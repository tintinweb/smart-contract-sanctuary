...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 bnb = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract SATAN is IBEP20, Auth {
    using SafeMath for uint256;

    address bnb = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SATAN";
    string constant _symbol = "STN";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 696969696969696969696696;
    ...
    uint256 reflectionFee   = 30;
    uint256 marketingFee    = 45;
    uint256 gameFee    = 10;
    uint256 teamFee    = 15;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _gameFee, uint256 _teamFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        gameFee = _gameFee;
        teamFee = _teamFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_gameFee).add(_teamFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/4);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _gameFeeReceiver, address _teamFeeReceiver) external authorized {
