...
contract RichFloki is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "RichFloki";
    ...
    uint256 public _maxTxAmount = 1 * 2000000**9;
