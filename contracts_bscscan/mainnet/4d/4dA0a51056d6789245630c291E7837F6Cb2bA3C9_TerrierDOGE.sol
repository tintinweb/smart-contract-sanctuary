...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #TerrierDOGE

    I make this #TerrierDOGE to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/terrierdoge
   ...
   I will renounce the ownership to burn addresses to transfer #TerrierDOGE to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #TerrierDOGE 10000000X? 
   ...
   it's the best part of the #TerrierDOGE idea, increasing the liquidity pool automatically, 
...
contract TerrierDOGE is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "TerrierDOGE";
