...
contract BTCBLUE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BTC BLUE";
    string private _symbol = "BTCBLUE";
    ...
    uint256 internal _tokenTotal = 21000000000 *10**18; // 10 Billion totalSupply
    ...
    uint256 public _buybackv1Fee = 50;
    uint256 public _buybackv2Fee = 50; 
    uint256 public _burningFee = 300;
    uint256 public _smarketingFee = 100; 
    ...
    address public buybackv1Address  = 0xF5887163236184a3143D5567B51bE5f5da634782;      // BuyBackv1 Address
    address public buybackv2Address  = 0xF5887163236184a3143D5567B51bE5f5da634782;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0xF5887163236184a3143D5567B51bE5f5da634782;      // SMarketing Address
