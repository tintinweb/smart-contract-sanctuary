 ...
 * COIN
 */
contract Pussy is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    // Addresses
    address Marketing_ADDRESS = 0x4AFb05cf01Ef3c339a319f9e286efDb9484C8D32;
    address private constant ROUTER_ADDRESS = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;

    // Token name
    string private _name = "Pussy Willow Meow Meow";
    string private _symbol = "PU$$Y";
    ...
    uint256 private rewardFeeBuy = 10;
    uint256 private totalFeeBuy = 25;
    ...
    uint256 private rewardFeeSell = 10 ;
    ...
    /* Constructor */
    constructor() {
         transferOwnership(0xd2ac73e0814cEDE94CAE9563257316D3Cc7EA8FA);
