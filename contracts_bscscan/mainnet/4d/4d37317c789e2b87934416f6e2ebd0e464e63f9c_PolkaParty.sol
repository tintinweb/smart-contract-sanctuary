...
/**
PolkaParty is a group wallet that allows all the members of a group to pool their funds together and collectively trade on DEFI. This wallet has built in governance mechanism through which, its users can decide cash out or disbursement rules for themselves.  
*/
