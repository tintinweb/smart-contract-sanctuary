...
/*
For all those who are disappointed with MissFloki launch, We present you LoveMissFloki, a spontanious meme reward token with big future plans
This token will pump your bags as we give the MissFloki token as rewards. So, hold your bags and enjoy the show :)

https://t.me/LoveMissFloki
Total Supply : 1,000,000
Max Wallet   : 40,000
Max Buy/Sell : 10,000

If you see a sell, Don't Panic
Contract will sell 0.1% of total supply to distribute the rewards
Instead consider it as a chance to buy more
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD_TOKEN = IBEP20(0x1987fDc87Fd63d4983C0d816A15CD66250820774);
...
contract Love_Miss_Floki is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD_TOKEN = 0x1987fDc87Fd63d4983C0d816A15CD66250820774;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Love_Miss_Floki";
    string constant _symbol = "LuMiss";
    ...
    uint256 init_liquidityFee    = 4;
    uint256 init_reflectionFee   = 2;
    uint256 init_marketingFee    = 4;
    uint256 public init_totalFee = 10; 
