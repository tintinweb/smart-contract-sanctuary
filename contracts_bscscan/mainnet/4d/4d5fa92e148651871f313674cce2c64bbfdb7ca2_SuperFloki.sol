...
import "./SuperFloki-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SuperFloki` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SuperFloki(Env.Testnet)` or `SuperFloki(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SuperFloki";
    string internal constant SYMBOL = "SFI";
     ...
     */
    address internal tipToTheDev =0x1EC7139b84DA91D00684fa00399e9866AD3471Ab;
...
contract SuperFloki is SafeToken{
