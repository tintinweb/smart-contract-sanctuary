...
/**Welcome to MicroDoge
   ...
   I will renounce the ownership to burn addresses to transfer #MicroDoge
   to the community
   Can you make #MicroDoge
   100X? 
   ...
   it's the best part of the #MicroDoge
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract MicroDoge is Context, IBEP20, Ownable {
