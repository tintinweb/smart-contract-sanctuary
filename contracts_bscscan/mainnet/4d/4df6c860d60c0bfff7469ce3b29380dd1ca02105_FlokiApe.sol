...
contract FlokiApe is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xD592580f6B66a73c97F558E2906557C6370891E8); // Marketing Address
    ...
    string private _name = "FlokiApe";
    string private _symbol = "FLOKIAPE";
    ...
    uint256 private _buypajekFee = 10;
