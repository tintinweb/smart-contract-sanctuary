...
contract BNBDROP is IERC20, Ownable {
    ...
    address public inviterAddress = address(0xEb7CbabCB3Bf1Ae8ccC3ddD5A33472700bD8ada8);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair;
    
    address public fund1Address = address(0xEb7CbabCB3Bf1Ae8ccC3ddD5A33472700bD8ada8);
