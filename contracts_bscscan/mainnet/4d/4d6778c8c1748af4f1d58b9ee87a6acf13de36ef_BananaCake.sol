...
/BananaCake is hyper-deflationary CAKE rewards and community driven token based on binance smart chain network. Earn cake in every hour just by holding BananaCake in your wallet.
...
contract BananaCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BananaCake";
    string constant _symbol = "BananaCake";
