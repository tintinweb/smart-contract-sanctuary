...
contract TGE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc4AeAA56B52F16664AE7b8d294D5E8Ab997AfcA6); // Marketing Address
    address payable public charityAddress = payable(0xc4AeAA56B52F16664AE7b8d294D5E8Ab997AfcA6); // Charity/Dev Address
    ...
    uint256 private _tTotal = 1980000 * 10**18; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ReSource Porotocol";
    ...
    uint256 public _maxTxAmount = 3500 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 3500 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 50000000000000000; // 5; token will be given on airdrop
    ...
    uint256 private salePrice = 3500;// 0.01*35 token for 0.01 bnb (set as per requirements)
