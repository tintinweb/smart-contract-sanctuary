...
// latest bossy baby token is here! telegram: bossbabybake
...
contract BossBabyBake is Context, IERC20, Ownable {
    ...
    string private _name = "BossBabyBake";
    string private _symbol = "BossBabyBake";
