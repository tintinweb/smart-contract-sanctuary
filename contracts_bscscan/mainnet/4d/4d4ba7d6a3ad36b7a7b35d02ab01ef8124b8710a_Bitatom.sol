...
/**
Bitatom SmartContract on Binance Smart Chain
Website 		: https:///bitatom.net
Twitter 		: https://twitter.com/bitatomnet
Telegram Group 		: https://t.me/bitatomnet
Telegram Channel 	: https://t.me/bitatomnews
*/
...
contract Bitatom is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BitatomDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Bitatom", "Bitom") {
        marketingWallet = payable(0x76b463ca82c34E370a3AF360aaBc5400faBE8546);
        ...
        dividendTracker = new BitatomDividendTracker(
            payable(this),
            router,
...
contract BitatomDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Bitatom public BitatomContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitatomContract = Bitatom(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Bitatom_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Bitatom_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Bitatom contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BitatomContract);

            uint256 prevBalance = BitatomContract.balanceOf(address(this));
            ...
            {
                uint256 received = BitatomContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BitatomContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
