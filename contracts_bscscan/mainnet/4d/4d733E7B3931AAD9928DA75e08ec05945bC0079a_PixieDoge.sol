...
PixieDoge is a game built on Binance Smart Chain that provides P2E game and NFTs to gain !

We are currently developing our official PixieDoge Game and NFTs! Stay tuned to our Telegram for regular updates.

Website : https://www.pixiedoge.com/
Telegram: https://t.me/PixieDoge
...
Liquidity Pool  : 240,000,000,000
Marketing Wallet: 10,000,000,000
...
contract PixieDoge is Context, IERC20, Ownable {
    ...
    string private _name = "PixieDoge";
    string private _symbol = "PIXIE";
   ...
   address private _marketingWalletAddress = 0x57688dFdb81c6060C5A17fCd6a22F58D5fb47419;
    ...
    function _takeDonation(uint256 tDonation) private {
        uint256 currentRate =  _getRate();
        uint256 rDonation = tDonation.mul(currentRate);
        _rOwned[_marketingWalletAddress] = _rOwned[_marketingWalletAddress].add(rDonation);
        if(_isExcluded[_marketingWalletAddress])
            _tOwned[_marketingWalletAddress] = _tOwned[_marketingWalletAddress].add(tDonation);
    }
