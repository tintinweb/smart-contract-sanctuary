...
contract BabyGreenChart is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Green Chart";
    string private _symbol = "BGREEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8B9Af7A0013e8b5339e3D91bEbDF58BDbA0aE498); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8B9Af7A0013e8b5339e3D91bEbDF58BDbA0aE498); // BuyBack Address
