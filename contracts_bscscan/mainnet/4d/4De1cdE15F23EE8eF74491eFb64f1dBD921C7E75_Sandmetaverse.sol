...
contract Sandmetaverse is ERC20, Ownable, SafeToken, LockToken {
    ...
    uint256 public swapTokensAtAmount = 1000000000 * 10**5 * (10**18);
    ...
    constructor() ERC20("Sand Metaverse", "SDM") {
        ...
        marketingFee = 3;
        marketingWallet = payable(0xc11d91453e05411b50D4e8e95E55aaFd092fb873);
...
initiateData(owner(), 10000000000000000 * (10**18));
