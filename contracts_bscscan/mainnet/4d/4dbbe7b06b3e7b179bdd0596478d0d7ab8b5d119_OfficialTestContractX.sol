...
contract OfficialTestContractX is IBEP20, Auth { //CHANGE THIS
    using SafeMath for uint256;
    ...
    string constant _name = "Official Test Name X"; //CHANGE THIS
    string constant _symbol = "TestX"; //CHANGE THIS
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 69 * (10 ** _decimals); //CHANGE THIS (default 1 million)
    uint256 public _maxTxAmount = _totalSupply / 100; //CHANGE THIS (default 1% of supply)
    ...
    uint256 liquidityFee = 200; //CHANGE THIS (default 2%)
    uint256 liquidityFeeAccumulator;
    uint256 buybackFee = 1;
    uint256 reflectionFee = 1000; //CHANGE THIS (default 10%)
    uint256 marketingFee = 1; //CHANGE THIS (default 0%)
    uint256 devFee = 300; //CHANGE THIS (default 3%)
    uint256 totalFee = 1500; //CHANGE THIS (default 15%)
