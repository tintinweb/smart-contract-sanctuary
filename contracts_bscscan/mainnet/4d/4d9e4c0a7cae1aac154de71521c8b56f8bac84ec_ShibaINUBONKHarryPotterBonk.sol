...
contract ShibaINUBONKHarryPotterBonk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x022dcdE0ccf107bdC87dBb5776AA61b8a38C491F); // Marketing Address
    ...
    string private _name = "ShibaINUBONKHarryPotterBonk";
    string private _symbol = "ShibaINUBONKHarryPotterBonk";
