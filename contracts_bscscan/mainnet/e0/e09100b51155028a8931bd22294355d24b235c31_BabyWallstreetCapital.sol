...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0x5B0C64768118380B357495F0c5D01Ad714Eda981);
...
/* Token contract */
contract BabyWallstreetCapital is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0x5B0C64768118380B357495F0c5D01Ad714Eda981; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "Baby Wall Street Capital";
    string constant _symbol = "BWSC";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 20 / 10000; // 0.2%
