...
contract SuperLuckyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9b5C4347F4F7967990999babf86dc59eacCD69d9); // Marketing Address
    ...
    string private _name = "SuperLuckyDoge";
