...
// LuckyChicken
// Tokenomics
// BUY -> 1% REFLECT, 3% MARKETING, 4% LOTTERY, 2% BUYBACK 
// SELL -> 1% REFLECT, 3% MARKETING, 4% LOTTERY , 7% BUYBACK
...
contract LuckyChicken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAC15bE845ff628308b58b7360f66c65995313dB6); // Marketing & Lottery Address
    ...
    uint256 private _tTotal = 1000000 * 10**9 * 10**9; // 1,000,000,000,000,000 TOTAL SUPPLY
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Lucky Chicken";
    string private _symbol = "LChicken";
    ...
    // Marketing and Lottery Divisor
    uint256 public marketingDivisor = 7;
    
    uint256 public _maxTxAmount = 3000 * 10**9 * 10**9;  // 3,000,000,000,000 
    uint256 private minimumTokensBeforeSwap = 100 * 10**9 * 10**9;  // 100,000,000,000 MinTokensSwaps
    ...
    // If remove the % go to Liquidity 
    function setBuyBackEnabled(bool _enabled) public onlyOwner {
        buyBackEnabled = _enabled;
        emit BuyBackEnabledUpdated(_enabled);
    }
    //Remove or put Autobuyback
