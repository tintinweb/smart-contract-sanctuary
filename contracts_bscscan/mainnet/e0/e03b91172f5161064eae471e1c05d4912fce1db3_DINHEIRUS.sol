...
/**
    Welcome to DINHEIRUS.CASH. A Charitable and adoptable Yield-Generating Crypto.
    Proceeds from our charity wallet will be donated to institutions in the 
    fight against cancer.
    
    Let's help the Fundação do Câncer on Brazil.
    https://www.cancer.org.br/blog/fundacao-do-cancer-e-dinheirus-cash-inovam-em-parceria-para-captacao-de-recursos-com-operacao-de-moeda-virtual/
    
    At the same time we have a second equally important mission, 
    to make Dinheirus Cash an adoptable currency.
    
    8% tax on transactions
    4% reflected back to holders
    2% liquidity
    ...
    The DINHEIRUS.CASH project is being migrated from the contract
    0x749e90d966ece8fc5a30ed150e4361f40db00219
    for this new contract, visit the website to learn more.
    
    https://dinheirus.cash 
...
contract DINHEIRUS is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50 * 10**6 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Dinheirus.Cash";
    string private _symbol = "DICASH";
    ...
    address public MarketingWallet = 0x0e85A857bB88Dd4c577021921c3800FF262fe6fB;
    ...
    uint256 public _maxTxAmount = 500000 * 10**8;
