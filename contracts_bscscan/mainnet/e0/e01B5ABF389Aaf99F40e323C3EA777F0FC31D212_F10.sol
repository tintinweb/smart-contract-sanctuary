...
contract F10 is Ownable, IBEP20 {
    ...
    function updateBurnAddress(address newAdd) external onlyOwner() returns(bool){
    ...
    function updateLiquidityAddress(address newAdd) external onlyOwner() returns(bool){
    ...
    function updateGameAddress(address  newAdd) external onlyOwner() returns(bool){
    ...
    function updateDonationAddress(address newAdd) external onlyOwner() returns(bool){
    ...
    function presaleTokenTransfer(address recipient, uint256 amount) public onlySender() returns (bool) {
