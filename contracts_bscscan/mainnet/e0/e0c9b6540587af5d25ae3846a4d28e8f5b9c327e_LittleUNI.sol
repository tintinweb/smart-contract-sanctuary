...
/**
 *
 ___      ___   _______  _______  ___      _______  __   __  __    _  ___  
|   |    |   | |       ||       ||   |    |       ||  | |  ||  |  | ||   | 
|   |    |   | |_     _||_     _||   |    |    ___||  | |  ||   |_| ||   | 
|   |    |   |   |   |    |   |  |   |    |   |___ |  |_|  ||       ||   | 
|   |___ |   |   |   |    |   |  |   |___ |    ___||       ||  _    ||   | 
|       ||   |   |   |    |   |  |       ||   |___ |       || | |   ||   | 
|_______||___|   |___|    |___|  |_______||_______||_______||_|  |__||___| 
 
 Hold and get rewarded in Uniswap tokens 9% Reflection fee
 
 TELEGRAM: @LITTLEUNITOKEN
 * 
*/
...
contract LittleUNI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LittleUNI";
