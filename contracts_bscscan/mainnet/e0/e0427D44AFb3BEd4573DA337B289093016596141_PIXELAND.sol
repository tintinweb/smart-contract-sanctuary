...
//5% fee is deducted from each transaction, of that 5% fee, 0% is is instantly distributed among all holders of the token available from C2050 wallet launched & 5% is automatically burned which continuously reduces the total supply.
...
contract PIXELAND is Context, IBEP20, Ownable {
    ...
    string private _name = 'PIXEL Land';
    string private _symbol = 'PIXELAND';
