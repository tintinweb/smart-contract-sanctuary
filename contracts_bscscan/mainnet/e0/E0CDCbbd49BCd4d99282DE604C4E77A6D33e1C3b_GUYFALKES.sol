...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router_Dividends = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(router_Dividends);
        _token = msg.sender;
    }
    ...
    function deposit() external payable override onlyToken {
        ...
        router_Dividends.swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
            0,
            path,
            address(this),
            block.timestamp
...
contract GUYFALKES is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GuyFalkesToken";
    string constant _symbol = "GUYFALKES";
    ...
    IDEXRouter public router_Dividends;
    address public pair;
    ...
    constructor () Auth(msg.sender) {
        ...
        router_Dividends = IDEXRouter(0xB0EeB0632bAB15F120735e5838908378936bd484);
        distributor = new DividendDistributor(address(router_Dividends));
        
        address _presaler = 0x49d86f06AbeEE2A82CD0f1cAd1A6f2608C99ce90;
    ...
    function setDividendRouter(IDEXRouter _DividendRouter) external authorized {
        router_Dividends = _DividendRouter;
    }
