...
contract BABYMETAPOLAR is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 10_000_000_000 * 10**9; // 1% of total supply
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10_000_000_000 * 10**9; // 0.01% of total supply

    string private constant _name = "Baby Meta Polar"; 
    string private constant _symbol = "$BABYPOLAR";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 6;
    address public _marketingWallet = 0x0E35D66ca88aD581Ad547911D48C4d88645Daf24;
