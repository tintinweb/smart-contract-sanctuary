...
contract BoyAndromeda is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BoyAndromeda";
    string private _symbol = "BA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07964e186F7Fa1cf926fbddA2172029d9299EC24); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x07964e186F7Fa1cf926fbddA2172029d9299EC24); // BuyBack Address
    ...
    uint256 public _sellMarketingFee = 16;
    uint256 public _sellBuyBackFee = 0;

    uint256 public _liquidityShare = 2;
    uint256 public _marketingShare = 27;
    uint256 public _BuyBackShare = 0;

    uint256 public _totalTaxIfBuying = 12;
    uint256 public _totalTaxIfSelling = 17;
    uint256 public _totalDistributionShares = 29;

    uint256 private _totalSupply = 100000 * 10**3 * 10**9;
    uint256 public _maxTxAmount = 1000 * 10**3 * 10**9;
    uint256 public _walletMax = 1000 * 10**3 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100 * 10**3 * 10**9; 
