...
DOGECUMROCKET is built upon the fundamentals of Buyback and increasing the investor's value
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract DogeCumRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x91FD716B5458ad357827651ccBf86319B512C687); // Marketing Address
    ...
    string private _name = "DogeCumRocket";
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > uint256(1 * 10**14)) {
