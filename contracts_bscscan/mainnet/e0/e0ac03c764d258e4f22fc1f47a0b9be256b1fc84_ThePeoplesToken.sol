...
Telegram: https://t.me/peerstoken
The peoples token 
very simple straight forward token for the people 
stealthed
4% marketing tax 
4%lp tax 
2% buyback tax 
it is completely up to the investors to take this where they will . enjoy . 
*/
...
contract ThePeoplesToken is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ThePeoplesToken";
