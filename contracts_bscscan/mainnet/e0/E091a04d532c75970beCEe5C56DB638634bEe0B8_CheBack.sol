...
contract CheBack is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd78397FA379073fa5e95f294eb5F0A0d3E2193dc); // Marketing Address
    ...
    string private _name = "CheBack";
    string private _symbol = "CheBack";
