...
library Address {
    function isContract(address account) internal view returns (bool) {
        bytes32 codehash;
        bytes32 accountHash = 0xec285d5a70895fffc47ebc66f4afe5733819c25f6a23c3134efaca6d030197bd;
...
contract CROWDSALE is Context, ReentrancyGuard{
    ...
    uint256 public minimumBuyAmount =  0.05 ether; // 0.05 BNB
    uint256 public maximumBuyAmount = 5000 ether; // 1000 BNB
    address payable public walletAddress;
    event TokensPurchased(address indexed to, uint256 amount);
    
    constructor () public {
        governance = tx.origin;
        rate = uint256(25000); // 25,000 Per BNB
        walletAddress = 0xAd390b1Fe83537db2c13CAc4Cd0AC32b468c0479; //Fund Receiver
    ...
    function buy() public payable {
        ...
        require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "Maximum amount is 5000 BNB");
