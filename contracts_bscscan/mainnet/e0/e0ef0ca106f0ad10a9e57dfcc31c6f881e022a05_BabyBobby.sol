...
/**
https://t.me/babybobbybsc
https://babybobby.vercel.app/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract BabyBobby is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x6d146036b6A1531B1c8CB2Bc58ba53aE04CD7D04); // Marketing Address

    address payable public teamAddress =
        payable(0x7e6771aa7eD9abDb0Abf1D9A01ae97198d2aeF7B); // Team Address

    address payable public liquidityAddress =
        payable(0x0c66555732E9DB1530E5DC741F3B27D318f9E310); // Liquidity Address
    ...
    string private constant _name = "BabyBobby";
