...
contract Darthinu is Context, IERC20, Ownable {
    ...
    string private _name = "Darthinu";
    string private _symbol = "$Darth";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Ee1869daa3f7c91d11Da04aB527FFdaA6C6e8C2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xeb6C243Cda1BECAC29e4dE4Eb7A64F0Bb0eB9E65); // BuyBack Address
