...
contract SpaceMoonKey is Context, IERC20, Ownable {
    ...
    string private _name = "Space Moonkey";
    string private _symbol = "MOONKEY";
    ...
    address public charityAdd = 0x1Ca579eBdB5eB2b630047EB9624cfB678814c988;
    ...
    constructor () {
        _owner = 0x189bd3DcCa0EcdC40ba289f5CB92CC1AE6d7e2B1;
    ...
    function SetnumTokensSellToAddToLiquidity(uint _example_500000x10e18) public onlyOwner {
        numTokensSellToAddToLiquidity = _example_500000x10e18;
    }
