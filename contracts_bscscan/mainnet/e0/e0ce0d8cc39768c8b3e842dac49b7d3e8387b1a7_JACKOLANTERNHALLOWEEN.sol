...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x828Cb87A5c9e8c79F7464ceE7978748a98D3feB2;
        _token = msg.sender;
    }
...
contract JACKOLANTERNHALLOWEEN is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x828Cb87A5c9e8c79F7464ceE7978748a98D3feB2;
    address MarketingWalletTwo = 0x828Cb87A5c9e8c79F7464ceE7978748a98D3feB2;

    string constant _name = "JACK OLANTERN HALLOWEEN";
    string constant _symbol = "JOH";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 500000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 500000000 * (10 ** _decimals);
    ...
    address IDEXPair = 0x828Cb87A5c9e8c79F7464ceE7978748a98D3feB2;
