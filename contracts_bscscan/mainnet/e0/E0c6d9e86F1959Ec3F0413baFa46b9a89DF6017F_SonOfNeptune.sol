...
If the God of the Sea had a cryptolike son, this would be him.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xbFc5D671Ccdeb25654EF83C61b1535B2CB0A29c7);
    IDEXRouter router;
...
contract SonOfNeptune is IBEP20, Ownable {

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SonOfNeptune";
    ...
    uint256 public _maxWalletToken = (_totalSupply/1000)*(15);
    ...
    function takeFee(address sender, address recipient, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        if(isSell && (burnFee >0)){
            toTheFire = (amount * burnFee)/feeDenominator;
        ...
        return amount-feeAmount-toTheFire;
    }
    ...
    function startTrading(uint256 _badBlocks) public onlyOwner {
