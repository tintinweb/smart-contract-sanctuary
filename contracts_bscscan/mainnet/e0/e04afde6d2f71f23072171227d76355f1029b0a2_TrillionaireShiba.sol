...
contract TrillionaireShiba is Context, IBEP20, Ownable {
    ...
    string private _name = "TrillionaireShiba";
    string private _symbol = "TRILLSHIB";
