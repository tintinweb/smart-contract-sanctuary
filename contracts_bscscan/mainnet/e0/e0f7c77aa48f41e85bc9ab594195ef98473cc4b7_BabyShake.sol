...
// Welcome to BabyShake
   
 //  This is a community token. If you want to create a telegram I suggest to name it to @BabyShakeChat
  ...
  // I will renounce the ownership to burn addresses to transfer #BabyShake to the community, make sure it's 100% safe.

  // I will add 0.2 BNB and all the left 10% total supply to the pool
  // Can you make #BabyShake 10000X? 
  ...
  // it's the best part of the #BabyShake idea, increasing the liquidity pool automatically, 
...
contract BabyShake is Context, IERC20, Ownable {
    ...
    string private _name = "BabyShake";
    string private _symbol = "BabyShake ";
