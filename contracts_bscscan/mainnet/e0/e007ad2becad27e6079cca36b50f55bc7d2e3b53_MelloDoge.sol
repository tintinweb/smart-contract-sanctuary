...
contract MelloDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mello Doge";
    string private _symbol = "MEDOG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb4f323d7Bb0C78D4310264CFc1C8Ecf880157F1A); // Marketing Address
    address payable private buyBackWalletAddress = payable(0xb4f323d7Bb0C78D4310264CFc1C8Ecf880157F1A); // buyback Address
    ...
    uint256 public _maxTxAmount = 5000000000 * 10**9; // 1%
    uint256 public _walletMax = 5000000000 * 10**9; // 3%
