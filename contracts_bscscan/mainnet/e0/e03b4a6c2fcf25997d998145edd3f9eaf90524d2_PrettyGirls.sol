...
contract Ownable is Context {
    address private _owner = 0xDD913dcB9C58ecAd85d0276BD5987d664F28Bf7b;
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 3 minutes");
...
contract PrettyGirls is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x6359231806b668e6D23635f09e68601c7cFE4573); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "PrettyGirls"; // token name
    string private _symbol = "PrettyGirls"; // token symbol
    ...
    uint256 durationBetweenEachBuyback = 3 minutes; // duration betweeen each buyback
    ...
    uint256 _buyBackFee = 70; // buyback fee 10%
