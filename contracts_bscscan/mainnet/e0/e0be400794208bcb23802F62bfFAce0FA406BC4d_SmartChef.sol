...
contract SmartChef is Ownable {
    ...
    uint256 public minTokenForPool = 250e9;
    ...
    function deposit(uint256 _amount) public {
        require(sponge.balanceOf(msg.sender) >= minTokenForPool, "You have not enough SPG");
        PoolInfo storage pool = poolInfo[0];
    ...
    function setMinTokenForPool(uint256 _minTokenForPool) public onlyOwner {
        minTokenForPool = _minTokenForPool.mul(10**9);
    }
