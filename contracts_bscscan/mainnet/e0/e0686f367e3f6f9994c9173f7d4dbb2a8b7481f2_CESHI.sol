...
contract CESHI is IBEP20, Auth {
    ...
    string constant _name = "ceshi";
    string constant _symbol = "ceshi";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 1000000000000000; // 0.5%
    ...
    uint256 reflectionFee = 600000;
    uint256 marketingFee = 0;
    uint256 totalFee = 120000;
    uint256 feeDenominator = 600000;
    ...
    uint256 public swapThreshold = _totalSupply / 2000000000000; // 0.005%
    bool inSwap;
