...
// File: contracts/FAMILYDOGEDividendPayingToken.sol
...
contract TOKEN is ERC20, Ownable {
    ...
    constructor() public ERC20("FAMILYDOGE", "FAMILYDOGE") {
...
contract XDOGEDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "FAMILYDOGE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
