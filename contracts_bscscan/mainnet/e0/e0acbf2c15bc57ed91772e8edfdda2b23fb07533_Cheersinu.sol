...
contract Cheersinu is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Cheers Inu";
    string constant _symbol = "Cheers Inu";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x7912Fb7cd2D6F769A3f64c99C4B20DB8A0D09145;
        marketingWallet = 0x403Fc240ab96dac056b7290E7eD070993A65A787;
    ...
    function BOTPROTECTION() external authorized {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(sender == pair && !authorizations[sender] && !authorizations[recipient]){
            require(buyOpen, "Trading not open yet");
        }
    ...
    function buyStatus(bool newStatus) public authorized {
        buyOpen = newStatus;
    }
