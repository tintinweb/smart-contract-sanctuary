...
contract SpaceKitty is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SpaceKitty";
    string constant _symbol = "SKITT";
    ...
    uint256 public swapThresholdMax = _totalSupply / 1000 * 8; // 0.8%
    bool inSwap;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = tokensToSell.mul(liquidityFee).div(totalFee).div(2);
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setSwapBackSettings(uint256 _minamount, uint256 _maxamount) external authorized {
        swapThreshold = _minamount;
        swapThresholdMax = _maxamount;
    }

    function setShouldSwapBack(bool _enabled) external authorized {
