...
contract AGREEN is IBEP20 {
    ...
    string public override name = "Ape GREEN";
    string public override symbol = "AGREEN";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 6 / 100;
