...
// Welcome to LittleBabyAqua
   
 //  This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyAquaChat
  ...
  // I will renounce the ownership to burn addresses to transfer #LittleBabyAqua to the community, make sure it's 100% safe.

  // I will add 0.2 BNB and all the left 10% total supply to the pool
  // Can you make #LittleBabyAqua 10000X? 
  ...
  // it's the best part of the #LittleBabyAqua idea, increasing the liquidity pool automatically, 
...
contract LittleBabyAqua is Context, IERC20, Ownable {
    ...
    string private _name = "LittleBabyAqua";
    string private _symbol = "LTBABYAQUA ";
