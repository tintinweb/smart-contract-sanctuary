...
contract Master is Ownable {
    ...
    IGravitA public GravitA;

    // Market oracle provides the GravitA/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _GravitA) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = GravitA.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && GravitA.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(GravitA.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return GravitA.totalSupply().toInt256Safe()
