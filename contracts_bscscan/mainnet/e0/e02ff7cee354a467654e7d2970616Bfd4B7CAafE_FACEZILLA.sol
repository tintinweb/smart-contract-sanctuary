...
/**
 * TELEGRAM: HTTPS://T.ME/FACEZILLA
 * Website : WWW.FACEZILLA.NET
 * PINNED IN : 
 * TWITTER INFLUENCERS MARKETING CHECK IN GROUP
 * REWARD
 * 4% CAKE REWARD - 5% MARKETING - 4% DEVELOPEMENT
 * TOKENOMICS
 * 50% BURN - 45% LIQUIDITY - 5% MARKETING WALLET
 * NO DEV WALLET
*/
...
contract FACEZILLA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FACEZILLA";
    string constant _symbol = "FZ";
