// 0xfa249Caa1D16f75fa159F7DFBAc0cC5EaB48CeFf
...
contract BunnyFactoryV2 is Ownable {
    ...
    // Number of GXO a user needs to pay to acquire a token
     ...
     * There is a limit on how many are distributed. It requires GXO balance to be > 0.
     */
    function mintNFT(uint8 _bunnyId) external {
        ...
        // Send GXO tokens to this contract
    ...
    /**
     * @dev It transfers the GXO tokens back to the chef address.
...
contract BunnyFactoryV3 is Ownable {
    ...
    BunnyFactoryV2 public bunnyFactoryV2; // leave it here even though not used now
    ...
    function mintNFT(uint8 _bunnyId) external {
        ...
        // Send GXO tokens to this contract
        gxoToken.safeTransferFrom(senderAddress, address(this), tokenPrice);
