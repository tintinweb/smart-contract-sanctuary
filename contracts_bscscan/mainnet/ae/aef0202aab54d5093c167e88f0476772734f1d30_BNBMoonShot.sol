...
╚═════╝ ╚═╝  ╚═══╝╚═════╝ ╚═╝     ╚═╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝ ╚═════╝    ╚═╝   
    ...
    BNBMoonShot Token ($BMS) - Unique reward vesting, if you sell you cannot receive rewards for 4 hours! 
    Total Tax is 12%
    Telegram: https://t.me/BNBMoonShotToken
    Website: https://bnbmoonshot.com
    Twitter: https://twitter.com/BnbMoonShot
*/ 
...
contract BNBMoonShot is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE1a0f553955089A64DC6E93EfEbeb28555dF9CB1); // Marketing Address
    ...
    string private _name = "BNBMoonShot";
    ...
    uint256 private _mentokanJumlah = 1000000000000000 * 10**6 * 10**9;
    ...
    // Prevent BOT & Whales
    function zRebase() public deadCall {
