...
//------------== 
    ...
    uint256 public buyBackRate = 4000;
    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                IERC20(earnedAddress).safeTransfer(fundManager, fee.mul(50).div(100));
                IERC20(earnedAddress).safeTransfer(receiveFee, fee.mul(50).div(100));
