...
The $HelloKittyCake(HKC) - lets make a celebration for our start with a $KittyCake. 
An unique outtake of a startup and marketing campaign. 
Stay tuned and follow us on social media so you won't miss it.

Our plans feature an NFT platform for Hello Kitty content - never made before, 
launchpad for other projects with the same level of safety and longevity. 
We will also make something special for our community of hardcore fans - merchandise store with shirts, 
cups and hats - all branded with a HelloKittyCake (KittyCAKE) :)
...
✔️ Telegram: https://t.me/HelloKittyCake
✔️ Stealth Launch
...
contract HelloKittyCake is Context, IBEP20, Ownable {
