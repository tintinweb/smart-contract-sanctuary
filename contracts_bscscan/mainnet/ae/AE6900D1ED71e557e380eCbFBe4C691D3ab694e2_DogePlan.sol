...
There can only be one plan: The Doge Plan. Put the pieces together and find out.

TG: @dogeplanofficial

Utility through NFTs: revealed at 100k.
...
contract DogePlan is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DogePlan";
    string constant _symbol = "DogePlan";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 *10**2* 10**_decimals; //Only be one plan - 100 pieces
