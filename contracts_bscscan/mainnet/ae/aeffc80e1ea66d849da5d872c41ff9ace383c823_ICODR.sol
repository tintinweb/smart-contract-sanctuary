...
contract ICODR is Operator {
    ...
    string private _name = "ICODR";//#币名
    string private _symbol = "ICODR";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x44bDc60F9bC16348aB8Eb2AA57294F1A5f0d137C),true);
    }
