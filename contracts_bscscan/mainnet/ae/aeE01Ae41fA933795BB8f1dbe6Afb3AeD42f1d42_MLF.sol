...
5% rewards Fees in ADA - directly auto claimed into your wallet just by holding MiniLittleFloki Tokens !
5% to marketing and 5% to liquidity pool.
Diamond hands will be rewarded !!

Official Telegram group : https://MiniLittleFloki
...
contract MLF is ERC20, Ownable {
    ...
    MLFDividendTracker public dividendTracker;
    ...
    uint256 public ADARewardsFee = 1;
    ...
    constructor() public ERC20("MiniLittleFloki", "MLF") {

    	dividendTracker = new MLFDividendTracker();

        _marketingWalletAddress = 0x71f658b73340f518779b575690Fc85166DF11704;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "MLF: The dividend tracker already has that address");

        MLFDividendTracker newDividendTracker = MLFDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "MLF: The new dividend tracker must be owned by the MLF token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "MLF: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MLF: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "MLF: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "MLF: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "MLF: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "MLF: Cannot update gasForProcessing to same value");
