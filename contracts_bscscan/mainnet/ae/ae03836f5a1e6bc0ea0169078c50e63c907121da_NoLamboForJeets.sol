...
contract NoLamboForJeets is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "NoLamboForJeets";
    string constant _symbol = "NLJ";
    uint8 constant _decimals = 9;

    // Supply
    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 1,000,000 Tokens
    uint256 _burntSupply = (_totalSupply * 0) /100;
    uint256 _liqSupply = (_totalSupply - _burntSupply);

    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100;  // 5% MaxWallet - 50,000 Tokens
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100;  // 100% Max Transaction - 1,000,000 Tokens  
    ...
    // Fee receivers
    address private marketingFeeReceiver = 0x3b82343783A3a65A682922E67DbA6059774B4409;
    address private buybackFeeReceiver = 0x3b82343783A3a65A682922E67DbA6059774B4409;
