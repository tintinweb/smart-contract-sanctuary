...
Nano Wallet is a cross-platform wallet for storing, managing, and discovering NFTs in all supported marketplaces and blockchains

TELEGRAM : https://t.me/NanoWalletOfficial
WEBSITE : https://nanowalletbsc.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAd1057C18930ED485983d9D2a143c4f96c4A08E6;
...
contract NANOWALLET is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAd1057C18930ED485983d9D2a143c4f96c4A08E6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NANO WALLET";
    string private _symbol = "NANOWALLET";
