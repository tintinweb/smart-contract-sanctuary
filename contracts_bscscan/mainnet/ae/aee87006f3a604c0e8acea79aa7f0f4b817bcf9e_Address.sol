...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9F0B0B43851A037B3E44DaFe43b9116e1F0Ca8Be;
...
contract GenTokens is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0x9F0B0B43851A037B3E44DaFe43b9116e1F0Ca8Be;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Jukita";
    string private _symbol = "JUKITA";
