...
/*
    ...
    3% of every transacion is converted to BNB and donated to one lucky holder via gleam
    0.5% is sent to the marketing wallet and 0.5% to the team wallet.
    
    2% of every transaction is redistributed between holders of the coin
    1% if every transacion is burned
    
    Telegram: https://t.me/ganartoken
    Twitter: https://twitter.com/ganartoken
    Website: https://ganartoken.com


    
    Deployer wallet:         0xb9eEbC54241a3b5818904B413285c99A2660113B
    Team wallet:             0xb73792f799306ABb785EE1081309D30e6f4FC06f
    Marketing wallet:        0xeD28A05c27c0702D403E57b0ce80C36eecF38328
    Raffle Wallet:           0xbf482C222882c0506aCAe12F33943F362F9Db15f
...
contract GanarToken is Context, IERC20, Ownable {
    ...
    string private _name = "Ganar";
    string private _symbol = "GNR";
    ...
    uint256 public _donationFee = 4; //4% is split to 3% donation + 0.5 % marketing + 0.5 % team
    uint256 private _previousDonationFee = _donationFee;
    
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 3 * 10**4 * 10**9; 
    
    address payable public charityAddress = 0xbf482C222882c0506aCAe12F33943F362F9Db15f;     // Raffle
    address payable public marketingAddress = 0xeD28A05c27c0702D403E57b0ce80C36eecF38328;   // Marketing
    address payable public teamAddress = 0xb73792f799306ABb785EE1081309D30e6f4FC06f;        // Team
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 BNBTransfer = (address(this).balance).div(8);
        uint256 charityTransfer = 6*BNBTransfer;
        
        TransferCharityBNB(charityAddress, charityTransfer); 
        uint256 afterTransferBalance = address(this).balance;
        
        TransferCharityBNB(marketingAddress, BNBTransfer);
        TransferCharityBNB(teamAddress, BNBTransfer);
        
        _tDonationTotal = _tDonationTotal.add(beforeTransferBalance.sub(afterTransferBalance));
        // The donation total is implemented in this way so it's more accurate because we're dealing with thirds.
    }
