...
contract Master is Ownable {
    ...
    // Market oracle provides the ForeverPump/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _pump) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = pump.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && pump.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(pump.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return pump.totalSupply().toInt256Safe()
