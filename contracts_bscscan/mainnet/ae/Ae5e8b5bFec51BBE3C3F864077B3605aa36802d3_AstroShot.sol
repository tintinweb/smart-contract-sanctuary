...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF432970cd8fd6C073E582A0e7D9c3123C882423B;
...
contract AstroShot is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7f6fC73566805d0cc55db161cFA4FD773415d2EB;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AstroShot";
