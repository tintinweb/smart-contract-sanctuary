...
contract TopSpaceX is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _maxTxAmount = 300000000000 * 10 ** _decimals;  
        _maxWalletBalance = 300000000000 * 10**_decimals;
        numTokensSellToAddToLiquidity = 100000000 * 10 ** _decimals;
        _marketingWalletAddress = 0x955d09334dFa14F6d2A30CBAE0E7F0E7dbBFB308; // Marketing wallet address
