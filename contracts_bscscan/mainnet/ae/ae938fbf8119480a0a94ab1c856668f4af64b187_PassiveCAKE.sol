...
interface IDEXRouter {
    ...
    function WCAKE() external pure returns (address);
    ...
    function addLiquidityCAKE(
        ...
        address to,
        uint deadline
    ) external payable returns (uint amountToken, uint amountCAKE, uint liquidity);
    ...
    function swapExactCAKEForTokensSupportingFeeOnTransferTokens(
        uint amountOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ...
    function swapExactTokensForCAKESupportingFeeOnTransferTokens(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        router.swapExactCAKEForTokensSupportingFeeOnTransferTokens{value: msg.value}(
            0,
            path,
            address(this),
            block.timestamp
...
contract PassiveCAKE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PassiveCAKE";
    string constant _symbol = "PCAKE";
    ...
    function swapBack() internal swapping {
        ...
        router.swapExactTokensForCAKESupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
            address(this),
        ...
        if(amountToLiquify > 0){
            router.addLiquidityCAKE{value: amountBNBLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
