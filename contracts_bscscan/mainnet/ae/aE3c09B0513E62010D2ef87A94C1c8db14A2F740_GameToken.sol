...
contract GameToken is Ownable, ERC20 {
    ...
    uint256 public antiWhale = 50 * 10**3 * 10**18;
    
    bool public botEnabled = false;
    
    bool public botDisableForever = false;
    ...
    function setBot(uint256 _amount, bool _botEnabled) external onlyOwner {
        antiWhale = _amount;
        botEnabled = _botEnabled;
    }
    
    function setBotDisableForever() external onlyOwner {
        require(botDisableForever == false);
        botDisableForever = true;
    }
    ...
    function _transfer(
        ...
        if(botEnabled && amount > antiWhale && !botDisableForever){
            revert("Anti whale");
        }
