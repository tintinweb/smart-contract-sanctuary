...
/**Welcome to PLASTICSTRAW
   ...
   I will renounce the ownership to burn addresses to transfer #PLASTICSTRAW
   to the community
   Can you make #PLASTICSTRAW
   100X? 
   ...
   it's the best part of the #PLASTICSTRAW
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract PLASTICSTRAW is Context, IBEP20, Ownable {
