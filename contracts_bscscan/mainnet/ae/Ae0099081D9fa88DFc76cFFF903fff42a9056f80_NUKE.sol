...
/*
 * Copyright 2021 Mini NUKE. ALL RIGHTS RESERVED.
 *
...
pragma solidity ^0.6.12;
    ...
    contract NUKE is Context, IERC20, Ownable {
        ...
        string private _name = 'Mini Nuke';
        ...
        uint256 private _numOfTokensToExchangeForteam = 500000;
        ...
        function addBotToBlackList(address account) external onlyOwner() {
            require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'We can not blacklist PancakeSwap router.');
        ...
        function _setteamFee(uint256 teamFee) external onlyOwner() {
            require(teamFee >= 0 && teamFee <= 11, 'teamFee should be in 0 - 11');
            _teamFee = teamFee;
        }
