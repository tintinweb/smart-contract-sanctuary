...
Rias Gremory Token is a community-driven, anime token on Binance Smart Chain with low tax,
hold $RIAS in your wallet and earn $RIAS. 
Each transaction will deduct a fee to be distributed to holders as reflections, 
expand our liquidity pool and also marketing wallet.

Telegram https://t.me/riasgremorytoken
Twitter https://twitter.com/RiasGremoryBSC
Website https://riasgremorytoken.com/
...
contract RiasGremory is Context, IERC20, Ownable {
    ...
    // Liquify when 700 billion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 700_000_000_000 * 10**9;
