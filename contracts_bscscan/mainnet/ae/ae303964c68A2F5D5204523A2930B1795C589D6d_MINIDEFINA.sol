...
---------------------------InstaFINA .sol--------------------------------
                    ...
                    symbol  : DEFINAM
                    decimals: 18
                    supply  : 1,000,000,000 DFA
                    Website : https://MINIDEFINA.io/
                    Twitter : https://twitter.com/MINIDEFINA
                    Telegram : https://t.me/MINIDEFINA
...
contract MINIDEFINA is ERC721 {

    // common addresses

    address private owner;
    address private FINA;
    address private MINI;
    address private io;
    ...
    string public override name = "MINI DEFINA";
    string public override symbol = "FINAM";
    ...
    constructor(uint totalSupplyValue, address FINAAddress, address MINIAddress, address ioAddress) {
        // set total supply
        ...
        balances[MINI] = totalSupply * 47 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint MINITBD = value * 4 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - MINITBD - burnTBD;
        ...
        balances[owner] += MINITBD + burnTBD;
        _burn(owner, burnTBD);
