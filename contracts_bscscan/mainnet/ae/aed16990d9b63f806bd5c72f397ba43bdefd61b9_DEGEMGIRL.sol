...
contract DEGEMGIRL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DEGEMGIRL";
    string private _symbol = "DEGIRL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x26e87e96b1Bf7DA14636796c06FeA88E96577454); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x26e87e96b1Bf7DA14636796c06FeA88E96577454); // Buyback Wallet Address
    ...
    uint256 public _maxTxAmount = 150000 * 10**9; // 2%
    uint256 public _walletMax = 300000 * 10**9; // 3%
