...
*  Telegram Chinese: t.me/KirbyInu_bsc_CN
*  Twitter: @KirbyInu
...
5. 10% BNB Redistribution Reflections and 3% dev fee on all buys / sells / transfers. 13% total tax. 26% round trip

 * Using FTPBNBReflect
    - FTPBNBReflect is a contract as a service (CaaS). Let your traders earn rewards in BNB
 * Using FTPAntiBot
