...
contract haloweenshiba is Context, IERC20, Ownable {
    ...
    string private _name = "HaloweenShiba";
    ...
    uint256 private minimumTokensBeforeSwap = 8 * 10**5 * 10**9;
...
*/
    ...
    // ETH Swapper class
    address payable ethSwapper = 0x019d41FffDE372C5f681b373bA4470F4992b87d0;
