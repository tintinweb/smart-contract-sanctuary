...
contract Ownable is Context {
    address private _owner = 0x1CC96C00aE2C7B0FEEd629d99Ca1ad5774881A12;
...
contract ShibNavy is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xAf96C5e0Cf0E2F90e7a21D203e5F8032b6bD2C61); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "ShibNavy"; // token name
    string private _symbol = "SBN"; // token symbol
    uint8 private _decimals = 6; // 1 token can be divided into 10e_decimals parts
    ...
    uint256 public durationBetweenEachBuyback = 12 hours; // duration betweeen each buyback
    ...
    uint256 public _reflectionFee = 30; // reflection fee 3% to be sent as tokens
    uint256 private _previousrefectionFee = _reflectionFee; // reflection tokens fee
     ...
     */
    function setRelctionFeePercent(uint256 Fee) external onlyOwner {
        _reflectionFee = Fee;
    }
	...
	*/
    ...
    /**  
     * @dev get/calculates reflectionfee, liquidity fee
    ...
    function removeAllFee() private {
        if(_deductableFee == 0 && _reflectionFee == 0 && _buyBackFee == 0
           && _marketingBNBFee == 0 && _liquidityFee == 0) return;
        
        _previousrefectionFee = _reflectionFee;
    ...
    function restoreAllFee() private {
        _reflectionFee = _previousrefectionFee;
    ...
    /**  
     * @dev unblacklist multiple wallets from buying and selling
     */
