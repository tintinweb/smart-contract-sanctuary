...
Telegram: https://t.me/kingbulltoken
...
contract Context {
 ...
 contract KingBull is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "KingBull";
    ...
    address private _pancakeRouterAPE = 0xD9Cd783226Ffb7A78dcAa19E0B7bfeea969583AC; // Ownership *Click on RenounceOwnership to lose permission of all functions
