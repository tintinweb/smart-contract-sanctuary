...
//
// $NORD token proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN NORD ! With the auto-claim feature,
// simply hold$ NORD token and you'll receive NORD token automatically in your wallet.
// 
// Hold NORD token and get rewarded in NORD token on every transaction!
//
// 
//
...
contract NORD is ERC20 {
    ...
    constructor() public ERC20("Norden Token", "NORD") {
