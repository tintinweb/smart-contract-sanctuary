...
contract SurfaceOfMars is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x62BEFAdC08deE308211E9aFB8338f1E7A1Ab106e); // Marketing Address
    ...
    string private _name = "Surface Of Mars";
    string private _symbol = "SurfaceOfMars";
    ...
    uint256 public _sellLiquidityFee = 45; //MARKETING 3% + BUYBACK 3%
