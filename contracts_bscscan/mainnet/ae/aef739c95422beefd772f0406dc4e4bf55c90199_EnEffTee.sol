...
// EnEffTee ($ENEFFTEE)
// 11% tax: 5% marketing wallet / 4% buyback and burn / 2% liquidity
// Telegram: https://t.me/EnEffTeeBSC        
// Website: https://www.enefftee.net/
...
contract EnEffTee is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6C01E7720bc77db0D0Db12ba96F412DCB717654E); // Marketing Address
    ...
    string private _name = "EnEffTee";
    string private _symbol = "ENEFFTEE";
    ...
    uint256 private _buypajekFee = 11;
    uint256 private _buylpPajek = 1;
    
    uint256 private _botNeedsPrevention = 1;
    uint256 private _whaleNeedsPrevention = 11;
