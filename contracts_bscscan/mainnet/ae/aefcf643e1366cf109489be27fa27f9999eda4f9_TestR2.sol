...
contract TestR2 is ERC20, Ownable {
    ...
    constructor() ERC20("TestConv2", "TESTA2") {
        
        address newOwner = address(0x4bceC8691A4979464FCB4f2C6a0c20dd0DD7DC18);
    	...
    	marketingWallet = address(0x8dC221F996dE6BEF70CaEdD7618bFFb4995A83b1); // set as marketing wallet
