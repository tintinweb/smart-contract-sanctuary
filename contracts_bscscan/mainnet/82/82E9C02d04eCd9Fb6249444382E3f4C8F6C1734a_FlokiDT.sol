...
contract FlokiDT is ERC20Detailed, Ownable {
    ...
    uint256 public sellDelay = 1 minutes;
    ...
    constructor() ERC20Detailed() {
        ...
        marketingFeeReceiver = 0x77d597bC42D6a4EcB41eFEf4c337CF10D6c5636b;
        ecosystemFeeReceiver = 0x07621D91b7e3560e2007990c853E45600fAadAF6;
        buyBackFeeReceiver = 0xA6AAEd1fF0B610655a8E12546077Fe5b361Ef6d7;
    ...
    function _transferFrom(
        ...
        require(!isBlackListed[sender] && !isBlackListed[recipient],"Account is blacklisted");
        
    if(sender == pair){
        
        userLastBuy[recipient] = block.timestamp;
        if (inSwap) {
        ...
        require(userLastBuy[sender] + sellDelay < block.timestamp || userLastBuy[sender] == 0 ,"Too soon to sell!");
            if (inSwap) {
            return _basicTransfer(sender, recipient, amount);
        }
