...
// CHANGE
contract BabyPunkCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyPunkCake";
    string constant _symbol = "$PUNK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 9) / 100; // 1% MAX 1,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 9) / 100; // 3% MAX 3,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xdF47B3B84801B8123E9471969B405e39bc5e1367);
