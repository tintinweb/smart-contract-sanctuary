...
//CHEESEMOON Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract CheeseMoon is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'CHEESEMOON';
    string private constant _symbol = 'CMOON';
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 21000000000 * 10**_decimals;//
    ...
    //The Treasury Wallet is a Multisig wallet that reqires 3 signatures for each action
    address public TreasuryWallet=0xa6A72df65567bdAC75180fa537e6B4780588b776;
    //TODO: Change to Mainnet
    //TestNet
    //address private constant PancakeRouter=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    //MainNet
    address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;
    //TODO: Set To Rewards Token
    address tokenToClaim=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;//ZIL
    //Testnet BUSD
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==TreasuryWallet;
    }
    ...
    function TeamWithdrawMarketingBNB() public onlyTeam{
        ...
        marketingBalance=0;
        (bool sent,) =TreasuryWallet.call{value: (amount)}("");
    ...
    function TeamReleaseLiquidity() public onlyTeam {
        ...
        if(liquidityRelease20Percent)
        {
            ...
            amount=amount*2/10;
            liquidityToken.transfer(TreasuryWallet, amount);
        }
        else
        {
