 ...
 * /$$$$$$$   /$$$$$$  /$$$$$$$  /$$     /$$       /$$$$$$$$ /$$$$$$$   /$$$$$$  /$$      
  ...
  | $$  \ $$| $$  | $$| $$  \ $$    | $$             | $$   | $$  \ $$| $$  | $$| $$      
  | $$$$$$$/| $$  | $$| $$$$$$$/    | $$             | $$   | $$  | $$|  $$$$$$/| $$$$$$$$
  |_______/ |__/  |__/|_______/     |__/             |__/   |__/  |__/ \______/ |________/
...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BABYTROL
   Important: Elon just calling about Mario. The early you create a group that shares the token, the more gain you'll get.
   ...
   I will renounce the ownership to burn addresses to transfer #BigMomDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BABYTROL 10000X? 
...
contract BABYTROL is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Trol";
    string private _symbol = "BbyTrL";
