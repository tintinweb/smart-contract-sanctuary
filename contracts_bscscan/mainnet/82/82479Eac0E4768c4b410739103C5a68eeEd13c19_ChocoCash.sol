...
/*
Auto-Cardano Reward Token
TG - @ChocoCash
Website - https://www.ChocoCash.network
*/
...
contract ChocoCash is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ChocoCash";
    string constant _symbol = "ChocoCash";
