...
contract BabyMessiahDoge is Context, IERC20, Ownable {
    ...
    string private _name = "BabyMessiahDoge";
    ...
    uint256 public maxBuyTranscationAmount = 250000000 * 10**6 * 10**9; 
    uint256 public maxSellTransactionAmount = 5000000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 500000000 * 10**6 * 10**9;
