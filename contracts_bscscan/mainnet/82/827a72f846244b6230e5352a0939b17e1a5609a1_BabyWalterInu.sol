...
// File contracts/BabyWalterInu.sol
pragma solidity ^0.8.0;

contract BabyWalterInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyWalterInu";
    string private constant _symbol = "BABYWINU";
