...
Website: https://babyasia.asia/
TG: https://t.me/BabyAsiaNFTs

Socials: https://linktr.ee/BabyAsiaNFT
...
// Begin sauce.
contract BabyAsiaNFT is Context, IERC20, Ownable {
    ...
    string private  _name               = "BabyAsia NFTs";
    string private  _symbol             = "BASNFT";
    ...
    // marketing
    uint256 public _fee_marketing = 400;
    uint256 private _fee_marketing_old = _fee_marketing;
    address payable public _wallet_marketing = payable(0x40B448A88FA38c6ABD65B8cCF51890843a2Be0f3);

    // for burn
    uint256 public _fee_burn = 100;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0x2011cfA169c5725ab1d1F9194D8f5e5e9c84c06B);

    // for team
    uint256 public _fee_team = 300;
    uint256 private _fee_team_old = _fee_team;
    address payable public _wallet_team = payable(0x3ecb6471ba7B4da9533fF9FBBB2df23ac2Af0C06);
