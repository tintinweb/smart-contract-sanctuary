...
//Community driven token, you can request be admin here, Launch and make hype together
//🔥🔥 BURN liquidity 🔥🔥
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TWT = IBEP20(0x4B0F1812e5Df2A09796481Ff14017e6005508003);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TWT.balanceOf(address(this));
        ...
        uint256 amount = TWT.balanceOf(address(this)).sub(balanceBefore);
...
contract SUPERTRUSTWALLET is IBEP20, Auth {
    using SafeMath for uint256;

    address TWT = 0x4B0F1812e5Df2A09796481Ff14017e6005508003;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SUPERTRUSTWALLET";
    string constant _symbol = "SuperTWT";
    ...
    uint256 public swapThreshold = _totalSupply / 200000000; // 2%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xA1ff9e48c59F0fCF218Aa2B42AEd7ce8663Ba370;
