...
///https://t.me/antivaxcoin
///🦠💉❌ ANTIVAX Coin 🦠💉❌
///🚨 Imminent Stealth Launch 🚨

//== The Reserve Currency For Independent Thinkers ==
//💫 Audit Soon & LP locked before launch                                                                                                                                                                                                                                                                                        
//💫 Roadmap: NFT, video game, merch, yield farming
//🍀 Huge Marketing Budget
//➡️ 15% Rewards on every transaction
//👉http://t.me/antivaxcoin
//👉https://www.antivax.io/
//👉https://twitter.com/antivaxcoin
...
contract ANTIVAX is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 100_000_000_000_000 * 10**9; // 1% of total supply
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10_000_000_000 * 10**9; // 0.01% of total supply

    string private constant _name = "ANTIVAX"; 
    string private constant _symbol = "ANTVX";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 6;
    address public _marketingWallet = 0xe04622f575a3074F6f4e4Cc81A72ff8334D1483F;
