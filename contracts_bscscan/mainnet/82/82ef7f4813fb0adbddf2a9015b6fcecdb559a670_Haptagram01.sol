 ...
 */
 ...
 contract Haptagram01 is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Haptagram01", "HAP01") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xB9a89eA51e267B07C8c316cCCbA883954DaDCe7D); 
          _setupRole(MINTER_ROLE, 0xB9a89eA51e267B07C8c316cCCbA883954DaDCe7D); 
          _setupRole(MINTER_ADMIN_ROLE, 0xB9a89eA51e267B07C8c316cCCbA883954DaDCe7D); 
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xB9a89eA51e267B07C8c316cCCbA883954DaDCe7D);  
     }
     ...
     function mint_by_id(address to, uint256 tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "HAP01/minter-role-required");
         _mint(to, tokenId);
     }      
     /**
