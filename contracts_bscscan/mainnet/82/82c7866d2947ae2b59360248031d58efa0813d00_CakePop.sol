...
/**
CakePop - HOLD AND GET 10% CAKES
100% SAFE NOT RUG OR HONEY
DONT BREAK THE CHART SELLING BIG AMOUNTS, KEEP THE CHART FAIR AND HEALTHY SELLING SMALL AMOUNTS
 *** THE MAX A WALLET CAN HAVE IS 25.000,000! THAT IS 2.5%!  ***

 - 1-day Liquidity Lock (will send BSCSAN link in the TG)
 - If the marketcap is above $100,000, after 3 days we'll lock it for a month and begin unveiling our future plans

 TG: https://t.me/CakePopBSC
 website: cakepop.live 

 
 
 Hold $CakePop and get $CAKE automatically in your wallet every hour!
 CAKE: 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82
 

 # of Tokens: 1,000,000,000
 Max Wallet Size = 25,000,000
 Max Transaction Size = 15,000,000 

 
 Reflection/Taxes: 10% in CAKE, 6% in Liquidity , 4% to Dev
...
// CHANGE
contract CakePop is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CakePop";
    string constant _symbol = "POP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 15) / 1000; // 1.5% MAX 15,000,000
    uint256 public _maxWalletSize = (_totalSupply * 25) / 1000; // 2.5% MAX 25,000,000
    ...
    uint256 liquidityFee = 600; // 6%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 1000; // 10%
    uint256 devFee = 400; // 4%
    uint256 totalFee = 2000; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xc3f696b51517fbA6D5472CdD420fB8cAC4760827);
