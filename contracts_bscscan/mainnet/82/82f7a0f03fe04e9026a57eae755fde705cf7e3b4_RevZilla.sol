...
https://www.youtube.com/c/RevZilla
https://twitter.com/revzilla
https://www.instagram.com/revzilla/
*/
...
contract RevZilla is IBEP2{
     // FairLaunch
    // common addresses
    
    address private owner;
    address private motorcycle;
    address private gear;
    ...
    string public override name = "RevZilla";
    string public override symbol = "RevZilla";
    ...
    constructor(uint totalSupplyValue, address motorcycleAddress, address gearAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        motorcycle = motorcycleAddress;
        gear = gearAddress;

        balances[motorcycle] =  totalSupply * 1 / 100;
        balances[gear] = totalSupply * 49 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        balances[owner] += AirDropFee + BuyBurnBack;
        _burn(owner, BuyBurnBack);
