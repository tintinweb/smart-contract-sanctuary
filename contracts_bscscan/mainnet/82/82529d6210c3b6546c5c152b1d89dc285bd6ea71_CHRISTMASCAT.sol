...
/**
TELEGRAM : https://t.me/ChristmasCatToken

Website: http://christmascat.art/

Twitter: https://twitter.com/CctToken

Github: https://github.com/christmascattoken

Reddit: https://www.reddit.com/user/christmascattoken/
*/
...
contract CHRISTMASCAT is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x3ec5dfc4e3D0DFb47aACE3C37a9f70859d1D0279); // Marketing Address
    ...
    string private _name = "CHRISTMAS CAT TOKEN";
    ...
    uint256 public _sellLiquidityFee = 9; //MARKETING 3% + BUYBACK 3%
    ...
    uint256 private minimumTokensBeforeSwap = 95425321425142 * 10**9; 
