...
contract BABYFOXDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Baby_fox_Dividend_tracker", "Baby_fox_Dividend_tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override pure {
        require(false, "Baby_fox_Dividend_tracker: No transfers allowed");
    }

    function withdrawDividend() public override  pure {
        require(false, "Baby_fox_Dividend_tracker: withdrawDividend disabled. Use the 'claim' function on the main bfox contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "Baby_fox_Dividend_tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Baby_fox_Dividend_tracker: Cannot update claimWait to same value");
...
contract BabyFox is ERC20, Ownable {
    
    using SafeMath for uint256;

    address public uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;
    BABYFOXDividendTracker public dividendTracker;

    address public _marketingWallet = 0xBa0598009Cd7431e2B0B307A0f8aE97f5099FaB7;

    bool public restrictWhales = true;

    uint256 public maxTxAmount = 50000000000 * (10**9);
    uint256 public walletMax = 100000000000 * (10**9);
    uint256 public swapTokensAtAmount = 2500000000 * (10**9);
    ...
    constructor() ERC20("Baby Fox", "BFOX") {

    	dividendTracker = new BABYFOXDividendTracker();
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "bfox: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "bfox: Account is already the value of 'excluded'");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "bfox: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "bfox: Cannot update gasForProcessing to same value");
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        maxTxAmount = 10000000000000 * (10**9);
