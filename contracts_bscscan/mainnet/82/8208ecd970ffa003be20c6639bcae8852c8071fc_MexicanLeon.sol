...
/**
Welcome to mexican Leon🦁

$MexicanLeon uses the following tokenomic breakdown to power its system and provide the premier Token reward platform.
...
Telegram : https://t.me/MexicanLeon
*/
...
contract MexicanLeon is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "MLeon";

  string private _name = "MexicanLeon";
