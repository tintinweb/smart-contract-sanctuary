...
// File: contracts/BabyDAIDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable DAI = address(0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B);
...
// File: contracts/BabyDAI.sol



pragma solidity ^0.7.4;

contract BabyDAI is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public immutable DAI = address(0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3);
	address payable public MarketingAddress = payable(0x5645B9676881b7c25c5892DcCDFfCC89b66cDd07); 
	address payable public BuyBackAddress = payable(0x6e862Fa589B15D403FAC7FaC42DbBF2012349F35); 
    bool private swapping;

    BabyDAIDividendTracker public dividendTracker;
	...
	uint256 private _maxSellAmount = 1000000 * (10**18);  
    uint256 private _swapTokensAtAmount = 100000 * (10**18);


    uint256 public immutable DAIRewardsFee;	
	...
	uint256 public BuyCooldownLimit = 5;
	
	bool public antiSnipingBot = false;
	bool public DisableRestrictions = false;
	bool public BuyCooldownActive = false;
    ...
    uint256 public immutable tradingEnabledTimestamp = 1627817340;
    ...
    constructor() ERC20("BabyDAI", "BabyDAI"){
        uint256 _DAIRewardsFee = 7;
        uint256 _LiquidityFee = 1;

        DAIRewardsFee = _DAIRewardsFee;
        LiquidityFee = _LiquidityFee;
        totalFees = _DAIRewardsFee.add(_LiquidityFee);


        dividendTracker = new BabyDAIDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BabyDAIDividendTracker newDividendTracker = BabyDAIDividendTracker(payable(newAddress));
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyDAI: The PanDAISwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BabyDAI: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BabyDAI: gasForProcessing must be between 200,000 and 500,000");
	...
	function setBuyCooldownActive (bool _enabled) public onlyOwner {
        BuyCooldownActive  = _enabled;
	}
	function setDisableRestrictions (bool _enabled) public onlyOwner {
        DisableRestrictions  = _enabled;
	}
	function setantiSnipingBot (bool _enabled) public onlyOwner {
        antiSnipingBot  = _enabled;
	}
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "BabyDAI: This account cannot send tokens until trading is enabled");
        }
    ...
    function swapTokensForDAI(uint256 tokenAmount, address recipient) private {
        ...
        // generate the uniswap pair path of weth -> DAI
    ...
    function swapAndSendDividends(uint256 tokens) private {
        swapTokensForDAI(tokens, address(this));
...
contract BabyDAIDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BabyDAI_Dividend_Tracker", "BabyDAI_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(true, "BabyDAI_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1 && newClaimWait <= 86400, "BabyDAI_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BabyDAI_Dividend_Tracker: Cannot update claimWait to same value");
