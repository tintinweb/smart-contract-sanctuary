...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    function getRandomNumber() external override {
        require(msg.sender == playLottery, "Only PlayLottery");
    ...
    /**
     * @notice Set the address for the PlayLottery
     * @param _playLottery: address of the PolyPlay lottery
     */
    function setLotteryAddress(address _playLottery) external onlyOwner {
        playLottery = _playLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPlayLottery(playLottery).viewCurrentLotteryId();
    }
