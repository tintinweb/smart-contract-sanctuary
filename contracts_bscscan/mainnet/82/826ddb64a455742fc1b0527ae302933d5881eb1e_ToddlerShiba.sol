...
contract ToddlerShiba is Context, IERC20, Ownable, LPLocker {
    ...
    string private _name = "ToddlerShiba";
    string private _symbol = "ToddlerShiba";
    ...
    address payable public _marketingAddress = 0xDFe10F4b7e9B1881c5624296Cd94Ea43A897560f;
