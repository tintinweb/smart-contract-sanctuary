...
contract BABYNANOMINIDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "BABYNANOMINIDOGE";
    string private _symbol = "BNMD";
    ...
    address public charityWallet = 0xAD06A70C7538F9693e972CC061158CD61129Bbe7;
    ...
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**11 * 10**18;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 initialBalance = address(this).balance; // Balance in BNB
    ...
    function setNumTokenSellToAddLiquify(uint256 amount) public onlyOwner {
