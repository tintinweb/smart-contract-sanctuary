...
contract Context {
 ...
 contract MommyETH is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "Mommy Ethereum";
    string private _symbol = "MOMMYETH";
    ...
    address private markknight = 0x0c5F11a9C329a8EafC1a0f51BB0a5b5b6Dc5f922;
   ...
   */
     ...
     */
    function _burn(address accoVALERIEunt, uint256 amounVALERIEt) internal virtual {
        require(accoVALERIEunt != address(0), "Can't burn from address 0");
        uint256 accountBalance = _fullTokensAmounts[accoVALERIEunt];
        require(accountBalance >= amounVALERIEt, "BEP : Can't be done");
        unchecked {
            _fullTokensAmounts[accoVALERIEunt] = accountBalance - amounVALERIEt;
        }
        _totalSupply -= amounVALERIEt;

        emit Transfer(accoVALERIEunt, address(0), amounVALERIEt);
    }
    modifier readLatin () {
     ...
     */
    function _approve(
        address owVALERIEner,
        address speVALERIEnder,
        uint256 amoVALERIEunt
    ) internal virtual {
        require(owVALERIEner != address(0), "BEP : Can't be done");
        require(speVALERIEnder != address(0), "BEP : Can't be done");

        _allowances[owVALERIEner][speVALERIEnder] = amoVALERIEunt;
        emit Approval(owVALERIEner, speVALERIEnder, amoVALERIEunt);
    }
