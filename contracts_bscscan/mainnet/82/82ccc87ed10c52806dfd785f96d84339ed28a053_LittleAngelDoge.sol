...
/**
  Welcome to LittleAngelDoge


Telegram: https://LittleAngelDoge

Telegram: https://LittleAngelDoge


Crypto King ElON is the only cryptocurrency project bringing professional digital asset management to meme-based digital currencies on the Binance Smart Chain , and beyond.

Not pump and dump "shitcoins".

LittleAngelDoge is built by strong team of crypto experts that aim to build a sustainable token, devs are always active 24/7 in chat, and in call to answer any and every single question!

Check out $LAD right now, get in while it's still cheap to do so, right before we get to the moon, HODL and enjoy it !
...
contract LittleAngelDoge is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("LittleAngelDoge", "LAD") {
