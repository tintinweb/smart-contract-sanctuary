...
contract SuperMetaKishu is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function Antibot(bool _number) public onlyOwner virtual returns (bool) {
        isNumber = _number;
        return true;
    }
