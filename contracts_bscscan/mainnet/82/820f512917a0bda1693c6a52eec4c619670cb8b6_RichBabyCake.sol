 ...
 * 
 Welcome to $RichBabyCake:
   ...
   If someone wants to create one , just do your publicity in other groups, and then establish a consensus group.
    ...
    I'll renounce the ownership to burn addresses to transfer this token to the community, make sure it's 100% safe.
   ...
   Many Great features:
    ...
    5.LP send to team.finance for 90days, if the response is good, I will continue to extend it
    6.Contract renounced on Launch!
    7.1000 Billion Supply and 50% to burn address!
    8.Auto-farming to All Holders! 
    9.Tax: 5% => Burn: 2.5% | LP: 2.5%
    
    2.5% fee for liquidity will go to an address that the contract creates,       
    and the contract will sell it and add to liquidity automatically, 
    it's the best part of the $RichBabyCake idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 30bnb in the pool. 
...
contract RichBabyCake is Context, IERC20, Ownable {
