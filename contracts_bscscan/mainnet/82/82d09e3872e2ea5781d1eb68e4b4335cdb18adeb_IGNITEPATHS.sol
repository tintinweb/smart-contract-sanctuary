...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd8ed6d6CEC1c0219eA7A4856dc3fd597E6F0D118;
...
contract IGNITEPATHS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x33aAB4fd01858181bca1C6758a1a5A9f494eF70e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "IGNITEPATHS";
    string private _symbol = "IGNITE";
