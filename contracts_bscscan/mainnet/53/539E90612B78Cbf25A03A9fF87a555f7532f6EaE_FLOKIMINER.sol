...
contract DividendDistributor {
    ...
    IERC20 BTCS = IERC20(0xB4a81261b16b92af0B9F7C4a83f1E885132D81e4); 
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            //pancake testnet router : 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function deposit() external payable {
        uint256 balanceBefore = BTCS.balanceOf(address(this));
        ...
        uint256 amount = BTCS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BTCS.transfer(shareholder, amount);
...
contract FLOKIMINER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKI MINER";
    string private _symbol = "$FLOKIM";
    uint8 private _decimals = 9;
    

    address payable public marketingWalletAddress = payable(0x93C9A8981397fd8770931606850e3dF098665002); // Marketing Address
    address payable public rewardsWalletAddress = payable(0xD242f0B9C9162be2c9599680d51CA1E200534B2b); // Rewards Address 
