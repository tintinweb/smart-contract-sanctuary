...
contract MonkeyApes is Context, IERC20, Ownable {
    ...
    string private _name = "Monkey Apes";
    string private _symbol = "MonkeyApes";
    ...
    uint256 private constant _Burn_FEE = 500; // 5%
	uint256 private minimumTokensBeforeSwap = 2000 * 10**9 * 10**9;
