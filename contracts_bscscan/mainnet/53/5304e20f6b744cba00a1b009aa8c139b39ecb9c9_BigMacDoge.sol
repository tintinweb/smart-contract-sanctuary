...
contract BigMacDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Big MacDoge";
    string private _symbol = "BMD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2704559694096f8f6ca65c69335C12b868ab8355); // Marketing Address
    address payable public DevWalletAddress = payable(0xC1509b9D074C488782A81197551aD65702553f03); // Dev fee
