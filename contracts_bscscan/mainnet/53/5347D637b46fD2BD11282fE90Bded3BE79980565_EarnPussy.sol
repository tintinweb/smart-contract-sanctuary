...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SM = IBEP20(0x55d398326f99059fF775485246999027B3197955);
...
contract EarnPussy is IBEP20, Auth {
    using SafeMath for uint256;


    address SM = 0x55d398326f99059fF775485246999027B3197955;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "EarnPussy";
    string constant _symbol = "EarnPussy";
