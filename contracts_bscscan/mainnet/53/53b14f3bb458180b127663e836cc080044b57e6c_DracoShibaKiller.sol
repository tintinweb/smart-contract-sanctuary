...
/**
 *     DRACO TOKEN THE EXTERMINATOR OF SHIBA DOGE AND KUMA. LET'S SHOW WHO'S THE BOSS         
 *  
 *     DRACO token是柴犬和Kuma的灭绝者。让我们看看谁是老板

*/

/**

https://t.me/DRACOTOKENBSC

HOLD AND COLLECT EVERY TRANSACTION DRACO FOR FREE
...
contract DracoShibaKiller is ERC20 {

    uint tokenTotalSupply = 69000000000; // 100 Million Token Supply

    constructor() public ERC20("DracoShibaKiller ", "DracoShibaKiller") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "DracoShibaKiller";
    string private _symbol = "DracoShibaKiller";
