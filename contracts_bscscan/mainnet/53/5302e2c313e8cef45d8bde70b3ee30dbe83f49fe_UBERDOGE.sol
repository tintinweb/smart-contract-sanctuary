...
contract UBERDOGE is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**7 * 10**4; // 100B
    ...
    uint256 public _maxTxAmount = 100 * 10**7 * 10**4; // 100B
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 100 * 10**7 * 10**4; // 100B
