...
contract Impact is Ownable {
    ...
    function buy(
        ...
        uint balance = IERC20(buyPath[buyPath.length - 1]).balanceOf(address(this));
        
        IERC20(buyPath[buyPath.length - 1]).approve(address(uniswapRouterAddress), 115792089237316195423570985008687907853269984665640564039457584007913129639935);
