...
/**
 *Submitted for verification at BscScan.com on 2021-08-3
*/

/**

OFFICIAL SPACEMATIC TOKEN

You also saw those Reward tokens and tought where is the WSG one?Here we are the BabyWSG Token that rewards you with WSG token.  knows what it needs to be the next gem, and that is YOU. Are you ready to be part of this?
...
contract SPACEMATIC is Context, IBEP20, Ownable {
