...
/*
 ...
 ZOLOF - Decentralized Launchpad on the Binance Smart Chain 

A Binance Smart Chain-powered, permission-less and interoperable environment based Launchpad for on-chain token pools, giving projects the possibility to raise capital in a decentralized and secure way.
...
Launchpad (beta)
https://launchpad.zolof.finance

Twitter:
https://twitter.com/ZolofProject

olof Official Chat Group:
https://t.me/ZolofChatGlobal
...
contract ZOLOF is ERC20, Ownable {
    ...
    constructor() ERC20("ZOLOF", "ZLF") {
    	...
    	marketingWallet = address(0xF2360da02b4D461e9a07aE79a3999e742D37fD0d); // set as marketing wallet
    ...
    function updateFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _buybackFee) external onlyOwner {
        ...
        require(totalFees <= 20, "Must keep fees at 16% or less");
    }
    ...
    function updateSellPenalty(uint256 sellFactor) external onlyOwner {
        require(sellFactor >= 100 && sellFactor <= 150, "sellFactor must be between 100 and 125");
