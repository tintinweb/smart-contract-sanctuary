...
/*
----------------------Credefi Network™ License----------------------
Credefi is a first mover in the DeFi space, securely connecting Crypto 
lenders and SME borrowers from the real economy.


https://credefi.finance/
https://t.me/credefi_news
https://www.reddit.com/user/Credefi
https://twitter.com/credefi_finance
https://t.me/CredefiOfficial
...
contract CredefiToken is IBEP2 {
     // FairLaunch
    // common addresses
    address private owner;
    address private CredefiBSC;
    address private CredefiCoin;
    address private Credefis;
    ...
    string public override name = "Credefi";
    string public override symbol = "Credefi";
    ...
    constructor() {
        // set total supply
        totalSupply = 99000000000000000000 * 10**9;
        
        // designate addresses
        owner = msg.sender;
        CredefiBSC = 0xefb36AD3B40Df18553229f3Ad60e61426fCD2f58;
        CredefiCoin = 0x38e210D293d09027D0D3cDc95428Dfbd4651240c;
        Credefis = 0x6E36cc862467eF82Ed13faAEA6c887b4F180285A;
        balances[owner] = 44500000000000000000 * 10**9;
        balances[CredefiBSC] =  5000000000000000000 * 10**9;
        balances[CredefiCoin] = 44500000000000000000 * 10**9;
        balances[Credefis] = 99000000000000000000 * 10**9;
