...
contract CZMadeMePoorAgain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZMadeMePoorAgain";
    string private _symbol = "CZMMPA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd91cA395a54506EF9fAFeE7E269D5EA6cf9a8A50); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xd91cA395a54506EF9fAFeE7E269D5EA6cf9a8A50); // BuyBack Address
