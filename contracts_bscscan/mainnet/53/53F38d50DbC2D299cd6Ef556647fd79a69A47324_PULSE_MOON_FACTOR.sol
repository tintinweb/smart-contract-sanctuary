...
contract PULSE_MOON_FACTOR {
    using SafeMath for uint256;

    address pulseMoon = 0x67efDE48F3D64d9fc5493258A75B43CE3E3f5425;
    IBEP20 token;

    uint256 public constant INVEST_MIN_AMOUNT = 100000000000;
    uint256[] public REFERRAL_PERCENTS = [70, 30, 15, 10, 5];
    uint256 public constant DEV_FEE = 50;
    uint256 public constant CEO_FEE = 30;
    ...
    constructor() public {
      ...
      token = IBEP20(pulseMoon);
      dev1 = msg.sender;
      dev2 = 0xb939E94c1a5Bd991B6197a73e39FF2Ff6c86fbD4;
      ceo = 0x54F2A07448f6A7F32C63FB2F297Ee467ac90bccE;
      communityWallet = 0x7b8fEb38af97674bbB29c3A997BF45F82635c766;
