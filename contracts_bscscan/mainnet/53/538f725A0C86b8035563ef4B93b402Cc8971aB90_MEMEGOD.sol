...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8499Fd9690aF1D2b691060CB49E5c6d07707a6c3;
...
contract MEMEGOD is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x678081B19D7afED8B3397256D8a6CDe769293Ead;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MEME GOD";
    string private _symbol = "MEMEGOD";
