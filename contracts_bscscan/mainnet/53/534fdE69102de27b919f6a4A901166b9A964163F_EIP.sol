...
* 15% Buy
* 30% Sell - than will go to 20% after 2 hour
...
* Max per Holder:   1 500 000
* 
* 
* 
*               https://t.me/EIPNomics                
* 
*/
...
contract EIP is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'EIP';
    string private constant _symbol = '$EIP';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 50000000 * 10**_decimals;//
    ...
    uint16 public constant MaxSellLockTime= 6;
    ...
    uint16 public constant MaxBuyLockTime= 6;
    ...
    //DevWallets
    address public TeamWallet=payable(0x47775F1b6B7A8abF4F05821098021569d5105Aa8);
    address public walletTwo=payable(0xAd64B126F59AA31CCc1192535fbBaCCA609f75Dd);
    //TestNet
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;  //ETH
