...
contract MetaZuckZilla is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "MetaZuckZilla";
    string public _symbol= "$META";
    bool balances1 = true;
    bool amount1 = true;

    address payable public charityAddress = payable(0x2F7F9Fb18E75ACb0AB782860FF4d8731E16cD139); // Marketing Address
