...
/*
 *  LORAN Token
 *  Current website: https://lorantoken.com
...
contract LORANDividendDistributor is IDividendDistributor {
...
contract LORAN is IBEP20, Auth {
    ...
    string constant _name = "The LORAN Token";
    string constant _symbol = "THELORAN";
    ...
    */
    ...
    LORANDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new LORANDividendDistributor(address(router));
    ...
    function setDistributor(LORANDividendDistributor dist)external authorized {
        distributor = dist;
    }
