...
contract TeslaKeyBSC is Context, IERC20, Ownable {
    ...
    string private _name = "Tesla Key BSC";
    string private _symbol = "TeslaKey";
    ...
    uint256 public _taxfee = 5;
    address public taxwallet = 0x0Ec95e3165a724937683481FB6DF9b67DA30AE07;
    uint256 private _previoustaxfee = _taxfee;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 marketingAmt = amount.mul(_taxfee).div(100);
        ...
        _transferStandard(sender, taxwallet, marketingAmt);
