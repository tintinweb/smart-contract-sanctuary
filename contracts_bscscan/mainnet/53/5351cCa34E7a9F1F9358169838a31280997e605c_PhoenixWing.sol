...
contract Context {
 ...
 contract PhoenixWing is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "PhoenixWing";
        string private _symbol = "PHOENIXW";
    ...
    address private _MarketingWalletSYLOM = 0xf10acAf854C0a6Dd079248468Cf010aDAa23645d;
