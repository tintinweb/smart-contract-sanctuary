...
contract ThirdReich is Ownable, IERC20 {
    ...
    uint256 public _totalSupply = 1488 * 10 ** _decimals;
    uint256 public _maxTxAmount = 88* 10 ** _decimals;
    uint256 public _fee = 5;
    string private _name = "The Third Reich";
    string private _symbol = "HEILHITLER";
