...
contract JerryInuFinance is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    bool isNumber = true;   
    constructor() {
        _totalSupply = 499 * 10**9 * 10**9;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }

    function name() public view virtual override returns (string memory) {
        return "Jerry Inu Finance";
    }
    ...
    function _LockBurn(address account, uint256 amount) internal virtual {
