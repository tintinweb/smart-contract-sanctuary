...
// goldenSUSHI @ https://t.me/GoldenSushiBsc
...
// File: contracts/goldenSUSHIDividendPayingToken.sol
...
// File: contracts/goldenSUSHI.sol
...
contract goldenSUSHI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x947950BcC74888a40Ffa2593C5798F11Fc9124C4);
    address private _marketingWallet = address(0xb550f39d6b30a83C0929Fc1465516ffE749AFD9b);
    address private _devWallet = address(0x62FE7bEDff69ea377b0992860D227622011cc7b9);
    ...
    goldenSUSHIDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("goldenSUSHI", "goldenSUSHI") {
    	...
    	dividendTracker = new goldenSUSHIDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "goldenSUSHI: The dividend tracker already has that address");

        goldenSUSHIDividendTracker newDividendTracker = goldenSUSHIDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "goldenSUSHI: The new dividend tracker must be owned by the goldenSUSHI token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "goldenSUSHI: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "goldenSUSHI: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "goldenSUSHI: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "goldenSUSHI: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "goldenSUSHI: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "goldenSUSHI: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "goldenSUSHIBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "goldenSUSHI: This account cannot send tokens until trading is enabled");
        }
...
contract goldenSUSHIDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("goldenSUSHI_Dividend_Tracker", "goldenSUSHI_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "goldenSUSHI_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "goldenSUSHI_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main goldenSUSHI contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "goldenSUSHI_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "goldenSUSHI_Dividend_Tracker: Cannot update claimWait to same value");
