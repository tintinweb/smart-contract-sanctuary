...
contract BabyNekoa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyNeko";
    string private _symbol = "BabyNeko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x400A72684DF541f80057096951Eb5761cc5a2Dd2); // Marketing Address
    address payable public teamWalletAddress = payable(0xb2241B031206b6a66Eb95D18eA476378860bF7dA); // Team Address
