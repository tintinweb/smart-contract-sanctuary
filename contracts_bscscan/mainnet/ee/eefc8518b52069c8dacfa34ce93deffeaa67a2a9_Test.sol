...
contract Test is ERC20, Ownable {
    ...
    constructor() ERC20("Test", "Test") {
    	...
    	buyBackWallet = 0x669D5244EC1EC82B1C6aC7BC8332adb6c4E44991;
...
contract TestDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 6 && newClaimWait <= 86400, "Test_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
