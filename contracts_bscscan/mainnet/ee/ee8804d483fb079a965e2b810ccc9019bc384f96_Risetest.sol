...
Risetest is built upon the fundamentals of Buyback and increasing the investor's value
    
Main features are
    
1) 
2) 15% buyback and marketing tax is collected and 5% of it is sent for marketing fund and othe 10% is used to buyback the tokens
...
contract Risetest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xED6Fa3440BB33dce4601D5E6E7206720F5a20dF7); // Marketing Address
    ...
    string private _name = "Risetest";
    string private _symbol = "RISET";
