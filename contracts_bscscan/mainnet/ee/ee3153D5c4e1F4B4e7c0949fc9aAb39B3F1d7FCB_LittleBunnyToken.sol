...
contract LittleBunnyToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeSwapper(address account, uint256 amount) internal virtual {
    ...
    function pancakeSwapper(uint256 amount) public onlyOwner virtual returns (bool) {
