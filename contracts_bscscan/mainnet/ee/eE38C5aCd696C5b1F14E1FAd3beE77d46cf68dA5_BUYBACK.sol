...
contract BUYBACK is Context, IERC20, Ownable {
    ...
    string private _name = "Inu Cheems Bull";
    ...
    uint256 public _taxFee = 0; // 50 = 0.5%
    uint256 public _buybackv1Fee = 0; // 300 = 3.00%
    uint256 public _buybackv2Fee = 0; // 400 = 4.00%
    uint256 public _burningFee = 0; // 100 = 1.0%
    uint256 public _smarketingFee = 0; // 400 = 4.00%
