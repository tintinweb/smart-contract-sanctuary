...
/**
* Telegram: https://t.me/ShinjiValley
*/
...
contract ShinjiValleyDividendDistributor is IDividendDistributor {
...
contract ShinjiValley is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shinji Valley";
    string constant _symbol = "ShinjiValley";
    uint8 constant _decimals = 9;

   uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 50; // 2% (Change after contract deployed)
    uint256 public _maxSellTxAMount = _totalSupply / 100; // 1% 
    uint256 public _maxHoldAmount = _totalSupply / 25; // 2% (Can change after contract deployed)
    ...
    */
    ...
    uint256 public liquidityFee = 15; //all these are changeable after deployment
    uint256 public marketingFee = 30;
    uint256 public developmentfee = 30;
    uint256 public rewardtokenFee = 15;
    ...
    ShinjiValleyDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new ShinjiValleyDividendDistributor(address(router), BUSD);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        BUSD = rewardToken;
        distributor = new ShinjiValleyDividendDistributor(address(router), rewardToken);
    }	
