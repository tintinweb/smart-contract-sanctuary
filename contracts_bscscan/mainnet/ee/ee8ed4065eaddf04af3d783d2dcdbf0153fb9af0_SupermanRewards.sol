...
/**
SUPERMAN REWARDSTOKEN 

HOLD AND WIN BUSD AND USDT JUST HOLDING

STEALLAUNCH

https://t.me/SUPERMANREWARDS

LPWILL BE LOCKED IN DXSALE FOR 6 MONTHS

ENJOY LAST GENERATION DOUBLE REWARDS
*/
...
contract SupermanRewards is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;

    string constant _name = "SupermanRewards";
    string constant _symbol = "SUPRS";
