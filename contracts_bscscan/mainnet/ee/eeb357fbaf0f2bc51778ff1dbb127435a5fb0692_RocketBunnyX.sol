...
Have you ever wanted to visit the stars and earn passive income at the same time?! Rocket Bunny X is here to offer you a ticket to the moon! $RBX Is a BSC token, which provides passive income to its holders by distributing 4% in BUSD rewards 💰

💎 Marketing Plan after launch 💎                                                                                                                                                                                                                     
📲 BSC/ Dextools social info
⏰ Reddit hot topic trending daily 
📸 Twitter/ Youtube promo 
📍 Poocoin Ads
👍 All coin listing sites upvoted
✅ CG Listing 

TG 📲: https://t.me/rocketbunnyx
Web 💻: https://rocketbunnyx.com/
*/
...
contract RocketBunnyX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Rocket Bunny X", "RBX")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setCD(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        function setBUSDReward(uint256 value) external onlyOwner{
