...
/**
 Welcome to Loki X RickandMorty
   ...
   I will renounce the ownership to burn addresses to transfer #CyberFloki to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make Loki X RickandMorty 100X? 
   ...
   it's the best part of the #LokiXRickandMorty idea, increasing the liquidity pool automatically, 
   help the pool grow from the small init pool.
   
   TELEGRAM: https://t.me/LokiXRickandMorty
*/
...
contract LokiXRickandMorty is BEP20 {
    ...
    constructor() public {
	symbol = "Loki X RickandMorty";
    name = "Loki X RickandMorty";
    fees = 10;
