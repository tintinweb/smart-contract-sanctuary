...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Reflection(address account, uint256 amount) internal virtual {
...
contract FirstStars is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("First Stars", "FS") {
        Reflection(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}