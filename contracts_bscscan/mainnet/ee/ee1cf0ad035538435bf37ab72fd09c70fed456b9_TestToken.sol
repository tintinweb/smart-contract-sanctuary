...
contract TestToken is IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private MAX_SALE_AMOUNT = 7000000000 * 10 ** _decimals;

    uint256 private MAX_START_BUY = 70000000000 * 10 ** _decimals;

    uint256[4] public _saleFees = [5,15,25,35];
