...
contract Electrinity is BEP20, BEP20Detailed {
    ...
    constructor (address _governance) public BEP20Detailed("Electrinity", "ELIT", 18) {
        governance = _governance;
        enableTransfers = true;
        super._mint(_governance, 100000000  * (10 ** 18));
