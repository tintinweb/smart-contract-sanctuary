...
/**
$HULK will smash every single red candle
Transparent devs, clean track record!

Tokenomics:
1 quadrillion total supply

Taxes:
 6% Buy Back | 2% Liquidity | 4% Marketing
 1% Max Txn | 2% Max Wallet
 
 TG: https://t.me/MiniHulkBSC
 Website: https://minihulkbsc.com/
...
contract MiniHulk is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingAddress = payable(0xEA7d0C552760FB8938b2061E66ac1c73bd8BE9Dc); // Marketing Address
    address payable public devAddress = payable(0x3747e70149dBb6F99Cc8a0288c19a75C71653f39); // Dev Address
    ...
    function _transfer(
        ...
        if (to != address(this)  && to != address(0) && to != uniswapV2Pair && to != marketingAddress){
