...
contract BaileyInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x9DD5D643D33BE41bc43E81ac413D08B62Fe71662;
 
    string constant _name = "Bailey Inu";
    string constant _symbol = "BAILEY";
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit isTx(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event isTx(uint256 amountBNB, uint256 amountBOG);
}