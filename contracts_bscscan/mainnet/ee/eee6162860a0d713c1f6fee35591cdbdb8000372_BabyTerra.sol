...
/**
   ...
   Welcome to BabyTerra
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyTerra
   ...
   I will renounce the ownership to burn addresses to transfer #BabyTerra to the community, make sure it's 100% safe.
   ...
   it's the best part of the #BabyTerra idea, increasing the liquidity pool automatically, 
...
contract BabyTerra is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Terra";
