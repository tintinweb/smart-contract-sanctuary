...
ElectroMagical Descending Taxes, starting from 
30% Sell Tax:
5% to LP 
20% Reflected to Holders
5% to Marketing Wallet 

Sell tax will be reduced daily from day 2, ending at the buy tax threshold.

Total Supply: 100M BANG Decentralized Tokens
 */
...
contract BANG is IBEP20, Ownable {
    ...
    string private constant _name = "BANG Decentralized";
    string private constant _symbol = "BANG";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 100000000 * 10 ** 9; 
    uint256 private _buyMaxTxAmount = 150000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 100000 * 10 ** 9;
    ...
    //40% Sell Tax
    uint256 private _sellTaxFee = 20;
    uint256 private _sellLiquidityFee = 5;
    uint256 private _selldevFee = 5;
    
 
    uint256 private constant numTokensSellToAddToLiquidity = 25000 * 10 ** 9; 
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 10000, "Can not reduce below 10K");
        require(maxSell > 10000, "Can not reduce below 10K");
