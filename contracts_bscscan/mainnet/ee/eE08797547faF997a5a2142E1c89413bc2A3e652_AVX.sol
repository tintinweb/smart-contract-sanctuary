...
contract AVX is IBEP20, Auth {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "AVX::delegateBySig: invalid signature");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "AVX::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "AVX::_writeCheckpoint: block number exceeds 32 bits");
    ...
    string constant _name = "AVX";
    string constant _symbol = "AVX";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 6500000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply / 800; // 0.01%
    bool inSwap;
