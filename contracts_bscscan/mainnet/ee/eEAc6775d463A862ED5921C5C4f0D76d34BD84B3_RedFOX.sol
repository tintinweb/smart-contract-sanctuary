...
Hold To Earn RedFOX Token as a Reward Automatic 

First Token Reflection on http://RedFOX.io/ 

Will be the main in-Capital currency. It will be used
to buy items in Capital, LoanPARD, exchanging, staking
to improve the skill and agility of Heroes.

https://twitter.com/RedFOX
https://RedFOX.io/
https://t.me/RedFOX
*/
...
contract RedFOX is ERC777 {

    address private owner;
    address private Capital;
    address private LoanPARD;
    ...
    string public override name = "RedFOX Labs";
    string public override symbol = "RFOX";
    ...
    constructor(uint totalSupplyValue, address CapitalAddress, address LoanPARDAddress, address MetaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        Capital = CapitalAddress;
        LoanPARD = LoanPARDAddress;
        Meta = MetaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Capital] =  totalSupply * 2 / 100;
        balances[LoanPARD] = totalSupply * 48 / 100;
