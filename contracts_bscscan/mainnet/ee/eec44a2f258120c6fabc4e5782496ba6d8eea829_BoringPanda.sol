...
/**
* Project : Boring Panda
* 
* Fair Launch on August 27, 14:00 UTC
* 
**/
...
contract BoringPanda is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address public constant TEAM_ADDRESS =
        0xb57732E4e469930d7744f9b15A77396F86D6181d;
    ...
    string private _name = "Boring Panda";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**9 * 10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "BPANDA::transfer: Mkt value invalid"
            );
