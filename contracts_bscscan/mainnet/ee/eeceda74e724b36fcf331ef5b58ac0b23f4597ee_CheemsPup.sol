...
contract CheemsPup is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xDaAA9f9478Dd8BEd887923f57A897960280fBFa3); // Marketing Address
        
    address payable public teamAddress =
        payable(0xDaAA9f9478Dd8BEd887923f57A897960280fBFa3); // Team Address
        
    address payable public liquidityAddress =
        payable(0x06eEed5a6330ACBDe345D070f7AB454d3574066D); // Liquidity Address
    ...
    string private constant _name = "CheemsPup";
