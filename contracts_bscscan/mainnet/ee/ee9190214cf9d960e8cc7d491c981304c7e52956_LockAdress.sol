...
contract LockAdress is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LockAdress";
    string private _symbol = "LOCKAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3cC5bF8C77176141c5F7F3203685e0b0BEcb3B48); // Marketing Address
    address payable public BuybackWalletAddress = payable(0xb7846CCB165F0d5f0B941D73b3dD630fD86b4B10); // Buyback Wallet Address
    ...
    function BlockAdress(address account, bool newValue) public onlyOwner {
