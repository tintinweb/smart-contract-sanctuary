...
// HswToken with Governance.
contract HswToken is BEP20("HiSwap Token", "HSW") {
    ...
    function delegateBySig(
        ...
        require(signatory != address(0), "c::delegateBySig: invalid signature");
        require(
            nonce == nonces[signatory]++,
            "HSW::delegateBySig: invalid nonce"
        );
        require(now <= expiry, "HSW::delegateBySig: signature expired");
        ...
        returns (uint256)
    {
        require(
            ...
            "HSW::getPriorVotes: not yet determined"
        );
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying HSW tokens (not scaled);
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "HSW::_writeCheckpoint: block number exceeds 32 bits"
        );
