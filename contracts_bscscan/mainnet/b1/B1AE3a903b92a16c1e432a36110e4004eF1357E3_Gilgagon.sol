...
contract Gilgagon is Context, IRC20, Ownable {
   ...
   address public _MarketingAddress = 0x9FDa5DdaB9887Bd912890C038BB642a34451c1D4;
    ...
    uint256 private _tTotalz = 1000 * 10**12 * 10**9;
    uint256 private _rTotalz = (MAX - (MAX % _tTotalz));
    uint256 private _tFeeTotalz;

    string private _namez = "Gilgagon";
    string private _symbolz = "Gigon";
    ...
    function _getCurrentSupply() private view returns(uint256, uint256) {
        uint256 rSupply = _rTotalz;
        uint256 tSupply = _tTotalz;      
        for (uint256 i = 0; i < _excluded.length; i++) {
            if (_rOwned[_excluded[i]] > rSupply || _tOwned[_excluded[i]] > tSupply) return (_rTotalz, _tTotalz);
