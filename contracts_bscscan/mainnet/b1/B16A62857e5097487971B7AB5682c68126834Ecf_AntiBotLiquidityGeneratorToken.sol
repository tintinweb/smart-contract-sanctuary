...
import "../antibot/IPinkAntiBot.sol";
import "../interfaces/IAntiBotLiquidityGeneratorToken.sol";

contract AntiBotLiquidityGeneratorToken is
  IERC20Upgradeable,
  OwnableUpgradeable,
  IAntiBotLiquidityGeneratorToken
{
  ...
  function initialize(
    ...
    pinkAntiBot.setTokenOwner(owner_);
    enableAntiBot = true;
