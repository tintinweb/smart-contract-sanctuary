...
Introducing Bitcoin Farm
The first token on the BSC smartchain to combine the rebase rewards with rewards.
Hold $BF and receive $BTC directly to your BEP-20 wallet as a reward for holding

TG: https://t.me/bitcoinfarmbsc
Website: https://bitcoinfarmbsc.com/
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
contract BF is IBEP20, Auth {
    ...
    string constant _name = "Bitcoin Farm";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7e4137eCB5385aBb07c1B024D5fbf2c422E912ed;
