...
/*
SlaughterFest is an Arena Style coin where selling is disabled on launch and enabled after a specific amount of time.

After 5 minutes selling is enabled with a ❌❌!!! 99% !!❌❌ tax going to rewards and liquidity.

Over the next 5 minutes, that tax slowly drops to 20%. 

So you have to gamble and figure out when is right to sell to make the most profit for the least tax, OR do you hold to the bottom and get rewards.

https://t.me/SlaughterFest
...
contract SlaughterFest is IBEP20, Ownable
{
    ...
    uint public BotCount;
    EnumerableSet.AddressSet private CaughtBotting;
    ...
    //Divider for Minimal sellLimit based on circulating Supply (2%)
    ...
    address public constant TeamWallet=0x409111394Ee65535320A6fF1FF5C34F7e9829157;
    ...
    function isBotting(address addr) public view returns (bool botting, uint256 count){
        return (CaughtBotting.contains(addr),BotCount);
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //BNB Autostake/////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////// 
   ...
   //withdraws all dividents of address
    ...
    function getDividends(address addr) private view returns (uint256){
        if(isExcludedFromStaking(addr)) return toBePaid[addr];
        return _newDividentsOf(addr)+toBePaid[addr];
    }

    function getDividendsOf(address addr) public view returns (uint256){
        uint256 amount=getDividends(addr);
        return amount;
    }
    ...
    function TeamSetTaxes(uint8 liquidityTaxes, uint8 stakingTaxes,uint8 buyTax, uint8 sellTax) public onlyTeam{
