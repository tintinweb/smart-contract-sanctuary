...
// CHANGE
contract SolidarityXRP is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SolidarityXRP";
    string constant _symbol = "SolidarityXRP";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xb44FaeDD86be47E18AeB7EC209B087d1353C42b7);
