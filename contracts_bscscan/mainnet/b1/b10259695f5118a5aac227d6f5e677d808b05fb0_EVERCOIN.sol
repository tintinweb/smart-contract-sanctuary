...
contract Ownable is Context {
    address private _owner = 0xa07d5A3193Af9C97DB4668d7484beA8154e1C7ec;
...
contract EVERCOIN is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xB56f760e549c1e0ecc06D486519F3f237AB0fA5C); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "EVER COIN"; // token name
    string private _symbol = "ERC"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 2160 minutes; // duration betweeen each buyback
    ...
    uint256 public _liquidityFee = 20; // liquidity fee 2%
