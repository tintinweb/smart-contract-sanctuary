 ...
 * Simply hold hungrydoge to join the journey and experience all of the benefit from hungrydoge.
 * 
 * 100% Unruggable
 * --------------- 
 ...
 * Marketing
 * ---------------
 * 1% will be sent to marketing Supermoonshiba.
 * 
 * Tokenomics
 * ----------
...
contract HungryDoge is Context, IERC20, Ownable {
    ...
    string private _name = "HungryDoge";
    string private _symbol = "HungryDoge";
    ...
    address public charityWallet = 0xBBC4ADCACeB528bE5Ec100FC01E3F6B5Eb2f8AC9;
