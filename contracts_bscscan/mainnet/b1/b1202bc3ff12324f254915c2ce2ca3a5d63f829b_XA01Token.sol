...
contract XA01Token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xb59611e112cA2171c16A89751b4AA3Dfb059A8Df); // Marketing Address
    address payable public charityAddress = payable(0xb59611e112cA2171c16A89751b4AA3Dfb059A8Df); // Charity/Dev Address
    ...
    uint256 private _tTotal = 1000000000000 * 10**18; // 1 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "XA01 metaverse";
    string private _symbol = "XA01";
    ...
    uint256 private minimumTokensBeforeSwap = 10000000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 300000000000000000000000; // 300,000; token will be given on airdrop
    ...
    uint256 private salePrice = 1000000000000;// 0.01*100000000000=10,000,000 token for 0.01 bnb (set as per requirements)
