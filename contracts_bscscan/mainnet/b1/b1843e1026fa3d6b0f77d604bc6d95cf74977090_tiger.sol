...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #tiger 

    I make this #tiger to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/tigerTokenBSC
   ...
   I will renounce the ownership to burn addresses to transfer #tiger to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #tiger 10000000X? 
   ...
   it's the best part of the #tiger idea, increasing the liquidity pool automatically, 
...
contract tiger is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 500000000 * 10**8 * 10**9;
