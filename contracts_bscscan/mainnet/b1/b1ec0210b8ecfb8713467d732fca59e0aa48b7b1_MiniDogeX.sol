...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x1F6819D87bD6e10cae34883175232EE9774e00b2);
...
contract MiniDogeX is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DogeXcash";
    string constant _symbol = "DXC";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x1F6819D87bD6e10cae34883175232EE9774e00b2;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x7b7BBD0dB3E7AfBA954C830Fc8Ebd233580A9497;
