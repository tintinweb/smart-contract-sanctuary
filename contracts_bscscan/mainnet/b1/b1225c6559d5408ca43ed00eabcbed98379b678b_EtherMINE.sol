...
🏵 💰 Intended to mine ethurium using fund raised by project & redistribute mining profit to our holders 💝 🏵

✅ 100% Locked liquidity 🔐
✅ Not an another shit coin ☺️
✅ Working Website & Twitter
✅ Dedicated Team ⭐️
...
🛍 1000 trillion supply
🔥 15% supply Burn After launch

⚙ Tokenamics 
💰 10% tax on buy & sell
💰 4% auto liquidity fee
💰 4% project development fee
💰 2% reward to holders in $ETH

website : https://ethermine.cc
telegram : https://t.me/etherminebsc
*/
...
contract EtherMINE is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100000000 * 10**7 * 10**4; // 10B 
    ...
    uint256 public _maxTxAmount = 100000000 * 10**7 * 10**4; // 10B 
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 100000000 * 10**7 * 10**4; // 10B
