...
contract SafeEarth is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**5 * 10**4;
    ...
    uint256 public _maxTxAmount = 5000000 * 10**5 * 10**4;
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10**5 * 10**4;
