...
/**
   Welcome to Spacexrocket

   Telegram : https://t.me/spacexrocket
...
contract SpaceXRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x60e933377fc16C1383C35490ec96bE48BcC6Bae4); // Marketing Address
    ...
    string private _name = "SPACE X ROCKET";
    string private _symbol = "SPXROC";
    ...
    uint256 public _maxTxAmount = 100000000 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = 4000000 * 10**6 * 10**9; 
    uint256 private buyBackUpperLimit = 1000000000 * 10**18;
