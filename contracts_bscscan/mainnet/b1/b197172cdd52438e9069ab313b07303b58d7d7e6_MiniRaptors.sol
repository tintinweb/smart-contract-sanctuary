...
/**
 *https://t.me/MegalodonDEVcall
*/

/**
    
 
   Welcome to MiniRaptors
   
   This is a community token. If you want to create a telegram I suggest to name it to @MiniRaptors
   ...
   I will lock. 100% liquidity LPs to lock addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #MiniRaptors to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 10% total supply to the pool
   Can you make #MiniRaptors 10000X? 
   ...
   it's the best part of the #MiniRaptors idea, increasing the liquidity pool automatically, 
...
contract MiniRaptors is Context, IERC20, Ownable {
    ...
    string private _name = "MiniRaptors";
    string private _symbol = "MiniRaptors";
    ...
    uint256 private numTokensSellToAddToLiquidity = 3000000000000000000000000 * 10**18;
