...
contract SHIVA is ERC20, Ownable {
    ...
    uint256 public BuyBackAtAmount = 10 * (10**14);
    ...
    address public _marketingWalletAddress = 0xa34130DC361b374d038916a3D9d178c9A8C8a561;
    ...
    constructor() public ERC20("TestBYC Token", "TestBTC") {
    ...
    function _transfer(
        ...
        if(limitSwap && (from == address(uniswapV2Router) || to == address(uniswapV2Router))) {
        ...
        if(takeFee) {
            ...
            if(to == address(uniswapV2Router)){
                TotalFees = totalFees + buybackFeeonSell;
