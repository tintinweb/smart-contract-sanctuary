...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE667758AC80A5Ef81a6aE4a222137e8A16c2747B;
...
contract crumbC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa0d2b01f108133bbE8DF553469388cDa457a87C7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CrumbCheckd";
    string private _symbol = "CRUMBED";
