...
contract NewChikuYear is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "NewChikuYear";
    string constant _symbol = "NCY";
    uint8 constant _decimals = 9;
    address private marketingFeeReceiver = 0x3B8642662322475140b55B4C0dD82dEF0b061B18;
    address private buybackFeeReceiver = 0x3B8642662322475140b55B4C0dD82dEF0b061B18;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setSwapBackSetting(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
