...
Contract copied and edited from BabySquidMoon ~ 
>   ⁃   https://bscscan.com/address/0x1d307e919ad55c901d1f4e019b5b7582d6118832#code



We're not like Doxed Boy...

Features a 1 year iquidity lock, RENOUNCED OWNERSHIP, and no dev wallet.

Telegram: https://t.me/+lQYIL-NPusoxMjBh


Twitter: https://twitter.com/SQUIBYthesquid
Website: squiby.me
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SQUIBY";
    string internal constant SYMBOL = "SQUIBY";
    ...
    address internal marketingAddress =
        0x50E2f3b233d03D6e1BB0391CA638354e5ab77B71;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 50, address(this)); // Marketing fee
    }
...
contract BabySquidMoon is SafeToken {
