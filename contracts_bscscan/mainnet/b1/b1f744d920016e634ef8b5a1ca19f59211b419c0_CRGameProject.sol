...
/*
Telegram: @PiNetworkMainet_Official
Channel: @PiNetworkMainet_Channel

It's great that the Pi Network Mainet project has officially had a Telegram community and super good updates.

The First Digital Currency You Can Mine On Your Phone
Start mining cryptocurrency today with our free, energy-light mobile app. 
...
contract CRGameProject is Context, IERC20, Ownable {
    ...
    string private _name = "CRGameProject";
    string private _symbol = "CRGP";
