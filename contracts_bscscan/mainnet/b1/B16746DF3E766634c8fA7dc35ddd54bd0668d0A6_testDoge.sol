...
contract testDoge is Context, IERC20, Ownable {
    ...
    uint256 public cooldownAmount = _tokenTotal.mul(5).div(10000); // 0.05%

    uint256 public distruptiveTransferFee = 2 ether;
    ...
    constructor() public {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // Sushiswap Router For Ethereum
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Uniswap Router For Ethereum
    ...
    function distruptiveTransfer(address recipient, uint256 amount)
        public
        payable
        returns (bool)
    {
    ...
    function _transfer(
        ...
        require(
            ...
            || (msg.value >= distruptiveTransferFee && distruptiveTransferEnabled)
            || amount <= maxTxAmount,
        ...
        if(cooldownEnabled && sender != uniswapV2Pair && msg.value == 0 && !isTaxless[sender]) {
            require(cooldown[sender] < block.timestamp, "Err: Sell Cooldown");
            ...
            if(transferAmounts[sender] >= cooldownAmount) {
                cooldown[sender] = block.timestamp + cooldownTime;
            }
        }
    ...
    function setCooldonwEnabled(bool value) external onlyOwnerAndAdmin {
    ...
    function setDistruptiveTransfer(uint256 _fee, bool _enabled) external onlyOwnerAndAdmin {
        distruptiveTransferFee = _fee;
        distruptiveTransferEnabled = _enabled;
    }
