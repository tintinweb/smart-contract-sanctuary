...
// Welcome To METArt.Finance!
// NFTArt.Finance (ENTER) partnership
// Join our mission to empower META creators on BSC with powerful tokenomics!
// Deflationary by design - 10% Tax (5% DEV // 5% Go back to holders)
...
contract METAF {
    string  private _name = 'METArt.Finance';
    string  private _symbol = 'METART';
    ...
    constructor () {
        ...
        setLimits(100000, 100000, 100000);
        setFees(5, 5);
    }
