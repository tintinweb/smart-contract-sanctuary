...
contract BINADOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BinaDoge";
    ...
    function triggerDogeBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
