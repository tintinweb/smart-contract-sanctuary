...
// https://t.me/dogeeSUSHI

//Earn pyram while holding onto dogeeSUSHI!
...
// File: contracts/dogeeSUSHIDividendPayingToken.sol
...
contract dogeeSUSHI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x947950BcC74888a40Ffa2593C5798F11Fc9124C4);
    address private _liqAdd = address(0x62F22ab71b7118F9631e8b4f362805755C9b3B2F);
    address private _LPadd = address(0x68CbdAffd45943F732e49187695e7BCDC729DFCB);

    bool private swapping;
    bool public airdrop;

    dogeeSUSHIDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("dogeeSUSHI", "dogeeSUSHI") {
    	...
    	dividendTracker = new dogeeSUSHIDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "dogeeSUSHI: The dividend tracker already has that address");

        dogeeSUSHIDividendTracker newDividendTracker = dogeeSUSHIDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "dogeeSUSHI: The new dividend tracker must be owned by the dogeeSUSHI token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "dogeeSUSHI: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "dogeeSUSHI: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "dogeeSUSHI: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "dogeeSUSHI: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "dogeeSUSHI: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "dogeeSUSHI: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "dogeeSUSHI: This account cannot send tokens until trading is enabled");
        }
...
contract dogeeSUSHIDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("dogeeSUSHI_Dividend_Tracker", "dogeeSUSHI_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "dogeeSUSHI_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "dogeeSUSHI_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main dogeeSUSHI contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "dogeeSUSHI_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "dogeeSUSHI_Dividend_Tracker: Cannot update claimWait to same value");
