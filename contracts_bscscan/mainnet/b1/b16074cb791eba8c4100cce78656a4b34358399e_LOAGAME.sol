...
/**
    ...
    4% of each transaction to the Reward Pool wallet
...
contract LOAGAME is Context, IBEP20, Ownable {
    ...
    string private _name     = "LOAGAME";
    string private _symbol   = "LOAG";
    ...
    uint256 public _percentageOfLiquidityForMarketing = 80; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        if (marketingFee > 0) {
            payable(0x1c89a7deB53615508376e35a72B877d4E3C84e85).transfer(marketingFee);
            emit MarketingFeeSent(0x1c89a7deB53615508376e35a72B877d4E3C84e85, marketingFee);
        }
