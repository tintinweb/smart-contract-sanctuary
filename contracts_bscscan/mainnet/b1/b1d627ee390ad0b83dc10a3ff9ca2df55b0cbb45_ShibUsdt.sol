...
Introducing SHIBA USDT
The SHIBA token on the BSC smartchain to combine rebase with rewards.
Hold $SHIBUSDT and receive $USDT directly to your BEP-20 wallet as a reward for holding

Website: https://ShibUsdt.net
TG: https://t.me/ShibUsdtOfficial
Twitter: https://twitter.com/ShibUsdtBSC
*/
...
contract ShibUsdt is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibUsdt";
    string constant _symbol = "$SHIBUSDT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5c294E2b36B82761cd796237A6A6D55F58a5BaA0;
