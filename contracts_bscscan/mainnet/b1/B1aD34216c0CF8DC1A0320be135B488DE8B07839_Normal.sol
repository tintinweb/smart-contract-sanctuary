...
contract Ownable is Context {
    address private _owner = 0x7af664037b0Bd0BF9F60D2503FeA2033646FDE7e;
...
contract Normal is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Normal"; // token name
    string private _symbol = "Normal"; // token symbol
