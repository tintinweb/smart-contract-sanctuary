...
contract shizilla is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xbeD0be063Fd2314Df0263fdf383853a81bB1Cc85); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xaB4eFC23F7e26e4b88502B02c93e9513C7911833); // buyback Address
    ...
    uint256 private _totalSupply            = 1 * 10**13 * 10**9;
    uint256 public _maxTxAmount             = 50 * 10**10 * 10**9;
    uint256 public _walletMax               = 500 * 10**12 * 10**9;
