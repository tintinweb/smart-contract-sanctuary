...
/* Tokenomics:
    *  10% TRX reflection
    *  5% marketing and buyback wallet
    *  Max wallet size of 3%
    *  Max Sell Amount 5,000,000,000 (0.5%)
...
contract EARNTRON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Earn Tron";
    string constant _symbol = "eTRON";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; //
    uint256 public maxBuyTranscationAmount = 50000000000 * (10**9);
    uint256 public maxSellTransactionAmount = 5000000000 * (10**9); // 0.5%
    uint256 public maxWalletToken = 30000000000 * (10**9); // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x147b84e91A48Ed70b40F8f3124b20ef0d8D7B733;
