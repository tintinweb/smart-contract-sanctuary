...
/**
 *Hello friends, enjoy your stay. DO NOT BUY UNLESS YOU KNOW WHAT THIS TOKEN IS ABOUT YOU STUPID MOONARCH JEETS
*/
...
contract ADARall is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ADARallDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0xC4f1ed6C6ced33B913d3d18945B45188BEFF04E2;
    address public _devWalletAddress = 0x33F306f84003d67D3C2a55592B624B000092F47F;
    ...
    constructor() public ERC20("ADARall", "$ADARALL") {

    	dividendTracker = new ADARallDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ADARallDividendTracker newDividendTracker = ADARallDividendTracker(payable(newAddress));
...
contract ADARallDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("ADARall Dividends", "ADARall_dividends") {
    	claimWait = 3600;
