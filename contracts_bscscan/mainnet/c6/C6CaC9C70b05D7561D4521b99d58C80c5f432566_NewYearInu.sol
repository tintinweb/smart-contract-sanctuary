...
/**
NewYearInu! The best Inu for 2022 

Website - newyearinu.xyz
Telegram - NewYearInuBSC
    
    3% Liqudity
    7% Marketing
    Max-Transacton/Wallet 3%
    No Team Tokens
...
contract NewYearInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xC0465101D1895c28dE44c2c0A0C4Cd91B4d1374D;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "NewYearInu";
    string constant _symbol = "NYI";
    ...
    uint8 public cooldownTimerInterval = 60; //this is in seconds. 
