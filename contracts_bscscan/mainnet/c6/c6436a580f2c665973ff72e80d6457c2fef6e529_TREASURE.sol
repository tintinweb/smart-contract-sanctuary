...
/**
    ...
    Welcome to TREASURE TOKEN
   
   This is a community token. TELEGRAM: @TREASURETOKEN
   ...
   I will renounce the ownership  #TREASURETOKEN to the community, make sure it's 100% safe.

   I will add 0.5 BNB.
   Can you make #TREASURETOKEN 10000X? 
   ...
   it's the best part of the #TREASURETOKEN idea, increasing the liquidity pool automatically, 
