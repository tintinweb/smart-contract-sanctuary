...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "HODL Doge";
    string internal constant SYMBOL = "HDGE";
    ...
    uint256 internal constant TOTAL_SUPPLY = 1000 * 10**12 * ZEROES;
     ...
     * See: `Liquifier`
     */
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY; // 0.1% of the total supply
    ...
    function _addFees() private {
        _addFee(FeeType.Rfi, 150, address(this) ); 
    }
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (!_isV2Pair(recipient)){ takeFee = false; }
        else {
            /**
...
contract HODLDoge is SafeToken{
