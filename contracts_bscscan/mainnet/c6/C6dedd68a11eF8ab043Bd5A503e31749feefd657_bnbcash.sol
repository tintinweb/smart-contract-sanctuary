...
contract bnbcash is AntiBots, IERC11, Sniper {
    ...
    uint256 private constant _allTotalSupply = 100000 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'UPTIME';
    string private _symbol = 'UPTIME';
