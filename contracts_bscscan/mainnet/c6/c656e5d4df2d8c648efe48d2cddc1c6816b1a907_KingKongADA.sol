...
King Kong ADA - Hold and get rewarded in $ADA
Total 15% Taxes
5% ADA REWARDS, 5% LP, 5% Marketing
Telegram: https://t.me/KingKongADA
Website: https://kingkongada.com/
...
// CHANGE
contract KingKongADA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "King Kong ADA";
    string constant _symbol = "$KingKongADA";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x4C48a9a9474372baaF811bfc281996A54dF7CE4A);
