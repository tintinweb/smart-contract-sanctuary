...
/**
 *  
 *      https://t.me/ElonsPetSquid
 * 
 * 
 *                                                                           
 *                                                     `..--..               
 *      3% Max wallet                                `so+////+so+/:/+o+`     
 *      30,000,000 Max transaction                  -d`    `-+oys+-.:Ns     
 *                                                   +s .:+oo/-.``  -h/d-    
 *      2% Reflections                              `yyo+/-``     `/h- +y    
 *      4% Marketing                             `-+o+-`         `+y.  `m-   
 *      4% Liquidity                          `-+o/-`           .ys.````+h`  
 *                                           ./o+-`              -ooho////s.  
 *                                       `.+o:`                  `+h`        
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x8d660420b772E5d679e3c99F322Babf8A5E1Da8B;
        _token = msg.sender;
    }
...
contract ElonsPetSquid is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Elons Pet Squid";
    string constant _symbol = "PetSquid";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 30000000 * (10 ** _decimals);     // 3%
    uint256 public _maxWalletToken = 30000000 * (10 ** _decimals);  // 3%
    ...
    address IDEXPair = 0x8d660420b772E5d679e3c99F322Babf8A5E1Da8B;
