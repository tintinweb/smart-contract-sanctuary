...
(_)) __| / _ \ | |   |   \ |  \/  ||_ _| | \| || __| 
  | (_ || (_) || |__ | |) || |\/| | | |  | .` || _|  
   \___| \___/ |____||___/ |_|  |_||___| |_|\_||___| 
                                                     
The day we have all been waiting for has finally arrived.
Don't miss out on the launch of the biggest mining coin on BSC!
Launch time is 8pm UTC. 

Telegram —> https://t.me/GoldMineRewards
Website —> https://goldmine.financial
...
contract GoldMine is IBEP20 {
    ...
    string public override name = "GoldMine";
    string public override symbol = "GMINE";
