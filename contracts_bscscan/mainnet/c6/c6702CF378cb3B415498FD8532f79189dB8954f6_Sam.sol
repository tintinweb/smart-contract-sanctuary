...
contract Sam is IERC20, Ownable {
    ...
    string constant _name = "Sam";
    string constant _symbol = "Sam";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 750; //0.3% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 1) / 3750; // 1.5% of total supply
