...
/**
    ...
    Buy and HODL $DisneyBNB to get $BNB
    
    www.disneybnb.io
    t.me/disneybnb
    twitter.com/DisneyBNB
    ...
    1 BNB will be added to liquidity
...
contract DISNEYBNB is Context, IBEP20, Ownable {
    ...
    string private constant _symbol   = "$DisneyBNB";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 0;
    uint256 public _liquidityFee = 0;
    uint256 public _marketingFee = 1800;
