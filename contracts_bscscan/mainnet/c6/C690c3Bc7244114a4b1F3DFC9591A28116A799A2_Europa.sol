...
import "./Europalib.sol";
contract Europa is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Europa"; // token name
    string private _symbol = "Europa"; // token symbol
    ...
    uint256 public _deadFee = 20;  // swap BNB
