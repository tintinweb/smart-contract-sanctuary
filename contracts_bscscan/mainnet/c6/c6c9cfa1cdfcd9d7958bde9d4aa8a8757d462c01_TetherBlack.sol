...
/**
   TetherBlack is the first BSC project to allow determined project owners to become a franchisees of our radical EcoSystem. 
   A real project run by a determined team. 
   
   Telegram: t.me/tetherblack
   Website : tetherblack.com
*/
...
contract TetherBlack is Context, IERC20, Ownable {
    ...
    string private _name = "TetherBlack";
