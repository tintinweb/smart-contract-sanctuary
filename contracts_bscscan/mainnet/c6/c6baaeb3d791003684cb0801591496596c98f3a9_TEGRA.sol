...
contract TEGRA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1010 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TEGRA NETWORK";
    ...
    uint256 public _maxTxAmount = 1010 * 10**6 * 10**9;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent > 13, "Cannot set transaction amount less than 10 percent!");
