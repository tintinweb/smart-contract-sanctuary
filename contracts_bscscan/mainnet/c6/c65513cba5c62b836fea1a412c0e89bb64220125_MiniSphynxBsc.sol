...
/*
  ...
  Welcome to Mini Sphynx

🪐We believe in Sphynx and we know their swap is the next BIG thing🪐
...
💻 http://www.minisphynx.com/


Telegram: https://t.me/MiniSphynxBsc
...
contract CakeCrewDividendTracker is IDividendDistributor {
    ...
    IBEP20 Cake = IBEP20(0x2e121Ed64EEEB58788dDb204627cCB7C7c59884c);
...
contract MiniSphynxBsc is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "MiniSphynx";
    string _symbol = "MiniSX";
    ...
    address public marketing = address(0x0e1fED7ad45400a75F6f122D79BC30f15CCB7bE8);
    address public liquidity = address(0x70a35A10D52E60D57b1f038355fa5E5556d01451);
