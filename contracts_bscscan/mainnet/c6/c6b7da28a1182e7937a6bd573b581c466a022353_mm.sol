...
contract mm is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x3868E78Cc73f19234a2e8F795fC17326Af9B0fcD); // 
    ...
    string private _name = "mm2";
    string private _symbol = "mm2";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 9 * 10**5* 10**9;
