...
/*
MetaShiba is the first Shiba Metaverse world. This is a stealth launch, follow Shiba's twitter to wait for the official announcment before buying. Buying before official launch will require far higher slippage.
*/
...
contract MetaShiba is Context, IERC20, Ownable {
    ...
    uint256 public _fee_charity_convert_limit = _supply_total * 1 / 10000;
    ...
    uint256 public _fee_reflection = 50;
    ...
    uint256 public _fee_charity = 10;

    uint256 private _fee_charity_old = _fee_charity;

    address payable private _wallet_charity = payable(0x74648b170a4b0De751a2f73c4ebFAcFFb5394a90);



    // for burn

    uint256 public _fee_burn = 20;

    uint256 private _fee_burn_old = _fee_burn;

    address payable private _wallet_burn = payable(0xa12f615AE447273dBfF569Be464A62c2B1195EFd);



    // for team

    uint256 public _fee_team = 20;

    uint256 private _fee_team_old = _fee_team;

    address payable private _wallet_team = payable(0xb041c9dA7B5f9e00f0132dFF2a81bbe137a3e317);



    // Dev wallet

    address payable private _wallet_dev = payable(0xa7A90D92a5279a8d398c040d9FA0cD2e15FEA78C);

    

    // Auto LP

    uint256 public _fee_liquidity = 2000;
    ...
    uint256 public _maxWalletToken = ( _supply_total * 3 ) / 100;
    ...
    uint256 public _maxTxAmount =  ( _supply_total * 5 ) / 1000;
...
// Reflect Finance core code
    ...
    function _getValues(uint256 tAmount) private view returns (
        ...
        tCharity       = ( tAmount * _fee_charity ) / _fee_denominator;

        tLiquidity      = ( tAmount * _fee_liquidity ) / _fee_denominator;

        tTeam           = ( tAmount * _fee_team ) / _fee_denominator;
