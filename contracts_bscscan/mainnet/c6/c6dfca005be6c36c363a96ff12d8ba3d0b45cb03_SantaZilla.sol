...
contract SantaZilla is Context, IERC20, Ownable {
    ...
    string private _name = "SantaZilla";
    string private _symbol = "SantaZilla";
    ...
    function _reflect(uint256 tAmount) external onlyOwner() {
        require(tAmount < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = tAmount;
    }
}