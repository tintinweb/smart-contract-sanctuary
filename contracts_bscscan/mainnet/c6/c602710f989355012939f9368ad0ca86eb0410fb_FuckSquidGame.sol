...
SQUID token rugged us... It's time to say FUCK SQUID GAME!

FuckSquidGame $FUCKSG is a brand new and safu token built on the newest pragma solidity version.

-Our total supply is a symbolic number of 420,000,000,000 tokens. 
-50% of the supply will be burnt.
-We have 0% for both - buy and sell tax, which turn your gains into pure profit.
-$FUCKSG liquidity will locked for 1 year on Mudra LP locker. It makes the token unruggable
-Dev wallet is only 2.5.%
...
contract FuckSquidGame is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    bool isNumber = true;   
    constructor() {
        _totalSupply = 420 * 10**9 * 10**9;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }

    function name() public view virtual override returns (string memory) {
        return "FuckSquidGame";
    }
