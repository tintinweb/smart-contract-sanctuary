...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xB67358D92B1c34De31a56B8521E780Cc1b12Da2a;
        _token = msg.sender;
    }
...
contract SpaceHarmony is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xbfB7BADFC51b74CD2fe58288dEF672b8f8630BcF;

    string constant _name = "SpaceHarmony";
    string constant _symbol = "SONE";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 15000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 15000000000 * (10 ** _decimals);
