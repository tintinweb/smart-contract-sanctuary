...
contract Token is Context, IERC20, Ownable {
    ...
    function setLPFeePercent(uint8 liquidityFee) external onlyOwner() {
    ...
    function setBuybackFeePercent(uint8 buybackFee) external onlyOwner() {
        _buybackFee = buybackFee;
    }

    function setTaxFeePercent(uint8 walletFee) external onlyOwner() {
