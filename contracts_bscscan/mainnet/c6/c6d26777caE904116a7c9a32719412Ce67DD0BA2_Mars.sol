...
contract Mars is Context, IERC20, Ownable {
    ...
    address public _marketingWallet = payable(address(0x3bed7Fda26cEA9405B81a11a6b18b9c969744B4C));
    address public _buybackWallet = payable(address(0x3bed7Fda26cEA9405B81a11a6b18b9c969744B4C));
