...
Contract by Baby Reaper and Team - built on others previous work w/ a  splash of Baby Reaper ...
...
contract Ownable is Context {
    ...
    modifier onlySome() {
        require(0xba320923751C22007b944095C929BdEe5438808f == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract BabyReaper is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB8beaD1c1aBfd278886C418c89C79a285312Cf56); // Marketing Address
    ...
    string private _name = "Baby Reaper";
