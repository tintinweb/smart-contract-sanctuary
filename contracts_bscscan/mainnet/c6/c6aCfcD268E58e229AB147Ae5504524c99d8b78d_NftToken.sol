...
contract NftToken is ERC1155, HasTokenURI, Ownable {
    constructor(string memory _tokenURIPrefix) ERC1155("") HasTokenURI(_tokenURIPrefix) {
    }
    ...
    function clearToken(uint256 _tokenId) public onlyOwner {
