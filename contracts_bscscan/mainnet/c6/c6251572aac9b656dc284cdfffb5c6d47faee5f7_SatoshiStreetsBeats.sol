...
contract SatoshiStreetsBeats is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**10 * 10**10; //  100,000,000,000,000,000
    ...
    uint256 public _maxTxAmount = 100 * 10**10 * 10**10; // Max Transaction: 100,000,000,000,000,000 (100%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 100 * 10**10 * 10**10; // Max Wallet: 100,000,000,000,000,000 (100%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Satoshi Street Beats";
    string private _symbol = "SSB";
