...
contract YYGPresale is Context, Ownable {
    ...
    function mint(address to, uint256 amount) public ownerOrKeeper(msg.sender) returns (bool) {
        _mint(to, amount);
        return true;
    }

    function burn(address account, uint256 amount) public ownerOrKeeper(msg.sender) returns (bool) {
