...
contract Monst3rBUSD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDB0797498fb3825B39009d2E7B5472c6fED761Ca); // Marketing Address
    ...
    string private _name = "M0nster BUSD";
    string private _symbol = "M0BUSD";
