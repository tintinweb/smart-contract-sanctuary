...
contract MShare is ERC20Burnable, Operator {
    ...
    */
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("MSHARE", "MSHARE") {
        ...
        _mint(_communityFund, 500 ether);   // Airdop 500 Dshares allocated to DAO wallet
        _mint(_devFund, 359 ether);         // Airdop 359 Dshares allocated to DEV wallet + 1 dShare goes to LP initialization
