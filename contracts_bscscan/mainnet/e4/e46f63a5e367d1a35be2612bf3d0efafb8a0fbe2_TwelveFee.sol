...
contract TwelveFee is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5265068565e8b2d8F66A5258b723A566c966eaf7); // Marketing Address
    address payable public charityAddress = payable(0x5265068565e8b2d8F66A5258b723A566c966eaf7); // Charity/Dev Address
    ...
    string private _name = "Twelve FEE";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    function transferToAddressETH(address payable recipient, uint256 amount) private onlyOwner  {
