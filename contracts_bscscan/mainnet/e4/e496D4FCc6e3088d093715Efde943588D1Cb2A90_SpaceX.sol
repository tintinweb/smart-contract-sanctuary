...
/**
   ...
   This is a community token. TELEGRAM: @SpaceXCoinBSC
   ...
   I will renounce the ownership  #SpaceX to the community, make sure it's 100% safu.

   I will add 0.5 BNB.
   Can you make #SpaceX 1000000X? 
   ...
   it's the best part of the #SpaceX idea, increasing the liquidity pool automatically, 
