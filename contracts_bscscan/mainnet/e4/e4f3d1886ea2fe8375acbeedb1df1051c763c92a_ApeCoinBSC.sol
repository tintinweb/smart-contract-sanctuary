...
contract ApeCoinBSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MARK = 0xd05EFcfa359eA7526DE07214C5ab6933bADE6E2c;

    string constant _name = "ApeCoinBSC";    
    string constant _symbol = "ApeCoinBSC";
