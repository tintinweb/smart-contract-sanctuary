...
/**
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |     _____    | || | _____  _____ | || |  ________    | || |    ______    | || |  _________   | |
| |    |_   _|   | || ||_   _||_   _|| || | |_   ___ `.  | || |  .' ___  |   | || | |_   ___  |  | |
| |      | |     | || |  | |    | |  | || |   | |   `. \ | || | / .'   \_|   | || |   | |_  \_|  | |
| |   _  | |     | || |  | '    ' |  | || |   | |    | | | || | | |    ____  | || |   |  _|  _   | |
| |  | |_' |     | || |   \ `--' /   | || |  _| |___.' / | || | \ `.___]  _| | || |  _| |___/ |  | |
| |  `.___.'     | || |    `.__.'    | || | |________.'  | || |  `._____.'   | || | |_________|  | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
.----------------.  .----------------.  .----------------.  .-----------------.
...
contract JudgeElonDoge is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 2;
  uint256 private _maxTrxLimit = 10000 * 10**9 * 10**12;
  address private _deployer;
