...
/**
https://t.me/GodzillaobvOfficial

 # of Tokens: 100,000,000,000
 Max Wallet Size = 4,000,000,000
 Max Transaction Size = 1,000,000,000 

 Reflection/Taxes: 5% in Marketing, 7% in Liquidity
 
 Buy Slippage: 12-15% 

 *** THE MAX A WALLET CAN HAVE IS 4,000,000,000! THAT IS 4%! ***
...
// CHANGE
contract GodZillaOBV is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "GodZilla OBV";
    string constant _symbol = "GZO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // 1% MAX 1,000,000,000
