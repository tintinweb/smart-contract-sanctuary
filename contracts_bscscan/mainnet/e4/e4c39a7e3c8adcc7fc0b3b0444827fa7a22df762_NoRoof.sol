...
contract DividendDistributor is IDividendDistributor {
    ...
    Controllrage WBNBc = Controllrage(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract NoRoof is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NoRoof";
    string constant _symbol = "Roofs";
