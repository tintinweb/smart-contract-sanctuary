...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LINK = IBEP20(0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD);
    ...
    event Deposit(uint256 amountBNB, uint256 amountLINK);
...
contract BabyBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyBNB";
    string constant _symbol = "BabyBNB";
