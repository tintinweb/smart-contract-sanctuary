...
The future of fitness-based cryptocurrency. GymScene token ($GYMSV2) will be used to access online classes, nutritional plans, decentralized gym memberships and provide a platform for GymScene community's activities and events!
...
contract GymScene is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x828dde39aE9343cf4C39958FF20B4B5E5260cAE4); // Marketing Address
