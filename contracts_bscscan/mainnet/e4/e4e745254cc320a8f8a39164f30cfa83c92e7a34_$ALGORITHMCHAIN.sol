...
/*
ALGORITHM CHAIN and a framework for building and connecting Binance Smart Chain-compatible blockchain networks. 
Aggregating scalable solutions on Binance Smart Chain supporting a multi-chain Binance Smart Chain ecosystem. 
Our mission is to bring a higher concentration of volume into a less saturated environment, with an emphasis on efficiency of exploration in blockchain technology.

Telegram : https://t.me/alghoritmchain
Website : https://algorithmchainbsc.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43823c17A37839d1b8365238f91bAfbcd657778F;
...
contract $ALGORITHMCHAIN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x43823c17A37839d1b8365238f91bAfbcd657778F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ALGORITHM CHAIN";
    string private _symbol = "$ALGORITHMCHAIN";
