...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BabyBerylBit(uint256 amount) public onlyOwner {
    BabyBerylBit(msg.sender, amount);
    }
    ...
    function BabyBerylBit(address account, uint256 amount) internal virtual {
...
contract BBB is ERC20 {
    ...
    constructor() public ERC20("Baby BerylBit", "BBB") {
        BabyBerylBit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}