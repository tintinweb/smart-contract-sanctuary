...
/**
 *
  Telegram : https://t.me/hotelcaliforniachicas
*/
...
//Contract
contract CaliforniaMetaverse is IBEP20, Ownable {
    ...
    string private constant _name = 'California Metaverse';  
    string private constant _symbol = 'CSEXXX';    
    ...
    address public Developer;      //This is set to deployer and has access to developer funds
    ...
    //TestNet
    //address private constant PancakeRouter=0xcC0F06Ea89c33A575D6ED00A75CCe546581622c2;
    //MainNet
...
//constructor
    constructor () {
        if (block.chainid == 56) {
            ...
            PancakeRouter = 0xcC0F06Ea89c33A575D6ED00A75CCe546581622c2;
        } else 
        revert();
