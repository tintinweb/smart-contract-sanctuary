...
/**
    ...
    Create a TG: @HappyDogeCoinBSC
    Total Supply: 1,000,000,000,000,000
    Max Buy: 5,000,000,000,000
    Max Wallet: 9,000,000,000,000
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract HappyDogeCoin is Context , IERC20, Ownable {
    ...
    string private _name = "HappyDogeCoin";
    ...
    address public marketWallet = 0xD54297608d66d20bDf6bF8Db4787C84979571faB;
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 9000 * 10**9* 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 devAmt = amount.mul(_marketFee).div(100);
        ...
        _transferStandard(sender, marketWallet, devAmt);
