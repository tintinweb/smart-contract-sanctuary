...
contract PancakeERC20 is IPancakeERC20 {
    ...
    string public constant name = 'Moonlift LPs';
    string public constant symbol = 'MLTP-LP';
...
contract MoonliftFactory is IPancakeFactory {
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(PancakePair).creationCode));

    address public feeTo = 0xE9f192160E7816C292Fd21E0C04EEb2900338ce7;
