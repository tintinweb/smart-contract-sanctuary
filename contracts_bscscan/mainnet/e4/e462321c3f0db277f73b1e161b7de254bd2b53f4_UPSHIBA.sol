...
contract UPSHIBA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x84cb86Fa1C5d870aaBF0984061692a6c2E5A13F2); // Marketing Address
    ...
    string private _name = "UpShiba";
    string private _symbol = "UPSHIB";
