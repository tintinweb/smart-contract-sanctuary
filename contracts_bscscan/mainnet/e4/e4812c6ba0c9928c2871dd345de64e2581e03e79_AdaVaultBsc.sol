...
// CHANGE
contract AdaVaultBsc is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "AdaVaultBsc";
    string constant _symbol = "Avault";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% MAX 200,000,000
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 4% MAX 4,000,000,000
    ...
    uint256 reflectionFee = 900; // 6%
    uint256 devFee = 500; // 2%
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x6D3cF76c6F3e33B655157d7901843772e36a2e14);
