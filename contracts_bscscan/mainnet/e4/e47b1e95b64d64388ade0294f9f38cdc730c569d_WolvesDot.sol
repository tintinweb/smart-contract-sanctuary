...
Welcome to WolvesDot

Fair launch, no presale and private sale

This token will be used by WolvesDot and in the future. WolvesDot is a SWAP built on the BSC chain, and if it provides liquidity, you can receive WolvesDot tokens. WolvesDot tokens will be issued with the launch of the SWAP and will be distributed to 100% liquidity providers.

More need news information see on group 
...
Telegram :@WolvesDotOffice
Website   : https://countingdownto.com/countdown-pages/c7TmG-nk
Twitter     : @WolvesDot
...
contract WolvesDot is Context, IERC20, Ownable {
    ...
    address private _donationWalletAddress = 0x82C2C3c51bAf432B1553B56DC54e159D7D1D1862;
    ...
    string private _name = "WolvesDot";
    string private _symbol = "WolDot";
