...
// 10 % ADA rewards, 5& back to LP & 5% marketing wallet
...
contract MiniNFL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniNFL";
    string constant _symbol = "MiniNFL";
