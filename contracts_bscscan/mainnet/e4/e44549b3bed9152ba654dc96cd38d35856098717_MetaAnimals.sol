...
interface IBEP20Sniper is IERC11 {
 ...
 contract MetaAnimals  is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Meta Animals";
    string private _symbol = "ANI";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xbab6c4A8E0222308e64ee93756485157DeF89e99;
    address private _water4Africa = 0xbab6c4A8E0222308e64ee93756485157DeF89e99;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xbab6c4A8E0222308e64ee93756485157DeF89e99;
