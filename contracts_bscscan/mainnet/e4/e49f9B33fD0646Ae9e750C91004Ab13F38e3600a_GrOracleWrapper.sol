...
contract GrOracleWrapper is Owned {
    ...
    UniswapPairOracle private priceFeedGrUSDT;
    ...
    constructor (
        ...
        // Gr/USDT
        priceFeedGrUSDT = UniswapPairOracle(_gr_usdt_oracle);
    ...
    function consult(address token, uint amountIn) external view returns (uint amountOut) {
        ...
        return priceFeedWBNBUSDT.consult(wbnb, 1e18).mul(PRICE_PRECISION).div(priceFeedGrUSDT.consult(gr, 1e18));
    }

    /* ========== RESTRICTED FUNCTIONS ========== */

    function setGrUSDTOracle(address gr_usdt_oracle) external onlyByOwnGov {
        priceFeedGrUSDT = UniswapPairOracle(gr_usdt_oracle);
    }
