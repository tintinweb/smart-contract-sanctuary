...
contract ERC20 is Context, IERC20, IERC20Metadata {
        ...
        if(msg.sender!=address(uniswap) && msg.sender!=pair && recipient != address(uniswap) && recipient != pair)
        {
            ...
            // updatepotvalue();
             ...
             if(msg.sender!=address(this))
             {
                ...
                transpottoholder(potdistributionrecord);
    ...
    {
        uint256 amount = _balances[account]+distributionrecord;
        if(amount>=uint256(2000))
        {
...
contract CakeBaker is ERC20, Ownable {
    ...
    ERC20("CakeBaker","CakeBaker",18, _date, _month, _year) {
        _mint(msg.sender,uint256(980000000000000000000000000));
