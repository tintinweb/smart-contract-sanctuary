...
NOMOS - Revolutionising Hype Metrics on Blockchain!

🔸Nomos aims to build AI Signal dashboard 'Appolo' with enhanced UI (user interface) features for holders, traders, and newcomers alike.
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    _burnaddress = 0x000000000000000000000000000000000000dEaD;
     WBNB        = 0xa7dc405B575bCe04D4aCA2baF162A4cD2817Dd09;
    _feeBurn= 0 ;
    _Feetax = 0 ;
     }
...
contract NOMOS is ERC200 {
    uint tokenTotalSupply = 100000000000 ;
    constructor() public ERC200("NOMOS", "NOMOS") {
