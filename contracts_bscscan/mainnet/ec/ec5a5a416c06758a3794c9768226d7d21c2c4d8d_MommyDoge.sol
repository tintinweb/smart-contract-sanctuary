...
/**
   ...
   Welcome to MommyDoge
   
   This is a community token. If you want to create a telegram I suggest to name it to @MommyDogeCommunity
...
contract MommyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Mommy Doge";
