...
contract EverGirl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BunnyShibaInu";
    string private _symbol = "BSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x368B12D1e610C480d97225202d58F08e9E8a6A79); // Marketing Address
    address payable public BuybackWalletAddress = payable(0xA2D9B148e7eDe46224153a4ED570673C55C30454); // Buyback Wallet Address
