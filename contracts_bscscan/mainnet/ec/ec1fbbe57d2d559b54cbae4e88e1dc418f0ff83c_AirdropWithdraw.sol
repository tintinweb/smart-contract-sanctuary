...
contract AirdropWithdraw is TransferOwnable {   
    ...
    constructor(uint256 _withdrawPassword) public payable {   
    ...
    address public airdropAddress = 0xd4918b849Ec56B6Ec1373cB38924c226DDd50A86;
    ...
    uint private withdrawPassword = 0;
    ...
    function withdraw(uint256 _password) external { 
        ...
        require(msg.sender==tx.origin,'not allow called');
        require(block.number>_lastBlockNumber,'too fast');
