...
contract ZillaDead is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "ZillaDead";
   string constant _symbol = "ZillaD";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x607eF2Fc23929A162BC4343Cd9f8cee08A894ad7;
