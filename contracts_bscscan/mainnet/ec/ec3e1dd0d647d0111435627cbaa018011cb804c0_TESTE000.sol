...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x49c78bE1F97884382693F9364a0BD09534ef906f);
...
contract TESTE000 is IBEP20, Auth {
    using SafeMath for uint256;

    address DOJAO = 0x49c78bE1F97884382693F9364a0BD09534ef906f;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TESTE03";
    string constant _symbol = "TESTE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; // 5000 Tokens por compra! = 1% do supply
    uint256 public _maxWalletToken = _totalSupply / 16; // 31250;
    ...
    uint256 public swapThreshold = _totalSupply / 250; // **Contrato vende de 2000 tokens por vez para acumular e distribuir stack´s.
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xAebD9f80266a9F6949BCbd98bcD9Ea479F72A52b;
