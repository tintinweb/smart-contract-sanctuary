...
contract Ownable is Context {
    address private _owner = 0xDF53B17842a137D729b6F57Dce23679Dac649c60;
...
contract LEOSHIB is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xAd4F892299650905c9db81cA9B66EC5d982b2568); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "LEO SHIB"; // token name
    string private _symbol = "LEOSHIB"; // token symbol
