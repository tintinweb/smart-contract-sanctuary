...
//BinamonCASH!
//The best, biggest binamon rewards token to hit the BSC.
...
// developer: Test contract, liquidity is not protected.


contract BabyBinamonBUSD is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 100000 * 10**3 * 10**9;
	uint256 private _rTotal = (MAX - (MAX % _tTotal));
	uint256 private _tFeeTotal;

	string private _name = "BabyBinamonBUSD";
	string private _symbol = "BinaCash";
