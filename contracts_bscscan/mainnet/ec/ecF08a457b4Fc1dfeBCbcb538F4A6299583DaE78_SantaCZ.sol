...
// CHANGE
contract SantaCZ is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SantaCZ";
    string constant _symbol = "SCZ";
    ...
    uint256 reflectionFee = 400; // 4%
    uint256 devFee = 500; // 5%
    uint256 totalFee = 1500; // liquidityFee + Buyback + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4eF4E0c3563873340D5393DC3e168B6A88642Dc8);
