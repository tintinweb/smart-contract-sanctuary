...
/**GoldenCatCake is inspired from the Neko Cat. It was believed that the figurine will bring good fortune and luck to the owners. 
 * Now, it is Golden Cat’s turn to bring you tons of fortune through its own token and the CAKE token that it is spreading

Come and join Golden Cat’s community and start building wealth from the fortune cakes that he generates.
...
-Whitepaper Release
– Audit
– Full Marketing Push & Community Sharing
...
contract GoldenCatCake is Context, IERC20, Ownable {
