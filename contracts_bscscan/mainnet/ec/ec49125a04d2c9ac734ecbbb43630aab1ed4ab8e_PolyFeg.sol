...
import "./PolyFegDividendPayingToken.sol";

/**
⚡️Token Protocol / Tokenomics⚡️
...
contract PolyFeg is ERC20, Ownable {
    ...
    address public immutable BANANA = address(0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167); // FEG
    ...
    constructor() ERC20("PolyFeg", "PFEG") {
