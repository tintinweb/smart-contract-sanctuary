...
contract TheFlokiExclusive is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("https://t.me/TheFlokiExclusive", "TFE") {
...
contract TFE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    string private _name = "bThe Floki Exclusive";
