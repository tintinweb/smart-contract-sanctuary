...
/**
 * The Official RAM Smart Contract
*/
contract RAM is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0xf276a456A306996237e37208FD7022a0fB6F825c);
    ...
    uint256 public _tokenSwapThreshold = 100000000 * 10**9;
    uint private constant DAY = 86400;
    bool    public _enableAntiWhale    = false;
    uint256 public _whaleSellThreshold = 1000000 * 10**9;
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9;
