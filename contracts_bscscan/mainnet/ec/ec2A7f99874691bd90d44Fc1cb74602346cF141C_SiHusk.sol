...
contract SiHusk is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 50000 * 10**9; // Max Transaction: (5%)
    uint256 public _numTokensSellToAddToLiquidity = 50000 * 10**9;
    uint256 public _maxWalletToken = 75000 * 10**9; // Max Transaction: (7.5%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = '$SiHusk';
    string private _symbol = '$SHUSK';
