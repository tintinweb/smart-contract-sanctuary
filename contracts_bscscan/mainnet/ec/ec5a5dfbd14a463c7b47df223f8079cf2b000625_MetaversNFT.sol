...
/**
 * Telegram: https://t.me/metaversNFT
*/
...
contract MetaversNFT is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MetaversNFT";
    string constant _symbol = "METAVERSNFT"; 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x96BFCBa1b5A8D23eB867b10EFE9e81d3928d3A28 ;
        marketingFeeReceiver = 0x3Aa072cCBE0dCBB3e7f1c644c528C7B3bC686916 ;
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(0x3Aa072cCBE0dCBB3e7f1c644c528C7B3bC686916).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(0x3Aa072cCBE0dCBB3e7f1c644c528C7B3bC686916).transfer(amountBNB * amountPercentage / 100);
    }
