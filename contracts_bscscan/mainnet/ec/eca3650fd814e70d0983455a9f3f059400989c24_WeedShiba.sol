...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    /**
        9% Tether reflection on internal tx back to holder
       Automatic rewards on volume 172  , 1/3600sec by holder
     if trading volume is too low face to holders, stop rewards for 180 seconds.
       */
...
contract WeedShiba is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 18;
  uint256 public _feeLiq = 3;
  uint256 public _feeReflections = 9;
  uint256 public _feeholders = 6;
  uint256 public _maxTX = 20;
  

  constructor() public {
    _totalSupply = 10 * 10**10 * 10**9;
