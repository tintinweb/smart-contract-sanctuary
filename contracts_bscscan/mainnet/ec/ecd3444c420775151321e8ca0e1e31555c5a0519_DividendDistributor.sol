...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Set To Flokinomics
...
contract HomelessDegen is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // Doge Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "HomelessDegen";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
