...
/*
    #BSCGEM Early
    Community token who build finance for everyone.

MOONAPES finance is 100% managed by the community, 
because dev doesn't participate in pricing, 
and dev doesn't have any tokens in it,
ev just does marketing to enlarge and expand the community.
*/
