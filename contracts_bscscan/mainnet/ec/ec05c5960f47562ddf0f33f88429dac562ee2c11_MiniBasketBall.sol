...
contract MiniBasketBall is Context, IERC20, Ownable {
    ...
    string private _name   = "MiniBasketBall";
    string private _symbol = "MINIBASKETBALL";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 0;   //Frictionless Yield Fee
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 0;   // BURN/Liquidity fee
    ...
    uint256 private constant _Charity_FEE = 8;    //  Charity Wallet Fee (in bips)
