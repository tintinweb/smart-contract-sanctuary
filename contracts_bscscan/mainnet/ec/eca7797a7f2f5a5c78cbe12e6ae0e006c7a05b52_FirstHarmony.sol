...
First Harmony - $FIRSTONE

telegram https://t.me/firstharmony
website https://firstharmony.space/
...
// CHANGE
contract FirstHarmony is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "First Harmony";
    string constant _symbol = "FIRSTONE";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100; // 1% MAX 3,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x632a1E87B4E2c9c73a4F45750a8eD89Ae1079E7e);
