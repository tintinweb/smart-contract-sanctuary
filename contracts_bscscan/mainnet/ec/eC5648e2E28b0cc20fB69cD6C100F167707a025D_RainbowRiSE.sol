...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #RainbowRiSE to the community, make sure it's 100% safe.

   I will add 5 BNB and all the left 49.5% total supply to the pool
   Can you make #RainbowRiSE 10000000X? 
   ...
   it's the best part of the #RainbowRiSE idea, increasing the liquidity pool automatically, 
...
contract RainbowRiSE is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "RainbowRiSE";
  string private _name = "RainbowRiSE";
