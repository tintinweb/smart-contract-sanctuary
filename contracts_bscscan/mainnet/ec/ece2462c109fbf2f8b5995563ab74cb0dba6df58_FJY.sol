...
contract FJY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x15763703eFcEF51E4538915723E06B621e074A10); // Marketing Address
    ...
    string private _name = "FJY";
    string private _symbol = "FJY";
