...
=> Total locked Tokens for Initial Liquidity: 20% => effectively sets the price floor to $01
=> All initial LP-CAKE tokens will be locked on DxSale directly by listing on Uniswap
=> Every transaction consumes 10% of your crypto to achieve the following investment goals:
=> Reflection: 2% of each transaction is auto redistributed to all #CharityWhale holders, increasing your number of shares
=> Auto-burn: 2% of each transaction is burn to the 0x000000000000000000000000000000000000dead address
=> This reduces the circulating supply, which helps to automatically pump the price in every transaction.
=> Liquidity: 2% of each transaction is forever auto-locked in the liquidity pool on PancakeSwap V3
=> Marketing: 2% is transferred to the team wallet: 0xdDBf53cE5239BD389fceBAe72dCa53AAd19D5080 to pump
the price, spread the word, secure your investment, and start building the Charity Network Launchpad
=> Charity: 2% is transferred to the charity address of the community’s choice to make this world a better place.
The default charity wallet: 0x0321724ab40936659CeF5a861bB2DEc71B919599

So, you should set your slippage to 11% or more

🚀  Presale starts on Sunday, August 21st at 5pm UTC on BSC Pad with FAIRLAUNCH two weeks later. Stay tuned!
...
contract CharityWhale is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    event MaxTxAmountUpdated(uint256 _maxTxAmount);
    
    string private constant _name = "CharityWhale";
    string private constant _symbol = "CharityWhale";
    ...
    uint256 private constant _totalSupply = 1 * 10**9;
