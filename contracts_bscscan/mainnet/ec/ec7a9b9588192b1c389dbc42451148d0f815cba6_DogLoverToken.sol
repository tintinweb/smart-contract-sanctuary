/**
   Welcome to Dog Lover Token
   
   site on progress
   t.me/DogLoverToken
   
   
   This Token Belong for all dog lovers, community Dog Lover is a charity community for helping all shelter in this world
   
   i will add 0.3 Bnb For LP 
   and hope it will be bigger charity community
...
contract DogLoverToken is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Dog Lover Token";
    string private constant _symbol   = "Dog-Lover";
    ...
    uint256 public _maxTxAmount  = 50000000000000000 * 10**8;
