...
contract BabyTheta is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Theta";
    string private _symbol = "BabyTheta";
    ...
    uint256 private constant _Burn_FEE = 200; // 2%
