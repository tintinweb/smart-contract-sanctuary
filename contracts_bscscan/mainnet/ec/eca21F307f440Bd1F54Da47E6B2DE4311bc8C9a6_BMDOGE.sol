...
contract BMDOGE is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BMDOGE";
  string private _name = "BABYMOONDOGE";
  address private newun;
  uint public buyback = 3;
  uint public bnbrewad = 6;
  uint public cakereward = 6;
  uint public MarketingWallet = 3;
