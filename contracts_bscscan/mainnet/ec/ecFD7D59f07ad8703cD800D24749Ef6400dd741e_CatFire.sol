...
contract Ownable is Context {
    address private _owner = 0x60c8B7E30be196B82f8Dc30b7395B8f20a507F50;
...
contract CatFire is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "CatFire"; // token name
    string private _symbol = "CatFire"; // token symbol
