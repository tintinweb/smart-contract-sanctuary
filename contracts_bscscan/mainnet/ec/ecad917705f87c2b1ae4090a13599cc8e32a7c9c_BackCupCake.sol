...
/**
👼 BackCupCake | $BCC| buyback | Farming(Soon) | BCCSwap Launch( Soon)| 👼 Fair-launch on Pancake Swap 9th of August at 14:30 UTC

🕹 BackCupCake | $BCC | is a hyper deflationary token buyback protocol approach & auto token rewards prepare to list on the market.
Through our BBC dAPP farm with highest APR, autobuyback protocol, and unstoppable community, we will  make a difference 📝


✅ $BCC Tokenomics
💰 Total Supply : 1.000.000.000 $BCC 
💎 Initial liquidity: 2 BNB $BCC  
🔒 Liquidity Lock: 1 𝘆𝗲𝗮𝗿
💵 Slippage: 21% and more
🍼Tax buy/sell: 21%
🎯Cake rewards 4,2%
...
contract BackCupCake is Context, IERC20, IERC20Metadata, Ownable {   
