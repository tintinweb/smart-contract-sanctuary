...
contract iii is BEP20("iii", "iii") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "iii::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "iii::delegateBySig: invalid nonce"
        );
        require(now <= expiry, "iii::delegateBySig: signature expired");
        ...
        returns (uint256)
    {
        require(
            ...
            "iii::getPriorVotes: not yet determined"
        );
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying iiis (not scaled);
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "iii::_writeCheckpoint: block number exceeds 32 bits"
        );
