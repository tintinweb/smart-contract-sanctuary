...
/*
 Welcome to Silver Husky 
   
   Telegram: https://t.me/SilverHuskybsc
   ...
   I will renounce the ownership to burn addresses to transfer #SilverHusky to the community

   I will add 2 BNB and all the left 10% total supply to the pool
   Can you make Silver Husky Token 100X? 
   ...
   it's the best part of the #SilverHusky idea, increasing the liquidity pool automatically, 
