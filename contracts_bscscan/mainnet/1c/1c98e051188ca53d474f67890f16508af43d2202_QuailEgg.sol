...
🥚 QuailEgg - $QEGG Official 🥚

TELEGRAM : https://t.me/qeggofficial
WEBSITE : https://quail-egg.com
TWITTER : https://twitter.com/QuailEggToken
...
contract QuailEgg is Context, IERC20, Ownable {
    using SafeMath for uint256;
 
    string private constant _name = "QuailEgg";
    string private constant _symbol = "QEGG";
    ...
    uint256 public minimumContractBalanceToSwap = 6000000000 * 10**9;   // 0.60% of total supply for both LQ and ETH distribution
