...
/**
 * 
DoxxedMatic - Most transparency Token should be created by doxxed Team!

tg: https://t.me./DoxxedMatic
...
contract DoxxedMatic is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DoxxedMatic";
    string constant _symbol = "DoxxedMatic";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xA4Ec2e0B4A90EF0d2FFb470369A2dD25F9D997C8;
