...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0290E56D2E8DAf4563e5655Bca03Bb75E521CD1D;
...
contract MoonhogInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x59A509d53cf14a01cCF486B1320494732c0852FD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MoonhogInu";
    string private _symbol = "MHGI";
