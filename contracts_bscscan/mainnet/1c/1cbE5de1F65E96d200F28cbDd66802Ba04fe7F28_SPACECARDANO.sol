...
contract SPACECARDANO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ACARDANO";
    string constant _symbol = "SPACEADA";
    ...
    uint256 public swapThreshold = _totalSupply / 200; // 0.4%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1b10Ea87A8D4dEC780d4CBdd93f2B4Ce23550ADf;
