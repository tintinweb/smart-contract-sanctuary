...
contract ETHernity is IERC20, Ownable {
    ...
    /** MAX TX/WALLETS */
    uint256 public _maxBuyTxAmount = (_totalSupply * 100) / 10000; // 1% of supply
    uint256 public _maxSellTxAmount = (_totalSupply * 50) / 10000; // 0.5% of supply
    uint256 public _maxWalletSize = (_totalSupply * 150) / 10000; // 1.5% of total supply
