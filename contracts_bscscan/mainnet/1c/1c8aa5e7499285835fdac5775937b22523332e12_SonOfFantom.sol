...
contract SonOfFantom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Son Of Fantom";
    string private _symbol = "SOF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39b1008eB674460c4dC6185231FBe4A2DCF92421); 
    address payable public BuyBackWalletAddress = payable(0x39b1008eB674460c4dC6185231FBe4A2DCF92421); 
    ...
    uint256 private _totalSupply = 1000000 * 10**3 * 10**9;
    uint256 public _maxTxAmount = 40000 * 10**3 * 10**9;
    uint256 public _walletMax = 40000 * 10**3 * 10**9;
