...
TG = https://t.me/DaddyTron
Website: https://forevertron.cc/
...
// CHANGE
contract ForeverTRON is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Forever TRON";
    string constant _symbol = "ForeverTRX";
    ...
    uint256 public _sellMultiplier = 3; // 3x for sells
    ...
    uint256 public swapThreshold = _totalSupply / 1000; // 0.2%
    bool inSwap;
