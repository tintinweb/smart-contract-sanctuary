...
// MasterChef is the master of DogeJr. He can make DogeJr and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once DogeJr is sufficiently
...
contract PapaMaster is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of DogeJrs
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint; // How many allocation points assigned to this pool. DogeJrs to distribute per block.
        uint256 lastRewardBlock; // Last block number that DogeJrs distribution occurs.
    ...
    // View function to see if user can harvest DogeJrs.
