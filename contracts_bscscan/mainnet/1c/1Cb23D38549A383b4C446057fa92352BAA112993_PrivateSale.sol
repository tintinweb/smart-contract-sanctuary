...
contract PrivateSale is Initializable , OwnableUpgradeable{
   ...
   * @param tokenAddress token for sale
   */
  function setSellToken(address tokenAddress) public onlyOwner {
  ...
  function claim(address recipient) public unlockEnabled {
    ...
    IERC20Upgradeable(vestingToken).transfer(recipient, claimableAmount);
  }   
