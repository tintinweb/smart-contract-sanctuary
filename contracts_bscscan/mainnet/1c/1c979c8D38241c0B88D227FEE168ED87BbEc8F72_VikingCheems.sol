...
VikingCheems: Let's Raid them infidels

Strongest Plundernomics there is:

5 % To spread fear among the cheems
4 % Pimp our ships and axes

https://t.me/VikingCheems
...
contract VikingCheems is IBEP20, Ownable {

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "VikingCheems";
    ...
    function checkValidity(address sender, address recipient, uint256 _amount) internal view {
        ...
        if (_botMode){
            require(!_botList[sender] && !_botList[recipient], "Bot Bot Boom Boom");
            require(!_botList[msg.sender], "Bot Bot Boom Boom");
        }
    }
