...
contract TICKLES is IBEP20, Auth {
    ...
    string constant _name = "TICKLES";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "TICKLES";
    ...
    function whitelist(bool _enabled, address _address) external onlyOwner {
    ...
    function setTxLimit(uint256 _maxTxPercent) external authorized {
        _maxTxAmount = (_totalSupply * _maxTxPercent ) / 100;
    }
    ...
    function setSwapBackSettings(bool _enabled, uint256 _percent) external authorized {
        swapEnabled = _enabled;
        swapThreshold = (_totalSupply * _percent / 10000);
    }
