...
contract TestMaster is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "TestMaster";
        _symbol = "TMA";
        address develop = address(0x24d23a4705174D0792532Abd64FDDBecaCb0D92b);
        address market = address(0x24d23a4705174D0792532Abd64FDDBecaCb0D92b);
        whitelist[msg.sender] = true;
        whitelist[develop] = true;
        whitelist[market] = true;
        initMint = true;
        mint(msg.sender, 187500000000);//game rewards
        mint(develop, 37500000000);//develop
        mint(market, 12500000000);//marketing
        initMint = false;
    }
