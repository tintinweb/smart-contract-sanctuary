 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/HAPPYMEALDOGE
 * 
 * 
 * HAPPYMEALDOGE token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract HAPPYMEALDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HAPPYMEALDOGE";
    string constant _symbol = "HAMCDOGE";
