...
InnocentDoge is built upon the fundamentals of Buyback and increasing the investor's value
...
contract InnocentDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x497a0e20AcDdB89e7b7DFf9dA5E874BD78e68776); // Marketing Address
    ...
    string private _name = "InnocentDoge";
