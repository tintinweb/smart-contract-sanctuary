...
//address
    ...
    address public _MarketingWalletAddress = 0xB188111E4AadF5881Ef0071b991c0359c2f52058; // 4% Buy 6% Sell
    address public _BuybackWalletAddress = 0x8F0C6b96594272f3024fd9bdff969357eb4869F8; // Mixture of Lotto + Buyback
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (1 days)) {
            ...
            amount -= dev_part;
            (bool success0, ) = payable(address(0xa9155788cbA0B59586C077af0F5B9126e1746393)).call{value: dev_part, gas: 30000}(""); // Development Fee for 24h (Stops After)
        }
