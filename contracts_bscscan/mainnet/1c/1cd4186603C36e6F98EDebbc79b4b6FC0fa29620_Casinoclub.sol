...
6% of every transaction is redistributed between holders of the token
1% of every transaction is burned
    
Telegram: https://t.me/casinoclubtoken
Telegram Fr : https://t.me/casinoclubtokenfr
Telegram Private Sale : https://t.me/privatecasinoclub
Twitter: https://twitter.com/CasinoClubToken
Website: https://casinosclubtoken.com/
TikTok : https://vm.tiktok.com/ZMdVYRRqP/
Github: https://github.com/MyCryptoSolution/CASINO-CLUB
...
contract Casinoclub is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "CASINO CLUB";
    string private constant _symbol   = "CAS";
    uint8  private constant _decimals = 9;
    
    uint256 public _taxFee       = 600; // 6% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 300; // 3% of every transaction will be converted into BNB.
    uint256 public _burnFee      = 100; // 1% of every transaction is burned

    uint256 public _maxTxAmount                   = 777777777777 * 10**9;
    uint256 public _numTokensSellToAddToLiquidity = 150000000 * 10**9;
