...
/**
           ...
           * REWARD
                       $$$$$$$$$$$$
                       Hold KISHUSWAP and Earn Rewards every 30 minutes
                       3 BNB WILL WITH ADDED FOR LIQUIDITY
                       LP WILL BE LOCK INSTANTLY
                       DEV WILL DOXX AT 100K MARKET 
                       CMS AFTER CMS, THEN TRENDING POST AND SOON TWITTER INFLUENCERS WILL POST ABOUT KISHUSWAP 
 * NO DEV WALLET
*/
...
contract KishuSwap is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "KishuSwap";
    string constant _symbol = "$KS";
