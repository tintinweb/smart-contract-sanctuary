...
contract WdogeSwap is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2Eb46574289f95DaD4ce28C47eE21E66a370A3F6); // Marketing Address
    address payable public charityAddress = payable(0x2Eb46574289f95DaD4ce28C47eE21E66a370A3F6); // Charity/Dev Address
    ...
    uint256 private constant MAX = ~uint256(0);  // nice
    uint256 private _tTotal = 850000000000000000 * 10**18; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Wdoge Swap"; // nice
    ...
    uint256 public _sellTaxFee=_taxFee;
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**18;
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 1000000000000000000000000; // nice: Claim 1,000,0000 (0.01 BNB = 100,000,000; 0.0000000000025 - 0.0000000000050) 
