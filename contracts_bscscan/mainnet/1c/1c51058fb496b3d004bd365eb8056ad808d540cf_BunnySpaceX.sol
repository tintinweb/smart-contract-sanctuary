...
/**
    ...
    Welcome to BunnySpaceX.
    We are so glad you're here! You are now part of a growing community.
    We believe in the power of our community!
    Spread the word on social media platforms and tell your friends!
    We've got something for you. Be ready, let's go!

    BunnySpaceX
        https://www.bunnyspacex.com/
        https://t.me/BunnySpaceX
...
contract BunnySpaceX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BunnySpaceX";
    string constant _symbol = "BSX";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x2D2e87aa150b6201FA3e53Ed54f85Ae66e8D9424;
