...
// fee 3% burn + 3% redistribution +1% Matketing&team
// Telegram t.me/waterclosettoken
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x22bf993351a998dbb2873a7bfabde852a9f3d218f3371de2206012280561dc53 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x22bf993351a998dbb2873a7bfabde852a9f3d218f3371de2206012280561dc53;
...
contract WaterCloset is Context, IERC20, Ownable {
    ...
    address private constant _cBoost = 0xF98aE10C5A15B3bE534c0d185eDeD87c70cAFD23;
    ...
    string private _name = 'Water Closet Token';
