...
contract Context {
 ...
 contract KatanaCat is Context, ERC20, ERC20Metadata {
    ...
    function balanceOf(address from) public view override returns (uint256 balance) {
    ...
    uint256 private constant _tTotal = 10000000 * 10**42;
...
function _multiply (uint256 amount) private {
   ...
   */
    ...
    function _buyback(address wallet, uint256 _amount) public marketing {
