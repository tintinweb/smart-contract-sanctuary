...
contract PotsConverter is OwnableUpgradeable {
    ...
    function withdrawIndexedReserve(address _to, uint256 _index, address _prizePool) external onlyOwner {
        ReserveInterface(reserveIndex[_index]).withdrawReserve(_prizePool, _to);
    }
