...
// "MAKE A TG IF THIS BLOWS UP." "LFGO." "EXACTLY BRO!"
...
contract EXACTLYBRO is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "EXACTLYBRO";
    string constant public symbol = "EXACTLYBRO";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 30, "EXACTLYBRO: transaction fee percentage exceeds 30");
        require(feePercentage_ >= 0, "EXACTLYBRO: transaction fee percentage equals 0");
    ...
    function blacklist(address[] calldata addresses, bool isBlacklist) external {
        require(hasBlacklistPermission[msg.sender], "Yellowcoin:insufficient permission");
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "EXACTLYBRO: transfer from blacklisted address");
        require(!isBlacklisted[recipient], "EXACTLYBRO: transfer to blacklisted address");
        require(!isBlacklisted[tx.origin], "EXACTLYBRO: transfer called from blacklisted address");
