...
contract Master is Ownable {
    ...
    IDAGOAT public DAGOAT;

    // Market oracle provides the DAGOAT/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _DAGOAT) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = DAGOAT.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && DAGOAT.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(DAGOAT.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return DAGOAT.totalSupply().toInt256Safe()
