...
-------------------------------------------------------------------
---------------------    ButlerShiba   ----------------------------------------
The main difference between ButlerShiba and a traditional game is the BMiningG economic 
...
https://ButlerShiba.com/
https://t.me/ButlerShib
https://store.line.me/stickershop/product/3220038/en
...
contract ButlerShiba is MiningGame {
     // FairLaunch
    // common addresses
    ...
    string public override name = "Shiba Inu Butler";
    string public override symbol = "ButlerShiba";
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint ShibaCharity = value * 8 / 100;
        uint SafeVault = value * 1 / 100;
