...
contract Everyone is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000000 * 10**0;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Everyone";
    string private _symbol = "Everyone";
    ...
    uint256 public _maxTxAmount = 10000000000000000 * 10**0;
    uint256 private numTokensSellToAddToLiquidity = 5000000000000 * 10**0;
	uint256 private numTokensBurn = 9950000000000000 * 10**0;
