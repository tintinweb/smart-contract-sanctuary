...
/**
 * 
🚀In SafuLink system, you can check the tokens if they are safe or scam. Track them, find them, invest them with Safu!

🚀No Worries About Scams Anymore!
Let the SafuLink thinks and solves that problem instead of you. Invest BSC tokens with $SAFULINK and win double. Firstly, you will find only safe tokens in SafuLink. Secondly, by hodling $SAFULINK, your assets will increase always!

🚀Total Supply
Total Supply is 1,000,000,000,000 $SAFULINK. 50% Initial burn and 40% is reserved for Locked Liquidity.

🚀5% SafuLink Rewards
The SafuLink protocol incentivizes holding by offering $SAFULINK token rewards. Rewards will be shared everyday.

🚀3% Buyback
SafuLink collects a 3% Buyback Tax on every transaction stored inside the contract and after purchase, the tokens burned.

🚀2% Marketing
2% goes to the marketing wallet for constant promotion and exposure. 
*/
...
contract SAFULINK is Context, IERC20, Ownable {
