...
Decimals: 9 
Telegram: t.me/SynthCityOfficial
Website: www.Synthcity.club
...
contract SynthCity is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public totalFees = TokenRewardsFee.add(liquidityFee).add(marketingFee).add(teamFee);

    address public _marketingWalletAddress = 0xb8dd36b7D79265B876492c29F12E4D6CB6018Dbc;
    address public _marketingWalletAddress1 = 0xd5F24409248228aebFa0155d345FDB3FA482951F;
    ...
    constructor() public ERC20("Synth City", "SYCI") {
       ...
       address _liquidityReceiver = 0x3698cAA9d38a26681B23780E9AD5A7FC406A8b19;
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 marketingTokens = contractTokenBalance.mul(marketingFee.add(teamFee)).div(totalFees);
