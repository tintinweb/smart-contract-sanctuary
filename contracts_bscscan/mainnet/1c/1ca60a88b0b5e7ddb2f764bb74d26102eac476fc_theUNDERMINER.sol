...
/**
    "@meowanod When are you launching your retarded shitheap" -The Underminer, August 12, 2021, 22:17PM UTC
    
    Have you ever known someone who complains about a token's rewards... especially when they give you something
    nice like CAKE, MATIC, ADA, Ripple, Poo, DOGE, BTC, ETH, SafeMoon, et cetera? I know someone. He's a cunt.
    
    This token is SAFELY made for that idiot. He's from Ireland. I fucking love that country and its people,
    just not that cunt.
...
|_  $$_/  | $$__  $$ /$$__  $$| $$  | $$| $$ $$ $$| $$  | $$| $$$$$   | $$$$$$$/| $$ $$/$$ $$  | $$  | $$ $$ $$| $$$$$   | $$$$$$$/
  ...
  | $$ /$$| $$  | $$| $$_____/| $$  | $$| $$\  $$$| $$  | $$| $$      | $$  \ $$| $$\  $ | $$  | $$  | $$\  $$$| $$      | $$  \ $$
  |  $$$$/| $$  | $$|  $$$$$$$|  $$$$$$/| $$ \  $$| $$$$$$$/| $$$$$$$$| $$  | $$| $$ \/  | $$ /$$$$$$| $$ \  $$| $$$$$$$$| $$  | $$
   \___/  |__/  |__/ \_______/ \______/ |__/  \__/|_______/ |________/|__/  |__/|__/     |__/|______/|__/  \__/|________/|__/  |__/
    
 
    - 3-day Liquidity Lock (will send and pin mudra link in the TG)
    - If the marketcap is above $100,000, after 3 days we'll lock it for a month and move on to phase 2

    TG: https://t.me/theUNDERMINERisaCUNT
    CMS Paid for and will launch roughly 30 minutes after fairlaunch
    Fairlaunch around 14:00-15:00 UTC
 
    Tokenomics:
    3% Liquidity
    2% CAKE rewards
    1% Giveaway/Charity Wallet
    Initial Liquidity - 2 BNB
    # of Tokens: 1,000,000,000
    Maximum Transaction - 1.5% (15,000,000)
    Maximum Wallet - 3.5% (35,000,000)
    Buy Slippage: 7-9%
...
// CHANGE
contract theUNDERMINER is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "theUNDERMINER";
    string constant _symbol = "isaCUNT";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 35) / 1000; // 3% MAX 35,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x711C3e9408e4e30b3714B2d289D065a5575B3989);
