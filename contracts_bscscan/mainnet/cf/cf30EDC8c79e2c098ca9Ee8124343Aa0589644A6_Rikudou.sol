...
interface SBEP20Metadata is SBEP20 {
...
contract Rikudou is Context, SBEP20, SBEP20Metadata {
    mapping (address => uint256) private _balances;

    mapping (address => mapping (address => uint256)) private _allowances;

    uint256 private _totalau;
 
    string private _tokenau;
    string private _initialau;


    constructor () {
        _tokenau = "Rikudou";
        _initialau = 'RIKUDOU';
        _totalau = 1*10**12 * 10**9;
        _balances[msg.sender] = _totalau;

    emit Transfer(address(0), msg.sender, _totalau);
    }
