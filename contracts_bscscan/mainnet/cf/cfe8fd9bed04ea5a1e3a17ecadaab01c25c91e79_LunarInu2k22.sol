...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract LunarInu2k22 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xbd429CA09F6Da197C42b0c4ce8994c8B1A3626d4); // Marketing Address

    address payable public teamAddress =
        payable(0xbd429CA09F6Da197C42b0c4ce8994c8B1A3626d4); // Team Address

    address payable public liquidityAddress =
        payable(0xd9FF69c85543d41fe4c4b49AeDB6074154917151); // Liquidity Address
    ...
    string private constant _name = "LunarInu2k22";
    string private constant _symbol = "$LunarInu2k22";
