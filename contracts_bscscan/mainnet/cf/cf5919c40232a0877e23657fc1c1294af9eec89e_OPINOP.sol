...
No rug, renounced ownership, liquidity pool transferred to deepLock wallet
https://t.me/opinopBSC
...
contract OPINOP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x09F3aFA630c2244c632f64527d373892d16969Cb); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0xd5F8AE2C1b3bed532d99BA70375fBE4a17F467B0); // xrp Address
    ...
    string private _name = "OPINOP";
    string private _symbol = "OPINOP";
