...
contract OwnableDogecoin is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableDogecoin: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableDogecoin: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DaoDoggy is Context, DAO, OwnableDogecoin {
    ...
    string private _name = 'Dao Doggy';
    string private _symbol = 'Dao Doggy';
