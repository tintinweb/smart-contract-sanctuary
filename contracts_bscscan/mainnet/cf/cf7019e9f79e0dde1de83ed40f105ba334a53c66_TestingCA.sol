...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x6B6804F3D01461fBd56403cf42c49afF1908cC43;
        _token = msg.sender;
    }
...
contract TestingCA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TestingCA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6B6804F3D01461fBd56403cf42c49afF1908cC43;
        devFeeReceiver = 0xA1e9d0b1e8F00f6bedcb41588ACDa3c21D5c690f;
        devFeeReceiver2 = 0x461d7044007f166bD4320de65E552F5e275c19B5;
