...
/**
   ...
   Welcome to BabyItaly
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyItaly
...
contract BabyItaly is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Italy";
    string private _symbol = "BABYITALY";
