...
//Contract
contract Cartoondoge is IBEP20, Ownable {
    ...
    string private constant _name = 'Cartoondoge';  
    string private constant _symbol = 'CARTD';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 1000000000000000 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;   
    uint8 private constant MaxWalletDivider=50; //2% = 80,000,000,000,000
    uint16 private constant SellLimitDivider=50; //2% = 80,000,000,000,000
