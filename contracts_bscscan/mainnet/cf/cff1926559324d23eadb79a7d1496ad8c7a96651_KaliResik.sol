...
/**
   #KaliResik Sidoarjo Jawa Timur
   
   KaliResik's aim is to distribute and help the conservation of Indonesia's river, and thus contribute to a better conditions for all the river.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x301C6cBa52921E281520ef52462e62802b60eE8E;
...
contract KaliResik is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x57132405285881ea2C9904277a405618c050A4C4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KaliResik";
    string private _symbol = "KALIRESIK";
