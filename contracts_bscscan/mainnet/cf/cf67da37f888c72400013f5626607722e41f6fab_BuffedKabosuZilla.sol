...
contract BuffedKabosuZilla is Context, IERC20, Ownable {
    ...
    string private _name = "BuffedKabosuZilla";
    string private _symbol = "BKZ";
    ...
    uint256 public _marketingFee = 1100; // All taxes are divided by 100 for more accuracy.
    ...
    address payable private _marketingWallet = payable(0x1c2F44bDa8F81E9AcFe8F11C1c6cB0F95c269Eb8);
    address payable private _devWallet = payable(0x79Cd545786346257d4d3b8386BD2FE32E5c465B2);
