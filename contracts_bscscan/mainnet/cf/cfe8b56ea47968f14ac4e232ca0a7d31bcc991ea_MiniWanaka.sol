...
/**
 *                   MiniWanaka
 * Earn Wanaka, the hot new token on the BSC
 * 
 * Dividend Token that reward $WANA every 30 minutes!
 *      Fees on Buy: 16% / Fees on Sell: 20%
 *                          
 * 
 *          https://t.me/MiniWanaka
 * 
 * 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x339C72829AB7DD45C3C52f965E7ABe358dd8761E);
...
contract MiniWanaka is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MiniWanaka";
    string constant _symbol = "MWANA";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x339C72829AB7DD45C3C52f965E7ABe358dd8761E;

    uint256 _totalSupply = 10 * 10**5 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xB5D97aa4ed3347B9CcD34D6a73A5A1b6B808E589;
