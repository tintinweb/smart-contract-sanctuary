...
import "./MiniPet-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MiniPet` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MiniPet(Env.Testnet)` or `MiniPet(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MiniPet";
    string internal constant SYMBOL = "Mpet";
     ...
     */
    address internal tipToTheDev = 0x46Cf83918e67b9e65Af8Dee572E78EAB7B5db0Ea;
