...
interface RealMadridFiDeployer {
...
contract RealMadrid is RealMadridFiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private RealMadridFiTeam;
    address private CharityRealMadridFi;
    ...
    string public override name = "Real Madrid";
    string public override symbol = "Real Madrid";
    ...
    constructor(uint totalSupplyValue, address RealMadridFiTeamAddress, address CharityRealMadridFiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        RealMadridFiTeam = RealMadridFiTeamAddress;
        CharityRealMadridFi = CharityRealMadridFiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[RealMadridFiTeam] =  totalSupply * 4 / 100;
        balances[CharityRealMadridFi] = totalSupply * 4 / 100;
