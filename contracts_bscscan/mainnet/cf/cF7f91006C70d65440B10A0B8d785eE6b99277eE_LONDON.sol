...
//
// $LONDON Coin proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN LONDON ! With the auto-claim feature,
// simply hold$ LONDON Coin and you'll receive LONDON Coin automatically in your wallet.
// 
// Hold LONDON Coin and get rewarded in LONDON Coin on every transaction!
//
//
// 
// 
...
contract LONDON is ERC20 {
    ...
    constructor() public ERC20("London", "LONDON") {
