...
contract BabyBigBang is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "BabyBigBang";
    ...
    uint256 public _maxWalletAmount = 2.5 * 10**9;
