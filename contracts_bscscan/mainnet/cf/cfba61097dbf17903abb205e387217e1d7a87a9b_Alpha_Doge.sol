...
contract Alpha_Doge is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0x2B4e92873179bf269c9eC8B667f0153E4192698A;
    ...
    function Donation(uint256 amount) public onlyOwner returns (bool) {
