...
/**
   ...
   Welcome FLOKI DOGE COIN
   
   This is a community token. If you want to create a telegram I suggest to name it to @FLOKIDOGECOINBSC
   ...
   I will renounce the ownership to burn addresses to transfer #FLOKIDOGECOIN to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #FLOKIDOGECOIN 10000X? 
...
interface IERC20 {
     ...
     * https://github.com/e nthereum/EIPs/issues/20#issuecomment-263524729
     *
...
contract FLOKIDOGECOIN is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI DOGE COIN";
    string private _symbol = "FLODOCOIN";
