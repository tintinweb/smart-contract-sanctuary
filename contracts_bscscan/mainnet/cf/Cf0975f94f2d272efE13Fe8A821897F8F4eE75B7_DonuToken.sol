...
contract DonuToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa14e93f17d0Ba1C3AE8b5FbE307d6979F9ea1dd6);
    ...
    string private _name = "DonuToken";
    ...
    function throwthedonut() external onlyOwner {
        _taxFee = 3;
        _liquidityFee = 13;
        _buyTaxFee = 3;
        _buyLiquidityFee = 13;
