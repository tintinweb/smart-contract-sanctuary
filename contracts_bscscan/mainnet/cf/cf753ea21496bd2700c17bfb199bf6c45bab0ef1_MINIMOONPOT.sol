...
contract MINIMOONPOT is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Minimoonpot";
    string constant _symbol = "MINIPOTS";
    ...
    address public marketingFeeReceiver = address(0xbc2153d7219395d322Fe11929470C7684Fd3eBC1);
    ...
    constructor () {
        ...
        TargetToken =  0x3Fcca8648651E5b974DD6d3e50F61567779772A8;   // moonpots rewards = 0x3Fcca8648651E5b974DD6d3e50F61567779772A8;  moonpots address
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
