...
JOIN US HERE  : https://t.me/SquidMetaGame
/**
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SquidMetaGame";
    string internal constant SYMBOL = "SMG";
     ...
     */
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 50; // 2.5% of the total supply
    ...
    address internal marketingAddress =
        0x6ae0684B4a05941817080dc58c177736ac2fA532;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 40, address(this)); // Marketing fee
    }
...
contract SquidMetaGame is SafeToken {
