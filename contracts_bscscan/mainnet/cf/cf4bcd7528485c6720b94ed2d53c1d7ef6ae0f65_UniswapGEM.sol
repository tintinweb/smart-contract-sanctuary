...
/**
   ...
   Welcome to UniswapGEM
   
   This is a community token. If you want to create a telegram I suggest to name it to @UniswapGEMBSC
   ...
   I will renounce the ownership to burn addresses to transfer #UniswapGEM to the community, make sure it's 100% safe.
   ...
   it's the best part of the #UniswapGEM idea, increasing the liquidity pool automatically, 
...
contract UniswapGEM is Context, IERC20, Ownable {
    ...
    string private _name = "UniswapGEM";
    string private _symbol = "UNIGEM";
