...
/**
 *MemeKing BSC Token - New Meme Token To Kill All The Meme Tokens and Wanna Be The King to all Meme Tokens.
 * 100% LP LOCK, OWNERSHIP RENOUNCE AFTER LAUNCH.
 * PLEASE DONT BUY UNTIL LIQUIDITY LOCK.
 * DAILY CMS POSTS, TWITTER PROMOTION
 * web: memekingbsc.io (coming soon)
 * telegram: t.me/MemeKingBSC
*/
...
contract MemeKing is Context,IBEP20,Ownable {
    ...
    string private constant _symbol = "MEMEKG";
