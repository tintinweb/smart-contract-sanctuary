...
A BEP20/ERC20 token with deflationary system. Auto liq + Burn + M&D + Rewards

It will charge a fee on each transaction and this is divided in:
    
    Auto Liquidity fee 3%
    Burn fee 3%
    Marketing and Development listed on contract as 'Charity' fee 5%
...
contract BabyKingRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "Baby King Rabbit";
    string private _symbol = "BKRBT";
    ...
    address public charityWallet = 0xAbd16aa26558a1A4f032C873A74fa8039B52b3eB;
