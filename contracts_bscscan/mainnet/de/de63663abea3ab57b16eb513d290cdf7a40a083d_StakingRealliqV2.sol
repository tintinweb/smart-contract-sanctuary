...
contract StakingRealliqV2 {
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        uint256 rewardtokenPrice = (amount.mul(RLQVAL)).div(1e18);
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address RLQ_WBNB = 0x8851e23156fbDdc584C7899Ad4921D19c45a3596; // RLQ_WBNB pancake pool address
        IERC20 RLQTOKEN = IERC20(0x19bB77FD24fc09Dd0C3E8Ea8b3781172479791E4); // RLQ Token address 

        uint256 WBNBSUPPLYINRLQ_WBNB =(WBNBTOKEN.balanceOf(RLQ_WBNB));
        uint256 RLQSUPPLYINRLQ_WBNB = (RLQTOKEN.balanceOf(RLQ_WBNB));

        uint256 RLQUSDVAL = (((WBNBSUPPLYINRLQ_WBNB.mul(1e18)).div((RLQSUPPLYINRLQ_WBNB))).mul(BNBPRICE)).div(1e18);
        return RLQUSDVAL;
    }
