...
a token made to compensate all those who have suffered from different kind of scams .

believe in this place you will truly find peace .
because our devs are pledged to honesty and transparency.

total Supply
100,000,000,000,000,000 Token

TOKENOMICS
total supply: 100,000,000,000,000,000  (100%)
-burnt tokens: 75,000,000,000,000,000  (75%)
-liquidity tokens: 20,000,000,000,000,000 (20%)
-marketing and more added liquidity: 3,000,000,000,000,000 (3%)
-airdrop and giveaways tokens: 2,000,000,000,000,000 (2%)
-developers tokens : 0 (0%)
...
contract GENTLEBABYDOGE is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 100_000_000_000_000_000; 
    ...
    string private _name = "GENTLE BABY DOGE";
    string private _symbol = "GBDG";
    ...
    uint256 public _tburn = 2;
    uint256 private _previoustburn = _tburn;
  

    uint256 public _Maxpertx = _tTotal/200;
    uint256 public _MaxperWallet = _tTotal/1;
    ...
    address _marketingWallet = 0xB42731F0bb7FE64094548f90900E8a3115a888fb;
