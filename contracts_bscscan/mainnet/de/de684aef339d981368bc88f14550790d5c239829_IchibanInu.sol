...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfB5CE70bdC931a5207aBDf00fA04d9899a9dAc3a;
...
contract IchibanInu is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0xb47a204CF71F8a3Eb5fC1D0Bd935c0Ff5FCB7a78);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "IchibanInu";
    string private _symbol = "ICHI";
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0xb47a204CF71F8a3Eb5fC1D0Bd935c0Ff5FCB7a78)] = true;
