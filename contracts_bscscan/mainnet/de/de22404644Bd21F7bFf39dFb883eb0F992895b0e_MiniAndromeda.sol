...
/* Token contract */
contract MiniAndromeda is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xBdA04eBB73f1BB1a406cC8D6e265807f801F0b7b;
    ...
    // Name and symbol
    string constant _name = "MiniAndromeda";
    string constant _symbol = "MINIME";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 70 / 10000; // 0.7%
    uint256 public _maxSellTxAmount = _totalSupply * 70 / 10000; // 0.7%
