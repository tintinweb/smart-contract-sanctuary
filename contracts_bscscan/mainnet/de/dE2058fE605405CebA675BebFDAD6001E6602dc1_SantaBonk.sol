...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x92b03d465676b23015c8524d888c3f3bb24F11b3;
...
contract SantaBonk is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x166155D46AC5163B34e3132164ad8eE6D1e747cE;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SantaBonk";
    string private _symbol = "SB";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 300;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 150;
