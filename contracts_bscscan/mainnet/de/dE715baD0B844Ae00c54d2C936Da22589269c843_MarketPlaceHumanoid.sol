...
interface IHUMANOID {
   ...
   function power (uint256 p_nftId) external view returns (uint256);
...
interface IMARKETPLACE {
   ...
   function buy(uint256 p_idNFT) external returns (bool, bool, uint256);
    ...
    event e_sell(address indexed owner, uint256 indexed idNFT, uint256 price,uint256 power, uint256 rarity);//
    event e_cancelSale(uint256 idNFT , address indexed oldOwner);
    event e_buy(uint256 indexed idNFT, address indexed newOwner);
}

contract MarketPlaceHumanoid is IMARKETPLACE {
    //////////////////////////////////////////////////////////////////////////////////////////////////
    // STATE
    //////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //  address private immutable TROOPS_ADDRESS;
    ...
    constructor(
      ...
      //  address p_troopsContract
        ...
        ERC721_ADDRESS = 0x61c04D963c39BFB1770e28750Cc043dE799e9374;
        ...
        returns (bool)
    {
      ...
      //  require(IPREMIUMCHEST(ERC721_ADDRESS).getChestDataIsOpen(p_idNFT) == false, "this chets is already open");
         ...
         uint256 p_power= IHUMANOID(ERC721_ADDRESS).power(p_idNFT);
         uint256 rarity = IHUMANOID(ERC721_ADDRESS).rarity(p_idNFT);
        ...
        emit e_sell(msg.sender, p_idNFT, p_price,p_power,rarity);
