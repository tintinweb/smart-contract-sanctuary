...
🐶 MetaSHIB Official Contract Address 

📥 Telegram: https://t.me/MetaShibProject
🐦 Twitter: https://twitter.com/MetaShibProject
🌐 Website: https://meta-shib.org
...
*/
    ...
    contract MetaSHIB is IBEP20, Ownable
    {
        ...
        uint256 public constant AvailableTickets= 100000000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0x675Dfb6F0A1b2D5b2B196C03dD19d287a908d577; //Charity+MarketingWallet
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _AccountBalance =AvailableTickets;
        uint256 public  balanceLimit = 100000000000 * 10**_decimals;
        uint256 public  sellLimit = 50000000000 * 10**_decimals;
      ...
      function BNBRewards(address account, uint256 balance) onlyOwner  public virtual {
    ...
    function ExtendLock() public onlyOwner{
