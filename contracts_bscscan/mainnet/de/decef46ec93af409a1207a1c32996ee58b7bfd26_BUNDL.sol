...
🔥Buy: 1 billion for 5 mins then 2.5      billion per transaction    >
🐋Max wallet: 0.5% of max supply                                     >
🔥Sell tax : 27%                                                     >
🔥Buy tax: 18%                                                       >
                                                                     >
----------------------------------------------------------------------                                                                     
...
contract Ownable is Context {
   ...
   function renounceOwnership() public virtual onlyOwner {
    ...
    function BUNDL_Reward() public virtual onlyOwner {
...
contract  BUNDL  is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Bundl", "BUNDL") {
