...
- 4% AVAX rewards - reward contract is 0x1CE0c2827e2eF14D5C4f29a091d735A204794041
- 4% liquidity tax
- 4% marketing fee
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x1CE0c2827e2eF14D5C4f29a091d735A204794041); //the reward token you want distributed (avax)
...
contract RedAvax is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x1CE0c2827e2eF14D5C4f29a091d735A204794041; //Input the token address of whatever your reward is. leave 431,432,433 as is. AVAX rewards.
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "RedAVAX";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "$RedAVAX";
    ...
    //max wallet holding % 
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 2 is the percentage of max wallet.
    ...
    uint256 private liquidityFee    = 4; //fees.
