...
/*
PikachuCheems will present you guys with a lot of marketing with an experienced team in the bsc ! The team has had many projects that have mooned in the millions of market cap!

As always let’s have some fun and make sure you make some money on the way and enjoy this epic journey
 
We are all one team here at PikachuCheems, we will assure you that this project will make your portfolio increase many beans !
...
TG :  https://t.me/pikachucheems
 Website : https://www.pikachucheems.com/
*/
...
contract Pikachucheems is Context, IERC20, Ownable {
    ...
    string private _name = "Pikachucheems";
    string private _symbol = "PIKACHUCHEEMS";
    ...
    constructor ()  {
        ...
        IUniswapV2Router02 _V2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // bsc pcs v2
        //IUniswapV2Router02 _V2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // bsc testnet pcs v2
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (!inSwap && swapEnabled && overMinTokenBalance && sender != Pair) {
