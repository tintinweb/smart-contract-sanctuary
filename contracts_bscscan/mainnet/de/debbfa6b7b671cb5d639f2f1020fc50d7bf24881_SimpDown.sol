...
contract SimpDownDividendDistributor is IDividendDistributor {
...
contract SimpDown is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SimpDown";
    string constant _symbol = "SNM";
    ...
    */
    ...
    SimpDownDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new SimpDownDividendDistributor(address(router), SIMP);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        SIMP = rewardToken;
        distributor = new SimpDownDividendDistributor(address(router), rewardToken);
    }	
