...
contract Ownable is Context {
    address private _owner = 0x2a80d1B5391b70532088fE95FE6496f81c0812e9;
...
contract AltMan is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x1D5efc5140Bc4224e1660D057Ca4eA6873eeD461); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "AltMan"; // token name
    string private _symbol = "AltMan"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 1000000 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
