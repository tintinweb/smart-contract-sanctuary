...
contract OPPAtoken is ERC20Detailed, Ownable {
    ...
    uint256 private gonMaxWallet = TOTAL_GONS;
    ...
    constructor() ERC20Detailed("OPPA Token", "OPPA", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xcd45DA29a54b048C548C62720dD5552484db3A21;
        marketingFeeReceiver = 0xcd45DA29a54b048C548C62720dD5552484db3A21;
