...
🔪 6% BTC rewards to holders
🔪 6% goes into Liquidity 
🔪 6% marketing wallet

https://t.me/SpookyFloki_Official
*/
...
contract SpookyFloki is ERC20, Ownable {
    ...
    address public BTCTokens = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    ...
    uint256 public _maxWalletLimit = 2000000000 * (10**18);

    uint256 public _BTCRewards = 6;
    uint256 public _feeMarketing = 6;
    uint256 public _feeLP = 6;

    uint256 public _maxBuyWallet = 1000000000 * (10**18);
    ...
    address public _marketingWalletAddress = 0xbb7F22e12edDE7F1EE93A5b3F6F73ecE1125E6E4;
    address public _teamWalletAddress = 0xbb7F22e12edDE7F1EE93A5b3F6F73ecE1125E6E4;
    ...
    constructor() ERC20("SpookyFloki", "SPOO")  {
    ...
    function setFeeMarketing() external onlyOwner{
        }

    function setFeeLP() external onlyOwner{
        }

    function setFees() external onlyOwner{
        }
        
    function setFeeRewards() external onlyOwner{
        }
