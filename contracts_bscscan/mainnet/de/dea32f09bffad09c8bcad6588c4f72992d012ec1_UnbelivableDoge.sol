...
interface IPancakePair {
 ...
 contract UnbelivableDoge is Context, IBEP20, Ownable {
    ...
    uint256 private _numOfTokensToExchange = 3 * 10**6 * 10**9;
    ...
    address payable private _marketingswap;

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "UnbelivableDoge";
    ...
    function restoreAllFee() private {
     ...
     function _transfer(
        ...
        if (contractTokenBalance > 0) {
            ...
            if (
                overMinTokenBalance && !_inSwapAndLiquify && swapAndLiquifyEnabled &&
                sender != pcsV2Pair    
            ) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferETH(payable(_marketingswap), address(this).balance);
        
        emit TokensSwapped(Portion, BalanceReceived, totalBalanceToSend, _marketingswap);
    }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxWallet = _tTotal.div(10**2).mul(100);
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 11;
        _maxWallet = _tTotal.div(10**2).mul(1);
    }   
