...
/**
 * TELEGRAM: HTTPS://T.ME/KrownFloki
 * Website : SOON
 * PINNED IN : 
 * TWITTER INFLUENCERS MARKETING
 * REWARD
 * 7% BUSD REWARD - 4% MARKETING - 4% DEVELOPEMENT
 * TOKENOMICS
...
contract KrownFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xB8ff50AF9a43Baf5811F4cfc5C0C6ff5Ab93638f;
 
    string constant _name = "KrownFloki";
