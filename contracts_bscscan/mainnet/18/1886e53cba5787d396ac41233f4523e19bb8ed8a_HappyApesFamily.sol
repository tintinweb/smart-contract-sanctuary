...
contract HappyApesFamily is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 100000 * 10**8 * 10**18;
    uint256 private minimumTokensBeforeSwap = 100000 * 10**8 * 10**18; 
    uint256 public buyBackSellLimit = 100000 * 10**8 * 10**18;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 100000 * 10**8 * 10**18;
    }
