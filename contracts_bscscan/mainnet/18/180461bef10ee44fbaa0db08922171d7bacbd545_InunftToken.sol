...
/*
InuNFT is an application which is dedicated to ease
the entry level for new investors and thus immensely expand the market capitalization.

InuNFT is a multi-chain platform — you can start selling your NFTs 
from any of the supported blockchains: Solana, Ethereum, BSC, Polygon and many more coming.

Website - https://inunft.app/
Twitter - https://twitter.com/inu_nft
Telegram - https://t.me/InuNFT
TelegramChannel - https://t.me/InuNftOfficialChannel
...
contract InunftToken is Context, IERC20, Ownable {
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma) {
        ...
        dappbuilderAddress = payable(0x204EdF64547f0C2EB0dec834FC5e7747d299492b);
