...
3% fee to marketing wallet payment

1% fee to the developer wallet Address

2% fee to the charity wallet Address


Website :  https://duxdoge.finance/

Telegram: https: https://t.me/OfficialDuxDogecoin, Office Chinese Telegram: https://t.me/DUXDogecoinChina

REDDIT:  u/DuxDogecoin

Note of thanks! TO DEV LABS AND GENTOKENS.COM, contact us at [email protected], telegram: @investorezzy
...
contract DuxDogecoin is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0xaF5b36c1bBDa6A6275bA1bab4a3a07A2d5aCA41E);
    address payable private _developerwalletAddress = payable(0x395a5745d29FE59Da36789880fa7F98cA982563B);
    address payable private _charitywalletAddress = payable(0x32FdDaFa7688CF031114f9862E156d9e0Cc556AF);
    uint256 private constant MAX = ~uint256(0);
    uint8 private _decimals = 9;
    uint256 private _tTotal = 1000 * 10**12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DuxDogecoin";
    ...
    uint256 private _ReflectionFeeAndDeveloperFee = _reflectionFee+_developerFee;
    uint256 private _previousReflectionAndDeveloper = _ReflectionFeeAndDeveloperFee;
    ...
    function removeAllFee() private {
        if(_reflectionFee == 0 && _liquidityAndMarketingFee == 0) return;
         ...
         _ReflectionFeeAndDeveloperFee = _ReflectionFeeAndDeveloperFee;
