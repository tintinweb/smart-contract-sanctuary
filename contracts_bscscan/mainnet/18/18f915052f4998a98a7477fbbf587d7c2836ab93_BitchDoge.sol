...
contract BitchDoge is Context, IBEP20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL,address devAddress, address owner) Ownable(owner) {
        ...
        _maxTxAmount = (_tTotal * 5 / 100000000) * 10 ** _decimals;
        numTokensSellToAddToLiquidity = (_tTotal * 5 / 1000000000) * 10 ** _decimals;
