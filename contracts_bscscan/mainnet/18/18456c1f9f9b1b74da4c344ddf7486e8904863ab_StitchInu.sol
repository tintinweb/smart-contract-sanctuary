...
/**
Welcome to @Stitch_Inu. A new and exciting token on the Binance Smart Chain (BEP20)! At Stitch Inu we aim to shake up BSC. 
With a safe & transparent staff, tested & verified contract, and a strong base of holders, our market cap is sure to blow through the roof! 
Let’s get Stitch to the millions!
...
Tokenomics:
6% Marketing of the token
4% Liquidity Pool to continue to raise the floor price
2% Development of the token

Join Stitch Inu now, enjoy our journey to the millions!

Web: tba
Twitter: tba
Telegram: https://t.me/Stitch_Inu
*/
...
contract StitchInu is IBEP20, Auth {
    ...
    string constant _name = "StitchInu";
    string constant _symbol = "SINU";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // MAX TX 2%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // MAX WALLET 4%
    ...
    address private MARKETINGFeeReceiver = 0x4fde68B5842Fefc85F1D67373B9925A3E6807396; // MARKETING SYSTEM
    address private developmentFeeReceiver = 0xDBb538832E956659f07268B98148806a935c679C;
