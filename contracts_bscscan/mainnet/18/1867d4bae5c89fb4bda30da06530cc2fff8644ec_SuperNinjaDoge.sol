...
import "./SuperNinjaDoge-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SuperNinjaDoge` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SuperNinjaDoge(Env.Testnet)` or `SuperNinjaDoge(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SuperNinjaDoge";
    string internal constant SYMBOL = "SND";
     ...
     */
    address internal tipToTheDev =0xFC4248849df55ac6fE93f4355DFeb38B1e77c61f;
...
contract SuperNinjaDoge is SafeToken{
