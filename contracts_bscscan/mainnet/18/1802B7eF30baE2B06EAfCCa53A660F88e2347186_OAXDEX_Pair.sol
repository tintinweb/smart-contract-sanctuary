...
interface IOAXDEX_Factory {
    ...
    event OraclePairCreated(address indexed token0, address indexed token1, address pair, uint newSize);
    ...
    function oracleTradeFee() external view returns (uint256);
    function oracleProtocolFee() external view returns (uint256);
    function protocolFeeLockedTill() external view returns (uint256);
    ...
    function getOraclePair(address tokenA, address tokenB) external view returns (address pair);
    function allOraclePairs(uint) external view returns (address pair);
    ...
    function allOraclePairsLength() external view returns (uint);

    function setOracle(address from, address to, address oracle) external;
    function addOracle(address from, address to, address oracle) external;
    function setTradeFee(uint256) external;
    function setProtocolFee(uint256) external;
    function setOracleTradeFee(uint256) external;
    function setOracleProtocolFee(uint256) external;
    function setProtocolFeeTo(address) external;
    function setSecurityScoreOracle(address, uint256) external;
    function setLive(bool) external;
    function setLiveForPair(address, bool) external;
    ...
    function createOraclePair(address tokenA, address tokenB) external returns (address pair);
