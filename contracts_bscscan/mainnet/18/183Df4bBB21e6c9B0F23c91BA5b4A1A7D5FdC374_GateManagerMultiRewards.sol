...
import "../infra/IGateManagerMultiRewards.sol";
...
contract GateManagerMultiRewards is ReentrancyGuardUpgradeable, Ownable {
    ...
    address public pots = address(0x3Fcca8648651E5b974DD6d3e50F61567779772A8);
    address public ziggy = address(0x1F50ff82b414d4822FFB2B24939C4Bd931A5fee0);
    ...
    constructor(
        ...
        IERC20Upgradeable(pots).safeApprove(address(ziggy), type(uint256).max);
    }
