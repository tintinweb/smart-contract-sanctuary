...
contract PancakeMOON is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x650789fd2BA19325b1d2321AffA9743eF0b83Dc1); // Marketing Address
    ...
    string private _name = "PancakeMOON";
    string private _symbol = "CakeMOON";
