...
/**
    ...
    Telegram: LittleSpaceDoge
    
    1,000,000,000,000,000 total supply
    5,000,000,000,000 LittleSpaceDoge max limit for per trade
   ...
   I will renounce the ownership to burn addresses to transfer #LittleSpaceDoge to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 10% total supply to the pool
   Can you make #LittleSpaceDoge 100000X? 

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #LittleSpaceDoge idea, increasing the liquidity pool automatically, 
...
contract LittleSpaceDoge is Context, IERC20, Ownable {
    ...
    string private _name = "LittleSpaceDoge";
    string private _symbol = "LSPACEDOGE";
