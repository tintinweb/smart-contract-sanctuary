...
contract DividendDistributor is IDividendDistributor {
    ...
    //SETMEUP, change this to suit your min time of reward dist
    uint256 public minPeriod = 45 minutes; //Holder will be rewarded with BUSD every 45 min
    uint256 public minDistribution = 3 * (10 ** 18); //3% distribution
...
contract BabyShark is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyShark";
    string constant _symbol = "BSK";
    ...
    //You can always edit this in your write UI
    ...
    mapping (address => bool) public _isBlacklisted; //add this to your mappings
    ...
    // Me hate snipers function , manually add their wallets and let them bleed 
    ...
    //but then they to your tg and and beg for mercy, so u dumbfck forgive em 
...
/* Airdrop Begins */
 ...
 function airdrop(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    // blacklist function for snipers , hell yeah!!
