...
contract ShiborgInu is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBORG INU";
    ...
    uint256 public _maxTxAmount = 8000000000 * 10**6 * 10**8;
    uint256 private minimumTokensBeforeSwap = 0 * 10**6 * 10**8; 
