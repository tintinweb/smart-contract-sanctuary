...
contract ElonsMicroToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa1A1E55c669b98D8b6948C21228A9396f2811fAB); 
    address payable public Wallet_Dev = payable(0xa1A1E55c669b98D8b6948C21228A9396f2811fAB);
    ...
    string private constant _name = "Elons Micro Token"; 
    ...
    constructor () {
        ...
        _owner = 0xa1A1E55c669b98D8b6948C21228A9396f2811fAB;
