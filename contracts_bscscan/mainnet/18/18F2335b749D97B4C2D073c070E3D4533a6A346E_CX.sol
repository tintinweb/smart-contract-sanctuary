...
contract CX is Context, IERC20, Ownable {
    ...
    function setTaxFraction(uint16 _taxFraction) external onlyOwner {
        TAX_FRACTION = _taxFraction;
    }

    function disableTaxForAddress(address _address) external onlyOwner {
        nonTaxedAddresses[_address] = true;
    }
