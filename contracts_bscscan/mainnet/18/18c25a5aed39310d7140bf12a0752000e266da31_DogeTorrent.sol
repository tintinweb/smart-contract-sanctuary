...
contract DogeTorrent is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9AD907af0ed50feC7EF51947cbCaceFae5e0751B); // Marketing Address
    address payable public charityAddress = payable(0x9AD907af0ed50feC7EF51947cbCaceFae5e0751B); // Charity/Dev Address
    ...
    string private _name = "Doge Torrent"; // nice
    string private _symbol = "DOGETO";
