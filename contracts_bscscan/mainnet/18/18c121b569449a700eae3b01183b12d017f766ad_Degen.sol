...
contract Degen is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "DegenINU";                                          // name
    string private _symbol = "DEGEN";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x89d0bc3c83b1Dd9BA0b9512159Cc399c7ACe39A8),                             // Dev+Team wallet
        payable(0xb53dc1f9b75237d7bDe202a7500b14Cd8658D48E),                             // Marketing wallet
        payable(0x81424b8eA52cb43728a13F8aA857AFd1aF6aF4e0)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "DegenINU is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "DegenINU is not live yet");
