...
contract DividendDistributor {
    ...
    IERC20 Rw = IERC20(0x43f11c02439e2736800433b4594994Bd43Cd066D); // $Floki main net
...
contract FlokiSkeleton is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Skeleton";
    string private _symbol = "FLOKISK";
    ...
    address payable public marketingWalletAddress = payable(0x9a6A3Bec8892c2FA9C31dE2177f257A0897F4A21); 
    address payable public rewardsWalletAddress = payable(0x789A400B13F1Dd53B11F86bB117C9C74a287A049); 
    ...
    constructor () {
        ...
        _totalTaxIfSelling = _totalTaxIfBuying.add(_BurnFee);
