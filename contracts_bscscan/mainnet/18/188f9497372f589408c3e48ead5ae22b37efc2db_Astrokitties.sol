/*
    ...
    https://t.me/astrokitties
    https://astrokitties.io/
    https://twitter.com/astrokittiesio
...
contract Astrokitties is ERC20, Ownable {
    ...
    AKDividendTracker public dividendTracker;
    ...
    uint256 public immutable fixedSaleStartTimestamp = 1624392000; //June 22, 20:00 UTC, 2021
    ...
    // timestamp for when the token can be traded freely on PanackeSwap
        uint256 public immutable tradingEnabledTimestamp = 1624399200; //June 23, 00:00 UTC, 2021
    ...
    constructor() public ERC20("Astrokitties", "AK") {
    	...
    	dividendTracker = new AKDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        AKDividendTracker newDividendTracker = AKDividendTracker(payable(newAddress));
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "AK: This account cannot send tokens until trading is enabled");
        }
        ...
        if(isFixedSaleBuy) {
            require(block.timestamp >= fixedSaleStartTimestamp, "AK: The fixed-sale has not started yet.");
            ...
            if(!openToEveryone) {
                require(fixedSaleEarlyParticipants[to], "AK: The fixed-sale is only available to certain participants at the start");
            }
...
contract AKDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("AK_Dividend_Tracker", "AK_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "AK_Dividend_Tracker: claimWait must be updated to between 0.5 and 24 hours");
