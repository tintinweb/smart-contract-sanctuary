...
/*
Welcome to 🥸 Daddy Harmony 🥸

🔱 Daddy Harmony token was created to reward holders progressively in terms Harmony ONE tokens starting from a small percentage of rewards to a high percentage.
In essence, the longer you hold the more you earn.

Our plan consists of surprises that shall be delivered each day on a specific timeframe following by raid events organized by PLUS team members.
Always remember, team PLUS is here to stay! 🔱

—— 📊Takenomics 📊——

🔰 Total supply: 1.000.000.000.000 tokens
✅ Transactions fees: 8% (with 3% on LIQ & 5% on MARK)
⚡️ Rewards starting from 2% Harmony ONE
...
contract DaddyHarmony is ERC20, Ownable {
    ...
    constructor() ERC20("Daddy Harmony", "DH")  {
