...
contract MEMELOTTERY is Context, IERC20, Ownable {
    ...
    string private _name = "MEMELOTTERY";
    string private _symbol = "MLOT";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> BeWhale swap when swap+liquify is triggered
