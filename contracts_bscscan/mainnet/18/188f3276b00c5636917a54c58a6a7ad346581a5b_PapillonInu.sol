 ...
 * 
 * Papillon Inu
 * TG: https://t.me/PapillonInuBSC
 * 
 * Papillon Inu token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
 * 
*/
...
contract PapillonInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Papillon Inu";
    string constant _symbol = "PAP";
