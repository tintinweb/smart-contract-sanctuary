...
contract Ownable is Context {
    ...
    address private _ownercd = 0x33A7e7C2f6B3603D8cc2BFd4e22635876489E305;
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 1000000000000000 * 10**3;
    uint256 private _tFeeTotal;
    
    string private _name = "GodLight";
    string private _symbol = "GodLight";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x33A7e7C2f6B3603D8cc2BFd4e22635876489E305;
