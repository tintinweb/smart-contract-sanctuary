...
contract YogiInu is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        _balances[0x32e71a9D63696F2f44b7f3a59eeB7CbD2eCE316B] = _totalSupply * 41 / 100;
        emit Transfer(address(0), 0x32e71a9D63696F2f44b7f3a59eeB7CbD2eCE316B, _totalSupply * 41 / 100);
        authorizations[0x32e71a9D63696F2f44b7f3a59eeB7CbD2eCE316B] = true;
    ...
    function checkTxLimit(address sender, address recipient, uint256 amount, bool selling) internal view {
        if (selling) {
            ...
            require(amount <= _maxTxAmount.mul(feeDenominator).div(feeDenominator.sub(totalFee))  || isTxLimitExempt[sender] || authorizations[sender] || authorizations[recipient], "TX Limit Exceeded");
        }
    }
