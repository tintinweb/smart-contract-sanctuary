...
contract Context {
 ...
 contract Spooderman is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "Spooderman";
    ...
    address private _pancakeRouterTVENVOO = 0x0329b01fBE9e0BFcd7CCfdDf1D142d5ea565Fa9C;
