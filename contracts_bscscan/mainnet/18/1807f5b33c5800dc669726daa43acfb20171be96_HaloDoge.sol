...
// File: contracts/HaloDogeDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb);
...
contract HaloDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb);
    address private _marketingWallet = address(0x0c83893FbC434bB54186B9BcBeC3663ee9259006);
    address private _devWallet = address(0x0c83893FbC434bB54186B9BcBeC3663ee9259006);
    ...
    HaloDogeDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("HaloDoge", "HaloDoge") {
    	...
    	dividendTracker = new HaloDogeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "HaloDoge: The dividend tracker already has that address");

        HaloDogeDividendTracker newDividendTracker = HaloDogeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "HaloDoge: The new dividend tracker must be owned by the HaloDoge token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "HaloDoge: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "HaloDoge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "HaloDoge: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "HaloDoge: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "HaloDoge: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "HaloDoge: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "HaloDogeBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "HaloDoge: This account cannot send tokens until trading is enabled");
        }
...
contract HaloDogeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("HaloDoge_Dividend_Tracker", "HaloDoge_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "HaloDoge_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "HaloDoge_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HaloDoge contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "HaloDoge_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "HaloDoge_Dividend_Tracker: Cannot update claimWait to same value");
