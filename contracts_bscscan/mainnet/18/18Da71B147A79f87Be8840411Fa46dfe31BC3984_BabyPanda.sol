...
╚═════╝ ╚═╝  ╚═╝╚═════╝    ╚═╝   ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝ ╚═╝  ╚═╝
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #BabyPanda

    I make this #BabyPanda to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BabyPanda_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #BabyPanda to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #BabyPanda 10000000X? 
   ...
   it's the best part of the #BabyPanda idea, increasing the liquidity pool automatically, 
...
contract BabyPanda is Context, IERC20, Ownable, Pausable {
