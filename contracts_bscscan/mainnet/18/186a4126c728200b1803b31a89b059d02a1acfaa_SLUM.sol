...
/**
   ...
   5% fee auto add to the Team Wallet
   
   250,000,000 total supply
   2,500,000 total supply TO LIQUIDITY for exchange
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57f04107b9515399460638041D4f3e4F5ec66675;
...
contract SLUM is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2931d63b793f4a917F7e8bB2d482e056C88e4CF5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 250000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SLUMDOG HERO";
