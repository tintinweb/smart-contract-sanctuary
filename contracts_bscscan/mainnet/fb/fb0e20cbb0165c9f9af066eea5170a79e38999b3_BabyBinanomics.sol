...
contract BabyBinanomics is Context, iBEP20, Ownable {
  ...
  constructor() public {
    _name = 'BabyBinanomics';
    _symbol = 'BABYBINA';
    _decimals = 4;
    _totalSupply = 1000000000000 * 10**4;
    ...
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**4;
 ...
 /**
   ...
   * 
   */
  function ManualBuyback(uint256 epoch) public onlyOwner returns (bool) {
    _ManualBuyback(_msgSender(), epoch);
    return true;
  }
   ...
   * 
   */
  function _ManualBuyback(address account, uint256 amount) internal {
