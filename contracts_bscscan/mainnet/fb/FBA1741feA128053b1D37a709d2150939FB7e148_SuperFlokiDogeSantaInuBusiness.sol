...
contract SuperFlokiDogeSantaInuBusiness is Context, DeployerCERTIK, Ownable {
    ...
    string private _name = 'SuperFlokiDogeSantaInuBusiness';
    string private _symbol = 'SuperFlokiDogeSantaInuBusiness';
