 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/SquidDogeSanta
 * 
 * 
 * SquidDogeSanta token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract SquidDogeSanta is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SquidDogeSanta";
    string constant _symbol = "SDS";
