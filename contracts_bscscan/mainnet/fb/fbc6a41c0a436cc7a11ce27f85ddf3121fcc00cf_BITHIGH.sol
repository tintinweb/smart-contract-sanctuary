...
//project - BITHIGH
//telegram-https://t.me/BitHighCoin
//website-https://www.bithigh.io/
//twitter-https://twitter.com/bithighcoin
...
/**
 * @title BITHIGH ERC20 token
 * @dev
 *      Based on the Ampleforth & Safemoon protocol.
 */
contract BITHIGH is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _deadBurn, address payable _marketingAddress)
        ERC20Detailed("BITHIGH", "BITHIGH", uint8(DECIMALS))
        payable
        public
    {
        deadBurn = _deadBurn;
