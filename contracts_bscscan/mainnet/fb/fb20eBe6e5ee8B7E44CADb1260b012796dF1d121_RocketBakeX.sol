...
// CHANGE
contract RocketBakeX is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "RocketBakeX";
    string constant _symbol = "$RBakeX";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xe6df1b12ADf88AA43E5e8C724605dABF7f8a1E21);
