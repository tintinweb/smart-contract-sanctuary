...
// 3 beans 1 dev cucks, this is a dummies guide on how to copy and paste you cant fuck this up
// Step 1: copy and paste, the entire thing and paste it into Remix IDE 
// Step 2:line 157 change this to the dev wallet
// step 3: line 377 change this to what you want to call your token
// steo 4: line 400-402 change these to your wallets of choice.
// line 414 change the details.
//  from 418, you will be able to set the taxes, this one is a test so all has been put to 0.
// step 5: on the left hand side, look for the complier change it to 0.8.6, check the optimisation box
 // step 6: compile 
 // once that is done go to the icon above the plug on the left, it should say deploy and run txs
 // change enviroment to web3 injected, connect the dev wallet go to contract should be a drop down
 // select the one with your token name so for example '3beans - contracts/.sol'
 // deploy.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4292DF09e6334bebe4Ea4aFd3D3e4eCA8E0f558C;
...
contract threebeans is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0xf65D9322A55f90C0f6e678682474301A1F21B0E7); 
    address payable private Wallet_Token_Burn = payable(0x30EFab94472c63e624C4F61C3198273a913ecd0f); 
    address payable private Wallet_Dev = payable(0x58c91BC56afABe79f5B26C05bA3f04b6120d84E5); 
    ...
    string private _name = "3beans"; 
    string private _symbol = "1DEV";  
