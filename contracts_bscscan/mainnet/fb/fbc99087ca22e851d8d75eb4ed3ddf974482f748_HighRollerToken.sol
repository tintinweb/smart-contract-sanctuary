...
/*
HighRoller Token - Based On Elon Musk's Tweet
Telegram: https://t.me/highrollertoken
*/
...
contract HighRollerToken {
    string  private _name = 'HighRoller Token';
    string  private _symbol = 'HROLL';
    ...
    constructor () {
        ...
        setLimits(3000000000, 1500000000, 500000000);
        setFees(3, 3);
    }
