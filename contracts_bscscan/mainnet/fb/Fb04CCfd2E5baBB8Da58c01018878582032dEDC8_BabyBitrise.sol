...
contract BabyBitrise is IERC20 {
    ...
    string constant _symbol = "BBRISE";
    ...
    uint256 public _buyBackFees = 0;
    uint256 public _buyLottoFee = 0;
    ...
    address payable private _marketingWallet = payable(0xa01e4EfbA166176C79F64b92099e4B873daa36b4) ;//Put your marketing address here
    address payable private _lottoWallet = payable(0xC645aed8663b2EE36fBeb95F63B1aB869556F514) ;// Enter lotto wallet here also
