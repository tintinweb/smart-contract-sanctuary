...
contract LEAP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Leap Lottery";
    string private constant _symbol = unicode"LEAP";
    ...
    function sendETHToFee(uint256 amount) private {
        payable(0x1Dd80cf2E26ec6727e0f281927BD05967e3CCa54).transfer(amount.div(2));
