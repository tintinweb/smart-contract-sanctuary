...
contract DexIRA is ERC20, Ownable {
    ...
    // uint256 public maxSellTransactionAmount = 1000000000000000 * (10**18); // @note Equals 1e+33

    uint256 public swapTokensAtAmount = 100 * 10 ** 9 * (10**9); // @note Equals 1e+20
    // uint256 public swapTokensAtAmount = 100000000000 * (10**18); // @note Equals 1e+29
    ...
    constructor() ERC20("TEST_2B_Dex", "TEST_2B_Dex", 9) {
        ...
        */
        ...
        // _mint(owner(), 1000000000 * (10**18)); // @note Equals 1e+27 | Set supply to 1,000,000,000 (with override)
        _mint(owner(), 1 * 10**9 * (10**9)); // @note Equals 1e+18 | Set supply to 1,000,000,000 (without override)
    }
    ...
    function _transfer(
        ...
        // @note Disabled holderSellFactor penalty
...
contract DexIRADividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("TEST_2B_Dex_Dividend_Tracker", "TEST_2B_Dex_Dividend_Tracker", 9) {
    	claimWait = 3600;

        // minimumTokenBalanceForDividends = 30 * 10 ** 9 * (10**9); // @note Equals 3e+19 | Must hold 30,000,000,000+ for dividends
        // minimumTokenBalanceForDividends = 10000 * (10**18); // @note Equals 1e+22
        minimumTokenBalanceForDividends = 10000 * (10**9); // @note Equals 1e+13 | Must hold a minimum of 10K+ for dividends

        // 100 * 10 ** 9 * (10**9); // @note Equals 1e+20 |
        // 1 * 10 ** 12 * (10**9); // @note Equals 1e+21 |
        // 100000000000 * (10**18); // @note Equals 1e+29 |
        // 1000000000000000 * (10**18); // @note Equals 1e+33 |
    }
