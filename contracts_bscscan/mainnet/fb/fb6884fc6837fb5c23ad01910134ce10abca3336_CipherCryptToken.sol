...
/**
    Cipher Crypt Project
    steganography based NFT's

    Twitter : @Cipher_Crypt
    Website: http://ciphercrypt.tech
    Telegram: t.me/cipher_crypt
*/
...
contract CipherCryptToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cipher Crypt Token";
    string private _symbol = "$CIP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xe05ACC0094f06045D45f9fa2Ee2719Fa4bC7189E); 
    address payable public BuyBackWalletAddress = payable(0xe05ACC0094f06045D45f9fa2Ee2719Fa4bC7189E); 
    ...
    uint256 private _totalSupply = 1000000000000 * 10**3 * 10**18;
    uint256 public _maxTxAmount = 30000000000 * 10**3 * 10**18;
    uint256 public _walletMax = 30000000000 * 10**3 * 10**18;
    uint256 private minimumTokensBeforeSwap = 10000 * 10**3 * 10**18; 
