...
/*
⚡️ Welcome everyone to BumbleBeetcoin⚡️

We are a rewards token with a goal in mind of saving the Bees, Earn BTC rewards and do your bit for the earth ⚜️
...
🌍 Web: BumbleBeetcoin.com
🔈Telegram: @Bumblebeetcoin
*/
...
contract Bumblebeetcoin is ERC20, Ownable {
    ...
    constructor() ERC20("BumbleBeetcoin", "BBTC")  {
    ...
    uint256 public liquidityFee = 3;
        ...
        function setBTCrewards(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
