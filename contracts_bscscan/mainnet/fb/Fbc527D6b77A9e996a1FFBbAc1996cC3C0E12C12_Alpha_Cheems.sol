...
contract Alpha_Cheems  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address payable public marketingAddress = payable(0xe9139E3377F2e8ecD4Ca7494fF34B37Ed8e7C820); // Marketing Address
    ...
    string private _name = "Alpha Cheems";
    string private _symbol = "Alpha Cheems";
