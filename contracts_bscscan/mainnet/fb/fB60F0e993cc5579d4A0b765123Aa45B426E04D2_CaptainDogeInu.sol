...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #CaptainDogeInu

    I make this #CaptainDogeInu to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/CaptainDogeInu_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #CaptainDogeInu to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49.5% total supply to the pool
   Can you make #CaptainDogeInu 10000000X? 
   ...
   it's the best part of the #CaptainDogeInu idea, increasing the liquidity pool automatically, 
...
contract CaptainDogeInu is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "CaptainDogeInu";
  string private _name = "CaptainDogeInu";
