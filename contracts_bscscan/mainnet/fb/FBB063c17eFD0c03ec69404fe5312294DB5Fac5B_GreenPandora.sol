...
contract SNIPER is AntiBots {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "SNIPER: caller is not the owner");
        _;
    }
...
contract GreenPandora is AntiBots, IBEP20, SNIPER {
    ...
    string private _name = 'Green Pandora';
    string private _symbol = 'GreenPandora';
