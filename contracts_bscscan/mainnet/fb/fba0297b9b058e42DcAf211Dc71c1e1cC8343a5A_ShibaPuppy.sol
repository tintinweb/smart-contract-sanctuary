...
contract ShibaPuppy is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaPuppy";
    ...
    address public marketingWallet = 0x86c4b57E7390895317C6b6c272a128305940f710;
    ...
    function setBoxerMarketingWallet(address newWallet) external onlyOwner() {
