...
//WBNB REWARD FOR SOMEONE WHO SELLS THEIR TOKEN TO ALL HOLDERS

//https://t.me/bnbslurper
//STEALTH LAUNCH LP-CAKE WILL BE LOCK FOR 1 YEAR
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BWBNB = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BWBNB.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BWBNB);
        ...
        uint256 amount = BWBNB.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BWBNB.transfer(shareholder, amount);
...
contract BNBSLURPER is IBEP20, Auth {
    using SafeMath for uint256;

    address BWBNB = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BNB Slurper";
