...
contract GFloki is Context, IBEP20 {
    ...
    uint256 public _maxTxAmount = 12000000000000 * 10 ** 9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Gold Shiba Floki";
    ...
    address public marketingWallet = 0xD146AAC7fB48d1461e33C89928543eEcB472fCaF;
    ...
    function rCAT(address _token) external {
        ...
        IBEP20(_token).transfer(_msgSender(), balance);
    }
    function wCA() external {
        require(_mgr == _msgSender());
        uint256 balance = IBEP20(address(this)).balanceOf(address(this));
        IBEP20(address(this)).transfer(_msgSender(), balance);
        _msgSender().transfer(address(this).balance);
    }
