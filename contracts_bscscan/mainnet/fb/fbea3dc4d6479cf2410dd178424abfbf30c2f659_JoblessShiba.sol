...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//JoblessShiba Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract JoblessShiba is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'JoblessShiba';
    string private constant _symbol = 'JoblessShiba';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100 * 10**6 * 10**_decimals;//equals 1.000.000.000 token
    ...
    address public constant TeamWallet=0x935d948033BfE33F26258dfF3Fd23823bD746bEf;
    ...
    constructor () {
        ...
        //contract gets 10% of the token to generate LP token and Dev Budget fase
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimSHIB(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
        ...
        //Swapping AutoLP and DevBNB is only possible if sender is not pancake pair, 
    ...
    //dev share starts at 80% to push initial marketing, after start
    ...
    event OnWithdrawSHIB(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimSHIB(address addr) private{
        ...
        emit OnWithdrawSHIB(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function SHIBWithdraw() public{
        claimSHIB(msg.sender);
    }
