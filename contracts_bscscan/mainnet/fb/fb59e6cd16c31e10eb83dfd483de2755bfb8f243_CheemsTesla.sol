...
contract CheemsTesla is Context, IERC20, Ownable, specialEvent {
    ...
    string private _name = "CheemsTesla";
    string private _symbol = "CHTESLA";
