...
contract Marketplace is IERC721Receiver, Auth {
    ...
    function executeTrade(uint tradeId) external {
        ...
        uint totalFee = (trade.tokenPrice * (tradeFee + wbnbReflectRewardsFee)) / 10000;

        require(token.transfer(trade.poster, trade.tokenPrice - totalFee), "Token transfer failed.");
