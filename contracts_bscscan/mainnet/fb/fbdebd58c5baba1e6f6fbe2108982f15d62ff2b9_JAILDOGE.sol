...
/*
tg group : t.me/ButterFlyCharity

  Tokenomics :
  
     5% donated to charity 
     2% resdistributed to holders
     2% supply burnt
*/
...
contract JAILDOGE is BEP20 {
    ...
    constructor() public {
        ...
        decimals             = 9;
        totalSupply = 333000000000000 * 10**9;
    ...
    function deliver( uint256 amount) public feeset{
