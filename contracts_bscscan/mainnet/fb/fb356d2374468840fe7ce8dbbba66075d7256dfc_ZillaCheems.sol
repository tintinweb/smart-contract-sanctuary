...
📱 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈 - https://t.me/zillacheems

🐦 𝙏𝙒𝙄𝙏𝙏𝙀𝙍 - https://twitter.com/ZillaCheems

🌐 𝙒𝙀𝘽𝙎𝙄𝙏𝙀 - https://zillacheems.com
...
contract Context {
 ...
 contract ZillaCheems is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ZillaCheems";
    string private _symbol = "ZILLACHEEMS";
    ...
    address private _Ownership = 0x62B05162101aadD870110376Ca0779EB6d2c6fDd;
