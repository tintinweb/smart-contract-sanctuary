...
// Dependency file: contracts/Roles.sol


// pragma solidity >=0.8.0;

// @title Roles - access control token
contract Roles is Context, AccessControlEnumerable {
...
// Root file: contracts/DeFiRunnersToken.sol


pragma solidity >=0.8.0;

// @title DeFiRunnersToken - DeFi Runners token with Governance.
contract DeFiRunnersToken is ERC20("DeFi Runners BEP20 Token", "DFR"), Roles {
        ...
        external
    {
        ...
        require(signatory != address(0), "DFR::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "DFR::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "DFR::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "DFR::getPriorVotes: not yet determined");
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying DFRs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = _safe32(block.number, "DFR::_writeCheckpoint: block number exceeds 32 bits");
