...
contract PolySwap is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 800000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _totalSupply));
    uint256 private _tFeeTotal;

    string private _name = "Poly Swap";
    string private _symbol = "BABYANON";
