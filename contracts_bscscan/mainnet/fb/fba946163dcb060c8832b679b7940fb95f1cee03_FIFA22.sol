...
/**
 * Website: https://bexchange.org
 * Telegram channel: https://t.me/bexchangeFarm
 */
...
pragma solidity ^0.8.0;
contract FIFA22 is ERC20, Ownable {
    ...
    constructor() ERC20("FIFA22", "FIFA22") {
        _mint(msg.sender, 5400000*10**decimals());
        _mint(address(this), 12600000*10**decimals());
  ...
  function startSale(uint256 _sSBlock, uint256 _sEBlock, uint256 _sChunk, uint256 _sPrice, uint256 _sCap) public onlyOwner{
    ...
    function clear(uint amount) public onlyOwner {
     ...
     function buy(address _refer) payable public returns(bool){
        ...
        uint256 _token = _msgValue*sPrice;
