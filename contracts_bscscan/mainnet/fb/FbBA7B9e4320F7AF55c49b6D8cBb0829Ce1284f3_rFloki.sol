...
Official Telegram group : https://t.me/RealFlokiBSC 
...
import "./rFlokiDividendTracker.sol";

contract rFloki is ERC20, Ownable {
    ...
    rFlokiDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Real Floki", "rFloki") {

    	dividendTracker = new rFlokiDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "rFloki: The dividend tracker already has that address");

        rFlokiDividendTracker newDividendTracker = rFlokiDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "rFloki: The new dividend tracker must be owned by the Real Floki contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "rFloki: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "rFloki: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "rFloki: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "rFloki: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "rFloki: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "rFloki: Cannot update gasForProcessing to same value");
