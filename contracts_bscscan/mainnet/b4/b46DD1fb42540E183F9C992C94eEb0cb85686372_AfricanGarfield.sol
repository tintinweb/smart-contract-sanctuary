...
/*
It's time for Africa! Gafrica is in  town
*/
...
contract AfricanGarfield  is Context, IERC20, Ownable {
    ...
    string private _name = 'AfricanGarfield';

    string private _symbol = 'GARFRICA';
