...
/**
 IMPORTANT: As CWB will be going live today only  believe the contracts sent by me or one of the admin, we are the only ones responsible for this token.
Call all friends, neighbors, and relatives to be part of our community we are not doing just one in cryptocurrency but a mass awareness work, we will open the minds of many people and show the strength the CWB community has.

TG :https://t.me/cwbofficial

 we will launch our token today 

Update: All diamond hands will definately be rewarded we are always thinking of the best for our community.
*/
...
contract CWB is Context, IERC20, Ownable {
    ...
    string private _name = "CWB Token";
