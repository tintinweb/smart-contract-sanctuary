...
/**
 Telegram: https;//t.me/AngryFloki
 *
 */
...
/* Token contract */
contract AngryFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB8ff50AF9a43Baf5811F4cfc5C0C6ff5Ab93638f;
    ...
    // Name and symbol
    string constant _name = "AngryFloki";
    string constant _symbol = "AngryFloki";
    ...
    uint256 public swapThreshold = _totalSupply * 200 / 10000; // 0.1% of supply
