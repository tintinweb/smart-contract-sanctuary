...
You can buy up to 1000 Tokens.
You can sell 10 Token every day.
You can not transfer Tokens from wallet to wallet.


You may join the Telegram group: https://t.me/The100Token
*/
...
contract The100 is IBEP20, Auth {

	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

	string constant _name = "The100";
    string constant _symbol = "100";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10000 * (10 ** _decimals);
    uint256 private _maxTxAmountBuy = _totalSupply / 1000;
    uint256 private _maxTxAmountSell = _totalSupply / 100000;
	uint256 private _maxWalletAmount = _totalSupply / 1000;
    uint256 public _maxBuyToken = 1000;
    uint256 public _maxSellToken = 10;
    uint256 public _maxWalletToken = 1000;
