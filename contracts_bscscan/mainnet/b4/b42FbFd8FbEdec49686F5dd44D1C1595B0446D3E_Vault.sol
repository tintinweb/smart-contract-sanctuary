...
contract Vault is ERC20Upgradeable, IVault, IUpgradeSource, ControllableInit, VaultStorage {
  ...
  */
  ...
  function withdraw(uint256 numberOfShares) override external {
    ...
    if (lockEnabled) {
      require(userLastDeposit[msg.sender].add(lockDelay) < block.timestamp, "deposit is freezed");
    }
  ...
  function _deposit(uint256 amount, address sender, address beneficiary) internal {
    ...
    userLastDeposit[beneficiary] = block.timestamp;
  ...
  */
  ...
  function enableLock(bool _bool) public onlyGovernance {
    lockEnabled = _bool;
  }

  function setLockDelay(uint256 _delay) public onlyGovernance {
    lockDelay = _delay;
  }
}
