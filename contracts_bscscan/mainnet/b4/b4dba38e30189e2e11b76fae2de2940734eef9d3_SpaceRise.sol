...
/*
    I make this #SR to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/SpaceRise
...
Great features:
   ...
   I will renounce the ownership to burn addresses to transfer #SR to the community, make sure it's 100% safe.

   I will add 0.3 BNB and all the left 49.5% total supply to the pool
   Can you make #SR 10000000X? 
   ...
   it's the best part of the #SR idea, increasing the liquidity pool automatically, 
...
contract SpaceRise is Context, IERC20, Ownable {
    ...
    string private _name = 'SpaceRise';

    string private _symbol = 'SR';
