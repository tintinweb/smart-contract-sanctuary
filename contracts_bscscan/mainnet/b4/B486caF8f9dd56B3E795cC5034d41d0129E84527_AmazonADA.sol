...
contract AmazonADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    AmazonADADividendTracker public dividendTracker;
    ...
    constructor() public ERC20("AmazonADA", "$AmazonADA") {

    	dividendTracker = new AmazonADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        AmazonADADividendTracker newDividendTracker = AmazonADADividendTracker(payable(newAddress));
...
contract AmazonADADividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("AmazonADA Dividends", "AmazonADA_dividends") {
    	claimWait = 3600;
