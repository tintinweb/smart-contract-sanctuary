...
contract THEWINNERDOGE is TWDDOGE, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtTWDDOGE;
    address private CharityTWDDOGE;
    ...
    string public override name = "THE WINNER DOGE";
    string public override symbol = "TWD";
    ...
    constructor(uint totalSupplyValue, address TeamtTWDDOGEAddress, address CharityTWDDOGEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtTWDDOGE = TeamtTWDDOGEAddress;
        CharityTWDDOGE = CharityTWDDOGEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtTWDDOGE] = totalSupply * 45 / 100;
        balances[CharityTWDDOGE] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's TeamtTWDDOGE pot
