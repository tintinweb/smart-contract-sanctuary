...
contract GangsterDoge {
    string  private _name = 'GangsterDoge';
    string  private _symbol = 'GangsDoge';
    ...
    uint256 public HEX_MAX_NUM = 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffd;
