...
contract AT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pallas Athena";
    string private _symbol = "Athena";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x67b34453B97C93AafA11e14D576EA4Ae50bA7383);
    address payable public teamWalletAddress = payable(0x67b34453B97C93AafA11e14D576EA4Ae50bA7383);
