...
pragma solidity ^0.6.12;
    ...
    contract MIGHTYZILLA is Context, IERC20, Ownable {
        ...
        uint256 private _buystaketaxFee = 3; 
        uint256 private _buyMarketingPoolFee = 2;
        uint256 private _selltaxFee = 5; 
        uint256 private _sellstaketaxFee = 3; 
        ...
        uint256 private _maxTxAmount = 500000000000 * 10**9;
        // We will set a minimum amount of tokens to be swaped => 500K
        uint256 private _numOfTokensToExchangeForMarketingPool = 100000000 * 10**9;
