...
contract MetaFishToken is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _whitelistTransfer;
    ...
    modifier onlyWhitelistTransfer() {
        require(_whitelistTransfer[msg.sender] == true);
        _;
    }
    constructor () {
        ...
        _whitelistTransfer[address(this)] = true;
        _whitelistTransfer[_routerAddress] = true;
        _whitelistTransfer[owner()] = true;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 _minimumTokensBeforeSwap) external onlyOwner() {
        ...
        emit SetNumTokensSellToAddToLiquidity(_minimumTokensBeforeSwap * 10**18);
    }
    ...
    function addWhitelistTransfer(address account) external onlyOwner() {
        _whitelistTransfer[account] = true;
    }

    function removeWhitelistTransfer(address account) external onlyOwner() {
        _whitelistTransfer[account] = false;
    }

    receive() external onlyWhitelistTransfer payable {}
}