...
contract testdash is ERC20, Ownable {
    ...
    uint256 public swapTokensDivisor = 50000000;
    ...
    function setSwapTokensDivisor(uint256 amount) external onlyOwner {
        swapTokensDivisor = amount;
    }
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >=
            (_totalSupply / swapTokensDivisor);
        ...
        if (
            ...
            contractTokenBalance = (_totalSupply / swapTokensDivisor);
