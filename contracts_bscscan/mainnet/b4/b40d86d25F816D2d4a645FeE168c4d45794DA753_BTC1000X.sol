...
contract BTC1000X is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "BTC1000X";
    string private _symbol = "BTC1000X";
    ...
    uint256 public _maxWalletAmount = 800000000 * 10**9;
