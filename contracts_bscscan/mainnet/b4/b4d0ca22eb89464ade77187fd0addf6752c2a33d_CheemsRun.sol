...
/**
_______ _     _ _______ _______ _______ _______  ______ _     _ __   _
|       |_____| |______ |______ |  |  | |______ |_____/ |     | | \  |
|_____  |     | |______ |______ |  |  | ______| |    \_ |_____| |  \_|
CheemsRun
Community Token
3% Liquidity 12% Marketing
1% Max Wallet
TG: https://t.me/CheemsRun
www.cheems.run
*/
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 BETH = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
...
contract CheemsRun is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BETH = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "CheemsRun";
   string constant _symbol = "CHEEMSRUN";
   ...
   uint256 liquidityFee = 300; // 300
   uint256 buybackFee = 0; // 0
   uint256 reflectionFee = 0; // 0
   uint256 marketingFee = 1200; // 1200
   uint256 totalFee = 1500; // 1500
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x8Ce1f4A5BC98bf5cE70b155a984644B816009B85;
