...
contract EGOIST is Context, IERC20, Ownable {
    ...
    string private _name = "EGOIST";
    string private _symbol = "EG";
    ...
    address payable public marketingWallet = payable(0x6574c27388f84cb8072c929AD533eFa405FAA9a0);
