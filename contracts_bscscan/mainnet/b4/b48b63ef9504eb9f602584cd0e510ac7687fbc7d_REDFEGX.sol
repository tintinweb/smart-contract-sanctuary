...
contract REDFEGX is Context, IERC20, IERC20Extented, Ownable {
    ...
    string private constant _symbol = "$RFEGX";
    ...
    uint256 public _sellReflectionFee = 6;
    ...
    address payable constant private _marketingAddress = payable(0xde5bd2A0a55A0e4f2eF637dD0321C13b6D6973D9);
    address payable constant private _buybackAddress = payable(0xde5bd2A0a55A0e4f2eF637dD0321C13b6D6973D9);
    address payable constant private _projectMaintainence = payable(0xde5bd2A0a55A0e4f2eF637dD0321C13b6D6973D9);
    ...
    address public _oraclePriceFeed = 0xde5bd2A0a55A0e4f2eF637dD0321C13b6D6973D9;//rinkeby 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
