...
contract MiniADA is IBEP20, HADAAuth {
    using SafeMath for uint256;
    ...
    uint256 liquidityFee = 1500;
    uint256 buybackFee = 0;
    uint256 reflectionFee = 600;
    uint256 marketingFee = 400;
    uint256 totalBuyFee = 2500;
    uint256 totalSellFee = 4500;
    ...
    uint256 public swapThreshold = _totalSupply / 5000; // 0.02% 200mil uni
    bool inSwap;
