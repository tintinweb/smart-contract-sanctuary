...
/**
 * 
 * PandoraPapers is a fair launched, low-tax coin that is commemorating the historic event for biggest world wide leak after WikiLeaks.
 * TG: t.me/pandorapapersbsc
 * 
 * Join PandoraPapers community now and get your seat on next world wide leak!
*/
...
contract PandoraPapers is Context, IERC20, Ownable {
    ...
    string private _name = "PandoraPapers";
