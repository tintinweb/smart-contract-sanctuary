...
contract YAFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2E7B2BFf1e49065eEa25204AF6460Ff6DFa4C537); // Marketing Address
    address payable public charityAddress = payable(0x2E7B2BFf1e49065eEa25204AF6460Ff6DFa4C537); // Charity/Dev Address
    ...
    string private _name = "YA Finance";
    string private _symbol = "YA";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 200000000000000000000000000; // 200,000,000; token will be given on airdrop
