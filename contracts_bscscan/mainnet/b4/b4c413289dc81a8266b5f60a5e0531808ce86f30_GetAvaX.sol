...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0x1CE0c2827e2eF14D5C4f29a091d735A204794041);
...
contract GetAvaX is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public currentlyServing = "AVAX";

    string constant _name = "GetAvaX";
    string constant _symbol = "GAVX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; //0.5% of total supply
