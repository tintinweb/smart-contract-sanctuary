...
Earn PVU token  holding PlantVsUndeadFarm

TG: https://t.me/pvufarm
https://www.plantvsundeadfarm.online
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PVU= IBEP20(0x31471E0791fCdbE82fbF4C44943255e923F1b794);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PVU.balanceOf(address(this));
        ...
        uint256 amount = PVU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PVU.transfer(shareholder, amount);
...
contract PVUFarm is IBEP20, Auth {
    using SafeMath for uint256;

    address PVU = 0x31471E0791fCdbE82fbF4C44943255e923F1b794;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Plant vs Undead Farm";
    string constant _symbol = "PVUFARM";
