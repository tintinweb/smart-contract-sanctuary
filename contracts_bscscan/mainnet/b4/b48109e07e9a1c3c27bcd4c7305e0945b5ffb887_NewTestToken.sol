...
contract NewTestToken is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8440370dE7853D9D6786941916f90c945dCBAe9D); // Marketing Address
    ...
    string private _name = "NewTestToken";
    string private _symbol = "NEWTESTTOKEN";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x8440370dE7853D9D6786941916f90c945dCBAe9D);
    }
