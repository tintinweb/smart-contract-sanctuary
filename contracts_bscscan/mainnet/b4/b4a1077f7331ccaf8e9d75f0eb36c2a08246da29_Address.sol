...
//
// Copyright of The $CARBON Team
//
//
// There is a pot of gold at the end of every CARBON
// 
// $CARBON has 7% tax split across 7 protocols
...
/**
 * @dev The official CARBONToken smart contract
 */
contract CARBONToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "CARBON-Token";
    ...
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for CARBON/WBNB
    ...
    uint256 private _tTotal = 1 * 10**12 * 10**3;
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $CARBON will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-CARBON tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts CARBON balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns CARBON tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of CARBON tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from CARBON)
