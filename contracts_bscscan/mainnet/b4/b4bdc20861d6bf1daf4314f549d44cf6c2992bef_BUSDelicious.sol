...
/**
https://t.me/BUSDelicious
https://twitter.com/busdelicious
https://www.busdelicious.com/
*/
...
contract BUSDelicious is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;

    string constant _name = "BUSDelicious";
    string constant _symbol = "BUSDD";
    ...
    uint256 _totalSupply = 74000000 * (10 ** _decimals);
