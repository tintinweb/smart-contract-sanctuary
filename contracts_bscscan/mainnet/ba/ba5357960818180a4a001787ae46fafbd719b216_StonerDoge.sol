...
contract StonerDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xECE82A6801623B70AEdcB360e1a5438a604F994C); // Marketing Address
    ...
    string private _name = "StonerDoge";
    string private _symbol = "StonerDoge";
