...
/* FacebookETF -  Biggest reward meme token on the Binance Smart Chain
...
contract FacebookETF is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x00f617b63173f85f536F4C1A0183947e7BeEeF22); // Marketing Address
    address payable public charityAddress = payable(0x00f617b63173f85f536F4C1A0183947e7BeEeF22); // Charity/Dev Address
    ...
    string private _name = "Facebook ETF";
    string private _symbol = "FETF";
