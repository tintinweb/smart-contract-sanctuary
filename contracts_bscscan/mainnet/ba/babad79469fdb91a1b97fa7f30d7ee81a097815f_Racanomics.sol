...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 COIN = IBEP20(0x12BB890508c125661E03b09EC06E404bc9289040); //the reward token you want distributed 
...
contract Racanomics is IBEP20, Auth {
    using SafeMath for uint256;

    address COIN = 0x12BB890508c125661E03b09EC06E404bc9289040; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "RacaNomics";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "RACANOMICS";
