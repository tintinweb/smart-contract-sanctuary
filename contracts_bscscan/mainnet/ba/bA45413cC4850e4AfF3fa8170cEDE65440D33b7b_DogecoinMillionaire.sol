...
contract DogecoinMillionaire is IBEP20 {
    ...
    string public override name = "Dogecoin Millionaire Token";
    string public override symbol = "DOGEM";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 15 / 100;
