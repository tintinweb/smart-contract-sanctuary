...
contract SuperFast is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbe315c3cc73be8CB3c309f1a94BC84Bc2F9fA417); // Marketing Address
    ...
    string private _name = "SuperFast";
    string private _symbol = "SUF";
