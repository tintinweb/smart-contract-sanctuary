...
StrongADA a BSC Token with 10% ADA Reflections distributed every 60 minutes directly to holders wallets. 
NO MINIMUM Tokens required to get rewards.

https://t.me/StrongADA
...
contract StrongADA is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "SADA";

  string private _name = "StrongADA";
