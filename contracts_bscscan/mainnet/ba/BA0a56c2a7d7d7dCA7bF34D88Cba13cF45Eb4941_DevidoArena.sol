...
//Just launched in $DevidoArena. We have created a token so rewarding for everyone.
//DevidoArena Hold we will Tothemoon
//Tg : @DevidoArena
...
contract DevidoArena is Context, IERC20, Ownable {
    ...
    string private _name = "DEVIDO ARENA";
    string private _symbol = "DevidoArena";
