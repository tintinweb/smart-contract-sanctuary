 ...
 * Join our community: Https://t.me/LincenTaurus
 * Website: On TG Group
 * Slippage ~10%
 * 
 * SAFU contract
 * No MINT functions
 * LINCENTECH SECURITY SYSTEM TO AVOID BOTS AND HACKS!!!
...
contract LINCENTAURUS is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LINCEN TAURUS";
    string constant _symbol = "LINCENTAURUS";
