...
//TestDai Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract TestDai is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TestDai';
    string private constant _symbol = 'TestDai';
    ...
    address public constant TeamWallet=0x3fe8E9C6956867A51130dB2276e4F0956aD08b3d;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimDAI(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawDAI(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimDAI(address addr) private{
        ...
        path[1] = 0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3;  //DAI
        ...
        emit OnWithdrawDAI(amount, addr);
        _isWithdrawing=false;
    }
