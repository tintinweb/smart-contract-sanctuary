...
/*
    ...
    FesBNB Staking rewards
    
    Rewards are distributed between ETH, ADA, XRP, CAKE, and DOT
    
    A unique dividend payment system that allows for multiple rewards in the same contract without multiple trackers required.
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56)); // BUSD - 0
...
contract TrunksInuStaking {
    
    IERC20 public immutable stakingToken; // update to fesBNB token address
    ...
    constructor() {
        stakingToken = IERC20(address(0xc2a115963F84116648dE0c2E9EaDb13698306458));
    ...
    function stake(uint256 amount) external nonReentrant {
        require(stakingToken.allowance(msg.sender, address(this)) >= amount, "Not enough allowance to transfer tokens to contract");
        require(stakingToken.balanceOf(msg.sender) >= amount, "Not enough tokens to transfer");
        require(amount > 0, "Must be greater than 0");
        uint256 initialBalance = stakingToken.balanceOf(address(this));
        stakingToken.transferFrom(msg.sender, address(this), amount);
        uint256 newBalance = stakingToken.balanceOf(address(this)) - initialBalance;
        holdings[msg.sender] += newBalance;
        dividendTracker.setBalance(payable(msg.sender), holdings[msg.sender]);
    }
