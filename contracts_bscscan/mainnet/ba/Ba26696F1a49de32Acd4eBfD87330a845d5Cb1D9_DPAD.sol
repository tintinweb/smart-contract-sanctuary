...
/**
 * 
Diamond Pad is a decentralized token created for the ultimate goal of donating to ending blood diamond mining in Africa. 


Along the way to that goal, Diamond Pad will be rewarding our community with ADA reflections in order to allow investors to capitalize on a passive income stream while they hold their tokens and watch them grow in value. 
*/
...
contract DPAD is Context, IERC20, Ownable {
