...
// TG: https:https://t.me/dogeportcoin
// WEBSITE: https://www.dogeport.click/
// Twitter: https://twitter.com/DogePortCoin


// ░D️░░O️░░G️░░E️░░ ️░░P️░░O️░░R️░░T️░░ ️░░C️░░O️░░İ️░░N️░
// ▂ ▃ ▅ ▆ █ DOGECOİN REWARD █ ▆ ▅ ▃ ▂
...
contract DogePort is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "DogePort";
   string constant _symbol = "DPORT";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 999000000 * (10 ** _decimals);
...
uint256 reflectionFee = 500;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x978Ad14f7B83B3E35b6F2Bd9Ea1AbFD7AF7dd0EB;
...
function shouldAutoBuyback() internal view returns (bool) {
   ...
   event AutoLiquify(uint256 amountBNB, uint256 amountDPORT);
