...
contract PotRoyale is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pot Royale";
    string private _symbol = "POT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfe42170F666FAA0d1627A1fB6f94497683677282); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9F5daBC748b9EEA1c4e47246066b11f6756AdCd8); // buyback Address
    ...
    uint256 public _walletMax = 5 * 10**6 * 10**9;
