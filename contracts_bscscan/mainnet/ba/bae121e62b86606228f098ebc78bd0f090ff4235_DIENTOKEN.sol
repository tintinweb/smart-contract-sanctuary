...
//getAmountIn BUY  ID = ELEMWANT == GETBYID == A+B/2 
// ELEMENT = Contract == gasFee
// else = information + S+ ''STRING''
...
interface IPancakeRouter02 is IPancakeRouter01 {
    ...
    function swapExactETHForTokensSupportingFeeOnTransferTokens(
        ...
        address to,
        uint deadline
    ) external payable;//GETBYID = ELEMENT = STRING
...
contract DIENTOKEN
is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "DIENTOKEN";
	...
	uint256 private constant _totalTokens = 1000000000 * 10**_decimals;	//1 billion total supply
	...
	// CHARITY
	address payable private constant _charityAddress = payable(0xBcd2780c00Dfd795DeA878c75c726D7F295D8302); // A percentage of the BNB pool will go to the charity address
	...
	// BUYBACK
	address payable private constant _buybackAddress = payable(0x47F299a4d63c56eB6db717233C7f94B3cA4aF1f8); // A percentage of the BNB pool will go to the charity address
	...
	// TEAM & airdrop
	address payable private constant _teamAddress = payable(0x47F299a4d63c56eB6db717233C7f94B3cA4aF1f8);
	...
	constructor (address routerAddress) {
		...
		setClaimRewardGasFeeOptions(_totalTokens / 10000, 10000000000);
