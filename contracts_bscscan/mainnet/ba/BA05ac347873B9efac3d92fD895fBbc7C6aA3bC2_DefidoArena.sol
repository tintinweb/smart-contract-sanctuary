...
//Just launched in $DefidoArena. We have created a token so rewarding for everyone.
//DefidoArena Hold we will Tothemoon
//Tg : @DefidoArena
...
contract DefidoArena is Context, IERC20, Ownable {
    ...
    string private _name = "DEFIDO ARENA";
    string private _symbol = "DefidoArena";
