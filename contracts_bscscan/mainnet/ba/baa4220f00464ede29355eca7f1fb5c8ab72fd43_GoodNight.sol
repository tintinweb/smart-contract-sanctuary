...
contract GoodNight is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xb9d9582451591B025446bfcFecC39771a47531d3); // Marketing Address
    ...
    string private _name = "GoodNight";
    ...
    uint256 public _maxTxAmount = 1000000000 * 10 * 10**9;
    uint256 private minimumTokensBeforeSwap = 200000 * 10 * 10**9; 
