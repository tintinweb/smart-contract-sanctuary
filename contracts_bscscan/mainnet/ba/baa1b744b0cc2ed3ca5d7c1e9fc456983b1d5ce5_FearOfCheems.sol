...
Combination of FOMO and CHEEMS, lol
idk how i got this name together i was driving home, thinking about a degen
i could launch today so this name fell into my mind. I often drive home
thinking of the most random stuff and all that so things often just fall into
my mind. Btw im only writing this because idk if this is enough for reddit so please
bear with me. Well what do I need to say: I hope you dont got Fear of Cheems because that
wouldnt be profitable for you. Good Luck! 
...
https://t.me/FearOfCheems
 
If you like this Degen feel free to follow my Channel, a young Cheems trying to make it big:
...
contract FearOfCheems is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingAddress = 0x9B05f3a20E012989557dBd840f2353AF9044d010;
    ...
    string private _name = "FearOfCheems";
    string private _symbol = "Im Scared";
    ...
    uint256 public _maxTxAmount = 4_000_000_0 * 10**18; //4%
...
//////--------  ANTI WHALE -------/////--------
    ...
    uint256 public maxLimit =  _tTotal.div(100).mul(4); //4%
