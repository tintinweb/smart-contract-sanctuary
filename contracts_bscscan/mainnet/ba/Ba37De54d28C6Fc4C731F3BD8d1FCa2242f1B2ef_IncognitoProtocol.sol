...
contract IncognitoProtocol is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "IncognitoProtocol";
    string constant _symbol = "INCP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 8 ) / 100; // 1%
    uint256 public _maxWalletToken = ( _totalSupply * 9 ) / 100; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x4eBaC0Cc94E538eF9e0cD50C7ccb354cC636cFAa;
