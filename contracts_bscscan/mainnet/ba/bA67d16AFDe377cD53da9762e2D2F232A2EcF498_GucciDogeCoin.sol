...
contract GucciDogeCoin is Context, IBEP20, Ownable {
    ...
    string private constant _name    = "Gucci Doge Coin";
    string private constant _symbol   = "GucciD";
    uint8  private constant _decimals = 9;
    
    uint256 public _taxFee       = 400; // 2% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 400; // 2% of every transaction will be converted into BNB. Will go towards marketing
    uint256 public _burnFee      = 100; // 2% of every transaction is burned
