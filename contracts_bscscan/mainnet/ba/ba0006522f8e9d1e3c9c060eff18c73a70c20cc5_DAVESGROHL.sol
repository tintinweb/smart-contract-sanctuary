...
/**Welcome to DAVESGROHL
   ...
   I will renounce the ownership to burn addresses to transfer #DAVESGROHL
   to the community
   Can you make #DAVESGROHL
   100X? 
   ...
   it's the best part of the #DAVESGROHL
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract DAVESGROHL is Context, IBEP20, Ownable {
