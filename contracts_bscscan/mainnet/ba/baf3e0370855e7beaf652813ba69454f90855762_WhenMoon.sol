...
contract WhenMoon is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x823ca16ef67d8C6666E4C499aD6Ab89F6f046aC6); // Marketing Wallet
    address payable private prizeRewardWallet = payable (0x69e1290e5D73590C13Fa2859aa35555c22Bd17F0); // prizeReward Wallet
    ...
    string private _name = "WHEN MOON";
    string private _symbol = "WHENMOON";
    

    uint256 public _maxWalletToken = _tTotal.div(1000).mul(4); //0.4% for first few mins
