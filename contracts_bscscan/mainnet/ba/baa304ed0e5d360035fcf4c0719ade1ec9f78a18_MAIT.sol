...
/**
* Mini Akamaru Inu Token - BNB Rewards for Holding, Charity, and much more
*🌎 Our Telegram:  https://t.me/miniakamarutoken
*🌎 Twitter: https://twitter.com/miniakamaruinu
*🌎 Website: https://miniakamaruinu.com/
*/
...
// File: contracts\MAITBase.sol


// Base class that implements: BEP20 interface, fees & swaps
abstract contract MAITBase is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	// MAIN TOKEN PROPERTIES
	string private constant NAME = "Mini Akamaru Inu";
	string private constant SYMBOL = "MAIT";
...
// File: contracts\MAIT.sol

// Implements rewards & burns
contract MAIT is MAITBase {
