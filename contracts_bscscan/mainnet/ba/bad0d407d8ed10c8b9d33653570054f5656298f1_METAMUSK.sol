...
the metaverse, which is also a fully immersive virtual economy, needs a mode of payment. 
Since activities and interactions in the virtual world are all done through an avatar of the user, it is not possible to transact in fiat currency (traditional paper currency).

WEBSITE : https://metamuskbsc.com
*/
...
contract METAMUSK is Context, IERC20, Ownable {
    ...
    string private   _name = "META MUSK";
