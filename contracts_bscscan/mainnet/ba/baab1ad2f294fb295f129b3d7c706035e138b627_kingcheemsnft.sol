...
// Telegram : https://t.me/KingcheemsNFT
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x28907e38aCe2acC3ec3e2B9622CF655cB0B16fED;
...
contract kingcheemsnft is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x884F1CA88A17CbCF8252c193f0f8350f75C9bA27;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "King Cheems NFT";
    string private _symbol = "KCN";
