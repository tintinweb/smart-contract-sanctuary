...
// File: contracts/WexNFT.sol

pragma solidity ^0.6.0;

contract WexNFT is ERC721, Ownable {
...
// File: contracts/WNTMintingStation.sol

pragma solidity ^0.6.0;

/** @title WNTMintingStation.
@dev It is a contract that allow different factories to mint
Pancake Collectibles/Bunnies.
*/

contract WNTMintingStation is AccessControl {
    WexNFT public wexNFT;
    ...
    constructor(WexNFT _wexNFT) public {
        wexNFT = _wexNFT;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev Mint NFTs from the WexNFT contract.
     */
    function mintCollectible(
        ...
        uint256 tokenId =
            wexNFT.mint(_tokenReceiver, _tokenURI, _bunnyId);
        return tokenId;
    }
    ...
    function setBunnyName(uint8 _bunnyId, string calldata _bunnyName)
        ...
        onlyOwner
    {
        wexNFT.setBunnyName(_bunnyId, _bunnyName);
    }
    ...
    function changeOwnershipNFTContract(address _newOwner) external onlyOwner {
        wexNFT.transferOwnership(_newOwner);
    }
}