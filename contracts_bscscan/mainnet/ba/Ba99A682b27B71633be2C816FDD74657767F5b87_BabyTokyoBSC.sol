...
/**
   ...
   https://t.me/babytokyobsc
  
  
  Please wait for official announcement in the official TG for contract. If you buy from this contract
  that means you agree that the money is for dev to take anytime. Please read the fucking contract you
  stupid shit.
...
contract BabyTokyoBSC is Context, IERC20, Ownable {
    ...
    string private _name = "BabyTokyoBSC";
    string private _symbol = "BATOYO";
    ...
    uint256 public _shibalympicFee = 70;
