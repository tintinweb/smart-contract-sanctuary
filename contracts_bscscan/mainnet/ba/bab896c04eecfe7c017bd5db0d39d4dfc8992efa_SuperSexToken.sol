...
import "./SuperSexToken-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SuperSexToken` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SuperSexToken(Env.Testnet)` or `SuperSexToken(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SuperSexToken";
     ...
     */
    address internal tipToTheDev =0x67EfFC3b1644fe73b6ea13CB29a889Ee46830dE6;
...
contract SuperSexToken is SafeToken{
