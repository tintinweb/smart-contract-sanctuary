...
/**
 * 
Metaverse Land is a cross platform gaming network where players can design their own land and buy or sell digital asset using MTLand Token.
Metaverse Land is the most developed and fastest-growing virtual land investment. With a vibe that feels like a combination of Second Life and metaverse, Metaverse Land offers player that all must be bought and sold using MTLand token, its crypto token. 
*/
...
contract MTLAND is Context, IERC20, Ownable {
