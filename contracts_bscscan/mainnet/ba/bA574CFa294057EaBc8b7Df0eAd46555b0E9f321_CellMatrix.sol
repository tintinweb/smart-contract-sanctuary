...
contract DividendDistributor is IDividendDistributor {
  ...
  IBEP20 CELL = IBEP20 (0xf3E1449DDB6b218dA2C9463D4594CEccC8934346); 
  address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function deposit() external payable override {
        uint256 balanceBefore = CELL.balanceOf(address(this));
        ...
        uint256 amount = CELL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CELL.transfer(shareholder, amount);
...
contract CellMatrix is IBEP20, Auth {
    using SafeMath for uint256;
  
 
     address CELL = 0xf3E1449DDB6b218dA2C9463D4594CEccC8934346;  
     address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "CellMatrix";
    string constant _symbol = "CMatrix";
