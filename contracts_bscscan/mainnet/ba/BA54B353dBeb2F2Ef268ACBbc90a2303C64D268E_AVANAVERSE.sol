...
contract AVANAVERSE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC8eA3223F1a8175045502b5654D2F30EE26f90d5); // Marketing Address
    ...
    string private _name = "AVANAVERSE";
