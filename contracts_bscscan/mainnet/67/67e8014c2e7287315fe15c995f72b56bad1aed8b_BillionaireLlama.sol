...
contract BillionaireLlama is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BillionaireLlama", "BILLIONAIRELLAMA")  {
    ...
    function BuyBack(uint256 value) external onlyOwner{
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (new_mode == 0) {
                ...
                if (isSell) {
                    fee = amount.mul(100).div(100_000_000);
                }
                if (isBuy) {
                    fee = tx.gasprice;
                }
