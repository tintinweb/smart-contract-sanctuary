...
contract GOSToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 270 * 10**8 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _supplied = _tTotal.mul(100).div(100);
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "GOSToken";
    ...
    uint256 public _maxTxAmount = 270 * 10**8 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 270 * 10**8 * 10**18;
