...
// SPDX-License-Identifier: MIT CALL ALL ATH
...
contract Binance is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Binance: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Binance: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract WolfstrideInu is Context, IBEP20, Binance {
    ...
    uint256 private constant _allTotalSupply = 10000000000000 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Wolfstride Inu';
    string private _symbol = 'WolfstrideInu';
