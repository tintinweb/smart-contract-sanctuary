...
Welcome new comers to the Official Launch of the Fair launch CyberCore !

CyberCore ( $CBC ) is the token reflection  $BNB token.

Cybercore is blockchain's first entertainment aggregator and licensed producer of original motion picture, exclusive Pay-Per-View events, and surreal gaming experiences. This unified ecosystem is all fuelled with $Cybercore tokens through open-source software and secured by cutting-edge blockchain technology. Vote, fund, and earn in a variety of pioneering ways.

🎰 Tokenomics 100.000.000.000.000 $ CBC
...
✅ Audit
✅ Influencer Twitter
✅ PINNED on telegram group
✅ Coingecko & CMC fast track
✅ Trending on Dextools
✅ Poocoin Ads
✅ Btok Ads

👨‍💻 CyberCore Social media

🎫Telegram: https://t.me/CyberCore_chat

🎧Twitter :   https://twitter.com/Cybercore_bsc

🪗Website: http://www.cybercore.club/
...
contract CBC is Context, BEP20 {
    ...
    string private _name = "CyberCore";
    string private _symbol = "CBC";
    uint8 private _decimals = 9;
    uint256 public _maximumTXamount = 500000000000000000;
