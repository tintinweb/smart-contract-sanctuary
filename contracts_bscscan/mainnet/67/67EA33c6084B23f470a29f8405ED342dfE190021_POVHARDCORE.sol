...
/**
 * Twitted by ElonMusk https://twitter.com/elonmusk/status/1436265776550490112
 * TG : https://t.me/pov_hardcore  LFG  Fair launch on Sunday  12.9.2021 
*/ 
...
contract POVHARDCORE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x6100f536A4D93742Dd62a9967A6428892473bF27); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xd365F0c95257B452b3C9d5bac991E1A8281338b5); // BuyBack Address
    ...
    string private _name = "PovHardcore";
    string private _symbol = "POVH";
    ...
    constructor () {
        ...
        _totalTaxPercent = _burnFee.add(_liquidityFee).add(_marketingFee).add(_buyBackFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(forWallets > 0 && _marketingFee.add(_buyBackFee) > 0)
        {
            ...
            uint256 buybackWalletShare = newBalance.sub(marketingShare);
    ...
    function setTaxes(uint256 newBurnFee, uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax) external onlyOwner() {
        _burnFee = newBurnFee;
