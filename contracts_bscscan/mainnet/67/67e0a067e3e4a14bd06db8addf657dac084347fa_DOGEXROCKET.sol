...
contract DOGEXROCKET is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "DogeXRocket";
    string private constant _symbol = "DOGEXROCKET";
    ...
    uint256 public _taxFreeBlocks = 0; // 0
    ...
    uint256 public _marketingPercent = 90;
    ...
    address payable constant private _marketingAddress = payable(0x834711BE3db047199eB7cd4e383fA4f7d7C4F6c5);
    address payable constant private _buybackAddress = payable(0xeb6E8C02298374a5370e769112c9aCeD9e380BA9);
    address payable constant private _projectMaintainence = payable(0x7CcfEDFf0b7f8B6E4A6D8738735764946F7A02E1);
