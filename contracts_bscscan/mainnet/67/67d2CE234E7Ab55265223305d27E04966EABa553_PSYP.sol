...
---------------------------PSYP.sol--------------------------------
                    ...
                    name    : Polkasyndicate Plus
                    symbol  : PSYP
                    decimals: 18
                    supply  : 1,000,000,000,000,000
 
 Each transaction is is subject to a tax :
...
contract PSYP is IERC20, Ownable {                                                                            
    using SafeMath for uint256;

    
    address public  Reward = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Polkasyndicate Plus";
    string constant _symbol = "PSYP";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xdE93c3C05DE25C20d520818DAF45270005a3966e);                                   
    ...
    function newRewards(address newRewards)public onlyOwner{
        require(newRewards!=address(Reward));
        Reward=newRewards;
    }
    ...
    function setAutoBuybackSettings(bool _enabled, uint256 _cap, uint256 _amount_inToken, uint256 _period) external onlyOwner {
        autoBuybackEnabled = _enabled;
        autoBuybackCap = _cap;
        autoBuybackAccumulator = 0;
        autoBuybackAmount = _amount_inToken.div(100);
