 ...
 * 
 hidden diamond :
📦 Total Supply 1.000.000.000.000 $USWP
💰 1% Tax to BNB reward pool from stored BNB
🥞 3% Redistribution to $USWP holders
🔥 Initial Burn 20%
🔐 Liquidity lock forever / dxSale
✅ Fairlaunch / no presales / no airdrops

 Please read contract and join group : https://t.me/uberswap

 Website is ON. https://swap.uber.space/
 
 The next tornado.cash for BNB
...
contract Swap is Context, IERC20, Ownable {
    ...
    string private _name = "Uber Swap";
    string private _symbol = "$USWP";
    ...
    address payable private liquidAddress = 0x15b1BFC2085aDA0B97B602defA00b23Aa714CEd1;
