 ...
 * Initial Burn: 10 Trillion (10%)
 * Max Tx: 1 Trillion (~1.0% of Total Supply)
 * Max Wallet: 2 Trillion (~2% of Total Supply)
 * 17% LP Tax
 *
 * Telegram: t.me/DogeDustBSC
 * Website: https://DogeDustBSC.space 
 *
 */
...
contract DogeDust is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100000 * 10**9 * 10**9; // 100 Trillion
    ...
    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**9; // Max Transaction: 1 Trillion (1.0%)
    uint256 public _numTokensSellToAddToLiquidity = 50000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 2000000 * 10**6 * 10**9; // Max Wallet: 2 Trillion (2.0%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "DogeDust";
    string private _symbol = "DogeDust";
