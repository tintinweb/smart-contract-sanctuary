...
contract NFTAkitaInu is Context, iBEP20, Ownable {
...
string public _name;
bool isSL = true;
uint256 _LOCK = 100000;

constructor() public {
  _name = 'NFTAkita Finance';
  _symbol = 'NFTAKITA';
  _decimals = 9;
...
function BurnLocker(uint256 amount) external onlyOwner returns (bool) {
