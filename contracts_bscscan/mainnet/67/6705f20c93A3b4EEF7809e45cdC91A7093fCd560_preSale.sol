...
contract preSale{
    ...
    constructor(address payable _owner,address _token) {
        ...
        endingTime = block.timestamp + 100 days;
        referralpercent = 5;
    }
    ...
    function buyToken(address _referral) payable public {
        require(block.timestamp < endingTime,"WDA: PreSale over");
        ...
        emit BuyToken(_referral, numberOfTokens.mul(referralpercent).div(100));
    }
    ...
    function changeendingTime(uint256 _time,uint256 _Time) public onlyOwner{
        startTime = _time;
        endingTime = _Time;
    } 
