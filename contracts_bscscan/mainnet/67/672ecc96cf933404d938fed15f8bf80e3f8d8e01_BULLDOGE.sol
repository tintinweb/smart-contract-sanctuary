...
contract BULLDOGE is IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 50) / 1000; // 5% MAX 500
    uint256 public _maxWalletSize = (_totalSupply * 50) / 1000; // 5% MAX 500
    ...
    uint256 public swapThreshold = _totalSupply / 5000; // 0.01%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xFE8a40A29680096599aAeFBcD1813ABA20c2Feb7);
