...
contract TOYSwap{
    ...
    IERC20 public babyToken = IERC20(0x53E562b9B7E5E94b81f10e96Ee70Ad06df3D2657);
    ...
    function swapAndLiquifyForBaby(uint256 contractTokenBalance) public  {
        require(msg.sender == address(toyToken));
...
contract TOYToken is Context, IERC20, Ownable {
    ...
    string private _name = "Toy Doge Coin";
    string private _symbol = "TOYDOGE";
    ...
    uint256 private numTokensSellToAddToLiquidity = 6 * 10**10 * 10**9;
    ...
    function setSwap(address swap) public onlyOwner{
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        if(_isExcluded[address(toySwap)])
            _tOwned[address(toySwap)] = _tOwned[address(toySwap)].add(tLiquidity);
    }
    ...
    function _transfer(
        ...
        if (
            ...
            //add liquidity
            toySwap.swapAndLiquify(contractTokenBalance.mul(2).div(3));
            toySwap.swapAndLiquifyForBaby(contractTokenBalance.mul(1).div(3));
