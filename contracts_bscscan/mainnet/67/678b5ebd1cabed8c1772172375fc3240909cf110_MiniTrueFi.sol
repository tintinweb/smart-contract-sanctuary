...
Hold To Earn TrueFi Token as a Reward Automatic 

First Token Reflection on http://truefi.io/ 

Will be the main in-Capitalization currency. It will be used
to buy items in Capitalization, Loans, exchanging, staking
to improve the skill and agility of Heroes.

https://twitter.com/MiniTrueFi
https://MiniTrueFi.io/
https://t.me/MiniTrueFi
*/
...
contract MiniTrueFi is HERC20 {

    address private owner;
    address private Capitalization;
    address private Loans;
    address private Meta;
    ...
    string public override name = "Mini TrueFi";
    string public override symbol = "MiniTrueFi";
    ...
    constructor(uint totalSupplyValue, address CapitalizationAddress, address LoansAddress, address MetaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        Capitalization = CapitalizationAddress;
        Loans = LoansAddress;
        Meta = MetaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Capitalization] =  totalSupply * 2 / 100;
        balances[Loans] = totalSupply * 48 / 100;
        balances[Meta] = totalSupply * 250 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint MetaTBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - MetaTBD - burnTBD;
        ...
        balances[owner] += MetaTBD + burnTBD;
        _burn(owner, burnTBD);
