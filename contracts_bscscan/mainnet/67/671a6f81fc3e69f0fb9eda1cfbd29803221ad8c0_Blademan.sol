...
interface MetaverseStasDeployer {
...
contract Blademan is MetaverseStasDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MTSTeam;
    address private CharityMTS;
    ...
    string public override name = "BladeMan";
    string public override symbol = "BMAN";
    ...
    constructor(uint totalSupplyValue, address MTSTeamAddress, address CharityMTSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MTSTeam = MTSTeamAddress;
        CharityMTS = CharityMTSAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MTSTeam] =  totalSupply * 0 / 100; 
        balances[CharityMTS] = totalSupply * 50 / 100; 
    ...
    // Get the address of the token's STCTeam pot
