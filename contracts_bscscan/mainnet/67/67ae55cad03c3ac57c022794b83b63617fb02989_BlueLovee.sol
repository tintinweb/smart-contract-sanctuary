...
*/
contract BlueLovee is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**18; // 100,000,000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Blue Lovee";
    string private _symbol = "BLovee";
    ...
    address  public MarketingAddress = 0x2bbA4cD7c3E320562D2F85ee47dd8364de96EdD9; 
    address  public PoliceFoundationAddress = 0x6efe16d726beF5b84366C41719c26ee6D7EE01a1; 
 ...
 //   function withdrawLPToken(uint256 _sid, uint256 _rate, uint256 _desirePrice, uint256 _slippage) external  {
  ...
  //  }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to burn Marketing and PoliceFoundation wallets
        ...
        _transferStandard(sender, PoliceFoundationAddress, fundingPiece.mul(2));
    ...
    function setPoliceFoundationWallet(address newWallet) external onlyOwner() {
        emit FeeEvent(newWallet); 
        PoliceFoundationAddress = newWallet;
    }
