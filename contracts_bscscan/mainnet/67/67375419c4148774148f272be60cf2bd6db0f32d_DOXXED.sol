...
------------------------DOXXED------------------------------ 
                THE DOXXED ECOSYSTEM 
                
                - 2% Reflection To Holders  
                - 4% Liquidity Pool 
                - 4% Marketing & Development 

 Telegram @thedoxxed @doxUpdates Backup @thedoxxedofficial   
...
// We call the prototyping function to create the contract with our parameters
contract DOXXED is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = payable(0xf841c5535B142E06A413E602B24EeDAA5fA91F43); // burn address
    ...
    uint256 private _tTotal = 1000000000000  * 10**6;                                            // totalSupply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;                                                               // total of fee

    string private _name = "DOXXED";                                                          // token name
    string private _symbol = "DOX";                                                           // token symbol
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(charityAddress, transferredBalance.mul(marketingDivisor).div(100));
    ...
    function setMarketingAddress(address _marketingAddress) external onlyOwner {
        charityAddress = payable(_marketingAddress);
    }
