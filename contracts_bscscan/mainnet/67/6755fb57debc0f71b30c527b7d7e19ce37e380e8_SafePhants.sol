...
/**
 *
 * SafePhants (Running on PancakeSwap v2 Router: 0x10ED43C718714eb63d5aA57B78B54704E256024E)
 * A Binance Smart Chain token with 6% tax at every transaction:
 * 2% distribution
 * 2% liquidity swap
 * 2% burn
 * 
...
contract SafePhants is Context, IERC20, Ownable {
    ...
    string  private _name       = "SafePhants";
    string  private _symbol     = "SFP";
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Pancake Swap V2 Router!
