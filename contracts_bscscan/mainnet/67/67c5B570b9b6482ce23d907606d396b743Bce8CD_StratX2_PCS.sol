...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-NUT staking vault.
    ...
    address public nutpieFarmAddress;
    ...
    address[] public earnedToNUTPath;
    ...
    function farm() public virtual nonReentrant onlyAllowGov {
        _farm();
    }
    
    function unfarm(uint256 _wantAmt) public virtual nonReentrant onlyAllowGov {
        _unfarm(_wantAmt);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(nutpieFarmAddress, _wantAmt);
    ...
    function _unwrapBNB() internal virtual {
        // WBNB -> BNB
        uint256 wbnbBal = IERC20(wbnbAddress).balanceOf(address(this));
        if (wbnbBal > 0) {
            IWBNB(wbnbAddress).withdraw(wbnbBal); // WBNB -> BNB
        }
    }
...
contract StratX2_PCS is StratX2 {
    constructor(
        ...
        govAddress = 0x5480146Bf557D7936C8d8BFa639d840755c40BFc;
        nutpieFarmAddress = 0x6c06470306967E9785776fdEc29ec6531A089eD2;
        NUTAddress = 0x3084b8845EbC1A0753a7a0B1C603C36DA0231e03;

        wantAddress = _wantAddress;
        token0Address = 0x3084b8845EbC1A0753a7a0B1C603C36DA0231e03;
        token1Address = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        earnedAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        lockerAddress = 0x28506d09b859355B6744e730192F78B34DE90EcB;
        ...
        earnedToNUTPath = [address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82),address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c),address(0x3084b8845EbC1A0753a7a0B1C603C36DA0231e03)];
        earnedToToken0Path = [address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82),address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c),address(0x3084b8845EbC1A0753a7a0B1C603C36DA0231e03)];
        earnedToToken1Path = [address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82),address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)];
        token0ToEarnedPath = [address(0x3084b8845EbC1A0753a7a0B1C603C36DA0231e03),address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c),address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82)];
        token1ToEarnedPath = [address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c),address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82)];

        buyBackRate = 4000;

        transferOwnership(nutpieFarmAddress);
    }
}