...
contract BetterFlyToken is Context, IERC20, Ownable {
    ...
    string private _name = "BetterFly";
    string private _symbol = "BTFLY";
    ...
    uint256 public _maxTxAmount = 8000000 * 10**1 * 10**12;
    uint256 private numTokensSellToAddToLiquidity = 3000000 * 10**1 * 10**12;
