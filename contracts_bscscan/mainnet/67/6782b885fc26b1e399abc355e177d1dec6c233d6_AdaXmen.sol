...
/** 
        ...
        - Marketing: 4%
        - Liquidity: 2%
        Boosted rewards in ADA: 24% (at least 1hr per day)


        Telegram: https://t.me/AdaXmen
        Website: https://adaxmen.space/
*/
...
// CHANGE
contract AdaXmen is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 40,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x5ED8996b8606D6d11FB18535E39588981449390a);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _devFee, uint256 _feeDenominator) external onlyOwner {
