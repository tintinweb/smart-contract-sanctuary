...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOGECOLA = IBEP20(0xe320Df552e78D57E95cF1182B6960746d5016561);
    ...
    function deposit() external payable override onlyToken {
        ...
        path[0] = WBNB;
        path[1] = address(0xe320Df552e78D57E95cF1182B6960746d5016561);
...
contract MiniDogeCola is IBEP20, Auth {
    ...
    string constant _name = "Mini DogeCola";
    string constant _symbol = "MDCOLA";
    ...
    address public _marketingWalletAddress = 0xE8dfECBDdf8adEce237fd98779Fd67a6733081A3;
