...
contract BoxerDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public ecosystemAddress = payable(0x05Bb50D8c1D4061630563AD63e72Fe6d0229427c);
    ...
    string private _name = "BoxerDoge";
    string private _symbol = "BoxerDoge";
    ...
    uint256 public ecosystemDivisor = 4;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        {
            transferToAddressETH(ecosystemAddress, transferredBalance.mul(ecosystemDivisor).div(100));
        }
    }
