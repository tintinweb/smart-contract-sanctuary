...
contract Dogetothemoon is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x63244f11F53A761A8E9C8F44d23698829eFBE843); // Marketing Address
    ...
    string private _symbol = "Dogetothemoon";
