...
/**
   Earn BUSD while holding FlokiBUSDv3
...
// File: contracts/FlokiBUSDv3DividendPayingToken.sol
...
FlokiBUSDv3DividendTracker public dividendTracker;
    ...
    constructor() public ERC20("FlokiBUSDv3", "FlokiBUSD"){
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "FlokiBUSDv3: This account cannot send tokens until trading is enabled");
        }
...
contract FlokiBUSDv3DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("FlokiBUSDv3_Dividend_Tracker", "FlokiBUSDv3_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
            require(newClaimWait >= 3600 && newClaimWait <= 86400, "FlokiBUSDv3_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
