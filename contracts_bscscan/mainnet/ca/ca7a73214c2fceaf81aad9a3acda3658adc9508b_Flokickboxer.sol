...
contract Flokickboxer is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Flokickboxer", "Flokickboxer", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x117aC70D1Df9aC184FA370fBcD8DD22F5D399243;
        marketingFeeReceiver = 0xB1Eaaa9Cb980e5Fa1Ac38ccCad7C68E8b94BA240;
        ecosystemFeeReceiver = 0x2767292962935aDD689FE0C573228B34a13F95E2;
        buyBackFeeReceiver = 0x19A0856b24142C2975cC217A4Effa192bD4D2CBD;
