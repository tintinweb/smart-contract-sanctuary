...
//Just launched in SonOfDragonMusk. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//SonOfDragonMusk Hold we will To the moon
//telegram : @SonOfDragonMuskBsc
...
contract SonOfDragonMusk is Context, IERC20, Ownable {
    ...
    string private _name = "SonOfDragonMusk";
    string private _symbol = "SonOfDragonMusk";
