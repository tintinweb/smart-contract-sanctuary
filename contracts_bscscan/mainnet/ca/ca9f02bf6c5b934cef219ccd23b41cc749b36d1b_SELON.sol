...
contract SELON is Context, IBEP20, Ownable { // change contract name
    ...
    string private _name = "SELON"; // token name
    string private _symbol = "SELON"; // token symbol
    ...
    uint256 public _maxTxAmount = 50000000 * 10**6 * 10**18; // max allowed tokens tranfer per transaction
    uint256 public _numTokensSellToAndTransfer = 500000 * 10**6 * 10**18; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress = 50000000 * 10**6 * 10**18; // Max number of tokens that an address can hold
