...
contract IDOPoint is Ownable, IIDOPoint {
    ...
    function getPoint(address user) external view override returns (uint256) {
        ...
        if (address(playToken) != address(0)) {
            total = total + playToken.balanceOf(user);
        }
    ...
    function setWeights(
        ...
        require(_stakedPlayWeight >= 10, "_stakedPlayWeight should be greater than 10");
        require(_lpTokenWeight >= _stakedPlayWeight, "_lpTokenWeight should be greater than _stakedPlayWeight");
        require(_lpTokenLockedWeight >= _lpTokenWeight, "_lpTokenLockedWeight should be greater than _lpTokenWeight");
