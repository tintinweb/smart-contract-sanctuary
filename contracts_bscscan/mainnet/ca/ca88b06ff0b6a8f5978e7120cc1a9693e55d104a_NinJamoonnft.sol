...
interface IERC20 {
    ...
    /**
     * @dev Returns thae amount of tokens owned by `account`.
     */
...
// File: contracts\NinJamoonnft

contract NinJamoonnft is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "NinJamoonnft";
	string private constant _symbol = "NJF";
	...
	// CHARITY
	address payable private constant _charityAddress = payable(0x6f833Bc5FA700AE59d0F65e74F604D87F4b02F40); // A percentage of the BNB pool will go to the charity address
	...
	// BUYBACK
	address payable private constant _buybackAddress = payable(0x3C4547c0170f716a5AB8Df2e9837A822F56Ba7C2); // A percentage of the BNB pool will go to the charity address
