...
contract TESTING is IERC20 {
    ...
    uint256 private constant startingSupply = 100_000; // 10 Billion, underscores aid readability

    uint8 private _decimals = 18;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "TESTING DO NOT BUY";
    string constant _symbol = "NOBUY";

    uint256 public _reflectionFee = 1600;
    ...
    address payable private _marketingWallet = payable(0xF18e75270C5e0A7A9eF6d4B8ee3eE90c6A6E1e42);
