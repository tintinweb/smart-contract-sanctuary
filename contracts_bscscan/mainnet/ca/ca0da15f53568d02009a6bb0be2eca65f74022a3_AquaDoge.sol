...
//HOLD $AQUADG & EARN $CAKE

//📲 https://t.me/AquaDogeRewards
//🌐 https://aquadoge.live
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also AquaDogeed.
...
// File: contracts/AquaDogeDividendPayingToken.sol
...
// File: contracts/AquaDoge.sol



pragma solidity ^0.6.12;

contract AquaDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable CAKE = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
	address payable public MarketingAddress = payable(0x71653CFD8268ad64E19EbCbFf1741FDC8683d1df); 
	address payable public BuyBackAddress = payable(0x76B35fF73a43551a1481F5af3a6bA9998DF450Dc); 
    bool private swapping;

    AquaDogeDividendTracker public dividendTracker;

    address public liquidityWallet;
	uint256 public _maxTxAmount = 20000000000000 * (10**18);
    uint256 private _antiDumpTransactionAmount = 1000000000000000 * (10**18); 
	uint256 private _maxWalletAmount = 1000000000000000 * (10**18);  
	uint256 private _maxSellAmount = 1000000 * (10**18);  
    uint256 private _swapTokensAtAmount = 1000000 * (10**18);
    ...
    uint256 private  tradingEnabledTimestamp = 1627817340;
    ...
    constructor() ERC20("AquaDoge", "AQUADG") public {
        ...
        dividendTracker = new AquaDogeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "AquaDoge: The dividend tracker already has that address");

        AquaDogeDividendTracker newDividendTracker = AquaDogeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "AquaDoge: The new dividend tracker must be owned by the AquaDoge token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "AquaDoge: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "AquaDoge: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "AquaDoge: The PanCAKESwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "AquaDoge: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "AquaDoge: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "AquaDoge: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "AquaDoge: Cannot update gasForProcessing to same value");
    ...
    function getTotalDividendsDistributed() external view returns (uint256) {
	 ...
	 function SetantiDumpTransactionAmount(uint256 antiDumpTransactionAmount) external onlyOwner() {
        _antiDumpTransactionAmount = antiDumpTransactionAmount;
    }
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "AquaDoge: This account cannot send tokens until trading is enabled");
        }
        ...
        if( 
            ...
            require(amount <= _antiDumpTransactionAmount, "Sell transfer amount exceeds the antiDumpTransactionAmount.");
        }
...
contract AquaDogeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("AquaDoge_Dividend_Tracker", "AquaDoge_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(true, "AquaDoge_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1 && newClaimWait <= 86400, "AquaDoge_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "AquaDoge_Dividend_Tracker: Cannot update claimWait to same value");
