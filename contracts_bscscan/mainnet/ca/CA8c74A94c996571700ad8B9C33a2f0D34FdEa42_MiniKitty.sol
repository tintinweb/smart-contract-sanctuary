...
contract MiniKitty is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress = payable(0x3dCA72f59b5cA37b7326Dd80ebAF6ba17E328a4e); 
    ...
    uint256 private minimumTokensBeforeSwap = 4131000000000000000  * 10**9; 
