...
/**
   ...
   PutDog token will deflate itself in supply with every transaction
...
contract PutDog is Context, IERC20, Ownable {
    ...
    string private _name = "PutDog";      //CHANGE_REQUIRED: name of token
    string private _symbol = "PUTDOG";    //CHANGE_REQUIRED: ticker of token
