...
/**
  ...
  New token. Community decide if we need rewards. Small MarketCap. Reddit's and more marketing! Initial LP: 1 BNB
...
contract GhettoFloki is Context, IERC20, Ownable {
    ...
    string private _name = "GhettoFloki";
