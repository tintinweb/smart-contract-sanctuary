...
contract ShibaInu is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xABfB6A4846284b4269AffCc4eDc1cD0935f1E155); // Marketing Address
    address payable public charityAddress = payable(0xABfB6A4846284b4269AffCc4eDc1cD0935f1E155); // Charity/Dev Address
    ...
    string private _name = "Shiba Inu Coin"; // nice
