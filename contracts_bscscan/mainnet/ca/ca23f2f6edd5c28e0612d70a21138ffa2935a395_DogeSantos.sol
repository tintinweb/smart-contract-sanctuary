...
//the contract belongs to DogeSantos do not use without permission
...
contract DogeSantos is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "DogeSantos";
    string private _symbol = "DogeSantos";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 69000000000000 * 10 ** _decimals;
    uint256 private _maxTxTokens = 69000000000000 * 10 ** _decimals;
