...
*
* 3% Auto Reflections Rewarded in LASM
* 4% Auto Liquidity
* 3% Game Development
* 
* 
...
contract LASM is ERC20, ERC20Burnable, Ownable {
    ...
    address public gameDevWalletAddress = 0x86327f3E4Ca50c371267b0e7ab643700417373F7;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public constant team = address(0xA5a4acDeED681328f30AdF7F4ab47f8Bc4B6e589);
    address public constant Development = address(0x33e47782B772EfEE32AB40cAd98973654ac4610f);
    address public constant Marketing = address(0x4Bf381d672A18872378a38297A96f98ED76C4762);
    address public constant GameRewards = address(0x5e5FD9978b4aee43c86eD11EE2Dd7a63b475A0D3);
    address public constant airdrop = address(0x3304F4d05A2fa0714804f236734fbf9Eca428A55);
    address public constant GameDev = address(0xd41776431D016762aFE0c557e90508075ac76Cf3);
    address public constant LP = address(0x50dF3b6eF57578284619A993DaF6663Fb0F23099);
    ...
    constructor(address manager, address beneficiary_ ) ERC20("LasMeta", "LASM") {
        _beneficiary = beneficiary_;
        _releaseTime = block.timestamp + 31536000;//94670856 * 1 seconds;
        _manager = manager;
...
contract LasmDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address _cake) DividendPayingToken("Lasm_Dividend_Tracker", "Lasm_Dividend_Tracker", _cake) {
        claimWait = 3600;
