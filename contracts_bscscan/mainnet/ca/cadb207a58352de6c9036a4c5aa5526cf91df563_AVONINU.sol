...
contract AVONINU is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 100 * 10**10 * 10**9; // Max Transaction: 10 Billion (100%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 200 * 10**10 * 10**9; // Max Wallet: 10 Billion (100%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "AVON INU";
    string private _symbol = "AVONINU";
