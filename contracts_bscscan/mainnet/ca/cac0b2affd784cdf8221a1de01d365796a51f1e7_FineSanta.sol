...
/**
 * FineSanta ($Fanta)
 * Refinable ($FINE) Rewards Every 30-60 Minutes
 * Telegram: https://t.me/finesantabsc
 * 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FINE = IBEP20(0x4e6415a5727ea08aAE4580057187923aeC331227);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FINE.balanceOf(address(this));
        ...
        uint256 amount = FINE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FINE.transfer(shareholder, amount);
...
contract FineSanta is IBEP20, Auth {
    using SafeMath for uint256;

    address FINE = 0x4e6415a5727ea08aAE4580057187923aeC331227;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FineSanta";
