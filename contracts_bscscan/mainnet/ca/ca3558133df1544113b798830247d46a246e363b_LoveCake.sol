...
contract LoveCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LoveCake";
    string constant _symbol = "LCAKE";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 15 / 100; // 1.5% Max TX
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xe20E77EC5ddd8d880c3829b531CeD9861565f1c9;
