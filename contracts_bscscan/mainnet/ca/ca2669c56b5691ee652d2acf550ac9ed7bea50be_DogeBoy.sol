...
https://t.me/dogeboyofficial
0.5% Max txn, 2% Max wallet
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 DOGE = IERC20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
// CHANGE
contract DogeBoy is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeBoy";
    string constant _symbol = "$DOGEBOY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1/2) / 100; // 0.5% MAX 5,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 2% MAX 20,000,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x9F95B91Cd3A301d1DFBd6c63C4a5a9733FA637bC);
