...
/**
// Solidified by The dev Gerard Himself.
// telegram: https://t.me/MetaBullUniverse
// Website: Https://App.Metabulluniverse.finance
*/
...
contract MetaBullUniverse is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public charityAddress = 0x389CAF147A59b9040860EFFdfBe5C978177E5253;
    ...
    string private _name = "MBullUniv";
    string private _symbol = "MBU";
    ...
    // Innovation for protocol by MBU Team!
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own MBU to claim reward');
