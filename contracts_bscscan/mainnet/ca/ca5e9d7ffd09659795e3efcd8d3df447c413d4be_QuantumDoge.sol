...
/**
    Welcome to QuantumDoge
   
   This is a community token. If you want to create a telegram I suggest to name it to @QuantumDogeChat
   ...
   I will renounce the ownership to burn addresses to transfer #QuantumDoge to the community, make sure it's 100% safe.

   I will add .15 BNB and all the left 10% total supply to the pool
   Can you make #QuantumDoge 10000X? 
   ...
   it's the best part of the #QuantumDoge idea, increasing the liquidity pool automatically, 
...
contract QuantumDoge is Context, IERC20, Ownable {
    ...
    string private _name = 'QuantumDoge';
