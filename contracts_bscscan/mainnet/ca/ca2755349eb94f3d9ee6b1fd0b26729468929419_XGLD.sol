...
// LP will be locked for 18 years.


// HODL AND EARN $MGLD + $EGLD

/**

TG LINK: https://t.me/MetallurgyGold

Website: https://metallurgy.gold
...
Taxes: 10% Buy 10% Sell
    ...
    1% Dev
    2% buyback/burn 
    6% $MGLD redistributions to hodlers.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // $MGLD CONTRACT
    IERC20 MGLD = IERC20(0x87AE87773345fa023E7d1556b1159aF6B74cbB57);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MGLD.balanceOf(address(this));
        ...
        uint256 amount = MGLD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MGLD.transfer(shareholder, amount);
...
// CHANGE
contract XGLD  is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address MGLD = 0x87AE87773345fa023E7d1556b1159aF6B74cbB57;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "XGLD";
    string constant _symbol = "XMetallurgy";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% MAX 200,000
    ...
    uint256 public swapThreshold = _totalSupply / 75; // 1.5%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x6bEEC830F8d42672A522AE6657034D6ee49aaDe9); // Change
