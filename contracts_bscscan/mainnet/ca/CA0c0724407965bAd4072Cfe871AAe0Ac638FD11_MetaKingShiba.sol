...
contract MetaKingShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meta King Shiba";
    ...
    address payable private _marketingAddress = payable(0xc617099F4bBAE2C37b5b030eC96acaDd85C9058F);
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**9; //2.5
    uint256 public _maxWalletSize = 5000000000000 * 10**9; //2.5
    uint256 private _swapTokensAtAmount = 5982016362091 * 10**9; //0.1
