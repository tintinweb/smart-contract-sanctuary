...
contract sGAToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 900000 * 10**9;
    ...
    constructor() ERC20("Staked Green Arrow", "sGA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sGA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sGA
