...
(   )                                                  (   )                              
 ...
 | |  | |  | '  | |  | |  | |  | | |  .'.-.   |  .'.-.  | |  | '  | |  | |  | |  |  .'.-. 
 | |  | |  '  `-' /  | |  | |  | | '  `-' /   '  `-' /  | |  '  `-' /  | |  | |  '  `-' / 
(___)(___)  `.__.'  (___)(___)(___) `.__.'     `.__.'  (___)  `.__.'  (___)(___)  `.__.'  
                                                                                          
Elon is home alone this christmas. Join HomeElone for giveaways to the community and charity this Christmas.
...
Tokenomic and Feature
4% USDC Reflection Fees
4% Marketing Fees
2% Giveaway Fees
2% Liquidity Fees

Social Media and Website
Website: WWW.HOMEELONe.COM
Telegram: t.me/HomeElone
Twitter: twitter.com/homeelone
TikTok: tiktok.com/@HomeEloneOfficial
*/
...
contract HomeELONe is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Home ELONe";
    string constant _symbol = "HELONE";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x6B59DAdF34598eCd7B4683FB0D267D287CcB8801;
        marketingWallet = 0x13133DE3FD2454294191A3040cd00e499A4814f7;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(sender == pair && !authorizations[sender] && !authorizations[recipient]){
            require(buyOpen, "Buy not open yet");
        }
    ...
    function setBuyIsOpen(bool buyIsOpen) public onlyOwner {
        buyOpen = buyIsOpen;
    }
