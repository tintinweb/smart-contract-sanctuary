...
import "./SuperDaddyBusd-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SuperDaddyBusd` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SuperDaddyBusd(Env.Testnet)` or `SuperDaddyBusd(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SuperDaddyBusd";
    string internal constant SYMBOL = "SDB";
     ...
     */
    address internal tipToTheDev = 0x6CB461C444a72BB90443BACc08403bF9b52ed6a7;
...
contract SuperDaddyBusd is SafeToken{
