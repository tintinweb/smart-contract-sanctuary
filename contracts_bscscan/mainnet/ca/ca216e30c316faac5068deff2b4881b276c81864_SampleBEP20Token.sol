...
/*
 * @Warfare is a Binance Smart Chain Nft games.
...
contract SampleBEP20Token {
    string public name = "Warfare Games";
    string public symbol = "Warfare";
    uint256 public totalSupply = 1000000000000000000000000000000; // 1 Q Token
