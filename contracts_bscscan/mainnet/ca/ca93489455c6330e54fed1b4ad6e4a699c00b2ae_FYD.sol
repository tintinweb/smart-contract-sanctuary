...
contract FYDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("FYD_Dividend_Tracker", "FYD_Dividend_Tracker") {
        claimWait = 14400;
...
contract FYD is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
...
//    mapping(address => bool) public _isBlacklisted;
    ...
    constructor() ERC20("FeedYourDoge", "FYD") {
        BNBRewardsFee = 0;
        liquidityFee = 0;
        extraFeeOnSell = 0; // extra fee on sell
        MarketingFee = 0;
        MarketingWallet = payable(0x74Dd37E499711f5094DC9D9806E46c9f764c9f13);
