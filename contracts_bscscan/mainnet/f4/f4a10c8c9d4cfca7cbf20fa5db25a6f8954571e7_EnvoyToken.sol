...
/* envoytoken Binance launch Pad- BNB Reward Token

website: https://envoytoken.net
Listing 1 ENV = 0.03 USD
...
contract EnvoyToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1506e5591f22fAC2ecb4a9F31588CaeB90dFA6bB); // Marketing Address
    address payable public charityAddress = payable(0x1506e5591f22fAC2ecb4a9F31588CaeB90dFA6bB); // Charity/Dev Address
    ...
    uint256 private _tTotal = 98000000 * 10**18; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Envoy Token";
    ...
    uint256 public _maxTxAmount = 200000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 200000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 2000000;// 0.01*20,000 token for 0.01 bnb (set as per requirements)
