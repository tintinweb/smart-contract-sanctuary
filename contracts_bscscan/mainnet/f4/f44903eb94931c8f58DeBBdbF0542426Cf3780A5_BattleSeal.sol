...
/*
https://t.me/BattleSEALToken

https://battleseal.com/

https://twitter.com/BattleSEALToken

https://www.instagram.com/battlesealtoken/
...
contract BattleSeal is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    /*
    DELETE BEFORE DEPLOYMENT https://www.youtube.com/watch?v=Yb6dZ1IFlKc
    */
    
    address payable public marketingAddress = payable(0x0919F851616E333d0351c98a0F3c5f96853a929A); // Marketing Address $$$ changed this to alternative wallet
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD; //If you wanted to burn tokens then you would send it to this address! This contract does have autoburn :P
    ...
    uint256 private _tTotal = 100000000 * 10**6 * 10**9;//Zero removed
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BattleSeal";
    ...
    uint256 public _buyTaxFee = 2; //Reflection
    uint256 public _buyLiquidityFee = 4; //Buy autoboost
    
    uint256 public _sellTaxFee = 6;// sell reflection
    uint256 public _sellLiquidityFee = 5; //sell autoboost
    ...
    uint256 public marketingDivisor = 4; //marketing
    
    
    uint256 public _maxTxAmount = 3000000 * 10**6 * 10**9; //max amount to buy
    ...
    This is the end https://youtu.be/NOW7i7aWQoE
