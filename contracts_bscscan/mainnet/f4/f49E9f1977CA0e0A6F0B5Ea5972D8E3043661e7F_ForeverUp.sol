...
contract ForeverUp is BEP20 {
     ...
     */
    constructor(uint _startTradingTime, address _pcsRouter, address payable _mkt, address payable _buyback) public BEP20("UpTest2", "UPTST2") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override 
        ...
        if (pair != address(0) && !burnPaused && recipient == pair && !_inSwapAndLiquify) {
