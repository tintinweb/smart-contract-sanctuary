...
contract UNCLESHIBZILLA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "UNCLESHIBZILLA";
    string constant _symbol = "USZ";
    ...
    function setRewardimit(uint256 amount) external authorized {
        _maxTxAmount = amount;
