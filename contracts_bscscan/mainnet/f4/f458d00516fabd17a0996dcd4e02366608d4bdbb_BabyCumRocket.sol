...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CUMMIES = IERC20(0x27Ae27110350B98d564b9A3eeD31bAeBc82d878d);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CUMMIES.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CUMMIES);
        ...
        uint256 amount = CUMMIES.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CUMMIES.transfer(shareholder, amount);
...
contract BabyCumRocket is IERC20, Ownable {
    using SafeMath for uint256;

    address CUMMIES  = 0x27Ae27110350B98d564b9A3eeD31bAeBc82d878d;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyCumRocket";
