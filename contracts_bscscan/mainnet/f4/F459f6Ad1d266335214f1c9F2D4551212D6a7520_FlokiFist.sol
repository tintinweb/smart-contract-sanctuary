...
contract Ownable is Context {
    address private _owner = 0x3bAF8A1af36385b6579AAbe59d660879f949e635;
...
contract FlokiFist is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xd9a534db05593701794269abaAbc77e4A4149dd1); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Floki Fist"; // token name
    string private _symbol = "Floki Fist"; // token symbol
    uint8 private _decimals = 9; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 1000 * 10**0 * 10**_decimals;
    ...
    uint256 public _minTokensSwapToAndTransferTo = 2 * 10**0 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
