...
1 % to LP
The rest to buyback/marketing, because our mission is all about the moon.

https://t.me/minifegnomics_token
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x7F3058b872555eCB3A2723D4FCf2A56a0b8488ca);
...
contract MiniFegnomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniFegnomics";
    string constant _symbol = "MFEGN";
    ...
    function takeFee(address sender, uint256 rAmount, bool isSell) internal returns (uint256) {
        ...
        if(FEG && !isSell && (launchedAt + deadBlocks) > block.number){
    ...
    function setFEG(bool _FEG) external onlyOwner{
        FEG = _FEG;        
    }
