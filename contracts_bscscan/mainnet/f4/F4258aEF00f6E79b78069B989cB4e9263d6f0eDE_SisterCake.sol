...
// Join our Telegram: https://t.me/sistercakeofficial
// Website: http://sistercake.online/
...
contract SisterCake is ERC20, Ownable {
    ...
    constructor() ERC20("SisterCake", "SisterCake") {
    ...
    receive() external payable {
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != marketingWallet, "SisterCake: The marketing wallet is already this address");
    ...
    function updatefirstDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(firstDividendTracker), "SisterCake: The dividend tracker already has that address");
 
        FIRSTDividendTracker newfirstDividendTracker = FIRSTDividendTracker(payable(newAddress));
 
        require(newfirstDividendTracker.owner() == address(this), "SisterCake: The new dividend tracker must be owned by the SisterCake token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(isExcludedFromFees[account] != excluded, "SisterCake: Account is already exluded from fees");
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "SisterCake: Trading has not started yet");
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("SisterCake_Dividend_Tracker", "SisterCake_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 3600;
    ...
    function withdrawDividend() pure public override {
        require(false, "SisterCake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SisterCake contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "SisterCake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
