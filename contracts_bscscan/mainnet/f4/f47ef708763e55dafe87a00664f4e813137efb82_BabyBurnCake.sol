...
/*
    EARN CAKE. TOTAL SUPPLY GETS BURNED.
*/
...
contract BabyBurnCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyBurnCakeDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0xF2211CE3cfd43126187BCC1676d3cB3B19A72Fad;
    ...
    constructor() public ERC20("BabyBurnCake", "BBURN") {

    dividendTracker = new BabyBurnCakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BabyBurnCakeDividendTracker newDividendTracker = BabyBurnCakeDividendTracker(payable(newAddress));
...
contract BabyBurnCakeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BabyBurnCake_Dividend_Tracker", "BabyBurnCake_Dividend_Tracker") {
    claimWait = 3600;
