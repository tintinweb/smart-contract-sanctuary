...
/**
     ...
     Bitgames - -  Stealth launch to the moon !!!!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ETH = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
contract Bitgames is IBEP20, Auth {
    using SafeMath for uint256;

    address ETH = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Bitgames";
    string constant _symbol = "$BGAM";
    ...
    address public autoLiquidityReceiver = 0x364aAF76a8a55b692E56D97E407Ca2E11d58EAE4;
    address public marketingFeeReceiver = 0x364aAF76a8a55b692E56D97E407Ca2E11d58EAE4;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x364aAF76a8a55b692E56D97E407Ca2E11d58EAE4;
