...
Web3 Token
Web3 Index is an index launched by Index Coop. Web3 Index, by Index Coop,
 is a basket of tokens designed to capture the trend of entertainment, 
 sports and business shifting to a virtual environment. 
 The index is represented by an BEP20 token, ''Web3 Token''

TG:https://t.me/web3token
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa9c2BD665B606869657762008863c1e567228Ae0;
...
contract Web3 is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xa9c2BD665B606869657762008863c1e567228Ae0);
