...
// File contracts/ERC20/ZIGTEST.sol

//  MIT
pragma solidity ^0.8.0;

interface ZIGTEST is IERC20 {
...
contract FarmDep is Pausable{
    ...
    ZIGTEST private richTokenInter;
    ...
    function setRichToken(address _newAddress) external onlyWhitelistSetter {
        ...
        richTokenInter = ZIGTEST(_newAddress);
...
abstract contract RichTokenCover is ERC20, ZIGTEST, ERC20Burnable, RichFarmStorage {
    using SafeMath for uint256;
