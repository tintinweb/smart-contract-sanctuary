...
contract leodog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf276a456A306996237e37208FD7022a0fB6F825c); // Marketing Address
    ...
    string private _name = "leodog";
    string private _symbol = "leodog";
    ...
    uint256 public _maxTxAmountBuy =  9999 * 10**9;
    uint256 public _maxTxAmountSell = 1 * 10**9;
