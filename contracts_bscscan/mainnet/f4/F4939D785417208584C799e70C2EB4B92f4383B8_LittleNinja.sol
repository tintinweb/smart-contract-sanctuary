...
contract LittleNinja is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x79E09981dA53424D1e065640C298d320feE1121d); // Marketing Address
    ...
    string private _name = "LittleNinja";
    string private _symbol = "LTNJ";
