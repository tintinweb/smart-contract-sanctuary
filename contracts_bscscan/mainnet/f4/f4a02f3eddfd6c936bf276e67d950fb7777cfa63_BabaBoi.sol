...
+  Devs Wallet:  2.000.000.000.000 (2%)
 ...
 16% Transaction Fees
 10% is auto redistributed to all holders In TWT Hold BabyCucumber tokens, earn TWT. 
...
contract BabaBoi is IERC20, Ownable {
    ...
    string constant _name = "Baby Cucumber";
    string constant _symbol = "BCucumber";
