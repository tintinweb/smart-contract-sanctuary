...
contract RiseUpBabyShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x65e5E3f02DAC26B8fdCEb6d31aCf3A2Bf091123C); // Marketing Address
    ...
    string private _name = "RiseUpBabyShiba";
    string private _symbol = "RUBS";
