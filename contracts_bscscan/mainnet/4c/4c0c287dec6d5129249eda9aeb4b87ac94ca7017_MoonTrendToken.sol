...
contract MoonTrendToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x05C81AcDD0c936C65FBcE460b48df480e4a4153D); // Marketing Address
    ...
    string private _name = "MoonTrendToken";
