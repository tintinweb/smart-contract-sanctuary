...
contract RPST is IBEP20, Auth {
    ...
    string constant _name = "RPS Token";
    ...
    function setIsDividendExclusionExempt(address account, bool exempt) external authorized {
    ...
    function setGameContract(address gameContractAddress) external authorized {
    ...
    function setFees(uint256 _devFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _gameFee, uint256 _feeDenominator) external authorized {
        if(feesLocked) {
    ...
    function setMarketingAddress(address _marketingFeeReceiver) external authorized {
    ...
    function rescueDividends(address to) external authorized {
        distributor.rescueDividends(to); 
    }

    function rescueTokenFromDividendDistributor(address token, address to) external authorized {
