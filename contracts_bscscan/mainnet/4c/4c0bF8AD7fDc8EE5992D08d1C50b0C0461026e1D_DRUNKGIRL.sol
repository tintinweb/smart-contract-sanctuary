...
/**
 *Submitted for verification at BscScan.com on 2021-11-020
*/
...
contract DRUNKGIRL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DRUNKGIRL";
    string constant _symbol = "DRNKGRL";
    ...
    uint256 liquidityFee = 3500;
    uint256 buybackFee = 100;
    uint256 reflectionFee = 700;
    uint256 marketingFee = 5500;
    uint256 totalFee = 9800;
