...
contract DividendDistributor is IDividendDistributor {
    ...
    function claimDivide0nd() external {
...
// CHANGE
contract FuckTheJeets is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FuckTheJeets";
    string constant _symbol = "FTJ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 40,000,000
    ...
    uint256 liquidityFee = 100; // 3%
    uint256 buybackFee = 300;   // 3% 
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 100; // 8%
    uint256 totalFee = 500; // liquidityFee + Buyback + devFee
    uint256 feeDenominator = 10000;
    uint256 public _sellMultiplier = 6; // 
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x5BD06d8a33e10037fBf3F831CF863E48675dE209);
