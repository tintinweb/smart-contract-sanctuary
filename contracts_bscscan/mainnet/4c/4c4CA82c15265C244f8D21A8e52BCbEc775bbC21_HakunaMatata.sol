...
// Telegram  T.me/HakunaMatatacoin
...
// CHANGE
contract HakunaMatata  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "HakunaMatata";
    string constant _symbol = "HUM";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 10,000,000,00
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 5% MAX 200,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 5% MAX 200,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xa53d2c298D8d96Af0af28BfF42Ba2185Dd71d5AD); // Change
