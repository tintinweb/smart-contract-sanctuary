...
Earn BUSD rewards while supporting England! Go England!
...
contract GoEngland is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "GoEngland";
    string constant _symbol = "GoEngland";
