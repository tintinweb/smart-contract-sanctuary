...
Meta-Swap is a redep20 token, 
with ideas to be your idea and biased,
it will be the creation of NFTs and METAVERSE games,
as we do not believe in a world full of new possibilities.
...
contract Metaswap is IBEP20, Auth {
    ...
    string constant _name = "Metaswap";
    ...
    uint256 public swapThreshold = _totalSupply / 20000; // Swap for distribuition
    bool inSwap;
