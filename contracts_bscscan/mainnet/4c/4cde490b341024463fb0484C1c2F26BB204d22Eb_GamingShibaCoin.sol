...
contract GamingShibaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "GamingShibaCoin";
    string private constant _symbol = "GamingShibaCoin";
    ...
    //Sell Fee
    uint private _redisFeeOnSell = 3;
    ...
    address payable private _marketingAddress = payable(0x2842f828fEfe3d7CA48ee9a0118AC063f17d71Cd);
