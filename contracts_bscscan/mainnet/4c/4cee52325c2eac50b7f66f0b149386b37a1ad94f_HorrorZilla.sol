...
contract HorrorZilla is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("HorrorZilla", "$HORRORZILLA", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0xA442F780c271b2C1128199C13B6EF1e76bba1197;
        ecosystemFeeReceiver = 0x064bdEeCC6365B4C21024c4de05B42bd48901B2d;
        buyBackFeeReceiver = 0x83CF7C0b531D40b21d2262F1F116D37937b89B0F;
