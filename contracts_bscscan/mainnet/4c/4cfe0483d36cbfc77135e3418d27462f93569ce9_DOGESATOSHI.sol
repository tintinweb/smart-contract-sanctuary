...
*       █▄▀ █▄█ █▄█ ██▄   ▄█ █▀█ ░█░ █▄█ ▄█ █▀█ █
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #DogeSatoshi
   
                https://t.me/DogeSatoshi

    I make this #DogeSatoshi to hand over it to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #DogeSatoshi to the community, make sure it's 100% safe.

   I will add 0,5 BNB and all the left total supply to the pool
   Can you make #DogeSatoshi 1000X?
   ...
   it's the best part of the #DogeSatoshi idea, increasing the liquidity pool automatically,
...
contract DOGESATOSHI is Context, IBEP20, Ownable {
