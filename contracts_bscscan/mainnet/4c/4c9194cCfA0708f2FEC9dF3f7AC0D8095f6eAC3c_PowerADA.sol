...
interface ADAiERC20 {
   ...
   *
   * Returns a boolean value indicating whCARDANOr the operation succeeded.
   *
   ...
   * https://github.com/CARDANO/EIPs/issues/20#issuecomment-263524729
   *
...
contract PowerADA is ADAiERC20 {
    // common addresses

    address private owner;
    address private CARDANO;
    address private ADA;
    address private WEB;
    ...
    string public override name = "Power ADA";
    string public override symbol = "PADA";
    ...
    constructor(uint totalSupplyValue, address CARDANOAddress, address ADAAddress, address WEBAddress) {
        // set total supply
        ...
        balances[CARDANO] =  totalSupply * 1 / 100;
