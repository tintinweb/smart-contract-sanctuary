...
contract LaqiraTokenTimeLock {
    ...
    // Seconds of 3 months, release period is 3 months and all the tokens will be released in 16 periods(16 * 3 month = 4 yaers).
    uint256 public constant period = 7776000;
