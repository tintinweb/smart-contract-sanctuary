...
contract ShibaCake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x606C7812FE6101E43631072b1474A6D211277EF8); // Marketing Address
    ...
    string private _name = "ShibaCake";
    string private _symbol = "SHICA";
