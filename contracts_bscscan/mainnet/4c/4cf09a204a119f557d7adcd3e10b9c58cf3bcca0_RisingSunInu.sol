...
/**
   ...
   I make this #RisingSunInu to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/RisingSunInuBSCToken

   Great features:
   5% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   3% fee for dev wallet
   50% burn to the black hole

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #RisingSunInu to the community, make sure it's 100% safe.

   I will add 0.4 BNB and all the left 50% total supply to the pool
   Can you make #RisingSunInu 1000X? 
   ...
   it's the best part of the #RisingSunInu idea, increasing the liquidity pool automatically, 
...
contract RisingSunInu is Context, IERC20, Ownable {
    ...
    string private _name = "Rising Sun Inu";
    string private _symbol = "RSUNI";
    ...
    address payable public devAddress = 0xA74f02CfAD2d6893026dA277230cEde5239476e7; 
