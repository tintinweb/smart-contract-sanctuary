...
contract PrivateSaleHoneyPad is Ownable {
    ...
    uint256 public hardCapEthAmount = 1 ether / 10;
    uint256 public totalDepositedEthBalance;
    uint256 public minimumDepositEthAmount = uint256(1 ether).div(100);
    uint256 public maximumDepositEthAmount = uint256(3 ether).div(100);
    uint256 public tokenPerBNB = 10000;
