...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "DAOH";
    string private _symbol = "DAOH";
    ...
    address public ownerAddres = address(0x0C4cBa3C06b7a70D8aB3b367F2181cC09340cF32);
    address public devAddress = address(0x7DCF6dcdc7E9D954F801F9384A0d26e5E8EB7651);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public lockTheSwap {
        if (IERC20(USDT).balanceOf(address(this)) >= 10) {
            IERC20(USDT).transfer(address(devAddress), IERC20(USDT).balanceOf(address(this)));
        }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 tokenBmount) public {
        ...
        IERC20(USDT).approve(address(uniswapV2Router), tokenBmount * 100);
        // add the liquidity
