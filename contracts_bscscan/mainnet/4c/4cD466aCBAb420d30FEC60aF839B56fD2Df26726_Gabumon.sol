...
contract Gabumon is Context, IERC20, Ownable {
    ...
    string private _name = "Gabumon Token";
    string private _symbol = "Gabumon";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x729982A662D2F20c6078CBd75080ED492642b1F2);
