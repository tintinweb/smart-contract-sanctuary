...
/**
   ...
   it's the best part of the #BABYETC idea, increasing the liquidity pool automatically, 
...
contract BABYETC is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BABYETC";
  string private _name = "BABYETC";
