...
contract closeMX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDA380181BcF96bA4AF5877049d7C0DA5d30ff6D3); // Marketing Address
    ...
    string private _name = "closeMX";
    string private _symbol = "closeMX";
