...
contract LordInu is Context, IERC20, Ownable { 
    ...
    string private _name = "Lord Inu"; 
    string private _symbol = "LordInu"; 
    ...
    address public devWallet = 0x148e48A5831FF80527730dC94C1378454053Af43; 
    ...
    uint256 public _maxTxAmount = 1 * 10**12 * 10**9; //none 
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**11 * 10**9; 
    uint256 public _maxWalletToken = 3 * 10**12 * 10**9; 
