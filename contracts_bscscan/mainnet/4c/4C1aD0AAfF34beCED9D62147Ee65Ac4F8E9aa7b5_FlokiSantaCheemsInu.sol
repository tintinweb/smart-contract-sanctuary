...
// File contracts/FlokiSantaCheemsInu.sol
pragma solidity ^0.8.0;

contract FlokiSantaCheemsInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiSantaCheemsInu";
    string private constant _symbol = "FSCI";
