...
contract Brawl13 is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    /* Constants and Mains */
    uint constant tournament_type = 1 ;
    string public constant tournament_name = 'Brawl Stars #13';
    string public constant start_date = '23rd Jan - 15:00 UTC';
    uint public prizepool = 0;
    uint public poolPerUser = 60000000000000000000;
    
    uint public constant timeLocked = 30 days;
    uint public constant timePaying = 5 days;
    uint public constant amountToLock = 2500000000000000000000;
    uint public pointsPerRegistration = 10;
    
    uint public constant percentage = 450;
    uint public constant playersPerTeam = 3;
    uint public maxParticipants = 64;
    uint public numParticipants;
    
    /* UNIX date when register finish: 22nd Jan 20:00 UTC */
    uint public register_date = 1642881600; 
