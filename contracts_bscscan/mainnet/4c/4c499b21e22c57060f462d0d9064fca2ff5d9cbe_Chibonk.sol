...
contract Chibonk is Context, IERC20, Ownable {
    ...
    string private _name = "Chibonk";
    string private _symbol = "$CHIBO";
    ...
    address public marketingWallet = 0x325F843eed656496caEb58b0904DD0d4A4810E0b;
