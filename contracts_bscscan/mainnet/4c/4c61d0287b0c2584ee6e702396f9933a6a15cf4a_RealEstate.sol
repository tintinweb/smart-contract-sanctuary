...
contract RealEstate is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 69000000000000000000000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 20000000000000000000000 * 10 ** 9;
    uint256 MAX_LOCK   = 69000000000000000000 * 10 ** 9;
    ...
    constructor() ERC20("RealEstate", "RealEstate") {
        addressForMarketing =address(0xd90646FC4E1e2207e350fCb167B5d616f5C4B314);
