...
/**
   #MECCACOIN RSVD (MRSVD)
   8% fee auto add to the liquidity pool
   8% distribute to a charity wallet
   8% to holders
   ttl supply = 888000000000000000
   decimals 18
*/
...
contract MeccacoinRSVD is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x0d9BFa805C9D7112c5E2BE836a30192B196A5cA1;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 888000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MECCACOIN RSVD";
    string private _symbol = "MRSVD";
    ...
    uint256 public _maxTxAmount = 888000000000000000 * 10**18;
