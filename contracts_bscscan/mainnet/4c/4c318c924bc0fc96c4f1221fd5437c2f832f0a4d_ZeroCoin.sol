...
/**
   ...
   Welcome to Zero Coin
   
   This is a community token. If you want to create a telegram I suggest to name it to @ZeroCoinBsc
   Important: Elon just calling about Dragonfly. The early you create a group that shares the token, the more gain you'll get.
   ...
   I will renounce the ownership to burn addresses to transfer #ZeroCoin to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ZeroCoin 10000X? 
...
contract ZeroCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Zero Coin";
