...
Bringing you that sweet 80'ies nostalgia (even for all of us wasn't even born)

Rewards in Daddy RetroMoon 👀.

https://t.me/MiniRetroMoon
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xE81FE8bBBEA13A0fd5Cc0AAFb6062631C659eC54);
    IDEXRouter router;
...
contract MiniRetroMoon is IBEP20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniRetroMoon";
    string constant _symbol = "MiniRETRO";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.div(1000).mul(50);
    uint256 public _maxWalletToken = _totalSupply.div(1000).mul(50);
