...
contract BabyTron is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x2E75796f0639E6Dc08Fc5BFe9DA0aFC7911D443B); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0x973a9f0C93DFa88987dE2BFB963D1A6a7569468A); // tron Address
    ...
    string private _name = "TRONEARNER";
    string private _symbol = "TRONEARN";
    uint8 private _decimals = 9;

    uint256 public _burnFee = 2;
    uint256 public _liquidityFee = 5;
    uint256 public _marketingFee = 5;
    uint256 public _tronCharityFee = 5;
    ...
    constructor () {
        ...
        _totalTaxPercent = _burnFee.add(_liquidityFee).add(_marketingFee).add(_tronCharityFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(forWallets > 0 && _marketingFee.add(_tronCharityFee) > 0)
        {
            uint256 initialBalance = address(this).balance;
            swapTokensForEth(forWallets);
            uint256 newBalance = address(this).balance.sub(initialBalance);
    
            uint256 marketingShare = newBalance.div(_marketingFee.add(_tronCharityFee)).mul(_marketingFee);
