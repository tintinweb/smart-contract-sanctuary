...
/** 
  * https://t.me/DogeRewardToken
 * 
Enjoy First BSC token with dual functionality : Buyback system AND DogeCoin reward

➡️10% to DogeRewardToken holders in official dogecoin (minimum hold to earn 250,000 Tokens)
...
contract DogeReward is Context, iBEP20, Ownable {
  ...
  constructor() public {
    _name = 't.me/DogeRewardToken';
    _symbol = 'HUGE presale in 10min';
    _decimals = 18;
