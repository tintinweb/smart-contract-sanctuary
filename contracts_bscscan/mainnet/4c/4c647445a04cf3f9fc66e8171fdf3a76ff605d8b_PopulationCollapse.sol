...
contract PopulationCollapse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x21dE1f87888De67d4D584AE527eA96291f8643d9); // Marketing Address

    address payable public teamAddress =
        payable(0x21dE1f87888De67d4D584AE527eA96291f8643d9); // Team Address

    address payable public liquidityAddress =
        payable(0x5dCF626373938c739702b12E30C40b86f675a877); // Liquidity Address
    ...
    string private constant _name = "PopulationCollapse";
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 60 / 1000; // 3% maxWalletToken
