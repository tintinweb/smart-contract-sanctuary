...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB92F435a03e526305dE52F22B7853A70B95185B4;
...
contract Onesto is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x84B1daa8CC6284534Ad0FD02a5d8037A726e524a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Onesto";
    string private _symbol = "ONST";
