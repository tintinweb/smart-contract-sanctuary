...
contract StepSisDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2D6F983c90d5D0a7A6ff35c0E74ed121CB17B641); // Marketing Address
    ...
    string private _name = "StepSisDoge";
    ...
    uint256 public _buyBackFee = 11;  //buyback + marketing
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(marketingAddress, transferredBalance.div(_buyBackFee).mul(marketingDivisor));
