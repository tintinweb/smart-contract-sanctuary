...
**
⚡️Fair Launch soon⚡️
December 24, 2021 at 15:00 UTC

Chikuinubsc is an exciting new project on the Binance Smart Chain network. 
Highly skilled developers, experienced marketing team and dynamic community.
So don't miss this opportunity ⚡️we're going to the moon soon🚀
...
Supply 100B
BURN 20%
Initial Liqudity 2 BNB

https://t.me/chikuinubsc
https://twitter.com/ChikuinuBSC/status/1474074016826609689?s=20
*
*
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x12EC89cb193C288aE0a8a700658892EdAe6C9b51;
...
contract ChikuinuBSC is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0x068288347c528245E65aCc53E3BFa5376f2025E7);
    address payable public Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_renounce = payable(0x0000000000000000000000000000000000000000); 
    ...
    */
    ...
    string private _name = "ChikuinuBSC"; 
    string private _symbol = "$CIB";  
    ...
    uint256 private maxPossibleFee = 100 * 10**6; 


    // Setting the initial fees
    uint256 private _TotalFee = 100 * 10**6;
    ...
    */
    ...
    // Max wallet holding (5% at launch)
    uint256 public _maxWalletToken = _tTotal.mul(5).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (5% at launch)
    ...
    */
    ...
    eg: For 5% enter 500, for 1% enter 100, for 0.25% enter 25, for 0.2% enter 20 etc!
