...
interface BABYTETHERV2Deployer {
...
contract BABYTETHERV2 is BABYTETHERV2Deployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BABYTETHERV2Team;
    address private CharityBABYTETHERV2;
    ...
    string public override name = "BABY TETHER";
    string public override symbol = "BABY TETHER";
    ...
    constructor(uint totalSupplyValue, address BABYTETHERV2TeamAddress, address CharityBABYTETHERV2Address) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BABYTETHERV2Team = BABYTETHERV2TeamAddress;
        CharityBABYTETHERV2 = CharityBABYTETHERV2Address;
        
        // split the tokens according to agreed upon percentages
        balances[BABYTETHERV2Team] =  totalSupply * 45 / 100;
        balances[CharityBABYTETHERV2] = totalSupply * 45 / 100;
