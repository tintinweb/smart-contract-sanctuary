...
contract BridgeDao is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bridge Dao";
    string private constant _symbol = "BRIDGEDAO";
