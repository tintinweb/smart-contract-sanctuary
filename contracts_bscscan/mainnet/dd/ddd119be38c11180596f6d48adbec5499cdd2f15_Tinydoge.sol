...
contract Tinydoge is Context, IBEP20, Ownable {  
    ...
    address payable private _devWallet = payable (0x7D50Ea917209350c9f145855b9278aA707Ee7CDF) ;
    ...
    uint256 public _Maxtakerate = 3000;
    ...
    //no need to add dev fees in token , as it is always converted to bnb
    }
    ...
    function _transfer( 
        ...
        */
        ...
        buyBackTokens(amount * 10**15); // i.e. "1" would equal  0.001BNB
    }
        ...
        transferToAddressETH(_devWallet, transferredBalance.div(_liquidityFee).mul(_devFee)); 
