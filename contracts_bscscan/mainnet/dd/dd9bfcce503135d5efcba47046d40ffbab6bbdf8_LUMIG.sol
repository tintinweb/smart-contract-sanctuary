...
contract LUMIG is Context, IERC20, Ownable {
    ...
    string private _name = "LUMI Governance Token";
    string private _symbol = "LUMIG";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1 * 10**10;
    ...
    event SetMaxBal(uint256 maxBal);
