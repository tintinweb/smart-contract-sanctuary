...
Telegram: https://t.me/sirdogelot
...
contract SIRDOGELOT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address private constant Burn =
    ...
    string private _name = "Sir Dogelott";
    string private _symbol = "SIRDOGELOT";
    ...
    uint256 private _maxTxAmount = 200000000000 * 10**9 ;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "ERRR::transfer: Burn value invalid"
            );

            //transfer amount, it will take tax, burn, liquidity fee
            _tokenTransfer(from, Burn, burnAmount, false);
