...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    address public devWallet = 0xF4674490a6Ee45D5cCAbD0abf61A679574E3a744; //2% for marketing ,1% for giveaways
    ...
    function excludeFromReward(address account) public onlyOwnerr() {
    ...
    function includeInReward(address account) external onlyOwnerr() {
        require(_isExcluded[account], "Account is already excluded");
    ...
    function excludeFromFee(address account) public onlyOwnerr {
        _isExcludedFromFee[account] = true;
    }
    
    function includeInFee(address account) public onlyOwnerr {
        _isExcludedFromFee[account] = false;
    }
    
    //Call this function after finalizing the presale on DxSale
    function enableAllFees() external onlyOwnerr() {
        _taxFee = 0;
    ...
    function setDevWallet(address newWallet) external onlyOwnerr() {
        devWallet = newWallet;
    }
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwnerr {
