...
/**
     Welcome to BabyJason. Hodl to earn HELL tokens.
     Liquidity will be burnt to hell ensuring safety. 
     Taxes are 20%
     Join the TG - https://t.me/FridayThe13thBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0x46328f831cFF23F44D65fa5e53a7217a660554Aa);
...
contract BabyJason is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public currentlyServing = "HELL";

    string constant _name = "BabyJason";
    string constant _symbol = "BabyJason";
