...
contract SCREWBSC is Context, IBEP20, Ownable {
    ...
    string private _name = "SCREW FUCKING JEETS RUGGING, SCREW BSC, SCREW FUCKING CZ FOR NOT DOING ANYTHING WITH BSC, SCREW MY NET WORTH AGAIN, SCREW BITCOIN RECOVERY, SCREW MY LIVE SAVINGS WHICH HAVE BEEN LOST THIRD TIME THIS YEAR, SCREW STEEZY AND HIS GEMS, SCREW KATY PERRY , SCREW JENNIFER LOPEZ BECAUSE SHE IS A MILF, SCREW THE DEV HIMSELF FOR NOT RUGGING WHEN WE WANT TO BE RUGGED, SCREW MOONARCH AND MOONARCH APP SNIPES GROUP WITH SPECIAL SCREW GOING TO YES, YOU BITCH, SCREW FRONTMANT FOR NOT CALLING MICROCAPS ANYMORE, I CALL YOUR MOM EVERY DAY, SCREW SuperMarioCalls as their gems are not jumping as high as Mario himself, SCREW ALL BEGGARS, ESPECIALLY THE INDIANA JONES ONES [special ethnicity group, indicating an advanced jeet], LAST BUT NOT LEAST, SCREW CHARLES HOSKINSON FOR NOT DOING ANYTHING WITH CARDANO EITHER";
    string private _symbol = "SCREW";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap =0xBC29496BEEff60bc468804A5E58dbbBFD777E917;
