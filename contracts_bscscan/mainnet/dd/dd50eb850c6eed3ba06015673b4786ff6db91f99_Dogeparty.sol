...
/**
       Welcome to #DogeParty
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #DogeParty designed.
      
       This is a community token. If you want to create a telegram.
       I suggest by name @DogepartyBSC
       ...
       I will renounce the ownership to burn addresses to transfer #DogeParty to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 90% total supply to the pool
       Can you make #DogeParty 10000X? 
       ...
       it's the best part of the #DogeParty idea, increasing the liquidity pool automatically, 
...
contract Dogeparty is Context, IERC20, Ownable {
    ...
    string private _symbol = "DogeParty";
    ...
    uint256 private minimumTokensBeforeSwap = 30000 * 10**6 * 10**9; 
