...
contract TimoToken is Context, ERC20, Ownable {
    ...
    // Address that include in timo LP list
    mapping(address => bool) private _includeInTimoLpList;
    ...
    string private _name = "Timotest";
    string private _symbol = "TIMOTEST";
    ...
    // Minimum TIMO sell order to trigger buyback
    ...
    constructor () public {
        ...
        _includeInTimoLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInTimoLpList(address _address) public view returns (bool) {
        return _includeInTimoLpList[_address];
    }

    function setIncludeInTimoLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInTimoLpList[_address] = _isIncludedOrNot;
    }
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= MIN_TX_AMOUNT_HARD_CAP, "maxTxAmount have to be greater than 1 timo");
