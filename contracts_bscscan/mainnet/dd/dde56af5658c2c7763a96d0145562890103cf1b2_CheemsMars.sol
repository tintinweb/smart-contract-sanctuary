...
// CHANGE
contract CheemsMars is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CheemsMars";
    string constant _symbol = "CHEEMSMARS";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xeBABbB31a74742FE3286bD0d339Bc94de6069B2d);
