...
╚██████╔╝██║██║        ██║       ██║     ╚██████╔╝██║ ╚═╝ ██║╚██████╔╝
 ╚═════╝ ╚═╝╚═╝        ╚═╝       ╚═╝      ╚═════╝ ╚═╝     ╚═╝ ╚═════╝ 
    ...
    > Audit: StaySAFU.org/audits/giftfomo
    > KYC: StaySAFU.org/kyc/giftfomo
    
    Tg : https://t.me/giftfomo
    Website : https://giftfomo.com
*
*/
...
contract GIFTFOMO is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'GiftFOMO';
    string private constant _symbol = 'GFOMO';
    ...
    //DevWallets
    address public TeamWallet=payable(0x42bEf1eB8D51C906928a9B1820a878c0CfcbabDD);
    address public walletTwo=payable(0x42bEf1eB8D51C906928a9B1820a878c0CfcbabDD);
    //TestNet
