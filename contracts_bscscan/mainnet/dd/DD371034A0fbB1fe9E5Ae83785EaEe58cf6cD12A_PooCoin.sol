...
contract PooCoin is ERC20, Ownable {
    ...
    constructor() public ERC20("Pablo Coin", "PABLO") {
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("Pablo_Dividend_Tracker", "Pablo_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function withdrawDividend() public override {
        require(false, "Dividen_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
