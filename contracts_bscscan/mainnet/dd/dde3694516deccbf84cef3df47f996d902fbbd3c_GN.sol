...
contract GN is ERC20, Ownable {
    ...
    constructor() ERC20("GN", "GN") {
        ...
        maxWallet = totalSupply * 5 / 100; // 1% max wallet
        ...
        marketingWallet = address(0xeBF2a8B72Dfd5cDA1A14509542b6d4AC399E0883); // set as marketing wallet
        buyBackWallet = address(0x23435515252c00a9E059Bc4973b52f850571CC89); // set as buyback wallet
