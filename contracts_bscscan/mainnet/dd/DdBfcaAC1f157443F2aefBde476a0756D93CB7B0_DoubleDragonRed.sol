...
contract DoubleDragonRed is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "DoubleDragonRed";
    string constant _symbol = "DDRED";
    ...
    uint256 public buyBackUpperLimit = 10 ** 9 * (10 ** _decimals);
    ...
    uint256 sellReflectionFee = 800;
    uint256 sellMarketingFee = 600;
    uint256 buyReflectionFee = 100;
    uint256 buyMarketingFee = 1300;
