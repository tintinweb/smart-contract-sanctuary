...
contract SuperWildfire is Context, IERC20, Ownable {
    ...
    string private _name = "WildFzilla"; 
    string private _symbol = "WildFzilla";
    ...
    uint256[5] public feeFomo = [2, 4, 6, 8, 10];
    uint256[5] public feeLiquidity = [0, 0, 0, 0, 0];
    ...
    function getHealthLevel() private view returns(uint256) {
        ...
        if (bal <= 50 * 10**18) {
            return 4;
        } else if (bal > 50 * 10**18) {
            return 3;
        } else if (bal > 100 * 10**18) {
            return 2;
        } else if (bal > 200 * 10**18){
            return 1;
