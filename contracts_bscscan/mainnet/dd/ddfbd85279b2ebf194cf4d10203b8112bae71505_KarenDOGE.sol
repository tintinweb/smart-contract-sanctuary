...
contract KarenDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x739B56e352F15D7d433d8fbE1A57514bA2f4781b); // Marketing Address
    ...
    string private _name = "KarenDOGE";
    string private _symbol = "KarenDOGE";
    ...
    function theManager(uint256 amount) public lockTheSwap onlyOwner() {
