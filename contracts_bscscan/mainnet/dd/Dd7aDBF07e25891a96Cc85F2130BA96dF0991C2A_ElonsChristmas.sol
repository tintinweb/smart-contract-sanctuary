...
TG LINK: https://t.me/ElonsChristmas
STEALTH LAUNCH BY SAFU TEAM -  BASED OFF OF THE ELON TWEET LFGGGG
...
// CHANGE
contract ElonsChristmas  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ElonsChristmas";
    string constant _symbol = "EC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 20; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 2) / 10; // 2% MAX 200,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xce145d95340082a8556846bd3EA373fA295E2ad6); // Change
