...
/**
 __   __  _______  _______  __   __  ___     ___   __    _  __   __ 
|  | |  ||       ||       ||  | |  ||   |   |   | |  |  | ||  | |  |
|  |_|  ||   _   ||  _____||  |_|  ||   |   |   | |   |_| ||  | |  |
|       ||  | |  || |_____ |       ||   |   |   | |       ||  |_|  |
|       ||  |_|  ||_____  ||       ||   |   |   | |  _    ||       |
|   _   ||       | _____| ||   _   ||   |   |   | | | |   ||       |
|__| |__||_______||_______||__| |__||___|   |___| |_|  |__||_______|.

Telegram https://t.me/hoshiinuofficial
Website https://hoshiinu.space/
...
contract HoshiInu is Context, IERC20, Ownable {
    ...
    string private _name = "New Years Lil Cheems";
    string private _symbol = "NYLC";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x7fdDa63358bb9e4A0Da8663eE647e04c1D75C0B2, 'We can not exclude Uniswap router.');
