...
/**
    ...
    Mini Safemars is Huge communityy token build for safemars holders.
    
    There will be airdrop for Safemars holders
...
contract MiniSafemars is Context, IERC20, Ownable {
    ...
    string private _name = "Mini Safemars";
