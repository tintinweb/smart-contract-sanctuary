...
contract MetaFury is Context, IERC20, Ownable {
    ...
    address payable public liquidityAddress =
        payable(0x000007C9c612600d13FE70C1B686DBC753cc3d0D); // Liquidity Address
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 40 / 1000; // 1% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 40 / 1000; // 2% maxWalletToken
