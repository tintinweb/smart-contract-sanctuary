...
contract MINISHIBAFLOKI is Context, IERC20, Ownable {
    ...
    address payable public teamAddress =
        payable(0xd9B6d54F1998b842005964CFe1A1Bd5cd7b3314f); // Team Address
    ...
    string private constant _name = "MINI SHIBA FLOKI";
