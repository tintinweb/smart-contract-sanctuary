...
/**
  ...
  Telegram link https://t.me/SquidBonkDoge
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ALICE = IBEP20(0xAC51066d7bEC65Dc4589368da368b212745d63E8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ALICE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ALICE);
        ...
        uint256 amount = ALICE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ALICE.transfer(shareholder, amount);
...
contract SquidBonkDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MARKETING = 0x3fE12115Adc4fEe9E9B7B5323b6a3616A617ba29;

    string constant _name = "SquidBonkDoge";
    string constant _symbol = "SquidBonkDoge";
    ...
    function Collection(bool _status) public onlyOwner {
        martin = _status;
    }
    ...
    function Config(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
