...
contract RisingDragonChest is IChest, Ownable, ReentrancyGuard {
    ...
    uint256 public constant totalChestCtrHolderCanBuy = 10;
    uint256 public constant totalChestUserCanBuy = 5;
    ...
    function ctrHolderlistAddress(address[] memory users) public onlyOwner {
        for (uint i = 0; i < users.length; i++) {
