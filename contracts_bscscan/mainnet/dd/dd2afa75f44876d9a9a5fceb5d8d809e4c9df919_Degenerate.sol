...
/* Token contract */
contract Degenerate is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Degenerate";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // 0.5% or 500k tokens
    uint256 public _maxWalletToken = _totalSupply * 400 / 10000; // 4% or 5m tokens
