...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  IPancakeswapV2Router02 public pancakeswapV2Router = IPancakeswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
...
contract DragonBallInu is ERC20, Ownable {
    ...
    constructor() ERC20("DragonBall Inu", "DNI", 9) {
        ...
        operationsWallet = 0xE81b16037d4972593313dE1C77CD35946aCaEfCA;
        buyBackWallet = owner();
