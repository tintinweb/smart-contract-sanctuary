...
/**
 * @title LA2 ERC20 token
 *      
 */
contract LA2 is ERC20Detailed, Ownable {
    ...
    address payable _marketingAddress = 0x448f7985c514db5E637249e04594661E4d302E88;
    ...
    constructor ()
        ERC20Detailed("LA2", "LA2", uint8(DECIMALS))
        payable
        public
    {
