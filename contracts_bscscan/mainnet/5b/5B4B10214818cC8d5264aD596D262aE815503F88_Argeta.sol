...
/*contract DividendDistributor is IDividendDistributor {
    ...
    //uint256 public minPeriod = 6 hours; 
...
contract Argeta is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Argeta";
    string constant _symbol = "ARG";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 4200000000000000 * (10 ** _decimals);
