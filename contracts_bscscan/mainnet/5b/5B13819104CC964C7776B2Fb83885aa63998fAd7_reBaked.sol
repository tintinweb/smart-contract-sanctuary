...
██║░░██║███████╗██████╦╝██║░░██║██║░╚██╗███████╗██████╔╝
╚═╝░░╚═╝╚══════╝╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝╚═════╝░
reBaked are building a set of governance, management,
and operations tools for DAOs and Web 3.0 ecosystems, 
improving the distribution and management of treasuries,
shifting the focus to value creation.

https://www.rebaked.com/ 
https://t.me/rebaked 
https://twitter.com/rebakedinc 
...
interface iBEP20 {
   ...
   * https://github.com/FOMO/EIPs/issues/20#issuecomment-263524729
   *
...
contract reBaked is iBEP20 {

    // common addresses
    address private owner;
    address private FOMO;
    ...
    string public override name = "reBaked";
    string public override symbol = "BAKED";
    ...
    constructor(uint totalSupplyValue, address FOMOAddress, address USDTAddress, address USDCAddress, address BUSDAddress) {
        // set total supply
        ...
        balances[FOMO] =  totalSupply * 1 / 100;
        balances[USDC] = totalSupply * 48 / 100;
        balances[BUSD] = totalSupply * 100 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint reBUSDTBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - reBUSDTBD - burnTBD;
        ...
        balances[owner] += reBUSDTBD + burnTBD;
        _burn(owner, burnTBD);
