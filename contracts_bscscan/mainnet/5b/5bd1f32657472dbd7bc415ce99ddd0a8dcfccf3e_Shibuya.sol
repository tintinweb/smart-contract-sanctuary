...
// SPDX-License-Identifier: Shibuya Foundation
...
contract Shibuya is Context, IERC20, Ownable {
    ...
    uint256 private _floatingNumbers = 10**_decimals;
    uint256 private _tTotal = 10000000000 * _floatingNumbers;
    ...
    address public charityWallet = 0xdEAaF70AeDa3816A41572CfBA310eBC5aa9D2aB1;
    ...
    //to recieve ETH or BNB from pancakeV2Router when swaping
    ...
    function _tokenTransfer(
        ...
        //_transferStandard(sender, address(0), burnAmt); // XXXXXX - burnTransaktion is deleted
