...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x22b3C0e6654bFA6a87260a4178813788050c4600;
...
contract Paullie is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdd0390E942c890079e0937D25356a43db09a6b4F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Paul Token";
    string private _symbol = "PAUL";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 380;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //bsc mainet
