...
contract GoodVibes is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8FAA7A3bB994c8757F1a4FA89497A77dc71b9Da3);
    address payable public teamWalletAddress = payable(0x8FAA7A3bB994c8757F1a4FA89497A77dc71b9Da3);
    ...
    uint256 private _totalTaxIfBuying = 12 * 1**10;
    uint256 private _totalTaxIfSelling = 12 * 1**10;
