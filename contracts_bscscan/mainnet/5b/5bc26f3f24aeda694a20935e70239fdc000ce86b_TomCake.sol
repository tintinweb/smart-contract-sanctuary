...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @TomCake
   ...
   I will renounce the ownership to burn addresses to transfer #TomCake to the community, make sure it's 100% safe.

   I will add 4 BNB and all the left 10% total supply to the pool
   Can you make #TomCake 10000X? 
   ...
   it's the best part of the #LittleBurn idea, increasing the liquidity pool automatically, 
...
contract TomCake is Context, IERC20, Ownable {
    ...
    string private _name = 'TomCake';
    string private _symbol = 'TomCake';
