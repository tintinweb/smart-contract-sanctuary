...
contract knobbbby is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 1000 * 10**6;
  string private _symbol = "knobbbby";
  string private _name = "knobbbby";
