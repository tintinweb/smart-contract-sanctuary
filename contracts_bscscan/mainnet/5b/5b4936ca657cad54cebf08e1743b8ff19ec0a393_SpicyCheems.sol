...
Telegram https://t.me/SpicyCheems
...
/* Token contract */
contract SpicyCheems is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Spicy Cheems";
    string constant _symbol = "SpicyCheems";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 700 / 10000;  // 3% max or 2M
    uint256 public _maxWalletToken = _totalSupply * 700 / 10000; // 4% or 4M tokens
