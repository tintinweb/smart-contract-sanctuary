...
Welcome to MagicBeasties
   
   This is a community token. If you want to create a telegram I suggest to name it to @MagicBeastiesBSC
   ...
   I will renounce the ownership to burn addresses to transfer #MagicBeasties to the community, make sure it's 100% safe.
   I will add .5 BNB and all the left 10% total supply to the pool
   Can you make #MagicBeasties 10000X?
...
contract MagicBesties is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Magic Besties";
    string private constant _symbol   = "MBesties";
