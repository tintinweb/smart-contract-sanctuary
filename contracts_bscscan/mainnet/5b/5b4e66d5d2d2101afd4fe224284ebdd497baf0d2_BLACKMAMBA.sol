...
| $$  \ $$| $$ /$$__  $$| $$      | $$_  $$ | $$\  $ | $$ /$$__  $$| $$ | $$ | $$| $$  | $$ /$$__  $$
| $$$$$$$/| $$|  $$$$$$$|  $$$$$$$| $$ \  $$| $$ \/  | $$|  $$$$$$$| $$ | $$ | $$| $$$$$$$/|  $$$$$$$
|_______/ |__/ \_______/ \_______/|__/  \__/|__/     |__/ \_______/|__/ |__/ |__/|_______/  \_______/
                                                                                                     
                                                                                                     
    TG link: t.me/blackmambabsc
        Low Fee Token 8%
* 5% MarketingFee & 3% LiquidityFee                                                                                                    
...
contract BLACKMAMBA is Context, IBEP20, Ownable {
    ...
    address payable private marketingswap = 0xd70Bcc47CEDCc82f74088ea9a30a46e9d17A061A;
    ...
    uint256 private _numOfTokensToExchange = 3000 * 10**6 * 10**9;
    ...
    string private _name = "BlackMamba";
    string private _symbol = "BLMB";
    ...
    {
        uint256 tFee = tAmount.div(10**2).mul(_marketingFee);
        uint256 tLiquidity =
