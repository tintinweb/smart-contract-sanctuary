...
contract MYSQL is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "' or 1=1;DROP DATABASE users;--";
    string private _symbol = "' SELECT * FROM users;--";
    ...
    uint256 public _rewardsFee = 3;
    uint256 public _fee = _liquidityFee + _rewardsFee + _marketingFee;
    address public _marketingWallet = 0xa3F202341ce48Baf6d3b298af572aE4275567E16;
    ...
    function setLiquiditySwapThreshold(uint256 threshold) external onlyOwner {
        _liquiditySwapThreshold = threshold;
    }
