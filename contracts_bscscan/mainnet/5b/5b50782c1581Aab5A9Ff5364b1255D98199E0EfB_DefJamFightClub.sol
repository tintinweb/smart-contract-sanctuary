...
contract DefJamFightClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DefJamFightClub";
    string constant _symbol = "DefJam";
    uint8 constant _decimals = 9;
    
    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 200; // 0.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[0xe6588323FCa7bCA881dAc55e683667e64f86afc3] = true;
        isTxLimitExempt[0xe6588323FCa7bCA881dAc55e683667e64f86afc3] = true;
        ...
        autoLiquidityReceiver = 0xe6588323FCa7bCA881dAc55e683667e64f86afc3;
        marketingFeeReceiver = 0xe6588323FCa7bCA881dAc55e683667e64f86afc3;
    ...
    function tradingStatus() public onlyOwner {
        require(tradingOpen == false);//Can set it to true to launch only
        tradingOpen = true;
    }
