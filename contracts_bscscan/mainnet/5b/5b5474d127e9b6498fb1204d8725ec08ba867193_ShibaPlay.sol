...
/**
 🌐 Shiba Play (ShibPlay) is a charity token aimed at protecting victims of child abuse.
 The project states, that its features include a locked liquidity,
 ruff rewards - free tokens for holders every time a transaction is carried out, as well as a "Zero Whale" feature - 
 the project ensures, that their token gets evenly distributed.
...
contract ShibaPlay is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x064E4F98A61A9fB8f8F73AD6236669fb239ea293; 
    ...
    string private _name = "ShibaPlay";
    string private _symbol = "SHIBLAY";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50000000 * 10**8 * 10**18;
