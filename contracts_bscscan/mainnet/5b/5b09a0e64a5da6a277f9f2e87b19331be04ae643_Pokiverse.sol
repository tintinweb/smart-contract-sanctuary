...
library Address{
 ...
 contract Pokiverse is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xFEecFc9725f213274dE5aB6e495FF1706aFa53BD;
    address public donationWallet = 0xFEecFc9725f213274dE5aB6e495FF1706aFa53BD;

    string private constant _name = "Pokiverse V2";
    ...
    Taxes public taxes = Taxes(1, 2, 3, 4);
    Taxes public sellTaxes = Taxes(5, 6, 7, 8);
