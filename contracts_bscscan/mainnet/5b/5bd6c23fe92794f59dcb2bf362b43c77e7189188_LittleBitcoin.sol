...
/**
   ...
   Welcome to LittleBitcoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBitcoinBSC
...
contract LittleBitcoin is Context, IERC20, Ownable {
    ...
    string private _name = "Little Bitcoin";
    string private _symbol = "LTBTC";
