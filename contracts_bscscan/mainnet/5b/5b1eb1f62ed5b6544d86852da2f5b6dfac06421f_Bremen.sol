...
contract Bremen is Context, IERC20, Ownable {
    ...
    string private constant _name = "BINANCE MAGIC";
    string private constant _symbol = "BNBMAGIC";
    ...
    uint private constant _tTotal = 20000000000 * 10**9;
    ...
    address payable private _marketingAddress = payable(0xb89707E8c6299d5a2912704618a742a308d1FA7A);
