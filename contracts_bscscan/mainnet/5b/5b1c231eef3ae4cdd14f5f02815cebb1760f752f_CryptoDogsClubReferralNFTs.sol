...
contract CryptoDogsClubReferralNFTs is IERC721 {
    ...
    string internal nftName = "Crypto Dogs Club Referral NFTs";
    string internal nftSymbol = "DOGNFTs";
    ...
    function mintForReferral(uint256 numberOfNfts) external payable reentrancyGuard {
    ...
    modifier onlyTokenOwner(uint256 _tokenId) {
        require(_tokenId < 1000, "doggy number is wrong");
    ...
    function buyDoggy(uint256 doggyIndex) public payable reentrancyGuard {
        require(marketPaused == false, "Market Paused");
        require(doggyIndex < 1000, "doggy number is wrong");
