...
contract CardanoZilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CardanoZilla";
    string constant _symbol = "CardanoZilla";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**15 * (10 ** _decimals);
