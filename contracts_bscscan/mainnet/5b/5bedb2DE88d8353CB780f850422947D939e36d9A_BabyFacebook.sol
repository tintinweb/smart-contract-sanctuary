...
// Telegram Group : @BabyFacebookChat
...
contract BabyFacebook is  Context, IERC20, Ownable {
    ...
    uint256 private _tBabyFacebookTotal;

    string private _name = "BabyFacebook";
    string private _symbol = "BabyFacebook";
    ...
    uint256 public _BabyFacebookFee = 8;
    uint256 private _previousBabyFacebookFee = _BabyFacebookFee;
    
    uint256 public _maxTxAmount = 250 * 10**9 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 4 * 10**9 * 10**9; 
    
    address payable public BabyFacebookAddress = 0xB3c57134149332cc51186B2226AE3248D04f08c0;
   ...
   function deliver(uint256 tAmount) public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tBabyFacebookTotal = _tBabyFacebookTotal.add(address(this).balance);
        TransferCharityETH(BabyFacebookAddress, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_BabyFacebookFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _BabyFacebookFee == 0 && _liquidityFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousBabyFacebookFee = _BabyFacebookFee;
    ...
    function restoreAllFee() private {
        ...
        _BabyFacebookFee = _previousBabyFacebookFee;
    ...
    function setBabyFacebookFeePercent(uint256 BabyFacebookFee) external onlyOwner() {
        _BabyFacebookFee = BabyFacebookFee;
    }
