...
/**
    Name =  Real Capital Blockchain
    Symbol = RCB
    Total Supply = 800,000,000
    Decimal = 18
    0% of each transaction to the liquidity pool
    4% of each transaction to the dev wallet(in BNB)
    0% of each transaction to holders
*/
...
contract RCB is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 800000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "Real Capital Blockchain";
    string private _symbol   = "RCB";
    uint8 private  _decimals = 18;
    
    uint256 public _taxFee       = 0; 
    uint256 public _liquidityFee = 4; 
    uint256 public _percentageOfLiquidityForDev = 100; 
    
    uint256 public  _maxTxAmount     = 800000000 * 10**18;
