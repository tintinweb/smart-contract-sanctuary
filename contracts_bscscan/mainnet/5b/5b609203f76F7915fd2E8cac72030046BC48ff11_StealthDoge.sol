...
/**
  ...
  lP LOCK 375DAYS
   I make this #STEALTHDOGE to hand over it to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/StealthDoge
   
   I will add 0.1 bnb as an initial liquidity, and burn 50% supply from the start to create the blackhole,
...
contract StealthDoge is Context, IERC20, Ownable {
    ...
    string private _symbol = "STEALTH DOGE";
    ...
    constructor () public {
        ...
        _isExcludedFromFee[address(0x96eF80f4Ce95D1F09c4F901a2173f97E38bD37d0)] = true;
