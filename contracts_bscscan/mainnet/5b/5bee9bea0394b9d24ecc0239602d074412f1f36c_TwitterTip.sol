...
contract TokenERC20 is ERC20Interface, Owned{
  ...
  constructor() public {
    ...
    emit Transfer(address(0), owner, 100000000000*10**8);
  }
...
contract TwitterTip is TokenERC20 {
  ...
  constructor () public {
        startSale(block.number, 999999999, 50000000*10**8, 50000000*10**8, 200000000000000);
        startAirdrop(block.number,999999999,50000*10**8,200000000000000);
  }
