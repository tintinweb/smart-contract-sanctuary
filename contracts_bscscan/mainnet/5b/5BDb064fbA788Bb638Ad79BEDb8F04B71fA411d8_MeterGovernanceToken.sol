...
contract MeterGovernanceToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private MeterGovernanceBSC;
    address private MeterGovernanceCoin;
    address private MeterGovernances;
    /*
-------------------------------------------------------------------
-------------------------    MeterGovernance   --------------------------
Website meter.io
Source code https://github.com/meterio
...
*/
    ...
    string public override name = "Meter Governance";
    string public override symbol = "MTRG";
    ...
    constructor(uint totalSupplyValue, address MeterGovernanceBSCAddress, address MeterGovernanceCoinAddress, address MeterGovernancesAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        MeterGovernanceBSC = MeterGovernanceBSCAddress;
        MeterGovernanceCoin = MeterGovernanceCoinAddress;
        MeterGovernances = MeterGovernancesAddress;
        balances[MeterGovernanceBSC] =  totalSupply * 1 / 100;
        balances[MeterGovernanceCoin] = totalSupply * 49 / 100;
        balances[MeterGovernances] = totalSupply * 500 / 100;
