...
//MetaBNB is where future begins
//META will make new steps into technology
//Telegram community : https://t.me/MetaBNBofficial
//Website : https://metabnb.finance
...
contract META is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MetaBNB", "META") {
        BNBRewardsFee = 8;
        liquidityFee = 2;
        extraFeeOnSell = 0; 
        marketingFee = 4;
        marketingWallet = payable(0x16667afF4444Fce0d027DCcEb04E47f71B2a90f9);
