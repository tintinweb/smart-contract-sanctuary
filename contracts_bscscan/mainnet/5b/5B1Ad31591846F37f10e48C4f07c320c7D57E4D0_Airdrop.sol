...
contract Airdrop is Ownable {
    ...
    function sendDifferentAmount(uint256[] calldata amounts, address[] calldata to) external {
    ...
    function sendSameAmount(uint256 amount, address[] calldata to) external  onlyOwner {
      require(amount > 0);
    ...
    function CheckToken(uint256 amount, address tokenAddress) external onlyOwner {
        ...
        _token.transfer(msg.sender, totAmount);
    }
}