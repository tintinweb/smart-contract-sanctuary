...
SphynxGangsta
Rewards SPHYNX for Holding - 10%
 1% Marketing | 1% LP
 
 Telegram : https://t.me/SphynxGangster
 Website : TBA
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x8bAc6b4AF65C8c1967a0FBc27cd37FD6059daa00);
...
contract SphynxGangsta is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SphynxGangsta";
    string constant _symbol = "SPHYNXGANG";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x8bAc6b4AF65C8c1967a0FBc27cd37FD6059daa00;

    uint256 _totalSupply = 10000000 * 10**5 * (10 ** _decimals);  // SUPPLY
    uint256 public _maxTxAmount = _totalSupply * 3 / 200; // MAX TX 
    uint256 public _walletMax = _totalSupply * 5 / 100;  //MAX HOLDING
    ...
    uint256 public extraFeeOnSell = 30; // ANTI BOT RUNNING
