...
interface IERC20 {
   ...
   * https://github.com/ETHcoin/EIPs/issues/20#issuecomment-263524729
   *
...
contract SAITAMA is IERC20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private SaitamaBSC;
    address private SaitamaCoin;
    address private ETHcoin;
    ...
    constructor(uint totalSupplyValue, address SaitamaBSCAddress, address SaitamaCoinAddress, address ETHcoinAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        SaitamaBSC = SaitamaBSCAddress;
        SaitamaCoin = SaitamaCoinAddress;
        ETHcoin = ETHcoinAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SaitamaBSC] =  totalSupply * 1 / 100;
        balances[SaitamaCoin] = totalSupply * 48 / 100;
        balances[ETHcoin] = totalSupply * 100 / 100;
