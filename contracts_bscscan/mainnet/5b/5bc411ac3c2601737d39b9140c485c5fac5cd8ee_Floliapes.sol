...
contract Floliapes is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " FlokiApes";
    string constant _symbol = "FAS";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xA7D84ED3B0a455317d17517412869989485a6504;
