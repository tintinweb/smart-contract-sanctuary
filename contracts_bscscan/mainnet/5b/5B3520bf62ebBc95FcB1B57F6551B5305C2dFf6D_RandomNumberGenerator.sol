...
// File: contracts/interfaces/ISpectraDexLottery.sol

pragma solidity ^0.8.4;

interface ISpectraDexLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in SPC per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in SPC token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInSpc: price of a ticket in SPC
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public spectraDexLottery;
     ...
     * @param _seed: seed provided by the SpectraDex lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == spectraDexLottery, "Only spectraDexLottery");
    ...
    /**
     * @notice Set the address for the spectraDexLottery
     * @param _spectraDexLottery: address of the SpectraDex lottery
     */
    function setLotteryAddress(address _spectraDexLottery) external onlyOwner {
        spectraDexLottery = _spectraDexLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ISpectraDexLottery(spectraDexLottery).viewCurrentLotteryId();
    }
}