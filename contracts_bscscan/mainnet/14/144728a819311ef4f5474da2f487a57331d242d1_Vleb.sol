...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6F18d081104bD00411C2405211Dc2ceC01dc0009;
...
contract Vleb is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4Db2fBBf680368764c1064B8Df13C7787110cd3c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Vleb Coin";
    string private _symbol = "VLEB";
