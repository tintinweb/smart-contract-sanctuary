...
contract BabySafeMoon is Context, Ownable, IERC20 {
    ...
    address payable public marketingWallet = payable(0x341141C863E849B926903dC6d24adceB540a1B1B);
    address payable public devWallet = payable(0x53EE4Deb0780426bA69511e0d3f002A0623d00C3);
    address payable public giveawaysWallet = payable(0x563e66304254A1F77EC37db422d2BB4a460e93c5);
    address payable public iBNBPool = payable(0xD1A3d10D9f129b8F987d185A0FEB6C8111FbdB35);
