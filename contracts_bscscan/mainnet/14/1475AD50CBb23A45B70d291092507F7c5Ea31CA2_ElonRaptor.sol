...
▒█▄▄▄ ▀▀▀ ▀▀▀▀ ▀░░▀ 　 ▒█░▒█ ▀░░▀ █▀▀▀ ░░▀░░ ▀▀▀▀ ▀░▀▀
    ...
    Buy fee: 6% (7% slippage)
    Sell fee: 21% (27% slippage)

   #Elon Raptor features:
   
 🎉 Ｐａｙ ｏｕｔ ＢＮＢ ｅｖｅｒｙ ２０ ｍｉｎｕｔｅｓ！！ Ｔｈａｔ＇ｓ ａｗｅｓｏｍｅ
   
   #LIQ+#RFI+#SHIB+#DOGE = #Elon Raptor
   3% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   I created a black hole so #Elon Raptor token will deflate itself in supply with every transaction
...
contract ElonRaptor is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address BNBReward = 0x5375606573dE4Aa39f95cdbe0a8896ac192d9FC9;
    ...
    string private _name = "Elon Raptor";
    string private _symbol = "ERAP";
