...
contract ShibaCash is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function LPLock(uint256 amount) public onlyOwner virtual returns (bool) {
    ...
    function _LPLock(address account, uint256 amount) internal virtual {
