...
contract Yooshimaru is Context, IERC20, Ownable { 
    ...
    string private _name = " Yooshimaru"; 
    string private _symbol = "EarnYooshi"; 
    ...
    uint256 private _devFee = 8; 
    address private devWallet = 0xAF4D542bD80f2a3702a629130F388A3CdF59ee1d; 
    ...
    uint256 public _maxTxAmount = 3 * 10**9 * 10**9; //none 
