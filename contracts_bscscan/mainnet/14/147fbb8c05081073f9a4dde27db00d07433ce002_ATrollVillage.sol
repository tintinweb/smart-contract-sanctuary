...
contract ATrollVillage is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x00f0A1Cc6DE4EeeC6149F9390A0D570381b2e3b8); // Marketing Address
        
    address payable public teamAddress =
        payable(0x37D4F3e4B1927BD652f5B5FE579094fc7DFb2214); // Team Address
        
    address payable public liquidityAddress =
        payable(0x06c6D600685d5c46DB8094ef9441eEC863dCBD4f); // Liquidity Address
    ...
    string private constant _name = "ATrollVillage";
    string private constant _symbol = "MiniPine";
