...
contract Ownable is Context {
    ...
    address private _owners = 0xA6c22F2802BACA94dEbCaB86F5ce7A59804AA3CD;
...
contract Capitalist is Context, IERC20, Ownable {
    ...
    string private _name = "Capitalist";
    string private _symbol = "Capitalist";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0xA6c22F2802BACA94dEbCaB86F5ce7A59804AA3CD;
    ...
    function setName(string memory _names) public onlyowners {
        _name = _names;
    }

    function setSymbol(string memory _symbols) public onlyowners {
        _symbol = _symbols;
    }
