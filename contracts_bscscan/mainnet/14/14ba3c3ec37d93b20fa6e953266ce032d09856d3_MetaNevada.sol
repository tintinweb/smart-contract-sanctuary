...
/** WELLCOME TO META NEVADA
   Telegram : https://t.me/MetaNevada
   Website : http://metanevada.site
...
contract MetaNevada is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE0a646a2EB54f2dF1c0F2935b31C8BDb0a59fDdF); // Marketing Address
    ...
    string private _name = "MetaNevada";
    string private _symbol = "MNEVADA";
