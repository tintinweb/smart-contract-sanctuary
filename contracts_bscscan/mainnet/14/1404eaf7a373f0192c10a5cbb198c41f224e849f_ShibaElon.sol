...
contract ShibaElon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaElon";
    string constant _symbol = "ShibaElon";
	...
	function ShibaElonSniperBan(address user, bool banned) external authorized {
		if (banned) {
    ...
    function ShibaElonsetSwapBackSettings(bool _enabled, uint256 _amount) external authorized {
