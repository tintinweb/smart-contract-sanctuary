...
/**
Doctor Binance is here to save your day!

Holders get rewarded with 5% BNB reflection. 

5% is our best choice because it keeps the transaction fees low and you still get rewarded with BNB.

Doctor Binance has anti-bot and anti-dump protection.

Telegram @DoctorBinance
...
contract DOCTORBINANCE is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "DOCTOR BINANCE";
    string private _symbol = "DRBINANCE";
    ...
    uint256 public _maxSellTransactionAmount = 150 * 10**9; // can't sell more than this
    uint256 public _maxWalletToken = 2500 * 10**9; // can't buy or accumulate more than this
