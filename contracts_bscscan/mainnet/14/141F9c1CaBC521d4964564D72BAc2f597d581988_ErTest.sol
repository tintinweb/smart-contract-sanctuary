...
contract ErTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    address payable public marketingAddress = payable(0x63c1C36FED8d3CFD2502aE5BCa9e7ec3DF27e949); // Marketing Address
    ...
    string private _name = "ErTest";
    string private _symbol = "ERT";
