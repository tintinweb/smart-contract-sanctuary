...
contract FootstepsoftheGoddess is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Footsteps of the Goddess';
    string  private constant _SYMBOL = 'GODDDESS';
