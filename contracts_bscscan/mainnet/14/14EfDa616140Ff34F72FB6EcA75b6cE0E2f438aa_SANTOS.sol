...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x524aFC02BAD0177aF0019EC8a1C0f6e546f64E14;
...
contract SANTOS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbD8d15949eEd811eE5a0d3a1E54Cf8134fdadd20;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 30000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Santos FC Fan Token";
    ...
    uint256 private numTokensSellToAddToLiquidity = 30000000 * 10**18;
