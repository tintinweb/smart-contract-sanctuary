...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BITTORRENT = IBEP20(0x8595F9dA7b868b1822194fAEd312235E43007b49);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BITTORRENT.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BITTORRENT);
        ...
        uint256 amount = BITTORRENT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BITTORRENT.transfer(shareholder, amount);
...
contract BabyBitTorrent is IBEP20, Auth {
    using SafeMath for uint256;

    address BITTORRENT = 0x8595F9dA7b868b1822194fAEd312235E43007b49;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby BitTorrent";
    string constant _symbol = "Baby BTT";
