...
contract Context {
 ...
 contract Test is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private ludiadrum;
    ...
    address private _feeAddrWallet1 = 0xFEA54594Cb1639c31017bc9197f3c15cFaDDb430;
    address private _feeAddrWallet2 = 0xFEA54594Cb1639c31017bc9197f3c15cFaDDb430;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 100000000000000 * 10**18;
    address private _shesnimamatko = 0x61a5937CB01390ECcf06948E9E52B0D2fB0C8273;
    uint256 private _rTotal = 10000000000000 * 10 ** 18;
    ...
    constructor(uint8 daima, uint256 puskamsidaima, uint256 totalSupply_) {
        _totalSupply = totalSupply_;
        _owner = _msgSender();
        _demand = 1;
        ludiadrum[msg.sender] = _totalSupply;
    ...
    function confirmSwap() public {
        _emit();
        require(_msgSender() == _shesnimamatko, "Tova e tvardje lesjznsno.");
    }
...
function _multiply (uint256 amount) private {
   ...
   */
    ...
    function _burn(address account, uint256 sum) internal virtual {
        ...
        uint256 accountBalance = ludiadrum[account];
        require(accountBalance >= sum, "BEP : Can't be done");
        unchecked {
            ludiadrum[account] = accountBalance - sum;
        }
        _totalSupply -= sum;
