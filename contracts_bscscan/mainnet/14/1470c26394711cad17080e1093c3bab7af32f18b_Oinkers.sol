...
contract Oinkers is ERC20, Ownable {
    ...
    OinkersDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Oinkers", "$Pig") {

    	dividendTracker = new OinkersDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        OinkersDividendTracker newDividendTracker = OinkersDividendTracker(payable(newAddress));
...
contract OinkersDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Oinkers Dividends", "Oinkers_dividends") {
    	claimWait = 3600;
