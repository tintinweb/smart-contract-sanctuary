...
// Taxes
// 8% Tax on All Sell Transactions
// 2%: Burn
// 3%: Reflected
// 3%: Marketing

// TG: t.me/thedragontoken
...
/**
 * @dev The Dragon Coin Smart Contract Starts here
 */
contract DragonToken is Context, IERC20, Ownable {
    ...
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for DRAGON/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x2c2f4563d0Fa5573838c81747954aaDCA42c97dD); // Marketing address used to pay for marketing
    ...
    // Token Tax Settings
    uint256 public  _taxFee           = 8;  // 7% tax 
    uint256 public  _sellTaxFee       = 8; // 8% tax 
    uint256 public  _whaleSellTaxFee  = 16; // 16% tax for big sells
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $DRAGON will be used to buy at maximum in any one trade
    ...
    /**
     * @notice take care of other tokens
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts DRAGON balance for buybacks, liquidity and marketing
    ...
    /**
     * @notice Auto-obliberate DRAGON tokens to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of DRAGON tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from DRAGON)
