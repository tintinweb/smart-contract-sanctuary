...
contract BABYSTRIKE is ERC20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private Strike;
    address private LAUNCH;
    address private StrikeX;
    ...
    string public override name = "Baby StrikeX";
    string public override symbol = "BABYSTRX";
    ...
    constructor(uint totalSupplyValue, address StrikeAddress, address LAUNCHAddress, address StrikeXAddress) {
        // set total supply
        ...
        StrikeX = StrikeXAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Strike] =  totalSupply * 1 / 100;
        balances[LAUNCH] = totalSupply * 47 / 100;
        balances[StrikeX] = totalSupply * 200 / 100;
