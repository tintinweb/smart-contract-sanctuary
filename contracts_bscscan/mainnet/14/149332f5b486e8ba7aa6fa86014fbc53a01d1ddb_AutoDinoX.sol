...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DinoX = IBEP20(0x3c1748D647E6A56B37B66fcD2B5626D0461D3aA0);
    ...
    function deposit() external payable override {
        uint256 balanceBefore = DinoX.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(DinoX);
        ...
        uint256 amount = DinoX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DinoX.transfer(shareholder, amount);
    ...
    event Deposit(uint256 amountBNB, uint256 amountDinoX);
...
contract AutoDinoX is IBEP20, Auth {
    using SafeMath for uint256;

    address DinoX = 0x3c1748D647E6A56B37B66fcD2B5626D0461D3aA0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AutoDinox";
    ...
    function setFees(
        ...
        require(totalFee.add(liquidityFee) < feeDenominator/3);
