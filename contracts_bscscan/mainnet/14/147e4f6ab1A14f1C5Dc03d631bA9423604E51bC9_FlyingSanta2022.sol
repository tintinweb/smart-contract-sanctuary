...
Telegram: https://t.me/FlyingSanta2022
...
contract FlyingSanta2022 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2022000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxBuyAmount = _tTotal.mul(2).div(10);
    uint256 public maxSellAmount = _tTotal.mul(1).div(10);
    uint256 public swapTokensAtAmount = 20220 * 10**_decimals;
    uint256 public _maxWalletSize = 20220 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0xf7a74Dc47A2FfC6f20A3eCF5Eef35FF909B3A578;
    address public operationsAddress = 0xf7a74Dc47A2FfC6f20A3eCF5Eef35FF909B3A578;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "FlyingSanta2022";
    string private constant _symbol = "FS2022";
