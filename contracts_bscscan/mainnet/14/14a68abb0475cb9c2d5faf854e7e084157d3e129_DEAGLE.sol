...
/**
   Dark Eagle Token
   " Fly with us "
   Community driven token that is helping saving Eagles on Earth.

   🦅 DARK EAGLE features:
   
   5% fee auto distrubuted Tokens to all holders.
   5% fee auto distrubuted as BNB to all holders.
   1% goes to liquidity pool.

   🦅 Telegram: https://t.me/darkeaglebsc
   🦅 Website: www.darkeagle.me
*/
...
contract DEAGLE is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "DARK 🦅 EAGLE";
  string private _name = "Dark Eagle";
