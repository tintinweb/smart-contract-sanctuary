...
/**
   ...
   Welcome to KingEVERRise
   
   This is a community token. If you want to create a telegram I suggest to name it to @KingEVERRiseGBSC
   ...
   I will renounce the ownership to burn addresses to transfer #KingEVERRise to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #KingEVERRise 10000X? 
   ...
   it's the best part of the #KingEVERRise idea, increasing the liquidity pool automatically, 
...
contract KingEVERRise is Context, IERC20, Ownable {
    ...
    string private _name = "KingEVERRise";
    string private _symbol = "KingEVERRise";
