...
/**
 * 
From the creators of Saiyan Inu, a fully doxxed team.

Instinct token is a BNB dividend token allowing the holder to choose ANY token on the smart chain to receive dividends in.

A fully operational Dashboard with a backend dividends changer already done.

A full techrate audit has already been completed.

NFT Marketplace being launched shortly after launch.

Predevelopment stages already completed for the game we are developing.

We are building an NFT trading card game with a Play to Earn dynamic. Rich lore, full maps of the realm already drawn and many factions to choose from. We are changing what it means to build an NFT blockchain game. 
*/
