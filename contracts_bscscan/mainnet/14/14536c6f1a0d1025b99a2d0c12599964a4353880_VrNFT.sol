...
contract VrNFT is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'VrNFT';
    string  private _SYMBOL = 'VRNFT';
    ...
    uint256 private _MAX_TX_SIZE = 2000000000000 * _DECIMALFACTOR;
