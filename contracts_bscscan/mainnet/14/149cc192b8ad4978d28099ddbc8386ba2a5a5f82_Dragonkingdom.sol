...
// File: contracts\Dragonkingdom.sol

contract Dragonkingdom
is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "Dragonkingdom";
	string private constant _symbol = "DKD";
	...
	// BUYBACK
	address payable private constant _buybackAddress = payable(0xbd2a9eEC6F74e85c78616ed275DEF1cD24F847Dc); // A percentage of the BNB pool will go to the charity address
	...
	// TEAM & airdrop
	address payable private constant _teamAddress = payable(0xbd2a9eEC6F74e85c78616ed275DEF1cD24F847Dc);
	...
	constructor (address routerAddress) {
		...
		uint256 _tokenForLiquidity = _totalTokens * 94 / 100;
		...
		uint256 _tokenForBurn = _totalTokens * 1 / 100;
