...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TDOGE = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TDOGE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(TDOGE);
        ...
        uint256 amount = TDOGE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TDOGE.transfer(shareholder, amount);
...
contract ThiefDoge is IBEP20, Auth {
    using SafeMath for uint256;

    address TDOGE = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
 
    string constant _name = "ThiefDoge";
    string constant _symbol = "ThiefDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2100 * 10**12 * 10**_decimals;
    ...
    address public marketingFeeReceiver = 0xBdB1676eDE3Bd3d953B9E3c8566B3af20e5725ab;
