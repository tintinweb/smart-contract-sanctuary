...
// CHANGE
contract AppleCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "AppleCake";
    string constant _symbol = "$AppleCake";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000 * (10 ** _decimals); // 100,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 100% MAX 100,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 100% MAX 100,000,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x7f810a810C15429A469eA62053a9E96eB59fb842);
