...
contract XWGNFT is ERC721Pausable, Ownable {
    ...
    constructor() public ERC721("TelrgramGameNFT", "TNFT") {
        _maxTotalSupply = 1000000;
    }
    ...
    function setMaxTotalSupply(uint256 maxTotalSupply) external onlyOwner virtual {
    ...
    function mint(address player) external onlyMinter returns (uint256) {
        require(totalSupply() < _maxTotalSupply, "XWGNFT: total supply is error");
