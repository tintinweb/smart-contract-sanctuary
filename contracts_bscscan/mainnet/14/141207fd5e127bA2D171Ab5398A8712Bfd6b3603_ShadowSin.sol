...
contract ShadowSin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2496C5E5a201Ab4e26395FE15B0865D35D635266); // Marketing Address
    ...
    string private _name = "ShadowSin";
    string private _symbol = "SHD";
