...
//
// Telegram: https://t.me/SonOfTether
//
...
contract SonOfTether is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x886e924B4eBA1C3214c9422F6c446bEA6645416b); // Marketing Address
        
    address payable public teamAddress =
        payable(0x886e924B4eBA1C3214c9422F6c446bEA6645416b); // Team Address
        
    address payable public liquidityAddress =
        payable(0x886e924B4eBA1C3214c9422F6c446bEA6645416b); // Liquidity Address
    ...
    string private constant _name = "SonOfTether";
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02( //official 0x10ED43C718714eb63d5aA57B78B54704E256024E testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
