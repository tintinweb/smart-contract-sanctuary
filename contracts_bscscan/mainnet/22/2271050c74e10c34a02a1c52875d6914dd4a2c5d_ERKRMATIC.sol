...
contract ERKRMATIC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ERKRMATIC";
    string constant _symbol = "BERKRMATIC";
    ...
    uint256 public swapThreshold = _totalSupply / 200000; // 5%
    bool inSwap;
