 ...
 * CAKELOVERS IS A CAKE GENERATOR TOKEN
 * 0.3 BNB INITIAL LIQUIDITY LOCKED
 * https://t.me/CAKELOVERSTOKEN
 * 
 */
library SafeMath {
...
contract CAKELOVERS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CAKELOVERS";
    string constant _symbol = "CAKELOVERS";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x6812F298DfBa65016b247fB9FC68fD4ECbFbEC55; //WALLET DEV
