...
contract BlueShibatest is Context, IERC20, Ownable {
    ...
    string private constant _name = "BlueShibatest";
    string private constant _symbol = unicode"BLUESHIBAtest";
