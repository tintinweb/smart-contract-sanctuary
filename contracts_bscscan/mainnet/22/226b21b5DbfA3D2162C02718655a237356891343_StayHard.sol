...
/**
            StayHard Community Token 


Telegram link:  https://t.me/StayHardCommunity

Join the community!

✅ Owner renounced
✅ 5% AUTO BURN of tokens
✅ 15% liquidityFee  =>  transferred to a marketing wallet for upcoming marketing!
✅ 90% tokens burned 
✅ 3% sell taxes => Sellers will add to supply of current token holders
✅ 12 Reddit Posts + CMS POST directly after launch! ===> Check the Telegram group for more info.
✅ A+++ Dev Team 
✅ UNIQUE FEATURES
...
contract StayHard is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'StayHardToken';
    string  private constant _SYMBOL = 'StayHard';

  
    uint8   private constant _DECIMALS = 18;
   
    uint256 private constant _MAX = ~uint256(300000000);
    uint256 private constant _DECIMALFACTOR = 10 ** uint256(_DECIMALS);
    uint256 private constant _GRANULARITY = 100;
    
    uint256 private _tTotal = 100000000000000 * _DECIMALFACTOR;
    ...
    uint256 private _BURN_FEE = 5;
    uint256 private _TAX_FEE = 300;
    ...
    function _setBurnFee(uint256 burnFee) private {
        require(burnFee >= 0 && burnFee <= 10000, 'burnFee should be in 0 - 100');
        _BURN_FEE = burnFee;
    }
    ...
    function setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <= 10000, 'taxFee should be in 0 - 100');
        _TAX_FEE = taxFee;
    }
