...
*/
/**
 ______            _______  _        _        _______   _________ _                
(  ___ \ |\     /|(  ___  )| \    /\| \    /\(  ___  )  \__   __/( (    /||\     /|
| (   ) )( \   / )| (   ) ||  \  / /|  \  / /| (   ) |     ) (   |  \  ( || )   ( |
| (__/ /  \ (_) / | (___) ||  (_/ / |  (_/ / | |   | |     | |   |   \ | || |   | |
|  __ (    \   /  |  ___  ||   _ (  |   _ (  | |   | |     | |   | (\ \) || |   | |
| (  \ \    ) (   | (   ) ||  ( \ \ |  ( \ \ | |   | |     | |   | | \   || |   | |
| )___) )   | |   | )   ( ||  /  \ \|  /  \ \| (___) |  ___) (___| )  \  || (___) |
|/ \___/    \_/   |/     \||_/    \/|_/    \/(_______)  \_______/|/    )_)(_______)
                                                                                   

The cutest white tiger on Binance Smart Chain network! RAWR

Goals: 
We are aiming for the next billion market cap moonshot with a steady growth and rewarding our holders. Byakko Inu will make his dad proud.

Committed & based team: 
Our team comprises of a few experienced devs who have launched many successful projects in the past, and we will be working 24/7 with shift rotations to make sure this goes to the moon.

Marketing: 
Marketing will kick in as soon as we go live, with callers and twitter influencers to keep the chart looking healthy. Contests such as biggest buy and meme competitions will happen as well. 

100% stealth and fair launch, with absolutely 0 team tokens, and 2 BNB initial liquidity.
...
contract ByakkoInu is Context, IERC20, Ownable {
    ...
    string private _name = "Byakko Inu";
    string private _symbol = "ByakkoInu";
    ...
    uint256 private minimumTokensBeforeSwap = 818274 * 10**6 * 10**9; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tMarketingTotal = _tMarketingTotal.add(address(this).balance);
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private MarketingAddress = 0xA68703ea407b397c7eaedeCFd5df2be4914Dc99C;
