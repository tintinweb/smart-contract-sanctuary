...
SonOfPaperHand  @Sonofpaperhand join in the tg! Stealth launching in a minutes!
...
contract SonOfPaperHand is IBEP20, Auth {
    ...
    string constant _name = "SonOfPaperHand";
    string constant _symbol = "SOPH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 1000 * 5;  //0.5% max tx
    uint256 public _maxWalletSize = (_totalSupply * 3) / 1000 * 7;  //0.7% max wallet
