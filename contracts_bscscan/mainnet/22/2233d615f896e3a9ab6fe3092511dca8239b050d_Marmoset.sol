...
contract Marmoset is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x01737Bd0390239BCd0E0B61682E500b0290166Af); // Marketing Address
    ...
    string private _name = "Marmoset";
    string private _symbol = "Marmoset";
