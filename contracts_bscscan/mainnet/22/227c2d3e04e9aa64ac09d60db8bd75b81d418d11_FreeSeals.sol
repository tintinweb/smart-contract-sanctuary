...
// Free Seals ($FreeSeals)

// BUY TAX 12% SELL TAX 24%
// Marketing 3% | Auto LP 3% | Reward in BNB 18%
// Telegram: https://t.me/FreeSeals   
// Website: https://freesealsbsc.com/
...
contract FreeSeals is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8a7d78D7CD965af37aB76538387cf7d0365d483D); // Marketing Address
    ...
    string private _name = "FreeSeals";
    string private _symbol = "FreeSeals";
    ...
    uint256 private _buypajekFee = 12;
    uint256 private _buylpPajek = 1;
    
    uint256 private _botNeedsPrevention = 1;
    uint256 private _whaleNeedsPrevention = 24;
    ...
    uint256 private _mentokanJumlah = 1000000000000 * 10**6 * 10**9;
    ...
    // Prevent BOT & Whales
    function zLock() public deadCall {
