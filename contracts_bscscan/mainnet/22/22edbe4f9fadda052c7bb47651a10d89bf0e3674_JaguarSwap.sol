...
contract JaguarSwap is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x583d34922B940DEf4953C11a8125337aa7ACF049); // Marketing Address
    address payable public charityAddress = payable(0x583d34922B940DEf4953C11a8125337aa7ACF049); // Charity/Dev Address
    ...
    string private _name = "Jaguar Swap"; // nice
    string private _symbol = "JAGU";
