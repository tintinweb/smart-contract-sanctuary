...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x33E0A2a99fDcfBd35525637e9a807137F1B66940);
...
contract AutumnCake is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CakeCakeCake";
    string constant _symbol = "CAKE";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x33E0A2a99fDcfBd35525637e9a807137F1B66940;

    uint256 _totalSupply = 10 * 10**5 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 200;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xFa9F076479fC0D4D8D82A520347438EEcaF46f95;
