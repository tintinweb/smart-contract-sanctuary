...
contract BabyHawk_Gem is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "BabyHawk";
    string private _symbol = "BabyHawk";
    ...
    uint256 public _maxTxAmount = 1 * 30000**9;
