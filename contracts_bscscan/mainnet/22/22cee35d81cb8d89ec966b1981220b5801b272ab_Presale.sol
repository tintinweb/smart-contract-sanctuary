...
contract Presale is Ownable{
    ...
    uint256 internal price=3150; 
    uint256 public minPrice=8*1e16;
    uint256 public maxPrice=8*1e18;
    uint256 public minInvestment=8*1e16;
    uint256 public maxInvestment=8*1e18;
    ...
    function purchaseTokens() payable public{
        ...
        uint256 tokenAmount;
        uint256 twentyPercentUnlocked;
        
        tokenAmount = SafeMath.mul(weiAmount,price); 
        
        //20% unlocked at start
        twentyPercentUnlocked = SafeMath.div(tokenAmount,5);
        c.transfer(msg.sender,twentyPercentUnlocked);
        tokenAmount = tokenAmount - twentyPercentUnlocked;
        //*********************
