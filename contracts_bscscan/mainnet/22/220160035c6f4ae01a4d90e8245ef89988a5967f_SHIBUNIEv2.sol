...
contract SHIBUNIEv2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6C60EF3D5CC4643B2977999e28135e88cD2D758B); // Marketing Address
    ...
    string private _name = "SHIBUNIEv2";
    string private _symbol = "SHIBUNIEv2";
