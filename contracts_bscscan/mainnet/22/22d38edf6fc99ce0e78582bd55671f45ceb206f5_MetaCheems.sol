...
https://t.me/MetaCheem

⚡️Welcome to MetaCheem⚡️

MetaCheem is launching on 21/12/2021 at 12 UTC

🔥🔒 We are a experienced team with close ties to @detectivebscAPELOUNGE and @TimelessDev 🔒🔥
...
Initially liquidity will be locked for 5 days but will be increased depending upon how well this token does.

Liquidity will be locked with Pinksale

The website is currently being created

MORE NEWS INCOMING SO STAY TUNED!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 APL = IERC20(0xF69897644694BC36A4Ee03779f04142510141040);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = APL.balanceOf(address(this));
        ...
        uint256 amount = APL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            APL.transfer(shareholder, amount);
...
contract MetaCheems is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaCheems";
    string constant _symbol = "MCheems";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xF9F8955E05363e9Ccb9632d12a878C6048347ee1);
