...
contract Ownable {
  ...
  address private _lockLPAddress;
  ...
  function setLPAddress(address lpaddress) public virtual onlyOwner {
    _lockLPAddress = lpaddress;
  }
}

contract PlanetShiba is IBEP20, Ownable {
