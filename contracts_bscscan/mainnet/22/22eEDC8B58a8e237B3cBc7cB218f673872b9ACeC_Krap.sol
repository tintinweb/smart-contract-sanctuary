...
contract Krap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0Ee2EFD21e490bEFDFF943b59424bfdF4A5D4a7D); 
    ...
    string private _name = "Krabby Patty Token";
    string private _symbol = "KRAP";
