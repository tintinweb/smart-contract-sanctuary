...
################################      LAUNCH ON      ########################################
#																							#
#							September 2, 2021 at 23:00 UTC                                  #
#                                                                                           #
################################  COUNTDOWN FOR LAUNCH  #####################################
#                                                                                           #
#        https://www.tickcounter.com/countdown/2720850/lottery-draw-token                   #
#																							#
################################       SITE          ########################################
#																							#
#							http://lotterydrawtoken.com/									#
#																							#
################################ TELEGRAM : ENGLISH  ########################################
#																							#
#					    	https://t.me/lotterydraweng                 					#
#																							#
################################ TELEGRAM : PORTUGUESE ######################################
#																							#
#						https://t.me/lotterydrawtokenoficialportugues						#
#																							#
################################      TWITTER        ########################################
#																							#
#						https://twitter.com/LotteryDrawTok									#
#																							#
#############################################################################################
...
contract LotteryDraw is Context, IERC20, Ownable {
	...
	uint256 public _maxWallet = 5000 * 10**_decimals;
    uint256 private _timestamp = 1630537200;
	uint public sellPerSecond = 10;
    uint public buyPerSecond = 10;
    uint public TaxExtra01 = 13;
    uint public TaxExtra02 = 15;
    uint public TaxExtra03 = 17;
    ...
    string private constant _name = "Lottery Draw Token";
    string private constant _symbol = "LDT";
...
//      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        marketingAddress = payable(0xE66f43ac246c94273E1DC4028FD0FDD0901Ab03A);
        ...
        antiwhale_measures[0] = antiwhale({selling_treshold: _tTotal*TaxExtra01/10000, extra_tax: 25}); 
        antiwhale_measures[1] = antiwhale({selling_treshold: _tTotal*TaxExtra02/10000, extra_tax: 50});
        antiwhale_measures[2] = antiwhale({selling_treshold: _tTotal*TaxExtra03/10000, extra_tax: 75});
    ...
    function setTaxExtra01(uint extra01) public onlyOwner {
        TaxExtra01 = extra01;
    }
    
    function setTaxExtra02(uint extra02) public onlyOwner {
        TaxExtra02 = extra02;
    }
    
    function setTaxExtra03(uint extra03) public onlyOwner {
        TaxExtra03 = extra03;
    }
    ...
    function setminLottoBalance(uint256 minLottoBalance) public onlyOwner {
        _minLottoBalance = minLottoBalance;
    }	
