...
/**
   ...
   Welcome to DogePloytopia
   
   This is a community token. If you want to create a telegram I suggest to name it to @DogePloytopia
   ...
   I will renounce the ownership to burn addresses to transfer #DogePloytopia to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 30% total supply to the pool
   Can you make #DogePloytopia 10000X? 
   ...
   it's the best part of the #DogePloytopia idea, increasing the liquidity pool automatically, 
...
contract DogePloytopia  is Context, IERC20, Ownable {
    ...
    string private _name = "DogePloytopia";
    string private _symbol = "DPLOYTOPIA";
