...
contract Zephyrfinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x9AC4Cb0ae48ebA5a3cD2A7a1C800494fd2f7057d); // Marketing Address
        
    address payable public teamAddress =
        payable(0x585A80Ef65D55b6D2e5d61637b18B9B25C0faC5b); // Team Address
        
    address payable public liquidityAddress =
        payable(0x37B68Ca5B98befC40dFbbA87364d46e082280E92); // Liquidity Address
    ...
    string private constant _name = "Zephyrfinance";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 5 / 10000; // 1.5% maxTransactionAmountTxn
