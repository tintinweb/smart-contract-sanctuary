...
10% Bitcoin reflection automatically every hours
LP Locked !!
...
contract MasterBTCX is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Master BitcoinX";
    string constant _symbol = "MBTCX";
