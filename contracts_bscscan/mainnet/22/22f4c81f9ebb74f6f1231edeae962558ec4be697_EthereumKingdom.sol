...
// user must hold 10,000,000 token to receive Ethereum

/*

STEALTH LAUNCH - ETHKingdom - 10% Ethereum reflection automatically EVERY HOURS
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Bitcoin = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    uint256 public minimumTokenBalanceForDividends = 10000000 * (10**9);
...
contract EthereumKingdom is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "EthereumKingdom";
    string constant _symbol = "EthereumKingdom";
