...
/**
Little Jake Paul - $LJP

Telegram: https://t.me/LilJakePaul
*/
...
contract LittleJakePaul is IBEP20, Auth {
	...
	string constant _name = "Little Jake Paul";
    string constant _symbol = "LJP";
	...
	function marketing() internal swapping {
        ...
        payable(0xA80dE10d63DB98521fceA1703a1d34C6B33eEFc0).transfer(devBNB*4);
