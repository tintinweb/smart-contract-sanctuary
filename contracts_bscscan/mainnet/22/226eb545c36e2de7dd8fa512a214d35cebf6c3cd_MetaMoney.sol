...
contract MetaMoney is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "MetaMoney";                                          // name
    string private _symbol = "MM";                                             // symbol
    ...
    uint256 public defaultLiquidityFee = 7;
    ...
    uint256 public _liquidityFee4Sellers = 7;
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x316b2200E1526A949dD43085DD5694890C770055),                             // Dev+Team wallet
        payable(0xA2cBa600F215f3c8d280c940a2909580Cc28D034),                             // Marketing wallet
        payable(0xDDbf66FB368F75C366B7ff6e7DE48cEEecc038c6)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "MetaMoney is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "MetaMoney is not live yet");
