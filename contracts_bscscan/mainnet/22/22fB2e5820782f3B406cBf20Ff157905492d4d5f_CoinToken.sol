...
contract CoinToken is Context, IERC20, Ownable {
    ...
    string private _name = "BransonGate";
    string private _symbol = "BGATE";
    ...
    uint public liquifyFee = 2; // percent
    uint public marketingFee = 3; // percent
    uint public buyBackFee = 3; // percent
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForUSD(address(this), contractTokenBalance.mul(_totalFees-liquifyFee).div(_totalFees));
