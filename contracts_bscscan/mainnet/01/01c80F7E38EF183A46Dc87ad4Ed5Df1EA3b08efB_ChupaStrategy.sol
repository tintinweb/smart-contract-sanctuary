...
// File: contracts/ChupaStrategy.sol


pragma solidity 0.6.12;

contract ChupaStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public ChupaMasterAddress;
    ...
    constructor(
        ...
        ChupaMasterAddress = _ChupaMasterAddress;
        ...
        transferOwnership(ChupaMasterAddress);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(ChupaMasterAddress, _wantAmt);
