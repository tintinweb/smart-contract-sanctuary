...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xa73026Dd1511E1fB88DAfCDC59C028897d3E8cee;
...
contract CROCOFINANCE is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x6C0b0304060f68fAf539f17dBe64Ca22f59D7736;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "CROCO FINANCE";
    string private _symbol = "CROFI";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000000000000000;
