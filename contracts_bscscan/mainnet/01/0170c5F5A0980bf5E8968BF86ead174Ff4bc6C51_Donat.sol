...
contract Donat is DonatDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DONTeam;
    address private CharityDON;
    ...
    string public override name = "Donat";
    string public override symbol = "DON";
    ...
    constructor(uint totalSupplyValue, address DONTeamAddress, address CharityDONAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DONTeam = DONTeamAddress;
        CharityDON = CharityDONAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DONTeam] =  totalSupply * 0 / 100; 
        balances[CharityDON] = totalSupply * 30 / 100; 
        
        balances[_owner] = totalSupply * 70 / 100; 
    }
    ...
    // Get the address of the token's DONTeam pot
