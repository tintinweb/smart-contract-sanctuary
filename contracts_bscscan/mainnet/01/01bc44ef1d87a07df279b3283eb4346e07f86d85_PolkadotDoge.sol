...
/**
 * TG: https://t.me/PolkadotDoge Welcome to PolkadotDoge, the only coin where doge gives you dot rewards for holding !!!
 * Max Wallet 3% Slippage buys 20 to 25% as for total tax is 18% , 10% Polkadotrewards, 4% liquidity, 3% Marketing , 1% buyback fee
...
contract PolkadotDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PolkadotDoge";
    string constant _symbol = "PolkadotDoge";
    ...
    uint256 public swapThreshold = _totalSupply / 5000; // 0.05%
    bool inSwap;
