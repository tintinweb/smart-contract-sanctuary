...
// flokireturnsBUSD @ https://t.me/flokireturnsBUSD
...
// File: contracts/flokireturnsBUSDDividendPayingToken.sol
...
// File: contracts/flokireturnsBUSD.sol
...
contract flokireturnsBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    flokireturnsBUSDDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("flokireturnsBUSD", "flokireturnsBUSD") {
    	...
    	dividendTracker = new flokireturnsBUSDDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "flokireturnsBUSD: The dividend tracker already has that address");

        flokireturnsBUSDDividendTracker newDividendTracker = flokireturnsBUSDDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "flokireturnsBUSD: The new dividend tracker must be owned by the flokireturnsBUSD token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "flokireturnsBUSD: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "flokireturnsBUSD: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "flokireturnsBUSD: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "flokireturnsBUSD: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "flokireturnsBUSD: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "flokireturnsBUSD: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "flokireturnsBUSDBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "flokireturnsBUSD: This account cannot send tokens until trading is enabled");
        }
...
contract flokireturnsBUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("flokireturnsBUSD_Dividend_Tracker", "flokireturnsBUSD_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "flokireturnsBUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "flokireturnsBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main flokireturnsBUSD contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "flokireturnsBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "flokireturnsBUSD_Dividend_Tracker: Cannot update claimWait to same value");
