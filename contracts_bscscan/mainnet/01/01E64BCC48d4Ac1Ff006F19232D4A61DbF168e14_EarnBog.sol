...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BBD = IERC20(0xB09FE1613fE03E7361319d2a43eDc17422f36B09);
...
contract EarnBog is IERC20, Ownable {
    using SafeMath for uint256;

    address BBD = 0xB09FE1613fE03E7361319d2a43eDc17422f36B09;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "EarnBogged";
    string constant _symbol = "EARNBOGGED";
    ...
    function TeamRemoveRemainingBNB() public onlyOwner{
        (bool sent,) =payable(marketingFeeReceiver).call{value: (address(this).balance)}("");
        require(sent);
    }
