...
contract BabyLambo is Context, IERC20, Ownable {
    ...
    string private _name   = "BabyLambo";
    ...
    uint256 public _liquidityFee = 7;   // BURN/Liquidity fee
    ...
    uint256 private constant _Charity_FEE = 3;    //  Charity Wallet Fee (in bips)
