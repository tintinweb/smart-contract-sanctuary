...
/**
 * TELEGRAM: HTTPS://T.ME/HoboBsc

                INSTANT LP LOCK FOR 10 days
                BUY AND HOLD HOBOBSC AND EARN REWARDS
                SOON WILL BE PINN IN BIG CRYPTO GROUP
                TWITTER INFLUENCERS LINNED up
...
contract HoboBsc is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "HoboBsc";
    string constant _symbol = "$HBSC";
