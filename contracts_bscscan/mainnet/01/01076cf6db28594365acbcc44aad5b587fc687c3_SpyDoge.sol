...
contract SpyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3931737aA3C6bF35967515ED62bb4a292106921B); // Marketing Address
    ...
    string private _name   = "SpyDoge";
    string private _symbol = "SPYDOGE";
    ...
    uint256 public _taxFee = 3;      // Reflection to Holders
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 6;     // Marketing + Buyback
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _buyTaxFee = 3;   // Reflection to Holders
    uint256 public _buyLiquidityFee = 6;  // Marketing + Buyback
    
    uint256 public _sellTaxFee = 5;  // Reflection to Holders
    uint256 public _sellLiquidityFee = 8; // Marketing + Buyback
