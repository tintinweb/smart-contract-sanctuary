...
/**
   ...
   Welcome to LittleBinance
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBinance
...
contract LittleBinance is Context, IERC20, Ownable {
    ...
    string private _name = "Little Binance";
    string private _symbol = "LTBNB";
