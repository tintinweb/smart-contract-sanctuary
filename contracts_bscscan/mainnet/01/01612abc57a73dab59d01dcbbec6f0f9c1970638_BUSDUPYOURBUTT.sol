...
contract BUSDUPYOURBUTT is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BUSDUPYOURBUTT";
    string constant _symbol = "BUSDBUTT";
    ...
    bool internal autoBuybackEnabled = false;
    ...
    function setDumpProtectionTimer(uint256 dumpTimer) external onlyOwner() {
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        uint256 feeAmount = (amount * getTotalFee(recipient == pair, sender)) / feeDenominator;
