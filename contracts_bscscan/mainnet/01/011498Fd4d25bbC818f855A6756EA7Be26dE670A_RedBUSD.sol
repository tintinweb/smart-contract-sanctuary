 ...
 *╚ ═╝░░╚═╝╚══════╝╚═════╝░╚═════╝░░╚═════╝░╚═════╝░╚═════╝
 * 
 * Dividend Token that reward BUSD every 30 minutes, and punish sellers by increasing tax on sells.
 * 
 * Tax on Buy: 12%
 * Tax on Sell: 18%
 * 
...
contract RedBUSD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Red BUSD";
    ...
    uint256 public swapThreshold = 1000 * 10**6 * (10 ** _decimals);
