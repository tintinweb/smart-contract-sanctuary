...
contract BabySkrat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabySkrat";
    string private _symbol = "$BabySkrat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x54fea813476323e5FA2839Ac88e900c6b8cA9367); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x54fea813476323e5FA2839Ac88e900c6b8cA9367); // BuyBack Address
