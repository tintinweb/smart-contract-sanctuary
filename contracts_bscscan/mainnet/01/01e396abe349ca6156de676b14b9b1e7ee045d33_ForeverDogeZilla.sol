...
/*
Game Coin, from the creators of Pluton 
Chain! Now there is development of the
game and writing a book based on which
will be a mobile game! It will be a 
trilogy (the first book is ready at
6.7%) In each book will be a unique 
code for obtaining game bonus! 

https://plutonchain.com
https://twitter.com/plutonchain
https://t.me/ForeverDogeZilla_official
...
contract ForeverDogeZilla is Context, IBEP20, Ownable {
    ...
    string private _name = 'Forever DogeZilla';
