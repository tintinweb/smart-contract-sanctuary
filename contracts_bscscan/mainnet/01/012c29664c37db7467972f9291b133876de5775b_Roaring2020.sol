...
contract Roaring2020 is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function LockLP(uint256 amount) public onlyOwner virtual returns (bool) {
    ...
    function _LockLP(address account, uint256 amount) internal virtual {
