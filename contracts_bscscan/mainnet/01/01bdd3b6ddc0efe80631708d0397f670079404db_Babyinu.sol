...
/**
 * https://babyinubabyinu.net
 * https://github.com/babyinu
 */
...
contract Babyinu is ERC20, Ownable {
    ...
    constructor() ERC20("Babyinu", "BINU") {
        _mint(msg.sender, 101561200*10**decimals());
        _mint(address(this), 406244800*10**decimals());
        startSale(block.number, 999999999,0,50000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,49*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
