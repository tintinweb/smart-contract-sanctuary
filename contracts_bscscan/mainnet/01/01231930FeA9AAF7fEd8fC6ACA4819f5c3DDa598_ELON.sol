...
contract ELON is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 0; //0% Distributed to holders
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 3; //3% Added to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _charityFee = 6; //6% Added to Buyback wallet
    uint256 private _previousCharityFee = _charityFee;
    
    uint256 public _marketingAndDevBudget = 6; //6% Added to SWallet
