...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 OnlyUp = IBEP20(0x5E12bB6DDd9214923d6c837dDF1FfB9c90f18883); //OnlyUp 
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = OnlyUp.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(OnlyUp);
        ...
        uint256 amount = OnlyUp.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            OnlyUp.transfer(shareholder, amount);
...
contract Test is IBEP20, Auth {
    ...
    address OnlyUp = 0x5E12bB6DDd9214923d6c837dDF1FfB9c90f18883; //OnlyUp
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Test"; 
    string constant _symbol = "$TXTO";
