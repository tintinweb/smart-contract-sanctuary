...
contract BUYBACK is Context, IERC20, Ownable {
    ...
    string private _name = "ANTI-DOGE";
    string private _symbol = "ATD";
    ...
    uint256 public _buybackv1Fee = 300; // 300 = 3.00%
    uint256 public _buybackv2Fee = 400; // 400 = 4.00%
    uint256 public _burningFee = 100; // 100 = 1.0%
    uint256 public _smarketingFee = 40; // 400 = 4.00%
    
    uint256 public _maxTxAmount = 15000000 * 10**18; // 15 Million inicial máx transfer
    ...
    address public buybackv1Address  = 0x5380D57f30515677790Cd6dB60f0109c2f2B9Db5;      // BuyBackv1 Address
    address public buybackv2Address  = 0x5380D57f30515677790Cd6dB60f0109c2f2B9Db5;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x29A374f5381a62E41BF92a0a150db421e2aFd272;      // SMarketing Address
