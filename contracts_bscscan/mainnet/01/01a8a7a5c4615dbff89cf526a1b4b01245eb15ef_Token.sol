...
/**
 * 
Welcome to CAPTAINXRP

Earn $XRP as you HODL (10% reflection)

Why tether when you can get $XRP rewards directly into your wallet by holding $CAPXRP?
...
For this reason, the token will get more and more legit as we reach different market caps (and you earn a bunch of $XRP). And rest assured, if our community bands together and holds, we can take this to the moon.

📂Token name: CaptainXRP
📋Symbol: CAPXRP
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable Token = address(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); // BSC-Pegged token
...
contract Token is ERC20, Ownable {
    ...
    uint256 public sellTimer = 45 seconds;
    ...
    constructor() public ERC20("CaptainXRP", "CAPXRP") {
