...
/**
 * Samurai Sushi BSC 
 * $SamSushi serves you the finest $SUSHI rewards.
 * https://www.samsushi.bar/  
 * https://twitter.com/SamuraiSushiBSC
 * https://t.me/samuraisushibsc
 * Total Tax 10% Buy, 20% Sell to reward Diamond Hands
*/
...
contract SamuraiSushiBSC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SamuraiSushiBSC";
    string constant _symbol = "SamSushi";
