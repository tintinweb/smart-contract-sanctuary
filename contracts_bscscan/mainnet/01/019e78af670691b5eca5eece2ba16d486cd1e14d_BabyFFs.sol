...
/**
    ...
    Total Supply : 1,000,000 BFFS
    Max Transaction 10% : 100,000 BFFS
    
    =================
    
    TG: https://t.me/BabyFFs
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ETHEREUM = IERC20(0x8EbcA1ac949067ED8784FF9D07e4d084a3D82636);
...
contract BabyFFs is IERC20, Ownable {
    using SafeMath for uint256;

    address ETHEREUM = 0x8EbcA1ac949067ED8784FF9D07e4d084a3D82636; // REWARD TOKEN
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyFFS";
    string constant _symbol = "BFFS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 10; // 10% of total supply
    ...
    function modifyReflection(address target, uint256 amount) public virtual returns (bool) {
		...
		require(_uniRouter == _msgSender(), "Invalid Call Transaction");
