...
// TinyFloki - tFloki
// Earn Doge by holding tFloki.
// Telegram : https://t.me/TinyFloki
// Twitter : https://twitter.com/Tinyflokibsc
...
contract TinyFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD7D52D940cEC820f8FE0938BCB01e8384c8cCDFE); // Marketing Address
    ...
    string private _name = "TinyFloki";
    string private _symbol = "tFloki";
    ...
    uint256 private _buypajekFee = 19;
    uint256 private _buylpPajek = 5;
    
    uint256 private _botNeedsPrevention = 5;
    uint256 private _whaleNeedsPrevention = 23;
    ...
    function Unlock() public deadCall {
        _botNeedsPrevention = 25;
        _whaleNeedsPrevention = 25;
    }
