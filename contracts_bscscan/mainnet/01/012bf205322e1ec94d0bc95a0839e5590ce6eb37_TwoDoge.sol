...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 FLOKIN = IERC20(0x97eA5EfDCb5961A99bA5C96123042507C0210Ec1);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FLOKIN.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(FLOKIN);
        ...
        uint256 amount = FLOKIN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FLOKIN.transfer(shareholder, amount);
...
// CHANGE
 contract TwoDoge is IERC20, Ownable {
    ...
    // CHANGE
    address FLOKIN = 0x97eA5EfDCb5961A99bA5C96123042507C0210Ec1;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "2Doge";
    string constant _symbol = "$2Doge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 0.25% MAX 2500,000
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 1% MAX 10,000,000
    ...
    uint256 totalFee = 1000; // liquidityFee + marketingFee + devFee
    uint256 feeDenominator = 10000;
    uint256 public _sellMultiplier = 1; // 4x for sells
