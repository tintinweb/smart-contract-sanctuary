...
/* ==========  Category Management  ========== */
  ...
  function orderCategoryTokensByMarketCap(uint256 categoryID) external validCategory(categoryID) {
    ...
    address[] memory categoryFactories = _categoryFactories[categoryID];
    address[] memory categoryRouters = _categoryRouters[categoryID];
    IBisharesUniswapV2Oracle oracle = _categoryOracles[categoryID];
    ...
    for (uint256 i = 1; i < len; i++) {
      ...
      categoryFactories[j + 1] = categoryFactories[i];
      categoryRouters[j + 1] = categoryRouters[i];

    }
    _categoryTokens[categoryID] = categoryTokens;
    _categoryFactories[categoryID] = categoryFactories;
    _categoryRouters[categoryID] = categoryRouters;
...
/* ==========  Category Queries  ========== */
  ...
  function getCategoryTokens(
    ...
    tokens = new address[](categoryTokens.length);
...
/* ==========  Pool Deployment  ========== */
   ...
   */
  function updateMinimumBalance(IIndexPool pool, address factory, address tokenAddress) external _havePool(address(pool)) {
...
/* ==========  Pool Queries  ========== */
  ...
  {
    (tokens, factories,) = getTopCategoryTokens(categoryID, indexSize);
