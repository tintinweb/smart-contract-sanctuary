...
contract SHIBWojak is IBEP20 {
    ...
    string public override name = "SHIB Wojak";
    string public override symbol = "SHIBWojak";
    ...
    constructor(uint totalSupplyValue, address SquidAddress, address GameAddress, address SHIBAAddress) {
        // set total supply
