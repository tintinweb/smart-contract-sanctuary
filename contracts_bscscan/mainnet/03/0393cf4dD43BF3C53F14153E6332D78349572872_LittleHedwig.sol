...
contract LittleHedwig is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LittleHedwig";
    string private _symbol = "LH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6a9c15ff396Ec25E8D53cd4d7D92e101721a5629); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6a9c15ff396Ec25E8D53cd4d7D92e101721a5629); // BuyBack Address
