...
//EVERLaunch002 Contract /////////////

contract EVERLaunch002 is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'EVERLaunch002';
    string private constant _symbol = '$EVER2';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000000 * 10**_decimals;//equals 1000000000000 tokens

    //Divider for the MaxBalance based on circulating Supply (3.5%%)
    uint8 public constant BalanceLimitDivider=29;
    ...
    //DevWallets
    address public TeamWallet=payable(0x468A4DCf9611981F7A367bA550841d8a0C9c325c);
    address public BoosterWallet=payable(0x082Ffeaf6e38fAc93fcf48bF5E87BcDDf6305639);
    //TestNet
	...
	uint256 private antiWhale = 5000000000 * 10**_decimals;
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==TeamWallet||addr==BoosterWallet;
    }
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 3000000000 * 10**_decimals;
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(BoosterWallet).transfer((amount*3)/5);
    } 
    ...
    function TeamChangeBoosterWallet(address newBoosterWallet) public onlyOwner{
      BoosterWallet=payable(newBoosterWallet);
    }
