...
Join us for the most efficient and highest yield FTM reflects on the BSC. 
Hold BabyFTM, earn FTM. It's as simple as that. 
If you have any questions, please join our TG.

https://t.me/BabyFantom
...
contract ReflectionToken is IERC20, Ownable {
    ...
    uint256 private constant startingSupply = 100_000_000; // 100 Million, underscores aid readability

    uint8 private _decimals = 18;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "BabyFantom";
    string constant _symbol = "BBYFTM";

    uint256 public _liquidityFee = 300;
    uint256 public _reflectionFee = 1000;
    ...
    address payable private _marketingWallet = payable(0xb46AE90859A43c4F23e0968013282DEDf6dbe39c);
