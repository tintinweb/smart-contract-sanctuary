...
/**
🥮 Welcome to PastryBAKE Token 🥮

PastryBAKE Token is a utility token that gives its holder a yield bake token.

✅ Auto Earn $Bake 🥯
10% of every buy/sell is taken and redistributed to all holders.
Hold $PASTRYBAKE tokens, earn BAKE. Minimum 200,000 tokens

⬇️Official account : 

🌐 Website : https://pastrybaketoken.com
☎️ Telegram : https://t.me/PastryBakeOfficialy
🤖Reddit : https://www.reddit.com/user/PastryBakeOfficialy
🕊 Twitter : https://twitter.com/NewsPastryBake
*/
...
contract PastryBAKEToken is Context, IBEP20, Ownable {
    ...
    string private _name = "PastryBAKE Token";
    string private _symbol = "PastryBT";
