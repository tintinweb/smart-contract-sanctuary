...
/*
    ...
    Did you also get rugged with JewishBONK ? Let's get back at those stupid jews and make them regret that rug
	
	It will be a stealth project to avoid more jews stealing our money 

    let's reach 6 million mcap 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x112A121082953D4b21E825Be55B33935f5DA039f;
...
contract AdolfBONK is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x757dD382F7eEe6F5C347e1C76bA412569aA4B696);
    ...
    */
    ...
    string private _name = "AdolfBONK"; 
    string private _symbol = "NEIN!NEIN!NEIN!";  
    ...
    */
    ...
    uint256 public _maxTxAmount = _tTotal.mul(90).div(100); 
