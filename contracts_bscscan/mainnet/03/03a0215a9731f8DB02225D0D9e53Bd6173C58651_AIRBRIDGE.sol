...
Air Bridge is DeFi's service platform, built on a proprietary blockchain,
designed to move tokens between Binance Smart Chain and Solana.
Every partner vault benefits the AIRB token price and APY.
...
Website - airbridge.pro
Join the Telegram - t.me/AirBridge
Join the Twitter - twitter.com/Air_Bridge_
*/
...
contract AIRBRIDGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "AIRBRIDGE";
    string private constant _symbol = "AIRB";
