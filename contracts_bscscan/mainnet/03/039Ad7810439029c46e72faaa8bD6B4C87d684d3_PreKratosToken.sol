...
abstract contract BEP20 is IBEP20 {
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        _approve(sender, Context._msgSender(), _allowances[sender][Context._msgSender()].sub(amount, "BEP20: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(Context._msgSender(), spender, _allowances[Context._msgSender()][spender].sub(subtractedValue, "BEP20: decreased allowance below zero"));
        return true;
    }
...
abstract contract Divine is BEP20, Ownable {

    constructor ( string memory name_, string memory symbol_, uint8 decimals_ ) BEP20( name_, symbol_, decimals_ ) {}
}

contract PreKratosToken is Divine {
  ...
  constructor() Divine( "PreKratos", "pKratos", 9 ) {
    uint256 initialSupply_ = 1000000000 * 1e9;
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal override {
    require( (_balances[to_] > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer pKratos." );
  }
  ...
  function mint( address recipient_, uint256 amount_) public virtual onlyOwner() {
   ...
   function burn(uint256 amount_) public virtual {
    ...
    function _burnFrom( address account_, uint256 amount_ ) internal virtual {
      uint256 decreasedAllowance_ = allowance( account_, msg.sender ).sub( amount_, "BEP20: burn amount exceeds allowance");
