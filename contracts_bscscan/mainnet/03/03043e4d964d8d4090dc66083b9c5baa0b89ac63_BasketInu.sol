...
✅Agreement made with great basketball players
✅SAFE DEV 
✅Buyback System
✅Crazy Marketing 
✅ Verified Contract
...
Tg:https://t.me/BasketInuOfficial
Website: https://basketinu.com/
*/
...
contract BasketInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Basket Inu", "BASKET") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setEnableRewards_fee(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function setEnableliquidity_fee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
