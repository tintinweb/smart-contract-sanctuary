...
- 12% FLOKI rewards - reward contract is 0x67d66e8ec1fd25d98b3ccd3b19b7dc4b4b7fc493
- 5% liquidity tax
- 5% marketing fee
...
- 20 second cooldown between buys at launch
- 3% max wallet size
*/
...
contract MiniFOMO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniFOMO";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "$MiniFOMO";
