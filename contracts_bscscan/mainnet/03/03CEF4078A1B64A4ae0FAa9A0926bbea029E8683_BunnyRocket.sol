...
contract BunnyRocket is ERC1155 {
    ...
    string public override name = "BunnyRocket";
    string public override symbol = "BUNNYROCKET";
    ...
    constructor(uint totalSupplyValue, address BUNNYAddress, address ETHTokenAddress, address MetaAddress) {
        // set total supply
        ...
        balances[BUNNY] =  totalSupply * 1 / 100;
        balances[ETHToken] = totalSupply * 48 / 100;
