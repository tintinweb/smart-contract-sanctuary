...
// Hold $DogeMoon Tokens AND GET PAID PASSIVE INCOME IN BNB EVERY 60 MINUTES
//
// It’s Time to Give Back to The People. 
//
// $DogeMoon proposes an innovative feature in its contract.
// 
//
...
//
//
// 📱 Telegram: https://t.me/mydogetoken
// 🌎 Website: https://bit.ly/MoonDogeToken
// 🌐 Twitter: https://twitter.com/Doge_Moon_token
//
//
//Submitted for verification at BscScan.com on 2021-11-05
...
contract MoonDoge is IBEP20, Auth {
    ...
    string constant _name = "MoonDoge";
    string constant _symbol = "MoonDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 _burntSupply = (_totalSupply * 30) /100;
    uint256 _liqSupply = (_totalSupply * 70) /100;
    ...
    uint256 buybackFee = 9;
    uint256 marketingFee = 5;
    uint256 totalFee = 15;
    uint256 feeDenominator = 100;
    
    address private marketingFeeReceiver = 0x3866f6c6dcE8049e01a0cCB6DBc2dd88feB26C2b;
    address private buybackFeeReceiver = 0x1f656b696B5113a0F4CEb0F5B3B4c4123A18457E;
