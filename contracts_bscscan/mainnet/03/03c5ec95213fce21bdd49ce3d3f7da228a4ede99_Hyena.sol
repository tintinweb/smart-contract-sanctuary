...
contract Hyena is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe48F49821D7fEB01c0B2a2466A770B28F5153DC6); // Marketing Address
    address payable public charityAddress = payable(0xe48F49821D7fEB01c0B2a2466A770B28F5153DC6); // Charity/Dev Address
    ...
    string private _name = "Hyena Token"; // nice
    string private _symbol = "HYE";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 50000000000000000000; // nice Claim 50 (0.01BNB = 750)
