...
TG: https://t.me/BabyROX_Official
...
// File: contracts/BabyROXDividendPayingToken.sol
...
contract BabyROX is ERC20, Ownable {
    ...
    function swapTokensForBusd(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of BabyROX
            path,
            recipient,
            block.timestamp
        );
...
contract BabyROXDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
