...
contract BRAINCLOUD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdc159dAa4fFe9D9EBb19Fb78047f8ad762fE0a0D); // Marketing Address
    ...
    string private _name = "BRAIN CLOUD";
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**9; // 5 Million, or 1% of total supply
    ...
    function callMoonShot(uint256 amount) external onlyOwner(){
        ...
        // Members will vote on how much BNB should be used in the MoonShot, and when exactly the should take place.

        // LIVE HOLDER INFO:
        // - (Please join our Telegram using the link posted on our website)
        
        buyBackTokens(amount * 10**9); // i.e. "1" would equal 0.001 BNB
    }
