...
contract TRUMPTOURToken is Context, IERC20, Ownable, SafeToken, LockToken {
    // User data Lottery
    struct userData {
        address userAddress;
        uint256 totalWon;
    ...
    address payable public marketingAddress =
        payable(0x410221C9d8392219234b89A348a10DeD472C84e1); // Marketing Address
    ...
    uint256 private _tTotal = 45000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Win a MAGA Tour Package";
    string private _symbol = "TRUMPTOUR";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 4;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _potFee = 10;
    ...
    uint256 public winAmount = 50000000000000000000;
