...
contract WeRich is Context, IERC20, Ownable {
    ...
    string private constant _name = 'WeRich.finance';
    string private constant _symbol = 'RICH';
    
    uint256 private _taxFee = 200;
    uint256 private _burnFee = 200;
    uint private _max_tx_size = 600000000000000 * 10 ** uint256(_decimals);
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x00deAd00000000000000000dEAd0000000000000, 'We can not exclude Uniswap router.');
