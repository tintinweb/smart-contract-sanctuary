...
/*
   ...
   50% burned at launch
   Liquitiy will be locked with dxsale
   Ownership Renounced
*/
...
contract SafeMarine is Context, IERC20, Ownable {
  ...
  uint256 public sPrice; 
    ...
    string private    _name = "SafeMarine";
    string private  _symbol = "SAFEMARINE";
    uint8 private _decimals = 9;
    
    uint256 public                _taxFee = 2; // 5% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 5; // 2% of transactions will be kept for liquidity
    uint256 public               _burnFee = 1; // 5% of transactions will be burned
