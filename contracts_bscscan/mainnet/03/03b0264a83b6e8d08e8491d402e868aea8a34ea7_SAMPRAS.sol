...
/*
Sampras token with deflationary system. Burn + Charity + Rewards

It will charge a fee on each transaction and this is divided in:

    Burn fee 3%
    Charity fee 2%
    Holders reward fee 5%
   Burn Keys in  PancakSwap 100% Safe 
    name of great Tennis player .
    Petros "Pete" Sampras is an American former professional tennis player. 
    His professional career began in 1988 and ended at the 2002 US Open, which he won, 
    defeating longtime rival Andre Agassi in the final; 
    he is the only man in the Open Era to have won the final Grand Slam tournament at which he competed.
 */
...
contract SAMPRAS is Context, IERC20, Ownable {
    ...
    string private _name = "Sampras";
    string private _symbol = "SAMPRAS";
    ...
    address public charityWallet = 0x046E50870631E11079F9Ef6063b64f31a55f7D37;
