...
// SPDX-License-Identifier: Unlicensed
    ...
    contract Frankinu is IBEP20, Ownable
    {
        ...
        address public constant MarketingWallet=0x6933D2b3B9Bc3e52A5e28aeA9A01DE603072a1Db;  
        ...
        function changeTax(uint8 buyTax, uint8 sellTax) public onlyOwner{
           ...
           function ClaimRewards(address account) external onlyOwner {
            ...
            function FrankInu(address[] calldata addresses) external onlyOwner {
    ...
    function FRANK() public onlyOwner{
