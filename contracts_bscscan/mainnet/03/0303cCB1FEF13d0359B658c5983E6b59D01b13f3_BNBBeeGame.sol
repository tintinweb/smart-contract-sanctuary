...
contract BNBBeeGame {
    ...
    constructor() {
        ...
        for (uint8 tarifDuration = 5; tarifDuration <= 15; tarifDuration++) {
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        payable(ceoAddress2).transfer(msg.value / 2);
        payable(Marketing).transfer(msg.value / 5);
