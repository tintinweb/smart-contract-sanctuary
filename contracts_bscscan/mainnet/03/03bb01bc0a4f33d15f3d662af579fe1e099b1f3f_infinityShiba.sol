...
/**
	...
	Welcome to the infinityShiba Token   @Telegram https://t.me/infinityShiba
   ...
   I will renounce the ownership to burn addresses to transfer #infinityShiba to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make infinityShiba 100X? 
   ...
   it's the best part of the #infinityShiba idea, increasing the liquidity pool automatically, 
...
contract infinityShiba is BEP20 {
