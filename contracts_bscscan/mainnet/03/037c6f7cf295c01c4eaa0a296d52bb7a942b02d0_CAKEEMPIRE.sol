...
/*
  ...
  Telegram: t.me/cakeempirebsc
 
  Earn massive Cake reward just by holding Cake Empire.
...
contract CAKEEMPIRE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cake Empire";
    string constant _symbol = "CAKEEMPIRE";
