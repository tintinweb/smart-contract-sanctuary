...
contract Flokinomics is IBEP20, Auth {
    ...
    uint256 public axTxAmount = 2;
    uint256 public maxWalletToken = 5;

    // Max wallet & Transaction
    uint256 public _maxTxAmount = rSupply.div(1000).mul(axTxAmount);
    uint256 public _maxWalletToken = rSupply.div(1000).mul(maxWalletToken);
