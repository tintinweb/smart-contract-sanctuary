...
contract PigZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PigZilla";
    string private _symbol = "PigZilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7925067e73C5192974788498d220342efA61Cd99); // Marketing Address
    address payable public teamWalletAddress = payable(0x7925067e73C5192974788498d220342efA61Cd99); // Team Address
