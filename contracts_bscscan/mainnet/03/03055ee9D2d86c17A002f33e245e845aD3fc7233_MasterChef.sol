...
// SwpyToken with Governance.
contract SwpyToken is BEP20('Swappies', 'SWPY') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "SWPY::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "SWPY::delegateBySig: invalid nonce");
        require(now <= expiry, "SWPY::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "SWPY::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying SWPYs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "SWPY::_writeCheckpoint: block number exceeds 32 bits");
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "SWPY: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "SWPY: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "SWPY: index out of bounds");
...
// File: contracts\SWPYMasterChef.sol
