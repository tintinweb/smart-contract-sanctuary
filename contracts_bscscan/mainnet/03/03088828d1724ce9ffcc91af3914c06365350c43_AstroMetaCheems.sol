...
Telegram = https://t.me/AstroMetaCheems
...
// CHANGE
contract AstroMetaCheems is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "AstrMetaCheems";
    string constant _symbol = "AMC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100; // 5% MAX 40,000,000
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 3% MAX 30,000,000
    ...
    uint256 liquidityFee = 100; // 4%
    uint256 buybackFee = 600;   // 4% 
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 600; // 4%
    uint256 totalFee = 1300; // liquidityFee + Buyback + devFee
