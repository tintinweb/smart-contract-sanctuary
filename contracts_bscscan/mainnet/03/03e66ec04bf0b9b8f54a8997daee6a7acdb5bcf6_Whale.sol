...
contract Whale is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL,  uint256 _supply, uint256 _MAXAMOUNT,address routerAddress,address tokenOwner) public {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = 9;
        ...
        numTokensSellToAddToLiquidity = _MAXAMOUNT * 10 ** _decimals;
