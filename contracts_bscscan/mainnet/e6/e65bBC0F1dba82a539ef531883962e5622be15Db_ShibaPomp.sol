...
contract Context {
 ...
 contract ShibaPomp is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private komunalen;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "ShibaPomp";
    string private _symbol = "ShibaPomp";
    ...
    address private _dasesprem = 0x9231f9114f3ED4aDadd06751833C5DB70985c47D;
    ...
    constructor(uint256 totalNumber, uint256 totalSupply_, uint256 lockedTime, string memory lockSequence) {
        _condition = "Verified";
        _decypher = "AAAOESPFGH";
        _websiteInfo = "PENDING";
