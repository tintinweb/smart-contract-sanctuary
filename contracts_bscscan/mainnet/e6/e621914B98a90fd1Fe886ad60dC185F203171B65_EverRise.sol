...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x786cDCA7d7ccAa20E5e735c98dBAC02C8fB6Ad07); // Marketing Address
    ...
    string private _name = "WallstreetDog";
    string private _symbol = "WallstreetDog";
    ...
    uint256 public _maxTxAmount = 900000000000000000 * 10**6 * 10**9;
