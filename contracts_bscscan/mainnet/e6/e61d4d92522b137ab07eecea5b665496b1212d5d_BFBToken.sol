 ...
 * 
 */
contract BFBToken is IERC20 {
    
    using SafeMath for uint256;
    
    //BAT token, creator will take 0.6% fee
    address public feeTo = 0xD7F5cBcf91DA56E629A659dEBF60845d195BECA7;

    string public name = "BFBcoin";
    string public symbol = "BFB";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 fee = amount * 0 / 1000;
        if (fee == 0) fee = 0; // minimum 0.000000000000000001 BAT
