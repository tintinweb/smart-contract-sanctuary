...
What is SafeStepHero ?

💎 SafeStepHero - A token that reward hyped-launched $STEPHERO to its holders automatically.

💎 The token automatically distributes $STEPHERP to holders. 
    Simply holding the SafeStepHero, you will obtain $STEPHERO. 

💎 This is 100% safu , and it'll be driven by the community and their intentions to hold the token and moon it.

💎 We're absolutely ready to do all the marketing needed such as CMS , Influencers , etc ...

🚀🚀  You guys will be informed about everything as we're launching today. 🚀🚀
                                                                                                
TG : https://t.me/safestephero
...
// File: contracts/TokenDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable DividendsToken = address(0xE8176d414560cFE1Bf82Fd73B986823B89E4F545);
...
contract Token is ERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 50000000000000 * (10**18); // 1.5% of total supply
    ...
    uint256 public immutable tradingEnabledTimestamp = 1628565720;
    ...
    constructor() public ERC20("SAFE STEPHERO", "SAFESTEPHERO") {
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Token: The liquidity wallet is already this address");
