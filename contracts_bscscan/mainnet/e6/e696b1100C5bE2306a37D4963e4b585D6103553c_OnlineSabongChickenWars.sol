...
contract OnlineSabongChickenWars is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Online Sabong Chicken Wars';
    string  private constant _SYMBOL = 'SABONG';
