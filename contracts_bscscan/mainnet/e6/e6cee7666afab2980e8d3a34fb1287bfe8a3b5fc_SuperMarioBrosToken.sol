...
/**
   ...
   #SUPER MARIO BROS TOKEN features:
...
contract SuperMarioBrosToken is Context, IERC20, Ownable {
    ...
    string private _name = "Super Mario Bros Token";
    string private _symbol = "SMBT";
