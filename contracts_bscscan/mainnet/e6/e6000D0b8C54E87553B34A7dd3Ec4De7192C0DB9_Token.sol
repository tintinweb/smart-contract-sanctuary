...
contract Token is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        // Disable the following rule for excluded addresses
        require( 
            (amount < maxSendAmount) || (MarketingAddress == msg.sender),
            "You are trying to send more than the allowed maximum amount"
        );
