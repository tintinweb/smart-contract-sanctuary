...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BABY = IBEP20(0x53E562b9B7E5E94b81f10e96Ee70Ad06df3D2657);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x325E343f1dE602396E256B67eFd1F61C3A6B38Bd);
        _token = msg.sender;
    }
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BABY.balanceOf(address(this));
        ...
        uint256 amount = BABY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BABY.transfer(shareholder, amount);
...
contract L17R is IBEP20, Auth {
    ...
    string constant _name = "L17R";
    string constant _symbol = "L17R";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x325E343f1dE602396E256B67eFd1F61C3A6B38Bd);
        ...
        marketingFeeReceiver = 0x5dEb5aA4720444b2eC81e05A2b25595960C35aD8;
