...
contract Centcex is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1FCE71254df522a7AC6Ba3043777B2ce69478Df4); // Marketing Address
    ...
    string private _name = "Centcex";
    string private _symbol = "CENX";
