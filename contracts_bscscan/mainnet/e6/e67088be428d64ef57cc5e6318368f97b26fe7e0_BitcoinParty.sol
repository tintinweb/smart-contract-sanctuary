...
/**
 * Buy to join the bitcoinparty. Be awarded in smart chain BTC tokens when you hold.
 */
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable BTC = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //WBTC
...
contract BitcoinParty is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BitcoinPartyDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public immutable BTC = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //BTC
    ...
    address public _marketingWalletAddress = 0x27543E02208ad90F6b12D3f45A2EA69a97Dcc078;
    ...
    constructor() public ERC20("BitcoinParty", "BTCPARTY") {

    dividendTracker = new BitcoinPartyDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BitcoinPartyDividendTracker newDividendTracker = BitcoinPartyDividendTracker(payable(newAddress));
...
dividendTracker.processAccount(msg.sender, false);
    ...
    function _transfer(
        ...
        {
            swapDuration++;if(swapDuration>4){
...
contract BitcoinPartyDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BitcoinParty_Dividend_Tracker", "BitcoinParty_Dividend_Tracker") {
    claimWait = 3600;
