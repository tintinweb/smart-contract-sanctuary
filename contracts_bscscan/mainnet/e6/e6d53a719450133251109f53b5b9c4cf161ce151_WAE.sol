...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6eC81C060d943541B69DB02De915578A54ad331e;
...
contract WAE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6eC81C060d943541B69DB02De915578A54ad331e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "We are Equal";
    string private _symbol = "WAE";
