...
contract LORDELEMON is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   LORDELEMONDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("LORDE LEMON", "LEMONLADE") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 2;
        _buyMarketingFee = 6;
        _buyDevFee = 2;
        ...
        dividendTracker = new LORDELEMONDividendTracker();

        liquidityWallet = owner();
        
        marketingWallet = payable(0x320ACB4F2BE1400d26B6C51B7c398e64B8327623);
        _devWallet = payable(0xFe6b9CE37ACdaba6E825036c82FD7830d7A0A196);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "LORDE LEMON: The dividend tracker already has that address");

        LORDELEMONDividendTracker newDividendTracker = LORDELEMONDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "LORDE LEMON: The new dividend tracker must be owned by the CAESAR THE GOD token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "LORDE LEMON: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "LORDE LEMON: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LORDE LEMON: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "LORDE LEMON: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "LORDE LEMON: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LORDE LEMON: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "LORDE LEMON: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "LORDE LEMON: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "LORDE LEMON: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "LORDE LEMON: Cannot update gasForProcessing to same value");
...
contract LORDELEMONDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("CTG_Dividend_Tracker", "CTG_Dividend_Tracker") {
        claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "CTG_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LORDE LEMON contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "CTG_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "CTG_Dividend_Tracker: Cannot update claimWait to same value");
