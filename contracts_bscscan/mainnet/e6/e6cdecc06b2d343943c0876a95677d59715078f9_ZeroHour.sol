...
📢 : https://t.me/ZeroHourAnnouncements
...
contract ZeroHour is Context, IERC20, Ownable {
    ...
    payable(0xe7aA1AcFE9a9386F7Ea91B50e06237Ff8c43C283);
    ...
    string private constant _name = "Zero Hour";
    string private constant _symbol = "ZEHO";
...
uint256 private minimumTokensBeforeSwap = _tTotal * 10 / 10000; // 0.05%
...
maxTransactionAmount = _tTotal * 35 / 1000; // maxTransactionAmountTxn
