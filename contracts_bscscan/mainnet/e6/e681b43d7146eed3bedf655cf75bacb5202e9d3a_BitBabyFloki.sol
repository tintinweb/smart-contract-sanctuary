...
/**
 * Buy to join the BitBabyFloki. Be awarded in smart chain BTC tokens when you hold.
 */
...
contract BitBabyFloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BitBabyFlokiDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x970c1999867c14c095635444237Ba24359432a42;
    ...
    constructor() public ERC20("BitBabyFloki", "BITF") {

    dividendTracker = new BitBabyFlokiDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BitBabyFlokiDividendTracker newDividendTracker = BitBabyFlokiDividendTracker(payable(newAddress));
...
contract BitBabyFlokiDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BitBabyFloki_Dividend_Tracker", "BitBabyFloki_Dividend_Tracker") {
    claimWait = 3600;
