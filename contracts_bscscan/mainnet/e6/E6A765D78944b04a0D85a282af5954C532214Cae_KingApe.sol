...
Baby Mr Hankey - Let's poo together!!!
...
contract KingApe is ERC20, Ownable {
    ...
    // TOKEM
    string tokenName = "KingApe";
    string tokenSymbol = "KOTA";
    uint256 tokenTotalSupply = 21_000_000 * (10**18);
    
    // ADRESSES
    address marketingWallet = 0x79B2CD48C992729d2407997BFD90f3bE6590893A;
    ...
    // WHALE PROTECTION
    uint256 maxTXAmount = 5_000_000 * (10**18);
