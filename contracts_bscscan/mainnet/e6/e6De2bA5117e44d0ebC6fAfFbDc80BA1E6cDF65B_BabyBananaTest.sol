...
contract BabyBananaTest is IBEP20 {
    struct TokenLock {
        uint256 amount;
        uint256 releaseTime;
    }
    ...
    address constant MULTI_SIG_TEAM_WALLET = 0xda83D3257E8880e44Cfe8e8690b9d6c283d397c6;
    ...
    function symbol() external pure override returns (string memory) { return "TTNANA"; }
    function name() external pure override returns (string memory) { return "BabyBananaTest"; }
