...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x23CF37F2644bA613c5b5c27E24760cDd07911a78;
...
contract SquidGameElonShib is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdE21a46d79FA66048C2F9F72ef7Dc7729A634DdD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SquidGameElonShib";
    string private _symbol = "SGES";
