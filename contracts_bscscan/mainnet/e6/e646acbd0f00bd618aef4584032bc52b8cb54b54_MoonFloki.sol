...
contract MoonFloki is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES *********************************
    string private _name = "Moon Floki";                                                   // name
    string private _symbol = "MOONFLOKI";                                                    // symbol
    uint256 private _tTotal = 100000000000 * 10**uint256(_decimals);                        // total supply
    uint256 public _taxFee = 2;                                                          // % to holders
    uint256 public _swapAndLiquifyFee = 2;                                               // % to swap and add to liquidity
    uint256 public _walletsFee = 12;                                                      // % to wallets
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive _walletsFee.
        0xA551e69AF983C4C5A4c35cFF94cf83DaDe07A531,                                      //
        0x497e8C729C2c3b207F61dDd0E69518D077B4BB22,                                      //
        0xf8f50840D7b2ceE204Df64790a45e3e6c139B787                                       //
    ];                                                                                   //
    // ********************************** END VARIABLES **********************************
