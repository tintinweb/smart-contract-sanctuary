...
TWINDOGE, the World's Best Investment Company

5% Tax on transactions.
3% Distributed to holders, hold and earn.
2% to Liquidity Pool

MAX SUPPLY = 1,999,999,999.9999
...
contract TWINDOGE is DeflationaryERC20 {

    constructor() DeflationaryERC20("BNB", "TWINDOGE") {

        _mint(msg.sender, 1999999999.9999e18);  
    }
