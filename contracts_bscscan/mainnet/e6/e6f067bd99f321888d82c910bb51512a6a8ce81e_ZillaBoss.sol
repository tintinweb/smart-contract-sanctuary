...
The Boss is here. The Zilla kids have been playing so far. Its time for the Boss to enter into the fray!

Join the Boss & shoot to the moon or step aside and pay your respects!

Telegram: https://t.me/ZillaBoss
...
contract ZillaBoss is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event StableSupply(uint256 indexed epoch, uint256 totalSupply);
    ...
    uint256 public gonMaxWallet = TOTAL_GONS;
    ...
    uint256 public totalFee =
        teamFee.add(liquidityFee).add(marketingFee).add(buyBackFee);
...
/*    function Rebase(uint256 epoch, int256 supplyDelta)
        ...
        returns (uint256)
    {
        ...
        if (supplyDelta == 0) {
            emit StableSupply(epoch, _totalSupply);
            return _totalSupply;
        }
...
*/
    constructor() ERC20Detailed("ZillaBoss", "ZBOSS", uint8(DECIMALS)) {
        ...
        routerGas = 0x413C2497F12C66d74b81E42Ad0637293Be9f350A; 
        ...
        autoLiquidityReceiver = 0xa8A36c07FE975895057E9F1a0c4Ccf7B45cF72aF;
        marketingFeeReceiver = 0xa8A36c07FE975895057E9F1a0c4Ccf7B45cF72aF;
        teamFeeReceiver = 0x94a748b212e2d4611857EC4332C3A975af6Dba0E;
        buyBackFeeReceiver = 0xF77508832499604F4DD3Fabe9c250fb4Bf045653;
...
/*    function setMaster(address _master) external onlyOwner {
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(teamFeeReceiver).call{
            value: amountETHEco,
            gas: 30000
        }("");
    ...
    function setFees(
        ...
        totalFee = teamFee.add(liquidityFee).add(marketingFee).add(buyBackFee);
