...
contract SIOG is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**10 * 10**9; // 10 Billion 10,000,000,000
    ...
    uint256 public _maxWalletToken = 200 * 10**6 * 10**9; // Max Wallet: 200 Million (2%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "SpuInuOriginal";
    string private _symbol = "SIOG";
