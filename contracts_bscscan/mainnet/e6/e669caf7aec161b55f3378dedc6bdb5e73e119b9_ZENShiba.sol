...
contract ZENShiba is Context, IERC20, Ownable {
    ...
    string private _name = "ZENShiba";
    string private _symbol = "ZENSHIBA";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0; // Manually adjust prior to renouncing...
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 12; // Manually adjust prior to renouncing...
