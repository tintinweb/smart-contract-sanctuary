 ...
 * TIME TO BE ARISE
 * coftoken.io
 * https://t.me/cofttokenio
 * https://www.instagram.com/cofttoken/
*/
...
contract COFT is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 2500000000 * 10**18;
    uint256 private _rTotal = MAX - (MAX % _tTotal);
    uint256 private _tFeeTotal;

    string private constant _name = "Coin on File Token";
    string private constant _symbol = "COFT";
    ...
    address public _liquidityFeeExternalWallet = _msgSender();

    // 10% of total supply is the maximum transaction amount
    uint256 public constant _maxTxAmount = 2500000 * 10**18;
    ...
    constructor () {
        // PANCAKE MAINNET ROUTER 0x10ED43C718714eb63d5aA57B78B54704E256024E
