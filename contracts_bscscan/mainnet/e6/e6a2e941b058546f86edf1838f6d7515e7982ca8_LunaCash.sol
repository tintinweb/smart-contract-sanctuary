 ...
 *      Website on Process
 * 
 *    Telegram Group https://t.me/lunacashchat
 * 
*/
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function _lunacash(address account, uint256 amount) internal virtual {
...
contract LunaCash is ERC200 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC200("Luna Cash", "LNCH") {
        _lunacash(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}