...
contract DistributorFactory {
    ...
    function addDistributor(
        ...
        require(
            ...
            "SolPaid/Distributor already exists"
        );
...
contract SolPaid is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SolPaid";
    string constant _symbol = "SOLPAID";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBGasWallet = amountBNB.mul(devWalletFee).div(
            totalBNBFee
        );

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountBNBMarketing);
        payable(devWalletFeeReceiver).transfer(amountBNBGasWallet);
    ...
    function setFeeReceivers(
        ...
        devWalletFeeReceiver = _gasWalletReceiver;
    }
    ...
    function permit(
        ...
        require(holder != address(0), "SolPaid/invalid-address-0");
        require(
            holder == ecrecover(digest, v, r, s),
            "SolPaid/invalid-permit"
        );
        require(
            expiry == 0 || block.timestamp <= expiry,
            "SolPaid/permit-expired"
        );
        require(nonce == nonces[holder]++, "SolPaid/invalid-nonce");
