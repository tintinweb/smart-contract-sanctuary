...
contract BullRaptor is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "BullRaptor";
   string constant _symbol = "BULLRAPTOR";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 100000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 2; // 2%
...
uint256 reflectionFee = 300;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x44E970dB6F75D2Dc99e006CD8B6C004ff7d29778;
