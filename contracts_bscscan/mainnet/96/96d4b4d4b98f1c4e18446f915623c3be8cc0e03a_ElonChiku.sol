...
/**
    Welcome To ElonChiku Community Tokens
...
contract ElonChiku is Context, IERC20AntiBots, Ownable {
    ...
    string private _name = 'ElonChiku';
    string private _symbol = 'ElonChiku';
