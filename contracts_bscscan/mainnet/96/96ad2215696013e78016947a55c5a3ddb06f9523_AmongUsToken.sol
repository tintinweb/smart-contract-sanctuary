...
contract AmongUsToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Among us Token$";
   ...
   // sell fee
    ...
    address public Owner=0x0e7B2225bC5643b7f00CE82D6259c8B14CD88384; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x17F1E9F966Fc5Ad5e8f3EEd66F0E5E386Ece7FBc; // marketing address
