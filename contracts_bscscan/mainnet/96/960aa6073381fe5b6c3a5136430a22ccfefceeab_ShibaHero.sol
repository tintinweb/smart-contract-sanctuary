...
/*
Shiba.Hero (Official)
🌐 Website : https://www.shibaherocoin.com/

💬 Twitter : https://twitter.com/ShibaHero_Token

✈️ Telegram : https://t.me/ShibaHeroToken
*/
...
contract ShibaHero is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 5;
  uint256 public _feeLiq = 5;
  uint256 public _feeHolders = 3;
  uint256 public _maxTXPercent = 100;

  constructor() public {
    _totalSupply = 400 * 10**6 * 10**9;
