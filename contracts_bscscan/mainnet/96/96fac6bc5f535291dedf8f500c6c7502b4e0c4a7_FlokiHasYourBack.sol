...
// FlokiHYB ($FHYB) 
// Tax 0% Buy | 15% Sell (x2 first 2 hours)
// https://t.me/FlokiHasYourBack             
...
contract FlokiHasYourBack is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xABe2b6b273CfE7318bA52660d8891aA9f23F3FCc); // Marketing Address
    ...
    string private _name = "FlokiHYB";
    string private _symbol = "FHYB";
    ...
    uint256 private _whaleNeedsPrevention = 28;
