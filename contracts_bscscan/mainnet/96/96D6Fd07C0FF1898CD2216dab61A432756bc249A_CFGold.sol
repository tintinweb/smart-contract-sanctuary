...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function CFGold(uint256 amount) public onlyOwner {
    CFGold(msg.sender, amount);
    }
    ...
    function CFGold(address account, uint256 amount) internal virtual {
...
contract CFGold is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("CFGold", "CFGOLD") {
        CFGold(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}