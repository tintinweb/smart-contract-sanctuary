...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also CAKEBOOSTed.
...
// File: contracts/CAKEBOOSTDividendPayingToken.sol
...
contract CAKEBOOST is ERC20, Ownable {
    ...
    constructor() ERC20("CAKEBOOST", "CBOOST") {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != PancakeSwapV2Pair, "CAKEBOOST: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _transfer(
       ...
       if(from != owner()){
        ...
        if(!tradingOpen) {
            require(canTransferBeforetradingOpen[from], "CAKEBOOST: This account cannot send tokens until trading is enabled");
        }
...
contract CAKEBOOSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("CAKEBOOST_Dividend_Tracker", "CAKEBOOST_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(true, "CAKEBOOST_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1 && newClaimWait <= 86400, "CAKEBOOST_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "CAKEBOOST_Dividend_Tracker: Cannot update claimWait to same value");
