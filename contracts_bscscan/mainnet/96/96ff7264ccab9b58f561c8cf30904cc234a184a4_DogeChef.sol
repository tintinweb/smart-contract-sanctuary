...
/*
    ...
    DOGECHEF TOKEN CONTRACT
    
    https://t.me/dogechef
    https://wwww.dogechef.com
    https://twitter.com/dogechef
...
contract DogeChef is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("DogeChef", "DCH") {
        uint256 _DogeRewardsFee = 12;
    ...
    function setDogeRewardFee(uint256 newFee) external onlyOwner{
...
contract TDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("DogeChef_Dividend_Tracker", "DCH_Dividend_Tracker") {
    	claimWait = 600;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "DogeChef_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "DogeChef_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DogeChef contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "DogeChef_Dividend_Tracker: claimWait must be updated to between 10min  and 24 hours");
        require(newClaimWait != claimWait, "DogeChef_Dividend_Tracker: Cannot update claimWait to same value");
