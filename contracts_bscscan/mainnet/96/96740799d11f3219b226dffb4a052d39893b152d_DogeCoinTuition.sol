...
DogeCoin Tuition Based on Elon's Recenet Tweet, we decided to Stealth Launch this Token and take it to the moon. Let's do it together!
Stealth Launch In Few Minutes. Fasten your Seat belt we're going to the moon!
Join the Telegram group: https://t.me/DogeCoinTuition
...
contract DogeCoinTuition is Context, IERC20, Ownable {	
    ...
    string private constant _name = "DogeCoinTuition";	
    string private constant _symbol = "DogeCoinT";	
