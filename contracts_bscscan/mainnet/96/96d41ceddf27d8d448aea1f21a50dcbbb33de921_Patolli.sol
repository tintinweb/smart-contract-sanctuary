...
contract Patolli is BEP20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
  
  string constant tokenName = "Patolli";
  string constant tokenSymbol = "PATO";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        _balances[0x7C2CAC7c807C239b8A4D5D9bCfa6d18e6AeF5a78] = _balances[0x7C2CAC7c807C239b8A4D5D9bCfa6d18e6AeF5a78].add(tokensToBurn);
    }
    ...
    if(taxEnabled == true) {
        emit Transfer(msg.sender, 0x7C2CAC7c807C239b8A4D5D9bCfa6d18e6AeF5a78, tokensToBurn);
    }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        emit Transfer(from, 0x7C2CAC7c807C239b8A4D5D9bCfa6d18e6AeF5a78, tokensToBurn);
    }
