...
contract SAITAMAV2 is SAITAMAETR, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtSAITAMAETR;
    address private CharitySAITAMAETR;
    ...
    string public override name = "SAITAMA V2";
    string public override symbol = "SAITAMA V2";
    ...
    constructor(uint totalSupplyValue, address TeamtSAITAMAETRAddress, address CharitySAITAMAETRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtSAITAMAETR = TeamtSAITAMAETRAddress;
        CharitySAITAMAETR = CharitySAITAMAETRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtSAITAMAETR] = totalSupply * 4 / 100;
        balances[CharitySAITAMAETR] = totalSupply * 4 / 100;
