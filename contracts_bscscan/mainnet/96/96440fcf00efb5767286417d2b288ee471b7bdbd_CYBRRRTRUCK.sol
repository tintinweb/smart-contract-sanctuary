...
Cybrrrtruck is a community driven token with buy back mechanics and backed by an elon tweet.
    

Tokenomics:    
1) 2% tax is collected and distributed to holders for HODLing
2) 9% towards buybacks and marketing(5%, 4%)
    
    
 _______    ______   _______   ________  ______   _______    ______  
/       \  /      \ /       \ /        |/      \ /       \  /      \ 
$$$$$$$  |/$$$$$$  |$$$$$$$  |$$$$$$$$//$$$$$$  |$$$$$$$  |/$$$$$$  |
$$ |__$$ |$$ |__$$ |$$ |__$$ |   $$ |  $$ |  $$ |$$ |__$$ |$$ \__$$/ 
$$    $$< $$    $$ |$$    $$/    $$ |  $$ |  $$ |$$    $$< $$      \ 
...
contract CYBRRRTRUCK is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8A6fe85bc5Dbf7baBB410831938B668471002f8E); // Marketing Address
    ...
    string private _name = "Cybrrrtruck";
    string private _symbol = "CYBRRRTRUCK";
	...
	function releaseTheKraken() public onlyOwner() {
        uint256 initialBalance = address(this).balance;
        transferToAddressETH(marketingAddress, initialBalance); 
    }
