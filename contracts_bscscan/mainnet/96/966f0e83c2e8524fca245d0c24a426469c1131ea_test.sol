...
contract test is IBEP20, Auth {
    ...
    string constant _name = "test";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    //max wallet holding % 
    uint256 public _maxWalletToken = ( _totalSupply * 6 ) / 100;  // 2 is the percentage of max wallet.
