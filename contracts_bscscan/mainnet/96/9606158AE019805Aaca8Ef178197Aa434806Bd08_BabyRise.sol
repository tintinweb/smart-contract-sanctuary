...
/*
The first member of the RISE2PROTOCOL ecosystem is 💎👶🏻BABYRISE💎👶🏻
BABYRISE is the first $RIPR rewards token in celebration of our Ecosystem.
BABYRISE will provide major support to $RIPR because of the rewards & buy backs build in the contract. The fees generated from BABYRISE will become the lifeblood of this ecosystem raising us to the top !!
RISE2PROTOCOL is the main project, and the main token, an ecosystem will be built around it 

🔰Total  supply: 100,000,000
⚡️Token Name: Baby Rise
⚡️Ticker Symbol: BBRI
✅ Max Wallet: 2000000 (2%)
✅ Max Transaction: 250000 (0.25%)

💎Taxes💎
⚜️ 7 % $RIPR Rewards
⚜️ 3 % Automatic Liquidity
⚜️ 5 % Marketing

🌐 Telegram:
https://t.me/BABYRISEoff
🌐Web Site:
https://babyrisetoken.com/
*/
...
contract BabyRise is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Rise", "BBRI")  {
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        ...
        function includeRIPRreward(uint256 value) external onlyOwner{
