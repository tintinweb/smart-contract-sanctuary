...
https://t.me/FuckBtcDumpersBnbWillPumpSoon
...
// CHANGE
contract FuckBtcDumpersBnbWillPumpSoon is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FuckBtcDumpersBnbWillPumpSoon";
    string constant _symbol = "$FuckBtcDumpersBnbWillPumpSoon ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 50) / 100; // Max 500,000,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // Max 1000,000,000,000,000,000
    ...
    uint256 public _BuyBackMultiplier = 4;
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xf8C26571fFb516E52Af743C870161ADB1833B7e0);
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(selling){ return totalFee.mul(_BuyBackMultiplier); }
        return totalFee;
    }
    ...
    function setBuyBackMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 300 && multiplier * totalFee <= 490000, "Multiplier too high");
        _BuyBackMultiplier = multiplier;
    }
