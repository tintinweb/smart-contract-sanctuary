...
contract SpiderManNoWayHomeToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(address(0x4996382B6D23294576935Ee999691C4A0351D7c3)); //marketing wallet
    ...
    constructor() ERC20("SpiderMan No Way Home Token", "SMNWH") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("SPIDER_Dividen_Tracker", "SPIDER_Dividend_Tracker")
    {
        claimWait = 3600;
