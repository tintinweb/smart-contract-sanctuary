...
/**
 * 
⭐️Welcome to the EveryBNB⭐️

🚀$EVERYBNB is the first everyday airdrop reward token on BEP20 network,
airdrops and rewards in BNB everyday.🚀

👌By holding $EVERYBNB in your wallet, you will be automatically rewarded a percentage of the distribution.👌

💎Our unique key feature is everyday airdrops, at every milestone we reach, we will increase these rewards,
so if you hold $EVERYBNB you get passive income from dividends, and get a chance to receive airdrops everyday.💎

🔥only 13% whole tax🔥

✅3% Liquidity
✅4% Marketing Wallet
✅6% Redistributed to holders who hold longer than 2 hours


🏦 Total tokens- 100billions
*/
...
contract EVERYBNB is Context, IERC20, Ownable {
