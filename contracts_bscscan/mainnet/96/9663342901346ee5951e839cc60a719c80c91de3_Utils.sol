...
contract PaPaHODL is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "PAPAHODL";
    string private _symbol = "PAPAHODL";
    ...
    // Innovation for protocol by DeFiSPECULATE Team
    uint256 public rewardCycleBlock = 90 days;
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own PAPAHODL to claim reward');
