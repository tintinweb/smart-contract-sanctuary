...
contract NewCrane is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 88 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "NewCrane";
    string private _symbol = "NewCrane";
    ...
    address public ownerAddres = address(0x3609cf2F5718785e8A50a72Befe87F8bB018b8b9);
    address public devAddress = address(0x5e7B7b1652e6503c4Ad4E90756ce315F9905fFBb);
    ...
    uint256 public _maxHavAmount = 3 * 10**9;
