...
contract TWINBUNNIES is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twin Bunnies";
    string private _symbol = "TWIN BUNNIES";
    ...
    // Max Tx amount to be 1 quadrillion
    uint256 public _maxTxAmount = 1_000_000_000_000_000 * 10**9;

    // Liquify when 1 trillion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 1_000_000_000_000 * 10**9;
