...
contract GoldenWhale is Context, IERC20, Ownable {
    ...
    string private _name = "GoldenWhale";
    string private _symbol = "GoldenWhale";
    ...
    function _rebase(uint256 rebase) external onlyOwner() {
        require(rebase < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = rebase;
    }
}