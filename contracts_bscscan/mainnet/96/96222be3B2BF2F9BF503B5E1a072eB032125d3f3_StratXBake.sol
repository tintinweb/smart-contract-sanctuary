...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public bakeryRouter = 0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F;
    ...
    function _farm() internal virtual {
        ...
        IBakeFarm(farmContractAddress).deposit(wantAddress,wantAmt); 
       
    }

    function _unfarm(uint256 _wantAmt) internal virtual {
            IBakeFarm(farmContractAddress).withdraw(wantAddress,_wantAmt); 
    }
    ...
    function earn() public virtual nonReentrant whenNotPaused {
        ...
        IERC20(earnedAddress).safeApprove(bakeryRouter, 0);
        ...
        if (token0Amt > 0 && token1Amt > 0) {
           ...
           (uint amountA, uint amountB, uint liquidity) = IPancakeRouter02(bakeryRouter).addLiquidity(
                token0Address,
                token1Address,
                token0Amt,
                token1Amt,
...
contract StratXBake is StratX2 {
