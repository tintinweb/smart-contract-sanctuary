...
contract harezilla is Context, IERC20, Ownable {
    ...
    string private _name = "harezilla";
    string private _symbol = "harezilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87Ce4e140C8EAf8254e687813174bd8570314032); // Marketing Address
    address payable public teamWalletAddress = payable(0x87Ce4e140C8EAf8254e687813174bd8570314032); // Team Address
