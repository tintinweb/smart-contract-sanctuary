...
contract APEINU is Context, IERC20, Ownable {
    ...
    uint public _treasuryFee = 3;
    address public treasuryWallet = 0x0759314feCF7Dd433257d12f6C4d9E6d35Fb4927;

    uint256 public _marketingFee = 2;
    address public marketingWallet = 0x055C820AB79b50e4a5f2794A950106df70193379;
    ...
    uint256 public maxWalletToken = 100000000000 * 10**16;
    uint256 public _maxTxAmount = 10000000000 * 10**16;
    ...
    function totalFees() public view returns (uint256) {
     ...
     function setMaxWalletTokend(uint256 _maxToken) external onlyOwner {
  	    maxWalletToken = _maxToken * (10**16);
  	}
    ...
    function setLiquiditFee(uint256 newFee) external onlyOwner() {
        _liquidityFee = newFee;
    }

    function setTaxFee(uint32 newFee) external onlyOwner(){
        _taxFee = newFee;
    }
