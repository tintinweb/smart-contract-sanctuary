...
contract IsekaiTruck is IsekaiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamIsekai;
    address private CharityIsekai;
    ...
    string public override name = "Isekai Truck";
    string public override symbol = "Meta.D";
    ...
    constructor(uint totalSupplyValue, address TeamIsekaiAddress, address CharityIsekaiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamIsekai = TeamIsekaiAddress;
        CharityIsekai = CharityIsekaiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamIsekai] =  totalSupply * 4 / 100;
        balances[CharityIsekai] = totalSupply * 25 / 100;
    ...
    // Get the address of the token's TeamIsekai pot
