...
import "@openzeppelin/contracts-upgradeable/proxy/Initializable.sol";
import "./openzeppelin-custom/ERC777Upgradeable.sol";
...
contract ERC777Upgradeable is Initializable, ContextUpgradeable, IERC777Upgradeable, IERC20Upgradeable {
    ...
    // NOTE The custom address for the registry for Luxochain. This is because their permissioned chain
    // does NOT accept transactions with gas prices, meaning we can't use the "Nick's Method" ERC1820
    // registry deployment unfortunately.
    IERC1820RegistryUpgradeable constant internal _ERC1820_REGISTRY = IERC1820RegistryUpgradeable(0x7F622D81Ef7A5D30Dc38FF12e6978DD5B1450bb1);
