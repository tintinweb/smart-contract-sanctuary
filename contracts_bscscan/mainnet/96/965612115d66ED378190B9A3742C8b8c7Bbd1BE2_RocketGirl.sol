...
/**
* Welcome to RocketGirl
*
* 2% taxes for Liquidity
* 2% reflected to HODLERS
* 4% marketing wallet
* 3% dev wallet for development of the game
*
* Total supply: 10000 billion tokens.
...
contract RocketGirl is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "RGirl";
    uint8 private constant _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 100000 * 10**9 * 10**_decimals;
