...
/**
   ...
   Welcome to ORBITDOGE
   
   This is a community token. If you want to create a telegram I suggest to name it to @ORBITDOGEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ORBITDOGE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ORBITDOGE 10000X? 
...
contract ORBITDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "ORBITDOGE";
    string private _symbol = "ORTDOGE";
