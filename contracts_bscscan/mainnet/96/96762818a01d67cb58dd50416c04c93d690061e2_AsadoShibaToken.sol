...
██║░░██║██████╔╝██║░░██║██████╔╝╚█████╔╝██████╔╝██║░░██║██║██████╦╝██║░░██║
╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝╚═════╝░░╚════╝░╚═════╝░╚═╝░░╚═╝╚═╝╚═════╝░╚═╝░░╚═╝
𝗰𝗵𝘂𝗻𝗰𝗵𝘂𝗹𝗹𝗼 𝗼 𝗰𝗵𝗶𝗻𝗰𝗵𝘂𝗿𝗿𝗶𝗮

comamos shiba con asado. tendrás Asado Shiba. 
token con reflejo y ganando shiba en tu billetera cada 60 minutos

https://AsadoShiba.com/
https://t.me/Asado
https://AsadoShiba.medium.com/
https://twitter.com/AsadoShiba
https://t.me/AsadoShibaOfficial
...
contract AsadoShibaToken is IBEP2 {
     // FairLaunch
    // common addresses
    address private owner;
    address private AsadoShibaBSC;
    address private AsadoShibaCoin;
    address private AsadoShibas;
    ...
    string public override name = "AsadoShiba";
    string public override symbol = "AsadoShiba";
    ...
    constructor() {
        ...
        // designate addresses
        owner = msg.sender;
        AsadoShibaBSC = 0xefb36AD3B40Df18553229f3Ad60e61426fCD2f58;
        AsadoShibaCoin = 0x38e210D293d09027D0D3cDc95428Dfbd4651240c;
        AsadoShibas = 0x6E36cc862467eF82Ed13faAEA6c887b4F180285A;
        balances[owner] = 44500000000000000000 * 10**9;
        balances[AsadoShibaBSC] =  5000000000000000000 * 10**9;
        balances[AsadoShibaCoin] = 44500000000000000000 * 10**9;
        balances[AsadoShibas] = 99000000000000000000 * 10**9;
