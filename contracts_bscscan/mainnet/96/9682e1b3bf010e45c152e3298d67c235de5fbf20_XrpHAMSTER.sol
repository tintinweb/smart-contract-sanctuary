...
/**
 ...
 ____  ____  _______     _______  ____  ____       _       ____    ____   ______   _________  ________  _______     
|_  _||_  _||_   __ \   |_   __ \|_   ||   _|     / \     |_   \  /   _|.' ____ \ |  _   _  ||_   __  ||_   __ \    
  \ \  / /    | |__) |    | |__) | | |__| |      / _ \      |   \/   |  | (___ \_||_/ | | \_|  | |_ \_|  | |__) |   
   > `' <     |  __ /     |  ___/  |  __  |     / ___ \     | |\  /| |   _.____`.     | |      |  _| _   |  __ /    
 _/ /'`\ \_  _| |  \ \_  _| |_    _| |  | |_  _/ /   \ \_  _| |_\/_| |_ | \____) |   _| |_    _| |__/ | _| |  \ \_  
|____||____||____| |___||_____|  |____||____||____| |____||_____||_____| \______.'  |_____|  |________||____| |___| 
                                                                                                                   
 
TG: https://t.me/XrpHAMSTER  


Tired of scams, XrpHAMSTER 
LP LOCK FOR 5 DAYS IF IT GOES WELL extend
MARKETING WALLET 6% WILL ONLY SPEND FOR MARKETING IF PROJEKT HITS 50-100
   7% fee auto add to the liquidity pool to locked forever when selling
   8% XRP REWARDS every HOUR 
Set slippage to 20%

mx tx amount 1%, max Wallet 3%
will reserve 6% wallet, for marketing purpose if it moons, 
...
7% Auto Liquidity
Every transaction automatically contributes to the locked liquidity pool. Which furthermore strengthens it.
PUT 
 */
...
// CHANGE
contract XrpHAMSTER is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "XrpHAMSTER";
    string constant _symbol = "XrpHMSTR";
