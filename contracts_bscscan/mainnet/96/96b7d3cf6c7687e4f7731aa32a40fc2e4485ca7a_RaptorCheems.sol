...
RaptorCheems stealth launch in about 1 hour. Elon tweet Raptor today! Join our hype now. RaptorCheems will grow fast and destroy other cheems!

Each holder gets reflection token, and will continue to increase as the holder holds their token longer.
...
📱Telegram : https://t.me/RaptorCheems
...
contract RaptorCheems is Context, IERC20, Ownable {
    ...
    string private _name = "RaptorCheems";
    string private _symbol = "RaptorCheems";
