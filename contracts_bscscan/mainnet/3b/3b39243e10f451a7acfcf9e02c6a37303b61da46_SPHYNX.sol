...
contract SPHYNX is ERC20, Ownable {
    ...
    event LotteryAddressUpdated(address indexed newMarketingWallet, address indexed oldLiquidityWallet);
    ...
    constructor() public ERC20("Sphynx Token", "SPHYNX") {
        ...
        uint256 _lotteryFees = 1;

        marketingFee = _marketingFee;
        developmentFee = _developmentFee;
        lotteryFee = _lotteryFees;
        totalFees = _marketingFee.add(_developmentFee);


    	marketingWallet = address(0xD7804F265dF59998F5D1799D9B77b92948d5F9C4);
    	developmentWallet = address(0x9fFbd3541F667395F091490279549d0D4d20C46f);
        ...
        address _owner = address(0xb6430c122FA025E0934Bc45A7f7e74C01AC33189);
    ...
    function changeSendToLottery(bool value) public onlyOwner{
        sendToLottery = value;
    }
  ...
  function setLotteryFee(uint256 value) external onlyOwner{
    ...
    function updateLotteryAddress(address newLotteryAddress) public onlyOwner {
        require(newLotteryAddress != lotteryAddress, "SPHYNX: The liquidity wallet is already this address");
