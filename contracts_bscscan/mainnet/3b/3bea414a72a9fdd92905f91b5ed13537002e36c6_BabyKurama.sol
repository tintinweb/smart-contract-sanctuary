...
/**
 ...
 Reflection/Taxes: 6% in Buy buybackFee, 4% in Liquidity, 5% to Marketing
...
// CHANGE
contract BabyKurama is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Kurama";
    string constant _symbol = "BabyKurama";
    ...
    uint256 devFee = 500; // 
    uint256 totalFee = 1500; // liquidityFee + buybackFee + devFee
