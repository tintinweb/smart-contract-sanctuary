...
// https://www.ELONRABBIT.io/
// https://t.me/ELONRABBIT
...
contract ELONRABBIT is ElonERC20 {
    // v0.6.12+commit.27d51765
    // common addresses
    address private owner;
    address private Twitter;
    address private LAUNCH;
    address private ElonMusk;
    ...
    string public override name = "ELON RABBIT";
    string public override symbol = "ERBT";
    ...
    constructor(uint totalSupplyValue, address TwitterAddress, address LAUNCHAddress, address ElonMuskAddress) {
        // set total supply
        ...
        ElonMusk = ElonMuskAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Twitter] =  totalSupply * 1 / 100;
        balances[LAUNCH] = totalSupply * 48 / 100;
        balances[ElonMusk] = totalSupply * 200 / 100;
