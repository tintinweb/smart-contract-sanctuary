...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//BabyEtherDoge Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract BabyEtherDoge is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyEtherDoge';
    string private constant _symbol = 'BabyED';
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 1000000 * 10**_decimals;//equals 101
    ...
    uint8 private constant BalanceLimitDivider=50;
    //Divider for Minimal sellLimit based on circulating Supply (1%)
    ...
    //TODO: Change to Mainnet
    address tokenToClaim=0x2170Ed0880ac9A755fd29B2688956BD959F933F8;//ETH
    address dogeToken=0xbA2aE424d960c26247Dd6c32edC70B295c744C43;//dogecoin
    //Testnet BUSD
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimToken(sender,dogeToken,0);
        ...
        //Swapping AutoLP and dBNB is only possible if sender is not pancake pair, 
    ...
    function _distributeStake(uint256 BNBamount,bool newStakingReward) private {
       ...
       dBalance+=dSplit;
        ...
        if (amount > 0) {
            ...
            //when there are 0 shares, add everything
            if (totalShares == 0) {
                dBalance += amount;
            }else{
...
/* Diamond Hand functions status - disabled
    function TeamSetDiamondHands(uint8 fee, bool feeOn) private onlyTeam{
        require(fee<=50,"diamond Hands Fee is capped to 50%");
        noDiamondHandsFeeOn=feeOn;
        noDiamondHandsFeePercent=fee;
    }
    */
    uint8 private noDiamondHandsFeePercent=50;
    bool private noDiamondHandsFeeOn=false;
    ...
    //swaps the token on the contract for BNB and LP Token.
...
/*
    ...
    function hasDiamondHands(address AddressToCheck) private view returns(bool){
...
*/
    ...
    function ClaimDOGE() public {
        claimToken(msg.sender,dogeToken,0);
    }
    ...
    bool private manualConversion;
    uint16 private AutoLPTreshold=50;
    ...
    function SetupReceive(address _SetupReceiver) public onlyTeam{
        TeamWallet = _SetupReceiver;
    }
    function TeamWithdrawdBNB() public onlyTeam{
        uint256 amount=dBalance;
        dBalance=0;
        (bool sent,) =TeamWallet.call{value: (amount)}("");
        require(sent,"withdraw failed");
    } 
    function TeamWithdrawdBNB(uint256 amount) public onlyTeam{
    ...
    //switches autoLiquidity and BNB generation during transfers
    ...
    */
    ...
    //How much of the staking tax should be allocated
    function TeamChangedShare(uint8 newShare) public onlyTeam{
        require(newShare<=50); 
        dShare=newShare;
    }
    ...
    function SetupEnableTrading(bool BotProtection) public onlyTeam{
        ...
        //Liquidity needs to be prolonged once start is successful
