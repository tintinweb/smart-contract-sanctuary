...
/*
    from "shibatokyo" token developer (164x)
    "BlueFloki" is our new token with a better system and marketing plan.
    prepare yourself to hit 100x or more!
     3% Liquidity 
     3% Marketing
     6% Anti dump system
               
    TG : https://t.me/BlueFloki
...
contract BlueFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BlueFloki";
    string constant _symbol = "BlueFloki";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1D22816243f1EDc32CeA9cC0D08019BC312C0594;
