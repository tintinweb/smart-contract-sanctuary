...
XcardanoX is a stealth driven token. What stealth driven means ? It means you will have to gain trust in shadows. No groups are made for this token.

The marketing wallet will be used for buyback and promotions, if you all stick together.


I will be monitoring everything closely and IF you hold a bit longer and don't jeet as soon as you hit x2 on your 12 bucks,I WILL EXTEND THE LOCK PERIOD AND REVEAL THE FACE BEHING THIS!


This is the last chance I'm giving to BSC. Prove me wrong - we can do a solid token.


If someone has interest in doing so, create a TG, ride it, share it in comments here, create a logo and lead this to glory.
__________________________________________________________________________________________________________________________________________________________________________________________
...
/**
 ...
 Reflection/Taxes: 6% in ADA, 3% in Liquidity, 4% to Marketing
...
// CHANGE
contract XcardanoX is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "XcardanoX [I have no master]";
    string constant _symbol = "XcX";
    ...
    uint256 totalFee = 1300; // liquidityFee + buybackFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xE92CcCE724f4F08657d870113f685236c0860d5a);
