...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6ac12097CaBCeb4850e98b62Dcd0A15Ae9019C2f); // Marketing Address
    address payable public devAddress = payable(0x2DA5fF31abd7Ac4744BeE3AEb130c00E8e9F59f7); // Dev Address
...
contract BITCOINECO is ERC1363, TokenRecover {
    constructor ()
        ERC1363("BITCOINECO.NET", "$BITCOINECO")
    {
    }
}