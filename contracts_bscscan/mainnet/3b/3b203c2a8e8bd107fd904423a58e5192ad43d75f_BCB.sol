...
5% rewards Fees in BUSD - directly auto claimed into your wallet just by holding your favourit BABYCHEEMSBILLIONAIRE !
5% to marketing and 5% to liquidity pool.
Diamond hands will be rewarded !!

Official Telegram group : https://t.me/BABYCHEEMSBILLIONAIRE

Website: www.babycheemsbillionaire.com
Twitter: https://twitter.com/babycheemsbil1
...
contract BCB is ERC20, Ownable {
    ...
    BCBDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("BABYCHEEMSBILLIONAIRE", "BCB") {

    	dividendTracker = new BCBDividendTracker();

        _marketingWalletAddress = 0x3B930c8c05286d52529f28905d78ED265f891C2a;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BCB: The dividend tracker already has that address");

        BCBDividendTracker newDividendTracker = BCBDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BCB: The new dividend tracker must be owned by the BCB token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BCB: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BCB: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BCB: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BCB: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BCB: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BCB: Cannot update gasForProcessing to same value");
