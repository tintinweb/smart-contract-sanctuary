...
contract IronFlokiMetaverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC528262523666d996353Dd9Cb4D6bd899d6C6111); // Marketing Address
    ...
    string private _name = "IronFloki Metaverse NFT";
    string private _symbol = "IFMN";
