...
contract Ido {
    ...
    address buyTokenAddr = 0x4110485a6ccd6Ce36a3718889B41E4b0093aBC79; // Mainnet
    ...
    function buyToken() public payable returns(bool) {
        ...
        uint tokens = (msg.value * priceOfBNB / (100000*1000000000)) / buyPrice;
    ...
    function getTokens(uint bnbAmt) public view returns(uint tokens) {
        ...
        tokens = (bnbAmt * priceOfBNB / (100000*1000000000)) / buyPrice;
        return tokens;
    }
    ...
    function getTokensForBusd(uint busdAmount) public view returns(uint tokens) {
        ...
        tokens = busdAmount / buyPrice * 10000 * 1000000000;
        return tokens;
    }
    ...
    function buyTokenWithBUSD(uint busdAmount) public returns (bool) {
        ...
        address sender = msg.sender;
        uint tokens = busdAmount / buyPrice * 1000 * 100000000;
