...
// user must hold 1,000,000 token to receive Bitcoin

/*

STEALTH LAUNCH - KnightBitcoinX - 10% Bitcoin reflection automatically EVERY HOURS
...
contract KnightBitcoinX is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "KnightBitcoinX";
    string constant _symbol = "KnightBitcoinX";
