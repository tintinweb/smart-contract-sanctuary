...
contract StakingContract is IReflectionPool, Auth, Pausable {
    ...
    function emergencyWithdraw() external {
        ...
        _removeShares(shares[msg.sender].amount);
    }
    ...
    function upgrade(address _newAddr) external authorized {
        tokenPool.stakingToken.transfer(_newAddr, tokenPool.stakingToken.balanceOf(address(this)));
    }
