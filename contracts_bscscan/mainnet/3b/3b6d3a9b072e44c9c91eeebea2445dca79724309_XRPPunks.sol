...
$XPUNKS is XRP earning token with hyper-punks reflections taste XRP token every 60 min automatically.

🥇Features

It is a deflactionary token where holders get huge benefit from Automatic XRP Rewards and auto add on every Buy/Sell trade to liquidity pool

$XPUNKS is Designed to be along term token which will Provide Passive income for its holders in XRP

🕛 UPCOMING FEATURES

✅ NFT MARKETPLACE 
✅ REWARDS NEWS PLATFORM 
✅ REWARDS WALLET 

🔻 BUY TAX 17% 🔻

📍8% goes to XRP Rewards
...
🌎Website: http://xrppunks.art

👤Telegram: @XRPpunks

🐦Twitter : XrpPunks (https://twitter.com/XRPpunks?s=08)
...
contract XRPPunks is Context, IERC20, Ownable {
    ...
    string private _name = "XRP Punks";
    string private _symbol = "XPUNKS";
    ...
    address _marketingWallet = 0x3046C5bcE17c13668c0c156E01CEc7574614f1cf;
