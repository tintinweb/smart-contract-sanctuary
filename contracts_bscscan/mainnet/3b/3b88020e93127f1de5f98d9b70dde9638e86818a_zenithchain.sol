...
ZenithChain is a digital peer to peer network that aims to implement a use case specific blockchain, 
designed to efficiently handle one single function: the transfer of assets from one party to another

https://www.zenithchain.co/
EMAIL : [email protected]
https://github.com/jezenith/
...
contract zenithchain is Context, IBEPMEME, Ownable {
    ...
    string private _name = 'zenithchain.co';
