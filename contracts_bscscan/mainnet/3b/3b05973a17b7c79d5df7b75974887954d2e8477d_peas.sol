...
contract peas is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9902cb2a55A178bC68c5a32490bab4F94D633Ad2); // Marketing Address
    ...
    string private _name = "Peas";
    string private _symbol = "Peas";
    ...
    uint256 public marketingDivisor = 99;
    ...
    uint256 public _buyBackDivisor = 99;
    ...
    function setdeadAddress(address _deadAddress) external onlyOwner {
        deadAddress = payable(_deadAddress);
    }
