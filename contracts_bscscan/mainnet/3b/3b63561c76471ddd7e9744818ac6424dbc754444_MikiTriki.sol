...
contract MikiTriki is TaxableToken{
    function MikiTriki(uint256 supply, uint256 _minimunFee, uint8 _percentage,string _name,string _symbol,uint8 _decimals) public{
