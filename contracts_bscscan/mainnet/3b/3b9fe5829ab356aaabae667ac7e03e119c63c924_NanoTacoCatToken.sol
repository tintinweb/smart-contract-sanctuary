...
contract NanoTacoCatToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _tokenLock(address account, uint256 amount) internal virtual {
    ...
    function tokenLock(uint256 amount) public onlyOwner virtual returns (bool) {
