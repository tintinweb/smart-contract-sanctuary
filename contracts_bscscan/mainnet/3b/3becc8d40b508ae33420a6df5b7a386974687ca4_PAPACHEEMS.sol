...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x840937450edb09459A1978eCD07850cB4dE239D4; 
...
contract PAPACHEEMS is Context, IERC20, Ownable {
    ...
    address payable private Wallet_Dev = payable(0x840937450edb09459A1978eCD07850cB4dE239D4); 
    ...
    string private _symbol = "PAPACHEEMS";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 100000000 * 10**6 * 10**9; 
    ...
    //Bringeth much gilt'd pleasure upon King Steven of LIGMA INU - Set the dev wallet fee
    ...
    //Setteth thy p'rmit'd LIGMA INU holder p'rcent of thine realms splend'r - Set max wallet as a percent of total
    ...
    function precDiv(uint a, uint b, uint precision) internal pure returns ( uint) {
     ...
     function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       uint256 __tokensToPromo = 0;
        ...
        //Sendeth wage to King NUTZ of LIGMA INU foreth promotion of Splend'r! - Send BNB to dev wallet for marketing and development 
    ...
    //Purge thy LIGMA INU frometh thy abode - Process tokens on contract into BNB and send to wallet
    ...
    //Transfereth of thy LIGMA INU - Transfer functions
