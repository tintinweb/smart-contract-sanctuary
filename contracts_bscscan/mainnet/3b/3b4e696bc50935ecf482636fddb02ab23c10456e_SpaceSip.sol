...
contract SpaceSip is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x05715c5f8dd2723C4b06207041f364aA163145A5); // Marketing Address
    ...
    string private _name = "Space SIP";
    ...
    uint256 private _sellTaxFee = 100;
    ...
    uint256 public _maxTxAmount = 8000000000 * 10**6 * 10**9;
