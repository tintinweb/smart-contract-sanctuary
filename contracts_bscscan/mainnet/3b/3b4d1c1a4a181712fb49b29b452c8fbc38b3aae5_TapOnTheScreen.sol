...
/**
   ...
   I make this #TapOnTheScreen to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/TapOnTheScreenBSCTokenReal
   ...
   I will renounce the ownership to burn addresses to transfer #TapOnTheScreen to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #TapOnTheScreen 1000X? 
   ...
   it's the best part of the #TapOnTheScreen idea, increasing the liquidity pool automatically, 
...
contract TapOnTheScreen
 is Context, IERC20, Ownable {
    ...
    string private _name = "Tap On The Screen";
