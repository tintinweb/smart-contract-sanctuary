...
contract ReflectionToken is IERC20 {
    ...
    string constant _name = "VenomCake";
    string constant _symbol = "VENOMCAKE";
    ...
    address payable private _marketingWallet = payable(0x32C793f15404B47D4cdfB297e57A150dc1C223b3);
