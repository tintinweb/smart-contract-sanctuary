...
/**
 Welcome to RedBull Token
 
   Telegram: https://t.me/RedBullTokenBSC
   ...
   I will renounce the ownership to burn addresses to transfer #RedBullToken to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make RedBull Token 100X? 
   ...
   it's the best part of the #RedBullToken idea, increasing the liquidity pool automatically, 
...
contract RedBullToken is BEP20 {
