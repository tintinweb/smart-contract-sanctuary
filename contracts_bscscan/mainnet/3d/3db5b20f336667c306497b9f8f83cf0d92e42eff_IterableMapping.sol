...
/**
     Tg: https://t.me/BUSDdealer  
     
     Max Buy : 4%
     
     Max Wallet : 5%
     
     Join The Tg , Stealth Launch
     
     Marketing Once Community Is Behind using
...
contract BUSDdealer is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   BUSDdealerDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("BUSDdealer", "BUSDdealer") {
        _ETHRewardsFee = 5;
        _liquidityFee = 5;
		_marketingFee = 10;
        ...
        _maxWalletToken = 5000000000 * (10**18); // 2% of total supply


    	dividendTracker = new BUSDdealerDividendTracker();
    	antiBotEnabled = true;

    	liquidityWallet = owner();
		
		bulkSender = payable(0xA9fbe7F0BFE39454715BFa16fF761F5B620D8151);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BUSDdealer: The dividend tracker already has that address");

        BUSDdealerDividendTracker newDividendTracker = BUSDdealerDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BUSDdealer: The new dividend tracker must be owned by the BUSDdealer token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BUSDdealer: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BUSDdealer: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BUSDdealer: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BUSDdealer: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BUSDdealer: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BUSDdealer: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BUSDdealer: Cannot update gasForProcessing to same value");
    ...
    function swapTokensForBUSD(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of BUSDdealer
            path,
            recipient,
            block.timestamp
        );
...
contract BUSDdealerDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("BUSDdealer_Dividend_Tracker", "BUSDdealer_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "BUSDdealer_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "BUSDdealer_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BUSDdealer contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "BUSDdealer_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BUSDdealer_Dividend_Tracker: Cannot update claimWait to same value");
