...
/**
    ...
    I make this #HMoon to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/harmonymoonbsc

   Two token features:
   3% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   70% burn to the black hole, with such big black hole and 2% fee, the strong holder will get a valuable reward

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #HMoon to the community, make sure it's 100% safe.

   I will add 0.25 BNB and all the left 30% total supply to the pool
   Can you make #HMoon 100000X? 
   
  100% SAFE NO RUG.

   100,000,000,000,000,000 total supply
   500,000,000,000,000 HMoon max limit for per trade
   ...
   it's the best part of the #HMoon idea, increasing the liquidity pool automatically, 
...
contract HarmonyMoon is Context, IERC20, Ownable {
    ...
    string private _name = "HarmonyMoon";
