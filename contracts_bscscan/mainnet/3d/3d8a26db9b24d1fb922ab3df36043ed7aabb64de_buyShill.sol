...
contract buyShill is Ownable {
    using SafeMath for uint;

    address public tokenAddr;
    
    uint256 public tokenPriceBnb = 167000000000; 
    ...
    uint256 public maxContribution = 2e25;
    uint256 public hardCap = 75e19;
    uint256 public levelPercentage = 5;
    ...
    function ExchangeBNBforToken(address _addr, uint256 _amount) private {
        ...
        totalHardCap = totalHardCap.add(_amount);
    ...
    function ExchangeBNBforTokenMannual(address _refAdd) public payable {
        ...
        uint256 refAmount = (bnbAmount * levelPercentage)/levelDivisor;
        tokenExchanged[_refAdd] += refAmount;
        refEarned[_refAdd] += refAmount;
        referralCount[_refAdd] = referralCount[_refAdd]+1;
