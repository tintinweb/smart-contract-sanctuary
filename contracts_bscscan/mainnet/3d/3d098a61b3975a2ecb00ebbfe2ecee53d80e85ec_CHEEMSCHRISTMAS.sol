...
contract CHEEMSCHRISTMAS is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CHEEMSCHRISTMAS ", "CHEEMSCHRISTMAS") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CHEEMSCHRISTMAS";
    string private _symbol = "CHEEMSCHRISTMAS";
