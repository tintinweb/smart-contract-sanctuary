...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @LokiDogeCommunity
...
contract AutoBNBLoki is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'LokiDoge';
    string  private constant _SYMBOL = 'LOKIDOGE';
