...
contract TestBull is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x945457B11D5fCF43764c31fFdb3A935480A95D27); // Marketing Address
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(marketingAddress, transferredBalance.mul(50).div(100));
