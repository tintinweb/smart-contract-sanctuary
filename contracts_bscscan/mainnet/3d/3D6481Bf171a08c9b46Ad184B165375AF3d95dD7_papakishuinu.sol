...
contract papakishuinu is Context, IERC20, Ownable {
    ...
    string private _name = "papa kishu inu";
    string private _symbol = "papakishuinu";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000000000000 * 10 **12;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //don't take burnFee
        if(balanceOf(address(0)) < 100000000000000 * 10**9){
