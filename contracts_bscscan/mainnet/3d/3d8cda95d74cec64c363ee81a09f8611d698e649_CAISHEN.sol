...
contract Ownable is Context {
    address private _owner = 0x123452D9bD820a4cD6538a8b6aB377362979CC0d;
...
contract CAISHEN is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x5D32223461d7E383D8f3f119584B5849113D6E59); // Marketing Address
    address payable public _burnAddress = payable(0x5D32223461d7E383D8f3f119584B5849113D6E59); // Burn Address

    string private _name = "\u8d22\u795e"; // token name
    string private _symbol = "\u8d22\u795e"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 20 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
