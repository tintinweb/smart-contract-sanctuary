...
contract MiniDOGES is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1A6a406fACfbCcDA751CA17F9b34Bc80093f3daD); // Marketing Address
    ...
    string private _name = "MiniDOGES";
    string private _symbol = "MiniDOGES";
