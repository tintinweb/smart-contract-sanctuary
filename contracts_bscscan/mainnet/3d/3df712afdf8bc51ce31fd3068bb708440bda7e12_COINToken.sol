...
contract COINDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("COIN_Dividend_Tracker", "COIN_Dividend_Tracker", 9) {
    	claimWait = 14400;
...
contract COINToken is BEP20, Ownable {
    ...
    address public marketingWallet = 0x314d70DC70B1A5937aC4abc1f5db6a65214232Fc;
    ...
    constructor() public BEP20("COIN", "COIN", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "COIN: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "COIN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "COIN: The liquidity wallet is already this address");
