...
/**
FREE BUSD
Auto Claim to Your Personal Address after 1 Hours, try and proof it 


   This is a community token. Telegrams @FREE BUSD  Important: The early you create a group that shares the token, the more gain you got.
...
🔥VERIFIED CONTRACT
🔥LP LOCKED
🔥RENOUNCE OWNERSHIP AFTER VERIFIED CONTRACT
🔥TOTAL SUPPLY 1,000,000,000,000,000 FREE BUSD
🔥BURN SUPPLY 90% FREE BUSD
🔥NO DEV TOKEN
   
   Great features:
   5% fee auto add to the liquidity pool to locked forever when selling
   5% fee auto distribute to all holders
   I will lock liquidity .
   I will renounce the ownership #FREE BUSD to the community, make sure it's 100% safe.

   I will add .5 BNB.
   Can you make #FREE BUSD 10,000 X? 
   ...
   it's the best part of the #FREE BUSD idea, increasing the liquidity pool automatically, 
...
contract FREE_BUSD_AUTO_CLAIM is Context, IERC20, Ownable {
    ...
    string private _name = "FREE BUSD";
    string private _symbol = "FREE BUSD";
