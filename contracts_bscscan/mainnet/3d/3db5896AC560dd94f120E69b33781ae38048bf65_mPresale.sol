...
contract OwnerContract {
   address payable public _owner;
    ...
    function _setOwner(address payable newOwner) private {
     ...
     function transferOwnership(address payable newOwner) public onlyOwner {//And this one allows the ownership transfer of this contract
...
contract MCrowdsale is ReentrancyGuard, OwnerContract {
    ...
    function getBNBIncontract(address payable newAddress) public onlyOwner{ //This function allows to transfer any bnb sent to contract to any address in case you need it
