...
contract LoveMySelf is Context, IERC20, Ownable {
    ...
    string private _name = "LoveMySelf";
    string private _symbol = "LSELF";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x116cAd526f04dbbf724E803D4F6E217Ce9a6E808);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 200 * 10**9 * 10**_decimals;
        _maxBalance = 5000 * 10**9 * 10**_decimals;
