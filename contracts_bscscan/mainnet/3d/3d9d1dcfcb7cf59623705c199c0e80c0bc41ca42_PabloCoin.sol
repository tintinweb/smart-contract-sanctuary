...
$PabloCoin is a BNB reflection token inspired by the legend of Pablo Escobar.

Our unique auto-claim feature will add every 60 minutes some BNB token to your wallet.
BNB is the utility token of Binance one of the leading crypto exchange in the world.

All you need to do to receive hourly passive income in BNB is to hold $PabloCoin tokens. Your rewards will be sent automatically to your wallet.

✓ Liquidity Locked: 100% - Unlock Date : 6 months
🔹 Initial liquidity : 10.000$
🔹 Total supply : 100.000.000.000 
🔹 Launch price : 0.00000001

Transaction Fees :
✓ Buy & Sell Tax: 15%
✓ 7% is used to purchase BNB which is automatically paid out in dividends to holders
✓ 4% is split between the buy back mechanism and the team/marketing fund. Marketing Fund which is 2% can be used in extreme circumstances to correct market volatility.
✓ 4% is allocated to the locked liquidy pool 
...
contract PabloCoin is Context, IERC20, Ownable {
    ...
    string private _symbol = "PabloCoin";
    ...
    address _marketingWallet = 0xd7e7abf128c25961017aE5C4ffdc4e815E41afdB;
