...
contract sanyue is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "sanyue";
    string private _symbol = "sanyue";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x320d6708862467aFB9f33a68CA5aBcA640DC3b1D); // Marketing Address
    address payable public teamWalletAddress = payable(0x320d6708862467aFB9f33a68CA5aBcA640DC3b1D); // Team Address
