...
contract CandleGenieGreenLight is Ownable, Pausable, ReentrancyGuard 
{
    ...
    event RoundEnded(uint256 indexed epoch, uint32 timestamp, address winner1stAddress, address winner2ndAddress, address winner3rdAddress);
    ...
    function _safeEndRound(uint256 epoch, uint32 timestamp, address winner1stAddress, address winner2ndAddress, address winner3rdAddress) internal 
    {
        ...
        emit RoundEnded(epoch, timestamp, winner1stAddress, winner2ndAddress, winner3rdAddress);
    }
