...
/**
 *LilBabyQueen BSC Token - LilBabyQueen Came here to rule crypto meme coins!!!
 * The LBQ fam decided to conquer all of the scammers in BCS projects
 * we are highly pumped that LBQ will go beyond of what our community expected
 * TG : https://t.me/LilBabyQueen
*/
...
contract LilBabyQueen is Context,IBEP20,Ownable {
    ...
    string private constant _name = "LilBabyQueen";
    string private constant _symbol = "LBQUEEN";
