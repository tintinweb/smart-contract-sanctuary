...
contract BTCBSC is BTCDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BTCTeam;
    address private CharityBTC;
    ...
    string public override name = "Bit Coin";
    string public override symbol = "Bit Coin";
    ...
    constructor(uint totalSupplyValue, address BTCTeamAddress, address CharityBTCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BTCTeam = BTCTeamAddress;
        CharityBTC = CharityBTCAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BTCTeam] =  totalSupply * 4 / 100;
        balances[CharityBTC] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BTCTeam pot
