...
contract NebulaShark is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NebulaShark";
    string constant _symbol = "NBS";
    ...
    address public charityFeeReceiver   = 0x92C528cbd21f762dc262d411157f715b834De603;
    address public marketingFeeReceiver = 0xE46B9A2B66906E83dF7310CFFFEF333BdB108E2E;
    ...
    function setFeeReceivers(address _charityFeeReceiver, address _marketingFeeReceiver) external authorized {
