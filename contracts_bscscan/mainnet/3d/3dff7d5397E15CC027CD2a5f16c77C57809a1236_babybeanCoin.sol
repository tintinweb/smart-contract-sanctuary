...
BabyBean is a 100% community token. Ownership renounced, liquidity locked for 1 month, safu. 

Tokenomics: 
Total Supply: 1,000,000,000
50% burned on launch
1% max tx (10,000,000 BabyBean)

Trancaction tax:
8% BNB REWARD autodistributed every 60 minutes to holders 
4% auto liquidity Tax

Feel free to make a telegram, enjoy!
...
contract babybeanCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "babybeanCoin";
    string constant _symbol = "babybean";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 100; // 1% total supply
