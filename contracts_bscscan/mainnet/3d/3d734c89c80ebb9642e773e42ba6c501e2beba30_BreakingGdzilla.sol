...
// CHANGE
contract BreakingGdzilla is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BreakingGdzilla";
    string constant _symbol = "BrZ";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x081aAe9e9D232754E133AaBd234Ff62A6A02B764);
