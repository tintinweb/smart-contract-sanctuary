...
contract Bullfight is ERC20, Ownable {
    ...
    uint256 public totalFees = USDTRewardsFee.add(liquidityFee).add(devFee);
    ...
    constructor() public ERC20("Bullfight", "Bullfight") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Bullfight: The dividend tracker already has that address");

        BullfightDividendTracker newDividendTracker = BullfightDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Bullfight: The new dividend tracker must be owned by the Bullfight token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Bullfight: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Bullfight: Account is already the value of 'excluded'");
    ...
    function setUSDTRewardsFee(uint256 value) external onlyOwner{
        ...
        totalFees = USDTRewardsFee.add(liquidityFee).add(devFee);
    }
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Bullfight: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Bullfight: gasForProcessing must be between 200,000 and 500,000");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 marketingTokens = contractTokenBalance.mul(devFee).div(totalFees);
...
contract BullfightDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("Bullfight_Dividen_Tracker", "Bullfight_Dividend_Tracker") {
    	claimWait = 60;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Bullfight_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
