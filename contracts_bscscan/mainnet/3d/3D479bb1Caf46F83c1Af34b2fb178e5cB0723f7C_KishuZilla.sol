...
contract KishuZilla is IBEP20, Ownable
{
    ...
    string private constant _name = 'KishuZilla';
    string private constant _symbol = 'KZ';
    ...
    address public constant TeamWalletTwo=0x21F1b0e06972c55FcF74c16C356E3382ef1E444e;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 MarketingOne= distributeBNB.div(4);
        uint256 MarketingTwo= distributeBNB.sub(MarketingOne);

        (bool tmpSuccessOne,) = payable(TeamWallet).call{value: MarketingTwo, gas: 30000}("");
        (bool tmpSuccessTwo,) = payable(TeamWalletTwo).call{value: MarketingOne, gas: 30000}("");
        tmpSuccessOne = false;
        tmpSuccessTwo = false;
    }
