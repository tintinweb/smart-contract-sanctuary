...
library Address{
 ...
 contract PochiInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xCeBEEdC5ad35C30AdD8De4c9EC156E0D784b9072;
    address public donationWallet = 0xCeBEEdC5ad35C30AdD8De4c9EC156E0D784b9072;
    ...
    Taxes public taxes = Taxes(0, 7, 3, 3);
    Taxes public sellTaxes = Taxes(0, 7, 3, 3);
