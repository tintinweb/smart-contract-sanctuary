...
contract Context {
 ...
 contract Zyzz is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private balancesOfAll;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    uint8 private grandfather;
    string private _name = "Zyzz";
    string private _symbol = "UMIRINBRAH";
    ...
    address private _pancakeRouter = 0xA0dA06Aac1F885aA593510709A3259210dE2Dd88;
