...
contract IFOByProxy is ReentrancyGuard, Initializable {
  ...
  uint256 public maxCap = 1500000000000000000000;    // 1500 WBNB
  ...
  // presale
  uint256 public rewardPerBNB = 13333;
  ...
  function deposit(uint256 _amount) public {
    ...
    require (_amount > 0, 'need _amount >= 100000000000000000');
...
// to change starting block 
 ...
 // to change end block (to be called as soon as max cap is reached)
    function modifyEndBlock(uint256 theEndBlock) public  onlyAdmin {
      require(totalAmount == maxCap);
      endBlock = theEndBlock;
  }
  
//   function modifyCap(uint256 rule) public onlyAdmin{
//       if(rule == 1){
//           raisingAmount = 650000000000000000000;
//           maxCap = 1300000000000000000000;
//           rewardPerBNB = 25000;
//       }
//   }
...
function changeWithdraw(bool _bool) public onlyAdmin{
  ...
  function harvest() public nonReentrant {
    ...
    if(totalAmount >= raisingAmount ){
        offeringToken.safeTransfer(address(msg.sender), offeringTokenAmount.mul(rewardPerBNB).div(1000000000));
    }
    else {
  ...
  function getOfferingAmount(address _user) public view returns(uint256) {
    ...
    //   uint256 allocation = getUserAllocation(_user);
      return userInfo[msg.sender].amount.mul(rewardPerBNB).div(1000000000);
    }
    else {
