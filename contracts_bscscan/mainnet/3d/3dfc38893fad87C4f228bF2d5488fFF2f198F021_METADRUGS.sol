...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1e198219C760f921f97CaF523dDf4Ee1DED71643;
...
contract METADRUGS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6C672Da0D359B302450BC8f81692381B46cE6b10;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Drugs";
    string private _symbol = "DRUGS";
