...
/**
LOVEDOGE – NEW REWARDS token that GIVES you $DOGE with big % dividend for every transaction!

A new token has been made, to reward holders!
Big big big rewards, one of the biggest around now.


Tokenomics :
 10% $DOGE Reflection Rewards
 5% Liquid Pool Tax Upon Sells
 3% Marketing Tax

 
Telegram : https://t.me/BscLoveDoge
...
contract LoveDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LoveDoge";
    string constant _symbol = "LoveDoge";
