...
/**
 *Submitted for verification at BscScan.com on 2021-10-2
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = 'BEI TOKEN';
    string private constant _symbol = 'BETK';

    uint256 private _taxFee = 100;
    uint256 private _burnFee = 100;
    uint private _max_tx_size = 5000000 * 10 ** uint256(_decimals);
