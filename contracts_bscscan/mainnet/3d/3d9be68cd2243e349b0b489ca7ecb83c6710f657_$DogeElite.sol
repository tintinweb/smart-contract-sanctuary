...
contract $DogeElite is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xBFafDdeB1617573872fa88678b9908744219134a); // Marketing Address
    ...
    string private _name = "$DogeElite";
    string private _symbol = "DGEE";
    ...
    uint256 public _maxTxAmount = 10000000 * 10**6 * 10**10; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = 200000 * 10**6 * 10**10; 
