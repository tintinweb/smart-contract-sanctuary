...
🎖 HOLD $NFTT AND EARN BNB ! IF YOU ARE HOLDING NFT TOKEN, YOU AUTOMATICALY WIN ! 🎖

🥏 NFT TECHNOLOGY ; We bring "NFT Technology" to the blockchain technology. 🥏

🎫* WHAT IS $NFTT ? *🎫

$NFTT NFT stands for non-fungible token. It’s generally built using the same kind of programming as cryptocurrency, like Bitcoin or Ethereum, but that’s where the similarity ends.
...
🌍 Website: www.nfttokenofficial.space
🗺 Telegram: https://t.me/BSCNFTTOKENOFFICIAL
💌 Twitter: https://twitter.com/nfttokenbsc

💸 %15 BNB REWARDS IN EVERY HOURS UNTILL YOU HOLD AND SUPPORT NFT TOKEN !

Anti whale and snipe mechanism included. We guarantee the future of the token !
...
4% for the NFT TOKEN
Pooled(Liquidity): 76%
15% BNB Reward all transactions
...
contract NFTTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "NFT TOKEN";
    string private _symbol = "NFTT";
    uint256 private _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 3;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _toHolder = 15;
    ...
    address _marketingWallet = 0x58eBb95Ffa7b42A575Ee2D07e977BCabdDF6FaDb;
