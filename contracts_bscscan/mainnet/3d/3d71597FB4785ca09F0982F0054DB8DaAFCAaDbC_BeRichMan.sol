...
contract BeRichMan is Context, IERC20, Ownable {
    ...
    string private _name = "Be Rich Man";
    string private _symbol = "BeRichMan";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2; // 2% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 7; // 7% added to liquidity 
