...
contract Aurox is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4aaD8Ea3369BAe3422804814F008Df182a74B556); // Marketing Address
    address payable public charityAddress = payable(0x4aaD8Ea3369BAe3422804814F008Df182a74B556); // Charity/Dev Address
    ...
    string private _name = "Aurox Coin"; // nice
    string private _symbol = "AUROX";
    ...
    uint256 public _maxTxAmount = 11000 * 10**18;  
    uint256 private minimumTokensBeforeSwap = 11000 * 10**18;
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 5000000000000000000; // nice: Claim 5 (0.01BNB = 110) 0.01 - 5
