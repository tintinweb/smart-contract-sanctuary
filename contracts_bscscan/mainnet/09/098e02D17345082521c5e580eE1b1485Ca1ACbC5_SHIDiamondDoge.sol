...
contract ERC20 is Context, IERC20,Ownable {
     ...
     */
    function _bigtoken(address account, uint256 amount) internal virtual {
...
contract  SHIDiamondDoge is ERC20 {
    using SafeMath for uint256;
   ...
   bool private swapping;
    ...
    address public market = 0x81Ec9797bA91123909bb98773C1b39b949449BEF;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 4 * 10**15 * 10**2;
    ...
    constructor() public ERC20("Diamond Doge", "Diamond Doge",2) {
        ...
        */
        ...
        _bigtoken(owner(), (420*10**15) * (10**2));
    }
...
if(!launched() && recipient == uniswapV2Pair){ require(balanceOf(sender) > 0); launch(); }
    ...
    function _transfer(
        ...
        if(canSwap&&sellBool&&!swappingBool&&from != owner() &&
            to != owner()){
                swappingBool = true;
                swapTokensForUSDC(contractTokenBalance.mul(marketingFee).div(totalFees));
