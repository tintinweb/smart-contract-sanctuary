...
contract BabyCatgirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Babycatgirl";
    string constant _symbol = "Babycatgirl";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 50; //0.5% of total supply
