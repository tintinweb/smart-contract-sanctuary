...
contract LostMonument is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress = payable(0x00d050Bf90771dB95ee3B9A352e5F57B5576AcFA); // buyback
    ...
    string private _name = "LostMonument";
    string private _symbol = "LostMonument";
