...
contract BTCEarn is ERC20, Ownable {
    ...
    address public immutable _dividendToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    ...
    constructor() ERC20("BTCEarn", "BTCEARN") {
    	...
    	buyBackWallet = 0xe6a7BA382b916cf1DD526A69a85c097BC8881cA9;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "BtcEarn: The new dividend tracker must be owned by the FLOKIBUSD token contract");
...
contract BtcEarnDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BtcEarn_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
