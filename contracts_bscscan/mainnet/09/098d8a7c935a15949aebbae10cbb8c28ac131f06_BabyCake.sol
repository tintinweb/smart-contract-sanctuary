...
// File: contracts/BabyCakeDividendPayingToken.sol
...
contract BabyCake is ERC20, Ownable {
    ...
    address public immutable CAKEToken = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
	address payable public marketingAddress = payable(0xd58494fc03e34D5696631a6Ed2960e8f9b5f9532);
	...
	// BuyBack Enabled split to MarketingFee
    ...
    constructor() ERC20("BabyCake", "BabyCake") {
        uint256 _CAKERewards = 7;
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BabyCake: The liquidity wallet is already this address");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "BabyCake: This account cannot send tokens until trading is enabled");
        }
...
contract BabyCakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BabyCake_Dividend_Tracker", "BabyCake_Dividend_Tracker") {
        claimWait = 3600;
