...
contract Zilla2K22 is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxBalance = 50000000000000 * 10**_decimals;
    ...
    function setMaxBalance(uint256 newMaxBalance) external onlyOwner {
        // Minimum _maxBalance is 5% of _totalSupply
