...
contract StratX_biswap is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant receiveFee =
        address(0x80a2b7224dE83222010E403EbF842799487A7aCE); //aries
        
    address public constant fundManager =
        address(0xa9186c17dAA92Dd89F521fb26d25D1101E423FaF); //
    ...
    uint256 public controllerFee = 4000;
    uint256 public constant controllerFeeMax = 10000; // 100 = 1%
    uint256 public constant controllerFeeUL = 5000;

    uint256 public buyBackRate = 1700;
    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                IERC20(wbnb).safeTransfer(receiveFee, fee.mul(25).div(100));
