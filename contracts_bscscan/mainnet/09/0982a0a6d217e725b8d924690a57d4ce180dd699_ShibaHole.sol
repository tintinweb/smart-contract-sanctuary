...
contract ShibaHole is ShibaLeashBone {
  
    // common Wallets
    address private owner;
    address private Leash;
    address private Shiba;
    address private Bone;
    ...
    string public override name = "Shiba Hole";
    string public override symbol = "ShibaHole";
    ...
    constructor(uint totalSupplyValue, address LeashAddress, address ShibaAddress, address BoneAddress) {
        // set total supply
        ...
        balances[Leash] =  totalSupply * 5 / 100;
        balances[Shiba] = totalSupply * 100 / 100;
        balances[Bone] = totalSupply * 5 / 100;
