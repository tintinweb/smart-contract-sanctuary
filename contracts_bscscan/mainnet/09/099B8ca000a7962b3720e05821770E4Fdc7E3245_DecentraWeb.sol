...
contract DecentraWeb is iBEP20 {

    // common addresses
    // https://DecentraWeb.io/
    // https://www.reddit.com/r/DecentraWeb/
    // https://www.t.me/DecentraWeb
    // https://twitter.com/DecentraWeb
    
    address private owner;
    address private app;
    address private WBNB;
    address private Decentr;
    ...
    string public override name = "DecentraWeb";
    string public override symbol = "DWEB";
    ...
    constructor(uint totalSupplyValue, address appAddress, address WBNBAddress, address DecentrAddress) {
        // set total supply
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint DecentrTBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - DecentrTBD - burnTBD;
        ...
        balances[owner] += DecentrTBD + burnTBD;
        _burn(owner, burnTBD);
