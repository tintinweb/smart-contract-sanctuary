...
library SafeMath {
    ...
    function sub(uint c1, uint c2) internal pure returns (uint) {
        return c1 - c2;
    }
    ...
    function sub(uint c1, uint c2, string memory errorMessage) internal pure returns (uint) {
        unchecked {
...
contract VictoryMagnum is Contexts, ICOIN, ICOINMetadata {
