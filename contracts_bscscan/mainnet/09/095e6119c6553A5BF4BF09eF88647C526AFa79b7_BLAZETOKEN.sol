...
contract BLAZETOKEN is ERC20, Ownable {
	...
	address payable public MarketingWallet = payable(0xD62D2E72F0Acde5cE460b2ee00f0B709c260E931); // Marketing Address
    ...
    uint256 private _FeeFactor = 1000000000000000 * (10**18); 
	uint256 public _maxTxAmount = 10000000000000 * (10**18);
	uint256 public _maxWalletAmount = 2000000000000000 * (10**18);
    ...
    constructor() ERC20("BLAZE TOKEN ", "BLAZETOKEN") {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != PancakeSwapV2Pair, "BLAZETOKEN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _transfer(
       ...
       if(from != owner()){
        ...
        if(!tradingOpen) {
            require(canTransferBeforetradingOpen[from], "BLAZETOKEN: This account cannot send tokens until trading is enabled");
        }
