...
/**
 ...
 Liquidity Fee 6%
 Marketing Fee 3%
 SAFU -> Check Moonarch, tokensniffer, bscheck

 This token is a tribute to THE BOGS. 

 !4chan ADMINS! Please add them permanently on /biz/ sticky. Other boards have their legends too..
...
contract BOG is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE BOGDANOFF TWINS"; // 
    string private constant _symbol = "BOG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 6;
    address public  _marketingWallet = 0xBEE53183DC1acc67C8Cd771d3822c5b48376b64F;
