...
/**
 __ _  ____  ___  ____   __  
(  ( \(  __)/ __)(  _ \ /  \ 
/    / ) _)( (_ \ )   /(  O )
\_)__)(____)\___/(__\_) \__/ 
*/
...
contract NegroNuggets is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NegroNuggets";
    string constant _symbol = "NEGRONUGGETS";
