...
/**
  ...
  Huskynomics | $HUSIN
  Tokenomics:
* 11% Buy Tax -  3% LP - 5% Marketing - 3% Husky Rewards
* 13% Sell Tax -  3% LP - 5% Marketing - 5% Husky Rewards

* Telegram:https://t.me/huskynomics 
*/
...
contract Huskynomics is Context, IERC20, Ownable {
    ...
    uint256 private _totalTokens = 1000000000000000 * 10**18;
    string private _name = 'Huskynomics';
    string private _symbol = 'HUSIN';
    uint8 private _decimals = 18;    
    uint256 private rTotal = 1000000000000000 * 10**18;
