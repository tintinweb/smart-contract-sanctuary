...
contract SwagRonaTokenContract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Swag Rona Token";
    ...
    uint256 _totalSupply = 1_000_000_000_000_000e8;

    //100% of all token can be bought with one transaction
    uint256 public _maxTxAmount = _totalSupply * 100 / 100;

    //one wallet can only hold 100% of all token
    ...
    address public marketingFeeReceiver = 0x3B28760E80E296641E1a13CC837472E564a44132;
