...
// Mini Warzone Doge / MINIWARDOGE

// Soldier! Enlist and form up with your squad immediately! It's time to join the warzone.
// Unique Project 

// TG: https://t.me/miniwarzonedoge
// website: https://www.miniwarzonedoge.com/

// Tokenomics:
// 2% reflection
// 2% Marketing
// 2% Development & Infrastructure
// 2% Buybacks and giveaways
...
pragma solidity ^0.6.12;
    ...
    contract MiniWarzoneDoge is Context, IERC20, Ownable {
        ...
        string private _name = 'Mini Warzone Doge';
        string private _symbol = 'MINIWARDOGE';
        ...
        function sendETHToDevelopment(uint256 amount) private {
            _developmentWalletAddress.transfer(amount.mul(3).div(8));
        ...
        function _setDevelopmentFee(uint256 developmentFee) external onlyOwner() {
            require(developmentFee >= 1 && developmentFee <= 50, 'developmentFee should be in 1 - 50');
