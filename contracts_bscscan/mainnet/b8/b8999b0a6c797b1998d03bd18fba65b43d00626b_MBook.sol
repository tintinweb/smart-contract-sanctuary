...
contract MBook is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 210000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 0 * 10 ** 9;
    uint256 MAX_LOCK   = 21000 * 10 ** 9;
    ...
    constructor() ERC20("M-Book", "M-Book") {
        addressForMarketing =address(0x00DB6C516a015173fABf230306636Db6caD19692);
