...
contract FuckDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x96f9D00152A2E23c1c4b70De11E112F663BBd3FC); // Marketing Address
    ...
    string private _name = "Fuck Doge token";
    string private _symbol = "FuckDoge";
