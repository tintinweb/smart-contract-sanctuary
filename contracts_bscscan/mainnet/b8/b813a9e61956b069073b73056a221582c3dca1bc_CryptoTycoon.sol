...
contract CryptoTycoon is Ownable, ERC721{
    ...
    string public constant name = "CryptoTycoonNFT";
    ...
    function _initCats() internal {
        _initCatBase("Ragdoll", 500, "Qmb8tzTkdiaVJjQ9YWkxsbnNUHz86XXDw9HpeH8ehEXbhy", "SSR");
        _initCatBase("American Shorthair", 4500, "QmZychthKWaAucxTtp6PZnwQgYhrZca3dL8JQqzb29JVfp", "SR");
         _initCatBase("British Shorthair", 4500, "QmZNtiU6pvjBJv1XkdkDmYRtPf6Ao7VQ6WaZ6mwnMrkPHn", "SR");
         _initCatBase("Soccer Cat", 500, "QmTmdH8osPWGHixqPrYSbSzEJi6FdV9MbpM7HBLCRrEFoE", "R");
         _initCatBase("Legendary Rod", 5, "QmPp6XTA4oiYQSw86FSjWczW5z7SMvR95a1ZFatkGjS9TZ", "SSR");
         _initCatBase("Precious Rod", 20, "QmaYzji4zensFVZwuBewR9AtF5fcBXnVdH2JP4r4NqDdNC", "SR");
    }
