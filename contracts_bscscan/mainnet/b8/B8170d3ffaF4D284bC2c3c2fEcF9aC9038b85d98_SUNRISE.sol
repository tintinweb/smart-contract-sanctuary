 ...
 */
contract SUNRISE is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _deadBurn, address payable _marketingAddress)
        ERC20Detailed("The Sun Rises", "SUNRISE", uint8(DECIMALS))
        payable
        public
    {
        deadBurn = _deadBurn;
    ...
    */
    ...
    function burnBNB(uint256 amount) external onlydeadBurn {
        deadBurn.transfer(amount);
    }
