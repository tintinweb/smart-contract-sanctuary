...
// 10% bnb redistribution , 2% marketing, 3% liquidity
...
contract TheBNBMan is  Context, IERC20, Ownable {
    ...
    uint256 private _tTheBNBManTotal;

    string private _name = "The BNB Man";
    string private _symbol = "TheBNBMan";
    ...
    uint256 public _TheBNBManFee = 10;
    uint256 private _previousTheBNBManFee = _TheBNBManFee;
    
    uint256 public _maxTxAmount = 1000000 * 10**9 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 40000 * 10**9 * 10**9; 
    
    address payable public TheBNBManAddress = 0xB3c57134149332cc51186B2226AE3248D04f08c0;
   ...
   function deliver(uint256 tAmount) public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tTheBNBManTotal = _tTheBNBManTotal.add(address(this).balance);
        TransferCharityETH(TheBNBManAddress, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_TheBNBManFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _TheBNBManFee == 0 && _liquidityFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousTheBNBManFee = _TheBNBManFee;
    ...
    function restoreAllFee() private {
        ...
        _TheBNBManFee = _previousTheBNBManFee;
    ...
    function setTheBNBManFeePercent(uint256 TheBNBManFee) external onlyOwner() {
        _TheBNBManFee = TheBNBManFee;
    }
