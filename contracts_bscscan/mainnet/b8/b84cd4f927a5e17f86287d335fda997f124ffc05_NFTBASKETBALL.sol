...
import "./NFTBASKETBALL-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `NFTBASKETBALL` at the very bottom **and** the `environment` into which
 * you are deploying the contract `NFTBASKETBALL(Env.Testnet)` or `NFTBASKETBALL(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "NFTBASKETBALL";
     ...
     */
    address internal tipToTheDev =0x1B53CB215d9244f44186CE3FBDEe29ADcfEc9be9;
...
contract NFTBASKETBALL is SafeToken{
