...
|_______/    |__|  |__| |__| |______/ 
 ...
 6% Liquidity  6% Marketing  3% Buy-Back
 TG: https://t.me/SonofShibTG
...
contract SonofSHIB is Context, IBEP20, Ownable {
    ...
    uint256 private _maxTxn = 360 * 10**9 * 10**8; // 3BNB
    uint256 private _maxWallet = 15 * 10**6 * 10**8; // 1.5% of 1bil
    ...
    string private _name = "Shiba Son";
    ...
    function set_MaxWallet(uint256 maxWallet) external onlyOwner() {
        _maxWallet = (maxWallet) * 10**6 * 10**8;
    }
