...
contract MaoGraceToken is BEP20 {
    // Transfer tax rate in basis points. (default 2.5%)
    uint16 public transferTaxRate = 250;
    // Burn rate % of transfer tax. (default 30% x 2.5% = 0.75% of total amount).
    ...
    // Min amount to liquify. (default 10 N-LAVAs)
    ...
    /**
     * @notice Constructs the LavaToken contract.
     */
    constructor() public BEP20("Mao Grace Token", "MGT") {
