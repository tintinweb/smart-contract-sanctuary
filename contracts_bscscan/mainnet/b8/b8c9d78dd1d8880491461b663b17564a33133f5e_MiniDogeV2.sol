...
/**
 Welcome to MiniDogeV2
   ...
   I will renounce the ownership to burn addresses to transfer #MiniDogeV2 to the community

   I will add 1.3 BNB and all the left 10% total supply to the pool
   Can you make MiniDogeV2  100X? 
   ...
   it's the best part of the #MiniDogeV2 idea, increasing the liquidity pool automatically, 
