...
contract Strategy_DAR_BNB {
    // This strategy is for BSC network. DAR - BNB pair. 
    // RewardToken = "cake"
    ...
    address public token0; // DAR
    address public token1; // wbnb
    address public vault;

    // ------------> Important constants <--------------
    uint256 public constant pid = 471;
    bool public hasPid = true;
    address public constant lpToken = 0x062f88E2B4896e823ac78Ac314468c29eEC4186d;
