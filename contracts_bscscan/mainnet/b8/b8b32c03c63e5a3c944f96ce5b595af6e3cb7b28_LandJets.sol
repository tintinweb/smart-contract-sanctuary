...
// File contracts/LandJets.sol
pragma solidity ^0.8.0;

contract LandJets is Context, IERC20, Ownable {
    ...
    string private constant _name = "Land Jets";
    string private constant _symbol = "LANDJETS";
    string private constant _ProjectName = "Land Jets";
