...
contract LockVaiyo is Ownable {
    ...
    uint256 public totalSwapedBNB;
    uint256 public totalSwapedBUSD;
    ...
    // VaiyoToken : 0xAeaBb627fe941418deD22c9E334897Fe6bAc2ff7; //for testnet
    ...
    function depositBUSDForLockToken(uint256 amnt) public {
    ...
    function depositBNBForLockToken() public payable {
    ...
    function depositBUSDForUnlockToken(uint256 amnt) public {
        require(amnt >= minDepositAmount, "Minimum amount is 2.5BUSD");
        ...
        totalSwapedBUSD = totalSwapedBUSD.add(amnt);
    }
    
    function depositBNBForUnlockToken() public payable {
        require(getBUSDAmount(msg.value) >= minDepositAmount, "Minimum amount is 2.5BUSD");
        ...
        totalSwapedBNB = totalSwapedBNB.add(msg.value);
    }
