...
contract SuperMiniFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xd9b0b2868672AbaC562aB3b197A34e6057501b8c;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "SuperMiniFloki";
    string constant _symbol = "SuperMiniFloki";
