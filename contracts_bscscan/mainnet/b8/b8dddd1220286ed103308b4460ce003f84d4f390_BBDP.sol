...
contract BBDP is Context, IBEP20, Ownable {
    ...
    address payable public _marketingWallet = payable(0xd180819D9EBB2D3294A7E6A9AA0927B3dF87b511); // Marketing Address
    ...
    string private constant _name     = "BBDP";
    string private constant _symbol   = "BBDP";
    uint8  private constant _decimals = 9;
    
    uint256 public  _taxFee       = 6; // holders tax
    uint256 public  _liquidityFee = 3; // auto lp
    uint256 public  _marketingFee  = 5; // Marketing wallet
    uint256 public  _burnFee      = 1; // burn address
