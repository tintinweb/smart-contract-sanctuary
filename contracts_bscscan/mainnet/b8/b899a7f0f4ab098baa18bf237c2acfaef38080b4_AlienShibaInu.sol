...
contract AlienShibaInu  is Context, IERC20, Ownable {
	...
	address payable public ASHIBANFT = payable(0xEa224D301B3C735B23680e201baB5b62122DC0d2); 
    ...
    function setantiWhale(bool _enabled) public onlyOwner {
        antiWhale = _enabled;
        emit antiWhaleUpdated(_enabled);
    }
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function removeAllFee() private {
        if(_Reflection == 0 && LiquidityFee == 0) return;
