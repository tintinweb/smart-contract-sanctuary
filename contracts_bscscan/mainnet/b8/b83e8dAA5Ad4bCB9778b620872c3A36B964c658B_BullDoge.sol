...
/**
   #BullDoge
   3% fee auto add to the liquidity pool - locked forever
   4% fee auto distribute to all holders
   3% fee auto moved to burn address
 */
...
contract BullDoge is IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal.mul(10).div(10000); // 0.1%
