...
contract ReflectionToken is IERC20 {
    ...
    uint256 private constant startingSupply = 1_000_000_000_000_000; // 100 Million, underscores aid readability

    uint8 private _decimals = 9;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "BabyBatman";
    string constant _symbol = "BBAT";
    ...
    address payable private _marketingWallet = payable(0xd0FD9bf9DEAF5e533f9711BC818Be634dAEc1C84);
