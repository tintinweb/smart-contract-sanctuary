...
contract CPO is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1**10 * 10**9; // 1 Billion 1,000,000,000
    ...
    uint256 public _maxTxAmount = 1 * 1**10 * 10**9; // Max Transaction: 1 Billion 1,000,000,000 (100%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 1 * 1**10 * 10**9; // Max Wallet: 1 Billion 1,000,000,000 (100%)
