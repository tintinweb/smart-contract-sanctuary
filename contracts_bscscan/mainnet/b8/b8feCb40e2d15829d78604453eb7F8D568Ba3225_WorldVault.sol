...
// File: client/src/contracts/HighstreetWorld/interface/IWorldVault.sol

pragma solidity ^0.8.3;

interface IWorldVault {
    struct Deposit {
    ...
    function setHigh(address highAddress_) external;
    ...
    function claimHigh(uint256 amount_, address to_) external;
...
// File: client/src/contracts/HighstreetWorld/WorldVault.sol
...
contract WorldVault is IWorldVault, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(address highAddress_) {
    ...
    function setHigh(address highAddress_) external override onlyOwner {
    ...
    function claimHigh(uint256 amount_, address to_) external override onlyOwner {
