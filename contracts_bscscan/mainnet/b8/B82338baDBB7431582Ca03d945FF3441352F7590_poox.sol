...
contract poox is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "PooX";
    string private constant _symbol = "PooX";
    ...
    address payable constant private _marketingAddress = payable(0x67271490ebF2ad50D73B953E41f3F3836b641037);
    address payable constant private _buybackAddress = payable(0xe425b51a5c1aE8268E39D2e547F25cBBc891577A);
    address payable constant private _projectMaintainence = payable(0x67271490ebF2ad50D73B953E41f3F3836b641037);
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//poox
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//poox
