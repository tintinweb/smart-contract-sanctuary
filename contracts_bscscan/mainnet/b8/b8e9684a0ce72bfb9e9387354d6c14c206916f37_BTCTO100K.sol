...
contract BTCTO100K is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BTCTO100K";
    string constant _symbol = "BTC2100K";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x50A678bc8ACBF2e62eA8d0c9803a5e3275A518c1);
