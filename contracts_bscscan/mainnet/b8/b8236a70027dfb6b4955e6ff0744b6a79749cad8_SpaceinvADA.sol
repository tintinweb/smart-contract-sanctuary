...
/**
 *Hello friends, enjoy your stay. DO NOT BUY UNLESS YOU KNOW WHAT THIS TOKEN IS ABOUT YOU STUPID MOONARCH JEETS. This is Chris's project btw, if you don't hear my voice someone forked the contract. 
*/
...
contract SpaceinvADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SpaceinvADADividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x53bfdDcd65Cd32cA0cc9A370b787649F232240A8;
    address public _devWalletAddress = 0x69712362a93108d20360f03Dfd4aC168BD79f252;
    ...
    constructor() public ERC20("SpaceinvADA", "$SPACEINVADA") {

    	dividendTracker = new SpaceinvADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        SpaceinvADADividendTracker newDividendTracker = SpaceinvADADividendTracker(payable(newAddress));
...
contract SpaceinvADADividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("SpaceinvADA Dividends", "SpaceinvADA_dividends") {
    	claimWait = 3600;
