...
GRAND FLOKI is meme token and it has automatic 
buy-back & burn features. It will automatically buy back 7% of the tokens and  burn 
them in each transaction. It is simply the best way to multiply your investment.
...
contract GrandFloki is IBEP20, Auth {
    ...
    string constant _name = "GrandFloki";
    string constant _symbol = "GrandFloki";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x833aa9595aB26c3aD297CD409aa77b2Cc52f85f0;
