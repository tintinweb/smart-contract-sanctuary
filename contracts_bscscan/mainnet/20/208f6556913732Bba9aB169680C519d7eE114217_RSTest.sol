 ...
 *  1% ScamSeekers fund
 */
contract RSTest is IERC20, Context, Ownable {
    ...
    // token data
    string constant _name = "RSTest";
    string constant _symbol = "TestSeek";
    ...
    uint256 public swapThreshold = _totalSupply.div(1000000); // 0.1% or 1 Billion to start
    // true if our threshold decreases with circulating supply
    bool public canChangeSwapThreshold = false;
    uint256 public swapThresholdPercentOfCirculatingSupply = 1000000;
    bool inSwap;
