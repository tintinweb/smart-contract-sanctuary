...
contract MilkShakeSwapNetwork is Ownable {
    using SafeMath for uint256;
    ...
    function changeMinDollarAmount(uint256 _amt) external onlyOwner{
        minimumDollarAmount = _amt;
    }
    ...
    // [0xa697ec8f0dffaf4c4ae800d9960cc75d33cd5615,0x6229Ae9dCACdC39C1524Cc87eE9e1044BfB398dF]
    function getMilkRate() public view returns (uint256) {
        uint256[] memory amounts = uniswaprouter1.getAmountsOut(1e18, arr);
        return amounts[1];
    }
    
    function miniDepositAmount()  public view returns(uint256){
        return (minimumDollarAmount.div(100)).mul(getMilkRate());
    } 
