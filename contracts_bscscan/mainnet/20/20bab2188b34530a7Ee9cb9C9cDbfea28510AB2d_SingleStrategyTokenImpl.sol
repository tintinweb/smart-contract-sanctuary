...
// File: contracts/earnV2/tokens/SingleStrategyTokenStorage.sol
...
// File: contracts/earnV2/tokens/SingleStrategyTokenImpl.sol
...
contract SingleStrategyTokenImpl is SingleStrategyTokenStorage {
    ...
    function setNewStrategy() external {
        require(msg.sender == govAddress || msg.sender == owner(), "Not authorized");
        _setNewStrategy(0x708b41de7E38aEA812B5Bd37eB906067cE9EC6B8);
    }
