...
Telegram : https://t.me/matrix_token
Twitter:   https://twitter.com/Matrix4_token
Website:   https://matrix4token.site/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BMX4 = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BMX4.balanceOf(address(this));
        ...
        uint256 amount = BMX4.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BMX4.transfer(shareholder, amount);
...
contract The_Matrix_4 is IBEP20, Auth {
    using SafeMath for uint256;

    address BMX4 = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "The Matrix 4";
    string constant _symbol = "MX4";
