...
contract Catemoon is Context, IERC20, Ownable {
    ...
    address payable public feeWallet = payable(0x2A6117Fd7C0f2e87a360BBd15D652341e3E579f6);
    ...
    constructor ()  {
        // 100 Billion Tokens
        _tTotal = 1 * 10**2 * 10**9 * 10**18;
        _rTotal = (MAX - (MAX % _tTotal));
        
        _rOwned[owner()] = _rTotal;

        // Set Max Transaction as 1% of total supply
        _maxTxAmount = _tTotal.mul(1).div(10**2);
        // Set Max Wallet Amount as 1% of total supply
        _maxWalletAmount = _tTotal.mul(1).div(10**2);
