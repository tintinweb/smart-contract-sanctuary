...
Welcome to MiniBabySolana
   This is a community token. If you want to create a telegram I suggest to name it to @MiniBabySolanaChat
   ...
   I will Lock liquidity 1 Month.
   I will renounce the ownership to burn addresses to transfer #MiniBabySolana to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left All (100%) total supply to the pool
   Can you make #MiniBabySolana 10000X? 
   ...
   it's the best part of the #MiniBabySolana idea, increasing the liquidity pool automatically, 
...
contract MiniBabySolana is Context, IERC20, Ownable {
    ...
    string private   _name = "Mini Baby Solana";
    string private _symbol = "MBSOL";
