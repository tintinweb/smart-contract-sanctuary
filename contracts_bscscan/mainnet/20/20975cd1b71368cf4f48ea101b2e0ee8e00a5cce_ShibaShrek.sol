...
contract ShibaShrek is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaShrek"; // 
    string private constant _symbol = "$ShibShrek"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x0e7B2225bC5643b7f00CE82D6259c8B14CD88384;
