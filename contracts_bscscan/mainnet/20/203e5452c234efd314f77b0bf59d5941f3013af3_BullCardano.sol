...
// BullCardano, simply hold BullCardano in your wallet and get rewarded in ADA!
...
contract BullCardano is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BullCardanoDividendTracker public dividendTracker;
    ...
    uint256 public _maxWalletToken = 50 * (10**18); 
    ...
    constructor() public ERC20("BullCardano", "BullCardano") {

    	dividendTracker = new BullCardanoDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BullCardanoDividendTracker newDividendTracker = BullCardanoDividendTracker(payable(newAddress));
...
contract BullCardanoDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BullCardano Dividends", "BullCardano_dividends") {
    	claimWait = 3600;
