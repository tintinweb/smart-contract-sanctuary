...
contract GrasCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000 * 10**1 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GRAS COIN";
    string private _symbol = "GRAS";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**1 * 10**18;
