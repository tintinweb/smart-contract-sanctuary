...
/*
    ...
    function transferLock() public {   
        require(_locks[msg.sender] == 0, "transferLock : lock amount already transfered");
        
        _locks[msg.sender] = ILocker(nalisLocker).lockOf(msg.sender);
        _totalLock = _totalLock.add(_locks[msg.sender]);
