/**
   ...
   site on progress ==? http://litedogetoken.com 
...
contract LiteDoge is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "LiteDoge";
    string private constant _symbol   = "LiteDoge";
    ...
    uint256 public _maxTxAmount  = 200000000000000 * 10**8;
