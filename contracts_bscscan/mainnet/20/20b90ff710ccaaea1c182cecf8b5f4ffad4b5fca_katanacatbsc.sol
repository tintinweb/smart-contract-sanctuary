...
/**
WEB: https://KatanaCat.org
TG:  https://t.me/KatanaCat
**/
...
contract katanacatbsc is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "NewYearsSantaFloki";
    string constant _symbol = "NYSF";
    uint8 constant _decimals = 8;
    uint256 _totalSupply =  300000000  * (10 ** _decimals);
    uint256 public _maxTxAmount =  1000 * (10 ** _decimals);     // 5%
    uint256 public _maxWalletToken = 3000  * (10 ** _decimals);  // 20%
    ...
    constructor ()  {
        address marketingFeeReceiver = 0x92cA98FD70A6ba6FdFB67FBB79D6C7cb6cD844E8;
        owner = msg.sender;
