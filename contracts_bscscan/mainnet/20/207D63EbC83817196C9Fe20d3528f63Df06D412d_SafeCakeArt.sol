...
SafeCakeArt
   ...
   Shiba,Rfi,Feg,CT,Safemoon,SafeCakeArt combine together to creat SafeCakeArt designed.
    
    I make this #SafeCakeArt to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/SafeCakeArt
   ...
   I will renounce the ownership to burn addresses to transfer #SafeCakeArt to the community, make sure it's 100% safe.

   I will add 0.35 BNB and all the left 50% total supply to the pool
   Can you make #SafeCakeArt 100000X? 

   1,000,000,000,000,000 total supply
   50,000,000,000,000 SafeCakeArt max limit for per trade
   ...
   it's the best part of the #SafeCakeArt idea, increasing the liquidity pool automatically, 
...
contract SafeCakeArt is Context, IERC20, Ownable {
    ...
    string private _name = "SafeCakeArt";
    string private _symbol = "SCART";
