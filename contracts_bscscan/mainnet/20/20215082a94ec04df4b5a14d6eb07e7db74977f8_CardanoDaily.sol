...
contract CardanoDaily is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CardanoDaily";
    string constant _symbol = "ADAILY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 25; // 2%
    ...
    address public autoLiquidityReceiver = 0xA1ff9e48c59F0fCF218Aa2B42AEd7ce8663Ba370;
    address public marketingFeeReceiver = 0xA1ff9e48c59F0fCF218Aa2B42AEd7ce8663Ba370;
    ...
    uint256 public swapThreshold = _totalSupply / 2500000000; // 2%
    bool inSwap;
