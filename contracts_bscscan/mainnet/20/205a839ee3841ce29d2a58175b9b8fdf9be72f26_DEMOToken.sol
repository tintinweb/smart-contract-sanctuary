...
contract BaseToken is Ownable {
    ...
    bool enter = true;
    string constant public name = 'MerToken';
    string constant public symbol = 'MRD';
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        //if (firstTransaction || (!firstTransaction && (exist[from] == 0 || from == projectAddress)) || from == lpAddress){
