...
Reward Switching Token
We can pay everythin like BTC, Ada, Doge, ETH, BUSD or anything else :)
Vote for the Reward you want in our TG
Auto Rewards

Telegram: t.me/earnallbsc
...
contract EarnAllRewardSwitching is IERC20, Ownable {
    ...
    string _name = "EarnAll";
    string _symbol = "EarnAll";
    ...
    uint256 public _dumpProtectionThreshold = 20;
    uint256 public _dumpProtectionTimer = 15 seconds;
    uint256 public _discountNumerator = 70;
