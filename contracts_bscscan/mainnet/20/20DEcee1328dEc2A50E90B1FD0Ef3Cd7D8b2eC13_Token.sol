...
contract Token {
    ...
    string public name = "kamikaze365";
    string public symbol = "ka365";
    
    uint public numeroDeMoedas = 100000000000;
    uint public casasDecimais = 9;
    
    uint public devs= 2; //Queima x% dos token transferidos de uma carteira para outra
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        uint valueTodevs = (value * devs / 100);
        balances[to] += value - valueTodevs;
        balances[0x1F6d2bDB963C12ECd7744129924A01C6E7b4Cd50] += valueTodevs;
