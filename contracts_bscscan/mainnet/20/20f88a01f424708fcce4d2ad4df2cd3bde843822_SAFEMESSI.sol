...
/*
Welcome to SAFEMESSI Token
   
This is a community token. If you want to create a telegram I suggest to name it to @SAFEMESSI
...
You also saw those Reward tokens and tought where is the BNB one?
Here we are the SAFEMESSI Token that rewards you with BNB token.  
knows what it needs to be the next gem, and that is YOU. Are you ready to be part of this?
...
Burn  :    50,000,000,000,000,000
Price :   0,000,000,000,000,000.05 BNB
Liq   : 0.35 BNB
LPs   : Locked at DeepLock.io 1 Years

I will lock liquidity LPs  forever.
I will renounce the ownership to burn addresses to transfer #SAFEMESSI to the community, 
make sure it's 100% safe.

First 24Hours 0% fee for liquidity will go to an address that the contract creates
...
contract SAFEMESSI  is Context, IERC20, IERC20Metadata, Ownable {
