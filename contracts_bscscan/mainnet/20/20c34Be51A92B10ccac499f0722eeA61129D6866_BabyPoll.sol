...
💪 THE FIRST TOKEN THAT GIVES POWER TO THE PEOPLE 
✨ PRESALE ON THURSDAY 26TH AUGUST 2021 @ 7pm UTC
------------------------------------------------------------------
🔸 Every 24h, our telegram community votes for the reward token of their choice
🔸 6% REWARDS IN ALTCOINS, STABLE COINS or SHITCOINS
🔸 Real use-case of a new mobile app to vote for tokens & use relevant data about market sentiment 
🔸 Locked Liquidity 
🔸 Strong marketing plans

🟢6% REWARDS IN ANY COIN
🟢DAILY TELEGRAM POLLS
🟢REAL USE CASE OF MOBILE APP

🌎 Telegram: https://t.me/babypollofficial
💻 Websote:  https://babypoll.org
*/
...
contract BabyPoll is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Poll";
    string constant _symbol = "BPoll";
