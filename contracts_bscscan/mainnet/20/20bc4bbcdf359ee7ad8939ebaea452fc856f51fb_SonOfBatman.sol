...
contract SonOfBatman is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SonOfBatman";
    string constant _symbol = "SON";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 10 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 5 / 100; // 1%

    uint256 public _maxWalletToken = ( _totalSupply * 15 ) / 100; // 4%
