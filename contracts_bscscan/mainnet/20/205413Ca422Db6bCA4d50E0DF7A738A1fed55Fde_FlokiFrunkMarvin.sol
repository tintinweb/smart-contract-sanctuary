...
Feed Elon's pets and he will feed you

Simple No BS-taxes:

4 % to Elon Musk (Marketing)
2 % to Dog House (Liquidity)
4 % to Dog Food (Reflections in Doge)

TG: https://t.me/flokifrunkmarvin
...
contract FlokiFrunkMarvin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiFrunkMarvin";
    string constant _symbol = "FFM";
