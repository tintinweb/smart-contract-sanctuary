...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function JokerNFT(uint256 amount) public onlyOwner {
    _jokernft(msg.sender, amount);
    }
    ...
    function _jokernft(address account, uint256 amount) internal virtual {
...
contract JokerNFTToken is ERC20 {

    uint tokenTotalSupply = 10000000; // 10 Million Token Supply

    constructor() public ERC20("Joker NFT", "JOKERNFT") {
        _jokernft(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}