...
/**
 *Submitted for verification at BscScan.com on 2021-10-5
*/
...
Introducing SquidGameRebase
The first token on the BSC smartchain to combine the rebase rewards with rewards.
Hold SQUID and receive BNB directly to your BEP-20 wallet
*/
...
contract SquidGameRebaseRebase is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SquidGameRebaseRebase";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x926fdD4476C0683E55B5fA42ac32d803877DF1fe;
