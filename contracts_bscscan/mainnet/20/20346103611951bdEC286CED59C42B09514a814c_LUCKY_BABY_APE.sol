...
LUCKY BABY APE
   ...
   This is a community token. Telegrams @LUCKY BABY APE  Important: The early you create a group that shares the token, the more gain you got.
...
🔥TOTAL SUPPLY 1,000,000,000,000,000 LBAPE
🔥BURN SUPPLY 90% LBAPE
🔥NO DEV TOKEN
   ...
   I will renounce the ownership #LBAPE to the community, make sure it's 100% safe.

   I will add .5 BNB.
   Can you make #LBAPE 10,000 X? 
   ...
   it's the best part of the #LUCKY BABY APE idea, increasing the liquidity pool automatically, 
...
contract LUCKY_BABY_APE is Context, IERC20, Ownable {
    ...
    string private _name = "LUCKY BABY APE";
    string private _symbol = "LBAPE";
