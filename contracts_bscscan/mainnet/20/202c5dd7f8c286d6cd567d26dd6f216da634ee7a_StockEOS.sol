...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EOS = IBEP20(0x2678EaCF217a5b85a40e18332F99dE15D877D12b);
...
contract StockEOS is IBEP20, Auth {
    using SafeMath for uint256;

    address EOS = 0x2678EaCF217a5b85a40e18332F99dE15D877D12b;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "StockEOS";
    string constant _symbol = "StocEOS";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x0B439926f26f4AC055d65ffBf5c8b97d9B6dAE00;
