...
/**
 *Submitted for verification at BscScan.com on 2021-09-24   TG: BabyMedaBsc  
*/ 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  MEDA = IBEP20(0x9130990dD16eD8BE8BE63E46CAd305C2C339Dac9);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MEDA.balanceOf(address(this));
        ...
        uint256 amount = MEDA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MEDA.transfer(shareholder, amount);
...
contract BabyMeda is IBEP20, Auth {
    using SafeMath for uint256;

    address MEDA = 0x9130990dD16eD8BE8BE63E46CAd305C2C339Dac9;
    address WBNB = 0x82190B7e0998cAA0d1B2d07eca951DfaE903B43D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "BabyMeda";
    string constant _symbol = "BabyMeda";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x5e496C20B670522EBDdCE9cf614416e69Eae5cc0;
        marketingFeeReceiver = 0xf23becDd0b7007e56aBcD38b7442E21d4Dc3b2Bf;
