...
library Address{
 ...
 contract PochiInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xe954CA350918b4B1739ab65e41fd0A0A7036A84A;
    address public donationWallet = 0x084F480cD596E08655223b143e50204C1D30fA27;
    ...
    Taxes public taxes = Taxes(1, 7, 3, 2);
    Taxes public sellTaxes = Taxes(1, 7, 3, 2);
