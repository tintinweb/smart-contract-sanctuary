...
| | /| / / / / __  / / __/ __ \/ __  /  / /  / / / / __ `/
| |/ |/ / / / /_/ / /_/ / /_/ / /_/ /  / /__/ / / / /_/ / 
|__/|__/_/_/\__,_/\____/\____/\__,_/  /____/_/_/_/\__,_/  
                                                          
                                                          
    Wild GodZilla is loyal, like all dogs should be! 
    Make sure you don’t miss out on this one, 
    Wild GodZilla will take you to the moon.
    ...
    Total Tax 4% (Small tax = easy moon)
    5% to Marketing and Development Wallet
    3% to Liquidity Pool

    Telegram https://t.me/Wildgodzilla/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ZILLA = IERC20(0xb86AbCb37C3A4B64f74f59301AFF131a1BEcC787);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ZILLA.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ZILLA);
        ...
        uint256 amount = ZILLA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ZILLA.transfer(shareholder, amount);
...
// CHANGE
contract Wilgodzilla is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address ZILLA = 0xb86AbCb37C3A4B64f74f59301AFF131a1BEcC787;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "WildGodZilla";
    string constant _symbol = "WGZ";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 3% MAX 15,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4B27cCF480ECEFb1e2536fc8E26749a284b7511C); //
