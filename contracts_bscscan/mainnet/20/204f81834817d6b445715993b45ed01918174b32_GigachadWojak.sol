...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract GigachadWojak is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x89eaDe213B9410b50aee76c4f6f3F99E7135a374); // Marketing Address

    address payable public teamAddress =
        payable(0x757d706217C2Ea9f720d4b9405D20b640256f670); // Team Address

    address payable public liquidityAddress =
        payable(0x757d706217C2Ea9f720d4b9405D20b640256f670); // Liquidity Address
    ...
    string private constant _name = "GigachadWojak";
