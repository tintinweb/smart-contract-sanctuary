...
contract StAxs is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "STACK AXS";
    string constant _symbol = "StAxs";
    ...
    uint256 _totalSupply = 100000 * 10**5 * (10 ** _decimals);
