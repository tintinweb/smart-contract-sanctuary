...
contract MegaDoge is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress = payable(0x9cDB5e8BCe60b8CDffd6F97e5F62206a4a00BF46);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 100000000000000000, "MegaDoge: MaxtxAmount >= 100000000000000000 ");
