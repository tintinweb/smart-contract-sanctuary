...
/**
welcome to EYERA FINANCE

�  Tokenomics  🥇

🔒 2% Liquidity pool
🎯 2% BuyBack
📣 3% Marketing (.5% can be used for community voted events)
*/
...
contract EYERAFINANCE is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**7 * 10**4; // 1B
    ...
    uint256 public _maxTxAmount = 100 * 10**7 * 10**4; // 1B
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 100 * 10**7 * 10**4; // 1B

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "EYERA FINANCE";
    string private _symbol = "EYERA";
