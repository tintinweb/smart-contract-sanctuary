...
contract xYSLShare is YSLOpt {
    ...
    function transferOut(address _user, uint256 _amount) public override onlyRole(STRAT_ROLE) returns (uint256) {
        ...
        // Swap sYSL to BUSD
        IERC20(xYSL).approve(pancakeSwap, _amount);
        
        amounts = IPancakeRouter02(pancakeSwap).swapExactTokensForTokensSupportingFeeOnTransferTokens(
            _amount,
            1,
            path,
            _msgSender(),
