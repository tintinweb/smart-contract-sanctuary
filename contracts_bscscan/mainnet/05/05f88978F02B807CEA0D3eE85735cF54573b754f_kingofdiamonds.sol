...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract kingofdiamonds is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress =0x4E3089F252173709375D9020A1a6a2eE5576e288;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;string private _name = "King Of Diamonds";
    string private _symbol = "KOD";
    ...
    uint256 private numTokensSellToAddToLiquidity = 8000000 * 10**6 * 10**18;
