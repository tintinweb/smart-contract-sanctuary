...
import "./BabyShibaEth-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyShibaEth` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyShibaEth(Env.Testnet)` or `BabyShibaEth(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyShibaEth";
     ...
     */
    address internal tipToTheDev = 0x890d4A4b76d3Dc87FDe1a484c1871Af463f122ca;
...
contract BabyShibaEth is SafeToken{
