...
$$ |  $$ |$$ |  $$ |$$ |  $$\ $$ |\$$\  $$ |         $$ |         $$\   $$ |$$ |  $$ |  $$ |  $$ |  $$ |$$ |  $$ |
$$ |  $$ | $$$$$$  |\$$$$$$  |$$ | \$$\ $$$$$$$$\    $$ |         \$$$$$$  |$$ |  $$ |$$$$$$\ $$$$$$$  |$$ |  $$ |
\__|  \__| \______/  \______/ \__|  \__|\________|   \__|          \______/ \__|  \__|\______|\_______/ \__|  \__|
...
contract ROCKETSHIBA is Context, IBEP20, Ownable {
    ...
    string private constant _symbol   = "RCKSH";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 100; // 2% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 300; // 3% of every transaction is kept for liquidity
    uint256 public _marketingFee = 300; // 5% of every transaction is sent to marketing/buyback wallet
