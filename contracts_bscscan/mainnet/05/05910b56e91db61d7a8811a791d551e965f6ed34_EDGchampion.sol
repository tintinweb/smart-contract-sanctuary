...
contract EDGchampion is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7777777777 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "EDGchampion";
    string private _symbol = "EDG冠军";
    ...
    uint256 public _maxTxAmount = 7777777777 * 10**6 * 10**9;

    // Liquify when 250 billion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 6666666 * 10**6 * 10**9;
