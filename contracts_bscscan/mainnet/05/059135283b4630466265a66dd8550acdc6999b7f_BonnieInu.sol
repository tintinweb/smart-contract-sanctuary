...
/** 
Telegram got down now, but you can following this @BonnieInu after tg gets back.

It will be renounced and locked !!
**/
...
contract BonnieInu is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REFLECTION = 0xd5B911cA992aE2EF95e324c71ba5D9e7F60C780a; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    ...
    address _marketingAdr = 0x2dEcEB7BaA165c4b4BF61CAb2139009461263787;
 
    string constant _name = "Bonnie Inu";
    string constant _symbol = "Bonnie";
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit autoReceiverLPToken(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event autoReceiverLPToken(uint256 amountBNB, uint256 amountBOG);
}