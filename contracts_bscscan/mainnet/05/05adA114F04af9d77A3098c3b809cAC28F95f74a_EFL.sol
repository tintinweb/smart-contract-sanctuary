...
8% for ADA
4% to marketing and 4% to liquidity pool.
Diamond hands will be rewarded !!

Official Telegram group : https://t.me/EvilFloki
...
contract EFL is ERC20, Ownable {
    ...
    EFLDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public ADA = address(0x45c4186D454e4eb7609B5B258a3Cd52d44370Ef2); //ADA

    uint256 public swapTokensAtAmount = 2000000 * (10**18);
    
    //Anti-Whale System
    uint256 public maxWalletTokens =  50000000000 * (10**18);
    ...
    constructor() public ERC20("EvilFloki", "EFL") {

    	dividendTracker = new EFLDividendTracker();

        _marketingWalletAddress = 0x45c4186D454e4eb7609B5B258a3Cd52d44370Ef2;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "EFL: The dividend tracker already has that address");

        EFLDividendTracker newDividendTracker = EFLDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "EFL: The new dividend tracker must be owned by the EFL token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "EFL: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "EFL: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "EFL: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "EFL: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "EFL: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "EFL: Cannot update gasForProcessing to same value");
