...
/**
   ...
   4% distribute to a charity wallet
   4% distribute to holders
   ttl supply = 25000000000
   decimals = 9
*/
...
contract DarkGenesis is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xF2C80e547f21C31f964d88292894eBFd00935840;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 25000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Dark Genesis";
    string private _symbol = "DKGS";
