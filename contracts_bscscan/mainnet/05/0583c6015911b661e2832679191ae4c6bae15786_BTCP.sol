...
Crypto Pups High Yield & High Reward puppies that are sure to keep you on your toes! 
Crypto pups are designed to be SAFU, protecting you from bots, rug pulls and scams.
Each pup offers a different coin as rewards. 
...
https://t.me/cryptopupsofficial
https://cryptopups.cash
*/
...
contract BTCP is Context, IERC20, Ownable {
    ...
    uint256 public _SupportFee = 1;
    uint256 private _previousSupportFee = _SupportFee;
    
    string public _Reward = "BTCB";
    string public _RewardAddress = "0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c";
    IUniswapV2Router02 public immutable uniswapV2Router;
    uint256 public MaxWalletHolding = _tTotal/25;
    // ROUTER
    ...
    address _marketingWallet = 0xFf9142B9aF489B028D9ABd22E9F9142Aca2c6ff3;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    // Max TX amount is 100% of the total supply.
    uint256 private maxTxX = 1000000000; // Less fields to edit
