...
/**
 ...
 #ANONYMOUS COIN
   ...
   #ANONYMUS COIN features:
   1% fee auto add to the liquidity pool to locked forever when selling
   1% fee auto distribute to all holders
   I created a black hole so #ANONIMYS COIN will deflate itself in supply with every transaction
...
contract SQUIDGAMETOKEN is TokenBEP20 {
