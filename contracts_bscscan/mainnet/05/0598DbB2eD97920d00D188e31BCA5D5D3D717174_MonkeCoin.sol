...
/**
 Telegram: https://t.me/monkebsc/
 Website: https://monkecoin.world/
 Twitter: https://twitter.com/monkecoinworld/
 Instagram: https://www.instagram.com/monkecoinworld/
*/
 ...
 * 
 * Fees Go Toward:
 * 2% Fee Redistributed to Token Owners in BNNA
 * 2% Marketing Fee 
 * 1% Auto-Liquidity Fee
 * 
 * 
 * Get BNNA Tokens just by holding MonkeCoin!
*/
...
contract MonkeCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Monke Coin";
    string private _symbol = "BNANA";
    ...
    uint public maxWalletToken = 1000000000 * 10 ** 9;

    address payable public charityAddress = 0xf2C1a83a94E16170f8EFA013988E0B5c9eD97835;

    address payable public marketingAddress = 0xF414a4a43b2cF9e631085D39eC6279655537157F;

    address payable public communityAddress = 0x910684E2C3708765ecaBc4dd77021Dbe4b15088e;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
        {
            ...
            require(contractBalanceRecipient + amount <= maxWalletToken, "Transfer amount exceeds the maxWalletAmount.");
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public lockTheSwap {
        uint256 totalFee = _donationFee.add(_marketingFee).add(_communityFee).add(_liquidityFee);
        uint256 totalFeeWithoutLiquidityTokens = _donationFee.add(_marketingFee).add(_communityFee).add(_liquidityFee.div(2));
        ...
        _tMarketingTotal = _tMarketingTotal.add(marketingContribution);
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        uint256 fee = _donationFee.add(_marketingFee).add(_communityFee).add(_liquidityFee);
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _donationFee == 0 && _marketingFee == 0 && _communityFee == 0) return;
    ...
    function restoreAllFee() private {
        ...
        _marketingFee = _previousDonationFee;
