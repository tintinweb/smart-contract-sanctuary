...
contract CHIN is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "ChinaInu";
    string constant _symbol = "CHIN";
    uint8 constant _decimals = 9;

    // Supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000 Tokens
    uint256 _burntSupply = (_totalSupply * 65) /100;
    ...
    // Fee receivers
    address private marketingFeeReceiver = 0x3B9bBF0CBCd851D9fBf3Cee17F6851407B08779C;
    address private buybackFeeReceiver = 0x84aD5FA752115f5C44044b69Cb87b7208F6d1B11;
