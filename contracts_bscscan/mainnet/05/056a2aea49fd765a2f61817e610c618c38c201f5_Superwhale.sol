...
contract Superwhale is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xbFF5312119E342660C567080F48366411912025a);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xA9c2b33807AE0F0f2b12564bdd45013d8D7f2F6A); 

    string private _name    = "Superwhale";
    string private _symbol  = "WAROO";
