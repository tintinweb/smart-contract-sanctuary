...
contract TokenTimelock {
    ...
    constructor(
        ...
        dao = _dao;
        token = _token; // should be KISS token
        releaseTime = _releaseTime;
    }

    function emergencyChangeDao(address _dao) external {
        require(msg.sender == dao, "only dao");
        dao = _dao;
    }

    function emergencyChangeReleaseTime(uint256 _releaseTime) external {
        require(msg.sender == dao, "only dao");
        releaseTime = _releaseTime;
    }
    ...
    function withdraw() external {
        ...
        uint256 unlocked = balanceOf[msg.sender];
        ...
        emit Withdrawn(msg.sender, unlocked);
    }
}