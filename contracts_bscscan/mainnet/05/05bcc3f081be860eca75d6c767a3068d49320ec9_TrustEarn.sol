...
//Trust Earn Token Contract /////////////

contract TrustEarn is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TRUSTEARN';
    ...
    //DevWallets
    address public TeamWallet=payable(0x6a4c6C593430a631D82D30125B634BCe067fBDd6);
    address public walletTwo=payable(0xda03d7575FB7e5B73bffD5898CE3E8Df3E4929EF);
    ...
    function claimCAKE(address addr) private{
        ...
        path[1] = 0x4B0F1812e5Df2A09796481Ff14017e6005508003;  // Trust Wallet Token (TWT)
