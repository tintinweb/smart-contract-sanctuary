...
contract Yieldex is Ownable,ReentrancyGuard{
    ...
    */
    ...
    //PanCakeSwapRouter
    address public routerAddress = 0x325E343f1dE602396E256B67eFd1F61C3A6B38Bd;
    address public farmAddress = 0x0F9eBf3E497454B07D1F4650Ac8C9092F5A30483;
    address public wbnbAddress = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public tenToken =  0xE0b6020cac66543E8dbd4bB924eDd7465F2b3f6c;
   ...
   function withdrawBalance(address userAddress, uint256 yieldPoolId, IERC20 lpAddress, uint256 percent )internal view returns(uint256){
    ...
    function lpToToken(IERC20 iAddress, address tokenAddress, uint256 slippage ) internal allowedWithdrawTokens(tokenAddress) {
        if(tokenAddress == wbnbAddress) {
            ...
            uint256 _returned1 = amountA; 
            uint256 _returned2 = amountB;
    ...
    modifier allowedWithdrawTokens (address tokenAddress) {
        require(tokenAddress == wbnbAddress || tokenAddress == busdAddress, "Not Allowed");
        _;
    }
