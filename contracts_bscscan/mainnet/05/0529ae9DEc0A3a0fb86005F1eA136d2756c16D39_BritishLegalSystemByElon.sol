...
/**
BritishLegalSystemByElon
    
   This is a community token. Telegrams @BritishLegalSystemByElon  Important: The early you create a group that shares the token, the more gain you got.
...
🔥TOTAL SUPPLY 1,000,000,000,000,000 BLSBELON
🔥BURN SUPPLY 90% BLSBELON
🔥NO DEV TOKEN
   ...
   I will renounce the ownership #BLSBELON to the community, make sure it's 100% safe.

   I will add .5 BNB.
   Can you make #BLSBELON 10,000 X? 
   ...
   it's the best part of the #BritishLegalSystemByElon idea, increasing the liquidity pool automatically, 
...
contract BritishLegalSystemByElon is Context, IERC20, Ownable {
    ...
    string private _name = "BritishLegalSystemByElon";
    string private _symbol = "BLSBELON";
