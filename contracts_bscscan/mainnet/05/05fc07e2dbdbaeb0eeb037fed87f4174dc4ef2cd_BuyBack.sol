...
contract BuyBack is Ownable {
    ...
    function getAllQueue() public view returns (address[] memory,address[] memory,uint256[] memory,uint256[] memory,uint256[] memory,uint256[] memory) {
        ...
        uint256[] memory amountXOS;
        uint256[] memory amountSwapToken;
        uint256[] memory price;
        uint256[] memory createDate;
    ...
    function saveQueue(uint256 totalXOSParam) public{
        ...
        xosToken.safeTransfer(address(msg.sender), totalXOSParam);
    ...
    function savetrans() internal{
        ...
        xosToken.safeTransferFrom(address(this),address(p2p.buyer), p2p.amountXOS);
        //add to history
        history.push(p2p);
        //remove from queue
        delete queue[0];
