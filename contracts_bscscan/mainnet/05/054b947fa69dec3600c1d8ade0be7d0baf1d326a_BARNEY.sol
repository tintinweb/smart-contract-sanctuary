...
contract BARNEY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 25000 * 10**9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Barney Finance Token";
    string private _symbol = "BARNEY";
    ...
    address public marketingWallet = 0x5a4Cd1451C206CA9B7960087D6764632e4c2CB08;
    ...
    uint256 public _maxTxAmount = 250 * 10**9; // 1%
    uint256 public _maxWalletSize = 750 * 10**9; // 3%
    uint256 private numTokensSellToAddToLiquidity = 25 * 10**9; // 0.1%
