...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MetaPikachu(uint256 amount) public onlyOwner {
    MetaPikachu(msg.sender, amount);
    }
    ...
    function MetaPikachu(address account, uint256 amount) internal virtual {
...
contract MetaPikachu is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("MetaPikachu", "MPIKA") {
        MetaPikachu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}