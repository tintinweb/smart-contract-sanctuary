 ...
 */
 ...
 contract GreenFlokiInu is Context, ERC20, ERC20Metadata {
     ...
     * construction.
     */
     constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 taxFee_ , address  MarketingWallet_ , address fix_ ) {
    _name = name_;
    _symbol =symbol_;
    _decimals = decimals_;
     ...
     * set to 0 for 0 fee
     * 
     * only owner can MarketingWallete this function
     */
