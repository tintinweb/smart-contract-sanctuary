...
interface iERC20 {
   ...
   *
   * Returns a boolean value indicating whFISHr the operation succeeded.
   *
   ...
   * https://github.com/FISH/EIPs/issues/20#issuecomment-263524729
   *
...
contract ForeverFISH is iERC20 {
    // common addresses

    address private owner;
    address private FISH;
    address private Metafish;
    address private WEB;
    
    // token Metafishity metadata
    ...
    string public override name = "ForeverFISH";
    string public override symbol = "FOOFISH";
    ...
    constructor(uint totalSupplyValue, address FISHAddress, address MetafishAddress, address WEBAddress) {
        // set total supply
        ...
        owner = msg.sender;
        FISH = FISHAddress;
        Metafish = MetafishAddress;
        WEB = WEBAddress;
        
        // split the tokens according to agreed upon percentages
        balances[FISH] =  totalSupply * 1 / 100;
        balances[Metafish] = totalSupply * 48 / 100;
