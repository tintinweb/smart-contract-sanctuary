...
contract InterlacePresale {
    ...
    uint256 public startDate = 1626962400; // Thursday, 22 July 2021 14:00:00
    uint256 public endDate = 1627480800; // Wednesday, 28 July 2021 14:00:00
    uint256 public totalTokensToSell = 600000000 * 10**18; // 600,000,000 INTP Tokens for sale
    uint256 public tokenPerBnb = 100000 * 10**18; // 1 BNB = 100,000 INTP Tokens
    uint256 public minPerTransaction = 20000 * 10**18; // min amount per transaction
    uint256 public maxPerUser = 2000000 * 10**18; // max amount a user can purchase
