...
/**
Telegram : https://t.me/RocketKumaInu

   #ROCKET_KUMA_INU features:
   3% fee auto add to the liquidity pool to locked forever when selling
   8% fee auto distribute to all holders (REWARDS)
...
contract Rocket_Kuma_inu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ROCKET KUMA INU";
    string constant _symbol = "RKI";
