...
contract FLAG is Context, IERC20, Ownable {
    ...
    address public devAddress = 0xb000CEf96dc599b2218218ffa7507e194cDE9d91;
  
    uint256 public deadFee = 3;
    uint256 public devFee = 2;

    uint256 public maxBalance = 100000;
        ...
        returns (bool)
    {
        ...
        require(balanceOf(recipient) < maxBalance, "Excessive balance");
    ...
    function transferFrom(
        ...
        if(sender == pair){
            //out
            require(amount < balanceOf(_msgSender()), "sale too much");
