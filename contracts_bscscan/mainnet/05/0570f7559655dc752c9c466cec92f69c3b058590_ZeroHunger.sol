...
ZeroHunger is a community driven token.
ZeroHunger aim: Lets fight hunger and end world hunger together.
If we can travel to the moon, we can end world hunger too.

#ZeroHunger features:	
Every ZeroHunger transaction has an automatic 8% transaction fee -
	
4% fee auto distribute to all holders
2% fee auto add to the locked liquidity
2% fee auto add to the charity wallet

Proof of Charitable Contributions will be available at official website, and social media accounts.
...
contract ZeroHunger is Context, IERC20, Ownable {
    ...
    string private _name = "Zero Hunger";
    string private _symbol = "ZeroHunger";
