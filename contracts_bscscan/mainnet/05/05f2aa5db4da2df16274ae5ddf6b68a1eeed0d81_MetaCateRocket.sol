...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x17981c39bA9ea19f77c75abEfDBE0637ef54d6a1;
...
contract MetaCateRocket is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x526f1dc9a9461190c900e14E51d04286C7eB22C8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Cate Rocket";
    string private _symbol = "MCRocket";
