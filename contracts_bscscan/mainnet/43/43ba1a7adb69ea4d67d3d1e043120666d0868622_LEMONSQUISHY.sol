...
|_|\___|_| |_| |_|\___/|_| |_|
 ...
 - Max Buy / Sell 1,500,000,000 $LEMON
 - Max Hold Per Wallet: 3,000,000,000 $LEMON (Anti Whale System)
 
 5% Tax 
 Use High Slippage in early phase
...
contract LEMONSQUISHY is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10 * 10**10 * 10**9; // 100 Trillion Total Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _taxFee = 5;
    uint256 private _liquidityFee = 35;
    uint256 public _previousTaxFee = _taxFee;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _maxTxAmount = 15 * 10**8 * 10**9; // Max Transaction: 1,500,000,000 (1,5%)
    uint256 private _numTokensSellToAddToLiquidity = 10 * 10**7 * 10**9; // Number of tokens to sell before Liquidity gets added: 100,000 (0.2%)
    uint256 public _maxWalletToken = 30 * 10**8 * 10**9; // Max Wallet: 3,000,000,000 (3%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'Lemon Squishy';
