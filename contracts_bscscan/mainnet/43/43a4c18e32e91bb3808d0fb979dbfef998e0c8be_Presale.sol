...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    uint256 public _rateFirst =  30000;
    uint256 public _rateSecond = 25000;
    uint256 public _rateThird =  20000;
    ...
    uint256 public firstPhase = 1626739200;
    uint256 public secondPhase = 1627344000;
    uint256 public thirdPhase = 1627948800;
    ...
    {
        if(now < secondPhase){
        return weiAmount.mul(_rateFirst);
        }else if(now >= secondPhase && now < thirdPhase){
            return weiAmount.mul(_rateSecond);
        }else{
            return weiAmount.mul(_rateThird);
        }
    }
...
contract Presale is Ownable, Crowdsale, AllowanceCrowdsale {
    ...
    uint256 _closingTime = 1628726340;
    uint256 _rate;
    
    IERC20 Token = IERC20(0xE94Eb1ECF347d6b3D31456993cDf02EC1023616f);
    address payable _wallet = address(0x76450dd0e7504602D78fD42cd86735B116DD514F);
    address _tokenWallet = address(0x76450dd0e7504602D78fD42cd86735B116DD514F);

    constructor(
    )
        public
        Crowdsale(_wallet, Token, _openingTime, _closingTime)
