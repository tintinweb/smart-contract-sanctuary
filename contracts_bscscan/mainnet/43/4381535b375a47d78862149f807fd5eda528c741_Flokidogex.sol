...
$$ |      $$ |$$ |  $$ |$$  _$$<  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$   ____|$$  /\$$\ 
$$ |      $$ |\$$$$$$  |$$ | \$$\ $$ |$$$$$$$  |\$$$$$$  |\$$$$$$$ |\$$$$$$$\ $$ /  $$ |
\__|      \__| \______/ \__|  \__|\__|\_______/  \______/  \____$$ | \_______|\__|  \__|
                                                          $$\   $$ |                    
                                                          \$$$$$$  |                    
                                                           \______/                     

‍━━━━━━━━━━━━━━━━━━━
⚡️FlokiDogeX is USDT reflection token, simply hold FlokiDogeX tokens and get rewarded in USDT on every transaction! With the active Buy-Back and Marketing wallet⚡️
‍━━━━━━━━━━━━━━━━━━━
🏆 Tokenomics 🏆
...
contract Flokidogex is ERC20, Ownable {
    ...
    constructor() ERC20("FlokiDogeX", "FLOKIDOGEX")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function buybackFee(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function autoLiquidityFee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        function enableCoolDown(uint256 value) external onlyOwner{
    ...
    function withdrawableDividendOf(address account,uint256 pos) public view returns(uint256) {
        ...
        function prepareLunch(uint256 value) external onlyOwner{
