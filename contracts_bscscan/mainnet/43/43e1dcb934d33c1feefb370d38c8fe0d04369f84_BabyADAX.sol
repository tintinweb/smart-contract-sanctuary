...
contract BabyADAX is Context, IERC20, Ownable {
    ...
    string private _name = "BabyADAX";
    string private _symbol = "BABYADAX";
    ...
    uint256 public maxBuyTranscationAmount = 30000000000 * 10**9;
    uint256 public maxSellTransactionAmount = 1  * 10**9;
    uint256 public _maxWalletToken = 30000000 * 10**9;
