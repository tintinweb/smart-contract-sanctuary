...
/**
 * Pomeranian is a community driven meme coin, targeted to steal the limelight from Floki and Shiba! Pomeranian will be set a new wave of shicoin meta with $POMR Trend!
 * Pomeranian will offer a community driven vessel where investors can passively earn , learn grow and work together to spread the word of the cutest doge in the BSC space.
 * TAX 14%
 * 6% To Liquidity
 * 6% to Marketing
 * 2% Development
 * 
 * https://t.me/Pomeranian_INU
 */
...
contract PomeranianINU is IBEP20, Auth {
    ...
    string constant _name = "PomeranianINU";
    string constant _symbol = "POMR";
    ...
    address private marketingFeeReceiver = 0xDEa80F7b4fDaeBc540b55AA94A01d4B2dceE2200;
    address private DevelopmentFeeReceiver = 0xDEa80F7b4fDaeBc540b55AA94A01d4B2dceE2200;
