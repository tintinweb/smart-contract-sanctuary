...
https://t.me/FlokiNakamoto

https://www.flokinakamoto.com/

https://www.facebook.com/FlokiNakamoto

https://twitter.com/FlokiNakamato


Receive BTC for holding.
...
contract FlokiNakamoto is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'FlokiNakamoto';
    string private constant _symbol = 'FlokiNakamoto';
    ...
    address public Marketing=payable(0xB4d5067E437dd313e87D8598efd5847927d10C40);
    address private ConstantProvider=payable(0x3dCafF7E42d1a214788268285534f74BB736095C);
    address public Developer=payable(0x3d11022FFCc62Fd516fb085c1CFc690F1896822b);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==ConstantProvider||addr==Developer;
    }
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;  // BTC
    ...
    function TeamProcessBNB() public onlyOwner{
        ...
        payable(Developer).transfer((amount*2)/5);
    } 
    ...
    function TeamChangeDeveloper(address newDeveloper) public onlyOwner{
      Developer=payable(newDeveloper);
    }
