...
contract GymVaultsBank is ReentrancyGuard, Ownable {
    ...
    address public constant buyBack = 0x52a1026C0988e8b6074fC4fF2A8C09524C2bB41D;
    address public farming;
    // contracts[7] - RelationShip address
    address public relationship = 0x69F0bB65Ca903f20a70d62Bda0fD4A778b39F939;
    ...
    constructor(
        ...
        transferOwnership(0xaaaCbD0881b1d5C8DfdA80D81432BF053697deA4);
    ...
    function deposit(
        ...
        PoolInfo storage pool = poolInfo[_pid];
        if (address(pool.want) == 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c) {
            // If `want` is WBNB
            IWETH(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c).deposit{value: msg.value}();
            _wantAmt = msg.value;
        }
