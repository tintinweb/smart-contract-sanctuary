...
/*
-----------------------BNBMINER FOR BNB MINERS CLUB--------------------------

BNBMiner Smart Contract created for BNB Miners Club a Community of Crypto Enthusiast that will come 
together to Multiply their BNB through BNBMiners Dapps Perpetual Contribution Distribution System

    Verified Smart Contract
    NO BACKDOOR
    Sustainable Passive Income
    Exponential Active Income.
    No Referrals needed to earn
    DONATIONS FOR CHARITY

    2 PAY PLAN (DISTRIBUTION SYSTEM) WORKING SIMULTANEOUSLY.

        #1. GLOBAL PAYLINE - NO SPONSORING NEEDED. 
        The Next person to Register will be placed under the last person that joined creating a Global Payline. 
        participants Earn 1% again and again from the contributions and recontributions of 10 upline and 1% from
        Contribution and Recontribution of 25 to 40 people under you.

        #2. UNI-LEVEL PAY PLAN -
        Earn Active Exponential Income from Contribution and Recontribution of Your Referrals down to 6 levels.
            
            First Level - 25% From All Direct Referrals
            2nd Level   - 5% (required 2 directs)
            3rd Level   - 5% (required 3 directs)
            4th Level   - 5% (required 4 directs)
            5th Level   - 5% (required 5 directs)
            6th Level   - 10% (required 6 directs)
            
Safety Net of the Smart contract that makes this Payplan Sustainable:
    *50% of contribution is allocated for Singleline 
    *50% of contribution is allocated for Unilevel
    *30% to 60% of Participants income is contributed back to keep the BNB distribution perpetiual.
    *Breakage Funds is also been utilized, this is the unused portion of the contribution in the payplan.
        one source of Breakage is from 0.1 BNB contributors, Because they only gets 35%
        from the 50% allocation for Singleline pay structure so there is a 15% Breakage and 
        there is other sources of Breakage funds from payPlan.
        
Website : www.bnbminers.club
Telegram : t.me/bnbminersclub2

IMPORTANT NOTE:
Make sure to DYOR and Never Use funds that you can't afford to lose!!!
