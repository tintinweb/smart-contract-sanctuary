...
contract DogeChain is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x84199C8B988215C63272C8ECF3Fd836A8A4CAfc0); // Marketing Address
    address payable public charityAddress = payable(0x84199C8B988215C63272C8ECF3Fd836A8A4CAfc0); // Charity/Dev Address
