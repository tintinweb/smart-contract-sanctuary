...
/**
* Unicorn Inu is here. New $UNIINU Token will be Fair Launch on BSC this friday August 20th, 14:00 UTC
* 
* Telegram  t.me/unicorn_inu
* Tebsite  unicorninu.cc
* TTwitter  twitter.com/unicorn_inu_
* 
**/
...
contract UnicornInu is Context, IERC20, Ownable {
    ...
    address public constant TEAM_ADDRESS =
        0x2b0F1c7C49b1d4c2076F2Bf472789BFbDCa3753d;
    ...
    uint256 private _tTotal = 400 * 10**9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Unicorn Inu";
    string private _symbol = "Uniinu";
    ...
    uint256 public _maxTxAmount = 40 * 10**9 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 400 * 10**9 * 10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "Uniinu::transfer: Mkt value invalid"
            );
