...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9B53bF244372982ef1e11a2AE548bae68BEf31e6;
...
contract ZULUToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x340c663174FEFFA18E3b425E03d52580c52A339B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ZULUToken";
    string private _symbol = "ZULU";
