...
contract Shepherd is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 20000000 * 10**9; // Max Transaction: (4%)
    uint256 public _numTokensSellToAddToLiquidity = 50000 * 10**9;
    uint256 public _maxWalletToken = 32500000 * 10**9; // Max Transaction: (6.5%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'Shepherd';
    string private _symbol = 'German';
