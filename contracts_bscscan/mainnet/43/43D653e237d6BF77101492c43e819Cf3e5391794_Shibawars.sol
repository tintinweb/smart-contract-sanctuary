...
$SWARS was designed by PROGRAMMERS and DEVELOPERS, all with BSC NFT GAMING experience. $SWARS P2E games aim to rank first in the crypto world with next-generation technology. Since our project is based on the game and nft market, we will distribute prizes to our investors with the constantly renewed Web3. 0 games

By activating the NFT-Market immediately in our project, we will create a secure platform where direct communication between the seller and the buyer is established on our site. Nft sales will take place over $SWARS . No fee will be charged. $SWARS SWAP will be activated in the near future. In this way, you will be able to perform swap transactions on $SWARS 
...
contract Shibawars is ERC20, Ownable {
    ...
    constructor() ERC20("ShibaWars", "SWARS")  {
    ...
    function maxTx(uint256 value) external onlyOwner{
    ...
    function setSHIBArewards(uint256 value) external onlyOwner {
        buyFee = value;
    }
