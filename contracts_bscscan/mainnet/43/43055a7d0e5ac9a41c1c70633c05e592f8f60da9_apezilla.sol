...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 12000 * (10 ** 8);
...
contract apezilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Apezilla";
    string constant _symbol = "Apez";
    ...
    uint256 public swapThreshold = rSupply * 10 / 1000000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x713937d86E4D7AfC0682D7DAF22982c149162EE4;
        BuyBackReceiver = 0x2d648a84be791C1B47AE936241ebB057f9855C3d;
    ...
    function setSwapBackSettings(bool _enabled, uint256 _percentage_base1000000) external authorized {
        swapEnabled = _enabled;
        swapThreshold = rSupply.div(1000000).mul(_percentage_base1000000);
    }
