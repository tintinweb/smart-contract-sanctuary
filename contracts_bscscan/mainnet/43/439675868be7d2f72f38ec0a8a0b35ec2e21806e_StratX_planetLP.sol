...
contract StratX_planetLP is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public PLANET_WITHDRAW_FEE = 15;
    ...
    constructor() public {
        wantAddress = 0x74d51fC48013546D716a7884cc69d0Bb75807f8A;
        pid = 53;
        ...
        if (token0Address == ust) {
            earnedToToken0Path = [earnedAddress, wbnb, ust ];
        } else if (token0Address != earnedAddress) {
            earnedToToken0Path = [earnedAddress, wbnb, ust, token0Address];
        }

        if (token1Address == ust) {
            earnedToToken1Path = [earnedAddress, wbnb, ust];
        } else if (token1Address != earnedAddress) {
            earnedToToken1Path = [earnedAddress, wbnb, ust, token1Address];
        }
