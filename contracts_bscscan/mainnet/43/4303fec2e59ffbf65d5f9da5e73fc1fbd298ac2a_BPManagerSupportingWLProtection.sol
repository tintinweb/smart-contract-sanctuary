...
// File contracts/BPManagerSupportingWLProtection.sol
...
contract BPManagerSupportingWLProtection is AccessControl{
    ...
    function setWLLimits(
        ...
        _botProtectionContract.setWLLimits(sellCooldown_, sellLimit_, buyCooldown_, buyLimit_);
    }
