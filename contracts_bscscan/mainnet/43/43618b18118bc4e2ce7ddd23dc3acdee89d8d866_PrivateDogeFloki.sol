...
contract PrivateDogeFloki is Context, IERC20, Ownable {
    ...
    string private _name = "PrivateDogeFloki";
    ...
    address payable public marketingWallet = payable(0xDcfA46c0F83035007316be9BB66cC168Df8B78c4); 
    ...
    uint256 public minimumTokensBeforeSwap = 900000  * 10**9;
