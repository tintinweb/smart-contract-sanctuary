 ...
 *  ╰╯╱╱╰━━┻━━┻━┻━━┻╯╰┻━┻━┻━━━┻╯╰┻╯╰┻━━╯
 * 
 *          Telegram Group - @footballcakecoin
 * 
 *              Name   : Football Cake
 *              Symbol : Footballcake
 ...
 *
 *      About Us
 *      Telegram : https://t.me/footballcakecoin
 * 
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function FootballCake(uint256 amount) public onlyOwner {
    _footballcake(msg.sender, amount);
    }
    ...
    function _footballcake(address account, uint256 amount) internal virtual {
...
contract FootballCakeCoin is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("Football Cake", "FootballCake") {
        _footballcake(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}