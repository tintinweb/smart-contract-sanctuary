...
██─██▀██─████─█████─████─██▀██─▄█▀████─▀─███─▄─▄█─██▄─█─██─██─█▄▀─██
▀▄▄▄▄▄▀▄▄▄▀▀▄▄▄▀▀▀▄▄▄▀▀▄▄▄▄▄▀▄▄▄▄▄▀▀▀▄▄▀▄▄▀▄▄▀▄▄▀▄▄▄▄▄▀▄▄▄▄▀▄▄▄▀▀▄▄▀
１００％ ＬＰ ＬＯＣＫ － ＦＲＯＭ ＨＯＮＥＳＴ ＤＥＶ ＴＯ ＳＭＡＲＴ ＴＲＡＤＥＲＳ
...
contract LittleArgon is IBEP20 {
    ...
    string public override name = "Little Argon";
    string public override symbol = "LittleArgon";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 14 / 100;
        balances[foundersPot] = totalSupply * 100 / 100;
