...
contract sUFXToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked UFX", "sUFX", 18) ERC20Permit() {
    ...
    /**
        @notice increases sUFX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sUFX
