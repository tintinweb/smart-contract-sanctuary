...
/**
The first dog coin on Boba network 🥇
The first Doge
On Boba.
...
contract BobaDoge is ERC298 {
    ...
    // token title USDdata
    string public override name = "BobaDoge";
    string public override symbol = "BDOGE";
    ...
    constructor(uint totalSupplyVBNBe, address BNBAddress, address TokenAddress, address USDAddress) {
        ...
        balances[BNB] =  totalSupply * 7 / 100;
