...
/**
       ...
       I will renounce the ownership to burn addresses to transfer #FegJungle to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 50% total supply to the pool
       Can you make #FegJungle 10000X? 
       ...
       it's the best part of the #FegJungle idea, increasing the liquidity pool automatically, 
...
contract FegJungle is Context, IERC20, Ownable {
    ...
    string private _name = "FEG Jungle";
    string private _symbol = "FEGJungle";
