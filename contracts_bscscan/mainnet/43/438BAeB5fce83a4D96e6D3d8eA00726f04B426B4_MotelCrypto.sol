...
/*
    ...
    $$ |\$  /$$ |$$ |  $$ | $$ |$$\ $$   ____|$$ |      $$ |  $$\ $$ |      $$ |  $$ |$$ |  $$ | $$ |$$\ $$ |  $$ |
    $$ | \_/ $$ |\$$$$$$  | \$$$$  |\$$$$$$$\ $$ |      \$$$$$$  |$$ |      \$$$$$$$ |$$$$$$$  | \$$$$  |\$$$$$$  |
    \__|     \__| \______/   \____/  \_______|\__|       \______/ \__|       \____$$ |$$  ____/   \____/  \______/ 
                                                                            $$\   $$ |$$ |                         
                                                                            \$$$$$$  |$$ |                         
                                                                             \______/ \__|                         
    https://t.me/motelcrypto
 */
...
contract MotelCrypto is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Motel Crypto";
    string constant _symbol = "$Motel";
    ...
    function setFees(uint256 _devFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized capGasPrice {
        if(feesLocked) {
            require( _devFee.add(_buybackFee).add(_reflectionFee).add(_marketingFee) < (_feeDenominator.div(4)) );
        }
        devFee = _devFee;
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _devFee.add(_buybackFee).add(_reflectionFee).add(_marketingFee);
