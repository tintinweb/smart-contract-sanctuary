...
/**
 ...
 Join our telegram:  @ToroPancake   stealth launch !!! Potential token.
...
// CHANGE
contract TORKE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Toro Pancake";
    string constant _symbol = "$TPCS";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x803ED09f63F8e748351348ABAF30FF50D30aED60);
