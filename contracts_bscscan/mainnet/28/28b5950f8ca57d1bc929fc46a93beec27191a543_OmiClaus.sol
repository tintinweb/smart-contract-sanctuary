...
contract OmiClaus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xDf39f67afC3C6632D0704b4089B4FBda1253D34b;

    string constant _name = "OmiClaus";
    string constant _symbol = "OMC";
