...
contract Aliencoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x816eB13CEd17bF56B22A1304201eaD0C84E8990c); // Marketing Address

    address payable public teamAddress =
        payable(0x816eB13CEd17bF56B22A1304201eaD0C84E8990c); // Burn Address
    ...
    string private constant _name = "Aliencoin";
    ...
    uint256 public _maxTxAmount = 25 * 1e5 * 1e18;
    uint256 public _maxWalletToken = 1 * 1e7 * 1e18;
    ...
    constructor() {
        ...
        _maxTxAmount = _tTotal * 2 / 800; // 0.25% maxTransaction
        _maxWalletToken = _tTotal * 2 / 200; // 1% maxWallet
