...
/**
    ...
    5% of each transaction to the marketing wallet
...
contract TOASTEDV2 is Context, IBEP20, Ownable {
    ...
    string private _name     = "TOASTED V2";
    ...
    uint256 private _minTokenBalance = 10000000 * 10**9;
