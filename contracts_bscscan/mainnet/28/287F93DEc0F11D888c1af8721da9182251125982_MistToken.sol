...
contract MistToken is Context, IERC20, Ownable {
    ...
    string private _name = "Mist Token";
    string private _symbol = "Mist";
    ...
    uint256 public _burnFee = 5; // 5% burn fee
    ...
    uint256 public _maxWalletToken = 100000 * 10**9;
