...
/*
  ______    ______   __    __  __    __  _______    ______    ______   ______ 
 /      \  /      \ /  |  /  |/  |  /  |/       \  /      \  /      \ /      |
/$$$$$$  |/$$$$$$  |$$ | /$$/ $$ |  $$ |$$$$$$$  |/$$$$$$  |/$$$$$$  |$$$$$$/ 
$$ \__$$/ $$ |__$$ |$$ |/$$/  $$ |  $$ |$$ |__$$ |$$ |__$$ |$$ | _$$/   $$ |  
$$      \ $$    $$ |$$  $$<   $$ |  $$ |$$    $$< $$    $$ |$$ |/    |  $$ |  
...
//Contract
contract SAKURAGI is IBEP20, Ownable {
    ...
    string private constant _name = 'SAKURAGI';  
    ...
    uint8 private _marketingTax=60;
    ...
    uint256 public constant blacklistBlocks = 5;
...
/////////////////////////////   STAKING REWARDS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 BNBamount,bool newStakingReward) private {
        ...
        uint256 DevSplit = (BNBamount * _devTax) / totalRatio;
    ...
    function _swapContractToken(uint16 permilleOfPancake,bool ignoreLimits) private lockTheSwap{
        ...
        _swapTokenForBNB(swapToken); address distribute=address(StakeMulti);
        uint256 newBNB=(address(this).balance - initialBNBBalance);
        uint256 liqBNB = (newBNB*liqBNBToken)/swapToken;
        if (liqToken > 0) _addLiquidity(liqToken, liqBNB); 
...
/////////////////////////////   DISPLAY INFO  /////////////////////////////////////////
    ...
    function getBurntTokens() public view returns (uint256) {
        return (_totalSupply-_circulatingSupply);
    }
