...
contract Sedimentary is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x279918Da5374FAa34677EED1000Fe034299F9428); // Marketing Address
    address payable public charityAddress = payable(0x279918Da5374FAa34677EED1000Fe034299F9428); // Charity/Dev Address
    ...
    string private _name = "Sedimentary Token"; // nice
    string private _symbol = "SED";
