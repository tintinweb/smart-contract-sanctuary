...
Brought to you by the Castle Team through the TigerInu2022 Incubator
...
contract ELONCHINESEYR is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'ElonChineseYear';
    string private constant _symbol = 'ECY';
    ...
    uint256 public _asT = 400000 * (10 ** _decimals);
