...
/**
 *META VERSION - METAQUEENGIRL
 * 
 * New BNB reward token with reflections
 * 
 * Https://t.me/MetaQueenGirl
*/
...
contract MetaQueenGirl is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MetaQueenGirl";
    string constant _symbol = "METAQGIRL";
