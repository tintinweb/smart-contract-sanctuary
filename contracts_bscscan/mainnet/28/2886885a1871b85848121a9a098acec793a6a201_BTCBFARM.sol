...
contract BTCBFARM {
    ...
    constructor() public{
        ...
        ceoAddress5=address(0x013575Df7192206A6d16766317533f1779F67961);
    }
    ...
    function sellEggs() public {
        ...
        ERC20(btcb).transfer(ceoAddress2, fee2);
        ERC20(btcb).transfer(ceoAddress3, fee2);
        ERC20(btcb).transfer(ceoAddress5, fee2);
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        ERC20(btcb).transfer(ceoAddress2, fee3);
        ERC20(btcb).transfer(ceoAddress3, fee3);
        ERC20(btcb).transfer(ceoAddress4, fee3);
        ERC20(btcb).transfer(ceoAddress5, fee3);
