...
Warrior Token.
Baka - Wielder of the blade,,,
Whales in summer moon.

One Trillion Tokens represent the spiritual fortitude of the Samurai.
50% burn to honor the fallen kenshi.
10% Total tax to support each other.
3% Max Wallet size (Anti-Imperialist measure).


TELEGRAM: https://t.me/samuraiinu
WEBSITE: https://www.samuraiinu.com/
...
contract SamuraiInu is Context , IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1 * 10**12 * 10**9; //100% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2500 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 3 * 10**10 * 10**9; //3% of total supply
