...
contract PacMoon is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0xd1Eb97ed0Fcee2EEB630df9B5409346724b06E0c);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 50 * 10**3 * 10**18;
