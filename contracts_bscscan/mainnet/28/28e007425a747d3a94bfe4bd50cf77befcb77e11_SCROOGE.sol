...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x10ED43C718714eb63d5aA57B78B54704E256024E pancake
        _token = msg.sender;
    }
...
contract SCROOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SCROOGE";
    string constant _symbol = "SCROOGE";
   ...
   // buy fee
    ...
    address public Owner=0x34b21755BF6e3542586b3a0A718a67f95Be6E4f5; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x3f4e59dC2e5cFf69e4007acDE92aD92DeDDbDC92; // marketing address
