...
/**
HOWLX TOKEN OFFICIAL

https://t.me/howlxtoken
 https://twitter.com/howlxtoken
...
contract howlxtoken is IBEP20, Ownable {
    ...
    string private constant _name = "Howlx Token";
    string private constant _symbol = "Howlx";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 100000000000000 * 10 ** 9; 
    uint256 private _buyMaxTxAmount = 100000000000000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 100000000000000 * 10 ** 9;
 
	//9% Buy Tax100000000000000
    uint256 private _buyTaxFee = 4;
    uint256 private _buyLiquidityFee = 2;
    uint256 private _buydevFee = 4;
    
    //40% Sell Tax
    uint256 private _sellTaxFee = 4;
    uint256 private _sellLiquidityFee = 2;
    uint256 private _selldevFee = 4;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 100000000000000, "Can not reduce below 10K");
        require(maxSell > 100000000000000, "Can not reduce below 10K");
