...
contract Chill is Context, IERC20, Ownable {
    ...
    constructor(address payable marketingWalletAddress) public {
        _charityWalletAddress = 0x8B99F3660622e21f2910ECCA7fBe51d654a1517D; // binance charity wallet
    ...
    function sendBNBToCharity(uint256 amount) private {
        ...
        _charityWalletAddress.transfer(address(this).balance.mul(20).div(100));
        _marketingWalletAddress.transfer(address(this).balance);
    }

    function _setCharityWallet(
