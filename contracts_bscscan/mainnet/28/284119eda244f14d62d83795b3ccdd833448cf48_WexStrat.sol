...
//    address constant public unirouter  = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    address constant public wusd = 0x3fF997eAeA488A082fb7Efc8e6B9951990D0c3aB;
     ...
     */
    address[] public route0 = [wex, wbnb, busd];
    address[] public route1 = [busd, wusd];
    ...
    function addLiquidity() internal {   
        uint256 wexBal = IERC20(wex).balanceOf(address(this));
        
        IPanwexRouter(unirouterwex).swapExactTokensForTokensSupportingFeeOnTransferTokens(wexBal, 0, route0, address(this), now.add(600));

        uint256 busdbal = IERC20(busd).balanceOf(address(this));

        IPanwexRouter(unirouterwex).swapExactTokensForTokensSupportingFeeOnTransferTokens(busdbal/2, 0, route1, address(this), now.add(600));
