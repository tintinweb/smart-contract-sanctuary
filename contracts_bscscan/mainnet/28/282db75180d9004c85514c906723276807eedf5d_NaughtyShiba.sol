...
/**
NaughtyShiba BSC Token
Telegram: NaughtyShiba
*/
...
contract NaughtyShiba is Context,IBEP20,Ownable {
    ...
    string private constant _name = "NaughtyShiba";
    string private constant _symbol = "NTYSHI";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 1 * 10**12 * 10**9;
