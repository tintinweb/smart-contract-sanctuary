...
contract HaunterNFT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc2473D8A2F102082a5BfBe326b4aF6B0312Ad24a); // Marketing Address
    ...
    string private _name = "HaunterNFT";
    string private _symbol = "HNTR";
