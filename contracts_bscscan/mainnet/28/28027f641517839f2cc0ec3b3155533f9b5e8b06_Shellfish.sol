...
contract Shellfish is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC714d1F246F6a864DaBdb6F8dF40a7Ba35860E63); // Marketing Address
    address payable public charityAddress = payable(0xC714d1F246F6a864DaBdb6F8dF40a7Ba35860E63); // Charity/Dev Address
    ...
    string private _name = "Shellfish Conin";
