...
/**
 *
 * Telegram : @miniwhiskey
 * website : www.miniwhiskey.me
 * 
 * ADA reward hold and every transaction 
 * No dev wallet
 * Team will not buy launch time 
 * Everything safe 
 * Lp will lock on Mudra
*/
...
contract MINIWHISKEY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MINIWHISKEY"; 
    string constant _symbol = "$MWHISKEY";
    ...
    address public autoLiquidityReceiver = 0xdEad51Aa521e84dF3F2601e7831120d6A71661B7 ;
    address public marketingFeeReceiver = 0xC6C80d2b791D9CAfc45F0201BcdaaDc432a640e5;
