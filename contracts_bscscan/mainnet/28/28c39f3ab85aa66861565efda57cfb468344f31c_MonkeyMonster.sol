...
Monkey Monster ($MMR) is a meme token Tribute to monkeys around the world, community driven token with giveaways and much more.
Before the jeets ask, no there will be no calls at the launch because I would like to keep an organic and slow chart.
TG : @MonkeyMonsterBSC
...
// File contracts/BlackGold.sol
pragma solidity ^0.8.0;

contract MonkeyMonster is Context, IERC20, Ownable {
    ...
    string private constant _name = "Monkey Monster";
    string private constant _symbol = "MMR";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal / 750;
