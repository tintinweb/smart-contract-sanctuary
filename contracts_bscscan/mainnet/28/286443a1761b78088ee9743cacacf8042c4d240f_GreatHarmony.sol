...
contract GreatHarmony is Context, IERC20, Ownable {
    ...
    string private _name = "天下大同";
    string private _symbol = '天下大同';
    ...
    // 0.5% of Total Supply
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 50) / 10000;
