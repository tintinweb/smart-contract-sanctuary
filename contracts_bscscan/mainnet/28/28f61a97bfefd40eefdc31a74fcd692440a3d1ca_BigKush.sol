...
/**
 * @dev The official BigKush smart contract
 */
contract BigKush is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // General Info
    string private _name = "Big Kush";
    ...
    address payable public _marketingAddress =
        payable(0xF15e3F1B01BBc3F23CbBF12791DCF893C5472464); // Marketing address used to pay for marketing
    ...
    // BUYBACK
    bool public _enableBuyback = true; // Disabled on deployment
    ...
    uint256 public _buybackBNBPercentage = 0; // 1% of BNB is used to buyback tokens
    ...
    uint256 private _lotteryPool = 2; // How many reflections are in the lottery pool
    uint256 public _lotteryChance = 1; // 1% chance to win on a buy
