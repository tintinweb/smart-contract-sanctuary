...
/**
    Telegram     => muttgirlbsc
    Website      => muttgirl.soy
    Dev Telegram => nukedevcalls
...
contract DEPLOYABLE is Context, IERC20, Ownable {
    ...
    string private _name = "Mutt Girl";
    ...
    address payable public CharityWalletAddress =
        payable(0x9a74ED09f32843105d126Afbb77C99635E1dF8A0); // Charity Address
    ...
    uint256 public _CharityShare = 2;
    ...
    constructor() {
        ...
        isWalletLimitExempt[CharityWalletAddress] = true;
        ...
        isTxLimitExempt[CharityWalletAddress] = true;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBLiquidity = amountReceived
            ...
            .div(totalBNBFee)
            .div(2);
        uint256 amountBNBCharity = amountReceived.mul(_CharityShare).div(
            totalBNBFee
        );
