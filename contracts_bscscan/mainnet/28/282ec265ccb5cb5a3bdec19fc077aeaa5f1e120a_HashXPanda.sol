...
/**
 * 
 *      Welcome to Hash X Panda
 *          The Stealth Launch
 * 
 *          Hash X Panda - HXPANDA
 ...
 *    Website In Process
 * 
 *    Telegram Group https://t.me/hashxpanda
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function _hashxpanda(address account, uint256 amount) internal virtual {
...
contract HashXPanda is ERC200 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC200("Hash X Panda", "HXPANDA") {
        _hashxpanda(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}