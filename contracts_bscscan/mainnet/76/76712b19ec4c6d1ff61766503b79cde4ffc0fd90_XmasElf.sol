...
contract XmasElfDividendDistributor is IDividendDistributor {
...
contract XmasElf is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "XmasElf";
    string constant _symbol = "XE";
    ...
    */
    ...
    XmasElfDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new XmasElfDividendDistributor(address(router), BUSD);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        BUSD = rewardToken;
        distributor = new XmasElfDividendDistributor(address(router), rewardToken);
    }	
