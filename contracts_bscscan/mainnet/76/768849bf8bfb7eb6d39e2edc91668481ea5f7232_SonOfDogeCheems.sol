...
contract SonOfDogeCheems is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SonOfDogeCheems ", "SonOfDogeCheems") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SonOfDogeCheems";
    string private _symbol = "SonOfDogeCheems";
