...
contract AnjiRouter is IPancakeRouter02 {
    ...
    uint256 public anjiFeeAmount = 2;
    address public anjiFeeAddress = 0x6134F23bB8ec4B1532683783C4c3Dac1d2EC94bB;
    ...
    function _transferAnjiFee(address token, uint amount) internal {
        uint fee = amount.mul(anjiFeeAmount)/10000;
        TransferHelper.safeTransferFrom(token, msg.sender, anjiFeeAddress, fee);
    }
