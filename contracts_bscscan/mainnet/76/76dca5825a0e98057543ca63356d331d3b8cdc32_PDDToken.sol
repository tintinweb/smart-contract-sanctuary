 ...
 * 
 */
contract PDDToken is IERC20 {
    
    using SafeMath for uint256;
    
    //PDD token, creator will take 5% fee
    address public feeTo = 0xCB2084bD74f84cE11B2eA4Bbe983Db64f799F0F6;

    string public name = "PDD Token";
    string public symbol = "PDD";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //PDD Token supply max length
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 PDD
