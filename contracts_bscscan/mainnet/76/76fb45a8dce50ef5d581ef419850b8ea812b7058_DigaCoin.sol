...
contract DigaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4357D5443791545A248E088E12879C1Bf453A0aa); // Marketing Address
    address payable public charityAddress = payable(0x7DCbB71Da412Af5565f15127867B746b520d8111); // Charity/Dev Address
    ...
    uint256 private minimumTokensBeforeSwap = 80000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 800000;
