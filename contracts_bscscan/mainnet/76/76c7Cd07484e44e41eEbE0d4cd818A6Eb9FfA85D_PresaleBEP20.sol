...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public softCapEthAmount = 105 ether;
    uint256 public hardCapEthAmount = 210 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x90Ae6F64518A4e24A3e7bD949470B37C63fB30AF;
        liquidity = _liquidity;

        presaleStartTimestamp = 1625682336;
        presaleEndTimestamp = 1625700336;
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.000007724 ether; // 129471.594 tokens per BNB
