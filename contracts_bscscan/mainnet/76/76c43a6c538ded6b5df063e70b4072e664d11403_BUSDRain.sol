...
contract BUSDRain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BUSDRainDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x7f5374B36ed6924B21d8BC436F889123A62555a2;
    address public _devWalletAddress = 0x1fd26C23EAE25E8f29247030d9AAD2Dbf44d448D;
    ...
    constructor() public ERC20("BUSDRain", "BUSDR") {

    	dividendTracker = new BUSDRainDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BUSDRainDividendTracker newDividendTracker = BUSDRainDividendTracker(payable(newAddress));
...
contract BUSDRainDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BUSDRain Dividends", "BUSDRain_dividends") {
    	claimWait = 3600;
