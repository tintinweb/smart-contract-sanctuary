 ...
 * 
 * Friday 13th Token The most haunted token on BSC Fair Launch Friday 13th 20:00 UTC
 * 
**/
...
contract Friday13thToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address public constant TEAM_ADDRESS =
        0x24fbba0a53b5F2f406101625B86aB5E94c6a29d3;
    ...
    uint256 private _tTotal = 13000 * 10**9 * 10**18;
    ...
    uint256 public _maxTxAmount = 13000 * 10**9 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 13000 * 10**9 * 10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "FRI13::transfer: Mkt value invalid"
            );
