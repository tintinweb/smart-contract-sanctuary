...
contract SAFEFLOKI is Context, IERC20, Ownable {
    ...
    string private _name = "Alphalink";
    ...
    uint256 public _maxTxAmount = 20000000 * 10**18; // 20 Million inicial máx transfer
    ...
    address public buybackv1Address  = 0x85463248Ec26749E094F5e5ff73cb877F86298Ee;      // BuyBackv1 Address
    address public buybackv2Address  = 0x6Bd92d6fE8234CF80b3b31c8e38D2DA116343457;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x00035EFf58b222805C0177e8Bd18ae56097Ce515;      // SMarketing Address
