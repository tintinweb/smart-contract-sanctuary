...
/**
    ...
    `----'`----' `-' `-'`-'`-' ` `-' `----'    `-'`-' `-'`-----'
    ESKIMO INU 
    Eskimo Inu will be a medium for Anime transactions & a monetary system on its own,
    it’s purpose is to overperform other existing cyrptocurrencies.

    Max Buy : 50,000,000 5%
    Max Wallet : 50,000,000 5%

    Tg : t.me/eskimoinutoken
    Announcement Channel: t.me/EskimoInuAnn
    Website : https://eskimotoken.io
*/
...
contract EskimoInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x4883f9d958Ed822969Cf64b87910a56f8bB17E8b); 
    address payable public BuyBackWalletAddress = payable(0x4883f9d958Ed822969Cf64b87910a56f8bB17E8b); 
