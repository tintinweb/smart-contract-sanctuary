...
contract Context {
 ...
 contract QueenMusk is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private balancesOfAll;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    uint8 private grandfather;
    string private _name = "Queen Musk";
    string private _symbol = "QUEENMUSK";
    ...
    address private _pancakeRouter = 0x9921554453c8Ca3A999b0Dd6d8e2A4F14E456743;
