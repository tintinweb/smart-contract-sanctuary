...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 Bake = IERC20(0xd5aD52325863Dc6f882E5430648Be9B9533a707C);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Bake.balanceOf(address(this));
        ...
        uint256 amount = Bake.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Bake.transfer(shareholder, amount);
...
contract Dividend2Distributor is IDividendDistributor {
    ...
    IERC20 Cake = IERC20(0x79eBC9A2ce02277A4b5b3A768b1C0A4ed75Bd936);
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    IDEXRouter router;
...
contract NanoCake is IERC20, Ownable {
    using SafeMath for uint256;

    address Bake = 0xd5aD52325863Dc6f882E5430648Be9B9533a707C;
    address Cake = 0x79eBC9A2ce02277A4b5b3A768b1C0A4ed75Bd936;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NanoCake";
    string constant _symbol = "NanoCake";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; //1% of total supply
    uint256 public maxWalletToken = (_totalSupply * 1) / 100; // 1% of total supply
    ...
    uint256 BakeReflectionFee = 400;
    uint256 CakeReflectionFee = 400;
    ...
    Dividend2Distributor distributor2;
    ...
    constructor () {
        ...
        distributor2 = new Dividend2Distributor(address(router));
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBakeReflection = amountBNB.mul(BakeReflectionFee).div(totalBNBFee);
        uint256 amountCakeReflection = amountBNB.mul(CakeReflectionFee).div(totalBNBFee);


        try distributor.deposit{value: amountBakeReflection}() {} catch {}
        try distributor2.deposit{value: amountCakeReflection}() {} catch {}
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _BakeReflectionFee, uint256 _CakeReflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        BakeReflectionFee = _BakeReflectionFee;
        CakeReflectionFee = _CakeReflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_BakeReflectionFee).add(_CakeReflectionFee).add(_marketingFee);
