...
/**
   ...
   Welcome to LittleBabySolana
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabySolanaBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabySolana to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabySolana idea, increasing the liquidity pool automatically, 
...
contract LittleBabySolana is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby Solana";
    string private _symbol = "LTBABYSOL";
