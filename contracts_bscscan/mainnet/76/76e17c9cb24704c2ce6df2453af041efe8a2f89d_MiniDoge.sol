...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @MiniDogeBSC
   Important: The early you create a group that shares the token, the more gain you got.
    
	I will add 0.25 BNB and all the left 25% total supply to the pool!
