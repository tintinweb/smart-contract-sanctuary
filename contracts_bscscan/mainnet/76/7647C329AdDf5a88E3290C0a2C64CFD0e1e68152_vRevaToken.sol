...
// File: contracts/reva/vRevaToken.sol

pragma solidity 0.6.12;


// SyrupBar with Governance.
contract vRevaToken is BEP20('reva voting token', 'VREVA') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "VREVA::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "VREVA::delegateBySig: invalid nonce");
        require(now <= expiry, "VREVA::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "VREVA::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "VREVA::_writeCheckpoint: block number exceeds 32 bits");
