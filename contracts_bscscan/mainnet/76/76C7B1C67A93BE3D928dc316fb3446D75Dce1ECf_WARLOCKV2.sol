...
contract WARLOCKV2 is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    string private NAME_CONTRACT="Warlock";
    string private NICK_CONTRACT="WRLK";
    ...
    WARLOCKV2DividendTracker public dividendTracker;
   ...
   // uint256 private _previousTotalFees = totalFees;
    ...
    constructor() public ERC20(NAME_CONTRACT, NICK_CONTRACT) {

    	dividendTracker = new WARLOCKV2DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        WARLOCKV2DividendTracker newDividendTracker = WARLOCKV2DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the WARLOCKV2 token contract");
...
contract WARLOCKV2DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("WARLOCKV2_Dividen_Tracker", "WARLOCKV2_Dividend_Tracker") {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 400000 * (10**9);
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "WARLOCKV2_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "WARLOCKV2_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WARLOCKV2 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "WARLOCKV2_Dividend_Tracker: claimWait must be updated to between 20 mins and 24 hours");
        require(newClaimWait != claimWait, "WARLOCKV2_Dividend_Tracker: Cannot update claimWait to same value");
