...
// https://t.me/Wildtimestokenbsc 15% 9% buyback 2% lp 4% marketing contract stacks rewards and unload it on sells do not snipe it
...
// CHANGE
contract Wild$T1mes is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _symbol = "Wild$T1mes";
    ...
    uint256 reflectionFee = 9000; // 10% I will keep a marketing wallet and use rewards to pay for influencers
    uint256 devFee = 0; // 0%
    uint256 totalFee = 9200; // liquidityFee + reflectionFee + devFee
