...
TG  - https://t.me/Minisphynxbsc
Website - http://www.minisphynx.com/
...
import "./SphynxDividendTracker.sol";
...
contract Sphynx is ERC20, Ownable {
    ...
    constructor() public ERC20("MiniSphynx", "Sphynx") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "Sphynx: The new dividend tracker must be owned by the MiniSphynx contract");
