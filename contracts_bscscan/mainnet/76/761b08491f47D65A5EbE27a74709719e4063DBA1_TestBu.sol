...
contract LTC_DISTRIBUTOR is IDividendDistributor { // TO-DO change contract name
    ...
    IBEP20 LTC = IBEP20(0x4338665CBB7B2485A8855A139b75D5e34AB0DB94); // LTC address
...
contract TestBu is IBEP20, Auth { // TO-DO change contract name
    using SafeMath for uint256;

    address public LTC = 0x4338665CBB7B2485A8855A139b75D5e34AB0DB94; //LTC address
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address zeroAddress = 0x0000000000000000000000000000000000000000;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public externalAddress = 0xCa9cb6Fa442003754AA3726672A72EB7D87Eb3d0; //TO-DO change external address
    address public autoLiquidityReceiver = 0xCa9cb6Fa442003754AA3726672A72EB7D87Eb3d0; //TO-DO change liquidty owner address

    string constant _name = "TestBu";
    string constant _symbol = "TestBu";
    ...
    uint256 public _maxTokensPerAddress         = 1000000000 * 10**6 * 10**_decimals; // Max number of tokens that an address can hold
	...
	*/
    ...
    function setMaxTxLimit(uint256 amount) external authorized {
     ...
     /**  
     * @dev set max amount any wallet can hold
     */
    function setMaxHolding(uint256 amount) external authorized {
        _maxTokensPerAddress = amount.mul(10**_decimals);
    }

    /**  
     * @dev burn amount of tokens manually
     */
    function reduceSupply(uint256 amount) external authorized {
        _totalSupply = _totalSupply.sub(amount.mul(10**_decimals));
