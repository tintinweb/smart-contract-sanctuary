...
contract BabyDogeFOOD is Context, IERC20, Ownable {
    ...
    string private _name = "BabyDoge FOOD";
    string private _symbol = "BabyDogeFOOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeec856bd1017916b766ff7C5e9A3C3bD3F26Adb5); // Marketing Address
    address payable public teamWalletAddress = payable(0x9db5f76576d86A3035014FFb81C83E0999fa899C); // Team Address
