...
/**
   ...
   Welcome to Humility Doge
   
   This is a community token. If you want to create a telegram I suggest to name it to @HumilityDoge
   ...
   Can you make #HumilityDoge 10000X? 
...
contract HumilityDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6535BCB8EB517B994cD77Fa681DA3C17769DA4ce); // Marketing Address
    ...
    string private _name = "Humility Doge";
