...
// File: contracts/TESTDONTBUYITLOLDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x46880afc2E6FA41bBbE9787c082f7c23F795465E);
...
// File: contracts/TESTDONTBUYITLOL.sol
...
contract TESTDONTBUYITLOL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x46880afc2E6FA41bBbE9787c082f7c23F795465E);
    address private _liqAdd = address(0x7be02D9347dE1c20e854f9832843A34D195ce9F4);
    address private _LPadd = address(0xd87F4D7EF18bFb62176Bec90Bd994B23070c5D28);

    bool private swapping;
    bool public airdrop;

    TESTDONTBUYITLOLDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public liqAdd;
    address public LPadd = _LPadd;

    uint256 public maxBuyTranscationAmount = 1500000 * (10**18); // 0.75%
    uint256 public maxSellTransactionAmount = 100000000 * (10**18); // No limit
    uint256 public swapTokensAtAmount = 20000 * (10**18);
    uint256 public _maxWalletToken = 1500000 * (10**18); // 1.5%
    ...
    constructor() public ERC20("TESTDONTBUYITLOL", "TESTDONT") {
    	...
    	dividendTracker = new TESTDONTBUYITLOLDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "TESTDONTBUYITLOL: The dividend tracker already has that address");

        TESTDONTBUYITLOLDividendTracker newDividendTracker = TESTDONTBUYITLOLDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "TESTDONTBUYITLOL: The new dividend tracker must be owned by the TESTDONTBUYITLOL token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TESTDONTBUYITLOL: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TESTDONTBUYITLOL: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TESTDONTBUYITLOL: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "TESTDONTBUYITLOL: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TESTDONTBUYITLOL: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TESTDONTBUYITLOL: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "TESTDONTBUYITLOL: This account cannot send tokens until trading is enabled");
        }
        ...
        if(
            ...
            uint256 swapTokens = contractTokenBalance.mul(3).div(totalFees);
...
contract TESTDONTBUYITLOLDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("TESTDONTBUYITLOL_Dividend_Tracker", "TESTDONTBUYITLOL_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "TESTDONTBUYITLOL_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "TESTDONTBUYITLOL_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TESTDONTBUYITLOL contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "TESTDONTBUYITLOL_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "TESTDONTBUYITLOL_Dividend_Tracker: Cannot update claimWait to same value");
