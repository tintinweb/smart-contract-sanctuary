...
Introducing FlokiFomo
The first token on the BSC smartchain to combine the rebase rewards with rewards.
Hold $FlokiFomo and receive $ETH directly to your BEP-20 wallet as a reward for holding

TG: https://t.me/flokifomo
*/
...
contract FlokiFomo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FLOKI FOMO";
    string constant _symbol = "$FlokiFomo";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xF1c305286010bFFCf76BE38fC3060460deFFf1a4;
        marketingFeeReceiver = 0x1AC235264b3c2a39b645eC0c71107AB984d7E5cf;
