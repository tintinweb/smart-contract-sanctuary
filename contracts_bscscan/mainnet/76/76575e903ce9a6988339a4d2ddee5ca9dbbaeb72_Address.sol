...
// change "name1" into ur name
    contract AgeofGods is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Age of Gods";
    ...
    uint256 internal _tokenTotal = 100_000_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0x988B18816Ad66AdBebca2251a730f09D99554525;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
