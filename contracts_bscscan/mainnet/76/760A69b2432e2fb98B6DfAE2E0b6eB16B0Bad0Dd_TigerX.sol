...
library Address{
 ...
 contract TigerX is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4F8f44B50AE68B94d034c2AC3FA6e6a4e03092Df;
    address public donationWallet = 0x5B8EFe44C793f0AeCD9d3AAA405bee81E85D8121;

    string private constant _name = "Tiger X";
    ...
    Taxes public taxes = Taxes(2, 5, 3, 5);
    Taxes public sellTaxes = Taxes(2, 5, 3, 5);
