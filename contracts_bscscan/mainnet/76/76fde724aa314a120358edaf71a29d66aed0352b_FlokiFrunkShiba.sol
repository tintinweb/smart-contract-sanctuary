...
contract FlokiFrunkShiba is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiFrunkShiba";
    string private _symbol = "FrunkShibaCOIN";
    ...
    uint256 public _maxWalletToken = 200 * 10**11 * 10**9; // Max Wallet: (2 %)
