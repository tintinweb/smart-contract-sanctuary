...
contract MiniFamilyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf54406C2E03e8859258aA9daf313a979bcfE8E21);
    ...
    string private _name = "MiniFamilyDoge";
    string private _symbol = "MiniFamilyDoge";
    ...
    function _getSellBnBAmount(uint256 tokenAmount) public view returns(uint256) {
        address[] memory path = new address[](2);
