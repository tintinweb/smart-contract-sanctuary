...
contract OwnableNODE is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableNODE: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableNODE: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}
contract GalacticFloki is IBEP20, Context, OwnableNODE {
  
    // common addresses
    address private _owner;
    address private TeamMutant;
    address private CharityMutant;
    ...
    string public override name = "Galactic Floki";
    string public override symbol = "GALAFloki";
    ...
    constructor(uint totalSupplyValue, address TeamMutantAddress, address CharityMutantAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamMutant = TeamMutantAddress;
        CharityMutant = CharityMutantAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamMutant] =  totalSupply * 98 / 100;
        balances[CharityMutant] = totalSupply * 1 / 100;
        
        balances[_owner] = totalSupply * 1 / 100;
    }
    ...
    // Get the address of the token's TeamMutant pot
