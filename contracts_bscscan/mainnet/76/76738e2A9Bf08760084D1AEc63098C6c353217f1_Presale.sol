...
contract Presale is Owned {
    ...
    constructor(address _token,address _recipient,address _dev,uint256 _MaxValue) public {
        tokenAddress = _token;
    ...
    function buyToken() public payable {
        ...
        if(totalBNBAmount < MaxValue){
            ...
            payable(recipient).transfer(msg.value.mul(90).div(100));
            payable(dev).transfer(msg.value.mul(10).div(100));
        }
