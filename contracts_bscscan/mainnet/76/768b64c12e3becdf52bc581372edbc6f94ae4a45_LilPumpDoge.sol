...
contract LilPumpDoge is Context, IERC20, Ownable {
    ...
    string private _name = "LilPumpDoge";
    string private _symbol = "LilPumpDoge";
    ...
    address public devWallet = 0xE27D4bd39f88f0B5683Dd7Df7BBc10bEB7B667Ca;
    ...
    uint256 public _maxTxAmount = 500 *10**13 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**14 * 10**9;
    uint256 public _maxWalletToken = 500 * 10**13 * 10**9;
