...
/**
https://t.me/TraumatizedMrIncredible
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract TraumatizedMrIncredible is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xDaca319F060a6D86A81eD6D4538abB9b4B6b9feD); // Marketing Address

    address payable public teamAddress =
        payable(0x1e40FDadd53134A4C1232eB7F8eE73A8b5855691); // Team Address

    address payable public liquidityAddress =
        payable(0x1e40FDadd53134A4C1232eB7F8eE73A8b5855691); // Liquidity Address
    ...
    string private constant _name = "TraumatizedMrIncredible";
