...
(⨀ ⯋ ⨀)
  ◡  ◡
    ...
    - 5% fee per transaction auto add to the liquidity pool
    - 1% send to dev/marketing wallet
    - 1% burned forever

    1,000,000,000,000,000 total supply (1 Quadrillion)
    500,000,000,000,000 tokens burned at launch
    
    Renouncing Ownership + Liquidity locked in Telegram
    Telegram : https://t.me/ChookityPokBSC
...
contract Pok is Context, IERC20, Ownable {
    ...
    address private _devAddress = 0xf80C4f177334C0563ac475f96Af4a9776b9e55F4;
    address private _burnAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "Chookity";
