...
TheLastRise is built upon the fundamentals of Buyback and increasing the investor's value    
    
1) 4% tax is collected and distributed to holders for HODLing
2) 6% buyback and marketing tax is collected and 3% of it is sent for marketing fund and othe 6% is used to buyback the tokens
...
contract TheLastOneToRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x578663BfA0B9C6a255f90b14BCB1de13584D2F5B); // Marketing Address
    ...
    string private _name = "TheLastOneToRise";
    string private _symbol = "LastRise";
