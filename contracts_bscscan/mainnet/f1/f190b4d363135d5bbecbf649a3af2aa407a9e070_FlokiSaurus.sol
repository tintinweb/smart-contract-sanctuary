...
🔹 Max Tx at launch: 1% of the total supply
🔹Max Wallet: 2% of the total supply
—————————————————————
...
contract FlokiSaurus is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FlokiSaurus", "fSaurus") public {
