...
contract GOMAMOON is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xBbD6C2D983138516E2Bc3E2b1FB9053beB4F0684); // Marketing Address
    ...
    string private _name = "GOMAMOON";
    string private _symbol = "GOMAMOON";
