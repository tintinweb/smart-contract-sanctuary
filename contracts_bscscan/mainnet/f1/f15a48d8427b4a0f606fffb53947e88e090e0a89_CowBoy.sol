...
contract Ownable is Context {
    address private _owner = 0x7777773BDdE6C8cbBcB782DC2672cdc4B30fB6Af;
...
contract CowBoy is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "CowBoy Coin"; // token name
    string private _symbol = "CowBoy"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 40000 * 10**1 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
