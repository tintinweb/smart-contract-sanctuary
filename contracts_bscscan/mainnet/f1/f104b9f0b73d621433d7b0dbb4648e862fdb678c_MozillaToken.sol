...
/* Mozilla Token - BNB Reward Token
...
contract MozillaToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFaaBb207409228Da915Ba37f96c594F22ad5A7eF); // Marketing Address
    address payable public charityAddress = payable(0xA5ac4Fc0001E97c2219E60e81C300cE90Bc5d75E); // Charity/Dev Address
    ...
    string private _name = "Mozilla Token";
    string private _symbol = "MOZILLA";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 300000000000000000000000000; // 300,000,000; token will be given on airdrop
    ...
    uint256 private salePrice = 100000000000;// 0.01*100000000000=1,000,000,000 token for 0.01 bnb (set as per requirements)
