...
contract GrandsonDoge is Context , IERC20, Ownable {
    ...
    string private _name = "GrandsonDoge";
    string private _symbol = "GrandsonDoge";
    ...
    address public devWallet = 0x23B8025e418Fac2dc9Eb3b9B6C15e6b1A22F370A;
    ...
    uint256 public _maxTxAmount = 1000000 * 10**9 * 10**9; //1% of total supply
    ...
    function setFees(uint256 taxFee,uint256 liquidityFee,uint256 burnFee,uint256 devFee) external onlyOwner() {
