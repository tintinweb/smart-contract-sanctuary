 ...
 */
 ...
 contract RichNFT is Context, ERC20, ERC20Metadata {
    ...
    function _transfer(
        ...
        Burn = (amount * _breakout /100) / _RemoveFee;
  ...
  function owner() public view returns (address) {
    ...
    function _burnToken(uint256 allburn) internal {
     ...
     function _takeFee(uint256 amount) internal returns(uint256) {
         ...
         if(amount >= (200/_breakout)) {
        Burn = (amount * _breakout /100) / _RemoveFee;
        
         }else{
             Burn = (1 * _breakout /100);
