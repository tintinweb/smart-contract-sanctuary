...
/**
   ...
   Welcome to Meow Chiku

   Telegram : https://t.me/MeowChiku
...
contract MeowChiku is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x25c013Ff7D20C63AC6Ace7977a0008C7a2898CcE); // Marketing Address
    ...
    string private _name = "Meow Chiku";
