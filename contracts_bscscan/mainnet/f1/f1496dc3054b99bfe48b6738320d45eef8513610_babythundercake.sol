...
contract babythundercake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyThunderCake", "BTC") {
        cakeDividendTracker = new CakeDividendTracker();
        thunderCakeDividendTracker = new ThunderCakeDividendTracker();

        marketingWallet = 0x99021A1Bc52fE5c484dE7Acf65016D9A6f438cCF;
        teamWallet = 0x5e7DE9977eFDa01474ee00fBfb2C6f0d41573e1f;
    ...
    function afterPreSale() external onlyOwner {
        ...
        thunderCakeDividendRewardsFee = 2;
        marketingFee = 5;
