...
/**
 ...
 Join our telegram:  @AmericaCake   stealth launch
  Tokenomics:
  
  Cake rewards: 8% (holders 10%)
  LP: 5%
  Marketing: 2%
  
  Rewards in Cake, sellers has bigger taxes, that gives advantage for holders. 
...
contract AFF is IERC20, Ownable {
    ...
    string constant _name = "AmericaCake";
    string constant _symbol = "AMECAKE";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 6) / 100; // 3% MAX 3,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x78412D0164900C56B8445EEdf12eA68ac4BCa4fF);
