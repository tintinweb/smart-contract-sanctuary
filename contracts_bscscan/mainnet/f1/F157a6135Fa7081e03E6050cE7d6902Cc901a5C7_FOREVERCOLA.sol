...
Telegaram : https://t.me/ForeverColaBsc
Website : https://t.me/ForeverColaBsc
...
contract FOREVERCOLA is ERC20, Ownable {
    ...
    constructor() ERC20("FOREVERCOLA", "FOREVERCOLA") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x159876EDf32F23B7a1FbE051ae9a69f8a91a5915;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "FOREVERCOLA: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "FOREVERCOLA: The new dividend tracker must be owned by the FOREVERCOLA token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("FOREVERCOLA_Dividend_Tracker", "FOREVERCOLA_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "FOREVERCOLA_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "FOREVERCOLA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "FOREVERCOLA_Dividend_Tracker: claimWait" );
