...
https://t.me/UltimatePolka
Stealth Launch BSC Token
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 Rewarding = IERC20(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402);
...
contract UltimatePolka is IERC20, Ownable {
    using SafeMath for uint256;

    address Rewarding = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "UltimatePolka";
    string constant _symbol = "ULTIPOLKA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals); 

    uint256 public _maxTxAmount = (_totalSupply * 10) / 50; 
    uint256 public _maxWalletSize = (_totalSupply * 50) / 1000; 
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x1Ce608564076Cd218879F9C6AD8bf697adeD09B7);
