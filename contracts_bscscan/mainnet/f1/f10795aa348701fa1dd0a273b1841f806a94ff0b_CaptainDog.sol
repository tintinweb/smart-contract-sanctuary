...
Captain Dog is the first multi-reflection token without bot sell features.
With the auto claim feature, you'll recieve Bitcoin, Ethereum & Cardano in your wallet every 15 minutes.

🌏 Telegram: t.me/captaindogbsc
🌏 Website: www.captaindog.finance
🌏 Twitter: twitter.com/captaindogbsc

🔒 Lp Lock for 3 years via Dx-Sale

🐕 Our Tokenomics
Total supply: 10,000,000,000 (15% Tax)
...
No need to claim your earned (BTC, ETH & ADA) it's automatically sent to your wallet every 15 minutes.
*/
...
contract CaptainDog is Context, IERC20, Ownable {
    ...
    uint256 public
    _taxFee = 12;  //12% Redistribution
    uint256 private
    _previousTaxFee = _taxFee;
   
    
    uint256 public
    _burnFee = 1;  //1% Tax to BNB reward pool
    uint256 private
    _previousBurnFee = _burnFee;
    
    
    uint256 public
    _liquidFee = 2; //2% Liquidity lock forever
    uint256 private
    ...
    private 
    liquidAddress 
    = 0x032F501398C08F33d8e170756058A88dDc23e390;
