...
contract AdvensturesSlot is TransferOwnable   { 
    ...
    function tokens_create(address _tokens_address, string memory _symbol, uint256 _least) public onlyAdmin {   
        uint256 tokensId = tokensLength++;
        TOKENS storage tk = tokensInfo[tokensId];
        tk.tokensId = tokensId;
        tk.tokens_symbol = bytes(_symbol);
        tk.tokens_least = _least;
        tk.tokens_address = _tokens_address;  
        tk.updateTime = block.timestamp; 
    }
    function tokens_set(uint256 _tokensId, address _tokens_address, string memory _symbol, uint256 _least) public onlyAdmin {   
	...
	constructor()   { 
        ...
        tokens_create(0x4ECfb95896660aa7F54003e967E7b283441a2b0A,'FRUIT',1000); // FRUIT 
        //tokens_create(0x4ECfb95896660aa7F54003e967E7b283441a2b0A,'FRUIT',1000); // FRUIT 
        //tokens_create(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82,'CAKE',100); // CAKE 
        tokens_create(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95,'BANANA',100); // BANANA
        
        domain_create("fruitsadvenstures", 20, 0x2037f7E7242abd6B71938fb83D2c65DE5D4A42B0); 
        //domain_create("advensturesFruit", 20, 0x2037f7E7242abd6B71938fb83D2c65DE5D4A42B0);  
        //domain_create("advensturesCake", 20, 0x39a73DB5A197d9229715Ed15EF2827adde1B0838);  
