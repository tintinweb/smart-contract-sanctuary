...
contract sonofbinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Son of Binance"; // 
    ...
    uint256 liquidityFee    = 5; // ammount to LP
    uint256 reflectionFee   = 5; // ammount to rewards
    uint256 marketingFee    = 5; // ammount to marketing wallet
