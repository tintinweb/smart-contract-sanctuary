...
contract BabyHulk is Context, IERC20, Ownable, Versionable {
    using SafeMath for uint256;
    ...
    constructor () {
        _name = "BabyHulk Coin";
        _symbol = "BHC";
        _totalSupply = 200 * 10**9 * 10**_decimals;

        _balances[owner()] = _totalSupply;

        _burnFee = 4000000;
        _teamFee = 1000000;
        _marketingFee = 4000000;
        _devFee = 1000000;

        _maxTxAmount = _totalSupply / 100 * 25;
        _minTxAmount = _percentFactor;

        _burnAddr = 0x000000000000000000000000000000000000dEaD;
        _teamAddr = 0xFc870A4edc265f765c62b198829E0b87d3E80a50;
        _marketingAddr = 0x062F30F3345bE9692afC13565E2856c6D064e9Fd;
        _devAddr = owner();
