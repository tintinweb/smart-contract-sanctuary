...
// http://www.magicempire.world/
// https://t.me/s/MagicEmpire_Channel
// https://twitter.com/magicempire_bsc
 ...
 * the owner.
 */
contract DxsalesPresale is AntiBot {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "DxsalesPresale: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DxsalesPresale: new owner is the zero address");
...
contract MagicEmpire is AntiBot, IBEP20, DxsalesPresale {
    ...
    string private _name = "MagicEmpire";
    string private _symbol = "Mempi";
    ...
    address public charityWallet = 0x7d37CbBB2b784BdE1f4E08f8e15497b0CE01eA72;
