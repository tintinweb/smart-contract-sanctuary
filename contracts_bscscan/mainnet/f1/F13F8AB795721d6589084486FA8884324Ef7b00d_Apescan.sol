...
The first cross-chain DeFi analytics platform featuring yield farming,
NFTs, vault integration, and more. Token holders receive 80% of in-app
advertising revenue and free airdrops from partnered projects.

🙈  ApescanLitepaper : https://apescan.com/ApescanLitepaper.pdf

🙈  Apescan Community : https://discord.com/invite/9uUXuDAxFD

𝔻𝕖𝕔𝕖𝕟𝕥𝕣𝕒𝕝𝕚𝕫𝕖𝕕. 𝔻𝕖𝕞𝕠𝕔𝕣𝕒𝕥𝕚𝕫𝕖𝕕. 𝕆𝕡𝕥𝕚𝕞𝕚𝕫�
...
contract Apescan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9dd1A41E0568173871eCF34A85737BC3FF2670B5); // Marketing Address
    ...
    string private _name = "Apescan Token";
