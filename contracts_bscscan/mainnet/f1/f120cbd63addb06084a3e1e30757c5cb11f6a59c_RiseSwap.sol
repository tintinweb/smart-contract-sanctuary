...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @RiseSwap
   ...
   I will renounce the ownership to burn addresses to transfer #LuckySHIB to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make #RiseSwap 10000X? 
...
contract RiseSwap is Context, IERC20, Ownable {
    ...
    string private _name = "RiseSwap";
    string private _symbol = "RiseSwap";
