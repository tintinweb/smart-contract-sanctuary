...
contract lunamoon is Context, IERC20, Ownable {
    ...
    string private _name = "lunamoon v2";
    ...
    constructor () public {
        address ownerSupply = 0xbd9Aa949290e47D7FE90aec9bB3951E08ce811aE;
        _rOwned[ownerSupply] = _rTotal;
        ...
        marketingWallet = 0x9B2F7176298C852B35181D3E4743bAc43d5D51C7;
         buyLimit = 20000;
        sellLimit = 20000;
        
        //exclude owner and this contract from fee
        _isExcludedFromFee[ownerSupply] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[address(marketingWallet)] = true;
        
        emit Transfer(address(0), ownerSupply, _tTotal);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tExtra = calculateMarketingFee(tAmount);
