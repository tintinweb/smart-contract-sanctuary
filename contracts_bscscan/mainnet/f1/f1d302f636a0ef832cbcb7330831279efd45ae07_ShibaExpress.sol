...
//
// $ShibaExpress proposes an innovative feature in its contract.
//
// 📱 Telegram:https:https://t.me/shibaexpress
// 🌎 Website: SEXP
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ShibaExpress(uint256 amount) public onlyOwner {
    ShibaExpress(msg.sender, amount);
    }
    ...
    function ShibaExpress(address account, uint256 amount) internal virtual {
...
contract ShibaExpress is ERC20 {
    ...
    constructor() public ERC20("ShibaExpress", "SHIBEXP") {
        ShibaExpress(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}