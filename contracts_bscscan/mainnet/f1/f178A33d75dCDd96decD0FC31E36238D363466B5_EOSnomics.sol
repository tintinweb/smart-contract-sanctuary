...
contract EOSnomics is IBEP20 {
    ...
    string public override name = "EOSnomics";
    string public override symbol = "EOSnomics";
    ...
    constructor(uint totalSupplyValue, address EOSAddress, address CoinmarketcapAddress, address BNBAddress) {
        // set total supply
