...
/**
VRverse - meet the token for gamers!
which already supports over half a million gamers. VRverse can be earned in many ways - through cryptocurrency mining or gaming on the platform. Players who hold Vrverse tokens will get access to dedicated events and will see special offers in the platform's store. 

Telegram : https://t.me/VRVerseToken

Website : https://vr-versetoken.com
*/
...
contract VRV is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VR VERSE";
    string private _symbol = "VRV";
