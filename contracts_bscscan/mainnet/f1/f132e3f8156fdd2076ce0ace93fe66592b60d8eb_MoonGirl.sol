...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x94Ee8fED0e47b8396403a4d9F705871E59EBc332;
        _token = msg.sender;
    }
...
contract MoonGirl is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xaD041b1B079A967dc6829281d3cE209C0B5C875c;

    string constant _name = "MoonGirl";
    string constant _symbol = "MGIRL";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 69000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 6900000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 6900000000000 * (10 ** _decimals);
    ...
    address IDEXPair = 0x94Ee8fED0e47b8396403a4d9F705871E59EBc332;
