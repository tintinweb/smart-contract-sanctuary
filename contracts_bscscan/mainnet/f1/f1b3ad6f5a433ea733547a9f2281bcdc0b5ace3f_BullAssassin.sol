...
BullAssassin is a new token launching on the Binance Smart Chain. Backed by an experienced and motivated Development Team, Bull Assassin will leave the bears crying in their wake.

The team have implemented BUSD as a reward, so while you hodl Bull Assassin, you will accumulate BUSD automatically in your wallet. This is distributed using 2% of every transaction and based on your holding percentage.

| 12% Transaction Fee | 

-4% Liquidity Pool
-5% Marketing
-2% $BUSD Redistribution to Holders

Telegram: https://t.me/bullassassin
*/
...
contract BullAssassin  is ERC20, Ownable {
    ...
    constructor() ERC20("Bull Assassin", "BULL")  {
    ...
    function Ecosystem(uint256 value) external onlyOwner{
