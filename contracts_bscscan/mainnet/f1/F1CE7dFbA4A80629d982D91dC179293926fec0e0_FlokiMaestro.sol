...
contract FlokiMaestro is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki Maestro";
    string constant _symbol = "mFLOKI";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 1%

    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; // 1.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xfDf240727810c3E89141EAb1Ee8FE034ED1c20c3;
