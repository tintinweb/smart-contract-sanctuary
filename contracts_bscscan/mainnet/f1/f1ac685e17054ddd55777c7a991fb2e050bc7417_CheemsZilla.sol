...
CheemsZilla is a Godzilla version of Cheems Inu,
community-driven token with reflection and small tax.
Your token amount will grow just by holding.

Telegram https://t.me/cheemszillaofficial
Website http://www.cheemszilla.space/
...
contract CheemsZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CheemsZilla";
    string private _symbol = "CheemsZilla";
    ...
    uint256 public _maxTxAmount = 10_000_000_000_000 * 10**9;

    // Liquify when 900 billion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 900_000_000_000 * 10**9;
