...
// CHANGE
contract LondonBonk  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "LondonBonk";
    ...
    uint256 public swapThreshold = _totalSupply / 25;
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xf44CA8DEa11d6e7648858E4CEFdA383661C840E1); // Change
