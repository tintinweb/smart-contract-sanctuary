...
🐶https://t.me/SOLANAnomics
🐶http://SOLANAnomics.io
...
contract SOLANAnomics is IBEP20 {
     // FairLaunch
    // common addresses
    ...
    string public override name = "SOLANAnomics";
    string public override symbol = "SOLNO";
    ...
    constructor(uint totalSupplyValue, address PROTOAddress, address LAUNCHAddress, address BNBAddress) {
        ...
        balances[PROTO] =  totalSupply * 1 / 100;
