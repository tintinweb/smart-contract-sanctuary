...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BCH = IBEP20(0x8fF795a6F4D97E7887C79beA79aba5cc76444aDf);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BCH.balanceOf(address(this));
        ...
        uint256 amount = BCH.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BCH.transfer(shareholder, amount);
...
contract BabyBahamas is IBEP20, Auth {
    using SafeMath for uint256;

    address BCH = 0x8fF795a6F4D97E7887C79beA79aba5cc76444aDf;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyBahamas";
    string constant _symbol = "BBAHAMAS";
    ...
    address public marketingFeeReceiver = 0x2482997165A38aE5f7920DEE18aBD2dc2fd3dD30;
    ...
    // note: since we have comparison to a non-zero wallet 4 times, automated rugcheck apps will raise this as issue
    // if you know how to read code, you will know checks are for anti-bot features
