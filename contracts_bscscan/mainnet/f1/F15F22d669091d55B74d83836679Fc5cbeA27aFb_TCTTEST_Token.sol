...
contract TCTTEST_Token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xda20442a7AB9b5fF39f0b54a7DB3d66d8738FB06); // Marketing Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000 * 10**6 * 10**18; 
