...
Fill your bag with DollarUP and get passive $USDT (tether) Rewards hourly!

DollarUP is a fork from onlyUP which broke the charts! 
Instead of ETH we reward holders passively with USDT! 

We also have the Rebase mechanic which can negate that pesky contract sales (div rewards) and even whale dumps!
So join in and get yourself some $DUP
...
Telegram: https://t.me/DollarUpBSC
Twitter: https://twitter.com/DollarUPBSC/
Website: https://www.DollarUPbsc.com
...
contract DollarUP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DollarUP";
    string constant _symbol = "DUP";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x95AC9e8122fcFFaE368Cc4Dd89D5a5aDdC831922;
...
// ~by monkey < You sick Legend sorry for Forking!