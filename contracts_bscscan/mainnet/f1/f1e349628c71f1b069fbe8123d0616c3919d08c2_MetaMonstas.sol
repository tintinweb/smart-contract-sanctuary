...
interface IBEP20Sniper is IERC11 {
 ...
 contract MetaMonstas is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Meta Monstas";
    string private _symbol = "MONSTA";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0x146946500e2D68A23fFa39d0cD094123EB147A4A;
