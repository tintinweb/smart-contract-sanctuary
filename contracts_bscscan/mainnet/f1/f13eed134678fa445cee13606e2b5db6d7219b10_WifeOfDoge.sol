...
contract WifeOfDoge is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "WifeOfDoge";
   string constant _symbol = "WODOGE";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 10; // 2%
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x2eBF4649fbA97FF876f9F0055C7C4C76503f60aD;
