...
/*
💦 Telegram: https://t.me/DrippleBSC
💦 Website: dripplebsc.com
                         
o.OOOo.   `OooOOo.  ooOoOOo OooOOo.  OooOOo.   o      o.OOoOoo 
 O    `o   o     `o    O    O     `O O     `O O        O       
 o      O  O      O    o    o      O o      O o        o       
 O      o  o     .O    O    O     .o O     .o o        ooOO    
 o      O  OOooOO'     o    oOooOO'  oOooOO'  O        O       
 O      o  o    o      O    o        o        O        o       
 o    .O'  O     O     O    O        O        o     .  O       
 OooOO'    O      o ooOOoOo o'       o'       OOoOooO ooOooOoO 
                                                               

💦 Maximum buy and sell: 1% - 1.000.000.000 Tokens 💦
💦 Maximum wallet size: 3% - 3.000.000.000 Tokens 💦
...
contract Dripple is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public firstDividendRewardsFee = 7;
    ...
    constructor() ERC20("Dripple", "Drops") {
    	firstDividendTracker = new FIRSTDividendTracker();
 
    	marketingWallet = 0x889fbddC98a6b532FF42f03A46Bc67Dc346a2b3B;
    	firstDividendToken = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; //XRP
    ...
    function ReadyForLaunch() external onlyOwner {
        maxSellTransactionAmount = 1000000000 * (10**9); //1%
        maxBuyTranscationAmount = 1000000000 * (10**9); //1%
        maxWalletBalance = 3000000000 * (10**9); // 3%
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("$Lovely_Dividend_Tracker", "$Lovely_Dividend_Tracker", 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE) { //XRP
    	claimWait = 3600;
