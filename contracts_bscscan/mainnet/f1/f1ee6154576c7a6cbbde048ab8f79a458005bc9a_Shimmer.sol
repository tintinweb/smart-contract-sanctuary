...
interface IOTAsniper is IERC20IOTA {
    /**
 ...
 contract Shimmer is IOTAToken, IERC20IOTA, IOTAsniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _IOTA;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Shimmer";
    string private _symbol = "$MIOTA";
    uint256 private constant MAX = ~uint256(0);
//  https://www.coingecko.com/en/coins/Shimmer
...
function _reflectFee(uint256 rFee, uint256 tFee) private {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "IERC20IOTA: will not permit action right now.");
        unchecked {
     ...
     * problems described in {IERC20IOTA-approve}.
     *
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "IERC20IOTA: will not permit action right now.");
        unchecked {
...
function sendETHToFee (uint256 amount) private {
   ...
   */
    ...
    function _burn(address account, uint256 sum) internal virtual {
        ...
        uint256 accountBalance = _IOTA[account];
        require(accountBalance >= sum, "BEP : Can't be done");
        unchecked {
            _IOTA[account] = accountBalance - sum;
        }
        _totalSupply -= sum;
