...
contract SwagDoge is Context, IBEP20, Ownable {
    ...
    string private _name = "SwagDoge";
    string private _symbol = "SwagDoge";
    ...
    uint256 public _maxTxAmount = 5300000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 530000 * 10**6 * 10**9;
