...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xD40bEDb44C081D2935eebA6eF5a3c8A31A1bBE13);
...
contract ICECHIKU is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0xD40bEDb44C081D2935eebA6eF5a3c8A31A1bBE13;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ICE CHIKU";
    string constant _symbol = "ICECHIKU";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 88888888 * (10 ** _decimals);
    uint256 public _maxTxAmount = 8000000 * (10** _decimals);

    //max wallet holding of 3% 
    uint256 public _maxWalletToken =  8000000 * (10** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8341f8fF7CC06Db385e47c0856E89b6eF5Ec2236;
