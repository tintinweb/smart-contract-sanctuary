...
contract sUreka is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10000000000000000000 * 10**9;
    ...
    constructor() ERC20("Staked Ureka", "sURK", 9) ERC20Permit() {
