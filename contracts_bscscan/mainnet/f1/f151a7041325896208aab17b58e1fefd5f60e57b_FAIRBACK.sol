...
> #RFI+#DOGE combine together to create $FAIRDOGEBACK designed

 14% DogeCoin rewards with $FAIRDOGEBACK token reflections
...
contract FAIRBACK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Fair Doge";
    string constant _symbol = "FAIRDOGEBACK";
