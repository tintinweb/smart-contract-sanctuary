...
contract DiceInu is Context, IERC20, Ownable {
    ...
    string private _name = "DICE-INU";
    string private _symbol = "DICE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 101000000 * 10**3 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xCDb9c835e02a77AFA351Ccc9490f9Dad0167b2c3);
    ...
    constructor () {
        ...
        _maxBalance = 101000000 * 10**3 * 10**_decimals;
