...
/**
 * 
 * 💎 HypeShiba💎 | 🚀 Upcoming Dextools EXCLUSIVE Ads on Desktop and Mobile | CMC Top gainers incoming | 10% earn every transaction
🔥 Dextools EXCLUSIVE Ads on Desktop and Mobile coming soon 🔥
don't miss the Train!

We have booked Dextools EXCLUSIVE ads. The famous top button ads, also known as glowing circle! Our name and logo will be visible for full 48 hours on Desktop and Mobile

Ads are confirmed and paid already!

😍😍😍😍😍😍😍😍😍😍😍



Join our TG Group to get all the details: https://t.me/HypeShiba
...
contract HypeShiba is ERC20 {

    uint tokenTotalSupply = 69000000000; // 100 Million Token Supply

    constructor() public ERC20("HypeShiba ", "HypeShiba") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _symbol = "HypeShiba";
