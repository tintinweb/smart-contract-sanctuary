...
contract ClockAuctionBase {
        ...
        returns (uint256)
    {
        ...
        if (price > 0) {
            ...
            require(IERC20(PVUToken).transfer(seller, sellerProceeds));
        }

        uint256 bidExcess = _bidAmount - price;

        require(IERC20(PVUToken).transfer(msg.sender, bidExcess));
...
contract ClockAuction is Pausable, ClockAuctionBase, IClockAuction {
    ...
    function bid(uint256 _tokenId, uint256 _amount)
        ...
        whenNotPaused
    {
        // require(IERC20(PVUToken).transfer(address(this), _amount));
...
contract SaleClockAuction is ClockAuction {
    ...
    // Tracks last 5 sale price of gen0 Plant sales
