...
// File: contracts/interfaces/flashloan/IERC3156FlashBorrower.sol
...
interface ICTokenFlashloan {
  function flashLoan(address receiver, address token, uint amount, bytes calldata params) external;
}
...
// File: contracts/RepayOnBehalf.sol
...
contract RepayOnBehalf is Ownable, IERC3156FlashBorrower {
  ...
  IStrategy strategy;
  address public crWant = address(0x2Bc4eb013DDee29D37920938B96d353171289B7C);
  address public want;
