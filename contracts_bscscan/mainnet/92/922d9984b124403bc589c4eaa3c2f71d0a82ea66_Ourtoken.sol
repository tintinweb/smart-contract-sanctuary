...
Discord: https://discord.gg/ExSWUAzDHx
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF32023a6E44a523c635922A34403d3Ebec12b36C; 
...
contract Ourtoken is Context, IERC20, Ownable {
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0xF32023a6E44a523c635922A34403d3Ebec12b36C); 
    address payable private Wallet_Charity = payable(0x3FDD1890719bDB2ce617AEEd08bF0479e875A92e); 

    address payable private Wallet_Dev = payable(0x60a4EA71566405Fd2717331465F184b5349a28EA); 
    ...
    //counters for swap and liquify trigger
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 


    
    //refection fee - token redistribution to holders
    ...
    constructor () {
        ...
        //other wallets are added to the whitelist manually post launch
        //remember to add the uniswapV2Pair address to the whitelist!!! 
    ...
    NOTE:   When you turn pre-sale mode off, it will close PublicTrade, so only whitelisted wallets and the Owner can interact with the contract
            You need to manually set publicTradeOpen to 'true' to allow trade. 
    ...
    */
    ...
    function setup_Presale_ON() external onlyOwner {
        ...
        safeLaunch_PublicTradeOpen(true);
        removeAllFee();
        removeWalletLimits();
    }
    ...
    function setup_Presale_OFF() external onlyOwner {
        ...
        safeLaunch_PublicTradeOpen(false);
        restoreAllFee();
        restoreWalletLimits();
    }
    ...
    2. The reflection fee can not be set below 3% 
    ...
    */
    ...
    function fees_setFeeReflectionPercent(uint256 FeeReflection) external onlyOwner() {
        ...
        if (limitCheck <= maxFee && FeeReflection >= 3){
    ...
    */
    ...
    Whitelist - At launch, we lock down the contract so only whitelisted wallets can buy. To remove
    this restriction, publicTradeOpen must be set to true.

    IMPORTANT: If publicTradeOpen is false, in order to add liquidity the uniswap pair will need 
    to be whitelisted.
