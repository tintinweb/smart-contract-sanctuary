...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 RWRD = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); 
  address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    event Deposit(uint256 amountBNB, uint256 amountRWRD);
...
contract BabyCakePOP is IBEP20, Auth {
    using SafeMath for uint256;
  
 
     address RWRD = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;  
     address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyCakePOP";
    string constant _symbol = "BCakePOP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);  
    uint256 public _maxTxAmount = _totalSupply / 200;          
    uint256 public _maxWallet = _totalSupply / 40;  
