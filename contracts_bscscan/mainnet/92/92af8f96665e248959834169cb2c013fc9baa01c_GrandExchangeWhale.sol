...
contract GrandExchangeWhale is Context, IBEP20, Ownable {

  using SafeMath for uint256;
  IUniswapV2Router02 public _uniswapV2Router;
  address public _uniswapV2Pair;
  string private constant _name = "Grand Exchange Whale";

  string private constant _symbol = "GEW";
