...
contract DogeTwinCoin is Context, IERC20, Ownable {
    ...
    string private _name = "DogeTwinCoin";
    string private _symbol = "DOGETWIN";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1500000000 * 10**6 * 10**9;
