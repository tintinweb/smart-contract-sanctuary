...
Ꮘ What's Moma Protocol ? 

The Moma Protocol uses a proprietary smart contract factory to produce, manage,
accelerate and aggregate the lending markets, creating an ecosystem that can expand infinitely
on lending liquidity and market diversity.

🗨Factory : 
Moma provides a smart contract factory for the production and management of Launch Pool and Lending Pool.
As a Pool Builder, a user can customize the type of crypto assets and other parameters independently,
and create their own Launch Pool and Lending Pool which they can fully operate by themselves to generate profits.

➕ TOTAL SUPPLY : 1,000,000
➕ Reward pool: 12%
➕ 50% Burn 🔥 
➕ Liquidity is Locked: 100% 🔒
➕ No Dev wallet .
➕ Token Type: BEP-20 (BSC)
➕ DEX: PancakeSwap
Features:
➕ Liquidity WILL be locked by Deeplock.io 
