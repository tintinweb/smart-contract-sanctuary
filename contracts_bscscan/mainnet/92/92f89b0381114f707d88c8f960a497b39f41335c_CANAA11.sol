...
/**
    ...
    CANAA INVESTIMENTOS E PARTICIPAÇÕES LTDA
    CNPJ 40.903.396/0001-00
    RUA DR. VEIGA FILHO, 140 
    SANTA CECILIA - SÃO PAULO - SP
    CEP 01.229-000
    
    https://canaa11.com
    https://www.instagram.com/canaa.11
    https://t.me/canaa111

    Nome: CANAA.11
    Simbolo: CNA
    6% taxa sobre todas transações - Tax on transactions
    3% para piscina de liquidez - Liquidity
    3% para carteira de marketing - Marketing Wallet
...
contract CANAA11 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**8 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CANAA.11";
    ...
    address public MarketingWallet = 0x71D3ca3F0529A75dFA1e6a488b5bfa002F196846;
