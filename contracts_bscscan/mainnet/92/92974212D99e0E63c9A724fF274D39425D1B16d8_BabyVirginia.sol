...
contract BabyVirginia is  Context, IERC20, Ownable {
    ...
    uint256 private _tBabyVirginiaTotal;

    string private _name = "BabyVirginia";
    string private _symbol = "BabyVirginia";
    ...
    uint256 public _BabyVirginiaFee = 10;
    uint256 private _previousBabyVirginiaFee = _BabyVirginiaFee;
    
    uint256 public _maxTxAmount = 1000 * 10**9 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**9 * 10**9; 
    
    address payable public BabyVirginiaAddress = 0xd7FBB8077e17859058A3ecfBC63BF19e7df1bf0f;
   ...
   function deliver(uint256 tAmount) public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tBabyVirginiaTotal = _tBabyVirginiaTotal.add(address(this).balance);
        TransferCharityETH(BabyVirginiaAddress, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_BabyVirginiaFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _BabyVirginiaFee == 0 && _liquidityFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousBabyVirginiaFee = _BabyVirginiaFee;
    ...
    function restoreAllFee() private {
        ...
        _BabyVirginiaFee = _previousBabyVirginiaFee;
    ...
    function setBabyVirginiaFeePercent(uint256 BabyVirginiaFee) external onlyOwner() {
        _BabyVirginiaFee = BabyVirginiaFee;
    }
