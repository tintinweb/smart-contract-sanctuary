...
;
    ...
    function putOnSale(uint256 _tokenId, uint256 _sellPrice) public {
        ...
        require(nfts[_tokenId - 1].isChoosen == false, "You must unwear it first, then you can sell it." );
    ...
    function putOnAuction(uint256 _tokenId) public {
        ...
        //item should not be on wear
        require(nfts[_tokenId - 1].isChoosen == false,  "You must unwear it first, then you can put it on auction.");
    ...
    function mint(
        ...
        return(nfts[_id -1].name, nfts[_id -1].class, nfts[_id -1].rarity);
