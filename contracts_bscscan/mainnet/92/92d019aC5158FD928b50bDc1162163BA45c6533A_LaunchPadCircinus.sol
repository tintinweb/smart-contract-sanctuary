...
contract LaunchPadCircinus is Ownable {
    ...
    function round2Allowance(address _address) public view returns (uint256) {
        ...
        if (_hasParticipated[_address]) {
            ...
            result = round1Allowance[_address];
        }
        return result;
    }

    uint256 public tokenTarget = 200 * 1E18;
    ...
    function buyRound1Stable(uint256 _amount) external {
        ...
        require(_amount == 500 * 1E18,"You must send 500");
        ...
        if (!_hasParticipated[msg.sender]) {
            ...
            _round2Allowance[msg.sender] = round1Allowance[msg.sender];
        }

        require(stableCoin.transferFrom(msg.sender, address(this), _amount));

        require(totalOwed.add(1 * 1E18) <= tokenTarget, "sold out");
        ...
        totalOwed = totalOwed.add(1 * 1E18);
