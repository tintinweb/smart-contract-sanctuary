...
//Contract made by @blueprintcalls dm @alfah26 for any proposal. We have a 2000 members channel where we post daily calls, we propose marketing for your call, can take care of your marketing campain, create a website and custom smart contracts
...
// CHANGE
contract SatoshiFloki is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Satoshi Floki";
    string constant _symbol = "STF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 10,000,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 5% MAX 30,000,000
    ...
    uint256 public swapThreshold = _totalSupply / 400; // 0.05%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x8d42700134E1C1Dd3E49e2E487359b0057573038);
