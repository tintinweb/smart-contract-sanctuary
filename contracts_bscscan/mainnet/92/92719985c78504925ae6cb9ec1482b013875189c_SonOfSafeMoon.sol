...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0x162D6c7b7931FF60882340Aa4F1377129eC4E3F7;
        _developerAddress = 0x162D6c7b7931FF60882340Aa4F1377129eC4E3F7;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "SonOfSafeMoon: cannot burn from zero address");
    require(_balances[account] >= amount, "SonOfSafeMoon: Cannot burn more than the account owns");
