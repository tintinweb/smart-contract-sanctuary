...
function recoverLostBNB() public  {
	...
	function getAirdropDetails(address userAddress) public view returns( uint256, uint256, uint256) {
			User storage user = users[userAddress];
			
			return (user.issued, user.claimed, MoonCoinApp.balanceOf(address(this)));	
