...
import "./sweetbabylib.sol";
contract SweetBaby is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "SweetBaby"; // token name
    string private _symbol = "STB"; // token symbol
    ...
    uint256 private _tokenFee = 1; // DeadW fee 1% to be sent as tokens
    uint256 private _previousTokenFee = _tokenFee; // DeadW tokens fee
    
    uint256 private _buyBackFee = 120; // buyback fee 12%
    uint256 private _previousBuyBackFee = _buyBackFee; // buyback fee

    uint256 private _deadFee = 20;  // swap BNB
    uint256 private _previousDeadFee = _deadFee; 

    uint256 private _liquidityFee = 30; // liquidity fee 3%
