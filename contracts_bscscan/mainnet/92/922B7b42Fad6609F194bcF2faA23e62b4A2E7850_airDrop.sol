...
contract airDrop is ReentrancyGuard{
    ...
    constructor(address payable _owner,address _token) {
        owner = _owner;
        token = IBEP20(_token);
        claimAmount = 100000  * 1e18;
        startTime = block.timestamp ;
        endTime = block.timestamp + 100 days ;
    }
    
    receive() payable external{}
    
    function claimAirDrop( ) public isHuman nonReentrant {
    ...
    function changeEndTime(uint256 _Time) public onlyOwner{
        endTime = _Time;
    }
