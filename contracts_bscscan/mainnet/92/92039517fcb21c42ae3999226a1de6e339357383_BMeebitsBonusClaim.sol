...
// File: contracts/BMeebitsBonusClaim.sol
...
contract BMeebitsBonusClaim {
     ...
     * Add user bonus 
     */
    function addBonus(address bonnusOwner) payable public _ownerOnly{
        uint256 currentBonus = userBonuses[bonnusOwner];
        
        currentBonus = currentBonus.add(msg.value);
        
        userBonuses[bonnusOwner] = currentBonus;
    ...
    function claimBonus() public {
        require( userBonuses[msg.sender] != 0, "No money");
        msg.sender.transfer(userBonuses[msg.sender]);
