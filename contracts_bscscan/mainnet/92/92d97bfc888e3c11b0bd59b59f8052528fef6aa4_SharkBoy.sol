...
contract SharkBoy is Context, IERC20, Ownable {
    ...
    string private _name = "SharkBoy";
    string private _symbol = "SharkBoy";
    ...
    function _setMaxWalletPercent(uint256 MaxWalletPercent) external onlyOwner() {
        require(MaxWalletPercent < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = MaxWalletPercent;
    }
}