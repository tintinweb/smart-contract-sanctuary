...
contract Tokemon3DNFT is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'Tokemon3D NFT';
    string  private _SYMBOL = 'TOKEMON';
    ...
    uint256 private _MAX_TX_SIZE = 500000 * _DECIMALFACTOR;
