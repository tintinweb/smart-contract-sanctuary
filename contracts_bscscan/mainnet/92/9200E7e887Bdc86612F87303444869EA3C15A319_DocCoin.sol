...
contract DocCoin is Context, IBEP20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DocCoin";
    string private constant _symbol = "DOCCO";
    ...
    uint256 public _maxTxAmount =  15*10**5*10**9;

    uint256 private _tTotal = 821*10**8*10**9;
