...
contract QuadLotto is ERC20, Ownable {
    ...
    IUniswapV2Router02 constant uniswapV2Router =
        IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //pcs v2 router
    ...
    //Change token  name symbol here
    constructor() ERC20("Qaud Lotto", "Quad")
    {
    ...
    function pickWinner(address user) external onlyOwner {
        ...
        lpToken.transfer(user, totalBalance);

        previousWinner = user;

        emit WinnerPicked(previousWinner);
    }
