...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #KingzToken

    I make this #KingzToken to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/KingzToken_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #KingzToken to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #KingzToken 10000000X? 
   ...
   it's the best part of the #KingzToken idea, increasing the liquidity pool automatically, 
...
contract KingzToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "KingzToken";
  string private _name = "KingzToken";
