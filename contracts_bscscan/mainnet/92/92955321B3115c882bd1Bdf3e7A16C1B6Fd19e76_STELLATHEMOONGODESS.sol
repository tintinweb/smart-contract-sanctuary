...
contract STELLATHEMOONGODESS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "STELLATHEMOONGODDESS";
    string private _symbol = "StellaTheMoonGodess";
    ...
    uint256 public _buybackv1Fee = 400; // 100 = 1.00%
    uint256 public _buybackv2Fee = 10; // 100 = 1.00%
    uint256 public _burningFee = 10; // 200 = 2.0%
    uint256 public _smarketingFee = 600; // 50 = 0.5%
    
    uint256 public _maxTxAmount = 10000000000 * 10**18; // 15 Million inicial máx transfer
