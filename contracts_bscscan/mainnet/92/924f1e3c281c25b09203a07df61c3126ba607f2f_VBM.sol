...
/**
* Viberate Music, Music analytics for professionals.

* - Streaming, airplay and social media monitoring
* - Professional charts and artist comparison
* - Industry trends and audience demographics
...
contract VBM is Context, IERC20, Ownable {
    ...
    address payable public BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;
     uint256 private _total = 1 * 10**12 ;
