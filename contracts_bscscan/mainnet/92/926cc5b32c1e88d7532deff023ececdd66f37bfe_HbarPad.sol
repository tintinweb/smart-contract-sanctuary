...
contract HbarPad is IERC20, Ownable {
   

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string public constant name = "HbarPad";
    string public constant symbol = "HBARP";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 10, "HbarPad: transaction fee percentage exceeds 10");
        require(feePercentage_ >= 0, "HbarPad: transaction fee percentage equals 0");
