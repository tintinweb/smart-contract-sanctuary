...
contract ShaolinShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShaolinShiba";
    string constant _symbol = "SHAOSHIB";
...
/* NFT Airdrop Begins */
 ...
 function nftAirdrop(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "NFT airdrop failed");
