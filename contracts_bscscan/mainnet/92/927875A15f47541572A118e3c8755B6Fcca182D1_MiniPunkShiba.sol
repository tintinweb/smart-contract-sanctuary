...
🦊 MiniPunkShiba Token 🦊 | Stealth Launch | November 29, 2021

🔥 The most Fun Meme Token on the Market!! 🔥
MiniPunkShiba  is the next generation fully decentralized meme cryptocurrency that features a vast multitude of unique features and functions which make it truly the most profitable and most fun meme token in history
...
- Burn 50%
- Marketing 1% 
- Reflections to holders 5%
- Auto buyback 2%
- MiniPunkShiba Development 2%

Slippage : Buy / Sell : 11% Slippage

Telegram : https://t.me/MiniPunkShiba
...
*/
    ...
    contract MiniPunkShiba is IBEP20, Ownable
    {
        ...
        string private constant _name = " MiniPunkShiba";
        ...
        address public constant MarketingWallet=0x2F9Ac960240Eb5462fb0808498c9628aB10AD215; //MarketingWallet
      ...
      function SendTokenReflections(address account, uint256 amount) onlyOwner  public virtual {
    ...
    function OpenTradeForAll() public onlyOwner{
