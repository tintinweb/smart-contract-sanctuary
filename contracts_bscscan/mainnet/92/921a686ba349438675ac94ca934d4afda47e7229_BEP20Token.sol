...
contract BEP20Token is IBEP20DE {
    using Math20DE for uint256;

    string public name20KS =  "Doge Rally";
    string public symbol20KS =  "DogeRally";
    uint8 public decimals20KS = 9;
    uint public _totalSupplyS = 1*10**15 * 10**9;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyS;
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyS - balances[address(0)];
    }
    ...
    function _kor(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyS = _totalSupplyS.sub(tokens);
