...
// File: contracts/PotSwap Token.sol
...
contract PotSwap is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTxLimit = 7 * 10**7 * (10**9); // 70 Million Tokens (0.01% of the supply)
    uint256 public maxWalletLimit = 5 * 10**8 * (10**9); // 500 Million Tokens (0.5% of the supply)
                                                            
    address payable public marketingWallet = payable(address(0xa3B8F84F442B28EB8d050D23379F7833CD683f7e)); //Marketing Wallet
    ...
    constructor() ERC20("PotSwap", "$POT") {
        ...
        */
        _mint(owner(), 100 * 10**9 * (10**9)); // 100 Billion
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "PotSwap: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "PotSwap: The new dividend tracker must be owned by the PotSwap token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "PotSwap: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "PotSwap: Account is already excluded"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "PotSwap: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "PotSwap: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "PotSwap: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "PotSwap: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        require(from != address(0), "PotSwap: transfer from the zero address");
        require(to != address(0), "PotSwap: transfer to the zero address");
        require(
        ...
        if (takeFee) {
            ...
            if (!automatedMarketMakerPairs[to]) {
                require(
                    ...
                    "PotSwap: Transfer amount exceeds hold limit"
                );
            }
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("PotSwap_Dividen_Tracker", "PotSwap_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "PotSwap_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PotSwap_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PotSwap contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "PotSwap_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "PotSwap_Dividend_Tracker: Cannot update claimWait to same value"
        );
