...
/**
  ...
  Be the Right Dad that invested in the Right Coin !

  Telegram : https://t.me/RichDadToken
...
contract RichDadToken is ERC20, Ownable {
    ...
    //liq taxes
    uint256 public  _liqTax = 3;
    uint256 private _previousLiqTax = _liqTax;

    //dev tax
    uint256 public   _devTax = 4;
    ...
    uint256 private _tTotal = 100 * 10**6 * 10**9; //TotalSupply = 1M
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _devTax == 0 && _liqTax == 0) return;
    ...
    function _transfer (
        ...
        if (!(_isExcludedFromFee[from] || _isExcludedFromFee[to])) {
            ...
            if (
                ...
                contractTokenBalance = tokensSoldThresholdForEthSwap;
