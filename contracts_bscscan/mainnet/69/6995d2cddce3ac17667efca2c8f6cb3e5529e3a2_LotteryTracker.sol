...
contract LotteryTracker is Ownable,VRFConsumerBase {
    ...
    IERC20 private BUSD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD
        ...
        )
    {
        ...
        fee = 0.2 * 10 ** 18; // 0.2 LINK (BSC Mainnet)
...
contract JEWELS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    JEWELSDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = address(0x9028f1b55a316888e86c16E724E1d6140253E69B);
    ...
    constructor() ERC20("JEWELS TOKEN", "JWLS") {

    	dividendTracker = new JEWELSDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "JEWELS: The dividend tracker already has that address");

        JEWELSDividendTracker newDividendTracker = JEWELSDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "JEWELS: The new dividend tracker must be owned by the JEWELS token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "JEWELS: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "JEWELS: Account is already excluded");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "JEWELS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "JEWELS: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "JEWELS: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "JEWELS: Cannot update gasForProcessing to same value");
...
contract JEWELSDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    using IterableMapping for IterableMapping.Map;
    ...
    constructor() DividendPayingToken("JEWELS_Dividen_Tracker", "JEWELS_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000 * (10**18); //must hold 1000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "JEWELS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "JEWELS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main JEWELS contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "JEWELS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "JEWELS_Dividend_Tracker: Cannot update claimWait to same value");
