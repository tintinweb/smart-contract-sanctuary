...
#Logos
#
# Logo 3192x3192 - https://files.fm/thumb_show.php?i=4m4hpeqky
#
# Logo 32x32 - https://files.fm/thumb_show.php?i=jdq5fu85z
#
#SOCIALS
#
# Telegram -Token https://t.me/DiamondMine
#
# Twitter - https://twitter.com/DiamondMineDMT
#
# Reddit - https://www.reddit.com/r/DiamondMineToken/
#
# TikTok - https://www.tiktok.com/@diamondminetoken?
#
# Instagram - https://www.instagram.com/diamondminetoken/
#
# Facebook - https://www.facebook.com/Diamond-Mine-Token-101863962384568
#
# Discord - https://discord.gg/ERg8zyEk4u
#
# Website - https://www.diamondminetoken.tech
*/
...
// Begin sauce.
contract DiamondMineToken is Context, IERC20, Ownable {
    ...
    uint256 private _supply_total       = 1 * 10**8 * 10**_decimals;
    uint256 private _supply_reflected   = (MAX - (MAX % _supply_total));
    string private  _name               = "DiamondMineToken";
    ...
    address payable public _wallet_marketing = payable(0x3D7382C5648B35c8442D7aCbfe430a51671365f0);

    // for burn
    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0x3D7382C5648B35c8442D7aCbfe430a51671365f0);

    // for buyback
    uint256 public _fee_buyback = 400;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0x3D7382C5648B35c8442D7aCbfe430a51671365f0);
