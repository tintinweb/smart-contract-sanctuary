...
/**
 * TELEGRAM : https://t.me/growtopiagame_bsc
 * TELEGRAM : https://t.me/growtopiagame_bsc
...
contract GrowtopiaGame is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x1a5d1F2e96C1574C3845593Ba9db91dbD3235778); // Marketing Address
    ...
    string private _name = "GrowtopiaGame";
    string private _symbol = "GrowtopiaGame";
    ...
    uint256 private _sellTaxFee = 1000;
    uint256 private _sellLiquidityFee = 1000;
    ...
    uint256  _maxTxSellAmount = 1 * 10**1 * 10**9;
    uint256 public _maxTxBuyAmount = 1 * 10**12 * 10**9;
    uint256  minimumTokensBeforeSwap = 1 * 10**1 * 10**9;
    uint256  buyBackSellLimit = 1 * 10**14;
