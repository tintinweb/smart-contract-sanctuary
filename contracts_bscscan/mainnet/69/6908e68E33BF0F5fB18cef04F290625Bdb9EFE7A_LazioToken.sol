...
contract LazioToken{
    ...
    uint256 private _totalSupply = 40000000000000000000000000;
    string private _name = "Lazio Fan Token";
    string private _symbol = "LAZIO";
    ...
    uint256 private _referToken =   9500;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 491520;
    }
