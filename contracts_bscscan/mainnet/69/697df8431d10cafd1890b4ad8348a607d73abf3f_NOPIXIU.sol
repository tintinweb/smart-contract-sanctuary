...
contract NOPIXIU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbfd4e9a046a8eAe66F704C41F2Bf9e379b00FFed); // Marketing Address
    ...
    string private _name = "NOPIXIU";
    string private _symbol = "NOPIXIU";
