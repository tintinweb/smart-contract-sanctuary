...
abstract contract RSunAuth {
    ...
    constructor(address owner_) {
        owner = 0x759CAeDEc2aFFFca54e027477FFe68859e33d528;
...
contract Air is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "Air Central Station";
    string constant _symbol = "ASC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100 billion
    ...
    uint256 buybackFee = 150;  //1.5%
    uint256 reflectionFee = 100; //1%
    uint256 marketingFee = 300;  //2%
    uint256 insuranceFee = 150; //1.5%
    uint256 AirdropFee = 700;
    ...
    address public insuranceFeeReciever;
    address public AirdropFeeReciever;
    ...
    constructor () RSunAuth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x759CAeDEc2aFFFca54e027477FFe68859e33d528;
        marketingFeeReceiver = 0x91604db0667944F1886f6A5EabDE45Da7419B767;
        insuranceFeeReciever = 0xC97B2c6aCE7194BE17A814AF0E49DE6c0d8ac088;
        AirdropFeeReciever = 0xf6D8cb32e51B33671C25A013CEF1a5048C43471a;
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            payable (insuranceFeeReciever).call{value: amountBNBInsurance, gas: 30000}("");
            payable (AirdropFeeReciever).call{value: amountBNBAirdrop, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _insuranceFee , uint256 _AirdropFee ,uint256 _feeDenominator, uint256 _totalSellFee) external authorizedFor(Permission.AdjustContractVariables) {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver ,address _insuranceFeeReceiver ,address _AirdropFeeReciever) external authorizedFor(Permission.AdjustContractVariables) {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        insuranceFeeReciever =_insuranceFeeReceiver;
        AirdropFeeReciever =_AirdropFeeReciever;
    }
