...
contract CuffiesFaucet is Whitelist {
    ...
    uint256 public startDate = 	1639238400;                  // 2021/12/11 16:00:00 UTC
    uint256 public endDate = 1639411200;                    // 2021/12/13 16:00:00 UTC
    ...
    function BuymyCuffies(uint256 amount) public  {
       ...
       Max_Alloc = Max_Alloc - CuffiesAmount;
        ...
        vestingFinishedAt[msg.sender] = block.timestamp + (45 days); 
