...
contract RippleBlitzHype is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x6bCD696cad6bFCc7F20ADbbC621039A3a1C1cb6d); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0x65a43B786cB91Dc2DD60044237caA264D7A33426); // xrp Address
    ...
    string private _name = "RippleBlitzHype";
