...
contract Master is Ownable {
    ...
    IFLOKIUSA public FLOKIUSA;

    // Market oracle provides the FLOKIUSA/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _FLOKIUSA) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = FLOKIUSA.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && FLOKIUSA.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(FLOKIUSA.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return FLOKIUSA.totalSupply().toInt256Safe()
