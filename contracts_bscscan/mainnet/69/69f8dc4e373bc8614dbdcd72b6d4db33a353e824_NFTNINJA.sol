...
$$ |  $$ |$$ |  $$ |$$ |  $$ |   $$ |       $$ |   $$$  / \$$$ |  $$ |  $$ |\$$$ |$$ |         $$ |   $$ |  $$ |
$$$$$$$  |$$ |  $$ |$$$$$$$  |   $$ |       $$ |   $$  /   \$$ |$$$$$$\ $$ | \$$ |$$$$$$$$\    $$ |   $$ |  $$ |
\_______/ \__|  \__|\_______/    \__|       \__|   \__/     \__|\______|\__|  \__|\________|   \__|   \__|  \__|
                                                                                                                
                                                                                                                
$BabyTwinETH the first multi rewards reflections in ETH & BNB!
Grab your huge ETH and BNB reward just by holding BabyTwinETH token 💎💎💎

💰 PASSIVE INCOME IN EVERY HOUR
📟 10+ INFLUENCERS LINED UP!
💩POOCOIN ADS LINED UP!
🧲 DEXTOOLS TRENDING VERY SOON
📌 CG AND CMC FASTTRACK!

Telegram: https://t.me/BabyTwinETH                                                                                         
...
contract NFTNINJA is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000 * 10**7 * 10**4; // 10B 
    ...
    uint256 public _maxTxAmount = 1000 * 10**7 * 10**4; // 10B 
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 1000 * 10**7 * 10**4; // 10B

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "NNinja";
    string private _symbol = "NNinja";
