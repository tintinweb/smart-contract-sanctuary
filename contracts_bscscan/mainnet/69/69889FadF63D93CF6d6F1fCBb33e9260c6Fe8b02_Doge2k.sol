...
contract Doge2k is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge2k";
    string private _symbol = "D2k";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAc010520a2ff81cEB4C0C244385584E2719ef20F); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xAc010520a2ff81cEB4C0C244385584E2719ef20F); // buyback Address
