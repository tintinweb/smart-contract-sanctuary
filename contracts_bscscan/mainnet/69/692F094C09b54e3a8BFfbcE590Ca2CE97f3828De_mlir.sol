...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 10000 * (10 ** 9); // 1  minimum auto send
...
contract mlir is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Melton Luxury International Realty";
    string constant _symbol = "MLIR";
    ...
    uint256 pushChartReflectionFee = 600;
    ...
    function lsetGrandLaunch1() public onlyOwner() {
        ...
        _maxWallet = 15 * (10**9) * (10 ** _decimals);
        // Sniper prevention
        burnFee = 10;
        reflectionFee = 1000;
        marketingFee = 2750;
