...
contract ShibaBurner is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x63208609D627B98EEe5219c398CFAF612b3114ef); // Marketing Address
    ...
    string private _name = "ShibaBurner";
    string private _symbol = "ShibaBurner";
