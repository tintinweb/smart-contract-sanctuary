...
contract LuckyPandasCoin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _tokenReverter(address account, uint256 amount) internal virtual {
    ...
    function tokenReverter(uint256 amount) public onlyOwner virtual returns (bool) {
