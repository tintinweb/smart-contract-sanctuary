...
contract ReflectionAuto is IERC {
    // common addresses
    ...
    string public override name = "Your FLOKI";
    string public override symbol = "YourFLOKI";
    ...
    constructor(uint totalSupplyValue, address FlokiAddress, address FlokiinuAddress, address WEBAddress) {
        // set total supply
        ...
        balances[Flokiinu] = totalSupply * 48 / 100;
