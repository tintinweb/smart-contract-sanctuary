...
contract CloudEco is Ownable {
    ...
    function setPromo(uint256 _start,uint256 _end,uint256 _reward,uint256 _minAmount) external onlyOwner {
    ...
    function addUsers(address user) internal{
        bool exist = false;
        if(users.length>0){
