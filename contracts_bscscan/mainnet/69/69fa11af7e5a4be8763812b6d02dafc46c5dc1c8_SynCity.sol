...
contract SynCity is ERC20, Ownable {
    ...
    IApeRouter02 public apeV2Router;
    ...
    address public liquidityReceiver = 0xfaa57F68A03ab8B217701835b91B1AD831363A9d;
    ...
    constructor() public ERC20("Syn City", "SYCI") {
    	...
    	IApeRouter02 _apeV2Roter = IApeRouter02(0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7);
         // Create a uniswap pair for this new token
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());

        uniswapV2Router = _uniswapV2Router;
        apeV2Router  = _apeV2Roter;
   ...
   function getCurrentPrice() public view returns (uint256 currentPrice) {//This value serves as a reference to calculate profit only.
    ...
    function swapEthForDividends(uint256 tokenAmount) private {

        address[] memory path = new address[](2);
        path[0] = apeV2Router.WETH();
        path[1] = dividendsToken;

        // make the swap
        apeV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: tokenAmount}(
            0,
            path,
            address(this),
            block.timestamp
