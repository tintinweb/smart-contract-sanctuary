...
TG: https://t.me/shibapetoken
WEB: https://www.shibape.online/

Shibape token is a 100% decentralized, community-focused project. Each transaction will contribute towards $SHIBGO growth.

One of the goals of Shibape creators and the community is to adopt animals and to protect precious habitats around the world and all the species which rely on them.
 A part of the tax collected will be contributed to where the funding is most needed,
which includes adopting and protecting habitats of animals like Mongoose, penguins, elephants, and gorillas.
...
contract SHIBAPE is IERC20, Ownable {
    ...
    string _name = "SHIBAPE";
    string _symbol = "SHIBAP";
