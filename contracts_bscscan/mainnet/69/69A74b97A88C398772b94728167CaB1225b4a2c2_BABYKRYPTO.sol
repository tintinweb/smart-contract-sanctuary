...
// BabyKrypto is a rewards token with an NFT component linked to the rewards.
// BabyKrypto holders will receive 8% rewards in 8 different tokens.
// Hold our NFTs, you can gain more potential rewards.

// 🌐 Twitter : https://twitter.com/BabyKryptoBSC
...
contract BABYKRYPTO is ERC20, Ownable {
    ...
    address public TOKEN = BNB; // initial reward BNB
    ...
    address public _marketingWalletAddress =
        0xcD47feB0B7994B88efB553F358e229a64e29acCB;
    ...
    constructor() public ERC20("Baby Krypto", "BabyK") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BABYKRYPTODividendTracker newDividendTracker = BABYKRYPTODividendTracker(
                payable(newAddress)
            );
    ...
    function updateWhaleLimit(uint256 val) external onlyOwner {
        whaleLimit = val;
    }
    ...
    function setTradeOpen(bool val) external onlyOwner {
        tradeOpen = val;
    }
...
contract BABYKRYPTODividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor()
        public
        DividendPayingToken(
            "BABYKRYPTO_Dividen_Tracker",
            "BABYKRYPTO_Dividend_Tracker"
        )
    {
        claimWait = 3600;
