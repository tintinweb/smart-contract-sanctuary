...
Hold $iBNB and get rewarded in BNB on every transaction!
Telegram: https://t.me/icebnb
...
contract IceBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ice BNB";
    string constant _symbol = "iBNB";
