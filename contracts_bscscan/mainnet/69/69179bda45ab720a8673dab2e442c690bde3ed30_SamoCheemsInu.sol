...
// File contracts/Samo Cheems Inu.sol
pragma solidity ^0.8.0;

contract SamoCheemsInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2022_000_000 * 10**_decimals;
    ...
    string private constant _PROJECTNAME = "Samo Cheems Inu";
    string private constant _name = "Samo Cheems Inu";
    string private constant _symbol = "SCHEEMSI";
