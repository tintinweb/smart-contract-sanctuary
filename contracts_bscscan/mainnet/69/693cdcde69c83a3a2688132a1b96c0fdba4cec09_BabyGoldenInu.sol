...
/**
       Welcome to #BabyGoldenInu 
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BabyGoldenInu designed.
      
       This is a community token. If you want to create a telegram.
       I suggest by name : @BABYGOLDENINU
       ...
       I will renounce the ownership to burn addresses to transfer #BabyGoldenInu to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 10% total supply to the pool
       Can you make #BabyGoldenInu 10000X? 
       ...
       it's the best part of the #GoldenBabyInu idea, increasing the liquidity pool automatically, 
...
contract BabyGoldenInu is Context, IERC20, Ownable {
    ...
    string private _name = "BabyGoldenInu";
    string private _symbol = "BGOLDINU";
