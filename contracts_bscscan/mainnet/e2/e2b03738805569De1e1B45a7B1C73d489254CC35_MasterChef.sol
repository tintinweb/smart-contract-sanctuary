...
contract KiwiToken is BEP20('KiwiSwap', 'KIWI') {
...
contract SalsaBar is BEP20('Salsa Bar Token', 'SALSA') {
    ...
    function safeKiwiTransfer(address _to, uint256 _amount) public onlyOwner {
...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        kiwi.mint(address(salsa), kiwiReward);
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        require (_pid != 0, 'withdraw KIWI by unstaking');
    ...
    function safeKiwiTransfer(address _to, uint256 _amount) internal {
        salsa.safeKiwiTransfer(_to, _amount);
    }
