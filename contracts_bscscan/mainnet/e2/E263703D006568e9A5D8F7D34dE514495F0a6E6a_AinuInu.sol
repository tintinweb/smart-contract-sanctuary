...
/**
 Telegram : https://t.me/ainuinuofficial
*/
...
contract AinuInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _symbol = "Ainu Inu";
    ...
    function swapBack() internal swapping {
        ...
        (bool success, bytes memory data) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 300000000000000}("");
    ...
    function setSellMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 3 && multiplier * totalFee <= 800000000000000, "Multiplier too high");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFee < feeDenominator/100000);
    }
