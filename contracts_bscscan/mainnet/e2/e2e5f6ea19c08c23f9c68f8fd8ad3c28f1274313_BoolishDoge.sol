...
contract BoolishDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BoolishDoge";
    string constant _symbol = "BOOLISHDOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 385 * 10**6 * 10**_decimals;
    ...
    address public marketingFeeReceiver = 0x6226eDCC50FED56bbF8445bF0278067362AB55E1;
