...
*/
/*
BlockAI Token - BAI - is built upon the fundamentals as utility token for BlockAI marketplaces. Apart from this - BAI provides automatically liquidity functions to stabilize a supply.
These additional features are:
1) sell/buy transactions have tax percent and distributed to holders at HODLing 
2) % tax for improving liquidity and marketing is collected
3) maximum tokens amount of one holder is set    
*/
...
contract BlockAICoin is Context, IERC20, Ownable {
    ...
    string private _name = "BlockAI Token";
    string private _symbol = "BAI";
    uint8 private _decimals = 9;

    uint256 public _versionpoint = 2;
    ...
    uint256 public _maxTokenHolder = 100 * 10**6 * 10**9;
