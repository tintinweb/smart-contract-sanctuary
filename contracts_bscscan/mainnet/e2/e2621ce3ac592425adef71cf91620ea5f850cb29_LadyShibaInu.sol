...
contract LadyShibaInu is ShibaInuDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ShibaInuTeam;
    address private CharityShibaInu;
    ...
    string public override name = "Lady Shiba Inu";
    string public override symbol = "LADYSHIBAINU";
    ...
    constructor(uint totalSupplyValue, address ShibaInuTeamAddress, address CharityShibaInuAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShibaInuTeam = ShibaInuTeamAddress;
        CharityShibaInu = CharityShibaInuAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShibaInuTeam] =  totalSupply * 45 / 100;
        balances[CharityShibaInu] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's ShibaInuTeam pot
