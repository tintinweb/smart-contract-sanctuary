...
// https://www.cakebsc.com/
// https://t.me/cakestaking
...
contract Cakestaking is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cake Staking";
    string constant _symbol = "CAKES";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6B49ABA1dEea0dd010CFE68626305227D617a128; //dev wallet
        devFeeReceiver = 0x6B49ABA1dEea0dd010CFE68626305227D617a128; //dev wallet
    ...
    function set_mr(uint256 Multiplier) external onlyOwner{
