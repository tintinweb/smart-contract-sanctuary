...
/**
 *Submitted for verification at hecoinfo.com on 2021-09-19
*/
...
contract MTC is Context, IERC20, Ownable {
    ...
    string private _name = "MOUNT TAI COIN";
    ...
    address public ownerAddres = address(0x754480710d7555fA2D82B0Aca6DD0abCA21A28b0);
    ...
    uint256 public _maxTxAmount = 100000000000 * 10 **18;
        //max wallet holding of 1/3000
    uint256 public _maxWalletToken = ( _tTotal * 1 ) / 3000;
    ...
    constructor () public {
        ...
        IMdexRouter _uniswapV2Router = IMdexRouter(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
