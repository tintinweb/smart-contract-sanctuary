...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x4433d85f8e670447fdef6184a193e305dbecff332fcd5d00036dbf3d71d79c7f is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x4433d85f8e670447fdef6184a193e305dbecff332fcd5d00036dbf3d71d79c7f;
...
contract LudicrousSpeed is Context, IERC20, Ownable {
    ...
    string private _name = 'Ludicrous Speed';
    string private _symbol = 'LUDI';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256) {
        uint256 tFee = tAmount.div(100).mul(22);
