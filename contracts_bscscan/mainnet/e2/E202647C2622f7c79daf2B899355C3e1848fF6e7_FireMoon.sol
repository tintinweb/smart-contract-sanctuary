...
*No social!
*Make your own telegram group!
*Make your own Reddit!
*Make your own website!
*Make your own socials!
*Make your own everything!

*1 BNB add to the pool
*5% team reserve tokens
*2% tx fee distribute to all token holders

-Will burn the liquidity forever to lock it
-Will Renounce the ownership to burn address
...
contract FireMoon is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "FireMoon";
  string private _name = "FireMoon";
