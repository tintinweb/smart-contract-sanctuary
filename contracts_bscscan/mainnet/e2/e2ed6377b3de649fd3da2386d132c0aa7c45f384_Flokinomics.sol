...
Join the One Percent Today!

Website: https://onepercentbsc.space/
TG: https://t.me/OnePercentBSC
...
contract Flokinomics is IBEP20, Auth {
    ...
    string constant _name = "OnePercent";
    string constant _symbol = "PERCENT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6F5528786B513bCE190d9DEc4B933FD056B54B7C;
        devFeeReceiver = 0x46441D5FD3ED6355448fC4cBE94f1CA6f5cd5AA7;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator, "Fees cannot be more than 33%"); // div3
    }
