...
/**
Burger Baby - BuBa 
Earn BUSD token every hours, by holdings Burger Baby 

supply: 100.000.000.000
decimals: 9 
liquidity: 5 BNB
telegram: BurgerBabyOfficial
website: www.BurgerBaby.net
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0xAe9269f27437f0fcBC232d39Ec814844a51d6b8f); // REWARD TOKEN
...
contract BurgerBaby is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD = 0xAe9269f27437f0fcBC232d39Ec814844a51d6b8f; // REWARD TOKEN
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BurgerBaby";
    string constant _symbol = "BuBa";
