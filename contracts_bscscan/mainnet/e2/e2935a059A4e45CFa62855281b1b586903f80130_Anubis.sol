...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #Anubis

    I make this #Anubis to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/Anubis_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #Anubis to the community, make sure it's 100% safe.

   I will add 5 BNB and all the left 49.5% total supply to the pool
   Can you make #Anubis 10000000X? 
   ...
   it's the best part of the #Anubis idea, increasing the liquidity pool automatically, 
...
contract Anubis is Context, IERC20, Ownable, Pausable {
