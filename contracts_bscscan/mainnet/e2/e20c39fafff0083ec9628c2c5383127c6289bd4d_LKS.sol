...
/**
 * 
LuckyStrike is an easy to play blockchain prediction game that aims to provide a seamless experience of the online blockchain prediction games interlaced with a user-friendly design and Nfts enable to play to earn. 
*/
