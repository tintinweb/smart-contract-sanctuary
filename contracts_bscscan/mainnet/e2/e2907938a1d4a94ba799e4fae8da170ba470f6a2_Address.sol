...
/** told you dont boei this serrrrrs
*/
...
contract DONTBOEI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100000000000 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "DONTBOEI";
    ...
    uint256 public cooldownTimerInterval = 5;
