 ...
 */
contract PiggySwapper is Context, Ownable {
  ...
  address public _piggyAddress = 0xCd2eCd5e06b1a330789B30e8AdA3D11c51503a71;
  
  function swapForPiggy(address sender, uint256 value) internal {
  ...
  function setPiggyContractAddress(address nPiggyAddr) public onlyOwner {
      _piggyAddress = nPiggyAddr;
  }
