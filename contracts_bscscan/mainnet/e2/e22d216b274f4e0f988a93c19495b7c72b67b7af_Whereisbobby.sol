...
// File contracts/WHEREBOBBY.sol
pragma solidity ^0.8.0;

contract Whereisbobby is Context, IERC20, Ownable {
    ...
    string private constant _name = "Where is Bobby?";
    string private constant _symbol = "WIB";
