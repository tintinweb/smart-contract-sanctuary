...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71); //the reward token you want distributed - CINU
...
contract CHEEMSVAULT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0x39fdcf279EfE831BfcE2CfdEE7f61B97e0a66FDB;
    address public devWallet = 0x39fdcf279EfE831BfcE2CfdEE7f61B97e0a66FDB;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "CHEEMSVAULT";
    string constant _symbol = "CHEEMSVAULT";
    ...
    uint256 public sellingRewardFee = 4;
    uint256 public buyingRewardFee = 4;
    
    uint256 public sellingLpFee = 7;
    uint256 public buyingLpFee = 7;
    ...
    // Total = 100%
    uint256 public marketingPortionOfSwap = 40; // 40%
    uint256 public rewardPortionOfSwap = 30; // 30%
    ...
    function swapBack() internal {
        ...
        uint256 amountBNBRewards = amountBNB.mul(rewardPortionOfSwap).div(FEES_DIVISOR);
