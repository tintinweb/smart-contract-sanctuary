...
contract Ownable is Context {
    address private _owner = 0x3D5fDf75e39Ff925DA0f669616968b3f336D1cf6;
...
contract Starship is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xAed2379403A35ccA645b199da86469bE9FABdC21); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Starship"; // token name
    string private _symbol = "SN20Zilla"; // token symbol
    ...
    uint256 durationBetweenEachBuyback = 7 days; // duration betweeen each buyback
    ...
    uint256 public _maxTxAmount = _tTotal.div(200); // max allowed tokens tranfer per transaction
    uint256 public _minTokensSwapToAndTransferTo = 69000000000000000000 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(100); // Max number of tokens that an address can hold 1% of total supply
	...
	*/
     ...
     */
    function buyBackTokens() public onlyOwner {
     ...
     * NOTE! if ownership is renounced then it will not work
     */
    function buyBackB() public onlyOwner {
