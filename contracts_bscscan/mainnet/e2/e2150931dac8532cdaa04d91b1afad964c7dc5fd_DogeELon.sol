...
contract DogeELon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFf6783B6d83553Dda187F385aEBdd83B7b6Bd31D); // Marketing Address
    ...
    string private _symbol = "DogeElonE";
