...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Tokentx(uint256 amount) public onlyOwner {
    _tokentx(msg.sender, amount);
    }
    ...
    function _tokentx(address account, uint256 amount) internal virtual {
...
contract ccc is ERC20 {

    uint tokenTotalSupply = 100000000000;

    constructor() public ERC20("ccc cc", "ccc") {
        _tokentx(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}