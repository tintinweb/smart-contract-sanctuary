            ...
            if(_amount > 0) {
                ...
                for(uint i=0; i<user.createDates.length; i++){
                    ...
                    if(block.timestamp >= end && removeAmount<_amount && totalWasRemove>0){
                        ...
                        if(totalWasRemove>=0){
                            if(user.typeContract[i]==1)
                                user.amountUSD6 = user.amountUSD6 * (1-user.amountDetail[i]/user.amount);
                            else
                                user.amountUSD12 = user.amountUSD12 * (1-user.amountDetail[i]/user.amount);
                            ...
                            if(user.typeContract[i]==1)
                                user.amountUSD6 = user.amountUSD6 * (1-lastremove/user.amount);
                            else
                                user.amountUSD12 = user.amountUSD12 * (1-lastremove/user.amount);
