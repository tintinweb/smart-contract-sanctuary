...
/**
* ~ Drunk Token features ~
* 
* Instant staking and burn on each transaction
* 10% tax (5% burn, 5% auto distributed to holders)
* Be the proud owner of some DRUNKs!
* 
* Since I'm drunk as fuck, I am simply gonna copy Cummies' contract!
* 
* Website - https://DrunkToken.com/ (I don't really have this website, i just placed an order 12 seconds ago)
* Join the Telegram - https://t.me/DrunkToken
* Join the Discord - https://discord.gg/qNa46PYCD6
* Active VERY-anon team on all socials! lol!
* 
* ok maybe i become non-anon, if you're nice! xD
* 
* ANYWAYSSSS here is my contract, but first i must fetch another beer:
* 
*/
...
contract DrunkToken is Context, IERC20, Ownable {
    ...
    string private constant _name = 'DrunkToken';
