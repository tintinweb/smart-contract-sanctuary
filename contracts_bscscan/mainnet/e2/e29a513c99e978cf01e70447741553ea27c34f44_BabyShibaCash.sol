...
Hold $BabyShibaCash To Earn $Shiba 

💰 Total Supply: 100,000,000,000 Coins

🪙 Tokenomics : 5% Marketing,
5% Liquidity, 5% Rewards 

🌐 Website : https://babyshiba.cash/

*IMPORTANT - NO PRE-SALE, NO WHITELISTING*

COIN WILL BE FAIR LAUNCH ON 12TH AUG!!! 

⌛️ Roadmap:
• Website Launch ✅. 
• Rug Check. 
• Liquidity will be Locked for 2 Months.
• Pre-Audited Code.
• Heavy influencer marketing pre launch ( in progress )
• Listing on Coingeko, CMC after launch.
• Listing on Major Exchanges.

All other info will be announced soon.

ADMINS WONT DM FIRST PLEASE BE AWARE OF COPIES WE HAVE NOT LAUNCHED YET!! 

TG : t.me/BabyShibaCash
...
contract BabyShibaCash is Context, IERC20, Ownable {
    ...
    string private _name = "BabyShibaCash";
