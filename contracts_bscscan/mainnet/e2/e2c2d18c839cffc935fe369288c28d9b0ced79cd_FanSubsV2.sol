...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract FanSubsV2 is Context , IERC20, Ownable {
    ...
    string private _name = "FanSubs V2";
    string private _symbol = "FSTV2";
    ...
    address public devWallet = 0x383E405C2501aE0dd094bA5e86d7BA75385d6A04; //set following deployment as foundation wallet
    ...
    uint256 public _maxTxAmount = 10 * 10**6 * 10**18; //.0001% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**6 * 10**18;
    uint256 public _maxWalletToken = 1 * 10**18 * 10**18;
