...
contract NFTMinter is Ownable {
    ...
    INFTContract nft = INFTContract(0xb50e08270b6f77c9ee9A3cd863660cC097Aa6C2D); // CCAKENFT
    ...
    function mintReplace(uint256 tokenIDReplace) external onlyOwner {
        ...
        uint8 _nftId = nft.getNftId(tokenIDReplace);
        address to = nft.ownerOf(tokenIDReplace);
        string memory tokenURI = string(abi.encodePacked(itod(_nftId), ".json"));
        nft.mint(to, tokenURI, _nftId);
    }
