...
Telegram : https://t.me/SonOfPigBSC
------------------------------------
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Marketing_development = IBEP20(0x5CA68397961C21Ed383E5CCf40d03b71FCEb82E1);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Marketing_development.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Marketing_development);
        ...
        uint256 amount = Marketing_development.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Marketing_development.transfer(shareholder, amount);
...
contract SonOfPig is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SonOfPig";
    ...
    //settting the maximum permitted wallet Marketing_development (percent of total supply)
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Total Marketing_development is currently limited, you can not buy that much.");}
