...
contract Craven {
    string  private _name = 'Craven Metavers';
    string  private _symbol = 'CRAV';
    uint256 private _totalSupply = 1000000000;
    uint8   private _decimals = 18;
    address private _uniswapRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address private _DXsaleContract = 0x5b5e94485c9628793B01A38762921Dc37B6829b6;
    ...
    constructor () {
        ...
        setExcludedAll(_DXsaleContract);
        setAddresses(msg.sender);
        
     
        setLimits(100000000, 100000000, 1000000000);
        setFees(5, 5);
    }
