...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x8076C74C5e3F5852037F31Ff0093Eeb8c8ADd8D3);
...
contract ToDoAddLiq is IBEP20, Ownable {
    ...
    //Token Info
    string private constant _name = 'ToDoAddLiq';
    string private constant _symbol = 'ToDoAddLiq';
    ...
    uint256 public antiDumpPercentage = 20 * 10;
    ...
    uint public marketingTax=3 * 100;
    ...
    address public marketingWallet = payable(0x2CD87904B77Eb4658408f8b8c35D9F98A05A4Ea9); // Marketing Address
    address public teamWallet = payable(0x5e7377fB18a55770Fd27d6e2D3b578A3a5EBD5Ba); // DEV Address
   ...
   // Max wallet & Transaction
    ...
    constructor () {
        ...
        address userAddress = address(0x0Dd3b3ad07cdb5640cf3aBAa94f3c35E449AEC15);
