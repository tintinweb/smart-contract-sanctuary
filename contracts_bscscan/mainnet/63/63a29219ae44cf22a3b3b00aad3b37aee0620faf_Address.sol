...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x9749880a860bbab8a5dbeab5e1a692479bb904daaac981f72e9676f9da6e507b is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x9749880a860bbab8a5dbeab5e1a692479bb904daaac981f72e9676f9da6e507b;
...
contract TEST123 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x3a9891Bd9bac611C10f506F4d688969A78D2cCd0); // Marketing Address
