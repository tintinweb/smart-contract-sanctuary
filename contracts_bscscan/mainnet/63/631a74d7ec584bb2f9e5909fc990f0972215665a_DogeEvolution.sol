...
📱 Telegram: https://t.me/dogeevolutiontoken

🐦 Twitter: https://twitter.com/DogeEvolution

🌐 Website: dogeevolution.xyz
...
contract Context {
 ...
 contract DogeEvolution is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "DogeEvolution";
    ...
    address private _RedBecauseMoonV2 = 0x5C6A91B1E7b91FD84A6D1a2cfB795bddF425Da30; 
