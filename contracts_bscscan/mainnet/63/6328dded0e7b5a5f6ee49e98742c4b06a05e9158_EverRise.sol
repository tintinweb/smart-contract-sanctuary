...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x4C35286974660658d1AB54756a332C04fd52D72a); // Marketing Address
    ...
    string private _name = "superbabykitty";
    string private _symbol = "superbabykitty";
