...
/**
 ...
 .----------------.  .----------------.  .----------------.  .----------------.   .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. |
| | ____    ____ | || |  _________   | || |  _________   | || |      __      | | | |  _________   | || |   ______     | |
| ||_   \  /   _|| || | |_   ___  |  | || | |  _   _  |  | || |     /  \     | | | | |_   ___  |  | || |  |_   _ \    | |
| |  |   \/   |  | || |   | |_  \_|  | || | |_/ | | \_|  | || |    / /\ \    | | | |   | |_  \_|  | || |    | |_) |   | |
| |  | |\  /| |  | || |   |  _|  _   | || |     | |      | || |   / ____ \   | | | |   |  _|      | || |    |  __'.   | |
| | _| |_\/_| |_ | || |  _| |___/ |  | || |    _| |_     | || | _/ /    \ \_ | | | |  _| |_       | || |   _| |__) |  | |
| ||_____||_____|| || | |_________|  | || |   |_____|    | || ||____|  |____|| | | | |_____|      | || |  |_______/   | |
| |              | || |              | || |              | || |              | | | |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------' 
...
contract WrappFLOKI is Context, IERC20AntiBots, Ownable {
    ...
    uint256 private constant _ALLTOTALSUPPLY = 99000000000000 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _ALLTOTALSUPPLY));
    uint256 private _tFeeTotal;

    string private _name = 'Wrapped FLOKI';
