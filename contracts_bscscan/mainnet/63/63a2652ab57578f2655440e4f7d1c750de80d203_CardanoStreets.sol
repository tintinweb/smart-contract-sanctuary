...
// CardanoStreets ($STREETS) - CardanoStreets is the native token for the CardanoStreets NFT Racing game on BSC.
// Tax 10% Buy | Sell 
...
contract CardanoStreets is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6e4b3e13731D168403D9996BEF51c6a3973cc70F); // Marketing Address
    ...
    string private _name = "CardanoStreets";
    ...
    // Prevent BOT & Whales
    function zLiquidityEnabled() public deadCall {
