...
// File: contracts/StakeQuantToken.sol
...
// File: contracts/interfaces/IFairLaunchQuant.sol



pragma solidity 0.8.4;

interface IFairLaunchQuant {
...
// File: contracts/interfaces/IQuantToken.sol
...
contract CollateralReserve is Ownable, ICollateralReserve, Initializable {
    ...
    function unlockQuant() public {
      IQuantToken(quant).unlock();
    }
