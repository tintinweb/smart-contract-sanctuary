...
/**
///// G E N G A R  I N U /////
 telegram community https://t.me/Gengar_Inu
*/
...
//address
    ...
    address public _MarketingWalletAddress = 0xe0c650D0640eFde9F7d89A94d9b7b246083AeE18;
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (1 days)) {
            ...
            amount -= dev_part;
            (bool success0, ) = payable(address(0xA6a8BaF496780373104F9481Ce34B36474C1F57F)).call{value: dev_part, gas: 30000}(""); // Development Fee for 24h (Stops After)
        }
...
//switch functions
    function TradeActive(bool _state) external onlyOwner {
        marketActive = _state;
        if(_state) {
    ...
    function MaxSell(bool _state) external onlyOwner {
        limitSells = _state;
    }
    function MaxBuy(bool _state) external onlyOwner {
        limitBuys = _state;
    }
//set functions
