...
contract kingdomToken2 is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Kingdom Token 2";
    string private _symbol = "KT2";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        //(account, 'We can not exclude Pancake router.');
    ...
    // Innovation for protocol by kingdom Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own KT2 to claim reward');
