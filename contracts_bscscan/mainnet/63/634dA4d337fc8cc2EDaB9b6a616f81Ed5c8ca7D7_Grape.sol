...
contract Grape is Context, IERC20, Ownable {
    ...
    string private _name = "Grape";
    string private _symbol = "Grape";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd6b504e3b9F72b587272ecE94EBc8c75a4A7996C); // Marketing Address
    address payable public teamWalletAddress = payable(0x5e5D3f2abDd1d50E1B83F3321c6a6E478BCFA3B1); // Team Address
    ...
    uint256 private _totalSupply = 1 * 10**6* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 1 * 10**6 * 10**6* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 3000 * 10**6* 10**_decimals; 
