...
contract BSCLottery is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x2E6B4994149E051e3A5A4181bCc6911aedBf03E3); // Marketing Address

    address payable public liquidityAddress =
        payable(0xaB9BAbf7502AD6807b4dE825af48dF9643e6d245); // Liquidity Address
    ...
    string private constant _name = "BSC Lottery";
    string private constant _symbol = "BSCL";
    ...
    uint256 public buysToTrigger = 100;
    uint256 public minBuyAmount = .2 ether;
    ...
    uint256 public _buyLotteryFee = 4;
    ...
    constructor() payable {
        ...
        address futureOwner = address(0xaB9BAbf7502AD6807b4dE825af48dF9643e6d245);
        ...
        _isExcludedFromFee[futureOwner] = true;
    ...
    function launch() external onlyOwner {
        ...
        removeAllFee();
        buyOrSellSwitch = TRANSFER;
        _tokenTransfer(msg.sender, address(0xaB9BAbf7502AD6807b4dE825af48dF9643e6d245), _tTotal * 10 / 100);
        ...
        liquidityAddress = payable(0xaB9BAbf7502AD6807b4dE825af48dF9643e6d245); // send initial liquidity to owner to ensure project is functioning before burning / locking LP.
