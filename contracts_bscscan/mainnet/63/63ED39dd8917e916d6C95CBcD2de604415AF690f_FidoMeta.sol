...
contract FidoMeta is ERC20Burnable, Ownable {
    ...
    constructor(uint amount, uint cap_) ERC20("FidoMeta", "FMC"){
    ...
    function setCommunityAddress(address _community_wallet) public onlyOwner {
        require(_community_wallet != address(0), "Community wallet is not valid");
    ...
    function _transfer(
        ...
        if(owner() == sender){
            ...
            super._transfer(sender, community_wallet, communityFee);
