...
contract BrokenBlade is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BrokenBlade";
    string constant _symbol = "BrokenBlade";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 10;

    //max wallet holding of 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 10;
