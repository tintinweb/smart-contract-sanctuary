 ...
 * 
 Welcome to $FluffyShiba:
   ...
   Many Great features:
    ...
    5.LP send to Mudra Liquidity Locker for 30days, if the response is good, I will continue to extend it
    ...
    it's the best part of the $FluffyShiba idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 4bnb in the pool. 
...
contract FluffyShiba is Context, IERC20, Ownable {
