...
contract GetADA is Context, IERC20, Ownable {
    ...
    address payable marketingAddress = payable(0x1377d5771383Dd03EC7c0EC9e15BD3D589eFbf23); 
    ...
    string private _name = "GET ADA";
    string private _symbol = "GETADA";
    ...
    uint256 private firstFewBlocksF = 90;
    ...
    function _transfer(
        ...
        if (takefirstFewBlocks) {
                ...
                _transferStandard(from, marketingAddress, fees);
        }
