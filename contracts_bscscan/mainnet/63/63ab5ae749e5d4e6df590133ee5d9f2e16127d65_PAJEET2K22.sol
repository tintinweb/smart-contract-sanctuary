...
contract PAJEET2K22 is Context, IERC20, Ownable, dAPPRewards {
    ...
    string private _name = "PAJEET2K22";
    string private _symbol = "THIS IS A FUCKING RUG PULL, RUGGING AT 1500 UTC, IT'S NOT A RUG IF YOU GET OUT BEFORE THE RUG";
