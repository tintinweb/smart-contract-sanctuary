...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public novaSwap = 0x0c0bf2bD544566A11f59dC70a8F43659ac2FE7c2;
    address public sNovaAddress = 0x0c0bf2bD544566A11f59dC70a8F43659ac2FE7c2;
    ...
    function earn() public virtual nonReentrant whenNotPaused {
        ...
        uint256 earnedAmtsNova = IERC20(sNovaAddress).balanceOf(address(this));
         IERC20(sNovaAddress).safeApprove(novaSwap, 0);
        IERC20(sNovaAddress).safeIncreaseAllowance(
            novaSwap,
            earnedAmtsNova
        );
        ISwap(novaSwap).swapToNova(earnedAmtsNova);
...
contract StratXShiba is StratX2 {
