...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //cake
...
contract BabyAmerica is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby America;";
    string constant _symbol = "BABYAMERICA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x444eE71399e13c59797ECCfb1331366DB53DA78E;  // marketingwallet
