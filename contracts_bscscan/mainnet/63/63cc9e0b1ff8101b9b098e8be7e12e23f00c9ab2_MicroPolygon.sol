...
/**
   ...
   Welcome to MicroPolygonBSC
   
   This is a community token. If you want to create a telegram I suggest to name it to @MicroPolygonBSC
   ...
   I will renounce the ownership to burn addresses to transfer #MicroPolygonBSC to the community, make sure it's 100% safe.
...
contract MicroPolygon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Micro Polygon";
