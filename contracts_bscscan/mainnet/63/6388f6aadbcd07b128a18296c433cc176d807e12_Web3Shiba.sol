...
contract Web3Shiba is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0x703BF7Ebe489856A2764E4E708ca42E92f577d94;
    ...
    string private _name = "Web3Shiba";
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            ...
            require(balanceOf(from) <= maxWallet, "Wallet exceeds Max Wallet limit.");
