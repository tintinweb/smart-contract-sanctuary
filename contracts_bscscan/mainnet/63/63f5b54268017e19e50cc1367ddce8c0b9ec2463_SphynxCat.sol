...
/**
  ...
  Tokenomics  
  Total Supply: ( 250B / 300.000.000.000 $SphynxCat)  
  - 7% liquidity
  - 7% $SPHYNX Reflection
  - Total Slip* 15%
...
contract DividendDistributor is IDividendDistributor {
  ...
  IBEP20 RWRD = IBEP20 (0x2e121Ed64EEEB58788dDb204627cCB7C7c59884c); 
...
contract SphynxCat is IBEP20, Auth {
    using SafeMath for uint256;
  
 
     address RWRD = 0x2e121Ed64EEEB58788dDb204627cCB7C7c59884c;  
     address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = 'SphynxCat';
    string constant _symbol = 'SphynxCat';
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 250000000000 * (10 ** _decimals);  
