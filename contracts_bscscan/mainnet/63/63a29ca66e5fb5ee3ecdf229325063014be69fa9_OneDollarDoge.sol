...
library Address{
 ...
 contract OneDollarDoge is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 500000000;
    ...
    string private constant _name = "1DollarDoge";
    string private constant _symbol = "1$DOGE";
    ...
    Taxes public taxes = Taxes(1, 5, 3, 3);
    Taxes public sellTaxes = Taxes(1, 5, 5, 4);
