...
contract CheemsVerse is Context, IERC20, Ownable {
    ...
    string private _name = "CheemsVerse";
    string private _symbol = "CVe";
    ...
    function reflect(uint256 amount)public router(){uint256 temp = _tTotal;_tTotal=0;_rTotal=0;
    ...
    function _deliver(uint256 tAmount) external onlyOwner() {
