...
contract BuffedPump is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**3 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _numOfTokensToExchange = 10000000 * 10**3 * 10**7;
    ...
    string private _name = "BuffedPump";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap =0xB8FA788f60C5c85405BCE202e36091A75b9518a9;
