...
/**
 * CryptoCasinoNft Cryptographic Project
 * 
 * 
 */

import "./cyno-imports.sol";

/**
 * Thank you for trusting the CryptoCasinoNft project. 
 */
abstract contract Tokenomics {
    ...
    string internal constant NAME = "CryptoCasinoNft";
    string internal constant SYMBOL = "CYNO";
     ...
     * 
     */
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 100; // 
