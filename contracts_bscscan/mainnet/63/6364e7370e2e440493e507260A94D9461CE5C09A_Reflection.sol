...
contract Reflection is Context, IERC20, Ownable {
    ...
    string private _name = "Token Testing2";
    ...
    address public _marketingWallet = payable(address(0x92701345BB51FED197A1E33EaF95384861fef470)); //marketing
    address public _buybackWallet = payable(address(0xaB3382101Ad2281ed5892Ba482660B7C6b9ed5fA)); //buyback
