...
contract Bigger is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xBB7289e22b45da19fF815f78679F20d848Bc7e25); // Marketing Address
    ...
    string private _name = "BigTester";
    string private _symbol = "BIGTEST";
    ...
    uint256 public marketingDivisor = 5; // marketing fee
    
    uint256 private maxTxPercent = 20; // MAXTX - 2%
    ...
    uint256 public buyBackSellLimit = 2 * 10**12;
