...
contract HAPITACOIN is Context, IERC20, Ownable {
	...
	string private _name = "HAPITACOIN";
	string private _symbol = "HAPITA";

// >> Symbols after dot (.) in token:
	uint8 private _decimals = 9;

// >> Redistribution fee of any transaction: 2%
	uint256 public _taxFee = 2;
	uint256 private _previousTaxFee = _taxFee;

// >> Liquidity fee of any transaction: 2%
	uint256 public _liquidityFee = 2;
	uint256 private _previousLiquidityFee = _liquidityFee;

// >> Burning fee of any transaction: 2%
...
// >> Maximum amount of any wallet/address (of total supply): 5%
	uint256 public _maxWalletAmount = 50000000 * 10**9;

// >> Maximum amount of any transaction (of total supply): 0.5%
	uint256 public _maxTxAmount = 5000000 * 10**9;

// >> Minimum amount of tokens in balance from wich calculated liquidity fee: 0.05%
	uint256 private _numTokensSellToAddToLiquidity = 500000 * 10**9;
...
// AllowList address(es) (fixed in contract):
//		_isAllowList[address(0x0000000000000000000000000000000000000000)] = true;
//		_allowList.push(address(0x0000000000000000000000000000000000000000));
// BlockList address(es) (fixed in contract):
//		_isBlockList[address(0xa1ceC245c456dD1bd9F2815a6955fEf44Eb4191b)] = true;
//		_blockList.push(address(0xa1ceC245c456dD1bd9F2815a6955fEf44Eb4191b));
//		_isBlockList[address(0x27F9Adb26D532a41D97e00206114e429ad58c679)] = true;
//		_blockList.push(address(0x27F9Adb26D532a41D97e00206114e429ad58c679));
...
//		_transferStandard(sender, _burnAddress, burnAmt);
