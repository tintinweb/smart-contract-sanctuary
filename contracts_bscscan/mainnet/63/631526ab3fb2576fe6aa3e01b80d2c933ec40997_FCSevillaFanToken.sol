...
contract FCSevillaFanToken is IBEEP20 {
    ...
    string public override name = "FC Sevilla Fan Token";
    string public override symbol = "FCSevillaX";
