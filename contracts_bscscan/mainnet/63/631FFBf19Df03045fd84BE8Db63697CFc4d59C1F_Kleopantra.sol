...
// change "name1" into ur name
    contract Kleopantra is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Kleopantra";
    string private _symbol = "KLPN";
    ...
    uint256 internal _tokenTotal = 50_000_000_000_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0xbEfCd4ee4bfB814E18483A04e512699f6b3FFFe7;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
