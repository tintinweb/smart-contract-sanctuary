...
contract AYFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x28F34b4BB2EB148C8333230c061bD815c0ABC6b9); // Marketing Address
    address payable public charityAddress = payable(0x28F34b4BB2EB148C8333230c061bD815c0ABC6b9); // Charity/Dev Address
    ...
    string private _name = "AY Finance";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 100000000000000000000000000; // 100,000,000; token will be given on airdrop
