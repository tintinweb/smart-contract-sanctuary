...
contract TRC20 is ITRC20 {
    ...
    function _mint(address account, uint256 value) internal {
        ...
        require(_totalSupply <= 1000000000000000);
...
/**
 * @title CHACHA Token Contract
 * @dev Responsible for receiving the token's details at deployment
    and creating the token with the TRC20 token standard. CHACHA token
    also has the burn feature
 * @author @wafflemakr
 */

contract CHACHA is TRC20Burnable, TRC20Mintable{


    /**
     * @notice Token Deployment
     * @param name Name of the token (CHACHA)
     * @param symbol Symbol of the token (CHACHA)
