...
library Utils {
    ...
    function swapETHForTokens(
        ...
        IPancakeV2Router02 pancakeRouter = IPancakeV2Router02(routerAddress);
...
contract TestToken is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "TestTokenName";
    ...
    function activateContract() public onlyOwner {
        ...
        // approve contract
        _approve(address(this), address(pancakeV2Router), 2 ** 256 - 1);
    }
    ...
    function calculateBNBReward(address ofAddress) public view returns (uint256) {
        ...
        .sub(balanceOf(address(pancakeV2Pair)));
    ...
    //     !(from == address(this) && to == address(pancakeV2Pair)) // swap 1 time
    //     ) {
    ...
    //         Utils.addLiquidity(address(pancakeV2Router), owner(), otherPiece, bnbToBeAddedToLiquidity);
