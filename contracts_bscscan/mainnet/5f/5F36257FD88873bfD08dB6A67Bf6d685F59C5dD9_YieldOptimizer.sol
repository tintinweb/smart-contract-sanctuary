...
contract YieldOptimizer {
    ...
    //                 // string(
    //                 //     abi.encodePacked(
    //                 //         appendUintToString("sharkAmountOut=pancakeAmountOut:", sharkAmountOut)
    //                 //     )
    //                 // )
    //                 "sharkAmountOut == pancakeAmountOut"
    //             );
    //         }
    ...
    //         'Unauthorized'
    //     ); 
    //     require(_amount0 > 0 && _amount1 == 0, "_amount0 is not greater than 0 or _amount1 != 0");

    //     address token0 = IUniswapV2Pair(msg.sender).token0();
    //     address token1 = IUniswapV2Pair(msg.sender).token1();

    //     require(token0 == CAKE_TOKEN_ADDRESS);

    //     address[] memory path = new address[](2);
    //     path[0] = token0;
    //     path[1] = token1;

    //     // uint amountOutRequired = autosharkRouter.getAmountsOut(
    //     //     _amount0, 
    //     //     path
    //     // )[1];

    //     // uint amountOut = pancakeRouter.getAmountsOut(
    //     //     _amount0, 
    //     //     path
    //     // )[1];

    //     require(false, "got here - FinsCall");
            
    //     (uint112 reserve0, uint112 reserve1,) = IUniswapV2Pair(CAKE_BNB_TOKEN_ADDRESS).getReserves();
    //     uint amountOut = getAmountOut(_amount0, reserve0, reserve1);

    //     (reserve0, reserve1,) = IUniswapV2Pair(AUTOSHARK_CAKE_BNB_TOKEN_ADDRESS).getReserves();
    //     uint amountOutRequired = getAmountOut(_amount0, reserve0, reserve1);

    //     require(amountOut > amountOutRequired, "pancake price not bigger than shark");

    //     require(false,
    //         string(abi.encodePacked(
    //             appendUintToString("fins-amountOut:", amountOut),
    //             appendUintToString(",amountOutRequired:", amountOut)
    //         ))    
    //     );
    ...
    //     require(amountReceived > amountOutRequired, "pancake price not bigger than shark");

    //     IERC20 otherToken = IERC20(path[1]);
    //     otherToken.transfer(msg.sender, amountOutRequired);
    //     otherToken.transfer(tx.origin, amountReceived - amountOutRequired);
    // }
    ...
    //     // uint amountOutRequired = pancakeRouter.getAmountsOut(
    //     //     _amount0, 
    //     //     path
    //     // )[1];

    //     // uint amountOut = autosharkRouter.getAmountsOut(
    //     //     _amount0, 
    //     //     path
    //     // )[1];
    ...
    //     require(amountOut > amountOutRequired, "shark price not bigger than pancake");

    //     require(false,
    //         string(abi.encodePacked(
    //             appendUintToString("cake-amountOut:", amountOut),
    //             appendUintToString(",amountOutRequired:", amountOut)
    //         ))    
    //     );
    ...
    //     require(amountReceived > amountOutRequired, "shark price not bigger than pancake");
