...
TG: https://t.me/Darth Vada   - A token that will take you to the dark side.
...
contract DarthVada is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Darth Vada";
    string constant _symbol = "DarthVada";
