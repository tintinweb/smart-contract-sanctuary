...
TG: https://t.me/https://t.me/bnbslice
...
contract BNBSlice is Context, IERC20, Ownable {
    ...
    uint256 private _supply_total       = 100 * 10**9 * 10**_decimals;
    uint256 private _supply_reflected   = (MAX - (MAX % _supply_total));
    string private  _name               = "BNB Slice Token";
    string private  _symbol             = "BNBSLICE";
    ...
    //refection fee
    uint256 public _fee_reflection = 300;
    uint256 private _fee_reflection_old = _fee_reflection;
    uint256 private _contractReflectionStored = 0;
    
    // marketing
    uint256 public _fee_marketing = 300;
    uint256 private _fee_marketing_old = _fee_marketing;
    address payable public _wallet_marketing = payable(0x40781657848fE6085C80044cf3025491c872AaC8);

    // for burn
    uint256 public _fee_burn = 100;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0xcD3c151fAC2122Fd2eC275E483d8Dd1411bd1B94);

    // for game / team
    uint256 public _fee_team = 300;
    uint256 private _fee_team_old = _fee_team;
    address payable public _wallet_team = payable(0x747161EE8CD19Df3d3128909C39b1136f0cBef62);

    // Auto LP
    uint256 public _fee_liquidity = 100;
    ...
    uint256 public _maxWalletToken = ( _supply_total * 3 ) / 1000;
    uint256 public _maxTxAmount =  ( _supply_total * 2 ) / 1000;
