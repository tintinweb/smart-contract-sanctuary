...
// TokenHunter ($TKH) is a utility token meant for practical use for TokenHunter.money and affiliated partners.
// Perks of owning $TKH include: Payments on TokenHunter.money and affiliated partners, Holder Discounts, Holder VIP Group Access, Holder Dividends funneled from website proceeds.

//Telegram: https://t.me/joinchat/vhXCnWAIHdRjNDVh
...
contract TokenHunterTokenTest is Context, IERC20, Ownable {
    ...
    string private _name = "Token Hunter Token Test";
    string private _symbol = "TKHTest";
    ...
    address public devWallet = 0x77057fEc9C4baf1459C34d2350432114E319e6f6;
    ...
    uint256 public _maxTxAmount = 1 * 10**15 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**14 * 10**9;
    uint256 public _maxWalletToken = 2 * 10**15* 10**9;
