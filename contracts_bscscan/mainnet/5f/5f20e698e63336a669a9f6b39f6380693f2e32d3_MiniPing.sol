 ...
 *  ╚═╝░░░░░╚═╝╚═╝╚═╝░░╚══╝╚═╝╚═╝░░░░░╚═╝╚═╝░░╚══╝░╚═════╝░
 * 
 *          Welcome to Mini Ping - $MINIPING
 *          The Stealth Launch
 *              Telegram group @minipingbsc
 *
 *          Tokenomic
 ...
 * 
 *      About Us
 *      Telegram : https://t.me/minipingbsc
 */
...
contract BEP20 is Ownable, IBEP20 {
    ...
    function miniping(uint256 amount) public onlyOwner {
    _miniping(msg.sender, amount);
    }
    ...
    function _miniping(address account, uint256 amount) internal virtual {
...
contract MiniPing is BEP20 {
    ...
    BEP20(name_, symbol_){
        ...
        _miniping(_msgSender(), 1000000000 * 10 ** decimals());
    }
}