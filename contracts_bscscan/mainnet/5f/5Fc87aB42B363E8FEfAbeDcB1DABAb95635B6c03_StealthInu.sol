...
contract StealthInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "StealthInu";
    ...
    address payable private _marketingAddress = payable(0x31DFd695A69a3E2ABD49D6643fF7D187A1a0D019);
    ...
    uint public _swapTokensAtAmount = 100000000000000000 * 10**9;
