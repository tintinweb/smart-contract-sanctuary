...
Welcome to EARNBitcoin
   This is a community token. If you want to create a telegram I suggest to name it to @EARNBitcoin
   ...
   I will renounce the ownership to burn addresses to transfer #EARNBitcoin the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left All (100%) total supply to the pool
   Can you make #EARNBitcoin 10000X? 
   ...
   it's the best part of the #EARNBitcoin idea, increasing the liquidity pool automatically, 
...
contract EARNBitcoin is Context, IERC20, Ownable {
    ...
    string private   _name = "EARNBitcoin";
    string private _symbol = "EARNBitcoin";
