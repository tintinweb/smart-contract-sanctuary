...
With RUG bot you will be able to scan any BSC/ETH tokens and check:
 ruggable, honeypot, lplock or unlocked, ownership renounce, distribution, buyback, taxes and more functions!!
*/
...
contract heroInu is Context, IERC20, Ownable {
    ...
    string private _name = "Rug Zero";
    string private _symbol = "RUG0";
