...
contract FuturovGovernanceToken is Context, IERC20, Ownable {
    ...
    string private _name = "DiamondInvestinG";
    string private _symbol = "DIGX";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2000000 ;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 2000000;
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _burnFee = 0;
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _marketingFee = 1000000;
    ...
    function enableAllFees() external onlyOwner() {
        ...
        _liquidityFee = 2000000;
        _previousLiquidityFee = _liquidityFee;
        _burnFee = 0;
        _previousBurnFee = _taxFee;
        _marketingFee = 1000000;
