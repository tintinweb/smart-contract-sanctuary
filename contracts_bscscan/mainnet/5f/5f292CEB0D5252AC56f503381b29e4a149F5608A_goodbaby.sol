...
contract goodbaby is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x3F06CCB822d698593B515f2984859CEC7Db217ef); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x3F06CCB822d698593B515f2984859CEC7Db217ef); // Liquidity Address
    ...
    uint256 private constant _tTotal = 12345678910 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "goodbaby";
    ...
    constructor() {
        address newOwner = address(0x3F06CCB822d698593B515f2984859CEC7Db217ef);
