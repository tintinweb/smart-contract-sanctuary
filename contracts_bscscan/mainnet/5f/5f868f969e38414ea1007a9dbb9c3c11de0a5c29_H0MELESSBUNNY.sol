...
contract H0MELESSBUNNY is IBEP20, B$TAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "H0MELESSBUNNY";
    string constant _symbol = "HMLSB";
    ...
    address public marketingFeeReceiver = 0xc977Ae58a97Fd8726fBA36Cda54aC324525B4E53;
    address public buybackFeeReceiver = 0xAe01d9A70bFec3939fcfe0D69EC5f036356ceb56;
    ...
    constructor () B$TAuth(msg.sender) {
