...
Youngest son of Doge,#CuteDoge The only doge with auto-claim feature of #BNB,With practical use cases and utilities.
...
contract COINCUTEDOGE is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 1000 * 10**9 * (10**18);
    ...
    uint256 public fixedSaleStartTimestamp = 1625838600; 
    ...
    uint256 public tradingEnabledTimestamp = 1625839200; 
...
contract CUTEDOGEDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("CUTEDOGE_Dividend_Tracker", "CUTEDOGE_Dividend_Tracker") {
    	claimWait = 1800;
        minimumTokenBalanceForDividends = 1 * 10**9 * (10**18); //must hold 1000000000+ tokens
    }
