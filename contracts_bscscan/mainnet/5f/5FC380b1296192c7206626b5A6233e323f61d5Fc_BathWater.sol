...
/**
   ...
   Welcome to BathWater
   
   This is a community token. If you want to create a telegram I suggest to name it to @BathWaterbsc
   ...
   I will renounce the ownership to burn addresses to transfer #BathWater to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make #BathWater 10000X? 
   ...
   it's the best part of the #BabyRocketInu idea, increasing the liquidity pool automatically, 
...
contract BathWater is Context, IERC20, Ownable {
    ...
    string private _name = "BathWater";
    string private _symbol = "Water";
