...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa8425A1Bf2522D6dC5fAFB3878438F979bA5A248;
...
contract BinanceBSC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2B8d180A93e869841a088b4DA324ca4dbfe7CE0f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BinanceBSC";
    ...
    uint256 public _maxTxAmount = 95000000000000 * 10**18;
