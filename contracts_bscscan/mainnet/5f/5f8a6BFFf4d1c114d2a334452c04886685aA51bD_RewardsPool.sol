...
contract RewardsPool is Context, Ownable{
    using SafeMath for uint256;
    
   function transferToRewardsDistribution(uint256 weiAmount, address payable addr) external onlyOwner{
       require(address(this).balance >= weiAmount, 'Inusfficient BNB balance');
