...
// File: contracts/SimitSwap.sol

pragma solidity 0.6.12;

contract SimitSwap is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable {
    constructor() 
    ERC20Detailed("SimitSwap", "SIMIT", 18) public {
        for(uint i =0 ;i < VALIDATOR_NUMBERS; i++ )
        {
            validators[i] = _msgSender();
        }
        super.mint(_msgSender(), 50000000 * 10 ** 18);
    }
