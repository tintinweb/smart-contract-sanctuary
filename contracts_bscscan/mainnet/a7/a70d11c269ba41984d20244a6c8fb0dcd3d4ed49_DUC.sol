...
contract DUC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DUC";
    string private _symbol = "DC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81107405C3b239C95692abF35bD4e70942162e48); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x81107405C3b239C95692abF35bD4e70942162e48); // BuyBack Address
