...
contract SugarFarm is Ownable, ReentrancyGuard {
    ...
    // Token address
    address public SUGAR = 0x41AA9F842AF935cC71252C0dE4BFF13F821546b8;
    // Owner reward per block: 10% ==> 11.11%
    uint256 public ownerSUGARReward = 1111;
    // Sugar total supply: 2 mil = 2000000e18
    uint256 public SUGARMaxSupply = 2000000e18;
    // Sugar per block: (0.190258751902588 - owner 10%)
    ...
    function getMultiplier(uint256 _from, uint256 _to)
        ...
        returns (uint256)
    {
        if (IERC20(SUGAR).totalSupply() >= SUGARMaxSupply) {
            return 0;
        }
