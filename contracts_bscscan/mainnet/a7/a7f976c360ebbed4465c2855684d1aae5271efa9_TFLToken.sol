 ...
 *
 */
contract TFLToken is ERC20Burnable, Ownable {
    ...
    uint256 public maxSupply = 100_000_000e8;

    constructor() ERC20("TFL Token", "TFL") {
    ...
    function decreaseMaxSupply(uint256 _amount) public onlyOwner {
        require(maxSupply.sub(_amount) >= totalSupply());
        maxSupply = maxSupply.sub(_amount);
    }
