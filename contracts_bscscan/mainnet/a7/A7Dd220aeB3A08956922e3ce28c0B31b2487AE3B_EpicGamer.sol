 ...
 *WELCOME PLAYER ONE
PLAY WITH CRYPTOS
Thought you'd seen it all? Welcome to an extra level in the Binance Smart Chain.
Here you will have an AAM to swap your BNB for EPIC Tokens and access the Pools and Farms where you can redeem your tokens for video game keys at the Epic Store.
Surprised? This has just started
*/

/**
 *Epic Gamer Token Bsc VideoGames for free playing whit Cryptos 

Thought you'd seen it all at BSC? EPIC GAMER arrives, the new AAM and yield farming platform that allows you to get video game keys to exchange in EPIC STORE. 
Totally free thanks to the EPIC Token!

🟢 NEW ON BSC
🟢 Active Staff
🟢 Safe Sale by DXSale
🟢 Audited Contract w/ Contract Ownership Renounced
🟢 CG & CMC immediately After Listing
🟢 Swap your Tokens for Videogame Keys

Website: https://epicgamer.finance/

Telegram: https://t.me/EPICGAMERbsc

Twitter: https://twitter.com/EPICGAMER_BSC1/

we delegate after fairlaunch our contract to masterchef
*/
