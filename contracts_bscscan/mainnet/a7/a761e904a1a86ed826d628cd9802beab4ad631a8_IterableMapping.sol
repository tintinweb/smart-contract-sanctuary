...
contract BKJEJU is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bank Jeju Doge", "BKJEJU") {
        BNBRewardsFee = 8;
        liquidityFee = 4;
        extraFeeOnSell = 3; // extra fee on sell
        marketingFee = 3;
        marketingWallet = payable(0xA662Cc777213768183A1455049c69FCcA16f1b59);
