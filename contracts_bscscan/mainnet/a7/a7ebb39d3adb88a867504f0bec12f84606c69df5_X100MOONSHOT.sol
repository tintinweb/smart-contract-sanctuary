...
//      ╚═╝░░╚═╝╚══════╝░╚════╝░░╚════╝░╚═╝░░░░░╚═╝░╚════╝░░╚════╝░╚═╝░░╚══╝╚═════╝░╚═╝░░╚═╝░╚════╝░░░░╚═╝░░░
    ...
    Total supply is 500 what is decreasing 6% every transaction,
    4% distributed to all hodlers automatically, the strong holder will get a valuable reward
...
contract X100MOONSHOT is Context, IERC20, Ownable {
    ...
    string private constant _name = 'x100 MoonShot';
    string private constant _symbol = 'MOONx100';
    
    uint256 private _taxFee = 100;
    uint256 private _burnFee = 500;
    uint private _max_tx_size = 500 * 10 ** uint256(_decimals);
