...
contract AstralInu is IERC20 {
    ...
    uint256 private constant startingSupply = 400_000_000_000_000_000; // 1 Quadrillion, underscores aid readability

    uint8 private _decimals = 9;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "Astral Inu";
    string constant _symbol = "Astral Inu";
    ...
    address payable private _marketingWallet = payable(0x1497961d54Ca605Abd1517Fa1c1E6a9c728a5867);

    // Max Buy TX amount is 1% of the total supply.
    uint256 private buyMaxTxPercent = 150; // Less fields to edit
    ...
    uint256 private sellMaxTxPercent = 7; // Less fields to edit
