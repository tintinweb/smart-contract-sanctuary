...
Telegram = https://t.me/brigadeirobscglobal
Telegram = https://t.me/brigadeirobsc
Twitter = https://twitter.com/brigadeirobsc
...
This is version 2 of Brigadeiro.Finance

10% Wallet for Marketing and Growth of the Token


4% Reflection - Just hold and get more tokens! 
3% Auto Liquidity - Keeps the token growing and keeps the token healthy!
3% Wallet for Marketing - ongoing growth! 
2% Auto burn
...
contract BrigadeiroV2 is Context, IERC20, Ownable {
    ...
    string private _name = "Brigadeiro.FinanceV2";
    ...
    address payable public marketingWallet = payable(0x5cbb98266814f36aa4433affc8DbCBf1063aFc14);
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal.mul(3).div(100000) * 10**9;
    uint256 public _maxTxAmount = _tTotal.mul(1).div(100) * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 TokensForMarketing = contractTokenBalance.mul(_marketingFee).div(_marketingFee.add(_liquidityFee));
        uint256 TokensForLiquidity = contractTokenBalance.sub(TokensForMarketing);
