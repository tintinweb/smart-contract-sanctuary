...
* Total Supply: 100 000 000 (100% Locked)
* Max per Holder: 3 500 000
* Max sell: 200 000 for the first hour than 500 000
* Max buy: 250 000 for the first 30 mins
* 
*
* 
*/
...
contract MUCHADA is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MuchAda';
    string private constant _symbol = '$MADA';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100000000 * 10**_decimals;//equals 10000 token

    //Divider for the MaxBalance based on circulating Supply (1.5%)
    uint8 public constant BalanceLimitDivider=28;
    ...
    address public constant TeamWallet=0xBeE7F5e7c3cdD8a709C3607068dB42Cd47921dcf;
	...
	uint256 private antiDump = 250000 * 10**_decimals;
