...
contract DogeMeister is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0xa740020eCE4Ed2542eD80E54e9B0F85FbADDee8B); // Marketing Address
    ...
    uint256 private _tTotal = 100 * 10**9 * 10**9; // 100 B
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'DogeMeister';
    string private _symbol = 'DogeMeister';
