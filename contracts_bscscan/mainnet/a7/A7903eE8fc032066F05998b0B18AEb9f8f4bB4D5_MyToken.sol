...
contract MyToken   is Ownable, IERC20, IERC20Metadata {
    ...
    constructor (string memory setName, string memory setSymbol, uint8 setDecimals, uint setTotalSupply ) {
        _name = setName;
        _symbol = setSymbol;
        _decimals = setDecimals;
        _totalSupply = setTotalSupply * 10**_decimals;
