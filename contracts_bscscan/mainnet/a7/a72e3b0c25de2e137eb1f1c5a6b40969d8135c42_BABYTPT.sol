...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TPT = IBEP20(0xECa41281c24451168a37211F0bc2b8645AF45092);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TPT.balanceOf(address(this));
        ...
        uint256 amount = TPT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TPT.transfer(shareholder, amount);
...
contract BABYTPT is IBEP20, Auth {
    using SafeMath for uint256;

    address TPT = 0xECa41281c24451168a37211F0bc2b8645AF45092;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby TPT";
    string constant _symbol = "BabyTPT";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xD544aB777eD5D32E778912E3bD13ED309536228b;
