...
/*
She Coin is a unique plateform which is designed to empower the women community around the word.

Our token $SHE is Community Driven token and will be the real utility for the future.

At She Coin we will offer unique products and experiences for Women Empowerment.

Every time People who buy our token or who are HODLERS will have special their special contribution to help women community around the world who are in need.

We have experience of more than 15 years in the field of social working and NGO operations which relates to women empowerment task.
   
    3% of every transaction will redistributed between holders
    3% of every transacion will burned
	3% of every transacion will goes to liquidity
	Total  Supply= 200,000,000
	Symbol= $SHE
    
    Twitter: https://twitter.com/SheCoin1
	Telegram: https://t.me/SHE_OfficialGroup
    Website: https://shecoin.live

    Whitepaper: https://shecoin.live/Whitepaper.pdf   
*/
...
contract SHE is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = 0xef6Ea72D8efC17B6dc2dE8bA6fE8Af7D27da46C7; // Charity Address
