...
/**
STEALTH LAUNCH - CofeeBUSD

I HAVE CREATED A TELEGRAM GROUP @CoffeeBUSDBSC BUT IT'S STILL PRIVATE 
AFTER LAUCHING I WILL OPEN A TELEGRAM GROUP SO YOU CAN PROMOTE THIS TOKEN


It's called CoffeeBUSD and it automatically reflects BUSD right into your wallet each transaction (Buys&Sells).. 

Website is currently under construction but it will be ready in 3 Days! 

Their is an AUTO buyback mechanism which buyback RocketBUSD with each and every transaction constantly raising the price floor!
...
contract COFEEBUSD is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "COFEE BUSD";
