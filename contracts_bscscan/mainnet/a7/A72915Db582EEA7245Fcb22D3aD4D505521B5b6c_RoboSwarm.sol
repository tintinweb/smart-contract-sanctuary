...
/**
$RoboSwarm Tokenomics:
Total Supply : 1,000,000,000 
Burn: 500.000.000 (50%) - During the 3 months 
PCS : 370.000.000 (37%) 
Marketing, airdops, shilling competition:  130.000.000 (13%)
Team Wallet: 100,000,000 (10%) - vesting 1% every week
 
 16% Transaction Fees
 10% is auto redistributed to all holders In CAKE Hold $RoboSwarm, earn CAKE. 
...
contract RoboSwarm is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Roboswarm";
    string constant _symbol = "RSwarm";
