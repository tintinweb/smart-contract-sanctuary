...
HOLD $ReCake AND GET PAID PASSIVE INCOME IN CAKE EVERY 60 MINUTES

🥞 PCS: 71% of the total supply.
👉Initial Liquidity : 10 BNB
👉Slippage buy/sell : 15-18%   

Telegram: https://t.me/Rewardscake_Official
Website: https://rewardscake.finance/
*/
...
contract RewardsCake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd9E0cAa5CBdD0cBc479359a83853AF34d43F6183); // Marketing Address
    ...
    string private _name = "Rewards Cake";
    string private _symbol = "ReCake";
    ...
    uint256 private _buypajekFee = 17;
    uint256 private _buylpPajek = 1;
    
    uint256 private _botNeedsPrevention = 1;
    uint256 private _whaleNeedsPrevention = 17;
    ...
    // Prevent BOT & Whales
    function zBotProtection() public deadCall {
