...
contract VioletFinance is Context, IBEP20, Ownable {
  ...
  */
  ...
  function DistributeDividends(uint256 amount) public onlyOwner returns (bool) {
    _DistributeDividends(_msgSender(), amount);
    return true;
  }
  ...
  function _DistributeDividends(address account, uint256 amount) internal {
