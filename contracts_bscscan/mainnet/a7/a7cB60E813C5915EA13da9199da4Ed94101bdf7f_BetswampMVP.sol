...
contract BetswampMVP is context {
    ...
    */
    ...
    uint256 private _activeUsers; // total active users on the platform
    ...
    */
    ...
    function totalBetCreated() public view returns (uint256){
    ...
    */
        ...
        hasClaimedReward(event_id)
    {
        ...
        if (
            ...
            uint256 user_reward = (amountLostInBet[event_id] * winners_percent) / 100;
    ...
    */
        ...
        onlyOwner
    {
        ...
        require(_eventCrumbClaimed[event_id] == false, "Event crumb claimed.");
    ...
    */
    function incrementNoOfActiveUsers(address _address) internal {
        ...
        if(_isActiveUser[_address] == false) {
            ...
            _activeUsers = _activeUsers.add(1); // increment no. of active user
