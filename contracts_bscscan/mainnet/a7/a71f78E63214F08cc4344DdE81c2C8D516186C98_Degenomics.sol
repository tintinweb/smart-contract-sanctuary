...
/**
 Degenomics with twist of Burn!
 
 Degenomics!
 - 3billion DNOMICS Tokens
 - 5% burn! no other taxes! just pure burn!
 
 This is a experimental project to analyze and calculate how fast supplies can burn with 5% per transaction.
 Here is the fun part! We are going to Manually burn as well with burn with transactions!
 
 and finally! The result will take us to next phase of the project! 
 See you all there! :)
...
contract Degenomics is ERC20 {

    uint tokenTotalSupply = 3000000000;

    constructor() public ERC20("Degenomics", "ㅇ△ㅁ") {
        _Claim(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}