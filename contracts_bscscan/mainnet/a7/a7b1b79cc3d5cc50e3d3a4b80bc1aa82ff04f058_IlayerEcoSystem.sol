...
import "./IlayerEcoSystem-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `IlayerEcoSystem` at the very bottom **and** the `environment` into which
 * you are deploying the contract `IlayerEcoSystem(Env.Testnet)` or `IlayerEcoSystem(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "IlayerEcoSystem";
    string internal constant SYMBOL = "IEC";
     ...
     */
    address internal tipToTheDev = 0xD13636F7B49850A1B94c9fA65e650d14139679b1;
...
contract IlayerEcoSystem is SafeToken{
