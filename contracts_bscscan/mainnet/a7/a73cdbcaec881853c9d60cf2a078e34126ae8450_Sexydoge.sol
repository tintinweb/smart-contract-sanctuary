...
/**
   ...
   Welcome to DogeUprising
   
   This is a community token. If you want to create a telegram I suggest to name it to @DogeUprisingBSC
   ...
   I will renounce the ownership to burn addresses to transfer #DogeUprising to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #DogeUprising 10000X? 
   ...
   it's the best part of the #DogeUprising idea, increasing the liquidity pool automatically, 
...
contract Sexydoge is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 300000000000000 * 10**18;
