...
Welcome to StrongADA
   ...
   Many Great features:
    ...
    it's the best part of the $StrongADA idea, increasing the liquidity pool automatically.
...
contract STRONG_CARDANO is Context, IERC20, Ownable {
