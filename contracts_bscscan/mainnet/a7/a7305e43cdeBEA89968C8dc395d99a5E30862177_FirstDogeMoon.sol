...
$FDM || NEXT 1000X MOONSHOT 🌕

FirstDogeMoon is a stealth launched low tax token and community-driven. Buy $NYD and hold, your token will grow in every transaction. 
...
contract FirstDogeMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb62C805b39bc49b2FbA1c236ed0D5C458287eeBa); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb62C805b39bc49b2FbA1c236ed0D5C458287eeBa); // BuyBack Address
