...
contract HyperFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address payable public marketingAddress = payable(0x750cdd2d916691cb4b9E79E031260061896587a2); // Marketing Address
    ...
    string private _name = "Hyper Floki";
    string private _symbol = "$HyperFloki";
