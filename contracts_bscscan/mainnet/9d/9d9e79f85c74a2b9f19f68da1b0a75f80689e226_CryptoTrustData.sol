...
Welcome to CRYPTO TRUST DATA TOKEN 
...
• 4% Added to liquidity to stabilizes price
• Burns 4% to reduces supply
• LP locked straight away after lunch

🌐 Twitter: CryptoTrusDat1 

🌍 Website: https://cryptotrustdata.com/ 

📩 Telegram: t.me/CryptoTrustData
...
contract CryptoTrustData is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 80_000_000; 
    ...
    string private _name = "Crypto Trust Data";
    ...
    address _marketingWallet = 0xD1b84e8d64Ed85F74AAa33E63726b74F28eCaD3b;
...
,        address to,
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbLiquidity = address(this).balance.sub(initialBalance).div(2);
