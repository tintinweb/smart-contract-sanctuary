...
contract SonOfCheems is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 500_000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "SonOfCheems";
    string private _symbol = "SOCheems";
    ...
    uint256 public _boostedDevFee = 300;
    ...
    address payable private _marketingWallet = payable(0x39af6503cE73556d01Dc52DC4DEc959e22DE4195);
    address payable private _devWallet = payable(0x55a57D1330d9816078E28aCB6eD582173Ac7Ce1F);
    ...
    uint256 private maxTxDivisor = 400;
    ...
    uint256 private maxWalletDivisor = 200;
