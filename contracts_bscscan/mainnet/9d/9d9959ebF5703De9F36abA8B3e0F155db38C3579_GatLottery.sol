...
contract GatLottery is Context, Ownable {
    ...
    uint public numberOfMegaWinners = 10;
    ...
    constructor() public {
        pickerAddress = 0x5832f04F2776f7cdE019Ca593136eB9A5F358Db0;
        tokenAddress = 0xC7a8C40AfBeE37761740ea78C122f1DD31b2Ea5B;
        devWallet = 0xf5510874D9B8a25faA67385a06038F005980dB6d;
        mtWallet = 0x282F06Dbd2C7BD410e9694284D0cc14780a4a05f;
        //test net
    ...
    function myTicketCount(address sender) public view returns(uint256) {
    ...
    function buyTicket(uint256 ticketCount) public {
        ...
        if(!isExcluded){
            totalAmount = totalAmount.mul(85).div(100);
        }
    ...
    function getTicketPrice() internal view returns(uint256){
        ...
        paths[0] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // busd 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
        paths[1] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // wbnb 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
