...
contract TigerBillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TigerBillionaire";
    string private _symbol = "Argghh";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88Cd1A16cf4ACD251E3130Eee274d20cD671b0E2); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x88Cd1A16cf4ACD251E3130Eee274d20cD671b0E2); // buyback Address
    ...
    uint256 public _maxTxAmount = 100 * 10**9 * 10**9; // 0.1%
    uint256 public _walletMax = 300 * 10**9 * 10**9; // 2%
