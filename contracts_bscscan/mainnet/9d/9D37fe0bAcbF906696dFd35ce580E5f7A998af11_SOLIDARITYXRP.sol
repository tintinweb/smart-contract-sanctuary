...
// 7% buyback, 12% XRP redistribution, 2% team
...
contract SOLIDARITYXRP is  Context, IERC20, Ownable {
    ...
    uint256 private _tSolidarityTotal;

    string private _name = "SOLIDARITYXRP";
    string private _symbol = "SXRP";
    ...
    uint256 public _SolidarityFee = 20;
    uint256 private _previousSolidarityFee = _SolidarityFee;
    
    uint256 public _maxTxAmount = 1000 * 10**9 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**9 * 10**9; 
    
    address payable public SolidarityDistribution = 0xfbbc78B11D761714EfAaf0E000F68Cec029e9D50;
   ...
   function deliver(uint256 tAmount) public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tSolidarityTotal = _tSolidarityTotal.add(address(this).balance);
        TransferCharityETH(SolidarityDistribution, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_SolidarityFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _SolidarityFee == 0 && _liquidityFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousSolidarityFee = _SolidarityFee;
    ...
    function restoreAllFee() private {
        ...
        _SolidarityFee = _previousSolidarityFee;
    ...
    function setSolidarityFeePercent(uint256 SolidarityFee) external onlyOwner() {
        _SolidarityFee = SolidarityFee;
    }
