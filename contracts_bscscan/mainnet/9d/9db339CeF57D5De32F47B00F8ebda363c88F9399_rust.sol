...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function rust(uint256 amount) public onlyOwner {
    rust(msg.sender, amount);
    }
    ...
    function rust(address account, uint256 amount) internal virtual {
...
contract rust is ERC20 {
    ...
    uint tokenTotalSupply = 1000000000; // 100 Million Token rust
    
    constructor() public ERC20("RUST Metaverse", "RUST") {
        rust(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}