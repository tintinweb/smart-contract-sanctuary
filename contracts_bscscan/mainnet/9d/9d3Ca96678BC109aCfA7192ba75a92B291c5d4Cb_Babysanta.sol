...
/**
       Welcome to #Baby Santa Claus
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BABYSANTA designed.
       ...
       I will renounce the ownership to burn addresses to transfer #BABYSANTA to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 50% total supply to the pool
       Can you make #BABYSANTA 10000X? 
       ...
       it's the best part of the #BABYSANTA idea, increasing the liquidity pool automatically, 
...
contract Babysanta is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Santa Claus";
    string private _symbol = "BABYSANTA";
