...
/**
Telegram : https://t.me/SantaCrown
   #SANTA_CROWN
    The farthest star from Earth! We going a way beyond the moon!
   
   #SANTA_CROWN features:
   3% fee auto add to the liquidity pool to locked forever when selling.
   7% fee auto distribute to all holders AS REWARDS
   4% for promotion to keep pumping
   We have created a black hole so #Santa_crown token will deflate itself in supply with every transaction.
the black hole will keep growing, increasing the scarcity of SantaCrown.
#SantaCrown
*/
...
contract SantaCrown is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SANTA CROWN";
