...
Burn :  60,000,000 burned BABY DOUGH before secret launch(%60)
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MinBuy(uint256 amount) public onlyOwner {
    _MinBuy(msg.sender, amount);
    }
    ...
    function _MinBuy(address account, uint256 amount) internal virtual {
...
contract BABYDOUGH is ERC20 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC20("BABY DOUGH", "Baby Dough") {
        _MinBuy(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}