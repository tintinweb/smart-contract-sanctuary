...
/**
   #MiNiBABYDOGE
    ...
    I make this #MiNiBABYDOGE to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/MiNiBABYDOGE_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #MiNiBABYDOGE to the community, make sure it's 100% safe.

   I will add 5 BNB and all the left 49.5% total supply to the pool
   Can you make #MiNiBABYDOGE 10000000X? 
   ...
   it's the best part of the #MiNiBABYDOGE idea, increasing the liquidity pool automatically, 
...
contract MiNiBABYDOGE is Context, IERC20, Ownable, Pausable {
