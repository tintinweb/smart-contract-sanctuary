...
contract QuickXXX is Context, IERC20, Ownable {
    ...
    string private _name = 'QuickXXX';
    string private _symbol = 'QuickXXX';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 5; // 4% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 12; // 9% of transactions will be kept for liquidity
