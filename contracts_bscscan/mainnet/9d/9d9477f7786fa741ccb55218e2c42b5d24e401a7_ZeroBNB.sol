...
contract ZeroBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Zero BNB";
    string constant _symbol = " ZBNB ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2000 * 10**6* 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xaAE9e20e39751f0F1C18f6fD05656AB17835ABC2;
        ecosystemfeeReceiver = 0xaAE9e20e39751f0F1C18f6fD05656AB17835ABC2;
