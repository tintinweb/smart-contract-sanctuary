...
/**
 * The dark side of the USD. Hold it to earn BUSD.
 */
...
contract DarkBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DarkBUSDDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("DarkBUSD", "DBUSD") {
        _ETHRewardsFee = 5;
        _liquidityFee = 5;
		_marketingFee = 1;
    	...
    	dividendTracker = new DarkBUSDDividendTracker();

    	liquidityWallet = owner();
		
		bulkSender = payable(0xE64215d8bbd16e01E6334FF1CC6a352cf8923dAA);
		marketingWallet = payable(0xE64215d8bbd16e01E6334FF1CC6a352cf8923dAA);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
       ...
       DarkBUSDDividendTracker newDividendTracker = DarkBUSDDividendTracker(payable(newAddress));
...
contract DarkBUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("DarkBUSD_Dividend_Tracker", "DarkBUSD_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "DarkBUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "DarkBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "DarkBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "DarkBUSD_Dividend_Tracker: Cannot update claimWait to same value");
