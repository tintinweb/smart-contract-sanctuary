...
contract UNITEDSTATES is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'UNITEDSTATES';
    string private constant _symbol = '$USA';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 3000 * 10**_decimals;//equals  3000 token

    //Divider for the MaxBalance based on circulating Supply (1.5%)
    uint8 public constant BalanceLimitDivider=67;
    //Divider for sellLimit based on circulating Supply (0.1%)
    uint16 public constant SellLimitDivider=1500;
    ...
    address public constant TeamWallet=0x22b0B7282B910b879de81b5b8291FBf221ad4E24;
