...
// babyBITCOINPUMP @ https://t.me/babyBITCOINPUMP
...
// File: contracts/baby_BITCOINPUMPDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
// File: contracts/baby_BITCOINPUMP.sol
...
contract baby_BITCOINPUMP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    address private _marketingWallet = address(0x6deA2C6EfcaE36245cBcC5b7B7acB121EFCdB25C);
    address private _liqAdd = address(0x82a07E386800B2A385739cfc1288b6d4A5b057E5);
    ...
    baby_BITCOINPUMPDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;
    address public liqAdd = _liqAdd;
    ...
    constructor() public ERC20("baby_BITCOINPUMP", "bBITCOINPUMP") {
    	...
    	dividendTracker = new baby_BITCOINPUMPDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "baby_BITCOINPUMP: The dividend tracker already has that address");

        baby_BITCOINPUMPDividendTracker newDividendTracker = baby_BITCOINPUMPDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "baby_BITCOINPUMP: The new dividend tracker must be owned by the baby_BITCOINPUMP token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "baby_BITCOINPUMP: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "baby_BITCOINPUMP: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "baby_BITCOINPUMP: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "baby_BITCOINPUMP: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "baby_BITCOINPUMP: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "baby_BITCOINPUMP: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "baby_BITCOINPUMPBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "baby_BITCOINPUMP: This account cannot send tokens until trading is enabled");
        }
        ...
        if(
            ...
            uint256 liqswap = contractTokenBalance.mul(5).div(totalFees);
            swapTokensForBNB2(liqswap);
...
contract baby_BITCOINPUMPDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("baby_BITCOINPUMP_Dividend_Tracker", "baby_BITCOINPUMP_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "baby_BITCOINPUMP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "baby_BITCOINPUMP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main baby_BITCOINPUMP contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "baby_BITCOINPUMP_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "baby_BITCOINPUMP_Dividend_Tracker: Cannot update claimWait to same value");
