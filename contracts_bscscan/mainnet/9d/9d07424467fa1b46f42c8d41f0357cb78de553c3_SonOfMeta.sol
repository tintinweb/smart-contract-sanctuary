...
/* Token contract */
contract SonOfMeta is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xCd3ACF55828bcb1C18016f8ba76117bf7316122d;
    ...
    // Name and symbol
    string constant _name = "SonOfMeta";
    string constant _symbol = "SonOfMeta";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 100; // 2%
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 25; // 4%
