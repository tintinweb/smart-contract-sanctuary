...
/*
M̳e̳t̳r̳o̳ S̳h̳i̳b̳a̳
𝔚𝔥𝔢𝔯𝔢 𝔗𝔯𝔞𝔫𝔰𝔭𝔬𝔯𝔱𝔞𝔱𝔦𝔬𝔫 𝔥𝔞𝔳𝔢 𝔚𝔦𝔫𝔤𝔰
☑️Liquidity lock at start 100 Years .
☑️Renouncing at start .
☑️Safe ☑️Clean ☑️LFG

 ☑️www.MetroShiba.Com
 ☑️Twitter :@MetroShiba
 ☑️Telegram:@MetroShiba
...
contract MetroShiba is Context, BinanceSwap, Ownable {
    ...
    string private _name = 'Metro Shiba';
    string private _symbol = 'SHIBAMETRO';
