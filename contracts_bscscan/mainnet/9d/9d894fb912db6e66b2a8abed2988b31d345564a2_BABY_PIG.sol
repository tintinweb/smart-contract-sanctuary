...
BABY PIG 
   ...
   This is a community token. Telegrams @BABY FEG   Important: The early you create a group that shares the token, the more gain you got.
...
🔥TOTAL SUPPLY 1,000,000,000,000,000 BABY FEG 
🔥BURN SUPPLY 90% BABY PIG 
🔥NO DEV TOKEN
   ...
   I will renounce the ownership #BABY FEG  to the community, make sure it's 100% safe.

   I will add .5 BNB.
   Can you make #BABY PIG  10,000 X? 
   ...
   it's the best part of the #BABY FEG  idea, increasing the liquidity pool automatically, 
...
contract BABY_PIG  is Context, IERC20, Ownable {
    ...
    string private _symbol = "BABY PIG ";
