...
contract Ownable is Context {
    address private _owner = 0xa978E7e868150C462F978b200094eE17EDE05bE3;
...
contract Phospherus is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xAaF9d2851349c7de259e64c9d894947AD9df3172); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "The Phosphor"; // token name
    string private _symbol = "Phospherus"; // token symbol
    uint8 private _decimals = 18; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 8000000000 * 10**1 * 10**_decimals;
    ...
    uint256 public _minTokensSwapToAndTransferTo = 80000000 * 10**1 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
