...
Stake
Lido lets users stake their assets for daily staking rewards. 
User can stake any amount of tokens - no minimum.

Mint
When staking Lido you mint staked tokens which are pegged 1:1 to your initial stake. 
Your staked tokens can be used across the DeFi ecosystem to compound your yield.

DeFi
Lido lets you use your staked assets to gain yield on top of yield. 
Use your tokens (which earn daily staking rewards) as collateral, for lending, yield farming and more.

Community
Lido DAO is a community that builds liquid staking services and governs the direction of Lido. 
The number of DAO participants is growing daily with contributors working together to build the future of Lido.
*/
...
contract stakelido is Context, IERC20, IERC20Metadata, Ownable {
