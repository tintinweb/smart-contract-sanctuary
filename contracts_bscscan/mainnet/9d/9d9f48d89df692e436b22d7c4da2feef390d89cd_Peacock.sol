...
contract Peacock is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6B33395aD9257730A2C9696770B0e6397d6785bc); // Marketing Address
    address payable public charityAddress = payable(0x6B33395aD9257730A2C9696770B0e6397d6785bc); // Charity/Dev Address
    ...
    string private _name = "Peacock Swap"; // nice
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 200000000000000000000000000; // nice: Claim 200,000,000 (0.01BNB = 10,000,000,000)
