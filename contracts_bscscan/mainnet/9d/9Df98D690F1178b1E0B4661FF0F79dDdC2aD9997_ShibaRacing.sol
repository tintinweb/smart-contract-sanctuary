...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 1200000 * (10**9); // user must hold 1500000 token
...
contract ShibaRacing is
    BASEToken("Shiba Racing https://shibaracing.xyz", "SRace", 120000000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
