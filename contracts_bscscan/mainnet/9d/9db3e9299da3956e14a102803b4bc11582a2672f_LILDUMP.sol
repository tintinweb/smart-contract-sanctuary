...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 Reward = BEP20(0xB27ADAfFB9fEa1801459a1a81B17218288c097cc);
...
contract LILDUMP is BEP20, Ownable {                                                                            
    using SafeMath for uint256;

    
    address public  Reward = 0xB27ADAfFB9fEa1801459a1a81B17218288c097cc;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "LilDump";
    string constant _symbol = "LILDUMP";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xA4B863d29fF45A7CA9C7856EB82E1Ac07c147072);                                   //!\ CHANGE WITH YOUR DEV / MARKETING WALLET
