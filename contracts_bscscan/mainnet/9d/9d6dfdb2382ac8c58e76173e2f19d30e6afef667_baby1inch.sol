...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x111111111117dC0aa78b770fA6A738034120C302;
...
contract baby1inch is ERC20, Ownable {
    ...
    address public _dividendToken = 0x111111111117dC0aa78b770fA6A738034120C302;
    ...
    constructor() ERC20("baby1inch", "baby1inch") {
    	...
    	buyBackWallet = 0x403aA06F3D91a8d4d488aDe1c994BbBA31D79c3f;
    ...
    receive() external payable {
  	...
  	function setSellTransactionMultiplier(uint256 multiplier) external onlyOwner {
  	    require(sellFeeIncreaseFactor >= 100 && sellFeeIncreaseFactor <= 200, "baby1inch: Sell transaction multipler must be between 100 (1x) and 200 (2x)");
  	    sellFeeIncreaseFactor = multiplier;
  	}
  	
  	function setMarketingDivisor(uint256 divisor) external onlyOwner {
  	    require(marketingDivisor >= 0 && marketingDivisor <= 100, "baby1inch: Marketing divisor must be between 0 (0%) and 100 (100%)");
    ...
    function triggerBuyBack(uint256 amount) public onlyOwner {
        require(!swapping, "baby1inch: A swapping process is currently running, wait till that is complete");
    ...
    function updateDividendRewardFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 10, "baby1inch: Dividend reward tax must be between 0 and 10");
    ...
    function updateBuyBackWallet(address newBuyBackWallet) public onlyOwner {
        require(newBuyBackWallet != buyBackWallet, "baby1inch: The liquidity wallet is already this address");
...
contract baby1inchDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("baby1inch_Dividend_Tracker", "baby1inch_Dividend_Tracker") {
    	claimWait = 3600;
