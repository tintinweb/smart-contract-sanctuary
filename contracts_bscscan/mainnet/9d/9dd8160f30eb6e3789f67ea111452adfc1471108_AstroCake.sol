...
contract AstroCake is ERC20, Ownable {
   ...
   AstroCakeDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("AstroCake", "AstroCake") {
		...
		marketingWallet = payable(0x6eDD2b7bf0288536F19065A1028522A742a10420);
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "AstroCake: The liquidity wallet is already this address");
    ...
    function updateMarketingFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 10, "AstroCake: Marketing tax must be between 0 and 10");
        marketingFee = newFee;
    }
    
    function updateLiquidityFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 10, "AstroCake: Liquidity tax must be between 0 and 10");
        liquidityFee = newFee;
    }
    
    function updateETHRewardsFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 15, "AstroCake: ETH Rewards tax must be between 0 and 15");
        liquidityFee = newFee;
    }
...
contract AstroCakeDividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public pure override {
        require(false, "AstroCake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MicroCake contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "AstroCake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
