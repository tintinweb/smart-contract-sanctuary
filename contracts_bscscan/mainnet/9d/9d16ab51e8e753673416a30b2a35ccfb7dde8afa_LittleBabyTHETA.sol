...
/**
   ...
   Welcome to LittleBabyTHETA
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyTHETABSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyTHETA to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyTHETA idea, increasing the liquidity pool automatically, 
...
contract LittleBabyTHETA is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby THETA";
    string private _symbol = "LTBABYTHETA";
