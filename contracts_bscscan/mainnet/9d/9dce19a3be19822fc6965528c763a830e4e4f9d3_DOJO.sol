...
/**
 Join our dynamic name changing token TG @Eloncallsbsc !
*/
...
contract DOJO is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x811663d4311C8607571d767ee65B1cD802558517); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x88ae8edF544EBf3247d366AeF5df1D2aD60A8Ed5); // Liquidity Address
    ...
    string private  _name = "DOJO @EloncallsBSC";
    ...
    constructor() {
        address newOwner = address(0x88ae8edF544EBf3247d366AeF5df1D2aD60A8Ed5);
        ...
        maxTransactionAmount = _tTotal * 1 / 100; // 100% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        maxWallet = _tTotal * 2 / 100; // 100% max wallet
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                if(from != owner() && to != uniswapV2Pair && block.number < tradingActiveBlock + 0){
                    boughtEarly[to] = true;
                    emit BoughtEarly(to);
                }
