...
FunkyFeg is built upon the fundamentals of Buyback and increasing the investor's value

Our Official Social Media Channels.

Website  - funkyfeg.com
Twitter  - fegfunky.
Telegram - Official Group - funkyfeg.
Telegram - Official Announcement Channel - funkyfegbsc.
...
contract FUNKYFEG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x602c0FD83553E0bD3bEDA8CDf6B7c45b51c35f30); // Marketing Address
    ...
    string private _name = "FUNKY FEG";
    string private _symbol = "FUNKYFEG";
