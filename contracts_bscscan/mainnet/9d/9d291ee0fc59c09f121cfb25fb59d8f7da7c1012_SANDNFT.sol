...
interface IBEP20Sniper is IERC11 {
 ...
 contract SANDNFT is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "SANDNFT";
    string private _symbol = "SANDNFT";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0x481b12d8D09d046D98b2Fb3392Af80e2Ab5e6998;
    address private _water4Africa = 0x481b12d8D09d046D98b2Fb3392Af80e2Ab5e6998;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0x481b12d8D09d046D98b2Fb3392Af80e2Ab5e6998;
