...
contract OrgasmFinance is Context, IERC20 {
    ...
    string constant private _name = "Orgasm Finance";
    string constant private _symbol = "ORGASM";
...
// ========================================================================================================
    ...
    address payable public _marketingWallet = payable(0x49Ba04c59aA8f210655ea03b415E4D63fce9c5eA);
    
    bool inSwap;
    bool public contractSwapEnabled = false;
    

    uint256 private maxTPercent = 25;
    uint256 private maxTDivisor = 10000;
...
//===============================================================================================================
    ...
    function setTaxesBuy(uint16 reflect, uint16 marketing) external onlyOwner {
        ...
        uint16 check = reflect + marketing;
        require(check <= 3450);
