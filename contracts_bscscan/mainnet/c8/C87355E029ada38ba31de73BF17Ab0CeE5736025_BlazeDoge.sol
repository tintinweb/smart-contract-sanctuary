...
contract BlazeDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Blaze Doge";
    ...
    address payable public _marketingAddress = payable(0xbD9d990Ad0F9439A5330C1862e486b089482e98A);
    ...
    function setReflectionFeePercent(uint256 reflectionFee) external onlyOwner() {
        require(reflectionFee<=15, 'Anti-rug');
        _reflectionFee = reflectionFee;
    }
        
    function setBuyFee(uint256 buyReflectionFee, uint256 buyLPMarketingFee) external onlyOwner {
        require(buyReflectionFee<=15, 'Anti-rug');
        require(buyLPMarketingFee<=15, 'Anti-rug');
    ...
    function setSellFee(uint256 sellReflectionFee, uint256 sellLPMarketingFee) external onlyOwner {
        require(sellReflectionFee<=15, 'Anti-rug');
        require(sellLPMarketingFee<=15, 'Anti-rug');
    ...
    function setMaxTxAmount(bool useConstantMaxTxAmount, uint256 maxTxAmount, uint256 maxTxDivisor ) external onlyOwner {
        require(maxTxAmount >= 2000000000000 * 10 ** 9, 'No rugs allowed'); // Anti-Dudley mechanism
        require(maxTxDivisor <= 500, 'No rugs allowed'); // Anti-Dudley mechanism
