...
contract TOYOTA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "T COROLLA";
    string constant _symbol = "TOYOTA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x000000000000000000000000000000000000dEaD;  // teamwallet
        lotteryWallet = 0x000000000000000000000000000000000000dEaD;  // lotterywallet
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newLotteryFee) external onlyOwner {
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newLotteryWallet) external onlyOwner {
