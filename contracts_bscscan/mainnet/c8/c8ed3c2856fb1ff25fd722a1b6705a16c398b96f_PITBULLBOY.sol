...
Telegram : https://t.me/PitBull_Boy
...
contract PITBULLBOY is Context, IERC20, Ownable {
    ...
    string private _name = " PITBULL BOY " ;
    string private _symbol = " PITBOY " ;
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 100 * 10**15 * 10**_decimals;
    
    address payable private marketingAddress = payable(0x5afAbAf5Ce0BBd4A880Ad43dfcED8eF3eFf7F4D6);
    address public marketingWalletToken = 0x3Ad92c33e56A2Aa2f2154cbf23DB65CDE6358330 ;
    address public constant AutoLiquidity = 0x0000000000000000000000000000000000000000 ;
    address public constant AutoBurnAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    uint256 private constant _maxFees = 11;
    ...
    constructor () {
        ...
        _liquifyThreshhold = 100 * 10**15 * 10**_decimals ;     
        _maxBalance = 100 * 10**15 * 10**_decimals ;           
    ...
    function ClaimBNBFromContract() public onlyOwner 
    {
            payable(0x3Ad92c33e56A2Aa2f2154cbf23DB65CDE6358330).transfer(address(this).balance);
    }
    ...
    function _transfer(
        ...
        if(
            ...
            transferToken(from, AutoBurnAddress, toBurnAmount);
