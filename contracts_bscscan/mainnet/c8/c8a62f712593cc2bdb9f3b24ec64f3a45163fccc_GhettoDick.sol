...
PLEASE READ FOR TRANSPARANCY:

* LP WILL BE LOCKED FOR 1 HR AFTER LAUNCH.
...
contract GhettoDick is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'GhettoDick';
