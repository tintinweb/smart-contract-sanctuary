...
Stealth Launch 🖱 13.01.2022 🖱 6PM UTC

We are GreyChart: The newest community driven token backed by crypto enthusiasts, skilled developers, and marketing professionals. A reward function has been developed with the goal to provide liquidity and raise the floor price.
...
contract GreyChart is Context, IERC20, Ownable {
    ...
    string private _name = "GreyChart";
    string private _symbol = "GREYCHART";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50000000000000 * 10**9;
