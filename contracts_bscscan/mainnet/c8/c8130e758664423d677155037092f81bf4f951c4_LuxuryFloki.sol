...
contract LuxuryFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9358c5991341F1D9fc5F313Eb9373F6a54CF71bB); // Marketing Address
    ...
    uint256 public _maxWalletToken = 3000000000 * (10**9); // can't buy or accumulate more than this
    string private _name = "LuxuryFloki";
    string private _symbol = "LUXFLOKI";
