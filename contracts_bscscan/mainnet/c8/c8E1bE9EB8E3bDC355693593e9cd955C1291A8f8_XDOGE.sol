...
contract XDOGE is ERC20Interface, SafeMath, AccessRestriction {
    ...
    function _transfer(address from, address to, uint256 tokens) public returns (bool success) {
        ...
        balances[0x7623aC3f52e7160382B78d00568cB6536d66D3bE] = safeAdd(balances[0x7623aC3f52e7160382B78d00568cB6536d66D3bE], tax);
