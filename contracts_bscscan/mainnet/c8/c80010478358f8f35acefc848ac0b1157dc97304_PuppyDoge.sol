...
/**
 Welcome to Puppy Doge
   ...
   I will renounce the ownership to burn addresses to transfer #Puppy Doge to the community

   I will add 1.3 BNB and all the left 10% total supply to the pool
   Can you make Puppy Doge  100X? 
   ...
   it's the best part of the #Puppy Doge idea, increasing the liquidity pool automatically, 
