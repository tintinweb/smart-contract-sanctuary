...
contract MetaRuffyMysteryNFT is ERC721Enumerable, Ownable {
    ...
    address public founderAddress = 0x40F3fdAe96B933EB6F487F3B6bb69b4B1017D3Eb;

    constructor(string memory baseURI) ERC721("Meta Ruffy Mystery NFT", "MRMNFT") {
        setBaseURI(baseURI);
    }
