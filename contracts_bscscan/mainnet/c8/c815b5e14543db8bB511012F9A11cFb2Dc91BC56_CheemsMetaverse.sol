...
contract CheemsMetaverse is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "CheemsMetaverse";
    string constant _symbol = "CMV";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  // 3% Max Transaction - 300,000 Tokens  
    ...
    uint256 _initialSellLiquidityFee = 6;
    uint256 _initialSellMarketingFee = 12;
    ...
    // Fee receivers
    address private marketingFeeReceiver = 0x469548f48D30fc0c72f387337361b46017f10dD8;
    address private buybackFeeReceiver = 0x91f95D4f87415244d81a247c90A6B5531766644D;
