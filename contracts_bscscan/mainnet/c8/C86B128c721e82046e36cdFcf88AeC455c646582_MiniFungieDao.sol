...
For everyone who miss Fungie DAO we got you buddy. 
Our contract forked form a Fungie DAO contract, so it’s gonna be safe let’s join the ride.
...
contract MiniFungieDao is Context, IERC20, Ownable {
