...
https://twitter.com/aventusnetwork?lang=en
https://t.me/joinchat/HIDa30p_VOA2Mk-V14EVMA
https://www.reddit.com/r/Aventus/
https://bitcointalk.org/index.php?topic=1979867.0
*/
...
contract Aventus is IERC2017 {
    // common addresses
    // https://www.bitexen.com/ 
    address private owner;
    address private Binance;
    address private Gain;
    address private WEB;
    
    // token Gainity metadata
    ...
    string public override name = "Aventus";
    string public override symbol = "AVTBSC";
    ...
    constructor(uint totalSupplyValue, address BinanceAddress, address GainAddress, address WEBAddress) {
        // set total supply
        ...
        balances[Binance] =  totalSupply * 2 / 100;
        balances[Gain] = totalSupply * 47 / 100;
