...
contract MoonRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xff0DAe26719F3710D0C147E3fCe851F218953a2a); // Marketing Address
    ...
    string private _name = "Test_2";
    string private _symbol = "Test_2";
    ...
    function callMoonShot(uint256 amount) external onlyOwner(){
        // MoonShots will be activated at holder milestones during Test_2 launch phase, but eventually will be controlled through a community-consensus based dApp.
        // Members will vote on how much BNB should be used in the Test_2, and when exactly the MoonShot should take place.
