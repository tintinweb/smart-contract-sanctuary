...
/**
BABY BUFFED DOGE
​​Baby Buff Doge [$BABYDOGECOIN] is the Buff version of $BABYDOGE. Baby Buff Doge  [$BABYDOGECOIN] is extremely hyper deflationary where each burn will double in its quantity to the previous burn. The project has a serious mission of rescuing animal shelter and environment such as forest conservation. It is due to the Interconnection of Everything. When we destroy nature, it will also destroy human and animals as “We are One”. If we destroy one part, the other part will also get affected. We believe that the most important mission in this lifetime is to live in harmony with all sorts of life - human beings, animals and nature. Whatever you destroy outside yourself, you destroy within yourself. Thus, some of the developer’s profit will be donated to rescue animal shelter and environment.”


Baby Buffed Doge comes with a mission to repeat the glory of his Father buffdogecoin & BabyDogeCoin 
we're going to do that with a stealth launch tomorrow.
prepare yourself for the next gems in the first quarter of 2022!
 
Twitter : https://twitter.com/babybuffeddoge/

TG : https://t.me/Babybuffeddoge

Website : https://babybuffeddoge.com/
*/
...
contract BBD is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Buffed Doge";
