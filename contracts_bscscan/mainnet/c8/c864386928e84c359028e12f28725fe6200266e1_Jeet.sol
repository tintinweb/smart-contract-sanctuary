...
contract Jeet is ERC20, Ownable {
    ...
    JeetDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0xbaB82fc947D856E7128829cC6842336Fa707294f;
    address public _devWalletAddress = 0xDce3De9A1d092dEe10D7B7d22A7eA2521B33454c;
    ...
    constructor() public ERC20("Jeet", "$omg") {

    	dividendTracker = new JeetDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        JeetDividendTracker newDividendTracker = JeetDividendTracker(payable(newAddress));
...
contract JeetDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Jeet Dividends", "Jeet_dividends") {
    	claimWait = 3600;
