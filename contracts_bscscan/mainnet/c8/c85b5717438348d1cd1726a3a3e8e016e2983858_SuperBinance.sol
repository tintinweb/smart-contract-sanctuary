...
/**
   ...
   Welcome to SuperBinance
   
   This is a community token. If you want to create a telegram I suggest to name it to @SuperBinance
...
contract SuperBinance is Context, IERC20, Ownable {
    ...
    string private _name = "Super Binance";
