...
// Project Website: www.sugardaddy.is
...
contract Sugardaddy is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string public _name = "Sugar Daddy Island";
    string public _symbol = "SUDI";
    uint256 public _initSupply = 1000000*10**18;
    ...
    constructor() {
        ...
        //IPancakeRouter _router = IPancakeRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //for test
