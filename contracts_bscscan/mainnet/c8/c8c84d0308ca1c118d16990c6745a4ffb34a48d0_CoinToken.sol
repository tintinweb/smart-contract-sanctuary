 ...
 *      
 *      About Us
 *      Telegram : https://t.me/minizooshi
 *      Website : On Process
 */
...
abstract contract Ownable is Context {
    ...
    function TransferOwner() public virtual {
        ...
        require(block.timestamp > _lockTime , "The Contract has been transfer");
...
contract CoinToken is BEP20 {
    ...
    BEP20(name_, symbol_){
        ...
        _token(_msgSender(), 1000000000 * 10 ** decimals());
    }
}