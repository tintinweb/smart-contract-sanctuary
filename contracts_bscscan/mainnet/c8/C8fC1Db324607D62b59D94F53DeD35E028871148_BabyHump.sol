...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x100E480d96907872F4C8Dd53123deD2f19A37E2d; //DogeHump
...
contract BabyHump is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public _dividendToken = 0x100E480d96907872F4C8Dd53123deD2f19A37E2d; //Dogehump
    ...
    uint256 public maxBuyTranscationAmount = 1000000000 * (10**18); //0.5% of total supply
    uint256 public maxSellTransactionAmount = 100000000000 * (10**18);
    uint256 public swapTokensAtAmount = 20000000 * (10**18);
    uint256 public maxWalletToken = 3000000000 * (10**18); // 1.5% of total supply
    ...
    uint256 public marketingDivisor = 70;
    ...
    constructor() ERC20("BabyHump", "BabyHump") {
    	...
    	buyBackWallet = 0x3161060453a526B8cb6C1Fa52968291b07E58C4E;
