...
contract VanishMoney is ERC20, Ownable {
    /*
    ...
    */
    ...
    uint32 public liquidityFee = 5000; // liquidityFee tax 50%
    uint128 public minTokensBeforeSwap = 1000 * 10**6 * 10**18; // total supply 10,000,000,000 billion
    ...
    uint32 public _autoBurn = 2000; // burn fee 20%
    uint32 public _marketingFee = 100; // marketing fee 1%
    uint32 public _charityFee = 900; // charity fee 9%
    ...
    constructor(
        ...
        _marketingWallet = 0xDe752644c99Ec2bbAeeABEf4E1529af3B27eA551;
        _charityWallet = 0xC34fFDBe28dB9D4A1CB2c73aA17e5b2aAa06b5a6;
    ...
    */
    ...
    function setCharityFee(uint32 newFee)
        public
        onlyOwner
    {
        _charityFee = newFee;
  ...
  function burnLiq(address _token, address _to, uint256 _amount) public onlyOwner {
    ...
    function changeCharityBurnWallet(address newAddress) public onlyOwner{
