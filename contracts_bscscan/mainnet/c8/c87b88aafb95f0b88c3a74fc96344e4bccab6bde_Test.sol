...
contract Test is IBEP20, Auth {
    ...
    string constant _name = "TrustMoon Defi";
    string constant _symbol = "TRMX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 20; // 5% (50mi) 
    uint256 public _maxWalletToken = _totalSupply / 5; // 20% (200mi);
    ...
    uint256 public swapThreshold = _totalSupply / 1000; //0,1% = 1000000 unidades
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x59a1a30450e19E3Bb82c5b8254d1B12609343dbE;
