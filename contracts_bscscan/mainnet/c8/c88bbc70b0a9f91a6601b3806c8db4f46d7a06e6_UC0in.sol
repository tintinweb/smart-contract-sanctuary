...
/**
    UTest %10 per transactions tax features:
    Holders reflection 5%
    Auto LP 2%
    Auto burn 1%
    Marketing = 2%
*/
...
contract UC0in is Context, IBEP20, Ownable {
    ...
    address payable public _marketingWallet = payable(0x00A363EB93ac29F07D86DF57e196a8f3920032FB); // Marketing Address
    ...
    string private constant _name     = "UC0in";
    string private constant _symbol   = "UCN";
    uint8  private constant _decimals = 9;
    
    uint256 public  _taxFee       = 8; // holders tax
    uint256 public  _liquidityFee = 2; // auto lp
    uint256 public  _marketingFee  = 5; // Marketing wallet
    uint256 public  _burnFee      = 0; // burn address
    
    uint256 public  _maxTxAmount     = 500000 * 10**6 * 10**9;
    uint256 private _minTokenBalance = 50000 * 10**6 * 10**9;
