...
contract CakeCrewDividendTracker is IDividendDistributor {
    ...
    IBEP20 Cake = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract ShibaMoonStop is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "ShibaMoonStop";
    string _symbol = "ShibaMoon";
    ...
    address private marketing = address(0xAEe1Da7CEB27F87B64347A24CDa496E27faC311a);
    address private liquidity = address(0x122704Ea8235D3C73B6Db51021D84c1b32EE1959);
