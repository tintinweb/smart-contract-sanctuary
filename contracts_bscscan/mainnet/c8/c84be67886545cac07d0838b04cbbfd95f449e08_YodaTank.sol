...
// CHANGE
contract YodaTank is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "YodaTank";
    string constant _symbol = "$Tank";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x46Db4cB686bAa117844e6D8d92F940c24bdEf0e1);
