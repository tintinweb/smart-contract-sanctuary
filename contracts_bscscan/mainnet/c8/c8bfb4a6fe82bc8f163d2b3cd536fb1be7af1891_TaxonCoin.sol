...
contract TaxonCoin is Context, Ownable, IERC20 {
    ...
    address payable public marketingWallet = payable(0x30Fb9A0a901FdDb210833cFa0a007421cB9c114a);
    address payable public liquidityWallet = payable(0x091ff631154480195C0E4880d35F53C371c84a68);
    address payable public airdropWallet = payable(0x091ff631154480195C0E4880d35F53C371c84a68);
   ...
   function setMarketingWallet(address payable _address) external onlyOwner returns (bool){
    ...
    function swapAndSendToFees(uint256 tokens) private {
        ...
        if(deployTime + (180 * 1 days ) > block.timestamp){
