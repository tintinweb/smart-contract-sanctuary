...
// File: contracts/interfaces/IChimpyLottery.sol
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the ChimpySwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == pancakeSwapLottery, "Only ChimpyLottery");
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IChimpyLottery(pancakeSwapLottery).viewCurrentLotteryId();
    }
}