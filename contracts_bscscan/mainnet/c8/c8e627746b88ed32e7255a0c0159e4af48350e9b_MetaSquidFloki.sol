...
contract MetaSquidFloki is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MetaSquidFloki';
    ...
    //DevWallets
    address public TeamWallet=payable(0xf88b2D8cfCaa4025A44C5678Bffcb52Ab95643df);
    address public walletTwo=payable(0xf88b2D8cfCaa4025A44C5678Bffcb52Ab95643df);
    //TestNet
    ...
    function claimXRP(address addr) private{
        ...
        path[1] = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;  //Reward ETH
