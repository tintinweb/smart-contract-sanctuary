...
contract BabyWhale is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyWhale";
    ...
    address public autoLiquidityReceiver = address(0xC3b5eAf2780D5E8Bc96acBD378AAA26f1e5f9e64);
    address public marketingFeeReceiver = address(0x5f1C4ea4724b6d0FcbeE8FA35C5093048F33beCb);
    address public buybackFeeReceiver = address(0x8db7C7ED1eC971f272be1AAE2ac55820b8b8169f);
    address public teamFeeReceiver = address(0x3dD5CC9206a42BdA3C2ccf777A4cAbcE51863288);
    ...
    function swapBack() internal swapping {
        ...
        payable(teamFeeReceiver).call{value: amountBNBteam, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_marketingFee).add(_teamFee);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buybackFeeReceiver, address _teamFeeReceiver) external onlyOwner {
