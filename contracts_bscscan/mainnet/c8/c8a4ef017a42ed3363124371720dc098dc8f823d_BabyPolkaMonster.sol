...
/*
    BabyPolkaMonster (BabyPkMon)
    Automatically rewards PkMon
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x609D183Fb91a0fce59550b62ab7d2c931b0Bb1BE); //the reward token you want distributed 
...
contract BabyPolkaMonster is IBEP20, Auth {
    using SafeMath for uint256;

    address RewardToken = 0x609D183Fb91a0fce59550b62ab7d2c931b0Bb1BE;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyPolkaMonster"; 
    string constant _symbol = "BabyPkMon";
