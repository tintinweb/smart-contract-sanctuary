...
contract SafeCamel is Context,IBEP20,Ownable {
    ...
    string private constant _name = "SafeCamel";
    string private constant _symbol = "SAFECAMEL";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 100000000000000 * 10**9;
