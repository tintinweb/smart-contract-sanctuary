...
contract ICO_Live_Test4 is Ownable {
    ...
    address public pair_address = 0xE080cF9308989A78f69545951585d1e4dE22Ea7C;
    
    IPancakeRouter02 private router = IPancakeRouter02(routerAddress);
    IUniswapV2Pair public pancake_pair = IUniswapV2Pair(pair_address);

    function getReservesTest() public view returns (uint reserveA, uint reserveB){
        return pancake_pair.getReserves(factory,tokenAddress,wBnb);
    }
