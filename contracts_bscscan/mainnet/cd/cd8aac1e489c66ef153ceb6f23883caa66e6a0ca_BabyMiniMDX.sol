 ...
 * 
 Welcome to $BabyMiniMDX:
   ...
   Many Great features:
    ...
    it's the best part of the $BabyMiniMDX idea, increasing the liquidity pool automatically.
...
contract BabyMiniMDX is Context, IERC20, Ownable {
