...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 MCI = IERC20(0xBc653A19e8FD48e5c81e05C68D6fD377b1deA33e);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MCI.balanceOf(address(this));
        ...
        uint256 amount = MCI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MCI.transfer(shareholder, amount);
...
contract BabyMinecraftInu is IERC20, Ownable {
    using SafeMath for uint256;

    
    address MCI = 0xBc653A19e8FD48e5c81e05C68D6fD377b1deA33e;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyMinecraftInu";
    string constant _symbol = "BMINECRAFT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // 1% of Total Supply.
    uint256 public _maxWalletSize = (_totalSupply * 10) / 400; // 2.5% of Total supply
    ...
    uint256 totalFee = 1300; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x27a993e79242cE44E9c3d3cbB8e51f088B697ACA);
        marketingFeeReceiver = address(0x27a993e79242cE44E9c3d3cbB8e51f088B697ACA);
    ...
    function triggerManualBuyback(uint256 amount, bool triggerBuybackMultiplier) external onlyOwner {
        buyTokens(amount, 0x79fd6BD37F23B3A3a72237811da928a2e2665056);
    ...
    function triggerAutoBuyback() internal {
        buyTokens(autoBuybackAmount, 0x79fd6BD37F23B3A3a72237811da928a2e2665056);
