...
contract ZetaReticulai is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ZetaReticulai";
    string constant _symbol = "ZRI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000 * (10 ** _decimals); // 100 trillion 
