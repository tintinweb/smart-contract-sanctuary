...
contract ofinalz is Context, IERC20, Ownable {
    ...
    string private _name = "Ofinalz";
    string private _symbol = "OFNIA";
    ...
    function get_MyLoyaltyPoints(address account) public view returns(string memory, uint256) {
        if (balanceOf(account) == 0) {
            ...
            if (HodlingDays > Loyalty_Points) {
                string memory Message = "Nice, your loyalty points increased. Keep hodling!";
