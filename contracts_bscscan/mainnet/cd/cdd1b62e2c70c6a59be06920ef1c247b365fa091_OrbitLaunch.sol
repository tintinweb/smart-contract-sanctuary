...
contract OrbitLaunch is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("OrbitLaunch", "$ORBIT", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0x920Db13D229C0d8f180a6C3d483CC82eeDA09f08;
        ecosystemFeeReceiver = 0x982B4E9Da93D7F73660e9390F78a7B8a092Bb853;
        buyBackFeeReceiver = 0xa48612AE3ff1ecD72DD84C92404bb12525C3B048;
