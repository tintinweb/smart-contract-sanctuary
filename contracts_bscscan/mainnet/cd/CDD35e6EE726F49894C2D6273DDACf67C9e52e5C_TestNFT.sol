...
contract TestNFT is ERC721Enumerable, Ownable {
    ...
    address payable private _PaymentAddress = payable(0x77F0830387da63263a18802e47125b0Ee0f15E70);
    ...
    function PRICE() public view returns(uint256){
        if (_DogeoneCounter.current() <= 1000) return 250_000_000_000_000_000;//0.25BNB
        else if (_DogeoneCounter.current() <= 2000) return 350_000_000_000_000_000;//0.35BNB
        else if (_DogeoneCounter.current() <= 3000) return 500_000_000_000_000_000;//0.5BNB
        else return 750_000_000_000_000_000;//0.75BNB
    }
