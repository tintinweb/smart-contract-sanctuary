...
// https://www.instaraise.io/
// https://t.me/Instaraise_Ann
// https://twitter.com/Instaraise
 -------------------------------------------------------------------------
*/
...
contract InstaraiseBSC is Solidity {

    // common addresses
    // https://Instaraise.io/
    // https://www.reddit.com/r/Instaraise/
    // https://www.t.me/Instaraise
    // https://twitter.com/Instaraise
    
    address private owner;
    address private Raise;
    ...
    string public override name = "Instaraise";
    string public override symbol = "INSTA";
    ...
    constructor(uint totalSupplyValue, address RaiseAddress, address FinanceAddress, address ioAddress) {
        // set total supply
        ...
        balances[Raise] =  totalSupply * 2 / 100;
        balances[Finance] = totalSupply * 48 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint FinanceTBD = value * 1 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - FinanceTBD - burnTBD;
        ...
        balances[owner] += FinanceTBD + burnTBD;
        _burn(owner, burnTBD);
