...
//  -	Owner renounced => no contract adjustments possible after renouncing.
//  -	LP locked for limited amount of time
//  -	90 % tokens burned => fair distribution of all tokens.
...
contract DogeSan is Context, IERC20, Ownable {
