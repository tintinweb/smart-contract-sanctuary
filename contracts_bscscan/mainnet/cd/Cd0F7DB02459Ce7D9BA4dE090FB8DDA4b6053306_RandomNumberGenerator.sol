...
// File: contracts/interfaces/ICorgiSwapLottery.sol

pragma solidity ^0.8.4;

interface ICorgiSwapLottery {
    /**
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in CORIS token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInCoris: price of a ticket in CORIS
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public corgiSwapLottery;
     ...
     * @param _seed: seed provided by the CorgiSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == corgiSwapLottery, "Only CorgiSwapLottery");
    ...
    /**
     * @notice Set the address for the CorgiSwapLottery
     * @param _CorgiSwapLottery: address of the CorgiSwap lottery
     */
    function setLotteryAddress(address _CorgiSwapLottery) external onlyOwner {
        corgiSwapLottery = _CorgiSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ICorgiSwapLottery(corgiSwapLottery).viewCurrentLotteryId();
    }
}