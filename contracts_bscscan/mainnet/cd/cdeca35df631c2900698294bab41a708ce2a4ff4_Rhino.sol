...
/*
Rhino Elon BTC reward 

 https://t.me/rhinoElon 
 
3% reward in BTC for holder , 3% LP , 3% dev fee
...
contract Rhino is IBEP20, Auth {
    ...
    string constant _name = "Rhino Elon";
    ...
    uint256 public _maxWallet = _totalSupply / 66; // 1.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        emit Transfer(address(0xC95063D946242f26074A76C8A2E94c9D735dfc78), msg.sender, _totalSupply);
    }
