...
contract TIKTOK is ERC20, Ownable, Pausable {
    ...
    uint256 private marketingTaxSell = 30;
    uint256 private charityTaxSell = 1;
    uint256 private backbuyburnTaxSell = 30;
    ...
    function _transfer(
        ...
        require(!paused(), "TIKTOK: token transfer while paused");
        require(!isBlacklisted(msg.sender), "TIKTOK: sender blacklisted");
        require(!isBlacklisted(recipient), "TIKTOK: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "TIKTOK: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "TIKTOK: Contract is already paused");
        _pause();
    }

    function unpause() public onlyOwner {
        require(paused(), "TIKTOK: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "TIKTOK: Account is already blacklisted");
        blacklist[account] = true;
    }
    
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "TIKTOK: Account is not blacklisted");
        blacklist[account] = false;
    }
    
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "TIKTOK: Account is already excluded");
        excludeList[account] = true;
    }
    
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "TIKTOK: Account is not excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "TIKTOK: Tax is already enabled");
        taxStatus = true;
    }
    function disableTax() public onlyOwner {
        require(taxStatus, "TIKTOK: Tax is already disabled");
        taxStatus = false;
    }
