...
͖͔͔̀𝙩̴̴̼̠͉̠͍̈́̒̿̐́͘͜𝙚̸̸̪̼͔͙͍͓̈́̓́̓͘𝙡̸̴̪͖̫͓̝̻̀̓̓͆́͆𝙡̸̴̡͓̞̘͚̟͒̒̓͘̚𝙖̸̵̡̙̻̫̻̪̈́̾̿̒̚̕𝙧̵̴̢͕̼͔͖̺́̀͒̐̈́͝𝙋̸̵͔̻͔̞͔̟͆͛͋͊̓̕𝙖̸̴̡͎͇̠͋͆̽̈́̀̚͜𝙙̵̸̦͓̟̦̫͔̈́̾̕͝͠
*/
...
contract BEP20Mintable is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = 'PNFT ';
    _decimals = 18;
    _totalSupply = 100000000 * 10**8 * 10**9; //100m
