...
/**
   ...
   Welcome to LittleBabyPolkadot
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyPolkadotBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyPolkadot to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyPolkadot idea, increasing the liquidity pool automatically, 
...
contract LittleBabyPolkadot is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby Polkadot";
    string private _symbol = "LTBABYDOT";
