...
SantaSack is a BSC project with rewards in $BNB. Based on an innovative contract, the Rewards technology aims to offer investors an unprecedented rate of passive income that is far superior to that of the banking system.
...
Telegram :  https://t.me/SantaSack_Official
...
contract SANTASACK is IBEP20, Auth {
    ...
    string constant _name = "Santa Sack";
