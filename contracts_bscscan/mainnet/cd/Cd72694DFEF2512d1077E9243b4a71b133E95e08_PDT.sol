...
/**
 * 
One of the fewest project in BSC Scan that will have an use case as well as will reward their holders in a stable coin! We aim to have a project for a very long run. 100% Legit and created to help people around the world to find the passive income that they are looking for and also to help the people in much needed! 
*/
