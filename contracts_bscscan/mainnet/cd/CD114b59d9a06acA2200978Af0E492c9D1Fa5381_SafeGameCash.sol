...
contract SafeGameCash is ERC20, Ownable {
    ...
    address public marketingWallet = payable(0x8B3a9bC8E990847c6050326a80b122D4b3803f32);
    address public gameWallet = payable(0x0d0e630553d65241E628C0935a1f6D9Fe60CE965);
    ...
    constructor() public ERC20("TEST TOKEN 19", "TST19") {
        CEO.add(msg.sender);
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            swapTokensForEth(gameAmount + marketingAmount);
            uint256 gameToSend = initBnbBalance.sub(gameAmount);
            uint256 marketingToSend = initBnbBalance.sub(marketingAmount);

            super._transfer(from, address(this), liquidityAmount + distributionAmount);
            super._transfer(from, marketingWallet, marketingToSend);
            super._transfer(from, gameWallet, gameToSend);
