...
contract Hellbound is ERC20, Ownable {
    ...
    constructor() ERC20("Hellbound", "HB") {
        ...
        marketingWallet = address(0xBa5941B5f29E879E417c41c4Fda6eD7585dF8334); // set as marketing wallet
        buyBackWallet = address(0x5285230FE7C9DE2a078132B6f2f3EC70a52a2681); // set as buyback wallet
