...
contract SnakeRise  is Context, IERC20, Ownable {
    ...
    string private _name = "SnakeRise";
    string private _symbol = "SNAKERISE";
    uint8 private _decimals = 9;


    uint256 public _taxFee = 17;
