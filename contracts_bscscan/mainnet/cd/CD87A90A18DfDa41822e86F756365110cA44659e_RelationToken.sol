...
import "@openzeppelin/contracts/math/SafeMath.sol";
 ...
 //TODO: add Aadmin base contract
contract RelationToken is Ownable, ERC20, ERC20Burnable {
    ...
    bytes32 private constant DOMAIN_NAME_HASH = keccak256("Relation Token");
    ...
    /**
     * @dev Relation Token Contract Constructor.
     */
    constructor() public ERC20("Relation Token", "RNT") {
    ...
    function permit(
        ...
        require(_owner == recoveredAddress, "RNT: invalid permit");
        require(_deadline == 0 || block.timestamp <= _deadline, "RNT: expired permit");
