...
Baby Manchester- Earn AVAX Rewards by holding BM!

AutoInfinity Protocol activated for Diamond Hand Holders 
Sell leads to 50% reduction in rewards, with the other 50% distributed back to diamond hand holders

1% Buy Tax
20% Sell Tax

This tax joins the reward pool and is split between the holders 

Earn passive gas fees for de
Liquidity Lock: 
Whale Protection
Dump Protection
...
Avalanche is an open, programmable platform for decentralized finance applications.
...
//AVAX Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract _BabyManchester is IBEP20, Ownable
{
    ...
    mapping (address => bool) private _NoAutoInfinity;
    ...
    //Token Info
    string private constant _name = 'Baby Manchester';
    string private constant _symbol = 'AVAX';
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 1000000000 * 10**_decimals;//equals 101
    ...
    address public constant TeamWallet=0xF7417Bf20648dD7473FAF8b19596F8E14f3e9877;
    ...
    //TODO: Change to Mainnet
    address tokenToClaim=0x1CE0c2827e2eF14D5C4f29a091d735A204794041;//AVAX
    //Testnet BUSD
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            //As soon someone sells, AutoInfinity Protocol ends
            _NoAutoInfinity[sender]=true;
            tax=_sellTax;
    ...
    function _calculateFee(uint256 amount, uint8 tax, uint8 taxPercent) private pure returns (uint256) {
        return (amount*tax*taxPercent) / 100000;
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //BNB Autostake/////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    function TeamSetAutoInfinity(uint8 fee, bool feeOn) public onlyTeam{
        require(fee<=50,"AutoInfinity Protocol Fee is capped to 50%");
        noAutoInfinityFeeOn=feeOn;
        noAutoInfinityFeePercent=fee;
    }
    uint8 public noAutoInfinityFeePercent=50;
    bool public noAutoInfinityFeeOn=true;
    ...
    function claimToken(address addr, address token, uint256 payableAmount) private{
        ...
        //If you don't have AutoInfinity Protocol engaged you are redistributing a part of your reward
        //Compound wont be punished
        if(noAutoInfinityFeeOn&&_NoAutoInfinity[addr]&&token!=address(this)){
            uint256 noAutoInfinityFee=amount*noAutoInfinityFeePercent/100;
            amount=amount-noAutoInfinityFee;
            _distributeStake(noAutoInfinityFee,false);
        }
    ...
    function hasAutoInfinity(address AddressToCheck) public view returns(bool){
        return !_NoAutoInfinity[AddressToCheck];
    }
    ...
    function getDividentsOf(address addr) public view returns (uint256){
        ...
        if(noAutoInfinityFeeOn&&_NoAutoInfinity[addr])
            amount-=amount*noAutoInfinityFeePercent/100;
        return amount;
    }
