...
/**
* Welcome to King Minos!
 
 * Website: https://king-minos.com/

 * Token Name: King Minos
 * Token Symbol: KMINOS

* Total Supply: 1,000,000,000,000,000 KMINOS (100%)
  *   0% TEAM TOKENS
  *  30% BURNED
  *  70% PRESALE AND PCS
   
* 70% liquidity blocked by DxSale!  
* You can buy our Tokens on Presale DxSale at a 30% discount.
...
* The token contract employs a static rewards system - 14% of every transaction is split in three:
  ...
  * 2% fee is automatically added to the charity wallet (community development and marketing, for regular promotion).
  
* Price KMINOS in BNB:
  * At presale - 0,000000000000250   
  * After listing - 0,000000000000326  
  
* Twitter:
  * #KingMinosPresaleGiveaways
  * #KingMinosListingGiveaways 
...
* 0% Owner Wallet
* 0% Marketing Wallet
* No fraudulent burns to disguise the wallet sizes
* Solid project 
* LP locked 
...
contract KingMinos is Context, IERC20, Ownable {	
    ...
    string private constant _name = "King Minos";	
    string private constant _symbol = "KMINOS";	
