...
/**
Telegram : https://t.me/RewardBNB

REWARD BNB brings cutting edge DeFi features to existing BSC tokens like staking and DeFi lending.
Every partner vault benefits the rewardbnb token price and APY
#REWARBNB
Token features include:
    Staking Vaults With Rewards (Bonuses for Time Locking)
    STAKING After Launch.
*/
...
contract RewardBNB is IBEP20, Auth {
    ...
    string constant _name = "Reward BNB";
    string constant _symbol = "$RBNB";
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 100000; // 0.01% of supply
    bool inSwap;
