...
// telegram : https://t.me/SantaLittleFloki
// 
...
contract SantaLittleFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SantaLittleFloki";
    string private _symbol = "$SFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F60b5Ac2DD5E960a37E4938A88B2f2Bd020A833); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x86b3ACe739AE08e3626462373de54F8a516b4a77); // BuyBack Address
