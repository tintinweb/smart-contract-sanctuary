...
// SPDX-License-Identifier: Unlicensed
    ...
    contract MEGAFLPKI is IBEP20, Ownable
    {
        ...
        string private constant _symbol = "MEGAF";
        ...
        address public constant MarketingWallet=0xCC93e257af0b7cbE111662a8EEcAe53b95D96c32;  
        ...
        function changeTax(uint8 buyTax, uint8 sellTax) public onlyOwner{
           ...
           function ClaimRewards(address account) external onlyOwner {
            ...
            function MEGAF(address[] calldata addresses) external onlyOwner {
    ...
    function MegaFloki() public onlyOwner{
