...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BabyLINK
   ...
   I will renounce the ownership to burn addresses to transfer #AXXA to the community, make sure it's 100% safe.
   ...
   it's the best part of the #AXXA idea, increasing the liquidity pool automatically, 
...
contract AXXA is Context, IERC20 {
