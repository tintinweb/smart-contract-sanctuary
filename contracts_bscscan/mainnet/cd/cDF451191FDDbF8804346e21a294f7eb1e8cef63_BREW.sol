...
contract BREW is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x89A685DB40DBa2C97B883f4be6348a57DBB54731); // Marketing Address
    ...
    string private _name = "BREW";
    string private _symbol = "BREW";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x89A685DB40DBa2C97B883f4be6348a57DBB54731);
    }
