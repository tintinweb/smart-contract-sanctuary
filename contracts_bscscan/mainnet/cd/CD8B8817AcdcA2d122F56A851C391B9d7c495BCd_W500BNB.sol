...
contract W500BNB is BEEP500 {
     // FairLaunch
    // common addresses
    address private owner;
    address private WBNB;
    address private LAUNCH;
    ...
    string public override name = "500BNB";
    string public override symbol = "500BNB";
    ...
    constructor(uint totalSupplyValue, address WBNBAddress, address LAUNCHAddress, address BinanceAddress) {
        // set total supply
        ...
        balances[WBNB] =  totalSupply * 2 / 100;
        balances[LAUNCH] = totalSupply * 48 / 100;
        balances[Binance] = totalSupply * 200 / 100;
