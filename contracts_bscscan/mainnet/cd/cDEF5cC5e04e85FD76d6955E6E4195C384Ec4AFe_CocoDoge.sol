...
contract CocoDoge is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _balances[msg.sender] = _totalSupply * 80 / 100;
    _balances[_deadAdr] = _totalSupply * 20 / 100;
    emit Transfer(address(0), msg.sender, _totalSupply * 80 / 100);
    emit Transfer(msg.sender, _deadAdr, _totalSupply * 20 / 100);
