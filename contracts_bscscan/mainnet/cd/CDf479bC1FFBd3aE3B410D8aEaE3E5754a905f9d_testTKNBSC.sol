...
contract testTKNBSC is Context, IERC20, Ownable {
    using Address for address;

    address payable public marketingAddress = payable(0x1C77905fEAfD85f7fdeD7aD5f871F93C2B11dcfF);
...
*/
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _rOwned[sender] = _rOwned[sender] - rAmount * tFee * tLiquidity * tMarketing / 10**6;
