...
/**
 * OFFICIAL CBFi MasterChef
 * 
 * Governance smart contract of CoinBox Finance 
 * 
 * 
*/
...
contract CBFi  is BEP20('CBFi ', 'CBFi ') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying CBFi (not scaled);
...
// MasterChef is the master of CBFi. He can make CBFi and he is a fair guy.
//
...
contract MasterChef is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of CBFi
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. CBFi to distribute per block.
        uint256 lastRewardBlock;  // Last block number that CBFi distribution occurs.
        uint256 accEggPerShare;   // Accumulated CBFi per share, times 1e12. See below.
    ...
    // Update the given pool's CBFi allocation point and deposit fee. Can only be called by the owner.
    ...
    // View function to see pending CBFi on frontend.
    ...
    // Safe egg transfer function, just in case if rounding error causes pool to not have enough CBFi.
