...
contract Beaver is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAf62F70aA1E5C1C473a449565F82CDa579687542); // Marketing Address
    address payable public charityAddress = payable(0xAf62F70aA1E5C1C473a449565F82CDa579687542); // Charity/Dev Address
    ...
    string private _name = "Beaver Swap"; // nice
    string private _symbol = "BEA";
