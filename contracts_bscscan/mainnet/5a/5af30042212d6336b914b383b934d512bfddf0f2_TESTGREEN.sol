...
contract TESTGREEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TESTGREEN";
    string private _symbol = "TESTGREEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB91d68e7c86BD68507dDea5F5eb9aDB89e5c1A93); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xB91d68e7c86BD68507dDea5F5eb9aDB89e5c1A93); // buyback Address
    ...
    uint256 public _maxTxAmount = 7500000000000 * 10**9; // 0.1%
    uint256 public _walletMax = 7500000000000 * 10**9; // 2%
