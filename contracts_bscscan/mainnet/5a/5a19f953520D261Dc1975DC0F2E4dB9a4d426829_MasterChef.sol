...
// UnderwaterFarmToken with Governance.
contract UnderwaterFarmToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // The UnderwaterFarmToken!
    UnderwaterFarmToken public panther;
    // Dev address.
    ...
    constructor(
        UnderwaterFarmToken _sjf,
        uint256 _startBlock,
        uint256 _sjfPerBlock
    ) public {
        panther = _sjf;
        startBlock = _startBlock;
        pantherPerBlock = _sjfPerBlock;
    ...
    function updateEmissionRate(uint256 _sjfPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _sjfPerBlock);
        pantherPerBlock = _sjfPerBlock;
    }
