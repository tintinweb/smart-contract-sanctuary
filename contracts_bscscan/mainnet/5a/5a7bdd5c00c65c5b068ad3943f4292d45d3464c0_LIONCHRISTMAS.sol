...
contract LIONCHRISTMAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LIONCHRISTMAS";
    string private _symbol = "LIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99c02976943346692eA343bebAE1de153348e897); // Marketing Address
    address payable public teamWalletAddress = payable(0x99c02976943346692eA343bebAE1de153348e897); // Team Address
