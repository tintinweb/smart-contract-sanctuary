...
With this, Evocardano is born, which is the development of a DEX - Decentralized Exchange) similar to Pancakeswap for the Cardano network. Where it will allow users to trade assets, Defi's projects on Cardano's network quickly, cheaply and securely. Step 2 of this big project is to implement our Evocardano coin in Cardano's own blockchain. Therefore, we can have an extreme valorization with the merger of the two networks into Evoc.
...
——————
- Website - https://www.evocardano.com/en

- Telegram (English) - https://t.me/evocardanoofficial

- Whitepaper - https://evocardano.com/documentos/EvoCardano%20-%20Whitepaper%20V.1%20-%20ENG.pdf 
...
contract EVOC is Context, IERC20, Ownable {
