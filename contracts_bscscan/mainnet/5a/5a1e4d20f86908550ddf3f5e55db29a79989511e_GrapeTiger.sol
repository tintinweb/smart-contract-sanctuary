...
/** We are the community of GRAPE TIGER, So, Join us now if you are looking for a healthy pump. 👌👌✊✊
 *https://t.me/grapetiger
*/
...
contract GrapeTiger is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grape Tiger"; // 
    string private constant _symbol = "GrapeTiger"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x1068abcA49091EC25801aF6a015926BbBFf80f17;
