...
contract cgctoken is Context, IERC20, Ownable {
	...
	string private _name = "Crypto Games Token";
	string private _symbol = "CGC";

// >> Symbols after dot (.) in token:
	uint8 private _decimals = 9;

// >> Redistribution fee of any transaction: 5%
	uint256 public _taxFee = 5;
	uint256 private _previousTaxFee = _taxFee;

// >> Liquidity fee of any transaction: 5%
