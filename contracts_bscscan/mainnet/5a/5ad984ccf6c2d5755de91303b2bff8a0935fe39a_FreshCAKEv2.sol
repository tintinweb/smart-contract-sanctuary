...
This is FreshCAKEv2 1000x potential.

Community: 

Telegram : https://t.me/freshcakev2
Twitter : https://twitter.com/frakv2
Website : www.FreshCAKE.one
...
// File: contracts/FreshCAKEv2DividendPayingToken.sol
...
// File: contracts/FreshCAKEv2.sol
...
contract FreshCAKEv2 is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   FreshCAKEv2DividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet = 0x489bFcba34B41CF5a4E4e059c7637b94B1E78C87;
    ...
    constructor() public ERC20("FreshCAKEv2", "FRAK") {
        uint256 _rewardsFee = 1;
    	...
    	dividendTracker = new FreshCAKEv2DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "FreshCAKEv2: The dividend tracker already has that address");

        FreshCAKEv2DividendTracker newDividendTracker = FreshCAKEv2DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "FreshCAKEv2: The new dividend tracker must be owned by the FreshCAKEv2 token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "FreshCAKEv2: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "FreshCAKEv2: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "FreshCAKEv2: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "FreshCAKEv2: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "FreshCAKEv2: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "FreshCAKEv2: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "FreshCAKEv2: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "FreshCAKEv2: This account cannot send tokens until trading is enabled");
        }
    ...
    function swapTokensForBusd(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of FreshCAKEv2
            path,
            recipient,
            block.timestamp
        );
...
contract FreshCAKEv2DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("FreshCAKEv2_Dividend_Tracker", "FreshCAKEv2_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "FreshCAKEv2_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "FreshCAKEv2_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FreshCAKEv2 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "FreshCAKEv2_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "FreshCAKEv2_Dividend_Tracker: Cannot update claimWait to same value");
