...
// Welcome to LittleBabyBull
   
 //  This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyBullChat
  ...
  // I will renounce the ownership to burn addresses to transfer #LittleBabyBull to the community, make sure it's 100% safe.

  // I will add 0.2 BNB and all the left 10% total supply to the pool
  // Can you make #LittleBabyBull 10000X? 
  ...
  // it's the best part of the #littleBabyBull idea, increasing the liquidity pool automatically, 
...
contract LittleBabyBull is Context, IERC20, Ownable {
    ...
    string private _name = "LittleBabyBull";
    string private _symbol = "LTBABYBULL ";
