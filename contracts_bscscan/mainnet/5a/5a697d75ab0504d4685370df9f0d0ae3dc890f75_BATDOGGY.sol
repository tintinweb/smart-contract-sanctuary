...
$BATDOGGY🦇 is a high-yield frictionless farming token. There is a 5% tax on every transaction: 3% is locked in liquidity 2% is distributed to holders proportional to the amount of token held.
...
contract BATDOGGY is ERC20 {

    uint tokenTotalSupply = 100000000000;

    constructor() public ERC20("Batdoggy", "BATDOGGY") {
