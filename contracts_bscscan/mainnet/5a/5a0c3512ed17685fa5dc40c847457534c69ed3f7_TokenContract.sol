...
contract TokenContract is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 100_000_000_000_000; //100 Trillion, underscores aid readability
    ...
    string private _name = "BigDogeShit";
    string private _symbol = "BDShit";
    ...
    address private _marketingWallet = 0x576d66890835a66d2303d8f34A0B4b59dDb92ED9;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee <= 5); // Prevents owner from abusing fees.
        _taxFee = taxFee;
    }
    ...
    function setMarketingFeePercent(uint256 marketingFee) external onlyOwner() {
        require(marketingFee <= 5); // Prevents owner from abusing fees.
