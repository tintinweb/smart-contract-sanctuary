...
// Telegram  https://t.me/flokicoke_official_global
...
// CHANGE
contract FlokiCoke  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiCoke";
    string constant _symbol = "FCOKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 2% MAX 200,000
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 2% MAX 200,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x16eC75439869d1Dc6B4Cc308DC021fd325403EaD); // Change
