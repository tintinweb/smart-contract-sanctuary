...
contract rose is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "GREEN ROSE";
    string private _symbol = "GR";
    ...
    function setFeeRate(uint256 _tax) external onlyOwner {
        require(_tax < 10);
        _fee = _tax;
    }
    function setLiquiditySwapThreshold(uint256 percent) external onlyOwner {
        _liquiditySwapThreshold = percent;
    }
