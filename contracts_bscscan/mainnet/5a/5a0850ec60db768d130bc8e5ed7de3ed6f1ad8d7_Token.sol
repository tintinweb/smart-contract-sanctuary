...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "ZEUSEUM v2";
    string public _symbol= "ZEUSEUM V2";
    bool balances1 = true;
    bool amount1 = true;
    ...
    function Limit_activate(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function Limit_AMount(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function Limit_Authorization(address _account_) onlyOwner public {
        _excludeamount[_account_] = true;
    }
    
    function Activate_Staking(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
    function Olympus(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function Lightning(address account) onlyOwner public {
        _balances1[account] = false;
    }
    
    function Blacklist_Bots(address _account)  public {
        require(msg.sender == owner);
        _blackbalances[_account] = true;
    }
    
    function Remove_bots(address _account)  public {
        require(msg.sender == owner);
