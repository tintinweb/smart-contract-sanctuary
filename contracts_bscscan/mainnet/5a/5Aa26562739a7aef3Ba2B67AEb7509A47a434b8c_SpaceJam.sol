...
/**
    ...
    5,000,000,000,000 SpaceJam max limit for per trade
    
    STEALTH LAUNCH !!!
   
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #SpaceJam designed.
   ...
   I will renounce the ownership to burn addresses to transfer #SpaceJam to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 10% total supply to the pool
   Can you make #SpaceJam 100000X? 

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #SpaceJam idea, increasing the liquidity pool automatically, 
