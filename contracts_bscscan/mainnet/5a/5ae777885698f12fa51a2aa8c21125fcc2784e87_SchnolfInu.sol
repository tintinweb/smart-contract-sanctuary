...
// https://t.me/SchnolfInu
// Taxes : Buy 10% Sell 15%
...
contract SchnolfInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SchnolfInu";
    string private _symbol = "Schnolf";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x423c42F9f233B910a02140275525eD8046ee0a0e); // Marketing Address
    address payable public DevWalletAddress = payable(0x423c42F9f233B910a02140275525eD8046ee0a0e); // Dev Address
