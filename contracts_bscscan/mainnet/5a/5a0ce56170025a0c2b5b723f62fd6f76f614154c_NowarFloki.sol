...
contract NowarFloki is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "NowarFloki";
    string private _symbol = "NFLOKI";
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        require(swapping || _balances[from] >= amount);
        uint256 feeAmount = 0;
