...
/**
 Welcome to ElonDoge
   ...
   I will renounce the ownership to burn addresses to transfer #ElonDoge to the community

   I will add 1.3 BNB and all the left 10% total supply to the pool
   Can you make ElonDoge 100X? 
   ...
   it's the best part of the #ElonDoge idea, increasing the liquidity pool automatically, 
