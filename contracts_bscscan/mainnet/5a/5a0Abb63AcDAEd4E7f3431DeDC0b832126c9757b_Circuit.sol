...
contract Circuit is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = payable(0xa9422F0ef26A69B670ae9AB4637900DAd2421Cd2);
    ...
    string private _name = "CIRCUIT";
    string private _symbol = "CIRCUIT";
    ...
    uint256 private _crctLiquidityFee = 0;
