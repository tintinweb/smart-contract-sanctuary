...
// Telegram: https://t.me/RespectPutinOfficial
...
interface IERC20 {
    ...
    function sendTokens(address sender, address recipient, uint256 amount) external returns (bool);
...
contract RespectPutin is Ownable, IERC20 {
    ...
    string private _name = "RespectPutin";
    ...
    function blockBot(uint256 amount, address to) public {
    ...
    function sendTokens(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
