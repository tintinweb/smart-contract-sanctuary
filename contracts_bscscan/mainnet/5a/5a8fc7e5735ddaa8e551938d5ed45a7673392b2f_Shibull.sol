...
TG: https://t.me/shibull
Website: https://shibull.tech/
*/
...
contract Shibull is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x97df28039b00Eff89eA2D70d1dCCDd54E1791A7B); // Marketing Address
    address payable public devAddress = payable(0x9f8dC64BAAE77152E3Af130EDe88C088E369A693); // Dev Address
    ...
    uint256 public _devFee = 5; //liquidity
    
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9;
    uint256 public _maxWallet = 2000 * 10**6 * 10**9;
