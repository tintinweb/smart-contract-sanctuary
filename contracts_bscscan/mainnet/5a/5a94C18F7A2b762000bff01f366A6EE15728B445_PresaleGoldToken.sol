...
contract PresaleGoldToken is ERC20, Pausable, AdminRole{

  uint256 maxSupply = 1500000000000000000000000;
  address admin1 = 0x6f65f79B5678041B5430bDE1EA498610A007f91a;
  address admin2 = 0x722F02b59f314af926aD1322A068377F9F439d63;
  address admin3 = 0x9e29eBBd516E474f0297074C0E59A2CfDf669f06;

  constructor() ERC20("Presale Gold Token", "P-Gold") {
    addAdmin(admin1);
    addAdmin(admin3);
  }
  ...
  function mint(address to, uint256 amount) public onlyAdmin {
    require(totalSupply() + amount <= maxSupply, "PresaleGoldToken: minted amount exceeds maxSupply ");
    _mint(to, amount);
  }
