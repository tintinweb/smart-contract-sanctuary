...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaAcB4Dd1B5A2aa0234dD87f6ed579FDd218f3fe0;
...
contract ApeZilla is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x30d869F3F76C4fF790BdE06885B8aD121bDd3dCB;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ApeZilla";
    string private _symbol = "APZ";
