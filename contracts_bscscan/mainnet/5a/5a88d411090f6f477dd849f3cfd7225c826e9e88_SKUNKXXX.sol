...
contract SKUNKXXX is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "SKUNKXXX";
   string constant _symbol = "SKUNK";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x99359839cFAEd07176f9E6BbC5d4E8dEDFd27fc8;
