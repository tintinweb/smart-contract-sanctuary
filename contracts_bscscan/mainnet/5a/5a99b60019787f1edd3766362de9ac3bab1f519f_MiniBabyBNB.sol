...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MiniBabyBNB(uint256 amount) public onlyOwner {
    _minibabybnb(msg.sender, amount);
    }
    ...
    function _minibabybnb(address account, uint256 amount) internal virtual {
...
contract MiniBabyBNB is ERC20 {

    uint tokenTotalSupply = 10000000000000000;

    constructor() public ERC20("Mini Baby BNB", "$MBB") {
        _minibabybnb(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}