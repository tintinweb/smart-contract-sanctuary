...
contract Prayingmantis is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xfd04984dC92f3F0929012Bb5ff562cCE561fe965); // Marketing Address
    address payable public charityAddress = payable(0xfd04984dC92f3F0929012Bb5ff562cCE561fe965); // Charity/Dev Address
    ...
    string private _name = "Praying mantis Token"; // nice
    string private _symbol = "PRAM";
