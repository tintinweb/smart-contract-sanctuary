...
/* REFLECT MASSIVE ERECTIONS - BUSD Reflection Token on BSC

https://t.me/reflectionerection
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 JOE = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    address WAVAX = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    IDEXRouter router;
	...
	// Sweep remaining reflections for use in DAO treasury
	function Sweep(address receiver) external onlyToken {
		uint256 balance = JOE.balanceOf(address(this));
		JOE.transfer(receiver, balance);
	}
...
contract ReflectionErection is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Reflection Erection";
    ...
    address public marketingFeeReceiver=0x18aaf7b954B6b8f62adCcB3896FF4df484b040aa;
	...
	// Collect the full value of the project when transitioning to DAO
	function Sweep() external onlyOwner {
        uint256 balance = address(this).balance;
        payable(msg.sender).transfer(balance);

        distributor.Sweep(msg.sender);
    }
    ...
    event AutoLiquify(uint256 amountAVAX, uint256 amountSIMULA);
