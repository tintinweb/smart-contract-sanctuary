...
contract MiniFirstDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiniFirstDoge";
    
    string private constant _symbol = "MiniFirstDoge"; 
    ...
    address public mkWallet = 0x964F3652971829809eBF2B8c76eDd9F89dC11042;
    ...
    constructor () {
        ...
        _isExcludedFromFee[mkWallet] = true;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(mkWallet).transfer(ethToSend);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount - ethFromLiquidity > 0)
            payable(mkWallet).sendValue (ethAmount - ethFromLiquidity);
    }
}