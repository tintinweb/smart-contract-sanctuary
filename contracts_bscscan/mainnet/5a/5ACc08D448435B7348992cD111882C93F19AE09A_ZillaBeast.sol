...
// Telegram: https://t.me/ZillaBeast
...
contract ZillaBeast {
    ...
    uint256 public _maxTxAmount = 20_000;      // Max Buy/Sell: 2.0%
    uint256 public _maxWalletAmount = 30_000; // Max Wallet:    3.0%

    uint256 public _numTokensSellToAddToLiquidity = 5_000_000_000; // Number of tokens to sell before Liquidity gets added: (0.1%)
    string public name = "ZillaBeast";
