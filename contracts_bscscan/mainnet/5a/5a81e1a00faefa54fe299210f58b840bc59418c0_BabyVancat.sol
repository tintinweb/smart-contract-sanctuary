...
/**
   ...
   Welcome to BabyVancat
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyVancatBSC
...
contract BabyVancat is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Vancat";
    string private _symbol = "BabyVancat";
