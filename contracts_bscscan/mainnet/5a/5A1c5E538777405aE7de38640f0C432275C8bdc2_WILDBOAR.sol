...
contract WILDBOAR is Context, IERC20, Ownable {
    ...
    string private _name = "Wild Boar";
    string private _symbol = "Wild Boar";
    ...
    function ROLEpig(address ZOMBIES, uint256 BULLET) external onlyOwner() {
