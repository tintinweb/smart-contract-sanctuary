...
Be Fair To Zeus And He'll Give You Wings To Fly..

https://t.me/AdaZeus
twitter.com/AdaZeusBSC
www.adazeus.com
...
contract AdaZeus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AdaZeus";
    string constant _symbol = "AdaZeus";
    ...
    uint8 public cooldownTimerInterval = 50;
    mapping (address => uint) private cooldownTimer;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply * 10 / 5000; // 0.2% of supply
    bool inSwap;
