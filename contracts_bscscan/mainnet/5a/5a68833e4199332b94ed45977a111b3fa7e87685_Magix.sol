...
//Created By AminiusGFX

//Magix Automatic BUSD Reflection Contract
...
contract Magix is IBEP20, MBCAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "Magix";
    string constant _symbol = "MGX";
    uint8 constant _decimals = 18;

    uint256 _totalSupply =100000000000000000000000000000; //100 Billion
    uint256 public _maxTxAmount = _totalSupply / 10000; // 0.1%

    // @dev  added max hold so that no single wallet can hold more than 1%.
    uint256 public _maxHold = _totalSupply / 300; // 3% (Only MAGIX Marketing wallet contains above 3%)
    ...
    address public marketingFeeReceiver =0x965BE36bfb3aad378121b4197B369Ba3a71844Ce ;
    address public buybackFeeReceiver =0xEc80967c2511CAdeBFb5912ce56A768Ec336D743 ;
