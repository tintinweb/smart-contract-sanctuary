...
contract WatchdogMigrator is Auth {
    ...
    address public oldTokenAdr = 0x8bfc1c564E4490790DFac641C9a0FecD3f91F584;
    address public newTokenAdr = address(0); // not deployed yet
    address public tokenReceiverAdr = 0x5cf4723204Eb11572F5a6DCaf5f6072C90eff8d4;
    address public whitelistAdr = 0xCb94c18C3209040A87D164A77BB09198963d1849;

    IWhitelister public whitelist;

    uint public conversionNumerator = 1000;
    uint public conversionDenominator = 100000000000;
