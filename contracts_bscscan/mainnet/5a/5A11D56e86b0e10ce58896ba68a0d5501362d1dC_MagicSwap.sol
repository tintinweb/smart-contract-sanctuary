...
library SafeMath {
    ...
    function sub(uint k1, uint k2) internal pure returns (uint) {
        return k1 - k2;
    }
    ...
    function sub(uint k1, uint k2, string memory errorMessage) internal pure returns (uint) {
        unchecked {
...
contract MagicSwap is Contexts, ICOIN, ICOINMetadata {
