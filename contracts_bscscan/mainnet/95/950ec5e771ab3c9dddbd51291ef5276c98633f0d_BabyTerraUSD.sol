...
| $$  \ $$ /$$__  $$| $$  | $$| $$  | $$| $$| $$_____/| $$      | $$      /$$__  $$| $$  | $$ /$$  \ $$| $$  | $$
| $$$$$$$/|  $$$$$$$| $$$$$$$/|  $$$$$$$| $$|  $$$$$$$| $$      | $$     |  $$$$$$$|  $$$$$$/|  $$$$$$/| $$$$$$$/
|_______/  \_______/|_______/  \____  $$|__/ \_______/|__/      |__/      \_______/ \______/  \______/ |_______/ 
                               /$$  | $$                                                                         
                              |  $$$$$$/                                                                         
                               \______/                                                                          
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 UST = IBEP20(0x23396cF899Ca06c4472205fC903bDB4de249D6fC);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = UST.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            UST.transfer(shareholder, amount);
...
contract BabyTerraUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyTerraUSD";
    string constant _symbol = "BabyTerraUSD";
