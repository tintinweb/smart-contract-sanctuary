...
contract Quizarena is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _QIZ(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _QIZ(uint256 amount) public onlyOwner virtual returns (bool) {
