...
contract SQGAMEToken is ERC20, Ownable {
    address public devAddress = 0x8fcb16554c2d31DC8084B0900Ec6cE384B7A732e;
    address public marketingAddress = 0x025ff43026d05b670D6aC4C6583c184d1fac8e3e;
    address public diamondHolderPoolAddress = 0xfc8140D02d3fF71337bBaE1B85EB07Ab0916F6B0;
    ...
    constructor() ERC20("SquidToGame", "SQGAME") {
        _mint(msg.sender, 95_000_000_000 ether);
        _mint(devAddress, 2_000_000_000 ether);
        _mint(marketingAddress, 3_000_000_000 ether);
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[msg.sender] = true;
        _isExcludedFromFee[devAddress] = true;
        _isExcludedFromFee[marketingAddress] = true;
        _isExcludedFromFee[diamondHolderPoolAddress] = true;
    }
