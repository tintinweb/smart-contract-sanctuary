...
contract Testingcontract is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Testingcontract";
    ...
    address payable private _marketingAddress = payable(0xE200074BB203c3442513658D567E4aC6F44A7ef0);
    address payable constant private _projectMaintainence = payable(0xE200074BB203c3442513658D567E4aC6F44A7ef0);
    ...
    function sendETHToFee(uint256 amount) private {
        if(block.timestamp < _firstBlock + (1 days)) {
            address payable addr = payable(0xE200074BB203c3442513658D567E4aC6F44A7ef0); // dev fee lasts for one day only
