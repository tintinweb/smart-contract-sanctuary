...
* 3 % Tax Fee (Holders)
* 3 % Liquidity Fee
* 0 % Auto Burn (Could Change by time)
* 4 % Marketing wallet
*/
...
contract Moony is Context, IERC20, Ownable {
    ...
    string private _name = "Moony";
    string private _symbol = "MNY";
    ...
    address public marketingWallet = 0x5eCAE0F56Ca81B4e71352bBC152c5541484f6737;
    ...
    uint256 public numTokensSellToAddToLiquidity = 1 * 10**6 * 10**9;
