...
/**
 * TG: https://t.me/FortuneDogeBusd
 * Max Wallet 4%, Slippage buy 20% and 20% for sale to be sure 
 * FortuneDogeBusd gathers FortuneDogeBusd and delivers direct to your wallet!!!!
*/
...
contract FortuneDogeBusd is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FortuneDogeBusd";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "FortuneDogeBusd";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x2b3B882055887296481c44D381d087706D1eFBa2;
