...
Hey 🧙🏻‍♂️ are you ready to take the hogwarts express in a magical pump?

We are going to crash all the horcruxes along the way.

This is a community token, this is not the real contract since we want to do a fair launch with the opinion on the community.

Join our express now!

Telegram:

https://t.me/HogwartsExpressToken
...
contract HogwartsExpress is Context, IERC20, Ownable {
    ...
    string private _name = "HogwartsExpress";
