...
/**
  ...
  📱TELEGRAM: https://t.me/morphypawbsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 AXIE = IERC20(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AXIE.balanceOf(address(this));
        ...
        uint256 amount = AXIE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AXIE.transfer(shareholder, amount);
...
// CHANGE
contract MorphyPaw is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address AXIE = 0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MorphyPaw";
    string constant _symbol = "$MPAW";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; // 1% MAX 1,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 30) / 100; // 3% MAX 3,000,000,000
