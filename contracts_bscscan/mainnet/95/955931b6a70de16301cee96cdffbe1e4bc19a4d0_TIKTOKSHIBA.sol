...
// $TIKTOKSHIBA proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN TiktokShiba! With the auto-claim feature,
// simply hold $TIKTOKSHIBA and you'll receive Reflections automatically in your wallet.
// 
// Hold TiktokShiba and get rewarded in TiktokShiba on every transaction!
//
//
// 📱 Telegram: https://t.me/TiktokShiba
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6Bfb9DFc88E9cBa3592EFFe43bF43ef64Fd43BA7;
...
contract TIKTOKSHIBA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6Bfb9DFc88E9cBa3592EFFe43bF43ef64Fd43BA7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TiktokShiba";
    string private _symbol = "TIKTOKSHIBA";
