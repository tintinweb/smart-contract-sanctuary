...
contract BillionaireLlama is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BillionareLlama";
    string private _symbol = "BL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5F6D0Fd03F42211E2691BC98cf2e831a52Ed834d); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5F6D0Fd03F42211E2691BC98cf2e831a52Ed834d); // BuyBack Address
