...
contract MetaSX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x902a57B412ab3d516bc2eF54F8453D98A5367dfE); // Marketing Address
    ...
    string private _name = "Meta Space X";
    ...
    uint256 private minimumTokensBeforeSwap = 50 * 10**4 * 10**9; 
