...
contract BeastDogeToken is ERC20, Ownable {
	...
	//set limits
    uint256 public maxTransactionAmount = 5000000000000 * (10**9); // Set to 0.5% for 
	...
	//set addresses
    address public _marketingWallet = 0xE2E550c21B1ad124d6B9803a0b15AA3A70dccD28;
    address public _fundraisingWallet = 0x4F895194c6358b0a304e120A62Cd491E858BBab2;
    ...
    constructor() public ERC20("BeastDoge", "TBDT") {
    ...
    function buyBackPercentage() public view returns (uint256) {
 	...
 	function setBuybackBlockPeriod(uint256 value) external onlyOwner() {
        _autoBuyBackBlockPeriod = value;
    }
    ...
    function setBuybackPercentage(uint256 value) external onlyOwner() {
        require(value > 0, "cannot be set as zero");
        _buyBackPercentage = value;
    }
    
    function setBuyBackUpperLimit(uint256 value) external onlyOwner() {
        require(value > 0, "cannot be set as zero");
        _buyBackUpperLimit = value;
    }
	...
	//Swap all tokens in 1 swap (minus BNB Rewards and Liquidity)
	//send to wallets and leave BNB in contract for BuyBack
