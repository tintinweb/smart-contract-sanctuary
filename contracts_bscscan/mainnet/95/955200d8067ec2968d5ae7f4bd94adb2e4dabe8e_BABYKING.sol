...
/**
   BABY KING (BABYKING) Tokenomics
   4% fee auto add to the liquidity pool 
   4% distribute to the Marketing / Charity Wallet
...
contract BABYKING is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x5640b9f32996c497E4CB6cF7A6f7eBc5e91aA1Da;
    ...
    string private _name = "BABY KING";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x01367a67190cfA5B239f727247E163d5169683A7, 'We can not exclude Uniswap router.');
