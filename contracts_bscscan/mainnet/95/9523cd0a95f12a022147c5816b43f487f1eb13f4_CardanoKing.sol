...
contract CardanoKing is ERC20Interface, babyMath {
    string public name = "CardanoKing";
    string public symbol = "ADAKINGG";
    ...
    function _transfer(address from, address to, uint256 tokens) private returns (bool success) {
        uint256 amountToBurn = babyDiv(tokens, 40); // 3% of the transaction shall be burned
