...
contract CheemsBullrun is IBEP20, Auth {
    ...
    string constant _name = "Cheems Bullrun";
    string constant _symbol = "CBR";
...
*/
    ...
    function RescueBNB(uint256 amountPercentage) external onlyOwner {
