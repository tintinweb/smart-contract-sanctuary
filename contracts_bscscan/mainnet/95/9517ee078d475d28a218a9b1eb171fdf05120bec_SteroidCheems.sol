...
// CHANGE
contract SteroidCheems is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SteroidCheems";
    ...
    uint256 public _sellMultiplier = 99;
    ...
    uint256 public swapThreshold = _totalSupply / 35; // 0.35%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xE3214cd664FAc12742f81C19813b5184c3AEE82E); // Change
