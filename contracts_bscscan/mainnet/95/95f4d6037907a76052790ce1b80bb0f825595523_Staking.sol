...
contract Staking {
  ...
  address tokenAddr = 0xAe67Cf598a349aFff89f6045108c6C1850f82839;
  ...
  constructor()  {
    tariffs.push(Tariff(365 days, 10));
  }
    ...
    function pWithdraw(uint i) public {
        IERC20 token = IERC20(tokenAddr);
        if(block.timestamp - depo[msg.sender].depTime[i] >= 365 days){
        ...
        else if(block.timestamp - depo[msg.sender].depTime[i] < 365 days){
