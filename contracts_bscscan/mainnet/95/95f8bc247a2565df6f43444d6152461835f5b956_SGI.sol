...
contract SGI is Context, IERC20, Ownable {
    ...
    string private _name = "SquidGame Inu";
    ...
    address public marketing = 0xF1D4A74465C0B4A883549f1E7B4E23093c6224ba; 
    ...
    event SetMaxTxPercent(uint256 maxBalPercent);
