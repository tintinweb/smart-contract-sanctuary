...
contract $ELMON is Context, IERC20, Ownable {
    ...
    string private _name = "$ELMON";              
    string private _symbol = "Elemon Game";                          
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x4Ffc38d215D022dfc7f725f6e88af2867C88FF55, 'We can not exclude Uniswap router.');
