...
contract BABYVADER is ERC20, Ownable {
    ...
    address public  CAKE = address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); //CAKE

    uint256 public swapTokensAtAmount = 2000000 * (10**18);
     uint256 public maxTxAmount = 10000000000 * (10**18); //10% by deafult
    ...
    address public _marketingWalletAddress = 0xF4c0C75b706ac69759ed250320f348eA7E0a0Ea2;
    ...
    constructor() public ERC20("BABY VADER", "BABYVADER") {
...
contract BABYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("BABYVADER_Dividen_Tracker", "BABYVADER_Dividend_Tracker") {
    	claimWait = 3600;
