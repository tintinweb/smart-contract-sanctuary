...
Meatwad from ATHF is here to kick ass on bsc as a token.
 ...
 Reflection/Taxes: 4% in Marketing, 4% in Liquidity, 
...
// CHANGE
contract Meatwad is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Meatwad";
    string constant _symbol = "Meat";
