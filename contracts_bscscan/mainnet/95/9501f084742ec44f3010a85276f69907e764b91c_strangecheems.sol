...
/**
10% buy tax 40%sell tax first 10min 10%buy tax 20% sell after 20min 
*/
...
contract strangecheems is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 50;  //2% max 
    uint256 public maxTxAmountSell = _tTotal /100 ; //1% max sell
    uint256 public maxWalletAmount = _tTotal / 40 ; //2.5% max hold
    ...
    string private constant _name = "Strange Cheems";
