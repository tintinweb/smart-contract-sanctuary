...
// File: contracts/dYdX.sol


pragma solidity ^0.6.0;

contract dYdX is ERC20Permit, ERC20Burnable, Ownable {
    constructor(address _owner) public ERC20("dYdX Token", "dYdX") EIP712("dYdX Token", "1") {
        _mint(_owner, 1e6 ether);
