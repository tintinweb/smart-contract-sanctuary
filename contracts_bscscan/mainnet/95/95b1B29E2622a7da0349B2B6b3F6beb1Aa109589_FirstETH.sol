...
contract FirstETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FirstETH";
    string private _symbol = "FirstETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96B398e92533382C6548b34E8c99dCB6577bBC3b); // Marketing Address
    address payable public teamWalletAddress = payable(0xAeE1D744524aB77D2FD181f7d7f77B1Bc0304c7E); // Team Address
