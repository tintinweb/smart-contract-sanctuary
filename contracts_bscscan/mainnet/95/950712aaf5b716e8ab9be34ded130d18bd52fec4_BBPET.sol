...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BINAPET = IBEP20(0xb26D2d67C7652f361b73552310dA5753041b3867);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BINAPET.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BINAPET);
        ...
        uint256 amount = BINAPET.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BINAPET.transfer(shareholder, amount);
...
contract BBPET is IBEP20, Auth {
    using SafeMath for uint256;

    address BINAPET = 0xb26D2d67C7652f361b73552310dA5753041b3867;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyBinapet";
    string constant _symbol = "BBPET";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x02FfE95578E2533a2522c12f1e42B501F078657a;
