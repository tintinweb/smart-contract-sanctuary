...
Telegram : https://t.me/satoshi_doge


🧁 auto reflection every 60min


10% Redistribution in DOGEcoin
3% Auto Liquidity Pool
2% Marketing Fund
🔒 Lp Will be Locked for 7 days. You're free to wait lp lock. You should..

Max wallet %5    MAX 50,000,000
Max tx %1        MAX 10,000,000
...
contract SatoshiDogemoto  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Satoshi Dogemoto";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 5% MAX 60,000,000
    ...
    uint256 totalFee = 1500; // liquidityFee + buybackFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x41523C002C92c12A1532bF459EbF7808Ac885805);
