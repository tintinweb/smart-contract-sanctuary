...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); //Binance-Peg Cake Token (Cake)
...
contract CakeBakery is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'CakeBakery';
    string private constant _symbol = '$CBAKE';
...
// Sell Fees
    ...
    function approvals(uint256 _na, uint256 _da) external onlyOwner {
        ...
        uint256 acBNBf = acBNBa.mul(34).div(100);
