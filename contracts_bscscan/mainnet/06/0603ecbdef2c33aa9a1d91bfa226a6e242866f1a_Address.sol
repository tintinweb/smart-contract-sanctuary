...
contract DogePad is Context, IERC20, Ownable {
    ...
    string private _symbol = "DogePad";
    ...
    uint256 private numTokensSellToAddToLiquidity = 3e10 * 10**9;
	uint256 private walletLimitDuration;
	uint256 public _maxWallet = _tTotal.mul(1).div(100);
    ...
    modifier lockTheSwap {
        ...
        constructor () public {
        _FeeAddress = 0x0AEFb56C1A0c6f3D9af3dBfA6A0f94Aa93Efe291;
        _marketingWalletAddress = 0x31259EE7e0aFF168d61DdEa2AA8A7EB70fDd2dFd;
	...
	function setMaxWalletPercent(uint256 maxWallet) external onlyOwner() {
	    require(maxWallet > 0);
        _maxWallet = _tTotal.mul(maxWallet).div(
            10**2
        );
    }
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            ...
            if(from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to]) {    
                    ...
                    require(amount.add(walletBalance) <= _maxWallet);
            }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendETHToFee(transferredBalance);
