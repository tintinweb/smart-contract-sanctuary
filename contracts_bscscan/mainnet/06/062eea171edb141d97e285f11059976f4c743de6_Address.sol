...
contract TruvInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA8191eDBE043020F94daA4BE8909425a4bCb3F15); // Marketing Address
    ...
    string private _name = "TruvInu";
    string private _symbol = "Truv";
