...
/* Token contract */
contract PrinceNinjaFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x57801cBd0F79f7bC16FecCd57F0e4ea1A4A2d426;
    ...
    // Name and symbol
    string constant _name = "PrinceNinjaFloki";
    string constant _symbol = "PNF";
    ...
    uint256 devFeeBuy = 0;
    uint256 public totalFeeBuy = 1300;
  ...
  // Sell fees
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 10000; // 0.04% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x57801cBd0F79f7bC16FecCd57F0e4ea1A4A2d426;
