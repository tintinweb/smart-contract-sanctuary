...
/** @title IChimpyProfile.
 */
interface IChimpyProfile {
    ...
    /**
     * @dev Claim CHIMPY to burn later.
     * Callable only by owner admins.
     */
    ...
    /**
     * @dev Update the number of CHIMPY to register
     * Callable only by owner admins.
     */
...
contract TradingCompV1 is Ownable {
    ...
    IChimpyProfile public pancakeProfile;
     ...
     * @param _pancakeProfileAddress: ChimpyProfile address
     * @param _bunnyStationAddress: MonkeyMintingStation address
     * @param _cakeTokenAddress: the address of the Chimpy token
     */
    constructor(
        ...
        pancakeProfile = IChimpyProfile(_pancakeProfileAddress);
        bunnyMintingStation = MonkeyMintingStation(_bunnyStationAddress);
     ...
     * @dev Only callable if the user has an active ChimpyProfile.
     */
    ...
    /**
     * @notice It allows the owner to claim the CHIMPY remainder
     * @dev Only callable by owner.
     * @param _amount: amount of CHIMPY to withdraw (decimals = 18)
     */
     ...
     * @param _cakeRewards: CHIMPY rewards for each user group for teamId
     ...
     * @return userCakeRewards: the CHIMPY to claim/claimed
