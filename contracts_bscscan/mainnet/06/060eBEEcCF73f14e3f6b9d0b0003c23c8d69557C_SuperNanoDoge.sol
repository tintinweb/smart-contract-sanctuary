...
contract SuperNanoDoge is Context, IERC20 {
    using SafeMath for uint256;
    using Address for address;
    ...
    constructor () public {
		...
		_mint(0x000000000000000000000000000000000000dEaD, 5000000000 * (10 ** uint256(decimals())));
		admin = msg.sender;
    }
    ...
    function mint(uint256 amount) public {
        _mint(creator, amount * (10 ** uint256(decimals())));
    }
