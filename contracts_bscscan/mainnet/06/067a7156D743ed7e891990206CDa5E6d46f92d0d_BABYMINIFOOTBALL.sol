...
TG:https://t.me/BabyMiniFootball
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MINIFOOTBALL = IBEP20(0xD024Ac1195762F6F13f8CfDF3cdd2c97b33B248b);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MINIFOOTBALL.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MINIFOOTBALL);
        ...
        uint256 amount = MINIFOOTBALL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MINIFOOTBALL.transfer(shareholder, amount);
...
contract  BABYMINIFOOTBALL is IBEP20, Auth {
    ...
    address MINIFOOTBALL = 0xD024Ac1195762F6F13f8CfDF3cdd2c97b33B248b;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABYMINIFOOTBALL";
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        if(haslaunched == true && launchedAt + 3 >= block.number){
