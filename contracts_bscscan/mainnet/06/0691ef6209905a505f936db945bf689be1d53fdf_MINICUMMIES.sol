...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CAKE = IBEP20(0x27Ae27110350B98d564b9A3eeD31bAeBc82d878d);
...
contract MINICUMMIES is IBEP20, Auth {
    using SafeMath for uint256;


    address CAKE = 0x27Ae27110350B98d564b9A3eeD31bAeBc82d878d;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MINICUMMIES";
    string constant _symbol = "MINICUMMIES";
