...
/**
 * 
babyHERO Official token - Earn MetaHero reward

tg: https://t.me./babyhero_bsc

website: https://babyhero.tech

 * 
*/

/** "SPDX-Licencse-Identifier: <SPDX-Licencse>" */
...
contract DividendDistributor is IDividendDistributor {
    ...
    function setShare(address shareholder, uint256 amount) external override onlyToken {
        ...
        //lp will be removed after 24h if mcap <5k, if >5k - we will extend it. Don't buy if you dont agree
...
contract babyHERO is IBEP20, Auth {
    using SafeMath for uint256;

    address MetaHero = 0xD40bEDb44C081D2935eebA6eF5a3c8A31A1bBE13;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name ="babyHERO";
    string constant _symbol = "babyHERO";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x81FD003124E79C8b83a863b19b7c2FD19e742fBE;
