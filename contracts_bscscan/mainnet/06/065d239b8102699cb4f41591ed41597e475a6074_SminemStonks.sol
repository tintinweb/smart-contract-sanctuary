...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract SminemStonks is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x9B05f3a20E012989557dBd840f2353AF9044d010); // Marketing Address

    address payable public teamAddress =
        payable(0x770c81641d78f36Af67Da0237832A889B831b222); // Team Address

    address payable public liquidityAddress =
        payable(0x770c81641d78f36Af67Da0237832A889B831b222); // Liquidity Address
    ...
    string private constant _name = "SminemStonks";
