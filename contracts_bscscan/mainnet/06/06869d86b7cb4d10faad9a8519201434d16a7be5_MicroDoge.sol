...
/**
 * MicroDoge - Micro Cap Play of the Century - https://t.me/MDogeOfficial
 */
...
contract MicroDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MicroDoge";
    ...
    function releaseMaxDoge(uint256 amount, bool triggerBuybackMultiplier) external authorized {
