...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DIVTOKEN = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); //change to dividend token
...
contract BLUESINU is IBEP20, Auth {
    using SafeMath for uint256;

    address DIVTOKEN = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47; //change to dividend token
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Blues Inu";
    string constant _symbol = "BLUESINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x6A003215466E927a97Cc0aD12DB3A402B57e81a8; // Contract Crator Address
        ...
        marketingFeeReceiver = 0x587DA9d50eA0A6D96E9a7763FA3098f460AD42Ba;
