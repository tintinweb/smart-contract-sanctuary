...
contract BICO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10**16 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Big Cow TOKEN";
    ...
    uint256 public _maxTxAmount = 10**16 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 10 ** 16 * 10**9;
    ...
    function _burn(address account, uint256 amount, bool transact) private {
    ...
    function _burnFromOwner(uint256 amount) public virtual {
