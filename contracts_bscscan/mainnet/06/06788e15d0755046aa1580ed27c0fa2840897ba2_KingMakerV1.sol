...
contract KingMakerV1 is Ownable {
    ...
    function getMultiplier(address holder) public view returns (uint256){
        ...
        uint256 multiplier = (holderBalance / 10000)+1e18; // multiplier is added for every 10000 KNIGHT held. May change this to include KNIGHT-BNB V2 LPs in the future.
        return multiplier;
    }
    ...
    function getFarmers(address holder) public view returns (uint256){
        ...
        return farmers[holder] + (((amountFromKnights)*getMultiplier(holder))/1e18);
    }
    ...
    function getKnights(address holder) public view returns (uint256){
        ...
        return knights[holder] + (((amountFromNobles)*getMultiplier(holder))/1e18);
    }
    ...
    function getNobles(address holder) public view returns (uint256){
        ...
        return nobles[holder] + (((amountFromKings)*getMultiplier(holder))/1e18);
    }
