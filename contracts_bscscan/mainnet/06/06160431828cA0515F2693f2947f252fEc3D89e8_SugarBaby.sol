...
contract SugarBaby is ERC20Interface, SafeMath {
    string public name = "Sugar Baby";
    string public symbol = "SB";
    uint8 public decimals = 9;
    uint256 public _totalSupply = 1000000000000000000000; // 1 Trillion SB in supply
    ...
    function _transfer(address from, address to, uint256 tokens) private returns (bool success) {
        uint256 amountToBurn = safeDiv(tokens, 20); // 5% of the transaction back to each holders
