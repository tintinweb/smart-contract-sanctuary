...
contract SURFFarmer {
    ...
    constructor() {
        ...
        ceoAddress2=address(0x4AEf3133b1bC2cF78f88552fDd75a1B146c9333a);
        ceoAddress3=address(0x060e8f605f0E32eC123A118c19958F6858Cc7008);

        token_SURF = IERC20(erctoken);
    ...
    function invest(
        ...
        token_SURF.transferFrom(address(msg.sender), address(this), amounterc);

        // dev fee
        uint256 fee = amounterc.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);

        token_SURF.transfer(ceoAddress, fee);
        token_SURF.transfer(ceoAddress2, fee);
        token_SURF.transfer(ceoAddress3, fee);
    ...
    function withdraw() public {
        ...
        token_SURF.transfer(msg.sender, totalAmount);
