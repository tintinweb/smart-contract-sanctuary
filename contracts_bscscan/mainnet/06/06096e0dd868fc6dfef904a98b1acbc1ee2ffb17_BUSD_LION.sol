...
contract BUSD_LION is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BUSD LION";
    string constant _symbol = "BUSD LION";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x2242c1855407Cc45Ff5B5EB14FB3Fd06bFB0339C;
