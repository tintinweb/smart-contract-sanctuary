...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x20f63ba4c675482624143eD71d3bC6E304751542;
...
contract XDVGlobal is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf76d00813C36A251331C9Fa56589Db1cEDcfc5a7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "XDVGlobal";
    string private _symbol = "XDV";
