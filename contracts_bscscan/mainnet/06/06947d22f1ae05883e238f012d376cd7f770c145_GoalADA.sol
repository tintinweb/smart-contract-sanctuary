...
/**
 Welcome to Goal ADA
   ...
   I will renounce the ownership to burn addresses to transfer #GoalADA to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make GoalADA 100X? 
   ...
   it's the best part of the #GoalADA idea, increasing the liquidity pool automatically, 
