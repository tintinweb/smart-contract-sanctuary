...
/**
    ...
    uint256 private _tTotal = 1000000000000000  * 10**9;    // so hien tai la 1 trieu ty token
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Star Coin";           // sua lai ten cua token
    string private _symbol = "SC";                       // sua lai ky hieu cua token
