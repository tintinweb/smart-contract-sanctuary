...
contract CTP is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 1000000000000000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 0 * 10 ** 9;
    uint256 MAX_LOCK   = 100000000000000 * 10 ** 9;
    ...
    constructor() ERC20("CTP", "CTP") {
        addressForMarketing =address(0x9939f549034C8938E2eAd4d9E417e90EB0dD86A5);
