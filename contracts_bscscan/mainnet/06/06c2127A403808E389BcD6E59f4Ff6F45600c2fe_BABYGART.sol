...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 GART = IBEP20(0xd1ECFDD45c49057479c4Ca95E045855370bC4F5B);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GART.balanceOf(address(this));
        ...
        uint256 amount = GART.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GART.transfer(shareholder, amount);
...
contract BABYGART is IBEP20, Auth {
    using SafeMath for uint256;


    address GART = 0xd1ECFDD45c49057479c4Ca95E045855370bC4F5B;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BABYGART";
    string constant _symbol = "BABYGART";
