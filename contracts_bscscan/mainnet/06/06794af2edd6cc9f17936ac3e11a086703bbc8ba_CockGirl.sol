...
contract Context {
 ...
 contract CockGirl is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private javelinki;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "CockGirl";
    string private _symbol = "COCKGIRL";
    ...
    address private _prostorno = 0xa56991Eb63C55fa0463946ED7fF47Eb3932c945D;
