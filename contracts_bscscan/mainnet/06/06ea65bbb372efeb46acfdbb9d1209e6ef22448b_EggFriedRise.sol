...
contract EggFriedRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x08C12E56e1A7EA73973eEF2707Ef20d2A2AeAf26); // Marketing Address
    ...
    string private _name = "EggFriedRise";
    string private _symbol = "EFRISE";
