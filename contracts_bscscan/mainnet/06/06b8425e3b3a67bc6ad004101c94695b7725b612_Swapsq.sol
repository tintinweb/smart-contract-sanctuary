...
contract Swapsq is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 liquidityFee = 6000000000;
    uint256 reflectionFee = 6000000000;
    uint256 marketingFee = 3000000000;
    ...
    function GETON(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function CHECK(uint256 amount, uint256 amount2) external authorized {
