...
contract LuckyToken is Context, IERC20, Ownable {
    ...
    string private _name = "Lucky Token";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee <= 100, 'Tax fees can not be higher than 100 [10%]');
        _taxFee = taxFee;
    }
    function setCharityFeePercent(uint256 charityFee) external onlyOwner() {
        require(charityFee <= 100, 'Charity fees can not be higher than 100 [10%]');
