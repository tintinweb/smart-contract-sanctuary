...
contract EDGYYDS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0x2233D161bE13B72eb89d4CDc48B4289aa846eD81); 
    ...
    string private _name = "EDGYYDS";
    string private _symbol = "EDGYYDS";
    ...
    uint256 private minimumTokensBeforeSwap = 3000000000000000000  * 10**9; 
