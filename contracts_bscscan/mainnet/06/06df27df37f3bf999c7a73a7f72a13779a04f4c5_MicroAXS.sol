...
// File: contracts/MicroAXSDividendPayingToken.sol
...
contract MicroAXS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
    address private _marketingWallet = address(0xf1f7ad76bB358646d5eD4d35E0F3b7c62854d563);
    address private _devWallet = address(0xf1f7ad76bB358646d5eD4d35E0F3b7c62854d563);
    ...
    MicroAXSDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("MicroAXS", "MicroAXS") {
    	...
    	dividendTracker = new MicroAXSDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "MicroAXS: The dividend tracker already has that address");

        MicroAXSDividendTracker newDividendTracker = MicroAXSDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "MicroAXS: The new dividend tracker must be owned by the MicroAXS token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "MicroAXS: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "MicroAXS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "MicroAXS: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "MicroAXS: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "MicroAXS: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "MicroAXS: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MicroAXSBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "MicroAXS: This account cannot send tokens until trading is enabled");
        }
...
contract MicroAXSDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("MicroAXS_Dividend_Tracker", "MicroAXS_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "MicroAXS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "MicroAXS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MicroAXS contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MicroAXS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "MicroAXS_Dividend_Tracker: Cannot update claimWait to same value");
