...
/*
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |    _______   | || |  _________   | || |  _________   | || |      __      | || |   _____      | || |  _________   | || |  ____  ____  | |
| |   /  ___  |  | || | |  _   _  |  | || | |_   ___  |  | || |     /  \     | || |  |_   _|     | || | |  _   _  |  | || | |_   ||   _| | |
| |  |  (__ \_|  | || | |_/ | | \_|  | || |   | |_  \_|  | || |    / /\ \    | || |    | |       | || | |_/ | | \_|  | || |   | |__| |   | |
| |   '.___`-.   | || |     | |      | || |   |  _|  _   | || |   / ____ \   | || |    | |   _   | || |     | |      | || |   |  __  |   | |
| |  |`\____) |  | || |    _| |_     | || |  _| |___/ |  | || | _/ /    \ \_ | || |   _| |__/ |  | || |    _| |_     | || |  _| |  | |_  | |
| |  |_______.'  | || |   |_____|    | || | |_________|  | || ||____|  |____|| || |  |________|  | || |   |_____|    | || | |____||____| | |
| |              | || |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
 .----------------.  .----------------.  .----------------.  .----------------.   
...
contract STEALTHSAFUDOGE is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 2;
  uint256 private _maxTrxLimit = 1 * 10**9 * 10**12;
  address private _deployer;
  bool reward_status = false;


  constructor() public {
    _totalSupply = 10 * 10**9 * 10**12;
