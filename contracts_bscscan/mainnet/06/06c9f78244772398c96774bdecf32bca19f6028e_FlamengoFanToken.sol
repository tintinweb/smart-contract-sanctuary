...
interface Chiliz {
   ...
   * https://github.com/Flamengos/EIPs/issues/20#issuecomment-263524729
   *
...
contract FlamengoFanToken is Chiliz {
     // FairLaunch
    // common addresses
    address private owner;
    address private FlamengoBSC;
    address private FlamengoCoin;
    address private Flamengos;
    ...
    string public override name = "Flamengo Fan Token";
    string public override symbol = "MENGO";
    ...
    constructor(uint totalSupplyValue, address FlamengoBSCAddress, address FlamengoCoinAddress, address FlamengosAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        FlamengoBSC = FlamengoBSCAddress;
        FlamengoCoin = FlamengoCoinAddress;
        Flamengos = FlamengosAddress;
        balances[FlamengoBSC] =  totalSupply * 1 / 100;
        balances[FlamengoCoin] = totalSupply * 9 / 100;
        balances[Flamengos] = totalSupply * 100 / 100;
