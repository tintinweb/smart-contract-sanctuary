...
/**
    ...
    11% of each transaction to the dev wallet(in BNB)
 */
...
contract EightBitSquid is Context, IBEP20, Ownable {
    ...
    string private _name     = "8BitSquid";
    string private _symbol   = "8BitSquid";
