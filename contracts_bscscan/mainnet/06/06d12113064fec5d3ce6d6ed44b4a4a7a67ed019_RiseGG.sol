...
contract RiseGG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0xE5140f82b61641BCb813fd670037Ac9025A2Ac13); // Marketing Address
    ...
    string private _name = "RiseBOTKILL";
    string private _symbol = "RBK";
