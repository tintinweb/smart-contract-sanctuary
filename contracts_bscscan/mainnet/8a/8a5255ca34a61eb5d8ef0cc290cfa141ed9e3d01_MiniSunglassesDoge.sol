...
contract MiniSunglassesDoge is Context, IERC20, Ownable {
    ...
    string private _name = "MiniSunglassesDoge";
    string private _symbol = "MiniSunglassesDoge";
    ...
    function setMiniSunglassesDogeCharityWallet(address newWallet) external onlyOwner() {
