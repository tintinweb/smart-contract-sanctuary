...
/**
/*
PrincessTest - Presale Launch December 6th 2021
Join our TG: https://t.me/TheRichDoge
...
Sell Tax 20% (first hour)
    🌀 10% Marketing
    🥯 10% Auto Liquidity
    
Tokenomics
    💵 0.50% Max Buy Tx ( 1,000,000 )
    💰 3% Max Bag ( 3,000,000)
    🔃 5 Seconds TX Cooldown ( Buy & Sell )
...
/* Token contract */
contract PrincessTest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3620aDfdCde5C726CBC6938ce7e206CcdD383d9B;
    ...
    // Name and symbol
    string constant _name = "PrincessTest";
    string constant _symbol = "TRD";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 0.20% or 250k tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 5% or 5m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 10000; // 0.1% of supply
