...
// Hold $ForestWolves and get rewarded in BNB on every transaction!
// Telegram: https://t.me/LR168168
// BOTK: https://0.plus/LR168168
...
contract DividendDistributor is IDividendDistributor{
    ...
    function getAccount(address _account)
        ...
        totalDividendss = getCumulativeDividends(shares[account].amount);
...
contract ShenLinToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShenLinToken";
    string constant _symbol = "SLT";
    ...
    uint256 timeBetweenBuy = 2 seconds;
    uint256 timeBeforeFirstBuy = 2 seconds;
