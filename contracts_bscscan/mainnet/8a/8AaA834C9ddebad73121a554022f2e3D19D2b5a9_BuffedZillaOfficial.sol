...
🚀 Welcome to Buffed Zilla Official
$BuffedZilla is a revolutionary, unique, game changing token built on
the Binance Smart Chain. BuffedZilla is a $Shib reflection token that 
...
// _______________________________________
// 🔥__Token Name : BuffedZillaOfficial
// 🔥__Token Symbol : $BUFFEDZilla
// 🔥__Total Supply : 100,000,000,000__
// 🔥__Initial Liquidity : 2 BNB__
// _______________________________________
// **📱Telegram: @BuffedZillaOfficial**
...
contract BuffedZillaOfficial is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BuffedZillaOfficial";
    string constant _symbol = "$BUFFEDZilla";
