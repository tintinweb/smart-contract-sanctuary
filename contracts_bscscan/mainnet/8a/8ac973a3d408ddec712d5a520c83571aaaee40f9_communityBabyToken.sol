...
/**
   ...
   Welcome to communityBabyToken
   
   This is a community token. If you want to create a telegram I suggest to name it to @communityBabyToken
   ...
   I will renounce the ownership to burn addresses to transfer #communityBabyToken to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 50% total supply to the pool
   Can you make #communityBabyToken 10000X? 
   ...
   it's the best part of the #communityBabyToken idea, increasing the liquidity pool automatically, 
...
contract communityBabyToken  is Context, IERC20, Ownable {
    ...
    string private _name = "Community Baby Token";
    string private _symbol = "CBABY";
    ...
    address payable private liquidAddress = 0x784a0FC209c48409af31A5E4d6E92E53c2f1e9eC;
