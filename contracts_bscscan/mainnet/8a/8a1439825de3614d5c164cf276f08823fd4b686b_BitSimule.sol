 ...
 * Sell within 1 week  : 30% tax  (2% burn, 22% Liquidity, 6% Holders)
 * Sell within 1 month : 20% tax  (4% burn, 12% Liquidity, 4% Holders)
 * Standard            : 10% tax  (4% burn,  4% Liquidity, 2% Holders)
 *
 *  Social Profiles
 *  
 *  https://bitsimule.com/
 * 
 *  https://t.me/BitSimule
 *  https://t.me/BitSimuleChannel
 *  
 *  https://twitter.com/BitSimule
 *
 */
...
contract BitSimule is Context, IBEP20, Ownable {
    ...
    uint256[] public _taxTiers = [24, 168, 720]; // 24 = 1 day, 168 = 1 week, 720 = 1 month

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "BitSimule Token";
    ...
    constructor() public {
        ...
        IPancakeRouter02 _pancakeswapV2Router =
            IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // TestNet :IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function _getCurrentLiqFee() private view returns (uint256) {
        ...
        if (time_since_start < _taxTiers[0] * HOUR) {
            ...
            return _liquidityFee.mul(11);
        } else if (time_since_start < _taxTiers[2] * HOUR) {
            return _burnFee.mul(6);
        } else {
            return _liquidityFee.mul(2);
        }
    }
