...
// File: contracts/ShibanceLottery.sol

pragma solidity ^0.8.4;
pragma abicoder v2;

/** @title Shibance Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract ShibanceLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    uint256 public maxPriceTicketInCake = 1000 ether; //Don't use with scheduler that calcs price in USD- susceptible to price volatility
    uint256 public minPriceTicketInCake = 0.001 ether; //Don't use with scheduler that calcs price in USD- susceptible to price volatility
    ...
    uint256 public constant MAX_TREASURY_FEE = 8000; // 80%
