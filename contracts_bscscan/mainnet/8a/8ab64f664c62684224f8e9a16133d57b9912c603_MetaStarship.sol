...
contract MetaStarship is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaStarship";
    string constant _symbol = "MTAS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; //0.5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 5) / 200; // 2%
