...
Welcome to the BabySpiderman Community Group❗️

👉What is BabySpiderman?

The BabySpiderman Marketplace is a NFT platform built on the Binance smart chain, made for social media personalities who want to create digital collectibles of their likeness. BABYSMNFT is a marketplace for social media users to create NFT’s of their items or images and sell them on the platform. 

BabySpiderman NFT Marketplace users are able to add single or multiple items on the market place to sell. Users looking to purchase on the marketplace must also be registered to the BabySpiderman NFT Marketplace

For more information visit the website below ⬇️⬇️⬇️

http://www.babyspiderman.art/

Big announcements soon, Including airdrops, stay tuned❗️

📣Media Links📣
🌍 Website: http://www.babyspiderman.art/
🎉 Twitter: https://twitter.com/BabySM_Group
💎 Telegram : https://t.me/babyspiderman_chat
...
contract BABYSM is Context, BEP20 {
    ...
    string private _name = "Baby Spiderman";
