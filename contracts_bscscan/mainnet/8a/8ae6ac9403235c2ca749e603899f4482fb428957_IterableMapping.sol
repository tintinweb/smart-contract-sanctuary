...
contract MarketingDistributor{
    ...
    address  public  marketingWallet = 0x2D1232a4E1E2F546Be152E96CbA41eEe5E92294f;
    bool public enableLiquify = true;
    address public owner;

    constructor(address _HDKNToken,address _owner){
    ...
    function forceswapAndLiquify(uint256 amount) public  {
            require(msg.sender ==owner,"not authorized");
            address[] memory path = new address[](2);
            path[0] = address(HDKNToken);
            path[1] = address(BUSD);
            HDKNToken.approve(address(uniswapV2Router), amount);
...
contract GamingWorld is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant MAX_SUPPLY = 7777777777777777 * 10**18;
    ...
    uint256 public _busdDividendRewardsFeeBuy = 4;
    uint256 public _marketingFeeBuy = 4;
    uint256 public _LpFeeBuy = 5;

    uint256 public _buyBackAndBurn = 1;


    uint256 public _busdDividendRewardsFeeSell=4;
    uint256 public _LpFeeSell=5;
    ...
    constructor() ERC20("GamingWorldV2", "GWM") {
        	
    	busdDividendToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
        _marketingDistributor = new MarketingDistributor(address(this),msg.sender);
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            tokensForBurn = tokensForBurn.add(burnAmount);
