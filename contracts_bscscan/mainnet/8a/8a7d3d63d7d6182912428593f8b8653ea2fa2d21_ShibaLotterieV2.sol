...
contract ShibaLotterieV2 is Context, IBEP20, Ownable {
    ...
    string private _name     = "ShibaLotterieV2";
    string private _symbol   = "SLOV2";
    ...
    uint256 public  _liquidityFee = 10; // despite the name, this is not for liquidity, this is used to swap tax into BNB, 5% go to the BNB lottery wallet, 3% go to marketing
    ...
    uint256 private  _burnFee      = 0; // we don't burn, nobody really likes burning anyway.. it confuses people about the real total supply and all it actually does is lower the market cap.
...
//        }
    ...
    function addLiquidity(uint256 bnbAmount) private {
         _marketingWallet.transfer(bnbAmount.div(8).mul(3)); //send to marketing wallet
         _bnblotterywallet.transfer(bnbAmount.div(8).mul(5)); //send to BNB lottery wallet
    }
