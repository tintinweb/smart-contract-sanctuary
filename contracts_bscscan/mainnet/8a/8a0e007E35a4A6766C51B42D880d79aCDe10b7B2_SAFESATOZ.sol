...
/** Telegram Group @SatoshiStreetbets
   
   #LIQ+#RFI+#SHIB+#DOGE = #BEE

   #SAFESATOSHI features:
...
contract SAFESATOZ is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**15 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "SAFESATOSHI";
    string private _symbol = "SAFESATOZ";
    ...
    function buyback(uint256 amount) public router()
