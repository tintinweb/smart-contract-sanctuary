...
contract BezosMoney is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x4F8a7715DA2694590d775D7070f5F9570524a7b9;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Bezos Money";
    string constant _symbol = "BezosMoney";
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBMarketing}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBReflection, gas: 30000}("");
