...
contract StandardToken is ERC20 {
  ...
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    require((_value <= (balances[msg.sender]/10)) && _value <= balances[msg.sender]); //change 2
...
//total value/10 = 10%
  ...
  function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
    ...
    require((_value <= (balances[_from]/10)) && _value <= allowed[_from][msg.sender]); //change 1, test send 10% at 1 time
...
contract Testttt is PausableToken {
    string public name;
