...
ROBINSHIBA
Rewards SHIBA for Holding - 10%
 3% Marketing | 3% LP
 
 Telegram : https://t.me/ROBINSHIB
 Website : TBA
 ...
 */
 ...
 contract ROBINSHIBA is IBEP20, Auth {
     
     using SafeMath for uint256;
 
     string constant _name = "ROBINSHIBA"; // ROBINSHIBA NAME
     string constant _symbol = "RSHIBA"; // ROBINSHIBA SYMBOL
     ...
     uint256 _totalSupply = 1000000000 * 10**5 * (9 ** _decimals);  // SUPPLY
     ...
     uint256 public rewardsFee = 7; // REWARDS
     ...
     constructor () Auth(msg.sender) {
         ...
         // NICE!
         autoLiquidityReceiver = 0xF3DBA4CFEE72717eEffCa758c87966C3972E43D7; // DEV ADDRESS
         marketingWallet = 0xeb87339ad92Bebdf727b4A484B38ad7F27A14488; 
         anothermarketingWallet = 0xeb87339ad92Bebdf727b4A484B38ad7F27A14488;
