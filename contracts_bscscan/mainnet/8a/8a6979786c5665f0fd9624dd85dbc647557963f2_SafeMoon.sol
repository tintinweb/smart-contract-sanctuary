...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    address public luck;
    address public dead;
    address public redistribute;
    uint public burnRate;
    uint public redistributeRate;
    ...
    constructor (
        ...
        address _redistributeAddress,
        uint _burnRate,
        uint _redistributeRate
        ) public {
            luck = _token;
            dead = _deadAddress;  
            redistribute = _redistributeAddress;  
            burnRate = _burnRate;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _takeLiquidity(tLiquidity);
        _reflectFee(rFee, tFee);
        IERC20(luck).transfer(dead, tTransferAmount.mul(burnRate).div(100));
        IERC20(luck).transfer(redistribute, tTransferAmount.mul(redistributeRate).div(100));
        emit Transfer(sender, recipient, tTransferAmount);
    }
