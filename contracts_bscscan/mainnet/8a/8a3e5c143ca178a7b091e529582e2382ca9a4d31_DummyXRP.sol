...
contract DummyXRP is IERC20 {
    ...
    string constant _name = "Dummy XRP";
    string constant _symbol = "DXRP";
    ...
    address payable private _marketingWallet = payable(0x1192c6C0B5D2cC2b0d5B07F5BE0CccC9024dC838);
