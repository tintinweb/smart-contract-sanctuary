...
//t.me/shooterfloki
//twitter.com/shooterfloki
//www.shooterflokibsc.com
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BABYFLOKI = IBEP20(0x71E80e96Af604Afc23Ca2AED4C1C7466DB6dd0c4);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BABYFLOKI.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BABYFLOKI);
        ...
        uint256 amount = BABYFLOKI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BABYFLOKI.transfer(shareholder, amount);
...
contract ShooterFloki is IBEP20, Auth {
    using SafeMath for uint256;

    address BABYFLOKI = 0x71E80e96Af604Afc23Ca2AED4C1C7466DB6dd0c4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Shooter Floki";
    string constant _symbol = "SHOOTERFLOKI";
    ...
    function airdrop(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
        require(addresses.length <= 1000, "Addresses list too long");
