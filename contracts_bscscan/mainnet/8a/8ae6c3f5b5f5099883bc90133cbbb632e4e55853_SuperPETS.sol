...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x558bEFd510515FBac7faB874528BA6338db10662;
...
contract SuperPETS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2730f394ca05104f9025d548a37ef8fA6659fA82;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 8000000000 * 10**14;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SuperPETS";
    ...
    uint256 public _maxTxAmount = 8000000000 * 10**14;
    uint256 private numTokensSellToAddToLiquidity = 8000000000 * 10**14;
