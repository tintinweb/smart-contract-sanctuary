...
/**
    The First Token To Reward Holders With 
    CHAINLINK [Binance-PEG ChainLink] Directly To Your Wallet.   
  
    TELEGRAM: https://t.me/BabyMiniLINK
 */
...
contract BabyMiniLINK is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMiniLINK";
    string constant _symbol = "BMLINK";
