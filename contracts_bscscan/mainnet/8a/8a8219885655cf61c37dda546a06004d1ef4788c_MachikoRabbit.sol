...
MachikoRabbit
is a native forked of EverRise. Capsule is a decentralized meme token which is created in bsc ecosystem. MachikoRabbit is a Community driven meme token and It is derived from the animal dbz MachikoRabbit Corp. MachikoRabbit will go somewhere in space by buidling a Strong Community.
...
🖊50% Burn Dead Wallet
🖊1% Dev and Admins Wallet(Will be locked)
🖊 Liquid 0.4 BNB
🖊 Slipage 8% - 15%, FAST buy 49%

NOTE:
Fair launch no presale

TG: https://t.me/MachikoRabbitChat
Twitter : @MachikoRabbit
Coinhunt.cc : https://coinhunt.cc/
Website : https://countingdownto.com/countdown-pages/cEZrOf9y
...
contract MachikoRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "MachikoRabbit";
