...
contract Arrnaya is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arrnaya Finance"; // Change it to your project name
    string private constant _symbol = "ARF"; // change the ticker/tracker
    uint8 private constant _decimals = 9; // If you decide to change it, make to sure to change it all places where you see 10**9
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0xeb24D6cA0Da1D902561036Ed3619c8921D1F49b0; //change it to your wallet address!! Don't blame me later ;) and also remove this comment after making changes
