...
contract FegPay is Context, IBEP20, Ownable {
  ...
  uint256 internal _maxLimitToSell = _totalSupply.div(10000).mul(1);

  address internal _marketingAddress;

  mapping (address => uint256) private _lastBuyTokens;
  string private constant _name = "Feg Pay";
  string private constant _symbol = "FEGPAY";
