...
╚═════╝░░╚════╝░░╚═════╝░╚═════╝░╚═╝░░░░░╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝╚══════╝░░░╚═╝░░░
 ...
 Welcome to DogsFamily
   
   This is a community token with around 2k active follower.

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #DogsFamily to the community, make sure it's 100% safe.

   I will add .15 BNB and all the left 10% total supply to the pool
   We will make this coin to 100x and over 1000x within this month !
   but we need your investment to do this, and we will acchieve this toghether !
...
contract DogsFamily is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "DogsFamily";
    string private _symbol = "DogsFamily";
