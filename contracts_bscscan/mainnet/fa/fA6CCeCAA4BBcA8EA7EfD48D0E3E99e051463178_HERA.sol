...
Will be the main in-game currency. It will be used
to buy items in game, trading, exchanging, staking
to improve the skill and agility of Heroes.

https://twitter.com/HeroArena_Hera
https://heroarena.app/
...
contract HERA is HERC20 {
    ...
    string public override name = "Hero Arena";
    string public override symbol = unicode"HERA™";
    ...
    constructor(uint totalSupplyValue, address GameAddress, address TradingAddress, address MetaAddress) {
        // set total supply
        ...
        balances[Game] =  totalSupply * 2 / 100;
        balances[Trading] = totalSupply * 48 / 100;
