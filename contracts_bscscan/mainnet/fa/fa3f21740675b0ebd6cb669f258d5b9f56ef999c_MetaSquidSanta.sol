...
contract MetaSquidSanta is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10 * 10**6 * 10**9; // 10 Billion
    ...
    uint256 public _maxTxAmount = 10 * 10**6 * 10**9; // Max Transaction: 10 Billion
    uint256 public _numTokensSellToAddToLiquidity = 10 * 10**1 * 10**9;
    uint256 public _maxWalletToken = 10 * 10**6 * 10**9; // Max Wallet: 10 Billion
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'MetaSquidSanta';
