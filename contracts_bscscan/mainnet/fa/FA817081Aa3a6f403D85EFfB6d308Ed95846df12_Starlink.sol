...
contract Starlink is AccessControlled, IDepositable  {
    ...
    uint256 public minFundsBeforePoolDeposit = 100000 wei;
    ...
    function processFunds(uint256 gas) external onlyAdmins {
        ...
        if (fundsPerPool < minFundsBeforePoolDeposit) {
            fundsPerPool = 0;
        }
    ...
    function setMinFundsBeforePoolDeposit(uint256 min) external onlyOwner {
        require(min > 0, "Starlink: Invalid value");
        minFundsBeforePoolDeposit = min;
    }
