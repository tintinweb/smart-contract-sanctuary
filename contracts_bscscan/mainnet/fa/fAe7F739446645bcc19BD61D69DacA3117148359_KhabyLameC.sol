...
contract KhabyLameC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0001bEdCd7B811630f3AD9d0A941dCE8dD3441f6); // Marketing Address
    ...
    string private _name = "KhabyLameC";
    string private _symbol = "KhabyLameC";
