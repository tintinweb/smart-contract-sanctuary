...
// File: contracts/BabyBTCDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSDToken = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
contract BabyBTC is ERC20, Ownable {
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BabyBTC: The liquidity wallet is already this address");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "BabyBTC: This account cannot send tokens until trading is enabled");
        }
...
contract BabyBTCDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BabyBTC_Dividend_Tracker", "BabyBTC_Dividend_Tracker") {
    	claimWait = 1800;
