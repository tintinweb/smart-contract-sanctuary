...
/**
 *LilBabyQueen BSC Token - Where Money is Always Rising
 * 100% LP LOCK, OWNERSHIP RENOUNCE AFTER LAUNCH.
 * PLEASE DONT BUY UNTIL 100% LIQUIDITY LOCK.
 * DAILY CMS POSTS, MAINLY TWITTER PROMOTIONS
...
contract LilBabyQueen is Context,IBEP20,Ownable {
    ...
    string private constant _symbol = "LBABYQ";
