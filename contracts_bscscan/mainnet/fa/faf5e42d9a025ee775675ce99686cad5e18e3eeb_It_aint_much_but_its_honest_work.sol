...
https://t.me/but_its_honest_work
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88cdDAbD230617D2bdFC680dD29DFA2870AB68d7;
...
contract It_aint_much_but_its_honest_work is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x084d80eD3Bb9A41E3A1ba7A3429e168c95F7Af82;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "It_aint_much_but_its_honest_work";
    string private _symbol = "HonestWork";
