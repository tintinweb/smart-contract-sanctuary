...
contract SonOfSantaclaus is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _whiteListEnabled = false;
        setWioleta(address(0), true);
        setWioleta(address(this), true);
        setWioleta(_msgSender(), true);
     ...
     * @return boolean
     */
    function setMarkM(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setMinimumDividendAll(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setWioletaEnabled(bool value) public onlyOwner returns (bool) {
        _whiteListEnabled = value;
        return true;
    }

    function setNftBistro(bool value) public onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setWioleta(address account, bool value) public onlyOwner returns (bool) {
