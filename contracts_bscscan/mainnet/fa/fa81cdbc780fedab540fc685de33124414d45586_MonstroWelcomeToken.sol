...
// Root file: contracts/WelcomeToken.sol

pragma solidity ^0.8.4;

// @title WelcomeToken
//
// Website: https://monstro.fun
// Twitter: https://twitter.com/monstro_dropper
//
contract MonstroWelcomeToken is  ERC721Enumerable, Ownable {

    string public message;

    constructor(string memory _message)
        ERC721("Welcome INO ticket from Monstro", "ticketMONSTRO")
    {
        message = _message;
    }
