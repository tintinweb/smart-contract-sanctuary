...
import "./BabyXrpToken-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyXrpToken` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyXrpToken(Env.Testnet)` or `BabyXrpToken(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyXrpToken";
    string internal constant SYMBOL = "BXT";
     ...
     */
    address internal tipToTheDev =0x385BAFABbe87aEe7BA6c3fA6ae8cf4CffC716749;
...
contract BabyXrpToken is SafeToken{
