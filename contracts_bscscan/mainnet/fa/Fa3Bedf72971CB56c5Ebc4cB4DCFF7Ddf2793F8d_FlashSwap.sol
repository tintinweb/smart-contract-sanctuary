...
contract FlashSwap {
    ...
    function pancakeCall(
        ...
        //require(msg.sender == UniswapV2Library.pairFor(pancakeFactory, token0, token1), "R1");
        require(_amount0 == 0 || _amount1 == 0, "R2");
        ...
        require(amountReceived > amountRequired, "R3"); // fail if we didn't get enough tokens
