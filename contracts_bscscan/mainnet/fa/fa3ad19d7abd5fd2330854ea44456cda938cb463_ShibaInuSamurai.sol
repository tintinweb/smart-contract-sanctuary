...
ShibaInuSamurai is a Community Driven Meme Token. 

https://t.me/SuperMiniFloki
...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/su/per/mi/ni/flo/ki/pull/522
        if (a == 0) {
            return 0;
        }
...
contract ShibaInuSamurai is IERC20 {
    ...
    string constant _name = "ShibaInuSamurai";
    string constant _symbol = "SIS";
    ...
    uint256 public _sellReflectionFee = 700;
    uint256 public _sellLiquidityFee = 100;
    uint256 public _sellMarketingFee = 1000;

    uint256 constant public maxReflectionFee = 1000;
    uint256 constant public maxLiquidityFee = 700;
    uint256 constant public maxMarketingFee = 1200;
    ...
    address payable private _marketingWallet = payable(0xd9b0b2868672AbaC562aB3b197A34e6057501b8c);
...
//===============================================================================================================
    ...
    function setStartingProtections(uint8 _block, uint256 _gas, address initializer) external onlyOwner{
        require (snipeBlockAmt == 0 && gasPriceLimit == 0 && !_hasLiqBeenAdded && init == false);
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (address(reflector) == address(0)) { revert(); }
        if (gasLimitActive) {
