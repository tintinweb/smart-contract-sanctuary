...
/**
 * Can you catch the duck cake? Buy and HODL to be rewarded in CAKE tokens.
 * Each transactions get trasnformed into cake for dividend token holders.
 */
...
contract DuckCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DuckCakeDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x6359644c3448c23A3cab01759284cB286770fEA1;
    ...
    constructor() public ERC20("DuckCake", "DUCK") {

    dividendTracker = new DuckCakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        DuckCakeDividendTracker newDividendTracker = DuckCakeDividendTracker(payable(newAddress));
...
contract DuckCakeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("DuckCake_Dividend_Tracker", "DuckCake_Dividend_Tracker") {
    claimWait = 3600;
