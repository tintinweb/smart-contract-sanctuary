...
BABY APE REBORN
   ...
   This is a community token. Telegrams @BABY APE REBORN  Important: The early you create a group that shares the token, the more gain you got.
...
🔥TOTAL SUPPLY 1,000,000,000,000,000 BAPE
🔥BURN SUPPLY 90% BAPE
🔥NO DEV TOKEN
   ...
   I will renounce the ownership #BAPE to the community, make sure it's 100% safe.

   I will add .5 BNB.
   Can you make #BAPE 10,000 X? 
   ...
   it's the best part of the #BABY APE REBORN idea, increasing the liquidity pool automatically, 
...
contract BABY_APE_REBORN is Context, IERC20, Ownable {
    ...
    string private _name = "BABY APE REBORN";
