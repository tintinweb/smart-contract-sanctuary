...
contract Context {
 ...
 contract ManPan is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private ludiadrum;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "ManPan";
    string private _symbol = "MANPAN";
    ...
    address private _shesnimamatko = 0x022467c23b5287bE0185C868C9B5eB6EF23F5461;
