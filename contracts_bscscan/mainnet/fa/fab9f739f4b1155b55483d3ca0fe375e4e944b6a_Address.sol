...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2d80348905747Fc850058bA58493A088D533AA21;
...
contract BSC_BABYKITTY is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x2d80348905747Fc850058bA58493A088D533AA21);
    ...
    */
    ...
    string private _name = "ChinaNiuBi"; 
    string private _symbol = "ChinaNiuBi";  
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        uint256 tTransferAmount; uint256 tDev;
        if(!_isExcludedFromFee[sender]){
            (tTransferAmount, tDev) = _getValues(tAmount);
