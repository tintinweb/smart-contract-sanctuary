...
contract Hash256 is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0x0591687405a3EEa3205B9ec9086E9aA3bcdA0F4e; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    ...
    string constant _name = "Hash256";
    string constant _symbol = "Hash256";
