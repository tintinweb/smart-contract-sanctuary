...
DogeCakes is a reflection token on the Binance Smart Chain (BSC).

DogeCakes brings passive income for all holders.
Simply hold $DogeCakesmtokens and get rewarded
in $Doge as well as $Cake on every transaction!

With the auto-reward feature,
you’ll receive both $Doge and
$Cake automatically into your wallet every 60 minutes. 

• 2% towards liquidity
 • 4.5% towards $CAKE rewards
 • 4.5% towards $DOGE rewards
 • 7% towards marketing

Website : www.dogecakestoken.com
Telegram : https://t.me/dogecakestoken
*/
...
contract DogeCakes is Context, IBEP20, Ownable {
    ...
    string private _name = "DogeCakes";
    string private _symbol = "DOKES";
