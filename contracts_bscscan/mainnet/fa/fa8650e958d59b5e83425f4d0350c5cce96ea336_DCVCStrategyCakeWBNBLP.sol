...
// File: contracts/DCVC/interfaces/common/IUniswapRouterETH.sol
...
// File: contracts/DCVC/interfaces/common/IUniswapV2Pair.sol
...
// File: contracts/DCVC/interfaces/pancake/IMasterChef.sol
...
// File: contracts/DCVC/utils/IGasPrice.sol
...
// File: contracts/DCVC/utils/GasThrottler.sol
...
// File: contracts/DCVC/strategies/Common/StratManager.sol
...
contract StratManager is Ownable, Pausable {
    ...
    address public DcvcFeeRecipient;
     ...
     * @param _DcvcFeeRecipient address where to send DCVC's fees.
     */
    constructor(
        address _keeper,
        address _strategist,
        address _unirouter,
        address _vault,
        address _DcvcFeeRecipient
    ) public {
        keeper = _keeper;
        strategist = _strategist;
        unirouter = _unirouter;
        vault = _vault;
        DcvcFeeRecipient = _DcvcFeeRecipient;
    }
    ...
    /**
     * @dev Updates DCVC fee recipient.
     * @param _DcvcFeeRecipient new DCVC fee recipient address.
     */
    function setDcvcFeeRecipient(address _DcvcFeeRecipient) external onlyOwner {
        DcvcFeeRecipient = _DcvcFeeRecipient;
    }
...
// File: contracts/DCVC/strategies/Common/FeeManager.sol
...
abstract contract FeeManager is StratManager {
    ...
    uint public DcvcFee = MAX_FEE - STRATEGIST_FEE - callFee;

    function setCallFee(uint256 _fee) external onlyManager {
        require(_fee <= MAX_CALL_FEE, "!cap");
        callFee = _fee;
        DcvcFee = MAX_FEE - STRATEGIST_FEE - callFee;
    }
}

// File: contracts/DCVC/strategies/Cake/StrategyCakeLP.sol


pragma solidity ^0.6.0;

contract DCVCStrategyCakeWBNBLP is StratManager, FeeManager, GasThrottler {
    ...
    constructor(
        ...
        address _strategist,
        address _DcvcFeeRecipient
    ) StratManager(_keeper, _strategist, _unirouter, _vault, _DcvcFeeRecipient) public {
        want = _want;
    ...
    function chargeFees() internal {
        ...
        uint256 DcvcFeeAmount = wbnbBal.mul(DcvcFee).div(MAX_FEE);
        IERC20(wbnb).safeTransfer(DcvcFeeRecipient, DcvcFeeAmount);
