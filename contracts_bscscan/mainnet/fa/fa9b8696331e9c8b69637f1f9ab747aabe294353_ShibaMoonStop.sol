...
// made by https://t.me/ShibaMoonStop
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ADA = IERC20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract ShibaMoonStop  is IERC20, Ownable {
    ...
    string constant _symbol = "ShibaMoon";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 20) / 1000; // 0.3% MAX 30,000
    uint256 public _maxWalletSize = (_totalSupply * 50) / 1000; // 1.5% MAX 150,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xB4617Aa46f0B3AF6bDC420eB84F75ad49149b3F3);
