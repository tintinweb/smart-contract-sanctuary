...
contract DEPLOY is Context, IERC20, Ownable {
    ...
    //    payable(0xEd8286739df5d0AB1C53A54113dB4e03035e287D); // Marketing Address
    // address payable public BuyBackWalletAddress =
    // payable(0xDc73D54974946F9a0E52391c37A938e14eA80084); // BuyBack Address
    ...
    constructor() {
        ...
        isWalletLimitExempt[
            payable(0xEd8286739df5d0AB1C53A54113dB4e03035e287D)
        ] = true;
        isWalletLimitExempt[
            payable(0xDc73D54974946F9a0E52391c37A938e14eA80084)
        ] = true;
