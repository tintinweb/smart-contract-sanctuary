...
/**
    ...
    %5 per transactions tax features:
    Holders reflection 1%
    Auto LP 2%
    Auto burn 1%
    Marketing = 1%
*/
...
contract Spurdex is Context, IBEP20, Ownable {
    ...
    address payable public _marketingWallet = payable(0x89351CCa7e1f0036954ce7e3a881Db301F028925); // Marketing Address
    ...
    string private constant _name     = "Spurdex Token";
    string private constant _symbol   = "SPDX";
    uint8  private constant _decimals = 9;
    
    uint256 public  _taxFee       = 1; // holders tax
    uint256 public  _liquidityFee = 2; // auto lp
    uint256 public  _marketingFee  = 1; // Marketing wallet
