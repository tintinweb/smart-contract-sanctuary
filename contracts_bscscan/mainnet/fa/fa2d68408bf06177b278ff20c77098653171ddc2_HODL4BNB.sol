...
contract HODL4BNB is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "HODL4BNB";
    string private _symbol = "HODL4BNB";
    ...
    uint256 public _maxSellTransactionAmount = 5 * 10**13 * 10**9; // can't sell more than this
    uint256 public _maxWalletToken =  5 * 10**13 * 10**9; // can't buy or accumulate more than this
    ...
    bool public swapAndLiquifyEnabled = false; // Toggle swap & liquify on and off
