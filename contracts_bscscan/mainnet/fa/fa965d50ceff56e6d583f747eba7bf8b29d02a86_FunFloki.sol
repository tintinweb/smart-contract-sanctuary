...
contract FunFloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FunFloki", "FFLOKI ") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setPercentagerewards(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
        


        function set_enablemarketing(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function set_enableLiquidity_fee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function set_percentage_Buy(uint256 value) external onlyOwner{
            buyFee = value;
        }
