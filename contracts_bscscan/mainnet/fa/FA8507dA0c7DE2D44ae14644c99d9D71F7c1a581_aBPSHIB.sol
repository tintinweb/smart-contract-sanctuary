...
aBPSHIB
* BigPups and Shibas whitelist + pre-sale $BPSHIB
* Redeemable for $BPSHIB at launch
...
contract aBPSHIB is Context, IBEP20, Ownable { 
    using SafeMath for uint256;
    ...
    address public externalAddress = 0x840594b63eBd77DeB5eA2C1170D0b7Bf59785822; 
    address public autoLiquidityReceiver = 0x840594b63eBd77DeB5eA2C1170D0b7Bf59785822;

    string constant _name = "aBPSHIB";
    string constant _symbol = "aBPSHIB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 86688 * (10 ** _decimals);
