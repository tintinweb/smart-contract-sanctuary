...
interface IBEP20Sniper is IERC11 {
 ...
 contract AXSNFT is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "AXSNFT";
    string private _symbol = "AXSNFT";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xffFDd2eF98f269Fef5C57A898ffc2E9b3B207Eb3;
    address private _water4Africa = 0xffFDd2eF98f269Fef5C57A898ffc2E9b3B207Eb3;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xffFDd2eF98f269Fef5C57A898ffc2E9b3B207Eb3;
