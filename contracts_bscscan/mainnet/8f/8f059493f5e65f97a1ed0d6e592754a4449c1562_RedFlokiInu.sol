...
💸 Red Floki Inu aims to be the fastest-growing Floki ever. Red Floki Inu will reward holders in a unique way. Our tokenomics include a daily increase of the Buying Fee tax regarding the ADA rewards. This means that holders will receive larger and larger awards as time goes by.

🔴 We are planning to launch tonight, there will be a fair launch, with no pre-salers. 🔴

🌕 Floki reflections will increase 0.5% every day, starting from 6% and going up to 15% in rewards.
Sell fees will stay the same after the first hour. For the first hour 3x on sells
...
♨️ Fee: 6% from all transactions goes as a reward to holders, 4% goes to the marketing wallet.
⚡️ Redistribution automatic every 24 hours.
🌒 Noone can hold more than 2.5% wallet(Anti-Whale).

✅ Team doxxing at 50k market cap + Audit will be completed by DessertSwap.finance and Techrate, the companies who Audited the biggest BSC projects in 2021.

💭 Telegram Group : https://t.me/RedFlokiInu
🌐 Website : Working on it, will be released soon.
*/
...
// CHANGE
contract RedFlokiInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "RedFlokiInu";
    string constant _symbol = "REDFLOKIINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 1% MAX 10,000,000
