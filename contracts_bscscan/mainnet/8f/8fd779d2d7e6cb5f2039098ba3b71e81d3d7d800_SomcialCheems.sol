...
/**
https://t.me/somcialcheems
https://somcialcheems.webador.es
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract SomcialCheems is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xd9f3a56Aa0C199dB59A76968b97EfbBcd71fD50f); // Marketing Address

    address payable public teamAddress =
        payable(0xa5B5fe2Cbe3Ca240B1e87e988c752a1a7860169a); // Team Address

    address payable public liquidityAddress =
        payable(0xAab4DC68Adeb2Bb577a272C7858e071cce20065e); // Liquidity Address
    ...
    string private constant _name = "SomcialCheems";
    string private constant _symbol = "$SomcialCheems";
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 30 / 1000; // 5% maxWalletToken
