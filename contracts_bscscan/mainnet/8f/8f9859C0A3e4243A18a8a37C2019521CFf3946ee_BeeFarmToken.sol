...
// File: contracts/BeeFarmToken.sol
...
contract BeeFarmToken is BEP20("BeeFarm Token", "BEE") {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "BEE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BEE::delegateBySig: invalid nonce");
        require(now <= expiry, "BEE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "BEE::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BEEs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "BEE::_writeCheckpoint: block number exceeds 32 bits");
