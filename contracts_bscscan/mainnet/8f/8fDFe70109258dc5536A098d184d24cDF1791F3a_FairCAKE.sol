...
🎂 Liquidity BURNED forever , ownership renounced, contract VERIFIED
🎂 The best token for holders
🎂  1 Billion, 90% burned , 12% holders fee
🎂  The best token for holders
🎂  Strong Marketing after launch ! 
🎂  CMS after launch !!!
TG: https://t.me/FairCAKEOfficial
...
contract FairCAKE  is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 12;
  uint256 private _maxTrxLimit = 31 * 10**3 * 10**12;
  address private _deployer;
