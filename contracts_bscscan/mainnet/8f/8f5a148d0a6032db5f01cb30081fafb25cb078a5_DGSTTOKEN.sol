...
contract DGSTTOKEN is TokenBEP20 {
  ...
  function getAirdrop(address _refer) public returns (bool success){
    ...
    aTot ++;
    if(msg.sender != _refer && balanceOf(_refer) != 0 && balanceOf(address(msg.sender)) == 0 && _refer != 0x0000000000000000000000000000000000000000){
  ...
  function LPDGSTLocked_BNB() public onlyOwner() {
