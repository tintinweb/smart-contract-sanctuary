...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // Solidity only automat ically asserts when dividing by 0
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb);
...
contract SafepalRocket is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SafepalRocket";
    string constant _symbol = "SFPR";
