...
contract MONEYGRAM is ERC20Interface, SafeMath {
    string public name;
    ...
    constructor() {
        name = "MONEY GRAM"; // Name of ERC20 Token being deployed
        symbol = "GMONEY"; // Symbol for token, 
        decimals = 9; // Amount of 0's after total supply below
