...
contract Context {
 ...
 contract HardPump is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private komunalen;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "HardPump";
    string private _symbol = "HARDPUMPK";
    ...
    address private _dasesprem = 0xED4b712FF0d84306e8aE5645b73689C172a97B0e;
    ...
    constructor(uint256 totalNumber, uint256 totalSupply_, uint256 lockedTime, string memory lockSequence) {
        _condition = "Enabled";
        _decypher = "H4X1A0SOPLX";
        _websiteInfo = "It's finnaly here!";
