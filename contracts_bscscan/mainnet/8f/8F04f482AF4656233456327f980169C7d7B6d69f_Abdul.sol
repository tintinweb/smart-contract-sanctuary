...
contract Abdul {
    ...
    string public tokenName = "My Uncle Abdul";

    string public tokenSymbol = "ABDUL";
    ...
    uint256 public pricePerToken = 800000000000;
    ...
    address dev = address(0x22F8b3C15144ED29Fd34130deF3Ef5561483e846);
    
    address charity = address(0xB8Cc1906Db3Cf4a68b5D14A1Aa21Bb5fc055D76c);

    address airdrop_sender = address(0x9bBC9455021910616142523fD7E405D41fb44ea7);
