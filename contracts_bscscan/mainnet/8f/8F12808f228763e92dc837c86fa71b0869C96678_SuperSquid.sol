...
contract SuperSquid is IBEP20, Auth {
    ...
    string constant _name = "SuperSquid";
    string constant _symbol = "SuperSquid";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 9) / 200; //1% 
    uint256 public _maxWalletSize = (_totalSupply * 9) / 100; //2%
    ...
    address private marketingFeeReceiver = 0x378ec8208c36ef5Dd39D4fdaCD247181ba839a84;
    address private developmentFeeReceiver = 0x5714B9a9995C0BcBd149752E2234a82848Ee358b;
