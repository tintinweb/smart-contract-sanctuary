...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public openOceanRouter = 0xBeB43fbb2f7AEA8AC904975816BB1b4cA9f4D9c5;
    ...
    function earn() public virtual nonReentrant whenNotPaused {
        ...
        if (token0Amt > 0 && token1Amt > 0) {
           ...
           (uint amountA, uint amountB, uint liquidity) = IPancakeRouter02(openOceanRouter).addLiquidity(
                token0Address,
                token1Address,
                token0Amt,
                token1Amt,
...
contract StratXOpenocean is StratX2 {
   constructor(
