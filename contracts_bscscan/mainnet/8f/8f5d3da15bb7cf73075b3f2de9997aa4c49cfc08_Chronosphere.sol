...
contract Chronosphere is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Chronosphere";                                          // name
    string private _symbol = "Sphere";                                             // symbol
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "Sphere is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "Sphere is not live yet");
