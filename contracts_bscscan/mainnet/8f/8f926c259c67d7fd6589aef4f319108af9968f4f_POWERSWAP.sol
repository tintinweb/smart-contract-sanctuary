...
interface IBEP20 {
  ...
  /**
   * @dev POWERCHAIN `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev POWERCHAIN `amount` tokens from `sender` to `recipient` using the
...
contract POWERCHAIN  is Context {
...
contract POWERSWAP is IBEP20, Context, POWERCHAIN  {
  
    // common addresses
    address private _owner;
    address private POWERCHAINxx;
    address private POWERCHAINX;
    ...
    string public override name = "POWER SWAP";
    string public override symbol = "POWER SWAP";
    ...
    constructor(uint totalSupplyValue, address POWERCHAINxxAddress, address POWERCHAINXAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        POWERCHAINxx = POWERCHAINxxAddress;
        POWERCHAINX = POWERCHAINXAddress;
        
        // split the tokens according to agreed upon percentages
        balances[POWERCHAINxx] =  totalSupply * 45 / 100;
        balances[POWERCHAINX] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's POWERCHAIN pot
