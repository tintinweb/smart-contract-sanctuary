...
contract shiq is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHIQ";
  

    uint256 public _taxFee = 100000; // will change according to sell or buy function
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 1000000; // will change according to sell or buy function
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _buyLiquidityFee = 1000000; // %
    uint256 public _buyTaxFee = 100000; // 1%
    uint256 public _sellLiquidityFee = 1000000;
    ...
    uint256 public _marketingFee = 60; // % of liquidityFee
    uint256 public _buybackFee = 20; // % of liquidityFee
    uint256 public _liqFee = 20; // % of liquidityFee
    ...
    uint256 private minTokensBeforeSwap = 100000000 * 10**_decimals; // 1m, 0.01%
