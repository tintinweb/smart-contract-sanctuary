...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable dividendsToken = address(0xAe9269f27437f0fcBC232d39Ec814844a51d6b8f); // BSC-Pegged token
...
contract BurgerBaby is ERC20, Ownable {
    ...
    address payable public marketingAddress1 = 0x7b7BBD0dB3E7AfBA954C830Fc8Ebd233580A9497;
    address payable public marketingAddress2 = 0x47a88fE358Ce7a9B0814e12729b6FFC8b83Ed25c;
    address payable public developmentAddress = 0xd5F24409248228aebFa0155d345FDB3FA482951F;
    ...
    address public uniswapV2RouterAddress = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;
    ...
    constructor() public ERC20("Burger Baby", "BuBa") {
   ...
   function getCurrentPrice() public view returns (uint256 currentPrice) {//This value serves as a reference to calculate profit only.
    ...
    function swapTokensForMarketing(uint256 tokenAmount) private {
        ...
        marketingAddress2.transfer(address(this).balance/2);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xfaa57F68A03ab8B217701835b91B1AD831363A9d),
            block.timestamp
        );
