...
// $SINU2 | Stealth Inu v2
// Telegram: https://t.me/StealthInu

// Originally Fair Launched, redeployed due to contract bug.

// Supply re-scaled to 1Q tokens, converted to deflationary.
// Holders airdropped with 50% supply (scaled to liquidity), 40% LP, 10% Black hole.
...
contract StealthInu is Context, IERC20, Ownable {
    ...
    string private _name = 'Stealth Inu V2 | t.me/StealthInu';
    ...
    function initContract() external onlyOwner() {
        ...
        _teamDevAddress = payable(0x9b535dABEE8030CFeCe8EDE6eEBCb1654ec21A76);
    }
