...
import "./mock/BasicToken.sol";

contract LaunchpadRef is Ownable, AccessControl, ReferralManager {
    using SafeMath for uint256;
    BasicToken public tokenA;
    BasicToken public tokenB;
    uint256 public rate = 833; //div by 1000
    ...
    constructor(
        ...
        tokenA = BasicToken(_tokenA);
        tokenB = BasicToken(_tokenB);
    ...
    function swap(uint256 _amount) public {
        ...
        uint256 _totalFeeAmount = transferReferralFee(tokenA, _amount);
        require(tokenA.transferFrom(msg.sender, address(this), _amount.sub(_totalFeeAmount)), "transfer failed");
        tokenB.mint(msg.sender, _payback);
    }
...
contract ReferralManager is Ownable, AccessControl {
        ...
        returns (uint256 totalFeeAmount)
    {
        ...
        for (uint256 i = 0; i < LEVEL; i++) {
            ...
            _token.safeTransferFrom(msg.sender, _referral, _feeAmount);
