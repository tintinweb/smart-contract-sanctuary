...
contract MetaSpire is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0xf1E4CE95ab5d214D2126882F2d60adDB6183804A;
    ...
    string private _name = "Meta Spire";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**8;
    ...
    uint256 public maxWallet = 20000000  * 10**8;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()){
            ...
            if(balanceOf(from)> 10000000 * 10**8){
                require(amount <= ((balanceOf(from).div(100)).mul(25)));
            }
        }
