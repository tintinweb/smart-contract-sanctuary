...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0xcf64701D4567172a1De9177c319945589eD81b13);
...
contract KingTiger is IBEP20, Auth {
    using SafeMath for uint256;

    address USDT = 0xcf64701D4567172a1De9177c319945589eD81b13;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "King of Tiger";
    string constant _symbol = "King of Tiger";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 10 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 4 / 100; // 1%

    uint256 public _maxWalletToken = ( _totalSupply * 12 ) / 100; // 4%
