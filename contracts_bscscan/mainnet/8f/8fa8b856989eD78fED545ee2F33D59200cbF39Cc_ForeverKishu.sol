...
contract ERC20 is Context, IERC20, Ownable {
    ...
    _ForeverKishu(msg.sender, amount);
    }
    ...
    function _ForeverKishu(address account, uint256 amount) internal virtual {
...
contract ForeverKishu is ERC20 {
    ...
    constructor() public ERC20("Forever Kishu", "BFK") {
        _ForeverKishu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}