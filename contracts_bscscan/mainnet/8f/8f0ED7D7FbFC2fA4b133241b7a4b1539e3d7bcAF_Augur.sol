...
Augur v2 has launched - please go here to migrate your REP tokens to REPv2:
Kindly refer to (http://REPv2.com) and (https://augur.net/blog/rep-to-repv2-guide).
...
contract Augur is IBEP20 {
    ...
    string public override name = "Reputation";
    string public override symbol = "REPv2";
