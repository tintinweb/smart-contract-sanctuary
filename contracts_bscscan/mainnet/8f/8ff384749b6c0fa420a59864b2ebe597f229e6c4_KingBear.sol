...
contract KingBear is Context, IBEP20, Ownable {
    ...
    string public constant name     = "King Bear";
    ...
    // buy fee
    uint256 public _taxFeeBuy       = 600; 
    uint256 public _liquidityFeeBuy = 600; 
    uint256 public _marketingFeeBuy = 600; 

    // sell fee
    uint256 public _taxFeeSell       = 900; 
    uint256 public _liquidityFeeSell = 900; 
    uint256 public _marketingFeeSell = 900; 
