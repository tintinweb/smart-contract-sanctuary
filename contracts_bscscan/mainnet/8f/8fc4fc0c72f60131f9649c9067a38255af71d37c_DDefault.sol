...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Cheems Gecko";
    string private _symbol = "CGecko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12Fd6D992375846748677476272FbfE6aCD7501C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4aAa13058bfE3Ef6e9eF8544d476DB831C15B367); // BuyBack Address
