...
/**     
 ...
 - Supply:            1 token (9 decimals)
 - Max wallet:        0.05 token
 - Max TX:            0.01 token
 - Sell cooldown:     120 seconds
 - Buy cooldown:      60 seconds
 - Fees:              2% reflections // 10% liquidity
...
contract justonetoken1 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    // Token name
    string private _name = "JUST ONE";
    string private _symbol = "JUST1";
    ...
    uint256 private _tTotal = 1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    // Max TX in tokens
    uint256 public _maxSellTxAmount = 0.01 * 10**9;
    uint256 public _maxBuyTxAmount = 0.01 * 10**9;

    // Max Wallet in tokens
    uint256 private _maxWalletSize = 0.05 * 10**9;
    ...
    */
    ...
    // Resets the the sell lock for the address calling it
