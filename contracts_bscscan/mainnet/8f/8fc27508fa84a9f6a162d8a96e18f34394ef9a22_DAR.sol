...
Welcome to Mines Of Dalarnia (DAR)
Official Contract Of The Binance Smart Chain
LaunchPool Farming 
...
contract DAR is Context, IERC20, Ownable {	
    ...
    string private constant _name = "Mine Of Dalarnia";	
    string private constant _symbol = "DAR";	
