...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x098927096fECdb7e2524E0a04ffDD4cE3eA945E2;
...
contract TeamSeas is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x098927096fECdb7e2524E0a04ffDD4cE3eA945E2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TeamSeas";
    string private _symbol = "TeamSeas";
