...
contract Orbit is ERC20, Ownable {
    ...
    constructor() ERC20("Andromeda", "M31") {
        ...
        // 9% buy tax to start, will be reduced over time.

        uint256 _buyMarketingFee = 80;
        uint256 _buyLiquidityFee = 10;
        uint256 _buyBuyBackFee = 0;

        // 9% sell tax to start, will be reduced over time.
        ...
        blackListFee = 99; // 99% tax for blocks(0,1,2,3)
    ...
    function _transfer(
        ...
        uint256 fees = 0;
        // only take fees on buys/sells of sniper bots, do not take on wallet transfers
        if(takeFee){
