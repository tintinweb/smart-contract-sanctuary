...
contract LamboShib is Context, IERC20, Ownable {
    using SafeMath for uint256;
 
    string private constant _name = "Lambo Shib";
    ...
    uint256 public minimumContractBalanceToSwap = 600000000 * 10**9;   // 0.06% of total supply for both LQ and ETH distribution
