...
TrendTools™ ~ fair launch 8PM UTC (1 hour)

TRTLS Tokenomics
Token Tax:
   4% Liquidity tax
   3% Marketing/development tax

Token Supply:
500,000,000,000  Total Supply
 10,000,000,000  Max TX/Wallet

Socials & Info
Website 👉 www.TrendTools.app
Twitter  👉 twitter.com/TrendToolsTM
Telegram 👉 t.me/TrendTools
...
contract TrendTools is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TrendTools';
    string private constant _symbol = '$TRTLS';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 500000000000 * 10**_decimals;//equals 500B tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0xaB8F5869b95f9Fc845C64A27B3fbe10Dd3eCD2d1);
    address public walletTwo=payable(0xD6293DAd9D6624cB6c9A8E7EF614eaAaBcfd5Bea);
    //TestNet
	...
	uint256 private antiWhale = 10000000000 * 10**_decimals;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimXRP(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    function claimXRP(address addr) private{
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 2000000000 * 10**_decimals;
