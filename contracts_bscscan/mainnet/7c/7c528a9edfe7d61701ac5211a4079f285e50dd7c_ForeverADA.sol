...
* ForeverADA - Stealth launch
* Telegram: https://t.me/TheForeverADA
...
// CHANGE
contract ForeverADA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ForeverADA";
    string constant _symbol = "ForeverADA";
    ...
    uint256 public swapThreshold = _totalSupply / 150; // 8M swap
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4300Ec6957bbb3a4A2C45bE9dfEB47167fE16C4D);
