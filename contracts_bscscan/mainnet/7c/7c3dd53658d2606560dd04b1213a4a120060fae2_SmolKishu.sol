...
SMOLKISHU ~ MiniKishu fork 

DOXED DEV 

STEALTH LAUNCH 

Initial Supply: 500 Billion tokens
Max Wallet: 10M (2%)
Max TX: 10B (2%) 
...
https://t.me/smolkishu
https://twitter.com/smolkishu
...
contract SmolKishu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SmolKishu';
    string private constant _symbol = '$SMOLKISHU';
    ...
    //DevWallets
    address public TeamWallet=payable(0xbB9D98668cFBb43E54F99D9C9ce21FB919926542);
    address public walletTwo=payable(0xfbCDe6566B4af1FbbF1966d0e1412dBde049F9e6);
    //TestNet
