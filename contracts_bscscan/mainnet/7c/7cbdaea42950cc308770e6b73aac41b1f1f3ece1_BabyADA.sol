...
//EarnADA fork
//Buys: 25% tax (21% ADA staking, 4% liquidity)(First hour buys get 30% tax)
//Sells: 30% tax (25% ADA staking, 5% liquidity)(First hour sells get 35% tax)
//There is an hour sell lock to prevent dumping
//3% max wallet balance and 0.5% max sell transaction. No limits on Buys
//WARNING: Don't exceed the maximum wallet balance or the contract may restrict you from selling
...
//BabyFOCUS Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract BabyADA is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyFOCUS';
    string private constant _symbol = 'bFOC';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 5000 * 10**6 * 10**_decimals;//equals 1.000.000.000 token

    //Divider for the MaxBalance based on circulating Supply (3%)
    uint8 public constant BalanceLimitDivider=100;
    //Divider for the Whitelist MaxBalance based on initial Supply(0.5%)
    ...
    address public constant TeamWallet=0x3639FC8F3253fAC41E4CD29e3B3Fb229317B0AF0;
    ...
    uint8 public constant MaxTax=35;
    ...
    constructor () {
       ...
       //Sets sellLockTime to be max by default
        ...
        _buyTax=30;
        _sellTax=35;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=35;
        //No burn
        _burnTax=0;
