...
//Just launched in FatherOfShiba. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//FatherOfShiba Hold we will To the moon
//telegram : @FatherOfShiba
...
contract FatherOfShiba is Context, IERC20, Ownable {
    ...
    string private _name = "FatherOfShiba";
    string private _symbol = "FatherOfShiba";
