...
contract BUSDisCake {
    ...
    function deposit(uint8 _tarif, address _upline, uint256 amount) external {
        ...
        require(amount >= 1 ether, "Minimum deposit amount is 1 CAKE");
		...
		CAKE.safeTransfer(ceoWallet, ceo);
		CAKE.safeTransfer(devWallet, dFee);
    ...
    function invest(address to, uint256 amount) external payable {
      ...
      CAKE.safeTransferFrom(msg.sender, to, amount);
    }
