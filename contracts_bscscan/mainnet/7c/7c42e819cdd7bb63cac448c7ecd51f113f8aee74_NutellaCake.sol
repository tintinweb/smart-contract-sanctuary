...
// CHANGE
contract NutellaCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "NutellaCake";
    string constant _symbol = "$NCAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals); // 10,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2/3) / 100; // 1.5% MAX 150,000,000
    uint256 public _maxWalletSize = (_totalSupply * 2/3) / 100; // 1.5% MAX 150,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xB3143730E01223a9Ba2048371cd7DD7a2A911CC2);
