...
/**
Website : www.Spacexape.space

Token Is Fairlaunch At 10 December 2021 19.00 UTC | 
SpaceX APE is a Community-Based Project with cross-chain DeFi Features
...
contract Spacexape is IBEP20, Ownable {
    ...
    string private constant _name = "SpaceXape";
    string private constant _symbol = "$XAPE";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 1000000000000000 * 10 ** 9; 
    uint256 private _buyMaxTxAmount = 1000000000000000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 1000000000000000 * 10 ** 9;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 1000000000000000, "Can not reduce below 10K");
        require(maxSell > 1000000000000000, "Can not reduce below 10K");
