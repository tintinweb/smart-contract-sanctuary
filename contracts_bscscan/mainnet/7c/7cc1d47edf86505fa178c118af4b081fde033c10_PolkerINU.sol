...
contract Ownable is Context {
    address private _owner = 0x2E2f3B93B5657986491D699689631280E6eA9a9a;
...
contract PolkerINU is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xa28eE419AB8b575Bd476979d42b652826787deA2); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "PolkerINU"; // token name
    string private _symbol = "PolkerINU"; // token symbol
