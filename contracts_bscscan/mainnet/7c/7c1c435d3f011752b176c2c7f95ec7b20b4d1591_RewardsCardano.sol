...
🚀 Rewards Cardano is a coin which gives its holders Cardano (ADA) rewards. To prevent whales and dumps, we’ve implemented an anti whale mechanism into the contract. We are also adding more liquidity to assist in stabilizing the chart. 🚀

⚡️ This is a very large project. We will slowly be bringing some influencers on board. While we wait, just sit back, relax, and shill.

We'll be pushing marketing and are aiming for CMC and CG immediately after launch, as long as we have enough holders to qualify. ⚡️

✅Hold for Cardano (ADA)!
✅HOLD for huge gains!
✅Rewards Cardano Army get out there and spread the word!
✅We’re here and taking over!
___________________________________________________________________
🔰Tokenomics:
...
contract RewardsCardano is ERC20, Ownable {
    ...
    constructor() ERC20("Rewards Cardano", "RADA") {
