 ...
 *
 ...
 Welcome to REBEL ETH.
 
   Rebel ETH is a community driven reward token with anti snipe n bot function.
   
   This is a community REWARD token. If you want to create a telegram I suggest to name it to @REBELETHBSC
   Important: The early you create a group that shares the token, the more gain you got.
   
   The rewards is auto-added to your wallet. Just in case if that didnt happen try buy/sell a few amount to trigger the function
   You will see contarct selling once you sell you token. SO DONT WORRY if that happen.
   They makew look like dump but it just normal for Reward Smart Contract System.
   
   It's a community token with ETHEREUM REWARD, every holder should promote it, or create a group for it, 
   if you want to pump your investment, you need to do some effort.
   
   Great features:
   Anti Whales N Anti Bot Sniper with cooldown features
   10% fee reflection fee
   2% fee liquidity pool
   4% marketing wallet for my little investment here.

   I will renounce the ownership to burn addresses to transfer #REBELETH to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #REBELETH 10000X? 
...
contract REBELETH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "REBELETH";
    string constant _symbol = "REBETH";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xFBF45699ddd20A9e901AF80B2D4F85Da08341C77;
...
// this is made by Mr.X for the community.