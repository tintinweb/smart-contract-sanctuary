...
/**
 *My project is profit. I will setup the table, you can play the game. The first to buy almost always will win. There will be no dev wallet. My profit will come from the 10% transaction fee that increases the initial liquidity that I put in.
*/
...
contract NanoCapMoonshots is Context, IERC20, Ownable {
