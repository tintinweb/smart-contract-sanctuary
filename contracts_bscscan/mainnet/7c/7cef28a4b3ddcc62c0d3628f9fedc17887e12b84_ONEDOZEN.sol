...
*
* Total Supply 12
* Initial Price: $12 each
* Max per Holder: 0.25 for the first 30 mins then no max
* Max sell: 0.1 tokens
* Sell cool down: 12 minutes
*
*
* TG: t.me/onedozenbsc
* 
...
contract ONEDOZEN is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = '1DOZEN';
    string private constant _symbol = '$1DOZ';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 12 * 10**_decimals;//equals 10000 token

    //Divider for the MaxBalance based on circulating Supply 
    uint8 public constant BalanceLimitDivider=48;
    //Divider for sellLimit based on circulating Supply
    uint16 public constant SellLimitDivider=120;
    //Sellers get locked for MaxSellLockTime so they can't dump repeatedly
    uint16 public constant MaxSellLockTime= 12 minutes;
