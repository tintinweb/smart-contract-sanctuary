...
In response to: https://twitter.com/BitTorrent/status/1467827849134587904

TG: https://t.me/TorrentZilla_BSC
Utility: TorrentZilla reborn. Private tracker solely for holders of our token 👀
*/
...
contract TorrentZilla is IBEP20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TorrentZilla";
    string constant _symbol = "$BTTZ";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.div(1000).mul(40);
    uint256 public _maxWalletToken = _totalSupply.div(1000).mul(40);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buyBackFee, uint256 _buyFee, uint256 _sellFee, uint256 _feeDenominator) external authorized {
    ...
    function setMinSell(bool _useMinSell) external authorized {
        useMinSell = _useMinSell;
    }

    function setMinSellValue(uint256 _minSell) external authorized {
    ...
    function updateRWRDToken(address token) external authorized {
