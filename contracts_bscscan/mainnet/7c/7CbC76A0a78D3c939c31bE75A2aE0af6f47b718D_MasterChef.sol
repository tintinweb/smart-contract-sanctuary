...
// PatrickToken with Governance.
contract PatrickToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    constructor(
        PatrickToken _patr,
        uint256 _startBlock,
        uint256 _patrPerBlock
    ) public {
        panther = _patr;
        startBlock = _startBlock;
        pantherPerBlock = _patrPerBlock;
    ...
    function updateEmissionRate(uint256 _patrPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _patrPerBlock);
        pantherPerBlock = _patrPerBlock;
    }
