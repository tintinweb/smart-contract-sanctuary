...
/**
    Telegram: https://t.me/ladylassie
...
contract LadyLassie is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xd586C5D5B9cc5AE10a5Bb3F6D4325B948d550C00;
    address public devWallet = 0x7FDf721e952EE6C8B94357432eFa862471F04130;
    address public buybackWallet = 0xf503EC41543F08dA363DEFA34ac7707FDf2B2C34;

    string private constant _name = "Lady Lassie";
    string private constant _symbol = "LLS";
    ...
    Taxes public taxes = Taxes(1, 4, 2, 1, 1);
    Taxes public sellTaxes = Taxes(2, 9, 2, 1, 4);
