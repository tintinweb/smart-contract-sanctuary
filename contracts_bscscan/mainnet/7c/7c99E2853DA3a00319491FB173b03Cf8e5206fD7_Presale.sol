...
contract Presale is ReentrancyGuard, Ownable {
    ...
    function claimTokens() external nonReentrant {
        ...
        require (tokensOwned[msg.sender] > 0, "User should own some GTR tokens");
        require (tokensUnclaimed[msg.sender] > 0, "User should have unclaimed GTR tokens");
        require (safeToken.balanceOf(address(this)) >= tokensOwned[msg.sender], "There are not enough GTR tokens to transfer, wtf?");
