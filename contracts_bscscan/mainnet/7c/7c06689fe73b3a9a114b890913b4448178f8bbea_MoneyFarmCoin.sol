...
contract MoneyFarmCoin is Context, IERC20, Ownable {
    ...
    string private    _name = "Money Farm Coin";
    string private  _symbol = "MFC";
    uint8 private _decimals = 9;
    
    uint256 public                _taxFee = 5; // 5% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 6; // 6% of transactions will be kept for liquidity
    uint256 public               _burnFee = 3; // 3% of transactions will be burned
