...
/**  
   ...
   it's the best part of the #ORA idea, increasing the liquidity pool automatically, 
...
contract Mercury is Context, IBEP20, Ownable {
    ...
    string private _name = "Mercury";
    string private _symbol = "Mercury";
