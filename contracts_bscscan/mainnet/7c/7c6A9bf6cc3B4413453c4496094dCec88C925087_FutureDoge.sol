...
/**
 *  WELCOME TO THE FUTURE OF DOGECOIN!
 * ELON BASED "DOGE IS THE FUTURE"
 * We have made this possible with our tokenomics-rewards! Now we need elons attention! 
 *  
 * ₍ᐢ•ﻌ•ᐢ₎*･ﾟ｡ https://FutureDoge.xyz ₍ᐢ•ﻌ•ᐢ₎*･ﾟ｡
 * 
 * ₍ᐢ•ﻌ•ᐢ₎*･ﾟ｡ https://t.me/FutureDogeCoin ₍ᐢ•ﻌ•ᐢ₎*･ﾟ｡
 * 
 * 8% of Every transaction (Buy/Sell) is converted to BUSD and Distributed to holders every hour!, Anti-Whale Dumping tax!, 3% Liqudity, 2% Marketing, 2% Buybacks  
 */
...
contract FutureDoge is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "FutureDoge";
    string constant _symbol = "FutureDoge";
