...
TG LINK: https://t.me/CheemsInuBonk
STEALTH LAUNCH BY SAFU Dude
...
// CHANGE
contract CheemsInuBonk is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CheemsInu Bonk";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 4% MAX 400,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x29427D1037D15f57c3e63DFb90390B2fceB6fa7b); // Change
