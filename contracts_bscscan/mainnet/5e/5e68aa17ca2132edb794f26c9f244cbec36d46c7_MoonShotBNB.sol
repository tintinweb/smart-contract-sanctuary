...
// CHANGE
contract MoonShotBNB is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MoonShotBNB";
    string constant _symbol = "$MSBNB";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x0AC445c8CD8487ad864EBffeb0630DF9152c2913);
