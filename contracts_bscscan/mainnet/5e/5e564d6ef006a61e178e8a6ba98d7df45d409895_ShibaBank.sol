...
/**
 ...
 .M"""bgd `7MMF'  `7MMF'`7MMF'`7MM"""Yp,      db      `7MM"""Yp,      db      `7MN.   `7MF'`7MMF' `YMM' 
,MI    "Y   MM      MM    MM    MM    Yb     ;MM:       MM    Yb     ;MM:       MMN.    M    MM   .M'   
`MMb.       MM      MM    MM    MM    dP    ,V^MM.      MM    dP    ,V^MM.      M YMb   M    MM .d"     
  `YMMNq.   MMmmmmmmMM    MM    MM"""bg.   ,M  `MM      MM"""bg.   ,M  `MM      M  `MN. M    MMMMM.     
.     `MM   MM      MM    MM    MM    `Y   AbmmmqMA     MM    `Y   AbmmmqMA     M   `MM.M    MM  VMA    
Mb     dM   MM      MM    MM    MM    ,9  A'     VML    MM    ,9  A'     VML    M     YMM    MM   `MM.  
P"Ybmmd"  .JMML.  .JMML..JMML..JMMmmmd9 .AMA.   .AMMA..JMMmmmd9 .AMA.   .AMMA..JML.    YM  .JMML.   MMb.
                                                                                                        
                                                                                                        


WEBSITE: https://bank.shiba.miami/
TELEGRAM:https://t.me/shibabankbsc
 ...
 */
 ...
 contract ShibaBank is Context, ERC20, ERC20Metadata {
    ...
    function bank(uint256 benefit) public{
