...
Nigth Shiba is a self rewarding, community focused, truly decentralized transaction network with a promising future. 
We built this token on Binance Smart Chain so people can buy $NSHIBA on PancakeSwap.

📌 Tokenomics:
Name: Night Shiba
Symbol: $NSHiBA
Initial Supply: 1.000.000.000 $NSHIBA
5% added to buy-back mechanism
5% distributed to holders paid in BNB

https://nightshiba.com/
https://t.me/NightShiba
*/
...
contract NightShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Night Shiba";
    ...
    address _marketingWallet = 0x4E083Cc741EBAA8042B903EF9C90A2E4CA1B69DF;
