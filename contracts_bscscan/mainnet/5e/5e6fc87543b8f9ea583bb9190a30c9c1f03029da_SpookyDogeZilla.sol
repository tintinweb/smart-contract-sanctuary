...
contract SpookyDogeZilla is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("SpookyDogeZilla", "SpookyDogeZilla", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xD1Adc93709f82656B99Dc71f46A536C06A77Bfb1;
        marketingFeeReceiver = 0xeE7705Cd8659D7d2e556180319e370E08C77FD8C;
        ecosystemFeeReceiver = 0xDb49d4Ac7a6a55C6B9a2ca85711DD6AdE32C3C61;
        buyBackFeeReceiver = 0x6aBb61E59A5680d73C5e1aEF0c7Ad0620c1C8B0A;
