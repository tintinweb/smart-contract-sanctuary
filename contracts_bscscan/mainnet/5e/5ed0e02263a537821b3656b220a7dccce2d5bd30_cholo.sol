...
contract cholo is Context, IERC20, Ownable {
    ...
    string private _name = "cholo";
    string private _symbol = "cholo";
    ...
    address payable public marketingWallet = payable(0xC3F2754c5b7b4A03020c8bB2a47f1ab6A4B7317c); 
    ...
    uint256 public minimumTokensBeforeSwap = 600  * 10**9;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 marketingTokenShare = contractTokenBalance.mul(_marketingFee).div(_marketingFee.add(_liquidityFee));
            uint256 liquiditytokenShare = contractTokenBalance.sub(marketingTokenShare);
            
            //swap and send to marketing wallet
            swapAndSendToMarketing(marketingTokenShare);
            
            //add liquidity
            swapAndLiquify(liquiditytokenShare);
        }
    ...
    function swapAndSendToMarketing(uint256 marketingTokens) private lockTheSwap {
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmt) external onlyOwner() {
        minimumTokensBeforeSwap = newAmt*10**_decimals;
    }
