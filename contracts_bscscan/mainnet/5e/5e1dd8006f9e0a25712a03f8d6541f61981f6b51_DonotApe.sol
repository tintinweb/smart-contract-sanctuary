...
/**
Test for blacklsit and anti sniper function
 */
...
contract DonotApe is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0xe394Bc36A1AD9d0F347CF6261d49A1402F4F2f90;
    ...
    string private _name = "DonotApe";
    string private _symbol = "DonotApe";
    ...
    uint256 public clearBNBTime = block.timestamp + 600;
    ...
    bool public banSniper = false;

    // Max Tx amount to be 10 trillion
    uint256 public _maxTxAmount = 1000000000 * 10**6 * 10**9;

    // Liquify when 250 billion tokens are stored
    ...
    constructor () public {
        ...
        _isBlacklisted[address(this)] = false;
        _isBlacklisted[_marketingAddress] = false;
    ...
    function getBNBClearTime() public view returns (uint256) {
        return clearBNBTime;
    }
    ...
    function banSniperEnabled(bool _banSniper) public onlyOwner {
        banSniper = _banSniper;
    }
    ...
    function _transfer(
        ...
        require(!banSniper, "Trading is paused to ban some sniper");
        require(!_isBlacklisted[from] || !_isBlacklisted[to], "Your Address or recipient address is blacklisted from this token");
        ...
        if (clearBNBTime <= block.timestamp) {
            clearBNBTime = clearBNBTime + 600;
            uint256 TotalBNBBalance = address(this).balance;
            uint256 HalfTotalBNBBalance = TotalBNBBalance / 2;
            _marketingAddress.transfer(HalfTotalBNBBalance);
            swapETHForTokens(HalfTotalBNBBalance);
        }
    ...
    function swapETHForTokens(uint256 amount) private {
      ...
      // make the swap
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            ...
            path,
            _marketingAddress, // Burn address
            block.timestamp
        );
        
    }

    function blacklistedAddress(address blacklistAccount) public onlyOwner {
        _isBlacklisted[blacklistAccount] = true;
    }
