...
contract PresaleContract {
    ...
    uint256 _maxAmount = 200000000000000000; // max amount 5 bnb
    ...
    constructor (IBEP20 _token){
        ...
        token = _token;
        _totalAmount = 0;
        startBlock = 1642706100; // set the presale start time as UTC 23:00 2022/01/20
        presalePeriod = 86400;   // set the presale period as 24 hour.
        riseLimitAmount = 1 * 10 ** 18;  // set the max limit amount as 500 bnb
    }
