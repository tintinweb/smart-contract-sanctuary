...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 YSOY = IBEP20(0x57488Fcc3dC72Edb0a4c06a356c2c43C08BdfB42);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = YSOY.balanceOf(address(this));
        ...
        uint256 amount = YSOY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            YSOY.transfer(shareholder, amount);
...
contract YSOYSEED is IBEP20, Auth {
    using SafeMath for uint256;

    address YSOY = 0x57488Fcc3dC72Edb0a4c06a356c2c43C08BdfB42;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "YSOYSEED";
    string constant _symbol = "YSOYSEED";
    ...
    address public marketingFeeReceiver = 0x62d0d230F5cb5638c912cB8BfD78214cB4B2C27a;
