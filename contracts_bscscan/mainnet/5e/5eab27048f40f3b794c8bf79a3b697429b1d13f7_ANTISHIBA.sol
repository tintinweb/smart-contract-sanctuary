...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract ANTISHIBA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x25acA91a253C8131128E89Ba5c0Ffaa03682e87a); // Marketing Address
    ...
    string private _name = "ANTISHIBA";
    string private _symbol = "ANTISHIBA";
