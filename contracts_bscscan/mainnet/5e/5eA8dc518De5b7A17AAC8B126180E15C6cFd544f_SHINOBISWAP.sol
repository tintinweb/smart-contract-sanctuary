...
contract SHINOBISWAP is Context, IERC20, Ownable {
    ...
    uint256 private constant AntiWhale = 0 * 10 ** 9;
    ...
    string private constant _name = "SHINOBI SWAP";
