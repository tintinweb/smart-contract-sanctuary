...
contract Daokitty is Context, IERC20, Ownable {
    ...
    string private _name = "DAO kitty";
    string private _symbol = "DAO kitty";
    ...
    address public ownerAddres = address(0x5c2D220DcA1b0D0Fff22Be0b81b5047A6Eee6A2B);
    address public devAddress = address(0xFE4b18b98846E18c5e5d1dafFaFcFC2cDE81E808);
