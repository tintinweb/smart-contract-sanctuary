...
/**
 * @title SureMoon ERC20 token
 * @dev
 *      Based on the Ampleforth, GRV & Safemoon protocols
 */
contract Suremoon is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("SureMoon", "SUREMOON", uint8(DECIMALS))
        payable
        public
    {
