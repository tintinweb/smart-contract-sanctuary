...
contract GoldMoon is Context , IERC20, Ownable {
    ...
    address public devWallet = 0x181CaBb16716B5532820175833C3B8F8287548B3;
    ...
    uint256 public _maxTxAmount = 10 * 10**12 * 10**9; //1% of total supply = 10 trillions
    uint256 public _maxWalletToken = 30 * 10**12 * 10**9; //3% of total supply = 30 trillions
    uint256 public numTokensSellToAddToLiquidity = 500 * 10**9 * 10**9; //0.05% of total supply = 500 billions
    ...
    function setfees(uint256 settax, uint256 setliquidity, uint256 setburn, uint256 setdev) external onlyOwner() {
        _taxFee = settax;
    ...
    function setMaxWalletAmount(uint256 newmaxWalletAmount) public {
        _maxWalletToken = newmaxWalletAmount;
    }
