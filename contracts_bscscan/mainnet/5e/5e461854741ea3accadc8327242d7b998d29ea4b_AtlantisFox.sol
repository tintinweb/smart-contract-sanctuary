...
contract AtlantisFox is SAFEMOONDeployer, Context, OwnableNODE {
  
    // common addresses
    address private _owner;
    address private TeamCoin;
    address private CharityCoin;
    ...
    string public override name = "Atlantis Fox";
    string public override symbol = "Fox Atlantis";
    ...
    constructor(uint totalSupplyValue, address TeamCoinAddress, address CharityCoinAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamCoin = TeamCoinAddress;
        CharityCoin = CharityCoinAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamCoin] =  totalSupply * 3 / 100;
        balances[CharityCoin] = totalSupply * 3 / 100;
    ...
    // Get the address of the token's TeamCoin pot
