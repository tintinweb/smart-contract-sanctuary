...
/**
   ...
   Welcome to Tesla Shareholder
   
   This is a community token. If you want to create a telegram I suggest to name it to @teslashareholdercoin
   ...
   Can you make #teslashareholdercoin 10000X? 
...
contract TeslaShareholder is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1187564039C04B9Fa8494435201D4f9f68f4550E); // Marketing Address
    ...
    string private _name = "Tesla Shareholder";
    string private _symbol = "TESLASHOLDER";
