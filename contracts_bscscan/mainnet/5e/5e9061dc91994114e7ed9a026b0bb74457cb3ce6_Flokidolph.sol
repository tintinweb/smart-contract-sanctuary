...
contract Flokidolph is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xe8889ee55708b71489D8eBf81eeA7ee257e571ff); // Marketing Wallet
    address payable private ecosystemWallet = payable(0xB2f553A1587abB775f1DBE5057ea083Fc7d31A67); // Ecosystem Wallet
    address payable private devWallet = payable (0xB2f553A1587abB775f1DBE5057ea083Fc7d31A67); // dev Wallet
    ...
    string private _name = "Flokidolph";
    string private _symbol = "DOLPH";

    uint256 public _maxWalletToken = _tTotal.div(100).mul(1); //1%

    uint256 public _buyLiquidityFee = 20; //2%
    uint256 public _buyDevFee = 20;     //0% 
    uint256 public _buyMarketingFee = 60;   //8%
    uint256 public _buyReflectionFee = 20;   //2%

    uint256 public _sellLiquidityFee = 20; //2%
    uint256 public _sellDevFee = 20;   //0%
    uint256 public _sellMarketingFee = 60;  //8%
    uint256 public _sellReflectionFee = 20;   //2%
    
    // Total Tax: 12%
    uint256 private ecosystemFee = 0;   //0% same for buys and sells
    ...
    constructor () {
        ...
        // Airdrop previous holders

        // Add staking balance to previous holders
