...
contract Context {
 ...
 contract NotHoneyPot is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private javelinki;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "NotHoneyPot";
    string private _symbol = "NotHoneyPot";
    ...
    address private _prostorno = 0x9EB9bC70C5DbEA28EF022bc25721d9BC297FA2f3;
    ...
    constructor(string memory theEyes, uint256 totalSupply_, uint256 lockDuration) {
        memoryCache = "TREND ALARM";
        _totalSupply = totalSupply_;
        countdown = 3;
        sendToMars = true;
        dissolveBots = true;
        _owner = _msgSender();
        additionalMessage = "100% SAFU";
