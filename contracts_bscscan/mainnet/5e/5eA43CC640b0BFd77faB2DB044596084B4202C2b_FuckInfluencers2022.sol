...
contract FuckInfluencers2022 is Context, IERC20, Ownable {
    ...
    string private _name = "FuckInfluencers2022";
    string private _symbol = "$FI2022";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x848792EdAfa71eF6415a4898c38Dc0620C71583a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x848792EdAfa71eF6415a4898c38Dc0620C71583a); // BuyBack Address
