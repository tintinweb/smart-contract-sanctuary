...
//StopFloki Hold we will Tothemoon
//Telegram: https://t.me/Stopflokibsc
*/
...
contract StopFloki is Context, IERC20, Ownable {
    ...
    string private _name = "StopFloki";
    string private _symbol = "StopFloki";
    ...
    uint256 public maxBuyTranscationAmount = 25000000000000 * 10**6 * 10**9;
    uint256 public maxSellTransactionAmount = 100000000000000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 25000000000000 * 10**6 * 10**9;
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private liquidAddress = 0x164dA838190729528c0282846fc39EC2DB119Fb0;
