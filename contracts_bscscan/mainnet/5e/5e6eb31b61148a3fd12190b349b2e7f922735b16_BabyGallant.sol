...
// Welcome to BabyGallant
   
 //  This is a community token. If you want to create a telegram I suggest to name it to @BabyGallantChat
  ...
  // I will renounce the ownership to burn addresses to transfer #BabyGallant to the community, make sure it's 100% safe.

  // I will add 0.2 BNB and all the left 10% total supply to the pool
  // Can you make #BabyGallant 10000X? 
  ...
  // it's the best part of the #BabyGallant idea, increasing the liquidity pool automatically, 
...
contract BabyGallant is Context, IERC20, Ownable {
    ...
    string private _name = "BabyGallant";
    string private _symbol = "BabyGallant ";
