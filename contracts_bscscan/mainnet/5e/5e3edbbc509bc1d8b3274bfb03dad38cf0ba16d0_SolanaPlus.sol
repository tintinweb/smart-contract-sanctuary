...
45% of tokens burned on launch
50% Liquidity Pool on PancakeSwap
Only 2% dev wallet (locked)
3% Marketing wallet

12% tax on transactions
10% Solana auto-distribution to holders(every 1 hour)
2% added to liquidity pool

Website : https://solanaplus.com/
Telegram : https://t.me/solanaplus
...
contract SolanaPlus is Context, IERC20, Ownable {
    ...
    string private _name = "SolanaPlus";
    ...
    address _marketingWallet = 0x8661A0b976779B100425fACD611bC696Ae56e466;
