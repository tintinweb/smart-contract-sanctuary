...
// File: contracts/EarnCAKEDividendPayingToken.sol
...
contract EarnCAKE is ERC20, Ownable {
    ...
    constructor() public ERC20("EarnCAKE", "ECAKE") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "EarnCAKE: The new dividend tracker must be owned by the Token token contract");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "EarnCAKE: The liquidity wallet is already this address");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "EarnCAKE: This account cannot send tokens until trading is enabled");
        }
...
contract EarnCAKEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
