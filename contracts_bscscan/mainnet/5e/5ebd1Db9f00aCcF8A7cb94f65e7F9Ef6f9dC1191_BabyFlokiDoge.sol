...
// Baby Floki Doge - $BFDOGE

// Baby but big

// TG: https://t.me/BabyFlokiDogeToken
// ANTIBOT AND LOCKED
...
pragma solidity ^0.6.12;
    ...
    contract BabyFlokiDoge is Context, IERC20, Ownable {
        ...
        string private _name = 'Baby Floki Doge';
        string private _symbol = 'BFDOGE';
        ...
        uint256 private _developmentFee = 7;
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 1 && taxFee <= 50, 'taxFee should be in 1 - 50');
            _taxFee = taxFee;
        }
