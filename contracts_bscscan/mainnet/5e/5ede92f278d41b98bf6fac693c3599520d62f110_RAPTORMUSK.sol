...
interface IERC20 {
    ...
    /**
     * @dev Returns the amount of tokens owned by `account`.F
     */
...
contract RAPTORMUSK is Context, IERC20, Ownable {
    ...
    string private _name = "Raptor Musk";
    string private _symbol = "RAPTORMUSK";
    ...
    address public devWallet = 0xcbfa2596b7494498f68Fa91ed99e14BDa897FF5D;
