...
// CHANGE
contract SonOfSafu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SonOfSafu";
    string constant _symbol = "SOS";
    ...
    uint256 liquidityFee = 400; // 4%
    uint256 buybackFee = 0;   // 4% 
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 600; // 4%
    uint256 totalFee = 1000; // liquidityFee + Buyback + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xce178F58fFdE672B3bb49FDE11Db585EFb3d3949);
