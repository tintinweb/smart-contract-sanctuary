...
contract SAFETURTLESDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("SAFETURTLES_Dividend_Tracker", "SAFETURTLES_Dividend_Tracker", 9) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 250000 * (10**9); 
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "SAFETURTLES_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "SAFETURTLES_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SAFETURTLES contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "SAFETURTLES_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SAFETURTLES_Dividend_Tracker: Cannot update claimWait to same value");
...
contract SAFETURTLESToken is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public buybackWallet = 0xe3ca03f84a5CdbcB96C8A7C6c195692088d71ED3;

    bool private swapping;

    SAFETURTLESDividendTracker public dividendTracker;
    ...
    constructor() public BEP20("SAFETURTLES", "TURTS", 9) {
        ...
        dividendTracker = new SAFETURTLESDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "SAFETURTLES: The dividend tracker already has that address");

        SAFETURTLESDividendTracker newDividendTracker = SAFETURTLESDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "SAFETURTLES: The new dividend tracker must be owned by the SAFETURTLES token contract");
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "SAFETURTLES: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SAFETURTLES: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "SAFETURTLES: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SAFETURTLES: Automated market maker pair is already set to that value");
    ...
    function setLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SAFETURTLES: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "SAFETURTLES: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "SAFETURTLES: Cannot update gasForProcessing to same value");
