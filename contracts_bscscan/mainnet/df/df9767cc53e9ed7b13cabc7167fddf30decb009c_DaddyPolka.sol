...
OFFICIAL DaddyPolka TOKEN

You also saw those Reward tokens and tought where is the WSG one?Here we are the DaddyPolka Token that rewards you with polkadot Tokens.  knows what it needs to be the next gem, and that is YOU. Are you ready to be part of this?
...
contract DaddyPolka is Context, IBEP20, Ownable {
