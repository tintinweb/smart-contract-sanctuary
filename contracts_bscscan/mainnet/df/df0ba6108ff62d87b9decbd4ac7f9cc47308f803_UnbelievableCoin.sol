...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14d04BFE1C6f07a71ECbb1371B22487f5183004a;
...
contract UnbelievableCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xceE2919cA5473fE1E3630aE75a6Dc4A2503bBDbD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "UnbelievableCoin";
    string private _symbol = "UCOIN";
