...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 3 days");
...
contract SafeDoughnut is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdD60f6ABc8d405ae195D2173fF980ff4b8C3a422); // Marketing Address
    ...
    string private _name = "SafeDoughnut";
