...
contract StarVerse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private feeAddress = payable(0xD8FdB78d24Cae81F9745E34ee3aC234e9e06110e);
    ...
    string private _name = "StarVerse";
    string private _symbol = "StarV";
    ...
    function swapTokens(uint256 contractTokenBalance) private Swap {
    ...
    function buyBackTokens(uint256 amount) private Swap {
    	if (amount > 0) {
