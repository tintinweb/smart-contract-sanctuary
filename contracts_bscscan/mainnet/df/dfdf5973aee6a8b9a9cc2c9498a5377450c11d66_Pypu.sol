...
contract Pypu is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Pypu";
    string private constant _symbol   = "Pypu";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 700000000 * 10**9;
