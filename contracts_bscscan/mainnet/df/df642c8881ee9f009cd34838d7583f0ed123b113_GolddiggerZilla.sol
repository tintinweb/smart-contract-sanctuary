...
// 💵 GolddiggerZilla 💵
//
// Are you tired of all the skank ass golddiggers? Wanna take revenge on your ex who stripped you 
// and your credit card naked before dumping you for a better looking chad? Get GolddiggerZilla! 
//
// Our use case is simple. We aim to punish golddiggers by letting you make ridiculous money 
// while not giving those THOTs a single fucking dime. Show your hoe that you got that 
// dough and buy her a bubblegum. 
//
// The longer you hold, the higher your BNB rewards and the more you hold the quicker you get them. 
// We will be investing 100% of the marketing wallet into promotion so IF we aren't at 1 million marketcap 
// in 3 days, we will eat a sheet of paper live on cam in the group.
//
// 💰Supply: 10 Trillion
// 💰Team tokens: 0
// 💰Starting Liquidity: 6 BNB
//
// 💰TAXES:
// Total: 11%
// 5% Reflection
...
contract GolddiggerZilla is Context, IBEP20, Ownable {
    ...
    string private _name = "GolddiggerZilla";
    string private _symbol = "DIGGER";
    ...
    address payable public buybackAddress = payable(0x385d5bEA5BD6C1e963C91B2986dC23FA2742C7A4);
    address payable public lpAddress = payable(0x385d5bEA5BD6C1e963C91B2986dC23FA2742C7A4);
