...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x87bBd8f9D4b150877bA3Bc9B90C5924378c93D91;
...
contract LUCK is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x0A29E022E38Da51E57fA39f2F48beE080D578d17;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Rabbitfoot";
    string private _symbol = "LUCK";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 40;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _marketingFee = 10;
    uint256 private _previousDevelopmentFee = _marketingFee;
    ...
    function _takeDevelopment(uint256 tDevelopment) private {
        uint256 currentRate =  _getRate();
        uint256 rDevelopment = tDevelopment.mul(currentRate);
        _rOwned[_marketingWalletAddress] = _rOwned[_marketingWalletAddress].add(rDevelopment);
        if(_isExcluded[_marketingWalletAddress])
            _tOwned[_marketingWalletAddress] = _tOwned[_marketingWalletAddress].add(tDevelopment);
    }
    ...
    function removeAllFee() private {
        ...
        _previousDevelopmentFee = _marketingFee;
    ...
    function restoreAllFee() private {
        ...
        _marketingFee = _previousDevelopmentFee;
