...
Mission
Create a WFD digital wallet for crypto and metaverse payments 

 Telegaram : https://t.me/worldflydimension
 Website : https://worldflydimension.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd1FF644632C38524F51362a3eD5ae10DB738a353;
...
contract WorldFlyDimension is Context, IERC20, Ownable {
    ...
    address public _developmentWalletAddress = 0xcadf395BDAD9cb45C1609BfA22dB3FfAFD6Bc901;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "World Fly Dimension";
