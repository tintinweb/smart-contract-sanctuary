...
contract NFTCALENDAR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x33A79114D8737C735F8B590f7046A457698Ee0DB); // Marketing Address
    ...
    string private _name = "NFTCALENDAR";
    string private _symbol = "NFTC";
