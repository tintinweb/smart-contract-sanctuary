...
contract ElonMuskName is ERC20, Ownable {
    ...
    uint16 public feeliq_buy = 10; // Fee is initially set to avoid sniperbots
    uint16 public feeliq_sell = 10; // Fee is initially set to avoid sniperbots
    ...
    constructor() ERC20("Elon Musk Name", "$ElonMuskName") {
        _mint(msg.sender, 100000000000000000000 * 10**9);      
