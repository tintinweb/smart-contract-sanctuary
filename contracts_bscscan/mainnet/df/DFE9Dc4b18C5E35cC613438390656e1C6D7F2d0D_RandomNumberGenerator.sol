...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public defiSwapLottery;
    ...
    {
        require(_vrfCoordinator != address(0), "RandomNumberGenerator:: vrfCoordinator is zero address"); 
        require(_linkToken != address(0), "RandomNumberGenerator:: linkToken is zero address"); 
        //
    }
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == defiSwapLottery, "Only DefiSwapLottery");
    ...
    /**
     * @notice Set the address for the DefiSwapLottery
     * @param _defiSwapLottery: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _defiSwapLottery) external onlyOwner {
        defiSwapLottery = _defiSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPancakeSwapLottery(defiSwapLottery).viewCurrentLotteryId();
    }
}