...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0xC147556353B645aA088aCbC922E8bfad6b076898;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0xb2F90DdC14D07BB42Ad4d88266fdE6E2AFDa9556); 
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xC147556353B645aA088aCbC922E8bfad6b076898;
        _token = msg.sender;
    }
...
contract MiniCulo is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x6e04689dD2E2eaB6454E3674192eE5bDa12413FA;

    string constant _name = "MiniCulo";
    string constant _symbol = "MiniCu";
