...
contract MartinLutherCheems is Context, IERC20, Ownable, LockToken 
{
    ...
    string private _name = "Martin Luther Cheems";
    string private _symbol = "MLC";
    ...
    uint256 public _saleMarketingFee = 20; 

    address payable public marketingWallet =  payable(0x81cEF31Ab2B5E446F6357F2a1eA629eeB82827f1);
    ...
    uint256 public _maxSaleAmount = 10_000_000 * 10**9; //1%
    uint256 public _maxBuyAmount = 20_000_000 * 10**9; //2%
    uint256 private numTokensSellToAddToLiquidity = 1_000 * 10**9;
    uint256 public maxLimit = 200_000_000 * 10**9; //max allowed tokens in one wallet. 
