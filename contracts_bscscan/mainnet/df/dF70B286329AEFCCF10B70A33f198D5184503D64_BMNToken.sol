...
contract BEP20 is Context, Ownable, IBEP20 {
    ...
    address public D = 0xe23D49e073b3f1a1525CBEec49dE8FF9aE889e26;  // deployer address
    address public T = 0x27259a7dc965ebCdC144519981CE86386417C9Ec;  // team address
    address public P = 0x0FBf40549965a9E498E8Aaf954202eD9B59E5080;  // partner address
    address public C = 0x2f2c31b164060C49Dfd5774432bD77f1d9Cf85fE;  // consultant address
    address public AD = 0x3df2d74f9653Fd977037369EE6099ae7C75CdE90;  // airdrop address
    address public A = 0xca0527348b622336B5dD9043609f90ffEd55e6C6;  // transition address
    address public M = 0xc1846d00E1be4540163836B82a88830216BFd683;  // market address
...
contract BMNToken is BEP20Detailed {

    constructor() BEP20Detailed("Batman", "BMN", 18) public {
