...
contract DUNE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DUNE";
    string constant _symbol = "PICE";
    ...
    uint256 public _walletMax = _totalSupply * 1 / 100; // 1% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x00d12CBC6d05A6F76786EcF3605d455602CC2D8f;  // teamwallet
        lotteryWallet = 0x00d12CBC6d05A6F76786EcF3605d455602CC2D8f;  // lotterywallet
