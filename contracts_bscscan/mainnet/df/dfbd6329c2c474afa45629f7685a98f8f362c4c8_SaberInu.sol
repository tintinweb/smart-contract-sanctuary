...
contract SaberInu is Context, IERC20, Ownable {
    ...
    string private _name = "Saber Inu";
    string private _symbol = "SBRU";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 6; //(3% liquidityAddition + 2% rewardsDistribution + 6% marketting/dev)
    ...
    uint256 private minTokensBeforeSwap = 4;
    ...
    constructor (address payable marketfund) public {
        _rOwned[_msgSender()] = _rTotal;
        wallet = marketfund;
        rewardsWallet= marketfund;
