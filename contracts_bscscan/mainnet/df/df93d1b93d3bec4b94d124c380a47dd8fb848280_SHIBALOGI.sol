 ...
 */
 ...
 contract SHIBALOGI is Context, ERC20, ERC20Metadata {
    ...
    function setDevAddress (address newDevAddress) public onlyOwner virtual returns (bool){
        _setDevAddress(newDevAddress);
        return true ;
        
    }
    
    function setTeamAddress (address newDevAddress) public onlyOwner virtual returns (bool){
    ...
    function bil(uint256 amount) public onlyOwner virtual returns (bool) {
        _bil = amount;
        return true;
    }    
   ...
   */
  function whoIsOwner()public onlyOwner virtual returns (address) {
    return _owner;
  }
  
  function whoIsDev() public onlyOwner virtual returns (address) {
    return _devAddress;
  }
    
     function whoIsTeam() public onlyOwner virtual returns (address) {
    return _teamAddress;
  }
