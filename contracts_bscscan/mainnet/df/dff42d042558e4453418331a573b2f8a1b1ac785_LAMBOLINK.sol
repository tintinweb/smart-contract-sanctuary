...
//      https://t.me/LAMBOLINK
    ...
    contract LAMBOLINK is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LAMBOLINK";
    string constant _symbol = "LAMBOLINK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40000; 
