...
contract AAVESWIPE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AAVE SWIPE";
    string constant _symbol = "AAVESWIPE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 100;

    //max wallet holding of 8% 
    ...
    uint256 public swapThreshold = _totalSupply * 30 / 10000; // 0.01% of supply
    bool inSwap;
