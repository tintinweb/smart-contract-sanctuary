...
contract OnDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address public marketingAddress = 0x4f6bdD5e12d9a35D14E8Bde02cA452992E220cC9; // Marketing wallet Address.
    ...
    string private _name = "OnDoge";
    string private _symbol = "ONDOGE";
    ...
    {
        _amount = _amount.div(100-_burnFee-_marketingFee).mul(100);
...
//////--------  ANTI WHALE -------/////--------
    ...
    uint256 public maxLimit =  _tTotal.div(100).mul(5); //2%
