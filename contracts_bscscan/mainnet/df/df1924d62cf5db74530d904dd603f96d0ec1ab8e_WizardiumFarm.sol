...
contract WizardiumFarm is Ownable, VRFConsumerBase {
    ...
    function setPerLuck(uint256 _nPerLuck) external onlyOwner{
        require(_nPerLuck != 0, "Cannot have 0 luck");
        perLUCK = _nPerLuck;
    }
    ...
    function getExpeditionRewards(uint256 heroID, uint256 worldRef, uint256 multiplier) internal view returns(uint256 tokens, uint256 levels) {
        ...
        uint256 cumulativeBasisPoints = ((_heroBase*multiplier)+worlds[worldRef].chance)/perLUCK; // 7 for luck
