...
pragma solidity ^0.6.12;
    ...
    contract CrossChain is Context, IERC20, Ownable {
        ...
        string private _name = 'Farming For You';
        ...
        address payable public _FFYWalletAddress;
        ...
        constructor () public {
            _FFYWalletAddress = 0x7E8A03e614D5217C41234984B8ABce6787Dd9871;
            _marketingWalletAddress = 0xdfD411c59AC1aCE25b3E1092FD481959F25f6863;
  ...
  function setCurrentLiqPair(address _pair) public onlyOwner {
     ...
     function setCurrentRouter(address _router) public onlyOwner {
        ...
        function sendETHToTeam(uint256 amount) private {
            _FFYWalletAddress.transfer(amount.div(2));
        ...
        function _setCCFWallet(address payable FFYWalletAddress) external onlyOwner() {
            _FFYWalletAddress = FFYWalletAddress;
        }
