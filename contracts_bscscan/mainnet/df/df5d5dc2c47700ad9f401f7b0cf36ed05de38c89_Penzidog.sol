...
contract Penzidog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x885a99D8A815c500b789669a80169cD9cE609242);
    ...
    string private _name = "Penzidog";
    string private _symbol = "Pzdog";
