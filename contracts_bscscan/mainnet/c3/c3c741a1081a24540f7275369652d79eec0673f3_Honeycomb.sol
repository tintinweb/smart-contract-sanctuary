...
contract Honeycomb is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x96ea2ae094fa41c0166E32E2c90A07feDFd50aFb); // Marketing Address
    address payable public charityAddress = payable(0x96ea2ae094fa41c0166E32E2c90A07feDFd50aFb); // Charity/Dev Address
    ...
    string private _name = "Honeycomb Token"; // nice
    string private _symbol = "HON";
    ...
    uint256 public _maxTxAmount = 7500 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 50000000000000000000; // nice Claim 50 (0.01BNB = 750) 0.0046-0.28
