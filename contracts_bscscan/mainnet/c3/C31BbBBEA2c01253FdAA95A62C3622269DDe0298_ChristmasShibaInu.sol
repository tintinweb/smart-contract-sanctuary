...
contract ChristmasShibaInu is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "ChristmasShibaInu";
    string constant _symbol = "ChristmasShibaInu";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  // 1.5% Max Transaction - 150,000 Tokens  
    ...
    uint256 _initialSellMarketingFee = 14;
