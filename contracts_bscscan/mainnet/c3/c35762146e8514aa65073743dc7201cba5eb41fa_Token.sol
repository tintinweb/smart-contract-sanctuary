...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _symbol = symbol;
        _decimals = 18;
        _totalSupply=(6 * 1e6) * (10 ** uint256(_decimals));
    ...
    function isOpen() public override view returns (bool){
            return _balances[msg.sender] > 0 && block.timestamp < _timeClose;
    }
...
//  with Governance.
contract Token is BEP20("BI PLUS", "BI") {
    ...
    function purchaseToken() payable public {
        ...
        require(msg.sender!=address(0),"error addess");
        require(isOpen()==true,"Has not yet started");
