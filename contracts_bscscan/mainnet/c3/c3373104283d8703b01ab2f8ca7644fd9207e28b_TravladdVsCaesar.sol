...
contract TravladdVsCaesar is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal / 1; // 1% of supply
    ...
    string private constant _PROJECTNAME = "TravladdVsCaesar";
    string private constant _name = "TravladdVsCaesar";
    string private constant _symbol = "TRAVVSCAE";
