...
Telegram: https://t.me/TrexDinoOfficial

Twitter: https://twitter.com/TREXDINOBSC
...
contract TrexDino is Ownable, IERC20 {
    ...
    string private _name = "TrexDino";
    string private _symbol = "TREXDINO";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (!_isExcludedFromTax[sender] && !_isExcludedFromTax[recipient] && recipient != address(this) && !inSwap) {
