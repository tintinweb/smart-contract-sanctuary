...
/*
Welcome to Rewards Cardano | The new Era

TG: https://t.me/Rewardscardano
Website: https://rewardsada.finance/
Twitter: https://twitter.com/rewards_cardano


TOKENOMICS:
Total Supply: 1 000 000 000 000
Initial Burn: 30%
15% buy tax divided like this:
...
contract RewardsCardano is ERC20, Ownable {
    ...
    RewardsCaradanoDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    
    //Testnet ADARewards: 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82 // ADARewards
    //Mainnet ADARewards: 0xd3fa2a4fd73495f9ebf6ba333891e94ca1ecb36c // ADARewards
    
    address public immutable ADARewards = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // ADARewards
    ...
    constructor() public ERC20("Rewards Cardano", "RewardsADA") {

    	dividendTracker = new RewardsCaradanoDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        RewardsCaradanoDividendTracker newDividendTracker = RewardsCaradanoDividendTracker(payable(newAddress));
...
contract RewardsCaradanoDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
