...
contract NAKATO is Context, ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Nakato";
    string private _symbol = "Nakato";
    uint8 private _decimals = 18;

    uint256 private _tTotal = 1000000000 * 10**21;
