...
contract SweetBabyCake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x036071C5af4DbefB825BCE00004A9aCe2C2Ea9B3); // Marketing Address
    ...
    string private _name = "SweetBabyCake";
