...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #BulleX

    I make this #BulleX to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BulleX_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #BulleX to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #BulleX 10000000X? 
   ...
   it's the best part of the #BulleX idea, increasing the liquidity pool automatically, 
...
contract BulleX is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BulleX";
  string private _name = "BulleX";
