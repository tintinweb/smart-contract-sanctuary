...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
    ...
    uint256 public minPeriod = 90 minutes;
...
contract AXSEA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AXS SEA";
    string constant _symbol = "AXSEA";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0;

    uint256 _totalSupply = 1000000000 * 10**5 * (10 ** _decimals);
