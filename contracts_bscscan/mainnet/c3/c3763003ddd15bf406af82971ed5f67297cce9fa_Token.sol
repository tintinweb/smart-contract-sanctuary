...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10000000000000000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = '虎年快乐';
    string private _symbol = '虎年快乐';
    uint8 private _decimals = 10;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    address public _factory = address(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73);
    address public _WBNB = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    address private fundAddress = address(0xF7fCfA5064ff3e46CAbcb009ABd9231bcFBab0b7);
    address public Pair;
    mapping(address => bool) private _isExcludedFromFee;
    
    modifier onlyOwners{
        require(msg.sender == owners, "OnlyOwners");
        _;
    }
    ...
    constructor () public {
        ...
        Pair = IPancakeFactory(_factory).createPair(_WBNB,address(this));
        emit Transfer(address(0), _msgSender(), _tTotal);
    }

    function isBlackList(address account) public view returns(bool status){
        if (_BlackList[account] == true){
            return true;
        }else{
            return false;
        }
    ...
    function addBlackList(address account) public onlyOwners{
        _BlackList[account] = true;
    }

    function removeBlackList(address account) public onlyOwners{
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(_BlackList[sender] != true, "You wallet in BlackList");
        require(_BlackList[recipient] != true, "You wallet in  BalckList");
