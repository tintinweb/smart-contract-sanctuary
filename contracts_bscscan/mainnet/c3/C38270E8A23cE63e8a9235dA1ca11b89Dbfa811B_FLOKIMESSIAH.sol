...
🐕FlokiMessiah🐕
____
STEALTH LAUNCHING TUESDAY 21ST SEPTEMBER NOW !

THE STRONGEST FLOKI COMMUNITY!
———————————————- 
...
contract FLOKIMESSIAH is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10**11 * 10**16;
    ...
    uint256 private _total = 10**11 * 10**15;
