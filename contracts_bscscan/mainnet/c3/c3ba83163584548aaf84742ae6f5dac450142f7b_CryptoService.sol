 ...
 *
   ...
   5% fee sent to charity(Marketing, develop, burn) wallet
 */
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x69FD82123900Bd71ab4386343D316E642131D682;
...
contract CryptoService is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xB620C171c578B45429a8eA87AdBA08fCbb3071DF;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1670000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Elon Cash";
