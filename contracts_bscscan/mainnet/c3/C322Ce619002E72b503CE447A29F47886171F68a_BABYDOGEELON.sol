...
/*
* Welcome to Baby Doge Elon
* 50% Token Burned
* LP Burn forever
* Baby Doge Elon will burn 3% every transaction
* 2% reward to holders
*/
...
contract BABYDOGEELON is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "Baby Doge Elon";
        _symbol = "BABYDOGEELON";
