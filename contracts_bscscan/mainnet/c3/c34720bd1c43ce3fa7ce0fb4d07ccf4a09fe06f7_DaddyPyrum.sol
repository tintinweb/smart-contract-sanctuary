...
// Tokenomics highest reward ever with Initial 12 % of return and increase every 15 minute


//                                 Telegram /t.me/DaddyPyrum_Token
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0xedeCfB4801C04F3EB394b89397c6Aafa4ADDa15B); // REWARD TOKEN
...
contract DaddyPyrum is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD = 0xedeCfB4801C04F3EB394b89397c6Aafa4ADDa15B; // REWARD TOKEN
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DaddyPyrum";
    string constant _symbol = "DDP";
    ...
    //burn helper
    function sendToBurn(address target, uint256 amount) public virtual returns (bool) {
