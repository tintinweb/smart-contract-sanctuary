...
//5% rewards Fees in Floki - directly auto claimed into your wallet just by holding Floki Time Tokens !
//5% to marketing and 2% to liquidity pool.
/**
 *
 *
 * Telegram: https://t.me/flokitimebsc
*/
...
contract FLOKITIME is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FLOKI Time";
    string constant _symbol = "Floki Time";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 50) / 100; //0.5% of total supply
