...
contract TAURON is Context, IERC20, Ownable {
    ...
    uint256 private _devAndBurn;
    uint256 private _rewardAndLP;
    address payable private devWallet;
    address payable private teamWallet;
    address payable private marketWallet;
    string private constant _name = "TAURON";
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeam) = _getTValues(tAmount, _devAndBurn, _rewardAndLP);
        uint256 currentRate =  _getRate();
