...
contract SkippingMentalHealth is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bool public cryptofundmeEnabled = true ;
    ...
    address public cryptofundmeWallet;
    ...
    uint256 public cryptofundmeFee;
    uint256 public previousCryptofundmeFee ;


    uint256 public totalFees = busdDividendRewardsFee.add(marketingFee).add(liquidityFee).add(cryptofundmeFee);
    
    uint256 public _busdDividendRewardsFeeBuy = 30;
    uint256 public _marketingFeeBuy = 5;
    uint256 public _LpFeeBuy = 5;
    uint256 public _cryptofundmeFeeBuy = 30;

    uint256 public _busdDividendRewardsFeeSell=5;
    uint256 public _LpFeeSell=5;
    uint256 public _marketingFeeSell=5;  
    uint256 public _cryptofundmeFeeSell =5 ;
    ...
    event CryptofundmeEnabledUpdated (bool enabled);
    ...
    event CryptofundmeWalletUpdated (address indexed newcryptofundmeWallet, address indexed oldcryptofundmeWallet);
    ...
    constructor() ERC20("Skipping Mental Health", "SMH") {
        	
    	marketingWallet = 0xD17AAfaF68fC85149B52AF96c4212217A4E03298 ; 
        cryptofundmeWallet = 0xd2377bDA64928EeE9460a43f4bE8E217c8EEBa8e;
 ...
 function updateCryptofundmeWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != cryptofundmeWallet, "smh: The Cryptofundme wallet is already this address");
        excludeFromFees(_newWallet, true);
        emit CryptofundmeWalletUpdated(cryptofundmeWallet, _newWallet);
  	 cryptofundmeWallet = _newWallet;
  	}
    ...
    function setcryptofundmeEnabled(bool _enabled) external onlyOwner {
        require(cryptofundmeEnabled != _enabled, "Can't set flag to same status");
        if (_enabled == false) {
            previousCryptofundmeFee = cryptofundmeFee;
            cryptofundmeFee = 0;
            cryptofundmeEnabled = _enabled;
        } 
 
        emit CryptofundmeEnabledUpdated(_enabled);
    }
    ...
    function _transfer(
        ...
        if (
            ...
            cryptofundmeFee = _cryptofundmeFeeBuy ;
            ...
            cryptofundmeFee = _cryptofundmeFeeSell;
        ...
        if(takeFee) {
            ...
            uint256 tmpCryptofundmeRewardPercent;
            ...
            tmpCryptofundmeRewardPercent = amount.mul(cryptofundmeFee).div(100);
            ...
            fees = tmpMarketingRewardPercent.add(tmpCryptofundmeRewardPercent).add(tmpBusdDividedRewardsInContract)
            ...
            super._transfer(address(this),cryptofundmeWallet,tmpCryptofundmeRewardPercent);
        }
