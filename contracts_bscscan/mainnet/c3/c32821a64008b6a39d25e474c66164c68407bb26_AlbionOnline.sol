...
//
contract AlbionOnline is ERC20, ERC20Detailed, ERC20Pausable {
    //160M fixed token supply with default 18 decimals
    uint256 public constant TOKEN_SUPPLY = 160 * 10**9 * 10**18;

    constructor() public ERC20Detailed("Albion Online NFT", "ABO", 18) {
