...
contract EthereumNameService is IBEP20 {
    ...
    string public override name = "Ethereum Name Service";
    string public override symbol = "Ethereum Name Service";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 20 / 100;
