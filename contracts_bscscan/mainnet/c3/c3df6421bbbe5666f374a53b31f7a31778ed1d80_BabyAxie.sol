...
/**
💎 BabyAxie, the token set to change the DeFi space. Holders earn Axie Infinity Shards automatically, simply by holding! The growth of AXS has been phenomonal in the past few days, and BabyAxie is definitely set on capitalizing on that! 

💪 Together, we’ll work towards making this an incredibly successful project. Community tasks, shilling and meme contests, constant community presence and drive: we want to make this a fun and rewarding ride for all holders! 

🚀🚀🚀 So hop on!! 🚀🚀🚀


🌐 Axienomics: Total Tax: 15%
...
💰 Axie Rewards: 5% of each transaction is automatically converted to AXS tokens, and distributed amongst holders every 60 minutes
