...
contract NFTONESTARS is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 686386386; //963 million
    ...
    string private _name = "NFT ONE STARS";
    string private _symbol = "NFTES";
