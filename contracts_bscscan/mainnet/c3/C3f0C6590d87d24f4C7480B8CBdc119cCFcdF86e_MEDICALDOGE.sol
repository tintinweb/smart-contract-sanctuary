...
/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #MEDICALDOGE designed.
   ...
   I will renounce the ownership to burn addresses to transfer #MEDICALDOGE to the community, make sure it's 100% safe.

   I will add 0.3 BNB and all the left 10% total supply to the pool
   Can you make #MEDICALDOGE 100000X? 

   1,000,000,000,000,000 total supply
   5,000,000,000,000 MEDICALDOGE max limit for per trade
  

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #MEDICALDOGE idea, increasing the liquidity pool automatically, 
...
contract MEDICALDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "MEDICALDOGE";
