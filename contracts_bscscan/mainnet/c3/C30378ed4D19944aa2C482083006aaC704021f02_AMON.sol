...
contract Ownable is Context {
    address private _owner = 0x0C0d32d740ab16647EFb2B5Def0d71908e532711;
...
contract AMON is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xbfBD24Bdad9932209E29F04dB41d3f5B3847C4c0); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "AMON"; // token name
    string private _symbol = "AMON"; // token symbol
