...
contract RocketFuel is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xAa642B5eF26cbaE69F0aB7AB6D37C7e669db105F); // Marketing Address
    address payable public charityWalletAddress = payable(0xcA8df01cD3a9DD894C8719af6794e181c08B5c37); // Charity Address
    ...
    string private _name = "Rocket Fuel";
    ...
    function setSwapBackSettings(bool isSwapByLimitOnly, uint256 newLimit, bool _enabled) public onlyOwner {
        swapAndLiquifyByLimitOnly = isSwapByLimitOnly;
