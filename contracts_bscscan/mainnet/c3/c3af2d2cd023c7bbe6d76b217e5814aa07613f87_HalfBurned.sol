...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BONFIRE = IERC20(0x5e90253fbae4Dab78aa351f4E6fed08A64AB5590);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BONFIRE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BONFIRE);
        ...
        uint256 amount = BONFIRE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BONFIRE.transfer(shareholder, amount);
...
contract HalfBurned is IERC20, Ownable {
    using SafeMath for uint256;

    address CAKE = 0x5e90253fbae4Dab78aa351f4E6fed08A64AB5590;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "HalfBurned";
