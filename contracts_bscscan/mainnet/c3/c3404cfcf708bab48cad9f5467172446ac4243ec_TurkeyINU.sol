...
d888888P                   dP                         dP 888888ba  dP     dP 
   88                      88                         88 88    `8b 88     88 
   88    dP    dP 88d888b. 88  .dP  .d8888b. dP    dP 88 88     88 88     88 
   88    88    88 88'  `88 88888"   88ooood8 88    88 88 88     88 88     88 
   88    88.  .88 88       88  `8b. 88.  ... 88.  .88 88 88     88 Y8.   .8P 
   dP    `88888P' dP       dP   `YP `88888P' `8888P88 dP dP     dP `Y88888P' 
                                                  .88                        
                                              d8888P                         
...
contract TurkeyINU is Context, IERC20AntiBots, Ownable {
    ...
    uint256 private constant _ALLTOTALSUPPLY = 100000000000 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _ALLTOTALSUPPLY));
    uint256 private _tFeeTotal;

    string private _name = 'Turkey INU';
    string private _symbol = 'TurkeyINU';
