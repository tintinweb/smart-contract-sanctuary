...
$Zillalord🦖 is a community based meme token on the Binance Smart Chain Network and we are not just a meme token! We dedicate this project to the community. Not just an ordinary meme coin but we are more than that, there will be a surprise at launch
...
contract Zillalord is ERC20, Ownable {
    ...
    constructor() ERC20("ZillaLord", "ZL")  {
