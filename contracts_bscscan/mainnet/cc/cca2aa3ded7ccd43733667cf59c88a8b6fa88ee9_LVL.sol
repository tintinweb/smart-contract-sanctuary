...
/**
 * 
LEVEL is the first token in Binance Smart Chain network, which combines rewards for holders and a buyback function, the values of which will be determined by our smart level system.

We have combined and improved all the most useful and important features that investors love so much.

LEVEL has been created by a team of experienced developers and is ready to take itself to another new LEVEL.

Doxxed fully transparent team, several audits, a clean professional website & message, watch us when we are listed in major exchanges and become a known global name. 
...
contract LVL is Context, IERC20, Ownable {
