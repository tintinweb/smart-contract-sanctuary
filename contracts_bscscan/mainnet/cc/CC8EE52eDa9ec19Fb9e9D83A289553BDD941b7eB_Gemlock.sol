...
/*
Telegram Group : https://t.me/gemlock_finance
Website: https://gemlock.co
*/
...
contract Gemlock {
    string  private _name = 'Gemlock';
    string  private _symbol = 'GEL';
    ...
    constructor () {
        ...
        setLimits(3000000, 2000000, 500000);
        setFees(5, 5);
    }
