...
contract BabySparkLab is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x44c7645508Da16919F4FdD9Dd3FE603E861dde5f); // Marketing Address
    address payable public devAddress = payable(0x1855237b7364BbDcAf161C269E40a30ae0A6e26A); // DEV Address
    ...
    string private _name = "Baby SparkLab";
    ...
    function _transfer(
        ...
        uint256 marketingFee = marketingDivisor;
        uint256 devFee = devDivisor;
