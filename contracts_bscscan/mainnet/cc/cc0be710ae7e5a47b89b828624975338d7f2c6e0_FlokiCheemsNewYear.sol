...
telegram = t.me/flokicheemsnewyear
 */                                                                         
...
contract FlokiCheemsNewYear is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FlokiCheemsNewYear";
    string constant _symbol = "$FCNY";
    ...
    uint256 public _walletMax = 30**9 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8dB540Faca7541453BeADf31DcA8D48c4FbbFaff;
        devWallet = 0xB0FBBF497222c9f4c0C22519ae2F69e6F90928b6;
