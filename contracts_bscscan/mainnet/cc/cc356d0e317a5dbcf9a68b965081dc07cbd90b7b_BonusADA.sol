...
/**
 BonusADA
 Hodl it to give Bonus ADA rewards to shareholders
 SmartContract Verified
 Contract : 0xcc356d0e317a5dbcf9a68b965081dc07cbd90b7b
...
contract BonusADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BonusADA";
    string constant _symbol = "BonusADA";
