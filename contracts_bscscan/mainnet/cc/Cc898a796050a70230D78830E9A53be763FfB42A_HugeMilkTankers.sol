...
/*Big Boobies. Huge Milk Tankers. Hoobies
...
contract HugeMilkTankers  is Context, IERC20, Ownable {
    ...
    string private _name = 'HugeMilkTankers';

    string private _symbol = 'HOOBIES';
