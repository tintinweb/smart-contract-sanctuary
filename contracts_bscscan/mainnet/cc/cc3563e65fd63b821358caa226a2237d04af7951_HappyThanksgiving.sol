...
Official Telegram Group: https://t.me/HappyThanksgiving_Bsc
...
contract HappyThanksgiving is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x94CaDc4960d620b3FdC45Ce9c4726F467EDB291F); // Marketing Address
    ...
    string private _name = "Happy Thanksgiving Day";
    string private _symbol = "HTD";
    ...
    uint256 public _buyLiquidityFee = 4; //MARKETING 3% + BUYBACK 2%
    
    uint256 public _sellTaxFee = 2; //TO HOLDER
    uint256 public _sellLiquidityFee = 4; //MARKETING 3% + BUYBACK 3%
    ...
    uint256 public marketingDivisor = 4; //% FROM %LP
    
    uint256 public _maxTxAmount = 1 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 742121365 * 10**9; 
