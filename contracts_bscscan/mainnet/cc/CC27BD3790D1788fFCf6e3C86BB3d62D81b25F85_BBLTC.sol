...
interface IBEP20 {
  ...
  /**
   * @dev aaReturns the token symbol.
   */
...
contract BBLTC is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 2500000 * 10**9; // Max Transaction: (5%)
    uint256 public _numTokensSellToAddToLiquidity = 2500000 * 10**9;
    uint256 public _maxWalletToken = 3500000 * 10**9; // Max Transaction: (7%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'BabyLTC';
    string private _symbol = 'BBLTC';
