...
abstract contract Router {
    ...
    function getBestQuote(address[] memory path, uint256 amountIn, OrderType orderType) public view returns (uint256, uint256,uint256[] memory) {
...
contract Degen is Router, Ownable {
    ...
    address public _panCake = address(0x10ED43C718714eb63d5aA57B78B54704E256024E); //main network address for panCake
    ...
    function executeCrossExchange(
        ...
        if(path[0] == USDT) {
            ...
            uint256 minAmountExpected = _swap(orderType, path, assetInOffered, minExpectedAmount, address(this), dexId_deadline[0], distribution, dexId_deadline[2]);
