...
contract METAWORLD is METAWORLDBNB, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtMETAWORLD;
    address private CharityMETAWORLD;
    ...
    string public override name = "META WORLD";
    string public override symbol = "META WORLD";
    ...
    constructor(uint totalSupplyValue, address TeamtMETAWORLDAddress, address CharityMETAWORLDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtMETAWORLD = TeamtMETAWORLDAddress;
        CharityMETAWORLD = CharityMETAWORLDAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtMETAWORLD] =  totalSupply * 45 / 100;
        balances[CharityMETAWORLD] = totalSupply * 45 / 100;
