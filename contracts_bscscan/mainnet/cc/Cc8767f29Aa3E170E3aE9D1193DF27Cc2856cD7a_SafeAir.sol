...
contract SafeAir is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafeAir";
    string private _symbol = "SafeAir";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingTokenBalance = contractTokenBalance.div(10).mul(9);
        ...
        uint256 bnbToLiquify = bnbSwapped.div(19);
