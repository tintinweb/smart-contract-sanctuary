...
/*
 ...
 Telegram: t.me/adaland_bsc

 Earn ADA reward just by holding ADA Land.
...
contract ADALAND is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ADA Land";
    string constant _symbol = "ADALAND";
