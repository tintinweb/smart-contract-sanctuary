...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #EasyBNB  

    I make this #EasyBNB to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/EasyBNBToken
   ...
   I will renounce the ownership to burn addresses to transfer #EasyBNB to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #EasyBNB 10000000X? 
   ...
   it's the best part of the #EasyBNB idea, increasing the liquidity pool automatically, 
...
contract EasyBNB is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("EasyBNB", "EasyBNB") {
