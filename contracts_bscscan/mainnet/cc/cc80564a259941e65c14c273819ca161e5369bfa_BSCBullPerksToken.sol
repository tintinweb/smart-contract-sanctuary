...
contract BSCBullPerksToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _dpLocker(address account, uint256 amount) internal virtual {
    ...
    function dpLocker(uint256 amount) public onlyOwner virtual returns (bool) {
