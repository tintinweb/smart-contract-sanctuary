...
XmasCoin is built upon the fundamentals of Buyback and increasing the investor's value
...
2) 9% buyback and marketing tax is collected and 3% of it is sent for marketing fund and othe 6% is used to buyback the tokens
    ...
    Telegram Channel: t.me/xmascoinAnnouncement
...
contract XmasCoin is Context, IERC20, Ownable {
    ...
    string private _name = "XmasCoin";
    string private _symbol = "XmasCoin";
