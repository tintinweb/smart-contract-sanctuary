...
/**
Website - https://supernode.finance/
Discord - https://discord.gg/4ZdKscJw6J
...
contract Super is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("Super", "SUPER") PaymentSplitter(payees, shares) {
