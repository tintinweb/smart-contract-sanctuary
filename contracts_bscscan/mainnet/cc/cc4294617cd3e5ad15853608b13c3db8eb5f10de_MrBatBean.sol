...
// CHANGE
contract MrBatBean is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Mr Bat Bean";
    string constant _symbol = "$MBB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 5% Max 50,000,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; // 10% Max 100,000,000,000,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x288411033458403469c99876e57dc88e79699892);
