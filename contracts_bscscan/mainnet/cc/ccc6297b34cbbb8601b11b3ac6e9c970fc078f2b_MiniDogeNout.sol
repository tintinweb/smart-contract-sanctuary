...
Easy 100x with this token, lets moon.
Stealth Launch ~ t.me/minidogenout
...
contract MiniDogeNout is Context, IERC20, Owwnable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x90a35274844233A2e518982Ecac9d9c82183005D); // Marketing Address
    ...
    string private _name = "MiniDogeNout";
    string private _symbol = "mDogeNout";
