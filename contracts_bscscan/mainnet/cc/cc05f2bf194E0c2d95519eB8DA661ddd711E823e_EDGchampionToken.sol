...
contract EDGchampionToken is Context, IERC20, Ownable {
    ...
    uint256 public _charityAndMarketingFee = 6;
    ...
    uint256 private numTokenSwapThreshold = 500000 * 10**18;

    address deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public walletCharity = 0xfA26D85e01bc237B574D488743B9Ec46a5DDbF76;
    address public walletMarketing = 0x50c36190C95FdEa0fF11219c99FD2E7CeB575325;
    ...
    function _transfer(
        ...
        if(launchTime == 0 && to == uniswapV2Pair){
            ...
            if(antiWhaleEnable && block.timestamp > launchTime && block.timestamp < launchTime + 30*60){
                ...
                uint256 nTokenPerBNB = nTokenInPair.div(nBNBInPair).mul(10**18);
