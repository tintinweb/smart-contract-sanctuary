...
/**
   #Akson is a token inspired by SafeToken philosophy that combine together #LIQ+#RFI+#SAFEMOON for a safer token. 
      
   We have created and manage a web site https://www.akson.biz where you will find news and update about the token and our ecosystem
   You can also receive #Akson tokens as a reward by purchasing a membership on the AksonWage learning platform.
   ...
   50% tokens for marketing purpose
   ...
   it's the best part of the SafeToken idea, increasing the liquidity pool automatically, 
   help the pool grow from a small initial pool.
 */
