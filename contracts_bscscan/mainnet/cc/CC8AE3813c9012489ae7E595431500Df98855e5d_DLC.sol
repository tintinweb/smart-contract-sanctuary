...
contract DLC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x30098E104AEf3B2b358a7fb4299BdbB67246E691); // Marketing Address
    ...
    string private _name = "DLC";
    string private _symbol = "3DLC";
