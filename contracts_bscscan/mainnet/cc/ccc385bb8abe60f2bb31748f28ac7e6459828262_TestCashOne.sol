...
contract TestCashOne is Context, IERC20, Ownable {
    ...
    string private _name = "TestCashOne";      //CHANGE_REQUIRED: name of token
    string private _symbol = "TCASHONE";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
