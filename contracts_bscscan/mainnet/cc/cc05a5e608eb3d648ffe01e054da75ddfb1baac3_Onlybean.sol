...
contract Onlybean is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x51aCF8820c6dd5263F28247B16d641f6Eed9d718); // Marketing Address
    ...
    uint256 private _tTotal = 2100000000000 * 10**10 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Onlybean";
    string private _symbol = "onlybean";
    ...
    uint256 public _maxTxAmount = 200000000000 * 10**10 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 250000000 * 10**10 * 10**9; 
    uint256 private buyBackUpperLimit = 200000000000 * 10**9;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 10000000000 * 10**10 * 10**9;
    }
