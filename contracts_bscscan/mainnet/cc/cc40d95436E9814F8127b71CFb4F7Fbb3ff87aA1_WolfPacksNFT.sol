...
/*
    ...
    */
    ...
    function setInitialWolfPackLife(uint256[] memory _wolfPackId, uint256[] memory _amountOfLife) external {
        require(msg.sender == minterWalletAddress, "Invalid account");
        for(uint256 i=0; i < _wolfPackId.length; i++){
            wolfPackLife[_wolfPackId[i]] = _amountOfLife[i];
        }
    } 
