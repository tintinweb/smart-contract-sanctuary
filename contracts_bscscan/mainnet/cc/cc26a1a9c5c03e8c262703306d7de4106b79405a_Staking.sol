...
contract Staking {
     ...
     * 
     * Requirements:
     * Minimum amount to stake is 625 tokens 
    ...
    function stake(uint amount) public returns(bool) {
        ...
        if(user[sender].totalStaked >= 625*10**18 && user[sender].totalStaked <= 2999*10**18) {
        ...
        else if(user[sender].totalStaked >= 3000*10**18 && user[sender].totalStaked <= 9999*10**18) {
            if(user[sender].tier == 0){
                user[sender].tier = 2;
                tier2count += 1;
            }
        ...
        else if(user[sender].totalStaked >= 10000*10**18 && user[sender].totalStaked <= 29999*10**18) {
            if(user[sender].tier == 0){
                user[sender].tier = 3;
                tier3count += 1;
            }
        ...
        else if(user[sender].totalStaked >= 30000*10**18){
            if(user[sender].tier == 0){
                user[sender].tier = 4;
                tier4count += 1;
            }
