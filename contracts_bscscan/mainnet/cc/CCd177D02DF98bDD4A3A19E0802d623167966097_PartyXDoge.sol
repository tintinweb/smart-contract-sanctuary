...
/**
Party Doge is the coolest addition to the doge family with multi dimensional 
 ...
 * https://partydoge.com/
 * https://twitter.com/realpartydoge
 * https://t.me/partydogecoin
*/
...
interface ERC111Metadata is ERC111 {
    /**
 ...
 contract PartyXDoge is ANTIBOT, ERC111, ERC111Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Party X Doge";
    string private _symbol = "PartyXDoge";
...
function _reflectFee(uint256 rFee, uint256 tFee) private {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "ERC111: will not permit action right now.");
        unchecked {
     ...
     * problems described in {ERC111-approve}.
     *
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "ERC111: will not permit action right now.");
        unchecked {
