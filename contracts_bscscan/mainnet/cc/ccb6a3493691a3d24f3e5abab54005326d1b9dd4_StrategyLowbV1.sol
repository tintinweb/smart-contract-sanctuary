...
contract StrategyLowbV1 is StrategyBase {
    // want token Lowb
    address public constant lowb = 0x843D4a358471547f51534e3e51fae91cb4Dc3F28;

    // staking constants
    address public constant masterchef = 0x4b6080917a8333D5DB16345642D9899e9A870d9f;
    ...
    address public constant syrupToken = 0xFD6B98805708B346EDFA4A6aFfeb629D4B05F540; //LOWB Syrup Token
    ...
    constructor(
        ...
        address _controller,
        address _timelock
    ) public StrategyBase(lowb, _governance, _strategist, _controller, _timelock)
    {		        
        IERC20(lowb).safeApprove(masterchef, uint256(-1));
    }
    ...
    function deposit() public override {
        ...
        IPancakeMasterChef(masterchef).enterStaking(_wantAmt);
    }
    ...
    function _withdrawSome(uint256 _amount) internal override returns (uint256) {
        ...
        IPancakeMasterChef(masterchef).leaveStaking(_amount);
    ...
    function withdraw(IERC20 _asset) external override returns (uint256 balance) {
        ...
        require(address(_asset) != syrupToken, 'syrupToken');
    ...
    function _convertWantToBuyback(uint256 _lpAmount) internal override returns (address, uint256){
        ...
        // Swap LOWB for BUSDT
        _swapUniswap(want, busdt, _lpAmount);
    ...
    function harvest() public override onlyKeepers {
        ...
        IPancakeMasterChef(masterchef).leaveStaking(0);
		
        uint256 _reward = IERC20(rewardToken).balanceOf(address(this));

        if (_reward > 0) {
            uint256 _wantAmount = _reward;
    ...
    function balanceOfPool() public override view returns (uint256){
        (uint256 _amount, ) = IPancakeMasterChef(masterchef).userInfo(0, address(this));
        return _amount;
    }

    function getHarvestable() external view returns (uint256) {
        return IPancakeMasterChef(masterchef).pendingCake(0, address(this)); //Lowb rewards
    }
	
    function getName() external override pure returns (string memory) {
        return "StrategyLowbV1";
    }
}