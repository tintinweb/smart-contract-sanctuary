...
contract TargetVaultAutoFarmLP is TargetVaultAutoFarm {
    ...
    constructor(
        ...
        autoTokenToTokenPath = [AUTOv2, wBNB, _token];
    }
    ...
    function _harvest() internal override {
        ...
        if (swapAmt > 0) {
            ...
            swapAmt = IERC20(AUTOv2).balanceOf(address(this));
...
contract TargetVaultAutoFarm is TargetVault {
    ...
    function vaultToken() public view virtual returns (address) {
        (IERC20 _want, , , , ) = IAutoFarmV2(autoFarm).poolInfo(pid);
    ...
    function vaultStrategy() public view virtual returns (address) {
        (, , , , IAutoFarmStrategy _strat) = IAutoFarmV2(autoFarm).poolInfo(pid);
