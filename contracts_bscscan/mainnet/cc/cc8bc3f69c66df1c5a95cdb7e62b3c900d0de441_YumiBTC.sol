...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x92c541f04DfDa896Bce461c9031ea4BB59e098eD);
        _token = msg.sender;
    }
...
contract YumiBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "YumiBTC t.me/YumiToken";
    string constant _symbol = "Yumy";
