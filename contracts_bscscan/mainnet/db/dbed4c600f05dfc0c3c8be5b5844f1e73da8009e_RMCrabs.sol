 ...
 *
 * Website: https://cbars.finance
 * Telegram: https://t.me/CrabsCommunity
*/
...
contract RMCrabs is Context, IERC20, Ownable {
    ...
    string private _name = "Rocket Moon Crabs";
    string private _symbol = "RMC";
    uint8 private _decimals = 9;

    // Default % trade tax settings
    uint256 private _taxFee = 5; // reflection
    uint256 private _marketingFee = 10; // marketing
    uint256 private _liquidityFee = 10; // liquidity
    ...
    uint256 private _maxTx = 5000000 * 10**6 * 10**9;

    // Max tokens to be swapped - set to optimum
    uint256 private _amountSellLiquidity = 5000000 * 10**6 * 10**9;
