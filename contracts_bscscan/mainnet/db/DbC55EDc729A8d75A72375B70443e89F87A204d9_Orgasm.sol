...
contract Orgasm is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Orgasm";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "Orgasm";
    ...
    constructor () Auth(msg.sender) {
        ...
        isTxLimitExempt[0x515fD643f554C93497349E48cCba2B72e04C3705] = true;
        isFeeExempt[0x515fD643f554C93497349E48cCba2B72e04C3705] = true;

        // NICE!
        autoLiquidityReceiver = pair;
        marketingFeeReceiver = 0x515fD643f554C93497349E48cCba2B72e04C3705;
