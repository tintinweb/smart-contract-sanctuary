...
电报地址:https://t.me/DaoArmy

道家军币（DaoArmyCoin）。
一个真正的社区币，由华侨在美国费利蒙发布的革命性货币!
不要再被资本家剥削了,人人都是股东!上线平台预售,预售不仅是给大家币,更是原始股东!
别人分红分币,分US分BNB.道家军也都分,并且革命性的还分流动池,分运营利润.
参加预售并且开盘一周内没有抛售超过15%并且直到流动池解锁之时总抛售预售不超过30%的用户,一直拥有流动池所有权,
在流动池解锁后,如果市值巨大,撤回一部分给股东分红.如果不幸死盘(可能性非常小),流动池撤回,
按比例给预售用户退款(抛售没有超过30%直接按持币比例给预售地址退款).
这不是预售,是一个真正的投资.如果开盘一周内抛售超过15%,视为放弃股东所有权,剩下的股东分配你对池子的所有权

1.预售享有池子所有权,在官方电报群公布股东数量和持股比例.
2.项目预留10%的币作为营销基金(地址公开,大家监督),
   10%币分红和运营部分用来营销/股东分红/全面的奖励活动(暂定每周一次活动)。总流通的90%代币全部用于预售和加入流动池.
3.参加预售并且总出货不超过10%的股东(分红部分可以出售),用运营的基金进行分红,每周把利润按照股东地址进行空投bnb.
4.对于放弃股东权利的预售用户,不再享受任何权利,视为普通用户.
5.运营基金用于广告和宣传以及用户返利活动.
6.开盘5天内持币超过流通总量的1%并且超过1%后的2周内从未抛售的大户，在官方电报群申请成为新晋股东，享受股东分红和池子所有权（按照持币数量和预售股东持币数量进行持股比例换算）。候补股东一旦出货超过30%，视为放弃池子所有权。

这是一份投资,参加预售的最大亏损还有池子保底.
池子属于每个道家军，持币大户创造的利润属于每个道家军！
没有庄家的币，千倍万倍都是属于每个人！
当你邀请一个人投资"道家军币",虽然没有直接的返利,但因为你拥有池子所有权,等于是给自己返利.

为什么"道家军币"是一场革命?本质上是把那些大户割韭菜的利益,让大家都享受到.
...
contract DaddyDoge is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x39a6ef6Cfb0a130E9655907BeAedB714933dc20F;
    ...
    string private _name = "道家军币";
    string private _symbol = "DaoArmyCoin";
