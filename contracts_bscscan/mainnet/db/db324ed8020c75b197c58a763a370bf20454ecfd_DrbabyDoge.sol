...
contract DrbabyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa9d6162902850eaBec8B71fFC1Cd114e7B5Dc8f0); // Marketing Address
    ...
    string private _name = "DrbabyDoge";
    string private _symbol = "DRBABYDOGE";
