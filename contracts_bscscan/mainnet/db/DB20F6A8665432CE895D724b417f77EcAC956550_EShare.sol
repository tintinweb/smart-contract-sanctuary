...
contract EShare is ERC20Burnable, Operator {
    ...
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 23800 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 2200 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("ESHARE", "ESHARE") {
        _mint(msg.sender, 1 ether); // mint 1 EMP Share for initial pools deployment
