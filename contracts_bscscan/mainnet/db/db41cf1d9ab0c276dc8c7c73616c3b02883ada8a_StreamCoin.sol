...
/*
The STREAM blockchain connects streamers and viewers directly. By utilizing blockchain technology, users
and streamers can send and receive donations without worrying about paying very high third-party
transaction fees and slow speed. You can send STREAM to your favorite streamers wherever you are!
With blockchain, you can easily reach each other and communicate directly.
...
• Liquidity Pool 85% (Locked 2 years)
• 2% Airdrop
• 5% Founding Wallet
• 8% Marketing Wallet
...
contract StreamCoin is ERC20, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() ERC20("StreamCoin", "STREAM")  {
