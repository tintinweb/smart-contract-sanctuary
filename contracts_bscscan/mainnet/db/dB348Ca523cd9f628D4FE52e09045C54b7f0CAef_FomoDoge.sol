...
the first Rebase with doge rewards

TG: https://t.me/fomodogebsc
...
contract FomoDoge is IBEP20, Auth {
    ...
    string constant _name = "Fomo Doge";
    string constant _symbol = "FOMODOGE";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + BurnFee + buyback;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x22151c30C6d42D52bb4fd8DD8569ba9Cb031E0a5;
        BurnFeeReceiver = 0xa4b29b55ea1bC83BA3c745dC0ee56CB3a250632A;
        buybackfeeReceiver = 0xa8da90952C0f70D5B31dc7D2A30B15f9A6d41768;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != BurnFeeReceiver  && recipient != autoLiquidityReceiver && recipient != buybackfeeReceiver){
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _BurnFeeReceiver, address _buybackfeeReceiver ) external authorized {
