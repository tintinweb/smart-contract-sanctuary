...
$EMPEROR Token from EMPEROR Team

$EMPEROR is a Secure Moonrat Token fork with bug fixes and additional anti-bot / anti-whale features added
...
* 15 seconds delay between buys for the first 30 minutes of launch (limit will be completely lifted and cannot be reintroduced shortly after launch)
...
Forked and enhanced by Sir Tristan of EMPEROR Team
 ...
 *
 * Note that because there is a single `nonReentrant` guard, functions EMPERORked as
...
contract EMPEROR is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    address private EMPERORketingAddress;

    string private _name = "EMPEROR Token";
    ...
    constructor (
        ...
        EMPERORketingAddress = address(0x97e09Ed54d038295a8D6e6e77524328d7d9D3fca);
        ...
        _isExcludedFromClaimTopUp[address(EMPERORketingAddress)] = true;

        // exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[address(EMPERORketingAddress)] = true;
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'claimBNBReward:: Error: must own EMPEROR to claim reward');
