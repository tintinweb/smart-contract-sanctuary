...
contract FlokiDrinks is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x518C998e4406Ed5E1A04aE961fC654C9935F03f0); // Marketing Address
    ...
    string private _name = "FlokiDrinks";
    ...
    uint256 private _buylpPajek = 7;
    
    uint256 private _botNeedsPrevention = 1;
    uint256 private _whaleNeedsPrevention = 8;
