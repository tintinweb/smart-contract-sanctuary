...
// CHANGE
contract Iceberg  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _symbol = "ICEBERG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 6942077766613201269420 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 20) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 20) / 100; // 3% MAX 300,000
    ...
    uint256 devFee = 9; // 9%
    uint256 totalFee = 11; // liquidityFee + reflectionFee + devFee
