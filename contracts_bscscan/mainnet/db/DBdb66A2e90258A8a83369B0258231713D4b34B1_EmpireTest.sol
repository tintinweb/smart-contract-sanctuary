...
contract EmpireTest is ERC20, Pausable {
    ...
    constructor(uint256 supply) payable ERC20("Test", "TST") {
        ...
        SUPPLY = supply;
        INITIAL_LIQUIDITY = supply.mul(20).div(100); // turn back
        // INITIAL_LIQUIDITY = supply.mul(2).div(100); // remove
    ...
    function close() external {
        require(msg.sender == _owner, "ERR: sender must be owner"); // consider
