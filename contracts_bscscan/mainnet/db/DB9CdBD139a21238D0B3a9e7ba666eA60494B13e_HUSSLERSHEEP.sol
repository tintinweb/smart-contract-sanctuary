                    ...
                    \_`_'_/      /###/@@@@/       :###; :@@@@@;
                     ~~~~~      ;###;@@@@/        :##;  `:@@@@;
                               ...
                               `-^--;@@@@/               `-^--'
                                    :~~~~:
                                    \/\_/
 __   __  __   __  _______  _______  ___      _______  ______    _______  __   __  _______  _______  _______ 
|  | |  ||  | |  ||       ||       ||   |    |       ||    _ |  |       ||  | |  ||       ||       ||       |
|  |_|  ||  | |  ||  _____||  _____||   |    |    ___||   | ||  |  _____||  |_|  ||    ___||    ___||    _  |
|       ||  |_|  || |_____ | |_____ |   |    |   |___ |   |_||_ | |_____ |       ||   |___ |   |___ |   |_| |
|       ||       ||_____  ||_____  ||   |___ |    ___||    __  ||_____  ||       ||    ___||    ___||    ___|
|   _   ||       | _____| | _____| ||       ||   |___ |   |  | | _____| ||   _   ||   |___ |   |___ |   |    
|__| |__||_______||_______||_______||_______||_______||___|  |_||_______||__| |__||_______||_______||___|    

TELEGRAM: https://t.me/HusslerSheep
...
Unique double dip mechanic. This token is build for HOLDING! 
Sell taxes are huge so HODL and get those juicy BUSD dividends send to your wallet!
Whenever some does sell (WHY WOULD YOU LOOK AT THOSE REWARDS) all rewards will be doubled!
This is Madness! Hussling has never been this profitable!

❗️❗️❗️❗️❗️BUY TAX: 19%   -    SELL TAX 38%❗️❗️❗️❗️❗️ 
     49% slippage recommended on sale! 
...
contract HUSSLERSHEEP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HUSSLERSHEEP";
    string constant _symbol = "HUSSLERSHEEP";
