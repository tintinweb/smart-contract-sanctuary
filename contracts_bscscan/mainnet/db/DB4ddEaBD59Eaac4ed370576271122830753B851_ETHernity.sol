...
contract ETHernity is IERC20, Ownable {
    ...
    uint256 buyLiquidityFee = 300;
    uint256 buyReflectionFee = 800;
    uint256 buyMarketingFee = 400;
    uint256 buyTotalFee = 1500;

    uint256 sellLiquidityFee = 1000;
    uint256 sellReflectionFee = 1000;
    uint256 sellMarketingFee = 1000;
    uint256 sellTotalFee = 3000;

    uint256 feeDenominator = 10000;

    /** MAX TX/WALLETS */
    uint256 public _maxBuyTxAmount = (_totalSupply / 20); // 1% of supply
    uint256 public _maxSellTxAmount = (_totalSupply / 20); // 0.5% of supply
    uint256 public _maxWalletSize = (_totalSupply / 20); // 5% of total supply
    ...
    constructor() {
        ...
        marketingFeeReceiver = payable(0xB1B4Ea89F214751A7E1514F13D628457ad9d45B9);
