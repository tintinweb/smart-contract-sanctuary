...
contract MoshiNeko is Context, IERC20, Ownable, Pausable 
{
    ...
    string private _name = "MOSHI NEKO";
    string private _symbol = "MOSH";
    ...
    address payable public marketingWallet =  payable(0xB8ed18991a1cFfeCee0876097Fcd4DA2c47FDD63);
    ...
    uint256 public  maxLimit = 2000000000 * 10**18;
    ...
    function  setMaximumLimitPerWallet(uint256 _amount) public onlyOwner 
    {
            maxLimit = _amount;
    }
