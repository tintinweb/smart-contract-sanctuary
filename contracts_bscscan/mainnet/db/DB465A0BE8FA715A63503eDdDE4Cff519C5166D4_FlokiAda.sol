...
/**
 * TELEGRAM: HTTPS://T.ME/FlokiAda
    
       #LIQ+#RFI+#SHIB+#DOGE = #BUSD

   #FLOKIADA features:
   3% fee auto add to the liquidity pool to locked forever when selling
   7% fee auto distribute to all holders As Rewards
   I created a black hole so #BUSD token will deflate itself in supply with every transaction
...
contract FlokiAda is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xd188EE5226A8E977c3CB88AeFcF5dAc464b22dcd;
 
    string constant _name = "FLOKI ADA";
    string constant _symbol = "$FADA";
