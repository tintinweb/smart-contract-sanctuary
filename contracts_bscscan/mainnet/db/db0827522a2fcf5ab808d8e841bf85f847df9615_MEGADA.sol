...
contract MEGADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MEGADA";
    string constant _symbol = "MEGADA";
    ...
    function GoSUPER(uint256 amount, bool triggerBuybackMultiplier) external authorized {
