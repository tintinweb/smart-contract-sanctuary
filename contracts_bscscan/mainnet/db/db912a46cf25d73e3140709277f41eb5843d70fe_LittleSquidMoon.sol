...
contract LittleSquidMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Little Squid Moon";
    string private _symbol = "LSQM";
    ...
    uint256 private numTokensSellToAddToLiquidity = 9_000 * 10**9;
