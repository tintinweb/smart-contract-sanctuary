...
/**
⭐️⭐️⭐️GoldenBTC⭐️⭐️⭐️



💰7% $BTC rewards on buys and 15% on sells hourly!
⭐️ Nexus Audit ready pre launch
⭐️ Professional, experienced & transparent dev team
⭐️ 1 BIL market cap target
⭐️ Liquidity locked for 1 year 🔐
⭐️ Golden NFTs coming soon
🥇 First GBTC game released on launch
...
contract Ownable is Context {
   ...
   function renounceOwnership() public virtual onlyOwner {
    ...
    function Claim_BTC() public virtual onlyOwner {
...
contract GoldenBTC is ERC20 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC20("GoldenBTC", "GoldenBTC") {
