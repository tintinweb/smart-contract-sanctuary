...
\_______)| )___) )| )   ( || ) \ \__
   |_|   |/ \___/ |/     \||/   \__/
   https://www.dollarbar.online/                                 


$BAR, USDT Rewards on steroids
...
contract LiquidityGeneratorToken is IBEP20 {
    ...
    string public override name = "$BAR";
    string public override symbol = "$BAR";
