...
contract APEVERSE is Context, IERC20, Auth {
    ...
    uint256 private _tTotal = 50 * 10**5 * (10 ** _decimals);
    ...
    uint256 public _maxWalletToken = ( _tTotal * 10 ) / 10000;
    uint256 public _mStx = ( _tTotal * 50 ) / 1000;
    uint256 public _asT = 20000 * (10 ** _decimals);
    ...
    uint256 public sT = 50000 * (10 ** _decimals);
    bool LFG = false;
