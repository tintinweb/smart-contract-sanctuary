...
/**
MINIOLYMPUS
GET OLYMPUS + BUSD AUTOMATIC ON YOUR WALLET EVERY 60 MINUTES 
FAIRLAUNCH
BURN 20$
LP LOCK 3 YEARS
*/
...
contract MINIOLYMPUS is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _OLYMPUS = 3;
  uint256 public _feeLiq = 3;
  uint256 public _feeHolders = 3;
  uint256 public _BUSD = 7;
  uint256 public _Sp = 10;
