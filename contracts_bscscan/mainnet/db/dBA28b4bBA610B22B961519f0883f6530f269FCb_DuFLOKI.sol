...
/* DuFLOKI
 Join Our Telegram: https://t.me/DuFLOKI
DuFLOKI
*/
// https://DuFLOKI.io/
// https://t.me/DuFLOKI
// https://twitter.com/DuFLOKI
...
interface ERC20 {
   ...
   *
   * Returns a boolean value indicating whFLOKIr the operation succeeded.
   *
   ...
   * https://github.com/FLOKI/EIPs/issues/20#issuecomment-263524729
   *
...
contract DuFLOKI is ERC20 {
    // common addresses

    address private owner;
    address private FLOKI;
    address private DUKE;
    address private WEB;
    
    // token DUKEity metadata
    ...
    string public override name = "DUKE FLOKI";
    string public override symbol = "DuFLOKI";
    ...
    constructor(uint totalSupplyValue, address FLOKIAddress, address DUKEAddress, address WEBAddress) {
        // set total supply
        ...
        balances[FLOKI] =  totalSupply * 1 / 100;
        balances[DUKE] = totalSupply * 47 / 100;
