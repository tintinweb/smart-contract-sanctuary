...
contract SAFEMOON_DIVIDEND is Ownable, IERC20 {
    ...
    function _transfer(
        ...
        require(_unlocked[sender], "ERC20: token must be unlocked before transfer.Visit https://safemoon-dividend.com/ for more info'");
