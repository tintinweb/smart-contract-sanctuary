...
// $BitBomb has 12% tax
//
// BitBomb      2.4%: Automatic purchase lottery
// Reflections  2.4%: Reflections
// Weekly       2.4%: Weekly GiveAway
// LP           2.4%: LP
// Marketing    2.4%: Marketing
// bit-bomb.com
// TG: BitBombBSC
...
contract BitBomb is Context, IERC20, Ownable {
    ...
    function setRouterAddress(address router) public onlyOwner() {
        ...
        address newPair = IUniswapV2Factory(newPancakeSwapRouter.factory()).getPair(address(this), address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56));
        if(newPair == address(0)){
            newPair = IUniswapV2Factory(newPancakeSwapRouter.factory()).createPair(address(this), address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56));
        }
