...
/**
* Welcome to Billgate INU!
*
* Telegram: t.me/billgateinubsc
* Twitter: twitter.com/billgateinubsc
* 
*
* BUY/SELL TAX = 9%
*
* 3% tax for Liquidity (lets moon together!)
* 2% tax reflected to HODLERS (get that juice!)
* 3% tax to marketing wallet (amazing marketing incoming!)
* 1% tax for development of the game (web3 huh?)
*
* 10%-15% recommended slippage
*
* Total supply: 100 000 000 000 Billgate Inu
...
contract BillgateInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "BILLGATE INU";
