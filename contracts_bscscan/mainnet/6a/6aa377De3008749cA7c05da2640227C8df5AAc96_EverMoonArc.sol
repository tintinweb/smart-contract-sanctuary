...
/**
    EverMoonArc -  EverMoonArc
    
    Telegram: @EverMoonArc
...
contract EverMoonArc is Context, IERC20, Ownable {
    ...
    string private _name = "EverMoonArc Floki";
    string private _symbol = "EMOONARC";
