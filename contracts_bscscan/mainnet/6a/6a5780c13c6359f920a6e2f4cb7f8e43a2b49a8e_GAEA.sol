...
contract GAEA is Context, IERC20, Ownable {
    ...
    string private _name = "GAEA Space Polemos";
    ...
    address public marketingWallet = 0xE97Ef2c22D6AAf50892572eCc9d02c205F78b72B;
    uint256 private _previousMarketingFee = _marketingFee;
    
    uint256 public _charityFee = 3;
    address public charityWallet = 0x17BD19044F3f61745325E60f2d939291801d591a;
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax,, liquidity, marketing and charity fee
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 charityFee) external onlyOwner() {
        _taxFee = taxFee;
