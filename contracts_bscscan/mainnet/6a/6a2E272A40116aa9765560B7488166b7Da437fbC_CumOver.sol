...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4CDdd58290D5c09fEA9AeC8E132Ea7cD1f404618;
...
contract CumOver is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9b91C8e0583d60Bf2c67678f548D2ae1Ef6580DD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 800000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cum Over";
    ...
    uint256 public _maxTxAmount = 80000000000 * 10**18;
