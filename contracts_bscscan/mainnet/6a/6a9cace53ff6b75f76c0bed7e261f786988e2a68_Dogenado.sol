...
Dogenado is a community driven Buyback & Rewards token.

Fair Launch

✅Community Driven Token

♻️15% Tax on Transactions
...
TG: https://t.me/DogenadoBSC

15% Tax - Tokenomics Breakdown
 - 5% $BUSD Rewards to holders automatically every two hours. 
 - 5% Marketing Wallet
 - 5% Liquidity Pool

in the holiday spirit we are giving away .05 BNB to 5 Lucky Holders. Type "santa" plus a number from 1-100 in the chat


 Telegram: https://t.me/DogenadoBSC
 Website:TBA
...
//SPDX-License-Identifier: Unlicensed 
    ...
    contract Dogenado is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "Dogenado";
        string constant _symbol = "Dogenado";
