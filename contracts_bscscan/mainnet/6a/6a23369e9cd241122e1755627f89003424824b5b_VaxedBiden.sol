...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DZ = IBEP20(0x370220f460C65E87a87341F48cC18BCbdbc18433);
...
contract VaxedBiden is IBEP20, Auth {
    using SafeMath for uint256;

    address DZ = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "VaxxedBiden";
    string constant _symbol = "VABID";
    uint8 constant _decimals = 4;

    //Total Supply: 100.000.000.000
    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);

    //max wallet holding of 3% (3.000.000.000 Tokens per Wallet)
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100; // 3% of total Supply (2.000.000.000)
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4D7238E97971088AF2288cEE891632BbE372B739;

        uint deployerSupply = _totalSupply;
