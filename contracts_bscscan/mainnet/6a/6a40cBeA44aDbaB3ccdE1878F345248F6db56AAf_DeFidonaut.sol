...
/*
    DeFidonaut
    Elon's Mission to Space this Weekend is Joined by Flokinaut, and now, DeFidonaut.
    Telegram: @DeFidonaut
*/
...
contract DeFidonaut is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10**11 * 10**17;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            uint256 burnAmount = amount.mul(18).div(100);
