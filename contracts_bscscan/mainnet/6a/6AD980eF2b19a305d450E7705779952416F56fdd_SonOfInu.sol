...
/**
  $SOI  is a stealth launch project that can earn while holdings.. we have anti-whale and rewarding while holding that is available on Pancake swap. 
TG: https://t.me/SonofInuBsc
*/
...
contract SonOfInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Son Of Inu";
    string constant _symbol = "SOI";
    uint8 constant _decimals = 2;
    uint256 constant _divisor = 1000;

    uint256 _totalSupply = 10 * 10**10 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply*(1000/_divisor);
    uint256 public _maxWalletToken = _totalSupply*(3000/_divisor);
    ...
    uint256 public swapThreshold = _totalSupply * 1000 / 10000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x404b47394e68e686EEd803C5cF6A4Ed8735727Bb;
        marketingFeeReceiver = 0x516E2828BD55Be42a482E9E1d1a9d428648D13Ce;
        teamFeeReceiver = 0x404b47394e68e686EEd803C5cF6A4Ed8735727Bb;
        charityFeeReceiver = 0x404b47394e68e686EEd803C5cF6A4Ed8735727Bb;
        burnFeeReceiver = 0x404b47394e68e686EEd803C5cF6A4Ed8735727Bb;
