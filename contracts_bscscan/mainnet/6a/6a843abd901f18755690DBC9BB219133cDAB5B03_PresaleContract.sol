...
contract PresaleContract is Context, Ownable, ReentrancyGuard{
    ...
    uint256 public priceRatio = 624000;
    ...
    constructor(IERC20 _rewardToken, uint256 _releaseTimeStamp, uint _hardcap ) public {
    ...
    function enterPresale() public payable nonReentrant{
        require(isAvailable, "presale is not available");
    ...
    function setIsAvailable(bool _bool)public onlyOwner {
        isAvailable = _bool;
    }
