...
contract MetaSpeed is Context, IBEP20, Ownables {
    ...
    constructor (string memory _names, string memory _symbol, uint256 _decimals, uint256 _supply,address _FeeAddress,address tokenOwner) {
        _NAME = _names;
        _SYMBOL = _symbol;
        _DECIMALS = _decimals;
