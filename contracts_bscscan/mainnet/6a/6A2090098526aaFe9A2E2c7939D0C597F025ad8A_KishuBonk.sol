...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DZ = IBEP20(0xAe2DF9F730c54400934c06a17462c41C08a06ED8);
...
contract KishuBonk is IBEP20, Auth {
    using SafeMath for uint256;

    address DZ = 0xAe2DF9F730c54400934c06a17462c41C08a06ED8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "KishuBONK";
    string constant _symbol = "KIBO";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x225382c6BD206a2b8bB92BF79189D7d5Cde75b0B;
