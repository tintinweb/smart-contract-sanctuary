...
/**
    ...
    Tax fee 3%
    Liquidity fee 8%
    Max transaction 0.5% (50000000)
    Max wallet 1.5% (150000000)
...
contract XDoge is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**9; // Max Transaction: 5 Million (.5%)
    uint256 public _numTokensSellToAddToLiquidity = 25 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 15 * 10**6 * 10**9; // Max Wallet: 15 Million (1.5%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'X-men Doge';
