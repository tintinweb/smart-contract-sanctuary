...
/**
Lunar Arch Verse is a decentralized virtual world building game that supports NFT
creation and trading and Play To Earn mode.
Anyone can own virtual land in the Lunar Arch Verse world, design and create various buildings and virtual items,
and realize the auction and exchange of virtual items through NFT.

Website : https://LunarArchVerse.live
...
contract LunarArchVerse is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**7 * 10**4; // 10B 
    ...
    string private _name = "LunarArchverse";
    string private _symbol = "LARVES";
