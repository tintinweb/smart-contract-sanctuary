...
contract EVGtest is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("EVGtest", "EVGtest", uint8(DECIMALS)) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Cake 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        marketingFeeReceiver = 0x6e8494554BEAA06Bd8a923381aeB94eB30845789;
        ecosystemFeeReceiver = 0x6FeBdE0ae2Ed2F2bd50a322fa08f5f1b882bCd18;
        buyBackFeeReceiver = 0xaA6Ff16753212A482E93a35a5F6B389eB4963DAd;
    ...
    function setFees(
        ...
        totalFee = ecosystemFee.add(liquidityFee).add(marketingFee).add(
            buyBackFee
        );
