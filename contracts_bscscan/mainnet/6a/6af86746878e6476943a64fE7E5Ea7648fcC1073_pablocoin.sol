...
contract pablocoin is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "pablocoin";
    string constant _symbol = "pablocoin";
    ...
    function setSellMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 10 && multiplier * totalFee <= 10000, "Multiplier too high");
