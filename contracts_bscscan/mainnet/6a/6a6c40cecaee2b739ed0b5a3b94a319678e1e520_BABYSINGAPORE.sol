...
/*
    ...
    Total supply 500 $BabySG's, decreasing 5% every transaction,
    5% distributed to all hodlers automatically, the strong holder will get a valuable reward
...
contract BABYSINGAPORE is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Baby Singapore';
    string private constant _symbol = 'BABYSG';
