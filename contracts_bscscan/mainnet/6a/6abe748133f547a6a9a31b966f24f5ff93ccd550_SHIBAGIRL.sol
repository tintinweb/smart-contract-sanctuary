...
contract Ownable is Context {
    address private _owner = 0x7015ECa896447732D0477988fD4CDfD35f43aEB7;
...
contract SHIBAGIRL is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x45f94Fb35Aa039Ce588174b62c19929D0413F1a8); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Girl Shiba"; // token name
    string private _symbol = "Shib Girl"; // token symbol
    ...
    uint256 _buyBackFee = 0; // buyback fee 10%
    uint256 private _previousBuyBackFee = _buyBackFee; // buyback fee

    uint256 _marketingBNBFee = 0; // marketing BNB fee
