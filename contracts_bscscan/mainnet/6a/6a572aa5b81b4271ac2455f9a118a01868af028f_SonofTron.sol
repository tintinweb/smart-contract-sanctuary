...
contract SonofTron is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2fa1F4e75d472C99B082Ad379aE5d8cAEB89088D); // Marketing Address
    ...
    string private _name = "SonofTron";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x2fa1F4e75d472C99B082Ad379aE5d8cAEB89088D);
    }
