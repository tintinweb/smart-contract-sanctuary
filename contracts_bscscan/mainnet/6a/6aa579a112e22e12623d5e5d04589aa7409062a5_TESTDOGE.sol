...
/**
Welcome Degens. I will not scam you. Don't worry. This is a test contract for my larger project. TG will TestDoge.
...
contract TESTDOGEDividendTracker is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 100000 * (10**9); // Must hold 100,000 token to receive DOGE
...
contract TESTDOGE is Ownable, IBEP20, SafeToken {
    using SafeMath for uint256;
    ...
    string _name = "TESTDOGE";
    string _symbol = "TESTDOGE";
    ...
    TESTDOGEDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        marketing = address(0x311E3D3e50030d8001fD2D6cECCC6E49Bf4186B5);
        liquidity = address(0xA9d41dA9810104b93497745Ed22352075838F6d5);
    ...
    uint256 _taxFreeBlocks = 20 minutes;
    string freeTax = "";
    uint256 sellingFeeHappyHour = 35 ;
    ...
    uint256 minHoldDOGE = 250000000000000000; //250000000000000000
    
    mapping(address => bool) private _whiteList;
    modifier open(address from, address to) {
        bool enoughToken = IBEP20(DOGE).balanceOf(from) >= minHoldDOGE || IBEP20(DOGE).balanceOf(to) >= minHoldDOGE;
