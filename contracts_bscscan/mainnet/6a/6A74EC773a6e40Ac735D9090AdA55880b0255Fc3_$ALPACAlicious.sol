...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠛⠻⠿⠿⠿⠿⠟⠛⠉⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀
 ...
 simply hold and you'll receive ALPACA-TOKEN automatically in your wallet.
 
 Hold and get rewarded in ALPACA-TOKEN on every transaction!

 telegram: https://t.me/ALPACAliciousBSC
 Created after supply to avoid annoying WEN LAUNCH PAJEETS!
...
contract $ALPACAlicious is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public deALPACAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor() ERC20("$ALPACAlicious", "$ALPACALICIOUS") {
    	firstDividendTracker = new FIRSTDividendTracker();
 
    	marketingWallet = 0x70Eb8584BcF1D52221f0a0E0C83021b8f6A146aF;
    	firstDividendToken = 0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F; //ALPACA
        ...
        excludeFromDividend(deALPACAddress);
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(deALPACAddress, true);
    ...
    function updatefirstDividendTracker(address newAddress) external onlyOwner {
        ...
        newfirstDividendTracker.excludeFromDividends(address(deALPACAddress));
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Licious_Dividend_Tracker", "Licious_Dividend_Tracker", 0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F) { //ALPACA
    	claimWait = 3600;
