...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CHIKUINU = IERC20(0x2C14CBffD9963C17fF65028C52f75Ea6f14205Ff);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CHIKUINU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CHIKUINU);
        ...
        uint256 amount = CHIKUINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CHIKUINU.transfer(shareholder, amount);
...
contract ChikuSnow is IERC20, Ownable {
    using SafeMath for uint256;

    
    address CHIKUINU = 0x2C14CBffD9963C17fF65028C52f75Ea6f14205Ff;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ChikuSnow";
    string constant _symbol = "CHIKUSNOW";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xF2Bc6cc6fe2d41BE1C20b7276088C88F8DFfb616);
        marketingFeeReceiver = address(0xF2Bc6cc6fe2d41BE1C20b7276088C88F8DFfb616);
