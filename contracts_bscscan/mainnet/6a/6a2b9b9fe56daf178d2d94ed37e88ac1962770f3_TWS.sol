...
* 
* 
*         Join our official Telegram : https://t.me/TheWalkingShiba
* 
* 
*/
...
contract TWS is Context, IERC20, Ownable {
    ...
    string private _name = 'TheWalkingShiba';

    string private _symbol = 'TWS';
    ...
    function _burn(uint256 amount) external onlyOwner() {
        require(_balances[msg.sender] > amount, "ERC20: burn amount exceeds balance");
         _tokenTransfer(msg.sender,address(0),amount);
    }
