...
contract YUKIAIRDROP is Ownable {
    using SafeMath for uint256;
    uint256 public tokenAtm = 20*1e18;
    uint256 public refAtm = 10*1e18;
    ERC20 public tokenInstance;
    // Addresses that excluded from antiWhale
    mapping(address => bool) private claimed;
    constructor(
        address _tokenInstance) public {
    ...
    function getAirdrop(address ref) public {
        ...
        tokenInstance.transfer(msg.sender, tokenAtm);
        if(msg.sender!= address(0)
        && msg.sender!= ref)
        {
        tokenInstance.transfer(ref,refAtm);
