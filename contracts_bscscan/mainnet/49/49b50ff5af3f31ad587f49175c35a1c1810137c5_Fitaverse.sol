...
contract Fitaverse is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _NAME = "Fitaverse";
    string constant _SYMBOL = "FIT";
    ...
    uint8 public marketingFeeOnBuy = 3;
    ...
    uint8 public HuHdistributionFeeOnSell = 4;
    ...
    uint256 public maxTxAmount = _tTotal.mul(1).div(10**2); // 
    uint256 public amountOfTokensToAddToLiquidityThreshold = 1*10*9; // 
    ...
    constructor() {
        ...
        rewardDistributor = IRewardDistributor(0x697c843c50c3992536cDAE713c50E15E41Ba288B);
        _allowances[address(this)][address(rewardDistributor)] = _MAX;
        _allowances[address(rewardDistributor)][address(pcsV2Router)] = _MAX;

        marketingWallet = 0xEe1ff70ed14BbCb42Fc8ba6fdc66366f22B76000;
