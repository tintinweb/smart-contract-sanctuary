...
// File: contracts/interfaces/IStakingReward.sol
...
// File: contracts/SnowBankVaultXBLZD.sol
...
contract SnowBankVaultXBLZD is IStakingReward, Ownable , ReentrancyGuard {
    ...
    IYetiMaster private constant YETIMASTER = IYetiMaster(0x321f393e3C5744C576c41AEe18774a4266c9E1Ab);
    address private constant XBLZD = 0x5042E3FCb08eb5637116B214697f0Ea306588C76;
    ...
    // Reward ID 0 GALE 1 TEMPEST 3 xBLZD
    ...
    constructor(
        ...
        xBLZD = IYetiMaster(YETIMASTER).xBLZD();
    ...
    function _safeAddLiquidity() internal virtual {
      ...
      if (token0Amt > 0 && token1Amt > 0) {
          IERC20(XBLZD).safeIncreaseAllowance(
                address(ROUTER),
                token0Amt
          );
    ...
    function _harvest() private {
        ...
        _safeAddLiquidity();
        uint256 lpForTEMPESTAfter = IERC20(stakingToken).balanceOf(address(this));
        uint256 lpForTEMPEST = lpForTEMPESTAfter.sub(lpForTEMPESTBefore);
