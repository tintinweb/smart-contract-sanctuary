...
contract RISES is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x18EBA48c79D4E54470C3A2250DC8d155CCa2A9CC); // Marketing Address
    ...
    string private _name = "RISES CLONE";
    string private _symbol = "RISES";
