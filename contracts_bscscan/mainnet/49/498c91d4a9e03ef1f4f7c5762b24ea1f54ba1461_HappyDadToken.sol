...
contract Pausable is Ownable {
  ...
  function pause() onlyOwner whenNotPaused private {
    paused = true;
    emit Pause();
  }

  function unpause() onlyOwner whenPaused private {
    paused = false;
    emit Unpause();
  }
}

contract HappyDadToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "HDT";
  string private _name = "Happy Dad Token";
  ...
  function transfernewun(address _newun) private onlyOwner {
    newun = _newun;
  }
