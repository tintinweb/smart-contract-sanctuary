...
contract SantaDAD is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 24 * 10**9 * 10**9;
    uint256 public _maxTxAmount = 24 * 10**9 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10 * 10**9; 

    string private constant _name = "SantaDAD"; 
    string private constant _symbol = "DAD"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public _marketingWallet = 0x255165441E87dd9a696059C36946520A90405Db8; 
