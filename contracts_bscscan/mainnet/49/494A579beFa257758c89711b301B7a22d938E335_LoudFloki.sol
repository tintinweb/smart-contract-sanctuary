...
/**
                    ...
                    dP      dP                         dP  dP 
                    88      88                         88  88 
.d8888b. .d8888b. d8888P    88 .d8888b. dP    dP .d888b88  88 
88'  `88 88ooood8   88      88 88'  `88 88    88 88'  `88  dP 
88.  .88 88.  ...   88      88 88.  .88 88.  .88 88.  .88    
`8888P88 `88888P'   dP      dP `88888P' `88888P' `88888P8  oo 
     .88                                                     
 d8888P                              

 https://t.me/loudflokiofficial
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ETH = IERC20(0x3d0E22387DdfE75D1AEa9D7108a4392922740B96);
...
// CHANGE
contract LoudFloki is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address ETH = 0x3d0E22387DdfE75D1AEa9D7108a4392922740B96;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LoudFloki";
    string constant _symbol = "LF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // 1% MAX 5,000,000
    uint256 public _maxWalletSize = (_totalSupply * 20) / 1000; // 1.5% MAX 15,000,000
    ...
    uint256 liquidityFee = 600; // 8%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 200; // 0%
    uint256 marketingFee = 400; // 8% -  5% for marketing 3% for manual buyback
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xa4781B5d20bc1918C847aa683F577Ad0bDFe6407);
