...
contract PandaVotesPANDA {

  function name() public pure returns(string memory) { return "PandaVotesPANDA"; }
  function symbol() public pure returns(string memory) { return "PandaVotesPANDA"; }
  function decimals() public pure returns(uint8) { return 18; }  

  function totalSupply() public view returns (uint256) {
  IPair pair1 = IPair(0x97f6665ac6b2d7C3d5a2aD11d7a779787F617ce0);
  ...
  function balanceOf(address owner) public view returns (uint256) {
    ...
    // LP pair2
    (uint256 lp1_totalpandaA, uint256 lp1_totalpandaB,) = pair1.getReserves();
    (uint256 lp1_userpanda,) = chef.userInfo(3, owner);
