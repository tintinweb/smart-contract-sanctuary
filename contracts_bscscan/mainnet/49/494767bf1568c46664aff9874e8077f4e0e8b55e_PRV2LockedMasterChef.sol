...
contract PRV2Referral is IPRV2Referral, Ownable {
 ...
 contract PRV2LockedMasterChef is Ownable,ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;
    ...
    function pendingPrv2(uint256 _pid, address _user) external view returns (uint256) {
    ...
    function withdraw(uint256 _pid) public  nonReentrant{
        ...
        uint256 commissions =  prvReferral.payReferralComission(msg.sender, finalReward,true);
