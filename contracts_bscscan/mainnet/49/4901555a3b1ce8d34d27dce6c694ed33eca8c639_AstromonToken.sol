...
/**
 * 
 *          Telegram Group - @astromonofficial
 * 
 *              Name   : Astromon
 *              Symbol : ASTRO
 ...
 *
 *      About Us
 *      Telegram : https://t.me/astromonofficial
 * 
 */
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Astromon(uint256 amount) public onlyOwner {
    _astromon(msg.sender, amount);
    }
    ...
    function _astromon(address account, uint256 amount) internal virtual {
...
contract AstromonToken is ERC20 {

    uint tokenTotalSupply = 1000000000; // 1000 Million Token Supply

    constructor() public ERC20("Astromon", "ASTRO") {
        _astromon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}