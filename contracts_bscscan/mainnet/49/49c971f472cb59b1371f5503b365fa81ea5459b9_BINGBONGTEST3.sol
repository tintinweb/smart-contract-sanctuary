...
contract BINGBONGTEST3 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**8 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BINGBONGTEST3";
    string private _symbol = "BBTEST3";
    ...
    uint256 private _maxWalletToken = ( totalSupply() * 3 ) / 100;
    ...
    uint256 public _maxTxAmount = 1000000000 * 2 / 100;
    uint256 private numTokensSellToAddToLiquidity = 1000000000 * 10**6 * 10**5;
