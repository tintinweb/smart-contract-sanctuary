...
contract ParaInu is ParaInuetr, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private Teamtetr;
    address private Charityetr;
    ...
    string public override name = "ParaInu";
    string public override symbol = "PARAINU";
    ...
    constructor(uint totalSupplyValue, address TeamtetrAddress, address CharityetrAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        Teamtetr = TeamtetrAddress;
        Charityetr = CharityetrAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Teamtetr] =  totalSupply * 45 / 100;
        balances[Charityetr] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's Teamtetr pot
