...
TheLastCake - First token launch on BitcoinPunkz Launch Pad 

Telegram: T.me/TheLastCakeOfficial
...
contract TheLastCakeDividendTracker is IDividendDistributor {
...
contract TheLastCake is Ownable, IBEP20, SafeToken {
    using SafeMath for uint256;
    ...
    address BitcoinPunkz = 0xe83706385E6F651AAE54EC563bB8Bf471fd8CcCB;

    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) _allowances;

    string _name = "TheLastCake";
    string _symbol = "TheLastCake";
    ...
    address public liquidity = address(0xFA8686B404f5341559a204d04495DCBCcce425A9);
    address public buyback = address(0x738Cfe123732cd3A49E371B346E83d815616ef53);

    IDEXRouter public router;
    address pair;

    TheLastCakeDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new TheLastCakeDividendTracker();
    ...
    uint256 blockWindow = 30 minutes;
    bool _hitFloor;
    uint256 _taxFreeWindowEnd;
    uint256 _taxFreeBlocks = 15 minutes;
    string freeTax = "";
    uint256 sellingFeeHappyHour = 30;
    ...
    uint256 minHoldBitcoinPunkz = 250000000000000000; //250000000000000000
    
    mapping(address => bool) private _whiteList;
    modifier open(address from, address to) {
        bool enoughToken = IBEP20(BitcoinPunkz).balanceOf(from) >= minHoldBitcoinPunkz || IBEP20(BitcoinPunkz).balanceOf(to) >= minHoldBitcoinPunkz;
