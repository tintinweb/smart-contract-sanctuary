...
contract MonkeCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x901C13AdBc94F5638ae71a42EBDfd1e3BbC3F131;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Monke Coin";
    string constant _symbol = "NANAS";
