...
Official Telegram group : https://t.me/batflokiofficial
...
import "./bFlokiDividendTracker.sol";
...
contract bFloki is ERC20, Ownable {
    ...
    bFlokiDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Bat Floki", "bFloki") {

    	dividendTracker = new bFlokiDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "bFloki: The dividend tracker already has that address");

        bFlokiDividendTracker newDividendTracker = bFlokiDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "bFloki: The new dividend tracker must be owned by the Bat Floki contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "bFloki: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "bFloki: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "bFloki: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "bFloki: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "bFloki: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "bFloki: Cannot update gasForProcessing to same value");
