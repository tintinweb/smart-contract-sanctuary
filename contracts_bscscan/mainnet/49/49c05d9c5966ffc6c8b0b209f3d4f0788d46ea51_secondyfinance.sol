...
/**
   ...
   2yfinance on Binance Chain
   
   14% distributed to token holders
...
contract secondyfinance is Context, IERC20, Ownable {
    ...
    string private _name = "2yfi 2.0";
    string private _symbol = "2yfi";
