...
/**
       we give a cashback to all $RFloki Holders earn automatic rewards in $Floki
       TG : @RewardsFloki
       WEB : Rewards-floki.com
	Fair launch start today 17:00 UTC 
 */
...
contract RewardsFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Rewards Floki";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x2ac5d863ea5be5a950de311A9a8d99a23d86E892;
