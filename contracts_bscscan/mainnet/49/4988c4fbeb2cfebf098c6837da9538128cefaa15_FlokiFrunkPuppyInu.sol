...
contract Ownable is Context {
    ...
    constructor() internal {
        _owner = 0x54Ab913AD5adaf38F4D63Eedcb7a82EA3C5DF132;
...
contract FlokiFrunkPuppyInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "FlokiFrunkPuppy Inu";
    string private _symbol = "FFPI";
    ...
    uint256 internal _tokenTotal = 10_000_000_000_000e9;
    ...
    uint256 public _buytaxFee = 500;
    uint256 public _buyliquidityFee = 500; 
    
    
    uint256 public _selltaxFee = 500;  // means 5% to holders
    
    uint256 public _sellliquidityFee = 1500;  // means 15% goes to Lp
    ...
    uint256 private minTokensBeforeSwap = 1_000_000e9;
    ...
    constructor() public {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // for  pancake v2
