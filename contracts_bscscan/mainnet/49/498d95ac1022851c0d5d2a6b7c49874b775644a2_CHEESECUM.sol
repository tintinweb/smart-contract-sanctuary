...
CHEESECUM, the World's Best Investment Company

5% Tax on transactions.
3% Distributed to holders, hold and earn.
...
contract DeflationaryERC20 is Context, IERC20, Ownable {
    ...
    // Transaction Fees:
    uint8 public txFee = 0; // capped to 5%.
   ...
   /* function _burn2() internal {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(TIME = true && timeNow < transData[sender] + 30 minutes){
            revert("PRICE PROTECTION MEASURES IN PLACE, ONLY SELL 1 Sale PER 30 MIN. TOTAL AMOUNT WILL BE RELEASED 24 HRS FROM PURCHASE");
        }
...
contract CHEESECUM is DeflationaryERC20 {

    constructor() DeflationaryERC20("BNB", "CHEESECUM") {
