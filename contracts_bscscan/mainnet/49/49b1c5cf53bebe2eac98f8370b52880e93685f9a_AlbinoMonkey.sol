...
/**
 * 
Here at AlbinoMonkey, we think it’s important to pay homage to our ancestors. That’s why we will be donating to WildFutures – a charity specifically aiming to protect primates – and we will be doing this every month. All donations will be done live so that you know it’s going where we say it’s going.

We know some of you will be thinking “oh here we go again just another charity token” but that’s where you are wrong. On top of the charity aspect, we are aiming to bring you the most in depth and reliable rug scanner that you have seen. It will be completely free of charge to use so you don’t need to worry about holding a certain amount of our token to make sure you’re safe.
...
contract AlbinoMonkey is Context, IERC20, Ownable {
    ...
    string private _name = "AlbinoMonkeyToken";
    string private _symbol = "$Albino";
