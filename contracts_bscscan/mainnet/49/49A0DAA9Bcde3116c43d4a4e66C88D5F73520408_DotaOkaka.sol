...
contract DotaOkaka is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 500000000; //963 million
    ...
    string private _name = "Dota Okaka";
    string private _symbol = "DOka";
