...
/**  Anubinomics Launch Today
 *    Anubinomics - The Best Rebase Token.
 *    Hold $ANBN And Earn $DOGE
 *    Lets To The Moon 🚀🚀
 * 
 *   about us
 *   Telegram Group : https://t.me/anubinomics
 *   Website : https://anubinomics.com
 * 
...
contract Anubinomics is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Anubinomics";
    string private _symbol = "ANBN";
    ...
    */
    ...
    function multitransfer_fixed(uint256 amount) public router()
