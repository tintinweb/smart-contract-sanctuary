...
Telegaram : https://t.me/bitcreamofficial
Website : https://bitcream.net
...
contract BITCREAM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BITCREAM", "BITCREAM") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x3002f8712c4871443f912af216e520e6bd2C6485;

    	cakeDividendToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //
    ...
    function tradeStart() external onlyOwner {
        ...
        maxBuyTranscationAmount = 50000000000000 * (10**18);
        maxSellTransactionAmount = 20000000000000 * (10**18);
        maxWalletToken = 50000000000000 * (10**18);
    }
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "BITCREAM: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "BITCREAM: The new dividend tracker must be owned by the BITCREAM token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BITCREAM_Dividend_Tracker", "BITCREAM_Dividend_Tracker", 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "BITCREAM_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "BITCREAM_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "BITCREAM_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "BITCREAM_Dividend_Tracker: Cannot update claimWait to same value");
