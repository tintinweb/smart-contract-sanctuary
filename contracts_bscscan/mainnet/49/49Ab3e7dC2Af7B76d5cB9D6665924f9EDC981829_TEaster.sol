...
contract TEaster is ERC20SnapshotUpgradeableCustom, OwnableUpgradeable {
    ...
    uint256 public inactiveTime = 12; // 7 days => need to Change
    ...
    function initialize(
        ...
        __ERC20_init('TMonster', 'TMonster');
        __Ownable_init();
    ...
    function setNextInterimClaimThreshold(uint256 _nextInterimClaimThreshold) public onlyOwner {
        nextInterimClaimThreshold = _pct(10000 - interimClaimPct, initialSupply);
    }
