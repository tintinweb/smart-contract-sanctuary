...
// CHANGE
contract SpaceCatXRP is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SpaceCatXRP";
    string constant _symbol = "SCXRP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 30,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x12993c3B7daE8BbB08C2790C0C06aDFc3ee66Bc9);
