...
--------2% Reflections to all Holders
--------5% Liqudity
--------8% Marketing

- 100% supply will added to Liquidity.
- 100% LP will be sent to a Dead.

--------All LP Tokens will NOT be LOCKED but will be Burn sent to DEAD address to sleep for LIFE (Dev Owner will never be able to remove finds from  it - Meaning NO SCAN NO RUG PULL).

NoScamToken (NOSCAM/BNB) is not only a very safe and simple Community driven Token designed for you, but also it is the next BITCOIN.

Hold it in your wallet, Shill it, be part of the team and watch your BNB amount grow days by days.
