...
/**
   ...
   Welcome to LittlePancakeswap
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittlePancakeswap
...
contract LittlePancakeswap is Context, IERC20, Ownable {
    ...
    string private _name = "Little Pancakeswap";
    string private _symbol = "LTPCS";
