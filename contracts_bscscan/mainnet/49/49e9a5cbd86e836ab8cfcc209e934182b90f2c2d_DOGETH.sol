 ...
 * 
 * Receive DOGE and ETH at the same time in your
 * wallet automatically every few minutes.
*/
...
contract DOGETH is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DOGETH";
    string constant _symbol = "DOGETH";
