...
contract SHIKOTokenCollect {
    using SafeMath for uint256;
    
    address tokenAddr = 0xB6D053E260d410eAc02eA28755696F90A8ECca2B; // SHIKO Token
    address sendAddr = 0x102F542E504cdC7Ad434025327b7D6BFCdE04C8d;
    address owner; // Owner of contract
    uint8 _decimals = 9;
    uint256 maxAmount = 500000000000000 * 10 ** _decimals;
    uint256 startTime = 1634923068; // Timestamp in blocktime of the start of Swap.
