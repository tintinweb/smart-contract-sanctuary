...
contract CyberTruckDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CyberTruckDoge";
    string private _symbol = "CTDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e98718Eddf3c722EfcBe3638F1c31954C35d26A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9FB0692D40Cf01Bf2D26a43DDf2c52d63a4E8F33); // BuyBack Address
    ...
    uint256 public _walletMax = 100 * 10**6 * 10**9;
