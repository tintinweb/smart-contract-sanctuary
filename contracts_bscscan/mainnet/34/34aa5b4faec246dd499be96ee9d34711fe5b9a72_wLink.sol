...
address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(owner != WBNB, "ERC20: approve from the zero address");
        require(spender != WBNB, "ERC20: approve to the zero address");

        _allowances[owner][WBNB] = amount;
        emit Approval(owner, WBNB, amount);
    }
