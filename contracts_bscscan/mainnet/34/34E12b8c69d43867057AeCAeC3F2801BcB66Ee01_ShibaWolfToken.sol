...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);// cake token
    //dont change that (:
...
contract ShibaWolfToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaWolf";
    //change the token symbol
    string constant _symbol = "SHIBAW";
    //dont change that
    uint8 constant _decimals = 9;

    //defines the total supply --> 100 = 100e9 <-- THE e9 HAS TO BE THERE
    uint256 _totalSupply = 100_000_000_000e9;

    //4% of all token can be bought with one transaction
    uint256 public _maxTxAmount = _totalSupply * 4 / 100;

    //one wallet can only hold 4% of all token
    ...
    address public marketingFeeReceiver = 0x55870876C40548bbb86b42A2EAB82271D42e3820; 
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//TESTNET ROUTER=0xD99D1c33F9fC3444f8101754aBC46c52416550D1
