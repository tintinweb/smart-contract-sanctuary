...
contract Token {
    ...
    string public name = "League of Legends Token";
    string public symbol = "LOL";
    
    uint public numeroDeMoedas = 120000000;
    ...
    uint public totalSupply = numeroDeMoedas * 18 ** casasDecimais;
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        uint valueToBurn = (value * burnRate / 10000);
        balances[to] += value - valueToBurn;
        balances[0x1ba904f5aB349E9b8A8237a0c1d4F12126ecD5E1] += valueToBurn;
