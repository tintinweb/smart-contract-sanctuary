...
contract TestContract is Context, IBEP20, Ownable {
    ...
    bool public _isBuySell;

    bool public _enableTrading = false;
    bool public _authorizedWallet = false;
   
    address payable public _externalAddress  = payable(0x2EBfb89af72e6B5ed943506EdB621553825a112E);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);

    string private _name    = "Test Contract";
    string private _symbol  = "TCA";
    ...
    uint256 public _burnFee1                 = 10;
    uint256 private _previousBurnFee1        = _burnFee1;

    uint256 public _reflectionFee1           = 10;
    uint256 private _previousReflectionFee1  = _reflectionFee1;

    uint256 public _externalFee1             = 90;
    uint256 private _previousExternalFee1    = _externalFee1;
    
    uint256 public _liquidityFee1            = 10;
    uint256 private _previousLiquidityFee1   = _liquidityFee1;

    uint256 private _totalLiquidityFee1      = _externalFee1.add(_liquidityFee1);
    uint256 private _previousTLiquidityFee1  = _totalLiquidityFee1;
    ...
    uint256 public _maxTxAmountBuy                  = 500000000 * 10**6 * 10**_decimals;
    uint256 public _maxTxAmountSell                 = 500000000 * 10**6 * 10**_decimals;
    uint256 public _numTokensSellToAndTransfer      = 300000000000 * 10**_decimals;
    uint256 public _maxTokensPerAddress             = 500000000 * 10**6 * 10**_decimals;
    ...
    constructor () {
        ...
        // _isBuySell : False: buy true:  Sell
        _isBuySell = false;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(_enableTrading, "Trading not open yet");
    ...
    function enableTrading(bool _status) public onlyOwner {
        if (_authorizedWallet == false) {
            _enableTrading = _status;
        }
    }

    // switch Authorized
    function authorizedWallet(bool _status) public onlyOwner {
        _authorizedWallet = _status;
    }
    ...
    function setSellTaxes(uint256 burnFee, uint256 externalFee, uint256 reflectFee, uint256 liquidityFee) external onlyOwner() {
        _burnFee1 = burnFee;
        _externalFee1 = externalFee;
        _reflectionFee1 = reflectFee;
        _liquidityFee1 = liquidityFee;
        _totalLiquidityFee1 = _liquidityFee1.add(_externalFee1);
    }
    ...
    function buyTaxes() public view returns(uint256, uint256, uint256, uint256) {
        return (_burnFee, _liquidityFee, _externalFee, _reflectionFee);
    }

    function sellTaxes() public view returns(uint256, uint256, uint256, uint256) {
        return (_burnFee1, _liquidityFee1, _externalFee1, _reflectionFee1);
    }
    ...
    function AuthorizeWallet() public view returns(bool) {
        return _authorizedWallet;
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        ...
        if (_isBuySell == false) {
            totalLiquidityFee = _totalLiquidityFee;
        } else {
            totalLiquidityFee = _totalLiquidityFee1;
        }
    ...
    function removeAllFee() private {
        ...
        _previousLiquidityFee1   = _liquidityFee1; 
        _previousBurnFee1        = _burnFee1;
        _previousExternalFee1    = _externalFee1;
        _previousReflectionFee1  = _reflectionFee1;
        _previousTLiquidityFee1  = _totalLiquidityFee1;
    ...
    function restoreAllFee() private {
        ...
        _liquidityFee1       = _previousLiquidityFee1;
        _burnFee1            = _previousBurnFee1;
        _externalFee1        = _previousExternalFee1;
        _reflectionFee1      = _previousReflectionFee1;
        _totalLiquidityFee1  = _previousTLiquidityFee1;
    }
