...
/**
 * TELEGRAM: HTTPS://T.ME/SquidMoonToken
 * Website : www.squidmoontoken.club

     Lp Lock Instantly 
     Buy And Hold SquidMoonToken and Earn Rewards
     Burn               : 50%
     liquidity          : 46%
     Marketing Wallet   : 4%
     
     Tax/Rewards        : 14% Total Tax
                            6% Gose to Rewards
                            4% Gose to liquidity    
                            4% Gose to Marketing
     * NO DEV WALLET
...
contract SquidMoonToken is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SquidMoonToken";
    string constant _symbol = "SMT";
