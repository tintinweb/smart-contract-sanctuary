...
contract Hoes is IBEP20, Auth {
    ...
    address teamFeeReceiver = 0x4886C241C8a9c7bA87fc6AFC9da16ab01aE2F18d;

    string constant _name = "Hoes & N-Prophecy";
    string constant _symbol = "Hoes";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 6 ) / 200;
