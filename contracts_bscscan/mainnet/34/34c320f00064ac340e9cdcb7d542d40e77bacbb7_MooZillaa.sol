...
| $$\  $ | $$| $$  | $$| $$  | $$ /$$/    | $$| $$| $$ /$$__  $$ /$$__  $$
| $$ \/  | $$|  $$$$$$/|  $$$$$$//$$$$$$$$| $$| $$| $$|  $$$$$$$|  $$$$$$$
|__/     |__/ \______/  \______/|________/|__/|__/|__/ \_______/ \_______/
                                                                     
https://t.me/MooZillaa
*
*/
...
contract MooZillaa is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MooZillaa';
    string private constant _symbol = '$MooZillaa';
    ...
    //DevWallets
    address public TeamWallet=payable(0x75B9a0F92664A7861315121EbDF7aCBdbDFb5C47);
    address public walletTwo=payable(0xC3e2e593D1f9243904224B80e7b9f27653b14700);
    //TestNet
	...
	uint256 private antiWhale = 100000000000 * 10**_decimals;
