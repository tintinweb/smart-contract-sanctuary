...
contract DogeDashGame is Ownable{
    ...
    uint256 public multiplierNumerator = 10;
    ...
    // uint256 total_seconds = 86400;
    // uint256 tenmin_seconds = 600;
    ...
    constructor (address _dogeDash, address _admin) {
        ...
        MAX_WITHDRAW_AMOUNT = 10000 * 10 ** 18;
        MIN_WITHDRAW_AMOUNT = 100 * 10 ** 18;
        MIN_REQUIRED_AMOUNT = 100 * 10 ** 18;
        // Player can withdraw one time per 5min
        PLAYER_WITHDRAW_RATE = 300;
    ...
    function withdrawToPlayer(address player_wallet, uint256 amount, uint256 _version) checkVersion(_version) public isNotPaused onlyAdmin {
        ...
        require(MIN_WITHDRAW_AMOUNT <= amount, "Withdraw: too low amount");
    ...
    function updateMinWithdrawAmount (uint256 _amount) external onlyOwner {
        ...
        emit UpdatedMaxWithdrawAmount(MIN_WITHDRAW_AMOUNT, block.timestamp);
    }
