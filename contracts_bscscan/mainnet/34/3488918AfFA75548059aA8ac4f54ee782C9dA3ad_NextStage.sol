...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa4f53f34624CAa1DC0E22a28D19F4Ad08596d375; 
...
contract NextStage is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x22F9e78E041AC36F37C6aB6B71a947f6F138a780;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2500000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NextStage";
    string private _symbol = "NXST";
    ...
    uint256 public _maxTxAmount = 2500000000 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 2500000000 * 10**8;
