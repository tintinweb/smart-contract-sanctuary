...
contract GAMEPADDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("GAMEPAD_Dividend_Tracker", "GAMEPAD_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override pure {
        require(false, "GAMEPAD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override  pure {
        require(false, "GAMEPAD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GAMEPAD contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "GAMEPAD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "GAMEPAD_Dividend_Tracker: Cannot update claimWait to same value");
...
contract GAMEPAD is ERC20, Ownable {
    IPinkAntiBot public pinkAntiBot;
    using SafeMath for uint256;

    address public uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;
    GAMEPADDividendTracker public dividendTracker;
   
    address private _mintedOwner = 0x9a2Cd4F8dA0ecC759985bb13eC70CA3F66ff6F4C;
    address public _marketingWallet = 0xD9C824981fb8C919cB9EbBaDed936109f69d4676;
    ...
    constructor() ERC20("GamePad", "GAMEPAD") {

        dividendTracker = new GAMEPADDividendTracker();
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "GAMEPAD: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "GAMEPAD: Account is already the value of 'excluded'");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "GAMEPAD: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "GAMEPAD: Cannot update gasForProcessing to same value");
