...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BABYMATIC = IERC20(0xB2ce41B71D93D7f5878F985C3e1A87A6229019BE);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BABYMATIC.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BABYMATIC);
        ...
        uint256 amount = BABYMATIC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BABYMATIC.transfer(shareholder, amount);
...
contract MiniBabyMatic is IERC20, Ownable {
    using SafeMath for uint256;

    address BABYMATIC = 0xB2ce41B71D93D7f5878F985C3e1A87A6229019BE;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniBabyMatic";
    string constant _symbol = "MBMATIC";
