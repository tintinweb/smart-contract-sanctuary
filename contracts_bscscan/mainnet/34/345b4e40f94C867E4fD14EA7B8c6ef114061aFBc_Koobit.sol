...
Official Telegram group : https://t.me/koobitBSC
...
import "./KoobitDividendTracker.sol";

contract Koobit is ERC20, Ownable {
    ...
    KoobitDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Koobit", "Koobit") {

    	dividendTracker = new KoobitDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Koobit: The dividend tracker already has that address");

        KoobitDividendTracker newDividendTracker = KoobitDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Koobit: The new dividend tracker must be owned by the Koobit contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Koobit: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Koobit: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Koobit: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Koobit: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Koobit: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Koobit: Cannot update gasForProcessing to same value");
