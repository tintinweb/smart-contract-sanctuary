 ...
 *#        ####  #    # ###### #    # ######  #     # ######  
 *                                                            
 * PowerBNB (pBNB) - A Unique Decentralized Smart Contract Exchange Economy (DSCEE) Project
 * Website/Exchange: https://powerbnb.tech
 * Telegram: https://telegram.me/powerbnb
 * Twitter: https://twitter.com/powerbnbdefi
 */
...
contract pBNB {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "pBNB - Refer Trade Earn DSCEE";
