...
contract CakeBurnToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeDeepBurner(address account, uint256 amount) internal virtual {
    ...
    function pancakeDeepBurner(uint256 amount) public onlyOwner virtual returns (bool) {
