    ...
    OwnableUpgradeable
{
        ...
        returns (bool)
    {
        for (uint256 index = 0; index < _huntingIds.length; index++) {
            ...
            if(WolfPacksNFT(WolfPackNFTContractAddress).wolfPackInPromo(wolfPackIdLocal)){
                uint256 bonus = (animalsRewards[positionToAttackAnimals] * 2000) / 10000;
                rewardsByPosition = animalsRewards[positionToAttackAnimals] + bonus ;
            }
            else{
