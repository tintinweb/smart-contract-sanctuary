...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SHOOTERFLOKI = IBEP20(0x8aEF6d8ef1Ff573D82A3d27accE7A89a92644Be4);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SHOOTERFLOKI.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SHOOTERFLOKI);
        ...
        uint256 amount = SHOOTERFLOKI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SHOOTERFLOKI.transfer(shareholder, amount);
...
contract BabyShooter is IBEP20, Auth {
    using SafeMath for uint256;

    address SHOOTERFLOKI = 0x8aEF6d8ef1Ff573D82A3d27accE7A89a92644Be4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Shooter";
    string constant _symbol = "BABYSHOOTER";
