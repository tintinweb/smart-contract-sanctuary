...
/*
$Santa Saitama (SS) is a community-driven reflections token on the Binance Chain. 
Holders have the opportunity to earn 8% BUSD passive income, By holding Santa Saitama Token
...
Burn 90% of total Supply At launch 

TG - https://t.me/SantaSaitama
*/
...
contract SantaSaitama is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    bool isNumber = true;   
    constructor() {
        _totalSupply = 100000000000000 * 10**9 * 10**9;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }

    function name() public view virtual override returns (string memory) {
        return "Santa Saitama";
    }
