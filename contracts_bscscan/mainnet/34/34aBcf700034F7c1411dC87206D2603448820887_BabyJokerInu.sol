 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/BabyJokerInu
 * 
 * 
 * Baby Joker Inu token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract BabyJokerInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Joker Inu";
    string constant _symbol = "BJKI";
