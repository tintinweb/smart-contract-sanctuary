...
The one and only buyback+rebase bunny token Elon approves of.
...
TG: https://t.me/MiniBunnyRocket_BSC
...
contract MiniBunnyRocket is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniBunnyRocket";
    string constant _symbol = "$MBR";
