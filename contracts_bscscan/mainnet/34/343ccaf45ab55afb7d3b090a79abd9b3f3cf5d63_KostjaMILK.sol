...
/**
 * https://kostjasmilk.com/
 * 1 quadrillion supply
 * 15% trade tax: 13% BNB, 1% MILK, 1% to LP
 * Maxhold: 1.5%
 * Maxsell: 0.1% of total supply
 * Ownership & Janitorship Renounced & Liquidity Locked
 * BNB is earned automatically by holding (claim in the contract or on the website)
*/
...
contract KostjaMILK is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "KostjaMILK";
