...
contract Nature is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 50 * 10**12 * 10**18; 
    ...
    address payable private _charityWallet = 0x173d957073A046845c6e490A1Fb17dFB913f3c44;
    uint256 private _numTokensSellToAddToLiquidity = 1.5 * 10**9 * 10**18;  
    uint256 private _numTokensSellToAddToCharity = 1.5 * 10**9 * 10**18;  
    uint256 private _totalCharityFee = 0;
    uint256 private _totalLiquidityFee = 0;

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Nature";
    string private _symbol = "NATURE";
    ...
    function _transfer(
        ...
        contractTokenBalance = _totalCharityFee;
        if (contractTokenBalance > _numTokensSellToAddToCharity){
            contractTokenBalance = contractTokenBalance;
            swapTokensForEth(contractTokenBalance);
            _totalCharityFee = _totalCharityFee.sub(_numTokensSellToAddToCharity);
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
        ...
        pcsV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(tokenAmount, 0, path, address(this), block.timestamp);
    }
    ...
    function _charity(uint256 charity) private {
        ...
        _totalCharityFee = _totalCharityFee.add(rCharity);
