...
contract SantaToTheMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SantaToTheMoon";
    string private _symbol = "STTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB963A6478685832eedBA1519Ca810Ee8B6e4bD20); 
    address payable public BuyBackWalletAddress = payable(0xB963A6478685832eedBA1519Ca810Ee8B6e4bD20); 
    ...
    uint256 public _BuyBackShare = 6;

    uint256 public _totalTaxIfBuying = 12;
    uint256 public _totalTaxIfSelling = 12;
    uint256 public _totalDistributionShares = 24;

    uint256 private _totalSupply = 10000000 * 10**3 * 10**9;
    uint256 public _maxTxAmount = 10000000 * 10**3 * 10**9;
    uint256 public _walletMax = 500000 * 10**3 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1000 * 10**3 * 10**9; 
