...
/**
WELCOME TO ZORIUM PROTOCOL


💥Official Channels

Telegram: https://t.me/zoriumprotocol
Twitter: https://twitter.com/o_zoriumntwrk
Website: zoriumprotocol.com
*/
...
contract ZORIUMPROTOCOL is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**7 * 10**4; // 100B
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**7 * 10**4; // 100B
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 1000000000 * 10**7 * 10**4; // 100B
