...
contract SquidGamefi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0aD90099a9F404FFC1bd49a1e5d4B3553cA3Fb83); // Marketing Address
    ...
    string private _name = "SquidGamefi";
    string private _symbol = "SQGF";
