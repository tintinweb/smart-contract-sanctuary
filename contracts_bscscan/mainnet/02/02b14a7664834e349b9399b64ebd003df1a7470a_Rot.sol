...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xea5138D72fEf536E21FF58924048BE02C0983923;
...
contract Rot is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x412b25F912f87Fcb5A70a16D2C7fd273015bdE54;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1500000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Raccoon Oatmeal";
    ...
    uint256 public _maxTxAmount = 1500000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 1500000000000000 * 10**18;
