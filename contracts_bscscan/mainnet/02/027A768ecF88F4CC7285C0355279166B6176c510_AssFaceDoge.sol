...
//  -   Telegram link: https://t.me/AssFaceShiba
//  -   Join the community and find out what we're doing!

//  -   Tokenomics:

//  -	Owner renounced 
//  -	LP locked for …  check out the TG group to find out!
//  -	90 % tokens burned 
...
contract AssFaceDoge is Context, IERC20, Ownable {
    ...
    string private _name = 'AssFaceDoge';
    string private _symbol = 'Doge';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 5; // 8% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 15; // 11% of transactions will be kept for liquidity
