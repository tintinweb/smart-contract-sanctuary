...
/**
 Welcome to MiniFlashDoge   @Telegram https://t.me/MiniFlashDoge
   ...
   I will renounce the ownership to burn addresses to transfer #MiniFlashDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make MiniFlashDoge 100X? 
   ...
   it's the best part of the #MiniFlashDoge A idea, increasing the liquidity pool automatically, 
...
contract MiniFlashDoge is BEP20 {
    ...
    constructor() public {
	symbol = "Mini Flash Doge";
    name = "MiniFlashDoge (https://t.me/MiniFlashDoge)";
    fees = 10;
