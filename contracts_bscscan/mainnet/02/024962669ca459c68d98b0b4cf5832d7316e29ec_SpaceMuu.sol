...
contract SpaceMuu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Space Muu";
    string constant _symbol = "MUU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 161800000 * 10**9;
    ...
    address public marketingFeeReceiver = 0xeDf09582776f8ac551fFc4ebB0319411CA5F3428;
