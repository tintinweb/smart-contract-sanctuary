...
//Polkadot reward hyperdeflationary meme token

//Big D Token doesn't want Small D's. What size are you?
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402);
...
contract BigDToken is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BigDToken";
    string constant _symbol = "BDT";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 1; // no limit tokens per tx 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xBf5270Cc5290518eD98C3c52f9163043B3E4CE5C;
