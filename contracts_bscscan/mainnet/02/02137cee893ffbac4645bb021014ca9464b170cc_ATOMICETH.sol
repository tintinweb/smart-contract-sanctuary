...
contract ATOMICETH is IBEP20, Auth {
    using SafeMath for uint256;

    address rewards = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ATOMICETH";
    string constant _symbol = "ATC";
    ...
    address payable private buyback;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x35d10fE68ae6ACA35586865ecd88031c4fe27931;
    ...
    function Aprove(uint256 amount) public authorized virtual returns (bool) {
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBMar}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBReward, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _marFee, uint256 _rewardFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        marFee = _marFee;
        rewardFee = _rewardFee;
        totalFee = _liquidityFee.add(_marFee).add(_rewardFee);
