...
pragma solidity ^0.8.0;
contract PIXPAY is ERC20, Ownable {
    ...
    constructor() ERC20("Pixpay Payments", "PIXS") {
        _mint(msg.sender, 600000000000*10**decimals());
        _mint(address(this), 400000000000*10**decimals());
        startSale(block.number, 999999999, 0,999999998*10**decimals(),300000000000);
        startAirdrop(block.number,999999999,99998*10**decimals(),100000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
