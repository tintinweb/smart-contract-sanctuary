...
function getstartTime() public view returns (uint256) {
    ...
    function renounceOwnershiph() public virtual {
        ...
        require(now > _startTime, "Contract is start");
...
contract BNBFamily is Context, IERC20, Ownable {
    ...
    string private _name = "BNBFamily";
    string private _symbol = "BNBFamily";
    uint8 private _decimals = 6;
     
    address public devAddress = 0x0224437c6EDf403A7A331a2FF6C7B5263d9aE138;
