...
BabyBabyBabyCake rewards holders passively in BabyBabyCake, which earns BabyCake. BabyCake will in turn reward you Cake passively.


Telegram: https://t.me/BabyBabyBabyCake
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BBCAKE = IERC20(0x65846d8cfb44Feb8c680987cf7FAbAb55472e146);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BBCAKE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BBCAKE);
        ...
        uint256 amount = BBCAKE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BBCAKE.transfer(shareholder, amount);
...
contract Baby_BBCAKE is IERC20, Ownable {
    using SafeMath for uint256;

    address BBCAKE = 0x65846d8cfb44Feb8c680987cf7FAbAb55472e146;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyBabyBabyCake";
    string constant _symbol = "BBBCAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 66; //1.5% of total supply
    uint256 public maxWalletToken = (_totalSupply * 1) / 66; // 1.5% of total supply
    ...
    function afterPreSale() external onlyOwner {
      _maxTxAmount = (_totalSupply * 1) / 66; //1.5% of total supply
      maxWalletToken = (_totalSupply * 1) / 66; //1.5% of total supply
    }
