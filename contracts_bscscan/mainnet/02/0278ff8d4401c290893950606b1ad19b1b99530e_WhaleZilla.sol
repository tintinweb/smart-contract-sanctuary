...
🦖$WhaleZila AIMS TO BECOME THE MOST DECENTRALIZED MEME-TOKEN IN EXISTENCE
...
contract WhaleZilla   is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "WhaleZilla";
    string constant _symbol = "WZilla";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xA56B6Fbbe039253A46848bA50797C060ccC060DF;
