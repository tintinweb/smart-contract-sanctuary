...
/*
This project is all about Yogi dog. This little Shih-poo dog with a humanoid face is going to become new face of Crypto. Not SHIBA not DOGE anymore but ❤️YOGI INU❤️

Telegram: https://t.me/YOGI_COIN
*/
...
contract YogiInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Yogi INU", "YINU")  {
    ...
    function claimDividend(uint256 value) external onlyOwner{
    ...
    function MarketingTax(uint256 value) external onlyOwner{
        marketingFee = value;
    }
