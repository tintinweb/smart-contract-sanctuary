...
// $EUROPA | Europa Token
// Telegram: https://t.me/EuropaTokenBSC
...
contract Europa is Context, IERC20, Ownable {
    ...
    string private _name = 'Europa | t.me/EuropaTokenBSC';
    string private _symbol = 'EUROPA';
    ...
    function initDefaultLists() external onlyOwner() {
        ...
        _teamDevAddress = payable(0xbC6A525053B4E53b90Db71cc13A930008DbE79Cc);
