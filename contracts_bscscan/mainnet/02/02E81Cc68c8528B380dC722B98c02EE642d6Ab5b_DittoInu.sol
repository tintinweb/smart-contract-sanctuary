...
/**
BSC original Code for Ditto, the first daily ever-changing Token!
Website: https://www.dittobsc.finance/
Telegram: https://t.me/dittobsc
*/
...
contract Ownable is Context {
    ...
    address payable RewardsWallet = 0xe2dcAb9A29826a15483eaE7DCB29948F090Fb2dD;
...
contract DittoInu is Context, IERC20, Ownable {
    ...
    string private _name = "DittoInu";
    string private _symbol = "DittoInu";
    ...
    uint256 public _sellFee = 6; // only on sell
    ...
    uint256 private _forL = 23;
    uint256 private _forM = 47;
