...
contract JBLNFT is ERC721{
    ...
    uint256 public PRICE = 50; //單位50個JBL-Token

    Card[] public cards; // First Item has Index 0
    address public owner;
    mapping (uint256 => string) private _tokenURIs;
    uint16 public maxSupply = 60;
    uint16 public mint_total = 60;
    ...
    constructor ()  public ERC721("JBL-Xmas", "JBL-Xmas"){
        owner = msg.sender; 
