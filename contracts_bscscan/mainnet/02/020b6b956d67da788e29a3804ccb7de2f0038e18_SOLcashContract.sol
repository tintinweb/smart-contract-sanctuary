...
//Website: https://solcash.tech
//Telegram: t.me/solcash_official
...
contract DividendDistributor is IDividendDistributor {
    ...
    //The auto-rewarded token (SOLANA)
    IBEP20 REWARD = IBEP20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF);
    //dont change that (:
...
contract SOLcashContract is IBEP20, Auth {
    using SafeMath for uint256;

    //The auto-rewarded coin (SOLANA)
    address REWARD = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF;
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "SOLcash";
    //change the token symbol
    string constant _symbol = "SOLcash";
    //dont change that
    ...
    address public marketingFeeReceiver = 0xE51852bF6a884BCDb892c03cf127697f3381181C; 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xE51852bF6a884BCDb892c03cf127697f3381181C;
