...
contract MickeyFox is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8ebD4dEa7e163E1BaD5dA2a3c97Ef7e4Bfa528C0); // Marketing Address
    ...
    string private _name = "MickeyFox";
    string private _symbol = "MickeyFox";
