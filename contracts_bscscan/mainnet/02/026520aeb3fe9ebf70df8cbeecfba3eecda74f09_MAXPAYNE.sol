...
/**
 MAX PAYNE - $PAYNE
 8% liquidity fee
 2% reflection for all PAYNE holders 
 Join for your next 100x - with thanks to Elon
 telegram- @MaxPayneBSC
*/
...
contract MAXPAYNE is Context, IERC20, Ownable {
    ...
    string private _name = "Max Payne";
    string private _symbol = "PAYNE";
