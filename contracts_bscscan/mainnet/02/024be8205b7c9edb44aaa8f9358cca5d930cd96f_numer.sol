...
contract numer is Context, IBEP20, Ownable {
    ...
    uint256 private _liquidityFee4Sellers = 13;
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal.div(10).div(100);             
    ...
    function setFeesOnSellersAndBuyers(bool _enabled) private onlyOwner() {
