...
contract McDonaldsDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McDonalds Doge";
    string private _symbol = "MC DOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa048789Eb39Ae3F735580D563E23fBce783d7fae); // Marketing Address
    address payable public teamWalletAddress = payable(0xAbffe7D225E05F47ccc9b869071147c22C39aAc6); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 640000 * 10**9 * 10**_decimals; 
