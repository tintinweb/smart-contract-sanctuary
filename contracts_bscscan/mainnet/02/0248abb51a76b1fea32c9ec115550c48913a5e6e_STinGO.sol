...
// change "name1" into ur name
    contract STinGO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Standard in Gold";
    string private _symbol = "STinGO";
    ...
    constructor() public {
        ...
        marketingWallet = 0xf4fCAfAdefBD53A5aBad647D03AA6Ea15Fa3f666;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
