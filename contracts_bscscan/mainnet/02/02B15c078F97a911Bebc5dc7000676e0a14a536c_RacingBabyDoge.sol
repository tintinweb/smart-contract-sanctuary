...
contract RacingBabyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA91b3657927ED9646CcaDeB96F1FaeBC8A5013Ca); // Marketing Address
    ...
    string private _name = "RacingBabyDoge";
    string private _symbol = "RBabyDoge";
