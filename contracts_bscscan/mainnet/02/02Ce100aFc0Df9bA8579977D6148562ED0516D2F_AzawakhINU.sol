...
// TG: https://t.me/AzawakhINU
// Website: www.azawakhinubsc.com
...
contract AzawakhINU is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Azawakh INU";
   string constant _symbol = "Azawakh INU";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 100000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = ( _totalSupply * 1 ) / 100 ; // %
   
   //max wallet holding of % 
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x45EAABC9Ef2F2c3d1A1A0643ec709d547Bb7Fc98;
