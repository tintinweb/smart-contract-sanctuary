...
contract SpaceJam is Context, IERC20, Ownable {
    ...
    string private _name = "Space Jam Metaverse";
    ...
    RouterTwo public immutable SjmRouter;
    address public immutable sjmPair;
    ...
    constructor() public {
        ...
        RouterTwo _SjmRouter = RouterTwo(
            0x10ED43C718714eb63d5aA57B78B54704E256024E
        );
        sjmPair = SjmFactory(_SjmRouter.factory()).createPair(
            address(this),
            _SjmRouter.WETH()
        );
        SjmRouter = _SjmRouter;
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = SjmRouter.WETH();
        _approve(address(this), address(SjmRouter), tokenAmount);
        SjmRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0,
            path,
            address(this),
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        _approve(address(this), address(SjmRouter), tokenAmount);
        SjmRouter.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            0,
            0,
