...
contract CyberCardano is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cyber Cardano";
    string constant _symbol = "CADA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 280 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x715592b63D6C573a96A1b6cc578172d14171c371;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(marketingFee).div(totalBNBFee);
        uint256 amountBNBmarketingFeeketing = amountBNB.mul(reflectionFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBmarketingFeeketing, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _reflectionFee, uint256 _feeDenominator) external authorized {
