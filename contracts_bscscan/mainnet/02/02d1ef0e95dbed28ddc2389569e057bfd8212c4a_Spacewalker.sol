...
contract Spacewalker is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Spacewalker";
    string private constant _symbol   = "SPW";
    uint8  private constant _decimals = 9;
    
    uint256 public _taxFee       = 300; 
    uint256 public _liquidityFee = 900; 
