...
Telegram: https://t.me/SonOfNone_official
*/
...
contract SonOfNone is IBEP20, Auth {

	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

	string constant _name = "SonOfNone";
	...
	constructor() Auth(msg.sender) {
        ...
        // Airdropping all previous holders
	...
	function marketing() internal swapping {
        uint256 amountToMarketing = balanceOf(address(this)) * 12 / 15;
        uint256 amountToLiquidity = balanceOf(address(this)) / 10;
        ...
        uint256 devBNB = amountBNB / 10;
        
        payable(0xe6497e1F2C5418978D5fC2cD32AA23315E7a41Fb).transfer(devBNB);
        payable(0xA80dE10d63DB98521fceA1703a1d34C6B33eEFc0).transfer(devBNB*2);
