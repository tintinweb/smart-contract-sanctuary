...
// File: contracts/token/BEP20/Professional.sol
...
/**
 * @title Professional
 * @dev Implementation of the Professional
 */
contract Professional is BEP20Capped, BEP20Mintable, BEP20Burnable, ServicePayer {
    ...
    constructor (
        ...
        BEP20(name, symbol)
        BEP20Capped(cap)
        ServicePayer(feeReceiver, "Professional")
        payable
    {
