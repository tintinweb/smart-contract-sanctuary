...
import './interfaces/ISphynxRouter02.sol';
import './libraries/SphynxLibrary.sol';
import './libraries/SafeMath.sol';
import './interfaces/IERC20.sol';
import './interfaces/IWETH.sol';

contract SphynxRouter02 is ISphynxRouter02 {
    ...
    {
        return SphynxLibrary.getAmountIn(amountOut, reserveIn, reserveOut, swapFee);
    }
...
library SphynxLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'2423e5057a3b29f925a0c38dade7bdc42176e81a17a6bc3fee51b1fea0686e5b'   // INIT_CODE_PAIR_HASH of Sphynx Factory
            ))));
    }
