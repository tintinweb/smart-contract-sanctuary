 ...
 * Bull vs bear will be the next hot meme token to answer this
 * 
*/ 
...
contract BullVSBear is Context, IERC20, Ownable {
    ...
    string private _name = "Bullish OR Bearish Market?";
    string private _symbol = "Bull VS Bear";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7D229Ad9c0C39167f614A24985B81A1f4a152aeF); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x0A4156E4149FDE1A73eA0A117076b2ebEc1F1249); // buyback Address
