...
Telegram: https://t.me/DemonKingBoy
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUYBACKANDMARKETING = IBEP20(0x6670551104914Cb3C7D0846484Cc24fb0c9c1C4f);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BUYBACKANDMARKETING.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BUYBACKANDMARKETING);
        ...
        uint256 amount = BUYBACKANDMARKETING.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BUYBACKANDMARKETING.transfer(shareholder, amount);
...
contract DemonKingBoy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DemonKingBoy";
    string constant _symbol = "DemonKingBoy";
    ...
    bool public marketingSending = true;
    ...
    function SendDividend(bool _status) public onlyOwner {
        marketingSending = _status;
    }
