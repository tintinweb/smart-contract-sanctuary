...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xb29d50aE837753b41315aA8fA4C350CA9C26467B); // Marketing Address
    ...
    uint256 private _tTotal = 1230000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "tPRoC Token";
    string private _symbol = "TPROC";
