...
🐦 Official Twitter: 
https://twitter.com/JedStarOfficial

📷 Official IG:
https://www.instagram.com/jedstarofficial/

🤖 Official Reddit: 
https://www.reddit.com/r/JedStarOfficial/

👾 Official Discord:
https://discord.gg/KewrZAQMMh
...
contract JedStarToker is Context, IERC20, Ownable {
    ...
    //added for 7 days lock
    mapping (address => uint) private _lastBuy;
    ...
    string private _name = "JEDSTAR";
    string private _symbol = "JED";
    ...
    uint256 public _liquidityFee = 4; // 0 or 4
    ...
    constructor () {
        ...
        //exclude Charity/Dead from reward
        _isExcluded[_charityWalletAddress] = true;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        require(_isExcludedFromFee[sender] || sender == uniswapV2Pair || _lastBuy[sender] <= block.timestamp);
        
        if(sender == uniswapV2Pair) _lastBuy[recipient] = block.timestamp + 7 days;
        if(recipient != uniswapV2Pair) _liquidityFee = 0; else _liquidityFee = _previousLiquidityFee; 
