...
contract AmazonCake is Context, IERC20, Ownable {
    ...
    string private _name = "Amazon Cake";
    string private _symbol = "AmazonCake";
    ...
    uint256 private constant _Burn_FEE = 100; // 1%
	uint256 private minimumTokensBeforeSwap = 1000000000 * 10**9;
