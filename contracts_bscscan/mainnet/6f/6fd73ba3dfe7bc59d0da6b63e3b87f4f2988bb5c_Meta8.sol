...
contract Meta8 is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x561a76aB857CfcE1858ae276F16eA16672623EDd;

    string constant _name = "Meta8";
    string constant _symbol = "META8";
