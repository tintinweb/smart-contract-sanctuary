 ...
 * 💎 Earn reward in DOGE and USDT
 * 
 *  10% - Earn DOGE // 4% - Earn USDT
 * 
 *  Telegram: https://t.me/MOONDOGEUSDT
 * 
 * BUY IN PANCAKESWAP:
 * https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x6F0239c6B71ec42b0F6219fF10F5d1cAf839ddfD
 *  
 */
...
contract MOONDOGEUSDT is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MOONDOGEUSDT";
    string constant _symbol = "MOONDOGEUSDT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 10000000; 
