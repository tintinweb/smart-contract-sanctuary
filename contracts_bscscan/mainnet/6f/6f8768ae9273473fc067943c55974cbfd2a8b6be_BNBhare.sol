...
contract BNBhare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBhare";
    string private _symbol = "BNBhare";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6e05A29730BD0A50624D34bd2899110A07011234); // Marketing Address
    address payable public teamWalletAddress = payable(0xcCe23B8CA23e970c6570763f1Ab8aEef1Da46789); // Team Address
