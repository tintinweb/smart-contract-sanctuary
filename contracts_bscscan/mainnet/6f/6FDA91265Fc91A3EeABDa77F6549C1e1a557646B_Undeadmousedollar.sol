...
contract Undeadmousedollar  is Context, IERC20, Ownable {
    ...
    string private   _name = "Undead Mouse Dollar";
    string private _symbol = "UndeadMDollar";
