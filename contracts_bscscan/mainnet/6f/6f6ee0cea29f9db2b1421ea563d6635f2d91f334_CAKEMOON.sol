...
/**
👨‍🚀CAKEMOON is a honest meme coin that is not trying to confuse you with useless tokenomics, the team has put together a token that we believe has features designed to make it moon.
...
✈️ Telegram : https://t.me/CakeMoonBSC
...
contract CAKEMOON is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "CAKEMOON";
    string public _symbol= "CAKEMOON";
     bool balances1 = true;
