...
/**
    ...
    *Max wallet : 1,500,000 (1,5%)
    *Max buy : 500,000 (0,5%)
    *Max sell : 300,000 (0,3%)
    *Min. hold to get reward : 300,000 (0,3%)

    There is a tax on every transaction, it consists of 2 components
    *10% Rewards as $FEG to the holders
    *10% Liquidity

    https://www.twitter.com/CaptainFeg
    https://t.me/CaptainFEGToken
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable DividendsToken = address(0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167);
...
contract CaptainFeg is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _maxWalletToken = 1500000 * (10**18); 
    ...
    constructor() public ERC20("CaptFEG", "$CFEG") {
