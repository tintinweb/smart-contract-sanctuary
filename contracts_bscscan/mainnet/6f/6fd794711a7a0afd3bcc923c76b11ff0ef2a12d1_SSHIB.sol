...
⏰   SamuraiShibaInu 🦊Launching 14:00 UTC 21th October🚀🚀

👉 Fair Launch
👉 Liq Lock on Launch 
👉 Huge Maketing
👉 Big Community
👉 Innitial Liquidity 10 BNB

⚠️ Contract Renounced on Launch !
...
🐶 Token Name: SamuraiShibaInu

🐕 Token Ticker: SSHIB
🐕 Total Decimal: 9
🐕 Buy On: Pancakeswap

It's pretty simple, so don't worry! We recommend using MetaMask or TrustWallet. Simply deposit the amount of BNB you wish to buy into your wallet, connect your wallet to PancakeSwap, input the contract address (or click the buy button on this website), set your slippage 15 or more and click swap
...
✅ Sell max 1% total token/transaction and max 1transaction/1 Minute
...
contract SSHIB is Context, BEP20 {
    ...
    string private _name = "SamuraiShibaInu";
