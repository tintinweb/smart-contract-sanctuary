...
/**
   ...
   santacat -  Justlaunched
   Low Mcap
   Safu 100% 
   Lp Locked 🔐
   https://t.me/santacatbsc
...
contract SantaCat is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 2000000000000 * 10**9;
    uint256 public maxSellTransactionAmount = 2000000000000 * 10**9;
