...
/**
   #Santa Drop (SD) tokenomics
   3% fee auto add to the liquidity pool 
   2% fee auto distribute to all holders
   5% fee auto moved to Aidrop
*/
...
contract SocietyToken is Context, IERC20, Ownable {
...
/////////////////////////// marketing wallet address/////////////////////////////////////////////
    address private _marketingWalletAddress = 0x00962B3187321AF9F7848E5B1447dd365706816a;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
/////////////////////// token details here//////////////////////////
    string private _name = "Santa Drop";
    string private _symbol = "SD";
    uint8 private _decimals = 12;
 
 ////////taxfee is the fee going to holders of the coin//////////////////   
   ...
   /////////////////////// router address has been set to binance testnet, can be changed as per actual requirement///////     
