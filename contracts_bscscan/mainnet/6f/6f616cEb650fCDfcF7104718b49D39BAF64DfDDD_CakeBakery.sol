...
contract CakeBakery is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CakeBakery";
    string constant _symbol = "CB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 1; // 2% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 4) / 1; // 4% total max wallet size
    ...
    uint256 public swapThreshold = _totalSupply / 2000; // 0.05% to earn
    bool inSwap;
