...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x644D310A9cCDBdABd9e276AF0BCa823cC43513a8;
...
contract SantaGirlBonk is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1D8CF8A7432Df133eCDbfcC662F85477bB299e5d;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SantaGirlBonk";
    string private _symbol = "SGB";
