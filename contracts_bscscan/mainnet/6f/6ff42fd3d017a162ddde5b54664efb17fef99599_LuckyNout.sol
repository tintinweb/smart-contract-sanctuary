...
/**
   ...
   Welcome to LuckyNout
   
   This is a community token. If you want to create a telegram I suggest to name it to @LuckyNout
...
contract LuckyNout is Context, IERC20, Ownable {
    ...
    string private _name = "LuckyNout";
    string private _symbol = "LuckyNout";
