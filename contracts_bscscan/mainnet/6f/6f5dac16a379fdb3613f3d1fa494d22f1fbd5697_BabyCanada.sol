...
contract BabyCanada is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyGemini";
    string constant _symbol = "BabyGUSD";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 1000;
