...
/**
 * 
        To celebrate 1st Anniversary of Binance Smart Chain (BSC), the community have created HappyBSC token!

    HappyBSC ($HBSC) is social token that rewards you with $BNB, it will be used to celebrate this memorable date! 

    Let’s buidl and hold $HBSC till next anniversary!
   ...
   🎂 Tokenomics:
    ...
    Launch: September 1st 20:00UTC                                                                     
    TG: https://t.me/happyBSC
    Website: https://happybsc.com/
...
// CHANGE
contract HappyBSC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "HappyBSC";
    ...
    uint256 devFee = 0; 
    uint256 totalFee = 700; // liquidityFee + reflectionFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x28F0C81A9Ab072Ca74a7054F5C030B06a13C6ed5);
