...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); 
...
contract AdaFEGX is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x3C8292462ccB4A651c7088E749EEcFcC146C3b99;

    string constant _name = "AdaFEGX";
    string constant _symbol = "AdaFEGX";
    uint8 constant _decimals = 8;
                         
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 30000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 30000000 * (10 ** _decimals);
    ...
    uint8 public cooldownTimerInterval = 30 seconds;
