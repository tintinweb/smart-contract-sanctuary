...
//             _______    ______   _______   __      __  ________  ________   ______  
//            /       \  /      \ /       \ /  \    /  |/        |/        | /      \ 
//            $$$$$$$  |/$$$$$$  |$$$$$$$  |$$  \  /$$/ $$$$$$$$/ $$$$$$$$/ /$$$$$$  |
//            $$ |__$$ |$$ |__$$ |$$ |__$$ | $$  \/$$/  $$ |__    $$ |__    $$ | _$$/ 
//            $$    $$< $$    $$ |$$    $$<   $$  $$/   $$    |   $$    |   $$ |/    |
...
// $BabyFeg proposes an innovative feature in its contract. This is a fork of the BABYCAKE contract.

// DIVIDEND YIELD PAID IN FEG! With the auto-claim feature,
// simply hold $BabyFeg and you'll receive FEG automatically in your wallet.

// Hold BabyFeg and get rewarded in Feg on every transaction!


// 📱 Telegram: https://t.me/baby_feg
// 🌐 Twitter: https://twitter.com/baby_feg
//
...
contract BABYFEG is ERC20, Ownable {
    ...
    address public immutable CAKE = address(0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167); //FEG
    ...
    address public _marketingWalletAddress = 0x2cBDA2B1BD8e5A86ecb2a9763221D961BeC1F3cf;
    ...
    constructor() public ERC20("BabyFeg", "BBFEG") {
...
contract BABYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("BABYCAKE_Dividen_Tracker", "BABYCAKE_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 0 * (10**18); //no minimum
    }
