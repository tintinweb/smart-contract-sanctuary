...
/**
    Welcome to Chinagoldendragon🐉

    FairLaunch at 50 members
    tg :@Chinagoldendragonbsc
  
    TOKENOMICS

    1,000,000,000,000,000 Total Supply
    900,000,000,000,000 Initial Burn (90%)
    Initial Liquidity 0.2 BNB 
    Renounce Ownership
    LP 100 % Burn to Burn Adresses
    100% SAFU
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @
   ...
   Can you make #Chinagoldendragon🐉 10000X? 

   1,000,000,000,000,000 total supply
   5,000,000,000,000 tokens limitation for trade, which is 0.5% of the total supply
   
   it's the best part of the #Chinagoldendragon idea, increasing the liquidity pool automatically, 
...
contract Chinagoldendragon is Context, IERC20, Ownable {
    ...
    string private _name = "Chinagoldendragon🐉";
