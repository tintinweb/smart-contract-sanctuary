...
contract SpaceDoggies is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SPACE DOGGIES";
    ...
    address payable constant private _marketingAddress = payable(0x4019C709449Ae83AacEb924a84aF95573D6f7F5a);
    address payable constant private _buybackAddress = payable(0x70C8a00FF32180F51aa296ccC6d15E50Ac75234b);
    address payable constant private _maintenanceWallet = payable(0x76Ec0092DfE53Dbc66fab5E5F0A5E88aaE264911);
