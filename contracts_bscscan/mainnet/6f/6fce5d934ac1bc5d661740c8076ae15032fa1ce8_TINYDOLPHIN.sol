...
Tiny Dolphin is a deflationary BEP-20 Token that lets the holders benefit by using the reflection model. 
We have a built-in mechanism that guarantees the funding of the Reward Wallet. And this mechanism doesn't effect the market price!
...
📱 Telegram group: https://t.me/tinydolphinn
🌐 Website: http://tinydolphin.coinnew.biz/
...
contract TINYDOLPHIN is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "TINY DOLPHIN";
