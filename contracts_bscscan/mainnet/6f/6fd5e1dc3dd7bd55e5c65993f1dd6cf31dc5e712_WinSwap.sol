...
contract WinSwap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x383c86d0BEA4d618bbd23CD6ed219F32744630e9); // Marketing Address
    address payable public charityAddress = payable(0x383c86d0BEA4d618bbd23CD6ed219F32744630e9); // Charity/Dev Address
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 200000000000000000000000; // 200,000; token will be given on airdrop
