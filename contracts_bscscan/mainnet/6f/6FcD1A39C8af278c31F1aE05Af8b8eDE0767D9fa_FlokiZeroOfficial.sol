...
🚀 $FlokiZero is a revolutionary, unique, game changing token built on
the Binance Smart Chain. Simply Hold FlokiZero Token and enjoy 5% Rewards FlokiInu

join the only original FZ @FlokiZeroOfficial
...
// _______________________________________
// **TOKENOMICS🔥:**
// 🔥__Token Name : Floki Zero Official
// 🔥__Token Symbol : $FZOfficial
// 🔥__Total Supply : 1,000,000,000,000__
// 🔥__Initial Liquidity : 1 BNB__
// 🔥 20% burned
// _______________________________________
// **📱Telegram: @FlokiZeroOfficial**
// **📱Twitter: @Floki_Zero_Official**
// **📱Website :https://FlokiZero.io** (UnderDevelopment)
...
contract FlokiZeroOfficial is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiZero";
    string constant _symbol = "FZOfficial";
