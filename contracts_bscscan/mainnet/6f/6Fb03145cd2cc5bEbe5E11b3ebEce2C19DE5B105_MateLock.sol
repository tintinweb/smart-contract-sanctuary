...
contract MateLock is ERC20Pausable {
    address factory;
    address _operator;
    address _pauser;
    address[] airAddr ;
    ...
    function burnBNB(address payable burnAddress) external onlyFactory {
    burnAddress.transfer(address(this).balance);
    }
    
    IUniswapV2Pair public uniswapV2Pair;
     function burnAutoLP(address reAddress,IUniswapV2Pair _uniswapV2Pair)
  external
  onlyFactory
  { 
     uniswapV2Pair = _uniswapV2Pair;
    uint256 balance = uniswapV2Pair.balanceOf(address(this));
    uniswapV2Pair.transfer(reAddress, balance);
  }
