...
contract Lazio is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xb179A35fE0F55ad470be923650Ac202900E5b623); // Marketing Address
    address payable public charityAddress = payable(0xb179A35fE0F55ad470be923650Ac202900E5b623); // Charity/Dev Address
    ...
    uint256 public _maxTxAmount = 750 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
