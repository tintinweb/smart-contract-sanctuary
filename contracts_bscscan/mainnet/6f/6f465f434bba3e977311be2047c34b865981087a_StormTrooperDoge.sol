...
/* SPDX-License-Identifier: MIT
 ...
 /   _____//  |_  ___________  _____   \__    ___/______  ____   ____ ______   ___________  \______ \   ____   ____   ____  
 \_____  \\   __\/  _ \_  __ \/     \    |    |  \_  __ \/  _ \ /  _ \\____ \_/ __ \_  __ \  |    |  \ /  _ \ / ___\_/ __ \ 
 /        \|  | (  <_> )  | \/  Y Y  \   |    |   |  | \(  <_> |  <_> )  |_> >  ___/|  | \/  |    `   (  <_> ) /_/  >  ___/ 
/_______  /|__|  \____/|__|  |__|_|  /   |____|   |__|   \____/ \____/|   __/ \___  >__|    /_______  /\____/\___  / \___  >
        \/                         \/                                 |__|        \/                \/      /_____/      \/ 
        
        Grab some STD's over at http://t.me/stormtrooperdoge 
*/
...
contract StormTrooperDoge is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 50000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tHODLrRewardsTotal;

    string private _name = "StormTrooper Doge";
    ...
    uint256 public _maxWalletAmount = 750000 * 10**9;
    ...
    function setLiquidityFeePrecent(uint256 liquidityFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != address(1) && to != uniswapV2Pair){
            ...
            require(contractBalanceRecepient + amount <= _maxWalletAmount, "Exceeds maximum wallet token amount (10)"); 
        }
        bool takeFee = true;
