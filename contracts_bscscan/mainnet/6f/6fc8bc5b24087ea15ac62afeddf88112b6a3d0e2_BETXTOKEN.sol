...
contract BETXTOKEN is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'BET X TOKEN';
    string  private constant _SYMBOL = 'BTX';
    ...
    uint256 private constant _MAX_TX_SIZE = 5000000000 * _DECIMALFACTOR;
