...
contract NEWYEARSVANCAT is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("NEWYEARS VANCAT", "NEWYEARSVANCAT") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "NEWYEARSVANCAT";
    string private _symbol = "NEWYEARSVANCAT";
