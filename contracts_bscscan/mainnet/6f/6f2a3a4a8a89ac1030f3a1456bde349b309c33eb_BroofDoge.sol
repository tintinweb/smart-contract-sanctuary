...
contract BroofDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x090D8318BcA73E7ff1fEa67E6C34b139756d4300); // Marketing Address
    ...
    string private _name = "Bro of Doge";
    string private _symbol = "BOD";
    ...
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 5) / 100;
