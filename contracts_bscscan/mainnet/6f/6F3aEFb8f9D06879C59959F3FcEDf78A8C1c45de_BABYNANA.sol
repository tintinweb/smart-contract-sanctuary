...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BANANA = IBEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607);
        _token = msg.sender;
    }
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = BANANA.balanceOf(address(this)).sub(balanceBefore);
...
contract BABYNANA is IBEP20, Auth {
    ...
    uint256 public _maxSellTxAmount = _totalSupply / 2000; // 0.05%
    ...
    function GIMMEBANANA(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function BANANASPLIT(uint256 amount, uint256 amount2) external authorized {
