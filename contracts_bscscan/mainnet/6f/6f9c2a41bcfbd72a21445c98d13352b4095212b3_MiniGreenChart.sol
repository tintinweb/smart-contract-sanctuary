...
/**
🔥Mini Green Chart Bsc 🔥
🥷 Fair launch
💎 SAFU
🔐 Locked LP 
📝 Buys 12% (4% Green Chart rewards, 3% Liquidity, 5% Marketing)
📝 Sells 20% (6% Rewards, 6% Liquidity, 8% Marketing) 
✅Sell tax will be reduced over time
♾ Max wallet 2% 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4);
...
/* Token contract */
contract MiniGreenChart is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV  = 0xED545cFd9C5CE3A63FcbE8C7Ab6cFD4c1f046F65;
    ...
    // Name and symbol
    string constant _name = "Mini Green Chart";
    string constant _symbol = "MinigChart";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 300 / 10000;  // 3% max or 2M
    uint256 public _maxWalletToken = _totalSupply * 500 / 10000; // 4% or 4M tokens
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 10000; // 400.000 tokens or 0.04% of supply
