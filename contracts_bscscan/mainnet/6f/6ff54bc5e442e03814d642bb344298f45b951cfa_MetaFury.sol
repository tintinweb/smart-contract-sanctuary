...
contract MetaFury is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x00000E5e779136a4f0611E72e0FcfD1E95ac585D); // Marketing Address

    address payable public teamAddress =
        payable(0x00000b62fB3D7CAFbFA196637eaB3AfA0bC09c88); // Team Address

    address payable public liquidityAddress =
        payable(0x00000419522A223477090053d2C41387BA6a637C); // Liquidity Address
    ...
    string private constant _name = "MetaFury";
