...
/**
   ...
   #MarkDigitalToken features:
   3% fee auto Tax to distribute in all holders.
...
contract MARKD is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4690683433 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MARK Digital";
    string private _symbol = "MARKD";
