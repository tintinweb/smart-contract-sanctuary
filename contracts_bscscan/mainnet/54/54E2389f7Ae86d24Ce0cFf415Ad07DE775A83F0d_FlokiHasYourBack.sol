...
100 % of tax revenues to buybacks until community decides otherwise
...
contract FlokiHasYourBack is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiHasYourBack";
    string constant _symbol = "$FHB";
    ...
    uint8 public cooldownTimerInterval = 9; //Three blocks coolDown
