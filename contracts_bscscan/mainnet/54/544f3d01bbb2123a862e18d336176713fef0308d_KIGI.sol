...
contract KIGI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KIGI";
    string private _symbol = "KIGI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2B8268b715dFE57ffE947F75054BCe81F96E60E9); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x3a689908127C5763DdECCEd918Fda91e99b89A50); // buyback Address
    ...
    uint256 private _totalSupply = 10**8 * 10**9;
    uint256 public _maxTxAmount = 10**8 * 10**9;
    uint256 public _maxSwapAmount = 10**8 * 10**9;

    uint256 public _walletMax = 10**8 * 10**9;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            checkSwapAmount(sender, recipient, amount);
    ...
    function checkSwapAmount(address sender, address recipient, uint256 amount) internal view {
        require((recipient == uniswapV2Pair ? (amount < _maxSwapAmount || isExcludedFromFee[sender]) : true), "TX Limit Exceeded");
    }
