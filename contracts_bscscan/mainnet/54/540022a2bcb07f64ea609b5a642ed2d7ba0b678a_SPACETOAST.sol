...
contract SPACETOAST is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SPACE TOAST";
    string constant _symbol = "TOAST";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * 10**3 * 10**9;
    ...
    uint256 swapThreshold = 100 * 10**3 * 10**9;
