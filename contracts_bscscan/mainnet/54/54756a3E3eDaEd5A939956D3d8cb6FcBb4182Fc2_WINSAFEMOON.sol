 ...
 *      FAIRLAUNCH
 * 
 * Earn SAFEMOON in your wallet automatically every few minutes.
 * 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SAFEMOON.balanceOf(address(this));
        ...
        uint256 amount = SAFEMOON.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SAFEMOON.transfer(shareholder, amount);
...
contract WINSAFEMOON is IBEP20,  Auth {
    using SafeMath for uint256;

    address SAFEMOON = 0x8076C74C5e3F5852037F31Ff0093Eeb8c8ADd8D3;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "WINSAFEMOON";
    string constant _symbol = "WSAFEMOON";
