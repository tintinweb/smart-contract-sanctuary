...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/pull/522
        if (a == 0) {
            return 0;
        }
...
interface Cashier {
    function setToken(address token, address tIntializer) external;
...
contract RoseCake is IERC20, Ownable {
    ...
    uint256 private startingSupply = 100_000_000_000; // 100 Billion, underscores aid readability

    uint8 private _decimals = 18;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "Rosecake";
    ...
    address payable private _marketingWallet = payable(0xe86cc3e9da28c73BFe3bc1e068219d99F86bA4E3);

    // Max TX amount is 10% of the total supply.
    ...
    uint256 public swapAmount = (_tTotal * 10) / 1000;
    bool inSwap;
    ...
    constructor (uint256 _snipeBlockAmt, address cInitializer) payable {
        ...
        isDividendExempt[0x2D045410f002A95EFcEE67759A92518fA3FcE677] = true;
    ...
    function setTaxes(uint256 liquidityFee, uint256 reflectionFee, uint256 marketingFee, uint256 divisor) external onlyOwner {
        require(_totalFee < masterTaxDivisor / 4);
    ...
    function swapBack(uint256 numTokensToSwap) internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB * dynamicLiquidityFee / totalBNBFee;
