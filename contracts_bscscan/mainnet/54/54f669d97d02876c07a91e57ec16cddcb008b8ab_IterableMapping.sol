...
/**
Telegram: t.me/QueenFloki
Website: https://QueenFloki.xyz/web
/**
...
contract QueenFloki is ERC20, Ownable {
    ...
    constructor() ERC20("QueenFloki", "QueenFloki") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x8A4A66b01024E1174af29Ee6525F26bb85b8B79F;
    ...
    function tradeStart() external onlyOwner {
        ...
        swapTokensAtAmount = 29000000 * (10**18);
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "QueenFloki: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "QueenFloki: The new dividend tracker must be owned by the QueenFloki token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("QueenFloki_Dividend_Tracker", "QueenFloki_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 150000 * (10**18); //must hold 150,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "QueenFloki_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "QueenFloki_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "QueenFloki_Dividend_Tracker: claimWait" );
