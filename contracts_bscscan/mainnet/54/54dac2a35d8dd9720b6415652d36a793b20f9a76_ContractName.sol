...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 30 minutes; //CHANGE THIS (default 30 minutes)
    uint256 public minDistribution = 1 * (10 ** 18); //CHANGE THIS (default 1 $BUSD)
...
contract ContractName is IBEP20, Auth { //CHANGE THIS
    using SafeMath for uint256;
    ...
    string constant _name = "Elon On Drugs SAFU"; //CHANGE THIS
    string constant _symbol = "EOD"; //CHANGE THIS
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals); //CHANGE THIS (default 1 million)
    uint256 public _maxTxAmount = _totalSupply / 1; //CHANGE THIS (default 1% of supply)
    uint256 public _maxWallet = _totalSupply / 20; //CHANGE THIS (default 5% of supply)
    ...
    uint256 liquidityFee = 500; //CHANGE THIS (default 5%)
    uint256 liquidityFeeAccumulator;
    uint256 buybackFee = 1;
    uint256 reflectionFee = 400; //CHANGE THIS (default 10%)
    uint256 marketingFee = 300; //CHANGE THIS (default 0%)
    uint256 devFee = 300; //CHANGE THIS (default 3%)
    uint256 totalFee = 1501; //CHANGE THIS (default 15%)
