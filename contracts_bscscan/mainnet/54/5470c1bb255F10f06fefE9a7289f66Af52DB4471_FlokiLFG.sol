...
___________.____    ________   ____  __.___.____   ___________________ 
\_   _____/|    |   \_____  \ |    |/ _|   |    |  \_   _____/  _____/ 
 |    __)  |    |    /   |   \|      < |   |    |   |    __)/   \  ___ 
 |     \   |    |___/    |    \    |  \|   |    |___|     \ \    \_\  \
 \___  /   |_______ \_______  /____|__ \___|_______ \___  /  \______  /
     \/            \/       \/        \/           \/   \/          \/ 

 Take It To The Moon Or To The Ground - Is Up To You!
 5% Liquidity | 3% Max Tx | 5% Max Wallet
 TG: https://t.me/FlokiLFG
...
contract FlokiLFG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiLFG";
    string constant _symbol = "FLFG";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 3 / 100; // 1%

    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; // 2%
    ...
    uint256 buybackMultiplierNumerator = 0;
    uint256 buybackMultiplierDenominator = 0;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x77Cf6D06De2bD75c168FdD4Fb30749A888876aF1;
