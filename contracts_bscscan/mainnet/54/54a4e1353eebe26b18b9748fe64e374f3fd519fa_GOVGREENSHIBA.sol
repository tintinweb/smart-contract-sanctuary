...
/**
 *
READ THE REAL CONTRACT IN THE GROUP BE AWARE OF SCAM
...
▶️TELEGRAM: https://t.me/greenshibacoin
▶️WEBSITE:  https://greenshiba.online
...
contract GOVGREENSHIBA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0c4698e6DBbbc2A69FAF7B3e8504fa6bb2de6107); // Marketing Address
    ...
    string private _name = "GOVGREENSHIBA";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x0c4698e6DBbbc2A69FAF7B3e8504fa6bb2de6107);
    }
