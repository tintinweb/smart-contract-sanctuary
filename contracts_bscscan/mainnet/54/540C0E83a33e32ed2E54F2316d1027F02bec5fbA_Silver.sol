 ...
 */
abstract contract SilverTier is BEP20 {
    /**
...
/**
 * @title Silver
 * @dev Implementation of the Silver tier
 */
contract Silver is SilverTier, ServicePayer {
    constructor(
        string memory name_,
    ...
    ) payable BEP20(name_, symbol_) ServicePayer(feeReceiver_, "Silver") {
        require(initialBalance_ > 0, "Silver: supply cannot be zero");
