...
/*
🚀SpaceX Shiba Inu🐶 is inspired by #DogeFather Elon Musk’s very own Shiba Inu. SpaceX Shiba Inu seeks to impress his father by showing his new improved transaction speeds & adorableness. 

SpaceX Shiba Inu crypto coin birthed by fans & members of the Doge, Shiba & Floki Inu communities. SpaceX Shiba Inu combines utility and the power of a community, aims to be a top 10 crypto project, listed on exchanges with plans to kickstart the next revolution
...
🌐 Twitter:
https://twitter.com/SpaceXShibaInu
🌐Web Site:
https://spacexshibainu.com/
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function totalSupply() public view virtual override returns (uint256) {
        return 10_000_000_000_000  * (10**18);
    }
...
contract SpacexShibaInu is ERC20, Ownable {
    ...
    constructor() ERC20("SpaceX Shiba Inu", "SPACEBONES")  {
        ...
        */
        _mint(owner(), 10_000_000_000_000  * (10**18));
    }
