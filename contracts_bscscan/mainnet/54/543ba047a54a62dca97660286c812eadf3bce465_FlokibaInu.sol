...
library SafeMath {
    ...
    function add2(uint256 a, uint256 b, uint256 c) internal pure returns(uint256) {
        return add(a,b) + c;
    }
}

contract FlokibaInu is ERC20 {
    ...
    string public name = "Flokiba Inu";
    string public symbol = "FlokibaInu";
