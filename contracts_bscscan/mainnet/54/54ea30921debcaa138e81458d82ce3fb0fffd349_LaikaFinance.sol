...
contract LaikaFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1ECfD0C4E3eC022fdc341F0Cc5ef173d66516295); // Marketing Address
    ...
    string private _name = "Laika Finance";
    string private _symbol = "LaFin";
