...
import "./BabyBinaPet-imports.sol";

/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyBinaPet` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyBinaPet(Env.Testnet)` or `BabyBinaPet(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyBinaPet";
    string internal constant SYMBOL = "BBP";
     ...
     */
    address internal tipToTheDev = 0xcf998d40018B189Ec7AD425610a0e42E3cc6563F;
...
contract BabyBinaPet is SafeToken{
