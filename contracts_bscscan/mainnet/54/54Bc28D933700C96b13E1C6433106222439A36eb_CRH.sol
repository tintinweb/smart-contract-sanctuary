...
/**
 * 
 * CryptoHero is a passion project with the goal of revolutionizing the current market for boring blockchain games. CryptoHero will provide players with a true game experience with a professional game development team. Of course, players will be rewarded for their efforts. 
*/
...
contract CRH is Context, IERC20, Ownable {
