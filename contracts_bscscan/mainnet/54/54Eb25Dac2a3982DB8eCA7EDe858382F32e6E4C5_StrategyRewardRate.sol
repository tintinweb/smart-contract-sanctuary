...
contract StrategyRewardRate is IStakingRewards, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        _rewardToken = IERC20(_earnToken);
        stakingToken = IERC20(_stakingToken);

        rewardsDuration = 1 hours;
    ...
    function getReward() public override nonReentrant updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            uint256 rewardTotal = IERC20(_rewardToken).balanceOf(address(this));
    ...
    function notifyRewardAmount(uint256 reward) public onlyRewardsDistribution {
        IERC20 rewardsToken = IERC20(_rewardToken);
