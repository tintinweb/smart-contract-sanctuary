...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0dcE402B09c16a00D8Ea790247aF2566DBD82674;
...
contract MetaHashPlanet is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC3CB1FF55Aa2E9301791A70A3D3495304a695A14;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 9000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Hash Planet";
    string private _symbol = "MHP";
    ...
    uint256 private numTokensSellToAddToLiquidity = 9000000000 * 10**18;
