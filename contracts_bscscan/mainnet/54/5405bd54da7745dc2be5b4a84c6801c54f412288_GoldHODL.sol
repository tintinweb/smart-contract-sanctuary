...
contract GoldHODL is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "GoldHODL";
    string private _symbol = "GHODL";
    ...
    // Innovation for protocol by GoldHODL Team
