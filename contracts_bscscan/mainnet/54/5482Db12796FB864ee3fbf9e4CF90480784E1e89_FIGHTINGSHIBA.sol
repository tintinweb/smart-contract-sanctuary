...
contract FIGHTINGSHIBA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FIGHTING SHIBA";
    string constant _symbol = "FSHIB";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 4%
    ...
    uint256 buybackFee = 1500;
    uint256 reflectionFee = 800;
    uint256 marketingFee = 4000;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x754De6996BbfaDb84bC7b232Cab91f2113803671;
