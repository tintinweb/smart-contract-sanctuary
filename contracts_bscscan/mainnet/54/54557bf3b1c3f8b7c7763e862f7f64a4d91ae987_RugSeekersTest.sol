 ...
 *  1% ScamSeekers fund
 */
contract RugSeekersTest is IERC20, Context, Ownable {
    ...
    // token data
    string constant _name = "RugSeekersTest";
    ...
    function isBotBlocker5000(address _address, bool _isBlackListed) external onlyOwner() returns (bool) {
