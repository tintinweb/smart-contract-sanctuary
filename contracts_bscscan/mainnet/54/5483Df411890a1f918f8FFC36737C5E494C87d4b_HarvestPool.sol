...
// File: contracts/interfaces/ISBVv2.sol
...
// File: contracts/HarvestPool.sol
...
contract HarvestPool is Ownable , ReentrancyGuard {
    ...
    constructor(
      ...
      rewardsDistributions[_admin] = true;
    }

    function harvest(address[] calldata _sbv) public onlyRewardsDistribution {
      for (uint256 i = 0; i < _sbv.length; i++) {
            ISBVv2(_sbv[i]).harvest();
      }
    }
