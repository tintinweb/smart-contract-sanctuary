 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/DogeSun
 * 
 * 
 * Doge Sun token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract DogeSun is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge Sun";
    string constant _symbol = "DOSU";
