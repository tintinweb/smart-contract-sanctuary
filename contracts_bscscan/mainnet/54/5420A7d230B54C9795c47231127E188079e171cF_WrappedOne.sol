...
contract WrappedOne is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Wrapped One";
    string constant _symbol = "WONE";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 70000000000; // 5%

    uint256 public _maxWalletToken = 90000000000; // 2%
    ...
    uint256 public swapThreshold = 10000000000; // 1% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xBE0F388C57a858a624bA749Df0B2CDAFa1A2B203;
