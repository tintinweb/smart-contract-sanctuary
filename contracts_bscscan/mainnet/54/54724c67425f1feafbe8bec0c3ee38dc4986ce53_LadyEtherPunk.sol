...
* TG group : https://t.me/LadyEtherPunk
* Fair launch.
...
contract LadyEtherPunk is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    LadyEtherPunkDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("LadyEtherPunk", "LEP") {
        _ETHRewardsFee = 10;
        _liquidityFee = 2;
		_marketingFee = 6;
        ...
        _maxWalletToken = 3000000000 * (10**18); // 


    	dividendTracker = new LadyEtherPunkDividendTracker();
    	antiBotEnabled = true;

    	liquidityWallet = owner();
		
		bulkSender = payable(0x979E44C6253C3B861705621DD0ac37f555025f82);
		marketingWallet = payable(0x1F08bB9fdbFa1168D4Aa1CC5dDc65eE480238961);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "LadyEtherPunk: The dividend tracker already has that address");

        LadyEtherPunkDividendTracker newDividendTracker = LadyEtherPunkDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "LadyEtherPunk: The new dividend tracker must be owned by the LadyEtherPunk token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "LadyEtherPunk: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LadyEtherPunk: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "LadyEtherPunk: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LadyEtherPunk: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "LadyEtherPunk: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "LadyEther: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "LadyEtherPunk: Cannot update gasForProcessing to same value");
    ...
    function swapTokensForBUSD(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of LadyEtherPunk
            path,
            recipient,
            block.timestamp
        );
...
contract LadyEtherPunkDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("LadyEtherPunk_Dividend_Tracker", "LadyEtherPunk_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "LadyEtherPunk_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "LadyEtherPunk_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LadyEtherPunk contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "LadyEtherPunk_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "LadyEtherPunk_Dividend_Tracker: Cannot update claimWait to same value");
