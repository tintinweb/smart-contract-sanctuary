...
contract Degen2k22 is Context, IERC20, Ownable {
    ...
    string private _name = "Degen2k22";
    string private _symbol = "D2k22";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x9c9b968c5b371DA8CBA7C7e492630F36cdBCA01E);
    address public marketingWalletToken = 0x90D9529B32bC51901970C2290E66f45e0551b154;
    ...
    function setMaxBal(uint256 newMaxBalance) external onlyOwner(){
        // Minimum _maxBalance is 1.5% of _totalSupply 
