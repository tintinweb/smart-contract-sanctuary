...
contract PARAPPA is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x5b82cAB840eFF7065ec07C1B92838B825dE1Eff8;
    ...
    string private _name = "Parappa Inu";
    string private _symbol = "PARAPPA";
    ...
    uint256 public maxWalletToken = 30000000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 20000000000000 * (10**18);
    ...
    function setNumOfTokensSellToAddLiuidity(uint256 _newAmount) external onlyOwner() {
        numTokensSellToAddToLiquidity = _newAmount;
    }
