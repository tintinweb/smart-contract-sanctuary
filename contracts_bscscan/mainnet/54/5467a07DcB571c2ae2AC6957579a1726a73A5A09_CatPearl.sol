...
contract Context {
 ...
 contract CatPearl is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "CatPearl";
        string private _symbol = "CATPEARL";
    ...
    address private _MarketingWalletSYLOM = 0x454392eF3C5A9cdA366F3EaAE7eD0313054066C9;
