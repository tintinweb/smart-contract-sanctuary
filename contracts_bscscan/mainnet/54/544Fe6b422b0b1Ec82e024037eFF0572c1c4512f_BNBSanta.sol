...
contract BNBSanta is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbAEe386E68f807eF142c8552F51A615931D8a58B); // Marketing Address
    ...
    uint256 private _tTotal = 500 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BNBSanta";
    ...
    uint256 public _buyBackRangeRate = 99;
