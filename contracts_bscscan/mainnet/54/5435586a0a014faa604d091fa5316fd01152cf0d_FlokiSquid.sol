...
Floki Squid
---------------------------------------
Events every 12 hours for holders. Winner takes the marketing wallet (minus 10% for the dev).
Whats the event? Check the timer on the website (flokisquid.com).
Join the Telegram for hints (@flokisquid)

Compete fairly and potentially win. The more volume, the bigger the prize.
*/
...
contract FlokiSquid is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x72Cd319814E05cED529a4B5AC982785522bE1f2d;
    ...
    string private _name = "Floki Squid";
