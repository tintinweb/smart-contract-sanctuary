...
contract AbusiveShibe is Context, IERC20, Ownable {
    ...
    string private _name = 'AbusiveShibe';
    string private _symbol = 'Shiba';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 3; // 5% of transactions will be redistributed among holders
