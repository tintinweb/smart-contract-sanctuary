...
contract BabyCoin98 is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BabyCoin98";

          string private _name ="Baby Coin98";
