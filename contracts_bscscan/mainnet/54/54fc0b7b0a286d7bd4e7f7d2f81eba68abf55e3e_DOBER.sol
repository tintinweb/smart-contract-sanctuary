...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf0A78BBf77ECFA472e66C19Fb02bcCaCDb6048A9;
...
contract DOBER is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x27477bDFc78E630a2ae9A024eC91bCdA9373B99d;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Doberman";
    string private _symbol = "DOBER";
    ...
    uint256 public _maxTxAmount = 100000000000000000000 * 10**18;
