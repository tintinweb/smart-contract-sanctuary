...
AtsuShiba is a Frictionless Yield Auto Generation DEFI & NFT Protocol on Binance Smart Chain, where community gets rewarded in ecosystem
tokens. 
...
📱Telegram : t.me/AtsuShibaChat
🖥 Website : https://countingdownto.com/countdown-pages/ljfuYNCX
🐦 Twitter : @AtsuShibaOffice
...
contract AtsuShiba is Context, IERC20, Ownable {
    ...
    string private _name = "AtsuShiba";
    string private _symbol = "AtsuShiba";
