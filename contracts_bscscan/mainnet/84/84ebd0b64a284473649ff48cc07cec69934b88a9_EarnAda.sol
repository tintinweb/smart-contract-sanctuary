...
import "./EarnAda-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `EarnAda` at the very bottom **and** the `environment` into which
 * you are deploying the contract `EarnAda(Env.Testnet)` or `EarnAda(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "EarnAda";
    string internal constant SYMBOL = "EarnAda";
     ...
     */
    address internal tipToTheDev =0x3d197af9482Ce3b7b4bFaD6AD0d4f43FB4D78040;
