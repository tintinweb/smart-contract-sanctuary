...
contract FatCate is Context, IERC20, Ownable {
    ...
    string private _name = "Fat Cate";
    string private _symbol = "FCATE";
    ...
    address public marketingWallet = 0x675d805fc35dA2ff9B715539DdB3a62c9C42c346;
    ...
    function afterPresale() external onlyOwner() {
        _taxFee = 25;  // 2.5 % Holders share
        _previousTaxFee = _taxFee;
        _liquidityFee = 35;  // 3.5 % goes to Liquidity
        _previousLiquidityFee = _liquidityFee;
        _burnFee = 15;  // 1.5 % auto Burn
        _previousBurnFee = _burnFee;
        _marketingFee = 25;  // 2.5 % Marketing wallet
