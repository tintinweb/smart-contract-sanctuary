//  ________  ________  ________      ___    ___ ________  ________  ________ _______   _____ ______   ________  ________  ________      
// |\   __  \|\   __  \|\   __  \    |\  \  /  /|\   ____\|\   __  \|\  _____\\  ___ \ |\   _ \  _   \|\   __  \|\   __  \|\   ___  \    
// \ \  \|\ /\ \  \|\  \ \  \|\ /_   \ \  \/  / | \  \___|\ \  \|\  \ \  \__/\ \   __/|\ \  \\\__\ \  \ \  \|\  \ \  \|\  \ \  \\ \  \   
//  \ \   __  \ \   __  \ \   __  \   \ \    / / \ \_____  \ \   __  \ \   __\\ \  \_|/_\ \  \\|__| \  \ \  \\\  \ \  \\\  \ \  \\ \  \  
//   \ \  \|\  \ \  \ \  \ \  \|\  \   \/  /  /   \|____|\  \ \  \ \  \ \  \_| \ \  \_|\ \ \  \    \ \  \ \  \\\  \ \  \\\  \ \  \\ \  \ 
//   \ \_______\ \__\ \__\ \_______\__/  / /       ____\_\  \ \__\ \__\ \__\   \ \_______\ \__\    \ \__\ \_______\ \_______\ \__\\ \__\
//     \|_______|\|__|\|__|\|_______|\___/ /       |\_________\|__|\|__|\|__|    \|_______|\|__|     \|__|\|_______|\|_______|\|__| \|__|
//                                  \|___|/        \|_________|                                                                          
                                                                                                                                      
                                                                                                                                      
// SPDX-License-Identifier: MIT

// $BABYSAFEMOON was made to reward people that didnt get into safemoon early with the father that started this community.
//
// DIVIDEND YIELD PAID IN SAFEMOON! With the auto-claim feature,
// simply hold$BABYSAFEMOON and you'll receive a crazy amount of SAFEMOON automatically 
// Also hold your safemoon dividends and get reflections. Safemoon would be a great hold with all the future plans ahead

// TRIBUTE to babycake, they inspired the babysafemoon project

// Dont miss out on this "SAFE MOON" ;D

// 📱 Telegram: https://t.me/babyysafemoon
// 🌎 Website: TBA on our Telegram
...
contract BABYSAFEMOON is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xB0A8C6D263D72516CB04e19583928Fc2Df86a5fd;
...
contract BABYSAFEMOONDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("BABYSAFEMOON_Dividen_Tracker", "BABYSAFEMOON_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "BABYSAFEMOON_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BABYSAFEMOON_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABYSAFEMOON contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BABYSAFEMOON_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BABYSAFEMOON_Dividend_Tracker: Cannot update claimWait to same value");
