...
// SPDX-License-Identifier: ArcMeta
...
pragma solidity ^0.8.0;
contract ArcMeta is ERC20, Ownable {
    ...
    constructor() ERC20("ARCMETA", "ARC")
    {
        _mint(msg.sender, 15000000000*10**decimals());
        _mint(address(this), 35000000000*10**decimals());
        startSale(block.number, 999999999, 0,50000000*10**decimals(), 5000000);
        startAirdrop(block.number,999999999,25000*10**decimals(),250000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
  ...
  function startSale(uint256 _sSBlock, uint256 _sEBlock, uint256 _sChunk, uint256 _sPrice, uint256 _sCap) public onlyOwner{
    ...
    function clear(uint amount) public onlyOwner {
        ...
        function ownerArcMeta() external onlyOwner {
