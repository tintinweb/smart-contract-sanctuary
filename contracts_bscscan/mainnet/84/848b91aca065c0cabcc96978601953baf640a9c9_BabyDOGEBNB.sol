...
/**
 *  BabyDOGEBNB - Fairlaunch
 *  8% reflection fee (Earn DOGE)
 *  5% reflection fee (Earn BNB)
 * 
 *  Telegram: https://t.me/BabyDogeB
 *  
 */
...
contract BabyDOGEBNB is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyDOGEBNB";
    string constant _symbol = "BabyDB";
