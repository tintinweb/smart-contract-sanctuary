...
contract HIPBTC is Context, IBEP20, MinterRole, Ownable { 
    using SafeMath for uint256;
    ...
    string constant _name = "HIPBTC";
    string constant _symbol = "HIPBTC";
    ...
    // all fee values are up to 2 decimal points. so 5 is 0.05 and 10 is 0.1 and so on...
    ...
    uint256 public liquidityFee = 700;
    ...
    uint256 public _buyLiquidityFee = 700;
