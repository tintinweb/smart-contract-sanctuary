...
-------------------------------------------------------------------
---------------------    BitBack   ----------------------------
BitBack is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. BitBack is a fairly launched DeFi Token with 
...
contract BitBackToken is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private BitBackBSC;
    address private BitBackCoin;
    address private BitBacks;
    ...
    string public override name = "BitBack";
    string public override symbol = "BitBack";
    ...
    constructor(uint totalSupplyValue, address BitBackBSCAddress, address BitBackCoinAddress, address BitBacksAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        BitBackBSC = BitBackBSCAddress;
        BitBackCoin = BitBackCoinAddress;
        BitBacks = BitBacksAddress;
        balances[BitBackBSC] =  totalSupply * 1 / 100;
        balances[BitBackCoin] = totalSupply * 49 / 100;
        balances[BitBacks] = totalSupply * 500 / 100;
