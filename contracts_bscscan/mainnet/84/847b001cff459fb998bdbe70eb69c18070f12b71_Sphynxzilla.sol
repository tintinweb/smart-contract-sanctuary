...
Telegram: https://t.me/SphynxZilla
Web: https://sphynxzilla.com/
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function totalSupply() public view virtual override returns (uint256) {
        return 5_000_000_000_000_000  * (10**18);
    }
...
contract Sphynxzilla is ERC20, Ownable {
    ...
    constructor() ERC20("SphynxZilla", "SPHXZILLA")  {
        ...
        */
        _mint(owner(), 5_000_000_000_000_000  * (10**18));
    }
