...
contract Unstoppable is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Unstoppable Moon Token";
    string private _symbol = "MOONonomoics";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcdca3d52754286Ee3b3DABb582708Ee4A5E28f1a); // Marketing Address
    ...
    uint256 public _maxTxAmount = 5000000000000 * 10**9; // 0.1%
    uint256 public _walletMax = 20000000000000 * 10**9; // 2%
