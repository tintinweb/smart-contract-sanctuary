...
contract ELEGANTDOGE is ERC20Upgradeable, OwnableUpgradeable, IBabyToken {
    using SafeMath for uint256;
    ...
    ELEGANTDOGEDividendTracker public dividendTracker;
    ...
    constructor() {
        implementation = address(new ELEGANTDOGEDividendTracker());
    }
    ...
    function initialize(
        ...
        dividendTracker = ELEGANTDOGEDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "ELEGANTDOGE: The dividend tracker already has that address"
        );

        ELEGANTDOGEDividendTracker newDividendTracker = ELEGANTDOGEDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "ELEGANTDOGE: The new dividend tracker must be owned by the ELEGANTDOGE token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "ELEGANTDOGE: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "ELEGANTDOGE: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "ELEGANTDOGE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "ELEGANTDOGE: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "ELEGANTDOGE: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "ELEGANTDOGE: Cannot update gasForProcessing to same value"
        );
...
contract ELEGANTDOGEDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ELEGANTDOGE contract."
        );
    }
