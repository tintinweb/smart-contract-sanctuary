...
3% fee to be added automatically to the liquidity pool.
7% reflection to be distributed automatically to all holders.
5% fee to be added automatically to marketing wallet.

Max Wallet 20,000,000
Max TX 20,000,000

Website http://unclefloki.xyz/
Telegram https://t.me/uncleflokitoken                                                                    
...
contract UncleFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Uncle Floki";
    string constant _symbol = "UFLOKI";
