...
contract ThunderBunny is Context, IBEP20, Ownable {
    ...
    string private _name = 'ThunderBunny';
    string private _symbol = 'TBUNNY';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 8;
    uint256 private _burnFee = 8;
    uint256 private _maxTxAmount = 100 * 10**9 * 10**18;
