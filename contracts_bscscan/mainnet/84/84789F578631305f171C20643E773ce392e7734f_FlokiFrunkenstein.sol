...
SimpUp
Community Token
Rewards SIMP for Holding - 5%

 
 TG: https://t.me/SimpUp
...
contract FlokiFrunkenstein is IBEP20, Auth {
    ...
    string constant _name = "SimpUp";
    string constant _symbol = "SimpUp";
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(address(router), SIMP);
