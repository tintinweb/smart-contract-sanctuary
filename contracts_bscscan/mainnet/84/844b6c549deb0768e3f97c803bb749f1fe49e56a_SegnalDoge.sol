...
/**
 Welcome to SegnalDoge    @Telegram: https://t.me/SegnalDoge
   ...
   I will renounce the ownership to burn addresses to transfer #SegnalDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make SegnalDoge 100X? 
   ...
   it's the best part of the #SegnalDoge A idea, increasing the liquidity pool automatically, 
...
contract SegnalDoge is BEP20 {
    ...
    constructor() public {
	symbol = "Segnal Doge";
    name = "SegnalDoge (https://t.me/SegnalDoge)";
    fees = 10;
