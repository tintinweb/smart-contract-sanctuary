...
/**
   ...
   The best and most cute creature in the gaming world!
   
   Kirby coin tokenomics
   Total supply 100.000.000.000
   50% Initial burn
   6% fee liquidity pool
   ...
   NO tokens reserved
   NO whales
   NO rugpulls, Liquidity pool locked, ask in telegram!
   
   Join our telegram!
   
   Telegram: t.me/kirbycoin
...
contract KirbyCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public _rewardFee = 2; //Rewards for holders
    uint256 private _previousRewardFee = _rewardFee;

    uint256 public _burnFee = 0;
    uint256 public _liquidityFee = 6; //LP Increase
