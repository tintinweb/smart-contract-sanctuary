...
contract californiachicas is Context, IERC20, Ownable {
    ...
    string private _name = "californiachicas";
    string private _symbol = "CFA";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xcC0F06Ea89c33A575D6ED00A75CCe546581622c2);
