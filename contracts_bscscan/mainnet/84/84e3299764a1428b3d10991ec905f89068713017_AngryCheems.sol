...
𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈 - https://t.me/Angrycheems

𝙏𝙒𝙄𝙏𝙏𝙀𝙍 - https://twitter.com/AngryCheemsBSC
...
contract Context {
 ...
 contract AngryCheems is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "AngryCheems";
    string private _symbol = "ANGRYCHEEMS";
    ...
    address private _Ownership = 0x84BE947C200138639B04f29c9837Bb4DFDeD9Ad0;
