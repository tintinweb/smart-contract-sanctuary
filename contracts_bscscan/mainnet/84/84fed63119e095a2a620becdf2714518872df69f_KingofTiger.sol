...
contract KingofTiger is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "King of Tiger";
    string private constant _symbol   = "King of Tiger";
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 800 / 10000; // 1% of total supply
    ...
    constructor () {
        ...
        // change this
        _teamWallet       = 0x373f778794Fa1619571476e0F662202740DfCAC1;
        _marketingWallet = 0x373f778794Fa1619571476e0F662202740DfCAC1;
        ...
        _isExcludedFromAntiWhale[address(0x373f778794Fa1619571476e0F662202740DfCAC1)]            = true;

        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x373f778794Fa1619571476e0F662202740DfCAC1)] = true;
