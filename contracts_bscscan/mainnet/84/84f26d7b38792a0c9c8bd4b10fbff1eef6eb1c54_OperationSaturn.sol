...
/**      
*____ ___  ____ ____ ____ ___ _ ____ _  _    ____ ____ ___ _  _ ____ _  _ 
*|  | |__] |___ |__/ |__|  |  | |  | |\ |    [__  |__|  |  |  | |__/ |\ | 
*|__| |    |___ |  \ |  |  |  | |__| | \|    ___] |  |  |  |__| |  \ | \| 
*                                  
* Max wallet: 10000000
* https://t.me/OperationSaturn
*
**/
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x726165ABC5956D4A8637670eA2b2CE2FE33EeEb4;
        _token = msg.sender;
    }
...
contract OperationSaturn is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x19802ddC3FBDbFDF78057985C1BE0C55Ce550De4;

    string constant _name = "Operation Saturn";
    string constant _symbol = "OSATURN";
    ...
    address IDEXPair = 0x726165ABC5956D4A8637670eA2b2CE2FE33EeEb4;
