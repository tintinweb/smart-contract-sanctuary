...
contract BaboonToken is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x10f1b2b1D5d51C396DfD58c843a4b21EcdD463c4); // Marketing Address
    address payable public charityAddress = payable(0x54634aD50a8bdC5d463774f5B8532EFfB2F64c1d); // Charity/Dev Address
    ...
    string private _name = "Baboon Token"; // nice
