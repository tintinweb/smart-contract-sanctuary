...
contract BurningMoonDividentNFT is ERC165, IERC721, IERC721Metadata ,IERC721Enumerable,Ownable {
    ...
    uint256 public currentValue=5*10**16; //0.05 BNB for first NFT
    ...
    constructor() {
        ...
        NFTPrototypes.push(NFTData("Common Piggybank", "0", Rarity.Common));
        NFTPrototypes.push(NFTData("Uncommon Piggybank", "1", Rarity.Uncommon));        
        NFTPrototypes.push(NFTData("Rare Piggybank", "2", Rarity.Rare));
        NFTPrototypes.push(NFTData("Ultra Rare Piggybank", "3", Rarity.UltraRare));
        NFTPrototypes.push(NFTData("Epic Piggybank", "4", Rarity.Epic));        
        NFTPrototypes.push(NFTData("Legendary Piggybank", "5", Rarity.Legendary));
        NFTPrototypes.push(NFTData("Legendary Shiny Piggybank", "6", Rarity.LegendaryShiny));
    ...
    receive() external payable {
        if(msg.sender.isContract()||msg.sender==address(BMPCS)||msg.sender==address(BM)) 
            return;
        PresalePurchase();
    }
