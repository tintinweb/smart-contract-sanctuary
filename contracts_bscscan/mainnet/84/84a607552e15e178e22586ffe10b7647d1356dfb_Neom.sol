...
// NeomCOIN Token contract based on the full ERC 20 Token standard
// Symbol: Neom
// Status: ERC20 Verified

contract NEOMCOINToken { 
...
contract NeomStandardToken is NEOMCOINToken, Ownable {
    
    using NeomMaths for uint256;
...
contract Neom is NeomStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 100000000000000 ; // 1 billion tokens, 8 decimal places
    string constant public name = "Neom"; //fancy name: eg Neom COIN
    string constant public symbol = "Neom"; //An identifier: eg Neom
