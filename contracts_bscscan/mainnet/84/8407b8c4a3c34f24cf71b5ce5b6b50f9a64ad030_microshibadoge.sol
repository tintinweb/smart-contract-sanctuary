...
contract microshibadoge is Context, IBEP20, Ownable {
    ...
    constructor ()  {
		_NAME = 'microshibadoge';
		_SYMBOL = 'MCD';
		_DECIMALS = 9;
		_DECIMALFACTOR = 10 ** _DECIMALS;
		_tTotal = 10000 * _DECIMALFACTOR;
		_maxTxAmount = (_tTotal * 2) / 10000;
		...
		FeeAddress = 0x91Fa9B5514D30A52B6d9EA103BF8F4FbEa93795b;
		_owner = _msgSender();
