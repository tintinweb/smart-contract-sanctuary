...
$PAPACAKE proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN CAKE! With the auto-claim feature,
// simply hold $PAPACAKECAKE and you'll receive CAKE automatically in your wallet.
//
// Hold $PAPACAKE and get rewarded in CAKE on every transaction!
...
contract PAPACAKE is Context, IERC20, Ownable {
    ...
    string private _name = "PAPACAKE";
    string private _symbol = "PAPACAKE";
