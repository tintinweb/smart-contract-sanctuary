...
/**
  ...
  I created a black hole so #BaByShort token will deflate itself in supply with every transaction
...
contract BaByShort is IBEP20, Ownable{
    ...
    constructor(){
        ...
        _tokenSupply = 1000000000000000000000;
