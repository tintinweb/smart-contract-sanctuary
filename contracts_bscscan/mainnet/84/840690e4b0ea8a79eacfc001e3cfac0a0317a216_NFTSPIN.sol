...
*/
 ...
 contract NFTSPIN is IBEP20, Auth {
     
     using SafeMath for uint256;
 
     string constant _name = "NFTSPIN";
     string constant _symbol = "NFTS";
     ...
     uint256 _totalSupply = 1000000000000 * 10**5 * (10 ** _decimals);
     ...
     constructor () Auth(msg.sender) {
         ...
         autoLiquidityReceiver = 0xddb3Bf77fe79bAD73343F7D3cb79C3Aa9f3dA76a;
         marketingWallet = 0x691F722112Ebe1654c30DcFA378a25830857A794; 
         lotteryWallet = 0x691F722112Ebe1654c30DcFA378a25830857A794;
     ...
     function swapBack() internal lockTheSwap {
         ...
         (bool tmpSuccess1,) = payable(lotteryWallet).call{value: anothermarketingShare, gas: 30000}("");
