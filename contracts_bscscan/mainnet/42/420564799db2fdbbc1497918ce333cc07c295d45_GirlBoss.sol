...
contract GirlBoss is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 private maxLiqFee = 100;
    uint8 private maxTaxFee = 100;
    uint8 private maxBurnFee = 100;
    uint8 private maxWalletFee = 100;
    uint8 private maxBuybackFee = 100;
