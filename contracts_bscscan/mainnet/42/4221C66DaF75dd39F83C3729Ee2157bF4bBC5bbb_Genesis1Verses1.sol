...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaCE47ac563a7bb3ce109a7525AbE2786Ef002b8D;
...
contract  Genesis1Verses1 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x311A3A6B08cE350F5BfDD9b67d4a83b1b26Fc6F0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 200000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Genesis1 Verses1";
    string private _symbol = "G1V1";
    ...
    uint256 private numTokensSellToAddToLiquidity = 200000000000000000 * 10**18;
