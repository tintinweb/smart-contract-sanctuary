...
contract PayOut is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PayOut";
    string constant _symbol = "PAY0";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x50FB734f0448a122B102F9A211E52C2f14eb208A;
        devWallet = 0x19F8FcF701c021FA64989934964380844782aA8A;
