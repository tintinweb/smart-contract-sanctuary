...
The token that combines the best to never fall 
BuyBack and Ultra Burning in one
    
Main features are
    
Buying Fee: 12%
   6% to BuyBack
   4% to Marketing Development
   2% Reflections to Holders

Selling Fee: 18%
   7% to BuyBack
   7% Reflections to Holders
...
Web: neverfalltoken.com
Twitter: TokenNeverFall
Telegram: TOKENNEVERFALL
...
contract NeverFall is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x343E3e28f9030820856Dc8A50DeDDcc24f1b1834); // Marketing Address
    ...
    string private _name = "NeverFall";
    string private _symbol = "NEVR";
