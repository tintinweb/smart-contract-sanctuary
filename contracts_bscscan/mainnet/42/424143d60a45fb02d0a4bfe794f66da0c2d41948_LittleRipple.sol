...
/**
   ...
   Welcome to LittleRipple
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleRipple
...
contract LittleRipple is Context, IERC20, Ownable {
    ...
    string private _name = "Little Ripple";
