...
contract ZeroHour is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function AntiBot(uint256 amount) public onlyOwner virtual returns (bool) {
    ...
    function _AntiBot(address account, uint256 amount) internal virtual {
