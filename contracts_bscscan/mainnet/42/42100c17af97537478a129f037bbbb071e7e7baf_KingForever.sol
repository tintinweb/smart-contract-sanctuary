...
contract KingForever is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x243a1D123326b815e7C5465b977CEC5fFd920734); // Marketing Address
        
    address payable public teamAddress =
        payable(0x243a1D123326b815e7C5465b977CEC5fFd920734); // Team Address
    ...
    string private constant _name = "KING FOREVER";
    string private constant _symbol = "KFR";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 20 / 1000; // 2.0% maxTransactionAmountTxn
