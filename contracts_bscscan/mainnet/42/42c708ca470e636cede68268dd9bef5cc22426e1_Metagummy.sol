...
/**
   ...
   Welcome to metagummy Finance
   
   Telegram : https://t.me/metagummy_finance
   wwbsite  : http://metagummyfinance.com/
   ...
   Can you make #metagummy finance 10000X? 
...
contract Metagummy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf6058948cFe525f12f23742a052f2efDA64b6a05); // Marketing Address
    ...
    string private _name = "Meta Gummy finance";
    string private _symbol = "Mgummy";
