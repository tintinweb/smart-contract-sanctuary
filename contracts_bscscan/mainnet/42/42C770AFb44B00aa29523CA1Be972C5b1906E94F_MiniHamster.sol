...
// change "name1" into ur name
    contract MiniHamster is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "MiniHamster";
    string private _symbol = "MiniH";
    ...
    constructor() public {
        ...
        marketingWallet = 0x0ed0Cd7aFA7d84A228D510E0D1440e59d8240F4C;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
