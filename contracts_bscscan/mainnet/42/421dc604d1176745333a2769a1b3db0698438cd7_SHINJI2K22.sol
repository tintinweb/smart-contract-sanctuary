...
contract SHINJI2K22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shinji2K22";
    string constant _symbol = "S2K22";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5A00D271e8bb4b6463862937EF8ee000294A9A2e;
        teamFeeReceiver = 0xAc0d1aeA2deCEe6BaA59855B6E176294c0f7EDCd;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            // Whitelist
            if(whitelistMode){
                require(isWhitelisted[sender] || isWhitelisted[recipient],"Whitelisted Only");    
            }
        }
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        // dear fucker, stop digging into contracts and enjoy degen life!
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        devFee = _devFee;
        burnFee = _burnFee;
        // dear jeet, stop digging into contracts and enjoy degen life!
