...
contract BabyMarvin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7000000 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'Baby Marvin';
    string private _symbol = 'Baby Marvin';
    ...
    address payable private _marketingWalletAddress = payable(0x97BfcEfdEF733A8AA5FCDFc7656174D653729941);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 100 * 10**3 * 10**9;
