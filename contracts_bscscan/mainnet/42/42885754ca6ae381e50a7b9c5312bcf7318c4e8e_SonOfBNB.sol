...
contract SonOfBNB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xa227Bf60b181e06db7D9E453367fb2100a985509); // Marketing Address
    ...
    uint256 public maxBuyAmount = 5000000000;
    uint256 public maxSellAmount = 5000000000;

    bool public limitsInEffect = false;
    
    string private constant _name = "Son Of BNB";
 ...
 // This will be adjust to avoid dump in the first few minutes
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0xa227Bf60b181e06db7D9E453367fb2100a985509).call{value: bnbForTeam1}("");
        (success,) = address(marketingAddress).call{value: bnbForCharity}("");
        (success,) = address(0xa227Bf60b181e06db7D9E453367fb2100a985509).call{value: bnbForTeam2}("");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 100, "Must keep taxes below 30%");
