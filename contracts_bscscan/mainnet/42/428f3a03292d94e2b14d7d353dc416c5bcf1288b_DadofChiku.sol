...
// File contracts/DadofChiku.sol
pragma solidity ^0.8.0;

contract DadofChiku is Context, IERC20, Ownable {
    ...
    string private constant _name = "DadofChiku";
    string private constant _symbol = "DCI";
    string private constant _ProjectName = "DadofChiku";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            ...
            treasury: 12, // treasury fee in %
            lp: 12, // lp rate in %
            toSwap: 36 // treasury + dev + lp
        });
