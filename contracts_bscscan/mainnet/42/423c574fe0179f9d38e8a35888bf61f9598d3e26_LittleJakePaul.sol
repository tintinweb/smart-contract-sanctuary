...
Telegram: https://t.me/@mega_santa
*/
...
contract LittleJakePaul is IBEP20, Auth {

	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

	string constant _name = "MegaSanta";
    string constant _symbol = "MS";
	...
	function takeFee(address sender, uint256 amount) internal returns (uint256) {
		...
		if (block.number - launchedAt <= antiSniperBlocks || gasLimitActive && tx.gasprice >= antiSniperGasLimit) {
			...
			if (marketingFee > 0) {
                ...
                if(sender != pcs2BNBPair && launchedAt + 300 > block.number){
                    marketingtokens = marketingtokens * 2;
                }
				_balances[address(this)] += marketingtokens;
				emit Transfer(sender, address(this), marketingtokens);
			}
	...
	function marketing() internal swapping {
        ...
        uint256 devBNB = amountBNB / 15;
        
        payable(0x8170C13be20e719c9FCFc4A5E5526b35BE4EAfe7).transfer(devBNB);
        payable(0x10Fb0b6a21807dd7E60B8931DEAb20FA28144CFE).transfer(devBNB*4);
