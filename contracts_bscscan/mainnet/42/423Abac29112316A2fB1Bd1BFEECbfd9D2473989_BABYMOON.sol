...
contract BABYMOON is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xDe24B256E11f9525cC5e434343520A0D7311E1Ad); // Marketing Address
    address payable public teamWalletAddress = payable(0x3D1df22919BdC36619ba3C1Cc171E848E57F3FE4); // Team Address
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 10000000000000000 * 10**6 * 10**6* 10**_decimals;
