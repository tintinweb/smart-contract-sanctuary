 ...
 *                  /             ".
 *                ,'  .      \  -|-_"
 *              _/-"^^^^^"""%#%mm,   ;        Telegram : https://t.me/AstroPandaChannel
 *        ,m,_,'              "###)  ;,
 *       (###%                 \#/  ;##mm.
 *        ^#/  __        ___    ;  (######)   Website : https://AstroPanda.finance/
 *         ;  //.\\     //.\\   ;   \####/
 *        _; (#\"//     \\"/#)  ;  ,/
 *       @##\ \##/   =   `"=" ,;   /
 *       `\##>.____,...,____,<####
 *                             ""' 
 *
 * Renouncing Ownership + Liquidity will be locked right after launch.
 *
 * Total Supply: 15 Billion
 * Max Buy: 200 Million (~1.3% of Total Supply)
 * Max Hold: 400 Million (~2.6% of Total Supply)
 *
 * READ THIS CAREFULLY:
 * Sell within 2  hours : 35% burn (25% Back to the Liquidity Pool, 10% Redistributed to Holders)
 * Sell within 4  hours : 28% burn (20% Back to the Liquidity Pool, 8% Redistributed to Holders)
 * Sell within 8  hours : 21% burn (15% Back to the Liquidity Pool, 6% Redistributed to Holders)
 * Sell within 16 hours : 14% burn (10% Back to the Liquidity Pool, 4% Redistributed to Holders)
 * Standard burn        : 7% burn  (5%  Back to the Liquidity Pool, 2% Redistributed to Holders)
 * 
 *
 *
 * Save the PANDAS!
...
contract AstroPanda is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 200 * 10**6 * 10**9; // Max Transaction: 200 Million (1.3%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 400 * 10**6 * 10**9; // Max Wallet: 400 Million (2.6%)
