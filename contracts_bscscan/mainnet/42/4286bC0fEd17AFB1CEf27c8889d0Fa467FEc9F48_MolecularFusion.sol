...
contract MolecularFusion is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 2500000000000;
  string private _symbol = "MFUS";
  string private _name = "MolecularFusion";
