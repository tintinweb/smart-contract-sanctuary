...
contract Ownable is Context {
    address private _owner = 0x1ff17aa19eBf4918775623f02A28cb2A171d9FEf;
...
contract StrayCat is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x57A642bC86D06C7069cBC44fEa15D755B9C33956); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "StrayCat"; // token name
    string private _symbol = "StrayCat"; // token symbol
    ...
    uint256 public _liquidityFee = 10; // liquidity fee 3%
