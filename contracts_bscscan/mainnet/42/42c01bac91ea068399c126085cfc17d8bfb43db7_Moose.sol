...
contract Moose is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8f7f251b74aAcaDB99fD8925C1A029F3D4008F9d); // Marketing Address
    address payable public charityAddress = payable(0x8f7f251b74aAcaDB99fD8925C1A029F3D4008F9d); // Charity/Dev Address
    ...
    string private _name = "Moose Token";
