...
contract DL is Context, IERC20, Ownable {
    ...
    uint256 public                _taxFee = 1; // 1% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 10; // 10% of transactions will be kept for liquidity
