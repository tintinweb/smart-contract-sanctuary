...
Welcome to KING BABY DOGE
   ...
   I make this #KING BABY DOGE to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/KING BABY DOGE	
   ...
   I will renounce the ownership to burn addresses to transfer #KING BABY DOGE to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 10% total supply to the pool
   Can you make #KING BABY DOGE 1000X? 
...
contract KingBabyDoge is Context, IERC20, Ownable {
    ...
    string private _name = 'KING BABY DOGE';

    string private _symbol = 'KING BDOGE';
