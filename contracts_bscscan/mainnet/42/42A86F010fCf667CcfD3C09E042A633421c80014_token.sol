...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1369000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Phenas Token";
    string private _symbol = "Phenas";
    ...
    address public ownerAddres = address(0x7bD694514BF4C01528b53a311A81cd262DED2F6A);
    address public devAddress = address(0xCdAbDbF54B642Ca080B51B7BeFE37e53fe8C79d8);
    ...
    uint256 public _maxTxAmount = 1369000000000000 * 10 **18;
    ...
    function setNumTokensSell(uint256 value) external onlyOwner() {
