...
JOIN THE MISSION
Buying & holding DogeCoke creates value for everyone on the network as a whole. It’s a win, win.
...
- FAIR TAX 🥤
8% Transaction tax - Autorewards for holders 
7% Transaction tax - Distributed back to holders and developer fee for marketing

- PART OF A FAMILY 🥤
Of coins that's about to change the game with a unique and based community around a classic drink, loved by all.

-UNRUGGABLE 🥤
Shibacoke is always on your side! With no dev wallets, renounced ownership and liquidity locked.
