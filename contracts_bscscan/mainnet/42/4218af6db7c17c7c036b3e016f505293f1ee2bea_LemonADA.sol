...
/**
 *Hello friends, safu project, Chris Approved. 
*/
...
contract LemonADA is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x856776d029711B60C7b806f3FfC832dEB12FE38C;
    address public _devWalletAddress = 0x311c18B4eA856cF7eC81E0Bc273c5Fa3aAf84180;
    ...
    constructor() public ERC20("LemonADA", "$Lemon") {
...
contract LemonADADividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("LemonADA Dividends", "LemonADA_dividends") {
    	claimWait = 3600;
