pragma solidity ^0.8.11;
  ...
  contract FlogeInu is Context, IERC20, Ownable {
      ...
      address public constant privateSaleWallet = 0x37d586E590762b3Dc8fA3C9510a76ef9A0E15512;


      //AIRDROP DATA

      uint256 public airdropLockDuration = 5 days;
      ...
      constructor () {
          ...
          excludeFromReward(privateSaleWallet);
          excludeFromReward(address(0xdead));

          emit Transfer(address(0), _msgSender(), _tTotal);
          _transfer(_msgSender(), marketingWallet, 20000000 * 10**6 * 10**9);
          _transfer(_msgSender(), airdropWallet, 10000000 * 10**6 * 10**9);
          _transfer(_msgSender(), charityWallet, 5000000 * 10**6 * 10**9);
          _transfer(_msgSender(), privateSaleWallet, 10000000 * 10**6 * 10**9);
      ...
      function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
          ...
          _tOwned[address(0xdead)] = _tOwned[address(0xdead)].add(burnFee);
          _rOwned[address(0xdead)] = _rOwned[address(0xdead)].add(burnFee.mul(_getRate()));
          emit Transfer(sender, address(0xdead), burnFee);
