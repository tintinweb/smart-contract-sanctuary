...
contract BTCManiaDividendDistributor is IDividendDistributor {
...
contract BTCMania is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BTC Mania";
    string constant _symbol = "BTCMania";
    uint8 constant _decimals = 9;

   uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 500; // 0.2% (Change after contract deployed)
    ...
    */
    ...
    BTCManiaDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new BTCManiaDividendDistributor(address(router), BTC);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        BTC = rewardToken;
        distributor = new BTCManiaDividendDistributor(address(router), rewardToken);
    }	
