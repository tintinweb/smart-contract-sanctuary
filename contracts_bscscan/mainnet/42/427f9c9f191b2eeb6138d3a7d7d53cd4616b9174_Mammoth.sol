...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Sushi = IBEP20(0x947950BcC74888a40Ffa2593C5798F11Fc9124C4);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = Sushi.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Sushi.transfer(shareholder, amount);
...
contract Mammoth is IBEP20, Auth {
    using SafeMath for uint256;

    address Sushi = 0x947950BcC74888a40Ffa2593C5798F11Fc9124C4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SushiRewardsTest";
    string constant _symbol = "SUSHIR";
