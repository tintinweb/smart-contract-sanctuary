...
RichXRP | XRP Reflection

Tokenomics : 3 AutoLP Tax to make the chart Less Volatile.
             10% XRP Rewards ,Investors can earn back their money without selling.
...
// CHANGE
contract RichXRP is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "RichXRP";
    string constant _symbol = "RichXRP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100; // 4% MAX 40,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x49cDb5ABcd435aE94853f3B6e2FAF5978FF0F6aA);
