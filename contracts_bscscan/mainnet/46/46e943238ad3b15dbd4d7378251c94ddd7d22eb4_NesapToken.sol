...
contract NesapToken is Context, ERC20, Ownable {
    ...
    // Address that include in Nesap LP list
    mapping(address => bool) private _includeInNesapLpList;
    ...
    string private _name = "Nesap";
    string private _symbol = "NESAP";
    ...
    // Minimum NESAP sell order to trigger buyback
    ...
    constructor () public {
        ...
        _includeInNesapLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInNesapLpList(address _address) public view returns (bool) {
        return _includeInNesapLpList[_address];
    }

    function setIncludeInNesapLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInNesapLpList[_address] = _isIncludedOrNot;
    }
