...
contract mm is Context, IERC20, Ownable {
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 99 * 10**4 * 10**9;
    uint256 private constant numTokensSellToAddToBuyback = 1 * 10**4 * 10**9;
