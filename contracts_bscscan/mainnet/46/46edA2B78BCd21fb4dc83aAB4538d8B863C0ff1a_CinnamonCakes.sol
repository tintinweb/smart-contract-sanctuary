...
// LATEST CAKE REWARD TOKEN ON BSC! TG: cinnamoncakesbsc
...
contract CinnamonCakes is Context, IERC20, Ownable {
    ...
    string private _name = "CinnamonCakes";
    string private _symbol = "CCAKES";
