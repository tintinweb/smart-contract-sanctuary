...
contract AssFaceShiba is Context, IERC20, Ownable {
    ...
    string private _name = 'AssFaceShiba';
    string private _symbol = 'Shiba';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 8; // 8% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 11; // 11% of transactions will be kept for liquidity
