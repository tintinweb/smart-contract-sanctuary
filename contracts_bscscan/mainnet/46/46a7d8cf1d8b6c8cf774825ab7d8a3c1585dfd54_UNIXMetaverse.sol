...
/**
 *  UNIX Metaverse - UNIX Metaverse gives you the opportunity to create virtual 3D objects in one system 

    Telegram: https://t.me/unixmetaverse
 */
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x26f21A7D387700F4574Ea125D3A2AAA563a7de68;
...
contract UNIXMetaverse is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5B900235c505b132297451413256d9A9a803B02D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 20000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "UNIX Metaverse";
    string private _symbol = "UXMV";
