...
/**
 Welcome to PocketDoge 
   ...
   I will renounce the ownership to burn addresses to transfer #PocketDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make PocketDoge 100X? 
   ...
   it's the best part of the #PocketDoge A idea, increasing the liquidity pool automatically, 
