...
Telegram = https://t.me/DipGoneInSixtySeconds
...
// CHANGE
contract DipGoneInSixtySeconds is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DipGoneInSixtySeconds";
    string constant _symbol = "DGI60s";
    ...
    uint256 public swapThreshold = _totalSupply / 300; // 0.3%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x26410c130B0De49ea0D0A4b37801b18A9b200bfa);
