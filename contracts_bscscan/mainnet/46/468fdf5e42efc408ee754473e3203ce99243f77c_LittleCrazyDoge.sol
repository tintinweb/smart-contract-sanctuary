...
contract LittleCrazyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa7B692DDc5e07b4B697C575DF4cb6A24D733ae18); // Marketing Address
    ...
    string private _name = "Little Crazy Doge";
    string private _symbol = "LC DOGE";
