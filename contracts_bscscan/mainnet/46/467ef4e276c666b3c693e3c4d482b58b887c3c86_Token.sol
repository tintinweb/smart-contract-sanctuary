...
contract Token is ERC20, Ownable {
    ...
    //Anti-Whale System
    uint256 public maxWalletTokens =  1500000000000000000000 * (10**18);
    uint256 public maxBuyTransactionAmount = 1500000000000000000000 * (10**18);
...
contract $CAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3333 && newClaimWait <= 86400, "$CAKE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
