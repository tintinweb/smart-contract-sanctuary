...
/**
CurrencyPunks is a result of hard working and noble inspiration.
Based on the marketing plans as well as products development,
we are all ready to bring a Legend of all Doge coin. Moreover,
it’s a community driven token, so you as a holder, your role
is also important to us. With community involvement, LegendDoge
surely be the king and rule the crypto world.

   #BEE
   
   #LIQ+#RFI+#SHIB+#DOGE = #CurrencyPunks
...
contract CurrencyPunks is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address BNBReward = 0x64260D965be21d7dD8293e9b77177F81627f917A;
    ...
    string private _name = "CurrencyPunks";
    string private _symbol = "CUPU";
