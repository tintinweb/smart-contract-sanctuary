...
/** https://t.me/LiquidityProtocolBSC
 *
*/
...
/**
 *  
 * Can and will blacklist bots/snipers after tax is lowered to normal
 * High tax on launch for bots/snipers
*/ 
...
contract LiquidityProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Liquidity Protocol";
    string private _symbol = "$LP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEe47bfc22FDD7a8D869a589936D03Eec2D354395); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xEe47bfc22FDD7a8D869a589936D03Eec2D354395); // buyback Address
    ...
    uint256 public _maxTxAmount = 50000000000000 * 10**9; // 0.1%
