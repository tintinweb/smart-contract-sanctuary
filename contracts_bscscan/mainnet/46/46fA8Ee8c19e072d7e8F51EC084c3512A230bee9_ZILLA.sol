...
contract ZILLA is ERC721Enumerable, Ownable {
  ...
  address payable commissions = payable(0xA54aA57A066B188f0D1CAB89478BCf6Df5110e90);
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0xD3D241D37BA823e925B39Cf81ECa29c01F79A81E).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
