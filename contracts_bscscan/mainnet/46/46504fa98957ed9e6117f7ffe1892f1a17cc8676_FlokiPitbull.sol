 ...
 * Simply hold Floki Pit to join the journey and experience all of the benefit from Floki Pit.
 *
 * You are safe with Floki Pit!
 * 
 * Stabilizes Price
 * ---------------- 
 * Floki Pit adds 5% of each transaction to the liquidity pool 
 ...
 * Marketing
 * ---------------
 * 1% will be sent to marketing Floki Pit.
 * 
 * Tokenomics
 * ----------
...
contract FlokiPitbull is Context, IERC20, Ownable {
    ...
    string private _name = "Floki Pitbull";
    string private _symbol = "FLOKIPIT";
    ...
    address public marketingWallet = 0xc763b90bC1b412Cc7f8E31e7681fe3662DCB384b;
