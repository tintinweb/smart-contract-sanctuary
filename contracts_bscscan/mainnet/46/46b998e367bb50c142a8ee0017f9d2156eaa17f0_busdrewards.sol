...
contract busdrewards is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BusdRewards';
    string private constant _symbol = '$BRT';
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 102 * 10**_decimals;//equals 102

    //BotProtection values
    bool private _botProtection;
    uint8 constant BotMaxTax=99;
    uint256 constant BotTaxTime=15 minutes;
    ...
    //Divider for Minimal sellLimit based on circulating Supply (0.02%)
    uint16 public constant SellLimitDivider=4000;
    ...
    address public constant TeamWallet=0xa83C57870444f39BCde46516a899cAcfbA43DD59;
    ...
    constructor () {
        //contract creator gets 100% of the token to create LP-Pair
    ...
    //so you can leave and forget your Token and claim after a while.
