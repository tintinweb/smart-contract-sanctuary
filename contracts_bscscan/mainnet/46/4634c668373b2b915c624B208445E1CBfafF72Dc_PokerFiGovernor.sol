...
{
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 10e18;
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 100000e18;

    uint256 public constant MIN_VOTING_DELAY = 1200;
    uint256 public constant MAX_VOTING_DELAY = 201600;

    uint256 public constant MIN_VOTING_PERIOD = 28800;
    uint256 public constant MAX_VOTING_PERIOD = 403200;
    ...
    constructor(ERC20Votes _token, TimelockController _timelock)
        Governor("PokerFi Governor")
        GovernorVotes(_token)
        GovernorVotesQuorumFraction(51)
        GovernorTimelockControl(_timelock)
    {
        _votingDelay = 57600;
        _votingPeriod = 144000;

        _proposalThreshold = 15e18;
    }
    ...
    function updateVotingDelay(uint256 newVotingDelay) external onlyGovernance {
        ...
        emit VotingDelayUpdated(oldVotingDelay, _votingDelay);
    }
    ...
    function updateVotingPeriod(uint256 newVotingPeriod) external onlyGovernance {
        ...
        emit VotingPeriodUpdated(oldVotingPeriod, _votingPeriod);
    }

    function updateProposalThreshold(uint256 newProposalThreshold) external onlyGovernance {
        ...
        emit ProposalThresholdUpdated(oldProposalThreshold, _proposalThreshold);
    }
