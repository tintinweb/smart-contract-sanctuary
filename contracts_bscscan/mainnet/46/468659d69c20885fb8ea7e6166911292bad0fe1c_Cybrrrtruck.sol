//stealth launched, 5% redistribution, 5% burn, 2% marketing wallet
...
contract Cybrrrtruck is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Cybrrrtruck";
    ...
    uint256 public _burnFee      = 500; // 4% of every transaction is burned
    uint256 public _DevelopmentFee = 200; // 1% of every transaction is sent to Development wallet
