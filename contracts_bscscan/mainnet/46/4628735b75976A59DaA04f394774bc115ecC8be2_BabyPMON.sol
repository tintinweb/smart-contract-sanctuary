...
/*
  o__ __o           o           o__ __o  \o       o/       o__ __o     o          o        o__ __o        o          o  
 <|     v\         <|>         <|     v\  v\     /v       <|     v\   <|\        /|>      /v     v\      <|\        <|> 
 / \     <\        / \         / \     <\  <\   />        / \     <\  / \\o    o// \     />       <\     / \\o      / \ 
 \o/     o/      o/   \o       \o/     o/    \o/          \o/     o/  \o/ v\  /v \o/   o/           \o   \o/ v\     \o/ 
...
tg :  @BabyPMON
website : http://www.babyPMON.space
*/
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // Solidity only autoPMONally asserts when dividing by 0
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PMON = IBEP20(0x4338665CBB7B2485A8855A139b75D5e34AB0DB94); 
...
contract BabyPMON is IBEP20, Auth {
    using SafeMath for uint256;

    address PMON = 0x1796ae0b0fa4862485106a0de9b654eFE301D0b2;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyPMON";
    string constant _symbol = "BabyPMON";
