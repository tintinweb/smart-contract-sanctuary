...
contract Token {
    ...
    constructor(string memory _name,string memory _symbol,uint8 _decimals,uint256 _totalSupply,address _TaxCollection) public {
        ...
        numTokensSellToAddToLiquidity=50000*10**uint256(decimals);
    ...
    function _transfer(
        ...
        if (
            ...
            //add USDT To Custody Contract
            swapTokensToBNB(contractTokenBalance);
        ...
        balanceOf[address(this)] = balanceOf[address(this)].add(fee_value);
        emit Transfer(_from, _to, _value.sub(fee_value));
    }

    function swapTokensToBNB(uint256 _tokenAmount)private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();

        allowance[address(this)][ address(uniswapV2Router)] = _tokenAmount;
