...
/**
   ChesterToken
   Chester, is the egyptian name of the god of death and the Underworld. In the Crypto space Chester comes to protect its holders and to overtake its biggest competitors #DOGE #SHIBA
   ...
   Let's get this coin to 10,000x and Chester will protect you and your beloved from the Underworld
 */
...
contract Yum is Context, IERC20, Ownable {
    ...
    string private _name = "YumCoin";
    string private _symbol = "Yum";
