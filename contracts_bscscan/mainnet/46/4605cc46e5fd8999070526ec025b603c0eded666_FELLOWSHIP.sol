...
/**
    ----------------------------------------------
     FELLOWSHIP RAPTORS İS BİNANCE SMARTCHAİN TOKEN
    ----------------------------------------------
**/
...
contract FELLOWSHIP is Context, IERC20, Ownable {
    ...
    string private _name = "FELLOWSHIP RAPTORS";
    string private _symbol = "FSHP";
