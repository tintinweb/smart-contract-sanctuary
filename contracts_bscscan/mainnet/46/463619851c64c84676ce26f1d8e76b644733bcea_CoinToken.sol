...
//NFTank - October - 2021
//This contract serves as a regular token with basic tax and liquidity functions.
//                 _                 __                 
//             __.--**"""**--...__..--**""""*-.            
//           .'                                `-.         
//         .'                         _           \        
...
//           :  *:   ;             :    |`*-'   `*+-*       
//           `**-*`""               *---*                 
//Ready to be traded for intent to use with a project or usecase.
//For the purpose of this contract ; It is to be used as a governance token for the
//NFTank community, for various uses, such as minting NFTs, potential staking, and fund transfers
//for community members. It does not contain any malicious function which could potentially affect the //of a project
//For the actual values for liquidity and fees, refer to the contract readable public information as //those are determined when deploying the actual contract.
