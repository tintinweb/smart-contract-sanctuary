...
/**
   ...
   ** 1,000,000,000,000
   ...
   5% Liquidity: 50,000,000,000
   5% Team & Development: 50,000,000,000
   50% Supply at Listing: 500,000,000,000

   ** Burned
   ----------------------
   15% Burned Launch: 150,000,000,000
   10% Burned after 500 Holders: 100,000,000,000
   10% Burned after 1000 Holders: 100,000,000,000
...
contract VertigoCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0FAdfFD924e2534e6C32Ea98D886441C35899F0D); // Marketing Address
    ...
    string private _name = "Vertigo Coin";
    string private _symbol = "VECO";
    ...
    uint256 private _intervalMinutesForSwap = 5 * 1 minutes;
