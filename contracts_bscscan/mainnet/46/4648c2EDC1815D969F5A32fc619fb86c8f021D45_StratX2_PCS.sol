...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-ELK staking vault.
...
contract StratX2_PCS is StratX2 {
    constructor(
        ...
        earnedToELKPath = [earnedAddress,wbnbAddress,ELKAddress];
        earnedToToken0Path = [earnedAddress,wbnbAddress,ELKAddress];
        earnedToToken1Path = [earnedAddress,wbnbAddress];
        token0ToEarnedPath = [ELKAddress,wbnbAddress,earnedAddress];
