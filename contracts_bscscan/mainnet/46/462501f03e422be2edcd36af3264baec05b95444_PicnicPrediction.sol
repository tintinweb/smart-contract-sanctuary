...
contract PicnicPrediction {
    
    uint public pollId;
    Picnic public picnic;
    ...
    constructor (address _Picnic,address _owner) {
        picnic = Picnic(_Picnic);
        owner = _owner;
    }
    ...
    function polling(
      ...
      uint _flag
         ...
         picnic.transferFrom(msg.sender,address(this),_amount);
    ...
    function getResult(
        ...
        address _user
         ...
         require(!userInfo.status ,"user already claimed");
    ...
    function claim (
        ...
        uint amount = getResult(_poolid,msg.sender);
         
        picnic.transfer(msg.sender,amount);
           userInfo.status = false;
            emit Claim(msg.sender,amount,_poolid,block.timestamp);
        }
    ...
    function failSafe(address  _toUser, uint _amount) public onlyOwner returns(bool) {
        ...
        require(picnic.balanceOf(address(this)) >= _amount, "PICNIC: Insufficient balance");
        picnic.transfer(_toUser,_amount);
