...
/**
 Welcome to High res FlashDoge
   ...
   I will renounce the ownership to burn addresses to transfer #FlashDoge to the community

   I will add 1.3 BNB and all the left 10% total supply to the pool
   Can you make FlashDoge 100X? 
   ...
   it's the best part of the #FlashDoge idea, increasing the liquidity pool automatically, 
