...
contract Babyzilla is Context, IERC20, Ownable {
    ...
    address payable public treasuryAddress ; // Marketing Address
    address payable public devAddress ; // Team Address

    mapping(address => bool) public isAutomatedMarketMakerPair;

    string private constant _name = "BABYZILLA";
    string private constant _symbol = "BABYZILLA";
