...
/**
 * PolyBUSD is safe from polygon exploits. Hold to earn BUSD.
 */
...
contract PolyBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PolyBUSDDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("PolyBUSD", "PBUSD") {
        _ETHRewardsFee = 5;
        _liquidityFee = 5;
		_marketingFee = 1;
    	...
    	dividendTracker = new PolyBUSDDividendTracker();

    	liquidityWallet = owner();
		
		bulkSender = payable(0x6fA178302a6ffffC5bcdB100eA87f5Af5a83C556);
		marketingWallet = payable(0x6fA178302a6ffffC5bcdB100eA87f5Af5a83C556);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
       ...
       PolyBUSDDividendTracker newDividendTracker = PolyBUSDDividendTracker(payable(newAddress));
...
contract PolyBUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("PolyBUSD_Dividend_Tracker", "PolyBUSD_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "PolyBUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "PolyBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "PolyBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PolyBUSD_Dividend_Tracker: Cannot update claimWait to same value");
