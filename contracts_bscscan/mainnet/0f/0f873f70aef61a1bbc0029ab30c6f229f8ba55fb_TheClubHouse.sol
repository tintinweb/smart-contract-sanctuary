...
theclubhouse will offer private group for holders only ...
*/
...
contract TheClubHouse is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PlugsHouse";
    string constant _symbol = "PLGH";
