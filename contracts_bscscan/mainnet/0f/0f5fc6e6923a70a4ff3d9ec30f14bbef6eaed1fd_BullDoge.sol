...
contract BullDoge is IERC20 {
    ...
    uint256 private constant startingSupply = 100_000_000_000; // 10 Billion, underscores aid readability
    ...
    address payable private _marketingWallet = payable(0x3dA139cf1088850de7b7C3521466a9dA7f064896);
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            require (tradingPaused != true, "Trading not yet enabled.");
            if (sameBlockActive) {
                if (from == lpPair){
