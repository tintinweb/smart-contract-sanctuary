...
contract BigMomInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BigMomInu";
    ...
    function BigMomInuLaunchStatus(uint256 amount) external authorized {
        _maxTxAmount = amount;
	...
	function BigMomInuSniperBan(address user, bool banned) external authorized {
		if (banned) {
