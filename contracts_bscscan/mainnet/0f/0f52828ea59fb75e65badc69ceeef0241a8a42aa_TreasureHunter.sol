...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe5A4823b0391051b9faa64d6a7F32bB8bf078AdE;
...
contract TreasureHunter is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa5E0b8B387127C78F48F67E6e25F1d9833c5E303;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 888000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Treasure Hunter";
    string private _symbol = "TH";
    ...
    uint256 public _maxTxAmount = 888000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 800000000 * 10**18;
