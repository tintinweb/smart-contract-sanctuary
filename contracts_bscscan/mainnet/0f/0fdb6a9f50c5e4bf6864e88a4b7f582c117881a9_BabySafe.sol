...
// CHANGE
contract BabySafe  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabySafe";
    string constant _symbol = "BabySafe";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x3209Ef6bC6202F725283844122dAA662348619c3); // Change
