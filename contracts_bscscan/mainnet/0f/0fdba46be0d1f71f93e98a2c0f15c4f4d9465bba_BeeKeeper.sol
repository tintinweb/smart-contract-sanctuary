...
library Address {
 ...
 contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x71FacF388f4d0e9Fe1CC9450bFb61d5fD9f85FED;
...
contract BeeKeeper is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x537f2C0Ca6E7fDa4aF2Eb550DF027306af7879eb;
    ...
    string private _name = "BeeKeeper";
    string private _symbol = "BKPR";
    ...
    function _transfer(
        ...
        // also, don't get caught in a circular liquidity event, therefore don't swap & liquify if sender is uniswap pair.
