...
/**
 Welcome to OrangeDoge     @Telegram  https://t.me/OrangeDoge1
   ...
   I will renounce the ownership to burn addresses to transfer #OrangeDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make OrangeDoge 100X? 
   ...
   it's the best part of the #OrangeDoge idea, increasing the liquidity pool automatically, 
...
contract OrangeDoge is BEP20 {
    ...
    constructor() public {
	symbol = "ORANGE DOGE";
    name = "OrangeDoge (https://t.me/OrangeDoge1)";
    fees = 10;
