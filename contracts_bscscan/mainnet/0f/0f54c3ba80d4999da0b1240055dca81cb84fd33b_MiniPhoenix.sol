...
/**
/**
/**    📱https://t.me/MiniPhoenix
 * 
      ✅📢📢📢MiniPhoenix (MPN)📢📢📢 STEALTH LAUNCH
...
contract MiniPhoenix is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    uint256 public _maxTxAmount = 10000 * 10**2 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**5 * 10**18;
