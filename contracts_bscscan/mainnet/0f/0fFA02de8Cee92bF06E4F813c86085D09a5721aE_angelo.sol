...
contract angelo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3e4552Ce5EdAcf6329BE1aB7d5Fb111205aEB431); // Marketing Address
    ...
    string private _name = "angelo";
    string private _symbol = "angelo";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x3e4552Ce5EdAcf6329BE1aB7d5Fb111205aEB431);
    }
