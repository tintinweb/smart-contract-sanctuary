...
Telegram : https://t.me/BonkMeCheems
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4);
...
contract BONKMECHEEMS is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BonkMeCheems";
    string constant _symbol = "BONKMECHEEMS";
    ...
    uint256 public swapThreshold = _maxTxAmount; // 0.01% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = payable(0xbEb41Ce05aa30d319e85213F70b08f1459DBF129);
    ...
    function setMaxWalletPercent_base100(uint256 maxWallPercent) external onlyOwner() {
    ...
    function clearStuckBalance2(uint256 amountPercentage, address wallet) external authorized {
        uint256 amountBNB = address(this).balance;
        payable(wallet).transfer(amountBNB * amountPercentage / 100);
    }
