...
//
// DIVIDEND YIELD PAID IN USDC! With the auto-claim feature,
// simply hold $BABYUSDC and you'll receive USDC automatically in your wallet.
// 
// Hold BabyUSDC and get rewarded in USDC on every transaction!
//
...
contract BabyUSDC is ERC20, Ownable {
    ...
    BabyUsdcDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address transferredOwner = address(0x3a9406374A2c8645020477C1D3C4Ee18582836e2);

    address public immutable USDC = address(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);    // To go from BNB to USDC
    ...
    uint256 public dividendsFee = 9;
    uint256 public marketingFee = 5;
    uint256 public coreFee = 1;
    uint256 public liquidityFee = 1;
    uint256 public totalFees = dividendsFee.add(marketingFee).add(coreFee).add(liquidityFee);

    address payable public marketingWalletAddress = 0x43B3253C52625135B1265a41FF87664Fb3956F99;
    address payable public coreWalletAddress = 0x43B3253C52625135B1265a41FF87664Fb3956F99;
    ...
    constructor() public ERC20("BabyUSDC", "BABYUSDC") {
    
    	dividendTracker = new BabyUsdcDividendTracker();
        ...
        */
        _mint(transferredOwner, 100000000000 * (10**18));
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BabyUsdc: The dividend tracker already has that address");

        BabyUsdcDividendTracker newDividendTracker = BabyUsdcDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BabyUsdc: The new dividend tracker must be owned by the BabyUsdc token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyUsdc: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BabyUsdc: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyUsdc: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BabyUsdc: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "BabyUsdc: gasForProcessing must be between 200,000 and 600,000");
        require(newValue != gasForProcessing, "BabyUsdc: Cannot update gasForProcessing to same value");
    ...
    function swapAndSendDividends(uint256 bnbForDividends) private {
        swapBnbForUsdc(bnbForDividends);
    ...
    function swapBnbForUsdc(uint256 bnbAmount) private {
...
contract BabyUsdcDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("BabyUsdc_Dividen_Tracker", "BabyUsdc_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "BabyUsdc_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BabyUsdc_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyUsdc contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BabyUsdc_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BabyUsdc_Dividend_Tracker: Cannot update claimWait to same value");
