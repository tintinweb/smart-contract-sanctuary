...
/**
 * @title RugZombieNftV2
 * NFT contract mainly used in the RugZombie platform but implements ERC721 for external marketplace support.
 */

contract RugZombieNftV2 is ERC721, Ownable {
    ...
    // Whitelisted addresses that can call #reviveRug
    ...
    // enable / disable address's admin status
    ...
    function reviveRug(address _to) public returns(uint) {
        ...
        require(adminWhitelist[msg.sender], 'reviveRug: must be called by whitelisted address.');
