...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MatrixRebond";
    string internal constant SYMBOL = "MTRX";
...
abstract contract Matrix is BaseRfiToken, Liquifier, Antiwhale {
...
contract MatrixV1Beta is Matrix{

    constructor() Matrix(Env.MainnetV2){
