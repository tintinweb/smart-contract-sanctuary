...
contract PoochonInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x456403c8929D6b7bfd92cDD50bcaa78d5E3d3564); // Marketing Address
        
    address payable public teamAddress =
        payable(0xd27dc12B93cd61C5F01eef1D911FaD6FFFaC7010); // Team Address
    ...
    string private constant _name = "Poochon Inu";
    ...
    uint256 private _sellMarketingFee = 17;
    uint256 private _sellTeamFee = 7;
