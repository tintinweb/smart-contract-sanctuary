...
contract AirDoge is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 internal _tokenTotal = 2_000_000e9;
    ...
    uint256 public maxTxAmount = _tokenTotal.div(10); 
    
    uint256 public minTokensBeforeSwap = 700e9;
