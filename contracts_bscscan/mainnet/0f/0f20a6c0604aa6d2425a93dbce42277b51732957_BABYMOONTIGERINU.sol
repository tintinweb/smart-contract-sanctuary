...
/**
        Welcome to Baby Moon Tiger Inu New Hype Token!



        Stealth Launch - $BabyMoonTigerInu
    ...
    🐯Tokenomics : 
        ...
        4% Marketing
        4% back to LP
        4% MoonTigerInu Reflection

    Telegram: https://t.me/babymoontiger
...
contract BABYMOONTIGERINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyMoonTigerInu";
    string constant _symbol = "$BabyMoonTigerInu";
