 ...
 * - 1 day Liquidity Lock (will send and pin mudra link in the TG)
 ...
 TG: https://t.me/granADAbsc
 
 Hold $granADA and get $ADA automatically in your wallet every hour!
 ...
 Reflection/Taxes: 10% in ADA, 2% in Marketing, 6% in Liquidity
...
// CHANGE
contract granADA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "granADA";
    string constant _symbol = "granADA";
    ...
    uint256 totalFee = 1700; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x797DcbebcE78de6f6BFCa736F286dBe728ab3aB9);
