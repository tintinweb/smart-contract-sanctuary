...
/**
   ...
   Welcome Mad Doge Token
   
   This is a community token. If you want to create a telegram I suggest to name it to @MadDogeTokenBSC
   ...
   I will renounce the ownership to burn addresses to transfer #MadDogeToken to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #MadDogeToken 10000X? 
...
contract MadDogeToken is Context, IERC20, Ownable {
    ...
    string private _name = "Mad Doge Token";
