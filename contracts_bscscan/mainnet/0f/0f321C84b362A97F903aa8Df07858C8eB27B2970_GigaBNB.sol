...
contract GigaBNBDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("GigaBNB_Dividend_Tracker", "GigaBNB_Dividend_Tracker", 9) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 1000000 * (10**9); //must hold 10000000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "GigaBNB_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "GigaBNB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GigaBNB contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "GigaBNB_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "GigaBNB_Dividend_Tracker: Cannot update claimWait to same value");
...
contract GigaBNB is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x66919398B7F5c92eb4B3bECc66458845DEF9382a;

    bool private swapping;

    GigaBNBDividendTracker public dividendTracker;
    ...
    constructor() public BEP20("GigaBNB", "GigaBNB", 9) {
    	...
    	dividendTracker = new GigaBNBDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "GigaBNB: The dividend tracker already has that address");

        GigaBNBDividendTracker newDividendTracker = GigaBNBDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "GigaBNB: The new dividend tracker must be owned by the GigaBNB token contract");
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "GigaBNB: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "GigaBNB: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "GigaBNB: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "GigaBNB: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "GigaBNB: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "GigaBNB: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "GigaBNB: Cannot update gasForProcessing to same value");
...

{
  ...
  "libraries": {
    "/C/Users/yvesr/flashbnb/contracts/flashbnb.sol": {
      "IterableMapping": "0x8a00fC4E44bba0B6324d457b25d44913D88C9539"
    }
  },
  "outputSelection": {
    "*": {
