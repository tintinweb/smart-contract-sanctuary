...
contract Mdexi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 200000000000 * 10**9; // 200 Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Mini Dexi";
    string private _symbol = "MDEXI";
    ...
    address public marketingWallet = 0x0DE70fA8178eACF82B63eCfA71E53B116757bfF6;
    ...
    uint256 public _maxTxAmount = 2000000000 * 10**9; // 1%
    uint256 public _maxWalletSize = 6000000000 * 10**9; // 3%
    uint256 private numTokensSellToAddToLiquidity = 200000000 * 10**9; // 0.1%
