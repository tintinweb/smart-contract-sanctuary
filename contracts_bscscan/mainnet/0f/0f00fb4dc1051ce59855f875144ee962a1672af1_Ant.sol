...
contract Ant is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xD3578840F7ec747C069B7Bc21802dD2A89588886); // Marketing Address
    ...
    uint256 private _tTotal = 500000000 * 10**2 * 10**9;
    ...
    uint256 public _maxTxAmount = 500000000 * 10**2 * 10**9;
