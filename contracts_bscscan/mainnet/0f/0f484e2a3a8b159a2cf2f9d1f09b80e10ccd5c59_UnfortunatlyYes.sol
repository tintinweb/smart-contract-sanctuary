...
// https://t.me/UnfortunatlyYes 12% tax :  7% lp as buyback 4% marketing contract stacks rewards and unload it on sells do not snipe it first block 99% taxed

// made by https://t.me/BlueprintCalls 
...
// CHANGE
contract UnfortunatlyYes is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Unfortunatly, Yes";
    string constant _symbol = "UFOy";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; // 3% MAX 300,000
    ...
    uint256 liquidityFee = 700; // 2%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; //
    uint256 devFee = 500; // 0%
    uint256 totalFee = 1200; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xa563B6860428b954D7BdeE8d268763E9551775Fe);
