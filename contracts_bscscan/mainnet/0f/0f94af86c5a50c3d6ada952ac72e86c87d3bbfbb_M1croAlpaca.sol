...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  COIN = IBEP20(0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F);
...
contract M1croAlpaca is IBEP20, Auth {
    using SafeMath for uint256;

    address COIN = 0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Micro Alpaca";
    string constant _symbol = "MAfarm";
    uint8 constant _decimals = 9;

//    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals); //1 trillion
    uint256 _totalSupply = 67  * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 3 / 100; //3% of total supply (2.01 coin)
    uint256 public _maxWalletToken = ( _totalSupply * 9 ) / 100; //9% of total supply (6.03 coin)
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 10000; // 5% of supply
    bool inSwap;
