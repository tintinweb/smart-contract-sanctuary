...
Stealth Launching -  marketing is lit.  Most tax to marketing for first hour then will update.

2% BUSD Rewards
6% Marketing 
4% Liquidity 
1% to the Dev (So he does something) 

Dont paper hand - lets hit it

Telegram: https://t.me/squidelfbsc  - TG Private till live. 90% Buy tax until public. Snipers - Rekt
...
contract SquidElf is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SquidElf";
    string constant _symbol = "SElf";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            if(sender == pair && block.number + gweiLimitBlocksAffected <= block.number && tx.gasprice >= gweiLimit){isBlacklisted[recipient] = true;}
        }
