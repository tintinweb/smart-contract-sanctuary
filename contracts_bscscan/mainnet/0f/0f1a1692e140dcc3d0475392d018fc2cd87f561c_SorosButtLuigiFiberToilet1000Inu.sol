...
contract SorosButtLuigiFiberToilet1000Inu is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "https://t.me/SorosButtLuigiFiberToilet1000Inu";
    string constant _symbol = "SBLFT";
