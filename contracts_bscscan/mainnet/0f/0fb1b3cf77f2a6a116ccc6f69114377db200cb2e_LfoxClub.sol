 ...
 * 
 * 
  _     _____ _____  __    ____ _    _   _ ____
 | |   |  ___/ _ \ \/ /   / ___| |  | | | | __ )
 | |   | |_ | | | \  /   | |   | |  | | | |  _ \
 | |___|  _|| |_| /  \   | |___| |__| |_| | |_) |
 |_____|_|   \___/_/\_\___\____|_____\___/|____/
                     |_____|


   #LFOX_CLUB features:
   5% fee auto added to the liquidity pool and locked forever
   6% fee auto distributed to all holders
...
contract LfoxClub is Context, IERC20, Ownable {
    ...
    string private _name = "LFOX_CLUB";
    string private _symbol = "LFCLUB";
