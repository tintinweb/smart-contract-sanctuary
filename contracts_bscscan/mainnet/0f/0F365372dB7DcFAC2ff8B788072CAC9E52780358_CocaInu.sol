...
https://t.me/CocaInuOfficial


5% fee auto add to the liquidity pool to locked
1% fee auto distribute to all holders
4% marketing fee destinated to help the project

I will burn lock LPs and extend as project grows.
I will renounce the ownership to burn addresses to transfer CocaInu to the community, make sure it's 100% safe.

100,000,000,000,000,000 total supply 50% burn 
2% FomoInu max limit for wallet
...
pragma solidity ^0.6.12;
    ...
    contract CocaInu is Context, IERC20, Ownable {
        ...
        uint256 private _maxTxAmount = 500000000000000000000000e9;
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 1 && taxFee <= 11, 'taxFee should be in 1 - 11');
            _taxFee = taxFee;
        }

        function _setmarketingFee(uint256 marketingFee) external onlyOwner() {
            require(marketingFee >= 1 && marketingFee <= 11, 'marketingFee should be in 1 - 11');
