...
contract ShibaFloki is Context, IERC20, Ownable {
    ...
    RouterTwo public immutable FlokiRouter;
    address public immutable flokiPair;
    ...
    uint256 private numTokensSellToAddToLiquidity = 600000 * 10**6 * 10**18;
    ...
    constructor() public {
        ...
        RouterTwo _FlokiRouter = RouterTwo(
            0x10ED43C718714eb63d5aA57B78B54704E256024E
        );
        flokiPair = FlokiFactory(_FlokiRouter.factory()).createPair(
            address(this),
            _FlokiRouter.WETH()
        );
        FlokiRouter = _FlokiRouter;
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = FlokiRouter.WETH();
        _approve(address(this), address(FlokiRouter), tokenAmount);
        FlokiRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0,
            path,
            address(this),
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        _approve(address(this), address(FlokiRouter), tokenAmount);
        FlokiRouter.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            0,
            0,
