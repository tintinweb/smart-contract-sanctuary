...
contract RollMyBlunt is Context, IERC20, Ownable {
    ...
    string private _name = 'RollMyblunt';
    string private _symbol = 'RMB';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 98; // 4% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 1; // 9% of transactions will be kept for liquidity
