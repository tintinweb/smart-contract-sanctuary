...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #GreenNight  

    I make this #GreenNight to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/GreenNightBSC
   ...
   I will renounce the ownership to burn addresses to transfer #GreenNight to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #GreenNight 10000000X? 
   ...
   it's the best part of the #GreenNight idea, increasing the liquidity pool automatically, 
...
contract GreenNight is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("GreenNight", "GreenNight") {
