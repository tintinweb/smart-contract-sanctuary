...
contract ERC20DEXTER is IERC20 {
 ...
 */
contract ERC20Burnable is ERC20DEXTER {
 ...
 */
contract ERC20Mintable is ERC20DEXTER, MinterRole {
 ...
 *
 */
contract ERC20Chocolate is ERC20DEXTER, ERC20Burnable, ERC20Mintable, Pausable {
    ...
    constructor (
        ...
        ERC20DEXTER(initialAccount, _tokenSymbol, _tokenName, initialBalance) {
