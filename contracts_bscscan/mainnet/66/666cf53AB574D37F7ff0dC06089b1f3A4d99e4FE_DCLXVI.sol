...
contract DCLXVI {
    string  private _name = '666 Token';
    string  private _symbol = 'DCLXVI';
    uint256 private _totalSupply = 666666666;
    ...
    constructor () {
        ...
        // setLimits(20000000, 11066666, 666666);
        setLimits(999999999, 999999999, 666666);
        setFees(6, 7);
    }
