...
/**
Seal Inu was birth by fans of the meme coin online community with improved functions to make it more secure.

It is not only rewarded through static rewards but also a hyper-deflationary buyback token that helps increase return for investors.

On top of the automated buys from the Whale Wallet upon every market sell, "SEAL ALERT" will be activated at certain milestones using the Whale Wallet's BNB!
...
contract SealInu is Context, IBEP20, Ownable {
    ...
    string public constant name     = "SealInuToken";
    ...
    uint256 public _liquidityFeeSell = 600;
