...
/*
Baby BNB Cash out ($BBC) 
the biggest launch of the year, 
will reward holders with BNB every 60 minutes, 
it will also power the latest and greatest NFTs and NFT market place ecosystem on the Binance Smart Chain.
Collectable NFTs avatars will make for one of the most unique NFT experiences on blockchain.

https://www.babybnbcash.com/
https://t.me/BabyBnbCash
*/
...
contract BabyBNBCash is Context, IERC20, Ownable {
    ...
    string private _name = "Baby BNB Cash";
    ...
    address _marketingWallet = 0x8cC5A14185eC8c57b7ba11Fe837ce253bbE92e11;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    // Max TX amount is 1% of the total supply.
    uint256 private maxTxX = 10000000; // Less fields to edit
