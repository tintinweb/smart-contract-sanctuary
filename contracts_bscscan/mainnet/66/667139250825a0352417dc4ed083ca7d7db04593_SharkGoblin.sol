...
/**
 *SharkGoblin BSC Token - New BEP20-Token on Binance SmartChain
 * 7% Redistribution to Holders
 * 2% Liquidity pool - locked forever
 * 3% Marketing fee used for promotion only.
 * Please Please DYOR before investing into crypto!!!
 * https://t.me/SharkGoblin
*/
...
contract SharkGoblin is Context,IBEP20,Ownable {
    ...
    string private constant _name = "SharkGoblin";
    string private constant _symbol = "SHARKGOBLIN";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 100000000000 * 10**9;
