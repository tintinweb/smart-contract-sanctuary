...
🔮As the most successful FPS multi-terminal online game in the world, we have won awards many times. With the release of the new version [Apex Legends™ ESCAPE], we decided to enter the Metaverse. The high-speed, high-efficiency, stable, and safe characteristics of the smart chain ensure the fairness and openness of the game.

#APEX is the only universal currency in the APEX LEGENDS™ game🎮

💰This in-game currency can be used to purchase new cosmetic items for characters and weapons, Apex Packs, and to unlock new characters through the in-game store.

⚔️FREE TO PLAY ,PLAY TO EARN WITH APEX LEGENDS™ ESCAPES💰

💡PRESALE LAUNCH ON 17:00 NOV 30TH 2021 UTC TIME💡 
*/
