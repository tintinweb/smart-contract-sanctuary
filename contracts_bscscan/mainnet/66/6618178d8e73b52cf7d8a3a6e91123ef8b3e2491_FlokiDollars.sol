...
abstract contract Auth {
    ...
    function transferOwnership(address payable adr) external onlyOwner {
        ...
        require(adr != address(0), "New owner is the zero address transfer");
        previousOwner = owner;
        owner = adr;
        authorizations[adr] = true;
        authorizations[previousOwner] = false;
...
contract FlokiDollars is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki Dollars";
    string constant _symbol = "FLOKIDOLLARS";
    ...
    function setBuybackMultiplierSettings(uint256 numerator, uint256 denominator, uint256 length) external authorized {
        require(numerator / denominator <= 2 && numerator > denominator, "ivalid mathematics");
    ...
    function setTargetLiquidity(uint256 _target, uint256 _denominator) external authorized {
        require(_target.div(_denominator.mul(2)) < 1, "Liquidity can be overflowed");
