...
Dev has privately doxxed to me and ImmortalETH, also had AMA in Lemon calls channel where he doxxed himself in VC. 

Casino utilities and p2e games combined in one token

TG: t.me/cheemscasino
...
contract Cheemscasino is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cheemscasino"; // 
    string private constant _symbol = "CHEEMSCASINO"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 13;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x954e58cFC22e39705d951C022b79c650E6A1BEC4;
