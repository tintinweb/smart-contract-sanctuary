...
contract PitbullChain is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD56A12Dc42110840bDbeEA18b0f960330cef9De4); // Marketing Address
    address payable public charityAddress = payable(0xD56A12Dc42110840bDbeEA18b0f960330cef9De4); // Charity/Dev Address
    ...
    string private _name = "Pitbull Chain"; // nice
