...
contract BlackPantherNFT is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 5;
  uint256 public _feeLiq = 5;
  uint256 public _feeHolders = 0;
  uint256 public _devWallet = 0;
  uint256 public _maxTX = 100;
