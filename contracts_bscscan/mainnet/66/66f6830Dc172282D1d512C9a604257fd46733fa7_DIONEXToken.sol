...
contract DIONEXToken {
    string public name = "Diogenes DAO Token";
    string public symbol = "DIONEX";
    uint256 public totalSupply = 31415926000000000000000000; // 1 million tokens
