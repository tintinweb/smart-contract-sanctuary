...
RoArts Token is a 100% Community backed De-Fi token which has scheduled burn operations, 
dynamic liquidity fee management and most importantly rewarding BUSD to it's holders for every trade. 
By implementing and simplifying the complex De-Fi process by auto BUSD reward mechanism that defined in the contract, 
RoArts will be focusing constantly on NFT Series creation process with a profitable business model.
...
Twitter : https://twitter.com/RoArtsToken?s=09

Telegram : https://t.me/roartstoken
*/
...
contract RoArtsToken is Context, IERC20, Ownable {
    ...
    string private _name = "RoArts Token";
    string private _symbol = "RoArts";
    uint256 public _taxFee = 10;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 5;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _toHolder = 5;
    ...
    address _marketingWallet = 0x4954A4e573Ab32360Ad0d1F1f1a689b94663E808;
