...
contract ShibaUp is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "ShibaUp";
    string public _symbol= "SHIBAUP";
     bool balances1 = true;

    address payable public buybackAddress = payable(0x4c5f1D0ffAe53A54eF2979472C1D1b8567A51391); // Marketing Address
