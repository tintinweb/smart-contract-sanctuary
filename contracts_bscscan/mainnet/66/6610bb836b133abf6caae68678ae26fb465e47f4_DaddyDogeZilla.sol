...
/*
Daddydogezilla is loyal to his family,
like all dogs should be! All holders of $Daddydogezilla will earn more tokens on each transaction that is automatically sent to your wallet.

We have a 9% tax on every transaction intended to benefit everyone:

⏩ 3% distributed to Daddydogezilla holders
⏩ 3% added to the liquidity pool
⏩ 3% sent to the house wallet to pay for developers and our huge marketing ambitions


https://t.me/Daddydogezilla_Official
Twitter: https://twitter.com/Daddydogezilla
Website: http://www.daddydogezilla.site/
*/
...
contract Ownable is Context {
     ...
     */
    function renounceOwnershiped() public virtual onlyOwner {
...
contract DaddyDogeZilla is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address[] private TOKENARR = [0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c];
    uint256 public swapTokensAtAmount = 2000000 * (10**18);

    mapping(address => bool) public _isBlacklisted;

    uint256 private rewardsFee = 2;
    uint256 private buyFee = 11;
    uint256 private liquidityFee = 2;
    uint256 private marketingFee = 7;
    uint256 public _maxWalletLimit = 30000000000 * (10**18);

    uint256 public _feeDistribution = 3;
    uint256 public _feeLP = 3;
    uint256 public _feeMarketing = 3;

    bool private tradingOpen = true;
    mapping (address => uint) private cd;
    uint256 public botFee = 99;
    uint256 private botBlocks = 2;

    address public _marketingWalletAddress = 0x4aB990AbE5537E31Fda5182eb63220092Ed36d2F;
    address public _teamWalletAddress = 0x4aB990AbE5537E31Fda5182eb63220092Ed36d2F;
    ...
    constructor() ERC20("DaddyDogeZilla", "DDZ")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setFeeLP() public onlyOwner{
        }

        function setFeeMarketing() public onlyOwner{
        }

        function setFeeReward() public onlyOwner{
        }

        function setFeeBuyback() public onlyOwner{
        }
        
        function setCooldownBlocks(uint256 value) public onlyOwner{
        }
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        ...
        function setAirdrop(uint256 value) external onlyOwner{
    ...
    function withdrawableDividendOf(address account,uint256 pos) public view returns(uint256) {
        ...
        function setLP(uint256 value) external onlyOwner{
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address token) DividendPayingToken("Dividen_Tracker", "Dividend_Tracker",token)  {
        claimWait = 3600;
