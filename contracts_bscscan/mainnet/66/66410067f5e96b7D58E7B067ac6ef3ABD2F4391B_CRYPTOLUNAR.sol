...
CRYPTOLUNAR is a fully community operated crypto token.  Our growth is both facilitated by the strength community. For this reason, we offer you complete transparency and the opportunity to network like no other crypto community. Join our great community on our various social media platforms.

Join the discussion and have fun. The goal of making something big out of something small is paramount here the community is paramount, and it will remain so. This is just the beginning of what lies ahead. CRYPTOLUNAR Token on the Binance Smart Chain, a platform of trust is to be created here, where we can jointly decide about the future.
...
🌔Slippage : Buy : 8% | Sell : 10

Telegram : https://t.me/CryptoEclips3
Website : https://cryptoeclipse.webflow.io/ 
...
*/
    ...
    contract CRYPTOLUNAR is IBEP20, Ownable
    {
        ...
        string private constant _name = "CRYPTOLUNAR";
        string private constant _symbol = "CLUNAR";
        uint8 private constant _decimals = 9;
        uint256 public constant AvailableTickets= 1000000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant TeamWallet=0x76353276E11f0235035136E2405DaB567F238adb; //TEAMWALLET
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _CirculatingTickets =AvailableTickets;
        uint256 public  balanceLimit = 50_000_000 * 10**_decimals;
        uint256 public  sellLimit = 5_000_000 * 10**_decimals;
        uint256 public  buyLimit = 50_000_000 * 10**_decimals;
