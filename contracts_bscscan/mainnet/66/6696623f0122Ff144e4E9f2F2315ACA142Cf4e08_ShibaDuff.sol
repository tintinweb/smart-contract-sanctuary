...
'--'.     /  |  :  :_:,' |  | '.'| |   | '/ :  /  /  ,.  |          |   | '` ,/   '  :  `--'   \ |  | |   |  | |   
  `--'---'   |  | ,'     ;  :    ; |   :    | ;  :   .'   \         ;   :  .'     :  ,      .-./ |  : \   |  : \   
             `--''       |  ,   /  /    \  /  |  ,     .-./         |   ,.'        `--`----'     |  |,'   |  |,'   
                          ---`-'   `-'----'    `--`---'             '---'                        `--'     `--'     
The first reflection token and beer at the same time. Every buy gives members more with the auto-boost and hyper deflation system in place.                                                                                                                
*/
...
contract ShibaDuff is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaDuff";
    string private _symbol = "SHIBADUFF";
