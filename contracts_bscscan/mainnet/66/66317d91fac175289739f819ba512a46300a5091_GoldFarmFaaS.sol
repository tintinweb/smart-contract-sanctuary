...
contract GoldFarmFaaS is IRewardDistributionRecipient, ReentrancyGuard {
    ...
    function Initialize(address _lpToken, address _rewardToken, address _rewardToken1, uint256 _duration1, uint256 _duration2, uint256 _lpTokenFrictionlessFee) external nonReentrant {
