...
// File contracts/BabyShiryoInu.sol
pragma solidity ^0.8.0;

contract BabyShiryoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyShiryoInu";
    string private constant _symbol = "BShiryoINU";
