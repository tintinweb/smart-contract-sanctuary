...
/**
  DOGEREWARD
   ...
   REWARD SYSTEM
   Every transaction of Shibrewards, there is a 5% distribution reward to the holders.
   This will give all the holders a passive source of income on their token.
