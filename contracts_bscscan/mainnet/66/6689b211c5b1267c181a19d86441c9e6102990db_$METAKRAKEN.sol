...
META KRAKEN created on Binance Smart Chain (BEP20), Meta Kraken is meme token being more positive vibes and kick out more scamers on 2022, we make safe token avoid more scammer on BEP-20.

Check out contract before you buy. Currently in development is our metrology-grade METAKRAKEN 3D scanner, allowing you to bring YOUR real world into the METAVERSE.

WEBSITE : https://metakrakentoken.com
CHANNEL : https://t.me/metakrakenchannel
GROUP : https://t.me/metakrakengroup
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3107C6E4EBF35D4583E7E173CFa8298e81145Ded;
...
contract $METAKRAKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3107C6E4EBF35D4583E7E173CFa8298e81145Ded;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "META KRAKEN";
    string private _symbol = "$METAKRAKEN";
