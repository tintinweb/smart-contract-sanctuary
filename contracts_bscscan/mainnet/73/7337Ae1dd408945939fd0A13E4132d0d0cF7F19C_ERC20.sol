...
contract HAXHIBUBACOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HAXHIBUBACOINDividendTracker public dividendTracker;
    ...
    address payable public marketingWallet = 0xD68e1F68fBfB80089D0764dA28e1B9c8f0E72dF0;
    ...
    constructor() ERC20("HAXHIBUBACOIN", "HAXHIBUBACOIN") {
        
        totalFees = BNBRewardsFee.add(liquidityFee);


    	dividendTracker = new HAXHIBUBACOINDividendTracker();
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "HAXHIBUBACOIN: The router already has that address");
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "HAXHIBUBACOIN: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "HAXHIBUBACOIN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "HAXHIBUBACOIN: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 1000000, "HAXHIBUBACOIN: gasForProcessing must be between 200,000 and 1,000,000");
        require(newValue != gasForProcessing, "HAXHIBUBACOIN: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "HAXHIBUBACOIN: This account cannot send tokens until trading is enabled");
        }
...
contract HAXHIBUBACOINDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("HAXHIBUBACOIN_Dividend_Tracker", "HAXHIBUBACOIN_Dividend_Tracker") {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "HAXHIBUBACOIN_Dividend_Tracker: No transfers allowed");
    }
    ...
    function withdrawDividend() public override {
        require(false, "HAXHIBUBACOIN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HAXHIBUBACOIN contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 900 && newClaimWait <= 86400, "HAXHIBUBACOIN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "HAXHIBUBACOIN_Dividend_Tracker: Cannot update claimWait to same value");
