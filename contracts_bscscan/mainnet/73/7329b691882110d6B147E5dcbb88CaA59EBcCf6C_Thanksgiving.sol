...
contract Ownable is Context {
    address private _owner = 0x306EC37d8c551FA6Fab2702D91bc65270537aeAC;
...
contract Thanksgiving is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Happy Thanksgiving to all"; // token name
    string private _symbol = "Thanksgiving"; // token symbol
