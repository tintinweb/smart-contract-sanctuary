...
My Spirit Shiba
Reflection Token On Shiba 
My Spirit Animal: Happy Shiba Inu Journal
For admirers of the lively, loyal and happy Shiba Inu comes 
a light-hearted journal which will reveal your true spirit animal to the world.

-Tokens Lock in dxsale // Shiba  charity To Golding Notebooks (Author)
-LP LOCK 10 Years in dxsale
-Fees 17% 
-Slippage 12 
-Renounce OwnerShip At 100 Holders

purpose is to create a platform devoted to teaching people mindfulness. 
By teaching people to take care of their minds, we can improve their mental
health and create a better world for everyone.
...
contract ShibaShiba  is BSCNFT  {
    ...
    string public override name = "Shiba Shiba";
    string public override symbol = "ShiShiba";
