...
/*
 :::  === :::===  :::====  :::===== USDC Rewards Coin
 :::  === :::     :::  === :::      Highest USDC Rewards in BSC each minute
 ===  ===  =====  ===  === ===      Liquidity Locked by 6 months
 ===  ===     === ===  === ===      TELEGRAM: https://t.me/USDCRewards
  ======  ======  =======   ======= TWITTER: https://twitter.com/USDCREW
...
contract USDCRewards is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "USDCRewards";
    string constant _symbol = "USDCRewards";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 120000 * (10 ** _decimals);
