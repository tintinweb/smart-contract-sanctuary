...
Telegram: https://t.me/foreverfloki

JOIN THE TELEGRAM AND HELP TAKE THIS TO THE MOON. 

TOKENOMICS
8% ADAC REWARDS plus MARKETING & DEVELOPMENT and AUTO-LIQUIDITY -
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADAC = IBEP20(0xb6a6DcccBa92905C34801E1458B0606e07Bb3dD4);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ADAC.balanceOf(address(this));
        ...
        uint256 amount = ADAC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ADAC.transfer(shareholder, amount);
...
contract foreverfloki is IBEP20, Auth {
    using SafeMath for uint256;

    address ADAC = 0xb6a6DcccBa92905C34801E1458B0606e07Bb3dD4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Forever Floki";
    string constant _symbol = "Foreverfloki";
