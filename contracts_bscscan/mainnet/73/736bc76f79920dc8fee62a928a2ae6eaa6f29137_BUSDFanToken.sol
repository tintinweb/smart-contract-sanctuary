...
/* Token contract */
contract BUSDFanToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xC64515eA499905ddEB87f691554fC44A1aBAdbF4;
    ...
    // Name and symbol
    string constant _name = "BUSDFanToken";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 10000; // 3%
  ...
  // Sell fees
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC64515eA499905ddEB87f691554fC44A1aBAdbF4;
