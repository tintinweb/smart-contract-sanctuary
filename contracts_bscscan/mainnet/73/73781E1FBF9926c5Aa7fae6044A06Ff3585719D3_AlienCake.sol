...
Hold and get rewarded in Uniswap tokens 10% Reflection fee
...
🌐TELEGRAM https://t.me/aliencakebsc
🌀Website https://aliencake.xyz/
 *
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 UNISWAP = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = UNISWAP.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(UNISWAP);
        ...
        uint256 amount = UNISWAP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            UNISWAP.transfer(shareholder, amount);
...
contract AlienCake is IBEP20, Auth {
    using SafeMath for uint256;

    address UNISWAP = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "AlienCake";
    string constant _symbol = "$ACAKE";
