...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x634304266339C9CCD8E5CeD0dfD06a48Ea6F00A3;
...
contract MetaHamster is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x705F10a2A472E91894DcBa039C3Eca6D758bA716;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MetaHamster";
    string private _symbol = "MHS";
