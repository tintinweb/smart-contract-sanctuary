...
contract BabyPIXIU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyPIXIU";
    string private _symbol = "BabyPIXIU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC0db2AFF52748160498EF370426dd6A0A8D38c96); 
    address payable public buyBackWalletAddress = payable(0x48f7f0B4E02F9b2F6F2CE4f0602dcbCBD7d8D2b5); 
    ...
    uint256 private _totalSupply            = 1 * 10**8 * 10**8 * 10**9;
    uint256 public _maxTxAmount             = 3 * 10**8 * 10**6 * 10**9;
    uint256 public _walletMax               = 5 * 10**8 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 25 * 10**8 * 10**9; 
