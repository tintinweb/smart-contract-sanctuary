...
/**
 *   Socials:                                                `._.'                  
 *   https://www.facebook.com/groups/apedex/
 *   https://www.facebook.com/apedexadx/
 *   https://t.me/apedexofficial
 *   https://twitter.com/ApeDex_ADX
 *   www.apedex.net
 * 
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 nativeToken = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
contract Apedex is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Apedex";
    string constant _symbol = "ADX";
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _sellFee, uint256 _feeDenominator) external authorized {
    ...
    function rescue(address adr) external authorized {
