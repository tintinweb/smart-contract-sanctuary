...
contract ABAX is ERC20, Ownable {
    ...
    uint16 public liquidityFee = 13; // 13% fee
    
    uint16 private totalFee = liquidityFee;
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ERC20: Account is already excluded");
