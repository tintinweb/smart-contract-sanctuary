...
/**
   Telegram : https://t.me/Lambocheems
...
contract Lambocheems is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x391B3cCAf2F6d1D193d12173907C9Ed5a84C8AD7); // Marketing Address
    ...
    string private _name = "Lambo cheems";
    string private _symbol = "LAMBOCH";
...
uint256 public _taxFee = 2;
    ...
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = 100000 * 10**6 * 10**9; 
    uint256 private buyBackUpperLimit = 100 * 10**18;
