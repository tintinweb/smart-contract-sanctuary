...
contract DefidoTiger is Context, IBEP20, Ownable {
    using SafeMath for uint256;
	uint8 private _decimals = 18;
	uint256 private _totalSupply = 128000000 * 10 ** _decimals;
	mapping (address => uint256) private anlog;
	string private constant _name = "DefidoTiger";

	string private constant _symbol = "DefidoT";
