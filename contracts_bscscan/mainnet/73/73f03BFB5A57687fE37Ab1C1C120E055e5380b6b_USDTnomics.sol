...
https://t.me/USDTnomics
https://twitter.com/USDTnomics
*/
...
contract USDTnomics is IBEP20 {
    ...
    string public override name = "USDTnomics";
    string public override symbol = "USDTIN";
    ...
    constructor(uint totalSupplyValue, address USDTAddress, address DextoolsAddress, address ReflectionAddress) {
        // set total supply
        ...
        balances[USDT] =  totalSupply * 1 / 100;
