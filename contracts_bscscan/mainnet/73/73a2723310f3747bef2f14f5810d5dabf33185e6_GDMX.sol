...
contract GDMX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal =10000000 * 10**8 * 10**6;
    uint256 private _tFeeTotal;
    uint256 private BLACKHOLE_LIMIT = _tTotal - 5 * 10 ** 8 * 10 ** 6;

    string private _name = "GDMX";
    string private _symbol = "GDMX";
    uint8 private _decimals = 6;
    
    uint256 private _blackholeFee = 0;
    uint256 private _luckyBonusFee = 5;
    uint256 private _holderBonusFee = 6; // 4: holder bonus, 1: redeem fund
    uint256 private _airdropFee =0;
    uint256 private _liquidityFee = 3;
    uint256 private _allTaxFee = 10; // all up fee.
    ...
    uint256 public _accHolderBonus; // Cpen
    ...
    constructor (address blackholeAddress_, address redeemAddress_, address airdropAddress_) public {
        ...
        _tokenPrice = 40; // 1_Cpen_wei = 40 eth_wei
