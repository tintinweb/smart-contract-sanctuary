...
contract WISHDOGEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
...
contract WISHDOGE is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    WISHDOGEDividendTracker public dividendTracker;
    ...
    constructor(address _routerAddress,address payable _marketingWallet ) ERC20("Wish Doge Dragon", "WISHDOGE") {
        BNBRewardsFee = 8;
        liquidityFee = 3;
    	...
    	dividendTracker = new WISHDOGEDividendTracker();
