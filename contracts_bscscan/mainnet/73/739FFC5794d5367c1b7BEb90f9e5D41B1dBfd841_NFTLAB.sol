...
contract NFTLAB is Ownable {
        ...
        internal
    {
        ...
        require(tokenBalance > item.price, "low balance on  buyer account");
        require(tokenBalance > auctionInfo.lastBid, "low balance on buyer account");
        require(_bidPrice > item.price, "new bid should be greater than minimal item price");
        require(_bidPrice > auctionInfo.lastBid, "new bid should be greater than last");
