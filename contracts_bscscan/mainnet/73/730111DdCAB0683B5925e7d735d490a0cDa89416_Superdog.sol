...
/*Superdog test use only Do not use for other functions

// SPDX-License-Identifier: MIT 

/*The contract is only for testing
...
contract Superdog is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 510000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Superdog Deflation token';
