...
contract KomoInu is IBEP20, Auth {
    ...
    string constant _name = "KomoInu";
    string constant _symbol = "$KOMOINU";
    ...
    address private teamFeeReceiver =0x4Fc999Ebe771C56661998764862f4e27016D3e0F;
