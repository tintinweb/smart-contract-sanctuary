...
contract ThoreumITOv2 is IThoreumITOv2, ReentrancyGuard, Ownable {
    ...
    event AdminWithdraw(address tokenAddress, uint256 amountTokens);
    ...
    function finalWithdraw(address _token, uint256 _amount) external onlyOwner {
        require(_token != address(offeringToken), "Cannot be offering token");
        ...
        emit AdminWithdraw(_token, amount);
    }
