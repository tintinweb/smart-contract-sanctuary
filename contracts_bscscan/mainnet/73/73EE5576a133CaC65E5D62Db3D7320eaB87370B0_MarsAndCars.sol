...
/**
    TG: https://t.me/Marsandcarsofficially
*/
...
contract MarsAndCars is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = _tTotal.mul(5).div(100);
    uint256 public swapTokensAtAmount = _tTotal.mul(5).div(1000);
    uint256 public _maxWalletSize = _tTotal.mul(15).div(100);
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x514717E60855038b9fB21dDD060F463c8087Ddb2;
    address public operationsAddress = 0x514717E60855038b9fB21dDD060F463c8087Ddb2;
