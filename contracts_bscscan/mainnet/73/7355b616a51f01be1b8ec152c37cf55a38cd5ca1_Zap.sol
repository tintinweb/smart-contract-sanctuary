...
contract Zap{
    ...
    //10000000000000000
    function ZapInPancake(address _token1, address _token2) payable public {
    ...
    function ZapInMars(address _token1, address _token2) payable public {
    ...
    function ZapInApe(address _token1, address _token2) payable public {
    ...
    function ZapInTokenPancake(address _tokenin, uint _amount, address _token1, address _token2) public {
    ...
    function ZapInTokenMars(address _tokenin, uint _amount, address _token1, address _token2) public {
    ...
    function ZapInTokenApe(address _tokenin, uint _amount,address _token1, address _token2) public {
    ...
    function convertApe(uint _amount, address _tokenin, address _tokenout) public {
        ...
        IERC20(_tokenin).safeApprove(aperouter, 0);
        IERC20(_tokenin).safeApprove(aperouter, uint256(-1));
    ...
    function convertPancake(uint _amount, address _tokenin, address _tokenout) public {
        ...
        IERC20(_tokenin).safeApprove(pancakerouter, uint256(-1));
        address[] memory path = new address[](2);
                    path[0] = _tokenin;
                    path[1] = _tokenout;
    ...
    function convertMars(uint _amount, address _tokenin, address _tokenout) public {
        // require(!Address.isContract(msg.sender),"!contract");
        IERC20(_tokenin).safeApprove(marsRouter, 0);
        IERC20(_tokenin).safeApprove(marsRouter, uint256(-1));
        address[] memory path = new address[](2);
                    path[0] = _tokenin;
                    path[1] = _tokenout;
