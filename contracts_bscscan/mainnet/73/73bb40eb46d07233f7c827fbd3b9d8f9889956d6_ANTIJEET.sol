...
contract ANTIJEET is Context, IBEP20, Ownable, TransactionThrottler {
    ...
    string private _name = "ANTIJEET";
    string private _symbol = "ANTIJEET";
    ...
    uint256 private marketingAddFee = 8;
    uint256 private marketingAddFeeDivisor = 100;

    uint256 private minimumTokensBeforeSwap = 1000 * 10**18;

    address payable public marketingAddress = payable(0x91Dee23dc1957537F2AFCdb9c91f0bbb4bFfd938);
