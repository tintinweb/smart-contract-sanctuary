...
contract fantomrise is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 40 * 10**5 * 10**4; // 100B 
    ...
    uint256 public _maxTxAmount = 40 * 10**5 * 10**4; // 100B 
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 40 * 10**5 * 10**4; // 100B

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "fantomriseBSC";
