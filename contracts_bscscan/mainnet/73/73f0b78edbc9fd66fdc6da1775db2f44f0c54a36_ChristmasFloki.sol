...
/**
    ...
    4% Liquidity  4% Marketing  2% Buy-Back
...
contract ChristmasFloki is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb3bd99080AF8d6FC43352b0CD35e61a1E34d4271); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb3bd99080AF8d6FC43352b0CD35e61a1E34d4271); // BuyBack Address
    ...
    uint256 private _totalSupply = 1000000000 * 10**3 * 10**9;
    uint256 public _maxTxAmount = 10000000 * 10**3 * 10**9;
    uint256 public _walletMax = 20000000 * 10**3 * 10**9;
