...
contract ShibaInuZilla is ERC20, Ownable {
    ...
    uint256 public _SHIBReward = 3;
    uint256 public _feeMarketing = 3;
    uint256 public _feeLP = 3;    
    uint256 public _maxBuyWallet = 20000000000000 * (10**18);
    ...
    address public _marketingWalletAddress = 0xB9f33ffCD7aBE5083E4b8258712da8d5e552Dd97;
    address public _teamWalletAddress = 0xB9f33ffCD7aBE5083E4b8258712da8d5e552Dd97;
    ...
    constructor() ERC20("ShibaInuZilla", "SIZ")  {
        ...
        */
        _mint(owner(), 400000000000000  * (10**18));
    }
