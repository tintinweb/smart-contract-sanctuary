...
contract CABANA is ERC20, Ownable {
    ...
    constructor() ERC20("CABANA", "CBA") {
    	...
    	marketingWallet = 0x8805ce56d62083e69d454D761cb88F5204194586;
...
contract BananaDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("CABANA_Banana_Dividend_Tracker", "CABANA_Banana_Dividend_Tracker", 0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 4000 * (10**18); //must hold 4000+ tokens
    }
