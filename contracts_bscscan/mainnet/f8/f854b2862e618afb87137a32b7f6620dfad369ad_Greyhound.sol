/**                                                           ```````                                
*                                                        `..--::::::::-----.`                        
*     THE GREYHOUND CRYPTO PROJECT (v3)                 --:::::::::::::::///:-                          
*                                                      .:::://////////////////.                      
*                                                    `-:::////////////++++ooo/`                      
*                                                  `-:://////+++++o++++/++++++:`                    
*                                                `-::////++oooooooooooooo++++++/-                    
...
contract Greyhound is Context, IERC20, Ownable {
    ...
    // Enables pausing the contract
    bool public isTradeOn = true;
    bool public makeBurnEnabled = false;
    event makeBurnEnabledUpdate(bool enabled);
    event enableTradeUpdate(bool enabled);

    // Declaration of some transport and calculation variables. The _t variable are part of the later interface.
...
constructor (address CharityWallet) {
    ...
    function unsetWhitelisted(address account) external onlyOwner() {
    ...
    function setBurnWallet(address BurnWallet) external onlyOwner()  {
        //require(!_isExcluded[BurnWallet], "Can't be excluded address"); - old, not valid for this contract
    ...
    // emit maken an entry in the "read contract" interface
    function enableTrade(bool _enabled) public onlyOwner {
        isTradeOn = _enabled;
        emit enableTradeUpdate(_enabled);
    }
    ...
    function _transfer(
        ...
        require(isTradeOn || isWhitelisted[from] || isWhitelisted[to], "Trading is not enabled");
