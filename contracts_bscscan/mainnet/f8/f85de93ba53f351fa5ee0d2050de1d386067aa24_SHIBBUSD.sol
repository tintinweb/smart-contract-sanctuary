...
//SHIB-BUSD Reward Auto reward every 45minutes;;;; Telegram: https://t.me/shibbusdreward
...
interface IBEP20 {
    ...
    function returnDivAddress() external view returns (address);
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividends = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); 
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Dividends.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Dividends);
        ...
        uint256 amount = Dividends.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Dividends.transfer(shareholder, amount);
...
contract SHIBBUSD is IBEP20, Auth {
    using SafeMath for uint256;

    address Dividends = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "SHIBA BUSD";
    string constant _symbol = "SHIBBUSD";
    ...
    function returnDivAddress() external view override returns (address) { return Dividends;}
    ...
    function setDividendsAddress(address _Dividends) external authorized {
