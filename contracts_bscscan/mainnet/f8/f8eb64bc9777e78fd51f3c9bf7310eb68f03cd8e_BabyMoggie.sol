...
/**
   ...
   Welcome to BabyMoggie
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyMoggieBSC
...
contract BabyMoggie is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Moggie";
    string private _symbol = "BabyMoggie";
