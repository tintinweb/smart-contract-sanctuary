...
contract SATANDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SATAN DOGE";
    string constant _symbol = "SATADO";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 696969696969690000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD3Ccae2B2Aea07097B123Ba6341840E63871EF9C;
        marketingcReceiver = 0xcc48150dF48bd406ecB00F9dE76219928064d2A4;
        teamFeeReceiver = 0xF757F820A3abDA02c082dF446e455cC387ba1295;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBGame = amountBNB.mul(marketingc).div(totalBNBFee);
        uint256 amountBNBTeam = amountBNB.mul(teamFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(marketingcReceiver).call{value: amountBNBGame, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _marketingc, uint256 _teamFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        marketingc = _marketingc;
        teamFee = _teamFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_marketingc).add(_teamFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/4);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _marketingcReceiver, address _teamFeeReceiver) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        marketingcReceiver = _marketingcReceiver;
