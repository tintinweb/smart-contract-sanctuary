...
contract SANTAGIRL is IBEP20, Auth {
    ...
    constructor (
        ...
        autoLiquidityReceiver = 0x64453E8D9E4aC579c67723CdA50101a822422694;//msg.sender;
        marketingFeeReceiver = 0x644F2469d7095BbfFf24153DdD20B33e26f55f64; //msg.sender;
        lotteryFeeReceiver = 0xc1ba2F5DC99f9baCD49eD42401B3f8Be6be20051;//msg.sender;
        devFeeReceiver = 0x3432fDB139625C2701EA3f855e9aC44EAcb0eD95;//msg.sender;
   ...
   function setMultiplierSettings(uint256 PaperHandNum, uint256 DiamondHandNum, uint256 denominator, uint256 length) external authorized{
    ...
    function setFees(uint256 _lotteryFee, uint256 _devFee, uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator, uint256 _totalSellFee, uint256 _totalBuyFee) external authorized {
