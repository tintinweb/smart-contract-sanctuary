...
//1% Auto Burn
// DEPLOYER - LGS
// TELEGRAM https://t.me/legacyofthefuture
// WEBSITE  https://www.legacytothefuture.com/
// TWİTTER  https://twitter.com/Legacy_Token_
...
contract Legacy is Context, IERC20, Ownable {
    ...
    string private _name = "Legacy Token";
    string private _symbol = "LegacyToken";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x743E970cc5c5c91d9Fc60C0cC648AB6f5Cf7BD02);
