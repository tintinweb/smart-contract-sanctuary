...
contract rechargeToken is Ownable{
    ...
    IBEP20 public waynewallet;

    uint256 public tokenPercentage = 10;
    address public receiverAddress = 0x790c705B8b3143152A8c6CF77eCb6AFd839c3404;

    event waynewalletDeposti(address indexed user, uint256 indexed depositAmount);
    ...
    constructor(IBEP20 _waynewallet){
        waynewallet = _waynewallet;
    }
    
    function setRewardAddress(address _receiverAddress)external onlyOwner {
        require(_receiverAddress != address(0x0),"Recharge :: zero address dected");
    ...
    function exchange(uint256 _amount)external {
        ...
        waynewallet.transferFrom(msg.sender, receiverAddress, _amount);
        emit waynewalletDeposti(msg.sender, _amount);
    }
