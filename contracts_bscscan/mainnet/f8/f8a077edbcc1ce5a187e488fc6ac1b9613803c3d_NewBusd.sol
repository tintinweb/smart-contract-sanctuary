...
contract NewBusd is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'NewBusd';
    string private constant _symbol = '$NBusd';
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 111 * 10**_decimals;//equals 111
    ...
    //Divider for the Minimal MaxBalance based on circulating Supply (10%)
    uint8 public constant BalanceLimitDivider=10;
    //Divider for Minimal sellLimit based on circulating Supply (5%)
