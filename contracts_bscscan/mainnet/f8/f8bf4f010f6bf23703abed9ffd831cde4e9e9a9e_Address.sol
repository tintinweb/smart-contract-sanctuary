...
// File contracts/token1363.sol





contract VEBE is ERC1363, Ownable {
    uint256 public _releaseTime = 1640991601;
    address public rewards = 0x28F782f8180b11dBe1F799Dd41e9eAdFF7597696;
    address public private_sale = 0x525786F5960BFDdBF19217A95710FDfb0C16aCE9;
    address public public_sale = 0x4B0294e2744B2B16529c82208Bcb07B6803E6aF6;
    address public marketing = 0x7E2d2fBf77A57e1c330D5A96A07E80a1Bdf92926;
    address public eco = 0x01D9A89d3e290435b525619E8d0D83fC88A4DdE2;
    address public liquidity = 0x5Be8C5C0bB426E74705B80d94Be8154Cc4200648;
    address public legal = 0x32D638f97B1803C58fe30874aB0cc123F4f260EE;
    address public charity = 0xeb7a332E39c133192a1963A8A8d43f813846A895;

    uint256 max = 10000000000 * 10**18;

    constructor ( ) ERC20("VEBE", "VEBE") {
        _mint(private_sale, max * 3 /100);
        _mint(public_sale, max * 17 /100);
        _mint(liquidity, max * 7 /100);
        _mint(address(this), max * 73 /100);
    ...
    function release() public onlyOwner {
        ...
        _transfer(address(this), rewards, max * 50 /100);
        _transfer(address(this), marketing, max * 15 /100);
        _transfer(address(this), eco, max * 5 /100);
        _transfer(address(this), legal, max * 2 /100);
        _transfer(address(this), charity, max * 1 /100);
