...
Final Round of DOGElympicsFINAL , get those medals and 15% REWARDS
...
contract DOGElympicsFINAL is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 15;
  uint256 private _maxTrxLimit = 20 * 10**3 * 10**12;
  address private _deployer;
