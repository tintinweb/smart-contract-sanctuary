...
/**
   ...
   Welcome to Neko Kiiro
   
   Tg : @nekokiiro
   Website : nekokiiro.com
...
contract NekoKiiro is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7f02B42949dFB8Cd03e5586c4d225B5782e29F7F); // Marketing Address
    ...
    string private _name = "Neko Kiiro";
    string private _symbol = "NKIIRO";
