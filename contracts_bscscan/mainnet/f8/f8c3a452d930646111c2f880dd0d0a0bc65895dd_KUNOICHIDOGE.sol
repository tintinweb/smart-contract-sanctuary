...
/**
 * https://t.me/kunoichidoge
 * https://kunoichidoge.com/
 * Max buy 1%
 * Max sell 1%
 * Max wallet 3%
 */ 
...
contract KUNOICHIDOGE is IBEP20, Auth {
    ...
    string constant _name = "KUNOICHIDOGE";
    string constant _symbol = "KD";
    ...
    function KUNOICHIDOGELaunchStatus(uint256 amount) external authorized {
        _maxTxAmount = amount;
	...
	function KUNOICHIDOGESniperBan(address user, bool banned) external authorized {
		if (banned) {
