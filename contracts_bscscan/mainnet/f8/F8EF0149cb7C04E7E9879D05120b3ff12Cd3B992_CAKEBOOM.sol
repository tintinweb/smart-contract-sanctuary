...
CAKEBOOM ~ FEEL THE EXPLOSION AND EARN YOUR $CAKE BY HODLING 
https://t.me/Cakeboombsc
...
contract CAKEBOOM is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CAKEBOOM";
    string constant _symbol = "CKB";
    ...
    constructor (uint256 _bytes) {
        ...
        marketingFeeReceiver = address(0x9227e5Dc2DA7463620bBAc68CA676658346Afa55);
