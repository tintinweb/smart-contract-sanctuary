...
contract DogeBitch is IERC20, Ownable {
  ...
  function _transfer(
    ...
    if (!inSwapAndLiquify && from != uniswapV2Pair && from != address(uniswapV2Router) && !_isExcludedFromFee[from]) {
