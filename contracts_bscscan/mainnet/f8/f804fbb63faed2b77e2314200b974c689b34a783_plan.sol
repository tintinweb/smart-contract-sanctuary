...
contract plan is ReentrancyGuard, Ownable {
    ...
    constructor (address _BTC, address _ETH, address _USDT, address _DOGE, address _ADA, address _BGC , address payable _feeReceive) public Ownable() {
        ...
        minCollateralBNB = 1e15;
        minCollateralUSDT = 5e17;
        minCollateralDOGE = 2e8;
        minCollateralADA = 1e17;
        collateralFee = 5e16;
        settlementFee = 2e16;
        orderNumber = 0;
        basicIncomeTime = 10 minutes;
        basicIncome = 1e15;
        BTC = _BTC;
        ETH = _ETH;
        USDT = _USDT;
