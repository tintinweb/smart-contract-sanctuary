...
contract MebloxFund is Ownable {
    ...
    function tokensToExactTokens(uint256 _amountOut, uint256 _amountInMax, uint256 _deadline) public payable {
        require(operatorPermissions[msg.sender], "You are not Operator");
        IERC20 exactTokens = IERC20(lpTokenAddress);
    ...
    function exactTokensToTokens(uint256 _amountIn, uint256 _amountOutMin, uint256 _deadline) public payable {
        require(operatorPermissions[msg.sender], "You are not Operator");
        IERC20 exactTokens = IERC20(lpExactTokenAddress);
