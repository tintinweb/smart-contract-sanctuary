...
contract SUM41 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2935b4203a46b9A684c6B654df3C65e3Dd4C8588;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SUM41";
    string private _symbol = "SUM41";
