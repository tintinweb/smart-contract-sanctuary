...
contract Ownable is Context {
    address private _owner = 0xF0722C042285EeBC8530d75aa59f4e6b7d59d596;
...
contract dimensional is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xeCdf31F6B589abf527B752f2aa4d36bbF275d494); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "2-dimensional"; // token name
    string private _symbol = "2-dimensional"; // token symbol
