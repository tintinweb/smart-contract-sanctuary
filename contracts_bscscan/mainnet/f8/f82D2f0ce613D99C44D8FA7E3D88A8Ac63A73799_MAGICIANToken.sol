...
contract MAGICIANToken is Context, IERC20, Operator {
    ...
    uint256 private _tTotal = 1 * 10**12 * 10**18;        //1万亿
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    IWrap public wrap;

    string private _name = "NFTMagician";
    string private _symbol = "MAGICIAN";
    ...
    uint256 public _maxTxAmount = 1 * 10**12 * 10**18;//1万亿
    ...
    constructor () public {
        _rOwned[0x8226d31c6BDf72A38cB6543F5eC5253e94FaccfE] = _rTotal;
        ...
        _isExcludedFromFee[0x8226d31c6BDf72A38cB6543F5eC5253e94FaccfE] = true;
        _isExcludedFromFee[0xEE87698ba9d86661CBA56F2E6014f5B4f609A887] = true;
        _isExcludedFromFee[0x397ce208a851451980248b139575E4Db82d28b2d] = true;
        _isExcludedFromFee[0xbd1ba5560F6C15B6296886CBef5a62CE021BAD02] = true;
        _isExcludedFromFee[0xB52F30E2eA9a07A608A5f719720500Cc36B55Ea8] = true;
    ...
    function batchTransfer(address[] memory addressList, uint256[] memory amountList) public onlyOwner returns (bool) {
        ...
        for (uint256 i = 0; i < length; i++) {
            _transfer(_msgSender(), addressList[i], amountList[i]);
            emit Transfer(_msgSender(), addressList[i], amountList[i]);
        }
        return true;
    }
    function withdrawOtherToken(address _token, address payable to) public onlyOperator {
