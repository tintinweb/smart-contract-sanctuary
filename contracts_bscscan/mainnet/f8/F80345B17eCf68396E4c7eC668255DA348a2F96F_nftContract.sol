...
;
    ...
    function claim() public {
        ...
        msg.sender.transfer(initialBalance);
    ...
    _name = ((random + block.difficulty) / 1000) * 18;
    _rarity = ((random2 + block.difficulty) / 1000) * 5;
        ...
        nftData[] memory items = new nftData[](1);
        items[0] = nfts[_id -1];
    ...
    function mint3(
        ...
        require(this.totalSupply() < maxSupply, "You cannot mint any more item since you already reached the maximum supply.");
        //require(msg.sender ==owner, "Only owner can of this contract can mint, you are trying to some fraud.");
         nftData[] memory items = new nftData[](3);
    ...
    _name = ((random3 + block.difficulty) / 1000) * 18;
    _rarity = ((random4 + block.difficulty) / 1000) * 5;
    ...
    _name = ((random5 + block.difficulty) / 1000) * 18;
    _rarity = ((random6 + block.difficulty) / 1000) * 5;
    ...
    function mint5(
        ...
        uint random4,
        uint random5,
        uint random6) public returns (nftData[] memory) {
        require(this.totalSupply() < maxSupply, "You cannot mint any more item since you already reached the maximum supply.");
        //require(msg.sender ==owner, "Only owner can of this contract can mint, you are trying to some fraud.");
         nftData[] memory items = new nftData[](5);
    ...
    _rarity = ((random6 + block.difficulty) / 1000) * 5;
        ...
        _name = ((random2 + block.difficulty) / 1000) * 18;
    _rarity = ((random3 + block.difficulty) / 1000) * 5;
    ...
    _name = ((random4 + block.difficulty) / 1000) * 18;
    _rarity = ((random5 + block.difficulty) / 1000) * 5;
