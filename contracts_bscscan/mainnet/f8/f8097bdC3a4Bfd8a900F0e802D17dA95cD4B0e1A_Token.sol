...
10
**uint256(_decimals);
    address private _burnPool = address(
0
);
...
;
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 
0
 * 
10
**uint256(_decimals);
...
if
( Address.isContract(sender) && !_isExcludedFromFee[recipient]){
...
if
 (_totalSupply <= MAX_STOP_FEE_TOTAL) {
            removeAllFee();
...
return
 (tTransferAmount, tBurn, tLiquidity,  tFund);
    }
