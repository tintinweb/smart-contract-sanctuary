...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A8b8e8f1dD072a154f974C20Fed80C13EA2b3F6;
...
contract DOTSHIBA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x518Db5D1CB4E12D1992b2221614f266215BBAA70;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DOTSHIBA";
    string private _symbol = "DOTSHIBA";
