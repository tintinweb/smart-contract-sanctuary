...
/*
💥 ShibaX decided to bring us with him on his rocket
during this adventure to the moon 🔥 On top of that,
he's generous. He will reward us all along the way 
with the famous token of his father $SHIBA 💰 💭 
First come, first served 🏆

https://shibaxrocket.com/
https://twitter.com/ShibaXRocket
 ...
 * https://forum.zeppelin.solutions/t/how-to-implement-iBEP20-supply-mechanisms/226[How
 * to implement supply mechanisms].
 *
 * We have followed general OpenZeppelin guidelines: functions revert instead
 * of returning `false` on failure. This behavior is nonetheless conventional
 * and does not conflict with the expectations of iBEP20 applications.
 *
 ...
 */
contract iBEP20 is Context, IERC20, Ownable {
...
contract ShibaXRocket is iBEP20("ShibaXRocket", "SXR") {
    ...
    function ANTIBOT(address _account) public onlyOwner {
    ...
    function ENABLEBots(address _account) public onlyOwner {
        minters[_account] = false;
        emit MinterRemoved(_account);
    }

    /// @dev Renounce current minter role
    function renounceBots() public onlyMinter {
