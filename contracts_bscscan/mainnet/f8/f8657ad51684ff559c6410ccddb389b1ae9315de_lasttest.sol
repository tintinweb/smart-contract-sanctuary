...
contract lasttest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LastTest", "test") {
        cakeDividendTracker = new CakeDividendTracker();
        thunderCakeDividendTracker = new ThunderCakeDividendTracker();

        marketingWallet = 0x0a2A90956AE74cB07fb512610e81c06b0ecEda02;
        teamWallet = 0x37E604c4e5817EFaAFE57e7862f8d39234D963B9;
