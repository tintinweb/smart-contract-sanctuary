...
contract sProjectX is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked ProjectX", "sPROJECTX", 9) ERC20Permit() {
    ...
    /**
        @notice increases sAPOLLO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sAPOLLO
