...
contract RetroNeko is RNKDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private RNKTeam;
    address private CharityRNK;
    ...
    string public override name = "RetroNeko";
    string public override symbol = "RNK";
    ...
    constructor(uint totalSupplyValue, address RNKTeamAddress, address CharityRNKAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        RNKTeam = RNKTeamAddress;
        CharityRNK = CharityRNKAddress;
        
        // split the tokens according to agreed upon percentages
        balances[RNKTeam] =  totalSupply * 45 / 100;
        balances[CharityRNK] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's RNKTeam pot
