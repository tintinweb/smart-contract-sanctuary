...
//🐶 ANIME + FLOKI KILLER 🐶
//The Official ANIME + FLOKI Killer,  TokyoRevenger Floki is here !!!

//Social Media:

//🌏 Telegram: https://t.me/tokyorevengerfloki
...
contract TRF is IBEP20, Auth {
    ...
    string constant _name = "TokyoRevenger Floki";
    string constant _symbol = "TRF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 66; // 1.5%
    ...
    uint256 public swapThreshold = _totalSupply / 20000000; // 2%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x9eaEb524236FB84479724EF71A4A64b11bD6b15B;
