...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402);
...
contract Time1 is IBEP20, Auth {
    ...
    string constant _name = "Time1";
    string constant _symbol = "TIME1";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x3fB836716EC0Db5b648Ec8556F307669b11053Df;
    ...
    function setMaxAmount(uint256 maxWalletToken) external onlyOwner() {
        _maxWalletToken = rSupply.div(100).mul(maxWalletToken);
    }

    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        _maxTxAmount = rSupply.div(100).mul(maxTxAmount);
    }
