...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x4F1A6FC6A7B65Dc7ebC4EB692Dc3641bE997c2F2);
...
contract FFToken is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x4F1A6FC6A7B65Dc7ebC4EB692Dc3641bE997c2F2;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FFToken";
    ...
    address public marketingFeeReceiver = 0xCb30CBE8a2b05FbD8478d1282276383f46547684;
