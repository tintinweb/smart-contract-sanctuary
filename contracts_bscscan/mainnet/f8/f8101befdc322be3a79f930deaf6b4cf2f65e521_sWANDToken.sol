...
contract sWANDToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked WAND", "sWAND", 9) ERC20Permit() {
    ...
    /**
        @notice increases sWAND supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sWAND
