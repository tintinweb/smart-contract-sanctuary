...
contract Elonbust is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5BC8f5340599DF8F9343f086C33376bc097f0f51); // Marketing Address
    ...
    string private _name = "Elonbust";
    string private _symbol = "ELONBUST";
