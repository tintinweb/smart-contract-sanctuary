...
contract GoldfishSwap is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6474e96167c87F8C5A7C0dDdaB651bd2D08f86Ed); // Marketing Address
    address payable public charityAddress = payable(0x6474e96167c87F8C5A7C0dDdaB651bd2D08f86Ed); // Charity/Dev Address
    ...
    string private _name = "Goldfish Swap";  // nice
