...
contract MoneyMaker is Context, IERC20, Ownable {
    ...
    string private _name = "Money Maker";
    ...
    address public devWallet = 0xd912Cc867CBe37Cff1f8368018910B27be809b35;
    ...
    uint256 public _maxTxAmount = 1 * 10**10 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**8 * 10**9;
    uint256 public _maxWalletToken = 3 * 10**10* 10**9;
