...
/**
    ...
    | $$  \ $$| $$      | $$  | $$  /$$/    | $$      
    | $$$$$$$/| $$$$$$$$| $$  | $$ /$$$$$$$$| $$$$$$$$
    |_______/ |________/|__/  |__/|________/|________/
    ...
    */
    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        IERC20 ADA = IERC20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    // CHANGE
    contract BLAZE is IERC20, Ownable {
        using SafeMath for uint256;
        ...
        string constant _symbol = "BLZ";
        uint8 constant _decimals = 9;
    
        uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
        uint256 public _maxTxAmount = (_totalSupply * 50) / 1000; // 5% MAX 20,000,000
        uint256 public _maxWalletSize = (_totalSupply * 50) / 1000; // 5% MAX 3,000,000
