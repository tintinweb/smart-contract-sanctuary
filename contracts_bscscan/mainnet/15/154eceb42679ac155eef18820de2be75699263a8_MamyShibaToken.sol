...
contract MamyShibaToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x85d7722f2d1818E9A4CeE7c436C6bAe1b68fCdf2); // Marketing Address
    ...
    string private _name = "MamyShibaInu";
    string private _symbol = "MamySHIBA";
