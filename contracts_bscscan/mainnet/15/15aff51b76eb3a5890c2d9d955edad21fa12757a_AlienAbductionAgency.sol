...
/**
  ...
  AlienAbductionAgency by Arthur
  TG:  @AlienAbductionAgency

 Fun and profitable degen plays brought to you by @OxDiamondDogs
 Join up and keep an eye on the channel for all future plays!
...
contract AlienAbductionAgency is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x333330E1620D8769545820A5c85a0783d7089fA5); // Marketing Address

    address payable public teamAddress =
        payable(0x33333B191F6BEa5c4DEc476205F52A67a37a8331); // Team Address

    address payable public liquidityAddress =
        payable(0x33333B88ff2ac35E34d16a0f8775eC8Be72Bc8D1); // Liquidity Address
    ...
    string private constant _name = "AlienAbductionAgency";
