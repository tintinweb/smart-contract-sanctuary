...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also SkyADAed.
...
// File: contracts/SkyADADividendPayingToken.sol
...
contract SkyADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable ADA = address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    address private _marketingWallet = address(0x281e2ed32Ac1A9dEd26c08218B71380F99daF628);
    address private _devWallet = address(0x281e2ed32Ac1A9dEd26c08218B71380F99daF628);
    ...
    SkyADADividendTracker public dividendTracker;
    ...
    constructor() public ERC20("SkyADA", "SkyADA") {
        ...
        dividendTracker = new SkyADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "SkyADA: The dividend tracker already has that address");

        SkyADADividendTracker newDividendTracker = SkyADADividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "SkyADA: The new dividend tracker must be owned by the SkyADA token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "SkyADA: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SkyADA: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SkyADA: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SkyADA: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "SkyADA: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "SkyADA: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SkyADABSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "SkyADA: This account cannot send tokens until trading is enabled");
        }
...
contract SkyADADividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("SkyADA_Dividend_Tracker", "SkyADA_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "SkyADA_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "SkyADA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SkyADA contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "SkyADA_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SkyADA_Dividend_Tracker: Cannot update claimWait to same value");
