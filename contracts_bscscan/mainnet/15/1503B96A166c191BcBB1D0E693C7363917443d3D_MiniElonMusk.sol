...
/**
   ...
   Welcome to MiniElonMusk
   
   This is a community token. If you want to create a telegram I suggest to name it to @MiniElonMusk
   ...
   I will renounce the ownership to burn addresses to transfer MiniElonMusk to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make BabyBullRun 10000X? 
   ...
   it's the best part of the #MiniElonMusk idea, increasing the liquidity pool automatically, 
...
contract MiniElonMusk is Context, IERC20, Ownable {
    ...
    string private _name = "MiniElonMusk";
    string private _symbol = "MiniElonMusk";
