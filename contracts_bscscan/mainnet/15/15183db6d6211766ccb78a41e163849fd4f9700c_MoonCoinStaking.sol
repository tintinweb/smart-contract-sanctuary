...
contract MoonCoinStaking  {
	...
	event Evt_Invest(address indexed investor, address indexed referrer, uint256 investOption, uint256 msgValue);
	...
	function invest(address investor, address referrer, uint256 investOption) public payable {	
		...
		emit Evt_Invest(investor, referrer, investOption, msgValue);
