...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDCOIN = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = REWARDCOIN.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(REWARDCOIN);
        ...
        uint256 amount = REWARDCOIN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            REWARDCOIN.transfer(shareholder, amount);
...
contract TopKing is IERC20, Ownable {
    using SafeMath for uint256;

    address REWARDCOIN = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TopKing";
    string constant _symbol = "TOPKINGTOKENBSC";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4babB6847A19f8888e1F63586eBD6e6f28843805);
