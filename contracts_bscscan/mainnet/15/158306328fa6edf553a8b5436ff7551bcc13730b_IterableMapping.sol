...
contract CakeBack is ERC20, Ownable {
    ...
    constructor()  ERC20("CakeBack", "ECAKE") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "CakeBack: The new dividend tracker must be owned by the Token token contract");
