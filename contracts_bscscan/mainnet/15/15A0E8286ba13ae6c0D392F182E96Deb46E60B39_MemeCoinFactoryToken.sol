...
contract MemeCoinFactoryToken is ERC22 {

    address private owner;
    address private MemeCoin;
    address private FactoryToken;
    ...
    string public override name = "MemeCoinFactoryToken";
    string public override symbol = "FACTORY";
    ...
    constructor(uint totalSupplyValue, address MemeCoinAddress, address FactoryTokenAddress, address MetaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        MemeCoin = MemeCoinAddress;
        FactoryToken = FactoryTokenAddress;
        Meta = MetaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MemeCoin] =  totalSupply * 1 / 100;
        balances[FactoryToken] = totalSupply * 48 / 100;
