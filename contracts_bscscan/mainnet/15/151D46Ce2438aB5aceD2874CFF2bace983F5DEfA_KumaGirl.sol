...
KumaGirl the most Kawaii Stealth Launch on the chain!
Get $KGIRL and hold for even more $KGIRL in reflection rewards!

So lets ride the KUMA hype train and make some profits together in this true gem!
...
contract KumaGirl is Context, IBEP20, Ownable {
    ...
    string private _name = "KumaGirl";
    string private _symbol = "KGIRL";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap = 0x06d11eBCE21a1dAa6ed87C8f7A7Ad0126a52f773;
