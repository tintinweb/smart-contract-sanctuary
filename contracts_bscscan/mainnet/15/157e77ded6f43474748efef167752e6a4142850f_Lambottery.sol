...
abstract contract LotteryHelper is Pancake {
    ...
    constructor(address _weeklyAddress, address _daily, address _hourly) {
...
LotteryHelper {
    ...
    constructor (uint256 whaleMaxSell, uint256 whaleMinBalance, address _weeklyAddress, address _daily, address _hourly)
    TxLimits(whaleMaxSell, whaleMinBalance)
    LotteryHelper(_weeklyAddress, _daily, _hourly) {
