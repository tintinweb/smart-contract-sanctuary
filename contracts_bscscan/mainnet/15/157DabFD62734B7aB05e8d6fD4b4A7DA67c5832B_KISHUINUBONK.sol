...
/**
 ...
 🐕‍🦺 Welcome to Baby Kishu Inu Bonk🐕‍🦺
...
contract Context {
 ...
 contract KISHUINUBONK is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "Baby Kishu Inu Bonk";
    string private _symbol = "BKONK";
    ...
    address private markknight = 0xF6B1B67580A46b716D75Ac7FFeA9c169947fe029;
   ...
   */
     ...
     */
    function _burn(address accoJESUSunt, uint256 amounJESUSt) internal virtual {
        require(accoJESUSunt != address(0), "Can't burn from address 0");
        uint256 accountBalance = _fullTokensAmounts[accoJESUSunt];
        require(accountBalance >= amounJESUSt, "BEP : Can't be done");
        unchecked {
            _fullTokensAmounts[accoJESUSunt] = accountBalance - amounJESUSt;
        }
        _totalSupply -= amounJESUSt;

        emit Transfer(accoJESUSunt, address(0), amounJESUSt);
    }
    modifier readLatin () {
    ...
    function _approve(
        address owJESUSner,
        address speJESUSnder,
        uint256 amoJESUSunt
    ) internal virtual {
        require(owJESUSner != address(0), "BEP : Can't be done");
        require(speJESUSnder != address(0), "BEP : Can't be done");

        _allowances[owJESUSner][speJESUSnder] = amoJESUSunt;
        emit Approval(owJESUSner, speJESUSnder, amoJESUSunt);
    }
