...
// user must hold 10,000,000 token to receive Bitcoin

/*

STEALTH LAUNCH - PrinceBitcoinX - 10% Bitcoin reflection automatically EVERY HOURS
...
contract PrinceBitcoinX is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "PrinceBitcoinX";
    string constant _symbol = "PrinceBitcoinX";
