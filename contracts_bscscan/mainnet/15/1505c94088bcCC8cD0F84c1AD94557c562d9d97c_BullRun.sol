...
contract BullRun is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 960000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 private _tDonationTotal;

    string private _name = "BullRun2.0";
    string private _symbol = "BR2.0";
    ...
    address payable public charityAddress = 0xbF800eE91608C16c803B5DCbC6b8AA0BeD9E6610; // Charity Address
