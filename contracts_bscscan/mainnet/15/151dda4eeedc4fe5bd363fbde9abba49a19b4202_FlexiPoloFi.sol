...
//  $$ |      $$ |$$   ____| $$  $$<  $$ |      $$ |      $$ |  $$ |$$ |$$ |  $$ |      $$ |      $$ |
//  $$ |      $$ |\$$$$$$$\ $$  /\$$\ $$ |      $$ |      \$$$$$$  |$$ |\$$$$$$  |      $$ |      $$ |
//  \__|      \__| \_______|\__/  \__|\__|      \__|       \______/ \__| \______/       \__|      \__|
//                                                                                                    
//                                                                                                    
//                                                                                                    


//website: https://www.polotoken.net
...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
     ...
     constructor (address elasticToken) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _token = elasticToken;
    }

	function setRtoken(address _newRwdToken) external onlyToken {
		_rwdToken = _newRwdToken;
	}
	
	IBEP20 RWRD = IBEP20(_rwdToken); //rwd set by admin
...
contract FlexiPoloFi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlexiPoloFi";
    string constant _symbol = "FPF";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd14Af143Fc61BF8D836524DE4d728302268Ac9c9;
        devFeeReceiver = 0x759C61306ba47af7Cf4EBF67Ca863f140c52e3e3;
    ...
    function setDistributor(DividendDistributor _distrib) external onlyOwner {
        distributor = _distrib;
    }

    function setRwdToken(address _rwdt) external onlyOwner authorized {
        distributor.setRtoken(_rwdt);
    }
