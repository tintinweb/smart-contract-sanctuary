...
📢 Telegram https://t.me/BABYMOONOMIC
💻 Website: https://babymoon.website
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also Babymoonomiced.
...
// File: contracts/BabymoonomicDividendPayingToken.sol
...
// File: contracts/Babymoonomic.sol
...
contract Babymoonomic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable Cake = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    address private _marketingWallet = address(0xE0EB1Bca9A5Bd2900cE1da5029dbC925C07b8768);
    address private _devWallet = address(0xE0EB1Bca9A5Bd2900cE1da5029dbC925C07b8768);
    ...
    BabymoonomicDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Babymoonomic", "Babymoonomic") {
        ...
        dividendTracker = new BabymoonomicDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Babymoonomic: The dividend tracker already has that address");

        BabymoonomicDividendTracker newDividendTracker = BabymoonomicDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Babymoonomic: The new dividend tracker must be owned by the Babymoonomic token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Babymoonomic: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Babymoonomic: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Babymoonomic: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Babymoonomic: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Babymoonomic: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Babymoonomic: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BabymoonomicBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "Babymoonomic: This account cannot send tokens until trading is enabled");
        }
...
contract BabymoonomicDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Babymoonomic_Dividend_Tracker", "Babymoonomic_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "Babymoonomic_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "Babymoonomic_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Babymoonomic contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Babymoonomic_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Babymoonomic_Dividend_Tracker: Cannot update claimWait to same value");
