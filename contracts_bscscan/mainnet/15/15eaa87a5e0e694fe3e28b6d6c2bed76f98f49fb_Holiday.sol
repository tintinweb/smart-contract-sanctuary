...
/**
 ...
 Telegram https://t.me/teslaholidayy
...
/* Token contract */
contract Holiday is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x6496941e6566A372397d277f660a4602eadf18Ea;
    ...
    // Name and symbol
    string constant _name = "Tesla Holiday";
    string constant _symbol = "Holiday";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = 3000000000 * 10**18; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = 1000000000 * 10**18; // 0.20% or 250k tokens
    uint256 public _maxWalletToken = 5000000000 * 10**18; // 5% or 5m tokens
    ...
    uint256 public swapThreshold = 400000000 * 10**18; // 0.1% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xE3cbE467b2c932Dd440C2afa8ce47B2891158E9F;
        marketingFeeReceiver = 0xE3cbE467b2c932Dd440C2afa8ce47B2891158E9F;
