...
contract BlueWave is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xF68Bd373B756FD0dDa800020C1BEEC238d7BB96F); // Marketing Address
    ...
    string private _name = "BlueWave";
    string private _symbol = "BLUEWAVE";
