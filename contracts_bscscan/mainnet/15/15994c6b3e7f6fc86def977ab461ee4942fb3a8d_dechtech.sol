...
/**
 *
  Telegram : https://t.me/dechtechofficial
  Website : https://dechtech.finance/
*/
...
contract dechtech is Context, IERC20, Ownable {
    ...
    string private _name = "Dechtech";
    string private _symbol = "DCH";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x713C0C4bF647755Ec2DEa012221E9F19c925b48b);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 100000 * 10**9 * 10**_decimals;
        _maxBalance = 1000 * 10**9 * 10**_decimals;
