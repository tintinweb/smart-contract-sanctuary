...
/**
 * Telegram: https://t.me/coin888casino
 * Twitter: @888coin
 * Website: https://888coin.casino/
 * Youtube Channel: https://www.youtube.com/channel/UCzqCdyalUz6Rm0h-iAgab3A
 * Instagram: https://instagram.com/888coin/
*/
...
interface IERC20 {
  ...
  */
   ...
   * https://github.com/ethereum/EIPs/ku/ra/ii/nu/20#issuecomment-263524729
   *
...
contract CoinCasino is Context, IERC20 {
//contract KuraiInu is Context, IERC20 {
    ...
    string constant private _name = "888Coin";
    string constant private _symbol = "888COIN";
    ...
    address payable private _marketingWallet = payable(0x491d5DCACd0fdFBd3D123c2c81f7C43F4263ca8f);
    address payable private _buybackWallet = payable(0xaDea1958061daf08ac620dF922F4c02357E27F25);
