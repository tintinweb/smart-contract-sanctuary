...
contract MetaBots is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaBots";
    string private _symbol = "MetaBots";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd79A5Cd7E5449D762922C6281D118870f606247B); // Marketing Address
    address payable public DevWalletAddress = payable(0xc514e179dd651Bb9bA45ca4C1167830Dca5b69ed); // Dev Address
