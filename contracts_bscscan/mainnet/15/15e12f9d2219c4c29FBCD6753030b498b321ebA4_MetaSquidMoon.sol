...
/**
 * Hello Bsc and Squid Community
 * 
 * TG: https://t.me/MetaSquidMoon
 * 
 * 
 * MetaSquidMoon token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract MetaSquidMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaSquidMoon";
    string constant _symbol = "MSM";
