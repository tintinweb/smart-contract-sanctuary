...
contract RagnarFloki is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "RagnarFloki";
    string private _symbol = "RagnarFloki";
    ...
    uint256 public _maxWalletAmount = 100000 * 10**9;
