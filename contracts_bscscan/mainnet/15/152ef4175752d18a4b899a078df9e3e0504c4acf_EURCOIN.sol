...
// SPDX-License-Identifier: EURCOIN 
interface IERC20 {
...
contract EURCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "EURCOIN";
    string private _symbol = "EURC";
    ...
    uint256 constant numTokensSellToAddToLiquidity = 100000000 * 10**6 * 10**9;
