...
Fair launch no presale and big team wallet. 

ChefDota Bsc is the newest decentralized token on BSC. This is the newest meme token manipulating beauty into real like a beauty diamond
...
DISTRUBUTION:
 Verified contract
 Burn 90 % coin dead wallet
 Lp tokens to be burned at launch
 Ownership Renounced
...
FUNDS SAFU
   ...
   Telegram     : @ChefDotaChat
   Twitter          :@ChefDotaOffice
   Website        : https://countingdownto.com/countdown-pages/3gwpHuxj
...
contract ChefDota is Context, IERC20, Ownable {
