...
contract rarity is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint constant DAY = 1 days;
      ...
      uint256 public tokenPrice;
       ...
       function approveToken(uint256 tokenId) public nonReentrant { 
...
"&#x97ED;&#x83DC;&#x662F;&#x600E;&#x6837;&#x7EC3;&#x6210;&#x7684;&#x79D8;&#x7C4D;"
    ...
    string[] private suffixes  =["R","R","R","R","R","R","R","SR","SR","SSR"];
    ...
    function update_nameSuffixes (string[] memory _line) public onlyOwner{  nameSuffixes=_line  ; }
       ...
       function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        parts[1] =string(abi.encodePacked( classes(class[_summoner])," | ",getLine2(tokenId)));
