...
======T===R===I===T===O===N=========================<%{%{%{>>+===--->
	...
	Telegram: https://t.me/Triton_official
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 nptun = IBEP20(0xbFc5D671Ccdeb25654EF83C61b1535B2CB0A29c7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = nptun.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(nptun);
        ...
        uint256 amount = nptun.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            nptun.transfer(shareholder, amount);
...
contract Triton is IBEP20, Auth {
    using SafeMath for uint256;

    address nptun = 0xbFc5D671Ccdeb25654EF83C61b1535B2CB0A29c7;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Triton";
    string constant _symbol = "TRTN";
