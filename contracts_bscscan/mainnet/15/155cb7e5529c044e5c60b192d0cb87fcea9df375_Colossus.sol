...
//
Colossus 
Network Token total supply provided in quantity of 10,000,000,000,000,000 Colossus tokens.
No single individual or entity may acquire more than 1% of the tokens through the public token sale

Max wallet 1% of supply
Lp 10 bnb 
https://t.me/ColossusNetwork
...
contract Colossus is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 10_000_000_000_000_000; 
    ...
    string private _name = "Colossus";
    string private _symbol = "Colossus";
    ...
    uint256 public _Maxpertx = _tTotal/100;
    uint256 public _MaxperWallet = _tTotal/100;
    ...
    address _marketingWallet = 0xA99320D34a81B09eDfa8289984DaE2f501D8FbC1;
    ...
    uint256 private maxTxAmountUI = (startingSupply * maxTxPercent) / maxTxDivisor; // Actual amount for UI's
    // 1% of Total Supply
