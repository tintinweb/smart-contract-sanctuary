...
// D3VIL TRANSFER CHECKER (FEE APPROVER) CONTRACT
...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        address _D3VILAddress,
        address _WBNBAddress,
        address _d3vilVaultAddress
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        d3vilTokenAddress = _D3VILAddress;
        WBNBAddress = _WBNBAddress;
        tokenUniswapPair = IUniswapFactory(address(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73)).getPair(WBNBAddress,d3vilTokenAddress);
        d3vilVaultAddress = _d3vilVaultAddress;
        feePercentX100 = 100;
    ...
    address d3vilTokenAddress;
    address d3vilVaultAddress;
    ...
    function setD3vilVaultAddress(address _d3vilVaultAddress) public onlyOwner {
        d3vilVaultAddress = _d3vilVaultAddress;
    }
        ...
        )
    {
        ...
        // Dont have a fee when d3vilVault is sending, or infinite loop
        // And when pair is sending (buys are happening, do not tax on it)
        if(sender == d3vilVaultAddress || sender == tokenUniswapPair ) {
