...
contract RacaFlokiSanta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RacaFlokiSanta";
    string private _symbol = "RacaFlokiSanta";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x356d2Eb8599341e24E1dD573BAF6F6c850419366); // Marketing Address
