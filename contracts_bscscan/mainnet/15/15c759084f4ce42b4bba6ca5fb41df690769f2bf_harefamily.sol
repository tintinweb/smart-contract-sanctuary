...
contract harefamily is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "harefamily";
    string private _symbol = "harefamily";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39859C859297C8795E5A9f8D2de3800cB6486fa9); // Marketing Address
    address payable public teamWalletAddress = payable(0xe089E3351Aa78AF922D3E86A0deF5E64Fbe43b1f); // Team Address
