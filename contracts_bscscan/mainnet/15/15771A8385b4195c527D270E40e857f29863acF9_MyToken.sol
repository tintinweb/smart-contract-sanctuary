...
contract MyToken is ERC721{
    ...
    mapping(uint256=>bool) nftstakestate;
    ...
    function changecsdogefees(uint256 fees) public
    {
        require(msg.sender == devwallet,"not devwallet");
        csdogefees = fees;
    }
    
    function nftstake(uint256 tokenid,address _address,bool stake) external
    {
        require(!timeforauction[tokenid].inlist,"already in sale");
        require(!nftprice[tokenid].inlist,"already in sale");
        require(ownerOf(tokenid) == _address,"You are not owner");
        nftstakestate[tokenid] = stake;
    }
    ...
    function stakevalue(uint256 _tokenid) public view returns(bool)
    {
        return nftstakestate[_tokenid];
    }
    
    function ownernft() public view returns(address)
    {
        return owner;
    }
