 ...
 * Inspired by the revolutionary play to earn trending
 * 
...
contract MonsterWar is Context, BEP20 {
    using Address for address;
    mapping(address => uint256) private _holders;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isContractAddress;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000000000000; //Total Supply 1.000.000.000 MONSTERWAR
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    string private _name = "MONSTERWAR";
    string private _symbol = "MWA";
    uint8 private _decimals = 18;
    uint256 public _LiquidityPool = 250000000000000000000000000;
