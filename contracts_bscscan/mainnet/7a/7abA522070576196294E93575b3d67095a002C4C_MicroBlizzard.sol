...
/*
  ...
  /     \ |__| ___________  ____\______   \  | |__|____________________ _______  __| _/
 /  \ /  \|  |/ ___\_  __ \/  _ \|    |  _/  | |  \___   /\___   /\__  \\_  __ \/ __ | 
/    Y    \  \  \___|  | \(  <_> )    |   \  |_|  |/    /  /    /  / __ \|  | \/ /_/ | 
\____|__  /__|\___  >__|   \____/|______  /____/__/_____ \/_____ \(____  /__|  \____ | 
        \/        \/                    \/              \/      \/     \/           \/                 
                                                 
*/                                                                           

// Web: Coming Soon
// TG: https://t.me/MicroBlizzard
// TW: https://twitter.com/MicroBlizzard
...
contract MicroBlizzard is IBEP20, Context, Ownable {
    ...
    string private _name = "MicroBlizzard";
    string private _symbol = "BLIZ";
    ...
    constructor () {
        ...
        marketingWallet = 0x0dc2377B2C430ab728FAaaB22cf01d749063ecD1;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        if(!canTrade){
            ...
            if(recipient != address(pair)) {
                require(balanceOf(recipient) <= maxWallet, "maxWallet");
            }
        }
