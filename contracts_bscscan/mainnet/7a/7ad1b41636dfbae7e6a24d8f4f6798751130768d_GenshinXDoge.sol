...
/**
Genshin Doge is the coolest addition to the doge family with multi dimensional 
 ...
 * https://Genshindoge.com/
 * https://twitter.com/realGenshindoge
 * https://t.me/Genshindogecoin
*/
...
interface IERC20Metadata is IERC20 {
 ...
 contract GenshinXDoge is AutoBot, IERC20, IERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Genshin X Doge";
    string private _symbol = "GenshinXDoge";
    uint256 private constant MAX = ~uint256(0);
//  https://www.coingecko.com/en/coins/GenshinXDoge
