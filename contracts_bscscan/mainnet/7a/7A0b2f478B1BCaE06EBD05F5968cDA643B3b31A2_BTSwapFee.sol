...
contract BTSwapFee is SafeOwnable, Initializable {
    ...
    function initialize(address vault_, IBTRouter router_, IBTFactory factory_, address WETH_, address destroyToken_, address USDT_, address receiver_, address caller_) external initializer {
    ...
    function canRemove(IBTPair pair) internal view returns (bool) {
