...
contract FlokiPlus is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x974Aa0213ec24Ca812d450266e6dd28193A1B0a4); // Marketing Address
    ...
    uint256 public _maxWalletToken = 2000000000 * (10**9); // can't buy or accumulate more than this
    string private _name = "FlokiPlus";
    string private _symbol = "FLOPLUS";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x974Aa0213ec24Ca812d450266e6dd28193A1B0a4);
    }
