...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x4Fabb145d64652a948d72533023f6E7A623C7C53);
...
contract WAGMINOW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WAGMI NOW";
    string constant _symbol = "WAGMINOW";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**9 * (10 ** _decimals);//1,000,000,000,000 1T

    uint256 public _maxTxAmount = ( _totalSupply * 1 )  / 100;//10,000,000,000

    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;//20,000,000,000
