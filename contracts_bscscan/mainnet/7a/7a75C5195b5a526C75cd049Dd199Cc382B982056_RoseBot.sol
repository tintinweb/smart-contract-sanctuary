...
contract RoseBot is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "Rose Bot Inu";
    ...
    uint256 public _minimumLiquidity;
    ...
    function setAutoLiquidityReceiver(address wallet) external onlyOwner {
        _autoLiquidityReceiver = wallet;
    }
    function setSwapEnabled(bool value) external onlyOwner {
        _swapEnabled = value;
    }
    function setSwapBackSettings(uint256 min, bool enabled) external onlyOwner {
        _liquiditySwapThreshold = min;
        _swapEnabled = enabled;
    }
    function setLiquiditySwapThreshold(uint256 value) external onlyOwner {
        _liquiditySwapThreshold = value;
    }
