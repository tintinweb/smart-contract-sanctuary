...
import "./BlocksRewardsManager4.sol";

// 1000 Blocks space - Exclusive space with rewards for participants in space
// How does it work / rules:
// - Fixed price per 1 block
// - There is minimal time between users another buy (42 mins)
// -

contract BlocksSpace5 is Ownable {
    struct Block {
        uint256 price;
        address owner;
    ...
    BlocksRewardsManager4 public rewardsPool;
    ...
    uint256 immutable bytecodeDiff = 1;
    ...
    constructor(address rewardsPoolContract_, bool hasLogo, uint256 blockClaimPrice_, uint256 maxBlockWidth_, uint256 maxBlockHeight_, uint256 maxBlocks_) {
        rewardsPool = BlocksRewardsManager4(rewardsPoolContract_);
    ...
    function updateClaimPriceForBlock(uint256 newPrice) external onlyOwner {
