...
╚██████╔╝██║     ╚██████╗╚██████╗╚██████╔╝██║██║ ╚████║
 ╚═════╝ ╚═╝      ╚═════╝ ╚═════╝ ╚═════╝ ╚═╝╚═╝  ╚═══╝
    ...
    UFC COIN ($UFCCOIN) - Fair Launching November, 5th, 2021
    Telegram: https://t.me/ufc_coin
    Website: https://ufc-coin.site
*/ 
...
contract UFCCOIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x540c4806cdD14E88c2b89F78bc18D1aF7d8Bf1d9); // Marketing Address
    ...
    string private _name = "UFC COIN";
    string private _symbol = "UFCCOIN";
    ...
    // Prevent BOT & Whales
    function zAlphaBegin() public deadCall {
        _botStartblock = 99;
        _botEndblock = 99;
    }
