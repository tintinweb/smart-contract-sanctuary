...
contract TEST is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 5 * 10**8 * 10**8; // 500 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _liquiditySplitCeiling = 30 * 10**8 * 10**8; // 0.2 BNB
    uint256 private _maxTxn = 30 * 10**9 * 10**8; // 1 BNB
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        address developmentWalletAddress = 0xb621B8d28e0d92F0d35624CEF9039AB526f59b2f;
