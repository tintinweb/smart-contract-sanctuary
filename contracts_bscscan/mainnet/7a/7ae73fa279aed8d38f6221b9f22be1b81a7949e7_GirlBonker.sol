...
contract GirlBonker is Context, IERC20, Ownable {
    ...
    string private _name = "GirlBonker";
    string private _symbol = "GIER";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x570D14a2CD37B52846c00dba1aaE98908f1317A1, 'We can not exclude Uniswap router.');
