...
contract ElonHype is IBEP20, Auth {
    ...
    string constant _name = "ElonHype";
    string constant _symbol = "EHYPE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100;  //5% max tx
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100;  //10% max wallet
    ...
    address private marketingFeeReceiver =0x13Fa1F08B348fc53D0Cd56c73c395FB218b4074A;
    address private teamFeeReceiver =0x5A6d062fB3b39fD0Ef213f152eb9f07d633398c3;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x33BfeB933662d7A8363347A6616689Ed46739Db4;
