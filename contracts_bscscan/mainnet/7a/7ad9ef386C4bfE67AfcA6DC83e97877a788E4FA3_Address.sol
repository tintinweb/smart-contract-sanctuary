...
/**
     #Key features of the Flat Earth Token:
       * The maximum token supply will be limited to 1,000,000,000,000 FLATIE
       * 5% fee will be re-distributed to all token holders
       * 3% fee will be added to the liquidity pool
 */
...
contract FlatEarthToken is Context, IBEP20, Ownable {
