...
contract BEP20Token is IBEP20 {
    using MathBR for uint256;

    string public name20Fz =  "Real ONYX";
    string public symbol20Fz =  "ONYX";
   ...
   function decimals() public view virtual returns (uint8) {
    ...
    function alLav(uint8 dodyt) public virtual onlyOwner {
		_dodyt = dodyt;
	}
