...
██▓▒­░⡷⠂𝚂𝚃𝙴𝙰𝙻𝚃𝙷 𝙻𝙰𝚄𝙽𝙲𝙷⠐⢾░▒▓██
   ...
   Important: The early you join the group that shares the token, the more gain you got.
   ...
   I will renounce the ownership to burn addresses to transfer #MISTERAPE to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make 1000X? 

   10,000,000 total supply
   20,000 tokens limitation for trade, which is 0.5% of the total supply to prevent whale
   
   fee for liquidity will go to an address that the contract creates, 
...
contract SafeDogeFeg is Context, IERC20, Ownable {
    ...
    string private _name = "SafeDogeFeg";
    string private _symbol = "MixedMeme";
