...
/*
    ...
    Total Fees: 14%
    2% fee is added to the developer wallet as BNB *Note the team will not be selling tokens*
    6% fee is added to the marketing wallet as BNB *Note the team will not be selling tokens*
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    string private _name = "PepeBonk";
    string private _symbol = "PEPEBONK";
    ...
    uint256 public numTokensSellToAddToLiquidity = 2500000000000* 10**9;
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0x9C697114dd5a611f463b53f10691Ac637980c95c;
        _developerAddress = 0x92854243a7d7B04CC94177326dC7dc2485061962;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "PepeBonk: cannot burn from zero address");
    require(_balances[account] >= amount, "PepeBonk: Cannot burn more than the account owns");
