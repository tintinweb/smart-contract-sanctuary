...
contract CovenantDividendTracker is DividendPayingToken, Ownable {
    ...
    {
        claimWait = 777600; // 9 days
        minimumTokenBalanceForDividends = 100000 * (10**9); //must hold 100,000+ tokens
    }
...
contract CovenantToken is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x47A850AaB6d9600e8910eA4D6c3C216c6650A09A;
    ...
    uint256 public maxSellTransactionAmount = 148410000 * (10**9); // 0.5%
    uint256 public swapTokensAtAmount = 14841000 * (10**9);
    ...
    constructor() public BEP20("Covenant", "UB", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        ...
        emit UpdatePancakeswapV2Router(
            newAddress,
        ...
        onlyOwner
    {
        require(
            ...
            "Covenant: The liquidity wallet is already this address"
        );
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        // swap tokens for BNB
        swapTokensForBnb(half); // <- this breaks the BNB -> UB swap when swap+liquify is triggered
