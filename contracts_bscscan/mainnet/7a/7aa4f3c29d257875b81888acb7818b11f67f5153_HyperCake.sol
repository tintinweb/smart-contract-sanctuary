...
HyperCake Tokenomics 
10% Rewards
Automatic distribution of CAKE rewards to the holders
4% Liquidity
Automatically add 4% of each transaction to liquidity pool.
1% Marketing and team support
HyperCake's glory will be promoted through a marketing fund
*1% of the liquidity - Max Buy/Sell transaction value
Anti-whale mechanism to prevent whales from tinkering with the chart
...
contract HyperCake is Context, IERC20, Ownable {
    ...
    string private _name = "HyperCake";
    string private _symbol = "HYPERCAKE";
    ...
    address _marketingWallet = 0xb7d972E3291D5A4ecE3302bF36EF94eb98a90A0a;
