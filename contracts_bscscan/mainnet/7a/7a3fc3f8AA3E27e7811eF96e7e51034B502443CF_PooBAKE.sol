...
//EARN DOUBLE REWARDS ON $CAKE AND $POO, JOIN US ON TG: poobake
...
contract PooBAKE is Context, IERC20, Ownable {
    ...
    string private _name = "PooBAKE";
    string private _symbol = "PooBAKE";
