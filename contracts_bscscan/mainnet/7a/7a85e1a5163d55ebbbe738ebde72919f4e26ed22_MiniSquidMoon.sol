...
/**
https://t.me/Minisquidmoon_bsc

/**

4% in Squid Moon rewards. Lp will be locked 
 ...
 Reflection/Taxes: 4% in Marketing, 4% in Liquidity 4% Squid Moon
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SquidMoon = IERC20(0x2766CC2537538aC68816B6B5a393fA978A4a8931);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SquidMoon.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SquidMoon);
        ...
        uint256 amount = SquidMoon.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SquidMoon.transfer(shareholder, amount);
...
// CHANGE
contract MiniSquidMoon is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address Doge = 0x7A565284572d03EC50c35396F7d6001252eb43B6;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Minisquidmoon";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x8289Da125F57865BE131B781c879EEe0E027295e);
