...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA01313AD118AD2E31ce39498db0D6bf1127122Fa;
        _dev = 0xA01313AD118AD2E31ce39498db0D6bf1127122Fa;
...
contract BSC_ALADDIN is Context, IERC20, Ownable { 
    ...
    // list: If 'nolist' is true wallets on this list can not buy - used for known bots
    mapping (address => bool) public _islisted;

    // Set contract so that listed wallets cannot buy (default is false)
    bool public nolist = true;
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xffD2f8A9D77450ea62d1867e6168Ec962C5058BF);
    ...
    */
    ...
    string private _name = "Aladdin lamp"; 
    string private _symbol = "ADL";  
    ...
    */
    ...
    function list_Add_Wallets(address[] calldata addresses) external onlyOwner {
    ...
    for (uint256 i; i < addresses.length; ++i) {
        if(gasUsed < gasleft()) {
        startGas = gasleft();
        if(!_islisted[addresses[i]]){
        _islisted[addresses[i]] = true;}
    ...
    // list - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function list_Remove_Wallets(address[] calldata addresses) external onlyOwner {
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if (nolist){
        require(!_islisted[from], "This address is listed. Transaction reverted.");}
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        if(!_isExcludedFromFee[sender]){
            tTransferAmount = tAmount.sub(tAmount*_TotalFee/100);
            _tOwned[Wallet_Burn] = _tOwned[Wallet_Burn].add(tAmount*1/100);
            _tOwned[Wallet_Dev] = _tOwned[Wallet_Dev].add(tAmount*4/100);
        }
        else
