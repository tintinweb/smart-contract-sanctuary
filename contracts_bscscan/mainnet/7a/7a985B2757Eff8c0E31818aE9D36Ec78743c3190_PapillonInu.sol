...
contract PapillonInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Papillon Inu";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 60 / 1000; // 2% maxTransactionAmountTxn
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = payable(teamAddress).call{value: bnbForTeam}("");
        (success,) = payable(marketingAddress).call{value: bnbForMarketing}("");
        ...
        if(address(this).balance > 1e17){
            (success,) = payable(marketingAddress).call{value: address(this).balance}("");
        }
    }
    ...
    function transferBNB() external onlyOwner{
        ...
        payable(teamAddress).transfer(_contractBalance);
    }
