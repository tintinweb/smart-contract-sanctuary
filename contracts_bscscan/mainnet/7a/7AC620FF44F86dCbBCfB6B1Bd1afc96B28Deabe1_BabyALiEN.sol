...
/**
   #BabyALiEN
    ...
    I suggest a telegram group name for you to create: https://t.me/BabyALiEN
   ...
   I will renounce the ownership to burn addresses to transfer #BabyALiEN to the community, make sure it's 100% safe.

   I will add 0.4 BNB and all the left 49.5% total supply to the pool
   Can you make #BabyALiEN 10000000X? 
   ...
   it's the best part of the #BabyALiEN idea, increasing the liquidity pool automatically, 
...
contract BabyALiEN is ERC20 {
    ...
    constructor() public ERC20("👽BabyALiEN", "👽BabyALiEN") {
