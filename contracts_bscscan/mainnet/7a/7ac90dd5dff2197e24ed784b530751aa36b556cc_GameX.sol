...
/**
   ...
   I created a black hole so #GMXtoken will deflate itself in supply with every transaction
...
contract GameX is Context, IERC20, Ownable {
    ...
    string private _name = "GameX";
    string private _symbol = "GMX";
