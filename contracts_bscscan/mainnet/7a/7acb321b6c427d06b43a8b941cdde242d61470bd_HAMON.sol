...
// HAMON, a JOJO Token
// A Harmony (ONE) reflection token
// Based off Mommy Milkers
// 2% LP 3% Reflections .5% Dev 5.5% Tax | Low Max Wallet (~1%)
...
//    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // Testnet
    ...
    uint256 public minPeriod = 33 minutes; // min 33 mins delay
...
contract HAMON is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "HAMON";
