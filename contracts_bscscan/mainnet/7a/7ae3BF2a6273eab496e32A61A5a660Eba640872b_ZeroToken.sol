...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1a61eaf07010fB30fDDe06ecF9c5C9F0A9a2C2cf;
...
contract ZeroToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4Ed9264A2Bd3E58d6bed1B9d352Db5bB9e0D1854;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Zero Token";
