...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _buyback(address account, uint256 amount) internal virtual {
...
contract FlokiTroll is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("FlokiTrollP", "FROLL") {
        _buyback(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}