...
EDIT THIS: Add your intro text here
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1;  // CHANGE THIS IF YOU WANT
...
contract CHANGEME is Context, IBEP20, Ownable { // CHANGE CHANGEME
    ...
    string private _symbol = "CHANGEME";
    ...
    function SetSwapMinutes(uint256 newSeconds) external onlyOwner {
        _intervalSecondsForSwap = newSeconds * 30 seconds;
    }
