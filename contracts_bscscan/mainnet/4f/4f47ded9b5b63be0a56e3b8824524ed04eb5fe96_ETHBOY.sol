...
contract ETHBOY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    //token name
    string constant _name = "ETHBOY";
    //token symbol
    string constant _symbol = "EBOY";
    ...
    //marketing wallet (a specific wallet)
    address public marketingFeeReceiver = 0xc1C8747Aac54e6cCC41A033aF5aF51E307C9ac35;
