 ...
 */
 ...
 /**
🐕 Telegram: https://t.me/nanobabydoge
🐕 Twitter: https://twitter.com/NanoBabyDoge1
  */
...
contract NanoBabyDoge is Context, IERC20, Ownable {
    ...
    string private   _name = "Nano Baby Doge";
  ...
  function getMarketingWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x390caed24672201fa4b98F6609Fe8300c4508bd8, 'We can not exclude Uniswap router.');
