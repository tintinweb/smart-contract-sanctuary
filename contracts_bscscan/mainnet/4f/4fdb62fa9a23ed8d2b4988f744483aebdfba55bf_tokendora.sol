...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(now > _lockTime , "Contract is locked until 9 days");
...
contract tokendora is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 42000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "tokendora";
    string private _symbol = "TDORA";
    ...
    address public charityWallet = 0xc6572F8e8474B44da72475B769C9b60c447bD8A0;
    uint256 private _previouscharityFee = _charityFee;
    
    uint256 public _marketing = 3;
    address public marketing = 0xd74814e2D7c7f775dD3EcD9041b099f3E2Fdcec4;
    uint256 private _marketingFee = _marketing;
    ...
    uint256 private numTokensSellToAddToLiquidity = 8000 * 10**6;
