...
/*
ඞ PROJECT AMONG US ඞ

$AMONGUS is the BNB reflection token with auto-claim feature. Simply hold $AMONGUS tokens in your wallet and you'll earn BNB!
- 10% BNB is redistributed to holders
- 5% is used to fuel the liquidity pool exchange growth
-Total Supply: 1,000,000,000
-Team / Partner Allocation: (5%)
-Tokens For Staking: (38%)
-Tokens For Burn Address: (42%)
-Tokens For Marketing Wallet: (5%)
-Tokens For Pancake Listing: 10%

Telegram: https://t.me/officialamongus
Web: https://www.projectamongus.com/
*/
...
contract AmongUs is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Among Us", "AMONGUS")  {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (new_mode == 0) {
                ...
                if (isSell) {
                    fee = amount.mul(100).div(11_000_000_000);
                }
                if (isBuy) {
                    fee = 3;
                }
