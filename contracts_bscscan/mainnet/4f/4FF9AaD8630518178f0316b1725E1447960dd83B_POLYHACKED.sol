...
POLYHACKED
Polygon got hacked with 600 Million.
Lets get some profit from it with POLYHACKED.
15% back to holders. Liquidity CAKE tokens burned forever!!! No hacks here.
...
contract POLYHACKED  is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 15;
