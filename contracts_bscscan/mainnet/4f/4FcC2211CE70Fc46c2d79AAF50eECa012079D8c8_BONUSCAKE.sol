...
contract BONUSCAKE is ERC20, Ownable {
    ...
    uint256 public tradingEnabledTimestamp = 1629460800;
    ...
    address public _marketingWalletAddress = 0xaaF5A354c37465b6314824595f5556684A985636;
    ...
    constructor() public ERC20("BONUS CAKE", "BONUS CAKE") {
    ...
    function updateTradingTime(uint tradingTime) external onlyOwner {
        require(tradingTime < tradingEnabledTimestamp);
        tradingEnabledTimestamp = tradingTime;
    }
    ...
    function _transfer(
        ...
        , "cannot trade before trading time");
...
contract BONUSCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("BONUSCAKE_Dividen_Tracker", "BONUSCAKE_Dividend_Tracker") {
        claimWait = 3600;
