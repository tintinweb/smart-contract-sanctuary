...
contract MetaHumanToken is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Human Token";
    string private _symbol = "METAHUMANTOKEN";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x06EC1543E0DFEb6Be7B547933CB8DD0fbD131946);
