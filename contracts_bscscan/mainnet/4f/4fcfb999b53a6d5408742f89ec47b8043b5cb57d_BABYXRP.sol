...
contract BABYXRP is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xdE1e53C2a0114c007871B62A3cfE5F0E28428f8d); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0xdE1e53C2a0114c007871B62A3cfE5F0E28428f8d); // xrp Address
    ...
    string private _name = "786 Coin";
    string private _symbol = "786";
    uint8 private _decimals = 9;

    uint256 public _burnFee = 2;
    uint256 public _liquidityFee = 5;
    uint256 public _marketingFee = 5;
    uint256 public _xrpCharityFee = 1;
