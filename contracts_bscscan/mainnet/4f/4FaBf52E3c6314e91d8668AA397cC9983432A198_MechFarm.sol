 ...
 */
contract MechFarm is BaseFallback {
    /**
...
contract MechaFarm is Ownable {
    ...
    address public constant UNIV2ROUTER2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    uint256 public constant BONUS_MULTIPLIER = 7;
    ...
    function startFarming(uint256 _sushiPerBlock) public onlyOwner {
        ...
        bonusEndBlock = startBlock + 28800 * 15;
    }
    ...
    function setPair(address _pairaddr) public onlyOwner {
        ...
        TransferHelper.safeApprove(pairaddr, UNIV2ROUTER2, uint(- 1));
        TransferHelper.safeApprove(WBNB, UNIV2ROUTER2, uint(- 1));
        TransferHelper.safeApprove(address(sushi), UNIV2ROUTER2, uint(- 1));
    }
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken, bool _withUpdate, uint256 _type) public {
        ...
        TransferHelper.safeApprove(address(_lpToken), UNIV2ROUTER2, uint(- 1));
        if (_type == POOL_LPTOKEN) {
            ...
            TransferHelper.safeApprove(token0, UNIV2ROUTER2, uint(- 1));
            TransferHelper.safeApprove(token1, UNIV2ROUTER2, uint(- 1));
        }
    }
