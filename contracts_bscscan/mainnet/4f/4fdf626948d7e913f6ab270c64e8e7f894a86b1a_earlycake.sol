...
// CHANGE
contract earlycake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "EarlyCAKE";
    string constant _symbol = "$EarlyCAKE";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xE9FB2bDc50FdD2ac0B0cE9b70b4395Af59350aB6);
