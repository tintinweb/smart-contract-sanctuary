...
contract BabyAngel is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Angel";
    string private _symbol = "BBANGEL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x892620b643961F025B57E3BaB6C904e9fF1c5141); // Marketing Address
    address payable public DevWalletAddress = payable(0x4f8e85edc3c195B4dfC34C6043B415eB5C1C217D); // Dev Address
