...
Sell timer: 15 seconds

Tax: 
100% buy tax declining 1% every 15 seconds until 12% after 22mins
19% sell

Tax Breakdown at launch
45% to Stella or FEG REWARDS
45% to LP
10% MARKETING

Tax Change after 11 mins
60% to Stella or FEG REWARDS
20% to LP
20% MARKETING
*                      
*
* https://t.me/stellarfeg
*/
...
contract StellarFEG is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'StellarFEG';
    string private constant _symbol = '$SFEG';
    ...
    uint16 public constant MaxSellLockTime= 15;
    ...
    //DevWallets
    address public TeamWallet=payable(0x3eCA71bF4E83000e219fA0EF7799f58474f0f35D);
    address public walletTwo=payable(0x3eCA71bF4E83000e219fA0EF7799f58474f0f35D);
    //TestNet
    ...
    //Claims Stellar
    function claimStellar(address addr) private{
        ...
        path[1] = 0x72b150fa9241Ef91E8BeF9340BD78f5195Fc19aD;  
    ...
    function claimFEG(address addr) private{
        require(!_isWithdrawing);
        _isWithdrawing=true;
        uint256 amount;
        if(isExcludedFromStaking(addr)){
        ...
        address[] memory path = new address[](2);
        path[0] = _pancakeRouter.WETH(); //BNB
        path[1] = 0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167;  
    ...
    function StellarWithdraw() public{
        claimStellar(msg.sender);
    }
        function Fegithdraw() public{
        claimFEG(msg.sender);
    }
