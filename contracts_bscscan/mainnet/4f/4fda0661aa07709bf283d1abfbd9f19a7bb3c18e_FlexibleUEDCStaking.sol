...
contract FlexibleUEDCStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() public {
        stakedToken = IBEP20(0xF0b6e29C429BBb8E1448340f0776bE933805344e);
        startBlock = block.number;
        bonusEndBlock = block.number.add(5* 10512000);
        rAPY = 50;
