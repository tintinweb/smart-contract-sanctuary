...
contract MUSKY is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2e6 * 10**_decimals;

    address public marketingAddress = 0xe219D2f260E5824160EbbC280540AfC21C89c1A8;

    string private constant _name = "GoodBurger";
    string private constant _symbol = "GBURGER";
    ...
    feeRatesStruct public sellFeeRates = feeRatesStruct(4, 1, 5);
  ...
  function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function setFeeRates(uint256 _rfi, uint256 _marketing, uint256 _liquidity) external onlyOwner {
      require(_rfi + _marketing + _liquidity <= 11, "Max Fee is 100%");
      feeRates.rfi = _rfi;
    ...
    function setSellFeeRates(uint256 _rfi, uint256 _marketing, uint256 _liquidity) external onlyOwner{
        require(_rfi + _marketing + _liquidity <= 11, "Max Fee is 100%");
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        feeRatesStruct memory tempFees;
        ...
        if(!takeFee) {
          ...
          return s;
            ...
            tempFees = sellFeeRates;
        }
        else tempFees = feeRates;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        _tokenTransfer(from, to, amount, !(_isExcludedFromFee[from] || _isExcludedFromFee[to]), isSell);
    }
