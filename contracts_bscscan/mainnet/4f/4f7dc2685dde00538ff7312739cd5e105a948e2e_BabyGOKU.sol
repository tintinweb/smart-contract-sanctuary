...
contract BabyGOKU is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 0* 100; // Max Transaction: (50%)
    uint256 public _numTokensSellToAddToLiquidity = 0 * 100;
    uint256 public _maxWalletToken = 0 * 10**9; // Max Transaction: (50%)
