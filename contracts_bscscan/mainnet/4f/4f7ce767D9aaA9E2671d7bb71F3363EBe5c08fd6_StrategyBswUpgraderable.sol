...
// File: contracts/StrategyBswUpgraderable.sol
...
contract StrategyBswUpgraderable is ReentrancyGuardUpgradeSafe, OwnableUpgradeable , Pausable {
    ...
    address[] public wbnbToGrandPath;
    ...
    function initialize(
        ...
        if (isGrandComp) {
            ...
            bswRouterAddress = _bswRouterAddress;
            
            earnedToWbnbPath = [earnedAddress, wbnbAddress];
            wbnbToGrandPath = [wbnbAddress, GrandAddress];
    ...
    function earn() public whenNotPaused {
        ...
        if (earnedAddress != token0Address) {
            ...
            IPancakeRouter02(bswRouterAddress)
        ...
        if (token0Amt > 0 && token1Amt > 0) {
            ...
            IPancakeRouter02(bswRouterAddress).addLiquidity(
                token0Address,
                token1Address,
                token0Amt,
                token1Amt,
