...
contract SpaceMisfitsCoddlePets  is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Space Misfits Coddle Pets';
    string  private constant _SYMBOL = 'CODDLE';
