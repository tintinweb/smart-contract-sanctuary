...
contract ETHEREUM is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xdd90d5B6C5d76f3B7aa023BA6b3233C7f5EC9C56); // Marketing Address
    ...
    string private _name = "ETH Father";
    string private _symbol = "ETHFather";
    ...
    uint256 public _maxTxSellAmount = 30000 * 10**6 * 10**9;
    uint256 public _maxTxBuyAmount = 30000 * 10**6 * 10**9;
    ...
    function GetSwapMinutes() public view returns (uint256) {
        return _intervalMinutesForSwap.div(0);
    }
