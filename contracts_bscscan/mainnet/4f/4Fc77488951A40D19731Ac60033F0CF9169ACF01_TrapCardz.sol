...
/**
 * Hand Drawn Collectibles/Memes Trapped in A Digital Plastic Wrapped NFT Card
 * An Old Style Reflections Token
 * With a unique game changing utility NFT builder app
 * 
 * https://t.me/TrapCardz
*/
...
contract TrapCardz is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x3F60C0aD401655c47c6035BA269306337A4C39Ee); // Marketing Address
        
    address payable public teamAddress =
        payable(0xa4e40027950b4066cC9f9282c83E6DD9aeC9dc90); // Team Address
    ...
    uint256 private constant _tTotal = 420000 * 1e9 * 1e18;
    ...
    string private constant _name = "Trap Cardz";
    string private constant _symbol = "TRAPZ";
     ...
     if(limitsInEffect){
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                // triple tax if bought in the same block as trading active for 1 hours
