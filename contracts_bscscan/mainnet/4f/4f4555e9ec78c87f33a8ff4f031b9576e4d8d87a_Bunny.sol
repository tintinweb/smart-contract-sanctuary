...
contract Bunny is Start, IBunny {
    ...
    mapping(address => mapping(address => uint)) public WPFI; // waiting period for inheritance
    mapping(address => mapping(address => bool)) public IC; // inheritance claim
    mapping(address => address) public IR; // Inheritance Recipient
    mapping(address => uint) public MyPotNow;
    mapping(address => uint) public Staked;

    bool public VotingOpen;
    uint[] public VoteArray;
    address[] public Voters;

    uint public INITS = 100000000 * 10 ** 14;
    uint public RBF = 100000;
    uint public totalSupply = RBF*INITS;
    uint public test = 10*RBF;
    uint public decimals = 14;
    uint public lastRBFReset;
    uint public Pot;
