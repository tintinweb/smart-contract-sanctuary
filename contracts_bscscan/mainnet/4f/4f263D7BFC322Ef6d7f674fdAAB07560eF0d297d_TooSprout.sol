...
/**
 * @title Too Sprout
 * @notice Too Sprout NFT collection
 */
contract TooSprout is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        require((_maxSupply == 100) || (_maxSupply == 1000) || (_maxSupply == 10000) || (_maxSupply == 20000), "Operations: Wrong max supply");
    ...
    /**
     * @notice Allows the owner to mint multiple token to a specific address
     * @param _to: address to receive the token
     * @param _mintAmount: mintAmount
     * @dev Callable by owner
     */
    function mintMultiple(address _to, uint256 _mintAmount) external onlyOwner {
