 ...
 *
 * The defaut value of {decimals} is 18. To select a different
value for
 * {decimals} you should overload it.
 *
 * All two of these values are immutable: they can only be set
once during
 * construction.
 */
 ...
 *
 * This is internal function is equivalent to {transfer}, and can
be used to
 ...
 *
 * To learn more about hooks, head to xref:ROOT:extendingcontracts.adoc#using-hooks[Using Hooks].
 */
...
contract CRYPTID is ERC20("Cryptid", "CRYPTID", 18) {
 constructor() {
 _mint(0x42A4Da6fb27eDC2a38A084BC7547eD6e531d0E9c, 22000000*(uint(10)**18));
 }
}