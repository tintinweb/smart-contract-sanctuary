...
// File: contracts/TriedApeYachtClub.sol
...
/**
 * @title TriedApeYachtClub contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract TriedApeYachtClub is ERC721, Ownable {
    using SafeMath for uint256;

    string public TAYC_PROVENANCE = "";

    uint256 public startingIndexBlock;

    uint256 public startingIndex;

    uint256 public constant apePrice = 100000000000000000; //0.1 BNB
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        TAYC_PROVENANCE = provenanceHash;
    }
