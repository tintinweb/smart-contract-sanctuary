...
/*
https://www.babysantatoken.com/
Baby Santa is working overtime on the BSC. Delivering diamond 
hands to all the good little boys and girls. Pack your bags, hop on and
 hold tight. The sleigh has been upgraded with rocket power fueled by good times 
 and reindeer farts. 🤣 Join the giving revolution, earn BUSD rewards, compound in 
 our BUSD farm Day 1, and give back this holiday season and beyond. NFT's coming soon! 
 Happy holidays, and LFG. Will be 
opened to the public after short period! Join us in Telegram!
*/
...
contract SnapVader is Context, BinanceMovie, Ownable {
    ...
    string private _name = 'Snap Vader';
    string private _symbol = 'SNAPVADER';
