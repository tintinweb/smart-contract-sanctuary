...
contract BigDogeX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "BigDogeX";
    string private constant _symbol = "$BigDogeX";
    ...
    address payable constant private _marketingAddress = payable(0x4C158051b2ee3C577bf75fC4a9319D326deF9aa8);
    address payable constant private _buybackAddress = payable(0x4C158051b2ee3C577bf75fC4a9319D326deF9aa8);
    address payable constant private _projectMaintainence = payable(0x4C158051b2ee3C577bf75fC4a9319D326deF9aa8);
    ...
    address public _oraclePriceFeed = 0x4C158051b2ee3C577bf75fC4a9319D326deF9aa8;//rinkeby 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//LokiDogeX
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//LokiDogeX
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent > 100, "Amount must be greater than 0");
