...
contract LunaPrimeFoundation is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Pruebas De POllos";
    string private _symbol = "PollosTest";
    ...
    address donationAddress=0xFE4d5187B0780A977008Dc62eA4158C72e963Aa8; //dummy address
    address marketingAddress=0x8332AB341B6E949b78f8F41581A876987d49EC5F; // dummy address
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && overMinTokenLiquidityBalance && sender != uniswapV2Pair && swapAndLiquifyEnabled) {
