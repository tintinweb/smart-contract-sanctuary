...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xC146B7CdBaff065090077151d391f4c96Aa09e0C); // MCC
    address WFTM = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB
...
contract MCCPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xC146B7CdBaff065090077151d391f4c96Aa09e0C; // MCC
    address public WFTM = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MCC Printer";
    string constant _symbol = "MCCP";
    ...
    address public autoLiquidityReceiver=0x2B0225025A5bb9eD421e0F0507F21E339a6b6839; //liq address
    address public marketingFeeReceiver=0x2B0225025A5bb9eD421e0F0507F21E339a6b6839; // marketing address
