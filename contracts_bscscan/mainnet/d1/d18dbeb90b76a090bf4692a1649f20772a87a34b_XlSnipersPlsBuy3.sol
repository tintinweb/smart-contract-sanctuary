...
contract XlSnipersPlsBuy3 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    XlSnipersPlsBuy3DividendTracker public dividendTracker;
    ...
    constructor() ERC20("XlSnipersPlsBuy3", "SniperBait3") {
        marketingWallet = payable(0xAF0f7Bc79446FeFa099002777109f9d833f0F208); //multi sig gnosis wallet
        ...
        dividendTracker = new XlSnipersPlsBuy3DividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "XlSnipersPlsBuy3TRACKER",
            "SniperBait3TRACKER"
        );
...
contract XlSnipersPlsBuy3DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    XlSnipersPlsBuy3 public XlSnipersPlsBuy3Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        XlSnipersPlsBuy3Contract = XlSnipersPlsBuy3(mainContract);
    ...
    function _transfer(
        ...
        require(false, "XlSnipersPlsBuy3_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "XlSnipersPlsBuy3_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main XlSnipersPlsBuy3 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(XlSnipersPlsBuy3Contract);

            uint256 prevBalance = XlSnipersPlsBuy3Contract.balanceOf(address(this));
            ...
            {
                uint256 received = XlSnipersPlsBuy3Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    XlSnipersPlsBuy3Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
