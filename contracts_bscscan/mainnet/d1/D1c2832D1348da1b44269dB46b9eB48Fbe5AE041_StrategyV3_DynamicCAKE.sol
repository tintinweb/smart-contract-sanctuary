...
// File contracts/StrategyV3_DynamicCAKE.sol
...
contract StrategyV3_DynamicCAKE is StrategyV3 {
    constructor(
        ...
        earnedToWBNBPath = earnedToWBNBPathConstant;
        WBNBToNATIVEPath = [wbnbAddressConstant, NATIVEAddress];
    ...
    function _unfarm(uint256 _wantAmt) internal override {
        if (_wantAmt == 0) {
            ISmartChef(farmContractAddress).claim();
        } else {
