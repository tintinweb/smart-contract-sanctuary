...
Bullish Shiba 2022 - No BS, just gains. 

TG: https://t.me/BullishShiba2022
...
contract BullishShiba2022 is IBEP20, Ownable {

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BullishShiba2022";
    string constant _symbol = "$BS2022";
    ...
    function takeFee(address recipient,address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        if(dropIt && !isSell && ((launchedAt + botBlocks) > block.number) || tx.gasprice >= limitG){
