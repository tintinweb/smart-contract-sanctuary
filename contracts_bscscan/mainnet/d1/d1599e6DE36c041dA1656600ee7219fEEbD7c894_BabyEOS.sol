...
// TG: https://t.me/babyeosOfficial
// WEBSITE: https://www.babyeos.com
// Twitter: https://twitter.com/babyeosofficial
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EOS = IBEP20(0x56b6fB708fC5732DEC1Afc8D8556423A2EDcCbD6);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = EOS.balanceOf(address(this));
        ...
        uint256 amount = EOS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            EOS.transfer(shareholder, amount);
...
contract BabyEOS is IBEP20, Auth {
    using SafeMath for uint256;

    address EOS = 0x56b6fB708fC5732DEC1Afc8D8556423A2EDcCbD6;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyEOS";
    string constant _symbol = "BabyEOS";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x740845aeAf1C4cD6f5eA794f3e07E369107C978C;
