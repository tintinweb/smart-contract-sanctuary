...
The first ever fully customed latest compiler version 0.8.9 smart contract for BSC network, proudly developed for TITS.Exchange.

TITS (Texas Institute of Technology & Science) TOKEN - A meme project that is launched fairly, with no dev wallets, no private sale, no presale, no whales, antibot, and antiwhale.

Project Telegram: https:/t.me/titstokenbsc
Project Twitter: https://twitter.com/titsexchange
...
abstract contract Auth {
    ...
    /**
     * Transfer ownership to new address. Caller must be owner. Leaves old owner authorized - CRYPTOTEEKA
     */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(address(this));
...
contract TITSEXCHANGE is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = address(this);
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TITS (Texas Institute of Technology & Science) TOKEN | TITS.EXCHANGE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x580FE4A0C140E7c6a6c38f1f4C2813e0969ea9a1;
