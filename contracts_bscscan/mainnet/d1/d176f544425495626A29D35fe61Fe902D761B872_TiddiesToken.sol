...
contract TiddiesToken is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "TiddiesToken";
    string constant _symbol = "TIDDIES";
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator, uint256 _totalSellFee) external authorizedFor(Permission.AdjustContractVariables) {
        ...
        require(totalBuyFee <= feeDenominator / 2, "Buy fee too high");
        require(totalSellFee <= feeDenominator / 2, "Sell fee too high");
    }
