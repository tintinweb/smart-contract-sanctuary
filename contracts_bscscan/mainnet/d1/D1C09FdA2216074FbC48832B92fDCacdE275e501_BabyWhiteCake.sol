...
Max Transaction: 2,000,000 (0.2%)

Telegram group:  https://t.me/BabyWhiteCake
Twitter: https://twitter.com/Baby_White_Cake
...
contract BabyWhiteCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyWhiteCake";
    string constant _symbol = "BabyWhiteCake";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 500; //0.2% of total supply
    uint256 public _maxWallet = (_totalSupply * 1) / 50; //2% of total supply
