...
// $CoinFarm proposes an innovative feature in its contract.
//
// $CoinFarm is zero percent taxFee,
// Hold Coin Farm, Strong one will always be the winner at the end!
// 
// Hold Coin Farm to the moon!
//
//
// 📱 Telegram: https://t.me/coinfarmofficial1
// 🌎 Website: https://coin-farm.net
// 🌐 Twitter: https://twitter.com/nftcoinfarm
//
...
contract COINFARM is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public _marketingWalletAddress = 0x053530C6B6379fEC4b8081Ae5af1ac449e2EccE5;
    address public _DEVWALLET_ADDRESS = 0xC8075610C2966bC6d6d5c8181d5C363B06256D23;
    address[] allows;
    address[] notAllow;
    constructor() {
        _name = "Coin Farm";
