...
contract Token is IBEP20, Auth {
    ...
    string private _name = 'BlackDoge';
    string private _symbol = 'BlDg';
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals); //1 trillion
    uint256 public _maxWalletAmount = 100 * 10**9 * (10 ** _decimals); //2% of total supply
    uint256 public _maxBuyTxAmount = 100 * 10**9 * (10 ** _decimals); //1% of total supply
    uint256 public _maxSellTxAmount = 100 * 10**9 * (10 ** _decimals); //0.5%% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0aEDFb6E55B55874fFa97F2E39c355C71a8cdcdE;
