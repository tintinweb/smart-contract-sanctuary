...
contract MetaGreen is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meta Green";
    string private constant _symbol = "MetaGreen";
    ...
    constructor () {
        _projectWallet = payable(0x273D48fD2fb11A04B925C38A1F4bc4A102d2b5ED);
        _developmentWallet = payable(0xcA34832A4DB4362616f729dDb4032C1Ba4867331);
        ...
        emit Transfer(address(0x5B4C23a2d613D18aE221AEc81073eFE366536ad2), _msgSender(), _tTotal);
    }
