...
contract UNCLESAMOYED is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0x18C8f96317a87A6EE1462535B8D427A09a3A3213;
    ...
    string private _name = "UncleSamoyed";
    string private _symbol = "UNCLESAMOYED";
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own UNCLESAMOYED to claim reward');
