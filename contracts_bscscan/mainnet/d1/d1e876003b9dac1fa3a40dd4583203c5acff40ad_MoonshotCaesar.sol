...
/**
   ...
   Welcome to MoonshotCaesar
   
   This is a community token. If you want to create a telegram I suggest to name it to @MoonshotCaesarBSC
   ...
   I will lock lp for 1 month (31 days)
   I will renounce the ownership to burn addresses to transfer #MoonShotCaesar to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make #MoonShotCaesar 10000X? 
...
contract MoonshotCaesar is Context, IERC20, Ownable {
    ...
    string private _name = "MoonshotCaesar";
    string private _symbol = "MshotCaesar";
