...
contract GameOfCoins is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 2 * 10**9 * 10**9; //billions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Game of Coins";
    ...
    address public devWallet = 0x0F1af072dD0e3278dB0f795c870A55063e86A42C; 
    ...
    uint256 public _maxTxAmount = 5 * 10**7 * 10**9; //5% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**7 * 10**9;
    uint256 public _maxWalletToken = 10 * 10**7 * 10**9; //10% of total supply
