...
contract PandaVotesDAI {

  function name() public pure returns(string memory) { return "PandaVotesDAI"; }
  function symbol() public pure returns(string memory) { return "PandaVotesDAI"; }
  function decimals() public pure returns(uint8) { return 18; }  

  function totalSupply() public view returns (uint256) {
  IPair pair1 = IPair(0x7C8BA77476A3E713b27E7c1450227A0fF3411616);
  ...
  function balanceOf(address owner) public view returns (uint256) {
    ...
    // LP pair2
    (uint256 lp1_totalpandaA, uint256 lp1_totalpandaB,) = pair1.getReserves();
    (uint256 lp1_userpanda,) = chef.userInfo(4, owner);
