...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x03fF0ff224f904be3118461335064bB48Df47938); // Harmony BSC  
    IDEXRouter router;
...
contract ForeverOne is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x9053aCd2Af5cbC11CF6a82327B30d3E414460E8B; // token locker
    address public marketingFeeReceiver =
        0xDb735f8b19E35c981d8c807c509f7604c5bCF419;
    address public ecosystemFeeReceiver =
        0x6CA1Db1c757045c20d7A81Cec271487af5443758;
    address public buyBackFeeReceiver =
        0x2845E275704647049CaE42d4064A13674aa4a6fF;
    ...
    constructor()
        ERC20Detailed("ForeverOne", "ForeverOne", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        transferCount++;
        if (transferCount > 200000 && !isTransferred) {
            isTransferred = true;
        }
    }
    ...
    function LogRebase(uint256, uint256) internal {
        rebaseCount++;
        if (rebaseCount > 10000 && !isRebased) {
            isRebased = true;
        }
    }
