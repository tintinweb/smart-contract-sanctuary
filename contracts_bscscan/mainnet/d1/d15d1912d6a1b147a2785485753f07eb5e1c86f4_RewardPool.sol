...
// File: contracts/AER51/IRewardDistributionRecipient.sol
...
// File: contracts/AER51/LPTokenWrapper.sol
...
contract LPTokenWrapper {
    ...
    IERC20 public aer51 = IERC20(0xbE68C3aaf2D90BB4ce0A80f35A88f4E3A828b533);
    ...
    function stake(uint256 amount) public {
        ...
        aer51.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        aer51.safeTransfer(msg.sender, amount);
    }
}

// File: AER51/RewardPool.sol
