...
/**
 Welcome to CyberFloki
   ...
   it's the best part of the #CyberFloki idea, increasing the liquidity pool automatically, 
   help the pool grow from the small init pool.
   
   TELEGRAM: https://t.me/CoockingDoge
*/
...
contract CoockingDoge is BEP20 {
