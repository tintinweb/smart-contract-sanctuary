...
/*
The Smartest Pup Of Them All!
With the launch of the new Ethereum fork, what better time is there for a ETH reward coin? 
You don’t need to do anything to claim your rewards, simply buy and hold ETH Pup in your wallet. 
Your Ethereum rewards will automatically be deposited into your wallet every 60 mins. 
Make sure you use the Ethereum Bep 20 token address to track your rewards.
...
contract ETHPup is IBEP20, Auth { // TO-DO change contract name
    using SafeMath for uint256;
    ...
    address public externalAddress = 0xA7C2B9Dd07280Fa0B7edCc5a9A385D7788bAf0e5; //TO-DO change external address
    address public autoLiquidityReceiver = 0xe07bf0C56A0A7EA7D03aB4C13d40F665D23780A5; //TO-DO change liquidty owner address

    string constant _name = "ETH Pup";
    string constant _symbol = "ETHPup";
    ...
    uint256 public _maxTokensPerAddress         = 100000000 * 10**6 * 10**_decimals; // Max number of tokens that an address can hold
