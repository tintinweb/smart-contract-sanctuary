...
/**
New Year Paris (BINANCE SMART CHAIN)
...
contract NewYearParis is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public HouseAddress = payable(0x94ABfAdbE65071269Dc7d039a497170326B42D23); // House Wallet Address
    ...
    string private _name = "New Year Paris";
    string private _symbol = "NYPARIS";
