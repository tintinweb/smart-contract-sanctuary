...
contract Collection is ERC721, Ownable {
    ...
    constructor(
        ...
        uint256 saleStart,
        uint256 mintPrice,
        uint _maxTokenPurchase
    ) ERC721(name, symbol) {
        MAX_NFTS = maxNftSupply;
        REVEAL_TIMESTAMP = saleStart + (86400 * 9);
        price = mintPrice;
        _maxTokenPurchase = maxTokenPurchase;
    }
    ...
    */
    function mintToken(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_NFTS, "Purchase exceeds max supply");
