...
contract TestBratan is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TestBratan";
    string constant _symbol = "BRATAN";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1000; // 1% of supply
    bool inSwap;
