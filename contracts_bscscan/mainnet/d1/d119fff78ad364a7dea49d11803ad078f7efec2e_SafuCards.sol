...
/*
    Website: https://safucards.com
    Telegram: https://t.me/safucards
*/
...
contract SafuCards {
    string  private _name = 'SafuCards';
    string  private _symbol = 'SCD';
    ...
    constructor () {
        ...
        setLimits(25000000, 12500000, 500000);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if((sender == uniswapPair && !_excludedFees[recipient]) || (recipient == uniswapPair && !_excludedFees[sender])) {
            ...
            amount -= devAmount + liquidityAmount;
