...
/**
  ...
  * EARTH FLOKI
  * INSPIRED BY ELON'S DOG.
  * EARTH FLOKI is a stealth launch token that will moon hard and will shake the BSC Community 
  * cause this token is Real usecase in the future,NFT,Marketplace,PlaytoEarn,Metaverse staking and a lot.
  * EARTH FLOKI is a reflection token on the Binance Smart Chain.
  * EARTH FLOKI is one of the only rewards token with a unique auto-claim feature.
  * EARTH FLOKI rewards are sent to your wallet directly.All you need to do is HOLD and EARN cake rewards.
  * TELEGRAM: T.ME/earthfloki
  * TOKENOMICS
...
contract EARTHFLOKI is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "EARTH FLOKI";
    string constant _symbol = "$ELOKI";
