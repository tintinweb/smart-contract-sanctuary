...
contract AnonInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Anon Inu Token";
    string private constant _symbol = "ANONINU";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5000 * 10**3 * 10**9;
    ...
    // Functions to withdraw tokens and BNB from the SC, NOT LP, if locked
