...
/*
 ...
 /   _____//  |_|__| ____ |  | _____.__. \______   \_____/  |_ 
 \_____  \\   __\  |/    \|  |/ <   |  |  |     ___/  _ \   __\
 /        \|  | |  |   |  \    < \___  |  |    |  (  <_> )  |  
/_______  /|__| |__|___|  /__|_ \/ ____|  |____|   \____/|__|  
        \/              \/     \/\/                            
!!!Selling open for 3 minutes every 30 minutes!!!

Prize pool claimable every 24 hours
If you sell you forfeit all unclaimed prizes!

Telegram: t.me/stinkypot

Supply: 1,000,000
Initial Max Txn: 10,000
Initial Max Wallet: 20,000
Claims can be done through BSCScan, purchasing 1 token (don't sell), or the dApp (when available)
*/
...
contract StinkyPot is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000 *  10**1;
    ...
    /* Dividend tracker = 0x3ee2200efb3400fabb9aacf31297cbdd1d435d47
