...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xaA767544f9DC01475083fC14bddb4Fa11812dA72;
...
contract NewMoon is Context, IERC20, Ownable {
    ...
    string private _name = "NewMoon Token";
   ...
   function GetexcludeLockState(address  ExcludelAddr) public returns(bool){
   ...
   function GetUnLockTime(address ExcludelAddr) public  returns(uint256) {
       return LockTimeList[ExcludelAddr];
    }

   function GetCurTime() public  returns(uint256) {
