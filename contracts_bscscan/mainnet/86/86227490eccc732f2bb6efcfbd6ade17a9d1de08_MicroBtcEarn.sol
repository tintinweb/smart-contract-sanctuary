...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SM = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
contract MicroBtcEarn is IBEP20, Auth {
    using SafeMath for uint256;


    address SM = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MicroBtcEarn";
    string constant _symbol = "MicroEarn";
