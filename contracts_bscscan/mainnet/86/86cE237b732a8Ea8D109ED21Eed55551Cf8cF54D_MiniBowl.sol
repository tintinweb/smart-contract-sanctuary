...
/*	
	...
	MINIBOWL - bringing the Class A Action from the stadium straight to your portfolio.
	The start of the newest trend bridging Sporting Events with Crypto Tokens,
	you can bet your bottom bnb this is the one to be in on.

	Twitter: https://twitter.com/minibowlbsc
	Website: https://minibowl.football/
...
contract MiniBowl is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x929079b42DbB78C20A45e22380Aaa7a27c2b0Fad;
    ...
    string private _name = "MiniBowl";
    string private _symbol = "MiniBowl";
