...
Easy 100x with this token, lets mars!!.
Stealth Launch ~ t.me/minidogestro
...
contract MiniDogeAstro is Context, IERC20, Owwnable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf2423B397Ae84eA9dF91Db3CcAC8fDe4b2A0a074); // Marketing Address
    ...
    string private _name = "MiniDogeAstro";
    string private _symbol = "mDogeStro";
