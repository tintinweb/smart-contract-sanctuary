...
/**
   ...
   Welcome to BinanceSafeMoon
   
   This is a community token. If you want to create a telegram I suggest to name it to @BinanceSafeMoonBsc
   ...
   I will renounce the ownership to burn addresses to transfer #BinanceSafeMoon to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 30% total supply to the pool
   Can you make #BinanceSafeMoon 10000X? 
   ...
   it's the best part of the #BinanceSafeMoon idea, increasing the liquidity pool automatically, 
...
contract BinanceSafeMoon  is Context, IERC20, Ownable {
    ...
    string private _name = "Binance SafeMoon";
