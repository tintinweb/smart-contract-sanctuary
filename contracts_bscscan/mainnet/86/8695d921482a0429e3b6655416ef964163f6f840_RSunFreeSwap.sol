...
contract RSunFreeSwap is RSunAuth, IERC721Receiver {
    ...
    address public wbnbAdr = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public rsunAdr = 0x917841c010b3d86ED886F36F2C9807E07a2e3093;
    address public nftAdr = 0xfC21dB4a88075d88c87BE662A0f17cF5167a1Ea7;

    address public routerAdr = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public distAdr = 0x10d06826ba9f6791abcECb190Bd4782264C1A86d;
    ...
    function swapBNBForRsunWithoutFees(uint nftId) external payable {
        ...
        require(msg.value <= bnbSwappablePerNFT, "Not able to swap this much BNB for RSUN without fees at once");
