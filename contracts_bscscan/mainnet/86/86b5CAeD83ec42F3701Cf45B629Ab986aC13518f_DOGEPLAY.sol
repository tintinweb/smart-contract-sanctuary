...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 1500000 * (10**9); // user must hold 1500000 token
...
contract DOGEPLAY is
    BASEToken("DOGE PLAY https://dogeplay.me", "DOGEP", 150000000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
