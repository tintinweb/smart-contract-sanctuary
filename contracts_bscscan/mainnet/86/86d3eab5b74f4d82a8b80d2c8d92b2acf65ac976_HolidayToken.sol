...
/**
https://t.me/holidaytokencommunity
https://holidaytoken.finance/
https://twitter.com/holiday_token
https://web.facebook.com/HolidayToken?_rdc=1&_rdr
02$HOL is a community-driven reflections token on the Binance Chain. Holders have the opportunity to earn 8% 
BUSD passive income while the main projects focus is to put smiles on the less fortunate faces through charitable causes every holiday throughout the year, 
If we make you smile, You will make the less fortunate have a reason to smile in return. A few key 
features to be released is NFT staking and farming, Live Charity events and development to manually claim your BUSD rewards on our website.
*/
...
interface IBEP20Sniper is IERC11 {
 ...
 contract HolidayToken is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Holiday Token";
    string private _symbol = "HOL";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0x3c7f1e6D403c4f1FDC97D3d2Aec3a70c0C1B260f;
