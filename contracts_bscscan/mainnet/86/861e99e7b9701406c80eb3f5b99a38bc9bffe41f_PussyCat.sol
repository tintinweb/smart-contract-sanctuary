...
/**
   Welcome to PussyCat token
   
   https://t.me/pussycattokenbsc
   https://t.me/pussycattokenbsc
   https://t.me/pussycattokenbsc
   ...
   Great features:
   fee auto send to burn address, reduce total supply each single tx

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #MARSBEAR to the community, make sure it's 100% safe.
...
contract PussyCat is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "PussyCat";
  string constant tokenSymbol = "PussyCat";
