...
contract MagicAndCats is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 37 * 10**6 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'Magic&Cats';
    ...
    function excludeAccount(address account) external onlyOwner() {
        //require(account !=0x034d9AFa60f61d7727F6f2AEE7c2A56DF598bff7, 'We can not exclude Uniswap router.');
