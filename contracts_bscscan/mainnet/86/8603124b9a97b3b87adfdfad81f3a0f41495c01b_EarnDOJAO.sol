...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOJAO = IBEP20(0x49c78bE1F97884382693F9364a0BD09534ef906f);
...
contract EarnDOJAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "teste06";
    string constant _symbol = "teste06";
    ...
    uint256 public swapThreshold = _totalSupply / 40; // 5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xB9CcfBc23FaFda8AcF03B5f18004e7e607f2DE1c;
