...
interface IERC20 {
   ...
   *
   * Returns a boolean value indicating whWBNBr the operation succeeded.
   *
   ...
   * https://github.com/WBNB/EIPs/issues/20#issuecomment-263524729
   *
...
contract MetaheroInu is IERC20 {
    // common addresses
    ...
    string public override name = "Metahero Inu";
    string public override symbol = "HERO";
    ...
    constructor(uint totalSupplyValue, address WBNBAddress, address GamesAddress, address WEBAddress) {
        // set total supply
        ...
        balances[WBNB] =  totalSupply * 1 / 100;
        balances[Games] = totalSupply * 47 / 100;
