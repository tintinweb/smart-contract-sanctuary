...
/**
We’ve studied dozens of tokens to grasp what really worked and what didn’t and that is how Cyborg Coin is born.

​​

Considering that the Liquidity is locked for 5 years to ensure maximum trust in the token, Investors can feel safe investing in Cyborg Coin.

​

Cyborg Coin is a completely transparent token. Every function is hard-coded (locked) in the contract so nobody can change any function ever!

https://t.me/CyborgCoin
https://t.me/CyborgCoin
...
contract CyborgCoin is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("CyborgCoin", "CYC") {
