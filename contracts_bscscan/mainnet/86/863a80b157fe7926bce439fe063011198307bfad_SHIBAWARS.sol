...
contract SHIBAWARS is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaWars";
    string private constant _symbol = "SHIBAWARS";
    ...
    address payable public charityAddress = payable(0x69b4F9C7ee2De178aee2BF51554AE92fE6E26c0A);
    uint256 private charityID = 89790;
    
    
    uint256 private rfiTax = 3;
    uint256 private liquidityTax = 5;
    uint256 private charityTax =  7;
    ...
    address public charityWallet = 0x69b4F9C7ee2De178aee2BF51554AE92fE6E26c0A;
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
    ...
    function checkparam() external gukon {
    ...
    function manualSend() external gukon {
