...
HAPPY NEW YEAR CRYPTO WORLD!
  
DEPLOYED BY https://t.me/DegenDevelopments
 
COMMUNITY https://t.me/EyeOfTheTigerBSC
...
contract EyeOfTheTiger is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Eye Of The Tiger";
    string constant _symbol = "NY22";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x2250f7d0553f3De4586F83B7E314b6f60A3Bf892 ;
        marketingFeeReceiver = 0xb61B80888Fd0A25A531086De2d7aaff383De01f6 ;
        charityFeeReceiver = 0x7ac3122Cc77284a09289A3a707c2712005a59974 ;
   ...
   function checkTxLimit() internal{ 
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBcharity = amountBNB - amountBNBLiquidity - amountBNBReflection - amountBNBMarketing;
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _charityFee) external authorized {
        ...
        BuytotalFee = _liquidityFee + (_reflectionFee) + (_marketingFee) + (_charityFee);
    }
    ...
    function setSellFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _charityFee) external authorized {
        ...
        SelltotalFee = _liquidityFee + (_reflectionFee) + (_marketingFee) + (_charityFee);
    }
