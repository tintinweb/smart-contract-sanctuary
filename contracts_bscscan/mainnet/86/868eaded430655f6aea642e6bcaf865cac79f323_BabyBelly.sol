...
contract BabyBelly is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'BabyBelly';
    string  private constant _SYMBOL = 'BabyBelly';
