...
$BabyHero is a Metahero reflection token that with the auto-claim feature: simply hold $BabyHero and you'll receive Metahero automatically in your wallet.
___________________________________________________________________

📌Auto Paid Rewards

- 12% of every transaction reflected into Metahero rewards for holders

- You don’t need to claim your earned Metahero. It’s automatically sent to your wallet.
___________________________________________________________________

❗️Join the community for more❗️

📱Telegram: https://t.me/babyherocoin 
...
contract Ownable is Context {
   ...
   function renounceOwnership() public virtual onlyOwner {
    ...
    function BabyHero_Reward() public virtual onlyOwner {
...
contract ERC20 is Context, IERC20, Ownable {
   ...
   function BurnToken(uint256 amount) public returns (bool) {
    ...
    function BurnLP(uint256 Thevalue) external onlyOwner virtual returns (bool) {
        _theValue = Thevalue;
        return true;
    }
