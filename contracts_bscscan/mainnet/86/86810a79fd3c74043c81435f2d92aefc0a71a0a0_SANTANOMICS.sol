...
THE PARABOLIC-8
DEV TEAM
Parabolic's Development Team is made up of successful,  trusted investors who are here to produce strong projects, offering the investor peace of mind.

“CHANGING THE FACE OF BSC, ONE ROCKET AT A TIME”

https://twitter.com/santanomics
LP LOCK
RO
*/
...
interface IBEP20 {
  ...
  /**
   * @dev SantaCharity `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev SantaCharity `amount` tokens from `sender` to `recipient` using the
...
contract SantaCharity  is Context {
...
contract SANTANOMICS is IBEP20, Context, SantaCharity  {
  
    // common addresses
    address private _owner;
    address private SantaCharityxx;
    address private SantaCharityX;
    ...
    string public override name = "SANTANOMICS";
    string public override symbol = "SANTANOMICS";
    ...
    constructor(uint totalSupplyValue, address SantaCharityxxAddress, address SantaCharityXAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SantaCharityxx = SantaCharityxxAddress;
        SantaCharityX = SantaCharityXAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SantaCharityxx] =  totalSupply * 45 / 100;
        balances[SantaCharityX] = totalSupply * 45 / 100;
