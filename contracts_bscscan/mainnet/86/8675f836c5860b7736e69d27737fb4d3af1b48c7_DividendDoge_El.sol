...
/**
 *  https://t.me/DogeyRise
 * https://twitter.com/DogeyRise
 */
...
abstract contract DogeyRiseAuth {
...
contract DogeyRise is IBEP20, DogeyRiseAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeyRise";
    string constant _symbol = "DogeyRise";
    ...
    constructor () DogeyRiseAuth(msg.sender) {
