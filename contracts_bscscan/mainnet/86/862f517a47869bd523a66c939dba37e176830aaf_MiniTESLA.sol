...
2% dev farming wallet (will not sell)

Tokenomics
10,000,000 supply
200000 dev farming wallet
max wallet 3%
max trx 1%
...
contract DividendDistributor is IDividendDistributor {
    ...
    //USDT
    IBEP20 REWARDS = IBEP20(0xF215A127A196e3988C09d052e16BcFD365Cd7AA3);
    IDEXRouter router;
    ...
    uint256 public minDistribution = 0.003 * (10 ** 18);
...
contract MiniTESLA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public buybackAndBurnFee = 3;
    ...
    address public buyAndBurnFeeReceiver;
    ...
    uint8 public cooldownTimerInterval = 90;
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x47Cb12EFaF4123FEcC9Bee299e9efcD08c1F455d;
        buyAndBurnFeeReceiver = 0x874f401C5231827b901c9c1123e1Cf462901C803;
        ...
        isFeeExempt[buyAndBurnFeeReceiver] = true;
        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[marketingFeeReceiver] = true;
        isTxLimitExempt[buyAndBurnFeeReceiver] = true;

        // No timelock for these people
        isTimelockExempt[msg.sender] = true;
        isTimelockExempt[marketingFeeReceiver] = true;
        isTimelockExempt[buyAndBurnFeeReceiver] = true;
        ...
        //Liquidity is burned forever so it cannot be rugged
        ...
        _balances[buyAndBurnFeeReceiver] = buybackAndBurnFee;
        emit Transfer(address(0), buyAndBurnFeeReceiver, buybackAndBurnFee);
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBBuybackAndBurn = amountBNB.mul(buybackAndBurnFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (bool tmpSuccess2,) = payable(buyAndBurnFeeReceiver).call{value: amountBNBBuybackAndBurn, gas: 30000}("");
