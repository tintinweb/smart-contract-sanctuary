...
contract MINIBNB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6BB6b12d0E092Fc0216A2EA70E9E2407E3072018); // Marketing Address
    address payable public airdropAddress = payable(0x75aE6e9a4384DB42FE4Bc3a878768d3424F5C0ED); // Airdrop Address
    ...
    string private _name = "LUNCHTIME";
    string private _symbol = "LTIME";
