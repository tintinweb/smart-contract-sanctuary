...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract BUSDFloki is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = " BUSD Floki";
    string constant _symbol = "BUSDF";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xA7952B359bc1cb3267783eF38Cb28Fa2279213ca;
