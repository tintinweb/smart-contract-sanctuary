...
//Hello my Name is Bluestone and I'm a well known develepor! My last projects did well over some very good x's. 700x ! 
...
contract KishuBoy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KishuBoy";
    string constant _symbol = "KishuBoy";
	...
	function KishuBoyFRSniperBan(address user, bool banned) external authorized {
		if (banned) {
    ...
    function KishuBoyFRsetSwapBackSettings(bool _enabled, uint256 _amount) external authorized {
