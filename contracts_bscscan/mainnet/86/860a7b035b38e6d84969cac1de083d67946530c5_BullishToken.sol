...
-🐂ᴛʜɪs ᴛᴏᴋᴇɴ ᴡᴀs ᴄʀᴇᴀᴛᴇᴅ ᴡɪᴛʜ ᴀ ᴅᴇғʟᴀᴛɪᴏɴᴀʀʏ sʏsᴛᴇᴍ ᴡʜɪᴄʜ ʟɪᴍɪᴛs ɪᴛs ᴜɴɪᴛs, ᴛᴏ ᴍᴀᴋᴇ ʏᴏᴜʀ ᴄᴏɪɴs ɪɴᴄʀᴇᴀsɪɴɢʟʏ sᴄᴀʀᴄᴇ ᴀɴᴅ ᴡᴏʀᴛʜ ᴍᴏʀᴇ🐂

-ɪᴛs sʏsᴛᴇᴍ ɪs ᴅɪᴠɪᴅᴇᴅ ɪɴᴛᴏ 5% ᴀᴜᴛᴏ ʙᴜʀɴs🔥, 3% ᴍᴀʀᴋᴇᴛɪɴɢ ᴀɴᴅ ɴᴇᴛᴡᴏʀᴋs👨🏻‍💻, 3% ғᴏʀ ᴛᴏᴋᴇɴ ʟɪǫᴜɪᴅɪᴛʏ♾️. 

-ᴡᴇ ʜᴀᴠᴇ ᴀɴᴛɪ ᴡʜᴀʟᴇ sʏsᴛᴇᴍ🐋, ᴀɴᴛɪ ʙᴏᴛs⚙️ ᴀɴᴅ ʟᴏᴄᴋᴇᴅ ʟɪǫᴜɪᴅɪᴛʏ ғᴏʀ ʏᴏᴜʀ sᴇᴄᴜʀɪᴛʏ⛓️

-ᴛᴇᴀᴍ ᴀɴᴅ ᴅᴇᴠ ᴡɪᴛʜ ᴛʜᴇ ᴠᴄ ᴏᴘᴇɴ🤝🔊

-ᴛᴇʟᴇɢʀᴀᴍ📱: @Bullishfinance 
...
contract BullishToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x1AE27E2587ffF70639a3F719497aCAdDB5fA6DaC); // Marketing Address
    address payable public devWalletAddress = payable(0xBdE7E2cd4E1Fc99C8CAc816037b1958079e94440); // Dev Address
    ...
    string private _name = "Bullish Token";
    string private _symbol = "ABullish Token";
