...
contract MarsDogeToken is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 163000 * 10**6 * 10**18;
    ...
    uint256 public _maxTxAmount = 815 * 10**6 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 815 * 10**6 * 10**18;
