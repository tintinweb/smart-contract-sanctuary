 ...
 *  Prize and buy back wallet = 0x31eb2937e76C33F626B6029708B0b6d96F14Df9B
 *
 */
...
contract Lottobull is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES *********************************
    string private _name = "Lotto Bull";                                                   // name
    string private _symbol = "LBT";                                                    // symbol
    uint256 private _tTotal = 100000000000 * 10**uint256(_decimals);                        // total supply
    uint256 public _taxFee = 4;                                                          // % to holders
    uint256 public _swapAndLiquifyFee = 5;                                               // % to swap and add to liquidity
