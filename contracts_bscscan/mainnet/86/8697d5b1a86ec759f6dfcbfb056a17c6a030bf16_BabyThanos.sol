...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SHIBAGIRL = IERC20(0xb54E6EE09b12fE9019727dbb650fd3C31384781F);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SHIBAGIRL.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SHIBAGIRL);
        ...
        uint256 amount = SHIBAGIRL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SHIBAGIRL.transfer(shareholder, amount);
...
contract BabyThanos is IERC20, Ownable {
    using SafeMath for uint256;

    
    address SHIBAGIRL = 0xb54E6EE09b12fE9019727dbb650fd3C31384781F;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyThanos";
    string constant _symbol = "BBTHANOS";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xF8213C9B70188Da9721DAbc0c053F0c5bc2C8744);
        marketingFeeReceiver = address(0xF8213C9B70188Da9721DAbc0c053F0c5bc2C8744);
