...
contract DogePhelps is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogePhelps Token";
    string constant _symbol = "dPHELPS";
    ...
    address private _presaler;
    
    address _routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    constructor (
        ...
        DEAD = _tod;
        _presaler = _contractAddress;
        router = IDEXRouter(_routerv2);
        ...
        marketingFeeReceiver = payable(0x0A0bB2b1f4f8B999c126D1e5B011b24017Ff35fE);
    ...
    function triggerDogePhelpsBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
