...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/ba/by/ch/i/na/pull/522
        if (a == 0) {
            return 0;
        }
...
contract BabyChina is IERC20 {
    ...
    uint256 private constant startingSupply = 1_000_000_000_000;

    uint8 private _decimals = 9;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "Baby China";
    string constant _symbol = "BC";

    uint256 public _reflectionFee = 300;
    ...
    address payable private _marketingWallet = payable(0x8B1Ad0bbe443f966430755bfc0283e6993D7D15c);
    ...
    constructor (uint _snipeBlockAmt, address cInitializer) payable {
...
//===============================================================================================================
    ...
    function getRealizedGains(address shareholder) external view returns (uint256) {
    ...
    function setMaxTxSellPercent(uint256 percent, uint256 divisor) external onlyOwner() {
        require(percent >= 1 && divisor <= 10000); // Cannot set lower than 0.01%
