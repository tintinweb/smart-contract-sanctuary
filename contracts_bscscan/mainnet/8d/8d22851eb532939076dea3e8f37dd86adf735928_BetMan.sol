...
// Main Contract
contract BetMan is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable private buybackWallet = payable(address(0xcb421446D127fA4DdEb4785204B5d8bb335EF4B2));
    address payable public marketingFeeWallet = payable(0x8e56bBdE6775B2762A485FD483242dd1a8759EC6);
    ...
    constructor() public ERC20("BetMan", "BET") {
       ...
       address _liquidityReceiver = 0x8e56bBdE6775B2762A485FD483242dd1a8759EC6;
   ...
   function setMaxToken(uint256 maxBuy, uint256 maxSell, uint256, uint256 maxWallet) external onlyOwner {
  	    require(maxBuy > 3000); require(maxSell > 3000); require(maxWallet > 3000);
  	    maxBuyTransactionAmount = maxBuy * (10**18);
