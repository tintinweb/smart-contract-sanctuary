...
/**
     ...
     Welcome to Shibasaur World!
  
Fine Contract & Market Optomization by NezDeFi - built for the community.
...
contract Shibasaur is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xB74710Be9efc5f3Da2435104295Ec9E1E65A32A6); // Marketing Address
    ...
    string private _symbol = "SHIBASAUR";
    ...
    constructor () {
        ...
        // Testnet Router IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
