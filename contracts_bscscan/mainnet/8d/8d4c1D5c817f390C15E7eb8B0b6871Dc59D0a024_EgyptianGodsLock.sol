...
contract EgyptianGodsLock is LockContract {
    ...
    function egyptianGodsLock() public onlyOwner {
        deposit(token, 9000000 ether, 36, 0x6939BB494603e35C1477b46B64CbF1E9F5730636);
        deposit(token, 2700000 ether, 31, 0x4C7694D19A995948aD9eB855BBE56b3623124577);
        deposit(token, 2000000 ether, 29, 0xd78C4a21aD340EE75302D1fCA5232c0d2DeF3D1e);
        deposit(token, 2000000 ether, 29, 0x6f773df7A3f9a859ccaE58B90C3Ec0fFB8c17617);
        deposit(token, 1200000 ether, 30, 0xFDDEB4115340499315553a332C340AA960e8409E);
        deposit(token, 100000 ether, 71, 0x93D3F96Ca3BA793320182dA174B41eC2cDaA4EBB);
        deposit(token, 2000000 ether, 364, 0x756297F990A4f81509908FdB79313249a60875C7);
        deposit(token, 1000000 ether, 364, 0xB8C314f0A84772DE3832DdCd321ee81cEd4CdfeB);
    }
