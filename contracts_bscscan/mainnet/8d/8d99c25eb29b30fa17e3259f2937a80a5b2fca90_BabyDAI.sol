...
// SPDX-License-Identifier: MIT
    ...
    contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
      ...
      address public immutable CAKE = address(0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3); 
    ...
    contract BabyDAI is ERC20, Ownable {
        ...
        uint256 public maxBuy = 100000000000 * (1e18);
        uint256 public maxSell = 100000000000 * (1e18);
        uint256 public maxWallet = 100000000000 * (1e18);
        ...
        address public _marketingWalletAddress = address(0x77433a717D2f3c4a08Bf6ce30709eB52E7c70355); // marketing wallet
        address public _devWalletAddress = address(0x948898cB27Cc9a42F981eD48AE5971005fc43F48); // fee for contract development
        address public _recoveryAddress = address(0x948898cB27Cc9a42F981eD48AE5971005fc43F48); //  Recovery Address (finalized)
        ...
        constructor() ERC20("BabyDAI", "BDAI") {
        ...
        function airdropToWallets(address[] memory airdropWallets, uint256[] memory amount) external onlyOwner() {
            require(airdropWallets.length == amount.length, "BabyDAI: airdropToWallets:: Arrays must be the same length");
            require(airdropWallets.length < 40, "BabyDAI: airdropToWallets:: Cannot airdrop more than 40 wallets due to gas limit restrictions");
    ...
    contract BabyDAIDividendTracker is Ownable, DividendPayingToken {
        using SafeMath for uint256;
        using SafeMathInt for int256;
        ...
        constructor() DividendPayingToken("BabyDAI_Dividend_Tracker", "BabyDAI_Dividend_Tracker") {
        	claimWait = 1200;
            minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
        }
    
        function _transfer(address, address, uint256) pure internal override {
            require(false, "BabyDAI_Dividend_Tracker: No transfers allowed");
        }
    
        function withdrawDividend() pure public override {
            require(false, "BabyDAI_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyDAI contract.");
        }
        ...
        function updateClaimWait(uint256 newClaimWait) external onlyOwner {
            require(newClaimWait >= 1200 && newClaimWait <= 86400, "BabyDAI_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
