...
contract BABYBENDER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Bender";
    string constant _symbol = "BABYBENDER";
    ...
    address public Owner=0xBe6Db37F3B7569fbFdE9ce11B4a52cC3487Ae190; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x73a33a61951884fa686266255a5DebB64FCDe16D;
