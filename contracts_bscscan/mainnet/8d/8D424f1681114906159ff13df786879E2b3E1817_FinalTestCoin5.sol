...
contract FinalTestCoin5 is Context, IBEP20, Ownable {
    ...
    string private constant _name = "FinalTestCoin4 v25";
    string private constant _symbol = "FTC4";
    ...
    /// This will allow to rescue TCG2 fees.
    function rescueTCG2FromContract(uint256 amount) external onlyOwner {
