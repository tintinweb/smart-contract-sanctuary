...
contract KoInu is BEP20, Ownable {
    ...
    string constant _symbol = "KOINU";
    uint8 constant _decimals = 9;

    // Supply
    uint256 _totalSupply = 7000000 * (10 ** _decimals); // 7,000,000 Tokens
    uint256 _burntSupply = (_totalSupply * 0) /100;
    uint256 _liqSupply = (_totalSupply - _burntSupply);

    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100;  // 1% MaxWallet - 70,000 Tokens
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100;  // 1% Max Transaction - 70,000 Tokens  
    ...
    // Fee receivers
    address private marketingFeeReceiver = 0x593B4Cc138b11929C205e431F2D500491c2F132a;
    address private buybackFeeReceiver = 0x6a5e423466067BF6Af2d1700624B82Ba6De2c59B;
