...
contract Onlyrise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc549d38745cd47be7E6477C463b8DB981E0D273d);
    address payable public teamAddress = payable(0xA0830065D6CF9f0692A3F4d05C91E710EE4a1E5a);
    ...
    string private _name = "onlyrise";
    string private _symbol = "oyr";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //Send to Marketing and Team address
