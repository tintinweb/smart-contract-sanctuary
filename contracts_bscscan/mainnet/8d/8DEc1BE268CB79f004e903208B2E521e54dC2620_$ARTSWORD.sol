...
contract $ARTSWORD is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "$ARTSWORD";
  string private _name = "ArtSword";
  address private newun;
  uint public Immortal = 200;
  uint public Legend = 100;
  uint public BNBReward = 12;
  uint public MaxReward = 800;
  uint public MarketingWallet = 4;
