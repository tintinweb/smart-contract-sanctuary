...
contract MiniHARE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8429DA388121DFE15104beb928A8932bBDB97E19); // Marketing Address
    ...
    string private _name = "MiniHARE";
    string private _symbol = "MiniHARE";
