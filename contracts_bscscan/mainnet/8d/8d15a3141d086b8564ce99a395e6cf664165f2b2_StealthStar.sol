...
/**
   ...
   #STEALTH STAR
NO RUG NO SCAM LP lOCK 3 DAYs -> EXTEND IF RUN GOOD!

   6% fee auto add to the liquidity pool to locked forever when selling
   4% fee auto distribute to all holders that means earning by holding!
   FUCK PAPERHANDS!
   slippage 15%
   
https://t.me/StealthStar
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x56FF728EFD10618FC0b8f79D714CAf096F00F6B5;
...
contract StealthStar is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xa49d912f2bA49D0faC856D8B72d472Be0eDa374D;
    ...
    string private _name = "StealthStar";
    string private _symbol = "StealthStar";
