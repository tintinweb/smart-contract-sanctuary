...
//ADA for mainnet: 0x3ee2200efb3400fabb9aacf31297cbdd1d435d47
//Mainnet Maincontract: 0x474599C4c9AFD3bF37EA6b7497609Fc0700FF077
...
contract ADAdistributor is IADAdistributor {
    ...
    uint256 public minPeriod = 12 hours; //displayed in seconds
    ...
    function startADAdistribution() external override initialization onlyMain {
    ...
    function migrate(address distributor) external override onlyMain {
        ADAdistributor adadistributor = ADAdistributor(distributor);
        require(!adadistributor.initialized());
        TOKEN.transfer(distributor, TOKEN.balanceOf(address(this)));
    }

    function setADAdistributionParameters(uint256 _minPeriod, uint256 _minDistribution, uint256 _gas) external override onlyMain {
