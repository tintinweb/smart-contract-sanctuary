...
/**
 ...
 ONLYCHEEMS!
 DOG TOKEN GIVING ETH REWARDS 
 AND GIVEAWAYS
 ON ITS MISSION TO THE MOON!

 2% ETH REWARDS TO HOLDERS
 4%  TAX TO LIQUIDITY
 4% MARKETING/GIVEAWAY TAX
 3% CHEEMSBUYBACK TAX
...
contract ONLYCHEEMS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ONLYCHEEMS";
    string constant _symbol = "ONLYCHEEMS";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x26adE4ccCa97A8957582481B1EfbA0d4bcB9d3f4;
