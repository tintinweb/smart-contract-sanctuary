...
contract SkullADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Skull ADA"; 
    string constant _symbol = "$SDA";
    ...
    address public marketingFeeReceiver = 0x8602cbE47C0e564f4CAA671d9b3fFEabb4701f8e;
