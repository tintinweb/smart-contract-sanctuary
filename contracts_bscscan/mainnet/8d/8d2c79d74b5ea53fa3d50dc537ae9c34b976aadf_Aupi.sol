...
/*
 *  Aupi TEST CONTRACT
*   THIS IS AUPI TERST CONTRACT, A TEST BEFORE OFFICIAL LAUNCH TO MAKE SURE THAT EVERYTHING WORKS!
*/
...
contract AupiDividendDistributor is IDividendDistributor {
...
contract Aupi is IBEP20, Auth {
    ...
    string constant _name = "Aupi";
    string constant _symbol = "Aupi";
    ...
    */
    ...
    AupiDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new AupiDividendDistributor(address(router));
    ...
    function setDistributor(AupiDividendDistributor dist)external authorized {
        distributor = dist;
    }
