...
//Just launched in FacebookShiba. We have created a token so rewarding for everyone.
//FacebookShiba Hold we will To the moon
//telegram : @FacebookShiba
...
contract FacebookShiba is Context, IERC20, Ownable {
    ...
    string private _name = "FacebookShiba";
    string private _symbol = "FacebookShiba";
