...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 THOREUM = IBEP20(0x580dE58c1BD593A43DaDcF0A739d504621817c05);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = THOREUM.balanceOf(address(this));
        ...
        uint256 amount = THOREUM.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            THOREUM.transfer(shareholder, amount);
...
contract BabyTHOREUM is IBEP20, Auth {
    using SafeMath for uint256;

    address THOREUM = 0x580dE58c1BD593A43DaDcF0A739d504621817c05;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyTHOREUM";
    string constant _symbol = "BabyTHOREUM";
