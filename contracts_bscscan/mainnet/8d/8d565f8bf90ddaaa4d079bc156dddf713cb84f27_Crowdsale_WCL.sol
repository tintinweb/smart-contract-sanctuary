...
pragma solidity ^0.5.5;
  ...
  * @title Crowdsale
  */
 contract Crowdsale_WCL is Crowdsale, Ownable {
     using SafeMath for uint256;
	 	 
     constructor(
         IERC20 token
     ) public Crowdsale(135, 0x8343803DCB28B7a71cC9e77Db1A0920333c6cECA, token) {
         transferOwnership(0x8343803DCB28B7a71cC9e77Db1A0920333c6cECA);
     } 
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        return weiAmount.mul(rate()).div(1000000000);  
    }
