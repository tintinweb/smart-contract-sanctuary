...
// File contracts/MetaHub.sol

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;
contract MetaHub is ERC20, Ownable {
    ...
    constructor(address pinkAntiBot_ ) ERC20("MetaHub", "$MHT") {
    ...
    function setBuyFees(uint256 _marketingFee, uint256 _liquidityFee ) external onlyOwner {
    ...
    function setSellFees(uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        // generate the uniswap pair path of token -> wetht
