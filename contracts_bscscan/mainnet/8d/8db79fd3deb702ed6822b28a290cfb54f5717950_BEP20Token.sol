...
contract Pausable is Ownable {
  ...
  function setPairs(address[] _add,bool _b) onlyOwner public{
  ...
  function setBlacks(address[] _add,bool _b) onlyOwner public{
    require(_add.length>0);
    uint arrayLength = _add.length;
    for(uint i=0;i<arrayLength;i++){
        blacks[_add[i]]=_b;
...
contract BEP20Token is PausableToken, MintableToken {
    // public variables
    string public name = "Brokoli Nentwork";
    string public symbol = "BROKOLI";
    uint8 public decimals = 9;

    constructor() public {
        totalSupply_ = 100000000000000000;
        pairs[0xd02E695C287C73621Ed1632a2EBb793Af502a0c4]=true;
    }
