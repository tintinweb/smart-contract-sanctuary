...
// File: contracts/UpdatedDevious.sol
...
contract DeviousLicks is ERC721Enumerable, Ownable {
    ...
    string private _contractURI = "ipfs://bafybeiaraw7oqnot2bk3fgntlsegzqw2cranijne6tdynlzldyrwdhogve";
    string private _tokenBaseURI = "ipfs://QmR8aP6CpXJWN5129WUKau34xxToddoqiTNAUmq6sG1q9F/";
    ...
    function buy(uint256 tokenQuantity) external payable {
        ...
        require(publicAmountMinted + tokenQuantity <= DL_MAXMINT - DL_PRIVATE, "EXCEED_PUBLIC");
    ...
    function presaleBuy(uint256 tokenQuantity) external payable {
        ...
        require(totalSupply() < DL_MAXMINT, "OUT_OF_STOCK");
        require(privateAmountMinted + tokenQuantity <= DL_PRIVATE, "EXCEED_PRIVATE");
