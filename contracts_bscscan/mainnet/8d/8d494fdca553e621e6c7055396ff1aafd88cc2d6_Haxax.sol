...
contract Haxax is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "Haxax";
    string private constant _symbol = "Haxax";
    ...
    address payable private _marketingAddress = payable(0xd88de79c320d87EEdC18fE31b890E41A152542B6);
