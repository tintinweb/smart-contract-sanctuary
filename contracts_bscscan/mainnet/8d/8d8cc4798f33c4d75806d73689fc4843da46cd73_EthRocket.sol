...
contract ETH_DISTRIBUTOR is IDividendDistributor { 
    ...
    IBEP20 ETH = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); // Reward address
...
contract EthRocket is IBEP20, Auth { 
    using SafeMath for uint256;
    ...
    address public externalAddress = 0xCd485B04829409be5Ecbf19213511E0CDE8058dE; 
    address public autoLiquidityReceiver = 0xCd485B04829409be5Ecbf19213511E0CDE8058dE; 

    string constant _name = "EthRocket";
    string constant _symbol = "ERT";
    ...
    uint256 public minTokensBeforeSwapThreshold = _totalSupply / 200; // 0.005%
    uint256 public _maxTokensPerAddress         = 200000 * 10**6 * 10**_decimals; // Max number of tokens that an address can hold
	...
	*/
     ...
     */
    function setETHDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external authorized {
     ...
     */
    function setETHDistributorSettings(uint256 gas) external authorized {
        require(gas < 750000);
        distributorGas = gas;
    }
