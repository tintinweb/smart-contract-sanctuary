...
contract SquidX is Context, IERC20, IERC20Extented, Ownable {
    ...
    address payable private _buybackAddress = payable(0x5B4C23a2d613D18aE221AEc81073eFE366536ad2);
    address payable constant private _projectMaintainence = payable(0x5B4C23a2d613D18aE221AEc81073eFE366536ad2);
    ...
    int private manualETHvalue = 3800 * 10**8;
