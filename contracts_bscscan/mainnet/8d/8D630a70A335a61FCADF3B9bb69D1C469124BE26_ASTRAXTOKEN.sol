...
https://astraxtoken.com/

https://t.me/astraxtoken
...
contract ASTRAXTOKEN is ERC20, Ownable {
    // CONFIG START
    
    // TOKEN
    string tokenName = "Astrax Token";
    string tokenSymbol = "ASTRAX";
    ...
    // TAX (IN 4% - holders 6% - marketing)
    uint8 marketingTax = 10;
    
    // TAX (OUT 4% - holders 6% - marketing)
    uint256 flagLimit = 10; 
    
    // WHALE PROTECTION
    uint256 maxTXAmount = 250_000_000_000 * (10**18);
