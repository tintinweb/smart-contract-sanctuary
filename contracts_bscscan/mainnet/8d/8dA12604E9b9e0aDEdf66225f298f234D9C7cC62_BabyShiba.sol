...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #BabyShiba

    I make this #BabyShiba to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BabyShiba_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #BabyShiba to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #BabyShiba 10000000X? 
   ...
   it's the best part of the #BabyShiba idea, increasing the liquidity pool automatically, 
