...
Telegram Official Chat: @tigerchibi
...
contract TigerChibi is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x638ed86ce31B7CF0D3a87BeDf20A5b7f93ad4EF3));
    address payable public _teamwallet =
        payable(address(0x638ed86ce31B7CF0D3a87BeDf20A5b7f93ad4EF3));
    address _partnershipswallet =
        payable(address(0xD7Ba2b2731D24eBa35982791a68cA5A5a228291C));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Tiger Chibi";
    string private _symbol = "TIBI";
