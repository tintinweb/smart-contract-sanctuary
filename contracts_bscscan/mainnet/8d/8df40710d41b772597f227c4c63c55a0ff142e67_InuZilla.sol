...
/**
   ...
   I make this #InuZilla to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/inuzillatoken

   Great features:
   8% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders

   I will add 0.5 BNB and all the total supply to the pool
   Can you make #InuZilla 1000X? 
   ...
   it's the best part of the #InuZilla idea, increasing the liquidity pool automatically, 
