...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xdEd46303F9Fd6e26612b85BBe817c79e9Aa83968;
        _token = msg.sender;
    }
...
contract NoJeetX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NoJeetX";
    string constant _symbol = "NoJeetX";
    ...
    uint256 public swapThreshold = rSupply * 35 / 10000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCf1967B61bC62701DA254891AA7357dFd94346aa;
        devFeeReceiver = 0xCf1967B61bC62701DA254891AA7357dFd94346aa;
        devFeeReceiver2 = 0xCf1967B61bC62701DA254891AA7357dFd94346aa;
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(0xdEd46303F9Fd6e26612b85BBe817c79e9Aa83968).transfer(amountBNB * amountPercentage / 100);
    }
