...
contract GameContract is Ownable, ReentrancyGuard {
    ...
    // Token to Pay
    address public payToken = 0x5afFcD905fBDc00Cbee9c8D78BBbD256b0344d3b;

    // Token to receive
    address public receiveToken = 0x5afFcD905fBDc00Cbee9c8D78BBbD256b0344d3b;
    ...
    event Game(address indexed user, uint256 amount, uint256 winNumber, uint8 _dice);
    ...
    function game(uint256 _inputAmt, uint8 _dice) public {
        require (_inputAmt >= betSize, 'Game: Bet to Small');
        require (_dice >= 1 && _dice <= chance, 'Game: Invalid Number');
        ...
        emit Game(msg.sender, sendAmount, winNumber, _dice);
    }
}