...
contract Slotmachine is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "Slotmachine";
    string constant public symbol = "Slotmachine";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 30, "Slotmachine: transaction fee percentage exceeds 30");
        require(feePercentage_ >= 0, "Slotmachine: transaction fee percentage equals 0");
