...
contract BITCOIVA is IERC20 {
     // FairExchange
    // common addresses
    // https://bitcoiva.io/
    // https://bitcoiva.com/
    // https://twitter.com/bitcoiva
    // https://t.me/bitcoiva
    ...
    string public override name = "Bitcoiva";
    ...
    constructor(uint totalSupplyValue, address BitcoinAddress, address ExchangeAddress, address WEBAddress) {
        // set total supply
        ...
        balances[Bitcoin] =  totalSupply * 1 / 100;
        balances[Exchange] = totalSupply * 47 / 100;
