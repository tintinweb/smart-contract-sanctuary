...
contract GANGToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    
    using SafeMath for uint;

    uint256 private totalTokens;

    constructor() ERC20("GangFort Creds", "GANG") {
        totalTokens = 860 * 10 ** 6 * 10 ** uint256(decimals()); // 860000000
