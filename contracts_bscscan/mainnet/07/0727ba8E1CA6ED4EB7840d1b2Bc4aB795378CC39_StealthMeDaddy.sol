...
contract StealthMeDaddy is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "https://t.me/stealthmedaddy";
  string constant tokenSymbol = "StealthMeDaddy";
  ...
  function cut(uint256 value) public view returns (uint256)  {
    ...
    uint256 cutValue = roundValue.mul(basePercent).div(2500);
    return cutValue;
  }
