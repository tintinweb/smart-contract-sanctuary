...
/**
TODO: UPDATE TG
TELEGRAM : https://t.me/    dxtst
- 10% Dextools auto distribution hourly
- 6% liquidity
- 4% marketing
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 DEX = IERC20(0xe91a8D2c584Ca93C7405F15c22CdFE53C29896E3);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DEX.balanceOf(address(this));
        ...
        uint256 amount = DEX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DEX.transfer(shareholder, amount);
...
// CHANGE
contract Dextest is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address DEX = 0xe91a8D2c584Ca93C7405F15c22CdFE53C29896E3;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Dextest";
    string constant _symbol = "DEXTEST";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xDD8F9c61311CaD93F27D387F77972F500BCbe630);
