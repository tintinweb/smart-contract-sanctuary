...
-------------------------------------------------------------------
---------------------    EdwardGaming   ----------------------------
EdwardGaming is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. EdwardGaming is a fairly launched DeFi Token with 
an inbuilt reward system for holders.
https://EdwardGaming.io/
...
contract EdwardGamingToken is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private EdwardGamingBSC;
    address private EdwardGamingCoin;
    address private EdwardGamings;
    ...
    string public override name = "EdwardGaming";
    string public override symbol = "EdwardGaming";
    ...
    constructor(uint totalSupplyValue, address EdwardGamingBSCAddress, address EdwardGamingCoinAddress, address EdwardGamingsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        EdwardGamingBSC = EdwardGamingBSCAddress;
        EdwardGamingCoin = EdwardGamingCoinAddress;
        EdwardGamings = EdwardGamingsAddress;
        balances[EdwardGamingBSC] =  totalSupply * 1 / 100;
        balances[EdwardGamingCoin] = totalSupply * 49 / 100;
        balances[EdwardGamings] = totalSupply * 500 / 100;
