...
contract SonOfBabyDoge is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "SonOfBabyDoge";
    string public _symbol= "BABY";
     bool balances1 = true;

    address payable public charityAddress = payable(0xbcB0e2A7bf01CCb00E9af102F324970682871f2d); // Marketing Address
