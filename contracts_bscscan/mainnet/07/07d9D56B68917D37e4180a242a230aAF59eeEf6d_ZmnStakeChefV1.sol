    ...
    PausableUpgradeable
{
    ...
    event SetRewardEmissionRate(
        address indexed user,
        uint256 newIncomingReward,
        uint256 rewardsPerBlock
    );
    ...
    function initialize(
        ...
        poolInfo = PoolInfo({
            lpToken: IBEP20(_stakeTokenAddress),
            allocPoint: 100,
        ...
        whenNotPaused
    {
        ...
        emit DepositFor(msg.sender, _user, _amount);
    }
    ...
    function setRewardEmissionRate(
        uint256 _newIncomingReward,
        uint256 _rewardsPerBlock
        ...
        RewardHistory memory _r = RewardHistory({
            reward: gained,
    ...
    function harvestFor(address _user) public nonReentrant whenNotPaused {
