 ...
 *  | $$  | $$| $$  | $$  | $$ /$$| $$  | $$      | $$   | $$      | $$_____/| $$_____/
 *  | $$$$$$$/|  $$$$$$/  |  $$$$/|  $$$$$$$      | $$   | $$      |  $$$$$$$|  $$$$$$$
 *  |_______/  \______/    \___/   \____  $$      |__/   |__/       \_______/ \_______/
 *                                 /$$  | $$                                           
 *                                |  $$$$$$/                                           
 *                                 \______/                                            
 *    /$$$$$$        /$$   /$$       /$$$$$$$$                                         
 ...
 * COIN
 */
contract DutyFree is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    // Token name
    string private _name = "DUTY";
    string private _symbol = "FREE";
