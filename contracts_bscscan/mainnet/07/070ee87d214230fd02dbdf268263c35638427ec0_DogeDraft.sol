...
/**
 ...
 TELEGRAM: DogeDraftBSC
 
 WEBSITE: https://DogeDraft.site/
 
 
 Automatic Lottery Contract
 
 1B Supply | 50% Initial Burn | 2% Max Wallet
 
 Fees: 8% Liquidity, 5% Lottery, 1% Marketing, 1% Burn
 
 Locking Liquidity on Launch
 
 Are you the next pick? Buy $DRAFT and find out today!
...
contract DogeDraft is Context, IBEP20, Ownable {
    ...
    address private constant _marketingWallet = 0x16286821Bd3B5c3a6a4e0e43442b614Ac3E12a57;
    ...
    address private constant _potAddress = 0xF65E63fB9f322fD8D4EE70604573555fFD5915b7;
    ...
    uint256 private _maxWalletToken = 20 * 10**6 * 10**9; // 20 Million (2%)
