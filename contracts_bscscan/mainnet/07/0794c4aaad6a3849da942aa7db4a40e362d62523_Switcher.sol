...
contract Switcher is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Switcher";
    string constant _symbol = "SWITCH";
    ...
    uint256 public swapThreshold = _totalSupply * 200; // 0.5% of supply
    bool inSwap;
