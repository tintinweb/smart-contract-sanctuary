...
contract TestRC2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TESTREWARD CYCLE 2", "TESTRC2") {
    	busdTokenDividendTracker = new BUSDDividendTracker();
    	rc1DividendTracker = new RC1DividendTracker();
 
    	marketingWallet = 0xAc3DC42d57de3D868E7080d112E2c85E2B901D1a;
    	devWallet = 0xD4d508BbedCA2E4EC05284D44947E203B9b2EcFC;
