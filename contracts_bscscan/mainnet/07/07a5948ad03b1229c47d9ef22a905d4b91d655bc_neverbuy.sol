...
contract neverbuy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x73EcDf49f5d49f455e9D808BBFa00eB9332ACA4d); // Marketing Address
    ...
    string private _name = "neverbuy";
    string private _symbol = "neverbuy";
