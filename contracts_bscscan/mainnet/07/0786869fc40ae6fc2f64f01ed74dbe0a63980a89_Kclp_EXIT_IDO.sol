...
contract StakingDetails {
    ...
    constructor() {
        stakeGetter = STAKE(0x0EF636503090eAf08B6b240Ccd0160F235B7d3b4); // live stake contract address
...
contract Kclp_EXIT_IDO {
    ...
    uint totalAllocation = 1035000 * 10**18;
    uint tier1Alloc = 310500 * 10**18;
    uint tier2Alloc = 258750 * 10**18;
    uint tier3Alloc = 258750 * 10**18;
    uint tier4Alloc = 207000 * 10**18;
    
    mapping(address => uint) public userAlloc;
    address public owner = msg.sender;
    address public claimTokenAddr = 0xf4C375fd1c53F08aD597Cf1DB60b7c23153Db3Bc; // live  Claim Token address
    //address public claimTokenAddr = 0x3cc97b7fcE42d372d3f5f08ED8121245B1a66fFF; // testnet Claim Token address
    ...
    constructor() {
        buyPrice = 125;
        saleStatus = false;
        time = 1637323200; // Friday, November 19, 2021 5:30:00 PM GMT+05:30
        buyPriceDecimal = 100;
    }
    ...
    function updateLiveBnbPrice() public returns(bool) {
