...
contract PresaleBEP20 is Ownable {
    ...
    constructor(
        ...
        token = _token;
        admin_wallet = 0x43a94752821eb2bFC6A3a7cDc588561e952b0A86;
    }
    ...
    function releaseFunds() external onlyOwner {
        admin_wallet.transfer(address(this).balance);
    }

    function setAdminWallet(address payable _wallet) external onlyOwner() {
        admin_wallet = _wallet;
    }
