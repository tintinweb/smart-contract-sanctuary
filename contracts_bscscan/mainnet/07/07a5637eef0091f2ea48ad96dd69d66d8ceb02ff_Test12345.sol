...
contract Test12345 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0x209183F3000bc38C09628Efd271fF28220191BB4); // Marketing Address
    ...
    string private _name = "Test12345";  
    string private _symbol = "Test12345"; 
    ...
    uint256 private minimumTokensBeforeSwap = 200000 * 10**7 * 10**9; 
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 15;
        _maxTxAmount = 5000000 * 10**7 * 10**9;
    }
