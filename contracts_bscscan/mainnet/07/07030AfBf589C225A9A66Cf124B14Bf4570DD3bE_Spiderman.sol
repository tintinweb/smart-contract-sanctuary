...
/*
⚡️($SPN spiderman token)⚡️
————————
Beyond basic digital economics, $SPN spiderman token also introduces a robust smart contract platform to the $SPN spiderman token environment by linking it with the Binance SmartChain. Through the combination of the DOGE to $SPN spiderman token liquidity pool and BSC powered smart contracts, users can build decentralized applications that operate seamlessly with DogeCoin as their near-native currency. Built on DOGE but powered by $SPN spiderman token

🔌 [Connect With us] 🔌
————————-————
💬 TG: https://t.me/tokenofspiderman
...
🔥 Initial Burn = 300,000,000,000 (30%)
🚬 Burn Fee = 3%
💧 Liquidity Fee = 3%
♻️ Reflection = 3%
🚫 Dev. Wallets = 15%
💠 Marketing Wallet = 35,000,000,000 (5%)
*/
...
contract Spiderman is ERC20, Ownable {
    ...
    constructor() ERC20("Spiderman", "SPN") public {
