...
/**
 *Shakey Cake - Just Shake it and Earn Cake!
 TG - https://t.me/ShakeyCakeBSC
*/
...
/**
 * ShakeyCake - Mmmmmmmm Shake that Cake!!!
 * 10% CAKE REWARDS, 5% MARKETING + EXTRA 5% to LIQUIDITY on SELLS
 */
...
contract ShakeyCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShakeyCake";
    string constant _symbol = "SHAKEYCAKE";
