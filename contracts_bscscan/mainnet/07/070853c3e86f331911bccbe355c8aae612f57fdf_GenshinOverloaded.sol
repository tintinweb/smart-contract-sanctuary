...
contract GenshinOverloaded is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GenshinOverloaded";
    string constant _symbol = "GenshinO";
    ...
    uint256 public _maxTxAmount = _totalSupply.div(100).mul(4);
    uint256 public _maxWalletToken = _totalSupply.div(100).mul(4);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xFC8F126Fd81a84d4886C19B06579B2Ee9bDFbAe1;
        devFeeReceiver = 0xFC8F126Fd81a84d4886C19B06579B2Ee9bDFbAe1;
