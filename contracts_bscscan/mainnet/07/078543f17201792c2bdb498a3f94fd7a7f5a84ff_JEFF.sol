 ...
 * JEFF IN SPACE has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 *
 * TOKENOMICS:
...
contract JEFF  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JEFF IN SPACE";
