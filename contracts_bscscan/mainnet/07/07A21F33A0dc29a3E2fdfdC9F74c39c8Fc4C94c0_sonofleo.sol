...
contract sonofleo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0351b5B74711ded334ece0a619A994AB5a2f7400); // Marketing Address
    ...
    string private _name = "son of leo";
