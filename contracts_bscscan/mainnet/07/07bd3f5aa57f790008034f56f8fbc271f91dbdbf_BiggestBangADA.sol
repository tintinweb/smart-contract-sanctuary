...
contract BiggestBangADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BiggestBangADADividendTracker public dividendTracker;
    ...
    constructor() public ERC20("BiggestBangADA", "BIGGESTBANGADA") {

    	dividendTracker = new BiggestBangADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BiggestBangADADividendTracker newDividendTracker = BiggestBangADADividendTracker(payable(newAddress));
...
contract BiggestBangADADividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BiggestBangADA Dividends", "BiggestBangADA_dividends") {
    	claimWait = 3600;
