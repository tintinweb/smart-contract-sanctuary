...
contract IndexMaster is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 800000000e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
	

	address payable private _marketingWallet = payable(0x517701d1CE792f717E05f0B7719Ce4E459527F8E);
    
    string private _name = "Index Master";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x517701d1CE792f717E05f0B7719Ce4E459527F8E, 'We can not exclude Uniswap router.');
