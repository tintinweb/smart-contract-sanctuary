...
/**
 *  TELEGRAM : https://t.me/roaring20bsc
 */
...
contract Roaring20 is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Roaring20";
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (1000) * (10); // 1%
    uint256 public _maxSellTxAmount = _totalSupply / (1000) * (10); // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xe3827efCB5583a07A79fF748659238A3241E159d ;
        marketingFeeReceiver = 0xe3827efCB5583a07A79fF748659238A3241E159d ;
        devFeeReceiver = 0xe3827efCB5583a07A79fF748659238A3241E159d ;
