...
TELEGRAM: https://t.me/DogeBuster
...
Tokenomics:
    ...
    *set 49% slippage
    *sell will incur 20% extra tax, i.e set 24% slippage for tax
...
contract DogeBuster is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DogeBuster", "DogeBuster") {
    	...
    	buyBackWallet = 0x7fF66dc87011f4BD9ac8022238A9d93FA63Bbd05;
    ...
    function setHLBB(uint256 _HLBB) external onlyOwner{
        require(HLBB >= 1 && HLBB <= 900, "HLBB factor must be between 1 and 900");
        HLBB = _HLBB;
    }
        ...
        if (
            ...
            if (!swapping && canSwap) {
                ...
                if (buyBackEnabled && buyBackBalance > uint256(1 * 10**18)) {
                    swapBNBForTokens(buyBackBalance.div(10**2).mul(HLBB));
                }
