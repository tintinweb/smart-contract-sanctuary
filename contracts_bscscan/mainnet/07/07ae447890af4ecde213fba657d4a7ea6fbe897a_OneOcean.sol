...
contract OneOcean is ERC20, Ownable {
    ...
    address _marketingWalletAddress = 0x17C907CA36Ff636b295c7C8699b8A7f6c89AAfeb; //change this
    ...
    constructor() ERC20("OneOcean", "ONEO") {
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 initialONEOBalance = IERC20(DividendToken).balanceOf(address(this));
 
        swapTokensForBusd(tokens, address(this));
        uint256 newBalance = (IERC20(DividendToken).balanceOf(address(this))).sub(initialONEOBalance);
