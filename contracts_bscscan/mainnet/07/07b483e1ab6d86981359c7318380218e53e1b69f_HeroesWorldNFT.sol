...
/*
    t.me/HeroesWorldNFT
    t.me/HeroesWorldNFTChina
    t.me/HeroesWorldNFTGermany
    Twitter : twitter.com/HeroesWorldNFT
    
    Welcome to HeroesWorldNFT ; 
   
   This is a community token. If you want to create a telegram I suggest to name it to @HeroesWorldNFT
   ...
   I will renounce the ownership to burn addresses to transfer #HeroesWorldNFT to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 10% total supply to the pool
   Can you make #HeroesWorldNFT 10000X? 
...
contract HeroesWorldNFT is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "HeroesWorldNFT";
    string private constant _symbol   = "HWnft";
