...
contract HackerDad is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x45f4d2C39bD04817ccED1a6db243Df9d3A7D7aD6;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 3350000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "HackerDad";
    string private _symbol = "HackerDad";
    ...
    uint256 public _maxTxAmount = 3350000000000 * 10**9;
