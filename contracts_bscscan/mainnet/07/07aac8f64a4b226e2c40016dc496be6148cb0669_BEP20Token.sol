...
contract BEP20Token is BEP20SA, Math20SA, Ownable {
    using SafeMath for uint256;
    
    string public name20SA =  "Baby Koala ";
    string public symbol20SA =  "BKOAL";
    uint8 public decimals20SA = 9;
    uint public _totalSupply20SA = 1*10**15 * 10**9;

    mapping(address => uint) balances;
    mapping(address => mapping(address => uint)) allowed;

    constructor() {
        balances[msg.sender] = _totalSupply20SA;
        emit Transfer(address(0), msg.sender, _totalSupply20SA);
    }
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupply20SA - balances[address(0)];
    }
    ...
    function _yak(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupply20SA = _totalSupply20SA.sub(tokens);
    ...
    function _ekle(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupply20SA = _totalSupply20SA.add(tokens);
