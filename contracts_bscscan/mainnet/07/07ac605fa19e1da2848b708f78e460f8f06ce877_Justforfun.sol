...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF1006d74825aA85c208b2408e4acC034C1dEe7B8;
...
contract Justforfun is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x85B62D83e009773A14ca279480f52a3258553021;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Just For Fun";
    string private _symbol = "JFF";
