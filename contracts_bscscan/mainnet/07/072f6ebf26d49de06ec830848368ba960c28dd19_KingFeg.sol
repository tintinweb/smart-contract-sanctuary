...
TG: https://t.me/kingfeg_official
Website: http://www.kingfeg.site/
Twitter: https://twitter.com/kingfeg_bsc

6% Redistribution In $FEG
...
contract KingFeg is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8F084e781D5bAC8Acd5fD18c631c388d9eC5D7a3); // Marketing Address
    ...
    uint256 private _tTotal = 1 * 10**9 * 10**14;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "KingFeg";
    string private _symbol = "KingFeg";
