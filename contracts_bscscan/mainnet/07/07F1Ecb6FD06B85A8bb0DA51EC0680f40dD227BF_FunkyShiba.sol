...
/**
 *
Funky Shiba High Yield & High Reward dogies that are sure to keep you on your toes! 

Hold FunkyShiba and get Reward USDC!

Don't Miss Out On This Launch

website: https://funkyshiba.xyz/
telegram: https://t.me/funkyshiba
 * 
*/
...
contract FunkyShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FunkyShiba";
    string constant _symbol = "FunkyShiba";
