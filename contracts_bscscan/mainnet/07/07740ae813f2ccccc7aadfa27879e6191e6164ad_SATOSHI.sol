...
contract SATOSHI is Context, IERC20, Ownable {
   ...
   //Ban Bots 
    ...
    address payable private _promotionsWalletAddress = payable(0x82EC3dd5FB4F471b8FDA99d8ad71ab3e274ECb79);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "sonofnakamoto.com ";
    ...
    //max wallet holding 20000000 * 10**6 * 10**9 is 1.5% of 1000000000 * 10**6 * 10**9 (total supply)
    ...
    function _transfer(
        ...
        //limits the amount of tokens that each person can buy - launch limit is 1.5% of total supply!
