...
contract SteamExchange is Context, IBEP20, Ownable {
    ...
    uint256 public _maxWalletToken = 200 * 10**9 * 10**9; 
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'STEAM EXCHANGE';
    string private _symbol = 'STEAMX';
