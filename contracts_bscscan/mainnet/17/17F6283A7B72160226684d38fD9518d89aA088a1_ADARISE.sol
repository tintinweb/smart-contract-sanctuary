...
AdaRise stealth launch between 17:30 - 18:00 UTC!

AkitaRise is community driven, automatic redistribution token that rewards holders with 10% ADA rewards on every buy and sell.

ANTI WHALE / ANTI SNIPE

Zero team tokens, a truly fair launch and based devs
...
1.5% Max tx
3% Max Wallet
Anti-Dump (30 mins sell countdown)

https://t.me/BSCAdaRise
...
contract ADARISE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ADARISE";
    string constant _symbol = "ADARISE";
    ...
    uint256 public swapThreshold = _totalSupply * 1500 / 100000; // 1.5% of supply
    bool inSwap;
