...
contract TestDad is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Test Dad";
    //change the token symbol
    string constant _symbol = "TMAMA";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x4E6cB3dcD0654FfEad390FF3cD2813d82097045D;
