...
Introducing CakeFomo
The first token on the BSC smartchain to combine the rebase rewards with rewards.
Hold CAKEFOMO and receive $CAKE directly to your BEP-20 wallet as a reward for holding
TG: https://t.me/cakefomobsc
*/
...
contract CakeFomo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cake Fomo";
    string constant _symbol = "CAKEFOMO";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1Dc027f2f46e67dd1005c75bCAEAF2dE552e592a;
