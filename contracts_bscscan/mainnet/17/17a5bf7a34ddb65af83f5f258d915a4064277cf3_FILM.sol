...
/**
    Name =  Crypto Film Fund
    Symbol = FILM
    Total Supply = 1,000,000,000,000,000
    Decimal = 18
    5% of each transaction to the liquidity pool
    10% of each transaction to the marketing wallet
    5% of each transaction to holders
*/
...
contract FILM is Context, IBEP20, Ownable {
    ...
    string private _name     = "Crypto Film Fund";
    string private _symbol   = "FILM";
    uint8 private  _decimals = 18;
    
    uint256 public _taxFee       = 5; 
    uint256 public _liquidityFee = 15; 
    uint256 public _percentageOfLiquidityForDev = 66; 
    ...
    constructor (address cOwner, address marketing) Ownable(cOwner) {
        _devWallet = marketing;
