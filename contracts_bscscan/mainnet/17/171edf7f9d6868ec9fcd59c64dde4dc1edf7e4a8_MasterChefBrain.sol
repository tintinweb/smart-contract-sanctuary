...
contract MasterChefBrain is Ownable {
    ...
    address private constant WETHUSD = 0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16;
    IERC20 constant USD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    constructor(
        ...
        pathForTVL[1] = _pancakeRouter.WETH();
    ...
    function getjoePerSec() public view returns(uint256 amount ) {
        ...
        uint256 joeUsdValue = (_pancakeRouter.getAmountsOut(1e18, pathForTVL))[2];
