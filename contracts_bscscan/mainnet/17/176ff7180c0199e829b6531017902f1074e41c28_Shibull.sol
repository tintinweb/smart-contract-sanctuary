...
/*
🔥 Welcome to Shibull 🔥 Where we’re BULLish on the biggest trend in crypto right now – Shiba!

⚡️We have a strategic marketing plan ready to expose Shibull via some big Twitter influencers & Telegram channels to start the 1st day off with a BANG! 💥
—————————————————————
🔱 No TEAM tokens 🔱
...
✅ 5% into Marketing Wallet
✅ 5% into LP 
—————————————————————
🔈Telegram: https://t.me/shibull
🌍 Web: https://shibull.tech/
*/
...
contract Shibull is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shibull", "Shibull") public {
