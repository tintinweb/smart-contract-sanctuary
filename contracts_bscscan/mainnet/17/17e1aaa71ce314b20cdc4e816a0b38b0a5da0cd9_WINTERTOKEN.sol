...
contract WINTERTOKEN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Winter Token";
    string constant _symbol = "WINT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6Bb9F201F5d4F6f5FfC5f9713D5d8cdC03Ff93da;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _burnFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
