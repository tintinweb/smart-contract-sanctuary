...
/**
https://t.me/IMGONNARUGTHISCOINONYOURBITHDAY
...
contract IMGONNARUGTHISCOINONYOURBITHDAY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "IMGONNARUGTHISCOINONYOURBITHDAY"; // 
    ...
    uint256 liquidityFee    = 12; // ammount to LP
    uint256 reflectionFee   = 3; // ammount to rewards
    uint256 marketingFee    = 0; // ammount to marketing wallet
