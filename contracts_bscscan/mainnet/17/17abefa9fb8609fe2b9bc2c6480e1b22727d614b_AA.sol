...
contract AA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000 * 10**18;//总量
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ATM";//全称
    string private _symbol = "ATM";//简称
    uint8 private _decimals = 18;//小数点

    uint256 public _taxFee = 2;//持币分红比例
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 0;//回流资金池比例
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _burnFee = 8;//销毁比例
    uint256 private _previousBurnFee = _burnFee;
    
    uint256 public _devFee = 0;//营销钱包比例
    uint256 private _previousDevFee = _devFee;
    
    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    address public ownerAddres = address(0x14cc97fF599E415B83F1C7f16a68b846Eb16faAb);//所有权地址，把代币发到这个地址上
    address public devAddress = address(0x14cc97fF599E415B83F1C7f16a68b846Eb16faAb);//营销钱包
    ...
    bool public swapAndLiquifyEnabled = false;//回流开关，false为关，true为开。
    bool public swapDevEnabled = false;//营销钱包开关

    uint256 public _maxTxAmount = 21 * 10 **18;//限购
    uint256 private numTokensSellToAddToLiquidity = 1000000000000 * 10 **18;//回流触发
