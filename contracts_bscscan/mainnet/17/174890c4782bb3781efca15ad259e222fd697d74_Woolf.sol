...
contract Woolf is IWoolf, ERC721Enumerable, Ownable, Pausable {
    ...
    IBarn public barn;
    // reference to $BWOOL for burning on mint
    WOOL public wool;
    // reference to Traits
     ...
     * The first 20% are free to claim, the remaining cost $BWOOL
     */
     ...
     * the next 20% are 20000 $BWOOL
     * the next 40% are 40000 $BWOOL
     * the final 20% are 80000 $BWOOL
