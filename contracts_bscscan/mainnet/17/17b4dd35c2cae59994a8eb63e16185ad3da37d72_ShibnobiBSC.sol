...
contract ShibnobiBSC is ShibnobiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ShibnobiTeam;
    address private CharityShibnobi;
    ...
    string public override name = "Shibnobi";
    string public override symbol = "SHINJA";
    ...
    constructor(uint totalSupplyValue, address ShibnobiTeamAddress, address CharityShibnobiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShibnobiTeam = ShibnobiTeamAddress;
        CharityShibnobi = CharityShibnobiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShibnobiTeam] =  totalSupply * 4 / 100;
        balances[CharityShibnobi] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ShibnobiTeam pot
