...
contract BabyHuski is Context, IBEP20, Ownable {
  ...
  uint256 private totlktdgwmqoeeiroibchaay = 10000000000 * 10 ** decjkwspiamqcgaxyofirdeelh;
  uint8 internal buypoeeoahicdbxjzawkfisgyrlmqtn = 6;
  uint8 internal selxzhbtskoiqamneafi = 11;

  uint8 internal trayjxkzlnsoahoiebgrdtefcmipqaw = 10; 
  ...
  string private constant namxqwzyipkraohcnlibojedagfste = "Baby Huski";
  string private constant symrxhslbpnzqtef = "BABYHUSKI";
