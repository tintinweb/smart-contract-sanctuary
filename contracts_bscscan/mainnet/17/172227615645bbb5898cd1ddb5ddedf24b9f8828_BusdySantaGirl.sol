...
contract BusdySantaGirl is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BusdySantaGirl';
    string private constant _symbol = 'BusdySantaGirl';
    ...
    address public Marketing=payable(0x25f9b2a70C822C04284C03830bf364ae2382b099);
    address public BuyBack=payable(0x1412C2D0309A0f5eB46FcD0289f78a427e6Fa45f);
    //TestNet
    ...
    //Staking Share gets an extra 0.40% during launch/
    uint8 public StakingShare=40;
    ...
    function TeamProcessBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Marketing).transfer((amount*3)/4);
        payable(BuyBack).transfer((amount*1)/4);
    } 
