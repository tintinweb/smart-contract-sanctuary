...
FlappyCake - Earn 7% Cake Rewards!

TG: t.me/FlappyCake
Website: flappycake.com/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
...
contract FlappyCake is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FlappyCake";
    string constant _symbol = "FLAPPYCAKE";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 15 / 100; //

    uint256 public _maxWalletToken = ( _totalSupply * 20 ) / 100; // 2% Max Wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x89843BaCC515cb973788ec32b20e0e3Ba1B85609;
