...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1C508A69CDDc6c8eeD6aE024CD25cda6D513E0CB;
...
contract ShibaInuZ is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBdd459000559a2A0ceefe33FcB9425DD436B7B24;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Shiba Inu Z";
    string private _symbol = "ShibZ";
