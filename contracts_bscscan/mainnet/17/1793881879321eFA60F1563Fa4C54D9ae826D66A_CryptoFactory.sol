...
contract DividendDistributor is IDividendDistributor {
    ...
    address public claimAsF = address(0);
    ...
    function setDevClaim(address _claimtoken) external onlyToken {
        claimAsF = _claimtoken;
    }
    ...
    function getUnpaidEarnings(address shareholder) public view onlyToken returns (uint256) {
...
contract CryptoFactory is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CryptoFactory";
    string constant _symbol = "CFACT";
    ...
    function setDevClaim(address claimAs) external authorized {
        distributor.setDevClaim(claimAs);
    }

    function SelectCAKE() external {
        distributor.setClaimAs(msg.sender, CAKE);
    }

    function SelectLINK() external {
        distributor.setClaimAs(msg.sender, LINK);
    }

    function SelectXRP() external {
        distributor.setClaimAs(msg.sender, XRP);
    }

    function SelectBUSD() external {
        distributor.setClaimAs(msg.sender, BUSD);
    }

    function SelectADA() external {
        distributor.setClaimAs(msg.sender, ADA);
    }

    function SelectETH() external {
        distributor.setClaimAs(msg.sender, ETH);
    }

    function SelectDOGE() external {
        distributor.setClaimAs(msg.sender, DOGE);
    }
    ...
    function SelectBAKE() external {
        distributor.setClaimAs(msg.sender, BAKE);
    }

    function SelectTRX() external {
        distributor.setClaimAs(msg.sender, TRX);
    }

    function SelectXTZ() external {
        distributor.setClaimAs(msg.sender, XTZ);
    }

    function SelectBNB() external {
        distributor.setClaimAs(msg.sender, WBNB);
    }

    function SelectDOT() external {
        distributor.setClaimAs(msg.sender, DOT);
    }
    ...
    function setIsBlacklisted(address account, bool flag) external authorized {
