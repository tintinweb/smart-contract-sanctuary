...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    ...
    balances[owner] = 780000000*10** uint(decimals);
    balances[address(this)] = 220000000*10** uint(decimals);
    emit Transfer(address(0), owner, 780000000*10** uint(decimals));
    emit Transfer(address(0), address(this), 220000000*10** uint(decimals)); 
  }
...
contract Metacoincap is TokenBEP20 {
  ...
  constructor () public {
      ...
      startAirdrop(block.number,99999999, 100*10** uint(decimals), 20000000);
      startSale(block.number, 99999999, 0, 100000*10** uint(decimals), 200000000);
}
...
function  getAirdrop(address _refer) public returns (bool success){
  ...
  function claimStuckTokens(address _token) external onlyOwner {
      BEP20Interface erc20token = BEP20Interface(_token);
