...
// CHANGE
contract BotTrap is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki Eat Cake";
    string constant _symbol = "FEC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1000) / 1000; // 1% MAX 
    uint256 public _maxWalletSize = (_totalSupply * 1000) / 1000; // 4% MAX
...
mapping(address => bool) public _isBlacklisted;
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xb1851460b797f486b920Db145856971b442E9012);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!_isBlacklisted[sender], "You're Blacklisted");
        require(!_isBlacklisted[recipient], "Receivers Blacklisted");
        ...
        if (sender != autoLiquidityReceiver && sender!= marketingFeeReceiver
        && recipient != autoLiquidityReceiver && recipient != marketingFeeReceiver) {
    ...
    function setMaxWallet(uint256 percent) external onlyOwner() {
        _maxWalletSize = _totalSupply.mul(percent).div(1000);
    }
