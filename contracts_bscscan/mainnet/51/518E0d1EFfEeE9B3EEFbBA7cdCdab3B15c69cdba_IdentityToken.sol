...
contract IdentityToken is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    constructor() public {
        address creatorAddress = 0x644A716Dc6b7aC1B8bdB38B7206Cc911092B160F;
        _name = "Identity";
        _symbol = "IDTT";
        _decimals = 18;
        _totalSupply = 1 * 10**9 * 10**18;
        _balances[creatorAddress] = _totalSupply;
