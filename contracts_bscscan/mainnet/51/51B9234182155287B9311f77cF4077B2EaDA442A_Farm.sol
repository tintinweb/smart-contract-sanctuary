...
contract Farm is Ownable {
    ...
    constructor(IERC20 _erc20, IERC20 _rewardErc20, uint256 _rewardPerBlock, uint256 _startBlock) public {
        erc20 = _erc20;
    ...
    function updateMultiplier(uint256 multiplierNumber, bool _withUpdate) public onlyOwner {
        if (_withUpdate) {
            massUpdatePools();
        }
    ...
    function updateRewardErc20(IERC20 _rewardErc20) public onlyOwner {
        rewardErc20 = _rewardErc20;
    }
    ...
    function erc20Transfer(address _to, uint256 _amount) internal {
        erc20.safeTransferFrom(address(rewardErc20), _to, _amount);
        paidOut += _amount;
    }
}
