...
contract Matiyaga is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Matiyaga';
    string private constant _symbol = 'Matiyaga';
    uint8 private constant _decimals = 18;
    uint256 public constant InitialSupply= 1000000000000 * 10**_decimals;

    uint256 public constant BalanceLimitDivider=1;
    uint256 public constant SellLimitDivider=1;
    uint16 public constant MaxSellLockTime= 1 hours;
    uint256 private constant DefaultLiquidityLockTime= 10 minutes;
    address public constant TeamWallet=0x91A26759cA72Cda365a3b66637F7c769F1A9ce46;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimBNB(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    function claimBNB(address addr) private{
