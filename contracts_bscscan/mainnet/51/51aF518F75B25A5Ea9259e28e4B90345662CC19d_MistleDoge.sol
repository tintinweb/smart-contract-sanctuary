...
/*
MistleDoge | $MIST
A festive token dedicated to rewarding diamond hands

TELEGRAM - https://t.me/mistledoge

WEBSITE - http://www.mistledoge.com

TWITTER - https://twitter.com/MistleDoge

INSTAGRAM - https://www.instagram.com/mistledoge
...
contract MistleDoge is IERC20, Ownable {
    ...
    string constant _name = "MistleDoge";
    string constant _symbol = "MIST";
    ...
    uint256 dev1Fee = 15;
    uint256 dev2Fee = 3;
    uint256 totalFee = 123;
    uint256 sellBias = 45;
    uint256 feeDenominator = 1000;

    address public autoLiquidityReceiver;
    address payable public marketingFeeReceiver;
    address payable public giftFeeReceiver;
    address payable public dev1FeeReceiver;
    address payable public dev2FeeReceiver;
    ...
    constructor () {
        ...
        distributor = new DividendDistributor(routerAddress, 0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
        ...
        autoLiquidityReceiver = 0x02408305a502ffeaa2Deee5fc4D49a67709c8093;
        marketingFeeReceiver = payable(0x2D2558a393cD8d4F7f87FE9aC43f4cDb2633A2D6);
        giftFeeReceiver = payable(0x07f0c436Da438f252661dF3D8ACb1FcFdb9B38dB);
        dev1FeeReceiver = payable(0xaBdAb521002EfC350927668b9D7614274fAfF4B5);
        dev2FeeReceiver = payable(0xB487b4DFB6954AF47EB4B4895200ef793B836E26);
    ...
    function setProtection(address _antiSnipe, bool _setOwner) external onlyOwner {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBGift = (amountBNB * giftFee) / totalBNBFee;
        uint256 amountBNBDev1 = (amountBNB * dev1Fee) / totalBNBFee;
        uint256 amountBNBDev2 = (amountBNB * dev2Fee) / totalBNBFee;
        ...
        if (amountBNBGift > 0)
            giftFeeReceiver.transfer(amountBNBGift);

        if (amountBNBDev1 > 0)
            dev1FeeReceiver.transfer(amountBNBDev1);
        
        if (amountBNBDev2 > 0)
            dev2FeeReceiver.transfer(amountBNBDev2);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _giftFee, uint256 _dev1Fee, uint256 _dev2Fee, uint256 _sellBias, uint256 _feeDenominator) external onlyOwner {
        ...
        dev2Fee = _dev2Fee;
        sellBias = _sellBias;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _giftFee + _dev1Fee + _dev2Fee;
    ...
    function setGiftReceiver(address _receiver) external onlyOwner {
        giftFeeReceiver = payable(_receiver);
    }

    function setDevReceivers(address _dev1, address _dev2) external onlyOwner {
        dev1FeeReceiver = payable(_dev1);
        dev2FeeReceiver = payable(_dev2);
    }
