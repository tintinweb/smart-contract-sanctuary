...
/**
   ...
   Can you make #PirateDiamondDoge 100X? 

   1,000,000 total supply
   20,000 tokens limitation for trade, which is 2% of the total supply
   
   9% tax fee will be distributed to all holders, 
   and the contract have the buyback function so it wont be dumped, 
   it's the best part of the #PirateDiamondDoge idea, increasing the liquidity pool automatically, 
   help the pool grow from the small init pool.

   TG :
   https://t.me/PirateDiamondDoge
   /*
...
contract PirateDiamondDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x586FD05323cA1cF4032621aCb7393722b1121b85); // Marketing Address
    ...
    string private _name = "PirateDiamondDoge";
    string private _symbol = "PirateDDoge";
