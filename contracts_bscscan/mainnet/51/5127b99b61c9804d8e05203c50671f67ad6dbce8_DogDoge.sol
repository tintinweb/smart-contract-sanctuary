...
/**
 Welcome to DogDoge
   ...
   I will renounce the ownership to burn addresses to transfer #DogDoge to the community

   I will add 1.3 BNB and all the left 10% total supply to the pool
   Can you make DogDoge 100X? 
   ...
   it's the best part of the #DogDoge idea, increasing the liquidity pool automatically, 
