...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract Forthechildren is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingAddress = payable(0xd08955F91d400b36D7A3556e8177fa9c1F63D71C); // Marketing Address
    ...
    uint256 private _tTotal = 1200000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
 
    string private _name = "For The Children";
    string private _symbol = "For";
