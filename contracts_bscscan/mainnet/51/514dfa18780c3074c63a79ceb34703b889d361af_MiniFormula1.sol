...
contract MiniFormula1 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniFormula1";
    string constant _symbol = "MiniF1";
    ...
    uint256 buybackMultiplierLength = 10080 minutes; 
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xE71d4e3bd49B534ca94297c56C3319C4FA562baA);
