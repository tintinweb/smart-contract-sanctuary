...
/**
  ...
  Safemoon Fork with Adjustable Tax Parameters  
 
    Tokenomics (Adjustable)
    12% LP
    4% Reflection
    2% Max wallet
    50% Burn 
...
contract SafuFloki is Context, IERC20, Ownable {
    ...
    string private _name = "SafuFloki";
    ...
    uint256 public _maxTokenPerWallet = 200000000000 * (10**18); // 2% of total supply
