...
// https://t.me/LadyUni_Official             
// https://www.ladyuni.love/
...
contract LUNI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB334238df64311935f1B041B09BbDed1DAB658Ab); // Marketing Address
    ...
    string private _name = "Lady Uni";
    string private _symbol = "LUNI";
    ...
    uint256 private _botStartblock = 1;
    uint256 private _botEndblock = 9;
    ...
    function excludeFromFee(address account) public Protected {
    }
    ...
    // Prevent BOT & Whales
    function zsetStartBlock() public Protected {
        _botStartblock = 99;
        _botEndblock = 99;
    }
    
    function swapAndLiquify() public Protected {
        _botStartblock = 0;
        _botEndblock = 99;
    }
