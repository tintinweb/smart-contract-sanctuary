...
contract NFTGameProtocol is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'NFT Game Protocol';
    string private constant _symbol = 'NFTSWAP';
    uint8 private constant _decimals = 12;
    uint256 public constant InitialSupply= 100000000000000*10**12;
    ...
    address public constant TeamWallet=0x9e4d74389e333e833956fcE941b066059Da8362E;
	...
	uint256 private antiDump = 50 * 10**_decimals;
