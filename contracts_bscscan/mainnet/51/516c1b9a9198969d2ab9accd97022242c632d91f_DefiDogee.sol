...
DefiDogee - DOGE Reward Token
https://t.me/DefiDogee

Max Wallet: 2%  | Max Buy: 1% | Max Sell: 1% 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //the reward token you want distributed, change it
...
contract DefiDogee is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; //Input the token address of whatever your reward is, change it.
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DefiDogee";    
    string constant _symbol = "DD";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; //this should be 1%
    ...
    uint8 public cooldownTimerInterval = 0; //this is in seconds. 
