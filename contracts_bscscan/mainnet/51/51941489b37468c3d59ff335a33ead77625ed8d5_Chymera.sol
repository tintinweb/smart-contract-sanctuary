...
*		 ╚════╝  ╚═╝  ╚═╝    ╚═╝    ╚═╝     ╚═╝ ╚══════╝ ╚═╝  ╚═╝ ╚═╝  ╚═╝
*
* Chymera is a proprietary, hyper deflationary BEP20 Token.
* Chymera token holders benefit through static rewards and also through the automatic Buy-Back process built into the contract.
* When the Buy-Back function is activated, the contract automatically buys back and burns tokens after every sell.
*
*
* CHYMERA TOKENOMICS
* 7% Automatic BuyBack Tax     
* 2% Automatic Liquidity Tax 
* 3% Auto Rewards Tax
* 3.3% Marketing/Development Tax
*
*
*/	
...
contract Chymera is Context, IERC20, Ownable {
    ...
    string private _name = "www.chymera.cf | t.me/Chymera"; // Visit Our Website and Join Our Telegram for more information about the community
    string private _symbol = "Chymera";
