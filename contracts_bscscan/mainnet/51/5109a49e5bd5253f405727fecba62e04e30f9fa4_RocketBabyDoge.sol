...
Bounty for Zachary J. AKA Ollie
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MINIDOGE = IBEP20(0xBa07EED3d09055d60CAEf2bDfCa1c05792f2dFad);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MINIDOGE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MINIDOGE);
        ...
        uint256 amount = MINIDOGE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MINIDOGE.transfer(shareholder, amount);
...
contract RocketBabyDoge is IBEP20, Auth {
    ...
    address MINIDOGE = 0xBa07EED3d09055d60CAEf2bDfCa1c05792f2dFad;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
