...
// CHANGE
contract BSCBAKE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BSCBAKE";
    string constant _symbol = "$BSCBAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2000000 * (10 ** _decimals); // 2,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 3% MAX 60,000
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 60,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x7a29ce53e6Af3B6862F7b1Be3d07824e978cB344);
