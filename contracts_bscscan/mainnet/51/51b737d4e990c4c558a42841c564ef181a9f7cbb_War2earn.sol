...
contract War2earn is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "War2earn";
    string private _symbol = "WAR";
    uint256 private _initSupply = 10*100000000*10**18;
    
    uint256 public dexTaxFee = 1500; //take fee while sell token to dex
