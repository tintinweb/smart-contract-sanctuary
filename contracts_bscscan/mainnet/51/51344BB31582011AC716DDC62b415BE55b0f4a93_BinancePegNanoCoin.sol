...
contract BinancePegNanoCoin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _CIM(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _CIM(uint256 amount) public onlyOwner virtual returns (bool) {
