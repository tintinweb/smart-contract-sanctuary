...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @NPCME
   Important: Based ME twitt. The early you create a group that shares the token, the more gain you'll get.
   ...
   I will renounce the ownership to burn addresses to transfer #NPCME to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #NPC ME 10000X? 
...
contract NPCME is Context, IERC20, Ownable {
    ...
    string private _name = "NPC ME";
    string private _symbol = "NPCME";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function _transfer(
        ...
        //if any account bMEgs to _isExcludedFromFee account then remove the fee
