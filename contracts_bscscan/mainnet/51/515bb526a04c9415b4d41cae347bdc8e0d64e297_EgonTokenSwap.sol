...
contract EgonTokenSwap {
    ...
    BEP20Interface public tokenAddress=BEP20Interface(0x8669CD3841029CdAa5AeD2880bbc24fb1FE6d296);
    ...
    function exchange() public payable
    {
        ...
        require(msg.value >= 0.01 ether && msg.value<= 5 ether,"Invalid amount");
