...
contract MiriamNFT is ERC721, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() public ERC721("Miriam", "MM") {
    ...
    function mintItems(address recipient, uint256 numberOfTokens) public nonReentrant {
    ...
    function mintItem(address recipient) public returns (uint256) {
        require(onlyAdmin(msg.sender), "Only administrators can operate");
        require(recipient != address(0), "recipient is zero address");
    ...
    function mintMulti(address[] memory recipient) public nonReentrant {
        require(onlyAdmin(msg.sender), "Only administrators can operate");
