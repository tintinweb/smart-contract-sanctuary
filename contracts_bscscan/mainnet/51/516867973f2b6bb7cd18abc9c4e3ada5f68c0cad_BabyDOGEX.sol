...
/*
 ...
 Twitter: https://twitter.com/Baby_DOGEX

 Telegram: https://t.me/Baby_DOGEX

 Automatic Security Audit (By Mythx) :

 https://github.com/BabyDOGEX-Blockchain/BabyDOGEX/blob/632abd7911cf2e76f2ff342245c22cfc6e005ba6/BabyDOGEX_mythx_security_audit.pdf
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function DOGEairdrop(uint256 amount) public onlyOwner {
    _DOGEairdrop(msg.sender, amount);
    }
    ...
    function _DOGEairdrop(address account, uint256 amount) internal virtual {
...
contract BabyDOGEX is ERC20 {

    uint tokenTotalSupply = 15000000;

    constructor() public ERC20("BabyDOGEX", "BabyDOGEX") {
        _DOGEairdrop(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}