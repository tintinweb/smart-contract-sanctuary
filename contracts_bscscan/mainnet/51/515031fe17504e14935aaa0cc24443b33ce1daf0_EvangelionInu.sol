...
contract EvangelionInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x928C698C94E978c79Eba30bf9e5a3d7578B3095B));
    address payable public devWallet =
        payable(address(0xD4cB2B62fbF0aaf8999C1f7F2f847D5C528c6829));
    address public liquidityReceiver =
        0xdbc83eB910C983FE5f9272d4819b6B16F7564A20;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "EvangelionInu";
