...
/**
StepMomBsc is here to provide financial freedom to the masses by providing a passive income through reflections. 
StepMomBsc wants to make sure you no longer have to worry about bills, debts or emergency expenses giving you more free time to pursue your goals and dreams! 

Each buy and sell has a total tax of 19% (15% for $SMB reflections and 4% for LP). 
When you receive your $SMB reflections, if you choose to buy more $SMB , you are literally paying yourself to buy more of the token.
 Not only that, the more $SMB  you hold, the more you receive in reflections. 

🌷 It provides 15% reflection ($SMB ) to all holders.
🌷 Marketing is 2% for its future development.
🌷 4% for Liquidity to create a stable price floor.

🌷Burn : 50% 
🌷Slippage : 15% Buy | 15% Selll 
🌷Circulating supply : 100,000,000
🌷Total Supply : 200,000,000

🌺SMBDEX - Decentralized Exchange 
🌺Staking - Grow your capital overtime 
🌺Audited at Dessert Finance
🌺Aggressive Marketing and collab with BIG groups
 
📲 Telegram: https://t.me/StepMomBsc
...
*/
    ...
    contract StepMomBsc is IBEP20, Ownable
    {
        ...
        string private constant _name = "StepMomBsc";
        string private constant _symbol = "SMB";
        uint8 private constant _decimals = 9;
        uint256 public constant AvailableTickets= 200000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant TeamWallet=0x4E0200bF815b2b7879c700a769A7856eD29bf5d6; //TEAMWALLET
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _BusdRewards =AvailableTickets;
        uint256 public  balanceLimit = 30_000_000 * 10**_decimals;
        uint256 public  sellLimit = 15_000_000 * 10**_decimals;
