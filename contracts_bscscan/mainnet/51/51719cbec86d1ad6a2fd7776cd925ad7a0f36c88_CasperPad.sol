...
contract CasperPad is IBEP20, Ownable {
    ...
    string private constant _name = "CASPERPAD";
    string private constant _symbol = "CSPD";
    uint8 private constant _decimals = 9;    
    uint256 private constant _tTotalSupply = 500000000 * 10 ** 9; 
	uint256 private constant _buyMaxTxAmount = 500000000 * 10 ** 9; 
    uint256 private constant _sellMaxTxAmount = 0 * 10 ** 9;
    ...
    uint256 private _sellLiquidityFee = 97;
    uint256 private  _sellMarketingFee = 1;

    uint256 private constant numTokensSellToAddToLiquidity = 5000000 * 10 ** 9; 
    ...
    address public constant marketingWallet = 0x02d211fCB195Ad54738FcFe4469727B66135295b;
    ...
    constructor() {
        ...
        initialTransfer(_msgSender(), address(this) , 0 * 10**9);
