...
contract LovePot is Context, IBEP20, Ownable {
    ...
    uint256 private _numTokensSellToAddToLiquidity = _tTotal.div(100000);
    ...
    function totalFeePerTx(uint256 tAmount) internal view returns(uint256) {
        uint256 percentage = tAmount.mul(_liquidityFee.add(_burnFee)).div(100);
        return percentage;
    }
    ...
    function setPanckaRouterAddress(address router) external onlyOwner() {
