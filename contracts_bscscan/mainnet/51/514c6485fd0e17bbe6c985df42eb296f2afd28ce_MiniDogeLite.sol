...
contract MiniDogeLite is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public devAddress = payable(0xA952fB174597897CBb9713Ca1E6d542b1Ed8B4Bc); // dev Address
    ...
    string private _name = "Mini Doge Lite";
    string private _symbol = "MDOGELITE";
