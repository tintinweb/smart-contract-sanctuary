...
/**
KELCHI Finance
Twitter: https://twitter.com/KelchiFinance
Telegram: hhtps://t.me/KelchiFinance
Website: kelchi.online
 */
...
contract KELCHIFinance is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KELCHI Finance";
    string constant _symbol = "KELCHI";
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountKELCHI);
