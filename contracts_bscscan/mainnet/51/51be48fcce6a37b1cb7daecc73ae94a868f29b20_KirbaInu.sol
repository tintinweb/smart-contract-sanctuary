...
contract KirbaInu is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x2686EDDf2564F69e6E9fBC37B4A79a05BdDf0c43);
    ...
    string private _name    = "Kirba Inu";
    string private _symbol  = "KIRBA";
