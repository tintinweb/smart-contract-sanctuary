...
contract ADAMOON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ADAMOON";
    string constant _symbol = "ADAMOON";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xD661cd27E45c3F10db64FfaE289443E36a31A0B9;
        ...
        uint marketingFee = _totalSupply.div(20); //1% of total supply to YOLO DAO
