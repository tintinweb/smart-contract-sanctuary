...
contract BitBite is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd28B573b38B16453ECd71dd4E309368e19F00A63); // Marketing Address
    ...
    uint256 private _tTotal = 1 * 10**9 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "BitBite";
    string private _symbol = "BitBite";
