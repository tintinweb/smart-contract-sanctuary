...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract CheemsBurbger is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xc76dB1afC12ded08AF9DE32aB93939b22f6f6319); // Marketing Address

    address payable public teamAddress =
        payable(0x5745354A2237450F32aEFF5e77D7aC207E09dd14); // Team Address

    address payable public liquidityAddress =
        payable(0x5745354A2237450F32aEFF5e77D7aC207E09dd14); // Liquidity Address
    ...
    string private constant _name = "CheemsBurbger";
    string private constant _symbol = "Burbger";
