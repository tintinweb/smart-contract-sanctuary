...
contract AlbertaFoodcourtBUSDLP is IAlberta, Ownable, ReentrancyGuard {
    ...
    IUniswapV2Factory public constant FACTORY = IUniswapV2Factory(0xc801C7980c8C7900Bc898B1F38392b235fF64097);
    IUniswapV2Router02 public constant ROUTER = IUniswapV2Router02(0x0F4610aB02920a99f639F675085A5d3e24b0D7ae);
    ...
    function add(
        ...
        IUniswapV2Pair lpToken = IUniswapV2Pair(_wantToken);
    ...
    function _safePriceImpactSwap(
        ...
        for (uint256 i; i < _path.length - 1; i++) {
            (uint256 rIn, uint256 rOut) = FoodcourtLibrary.getReserves(address(FACTORY), _path[i], _path[i + 1]);
            uint256 q = ROUTER.quote(_amountIn, rIn, rOut);
            uint256 out = FoodcourtLibrary.getAmountOut(_amountIn, rIn, rOut);
