...
contract FlokiOneDollar is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xa410d873f76A516580bB9340fFbf58eB6Ae5c02b); // Marketing Address

    address payable public teamAddress =
        payable(0xa410d873f76A516580bB9340fFbf58eB6Ae5c02b); // Team Address

    address payable public liquidityAddress =
        payable(0xa410d873f76A516580bB9340fFbf58eB6Ae5c02b); // Liquidity Address
    ...
    string private constant _name = "Floki1$";
    string private constant _symbol = "Floki1$";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 100 / 1000; // 1,25% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 100 / 1000; // 2.5% maxWalletToken
