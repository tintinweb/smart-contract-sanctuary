...
contract StGB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0x68EbecAaEAE3656D0840008c03a1A7C67F877b70);
    ...
    string private _name = "strength gourd baby";
    string private _symbol = "StGB";
