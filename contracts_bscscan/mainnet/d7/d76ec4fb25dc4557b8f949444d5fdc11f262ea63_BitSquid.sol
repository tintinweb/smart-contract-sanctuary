...
10% Reflections in Bitcoin
Hold BitSquid to earn BTC
...
contract BitSquid is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x6d5CBc8eE101d0Ee0aCDD165886FA43d0E2Cd2F9);
    ...
    */
    ...
    string private _name = "BitsQuid"; 
    string private _symbol = "BITSQUID";  
