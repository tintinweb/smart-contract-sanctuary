  ...
  CoinDexTools
{
  ...
  function __MemeWarsPresenter_init(
    ...
    updateTaxInfo(200, 100, 100, true);
  ...
  function receiveTokens(
    ...
    if (flags[8] || flags[4] || isInsideTrigger) {
      ...
      if (isAutoLP && (flags[7] || flags[6]) && buybackTax.pending > 0) {
   ...
   * @param _isAutoLP auto add LP on transfer and sell
   */
  ...
  function _solvePendingBuyback() private {
    if (buybackTax.pending > 0) {
      ...
      IERC20(buybackToken).transfer(teamAddress, buybackAmount_);
