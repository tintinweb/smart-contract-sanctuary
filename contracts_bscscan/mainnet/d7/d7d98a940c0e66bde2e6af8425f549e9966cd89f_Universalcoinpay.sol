...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFB2E3E2F7faE2552F7C9AfEa0D456794Ff02ce09;
...
contract Universalcoinpay  is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFB2E3E2F7faE2552F7C9AfEa0D456794Ff02ce09;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Universalcoinpay";
    string private _symbol = "UCP";
