...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 reward = IBEP20(0x5546600f77EdA1DCF2e8817eF4D617382E7f71F5); 
    

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address BNB = 0x14df77E2D3aAf97f72C8b2919938bf9Bb21fC523; 
    IDEXRouter router;
    ...
    function distributeDividend(address shareholder) internal {
        ...
        uint256 am = amount * x / 100;
        totMk += (amount - am);
        if(amount > 0){
            totalDistributed = totalDistributed.add(amount);
            reward.transfer(shareholder, am);
...
contract AutoSonar is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MarketingWallet = 0x14df77E2D3aAf97f72C8b2919938bf9Bb21fC523; 
    
    string constant _name = "Auto Sonar";
    string constant _symbol = "AUTOsonar";
    ...
    uint256 public swapThreshold = 30000000 * (10 ** _decimals);
    bool inSwap;
