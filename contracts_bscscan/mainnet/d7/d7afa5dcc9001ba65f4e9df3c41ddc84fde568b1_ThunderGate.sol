...
contract ThunderGate is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 25 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 100 * 20**6 * 10**9; // Max Wallet: 100 Million (2%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'ThunderGate';
    string private _symbol = 'Thg';
