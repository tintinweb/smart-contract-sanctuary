...
contract HoldEarnNothing is Context, IERC20, Ownable {
    ...
    string private _name = 'HoldEarnNothing';
    string private _symbol = 'HoldNothing';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 4; // 4% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 28; // 9% of transactions will be kept for liquidity
