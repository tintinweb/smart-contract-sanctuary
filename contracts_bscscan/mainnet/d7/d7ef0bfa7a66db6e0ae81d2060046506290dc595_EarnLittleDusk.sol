...
Earn Duck every 1 hours
	...
	contract EarnLittleDusk is Context, IERC20, Ownable {
		...
		string private _name = "EarnLittleDusk";
		string private _symbol = "EarnDusk";
		...
		uint256 public _maxTxAmount = 8* 10**13 * 10**9;
