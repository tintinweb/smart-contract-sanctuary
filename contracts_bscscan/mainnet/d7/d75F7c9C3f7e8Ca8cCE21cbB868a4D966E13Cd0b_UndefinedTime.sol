...
contract UndefinedTime is IBEP20, Ownable {
    ...
    //Token Info
    string private constant _name = 'UndefinedTime';
    string private constant _symbol = 'UndefinedTime';
    ...
    uint256 public antiDumpPercentage = 35 * 10;
    ...
    uint public liquidityTax=5 * 100;
    uint public marketingTax=5 * 100;
    uint public teamTax= 1 * 100;
    uint public rewardsTax = 2 * 100;
    ...
    address public marketingWallet = payable(0x0Dd3b3ad07cdb5640cf3aBAa94f3c35E449AEC15); // Marketing Address
