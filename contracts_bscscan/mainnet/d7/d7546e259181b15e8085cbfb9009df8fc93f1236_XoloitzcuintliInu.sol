...
contract XoloitzcuintliInu is Context, IERC20, Ownable {
    ...
    string private _name = "Xoloitzcuintli Inu";
    string private _symbol = "XOLOINU";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xf2bB061A941a4A04aF58A9975328c852a780E5F9);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 120 * 10**9 * 10**_decimals;
