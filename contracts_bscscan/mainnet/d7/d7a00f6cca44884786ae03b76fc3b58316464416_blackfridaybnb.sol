...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  MATIC = IBEP20 (0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    uint256 public minDistribution = 0.005 * (10 ** 18);
...
contract blackfridaybnb is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

        string constant _name = "Black Friday BNB";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 3000; // 0.1% of supply
    bool inSwap;
