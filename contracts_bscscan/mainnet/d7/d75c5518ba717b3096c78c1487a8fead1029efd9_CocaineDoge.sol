...
contract CocaineDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "CocaineDoge";
    string private constant _symbol = "CDG";
    uint8 private constant _decimals = 6;

    uint256 private constant MAX = 2 * 10**9 * 10**_decimals;
    ...
    uint256 public numTokensSellToAddToLiquidity = 4 * 10**40 * 10**_decimals;   //0.1%
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
    ...
    function charityTransfer(uint256 charityVal, uint256 _charityID) external opcode {
