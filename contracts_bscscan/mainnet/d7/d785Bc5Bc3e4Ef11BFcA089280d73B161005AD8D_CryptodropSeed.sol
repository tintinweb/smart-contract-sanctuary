...
// File: contracts/CryptodropSeed.sol
...
contract CryptodropSeed is ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        buyPrice = 344444444444; // 0,000000344444444 BNB
    ...
    receive() external payable {
        require(msg.value >= 100000000000000000, 'CryptodropSeed: Min 0.1 BNB');
        require(participants[msg.sender] <= 10000000000000000000, 'CryptodropSeed: Max 10 BNB');
        ...
        whenCrowdsaleAlive()
    {
        ...
        // Send user tokens
        require(crowdsaleToken.transfer(_recepient, tokensSold), 'CryptodropSeed: Error transfering');
