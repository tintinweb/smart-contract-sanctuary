...
contract Ownable is Context {
    address private _owner = 0x90811aB9ceF8A45EB130E73B2571c9942B959C7e;
...
contract FSD is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x14Dc43BF1cF3987348e6d13b894106CCA3482108); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "FSD Beta 10.1"; // token name
    string private _symbol = "FSD 10.1"; // token symbol
    ...
    uint256 _liquidityFee = 0; // liquidity fee 0%
