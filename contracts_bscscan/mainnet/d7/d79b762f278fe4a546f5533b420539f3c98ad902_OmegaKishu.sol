...
/**
 *Submitted for verification at BscScan.com on 2021-15-09
*/
...
Omega Kishu (O KISHU!)  Token
Strong Marketing Plan 
 5% Liquidity | 10% Marketing
.
 TG: https://t.me/OmegaKishu
...
contract OmegaKishu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Omega Kishu";
    string constant _symbol = "O Kishu!";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 1000; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1097c1c85A4c77BA7Cfa9abA84A85130e113FCBd; 
