...
/*
  ...
  # Matrimony Token features:
   ⤏ Liquidity pool is locked 
   ⤏ Ownership will be renounced after presale
   ⤏ Release will be on PancakeSwap V2
   # Website : matrimony.life
	2% tax is collected and distributed to holders for HODLing
	9% buyback and marketing tax is collected and 3% of it is sent for marketing fund and other 6% is used to buyback the tokens
...
contract Matrimony is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xba65DDa7b55A08B670521f58f08aF2aF49237C5E); // Marketing Address
    ...
    string private _name = "Matrimony";
    string private _symbol = "MATRIMONY";
