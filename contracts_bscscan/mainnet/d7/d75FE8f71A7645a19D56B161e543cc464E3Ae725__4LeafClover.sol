...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFD47e6305fc8057538978bBdF27B64e51597f120;
...
contract _4LeafClover is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5FAE385f602F902C2b203528Fef5A3fF4D49332e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "4 Leaf Clover";
    string private _symbol = "4LeafClover";
