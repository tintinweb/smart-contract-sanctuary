...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public ADA = IBEP20(0x12BB890508c125661E03b09EC06E404bc9289040);
...
contract NanoRaca is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "NanoRaca";
    string constant _symbol = "NanoRaca";
    ...
    uint256 public _maxWallet = 39 * (10**9) * (10 ** _decimals);
