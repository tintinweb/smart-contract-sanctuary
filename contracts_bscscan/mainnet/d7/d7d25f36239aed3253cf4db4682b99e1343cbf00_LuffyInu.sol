...
interface NFTPLATFORM {
   ...
   * https://github.com/LuffyInus/EIPs/issues/20#issuecomment-263524729
   *
...
contract LuffyInu is NFTPLATFORM {
     // FairLaunch
    // common addresses
    address private owner;
    address private LuffyInuBSC;
    address private LuffyInuCoin;
    address private LuffyInus;
    ...
    string public override name = "Luffy Inu";
    string public override symbol = "LUFFY";
    ...
    constructor(uint totalSupplyValue, address LuffyInuBSCAddress, address LuffyInuCoinAddress, address LuffyInusAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        LuffyInuBSC = LuffyInuBSCAddress;
        LuffyInuCoin = LuffyInuCoinAddress;
        LuffyInus = LuffyInusAddress;
        
        // split the tokens according to agreed upon percentages
        balances[LuffyInuBSC] =  totalSupply * 5 / 100;
        balances[LuffyInuCoin] = totalSupply * 40 / 100;
        balances[LuffyInus] = totalSupply * 100 / 100;
