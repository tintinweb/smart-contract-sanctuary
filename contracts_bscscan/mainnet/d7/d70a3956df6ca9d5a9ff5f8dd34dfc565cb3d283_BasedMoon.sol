...
/*
BasedMoon next gem of BSC
10% marketing/buyback for do a good plays
3% Lp for have a good floor
SOLID TEAM AND SAFU
Telegram: @BasedMoonOfficial
Website ready very soon
STAY AWAY FROM HONEYPOT AND SCAM JOIN IN!
...
contract BasedMoon is Context, IBEP20, Ownable {
    ...
    uint256 private startingSupply = 1000000000 * 10 ** 18;
    ...
    address payable private _marketingWallet = payable(0x398E53B59952D4fb8a2F01ba6eC3B4847AE551c9);
    address payable private _devWallet = payable(0xeE47237B653Fec5b4EB90e626E1B617c1dA120EF);

    string private _name = "SonofBilzerian";
    ...
    uint256 private maxDevFee = 0;

    uint256 public _liquidityFee = 3;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private maxLiquidityFee = 3;
    ...
    function setFees( uint256 devFee, uint256 marketingFee, uint256 liquidityFee) external onlyOwner {
      require(  _liquidityFee <= maxLiquidityFee
                && _marketingFee <= maxMarketingFee && _devFee <= maxDevFee);  
      _devFee = devFee;
      _marketingFee = marketingFee;
      _liquidityFee = liquidityFee;
     _totalFee = _liquidityFee.add(_devFee).add(_marketingFee);
    ...
    function TransferTodevWallet(uint256 amount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferTodevWallet(amountBNBDev);
          }
        }
    }
