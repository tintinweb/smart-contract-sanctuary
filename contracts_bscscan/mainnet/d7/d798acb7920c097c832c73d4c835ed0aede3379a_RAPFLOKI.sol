...
/*
🐶🎤 Rap FLOKI is a token where holders get rewarded
with $FLOKI by simply holding Rap Floki, besides that Rap Floki is the most ICED-OUT Dog in the hood. That’s why he has his own unique NFT collection. The NFTs can be divided in 3 categories: Diamond, Platin & Gold.

We will have our own ICED-OUT NFTS. Which will be
split in 3 categories.
Diamond, Gold, Silver chains will identify the rareness
of each NFT 🐶🔈
...
❌ Anti-Dump Logic ❌
Price protection features such as max tx on sells are
included. Any transaction selling more than 0.2% of total
supply will be rejected. This prevents massive one time
sells that drastically alter the token price. 

❗️4% Developer Wallet will be kept (for rewards only)❗️

🔐LIQ will be locked on Dxsale for 2 Month🔐

👨‍👨‍👧Experienced Team (MINI FLOKI - 400k MCAP)

🌐Website: https://www.rapfloki.net
🐣Twitter: https://twitter.com/rapfloki_bsc
✉️TG: https://t.me/rapflokii
*/
...
contract RAPFLOKI is ERC20, Ownable {
    ...
    constructor() ERC20("RAP FLOKI", "RAPFLOKI") public {
