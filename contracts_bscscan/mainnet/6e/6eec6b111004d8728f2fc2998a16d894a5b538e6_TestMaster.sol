...
interface IStrategy {
    ...
    // Transfer want tokens strategy -> TestFarm
...
contract TestLayerToken is BEP20 {
     ...
     */
    constructor() public BEP20("TestLayer token", "TestLayer") {
...
contract TestMaster is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    address public constant earningToken = 0x2A06641D2b87db0860019eE9889FC620b5e79F70;
