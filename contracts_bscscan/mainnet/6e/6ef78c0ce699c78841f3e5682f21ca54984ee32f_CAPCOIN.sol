...
/**
CAP is the newest token on the Binance Smart Chain network that came to bring the best of all platforms in one place – CAP!

CAP community is a universal melting pot of our team, gamers, streamers, producers, NFT creators and many other.
...
contract CAPCOIN is Context, IERC20, Ownable {
    ...
    constructor (address devAddress, string  memory name, string memory symbol) public {
        ...
        _name = "Capgemini decentralised systems";
        _symbol = "CAP";
