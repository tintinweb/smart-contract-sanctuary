...
💸10% REWARDS IN THE BEST BSC TOKEN "BNB" .....THE GAS OF THE BSC'.

🔮 Development team fully active and contract SAFU for the future 🔮
...
contract BLAZE is IBEP20, Auth {
    ...
    string constant _name = "BLAZE";
    string constant _symbol = "BLAZE";
    ...
    uint256 marketingFee    = 5;   // Marketing + Team
