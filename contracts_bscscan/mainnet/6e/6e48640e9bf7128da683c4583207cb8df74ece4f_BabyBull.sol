...
$BABYBULL Enhanced Features & Tokenomics:
- New "BABYBULL" function; allows the community to vote and spend a specified amount of the Whale's BNB balance in a buyback, regardless of market conditions.
...
contract BabyBull is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0329B4706243f627C6af4Db6468D1ac7aE464BE3); // Marketing Address
    ...
    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**9; // 1 trillion, or 0.1% of total supply
