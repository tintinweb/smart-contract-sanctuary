...
We‘re based in Switzerland and our company focusing on E-Commerce was one of the fastest growing StartUps in Switzerland with more than 5M USD in sales in the first year. Our team is tech savvy with experience in influencer marketing and other traffic methods.
We‘re supporting and investing in Bitcoin since 2017 and then we saw this opportunity to start NFT Global.

Our goal is to build the biggest NFT Market (available in 20 different languages). With the general market trend and our organic marketing strategy we aim to get 10‘000‘000 active users until 2023.  
*/
