 ...
 */
 ...
 contract DNPM is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("DNP Market", "DNPM") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x40D661EE82365C19b5685Ce127AD6db1F71652d9); 
          _setupRole(MINTER_ROLE, 0x40D661EE82365C19b5685Ce127AD6db1F71652d9); 
          _setupRole(MINTER_ADMIN_ROLE, 0x40D661EE82365C19b5685Ce127AD6db1F71652d9); 
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "https://ipfs.io/ipfs/";
          transferOwnership(0x40D661EE82365C19b5685Ce127AD6db1F71652d9);  
     }
     ...
     function mint_by_id(address to, uint256 tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "DNPM/minter-role-required");
         _mint(to, tokenId);
     }      
     /**
