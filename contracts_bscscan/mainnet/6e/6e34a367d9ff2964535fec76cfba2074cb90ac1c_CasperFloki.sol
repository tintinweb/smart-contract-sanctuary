...
CasperFloki (BOO)
Meet CasperFloki – Runs on the Binance Smart Chain! Your favourite ghost is on a journey to the moon! CasperFloki is bringing the global community together by launching the world’s best ghost-friendly token.
...
contract CasperFloki is ERC20Detailed, Ownable {
...
*/
    constructor() ERC20Detailed("CasperFloki", "BOO", uint8(DECIMALS)) {
