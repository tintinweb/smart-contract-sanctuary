    ...
    UUPSUpgradeable
{
        ...
        public
    {
        ...
        require(apeOwnerAddress[apeNftId] == _msgSender() || apeOwnerAddress[apeNftId] == address(this), "Ape owner failed");
    ...
    function claimBuildingRewards(
        ...
        if (apeid1 != 0) 
        {
            claim(apeid1, buildingId);
        }
        if (apeid2 != 0)
        {
            claim(apeid2, buildingId);
        }  
        if (apeid3 != 0)
        {
            claim(apeid3, buildingId);
        }
    }
    ...
    function evolve(
        ...
        if (address(msg.sender) != this.owner()) {
            require(
                apeInstance.deltaStack(nftID) >= 1296000,
                "farming period is below 15 days"
            );
        }
