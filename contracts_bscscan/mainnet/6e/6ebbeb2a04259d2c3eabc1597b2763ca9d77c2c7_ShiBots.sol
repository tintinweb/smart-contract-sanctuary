...
telegram: https://t.me/shibotsBSC
website: https://shibots.digital/

SHIBOTS are a collection of 8000 programmatically generated NFT collectables living on the Binance Smart Chain blockchain. 
Each one has been generated at random, except for the extremely rare SHIBOT sets, from a selection of over 240 traits, making each image unique! 
Traits include heads, eyes, bodies, legs, backgrounds, and more!

keep your eyes peeled for cool accessories, rare backgrounds, and one-off complete character sets.

Study and discover the SHIBOT collection, some NFT images even conceal hidden references and meanings. See if you can work out what they are!

Purchase below and own your very own piece of internet history!
*/
...
contract ShiBots is IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = (_totalSupply * 200) / 1000; // 2% of total supply
