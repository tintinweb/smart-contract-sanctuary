...
/**
    //Stealth launched - $NiceKishu
    //Low Mcap
    //Lp Locked
    //Ownershib Renounced
    Telegram: https://t.me/NiceKishuelon
...
contract NiceKishu is Context, IERC20, Ownable {
    ...
    string private _name = "Nice Kishu";
    string private _symbol = "NiceKishu";
    ...
    uint256 public maxBuyTranscationAmount = 20000 * 10**18;
    uint256 public maxSellTransactionAmount = 10000 * 10**18;
    uint256 public _maxWalletToken = 50000 * 10**18;
    uint256 private minimumTokensBeforeSwap = 7596 * 10**18; 
