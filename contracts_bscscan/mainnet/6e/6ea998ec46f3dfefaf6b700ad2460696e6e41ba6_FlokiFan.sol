...
Starting with low market cap.

TG: https://t.me/FlokiFanBSC
*/
...
contract FlokiFan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x0B4538d052419AEC668312959cEB2De76Ea801a8); // Marketing wallet Address.
    ...
    uint256 public _maxTxAmount = 5_000_000_00 * 10**18;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 __totalFees = _liquidityFee.add(_marketingFee);
        uint256 halfLiquidityTokens = contractTokenBalance.div(__totalFees).mul(_liquidityFee).div(2);
        ...
        uint256 bnbForLiquidity = newBalance.div(__totalFees).mul(_liquidityFee).div(2);
    ...
    {    
        ...
        _maxTxAmount = 5_000_000_00 * 10**18;
    }
