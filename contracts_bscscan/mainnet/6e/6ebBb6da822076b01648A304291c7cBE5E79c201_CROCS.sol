...
// SPDX-License-Identifier: Meta Crocs
// S33 Y0U 1N TH3 M3T4 V3R53
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCFD6A4F314cAdacF40f75908C33fE16d8025d25e;
...
contract CROCS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x220F2f72f665A41cA463c6679251B4d71120E582;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**19;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Crocs";
    string private _symbol = "CROCS";
    uint8 private _decimals = 19;
    uint256 public _taxFee = 30;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 45;
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**19;
    uint256 private numTokensSellToAddToLiquidity = 1000000000 * 10**19;
