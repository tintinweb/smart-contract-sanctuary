...
// MasterChef is the master of JAVA. Farms & pools
//
...
contract MasterChef is Ownable {
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken, uint16 _depositFeeBP, uint16 _withdrawFeeBP, uint256 _lockTime, bool _withUpdate) public onlyAdmin {
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint16 _depositFeeBP, uint16 __withdrawFeeBP, uint256 _lockTime, bool _withUpdate) public onlyAdmin {
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if(_amount > 0) {
            ...
            totalStakedAmount[_pid] = totalStakedAmount[_pid].sub(user.amount);
            ...
            totalStakedAmount[_pid] = totalStakedAmount[_pid].add(user.amount);
        }
