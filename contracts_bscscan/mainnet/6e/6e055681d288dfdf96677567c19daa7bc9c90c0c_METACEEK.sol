...
contract METACEEK is Context, IBEP20, Ownable {
    ...
    string public constant name     = "MetaCeek";
    ...
    // buy fee
    uint256 public _taxFeeBuy       = 500; 
    uint256 public _liquidityFeeBuy = 300; 
    uint256 public _marketingFeeBuy = 700; 

    // sell fee
    uint256 public _taxFeeSell       = 800; 
    uint256 public _liquidityFeeSell = 800; 
