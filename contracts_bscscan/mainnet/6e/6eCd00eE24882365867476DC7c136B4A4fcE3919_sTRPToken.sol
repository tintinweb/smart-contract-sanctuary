...
contract sTRPToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 20000000 * 10**9;
    ...
    constructor() ERC20("Staked TRP", "sTRP", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTRP supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTRP
