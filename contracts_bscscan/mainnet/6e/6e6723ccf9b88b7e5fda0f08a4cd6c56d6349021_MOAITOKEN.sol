 ...
 * MOAI TOKEN
 * Symbol : MOAI
 * Telegram : @moaitokenbsc
 * 
 * Built for the community. 
 * Simply hold MOAI to join the journey and experience all of the benefit from MOAI TOKEN.
 * 
 * 100% Unruggable
 * --------------- 
 * We will lock 100% LP on CyberNetwork right after adding liquidity.
 * You are safe with MOAI TOKEN!
 * 
 * Stabilizes Price
 * ---------------- 
 * MOAI TOKEN adds 5% of each transaction to the liquidity pool 
...
contract MOAITOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "MOAI TOKEN";
    string private _symbol = "MOAI";
    ...
    address public marketingWallet = 0xE0eb64091deA10ab9dA39C2CBe39634dd7f589aD;
