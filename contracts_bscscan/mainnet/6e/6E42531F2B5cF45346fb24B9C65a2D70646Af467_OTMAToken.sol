...
contract OTMAToken is Context, IERC20, Ownable {
    ...
    string private _name = "OTMA3.0";
    string private _symbol = "OTMA3.0";
    ...
    address public ownerAddres = address(0x22633e7d4bc27fD46A919d3Ba50441205669AAD0);
    address public devAddress = address(0xaA0Dc3CEdEA84BFAf5ef6d40598954E0b793dA05);
    address public foundAddress = address(0xAE368b9CF4FAa2138e271949FE407480fA546f89);
    ...
    constructor () public {
        ...
        _isExcludedFromFee[burnAddress] = false;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 1000 * 10 ** 18 && !_isExcludedFromFee[sender]) {
