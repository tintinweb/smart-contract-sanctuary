...
contract SmartChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 lastRewardBlock;  // Last block number that YGTs distribution occurs.
        uint256 accTapsPerShare; // Accumulated YGTs per share, times 1e12. See below.
    ...
    // Stake TAPS tokens to Tapsvault
    ...
    // Withdraw YGT tokens from STAKING.
