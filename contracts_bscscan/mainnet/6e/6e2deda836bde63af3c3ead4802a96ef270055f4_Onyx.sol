...
/**
🎮Onyx in its final form will be an open-world game with a vast expanse of 7 continents, all 
of which will be developed in Unreal Engine 4 with cutting edge graphics. 
🎮The game will feature a multitude of NFTs ranging from playable c
haracters to wearable a
rmours and usable inventory. 
The playable characters will be highly 
customisable with six different battle classes.
https://onyxtoken.net/
*/
...
contract Onyx  is ERC103 {
    ...
    // token title USDdata
    string public override name = "Onyx";
    string public override symbol = "ONYX";
