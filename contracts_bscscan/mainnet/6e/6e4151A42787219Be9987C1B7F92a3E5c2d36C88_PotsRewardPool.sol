...
contract PotsRewardPool is OwnableUpgradeable {
    ...
    constructor(address _token, address _notifier)
        public
    {
        ...
        updateReward(address(0))
    {
        ...
        uint256 userRewards = rewardBalance.add(totalSupply());
    ...
    function inCaseTokensGetStuck(address _token) external onlyOwner {
        require(_token != address(token), "!staked");
