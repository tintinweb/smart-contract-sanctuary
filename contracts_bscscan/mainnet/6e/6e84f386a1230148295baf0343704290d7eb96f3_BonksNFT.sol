...
contract BonksNFT is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BonksNFT";
    string constant _symbol = "BONKSNFT"; 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xf172C9008318C6b6d2aD855bE55b92c336B8DD8D ;
        marketingFeeReceiver = 0x96baaa5Caa5A8638348b28996CB718f55291614e ;
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(0x96baaa5Caa5A8638348b28996CB718f55291614e).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(0x96baaa5Caa5A8638348b28996CB718f55291614e).transfer(amountBNB * amountPercentage / 100);
    }
