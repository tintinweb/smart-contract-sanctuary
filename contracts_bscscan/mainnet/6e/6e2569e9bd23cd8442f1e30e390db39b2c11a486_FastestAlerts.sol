...
contract FastestAlerts is IBEP20, Ownable {
    ...
    string private constant _name = "Fastest Alerts 0xFed7A9ED8535EA78D8b992B4D28f499CDDeaf01A";
    string private constant _symbol = "FA";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 100000000 * 10 ** 9;
    uint256 private _buyMaxTxAmount = 100000000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 100000000 * 10 ** 9;
    ...
    //25% Sell Tax At Launch
    uint256 private _sellTaxFee = 0;
    uint256 private _sellLiquidityFee = 25;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 200000000000000, "Can not reduce below 10K");
        require(maxSell > 200000000000000, "Can not reduce below 10K");
