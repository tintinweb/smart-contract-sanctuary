...
contract Lottery is Ownable, Pausable, ReentrancyGuard {
    ...
    event LastDrawUpdated(uint256 poolId, uint256 timestamp);
    ...
    function setLastDraw(uint256 poolId, uint256 timestamp) external onlyOwner {
        poolLastDraw[poolId] = timestamp;
        emit LastDrawUpdated(poolId, timestamp);
    }
