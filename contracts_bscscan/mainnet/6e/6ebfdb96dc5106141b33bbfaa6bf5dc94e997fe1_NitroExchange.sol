...
/**
📊Nitro Exchange Trading and Investing in one hand📊

📌 SAVE THE DATE
      FAIR LAUNCH TODAY     january 16.00 PM UTC

 NITRO EXCHANGE is a platform centralized exchange with complete features....
...
https://t.me/nitroexchangeofficial
https://nitroexchange.space
*/
...
contract NitroExchange is Context, IBEP20, Ownable {
    using SafeMath for uint256;
	uint8 private decqkdiixlojcsb = 18;
	uint256 private totlqxjorcakdtie = 1000000000 * 10 ** decqkdiixlojcsb;
	uint8 internal _sta = 3;
	mapping (address => uint256) private selbgadnahemozktiop;
	string private constant nambixqekienal = "$Nitro Exchange";
	string private constant symwaoefitszcykroiglxedbnqjamph = "$Nitro";
