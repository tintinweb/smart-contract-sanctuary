...
King Tiger INU
   ...
   *STEALTH LAUNCH
   *
    6% fee is added to the kingTiger INU marketing wallet as BNB 
    2% is reflected to holders
    4% is added to LP
    https://t.me/kingtigerinu
*/
...
contract KingTigerinu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KingTigerINU";
    string private _symbol = "$KTI$";
