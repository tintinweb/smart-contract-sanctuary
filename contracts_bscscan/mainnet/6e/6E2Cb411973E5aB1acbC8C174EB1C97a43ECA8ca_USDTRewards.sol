...
/*
                                     USDT REWARDS
Simple and profitable. HODL USDTREWARD token and earn USDT Tokens rewards diviedends
-----------------------------------------------
TELEGRAM -> https://t.me/usdtrewardtoken
-----------------------------------------------
SAFU -> LP LOCKED at launch
LEGIT -> Stealth Launch right now
FUTURE -> Roadmap and website avaible soon 
-----------------------------------------------
...
contract USDTRewards is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "USDTRewards";
    string constant _symbol = "USDTRewards";
