...
'  `'-'` '   .'|  '/           |   /              `                    |  |   |  | 
          `-'  `--'            `'-'                                    '--'   '--'
   $BUILTCOIN FOR YOU, FOR ME, FOR THE EARTH 
...
contract BuiltCoin is Context, IERC20, Ownable {
    ...
    uint256 public _marketingFee = 6; // 4% dedicated for charity, 2% dedicated for project expansion
    address public marketingWallet = 0x383EE480e96426a8100Dec99b7e5d111524e9C09;
