...
/**
ANYClaimCoin – A reward crypto that allows you the holder to be rewarded how you want.
...
contract AnyClaim is IBEP20, Ownable
{
    ...
    uint16 public constant MaxSellLockTime= 12;
	//Buyers get locked for MaxBuyLockTime so they can't buy repeatedly
    uint16 public constant MaxBuyLockTime= 12;
    ...
    address public walletTwo=payable(0x65a89aB0402596cbDbF779dD8455B821109B6F14);
    //TestNet
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 3300000 * 10**_decimals;
