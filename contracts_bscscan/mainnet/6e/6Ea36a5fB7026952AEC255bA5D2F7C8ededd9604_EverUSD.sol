...
/**
    Ever USD is the newest BSC gem
    This project was launched as a fairlaunch and will be community run.

    Some features of Ever USD token:
    
    14% FEES PER TRANSACTION
    - 5% fee per transaction auto add to the buy back feature
    - 3% fee per transaction auto distributed to holders in BUSD
    - 2% fee per transaction auto distributed to marketing wallet
    - 2% fee per transaction auto distributed to development
    - 2% fee per transaction auto distributed to liquidity
    
    Ever USD Token will start with 2 BNB in liquidity so no whales will be present.
    As more holders buy, you can then increase your buy orders.
    
    1,000,000,000,000,000 total supply (1 Quadrillion).
    30% burned at launch.
    
    TELEGRAM: https://t.me/EverUSD
    WEBSITE: https://www.EverUSD.com/
 */
...
contract EverUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ever USD";
    string constant _symbol = "EverUSD";
