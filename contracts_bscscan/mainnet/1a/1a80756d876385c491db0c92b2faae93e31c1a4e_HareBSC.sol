...
contract HareBSC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0x7275ec3Bb85DF0778E6ec9d0046BF528E121aF30); // Marketing Address
    ...
    uint256 public _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Hare BSC";
    string private _symbol = "HARE";
...
uint256 private _taxFee = 2;
    ...
    uint256 private marketingDivisor = 7;
    
    uint256 public _maxTxAmount = 10000000000000000 * 10**18; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = 5000000000000 * 10**18; 
    uint256 private buyBackUpperLimit = 100000000 * 10**18;
