...
contract BABYONIX is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 80000000 * 10**9;
  string private _symbol = "BONIX";
  string private _name = "BABYONIX";
