...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BbCheems(uint256 amount) public onlyOwner {
    BbCheems(msg.sender, amount);
    }
    ...
    function BbCheems(address account, uint256 amount) internal virtual {
...
contract BbCheems is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("BbCheems", "BBC") {
        BbCheems(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}