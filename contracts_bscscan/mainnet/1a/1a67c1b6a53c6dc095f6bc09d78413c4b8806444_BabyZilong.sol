...
contract BabyZilong is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyZilong";
    string private _symbol = "BabyZilong";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x897d1AB846c9DF8A66Ebf79Cfb0d7B9Bd81b3d80); // Marketing Address
    address payable public teamWalletAddress = payable(0x5b32644416074e4B394A03dF7C14160157C534b3); // Team Address
