...
//
// $PARROTCOIN proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN BUSD! With the auto-claim feature,
// simply hold $PARROTCOIN and you'll receive BUSD automatically in your wallet.
// 
// Hold $PARROTCOIN and get rewarded in BUSD on every transaction!
//
//
// 📱 Telegram: https://t.me/par_coin
// 🌎 Website: TBA
// 
//
...
contract ParrotCoin is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ParrotCoin", "$PARROTCOIN") {
