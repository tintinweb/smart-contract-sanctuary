...
$$ |  $$ |$$   ____| $$ |$$\ $$ |     $$ |  $$ |$$ |  $$ |$$ |  $$ |
\$$$$$$$ |\$$$$$$$\  \$$$$  |$$$$$$$$\ $$$$$$  |\$$$$$$  |$$$$$$$  |
 \____$$ | \_______|  \____/ \________|\______/  \______/ \_______/ 
$$\   $$ |                                                          
\$$$$$$  |                                                          
 \______/                                                           
 ...
 Taxes: 7% in liquidity, 0% anywhere else
...
// CHANGE
contract getLOUD is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "getLOUD";
    string constant _symbol = "DEAF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 15) / 1000; // 1.5% MAX 35,000,000
