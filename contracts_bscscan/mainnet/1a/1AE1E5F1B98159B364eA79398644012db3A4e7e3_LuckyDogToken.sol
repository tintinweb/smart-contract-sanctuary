...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #LuckyDog

    I make this #LuckyDog to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/LuckyDogTokenBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LuckyDog to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #LuckyDog 10000000X? 
   ...
   it's the best part of the #LuckyDog idea, increasing the liquidity pool automatically, 
...
contract LuckyDogToken is Context, IERC20, Ownable {
    ...
    string private _name = "LuckyDog Token";
