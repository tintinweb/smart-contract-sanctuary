...
/**
  ...
  Each trade also automatically adds liquidity on Pancakeswap leading to an ever-increasing price floor of BabyShiba. 
  This means that even if every single BabyShiba holder sells, the price will not go to zero.


 * Welcome to BabyShiba
 * Telegram group - https://t.me/BabyShibaofficialbsc
 * After token launch 50% of supply are burned
 * All LP tokens are locked after liquidity add
 * Anti bot
 * Anti Whales
 * Fees 12% :
 * 2% are rewarded to every holder with every transaction
 * 4% are provided for marketing 
 * 6% are provided to liquidity
 * Telegram group - https://t.me/BabyShibaofficialbsc
*/
...
contract BabyShiba is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x839D71fb0E00a54Ad2C0b0CbA06dbA7dc2E9D7d6;
