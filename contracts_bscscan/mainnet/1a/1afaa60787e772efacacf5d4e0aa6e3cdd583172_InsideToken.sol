...
/*
//
The Inside Token Economics
 
INSIDE is the token for the BSC network. To deliver superior performance and scalability, INSIDE employs a proof of stake model.
Inside token total supply: 10,000,000,000,000,000.
No single individual or entity may acquire more than 1% of the tokens through the public token sale.

https://www.insidetoken.cc/
...
contract InsideToken is Context, IERC20, Ownable {
    ...
    string private _name = "Inside Token";
    ...
    uint256 public _Maxtokenperwallet = 1;
    uint256 private _previousMaxtokenperwallet = _Maxtokenperwallet;
