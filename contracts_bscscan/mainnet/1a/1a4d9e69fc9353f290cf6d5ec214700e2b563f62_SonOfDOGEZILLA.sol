...
// File contracts/SonOfDOGEZILLA.sol
pragma solidity ^0.8.0;

contract SonOfDOGEZILLA is Context, IERC20, Ownable {
    ...
    string private constant _name = "SonOfDOGEZILLA";
    string private constant _symbol = "SONDOGEZ";
