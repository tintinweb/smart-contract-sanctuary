...
contract FlokiJeetInu is Context, IBEP20, Ownable {
    ...
    uint private _previousMarketingFee = _marketingFee;
    ...
    function setMarketingFeePercent(uint marketingFee) external onlyOwner {
    ...
    function getTradingIsEnabled(bool enable) public onlyOwner {
