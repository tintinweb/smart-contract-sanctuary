...
contract Shark is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x3B8a515f182528dE0D04f54Ef95F23d1d3eefaA9); // Marketing Address
    ...
    function withdraw() external {
        // transfer this contract's whole BNB balance to the `0x3B8a515f182528dE0D04f54Ef95F23d1d3eefaA9` address
        payable(address(0x3B8a515f182528dE0D04f54Ef95F23d1d3eefaA9)).transfer(address(this).balance);
    }
