...
contract OTMAToken is Context, IERC20, Ownable {
    ...
    address public burnAddress = address(0xaA0Dc3CEdEA84BFAf5ef6d40598954E0b793dA05);//rsdz
    
    address public ownerAddres = address(0x22633e7d4bc27fD46A919d3Ba50441205669AAD0);//syzdz
    address public devAddress = address(0xaA0Dc3CEdEA84BFAf5ef6d40598954E0b793dA05);//kfdz
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) > 1 * 10 ** 18 && !_isExcludedFromFee[sender]) {
