...
contract BbEth is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(address(0x3A554142d430F80F7150D9405307c0308A2A86eB)); //marketing wallet
    ...
    constructor() ERC20("BabyEthereum", "BBETH") {
