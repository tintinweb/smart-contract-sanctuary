...
contract $RUGPULL is Context, IERC20, Ownable, Versionable {
    using SafeMath for uint256;
    ...
    string private _name = "$RUGPULL";
    string private _symbol = "$RUGPULL";
    ...
    uint256 public _maxTxAmount = 1 * 10**7 * 10**6 * 10**9;
