...
EARNFILECOIN: earn Filecoin rewards by holding . EARNFIL TOKEN
...
contract EARLFILECOIN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EARN FILECOIN";
    string constant _symbol = "EARMFIL";
