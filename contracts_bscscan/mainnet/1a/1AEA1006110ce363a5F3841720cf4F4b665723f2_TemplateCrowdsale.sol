...
contract Consts {
    ...
    string public constant TOKEN_NAME = "ClassicDoge";
    string public constant TOKEN_SYMBOL = "XDOGE";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x98D17A119487076b29F7caFBecff7CCd5882C42a;
    
    uint public constant START_TIME = 1636020055;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(5000000 * TOKEN_DECIMAL_MULTIPLIER, 0xE2C37223a05793863dce55D6E36AFa02ab1F00B5, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1640948400)
        CappedCrowdsale(3200000000000000000000)
        
        RefundableCrowdsale(440000000000000000000)
    ...
    function init() public onlyOwner {
        ...
        address[5] memory addresses = [address(0x57b27d4b8e3a8bf5d502894d08654477c262b11d),address(0x70b84a4fbe4784661b5beec3410f818cf31d7d8f),address(0x5bf231c0168abebaced4ded56a1a6eed2806be21),address(0x9bcd36c05371497213b81c3c2e70b8fcab37f465),address(0xd9a43c5604118cdb0f1bd3a0ae15cb4556c1fb73)];
        uint[5] memory amounts = [uint(8000000000000000000000000000),uint(12000000000000000000000000000),uint(20000000000000000000000000000),uint(24000000000000000000000000000),uint(80000000000000000000000000000)];
        uint64[5] memory freezes = [uint64(1656651601),uint64(0),uint64(0),uint64(0),uint64(0)];
