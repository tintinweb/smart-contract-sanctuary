...
contract ElonHappy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonHappy";
    string private _symbol = "ELH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa2713D76Fb77F5576778Fd42c6e134e1dB6035F5); // Marketing Address
    address payable public teamWalletAddress = payable(0xa2713D76Fb77F5576778Fd42c6e134e1dB6035F5); // Team Address
