...
contract TestLiq is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xCa9cb6Fa442003754AA3726672A72EB7D87Eb3d0); //fill before using
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xCa9cb6Fa442003754AA3726672A72EB7D87Eb3d0); //TO-DO change liquidty owner address

    string private _name    = "TestLiq";
    string private _symbol  = "TestLiq";
