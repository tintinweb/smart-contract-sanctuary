...
//   Telegram https://t.me/NFTtrain

// 6% of each & every transaction is distributed among all  NFT train holders. Just hold $NT in your wallets & you'll see it rising as more people buy.
//6% of every transaction is automatically locked in the liquidity pool. Higher liquidity pool means lower volatility & will contribute to increasing NFT train price.
//6% of every transaction for Marketing and NFT reward in near future
...
contract NFTtrain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NFTtrain";
