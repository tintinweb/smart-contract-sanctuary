...
contract TSTU is Context, IERC20, Ownable {
    ...
    string private constant _name = "TS TU";
    string private constant _symbol = "TESTU";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if( from != owner() && to != owner() && swapEnabled && from == pair){
        ...
        if( from != owner() && to != owner() && swapEnabled && to == pair){
