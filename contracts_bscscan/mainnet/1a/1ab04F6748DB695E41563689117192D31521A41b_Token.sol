...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function modifyWhiteListSender(
        ...
        require(newAddr.length <= 50, "too much address");
        require(removedAddr.length <= 50, "too much address");
    ...
    function setNumTokensSell(uint256 numTokensSellToAddToLiquidity)
        public
        onlyOwner
        returns (bool)
    {
...
contract Token is ERC20 {
    ...
    constructor() {
        _initialize("Z Key", "ZKEY", 0, maxSupply);
    ...
    function _transfer(
        ...
        if (amount > _numTokensSellToAddToLiquidity && limitSell == true && whiteListPool[recipient]) {
            revert("Limit Sell Pancakeswap");
        }
