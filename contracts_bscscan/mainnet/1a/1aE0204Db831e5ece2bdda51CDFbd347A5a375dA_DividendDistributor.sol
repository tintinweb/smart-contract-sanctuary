...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        tokenPools[currentToken].amount = pool.amount.add(amount);
        tokenPools[currentToken].dividends = pool.dividends.add(amount);
        tokenPools[currentToken].dividendsPerShare = pool.dividendsPerShare.add(dividendsPerShareAccuracyFactor.mul(amount).div(pool.shares));
    }
