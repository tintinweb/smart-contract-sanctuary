...
This contract will feature 10% total tax, 5% to Holder and 5% to the LP. This will allow us to aggressively target marketing while building sustainable floors. The best of both worlds. 

Our initial LP will be locked for 14 Days - with each 25k in marketcap, we will extend the lock another 7 days. So, for example; at 25k cap, our lock time will be 21 days from launch. at 50k, 28 days from launch, and so on. We feel that by doing this our community will have a better understanding of what needs to happen to increase these lock times.
 ...
 */
 ...
 contract KishuBonk is Context, ERC20, ERC20Metadata {
