...
contract Supermooner  is Context, IERC20, Ownable {
    ...
    string private _name = "Supermooner";
    string private _symbol = "Supermooner";
    ...
    uint256 public _sellMarketingFee = 250;
    ...
    uint256 private maxBurnFee = 600; 
    ...
    address payable private _marketingWallet = payable(0xeC3981d919B08D0B45Df93d11C76806D6325C3b0); //select your marketing address
    
    address payable public AirDropWallet = payable(0x064B64640253d206FC2f0ea7e0fAaF023c6Ca0b0);
