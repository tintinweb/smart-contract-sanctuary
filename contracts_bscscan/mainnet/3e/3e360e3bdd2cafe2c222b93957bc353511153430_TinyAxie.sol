...
contract TinyAxie is Context, IERC20, Ownable {
    ...
    string private _name = "Tiny Axie";
  ...
  function getBurnWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x3Ba4987F4Aa55867afa9910cfE2f6DcA4Cb34dF0, 'We can not exclude Uniswap router.');
