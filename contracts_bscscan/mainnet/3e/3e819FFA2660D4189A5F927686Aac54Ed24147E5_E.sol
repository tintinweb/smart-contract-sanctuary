...
contract E is IBEP20, Auth {
    ...
    string constant _name = "E";
    string constant _symbol = "$E";
    ...
    function triggerGladiatorBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
