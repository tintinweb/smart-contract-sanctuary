...
/**
   Name SCATTOKEN(SCAT)
   Total Suppy = 1000000000000000
   Decimals = 9
   5% fee auto added to liquidity
   4% fee auto distributed to all hodlers
   4% fee auto sent to the dead wallet
   3% fee auto distributed to Marketing wallet
...
contract SCATTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "SCATTOKEN";
    ...
    address  public devAddress = 0x93350454cB5E79B95695fd013E13a90a0b2ce893;
    address  public MarketingWallet = 0x68192e8cf36e66510c5A42F0FbD17e90429bcD85;
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[from], "scat: Sender address is blacklisted");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to burn dev and wallets
        _transferStandard(sender, address(0), burnAmt);
        _transferStandard(sender, devAddress, fundingPiece.mul(1));
        _transferStandard(sender, MarketingWallet, fundingPiece.mul(4));
