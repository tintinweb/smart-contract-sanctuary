...
contract SinfulTest is IBEP20, Auth {
    ...
    string constant _name = "SinfulTest";
    string constant _symbol = "SIT";
    ...
    uint256 liquidityFee = 10; //10% LIQUIDITY FEE
    uint256 marketingFee = 4; // 4% MARKETING FEE
    uint256 totalFee = 14; // 14% SELL & BUY FEE

    uint256 feeDenominator = 100;
    
    address private marketingFeeReceiver = 0xd730e18c1bD77C32656414099c4a0A79b6C204bC;
