...
library SafeMath {
     ...
     * `revert` opcode (which leaves remaining gas unMINIBANANAed) while Solidity
     ...
     * opcode (which leaves remaining gas unMINIBANANAed) while Solidity uses an
...
contract MINIBANANA  is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "MINIBANANA";
