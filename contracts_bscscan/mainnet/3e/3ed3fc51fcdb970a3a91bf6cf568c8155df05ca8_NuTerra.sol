...
/**
   ...
   1% fee auto sent to the MarketingWallet
   2% fee auto sent to the charity wallet
...
contract NuTerra is Context, IERC20, Ownable {
    ...
    address public CharityWallet = 0x3DBAFBBa7934bE5c367a9486e926bccC02a33390;
    address public MarketingWallet = 0xfdc81586f41e1d1a2A52d27481778C6c573d9DE8;
    ...
    function setTaxFeePercentage(uint256 percentage) external onlyOwner {
        _taxFee = percentage;
    }
        function setLiquidityFeePercentage(uint256 percentage) external onlyOwner {
        _taxFee = percentage;
    }
        function setCharityFeePercentage(uint256 percentage) external onlyOwner {
        _taxFee = percentage;
    }
