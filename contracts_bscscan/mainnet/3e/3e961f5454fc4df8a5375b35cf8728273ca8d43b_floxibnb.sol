...
- Stealth Launch
- Contract Verified & Renounce
- BNB Reward
- Marketing Campaign
- Utility Project

🔶 Tokenomics 🔶
- Locked Liquidity for 3 Years
- 8% Reward BNB
- 2% BuyBack
- 2% Marketing
...
contract floxibnb is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x10e5583bcB356574B2A5Bb7B97431E573d493A8a); // Marketing Address
    ...
    string private _name = "FloxiBnb";
    string private _symbol = "Fxbnb";
    ...
    uint256 public _maxTxSellAmount = 300000 * 10**6 * 10**9;
    uint256 public _maxTxBuyAmount = 300000000 * 10**6 * 10**9;
