 ...
 * @author Compound
 */
contract CErc20Delegator is CErc20Interface, ODelegator {
 ...
 * @author Ola
 */
contract ODelegator is CTokenInterface, CDelegatorInterface {
    ...
    function updateImplementationFromRegistry(bool allowResign, bytes calldata becomeImplementationData) external returns (bool) {
        ...
        require(implementationToSet != address(0), "No 1implementation");
