...
contract CHRISTMASORBIT is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CHRISTMAS ORBIT ", "CHRISTMASORBIT") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "ChristmasOrbit";
    string private _symbol = "ChritmasOrbit";
