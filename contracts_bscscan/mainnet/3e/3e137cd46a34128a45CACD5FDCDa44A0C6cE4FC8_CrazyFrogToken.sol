...
contract  CrazyFrogToken is Context, IERC20, Ownable {
    ...
    string private    _name = "CrazyFrogToken";
    string private  _symbol = "CFT";
    uint8 private _decimals = 8;
    
    uint256 public                _taxFee = 0; // 0% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 0; // 0% of transactions will be kept for liquidity
    uint256 public               _burnFee = 400; // 4% of transactions will be burned
    ...
    function setBurnFeeRate(uint256 burnFee) external onlyOwner {
        _burnFee = burnFee;
    }
    ...
    function setMinBalanceToAddToLiquidity(uint256 minBalance) external onlyOwner {
        numTokensSellToAddToLiquidity = minBalance;
    }
    ...
    function calculateTaxFee(uint256 _amount) private view returns (uint256) {
        return (_amount.mul(_taxFee).div(100)).div(100);
    }

    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return (_amount.mul(_liquidityFee).div(100)).div(100);
    }

    function calculateBurnFee(uint256 _amount) private view returns (uint256) {
        return (_amount.mul(_burnFee).div(100)).div(100);
    }
