...
/**
 * 
Gummy Beans ($GUMMIE) is a unique BSC token where its holders earn BNB rewards every 2 hours, help find a cure for Diabetes, collect NFTs and play games. 
*/
...
contract GUMMIE is Context, IERC20, Ownable {
