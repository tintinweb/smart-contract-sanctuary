...
contract BLUEFIRE  is Context, IERC20, Ownable {
    ...
    string private _name = "BLUEFIRE";
    string private _symbol = "BLUEFIRE";	
    ...
    uint256 private minimumTokensBeforeSwap = 2000000 * 10**18;
