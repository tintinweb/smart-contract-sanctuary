...
contract DYM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DYM";
    string private _symbol = "DYM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2d0FC45178EBD36Ada21F5e7a3c602811d068e70); // Marketing Address
    address payable public teamWalletAddress = payable(0x296CBa0c8F15cA1295f16cb05722EDE291FFdE69); // Team Address
