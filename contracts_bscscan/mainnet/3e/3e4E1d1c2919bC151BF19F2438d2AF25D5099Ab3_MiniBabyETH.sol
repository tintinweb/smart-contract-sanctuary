...
Welcome to MiniBabyETH
   This is a community token. If you want to create a telegram I suggest to name it to @MiniBabyETH
   ...
   I will renounce the ownership to burn addresses to transfer #MiniBabyETH to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left All (100%) total supply to the pool
   Can you make #MiniBabyETH 10000X? 
   ...
   it's the best part of the #MiniBabyETH idea, increasing the liquidity pool automatically, 
...
contract MiniBabyETH is Context, IERC20, Ownable {
    ...
    string private   _name = "Mini Baby ETH";
    string private _symbol = "MBETH";
