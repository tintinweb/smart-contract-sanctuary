...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ETHEREUM = IERC20(0xB27ADAfFB9fEa1801459a1a81B17218288c097cc);
...
contract PooHODL is IERC20, Ownable {
    using SafeMath for uint256;

    address ETHEREUM = 0xB27ADAfFB9fEa1801459a1a81B17218288c097cc;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PooHODL";
    string constant _symbol = "POOHODL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 2;
