...
/**
       Welcome to #BabyKenzo 
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BabyKenzo designed.
      
       This is a community token. If you want to create a telegram.
       I suggest by name : @BabyKenzoBSC
       ...
       I will renounce the ownership to burn addresses to transfer #BabyKenzo to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 10% total supply to the pool
       Can you make #BabyKenzo 10000X? 
       ...
       it's the best part of the #BabyKenzo idea, increasing the liquidity pool automatically, 
...
contract BabyKenzo is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Kenzo";
    string private _symbol = "BabyKenzo";
