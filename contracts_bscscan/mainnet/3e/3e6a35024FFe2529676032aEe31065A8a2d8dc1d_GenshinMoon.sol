...
contract GenshinMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0cf4946A99eB0d368fD0ACF2909e6953C93Bba71); // Marketing Address
    ...
    string private _name = "GenshinMoon";
