...
// File: contracts/dogeyADADividendPayingToken.sol
...
contract dogeyADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    address private _marketingWallet = address(0xb020D30AC2AbaF030D057eF57F0AAF6c5Ced1109);
    address private _liqAdd = address(0x3D8333eBA0896109F9828F463FbCDA9aFd00a4e7);
    ...
    dogeyADADividendTracker public dividendTracker;
    ...
    constructor() public ERC20("dogeyADA", "dADA") {
    	...
    	dividendTracker = new dogeyADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "dogeyADA: The dividend tracker already has that address");

        dogeyADADividendTracker newDividendTracker = dogeyADADividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "dogeyADA: The new dividend tracker must be owned by the dogeyADA token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "dogeyADA: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "dogeyADA: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "dogeyADA: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "dogeyADA: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "dogeyADA: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "dogeyADA: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "dogeyADABSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "dogeyADA: This account cannot send tokens until trading is enabled");
        }
...
contract dogeyADADividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("dogeyADA_Dividend_Tracker", "dogeyADA_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "dogeyADA_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "dogeyADA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main dogeyADA contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "dogeyADA_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "dogeyADA_Dividend_Tracker: Cannot update claimWait to same value");
