    ...
    UUPSUpgradeable
{
    ...
    event BuyKingdom(address buyer, address feeReceiver, uint256 price, uint256 nftId);
    ...
    function setup() public onlyOwner {
        ...
        collaterals["Drago"] = address(
            0x3D87f8923c3a16c5AB5D460ffA548418b58d9Fd8
        );
        collaterals["Dragoland_Ice"] = address(
            0x172cf969456b9172cEc6cfab8f2C21E5647C7549
        );
        collaterals["Dragoland_Rock"] = address(
            0x00D86cCE1debE1ceA37383e65bbd46e9c43217cf
        );
        collaterals["Dragoland_DragonFlame"] = address(
            0x36BD12EdD7e4224016C05abdB5193D2d3206F958
        );
        collaterals["Dragoland_LightningBolt"] = address(
            0xdFdaCDd8193Ae7cB6519E3b3A35BAc9515F4056b
        );
        collaterals["Dragoland_Lava"] = address(
            0x8f3bBe8406269b5C918F1bf6656b9ab85910b8d2
        );
        collaterals["Dragoland_Crystals"] = address(
            0xEe4feaB6828228A83e0e8e6c6c2f0D754e1c7B64
        );
        ...
        //1-Play2Earn
        feeMap[1].receiver = 0x3D87f8923c3a16c5AB5D460ffA548418b58d9Fd8;
        feeMap[1].fee = 50;
        //2-Liquidity
        ...
        feeMap[4].fee = 0;
        //5-Spare
        feeMap[5].receiver = 0x3D87f8923c3a16c5AB5D460ffA548418b58d9Fd8;
        feeMap[5].fee = 1;
        //6-Burn
    ...
    function Buy(string memory kingdomName) public {
        ...
        _setTokenURI(currentNFTId, bProps[kingdomName].fullURI);
        emit BuyKingdom(buyer, feeMap[1].receiver, price, _tokenIdCounter.current());
        _tokenIdCounter.increment();
