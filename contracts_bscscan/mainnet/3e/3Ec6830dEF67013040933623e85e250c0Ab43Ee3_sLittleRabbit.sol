...
//  Tokenomics: 8% REWARDS LTRBT 3% LIQUIDITY 2% Marketing

// Website : https://newlittlerabbit.com/
// Telegram : https://t.me/littlerabbitchat
// Twitter : https://twitter.com/LTRBTtwt
// Facebook : https://www.facebook.com/LittleRabbitOfficialFB/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LTRBT = IBEP20(0x17D749D3E2ac204a07e19D8096d9a05c423ea3af);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LTRBT.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(LTRBT);
        ...
        uint256 amount = LTRBT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LTRBT.transfer(shareholder, amount);
...
contract sLittleRabbit is IBEP20, Auth {
    using SafeMath for uint256;

    address LTRBT = 0x17D749D3E2ac204a07e19D8096d9a05c423ea3af;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "sLITTLE RABBIT";
    string constant _symbol = "sLTRBT";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xe6CfBE010A4612940eCffDE5bE15B893bE87695d;
