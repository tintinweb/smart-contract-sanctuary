...
GodFatherX | Launching in Now! | Experienced devs | Locked liquidity | Great tokenomics! | 
Hi there guys ! Today I will be bringing attention to a brand new project that I have come acrross! It is called GodFatherX and for me it ticks all the boxes and things I look for when researching and investing into a new project!
...
GodFatherX Tokenomics

GodFatherX is a hyper-deflationary token, all holders will be rewarded for holding tokens via static reflection.
...
contract GodFatherX is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "GodFatherX";
  string constant tokenSymbol = "GodFatherX";
