...
contract GTCW is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x31f96E4199C1a6326C7eE3E09fd776d210431241); // Marketing Address
    address payable public airdropAddress = payable(0x1016B95C6e03dF6f16b479E16740d460aF3DbBb7); // Airdrop Address
    ...
    uint256 private _tTotal = 160000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Global Transport Coin";
    string private _symbol = "GTCW";
    ...
    uint256 public _maxTxAmount = 160000000000* 10**9;
