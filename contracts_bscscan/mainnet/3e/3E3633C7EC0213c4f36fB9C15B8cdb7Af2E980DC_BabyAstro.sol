...
contract BabyAstro is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Baby Astro";
    string private _symbol = "BAstro";
    ...
    constructor() {
        ...
        _smFee = 5;
        stsmf = 1200000000000000 * 10 ** _decimals;
        _smfA = payable(0xF9B7EeF3F78B53D79FF56f5743C1aFAF75b21e11);
