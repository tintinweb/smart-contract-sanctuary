...
/**
   ...
   I make this #Mini BUNNY to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/MiniBUNNYGroub
   Great features:
   
    DIVIDEND YIELD PAID IN BUNNY! With the auto-claim feature every 30-60mins!
    Simply hold Mini BUNNY and you'll receive BUNNY automatically in your wallet.
    Hold Mini BUNNY, Trade Mini BUNNY and get rewarded in BUNNY on every transaction!
...
contract MiniBUNNY is IBEP20, Auth {
    ...
    string constant _symbol = "Mini BUNNY";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xaf77202AdEF2cfE428eE66E69DF61Dc2Bf027A8A;
