...
contract DividendDistributor {
    ...
    IERC20 Akita = IERC20(0xFfb6a98c33937F0239fE20C9a38985Ac14f55b7F); //Akita Rewards
    ...
    function deposit() external payable {
        uint256 balanceBefore = Akita.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = router.WETH();
        path[1] = address(Akita);
        ...
        uint256 amount = Akita.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Akita.transfer(shareholder, amount);
...
contract AKITAWEED is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AKITA WEED INU";
    string private _symbol = "AKITAW";
    ...
    address payable public marketingWalletAddress = payable(0x09784f1c8BfE6947bCD91CfE93Baa249E4757935); 
    address payable public rewardsWalletAddress = payable(0x5961219D518B0570BFD4A68FD403F8350C035DE3); 
