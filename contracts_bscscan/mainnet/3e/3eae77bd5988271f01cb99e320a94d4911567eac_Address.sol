...
// File @uniswap/v2-periphery/contracts/interfaces/[email protected]1.1.0-beta.0
...
contract YOWA is Context, ERC20, Ownable {
    ...
    string private _name = "YOWA";
    string private _symbol = "YOWA";
    ...
    uint256 private buyBackUpperLimit = 40 * 10 ** 10;       //40 * 0.0001 BNB

    // Minimum BNB balance before buyback IF lower than this number no buyback
    uint256 public minimumBalanceRequired = 1 * 10 ** 10;   //0.0001 BNB
