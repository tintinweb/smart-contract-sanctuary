...
#BABYDEVILION
   ...
   I make this #BABYDEVILION to hand over to the community.
   ...
   it's the best part of the #HeroeShiba idea, increasing the liquidity pool automatically, 
...
contract BABYDEVILION is Context, IERC20, Ownable {
    ...
    string private _name = "BABYDEVILION";
    string private _symbol = "BDLION";
