...
social defi platform built on solona

Website: www.solclout.com
Telegram : t.me/solclout
 */
...
contract Solclout is IBEP20, Ownable {
    ...
    string private constant _name = "SolClout";
    string private constant _symbol = "$SCT";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 1000000000 * 10 ** 9; 
    uint256 private _buyMaxTxAmount = 1000000000 * 10 ** 9; 
    ...
    uint256 private _selldevFee = 99;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 1000000000, "Can not reduce below 10K");
        require(maxSell > 1000000000, "Can not reduce below 10K");
