...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9489229d3E609b66C90EFcC555488f7DA6154990;
...
contract DELAND is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5b653a66D0DB73208a4de4Ae7c481a90F88f05de;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DELAND";
    string private _symbol = "DL";
