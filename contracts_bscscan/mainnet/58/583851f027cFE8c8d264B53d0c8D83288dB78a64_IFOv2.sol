...
contract IFOv2 is IIFOv2, ReentrancyGuard, Ownable {
    ...
    // The LP token used in pool 0 (WBNB)
    IBEP20 public lpToken;

    // The other LP token used in pool 1 (THOREUM)
    ...
    function setPool(
        ...
        // lpToken (wbnb) for pool 0 and lpToken2 (thoreum) for pool 1
