...
contract Ragdoll is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000 * 15**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxBuyAmount = _tTotal.mul(2).div(100);
    uint256 public maxSellAmount = _tTotal.mul(1).div(100);
    uint256 public swapTokensAtAmount = 500000 * 15**_decimals;
    uint256 public _maxWalletSize = 20000000 * 15**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x058642f80fD477446B3Be95A161Fe9eb1992D7AE;
    address public operationsAddress = 0xBD1529313c8f5fF6a3C0Be74dC0CECabDD165DA7;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Ragdoll";
    string private constant _symbol = "RG";
