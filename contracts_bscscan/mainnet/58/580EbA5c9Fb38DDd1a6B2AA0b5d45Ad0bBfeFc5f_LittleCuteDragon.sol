...
/**
 * Telegram : https://t.me/LITTLECUTEDRAGON
*/
...
contract LittleCuteDragon is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Little Cute Dragon";
    string private _symbol = "LTCD";
    ...
    constructor() {
        ...
        _smFee = 4;
        stsmf = 2700000000 * 10 ** _decimals;
        _smfA = payable(0xAB0C5eD1670B3738BD9000075f1eFeBb453E208A);
