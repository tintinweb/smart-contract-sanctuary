...
// MonsterDoge - Play-to-Earn NFTs platform
// Website: https://monsterdogecoin.com/
...
contract MonsterDogeCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0xE7a5AF571ba9b80D2cC8CB0b36b6889F827Cd586;
    address public buybackWallet = 0x89cbE4A486455cDb28EF6D66f35Bad201b795e04;
    ...
    constructor() ERC20("MONSTERDOGE", "MDT") {
    ...
    function updatePancakeRouter(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeRouter), "MonsterDoge: The router already has that address");
    ...
    function excludeFromPeriodLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromPeriodLimit[account] != excluded, "MonsterDoge: Account is already the value of 'excluded'");
    ...
    function excludeFromMaxTxLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTxLimit[account] != excluded, "MonsterDoge: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "MonsterDoge: This account cannot send tokens until trading is enabled");
        }
...
contract MonsterDogeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("MonsterDogeDividendTracker", "MDT_DividendTracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**decimals()); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "MonsterDogeDividendTracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "MonsterDogeDividendTracker: withdrawDividend disabled. Use the 'claim' function on the main MonsterDoge contract.");
    }
