...
contract GateManagerPots is ReentrancyGuardUpgradeable, Ownable {
    ...
    function withdrawUnderlying(uint256 amount) external { 
       ...
       withdrawInstantlyFromMoonPotPrizePool(shares);
    }
    ...
    function withdrawInstantlyFromMoonPotPrizePool(uint256 shares) public nonReentrant {
        require(
        ...
        IERC20Upgradeable(mooToken).safeTransferFrom(msg.sender, address(this), shares);
