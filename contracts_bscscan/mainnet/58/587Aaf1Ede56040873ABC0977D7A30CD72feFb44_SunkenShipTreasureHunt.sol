...
contract SunkenShipTreasureHunt is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Sunken Ship Treasure Hunt';
    string  private constant _SYMBOL = 'TREASURE';
