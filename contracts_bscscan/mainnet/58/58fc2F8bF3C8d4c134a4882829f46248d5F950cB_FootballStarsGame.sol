...
contract FootballStarsGame is BEP20 {
    ...
    */
    ...
    uint256 public transactionFee = 10 ** 13;
    ...
    function setDefault() public onlyOwner {
        ...
        BEP20 bep20 = BEP20(0x6507458BB53aec6Be863161641ec28739C41cC97);
        token = bep20; // FTS token 
        
        gameSettingsUpdaterAddress = _msgSender();
        
        marketingWallet = 0xd1460ca80A590FACa74722a1113fAde69bBA718c;
        ...
        uniswapV2Pair = 0x8D6f5556FdA740Dc13afAb3009e277C15bF686D2;
        // set the rest of the contract variables
        weth = uniswapV2Router.WETH();
    ...
    function setTestMode() public onlyOwner{
        ...
        gameSettings.minimumPrizeAmount = 10 ** 14;
        
        gameSettings.eliglblePlayers = 1;
        gameSettings.marketingWalletPercent = 1;
        gameSettings.prizeRewardPercentage = 1;
        
        BEP20 bep20 = BEP20(0x4068bbB1FC5ACD8052eaB27135fB20dd48249679);
        token = bep20; // FTS token 
        ...
        uniswapV2Pair = 0x3AB40C47C0EAf2581D446077FF8f3F95aDE36954;
        // set the rest of the contract variables
    ...
    function updateGameSettingsOrigin(
        uint256 maxTimeLeft,
        uint256 eliglblePlayers,
        uint256 marketingWalletPercent,
        uint256 prizeRewardPercentage,
        ...
        if(minimumPrizeAmount > 0)  {
            require(minimumPrizeAmount >= 10 ** 18);
    ...
    function updateGameSettings(
        ...
        if(minimumPrizeAmount > 0)  {
            require(minimumPrizeAmount >= 10 ** 14);
            gameSettings.minimumPrizeAmount = minimumPrizeAmount;
        }
    ...
    function buy() public payable {
        ...
        uint256 marketingAmount = msg.value.mul(gameSettings.marketingWalletPercent).div(100);
        payable(marketingWallet).transfer(marketingAmount); // marketing 1%
        
        uint256 swapAmount = (msg.value).mul(98).div(100); // 1% swap
    ...
    function timeLeft() public view returns (int256) {
        ...
        return int256(gameSettings.maxTimeLeft) - int256(blocksSinceLastBuy.mul(3));
    }
    ...
    function completeRoundWhenNoTimeLeft() public {
        ...
        if (oldBalance > gameSettings.minimumPrizeAmount) {
            
            if (secondsLeft < 0 ) {
            
               winner = buyerInfo[buyerInfo.length-1].buyer;
               
               if(oldBalance > 0) {
                   
                    payable(winner).transfer(oldBalance); // send BNB to winner
