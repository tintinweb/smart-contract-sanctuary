...
contract BBYBNB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5bcB53A8BB1c7ceb18AcF4f10530614F345Ca758); // Marketing Address
    ...
    string private _name = "BBYBNB";
    string private _symbol = "BBYBNB";
