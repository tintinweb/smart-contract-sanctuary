...
/*
FOREVER TURTLE
TG : https://t.me/ForeverTurtle
GIVEAWAYS;  EXCEPCIONAL NFT every ATH ! Check telegram for more info
3 DAY LIQUIDITY LOCK and increasing it when we reach new ATH
5% to devWallet
5% to liquidity
...
contract ForeverTurtle is Context, IBEP20, Ownable {
    ...
    string private _name = "ForeverTurtle";
    string private _symbol = "FTurtle";
