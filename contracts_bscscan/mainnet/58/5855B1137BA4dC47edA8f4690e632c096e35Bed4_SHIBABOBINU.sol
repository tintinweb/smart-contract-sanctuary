...
contract SHIBABOBINU is Ownership, IBEP20 {
    using SafeMath for uint256;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100B
    uint256 public _maxTxAmount = _totalSupply * 10 / 1000; // 1%
    uint256 public _walletMax = _totalSupply * 35 / 1000; // 3.5%

    address AUTO_LP = 0xA00626538651A9d9308fFb84d359D8991fd6c377;
    ...
    constructor() Ownership(msg.sender) {
        ...
        isTxLimitExempt[AUTO_LP] = true;

        autoLiquidityReceiver = AUTO_LP;
        marketingWallet = 0xd84879A3d14D1086303851aCc4d31617bE972058;
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _totalSupply.sub(balanceOf(AUTO_LP)).sub(balanceOf(ZERO_WALLET));
    }
