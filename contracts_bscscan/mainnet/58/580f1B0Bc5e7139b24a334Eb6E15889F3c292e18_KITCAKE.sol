...
/**
 ...
 Telegram : https://t.me/kittencakebsc
...
contract KITCAKE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x77a6f213456af145320dF9a13Bc159459B58bcFA); // Marketing Address

    address payable public teamAddress =
        payable(0x6181E3AE03255a282491c648734788295d80c9E6); // Team Address

    address payable public liquidityAddress =
        payable(0x8574E74E3A7BF8606c2d73B649C5cF90c656fCE4); // Liquidity Address
    ...
    string private constant _name = "Kitten Cake";
    string private constant _symbol = "KITCAKE";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 50 / 1000; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 100 / 1000; // 1% maxWalletToken
