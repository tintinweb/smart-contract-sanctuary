...
// Some logic
	...
	// ∙∙·▫▫ᵒᴼᵒ▫ₒₒ▫ᵒᴼᵒ▫ₒₒ▫ᵒᴼᵒ 𝐂𝓸ＮⓉ ᵒᴼᵒ▫ₒₒ▫ᵒᴼᵒ▫ₒₒ▫ᵒᴼᵒ▫▫·∙∙
	//
	// Symbol      : CONT
	// Name        : Continental
	// Total supply: 15,000,000,000,000
	// Decimals    : 14
	// Website     : continentalcoin.net
	//
	// Your gateway into the decentralize financial (CONT) world. 
	...
	interface AltcoinToken {
	    ...
	    string public constant name = "Continental";
	    string public constant symbol = "CONT";
	    uint public constant decimals = 14;
	    
	    uint256 public totalSupply = 15e26; // Total supply: 15,000,000,000,000
