...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #LittleCateCat to the community, make sure it's 100% safe.


   Can you make #LittleCateCat 10000X? 
...
contract LittleCateCat is Context, IERC20, Ownable {
    ...
    string private _name = "LittleCateCat";
