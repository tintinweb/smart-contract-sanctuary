...
contract OneSplit is Initializable, IOneSplit, OneSplitRoot, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(IOneSplitView _oneSplitView, address _handlerAddress) public initializer {
        __AccessControl_init();
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    ...
    function _swap(
        ...
        require(
            ...
            "Distribution array should not exceed reserves array size"
        );
...
interface IUniswapV2Factory {
    function getPair(IERC20Upgradeable tokenA, IERC20Upgradeable tokenB) external view returns (IUniswapV2Exchange pair);
}
