...
contract Ownable is Context {
    address private _owner = 0xC06f5FB74c928dF8369De6E1c9e3791f5cCa960A;
...
contract PINKBABYDOGE is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xC06f5FB74c928dF8369De6E1c9e3791f5cCa960A); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Pink Baby Doge"; // token name
    string private _symbol = "PBD"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 6470 minutes; // duration betweeen each buyback
    ...
    uint256 public _buyBackFee = 80; // buyback fee 6%
	...
	uint256 private _transactionLockTime = 6000; 
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000000); // max allowed tokens tranfer per transaction
    ...
    uint256 public _maxTokensPerAddress          = _tTotal.div(800); // Max number of tokens that an address can hold 5% of total supply
