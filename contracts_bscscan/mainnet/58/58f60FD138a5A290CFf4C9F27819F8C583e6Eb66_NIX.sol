...
contract NIX is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress = payable(0xe6Fd4d543bCE1Abc82a2D7b65646510976786038); 
    ...
    string private _name = "NIX";
    string private _symbol = "NIX";
    ...
    uint256 private marketingDivisor = 100;
    
    uint256 public _maxTxAmount = 10000000000  * 10**9;
    uint256 private minimumTokensBeforeSwap = 3500000  * 10**9; 
