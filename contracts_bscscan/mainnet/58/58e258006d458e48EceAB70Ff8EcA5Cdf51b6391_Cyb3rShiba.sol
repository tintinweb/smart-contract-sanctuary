...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #Cyb3rShiba to the community, make sure it's 100% safe.


   Can you make #Cyb3rShiba 10000X? 
...
contract Cyb3rShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Cyb3rShiba";
    string private _symbol = "CYSHIB$";
