 ...
 * INTERPOLATED BY NANDO
 * Contract to accept BNB and return RVL off the FEGEX Exchange!!!
 * COUCHOSTABBO!
 */
 ...
 */
contract RevivalSwapper is Context, Ownable {
  ...
  address public _revival = 0x611b25af6B30de52C9705972EfEbDaf387028F95;
  
  function swapForRevival(address sender, uint256 value) internal {
  ...
  function setSafemoonAddress(address nRevival) public onlyOwner {
      _revival = nRevival;
  }
