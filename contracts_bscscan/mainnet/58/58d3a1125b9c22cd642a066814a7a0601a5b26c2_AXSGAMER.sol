...
💰AXSGAMER💰  is a deflationary token with AXS rewards, burns, as well as a fully automated liquidity generation protocol.
Hold AXSGAMER in your wallet, and receive AXS automatically in every 30minutes !
...
contract AXSGAMER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AXSGAMER";
    string constant _symbol = "AXSGAMER";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xF199B232be8fD9Bc394818A0d785884c7A09D106; //WALLET DEV
