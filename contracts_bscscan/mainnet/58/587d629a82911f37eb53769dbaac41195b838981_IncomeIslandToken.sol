...
abstract contract ReentrancyGuard {
    ...
    modifier nonReentrant() {
        ...
        // I N C O M E I S L A N D T O K E N
...
contract IncomeIslandToken is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "Income Island Token";
    ...
    uint256 public _rewardCycle = 1 hours;
    ...
    // When Income Island Token becomes an utility token with 0% tax, withdrawToken function will allow us to remove the remaining token inside the contract address.
