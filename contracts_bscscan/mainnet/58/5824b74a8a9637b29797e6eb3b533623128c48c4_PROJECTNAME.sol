...
contract PROJECTNAME is ERC20, Ownable {
    ...
    PROJECTNAMEDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ProjectName", "ProjectSymbol") {
        ...
        dividendTracker = new PROJECTNAMEDividendTracker(
            payable(this),
            router,
...
contract PROJECTNAMEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PROJECTNAME public PROJECTNAMEContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PROJECTNAMEContract = PROJECTNAME(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PROJECTNAME_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PROJECTNAME_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PROJECTNAME contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PROJECTNAMEContract);

            uint256 prevBalance = PROJECTNAMEContract.balanceOf(address(this));
            ...
            {
                uint256 received = PROJECTNAMEContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PROJECTNAMEContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
