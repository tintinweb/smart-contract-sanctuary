...
contract DividendDistributor is IDividendDistributor {
    ...
    // 
    IBEP20 RWRD = IBEP20(0xdafa265004744e5c3306973B82c40A022ecDeae4);
    // pancake swap router
...
contract BRF is IBEP20, Auth {
    ...
    string constant _name = "Baby Rudolph Floki";
    string constant _symbol = "BRUF";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4d93cb5345323F20D04738723c4FA37A33AEca05;
        teamFeeReceiver = 0x01260D204D41476928Deee6B723eD9D729d213a9;
        charityFeeReceiver = 0x763bDa14BF6dbD542C86faC3e8A8ae74AFEcbAC6;
