...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @ItalyWin
...
contract ItalyWin is Context, IERC20, Ownable {
    ...
    string private _name = "Italy Win";
    string private _symbol = "ItalyWin";
