...
contract DogePool is IBEP20, Auth {
  ...
  uint256 public _maxTxAmount = _totalSupply.mul(1).div(10000);//( _totalSupply * 1 )  / 10000;

  //max wallet holding of 0.0001%
  uint256 public _maxWalletToken = _totalSupply.mul(1).div(10000);//( _totalSupply * 1 ) / 10000;
