...
/**
//TeacherShiba Justlaunched.
//Low Mcap
//Lp Locked
//OwnershibRenounced
//Telegram: https://t.me/Teachershiba
*/
...
contract Teachershiba is Context, IERC20, Ownable {
    ...
    string private _name = " Teacher Shiba";
    string private _symbol = "TeatherShiba";
    ...
    function _transfer(
        ...
        if(
            ...
            _isExcludedFromFee[owner()] //no max for those excluded from fees
        ) {
