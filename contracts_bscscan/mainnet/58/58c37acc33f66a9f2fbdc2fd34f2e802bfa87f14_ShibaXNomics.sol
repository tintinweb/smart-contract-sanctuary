...
/**
    ShibaXNomics    X    Stealthlaunch!
    (From the MiniShibaFomo developer)
        ...
        liquidity will be locked & renounced!
            ShibaXNomics is a safe token for degenplay,
            in order to avoid rugpull and contract manipulation,
            we will lock liquidity and renounce ownership.
            So you can trade after that to stay safu.
    
        Concept
            this is degen with meme concept,
            pump and dump control is in the community,
            be a good community to reach 100x and dwyor
    
        Marketing
            marketing runs depending on the volume of transactions and holders,
            this will run as long as the community keeps the chart alive
    

    https://t.me/ShibaXNomics
...
contract ShibaXNomics is Context, IERC20, Ownable { 
    ...
    string private _name = " ShibaXNomics"; 
    string private _symbol = "ShibaXN"; 
