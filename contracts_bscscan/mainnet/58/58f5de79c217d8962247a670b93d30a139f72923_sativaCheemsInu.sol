 ...
 *                
 *                  
 *      Fees on Buy: 13%   Sell:16%
 *          
 *                          
 *      t.me/sativacheemsinu
 *         
 * 
 * 
*/         
...
contract sativaCheemsInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Sativa Cheems Inu";
    string constant _symbol = "THCHEEMS";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x1Ca9b56E58664205f4E5EDfdE85A41d24C81dA37;
