...
contract MilkRoad is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Milk Road";
    ...
    uint256 _totalSupply = 21 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = 84 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 84 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x76793ea8a588b5FA84cD69701b7450FcD65E559c;
        devWallet = 0xfD01F9B9ebEcDf6Ef174a6253fabe46f6adFb46F;
