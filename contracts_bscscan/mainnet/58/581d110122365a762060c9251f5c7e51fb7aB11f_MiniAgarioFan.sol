...
/**
https://t.me/MiniAgarioFan

MINIAGAR.IO FAN TOKEN 

IF YOU KNOW AGAR.IO U DONT NEED MORE INTRODUCTIONS.

CHARITY WALLET WILL BE USED TO GIVE GIFTCARDS TO PLAY AGAR.IO

if someone have some better record than me in AGAR.IO and proof i ll gift 100 dollars 


OUR TELEGRAM GROUP: https://t.me/MiniAgarioFan
...
contract MiniAgarioFan is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;

    string constant _name = "MiniAgarioFan";
    string constant _symbol = "MiniAgarioFan";
