...
contract DiscoDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "DiscoDoge"; // 
    string private constant _symbol = "DiscoDoge"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 7;
    address public _marketingWallet = 0xD8e595005a6dE7e5eaE115FdC01bBB27276dc8B9;
