...
https://t.me/flokiriseada

🗓Tokenomics:

📘Total supply: 10,000,000
📘Max tx: 0.2% of total supply.
📘Max Wallet: 2%

📒Rewards: 8%
📒LP: 5%, INITIAL LP: 0.6 BNB
📒MARKETING: 1%
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 FEG = IERC20(0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = FEG.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FEG.transfer(shareholder, amount);
...
// CHANGE
contract FFEG is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address FEG = 0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FlokiRiseAda";
    string constant _symbol = "$RADA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 1% MAX 1,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 3% MAX 3,000,000,000
    ...
    uint256 reflectionFee = 1200; // 10%
    uint256 devFee = 400; // 4%
    uint256 totalFee = 1800; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x9F17A18dA3b295341c72F3841d1A9F0bb8328a8a);
