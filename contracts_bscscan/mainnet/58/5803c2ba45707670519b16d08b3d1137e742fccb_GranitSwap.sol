...
contract GranitSwap is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5DB07Bfaa8fE7a4Bb3D7b02E10283621163Ef746); // Marketing Address
    address payable public charityAddress = payable(0x5DB07Bfaa8fE7a4Bb3D7b02E10283621163Ef746); // Charity/Dev Address
    ...
    string private _name = "Granit Swap"; // nice
    string private _symbol = "GRA";
