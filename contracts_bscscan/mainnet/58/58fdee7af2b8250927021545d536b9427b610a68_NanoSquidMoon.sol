...
contract Ownable is Context {
  ...
  constructor () internal {
   ...
   /**
      10 % Dogecoin rewards on internal tx back to holder
     Automatic rewards on volume 172
    if trading volume is too low face to holders, stop rewards for 320 seconds.
     */
  /**
...
contract NanoSquidMoon is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 10;
  uint256 public _feeLiq = 4;
  uint256 public _feeDead = 4;
  uint256 public _feeholders = 2;
  uint256 public _maxTX = 4;
  

  constructor() public {
    _totalSupply = 10 * 10**8 * 10**6;
