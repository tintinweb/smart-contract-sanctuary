...
contract Koalabear is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0640bc4a6D4920002263bfd2ef993dFFB23734B1); // Marketing Address
    address payable public charityAddress = payable(0x0640bc4a6D4920002263bfd2ef993dFFB23734B1); // Charity/Dev Address
    ...
    string private _name = "Koala bear Swap"; // nice
    string private _symbol = "KOAB";
