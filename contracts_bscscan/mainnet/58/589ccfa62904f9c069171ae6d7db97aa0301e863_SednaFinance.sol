...
/**
 * Sedna Finance - GreenPro Captial
 * 
 */
...
contract SednaFinance {
    mapping(address => uint) public balances;
    mapping(address => mapping(address => uint)) public allowance;
    uint public totalSupply = 100_000_0 * 10 ** 9;
    uint256 private maxSaleLimit = 100_0 * 10 ** 9;
    string public name = "Sedna Finance";
    string public symbol = "SEDNA";
