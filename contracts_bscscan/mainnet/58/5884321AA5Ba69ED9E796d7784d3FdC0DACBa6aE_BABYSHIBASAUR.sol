...
/**
       Welcome to #Baby ShibaSaur
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BABYSHIBASAUR designed.
       ...
       I will renounce the ownership to burn addresses to transfer #BABYSHIBASAUR to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 90% total supply to the pool
       Can you make #BABYSHIBASAUR 10000X? 
       ...
       it's the best part of the #BABYSHIBASAUR idea, increasing the liquidity pool automatically, 
...
contract BABYSHIBASAUR is Context, IERC20, Ownable {
    ...
    string private _name = "Baby ShibaSaur";
    string private _symbol = "BABYSHIBASAUR";
