...
/**
   ...
   Welcome to AuntieDoge
   
   This is a community token. If you want to create a telegram I suggest to name it to @AuntieDogeCommunity
...
contract AuntieDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Auntie Doge";
