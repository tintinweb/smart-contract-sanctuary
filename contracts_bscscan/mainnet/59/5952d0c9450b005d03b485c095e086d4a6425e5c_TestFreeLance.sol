...
contract TestFreeLance is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**15 * 10**9; // 1,000,000,000,000,000
    ...
    address public _charityWallet = 0x218D271b221547a188859606e0d499111122d500;
    uint256 private _previouscharityFee = _charityFee;

    address developmentWalletAddress = 0xb1f388dC6C808Bb8EF8911a3a41F0675ca133323;
    uint256 public _devFee = 1;

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "TestFreeLance";
    string private _symbol = "TFL";
    ...
    constructor() {
        ...
        IPancakeRouter02 _pancakeswapV2Router = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Test Net
    ...
    function excludeFromReward(address account) public onlyOwner() {
        ...
        require(!_isBlacklisted[account], "Account is already excluded");
    ...
    function includeInReward(address account) external onlyOwner() {
        require(_isBlacklisted[account], "Account is already included");
    ...
    function whitelistAddress(address account) public onlyOwner {
     ...
     function _transfer(
        ...
        uint256 devAmt = amount.div(100).mul(_devFee);

        _transferStandard(sender, address(0), burnAmt);
        TransferToAddETH(payable(_charityWallet),charityAmt);
        TransferToAddETH(payable(developmentWalletAddress),devAmt);
        
        _tokenTransfer(sender,recipient,amount.sub(burnAmt),takeFee);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        } else if (!_isBlacklisted[sender] && _isBlacklisted[recipient]) {
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        if(_isBlacklisted[address(this)])
    ...
    function _takeCharity(uint256 tCharity) private {
        ...
        if(_isBlacklisted[_charityWallet])
    ...
    function TransferToAddETH(address payable recipient, uint256 amount) private {
