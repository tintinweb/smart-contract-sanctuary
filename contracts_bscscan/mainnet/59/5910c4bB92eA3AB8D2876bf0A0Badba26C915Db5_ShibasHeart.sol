...
contract ShibasHeart is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x94409eCAF225b6ca3d95342b9e9BB71535B8C172); // Marketing Address
    ...
    string private _name = "ShibasHeart";
    string private _symbol = "SHIBH";
