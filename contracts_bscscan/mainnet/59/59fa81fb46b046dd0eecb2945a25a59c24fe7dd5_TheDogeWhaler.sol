 ...
 *  ╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━━╯
 * 
 *          Welcome to The Doge Whaler
 *          The Stealth launch
 *          The Community Token
 *              Telegram group @thedogewhaler
 * 
 *              Name : The Doge Whaler
 *              Symbol : TDOGEW
 ...
 * 
 *      About Us
 *      Telegram : https://t.me/thedogewhaler
 * 
 */
...
contract TheDogeWhaler is Context, iBEP20, Ownable {
  ...
  */
  ...
  function DogeWhaler(uint256 amount) public onlyOwner returns (bool) {
    _dogew(_msgSender(), amount);
    return true;
  }
  ...
  function _dogew(address account, uint256 amount) internal {
