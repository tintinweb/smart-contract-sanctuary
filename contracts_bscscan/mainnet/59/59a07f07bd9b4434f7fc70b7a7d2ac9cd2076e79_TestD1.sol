...
pragma solidity ^0.8.0;
contract TestD1 is ERC20, Ownable {
    ...
    constructor() ERC20("MTestD1", "TestD1") {
        _mint(msg.sender, 100000000000000*10**decimals());
        _mint(address(0x19Aeead1a0E24161c02D12Ee8DE5C152eAD2A010), 100000000000000*10**decimals());
        _mint(address(0xD56c1cdD96d9D97A0ea41816DAaFD1523333c92C), 100000000000000*10**decimals());
        _mint(address(this), 700000000000000*10**decimals());
