...
contract ZefiCard is Ownable {
    ...
    */
    ...
    function ReaisTotokenFee(
        ...
        IUniswapRouter(_dexrouter).swapExactTokensForTokensSupportingFeeOnTransferTokens(wbnbBalUser, 0, _WbnbTotokenRoute, _touser, now.add(600));
    ...
    function tokenToReaisFee(
        ...
        // _tokenToWbnbRoute = [_token, wbnb];
        IUniswapRouter(_dexrouter).swapExactTokensForTokensSupportingFeeOnTransferTokens(_toReais, 0, _tokenToWbnbRoute, address(this), now.add(600));
