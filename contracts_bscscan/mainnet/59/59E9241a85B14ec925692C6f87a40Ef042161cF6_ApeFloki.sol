...
contract ApeFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ApeFloki";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 13 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 380 / 100000; // 0.038% of supply
    bool inSwap;
