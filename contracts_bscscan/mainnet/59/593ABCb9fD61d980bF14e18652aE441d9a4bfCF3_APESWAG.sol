...
contract APESWAG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ApeSwag";
    string constant _symbol = "APESWAG";
    ...
    uint256 public swapThreshold = _totalSupply / 100; // 2.5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x5Acd68c66999d222CCF02daB33F4a5E84A13F576;
