...
Welcome to PuppyBee
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @PuppyBeeChat
   ...
   I will renounce the ownership to burn addresses to transfer #PuppyBee to the community, make sure it's 100% safe.

   I will add .15 BNB and all the left 10% total supply to the pool
   Can you make #PuppyBee 10000X? 
   ...
   it's the best part of the #PuppyBee idea, increasing the liquidity pool automatically, 
...
contract PuppyBee is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "PuppyBee";
    string private _symbol = "PUPPYBEE";
