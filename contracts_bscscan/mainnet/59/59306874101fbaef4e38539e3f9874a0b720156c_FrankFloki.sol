...
/**
* Telegram: https://t.me/FrankFloki
*/
...
contract FrankFlokiDividendDistributor is IDividendDistributor {
...
contract FrankFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Frank Floki";
    string constant _symbol = "FrankFloki";
    ...
    */
    ...
    uint256 public liquidityFee = 3; //all these are changeable after deployment
    ...
    FrankFlokiDividendDistributor public distributor;
    uint256 distributorGas = 500000;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply / 333; // 0.3%
    bool inSwap;
    ...
    constructor (
        ...
        distributor = new FrankFlokiDividendDistributor(address(router), BUSD);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        BUSD = rewardToken;
        distributor = new FrankFlokiDividendDistributor(address(router), rewardToken);
    }	
