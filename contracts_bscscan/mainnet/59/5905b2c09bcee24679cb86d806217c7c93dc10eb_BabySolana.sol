...
/**
   ...
   Welcome to BabySolana
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabySolanaCommunity
...
contract BabySolana is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Solana";
