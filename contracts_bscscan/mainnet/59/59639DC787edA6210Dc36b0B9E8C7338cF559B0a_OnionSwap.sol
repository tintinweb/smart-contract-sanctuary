...
library SafeMath {
    ...
    function sub(uint aa1, uint aa2) internal pure returns (uint) {
        return aa1 - aa2;
    }
    ...
    function sub(uint aa1, uint aa2, string memory errorMessage) internal pure returns (uint) {
        unchecked {
...
contract OnionSwap is Contexts, ICOIN, ICOINMetadata {
