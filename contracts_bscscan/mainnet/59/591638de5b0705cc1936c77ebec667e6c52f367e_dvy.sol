...
contract dvy is ERC20 {
 ...
 string public constant name = "Drivy";
 string public constant symbol = "DVY";
 uint public constant decimals = 8;
 uint public deadline = now + 70 * 1 days;
 uint public round2 = now + 30 * 1 days;
 uint public round1 = now + 60 * 1 days;
 
 uint256 public totalSupply = 500000000000000000e8;
 ...
 address multisig = 0x18dBf7A95cc5d694C868c524545dA866c7E15752;
 ...
 constructor() public {
 uint256 teamFund = 500000000000000000e8;
 owner = msg.sender;
