...
contract CATTY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0xE0cF8A15FD2b0daF665A0aCFf697518Ef9E43C5a;
    ...
    constructor() public ERC20("CATTY", "CATTY") {
    ...
    function setSwapState(bool value) public onlyOwner{
        swapStart = value;
    }
    ...
    function _transfer(
        ...
        if(amount == 0 || (from != owner() && to != owner() && !swapStart && automatedMarketMakerPairs[to])) {
