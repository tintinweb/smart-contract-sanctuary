...
contract Xspacedog is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress=0x6aC0d4c8E77aC4B82ebc9A663379B6Dc45827371;
    address private _charityWalletAddress1=0x259C5eFD823dB8C1eaDBE6d1889e5f54Bd234bC3;
 ...
 //       IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tCharity, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount.sub(rFee).sub(rLiquidity).sub(rCharity);
         rTransferAmount=rTransferAmount.sub(tCharity);
    ...
    function _takeCharity(uint256 tCharity) private {
        ...
        _rOwned[_charityWalletAddress] = _rOwned[_charityWalletAddress].add(rCharity);
         _rOwned[_charityWalletAddress1] = _rOwned[_charityWalletAddress1].add(rCharity);
        if(_isExcluded[_charityWalletAddress])
            _tOwned[_charityWalletAddress] = _tOwned[_charityWalletAddress].add(tCharity);
            
            if(_isExcluded[_charityWalletAddress1])
            _tOwned[_charityWalletAddress1] = _tOwned[_charityWalletAddress1].add(tCharity);
    }
