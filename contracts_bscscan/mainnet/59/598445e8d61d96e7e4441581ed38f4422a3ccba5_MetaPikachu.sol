...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD702220B077247455cF8a04C429F1951b5EF8779;
...
contract MetaPikachu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4dD828DF31Eeba89557a7ad0977EB8158988DEd8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Pikachu";
    string private _symbol = "MPIKA";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 33;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 33;
