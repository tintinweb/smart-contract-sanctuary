...
contract Ceack is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x298eb4250779601D8314F5932a209991CCf07cDb); // Marketing Address
    ...
    string private _name = "Ceack";
    string private _symbol = "Ceack";
