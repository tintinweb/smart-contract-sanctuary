...
Earn shiba by holding Teemo

🎁-8% back to holders as shiba inu
💧-3% back to LP Liquidity for a healthy pool
😸-4% to Marketing Charity .
🤝-2% Buyback

🔐 Locked LP for 100 years after launch
https://mudra.website/?certificate=yes&type=0&lp=0xf01d32B93f6409E8fAa6cCc65fDc565c5937865c

StaySAFU
Invest Safely.
https://app.staysafu.org/scan?a=0x59c2950d5cf8d82d7d96a3333f32de5fb049df81&mobile=false

i am small dev i just want to open my first token with 25 years lock 
if you want you can create a TG group ..⚙️https://t.me/TeemoShibaToken
*/
...
contract TeemoShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Teemo Shiba";
    string constant _symbol = "Teemo";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 15; // 5%
    ...
    address public autoLiquidityReceiver = 0x85e8498fA8F3445740b8773417DB75737C75E655;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x85e8498fA8F3445740b8773417DB75737C75E655;
