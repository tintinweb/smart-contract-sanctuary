...
contract RVF is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "Rugs Victims Foundation";
    ...
    uint256 public buybackUpperLimit  = _maxTxAmount;
    ...
    function setBuybackUpperLimit (uint256 value) external onlyOwner {
        buybackUpperLimit = value;
    }
    function setBurnWallet (address value) external onlyOwner {
        burnWallet = value;
    }
