...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #TheLastInu

    I make this #TheLastInu to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/TheLastInu_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #TheLastInu to the community, make sure it's 100% safe.

   I will add 5 BNB and all the left 49.5% total supply to the pool
   Can you make #TheLastInu 10000000X? 
   ...
   it's the best part of the #TheLastInu idea, increasing the liquidity pool automatically, 
...
contract TheLastInu is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "TheLastInu";
  string private _name = "TheLastInu";
