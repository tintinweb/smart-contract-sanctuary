...
contract ChildDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Child Doge";
    string constant _symbol = "$ChildDoge";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xF6343efbe583636606Fb5C832894CC68213818bE;
