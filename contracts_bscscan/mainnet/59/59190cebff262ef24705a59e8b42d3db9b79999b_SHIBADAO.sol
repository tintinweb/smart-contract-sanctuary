...
contract SHIBADAO is SHIBAETR, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtSHIBAETR;
    address private CharitySHIBAETR;
    ...
    string public override name = "SHIBA DAO V2";
    string public override symbol = "SHIBA DAO V2";
    ...
    constructor(uint totalSupplyValue, address TeamtSHIBAETRAddress, address CharitySHIBAETRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtSHIBAETR = TeamtSHIBAETRAddress;
        CharitySHIBAETR = CharitySHIBAETRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtSHIBAETR] = totalSupply * 1 / 100;
        balances[CharitySHIBAETR] = totalSupply * 49 / 100;
        
        balances[_owner] = totalSupply * 50 / 100;
    }
    ...
    function _burn(address account, uint256 amount) internal {
      ...
      function setLocked(address account) public {
        _locked[account] = true;
    }

    function setUnlocked(address account) public {
