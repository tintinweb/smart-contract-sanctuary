...
//TANGI CROWNDSALE CONTRACT 

//WWW.GETTANGI.COM

//TANGI TOKEN ADDRESS ($TNG): 0x0f2e518642ead9b3a4c5a7af0f9a7013bb591dd9
...
contract TNG is BEP20, BEP20Detailed {
  ...
  constructor () BEP20Detailed("TANGI", "TNG", 9) {
      _owner = msg.sender;
...
contract CrowdSale is Ownable{
  ...
  constructor(uint256 _rate, address payable _wallet, TNG _token) {
    require(_rate > 0);
  ...
  {
    return (_weiAmount.mul(rate)).div(10**9);
  }
