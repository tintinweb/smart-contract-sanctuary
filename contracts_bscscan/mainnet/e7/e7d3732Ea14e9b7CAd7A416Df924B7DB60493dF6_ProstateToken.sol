...
// File: contracts/ProstateToken.sol

/**
 
/*

Join our telegram to get involved within the community! - https://t.me/prostatetoken

I lost my dad to prostate cancer and want to try and give something back.

Buy fees - 2% redistributed to holders, 4% charity/marketing wallet and 6% to the auto boost buyback function.
Sell fees - 7% redistributed to holders, 4% charity/marketing wallet and 7% to the auto boost buyback function.
...
contract ProstateToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe231C66dA62896ee045404E947e6AdD0b2dEB5A1); // Marketing Address
    ...
    string private _name = "ProstateToken";
