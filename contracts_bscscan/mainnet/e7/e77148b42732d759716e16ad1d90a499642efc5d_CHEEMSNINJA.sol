...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC3d3DD88A45360c28896508855508a0Df3Fd27bb;
...
contract CHEEMSNINJA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xec91fBBC3d41bc595EF80fd58E9003ecFa6d425a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CHEEMS NINJA";
    string private _symbol = "CSNNJ";
