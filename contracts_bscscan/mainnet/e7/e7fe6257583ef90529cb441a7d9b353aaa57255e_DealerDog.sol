...
contract DealerDog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x17901ef97Fcdc7eddBD30f5b1BfBD72197d27cCc); // Marketing Address
    ...
    string private _name = "DealerDog";
