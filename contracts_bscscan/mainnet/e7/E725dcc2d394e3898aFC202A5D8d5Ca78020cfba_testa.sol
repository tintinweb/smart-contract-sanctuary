...
pragma solidity ^0.7.6;//compiler
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 3 * (10 ** 18);
...
contract testa is IBEP20, Auth {
    using SafeMath for uint256;

    address XRP = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Test a";
    string constant _symbol = "TestA";
