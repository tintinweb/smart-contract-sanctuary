...
contract goodxyz is Context, IERC20, Ownable {
    ...
    string private _name = "goodxyz";
    string private _symbol = "goodxyz";
    ...
    address public ownerAddres = address(0x06dFb9Baa643c07E5374A87feB344a17aa65012B);
    address public devAddress = address(0x59271cC4ca1C48CD323BEB4a6228d08a8eeb83B7);
