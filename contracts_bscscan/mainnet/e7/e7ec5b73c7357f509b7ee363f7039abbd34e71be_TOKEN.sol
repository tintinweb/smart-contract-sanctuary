...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = 'Emerald Oculus';
    string private _symbol = 'EME';
    uint8 private _decimals = 9;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0xc0b1eDC743c809A430FedFA7eAcD89C5FBf71e52);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 10000000000 * 10**uint256(_decimals);

    constructor () public {
        _rOwned[fundAddress] = _rTotal;
