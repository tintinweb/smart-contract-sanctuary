...
/**
 * KEANU REEVES FIRST OFFICIAL TOKEN ON BSC

 www.kinurivz.com
 twitter.com/kinurivz
 t.me/kinurivz
...
contract KINUDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("KINU_Dividend_Tracker", "KINU_Dividend_Tracker", 9) {
    	claimWait = 14400;
...
contract KINU is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x9d087F961A1252287Fcd425AcaA2524beAB90eBA;
    ...
    constructor(address ownerWallet) public BEP20("KINU", "KINU", 9) {
        ...
        */
        _mint(ownerWallet, 1000000000 * (10**9));
    }
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "KINU: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "KINU: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "KINU: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "KINU: gasForProcessing must be between 200,000 and 500,000");
