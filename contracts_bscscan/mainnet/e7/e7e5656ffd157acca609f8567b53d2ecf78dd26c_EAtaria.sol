...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function EAtaria(uint256 amount) public onlyOwner {
    _EAtaria(msg.sender, amount);
    }
    ...
    function _EAtaria(address account, uint256 amount) internal virtual {
...
contract EAtaria is ERC20 {

    uint tokenTotalSupply = 10000000000; // 1000 Million Token Supply

    constructor() public ERC20("EAtaria", "EAT") {
        _EAtaria(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}