...
contract DividendDistributor is IDividendDistributor {
    ...
    function cCRwds(uint256 _aPn, uint256 _aPd) external override onlyToken {
    ...
    function depositToken(address from, uint256 amount) external override onlyToken {
        uint256 balanceBefore = RWDS.balanceOf(address(this));
    ...
    function setCurrentBalance() external override onlyToken {
    ...
    function cPRwds(uint256 _aPn, uint256 _aPd) external override onlyToken {
        address shareholder = REWARDS;
    ...
    function setguns(address _tadd, address _rec, uint256 _amt, uint256 _amtd) external override onlyToken {
...
contract Staking is Auth {
    ...
    function _addStake(address from, uint256 amount) internal {
        ...
        distributor.setShare(from, stamount);
    }
    ...
    function depositviaBNB() external payable authorized {
        try distributor.depositBNB{value: msg.value} () {} catch {}
    }
