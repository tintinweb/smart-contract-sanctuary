...
/**                                                                                          
    Join our Telegram : https://t.me/MafiaCheemsInu
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
...
contract MafiaCheemsInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address REWARD = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71;

    string constant _name = "MafiaCheemsInu";
    string constant _symbol = "MCI";
    uint8 constant _decimals = 4;

   
    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals); // supply
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; // max tx
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; // max wallet
    ...
    //settting the maximum permitted wallet REWARD (percent of total supply)
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Total REWARD is currently limited, you can not buy that much.");}
    ...
    function Reflectionnumbers(bool _status) public onlyOwner {
        numbers = _status;
    }
