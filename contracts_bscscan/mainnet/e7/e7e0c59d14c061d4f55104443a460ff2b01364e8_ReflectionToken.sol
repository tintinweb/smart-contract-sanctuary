...
contract ReflectionToken is IERC20 {
    ...
    string constant _name = "Hodl Cake";
    string constant _symbol = "CAKEHODL";
    ...
    address payable private _marketingWallet = payable(0x44f3f492d48B10f67d7c0CB6463254F14247A3ad);
