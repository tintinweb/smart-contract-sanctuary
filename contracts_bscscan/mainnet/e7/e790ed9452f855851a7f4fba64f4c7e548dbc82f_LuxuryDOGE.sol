 ...
 * 
 Welcome to $LuxuryDOGE:
   ...
   Many Great features:
    ...
    it's the best part of the $LuxuryDOGE idea, increasing the liquidity pool automatically.
...
contract LuxuryDOGE is Context, IERC20, Ownable {
