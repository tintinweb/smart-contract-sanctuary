...
contract BDI is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x743fA1621b050E2b6e4a346B93eccC2Ac9AfA048;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**9; //100
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Big Doge Inu";
