...
contract TravLaddChart is IBEP20, Auth {
    ...
    string constant _name = "TravLaddChart";
    string constant _symbol = "TravLaddChart";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 8) / 200; //1% 
    uint256 public _maxWalletSize = (_totalSupply * 8) / 100; //2%
    ...
    address private marketingFeeReceiver = 0x15264c332f40554Ce158024a378cDc90D01B7A05;
    address private developmentFeeReceiver = 0x5640Dce70a4923E24A72a927c807c597F5E65189;
