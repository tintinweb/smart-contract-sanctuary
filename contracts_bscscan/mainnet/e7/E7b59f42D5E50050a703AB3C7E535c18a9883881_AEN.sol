...
contract AEN is Auth, IBEP20 {
    ...
    string constant _name = "Altera Technology";
    string constant _symbol = "AEN";
    ...
    uint256 _tTotal = 3500000 * (10**_decimals);
    ...
    uint256 public _buybackSplit = 500;
    uint256 public _communitySplit = 100;
    uint256 public _devSplit = 30;
    uint256 public _marketingSplit = 70;
