...
contract test is IBEP20, Auth {
    ...
    address payable public marketingWallet = payable(0x17aC94F31ad033F5087B2ffDdbce045E284F2841);
    address payable public treasury = payable(0xc77949daBf3DEb16c56e21Ae6cf601e34cf9E3B2);
    ...
    uint256 private maxBuy = 5000 * (10 ** _decimals);
