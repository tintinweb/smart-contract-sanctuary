...
✅ Fair launch tomorrow 22h30 >> countdown : https://countingdownto.com/fr?c=3840573 📱

ℹ️ Pour avoir plus d’informations venez voir notre site internet : futocoin.fr
...
// CHANGE
contract Futocoin is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 25) / 10000; // 0.25%
