...
contract Ronaldoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x96cf7A2b305Bf91e6beDC6191B70d4408a040Fb6); // Marketing Address
    ...
    string private _symbol = "RONALDOGE";
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || (_isExcludedFromFee[from] || _isExcludedFromFee[to]), "oops too early, beep boop.");
        ...
        if (tradingIsEnabled || (_isExcludedFromFee[from] || _isExcludedFromFee[to])) {
