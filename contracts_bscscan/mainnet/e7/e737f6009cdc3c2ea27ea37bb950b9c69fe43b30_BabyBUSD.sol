...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BabyBUSD
   ...
   I will renounce the ownership to burn addresses to transfer #BabyBUSD to the community, make sure it's 100% safe.
   ...
   it's the best part of the #BabyBUSD idea, increasing the liquidity pool automatically, 
...
contract BabyBUSD is Context, IERC20, Ownable {
    ...
    string private _name = "Baby BUSD";
