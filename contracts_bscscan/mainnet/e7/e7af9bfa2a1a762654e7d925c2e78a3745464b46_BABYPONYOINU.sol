...
/*
 ...
 _______  _______  _______  __   __    _______  _______  __    _  __   __  _______         ___   __    _  __   __ 
|  _    ||   _   ||  _    ||  | |  |  |       ||       ||  |  | ||  | |  ||       |       |   | |  |  | ||  | |  |
| |_|   ||  |_|  || |_|   ||  |_|  |  |    _  ||   _   ||   |_| ||  |_|  ||   _   | ____  |   | |   |_| ||  | |  |
|       ||       ||       ||       |  |   |_| ||  | |  ||       ||       ||  | |  ||____| |   | |       ||  |_|  |
|  _   | |       ||  _   | |_     _|  |    ___||  |_|  ||  _    ||_     _||  |_|  |       |   | |  _    ||       |
| |_|   ||   _   || |_|   |  |   |    |   |    |       || | |   |  |   |  |       |       |   | | | |   ||       |
|_______||__| |__||_______|  |___|    |___|    |_______||_|  |__|  |___|  |_______|       |___| |_|  |__||_______|

Telegram: t.me/babyponyo
...
contract BABYPONYOINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyPonyoInu";
    
    string private constant _symbol = "BABYPONYO"; 
    ...
    address public _marketingWallet = 0x7A36a6B310a52771819CE852D2d905820057F77B;
