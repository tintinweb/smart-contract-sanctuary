...
contract FirstSHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "FirstSHIB";
    string private _symbol = "FirstSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00CE038e6808de64113977d9CDb68942F8aE15a4); // Marketing Address
    address payable public teamWalletAddress = payable(0xFB744c7C5BD317897fC70e5aF28908acC8D0a56E); // Team Address
