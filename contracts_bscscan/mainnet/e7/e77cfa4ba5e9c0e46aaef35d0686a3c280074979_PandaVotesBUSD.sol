...
contract PandaVotesBUSD {

  function name() public pure returns(string memory) { return "PandaVotesBUSD"; }
  function symbol() public pure returns(string memory) { return "PandaVotesBUSD"; }
  function decimals() public pure returns(uint8) { return 18; }  

  function totalSupply() public view returns (uint256) {
  IPair pair1 = IPair(0x0810E97C9FA4cCCebe559509edf74b650B432dcE);
  ...
  function balanceOf(address owner) public view returns (uint256) {
    ...
    // LP pair2
    (uint256 lp1_totalpandaA, uint256 lp1_totalpandaB,) = pair1.getReserves();
    (uint256 lp1_userpanda,) = chef.userInfo(2, owner);
