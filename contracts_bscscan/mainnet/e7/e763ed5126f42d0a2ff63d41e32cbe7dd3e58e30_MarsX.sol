...
contract MarsX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "MarsX";
    string private constant _symbol = "MarsX";
    ...
    address payable constant private _marketingAddress = payable(0x5ec7a94A336dDe6C96a78A175CAeedC509279F28);
    address payable constant private _buybackAddress = payable(0xBDE200D40CDB69Da7b224de251cDDadb25B1D14C);
    address payable constant private _projectMaintainence = payable(0xe233A166F77c54B9bF5146e131bBE2ab7abBE1a9);
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//marsx
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//marsx
