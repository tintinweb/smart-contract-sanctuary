...
contract FegZilla is Context, IERC20 {
    ...
    uint256 private startingSupply = 1_500_000_000;

    string constant private _name = "FegZilla";
    string constant private _symbol = "FEGZ";
    ...
    address payable private _marketingWallet = payable(0xC52F9EA9Ea90F6f0E0D3b74E4902082Fd2152bD6);
    address payable private _buybackWallet = payable(0xeA15b92E8a5C36563ce686f17cD276598A53ddDE);
