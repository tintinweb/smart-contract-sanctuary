...
contract USADoge is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x0459FfA70C13d6AC7017fe803e96645ec2DC658b;

    //_isBlacklisted = Fuck bots. If blacklisted, can't sell or transfer tokens at all.
    ...
    string private _name = "USA Doge";
    string private _symbol = "USA Doge";
    ...
    //Remove BOT from Blacklist 
    function removeFromBlackList(address account) external onlyOwner {
        _isBlacklisted[account] = false;
    }

    //Blacklisting multiple bots
    ...
    function _transfer(
        ...
        //Don't use bots. Blacklisted addreses can not buy or sell.
