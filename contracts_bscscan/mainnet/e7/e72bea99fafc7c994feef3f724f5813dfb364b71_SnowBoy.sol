...
// Telegram : https://t.me/SnowBoyBSC
...
contract SnowBoy is Context, IERC20, Ownable {
    ...
    function _airdrop(uint256 airdrop) external onlyOwner() {
        require(airdrop < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = airdrop;
    }
}