...
contract Holdem is Context, IERC20, Ownable {
    ...
    address payable public projectAddress = payable(0xf602DEC1164eaCEB28989d30DE0DB714382F446A); // Project Address
    ...
    uint256 private _tTotal = 865368000 * 10**9;
    ...
    uint256 public _maxTxAmount = 8653680 * 10**9;
    uint256 public _minimumTokensBeforeSwap = 865368 * 10**9;
