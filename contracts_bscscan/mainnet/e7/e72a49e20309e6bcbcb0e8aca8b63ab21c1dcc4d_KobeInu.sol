...
// CHANGE
contract KobeInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Kobe Inu";
    string constant _symbol = "KOBE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 50) / 1000; // 3.5% MAX 30,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 50) / 1000; // 3.5% MAX 30,000,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xBdB1676eDE3Bd3d953B9E3c8566B3af20e5725ab);
