...
/**
WELCOME TO THE METATRIX

WE CAN ONLY GUIDE YOU TO THE TRUTH 
Buying $TRIX you can sit back and relax while our manual buyback pumps your briefcase. 
You will be rewarded in exclusive giveaways for holding. 
On top of this you will have the opportunity to own percentage of land in the metaverse.
...
contract MetaTrix is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xD0d8a9B936aeb94c622aba78F54206901DBcde81); // Marketing Wallet
    address payable private ecosystemWallet = payable(0xD0d8a9B936aeb94c622aba78F54206901DBcde81); // Ecosystem Wallet
    address payable private devWallet = payable (0xD0d8a9B936aeb94c622aba78F54206901DBcde81); // dev Wallet
    ...
    uint256 public swapThreshold = _tTotal.div(1000).mul(5); //0.5%
