...
contract BlocksRewardsManager3 is Ownable {
    // Info of each user.
    struct UserInfo {
    ...
    constructor(address blocksStakingAddress_, address treasury_) {
    ...
    function addSpace(address spaceContract_) external onlyOwner {
    ...
    function blocksAreaBoughtOnSpace(address buyer_, address[] calldata previousBlockOwners_) external payable {
        ...
        uint256 numberOfBlocksAddedToSpace = numberOfBlocksBought - numberOfBlocksToRemove;
        // Set user data
