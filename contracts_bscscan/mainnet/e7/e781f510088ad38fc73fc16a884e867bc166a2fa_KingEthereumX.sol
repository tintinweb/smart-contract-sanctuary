...
STEALTH LAUNCH - KingEthereumX - 10% Ethereum reflection automatically every hours
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 1000000 * (10**9); // user must hold 1000,000 token to receive Ethereum
...
contract KingEthereumX is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "KingEthereumX";
    string constant _symbol = "KingEthereumX";
