...
/*
 💎 Welcome to $DISJOY, the game token for the DicashJourney game. 
    We are a product of Dinheirus.Cash ($DICASH).💎
    5% Reward in $DICASH
    4% Liquidity
    1% Marketing and Development
    
    https://DicashJourney.com
...
contract DividendDistributor is IDividendDistributor {
    ...
    //The auto-rewarded token $DICASH
    IBEP20 REWARD = IBEP20 (0xE03b91172f5161064eAe471e1C05d4912FCE1db3);
...
contract DISJOY is IBEP20, Auth {
    using SafeMath for uint256;

    //The auto-rewarded coin $DICASH
    address REWARD = 0xE03b91172f5161064eAe471e1C05d4912FCE1db3;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DICASH JOURNEY";
    string constant _symbol = "DISJOY";
    uint8 constant _decimals = 8;

    //total supply --> 200,000,000
    uint256 _totalSupply = 200000_000e8;
    ...
    address public marketingFeeReceiver = 0x06F1380d88A4E739184546A5de59C56e86E3e99B; 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xEf33E47978F9ebC00F7D05E47a271D7bD7357a65;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // cooldown timer. 1min gap between 2 trades.
        if (sender == pair &&
            buyCooldownEnabled &&
