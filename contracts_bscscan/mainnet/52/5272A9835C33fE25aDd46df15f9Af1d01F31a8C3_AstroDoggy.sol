...
// https://www.astrodoggy.io/
// https://twitter.com/astro_doggy
// https://www.reddit.com/r/Astrodoggy/
// https://t.me/astrodoggy
...
contract AstroDoggy is IBEP20 {
    ...
    string public override name = "AstroDoggy";
    string public override symbol = "ADOGGY";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[foundersPot] = totalSupply * 46 / 100;
        
        balances[owner] = totalSupply * 53 / 100;
    }
