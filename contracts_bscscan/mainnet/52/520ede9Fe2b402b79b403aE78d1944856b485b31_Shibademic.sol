...
contract Shibademic is Context, IERC20, Ownable {
  ...
  string private _name = 'Shibademic';
  string private _symbol = 'SHIMIC';
  ...
  address payable public _SHIMICWalletAddress;
  ...
  constructor(
    address payable SHIMICWalletAddress,
    address payable marketingWalletAddress
  ) {
    _SHIMICWalletAddress = SHIMICWalletAddress;
  ...
  function sendETHToTeam(uint256 amount) private {
    _SHIMICWalletAddress.call{ value: amount.div(2) }('');
  ...
  function _setSHIMICWallet(address payable SHIMICWalletAddress) external onlyOwner {
    _SHIMICWalletAddress = SHIMICWalletAddress;
  }
