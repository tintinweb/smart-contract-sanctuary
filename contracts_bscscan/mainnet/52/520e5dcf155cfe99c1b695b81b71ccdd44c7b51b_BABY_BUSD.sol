...
Welcome to BabyBUSD
   This is a community token. If you want to create a telegram I suggest to name it to @BabyBUSDChat
   ...
   I will renounce the ownership to make sure it's 100% safe.
   I will add 2 BNB and all the left 10% total supply to the pool
   Can you make #BabyBUSD 10000X? 
