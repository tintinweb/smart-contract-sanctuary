...
ZombieGirl is a community-based token on BSC. Each transaction will deduct a fee to be distributed to holders as reflections, 
grow our LP and also marketing wallet. It's By Community For Community.

Tokenomics:
- Supply 100,000,000,000
- Tax 12%

https://t.me/ZombieGirlToken
*/
...
contract ZombieGirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ZombieGirl";
    string constant _symbol = "ZOMBIEGIRL";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xCa510bc17421B8852e3f32C1afed0CF97Bd2E585);
