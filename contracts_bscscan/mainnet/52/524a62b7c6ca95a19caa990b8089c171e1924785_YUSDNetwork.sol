...
contract YUSDNetwork is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xfEcE251C541Be2d6F8E3214C2CBdc8088188443A); // Marketing Address
    address payable public charityAddress = payable(0xfEcE251C541Be2d6F8E3214C2CBdc8088188443A); // Charity/Dev Address
    ...
    string private _name = "YUSD Network"; // nice
    string private _symbol = "YUSD";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 200000000000000000000000000; // nice: 200,000,000 
