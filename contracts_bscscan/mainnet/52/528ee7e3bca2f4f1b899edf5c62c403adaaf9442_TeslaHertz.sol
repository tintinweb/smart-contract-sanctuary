...
/**
https://t.me/teslahertztokenofficial

 # of Tokens: 1,000,000,000,000,000
 Max Wallet Size = 60,000,000,000,000
 Max Transaction Size = 20,000,000,000,000 

 Reflection/Taxes: 6% in Marketing, 6% in Liquidity
 
 Buy Slippage: 12-15% 

 *** THE MAX A WALLET CAN HAVE IS 60,000,000,000,000! THAT IS 6%! ***
...
// CHANGE
contract TeslaHertz is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Tesla Hertz Token";
    string constant _symbol = "HERTZ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 20) / 1000; // 1% MAX 1,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 60) / 1000; // 4% MAX 4,000,000,000
