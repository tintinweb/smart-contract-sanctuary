...
// File: contracts/stuffybunnys.sol
...
contract StuffyBunnys is ERC721Enumerable, Ownable {
    using Strings for uint256;


    uint16 public maxMintQty = 40;
    uint16 public constant MAX_SUPPLY = 3_600;
    bool public autoFloor = false;
    ...
    constructor(
        ...
        cost[0] = 250000000000000000 ;
        cost[1] = 380000000000000000 ;


        maxSubCollectionMints[0] = 3250;
        maxSubCollectionMints[1] = 350;
  ...
  // internal
    ...
    function mint2(uint8 mintQty) public payable { _iterateMint(1, mintQty); }
    ...
    function _mintCustom() internal {
        ...
        if(customMintables[_msgSender()] > 0 || _msgSender() == owner()){
            ...
            uint256 tokenId = totalSupply() + 1;
            currentSubCollectionSupply[1]++;
            addressUrlType[tokenId] = 1;
            _safeMint(_msgSender(), tokenId);
