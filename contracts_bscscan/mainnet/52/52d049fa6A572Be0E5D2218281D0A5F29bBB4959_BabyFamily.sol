...
contract BabyFamily is Context, IERC20, Ownable {
    ...
    string private _name = "BabyFamily";
    string private _symbol = "BabyFamily";
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**3 * 10**9; 
    
    address payable public marketingAddress = 0xdDc4d6719927116e2D409A92f3981A7402CA31B1; //Marketing
