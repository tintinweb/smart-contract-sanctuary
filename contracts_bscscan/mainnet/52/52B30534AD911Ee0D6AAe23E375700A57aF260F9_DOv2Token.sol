...
contract DOv2Token is Context, IERC20, Ownable {
    ...
    string private _name = "DOv2";
    string private _symbol = "DOv2";
    ...
    address public ownerAddres = address(0x4FB08d8A667F096686F3cb41C4e7c31AAcEB6623);
    address public devAddress = address(0x93B0851581FCeECCb42aBc12060F0a0e705DeDe1);
    
    address public DOv2Token = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
