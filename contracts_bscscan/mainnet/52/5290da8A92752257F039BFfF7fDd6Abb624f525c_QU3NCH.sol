...
/*
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @QU3NCH
   ...
   I will renounce the ownership to burn addresses to transfer #QU3NCH to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #QU3NCH 10000X? 
   ...
   it's the best part of the #QU3NCH idea, increasing the liquidity pool automatically, 
...
contract QU3NCH is Context, IERC20, Ownable {
    ...
    string private _name = "QU3NCH";
    string private _symbol = "3NCH";
