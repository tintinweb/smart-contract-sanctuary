...
contract NutsTokenT is IERC20 {
    ...
    uint256 private constant startingSupply = 1_000_000_000; // 1 Quadrillion, underscores aid readability

    uint8 private _decimals = 9;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "NutsTokenT";
    string constant _symbol = "NUTSTT";
