...
contract PresaleBEP20 is Ownable {
    ...
    bool public stopPreSaleEn = false;
    ...
    constructor(
        ...
        token = _token;
        presale = 0xF446b17800e2Cc7c0C04e0C612eFA855d3B9CBE4;

        presaleStartTimestamp = 1626282000;
        presaleEndTimestamp = presaleStartTimestamp.add(7 days);
    }
    ...
    function deposit() public payable {
        require(now >= presaleStartTimestamp && stopPreSaleEn == false, "presale is not active");
        ...
        rewardTokenCount = 0.000001 ether; // 1,000,000 JOKE tokens per BNB

        uint256 tokenAmount = msg.value.mul(1e12).div(rewardTokenCount);
    ...
    function returnAllJOKE() external onlyOwner{
        // require(now >= presaleEndTimestamp || totalDepositedEthBalance == hardCapEthAmount, "presale is active");
    ...
    function continuePreSale() public onlyOwner{
        stopPreSaleEn = false;
    }
