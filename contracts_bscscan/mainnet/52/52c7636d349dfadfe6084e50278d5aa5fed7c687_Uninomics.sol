...
🚨 SWEEPWIDGET + PINKSALE

📣 TG: https://t.me/UninomicsToken
🐦 Twitter: https://twitter.com/UninomicsToken
💻 Website: https://www.uninomics.net/

️ 11% Buy Tax | 15% Sell Tax

🦄 5-6% $UNI Rewards
💧 3-4%  Auto Liquidity Pool
🚀 2-3% Marketing
💰 1-2% BuyBack Wallet
...
contract Uninomics is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Uninomics';
    string private constant _symbol = 'Uninomics';
    ...
    address public Marketing=payable(0x3d11022FFCc62Fd516fb085c1CFc690F1896822b);
    address private ConstantProvider=payable(0x3dCafF7E42d1a214788268285534f74BB736095C);
    address public BuyBack=payable(0xC913bBE5E59750Ae8a0376Ae94d523d9F807f86a);
    //TestNet
    ...
    //Staking Share Minimum for anti-manipulation/
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0xBf5140A22578168FD562DCcF235E5D43A02ce9B1;  // UNI
    ...
    function TeamProcessBNB() public onlyOwner{
    ...
    function TeamProcessXBNB(uint256 amount) public onlyOwner{
    ...
    function TeamRelease() public onlyOwner {
    ...
    function TeamRemove(bool addToStaking) public onlyOwner{
        //Only callable if liquidity Unlock time is over
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
    ...
    //Distribution of BNB 
    function TeamDisibuteRemainingBNB() public onlyOwner{
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
