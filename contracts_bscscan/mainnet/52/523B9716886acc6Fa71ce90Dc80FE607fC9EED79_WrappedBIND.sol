...
contract WrappedBIND is IBEP20 {
    ...
    string public override name = "Wrapped BIND";
    string public override symbol = "WBIND";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress, address marketingAddress) {
        ...
        balances[marketingPot] =  totalSupply * 10 / 100;
        balances[foundersPot] = totalSupply * 80 / 100;
