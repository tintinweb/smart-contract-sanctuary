...
/**
 Our goal is to fight the threat against pandas kind!
 As you know a lot of pandas are kept in captivity and a lot of them are being shot by hunters for fun.
 We have to stop them at all costs.

 That is why we are going to donate funds towards helping our lovely panda bears and fight against humanity to provide them with safe and peaceful life!

 Help us improve their wellbeing, we know that we can make a change! 


 * Welcome to PandaBear
 * Website - https://pandabear.life
 * Telegram group - https://t.me/PandaBearWWF
 * After token launch 30% of supply are burned
 * All LP tokens are locked after liquidity add
 * Anti bot
 * Anti Whales
 * Fees 12% :
 * 2% are rewarded to every holder with every transaction
 * 4% are provided for marketing and charity wallet
...
contract PandaBear is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x07A43C724c7DaE535400Cd6F326844aD51299eC1;
    ...
    string private _name = "PandaBear";
