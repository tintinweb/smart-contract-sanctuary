...
contract GoodDoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Good Doge";
    ...
    uint256 public _walletMax = 1000 * 10**9 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xD1905E7e35347D1e51ea7469589550d639E0447e;
        marketingWallet = 0x891C3A3DFa36b79F356c547313cb44eE1761c0D7;
        devWallet = 0xaA0c2cE4a0b4b27B15b029174415D4F6a7E9cBda;
