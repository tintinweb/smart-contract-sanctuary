...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdc85bC9f8d89f3aB3Cd62882215A63Ee0a98B9c1;
...
contract DunaldDuk is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x410190767C6ef1b905cEEF7E376e82B15cECcCC4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DunaldDuk";
    string private _symbol = "DUNALD";
