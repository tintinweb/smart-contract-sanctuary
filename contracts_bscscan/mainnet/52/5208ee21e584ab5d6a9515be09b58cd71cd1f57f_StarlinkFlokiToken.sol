...
contract StarlinkFlokiToken is Context, IERC20, Ownable {
    ...
    string private _name = "Starlink Floki Token";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**6 * 10**9; // 50 trillion, or 1% of total supply
