...
// Kimochi Inu
// Earn Little Dogecoin just hold Kimochi Inu
...
// CHANGE
contract KimochiInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Kimochi Inu";
    string constant _symbol = "KINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 35) / 1000; // 3.5% MAX 30,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 35) / 1000; // 3.5% MAX 30,000,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x35763B84F875ba5c117794E472EB4110FE4d5654);
