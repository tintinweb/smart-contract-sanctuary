...
contract TESTEST is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 99000000 * 10**6;
    ...
    address public marketingWallet = 0x6d544443f2fA6a054D041066be51E7f606Ed928A;
    ...
    uint256 public _maxTxAmount = 99000 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 110 * 10**6;
    ...
    function enableDefaultFees() external onlyOwner() {
        ...
        _marketingFee = 0; // Marketing fee is to energize the token development and also a buyback & burn program.
    ...
    function enableLowFees() external onlyOwner() {
        _taxFee = 5;
        _previousTaxFee = _taxFee;
        _liquidityFee = 3; // Liquidity fee increased to support the pool & price
        _previousLiquidityFee = _liquidityFee;
        _burnFee = 2;
        _previousBurnFee = _taxFee;
        _marketingFee = 0;
