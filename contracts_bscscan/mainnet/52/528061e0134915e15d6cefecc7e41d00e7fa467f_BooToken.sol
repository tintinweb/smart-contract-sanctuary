...
contract BooToken is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 200000000 * 10**9;
  string private _symbol = "BooToken";
  string private _name = "BOO";
