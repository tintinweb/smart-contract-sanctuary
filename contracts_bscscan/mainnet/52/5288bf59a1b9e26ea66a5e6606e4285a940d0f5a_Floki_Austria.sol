...
Telegram : https://t.me/flokiaustria
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BFLK = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BFLK.balanceOf(address(this));
        ...
        uint256 amount = BFLK.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BFLK.transfer(shareholder, amount);
...
contract Floki_Austria is IBEP20, Auth {
    using SafeMath for uint256;

    address BFLK = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Floki Austria";
    string constant _symbol = "FlokiAustria";
