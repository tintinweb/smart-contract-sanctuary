...
contract MiniGUH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniGUH";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "$MiniGUH";
    ...
    //max wallet holding % 
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100;  // 2 is the percentage of max wallet.
    ...
    uint256 private liquidityFee    = 5; //fees.
    uint256 private reflectionFee   = 12;
    uint256 private marketingFee    = 5;
    uint256 public totalFee = 22;
    ...
    uint8 public cooldownTimerInterval = 20; //this is in seconds. 
