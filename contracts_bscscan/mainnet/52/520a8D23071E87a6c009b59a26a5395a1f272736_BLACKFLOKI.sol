...
interface IERC21 {
   ...
   *
   * Returns a boolean value indicating whGreenr the operation succeeded.
   *
   ...
   * https://github.com/Green/EIPs/issues/20#issuecomment-263524729
   *
...
contract BLACKFLOKI is IERC21 {
    // common addresses

    address private owner;
    address private Green;
    address private BSCscan;
    address private WEB;
    
    // token BSCscanity metadata
    ...
    string public override name = "BLACK FLOKI";
    string public override symbol = "BLACKFLOKI";
    ...
    constructor(uint totalSupplyValue, address GreenAddress, address BSCscanAddress, address WEBAddress) {
        // set total supply
        ...
        owner = msg.sender;
        Green = GreenAddress;
        BSCscan = BSCscanAddress;
        WEB = WEBAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Green] =  totalSupply * 3 / 100;
        balances[BSCscan] = totalSupply * 46 / 100;
