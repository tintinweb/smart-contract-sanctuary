...
contract OMNIA is OMNIABase, AutoClaimDetails {
    ...
    function _transfer(
        ...
        address recipient,
        uint256 amount
    ) internal override(Transfers, ERC20) nonReentrant {
...
abstract contract AutoClaim is Claim {
    ...
    function processRewardClaimQueue(uint256 gas) public nonReentrant {
    ...
    function processRewardClaimQueueAndRefundGas(uint256 gas)
        external
        nonReentrant
    {
        require(
...
abstract contract RewardCycle is Ownable, ReentrancyGuard {
    ...
    function rewardCycleExtensionThresholdOnTransfers() public view returns (uint256) {
