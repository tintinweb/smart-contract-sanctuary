...
/**
   https://t.me/Cardanomicsofficial
   The Real Cardanomics!
...
// CHANGE
contract Cardanomics is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Cardanomics";
    string constant _symbol = "$CARDANOMICS";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x2ecB91301DfA43D9D6fdA3FC129DB47de6A91edB);
