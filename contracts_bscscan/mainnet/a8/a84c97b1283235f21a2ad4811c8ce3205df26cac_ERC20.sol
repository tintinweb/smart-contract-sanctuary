...
contract PRAXTRON is ERC20, Ownable {
    ...
    address public _teamWalletAddress = address(0x3205674D73A28D4552516A31c5E1A053e47DffE7); // Team Wallet
    address public _projectWalletAddress = address(0x0Cdc063abC3a2F59D7C389E3847A5480E12Ce9Be); //Project Wallet
    ...
    constructor() ERC20("PRAXTRON", "PRX") {
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "PRX: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PRX: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "PRX: Automated market maker pair is already set to that value");
