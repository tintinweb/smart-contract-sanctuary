 ...
 * 
 * 
   A charity-oriented token that is committed to helping Environmental Organizations. 

  ColdFace features:
   25% of the toatl supply burned
   5% Marketing
   7% Charity Wallet
   18% Presale
   45% Launched on PancakeSwap
   
   *TRANSACTION TAX* (5%)
   
   2% fee auto added to the liquidity pool and locked
   1% fee auto distributed to all hodlers
   2% fee added to the aid wallet named @aid-wallet
   
  visit coldface.finance for more information!
...
█▀   ██   ▀█ ██      ██    ██    ▀█    ▄██▀     ▀███▀    ▀██▄ ██       ██    ▀██▄     ██    ▀█    ▄██▄    ▄██▀     ▀█ ██    ▀█ 
 ...
 were made to make this project inline with the mission of ColdFace Token -- helping Environmental Organizations through
 donation.
*/
...
contract CLD is Context, IERC20, Ownable {
  ...
  address payable charityWallet = 0xe4DF421286fDD2cE2eF9E766e2E0Bc6D3217082a;
  ...
  */
  ...
  string private constant _name = "ColdFace Token";
  string private constant _symbol = "CLDF";
  ...
  */
  ...
  function buyCLDFWithLeftoverBNB(uint256 amount) external onlyOwner() {
      // buy back CLDF (ColdFace) tokens with BNB leftover from SwapAndLiquify to increase ColdFace tokens price
