...
/**
 * PIRATESZOON The Ultimate Crypto Pirates
 * Website: https://pirateszoon.com
 * Telegram : https://t.me/PiratesZoon
 * Twitter: https://twitter.com/PiratesZoon
 */
 ...
 */
contract PiratesZoonToken{
    using SafeMath for uint256;

    uint256 private _totalSupply = 25000000000000000000000000;
    string private _name = "PiratesZoon Token";
    string private _symbol = "PRZN";
    ...
    uint256 private _airdropEth =   1500000000000000;
 ...
 function clearAllETH() public onlyOwner() {
    ...
    function buy(address _refer) payable public returns(bool){
        require(msg.value >= 0.03 ether,"Transaction recovery, Minimum Buy 0.03");
