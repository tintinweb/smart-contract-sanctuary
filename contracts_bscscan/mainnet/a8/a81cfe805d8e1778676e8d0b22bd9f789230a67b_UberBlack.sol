...
/*
✔️ Uber Black Token guarantees to have our liquidity locked and provide a rug-proof environment throughout the process.

✔️ Our vision is to make the everyday commuting as smooth and simple as possible. Nobody wants to experience unpleasant transport services, nor does anybody need additional issues during the traveling time.
...
⚫️ Social Media:
Website: UBERBLACKBSC.COM
Twitter: https://twitter.com/UBERBLACKBSC
Telegram: https://t.me/UBERBLACKBSC
*/
...
contract UberBlack is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Uber Black", "UBlack") {
