...
5% Min Possible Token Reflections!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe01b9319b7fCB5C32c6aE7bABDd4DF69CBD67C7A;
...
contract CryptoWhale is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0x4f300F8F89C25B4a65255E28B571b3d2bC0E354B); 
    address payable public Wallet_Dev = payable(0xe01b9319b7fCB5C32c6aE7bABDd4DF69CBD67C7A); 
    ...
    string private _name = "CryptoWhale"; 
    string private _symbol = "CWHL";  
    ...
    uint256 public minPossibleReflect = 5; 
    ...
    At launch, reflection is set to 0% but the first time the fees are updated this must be set to a minimum of 5%
    After this, the refelction can never be lower than 5%
