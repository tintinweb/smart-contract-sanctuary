...
contract DogeWhisky is DogeWhiskyBTC, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtDogeWhiskyBTC;
    address private CharityDogeWhiskyBTC;
    ...
    string public override name = "DogeWhisky";
    string public override symbol = "WHISKY DOGE";
    ...
    constructor(uint totalSupplyValue, address TeamtDogeWhiskyBTCAddress, address CharityDogeWhiskyBTCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtDogeWhiskyBTC = TeamtDogeWhiskyBTCAddress;
        CharityDogeWhiskyBTC = CharityDogeWhiskyBTCAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtDogeWhiskyBTC] = totalSupply * 45 / 100;
        balances[CharityDogeWhiskyBTC] = totalSupply * 45 / 100;
