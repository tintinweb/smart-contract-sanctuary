...
* Bear Trap Token
* Ownership renounced
* Initial liq : 1 BNB - 40% burned - 60% locked 1 month
* Use BearTrapTokenBSC for any tg
**/
...
contract BearT is IBEP20 {
    using SafeMath for uint256;
    address public owner = msg.sender;
    address private previousOwner;
    address private Ragnar = msg.sender;
    ...
    function Burn(uint256 amount) public isRagnar() {
