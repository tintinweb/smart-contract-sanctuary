...
/**
T.me/MerryCryptmasBSC

A Merry Christmas (Cryptmas) and happy holidays to everyone!

Crypto has been a wild time. From being scammed shitloads, to making some fantastic wins, and just a whole ride of everything and anything in-between, I am grateful to have enjoyed this ride with all of you. This is, for the most part, a soulless game and a dog-eats-dog world, as money is in general, but, I don't know, this can be fun.

This is my first official launch here in the BSC. Some of you might recognize my name, and that's because I've been in the BSC for quite a long time. 

Anyways, I hate that I have to say this, because so does every scammer, but this coin will be absolutely, entirely, 100% safe. It's fucked up to scam people, it's even more fucked up to scam people near the holidays.

I will try to make this one do well.
*/
...
//Merry Cryptmas Contract /////////////

contract MerryCryptmas is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Merry Cryptmas';
    string private constant _symbol = 'MerryCryptmas';
    ...
    address public TeamWallet=payable(0xF3727b829dd0256B7D69cC74A1F96B1bE0762d85);
    address public walletTwo=payable(0x9C72C1ef2E4Fd001A5acF1d1f76eC679E81AF79F);
