...
contract FomoDoge2 is Context, IERC20, Ownable {
    ...
    string private _name = "FomoDoge2";
    string private _symbol = "FDOGE2";
    ...
    constructor () public {
        gameSettings = GameSettings(
            5000000 * 10**18, //maxTxAmount is 2 million tokens
            1000000 * 10**18, //tokenSwapThreshold is 200000 tokens
            100000 * 10**18, //minimumBuyForPotEligibility is 50000 tokens
            35, //increaseRatio 0.035% for minimumBuyForPotEligibility
            60 * 60 * 4, // initTimeLeft is 4 hours
            60 * 60 * 8, //maxTimeLeft is 8 hours
            15, //extraTimeEachPot is 30 seconds
    ...
    function updateGameSettings(
        ...
        if(maxTxAmount > 0)  {
            require(maxTxAmount >= 5000000 * 10**18 && maxTxAmount <= 10000000 * 10**18);
            gameSettings.maxTxAmount = maxTxAmount;
        }
        if(tokenSwapThreshold > 0)  {
            require(tokenSwapThreshold >= 1000000 * 10**18 && tokenSwapThreshold <= 1000000 * 10**18);
        ...
        if(initTimeLeft > 0)  {
            require(initTimeLeft >= 3600 && initTimeLeft <= 86400);
    ...
    function handleBuyer(address buyer, uint256 amount) private {
        ...
        int256 newTimeLeft = oldTimeLeft + 15; // eeach buy can increase
