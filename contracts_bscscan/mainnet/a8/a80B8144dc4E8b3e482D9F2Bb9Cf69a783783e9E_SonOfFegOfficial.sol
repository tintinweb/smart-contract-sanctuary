...
// / _     \  .'  .-,  '.  |    \  |  |          .'  .-,  '.  |        |        |        |  .'_ _   \  '_( )_   \   
//  (`' )/`--' / ,-.|  \ _ \ |  ,  \ |  |         / ,-.|  \ _ \ |   .----'        |   .----' / ( ` )   '|(_ o _)|  '  
// (_ o _).   ;  \  '_ /  | :|  |\_ \|  |        ;  \  '_ /  | :|  _|____         |  _|____ . (_ o _)  |. (_,_)/___|  
//  (_,_). '. |  _`,/ \ _/  ||  _( )_\  |        |  _`,/ \ _/  ||_( )_   |        |_( )_   ||  (_,_)___||  |  .-----. 
// .---.  \  :: (  '\_/ \   ;| (_ o _)  |        : (  '\_/ \   ;(_ o._)__|        (_ o._)__|'  \   .---.'  \  '-   .' 
// \    `-'  | \ `"/  \  ) / |  (_,_)\  |         \ `"/  \  ) / |(_,_)            |(_,_)     \  `-'    / \  `-'`   |  
//  \       /   '. \_/``".'  |  |    |  |          '. \_/``".'  |   |             |   |       \       /   \        /  
//   `-...-'      '-----'    '--'    '--'            '-----'    '---'             '---'        `'-..-'     `'-...-'   
...
/**
 Welcome to Son Of Feg!
🐒Son of FEG🐒

🚀Fair Launch today @ at 17:00 UTC 🚀

Missed BIG GAINS?!
You definitely don't want to miss $SonOfFeg
The Greatest of all the SONS in BSC! The liquidity will be locked so that our community can feel completely SAFU!  
 Join https://t.me/Son_Of_Feg   for the next x100 moonshot! Ape wisely!

The Greatest of all the SONS in BSC!
...
// 🔥__Token Name : SON OF FEG
// 🔥__Token Symbol : $SOF
// 🔥__Total Supply : 1,000,000,000,000__
// 🔥__Initial Liquidity : 7 BNB__
// _______________________________________
// **📱Telegram: @Son_Of_Feg**
...
contract SonOfFegOfficial is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SonOfFeg";
