...
contract DEMO3TEST is Context, IERC20, Ownable {
    ...
    string private _name = "DEMO3TEST";
    string private _symbol = "TFS";
    ...
    address public charityWallet = 0x30D2aEeFD497444a24d9509bc4bBfcB6e5FE80cb;
    ...
    uint256 public numTokensSellToAddToLiquidity = 26 * 10**6 * 10**9;
