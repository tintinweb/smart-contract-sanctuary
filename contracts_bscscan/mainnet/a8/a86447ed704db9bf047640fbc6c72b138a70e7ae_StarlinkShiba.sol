...
contract StarlinkShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x4Beb153230eBe8B7EdDE5C446162551626b77DB8); // Marketing Address
    ...
    string private _name = "Starlink Shiba";
    string private _symbol = "SLShiba";
    ...
    uint256 public _maxTxAmount = 300000000 * 10**3 * 10**9;
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 9;
        _maxTxAmount = 300000000 * 10**3 * 10**9;
    }
