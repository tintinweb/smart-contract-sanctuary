...
GoldenUnicornBSC
   ...
   Shiba,Rfi,Feg,CT,Safemoon,GoldenUnicornBSC combine together to creat GoldenUnicornBSC designed.
    
    I make this #GoldenUnicornBSC to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/GoldenUnicornBSC
   ...
   I will renounce the ownership to burn addresses to transfer #GoldenUnicornBSC to the community, make sure it's 100% safe.

   I will add 0.35 BNB and all the left 50% total supply to the pool
   Can you make #GoldenUnicornBSC 100000X? 

   1,000,000,000,000,000 total supply
   50,000,000,000,000 GoldenUnicornBSC max limit for per trade
   ...
   it's the best part of the #GoldenUnicornBSC idea, increasing the liquidity pool automatically, 
...
contract GoldenUnicornBSC is Context, IERC20, Ownable {
    ...
    string private _name = "GoldenUnicornBSC";
    string private _symbol = "GUBSC";
