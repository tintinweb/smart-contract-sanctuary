...
🐯 Hello and Welcome to the most ambitious HiXiang project represent the strongest nation in the world. 

🇨🇳 HaiXiang aims to represent China to the entire world. And what better way to do that than to introduce. 

💰Are you willing to put in the sweat and be rewarded? HaiXiang needs you!

Notes
*FAIR LAUNCH, NO PRESALE AND PRIVATE SALE

More info is below or on the website.
...
* 🔥 90% of initial supply burnt
* 📈 Great PROFITS to be made. (1000x) 🚀
* 🏅 Aggressive fair launch and post-launch MARKETING
* ✅ NO risk of rugpulls / 100% safe(Liquidity locked buy)
* 🙎🏼‍♂️ No TEAM or DEV wallet 
* 🔒 Liquidity LOCKED 
* 📊 CoinGecko/CoinMarketCap applications will be after launch 
* 👫 Devs are apart of the community

Designed to improve on other community failures & to thrive on transparency & community direction.

✈️ Telegram: https://t.me/HaiXiangBSC
🌐 Twitter: https://twitter.com/HaiXiangOffice
🌐 WEBSITE: https://www.timeanddate.com/countdown/launch?iso=20210710T04&p0=102&msg=Launch+Countdown&font=cursive&csz=1
🪙 Coinsniper: https://coinsniper.net/coin/
...
contract HaiXiang is Context, IERC20, Ownable {
    ...
    address private _donationWalletAddress = 0xF8B3CB34a311c7d39d8cf1F0Ac43C71a22a1E4a4;
    ...
    string private _name = "HaiXiang";
    string private _symbol = "HX";
