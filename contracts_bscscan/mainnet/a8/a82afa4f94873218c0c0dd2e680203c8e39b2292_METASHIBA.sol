...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x70e5AbcD93f2eA3Ff5651626f564637be2c5BB33;
...
contract METASHIBA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc9747592f8623f8EAd5859644a3cD5c65F7854fc;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "METASHIBA";
    string private _symbol = "METASHIBA";
