...
/**
SHIBA MUTANT In biology, and especially in genetics, a mutant is an organism or a new genetic 
character arising or resulting from an instance of mutation, which is generally an alteration of 
the DNA sequence of the genome or chromosome of an organism. 
It is a characteristic that would not be observed naturally in a specimen.
LP LOCK RO -- INVEST OR CRY LATER 
*/
...
contract ShibaMutant is IBEP20, Context, OwnableNODE {
    ...
    string public override name = "Mutant Shiba";
    string public override symbol = "Shiba Mutant";
    ...
    constructor(uint totalSupplyValue, address TeamMutantAddress, address CharityMutantAddress) {
        ...
        balances[TeamMutant] =  totalSupply * 4 / 100;
        balances[CharityMutant] = totalSupply * 3 / 100;
        
        balances[_owner] = totalSupply * 93 / 100;
    }
