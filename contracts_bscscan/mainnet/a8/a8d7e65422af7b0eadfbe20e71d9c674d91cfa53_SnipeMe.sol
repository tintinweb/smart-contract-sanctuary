...
/**
 ...
 This token is intended to be a community token. Once liquidity is added, it will be locked
 and a link pinned in the telegram. There's no marketing wallet, but we have already paid up 
 front for initial marketing. HIGH AF rewards.LET'S GO!
    ...
    $$ |  $$ |$$ |  $$ |  $$ |  $$ |      $$ |      $$ |      $$ |      
    \$$$$$$$ |$$ |  $$ |$$$$$$\ $$ |      $$ |      $$$$$$$$\ $$$$$$$$\ 
     \_______|\__|  \__|\______|\__|      \__|      \________|\________|
    



 TG: https://t.me/dRIPPLE_bsc
 
 Tokienomics:
 17% drippin' in RIPPLE reflections
 3% back into liquidity
 Total Supply: 1000000000
 Max Wallet: 3.5% 
 Max Transaction: 3.5%
 Buy Slippage: 21-23% (12% should be OK)
 
 Check $XRP gains: 0x1d2f0da169ceb9fc7b3144628db156f3f6c60dbe
...
// CHANGE
contract SnipeMe is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SnipeMe";
    string constant _symbol = "Snipes";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 100
    uint256 public _maxTxAmount = (_totalSupply * 500) / 1000; // 50% MAX 35
    uint256 public _maxWalletSize = (_totalSupply * 500) / 1000; // 50% MAX 35
    ...
    uint256 totalFee = 200; // liquidityFee + reflectionFee + marketingFee
