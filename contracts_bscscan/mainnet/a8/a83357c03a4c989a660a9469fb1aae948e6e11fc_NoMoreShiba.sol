...
.__   __.   ______      .___  ___.   ______   .______       _______ 
|  \ |  |  /  __  \     |   \/   |  /  __  \  |   _  \     |   ____|
|   \|  | |  |  |  |    |  \  /  | |  |  |  | |  |_)  |    |  |__   
|  . `  | |  |  |  |    |  |\/|  | |  |  |  | |      /     |   __|  
|  |\   | |  `--'  |    |  |  |  | |  `--'  | |  |\  \----.|  |____ 
|__| \__|  \______/     |__|  |__|  \______/  | _| `._____||_______|
                                                                    
     _______. __    __   __  .______        ___      
    /       ||  |  |  | |  | |   _  \      /   \     
   |   (----`|  |__|  | |  | |  |_)  |    /  ^  \    
    \   \    |   __   | |  | |   _  <    /  /_\  \   
.----)   |   |  |  |  | |  | |  |_)  |  /  _____  \  
...
Welcome to No More Shiba, tired of always hearing about that annoying dogo?
Then you are at the right place because so we are!

This token aim to completely destroy shiba inu from the market and all of his clone
Join the fight because we are going to fly 

tg : https://t.me/NoMoreShiba
Website : nomoreshiba.com
...
contract NoMoreShiba is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x6BaBaaBCf8528A412B463461B5fd5AFB9F634DB9);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "No More Shiba";
    string private _symbol = "NMS";
    ...
    //amount (in tokens) at launch set to 0.2% of total supply
    uint256 public _numTokensSellToAddToLiquidity = 2000000 * 10**6 * 10**9;
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0xbda78e480A2E8f418C8c27A8d81465B66b3ecd36)] = true;
