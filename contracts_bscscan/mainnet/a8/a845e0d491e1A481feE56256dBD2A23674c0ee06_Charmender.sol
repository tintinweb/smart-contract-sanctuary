...
/*
    ...
    Charmender Token - 10% ETH Redistribution - Auto Claim ETH by just holding!
    
    10% Auto Rewards in ETH added to holder wallets 
    Charmander-Token.com
    twitter.com/CharmnderToken
    t.me/CharmanderToken
    ...
    📌   3% Added to Lottery wallet
    
    📌   No Dev wallets
    📌   ANTI RUG embedded in code
    📌   Anti-Dump mechanis
    📌   10% ETH Will be Added to holder’s wallets
    
    We will add 0.5 BNB to liquidity and burn and renounce ownership after launch.
...
contract Charmender is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Charmender";
    string private constant _symbol   = "$CHARMENDER";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 0;
    uint256 public _liquidityFee = 0;
    uint256 public _marketingFee = 1600;
