...
contract TheApening is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xC344Dc589d02AE7d34c789DFb6E4271513b6D614;
    ...
    string private _name   = "TheApening";
    string private _symbol = "APENING";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2;   //Frictionless Yield Fee
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 8;   // BURN/Liquidity fee
    ...
    uint256 public _maxTxAmount = 10**15 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 10**9 * 10**18;
    address private _CharityWallet;
    uint256 private constant _Charity_FEE = 2;    //  Charity Wallet Fee (in bips)
