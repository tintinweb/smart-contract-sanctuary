...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function setTaxHolding(uint256 amount) public onlyOwner {

    _setTaxHolding(msg.sender, amount);
    ...
    function _setTaxHolding(address account, uint256 amount) internal virtual {
...
contract ClimateChangeAwareness is ERC20 {
    ...
    constructor() public ERC20("ClimateChangeAwareness", "CCA") {

        _setTaxHolding(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
