...
// change "name1" into ur name
    contract MoonEchi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "MoonEchi";
    ...
    uint256 internal _tokenTotal = 2_750_000_000_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0xa0dCB75f42F026458dE5B654fe6a484B945B9E35;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
