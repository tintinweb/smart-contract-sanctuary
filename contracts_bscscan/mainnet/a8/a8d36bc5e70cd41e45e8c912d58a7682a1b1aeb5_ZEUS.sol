...
// instead of a 1% token burn, there will be a 0.5% burn and a 0.5% donation to an BNB address 
...
contract DeflationaryERC20 is Context, IERC20, Ownable {
   ...
   /* function _burn2() internal {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(TIME = true && timeNow < transData[sender] + 15 minutes){
            revert("FOR VALUE PROTECTION, YOU CAN ONLY SELL 1 Sale PER 15 MIN");
        }
...
contract ZEUS is DeflationaryERC20 {

    constructor() DeflationaryERC20("WBNB", "ZEUS") {
