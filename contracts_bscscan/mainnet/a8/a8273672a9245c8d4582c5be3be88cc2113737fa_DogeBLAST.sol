...
contract DogeBLAST is Context, IBEP20, Ownable {
  ...
  uint256 public _rewardPercent = 13;
  uint256 private _maxTrxLimit = 30 * 10**3 * 10**12;
  address private _deployer;
