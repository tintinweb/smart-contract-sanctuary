...
contract Master is Ownable {
    ...
    // Market oracle provides the GFC/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _gfc) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = gfc.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && gfc.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(gfc.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return gfc.totalSupply().toInt256Safe()
