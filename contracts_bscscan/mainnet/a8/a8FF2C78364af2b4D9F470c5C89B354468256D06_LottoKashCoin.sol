...
// hodl and win up to 100x @lottokashcoin
...
contract LottoKashCoin is Context, IERC20, Ownable {
    ...
    string private _name = "LottoKashCoin";
    string private _symbol = "LottoKash";
