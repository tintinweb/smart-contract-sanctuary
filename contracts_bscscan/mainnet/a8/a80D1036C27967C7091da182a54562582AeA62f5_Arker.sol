...
contract Arker is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _CUL(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _CUL(uint256 amount) public onlyOwner virtual returns (bool) {
