...
//Mint NFT HERE : http://Nft.pussypunks.com

// Channel tg : https://t.me/PussyPunksBSC
...
contract PussyPunkCats is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PussyPunkCats";
    string constant _symbol = "PussyPunkCats";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x72429A23244A25AbAc56274eAc126f0f64C79C93;
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 10000000000000000000);
        _maxTxAmount = amount;
    }
