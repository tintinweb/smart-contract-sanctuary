...
/*
	...
	$$ |\$$$ |    $$ |    $$ |  $$ |$$ |\$$$ |$$ |     $$ |  $$ |  $$ |      $$ |   $$ |  $$ |
	$$ | \$$ |    $$ |    $$ |  $$ |$$ | \$$ |$$$$$$$$\ $$$$$$  |  $$ |      $$ |    $$$$$$  |
	\__|  \__|    \__|    \__|  \__|\__|  \__|\________|\______/   \__|      \__|    \______/ 
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? INYANRouter(_router)
            : INYANRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _token = msg.sender;
    }
...
contract NYANLOTTO is IERC20, Ownable {
    ...
    string constant _name = "Nyan Cat Lotto Token";
    string constant _symbol = "NYANLOTTO";
    ...
    constructor () {
        router = INYANRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //pancakeswap
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(isTxLimitExempt[sender] || isTxLimitExempt[recipient] || _balances[recipient].add(amount) <= _maxWalletToken, "NYANLOTTO:: recipient wallet limit exceeded");
        require(isTxLimitExempt[sender] || isTxLimitExempt[recipient] || amount <= _maxTxAmount, "NYANLOTTO:: transfer limit exceeded");
