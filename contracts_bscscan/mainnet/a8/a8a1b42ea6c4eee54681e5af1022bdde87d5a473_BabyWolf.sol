...
🐺Baby Wolf Token🐺 New BSC Reward Token🐺
Fair-launch on Pancake Swap 6th of September 2021 at 15:30 UTC

🐺Welcome to Baby Wolf Token!🐺

What is better than earning 10% BNB every 1 Hour, just HOLD $BWT and Enjoy !!!

🐺Contract: Will be published 10 minutes before the launch

✔️SMART VERIFIED CONTRACT
✔️NO PRE-SALES
✔️NO WHITELIST
✔️NO AIRDROPS
✔️100% FAIR LAUNCH
...
14% BNB Redistribution every 1 Hour
3% Liquidity
2% Marketing wallet

🐦Twitter: https://twitter.com/Baby_Wolf_bsc
💌Telegram: @babyWOLF_token
🌐Website: babywolf.org
...
contract BabyWolf is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1_000_000_000;
    ...
    string private _name = "Baby Wolf Token";
    string private _symbol = "BWT";
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 3;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _toHolder = 14;
    uint256 private _previoustoHolder = _toHolder;
    uint256 private _Buyback = 0;
    uint256 private _previousBuyback = _Buyback;
    uint256 private _Burn = 0;
    uint256 private _previousBurn = _Burn;
    uint256 private _PrizeCash = 0;
    uint256 private _previousPrizeCash = _PrizeCash;
    
    IUniswapV2Router02 public immutable uniswapV2Router;

    // ROUTER
    address private _v2Router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    // mainnet PCS 0x10ED43C718714eb63d5aaA57B78B54704E256024E
    // testnet PCS 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3

    address public uniswapV2Pair;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;

    address _marketingWallet = 0x41ffCc961134B3f48003BBCA7AA1ae6e3d7a0Cc4;
