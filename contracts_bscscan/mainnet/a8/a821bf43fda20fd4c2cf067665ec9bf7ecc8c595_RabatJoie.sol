...
/**
HERE YOU CAN PASTE A DESCRIPTION OR COOL ASCII LOGO FOR YOUR TOKEN                      
HERE YOU CAN PASTE A DESCRIPTION OR COOL ASCII LOGO FOR YOUR TOKEN 
HERE YOU CAN PASTE A DESCRIPTION OR COOL ASCII LOGO FOR YOUR TOKEN 
HERE YOU CAN PASTE A DESCRIPTION OR COOL ASCII LOGO FOR YOUR TOKEN 
HERE YOU CAN PASTE A DESCRIPTION OR COOL ASCII LOGO FOR YOUR TOKEN 
...
contract RabatJoie is Context, IERC20, Ownable {
    ...
    string private _name = "Rabat Joie";
    ...
    uint256 internal _tokenTotal = 100000 *10**16;
    ...
    // fees
    uint256 public _StakingFee = 1500; // 100 = 1%
    ...
    uint256 public _liquidityFeeTotal = 100; // 100 = 1%
    //addresses
    address public marketingAddress = 0x08aD8DA04EFBd45B6505490cA691EB16FB3d52D6;
 ...
 /**
    ...
    */
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E,"TOKEN: Uniswap router cannot be excluded.");
        require(account != address(this), 'TOKEN: The contract it self cannot be excluded');
