...
contract Joker777 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 777 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tHODLrRewardsTotal;

    string private _name = "Joker777";
    string private _symbol = "Joker777";
