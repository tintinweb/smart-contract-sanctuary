...
/* contacts let = "name cryptotanks" id =1000000000000000 
getAmountOut(cryptotanks)
...
// File: contracts\cryptotanks.sol

contract CRYPTOTANKS is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "CRYPTO TANKS";
	...
	// CHARITY
	address payable private constant _charityAddress = payable(0x2d8479293dd783aba67bbAcbce1dD08daF1965C5); // A percentage of the BNB pool will go to the charity address
	...
	constructor (address routerAddress) {
		...
		uint256 _tokenForLiquidity = _totalTokens * 35 / 100;
		...
		uint256 _tokenForBurn = _totalTokens * 60 / 100;
