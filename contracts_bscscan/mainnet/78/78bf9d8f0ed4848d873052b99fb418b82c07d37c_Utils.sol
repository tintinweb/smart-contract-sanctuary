...
contract GoldenClover is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Golden Clover";
    string private _symbol = "GCVR";
    ...
    uint256 public _liquidityFee = 7; // 3% will be added pool, 4% will be converted to BNB
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own GCVR to claim reward');
