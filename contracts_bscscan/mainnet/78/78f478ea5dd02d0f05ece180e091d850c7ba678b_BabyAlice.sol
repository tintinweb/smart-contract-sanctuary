...
/**
	...
	contract BabyAlice is Context, IERC20, Ownable {
		...
		uint256 private _tTotal = 1 * 10**17 * 10**9;
		uint256 private _rTotal = (MAX - (MAX % _tTotal));
		uint256 private _tFeeTotal;
		uint256 private _tBurnTotal;

		string private _name = "BabyAlice";
		string private _symbol = "BabyAlice";
		...
		uint256 public _maxTxAmount = 8* 10**14 * 10**9;
