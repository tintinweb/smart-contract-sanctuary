...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2d0D873D93B6553A40CF0C994F1405184D9377E1;
...
contract ChikuCheemsInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x179982f2104e6C80f4C3ea4400B98c37403B0710;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18; // 1 Trillion Total Token Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Chiku Cheems Inu";
    ...
    uint256 public _maxTxAmount = 150 * 10**8; // Max Tx Amount 15 Billion (1.5%)
    uint256 public _maxWalletToken = 300 * 10**8; // Max Wallet: 30 Billion (3%)
