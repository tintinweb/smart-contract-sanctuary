...
contract SquidGameFan is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 45600 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    string private _name = "Squid Game Fan";
    ...
    address public developmentFeeWallet = 0xa976Bb546b9504E378e61AA8A8Fb4649FEe5ffe3;
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;
    uint256 public _maxTxAmount = 228 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 22.8 * 10**6 * 10**9;
    ...
    function _distributeFee(uint256 rFee, uint256 rBurn, uint256 rDevelopment, uint256 tFee, uint256 tBurn, uint256 tDevelopment) private {
        ...
        _rOwned[developmentFeeWallet] = _rOwned[developmentFeeWallet].add(rDevelopment);
        if (_isExcluded[developmentFeeWallet]) {
            _tOwned[developmentFeeWallet] = _tOwned[developmentFeeWallet].add(tDevelopment);
        }
    }
    ...
    function setDevelopmentWallet(address newWallet) external onlyOwner() {
        developmentFeeWallet = newWallet;
    }
