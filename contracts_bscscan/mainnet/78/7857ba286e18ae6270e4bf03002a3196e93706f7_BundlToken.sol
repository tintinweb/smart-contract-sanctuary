...
/**
   ...
   # Founder of Bundl: Noel security-considerations
   [Bundl](https://bundl.me)
   # Founders of BundlToken: Noel Serrato, Man Bui, Michael Navarro
...
contract BundlToken is Context, IERC20, Ownable {
    ...
    string private _name = "BundlToken";
    ...
    uint256 public maxlimit = 100000 * 10**6 * 10**9;
    ...
    function _transfer(
        ...
        if(to == address(uniswapV2Pair) || to == address(uniswapV2Router)) {
                ...
                if (fromBalance > threshold) {
                    ...
                    require( _now - (previousSale[from]) > 5 hours, "You must wait 5 hours before you may sell again.");
                }
            }
