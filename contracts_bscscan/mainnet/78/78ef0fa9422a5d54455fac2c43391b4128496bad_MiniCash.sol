...
Contract by DeFiSCI and Team - built on others previous work w/ a splash of  magic...
...
contract MiniCash is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbEe9448967De11cf0ED5f35ee6A4385c4e5780B6); // Marketing Address
    ...
    string private _name = "MiniCash";
    string private _symbol = "MiniCash";
    ...
    uint256 public _intervalMinutesForSwap = 2 * 2 minutes;
