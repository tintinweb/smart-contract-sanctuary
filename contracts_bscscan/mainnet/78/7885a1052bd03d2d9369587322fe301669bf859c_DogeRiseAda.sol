...
// CHANGE
contract DogeRiseAda is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeRiseAda";
    string constant _symbol = "DRADA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 1% MAX 1,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x9632DAe1F239AF5342479bd3702e793Da525B286);
