...
contract IncredibleFRED is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x771a56981E939133d95196307a9d8D604951D580); // Marketing Address
    ...
    string private _name = "IncredibleFRED";
    string private _symbol = "IncFRED";
    ...
    uint256 public _maxTxAmount = 30000000000000 * 10**6 * 10**9;
