...
Welcome to BabyVET
   This is a community token. If you want to create a telegram I suggest to name it to @BabyVET
   ...
   I will renounce the ownership to burn addresses to transfer #BabyVET to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left All (100%) total supply to the pool
   Can you make #BabyVET 10000X? 
   ...
   it's the best part of the #BabyVET idea, increasing the liquidity pool automatically, 
...
contract BabyVET is Context, IERC20, Ownable {
    ...
    string private   _name = "BabyVET";
    string private _symbol = "BabyVET";
