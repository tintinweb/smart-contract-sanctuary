...
import "./MiniBasketBall-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MiniBasketBall` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MiniBasketBall(Env.Testnet)` or `MiniBasketBall(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MiniBasketBall";
    string internal constant SYMBOL = "MBB";
     ...
     */
    address internal tipToTheDev =0xB67CE4Bb7dB439aF90ED3f21183FC5f80EfF8F89;
...
contract MiniBasketBall is SafeToken{
