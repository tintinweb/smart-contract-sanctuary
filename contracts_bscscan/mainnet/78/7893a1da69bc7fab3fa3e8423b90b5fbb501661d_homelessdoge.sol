...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95); //the reward token you want distributed 
...
contract homelessdoge is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "homelessdoge";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "$Homeless";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; //4% max tx
    ...
    uint256 reflectionFee   = 5; // $Banana rewards
    uint256 marketingFee    = 10; // buybacks and marketing costs
