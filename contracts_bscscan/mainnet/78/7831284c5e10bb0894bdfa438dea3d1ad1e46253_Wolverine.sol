...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
contract Wolverine is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public currentlyServing = "ADA";

    string constant _name = "Wolverine";
    string constant _symbol = "WLV";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 6) / 1000; //0.3% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 9) / 1000; // 0.9%
    ...
    function setTxLimit(uint256 numerator, uint256 divisor) external onlyOwner {
        require(numerator > 2 && divisor > 0 && divisor <= 1000);
