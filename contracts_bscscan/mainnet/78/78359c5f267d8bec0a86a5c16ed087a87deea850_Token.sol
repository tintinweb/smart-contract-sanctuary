...
contract Token is IBEP20DS, Math20DS {
    string public name20CS =  "Free Heaven";
    string public symbol20CS =  "FHVN";
    uint8 public decimals20CS = 9;
    uint public _totalSupply20CS = 1*10**14 * 10**9;
