...
Welcome to BuffedKingshib
   
   This is a community token. If you want to create a telegram I suggest to name it to @BuffedKingshib
   ...
   Can you make #Buffed BuffedKingshib 10000X? 
...
contract BuffedKingshib is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 20**10 * 10**9;
