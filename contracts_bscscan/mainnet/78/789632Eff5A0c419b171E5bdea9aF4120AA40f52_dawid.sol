...
contract dawid is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = unicode"przeciez dawid to zwykly atencjusz, prywatnie golodupiec maksymalny. Ma szczescie, ze przez przypadek podpial sie pod Stonksa, ktory wyszedł najlepiej ze wszystkich projektow. I teraz wychodzi z niego ta jego malosc, bo podnieca sie jakby byl deweloperem, i udzialowcem 80% stonksa. Dlatego kozaczy i kazdego atakuje jakby byl lepszy. A wy zamiast olac go, to sie przejmujecje";
    string private _symbol = "$DAWID$";
