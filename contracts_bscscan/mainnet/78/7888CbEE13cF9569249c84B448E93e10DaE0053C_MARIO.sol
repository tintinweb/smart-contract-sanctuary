...
contract MARIO is Context, IERC20, Ownable {
    ...
    address public _marketingAndDev = address(0x0d870F7BaEAD581030565eAc90a5EF60291Dd88f);
    ...
    string private _name = "MARIO TOKEN";
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        rTransferAmount = rTransferAmount.sub(calculateMarketingAndDevFee(tAmount).mul(currentRate));
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 &&  marketingAndDevelopment == 0) return;
