...
contract StratX_planetLP is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public PLANET_WITHDRAW_FEE = 10;
    ...
    constructor() public {
        wantAddress = 0x4c4f18da91063F1c34a9396B2d97e95b163F2b0c;
        pid = 54;
        token0Address = IPlanetPair(wantAddress).token0();
        token1Address = IPlanetPair(wantAddress).token1();
        ...
        IERC20(token0Address).safeApprove(unirouterplanet, 0);
        IERC20(token0Address).safeApprove(unirouterplanet, uint256(-1));

        IERC20(token1Address).safeApprove(unirouterplanet, 0);
        IERC20(token1Address).safeApprove(unirouterplanet, uint256(-1));
    ...
    function addLiquidity() internal {
        ...
        IPlanetRouter01(unirouterplanet).addLiquidity(
            token0Address,
            token1Address,
            lp0Bal,
            lp1Bal,
