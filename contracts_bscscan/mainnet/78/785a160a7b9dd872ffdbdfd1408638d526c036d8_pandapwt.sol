...
contract pandapwt is Context, IERC20, Ownable {
    ...
    address private _projectWalletAddress = 0x6A35C5963Ad97E73b61d6C9087ED697fe4bF7e57;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 475000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PandaInu Wallet Token";
    string private _symbol = "PWT";
