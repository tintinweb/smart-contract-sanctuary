...
// CHANGE
contract theTESTES is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "The Testes";
    string constant _symbol = "t Testes";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 100
    uint256 public _maxTxAmount = (_totalSupply * 15) / 1000; // 1.5% MAX 35
    uint256 public _maxWalletSize = (_totalSupply * 35) / 1000; // 3.5% MAX 35
    ...
    uint256 liquidityFee = 650; // 6.5%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 1350; // 13.5%
