...
/**
   #SeaWARS
    ...
    I suggest a telegram group name for you to create: https://t.me/SeaWARS
   ...
   I will renounce the ownership to burn addresses to transfer #SeaWARS to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 49.5% total supply to the pool
   Can you make #SeaWARS 10000000X? 
   ...
   it's the best part of the #SeaWARS idea, increasing the liquidity pool automatically, 
...
contract SeaWARS is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("SeaWARS", "SeaWARS") {
