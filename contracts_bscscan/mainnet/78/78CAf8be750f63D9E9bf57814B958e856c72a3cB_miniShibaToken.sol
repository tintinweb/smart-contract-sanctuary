...
contract miniShibaToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "miniShibaToken";
  string private _name = "miniShibaToken";
