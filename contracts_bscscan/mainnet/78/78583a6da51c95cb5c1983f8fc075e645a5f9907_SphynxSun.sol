...
//   I make this SphynxSun to hand over it to the community.
//   Create the community by yourself if you are interested.   
//   I suggest a telegram group name for you to create: https://t.me/SphynxSun
	 
	 

//	Liquidity will add 0.4
//	Liquidity Locked
//	DONT BUY BEFORE LIQUIDITY LOCK!!!!!!
//	BURN SUPPLY 20%
...
contract SphynxSun is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SphynxSun";
    string constant _symbol = "SphynxSun";
