...
contract GAMERPLAY is Context, IBEP20, Ownable {
    ...
    string  private _name = 'GAMERPLAY';
    string  private _symbol = 'GAMER';
    uint8   private _decimals = 9;
   
    uint256 private constant _MAX = ~uint256(0);
    uint256 private _decimal_factor = 10 ** uint256(_decimals);
    uint256 private constant _GRANULARITY = 100;
    
    uint256 private _tTotal = 20000000 * _decimal_factor;
    ...
    uint256 private _max_tx_size = 1000000000000 * _decimal_factor;
    
    address private LiquidityAddress;
    uint256 private _max_wt_size = 4000000000 * _decimal_factor;

    bool public tradingEnabled = true;
    uint256 public _marketingFee = 200;
    address public marketingWallet = 0x4671cc0D92df5e6746aA535D562B9ACCB1E29377;
    ...
    function setMaxTxSize(uint256 amount) external onlyOwner() {
        _max_tx_size = amount * _decimal_factor;
    }
    ...
    function setMaxWtSize(uint256 amount) external onlyOwner() {
        _max_wt_size = amount * _decimal_factor;
    }
    ...
    function setTaxPercent(uint256 _taxFee) external onlyOwner() {
        _tax_fee = _taxFee;
        _burn_fee = _taxFee;
    }
}