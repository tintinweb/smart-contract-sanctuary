...
EPIC NFT CARD GAME FOR PLAYERS, TRADERS AND ART COLLECTORS

~ Show your true power by collecting the most unique and powerful Egyptian cards ~

NEXT-GEN META MMO & CARD GAME
EXPLORE A VAST WORLD FULL OF PERIL IN 
AN ANCIENT EGYPT STYLIZED ACTION DRIVEN METAVERSE MMO & CARD GAME


 Twitter: https://twitter.com/Mummylabs
        Website: https://Mummy.io
        TG: https://t.me/joinchat/2i5rhMhlS99mYjJk


        Tokenomics
        10,000,000,000 $MMY
        3% Buy tax
        7% Sell tax first hour, 13% thereafter
...
contract MummyGamingBSC is Context, MummyGaming, Ownable {
    ...
    string private _name = 'Mummy.io';
    string private _symbol = 'Mummy';
