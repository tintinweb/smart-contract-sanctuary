...
// File: contracts\MRFTMToken.sol

contract MRFTMToken  is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "Mad Respect For The Makers Token";
	string private constant _symbol = "MRFTM";
    ...
    uint256 private constant _initialLiquidityPercentage = 10;
	...
	constructor (address routerAddress) {
		...
		_balances[_msgSender()] = _totalTokens * _initialLiquidityPercentage / 100 * currentRate;

        	_balances[_burnWallet] = _totalTokens * _initialBurnPercentage / 100 * currentRate;
		...
		// Initialize PancakeSwap V2 router and MRFTM <-> BNB pair.  Router address will be: 0x10ed43c718714eb63d5aa57b78b54704e256024e
	...
	// This function swaps a {tokenAmount} of MRFTM tokens for BNB and returns the total amount of BNB received
	...
	function claimReward() isHuman nonReentrant private {
		...
		require(balanceOf(msg.sender) >= 0, "The address must own MRFTM before claiming a reward");
