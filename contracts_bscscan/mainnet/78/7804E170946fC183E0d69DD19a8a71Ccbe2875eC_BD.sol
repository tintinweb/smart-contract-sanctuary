...
contract BD is Context, IERC20, Ownable {
    ...
    string private _name = "DOGE zijia";
    string private _symbol = "DOGE zijia";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2; // 3% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 1; // 3% added to liquidity 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _burnFee = 5; // 2% burn fee
