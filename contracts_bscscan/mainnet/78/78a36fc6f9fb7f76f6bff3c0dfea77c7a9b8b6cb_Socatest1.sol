...
contract Socatest1 is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 20_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 50_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 100_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 3000_000_000 * 10**_decimals;

    address public marketingAddress = 0x0C0886A8dB6C57a4a97057517482856bb09ABF35;
    address public devAddress = 0x0C0886A8dB6C57a4a97057517482856bb09ABF35;

    string private constant _name = "Socaverse";
    string private constant _symbol = "SOCA";
    ...
    Taxes public taxes = Taxes(2,2,4);
    ...
    function updateRouterAndPair(address newRouter, address newPair) external onlyOwner{
        // Thanks you Freezy (https://t.me/FreezyDev)
