...
contract DividendTracker is DividendPayingToken {
  ...
  constructor(
    ...
    minimumTokenBalanceForDividends = 100_000_000 * 10**9; // must hold 100M tokens which equates to 0.01% of the total VagabondDogeCoin supply
  }
...
// File: contracts/IVagabondDogeCoin.sol
...
interface IVagabondDogeCoin is IERC20, IERC20Metadata {
...
// File: contracts/VagabondDogeCoin.sol
  ...
  ReentrancyGuard
{
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'VagabondDoge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'VagabondDoge: Automated market maker pair is already set to that value'
    );
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'VagabondDogeCoin: The dividend tracker already has that address'
    );
    ...
    require(
      ...
      'VagabondDogeCoin: The new dividend tracker must be owned by the token contract'
    );
