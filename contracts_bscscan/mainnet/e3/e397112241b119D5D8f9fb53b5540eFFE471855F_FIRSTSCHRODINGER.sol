...
contract FIRSTSCHRODINGER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "First Schrodinger iNu";
...
/* lottery Begins */
 ...
 function lottery(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to lottery");
