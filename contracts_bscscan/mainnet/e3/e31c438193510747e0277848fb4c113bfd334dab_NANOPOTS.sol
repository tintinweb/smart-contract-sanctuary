...
contract DividendDistributor is IDividendDistributor {
    ...
    event Deposit(uint256 amountBNB, uint256 amountPOTS);
...
contract NANOPOTS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NANO POTS";
    string constant _symbol = "NPOTS";
    ...
    uint256 swapThreshold = _totalSupply / 40000; // 0.025%
