...
contract TIPSYSHIBA is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x333ffBb4B2312C867A0737f558BbAC6659465EF4); // Marketing Address
    ...
    string private _name = "TIPSY SHIBA";
    ...
    uint256 private _maxTransaction = 100000000000 * 10**9;
	...
	function setTxLimit(uint256 maxTx, uint256 maxWallet) external onlyOwner() {
        _maxTxAmount = maxTx;
		_maxWalletSize = maxWallet;
    }
	
	function launchToken () external onlyOwner() {
        _maxTransaction = 1000000000000000000000000000000;
		until = 0;
    }
