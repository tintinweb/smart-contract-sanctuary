...
/**
 Welcome to Mother Of Floki
   
   Telegram: https://t.me/MotherOfFloki
   ...
   I will renounce the ownership to burn addresses to transfer #MotherOfFloki to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make MotherOfFloki inu 100X? 
   ...
   it's the best part of the #MotherOfFloki idea, increasing the liquidity pool automatically, 
...
contract BEP20 {
    ...
    contract MotherOfFloki is BEP20 {
