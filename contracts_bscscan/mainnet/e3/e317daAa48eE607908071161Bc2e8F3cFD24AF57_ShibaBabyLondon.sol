...
//SPDX-License-Identifier: MIT
    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        event Deposit(uint256 amountBNB, uint256 amountETH);
    ...
    contract ShibaBabyLondon is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "ShibaBabyLondon";
        string constant _symbol = "$SHIBLOND";
        uint8 constant _decimals = 9;
    
        uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000,000
