...
/**
    ...
    Buy and HODL RiseBabyBNB get $BNB
    
    We will add 0.5 BNB to liquidity and burn and renounce ownership after launch.
    
    RiseBabyBNB Token - 10% BNB Redistribution - Auto Claim BNB by just holding!
    
    💎🚀RiseBabyBNB Token - 3% BNB Lottery - Auto Claim BNB by just holding!🚀💎
    
    http://www.babybnb.biz
    
    t.me/RiseBabyBNB
    
    twitter.com/RiseBabyBNB
    ...
    📌   Anti-Dump mechanis
    📌   10% BNB Will be Added to holder’s wallets
...
contract RiseBabyBNB is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "RiseBabyBNB";
    string private constant _symbol   = "RiseBabyBNB";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 100;
    uint256 public _liquidityFee = 1400;
