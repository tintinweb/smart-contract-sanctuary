...
//SPDX-License-Identifier: MIT
    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        IBEP20 BUSD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);//BUSD address
        address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;//WBNB adress
        IDEXRouter router;
        ...
        constructor (address _router) {
            ...
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//pancake route
            _token = msg.sender;
        }
    ...
    contract PanCAKEPunk is IBEP20, Auth {
        using SafeMath for uint256;
    
        address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;//BUS
        address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;//wbnb
        address DEAD = 0x000000000000000000000000000000000000dEaD;
    
        string constant _name = "PanCAKEPunk";
        string constant _symbol = "CAKEPUNKS";
        ...
        constructor () Auth(msg.sender) {
            router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//pancake route address
