...
Telegram : https://t.me/santaflokizilla
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB5696323E05D998d702A93B83A365991C91F025d;
...
contract SantaFlokizilla is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xB5696323E05D998d702A93B83A365991C91F025d);
    ...
    */
    ...
    string private _name = "Santa Flokizilla"; 
    string private _symbol = "SantaFlokizilla";  
    ...
    */
    ...
    // Max wallet settings
    uint256 public _maxWalletToken = _tTotal.mul(4).div(100); // 4% max limit for each wallet
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Max Transaction settings 
    uint256 public _maxTxAmount = _tTotal.mul(2).div(100); // 2% max limit to prevent whales and massive dump. Do not increase further
    ...
    */
    ...
    list prior to launch. We also check for people using bots on the contract before we
