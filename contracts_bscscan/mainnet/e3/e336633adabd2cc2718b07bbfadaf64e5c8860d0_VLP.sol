...
/**
“Todo prazer é voluptuoso”
“Every pleasure is voluptuous”
- Sigmund Freud

The Most Desired Token
The Pink Diamond 

Website: https://voluhpia.com
...
contract VLP is Context, IERC20, Ownable {
    ...
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        ...
        _liquidityFee = liquidityFee * 10**2;
    }
   
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
		require(maxTxPercent < 100);
