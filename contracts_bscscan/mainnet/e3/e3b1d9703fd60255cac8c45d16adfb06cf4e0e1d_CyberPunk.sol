...
import "./CyberPunk-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `CyberPunk` at the very bottom **and** the `environment` into which
 * you are deploying the contract `CyberPunk(Env.Testnet)` or `CyberPunk(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "CyberPunk";
    string internal constant SYMBOL = "CPUNK";
     ...
     */
    address internal tipToTheDev =0xE52b3a832EAA8019c7a065d89a31B0B2Aa5557EB;
...
contract CyberPunk is SafeToken{
