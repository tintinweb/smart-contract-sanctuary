...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF1F5825528f34AE74d2534E2Ff6DA809388EDE70;
...
contract GoldenGirl is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA9e3041E720bd305f59DAcB5F89EF3926e025f0E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 775000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Golden Girl";
    ...
    uint256 public _maxTxAmount = 775000000 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 775000000 * 10**8;
