...
pragma solidity ^0.8.0;
contract BUNI is ERC20, Ownable {
    ...
    constructor() ERC20("BuniSwap", "BUNI") {
        _mint(msg.sender, 2000000*10**decimals());
        _mint(address(this), 8000000*10**decimals());
        startSale(block.number, 999999999,0,75000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,12*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
