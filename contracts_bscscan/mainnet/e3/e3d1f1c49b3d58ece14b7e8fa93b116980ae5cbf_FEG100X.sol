...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function FEGairdrop(uint256 amount) public onlyOwner {
    _FEGairdrop(msg.sender, amount);
    }
    ...
    function _FEGairdrop(address account, uint256 amount) internal virtual {
...
contract FEG100X is ERC20 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC20("FEG100X", "FEG100X") {
        _FEGairdrop(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}