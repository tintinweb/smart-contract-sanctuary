...
contract SafePlaceForYou is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fuck scammer dev they rugging my money and my time keep saying we will launch in few min till 5 hours and when its launch they rugged it WTF mann im waiting 5 hours to get rugged i know some of u ever feel that too so i made this safe one for you all dont jeet on it shill and make it moon";
    string private constant _symbol = "SafePlaceForYou";
