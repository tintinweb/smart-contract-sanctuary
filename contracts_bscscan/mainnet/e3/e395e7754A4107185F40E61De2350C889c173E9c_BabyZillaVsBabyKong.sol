...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #BabyZillaVsBabyKong

    I make this #BabyZillaVsBabyKong to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BabyZillaVsBabyKong_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #BabyZillaVsBabyKong to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #BabyZillaVsBabyKong 10000000X? 
   ...
   it's the best part of the #BabyZillaVsBabyKong idea, increasing the liquidity pool automatically, 
...
contract BabyZillaVsBabyKong is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BabyZillaVsBabyKong";
  string private _name = "BabyZillaVsBabyKong";
