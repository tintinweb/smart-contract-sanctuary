...
contract SisterDogezilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x350a76CA99a3b26acd448DA4A4F52D28dAD9F4f1); // Marketing Address
    ...
    uint256 private _tTotal = 69000000000 * 10**12 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SisterDogezilla";
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**12 * 10**18; 
    uint256 private minimumTokensBeforeSwap = 25000000 * 10**12 * 10**18; 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 100000000 * 10**12 * 10**18;
    }
