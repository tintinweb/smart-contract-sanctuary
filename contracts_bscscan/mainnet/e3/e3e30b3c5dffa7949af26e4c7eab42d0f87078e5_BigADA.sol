...
// Telegram : https://t.me/BigADABSC

// Tokenomics : 20% total TAX, 10% reflections, 5% marketing & 5% back to liquidity
...
contract BigADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BigADA";
    string constant _symbol = "BigADA";
