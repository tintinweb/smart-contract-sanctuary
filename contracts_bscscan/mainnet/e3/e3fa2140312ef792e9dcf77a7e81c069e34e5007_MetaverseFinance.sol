...
contract MetaverseFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE715AB5eb2e85A933CCb0823Ce3C513AE3348855); // Metaverse Fiance Marketing
    ...
    string private _name = "Metaverse Finance";
    string private _symbol = "MVF";
    ...
    uint256 private _sellLiquidityFee = 85;
