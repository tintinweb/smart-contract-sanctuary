...
Tax 10%
5% - Reflection to all Baby Rabbit Hodlers
3% - Marketing wallet
2% - Auto supply burn

Anti Whale / Dump with Max TX 2000000000000 (2Trillion) Tokens
Telegram @FuckDogeCoins
*/
...
contract Fuck_Doge_Coins is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Fuck Doge Coins';
    string  private constant _SYMBOL = 'FDC';
    ...
    uint256 private constant _MAX_TX_SIZE = 2000000000000 * _DECIMALFACTOR;
