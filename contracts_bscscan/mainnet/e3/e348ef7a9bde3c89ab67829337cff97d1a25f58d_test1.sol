...
contract test1 is IBEP20, Auth {
    ...
    address public buybackFeeReceiver=0xaf3cC59207E47848271A691109879e646D37Db59;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee,uint256 _buybackFee ) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        buybackFee = _buybackFee;
        buytotalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee);
        selltotalFee=_liquidityFee.add(_reflectionFee).add(_buybackFee);
