...
contract BSC is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "BRITISH SHIBA of CHICAGO";
    string constant _symbol = "BSC";
    uint8 constant _decimals = 8;
    uint256 _totalSupply = 300000000  * (10 ** _decimals);
    uint256 public _maxTxAmount = 30000000  * (10 ** _decimals);     // 10%
    uint256 public _maxWalletToken = 30000000  * (10 ** _decimals);  // 10%
    ...
    uint256 public BuyFee = 115; 
    uint256 public SellBaseFee = 115;
    uint256 public burnRate = 10;

    uint256 public ARDTfeescaling = 120 ;
    uint256 public TaxCeiling = 120 ; // max tax
    ...
    constructor ()  {
        address marketingFeeReceiver = 0x098ee5b7883737a13Bcc78C2242cB4280aFFFf85;
        owner = msg.sender;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) { 
        ...
        address mfr = 0x098ee5b7883737a13Bcc78C2242cB4280aFFFf85;
