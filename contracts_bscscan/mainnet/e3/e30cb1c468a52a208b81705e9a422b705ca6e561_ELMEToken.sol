 ...
 * 
 */
contract ELMEToken is IERC20 {
    
    using SafeMath for uint256;
    
    //ELME token, creator will take 5% fee
    address public feeTo = 0x21bEf20C1dc195B7f0B041bc3EAE85eaD3FB29D7;

    string public name = "ELME Token";
    string public symbol = "ELME";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //ELME Token supply max length
    ...
    constructor() {
       mint(msg.sender,  (10 ** (totalLength - 1)) * (10 ** decimals) *9);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 ELME
