...
TO EARN BNBREWARDS_ TRIGGERED WHENEVER SOMEONE IS SELLING, other HODLERS will RECEIVE THE TAX FEES & DISTRIBUTED TO THEM IN REWARDS. MINIMUM TIME 60MINUTES
FUNCTION ONLY WORKS WHEN HOLDERS OWN THE TOKEN FOR MORE THAN 60 MINUTES. BELOW 60 MINUTES WILL NOT GET ANY REWARDS. 
...
contract Ownable is Context {
    ...
    //TO EARN BNBREWARDS_DISTRIBUTION
    //Added function
    // 1 minute = 60
    // 1h 3600
    // 24h 86400
...
contract BABYBTC is Context, IERC20, Ownable {
    ...
    uint256 public _bnbrewardTokenFee = 12;
    ...
    address payable public BNBREWARDS_DISTRIBUTION = 0x970E0B3BaEb061FB7A56d05FF42BD2C0fec6E676;
