...
contract SonofminiKitty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SonofminiKitty";
    string private _symbol = "SonofminiKitty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE4CC021C67d59812daea304525C8DF4D3A13ff21); // Marketing Address
    address payable public teamWalletAddress = payable(0x215141B554C068651655fEc4faC145942FdB0FC5); // Team Address
