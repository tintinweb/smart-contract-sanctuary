...
contract GengerInu is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Genger Inu";
   string constant _symbol = "BGM";
...
uint256 reflectionFee = 100;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x5894f88Fb9CAA2d0Ad0cDb2408d555F5BE16EaBd;
       ...
       marketingFeeReceiver = 0x9363D55a70f32dae5B3b1b4863A07Ec77B0fDdbB;
