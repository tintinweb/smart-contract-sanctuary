...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2CCfA20ABF56083b4B8510c3637eFe15dFc4eE76;
...
contract CheemsLambo is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x80481c9a32887334C00f48B3cD5C89A718C13009;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cheems Lambo";
    string private _symbol = "CHEEMSL";
