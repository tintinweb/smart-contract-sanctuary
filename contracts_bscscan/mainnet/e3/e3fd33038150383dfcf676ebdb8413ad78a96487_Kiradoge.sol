...
/**
    ...
    https://kiradoge.com/
    KIRADOGE Coin
    Listed on CEX, KYC verified ( ETH , USDT ) Trade will be enabled after launch
    Audited
...
contract Kiradoge is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x1506e4bc08f751D6c8FB6Aa5D397Fa2a8EC1B231;

    string constant _name = "Kiradoge";
