...
contract VelhallaStaking is Ownable, Pausable {
    ...
    constructor(
        ...
        vht = _vht;
        //devaddr = _devaddr;
        totalReward = _totalreward;  // total SCAR token reward for 1 year
    ...
    function getWithdrawLockTime(address _user) public view returns (uint256) {
        UserInfo storage user = userInfo[0][_user];
    ...
    function setEmergencyWithdrawLock(bool _emergencyWithdrawLock) public onlyOwner{
