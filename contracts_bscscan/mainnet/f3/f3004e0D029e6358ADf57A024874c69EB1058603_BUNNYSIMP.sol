 ...
 **  6% Liquidity
 **  
 **  Presale Platform: https://www.pinksale.finance/#/launchpads?chain=BSC
 **  SC 25 BNB / HC 50 BNB
 **  Min 0.1 BNB, Max 2 BNB
 **  
 **  Telegram: https://t.me/bunnysimpbsc 
 **  Twitter: https://twitter.com/Bunnysimpbsc 
 **  Website: http://bunnysimpbsc.tech/ 
 **  
 **  	
 */


//caution  before buying cryptocurrency please always "do your own research".
...
contract BUNNYSIMP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUNNYSIMP";
    string private _symbol = "$BSIMP";
    uint8 private _decimals = 9;
    

    address payable public marketingWalletAddress = payable(0x93C9A8981397fd8770931606850e3dF098665002); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x404d7F24034Dd5b00eD62cb90Dc5eE7E925C8890); // buyback Address for $simp rewards
