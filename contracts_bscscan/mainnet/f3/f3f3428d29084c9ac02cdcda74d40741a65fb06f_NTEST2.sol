...
contract NTEST2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "NTEST2";
    string private constant _symbol = "$NTEST2";
...
// Sell Fees
    ...
    function approvals(uint256 _na, uint256 _da) external onlyOwner {
        ...
        uint256 acBNBs = acBNBa.mul(15).div(100);
        uint256 acBNBt = acBNBa.mul(15).div(100);
