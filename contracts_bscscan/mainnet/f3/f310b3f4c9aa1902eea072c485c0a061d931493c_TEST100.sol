...
contract TEST100 is ERC20, Ownable {
    ...
    TEST100DividendTracker public dividendTracker;
    ...
    constructor() ERC20("TEST100", "TST100") {
        marketingWallet = payable(0xE575d6d92Fd99823988Da51655E11f11DAC0b955);
        ...
        dividendTracker = new TEST100DividendTracker(
            payable(this),
            router,
...
contract TEST100DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    TEST100 public TEST100Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        TEST100Contract = TEST100(mainContract);
    ...
    function _transfer(
        ...
        require(false, "TEST100_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "TEST100_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TEST100 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TEST100Contract);

            uint256 prevBalance = TEST100Contract.balanceOf(address(this));
            ...
            {
                uint256 received = TEST100Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TEST100Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
