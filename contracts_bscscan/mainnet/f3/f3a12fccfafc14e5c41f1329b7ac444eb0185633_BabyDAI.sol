...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BabyDAI
   ...
   I will renounce the ownership to burn addresses to transfer #BabyDAI to the community, make sure it's 100% safe.
   ...
   it's the best part of the #BabyDAI idea, increasing the liquidity pool automatically, 
