...
// CHEEMSMARTIAN
//
// 📱 Telegram: https://t.me/CheemsMartian
// 🌎 Website: https://cheemsmartian.com 
//
/**
...
contract CHEEMSMARTIAN is ERC20, Ownable, Shared {
    ...
    address public marketingWalletAddress = 0xcd50eF16cB69F4203Eb7F1F50BC9B19fC111723c;
    address public devWalletAddress = 0x668Ff79527bA0b4230E8C2E6b3e3E72E3cECFB9D;
    ...
    constructor() ERC20("CHEEMSMARTIAN", "$CHEEMARTIAN") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "CHEEMSMARTIAN: The router already has that address");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "CHEEMSMARTIAN: Can't set marketing wallet to the zero address");
        marketingWalletAddress = wallet;
    }
    
    function setDevWallet(address payable wallet) external onlyOwner{
        require(devWalletAddress != address(0), "CHEEMSMARTIAN: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, "CHEEMSMARTIAN: Can't set max Tx to 0");
        maxTxAmount = totalSupply() * maxTxPermille / 1000;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "CHEEMSMARTIAN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "CHEEMSMARTIAN: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "CHEEMSMARTIAN: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "CHEEMSMARTIAN: Blacklisted address");
