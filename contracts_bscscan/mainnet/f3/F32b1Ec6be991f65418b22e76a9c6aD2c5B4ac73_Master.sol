...
contract Master is Ownable {
    ...
    // Market oracle provides the RMOON/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _RMOON) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = RMOON.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && RMOON.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(RMOON.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return RMOON.totalSupply().toInt256Safe()
