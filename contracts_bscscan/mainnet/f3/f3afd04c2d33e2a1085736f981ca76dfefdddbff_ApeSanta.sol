...
/**
   ...
   Welcome to ApeSanta Token
   
   This is a community token. If you want to create a telegram I suggest to name it to @ApeSanta
   ...
   I will add .3 BNB and all the left 40% total supply to the pool
   Can you make #ApeSanta 10000X? 
...
contract ApeSanta is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8fAb47Ce660868169f48F4944c2B5416325205A8); // Marketing Address
    ...
    string private _name = "ApeSanta";
    string private _symbol = "APSA";
