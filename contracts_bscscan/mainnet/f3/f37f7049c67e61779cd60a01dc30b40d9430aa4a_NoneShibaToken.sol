...
contract NoneShibaToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0ADc3E3c149AeD89093465d3349CA4116618fb5d); // Marketing and Buyback Address
    ...
    string private _name = "NoneShiba";
    string private _symbol = "NONESHIB";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _busdfee = 8;
