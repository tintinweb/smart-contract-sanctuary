...
Low Cap + High Marketing Pump = SQUID2K22
 BSC Gem
...
contract SQUID2K22 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 1000000000000 * 10 ** 18;
    string private _name = "SQUID2K22";
    string private _symbol = "SQUID";
    uint8 private _decimals = 6;
    address public rewardAddress = 0x993d3A2B49212e8c2F5F1006Ead1fF1e5Dd5dbCd;
