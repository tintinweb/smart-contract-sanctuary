...
contract HelloWorld4 is ERC20, Ownable {
	using SafeMath for uint256;

	IUniswapV2Router02 public uniswapV2Router;
	address public immutable uniswapV2Pair;

	string private _name = "HelloWorld4";
	string private _symbol = "HW4"; //SeTC
	...
	// Reflection cycle
	uint256 public _dividendTokenTimestamp;
	...
	function setDividendTokens(address[] memory newTokens) public onlyOwner {
		emit DividendTokensChange(newTokens, dividendTokens);
