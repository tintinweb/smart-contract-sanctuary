...
THE ULTIMATE HOLD TOKEN

•  Liquidity Locked
•  Rug Proof
•  Ownership Renounced

Telegram: https://t.me/TheUltimateHold
...
========
•  33% Total Tax Fee
•  20% --> Back To The Token Holders
•  5% --> Gets added back to the liquidity pool
•  5% --> Gets Burnt Burned
•  3% --> Gets Sent To The Marketing Wallet
...
contract UltimateHoldToken is Context, IERC20, Ownable {
    ...
    string private _name = "UltimateHodl";
    string private _symbol = "UHT";
    uint8 private _decimals = 9;
    address private _marketingWalletAddress = 0x0520f1458eB34195b65adb829d0CE95d266576e8;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256[5] memory tValues) {
        ...
        uint256 tTransferAmount = tAmount.sub(tFee).sub(tLiquidity).sub(tMarketing).sub(tBurn);
    ...
    function _getRValues(uint256[5] memory tValues, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        //uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tMarketing, uint256 tBurn
        ...
        uint256 rBurn = tValues[4].mul(currentRate);
