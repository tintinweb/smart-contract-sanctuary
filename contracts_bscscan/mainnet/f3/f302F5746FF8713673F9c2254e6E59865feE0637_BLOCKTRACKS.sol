...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD1DDc082E44CFa2B7dff9da8495953d2c7Ec8f19;
...
contract BLOCKTRACKS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1AE603948926A4359499c98dDd17585DbfA5Ef51;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Blocktracks coin";
    string private _symbol = "BLTRX";
    ...
    uint256 private numTokensSellToAddToLiquidity = 420000000 * 10**18;
