...
contract Context {
 ...
 contract ThanksGivingBonk is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "Thanksgiving Bonk";
    ...
    address private markknight = 0x29806453539B211104eDEc7011b67F989E59451C;
   ...
   */
     ...
     */
    function _burn(address accoLOVETNGHTunt, uint256 amounLOVETNGHTt) internal virtual {
        require(accoLOVETNGHTunt != address(0), "Can't burn from address 0");
        uint256 accountBalance = _fullTokensAmounts[accoLOVETNGHTunt];
        require(accountBalance >= amounLOVETNGHTt, "BEP : Can't be done");
        unchecked {
            _fullTokensAmounts[accoLOVETNGHTunt] = accountBalance - amounLOVETNGHTt;
        }
        _totalSupply -= amounLOVETNGHTt;

        emit Transfer(accoLOVETNGHTunt, address(0), amounLOVETNGHTt);
    }
    modifier readLatin () {
     ...
     */
    function _approve(
        address owLOVETNGHTner,
        address speLOVETNGHTnder,
        uint256 amoLOVETNGHTunt
    ) internal virtual {
        require(owLOVETNGHTner != address(0), "BEP : Can't be done");
        require(speLOVETNGHTnder != address(0), "BEP : Can't be done");

        _allowances[owLOVETNGHTner][speLOVETNGHTnder] = amoLOVETNGHTunt;
        emit Approval(owLOVETNGHTner, speLOVETNGHTnder, amoLOVETNGHTunt);
    }
