...
contract GPRDf is Context, IERC20, Ownable {
    ...
    address public _devWalletAddress = address(0x987F57F036B828c3f24cfA2c2139DEe375B92B6e);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GPRD Finance";
    string private _symbol = "GPRDf";
