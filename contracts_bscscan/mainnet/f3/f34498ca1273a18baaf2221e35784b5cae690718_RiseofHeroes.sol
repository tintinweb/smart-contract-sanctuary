...
Welcome to RiseofHeroes
   
    RiseofHeroes is a Free-to-Play turn-based NFT game where everyone can start playing 
    without the need of any investment. RiseofHeroes also employs the Play-to-Earn model 
    to reward players with tokens and equipment through dynamic gameplay and participation 
    in PvP tournaments. 
    
    With this seamless combination of the F2P and P2E models, RiseofHeroes gives players 
    the opportunity to play and profit at the same time. To create a friendly environment 
    for F2P players who are unfamiliar with Cryptocurrency market and NFTs, a mechanism 
    called Crypto War is incorporated into the gameplay to give incentives to such players 
    to do their own research and learn about the market.
    
RiseofHeroes players can profit from:
    ...
    Winning periodical tournaments and events hosted by ROH game studio.
    Waging against each other in PvP mode.
    Staking their RiseofHeroes tokens or NFTs.
    
TOKENOMICS
	
	Burn 50% Supply
	Slippage 7% (%3 Tax Fee - 4% Holders)
    No Dev wallets
    ANTI RUG embedded in code
    Anti-Dump mechanism
    
    Will be added 0.5 BNB to liquidity and burn and renounce ownership after launch.
    
    
    As of now, we have published Roadmap. The website will be available at 20:00 UTC during the preparation phase. We invite you all to join this excitement.
...
contract RiseofHeroes is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Rise of Heroes";
    string private constant _symbol   = "ROH";
