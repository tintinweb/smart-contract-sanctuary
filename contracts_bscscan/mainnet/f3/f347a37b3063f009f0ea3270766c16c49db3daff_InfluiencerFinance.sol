...
/*
 * 
 * Website:  https://influencerfinance.io/
 * Telegram: https://t.me/financeinfluencer
 */
...
contract InfluiencerFinance is Context, IBEP20, Ownable {
  ...
  uint8 internal selxzhbtskoiqamneafi = 8;
  ...
  string private constant namxqwzyipkraohcnlibojedagfste = "Influiencer Finance";
  string private constant symrxhslbpnzqtef = "$INFLUIENCE";
