...
// Sufuon Liquidity lock
// We will lock LP for 12 months, after this time we will use some LP for marketing/listings and lock it again for 12 months 
// The time value is determined by epoch time stamp, find below 1657393200 you can convert the value at epochconverter.com
// before the lock time expires it is not possible to release the LP tokens ... locked till the 9th of july 2022.
...
contract SimpleTokenTimelock is TokenTimelock {
    constructor () public TokenTimelock(
        IERC20(0xbB191A755FD8C4908F7A9E5135595Cbce546F007), // token
        0x896ed713E7fF624358315328476c27c962355219, // beneficiary
        1625868000) {
    }
}