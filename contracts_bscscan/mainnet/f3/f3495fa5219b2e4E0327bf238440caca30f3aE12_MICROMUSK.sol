...
* - Max Wallet: 15 tokens 
* - Max Sell: 1 tokens 
* - Max Buy: 3   max buy same as max wallet after 5 min
*
* - Buy Tax: 15% 
* - Sell Tax: 20% 
* - Transfer Tax: 30% 
...
contract MICROMUSK is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MICROMUSK';
    string private constant _symbol = '$MMT';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000 * 10**_decimals;//equals 1000 tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0x11E965E7dDc6733d29C9c1730188263E25bEFa4f);
    address public walletTwo=payable(0x8e4dde17A5A850350434889442d6530E47cAec92);
    ...
    function claimCAKE(address addr) private{
        ...
        path[1] = 0xF215A127A196e3988C09d052e16BcFD365Cd7AA3;  // Wrapped Mirror TSLA Token
