...
contract Ownable is Context { // Apply 0 for full renounce
...
contract WBNBFLOKIn is Context, iERC20, Ownable {
  ...
  constructor() public {
    ...
    _totalSupply = 10**12 * 10**9;
    _balances[msg.sender] = _totalSupply;

    emit Transfer(address(0), msg.sender, _totalSupply);
  }

    uint256 public _taxFee = 10; // WBNB Fee burnt to WBNB
    ...
    uint256 private numTokensSellToAddToLiquidity = 10**10 * 10**9;
