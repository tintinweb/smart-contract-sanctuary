...
pragma solidity ^0.8.0;
contract Safewex is ERC20, Ownable {
    ...
    constructor() ERC20("Safewex", "SAWEX") {
        _mint(msg.sender, 2160000*10**decimals());
        _mint(address(this), 8640000*10**decimals());
        startSale(block.number, 999999999,0,9000*10**decimals(), 2000000000000);
