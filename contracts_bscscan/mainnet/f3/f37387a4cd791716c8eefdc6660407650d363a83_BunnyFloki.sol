...
contract BunnyFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc75c7346Bb3f3750bCD9d05e12BF315530126deC); // Marketing Address
    ...
    string private _name = "BunnyFloki";
    string private _symbol = "BUNFLOKI";
