...
/*
            ELONBULLY - WE DON'T PLAY BY THE RULES - TO THE MOON WE GO!! 🌙
*/
...
contract ElonBully is Context, IERC20, Ownable {
    ...
    string private _name = "ElonBully";
    string private _symbol = "ElonBully";
