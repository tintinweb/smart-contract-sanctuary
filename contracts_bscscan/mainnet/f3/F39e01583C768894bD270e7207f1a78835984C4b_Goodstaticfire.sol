...
contract Goodstaticfire is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Good static fire"; // token name
    string private _symbol = "GSF"; // token symbol
