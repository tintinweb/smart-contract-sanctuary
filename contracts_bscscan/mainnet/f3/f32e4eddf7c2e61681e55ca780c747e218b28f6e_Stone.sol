...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x16bbFaeD1FfaA57d215f8c1fD06C2CD1664e951B;
...
contract Stone is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbB6762a4b766E2765F2CdaaB4a3b11F6D72350ED;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Stone";
    string private _symbol = "MK1001";
