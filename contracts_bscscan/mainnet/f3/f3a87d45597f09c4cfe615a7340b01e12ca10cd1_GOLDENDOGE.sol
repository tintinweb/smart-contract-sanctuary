...
*/
/*
 GoldenDOGE is a $DOGE rewards tokens with a unique auto-claim feature. 

$DOGE (BSC pegged tokens) rewards are sent to your wallet directly. All you need to do is HODL $GOLDENDOGE and earn $DOGE rewards every 10 minutes.
After seeing the success of BABYCAKE, we want all those who missed it to have a second chance with GOLDENDOGE
...
📋 Token distribution:
    ...
    ✅  8% tax fees (7% is used to purchase $DOGE which is automatically paid out in dividends to holders - 1% is automatically added to LP)
...
contract GOLDENDOGE is Context, IERC20, IERC20Metadata, Ownable {   
