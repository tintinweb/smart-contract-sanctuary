...
/**
Lady Cake is the new BSC project which rewards holders in CAKE on every 60 minutes. ❤️
...
Max Transaction (Buy/Sell): 500,000,000 (0.50% of total supply)
Initial LP: 5 BNB
LP locked 6 months.
Slippage: 19-20%, Buy: 18-19%, Sell: 20-21%
Tax: 8% CAKE Rewards, 3% Marketing, 7% Buy-Back Wallet
Buy-Back and Marketing Wallet is the same wallet address (one wallet).
Audit: Techrate will be applied after launch.
CMC & CG listing in coming.
...
Telegram: https://t.me/LadyCakeBsc
Web: http://ladycake.app/
...
contract LadyCake_Token is Context, IERC20, IERC20Metadata, Ownable {   
