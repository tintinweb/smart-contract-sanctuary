...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "男神女神";
    string private _symbol = "男神女神";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 5; // 3% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 8; // 3% added to liquidity 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _burnFee = 1; // 2% burn fee
    uint256 private _previousBurnFee = _burnFee;
    
    uint256 public marketingAndDevelopment = 1; // 2% Marketing and Development
    ...
    uint256 public _maxWalletToken = 10000000000 * 10**18;
