...
/**
 * @title Gold
 * @dev Implementation of the Gold BEP20 token
 */
contract Gold is BEP20Capped, BEP20Mintable, BEP20Burnable, ServicePayer {
    constructor(
        string memory name_,
    ...
    ) payable BEP20(name_, symbol_) BEP20Capped(cap_) ServicePayer(feeReceiver_, "Gold") {
