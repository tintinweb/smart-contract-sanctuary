...
contract SpaceXDogNFT is ERC721Enumerable, Ownable {
    string private _baseTokenURI;

    constructor () ERC721("SpaceXNaut Dog", "SNG") {
        _baseTokenURI = "https://racawebsource.s3.us-east-2.amazonaws.com/nft/SpaceXDogNFT.json";
    }
    ...
    function batchSafeMint(address to, uint256 fromTokenId, uint256 toTokenId) external onlyOwner {
        for (uint256 i = fromTokenId; i <= toTokenId; i++) {
            _safeMint(to, i);
        }
    }
