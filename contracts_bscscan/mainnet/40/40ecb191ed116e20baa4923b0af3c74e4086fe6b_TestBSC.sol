...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x74b493B2b7536332Ea3BFaF6422e09ba55A747fD;
...
contract TestBSC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4fe253Ba31B60a61BC48E3e64B18fBa83Bd4df08;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TestBSC";
    ...
    uint256 private numTokensSellToAddToLiquidity = 4800000000000000 * 10**9;
