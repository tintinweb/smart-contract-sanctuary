...
contract Chronobull is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Chronobull";                                          // name
    string private _symbol = "$BULL";                                             // symbol
    ...
    uint[] public _percentages = [40,30,30];                                             // % of liquidity fee split to wallet(s)
