...
contract FirstBabyFloki is Context, IERC20, Ownable {
    ...
    string private _name = "First Baby Floki";
    string private _symbol = "FIRSTBF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97874469D23b6FE050257574A0CF9571ED388d7E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x99868E11C668f81b6c2204bB1C9a00CB6E5735dB); // BuyBack Address
