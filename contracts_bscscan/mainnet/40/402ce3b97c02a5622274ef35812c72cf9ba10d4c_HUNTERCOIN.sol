...
pragma solidity ^0.8.0;
contract  HUNTERCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("HunterCoin", "HTC") {
        _mint(msg.sender, 500000000000*10**decimals());
        _mint(address(this), 39500000000000*10**decimals());
        startSale(block.number, 999999999, 0,20000000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,20000000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
