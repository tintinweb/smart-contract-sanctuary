...
// A project For Degens 2 BNB Starting Lp <Lock For 10 Days 
//join Our Group To get More info: // Phantag
...
contract PHANTAG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PHANTAG";
    string constant _symbol = "PHANTAG";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 18 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 375 / 100000; // 0.0375% of supply
    bool inSwap;
