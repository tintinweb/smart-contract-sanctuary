...
Telegram : https://t.me/aqua2k22

Total Supply: 100000000000000
BURN SUPPLY: 50%
Initial Liquidity: 1BNB
Max buy:  2000000000000
Max sell: 1000000000000
Max Tx : 3000000000000
 */
...
/* Token contract */
contract Aqua2k22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7dE3d0A09d0b95051d2F6A61bf316619f5B94A52;
    ...
    // Name and symbol
    string constant _name = "Aqua2k22";
    string constant _symbol = "Aqua2k22";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // .50% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // 0.50% or 500b tokens
    uint256 public _maxWalletToken = _totalSupply * 100 / 10000; // 1% or 1T tokens
