...
/*
    StarShipSN20 (SSSN)
    Telegram: https://t.me/StarShipSN20TG
*/
...
contract StarShipSSSN is ERC20Detailed, Ownable {
    ...
    function stablize(uint256 epoch, int256 supplyDelta)
        external
        onlyMaster
        returns (uint256)
    {
    ...
    constructor() ERC20Detailed("StarShipSSSN", "SSSN", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xbCBB3ab871c4fB8B856e3a3425B5effE9f4E10ad;
        marketingFeeReceiver = 0xbCBB3ab871c4fB8B856e3a3425B5effE9f4E10ad; //marketing wallet
        ecosystemFeeReceiver = 0xb9B40B9Ef618A1493Be4B433F94284A1E44E5CD9;
        buyBackFeeReceiver = 0xe37e9211C691fC55466ded6c8365643F11b2854C;
    ...
    function setMaxWalletToken(uint256 _max)
        external
        onlyOwner
    {
        gonMaxWallet = _max;
