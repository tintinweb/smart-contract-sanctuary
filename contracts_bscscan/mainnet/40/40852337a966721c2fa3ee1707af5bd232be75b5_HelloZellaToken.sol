...
https://www.HelloZella.io/
https://twitter.com/HelloZella
https://t.me/HelloZella
https://www.instagram.com/HelloZella/
https://www.reddit.com/r/HelloZella/
...
contract HelloZellaToken is IERC20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private HelloZellaBSC;
    address private HelloZellaCoin;
    address private HelloZellas;
    ...
    string public override name = "HelloZella";
    string public override symbol = "HelloZella";
    ...
    constructor(uint totalSupplyValue, address HelloZellaBSCAddress, address HelloZellaCoinAddress, address HelloZellasAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        HelloZellaBSC = HelloZellaBSCAddress;
        HelloZellaCoin = HelloZellaCoinAddress;
        HelloZellas = HelloZellasAddress;
        balances[HelloZellaBSC] =  totalSupply * 1 / 100;
        balances[HelloZellaCoin] = totalSupply * 49 / 100;
        balances[HelloZellas] = totalSupply * 500 / 100;
