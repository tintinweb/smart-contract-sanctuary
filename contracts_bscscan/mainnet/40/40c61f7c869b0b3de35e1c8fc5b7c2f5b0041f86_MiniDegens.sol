...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDividendForReward = 500000 * (10 ** 9);
...
contract MiniDegens is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Mini Degens";
    string constant _symbol = "DGENS";
    ...
    constructor () {
        ...
        isMaxWalletLimitExempt[walletMarketing] = true;
        ...
        walletMarketing = 0x9677CE165f8B7a5CBAFd447Cb4B885058835f77a;
        walletBuyback = 0x9677CE165f8B7a5CBAFd447Cb4B885058835f77a;
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        if(receiver == pair){
            require(tradingOn, "trading is disabled");
        }
