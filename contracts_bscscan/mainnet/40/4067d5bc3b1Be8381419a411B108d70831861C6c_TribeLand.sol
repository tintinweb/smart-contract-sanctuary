...
contract TribeLand is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x556972A5D70D54260EB4359236cbd1F67B2A5833); // Marketing Address
    ...
    string private _name = "TribeLand";
    string private _symbol = "TRBL";
