...
/**
 * @title CryptoGirlFriend contract
 */
contract CryptoGirlFriend is ERC721Enumerable, Ownable {
    ...
    address private constant fundWallet = 0xdcab82AE4710e4CB0ed05472068594fbB9866132;

    constructor(string memory name, string memory symbol, uint256 maxNftSupply, uint256 revealTimestamp) ERC721(name, symbol) {
     ...
     * Mint Token by owner
     */
    function reserveByOwner(address _to, uint256 numberOfTokens) external onlyOwner {
