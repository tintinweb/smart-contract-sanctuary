...
contract METAAIR is ERC20, Ownable {
    ...
    Taxes public buyTaxes = Taxes(3,3,1,1,2);
    Taxes public sellTaxes = Taxes(3,3,1,1,2);
   ...
   ///////////////////////
    ...
    function setBuyTaxes(uint256 _rewards, uint256 _marketing, uint256 _liquidity, uint256 _operations, uint256 _buyback) external onlyOwner{
        buyTaxes = Taxes(_rewards, _marketing, _liquidity, _operations, _buyback);
    }

    function setSellTaxes(uint256 _rewards, uint256 _marketing, uint256 _liquidity,uint256 _operations,uint256 _buyback) external onlyOwner{
        sellTaxes = Taxes(_rewards, _marketing, _liquidity, _operations, _buyback);
    }
