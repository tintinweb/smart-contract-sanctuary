...
contract VSHIBA is Context, IERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xb51EcEA2b80e4a8CFAC0F28533568bF2Ac6B5f2A;
    ...
    string private _name = "VIKING SHIBA";
    ...
    uint256 public maxWalletToken = 100000 * (10**9);
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xb51EcEA2b80e4a8CFAC0F28533568bF2Ac6B5f2A] = true;
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
  	...
  	function setMarketingWallet(address _newWallet) external onlyOwner{
  	    _marketingWalletAddress = _newWallet;
  	}
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        _rOwned[_marketingWalletAddress] = _rOwned[_marketingWalletAddress].add(rCharity);
        if(_isExcluded[_marketingWalletAddress])
            _tOwned[_marketingWalletAddress] = _tOwned[_marketingWalletAddress].add(tCharity);
    }
