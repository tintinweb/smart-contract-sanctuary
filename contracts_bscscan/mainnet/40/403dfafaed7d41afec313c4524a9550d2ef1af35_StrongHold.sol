...
* StrongHold
*
* Tokenomics will be a tax of 10% Buy, 20% Sell and 90% to transfer between wallets 
*
* 40% for liquidity 
* 40% to burn wallet 
* 20% to staking
*
* Total Supply 10000
* Max per Holder: ~1% of Total Supply (100 tokens)
* Max sell: 0.2% of supply (20 tokens)
* Sell cool down: 40 minutes
*
* 
* Safe to hold 
*
* TG: t.me/StrongHoldBSC
* Launch at 50 member 
*/
...
contract StrongHold is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'StrongHold';
    string private constant _symbol = 'SHold';
    ...
    uint16 public constant MaxSellLockTime= 40 minutes;
    ...
    address public constant TeamWallet=0xe481f05207108CAE28a23B4C85243A8001D04c12;
