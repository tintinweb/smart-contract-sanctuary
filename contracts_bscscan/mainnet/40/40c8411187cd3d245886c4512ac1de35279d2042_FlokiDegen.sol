...
contract FlokiDegen is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = _tTotal.mul(5).div(10);
    uint256 public maxSellAmount = _tTotal.mul(3).div(10);
    uint256 public swapTokensAtAmount = 50000 * 10**_decimals;
    uint256 public _maxWalletSize = 10000 * 10**5  * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x0AF6860A459E0624807fEf06610fE494B7F8e2Eb;
    address public operationsAddress = 0x0AF6860A459E0624807fEf06610fE494B7F8e2Eb;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "FlokiDegen";
    string private constant _symbol = "FlokiDegen";
