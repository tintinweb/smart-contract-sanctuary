...
contract Dogezilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x07a79C5cDB85B798949Ce66cF2E74d00098b0411); // Marketing Address
    ...
    string private _name = "Dogezilla";
    string private _symbol = "DogeZ";
