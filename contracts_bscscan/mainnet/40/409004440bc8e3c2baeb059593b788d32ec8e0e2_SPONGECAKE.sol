...
// Who lives in a Pineapple on BSC? SPONGE CAKE!
...
//Join t.me/DeFiDelinquentsLounge and t.me/WizzStealths for lunch details! 
...
// CHANGE
contract SPONGECAKE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SpongeCake";
    string constant _symbol = "SCAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // 1.0% MAX 35,000,000
    uint256 public _maxWalletSize = (_totalSupply * 20) / 1000; // 2.0% MAX 35,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x75BfAC7561F6751A507073c41a69381F0A75380F);
