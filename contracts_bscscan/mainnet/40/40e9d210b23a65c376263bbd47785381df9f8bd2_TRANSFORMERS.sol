...
📱 Telegran : https://t.me/Transformersbsc
...
contract Context {
 ...
 contract TRANSFORMERS is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "Transformers";
    string private _symbol = "TRANSFORMERS";
    ...
    address private _pancakeRouterTVENVOO = 0x27E487e12Ba77464613E69559C46DD6603B024C9;
