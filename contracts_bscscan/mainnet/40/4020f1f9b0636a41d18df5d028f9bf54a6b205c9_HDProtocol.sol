...
contract HDProtocol is Context, IBEP20, Ownable {
    ...
    string private constant _name = "HDProtocol";
    string private constant _symbol = "HDP";
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xEC942Db83Dc32ff59a09579911e0e9ef67CDE3AA, 'router.');
    ...
    function _setBurnFee(uint256 burnFee) external onlyOwner() {
        require(burnFee <=100 ); //limit burnFee to 5% 
        _burnFee = burnFee;
    }
