...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = _owner;
        authorizations[
    0xbA09b839235Ad367A9850d10940866B95Cc519Fe] = true;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract Shibamoto is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _name = "Shibamoto";    
