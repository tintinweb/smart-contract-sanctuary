...
/*
<MetaBonk BSC Token>
    ......The only Token That Always Bonks the Dip.......


 >> 5% BuyBack to Bonk the Dip
 >> 2% into Liquidity
 >> 3% for Marketing
 >> 1% Max Ttansaction when we are launching, to be removed later.
 
 
 
 Join our Telegram Chat: https://t.me/MetaBonkOfficial
*/
...
contract MetaBonk is IBEP20, Auth {
    ...
    string constant _name = "MetaBonk";
    string constant _symbol = "MBONK";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xD5119dD30490227b02b6CD6811922b4f3A85A57E; 
