...
/**
    ...
    PeaceShiba, 85% burn, ownership renounced, liquidity locked
    supply 1,000,000,000,000,000 maxtx 5,000,000,000,000
    stealth lauch, verified contract, add 0.2 bnb
...
contract PeaceShiba is Context, IERC20, Ownable {
    ...
    string private _name = "PeaceShiba";
    string private _symbol = "PEACESHIBA";
