...
contract RichHare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RichHare";
    string private _symbol = "RichHare";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0dA56B444430b1B04F80894d6d89d06f04B12769); // Marketing Address
    address payable public teamWalletAddress = payable(0x0dA56B444430b1B04F80894d6d89d06f04B12769); // Team Address
