...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa398f348db5f67Fc811ee4A8AB042CeC80a9221B;
...
contract FacebookToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA86e9aDeb9e8F26C6b57Ff65b5f5fcEfE479080c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Facebook Token";
    string private _symbol = "FBK";
