...
/**
   ...
   Welcome to BabyTether
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyTether
   ...
   I will renounce the ownership to burn addresses to transfer #BabyTether to the community, make sure it's 100% safe.
   ...
   it's the best part of the #BabyTether idea, increasing the liquidity pool automatically, 
...
contract BabyTether is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Tether";
    string private _symbol = "BABYUSDT";
