...
library Address{
 ...
 contract ShikageInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x213F1253a3CdeB8fCf3c6323Ee0b728f8883625E;
    address public donationWallet = 0xab208E322a045D43E8e0324cE1348f5eEDF24161;

    string private constant _name = "Shikage Inu";
    string private constant _symbol = "SHKG";
    ...
    Taxes public taxes = Taxes(1, 5, 2, 2);
    Taxes public sellTaxes = Taxes(1, 5, 2, 2);
