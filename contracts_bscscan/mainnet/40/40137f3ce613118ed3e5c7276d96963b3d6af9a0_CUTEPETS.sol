...
/**
 * CutePets (CUTEPETS)
 * Telegram : https://t.me/cutepetsbsc
*/
...
contract CUTEPETS is Context, IERC20, Ownable {
    ...
    string private _name = "CutePets";
    string private _symbol = "CUTEPETS";
    ...
    address payable public marketingWallet = payable(0x48FEcc8885DDC4D1B057D465aDc0aD47562d1A86);
