...
/**
    ...
    Decimal = 9
    7% of each transaction to the liquidity pool
    6% of each transaction to the Charity wallet
    9% of each transaction to holders
*/
...
contract OuijaCoin is Context, IBEP20, Ownable {
    ...
    string private _name     = "Ouija Coin";
    string private _symbol   = "Ouija";
