...
contract SHIBAINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0844EC0C22C54AF3bcbeF966c11ff3bA913aEf11;
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10 **12;
    uint256 private numTokensSellToAddToLiquidity = 10000000000 * 10 **12;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //don't take burnFee
        if(balanceOf(address(0)) < 10000000000000000 * 10**9){
