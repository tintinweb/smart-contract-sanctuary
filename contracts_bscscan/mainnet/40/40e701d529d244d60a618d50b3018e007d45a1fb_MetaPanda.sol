...
/**
Welcome Everyone to the Pandaverse
 */
...
contract Context {
 ...
 contract MetaPanda is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "PandaVerse";
    string private _symbol = "PNDVRS";
    ...
    address private markknight = 0x8A3cc483a4AFF20c5c47d42afd0EF7FC48948e2b;
