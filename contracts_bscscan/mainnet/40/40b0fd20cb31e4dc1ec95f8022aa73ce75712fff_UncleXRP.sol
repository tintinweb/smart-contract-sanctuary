...
OFFICIAL UncleXRP TOKEN

You also saw those Reward tokens and tought where is the XRP one?Here we are the UncleXRP Token that rewards you with Tron Tokens.  knows what it needs to be the next gem, and that is YOU. Are you ready to be part of this?
...
contract UncleXRP is Context, IBEP20, Ownable {
