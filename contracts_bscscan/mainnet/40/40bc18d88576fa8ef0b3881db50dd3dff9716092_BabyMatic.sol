...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #BabyMatic to the community, make sure it's 100% safe.

   I will add 4 BNB and all the left 10% total supply to the pool
   Can you make #BabyMatic 10000X? 
...
contract BabyMatic is Context, IERC20, Ownable {
    ...
    string private _name = "BabyMatic";
