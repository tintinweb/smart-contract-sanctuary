...
contract FuckWageSlave is IBEP20, Auth {
    ...
    string constant _name = "FuckWageSlave";
    string constant _symbol = "FWS";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // MAX TX
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; //max wallet holding of 5%
    ...
    address private marketingFeeReceiver = 0x8fE2c60dc98C973d791c1D578eD473bd6eea236B; // marketing AND rewards,
    address private DEVELOPMENTFeeReceiver = 0x8fE2c60dc98C973d791c1D578eD473bd6eea236B;
