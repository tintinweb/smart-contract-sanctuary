...
contract FarmFactoryADA is Context, Ownable {
    using SafeMath for uint256;

    address ada = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    IBEP20 token;

    uint256 public constant INVEST_MIN_AMOUNT = 1 ether;// 1 ADA
    ...
    uint256 public constant ANTI_WHALE = 200000 ether;// 200000 ADA
    ...
    function invest(address referrer, uint8 plan, uint256 _amount) public payable {
      ...
      require(totalDeposits < ANTI_WHALE, "Deposit limit reached (200,000 ada)");
