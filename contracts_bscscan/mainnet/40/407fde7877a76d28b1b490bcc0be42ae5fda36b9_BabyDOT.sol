...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BabyDOT
   ...
   I will renounce the ownership to burn addresses to transfer #BabyDOT to the community, make sure it's 100% safe.
   ...
   it's the best part of the #BabyDOT idea, increasing the liquidity pool automatically, 
...
contract BabyDOT is Context, IERC20, Ownable {
    ...
    string private _symbol = "BabyPolkadot";
