...
contract PrivateSale is ReentrancyGuard, Context, Ownable{
    ...
    IERC20 private _token = IERC20(0xe157020a326651e957f9cDe7366A1D5fdBC039c5); // MOONA
    ...
    uint startDate = 1633194000; // 2nd October @ 5PM UTC
    ...
    uint public bnbRate = 10400000; // 10,400,000 MOONA per BNB
