...
contract PolyFeg is ERC20, Ownable {
	...
	address payable public MarketingWallet = payable(0x15e0cE9DbCc38F12fAd7a22eD200E5Dd5C75eb1d); // Marketing Address
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != PancakeSwapV2Pair, "POLYFEG: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _transfer(
       ...
       if(from != owner()){
        ...
        if(!tradingOpen) {
            require(canTransferBeforetradingOpen[from], "POLYFEG: This account cannot send tokens until trading is enabled");
        }
    ...
    function swapTokensForMATIC(uint256 tokenAmount, address recipient) private {
        ...
        // generate the PancakeSwap pair path of weth -> MATIC
