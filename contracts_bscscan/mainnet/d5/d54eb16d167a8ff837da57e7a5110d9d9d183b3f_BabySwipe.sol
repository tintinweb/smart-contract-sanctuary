...
#BabySwipe will launch in shortly, Insane reflections!!!

Dont miss the first $SXP redistribution straight to the moon 🚀

👀10% $SXP Rewards ( Every hour)
🤖 5% Liquidity
...
contract BabySwipe is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**7 * 10**9; // 1B 
    ...
    uint256 public _maxTxAmount = 100 * 10**7 * 10**9; // 1B 
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 100 * 10**7 * 10**9; // 1B

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Baby Swipe";
    string private _symbol = "BabySwipe";
