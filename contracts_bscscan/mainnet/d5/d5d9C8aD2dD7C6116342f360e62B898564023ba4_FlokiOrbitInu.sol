...
/**
    ...
    Decimal = 9
    1% of each transaction to the liquidity pool
    3% of each transaction to the marketing wallet
    2% of each transaction to holders
*/
...
contract FlokiOrbitInu is Context, IBEP20, Ownable {
    ...
    string private _name     = "FlokiOrbitInu";
    string private _symbol   = "FOL";
    ...
    uint256 private _minTokenBalance = 10000 * 10**9;
