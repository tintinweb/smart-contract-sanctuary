...
contract MetaGuru is Context, IERC20, Ownable {
    ...
    uint256 private _holderRewards;
    uint256 private _devPlusLP;
    address payable private devWallet;
    address payable private teamWallet;
    address payable private marketWallet;
    string private constant _name = "MetaGuru";
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeam) = _getTValues(tAmount, _holderRewards, _devPlusLP);
        uint256 currentRate =  _getRate();
