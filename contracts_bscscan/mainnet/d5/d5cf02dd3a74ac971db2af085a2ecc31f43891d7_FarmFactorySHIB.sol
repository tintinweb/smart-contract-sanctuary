...
/**
 ...
 ^   2) Contribute to the contract with at least the minimum amount of shib required + Blockchain Fees
 ...
 ^   - Minimum deposit: 10 shib, 200000 shib max deposit per wallet due for anti ANTI_WHALE protection
...
contract FarmFactorySHIB is Context, Ownable {
    using SafeMath for uint256;

    address shib = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    IBEP20 token;

    uint256 public constant INVEST_MIN_AMOUNT = 1 ether;// 1 SHIB
    ...
    uint256 public constant ANTI_WHALE = 5000000000000000 ether;// 200000 shib
    ...
    function invest(address referrer, uint8 plan, uint256 _amount) public payable {
      ...
      require(totalDeposits < ANTI_WHALE, "Deposit limit reached (200,000 shib)");
