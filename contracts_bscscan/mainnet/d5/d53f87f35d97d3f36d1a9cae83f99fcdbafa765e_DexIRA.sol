...
contract DexIRA is ERC20, Ownable {
    ...
    uint256 public immutable tradingEnabledTimestamp = 1626577200; // @note tradingIsEnabled
    ...
    constructor() ERC20("TEST_Dex_5", "TEST_Dex_5", 9) {
...
contract DexIRADividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("TEST_Dex_5_Dividend_Tracker", "TEST_Dex_5_Dividend_Tracker", 9) {
        claimWait = 3600;
