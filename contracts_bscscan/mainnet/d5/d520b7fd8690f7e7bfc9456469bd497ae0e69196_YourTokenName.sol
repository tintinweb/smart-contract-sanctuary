...
contract YourTokenName is IBEP20, Ownable
{
    ...
    string private constant _name = "Infinity NFT";
    string private constant _symbol = "ITNFT";
    ...
    address public constant TeamWallet=0x990b3db3A905143f0DCEF50B0265c1e41D6875B6;
    address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = 600000000 * 10**_decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private{
        ...
        if(isContractTransfer || isLiquidityTransfer || isExcluded){
            ...
            require(tradingEnabled=true,"trading not yet enabled");
