...
contract BabeZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public HouseAddress = payable(0x1Fe9c86b8aBf588E516F51C85470a297D56717c1); // House Wallet Address
    ...
    string private _name = "BabeZilla";
    string private _symbol = "BABEZ";
    ...
    uint256 public HouseDivisor = 8;
    
    uint256 public _maxTxAmount = 20 * 10**6 * 10**9; // 20 million, or 2% of total supply
