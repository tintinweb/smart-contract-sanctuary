...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract minidogecandy is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x3a24AeFBB7d81c0a77848566A99a543A08b6839d;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;string private _name = "Mini Doge Candy";
    string private _symbol = "MiniDC";
