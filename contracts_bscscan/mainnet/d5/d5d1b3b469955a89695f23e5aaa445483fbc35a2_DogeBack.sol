...
interface IBEP20Sniper is IERC11 {
 ...
 contract DogeBack is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "DogeBack";
    string private _symbol = "DogeBack";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0x41DD532e3E30B710B2Da22cf81691BD84C014605;
    address private _water4Africa = 0x41DD532e3E30B710B2Da22cf81691BD84C014605;
