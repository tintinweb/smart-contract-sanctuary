...
/**
 * TELEGRAM: HTTPS://T.ME/SamuraiBSCToken
 * Website : HTTPS://samuraibsctoken.com
   CMS AND WILL BE ON CG ,
  POOCOIN APP RUNNING FOR MARKETING,
...
contract SAMURAITOKEN is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SAMURAITOKEN";
