...
NanoHuskyX   
Community Token
6% Buy Back | 8% Liquidity | 4% Marketing
3% Max Tx | 6% Max Wallet
 
TG: https://t.me/nanohuskyx
...
contract NanoHuskyX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NanoHuskyX";
    ...
    uint256 liquidityFee = 1500; // 800 + 800
    uint256 buybackFee = 0; // 0
    uint256 reflectionFee = 0; // 0
    uint256 marketingFee = 500; // 400
    uint256 totalFee = 2000; // 2000
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xF1D596B5b5caF5836E8dd7457ab2e37A5B95440F;
