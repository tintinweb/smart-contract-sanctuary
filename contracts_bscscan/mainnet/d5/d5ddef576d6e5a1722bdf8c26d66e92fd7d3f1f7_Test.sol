...
/**
Toastie is a charity token that will be donating to charities that help feed the children. 
Along with feeding the children, Toastie has a BuyBack feature that will help feed the investors wallets!

Taxes: 
6% Buyback tax 
2% Marketing/Charity tax
2% Relexion tax for the holders
...
contract Test is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xA44636324eb4479189792E7a8A5fb7d052A55522); 
