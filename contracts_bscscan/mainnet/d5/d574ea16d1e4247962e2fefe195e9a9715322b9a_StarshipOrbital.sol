...
contract StarshipOrbital is Context, IERC20, Ownable { 
    ...
    string private _name = "Starship Orbital"; 
    string private _symbol = "Starship Orbital";  
