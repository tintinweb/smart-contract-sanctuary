...
/**
   Introducing Husky Boy, 100x Potential token
   
   Telegram: https://t.me/huskyboybscchinese
...
contract HuskyBoy  is Context, IERC20, Ownable {
    ...
    string private _name = "HuskyBoy";
    string private _symbol = "HUSKYBOY";
