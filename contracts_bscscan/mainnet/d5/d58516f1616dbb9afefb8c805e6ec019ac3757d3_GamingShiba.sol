...
contract GamingShiba is GamingDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamGaming;
    address private CharityGaming;
    ...
    string public override name = "Gaming Shiba";
    string public override symbol = "Gaming Shiba";
    ...
    constructor(uint totalSupplyValue, address TeamGamingAddress, address CharityGamingAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamGaming = TeamGamingAddress;
        CharityGaming = CharityGamingAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamGaming] =  totalSupply * 4 / 100;
        balances[CharityGaming] = totalSupply * 25 / 100;
    ...
    // Get the address of the token's TeamGaming pot
