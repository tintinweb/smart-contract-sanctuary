...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MKR = IBEP20(0x5f0Da599BB2ccCfcf6Fdfd7D81743B6020864350);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xE46FAc627d45769B3C81cfF0432fde212183bb3D);
        _token = msg.sender;
    }
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MKR.balanceOf(address(this));
        ...
        uint256 amount = MKR.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MKR.transfer(shareholder, amount);
...
contract BabyMaker is IBEP20, Auth {
    ...
    address MKR = 0x5f0Da599BB2ccCfcf6Fdfd7D81743B6020864350;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyMaker t.me/BBYMaker";
