...
contract Seagull is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf35a9C2768391b1fAe06edb357579dF544898B34); // Marketing Address
    address payable public charityAddress = payable(0xf35a9C2768391b1fAe06edb357579dF544898B34); // Charity/Dev Address
    ...
    string private _name = "Seagull Token";
