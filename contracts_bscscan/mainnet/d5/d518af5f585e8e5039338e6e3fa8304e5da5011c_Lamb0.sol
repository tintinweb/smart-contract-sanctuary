...
WE WILL KEEP REBASING UNTIL 1 TOKEN = 1 LAMBO
...
contract Lamb0 is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("ForeverLambo", "LAMBO", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xE8Cd6b474B979B3569439c4151b739ea6BCBb7C0;
        marketingFeeReceiver = 0x8C5ecDeF936013B293d02f567DCbd3b0A6d89e0A;
