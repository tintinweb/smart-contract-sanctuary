...
contract Strategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant buyBackAddress = 0x960A53FacA1671b97efE8898a6FFDeD937C3c0eA;
    ...
    constructor(
        ...
        feeAddress = 0x960A53FacA1671b97efE8898a6FFDeD937C3c0eA;
        ...
        isEnterStaking = _isEnterStaking;
        ...
        if (isAutoComp) {
            ...
            earnedToWBNBPath = [earnedAddress, wbnbAddressConstant];
        ...
        returns (uint256)
    {
        ...
        if (isAutoComp) {
            if (isEnterStaking) {
                IXswapFarm(farmContractAddress).leaveStaking(_wantAmt);
            } else {
    ...
    function earn() public nonReentrant whenNotPaused {
        ...
        // Harvest farm tokens
        if (isEnterStaking) {
            IXswapFarm(farmContractAddress).leaveStaking(0);
        } else {
