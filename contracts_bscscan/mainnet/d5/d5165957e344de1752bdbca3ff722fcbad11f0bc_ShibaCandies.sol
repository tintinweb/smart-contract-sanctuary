...
// Welcome to ShibaCandies
   
 //  This is a community token. If you want to create a telegram I suggest to name it to @ShibaCandiesChat
  ...
  // I will renounce the ownership to burn addresses to transfer #ShibaCandies to the community, make sure it's 100% safe.

  // I will add 0.2 BNB and all the left 10% total supply to the pool
  // Can you make #ShibaCandies 10000X? 
  ...
  // it's the best part of the #ShibaCandies idea, increasing the liquidity pool automatically, 
...
contract ShibaCandies is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaCandies";
    string private _symbol = "ShibaCandies ";
