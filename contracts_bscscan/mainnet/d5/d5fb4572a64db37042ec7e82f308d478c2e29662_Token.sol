...
contract Reflective is IERC20, Authorizable {
    ...
    address payable public constant reserve = payable(0xcbC2aBb9E492E40012b436DD14DC0743EE973504); 
    ...
    string  private constant _NAME = "KAT3 P3RRY";
    string  private constant _SYMBOL = "KAT3";
...
contract Token is Reflective {
    ...
    uint32  private constant _TERM      = 10 seconds;
    ...
    uint256 private _COOLDOWN = 1800 seconds;
    ...
    function unlockBNBTesting() external onlyAuthorized returns (bool) {
...
contract Outpost is Context {
    ...
    uint256 private constant _DENOMINATOR = 100;
    address payable private constant _RESERVE = 0xcbC2aBb9E492E40012b436DD14DC0743EE973504;
