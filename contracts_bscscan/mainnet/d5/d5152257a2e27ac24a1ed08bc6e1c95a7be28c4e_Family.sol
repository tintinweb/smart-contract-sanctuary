...
contract Family is IBEP20, Ownable
{
    ...
    string private constant _symbol = "FMY";
    ...
    function changeTax(uint8 liquidityTax, uint8 marketingTax) public onlyOwner{
        _buyTax=liquidityTax;
        _sellTax=marketingTax;
    }
