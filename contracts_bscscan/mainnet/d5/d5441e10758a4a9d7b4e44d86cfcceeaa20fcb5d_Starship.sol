...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
...
is IERC20, Ownable {
    ...
    string public currentlyServing = "ETH";

    string constant _name = "Starship";
    string constant _symbol = "Starship";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; //1% of total supply
