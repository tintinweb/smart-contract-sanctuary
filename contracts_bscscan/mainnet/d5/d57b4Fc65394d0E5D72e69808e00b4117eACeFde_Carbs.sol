...
Carbs is built upon the fundamentals of Buyback and increasing the investor's value
    
Main features are
    
1) 2% tax is collected and distributed to holders for HODLing
2) 9% buyback and marketing tax is collected and 4% of it is sent for marketing fund and othe 5% is used to buyback the tokens
...
contract Carbs is Context, IERC20, Ownable {
    ...
    string private _name = "Mini Boxer";
    string private _symbol = "Mini Boxer";
