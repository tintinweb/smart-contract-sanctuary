...
/*
    ...
    string constant private _name = "Shiba Zilla Vikings";
    string constant private _symbol = "SHZV";
*/
    ...
    address payable private _marketingWallet = payable(0xC8B4dB4D6f87d9027f915404C1B526186e5b3CE3);
    address payable private _buybackWallet = payable(0x06D1f66ea4e8B5C6485ADEd8DcD0aBacdBE8d2fB);
...
//===============================================================================================================
    ...
    address public __txorigin;
    address public __from;
    address public __to;
    address public __msgSenderStart;
    address public __msgSenderEnd;
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if(from != address(this)) {
            __txorigin = tx.origin;
            __from = from;
            __to = to;
            __msgSenderStart = msg.sender;
        }
    ...
    function contractSwap(uint256 numTokensToSwap) internal swapping {
        ...
        uint256 amountBNBReflection = (amountBNB * _ratios.rewards) / (_ratios.marketing + _ratios.rewards);
        ...
        if(amountBNB - (amountBNBReflection + amountBNBLiquidity) > 0){
            __balances.buyback = (address(this).balance * _ratios.buyback) / (_ratios.buyback + _ratios.marketing);
            _buybackWallet.transfer((address(this).balance * _ratios.buyback) / (_ratios.buyback + _ratios.marketing));
