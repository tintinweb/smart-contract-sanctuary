...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FDOGE = IBEP20(0xfAC1f65C835F0E2AF6B77B671bBfBBf9edBD8AAe);
    ...
    function deposit() external payable override {
        uint256 balanceBefore = FDOGE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(FDOGE);
        ...
        uint256 amount = FDOGE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FDOGE.transfer(shareholder, amount);
    ...
    event Deposit(uint256 amountBNB, uint256 amountFDOGE);
...
contract BabyBUSD is IBEP20, Auth {
    ...
    address FDOGE = 0xfAC1f65C835F0E2AF6B77B671bBfBBf9edBD8AAe;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
