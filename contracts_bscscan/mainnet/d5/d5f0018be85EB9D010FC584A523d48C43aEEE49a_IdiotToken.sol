...
contract IdiotToken is Context, IERC20, Ownable {
    ...
    string private _name = "IdiotToken";
    string private _symbol = "IDOT";
    uint8 private _decimals = 18;

    
    uint256 private constant DIVISION_FACTOR = 4;   // fee precision up to 2 decimals
    uint256 public _taxFee = 500;                   // 500 = 5.00%
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 400;             // 400 = 4.00%
