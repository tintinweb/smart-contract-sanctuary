...
Tele : https://t.me/CheemsUniverse
...
contract CheemsUniverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CheemsUniverse";
    string private _symbol = "CHEEMSUNIVERSE";
