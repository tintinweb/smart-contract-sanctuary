...
/* Token contract */
contract SPONGEBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2793DFcA6472ADd28E2E80052f8660c01dEf2381;
    ...
    // Name and symbol
    string constant _name = "Sponge BNB";
    string constant _symbol = "SpongeBean";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 2% on launch or 2M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 1% or 1M tokens
    ...
    uint256 public swapThreshold = _totalSupply * 400 / 10000; // 4% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xAE27a74D7cc5EbE33078bdC5BD40e013a2Ce2Dfe;
        marketingFeeReceiver = 0x41951077B068B89518685d8b93197F238e345a79;
