...
// Adopt This UglyShiba. Bored of scams? %100 SAFE. 
...
contract UglyShiba is Context, IERC20, Ownable {
    ...
    string private   _name = "UglyShiba";
    string private _symbol = "UglyShiba";
  ...
  function getMarketingWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xb4bB8d16d04de1347F6807DD1D99A904a63edD14, 'We can not exclude Uniswap router.');
