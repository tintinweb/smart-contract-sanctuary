...
/*
 ...
 |_____/|_| /_/    \_\_____|______| /_/    \_\_|    |______|
                                                            
                                                            
                                                            
https://t.me/spaceapetoken

Tokenomics:

- 1 Billion Total Supply (1,000,000,000)
- 8% $BANANA rewards - reward contract is 0x603c7f932ed1fc6575303d8fb018fdcbb0f39a95
- 4% liquidity tax
- 5% marketing fee
...
- 30 second cooldown between buys at launch
- 2% max wallet size
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95); //the reward token you want distributed $BANANA
...
contract SpaceApe is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95; //Input the token address of whatever your reward is. leave 431,432,433 as is. $BANANA
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Space Ape";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "$MoonBananas";
    ...
    uint256 public liquidityFee    = 5; //fees.
