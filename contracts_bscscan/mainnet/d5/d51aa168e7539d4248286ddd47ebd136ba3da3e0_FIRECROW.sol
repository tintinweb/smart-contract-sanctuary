...
/**
   #FIRECROW METAVERSE (FIRE)
       ...
       ----------------------------------------------
                 On Buy
        10% fee auto add to liquidity Pool.
...
contract FIRECROW is Context, IBEP20, Ownable {
    ...
    mapping (address => bool) AutomatedMarketMaker;
    ...
    string private _name = "FIRECROW METAV";
    string private _symbol = "FIRE";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 5; // Redistribute fee
    ...
    address public MarketingWallet = 0xacb6816cDfe961b7b73949125Ba984F70a3c0f12; // Marketing Wallet address Here ....
    ...
    constructor ()  {
        ...
        AutomatedMarketMaker[0x10ED43C718714eb63d5aA57B78B54704E256024E] = true;
    ...
    function setAutomatedMarketMaker(address _autoMM,bool _status) external onlyOwner(){
        AutomatedMarketMaker[_autoMM] = _status;
    }
