...
contract GRT is IBEP20 {
    ...
    string public override name = "Graph Protocol";
    string public override symbol = "GRT";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[foundersPot] = totalSupply * 75 / 100;
        
        balances[owner] = totalSupply * 20 / 100;
    }
