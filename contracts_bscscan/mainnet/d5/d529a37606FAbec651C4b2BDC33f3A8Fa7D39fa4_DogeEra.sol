...
contract DogeEra is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "DogeEra";
   string constant _symbol = "DogeEra";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x330C0CF556F153b59Be886aEBDF73FF1749c3849;
