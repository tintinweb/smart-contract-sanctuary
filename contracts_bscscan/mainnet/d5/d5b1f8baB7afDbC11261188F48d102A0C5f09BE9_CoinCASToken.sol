...
contract CoinCASToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF13FD97CB746589219C66FeAA1bc4B1DF89977d9); // Marketing Address
    ...
    string private _name = "CoinCAS Token";
    string private _symbol = "CCAS";
