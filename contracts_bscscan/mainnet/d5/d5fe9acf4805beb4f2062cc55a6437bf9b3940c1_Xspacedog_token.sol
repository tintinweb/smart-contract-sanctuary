...
contract Xspacedog_token is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Navneet";
    string constant _symbol = "NBB";
    ...
    uint256 buybackFee = 4000000000;
    uint256 reflectionFee = 8000000000;
    uint256 marketingFee = 4000000000;
    uint256 totalFee = 18000000000;
    ...
    function BANK(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function NOTE(uint256 amount, uint256 amount2) external authorized {
