...
contract Jullie is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0F9131059b71fDEf9e28D64340c3C4b499475119); // Marketing Address
    ...
    string private _name = "Oh my jullie";
    string private _symbol = "Jullie";
