...
/**
⚔️🛡 ART OF WAR 🛡🛠❗ ️ ❗ X100 potential ❗ ️ ❗ Don't miss it 🤑
 AOW launched September 6, 2021 at 15:00 (UTC) - on pancakeswap September 24, 
2021 - Launch NFT marketplace September 27, 
2021 - game launch war Art - lunar land "
 ⚔️🛡 ART OF WAR 🛡⚔️ It is a developing 🎮 Game ecosystem. 
This includes: 🌍 The game world can place castles / kingdoms on our map for all items or tokens of interest; Market and our own currency $AOW; A unique game that uses our own NFT collection. 
Total amount of AOW casting: 10000000000; 
Burn address: 50% of the project party gives up ownership, no reservation and no pre-sale;
 Pancakeswap sliding point: LP sends burn address after 12% 
startup; 🤑 Play and make money with $AOW 🤑
 TG: ARTOFWAR_ Chat_ EN
  */
...
contract AOW is Context, IERC20, Ownable {
