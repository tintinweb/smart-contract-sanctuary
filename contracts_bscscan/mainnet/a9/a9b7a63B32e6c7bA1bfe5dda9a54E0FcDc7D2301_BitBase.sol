...
contract BitBase is IBEP20 {
    ...
    string public override name = "BitBase Token";
    string public override symbol = "BTBS";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[foundersPot] = totalSupply * 85 / 100;
