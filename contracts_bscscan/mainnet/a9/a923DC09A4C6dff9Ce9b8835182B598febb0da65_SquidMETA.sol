 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/SquidMETA
 * 
 * 
 * SquidMETA token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract SquidMETA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SquidMETA";
    string constant _symbol = "SMETA";
