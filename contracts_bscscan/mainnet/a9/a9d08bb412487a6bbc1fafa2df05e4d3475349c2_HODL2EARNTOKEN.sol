...
contract HODL2EARNTOKEN is ERC20, Ownable {
    // CONFIG START
    
    // TOKEM
    string tokenName = "HODL2EARN TOKEN";
    string tokenSymbol = "Hodl2Earn";
    uint256 tokenTotalSupply = 100_000_000_000 * (10**18);
    
    // ADRESSES
    address marketingWallet = 0x0683bfAe60f32292fBb40e18320613fb16d057Bd;
    address router02 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    
    // TAX (IN %)
    uint8 marketingTax = 15;
    
    // BOT PREVENTION
    uint256 flagLimit = 1; // High gas fee for bots
    
    // WHALE PROTECTION
    uint256 maxTXAmount = 10_000_000_000 * (10**18);
