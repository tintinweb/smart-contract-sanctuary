...
// THE OFFICIAL LEMON FINANCE PROJECT
...
contract LEMONFINANCE is ERC20, Ownable {
    ...
    uint16 public feeliq_buy = 99; // Fee is initially set to 99% to avoid sniperbots
    ...
    constructor() ERC20("LEMONFINANCE", "LEMON") {
