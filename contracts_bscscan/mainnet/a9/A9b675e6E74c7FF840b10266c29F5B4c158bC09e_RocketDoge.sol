...
/*
ROCKETDOGE is the new Binance Smart Chain (BSC) 
token which rewards holders on every transaction. 
Liquidity pool is locked with DxLock for next 6 months
to provide our investors with peace of mind that tokens can be exchanged in every time.
*/
...
contract RocketDoge is Context, IERC20, Ownable {
    ...
    address _marketingWallet = 0xbE4405bacA297A5E3C6B5f64B4d5Cd221Faae7d2;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    // Max TX amount is 0.2% of the total supply.
    uint256 private maxTxX = 2000000; // Less fields to edit
