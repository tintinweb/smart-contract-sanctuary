...
contract MetaProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "MetaProtocol";
    string private _symbol = "METAPRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc27004c9763e73fB8E18DFf8c734eA5a671C119a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc27004c9763e73fB8E18DFf8c734eA5a671C119a); // BuyBack Address
