 ...
 * `onlyOwner`, which
     * @dev Initializes the c can be applied to your functions to restrict their use to
 * the owner.
 */
abstract contract Ownable is Context {
    ...
    /**ontract setting the deployer as the initial owner.
     */
    constructor () {
...
contract shinomics_NFT is ERC721Enumerable, Ownable{
    ...
    constructor(address _beneficiary) ERC721("Shinomics", "Shinomics") {
        baseURI = "ipfs://QmQGEe1U5piyat9kqEiECNqxRshVp7mAPDQ5vxeioi1MsX/";
    ...
    function mint_shino() public payable returns (uint256){
        require(totalSupply() <= 979, "enough minting");
