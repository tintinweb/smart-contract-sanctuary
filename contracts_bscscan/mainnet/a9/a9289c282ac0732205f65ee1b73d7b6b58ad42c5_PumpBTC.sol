...
4% rewards Fees in BTCB - directly auto claimed into your wallet just by holding our Tokens !
4% to marketing
4% to liquidity pool
2% charity
...
contract PumpBTC is ERC20, Ownable {
    ...
    address public RewardToken = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); //BTCB
    ...
    constructor() public ERC20("PumpBTC", "$PBTC") {

    	dividendTracker = new DividendTracker();

        _marketingWalletAddress = address(0xBabBfA156BaAB65f569C70b2D9a6dB7BED218a64);

        _charityWalletAddress = address(0xAbB7bAB97bcCAeAf671FA6Cc8bfE1E879621819C);
