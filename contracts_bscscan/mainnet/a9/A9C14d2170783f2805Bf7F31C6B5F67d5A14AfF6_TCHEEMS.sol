...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Dis(uint256 amount) public onlyOwner {
    _Dis(msg.sender, amount);
    }
    ...
    function _Dis(address account, uint256 amount) internal virtual {
...
contract TCHEEMS is ERC20 {

    uint tokenTotalSupply = 50000000000; // 100 Million Token 
    
    constructor() public ERC20("Tiger Cheems", "TCHEEMS") {
        _Dis(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}