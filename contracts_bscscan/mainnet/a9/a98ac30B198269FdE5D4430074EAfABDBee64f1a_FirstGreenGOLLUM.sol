...
/**
✅Fırstgreengollum New big hyped token launching soon

✅Green chart and First made some huge pump, so Fırstgreengollum comming soon big hype
✅Launch comming soon
...
contract FirstGreenGOLLUM is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FirstGreenGOLLUM";
    string constant _symbol = "FIRGOLLUM";
