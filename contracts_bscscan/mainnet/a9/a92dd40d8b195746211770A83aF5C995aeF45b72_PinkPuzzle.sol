...
contract PinkPuzzle is Context, IERC20, LockToken {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE74494349f00407DB6451B1f0408Cb96E9A28073); // Marketing wallet Address.
    address payable public developerAddress = payable(0x5D78B1105B117E109Be91Ba23a2D5F9c9218B243); // developer wallet address. 
    ...
    string private _name = "PinkPuzzle"; //token name
    string private _symbol = "PPUZZLE"; // token symbol. 
