...
contract AstroCakeBNBPresale is Ownable {
    ...
    receive() external payable {
        require(block.timestamp >= 1599387059, "Presale has not started!");
        require(block.timestamp <= 1693995059, "Presale has ended!");
        ...
        // require maximum presale contribution to be at most 5 BNB
        require(msg.value <= 5 * (50**18), "Maximum contribution of 5 BNB");
