...
contract Context {
 ...
 contract DaemonZilla is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private balancesOfAll;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    uint8 private grandfather;
    string private _name = "Daemon Zilla";
    string private _symbol = "DAEMONZILLA";
    ...
    address private _pancakeRouter = 0xE495A6f64f6853af522D9354CFE19465df2f0cb9;
