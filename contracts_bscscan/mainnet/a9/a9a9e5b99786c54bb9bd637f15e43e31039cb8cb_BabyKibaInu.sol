...
Hey U all and welcome to BabyKibaInu as we gonna start our journey
we want to have organic growth at first and then we will kick the marketing 
whenever we got money in the marketing wallet
I will do whatever u all ask for 
if the marketing wallet affords that so let's moon together.
Please don't be a d and dump for 1-2xx's, just hold and I promise U
that u will not regret 
...
Join Telegram: https://t.me/BabyKibaInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 KIBA = IERC20(0x8E49e74DF036308495648ef3465F0c1476852679);
...
// CHANGE
contract BabyKibaInu is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address KIBA = 0x8E49e74DF036308495648ef3465F0c1476852679;
    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyKibaInu";
    string constant _symbol = "$BabyKiba";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1/2) / 100; // .5% MAX 5,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xf171F1197474bE94ef89D8FF725c81d36D40554C);
