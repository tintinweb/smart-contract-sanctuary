...
contract METATEST is Context, IERC20, Ownable {
    ...
    string private _symbol = "META34";

    // Fees for buy trades (%)
    uint256 public Buy_TotalProjectFee = 5;
    uint256 public Buy_ReflectionsFee;

    // Fees for sell trades (%)
    uint256 public Sell_Default_Total_ProjectFee = 1; 
    uint256 public Sell_Default_ReflectionsFee = 1;
    
    uint256 public Sell_Total_ProjectFee_Under_Impact1 = 3;
    uint256 public Sell_Total_ProjectFee_Above_Impact1 = 8;
    uint256 public Sell_Total_ProjectFee_Above_Impact2 = 20;
    
    uint256 public Sell_ReflectionsFee_Under_Impact1 = 2;
    uint256 public Sell_ReflectionsFee_Above_Impact1 = 2;
    uint256 public Sell_ReflectionsFee_Above_Impact2 = 18;

    // Sell price impact tiers 
    //   (% multiplied by 100)
    uint256 public price_impact1 = 500;
    uint256 public price_impact2 = 1000;
    ...
    uint256 public transfer_ReflectionsFee = 1;
    ...
    uint256 public productDevelopmentFee = 20; 
    uint256 public marketingFee = 20;          
    uint256 public blockchainSupportFee = 20;  
    uint256 public reservaFee = 40;
    ...
    uint256 public minAmountTokens_ProjectFundingSwap =  1000 * 10**_decimals; // 0.02%
