...
Hodl StockUpCake and get $CAKE automatically in your wallet every 30 minutes!
...
📋 Token distribution:
  ...
  - 15% transaction fee (1% to the locked LP and 14% $CAKE reflection)
...
contract StockUpCakes is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("Stock Up Cakes", "StockUpCakes") {
