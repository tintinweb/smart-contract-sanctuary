...
// CHANGE
contract SHALL is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SHALL";
    string constant _symbol = "SHALL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1000) / 1000; // 2.5% MAX, Transaction par raport à la liquidité 
    uint256 public _maxWalletSize = (_totalSupply * 1000) / 1000; // 0.5% MAX, Transaction par raport à la liquidité
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xBD51bec954A0b1807eca72129Da89DbdCD5AB132);
