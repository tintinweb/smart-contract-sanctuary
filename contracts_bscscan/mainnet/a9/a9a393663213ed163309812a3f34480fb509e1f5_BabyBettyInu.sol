...
contract BabyBettyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Betty Inu";
    string private _symbol = "$BBetty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd63B785af8811742A249f84d1723FdD95f9097c0);
    address payable public teamWalletAddress = payable(0xd63B785af8811742A249f84d1723FdD95f9097c0);
