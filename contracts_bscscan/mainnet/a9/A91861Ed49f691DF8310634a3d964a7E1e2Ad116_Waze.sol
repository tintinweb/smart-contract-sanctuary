...
contract Waze is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x609BceAb4adC02147Cea97a9E953f9A81eE2a5b3); // Marketing Address $$$ changed this to alternative wallet
    ...
    uint256 private _tTotal = 100000000 * 10**6 * 10**9;//This number has been changed to make the coins in circulation 100 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "WazeCoin";//Yes, just like the app
    string private _symbol = "WAZE";
    ...
    uint256 public _buyTaxFee = 2; //buy Reflection
