...
🚀GAME DESTINY🚀
_______________
👑 Game Destiny is the latest RPG fighting game on BSC
. We aim to make Game Destiny the best Defi game in the world.
Metaverse, Gamefi, NFT and farming have confirmed huge growth potential and are a future trend in the cryptocurrency market.
Game Destiny is aiming to build a financial system that is the perfect combination of game experience and Blockchain, making you profitable while having fun.
...
contract GAMEDESTINY is Context, IERC20, Ownable {
    ...
    string private _name = "Game Destiny";
    string private _symbol = "GameDestiny";
