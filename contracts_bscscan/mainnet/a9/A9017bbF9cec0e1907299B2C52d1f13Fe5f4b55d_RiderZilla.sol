...
contract RiderZilla is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x3B31Bec59db1C36b72C6C60b848093ad49F4A20F); // Marketing Address
    ...
    uint256 private _tTotal = 6900000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "RiderZilla";
    string private _symbol = "RiderZilla";
