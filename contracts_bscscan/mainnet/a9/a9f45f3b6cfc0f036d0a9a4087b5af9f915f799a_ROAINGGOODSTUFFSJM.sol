...
contract ROAINGGOODSTUFFSJM is Context, IERC20, Ownable {
    ...
    string private _name = "ROAING GOOD STUFF SJM";
    string private _symbol = "ROAING GOOD STUFF SJM";
    ...
    uint256 private maxSellTransactionAmount = 1 * (10**9);
