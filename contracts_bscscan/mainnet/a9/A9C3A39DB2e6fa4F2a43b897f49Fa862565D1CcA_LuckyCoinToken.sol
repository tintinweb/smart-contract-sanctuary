...
contract LuckyCoinToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 888888888888 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'LuckyCoin';
    string private _symbol = 'LuckyCoin';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = 0x9936f8ffC53d4a306982d039DB501bC43AAe5212;
