...
// SnowFloki
// https://snowflokitoken.com/
// https://twitter.com/snowflokitoken
// https://t.me/snowflokitoken
...
contract SnowFloki is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x985A84903a70c015FDA7adCB2E116a25f665F713); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x89E0068f6297fB09CA7622981Ca7c0aF2800134e); // Ecosystem Wallet
    address payable private devWallet = payable (0x89E0068f6297fB09CA7622981Ca7c0aF2800134e); // dev Wallet
    ...
    string private _name = "SnowFloki";
