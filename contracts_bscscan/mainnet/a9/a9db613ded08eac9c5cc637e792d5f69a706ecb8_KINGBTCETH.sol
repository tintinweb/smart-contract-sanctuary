...
/**
double reward exclusive ETH AND BTC

HOW IT WORKS? JUST HOLD AND IN EVERY TRANSACTION YOU WILL RECEIVE ETH AND BTC

LIQUIDITY BLOCKED 100% BY DXSALE (YOU CAN CHECK IN DXSALE LIQUIDITY LOCK AND SEARCH OUR CONTRACT)

https://t.me/KINGBTCETH (FUDDERS WILL BE KICKED)
 */
...
contract KINGBTCETH is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KINGBTCETH";
    string constant _symbol = "KINGBTCETH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 50000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100000; 
