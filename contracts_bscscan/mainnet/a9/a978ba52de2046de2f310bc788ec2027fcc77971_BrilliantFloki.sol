...
/**
 *BrilliantFloki - BrilliantFloki inspired by ELON MUSK
*/
...
contract BrilliantFloki is Context,IBEP20,Ownable {
    ...
    string private constant _name = "BrilliantFloki";
    string private constant _symbol = "BRFOKI";
