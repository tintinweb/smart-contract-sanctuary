...
https://t.me/SatoshiGirls_SatGirl


5% fee auto add to the liquidity pool 
2% fee auto distribute to all holders
7% marketing fee destinated to help the project

I will burn lock LPs and extend as project grows.
I will renounce the ownership to burn addresses to transfer $SatoshiGirls to the community, make sure it's 100% safe.

100,000,000,000,000,000 total supply.
500,000,000,000,000 max limit per trade.
2% $SatGirls max wallet, anti whale system.
...
pragma solidity ^0.6.12;
    ...
    contract SatoshiGirls is Context, IERC20, Ownable {
        ...
        string private _name = 'SatoshiGirls';
        string private _symbol = '$SatGirl';
