...
//
Millwall
Millwall - Where everyone can buy castle!Supply is only 100,
4% burn on every transaction| Aim is to make one token equal to 1 Million Dollar or more!!|

Official Telegram group to discuss all things MILLWALL!
https://t.me/mill_wall
*/
...
contract Millwall is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 100; 
    ...
    string private _name = "Millwall";
    string private _symbol = "Millwall";
    ...
    address _marketingWallet = 0xE89b0391Af53378D6b6B01a10B9D61a11D899fDc;
