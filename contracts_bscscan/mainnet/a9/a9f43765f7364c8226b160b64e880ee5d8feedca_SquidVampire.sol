...
/**
  ...
  _________            .__    .___ ____   ____                     .__                
 /   _____/ ________ __|__| __| _/ \   \ /   /____    _____ ______ |__|______   ____  
 \_____  \ / ____/  |  \  |/ __ |   \   Y   /\__  \  /     \\____ \|  \_  __ \_/ __ \ 
 /        < <_|  |  |  /  / /_/ |    \     /  / __ \|  Y Y  \  |_> >  ||  | \/\  ___/ 
/_______  /\__   |____/|__\____ |     \___/  (____  /__|_|  /   __/|__||__|    \___  >
        \/    |__|             \/                 \/      \/|__|                   \/                          

Telegram : https://t.me/SquidVampire
...
contract SquidVampire is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x58A0C8f144Ab847483308d90e76f4dAA4593Fb94); // Marketing Address
    ...
    string private _name = "SquidVampire";
    string private _symbol = "$SquidVampire";
    ...
    uint256 private minimumTokensBeforeSwap = 1000 * 10**6 * 10**9; 
    ...
    function SetBuyBackTimeInterval(uint256 newMinutes) external onlyOwner {
        _buyBackTimeInterval = newMinutes * 0 minutes;
    }
