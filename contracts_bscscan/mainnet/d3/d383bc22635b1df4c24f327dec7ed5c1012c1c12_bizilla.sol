...
contract bizilla is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0xeb4c0B5e6609bA0FFD87b2ac839d74dFCc9b04B3;
    ...
    string private _name = "bizilla";
    string private _symbol = "bizilla";
    ...
    uint256 public _maxTxAmount = 10000000000000000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 10000000 * 10**9;
	uint256 private numTokensBurn = 68999500000000000000000 * 10**9;
