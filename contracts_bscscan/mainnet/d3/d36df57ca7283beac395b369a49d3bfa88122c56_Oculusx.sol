...
contract Oculusx is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6c0E07806E5319527557Df134Db0518A049661B6); // Marketing Address
    ...
    uint256 private _tTotal = 777000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "OculusX";
    string private _symbol = "OsX";
