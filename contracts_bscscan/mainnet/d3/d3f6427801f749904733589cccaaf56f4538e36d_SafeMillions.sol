...
contract SafeMillions is Context, IERC20, Ownable {
    ...
    string private _name = "SafeMillions";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x2163246f2Dcb2CECc97788c985d11Ecb9ec1EF68, 'We can not exclude Uniswap router.');
