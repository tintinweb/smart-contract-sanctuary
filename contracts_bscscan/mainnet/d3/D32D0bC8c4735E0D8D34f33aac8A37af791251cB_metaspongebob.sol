...
//
//
// telegram : https://t.me/metaspongebobtoken
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x892820192561F769464E7d7E0F10b093e8c0F5a5;
...
contract metaspongebob is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD8008C2074B07D8957473f7D7b06a842ac2BFBaB;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Spongebob";
    string private _symbol = "METASPONGEBOB";
