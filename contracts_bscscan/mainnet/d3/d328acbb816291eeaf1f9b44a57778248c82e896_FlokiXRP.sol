...
// Floki XRP ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract FlokiXRP is IBEP20, Ownable
{
	...
	address _XRPTokenAddress = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;
    ...
    uint16 public constant SellLimitDivider=10000;
    ...
    constructor () {
       ...
       //Sets sellLockTime to be 2 seconds by default
        ...
        _buyTax=8;
        _sellTax=15;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=10;
        //97% gets burned
        _burnTax=3;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimFarmedToken(sender, _XRPTokenAddress);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
	...
	function XRPWithdraw() public {
		claimFarmedToken(msg.sender, _XRPTokenAddress);
	}
