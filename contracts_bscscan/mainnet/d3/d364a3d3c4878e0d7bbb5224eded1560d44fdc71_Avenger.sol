...
contract Avenger is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Avenger";
    string private _symbol = "AVG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x9De11b57b1A9C4d8CDb6706B3327eCc4C1564137);
    address payable public buyBackWalletAddress =
        payable(0x79d3D54b49DE90dA05F10952388b0cCdFae28905);
