...
// CHANGE
contract BABYTIGER is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 1,000,000,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x39F0564f5C98d1e3Bb65C6636Ab84038Db38c0ce);
