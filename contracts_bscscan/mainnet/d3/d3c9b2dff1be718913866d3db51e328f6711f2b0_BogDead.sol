...
/**
Grichka Bogdanoff Died
But Degens will live in our hearts
...
contract BogDead is Context, IERC20, Ownable {
    ...
    payable(0x8b9d7089BeA03b2861B09bD76594fb16415B38D0);
    ...
    string private constant _name = "BogdanoffDiedButDegensWillLiveForeverInu";
    string private constant _symbol = "$BogDead";
