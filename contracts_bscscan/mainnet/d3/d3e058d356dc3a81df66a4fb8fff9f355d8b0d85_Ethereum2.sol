...
Key Takeaways
    ...
    The Ethereum 2.0 deposit contract currently contains 9,008,082 ETH,
     or about $30.2 billion.
    This deposit contract allows users to transfer funds 
    from Ethereum mainnet to Beacon Chain, a parallel Proof-of-Stake network.
    Ethereum is expected to switch to Proof-of-Stake with a proposed merge 
    with Beacon Chain, tentatively scheduled in June 2022.



    Is Ethereum 2.0 safe?
...
contract Ethereum2 is Context, Ethereum2Gaming, Ownable {
    ...
    string private _symbol = 'Ethereum 2.0';
