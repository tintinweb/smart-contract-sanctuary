...
contract ChralaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChralaCoin";
    string private _symbol = "ChralaCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F75B5F577Db4Cd2E6E845443554c27a2e948D9e); // Marketing Address
    address payable public teamWalletAddress = payable(0x3A695bDDe63745245454e36C19ce807405cc3E34); // Team Address
    ...
    uint256 private _totalSupply = 1 * 10**5* 10**5 * 10**_decimals;
    uint256 public _maxTxAmount = 100 * 10**5 * 10**5* 10**_decimals; 
    uint256 public _walletMax = 1000 * 10**5 * 10**5* 10**_decimals;
