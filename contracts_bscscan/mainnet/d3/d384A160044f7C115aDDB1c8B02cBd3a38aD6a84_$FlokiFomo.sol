...
/**
            * TELEGRAM: HTTPS://T.ME/FlokiFomo
             
            
        
    50% Token will Be Burn 
    Rewards Of USDT that Will Reflect automatically In Every 30 minutes
    Soon Twitter Influencers will Post ABout FlokiFomo
    Lp Will Be Lock Instantly
                 FlokiFomo        FlokiFomo     FlokiFomo    FlokiFomo   FlokiFomo   FlokiFomo
...
contract $FlokiFomo is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "$FlokiFomo";
    string constant _symbol = "FF";
