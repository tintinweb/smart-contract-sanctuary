...
░░░╚═╝░░░░╚════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚══╝╚═╝░░░░░░░░╚═╝░░░╚═╝░░░░░
 ...
 - AutoBOOST
 - Hyper Deflation
 - higher transaction tax on sells than on buys 
...
contract PVP is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc1144a844B0fDb6366C2B7E471d848B8D6957A6e); // Marketing Address
    ...
    uint256 private _tTotal = 40000000 * 10**9;  // 40 million tokens 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "$PVP";
    string private _symbol = "$PVP";
    ...
    uint256 public _liquidityFee = 10;  // adding to address 
    ...
    uint256 public _maxTxAmount = 3000000 * 10**9; // 3 million tokens 
    uint256 private minimumTokensBeforeSwap = 200000 * 10**9; // when it has 200k tokens or more, smart contract swaps them
