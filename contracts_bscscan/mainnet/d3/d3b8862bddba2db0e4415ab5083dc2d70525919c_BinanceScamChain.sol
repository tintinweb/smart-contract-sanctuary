...
*/
/**
https://t.me/BinanceScamChainToken
*/
...
contract BinanceScamChain is Context, IERC20, Ownable {
    ...
    string private _name = "BinanceScamChain";
    ...
    address public devWallet = 0xaa6F936608B935D777B1Db4349d6eDe90949dABf;
    ...
    uint256 public _maxTxAmount = 0.5 * 10**10 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 8 * 10**8 * 10**9;
    uint256 public _maxWalletToken = 2 * 10**10* 10**9;
