...
contract X100ZILLA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X100ZILLA";
    string private _symbol = "X100ZILLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0498112483F5FBDBd4a30CE28dA228e1ED047e5B); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x0498112483F5FBDBd4a30CE28dA228e1ED047e5B); // Buyback Wallet Address
