...
Grab your $PICKAXE and join the epic Gold Rush. Rebase x $BTCB Rewards x NFTs.

Telegram: https://t.me/goldrushbscofficial
Website: http://www.goldrushbsc.com
...
contract PICKAXE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Gold Rush";
    string constant _symbol = "PICKAXE";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 3 * 10**5 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb30E7eC07f6C87c50CB43DE11823AA0315E1F02C;
        devFeeReceiver = 0x79e96CF8652EE59397b2ed65d8b42B5141D3A7d1;
