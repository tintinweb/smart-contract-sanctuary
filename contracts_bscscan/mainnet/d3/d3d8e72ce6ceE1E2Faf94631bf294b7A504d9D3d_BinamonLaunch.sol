...
/*
 ...
 ____   ____  ____    ____  ___ ___   ___   ____       _       ____  __ __  ____     __  __ __ 
|    \ |    ||    \  /    ||   |   | /   \ |    \     | |     /    ||  |  ||    \   /  ]|  |  |
|  o  ) |  | |  _  ||  o  || _   _ ||     ||  _  |    | |    |  o  ||  |  ||  _  | /  / |  |  |
|     | |  | |  |  ||     ||  \_/  ||  O  ||  |  |    | |___ |     ||  |  ||  |  |/  /  |  _  |
|  O  | |  | |  |  ||  _  ||   |   ||     ||  |  |    |     ||  _  ||  :  ||  |  /   \_ |  |  |
|     | |  | |  |  ||  |  ||   |   ||     ||  |  |    |     ||  |  ||     ||  |  \     ||  |  |
|_____||____||__|__||__|__||___|___| \___/ |__|__|    |_____||__|__| \__,_||__|__|\____||__|__|
                                                                                               
https://t.me/binamonlaunch

Tokenomics:

- 1 Billion Total Supply (1,000,000,000)
- 10% $BMON rewards - reward contract is 0x08ba0619b1e7a582e0bce5bbe9843322c954c340
- 5% liquidity tax
- 5% marketing fee
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x08ba0619b1e7A582E0BCe5BBE9843322C954C340); //the reward token you want distributed
...
contract BinamonLaunch is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x08ba0619b1e7A582E0BCe5BBE9843322C954C340; //Input the token address of whatever your reward is. leave 431,432,433 as is. BMON
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Binamon Launch";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "$BinaLaunch";
    ...
    //max wallet holding % 
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 100;  // 2 is the percentage of max wallet.
