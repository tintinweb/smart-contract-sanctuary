...
/**
   ...
   Zerotoken.io = NO TOKEN FOR DEV ! https://t.me/zerotoken
...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/m/in/i_ba_s/ket/b*all/pull/522
        if (a == 0) {
            return 0;
        }
...
contract ZEROTOKEN is IERC20 {
    ...
    string constant _name = "Zerotoken.io";
    string constant _symbol = "ZERO";

    uint256 public _reflectionFee = 500;
    ...
    address payable private _marketingWallet = payable(0xF70B714CcD451025609756Ed62488b99ab672d9D);
    ...
    // Maximum wallet size is 4% of the total supply.
    uint256 private maxWalletPercent = 4; // Less fields to edit
    ...
    constructor (uint _snipeBlockAmt, address cInitializer) payable {
        ...
        _isFeeExcluded[0xb3C271718aaF0c94F8D445dd2674fCD4C4F47dEc] = true;
        _isDividendExcluded[0xb3C271718aaF0c94F8D445dd2674fCD4C4F47dEc] = true;
