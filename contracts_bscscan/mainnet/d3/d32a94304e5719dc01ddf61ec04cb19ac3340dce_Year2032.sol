...
Fair launch + Anti Snipe. Liq will be locked for 7 days. Extend at 100k MC

Buy Tax 10%
    🍰 5% Marketing
    🌀 2% LP
    🌀 3% WholeLottaCake Rewards    
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0xaF1F6918A433dB7561c7593CF723887466A5D74b);
...
/* Token contract */
contract Year2032 is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0xaF1F6918A433dB7561c7593CF723887466A5D74b; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "Year2032";
    string constant _symbol = "Year2032";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 250 / 10000; // 1.0% on launch or 1M tokens
