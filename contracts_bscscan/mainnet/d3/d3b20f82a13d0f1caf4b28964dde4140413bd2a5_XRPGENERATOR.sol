...
/**
   _  __ ____  ____     _____________   ____________  ___  __________  ____ 
  | |/ // __ \/ __ \   / ____/ ____/ | / / ____/ __ \/   |/_  __/ __ \/ __ \
  |   // /_/ / /_/ /  / / __/ __/ /  |/ / __/ / /_/ / /| | / / / / / / /_/ /
 /   |/ _, _/ ____/  / /_/ / /___/ /|  / /___/ _, _/ ___ |/ / / /_/ / _, _/ 
/_/|_/_/ |_/_/       \____/_____/_/ |_/_____/_/ |_/_/  |_/_/  \____/_/ |_|  
   
ANTI WHALE SYSTEM
NO DEV WALLET JUST 2% FEES FOR MARKETING
LIQUIDITY 100% LOCKED BY 2 MONTHS
LOW INITIAL LIQUIDITY

OUR TG GROUP: https://t.me/xrpgenerator

TOTAL SUPPLY: 50000000000000

WE VERIFY CONTRACT WE ADD LIQUIDITY AND WE LAUNCH. HURRY UP
...
contract XRPGENERATOR is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "XRPGENERATOR";
    string constant _symbol = "XRPGEN";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xD46348C45063262e3125C3c901dBfd1E3792AF19; //WALLET DEV
