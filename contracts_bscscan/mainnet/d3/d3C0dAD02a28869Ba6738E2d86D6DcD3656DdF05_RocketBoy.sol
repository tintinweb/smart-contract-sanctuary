...
contract Context {
 ...
 contract RocketBoy is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "RocketBoy";
    ...
    address private _MarketingWalletSYLOM = 0x11bD94f3405E7b82cEc3327f1cDeC8D769B076Ff;
