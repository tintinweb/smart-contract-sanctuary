...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/li/ld/og/efl/oki/pull/522
        if (a == 0) {
            return 0;
        }
...
contract LilDogeFloki is IERC20 {
    ...
    string constant _name = "Lil Doge Floki";
    string constant _symbol = "LilDogeFloki";
    ...
    uint256 public maxLiquidityFee = 1500;
    uint256 public maxMarketingFee = 1500;
