...
contract PrivateSaleHoneyPad is Ownable {
    ...
    uint256 public minimumDepositEthAmount = 1 ether / 10;
    uint256 public maximumDepositEthAmount = 3 ether / 10;
    ...
    function deposit() public payable {
        ...
        require(privateSaleStartTimestamp > 0 && now >= privateSaleStartTimestamp && now <= privateSaleEndTimestamp, "presale is not active");
        uint256 take;
        uint256 sendBack;
    ...
    function releaseFunds() external onlyOwner {
        require(now >= privateSaleEndTimestamp, "Too soon");
    ...
    function getLeftTimeAmount() public view returns (uint256) {
        if(now > privateSaleEndTimestamp) {
            return 0;
        } else {
            return (privateSaleEndTimestamp - now);
        }
    }
