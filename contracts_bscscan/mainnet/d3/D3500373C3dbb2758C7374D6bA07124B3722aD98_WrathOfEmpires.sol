...
contract WrathOfEmpires is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        address gameDevelopmentAddress_,
        uint16 taxFeeBps_,
        uint16 liquidityFeeBps_,
        uint16 charityFeeBps_,
        uint16 gameDevelopmentFeeBps_
    ) payable {
        ...
        require(gameDevelopmentFeeBps_ >= 0, "Invalid game development fee");
        ...
        _marketingAddress = charityAddress_;
        _marketingFee = charityFeeBps_;
        _previousCharityFee = _marketingFee;

        _gameDevelopmentAddress = gameDevelopmentAddress_;
        _gameDevelopmentFee = gameDevelopmentFeeBps_;
    ...
    function _takeCharityFee(uint256 tCharity) private {
        if (tCharity > 0) {
            ...
            emit Transfer(_msgSender(), _marketingAddress, tCharity);
        }
    }
