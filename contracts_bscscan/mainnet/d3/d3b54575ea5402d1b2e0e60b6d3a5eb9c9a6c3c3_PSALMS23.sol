...
contract PSALMS23 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x969b4a35ce44D8C5A54940bc1e8258DEeff31Cfb); // Marketing Address
    ...
    string private _name = "PSALMS23";
    string private _symbol = "PSALMS23";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x969b4a35ce44D8C5A54940bc1e8258DEeff31Cfb);
    }
