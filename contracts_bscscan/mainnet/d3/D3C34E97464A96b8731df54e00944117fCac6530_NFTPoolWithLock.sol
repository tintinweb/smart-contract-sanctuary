...
contract NFTPoolWithLock is ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    ...
    uint256 public lockingPeriod = 1209600; // 2 weeks
    ...
    uint256 public pricePerCard = 850000000 * 10**18; // cost in wsg per card
