...
/**
BNB Fortune ($BNBF) Official Contract
...
contract BNBFortune is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9988B2854ceEEb911d9E10964bfD4563b75Fa885); // Marketing Address
    ...
    string private _name = "BNB Fortune";
    ...
    uint256 private minTknBfrSwp= 200 * 10**6 * 10**9; 
