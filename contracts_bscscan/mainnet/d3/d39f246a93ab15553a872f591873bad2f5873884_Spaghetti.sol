...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x484D658736390E70A97899D9B2b8AFB0Ba4F2bDC;
...
contract Spaghetti is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xfC402e84a66308DD582e5202780204DE04426B88;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Spaghetti";
    string private _symbol = "MNM";
