...
/**
 * 
We are a brewery that starts producing Gigabeer together with Tesla. It will be bottled at a new American-brand automobile plant near Berlin. This was announced by Elon Musk. You've probably heard that Tesla hosted an entertainment festival called GigaFest at its first European facility, known as Gigafactory 4. There Musk announced the idea of releasing branded beer in special faceted bottles, the shape of which will resemble the body outline of the Tesla Cybertruck electric pickup that has not yet been launched into production. 
*/
...
contract GIGBIER is Context, IERC20, Ownable {
