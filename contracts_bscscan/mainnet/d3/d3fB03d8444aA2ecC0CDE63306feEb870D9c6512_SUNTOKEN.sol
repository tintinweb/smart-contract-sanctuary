...
contract SUNTOKEN {
    ...
    address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //ETH: 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D  BSCtest: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    address WBNB_address = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //ETHtest: 0xc778417e063141139fce010982780140aa0cd5ab BSCtest: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    address wallet_team;
    ...
    function transferFrom(address from, address to, uint amount) public returns (bool) {
        ...
        require(balanceOf(msg.sender) + amount <= maxbuy_amount, "Balance exceeds max.limit");
        ...
        if(blacklistedUsers < 10 && msg.sender != router){
