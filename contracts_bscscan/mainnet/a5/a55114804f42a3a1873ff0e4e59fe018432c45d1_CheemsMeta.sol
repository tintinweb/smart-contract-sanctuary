...
contract CheemsMeta is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hellbound", "HB") {
        ...
        marketingWallet = address(0xd6c28D3F143aA93781663B9ca3e84C9c7a3001f6); // set as marketing wallet
        buyBackWallet = address(0xd6c28D3F143aA93781663B9ca3e84C9c7a3001f6); // set as buyback wallet
