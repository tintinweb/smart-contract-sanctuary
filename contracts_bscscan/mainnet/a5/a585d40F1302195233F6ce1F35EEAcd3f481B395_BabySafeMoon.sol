...
contract BabySafeMoon is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "BabySafeMoon";
    string private constant _symbol   = "BABYSAFEMOON";
    ...
    uint256 public _marketingFee = 400; // 4% of every transaction is sent to marketing/buyback wallet
