...
contract REDFEGX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "RED FEGX";
    string private constant _symbol = "$RED FEGX";
    ...
    uint256 public _buyReflectionFee = 6;
    ...
    address payable constant private _marketingAddress = payable(0x153858AF05a331Cf7a9D90DCc395a6c18ed9A857);
    address payable constant private _buybackAddress = payable(0x153858AF05a331Cf7a9D90DCc395a6c18ed9A857);
    address payable constant private _projectMaintainence = payable(0x153858AF05a331Cf7a9D90DCc395a6c18ed9A857);
    ...
    address public _oraclePriceFeed = 0x153858AF05a331Cf7a9D90DCc395a6c18ed9A857;//rinkeby 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
