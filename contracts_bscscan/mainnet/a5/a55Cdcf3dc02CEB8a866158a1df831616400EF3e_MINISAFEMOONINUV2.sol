...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MSMI = IBEP20(0xA29546df88fC6B021443C16094AA1A58687b95C8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MSMI.balanceOf(address(this));
        ...
        uint256 amount = MSMI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MSMI.transfer(shareholder, amount);
...
contract MINISAFEMOONINUV2 is IBEP20, Auth {
    using SafeMath for uint256;

    address MSMI = 0xA29546df88fC6B021443C16094AA1A58687b95C8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MINISAFEMOONV2";
    string constant _symbol = "MSMI2";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x3BbDb5cBC8D61541c9b54bf66f9A00d015D36F35;
        ...
        autoLiquidityReceiver =  0x3BbDb5cBC8D61541c9b54bf66f9A00d015D36F35;
        marketingFeeReceiver =   0xAFCa50edd1952d182001ec7Ad1C9e56Bc088f3dA;
