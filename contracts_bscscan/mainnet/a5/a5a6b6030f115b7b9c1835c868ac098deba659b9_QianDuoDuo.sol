...
/**
   A gift from a father to his son - Lawrence Qian 
   $QDD features:
...
contract QianDuoDuo is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20191204 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "QianDuoDuo";
    string private _symbol = "QDD";
