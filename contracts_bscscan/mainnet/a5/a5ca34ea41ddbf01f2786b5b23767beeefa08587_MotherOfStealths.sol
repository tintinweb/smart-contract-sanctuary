...
* MotherOfStealths as the name suggests is all about being stealthy and exciting! 
 * I am a well known safe dev although anonymous I will appear in the TG when we hit 100k MC.
 * Super stealth launch. No TG yet so I recommend creating one called: https://t.me/MotherOfStealths
 * 6% buys on tax, 20% on sells. 
 *1% Max tx
...
/* Token contract */
contract MotherOfStealths is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Mother Of Stealths";
    string constant _symbol = "MOS";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 100 / 10000;  // 1% max or 2M
