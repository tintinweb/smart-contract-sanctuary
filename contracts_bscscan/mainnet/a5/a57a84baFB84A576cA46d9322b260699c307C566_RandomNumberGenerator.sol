...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     */
    function getRandomNumber() external override returns (bytes32 requestId) {
        require(msg.sender == hyperLottery, "Only HyperLottery");
    ...
    /**
     * @notice Set the address for the Hyperjump Lottery
     * @param _hyperLottery: address of the Hyperjump lottery
     */
    function setLotteryAddress(address _hyperLottery) external onlyOwner {
        hyperLottery = _hyperLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IHyperLottery(hyperLottery).viewCurrentLotteryId();
    }
}
