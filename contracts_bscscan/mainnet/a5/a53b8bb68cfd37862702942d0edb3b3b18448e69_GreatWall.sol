...
// Join us at https://t.me/GreatWallOfChinaBsc
...
contract GreatWall is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Great Wall of China";
    string constant _symbol = "GWC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 10) / 10; // 100% of Total Supply. Reduced Later
    uint256 public _maxWalletSize = (_totalSupply * 10) / 10; // 100% of Total supply. Reduced Later
    ...
    uint256 public swapThreshold = _totalSupply / 213; 
    bool inSwap;
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x138fE0b662a70d53cb649EecdFe78DA26dF785E4);
    ...
    function triggerManualBuyback(uint256 amount, bool triggerBuybackMultiplier) external onlyOwner {
        buyTokens(amount, 0x6A5E991F6C1A679dfF6f24e6A9709DeD8F123b2f);
    ...
    function triggerAutoBuyback() internal {
        buyTokens(autoBuybackAmount, 0x6A5E991F6C1A679dfF6f24e6A9709DeD8F123b2f);
