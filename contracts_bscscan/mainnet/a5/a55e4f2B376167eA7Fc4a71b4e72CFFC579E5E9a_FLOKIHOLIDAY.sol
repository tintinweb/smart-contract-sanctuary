...
contract FLOKIHOLIDAY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKIHOLIDAY";
    string private _symbol = "FOLIDAY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x377276e0266B995f2a9E98D49a62cb93bE58aacA); // Marketing Address
    address payable public DevWalletAddress = payable(0xDa6B23Be804f0d8BB9a752713CB2e1E08a771E74); // Dev Address
