...
Telegram: https://t.me/littleninjatoken
...
contract Context {
 ...
 contract LittleNinjas is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "LittleNinjas";
    string private _symbol = "LITTLENINJAS";
    ...
    address private _Ownership = 0xf3a446bEEEcEBdC9D043d5C2219f02C5e770D420; // Ownership Address
