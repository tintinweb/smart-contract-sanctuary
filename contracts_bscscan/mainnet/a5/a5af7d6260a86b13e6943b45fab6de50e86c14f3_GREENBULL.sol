...
contract GREENBULL is Context, IERC20, Ownable {
    ...
    string private _name = "Green Bull";
    string private _symbol = "GREENBULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2231E4afe34FF4A205912ccF3229f9fB7Cad14af);
    address payable public teamWalletAddress = payable(0x932C563c4117c9cFBDe2a40Ed69847FC1666bD5A);
