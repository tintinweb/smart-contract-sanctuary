...
contract FJr is IBEP20, Auth {
    ...
    string constant _name = "FJunior";
    string constant _symbol = "Fjr.";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 1.1%

    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; // 1.8%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x4596bF1cC420ae65269C1E162831e01287c8ea26;
