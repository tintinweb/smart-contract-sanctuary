...
contract _TestSc is IBEP20, Auth {
    ...
    string constant _name = "PleaseDontBuy"; 
   ...
   function isOverLiquified(uint256 target, uint256 accuracy) public view returns (bool) {
    ...
    /*
    STUPID CODE... MESSING UP, SO I HAD TO COMMENT IT OUT OR REMOVE IT AND TRY ANOTHER SWAP AND LIQUIDIFY LOGIC :)
    ...
    function setTxParams(uint256 maxSellPercentage, uint256 maxHoldPercentage, uint256 _leastTokensForAirdropPercentage) external authorized {
