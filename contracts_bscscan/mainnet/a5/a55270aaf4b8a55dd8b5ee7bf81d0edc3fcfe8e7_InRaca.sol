...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x043b49749e0016E965600d502E2177cA2d95B3d9);
...
contract InRaca is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "inRaca";
    string constant _symbol = "IRaca";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x043b49749e0016E965600d502E2177cA2d95B3d9;

    uint256 _totalSupply = 100000 * 10**5 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 75 / 200;
    uint256 public _walletMax = _totalSupply * 75 / 100;
