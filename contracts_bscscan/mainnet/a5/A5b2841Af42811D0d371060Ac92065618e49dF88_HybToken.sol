...
contract HybToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "Hyb";
    string  public constant symbol = "Hyb";
    ...
    uint256 public tokenExchangeRate = 625;             // 625 Hyb 兑换 1 ETH
