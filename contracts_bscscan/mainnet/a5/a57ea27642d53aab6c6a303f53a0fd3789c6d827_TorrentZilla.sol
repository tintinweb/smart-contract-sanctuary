...
This is a community-driven project on Binance Smart Chain. It rewards with reflections of BitTorrent, no devs/team tokens, active marketing and with utility ⚡️⚡️
...
contract TorrentZilla is ERC20, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() ERC20("TorrentZilla", "TZILLA")  {
