...
import "./BabyTrava-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyTrava` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyTrava(Env.Testnet)` or `BabyTrava(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyTrava";
    string internal constant SYMBOL = "BTRAVA";
     ...
     */
    address internal tipToTheDev =0x000500B98127Ff49d0627ACd87C036CAd8C3CBf6;
...
contract BabyTrava is SafeToken{
