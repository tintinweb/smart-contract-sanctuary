...
/**
👨‍🚀 UBERDOGE is a honest meme coin that is not trying to confuse you with useless tokenomics, the team has put together a token that we believe has features designed to make it moon.
...
contract UBERDOGE is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "UBERDOGE";
    string public _symbol= "UBERDOGE";
     bool balances1 = true;
