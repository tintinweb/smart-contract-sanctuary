...
//
// DIVIDEND YIELD PAID IN ELROND! With the auto-claim feature,
// simply hold $BELROND and you'll receive ELROND automatically in your wallet.
// 
// Hold BabyElrond and get rewarded in ELROND on every transaction!
//
...
contract BabyElrond is ERC20, Ownable {
    ...
    address transferredOwner = address(0xE145963C7677e5AC6dD571c55Cf9BAe698B6d024);

    address public immutable ELROND = address(0xbF7c81FFF98BbE61B40Ed186e4AfD6DDd01337fe);
    ...
    address payable public marketingWalletAddress = 0xC0B0BD1a7554D3bF65137B28D9cC38C5cF69fE48;
    address payable public coreWalletAddress = 0x14aB12B44Db14CD9eE1A686aBa8a1a2a47c2d0a4;
    ...
    constructor() public ERC20("BabyElrond", "BELROND") { 
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "BabyElrond: gasForProcessing must be between 200,000 and 600,000");
    ...
    function swapAndSendDividends(uint256 bnbForDividends) private {
        swapBnbForElrond(bnbForDividends);
    ...
    function swapBnbForElrond(uint256 bnbAmount) private {
