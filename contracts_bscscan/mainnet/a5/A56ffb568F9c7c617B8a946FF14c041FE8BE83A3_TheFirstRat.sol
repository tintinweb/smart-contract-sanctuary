...
contract TheFirstRat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The first rat";
    string private _symbol = "TFR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3bd4bE9e9c099bA17ba18aD35D335abf964B8A71); // Marketing Address
    address payable public teamWalletAddress = payable(0xc8D539Ee0b29c1EdE1b2e293D3b88E1939D4C4CA); // Team Address
