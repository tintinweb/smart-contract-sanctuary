...
AdaSaurus - Fair launch

Social references:

▶️ Countdown: https://countingdownto.com/?c=3847723
▶️ Website: https://www.adasaurus.co/
▶️ Twitter: https://twitter.com/AdasaurusBSC
▶️ Telegram: https://t.me/AdaSaurus
...
contract AdaSaurus is IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 50,000,000
    ...
    uint256 public swapThreshold = _totalSupply / 125; // 8M swap
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x09e31c97684C16375d7A7951A97119375014dee1);
