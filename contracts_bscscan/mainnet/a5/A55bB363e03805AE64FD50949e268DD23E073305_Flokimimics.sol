...
The Real Flokimimics!

Telegram: https://t.me/Flokimimics
Website: http://www.flokimimics.com
Twitter: https://twitter.com/Flokimimics
...
contract Flokimimics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Flokimimics";
    string constant _symbol = "FLOKIMIMICS";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + lotteryFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3fB836716EC0Db5b648Ec8556F307669b11053Df;
        lotteryFeeReceiver = 0x3fB836716EC0Db5b648Ec8556F307669b11053Df;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _lotteryFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        lotteryFee = _lotteryFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_lotteryFee);
