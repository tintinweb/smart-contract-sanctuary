...
contract ForeverBNB is Context, IBEP20, Ownable {
    ...
    string private _symbol   = "DGMOON";
    uint8 private  _decimals = 9;
    
    uint256 public _taxFee       = 2; 
    uint256 public _liquidityFee = 18; 
    uint256 public _percentageOfLiquidityForDev = 83; 
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        _maxTxAmount = _tTotal.mul(maxTxPercent).div(200);
    }
