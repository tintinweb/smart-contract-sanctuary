...
/**
 * 
 SandBox Pro will be built based on the logic of Sandbox，cause some different ideas and The Sandbox pro improve its logic. Players can build everything alive in their world at and cheaper cost than Eth network. The Sandbox pro team is building a unique virtual world where players can build, own, and monetize their gaming experiences using SANDPRO, the main utility token of the platform. The demon version will be based on Sandbox and Bsc at first until the publish of the Sandbox pro network. 
*/
...
contract SANDPRO is Context, IERC20, Ownable {
