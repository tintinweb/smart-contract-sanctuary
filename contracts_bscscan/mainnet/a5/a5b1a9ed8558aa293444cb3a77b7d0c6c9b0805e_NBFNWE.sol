...
contract NBFNWE is Context, IERC20, Ownable {
    ...
    uint256 public _buyLiquidityFee = 5; //MARKETING 1% + BUYBACK 1%
    
    uint256 public _sellTaxFee = 2; //TO HOLDER
    uint256 public _sellLiquidityFee = 5; //MARKETING 1% + BUYBACK 1%
    ...
    uint256 private minimumTokensBeforeSwap = 51324214236584 * 10**9; 
