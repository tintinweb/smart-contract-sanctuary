...
contract SonOfBonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Son Of Bonk";
    string private _symbol = "SOB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8551330DcB962188dC58bbEc6398FC8A52C3959c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8551330DcB962188dC58bbEc6398FC8A52C3959c); // BuyBack Address
