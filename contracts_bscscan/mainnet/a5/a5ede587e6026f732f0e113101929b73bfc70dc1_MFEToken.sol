...
/**
   Motion Frames Entertainment Token- V1
   $MFEToken features:
   4% fee auto distribute to all holders
   4% fee auto add to the liquidity pool
   2% fee for Marketing & Project Sustainability
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract MFEToken is Context , IERC20, Ownable {
    ...
    string private _name = "MFEToken";
    string private _symbol = "MFE";
    ...
    address public devWallet = 0x6D590bF4426782B057a7d2542375d9010Ceb184E; //2% for marketing & Project Sustainability
    ...
    uint256 public _maxTxAmount = 10000 * 10**3 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2500 * 10**3 * 10**9;
    uint256 public _maxWalletToken = 30000 * 10**3 * 10**9;
