...
/**
 * Standard SafeMath, stripped to just add/sub/mul/div
 */
library SafeMath {
...
contract EthZillaDividendDistributor is IDividendDistributor {
...
contract EthZilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EthZilla";
    string constant _symbol = "EthZilla";
    uint8 constant _decimals = 9;

   uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; // 1% (Change after contract deployed)
    uint256 public _maxSellTxAMount = _totalSupply / 100; // 0.5% 
    ...
    */
    ...
    uint256 public liquidityFee = 23; //all these are changeable after deployment
    uint256 public marketingFee = 30;
    uint256 public developmentfee = 40;
    uint256 public rewardtokenFee = 5;
    uint256 public totalFee = 98;
    ...
    EthZillaDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new EthZillaDividendDistributor(address(router), Eth);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        Eth = rewardToken;
        distributor = new EthZillaDividendDistributor(address(router), rewardToken);
    }	
