...
contract NftreePool {
  ...
  /** 
    ...
    * @param releaseTime_ defines release timestamp of prize pool
	*/
    ...
    onlyOwner
  {
    ...
    require(
        releaseTime_ > block.timestamp && treeId_.length <= 10,
        "Treedefi: Invalid input"
    );
  ...
  /** 
    ...
    */
  function revokePrize() external onlyOwner {
  ...
  function removeSeed(uint256 amount_) external {
    ...
    SEED.transferFrom(address(this), msg.sender, amount_);
