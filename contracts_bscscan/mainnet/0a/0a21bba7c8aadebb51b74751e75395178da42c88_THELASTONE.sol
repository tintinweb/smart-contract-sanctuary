...
Goal is to burn 99.99% of the tokens. With our strict tokenomics + Progressive tax brackets, we are confident we can achieve this.

Brought to you by @DetectiveBSCApelounge

https://t.me/TheLastOneBSC
...
contract THELASTONE is IBEP20, Auth {
    ...
    string constant _name = "THELASTONE";
    string constant _symbol = "TLO";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.div(1000).mul(5);
    uint256 public _maxWalletToken = _totalSupply.div(1000).mul(15);
    ...
    uint256 public cooldownTimerInterval = 600;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(blacklistMode){
            require(!isBlacklisted[sender] && !isBlacklisted[recipient],"FuckBots");    
        }
        ...
        if (recipient == pair &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"Please wait a little while between two sells");
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        uint256 toTheFire = amount.mul(burnFee).div(feeDenominator);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _burnFee, uint256 _sellFee, uint256 _feeDenominator) external authorized {
    ...
    function manage_botlist(address[] calldata addresses, bool status) external authorized {
