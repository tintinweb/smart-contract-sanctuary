...
contract Falcon is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x69Ffd4a0f97F4f867031b45a2D309d18265a617C); // Marketing Address
    address payable public charityAddress = payable(0x69Ffd4a0f97F4f867031b45a2D309d18265a617C); // Charity/Dev Address
