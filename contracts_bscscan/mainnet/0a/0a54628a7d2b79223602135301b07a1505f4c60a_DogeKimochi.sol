 ...
 * What is $DogeKimochi
 * As the name suggests, $DKI is an intricately designed BSC contract and BSC based investment created in order to provide a passive income in one of BSC's favourite, most stable and future proof token.
...
contract DogeKimochi is Context, IERC20, Ownable {
    ...
    uint256 private _feesHolder = 12; // reflection in TRON
    ...
    address Cake = 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B; // Cake ADDRESS FOR REFLECTION
