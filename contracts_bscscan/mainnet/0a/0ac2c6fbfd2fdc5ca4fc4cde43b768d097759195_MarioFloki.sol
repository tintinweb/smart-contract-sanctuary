...
interface IBEP20Sniper is IERC11 {
    ...
    contract MarioFloki is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Mario Floki";
    string private _symbol = "MRFLOKI";
    uint256 private constant MAX = ~uint256(0);
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0x6d5a84a45DFEc56A75A8205f6329f3516831ec70;
    address private _water4Africa = 0x6d5a84a45DFEc56A75A8205f6329f3516831ec70;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0x6d5a84a45DFEc56A75A8205f6329f3516831ec70;
