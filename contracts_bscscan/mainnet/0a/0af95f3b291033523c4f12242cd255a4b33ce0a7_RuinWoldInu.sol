...
RuinWorld Inu is a community driven meme coin, targeted to steal the limelight from Cheems inu !

telegeram: https://t.me/Ruinworldinu
*/
...
contract RuinWoldInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RuinWorlInu";
    string private _symbol = "RUWINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcb1DC050d52fA5C3b3e1bcFf9bA98C2Df05085A3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xABA4DcE627D0573bcE0b714b4A2513F9b22e54C8); // Treasury / Buyback
