...
/*
 * Welcome to Fair Doge
 *
 * All is fair in a fair launch, providing the best platform for anti-dump fair launches.
 *
 * Total Supply: 100 Billion
 * Max Buy: 100 Billion (~1% of Total Supply)
 * Max Hold: 2 Billion (~2% of Total Supply)
 *
 * READ THIS CAREFULLY:
...
contract FairDoge is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 1 * 10**9 * 10**9; // Max Transaction: 100 Million (1%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 2 * 10**9 * 10**9; // Max Wallet: 200 Million (2%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Fair Doge";
