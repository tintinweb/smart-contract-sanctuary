...
Trusted Node (Blockchain Service)
...
Maximize Yield While Securing the Network
The new era of Proof-of-Stake is here. 
Get instant access to PoS rewards, DeFi yield, and multichain governance. 
All through a network of Trusted Nodes.
Role of Token: UTILITY

==)https://trustednode.io/
==) https://t.me/trustednode_io
==)https://twitter.com/trustednode
...
contract TrustedNode is Context, IBEP20, Ownable {
    ...
    string private _name = 'Trusted Node';
    string private _symbol = 'TNODE';
