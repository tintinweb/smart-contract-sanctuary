...
contract Bet is BaseSingleTokenStaking {
    ...
    function transferStake(address staker) external onlyOperator notLocked updateReward(staker) {
    ...
    function liquidityProviderGetBonus() external nonReentrant onlyLiquidityProvider {
