...
contract Ownable is Context {
    address private _owner = 0x4e0d044F957409D8a10817A6ad39901468388256;
...
contract Water is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xD63126d4b136348eA5b82A1C9BAE0a4AA48deA7b); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "FE-Water"; // token name
    string private _symbol = "Water"; // token symbol
    uint8 private _decimals = 9; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 2000 * 10**0 * 10**_decimals;
    ...
    uint256 public _minTokensSwapToAndTransferTo = 1000 * 10**0 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
