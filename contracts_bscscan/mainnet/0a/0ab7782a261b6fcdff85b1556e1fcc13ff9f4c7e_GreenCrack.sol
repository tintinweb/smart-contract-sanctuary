...
// 10% tax
// 3% BNB rewards
// 1% max wallet and sell at launch increased later (4.2 CUSH)
// https://t.me/GreenCrackToken
...
//Contract
contract GreenCrack is IBEP20, Ownable {
    ...
    string private constant _name = 'Green Crack';  
    string private constant _symbol = 'CUSH';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 420 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;    
    uint8 private constant MaxWalletDivider=100; //1% = 4.2
    uint16 private constant SellLimitDivider=100; //1% = 4.2
    uint8 public constant MaxTax=20;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
    uint8 private _devTax=15;
