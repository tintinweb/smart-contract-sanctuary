...
/**
 ...
 TG: https://t.me/MiniBogged_BSC
 http://www.minibogged.live/
 
 Hold $MiniBOGGED and get $BOGG automatically in your wallet every hour!
 $BOGG: 0xB09FE1613fE03E7361319d2a43eDc17422f36B09
 

 # of Tokens: 1,000,000,000
 Max Wallet Size = 20,000,000
 Max Transaction Size = 20,000,000 

 Reflection/Taxes: 8% in BOGG, 6% in Liquidity
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20  BOGG = IERC20(0xB09FE1613fE03E7361319d2a43eDc17422f36B09);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BOGG.balanceOf(address(this));
        ...
        uint256 amount = BOGG.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BOGG.transfer(shareholder, amount);
...
// CHANGE
contract MiniBOGGed is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address BOGG = 0xB09FE1613fE03E7361319d2a43eDc17422f36B09;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniBOGGED";
    string constant _symbol = "MBOGG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 20) / 1000; // 2.0% MAX 20,000,000
    uint256 public _maxWalletSize = (_totalSupply * 20) / 1000; // 2.0% MAX 20,000,000
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountBOGG);
