...
contract ShinobuInu is IBEP20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    string constant _name = "Shinobu Inu";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0x398c99Ea81bDe539EA3BbC016430E31515c6873b);
	    teamFeeReceiver = address(0x398c99Ea81bDe539EA3BbC016430E31515c6873b);
