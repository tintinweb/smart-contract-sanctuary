...
contract MiniCasino is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MiniCasinoToken";
    ...
    uint256 internal _tokenTotal = 10000000 *10**18; // 10 Billion totalSupply
    ...
    uint256 public _taxFee = 100; // 50 = 0.5%
    ...
    uint256 public _maxTxAmount = 50000 * 10**18; // 20 Million inicial máx transfer
    ...
    address public buybackv1Address  = 0x235A50295577BF4c94F01AE36e7A8Fc3556CF769;      // BuyBackv1 Address
    address public buybackv2Address  = 0x235A50295577BF4c94F01AE36e7A8Fc3556CF769;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x235A50295577BF4c94F01AE36e7A8Fc3556CF769;      // SMarketing Address
