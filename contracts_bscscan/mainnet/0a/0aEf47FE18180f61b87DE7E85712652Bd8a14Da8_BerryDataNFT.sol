...
/// @title Berry Data NFT based on ERC721 standard.
/// @notice Berry Data NFT is the NFT used in Berry Data Network platform.
/// Nothing special about it except that it has two more additional parameters to
/// for quality and generation to use in Berry Data Platform.
/// @author Medet Ahmetson
contract BerryDataNFT is ERC721, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private tokenId;

    /// @dev minting of berry data  nfts are done by factory contract only.
     ...
     */
    constructor() public ERC721("Berry Data NFT", "BRYNFT") {
	    tokenId.increment(); // set to 1 the incrementor, so first token will be with id 1.
    }

    modifier onlyFactory() {
        require(factory == _msgSender(), "Berry Data NFT: Only NFT Factory can call the method");
        _;
    }
