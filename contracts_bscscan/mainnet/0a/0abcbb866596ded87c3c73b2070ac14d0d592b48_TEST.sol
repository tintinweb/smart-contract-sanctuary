...
contract TEST is ERC20, Ownable {
    ...
    constructor() ERC20("TEST", "TEST") {
    	...
    	marketingWallet = 0xb18B255128a3B2e7904dC201CB25525fB243ba37;
    	DevFee = 0x080567745d2F7a9762B0e77d955418A407F1A773;
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[from]) { // if buy
                ...
                if (rewardsEnabled) {
                    ...
                    super._transfer(from, DevFee, rewardPortion);
                }
            }
