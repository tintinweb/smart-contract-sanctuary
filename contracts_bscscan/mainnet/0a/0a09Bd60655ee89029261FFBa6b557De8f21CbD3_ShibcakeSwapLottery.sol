...
// File: contracts/interfaces/IShibcakeSwapLottery.sol

pragma solidity ^0.8.4;

interface IShibcakeSwapLottery {
    /**
     ...
     * @dev Callable by operator
     * @param _endTime: endTime of the lottery (seconds)
...
// File: contracts/ShibcakeSwapLottery.sol

pragma solidity ^0.8.4;
pragma abicoder v2;

/** @title ShibcakeSwap Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract ShibcakeSwapLottery is ReentrancyGuard, IShibcakeSwapLottery, Ownable {
