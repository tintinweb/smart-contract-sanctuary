 ...
 *  
*   
*   Telegram: https://t.me/TheLastHourBSc
*/
...
contract LastHourDividendDistributor is IDividendDistributor {
...
contract LastHour is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "The Last Hour";
    string constant _symbol = "LastHour";
   ...
   uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    ...
    uint256 public _maxHoldAmount = _totalSupply / 25; // 4% (Can change after contract deployed)
    ...
    */
    ...
    LastHourDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new LastHourDividendDistributor(address(router), BUSD);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        BUSD = rewardToken;
        distributor = new LastHourDividendDistributor(address(router), rewardToken);
    }	
