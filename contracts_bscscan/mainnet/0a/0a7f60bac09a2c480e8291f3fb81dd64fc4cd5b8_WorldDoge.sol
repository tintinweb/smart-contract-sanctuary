...
/**
 *WorldDoge BSC Token - New Meme Doge Token to kill all other dogs
 * 100% tokens added to pancakeswap.
 * Tokenomics apply a special 15% tax.
 * 8% redistributed back to holders.
 * 3% liquidity fee.
 * 4% marketing fee.
 * TG: https://t.me/WorldDoge
*/
...
contract WorldDoge is Context,IBEP20,Ownable {
    ...
    string private constant _name = "WorldDoge";
    string private constant _symbol = "WORLDDOGE";
