...
/** 
 *  SourceUnit: d:\GitWork\LuchowNFT\Contracts\contracts\LuchowAuction.sol
*/
...
contract LuchowAuction is Ownable, ERC721Holder {
    ...
    function finalizeAuction(uint256 _auctionId) public {
        ...
        if(bidsLength == 0) {
            ILuchowNFT(myAuction.collectionId).safeTransferFrom(address(this), myAuction.owner, myAuction.tokenId);
