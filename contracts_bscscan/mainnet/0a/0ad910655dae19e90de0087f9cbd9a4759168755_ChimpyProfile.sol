...
*/
contract ChimpyProfile is AccessControl, ERC721Holder {
     ...
     * and sends CHIMPY to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer CHIMPY tokens to this contract
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer CHIMPY token to this address
        cakeToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberCakeToUpdate
