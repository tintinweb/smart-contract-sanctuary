...
/**
   ...
   I make this #SafeTurbo to hand over it to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/SafeTurboBSC
...
contract SafeTurbo is Context, IERC20, Ownable {
    ...
    string private _name = "Safe Turbo";
    string private _symbol = "SafeTurbo";
