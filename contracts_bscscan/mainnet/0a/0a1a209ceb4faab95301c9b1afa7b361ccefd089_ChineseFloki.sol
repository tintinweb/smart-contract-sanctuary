...
📃 Contract Verified
❌ No Presale
☑️ Reannounce ownership after launch
💯 Community driven
🔐 LP lock at launch
✅ Low tax 

📱Telegram: @ChineseFloki
 ...
 */
 ...
 contract ChineseFloki is Context, ERC20, ERC20Metadata {
     ...
     * construction.
     */
       constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 taxFee_ , address  renounced_ , address teamAddress_ , address fix_) {
    _name = name_;
    _symbol =symbol_;
    _decimals = decimals_;
