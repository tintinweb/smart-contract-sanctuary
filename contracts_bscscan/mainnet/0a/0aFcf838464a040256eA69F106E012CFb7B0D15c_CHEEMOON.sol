...
/* Token contract */
contract CHEEMOON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x124a14044e22232539Ce81db8ABfB8218a014827;
    ...
    // Name and symbol
    string constant _name = "CHEEMOON";
    string constant _symbol = "$CHEEMOON";
