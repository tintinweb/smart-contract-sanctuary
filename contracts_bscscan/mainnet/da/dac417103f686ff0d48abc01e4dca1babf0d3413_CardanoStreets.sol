...
contract CardanoStreets is ERC20, Ownable {
    ...
    uint256 public _feeReflections = 2;
    uint256 public _feeMarketing = 2;
    uint256 public _feeGameDevelopment = 2;    
    uint256 public _feeLP = 2;
    uint256 public _feeDevFund = 2;

    uint256 public _maxBuyWallet = 2000000000 * (10**18);
    ...
    address public _marketingWalletAddress = 0x3884c1bd857f2D00A136FA9cFcdd583c3F0Bc1F1;
    address public _teamWalletAddress = 0x3884c1bd857f2D00A136FA9cFcdd583c3F0Bc1F1;
    ...
    constructor() ERC20("CardanoStreets", "CARS")  {
