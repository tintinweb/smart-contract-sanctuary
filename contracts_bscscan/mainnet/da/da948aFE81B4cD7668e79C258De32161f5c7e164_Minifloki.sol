...
contract Ownable is Context {
    address private _owner = 0x958D36D8407293Ce113F21A479A08fDbbfF076c6;
...
contract Minifloki is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x1cd5683F76ecC22F44e45bF2f002c187D7b85EEd); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Minifloki"; // token name
    string private _symbol = "Minifloki"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 4 days; // duration betweeen each buyback
