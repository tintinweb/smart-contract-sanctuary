...
The contract employs a static rewards system — 15% of every transaction is split in three: – 10% BabyAlonzo is redistributed in ADA to holders‌ – 2% tokens is used to fuel the liquidity pool exchange growth – 3% BabyAlonzo is allocated to the marketing wallet.
