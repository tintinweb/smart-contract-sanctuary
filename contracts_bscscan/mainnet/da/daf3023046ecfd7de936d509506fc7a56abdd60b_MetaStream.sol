...
contract MetaStream is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "MetaStream";                                          // name
    string private _symbol = "MST";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xc4EeddED3EeD85bEC8f4Ba8ef3e06e566b3F29f5),                             // Dev+Team wallet
        payable(0x60393d6e0a748CE6f36aD87f7F3732e53530f070),                             // Marketing wallet
        payable(0x5a14c8d9EF2b949A5903d644ed94918B3B86b210)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "MetaStream is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "MetaStream is not live yet");
