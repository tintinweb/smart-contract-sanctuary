...
Who doesn't like Elfs, and Dogs? @DetectiveBSCApeLounge are proud to present to you ElfDoge, a Christmas theme meme play on BSC.

DISCLAIMER:

BSC HAS A HORRIBLE JEET PROBLEM AND IT RUINS A MAJORITY OF SMALL CAPS. ELFDOGE WILL BE IMPOSING A 1 HOUR LOCK LIMIT FOR ALL SELLS AND REOPEN IT AT 0.10%.
...
contract ELFDOGE is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "ELFDOGE";
    string constant _symbol = "ELFDOGE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // .25% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 0 / 10000; // 0.20% or 250k tokens
    uint256 public _maxWalletToken = _totalSupply * 10000 / 10000; // 2.5% or 2m tokens
