...
/**
Please ser, do not ape this, this is not a safe place.  
*/
...
contract PinkasleSkemDONTBOEI is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c ;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xbFb7bB84585E5a5851bc21852F11C2e66D224088;

    string constant _name = "{PinkasleSkemDONTBOEI}";
    string constant _symbol = "PASDB";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 25000000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 30000000000000 * (10 ** _decimals);
