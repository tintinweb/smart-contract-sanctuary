...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0x862d47994490B90bAee8dbC4DA39a836d388C1D6;
    }
...
contract HarmonyOneX is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "HarmonyOneX";
    string constant _symbol = "HarmonyOneX";
