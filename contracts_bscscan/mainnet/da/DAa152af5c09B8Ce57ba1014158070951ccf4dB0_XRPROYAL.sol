...
contract XRPROYAL is  Context, IERC20, Ownable {
    ...
    uint256 private _tXRPROYALTotal;
    ...
    uint256 public _XRPROYALFee = 10;
    uint256 private _previousXRPROYALFee = _XRPROYALFee;
    
    uint256 public _maxTxAmount = 1000 * 10**9 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**9 * 10**9; 
    
    address payable public XRPROYALAddress = 0xd7FBB8077e17859058A3ecfBC63BF19e7df1bf0f;
   ...
   function deliver(uint256 tAmount) public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tXRPROYALTotal = _tXRPROYALTotal.add(address(this).balance);
        TransferCharityETH(XRPROYALAddress, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_XRPROYALFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _XRPROYALFee == 0 && _liquidityFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousXRPROYALFee = _XRPROYALFee;
    ...
    function restoreAllFee() private {
        ...
        _XRPROYALFee = _previousXRPROYALFee;
    ...
    function setXRPROYALFeePercent(uint256 XRPROYALFee) external onlyOwner() {
        _XRPROYALFee = XRPROYALFee;
    }
