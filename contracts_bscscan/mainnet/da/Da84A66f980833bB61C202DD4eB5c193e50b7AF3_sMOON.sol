...
Official Telegram group : The group is private and it will be opened after launch. 
...
import "./sMOONDividendTracker.sol";
...
contract sMOON is ERC20, Ownable {
    ...
    sMOONDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("SureMoon", "sMOON") {

    	dividendTracker = new sMOONDividendTracker();

        _marketingWalletAddress = 0x1c3042fb2ecCB36234b815670B1DCcE722D5cfd7;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "sMOON: The dividend tracker already has that address");

        sMOONDividendTracker newDividendTracker = sMOONDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "sMOON: The new dividend tracker must be owned by the SureMoon contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "sMOON: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "sMOON: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "sMOON: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "sMOON: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "sMOON: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "sMOON: Cannot update gasForProcessing to same value");
