...
contract MBC is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Meta busd coin";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //testnet
        ...
        marketingFeeReceiver = 0x709A3BE1B4684Bf47f548C96FEecE0C71FbbbB39;
    ...
    function swapBack() internal swapping {
        ...
        (bool success1, /*bytes memory data*/ ) = payable(burnFeeReceiver).call{value: amountBNBburn, gas: 30000}("");
    ...
    function triggerMBCBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _burnFee) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_marketingFee).add(_burnFee);
    }
