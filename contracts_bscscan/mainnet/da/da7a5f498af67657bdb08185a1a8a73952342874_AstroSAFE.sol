...
contract AstroSAFE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AstroSAFE";
    string constant _symbol = "AstroSAFE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingAddress = 0x33051fb1EcE9E3Bc7385766155e4B3225690a8fa;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newmarketingAddress) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 newmarketingShare = amountBNBMarketing.sub(marketingShare);
        
        (bool tmpSuccess,) = payable(marketingWallet).call{value: marketingShare, gas: 30000}("");
        (bool tmpSuccess1,) = payable(marketingAddress).call{value: newmarketingShare, gas: 30000}("");
