...
contract DogeSwap is Context, IBEP20, Ownable {
    ...
    string public constant name     = "DOGE SWAP";
    string public constant symbol   = "DOGESWAP";
    ...
    function setFee(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner {
        _taxFeeBuy       = taxFee;
