...
contract FunkyPenguins is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 private _maxMint = 20;
    uint256 private _price = 8 * 10**16; //0.03 BNB;
    bool public _paused = true;
    uint public constant MAX_ENTRIES = 4444;

    constructor(string memory baseURI) ERC721("Funky Penguins", "FunkyPenguins")  {
        setBaseURI(baseURI);
