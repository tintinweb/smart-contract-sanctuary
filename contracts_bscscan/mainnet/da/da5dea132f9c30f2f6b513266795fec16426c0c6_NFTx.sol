...
// NFTx with Governance.
contract NFTx is HRC20('NFT Apocalypse', 'NFTx') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "NFTx::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "NFTx::delegateBySig: invalid nonce");
        require(now <= expiry, "NFTx::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "NFTx::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying NFTx's (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "NFTx::_writeCheckpoint: block number exceeds 32 bits");
