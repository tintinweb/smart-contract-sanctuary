...
contract Ownable is Context {
    ...
    //     require(block.timestamp > _lockTime , "Contract is locked until 1days");
...
contract Safe2Moon is Context, IERC20, Ownable {
    ...
    string private _symbol = "SAFE2MOON";
    ...
    constructor ()   {
        ...
        emit Transfer(payable(address(0)),payable(_msgSender()), _tTotal);
    }
    ...
    function includeInReward(address account) external onlyOwner() {
        ...
        emit Transfer(payable(sender), payable(recipient), tTransferAmount);
    }
