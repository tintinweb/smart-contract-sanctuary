...
contract SafeSuper is
    Context,
    BEP20,
    Ownable,
    ServicePayer,
    GeneratorCopyright("v1.0.0")
{
    ...
    constructor(address payable feeReceiver_)
        payable
        ServicePayer(feeReceiver_, "SafeSuper")
    {}
    ...
    function init(
        ...
        uint256 numtokenstoselltoaddtoliquidity,
        uint256 charityFee,
        ...
        require(
            charityWalletAddress != newContractOwner,
            "Charity Fee wallet must not be your wallet address"
        );
        ...
        numTokensSellToAddToLiquidity =
            numtokenstoselltoaddtoliquidity *
            (10**decimalmulty);
        _taxFee = taxFee;
        ...
        _previousCharityFee = _previousCharityFee;
