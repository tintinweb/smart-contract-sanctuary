...
// Welcome to BabyFuel, The first Token to give fuel rewards to shareholders
//TG: https://t.me/BabyFuel
// Tokenomics: 8% REWARDS 3% LIQUIDITY 5% Marketing
//slippage 16%-20
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FUEL = IBEP20(0x2090c8295769791ab7A3CF1CC6e0AA19F35e441A);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FUEL.balanceOf(address(this));
        ...
        uint256 amount = FUEL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FUEL.transfer(shareholder, amount);
...
contract BabyFuel is IBEP20, Auth {
    using SafeMath for uint256;

    address FUEL = 0x2090c8295769791ab7A3CF1CC6e0AA19F35e441A;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyFuel";
    string constant _symbol = "BabyFuel";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x7Cd12ddde1E0A29165D59ef77312BB6099392804;
