...
contract $BABYSWISS is IBEP20, Auth {
    ...
    string constant _symbol = "$BSWISS";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 25 / 100; // 0.05%

    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 100; //  1%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x291Aca3D4457B271d1418C31472c80efa46112CB;
