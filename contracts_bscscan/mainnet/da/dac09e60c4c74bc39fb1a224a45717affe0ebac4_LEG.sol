...
/* leagueofkingdoms.art Binance launch Pad- BNB Reward Token

website: https://leagueofkingdoms.art
Listing 1 LEG = 1.2 USD
...
contract LEG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9c120BEdca51b8e5D37f0a6c645d5379bAc933a5); // Marketing Address
    address payable public charityAddress = payable(0x9c120BEdca51b8e5D37f0a6c645d5379bAc933a5); // Charity/Dev Address
    ...
    string private _name = "League Of Kingdoms";
    string private _symbol = "LEG";
    ...
    uint256 public _maxTxAmount = 72000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 72000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 60000000000000000000; // 60; token will be given on airdrop
    ...
    uint256 private salePrice = 72000;// 0.01*720 token for 0.01 bnb (set as per requirements)
