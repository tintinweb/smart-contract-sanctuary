...
//   Welcome to CardanoRocket
   
 //  This is a community token. If you want to create a telegram I suggest to name it to @CardanoRocket
...
//   5% fee For Marketing
//   80% burn to the black hole

//   I will add .2 BNB and all the left 20% total supply to the pool
//   Can you make #CardanoRocket 10000X? 
...
contract CardanoRocket is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CardanoRocket";
    string constant _symbol = "CardanoR";
