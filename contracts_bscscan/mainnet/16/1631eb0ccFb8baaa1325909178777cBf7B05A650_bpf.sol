...
Welcome to BabyPeach!

https://t.me/babypeachbsc
...
contract bpf is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyPeach";
    string constant _symbol = "Bpeach";
    ...
    uint256 reflectionFee = 15; // Cake reflection fee
    uint256 marketingFee = 3;
    uint256 totalFee = 18;
    uint256 feeDenominator = 100;
    
    uint256 sellFeeIncreaseFactor = 120;

    address autoLiquidityReceiver;
    address marketingFeeReceiver = address(0xD48fBea10fdB1bC9b6781C24de9FAF9Cf267a91C);
    ...
    constructor () {
        ...
        TargetToken = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
    ...
    function Appfees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee) external onlyOwner {
