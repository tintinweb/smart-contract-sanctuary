...
contract NFTROCKET is Context, IERC20, Ownable {
    ...
    string private _name = "NFTROCKET";
    string private _symbol = "NRock";
    ...
    address _marketingWallet = 0x2281B7076CE8A4B67fD5A8F48883F6F8B47a2aAf;
