...
/*
    ...
    Telegram: ShibaClassicBSC
    Website: ShibaClassic.Finance
    Twitter: TBA
    4Chan: Daily Yeet!
...
contract Token is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(_walletFee != 0){
            ...
            swapTokensForBNB(spentAmount, feeWallet);
        }

        if(_buybackFee != 0){
            spentAmount = contractTokenBalance.div(totFee).mul(_buybackFee);
            swapTokensForBNB(spentAmount, address(this));
    ...
    function swapTokensForBNB(uint256 tokenAmount, address reciever) private {
