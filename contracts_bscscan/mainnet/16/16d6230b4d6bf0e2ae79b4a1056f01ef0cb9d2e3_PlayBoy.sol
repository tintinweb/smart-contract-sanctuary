...
contract PlayBoy is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 10_000_000_000_000 * 10**9; // 1% of total supply
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100_000_000_000 * 10**9; // 0.01% of total supply

    string private constant _name = "PlayBoy"; 
    string private constant _symbol = "PLAYBOY";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 6;
    address public _marketingWallet = 0x86787DFc4b46092eB54632a70d776404f8005F07;
