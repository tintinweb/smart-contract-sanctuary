...
contract SnitchNine is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "SnitchNine";
    string private _symbol = "STITCHES";
    ...
    uint256 public _maxWalletSize = 1.4 * 10**9;
