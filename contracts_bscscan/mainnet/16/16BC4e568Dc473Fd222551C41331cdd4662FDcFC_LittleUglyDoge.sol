...
contract LittleUglyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0E9A7588dd61c54dAaeFF910E052AEc5569F9345); // Marketing Address
    ...
    string private _name = "LittleUglyDoge";
    string private _symbol = "LUDOGE";
    ...
    uint256 public _maxTxAmount = 30000000000 * 10**6 * 10**9;
