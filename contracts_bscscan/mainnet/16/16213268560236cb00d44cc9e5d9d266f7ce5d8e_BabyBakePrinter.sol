...
contract BabyBakePrinter is Context, IBEP20, Ownable {
    ...
    uint256 private _maxWallet = _tTotal.div(10**2).mul(50);
    ...
    string private _name = "BabyBakePrinter";
    string private _symbol = "BabyBakePrinter";
