...
/**
 Welcome to CakeDoge
   ...
   I will renounce the ownership to burn addresses to transfer #CakeDoge to the community

   I will add 1.3 BNB and all the left 10% total supply to the pool
   Can you make CakeDoge 100X? 
   ...
   it's the best part of the #CakeDoge idea, increasing the liquidity pool automatically, 
