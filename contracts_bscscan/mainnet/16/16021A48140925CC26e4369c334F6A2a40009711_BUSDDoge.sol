...
/**
 *  
 *  https://t.me/BUSDDogeOfficial
 * 8% of Every transaction (Buy/Sell) is converted to BUSD and Distributed to holders every hour!, Anti-Whale Dumping tax!  
 */
...
contract BUSDDoge is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "BUSDDoge";
    string constant _symbol = "BUSDDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10 ** 9 * (10 ** _decimals); // 1 trillion
    uint256 public _maxTxAmount = _totalSupply / 1000000000; // 0.1%
