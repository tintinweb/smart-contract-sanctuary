...
/**
https://t.me/MetaLoanPad
http://metaloanpad.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x391e49332C6e0ca778ec87E992183C5e51898077;
...
contract MetaLoanPad is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0x7D750784B42a8709cC37F7C49BC3e43fC6104207);
    address payable public Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable private Wallet_renounce = payable(0x0000000000000000000000000000000000000000); 
    ...
    */
    ...
    string private _name = "MetaLoanPad"; 
    string private _symbol = "MetaLoan";  
    ...
    uint256 private maxPossibleFee = 1 * 10**6; 

    // Setting the initial fees
    uint256 private _TotalFee = 1 * 10**6;
