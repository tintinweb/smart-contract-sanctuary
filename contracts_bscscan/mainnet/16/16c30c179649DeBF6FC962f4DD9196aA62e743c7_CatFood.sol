...
library Anquan {
    function teywig(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        uint256 c = a + b;
        if (c < a) return (false, 0);
        return (true, c);
    }

    function tryhair(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        if (b > a) return (false, 0);
        return (true, a - b);
    }

    function tryNa(uint256 a, uint256 b) internal pure returns (bool, uint256) {
    ...
    function wig(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "Anquan: addition overflow");
        return c;
    }

    function hair(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "Anquan: subtraction overflow");
        return a - b;
    }

    function Na(uint256 a, uint256 b) internal pure returns (uint256) {
        if (a == 0) return 0;
        uint256 c = a * b;
    ...
    function hair(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
