...
/**
/*
🌀HarryPotter Token🌀. Join the magical fair launch 19:00 UTC. The mystery word needs you!

Join the magical world of Harry Potter with us.
Are you Harry Potter series fan? Then you MUST buy this token.
We have some special announcements for later and trust us, you will be surprised!
...
contract HarryPotter is Context, IERC20, Ownable {
    ...
    string private _name = "HarryPotter Token";
    string private _symbol = "HarryPotter";
    ...
    uint256 private minimumTokensBeforeSwap = 0 * 10**6 * 10**18; 
