...
contract XTest3 is Context, IERC20, Ownable {
    ...
    string private _name     = "XTest3";
    string private _symbol   = "XTest3";
    ...
    function swapBnbForTokens(uint256 bnbAmount) private {
        ...
        _approve(address(this), address(_uniswapV2Router), bnbAmount);
