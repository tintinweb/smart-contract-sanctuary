...
contract UrekaCBondDepository is Ownable {
    ...
    /**
     *  @notice set temporary static price
     *  @param _input uint
     */
    function setOverridePrice( uint _input ) external onlyPolicy() {
        overridePrice = _input;
    }
