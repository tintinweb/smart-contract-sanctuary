...
/**
 PLANET X 
 Telegram : https://t.me/planetxtoken
...
contract PlanetX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Planet X";
    string private constant _symbol = "PLX";
    ...
    address payable constant private _marketingAddress = payable(0x481597f755F4ca4C04ffF8deD6CAEf2e973aaFAA);
    address payable constant private _buybackAddress = payable(0xf9b33ADdE85d6e5CB7F48A2C3Ef82C8CFc260Dc5);
    address payable constant private _projectMaintainence = payable(0x6240dAe561911bD14D0C18A35a55833c7557e252);
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//PlanetX
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//PlanetX
