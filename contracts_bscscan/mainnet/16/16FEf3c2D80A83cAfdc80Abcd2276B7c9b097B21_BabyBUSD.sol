...
// 
// Hold BabyBUSD and get rewarded in BUSD on every transaction!
//
...
contract BabyBUSD is ERC20, Ownable {
    ...
    address transferredOwner = address(0xf5d933119dDcC31f0933137fE065130e233EA4ee);
    ...
    address payable public marketingWalletAddress = 0x6066308c6da3089bbd46DC5FD389417c36BB2722;
    address payable public coreWalletAddress = 0x6066308c6da3089bbd46DC5FD389417c36BB2722;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "BabyBusd: gasForProcessing must be between 200,000 and 600,000");
