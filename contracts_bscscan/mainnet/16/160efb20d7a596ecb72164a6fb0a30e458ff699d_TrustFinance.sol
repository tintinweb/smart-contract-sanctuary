...
contract TrustFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x05d1d8856E388017Ff6FDcd131337640bb989684); // Marketing Address
    ...
    uint256 private _tTotal = 15000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TrustFinance";
    string private _symbol = "TrustFinance";
