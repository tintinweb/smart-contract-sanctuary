 ...
 *
 * Join
 * https://sleepydoge.net
 *
 * Fees
 * 8% distributed to public liquidity pool
 * 3% distributed to loyal token holders
 * 1% distributed to marketing
 * 
 * Supply
 * 1,000,000,000,000,000 total supply
 * 40% of supply burned on launch
 * 10% of supply airdrop & event
 * 10% of supply allocated for marketing , growth and development & charity
 * 40% of supply provided as public liquidity
 * 
 * SleepyDOGE !!!
 * $ZZZDOGE
 *
...
contract SleepyDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x175AaEc0Bb17DFD745f50cC562C44fb9eA2BbaB8); // Marketing Address
    ...
    string private _symbol = "ZZZDOGE";
