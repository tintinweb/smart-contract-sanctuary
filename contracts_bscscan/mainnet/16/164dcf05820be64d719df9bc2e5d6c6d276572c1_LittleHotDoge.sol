...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaDf8E04bEDB153f13cdCB1f9A45d7aef21992179;
...
contract LittleHotDoge is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD0627D9d23672F31FE0654dBC0aa42186095Dce7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Little HotDoge";
    string private _symbol = "LTHD";
    ...
    uint256 private numTokensSellToAddToLiquidity = 4000000000 * 10**18;
