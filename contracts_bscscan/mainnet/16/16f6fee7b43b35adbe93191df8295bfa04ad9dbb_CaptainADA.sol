...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 1 minutes; // min 1 minutes delay
...
contract CaptainADA is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "CaptainADA";
    string constant _symbol = "CaptainADA";
    ...
    uint256 sellMarketingFee = 800;
    uint256 buyReflectionFee = 1000;
    uint256 buyMarketingFee = 800;
