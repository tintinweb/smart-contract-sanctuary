...
South Park Token has a unique burn mechanism.
Indeed, we have access to liquidity, this liquidity is composed of BNB and $SOUTHPARK.
Every day, we will withdraw 20% of this liquidity
and use it to buyback and burn $SOUTHPARK tokens.
All proofs of buy and burn will of course be posted on our social networks.
We hope that this mechanism will help the project to last through time compared to other similar tokens.

SOUTH PARK TOKEN
️ Token Name : South Park
️ Token Symbol: $SOUTHPARK
️ Max Supply : 10,000,000,000,000,000 $SOUTHPARK
️ Token Address:TBA

 Useful Links

 Website: https://www.southparktoken.com
 Telegram: https://t.me/SouthParkToken
...
contract SouthParkToken is Context, IERC20, Ownable {
    ...
    address _marketingWallet = 0xA19d094f85773b69D9D1d555622a8CB57171db39;
