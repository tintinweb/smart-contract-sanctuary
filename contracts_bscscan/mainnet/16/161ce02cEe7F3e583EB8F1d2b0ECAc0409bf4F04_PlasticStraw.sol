...
contract PlasticStraw is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public safeManager;
    address payable public marketingAddress =
        payable(0xD1294a26Bd67fcbeF7383f64A51bdbb573beA433); // Marketing Address
    ...
    string private _name = "Elon PlasticStraw";
    string private _symbol = "PlasticStraw";
    ...
    // 0.5%
    uint256 public _maxTxAmountForSell = 5000000000 * 10**9;
    ...
    function swapETHForTokens(uint256 amount) private {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{
            ...
            path,
            deadAddress, // buy back token and burn
