...
contract SATOSHIFLOKI is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _symbol = "SASHIFLO";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 4044000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 202200000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 202200000 * (10 ** _decimals);
