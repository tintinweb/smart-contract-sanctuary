...
contract BabyBTC is Context, IERC20, Ownable {
    ...
    string private _name = "BabyBTC";
    string private _symbol = "BabyBTC";
    ...
    address payable public _watchWalletAddress;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount = 500000000000 * 10**1 * 10**9;
    ...
    constructor (address payable watchWalletAddress) public {
        _watchWalletAddress = watchWalletAddress;
    ...
    function sendBNBToWatch(uint256 amount) private { 
        swapTokensForEth(amount); 
        _watchWalletAddress.transfer(address(this).balance); 
    }
    
    function _setWatchWallet(address payable watchWalletAddress) external onlyOwner() {
        _watchWalletAddress = watchWalletAddress;
    }
