...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB7c67fF038CD57d7A598cbA3eD812B99cC2F8E60;
...
contract FORTUNE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x60c93c66F3516d1f200383430640d43364F125F4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 222000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Fortune Education";
    string private _symbol = "FORE";
