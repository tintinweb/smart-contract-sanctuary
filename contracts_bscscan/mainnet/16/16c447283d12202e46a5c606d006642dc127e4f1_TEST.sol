...
contract TEST is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x18A2BCEb4871A3B07234063fe82753E9e1684161); // Marketing Address

    address payable public teamAddress =
        payable(0x18A2BCEb4871A3B07234063fe82753E9e1684161); // Team Address
    ...
    uint256 private constant _tTotal = 100000 * 1e9 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "TEST TEST TEST";
    ...
    // 9% TOTAL | 5% MARKETING 2% LP 2% DEV
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 2 / 100; // 2% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 4 / 100; // 4% maxWalletToken
