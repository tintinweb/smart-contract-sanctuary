...
contract Test is IBEP20, Auth {
    ...
    address DEV = 0xD2a0DcA46F6b3dcADFC9d2b5E49B83a0e1469C45;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 0.20% or 250k tokens
    ...
    uint256 public swapThreshold = _totalSupply * 300 / 10000; // 0.1% of supply
