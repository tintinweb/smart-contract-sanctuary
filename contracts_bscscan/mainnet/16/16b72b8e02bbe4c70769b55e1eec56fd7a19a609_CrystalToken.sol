...
contract CrystalToken is BEP20('Lost Ark', 'CRYSTAL') {
...
contract xCrystalToken is Ownable {
    using SafeMath for uint256;
    ...
    CrystalToken public rewardtoken;
    // Dev address.
    ...
    constructor(
        CrystalToken _rewardtoken
    ) public {
        rewardtoken = _rewardtoken;
        devaddr = address(0x122C67AcdAa9cF952419a5329B7C090050ae98D3);
        feeAddress = address(0x122C67AcdAa9cF952419a5329B7C090050ae98D3);
