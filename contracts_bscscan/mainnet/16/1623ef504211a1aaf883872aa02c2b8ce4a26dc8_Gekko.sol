...
/**
  First Crypto Project for Jobs and Service Marketplace.     
  
 Website: https://gekko.llc/    Twitter: https://twitter.com/Gekkollc
https://t.me/gekkollc
...
contract Gekko is IBEP20, Ownable {
    ...
    string private constant _name = "Gekko LLC";
    string private constant _symbol = "Gekko";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 1000000000000 * 10 ** 9; 
    uint256 private _buyMaxTxAmount = 1000000000000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 1000000000000 * 10 ** 9;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 1000000000000, "Can not reduce below 10K");
        require(maxSell > 1000000000000, "Can not reduce below 10K");
