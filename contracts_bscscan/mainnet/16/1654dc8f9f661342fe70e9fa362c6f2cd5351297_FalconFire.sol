...
Telegram: https://t.me/falconfiretoken

Twitter: https://twitter.com/FalconFireToken
...
contract Context {
 ...
 contract FalconFire is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "FalconFire";
    string private _symbol = "FALCONFIRE";
    ...
    address private _Ownership = 0x6D8f2E042d9A5bfbe0D5517Ee6cDDcaA081D3886; // Ownership Address
