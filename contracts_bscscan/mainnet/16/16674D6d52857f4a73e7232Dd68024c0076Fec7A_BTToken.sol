...
contract BTToken is ERC20Capped, SafeOwnable {
    using SafeMath for uint256;
    ...
    constructor() ERC20Capped(MAX_SUPPLY) ERC20("BEE", "BEE") {
        ...
        external
    {
        ...
        require(block.timestamp <= expiry, "BT::delegateBySig: signature expired");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BTs (not scaled);
