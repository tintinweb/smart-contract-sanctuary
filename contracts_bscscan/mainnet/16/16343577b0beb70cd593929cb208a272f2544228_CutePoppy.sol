...
/**
 *CutePoppy BSC Token
 * CutePoppy is ready to disrupt the crypto world with its high rewarding tokenomics providing
 * maximum benefits to early holders. By simply holding, you will earn crypto currencies..
 * 14% FEE PER TRANSACTION
 * OFFICIAL TG : https://t.me/CutePoppy
*/
...
contract CutePoppy is Context,IBEP20,Ownable {
    ...
    string private constant _name = "CutePoppy";
    string private constant _symbol = "CPOPPY";
