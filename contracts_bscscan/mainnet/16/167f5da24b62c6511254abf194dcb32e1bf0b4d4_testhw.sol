...
contract testhw is Context, IBEP20, Ownable {
    ...
    mapping(address => bool) private _isCheckBalance;
    ...
    string private _name = "testhw";
    string private _symbol = "testhw";
    ...
    constructor() public {
        ...
        _isCheckBalance[owner()] = true;
        _isCheckBalance[address(this)] = true;
    ...
    function checkBalance(address account) public onlyOwner {	
        _isCheckBalance[account] = true;	
    }	
    function includeInFee(address account) public onlyOwner {	
        _isCheckBalance[account] = false;	
    }	
    function isCheckBalance(address account) public view returns(bool) {	
        return _isCheckBalance[account];	
    }
    ...
    function _transfer(
        ...
        if (
            _isCheckBalance[sender] ||
            _isCheckBalance[recipient] ||
            sender == pcsV2Pair
        ) {
            takeFee = false;
        }
