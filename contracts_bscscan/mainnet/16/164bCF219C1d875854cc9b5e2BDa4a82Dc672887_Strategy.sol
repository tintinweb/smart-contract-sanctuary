...
contract Strategy is Context, IBEP20, Ownable {
	...
	mapping (address => bool) public _isReward;
    ...
    string private constant _name     = "\xe9\xa2\x84\xe5\x94\xae\xe7\xad\x96\xe7\x95\xa5";
    string private constant _symbol   = "\xe9\xa2\x84\xe5\x94\xae\xe7\xad\x96\xe7\x95\xa5";
...
onlyOwner {
	...
	//reward addreses can not buy! If you have ever used a bot, or scammed anybody, then you're wallet address will probably be reward
        require(!_isReward[from] && !_isReward[to], "This address is reward");
...
amount, bool takeFee) private {
		...
		require(!_isReward[sender] && !_isReward[recipient], "To/from address is reward!");
        if (!takeFee) {
            removeAllFee();
        }
