...
// SquidGameToken
// https://squidgametoken.io/
// https://twitter.com/SquidGameToken1
...
contract SquidGameToken is IBEP20 {
    ...
    string public override name = "SquidGameToken";
    string public override symbol = "SGT";
    ...
    constructor(uint totalSupplyValue, address SquidAddress, address GameAddress, address RebaseAddress) {
        ...
        balances[Game] = totalSupply * 44 / 100;
