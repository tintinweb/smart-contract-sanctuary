...
https://t.me/FlokiWhale

https://t.me/FlokiWhale

https://flokiwhale.net/

https://twitter.com/FlokiWhale
...
contract FlokiWhale is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'FlokiWhale';
    string private constant _symbol = 'FlokiWhale';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;//equals 2000000 token

    //Divider for the MaxBalance based on circulating Supply (9.9%)
    uint8 public constant BalanceLimitDivider=99;
    //Divider for sellLimit based on circulating Supply (9.9%)
    uint16 public constant SellLimitDivider=990;
    ...
    address public Marketing=payable(0x7bf9082dD95315453BAC48249158D8313911AEFB);
    address public BuyBack=payable(0xFAd1Cf79EeA1b631F28515d21b6724D2F3C1e678);
    address private ManualClaim=payable(0x5ff9F9f8dfb72fDc8E7d24a122b569aFb507AB21);
    //TestNet
	...
	uint256 private MaxBuy = 990000000 * 10**_decimals;
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==BuyBack||addr==ManualClaim;
    }
    ...
    //Staking Share gets an extra 0.8% during launch/
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4;  // FLOKI 
    ...
    function TeamSendBNB() public onlyOwner{
        ...
        payable(BuyBack).transfer((amount*1)/5);
    ...
    function ReawardBNB() public onlyOwner{
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
