...
/**
   Super Bunny Coin(SBC)
   5% fee auto add to the liquidity pool
   5% distribute to a holders wallet 
   3% Distribute to Charity wallet
   ttl supply = 90000000000
   decimals 12
*/
...
contract SuperBunnyCoin is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x999bA67d233E82292f089C5296478B2048ce6f87;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 90000000000 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Super Bunny Coin";
    ...
    uint256 public _maxTxAmount = 90000000000 * 10**12;
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10**12;
