...
abstract contract Strat is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-INKU staking vault.
    ...
    address public INKUAddress = 0xB37CaD62441EF8B866F3e36F12fd42062b6c0F33;
    address public TAKOAddress = 0x2F3391AeBE27393aBa0a790aa5E1577fEA0361c2;
...
contract BSC_INKU_Strat is Strat {
    constructor(
        ...
        uniRouterAddress = _uniRouterAddress;
        earnedToINKUPath = [earnedAddress, wbnbAddress, INKUAddress];
