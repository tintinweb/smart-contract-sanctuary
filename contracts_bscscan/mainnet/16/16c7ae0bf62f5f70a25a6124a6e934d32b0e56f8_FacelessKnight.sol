...
Faceless knight is the first decentralized TCG (trading card game) application based on coin security smart chain (BSC) with the theme of Medieval Knight combined with magic culture
...
Telegram: https://t.me/Faceless_Knight_Offical
Website: https://FacelessKnight.com
*/
...
contract FacelessKnight is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x3FCaFB3c7C39C6756aA07b88731857bf9485B437);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0x3FCaFB3c7C39C6756aA07b88731857bf9485B437); 

    string private _name    = "FacelessKnight";
    ...
    uint256 public _externalTokenMinAmount          = 10 * 10**6 * 10**_decimals;
