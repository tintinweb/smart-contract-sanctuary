...
contract MircoDoge is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "SuperMicroShiba";
        ...
        )
    {
        ...
        (uint256 rAmount, uint256 rTransferAmount) = _getRValues(tAmount, tBurn, tLiquidity, _getRate());
    ...
    function _transferFromExcluded(
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 tTransferAmount, uint256 tBurn, uint256 tLiquidity) =
            _getValues(tAmount);
