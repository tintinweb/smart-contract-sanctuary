...
contract UrekaERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor(address _deployerAddress, uint256 _mintAmount) ERC20("Ureka", "URK", 9) {
      _mint(_deployerAddress, _mintAmount);
    }
