...
We have a special contract that is protected against bots. We attach great importance to fairness and justice. Everyone who buys should have the same chances. 
We would be happy about your investment.

https://t.me/moonraccoon_bsc
...
contract MoonRaccoonearn is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MoonRaccoonearn";
    string constant _symbol = "MoonRaccoonearn";
