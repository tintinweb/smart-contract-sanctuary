...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MetaNet(uint256 amount) public onlyOwner {
    MetaNet(msg.sender, amount);
    }
    ...
    function MetaNet(address account, uint256 amount) internal virtual {
...
contract MetaNet is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("MetaNet", "MNET") {
        MetaNet(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}