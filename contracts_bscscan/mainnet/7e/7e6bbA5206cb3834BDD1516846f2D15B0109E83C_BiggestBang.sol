...
Daddy Elon has blessed us with the Biggest Bang Theory! Starting as Stealth, Ending with much BANG!

6% liquidity
3% reflection
2% marketing

Sweet and Simple cause thats what makes the biggest Bang!

TG: https://t.me/officialbiggestbang
...
contract BiggestBang is Context, IERC20, Ownable {
    ...
    address payable private _bangAddress = 0x9787c1A74BEd453401C42Ab2c27381413F369d65;
    ...
    string private _name = "Biggest Bang";
    ...
    event DonateToBang(uint256 bnbDonated);
    ...
    constructor () public {
        ...
        _isExcludedFromFee[_bangAddress] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // 1/2 balance is sent to the bang wallet, 1/2 is added to the liquidity pool
        uint256 bangTokenBalance = contractTokenBalance.div(2);
        uint256 liquidityTokenBalance = contractTokenBalance.sub(bangTokenBalance);
        ...
        uint256 tokensToSwapToBNB = tokenBalanceToLiquifyAsBNB.add(bangTokenBalance);
        ...
        // The remaining BNB balance is to be donated to the bang wallet
        uint256 bangBNBToDonate = bnbSwapped.sub(bnbToLiquify);

        // Transfer the BNB to the bang wallet
        _bangAddress.transfer(bangBNBToDonate);
        emit DonateToBang(bangBNBToDonate);
    }
