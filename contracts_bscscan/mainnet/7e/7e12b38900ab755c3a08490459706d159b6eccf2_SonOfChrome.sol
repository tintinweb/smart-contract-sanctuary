...
contract SonOfChrome is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "SonOfChrome";
    ...
    uint256 public _maxTxAmount = 1 * 10000**9;
