...
contract TheReviveDividendTracker is IDividendDistributor {
    ...
    uint256 public minDistribution = 50000000 * (10 ** 9); // 0.05 XLM minimum auto send  
...
contract TheRevive is Ownable, IBEP20, SafeToken {
    using SafeMath for uint256;
    ...
    string _name = "TheRevive";
    string _symbol = "Revive";
    ...
    address public liquidity = address(0xe666dCfa0dD956874A83d1Ca013b1Eeb20fAAD22);
    address public buyback = address(0xe666dCfa0dD956874A83d1Ca013b1Eeb20fAAD22);

    IDEXRouter public router;
    address pair;

    TheReviveDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new TheReviveDividendTracker();
    ...
    string freeTax = "";
    uint256 sellingFeeHappyHour = 56;
