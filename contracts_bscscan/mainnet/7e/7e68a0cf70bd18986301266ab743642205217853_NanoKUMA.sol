...
contract NanoKUMA is IBEP20 {
  
    // common Wallets
    address private owner;
    address private KUMA;
    ...
    string public override name = "Nano KUMA";
    string public override symbol = "NanoKUMA";
    ...
    constructor(uint totalSupplyValue, address KUMAAddress, address WETHAddress, address RebaseAddress) {
        // set total supply
        ...
        balances[KUMA] =  totalSupply * 5 / 100;
