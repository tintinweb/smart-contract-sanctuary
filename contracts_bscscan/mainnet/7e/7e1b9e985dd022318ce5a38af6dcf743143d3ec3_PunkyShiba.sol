...
// CHANGE
contract PunkyShiba is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Punky Shiba";
    string constant _symbol = "Punky Shiba";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x24779106fa0a910aFD4f0fe4a41860e4100b5B7B);
