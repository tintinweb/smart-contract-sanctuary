...
contract CryptoDogsBEP20 is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner) {
        ...
        unlocked[address(_FeeAddress)] = true; 
        unlocked[address(tokenOwner)] = true; 
        
        emit Transfer(address(0),tokenOwner, _tTotal);
    }
    
    uint256 public _maxTxAmount = 10000000 * 10**9 * 10**9; // Max Transaction: 1 Trillion (0.1%)
    uint256 public _maxWalletToken = 80000000 * 10**9 * 10**9; // Max Wallet: 8 Trillion (0.8%)
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(locked && unlocked[sender] != true && unlocked[recipient] != true)
            revert("Transfers are locked until after Airdrop.");
