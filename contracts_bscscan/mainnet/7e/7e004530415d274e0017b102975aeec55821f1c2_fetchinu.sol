...
/*
$FINU BEP-20 TOKEN LAUNCH! 
We taught our dog how to play fetch.Tennis ball
The first 3D skill-based to play fetch game inspired, 
built and owned by communities.

💰 fetchinu Token
💰 $FINU
💰 BEP-20
💣20% Burn
💣20% LOCK Legion Vesting Network (Audit KYC)
💣20% LOCK DxSale App For Game project
💣20% LOCK Dxsale For Presale V2
💣10% Drop To Winners Throw Twitter

🔐RenounceOwnerShip  🔐Liquidty Tokens LOCK

https://twitter.com/FetchInu
https://www.fetchinu.com/
...
contract fetchinu  is Context, NFTGAME, Ownable {
