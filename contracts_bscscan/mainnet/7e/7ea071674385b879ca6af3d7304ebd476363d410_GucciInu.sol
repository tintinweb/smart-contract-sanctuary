...
/* Token contract */
contract GucciInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x81754188901b06A54C64c669DdCEAd620D0a3836;
    ...
    // Name and symbol
    string constant _name = "Gucci Inu";
    ...
    uint256 buybackFeeSell = 4;
    uint256 reflectionFeeSell = 0;
    uint256 marketingFeeSell = 7;
    uint256 devFeeSell = 3;
    uint256 totalFeeSell = 16;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4df60578caA52C5892B99c8db2bF650602352E91;
