 ...
 *Submitted for verification at BscScan.com on 2021-08-22
*/
//Puplished by https://t.me/babymoonpotsCH;


/*

Contract by BabyMoonpots and Team - built on others previous work w/ a splash of DevTeamSix magic...
...
contract BabyMoonpots is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0x000000000000000000000000000000000000dEaD); 
    ...
    uint256 private _tTotal = 1000000000 * 10**11 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baby Moonpots";
    string private _symbol = "Baby Moonpots";
    ...
    uint256 public _maxTxAmount = 3000000 * 10**11 * 10**9;
    uint256 private minimumTokensBeforeSwap = 200000 * 10**11 * 10**9; 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1000000000 * 10**11 * 10**9;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 10;
        _maxTxAmount = 200000000 * 10**11 * 10**9;
    }
