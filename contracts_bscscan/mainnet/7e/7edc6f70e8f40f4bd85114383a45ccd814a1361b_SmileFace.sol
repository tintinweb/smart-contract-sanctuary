...
contract SmileFace is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1078792711e680De50D611aD93d67A81F5Ea5003); // Marketing Address
    ...
    string private _name = "Smile Face";
    string private _symbol = "S-FACE";
