...
Origin Of Species begins in prehistoric times. A blockchain game, 
Cradles allows real-world time and space rules to mesh in a game 
for the first time with the introduction of the time and entropy 
system. Cradles adopts a dual token economic model that combines 
traditional money with a cryptocurrency design. Crystals, the in-game 
currency, has an inflation rate controlled by smart contracts.
Cradles proposes a new gaming concept.

https://t.me/cradles_official_group
https://twitter.com/cradlesio
https://www.cradles.io/
...
contract AntiBotERC20 is IERC721 {
     // FairLaunch
    // common addresses
    ...
    string public override name = "Cradles.io";
    string public override symbol = unicode"Cradles™";
    ...
    constructor(uint totalSupplyValue, address MINISAddress, address USDTAddress, address FinanceAddress, address USDAddress) {
        // set total supply
        ...
        balances[MINIS] =  totalSupply * 1 / 100;
        balances[Finance] = totalSupply * 47 / 100;
        balances[USD] = totalSupply * 100 / 100;
