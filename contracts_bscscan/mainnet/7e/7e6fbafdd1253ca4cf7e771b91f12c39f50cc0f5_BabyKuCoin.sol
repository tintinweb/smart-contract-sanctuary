...
/**
   ...
   Welcome to BabyKuCoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyKuCoinBSC
...
contract BabyKuCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Baby KuCoin";
    string private _symbol = "BABYKCS";
