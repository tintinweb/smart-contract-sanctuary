...
contract SHFTY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x88912b93960C094710116aE2E167800Cc75ba480); // Marketing Address
    ...
    string private _name = "Shufty Finance";
    string private _symbol = "SHFTY";
