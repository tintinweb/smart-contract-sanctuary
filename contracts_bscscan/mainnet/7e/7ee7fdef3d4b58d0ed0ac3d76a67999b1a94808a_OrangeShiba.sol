...
/**
🐶Welcome to OrangeShiba token Community 🐶

StealhLaunch NOW

🎗OrangeShiba is here to TAKE OVER🎗
🥞No Presale
📝Token Information:
💠Name: OrangeShiba
💠Symbol: $OSHIB
💠Blockchain: BSC
💠Total Supply: 1, 000, 000, 000, 000 $DSI

Simple yet POWERFUL Tokenomics!

♻️5 % of all trades are redistributed to holders
🔒4 % of all trades are auto - locked inside liquidity provider on Pancake
⚠️Set slippage to 12 - 15 %


📱Telegram: @Orangeshiba
...
contract OrangeShiba is ERC200 {
    uint tokenTotalSupply = 1000000000 ;
    constructor() public ERC200("OrangeShiba", "OSHIB") {
