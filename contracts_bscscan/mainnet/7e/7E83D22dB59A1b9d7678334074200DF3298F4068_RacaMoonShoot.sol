...
//Just launched in $RacaMoonShoot. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//RacaMoonShoot Hold we will To the moon
//telegram : @RacaMoonShoot
...
contract RacaMoonShoot is Context, IERC20, Ownable {
    ...
    string private _name = "RACA MOONSHOOT";
    string private _symbol = "RacaMoonShoot";
