...
///
//    Great Features:
//     Total supply 500 $FairBurner's, decreasing 6% every transaction, the strong holder will get a valuable reward
//
///
...
contract FAIRBURNER is Context, IERC20, Ownable {
    ...
    string private constant _name = 'FairBurner';
    string private constant _symbol = 'FAIRBURNER';
