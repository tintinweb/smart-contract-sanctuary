...
/////
//    $CakePredator Stealth Launch
//
//  Total supply 500 $CakePredator's, decreasing 6% every transaction,
...
contract CAKEPREDATOR is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Cake Predator';
    string private constant _symbol = 'CPREDATOR';
