...
contract RandomTicket is VRFConsumerBase, Ownable  {
    ...
    function getRandomNumber() public returns (bytes32 requestId) {
        require(msg.sender == _slaveAddr, 'Your are not the slave');
    ...
    function setSlaveAddr(address slaveAddr) public onlyOwner {
