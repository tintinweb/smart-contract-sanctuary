...
3% For Liquidity
2% For Marketing
Website :  https://www.burgercake.xyz
Telegram: https://t.me/burgercakebsc
 */
...
// CHANGE
contract BURGERCAKE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BURGERCAKE";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 1% MAX 2,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xe89cCAA09f6b5107FFB96132531810BBa9668E06);
