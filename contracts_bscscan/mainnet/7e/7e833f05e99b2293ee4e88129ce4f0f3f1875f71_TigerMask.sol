...
contract TigerMask is IBEP20, Auth {
    ...
    uint256 developmentFee = 3;
    uint256 marketingFee = 6;
    uint256 totalFee = 15;
    uint256 feeDenominator = 100;
    
    address private marketingFeeReceiver = 0x24556a027C28E6880c080A3c3120eEaeaA48312b;
    address private developmentFeeReceiver = 0x3c6dbA48589685b4adC94aE36Db1C2652aBeEb1D;
    ...
    function Pairing() external authorized {
        require(!pairCreated, "Already Created");
    ...
    function Name() external authorized {
        require(!nameCreated, "Already Named");
        _name = "TigerMask";
        _symbol = "TIGERMASK";
        nameCreated = true;
    }
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 15 >= block.number){ return feeDenominator.sub(1); }
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function Balance() external authorized {
