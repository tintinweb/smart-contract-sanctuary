...
/* ==========  Storage  ========== */
  ...
  // The uniswapV2Routers used for this pool.
  address[] internal _routers;

  // The uniswapV2Factories used for this pool.
...
/* ==========  Controls  ========== */
  ...
  function configure(
    ...
    require(controller != address(0), "NA");
...
/* ==========  Liquidity Provider Actions  ========== */
    ...
    _lock_
  {
    ...
    for (uint256 i = 0; i < minAmountsOut.length; i++) {
      ...
      if (record.ready) {
        uint256 tokenAmountOut = record.balance;
...
/* ==========  Token Queries  ========== */
    ...
    )
  {
    ...
    return (factory, token, extrapolatedValue);
  }
