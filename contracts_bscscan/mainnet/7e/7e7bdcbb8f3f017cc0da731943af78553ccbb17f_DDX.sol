...
contract DDX is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function BurnOut(uint256 amount) public onlyOwner virtual returns (bool) {
    ...
    function _BurnOut(address account, uint256 amount) internal virtual {
