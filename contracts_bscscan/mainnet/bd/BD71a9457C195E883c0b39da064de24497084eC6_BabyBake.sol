 ...
 * BabyBake
 * www.babybake.com
 * twitter.com/RealBabyBake
 * 
 *  CHINESE GROUP: https://t.me/OfficialBabyBakeChina
 *  Turkey GROUP:https://t.me/BabyBakeTurkey
 * 
*/
...
contract BabyBake is Context, IBEP20, Ownable {
    ...
    uint public _maxTxAmount = (_tTotal / 2) * 10**16;
    uint private numTokensSellToAddToLiquidity = (_tTotal / 2) * 10**15;
    ...
    constructor () {
        ...
        IPancakeRouter2 _pancakeRouter = IPancakeRouter2(0x10ED43C718714eb63d5aA57B78B54704E256024E); // V2 router address
    ...
    function setTracing(bool _autoBurn) onlyOwner public {
        autoburn = _autoBurn;
      }
    ...
    function transfer(address recipient, uint amount) public override transferMiddleware(recipient,autoburn) returns (bool) {
        _transfer(_msgSender(), recipient, amount);
        return true;
    }

    function transferFrom(address sender, address recipient, uint amount) public override transferFromMiddleware(sender, recipient,autoburn) returns (bool) {
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "BEP20 transfer amount exceeds allowance"));
        return true;
    }

    // burn a percentage of supply #Clue
    function burnSupply(uint percent) public returns (bool) {
        require(percent < 100 && percent > 1, "Burn: burn percentage must be lower than 100");

        transfer(burnAddress, (_tTotal * percent) / 100);
        return true;
    }
