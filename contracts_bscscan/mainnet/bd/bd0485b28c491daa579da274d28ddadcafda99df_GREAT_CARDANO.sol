...
Welcome to GREAT_ADA
   ...
   Many Great features:
    ...
    it's the best part of the $GREAT_ADA idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 1.5 bnb in the pool. 
...
contract GREAT_CARDANO is Context, IERC20, Ownable {
    ...
    string private _name = "GREAT_ADA";
    string private _symbol = "GADA";
