...
contract LuckyPigV2 is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'LuckyPig';
    string private constant _symbol = 'LPGV2';
    uint8 private constant _decimals = 9;
    uint public constant InitialSupply= 10**10 * 10**_decimals;//equals 10.000.000.000 Token
