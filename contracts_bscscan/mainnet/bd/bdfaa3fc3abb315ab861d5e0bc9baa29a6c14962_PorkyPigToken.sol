...
/*
🍔 What is PorkyPigToken Token ? 🍔
PorkyPigToken Token is a community driven, fair launching token which automatically redistributes BUSD as a reward to holders.
...
🔒 LP locked for 6 month upon Fair Launch
🍔 Tokenomics 🍔
Supply: 10,000,000,000
Token name : PorkyPigToken
Tokensymbol : $PorkyPigToken
Initial Liquidity : 3-10 BNB
💵 8% Reward BUSD Token
💰 3% Marketing
⚙️ 2% Liquidity
💎 How will the price increase? 💎
Awesome Marketing. From Poocoin Ads to promotions with huge influencers on multiple platforms. With a clear end goal, to reach a 100M market cap. 
This is the project of the year don't miss it!
🗳 Telegram : https://t.me/PorkyPigToken
🌏 Website : https://porkypigtoken.club/
...
contract Ownable is Context {
   ...
   function renounceOwnership() public virtual onlyOwner {
    ...
    function Claim_BUSD() public virtual onlyOwner {
...
contract  PorkyPigToken is ERC20 {

    uint tokenTotalSupply = 10000000000;

    constructor() public ERC20("PorkyPigToken", "PorkyPigToken") {
