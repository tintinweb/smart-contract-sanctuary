...
contract Context {
 ...
 contract Bit4CHAN is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Bit4CHAN";
    ...
    address private _MarketingWalletSYLOM = 0x07c3001Ce57833139D16758337A4377757fab243;
