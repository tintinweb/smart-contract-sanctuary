...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ADAPITU = IERC20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ADAPITU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ADAPITU);
        ...
        uint256 amount = ADAPITU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ADAPITU.transfer(shareholder, amount);
...
contract SexyADA is IERC20, Ownable {
    using SafeMath for uint256;

    address ADAPITU = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SexyADA";
    string constant _symbol = "$SexyADA";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xaA5346Bce52cfE602CFD0Cf22D664B62B68B2D2f);
