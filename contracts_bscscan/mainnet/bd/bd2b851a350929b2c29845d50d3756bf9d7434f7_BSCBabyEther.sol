...
// BSCBabyEther @ https://t.me/BSCBabyEther
...
// File: contracts/BSCBabyEtherDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
...
// File: contracts/BSCBabyEther.sol
...
contract BSCBabyEther is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    address private _marketingWallet = address(0x1AceB4e9F87d1aEF156458b1730a384bD1E1Ba86);
    // address private _devWallet = address(0x1AceB4e9F87d1aEF156458b1730a384bD1E1Ba86);

    bool private swapping;
    bool public airdrop;

    BSCBabyEtherDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;
    // address public devWallet = _devWallet;

    uint256 public maxBuyTranscationAmount = 10 * (10**18); // 1% of total supply
    uint256 public maxSellTransactionAmount = 10 * (10**18); // 1% of total supply
    uint256 public swapTokensAtAmount = 5 * (10**18);
    uint256 public _maxWalletToken = 1000 * (10**18); // No limit
    ...
    constructor() public ERC20("BSCBabyEther", "BSCBabyEther") {
    	...
    	dividendTracker = new BSCBabyEtherDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BSCBabyEther: The dividend tracker already has that address");

        BSCBabyEtherDividendTracker newDividendTracker = BSCBabyEtherDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BSCBabyEther: The new dividend tracker must be owned by the BSCBabyEther token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BSCBabyEther: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BSCBabyEther: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BSCBabyEther: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BSCBabyEther: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BSCBabyEther: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BSCBabyEther: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BSCBabyEtherBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "BSCBabyEther: This account cannot send tokens until trading is enabled");
        }
...
contract BSCBabyEtherDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BSCBabyEther_Dividend_Tracker", "BSCBabyEther_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "BSCBabyEther_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BSCBabyEther_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BSCBabyEther contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BSCBabyEther_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BSCBabyEther_Dividend_Tracker: Cannot update claimWait to same value");
