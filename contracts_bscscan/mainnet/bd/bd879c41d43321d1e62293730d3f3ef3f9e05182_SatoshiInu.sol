...
🔥Satoshi Inu is a community-built token with the goal of becoming one of the few
meme decentralized tokens with a true utility. Our mission does not only include
helping in the growth and adoption of Cryptocurrency’s but also providing a
place where dog owners can purchase the products they want for their precious
pups with an online pet accessories and merch store🔥

—— 📊Takenomics 📊——

🐶SATSINU Token has 13% Taxes on all Buys and Sells .
⚡️4% Auto Liquidity Pool
⚡️ 4% Rewards to holders in the form of bep20 BTC
⚡️ 5% Split between marketing/P2E game rewards & Charity

✅ Total supply - 100,000,000,000
✅79% will be burned before launch to reduce the total supply to 21,000,000,000 tokens.
✅20% will be for the launch liquidity and we be the new total supply
✅1% will be in the split wallet.

——📱Social networks 📱 ——

📢 TG: https://t.me/Satoshi_inu
💻 Website: https://www.satoshi-inu.net/
*/
...
contract SatoshiInu is ERC20, Ownable {
    ...
    constructor() ERC20("Satoshi Inu", "SATSINU")  {
