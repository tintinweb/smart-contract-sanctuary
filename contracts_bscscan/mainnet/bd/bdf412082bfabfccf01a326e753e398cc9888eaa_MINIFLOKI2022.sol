...
// CHANGE
contract MINIFLOKI2022 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _maxWalletSize = (_totalSupply * 20) / 100; // 20% Max 200,000,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x11D7c1c231125021a6d329433A7591b9B537612B);
