...
contract MossCoinBEP20 {
	using SafeMath for uint;

	// Constants
	string public constant name = "Moss Coin";
	string public constant symbol = "MOSS";
	...
	// NOTE: Burning by sending to 0x00 is not possible with many ERC20 implementations, but this one is made specifically for the old HEZ
