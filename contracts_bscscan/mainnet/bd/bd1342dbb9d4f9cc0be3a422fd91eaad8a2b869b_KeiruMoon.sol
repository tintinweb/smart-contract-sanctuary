...
🐯 Hello and Welcome to the most ambitious KeiruMoon project represent the strongest nation in the world. 

KeiruMoon aims to represent Japan to the entire world. And what better way to do that than to introduce. 

💰Are you willing to put in the sweat and be rewarded? KeiruMoon needs you!
...
✈️ Telegram: https://t.me/KeiruMoonChat
🌐 Twitter: https://twitter.com/KeiruMoonOffice
...
contract KeiruMoon is Context, IERC20, Ownable {
    ...
    string private _name = "KeiruMoon";
    string private _symbol = "KeiruMoon";
