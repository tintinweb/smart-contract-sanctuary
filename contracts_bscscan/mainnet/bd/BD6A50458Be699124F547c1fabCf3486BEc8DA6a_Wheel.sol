...
contract Wheel is Context, Ownable {
    ...
    function terminateGame(uint pool_id, uint random) private{
        ...
        game.playedCount = pool.playedCount;
        game.pool_name = pool.name;
    ...
    function getGameById(bytes32 pool_name, uint256 id) external view returns(Game memory){
        return games[pool_name][id];
    }
