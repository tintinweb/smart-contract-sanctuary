 ...
 *The newest Floki on the BSC Platform , Come and Grab your $ETH rewards while holding $FLOKIPUFF
 *Inspired by Elon's new pup floki we ride the hype and make a new token that will reward you $ETH while holding our token. Not a meme token but a utility token

  Telegram: https://t.me/FlokiPuff
  Twitter : https://twitter.com/FlokiPuff
...
contract $FLOKIPUFF is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiPuff";
    string constant _symbol = "$FlokiPuff";
