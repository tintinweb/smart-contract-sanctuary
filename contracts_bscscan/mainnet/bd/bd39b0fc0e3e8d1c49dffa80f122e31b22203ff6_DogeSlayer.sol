...
WELCOME TO DOGE SLAYER GUYS, the token based on the most loved doggo, shiba and the best game of the decade DOOM MOTHERFUCKER
We are going to pump this to the moon guys don't worry, marketing is ready

tg : https://t.me/DogeSlayerBSC
website: https://www.dogeslayer.net/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0Ba43A67A897801B3C6AF53b092BA520A0890846;
...
contract DogeSlayer is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0xa568703e5664cca183Fe8640C994236d532b6dCA);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Doge Slayer";
    ...
    //max wallet holding 30000000 * 10**6 * 10**9 is 3% of 1000000000 * 10**6 * 10**9 (total supply)
    uint256 public _maxWalletToken = 30000000 * 10**6 * 10**9;
    ...
    //this is the maximum transaction amount (in tokens) at launch this is set to 3% of total supply
    ...
    //amount (in tokens) at launch set to 0.05% of total supply
    uint256 public _numTokensSellToAddToLiquidity = 500000 * 10**6 * 10**9;
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0xa568703e5664cca183Fe8640C994236d532b6dCA)] = true;
