...
abstract contract BEP20 is Context, IBEP20, IBEP20Metadata, Ownable, Pausable {
    ...
    string private constant _name = "Polkadog-V2.0";
    string private constant _symbol = "EINSTEIN";
    uint8 private constant _decimals = 18;
    uint256 private _totalSupply;
    
    uint256 public liquidityFeePercentage = 3;
    uint256 public transactionBurnPercentage = 2;
    uint256 public maxTxLimit = 50000 * 10**18;
...
contract Polkadog is BEP20Capped {
    uint256 private constant _initialSupply = 400000000 * 10**18;
    uint256 private _cap = 400000000 * 10**18;
