...
// Off brand token is like a name brand token, but cheaper. 
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract Offbrand is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x49f644C0bEa5defb3aadD2Fab54bfB134d6B2AE7); // Marketing Address
    ...
    uint256 private _tTotal = 4200000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Offbrand Token";
