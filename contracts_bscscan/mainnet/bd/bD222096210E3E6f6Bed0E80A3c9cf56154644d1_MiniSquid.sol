...
contract MiniSquid is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x05d85d9ea8c4cA6fAf8Ea097d7713fe775559150); // Marketing Address
    ...
    string private _name = "MiniSquid";
    string private _symbol = "MiniSquid";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // 2/3 balance is sent to the marketing wallet, 1/3 is added to the liquidity pool
        ...
        uint256 bnbToLiquify = bnbSwapped.div(4);
        ...
        marketingAddress.transfer(marketingBNBToDonate);
