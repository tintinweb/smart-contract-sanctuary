 ...
 * 
 ...
 average and that funds the buy back wallet, then those tokens get burned! FIRST EVER TOKENOMICS from evergive of 
  and the FOMO will never be so real! So don’t miss out and join the telegram!! Solving the 
...
/* xposed is a fork of SafeMoon that has been edited to support the children-focused
...
contract Xposedtest is Context, IERC20, IERC20Extented, Ownable {
  ...
  address payable public _feeWallet = payable(0x27a89fEee4f41AED46D790FB5ce731F4D5fEb1ec);
  ...
  /* Variables _tTotal, _name, _symbol, _decimals, and numTokensSellToAddToLiquidity
     ...
     audit of Safemoon.
  */
  uint256 private constant MAX = 17000000 * 10**9;
  uint256 private constant _tTotal = 17000000 * 10**9;
  uint256 private _rTotal = (MAX - (MAX % _tTotal));
  uint256 private _tFeeTotal;
  
  string public _name = "XposedTEST";
  string public _symbol = "xPSDt";
  ...
  uint256 public _dipRewardFee = 2;
  ...
  uint256 public maxWallet = 800000 * 10**9;
  uint256 public _whalePenaltyAmount = 10000000 * 10**9; // 75% of maxWallet
    
  uint256 private buyBackUpperLimit = 17000 * 10**9;
