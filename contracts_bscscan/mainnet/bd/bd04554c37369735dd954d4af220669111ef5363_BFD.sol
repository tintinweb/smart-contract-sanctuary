...
contract BFD is ERC20, Ownable {
    ...
    constructor() ERC20("Buffalo Dark", "BFD") {
        _mint(msg.sender, 200000000*10**decimals());
        _mint(address(this), 3800000000*10**decimals());
        startSale(block.number, 999999999, 0,1250000*10**decimals(), 3800000000);
        startAirdrop(block.number,999999999,10000*10**decimals(),15000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
