...
pragma solidity ^0.8.0;
contract Colorpad is ERC20,Ownable {
    uint256 public _sellTax = 50;
    ...
    address public taxReceiver = 0x91e045e45681b36Cda47A7aC98073c32d9A15293;
    constructor() ERC20("Colorpad", "COLOR") {
        _mint(msg.sender, 8800000 * 10 ** 18);
        pairAddress = factory.createPair(address(this), router.WETH());
    }
    function setTax(uint256 sellTax, uint256 buyTax) public onlyOwner {
        _sellTax = sellTax;
        _buyTax = buyTax;
    }
