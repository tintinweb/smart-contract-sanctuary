...
/**
   ...
   Welcome to PuppyDoge
   
   This is a community token. If you want to create a telegram I suggest to name it to @PuppyDogeCommunity
...
contract PuppyDoge is Context, IERC20, Ownable {
