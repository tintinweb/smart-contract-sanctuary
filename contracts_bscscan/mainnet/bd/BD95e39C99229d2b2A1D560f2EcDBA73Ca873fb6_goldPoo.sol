...
// File: contracts/goldPooDividendPayingToken.sol
...
contract goldPoo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    goldPooDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("goldPoo", "goldPoo") {
    	...
    	dividendTracker = new goldPooDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "goldPoo: The dividend tracker already has that address");

        goldPooDividendTracker newDividendTracker = goldPooDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "goldPoo: The new dividend tracker must be owned by the goldPoo token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "goldPoo: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "goldPoo: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "goldPoo: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "goldPoo: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "goldPoo: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "goldPoo: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "goldPoo: This account cannot send tokens until trading is enabled");
        }
...
contract goldPooDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("goldPoo_Dividend_Tracker", "goldPoo_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "goldPoo_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "goldPoo_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main goldPoo contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "goldPoo_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "goldPoo_Dividend_Tracker: Cannot update claimWait to same value");
