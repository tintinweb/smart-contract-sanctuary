...
contract MiniDoge2022 is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xab851Df113E60B1602c9a4Aa21ee83AE557C8dea;
    address DevWallet       = 0x4CE471ddf977c5b037099862fACd16d493DE7869;
    address BuyBackWallet   = 0x6dc3257a2074c84CecAF35f19eD926A9b7968492;

    string constant _name = "MiniDoge2022";
    string constant _symbol = "MD22";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee).div(10).mul(7);
        uint256 amountBNBBuyback = amountBNB.mul(buybackFee).div(totalBNBFee).div(10).mul(7);
