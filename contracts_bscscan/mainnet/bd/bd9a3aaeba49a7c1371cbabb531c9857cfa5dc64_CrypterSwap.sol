...
/**
 * BNB Sent to this contract will be used to automatically buy Crypter and send it back to the sender
 */
contract CrypterSwap is Context, Ownable {
  ...
  address public _crypterAddr = 0xDa6802BbEC06Ab447A68294A63DE47eD4506ACAA;
  
  function swapForCrypter(address sender, uint256 value) internal {
  ...
  function setCrypterAddress(address nCRYPTAddr) public onlyOwner {
      _crypterAddr = nCRYPTAddr;
  }
