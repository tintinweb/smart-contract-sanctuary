...
contract metarcane is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0xd5B772AA0Fa5f5bB214C0A538fA0450518557Ef6;

    string constant _name = "Metarcane";
    string constant _symbol = "METEAR";
