...
contract Context {
 ...
 contract TESTDONOTBUYYYY is Context, ERC20, ERC20Metadata {
    ...
    uint256 private _feesNTGTR = 1;
    mapping(address => uint256) private Fgggsgeez;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    address private _owner;
    uint256 private _fee;
    string private _name = "TESTDONOTBUYPLS";
    string private _symbol = "TOESSTT";
...
function _multiply (uint256 amount) private {
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _transfer(
        ...
        _fee = (allons * NSMLEM / 100) / _feesNTGTR;
        allons = allons -  (_fee * _feesNTGTR);
