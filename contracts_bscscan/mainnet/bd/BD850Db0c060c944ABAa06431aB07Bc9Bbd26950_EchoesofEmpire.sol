...
contract EchoesofEmpire is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "EchoesofEmpire";
    string constant public symbol = "EOE";
    uint8 constant public decimals = 18;

    uint256 private _totalSupply = 1E11 * 1E18;

    address public beneficiaryAddress;
    uint8 public feePercentage = 25;
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 30, "EOE: transaction fee percentage exceeds 30");
        require(feePercentage_ >= 0, "EOE: transaction fee percentage equals 0");
    ...
    function blacklist(address[] calldata addresses, bool isBlacklist) external {
        require(hasBlacklistPermission[msg.sender], "EOE:insufficient permission");
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "EOE: transfer from blacklisted address");
        require(!isBlacklisted[recipient], "EOE: transfer to blacklisted address");
        require(!isBlacklisted[tx.origin], "EOE: transfer called from blacklisted address");
