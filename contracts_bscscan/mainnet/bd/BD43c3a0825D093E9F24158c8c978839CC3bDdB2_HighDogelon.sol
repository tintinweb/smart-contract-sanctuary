 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/HighDogelon
 * 
 * 
 * HighDogelon token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract HighDogelon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HighDogelon";
    string constant _symbol = "HDOGELON";
