...
contract Mammoth is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6269B0fAa7690F0de9cA5B9DCDd291AD430FAD2a); // Marketing Address
    address payable public charityAddress = payable(0x6269B0fAa7690F0de9cA5B9DCDd291AD430FAD2a); // Charity/Dev Address
    ...
    string private _name = "Mammoth Token"; // nice
    string private _symbol = "MAMM";
