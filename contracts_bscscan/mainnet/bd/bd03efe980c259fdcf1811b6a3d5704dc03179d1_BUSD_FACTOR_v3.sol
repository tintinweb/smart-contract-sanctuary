...
contract BUSD_FACTOR_v3 {
    ...
    uint256 public constant WALLET_LIMIT = 100000 ether;
    ...
    function invest(address referrer, uint8 plan, uint256 _amount) public payable {
      ...
      require(totalDeposits < WALLET_LIMIT, "Wallet limit reached (100,000 BUSD)");
      ...
      token.transfer(assocWallet, assocFee);
