...
contract CatFish is IBEP20, Auth {
    ...
    string constant _name = "CatFish";
    string constant _symbol = "CFH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 9) / 100;  //9% max wallet
    ...
    address private marketingFeeReceiver = 0xE811c092EdD5EBbdE0FE1C2a59F35ae6FA4640C1;
    address private buybackFeeReceiver = 0xE811c092EdD5EBbdE0FE1C2a59F35ae6FA4640C1;
