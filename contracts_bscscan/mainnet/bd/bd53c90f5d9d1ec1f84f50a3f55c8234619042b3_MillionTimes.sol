...
// Begin sauce.
contract MillionTimes is Context, IERC20, Ownable {
    ...
    string private  _name               = "MILLIONTIMES";
    ...
    address payable public _wallet_marketing = payable(0x0c5e1Ad20DEAeD64c38a782bF98f7cd7dF2678C7);

    // for burn
    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0x347250ACDC71d73c81C45c7C0b6706e85001047c);

    // for buyback
    uint256 public _fee_buyback = 0;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0x4504694617Db4Ba289cf36b95B914C72e4777D72);
