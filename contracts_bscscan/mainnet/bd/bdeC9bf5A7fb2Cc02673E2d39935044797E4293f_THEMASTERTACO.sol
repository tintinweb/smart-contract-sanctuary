...
interface IDividendDistributor {
    ...
    function CurrentRewards() external view;
    function PreviousRewards() external view;
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public prevrewards = address(PREVRWDS);
    ...
    function CurrentRewards() external view override {
        rewards; 
    }
    
    function PreviousRewards() external view override {
        prevrewards; 
    }
}
...
contract THEMASTERTACO is IBEP20, Auth {
    ...
    function CurrentRewards() public view{
        distributor.CurrentRewards;
    }

    function PreviousRewards() public view {
