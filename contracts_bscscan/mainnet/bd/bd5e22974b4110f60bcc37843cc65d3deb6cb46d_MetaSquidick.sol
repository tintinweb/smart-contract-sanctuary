...
MetaSquidick stealth launch between friends 

@MetaSquidick be patient
...
contract MetaSquidick is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaSquidick";
    string constant _symbol = "MSD";
