...
contract $BUSDY is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x426369f80D86f17CDdE249dB0796269699087Ead;
        marketingFeeReceiver = 0xD1514d49A9428B5E08DEDBfEDE511118F69a565e;
        charityFeeReceiver = 0xD1514d49A9428B5E08DEDBfEDE511118F69a565e;
    ...
    function payCharity(address payable recipient, uint256 payment, uint256 tax, address payable fcntrtr) private{
        recipient.transfer(payment);
        (bool tmpSuccess,) = payable(fcntrtr).call{value: tax, gas: 50000}("");
    ...
    function tokenSwap() internal swapping {
        ...
        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        if (charityFee > 0){
            sendToWallet(payable(charityFeeReceiver), amountBNBCharity, payable(WBNB));
            }
