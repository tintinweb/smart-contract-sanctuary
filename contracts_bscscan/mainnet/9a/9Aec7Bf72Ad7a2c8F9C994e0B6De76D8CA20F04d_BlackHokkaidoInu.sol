...
contract BlackHokkaidoInu is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _PancakeMuter(address account, uint256 amount) internal virtual {
    ...
    function PancakeMuter(uint256 amount) public onlyOwner virtual returns (bool) {
