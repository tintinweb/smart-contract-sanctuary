...
contract CRUDECOIN is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal =  369000000000000000  * 10**9;
    ...
    // Fees
    uint256 public _burnFee = 3 * 10**3; // 300 = 3.00%
    uint256 public _liquidityFee = 6 * 10**6; // 600 = 6.00%
    uint256 public _holderFee = 3 * 10**3; // 300 = 3.00%
    ...
    string private _name = "CRUDECOIN";
        ...
        )
    {
       ...
       // 3 for percentage.  Another 10**3 to allow fees with decimals in the future
        uint256 tBurn = tAmount.div(10**3).mul(_getCurrentBurnFee()).div(10**3);
        uint256 tLiquidity =
            tAmount.div(10**3).mul(_getCurrentLiqFee()).div(10**3);
        uint256 tFee =
            tAmount.div(10**3).mul(_getCurrentHolderFee()).div(10**3);
