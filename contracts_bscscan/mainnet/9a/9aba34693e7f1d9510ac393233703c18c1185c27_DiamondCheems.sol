...
TG: https://t.me/DiamondCheems <<Stealth launch, Do not try to snipe this guys. ;)
...
// CHANGE
contract DiamondCheems is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DiamondCheems";
    string constant _symbol = "$Domgs";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100; // 3% MAX 3,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x02fFC39AF557B5FAf43542Cb9c05f5AA8F984cCF);
