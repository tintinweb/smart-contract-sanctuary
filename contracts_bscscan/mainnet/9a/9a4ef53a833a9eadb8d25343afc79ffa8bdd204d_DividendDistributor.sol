...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //the reward token you want distributed 
...
contract CORNDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CornDoge";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "CORNDOGE";
