...
/**
 * @title BTCB price Oracle
 *      This Oracle calculates the average USD price of BTCB based on the BNB-BTCB and USDC-BNB pools.
...
contract MarketOracleBTC is Ownable {
    ...
    constructor(
        address __btcb_bnb,   // Address of the BTCB-BNB pair on Pancakeswap
    ...
    function getBtcbBnbRate() public view returns (uint256, uint256, uint32, uint256) {
        ...
        FixedPoint.uq112x112 memory btcbBnbAverage = FixedPoint.uq112x112(uint224(1e18 * (price0Cumulative - btcbBnbPrice0CumulativeLast) / (_blockTimestamp - btcbBnbBlockTimestampLast)));
