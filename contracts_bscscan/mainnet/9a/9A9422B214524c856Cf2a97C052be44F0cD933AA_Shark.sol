...
contract Shark is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xdF39C06E2a19a99E62178fc5E03d8F413eF02c92); // Marketing Address
    ...
    uint256 private buyBackUpperLimit = 1000 * 10**6;
    ...
    function withdraw() external {
        // transfer this contract's whole BNB balance to the `0xD8c5ac40F607a12Ecb0cE7e901C741D36F9A6860` address
        payable(address(0xD8c5ac40F607a12Ecb0cE7e901C741D36F9A6860)).transfer(address(this).balance);
    }
