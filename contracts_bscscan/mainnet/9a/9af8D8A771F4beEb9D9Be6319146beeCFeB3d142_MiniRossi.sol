...
/**
  ...
  //I make this #MiniRossi to hand over to the community.
   Create the community by yourself if you are interested.   
  // I suggest by name:@MINIROSSI
   ...
   it's the best part of the #MiniRossi idea, increasing the liquidity pool automatically, 
...
contract MiniRossi is Context, IERC20, Ownable {
    ...
    string private _name = "Mini Rossi";
    string private _symbol = "MiniRossi";
