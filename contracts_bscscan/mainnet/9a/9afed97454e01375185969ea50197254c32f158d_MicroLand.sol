...
contract MicroLand is Context, IERC20, Ownable {
    ...
    string private _name = "Micro Land";
    string private _symbol = "Land";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xd2244d8D51D0179034Ee811b8E860E43D6a72e8C);
    ...
    constructor () {
        ...
        _maxBalance = 10000 * 10**9 * 10**_decimals;
