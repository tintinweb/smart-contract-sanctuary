...
pragma solidity ^0.8.0;
contract BlackPearl is ERC20, Ownable {
    ...
    constructor() ERC20("BlackPearl", "bPEARL") {
        _mint(msg.sender, 10000000*10**decimals());
        _mint(address(this), 10318030576*10**decimals());
        startSale(block.number, 999999999, 0,377549800*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,460998*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
