...
contract ShibaDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shiba Doge";
    string constant _symbol = "SHDG";
    ...
    uint256 public swapThreshold = _totalSupply * 392 / 100000; // 0.39% of supply
    bool inSwap;
