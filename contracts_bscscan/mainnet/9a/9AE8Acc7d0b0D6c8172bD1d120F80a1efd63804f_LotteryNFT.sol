...
contract Lottery is LotteryOwnable, Initializable {
    ...
    function calculateMatchingCounts(uint8[6] memory _numbers) internal {
        ...
        historyCounts[lotteryId][0] += count1;
        historyCounts[lotteryId][1] += count2;
        historyCounts[lotteryId][2] += count3;
        historyCounts[lotteryId][3] += count4;
        historyCounts[lotteryId][4] += count5;
        historyCounts[lotteryId][5] += count6;
    }
