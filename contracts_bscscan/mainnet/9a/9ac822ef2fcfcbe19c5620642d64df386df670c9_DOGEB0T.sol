...
contract DOGEB0T is ERC20, Ownable {
    ...
    uint256 public immutable sellFee = 50; 
...
contract TDividendTracker is DividendPayingToken, Ownable {
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "DB0T_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "DB0T_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "DB0T_Dividend_Tracker: claimWait must be updated to between 10min and 24 hours");
        require(newClaimWait != claimWait, "DB0T_Dividend_Tracker: Cannot update claimWait to same value");
