...
contract BitRon is Context, ERC20, Ownable {
    ...
    // Address that include in bitron LP list
    mapping(address => bool) private _includeInBitRonLpList;
    ...
    string private _name = "BitRon";
    string private _symbol = "BitRon";
    ...
    // Minimum BitRon sell order to trigger buyback
    ...
    constructor () public {
        ...
        _includeInBitRonLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInBitRonLpList(address _address) public view returns (bool) {
        return _includeInBitRonLpList[_address];
    }

    function setIncludeInBitRonLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInBitRonLpList[_address] = _isIncludedOrNot;
    }
    ...
    function _transfer(
        ...
        && from != owner()
            ...
            if (isIncludedInBitRonLpList(to)) {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= MIN_TX_AMOUNT_HARD_CAP, "maxTxAmount have to be greater than 1 bitron");
