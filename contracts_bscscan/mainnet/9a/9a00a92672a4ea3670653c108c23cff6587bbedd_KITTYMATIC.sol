...
▀▀█████▄    ███▌     ███         ███     ▄██   ███      ███   ███   ███ ▀███████████     ███     ███▌ ███        
 ...
 TG: https://t.me/officialkittymatic
 Twitter @kitty_matic
 Website: coming soon
 Hold Kitties earn MATICs
 ...
 THESE ARE COMMUNITY TOKENS! I AM NOT RESPONSIBLE FOR THE MARKETING AT ALL! 
 
 
 
 Total Supply of Tokens: 1,000,000,000 (1 Billion)
 Max Wallet Size = 20,000,000 (20 Million or 2%)
 Max Transaction Size = 20,000,000 (20 Million or 2%)
 
 Reflection/Taxes: 12% in MATIC, 6% in Liquidity, 3% to Developer
 
 Buy Slippage: 21% 

 *** THE MAX A WALLET CAN HAVE IS 20,000,000! THAT IS 2%!

 
 Developer Actions:
	will make a marketing wallet of 5% community based decisions!
	will lock lp in the first 15 min after launch
*/
...
// CHANGE
contract KITTYMATIC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "KITTY MATIC";
    string constant _symbol = "KITTYMATIC";
    ...
    uint256 totalFee = 2100; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x89cA2FCb325AC9A996Eb9f4dA1e26669c6b0679e);
