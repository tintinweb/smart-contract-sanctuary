...
contract sTPD is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked TiPiDao", "sTPD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTPD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTPD
