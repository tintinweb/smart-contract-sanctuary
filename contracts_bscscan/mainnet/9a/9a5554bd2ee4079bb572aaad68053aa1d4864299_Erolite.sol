...
Tokenomics: 3% REWARDS  5% Marketing
...
contract Erolite is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Erolite";
    string constant _symbol = "EROL";
    ...
    uint256 public swapThreshold = _totalSupply / 2000 * 3; // 0.3%
    bool inSwap;
