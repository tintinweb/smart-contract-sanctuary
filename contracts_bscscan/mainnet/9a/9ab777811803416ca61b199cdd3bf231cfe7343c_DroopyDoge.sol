...
/*
    # DroopyDoge
    Total Fees: 15%
    2% fee is added to the DroopyDoge developer wallet as BNB *Note the team will not be selling tokens*
    6% fee is added to the DroopyDoge marketing wallet as BNB *Note the team will not be selling tokens*
...
contract DroopyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "DroopyDoge";
    string private _symbol = "DroopyD";
