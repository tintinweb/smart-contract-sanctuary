...
/* Token contract */
contract SonofGreenChart is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address Buyback = 0x5bD78E9260421Fe41E41f1e1a32Fb36A0039222a;
    ...
    // Name and symbol
    string constant _name = "Son of Green Chart";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 201 ) / 10000; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAbcFe3C7bA1aBDc3AeAaE6b97AF3a4D620fe582F;
