...
contract flokiETH is ERC20, Ownable {
    ...
    address public immutable BUSD = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    address private _marketingWallet = address(0xA47F929f50A1156f29EA5D62FdB8C36B746beeBb);
    // address private _devWallet = address(0x028b567F883f4a54A763b8426cEFdd32545862D2);
    ...
    constructor() public ERC20("flokiETH", "flokiETH") {
