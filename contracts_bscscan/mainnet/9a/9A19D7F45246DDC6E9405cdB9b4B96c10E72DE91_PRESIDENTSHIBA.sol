...
______     _____  _   _  _____ ______   ___  
| ___ \   /  ___|| | | ||_   _|| ___ \ / _ \ 
| |_/ /   \ `--. | |_| |  | |  | |_/ // /_\ \
|  __/     `--. \|  _  |  | |  | ___ \|  _  |
| |     _ /\__/ /| | | | _| |_ | |_/ /| | | |
...
the PRESIDENT SHIBA footprint. The organizations will be voted by the community.

   #BEE
   
   #LIQ+#RFI+#SHIB+#DOGE = #PRESIDENT SHIBA
...
contract PRESIDENTSHIBA is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "PRESIDENT SHIBA";
    string private _symbol = "PRESIDENTSHIBA";
