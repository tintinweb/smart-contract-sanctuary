...
contract OneEyeShiba is Context, IERC20, Ownable {
    ...
    string private _name = 'OneEyeShiba';
    string private _symbol = 'OneYShiba';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 9; // 4% of transactions will be redistributed among holders
