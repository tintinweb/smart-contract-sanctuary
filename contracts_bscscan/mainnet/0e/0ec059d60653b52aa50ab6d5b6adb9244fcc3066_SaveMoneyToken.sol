...
Save money is entering in crypto world to offer all Investors a better platform to analyse Token and Coins so, they can Understand the Risk they are Talking while investing in any Tokens or Coins. 
...
📝Links
🛎Contract Addres : Coming Soon
🚨Telegram : https://t.me/SaveMoneyBSC
*/
...
contract SaveMoneyToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Save Money Token";
