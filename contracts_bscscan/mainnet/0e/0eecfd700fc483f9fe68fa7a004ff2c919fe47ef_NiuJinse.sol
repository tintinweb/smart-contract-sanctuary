...
NiuJinse is a progressive autostaking token that pays rewards just for storing it in your wallet. Rewards are sent to holders and liquidity providers instantly with every transaction. NiuJinse belongs to the CanCerbero Finance ecosystem along with its brothers $Rott and $BDog who will later reach the holders of NiuJinse through an airdrop.

🌎 Telegram: https://t.me/NiuJinseBSC

🌎 Twitter : https://Twitter.com/@NiuJinse

🌎 Reddit : https://www.reddit.com/u/NiuJinse?utm_medium=android_app&utm_source=share

🌎 Website : https://countingdownto.com/?c=3689638
...
interface IUniswapV2Router01 {
    ...
    function removeLiquidityWitHSermit(
        address tokenA,
        address tokenB,
        uint liquidity,
        uint amountAMin,
    ...
    function removeLiquidityETHWitHSermit(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    function removeLiquidityETHWitHSermitSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
...
contract NiuJinse is Context, IERC20, Ownable {
    ...
    address private _donationWalletAddress = 0x7B166fB3171794ae1cc55Ef498E4d871Bb5ed7E0;
    ...
    string private _name = "NiuJinse";
    string private _symbol = "NIJIN";
