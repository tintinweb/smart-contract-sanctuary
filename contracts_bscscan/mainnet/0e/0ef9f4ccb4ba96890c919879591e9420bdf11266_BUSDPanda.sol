 ...
 *                NEXT 100X GEM!
 * 
 * Dividend Token that reward $BUSD every 30 minutes!
...
contract BUSDPanda is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BUSDPanda";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x83C6670189a8c2466F12e6987651404Dad966ACC;
