 ...
 */
abstract contract FAVOPausable is FAVOAuth {
    bool public paused;
...
contract FAVO is IBEP20, FAVOAuth, FAVOPausable {
    using SafeMath for uint256;

    string constant _name = "FAVOFI";
    string constant _symbol = "FAVO";
    ...
    constructor (address _owner, address _router) FAVOAuth(_owner) FAVOPausable(true) {
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountFAVO);
}