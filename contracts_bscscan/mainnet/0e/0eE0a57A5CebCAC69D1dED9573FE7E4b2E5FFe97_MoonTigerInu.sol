...
contract MoonTigerInu
 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xa0f2E7B1D90B6CCe52D3F79Ad2e57f04cFDc0933); // Marketing Address
    address payable public devWalletAddress = payable(0xa0f2E7B1D90B6CCe52D3F79Ad2e57f04cFDc0933); // Dev Address
    ...
    string private _name = "MoonTigerInu";
    string private _symbol = "$MTI";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 500000 * 10**9;
