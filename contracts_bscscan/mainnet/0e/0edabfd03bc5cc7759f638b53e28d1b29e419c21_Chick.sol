...
contract Chick is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1faAA827472842586fdE14d36b8EF5E939979616); // Marketing Address
    address payable public charityAddress = payable(0x1faAA827472842586fdE14d36b8EF5E939979616); // Charity/Dev Address
    ...
    string private _name = "Chick Token";  // nice
    string private _symbol = "CHIC";
    ...
    uint256 public _maxTxAmount = 100000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 750 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 200000000000000000000000; // nice 200,000 (0.01BNB - 10,000,000) 0,00000005 - 0.000025
    ...
    uint256 private salePrice = 1000000000;// 0.01*10,000,000 token for 0.01 bnb (set as per requirements)
