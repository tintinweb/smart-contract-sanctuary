...
TG: https://t.me/koobitBSC
Website:https://koobit.club

KooBit the meme birth from current pandemic brought to you exclusively on BSC.

KooBit is a platform/puzzle game made in various styles of pixel art, ranging from 8bit to 16bit. The ceaseless adventures never stop until Koobit gets vaccinated and triumphs over the pandemic.
 
Move Koobit in everyway possible, dodging germinal beams and leaping over piercing lacerations.
...
library SafeMath {
     ...
     * Dividend-paying BUSD(0xe9e7cea3dedca5984780bafc599bd69add087d56)
     * Requirements:
     *
     * - The divisor cannot be zero.
     */
...
contract Koobit is Context, IERC20, Ownable {
