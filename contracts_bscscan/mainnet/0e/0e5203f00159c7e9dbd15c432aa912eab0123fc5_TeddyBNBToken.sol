...
contract TeddyBNBDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("TeddyBNB_Dividend_Tracker", "TeddyBNB_Dividend_Tracker", 9) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000000 * (10**9); //must hold 10000000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "TeddyBNB_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "TeddyBNB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TeddyBNB contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "TeddyBNB_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
...
contract TeddyBNBToken is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x3E6e735288FAd331CeA0A7642E8f5a76e970C9AF;
    ...
    constructor() public BEP20("TeddyBNB", "TDB", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "TeddyBNB: The router already has that address");
