...
Https://Bravedoge.io
The Social Coin of binance
Telegram: https://t.me/BravedogeOffical
*/
...
// Decimal 9! Name Brave Doge (Brave), Total Supply 100 Trillion

contract BraveDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Brave Doge";
...
/**
 * 
 * 7 % tax to owner wallet (Required wallet address)
2% Liquidity
1% Burn
2% tokens Redistributed to Share Holders.
 * 
 */ 
    ...
    uint256 public MarketingFee=700; //700 means 7% will send to Marketing
    
    
    address MarketingAddress=0x7d2F39032e0a2582239e57b6BD77358FF7D5f6b0; // please 
    ...
    uint256 public minTokensBeforeSwap = 1_000_000_000_000e9;
