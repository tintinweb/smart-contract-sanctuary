...
import "./MiniBinaPet-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MiniBinaPet` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MiniBinaPet(Env.Testnet)` or `MiniBinaPet(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MiniBinaPet";
    string internal constant SYMBOL = "BBA";
     ...
     */
    address internal tipToTheDev = 0xAE4Ee8Fbb99F2D66d5Bb9C0D37D42E87Ec3C49F0;
...
contract MiniBinaPet is SafeToken{
