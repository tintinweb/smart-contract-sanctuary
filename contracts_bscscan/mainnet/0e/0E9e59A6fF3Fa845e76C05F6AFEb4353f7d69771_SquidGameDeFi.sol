...
contract BEP20 is Context, IBEP20 {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        (uint256 tAmount, uint256 charityFrr_, uint256 referralFrr_, uint256 liquidityFrr_, uint256 squidHubFrr_, uint256 burnFrr_) = transferFee(sender, recipient, amount);
