...
/**
   ...
   Welcome to BNB Mongoose
   
   Tg : https://t.me/BNBMongoose
...
contract BNBMongoose is Context, IERC20, Ownable {
    ...
    string private _name = "BNB Mongoose";
    string private _symbol = "BNBMONGOOSE";
    ...
    uint256 public _maxTxAmount = 400000000 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = 1215457 * 10**6 * 10**9; 
