...
🔥 The highest paying dividend reward token, Automatically receive 🐻 BILLIONAIRE BEAR 🐻 for holding $BillionBear. Get $BillionBear automatically streamed straight to your wallet. The longer you hold $BillionBear tokens, the more you earn in rewards! Simply buy & hold $BillionBear and you’ll get 14% $BillionBear automagically! Why settle for 7% or 10% rewards when we can reward holders with insanely high rewards - 14% from every sell transaction! 🔥
...
contract BillionaireBear is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BILLIONAIRE BEAR", "BillionBear")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function set_enableMarketingFee(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function set_percentage_Liquidity_fee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
