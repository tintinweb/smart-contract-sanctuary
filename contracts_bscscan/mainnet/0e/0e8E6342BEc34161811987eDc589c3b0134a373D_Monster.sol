...
contract Monster is ERC1155, Ownable{
    ...
    IWhiteList private _white = IWhiteList(0xAa2F33328D6Cc07b78fCA5a72DAA1668B29C549b);
    ...
    constructor() public ERC1155("https://game.example/api/item/{id}.json") {
        _supplyCount[6] = 900;  //godzilla
        _tokenUri[6] = "https://image.godzillacoin.io/icon8/icon8.png";
        _supplyCount[5] = 2250;  //tyranno
        _tokenUri[5] = "https://image.godzillacoin.io/icon8/icon7.png";
        _supplyCount[4] = 4500;  //tyranno
        _tokenUri[4] = "https://image.godzillacoin.io/icon8/icon6.png";
        _supplyCount[3] = 5850;  //turtle
        _tokenUri[3] = "https://image.godzillacoin.io/icon8/icon5.png";
        _supplyCount[2] = 6750;  //smaug
        _tokenUri[2] = "https://image.godzillacoin.io/icon8/icon4.png";
        _supplyCount[1] = 24750;  //alien
        _tokenUri[1] = "https://image.godzillacoin.io/icon8/icon3.png";
        _supplyCount[7] = 45000;  // map
        _tokenUri[7] = "https://image.godzillacoin.io/icon8/icon2.png";
    }
