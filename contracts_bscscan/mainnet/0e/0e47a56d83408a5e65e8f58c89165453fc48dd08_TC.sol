...
contract TC is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x0d3497D40F442370efE81a452E2D1993B2b6a95C;
	
	address private _burnWalletAddress = 0x000000000000000000000000000000000000dEaD;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1314 * 10**8;
    ...
    uint256 public _maxTxAmount = 10000000000000000 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**8;
	uint256 private numTokensBurn = 500 * 10**8;
