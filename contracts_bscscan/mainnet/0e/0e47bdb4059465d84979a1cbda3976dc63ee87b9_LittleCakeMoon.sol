...
/**
   ...
   Welcome to Little Cake Moon
   
   This is a community token. If you want to create a telegram I suggest to name it to https://t.me/LittleCakeMoon
...
contract LittleCakeMoon is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
  string constant tokenName = "LittleCakeMoon";
  string constant tokenSymbol = "LCM";
