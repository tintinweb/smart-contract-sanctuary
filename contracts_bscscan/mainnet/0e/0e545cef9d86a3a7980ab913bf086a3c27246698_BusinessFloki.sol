...
/**
    BusinessFloki ($BFLOKI)

    Total fees: 
    0% Buy Tax/ 12% Sell Tax
    
    10% on Sells goes to LP
    2% on Sells for Marketing
  
    Telegram: https://t.me/BusinessFloki - ~Stealth Launch
*/
...
contract BusinessFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xfd8A2b881147f75f127d5d204633b4EEC12De484); // Marketing Address
    ...
    string private _name = "BusinessFloki";
