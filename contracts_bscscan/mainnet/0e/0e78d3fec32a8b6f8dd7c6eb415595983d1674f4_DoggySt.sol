...
contract DoggySt is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "doggy";
    string constant _symbol = "doggy";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; //5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 20) / 100; // 20%
