 ...
 */
contract chipToken is ERC20, Ownable, AccessControl {
	/**
	...
	uint256 public idoSupply = 150 * 10**6 * 10**18; // ido 150
    ...
    uint256 public numTokensSellToAddToLiquidity = 25 * 10**7 * 10**18;
	...
	constructor(address newRouter) public ERC20("chip", "chip") {
		_mint(_msgSender(), idoSupply);
    ...
    function withdrawOtherToken(address _token) public onlyOwner {
