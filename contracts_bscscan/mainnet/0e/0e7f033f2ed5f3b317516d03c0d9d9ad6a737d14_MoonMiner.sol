...
contract MoonMiner is MoonDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamMoon;
    address private CharityMoon;
    ...
    string public override name = "Moon Miner";
    string public override symbol = "Miner Moon";
    ...
    constructor(uint totalSupplyValue, address TeamMoonAddress, address CharityMoonAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamMoon = TeamMoonAddress;
        CharityMoon = CharityMoonAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamMoon] =  totalSupply * 4 / 100;
        balances[CharityMoon] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TeamMoon pot
