...
contract KidofDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x716d8CE7eae4f6f5817b6B83FDC3E07B8F70BD9b); // Marketing Address
    ...
    string private _name = "KidOfDoge";
    string private _symbol = "KidOfDoge";
