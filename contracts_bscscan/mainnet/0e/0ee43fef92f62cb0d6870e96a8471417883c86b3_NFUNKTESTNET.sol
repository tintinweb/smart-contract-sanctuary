...
contract NFUNKTESTNET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NFUNKTESTNET";
    string private _symbol = "NFUNKT";
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**9; //5,000,000
    uint256 public _walletMax = 20* 10**6 * 10**9; //20,000,000
