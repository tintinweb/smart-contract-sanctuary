...
STEALTH LAUNCH - ForeverETH - 10% Ethereum reflection automatically in every hour
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 1000000 * (10**9); // user must hold 1,000,000 token to receive Ethereum
...
contract ForeverETH is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "ForeverETH";
    string constant _symbol = "ForeverETH";
