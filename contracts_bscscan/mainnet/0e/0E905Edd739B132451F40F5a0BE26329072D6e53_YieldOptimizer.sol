...
contract YieldOptimizer {
    ...
    function startArbitrage(
        ...
        if (token0 == IUniswapV2Pair(CAKE_BNB_TOKEN_ADDRESS).token0()) {
            ...
            uint sharkAmountOut = autosharkRouter.getAmountsOut(amount, PATH)[0];
            uint pancakeAmountOut = pancakeRouter.getAmountsOut(amount, PATH)[0];
    ...
    function FinsCall(
        ...
        token.approve(PANCAKE_ROUTER_ADDRESS, _amount0);
    ...
    function pancakeCall(
        ...
        IERC20 token = IERC20(token0);
        token.approve(AUTOSHARK_ROUTER_ADDRESS, _amount0);
