...
/**
 *Submitted for verification at BscScan.com on 2022-01-9
*/
 ...
 * 
 */
contract BFCTToken is IERC20 {
    
    using SafeMath for uint256;
    
    //BFCT token, creator will take 0.6% fee
    address public feeTo = 0x2B9D9dc9d4d938a386A3b4CD594175f5dDD2f60B;

    string public name = "BOFU CITI Token";
    string public symbol = "BFCT";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //BFCT Token supply max length
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 BFCT
