...
contract TeslADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TeslADA",  "TeslADA") {
    	...
    	operationsWallet = address(0x87b0e56D85F6FC5E5002e35862f3BD03072D8221);
        devWallet = address(0x87b0e56D85F6FC5E5002e35862f3BD03072D8221);
        BuyBackWallet = address(0x4789bA1f12C77e2D1D677c6fF947f7285283D9cf);
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the TeslADA token contract");
