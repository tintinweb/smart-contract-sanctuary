...
/* Token contract */
contract FirstElonZilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xF4f5A893B3bA314Fc2DbE1d1b4FF31E18d34c926;
    ...
    // Name and symbol
    string constant _name = "First Elon ZIlla";
    string constant _symbol = "FIRSTELONZILLA";
    ...
    uint256 marketingFeeBuy = 9900;
    uint256 devFeeBuy = 0;
    uint256 totalFeeBuy = 9900;
