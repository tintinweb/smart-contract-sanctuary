...
contract SkyShare is Context, IERC20, Ownable {
    ...
    string private _name = "SkyShare";
    string private _symbol = "Syre";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 5; // This tax fee is for the redistribution of rewards for the holders of token 
    ...
    uint256 public _charityFee = 5; // Charityfee is 0.005% i'm using 5 here but dividing it by 1000 when fee is cut i.e 0.05 = 5/1000 or 1/200
    address public charityWallet = 0x78E3d3B60F1c3586f19bF7dFB663cdce2DD71EfB;
