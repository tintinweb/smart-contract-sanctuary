...
contract Admin is Initializable {
    ...
    string public policy_hash;
    string public policy_link;
    ...
    modifier isActive() {
        require(current_system_state == 1, "System has been paused by Admin.");
        _;
    }
    ...
    function validate_conversion_ratio(uint _ratio) public view onlyGovernor returns (bool) {
        return true;
    }
    ...
    function set_policy(string memory _policy_hash, string memory _policy_link) public onlyAdmin {
        policy_hash = _policy_hash;
        policy_link = _policy_link;
    }
	...
	*/
    ...
    function set_usd_inr_ratio(uint _ratio) public onlyGovernor {
        require(validate_conversion_ratio(_ratio) == true, "USD-INR Conversion ratio is not valid.");
    ...
    // ///////////////////////////////////////////////////////////////////////////
    // /**
    //  * J-USD <=> J-GBP Exchange
    //  */

    
    // uint public usd_gbp_ratio;

    // uint public jusd_jgbp_markup_fee;    
    // address public jusd_jgbp_markup_fee_wallet;

    // XBEP20 jgbp;

    // event Convert_JUSD_JGBP(
	// 	address sender,
	// 	uint jusd_amount,
    //     uint jgbp_amount,
    //     uint fee_jgbp_amount
    // );

    // event Convert_JGBP_JUSD(
	// 	address sender,
    //     uint jgbp_amount,
	// 	uint jusd_amount,
    //     uint fee_jusd_amount
    ...
    // function convert_jusd_jgbp(uint _amount) public isActive returns (uint) {
    //     uint256 jgbp_amount = _amount * usd_gbp_ratio / (10 ** ratio_decimal);
    //     // Calculate Fee on receiver side
    //     uint256 fee_jgbp_amount = calculate_jusd_jgbp_markup_fee(jgbp_amount);
	// 	require(jusd.balanceOf(msg.sender) >= _amount, "Insufficient fund");
    //     jusd.burnFrom(msg.sender, _amount);
    //     // The recipient has to pay fee. 
    //     jgbp.mint(jusd_jgbp_markup_fee_wallet, fee_jgbp_amount);
    //     jgbp.mint(msg.sender, jgbp_amount-fee_jgbp_amount);
    //     emit Convert_JUSD_JGBP(msg.sender, _amount, jgbp_amount, fee_jgbp_amount);
    //     return jgbp_amount;
    // }

    // function convert_jgbp_jusd(uint _amount) public isActive returns (uint) {
    //     uint256 jusd_amount = _amount * (10 ** ratio_decimal) / usd_gbp_ratio;
    //     // Calculate Fee on receiver side
    //     uint256 fee_jusd_amount = calculate_jusd_jgbp_markup_fee(jusd_amount);
	// 	require(jgbp.balanceOf(msg.sender) >= _amount, "Insufficient fund");
    //     jgbp.burnFrom(msg.sender, _amount);
    //     // The recipient has to pay fee. 
    //     jusd.mint(jusd_jgbp_markup_fee_wallet, fee_jusd_amount);
    //     jusd.mint(msg.sender, jusd_amount-fee_jusd_amount);
    //     emit Convert_JGBP_JUSD(msg.sender, _amount, jusd_amount, fee_jusd_amount);
    //     return jusd_amount;
    // }
    
    // function get_jusd_jgbp_ratio() public view returns (uint, uint) {
    //     return (usd_gbp_ratio, ratio_decimal);
    // }

    // function get_jgbp_jusd_ratio() public view returns (uint, uint) {
    //     return (10 ** (ratio_decimal * 2) / usd_gbp_ratio, ratio_decimal);
    // }

    // function set_usd_gbp_ratio(uint _ratio) public onlyGovernor {
    //     require(validate_conversion_ratio(_ratio) == true, "JUSD-INR Conversion ratio is not valid.");
    //     usd_gbp_ratio = _ratio;
    // }

    // function set_jusd_jgbp_markup_fee(uint _markup_fee) public onlyGovernor {
    //     jusd_jgbp_markup_fee = _markup_fee;
    // }

    // function set_jusd_jgbp_markup_fee_wallet(address _wallet) public onlyGovernor {
    //     jusd_jgbp_markup_fee_wallet = _wallet;
    // } 
    
    // function calculate_jusd_jgbp_markup_fee(uint _amount) internal view returns (uint) {
    //     return _amount * jusd_jgbp_markup_fee / (10 ** fee_decimal);
    // }
