...
contract DoxieInfinity is Context, IERC20, Ownable {
    ...
    string private _name = "DoxieInfinity";
    string private _symbol = "DoxieInfinity";
    ...
    address public devWallet = 0x5bc1C18FDe067F108F2013A75dd012112CFd4676;
    ...
    uint256 public _maxTxAmount = 4 *10**12 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**11 * 10**9;
    uint256 public _maxWalletToken = 4 * 10**12 * 10**9;
