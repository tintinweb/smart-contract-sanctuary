...
contract PCOINDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("PCOIN_Dividend_Tracker", "PCOIN_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override pure {
        require(false, "PCOIN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override  pure {
        require(false, "PCOIN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PCOIN contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "PCOIN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PCOIN_Dividend_Tracker: Cannot update claimWait to same value");
...
contract Alpha is ERC20, Ownable {
    ...
    PCOINDividendTracker public dividendTracker;
    ...
    constructor() ERC20("mick", "BNB") {

        dividendTracker = new PCOINDividendTracker();
