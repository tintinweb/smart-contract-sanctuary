...
You are missed meme token for charity x1000
Don't missed this one!🌖

TG  : https://t.me/BabyDogeCashJunior
Web : http://babydogejr.com

Sometimes charity is very good and very EZ , we try to help many doge and people who have a problem and help with BDC Jr

Babydogecash Jr is not scam token, we will very serious for doing charity and we will update & Transparent about
- What we do? 
- When we do? 
- How we do ?
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x17e4aB6fD5EEde2Fe288904Ff36eB004Bc362f5C;
...
contract BDCJ is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x34EC4d3cf6b5731286984082741076EAD89fc8Bb;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Doge Cash Junior";
    string private _symbol = "BDCJ";
