...
contract DistributorFactory {
    ...
    function addDistributor(
        ...
        require(
            ...
            "testgrow/Distributor already exists"
        );
        ...
        returns (bool)
    {
        require(
            distributorsMapping[_BEP_TOKEN].exists,
            "testgrow/Distributor not found"
        );
...
contract testgrow is IBEP20, Auth {
    ...
    string constant _name = "testgrow";
    string constant _symbol = "FGROW";
    ...
    function permit(
        ...
        require(holder != address(0), "testgrow/invalid-address-0");
        require(
            holder == ecrecover(digest, v, r, s),
            "testgrow/invalid-permit"
        );
        require(
            expiry == 0 || block.timestamp <= expiry,
            "testgrow/permit-expired"
        );
        require(nonce == nonces[holder]++, "testgrow/invalid-nonce");
