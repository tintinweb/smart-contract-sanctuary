...
contract airDropSDT is ReentrancyGuard{
    ...
    constructor(address payable _owner,address _token) {
        ...
        referalAmount = 1000 * 1e8;
        startTime = block.timestamp ;
        endTime = block.timestamp +71 days ;
    }
    
    receive() payable external{}
    
    function claimAirDrop(address _referrer) public isHuman nonReentrant {
    ...
    function setAirDrop( uint256 _claimAmount, uint256 _refAmount) external onlyOwner{
    ...
    function changeStartTime(uint256 _startTime,uint256 _endTime) public onlyOwner{
