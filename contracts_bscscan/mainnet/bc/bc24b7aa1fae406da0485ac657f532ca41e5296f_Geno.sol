...
contract Geno is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x18BcD0937f4717302d9f2EdA578F98b7E342FBBe); // Marketing Address
    address payable public charityAddress = payable(0x18BcD0937f4717302d9f2EdA578F98b7E342FBBe); // Charity/Dev Address
    ...
    string private _name = "Genopets Token";
    string private _symbol = "GENO";
    ...
    uint256 public _maxTxAmount = 50000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 50000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 250000000000000000000; // 250; token will be given on airdrop
    ...
    uint256 private salePrice = 500000;// 0.01*10,000,000 token for 0.01 bnb (set as per requirements)
