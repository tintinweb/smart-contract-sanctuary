...
MiniDogeRocket is built upon the fundamentals of Buyback and increasing the investor's value
...
contract MiniDogeRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address public dogeContract1 = address(this);
    address payable public dogeContract = payable(dogeContract1); 
    address payable public marketingAddress = payable(0x8dFE7A02D1A4f661a470dA4f42fB5fD6586BeCd2); // Marketing Address
    ...
    string private _name = "MiniDogeRocket";
    ...
    uint256 public _maxWalletAmount = 1100000 * 10**6 * 10**9;
 ...
 /* Mainnet router: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function callMoonShot(uint256 amount) external onlyOwner(){
        // MoonShots will be activated at holder milestones during MiniDogeRocket launch phase, but eventually will be controlled through a community-consensus based dApp.
    ...
    function beforeFinalize() external onlyOwner {
        _maxTxAmount = 4000 * 10**6 * 10**9;
        _maxWalletAmount = 200000 * 10**6 * 10**9;
        TDEnabled = true;
        setTDTime(45 seconds);
        setSwapAndLiquifyEnabled(false);
        _taxFee = 0;
    ...
    function activateTrading() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 9;
        _maxTxAmount = 800000 * 10**6 * 10**9;
        _maxWalletAmount = 1600000 * 10**6 * 10**9;
        TDEnabled = false;
    }
