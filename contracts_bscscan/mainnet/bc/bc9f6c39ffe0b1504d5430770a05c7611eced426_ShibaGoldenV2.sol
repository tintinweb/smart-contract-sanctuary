...
contract ShibaGoldenV2 is Context, IERC20, Ownable {
    ...
    address private _marketingAddress = 0x72F545a47AC2e0F73B9BCDA6F6930A75f27761aA;
    address private _donationAddress = 0x432F39c9E4E03C2A4c05460D61d8F3A41d42e22c;

    string private _name = "Shiba GoldenV2";
    string private _symbol = "$SHIBV2";
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != address(1) && to != uniswapV2Pair){
            ...
            require(contractBalanceRecepient + amount <= _maxWalletToken, "Exceeds maximum wallet token amount (10000000)"); 
        }
