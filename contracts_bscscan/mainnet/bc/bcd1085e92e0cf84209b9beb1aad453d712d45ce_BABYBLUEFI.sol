...
//   ᴛᴇʟᴇɢʀᴀᴍ https://t.me/BabyBleuFiBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 USDT = IBEP20(0xfFdC00285DDe1f5b5c65C6a963357b4C55d8f601);
...
/* Token contract */
contract BABYBLUEFI is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address USDT = 0xfFdC00285DDe1f5b5c65C6a963357b4C55d8f601; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xcB9efa0e1610E8f7eBeaE676da5A02d62BC8C2A7;
    ...
    // Name and symbol
    string constant _name = "BabyBleuFi";
    string constant _symbol = "BABYBLEU";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% or 3m tokens
    ...
    uint256 marketingFeeSell = 12;
    uint256 devFeeSell = 2;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x31B818c85E87f42FF9Dd9120D8d5D95bbA5D612f;
