...
contract ShinobiInu is IBEP20, MBCAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shinobi Inu";
    ...
    // @dev  added max hold so that no single wallet can hold more than 4%.
    uint256 public _maxHold = _totalSupply / 25; // 4 %
