...
📱 - TELEGRAM: https://t.me/BabyHolland

✔️ Tokenomics:✔️

🔥  *  10% CAKE distribution
🔥  *  6% buyback, marketing, and team wallet
🔥  *  Max transaction is 0.5% -> 500.000.000 Tokens
🔥  *  Set high enough slippage!
🔥  *  Sell will incur 8% extra tax, i.e. 24% set 25+% slippage for sell tax.
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //Cake
...
contract BabyHolland is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public _dividendToken = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //Cake
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address private Daed = 0x000000000000000000000000000000000000dEaD;
    ...
    uint256 public maxBuyTranscationAmount = 500000000 * (10**18); //0.5% of total supply
    uint256 public maxSellTransactionAmount = 500000000 * (10**18);
    uint256 public swapTokensAtAmount = 20000000 * (10**18);
    uint256 public maxWalletToken = 25000000000 * (10**18); // 25% of total supply
    ...
    uint256 public marketingDivisor = 90;
    ...
    constructor() ERC20("BabyHolland", "BH") {
    	...
    	buyBackWallet = 0x7DAA169615030c789b984494EF3397fB9d32C36C;
        ...
        dividendTracker.excludeFromDividends(address(Daed));

        // exclude from paying fees or having max transaction amount
        excludeFromFees(buyBackWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(Daed, true);
