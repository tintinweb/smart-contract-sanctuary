...
The newest BSC 💎!
Fair launching soon!
I’ve taken several precautions to make sure no bots will be able to get in and even if they do they will be rekt!!
Tokenomics:
7% marketing
5% liquidity 
2% ecosystem fee

https://t.me/bottedinu
*/
...
library Address{
 ...
 contract BottedInu is Context, IERC20, Ownable {
    ...
    address public ecosystemWallet = 0x8C9EcB1Fc7b1CE4D3B42eBf7112b29525b428Cc6;

    string private constant _name = "Botted Inu";
    string private constant _symbol = "BOTTEDINU";
    ...
    Taxes public taxes = Taxes(1, 7, 5, 2);
    Taxes public sellTaxes = Taxes(1, 7, 5, 2);
