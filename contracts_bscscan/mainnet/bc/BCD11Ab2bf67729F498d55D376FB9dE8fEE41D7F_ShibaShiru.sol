...
contract ShibaShiru is Context, IERC20, Ownable {
    ...
    uint256 public maxLimit = 400_000_000_000 * 10**18;
...
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Testnet
    ...
    function excludeFromWhale(address account, bool status) public onlyOwner {
        _isExcludedFromWhale[account] = status;
    }
