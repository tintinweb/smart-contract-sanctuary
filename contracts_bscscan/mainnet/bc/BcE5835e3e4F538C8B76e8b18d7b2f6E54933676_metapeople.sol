...
contract metapeople is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "metapeople";
  string constant _symbol = "metapeople";
  ...
  uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**14 * 10**_decimals;
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0x132995f1637f4d700a3988f291b1385F1B0d9873;
    devFeeReceiver = 0x94Bd5118D820fd1d74CD0C2A1dc33EeF6ed12332;
