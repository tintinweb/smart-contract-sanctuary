...
Web: https://dogedash.com/
Play Demo: https://demo.dogedash.com/
...
Anti-Sniper Bot Mechanism

*/

// SPDX-License-Identifier: UNLICENSED

//Pramga Solidity Version
...
contract DogeDash is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0x8339E7e80A5C789793cB6e4b1F017FBfA75EEb65;
    address public _developmentWalletAddress = 0x0C74ae25500f7d8Ff53A8674640C376b86132E2f;
    address public _ownerWallet = 0xa9a1F9a81eDaeE1df0286D27189e81E2E1589341;
    ...
    constructor() public ERC20("DogeDash", "DOGEDASH") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DogeDash: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "DogeDash: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DogeDash: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function whitelist(address _presaleAddress, address _routerAddress) public onlyOwner {
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DogeDash: Automated market maker pair is already set to that value");
