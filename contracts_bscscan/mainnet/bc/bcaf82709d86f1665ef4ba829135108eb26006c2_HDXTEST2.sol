...
contract HDXTEST2 is Context, IERC20, Ownable {
    ...
    uint256 public _maxBuyAmount = 10 * 10**6 * 10**9;
    uint256 public _maxSellAmount = 5 * 10**6 * 10**9;
    uint256 public _maxWhaleAmount = 10 * 10**6 * 10**9;
