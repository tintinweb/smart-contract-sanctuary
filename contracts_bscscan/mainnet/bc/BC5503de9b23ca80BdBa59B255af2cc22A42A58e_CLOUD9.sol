...
/** CLOUDFLIP
We are all about incentives over control here at Cloud9bsc, our Cloudflip game will 2X your tokens if you win.
1.5M MIN HOLD REQUIRED
We have logic theory systems behind this to make it sustainable. 
We've tested the game extensively and set win-rate odds accordingly, not everyone can 2X any amount of tokens and walk away from it, it's not realistic.
Max bet depends on Cloudflips wallet balance. (89M)(ranging from 30% of balance)
*/
...
contract CLOUD9 is Context, IBEP20, Ownable {
