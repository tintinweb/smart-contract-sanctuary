...
/**
    ...
    5% of each transaction to the dev wallet for continued development
 */
...
contract FALO is Context, IBEP20, Ownable {
    ...
    string private _name     = "Kill Floki";
    string private _symbol   = "KILLFLOKI";
