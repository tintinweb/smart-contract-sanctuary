...
// FlappyCake, the Most addictive Play-To-Earn BSC Game!
...
contract FLAPPYCAKE is ERC20, Ownable {
    ...
    uint256 public minTxAmountToGetGameCompetiti = 20 * (10**6) * (10**18); // 0.2% of total circulation
    uint256 public minHoldAmountToGetGameRewards = 30 * (10**6) * (10**18); // 0.3% of total circulation

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public CAKE = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);

    uint256 public swapTokensAtAmount = 500 * (10**6) * (10**18); // 5% of total circulation

    mapping(address => bool) public _isBlacklisted;
    uint256 public _maxTxAmount = 4000 * (10**6) * (10**18); // 40% of total circulation
    ...
    address public _marketingWalletAddress =
        0x6b6caA1B789429934E90201EBF03951695B9B392;
    ...
    constructor() public ERC20("FlappyCake", "FLAPPYCAKE") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(
            ...
            "The new dividend tracker must be owned by the FlAPPYCAKE token contract"
        );
    ...
    function updateCanSwap(bool val) public onlyOwner {
        canSwap = val;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            require(canSwap, "Please Buy after LP added");
            require(
                amount <= _maxTxAmount,
...
contract FLAPPYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        public
        DividendPayingToken(
            "FLAPPYCAKE_Dividen_Tracker",
            "FLAPPYCAKE_Dividend_Tracker"
        )
    {
        claimWait = 3600; //1小时
        minimumTokenBalanceForDividends = 20 * (10**6) * (10**18); //must at least hold 20000000+ tokens
    }
