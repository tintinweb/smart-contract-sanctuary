...
/**
   ...
   I make this #AkitaZilla to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/AkitaZillabsc

   Great features:
   8% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders

   I will add 0.3 BNB and all the total supply to the pool
   Can you make #AkitaZilla 1000X? 
   ...
   it's the best part of the #AkitaZilla idea, increasing the liquidity pool automatically, 
...
contract AkitaZilla is Context, IERC20, Ownable {
    ...
    string private _name = "AkitaZilla";
    string private _symbol = "AZilla";
