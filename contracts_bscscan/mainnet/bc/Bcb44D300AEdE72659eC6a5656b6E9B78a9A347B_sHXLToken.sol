...
contract sHXLToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked HXL", "sHXL", 9) ERC20Permit() {
    ...
    /**
        @notice increases sHXL supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sHXL
