    ...
    PausableUpgradeable
{
    ...
    function setSwapRate(uint256 _rate)
        public
        onlyOwner
        {
           swapRate = _rate;
        ...
        nonReentrant
    {
        ...
        if (round > 1){
            require(
                getTokenAmountLeftInRound(round) >= withdrawTokenAmount.div(10).mul(12), // cho rút thêm 1 tí để tránh lỗi 
    ...
    function addLiquidity(uint256 bnbAmount) internal {
        ...
        uint swapAmout = (bnbAmount/100)*swapRate;
