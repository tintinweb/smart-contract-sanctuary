...
*                       `+my/:-/sshdhys+///+++//oNo                     
*                      :No::/+++oyhyso+//+++/////oM-                
*                    .yNd+oNyyyhhysooossso+///://+ym`                
*                  `sNdhmMMdhhhdhhyyyysssso+/::/+/:hh                 
*                 oNmdmm/dmhyyhhhhhhhhhhyo+//////::/N:               
*               /mmdmd:  smsssyhhyyyyyyso+///////://ds              
*             :mmdmd/    +msyyyyyyyysso++/////////:/M-            
*           :dNdmd:      omsyyyoossssso++/:::/:://+my                                                    
*         :dNmNd:   `:+shmdsyhs/:+oooyoo+/:--::::oN+                                                                                   
...
*    Telegran: https://t.me/ShibaBonkTG
*    
*
*    Bonk!
*   
...
contract Context {
 ...
 contract ShibaBonk is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private theweekend;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _namex = "ShibaBonk";
    string private _symbolx = "SBONK";
    uint256 private constant MAX = ~uint256(0);
    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWalletsX1 = 0x747F61ef312A672b64c0C5C21E9A96FD06784A8A;
    address private _feeAddrWalletsX2 = 0x747F61ef312A672b64c0C5C21E9A96FD06784A8A;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 100000 * 10**18;
    address private _elementx = 0x747F61ef312A672b64c0C5C21E9A96FD06784A8A;
