...
/**
 *                                                                                    
`7MMM.     ,MMF'`7MM"""YMM  `7MMM.     ,MMF'`7MM"""YMM  `7MM"""Mq.`7MMF' .g8"""bgd  
  MMMb    dPMM    MM    `7    MMMb    dPMM    MM    `7    MM   `MM. MM .dP'     `M  
  M YM   ,M MM    MM   d      M YM   ,M MM    MM   d      MM   ,M9  MM dM'       `  
  M  Mb  M' MM    MMmmMM      M  Mb  M' MM    MMmmMM      MMmmdM9   MM MM           
  M  YM.P'  MM    MM   Y  ,   M  YM.P'  MM    MM   Y  ,   MM        MM MM.    `7MMF'
  M  `YM'   MM    MM     ,M   M  `YM'   MM    MM     ,M   MM        MM `Mb.     MM  
.JML. `'  .JMML..JMMmmmmMMM .JML. `'  .JMML..JMMmmmmMMM .JMML.    .JMML. `"bmmmdPY  
                                                                                    
                                                                                    
*/

/**
WEBSITE:https://www.memepig.online/
TELEGRAM:https://t.me/memepigBSC
 ...
 */
 ...
 contract MemePig is Context, ERC20, ERC20Metadata {
