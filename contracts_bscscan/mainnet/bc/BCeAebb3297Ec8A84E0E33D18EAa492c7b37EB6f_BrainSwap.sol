...
contract BrainSwap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BrainSwap";
    ...
    uint256 internal _tokenTotal = 100000000 *10**18; // 100 Million totalSupply
    ...
    uint256 public _taxFee = 0; //0
    uint256 public _buybackv1Fee = 500; // 500 = 5%
    uint256 public _LiquidityFee = 200; // 200 = 2%
    uint256 public _burningFee = 0; //0
    uint256 public _smarketingFee = 300; // 300 = 3%
    ...
    address public buybackv1Address  = 0x5d7E7Da60b5be24227B828F790eF15C3fAfaDa8f;      // BuyBackv1 Address
    address public LiquidityFeeAddress  = 0x5d7E7Da60b5be24227B828F790eF15C3fAfaDa8f;      // Liquidity Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x5d7E7Da60b5be24227B828F790eF15C3fAfaDa8f;      // SMarketing Address
...
function _approve(address owner, address spender, uint256 amount) private {
    ...
    function setLiquidityFeeAddress(address _Address) public onlyOwner {
        require(_Address != LiquidityFeeAddress);
        
        LiquidityFeeAddress = _Address;
    }
