...
contract Ownable {
    ...
    constructor () internal {
        _owner = 0x808E95185ab79bA31684778A5F2c929367BF1321;//msg.sender;
...
contract Token is Ownable, ERC20, ERC20Detailed("WineProtocol", "WINE", 18) {
  ...
  constructor() public {
    uint256 tokensAmount = 500000000 * 10 ** 18;
