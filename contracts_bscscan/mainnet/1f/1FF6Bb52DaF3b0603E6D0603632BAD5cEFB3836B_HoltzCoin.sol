...
NAME TOKEN: HoltzCoin
SYMBOL: HLTZ
TOTAL SUPPLY: 210,000,000

--------------------------------------

MAX. AMOUNT PER TX: 1,000,000
TRANSACTION TAX: 8% on every transaction
BURNT RATE:	5% of tax is locked in liquidity
REWARDS: 3% of tax is distributed to HLTZ Holders

--------------------------------------

🌐 Website: https://holtzcoin.site/
📢 Telegram: https://t.me/HoltzCoin
...
contract HoltzCoin is Context, IBIP20, Ownable {
    ...
    string private _name = 'HoltzCoin';
    string private _symbol = 'HLTZ';
