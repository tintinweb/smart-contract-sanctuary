...
contract WeLoveADA is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 333333333 * (10**18);  //0.3% Max buy
    uint256 public maxSellTransactionAmount = 333333333 * (10**18); //0.3%  Max sell
    uint256 public swapTokensAtAmount = 20000000 * (10**18);
    uint256 public maxWalletToken = 1000000000 * (10**18); // 1.0% of total supply for max wallet
    ...
    function afterPreSale() external onlyOwner {
        ...
        marketingFee = 5; //
        maxBuyTranscationAmount = 333333333 * (10**18); //0.3%
        maxWalletToken = 1000000000 * (10**18); //1%
    }
