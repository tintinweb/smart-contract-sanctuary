...
/  \    /  \/  \    /  \/   _____/\__    ___/  The Woof Of Wall Street
\   \/\/   /\   \/\/   /\_____  \   |    |     Supply: 100.000.000.000
 \        /  \        / /        \  |    |     Decimals: 18
  \__/\  /    \__/\  / /_______  /  |____|     Telegram: t.me/thewoofofwallstreetbsc
       \/          \/          \/            
...
contract TheWoofOfWallStreet is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable private buybackWallet = payable(address(0x678f21Be580685009A0d35df123683929767D17A));
    address public marketingFeeWallet = 0x678f21Be580685009A0d35df123683929767D17A;


    constructor() public ERC20("The Woof Of Wall Street", "WWST") {
       ...
       address _liquidityReceiver = 0x3e2B2249C5b2d17B1b0c03B78f927d3396feA007;
    ...
    function setBuybackFee(uint256 value) external onlyOwner{
        buybackFee = value;
        totalFees = buybackFee.add(liquidityFee).add(marketingFee);
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if( canSwap &&
            ...
            super._transfer(address(this), marketingFeeWallet, marketingTokens);
