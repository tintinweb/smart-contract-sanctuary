...
/**           
     Make your own tg. I'll lock the liq for 1 day and extend if necessary. I'll probably we watching the tg.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD because why not?
...
contract DontLookUpIntoMyAssholeIAteTacoBellLastNight is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DontLookUpIntoMyAssholeIAteTacoBellLastNight";
    string constant _symbol = "DIARRHEA";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken =   0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD because why not?
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x9fa2A71F193bfa4F16F1A2ffacd7BBf471e857c1;  // teamwallet
        lotteryWallet = 0x9fa2A71F193bfa4F16F1A2ffacd7BBf471e857c1;  // lotterywallet
