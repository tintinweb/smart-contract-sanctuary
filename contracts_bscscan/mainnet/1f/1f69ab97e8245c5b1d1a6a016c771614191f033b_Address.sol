...
contract SilverDragonV2 is Context, IERC20, Ownable {
    ...
    string private _name = "SilverDragon";
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2b34986a000c9Cc4Bbc0970a16Cf6aBe68C68ac0);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x4956F24bC1290f7489ad89D54122D6A95E565F21, 'We can not exclude Uniswap router.');
