...
/**
 * TELEGRAM: HTTPS://T.ME/SaitamaInuPro
 * 
 * 
     
Welcome to SaitamaInuPro
The token that's been designed to EXPLODE!
Super addictive game and tokenomics carefully engineered to do nothing but pump the chart! Let’s go SAITAMA INU PRO!

It’s in the Name! 
SaitamaInuPro Token has been carefully designed to achieve a single purpose – GOING BULLFOMO! 
Our super addictive game and tokenomics will benefit the coin and consistently take it to new heights.
Our game will be released in November, so don’t miss your chance to get in early!
...
,join our telegram and ask any questions you may have.   
...
contract SaitamaInuPro is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SaitamaInuPro";
