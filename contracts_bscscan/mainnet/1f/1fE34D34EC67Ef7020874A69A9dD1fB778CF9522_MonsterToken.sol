...
contract MonsterERC20 is Ownable, ERC20 {
    using SafeMath for uint256;

    uint256 constant public PLAYTOEARN_ALLOCATION = 350 * 10**6 * 10**18;
    ...
    function win(address winner, uint256 reward) external onlyEvolver{
        ...
        require(playToEarnReward <= PLAYTOEARN_ALLOCATION, "Over cap farm");
