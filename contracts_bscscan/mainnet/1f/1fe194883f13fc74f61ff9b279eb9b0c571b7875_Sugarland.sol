...
contract Sugarland is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x29906c39c5362Ebc11cEA946009a89Bfa0bAef43;
    address public devAddress = 0x29906c39c5362Ebc11cEA946009a89Bfa0bAef43;

    string private constant _name = "Sugarland V2";
    string private constant _symbol = "Sugarland";
    ...
    Taxes public sellTaxes = Taxes(0,0,5,5);
