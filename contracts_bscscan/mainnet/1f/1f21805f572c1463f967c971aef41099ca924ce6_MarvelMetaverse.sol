...
contract MarvelMetaverse is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 2 * 10**11 * 10**4;
    bool public lock = true;
    address public uniSwapV2;

    string private _name = "MarvelMetaverse";
    ...
    address payable public BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;
     uint256 private _total = 2 * 10**11 * 10**4;
