...
contract BabySport is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BabySport";
    string private _symbol = "BABYSPORT";
    ...
    uint256 internal _tokenTotal = 100000000000000000 * 10**9; //100_000_000_000_000e9; 
 ...
 */ 
    ...
    address MarketingAddress=0x36455b788093C11257bb7d6Fd36b7A6121CBe0F0; // please 
    ...
    uint256 public minTokensBeforeSwap = 1000000000000000 * 10**9; // 1_000_000_000_000e9;
