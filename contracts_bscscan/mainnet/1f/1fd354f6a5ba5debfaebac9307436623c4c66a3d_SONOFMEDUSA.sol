...
contract SONOFMEDUSA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAF680BBbd0C01171F181843466BEb6aF15eE1714); // Marketing Address
    ...
    string private _name = "SONOFMEDUSA";
    string private _symbol = "SMedusa";
    ...
    uint256 private minimumTokensBeforeSwap = 250 * 10**6 * 10**18; 
    uint256 private buyBackUpperLimit = 100000 * 10**18;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 100000 * 10**6 * 10**18;
    }
