...
contract MetaGoogle is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 6_000_000 * 10**_decimals;
    uint256 public maxWalletAmount = 6_000_000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x6DA5B247b41FAD8cdDf0a304a507A0185eAbE718;

    string private constant _name = "MetaGoogle";
    ...
    Taxes public taxes = Taxes(2,5,4,1);
