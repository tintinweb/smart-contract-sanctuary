...
contract dogejeets is Context, IERC20, Ownable {
    ...
    string private _name = "dogejeets";
    string private _symbol = "dogejeets";
    ...
    uint256 public _maxTxAmount = 15 *10**13 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**13 * 10**9;
    uint256 public _maxWalletToken = 15 * 10**13 * 10**9;
