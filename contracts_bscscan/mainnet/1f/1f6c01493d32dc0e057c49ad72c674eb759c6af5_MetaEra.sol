...
██║░╚═╝░██║███████╗░░░██║░░░██║░░██║███████╗██║░░██║██║░░██║
╚═╝░░░░░╚═╝╚══════╝░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚═╝░░╚═╝
We are here to revolutionise the way technology impacts daily human life. 
We are focused on making innovative products that push the limits of what people think
...
abstract contract GamingContext {
 ...
 * the owner.
 */
contract GamingOwnable is GamingContext {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "GamingOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "GamingOwnable: new owner is the zero address");
...
contract MetaEra is GamingContext, Gaming, GamingOwnable {
    ...
    string private constant _name = "MetaEra"; // 
    string private constant _symbol = "MetaEra"; //    
