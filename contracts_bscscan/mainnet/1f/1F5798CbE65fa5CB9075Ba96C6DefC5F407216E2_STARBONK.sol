...
contract STARBONK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name ="STARBONK.SPACE";
    string constant _symbol = "STARBONK";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x356C2094b40914d50f1C8C7f0C69ed09fd395831;
