...
/**
AnyClaim Coin – A reward crypto that allows you the holder to be rewarded how you want.

With our unique contract, you can claim any token with LP on PancakeSwap v2.

TG: https://t.me/AnyClaimCoin
Website: http://anyclaimcoin.com
*/
...
contract AnyClaim is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'AnyClaim Coin';
    string private constant _symbol = 'ACC';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;//equals 10000 token
    ...
    uint16 public constant MaxSellLockTime= 120;
	//Buyers get locked for MaxBuyLockTime so they can't buy repeatedly
    uint16 public constant MaxBuyLockTime= 120;
    ...
    //DevWallets
    address public TeamWallet=payable(0x6d25FBAE7E10d5F8092a070d7549A50E61f245E0);
    address public walletTwo=payable(0x0f5586559c2ff18fCB01762aDF7435dee0e8760B);
    //TestNet
    ...
    function claimBTC(address addr, address rAddress) private{
    ...
    function RewardWithdraw(address rAddress) public{
        claimBTC(msg.sender, rAddress);
    }
