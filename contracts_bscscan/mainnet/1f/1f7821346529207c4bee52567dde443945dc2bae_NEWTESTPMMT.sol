...
contract Ownable is Context {
    address private _owner = 0x100A3Ef0a81b0B079D94A5e02D55Ed71A4501ECe;
...
contract NEWTESTPMMT is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xeF33c47D53de0938fF711f4071114258eDFD668C); // Marketing Address
    address payable immutable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "NEWTESTPMMT"; // token name
    string private _symbol = "NTPM"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 10 minutes; // duration betweeen each buyback
    ...
    uint256 public _buyBackFee = 120; // buyback fee 12%
    uint256 private _previousBuyBackFee = _buyBackFee; // buyback fee

    uint256 public _marketingBNBFee = 20; // marketing BNB fee
    uint256 private _previousMarketinBNBFee = _marketingBNBFee; // marketing BNB fee

    uint256 public _liquidityFee = 30; // liquidity fee 3%
    ...
    uint256 public _maxTokensPerAddress          = _tTotal.div(20); // Max number of tokens that an address can hold 5% of total supply
	...
	*/
	function setDurationBetweenEachBuyBcakTime(uint256 duration) public onlyOwner {
		durationBetweenEachBuyback = duration * 1 days;
	}
    ...
    function _transfer(
        ...
        {
            buyBackTokens(address(this).balance/2);
        }
