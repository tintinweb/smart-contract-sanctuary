...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x43bC128De845486F8E84D1AaFF2E2188DfB460fe;
...
contract ETHERMINE is Context, IERC20, Ownable {
    ...
    string private _name = "Ether Mine";
    string private _symbol = "ETHMine";
    ...
    uint256 public _taxMultiplier = 2;
    ...
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**9 * 10**9;
    uint256 public maxTxAmount = _tTotal.mul(1).div(1000);
    ...
    function setDevWalletAddress(address devWalletAddress) external onlyOwner(){
    ...
    function setTaxMultiplier(uint256 value) external onlyOwner{
        _taxMultiplier = value;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if(recipient == uniswapV2Pair) {
            _taxFee = _taxFee.mul(_taxMultiplier);
            _devFee = _devFee.mul(_taxMultiplier);
            _burnFee = _burnFee.mul(_taxMultiplier);
            _liquidityFee = _liquidityFee.mul(_taxMultiplier);
        }
        ...
        _taxFee = 0; _devFee = 0; _liquidityFee = 0;
        _transferStandard(sender, address(0), burnAmt);
        _taxFee = _previousTaxFee; _devFee = _previousDevFee; _liquidityFee = _previousLiquidityFee;
