...
// GREEAT GAMES coins (GREEAT GAMES Project @2021)
// Based on FEG Token
...
contract GreeatGames is Context, IERC20, Ownable {
    ...
    string private _name = 'GREEAT GAMES coin';
    string private _symbol = 'GREEAT';
