...
contract BabyFlokiRun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyFlokiRun";
    string private _symbol = "$BabyFlokiRun";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7628F9957940afaeb73b0fd1f8D80a8F6464B8eb); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7628F9957940afaeb73b0fd1f8D80a8F6464B8eb); // BuyBack Address
