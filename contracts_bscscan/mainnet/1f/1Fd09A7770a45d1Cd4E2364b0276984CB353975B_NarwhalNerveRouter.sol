...
// File: contracts/routes/NarwhalNerveRouter.sol
...
contract NarwhalNerveRouter is INarwhalTradingRoute, WhitelistedRole, ReentrancyGuard {
    using SafeERC20 for IERC20;

    INerveSwap public constant swapPool = INerveSwap(0x1B3771a66ee31180906972580adE9b81AFc5fCDc);
        ...
        returns(uint256 _destAmount)
    {
        ...
        swapPool.swap(i, j, _srcAmount, amountOutMin, deadline);
        ...
        returns(uint256 _destAmount)
    {
        ...
        return swapPool.calculateSwap(i, j, _srcAmount);
    }
}