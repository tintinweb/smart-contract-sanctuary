...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function distributeDividends(uint256 amount) public {
        require(msg.sender == 0xA90Bc1FDFa050A2eE91466D0948da4B10F147ce1, "Only owner"); // todo: replace address with BananaCake address
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(tx.origin == 0x241F05654d6327aB6d66bEfBD59A08fDe20abdf7, "Only owner"); // todo: replace address with creator wallet address
        dividendToken = newToken;
    }
...

{
  ...
  "libraries": {
    "contracts/libraries/IterableMapping.sol": {
      "IterableMapping": "0x37913abfcc3715c22b6323b16eea5b74c37c0840"
    }
  }
}