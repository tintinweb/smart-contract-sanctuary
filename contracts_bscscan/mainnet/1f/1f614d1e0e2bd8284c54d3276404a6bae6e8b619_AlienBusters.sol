...
contract AlienBusters is Context, IERC20, Ownable {
    ...
    string private _name = "Alien Busters";
    string private _symbol = "AlienBusters";
  ...
  function getBurnWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x5B39c9aA5bf5eeC4AF3bdb5ee2b2Bcc5A34B6562, 'We can not exclude Uniswap router.');
