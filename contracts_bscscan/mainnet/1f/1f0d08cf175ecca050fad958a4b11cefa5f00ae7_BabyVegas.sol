...
TG: https://t.me/BabyVegasBSC
Website: https://www.babyvegas.ovh

By: https://t.me/SafeCoinDistrict

Celebrating Casino and all gamble games all around the world by rewarding our holders with BTC !
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BBTC = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BBTC.balanceOf(address(this));
        ...
        uint256 amount = BBTC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BBTC.transfer(shareholder, amount);
...
contract BabyVegas is IBEP20, Auth {
    using SafeMath for uint256;

    address BBTC = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyVegas";
    string constant _symbol = "BabyVegas";
