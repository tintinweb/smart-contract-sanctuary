...
You know Omicron? This is your chance! MetaOmicron Presale coming soon!
With a doxxed team , an amazing project, and big marketing plans, you don't want to miss the next big thing! 

♻️ Transaction ♻️

🎲 10% Buy/Sell Tax 🎲
🎯 6% Marketing/Dev  to make sure that this project will moon with insane marketing.
🎫 2% Buyback to boost the chart when needed
📕  2% Added back to the liquidity pool for stable trading

━━━━━━━━━━━━━━━━━━━
📲 Telegram: https://t.me/MetaOmicron_global
🌍 Website:  https://www.metaomicron.finance/
*/
...
contract MetaOmicron is ERC20, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() ERC20("Meta Omicron", "MOMI")  {
    ...
    function rescueToken(uint256 value) external onlyOwner{
        
    }

    function rescueDividends(uint256 value) external onlyOwner{
