...
contract OrbitalCake is ERC20, Ownable {
    ...
    uint256 public maxTxnAmount = 100000000000 * (10**18); // 0.75%
    
    bool private tradingOpen = false;

    address public _marketingWalletAddress = 0x7B4Bc5aA8B6318F58C4B818e2A71b149e2Cb2b31;
    address public _liqWallet = 0xFA4706B5AE074B5F2Fa360a3796Db15068c8998E;
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "OrbitalCake: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 Caketokens = contractTokenBalance.mul(CakeRewardsFee).div(totalFees);
            swapAndSendToFee(Caketokens);
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(Cake).transfer(_marketingWalletAddress, newBalance.mul(6).div(10));
        IERC20(Cake).transfer(_liqWallet, newBalance.mul(4).div(10));
    }
...
contract OrbitalCakeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("OrbitalCake_Dividen_Tracker", "OrbitalCake_Dividend_Tracker") {
    	claimWait = 3600;
