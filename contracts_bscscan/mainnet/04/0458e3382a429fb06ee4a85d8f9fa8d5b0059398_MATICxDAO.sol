...
/*
STEALTH LAUNCH - PolygonXDAO - 10% $MATIC reflection


10 Features:

1. Reward 10% $MATIC
2. 1 (One) Year LP Locked !!!
3. Supply 1.000.000.000.000
4. Initial burn 100.000.000.000
5. Min Hold 10,000,000 Token
6. BurnFee 1%;
7. 10% $MATIC reflection
8. Marketing 4%
9. Max tx 3%
10. 5 BNB Initial Liquidity

Website: https://maticxdao.finance
TG: https://t.me/MATICxDAO
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    uint256 public minimumTokenBalanceForDividends = 10000000 * (10**9); // user must hold 10.000.000 token to receive MATIC
...
contract MATICxDAO is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "PolygonXDAO";
    string constant _symbol = "MATICxDAO";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(3).div(100); //Max tx one time is 3%
