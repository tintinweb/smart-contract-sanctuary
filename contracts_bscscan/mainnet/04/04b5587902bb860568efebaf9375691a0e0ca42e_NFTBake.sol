...
/**
 Welcome to NFT Bake
   ...
   I will renounce the ownership to burn addresses to transfer #NFTBake to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make NFT Bake 100X? 
   ...
   it's the best part of the #NFTBake idea, increasing the liquidity pool automatically, 
