...
//llamado TESTDontbuy3

//Find original code that is now commented
//Commented to have BL

//Find new code that is now commented to avoid error
//Not added, makes exceed error

contract TESTDontbuy3 is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TESTDontbuy3';
    string private constant _symbol = 'TESTDontbuy3';
    ...
    function Sacrifice(uint256 amount) public{
        //Not added, makes exceed error
        /*bool isBlacklisted = _blackList.contains(msg.sender);
        require(!isBlacklisted, 'El emisor esta en la blacklist.');*/
