...
▀▄▄▄▄▄▀▄▄▄▄▀▄▄▄▄▀▀
    ...
    https://t.me/GreenOneDollarGlobal
    https://greenonedollar.com
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // WBNB BSC  
    IDEXRouter router;
...
contract GreenOneDollar is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x602506D3024d8d552B995a55e8f67368B31Ce192; // token locker
    address public marketingFeeReceiver =
        0x4724A20B6224e65FcD16d46837e0C924645bD717;
    address public gamingFeeReceiver =
        0x6a391a1fE59569C2CA915E5098D7b1E6B2695C2B;
    address public buyBackFeeReceiver =
        0x9e06FfF6eEAD81941a97a3570E96D10188e83855;
    ...
    constructor()
        ERC20Detailed("GreenOneDollar", "GOD", uint8(DECIMALS))
    {
