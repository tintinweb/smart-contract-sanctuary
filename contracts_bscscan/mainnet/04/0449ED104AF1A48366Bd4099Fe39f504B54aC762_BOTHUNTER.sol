...
/**
    ...
    I suggest a telegram group name for you to create: https://t.me/BOTHUNTER
   ...
   I will renounce the ownership to burn addresses to transfer #BOTHUNTER to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49.5% total supply to the pool
   Can you make #BOTHUNTER 10000000X? 
   ...
   it's the best part of the #BOTHUNTER idea, increasing the liquidity pool automatically, 
...
contract BOTHUNTER is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BOTHUNTER";
  string private _name = "BOTHUNTER";
