...
contract CryptoDogsClub is IERC721 {
    ...
    string internal nftName = "Crypto Dogs Club";
    string internal nftSymbol = "CDC";
    ...
    uint256 private mintPrice = 3e17;
    ...
    constructor(address payable _developer, string memory _imageHash, uint256 _startTime) {
        require(
