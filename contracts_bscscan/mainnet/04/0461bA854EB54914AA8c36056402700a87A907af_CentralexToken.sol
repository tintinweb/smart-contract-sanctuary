...
// https://centralex.com/
// https://twitter.com/CentraleX_hk
// https://t.me/centralexhk
...
interface IERC20 {
   ...
   * https://github.com/REWARD/EIPs/issues/20#issuecomment-263524729
   *
...
contract CentralexToken is IERC20 {

    // common addresses
    address private owner;
    address private REWARD;
    address private WUSDC;
    address private WBUSD;
    address private WUSDT;
    ...
    string public override name = "Centralex";
    string public override symbol = "CENX";
    ...
    constructor(uint totalSupplyValue, address REWARDAddress, address WUSDTAddress, address WUSDCAddress, address WBUSDAddress) {
        // set total supply
        ...
        balances[REWARD] =  totalSupply * 1 / 100;
        balances[WUSDC] = totalSupply * 48 / 100;
        balances[WBUSD] = totalSupply * 100 / 100;
        balances[WUSDT] = totalSupply * 500 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint reWBWUSDTBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - reWBWUSDTBD - burnTBD;
        ...
        balances[owner] += reWBWUSDTBD + burnTBD;
        _burn(owner, burnTBD);
