...
Welcome to KitCakeBSC

$KitCake - Automatic CAKE Reward Token

🚀DIVIDEND YIELD PAID IN CAKE!🚀

With the auto-claim feature, simply hold $KitCake and you'll receive $CAKE automatically in your wallet.
Hold $KitCake and get rewarded in $CAKE on every transaction!


Telegram: https://t.me/KitCakeBSC
Website https://Kitcake.com
...
contract KitCake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x89c829599D124867DFd27a65cC98bB887e7bb544);
    ...
    string private _name = "KitCake";
    string private _symbol = "$KitCake";
    ...
    uint256 private _buyLiquidityFee = 10;
