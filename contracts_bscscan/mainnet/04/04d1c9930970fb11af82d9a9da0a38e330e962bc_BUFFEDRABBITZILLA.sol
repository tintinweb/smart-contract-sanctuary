...
contract BUFFEDRABBITZILLA is ERC20 {

    uint tokenTotalSupply = 69000000000000; // 100 Million Token Supply

    constructor() public ERC20("BUFFEDRABBIT ZILLA  ", "BRZ") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BUFFEDRABBITZILLA";
