...
contract StakingDetails {
    ...
    constructor() {
        stakeGetter = STAKE(0x6ddf0555fB4c56a122248149F2317BbB5Fe93c42); // live stake contract address
        //stakeGetter = STAKE(0x8D190277Ee9FCFcFe7F259B2Ef3Ce5a12Fd7669a); // testnet stake contract address
...
contract GAMEZILA_CBT_IDO {
    ...
    uint public totalAllocation = 390000 * 10**18;
    uint public tier1Alloc = 78000 * 10**18;
    uint public tier2Alloc = 97500 * 10**18;
    uint public tier3Alloc = 117000 * 10**18;
    uint public tier4Alloc = 78000 * 10**18;
    ...
    function buyToken() external payable  {
        ...
        uint tokens = (msg.value * priceOfBNB / (100000000/buyPriceDecimal)) / buyPrice;
    ...
    function setTierMemberCount() external {
        require(msg.sender == owner, "Only owner");
    ...
    function getTokens(uint bnbAmt) public view returns(uint tokens) {
        ...
        tokens = (bnbAmt * priceOfBNB / (100000000/buyPriceDecimal)) / buyPrice;
        return tokens;
    }
    ...
    function buyTokenWithBUSD(uint busdAmount) external {
       ...
       //BEP20 token = BEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); // BUSD address testnet
        
        address sender = msg.sender;
        uint userTier = getUserTier(sender);
        uint tokens = busdAmount / buyPrice * buyPriceDecimal;
   ...
   // add same claim to multiple addresses
    ...
    // Set updater address 
    function setUpdaterAddress(address to) external {
        require(msg.sender == owner, "Only owner");
        updater = to;
    }
