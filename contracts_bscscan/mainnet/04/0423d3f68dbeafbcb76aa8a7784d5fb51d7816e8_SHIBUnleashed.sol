...
12% tax per transaction
Reflections (SHIBA):  3% (minimum hold of 1 million Token to earn reflections)
Liquidity:  6%
Marketing:  3% 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRDSHIB = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    ...
    uint256 public minimumTokenBalanceForDividends = 1000000 * (10**9); // user must hold 1,000,000 token
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RWRDSHIB.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(RWRDSHIB);
        ...
        uint256 amount = RWRDSHIB.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RWRDSHIB.transfer(shareholder, amount);
...
contract SHIBUnleashed is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRDSHIB = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SHIB Unleashed";
    string constant _symbol = "SHIBxLEASH";
