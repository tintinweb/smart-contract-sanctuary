...
contract IceCubeCoin is Context, IERC20, Ownable {
    ...
    address public _marketingWallet = 0x4E72e4b5528C7B717532d40b96CdbcD02F552D91;
    ...
    string private _name = "IceCube Coin";
    string private _symbol = "ICECUBE";
    ...
    function setMinNumOfTokenToLiquidifiy(uint256 minTokens) external onlyOwner() {
        numTokensSellToAddToLiquidity = minTokens * 10**9;
    }
    ...
    function setUniswapRouter(address r) external onlyOwner {
        IUniswapV2Router02 uniswapV2Router2 = IUniswapV2Router02(r);
        uniswapV2Router = uniswapV2Router2;
    }
