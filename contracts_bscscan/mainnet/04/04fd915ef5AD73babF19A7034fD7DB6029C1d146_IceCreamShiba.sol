...
/**
 TG: https://t.me/IceCreamShiba
 Website : www.icecreamshiba.com
 Stealth Launch - Marketing Before and After Launch 
 From @MagiDevLaunch 
*/
...
contract IceCreamShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IceCreamShiba";
    string private _symbol = "ICSHIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDd8d4ae23D9c6316f70F3497C9706AAB6A8EbC13); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xDd8d4ae23D9c6316f70F3497C9706AAB6A8EbC13); // BuyBack Address
