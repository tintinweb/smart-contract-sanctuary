 ...
 * Token name : Biden Token
 * Supply: 333,000,000
 * Decimal place: 18 
 * Symbol : BIDEN 
 
 Telegram: https://t.me/BidenTG
 Website: https://www.bidentoken.org/
*/ 
...
contract BidenToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9fc3E7d3bdCf7fbb1B575Ce7032325e9cb9bc1CC); // Marketing Address
    ...
    uint256 private _tTotal = 333 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Biden Token";
