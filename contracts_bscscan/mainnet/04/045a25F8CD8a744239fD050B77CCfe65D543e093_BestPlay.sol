...
/**
 *                  COMMUNITY DRIVEN TOKEN - NO TELEGRAM
 *              COMMUNITY CAN MAKE ONE AND SHILL THE OUT OF IT.
 *      Reflection Fee: 15% | Liquidity Fee: 2% | Marketing Fee: 1%
 * 
 * Liquidity will be locked for 7 days initially.
 * Marketing fee will be used for automatic shill bots shills this token over 60 telegram groups
 * 
 * 
 * THE FIRST HIGHEST STABLE COIN THAT REWARDS 15% IN BUSD IN THE SPACE!
 *                      The $BestPlay ! 🤑🤑🤑
 * 
 * Maximum Buy: 12.5m Tokens
 * Maximum Wallet: 30m Tokens
 * BuyCooldown Enabled: 30 minutes
 * 
 * 
 *  Hold $BestPlay and get rewards in $BUSD on every transactions
 *          and you'll receive it automatically in your wallet !
 *
 * 
/**
*/
...
contract BestPlay is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BestPlay";
    string constant _symbol = "BPY";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 5 / 400;
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 8000; // 0.01% of supply
    bool inSwap;
