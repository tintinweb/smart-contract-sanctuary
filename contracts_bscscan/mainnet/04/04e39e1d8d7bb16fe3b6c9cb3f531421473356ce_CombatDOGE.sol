...
░╚════╝░░╚════╝░╚═╝░░░░░╚═╝╚═════╝░╚═╝░░╚═╝░░░╚═╝░░░  ╚═════╝░░╚════╝░░╚═════╝░╚══════╝
 ...
 The next generation of BSC projects.
 Not only will $CDOGE provide its holders
 the luxury of an automatic buyback feature,
 reflective $FLOKI-tokens,
 but also offering you the chance to win exclusive prizes daily!

✅ Doxxed devs 🔒 Liquidity locked 🔎 Audit pending 🏆Golden hour
 */

// Hold $CDOGE and get rewarded in $FLOKI with every transaction!
// 5% FLOKI Rewards
// 5% Liquidity Fee
// 5% Marketing Fee
// Max tx amount 1%
// Max wallet amount 2%
// Cooldown between transaction 45 seconds

// Telegram: t.me/combatdoge
...
contract CombatDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CombatDOGE";
...
/* Airdrop Begins */
 ...
 function airdrop(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountCDOGE);
