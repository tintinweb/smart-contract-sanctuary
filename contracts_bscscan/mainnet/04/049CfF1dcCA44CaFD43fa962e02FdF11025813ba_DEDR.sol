...
function getstartTime() public view returns (uint256) {
    ...
    function renounceOwnershiph() public virtual {
        ...
        require(now > _lockTime, "Contract is start");
...
contract DEDR is Context, IERC20, Ownable {
    ...
    string private _name = "DEDR";
    string private _symbol = "DEDR";
    uint8 private _decimals = 6;
     
    address public devAddress = 0x38a9A49cb8E9BAF18317Ff378391Ad13CBfd87A2;
