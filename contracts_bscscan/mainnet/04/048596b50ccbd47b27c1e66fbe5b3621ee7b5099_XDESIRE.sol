...
/***** <3 with tons of love from the XDESIRE TEAM
 XDESIRE - XDESIRE - XDESIRE - XDESIRE - XDESIRE - XDESIRE - XDESIRE - XDESIRE - XDESIRE
-..- -.. . ... .. .-. . <-puzzle <3 
******/
...
contract XDESIRE is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public charityAddress = 0x88E76817513d329f8c750Cc94fd31886571D2EEC;
    ...
    string private _name = "XDESIRE";
    string private _symbol = "XDESIRE";
    ...
    // Innovation for protocol by XDESIRE Team!
    ...
    uint256 public _liquidityFee = 14; // 4% will be added pool, 10% will be converted to BNB for a reward
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own Martians to claim reward');
