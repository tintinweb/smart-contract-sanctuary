...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        router.swapExactBTCForTokensSupportingFeeOnTransferTokens{value: msg.value}(
            0,
            path,
            address(this),
            block.timestamp
...
contract FindBitcoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FindBitcoin";
    string constant _symbol = "FBitcoin";
    ...
    address public autoLiquidityReceiver = 0x60528f9F00E8e5FC151e2873FcDD4e4FB3fFFd7c;
    address public marketingFeeReceiver = 0x60528f9F00E8e5FC151e2873FcDD4e4FB3fFFd7c;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x8bE601E1121905606343f389f3b933B18623EdbF;
    ...
    function swapBack() internal swapping {
        ...
        router.swapExactTokensForBTCSupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
            address(this),
        ...
        require(success, "receiver rejected BTC transfer");

        if(amountToLiquify > 0){
            router.addLiquidityBTC{value: amountBNBLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
    ...
    function buyTokens(uint256 amount, address to) internal swapping {
        ...
        router.swapExactBTCForTokensSupportingFeeOnTransferTokens{value: amount}(
            0,
            path,
            to,
            block.timestamp
    ...
    function manualSend() external authorized {
        uint256 contractBTCBalance = address(this).balance;
        payable(marketingFeeReceiver).transfer(contractBTCBalance);
    }
