...
contract DogeFinancelnu is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "DogeFinancelnu";
  string private _name = "DogeFinancelnu";
