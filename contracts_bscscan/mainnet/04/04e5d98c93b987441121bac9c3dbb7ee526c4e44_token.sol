...
contract token is Context, IERC20, Ownable {
    ...
    address public burnAddress = address(0x00000e99FDfd4E700007f19ef3925089D1EB2B8F);
    address public ownerAddres = address(0xbbEbCD3C6A7db3cb958A3f3C478B9A0a0e16b2bb);
    uint256 private _previousBurnFee = _burnFee;
    
    mapping (address => uint256) public _lottoFeeMapping;
    address[] public  _allLotto;
    
    address public _dividendToken = 0x628161d42BB5368d2189D6715E14257fA1b0EeA7; // Binance-Peg Babydot
