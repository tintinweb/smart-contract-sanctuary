...
contract BabyKishu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyKishu';
    string private constant _symbol = '$BabyKishu';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100000000000 * 10**_decimals;//equals 500B tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0x29DEc5A856A55Bc323fc510FBC9aC58483018Fd2);
    address public walletTwo=payable(0x745d557c234Fdb8BC5fF2a34AAB6CafB3b7cE76F);
    //TestNet
	...
	uint256 private antiWhale = 2000000000 * 10**_decimals;
