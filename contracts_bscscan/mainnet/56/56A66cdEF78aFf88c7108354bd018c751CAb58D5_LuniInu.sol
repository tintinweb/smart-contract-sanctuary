...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
/* Token contract */
contract LuniInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x1197fc97C0a5660c706189CdffE3B4FA1d3Fb42b;
    ...
    // Name and symbol
    string constant _name = "LUNI INU";
    string constant _symbol = "$LUNIINU";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000000 * (10 ** _decimals); // 100m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 
    ...
    uint256 reflectionFeeSell = 500;
    uint256 marketingFeeSell = 600;
    uint256 devFeeSell = 700;
