...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/ve/n/om/ca_ke/pull/522
        if (a == 0) {
            return 0;
        }
...
contract TEK is IERC20 {
    ...
    string constant _name = "TEK COIN";
    string constant _symbol = "TEK";

    uint256 public _liquidityFee = 500;
    uint256 public maxLiquidityFee = 600;
    uint256 public _reflectionFee = 200;
    ...
    address payable private _marketingWallet = payable(0x3476137ec837D6e618E09a41Daf32dffBB3178CB);
