...
Mike is a squirrel who loves nuts. He eats them in ignorance. 
What does this have to do with crypto? Nothing at all, Mike's Nuts is a token without sense like many others, but safe and guaranteed to be free of harmful substances. 
Come and get the 8% BNB reward nuts.

https://t.me/MikesNutsOfficial
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x95b1Ec215cFeC02cba3516D761ACd66BC1194d76); // Marketing Address
    address payable public devAddress = payable(0x2B8E53Aff50CfaE29F6D4093DAfa283e0C109C5D); // Dev Address
    ...
    uint256 public _taxFee = 8;  // rewards to holder
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 7;   // Marketing + dev + buyback
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public devAndMarketingDivisor = 4;
...
contract MikesNuts is ERC1363, TokenRecover {
    constructor ()
        ERC1363("MikesNuts", "NUTS")
    {
    }
}