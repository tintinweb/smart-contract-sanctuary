...
//Official links: https://t.me/linknomics
...
interface IDEXRouter {
    ...
    function WLINK() external pure returns (address);
    ...
    function swapExactLINKForTokensSupportingFeeOnTransferTokens(
        uint amountOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ...
    function swapExactTokensForLINKSupportingFeeOnTransferTokens(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        router.swapExactLINKForTokensSupportingFeeOnTransferTokens{value: msg.value}(
            0,
            path,
            address(this),
            block.timestamp
...
contract Linknomics  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Linknomics";
    string constant _symbol = "Linkn";
    ...
    function swapBack() internal swapping {
        ...
        router.swapExactTokensForLINKSupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
            address(this),
        ...
        if(amountToLiquify > 0){
            router.addLiquidityLINK{value: amountBNBLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
