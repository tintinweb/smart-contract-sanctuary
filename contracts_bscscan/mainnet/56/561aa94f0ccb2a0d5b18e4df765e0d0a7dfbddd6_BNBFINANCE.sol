...
* https://bnbcute.finance/
https://twitter.com/bnbcutefinance
*/
...
contract BNBFINANCE is Context, IERC20, Ownable {
    ...
    string private _name = 'BNBFinance';

    string private _symbol = 'BNBF';
