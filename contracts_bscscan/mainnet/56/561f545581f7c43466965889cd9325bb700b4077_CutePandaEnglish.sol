...
contract CutePandaEnglish is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "CPE";

  string private _name = "CutePandaEnglish";
