...
Yass queen. Are you tired of being a high school drop out that never did something with their life? Are you looking for the respect and status you have always so much desired but never got? Then come on, be your own boss, ‘work’ from home, this is not an MLM company, this is not a scheme, it is Pyramid Finance.
The deal is simple, you buy in, then get others to join, then you get more, then they get people to join as well and we all get richer. Let me draw you a handy pyramid shape to explain how it works.
...
On top is me, and you guys are all the building blocks of this sch…. Project… finance!

6% Marketing and buyback fee (combined)
1% Fee for the great leader of the pyramid
3% Liquidity fee

https://t.me/PyramidFinance

For more crappy crapcoins like this. 
...
contract PyramidFinance is ERC20Detailed, Ownable {
...
*/
    constructor() ERC20Detailed("PyramidFinance", "PYMDF", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x6CF75734505093F60dce080606F189A35eA178Da;
        marketingFeeReceiver = 0x6CF75734505093F60dce080606F189A35eA178Da;
        teamFeeReceiver = 0x221593355b46f7Dd7AcF951C044e5bAE1b1cE56F;
        buyBackFeeReceiver = 0x6CF75734505093F60dce080606F189A35eA178Da;
