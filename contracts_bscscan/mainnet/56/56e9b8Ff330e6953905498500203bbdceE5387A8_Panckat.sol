...
contract Context {
 ...
 contract Panckat is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Panckat";
    string private _symbol = "PANCKAT";
    ...
    address private _MarketingWalletSYLOM = 0x32B21F766099bE9aBCc260ea732C01Fac85aC7B4;
