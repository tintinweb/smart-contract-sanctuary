...
contract ShibaM is Context, IERC20, Ownable {
    ...
    address public marketingAndTeamFeeWallet = 0x20bb46fe51E53468ccD0F154eDE55D93d5567452;
	...
	function setMarketingAndTeamFeePercent(uint256 marketingAndTeamFee) external onlyOwner() {
        _marketingAndTeamFee = marketingAndTeamFee;
    }
	...
	function setNumTokensSellToAddToLiquidity(uint256 newLiquify) external onlyOwner() {
        numTokensSellToAddToLiquidity = newLiquify;
    }
