...
contract BabyVenom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyVenom";
    string private _symbol = "BabyVenom";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2cb524c79aa1223e8F6eEec380a059f5dAa0Af4f); // Marketing Address
    address payable public ProjectWalletAddress = payable(0x2cb524c79aa1223e8F6eEec380a059f5dAa0Af4f); // Project Wallet Address
    ...
    uint256 public _maxTxAmount = 5000000000 * 10**9; // 2%
    uint256 public _walletMax = 20000000000 * 10**9; // 2%
