...
https://t.me/SlumDogeMillionaireBSC

Go from Jeet to millionaire, hold Slumdoge Millionaire!

Get paid Doge reflections, low tax 13% that shit perfections!
...
contract SlumDogeMillionaire is IBEP20, Auth {
    ...
    string constant _name = "SlumDoge Millionaire";
    string constant _symbol = "$SDM";
