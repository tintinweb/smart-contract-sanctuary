...
8% token reward for holders with special NFT features
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 200000 * (10 ** 18);
...
contract AdaFOMO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address ZERO = 0x0000000000000000000000000000000000000000;
        ...
        string constant _name = "Ada FOMO";
    string constant _symbol = "AFOMO";
