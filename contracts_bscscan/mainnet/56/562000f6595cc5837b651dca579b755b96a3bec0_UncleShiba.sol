...
contract UncleShiba is IBEP20, USHIBAuth {
    ...
    function cleanUp(uint256 amount) external onlyOwner {
        ...
        require(amount <= _balances[address(this)], "Amount is greater than current balance");
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            uint256 BNBsold = address(this).balance.sub(balanceBefore);
            (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: BNBsold, gas: 30000}("");
