...
contract DogeBite is IERC20, Context, Ownable {
    ...
    // token data
    string constant _name = " DogeBite";
    string constant _symbol = " DBT";
    ...
    uint256 public _maxWalletToken = 300000000000000 * (10**18);
    // balances
    ...
    // total fees
    uint256 totalFeeSells = 8800;
    uint256 totalFeeBuys = 500;
    uint256 feeDenominator = 10000;
    // receiving addresses
    address public autoLiquidityReceiver;
    
    address public marketingFeeReceiver = 0x05770AcD221e8fDB5Cd6b2DCee114bCdd80eEC33;
