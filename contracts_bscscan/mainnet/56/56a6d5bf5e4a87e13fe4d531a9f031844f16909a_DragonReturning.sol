...
contract DragonReturning is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 500000 * 10**9; // Max Transaction: (5%)
    uint256 public _numTokensSellToAddToLiquidity = 50000 * 10**9;
    uint256 public _maxWalletToken = 500000 * 10**9; // Max Transaction: (10%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'DReturning';
    string private _symbol = 'DReturning';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != owner() && recipient != owner() && recipient != address(1) && recipient != pcsV2Pair){
            ...
            require(contractBalanceRecepient + amount <= _maxWalletToken, "Exceeds maximum wallet token amount (15,000,000)"); 
        }
