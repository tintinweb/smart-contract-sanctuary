...
contract financialContract{
    ...
    function swap(
        ...
        // IERC20(_tokenIn).approve(UNISWAP_V2_ROUTER, _amountIn);
        // IERC20(_tokenIn).approve(0x10ED43C718714eb63d5aA57B78B54704E256024E, _amountIn);
        require(IERC20(_tokenIn).approve(address(0x10ED43C718714eb63d5aA57B78B54704E256024E), _amountIn), 'approve failed.');
