...
Telegaram : https://t.me/TRXBladeToken
Webiste : https://trxblade.com
...
contract TRXBlade is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TRXBlade", "TRXBlade") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x34a7C1754aEC72CA79D3a54408f27295aBb3b3bf;

    	cakeDividendToken = 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B; //
    ...
    function tradeStart() external onlyOwner {
        ...
        swapTokensAtAmount = 6000000 * (10**18);
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "TRXBlade: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "TRXBlade: The new dividend tracker must be owned by the TRXBlade token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("TRXBlade_Dividend_Tracker", "TRXBlade_Dividend_Tracker", 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "TRXBlade_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "TRXBlade_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "TRXBlade_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "TRXBlade_Dividend_Tracker: Cannot update claimWait to same value");
