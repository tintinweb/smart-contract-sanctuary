...
contract KamiShiba is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "KamiShiba";
    string constant _symbol = "KMS";
    ...
    function clearBuybackMultiplier() external onlyManager {
    ...
    function setTxLimit(uint256 amount) external onlyManager {
    ...
    function setIsFeeExempt(address holder, bool exempt) external onlyManager {
    ...
    function setDistributorSettings(uint256 gas) external onlyManager {
        require(gas < 750000);
        distributorGas = gas;
    }
