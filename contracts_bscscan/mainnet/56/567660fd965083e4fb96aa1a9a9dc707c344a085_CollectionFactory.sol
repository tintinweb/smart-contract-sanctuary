...
// Interface to get minting chareges from Mintable token
 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721Base is Ownable, ERC721, HasContractURI, HasTokenURI, ERC721Enumerable {
    // Token name
    string public name;
    ...
    // mintingCharges in wei, Will be controlled by owner of Mintable Token Contract
    address payable private mintableToken;    
    address payable private brokerAddress;
    ...
    constructor (
        ...
        address payable _mintableToken,
        address payable _brokerAddress
    ...
    function revertFunction() payable public returns(bool success) {
        return true;
    }
    ...
    function mintingCharge() public view returns (uint256) {
        return IMintableToken(mintableToken).mintingCharge();
    }
    ...
    function _mint(address to, uint256 tokenId,  uint _royality) internal {
        ...
        brokerAddress.transfer(msg.value);
    }
...
contract Collection is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base{
...
contract CollectionFactory is Ownable{
     ...
     * @dev Constructor function
     */
    constructor(address payable _mintableToken, address payable _brokerAddress) public{
