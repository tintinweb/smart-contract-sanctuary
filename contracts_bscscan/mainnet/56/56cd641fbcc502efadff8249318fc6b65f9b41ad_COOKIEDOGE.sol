...
contract COOKIEDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x63d97bfb33998561D315b495607E9876c8A03B3c); // Marketing Address
    ...
    string private _name = "COOKIE DOGE";
    string private _symbol = "COOKIEDOGE";
