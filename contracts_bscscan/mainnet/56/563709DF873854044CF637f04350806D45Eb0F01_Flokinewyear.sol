...
*                 FLOKINEWYEAR
* 
* Dividend Token that reward $DOGE every 60 minutes!
*     
* Fees on Buy&Sell: 15%
*
* 🌲 Let's have a celebration to welcome 2022 . 
* This meme token is a good luck charm and probably the next post of Elon on Twitter,
* so investors can probably enjoy 50x off of their initial investment. 
* 
* https://t.me/FLOKINEWYEAR2K22
* 
* https://
* 
...
contract Flokinewyear is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Floki New Year";
    string constant _symbol = "FNY22";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x56628F89D50A0eEA874a3f69b64c5AcEF3bFCdE1; // liquidity
        marketingWallet = 0xa8452f2Aabf65AA508ecF6667a8c258149216b58;  // marketing
