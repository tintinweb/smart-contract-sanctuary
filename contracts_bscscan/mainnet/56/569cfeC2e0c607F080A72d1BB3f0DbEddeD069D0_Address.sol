...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB0DBb99507c80d1127c16Bb144f38eFc928a3A85;
...
contract RIKR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1D40df418cB9a7120166c4DAf4e17E8A96851342;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "RIKR";
    string private _symbol = "RIKR";
