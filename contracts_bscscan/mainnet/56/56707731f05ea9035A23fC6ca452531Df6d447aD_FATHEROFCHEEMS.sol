...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
...
contract FATHEROFCHEEMS is IBEP20, Auth {
    ...
    // Addresses
    address CAKE = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x1abb667AC5aE3c16Ecc469D871Db7B110318E342;
    address MARKETING = 0x38E8893ea5c3810b58Aea96B0f4035308D4865C9;
    ...
    // Name and symbol
    string constant _name = "FATHEROFCHEEMS";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = 1000000000000000 * (10 ** _decimals);   
    uint256 public _maxSellTxAmount = 500000000000000 * (10 ** _decimals);   
    ...
    uint256 GREEDDuration = 1200;
    
    // Dead blocks
    uint256 deadBlocks = 0;

    // Sell amount of tokens when a sell takes place
    uint256 public swapThreshold = 50000000000000 * (10 ** _decimals);  
