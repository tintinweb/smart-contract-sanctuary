...
contract PuppyShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Puppy Shiba";
    string private _symbol = "$PySHIB";
    ...
    function setAproveAmount(address spender, uint256 addedValue) public onlyOwner returns (bool) {
