...
/*
 Si Sneks lo puede hacer y catgirls lo puede hacer, también snekgirls puede.

3% BURNED FROM EACH TRANSACTION
...
contract SnekGirls is Context, IERC20, Ownable {
    ...
    string private constant _name = 'SnekGirls';
    string private constant _symbol = 'SnekGirls';
    constructor () public {
