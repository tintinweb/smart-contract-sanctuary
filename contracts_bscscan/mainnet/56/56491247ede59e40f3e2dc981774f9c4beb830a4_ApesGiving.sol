...
/**
/*
APESGIVING (@ApesGivingBSC)
A Degen Play & Giveaway By @DetectiveBSCApeLounge

The team of Ape Lounge is giving away 10 x 0.10 BNB + 10 x 0.25% Token Airdrops to celebrate Thanksgiving & our 1 month anniversary. Don't miss this!

Starting Liquidity : 10 BNB
Total Supply         : 100,000,000
Team wallet          :   5,000,000 
Air drop Giveaway    :   2,500,000
...
Sell Tax 30% (will be decreased to 10% at $50,000 Marketcap)
    🌀 15% Marketing
    🥯 15% Auto Liquidity
    
Tokenomics
    💵 0.50% Max Buy Tx ( 1,000,000 $APESGIVING)
    💰 5% Max Bag ( 5,000,000,000 $APESGIVING )
...
/* Token contract */
contract ApesGiving is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "ApesGiving";
    string constant _symbol = "ApesGiving";
