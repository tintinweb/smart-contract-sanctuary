...
contract Ownable is Context {
     ...
     */
    modifier onlyuner() {
        require(_owner == _msend(), "Ownable: caller is not the aishia");
        _;
    }
...
contract WildT1mes is Context, iBEH20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = 'Wild $T1mes';
    _decimals = 4;
    _totalSupply = 1000000000000000 * 10**4;
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**4;
