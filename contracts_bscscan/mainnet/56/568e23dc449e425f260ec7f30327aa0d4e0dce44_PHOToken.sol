...
contract PHOToken is IERC20
{
    ...
    address _owner;
    uint256 _maxSupply= 21940 * 1e18;

    string constant  _name = 'Phoenix Community Token';
    ...
    address public poolOwner=0x07a295F9768979689FEff5Bb86b14a8c3EEFf762; //分红池地址
    uint256 public poolRatio=40; //分红池比率 1000为基数
    address public congressOwner=0x16247107B13eb164345Df98d889D4C7AEF971116; //国会手续费地址
    uint256 public congressRatio=20; //国会手续费比率
    address public partnerOwner=0xB5aCA38179a11FB1Af73F226905e37B9cDE29437; //合伙人地址
    uint256 public partnerRatio=40; //合伙人比率
    uint256 public destroyRatio=0; //销毁比率
    ...
    function setFeeOwners(address poolAddr,address congressAddr,address partnerAddr) public
    {
        require(msg.sender==_owner,"Only the owner can perform the operation");
        poolOwner=poolAddr;
        congressOwner=congressAddr;
