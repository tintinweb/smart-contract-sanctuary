...
/**  
   ...
   100,000,000 tokens limitation for trade, which is 100% of the total supply
...
contract OGET is Context, IERC20, Ownable {
    ...
    uint256 private _liquidityFee = liquidityFee.add(developmentFee);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap 
	{
		...
		uint256 developmentPart = newBalance.sub(liquidityPart);
