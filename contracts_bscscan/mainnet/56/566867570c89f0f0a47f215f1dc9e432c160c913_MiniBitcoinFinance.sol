...
/**
Welcome to Mini Bitcoin Finance Contract

Mini Bitcoin Finance is the first investment
as a service token on the BEP20 network The
investments on our platform are fully decided
by the token holders and will be
verified and saved within our smart contract.

BENEFIT
3 benefits for our investors

🌐 Check Website: https://minibitcoinfinance.co/

🕊 Check Twitter:
https://twitter.com/MINI_BTC_NEWS

Telegram : https://t.me/MiniBitcoinFinance
...
contract MiniBitcoinFinance is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 50000 * 10**7 * 10**4; // 10B 
    ...
    uint256 public _maxTxAmount = 50000 * 10**7 * 10**4; // 10B 
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 50000 * 10**7 * 10**4; // 10B
