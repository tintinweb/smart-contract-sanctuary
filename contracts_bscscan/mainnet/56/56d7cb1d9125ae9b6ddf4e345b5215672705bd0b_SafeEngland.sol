...
/**
   ...
   Welcome to SafeEngland
   
   This is a community token. If you want to create a telegram I suggest to name it to @SafeEngland
...
contract SafeEngland is Context, IERC20, Ownable {
    ...
    string private _name = "Safe England";
    string private _symbol = "SAFEENGLAND";
