...
contract Presale is Owned {
    ...
    address public mainCurrencyAddress;     //is address mainToken, BUSD:decimal 18
    address public presaleTokenAddress;     //decimal 9
    
    uint256 public tokenPrice = 10;     // 10 busd
    ...
    function buy(uint256 _paidAmount) public {
        ...
        uint tokenAmount = _paidAmount.mul(tokenPrice).mul(10**9).div(10**18);
