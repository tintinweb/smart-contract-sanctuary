...
contract SonOfCake is Context, IERC20, Ownable {
    ...
    string private _name = "SonOfCake";
    string private _symbol = "SOCAKE";
    ...
    address public devWallet = 0xeCE3b9FCa01e48E9E1B449d160e96F995fF34356;
    ...
    uint256 public _maxTxAmount = 1 * 10**11 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**4 * 10**9;
    uint256 public _maxWalletToken = 3 * 10**11* 10**9;
