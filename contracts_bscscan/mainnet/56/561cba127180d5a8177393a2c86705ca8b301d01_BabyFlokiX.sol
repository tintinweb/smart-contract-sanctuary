...
contract BabyFlokiX is Context, IERC20, Ownable {
    ...
    address payable marketingAddress = payable(0x7db4Ae35792B5339C2aa4cBFbEEDBd01cD7e78C9); 

    uint256 private constant MAX = ~uint256(0);
    string private _name = "BabyFlokiX";
    string private _symbol = "BabyFlokiX";
