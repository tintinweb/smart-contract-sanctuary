...
contract MononoKing is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "MononoKing";
   string constant _symbol = "MKING";
...
uint256 reflectionFee = 300;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xfF778FC9701Ec1c1DA6C285E159E15b5d3eF966B;
