...
contract Utopia is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x35A888E7d551dA76D36EBA0d62D8686E2983A138;
    ...
    constructor() public ERC20("Utopia", "UTP") {
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Utopia: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Utopia: Cannot update gasForProcessing to same value");
...
contract UtopiaDividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "Utopia_Dividend_Tracker: claimWait must be updated to between 0.5 and 24 hours");
