...
Poochon Inu token is a meme-utility token connected with an already existing ecosystem with staking functionalities and NFTs Market place
...
// CHANGE
contract PoochonInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Poochon Inu";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x40B1086F2a19d367d4FA31e0bE67abb1bdA52959);
