...
contract PENGUININU is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _symbol = "PENGUIN";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = ( _totalSupply * 25 ) / 1000 ; // 2.5%
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x5816c925B0e7DE910F7dFe520C04Fc2b7d61a310;
