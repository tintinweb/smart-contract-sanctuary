...
/**
   ...
   Welcome to ScaredLion
   
   This is a community token. If you want to create a telegram I suggest to name it to @ScaredLionBsc
   ...
   I will renounce the ownership to burn addresses to transfer #ScaredLion to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 10% total supply to the pool
   Can you make #ScaredLion 10000X? 

   1,000,000,000, total supply
   5,000,000 tokens limitation for trade, which is 0.5% of the total supply
   ...
   it's the best part of the #ScaredLion idea, increasing the liquidity pool automatically, 
...
contract ScaredLion is Context, IERC20, Ownable {
    ...
    string private _name = "ScaredLion";
    string private _symbol = "ScaredLion";
