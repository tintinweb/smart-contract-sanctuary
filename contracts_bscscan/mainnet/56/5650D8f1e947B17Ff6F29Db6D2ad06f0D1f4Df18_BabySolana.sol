...
/**
           ___       _             __       _                   
          / __\ __ _| |__  _   _  / _\ ___ | | __ _ _ __   __ _ 
         /__\/// _` | '_ \| | | | \ \ / _ \| |/ _` | '_ \ / _` |
        / \/  \ (_| | |_) | |_| | _\ \ (_) | | (_| | | | | (_| |
        \_____/\__,_|_.__/ \__, | \__/\___/|_|\__,_|_| |_|\__,_|
                           |___/                                

    TELEGRAM: https://t.me/BabySolanaCommunity
    WEBSITE: https://www.BabySolana.NET/
    Baby Solana is the newest BSC gem
    This project was launched as a fairlaunch and will be community run.

    Some features of Baby Solana token:
    20% FEES PER TRANSACTION
    - 16% fee per transaction auto distributed to holders in rewards
    - 2% fee per transaction auto distributed to marketing wallet
    - 2% fee per transaction auto distributed to liquidity
    
    Baby Solana Token starts with 2 BNB in liquidity so no whales will be present.
...
contract BabySolana is IBEP20, Auth {
    ...
    string constant _symbol = "BabySOL";
