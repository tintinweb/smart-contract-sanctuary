...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x342233E905112E702f11D84dC03Cc2eb969b171B;
...
contract TOOL is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeF8b119Ae3cdd47BF263b493160B398CfA90A9F4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Tool Token";
