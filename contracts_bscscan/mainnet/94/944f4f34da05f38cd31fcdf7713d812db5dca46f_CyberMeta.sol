...
// File: nft-ne-fu1/cmeta/lib/IterableMapping.sol
...
// File: nft-ne-fu1/cmeta/interface/IPancakeswap.sol
...
// File: nft-ne-fu1/cmeta/CyberMetaRewardsTracker.sol
...
contract CyberMetaRewardsTracker is RewardPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public RewardPayingToken("CyberMetaRewardsTracker", "CyberMetaRewardsTracker") {
        claimWait = 3600;
        // minimumTokenBalanceForRewards = 2000 * (10**18); // 1000 coins to get earnings
        minimumTokenBalanceForRewards = 100 * (10**18); // 1000 coins to get earnings instead
    } 
...
// File: nft-ne-fu1/cmeta/CyberMeta.sol
...
contract CyberMeta is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CyberMetaRewardsTracker public rewardsTracker;
    ...
    constructor() public ERC20("CyberMeta", "CMETA") {
        ETHRewardsFee = 2;
        liquidityFee = 2;
        teamFee = 6;
    	...
    	rewardsTracker = new CyberMetaRewardsTracker();
        ...
        maxSellTransactionAmount = 250 * (10**18);

        excludeFromFeesUntilAtAmount = 10 * (10**18);
    ...
    function updateRewardsTracker(address newAddress) public onlyOwner {
        CyberMetaRewardsTracker newRewardsTracker = CyberMetaRewardsTracker(payable(newAddress));

        require(newRewardsTracker.owner() == address(this), "The new one must be owned by the CyberMeta token contract");
    ...
    function setUseFees() external onlyOwner {
