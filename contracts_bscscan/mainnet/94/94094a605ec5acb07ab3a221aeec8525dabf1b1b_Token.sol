...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "MGFA";
    string private _symbol = "MGFA";
    ...
    uint256 public _poolFeeA = 10;
    uint256 private _previousPoolFeeA = _poolFeeA;
    address public _poolAddressA = 0xa80b82073C149fF9464358F7c990E342750D4111;

    uint256 public _poolFeeB = 15;
    uint256 private _previousPoolFeeB = _poolFeeB;
    address public _poolAddressB = 0x000000000000000000000000000000000000dEaD;
    ...
    uint256 public _maxTxAmount = 2100 * 10**4 * 10**18;
    uint256 public numTokensSellToAddToLiquidity = 2100 * 10**4 * 10**18;
    ...
    constructor () public {
		...
		_isExcluded[_poolAddressB] = true;
