...
/**
BabyTiger (BABYTIGER) Oficial

Supply 300
Maxbuy: 6 Tokens
Queima: 15% inicial e 15% após 1 hora
Taxa: 20%

https://t.me/babytigeren
*/
...
contract BabyTiger is BSC, Math {
    string public name =  "BabyTiger";
    string public symbol =  "BABYTIGER";
    uint8 public decimals = 9;
    uint public _totalSupply = 3*10**2 * 10**9;
