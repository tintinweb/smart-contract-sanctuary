...
contract NinnekoBox is Initializable, ERC721EnumerableUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize(address _addPoint) public initializer {
        ...
        pricePointPerBox = [50**18, 600 * 10**18];
    }
    ...
    function SwapPointToBox(uint256 _typeBox, uint256 _amount) public whenNotPaused {
        ...
        require(map[msg.sender] + _amount <= maxBoxBuyByPointPerUser[_typeBox], "you run out of purchases");
        ...
        tokenPoint.transferFrom(msg.sender, owner(), price * _amount);
