...
contract NFTPoolWithLockRank is ReentrancyGuard, Pausable {
    ...
    uint256 public maxDepositsPerUser = 25;
    uint256 public maxCountPerDeposit = 100;
    uint256 public pricePerCard;
    uint256 public rankTokenId;
    ...
    constructor() public {
        ...
        lockingPeriod = 5 weeks;
        pricePerCard = 8500000000 * 10**18;
        tokenId = 5;
        rankTokenId = 4;
    }
    ...
    function setTokenIds(uint256 _tokenId, uint256 _rankTokenId) external restricted {
        tokenId = _tokenId;
        rankTokenId = _rankTokenId;
        emit TokenIdsUpdated(_tokenId, _rankTokenId);
    }
    ...
    event TokenIdsUpdated(uint256 tokenId, uint256 rankTokenId);
