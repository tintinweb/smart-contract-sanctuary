...
contract MOON is BEP20('White Moon Finance', 'MOON'), HasForeignAsset {
...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 moonReward = multiplier.mul(moonPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
         ...
         if (moon.allowance(devaddr, address(this)) > moonReward) {
            moon.transferFrom(devaddr, address(this), moonReward);
        }
