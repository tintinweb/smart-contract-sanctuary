...
// File: contracts/FrogPePe.sol


pragma solidity ^0.8.0;
contract FrogPePe is ERC20, Ownable {
    ...
    constructor() ERC20("FrogPePe", "PePe") {
        _mint(msg.sender, 100000000000000*10**decimals());
        _mint(address(this), 900000000000000*10**decimals());
        startSale(block.number, 999999999, 0,2000000*10**decimals(), 2000000000000);
