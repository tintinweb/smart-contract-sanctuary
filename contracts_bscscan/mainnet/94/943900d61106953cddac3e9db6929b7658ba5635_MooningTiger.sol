...
contract MooningTiger is Context, IBEP20, Ownable { 
    using SafeMath for uint256;
    ...
    address public externalAddress = 0x22D1E2657bA16496418541afFDc16393548DebbF;
    address public autoLiquidityReceiver = 0x0000000000000000000000000000000000000000;

    string constant _name = "Tiger Moon Token";
    string constant _symbol = "TIGMT";
    ...
    uint256 public _antiwhalefee = 0;
