...
/**
 * $$ LordDoge $$
 * LordDoge has reflection, BNB rewards, anti-whale, anti-robot system, making it one of the most powerful token on Binance Smart Chain
 * Join us, be a Real Lord in Real World
 * https://www.LordDoge.finance
 * https://t.me/LordDoge_Official
 * https://twitter.com/LordDogeToken
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _luckyBonusFee = 5; // be allocated to Lord Identity buyers
    uint256 private _holderBonusFee = 3; // hodler's bonus for hodling more than oneday
    ...
    uint256 public _require2 = 1 * 10**13 *  10**18;  //100 * 10**8 * 10**18;     
