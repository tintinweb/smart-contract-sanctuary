...
contract MiniShibADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniShibADA";
    string constant _symbol = "MSADA";
    ...
    function setFlexibleBuy(bool _status) public onlyOwner {
        tradingOpen = _status;
    }
