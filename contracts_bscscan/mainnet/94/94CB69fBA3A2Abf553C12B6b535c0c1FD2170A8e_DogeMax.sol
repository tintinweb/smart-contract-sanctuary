...
// Telegram: https://t.me/DogeMaxDMX/
// Website: https://www.dogemax.io/

// 70% Liquidity Locked on DX sale.  Private sale Allocation is the same price as Presale and Listing.
// Doge Power Utilized to the Maximum!

// Minimum Slippage: 15% +

/**   DDDDD    OOOOO    GGGG    EEEEEEE  MM    MM     AA     XXX     XXX
 *    DD  DD  OO   OO  GG  GG   EE       MMM  MMM    AA AA    XXX   XXX
 *    DD   DD OO   OO GG  ..... EEEEE    MM MM MM   AAA AAA     XXXXX
 *    DD  DD  OO   OO GG   GG   EE       MM    MM  AAA A AAA   XXX  XXX
 *    DDDDD    OOOOO    GGGG    EEEEEEE  MM    MM  AAA   AAA  XXX    XXX
 *
*/
...
pragma solidity ^0.6.12;
    ...
    contract DogeMax is Context, IERC20, Ownable {
        ...
        string private _name = 'DogeMax';
        string private _symbol = 'DMX \xE2\x9A\xA1';
