...
// Highest Shiba Inu Rewards!

Tokenomics:
   * 10% Shiba Inu Rewards
...
contract DogeCoinReward is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge Coin Reward";
    string constant _symbol = "DOGECOINREWARD";
