...
TG: https://t.me/firedogex

returning from rice. let the pot break - anonymous 
...
contract FIREDOGEX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "fireDogeX";
    ...
    address payable constant private _marketingAddress = payable(0x2057d58AaCfd0fd35dD8670a88096c4B777ac5A4);
    address payable constant private _buybackAddress = payable(0xDaA33e96D1193F6b68f1bbc992d9dD3f5de87e61);
    address payable constant private _projectMaintainence = payable(0xb22F04BfEa356D6765CB4518e410Aec4AF69eE9E);
