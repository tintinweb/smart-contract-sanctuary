...
/**
 * @title La2Test ERC20 token
 *      
 */
contract La2Test is ERC20Detailed, Ownable {
    ...
    address payable _marketingAddress = 0x001e70591f8E1a4162a950038B8442643124b975;
    ...
    constructor ()
        ERC20Detailed("La2Test", "La2Test", uint8(DECIMALS))
        payable
        public
    {
