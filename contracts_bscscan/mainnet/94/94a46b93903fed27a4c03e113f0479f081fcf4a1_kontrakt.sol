...
// File contracts/kontrakt.sol


pragma solidity >=0.8.0;
contract kontrakt is ERC20('kontrakt', 'kontrakt'), Ownable {
    ...
    function swapAndLiquify() private lockTheSwap transferTaxFree {
        ...
        bool overMinimumTokenBalance = contractTokenBalance >= minAmountToSwap;
        if (overMinimumTokenBalance) {
            contractTokenBalance = minAmountToSwap;
    ...
    function setMinAmountToSwap(uint256 _minAmountRate) external onlyOwner {
        require(_minAmountRate <= MAX_BP_RATE);
        minAmountToSwap = totalSupply().mul(_minAmountRate).div(MAX_BP_RATE);
    }
