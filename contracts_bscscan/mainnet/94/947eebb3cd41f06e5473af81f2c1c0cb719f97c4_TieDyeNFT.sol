...
/**
$TieDyeNFT Tokenomics:
+  Total Supply : 100.000.000.000.000 
+  Burn: 50.000.000.000.000 (50%) 
+  PCS : 37.000.000.000,000 (37%) 
+  TeamWallet: 3.000.000.000.000 (3%)
+  Challenges, airdop:  5.000.000.000.000 (5%)
+  Marketing:  5.000.000.000.000 (5%)
 
 16% Transaction Fees
 10% is auto redistributed to all holders In CAKE Hold $TieDye tokens, earn CAKE. 
 Auto Paid For the first time ever, you don’t need to claim your earned CAKE. It’s automatically sent to your wallet.
...
=> Liquidity Secured By DxSale Liquidity will be locked with Mudra for 30 days
...
contract TieDyeNFT is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "TieDyeNINJA";
    string constant _symbol = "TIEDYENINJA";
