...
contract Akita is Context, IERC20, Ownable{
    ...
    uint256 public _BuytaxFee = 50; // % of transactions will be redistributed among holders
    uint256 public _BuyliquidityFee = 100; // % of transactions will be kept for liquidity
    uint256 public _BuyburnFee = 200; // % of transactions will be burned
    uint256 public _BuymarketingFee = 50; // % of transactions will be kept for marketing wallet
    uint256 public _SelltaxFee = 100; // % of transactions will be redistributed among holders
    uint256 public _SellliquidityFee = 200; // % of transactions will be kept for liquidity
    uint256 public _SellburnFee = 200; // % of transactions will be burned
    uint256 public _SellmarketingFee = 50; // % of transactions will be kept for marketing wallet
    ...
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out AKita!");
