...
/**
   ...
   First social - https://t.me/littlebeebsc
   
   #Little Bee features:
   5% fee auto add to the liquidity pool to locked forever when selling
   5% fee auto distribute to all holders
   I created a black hole so #Little Bee token will deflate itself in supply with every transaction
   .
...
contract Littlebee is Context, IBEP20, Ownable {
    ...
    string private _name = "LITTLE BEE";
    string private _symbol = "LTBEE";
    ...
    uint256 public _maxTxAmount = 100000000000000000000000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100000000000000000000000 * 10**6 * 10**9;
...
//to the moon - creator bsc adress: 0x1a2ee6f12bB0e72E6B521E134e63C146ea58D702