 ...
 * Max wallet 5%
 * Tax 13% - 2% marketing / 3% lp / 8% BUSD Rewards
 * 
 * Telegram: @TurkeyTokenOfficial
 * Twitter: @Turkey_token
 * 
 * BUY TURKEY, GET RICH, BE THANKFUL
 */
/*
 */
...
/* Token contract */
contract TurkeyToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x61ccb495eF4432fE2e6733Cb83E89E3f2Bdd5C81;
    ...
    // Name and symbol
    string constant _name = "TurkeyToken";
    string constant _symbol = "TRKY";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 25 / 10000; // 0.25%
    uint256 public _maxSellTxAmount = _totalSupply * 25 / 10000; // 0.25%
