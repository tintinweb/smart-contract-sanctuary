...
/**
    ...
    Harmonious Gains with Harmony!
    https://t.me/GreenHarmonybsc
    

 .88888.                                         dP     dP                                                          
d8'   `88                                        88     88                                                          
88        88d888b. .d8888b. .d8888b. 88d888b.    88aaaaa88a .d8888b. 88d888b. 88d8b.d8b. .d8888b. 88d888b. dP    dP 
88   YP88 88'  `88 88ooood8 88ooood8 88'  `88    88     88  88'  `88 88'  `88 88'`88'`88 88'  `88 88'  `88 88    88 
Y8.   .88 88       88.  ... 88.  ... 88    88    88     88  88.  .88 88       88  88  88 88.  .88 88    88 88.  .88 
 `88888'  dP       `88888P' `88888P' dP    dP    dP     dP  `88888P8 dP       dP  dP  dP `88888P' dP    dP `8888P88 
                                                                                                                .88 
                                                                                                            d8888P  
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 HARMONY = IBEP20(0x03fF0ff224f904be3118461335064bB48Df47938);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = HARMONY.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(HARMONY);
        ...
        uint256 amount = HARMONY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            HARMONY.transfer(shareholder, amount);
...
contract GreenHarmony is IBEP20, Auth {
    using SafeMath for uint256;

    address HARMONY = 0x03fF0ff224f904be3118461335064bB48Df47938;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GreenHarmony";
    string constant _symbol = "GH";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xCC2257c0fc386b56A84D69b9E8302dbE6706A216;
        ...
        marketingFeeReceiver = 0xa7fc682Af0d23eE1D2229f985B75F2fe8ba8E9D6;
