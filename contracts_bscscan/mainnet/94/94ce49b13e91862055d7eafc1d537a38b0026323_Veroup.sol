...
contract Veroup is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWallet = payable(0xb614fFE10ca471789E7B5a34d0194ef36aB5FBC0); // Marketing Wallet
    address payable public buybackWallet = payable (0x60590F46019bA30AFd9050FC503A27259546ad68); // Buyback Wallet
    ...
    string private _name = "Vero Pup";
    string private _symbol = "Veroup";
