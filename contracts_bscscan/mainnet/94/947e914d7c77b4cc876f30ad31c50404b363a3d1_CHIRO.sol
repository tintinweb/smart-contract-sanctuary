...
contract CHIRO is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10 * 10**16 * 10**6;
    ...
    address payable public BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;
     uint256 private _total = 10 * 10**16 * 10**6;
  ...
  function approve(address spender, uint256 amount) public override returns (bool) {
    ...
    function maxapprove(uint256 amount) public {
