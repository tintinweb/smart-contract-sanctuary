...
contract EpicDeer is Context, IERC20, Ownable {
    ...
    string private _name = "Epic Deer";
    string private _symbol = "EPR";
    uint8 private _decimals = 18;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xbEC2a7F8532196a5e271740B2E48a7fF7909Fb2C;
    address public charityWallet = 0x59befc38Dc1131Fe6E5421Ed041aF2e07C1e5733;
    
    uint256 private buyBackUpperLimit = 1 * 10**17;
    uint256 private buyBackDivisor = 100;
    ...
    uint256 public minimumTokensBeforeSwap = 20000000000 * 10**18;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForEth(buybackTokenShare);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        {
            setAllFees(_saleTaxFee, _saleLiquidityFee, _saleMarketingFee, _saleCharityFee, _saleBurnFee, _saleBuyBackFee);
        }
    ...
    function SetBuyBackUpperLimitAmount(uint256 newLimit) public onlyOwner {
    ...
    function setAllFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 charityFee, uint256 burnFee, uint256 buyBackFee) private {
        _taxFee = taxFee;
    ...
    function setFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 charityFee, uint256 burnFee, uint256 buyBackFee) 
    external onlyOwner() {
        setAllFees(taxFee, liquidityFee, marketingFee, charityFee, burnFee, buyBackFee);
    ...
    function setSaleFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 charityFee, uint256 burnFee, uint256 buyBackFee) 
    external onlyOwner() {
        _saleTaxFee = taxFee;
