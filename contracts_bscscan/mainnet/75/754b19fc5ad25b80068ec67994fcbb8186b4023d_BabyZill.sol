...
// Join our Telegram Group: https://t.me/BabyZilliqaBSC  
// 8% Reward
// 2% Liquidity
// 5% Marketing
// Please add ZIL to your wallet in order to see rewards- 0xb86AbCb37C3A4B64f74f59301AFF131a1BEcC787
// Code Start Here
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // Solidity only autoZILally asserts when dividing by 0
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ZIL = IBEP20(0xb86AbCb37C3A4B64f74f59301AFF131a1BEcC787);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ZIL.balanceOf(address(this));
        ...
        uint256 amount = ZIL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ZIL.transfer(shareholder, amount);
...
contract BabyZill is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyZill";
    string constant _symbol = "BabyZill";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x2AA3ab39a88A5d293620B1A0495FBE3b60f78d61;
