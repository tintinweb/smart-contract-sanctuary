...
contract RetroGames is Context, IERC20, Ownable {
    ...
    string private _name = "Retro Games";
    ...
    address _marketingWallet = 0x3F1b08c4722438DE89d8def312efC7C20B94279f;
    ...
    uint256 public _previousMaxTxAmount = _maxTxAmount;
    uint256 private maxTxAmountUI = (startingSupply * maxTxX) / maxTxDivisor; 
