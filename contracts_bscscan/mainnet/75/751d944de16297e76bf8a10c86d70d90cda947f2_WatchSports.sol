...
contract WatchSports is ERC20, Ownable {
    ...
    constructor() ERC20("WatchSports", "WSPORTS", 9) {
        ...
        uint256 totalSupply = 10 * 10 ** 8 * 10 ** 9; // Total supply of 1,000,000,000 with 12 decimal places
    ...
    // update launch tax time limit - can only be a time before the current time
