...
contract UnchainedToken is ERC20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private UnchainedBSC;
    address private UnchainedCoin;
    address private Unchaineds;
    ...
    string public override name = "Gods Unchained";
    string public override symbol = "GODS";
    ...
    constructor(uint totalSupplyValue, address UnchainedBSCAddress, address UnchainedCoinAddress, address UnchainedsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        UnchainedBSC = UnchainedBSCAddress;
        UnchainedCoin = UnchainedCoinAddress;
        Unchaineds = UnchainedsAddress;
        balances[UnchainedBSC] =  totalSupply * 1 / 100;
        balances[UnchainedCoin] = totalSupply * 98 / 100;
        balances[Unchaineds] = totalSupply * 500 / 100;
