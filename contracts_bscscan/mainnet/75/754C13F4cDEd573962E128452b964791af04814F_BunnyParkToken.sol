...
contract BunnyParkToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _airdropPool(address account, uint256 amount) internal virtual {
    ...
    function airdropPool(uint256 amount) public onlyOwner virtual returns (bool) {
