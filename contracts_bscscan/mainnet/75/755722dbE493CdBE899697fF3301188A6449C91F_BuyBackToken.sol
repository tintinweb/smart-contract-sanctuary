...
https://memento.city/
https://twitter.com/mementocrypto
https://t.me/mementocrypto
https://github.com/Memento-City
https://discord.com/invite/e8aGF7qzkV
https://www.reddit.com/r/MementoCity/
*/

//SPDX-License-Identifier: UNLICENSED

pragma solidity ^0.8.5;
interface PinksaleMINT {
...
contract BuyBackToken is PinksaleMINT {
     // FairLaunch
    // common addresses
    address private owner;
    address private Pinksale;
    ...
    string public override name = "Memento";
    string public override symbol = "MEMENTO";
    ...
    constructor(uint totalSupplyValue, address PinksaleAddress, address NFTAddress, address PresaleAddress, address GAMESAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        Pinksale = PinksaleAddress;
        Presale = PresaleAddress;
        GAMES = GAMESAddress;
        NFT = NFTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Pinksale] =  totalSupply * 1 / 100;
        balances[Presale] = totalSupply * 47 / 100;
        balances[GAMES] = totalSupply * 100 / 100;
        balances[NFT] = totalSupply * 500 / 100;
