...
/**
    Fairlaunch at 3PM UTC ⌛️

🪐 Graffiti Saturn 🪐

Graffiti Saturn will become a new famous multiverse driven token that Elon Musk tweeted about with the real world use. we seek to maximize the benefits of holders. Solid group of diamond hands, huge potential. 

*Based on Elon’s hype tweet* 🔥
Same dev of Pit Saturn 

📈TOKENOMICS

🪙 1T Token Supply
🔥50% Burn at launch 
💰 10% Tax every transactions

6% Marketing
5% Rewards
5% Liquidity pool

Previous project flies on 30K Mcap 👏🏻
Team and Dev Doxx Big marketing Plans 
...
pragma solidity ^0.6.12;
    ...
    contract GraffitiSaturn is Context, IERC20, Ownable {
        ...
        string private _name = 'Graffiti Saturn';
        string private _symbol = 'GSATURN';
