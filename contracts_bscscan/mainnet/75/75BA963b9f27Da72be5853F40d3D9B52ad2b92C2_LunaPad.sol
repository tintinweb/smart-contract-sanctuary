...
/**
  ...
  {
    require(totalSupply_.add(_amount) <= 100000000 * 10 ** 18);
...
contract LunaPadToken is MintableToken,CappedToken {
  string public name = "LunaPad";
  string public symbol = "LunaPad";
