...
/**Welcome to MadMakers
   ...
   I will renounce the ownership to burn addresses to transfer #MadMakers
   to the community
   Can you make #MadMakers
   100X? 
   ...
   it's the best part of the #MadMakers
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract MadMakers is Context, IBEP20, Ownable {
