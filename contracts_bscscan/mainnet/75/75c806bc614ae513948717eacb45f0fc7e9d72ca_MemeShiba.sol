...
contract MemeShiba is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) public _balances;
    mapping(address => mapping(address => uint256)) public _allowances;
    uint256 public _totalSupply = 1000000000000*10**18;
    string public _name = "MemeShiba";
    string public _symbol= "MemeShiba";

    address payable public charityAddress = payable(0x910E8e505A335261c27C2841F4cF266cCD389E91); // Marketing Address
