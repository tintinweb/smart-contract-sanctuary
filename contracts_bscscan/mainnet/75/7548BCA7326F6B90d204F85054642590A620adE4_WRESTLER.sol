...
contract WRESTLER is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000 * 10**9; // 100 quadrillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Floki Wrestler";
    string private _symbol = "FLOKIWRESTLER";
    ...
    address public marketingWallet = 0xc14A4BD92a4a5E55CFeCdFaaa6fc1776AF02ef90;
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**9; // 1%
    uint256 public _maxWalletSize = 3000000000000000 * 10**9; // 3%
