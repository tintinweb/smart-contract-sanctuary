...
contract SurvivalCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD69e8daB1001D00328858dF80Be057AfDaa537EF); // Marketing Address
    ...
    string private _name = "SurvivalCoin";
    string private _symbol = "SRV";
