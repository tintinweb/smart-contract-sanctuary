...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract ShibaWars is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ShibaWars";
    string constant _symbol = "SW";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 1 ) / 100; // 1%
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xc7631634C519cC90142a5a396Ef64d26Bd1Ddfe0;
