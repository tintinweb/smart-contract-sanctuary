...
* ||<<|      L38036133B        *\\  |\_/  //* series                 |>>||
* ||>>|  12                     *\\/___\_//*   1989                  |<<||
* ||<<\      Treasurer     ______/Satoshi\________      Secretary 12 />>||
* ||//$\                 ~|UNITED STATES OF BUYBACK|~               /$\\||
* ||(100)===================   ONE HUNDRED BNB    =================(100)||
* ||\\$//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\\$//||
* ||====================================================================||                        
*                                                                                     
* TheBigBuyback $TBBB           
* Supply: 1,000,000,000,000
* 12% Buy Back | 3% Liquidity 
...
contract TheBigBuyBack is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TheBigBuyBack";
    string constant _symbol = "TBBB";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x0a4b5574f49C58A0C42E77233cdD1d7B48B742C9;
