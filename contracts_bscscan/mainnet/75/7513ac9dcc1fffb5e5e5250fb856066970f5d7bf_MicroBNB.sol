...
contract MicroBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MicroBNB";
    string constant _symbol = "MIB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 9; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x8285200a4E1047f15D6Be68dFED02ADc29b08D0b;
