...
contract Sensei is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        _rOwned[0xcE7Bff56dD807375b36163487288C6626e8d65B3] = _rTotal.div(100).mul(3); // Wallet future development - 3%
        _rOwned[0x80A17D8af9c4092abF58EbdcED9F1B1dc894502e] = _rTotal.div(10000).mul(553); // Wallet future team - 5.53%
        _rOwned[0x9A5e0f0736EF2B25cbA9839C7bB83069965A7B05] = _rTotal.div(1000).mul(84); // Wallet future advisor - 8.4%
        _rOwned[0x46635e27224148c69Adb996f2F2F22eB7f7e3Dc4] = _rTotal.div(100).mul(12); // Wallet future marketing - 12%
        ...
        emit Transfer(address(0), 0xcE7Bff56dD807375b36163487288C6626e8d65B3, _tTotal.div(100).mul(3)); // Wallet future development - 3%
        emit Transfer(address(0), 0x80A17D8af9c4092abF58EbdcED9F1B1dc894502e, _tTotal.div(10000).mul(553)); // Wallet future team - 5.53%
        emit Transfer(address(0), 0xa3448570Ac5b48e7C40D2356e7dE8aCc9efe2C27, _tTotal.div(1000).mul(84)); // Wallet future advisor - 8.4%
        emit Transfer(address(0), 0x46635e27224148c69Adb996f2F2F22eB7f7e3Dc4, _tTotal.div(100).mul(12)); // Wallet future marketing - 12%
