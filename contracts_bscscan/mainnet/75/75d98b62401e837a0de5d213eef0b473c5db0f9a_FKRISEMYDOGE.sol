...
contract FKRISEMYDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "FKRISEMYDOGE";
    string private _symbol = "FKRMD";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 3; // Manually adjust prior to renouncing...
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 9; // Manually adjust prior to renouncing...
