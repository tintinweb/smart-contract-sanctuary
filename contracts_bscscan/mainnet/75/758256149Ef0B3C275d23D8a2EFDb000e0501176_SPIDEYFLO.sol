...
contract SPIDEYFLO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "SPIDEYFLO";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1_000_000_000_000e2;
    ...
    uint256 internal reflectionFee   = 0;
    ...
    constructor (address _router, address _rewardToken) Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x07D73E9d19F808e8054aAF80235B34e99BaFb1dA;
        teamFeeReceiver = 0x40b64b0cfc332495Dcc65659BF0Dd405c565abf0;
        charityFeeReceiver = 0x0C4cCF7EaD4418cF027ed28CD6db997DaA3aE3a3;
