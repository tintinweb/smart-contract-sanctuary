...
contract Babygirl is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xEF811B4c299FD45DcD354826c1aC7Ca86BcB5239); // Marketing Address
    ...
    uint256 public lockTokenUntilTimestamp = 1626093000;//2021-07-13 20:30:00 UTC+8
    ...
    function _transfer(
        ...
        if(from!=owner()){
            require(block.timestamp>=lockTokenUntilTimestamp,"Can't transfer until 2021-07-12 20:30:00 UTC+8");
        }
