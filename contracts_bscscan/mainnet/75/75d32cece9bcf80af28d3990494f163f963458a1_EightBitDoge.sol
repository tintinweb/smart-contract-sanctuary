...
HYPER DEFLATIONARY & LIQUIDITY GENERATING

8% Transaction Tax
⚖️3% to Auto LP 
♻️3% to Redistribution
📰2% to Marketing and development 

🌟MARKETCAP GOAL GIVEAWAYS AND BURNS🔥🔥🔥

💥The most deflationary and ever rising token to hit BSC to date! 💥

A bit more about this project, we aim to be the small project creating solpunk like pixel doge NFTs. We will update when we have prototypes to show the community!
5

🕊Twitter: https://twitter.com/eightbitdoge

📩Telegram: https://t.me/eightbitdoge
...
contract EightBitDoge is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "EightBitDoge";
