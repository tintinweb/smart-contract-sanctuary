...
/*
ExperimentY - Fair launch
https://t.me/experimentybsc
...
/* Token contract */
contract ExperimentY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xD78b91f12827fc1A96316328B182c4Efcd926220;
    ...
    // Name and symbol
    string constant _name = "ExperimentY";
    string constant _symbol = "ExY";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 5% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 3% or 3m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 1% of supply
