...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); //BTC BEP20
    ...
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //PANCAKE
        _token = msg.sender;
    }
...
contract SquidGameToken is IBEP20, Auth {
    using SafeMath for uint256;
