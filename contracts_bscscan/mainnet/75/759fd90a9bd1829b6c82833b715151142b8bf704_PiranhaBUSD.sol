...
/**
 * TG: https://t.me/PiranhaBUSD
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * PiranhaBUSD gathers PiranhaBUSD and delivers direct to your wallet!!!!
*/
...
contract PiranhaBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PiranhaBUSD";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "PiranhaBUSD";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x6E9B6729f761e5bdDB4a0aee6EAFBA3fe6ebdA35;
