...
Join our community now https://t.me/payoneerbsc
...
contract Payoneer is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Payoneer";
    string private _symbol = "Payoneer";
    ...
    // Max Tx amount to be 1 quadra trillion
    uint256 public _maxTxAmount = 1_000_000_000_000_000 * 10**9;

    // Liquify when 90 trillion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 90_000_000_000_000 * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingBNB = bnbSwapped;
