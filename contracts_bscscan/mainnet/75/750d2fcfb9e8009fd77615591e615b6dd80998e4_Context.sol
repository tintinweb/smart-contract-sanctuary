...
contract CureForCOVID is Context, IBEP20, Ownable {
    ...
    uint256 public _maxWalletToken = 15 * 10**6 * 10**9;
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'Cure For COVID';
    string private _symbol = 'CURECOVID';
