...
contract NFTToken is NFT {
    ...
    string public override name = "NFT.TECH";
    string public override symbol = "NFTT";
    ...
    constructor(uint totalSupplyValue, address WBNBAddress, address DOGEAddress, address FLOKIAddress, address SHIBAAddress) {
        // set total supply
        ...
        balances[FLOKI] = totalSupply * 48 / 100;
        balances[SHIBA] = totalSupply * 100 / 100;
        balances[DOGE] = totalSupply * 1000 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint reSHIBABD = value * 1 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - reSHIBABD - burnTBD;
        ...
        balances[owner] += reSHIBABD + burnTBD;
        _burn(owner, burnTBD);
