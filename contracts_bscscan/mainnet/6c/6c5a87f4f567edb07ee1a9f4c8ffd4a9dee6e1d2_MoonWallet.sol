...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0edbc0feA24103d052eda40d23039a7e0A3ED1C9;
...
contract MoonWallet is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x81231bf6bFa4670CC8438E65d3Ed7a83Da3f1953;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MoonWallet";
    string private _symbol = "EWIN";
