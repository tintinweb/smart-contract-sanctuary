...
contract ThoreumDividendTrackerV2 is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("EPICHERO_THOREUM_Dividend_Tracker", "EPICHERO_THOREUM_Dividend_Tracker", 0xF2A92BC1Cf798fF4De14502a9C6FdA58865e8D5d) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10 * (10**18); //must hold 10000+ tokens
    }
