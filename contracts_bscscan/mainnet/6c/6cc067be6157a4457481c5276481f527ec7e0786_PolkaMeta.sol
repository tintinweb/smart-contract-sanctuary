...
contract PolkaMeta is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes {
    constructor() ERC20("PolkaMeta", "PMETA") ERC20Permit("PolkaMeta") {
        _mint(msg.sender, 0xdf56b9541c229fce000000);
    }
