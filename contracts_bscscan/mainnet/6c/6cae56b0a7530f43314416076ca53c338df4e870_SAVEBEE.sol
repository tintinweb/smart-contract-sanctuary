...
//100.000.000
    ...
    uint256 public _maxTxAmount = 10000 * 10**_decimals; //10k
	uint256 public _maxWallet = 100000 * 10**_decimals;  //100k
    ...
    uint public tokensTax1 = 10; // 0.1 % = 100.000 to sell
    uint public tokensTax2 = 15; // 0.15 % = 150.000 to sell
    uint public tokensTax3 = 20; // 0.2 % = 200.000 to sell
    ...
    string private constant _name = "SVB1 Token";
    string private constant _symbol = "SVB1";
...
//      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        // 1000000000 * (15/10) /10000
        antiwhale_measures[0] = antiwhale({selling_treshold: _tTotal*(tokensTax1/10)/10000, extraTax: tokensFee1}); 
        antiwhale_measures[1] = antiwhale({selling_treshold: _tTotal*(tokensTax2/10)/10000, extraTax: tokensFee2}); 
        antiwhale_measures[2] = antiwhale({selling_treshold: _tTotal*(tokensTax3/10)/10000, extraTax: tokensFee3});
    ...
    function setTokensTax1(uint tx1) public onlyOwner { tokensTax1 = tx1; }
    function setTokensTax2(uint tx2) public onlyOwner { tokensTax2 = tx2; }
    function setTokensTax3(uint tx3) public onlyOwner { tokensTax3 = tx3; }
