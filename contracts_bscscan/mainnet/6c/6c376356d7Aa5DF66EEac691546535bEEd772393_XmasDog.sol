...
contract XmasDog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xfBA011367927d425A71b400029C172f5f22d5AA2); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x925155f547c202ea613D4579c01D27edC4a4cd6b); // Liquidity Address
    ...
    string private constant _name = "XmasDog";
    string private constant _symbol = "XDog";
    ...
    constructor() {
        address newOwner = address(0x925155f547c202ea613D4579c01D27edC4a4cd6b);
