...
/**
     Mini Karate is aiming to be your play of the day!
     Stealth Launching on 24th of August
     Find us on Telegram: @MiniKarate
     
We have great Anti-Bot features as well as Anti-Whale and Anti-Dump tokenomics that work!
Total supply is only 10,000
Max wallet is just 5%, so no whales can control the supply
Max sell is only 2%, so we prevent instant dumping
9% BNB reflection to holders 
 */
...
contract MINIKARATE is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "Mini Karate";
