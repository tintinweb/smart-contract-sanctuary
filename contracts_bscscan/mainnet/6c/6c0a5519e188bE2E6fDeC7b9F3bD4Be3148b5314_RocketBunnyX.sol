...
/**
 *Telegram: RocketBunnyX
 *Website: RocketBunnyX.com
*/
...
contract RocketBunnyX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Rocket Bunny X";
    string constant _symbol = "RBX";
