...
contract MICHI is IBEP20, Auth {
    ...
    address MARK = 0x0Ec2BAe797681573ffF23598EA2CDD21b32fc933;

    string constant _name = "Michi";    
    string constant _symbol = "MICHI";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 7 ) / 100;  
