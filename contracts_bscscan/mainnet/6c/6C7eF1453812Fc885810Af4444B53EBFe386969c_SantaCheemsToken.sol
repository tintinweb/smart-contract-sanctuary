...
/*
Santa Cheems
Website: https://santacheems.com
Telegram: https://t.me/santa_cheems
Twitter: https://twitter.com/santacheems
*/
...
contract SantaCheemsToken {
    string  private _name = 'Santa Cheems';
    ...
    constructor () {
        ...
        setLimits(2500000, 1250000, 500000);
        setFees(7, 4, 2);
    }
    ...
    function setFees(uint8 _devFee, uint8 _liquidityFee, uint8 _burnFee) public virtual onlyOwner {
        devFee = _devFee;
