...
contract DogeBoy is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xA85683F0B9C796500C8015119053ebf246553C47); // Marketing Address
        
    address payable public teamAddress =
        payable(0xdb7ee26Bc277CDd04f460C7F56B27E5B9A2f7988); // Team Address
    ...
    string private constant _name = "DogeBoy";
