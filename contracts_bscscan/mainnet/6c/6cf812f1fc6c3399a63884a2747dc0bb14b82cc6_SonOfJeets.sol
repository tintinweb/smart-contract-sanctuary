...
💎 OFFICIAL DOXEDBOY LAUNCH! 💎

💎 STEALTH LAUNCH 💎

LOW FEE TAX 🔅 BASED DEV 

BIG MARKETING READY 💎

2% LP LIQUIDITY TAX, 2% MARKETING TAX

4% WALLET, 2% TRANSACTION
...
contract SonOfJeets is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SonOfJeets';
    string private constant _symbol = '$SONOFJEETS';
    ...
    uint16 public constant SellLimitDivider=5;
    ...
    //DevWallets
    address public TeamWallet=payable(0x349c2B0f53226ebae7839dde5425985b58bFF963);
    address public walletTwo=payable(0xe224ca5a671045f04ffFD233E135A0b1E720970d);
    //TestNet
