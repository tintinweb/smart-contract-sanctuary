...
/**
 ...
 TG: https://t.me/BMBBNB_Token
 
 Hodl $BMBBNB and get $BNB automatically in your wallet every hour!
 $BNB: 0xB8c77482e45F1F44dE1745F52C74426C631bDD52
 
 # of Tokens: 100,000,000,000 (100 BILLION)
 
 Max Tax: 2% (2 BILLION)
 Max wallet: 4% (4 BILLION)
 
 Reflection/Taxes: 20% in $BNB, 5% to Liquidity
...
// CHANGE
contract BMBBNB is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BMB BNB";
    string constant _symbol = "BMBBNB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% MAX 
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 4% MAX 
    ...
    uint256 reflectionFee = 2000; // 20%
    uint256 devFee = 0; // 0%
    uint256 totalFee = 2500; // liquidityFee + reflectionFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x56DE22417186F3363Db61Ce17f2b7F9914Db1C47);
