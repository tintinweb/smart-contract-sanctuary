...
contract Ownable is Context {
    address private _owner = 0x1AF99bfA375a7f9Ef0B469c82296b57a5165EBFd;
...
contract DUREX is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x1AF99bfA375a7f9Ef0B469c82296b57a5165EBFd); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Durex"; // token name
    string private _symbol = "Durex"; // token symbol
