...
// CHANGE
contract SafuMoonBaboon is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SafuMoonBaboon";
    string constant _symbol = "SMB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 1000; // 0.5% MAX 5,000,000
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100; // 1% MAX 10,000,000
    ...
    uint256 totalFee = 1000; // liquidityFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x9754D94810cE7AE6B06A37Df9cB81Ae3b2a09aF4);
