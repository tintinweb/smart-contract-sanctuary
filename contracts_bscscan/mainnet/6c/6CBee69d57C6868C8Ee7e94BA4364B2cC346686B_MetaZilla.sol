...
contract MetaZilla is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2D6192e3C8966DdBF9D460829665dc6E7b544A5b); 
    address payable public buyBackWalletAddress = payable(0x366B733655685164DEa78eBCAB41F794A2e9e233); 
    ...
    uint256 public _walletMax               = 100000000000000000000 * 10**9;
