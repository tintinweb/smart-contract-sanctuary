...
Dev - 1% of Total Supply

Burn - 25% of Total Supply

Tax:

7% taxed on each transaction:

3% Redistribution to holders
TG : https://t.me/BengalTigerToken
...
contract BengalTigerToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BengalTiger";

  string private _name = "BENGALTIGER";
