...
contract RentEz is ERC20, Ownable {
	using SafeMath for uint256;

	IUniswapV2Router02 public uniswapV2Router;
	address public immutable uniswapV2Pair;

	string private _name = "RentEz";
	...
	function _adjustTaxes(bool isBuyFromLp, bool isSelltoLp) private {
		...
		emit FeesApplied(isBuyFromLp, isSelltoLp, _liquidityFee, _marketingFee, _devFee, _buyBackFee, _charityFee, _holdersFee, _totalFee);
	}
