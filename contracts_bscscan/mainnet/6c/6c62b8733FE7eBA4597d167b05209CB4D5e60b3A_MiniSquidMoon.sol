...
Big announcement at 100 holders 
...
contract MiniSquidMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini SquidMoon";
    string private _symbol = "MINISQUIDMOON";
