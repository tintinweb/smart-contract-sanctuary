...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // Floki
...
contract GokuFlokiInu is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // Floki
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GokuFlokiInu";
    string constant _symbol = "GFLOKI";
