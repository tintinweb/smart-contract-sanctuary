...
/**
   ...
   Welcome Only Ever Have
   
   This is a community token. If you want to create a telegram I suggest to name it to @OnlyEverHaveBSC
   Important: The early you create a group that shares the token, the more gain you'll get.
   https://twitter.com/elonmusk/status/1413739988399833091?s=19
   ...
   I will renounce the ownership to burn addresses to transfer #OnlyEverHave to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #OnlyEverHave 10000X? 
...
contract OnlyEverHave is Context, IERC20, Ownable {
    ...
    string private _name = "Only Ever Have";
    string private _symbol = "OnlyEverHave";
