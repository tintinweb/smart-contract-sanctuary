...
//Just launched in $RoyalFlokiNomics. We have created a token so rewarding for everyone.
//RoyalFlokiNomics Hold we will Tothemoon
//Tg : t.me/RoyalFlokiNomics
...
contract RoyalFlokiNomics is Context, IERC20, Ownable {
    ...
    string private _name = "ROYALFLOKINOMICS";
    string private _symbol = "RoyalFlokiNomics";
