...
contract ShibaFinance is ShibaFiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ShibaFiTeam;
    address private CharityShibaFi;
    ...
    string public override name = "Shiba Finance";
    string public override symbol = "ShibaFi";
    ...
    constructor(uint totalSupplyValue, address ShibaFiTeamAddress, address CharityShibaFiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShibaFiTeam = ShibaFiTeamAddress;
        CharityShibaFi = CharityShibaFiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShibaFiTeam] =  totalSupply * 4 / 100;
        balances[CharityShibaFi] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ShibaFiTeam pot
