...
contract LamaVaults {
	...
	function toggleAuthorized(address _addr, bool enabled) external adminOnly {
		authorized[_addr] = enabled;
	}

	function toggleWhitelist(address _addr, bool enabled) external adminOnly {
		whitelist[_addr] = enabled;
	}
