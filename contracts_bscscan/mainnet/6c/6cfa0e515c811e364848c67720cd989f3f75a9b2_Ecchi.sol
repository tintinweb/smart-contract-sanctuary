...
/**
        ...
        ╚══════╝░╚════╝░░╚════╝░╚═╝░░╚═╝╚═╝          ╚══════╝░░░░╚═╝░░░╚═╝░░╚══════╝╚══════╝╚═════╝░
                 ...
                 ⠄⣼⣖⣿⣿⣿⣿⣿⣿⣿⣿⣿⢿⣿⣿⣿⣿⣿⢇⣿⣿⡷⠶⠶⢿⣿⣿⠇⢀⣤         
                 ⠘⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣽⣿⣿⣿⡇⣿⣿⣿⣿⣿⣿⣷⣶⣥⣴⣿⡗     
                 ⢀⠈⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡟⠄         Telegram: https://t.me/ecchitoken
                 ⢸⣿⣦⣌⣛⣻⣿⣿⣧⠙⠛⠛⡭⠅⠒⠦⠭⣭⡻⣿⣿⣿⣿⣿⣿⣿⣿⡿⠃⠄         
                 ⠘⣿⣿⣿⣿⣿⣿⣿⣿⡆⠄⠄⠄⠄⠄⠄⠄⠄⠹⠈⢋⣽⣿⣿⣿⣿⣵⣾⠃⠄
                 ⠄⠘⣿⣿⣿⣿⣿⣿⣿⣿⠄⣴⣿⣶⣄⠄⣴⣶⠄⢀⣾⣿⣿⣿⣿⣿⣿⠃⠄⠄
                 ⠄⠄⠈⠻⣿⣿⣿⣿⣿⣿⡄⢻⣿⣿⣿⠄⣿⣿⡀⣾⣿⣿⣿⣿⣛⠛⠁⠄⠄⠄
...
contract Ecchi is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "Ecchi";
    string constant _symbol = "WEEB";
    ...
    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100;  // 2% MaxWallet - 20,000 Tokens
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100;  // 1% Max Transaction - 10,000 Tokens  
    ...
    // Fee receivers
    address private marketingFeeReceiver = 0x4E5903C24A7FEd6F9CB4497B9A6480aebE816ce9;
    address private buybackFeeReceiver = 0x6039DD70cE054a7e77F6b118Cd783f86919C3cc6;
