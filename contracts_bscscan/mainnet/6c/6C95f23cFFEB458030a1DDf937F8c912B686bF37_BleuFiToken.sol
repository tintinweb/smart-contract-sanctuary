...
contract BleuFiToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BleuFi Token";
    string constant _symbol = "BleuFi";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 15 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 392 / 100000; // 0.03% of supply
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (pair == sender &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"DIAMOND HOLDER!!!Please wait for cooldown between sells");
