...
contract Foreverx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Foreverx";
    string private _symbol = "FRVX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFBB780cB0e243138D42B59bC8C5b2fB133d0D2FE); // Marketing Address
    address payable public ProjectWalletAddress = payable(0x22DfB98F810edA65AEFd685C547a8dd31D9bEC95); // Project Wallet Address
