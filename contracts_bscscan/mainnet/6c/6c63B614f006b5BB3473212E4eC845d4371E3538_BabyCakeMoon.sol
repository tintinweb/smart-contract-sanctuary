...
/**
   ...
   Welcome to BabyCakeMoon
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyCakeMoon
   ...
   I will renounce the ownership to burn addresses to transfer #BabyCakeMoon to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BabyCakeMoon 10000X? 
   ...
   it's the best part of the #GoldDoge idea, increasing the liquidity pool automatically, 
...
contract BabyCakeMoon is Context, IERC20, Ownable {
    ...
    string private _name = "BabyCakeMoon";
    string private _symbol = "BabyCakeMoon";
