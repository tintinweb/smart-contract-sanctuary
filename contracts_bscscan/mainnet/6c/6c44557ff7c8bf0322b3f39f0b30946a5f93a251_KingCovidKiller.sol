...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7470d90C0B235629f1C70a8C2FF1a5B086166cFA;
...
contract KingCovidKiller is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xafA5373Ca12a97Dc2d1C5e21d1843f8F6d76D541;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KingCovidKiller";
    string private _symbol = "KCK";
