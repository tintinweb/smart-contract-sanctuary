...
contract SHIBABOSHIARMY is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBABOSHIARMY";
    string private _symbol = "BOSHIARMY";
    ...
    uint256 private _previousTokenFee = _previousTokenFee;
    
    uint256 public _maxTxAmount = 1000 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**9 * 10**9; 
    
    address payable public FFI = 0xACca3e3Bee8235275b60b2330EFdF3d4454E7d79; 
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _TokenFee == 0) return;
    ...
    function setbabymuskdogeTokenFeePercent(uint256 babymuskdogeTokenFee) external onlyOwner() {
        _TokenFee = babymuskdogeTokenFee;
    }
