...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//BabyRocketBoys contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract BabyRocketBoys is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyRocketBoys';
    ...
    uint256 private constant DefaultLiquidityLockTime=2 hours;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimRocketBoys(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawRocketBoys(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimRocketBoys(address addr) private{
        ...
        path[1] = 0x071Fa11f7516CDeb366F7f7d91DA5049F7086185;  //Binance-Peg RocketBoys Token
        ...
        emit OnWithdrawRocketBoys(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function RocketBoysWithdraw() public{
    claimRocketBoys(msg.sender);
    }
