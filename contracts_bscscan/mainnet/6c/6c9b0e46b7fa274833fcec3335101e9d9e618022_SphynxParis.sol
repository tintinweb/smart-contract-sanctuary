...
//    I make this SphynxParis to hand over it to the community.
//    Create the community by yourself if you are interested.   
//    I suggest a telegram group name for you to create: https://t.me/SphynxParis
...
contract SphynxParis is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SphynxParis";
    string constant _symbol = "SphynxParis";
