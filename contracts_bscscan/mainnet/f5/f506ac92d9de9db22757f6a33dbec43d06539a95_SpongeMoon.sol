...
contract SpongeMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpongeMoon";
    string private _symbol = "$SpongeMoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6815e3d74cb4d6bB8Ef965607D9F96A25085CF11); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x25c78e70bd4A282C7EacEDfea976e515b3B61928); // BuyBack Address
