...
contract ReflectionToken is IERC20 {
    ...
    string constant _name = "PoundCake";
    string constant _symbol = "POUNDCAKE";
    ...
    address payable private _marketingWallet = payable(0xfEcdDc4E53216149a310b6C8758b325CeFbb503e);
