...
contract BabyZilla is  Context, IERC20, Ownable {
    ...
    uint256 private _tZillaTotal;

    string private _name = "Baby Zilla";
    ...
    uint256 public _ZillaFee = 12;
    uint256 private _previousZillaFee = _ZillaFee;
    
    uint256 public _maxTxAmount = 1000 * 10**9 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**9 * 10**9; 
    
    address payable public ZillaAddress = 0x1F1dd6a279523aFb7dC9D2C391ced72EDe386Ad5;
   ...
   function deliver(uint256 tAmount) public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tZillaTotal = _tZillaTotal.add(address(this).balance);
        TransferCharityETH(ZillaAddress, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_ZillaFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _ZillaFee == 0 && _liquidityFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousZillaFee = _ZillaFee;
    ...
    function setZillaFeePercent(uint256 ZillaFee) external onlyOwner() {
        _ZillaFee = ZillaFee;
    }
