...
| $$      | $$| $$  | $$| $$\  $$ | $$ \____  $$| $$  | $$| $$  | $$
| $$      | $$|  $$$$$$/| $$ \  $$| $$ /$$$$$$$/| $$  | $$|  $$$$$$/
|__/      |__/ \______/ |__/  \__/|__/|_______/ |__/  |__/ \______/ 
—————————————————————————————————————————————————————————————————————
🐶 Welcome to FloKishu – Where we have combined Floki & Kishu – the two biggest trends, into one! 🐶

💥 We have a strategic marketing plan ready to expose FloKishu via some big Twitter influencers & Telegram channels to start the 1st day off with a BANG! 💥
...
📢Tg: https://t.me/flokishu
🌐 Web: https://flokishu.tech/ma
*/
...
contract Flokishu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FloKishu", "fKishu") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function rewards_fee(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
        


        function setEnableMarketing(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function BuyFee(uint256 value) external onlyOwner {
            buyFee = value;
        }
