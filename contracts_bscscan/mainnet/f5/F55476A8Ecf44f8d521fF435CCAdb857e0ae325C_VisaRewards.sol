...
💳 Liquidity Locked for 1 month, ownership renounced, contract VERIFIED
💳 The best token for holders, super early
💳  1 million, 90% burned , 16% holders fee
💳  Strong Marketing after launch ! 
💳  CMS at 50 holders
TG: https://t.me/VisaRewards
...
contract VisaRewards is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 16;
  uint256 private _maxTrxLimit = 32 * 10**3 * 10**9;
  address private _deployer;
  bool reward_status = false;


  constructor() public {
    _totalSupply = 1000 * 10**3 * 10**9;
