...
/**
Be part of a team of experts that are building the future of enterprise data and NFT's!
We are a group of passionate individuals that are fully committed to improving the way that people and companies use data. 
People that are looking for a disruptive, fast-paced tech company will flourish in our team. 
We believe that you can only succeed as a team, no matter how big the challenge.

WELLCOME TO FC PORTO FAN TOKEN !
*/
...
contract PORTO is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0xdAF0DFeD18acd707AaAA3899F9f853CD7D569246;
    ...
    string private _name = "FC Porto Fan Token";
    string private _symbol = "PORTO";
    ...
    uint256 public _maxTxAmount = 40000000 *  10**18;
