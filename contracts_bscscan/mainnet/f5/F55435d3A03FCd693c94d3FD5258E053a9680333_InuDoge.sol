...
Hi!  This is InuDoge (INU)  
 
Are you looking for new DeFi projects to double your investments ? 
InuDoge is built by strong team of crypto experts that aim to build a sustainable token, devs are always active 24/7 in chat, and in call to answer any and every single question!
We focus on building a strong community of investors that are in it for the long run.
Check out InuDoge right now, get in while it's still cheap to do so, right before we get to the moon, HODL and enjoy it !
...
contract InuDoge is Context, ERC20Detailed, Ownable {
  ...
  string constant tokenName = "InuDoge";
  string constant tokenSymbol = "INU"; //displayed in MM; BSCSCAN: tokenName (tokenSymbol)
