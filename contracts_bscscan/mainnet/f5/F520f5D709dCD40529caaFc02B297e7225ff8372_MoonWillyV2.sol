...
contract MoonWillyV2 is ERC20, Ownable {
    ...
    address public constant DAIToken = 0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3;

    address public constant treasury = 0x47Eb130179cD0C25f11Da3476F2493b5A0eb7a6b;

    address public constant marketing = 0x8F7C10f725853323aF9aD428aCBaa3BFdD1D9A2B;

    address public constant airdrop = 0xA448D903442436c0841eE150520eF0737F4a2735;

    address public constant teamwallet = 0x65AF81855Af6be6Bf3a818167E9cf14BA3b1F1BF;

    address public constant burnWallet = 0xFe59c4Ce0B45997D24c03034396aCF648C9a4D1F;
    ...
    constructor() ERC20("MoonWilly", "MoonWilly") {
        ...
        tradingEnabledTimestamp = block.timestamp.add(3 days);
    }
