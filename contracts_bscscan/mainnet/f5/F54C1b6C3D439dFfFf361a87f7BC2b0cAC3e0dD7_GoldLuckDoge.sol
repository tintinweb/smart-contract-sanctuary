...
/**
 * TELEGRAM: HTTPS://T.ME/GoldluckDoge

SOON PINN ON CALL GROUPS 
TWITT WILL BE UP AT 30K MARKETCAP
REWARDS OF BUSD EVERY 30 
AUTO REFLECTION
    LP WILL BE LOCK INSTANTLT 
    AT 50K MCAP   CMC
...
contract GoldLuckDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xd9297Aa13d9E7A06C7D6e3CD9cCe4fBE5191CEFa;
 
    string constant _name = "GoldLuckDoge";
    string constant _symbol = "$GLD";
