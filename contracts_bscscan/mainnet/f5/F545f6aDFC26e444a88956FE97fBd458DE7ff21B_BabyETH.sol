...
/**
 ...
 TG: https://t.me/BabyETH
 
 Hodl $ETHD and get $ETH automatically in your wallet every hour!
 $ETH: 0x3AeEE6dA298084529c6E19EDB2e7fD1A053E6D15
 
 # of Tokens: 100,000,000,000 (100 BILLION)
 
 Reflection/Taxes: 10% in $ETH, 5% to Liquidity
...
contract BabyETH is IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 2% MAX 
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 4% MAX 
    ...
    uint256 reflectionFee = 1000; // 20%
    uint256 devFee = 0; // 0%
    uint256 totalFee = 1500; // liquidityFee + reflectionFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xfF8155C4B5e1E764F359d1516B427F2983f22809);
