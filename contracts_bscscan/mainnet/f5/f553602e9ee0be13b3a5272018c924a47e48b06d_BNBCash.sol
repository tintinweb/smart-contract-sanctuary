...
contract BNBCash is Context, IERC20, Ownable {
    ...
    string private _name = "svs";                                                   // name
    string private _symbol = "svs";                                                    // symbol
    ...
    uint256 public _swapAndLiquifyFee = 0;                                               // % to swap and add to liquidity
    uint256 public _walletsFee = 8;                                                      // % to wallets
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive _walletsFee.
        0xD3d41fD0D5606008A281732f513a828ef881EFd0                                   //
    ];                                                                                   //
