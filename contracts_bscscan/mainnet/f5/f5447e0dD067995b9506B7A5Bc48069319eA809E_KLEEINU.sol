...
contract KLEEINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x2cbc45798083FfccE4EDD3c3B29107Ce8e52Ac39;
 
    string constant _name = "KLEE INU";
    string constant _symbol = "KLEE";
