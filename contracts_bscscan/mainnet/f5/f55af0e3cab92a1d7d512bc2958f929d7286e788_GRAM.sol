...
contract GRAM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFca940A01A36d65303936008a425b0A718AFdE27); // Marketing Address
    ...
    uint256 private _tTotal = 8 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "8GB of RAM Now";
    string private _symbol = "8GRAM";
    ...
    uint256 public _taxFee = 2; //TO HODLER
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 7;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _buyTaxFee = 2; //TO HOLDER
    uint256 public _buyLiquidityFee = 7; //MARKETING 3% + BUYBACK 2%
    
    uint256 public _sellTaxFee = 2; //TO HOLDER
    uint256 public _sellLiquidityFee = 7; //MARKETING 3% + BUYBACK 3%

    uint256 public _startTimeForSwap;
    uint256 public _intervalMinutesForSwap = 1 * 1 minutes;

    uint256 public _buyBackRangeRate = 20;

    // Fee per address
    mapping (address => AddressFee) public _addressFees;

    uint256 public marketingDivisor = 2; //% FROM %LP
    
    uint256 public _maxTxAmount = 8 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 418362142 * 10**9; 
    uint256 public buyBackSellLimit = 1000000 * 10**9;
