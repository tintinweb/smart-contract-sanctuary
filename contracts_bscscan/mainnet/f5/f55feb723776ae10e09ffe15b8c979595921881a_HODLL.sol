...
/**
 ...
 Initial Liquidity (0.8 BNB) will be locked.
 50% Token supply burned!

 TELEGRAM: https://t.me/BabyDexe
...
// CHANGE
contract HODLL is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyDexe";
    string constant _symbol = "$BBY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 1% MAX 1,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xc568D5AF7e75d137d3807DdACd4dc77ED98a6882);
