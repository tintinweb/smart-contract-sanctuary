...
contract PaxToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4970dDAf876f8701bAa21fA9a80e99184219c4Fd); // Marketing Address
    ...
    string private _name = "Pax Token";
    string private _symbol = "PaxT";
