...
contract CATAVENGERS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CATAVENGERS";
    string constant _symbol = "$CAV";
    ...
    uint256 private _maxTxAmount = rSupply.div(1000).mul(7);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa58DF80Ec792679136845aabE2911Bc9C2601116;
        BuyBackReceiver = 0xa58DF80Ec792679136845aabE2911Bc9C2601116;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(rAmount <= _maxTxAmount || isTxLimitExempt[sender] || authorizations[sender] || authorizations[recipient], "TX Limit Exceeded");
