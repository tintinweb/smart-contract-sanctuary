...
Transaction Fee: 8 %
4% added to LP
2% Marketing/ Rewards/ business
2% Redistributed to our holders

Wallet Distribution
 75%  Liquidity Pool  ( locked thru DxSale ) 
 20%  Marketing/ Rewards/ Business wallet
  5%  Team wallet  
...
contract Sprout is Context, IERC20, Ownable {
    ...
    string private _name = "Sprout Token";
    string private _symbol = "SPROUT";
    ...
    uint256 private _Maxpertx = _tTotal/200;
    ...
    address _marketingWallet = 0x3a8966EbE75a7ABfd56736E63064a5C176D69380;
