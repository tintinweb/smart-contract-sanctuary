...
contract rarity is ERC721, Ownable {
    uint256 public summonPrice = 10000000000000000; //0.01BNB
    uint256 public next_summoner;
    uint256 constant xp_per_day = 250e18;
    uint256 constant DAY = 1 days;

    string public constant name = "BSC Rarity Manifested";
    ...
    function setSummonPrice(uint256 newPrice) public onlyOwner {
        summonPrice = newPrice;
    }
    ...
    function summon(uint256 _class) external payable {
        require(1 <= _class && _class <= 11);
        require(summonPrice <= msg.value, "Please pay mint fee");
