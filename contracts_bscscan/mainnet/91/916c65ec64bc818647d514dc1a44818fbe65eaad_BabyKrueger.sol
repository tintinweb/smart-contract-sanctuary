...
| $$  \ $$ /$$__  $$| $$  | $$| $$  | $$| $$\  $$ | $$      | $$  | $$| $$_____/| $$  | $$| $$_____/| $$      
| $$$$$$$/|  $$$$$$$| $$$$$$$/|  $$$$$$$| $$ \  $$| $$      |  $$$$$$/|  $$$$$$$|  $$$$$$$|  $$$$$$$| $$      
|_______/  \_______/|_______/  \____  $$|__/  \__/|__/       \______/  \_______/ \____  $$ \_______/|__/      
                               /$$  | $$                                         /$$  \ $$                    
                              |  $$$$$$/                                        |  $$$$$$/                    
                               \______/                                          \______/                     
 Celebrating Friday the 13th with BabyKrueger, rewarding holders with 13% in $XRP
 
 - 1 day Liquidity Lock (will send and pin mudra link in the TG)
    - If the marketcap is above $50,000, after 3 days we'll lock it for a month and begin unveiling our future plans

 TG: https://t.me/BabyKrueger

 
 Hold $BabyKrueger and get RIPPLE automatically in your wallet every hour!
...
// CHANGE
contract BabyKrueger is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyKrueger";
    string constant _symbol = "KRUEGER";
    ...
    uint256 reflectionFee = 1300; // 13%
    uint256 marketingFee = 300; // 3%
    uint256 totalFee = 2100; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xc3f696b51517fbA6D5472CdD420fB8cAC4760827);
