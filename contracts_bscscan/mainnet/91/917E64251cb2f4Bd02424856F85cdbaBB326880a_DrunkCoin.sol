...
contract DrunkCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DrunkCoin";
    string private _symbol = "DRUNKCOIN";
    ...
    uint256 internal _tokenTotal = 100000000000 *10**18; // 10 Billion totalSupply
    ...
    uint256 public _taxFee = 10; // 50 = 0.5%
    uint256 public _buybackv1Fee = 10; // 100 = 1.00%
    uint256 public _buybackv2Fee = 200; // 100 = 1.00%
    uint256 public _burningFee = 200; // 200 = 2.0%
    uint256 public _smarketingFee = 700; // 50 = 0.5%
    
    uint256 public _maxTxAmount = 500000000 * 10**18; // 15 Million inicial máx transfer
    ...
    address public buybackv1Address  = 0xC774dA5714Ec29109f3Ec85B7dd8a6eE2de1FB66;      // BuyBackv1 Address
    address public buybackv2Address  = 0xC774dA5714Ec29109f3Ec85B7dd8a6eE2de1FB66;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0xC774dA5714Ec29109f3Ec85B7dd8a6eE2de1FB66;      // SMarketing Address
