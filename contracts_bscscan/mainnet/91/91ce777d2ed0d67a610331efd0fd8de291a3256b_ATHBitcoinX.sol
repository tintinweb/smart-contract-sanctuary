...
//   Welcome to ATHBitcoinX
   
//   This is a community token. If you want to create a telegram I suggest to name it to @ATHBitcoinX
...
//   I will add .3 BNB and all the left 46% total supply to the pool
//   Can you make #ATHBitcoinX 10000X? 
...
contract ATHBitcoinX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ATHBitcoinX";
    string constant _symbol = "ATHBitcoinX ";
