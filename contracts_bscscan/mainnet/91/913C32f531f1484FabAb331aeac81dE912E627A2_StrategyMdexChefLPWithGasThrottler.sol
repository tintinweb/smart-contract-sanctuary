...
contract StrategyMdexChefLPWithGasThrottler is StratManager, FeeManager, GasThrottler {
    ...
    function harvest() external virtual whenNotPaused gasThrottle onlyEOA {
        _harvest();
    }
