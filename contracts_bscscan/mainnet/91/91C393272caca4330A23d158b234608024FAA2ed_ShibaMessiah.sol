...
contract ShibaMessiah is Context, IBEP20, Ownable {
    ...
    uint256 private _maxTxn = 90 * 10**9 * 10**8; // 3BNB
    uint256 private _maxWallet = _tTotal.div(10**2).mul(2); // 3% of total supply
    ...
    string private _name = "ShibaMessiah";
    string private _symbol = "SM";
