...
contract janniedfinance is Context, IERC20, Ownable {
    ...
    string private _name = "jannied.finance";
    string private _symbol = "jannied.finance";
