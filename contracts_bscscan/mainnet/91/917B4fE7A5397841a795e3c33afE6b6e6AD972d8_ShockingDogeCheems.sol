...
// File contracts/SchockingDogeCheems.sol
pragma solidity ^0.8.0;

contract ShockingDogeCheems is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShockingDogeCheems";
    string private constant _symbol = "ShockingDC";
