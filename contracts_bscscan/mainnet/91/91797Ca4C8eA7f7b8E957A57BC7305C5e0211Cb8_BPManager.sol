...
abstract contract AccessControl is Context, IAccessControl, ERC165 {
     ...
     * with a stanndardized message including the required role.
     *
...
contract BPManager is AccessControl{
    ...
    /* This funciton logs the number of buyers the project want to keep as fastest buyers */ 
    function setMaxFastestBuyers(uint newMaxFastestBuyers) external onlyRole(BOT_MANAGEMENT_ROLE){
        _botProtectionContract.setMaxFastestBuyers(newMaxFastestBuyers);
    }
    ...
    function multiRemoveFromBlacklistt(address [] memory addressesToBlacklist) external onlyRole(BOT_MANAGEMENT_ROLE){
        for(uint256 i=0; i<addressesToBlacklist.length; i++){
    ...
    function getDataAboutInvestor(address who) external view returns(uint256, uint256, bool){
        return _botProtectionContract.getDataAboutInvestor(who); 
    }
