...
contract Context {
 ...
 contract HollowGirl is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "HollowGirl";
    string private _symbol = "HOLLOWG";
    ...
    address private _MarketingWalletSYLOM = 0x7b31AE73090feFfb4882E0EE72C0b93648CE15a6;
