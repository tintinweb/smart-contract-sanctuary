...
contract MinWarzoneDoge is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Mini Warzone Doge','MINIWARDOGE') {
        _mint(0xB1a2a230a02ebC221caC8e0f1efF8f3a2d2cB83D, 1000000000000 *10**18);
