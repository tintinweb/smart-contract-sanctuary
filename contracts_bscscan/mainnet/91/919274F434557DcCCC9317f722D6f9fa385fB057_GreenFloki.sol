...
contract GreenFloki is IBEP20, Auth {
    ...
    string constant _name = "Green Floki"; //token name #4 
    string constant _symbol = "GFloki"; // token tika #5
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 5 )  / 100; //max transaction % #6
    ...
    uint256 liquidityFee    = 5; // ammount to LP #7
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x22dc33e6C9902C111bB86fC4392baDeaC273546A ;
