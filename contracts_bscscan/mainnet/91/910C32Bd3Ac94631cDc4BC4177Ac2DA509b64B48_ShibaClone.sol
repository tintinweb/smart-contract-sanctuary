 ...
 * TELEGRAM: HTTPS://T.ME/ShibaClone
  ...
  Welcome to ShibaClone   
   Tax: 
   4 % added to liquidity
   3% goes to marketing
   7% goes to holder (SHIBA REWARDS)
...
contract ShibaClone is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaClone";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x6Ac842D85e7858cf3b2C45Be1d7b66bfC804BFe1;
