...
contract NarutoSpace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NarutoSpace";
    string private _symbol = "NARUTOSPACE";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x2591C0411b99fb8C133C9BF78665750503abe8Ce);
    address payable public teamWalletAddress = payable(0x2591C0411b99fb8C133C9BF78665750503abe8Ce);
