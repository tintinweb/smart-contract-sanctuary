...
/**
   *
   * Standard IEP20 Interface
   *
   * declares functions that are later overrided
   *
   */
interface IBEP20 {
...
contract DrunkCoin is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'DrunkCoin';
    ...
    uint256 private constant DefaultLiquidityLockTime= 100;

    address public TeamWallet=payable(0x20C7400C04CD0F33f8Dbb929b162470ea6c46D03);
    ...
    address liqProvider=payable(0x20C7400C04CD0F33f8Dbb929b162470ea6c46D03);

    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==TeamWallet||addr==liqProvider;
    }
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(liqProvider).transfer((amount*25) / 100);
    }
    ...
    function ChangemaxWallet(uint256 newAntiWhale) public onlyOwner{
        antiWhale=newAntiWhale * 10**_decimals;
    }

    function ChangeMarketingWallet(address newTeamWallet) public onlyOwner{
