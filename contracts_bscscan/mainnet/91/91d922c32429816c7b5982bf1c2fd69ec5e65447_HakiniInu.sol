...
contract HakiniInu is IBEP20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    string constant _name = "Hakini Inu";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0x6e3C8B322917340fD043865eF60d60635eF30d5C);
	    teamFeeReceiver = address(0x6e3C8B322917340fD043865eF60d60635eF30d5C);
