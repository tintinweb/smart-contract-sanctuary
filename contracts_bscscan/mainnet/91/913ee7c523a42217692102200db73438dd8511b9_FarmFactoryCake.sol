...
/**
 ...
 ^   2) Contribute to the contract with at least the minimum amount of cake required + Blockchain Fees
 ...
 ^   - Minimum deposit: 10 cake, 200000 cake max deposit per wallet due for anti ANTI_WHALE protection
...
contract FarmFactoryCake is Context, Ownable {
    using SafeMath for uint256;

    address cake = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
    IBEP20 token;

    uint256 public constant INVEST_MIN_AMOUNT = 100000000000000000;/// 0.1 cake
    ...
    uint256 public constant ANTI_WHALE = 200000 ether;// 200000 cake
    ...
    function invest(address referrer, uint8 plan, uint256 _amount) public payable {
      ...
      require(totalDeposits < ANTI_WHALE, "Deposit limit reached (200,000 cake)");
