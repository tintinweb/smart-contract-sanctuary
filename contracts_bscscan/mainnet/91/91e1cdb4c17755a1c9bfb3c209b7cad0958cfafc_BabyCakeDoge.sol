...
contract BabyCakeDoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyCakeDoge";
    string constant _symbol = "BABYCAKEDOGE";
    ...
    uint256 public _walletMax = 80000000000000 * (10**9);
    ...
    uint256 public swapThreshold = 2000000000 * (10**9);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x07BC99Ee48C937C403b8189645a3c25364ABA506;
