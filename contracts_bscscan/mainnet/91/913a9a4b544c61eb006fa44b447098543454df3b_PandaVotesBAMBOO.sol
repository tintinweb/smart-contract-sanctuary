...
contract PandaVotesBAMBOO {

  function name() public pure returns(string memory) { return "PandaVotesBAMBOO"; }
  function symbol() public pure returns(string memory) { return "PandaVotesBAMBOO"; }
  function decimals() public pure returns(uint8) { return 18; }  

  function totalSupply() public view returns (uint256) {
  IPair pair1 = IPair(0xa300526D664a0227c2fdFC0b423750E371Ab2ebD);
  (uint256 lp1_totalpandaA, uint256 lp1_totalpandaB,) = pair1.getReserves();

    return (lp1_totalpandaB);
  }
  ...
  function balanceOf(address owner) public view returns (uint256) {
    ...
    // LP pair2
    (uint256 lp1_totalpandaA, uint256 lp1_totalpandaB,) = pair1.getReserves();
    (uint256 lp1_userpanda,) = chef.userInfo(91, owner);
