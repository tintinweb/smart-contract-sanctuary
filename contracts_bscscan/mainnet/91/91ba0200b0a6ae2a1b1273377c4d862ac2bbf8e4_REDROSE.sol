...
contract REDROSE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Red Rose";
    string private _symbol = "RDR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD50d43BEF9FF32c67DbA35a8Dec21CE3A0Bff664); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6Fc51b939F1E1631C934bCfFAE4571De6248c554); // Treasury / Buyback
    ...
    uint256 private _totalSupply = 1000000000 * 10**6 * 10**9; // 1 Billion
