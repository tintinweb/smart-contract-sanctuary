...
/*
Hello, from Danial, Amir, Shasha, Diayana & Nik !               
*/
...
contract MetaTicket is Context, IERC20, Ownable {
    ...
    string private _name = "MetaTicket";
    string private _symbol = "MEKE";
    ...
    //addresses
    address public BuybackFeeAddress = 0x7b18646f76D9662e2768DCDf14191E2EfdfAFbB5; // BuybackFeeAddress
 ...
 /**
    ...
    */
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'GNGL:ctract it self cannot be excluded');
        require(!_isExcluded[account], "GNGL: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "GNGL: Account is already included");
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        uint256 BuybackFee = amount.mul(_BuybackFee).div(10000);
        ...
        if(BuybackFee > 0){
            ...
            _reflectionBalance[BuybackFeeAddress] = _reflectionBalance[BuybackFeeAddress].add(BuybackFee.mul(rate));
            _BuybackFeeTotal = _BuybackFeeTotal.add(BuybackFee);
            emit Transfer(account,BuybackFeeAddress,BuybackFee);
        }
        //@dev Burn fee
        if(BurnFee > 0){
