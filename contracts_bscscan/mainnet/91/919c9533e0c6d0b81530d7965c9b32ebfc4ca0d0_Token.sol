...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (string memory tokenName, string memory tokenSymbol, uint8 decimal)  {
        
        address tokenOwner = 0x60bcb0Cd4E76a1E385A0bE028F99017b19266096;
        uint256 amountOfTokenWei = 1000000000000000000;
        _name = tokenName;
        _symbol = tokenSymbol;
        _decimals = decimal;
        _tTotal = amountOfTokenWei; //1000000000000000000
        _rTotal = (MAX - (MAX % _tTotal));
        
        _rOwned[tokenOwner] = _rTotal;

        feeWallet = payable(0x60bcb0Cd4E76a1E385A0bE028F99017b19266096);
        

        _maxTxAmount = _tTotal.mul(100).div(
            10**2
        );
        _maxWalletAmount = _tTotal.mul(100).div(
            10**2
        );
