...
// Big Mom Inu ($BigMomInu) - Welcome to Big Moms Whole Cake Island!
// Tax 15% Buy | Sell | Transfer
// Telegram: https://t.me/bigmominu                  
// Website: https://bigmominu.com/
...
contract BigMomInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2011dd779EEc65048FCEbcB439b264B5eAbF8011); // Marketing Address
    ...
    string private _symbol = "BigMomInu";
    ...
    uint256 private _botEndblock = 15;
    ...
    // Prevent BOT & Whales
    function zUnlock() public onlyOwner {
        _botStartblock = 99;
        _botEndblock = 99;
    }
