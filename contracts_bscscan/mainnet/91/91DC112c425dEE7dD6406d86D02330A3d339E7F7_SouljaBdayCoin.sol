...
████████████████████████████████████████████████████
██TELEGRAM: https://t.me/SouljaBdayCoin           ██
██Twitter:  https://twitter.com/SouljaBdayCoin    ██
████████████████████████████████████████████████████


It's a sad thing BSC scan is slow today, But it's Soulja's birthday so we gotta push through and celebrate like no tomorrow! 

█████████████████████████████████████████████████████████████████████████████████████████████████████████████████
██                                                                                                             ██
██Today is Souljaboy's Birthday and what better to celebrate than with a $DOGE rewarding token!                ██
██$DOGE gets redistributed automatically every hour or when you sell 100+ tokens.                              ██
██To see the $DOGE in your wallet add the following address:                                                   ██
██                                                                                                             ██
██You might wonder why some transactions happen in 3's?                                                        ██
██This is the contract selling the tax reserved tokens in order to reward the holders with $DOGE               ██
██                                                                                                             ██
██We on't renounce ownership as the burns are done manually,                                                   ██
██We will lock or burn the LP tokens after launch so no rugs will be possible!                                 ██
██                                                                                                             ██
██Some more info on tokenomics can be found below                                                              ██
██                                                                                                             ██
█████████████████████████████████████████████████████████████████████████████████████████████████████████████████
...
>>>>>> 3% Team wallet
>>>>>> 2% marketing wallet
>>>>>> total supply: 100billion = 100.000.000.000 tokens
>>>>>> Max wallet size of 1.5b = 1.500.000.000 tokens
>>>>>> slippage: 18%
>>>>>> sell will incur 3% extra tax, i.e set 21% slippage for sell tax this is being used by the contract to cover the BNB to $DOGE swap costs.
...
contract SouljaBdayCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SouljaDividendTracker public dividendTracker;
    ...
    constructor() ERC20("SouljaBdayCoin", "SBC") {
    	...
    	dividendTracker = new SouljaDividendTracker();

    	buyBackWallet = 0xBdEf302c197A0574Ff9EFd162eE04c367a405566;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        SouljaDividendTracker newDividendTracker = SouljaDividendTracker(payable(newAddress));
...
contract SouljaDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Soulja_Dividend_Tracker", "Soulja_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "Soulja_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "Soulja_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Soulja_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Soulja_Dividend_Tracker: Cannot update claimWait to same value");
