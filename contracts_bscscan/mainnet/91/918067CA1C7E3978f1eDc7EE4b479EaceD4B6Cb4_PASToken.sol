...
contract PASToken is Context, IBEP20, Ownable, ERC1132 {
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal {
        ...
        require((_balances[sender] - lockAmount(sender)) >= amount, "Transfer LOCK: You are staking on this address");
    ...
    function lockAmount(address _of) public view returns (uint256 amount){
