...
Marketplace: https://nft-lokibsc.com/marketplace
TG: 
...
contract NFTLOKI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4d8ee4a205788a9F81acD8B1Aa5c9FaBF67b7aC5); // Marketing Address
    ...
    uint256 private _tTotal = 100 * 10**9 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "NFT LOKI";
