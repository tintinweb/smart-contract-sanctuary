...
/**
 *
 * https://bankroll.holdings/
 * Telegram: https://t.me/bankrollbsc
 */
...
abstract contract BANKPausable is BANKAuth {
    bool public paused;
...
abstract contract BANKFinalizable is BANKAuth {
...
interface IBANKWhitelister {
    function isWhitelisted(address adr) external view returns (bool);
}

contract BANKWhitelistPassthrough is IBANKWhitelister {
    IBANKMigrationData migration;
    constructor (address _migration) {
        migration = IBANKMigrationData(_migration);
    }
...
abstract contract BANKWhitelisted is BANKAuth {
    IBANKWhitelister whitelister;
    bool public whitelistEnabled;
    
    constructor (bool _enabled, address _whitelister) {
        whitelistEnabled = _enabled;
        whitelister = IBANKWhitelister(_whitelister);
    }
...
contract BANKStaking is BANKAuth, BANKPausable, BANKFinalizable, BANKWhitelisted, IBANKStaking {
    ...
    constructor (address _stakingToken, address _rewardToken, bool _whitelisted, address _whitelister, bool _final) BANKAuth(msg.sender) BANKWhitelisted(_whitelisted, _whitelister) {
