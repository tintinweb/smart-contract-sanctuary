...
Official Telegram group : https://t.me/babyspiderman_chat
Website : https://twitter.com/BabySM_Group
Twitter : https://twitter.com/BABY SPIDERMANbsc
...
contract BSM is ERC20, Ownable {
    ...
    constructor() public ERC20("BABY SPIDERMAN", "BSM") {

    	dividendTracker = new BSMDividendTracker();

        _marketingWalletAddress = 0xb16011b46ee326F96b22368aa6640377b7b018C6;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BSM: The dividend tracker already has that address");

        BSMDividendTracker newDividendTracker = BSMDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BSM: The new dividend tracker must be owned by the BSM token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BSM: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BSM: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BSM: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BSM: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BSM: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BSM: Cannot update gasForProcessing to same value");
