...
/**
   ...
   Welcome to LittleCorgi
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleCorgiCommunity
...
contract LittleCorgi is Context, IERC20, Ownable {
    ...
    string private _name = "Little Corgi";
    string private _symbol = "LTCORGI";
