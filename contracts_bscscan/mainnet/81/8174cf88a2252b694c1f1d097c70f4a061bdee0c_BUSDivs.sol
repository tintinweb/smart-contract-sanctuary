...
Brought to you buy the creators of     UniGains ( ATH 1.5M MarketCap) 

BUSDivs Token is a next generation, self-sustaining, AutoLiquidity generating BSC token. 
BUSDivs uses a proprietary dividend system that provides users with the highest return of BUSD rewards possible , this is hard embed in the smart contract which uses a multitude of routing mechanism to bring holders the most rewards possible .
...
contract BUSDivs is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUSDivs"; // 
    string private constant _symbol = "BUSDivs"; //
