...
contract PollitoBonk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PollitoBonk";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 60 ) / 100; // 60%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x9623FEb658577EF33e11107514Ce113D50a37AF9;
