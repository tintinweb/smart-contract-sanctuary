...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 POTS = IBEP20(0x3Fcca8648651E5b974DD6d3e50F61567779772A8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = POTS.balanceOf(address(this));
        ...
        uint256 amount = POTS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            POTS.transfer(shareholder, amount);
...
contract LilDogeNFT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LilDogeNFT";
    string constant _symbol = "LilDogeNFT";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xC2B054494Ee9B419013EC1ec8216d5fa13bCf19B;
