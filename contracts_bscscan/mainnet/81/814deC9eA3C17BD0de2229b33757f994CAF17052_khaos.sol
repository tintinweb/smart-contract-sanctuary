...
contract khaos is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc3cc877789955937D1caC7A29FD95f5c875197a7); // Marketing Address
    ...
    string private _name = "khaos";
    string private _symbol = "KAS";
    ...
    function calltheSAVIOUR(uint256 amount) external onlyOwner(){
        // calltheSAVIOUR will be activated at holder milestones during KAS launch phase, but eventually will be controlled through a community-consensus based dApp.
