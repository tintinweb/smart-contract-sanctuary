...
contract SantasMoon is Context, IERC20, Ownable {
    ...
    // fees
    uint256 public _taxFee = 200; // 100 = 1% HOLDERS REDISTRIBUTION
    uint256 public _charityFee = 200; // 100 = 1% CHARITY FEE
    uint256 public _MarketingFee = 500; // 100 = 1% MARKETING FEE
    uint256 public _liquidityFee = 500; // 100 = 1% LIQUIDITY FEE
    //variables
