...
Shibic brings cutting edge DeFi features to existing BSC tokens like staking and DeFi lending.
...
contract Shibic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x7b5C57FE977a720031D655d1aA00D93A00B772FC); 
    address payable public developmentAddress = payable(0x8913e8023667Fca925D849bfed5fC6262E1C500E); 
    address payable public charityAddress = payable(0x32b730AaDe4DAF98375550130CdA489f90611542); 
    address payable public vaultRewardAddress = payable(0x78E2EFA3aC2AC00a4E3683D06153493B1bB3465D); 
    ...
    string private constant _symbol = "Shibic";
