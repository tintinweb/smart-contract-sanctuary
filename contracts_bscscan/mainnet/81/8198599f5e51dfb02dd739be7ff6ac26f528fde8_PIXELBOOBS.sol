...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0xCd7DAD8100088850456375b92baF9ADA673dcce6;
...
contract PIXELBOOBS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "PIXEL BOOBS";
    string private _symbol = "PBOOBS";
    ...
    uint256 internal _tokenTotal = 69_000_000_000_000e9;
    ...
    uint256 public _taxFee = 2; // means 4% which distribute to all holders
    uint256 public _liquidityFee = 1; // means 2% add liquidity on each buy and sell
    uint256 public _burnFee = 2; // means 3% it menas on burn 
    uint256 public communityFee=100; //100 means 1% will send to charity
    
    
    address communityAddress=0xdF74826AFEcd92e00F592d634425d87AEf72C9Fd; //
