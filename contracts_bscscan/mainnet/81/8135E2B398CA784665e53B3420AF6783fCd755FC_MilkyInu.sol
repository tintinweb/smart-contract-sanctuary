...
contract Context {
 ...
 contract MilkyInu is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "MilkyInu";
    string private _symbol = "MKINU";
    ...
    address private _MarketingWalletSYLOM = 0x0E2C519d81BDa36a1a7dDdCcAd4aB1CCb8e5164F;
