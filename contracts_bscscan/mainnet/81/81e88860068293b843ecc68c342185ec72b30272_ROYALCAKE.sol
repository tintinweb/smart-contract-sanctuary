...
( Slippage = 13-15% )
*𝗜𝗠𝗣𝗢𝗥𝗧𝗔𝗡𝗧 - 𝗧𝗛𝗘𝗥𝗘 𝗪𝗜𝗟𝗟 𝗕𝗘 𝗡𝗢 𝗣𝗩𝗧, 𝗡𝗢 𝗣𝗥𝗘𝗦𝗔𝗟𝗘, 𝗡𝗢 𝗪𝗛𝗜𝗧𝗘𝗟𝗜𝗦𝗧𝗜𝗡𝗚*



𝟏𝟎% 𝐑𝐞𝐝𝐢𝐬𝐭𝐫𝐢𝐛𝐮𝐭𝐢𝐨𝐧 𝐈𝐧 𝐂𝐚𝐤𝐞
10% of every transaction is taken and redistributed to all holders. Minimum to hold is 0.02% of supply.



𝗔𝘂𝘁𝗼 𝗣𝗮𝗶𝗱 𝗘𝘃𝗲𝗿𝘆 𝟲𝟬 𝗠𝗶𝗻𝘂𝘁𝗲𝘀
With our uniquely designed contract, you don't have to lift a finger to receive your rewards, let RoyalCake do all the work while you enjoy your yummy cake!
...
Earn 10% Cake Rewards! Join Now, Dont miss this 100x!

WEB: https://www.royalcakebsc.net/
 */
...
contract ROYALCAKE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ROYALCAKE";
    string constant _symbol = "RCAKE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xEc88ce925faB504E14db8Dd16a09731e66219D4B; //WALLET DEV
