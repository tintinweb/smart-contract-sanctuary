...
░█▄▄▄█ ▀──▀ ──▀── ▀▀▀ ──▀── ▀──▀ ▀▀▀ ▀── ─▀▀▀ ──▀── ─▀▀▀ ▀─▀▀ ▀▀▀
 ...
 Welcome to SaveTheFuture
   
   This is a community token with around 5k active follower.

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #SaveTheFuture to the community, make sure it's 100% safe.

   I will add .4 BNB and all the total supply left to the pool
   We will make this coin to 100x and over 1000x within this month i believe !
   but we need your help to do this, and we will acchieve this toghether !

   With your help, i know and you know. that we can save the future.
*/
...
contract SaveTheFuture is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "SaveTheFuture";
    string private _symbol = "SaveTheFuture";
