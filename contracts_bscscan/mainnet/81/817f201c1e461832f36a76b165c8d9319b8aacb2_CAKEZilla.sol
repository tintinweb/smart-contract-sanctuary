...
contract CAKEZilla is Context, IERC20, Ownable {
    ...
    string private _name = "CAKE ZILLA";
    ...
    uint256 public _buyLiquidityFee = 10; //MARKETING 3% + BUYBACK 2%
    
    uint256 public _sellTaxFee = 4; //TO HOLDER
    uint256 public _sellLiquidityFee = 17; //MARKETING 3% + BUYBACK 3%
    ...
    uint256 public marketingDivisor = 8; //% FROM %LP
