...
/**
 * @title TrustPocketTokenGold
 */
contract TrustPocketTokenGold is ERC20, Ownable {
    ...
    uint256 private _baseSlab = 1470000000000000000000000;
    uint256 private _basePriceWei = 10630000000000000;

    uint256 private _incrementWei = 1329000000000;
    uint256 private _buyFee = 0;
    uint256 private _buyCommission = 1000;
    uint256 private _sellCommission = 1000;

    uint256 private _maxSellBatch = 99000000000000000000; //in TPTG
    uint256 private _maxBuyBatch = 999000000000000000000; //in TPTG
    ...
    address payable PUBLIC_LISTINGS; //40%
    ...
    constructor (
        ...
        //distribute shares
        transferTo(PUBLIC_LISTINGS, 840000000000000000000000 , false);
    ...
    function buyTokens() external payable{
        ...
        require(token_wei <= _maxBuyBatch, "TPTG: invalid buy quantity" );
    ...
    function transferTo(address to, uint256 value, bool convert_to_wei) internal  {
        require(to != address(0), "TPTG: transfer to zero address");
    ...
    function stakeTokens(uint256 amount) external {
        ...
        require(balanceOf(_msgSender()) >= amount, "TPTG: recipient account doesn't have enough balance");
    ...
    function unstakeTokens(uint256 amount) external {
        amount = amount * 1 ether;
        require(balanceOf(_feeReceiver) >= amount, "TPTG: invalid token digits");
    ...
    function sellTokensWei(uint256 amount) external {
        ...
        require(balanceOf(_msgSender()) >= amount, "TPTG: recipient account doesn't have enough balance");
        require(amount <= _maxSellBatch, "TPTG: invalid sell quantity" );
        ...
        require(address(this).balance >= wei_value, "TPTG: invalid digits");
