...
contract EggFlipper is Ownable, IERC721Receiver {
  // mainnet
  address public constant ANML_TOKEN_ADDRESS = 0xad9282bD580Ba3D17603de9dE1113234AC829686;
  // testnet
  // address public constant ANML_TOKEN_ADDRESS = 0x030b97ccD62d07864139c029bE725E677A0bE897;

  // mainnet
  address public constant ZOO_TOKEN_ADDRESS = 0x7fFC1243232da3Ac001994208E2002816b57c669;
  // testnet
  ...
  IERC721Enumerable private anmlToken;
  ...
  constructor() {
    anmlToken = IERC721Enumerable(ANML_TOKEN_ADDRESS);
  }
  ...
  function getAnmlsOwnedBy(address _user) external view returns (OwnAnml[] memory) {
    uint256 anmlCount = anmlToken.balanceOf(_user);

    OwnAnml[] memory anmls = new OwnAnml[](anmlCount);
    for (uint256 i = 0; i < anmlCount; i++) {
      uint256 tokenId = anmlToken.tokenOfOwnerByIndex(_user, i);
