...
/**
   #BigRocket
    ...
    I make this #BOKINewShiba to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BigRocket
   ...
   I will renounce the ownership to burn addresses to transfer #BigRocket to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #BigRocket 10000000X? 
   ...
   it's the best part of the #BigRocket idea, increasing the liquidity pool automatically, 
...
contract BigRocket is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "🚀BigRocket🚀";
  string private _name = "BigRocket";
