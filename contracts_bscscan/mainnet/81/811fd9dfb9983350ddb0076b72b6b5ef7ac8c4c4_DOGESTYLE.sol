...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract DOGESTYLE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5892dBB93A963493B9b501c769f6d6Da7ffd7D95); // Marketing Address
    ...
    string private _name = "DOGESTYLE";
