...
import "./BabyFootball-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyFootball` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyFootball(Env.Testnet)` or `BabyFootball(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyFootball";
    string internal constant SYMBOL = "BFB";
     ...
     */
    address internal tipToTheDev =0x0866A8BA4eC3cE2E144CA2f58Cb171f872c11cFC;
...
contract BabyFootball is SafeToken{
