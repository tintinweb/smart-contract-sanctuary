 ...
 * NinjaShibaBUSD gathers BUSD and delivers direct to your wallet!!!!
*/
...
contract NinjaShibaBUSD is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "NinjaShibaBUSD";
  string private _name = "NinjaSBUSD";
