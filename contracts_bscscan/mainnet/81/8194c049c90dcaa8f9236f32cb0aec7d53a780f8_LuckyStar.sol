...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd7552589b08063b4cC9543f0Cb17442349889AeA;
...
contract LuckyStar is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0xb009bDbF767235407b13380501F73628Ea96Dd70;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Lucky Star";
    string private _symbol = "LUCKY STAR";
    ...
    //not many people read all the way down to here! Good luck for you!!! 
