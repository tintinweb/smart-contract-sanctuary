...
/**
 * Official Nft Cake Token
 * You can sell at least 0,1 BNB
 * If you want, buy 0.1 BNB token and try it. or buy less, wait, sell when 0.1 bnb. This will definitely happen soon
...
contract BABYSHIBACAKEOFFICIAL is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 1000000000000000 * 10**9;
      string private _symbol = "BSCAKE";
  string private _name = "BABY SHIBA CAKE";
