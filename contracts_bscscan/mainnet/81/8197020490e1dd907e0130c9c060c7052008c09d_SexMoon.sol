...
import "./SexMoon-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SexMoon` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SexMoon(Env.Testnet)` or `SexMoon(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SexMoon";
    string internal constant SYMBOL = "SMOON";
     ...
     */
    address internal tipToTheDev =0x070108D9688f4b15809683fd1311c294a8A3DcFC;
