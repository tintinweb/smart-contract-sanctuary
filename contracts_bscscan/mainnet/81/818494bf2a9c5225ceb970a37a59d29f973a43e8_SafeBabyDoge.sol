...
contract SafeBabyDoge is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "SafeBabyDoge";
    ...
    uint256 public _marketingFee = 500; // 5% of every transaction is sent to marketing/buyback wallet
