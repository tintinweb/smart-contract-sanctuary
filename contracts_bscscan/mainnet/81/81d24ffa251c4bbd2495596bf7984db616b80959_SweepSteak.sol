...
// SPDX-License-Identifier: MIT
 ...
 /**
    SweepSteak: Roulette, Lottery, Casino

    Token Lottery/Roulette: One lucky winner will take the POT every 50 transactions. The more you hold, the bigger your chance to win.

    BNB Lotterie: A lucky holder/holders are drawn once a day to win the jackpot of BNB from the accumulated pool

    HODL AND WIN - It’s that easy! And its the SweepSteak way!

    Join the Telegram: https://t.me/sweepsteaks

    Website and Whitepaper: https://www.sweepsteak.net/
...
contract SweepSteak is Context, IBEP20, Ownable {
    ...
    address public constant _potAddress = 0xD31Fe68A3113aE6ECF92176B9dFF2f3CEC4fdd82;
    ...
    string private _name     = "SweepSteak";
    ...
    uint256 public transactionsPerLottery = 50;
