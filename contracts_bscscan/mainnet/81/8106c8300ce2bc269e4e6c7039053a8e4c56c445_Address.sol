...
// DUPA change "STARINU" to the name of the contract e.g. CAKE is called CakeToken
contract Dango is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    // DUPA change this to your wallet address
