...
/**
   ...
   I love NFTGAME, NFTGAME is the future of crypto, are you an NFTGAME lover?
   ...
   I make this #NFT1000X to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/BSCNFTGAME1000X
   ...
   I will renounce the ownership to burn addresses to transfer #NFT1000X to the community, make sure it's 100% safe.

   I will add 0.1 BNB and all the left 50% total supply to the pool
   Can you make #NFT1000X 1000X? 
   ...
   it's the best part of the #NFTGAME1000X idea, increasing the liquidity pool automatically, 
...
contract NFTGAME1000X is Context, IERC20, Ownable {
    ...
    string private _name = "NFTGAME 1000X Token";
    string private _symbol = "NFTGAME1000X";
