...
// 3% LP, 7% UNI REWARDS, 4% MARKETING | 14% TAX
// Telegram : https://t.me/stronguni
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SUSHI = IBEP20(0x3Fcca8648651E5b974DD6d3e50F61567779772A8);
    ...
    event Deposit(uint256 amountBNB, uint256 amountSUSHI);
...
contract StrongUni is IBEP20, Auth {
    using SafeMath for uint256;

    address SUSHI = 0xBf5140A22578168FD562DCcF235E5D43A02ce9B1;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "StrongUni";
    string constant _symbol = "StrongUni";
