...
$InfinityDoge uses the following tokenomic breakdown to power its system and provide the premier Token reward platform.

Great features🔥:
2% of each transaction redistributed to holders
2% of each transaction sent to liquidity
2% of each transaction burned

✅ Verified contract
✅ Ownership Renounce
✅  Max Buy 2% from Total Supply
✅ Big Marketing Before and After Launch
...
TG: https://t.me/InfinityDogeChain
...
contract InfinityDogeCoin   is BEP20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public BEP20("InfinityDoge", "INFINITY DOGE") {
