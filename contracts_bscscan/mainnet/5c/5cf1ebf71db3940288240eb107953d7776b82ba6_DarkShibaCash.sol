...
//   
/*
Welcome to DarkShibaCash where rewards in SHIB
TG: https://t.me/DarkShibaCash
Twitter: https://twitter.com/DarkShibaCash
Website: darkshiba.cash

Tokenomics: 8% REWARDS 2% LP Fee 4% Marketing Fee, 1% Team
add SHIB token to check your rewards
...
abstract contract Auth {
     ...
     */
    modifier authorized() {
        require(isContractOwner(msg.sender), "!AUTHORIZED"); _;
    }
     ...
     */
    function isContractOwner(address adr) public view returns (bool) {
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Eth = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract DarkShibaCash is IBEP20, Auth {
    using SafeMath for uint256;

    address Eth = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DarkShibaCash";
	...
	uint256 public _maxWalletSize = (_totalSupply * 0) / 100; // 0% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xeDf78c396a648c9cC775e6383690fBE35e67552A;
    ...
    function checkTxLimit(address sender, uint256 amount, bool selling) internal view {
		...
		if(selling) {require(amount <= _maxSellTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");}
    }
