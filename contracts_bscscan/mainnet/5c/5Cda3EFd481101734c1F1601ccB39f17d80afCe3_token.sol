...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "ceshibi";
    string private _symbol = "ceshibi";
    ...
    address public ownerAddres = address(0xEbe28b0B63838988F60abf6026A71fcBB9AfD998);
    address public devOneAddress = address(0xF59b8966145C8024e91D8a804db6F2dba2Db74Fd);
    address public devTwoAddress = address(0x0fF3C355692a911FeA831AC59d42B4eaa6f3fbC6);
    address public lpTokenAddress = address(0x1c956F758E144f4169d4094953e81Fc155e8D825);
    ...
    uint256 public _kpMaxTxAmount = 500000000000 * 10 **18;
