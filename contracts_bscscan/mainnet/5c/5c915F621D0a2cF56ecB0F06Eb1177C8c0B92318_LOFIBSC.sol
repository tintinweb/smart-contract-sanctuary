...
/**
 * TELEGRAM: T.ME/LOFIBSC
 * WEBSITE : WWW.LOFIBSC.CF
 * TRENDING REDDIT POST - COINSNIPER LISTING SOON - MARKETING STARTED
 * 9% CAKE REWARD
 * 3% LIQUIDITY 
 * 3% MARKETING 
*/
...
contract LOFIBSC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "LOFIBSC";
    string constant _symbol = "LB";
