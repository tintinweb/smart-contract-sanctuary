...
//Magic Chart Contract /////////////

contract MagicChart is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Magic Chart';
    string private constant _symbol = 'Magic Chart';
    ...
    address public TeamWallet=payable(0x6FA8A39BfA69739C292B59284E4f6B9ec5a63FC4);
    address public walletTwo=payable(0x0b85136Af7f98d85768f313f46fD62D77fC3D073);
