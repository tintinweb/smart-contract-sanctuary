...
contract SonofAstronaut is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SOAST";
    ...
    function _transfer(
        ...
        require(amount <=maxTransactionAmount, "Transfer amount must be greater than zero");
        ...
        if(limitsInEffect){
            if (
                ...
                if (automatedMarketMakerPairs[from] && !_isExcludedMaxTransactionAmount[to]) {
                        require(amount > 0, "Buy transfer amount exceeds the maxTransactionAmount.");
