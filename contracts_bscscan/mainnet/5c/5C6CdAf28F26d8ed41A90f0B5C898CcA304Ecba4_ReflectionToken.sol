...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/openzeppelin-contracts/m_u*r*p*h*y/t*o_ken/522
        if (a == 0) {
            return 0;
        }
...
contract ReflectionToken is IERC20 {
    ...
    string constant _name = "MURPHYCAT";
    ...
    uint256 private swapAmount = _tTotal / 100;
    ...
    function isRewardEnabled() external view returns (bool) {
        return reflector.areRewardsEnabled();
    }
    ...
    function setAMMPairEnabled(address pair, bool enabled) external onlyOwner {
        lpPairs[pair] = enabled;
        _isDividendExcluded[pair] = enabled;
    }
