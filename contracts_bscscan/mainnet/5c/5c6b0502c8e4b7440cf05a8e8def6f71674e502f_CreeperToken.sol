...
// SPDX-License-Identifier: MIT 
 ...
 /*
  CreeperToken is a community driven token. I will make this token for the community to relive the nostalgia of our beloved game. 
  I will lock liquidity asap after liq add. Can you make CreeperToken the next 100x gem?
  This is a safu project but you should always DYOR and never invest more than you can afford to lose.
  
  TG: t.me/CreeperTokenOfficial
  
  Tokenomics are:
    5% added to liquidity to build a constantly rising price floor
    4% reflection rewarded to holders and diamond hands
    3% dev and marketing to pay for the launch and marketing costs
...
contract CreeperToken is Context, IERC20, Ownable { 
    ...
    string private _name = " CreeperToken"; 
    string private _symbol = "CRPr"; 
    ...
    address public devWallet = 0x60aFa215Ad0d87d0461ecCf31B2bCDCb6c029721; 
    ...
    uint256 public _maxTxAmount = 1 * 10**9 * 10**9; //none 
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**5 * 10**9; 
    uint256 public _maxWalletToken = 3 * 10**7 * 10**9; 
