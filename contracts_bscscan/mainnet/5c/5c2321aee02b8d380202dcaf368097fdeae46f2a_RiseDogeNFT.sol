...
contract RiseDogeNFT is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function theLPBURN(bool _lpburn) public onlyOwner virtual returns (bool) {
        isBURN = _lpburn;
        return true;
    }
