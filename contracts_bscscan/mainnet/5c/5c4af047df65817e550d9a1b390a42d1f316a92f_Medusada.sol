...
/*
💥MedusADA💥 is an auto-reward token, which distributes ADA rewards among all holders. This contract has been set up to reward holders with a x2 rewards fee whenever somebody sells. This token will be a combination of fair and stealth launch. This means we will announce the day of launch but the exact time will remain a secret 💫
...
▶️ LP lock after launch with Mudra Manager
▶️ Contract will be verified
▶️ Anti bot and anti whale functions
▶️ AMA in VC on the day of launch
▶️ 10% tokens go to marketing wallet for paid promotions

——📱Social Media and References📱 ——

☑️ Website = www.medusada.com
☑️ Twitter = https://twitter.com/MedusADA_
☑️ Telegram = https://t.me/MedusADA
*/
...
contract Medusada is ERC20, Ownable {
	using SafeMath for uint256;
	...
	constructor() ERC20("MedusADA", "mADA")  {
