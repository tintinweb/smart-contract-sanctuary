...
/**
Brought to you by https://t.me/escobarcalls100x https://t.me/escobarsafucalls

https://www.mysterylaunch.me/
*/
...
library Address{
 ...
 contract PabloDoge is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 4000000 * 10**9;
    ...
    string private constant _name = "PabloDoge";
    string private constant _symbol = "PabloDoge";
    ...
    Taxes public taxes = Taxes(2, 5, 5, 3);
    Taxes public sellTaxes = Taxes(2, 5, 5, 3);
