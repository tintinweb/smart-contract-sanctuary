...
contract BlindDoge is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0x24Ff9384FB0816a98e5DBca5FC9A165714787290;
    ...
    string private _name   = "BlindDoge";
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    // Innovation for protocol by BDoge Team
    ...
    uint256 public _liquidityFee = 13; // 3% will be added pool, 10% will be converted to BNB
