...
contract Starzilla is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Starzilla";
    string constant _symbol = "Starzilla";
    ...
    address payable public liquidityFeeReceiver = payable(0x2E8741C0Fa2833485bF18747A39c035aD401F139);
    address payable public marketingFeeReceiver = payable(0x2E8741C0Fa2833485bF18747A39c035aD401F139);
