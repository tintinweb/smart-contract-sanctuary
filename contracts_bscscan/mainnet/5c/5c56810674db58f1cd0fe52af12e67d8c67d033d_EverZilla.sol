...
📣 TG: https://t.me/EverZilla
🐦 Twitter: https://twitter.com/EverZillaBSC
💻 Website: https://www.everzilla.net/

  10% Buy Tax | 15% Sell Tax
...
contract EverZilla is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'EverZilla';
    string private constant _symbol = 'EverZilla';
    ...
    address public Marketing=payable(0x6fAaA028eB0c51A0D0bf318b6E8dd98Ea65c5d48);
    address private ConstantProvider=payable(0xF20458FBBF5B4C22dD8CbC9a6E80d8eB5F6cc903);
    address public BuyBack=payable(0x4c6E9B1Ef8952Fc9130694b179d4Ea0534E2b3A0);
    //TestNet
    ...
    function TeamProcessBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Marketing).transfer((amount*1)/5);
        payable(ConstantProvider).transfer((amount*3)/5);
