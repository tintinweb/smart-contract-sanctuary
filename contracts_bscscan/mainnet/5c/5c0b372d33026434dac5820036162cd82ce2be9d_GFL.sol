...
contract GFL is IBEP20, Auth {
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2A3E1D095F2902C9B6Da1bFF7813a7B2fc65C3dA;

    uint256 _totalSupply = 10**15 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10**13 * (10 ** _decimals);
    uint256 public _walletMax = 30**13 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x3db3067aC6365FBF769cf7965c24a1cBcF2bD61a;
        devWallet = 0x3db3067aC6365FBF769cf7965c24a1cBcF2bD61a;
