...
• • Burned: 50% 🔥
• 100% Liquidity burn to dead wallet 
• • Ownership Renounced
• 5% Tax Redistribution 
• ————————————————————    
KING Simba (KSIMBA) is a decentralized, peer-to-peer deflationary meme token that passively rewards its holders with a 5% tax redistribution for all transactions.  

Telegram📢: https://t.me/kingsimbacoin
Website👨‍💻: TBA
Twitter🐦: https://mobile.twitter.com/KingSimba67

BIG PARTNERSHIP ANNOUNCEMENT IS ON THE WAY!! 📢
...
contract KingSimbaCoin is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "KINGSIMBA";
