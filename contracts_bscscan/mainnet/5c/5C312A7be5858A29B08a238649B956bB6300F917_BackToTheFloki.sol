...
contract BackToTheFloki is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 200_000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "BackToTheFloki";
    string private _symbol = "BACKTOTHEFLOKI";
    ...
    uint256 public _marketingFee = 1300; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _boostedMarketingFee = 1500;
    ...
    address payable private _marketingWallet = payable(0x89A6B21cFC7262b61Cc8Df6A08ff0ca33c8F156a);
    address payable private _devWallet = payable(0x129e0B43e5cBd78cAD87C2bCCcd48bfed7057aea);
