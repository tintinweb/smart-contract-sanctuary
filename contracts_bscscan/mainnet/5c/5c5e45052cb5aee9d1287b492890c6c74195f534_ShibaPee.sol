...
contract ShibaPee is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFc6F0defE51257eE144Ba8F96fa04d46d42bCFe1); // Marketing Address
    ...
    uint256 public _taxFee = 2; // Auto-farm fee
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 6; // Other fees
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    // Tax fee applied when buying from Pancakeswap
    uint256 public _buyTaxFee = 2;
    uint256 public _buyLiquidityFee = 6;
    
    // Tax fee applied when selling to Pancakeswap
    ...
    uint256 public marketingDivisor = 67; // (Other fees / other fees + auto-boost fee) percentage
    
    uint256 public _maxTxAmount = 3 * 10**10 * 10**6;
    uint256 private minimumTokensBeforeSwap = 2 * 10**9 * 10**6; 
