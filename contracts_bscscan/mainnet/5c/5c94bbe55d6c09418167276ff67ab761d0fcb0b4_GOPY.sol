...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "locked until 7 days");
...
contract GOPY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x030809b2A826b383Aff19D67cE4d8852584af04b); 
    ...
    string private _name = "mrb";
    string private _symbol = "Pii";
