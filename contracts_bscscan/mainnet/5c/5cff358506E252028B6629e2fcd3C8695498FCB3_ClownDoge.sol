...
contract ClownDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0xf52d63c5bcf137e2A7639a477512462830229e46); 
    ...
    string private _name = "Clown Doge";
