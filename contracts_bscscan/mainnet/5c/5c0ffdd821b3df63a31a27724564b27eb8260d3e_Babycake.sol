...
//
Projcect : Babycake
Launch Time: July 17, 2021 at 2PM (UTC)
Total Supply: 1,000,000,000 TOKENS
15% TAX ON EVERY TRANSACTION
That will be distributed as follows:
10% to BNB Rewards pool
3% liquidity pool
2% Buy back to burn, Charity, and Events
...
contract Babycake is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1_000_000_000; //1 Trillion, underscores aid readability
    ...
    uint256 public _Maxtransectionperblock = 1;
    uint256 private _previousMaxtransectionperblock = _Maxtransectionperblock;
    ...
    address _marketingWallet = 0x7D2eAFAb9c4614Bf2BdF4d8490EB31751201F683;
    ...
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee <= 6); // Prevents owner from abusing fees.
