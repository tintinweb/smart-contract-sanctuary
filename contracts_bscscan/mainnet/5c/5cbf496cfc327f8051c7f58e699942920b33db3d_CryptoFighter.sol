...
/*
CRYPTO FIGHTER UTILITY TOKEN

https://crypto-fighter.com/

THE SEARCH FOR JUSTICE AND INTELLIGENCE IN THE DEFIVERSE BEGINS. 
GAIN GOLDEN PASS ACCESS TO THE HIGH UTILITY GAMING NFT WITH CRYPTO FIGHTER!
...
contract CryptoFighter is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9b9e4Eec1f98d6aFBF7BF1AD22d18f721c5Dc778); 
    ...
    string private _name = "CryptoFighter";
    string private _symbol = "CRYFI";
