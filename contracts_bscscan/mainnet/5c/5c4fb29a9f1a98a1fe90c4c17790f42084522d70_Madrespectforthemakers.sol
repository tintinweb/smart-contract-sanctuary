...
/**
   ...
   This is a community Mad respect for the makers. Create a telegram by your own.
...
contract Context {
 ...
 //LP is not locked and will be removed for test purposes, dont' put money in
library SafeMath {
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract Madrespectforthemakers is Context, IBEP20, Ownable {
  ...
  constructor() public {
    _name = "Mad respect for the makers";
    _symbol = "MRFTM";
    _decimals = 9;
