...
contract MASTERSHIBATOKEN  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MASTER SHIBA TOKEN ";
    string constant _symbol = "MSTOKEN";
    ...
    address public marketingFeeReceiver = 0xeFbb147855e4B7CEad19721795C4cDdF36bE41aD;
