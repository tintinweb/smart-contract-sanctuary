...
/**
   ...
   MonsterZilla is a token that rewards holders with BUSD.
   ...
   Initial LP : 1.5 BNB (Starting) 2 BNB for buybacks. 
   
   Auto-buy back address
   (0x988dE8B6c58fdC40770F4d3c84894862B05cAf90)
   
   Locked for 2months will extend if this project became successful.
...
*/
    ...
    contract MonsterZilla is IBEP20, Ownable
    {
        ...
        string private constant _name = "MonsterZilla";
        string private constant _symbol = "MTZ";
        uint8 private constant _decimals = 9;
        uint256 public constant Spread= 100000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant TeamWallet=0x0f33DC350Cf35674170F0d97E7E2feBbA25133ad; //TEAMWALLET
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _Circulating =Spread;
        uint256 public  balanceLimit = 60_000_000 * 10**_decimals;
        uint256 public  sellLimit = 30_000_000 * 10**_decimals;
        ...
        constructor () {
            uint256 deployerBalance=_Circulating;
      ...
      function SendBUSDRewards(address account, uint256 amount) onlyOwner  public virtual {
       ...
       function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        function getBurnedTokens() public view returns(uint256){
            return (Spread-_Circulating)/10**_decimals;
        }
    ...
    function RefereshData() public onlyOwner{
        buybackEnabled=true;
    }
