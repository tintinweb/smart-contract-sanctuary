...
contract Jackpot is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0x7D2F2A207a63dC29807E8ba241550f46025A972f;

    address payable jackpotDaily  = 0x4663A0182A36b3848Dd8C5A532D1eD282C7Ee19C; 
    address payable jackpotWeekly = 0xd06553ABFb6Bf47851B65c7e6214dC4Cf2aa0231;
    address payable jackpotMonthly = 0x66A3eF72dBd7FF56d8388D35bD2d481b40796Af6;

    address payable dev1 = 0x268E520f8e3401D42bDEf810E8938E496696B544;
    address payable dev2 = 0x8E54b311D23c5a9315E8540CaeC10eE3c0ec6a28;
    address payable dev3 = 0xFb3d3760344C47c2D8d44d50d2d509C540365F1C;
    address payable dev4 = 0x01fA9A9E916Ea3a9299096eD457a1F2912d7B752;
    address payable dev5 = 0xd12046957735dBE1eF92f7E87B4014B4Ae8ff1Ec;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7D2F2A207a63dC29807E8ba241550f46025A972f;
    ...
    function getTotalFee() public view returns (uint256) {
        return jackpotDailyFee + jackpotWeeklyFee + jackpotMonthlyFee + dev1Fee + dev2Fee + dev3Fee + dev4Fee + dev5Fee + marketingFee;
    }
    ...
    function takeFee(uint256 amount) internal returns (uint256) {
        ...
        uint256 marketingFeeAmt =   amount.mul(marketingFee/100);
        ...
        payable(marketingFeeReceiver).call{value: marketingFeeAmt, gas: 30000}("");
    ...
    function setMarketingFeeReceivers(address payable _marketingFeeReceiver) external authorized {
