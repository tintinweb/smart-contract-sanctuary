...
// simply hold $POW and you'll receive ADA automatically in your wallet.
// 
// Hold PowerADA and get rewarded in ADA on every transaction!
//
...
contract PowerADA is ERC20, Ownable {
    ...
    PowerAdaDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address transferredOwner = address(0xe25e72CA02D99c3031d5CAC1311a09B28EF8aa78);
    ...
    address payable public marketingWalletAddress = 0xd4E79655B929d162Ad9472BD41b1759F83400557;
    address payable public coreWalletAddress = 0xd4E79655B929d162Ad9472BD41b1759F83400557;
    ...
    constructor() public ERC20("PowerADA", "POW") {

    	dividendTracker = new PowerAdaDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "PowerAda: The dividend tracker already has that address");

        PowerAdaDividendTracker newDividendTracker = PowerAdaDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "PowerAda: The new dividend tracker must be owned by the PowerAda token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "PowerAda: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "PowerAda: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PowerAda: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "PowerAda: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "PowerAda: gasForProcessing must be between 200,000 and 600,000");
        require(newValue != gasForProcessing, "PowerAda: Cannot update gasForProcessing to same value");
...
contract PowerAdaDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("PowerAda_Dividen_Tracker", "PowerAda_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "PowerAda_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "PowerAda_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PowerAda contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "PowerAda_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PowerAda_Dividend_Tracker: Cannot update claimWait to same value");
