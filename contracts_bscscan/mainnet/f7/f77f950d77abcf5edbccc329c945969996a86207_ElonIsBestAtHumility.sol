...
Telegram = https://t.me/ElonIsBestAtHumility
...
// CHANGE
contract ElonIsBestAtHumility is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ElonIsBestAtHumility";
    string constant _symbol = "ElonHumility";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 7) / 100; // 7% MAX 70,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4A1E61adb5b56ad52Df0bb4241fe97DfBeDd3E07);
