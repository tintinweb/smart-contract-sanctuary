...
contract Thebatbabytoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public batAddress = payable(0x3fbBeB62A6fA48182ae115ee8331394eAA170D6c); // Bat Address
    ...
    string private _name = "Thebatbabytoken";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Send to bat address
        transferToAddressETH(batAddress, transferredBalance.mul(batDivisor).div(100));
    ...
    function setbatDivisor(uint256 divisor) external onlyOwner {
        batDivisor = divisor;
    }
    ...
    function setbatAddress(address _bataddress) external onlyOwner {
        batAddress = payable(_bataddress);
    }
