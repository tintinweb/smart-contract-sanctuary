...
// flokiflokireturnsBUSD @ https://t.me/flokiflokireturnsBUSD
...
// File: contracts/flokiflokireturnsBUSDDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x01e0910079fFb185565a756e97fc0C45bF21Fd2F);
...
// File: contracts/flokiflokireturnsBUSD.sol
...
contract flokiflokireturnsBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x01e0910079fFb185565a756e97fc0C45bF21Fd2F);
    address private _marketingWallet = address(0xEF4Bd34719c32d9B100b9048536eA5D337483f5B);
    // address private _devWallet = address(0x028b567F883f4a54A763b8426cEFdd32545862D2);

    bool private swapping;
    bool public airdrop;

    flokiflokireturnsBUSDDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;
    // address public devWallet = _devWallet;

    uint256 public maxBuyTranscationAmount = 1000 * (10**18); // 1% of total supply
    uint256 public maxSellTransactionAmount = 1000 * (10**18); // 1% of total supply
    ...
    constructor() public ERC20("flokiflokireturnsBUSD", "flokiflokireturnsBUSD") {
    	...
    	dividendTracker = new flokiflokireturnsBUSDDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "flokiflokireturnsBUSD: The dividend tracker already has that address");

        flokiflokireturnsBUSDDividendTracker newDividendTracker = flokiflokireturnsBUSDDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "flokiflokireturnsBUSD: The new dividend tracker must be owned by the flokiflokireturnsBUSD token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "flokiflokireturnsBUSD: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "flokiflokireturnsBUSD: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "flokiflokireturnsBUSD: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "flokiflokireturnsBUSD: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "flokiflokireturnsBUSD: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "flokiflokireturnsBUSD: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "flokiflokireturnsBUSDBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "flokiflokireturnsBUSD: This account cannot send tokens until trading is enabled");
        }
        ...
        if(
            ...
            uint256 marketingTokens = contractTokenBalance.mul(liquidityFee).div(totalFees);
...
contract flokiflokireturnsBUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("flokiflokireturnsBUSD_Dividend_Tracker", "flokiflokireturnsBUSD_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "flokiflokireturnsBUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "flokiflokireturnsBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main flokiflokireturnsBUSD contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "flokiflokireturnsBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "flokiflokireturnsBUSD_Dividend_Tracker: Cannot update claimWait to same value");
