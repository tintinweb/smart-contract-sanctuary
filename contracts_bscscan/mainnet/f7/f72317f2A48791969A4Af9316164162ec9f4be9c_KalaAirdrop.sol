...
contract KalaAirdrop is Context, ReentrancyGuard {
  ...
  constructor(
    ...
    require(maxClaimed_ > 0, "LDG::ctr: maxClaimed is zero");
    require(maxDownline_ > 0, "LDG::ctr: maxDownline is zero");
    require(amountPerClaim_ > 0, "LDG::ctr: amountPerClaim is zero");
    require(amountPerClaim_ <= maxClaimed_, "LDG::ctr: amountPerClaim exceeds maxClaimed");
  ...
  function _preProcess(
    ...
    require(referral_ != claimer_, "LDG::_preProcess: referral can not be sender");
    require(claimer_ != address(0), "LDG::_preProcess: claimer is the zero address");
    require((_claimed[claimer_] + amount_) <= _maxClaimed, "LDG::_preProcess: exceeds maximum claimed amount");
  }
