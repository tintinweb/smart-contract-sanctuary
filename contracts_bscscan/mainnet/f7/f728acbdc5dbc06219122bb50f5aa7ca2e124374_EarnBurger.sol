...
/**
    Welcome to EARN BURGER
    THE BURGER reward token
    BURGER reflection rewards just by holding EARN BURGER!

    Telegram : https://t.me/EarnBurger
    Website  : www.earnburger.com
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BURGER = IERC20(0xAe9269f27437f0fcBC232d39Ec814844a51d6b8f);
...
contract EarnBurger is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Earn Burger";
    string constant _symbol = "EARNBURGER";
