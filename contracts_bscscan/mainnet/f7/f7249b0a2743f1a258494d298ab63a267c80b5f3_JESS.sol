...
contract JESS is IBEP20, Ownable {
    ...
    uint256 private _buyMaxTxAmount = 2000000000000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 2000000000000 * 10 ** 9;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 2000000000000, "Can not reduce below 10K");
        require(maxSell > 2000000000000, "Can not reduce below 10K");
