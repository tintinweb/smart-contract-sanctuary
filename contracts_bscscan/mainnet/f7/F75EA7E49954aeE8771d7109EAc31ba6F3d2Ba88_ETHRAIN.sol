...
/**
 http://www.ethrain.com/
 https://twitter.com/ethrainn
 https://t.me/ethrain
 
 ✅ Honest team and dev doxxed
✅ Liquidity locked for 1 year.
✅ Low Market Cap.
✅ Invest in this project and feel safe.


🔹ETH and BNB Rewards Auto Redistributed
15% of each transaction is distributed amongst all $ERAIN holders in Eth and BNB. If you hold a minimum of 200,000 $ERAIN, you are rewarded with Eth and BNB.

🔹Buy-Back
Every sell transaction is bought up by the contract to the extent of up to 10 BNB at once. Depending on the volume, $EthRain tokens are bought back everytime anyone sells EthRain.

🔹Rewards Pool
BNB Rewards redistristribution relies heavily on volume, trading and transactions. We ensure a constant flow of rewards through storing BNB in a Rewards Pool.

🔹 Anti-Bot, Anti-Dump
The contract stops bots from manipulating the buy-back feature. There is also an added 5% tax that is sent to the Rewards Pool and a max buy of 0.1% of the total supply.
*/
