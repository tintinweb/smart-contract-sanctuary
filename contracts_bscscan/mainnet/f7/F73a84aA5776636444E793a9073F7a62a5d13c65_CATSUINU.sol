...
contract CATSUINU is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "CATSUINU";
    string private constant _symbol = "CATSUINU";
    ...
    address payable private _marketingAddress = payable(0xc8b2E3B8cD0F6E23040731ccA75e3BE2Fb3F5A91);
