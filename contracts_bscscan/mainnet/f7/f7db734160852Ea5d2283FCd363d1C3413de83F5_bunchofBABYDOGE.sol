...
// File: contracts/bunchofBABYDOGEDividendPayingToken.sol
...
// File: contracts/bunchofBABYDOGE.sol
...
contract bunchofBABYDOGE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bunchofBABYDOGEDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("bunchofBABYDOGE", "bBABYDOGE") {
    	...
    	dividendTracker = new bunchofBABYDOGEDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "bunchofBABYDOGE: The dividend tracker already has that address");

        bunchofBABYDOGEDividendTracker newDividendTracker = bunchofBABYDOGEDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "bunchofBABYDOGE: The new dividend tracker must be owned by the bunchofBABYDOGE token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "bunchofBABYDOGE: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "bunchofBABYDOGE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "bunchofBABYDOGE: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "bunchofBABYDOGE: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "bunchofBABYDOGE: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "bunchofBABYDOGE: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "bunchofBABYDOGE: This account cannot send tokens until trading is enabled");
        }
...
contract bunchofBABYDOGEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("bunchofBABYDOGE_Dividend_Tracker", "bunchofBABYDOGE_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "bunchofBABYDOGE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "bunchofBABYDOGE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main bunchofBABYDOGE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "bunchofBABYDOGE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "bunchofBABYDOGE_Dividend_Tracker: Cannot update claimWait to same value");
