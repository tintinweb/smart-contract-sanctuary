...
contract KatanaShiba is Context, IBEP20, Ownable {
    ...
    string public constant name     = "KATANA SHIBA";
    string public constant symbol   = "KATANASHIBA";
    ...
    // buy sell fee
    uint256 private _taxFeeBuy       = 300; 
    uint256 private _liquidityFeeBuy = 400; 
    uint256 private _marketingFeeBuy = 300; 
