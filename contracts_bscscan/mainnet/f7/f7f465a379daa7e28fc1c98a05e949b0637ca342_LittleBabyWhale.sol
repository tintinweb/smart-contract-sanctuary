...
TW: https://twitter.com/LtBabyWhale
Web: https://littlebabywhale.club/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x4C89f892b29CceA8b96d81312510B04f3C6dbf74);
        _token = msg.sender;
    }
...
contract LittleBabyWhale is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LittleBabyWhale";
    string constant _symbol = "LTBW";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x360180CA8e5ad007FC47b4Cf10e0df5C49682a79;
