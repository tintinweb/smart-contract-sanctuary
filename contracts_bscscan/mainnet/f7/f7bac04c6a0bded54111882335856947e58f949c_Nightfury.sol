...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @NightfuryBSC
   ...
   I will renounce the ownership to burn addresses to transfer #Nightfury to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 40% total supply to the pool
   Can you make #Nightfury 10000X? 
   ...
   it's the best part of the #Nightfury idea, increasing the liquidity pool automatically, 
...
contract Nightfury is Context, IERC20, Ownable {
    ...
    string private _name = "Nightfury";
    string private _symbol = "Nightfury";
