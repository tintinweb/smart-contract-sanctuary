...
contract AliCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x94B9803FeFeA78E3B0320f1D7Df8b0171dD86414); // Marketing Address
    ...
    string private _name = "AliCoin";
    string private _symbol = "AliCoin";
