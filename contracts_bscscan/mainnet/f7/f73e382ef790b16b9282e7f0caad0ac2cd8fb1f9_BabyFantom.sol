...
all you need to do is hold BabyFantom to automatically receive $FTM dividends in your wallet.
...
contract BabyFantom is Context, IERC20, Ownable {
    ...
    string private _name = "BabyFantom";
