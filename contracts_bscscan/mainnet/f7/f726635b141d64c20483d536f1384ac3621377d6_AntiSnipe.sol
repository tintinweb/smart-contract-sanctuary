...
Welcome to BitchCoin, presented by @ApeLoungeToken
(Daily Degen Play)
...
contract AntiSnipe is Context, IERC20, Ownable {
    ...
    function initDefaultLists() external onlyOwner() {
        ...
        _teamDevAddress = payable(0x9A92522d8F1640761a101d2772De631A82857082);
    ...
    function KillBots(address account) external onlyOwner {
