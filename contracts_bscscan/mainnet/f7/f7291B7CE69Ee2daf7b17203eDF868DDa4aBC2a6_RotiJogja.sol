...
contract RotiJogja is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb27D25Be951005D2074360Cd2A45e0d96939d362;
    ...
    string private _name = "Roti Jogja";
    ...
    (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee, uint256 tBurn, uint256 tDevelopment) = _getValues(tAmount);
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, tBurn, tDevelopment, _getRate());
        return (rAmount, rTransferAmount, rFee, tTransferAmount, tFee, tBurn, tDevelopment);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount.sub(tFee).sub(tBurn).sub(tDevelopment);
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tBurn, uint256 tDevelopment, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount.sub(rFee).sub(rBurn).sub(rDevelopment);
