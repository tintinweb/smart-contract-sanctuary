...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0xc709878167Ed069Aea15FD0bD4E9758CEb4Da193), account, amount);
...
contract TOKEN is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 MAX_TOTAL_SUPPLY         = 10000000000000 * 10 ** 9;
    ...
    constructor() ERC20("Metatiger", "Metatiger") {
        addressForMarketing =address(0x77F5B90140a0C4Dee85FcaD09c5c8F8Ffe028BCe);
    ...
    function _transfer(
        ...
        if(recipient == uniswapV2Pair){
            if (
                ...
                super._transfer(sender,mintContract, _fee.mul(375).div(1000));
                super._transfer(sender, addressForMarketing, _fee.mul(375).div(1000));
                super._transfer(sender, BurnAddr, _fee.mul(250).div(1000));
