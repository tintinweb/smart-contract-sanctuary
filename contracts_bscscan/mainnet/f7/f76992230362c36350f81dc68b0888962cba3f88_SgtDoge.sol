...
contract SgtDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x99dB7ee5A14BcD9928C8296db3cB85D216b54E6F); // Marketing Address
    ...
    string private _name = "SgtDoge";
    string private _symbol = "SgtDoge";
    ...
    uint256 public _sellLiquidityFee = 31;
