...
/**
😱Demons are real and 💀Ghosts are real too. They live inside us and sometimes they win. The haunted🧟 stories are all over the place from dark to dawn. Stare at the dark too long and you will eventually see what isn’t there. 

Friday 13 $FRI13 First ever the horror’s token. The FRI13 is the most haunted token on Blockchain. Will be a fair launch on Friday 13th 8PM UTC.

🪓Tokenomics🪓

🩸Max Supply : 13,000,000,000,000
🩸Initial LP : 13 BNB
🩸Tax Fee First Hour : 13%
🩸After 1 hour will be : 8%
Tax Fee will go to
🔪Holder : 4%
🔪Liquidity Pool : 2%
🔪Haunted Valley (Development Program): 2%

The incoming project about this token after launch. We will gather up people who believe in ghosts and like the horror stories and build up the community. After that we will launch the NFT platform for the ghost haunter who can capture the ghost in a photo and sell it on our market also the serial killer and horror arts using blockchain to support the entire platform.

Join our community

🪓Telegram : https://t.me/Friday13th_Token
⚰️Twitter : https://twitter.com/Friday13th_BSC
🪦Website : https://friday13th.world
Reddit : https://www.reddit.com/r/CryptoMoonShots/comments/p3qlgu/friday_13th_token_the_most_haunted_token_on_bsc/
...
contract FRI13 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xf7b8ffc1d468Da90E5E6d34b66Bc44Ca35eE5c4D); // Marketing Address
    ...
    uint256 private _tTotal = 13000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FRI13";
    string private _symbol = "$FRI13";
    ...
    uint256 private _sellTaxFee = 99;
