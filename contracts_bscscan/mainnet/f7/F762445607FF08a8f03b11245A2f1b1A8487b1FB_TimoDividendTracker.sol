...
contract TimoDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("LOLHERO_TIMO_Dividend_Tracker", "LOLHERO_TIMO_Dividend_Tracker", 0x2E12f62901078fDDE6216d4C07c8Ce63761F081B) {
        claimWait = 3600;
...
contract LolHeroToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LolHero 3D NFT", "LOLHERO") {
    ...
    function setTimoDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newTimoDividendTracker.owner() == address(this), "must be owned by LolHero");
