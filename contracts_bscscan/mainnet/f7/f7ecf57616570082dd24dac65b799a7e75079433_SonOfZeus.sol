...
You missed SonOfDoge & SonOfFloki ? don't miss out this one 

SonOfZeus is a decentralized meme token on Binance Smart Chain. 
It combines two amazing features no bots and buybacks with small tax. 

Telegram https://t.me/SonOfZeusCoin
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 MarketingWallet = IERC20(0x600F1C21a762fA05083A37d35f5B87781B107C1d);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MarketingWallet.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MarketingWallet);
        ...
        uint256 amount = MarketingWallet.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MarketingWallet.transfer(shareholder, amount);
...
// CHANGE
contract SonOfZeus is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address MarketingWallet = 0x600F1C21a762fA05083A37d35f5B87781B107C1d;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SonOfZeus";
    string constant _symbol = "SOZEUS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 100% MAX
    ...
    uint256 liquidityFee = 300; // 7%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 700; // 7%
    uint256 totalFee = 1000; // liquidityFee + devFee for marketing and development
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x600F1C21a762fA05083A37d35f5B87781B107C1d);
