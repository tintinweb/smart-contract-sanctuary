...
/* Token contract */
contract MysterySanta is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x8B4Bffbd69090Cbf779c09B68192071DBB64bBB3; // TB
    ...
    // Name and symbol
    string constant _name = "MysterySanta";
    string constant _symbol = "MSanta";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 50 / 10000;  // 3% max or 3M
    uint256 public _maxWalletToken = _totalSupply * 100 / 10000; // 4% or 4M tokens
