 ...
 *    Website In Process
 * 
 *    Telegram Group https://t.me/solxnft
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function _solxnft(address account, uint256 amount) internal virtual {
...
contract SOLXNFT is ERC200 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC200("SOLX NFT", "SOLXNFT") {
        _solxnft(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}