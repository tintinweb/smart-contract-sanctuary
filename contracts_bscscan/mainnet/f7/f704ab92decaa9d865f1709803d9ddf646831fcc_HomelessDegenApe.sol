...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xd6c28D3F143aA93781663B9ca3e84C9c7a3001f6;
        _token = msg.sender;
    }
...
contract HomelessDegenApe is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xac7b4fb7C87dfE87E86714b25312D1dA902fceDF;

    string constant _name = "HomelessDegenApe";
    string constant _symbol = "HDA";
    ...
    address IDEXPair = 0xd6c28D3F143aA93781663B9ca3e84C9c7a3001f6;
