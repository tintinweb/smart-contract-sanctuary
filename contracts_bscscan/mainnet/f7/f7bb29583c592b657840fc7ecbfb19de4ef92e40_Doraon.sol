...
contract Doraon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function setSellFeeIncreaseFactor(uint256 _sellFeeIncreaseFactor)
        public
        onlyOwner
    {
    ...
    constructor(address _ma) public ERC20("DORA", "DORA") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "DORAON The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "DORAON The new dividend tracker must be owned by the DORAON token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "DORAON The router already has that address"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "DORAON The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DORAON Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        ...
        onlyOwner
    {
        require(
            ...
            "DORAON The liquidity wallet is already this address"
        );
    ...
    function updateMarketingWallet(address newMarkting) public onlyOwner {
        require(
            newMarkting != _marketingWalletAddress,
            "DORAON The Markting wallet is already this address"
        );
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DORAON gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DORAON Cannot update gasForProcessing to same value"
        );
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    function _transfer(
        ...
        require(false, "DORAON_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(
            false,
            "DORAON_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DORAON contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "DORAON_Dividend_Tracker: Cannot update claimWait to same value"
        );
