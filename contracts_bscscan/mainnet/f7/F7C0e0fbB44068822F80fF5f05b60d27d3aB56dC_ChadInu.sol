...
contract ChadInu is ERC20Detailed, Ownable {
    ...
    uint256 public gonMaxWallet = TOTAL_GONS.div(1000).mul(5);
    ...
    constructor() ERC20Detailed("CHAD INU", "CINU   ", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0x63376F244E68bE5714473cc74b23173B7e9c4699;
        ecosystemFeeReceiver = 0x63376F244E68bE5714473cc74b23173B7e9c4699;
        buyBackFeeReceiver = 0xf85A7F5711c52eE6CBB0f43586F6776a2790bb89;
