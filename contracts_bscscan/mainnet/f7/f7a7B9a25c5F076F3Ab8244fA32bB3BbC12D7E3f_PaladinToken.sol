...
contract PaladinToken is BEP20, MinterRole {
    ...
    uint256 public minSwapAmount = 50000000;   // 0.05 BUSD
    // Trading bool
     ...
     */
    constructor(address _feeWallet) public BEP20("Paladins", "PAL") {
        operator = _msgSender();
    ...
    function swapTokensAndSend() public lockTheSwap {
    ...
    function approveToRouter(address _addr, uint256 _amount) public onlyOperator {
        _approve(V2ROUTER, _addr, _amount);
    }
}