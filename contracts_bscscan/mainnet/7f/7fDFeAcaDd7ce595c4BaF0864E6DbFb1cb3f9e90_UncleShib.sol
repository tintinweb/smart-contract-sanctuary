...
contract Ownable is Context {
    address private _owner = 0xeB0E64bb920758dB1565D38B63AFF34C0a4909c2;
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 6 days");
...
contract UncleShib is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xeB0E64bb920758dB1565D38B63AFF34C0a4909c2); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "UncleShib"; // token name
    string private _symbol = "UncleShib"; // token symbol
