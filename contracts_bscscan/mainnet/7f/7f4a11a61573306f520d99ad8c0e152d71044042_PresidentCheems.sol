...
Telegram : https://t.me/PresidentCheems
Website : TBA (presidentcheems.space)
...
contract PresidentCheems is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PresidentCheems";
