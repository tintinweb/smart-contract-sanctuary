...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        uint256 reamount = amount - burnamount;
        require(senderBalance >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            _balances[sender] = senderBalance - amount;
        }
        _balances[recipient] += reamount;
...
contract sFLOWKI is Owner,ERC20 {

    address private miner;
    uint256 public constant maxSupply = 1e9 * 1e18;

    constructor() ERC20("sFLOWKI Token", "sFOWKI") {
        _mint(0x4AA8a16732429fdB7aA408ed9A88763466499B2A, 5000 * 1e4 * 1e18);
    }
