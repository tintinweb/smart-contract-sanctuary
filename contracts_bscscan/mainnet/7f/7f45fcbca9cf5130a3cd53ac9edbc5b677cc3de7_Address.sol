...
contract ZaionMetaverse is Context, IERC20, Ownable {
    ...
    uint256 private _supply = 1000000 * 10**6 * 10**9;
    string private _name = "ZAION Metaverse";
    string private _symbol = "ZAIO";
