...
PandaBoba
[email protected] UTC 
TG:https://t.me/PandaBobaBsc
Web:https://www.pandaboba.net
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BNB = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract PandaBoba is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PandaBoba";
    string constant _symbol = "$Padabo";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x0D2ca6269e0A8Dd3D9c0497c719644a9AF2300aB);
    ...
    function setSellMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 300 && multiplier * totalFee <= 49000, "Multiplier too high");
