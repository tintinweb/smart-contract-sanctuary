...
contract MiniSlam is Context, IERC20, Ownable {
    ...
    string private _name = "MiniSlam";
    string private _symbol = "MiniSlam";
    ...
    address immutable marketingWallet = 0x4FAE372D679cc440e3731D066cD2C5f78c4Da5e1;
    ...
    function reflectionFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
        ...
        if (!deductTransferFee) {
            ...
            ( , uint256 tFee, uint256 tLiquidity, uint256 tMarketing,uint256 tBurn) = _getValues(tAmount);
            (,uint256 rTransferAmount, ) = _getRValues(tAmount, tFee, tLiquidity, tMarketing, tBurn, _getRate());
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        (  uint256 tTransferAmount, uint256 tFee, uint256 tLiquidity, uint256 tMarketing,uint256 tBurn) = _getValues(tAmount);
