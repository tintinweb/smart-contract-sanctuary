...
interface IBEP20Sniper is IERC11 {
 ...
 contract FlokiWorld is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Floki World";
    string private _symbol = "FWD";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0x2EcB8a1236d8fF74E6890D2F0001d52de8B309dD;
