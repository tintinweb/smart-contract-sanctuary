...
/*
BioFloki 
$BF mission is to help solve the largest problem facing the future of our species: pollution and deforestation!
...
contract BioFloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private _maxWalletLimit = 30000000000 * (10**18);

    uint256 public _feeMarkting = 7;
    uint256 public _feeTesla = 2;
    uint256 public _feeBuyback = 5;
    ...
    address public _marketingWalletAddress = 0x1DE93dDc23539f20e6d1879c6D990e02A842f96b;
    address public _teamWalletAddress = 0x1DE93dDc23539f20e6d1879c6D990e02A842f96b;
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function disableFeeBot() external onlyOwner{
        }

        function enableFeeBot() external onlyOwner{
        }

        function renounceOwnership() external onlyOwner{
        }

        function setFeeLP(uint256) public onlyOwner{
        }

        function setFeeMarketing(uint256) public onlyOwner{
        }

        function setFeeReward(uint256) public onlyOwner{
        }

        function setFeeBuyback(uint256) public onlyOwner{
        }

        function setCooldownBlocks(uint256) public onlyOwner{
        }
