...
contract Tiger01 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tiger01";
    string private _symbol = "Tiger01";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25F3e8756b92a9c6bE1a0C9D7bd83Db0704286E0); // Marketing Address
    address payable public teamWalletAddress = payable(0x5541F3812027b2DE252D89400C210Bc5d77aD54e); // Team Address
