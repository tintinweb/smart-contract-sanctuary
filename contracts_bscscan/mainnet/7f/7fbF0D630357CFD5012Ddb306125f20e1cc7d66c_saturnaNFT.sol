...
contract saturnaNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Holder, Ownable, ReentrancyGuard {
    ...
    constructor (address _v1NFT, address _sat, address _fee1, address _fee2) ERC721("Saturna NFT" , "SATURNA"){
        info.royalty = 100;
        info.adminFee1 = 255;
        info.adminFee2 = 45;
        ...
        info.minSatToCreate = 1000000000000000000;
    ...
    */
    ...
    function _processPayment(uint256 _id, address buyer, uint256 _amount) internal {
        ...
        if (item.currency == address(0)) {
            ...
            if(_commissionValue1 > 0) _safeTransferBNB(info.feeAddress1, _commissionValue1);
            if(_commissionValue2 > 0) _safeTransferBNB(info.feeAddress2, _commissionValue2);
