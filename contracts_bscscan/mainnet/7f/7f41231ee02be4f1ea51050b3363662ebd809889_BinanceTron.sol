...
/* Binance Tron -  A Tron-backed assets for a stable currency on Binance Smart Chain Network
website: https://binancetron.online/
...
contract BinanceTron is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA6BEA506EA4A770fBE1c1B4775d1A82C0b829A8f); // Marketing Address
    address payable public charityAddress = payable(0xA6BEA506EA4A770fBE1c1B4775d1A82C0b829A8f); // Charity/Dev Address
    ...
    string private _name = "BinanceTron";
