...
contract Testtoken is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = 1500 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 1500 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xFAE0e741fbAec08CB87883D9841e667c4dA9415D;
        marketingWallet = 0x78aaC1A388124907e1A41AE7Ea355E8385b1709C;
        devWallet = 0x2F57cc51E3BD27139d4a515e6C8d19F8de2E96DB;
