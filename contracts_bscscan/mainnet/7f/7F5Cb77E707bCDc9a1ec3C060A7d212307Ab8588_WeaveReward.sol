...
// File contracts/WeaveReward.sol
pragma solidity =0.8.9;




contract WeaveReward is Ownable, ReentrancyGuard, Pausable {
    ...
    function getReward() external nonReentrant updateReward(msg.sender) {
        require(block.timestamp >= periodFinish, "Reward locked");
    ...
    // Recover ERC20 tokens which were sent incorrectly
