...
contract LuniPup is Context, IERC20, Ownable {
    ...
    string private _name = "LuniPup";
    string private _symbol = "LUNIPUP";
    ...
    uint256 public maxBuyTranscationAmount = 500000 * 10**18;
    uint256 public maxSellTransactionAmount = 100000 * 10**18;
    uint256 public _maxWalletToken = 500000 * 10**18;
    uint256 private minimumTokensBeforeSwap = 73196 * 10**18; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferLiquidETH(_liquidAddress, address(this).balance);
    }
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private _liquidAddress;
