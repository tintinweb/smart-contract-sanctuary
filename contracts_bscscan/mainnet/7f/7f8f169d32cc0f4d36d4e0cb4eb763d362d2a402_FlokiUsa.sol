 ...
 * - 3 day Liquidity Lock (will send and pin mudra link in the TG)
 ...
 TG: https://t.me/flokiusa
 
 Hold FLOKIUSA and get $FLOKI automatically in your wallet every hour!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ETH = IERC20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4);
...
// CHANGE
contract FlokiUsa is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiUsa";
    string constant _symbol = "FlokiUSA";
    ...
    uint256 liquidityFee = 400; // 5%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 500; // 8%
    uint256 marketingFee = 700; // 4%
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x36984602e2aBdAc3958783a63870E28534B71e7C);
