...
10% BNB reflection, 5% liquidity

Max wallet size of 1,500,000,000

Max transaction of 300,000,000 Set slippage to 15%
...
✅ Telegram community: https://t.me/islnd_tkn 🧉
...
contract MOONISLAND is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public BurnAddress = payable(0x000000000000000000000000000000000000dEaD); // Continues Supply Burn Address
    ...
    uint256 private _tTotal = 100000000000 * 10**18; // Total Supply 100 Million
	...
	bool public BlacklistBot = true;
	bool public PreApprovedBlacklist = true;
    ...
    function setBurnFee(uint256 Burn) external onlyOwner() {
        BurnFee = Burn;
    }
    ...
    function EnabledBlacklistBot() external onlyOwner {
