...
/**
 ...
 Max Wallet Size = 45,000,000
 Max Transaction Size = 35,000,000 

 Reflection/Taxes: 5% in Marketing, 3% in Liquidity
 
 Buy Slippage: 21-23% 

 *** THE MAX A WALLET CAN HAVE IS 45,000,000! THAT IS 4.5%! ***
...
contract HAMSTERINU is IERC20, Ownable {
    ...
    string constant _name = "HAMSTER INU";
    string constant _symbol = "HAMINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 45) / 1000; // 4.5% MAX 45,000,000
    uint256 public _maxWalletSize = (_totalSupply * 85) / 1000; // 8.5% MAX 85,000,000
    ...
    uint256 marketingFee = 800; // 5%
    uint256 totalFee = 1100; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x85999Eae9aA524911972989e03f700a161462998);
