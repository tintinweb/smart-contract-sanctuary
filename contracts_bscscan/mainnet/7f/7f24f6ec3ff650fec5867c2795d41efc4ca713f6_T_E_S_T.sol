...
contract T_E_S_T is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _infinityFee = 3;
        _burnFee = 3;
        _totalFees = _liquidityFee.add(_marketingFee).add(_infinityFee).add(_burnFee);
    ...
    function collectFees() private lockTheSwap {
        ...
        // Get Infinity Burn Fees
        swapAndSendToInfinity(infinityTokensToSell); 
    }
    ...
    function swapAndSendToInfinity(uint256 tokens) private  {

        swapTokensForInfinity(tokens);
    ...
    function swapTokensForInfinity(uint256 tokenAmount) private {
