...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x85421FE058712a1eC48D41aAD5836d1b25543aEB;
...
contract CiornyDelfin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x89EBF60a1DE474E279db8bdA8b9E5aE4634489F6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CiornyDelfin";
    string private _symbol = "DLF";
