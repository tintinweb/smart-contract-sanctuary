...
contract Mini_Doge_Cricket is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x991bA16946616Ce36eb65263F248cc90a0D79754;
    ...
    string private _name = "MiniDoge Cricket";
    ...
    uint256 public _maxTxAmount = 650 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 80000 * 10**5 * 10**18;
