...
Satoshi Nakamoto is the name used by the presumed pseudonymous person or persons who developed bitcoin, authored the bitcoin white paper,
and created and deployed bitcoin’s original reference implementation. 
As part of the story, Nakamoto has a ninja cat to fight against bad doggys . 
All the same, KottoCat is the Next Level Cryptocurrency in the Metaverse.

TG: https://t.me/kottocat

WEB: https://kottocat.online/
...
contract KottoCat is IERC20, Ownable {
