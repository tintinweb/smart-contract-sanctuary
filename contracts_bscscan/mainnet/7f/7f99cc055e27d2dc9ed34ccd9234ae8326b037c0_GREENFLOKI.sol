...
contract GREENFLOKI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6ca163B0E66e2Acdd574D2735D56aC9d0C04f598); // Marketing Address
    ...
    uint256 public _maxTxAmount = 77000000 * 10**6 * 10**9;
