 ...
 * 
 *
 * TG: https://t.me/LolakiInu
 * 
 * 
 * Lolaki Inu token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract LolakiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Lolaki Inu";
    string constant _symbol = "LLK";
