...
/**
*
*    Telegram: https://t.me/CheemsCakeOfficial
*    Website: https://cheemscake.io/
*/
...
contract CheemsCake is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x670d636B8962644690B0a6190Ea874A86c6e5352;
    address public devWallet = 0xB60161386EAAe949720A50f658206d3488aA5CD0;
    address public operationWallet = 0x3568650c3A4f148D8902550dd3Ee829dD7D42f8E;
    address public charityWallet = 0x5cd537F1608D299d752B58500acb4f9042E8B13C;

    string private constant _name = "CheemsCake";
    ...
    Taxes public taxes = Taxes(1, 7, 4, 0, 0, 0);
    Taxes public sellTaxes = Taxes(1, 7, 4, 0, 0, 0);
