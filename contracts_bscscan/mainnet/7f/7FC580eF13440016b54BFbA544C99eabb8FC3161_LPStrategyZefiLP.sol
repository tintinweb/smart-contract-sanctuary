...
// File: contracts/ZEFI/interfaces/common/IUniswapV2Pair.sol
...
// File: contracts/ZEFI/utils/IGasPrice.sol
...
// File: contracts/ZEFI/utils/GasThrottler.sol
...
// File: contracts/ZEFI/strategies/Common/StratManager.sol
...
// File: contracts/ZEFI/strategies/Common/FeeManager.sol
...
abstract contract FeeManager is StratManager {
    ...
    // uint constant public TREASURY_FEE   = 1000; // ZEFI
    uint constant public TREASURY_FEE   = 500; // OTHER
    
    uint constant public MAX_FEE = 1000;
    uint constant public MAX_CALL_FEE = 111;

    uint constant public WITHDRAWAL_FEE = 10; // 0,1% OTHER
    // uint constant public WITHDRAWAL_FEE = 0; // 0% ZEFI
...
// File: contracts/ZEFI/strategies/degens/LPStrategyZefiLP.sol
...
contract LPStrategyZefiLP is StratManager, FeeManager, GasThrottler {
    ...
    address constant public output      = address(0x40B34cC972908060D6d527276e17c105d224559d); // TOKEN DA FARM - SEED
    address constant public masterchef  = address(0xA9a438B8b2E41B3bf322DBA139aF9490DC226953); // MASTERCHEF
    
    address constant public zefi        = address(0x0288D3E353fE2299F11eA2c2e1696b4A648eCC07); // buyback ZEFI    
    ...
    address[] public wbnbToBifiRoute = [wbnb, zefi];
    ...
    function chargeFees() internal {
        ...
        uint256 toWbnb = IERC20(output).balanceOf(address(this)).mul(porcFee).div(1000);
        IUniswapRouter(unirouter).swapExactTokensForTokens(toWbnb, 0, outputToWbnbRoute, strategist, now);

        // uint256 wbnbBal = IERC20(wbnb).balanceOf(address(this));
        // IERC20(wbnb).safeTransfer(strategist, wbnbBal);

        // uint256 treasuryHalf = wbnbBal.mul(TREASURY_FEE).div(MAX_FEE);
        // IUniswapRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToBifiRoute, dead, now.add(600));  // 11,2        
