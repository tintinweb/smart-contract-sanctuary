...
/* SkypeToken -  Revolution of money system. Biggest BNB reward meme token on the Binance Smart Chain
...
contract SkypeToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xACb20d975a52F412Aa04D11f6e029C01603a279c); // Marketing Address
    address payable public charityAddress = payable(0xACb20d975a52F412Aa04D11f6e029C01603a279c); // Charity/Dev Address
    ...
    string private _name = "Skype Token";
    string private _symbol = "SKYPE";
