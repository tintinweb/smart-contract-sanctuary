...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @FlokiIceBSC
   ...
   Can you make #PolarFloki 10000X? 
...
contract FlokiIce is Context, IERC20, Ownable {
    ...
    string private _name = "Floki Ice";
