...
/**
   ...
   Welcome to MiniFootballInu
   
   This is a community token. If you want to create a telegram I suggest to name it to @MiniFootballInuBSC
   ...
   I will renounce the ownership to burn addresses to transfer #MiniFootballInu to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #MiniFootballInu 10000X? 
   ...
   it's the best part of the #MiniFootballInu idea, increasing the liquidity pool automatically, 
...
contract MiniFootballInu is Context, IERC20, Ownable {
    ...
    string private _name = "Mini Football Inu";
