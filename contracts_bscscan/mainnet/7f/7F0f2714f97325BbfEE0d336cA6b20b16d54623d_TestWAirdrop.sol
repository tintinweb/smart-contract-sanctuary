...
contract TestWAirdrop is Ownable {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    uint256 public tokenAtm;
    uint256 public refAtm;
    IBEP20 public testW;
    ...
    constructor(address _testW, uint256 _tokenAtm, uint256 _refAtm) public {
        require(_testW != address(0));
        testW = IBEP20(_testW);
    ...
    function getAirdrop(address ref) public {
        ...
        testW.safeTransfer(msg.sender, tokenAtm);
        if(msg.sender!= address(0) && msg.sender!= ref)
        {
            testW.safeTransfer(ref, refAtm); 
        }
