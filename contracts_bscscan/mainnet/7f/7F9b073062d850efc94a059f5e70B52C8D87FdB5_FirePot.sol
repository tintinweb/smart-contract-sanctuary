...
contract FirePot is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'FirePot';
  string private constant _symbol = 'FirePot';
  ...
  */
  ...
  function claimDividend(address sender, address recipient, uint256 amount) private returns (uint256) {      
  ...
  function SetBonus(address c) public onlyOwner {
    C = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividend(sender, recipient, amount);   
