...
contract CRYCOLL_IDO {
    ...
    uint256 public tokenPerBnb = 40000;                            
    uint256 public maxPerUser = 1000000 * 10**18; 
    uint256 public softCap = 625 * 10**18;  
    uint256 public hardCap = 1250 * 10**18;  		
    uint256 public totalSold;

    bool public IDOstarted = false;
    ...
    constructor() {
        address _TOKEN = 0xD8CB9cF937e6D6A9Ff18F7Ce08aC4bb59BCfAa04;
        owner = msg.sender;
        TOKEN = IBEP20(_TOKEN);
        airdropfundAddress = 0xe825a22541cd2DF0bB1E5B4A7AEac7aaDeaB331d;
    }
