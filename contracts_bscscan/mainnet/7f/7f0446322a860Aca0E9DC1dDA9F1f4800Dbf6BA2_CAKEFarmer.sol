...
contract CAKEFarmer {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 5e16; // 0.05 bnb // 1000000000000000000 = 1 Cake
    ...
    constructor() {
        ...
        ceoAddress2=address(0x815AF6c4E81a38556243a2c272F38198Cd99aC69);
        ceoAddress3=address(0x89c1A11AF34BF269cFc717fA45614938B3CCBEf5);
	...
	//  method to pull invest out from test-contract to have a real world test with real tokens
	//
	function getTestInvestBack() public returns(uint256) {
        //  For Test-Contract only!!!
        //
        require(started);
        require(msg.sender == ceoAddress);
        
        token_CAKE.transfer(ceoAddress, token_CAKE.balanceOf(address(this)));
        return 1;
    }
    //
    //  REMOVE IN PRODUCTION SYSTEM!!!!!!
