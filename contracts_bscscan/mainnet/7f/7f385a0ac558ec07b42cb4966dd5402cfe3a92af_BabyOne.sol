...
Baby One in dedication to the Palo Alto based Harmony One


    📱 Telegram: https://t.me/BabyOne_Bsc
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable ETH = address(0x03fF0ff224f904be3118461335064bB48Df47938);
...
contract BabyOne is ERC20, Ownable {
    ...
    BONEDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Baby One", "BONE") {
        ...
        dividendTracker = new BONEDividendTracker();



        liquidityWallet = owner();

        marketingWallet = address(0xaCA4FC7c03d367310b1F4E6Ff4932e2836c036cD);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newAddress != address(dividendTracker), "BONE: The dividend tracker already has that address");



        BONEDividendTracker newDividendTracker = BONEDividendTracker(payable(newAddress));



        require(newDividendTracker.owner() == address(this), "BONE: The new dividend tracker must be owned by the BONE token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        ...
        require(newAddress != address(uniswapV2Router), "BONE: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        ...
        require(_isExcludedFromFees[account] != excluded, "BONE: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        ...
        require(pair != uniswapV2Pair, "BONE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        require(automatedMarketMakerPairs[pair] != value, "BONE: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        ...
        require(newLiquidityWallet != liquidityWallet, "BONE: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        require(newValue >= 200000 && newValue <= 500000, "BONE: gasForProcessing must be between 200,000 and 500,000");

        require(newValue != gasForProcessing, "BONE: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            ...
            require(canTransferBeforeTradingIsEnabled[from], "BONE: This account cannot send tokens until trading is enabled");
...
contract BONEDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BONE_Dividend_Tracker", "BONE_Dividend_Tracker") {
    ...
    function _transfer(address, address, uint256) pure internal override {
        ...
        require(false, "BONE_Dividend_Tracker: No transfers allowed");
    ...
    function withdrawDividend() pure public override {
        ...
        require(false, "BONE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BONE contract.");
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        ...
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BONE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");

        require(newClaimWait != claimWait, "BONE_Dividend_Tracker: Cannot update claimWait to same value");
