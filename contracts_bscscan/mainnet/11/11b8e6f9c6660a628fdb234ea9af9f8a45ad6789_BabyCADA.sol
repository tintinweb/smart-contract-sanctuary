...
//Contract built by Team - Providing Safe and Legit contracts. Always safe from the dev side of things. 

/**
   
BabyCADA Token
Community Token
Rewards Cardano (ADA) for Holding - 14%
 1% Buy Back | 1% Marketing | 4% LP
 
 TG: https://t.me/BabyCADA
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
contract BabyCADA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyCADA";
    string constant _symbol = "BabyCADA";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;

    uint256 _totalSupply = 10000000 * 10**5 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 50 / 200;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x5aFaF8c83A5B2C537749685B56CFCfacfA2539D5;
