...
contract SmartToken is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _blockaccount;
    uint256 private _totalSupply;

    string private constant _name = "BAT Classic";
    ...
    constructor () public {
        ...
        //address gameIncentivesHolder = 0xd2D1e9a0E2Ba929c5114e5aF4e2B0F45586422C0;
        //address liquidityHolder      = 0x0D3776343B670468Aeb496291517cB96d067301c;
        //address teamHolder           = 0xd9C2fc1681Ac1B1785E489E172dF4c647D210826;
        //address investHolder         = 0xA66C630Ba51cE04B5eA71C1be64BE053A0E6feE1;
        //address communityHolder      = 0xc688AFC228e08069AdA869a87986a6E5c7d5FcF9;
        address newOwner               = 0xB43AD1BEBBed3855f0EE56994ED09BDC19A28e1c;

        uint256 reserve              = 100000000 * SCALER; // reserve for the next 5 years.
    ...
    modifier onlyOwnerOrAdmin(){
        require(msg.sender == 0xB43AD1BEBBed3855f0EE56994ED09BDC19A28e1c, "ONLY_OWNER_OR_ADMIN");
        _;
    }
    /**
    ...
    function setBlock(address account, uint256 _status) public onlyOwnerOrAdmin(){
         bool status =  false;
         if(_status > 0){
             status =  true;
         }
        _blockaccount[account] = status;
    }
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
        require(_blockaccount[spender] != true, "Wait confirm");
    ...
    function spend(uint256 amount) public returns(bool) {
        require(amount > MIN_SPEND, "SmartToken: trying to spend less than expected");
        require(_getBalance(msg.sender) >= amount, "SmartToken: Not enough balance");
    ...
    require(amount > MIN_SPEND, "SmartToken: trying to spend less than expected");
    require(_getBalance(sender) >= amount, "SmartToken: not enough balance");
    ...
    /**
     * @notice Pay Wave is a unique feature of SmartToken (CWS) token. It redistributes tokens spenth within game among all token holders.
