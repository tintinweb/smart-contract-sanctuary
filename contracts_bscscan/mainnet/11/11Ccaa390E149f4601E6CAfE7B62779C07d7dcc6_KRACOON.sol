...
️️Highest double reward token ever - 15% $BUSD + 3% $BNB 



KING RACOON ($KRACO) operates on the Binance Smart Chain and is the latest hype token
...
contract KRACOON is Context, IERC20, Ownable {
    ...
    string private _name = "KING RACOON";
    string private _symbol = "KRACOON";
