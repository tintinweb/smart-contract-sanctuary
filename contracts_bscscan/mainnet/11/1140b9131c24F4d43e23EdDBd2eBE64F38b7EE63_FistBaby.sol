...
contract FistBaby is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7374Ba519087531bF844DB63857B1c095AFEACAA); // Marketing Address
    ...
    string private _name = "FistBaby";
    string private _symbol = "FistBaby";
