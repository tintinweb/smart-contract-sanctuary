...
/**
* Mini Daddy Doge is a deflationary token based on the Binance Smart Chain network,  
  whose purpose is to let $MDADDY holders gain BNB rewards on every transaction. 
  Mini Daddy Doge Finance gathers frictionless BNB yield, regular draws and buybacks, 
  NFT capabilities and is focused on creating a safe and secure Launchpad platform for DeFi projects.

  Telegram: https://t.me/minidaddy
  
  Transaction Tax 13%
    
   1% Holders Reflection Fee
   7% BNB Redistribution fee
   2% Mini Daddy Doge Stash
...
contract MiniDaddyDoge is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Mini Daddy Doge";
    string private _symbol = "MDADDY";
    ...
    function claimBNBReward() public isHuman nonReentrant {
        ...
        require(balanceOf(msg.sender) >= 0, "Error: must own MDADDY to claim reward");
