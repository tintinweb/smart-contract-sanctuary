...
/**
   ...
   5% fee auto add to the liquidity pool to locked forever when trading
   2% fee auto distribute to all holders
   4% fee auto moved to project/marketing wallet
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xfcCFD0Cd2540766a33Bebee27De1bFE36D116E0B;
...
contract Glad is Context, IERC20, Ownable {
    ...
    string private _name = "Gladiator GameFi";
    string private _symbol = "GLAD";
    ...
    uint256 public maxSellAmount = _tTotal.mul(5).div(10000);
