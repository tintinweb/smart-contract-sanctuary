...
contract Senseita_Boobs is IBEP20, Auth {
    ...
    uint256 FeeDenominatorWalletTx = 1000;
    uint256 public _maxTxAmount = (_totalSupply * 1500) / FeeDenominatorWalletTx; 
    uint256 public _maxWalletSize = (_totalSupply * 750) / FeeDenominatorWalletTx;
    ...
    address private marketingFeeReceiver = 0xDA5E0C003b2FD3659bC5D304A79AA8a2FE06c828;
    address private buybackFeeReceiver = 0xDA5E0C003b2FD3659bC5D304A79AA8a2FE06c828;
    address private DevFeeReceiver =0xDA5E0C003b2FD3659bC5D304A79AA8a2FE06c828;
    ...
    function setTxLimit(uint256 amount, uint256 _FeeDenominatorWalletTx) external authorized {
        require(amount >= _totalSupply / 1000);
        _maxTxAmount = amount;
        FeeDenominatorWalletTx = _FeeDenominatorWalletTx;
    }

   function setMaxWallet(uint256 amount, uint256 _FeeDenominatorWalletTx) external onlyOwner() {
        require(amount >= _totalSupply / 1000);
