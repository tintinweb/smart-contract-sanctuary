...
//First coin I made, tribute to AC/DC, make it moon, dust it, rip it, whatever, this is a community token. 
// At stable 10K mcap will create a TG for the token
// At stable 20k mcap will start marketing
// At stable 30k mcap will create a website
// If by some miracle this will reach stable 100k mcap, I will actually start thinking about Utility, already have something in mind, tribute to AC/DC 
//LET THERE BE ROCK!
//////////////////////////////////////////////////////////////////////////////////
//                                          ________                      ////////
//      /\            / \                   \        \         / \        ////////
...
contract ACDC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x260a05Bb629D8F77eDe0E4c4248cf6c75feb5268;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 8000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AC/DC";
    string private _symbol = "Thunderstruck";
