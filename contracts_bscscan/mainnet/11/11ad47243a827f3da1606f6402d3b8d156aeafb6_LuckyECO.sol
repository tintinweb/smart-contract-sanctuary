...
contract LuckyECO is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "LuckyECO";
    string constant _symbol = "ECO";
    ...
    uint256 public _maxTxAmount = 50000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 50000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x4fdeA3eF15a25BdDD07bdCE07bd9ccF010f05F03;
        devWallet = 0xaAA2D0094860a985644c92D73E15100D9054BC5c;
