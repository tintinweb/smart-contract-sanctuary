...
contract SHIBMEKIINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBMEKI INU";
    string constant _symbol = "$SHIBMEKI";
    uint8 constant _decimals = 4;
    uint256 _totalSupply = 100 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.div(100).mul(2);
    uint256 public _maxWalletToken = _totalSupply.div(100).mul(2);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _sellFee, uint256 _feeDenominator) external authorized {
