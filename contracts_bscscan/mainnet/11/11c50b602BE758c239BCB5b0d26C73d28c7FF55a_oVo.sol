...
contract oVo is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 500_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5_000_000 * 10**9; //
    string private constant _name = "oVo Network"; // 
    string private constant _symbol = "oVo"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xeC3d99b7903533365cC627BF393762b7E4aFBf7e;
