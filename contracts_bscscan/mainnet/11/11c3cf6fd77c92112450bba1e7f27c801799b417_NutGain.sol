...
contract NutGain is NUTGDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NUTGTeam;
    address private CharityNUTG;
    ...
    string public override name = "NutGain";
    string public override symbol = "NUTG";
    ...
    constructor(uint totalSupplyValue, address NUTGTeamAddress, address CharityNUTGAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NUTGTeam = NUTGTeamAddress;
        CharityNUTG = CharityNUTGAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NUTGTeam] =  totalSupply * 45 / 100;
        balances[CharityNUTG] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's NUTGTeam pot
