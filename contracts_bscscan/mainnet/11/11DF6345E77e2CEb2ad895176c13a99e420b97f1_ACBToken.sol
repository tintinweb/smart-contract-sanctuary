...
contract ACBToken is ERC20PresetMinterPauser, ERC20Capped, Ownable {
    constructor()
        public
        ERC20PresetMinterPauser("Apes Casino Banana Token", "ACB") ERC20Capped(5000000000 * (10**uint256(18)))
    {
    }

    function _mint(address account, uint256 amount) internal virtual override(ERC20, ERC20Capped) onlyOwner {
        super._mint(account, amount);
    }
