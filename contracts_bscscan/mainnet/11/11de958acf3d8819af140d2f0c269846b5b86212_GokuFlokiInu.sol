...
/*
🐶 Goku Floki Inu 👊 is the latest Anime & Floki Inu based Token released on the BSC Network. We decided to go with Goku Floki Inu because its definitely Anime + Floki season, so its kind of a nobrainer what will happen. Its purpose is to overperform all other existing cyrptocurrencies with the help of Elon Musk and the awesome community we about to build. Goku Floki Inu wants to give the community a platform where everyone can decide about the future of the token. It is completely community driven and can only grow with the help of the holders 💥

✅ Liquidity locked
✅ Buybacks from the marketing wallet
✅ Giveaways & Contests
✅ Experienced devs (1x 2million Mcap project)
✅ 4% rewards for holding
...
📲 Join our TG: https://t.me/gokuflokiinu
*/
...
contract GokuFlokiInu is ERC20, Ownable {
    ...
    constructor() ERC20("Goku Floki Inu", "GFINU")  {
