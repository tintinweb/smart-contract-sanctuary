...
contract CorgiArticleFactory is Ownable {
    ...
    // Number of CORISs a user needs to pay to acquire a token
    ...
    function mintNFT(uint8 _bunnyId) external {
        ...
        // Send CORIS tokens to this contract
    ...
    /**
     * @dev It transfers the CORIS tokens back to the chef address.
     ...
     * Only callable by the owner.
     */
    function claimTokenFee(address _token, uint256 _amount) external onlyOwner {
