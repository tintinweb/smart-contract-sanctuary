...
contract AppleBite is Context, IERC20, Ownable {
    ...
    string private _name = "AppleBite";
    string private _symbol = "$ABITE";
    ...
    address public charityWallet = 0xef6Ea72D8efC17B6dc2dE8bA6fE8Af7D27da46C7;
    ...
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**2 * 10**9;
