...
contract GuOracleWrapper is Owned {
    ...
    UniswapPairOracle private priceFeedGuUSDT;
    UniswapPairOracle private priceFeedWBNBUSDT;
    ...
    constructor (
        ...
        address _gu_usdt_oracle,
        address _wbnb_usdt_oracle,
        address _gu
        ...
        // Gu/USDT
        priceFeedGuUSDT = UniswapPairOracle(_gu_usdt_oracle);

        // WBNB/USDT
        priceFeedWBNBUSDT = UniswapPairOracle(_wbnb_usdt_oracle);
    }
    ...
    function consult(address token, uint amountIn) external view returns (uint amountOut) {
        ...
        return priceFeedWBNBUSDT.consult(wbnb, 1e18).mul(PRICE_PRECISION).div(priceFeedGuUSDT.consult(gu, 1e18));
    }

    /* ========== RESTRICTED FUNCTIONS ========== */

    function setGuUSDTOracle(address gu_usdt_oracle) external onlyByOwnGov {
        priceFeedGuUSDT = UniswapPairOracle(gu_usdt_oracle);
    }

    function setWBNBUSDTOracle(address wbnb_usdt_oracle) external onlyByOwnGov {
        priceFeedWBNBUSDT = UniswapPairOracle(wbnb_usdt_oracle);
    }
}
