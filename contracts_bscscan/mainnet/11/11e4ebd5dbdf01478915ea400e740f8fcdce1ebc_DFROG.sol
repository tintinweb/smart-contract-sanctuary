...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x947950BcC74888a40Ffa2593C5798F11Fc9124C4); 
...
contract DFROG is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x947950BcC74888a40Ffa2593C5798F11Fc9124C4; // USDC
    address public WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DANIELE FROG";
    string constant _symbol = "DFROG";
    ...
    address public marketingFeeReceiver=0x36cc2CB26A93a2e2561Da657bf94a8b4C39622A6;
