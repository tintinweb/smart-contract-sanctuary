...
Twitter: twitter.com/Hi5Token   
Telegram: t.me/Hi5Token                                                                                             
...
contract Hi5Token is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x560FfA5a58361f8a421676Ef230Ce66EFD0DBBc6);

    address payable private _marketingAddress = payable(0x560FfA5a58361f8a421676Ef230Ce66EFD0DBBc6);

    

    string private constant _name = "HIFIVE";

    string private constant _symbol = "HIF";
