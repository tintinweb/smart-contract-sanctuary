...
contract LB is Context, IERC20, Ownable {
    ...
    string private _name = "Lucky Baby Token";
    ...
    address public charityWallet = 0x84Cb6d5eE67b490A5B3c67c525D3662554c4372f;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x84Cb6d5eE67b490A5B3c67c525D3662554c4372f);  // PCS V2
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x84Cb6d5eE67b490A5B3c67c525D3662554c4372f, 'We can not exclude Pancake router.');
    ...
    function setLBCharityWallet(address newWallet) external onlyOwner() {
