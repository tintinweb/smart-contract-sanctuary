...
contract CrazyFLOKI is Context, IERC20, Ownable {
    ...
    string private _name = "CrazyFloki TOKEN";
    string private _symbol = "CrazyFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2c10622063CcE77a3C44ABeb97B8C2761D901Fb2); // Marketing Address
    address payable public teamWalletAddress = payable(0x1b4239b6330808CbaFc9a21ee8dB95EC7dF0AeaA); // Team Address
