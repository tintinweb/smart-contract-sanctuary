...
// CHANGE
contract DemonDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DemonDoge";
    string constant _symbol = "DemonDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1); //
    uint256 public _maxWalletSize = (_totalSupply * 2) / 40; // 5% MAX 50,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xeb754B8bdc0E6D91937065C71644897677Bb4BD4);
