...
contract JesusDoge is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA87DaDd703e0cFd76E00233683E8bAa4ff573299); // Marketing Address
    address payable public charityAddress = payable(0xA87DaDd703e0cFd76E00233683E8bAa4ff573299); // Charity/Dev Address
    ...
    string private _name = "Jesus Doge Swap"; // nice
    string private _symbol = "JDS";
