...
contract xBNBL is IBEP20, Auth {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "xBNBL::delegateBySig: invalid signature");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "xBNBL::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "xBNBL::_writeCheckpoint: block number exceeds 32 bits");
    ...
    string constant _name = "xBNBL";
    string constant _symbol = "xBNBL";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 2100000 * (10 ** _decimals);
