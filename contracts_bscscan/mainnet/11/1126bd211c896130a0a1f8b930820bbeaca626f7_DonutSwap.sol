...
/* DonutSwap -  DonutSwap will be the leading decentralized exchange on Binance Smart Chain, with the highest trading volumes in the market.
...
contract DonutSwap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5b815B2EC5Fc20e6821616b548C2F9C5d07D2C1c); // Marketing Address
    address payable public charityAddress = payable(0x5b815B2EC5Fc20e6821616b548C2F9C5d07D2C1c); // Charity/Dev Address
    ...
    string private _name = "DonutSwap";
