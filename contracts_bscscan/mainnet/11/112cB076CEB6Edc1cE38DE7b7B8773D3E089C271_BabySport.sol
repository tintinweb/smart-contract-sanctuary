 ...
 * 
 * 
 * Token brought by the Ignitionpad Team Providing Safe contracts for the community to take into space!
 * 
 * https://t.me/BabySport |  
 * 
 * TOKENOMICS:
 * 
 *
 * 3% to liquidity to keep the token price growing with every txn!
 * 4% to marketing so we can help to make it go BOOM! and do BNB AIRDROPS!
 * 
 * 
 * 
 * 
...
contract BabySport is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabySport";
    string constant _symbol = "BSport";
