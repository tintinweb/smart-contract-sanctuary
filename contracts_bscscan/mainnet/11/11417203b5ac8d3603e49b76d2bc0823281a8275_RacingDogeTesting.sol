...
/*
    #RacingDoge Contract :
        2% Liquidity
        2% Devolopment Wallet
        2% Marketing Wallet
        
        Telegram : https://t.me/RacingDoge
        Website : https://racingdoge.app/
        Twitter : https://twitter.com/RacingDoge
        Channel : https://t.me/RacingDogeOfficial
...
contract RacingDogeTesting is Context, IBEP20, Ownable {
    ...
    string private _name = "RacingDogeTesing";
    string private _symbol = "RDOGETESTING";
    ...
    function _takeMarketingNDevFee(uint256 tMarketingNDevFee) private {
        if(tMarketingNDevFee > 0){ // Fee is zero when transferring from excluded wallet
            ...
            _rOwned[address(this)] = _rOwned[address(this)].add(tDev.mul(currentRate));
            if(_isExcluded[address(this)])
