...
contract ShibaBonk is IERC20, Ownable {
    ...
    string constant _name = "Shiba Bonk";
    string constant _symbol = "ShibaBonk";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 7/2) / 100; // 3.5% MAX 35,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x2D45468A903F2f9EC01280F8f82b1EdCea42b7a7);
