...
contract fluffydoge1 is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x7e3bf5262600320A93eA6554cb76BEbfCd4dBCcB;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Fluffy Doge Coin";
    string private _symbol = "FluffyDoge";
