...
contract CMBSC is Context, IERC20, Ownable {
    ...
    string private _name = "Crypto Magic BSC";
    ...
    uint256 private minimumTokensBeforeSwap = 10000 * 10**5 * 10**9; 
    
    address payable public charityAddress = 0x58954a594d9A206e01F424fE7efDBA501dee3284; 
