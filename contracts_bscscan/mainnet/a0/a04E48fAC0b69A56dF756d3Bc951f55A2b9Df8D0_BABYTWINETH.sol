...
// Contract built for rewards, 12% BUSD,2% marketing,2% buy back and 2%LP //
// Time to spread your baby batter all over BSC //
// TG: https://t.me/BabyBatterBSC//
// website: http://babybatterbsc.club//
...
contract BABYTWINETH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABYTWINETH";
    string constant _symbol = "BabytwinETH";
    ...
    uint256 public swapThreshold = _totalSupply / 400; // 10%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xf35BE5892ce02154731E704c07D6EEb12A02E5cE;
