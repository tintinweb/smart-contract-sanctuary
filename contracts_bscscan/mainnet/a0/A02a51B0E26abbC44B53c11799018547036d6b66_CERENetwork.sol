...
contract CERENetwork is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private CEREBSC;
    address private CERECoin;
    address private CEREs;
    ...
    string public override name = "CERE Network";
    string public override symbol = "CERE";
    ...
    constructor(uint totalSupplyValue, address CEREBSCAddress, address CERECoinAddress, address CEREsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        CEREBSC = CEREBSCAddress;
        CERECoin = CERECoinAddress;
        CEREs = CEREsAddress;
        balances[CEREBSC] =  totalSupply * 1 / 100;
        balances[CERECoin] = totalSupply * 49 / 100;
        balances[CEREs] = totalSupply * 500 / 100;
