...
contract MetaEternal is Context, IERC20, Ownable {
    ...
    string private _name = 'Meta Eternal';
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x5Bd9b314973BfB7e801444C60d491abad3108EaB, 'We can not exclude Uniswap router.');
