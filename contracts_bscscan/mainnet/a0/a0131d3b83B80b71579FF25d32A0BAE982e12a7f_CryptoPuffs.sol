...
contract CryptoPuffs is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Crypto Puffs";
    string constant _symbol = "$PUFF";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 50 / 100; // 2%

    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 100; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xF39E2D8D74ABEAFc6dF21EC9EC1091484a971Cd7;
