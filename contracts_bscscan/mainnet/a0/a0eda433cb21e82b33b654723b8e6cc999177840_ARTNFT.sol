...
/**
Our project will be based on a platform that produces unique art paintings consisting of puzzles. Everyone can buy both a case and one unique puzzle. The puzzles will feature works of art by Van Gogh and Leonardo Davinci, as well as many other artists. This is not only an exciting game, but also a unique investment of the 21st century. Buy cases, collect rare, and not only, paintings. Each picture can be made unique by adding your own charm and a piece of your soul.
...
🖼Liquidity supply: 800,000,000
🖼Team(locked for 12 months): 100,000,000
🖼Marketing pool: 100,000,000

Initial liquidity: 20 BNB (Liquidity will be locked for 2 years before fairlaunch and ownership will be renounced as soon as possible) 
*/
