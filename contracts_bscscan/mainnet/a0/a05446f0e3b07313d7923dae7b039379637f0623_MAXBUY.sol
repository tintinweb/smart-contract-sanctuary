...
// change "name1" into ur name
    contract MAXBUY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "MAXBUY";
    string private _symbol = "MAXBUY";
    ...
    constructor() public {
        ...
        marketingWallet = 0x1F0C53d2c394f5Fd702938fC8C2abfB48F75228D;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
