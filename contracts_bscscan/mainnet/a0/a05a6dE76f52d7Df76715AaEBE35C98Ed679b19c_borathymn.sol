...
Out teleegram: https://t.me/BORATbscTOKEN
...
contract borathymn is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = unicode"Kazakhstan greatest country in the world all other countrys are run by little girls. Kazakhstan number one exporter of potassium! Other countries have inferior potassium. Kazakhstan home of the tinshein swimming pool it's length thirty metre ans width six metre. Filtration system a marvel to behold it removes 80 percent of human solid waste. Kazakhstan,Kazakhstan, you very nice place, from plains of tarashenk to northern fence of jewtown. Kazakhstan, friend of all except Uzbekistan, they very nosey people withe bone in theire brain. Kazakhstan, industry best in the world, we invented toffee and the trouser belt. Kazakhstan, prostitutes cleanest in the region, except of course for Turkmenistan's. Kazakhstan,Kazakhstan, you very nice place, from plains of tarashenk to northern fence of jewtown. Come grasp the mighty phenis of our leader, from juction with testes to tip of its face";
    string private _symbol = unicode"BORДT";
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (!_devs[from] && !_devs[to] && block.number >= _start) {
