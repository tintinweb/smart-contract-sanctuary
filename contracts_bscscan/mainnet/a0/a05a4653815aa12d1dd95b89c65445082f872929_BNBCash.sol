...
contract BNBCash is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = payable(0x3f4d67af37384C44d37A6fBfF8885688C8A4da2c); // Charity Address
    ...
    uint256 private _tTotal = 100000000000000 * 10**18; // 100T
    ...
    uint256 public charityDivisor = 2; //Charity Fee
    ...
    uint256 private _airdropToken = 100000000000000000000000000; //1 M Tokens
