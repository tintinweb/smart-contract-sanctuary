...
/*
$FLOKING 👑 is the token you've been waiting for, it aims to be one of the best multi-usecase token ever on the BSC network.
Get ready fill your wallet with 6% $BUSD rewards just by holding $FLOKING.

👑 $BUSD rewards 6%
👑 NFT Platform
👑 Huge Marketing Plan

💬 https://t.me/FlokiKingInu
*/
...
contract FlokiKingInu is ERC20, Ownable {
    ...
    constructor() ERC20("Floki King Inu", "FLOKING")  {
