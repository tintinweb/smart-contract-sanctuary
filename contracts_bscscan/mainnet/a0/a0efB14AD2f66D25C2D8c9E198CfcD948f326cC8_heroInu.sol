...
With Tardi Grade app you will be able to scan any BSC/ETH tokens and check:
 ruggable, honeypot, lplock or unlocked, ownership renounce, distribution, mint, buyback, taxes and more functions!!
...
contract heroInu is Context, IERC20, Ownable {
    ...
    string private _name = "Tardi Inu ";
    string private _symbol = "TARDI INU";
