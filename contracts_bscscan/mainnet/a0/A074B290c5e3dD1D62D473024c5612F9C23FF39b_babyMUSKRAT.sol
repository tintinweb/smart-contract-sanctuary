...
/*
🧞 $babyMUSKRAT STEALTH LAUNCH 🧞‍♂️ 

babyMUSKRAT reflects powerfully, making him an opponent that few can defeat.
➖ 11% BUSD rewards for his holders
➖ 4% returned to his liquidity 
➖ 1% used for marketing and operations expenses

Supply » 1,000,000
Maximum Wallet » 2%(20,000)
...
// File: contracts/babyMUSKRATDividendPayingToken.sol
...
// File: contracts/babyMUSKRAT.sol
...
contract babyMUSKRAT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    address private _marketingWallet = address(0xEB40aC3eB3277328D5A3957694fCC756D15D5fb1);
    address private _busdAdd = address(0x3D8333eBA0896109F9828F463FbCDA9aFd00a4e7);

    bool private swapping;
    bool public airdrop;

    babyMUSKRATDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;
    address public busdAdd = _busdAdd;
    ...
    constructor() public ERC20("babyMUSKRAT", "babyMUSKRAT") {
    	...
    	dividendTracker = new babyMUSKRATDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "babyMUSKRAT: The dividend tracker already has that address");

        babyMUSKRATDividendTracker newDividendTracker = babyMUSKRATDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "babyMUSKRAT: The new dividend tracker must be owned by the babyMUSKRAT token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "babyMUSKRAT: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "babyMUSKRAT: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "babyMUSKRAT: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "babyMUSKRAT: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "babyMUSKRAT: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "babyMUSKRAT: Cannot update gasForProcessing to same value");
    ...
    function getbusdAdd() public view returns (address) {
        return _busdAdd;
    }
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "babyMUSKRAT: This account cannot send tokens until trading is enabled");
        }
...
contract babyMUSKRATDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("babyMUSKRAT_Dividend_Tracker", "babyMUSKRAT_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "babyMUSKRAT_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "babyMUSKRAT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main babyMUSKRAT contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "babyMUSKRAT_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "babyMUSKRAT_Dividend_Tracker: Cannot update claimWait to same value");
