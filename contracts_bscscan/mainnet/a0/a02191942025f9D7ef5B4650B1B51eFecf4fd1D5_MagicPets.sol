...
contract MagicPets is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

 
    address public MARKETING_ADDRESS = 0x19b7eA41529c1a3674Aff1C4B7eaA7B27be88a53;
    ...
    string private _name = "My MagicPets";
    string private _symbol = "MagicPets";
