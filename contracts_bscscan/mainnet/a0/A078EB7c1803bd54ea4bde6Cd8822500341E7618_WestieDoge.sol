...
contract WestieDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WESTIE DOGE";
    string constant _symbol = "WESTY";
    ...
    address public Owner=0x23aa90144F021e3fAFA708eD28Bc9BE0ac7B4431; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xCB70cC224DE05213b6ab0592644804e15b3e6aA2;
