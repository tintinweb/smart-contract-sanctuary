...
//DogGirl is the next BSC community driven meme/utility token which has the goal to be the next big moonshot.
...
contract DogGirl is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //Mainnet:0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c Testnet: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DogGirl";
    string constant _symbol = "DogGirl";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 _liqSupply = (_totalSupply * 43) /100;
    ...
    uint256 _giveAwaySupply = (_totalSupply * 5) /100;
    ...
    address private marketingFeeReceiver = 0xA9b6298573c08180329984c718375a0B8Ac77C77;
    address private devFeeReceiver = 0x7dFED61eF95bc7f408bF084147A1EC01f9BB523d;
    address private ethBridgeAndExchange = 0x8C6746c6ECE0075608791fc4610d2294f2B8a52A;
    address private stakingWallet = 0xDFd0D04e129C479f91D720958e7A35036b767501;
    address private giveawayWallet = 0x7eB18d99ab821E163713479B0ABEa1C8B3514E9E;
    ...
    constructor () Auth(msg.sender) {
        ...
        _balances[giveawayWallet] = _giveAwaySupply;
        _balances[DEAD] = _burntSupply;
        emit Transfer(address(0), _owner, _liqSupply);
        emit Transfer(address(0), giveawayWallet, _giveAwaySupply);
        ...
        emit Transfer(address(0), DEAD, _burntSupply);
    }
