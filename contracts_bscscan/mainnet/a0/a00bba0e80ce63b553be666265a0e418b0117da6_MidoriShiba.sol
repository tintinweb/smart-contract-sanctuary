...
Welcome to MidoriShiba
MidoriShiba is a decentralized exchange running on Binance Smart Chain, with lots of features that let you earn and win tokens. It is fast, cheap and easily accessible as it is not difficult to use.
...
✅Burn LPs
✅RenounceOwnership
Telegram : @MidoriShibaChat
Twitter : @MidoriShibaa
Website : https://countingdownto.com/countdown-pages/04aTqgwA
...
contract MidoriShiba is Context, IERC20, Ownable {
    ...
    string private _name = "MidoriShiba";
    string private _symbol = "MidoriShiba";
