...
/**
   ...
   Welcome to LittleBabyEthereum
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyEthereumBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyEthereum to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyEthereum idea, increasing the liquidity pool automatically, 
...
contract LittleBabyEthereum is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby Ethereum";
    string private _symbol = "LTBABYETH";
