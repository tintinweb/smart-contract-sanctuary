...
/*
🐈‍⬛Baby PULI INU is fully decentralized and on a mission to bring crypto to the average pe
rson while also helping the deep and warm consciousness of humanity. 
💡Baby PULI INU has learned a few tricks and lessons from his meme father, 
PULI INU. A new crypto birthed by members of the PULI INU online community. 
Baby PULI INU seeks to impress his father by showing his new improved 
transaction speeds & adorableness. 
💰Hold $BabyPULI and get paid passive income in 💰!
 ...
 * the owner.
 */
contract BinanceOwnable is Binance {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "BinanceOwnable: caller is not the owner");
        _;
    }
...
contract PULIINU is Binance, BinanceDeployer, BinanceOwnable {
