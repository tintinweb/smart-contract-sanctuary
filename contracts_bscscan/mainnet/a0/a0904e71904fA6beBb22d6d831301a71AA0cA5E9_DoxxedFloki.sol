...
/**
 * Your next FLOKI MOONSHOT!!!
 * https://t.me/doxxedflokiofficial
 */
...
// CHANGE
contract DoxxedFloki is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DoxxedFloki";
    string constant _symbol = "DXF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 1000; // 1% MAX 5,000,000
    uint256 public _maxWalletSize = (_totalSupply * 15) / 1000; // 1.5% MAX 15,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xa9af96BFf3e2F3942F6ccbAcf04062538b8fE5cE);
