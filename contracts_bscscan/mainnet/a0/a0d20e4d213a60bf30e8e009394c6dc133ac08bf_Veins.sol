...
contract Veins is ERC20, Ownable {
    ...
    ) public ERC20("Veins", "VEINS") {
        
        _mint(address(0x40eE2ad871896D319cA0E39624c49Bab7b73Edf3), 108000000 * 10**6); // OWNER ADDRESS     - 208,000,000
        _mint(address(0x40eE2ad871896D319cA0E39624c49Bab7b73Edf3), 38250000 * 10**6); // ADMIN ADDRESS     -  68,250,000
        _mint(address(0x40eE2ad871896D319cA0E39624c49Bab7b73Edf3), 8250000 * 10**6); // MARKETING ADDRESS -  16,250,000 
        _mint(address(0x40eE2ad871896D319cA0E39624c49Bab7b73Edf3), 16500000 * 10**6); // RESERVA ADDRESS   -  32,500,000
        
        ownerWallet = 0x40eE2ad871896D319cA0E39624c49Bab7b73Edf3; //OWNER WALLET FOR REFLECTION
