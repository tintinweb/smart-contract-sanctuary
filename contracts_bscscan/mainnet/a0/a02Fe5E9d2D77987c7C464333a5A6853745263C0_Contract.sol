...
I make this #HolidayShiba to hand over it to the community.
Create the community by yourself if you are interested. 
I Suggest @HolidayShiba

I will burn liquidity LPs to burn addresses to lock the pool forever.
I will renounce the ownership to burn addresses to transfer #HolidayShiba to the community, make sure it's 100% safe.
