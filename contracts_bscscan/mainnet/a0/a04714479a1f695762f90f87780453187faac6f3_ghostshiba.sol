...
Every transaction within Ghost Shiba token taxed by 11%. 
The tax is split in three parts, where 6% goes to Buyback, 
3% goes to charity and 2% redistribute to Ghost Shiba token holders.

TG : https://t.me/GhostShiba_Remastered
Website : www.ghostshibax2.io
*/
...
contract ghostshiba is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "GHOSTSHIBA";
