...
// https://t.me/BabyZuFinanceGlobal
// Inspired by the Zu Finance In project and its rise, baby Zu Finance is born as a gem ABUNDANT EARNINGS FOR EVERYONE
...
contract BabyZuFinance is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyZuFinance";
    string constant _symbol = "BABYZUF";
