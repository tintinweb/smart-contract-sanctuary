...
contract RICH is Context, IERC20, Ownable {
    ...
    // Repurchase Address
    address payable public repurchaseAddress = payable(0x39d5CA7779804aF9Da28B156C1D399FCA2Bb1Af5); 
    ...
    uint256 public repurchaseDivisor = 4;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(repurchaseAddress, transferredBalance.mul(repurchaseDivisor).div(100));
    ...
    function setrepurchaseDivisor(uint256 divisor) external onlyOwner {
        repurchaseDivisor = divisor;
    }
    ...
    function setrepurchaseAddress(address _repurchaseAddress) external onlyOwner {
        repurchaseAddress = payable(_repurchaseAddress);
    }
