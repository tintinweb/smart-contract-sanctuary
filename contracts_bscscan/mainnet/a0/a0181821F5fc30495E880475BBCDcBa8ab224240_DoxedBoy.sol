...
Doxed Boy 
Doxed Boy is riding the Boy hype with the safest possible contract ~

Features a DOXED DEV LIVE IN VC, 1 week liquidity lock, RENOUNCED OWNERSHIP, and no dev wallet 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "DoxedBoy";
    string internal constant SYMBOL = "DBoy";
    ...
    address internal marketingAddress =
        0x409592D978ce0106Fb93834D5DFC63249AAB959f;
...
abstract contract AntiBot is Tokenomics {
    ...
    uint256 public antiBotDuration = 5 minutes;
...
contract DoxedBoy is SafeToken {
