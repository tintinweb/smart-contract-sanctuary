...
/* Token contract */
contract KFCheems is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x512D904443D0873075e2cb9E568740946d341843;
    ...
    // Name and symbol
    string constant _name = "KentuckyFriedCheems";
    string constant _symbol = "KFCheems";
  ...
  // Sell fees
    ...
    uint256 public reflectionFeeSell = 400;
    ...
    uint256 public swapThreshold = _totalSupply * 20 / 10000; // 0.1% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x512D904443D0873075e2cb9E568740946d341843;
