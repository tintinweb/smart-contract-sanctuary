...
/**   
   ...
   Welcome to CovidRecovery Token
   
   This is a community token. If you want to create a telegram I suggest to name it to @CovidRecoveryBSC
   ...
   I will Locked liquidity LPs.
   I will renounce the ownership to burn addresses to transfer #CVD to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #CVD 10000X? 
   ...
   it's the best part of the #CVD idea, increasing the liquidity pool automatically, 
...
contract CovidRecoveryToken is Context, IERC20, Ownable {
    ...
    string private _name = "CovidRecovery";
    string private _symbol = "CVD";
