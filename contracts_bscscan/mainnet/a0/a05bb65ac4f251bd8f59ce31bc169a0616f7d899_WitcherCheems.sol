...
// File contracts/WitcherCheems.sol
pragma solidity ^0.8.0;

contract WitcherCheems is Context, IERC20, Ownable {
    ...
    string private constant _name = "WitcherCheems";
    string private constant _symbol = "WCHEEMS";
    string private constant _ProjectName = "WitcherCheems";
