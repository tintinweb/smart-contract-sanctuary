...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/d_o_g_e/alm_i_g_hty/522
        if (a == 0) {
            return 0;
        }
...
contract DOGEALMIGHTY is IERC20 {
    ...
    uint256 private constant startingSupply = 100_000_000_000; // 100 Bilion, underscores aid readability

    uint8 private _decimals = 9;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "DOGE ALMIGHTY";
    string constant _symbol = "DOGEALMIGHTY";

    uint256 public _reflectionFee = 0; // Adjusted by buys and sells.
    uint256 public _liquidityFee = 0; // Adjusted by buys and sells.
    uint256 public _marketingFee = 0; // Adjusted by buys and sells.
    uint256 public _totalFee = _liquidityFee + _reflectionFee + _marketingFee;
    uint256 public masterTaxDivisor = 10000;

    uint256 public _buyReflectionFee = 900;
    uint256 public _buyLiquidityFee = 360;
    uint256 public _buyMarketingFee = 540;

    uint256 public _sellReflectionFee = 1200;
    uint256 public _sellLiquidityFee = 480;
    uint256 public _sellMarketingFee = 720;

    uint256 public maxReflectionFee = 2500;
    ...
    address payable private _marketingWallet = payable(0x8fFcb391f7706542f5e5B3627430CB2FEb00E869);
    ...
    bool private initialSubEnabled = true;
    bool inSwap;
    ...
    function setBlacklistEnabled(address account, bool enabled) external onlyOwner() {
        require(_isSniper[account] != enabled, "Already blacklisted.");
    ...
    function setBuyTaxes(uint256 liquidityFee, uint256 reflectionFee, uint256 marketingFee) external onlyOwner {
        ...
        require(liquidityFee + reflectionFee + marketingFee <= 6000);
    ...
    function adjustTaxes(address to) internal {
        ...
        _totalFee = _reflectionFee + _liquidityFee + _marketingFee;
    }
