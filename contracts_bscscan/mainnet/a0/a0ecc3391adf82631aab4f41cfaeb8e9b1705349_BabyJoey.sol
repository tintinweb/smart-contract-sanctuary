...
import "./BabyJoey-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyJoey` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyJoey(Env.Testnet)` or `BabyJoey(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyJoey";
    string internal constant SYMBOL = "BJOEY";
     ...
     */
    address internal tipToTheDev =0x909047603E5F8D7793B3C2321F699c9a02029c62;
...
contract BabyJoey is SafeToken{
