...
contract Crowdsale is Ownable {
  ...
  uint256 public minimumPurchaseLimit;
   ...
   */
  constructor(address payable _wallet, Token _token) Ownable(0x74060a990caA66A5AA1A2ed107C7011a1235Afc6){
    ...
    wallet = _wallet;
    token = _token;
    minimumPurchaseLimit = 80000000;
    maxPurchaseLimit = 8 ether;
  }

  function changePrice(uint256 _rate) public onlyOwner
  {
      rate = _rate;
  }
  ...
  {
      minimumPurchaseLimit = _min;
  }

     function changeMax(uint256 _max) public onlyOwner
  {
      maxPurchaseLimit = _max;
  }
  ...
  function buyTokens(address _beneficiary) public payable {
    ...
    require(weiAmount > minimumPurchaseLimit && weiAmount < maxPurchaseLimit, "Insuffiecint bnbs");
