...
Telegaram : https://t.me/OreoRipple
Website : https://t.me/OreoRipple
...
contract OreoRipple is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("OreoRipple", "OreoRipple") {
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "OreoRipple: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "OreoRipple: The new dividend tracker must be owned by the OreoRipple token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("OreoRipple_Dividend_Tracker", "OreoRipple_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "OreoRipple_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "OreoRipple_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "OreoRipple_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "OreoRipple_Dividend_Tracker: Cannot update claimWait to same value");
