...
//===============================================================================================================
    ...
    function toBNBOut(uint256 amt, uint256 totalFee) internal {
        _maintenanceWallet.transfer((amt * _maintenanceRatio) / totalFee);
        _manualBuybackWallet.transfer((amt * _manualBuybackRatio) / totalFee);
        _marketingWallet.transfer((amt * _marketingRatio) / totalFee);
    }
