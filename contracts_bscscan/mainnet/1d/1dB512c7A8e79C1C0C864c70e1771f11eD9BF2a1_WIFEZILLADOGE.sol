...
contract WIFEZILLADOGE is ERC20, Ownable {
    ...
    WIFEZILLADOGEDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    uint256 public swapTokensAtAmount = 69 * (10**19) * (10**18);

    uint256 public _maxTxAmount = 40 * (10**20) * (10**18);
    ...
    address public _marketingWalletAddress =
        0x2D6192e3C8966DdBF9D460829665dc6E7b544A5b;
    ...
    constructor() public ERC20("WifeZillaDoge", "WifeZillaDoge") {
        swapOpen = true;
        dividendTracker = new WIFEZILLADOGEDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        WIFEZILLADOGEDividendTracker newDividendTracker = WIFEZILLADOGEDividendTracker(
                payable(newAddress)
            );
...
contract WIFEZILLADOGEDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor()
        public
        DividendPayingToken(
            "WIFEZILLADOGE_Dividen_Tracker",
            "WIFEZILLADOGE_Dividen_Tracker"
        )
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10**18 * (10**18);
    }
