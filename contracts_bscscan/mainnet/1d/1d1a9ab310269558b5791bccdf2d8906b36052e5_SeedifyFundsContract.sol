...
contract SeedifyFundsContract is Ownable {
    ...
    constructor(
        ...
        totalUserInTierOne = 14021;
        totalUserInTierTwo = 8412;
        totalUserInTierThree = 3058;
        totalUserInTierFour = 1402;
        totalUserInTierFive = 885;
        totalUserInTierSix = 647;
        totalUserInTierSeven = 240;
        totalUserInTierEight = 112;
        totalUserInTierNine = 51;
