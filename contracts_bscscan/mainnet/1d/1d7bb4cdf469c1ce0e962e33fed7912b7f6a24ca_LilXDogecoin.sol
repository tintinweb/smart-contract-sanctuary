...
/**
   ...
   Welcome Lil X Dogecoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @LilXDogecoin
   ...
   I will renounce the ownership to burn addresses to transfer #LilXDogecoin to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #LilXDogecoin 10000X? 
...
contract LilXDogecoin is Context, IERC20, Ownable {
    ...
    string private _name = "Lil X Dogecoin";
    string private _symbol = "LILXDOGE";
