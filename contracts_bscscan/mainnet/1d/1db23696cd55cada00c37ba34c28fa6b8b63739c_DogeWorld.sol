...
contract DogeWorld is IBEP20, Auth {
    ...
    string constant _name = "DogeWorld";
    string constant _symbol = "DogeWorld";
    ...
    uint256 public _maxTxAmount = _totalSupply * 1000 / 100;
    uint256 public _walletMax = _totalSupply * 1000 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x4bE44C301860a1C3e1cb3B3EC65169edC3645F3B;
        marketingWallet = 0xeae08448363F93CF53FFB0EF370F2B98881E519F;  // teamwallet
        lotteryWallet = 0x4bE44C301860a1C3e1cb3B3EC65169edC3645F3B;  // lotterywallet
