...
contract NicElonMusk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7197c93be5496998393AcE73aE5AB34C72adB56b); // Marketing Address
    ...
    string private _name = "NicElonMusk";
    string private _symbol = "NICELON";
