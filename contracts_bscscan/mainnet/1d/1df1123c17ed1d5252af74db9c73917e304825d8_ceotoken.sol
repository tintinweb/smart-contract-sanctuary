...
contract ceotoken is IBEP20, Auth {
    ...
    string constant _name = "C.E.O. Token"; //token name #4 
    string constant _symbol = "CEOT"; // token tika #5
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 1 )  / 200; //max transaction %
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1B807a0F1b4CEEdBe4573AC3C2E591064A52CDD1;
