...
Telegram: https://t.me/DotDealer
Website: https://www.dotdealerbsc.com
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402); //Polkadot
...
contract DotDealer is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "DotDealer";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;  //Polkadot

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100;
    uint256 public _walletMax = _totalSupply * 3 / 100;

    uint256 sellFeeMultiplier = 1;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xFF3Cc45b6F1D9502C09De9C49D097A90116F089d;  // marketingwallet
    ...
    function changeSellFeeMultiplier(uint256 _multiplier) external authorized {
        require(_multiplier >= 1, "Multiplier cannot be less than 0");
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(recipient == pair){
            feeApplicable = totalFeeIfSelling * sellFeeMultiplier;
        } else {
