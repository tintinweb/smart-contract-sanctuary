...
/**
 *BabyNobita - The easiest way to earn while watching Nobita
 * Holders will receive high rewards!!!
*/
...
contract BabyNobita is Context,IBEP20,Ownable {
    ...
    string private constant _name = "BabyNobita";
    string private constant _symbol = "BBYNBT";
