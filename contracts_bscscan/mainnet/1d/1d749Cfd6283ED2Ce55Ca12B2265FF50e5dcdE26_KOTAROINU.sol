...
/**
    ...
    Anti-Bot/Whale 
    To create a successful fair launch environment, we've implemented an exclusive feature to our contract.
    on flokimoonway I arrange for investors who want to sell it to wait until 20 minutes after launch
...
🔥Holders: 1%
    ...
    Total Supply = 500T (500,000,000,000,000)
    Burned = 200T (200,000,000,000,000)
    Airdrop+Marketing = 50T (50,000,000,000,000)
    Circulating Supply after burn = 250T (250,000,000,000,000)
...
contract Ownable is Context {
    ...
    */
    function renounceOwnership() public virtual onlyOwner { //renounced contract once threshold/anti-bot is disabled
...
interface IUniswapV2Pair {
    ...
    event Mint(address indexed sender, uint amount0, uint amount1); //required function for liquidity
    ...
    function mint(address to) external returns (uint liquidity); //swap and liquify - liquidity function
...
//threshold function for anti-bot/whale - disabled after successful launch
    ...
    string private _name = "KOTAROINU";
    string private _symbol = "KOTAROINU";
    ...
    uint256 private _threshold_amount = 12000000000 * 10**9; //limit
    uint private _reset_time = 1800; //time interval after previous sell - no restriction on first sell up to 12000000000 tokens - 10% of max tx limit

    uint256 public _taxFee = 3; //redistribution
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 7; //liquidity pool
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap); //swap for liquidity
...
bool overMinTokenBalance = contractTokenBalance >= numTokensSellToAddToLiquidity; //function to activate swap and liquify for liquidity
if (
overMinTokenBalance &&
!inSwapAndLiquify &&
from != uniswapV2Pair &&
