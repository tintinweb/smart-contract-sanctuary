...
/**
    ...
    WinstonsCAKE is a CAKE rewards with FAT cake rewards just for holding.
...
$$$  / \$$$ |$$ |$$ |  $$ | \____$$\   $$ |$$\ $$ |  $$ |$$ |  $$ | \____$$\ $$ |  $$\ $$ |  $$ |$$ |\$$\  $$ |      
$$  /   \$$ |$$ |$$ |  $$ |$$$$$$$  |  \$$$$  |\$$$$$$  |$$ |  $$ |$$$$$$$  |\$$$$$$  |$$ |  $$ |$$ | \$$\ $$$$$$$$\ 
\__/     \__|\__|\__|  \__|\_______/    \____/  \______/ \__|  \__|\_______/  \______/ \__|  \__|\__|  \__|\________|

 

 TG: https://t.me/WinstonsCAKE
 ...
 *** THE MAX A WALLET CAN HAVE IS 35,000,000! THAT IS 5%! YOU CAN SELL A MAX OF 1.5%! ***
...
// CHANGE
contract WinstonsCAKE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "WinstonsCAKE";
    string constant _symbol = "Winston";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 15) / 1000; // 1.5% MAX 20,000,000
    uint256 public _maxWalletSize = (_totalSupply * 35) / 1000; // 3.5% MAX 3,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x0000000000000000000000000000000000000000);
