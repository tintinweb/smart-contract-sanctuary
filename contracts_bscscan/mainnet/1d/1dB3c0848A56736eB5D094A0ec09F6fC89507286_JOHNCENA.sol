...
contract JOHNCENA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "JOHNCENA";
    string constant _symbol = "JOHNCENA";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xC6D45f2D7e4B09867939B6B90A159076172234b9;
