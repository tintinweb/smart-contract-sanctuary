    ...
    UUPSUpgradeable
{
    ...
    constructor() initializer {
        ...
        DragoAddr = 0x70D542e94a70081a15a555eCFA1Ba4BFB9217FBb;
        wDragoAddr = 0x70D542e94a70081a15a555eCFA1Ba4BFB9217FBb;
        DragonBreathAddr = 0xc89Afb095805796fb4BCdB912DACdAB33c6C6e62;
        LifeElixirAddr = 0xB608C633C58457E5Ec5Cd007930c66FA2444A2c7;
        DragonFlameAddr = 0x4D48d91525f4dED93B275782fAF4F2D5C130E29F;
        RockAddr = 0xe69e58B8e1359a20227BEAdadb586f95920040d7;
        IceAddr = 0xc072bA75c2F33835B3122a3db4804Bf2350cD20D;
        LightningBoltAddr = 0x43c41D6072833C5B897Ab7e8e273aa2F3EB15a93;
        LavaAddr = 0x8de5bf99Fb4174C7e36108266003E80286b70d5C;
        CrystalsAddr = 0xB57a9dc286E52409d4AF347233bf4EE6E7cee653;
        ...
        rewardsEcosystemContract = 0x70D542e94a70081a15a555eCFA1Ba4BFB9217FBb;
        oldDragos = 0xdb93808c5f7b8EaB734c5c95748A0C3F17FEfe8F;
    }
    ...
    function listToSell(uint256 _idx, uint256 _price) public {
        ...
        DragoNFT memory current = dragos[_idx];
        require(farmLandInstance.dragoNFTOwnerAddress(current.id) == address(0x000), "ape is stacked");
    ...
    function getTypeIdByNftId(uint256 tokenId) public view returns (uint256) {
        ...
        DragoNFT memory current = dragos[idx];
