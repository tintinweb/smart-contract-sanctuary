...
contract BSTK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public _marketingAndDev = address(0xb9970764E62Fc600Ec9D7DeE4be21C65455f2685);
    ...
    string private _name = "Biospheretoken";
    string private _symbol = "BSTK";
    ...
    uint256 private numTokensSellToAddToLiquidity = 200000 * 10**8;
    uint256 public _maxWalletToken = 100 * 10**6 * 10**8;
