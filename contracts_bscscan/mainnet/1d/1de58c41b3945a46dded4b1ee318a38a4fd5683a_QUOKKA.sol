...
contract QUOKKA is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x51D20b9Fc7097c51bB4aB4016F37eD2d266531Cc ;
    ...
    string private _name = "QUOKKA";
    string private _symbol = "QKA";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2; // Destribution Fee
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _charityFee = 2; // Charity Fee
    uint256 private _previousCharityFee = _charityFee;
    uint256 public _liquidityFee = 2;  // liquidityFee
