...
/**
   #shibaoppa
   buying here means your money is considered as charity for dev to use
...
contract ShibaOppa is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaOppa";
    ...
    uint256 public _shibabinanceFee = 90;
