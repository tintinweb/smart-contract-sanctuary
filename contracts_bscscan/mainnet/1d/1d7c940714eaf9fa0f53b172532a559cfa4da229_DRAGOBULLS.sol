...
contract DRAGOBULLS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DRAGOBULLS";
    string private _symbol = "DGB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B0948241A01714Cd84BaC9feb00C04F1d2b496b); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1B0948241A01714Cd84BaC9feb00C04F1d2b496b); // BuyBack Address
