...
contract MambaICO is Ownable {
    IBEP20 public token;
    address public tokenAddress = 0xe53683e551Ed02206b2924C3958f68549BA2d4E7;
    
    IPancakeRouter02 private router;
    address public routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    address public wBnb = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //; 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    ...
    function getLPLockedTokensBalance() public view returns (uint256 liquidity) {
        address pair = IUniswapV2Factory(factory).getPair(tokenAddress, wBnb);
