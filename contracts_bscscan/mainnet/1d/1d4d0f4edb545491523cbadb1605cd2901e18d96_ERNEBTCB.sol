...
This is a community token. If you want to create a telegram I suggest to name it to @ERNEBTC
Important: The early you create a group that shares the token, the more gain you got.
   
It's a community token, every holder ERNE BTC  should promote it, or create a group for it, 
if you want to pump your investment, you need to do some effort.
   
Tokenomics
Total Supply: 1,000,000,000
Innovative Features
12% REDISTRIBUTION BTC TOKEN FOR HOLDER
...
contract ERNEBTCB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ERNE BTCB";
    string constant _symbol = "ERNEBTCB";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xF91C8A553B1A300243cea71C49F8deDe14B4d4fD;
