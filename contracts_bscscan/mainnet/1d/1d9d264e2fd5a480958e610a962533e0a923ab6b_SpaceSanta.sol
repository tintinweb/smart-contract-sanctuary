...
/**
   ...
   Welcome to Space Santa 
   
   A token to celebrate christmas early
   
   Space Santa $SpaceSANTA
   Website: https://SpaceSanta.net
   Telegram: https://t.me/SpaceSanta
...
contract SpaceSanta is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x19D8154FB87C0F3533fFb3ABbb0a10Cc2AA31cB7); // Marketing Address
