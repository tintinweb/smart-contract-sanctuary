...
contract LuckyMetaSanta is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 50 * 10**10 * 10**9; // Max Transaction: (2%)
    uint256 public _maxWalletToken = 50 * 10**10 * 10**9; // Max Wallet: (3%)
