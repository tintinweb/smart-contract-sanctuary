...
/*
 ...
 _____             _____  __ _____ _               _____            
/  ___|           |  _  |/ _|_   _(_)             |_   _|           
\ `--.  ___  _ __ | | | | |_  | |  _  __ _  ___ _ __| | _ __  _   _ 
 `--. \/ _ \| '_ \| | | |  _| | | | |/ _` |/ _ \ '__| || '_ \| | | |
/\__/ / (_) | | | \ \_/ / |   | | | | (_| |  __/ | _| || | | | |_| |
\____/ \___/|_| |_|\___/|_|   \_/ |_|\__, |\___|_| \___/_| |_|\__,_|
                                      __/ |                         
                                     |___/                          
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x47A2EBa06D06AE21202dc280b48F4b8f1446dF44); //TigerInu2022 BSC
    IBEP20 PRWDS = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); //old token for ADA
    address REWARDS;
    IRouter router;
...
contract SOTI is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'SonOfTigerInu';
    string private constant _symbol = '$SOTI';
    uint8 private constant _decimals = 9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**15 * (10 ** _decimals); //1 Qaudrillion
    ...
    uint256 public _asT = 400000000000 * (10 ** _decimals);
    ...
    uint256 public sT = 1000000000000 * (10 ** _decimals); //
    bool LFG = false;
...
// Sell Fees
    ...
    function setrecadd(address _mkwa, address _krh, address _mdh, address _wth, address _newra, address _przwa, address _charwa) external authorized {
        mkwA = _mkwa;
        przwA = _przwa;
        charwA = _charwa;
        krhF = _krh;
