...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0x45Fc3F23cb4547DaC55af126d558e644E50D1CeF;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x2A1ed0e45FAc65e1Fd112fc9eeA1600B2F774777;
        _token = msg.sender;
    }
...
contract GoldenGirl is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x45Fc3F23cb4547DaC55af126d558e644E50D1CeF;

    string constant _name = "GoldenGirl";
    string constant _symbol = "GG";
    ...
    address IDEXPair = 0x2A1ed0e45FAc65e1Fd112fc9eeA1600B2F774777;
