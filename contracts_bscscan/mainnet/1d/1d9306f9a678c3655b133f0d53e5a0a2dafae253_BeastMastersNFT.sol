...
contract BeastMastersNFT is ERC20, Ownable {
    ...
    ) public ERC20("BeastMastersNFT", "MASTERS") {
        
        _mint(address(0x16765B966190c963359e7744FFF2Ef51F8FAA84A), 250000000 * 10**6); // OWNER ADDRESS     - 250,000,000
        _mint(address(0x4751E16c5f7B0d53B9AF82eaE852169BB6Ce138F), 25000000 * 10**6); // ADMIN ADDRESS     -  25,000,000
        _mint(address(0x881DEaF1590DF6547225046821681242B53CCE17), 15000000 * 10**6); // MARKETING ADDRESS -  15,000,000 
        _mint(address(0x5146b8103aE95C33BEa6B42be0F958075A224558), 10000000 * 10**6); // RESERVA ADDRESS   -  10,000,000
        
        ownerWallet = 0x16765B966190c963359e7744FFF2Ef51F8FAA84A; //OWNER WALLET FOR REFLECTION
