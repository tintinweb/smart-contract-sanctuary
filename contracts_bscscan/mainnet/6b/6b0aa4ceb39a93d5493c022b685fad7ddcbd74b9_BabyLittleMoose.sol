...
/**
    ...
    2% max of supply in one transaction
    */
...
contract BabyLittleMoose is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "Baby Little Moose";
	string private _symbol = "BLTM";
