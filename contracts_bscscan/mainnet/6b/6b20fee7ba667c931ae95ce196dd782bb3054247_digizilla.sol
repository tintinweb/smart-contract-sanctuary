...
contract digizilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "digizilla";
    string private _symbol = "digizilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3051f63785e2bf44e4b10Ce80635B9A6a8654bB9); // Marketing Address
    address payable public teamWalletAddress = payable(0x0C3003485eb5A63A0dc1F9d8cCbCF8C3373Ee4ca ); // Team Address
