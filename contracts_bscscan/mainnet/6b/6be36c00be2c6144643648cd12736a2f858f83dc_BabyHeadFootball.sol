...
contract BabyHeadFootball is Context, IERC20, Ownable {
    ...
    string internal constant _name = "Baby Head Football";
    string internal constant _symbol = "$BHEAD";
    ...
    address payable public _marketingWallet =
        payable(address(0x349d96FeC33F7e00f9e513E86fc493Deb8A3f6b0)); // Marketing Wallet 

    bool internal inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 1 * 10**7 * 10**9; // 1% Of the supply
    uint256 public numTokensSellToGetBnb = 1 * 10**4 * 10**9; //20000 Tokens
