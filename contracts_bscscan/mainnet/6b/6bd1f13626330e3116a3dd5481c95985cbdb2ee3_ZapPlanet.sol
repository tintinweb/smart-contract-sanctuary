...
contract ZapPlanet is OwnableUpgradeable, ReentrancyGuard {
    ...
    IPlanetRouter02 private constant ROUTER =
        IPlanetRouter02(0x9F088377BcdC220CB0E1Ad15aE6Bc75074beE9F6);
    IPlanetFarm private constant FARM =
        IPlanetFarm(0xB87F7016585510505478D1d160BDf76c1f41b53d);
    IPlanetFactory private constant FACTORY =
        IPlanetFactory(0xa053582601214FEb3778031a002135cbBB7DBa18);
    ...
    */
    ...
    function getAPR(uint256 _allocPoint, uint256 _totalAllocPoint, address lpToken, uint256 _rewardPerBloc) public view returns(
        ...
        )
        {
            ...
            uint256 br = rewardPerBloc.mul(_priceFeed(GAMMA)).mul(10512000);//per block reward for the pool 10512000=1200*24*365
