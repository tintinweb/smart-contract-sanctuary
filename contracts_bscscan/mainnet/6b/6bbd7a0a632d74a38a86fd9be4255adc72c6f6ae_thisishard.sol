...
// CHANGE
contract thisishard is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "thisishard";
    string constant _symbol = "tid";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x77409169e33647DC7767178406f32EaafE311Ba7);
