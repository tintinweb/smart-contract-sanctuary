...
// Ozutochi Token contract based on the full ERC 20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Symbol: OZU
// Status: ERC20 Verified

contract OZUTOCHIToken { 
...
/**
 * OZUTOCHI Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract OzuStandardToken is OZUTOCHIToken, Ownable {
    
    using OZUMaths for uint256;
...
contract OZUTOCHI is OzuStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 75 * (10**5) * 10**8 ; // 6 million tokens, 8 decimal places
    string constant public name = "OZUTOCHI"; //fancy name: eg OZUTOCHI
    string constant public symbol = "OZU"; //An identifier: eg OZU
