...
contract AIOTNetwork is ERC20Capped, Orchestrated {

    bool public contractLimit;
    mapping(address => bool) public white;

    constructor(uint256 cap_) ERC20Capped(cap_) ERC20("AIOT Network", "AIOT") {
        white[address(this)] = true;
        ERC20._mint(msg.sender, 100000000 * (10 ** 18));
    }
