...
Great features:
   ...
   I will renounce the ownership to the community.
...
contract GingerFoxBSC is Context, IERC20, Ownable {
    ...
    string private _name = "GingerFox";
