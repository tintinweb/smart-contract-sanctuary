...
contract Ather is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500000 * 10**3 * 10**5;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'Ather';
    string private _symbol = '$ATHR';
    ...
    uint256 private _liquidityFee = 2; // 4% into liquidity

    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    address payable private _marketingWalletAddress = payable(0x221664Af5c6C1cb93a59FEDf0fa76058e04461E5);
    ...
    uint256 private _maxTxAmount = 500000 * 10**3 * 10**5;
    // We will set a minimum amount of tokens to be swapped
    uint256 private _numTokensSellToAddToLiquidity = 50 * 10**3 * 10**5;
