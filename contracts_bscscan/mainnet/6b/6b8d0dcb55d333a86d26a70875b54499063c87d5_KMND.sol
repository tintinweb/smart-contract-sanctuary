 ...
 * KingMiniDoge has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 *
 * TOKENOMICS:
 * 1,000,000,000 token supply
 * FIRST TWO MINUTES: 3,000,000 max buy / 45-second buy cooldown (these limitations are lifted automatically two minutes post-launch)
...
contract KMND is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"KingMiniDoge";
    string private constant _symbol = unicode"KMND";
