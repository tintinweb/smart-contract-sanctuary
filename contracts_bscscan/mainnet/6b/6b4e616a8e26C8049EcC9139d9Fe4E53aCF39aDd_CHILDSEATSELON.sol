...
contract CHILDSEATSELON is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5600C437e9cefBd0d721763AFe029ECe7a2eF4A9); // Marketing Address
    ...
    string private _name = "CHILDSEATSELON";
    string private _symbol = "CHILDSEATSELON";
