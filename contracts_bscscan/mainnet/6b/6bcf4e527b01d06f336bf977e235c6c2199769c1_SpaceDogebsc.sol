...
All preSales seems to have running issues, so why not stealtch Launch, 
SpaceRiseDoge is the next one that will not fullfill, so come on over  
and lets rock this together.

You as a community can create a TG called: https://t.me/SpaceDoge_bsc and go for it.
We will burn all and renounce ownership. 
...
contract SpaceDogebsc is BEP20 {
