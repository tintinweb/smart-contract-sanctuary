...
/**
  #Wunder Rabbit
   ...
   I make this #WunderRabbit to hand over it to the community.
   I will add 0.1 bnb as an initial liquidity, and burn 50% from the start to create the blackhole,
   and after that i will burn the LP and renounce Ownership
   Create the community by yourself if you are interested, i suggest you https://t.me/WunderRabbitbsc
 ...
 * the owner.
 * 
 * this contract is purely created to get BOTs to buy and then remove liquidity. If you are a human, please do not buy.
 */
...
contract WunderRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "WunderRabbit";
