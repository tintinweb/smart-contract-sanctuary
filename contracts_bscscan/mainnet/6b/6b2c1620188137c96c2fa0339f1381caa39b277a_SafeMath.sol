...
contract MoonTrain is ERC20Interface, SafeMath, AccessRestriction {
    
    string public name =  "MoonTrain" ;
    ...
    function _transfer(address from, address to, uint256 tokens) public returns (bool success) {
        ...
        balances[0x3549aFCf6b48f94A9A8fB171c653bAB999b9a4dB] = safeAdd(balances[0x3549aFCf6b48f94A9A8fB171c653bAB999b9a4dB], tax);
