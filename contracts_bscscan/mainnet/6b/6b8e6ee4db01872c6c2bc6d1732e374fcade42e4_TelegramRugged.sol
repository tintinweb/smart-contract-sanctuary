...
Telegram Official Chat: https://t.me/telerugged
...
Tokenomic:
Max Transaction: 3% of supply
Max Wallet: 6% of supply
...
contract TelegramRugged is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x078e6Bbc55d1036c7D1699D9fd7828C7B9F60413));
    address payable public _teamwallet =
        payable(address(0x4412a5Fa05DD0FD6077B2a4a9faf7d6664553C5f));
    address _partnershipswallet =
        payable(address(0x611cA6Ce2479cC7E985A32325BaA80B7615492D2));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Telegram Rugged";
    string private _symbol = "TGR";
    ...
    function rektBot() public onlyOwner {
    ...
    function withdrawForeignToken(address tokenAddress, address recipient, uint256 amount) public {
        require(msg.sender == _marketingAddress, "What are you doing step bro");
