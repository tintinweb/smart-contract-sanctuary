...
contract Ecochaintoken is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Ecochaintoken";
    ...
    uint256 public _liquidityFee = 60; // 6% will be added to the liquidity pool
    ...
    uint256 public _devFee = 20;  // 2% will go to the maeketingAndDev address 
