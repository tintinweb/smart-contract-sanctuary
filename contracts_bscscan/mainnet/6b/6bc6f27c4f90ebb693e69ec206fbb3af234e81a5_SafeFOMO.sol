...
web: https://safefomo.com
telegram: t.me/safefomo
...
//mainnet 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//router 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 //0x10ED43C718714eb63d5aA57B78B54704E256024E
        _token = msg.sender;
    }
...
contract SafeFOMO is IBEP20, Auth {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //test 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SafeFOMO";
    ...
    uint256 public launchedAt = 5;
    uint256 public sellMultiplier  = 100; //100
    ...
    constructor () Auth(msg.sender) { //test 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //  router
        ...
        marketingFeeReceiver = 0x5dEA0D500DeF71C925B2356193Ae29FC50B644a3;
        devFeeReceiver = 0x5dEA0D500DeF71C925B2356193Ae29FC50B644a3;
