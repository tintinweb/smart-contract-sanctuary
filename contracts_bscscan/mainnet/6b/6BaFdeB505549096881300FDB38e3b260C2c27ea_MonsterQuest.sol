...
/**
👍Introducing MONSTER QUEST - the first NFT game that lives on MULTIPLE blockchains!😋

Are you ready to embark on the journey to become the most successful monster collector? 👈👈👈

Site: http://www.monsterquest.cc/
Twitter: https://twitter.com/MonsterQuestt
Telegram: https://t.me/monstersquest
*/
pragma solidity ^0.8.4;
 
import "./Libraries.sol";
 
contract MonsterQuest is Ownable, IBEP20 {
 
    string private _name = "MonsterQuest";
    string private _symbol = "MNQT";
