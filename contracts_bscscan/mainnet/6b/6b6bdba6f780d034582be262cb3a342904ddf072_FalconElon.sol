...
* Falcon Elon is a deflationary token based on the Binance Smart Chain network,  
  whose purpose is to let $MDADDY holders gain BNB rewards on every transaction. 
  Falcon Elon Finance gathers frictionless BNB yield, regular draws and buybacks, 
  NFT capabilities and is focused on creating a safe and secure Launchpad platform for DeFi projects.

  Telegram: https://t.me/falconelon
...
contract FalconElon is Context, IBEP20, Ownable, ReentrancyGuard {
