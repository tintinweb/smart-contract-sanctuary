...
/**
   ...
   Moon to the Ground like MoonGround
   
   You are early now, join our telegram : https://t.me/MoonGroundBSC

   Great features:
   5% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   1% fee to dex wallet
   50% supply burn to the black hole
   I will add .4 BNB and all the left 50% total supply to the pool
...
contract MoonGround is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x25a4ccFc6a6D3d05a03E0eFAd7E0cA75F9F4e6B3); // Marketing Address
    ...
    string private _name = "MoonGround";
