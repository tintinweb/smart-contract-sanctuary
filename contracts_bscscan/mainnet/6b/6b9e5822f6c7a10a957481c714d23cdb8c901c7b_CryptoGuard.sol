...
/**
Born with the desire to be a fully decentralized DeFi token, the developers have decided to renounce their contract in order for the community to be in charge of supporting it and giving it value.

CryptoGuard plans to implement a marketing plan so that in the future it will be a coin of great value, we are sure that the community itself will make it grow hand in hand with marketing.


https://t.me/CryptoGuardBSC
...
contract CryptoGuard is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 60_000_000_000; 
    ...
    string private _name = "Crypto Guard";
    string private _symbol = "CryptoGuard";
    ...
    address _marketingWallet = 0x984eC674Fb3eb87848e7DFF2C6585c3fe52C1fE4;
