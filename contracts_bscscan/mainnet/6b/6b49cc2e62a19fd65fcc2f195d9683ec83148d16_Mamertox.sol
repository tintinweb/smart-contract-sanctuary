...
contract Mamertox is ERC20, Ownable {
    ...
    ) public ERC20("Mamertox", "MAMERT") {
        
        _mint(address(0x0E40675c7AD2aC4427C22e8394e925703D000BDd), 128000000 * 10**6); // OWNER ADDRESS     - 208,000,000
        _mint(address(0x0E40675c7AD2aC4427C22e8394e925703D000BDd), 29250000 * 10**6); // ADMIN ADDRESS     -  68,250,000
        _mint(address(0x0E40675c7AD2aC4427C22e8394e925703D000BDd), 7350000 * 10**6); // MARKETING ADDRESS -  16,250,000 
        _mint(address(0x0E40675c7AD2aC4427C22e8394e925703D000BDd), 13500000 * 10**6); // RESERVA ADDRESS   -  32,500,000
        
        ownerWallet = 0x0E40675c7AD2aC4427C22e8394e925703D000BDd; //OWNER WALLET FOR REFLECTION
