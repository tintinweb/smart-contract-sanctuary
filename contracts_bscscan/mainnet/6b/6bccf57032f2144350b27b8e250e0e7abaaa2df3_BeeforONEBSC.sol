...
/**
   ...
   We will give ONE as reward to holders with draw. It will not be the reflection.
   So there is no dividen function here. 
   
   TAX:
   4% back to holders
   4% back to liq
   2% to the dev wallet (details below)
   
   This 2% tax for the dev wallet will be used for marketing and ONE reward.
   So that 1% of it in marketing;
   1% of it will be used to buy ONE and to give to lucky holders!
   
   More details and launch time in telegram group!
   
   Telegram: https://t.me/BeeforONEBSC
   
   Website, twitter and other socials will be up as we grow!
...
contract BeeforONEBSC is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xA14D30ECc8A5e862ec60645f4574919A711C3E0F;
    ...
    string private _name = "Bee for ONE";
    string private _symbol = "BfONE";
