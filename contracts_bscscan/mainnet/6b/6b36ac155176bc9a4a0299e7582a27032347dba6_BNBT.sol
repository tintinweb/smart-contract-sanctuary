...
contract BNBT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBT";
    string private _symbol = "BNBT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2487a574F0B261eDEE10b9e35575b1E780F14de0); // Marketing Address
    address payable public teamWalletAddress = payable(0x69b486e26A8ca98009276893eDA32E8eC7554e4f); // Team Address
