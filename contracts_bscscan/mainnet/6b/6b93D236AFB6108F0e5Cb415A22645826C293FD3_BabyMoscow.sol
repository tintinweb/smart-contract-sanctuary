...
/**
    ...
    A project that aims to create a renown brand in the cryptoworld.
    Our team seek to achieve our vision and create the biggest  token with multiple usage purposes in the real world.
 
    #BabyMoscow Features:
    
    Telegram : https://t.me/BabyMoscow_Token
 
    10% TRANSACTION FEE
    - 5% fee per transaction gets distributed to holders.
    - 4% fee per transaction gets added to the liquidity pool.
    - 1% fee per transaction gets added to jackpot pool. It will distributed to 10 holders with lottery every week.
*/
...
contract BabyMoscow is Context, IERC20, Ownable {
    ...
    string private _name = "BabyMoscow";
    string private _symbol = "BabyMoscow";
    ...
    address public _jackpotfeewallet = 0xD8dbB13D262328581cd7219280a1c38d1B9B47aE;
    uint256 public _jackpotFeePercent = 1;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _jackpotFeePercent == 0) return;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if (_jackpotFeePercent != 0) {
            jackpotFeeAmount = rAmount / (100 / _jackpotFeePercent);
        } else {
            jackpotFeeAmount = 0;
        }
