...
// File contracts/SquidGameInuFloki.sol

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;
contract SquidGameInuFloki is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0x0000000000000000000000000000000000000000);
    ...
    constructor() ERC20("SquidGameInuFloki", "SGIF") {
        ...
        uint256 totalSupply = 1 * 1e8 * 1e18; // 100 Millions
        
        maxTransactionAmount = totalSupply * 100 / 100; //maxTransactionAmountTxn
        swapTokensAtAmount = 10000 * 1e18; //transaction
        maxWallet = totalSupply * 100 / 100; //max wallet
    	...
    	marketingWallet = 0xa525490608B3A50C45c869C1Fd4c85CE9FD7DC90; // set as marketing wallet
    	buyBackWallet = 0xa525490608B3A50C45c869C1Fd4c85CE9FD7DC90; // set as buyback wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(newOwner, true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0x0000000000000000000000000000000000000000), true);
        ...
        excludeFromMaxTransaction(address(0x0000000000000000000000000000000000000000), true);
