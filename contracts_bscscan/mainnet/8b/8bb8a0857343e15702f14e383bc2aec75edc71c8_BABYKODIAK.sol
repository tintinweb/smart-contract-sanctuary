...
// CHANGE
contract BABYKODIAK is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BABY KODIAK";
    string constant _symbol = "BABYKODIAK";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x410034B5BBef6DB1c95709887041Ce42033bDd62);
