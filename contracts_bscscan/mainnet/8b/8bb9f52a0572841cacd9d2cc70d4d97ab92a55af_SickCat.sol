...
/**
  Super Stealth Reward token for the love of god let's go! 
  Telegram will be created in an hour.
  Slippage is 12-20%
...
contract SickCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SickCat";
    string constant _symbol = "SACO";
