...
/*
 ...
 - Total Supply: 100,000,000 $LTDOGE
 - Burn 50,000,000 $LTDOGE
 - 3% Dev Wallet (2% DEV - 1% Team)

 We Create This Token With Anti Whale System
 - Max Buy / Sell 1,000,000 $FRISE
 - Max Hold Per Wallet: 3,000,000 $FRISE

 Renounce Ownership
 Burn 100% LP to Dead Wallet
...
contract LIMITEDDOGE is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10 * 10**7 * 10**9; // 100 Million Total Supply
    ...
    uint256 public _maxTxAmount = 10 * 10**5 * 10**9; // Max Transaction: 1,000,000 (1%)
    ...
    uint256 public _maxWalletToken = 30 * 10**5 * 10**9; // Max Wallet: 3,000,000 (3%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'Limited Doge';
