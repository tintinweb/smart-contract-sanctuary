...
Locked Will Be locked
Buy fee : 6%
Sell Fee 8%
telegram = https://t.me/SmeagolInu
*/
...
/* Token contract */
contract SmeagolInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Smeagol Inu";
    string constant _symbol = "SmeagolInu";
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 10000; // 400.000 tokens or 0.04% of supply
