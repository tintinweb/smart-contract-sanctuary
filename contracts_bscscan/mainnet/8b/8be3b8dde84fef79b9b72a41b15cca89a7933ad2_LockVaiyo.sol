...
contract LockVaiyo is Ownable {
    ...
    function deposit() public payable {
        require(getBUSDAmount(msg.value) >= minDepositAmount, "Mimumn amount is 2.5BUSD");
    ...
    function read(address add) public view returns(uint256, uint256, bool) {
        ...
        return (tokenamount, deposittime, checkTime(add));
    }
    ...
    function claimTokens() public {
        ...
        uint256 usdAmount = getBUSDAmount(deposits[msg.sender]);
