...
/**
 * @title $Mask ERC20 token
 * @dev
 *      Based on the Ampleforth & Safemoon protocol.
 */
contract $Mask is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**8 * 8**DECIMALS;
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("MetaMask", "$MASK", uint8(DECIMALS))
        payable
        public
    {
