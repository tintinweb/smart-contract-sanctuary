...
LINKS:
https://Unique.io/
https://twitter.com/UniqueBSC
https://www.facebook.com/UniqueBSC
https://t.me/UniqueBSC
 */
...
contract Unique is IBEP20 {
    ...
    string public override name = "Unique";
    string public override symbol = "UNI";
    ...
    constructor(uint totalSupplyValue, address YooshiAddress, address GameAddress, address SHIBAAddress) {
        ...
        balances[Yooshi] =  totalSupply * 2 / 100;
        balances[Game] = totalSupply * 46 / 100;
