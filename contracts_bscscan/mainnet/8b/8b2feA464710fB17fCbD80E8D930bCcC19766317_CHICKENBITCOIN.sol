...
/**
 * TELEGRAM: T.ME/CHICKENBITCOIN
 * WEBSITE : WWW.CHICKENBITCOIN.ML 
 * 9% CAKE REWARD 
 * 4% LIQUIDITY 
 * 1% MARKETING 
 * LAUNCHING NOW
...
contract CHICKENBITCOIN is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CHICKENBITCOIN";
    string constant _symbol = "CBTC";
