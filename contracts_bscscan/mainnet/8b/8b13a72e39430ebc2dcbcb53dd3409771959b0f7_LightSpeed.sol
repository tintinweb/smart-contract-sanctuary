...
/**
 LightSpeed - is a deflationary token that will pump with a speed of light
*/
...
contract LightSpeed is Context, IERC20, Ownable {
    ...
    string private _name = "LightSpeed";
    string private _symbol = "LTSP";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xDdC2256DC1a7cE2cC50970EcaB9756F72C49f571);
    ...
    constructor () {
        ...
        _maxBalance = 15000 * 10**9 * 10**_decimals;
