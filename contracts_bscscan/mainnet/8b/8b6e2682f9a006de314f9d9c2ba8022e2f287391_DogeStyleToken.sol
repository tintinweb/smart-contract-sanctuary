...
Dogestyle is a decentralized Meme Token that became part of a powerful and vibrant ecosystem, 
hyper deflationary token built on the BSC network and inspired by the community. 
With the latest instant yield generation built inside this token, 
holders can generate yield just by holding the token in their wallet, without any further action required.
...
‼️‼️ Use slippage 12%‼️‼️

🌐 Telegram
https://t.me/Dogestyleetoken
...
contract DogeStyleToken is Context, IERC20, Ownable, Pausable {
