...
/**
 * TELEGRAM: HTTPS://T.ME/SuperCake
 * Website : soon
 * REWARD
 * 9% CAKE REWARD - 4% LIQUIDITY - 1% MARKETING
 * TOKENOMICS
 * 50% BURN - 48% LIQUIDITY - 2% MARKETING WALLET
 * NO DEV WALLET
*/
...
contract SuperCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SuperCake";
    string constant _symbol = "SuperCake";
