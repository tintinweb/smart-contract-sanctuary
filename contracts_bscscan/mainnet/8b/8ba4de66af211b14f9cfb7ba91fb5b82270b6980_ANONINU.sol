...
/* contacts let = "name ANONINU" id =1000000000000000 
getAmountOut(ANONINU)
...
// File: contracts\ANONINU.sol

contract ANONINU is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "ANONINU";
