...
contract WingsOfVictory is Authorized, ERC20 {
  address constant DEAD = 0x000000000000000000000000000000000000dEaD;
  address constant ZERO = 0x0000000000000000000000000000000000000000;
  address constant BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
  address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

  string constant _name = "Wings of Victory";
  string constant _symbol = "WOV";

  // Token supply control
  uint8 constant decimal = 18;
  uint8 constant decimalBUSD = 18;  
  uint256 constant maxSupply = 650_000_000 * (10 ** decimal); 
  ...
  // Fees
  uint256 public feeAdministrationWallet = 1000; // 10%
  ...
  constructor()ERC20(_name, _symbol) {
    ...
    administrationWallet = 0x0cE5de07D98F89160aa324102bE02f274C406032;
