...
contract PunkFinanceToken is Context, IBEP20, Ownable {
    ...
    address private _treasuryWalletAddress = 0x9130a4C072F8505D948Be70058b40632EfF48224;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        // Calculate burn + treasury amount
        ...
        //Temporarily remove fees to transfer to burn and treasury address
        _taxFee = 0;
        _liquidityFee = 0;

        // Send transfers to burn + treasury
        _transferStandard(sender, address(0), burnAmt);
        _transferStandard(sender, address(_treasuryWalletAddress), treasuryAmt);
