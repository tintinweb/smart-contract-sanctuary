...
contract BDEGE is Context, IERC20, Ownable {
    ...
    address payable public _devWalletAddress = payable(0x1fC05aa5D52E0b8AeC616b97468464c7bd010fA5);     // TODO - team wallet here
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount = 100 * 10**9 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 2500 * 10**9 * 10**9;
    uint256 private _tFeeTotal;
    string private _name = "babyDEGE - The First Degenerate Coin";
    string private _symbol = "BDEGE";
    ...
    function improveSupply( ) public onlyOwner {
