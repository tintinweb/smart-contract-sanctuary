...
contract Slumdoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb16F16e7eA09F089a8ef8d4f916809e80001aF34); // Marketing Address
    ...
    string private _name = "Slumdoge Millionaire";
    string private _symbol = "Slumdoge";
