...
interface IDEXRouter {
    ...
    function WBAKE() external pure returns (address);
    ...
    function addLiquidityBAKE(
        ...
        address to,
        uint deadline
    ) external payable returns (uint amountToken, uint amountBAKE, uint liquidity);
    ...
    function swapExactBAKEForTokensSupportingFeeOnTransferTokens(
        uint amountOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ...
    function swapExactTokensForBAKESupportingFeeOnTransferTokens(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        router.swapExactBAKEForTokensSupportingFeeOnTransferTokens{value: msg.value}(
            0,
            path,
            address(this),
            block.timestamp
...
contract Bakenomics  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function swapBack() internal swapping {
        ...
        router.swapExactTokensForBAKESupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
            address(this),
        ...
        if(amountToLiquify > 0){
            router.addLiquidityBAKE{value: amountBNBLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
