...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DZ = IBEP20(0xBDaa094a95e452c6bA175cE9EdfeFBa04e6a51Ac);
...
contract BabySafeOHM is IBEP20, Auth {
    using SafeMath for uint256;

    address DZ = 0xBDaa094a95e452c6bA175cE9EdfeFBa04e6a51Ac;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabySafeOHM";
    string constant _symbol = "BSOHM";
