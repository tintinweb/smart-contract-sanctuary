...
contract GhostShiba is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ghost Shiba", "GSHIBA") {
    	...
    	marketingWallet = address(0x42aaBd1018b551bafAAfe358228250d6077049E1); // set as marketing wallet
