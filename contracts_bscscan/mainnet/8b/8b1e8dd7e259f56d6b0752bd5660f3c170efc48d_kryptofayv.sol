...
contract kryptofayv is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 public minMxWalletPercentage = 10;     // The maximum supply % that a wallet can hold (1-100). Anti-Whale mechanics
