...
/**
  TG : @BabyDogeArtist Stealth Fairlaunch at 50 Member
*/
...
contract BabyDogeArtist is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Doge Artist";
    string private _symbol = "BDA";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0; // Manually adjust prior to renouncing...
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 15; // Manually adjust prior to renouncing...
