...
/**                                                                                                                                                                                                                                                                                                                                                                                                               
https://t/me/NewYearBullishOfficial                                                               
*/
...
contract NewYearBullish is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "NewYearBullish";
    string constant _symbol = "NY BULLISH";
    uint8 constant _decimals = 9;
    address private marketingFeeReceiver = 0x381fB769Cb20318B11720C2509B7100c927FE474;
    address private buybackFeeReceiver = 0x381fB769Cb20318B11720C2509B7100c927FE474;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function feeyourbae(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
