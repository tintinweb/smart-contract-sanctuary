...
//   _______    ______    ______   __       __        __    __  ______  ________  ________  __      __ 
//  |       \  /      \  /      \ |  \     /  \      |  \  /  \|      \|        \|        \|  \    /  \
//  | $$$$$$$\|  $$$$$$\|  $$$$$$\| $$\   /  $$      | $$ /  $$ \$$$$$$ \$$$$$$$$ \$$$$$$$$ \$$\  /  $$
//  | $$__/ $$| $$  | $$| $$  | $$| $$$\ /  $$$      | $$/  $$   | $$     | $$      | $$     \$$\/  $$ 
//  | $$    $$| $$  | $$| $$  | $$| $$$$\  $$$$      | $$  $$    | $$     | $$      | $$      \$$  $$  
...
// Website:     https://boomkittybsc.com
// Telegram:    https://t.me/boomkittybsc
...
contract BoomKitty  is Context, IERC20, Ownable {
    ...
    string private _name = "Boom Kitty";
    string private _symbol = "BOOMKITTY";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 6; //(2% liquidityAddition + 2% marketing  + 2% Development)
    uint256 private _previousLiquidityFee = _liquidityFee;
    

    //No limit
    uint256 public _maxTxAmount = 5000000 * 10**9;
    uint256 public _maxWtAmount = 10000000 * 10**9;
    ...
    constructor () public {
        ...
        marketingWallet = payable(0x8403a69420adc130B78E28684e4AD66f2343e526);
        developmentWallet = payable(0x802C689D90aAEcd1b09660d8dE1AcA3c3aa3b2D2);
    ...
    function _transfer(
        ...
        if(limit == true && from != owner() && to != owner() && to != burnAddress){
            if(to != uniswapPair && from == uniswapPair){
                require(((balanceOf(to).add(amount)) <= _maxWtAmount));
            }
            require(amount <= _maxWtAmount, 'Transfer amount must be less');
            }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        developmentWallet.transfer(oneThird);
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
         require(maxTxPercent <= 40, "Maximum tax limit is 40 percent");
        _maxTxAmount = _tTotal.mul(maxTxPercent).div(10**2);
        _maxWtAmount = 2 * _maxTxAmount;
    }
