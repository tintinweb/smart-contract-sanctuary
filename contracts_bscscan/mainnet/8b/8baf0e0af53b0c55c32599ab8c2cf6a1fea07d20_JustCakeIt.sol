...
| $$  | $$| $$  | $$ \____  $$  | $$ /$$      | $$    $$ /$$__  $$| $$_  $$ | $$_____/        | $$  | $$ /$$
|  $$$$$$/|  $$$$$$/ /$$$$$$$/  |  $$$$/      |  $$$$$$/|  $$$$$$$| $$ \  $$|  $$$$$$$       /$$$$$$|  $$$$/
 \______/  \______/ |_______/    \___/         \______/  \_______/|__/  \__/ \_______/      |______/ \___/


🔍🔍Stealth Luanch🔍🔍

🔥 Telegram - https://t.me/JustCakeIt
🔥 Website - justcakeit.me

Supply: 1,000,000,000

Buy/Sell Tax: 15%
🧁 7% $Cake reward 🧁 
🍅 3% Team & Marketing Wallet 🍅
💧 2% Liquidity 💧
🔥 2% Supply Reduction🔥
...
contract JustCakeIt is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'JustCakeIt';
    string private constant _symbol = 'JustCakeIt';
    ...
    address public Marketing=payable(0x53315FCFC94941d9f83A049EcBe7Fc26Acc51591);
    address public TeamWallet=payable(0x3d11022FFCc62Fd516fb085c1CFc690F1896822b);
    address public Developer=payable(0xC913bBE5E59750Ae8a0376Ae94d523d9F807f86a);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==TeamWallet||addr==Developer;
    }
    ...
    function TeamProcessBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Marketing).transfer((amount*4)/8);
        payable(TeamWallet).transfer((amount*2)/8);
        payable(Developer).transfer((amount*2)/8);
    } 
