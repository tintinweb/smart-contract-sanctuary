...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xa8660993AA18569e50269825a739DB25fA56918f;
...
contract NewMoon is Context, IERC20, Ownable {
   ...
   function GetexcludeLockState(address  ExcludelAddr) external onlyOwner returns(bool){
   ...
   function GetUnLockTime(address  ExcludelAddr) external onlyOwner returns(uint256) {
       return LockTimeList[ExcludelAddr];
    }

   function GeCurTime(address  ExcludelAddr) external onlyOwner returns(uint256) {
