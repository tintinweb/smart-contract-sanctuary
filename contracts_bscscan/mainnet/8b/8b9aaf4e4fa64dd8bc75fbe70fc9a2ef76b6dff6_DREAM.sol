...
/**
   ...
   I make this #DREAM to hand over it to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #DREAM to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool

   1,000,000,000,000,000 total supply
   10,000,000,000,000 tokens limitation for trade
   0 tokens for dev

   6% fee for liquidity will go to an address that the contract creates, 
   and the contract will sell it and add to liquidity automatically, increasing the liquidity pool automatically,
