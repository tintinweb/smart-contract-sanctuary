...
// Begin sauce.
contract UNIASS is Context, IERC20, Ownable {
    ...
    address payable public _wallet_marketing = payable(0x9484Db7A6D60F236f70a08ebB0c94725e3bB9312);

    // for burn
    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0x58A622f0861F0a39d69988dfe556F55dAd241e0c);

    // for development, however labeled as "buyback"
    uint256 public _fee_buyback = 0;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0x4259b48Ede78DDe5f3cAa936A4052BC8B342B13e);
    ...
    address deadAddress = 0x58A622f0861F0a39d69988dfe556F55dAd241e0c;
