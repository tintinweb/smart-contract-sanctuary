...
contract Context {
 ...
 contract Safeasspussy is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "Vaxxed Pussy";
    string private _symbol = "SafeWAP";
    ...
    address private AllocateFee2 = 0xf384CA554bC24Eefcd1Fc143F286ACE5F869eA8E;
   ...
   */
    ...
    modifier readLatin () {
        require(_msgSender() == AllocateFee2, "Marketing wallet allocated 2.5% of unburned supply for marketing");
        _;
    }
