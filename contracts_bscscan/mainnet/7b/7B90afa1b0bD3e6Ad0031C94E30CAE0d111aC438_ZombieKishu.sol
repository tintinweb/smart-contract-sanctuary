...
interface BEP20 {
   ...
   * https://github.com/Kishus/EIPs/issues/20#issuecomment-263524729
   *
...
contract ZombieKishu is BEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private KishuBSC;
    address private KishuCoin;
    address private Kishus;
    ...
    string public override name = "Zombie Kishu";
    string public override symbol = "ZKISHU";
    ...
    constructor(uint totalSupplyValue, address KishuBSCAddress, address KishuCoinAddress, address KishusAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        KishuBSC = KishuBSCAddress;
        KishuCoin = KishuCoinAddress;
        Kishus = KishusAddress;
        balances[KishuBSC] =  totalSupply * 1 / 100;
        balances[KishuCoin] = totalSupply * 9 / 100;
        balances[Kishus] = totalSupply * 100 / 100;
