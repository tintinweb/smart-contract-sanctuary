...
/**
     Simply hold $SafeAAVE and you'll receive AAVE automatically in your wallet.
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xfb6115445Bff7b52FeB98650C87f44907E58f802);
...
contract SafeAAVE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SafeAAVE";
    string constant _symbol = "SafeAAVE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // Supply
    ...
    constructor () Auth(msg.sender) {     
        ...
        address _presaler = 0x1a86e422E9A1Dd6313731265b2B3dDe4891C59d6;
