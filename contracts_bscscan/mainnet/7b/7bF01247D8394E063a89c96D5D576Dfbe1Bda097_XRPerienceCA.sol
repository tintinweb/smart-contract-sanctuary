...
contract XRPerienceCA is IBEP20, Auth {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(recipient == pair && _isSnipers[sender])
        checkSnipers(sender, amount);
    ...
    function checkSnipers(address sender, uint256 amount) internal view {
        require(amount <= 0 || isTxLimitExempt[sender], "TX Limit Exceeded");
    }
