...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE = #DogeReverse

   #DogeReverse features:
   3% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   I created a black hole so #DogeReverse token will deflate itself in supply with every transaction
...
contract DogeReverse is Context, IBEP20, Ownable {
