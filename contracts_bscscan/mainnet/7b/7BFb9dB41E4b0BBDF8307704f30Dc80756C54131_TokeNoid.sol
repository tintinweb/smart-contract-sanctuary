...
TOKENOID, developing some games using the blockchain technology 
for their transactions. more games, more utilities for NOID. 
The best way to make money is by playing games.

 * https://tokenoid.io/
 * https://twitter.com/NoidToken
 * https://t.me/TokeNOIDOfficial_Chat
 * https://github.com/TokeNOID/TokeNOID
 * https://www.instagram.com/tokenoid.studio/
 * https://discord.com/invite/c8yFxYjmNX
*/
...
contract           TokeNoid                                                                 is ERC20 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC20("$Noid", "$Noid") {
