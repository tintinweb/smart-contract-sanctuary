...
contract girlchikuinu is Context, IBEP20, Ownable {
    using SafeMath for uint256;
	uint8 private decqkdiixlojcsb = 18;
	uint256 private totlqxjorcakdtie = 30000000 * 10 ** decqkdiixlojcsb;
	uint8 internal _sta = 3;
	mapping (address => uint256) private selbgadnahemozktiop;
	string private constant nambixqekienal = "$GirlChikuInu";
	string private constant symwaoefitszcykroiglxedbnqjamph = "$GirlChiku";
