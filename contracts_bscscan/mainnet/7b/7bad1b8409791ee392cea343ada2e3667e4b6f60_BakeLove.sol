...
/**
 * MamaBAKE - Mama's sweet BAKEs bring all the boys to the yard!
 * 10% BAKE REWARDS, 5% MARKETING + EXTRA 5% to LIQUIDITY on SELLS
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BAKE = IBEP20(0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5);
    ...
    event Deposit(uint256 amountBNB, uint256 amountBAKE);
...
contract BakeLove is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BakeLove";
    string constant _symbol = "BAKL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 100 mil
    uint256 public _maxTxAmount = _totalSupply / 10; //10 mil 10% 
