...
/**
   ...
   Welcome to LittleBabyPolygon
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyPolygonBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyPolygon to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyPolygon idea, increasing the liquidity pool automatically, 
...
contract LittleBabyPolygon is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby Polygon";
    string private _symbol = "LTBABYPOLYGON";
