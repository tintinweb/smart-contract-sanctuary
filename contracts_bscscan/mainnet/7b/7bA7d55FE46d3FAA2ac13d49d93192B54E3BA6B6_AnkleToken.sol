...
Ankle Token Finna Break out on BSC

TG: https://t.me/ankletoken
...
contract AnkleToken is Context, IERC20, Ownable {
    ...
    address payable private _medicAddress = 0x9616740731befe97eA24e8F5Cd900382BAf96669;
    ...
    string private _name = "Ankle Token";
    string private _symbol = "ANKLE";
    ...
    event DonateToMedic(uint256 bnbDonated);
    ...
    constructor () public {
        ...
        _isExcludedFromFee[_medicAddress] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // 1/2 balance is sent to the medic wallet, 1/2 is added to the liquidity pool
        uint256 medicTokenBalance = contractTokenBalance.div(2);
        uint256 liquidityTokenBalance = contractTokenBalance.sub(medicTokenBalance);
        ...
        uint256 tokensToSwapToBNB = tokenBalanceToLiquifyAsBNB.add(medicTokenBalance);
        ...
        // The remaining BNB balance is to be donated to the medic wallet
        uint256 medicBNBToDonate = bnbSwapped.sub(bnbToLiquify);

        // Transfer the BNB to the medic wallet
        _medicAddress.transfer(medicBNBToDonate);
        emit DonateToMedic(medicBNBToDonate);
    }
