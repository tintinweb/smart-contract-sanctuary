...
contract HolaHopV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xBA1917BbB886A7Ff095a655B02aCa212bD766C3E); // Marketing Address
    ...
    string private _name = "HolaHopV2";
    string private _symbol = "HolaHopV2";
    ...
    uint256 public marketingDivisor = 50; // marketing fee
    
    uint256 private maxTxPercent = 2; // MAXTX 
    ...
    // MAX Wallet amount is 4% of the total supply, except for deadAddress
    uint256 private maxWalletPercent = 4;
    ...
    uint256 public buyBackSellLimit = 1 * 100**1;
