...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Grisbee";
    string public constant TOKEN_SYMBOL = "GRSB";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x2821b6DB235a1CAF204Fb16508fB122488F3C6ba;
    ...
    
{
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x2821b6db235a1caf204fb16508fb122488f3c6ba)];
        uint[1] memory amounts = [uint(20000000000000000)];
