...
contract ElonFLOPS is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**9 * 10**9; //billions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ElonFLOPS";
    string private _symbol = "FLOPS";
    ...
    address public devWallet = 0x34b57678A7442e270A735d4f84629dEC9dB9e4A7; 
    ...
    uint256 public _maxTxAmount = 2 * 10**9 * 10**9; //2%
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 5 * 10**9 * 10**9; //5%
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //v2  //mainnet
