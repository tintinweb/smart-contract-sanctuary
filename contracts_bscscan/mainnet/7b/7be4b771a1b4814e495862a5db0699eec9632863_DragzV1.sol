...
//_______  .______          ___       _______  ________     .___________.  ______    __  ___  _______ .__   __.
//|       \ |   _  \        /   \     /  _____||       /     |           | /  __  \  |  |/  / |   ____||  \ |  |
//|  .--.  ||  |_)  |      /  ^  \   |  |  __  `---/  /      `---|  |----`|  |  |  | |  '  /  |  |__   |   \|  |
//|  |  |  ||      /      /  /_\  \  |  | |_ |    /  /           |  |     |  |  |  | |    <   |   __|  |  . `  |
//|  '--'  ||  |\  \----./  _____  \ |  |__| |   /  /----.       |  |     |  `--'  | |  .  \  |  |____ |  |\   |
//|_______/ | _| `._____/__/     \__\ \______|  /________|       |__|      \______/  |__|\__\ |_______||__| \__|


/**
 * Dragz Token v0.0.1
 * The beginning of the journey
 * This contract uses a proxy so that we can add functionality depending on the phase of the roadmap
 * Watchdogs will be implemented along the way which will be very clear in the next versions of the smart contracts
 */
contract DragzV1 is ERC20PresetMinterPauserUpgradeable {
    uint256 public max_supply;
    uint256 public constant _totalSupply = 21000000000;

    using SafeMathUpgradeable for uint256;

    // As you can see, we will implement these in some way
    uint256 public reflection_fee;
    uint256 public liquidity_fee;
    uint256 public burn_fee;
    uint256 public project_development_fee;

    mapping (address => bool) private _isExcluded;

    /**
     * @notice Initialize Dragz Token
     */
    function initializeDragz() public initializer {
        ERC20PresetMinterPauserUpgradeable.initialize("Dragz Token", "DRAGZ");
    }
}
