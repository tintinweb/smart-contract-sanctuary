...
/*
* Welcome to Safe Doctor Doge
* 50% Token Burned
* LP Burn forever
* Safe Doctor Doge will burn 3% every transaction
* 2% reward to holders
*/
...
contract SafeDoctorDoge is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "Safe Doctor Doge";
        _symbol = "SAFEDOCTORDOGE";
