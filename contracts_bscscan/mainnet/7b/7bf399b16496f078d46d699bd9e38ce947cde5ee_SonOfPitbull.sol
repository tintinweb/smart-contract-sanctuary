...
contract SonOfPitbull is Context, IBEP20, Ownable {
    ...
    string public constant name     = "SonOfPitbull";
    string public constant symbol   = "SOP";
    ...
    uint256 public _maxTxAmount     = _tTotal / 3;
