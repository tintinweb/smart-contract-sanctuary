...
Contract forked directly from DogeX
Telegram : @shibax_bsc
*/
...
contract SHIBAX is Context, IERC20, IERC20Extented, Ownable {
    ...
    address payable constant private _marketingAddress = payable(0x8691A5Fb1cb900B82E52B52190BC28a2F92f3b19);
    address payable constant private _buybackAddress = payable(0xE5A6Cb1Da587855620778f912826B2929693Dd83);
    address payable constant private _projectMaintainence = payable(0xFDFFE0d14610B18a2Ca25368F66353aC715F8105);
