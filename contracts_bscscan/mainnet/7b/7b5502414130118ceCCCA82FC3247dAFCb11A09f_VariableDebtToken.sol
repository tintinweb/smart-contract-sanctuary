...
contract VariableDebtToken is DebtTokenBase, IVariableDebtToken {
  ...
  uint256 public constant DEBT_TOKEN_REVISION = 0x7;
  ...
  function setNewIncentive(
    address newIncentive
  ) public {
    _setIncentive(newIncentive);
  }
...
contract IncentivizedERC20 is Context, IERC20, IERC20Detailed {
  ...
  // /**
  //  * @return The incentive of the token
  //  **/
  // function incentive() public view override returns (uint8) {
  ...
  function _setIncentive(address newIncentive) internal {
    if (address(_incentivesController) == address(0)) {
      _incentivesController = IAaveIncentivesController(newIncentive);
    }
  }
