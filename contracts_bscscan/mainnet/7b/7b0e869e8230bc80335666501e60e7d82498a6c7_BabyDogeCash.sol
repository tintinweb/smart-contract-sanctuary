...
// Telegram  https://t.me/BabyDogeCash
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ADA = IERC20(0x62175af6D9B045D8435CDeDd9Bf542c7bcc56dCC);
...
// CHANGE
contract BabyDogeCash  is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address ADA = 0x62175af6D9B045D8435CDeDd9Bf542c7bcc56dCC;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyDogeCash";
    string constant _symbol = "BDC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 2% MAX 200,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 2% MAX 200,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x52a5a843e686252cE563b6e1f81d08aF7587fa4d); // Change
