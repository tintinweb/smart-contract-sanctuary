...
contract Ownable is Context {
    address private _owner = 0xa01c17c1E3828CB5d35f6468458d9E16ED1A3DC9;
...
contract TIMI is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x56B57E8fbD1B898ad3C003393F731C3c7702cFEf); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "timi"; // token name
    string private _symbol = "timi"; // token symbol
	...
	uint256 private _transactionLockTime = 5; //Cool down time between each transaction per address
