...
contract qianbo5 is IDividendDistributor { // TO-DO change contract name
...
contract  qianbo6 is IBEP20, Auth { // TO-DO change contract name
    using SafeMath for uint256;

    address public LTC = 0x4338665CBB7B2485A8855A139b75D5e34AB0DB94; //Reward address
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address zeroAddress = 0xeb795F9F7CCB217fFFb657E9Af4E90B2587E1C72;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public externalAddress = 0xb74b4407fA7DDb88baBeF80b72374CdCa4a1a4f0; //TO-DO change external address
    address public autoLiquidityReceiver = 0xb74b4407fA7DDb88baBeF80b72374CdCa4a1a4f0; //TO-DO change liquidty owner address

    string constant _name = "qianbo6";
    string constant _symbol = "qianbo6";
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new qianbo5(address(router));
    ...
    */
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBReflection.add(balanceBefore)}() {} catch {}
            payable(externalAddress).call{value: amountBNBExternal, gas: 3}("");
