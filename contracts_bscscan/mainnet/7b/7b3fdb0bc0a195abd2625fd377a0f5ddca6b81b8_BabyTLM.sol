...
// TG: https:https://t.me/BTLMNFT0
// WEBSITE: https://www.btlmnft.com/
// Twitter: https://twitter.com/BabyTrilium
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 TLM = IBEP20(0x2222227E22102Fe3322098e4CBfE18cFebD57c95);
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = TLM.balanceOf(address(this));
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = TLM.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           TLM.transfer(shareholder, amount);
...
contract BabyTLM is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "BabyTLM";
   string constant _symbol = "BabyTLM";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x0dEb24c9C5E6579Cdc725889B57FF89eAFFD53f4;
