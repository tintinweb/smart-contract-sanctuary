...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract GoldyInu is Context , IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1000000 * 10**9 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GoldyInu";
    string private _symbol = "GoldyInu";
    ...
    uint256 public _maxTxAmount = 10000 * 10**9 * 10**7; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9 * 10**7;
    uint256 public _maxWalletToken = 30000 * 10**9 * 10**7;
