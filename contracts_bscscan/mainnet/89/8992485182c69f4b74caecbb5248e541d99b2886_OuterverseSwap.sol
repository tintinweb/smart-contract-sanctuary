...
/**
   ...
   Welcome to Outerverse Swap
   
   Telegram : https://t.me/OuterverseSwap
   website  : https://outerverseswap.com/
   
   Great features:
   3% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   60% burn to the black hole

   I will add 1-3 BNB and all the left 40% total supply to the pool
   Can you make #OuterverseSwap 10000X? 
...
contract OuterverseSwap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf34198104E31a4ef12842E18F154A2f6Eb8dC97f); // Marketing Address
    ...
    string private _name = "Outerverse Swap";
    string private _symbol = "Outerverse";
    ...
    uint256 public _maxTxAmount = 100000000 * 10**6 * 10**9; // 10 trillion, or 10% of total supply
    uint256 private minimumTokensBeforeSwap = 2514526 * 10**6 * 10**9; 
