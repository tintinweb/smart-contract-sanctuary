...
/* contacts let = "name taothao" id =1000000000000000 
getAmountOut(taothao)
...
// File: contracts\taothao.sol

contract TAOTHAO is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "TAOTHAO";
	string private constant _symbol = "TAOTHAO";
	...
	// BUYBACK
	address payable private constant _buybackAddress = payable(0x04c259A8462a0c8Da970Ef72130eDECC72Fa5856); // A percentage of the BNB pool will go to the charity address
	...
	// TEAM
	address payable private constant _teamAddress = payable(0x04c259A8462a0c8Da970Ef72130eDECC72Fa5856);
