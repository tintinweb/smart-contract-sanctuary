...
contract PuangAjiSyarif is Context, IERC20, Ownable { 
    ...
    string private _name = "PuangAjiSyarif"; 
    string private _symbol = "PAS"; 
    ...
    address public devWallet = 0x6B6B51d03e11afBCaF7b600C27C2aa85CfF1bBb6; 
    ...
    uint256 public _maxTxAmount = 1 * 10**13 * 10**9; //none 
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**12 * 10**9; 
    uint256 public _maxWalletToken = 3 * 10**13 * 10**9; 
