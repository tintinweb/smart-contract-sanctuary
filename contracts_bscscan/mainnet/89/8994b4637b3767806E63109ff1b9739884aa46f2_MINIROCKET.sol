...
MINIROCKET is a token designed to promote the latest innovations, With the buyback feature, every 8% of sales transactions we aim to stabilize the token price.
...
contract MINIROCKET is Context, IERC20, Ownable {
