...
Welcome to ReturnToMonke 

10% Rewards in Banana 
4% Marketing fee auto converted in bnb 
4% Back to Liquidity 
5M Max Transaction (START)
20M Max Wallet (START)
cooldown between buys 20 seconds (start)
t.me/bananasplitbsc
 * 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 0.15 * (10 ** 18);
...
contract BananaSplit is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ReturnToMonke";
    string constant _symbol = "MONKE";
    uint8 constant _decimals = 10;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 5 / 10000000000;
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xbc8103f3b4e7A4eAffC28a9737b01D25a071a12D;  
        ...
        // NICE!
        autoLiquidityReceiver = 0xB8b24a04399C9609C796022E5a1362FeFbF67fFB;
