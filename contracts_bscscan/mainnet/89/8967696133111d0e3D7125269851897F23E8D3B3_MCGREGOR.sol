...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SAFU = IERC20(0x890cc7d14948478c98A6CD7F511E1f7f7f99F397);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SAFU.balanceOf(address(this));
        ...
        uint256 amount = SAFU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SAFU.transfer(shareholder, amount);
...
// CHANGE
contract MCGREGOR is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address SAFU = 0x890cc7d14948478c98A6CD7F511E1f7f7f99F397;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MCGREGOR";
    string constant _symbol = "MCGREGOR";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 0.5% MAX 5,000,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 1% MAX 10,000,000
    ...
    uint256 liquidityFee = 400; // 2%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; // 8%
    uint256 devFee = 2000; // 2%
    uint256 totalFee = 2400; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x9Cbe0C6306426523B63Eb43EBD392Cbb8AA20002);
