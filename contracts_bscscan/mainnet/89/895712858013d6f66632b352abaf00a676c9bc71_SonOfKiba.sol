...
// CHANGE
contract SonOfKiba is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Son Of Kiba";
    string constant _symbol = "SoKiba";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 2% MAX 40,000,000
