...
// https://mi4.space prepare for liftoff!
// https://t.me/mi4bsc 
...
contract Mi4 is ERC20, Ownable {
	...
	uint256 public _maxWalletAmount = 10000000000 * (10 ** 18); // 1% circulating supply
	...
	constructor(address routerAddress, address payable marketingWalletAddress, address payable devWalletAddress) public ERC20("mISPN4", "Mi4") {
		...
		// set default fees (dividends, marketing, liquidity, developer)
		setBuyFees(4, 2, 2, 2);
		setSellFees(6, 5, 4, 2);
...
contract Inspiration4DividendTracker is Ownable, DividendPayingToken {
	...
	uint256 public immutable minimumTokenBalanceForDividends = 100000 * (10 ** 18);
