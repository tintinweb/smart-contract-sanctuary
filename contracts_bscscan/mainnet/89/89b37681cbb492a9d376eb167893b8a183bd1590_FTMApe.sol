...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xAD29AbB318791D579433D831ed122aFeAf29dcfe); //BUSD contract address
...
contract FTMApe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FTMApe";
    string constant _symbol = "FMAPE";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xAD29AbB318791D579433D831ed122aFeAf29dcfe;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = _totalSupply * 30 / 1000; // 3% of total supply.
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x83033C6a281160Af5E120deD89f1B848CA393319; //Where the 5% marketing fee will be sent
