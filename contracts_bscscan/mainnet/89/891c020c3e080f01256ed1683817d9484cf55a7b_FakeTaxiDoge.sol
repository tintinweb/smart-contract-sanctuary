...
/**
 * TG: https://t.me/FakeTaxiDoge
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * FakeTaxiDoge gathers FakeTaxiDoge and delivers direct to your wallet!!!!
*/
...
contract FakeTaxiDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FakeTaxiDoge";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x5d00e60DF3dFac937B75066aa24808acCbc1C98D;
