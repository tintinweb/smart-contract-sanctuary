...
contract SandShiba is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 10000000000000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 10 * 10 ** 9;
    uint256 MAX_LOCK   = 10000000000 * 10 ** 9;
    ...
    // Transfer fee
    uint256 public sellFeeRate = 49;
    uint256 public buyFeeRate = 15;


    constructor() ERC20("SandShiba", "SANDSH") {
        addressForMarketing =address(0xE266FAc2527842a6Dfb88F9B3a3dEBa91C4Ed31e);
