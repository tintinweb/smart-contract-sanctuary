...
/**
   ...
   Welcome to MiniPolkadot
   
   This is a community token. If you want to create a telegram I suggest to name it to @MiniPolkadot
   ...
   I will renounce the ownership to burn addresses to transfer #MiniPolkadot to the community, make sure it's 100% safe.
   ...
   it's the best part of the #MiniPolkadot idea, increasing the liquidity pool automatically, 
