...
contract safeBNB is Context, IERC20, Ownable {
    ...
    string private _symbol = "safeBNB";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xce91f03c420bB81FE02091355D114584545FC8ca);
    ...
    uint256 private constant _maxFees = 1;
