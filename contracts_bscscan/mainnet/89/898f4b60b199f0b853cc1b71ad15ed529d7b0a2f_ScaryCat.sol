...
/**
    ...
    10% of each transaction to the dev wallet
...
contract ScaryCat is Context, IBEP20, Ownable {
    ...
    string private _name     = "Scary Cat";
    ...
    uint256 private _minTokenBalance = 8000 * 10**9;
