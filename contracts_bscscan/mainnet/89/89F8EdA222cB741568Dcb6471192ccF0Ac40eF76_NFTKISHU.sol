...
// https://t.me/NftKishu
  // No Presale
  // LP token will burn just after launch
...
contract NFTKISHU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NFT Kishu";
    string constant _symbol = "$NFTK";
    ...
    uint256 public swapThreshold = _totalSupply * 394 / 100000; // 0.3% of supply
    bool inSwap;
