...
contract ShibaDealer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaDealer";
    string constant _symbol = "SHIBADEALER";
    ...
    require(multiplier <= 5 && multiplier * totalFee <= 4900, "Multiplier too high");
