...
contract Ownable is Context {
    ...
    constructor()  {
        ...
        _owner =0xEd6a41B7203eE3C934E91b10a963fe344767950e; //0x30Fd3F75FE330d06A7Ab8E91836BD7727ead35DC;
...
contract newtest is Context, IERC20, Ownable {
    ...
    uint256 public _foundersFee  = 300; 
    ...
    uint256 public _SellchartiyFee = 600;

    uint256 public _taxFee  = 300; // means 3% which distribute to all holders

    uint256 public _SellmarketingFee = 400; 

    

    address marketingAddress=0x7816FB6e6e9af4e24dfb5cf29784AA58d1edE7B5;

    address foundersAddress=0x6a653f46094E4d9a308604AFC266891395341085;

    address charityAddress=0x203a511c5058b6B4faFA4FD7C15e3F57077Fb615;
