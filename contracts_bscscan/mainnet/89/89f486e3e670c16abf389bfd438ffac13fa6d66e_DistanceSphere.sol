 ...
 * ______ _     _                         _____       _                   
 * |  _  (_)   | |                       /  ___|     | |                  
 * | | | |_ ___| |_ __ _ _ __   ___ ___  \ `--. _ __ | |__   ___ _ __ ___ 
 * | | | | / __| __/ _` | '_ \ / __/ _ \  `--. \ '_ \| '_ \ / _ \ '__/ _ \
 * | |/ /| \__ \ || (_| | | | | (_|  __/ /\__/ / |_) | | | |  __/ | |  __/
 * |___/ |_|___/\__\__,_|_| |_|\___\___| \____/| .__/|_| |_|\___|_|  \___|
 *                                             | |                        
 *                                             |_|   
 * 
 * https://www.distancesphere.com/
 * https://twitter.com/DistanceSphere
 * https://t.me/DistanceSphere
 * https://discord.com/nYn5Yns8Ct
 * https://medium.com/@distancesphere
 *           
 */
...
contract DistanceSphere is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Distance Sphere";
    ...
    address payable private _marketingAddress1 = payable(0x91C794fA4d5c1782B9a400fBF378500f6609BDaE);
    address payable private _marketingAddress2 = payable(0x4Ea458A22C1dC3a0e6DEED27cE42Ff1Ea4c85350);
    address payable private _marketingAddress3 = payable(0x5c5373830c0C5806C19eEF5D49e060e7ADbE95D7);
    ...
    constructor() {
        ...
        _isContract[_marketingAddress1] = true;
        _isContract[_marketingAddress2] = true;
        _isContract[_marketingAddress3] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && !presale && from != address(this) && to != address(this) && !_isContract[from] && !_isContract[to]) {
            require(tradingOpen, "trading not ");
    ...
    function sendETHToFee(uint256 amount) private {
        if(block.timestamp < _firstBlock + (1 days)) {
            _marketingAddress1.transfer(amount.div(100).div(3));
            _marketingAddress2.transfer(amount.div(100).div(3));
            _marketingAddress3.transfer(amount.div(100).div(3));
        }
        else {
            _marketingAddress1.transfer(amount.mul(_marketingPercent).div(100).div(3));
            _marketingAddress2.transfer(amount.mul(_marketingPercent).div(100).div(3));
            _marketingAddress3.transfer(amount.mul(_marketingPercent).div(100).div(3));
        }
    }
    ...
    function updateMarketingAddresses(address payable marketingAddress1, address payable marketingAddress2, address payable marketingAddress3) external onlyOwner() {
        _marketingAddress1 = marketingAddress1;
        _marketingAddress2 = marketingAddress2;
        _marketingAddress3 = marketingAddress3;
    }
