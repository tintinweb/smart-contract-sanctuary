...
🔐 Pancake LP 100% Will be Locked

TG: https://t.me/HappySocietyMeal
 Telegram: https://t.me/HappySocietyMeal
 Website: TBA
...
//SPDX-License-Identifier: Unlicensed 
    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        IBEP20 FLOKI = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        ...
        uint256 public minPeriod = 120 minutes;
    ...
    contract HappySocietyMeal is IBEP20, Auth {
        using SafeMath for uint256;
    
        address FLOKI = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
        address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        address DEAD = 0x000000000000000000000000000000000000dEaD;
    
        string constant _name = "HappySocietyMeal";
        string constant _symbol = "HSM";
        uint8 constant _decimals = 9;
    
        uint256 _totalSupply = 1000000 * (10 ** _decimals); // 1,000,000 (1M)
        uint256 public _maxTxAmount = _totalSupply / 125000; // 8,000(.8%)
        ...
        uint256 liquidityFee = 300; // 5%
        uint256 liquidityFeeAccumulator;
    
        uint256 buybackFee = 100; // 1%
        uint256 reflectionFee = 300; // 5%
        uint256 marketingFee = 200; // 4%
        uint256 charityFee = 0; // 0%
        uint256 totalFee = 900; // 15%
        uint256 feeDenominator = 10000;

        uint256 private maxWalletPercent = 400; 
