...
contract PMGToken is IERC20 {
    using SafeMath for uint;

    string public override constant name = "Pokemon Gems";
    string public override constant symbol = "PMG";
    uint8 public override constant decimals = 18;
    uint  public override totalSupply ;
    uint private _init = 10000 * 10**4 * 10**18;
