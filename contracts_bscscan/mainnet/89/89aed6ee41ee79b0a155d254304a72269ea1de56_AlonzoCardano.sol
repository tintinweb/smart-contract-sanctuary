...
TG: https://t.me/AlonzoCardano

Celebrating the release of Alonzo in Cardano Blockchain we’ve developed a revolutionary defi token that rewards holders in Wrapped Cardano.
...
contract AlonzoCardano is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AlonzoCardano";
    string constant _symbol = "AlonzoCardano";
