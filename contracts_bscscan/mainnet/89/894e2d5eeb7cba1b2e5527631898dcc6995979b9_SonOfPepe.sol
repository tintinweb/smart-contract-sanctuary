...
contract SonOfPepe is Context, IBEP20, Ownable {
    ...
    string private constant _symbol   = "JRPEPE";
    uint8  private constant _decimals = 9;
    
    uint256 private  _percentageOfLiquidityForTeam       = 250;
    uint256 private  _percentageOfLiquidityForMarketing = 6250;
    uint256 private  _percentageOfLiquidityForCharity   = 2000;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 100 / 10000; // 1% of total supply
    ...
    constructor () {
        ...
        // change this
        _teamWallet       = 0x168A1dA29EF79632C04538963c2b1F60F3EAb92C;
        _marketingWallet = 0x2e9a9F625cD8EC3cC1C17163fe9F23C2a44aCF2F;
        _charityWallet   = 0x71008453003D4242E3c9298DB45cd3Ae746BEE7E;
    ...
    function setAddresses(address teamWallet, address marketingWallet, address charityWallet) external onlyOwner {
        _teamWallet       = teamWallet;
        _marketingWallet = marketingWallet;
        _charityWallet   = charityWallet;
    }

    function setLiquidityPercentages(uint256 teamFee, uint256 marketingFee, uint256 charityFee) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbForLiquidity = newBalance - bnbForTeam - bnbForMarketing - bnbForCharity;
