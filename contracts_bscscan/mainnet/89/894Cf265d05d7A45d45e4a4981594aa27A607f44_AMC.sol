...
/*                                                                                                   
       ...
       db        88b           d88   ,ad8888ba,   
      d88b       888b         d888  d8"'    `"8b  
     d8'`8b      88`8b       d8'88 d8'            
    d8'  `8b     88 `8b     d8' 88 88             
   d8YaaaaY8b    88  `8b   d8'  88 88             
  d8""""""""8b   88   `8b d8'   88 Y8,            
 d8'        `8b  88    `888'    88  Y8a.    .a8P  
d8'          `8b 88     `8'     88   `"Y8888Y"'   
...
contract AMC is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xCd662EF0307f4732febadb881ae972E473c4e81A); 
    address payable public developmentAddress = payable(0xCd662EF0307f4732febadb881ae972E473c4e81A); 
    address payable public charityAddress = payable(0xCd662EF0307f4732febadb881ae972E473c4e81A); 
    address payable public vaultRewardAddress = payable(0xCd662EF0307f4732febadb881ae972E473c4e81A); 
    ...
    string private constant _name = "All Coin Market";
    ...
    uint256 public developmentDivisor = 0;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 1000000 * 10**9;
        _sMaxTxAmount = 1000000 * 10**9;
    }
