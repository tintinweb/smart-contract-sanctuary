...
// File contracts/RoyalCheems.sol
pragma solidity ^0.8.0;

contract RoyalCheems is Context, IERC20, Ownable {
    ...
    string private constant _name = "RoyalCheems";
    string private constant _symbol = " RoyalCheems";
    string private constant _ProjectName = "RoyalCheems";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            ...
            treasury: 22, // treasury fee in %
            lp: 22, // lp rate in %
            toSwap: 66 // treasury + dev + lp
        });
