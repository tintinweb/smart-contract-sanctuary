...
/**
 ...
 | |\/| |/ _` | '__/ __|   / /\ \ | '_ \ / _` | | |    / _` | '__/ __|
 | |  | | (_| | |  \__ \  / ____ \| | | | (_| | | |___| (_| | |  \__ \
 |_|  |_|\__,_|_|  |___/ /_/    \_\_| |_|\__,_|  \_____\__,_|_|  |___/
...
contract MarsAndCars is Context, IERC20, Ownable {
    ...
    string private _name = "Mars And Cars";
    string private _symbol = "MAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4D235186ce37Ce78ed2716Aea401673450e8acEd); 
    address payable public BuyBackWalletAddress = payable(0x4D235186ce37Ce78ed2716Aea401673450e8acEd); 
    ...
    uint256 public _walletMax = 50000 * 10**3 * 10**9;
