...
/**
 JUDGE BY ELON TWEETS 
 NO DEV WALLET 
 LP LOCKED 
 BURN 50% SUPPLY 
 
 TELEGRAM : t.me/JUDGEBYELONBSC
*/
...
contract JUDGETOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "JUDGE TOKEN";
    string private _symbol = "JUDGETOKEN";
