...
contract HoneyPad is ERC20, Ownable {
    ...
    event CalculatedBNBForEachRecipient(uint256 forMarketing, uint256 forBuyback, uint256 forDividends);
    ...
    constructor() ERC20("WoneyPad", "$WONEY") {
    ...
    function excludeFromMaxTxLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTxLimit[account] != excluded, "HoneyPad: Account is already the value of 'excluded'");
