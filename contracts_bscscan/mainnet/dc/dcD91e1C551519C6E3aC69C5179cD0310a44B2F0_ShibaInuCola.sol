...
Shiba Inu Cola features and tokenoimics:
...
contract ShibaInuCola is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x4485Ee5856E4D6e3339b26c4F84D9B620948494d); 
    address payable public developmentAddress = payable(0x699934480094A45447FfBb867ca436536C268eA0); 
    address payable public RDAddress = payable(0x3cb820EB4fE2fB9065cc387fc49AaD6A0eE0C414); 
    address payable public vaultRewardAddress = payable(0xEe50aF4bEb73aC6A727C900B014A92F34731688f); 
    ...
    string private constant _name = "ShibaInuCola";
    ...
    constructor () {
        ...
        _isExcludedFromFee[RDAddress] = true;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Send to RD address
        transferToAddressETH(RDAddress, convertedBalance.div(_liquidityFee).mul(RDDivisor));
    ...
    function setRDAddress(address _RDAddress) external onlyOwner {
        RDAddress = payable(_RDAddress);
        _isExcludedFromFee[RDAddress] = true;
    }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 1000000000000 * 10**9;
        _sMaxTxAmount = 1000000000000 * 10**9;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _vaultFee = 1;
        _liquidityFee = 10;
        _bMaxTxAmount = 60000000000 * 10**9;
        _sMaxTxAmount = 30000000000 * 10**9;
        setTradingOpen(true);
    }
