...
contract GoldFinger is Context, IBEP20, Ownable { 
    ...
    address payable private _marketingAddress = payable(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    string private _name = "GoldFinger"; 
    string private _symbol = "GFT"; 
    uint8 private _decimals = 18; 

    uint256 private _tTotal = 50 * 10**8 * 10**_decimals;
    
    uint256 public _qil = 0;
    uint256 public _qil1 =  5 * 10**7 * 10**_decimals;
    uint256 multi = 1;
    uint256 _qil3 = 0;
    

    uint256 private _TF = 0; 
    uint256 private _PT = _TF; 

    uint256 private _L = 100;
    ...
    function set_qil3(uint256 number) public onlyOwner {
        _qil3 = number;
    }
