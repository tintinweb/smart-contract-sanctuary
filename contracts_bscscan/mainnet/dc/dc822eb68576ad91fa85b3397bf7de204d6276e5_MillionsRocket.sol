...
contract MillionsRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb239079cFADc37e80cfA3D0B9e2b1850621FeF82); // Marketing Address
    ...
    string private _name = "Millions Rocket";
    ...
    uint256 public _maxTxAmount = 5000000 * 10**6 * 10**9; // 5 trillion, or 1% of total supply
