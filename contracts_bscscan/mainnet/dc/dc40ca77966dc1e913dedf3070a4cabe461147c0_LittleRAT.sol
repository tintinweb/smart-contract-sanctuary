...
/**   
   ...
   Welcome to LittleRAT
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleRat
   ...
   I will renounce the ownership to burn addresses to transfer #LittleRat to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make #LittleRat 10000X? 
   ...
   it's the best part of the #LittleRat idea, increasing the liquidity pool automatically, 
...
contract LittleRAT  is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        _transfer(_msgSender(), burnWallet, _totalSupply /5 );
    }
