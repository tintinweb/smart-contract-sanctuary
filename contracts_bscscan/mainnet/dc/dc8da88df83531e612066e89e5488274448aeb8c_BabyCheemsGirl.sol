...
contract BabyCheemsGirl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x70B436562F6f15C03F1B8A31C84e89031a687faf); // Marketing Address
    ...
    string private _name = "BabyCheemsGirl";
    string private _symbol = "BabyCheemsGirl";
