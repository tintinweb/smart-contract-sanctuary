...
contract Dogecoins is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x901a64d0ef28e673356a55710F301764e26B1b1F); // Marketing Address
    ...
    string private _name = "Dogecoins";
