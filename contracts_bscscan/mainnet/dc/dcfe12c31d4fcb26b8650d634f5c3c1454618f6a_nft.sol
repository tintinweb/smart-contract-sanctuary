...
contract nft is ERC721, Ownable {
    ...
    constructor() ERC721('Eroverse Celeb Love Collection', 'ECLC') {
        ...
        addCollection("ipfs://QmU44KsDru2mznboQtgUzv5USazL2eqZhcMrVkWiFqig6s/");
        //minting token for owner
        _safeMint(msg.sender, 1);
        mintsPerAddress[msg.sender] += 1;
        numberOfTotalTokens += 1;
        collectionSupply[1] += 1;
