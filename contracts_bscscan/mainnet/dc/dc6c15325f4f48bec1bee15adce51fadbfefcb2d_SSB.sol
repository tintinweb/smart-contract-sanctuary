...
╚══════╝╚══════╝╚═════╝ 
    ...
    Satoshi Steet Bets Token ($SSB)
    12% Total Transaction Tax
    Telegram: https://t.me/SSBTokenOfficial
    Website: https://SSBtoken.com
*/ 
...
contract SSB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x7385138Fc22ec9762957225CbdcADace09863C50); // Marketing Address
    ...
    string private _name = "Satoshi Street Bets Token";
    ...
    uint256 private _buypajekFee = 1;
    uint256 private _buylpPajek = 11;
