...
contract Ahmad is Context, IERC20 {
    ...
    string constant private _name = "Test ahmad";
    string constant private _symbol = "TESTAHMAD";
...
//===============================================================================================================
    ...
    function setMaxSellTransactionAmount(uint256 amount) external onlyOwner{
        require(amount > _tTotal, "Max Sell Transaction amt must be below total supply.");
        require(amount < (_tTotal / 100), "Max Sell Transaction amt must be above 1% of total supply.");
