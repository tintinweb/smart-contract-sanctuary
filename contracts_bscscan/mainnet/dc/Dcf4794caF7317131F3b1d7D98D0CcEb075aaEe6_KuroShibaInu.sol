...
// verified on BSCscan.com - 19/12/2021

/**
 * https://kuroinu.io
 * Twitter.com/KuroShibaInu1
 * https://t.me/kuroshibainu
 */
...
contract KuroShibaInu is Context, IERC20, Ownable {
    ...
    string private _name = "Kuro Shiba Inu";
    string private _symbol = "KSI";
    ...
    uint256 public _buybackFee = 22; // % of liquidityFee
    uint256 public _liqFee = 33; // % of liquidityFee
    ...
    constructor () {
        _rOwned[_msgSender()] = _rTotal;
         ...
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Pancake // testnet address: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 mainnet address: 0x10ED43C718714eb63d5aA57B78B54704E256024E
