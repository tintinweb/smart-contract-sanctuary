...
🐶Welcome To CyberArmy Doge🐶

CyberArmy Doge - a deflationary token and community driven project. 

Hold and Earn $DOGE - Most rewarded token Project with rewards of $DOGE while holding! A passive income benefits from the holders 


💰Marketing -1% of every transaction is allocated Marketing and development
⚙️LP - 1% of every transaction is added to the liquidity pool.
🐶$DOGE Rewards - 15% $DOGE passive rewards for every transactions which will be sent to your wallet automatically.

📱Telegram : 
@CyberArmyDoge

☎️ Twitter : 
https://twitter.com/cyberarmydoge
...
contract CyberArmyDoge is Context, IERC20, IERC20Metadata, Ownable {   
