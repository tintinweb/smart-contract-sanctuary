...
contract DogeS is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 69000000000000000000000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 69000000000000000000000 * 10 ** 9;
    uint256 MAX_LOCK   = 69000000000000000000000 * 10 ** 9;
    ...
    constructor() ERC20("DogeShib", "DogeShib") {
        addressForMarketing =address(0x58a08Ffd730b831Bb1786e2d80CD8d6CD5259902);
