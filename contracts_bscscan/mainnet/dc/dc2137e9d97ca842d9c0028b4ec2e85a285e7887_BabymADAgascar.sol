...
// Earn huge ADA rewards while holding BabymADAgascar

// TG @ https://t.me/BabymADAgascarBSC

// Rewards : 20% TAX per tx, 10% ADA reflections, 5% back to liquidity & 5% Marketing

// Fairlaunching @ 50 telegram members!

// LP will be locked, 100% SAFU
...
contract BabymADAgascar is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabymADAgascar";
    string constant _symbol = "BabymADA";
