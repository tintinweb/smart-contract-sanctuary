...
contract daddykitty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "daddykitty";
    string private _symbol = "daddykitty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1575C99957e7D09Ca0E02Dd11Ad9303B926aCDde); // Marketing Address
    address payable public teamWalletAddress = payable(0x1E30D6d2064d0C27D3D5122FB75D5833C1159c88); // Team Address
