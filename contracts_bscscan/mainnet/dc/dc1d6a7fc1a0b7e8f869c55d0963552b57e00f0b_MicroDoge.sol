...
/**
Welcome to MicroDoge

Low market cap, low initial LP to make a stealth launch

✅ Ownership renounced
✅ LP Burned after launch
...
contract MicroDoge is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "MicroDoge";
  string constant tokenSymbol = "MicroDoge";
