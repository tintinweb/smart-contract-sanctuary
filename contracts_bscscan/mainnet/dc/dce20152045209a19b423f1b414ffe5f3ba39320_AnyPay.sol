...
// AnyPay 🚀 Fair launch/Anti-Snipe 
// 🔥 Huge marketing campaign
// 🎯 Rewards/Competitions 
// 📊 Social media ads and influencers ready
...
contract AnyPay is IERC20 {
    ...
    uint256 private constant startingSupply = 1_000_000_000_000; // 1 Trillion, underscores aid readability

    uint8 private _decimals = 9;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "AnyPay";
    string constant _symbol = "ANYPAY";
    ...
    address payable private _marketingWallet = payable(0xdF901e128935ef5A65e548822669865b7CB5b6eE);
