...
/**
// https://t.me/scout_app
// @scout_app
// Scout dVPN Smart Contract                                        
//
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DZ = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract Scout is IBEP20, Auth {
    using SafeMath for uint256;

    address DZ = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Scout";
    ...
    constructor () Auth(msg.sender) {
        ...
        devDeployReceiver = 0x1f755c5f93E68f4B6e1Ac2692cF7925c9aE332B3;
        marketingFeeReceiver = 0x70345f4517F357aDd1A9bc463b221021cf96c8B7;
    ...
    function setDZToken(address _DZ) external authorized {
        DZ = _DZ;
        }
