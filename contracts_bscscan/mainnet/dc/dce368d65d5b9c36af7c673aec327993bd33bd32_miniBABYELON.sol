...
/**Welcome to miniBABYELON
   ...
   I will renounce the ownership to burn addresses to transfer #miniBABYELON
   to the community
   Can you make #miniBABYELON
   100X? 
   ...
   it's the best part of the #miniBABYELON
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract miniBABYELON is Context, IBEP20, Ownable {
