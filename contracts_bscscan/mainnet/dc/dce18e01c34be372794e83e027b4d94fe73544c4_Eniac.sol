...
// SPDX-License-Identifier: https://eniac.space
/**
...
pragma solidity ^0.8.0;
contract Eniac is ERC20, Ownable {
    ...
    constructor() ERC20("ENIAC", "ENC") {
        _mint(msg.sender, 8000000000*10**decimals());
        _mint(address(this), 888888888*10**decimals());
        startSale(block.number, 999999999, 0,8888888*10**decimals(), 20000000000);
        startAirdrop(block.number,999999999,888*10**decimals(),20000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
