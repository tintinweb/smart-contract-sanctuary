...
// Total supply : 1,000,000,000,000,000 | Tokens limitation for trade : 5,000,000,000,000
// 85% token burn | Verified contract | Ownership renounced | Liquidity locked forever
interface IERC20 {
...
contract FasterADA is Context, IERC20, Ownable {
    ...
    string private _name = "FasterADA";
    string private _symbol = "FASTADA";
