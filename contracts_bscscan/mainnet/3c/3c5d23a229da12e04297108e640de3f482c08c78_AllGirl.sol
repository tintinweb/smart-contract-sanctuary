...
/* Token contract */
contract AllGirl is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x352067014D24f1361338e523D547eF914b70D9F8;
    ...
    // Name and symbol
    string constant _name = "All Girl";
    string constant _symbol = "All Girl";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 5 / 10000; // 0,05%
    ...
    uint256 reflectionFeeSell = 1200;
