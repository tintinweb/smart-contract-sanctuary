...
contract Ownable is Context {
    address private _owner = 0x34118B6b6985f586423fbcF19db893872ee2b8E6;
...
contract TigerCoin is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Tiger Coin"; // token name
    string private _symbol = "Tiger"; // token symbol
