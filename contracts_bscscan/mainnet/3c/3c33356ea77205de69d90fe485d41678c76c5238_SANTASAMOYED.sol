...
Telegram : https://t.me/santasamoyed
...
contract SANTASAMOYED is Context, IERC20, Ownable {
    ...
    string private _name = " SANTA SAMOYED " ;
    string private _symbol = " SANTASAMO " ;
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 10000 * 10**9 * 10**_decimals;
    
    address payable private marketingAddress = payable(0x881C28Fe56B845F1A3BE641433046d8f6b1c906b);
    address public marketingWalletToken = 0x46C203c53beE8Ca8dDFBa3f1ADC808491fe759F7;
    ...
    constructor () {
        ...
        _liquifyThreshhold = 2 * 10**9 * 10**_decimals;     // _totalSupply / 5000 ;         // 2.000.000.000 
        _maxBalance = 50 * 10**9 * 10**_decimals;           // _totalSupply / 1000 ;         // 100.000.000.000
    ...
    // Reset Stuck BNB From Contract Balance to Dev Wallet or Marketting Address \\
    function ResetStuckBNBContract() public onlyOwner 
    {
            payable(marketingWalletToken).transfer(address(this).balance);
    }
    ...
    function setMaxBalance(uint256 newMaxBalance) external onlyOwner(){
        // Minimum _maxBalance is 1.0% of _totalSupply 
