...
💥SonOfPunk is a BUSD reflection token with genererous reward to all holders, just hold $SOP and you'll receive massive $BUSD reward to your wallet automatically in every 30 minutes!

💥Network
SonOfPunk is a project created in the Binance Smart Chain (BEP20) network using BUSD reflection system as a reward

💥Future
in the future we will create the PunkSwap platform the exchange system protocol in BSC for the exchange between BEP20 tokens. Conversion can happen easily between 2 BEP20 tokens based on system price.

🎟 Lottery Every 3% go to lottery pool and dev will pick winner for one lucky holders every day.
...
🌐Website : https://sonofpunk.info/

🕊️Twitter : https://twitter.com/sonofpunks

☎️ Telegram : https://t.me/sonofpunk
*/
...
contract SonOfPunk is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x56b8acDCB97c09a8ba368F545040abeD923ad19A;
    ...
    string private _name = "SonOfPunk";
    string private _symbol = "SonOfPunk";
