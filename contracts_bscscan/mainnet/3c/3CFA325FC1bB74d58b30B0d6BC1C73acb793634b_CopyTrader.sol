...
contract CopyTrader is Ownable {
    ...
    function addAsset(
        ...
        Asset storage _asset = asset(IERC20(token));
    ...
    function swapBNBForToken(
        ...
        destAsset.amount = destAsset.amount.add(returnAmount);
    ...
    function swapTokenForBNB(
        ...
        require(fromAsset.amount >= tokenAmount, "CopyTrader: not enough token balance");
        ...
        fromAsset.amount = fromAsset.amount.sub(tokenAmount);
