...
https://t.me/ApeLoungeNameChanger



Welcome to ApeLoungeNameChanger, presented by @ApeLoungeToken

Inspired by @Selontweet, Ape Lounge is now creating a Name Changer token to capture all of the hype on Elon's Tweet. This will be an addition to $APL Ecosystem
and further increase the buying pressure on $APL.
...
$APL holders are given the rights and perks to everlasting buying pressure for $APL fuelled by the ecosystem,
 participation in giveaways, and soon a discount on taxes on all DDP (in development). Discount tax on every launches.
...
/* Token contract */
contract APELoungeNameChanger is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string private _name = "APELoungeNameChanger";
    string private _symbol = "APELoungeNameChanger";
    ...
    uint256 public earlybuyBlocks = 20;  // for $APL holders to buy early
    uint256 public holdingThreshold = 20;  // 1 basis point, i.e., 1 is 0.01%
