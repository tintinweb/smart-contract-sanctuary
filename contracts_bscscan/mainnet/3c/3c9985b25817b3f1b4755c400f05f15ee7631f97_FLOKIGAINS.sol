 ...
 *
 *
 * Telegram: https://t.me/flokigainsbsc
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 FLOKI = IERC20(0x33E4dA82540B6a37220834d8Efa841e2a46c7494);
...
contract FLOKIGAINS is IERC20, Ownable {
    using SafeMath for uint256;

    address FLOKI = 0x33E4dA82540B6a37220834d8Efa841e2a46c7494;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FLOKI GAINS";
    string constant _symbol = "Floki G";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 100; //0.5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 20) / 100; // 2%
