...
/**
Introducing Lil Shiba
 
Lil Shiba is an autonomous yield and liquidity generation protocol that directly rewards the holders, while continuously increasing liquidity.


The token rewards the investors just for holding; the longer you hold, the bigger the reward!

While also adding real utility to the project by working towards a full-fledged NFT marketplace.
*/
...
contract LilShiba is Context, IERC20, Ownable, Pausable {
