...
/**
 Welcome to BABYRTE
   ...
   I will renounce the ownership to burn addresses to transfer #BABYRTE to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make BABYRTE 100X? 
   ...
   it's the best part of the #BABYRTE idea, increasing the liquidity pool automatically, 
