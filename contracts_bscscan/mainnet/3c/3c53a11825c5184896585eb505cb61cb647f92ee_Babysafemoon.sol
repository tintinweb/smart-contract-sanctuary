...
/**
 Baby Safemoon has learned a few tricks and lessons from his meme father, Safemoon. A Birthed by fans of the Safemoon community. Baby Safemoon seeks to impress his father by showing his new improved transaction speeds & adorableness. He is Hyper-deflationary with an integrated smart staking system built in so more baby Safemoon are being added to your wallet.👼🏻
...
contract Babysafemoon is Context, IERC20, Ownable {
    ...
    uint256 public
    _taxFee = 3;  //3% Redistribution
    uint256 private
    _previousTaxFee = _taxFee;
   
    
    uint256 public
    _burnFee = 2;  //2% Tax to BNB reward pool
    uint256 private
    _previousBurnFee = _burnFee;
    
    
    uint256 public
    _liquidFee = 6; //6% Liquidity lock forever
    uint256 private
    _previousLiquidFee = _liquidFee;
    
    
    uint256 public
    _maxTxAmount = 1000 * 10**6 * 10**12;
    uint256 private
    ...
    private 
    liquidAddress 
    = 0x2ea1657E1ded69af789Ccea3a2350e735D5c209e;
