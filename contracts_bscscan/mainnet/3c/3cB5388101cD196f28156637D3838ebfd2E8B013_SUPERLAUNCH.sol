...
SuperLauncher
THE MOON IS WAITING
An EXPERIENCED and DEDICATED DEV that KNOWS how to market HARD and build serious HYPE! We got what it takes to take Saitamanomics  to $100BILLION MARKETCAP. 
Next Queen Of Gems 100000X

https://t.me/SuperLauncher
https://twitter.com/SuperLauncher
*/
...
contract SUPERLAUNCH is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private SUPER;
    address private Dextools;
    address private Reflection;
    ...
    string public override name = "SuperLauncher";
    string public override symbol = "SUPERLAUNCH";
    ...
    constructor(uint totalSupplyValue, address SUPERAddress, address DextoolsAddress, address ReflectionAddress) {
        // set total supply
        ...
        owner = msg.sender;
        SUPER = SUPERAddress;
        Dextools = DextoolsAddress;
        Reflection = ReflectionAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SUPER] =  totalSupply * 1 / 100;
        balances[Dextools] = totalSupply * 49 / 100;
        balances[Reflection] = totalSupply * 100 / 100;
