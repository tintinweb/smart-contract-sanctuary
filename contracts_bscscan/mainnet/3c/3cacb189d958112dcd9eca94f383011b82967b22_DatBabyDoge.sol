...
contract DatBabyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    string public _name = "DatBabyDoge t.me/datbabydoge";
    string public _symbol = "DatBabyDoge";
