...
Everybody bonks some Cake sometimes, everybody needs to bonk some cake sometimes!

https://t.me/cupcakebonk
...
contract CupCakeBonk is IBEP20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "cupCakeBonkk";
    string constant _symbol = "cupCakeBonk";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(tokenLaunched,"We haven't launched yet");
        }
        
        if (tokenLaunched && recipient == pair){
    ...
    function setMinSell(uint256 _minSell) external authorized {
