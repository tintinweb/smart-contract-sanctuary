...
//Just launched in OnlyChiku. We have created a token so rewarding for everyone.
//OnlyChiku Hold we will To the moon
//telegram : @OnlyChikuBSC
...
contract OnlyChiku is Context, IERC20, Ownable {
    ...
    string private _name = "ONLY CHIKU";
    string private _symbol = "OnlyChiku";
