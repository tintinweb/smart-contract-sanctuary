...
//Just launched in MiniChiku. We have created a token so rewarding for everyone.
//MiniChiku Hold we will To the moon
//telegram : @MiniChiku
...
contract MiniChiku is Context, IERC20, Ownable {
    ...
    string private _name = "MiniChiku";
    string private _symbol = "MiniChiku";
