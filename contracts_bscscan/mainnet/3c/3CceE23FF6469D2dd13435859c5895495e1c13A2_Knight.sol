...
contract Knight is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "Knight";
    string constant public symbol = "Knight";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 30, "Knight: transaction fee percentage exceeds 30");
        require(feePercentage_ >= 0, "Knight: transaction fee percentage equals 0");
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "Knight: transfer from blacklisted address");
        require(!isBlacklisted[recipient], "Knight: transfer to blacklisted address");
        require(!isBlacklisted[tx.origin], "Knight: transfer called from blacklisted address");
