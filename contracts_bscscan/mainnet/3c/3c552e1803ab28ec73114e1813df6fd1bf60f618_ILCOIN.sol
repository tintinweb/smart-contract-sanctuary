...
contract ILCOIN is Context, IERC20, Ownable {
    ...
    uint256 private _supply = 2500 * 10**6 * 10**8;
    ...
    constructor () public {
        _balances[_msgSender()] = _supply.div(100).mul(97);
        _balances[address(0)] = _supply.div(100).mul(3);
        ...
        emit Transfer(address(0), _msgSender(), _supply.div(100).mul(97));
        emit Transfer(address(0), address(0), _supply.div(100).mul(3));
    }
