...
| $$    $$| $$  | $$| $$      | $$  | $$        | $$  | $$  | $$| $$  | $$
|  $$$$$$/|  $$$$$$/|  $$$$$$$|  $$$$$$/       /$$$$$$| $$  | $$|  $$$$$$/
 \______/  \______/  \_______/ \______/       |______/|__/  |__/ \______/ 
                                                                          

https://t.me/cocoinuofficial
...
// CHANGE
contract CocoInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Coco Inu";
    string constant _symbol = "COCO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500000000000 * (10 ** _decimals); // 500,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% 5,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 2% MAX 10,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x52E073127a646595d1187cB3754165f8710B8940);
