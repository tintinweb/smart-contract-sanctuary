...
3% tax:
1% for LP, 1% redistribution, 1% burn.
Supply - 7000000
Max Wallet - 69069
Max Transaction - 33000
...
contract TESTWillRugIn5Mins is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "TESTWillRugIn5Mins";
    ...
    uint256 public _maxWalletAmount = 69069 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 3500 * 10**9;
