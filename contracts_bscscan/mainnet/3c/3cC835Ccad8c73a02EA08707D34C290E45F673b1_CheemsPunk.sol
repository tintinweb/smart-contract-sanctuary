...
//Just launched in CheemsPunk. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//CheemsPunk Hold we will To the moon
//telegram : @CheemsPunk
...
contract CheemsPunk is Context, IERC20, Ownable {
    ...
    string private _name = "CheemsPunk";
    string private _symbol = "CPUNK";
