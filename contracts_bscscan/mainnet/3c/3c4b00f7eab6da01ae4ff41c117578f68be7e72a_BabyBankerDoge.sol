...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xf06419C638a1d809C024Aa693147dBDc42B60145); //the reward token you want distributed 
...
contract BabyBankerDoge is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xf06419C638a1d809C024Aa693147dBDc42B60145; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyBankerDoge";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
