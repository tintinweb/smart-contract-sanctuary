...
contract FLAPPYCAKE is ERC20, Ownable {
	...
	address payable public MarketingWallet = payable(0x2117f1a5d3eC72173f9EAc108a94327Ee74493fa); // Marketing Address
    ...
    constructor() ERC20("Flappy Cake", "FlappyCake") {
    ...
    function _transfer(
       ...
       if(from != owner()){
        ...
        if(!tradingOpen) {
            require(canTransferBeforetradingOpen[from], "FLAPPYCAKE: This account cannot send tokens until trading is enabled");
        }
