...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 120 days");
...
contract TBBT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1099a29c5f3434107B9487490a22Ac7B576bD980); // Marketing Address
    ...
    string private _name = "The Biggest Bang Theory";
    string private _symbol = "TBBT";
    ...
    uint256 public _taxFee = 4; //TO HODLER
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 8;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _buyTaxFee = 4; //TO HOLDER
    uint256 public _buyLiquidityFee = 8; //MARKETING 3% + BUYBACK 2%
    
    uint256 public _sellTaxFee = 4; //TO HOLDER
    uint256 public _sellLiquidityFee = 8; //MARKETING 3% + BUYBACK 3%
    ...
    uint256 public marketingDivisor = 3; //% FROM %LP
    
    uint256 public _maxTxAmount = 1000000000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**6 * 10**9; 
