...
contract SHIBMXC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC62d78F7A2d07c37c5FA3Bf539Ba63163812B15a); // Marketing Address
    ...
    string private _name = "SHIBMXC";
    string private _symbol = "SHIBMXC";
