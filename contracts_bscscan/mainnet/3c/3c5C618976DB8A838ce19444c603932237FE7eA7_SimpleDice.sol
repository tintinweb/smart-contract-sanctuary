...
contract SimpleDice is GambleBase, AccessControlEnumerable {
    ...
    *
    **/
    function startBet(IERC20 _token, uint256[3] memory _rollIntegerVariables, bytes32 _userSeed, bytes32 _houseCommit) external noContract {
    ...
    function finishBet(IERC20 _token, address _gambler,uint256 _blockNumber, uint256[3] memory _rollIntegerVariables, bytes32 _userSeed, bytes32 _houseReveal) external onlyCoupier {
