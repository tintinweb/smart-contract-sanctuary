...
Son of Satan: Time to give him Hell!

Eaaazzy taxes:

5 % Market - to devour those influencers
3 % LP - to fill up the fumes

10 % Extra Burn for Sellers - Burn you MOFOs

https://t.me/SonOfSatan_BSC
...
contract SonOfSatan is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SonOfSatan";
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _buyBackFee, uint256 _burn, uint256 _sellFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(sellFee < feeDenominator/4, "Fees cannot be more than 25%");
    }
