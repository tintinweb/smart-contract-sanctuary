...
contract MoonPuppyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xCDA79A8534268DbA9c9C5346ee0e248A7A482917); // Marketing Address
    ...
    string private _name = "MoonPuppyDoge";
    string private _symbol = "MPDOGE";
