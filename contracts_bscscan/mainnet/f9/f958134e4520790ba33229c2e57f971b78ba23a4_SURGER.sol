...
contract SURGER is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**6 * 10**9; // 1
    ...
    uint256 public _maxTxAmount = 50000000 * 10**6 * 10**9; // Max Transaction: 5%
    uint256 public _numTokensSellToAddToLiquidity = 1000000000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 50000000 * 10**6 * 10**9; // Max Wallet: 5%
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'SurgersAreCool';
    string private _symbol = 'SURGEE';
