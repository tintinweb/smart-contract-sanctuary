...
contract SavingsCoin is Context, IBEP20, Ownable {
    ...
    address public _marketingWallet = 0xa6f8a328569B578495A8aFd10680c5ae0Cb8906b;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 70000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "Savings Coin";
    string private _symbol   = "SAVINGS";
