...
🌙 WELCOME TO MOONFASTER 🚀


✅ Verified contract.
⭐️ Ownership will be renounced after lauch
🔒 Liquidity locked
🔥 60% Burn
📝 WhitePaper.
🐳 Max transaction set. (anti-whales)
...
contract MoonFaster is Context, IERC20, Ownable {
    ...
    string private _name = "MoonFaster";
    string private _symbol = "MOONFASTER";
