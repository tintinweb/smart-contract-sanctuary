// SPDX-License-Identifier: MIT
 ...
 /**
  ...
  Contact us: 
 🟣 Telegram:https://t.me/MiniTennisOficial
 🟣 Website: http://minitennistoken.site
 🟣 Twitter: https://twitter.com/minitennistoken
 ...
 */ 
 ...
 contract MiniTennis is ERC20, Ownable {
    ...
    MiniTennisDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address transferredOwner = address(0x60c76e3aB6005ab33AA10F5b3E2FAC288A06f76f);
    ...
    uint256 public maxTokensToSwap = 500000000000 * (10**18);
    ...
    uint256 public dividendsFee = 3; //rewards ADA
    uint256 public marketingFee = 7; //marketing+buyback+team
    uint256 public coreFee = 3; //project
    uint256 public liquidityFee = 2;
    uint256 public totalFees = dividendsFee.add(marketingFee).add(coreFee).add(liquidityFee);

    address payable public marketingWalletAddress = 0x670e23c192BF2c4e127b9245AF9Ec5a92F5BE70D;
    address payable public coreWalletAddress = 0x0E8DD193E73E32873584e1De0B09341FB2596298;
    ...
    uint256 public maxTxAmount = 500000000000 * (10**18);
    ...
    constructor() public ERC20("MiniTennis", "MNT") { 

    	dividendTracker = new MiniTennisDividendTracker();
        ...
        */
        _mint(transferredOwner, 1000000000000 * (10**18));
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "MiniTennis: The dividend tracker already has that address");

        MiniTennisDividendTracker newDividendTracker = MiniTennisDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "MiniTennis: The new dividend tracker must be owned by the MiniTennis token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "MiniTennis: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MiniTennis: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "MiniTennis: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "MiniTennis: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "MiniTennis: gasForProcessing must be between 200,000 and 600,000");
        require(newValue != gasForProcessing, "MiniTennis: Cannot update gasForProcessing to same value");
...
contract MiniTennisDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("MiniTennis_Dividen_Tracker", "MiniTennis_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2000000 * (10**18); //must hold 2+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "MiniTennis_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "MiniTennis_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MiniTennis contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MiniTennis_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "MiniTennis_Dividend_Tracker: Cannot update claimWait to same value");
