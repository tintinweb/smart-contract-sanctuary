...
contract MiniMATIC is IBEP20, Auth {
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address OWNER = 0x7AEe5229FD278793242f4fc6606a9C39374A6a22;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // max wallet code
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(OWNER) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _totalSupply.sub(balanceOf(OWNER)).sub(balanceOf(ZERO));
    }
