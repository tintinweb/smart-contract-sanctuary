...
Welcome to Fatoshi, First to have CertiK Audit PRElaunch, 10% FAT BTC rewards and also an extremely Bullish Cross-Chain NFT ecosystem
*/
...
contract FATOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "FATOSHI"; // 
