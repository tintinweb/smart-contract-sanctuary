...
contract MOONZilla is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 69000000000000000000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'MOONZilla';
    string private _symbol = 'MOONZilla';
    uint8 private _decimals = 8;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0xcfcB9B4a7981ae469Ea535Cc5bF5DA451f178aDf);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 10 * 10**uint256(_decimals);
