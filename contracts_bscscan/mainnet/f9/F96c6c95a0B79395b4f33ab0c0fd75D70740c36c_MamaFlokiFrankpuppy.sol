...
/**
   ...
   25,000,000,000,000 tokens limitation for trade, which is 2.5% of the total supply.
...
contract MamaFlokiFrankpuppy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE2DaA01f8E0C7Ad8171e8198FfBDaAFC05a3d605); // Marketing Address
    ...
    string private _name = "Mama Floki Frankpuppy";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
