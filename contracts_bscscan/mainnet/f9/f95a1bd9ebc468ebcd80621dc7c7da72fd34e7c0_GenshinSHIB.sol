...
/**
GenshinSHIB is the coolest addition to the doge family with multi dimensional 
 ...
 * https://GenshinSHIB.IO/
 * https://twitter.com/GenshinSHIB
 * https://t.me/GenshinSHIB
*/
...
interface IBEP20Sniper is IERC20AntiBot {
 ...
 contract GenshinSHIB is Genshin, IERC20AntiBot, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "GenshinSHIB";
    string private _symbol = "GenshinSHIB";
    uint256 private constant MAX = ~uint256(0);
//  https://www.coingecko.com/en/coins/GenshinSHIB
