...
📱 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈 - https://t.me/watercheems

🐦 𝙏𝙒𝙄𝙏𝙏𝙀𝙍 - https://twitter.com/WaterCheems

🌐 𝙒𝙀𝘽𝙎𝙄𝙏𝙀 - https://watercheems.xyz

𝙏𝙊𝙆𝙀𝙉𝙊𝙈𝙄𝘾𝙎 

- 8% ADDED TO THE LIQUIDITY POOL

- 1% ADDED TO THE MARKETING

- 1% $CAKE REWARD - EVERY 24 HOURS
...
contract Context {
 ...
 contract WaterCheems is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "Water Cheems";
    string private _symbol = "W-Cheems";
    address private constant _RewardAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    address private _Ownership = 0x4Ff8138c490e751f4790a514f1C146c98B134b8B;
