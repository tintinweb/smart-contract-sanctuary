...
/**
 *
  Official Miss Shiba Inu Binance Smart Chain Token
  
  
  We are occupy to the moon with Miss Shiba Inu. Would you like to come with us?
  ...
  Burned       50%
  Team Token   0%
  Put only 1 bnb liquidity for easily moon
...
contract MISS is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "MISS SHIBA";
  string private _name = "Miss Shiba Inu";
