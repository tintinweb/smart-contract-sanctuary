...
// 
contract FlokinHigh is BEP20, Manageable {
	using SafeMath for uint256;
	...
	constructor() public BEP20('FlokinHigh', 'FLH') {
		...
		marketingWallet = address(0x5260f7FE1E2f04fB13D6A03389689e7446d4b33a);
		developmentWallet = address(0x980cB2DCE8A02d33f01D0227dc0BcBA348dCE216);
		...
		address _owner = address(0x5260f7FE1E2f04fB13D6A03389689e7446d4b33a);
	...
	function updatePancakeSwapRouter(address newAddress) public onlyManager {
		require(newAddress != address(pancakeSwapRouter), 'FLN: The router already has that address');
	...
	function excludeFromFees(address account, bool excluded) public onlyManager {
		require(_isExcludedFromFees[account] != excluded, "FLN: Account is already the value of 'excluded'");
	...
	function _setAutomatedMarketMakerPair(address pair, bool value) private {
		require(automatedMarketMakerPairs[pair] != value, 'FLN: Automated market maker pair is already set to that value');
	...
	function updateMarketingWallet(address newMarketingWallet) public onlyManager {
		require(newMarketingWallet != marketingWallet, 'FLN: The marketing wallet is already this address');
	...
	function updateDevelopmentgWallet(address newDevelopmentWallet) public onlyManager {
		require(newDevelopmentWallet != developmentWallet, 'FLN: The development wallet is already this address');
	...
	function updateLotteryAddress(address newLotteryAddress) public onlyManager {
		require(newLotteryAddress != lotteryAddress, 'FLN: The lottery wallet is already this address');
