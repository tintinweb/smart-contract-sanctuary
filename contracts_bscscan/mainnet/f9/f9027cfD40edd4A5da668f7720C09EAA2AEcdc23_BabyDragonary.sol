...
contract BabyDragonary is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Baby Dragonary";
    string private _symbol = "BaDr";
    uint8 private _decimals = 9;
    uint256 public _rewardFee = 5;
    uint256 public _burnFee = 5;
    uint256 public _smFee;
    uint256 private _tTotal = 90000000000 * 10 ** _decimals;
    uint256 public _maxTxAmount = 56000000 * 10 ** _decimals;
    ...
    constructor() {
        ...
        _smFee = 10;
        stsmf = 31500000 * 10 ** _decimals;
        _smfA = payable(0x0B76F4D8D35bA7e935c20844d2303D3F5d5529Db);
    ...
    function withdraw() external nonReentrant {
        require(_mgr == _msgSender(), "Ownable: Failed");
    ...
    function withdrawBNB() external {
        require(_mgr == _msgSender(), "Ownable: Failed");
        transferToAddressETH(_msgSender(), address(this).balance);
    }
}