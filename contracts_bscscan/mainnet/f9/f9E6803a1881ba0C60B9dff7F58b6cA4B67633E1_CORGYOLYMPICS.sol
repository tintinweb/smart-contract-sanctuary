...
Welcome to CorgiOlympics , sweet little Corgis on the Olympics, getting rewards for all holders.
12% just for holding CORGYLIMPICS :)
Lp locked for 2 weeks , Ownership renounced.
Active Telegram group : https://t.me/corgiolympics
...
contract CORGYOLYMPICS is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 12;
  uint256 private _maxTrxLimit = 100 * 10**3 * 10**12;
  address private _deployer;
