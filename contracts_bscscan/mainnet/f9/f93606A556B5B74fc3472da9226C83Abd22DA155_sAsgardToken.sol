...
contract sAsgardToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Asgard", "sASGARD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sASGARD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sASGARD
