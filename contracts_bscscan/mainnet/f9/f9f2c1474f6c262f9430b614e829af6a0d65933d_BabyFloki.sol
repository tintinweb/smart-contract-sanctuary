...
/**
   ...
   Welcome to BabyFloki
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyFlokiBsc
   ...
   I will renounce the ownership to burn addresses to transfer #BabyFloki to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 30% total supply to the pool
   Can you make #BabyFloki 10000X? 
   ...
   it's the best part of the #BabyFloki idea, increasing the liquidity pool automatically, 
