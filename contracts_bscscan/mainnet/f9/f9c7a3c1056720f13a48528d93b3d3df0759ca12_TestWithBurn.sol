...
contract TestWithBurn is BEP20 {
     ...
     */
    constructor(uint _startTradingTime, address _pcsRouter, address payable _mkt, address payable _buyback) public BEP20("TestWithBurn", "TWB") {
    ...
    function tradingBeforeTime(address _whitelisted) public onlyOwner {
        _excludedFromTransferBeforeTradingEnabled[_whitelisted] = true;
    }
