...
Sleepycat is token with system automatic buyback every 30 minutes, U can see on poocoin or other web chart. 
Antidump system with max tx for sell and buy. 
Have tax 10% for sell and buy 2%
Join our group telegram : t.me/sleepycatbsc
...
contract SLEEPYCAT is Context, IERC20, Ownable {
    ...
    string private _name = "SleepyCat";
