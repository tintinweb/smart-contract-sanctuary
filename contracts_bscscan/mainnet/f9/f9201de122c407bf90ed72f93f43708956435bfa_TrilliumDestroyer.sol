...
/*
   ...
   website: https://www.trilliumdestroyer.xyz
   telegram: https://t.me/trilliumdestroyer
   twitter: https://twitter.com/TLM_Destroyer
   $TRILL
    ...
    3% go to community wallet used for buy and burn $TLM
   
   Two "ANTI-WHALE" mechanisms :        max trx amount is 2% of the original total supply
                                        max wallet balance is 2% of the total supply
        - Smart-contract has been adapted for BinanceSmartChain and Pancakeswap deployment.
    
    Learn more :
   https://www.trilliumdestroyer.xyz
...
contract TrilliumDestroyer is Context, IERC20, Ownable {
    ...
    string private _name = "TrilliumDestroyer";
    ...
    // address for the buy back
    address private _charityWalletAddress = 0x51C3AFa10Cc98672D6E81eb0e64775661BFA11c6;
    ...
    uint256 private maxWalletBalance = _tTotal / 50;
    ...
    function _transfer(
        ...
        if (maxWalletBalance > 0 && !isExcludedFromFee(from) && !isExcludedFromFee(to) && to != uniswapV2Pair){
