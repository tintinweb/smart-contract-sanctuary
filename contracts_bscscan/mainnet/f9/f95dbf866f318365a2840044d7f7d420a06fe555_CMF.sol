...
/**
 * 
Campfire ($CAMPFIRE) is a frictionless, yield-generating, hyper-deflationary, double reward reflection contract that isn't broken. Enter a new era of smart contracts, Generation 4. Introducing and exclusive and unique rewards system that is not otherwise found on the Binance network, Campfire is taking the Altspace by storm. 
*/
...
contract CMF is Context, IERC20, Ownable {
