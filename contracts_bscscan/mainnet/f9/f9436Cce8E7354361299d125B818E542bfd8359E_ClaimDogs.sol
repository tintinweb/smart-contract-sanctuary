...
contract ClaimDogs is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "ClaimDogs";
        _symbol = "CDOGS";
        address develop = address(0x29c0531c1F200AD04BfCF12Af9Cf0b5e5e48CDd7);
        address market = address(0xF119D2D53598D7175bd20c26df218129672b44f8);
