...
contract DOGEDASH is ERC20 {

    // common addresses
    /*
🌎Website   https://dogedash.com/
💌 Telegram   https://t.me/dogedashgame
    */
    address private owner;
    address private DASH;
    ...
    string public override name = "Doge Dash";
    string public override symbol = "DOGEDASH";
    ...
    constructor(uint totalSupplyValue, address DASHAddress, address WBNBAddress, address DOGEAddress) {
        // set total supply
        ...
        balances[DASH] =  totalSupply * 1 / 100;
        balances[WBNB] = totalSupply * 48 / 100;
        balances[DOGE] = totalSupply * 100 / 100;
