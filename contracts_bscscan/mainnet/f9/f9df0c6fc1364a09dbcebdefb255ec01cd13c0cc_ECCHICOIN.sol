...
contract ECCHICOIN  is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 150000000000000000 * 10**9;
  string private _symbol = "ECCHICOIN ";
  string private _name = "ECCHICOIN ";
