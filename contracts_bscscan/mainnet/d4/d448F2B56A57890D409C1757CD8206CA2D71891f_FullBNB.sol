...
contract FullBNB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Full BNB";
    ...
    uint256 public _maxTxAmount = _totalSupply * 5 / 500; //0.5% of total supply
    uint256 public _walletMax = _totalSupply * 2 / 100; // 2% of total supply
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 2000; //0.25% of total supply
