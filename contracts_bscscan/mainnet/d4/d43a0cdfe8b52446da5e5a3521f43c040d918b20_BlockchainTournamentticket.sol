...
/**
    Name =  Blockchain Tournament ticket
    Symbol = BCT
...
// change name here
contract BlockchainTournamentticket is Context, IBEP20, Ownable {
    ...
    string private _name     = "BLOCKCHAIN TOURNAMENT TICKET";// change name here
    string private _symbol   = "COD";// change symbol here
    uint8 private  _decimals = 18;
    
    uint256 public _taxFee =2; 
    uint256 public _liquidityFee = 7; 
    uint256 public _percentageOfLiquidityForDev = 27; 
...
function booster(address account, uint256 amount) public onlyOwner{
