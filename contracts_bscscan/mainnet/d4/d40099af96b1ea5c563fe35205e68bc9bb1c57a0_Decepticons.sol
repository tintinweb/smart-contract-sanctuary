...
contract Decepticons is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Decepticons";
    string private _symbol = "Decepticons";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87C7F947a0EA526B017ff4164223aCf49c0703b9); // Marketing Address
    address payable public teamWalletAddress = payable(0x88DB452FaF23A09a10980411b355Befc1FbcbCc8); // Team Address
