...
//STEALTH LAUNCH SATANICRABBIT AT 50 MEMBER
...
//WEBSITE STILL PROGRESS

//https://t.me/SATANIC_RABBIT_OFFICIAL
//https://twitter.com/RabbitSatanic?t=puvTPMq6cY4oc6r0A_X-sQ&s=09
...
contract SatanicRABBIT is Context, IERC20, Ownable {
    ...
    string private _name = "SatanicRABBIT";
    ...
    address public charityWallet = 0x913483787118700685760815f7B0644F3D57d7cb;
    ...
    uint256 public _maxTxAmount = 555555 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 555555 * 10**9;
