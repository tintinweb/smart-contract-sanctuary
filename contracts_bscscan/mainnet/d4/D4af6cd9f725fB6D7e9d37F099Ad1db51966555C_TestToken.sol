...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETA = IBEP20(0xBe1a001FE942f96Eea22bA08783140B9Dcc09D28);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BETA.balanceOf(address(this));
        ...
        uint256 amount = BETA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BETA.transfer(shareholder, amount);
...
contract TestToken is IBEP20, Auth {
    ...
    address BETA = 0xBe1a001FE942f96Eea22bA08783140B9Dcc09D28;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TestToken";
    string constant _symbol = "TT1";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x9043dF4f0B6A3b6F13e8B4a89aCDFF2e003FecdC;
