...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract test is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x146e60CCFfa7d40A7004d0863A4858A1589b6A7a); // Marketing Address

    address payable public teamAddress =
        payable(0x98fD650F36765dF04635Be4e6A2a81236e959E06); // Team Address

    address payable public liquidityAddress =
        payable(0x1A14A07D36a9143D0Bd31C4Dd38d72Dd087D16Be); // Liquidity Address
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 10 / 2000; // 2% maxTransactionAmountTxn
