 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/Mario2K22
 * 
 * 
 * Mario2K22 token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract Mario2K22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mario2K22";
    string constant _symbol = "MARIO2K22";
