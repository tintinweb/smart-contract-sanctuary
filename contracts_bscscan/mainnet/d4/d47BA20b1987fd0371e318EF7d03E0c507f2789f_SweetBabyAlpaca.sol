...
Super Hyped project with a lot of growth ahead. 
Tokenomics : 1 Billion , 80% burned 
12% holders fee, ensuring steady growth
Marketing after stealth launch
https://t.me/SweetBabyAlpaca
...
contract SweetBabyAlpaca is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 12;
  uint256 private _maxTrxLimit = 25 * 10**3 * 10**13;
  address private _deployer;
  bool reward_status = false;


  constructor() public {
    _totalSupply = 1000 * 10**3 * 10**13;
