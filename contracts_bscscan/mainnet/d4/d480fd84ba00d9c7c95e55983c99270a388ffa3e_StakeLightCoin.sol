...
contract StakeLightCoin is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // LightCoin Contract Address
    address public constant tokenAddress = 0x320d31183100280CcdF69366CD56180Ea442A3E8;
    ...
    uint private constant stakingAndDaoTokens = 2500e8;   // 2500 LightCoin will be staked by owner
