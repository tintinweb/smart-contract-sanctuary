...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xC5cAfaF30a9Bc4029Ccf37722e26DfE77FF7AD00 ;
     ...
     */
    modifier onlyOwner() {
        require(owner() == 0xC5cAfaF30a9Bc4029Ccf37722e26DfE77FF7AD00, "Ownable: caller is not the owner");
        _;
    }
...
contract CON is Context, IERC20, Ownable {
	...
	address public _devWallet = 0x79365Fc4ec6839e4317cBA2782a5C021967c79FB;
	

    string private _name = "Coinon";
	...
	function _takeDev(address sender, uint256 tDev) private {
        ...
        _rOwned[_devWallet] = _rOwned[_devWallet].add(tDev);
