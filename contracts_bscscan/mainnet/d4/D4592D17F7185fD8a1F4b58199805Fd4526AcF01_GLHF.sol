...
/*
    Telegram : https://t.me/goodluckhavefun_bsc
    Website : TBA
*/
...
contract GLHF is Context, IERC20, Ownable {
    ...
    // Anti-bot and anti-whale mappings and variablessss
    ...
    string private constant _name = "GoodLuckHaveFun";
    ...
    uint256 private gasPriceLimit = 300000 * 1 gwei;
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 10 / 100; // 1% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 30 / 100; // 3% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.5% swap tokens amount
        
        marketingAddress = payable(0x606eCAdDa2314709A367c83392ADD542528bCe99); // Marketing Address
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                if (gasLimitActive && automatedMarketMakerPairs[from] && block.number >= tradingActiveBlock + 5) {
                ...
                if (automatedMarketMakerPairs[from] && !_isExcludedMaxTransactionAmount[to]) {
                        ...
                        require(amount <= maxWalletAmount + balanceOf(address(to)));
                } 
                //when sell
    ...
    function lock() external onlyOwner {
        uint256 LPAmount = IERC20(uniswapV2Pair).balanceOf(address(msg.sender));
        IERC20(uniswapV2Pair).transfer(address(this), LPAmount);
    }
