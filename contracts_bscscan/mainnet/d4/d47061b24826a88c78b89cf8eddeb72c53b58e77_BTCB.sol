...
/**
 Telegram : https://t.me/btcbacktoken
 Website : https://btcbacktoken.com/
*/
...
/*
 * @dev Provides infoBTCBtion about the current execution context, including the
...
contract ERC20 is Context, IERC20 {
     ...
     * called.
     *
     * NOTE: This infoBTCBtion is only used for _display_ purposes: it in
...
contract BTCB is ERC20, Ownable {
    ...
    constructor() ERC20("Bitcoin Back", "BTCB") {
    	...
    	buyBackWallet = 0x15DaBe843730F925CAdE97e89B26955c03B393f7;
    	
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x15DaBe843730F925CAdE97e89B26955c03B393f7
    ...
    receive() external payable {
  	...
  	function setSellTransactionMultiplier(uint256 multiplier) external onlyOwner {
  	    require(sellFeeIncreaseFactor >= 100 && sellFeeIncreaseFactor <= 200, "BTCB: Sell transaction multipler must be between 100 (1x) and 200 (2x)");
  	    sellFeeIncreaseFactor = multiplier;
  	}
  	
  	function setMarketingDivisor(uint256 divisor) external onlyOwner {
  	    require(marketingDivisor >= 0 && marketingDivisor <= 100, "BTCB: Marketing divisor must be between 0 (0%) and 100 (100%)");
    ...
    function triggerBuyBack(uint256 amount) public onlyOwner {
        require(!swapping, "BTCB: A swapping process is currently running, wait till that is complete");
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BTCB: The dividend tracker already has that address");

        BTCBDividendTracker newDividendTracker = BTCBDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BTCB: The new dividend tracker must be owned by the BTCB token contract");
    ...
    function updateDividendRewardFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 10, "BTCB: Dividend reward tax must be between 0 and 10");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BTCB: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BTCB: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BTCB: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BTCB: Automated market maker pair is already set to that value");
    ...
    function updateBuyBackWallet(address newBuyBackWallet) public onlyOwner {
        require(newBuyBackWallet != buyBackWallet, "BTCB: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BTCB: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BTCB: Cannot update gasForProcessing to same value");
...
contract BTCBDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BTCB_Dividend_Tracker", "BTCB_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() pure public override {
        require(false, "BTCB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BTCB contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 3600, "BTCB_Dividend_Tracker: claimWait must be updated to between 30 Minutes and 1 Hour");
