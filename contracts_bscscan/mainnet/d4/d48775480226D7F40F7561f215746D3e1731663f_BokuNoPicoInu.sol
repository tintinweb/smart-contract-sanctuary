...
// File: contracts/BokuNoPicoInu.sol


pragma solidity ^0.8.9;

contract BokuNoPicoInu is ERC20, Ownable {
    ...
    constructor () ERC20("Boku No Pico Inu", "BOKU") {
    ...
    function excludeFromAntiwhale(address account, bool value) external onlyOwner returns (bool) {
    ...
    function _transfer(
        ...
        if(!_isExcluded[sender] && !_isExcluded[recipient]){
            require(amount + balanceOf(recipient) <= maxAmount,"should be less than 1.5%");
        }
