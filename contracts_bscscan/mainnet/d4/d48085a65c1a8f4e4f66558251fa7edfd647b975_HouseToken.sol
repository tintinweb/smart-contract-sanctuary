...
contract HouseToken is IBEP20, Auth {
...
//mainnet: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    ...
    string constant _name = "House Token";
    ...
    constructor () Auth(msg.sender) {
        ...
        //tesnet factory: 0x6725F303b657a9451d8BA641348b6761A6CC7a17
        //mainnet factory:
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == pair &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"Please wait for 1block between two buys");
