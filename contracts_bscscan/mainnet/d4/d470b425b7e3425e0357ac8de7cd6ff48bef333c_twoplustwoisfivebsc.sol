...
/**
You know that political thing you don't like? That one leader that does something and you are personally effected by it?
Well that thing is exactly like 1984, come on, don't be shy. Grab out the old book.

Special words? 1984
Anything taught in school you don't agree with? 1984
An entire ethnic group being excluded? Tbh, not sure if that was in 1984, I might have to reread.

Anyhow, whatever it is, you can sound like you are a true intelligent person by bringing 1984 into the discussion. Because who needs arguments?

What does this have to do with cryptocurrencies? Fuck if I know. I liked the name, it's maybe not very bullish but whatever, I am just trying stuff out.
Testnet is for losers.
...
I forked spooderman for this, who forked another contract. But I forgot which one, I did change the taxes a bit to better fit. 
There is swap and liquify because of the liqfee, I am saying this for those that are a bit slow.
But then again they probably would not read dumb text in a contract/cms/tg whereever you saw it.

Ok, thanks, bye.

https://t.me/twoplustwoisfivebsc
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract twoplustwoisfivebsc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xCcfe754978FE64b12611FF99D1662D2C41235a7e); // Marketing Address

    address payable public teamAddress =
        payable(0x221593355b46f7Dd7AcF951C044e5bAE1b1cE56F); // Team Address

    address payable public liquidityAddress =
        payable(0xCcfe754978FE64b12611FF99D1662D2C41235a7e); // Liquidity Address
    ...
    string private constant _name = "Everything I personally dislike is exactly like George Orwell described in 1984";
    string private constant _symbol = "2+2=5";
