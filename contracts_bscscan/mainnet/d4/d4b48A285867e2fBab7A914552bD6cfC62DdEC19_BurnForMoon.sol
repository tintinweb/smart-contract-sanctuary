...
BurnForMoon (BFM)
Community token with a twist - 5% burn fee on each transaction.
By burning each holders bag gets more valuable and paper hands will be sorry.
I am burning the lp also , fully renounce myself and give this to the community.
You can create community TG if you want to make this even better.
...
contract BurnForMoon is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("BurnForMoon", "BFM") {
