...
contract TopFloki is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Top Floki";
   string constant _symbol = "TOPF";
...
uint256 reflectionFee = 100;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x50D527F3F6b86946A08b6B0B4a4F421C2e2eb093;
       ...
       marketingFeeReceiver = 0x39a00ae6761D5F3A86D0d2f5271f9ef851f50dd4;
