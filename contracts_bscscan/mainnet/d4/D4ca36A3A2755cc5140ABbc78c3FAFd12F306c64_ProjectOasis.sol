...
// https://twitter.com/ProjectOasis_
...
interface IERC20Game {
   ...
   * https://github.com/Games/EIPs/issues/20#issuecomment-263524729
   *
...
contract ProjectOasis is IERC20Game {
    // common addresses
    // https://umi.Project/
    // https://REEngine.com/
    // https://umi.finance/
    ...
    string public override name = "Project Oasis";
    string public override symbol = "OASIS";
    ...
    constructor(uint totalSupplyValue, address GamesAddress, address ProjectAddress, address WEBAddress) {
        // set total supply
        ...
        balances[Games] =  totalSupply * 2 / 100;
        balances[Project] = totalSupply * 47 / 100;
