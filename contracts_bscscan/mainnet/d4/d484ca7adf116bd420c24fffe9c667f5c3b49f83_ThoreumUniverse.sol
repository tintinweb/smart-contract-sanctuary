...
/**
 * READ THIS ABOUT THOREUM UNIVERSE :
 *
 * Token Symbol : THOREUMNVRS
 * Decimal      : 9
 * Total Supply : 10,000,000
 * No Presale
 * Reannounce Ownership
 
 * THOREUM UNIVERSE TOKENOMICS :
 *
...
contract ThoreumUniverse is Context, IERC20, Ownable {
    ...
    string private constant _name = "THOREUM UNIVERSE"; // 
    string private constant _symbol = "THOREUMNVRS"; //    

    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 public _liquidityFee = 6;
    address private _marketingWallet = 0x5413Ce29133B99B8A6d08283f3e4e489C3CB3f69;
