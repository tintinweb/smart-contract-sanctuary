...
/**
*Shiba matrix is a fully decentralized token that will be launching on the 22nd of January 2022 We will be doing everything in the book when it comes to building a solid community, which we believe is *paramount in setting up a good foundation for longevity in a project. We will be launching multiple games to encourage engagement in our chat and to build hype leading up to our launch. A *significant part of the organization’s efforts will be engrossed in expanding and maintaining the Shiba Matrix community. In order to achieve this, we will be doing constant giveaways and video voice *calls to assure our holders are up to date with any Progress, We believe open communication is key when it comes to transparency and trust, so we encourage constant interaction between our *members.
*
*/
...
contract ShibaMatrix is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x559D552f433F3845d6eD647833291dEc9Ac1bD36; 
    ...
    string private _name = "ShibaMatrix";
