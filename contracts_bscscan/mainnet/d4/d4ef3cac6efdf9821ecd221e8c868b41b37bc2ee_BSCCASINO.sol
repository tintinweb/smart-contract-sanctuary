...
contract BSCCASINO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSC Casino";
    string private _symbol = "$YD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB17F1f2fe147772EC786a9E992195491F63D318C);
    address payable public teamWalletAddress = payable(0xB17F1f2fe147772EC786a9E992195491F63D318C);
