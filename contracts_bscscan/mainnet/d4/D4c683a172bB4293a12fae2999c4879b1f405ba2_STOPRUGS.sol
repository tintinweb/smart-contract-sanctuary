...
/**
Who are we? A group of investors tired of being swindled.

No more robberies, now our time has come.

FOLLOW US IN TWITTER: https://twitter.com/STOPRUGSBSC

STOPRUGS GIVES YOU USDT JUST FOR HOLDING

WE DON'T HAVE A TELEGRAM CHANNEL, ANY NEWS WILL BE COMMUNICATED VIA TWITTER.
...
contract STOPRUGS is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "STOPRUGS";
    string constant _symbol = "STOPRUGS";
