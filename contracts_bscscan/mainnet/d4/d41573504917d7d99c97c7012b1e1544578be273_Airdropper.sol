...
contract ERC20 is Context, IERC20 {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(nowTotalAmount <= mintThreshold, "exceed the token threshold");
    ...
    function _setupThreshold(uint256 _threshold) internal {
        mintThreshold = _threshold;
    }

    function _mintThreshold() public view returns (uint256) {
...
contract StandardToken is ERC20Pausable {
    ...
    constructor(string memory name, string memory symbol, uint256 thresholdAmount, uint8 decimal) public ERC20(name, symbol) {
        factory = msg.sender;
    ...
    modifier onlyPauser(){
        require(pausers[msg.sender], "not allowed");
        _;
    }
...
contract Airdropper {
    ...
    function multisend(address[] memory dests, uint256[] memory values) public {
        uint256 i = 0;
    ...
    function changeToken(StandardToken _token) public  {
