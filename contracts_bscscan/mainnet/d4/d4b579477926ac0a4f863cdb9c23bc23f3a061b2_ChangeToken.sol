...
contract ChangeToken is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    // Token to Pay
    address public payToken = 0xa80Fa369382A4B2c7B1cf86ECf15b9E069ccf4D7;

    // Token to receive
    address public receiveToken = 0x3671580510Db6Fb4B872b3B3a5B052Aa191DD6CF;
    ...
    event SellYourToken(address indexed user,uint256 amount);
    ...
    function sellYourToken(uint256 _inputAmt) public {
        ...
        emit SellYourToken(msg.sender, sendAmount);
    }
}