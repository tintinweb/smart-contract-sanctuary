...
contract SeedifyFundsContract is Ownable {
    ...
    constructor(
        ...
        totalUserInTierOne = 18962;
        totalUserInTierTwo = 11377;
        totalUserInTierThree = 4136;
        totalUserInTierFour = 1896;
        totalUserInTierFive = 1197;
        totalUserInTierSix = 875;
        totalUserInTierSeven = 325;
        totalUserInTierEight = 151;
        totalUserInTierNine = 70;
