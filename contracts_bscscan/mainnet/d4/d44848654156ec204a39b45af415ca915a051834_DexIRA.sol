...
contract DexIRA is ERC20, Ownable {
    ...
    address public immutable migrationSwapContract;

    // uint256 public maxSellTransactionAmount = 1 * 10**12 * (10**9); // @note Equals 1e+21
    uint256 public maxSellTransactionAmount = 10000000 * (10**9); // @note Equals 1e+16 | 10,000,000

    // uint256 public swapTokensAtAmount = 100 * 10**9 * (10**9); // @note Equals 1e+20
    ...
    // @note tradingIsEnabled
    uint256 public immutable tradingEnabledTimestamp = 1626483600; // @note tradingIsEnabled
    ...
    constructor() ERC20("TEST_Dex_2", "TEST_Dex_2", 9) {
        ...
        // airDropLimitLiftDate = block.timestamp + 10 days; // @note 10 day restrictions on Air Drop recipients
        ...
        // @note tradingIsEnabled
        dividendTracker.excludeFromDividends(_migrationSwapContract);
        ...
        canTransferBeforeTradingIsEnabled[_migrationSwapContract] = true;

        /*
            _mint is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        // _mint(owner(), 1 * 10**15 * (10**9)); // @note Equals 1e+24 | Set supply to 1,000,000,000,000,000 (without override)
...
contract DexIRADividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("TEST_Dex_2_Dividend_Tracker", "TEST_Dex_2_Dividend_Tracker", 9) {
    	claimWait = 3600;

        // minimumTokenBalanceForDividends = 30 * 10 ** 9 * (10**9); // @note Equals 3e+19 | Must hold 30,000,000,000+ for dividends
