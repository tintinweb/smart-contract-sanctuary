...
contract GOLcoin is Context, IERC20, Ownable {
    ...
    uint256 private excludedUpperLimit = 100;
   ...
   function setBpEnabled(bool _enabled) external onlyOwner {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        ...
        _excluded.push(account);
         require(_excluded.length <= excludedUpperLimit,"UpperLimit reached");
    ...
    function setExcludedUpperLimit(uint256 limit) external onlyOwner {
        excludedUpperLimit = limit;
    }
    ...
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out GOL!");
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
       ...
       _rOwned[marketingAddress] = _rOwned[marketingAddress].add(rFee);
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        uint256 allow = allowance(address(this), address(uniswapV2Router));
