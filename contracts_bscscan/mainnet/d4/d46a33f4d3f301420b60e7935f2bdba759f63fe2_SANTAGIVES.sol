...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD32B437261Ba84fdEA0488b2097ABd4edf6F691E;
...
contract SANTAGIVES is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x69dF9aa21558E06708764Cb25150B14C197dBF88;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 800000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SANTAGIVES";
    string private _symbol = "SANTAGIVES";
    ...
    uint256 private numTokensSellToAddToLiquidity = 80000000 * 10**9;
