...
contract XMASELON is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 10000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "MERRY CHRISTMAS";
    string public _symbol = "XMASELON";
    ...
    address private marketingWallet = owner();
