...
/*
Fight against mini talibans earning rewards in USDT 
10% Fee for holders & NO DEV WALLET & LP LOCKED

Telegram: https://t.me/MiniTaliban
                         .-----------------TTTT_-----_______
...
contract MiniTaliban is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniTaliban";
    string constant _symbol = "TALI";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x00467C957C71aF29a4733A052C3Bec84c87a0061; //WALLET DEV
