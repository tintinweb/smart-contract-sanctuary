...
contract TestKird is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x000000000000000000000000000000000000dEaD);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xF1A49Af6a8A922D4e2E00fED92fD5c9730E6290b); 

    string private _name    = "Kird Inu";
    string private _symbol  = "$KRD";
    ...
    uint256 public _reflectionFee           = 50;
    uint256 private _previousReflectionFee  = _reflectionFee;

    uint256 public _externalFee             = 0;
