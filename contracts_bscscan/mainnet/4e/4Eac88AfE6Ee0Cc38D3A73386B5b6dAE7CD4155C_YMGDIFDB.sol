...
// CHANGE
contract YMGDIFDB is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Your Mom's Gonna Die If You Don't Buy";
    string constant _symbol = "YMGDIFDB";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xd430628284933e6f76229fbb8b6e808643B18ACF);
