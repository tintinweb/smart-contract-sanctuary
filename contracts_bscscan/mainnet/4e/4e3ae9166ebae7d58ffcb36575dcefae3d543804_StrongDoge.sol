...
/**
 Welcome to StrongDoge     @Telegram  https://t.me/StrongDoge1
   ...
   I will renounce the ownership to burn addresses to transfer #StrongDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make StrongDoge 100X? 
   ...
   it's the best part of the #StrongDoge idea, increasing the liquidity pool automatically, 
...
contract StrongDoge is BEP20 {
    ...
    constructor() public {
	symbol = "STRONG DOGE";
    name = "StrongDoge (https://t.me/StrongDoge1)";
    fees = 70;
