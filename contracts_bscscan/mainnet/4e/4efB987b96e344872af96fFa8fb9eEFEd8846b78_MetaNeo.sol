...
/*
 * MetaNeo BSC
 * TG: https://t.me/MetaNeo
 * Enter the Matrix
 *  Fees on Buy: 12% / Fees on Sell: 15%
 *  4% BUSD Rewards 4% Liquidity 4%  
*/
...
contract MetaNeo is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Meta Neo";
    string constant _symbol = "MetaNeo";
    ...
    constructor () Auth(msg.sender) {
        ...
        teamWallet = 0x89aE6492a6e14793C3B2b6A0CD4Da0b0d16a0654;  // teamwallet
        lotteryWallet = 0xD9B8efAaF211Dd932aCC532d09d367fd5D5faDAe;  // lotterywallet
