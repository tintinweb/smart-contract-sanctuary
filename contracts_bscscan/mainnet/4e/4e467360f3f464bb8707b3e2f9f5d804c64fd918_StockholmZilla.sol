...
/**
   ...
   Welcome to Stockholm Zilla
   
   Based on elon tweet https://twitter.com/elonmusk/status/1452373897366618112?s=21
   
   This is a community token. If you want to create a telegram I suggest to name it to @StockholmZilla
   ...
   Can you make #StockholmZilla 10000X? 
...
contract StockholmZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb392A7Ad0a6DF116478E1D62C418eFb554d576eA); // Marketing Address
    ...
    string private _name = "Stockholm Zilla";
    string private _symbol = "SZA";
