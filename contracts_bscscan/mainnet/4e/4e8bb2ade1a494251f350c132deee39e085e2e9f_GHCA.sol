...
contract GHCA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 26000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GHCA TOKEN";
    string private _symbol = "GHCA";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 3; // 3% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 7; // 3% added to liquidity 
    ...
    uint256 public _maxWalletToken = 26000000000 * 10**18;
