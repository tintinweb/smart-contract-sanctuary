 ...
 * 375,000,000 Max walet / max trasnsaction (2.5%)
 *
 * 12% Fee: 5% to Boge hodlers, 7% back into liqidty
 *
 * LP tokens will be burned.
 * Ownership will be renounced.
 *
 * 2% airdropped for dev & marketing wallet
 * 
 * https://boge.money
 *
 */
...
contract BOGE is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 375 * 10**6 * 10**9;
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 375 * 10**6 * 10**9;

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'Boge';
