...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            TOKENPAIR = 0xFb2396755872B4609EEB9AAdB6156Bb56F094ef6;
        _token = msg.sender;
    }
...
contract TigerChibi is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xa563B6860428b954D7BdeE8d268763E9551775Fe;
    address DevWallet       = 0x5d268DAE251Cb9c92D6AdEA0252b44B10C18c12B;

    string constant _name = "Tiger Chibi";
    string constant _symbol = "Tiger Chibi";
