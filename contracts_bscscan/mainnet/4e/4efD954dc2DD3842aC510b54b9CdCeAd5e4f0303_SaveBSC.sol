...
contract SaveBSC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa1a0233f4ABaE2EbBaaA02BDc880185ac28Cee64); // Marketing Address
    ...
    string private _name = "SaveBSC";
    string private _symbol = "SaveBSC";
