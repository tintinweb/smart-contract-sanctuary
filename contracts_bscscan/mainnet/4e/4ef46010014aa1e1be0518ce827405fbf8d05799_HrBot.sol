...
contract Ownable is Context {
    address private _owner = 0xF610f22Acb94ABEe089E34EABbE24f9ad5612CdE;
...
contract HrBot is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Humanoidrobot"; // token name
    string private _symbol = "HrBot"; // token symbol
