...
/*
    ...
    GangLegends aims to develop the first of its kind NFT game, 
    which aims to combine real life and the virtual space in a game. 
    This project aims to develop and bring about a revolutionary change 
    to the NFT gaming space with mechanics that have never been developed before.

    TOKENOMICS
    
    Total Supply: 1,000,000,000,000,000
    60% supply will be burnt after launch
    40% liquidity pool will be sent to dead wallet
    ...
    No Dev wallets
    AntiWhale-MaxTransactions 20B
    ANTI RUG embedded in code
    Anti-Dump mechanis

    www.ganglegends.io
    t.me/GangLegends
    twtitter/GangLegendsio
...
contract GangLegends is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "GangLegends";
