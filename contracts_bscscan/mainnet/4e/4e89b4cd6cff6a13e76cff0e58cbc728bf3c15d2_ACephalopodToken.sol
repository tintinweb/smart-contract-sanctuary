...
/**
   ...
   Welcome A Cephalopod Token
   
   This is a community token. If you want to create a telegram I suggest to name it to @ACephalopodTokenBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ACephalopodToken BSC to the community, make sure it's 100% safe.

   I will add .4 BNB and all the left 10% total supply to the pool
   Can you make #ACephalopodToken BSC 10000X?
...
contract ACephalopodToken  is Context, IERC20, Ownable {
    ...
    string private _name = "A Cephalopod Token";
