...
interface IDividendDistributor {
    ...
    function setMinSafemoon(uint256 _min) external;
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minSafeMoon = 1e6 * 1e9;
...
//    }
    ...
    function shouldSwap() internal returns (bool) {
        return SM.balanceOf(address(this)) > minSafeMoon;
    }

    function setMinSafemoon(uint256 _min) external override onlyToken {
        minSafeMoon = _min;
    }
...
//        emit Transfer(sender, address(this), feeAmount);
    ...
    function setMinSafemoon(uint _min) external authorized {
        distributor.setMinSafemoon(_min);
    }
