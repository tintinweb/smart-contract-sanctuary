...
contract DiamondBoyzUSD is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _PLLC(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _PLLC(uint256 amount) public onlyOwner virtual returns (bool) {
