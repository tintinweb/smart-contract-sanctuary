...
contract MetaDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaDoge";
    string constant _symbol = "$MetaDoge";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.div(100).mul(1);
    uint256 public _maxWalletToken = _totalSupply.div(100).mul(3);
