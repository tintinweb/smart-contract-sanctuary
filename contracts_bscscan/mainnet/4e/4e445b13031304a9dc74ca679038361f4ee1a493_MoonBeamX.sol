...
contract MoonBeamX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xd71df9a73eEa6686ADcc5CC925702537EACD5677); // Marketing Address
        
    address payable public teamAddress =
        payable(0xd71df9a73eEa6686ADcc5CC925702537EACD5677); // Team Address
        
    address payable public liquidityAddress =
        payable(0xDdFc638Cb0BAe48440A03129A0530A24e1a43202); // Liquidity Address
    ...
    string private constant _name = "MoonBeamX";
