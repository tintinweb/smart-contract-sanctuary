...
contract LaughingEmojiBSC is Context, IERC20, Ownable {
    ...
    address private _marketingAddress = 0x96FDDFBa01D9e5c03c2885b154574731b0b23988;
    address private _donationAddress = 0x96FDDFBa01D9e5c03c2885b154574731b0b23988;

    string private _name = "Adult Baby Diapers";
    string private _symbol = "DIAPER";
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount - tFee - tLiquidity;
                ...
                tTransferAmount = tTransferAmount - tDonation;
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tMarketing, uint256 tDonation, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount - rFee - rLiquidity - rMarketing - rDonation;
    ...
    function _takeMarketingFee(uint256 tMarketing) private {
        uint256 currentRate =  _getRate();
        uint256 rMarketing = tMarketing * currentRate;
        _rOwned[_marketingAddress] = _rOwned[_marketingAddress] + rMarketing;
        if(_isExcluded[_marketingAddress])
            _tOwned[_marketingAddress] = _tOwned[_marketingAddress] + tMarketing;
    }
