...
/**
   ...
   Welcome to BabyPolygon
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyPolygon
   ...
   I will renounce the ownership to burn addresses to transfer #BabyPolygon to the community, make sure it's 100% safe.
   ...
   it's the best part of the #BabyPolygon idea, increasing the liquidity pool automatically, 
...
contract BabyPolygon is Context, IERC20, Ownable {
    ...
    string private _symbol = "BabyPolygon";
