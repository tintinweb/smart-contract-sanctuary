...
// Lord Ghozali
// The new meme tokens of ghozali_Ghozalu nft’s, we make this
// tokens for everyone who loves and appreciate for what
// ghozali does to dedicate himself on crypto world. Long live
// the king ghozali
//
// telegram : t.me/LordGhozali
...
contract LordGhozali is Context, IERC20, Ownable {
    ...
    //
    string private _name = "LordGhozali";
    string private _symbol = "LG";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10**9 * 10**_decimals;
    //
    address payable public marketingAddress = payable(0xFe4950a54f8d378ebFA41B238a301c33a25e1884);
    //
