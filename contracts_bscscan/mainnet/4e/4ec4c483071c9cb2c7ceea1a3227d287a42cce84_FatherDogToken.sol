...
Telegram : https://t.me/fatherdogtoken
...
contract FatherDogToken is BSC, Math {
    string public name =  "FatherDogToken" ;
    string public symbol =  "FDT";
    uint8 public decimals = 9;
    uint public _totalSupply = 1*10**10 * 10**9;
