...
/**Welcome to BabyPancake
   ...
   I will renounce the ownership to burn addresses to transfer #BabyPancake
   to the community
   Can you make #BabyPancake
   100X? 
   ...
   it's the best part of the #BabyPancake
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract BabyPancake is Context, IBEP20, Ownable {
