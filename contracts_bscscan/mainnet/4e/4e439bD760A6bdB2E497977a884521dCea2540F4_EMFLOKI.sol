...
contract Ownable is Context {
    address private _owner = 0x389655B098a729f1BDcD6ddFf02654dFBbb4fd73;
...
contract EMFLOKI is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xA552a9C4B9A6e3C0c40d2432F934a9b0336eA28c); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "EMFLOKI"; // token name
    string private _symbol = "EMFLOKI"; // token symbol
