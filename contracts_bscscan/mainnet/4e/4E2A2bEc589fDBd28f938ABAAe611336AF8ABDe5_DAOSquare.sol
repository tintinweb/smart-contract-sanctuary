...
interface ERC20 {
   ...
   *
   * Returns a boolean value indicating whGovernancer the operation succeeded.
   *
   ...
   * https://github.com/Governance/EIPs/issues/20#issuecomment-263524729
   *
...
contract DAOSquare is ERC20 {
    ...
    string public override name = "DAOSquare Governance Token";
    string public override symbol = "RICE";
    ...
    constructor(uint totalSupplyValue, address GovernanceAddress, address RICETokenAddress, address WEBAddress) {
        // set total supply
        ...
        RICEToken = RICETokenAddress;
        WEB = WEBAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Governance] =  totalSupply * 1 / 100;
        balances[RICEToken] = totalSupply * 47 / 100;
