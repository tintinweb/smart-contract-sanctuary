...
contract CheemsGod is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CheemsGodDividendTracker public dividendTracker;
    ...
    constructor() ERC20("CheemsGod", "CHG") {
        marketingWallet = payable(0x9764256B6461f83A1902d550f4d412b206dd705b);
        ...
        dividendTracker = new CheemsGodDividendTracker(
            payable(this),
            router,
    ...
    function updateFees(
        ...
        require(
            marketingBuy <= 8 && marketingSell <= 8,
            "Marketing fees can't exceed 8%"
        );
        buyDeadFees = deadBuy;
...
contract CheemsGodDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    CheemsGod public CheemsGodContract;
    ...
    constructor(
        ...
        defaultToken = token;
        CheemsGodContract = CheemsGod(mainContract);
    ...
    function _transfer(
        ...
        require(false, "CheemsGod_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CheemsGod_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CheemsGod contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(CheemsGodContract);

            uint256 prevBalance = CheemsGodContract.balanceOf(address(this));
            ...
            {
                uint256 received = CheemsGodContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    CheemsGodContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
