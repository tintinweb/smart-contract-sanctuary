...
earncakeeth is the first contract to pay double reward
Pioneers in granting double rewards to holders. Rewards every 2 hours. 

Verified and 100% secure contract

TELEGRAM: https://t.me/EarnCakeEth
...
contract earncakeeth is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "earncakeeth";
    string constant _symbol = "earncakeeth";
