...
/**
 * Join our TG: https://t.me/community_4chan_token

 Ownership Renounced - Lp Locked - Contract verified = Safety guaranteed (check on tokensniffer)
 Happy x100 to all the 4Chan Community!
*/
...
contract FOURCHAN is Context, IERC20, Ownable {
    ...
    string private constant _name = "4CHAN COMMUNITY TOKEN"; // 
    string private constant _symbol = "4CHANT"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 5;
    
    address public _marketingWallet = 0xf1E2359EB3b942f331f2A6f5f17571D79d0DD749;
