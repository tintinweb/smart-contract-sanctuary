...
contract DroidVerse is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'DroidVerse';
    string private constant _symbol = 'DroidVerse';
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell){  
            ...
            uint SellTaxDuration2=5 seconds;
            if(block.timestamp<LaunchTimestamp+SellTaxDuration2){
                ...
                tax=_getStartTax2(SellTaxDuration,980);
                } else {
                        tax=sellTax;
                }
            }
