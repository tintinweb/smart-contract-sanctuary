...
/**
       Cash FEG auto $FEG Redistribution 
         We took your $FEG is a favorite coin and made it much better, with $FEG reward,Auto Yield Farms, Swap DApp, and NFT Marketplace. 
	 $CashFEG is the new reflection project with an actual utility on top of the community's efforts to hodl and grow.
 */
...
contract CashFEG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cash FEG";
    string constant _symbol = "CashFEG";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x80568E061Bcf15D6B76A001ee4583486f15b5994;
