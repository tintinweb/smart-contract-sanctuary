...
/**
 It's always calm before storm hits,
 like Hurricane Ida it was calm and subtle before the storm hit.
 
 As we all know ADA is coming.
 and as always it will always be calm before the storm hits.

 Reason why I'm launching $HricnADA is because I am so tired of scammers
 ruining every ecoystem. Degens are leaving defi scene
 Rugs and Scams are whats left and something must be done.
 I haven't seen anyone stepped up with basic shitcoin to ground this
 so here I am. 
 since Cardano is my main interest, we might as well earn $ADA while shitcoining.
 A true Shitcoin without website and exetera.
 driven by pure hype and Power of mouth to mouth marketing.
 
 if you'd like to join this movement 
 we are at TG: hricnada
...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); 
...
contract HurricaneIda  is IERC20, Auth {
    ...
    string constant _name = "HurricaneIda";

    string constant _symbol = "$HricnADA";

    uint8 constant _decimals = 9;



    uint256 _totalSupply = 20210829 * (10 ** _decimals);  
    ...
    constructor () Auth(msg.sender) {
        ...
        isMaxWalletExempt[0xa9D5C6543d7D3A8376998e2b1cAaBECbB0DF7470] = true;
