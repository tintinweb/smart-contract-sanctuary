...
contract FastansyWorldofWarriorsEGames is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Fastansy World of Warriors EGames';
    string  private constant _SYMBOL = 'EGAMES';
