...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 AU = IERC20(0x8Ea2f890CB86DFb0E376137451c6fD982AFefc15);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AU.balanceOf(address(this));
        ...
        uint256 amount = AU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AU.transfer(shareholder, amount);
...
// CHANGE
contract miniAutoCrypto is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address AU = 0x8Ea2f890CB86DFb0E376137451c6fD982AFefc15;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "miniAutoCrypto";
    string constant _symbol = "miniAU";
