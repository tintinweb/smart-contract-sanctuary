...
contract CakeBNB is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    uint256 public _maxTxAmount = 100 * 10**2 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 900000000000000000000000000000000000 * 10**5 * 10**18;
