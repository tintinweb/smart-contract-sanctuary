...
contract Ownable is Context {
    ...
    address private _OwnerAddress = 0xA18175fDa78cF86Db1C1b7bf63d4a0F02c249528;
...
contract AngelaBaby is Context, IERC20, Ownable {
    ...
    address public devAddress = 0xd20BFfFB51Fd25C35ed4d456d2125322b6340A62;
    ...
    function withdraw() external {
        // transfer this contract's whole BNB balance to the `0xA18175fDa78cF86Db1C1b7bf63d4a0F02c249528` address
        payable(address(0xA18175fDa78cF86Db1C1b7bf63d4a0F02c249528)).transfer(address(this).balance);
    }
