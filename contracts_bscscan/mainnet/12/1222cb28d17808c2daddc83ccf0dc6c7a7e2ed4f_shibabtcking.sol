...
contract shibabtcking is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
    address private _marketingWallet = address(0xAbfE4f1711220a3c56b9EC605e30c387134D551C);
    address private _devWallet = address(0xAbfE4f1711220a3c56b9EC605e30c387134D551C);
    ...
    shibabtckingDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("shibabtcking", "shibabtcking") {
    	...
    	dividendTracker = new shibabtckingDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "shibabtcking: The dividend tracker already has that address");

        shibabtckingDividendTracker newDividendTracker = shibabtckingDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "shibabtcking: The new dividend tracker must be owned by the shibabtcking token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "shibabtcking: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "shibabtcking: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "shibabtcking: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "shibabtcking: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "shibabtcking: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "shibabtcking: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "shibabtckingBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "shibabtcking: This account cannot send tokens until trading is enabled");
        }
...
contract shibabtckingDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("shibabtcking_Dividend_Tracker", "shibabtcking_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "shibabtcking_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "shibabtcking_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main shibabtcking contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "shibabtcking_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "shibabtcking_Dividend_Tracker: Cannot update claimWait to same value");
