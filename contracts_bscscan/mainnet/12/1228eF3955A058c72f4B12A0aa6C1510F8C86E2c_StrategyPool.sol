...
contract StrategyPool is Ownable, Pausable, GasThrottler {
    ...
    address constant public want = address(0x40B34cC972908060D6d527276e17c105d224559d); // token do pool SEED
    ...
    address constant public masterchef = address(0xA9a438B8b2E41B3bf322DBA139aF9490DC226953);
    uint8 constant public poolId = 24;
