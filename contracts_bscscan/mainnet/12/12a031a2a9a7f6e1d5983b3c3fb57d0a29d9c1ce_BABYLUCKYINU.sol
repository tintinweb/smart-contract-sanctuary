...
/**
 *
  Official BABY LUCKY INU Binance Smart Chain Token
...
contract BABYLUCKYINU is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BABYLUCKY";
  string private _name = "BABY LUCKY INU";
