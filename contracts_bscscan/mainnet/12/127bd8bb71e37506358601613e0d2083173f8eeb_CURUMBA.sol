...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x20AeF1a2D8F8cE4032fD7C70093de3eCFC288E66;
...
interface IUniswapV2Factory {
    ...
    function setBurnFee(address) external;
}
...
contract CURUMBA is Context, IERC20, Ownable {
    ...
    string private _name = "Curumba";
    string private _symbol = "CURUMBA";
