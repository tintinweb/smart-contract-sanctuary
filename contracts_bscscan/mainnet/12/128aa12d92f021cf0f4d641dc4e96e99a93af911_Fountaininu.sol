...
contract Fountaininu is Context, IERC20, Ownable {
    ...
    string private _name = "FOUNTAIN INU";
    ...
    address public charityWallet = 0x5E8D0590346d560c235Cf518C12C98DbE7f28B87;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x3B6A9AFA9c741989C4c03161d81FA8306f188e3B, 'We can not exclude Pancake router.');
    ...
    function removeAllFee() private {
        if(_taxFee == 5 && _liquidityFee == 5 && _charityFee== 5 && _burnFee==1) return;
