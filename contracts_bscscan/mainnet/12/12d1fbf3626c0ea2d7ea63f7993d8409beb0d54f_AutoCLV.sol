...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CLV = IBEP20(0x09E889BB4D5b474f561db0491C38702F367A4e4d);
    ...
    function deposit() external payable override {
        uint256 balanceBefore = CLV.balanceOf(address(this));
        ...
        uint256 amount = CLV.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CLV.transfer(shareholder, amount);
    ...
    event Deposit(uint256 amountBNB, uint256 amountCLV);
...
contract AutoCLV is IBEP20, Auth {
    using SafeMath for uint256;

    address CLV = 0xaEC945e04baF28b135Fa7c640f624f8D90F1C3a6;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AUTO CLV";
    string constant _symbol = "AUTOCLV";
