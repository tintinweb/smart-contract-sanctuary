...
Holiday Token is working hard to put smiles on faces of underpriviled kids every holiday season. Join the Holiday revolution, earn 8% BUSD stable coin rewards, and give back every holiday season and beyond.

holidaytoken.finance
https://t.me/holidaytokencommunity
https://www.facebook.com/HolidayToken
...
contract HolidayToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Holiday Token";
    string constant _symbol = "HOL";
    ...
    address public marketingFeeReceiver=0xEB32f32cCd81b7c4D2A1DF789fADC741e88b7946;
