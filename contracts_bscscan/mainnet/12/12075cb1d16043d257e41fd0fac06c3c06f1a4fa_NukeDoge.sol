...
abstract contract DumpProtectedToken is Ownable {
    ...
    uint256 private _dumpRate = 20**5 * 10**9;
    ...
    function getDumpRate() view external returns(uint256) {
        return _dumpRate.div(10**9);
    }
 ...
 */
contract NukeDoge is Context, Ownable, IERC20, DumpProtectedToken, GasThrottled {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "NukeDOGE";
    string private _symbol = "NUKED";
    ...
    //address payable public _marketingAddress = payable(); // Testnet
    //address payable public _charityAddress = payable(); // Testnet
