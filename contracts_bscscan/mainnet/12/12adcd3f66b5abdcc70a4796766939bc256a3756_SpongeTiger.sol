...
contract SpongeTiger is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xbABB325779b30D967183bF8a019b9E959Eb92E60));
    address payable public _teamwallet =
        payable(address(0x0112BC0705Bf059e3237fB61D1ee963705BBe941));
    address _partnershipswallet =
        payable(address(0x41912Dfef81508470Bb648F67BE9b410CBa2Df5c));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "SpongeTiger";
