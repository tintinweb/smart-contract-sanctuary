...
"Because he's the hero BSC deserves, but not the one it needs right now."
...
contract  FlokiBatman is IERC20, Context, Ownable {
    ...
    // token data
    string constant _name = "FlokiBatman";
    string constant _symbol = "FlokiBatman";
    ...
    uint256 totalFeeSells = 500;
    uint256 totalFeeBuys = 0;
    // receiving addresses
    address public autoLiquidityReceiver;
    
    address public marketingFeeReceiver = 0x417d90336111C76b98f2493114B9C25932a2dBDf;
