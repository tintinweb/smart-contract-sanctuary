...
contract StreamBusiness is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Stream Smart Business";
    string constant _symbol = "SSB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 20000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 140; // 140k
    uint256 public _maxWalletToken = _totalSupply / 10; // 1kk;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xEa960961c33E95A6E6985EDCe8bDDE05EBc4425c;
