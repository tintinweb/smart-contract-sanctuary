...
contract MechShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3cC5bF8C77176141c5F7F3203685e0b0BEcb3B48); // Marketing Address
    ...
    string private _name = "MechShiba";
    string private _symbol = "MECHSHIB";
    ...
    uint256 public _intervalMinutesForSwap = 1 * 1 hours;
    ...
    uint256 public _buyBackTimeInterval = 1 hours;
    uint256 public _buyBackMaxTimeForHistories = 24 * 10 hours;
    ...
    function SetBuyBackMaxTimeForHistories(uint256 newMinutes) external onlyOwner {
        _buyBackMaxTimeForHistories = newMinutes * 1 hours;
    }
    ...
    function SetBuyBackTimeInterval(uint256 newMinutes) external onlyOwner {
        _buyBackTimeInterval = newMinutes * 1 hours;
    }
    ...
    function SetSwapMinutes(uint256 newMinutes) external onlyOwner {
        _intervalMinutesForSwap = newMinutes * 1 hours;
    }
