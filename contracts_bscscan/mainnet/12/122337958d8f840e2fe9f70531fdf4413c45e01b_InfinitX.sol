...
/** 
InfinitX ($INX) is the first Reward&Rebase token to combine a high rate of rewards in $XRP with an advanced rebase system.
Total Tax = buy 12% | sell 16%
This token was fair launched on October 19, 2021

Website: https://infinitx.io
TG: https://t.me/infinit_x
Twitter : https://twitter.com/Infinitx_token
*/
...
contract InfinitX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x97A3339fcA7e699E1Ec470099aCFb2a4E2b60DCA); // Marketing Address
    ...
    uint256 private _whaleNeedsPrevention = 16;
