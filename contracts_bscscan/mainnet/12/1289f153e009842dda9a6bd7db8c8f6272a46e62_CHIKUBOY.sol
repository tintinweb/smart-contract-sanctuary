...
/**
 * 
Chiku Boy the next MoonShot
While Chiku INU is on the big run we would like to join the hype train and follow the hype
u don't wanna miss this one

tax is 10% divided to:
5% BUSD reward
3% marketing
2% auto - liquidity

Visit our TG : https://t.me/chikuboy
*/
...
contract CHIKUBOY is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CHIKU BOY"; 
    string constant _symbol = "CHIKUBOY";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x3C9f5C0A4A4b502302E26536F06A09D18152F4c2);
