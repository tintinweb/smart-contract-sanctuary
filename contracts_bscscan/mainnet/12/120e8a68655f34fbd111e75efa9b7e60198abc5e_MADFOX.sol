...
/*
    ...
    PRE-SALE MONDAY 23rd 16:00 subtraction
    t.me/madfoxcoin
...
contract MADFOX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mad Fox";
    string constant _symbol = "MADFOX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 80;
