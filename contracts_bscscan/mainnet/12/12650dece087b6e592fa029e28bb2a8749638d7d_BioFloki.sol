...
contract BioFloki is Context, IBEP20, Ownable {
    ...
    string public constant name     = "BioFloki";
    string public constant symbol   = "BFLOKI";
    uint8  public constant decimals = 18;
    
    // transfer fee
    uint256 public _taxFeeTransfer       = 200;
    uint256 public _liquidityFeeTransfer = 300; 
