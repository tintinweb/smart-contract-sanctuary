...
contract MINICRYPTOMINESREBORN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("MINICRYPTOMINES REBORN ", "MCMR") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "MINICRYPTOMINESREBORN";
    string private _symbol = "MCMR";
