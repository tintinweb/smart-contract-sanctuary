...
contract MasterChef is Ownable, ReentrancyGuard {
  ...
  // Initial emission rate: 1 STARSHIP per block.
    ...
    // Minimum emission rate: 0.00 STARSHIP per block.
    ...
    // Bonus muliplier for early starship makers.
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 starshipReward = multiplier.mul(starshipPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        starship.mint(devAddress, starshipReward.div(15));
    ...
    function updateEmissionRate() public {
        ...
        require(starshipPerBlock > MINIMUM_EMISSION_RATE, "updateEmissionRate: Emission rate has reached the minimum threshold");
