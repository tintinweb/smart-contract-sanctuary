...
contract Spacewar is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xde97771c2c4428D7e7B28836F0d2B83024F510d2); // Marketing Address
    ...
    string private _name = "Spacewar";
    string private _symbol = "SWAR";
