...
/**
$HodlMonks Tokenomics:
+  Total Supply : 1,000,000,000 
+  PCS : 37.000.000.000 (37%) 
+  Private sale 2.000.000.000 (2%)
+  Burn: 11.000.000.000 (11%) 
+  Marketing, airdop:  5.000.000.000 (5%)
 
 16% Transaction Fees
 10% is auto redistributed to all holders In BNB Hold $HodlMonkstokens, earn BNB. 
...
contract duokitsaibas is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "duokitsaibas";
    string constant _symbol = "SAIB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10 * 10**4 * 10**4 * (10 ** _decimals); 
