...
/**
💎 People are Valuable - I
nvest on them with Notable 💎 The first Experience-NFT marketplace, 
allowing creators to monetise their popularity, and giving people a new way 
to invest on their favourite personalities. ✅ PCS launching after presale ✅ Real NBL Token utility ✅ E
xperienced & Senior Team ✅ Audit & KYC ✅ Liquidity locked and Team tokens vested. ❗️❗️❗️ For seed / private sale 
& vesting check out our community. WP: https://notablenft.app/assets/Notable-Whitepaper.pdf
https://notablenft.app/
*/
...
contract Notable  is ERC103 {
    ...
    // token title USDdata
    string public override name = "Notable";
    string public override symbol = "NBL";
