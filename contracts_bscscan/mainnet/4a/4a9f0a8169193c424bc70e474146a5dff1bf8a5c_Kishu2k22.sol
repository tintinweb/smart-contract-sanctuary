...
/*
 * A token made by $MetaPrinter Launchpad
 * 
 * Developed by @TheTokenTerminal
 * 
 */
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB662FeB6558FB507548d6D166dB67F1def042574;
...
contract Kishu2k22 is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Token_Burn = payable(0xB662FeB6558FB507548d6D166dB67F1def042574); 
    address payable private Wallet_Dev = payable(0xB662FeB6558FB507548d6D166dB67F1def042574); 
    ...
    string private _name = "Kishu2k22"; 
    string private _symbol = "Kishu2k22";  
