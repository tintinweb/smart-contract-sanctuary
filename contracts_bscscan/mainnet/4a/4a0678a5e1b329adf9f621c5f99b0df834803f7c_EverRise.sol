...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2eAD0A2b7a5cA5Ffc8528c6F08f55A26b3fd107B); // Marketing Address
    ...
    uint256 private _tTotal = 2022000000000000000 * 10**6 * 10**9;
