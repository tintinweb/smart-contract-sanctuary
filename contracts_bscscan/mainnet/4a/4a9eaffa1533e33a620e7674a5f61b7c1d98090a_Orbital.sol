...
Orbital Official The project starts with an introduction to the Orbit, creating an interactive Orbit model that will serve as the base for future exploration.
The project starts with an introduction to the Orbit, creating an interactive Orbit model that will serve as the base for future exploration
...
━━━━━━━━━━━━━━━━━━━
Telegram: https://t.me/ORBITALOFFICIALS
Website: https://www.orbitalofficial.website/
*/
...
contract Orbital is ERC20, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() ERC20("Orbital Official", "ORBITAL")  {
