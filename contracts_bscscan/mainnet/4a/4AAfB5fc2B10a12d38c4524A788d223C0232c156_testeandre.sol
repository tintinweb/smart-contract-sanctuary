...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // bnb
...
contract testeandre is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("teste andre", "teste") {
        ...
        maxWallet = totalSupply * 1 / 200; // 0,5% Max wallet
    	...
    	marketingWallet = address(0x5D4514b8b823F2eefd80df98035687ed1434C36c); // set as marketing wallet
    ...
    function swapBack(uint256 contractTokenBalance) internal {
        ...
        (success,) = address(0x5D4514b8b823F2eefd80df98035687ed1434C36c).call{value: amountBNBDev}("");
