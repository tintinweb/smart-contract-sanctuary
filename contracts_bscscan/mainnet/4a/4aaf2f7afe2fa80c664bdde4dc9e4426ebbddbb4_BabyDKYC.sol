...
DKYC is the hottest project in BSC right now. Let's make some DKYC while sending this to the outer space!
Stealthy la
- 8% DKYC rewards
- 5% liquidity tax
- 3% marketing fee
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xdf5Fac537aa09e1eb0F3f8DD1d34CBdC42CA1076); //the reward token you want distributed 
...
contract BabyDKYC is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xdf5Fac537aa09e1eb0F3f8DD1d34CBdC42CA1076; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyDKYC";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "BDKYC";
