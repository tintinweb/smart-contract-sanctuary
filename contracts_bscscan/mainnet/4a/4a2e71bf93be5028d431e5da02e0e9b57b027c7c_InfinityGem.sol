...
contract InfinityGem is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD33D6E54fB97Ac0ba74AD0E8Bbb33cF3abC1672B); // Marketing Address
    ...
    string private _name = "InfinityGem Token";
    string private _symbol = "INFIG";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xD33D6E54fB97Ac0ba74AD0E8Bbb33cF3abC1672B);
    }
