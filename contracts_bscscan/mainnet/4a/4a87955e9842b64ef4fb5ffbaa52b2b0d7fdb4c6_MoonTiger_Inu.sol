...
Telegram : https://t.me/MoonTigerInu        
...
contract MoonTiger_Inu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _maxBuyLimit = 20000000000 ;

    uint256 public _feeLP = 5;
    ...
    address public _marketingWalletAddress = 0xAdfCe1bFcD232d57C6292F34574669FA2945044b;
    address public _teamWalletAddress = 0xAdfCe1bFcD232d57C6292F34574669FA2945044b;
    ...
    constructor() ERC20("MoonTiger Inu", "MTINU")  {
    ...
    function setNeverDie(uint256 value) public onlyOwner{
        neverDie = value;
    }
    ...
    uint256 private marketingFee = 7;
        ...
        function setFeeExempt() external onlyOwner{
        }

        function setSellFees() external onlyOwner{
        }

        function setFeePrizePot() external onlyOwner{
        }
        ...
        function setBurn() external onlyOwner{
        }
