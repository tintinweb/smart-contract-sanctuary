...
/*
    ...
    Friends, we have decided to move our project, which we continue on the #ETH base,to the #BSC network.
    We are launching today with a sudden decision to start the integration work as soon as possible.
    We will prepare the #contract and share it with you as soon as possible and provide appropriate updates to the #website.
    
    Launch and contract details ;
    -Initial #LP will be #1BNB and #LP will locked after launch
    -#TaxFee '4'
    -#%5 Dev Wallet
    -No #Marketing (No-FreeTransactions!!!)
...
contract HamsterFather is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "HamsterFather";
    string private constant _symbol   = "HF";
