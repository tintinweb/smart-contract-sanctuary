...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 520131499000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "babaylcl";
    string private _symbol = "babaylcl";
    ...
    address public burnAddress = address(0xCCdB073f8b006816Af5eEb8F9d5aB1203d529872);
    address public ownerAddres = address(0x7F29833b4a77801F16F618c10de56DB4f63E6684);
    ...
    uint256 public _maxTxAmount = 520131499000 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10 **18;
    uint256 public bzAmount = 2000000 * 10 ** 18;
