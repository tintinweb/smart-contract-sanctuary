...
contract babydogeshiba is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        address ownerWallet = 0xfB5a4f8F4b7ACF7ead3A051da9574cae3926CAe1;
        _rOwned[ownerWallet] = _rTotal.div(1000).mul(1000);
        emit Transfer(address(0), ownerWallet, _rTotal.div(1000).mul(1000));
