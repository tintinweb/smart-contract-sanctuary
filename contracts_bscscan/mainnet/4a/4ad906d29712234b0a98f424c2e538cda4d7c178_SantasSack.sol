...
// SantasSack - where good and bad children get passive rewards from Santa's Sack!
// 
// STEALTH LAUNCH
//
// 12% BUSD rewards
...
// 4% Marketing fee
// 
// Liquidity will be burned shortly after launch
// Contract ownership will be renounced shortly after launch 
//
// Telegram: https://t.me/Santas_Sack
//
...
contract SantasSack is IBEP20, Auth {
    using SafeMath for uint256;

    //The auto-rewarded coin (BUSD)
    ...
    string constant _name = "SantasSack";
    //change the token symbol
    string constant _symbol = "SACK";
    //dont change that
    uint8 constant _decimals = 8;

    //defines the total supply --> 100,000,000,000,000 = 1000000000000000e8 <-- THE e8 HAS TO BE THERE
    uint256 _totalSupply = 100000000_000e8;
    ...
    //marketingfee refers to marketing, buyback, airdrops, contests and rewards, project development
    // "liquidityFee + reflectionFee + marketingFee" = totalFee
    uint256 public totalFee = 18;
    //dont change that
    uint256 feeDenominator  = 100;

    //defines the marketing wallet (a specific wallet)
    address public marketingFeeReceiver = 0x3eEFaE4A614f2cb2dBDf1774F9D0E3d147272A70; 
