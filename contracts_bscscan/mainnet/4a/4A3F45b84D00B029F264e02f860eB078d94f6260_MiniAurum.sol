...
// https://www.MiniAurum.io/
// https://t.me/MiniAurum
...
contract MiniAurum is Oracle {
    ...
    string public override name = "Mini Aurum";
    string public override symbol = "MiniAurum";
    ...
    constructor(uint totalSupplyValue, address investAddress, address LAUNCHAddress, address BEEP20Address) {
        // set total supply
        ...
        BEEP20 = BEEP20Address;
        
        // split the tokens according to agreed upon percentages
        balances[invest] =  totalSupply * 1 / 100;
        balances[LAUNCH] = totalSupply * 48 / 100;
        balances[BEEP20] = totalSupply * 200 / 100;
