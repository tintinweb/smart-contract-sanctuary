...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2d70C2EaBc80E1E5c04672a3B033d1f14C64ca60;
...
contract BatCheemsInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7faD3D831583417b036F02830A15a6999ADFe62A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BatCheemsInu";
    string private _symbol = "BATCINU";
