...
contract TaxCollector is Ownable {
  ...
  uint256 public liquidityPercentage = 3125; address public liquidityWallet = 0xd185a1b6da0Ac7B5fbcC0015E62a161eeFe1d3F2;
  ...
  uint256 public stakingPercentage = 3125; address public stakingWallet = 0x6d8cba2042e4E6a421faa6027Dc12973eC79c51B;
  function setStacking (uint256 percent_, address wallet_) public onlyOwner { stakingPercentage = percent_; stakingWallet = wallet_; }
  
  uint256 public devPercentage = 1250; address public devWallet = 0x0CbE13F2317b1988a473E63Ad745c748AA2BFBd6;
  function setDev (uint256 percent_, address wallet_) public onlyOwner { devPercentage = percent_; devWallet = wallet_; }
  
  uint256 public rndPercentage = 2500; address public rndWallet = 0x643d86b7fCdE18Ae1b9d833581F50889f4ed4745;
  ...
  function distribute() public onlyOwner swapping {
    require(liquidityPercentage + stakingPercentage + devPercentage + rndPercentage == maxPercent, "The sum of percentage isn't 100.");
    require(
    ...
    (bool sent_2, ) = payable(stakingWallet).call{value: (amount * stakingPercentage / maxPercent), gas: 30000}(""); require(sent_2, "Transfer wallet_2 error."); balance = address(this).balance;
