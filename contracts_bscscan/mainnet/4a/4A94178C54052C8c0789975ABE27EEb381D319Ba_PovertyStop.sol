...
//Contract
contract PovertyStop is IBEP20, Ownable {
    ...
    string private constant _name = 'Povertystop';  
    ...
    uint8 private constant MaxWalletDivider=200; //20%% = 100,000,000
    uint16 private constant SellLimitDivider=100; //10% = 200,000,000
    uint8 public constant MaxTax=50;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
    uint8 private _devTax=0;
    uint8 private _burnTax=0;
    uint8 private _marketingTax=65;
    uint8 private _liquidityTax=35;
    uint8 private _stakingTax=0;  
    uint8 private _buyBackTax=0; 
    //buy, sell and transfer tax
    uint8 private _buyTax=20;
    uint8 private _sellTax=27;
