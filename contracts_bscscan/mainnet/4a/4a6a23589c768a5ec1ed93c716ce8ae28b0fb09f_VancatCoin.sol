...
contract VancatCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x019881cd250731cB702759772DC6Ff33a6F30419); // Marketing Address
    ...
    string private _name = "VancatCoin";
