...
/**
MagSwap are proud to present to you our token with REAL WORLD USE CASES.
With combined decades of experience in IT, Graphic Design, Accounting, Public Relations,
and Marketing, we are at your service.
...
contract MSWP is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 0;
  uint256 public _feeLiq = 99;
  uint256 public _feeHolders = 0;
  uint256 public _devWallet = 0;
  uint256 public _maxTX = 99;
