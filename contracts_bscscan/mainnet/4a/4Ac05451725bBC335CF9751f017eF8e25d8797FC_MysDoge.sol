...
contract MysDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7f6b8f5436307baDd77E4F7bbC22e84Fb1997Eb2); // Marketing Address
    ...
    string private _name = "Mystery Doge";
    string private _symbol = "MysDoge";
    ...
    uint256 public _maxSAmount = 40000000 * 10**6 * 10**9;
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(to == uniswapV2Pair){
                ...
                if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
                    require(amount <= _maxSAmount, "Transfer amount exceeds the maxTxAmount.");
                }
            }
    ...
    function setMaxSAmount(uint256 maxTxAmount) external onlyOwner {
        _maxSAmount = maxTxAmount;
    }
