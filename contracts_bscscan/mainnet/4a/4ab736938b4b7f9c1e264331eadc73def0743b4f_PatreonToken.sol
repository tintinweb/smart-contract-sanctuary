...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe48eF3C5025105c44c4628337F4b34B52f6C3ecA;
...
contract PatreonToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x267916a512ecB93ca2c02917DAA6ae3866d3db2F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 88000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Patreon Token";
    string private _symbol = "PTRN";
    ...
    uint256 public _maxTxAmount = 88000000 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 88000000 * 10**8;
