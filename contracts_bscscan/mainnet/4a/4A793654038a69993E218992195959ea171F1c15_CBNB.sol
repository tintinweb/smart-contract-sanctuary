...
5% rewards Fees in BNB - directly auto claimed into your wallet just by holding BNBCash Tokens !
5% to marketing and 5% to liquidity pool.
Diamond hands will be rewarded !!

Official Telegram group : https://t.me/bnbcashofficial1
...
import "./CBNBDividendTracker.sol";

contract CBNB is ERC20, Ownable {
    ...
    //Anti-Whale System
    uint256 public maxWalletTokens =  3000000 * (10**18);
    
    mapping(address => bool) public _isBlacklisted;

    uint256 public BNBRewardsFee = 1;
    uint256 public liquidityFee = 48;
    ...
    constructor() public ERC20("BNBCash", "CBNB") {

    	dividendTracker = new CBNBDividendTracker();

        _marketingWalletAddress = 0x8b33813C2D8b96Bde3eC92681E701feAee8ec70D;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "CBNB: The dividend tracker already has that address");

        CBNBDividendTracker newDividendTracker = CBNBDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "CBNB: The new dividend tracker must be owned by the CBNB token contract");
