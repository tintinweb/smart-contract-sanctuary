...
contract AEONTokenByLevelK is Context, IERC20, Ownable {
    ...
    uint256 public _sellReflectFee = 950;
    uint256 private maxReflectFee = 950;
    
    uint256 private _liquidityFee = 0; // Set dynamically
    uint256 public _buyLiquidityFee = 750; 
    uint256 public _sellLiquidityFee = 9000;
    uint256 private maxLiquidityFee = 9000;


    uint256 private _burnFee = 0; // Set dynamically
    uint256 public _buyBurnFee = 50;
    uint256 public _sellBurnFee = 50;
    uint256 private maxBurnFee = 50;
