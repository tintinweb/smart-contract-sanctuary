...
// SPDX-License-Identifier: Unlicensed
     //Welcome to AtripRemix
   
    //This is a community token. If you want to create a telegram I suggest to name it to @AtripRemix
    //Important: The earlier you create a group that shares the token, the more gain you got.

    //This token is a low supply, 500 minted, low buy taxes (4%), high sell taxes that goes back into LP(20%).
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract AtripRemix is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9c0709cB4F969D25BfABeD5Dd595E515fe3480AB); // Marketing Address
    ...
    string private _name = "AtripRemix";
