...
// File: contracts/ADADividendPayingToken.sol
...
contract BabyUFO is ERC20, Ownable {
    ...
    constructor() public ERC20("BabyUFO", "BabyUFO") {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ADA: Account is already the value of 'excluded'");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "ADA: The liquidity wallet is already this address");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "ADA: This account cannot send tokens until trading is enabled");
        }
