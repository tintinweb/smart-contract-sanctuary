...
//              Long Term Project! 
//
// Telgram:        https://t.me/RicFlairBTC
// Website:        www.ricflairbtc.com
// Twitter:        https://twitter.com/RicFlairBTC
// Email:          [email protected]
//
// Tokenomics:     12% BTC reflections,
//                 4% liq
//                 1% marketing
//
//                 Max wallet 20,000 (2%)
...
// File: contracts/RicFlairBTCDividendPayingToken.sol
...
// File: contracts/RicFlairBTC.sol
...
contract RicFlairBTC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    address private _marketingWallet = address(0x347B5198ecfac17716Fdf34DADec897C146d52ff);
    address private _liqAdd = address(0x259D5aE610783Cb320b830e40cdF51e3415Ba08c);
    ...
    RicFlairBTCDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;
    address public liqAdd = _liqAdd;

    uint256 public maxBuyTranscationAmount = 20000 * (10**18); // 2% of total supply
    uint256 public maxSellTransactionAmount = 10000 * (10**18); // 1% of total supply
    uint256 public swapTokensAtAmount = 500 * (10**18);
    uint256 public _maxWalletToken = 20000 * (10**18); // No limit
    ...
    constructor() public ERC20("RicFlairBTC", "RicFlairBTC") {
    	...
    	dividendTracker = new RicFlairBTCDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "RicFlairBTC: The dividend tracker already has that address");

        RicFlairBTCDividendTracker newDividendTracker = RicFlairBTCDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "RicFlairBTC: The new dividend tracker must be owned by the RicFlairBTC token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "RicFlairBTC: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "RicFlairBTC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "RicFlairBTC: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "RicFlairBTC: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "RicFlairBTC: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "RicFlairBTC: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "RicFlairBTC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "RicFlairBTC: This account cannot send tokens until trading is enabled");
        }
...
contract RicFlairBTCDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("RicFlairBTC_Dividend_Tracker", "RicFlairBTC_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "RicFlairBTC_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "RicFlairBTC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RicFlairBTC contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "RicFlairBTC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "RicFlairBTC_Dividend_Tracker: Cannot update claimWait to same value");
