...
/*
Captain Floki Inu is the latest Marvel & Floki Inu based Token released on the BSC Network.

We decided to go with Captain Floki Inu because it's definitely superhero + Floki season, so it's kind of a no-brainer what will happen.
Its purpose is to over perform all other existing cryptocurrencies with the help of Elon Musk and the awesome community we are about to build.
Captain Floki Inu wants to give the community a platform where everyone can decide about the future of the token

It is completely community driven and can only grow with the help of the holders.

-Experienced devs 
-Liquidity locked 100% upon launch for 1 year!
-Community owned project
-Unique Contract
-No Dev Wallets

📱Twitter: https://twitter.com/captainflokiinu
📱Telegram: https://t.me/captainflokiinu
💻 Website: https://www.captainflokiinu.com/
*/
...
contract CaptainFlokiInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address[] public TOKENARR = [0xdF2fc196d57f7E3736DAAab1De4b717C32380fB6];
    ...
    constructor() ERC20("Captain Floki Inu", "CFINU")  {
