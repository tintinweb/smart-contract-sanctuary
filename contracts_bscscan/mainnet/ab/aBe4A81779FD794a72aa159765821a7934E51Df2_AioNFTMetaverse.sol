...
/**
     * Website: https://aionft.market/
     * Twiter: https://twitter.com/aionft
     * Telegram: https://t.me/aionftmarket
     * Fanpage: https://www.facebook.com/aionftmarket/
     * Whitepaper: https://docs.aionft.market/
     * Github: https://github.com/aionft
     */
...
contract AioNFTMetaverse is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000000000;
    ...
    string private _name = "AioNFT Metaverse";
    string private _symbol = "AIOM";
    
    uint256 private _reflectFee = 0; // Set dynamically
    uint256 public _buyReflectFee = 200;
    uint256 public _sellReflectFee = 3000;
    uint256 private maxReflectFee = 3000;
    
    uint256 private _liquidityFee = 0; // Set dynamically
    uint256 public _buyLiquidityFee = 500; 
    uint256 public _sellLiquidityFee = 6900;
    uint256 private maxLiquidityFee = 6900;
    ...
    uint256 public maxSellTransactionAmount = (_tTotal * 100) / 10000;
    
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 100) / 10000;
