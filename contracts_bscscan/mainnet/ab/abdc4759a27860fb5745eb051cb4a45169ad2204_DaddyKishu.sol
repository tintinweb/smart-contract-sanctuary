...
/**
 ____                 __      __              __  __               __                
/\  _`\              /\ \    /\ \            /\ \/\ \  __         /\ \               
\ \ \/\ \     __     \_\ \   \_\ \  __  __   \ \ \/'/'/\_\    ____\ \ \___   __  __  
 \ \ \ \ \  /'__`\   /'_` \  /'_` \/\ \/\ \   \ \ , < \/\ \  /',__\\ \  _ `\/\ \/\ \ 
  \ \ \_\ \/\ \L\.\_/\ \L\ \/\ \L\ \ \ \_\ \   \ \ \\`\\ \ \/\__, `\\ \ \ \ \ \ \_\ \
   \ \____/\ \__/.\_\ \___,_\ \___,_\/`____ \   \ \_\ \_\ \_\/\____/ \ \_\ \_\ \____/
    \/___/  \/__/\/_/\/__,_ /\/__,_ /`/___/> \   \/_/\/_/\/_/\/___/   \/_/\/_/\/___/ 
                                        /\___/                                       
                                        \/__/                                        
    
    Daddy Kishu is loyal to his family, like all dogs should be! Make sure you don’t miss out on this one, 
    Daddy Kishu will take you to the moon
    
    TOKENOMICS;
    
    Supply 500,000,000,000
    Initial LP 5BNB
    LP will be locked after launch
    And 30% Supply will be burned before launch on PancakeSwap

    Total Tax 8% (Small tax = easy moon)
    5% to Marketing and Development Wallet
    3% to Liquidity Pool

    Website https://daddykishutoken.com/
    Telegram https://t.me/daddykishutoken/
    Twitter https://twitter.com/daddykishu/
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 FLOKI = IERC20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4);
...
// CHANGE
contract DaddyKishu is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address FLOKI = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DaddyKishu";
    string constant _symbol = "DADDYKISHU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500000000000 * (10 ** _decimals); // 500,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 100% MAX
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 15,000,000,000
    ...
    uint256 devFee = 500; // 5%
    uint256 totalFee = 800; // liquidityFee + devFee for marketing and development
    ...
    uint256 public swapThreshold = _totalSupply / 4000; // 0.05%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x6D21564a0687450B4cAa53151757925eE8959a20);
