...
contract Soaring is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Soaring";                                          // name
    string private _symbol = "SOAR";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x0eFbdBDE1A320EEaB17edD26664b86dc74c2B45D),                             // Dev+Team wallet
        payable(0x91Dc8669499a2aCA1C39E0bAC1E59Cce17c291b0),                             // Marketing wallet
        payable(0xa5D10104769fb8316aC9DAE6c5Ae7a45aC8D3E03)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "Soaring is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "Soaring is not live yet");
