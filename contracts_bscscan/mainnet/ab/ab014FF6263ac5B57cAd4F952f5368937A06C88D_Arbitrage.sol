...
contract Arbitrage is Ownable {
  ...
  function arbWETH(
    ...
    _arb(loanFromApe, token, loanFromApe? apeWETH : pancakeWETH, amountToken, amountWETH);
  }
  ...
  function arb(
    ...
    _arb(loanFromApe, token0, token1, amount0, amount1);
  }
  ...
  function _arb(
    ...
    address token1, 
    uint amount0, 
    uint amount1) private {
    factory = loanFromApe? apeFactory : pancakeFactory;
    sushiRouter = loanFromApe? pancakeRouter : apeRouter;
