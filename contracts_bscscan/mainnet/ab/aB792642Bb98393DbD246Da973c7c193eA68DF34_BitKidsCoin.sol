...
/**
                       ...
                       Project Name: Bit Kids Coin
                  Official Website: www.BitKidsCoin.com
   
   
   #Bit Kids Coin $BKC
   3% fee auto added to liquidity
   10% fee auto distributed to all hodlers
   2% fee auto distributed to the charity wallet
   5% fee auto sent to the dead wallet
...
contract BitKidsCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Bit Kids Coin";
    ...
    address public charityWallet = 0x8e0265Ab090eC3016f4C1B184d3B8a3137CF75A9;
    ...
    uint256 private numTokensSellToAddToLiquidity = 50000000000000000 * 10**9;
