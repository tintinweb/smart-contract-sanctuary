...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7292D571d6a289d017B2200466e750Ba0e193039;
...
contract SpaceXCO2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x121ee62274728e142f9E04aB1756b62341fE7C89;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SpaceX CO2";
    string private _symbol = "SPXCO2";
