...
contract Brandon is Context, IBEP20, Ownable {
    ...
    address public   MarketingWallet = 0x550f64676fa1513B9d3C8195794b2db718C2F2D9; 
    
    string private _name = "Brandon";
    string private _symbol = "LGBFJB";
