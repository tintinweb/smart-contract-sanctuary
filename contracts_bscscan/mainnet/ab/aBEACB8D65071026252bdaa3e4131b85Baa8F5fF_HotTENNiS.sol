...
/**
   #HotTENNiS
    ...
    I suggest a telegram group name for you to create: https://t.me/HotTENNiSBSC
   ...
   I will renounce the ownership to burn addresses to transfer #HotTENNiS to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #HotTENNiS 10000000X? 
   ...
   it's the best part of the #HotTENNiS idea, increasing the liquidity pool automatically, 
...
contract HotTENNiS is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("HotTENNiS", "HotTENNiS") {
