 ...
 * 
 Welcome to $GoldenBabyDoge:
   ...
   Many Great features:
    ...
    it's the best part of the $GoldenBabyDoge idea, increasing the liquidity pool automatically.
...
contract GoldenBabyDoge is Context, IERC20, Ownable {
