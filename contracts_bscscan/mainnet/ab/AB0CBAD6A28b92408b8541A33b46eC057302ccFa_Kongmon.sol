...
/**
    ...
    I make this #Kongmon to hand over it to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #KONGMON to the community, make sure it's 100% safe.
...
contract Kongmon is Context, IBEP20, Ownable {
