...
/*
TG - @NinjaXRPBSC
Website - https://www.NinjaXRP.network
*/
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // Solidity only autoBNBally asserts when dividing by 0
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BNB = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); 
...
contract NinjaXRP is IBEP20, Auth {
    using SafeMath for uint256;

    address BNB = 0x4338665CBB7B2485A8855A139b75D5e34AB0DB94;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NinjaXRP";
    string constant _symbol = "NinjaXRP";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 30000; // 0.01% of supply
    bool inSwap;
