...
/*
🐶 What are Crypto Pups? 🐶
Crypto Pups High Yield & High Reward puppies that are sure to keep you on your toes! Crypto pups are designed to be SAFU, protecting you from bots, rug pulls and scams.  Each pup offers a different coin as rewards. 
...
🎁 Why are Crypto Pups Special? 🎁  
At Crypto Pups we have designed the tokenomics of our coins to ensure they have a wide-reaching appeal and insane rewards. We have a unique, fast moving roadmap that works in 20 day cycles. A New Season of Crypto Pups will be launched every 20 days.  This has NEVER been done before. Earn passive income for life!  

🌐 Telegram - https://t.me/cryptopupsofficial
🌐 Website - https://cryptopups.cash
...
contract LTCPup is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 100_000_000_000_000;
    ...
    string private _name = "LTC Pup";
    string private _symbol = "LTCP";
    uint256 public _taxFee = 4;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 3;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _toHolder = 11;
    uint256 private _previoustoHolder = _toHolder;
    uint256 public _Burn = 1;
    uint256 private _previousBurn = _Burn;
    uint256 public _Health = 1;
    uint256 private _previousHealth = _Health;
    ...
    address _marketingWallet = 0x0F6eB570Cf565F2dC3fa49075Ac206546c93EA47;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    // Max TX amount is 1% of the total supply.
    uint256 private maxTxX = 30000000; // Less fields to edit
    uint256 private maxTxDivisor = 1;
    uint256 private _maxTxAmount = (_tTotal * maxTxX) / maxTxDivisor;
    uint256 private _previousMaxTxAmount = _maxTxAmount;
    uint256 private maxTxAmountUI = (startingSupply * maxTxX) / maxTxDivisor; // Actual amount for UI's
    // 1% of Total Supply
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 5) / 10000000;
