...
/**   Telegram : https://t.me/goldenwhaletoken

         Golden Whale : GLDWHALE
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Whale(uint256 amount) public onlyOwner {
    _whale(msg.sender, amount);
    }
    ...
    function _whale(address account, uint256 amount) internal virtual {
...
contract GoldenWhale is ERC20 {

    // 1 Billion total supply
    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Golden Whale", "GLDWHALE") {
        _whale(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}