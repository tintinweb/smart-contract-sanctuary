...
// File contracts/XmasCheems2022Inu.sol
pragma solidity ^0.8.0;

contract XmasCheems2022Inu is Context, IERC20, Ownable {
    ...
    string private constant _name = "XmasCheems2022Inu";
    string private constant _symbol = " X2022";
    string private constant _ProjectName = "XmasCheems2022Inu";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 1, // 0 RFI rate, in %
            dev: 24, // dev team fee in %
            treasury: 24, // treasury fee in %
            lp: 24, // lp rate in %
            toSwap: 72 // treasury + dev + lp
        });
