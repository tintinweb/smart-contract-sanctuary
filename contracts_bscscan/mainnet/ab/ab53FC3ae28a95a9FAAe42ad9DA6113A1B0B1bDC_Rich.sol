...
contract Rich is Context, IERC20, Ownable {
    ...
    string private _name = "CrazyShib";
    string private _symbol = "CrazyShib";
    ...
    uint256 public _maxTxAmount =   6600000000 * 10**_decimals; 
    uint256 public _walletMax =     6600000000 * 10**_decimals;
