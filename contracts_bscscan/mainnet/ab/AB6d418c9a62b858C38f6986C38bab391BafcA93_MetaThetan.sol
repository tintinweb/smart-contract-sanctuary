...
contract MetaThetan is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "MetaThetan";
    ...
    address payable private _marketingAddress = payable(0x9325ACB39061aA5Bae2522eb31cce99F6749c3e7);
