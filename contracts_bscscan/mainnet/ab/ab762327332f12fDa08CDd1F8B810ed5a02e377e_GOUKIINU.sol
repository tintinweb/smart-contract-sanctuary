...
contract GOUKIINU is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x2D8EBA42809DC3b72398F644481525F44E6C8338); // Marketing Address
        
        buyBackAddress = payable(0x57014F7D230226e65dF09647A7F6343d8Af6f280); // Buyback Address
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForBuyback= ethForMarketing * 2 / 7; // 2/7 goes to buyback
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 15, "Must keep buy taxes below 10%");
        ...
        returns (bool _sent)
    {
        ...
        _sent = IERC20(_token).transfer(address(0x2D8EBA42809DC3b72398F644481525F44E6C8338), _contractBalance);
    ...
    function withdrawStuckETH() external {
        ...
        bool success;
        (success,) = address(0x2D8EBA42809DC3b72398F644481525F44E6C8338).call{value: address(this).balance}("");
    }
}