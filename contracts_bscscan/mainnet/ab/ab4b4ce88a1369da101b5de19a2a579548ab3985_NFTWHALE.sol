...
/**
   ...
   2% distribute to a Charity Wallet 
   6% of transaction fee will go to Holders
   ttl supply = 777,777,777,777
   decimals 9
*/
...
contract NFTWHALE is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xdf4aF0DB85383fffC2A57312BE0DfA49262a0982;
    ...
    string private _name = "NFT WHALE";
    string private _symbol = "NFTWHALE";
    ...
    uint256 public _maxTxAmount = 777777777777 * 10**9;
