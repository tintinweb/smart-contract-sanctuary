...
The Only Roaring 20s

Telegram: @Roaring20sBSC
**/
...
contract Roaring20s is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "Roaring20s";
    string constant _symbol = "R20";
    uint8 constant _decimals = 8;
    uint256 _totalSupply = 1000 * 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 5 * 10000000 * (10 ** _decimals);     // 1%
    uint256 public _maxWalletToken = 20 * 10000000 * (10 ** _decimals);  // 4%
    ...
    constructor ()  {
        address marketingFeeReceiver = 0x9099F64A0a33cFA1d22bF2C343789477600539b7;
        owner = msg.sender;
