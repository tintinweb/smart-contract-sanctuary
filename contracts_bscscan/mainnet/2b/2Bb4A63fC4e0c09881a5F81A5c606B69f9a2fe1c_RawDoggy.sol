...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #RawDoggy

    I make this #RawDoggy to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/RawDoggy_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #RawDoggy to the community, make sure it's 100% safe.

   I will add 4 BNB and all the left 49.5% total supply to the pool
   Can you make #RawDoggy 10000000X? 
   ...
   it's the best part of the #RawDoggy idea, increasing the liquidity pool automatically, 
...
contract RawDoggy is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "RawDoggy";
  string private _name = "RawDoggy";
