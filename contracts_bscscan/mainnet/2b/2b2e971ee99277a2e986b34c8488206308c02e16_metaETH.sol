...
/**
 * https://t.me/Meta_ETHER
 * 4% Rewards in ETH
 * 6% Marketing tax
 * + 3% Liquidity tax on selling 
*/
...
contract metaETH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaETH";
    string constant _symbol = "METAETH";
    ...
    uint256 public swapThreshold = (_totalSupply * 5) / 10; // 5% of supply
