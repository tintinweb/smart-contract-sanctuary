...
contract RedSafe is Context, IBEP20, Ownable {
    ...
    address payable public _charityWallet = payable(0x3397F111Bf503a9b1573B7AC1236de533Aa38DAA); // Charity Address
    ...
    string private constant _name     = "RedSafe";
    string private constant _symbol   = "REDSAFE";
    ...
    uint256 private _minTokenBalance = 500000 * 10**6 * 10**9;
