...
/**
  ...
  2% fee auto mkt
  I created a black hole so #Blog token will deflate itself in supply with every transaction
  25% supply is burned at start.
  5% team DEV
  65% Presale
  Total Supply: 1,000,000,000 $Blog
...
contract Blogger is Context, IERC20, Ownable {
    ...
    string private _name = "Blogger";
    string private _symbol = "Blog";
