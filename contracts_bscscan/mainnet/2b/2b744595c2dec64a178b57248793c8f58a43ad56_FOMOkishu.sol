...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 MINIKISHU = IERC20(0xd62934ea8093ce56d339d75b501E8955aF4eC236);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MINIKISHU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MINIKISHU);
        ...
        uint256 amount = MINIKISHU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MINIKISHU.transfer(shareholder, amount);
...
// CHANGE
contract FOMOkishu is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address MINIKISHU = 0xd62934ea8093ce56d339d75b501E8955aF4eC236;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FOMOkishu";
    string constant _symbol = "FOMOkishu";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xEf01E0F908F63707d3d094B78c563e8E33C75909);
