...
*/
 ...
 contract XRPBOY is IBEP20, Auth {
     
     using SafeMath for uint256;
 
     string constant _name = "XRPBOY";
     string constant _symbol = "XRPB";
     ...
     constructor () Auth(msg.sender) {
         ...
         // NICE!
         autoLiquidityReceiver = 0x40592f3Ff2ca40eFfE42DFEee58E28e0207051e1;
         marketingWallet = 0x6492F8c65635cb7d822Ea5c97D9e0c96E464C8f2; 
         ecosystem = 0x6492F8c65635cb7d822Ea5c97D9e0c96E464C8f2;
     ...
     function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newecosystem) external authorized {
     ...
     function swapBack() internal lockTheSwap {
         ...
         (bool tmpSuccess1,) = payable(ecosystem).call{value: anothermarketingShare, gas: 30000}("");
