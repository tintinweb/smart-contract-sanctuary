...
contract DogengerCoin is ERC20Interface, SafeMath {
    string public name = "Dogenger";
    string public symbol = "Dogenger";
    uint8 public decimals = 18;
    uint256 public _totalSupply = 1000000000000000000000000000; // 2 billion SIM in supply
    ...
    function _transfer(address from, address to, uint256 tokens) private returns (bool success) {
        uint256 amountToBurn = safeDiv(tokens, 12); // 5% of the transaction shall be burned
