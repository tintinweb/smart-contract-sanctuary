...
*/
// CAKE REWARD
//💎Great Potential 100x
//💎Rug-Proof
//💎SAFU 💯
// Telegram : https://t.me/SONICNOMICS
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also SONICNOMICSed.
...
// File: contracts/SONICNOMICSDividendPayingToken.sol
...
// File: contracts/SONICNOMICS.sol
...
contract SONICNOMICS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable Cake = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    address private _marketingWallet = address(0x41F4117B56FBd89de8D369EeBC615d5712fcc0d7);
    address private _devWallet = address(0x41F4117B56FBd89de8D369EeBC615d5712fcc0d7);
    ...
    SONICNOMICSDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("SONICNOMICS", "SONICNOMICS") {
        ...
        dividendTracker = new SONICNOMICSDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "SONICNOMICS: The dividend tracker already has that address");

        SONICNOMICSDividendTracker newDividendTracker = SONICNOMICSDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "SONICNOMICS: The new dividend tracker must be owned by the SONICNOMICS token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "SONICNOMICS: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SONICNOMICS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SONICNOMICS: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SONICNOMICS: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "SONICNOMICS: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "SONICNOMICS: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SONICNOMICSBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "SONICNOMICS: This account cannot send tokens until trading is enabled");
        }
...
contract SONICNOMICSDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("SONICNOMICS_Dividend_Tracker", "SONICNOMICS_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "SONICNOMICS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "SONICNOMICS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SONICNOMICS contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "SONICNOMICS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SONICNOMICS_Dividend_Tracker: Cannot update claimWait to same value");
