...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbDD0f6634D271699fd7f66c9BecB217f62edEcC1;
...
contract Floki is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0x72eF6cDc5aFF302F7FF3c9F28106d33E7f40C4A1;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 21000000 * 10**3 * 10**8;
    ...
    uint256 public _maxTxAmount = 210000 * 10**3 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 105000 * 10**3 * 10**8;
