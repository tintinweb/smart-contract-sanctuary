...
XmasDoge ( $XMASDOGE ) is a peer-to-peer deflationary meme DeFi token with built-in Automated Rewards Farming (ARF) technology ( gift from Canta Claus ) .
Just buy and hold $XMASDOGE and watch the gifts from santa claus your balance grow with every transaction!

STEALTH LAUNCH

Join our Telegram group: https://t.me/XmasDogeCoin
...
contract XMASDOGE is Context, IERC20, Ownable {	
    ...
    string private constant _name = "Xmas Doge";	
