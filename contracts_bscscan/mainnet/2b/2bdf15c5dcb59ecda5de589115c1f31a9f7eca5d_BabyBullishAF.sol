...
contract BabyBullishAF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Bullish AF";
    string private _symbol = "BabyBULLAF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8Abe0e8aeB4bD63A9D1c24f54BC3Fe0E313398eD); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x95e5D4aa70bf740836e925707bfC56C12DAC6397); // buyback Address
