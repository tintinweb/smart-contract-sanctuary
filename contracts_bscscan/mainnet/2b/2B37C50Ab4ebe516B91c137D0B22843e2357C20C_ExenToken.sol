...
// https://twitter.com/ExenToken
// https://t.me/ExenToken
...
interface iERC30 {
   ...
   * https://github.com/BETA/EIPs/issues/20#issuecomment-263524729
   *
...
contract ExenToken is iERC30 {
    // common addresses
    // https://www.bitexen.com/ 
    address private owner;
    address private BETA;
    ...
    string public override name = "ExenToken";
    string public override symbol = "EXEN";
    ...
    constructor(uint totalSupplyValue, address BETAAddress, address ProjectAddress, address WEBAddress) {
        // set total supply
        ...
        balances[BETA] =  totalSupply * 2 / 100;
