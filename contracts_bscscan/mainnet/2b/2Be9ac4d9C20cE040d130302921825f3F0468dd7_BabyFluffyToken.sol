...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0xA3aBE68db1B8467B44715eb94542B20DC134f005);
    //dont change that (:
...
contract BabyFluffyToken is IBEP20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0xA3aBE68db1B8467B44715eb94542B20DC134f005;
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Baby Fluffy Coin";
    //change the token symbol
    string constant _symbol = "FLUFFBB";
    //dont change that
    ...
    address public marketingFeeReceiver = 0xB47CA1e7288A992109CC774c18Dd382CD9B06159;
