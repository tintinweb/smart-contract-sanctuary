...
contract LittleBabyZoon is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby Zoon";
    string private _symbol = "LBZ";
    ...
    uint256 private constant _Burn_FEE = 500; // 2%
