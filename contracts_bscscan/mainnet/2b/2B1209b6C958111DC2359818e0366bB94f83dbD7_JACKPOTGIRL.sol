 ...
 */ 
 ...
 // @JackpotGirl, Join us on telegram now!
...
contract JACKPOTGIRL is IERC20Metadata, Ownable {
    ...
    string constant _name = "JACKPOTGIRL";
    string constant _symbol = "POTGIRL";
    ...
    uint256 public buyersTotalFees = buyingMarketingFee.add(buyingRfiFee).add(buyingLpFee).add(buyingJackpotFee);
    uint256 public sellersTotalFees = sellingMarketingFee.add(sellingRfiFee).add(sellingLpFee).add(sellingJackpotFee);
