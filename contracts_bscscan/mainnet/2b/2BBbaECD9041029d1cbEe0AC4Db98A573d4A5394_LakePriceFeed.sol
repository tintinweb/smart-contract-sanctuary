...
contract LakePriceFeed is Ownable {
    /// @notice keeps track of oracles for each tokens
    mapping(address => address) public oracles;

    /// @notice lake address registry contract
    address public addressRegistry;

    /// @notice wrapped BNB contract
    address public wBNB;

    constructor(address _addressRegistry, address _wBNB) public {
    ...
    function registerOracle(address _token, address _oracle)
        ...
        onlyOwner
    {
        ILakeTokenRegistry tokenRegistry = ILakeTokenRegistry(
            ILakeAddressRegistry(addressRegistry).tokenRegistry()
        );
