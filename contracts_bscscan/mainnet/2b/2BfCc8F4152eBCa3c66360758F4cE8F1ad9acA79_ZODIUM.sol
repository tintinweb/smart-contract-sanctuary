...
contract ZODIUM is Operator {
    ...
    string private _name = "ZODIUM";//#币名
    string private _symbol = "ZODIUM";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x450dF853fe9E48330d82451b08B8A040a8150423),true);
    }
