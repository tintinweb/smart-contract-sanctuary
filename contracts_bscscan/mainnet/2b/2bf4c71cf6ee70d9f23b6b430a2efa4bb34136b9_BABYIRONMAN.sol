...
📍Our BABYIRONMAN has reached to the last step. Now, our dev team is ready to launch the coin. Are your guys ready?
...
12% of every buy/sell is taken and redistributed to all holders. 
Hold $BabyIronman tokens, earn BNB. Minimum 200,000 tokens.

⏰ Auto Paid Every 60 Minutes
You don’t need to claim your earned BNB. 
It’s automatically sent to your wallet every 60 minutes. 
Note: in periods of lower volume this may take longer, but you always get your BNB.
...
📊 2% Sell Fee
Extra 2% fee is applied to all sells. 
...
✈️ Telegram : https://t.me/BABYIRONMAN

💬 Twitter : https://twitter.com/BABYIRONMAN
...
contract BABYIRONMAN is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "BABYIRONMAN";
    string public _symbol= "BABYIRONMAN";
     bool balances1 = true;
