...
contract Ownable is Context {
    address private _owner = 0xcA8E00BA88bB851cc1E9F0ee9944012Cd0518FB4;
...
contract CopperDoge is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x94020f066F7287F9380f161D4a802bee4bB95ACB); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "CopperDoge"; // token name
    string private _symbol = "CopperDoge"; // token symbol
    ...
    uint256 public _buyBackFee = 30; // buyback fee 12%
    uint256 private _previousBuyBackFee = _buyBackFee; // buyback fee

    uint256 public _marketingBNBFee = 120; // marketing BNB fee
    uint256 private _previousMarketinBNBFee = _marketingBNBFee; // marketing BNB fee

    uint256 public _liquidityFee = 20; // liquidity fee 3%
    ...
    uint256 public _maxTxAmount = _tTotal.div(10); // max allowed tokens tranfer per transaction
