...
HARMONIZED 2021 | https://harmonized.org/

Harmonized ($HMZ) is the go-to decentralized exchange and yield aggregator of the Binance Smart Chain (BSC) Blockchain.
Similarly to the highly successful and widely utilized 1inch exchange on the Ethereum Blockchain,
Harmonized operates by querying, routing and funneling the users' funds through multiple decentralized exchanges(DEXs) 
such as PancakeSwap, ApeSwap, BakerySwap, WagyuSwap and more.

for more info:
Telegram : https://t.me/harmonizedapp
Twitter  : https://twitter.com/harmonizedapp

Copyright (c) 2021 HARMONIZED
...
contract Harmonized is Context, IERC20, Ownable {
    ...
    string private _name = "Harmonized";
    string private _symbol = "HMZ";
