...
* - 7 day Liquidity Lock (will send and pin mudra link in the TG)
   

 TG: https://t.me/FreeTheNippleofficial
 
 Hold $FTN and get $PORNROCKET automatically in your wallet every hour!
 ...
 Reflection/Taxes: 4% in PORNROKET, 4% in Marketing, 6% in Liquidity
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 PORNROCKET = IERC20(0xCF9f991b14620f5ad144Eec11f9bc7Bf08987622);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PORNROCKET.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(PORNROCKET);
        ...
        uint256 amount = PORNROCKET.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PORNROCKET.transfer(shareholder, amount);
...
// CHANGE
contract FreeTheNipple is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address PORNROCKET = 0xCF9f991b14620f5ad144Eec11f9bc7Bf08987622;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FreeTheNipple";
    string constant _symbol = "$FTN";
