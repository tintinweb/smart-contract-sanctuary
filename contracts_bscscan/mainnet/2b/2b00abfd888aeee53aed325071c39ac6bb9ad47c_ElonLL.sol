...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x38BE2f008324Cccd4e24fF48AE7bfF90a71AA37c;
...
contract ElonLL is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x46e14347d1d65502279a493032740BB4d23Ae3C9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Elon Laser Link";
    string private _symbol = "ElonLL";
