...
contract RedZoneTK is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'RedZoneTK Token';
    string  private constant _SYMBOL = 'RZTK';
    ...
    uint256 private _tTotal = 99999999 * _DECIMALFACTOR;
    ...
    uint256 private    _BURN_FEE = 300; // 3% BURNED
    uint256 private _CHARITY_FEE = 200; // 2% TO Marketing/Developer Wallet
