...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB9636488EF20B92C855c7D21121C1d1A9D7CBabd;
...
contract Seismic is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0xBf63be90f859B152ea3FcfeD100f37B6279502ec); 
    address payable private Wallet_Token_Burn = payable(0x05B1F06aaB0578D59FeB31387496DaDb9A2D1443); 
    address payable private Wallet_Dev = payable(0x05B1F06aaB0578D59FeB31387496DaDb9A2D1443); 
    ...
    string private _name = "BBJUL"; 
    string private _symbol = "OVNI";  
