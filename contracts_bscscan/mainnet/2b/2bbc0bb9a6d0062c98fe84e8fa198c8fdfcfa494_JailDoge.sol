 ...
 *   Jail Doge
 * 
 *   - Don't buy us! We're not worth! We are too simple!!
 * 
 *  ---------------------------------------------------
 *   Let's taste the simple tokenomics:
 * 
 *      - 3% distributed to JailDoge holders.
 *      - 3% added to the liquidity pool.
 *      - 3% sent to the marketing wallet so the budget can match the ambition of the token.
 * 
 *  ---------------------------------------------------
 *      Website:    https://jaildoge.net
 *      Telegram:   https://t.me/jaildoge
 *      Twitter:    https://twitter.com/jaildoge
 */
...
contract JailDoge is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0xB737200739216007FAfB20980FbF82E18de33207;
    ...
    string private _name = "Jail Doge";
    string private _symbol = "JAILDOGE";
    ...
    // Liquify when 150 billion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 150000 * 10**6 * 10**9;
    ...
    constructor () public {
        ...
        //main psc_router_v2 0x10ED43C718714eb63d5aA57B78B54704E256024E
