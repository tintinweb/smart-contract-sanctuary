...
contract ERC20Handler is IDepositExecute, HandlerHelpers, ERC20Safe {
    ...
    */
    ...
    function deposit(
        ...
        require(amount <= IBridge(_bridgeAddress)._amountLimit(), "amount limit");

        uint256 fee = IBridge(_bridgeAddress)._fee();
        amount = amount.sub(amount.mul(fee).div(FEE_BASEPOINT));
...
interface IBridge {
    ...
    function _amountLimit() external returns (uint128);
}
