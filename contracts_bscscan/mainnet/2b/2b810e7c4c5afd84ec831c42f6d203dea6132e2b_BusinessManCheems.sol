...
Telegram:   https://t.me/BusinessManCheems
...
// CHANGE
contract BusinessManCheems is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BusinessManCheems";
    string constant _symbol = "BusinessManCheems";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 90) / 100; // 90% MAX 900,000,000
    uint256 public _maxWalletSize = (_totalSupply * 90) / 100; // 90% MAX 900,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x4A764182BAb9eBBA578e02Cb808f1f2858bfa5Cd);
