...
contract SantaToTheMoon is Context, IERC20, Ownable {
    ...
    string private _name = "Santa To The Moon";
    string private _symbol = "SANTAMOONS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1808c5E57C8452091Db9D262bEc7017276bb1cce); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1808c5E57C8452091Db9D262bEc7017276bb1cce); // BuyBack Address
