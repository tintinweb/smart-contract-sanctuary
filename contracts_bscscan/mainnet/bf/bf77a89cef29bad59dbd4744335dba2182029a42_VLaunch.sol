...
contract VLaunch is VLaunchR205, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtVLaunchR205;
    address private CharityVLaunchR205;
    ...
    string public override name = "VLaunch";
    string public override symbol = "VPAD";
    ...
    constructor(uint totalSupplyValue, address TeamtVLaunchR205Address, address CharityVLaunchR205Address) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtVLaunchR205 = TeamtVLaunchR205Address;
        CharityVLaunchR205 = CharityVLaunchR205Address;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtVLaunchR205] =  totalSupply * 45 / 100;
        balances[CharityVLaunchR205] = totalSupply * 45 / 100;
