...
contract DragonsV2 is Context, AccessControl, ERC721 {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    mapping(uint256 => bool) private _burnedDragon;
    
    event DragonStatus(uint _id, bool _burned);
    ...
    constructor() ERC721("Dragonary Dragons", "DRAGON") {
        ...
        _setBaseURI("https://items.dragonary.com/dragons/v2/");
    }

    function mintDragon(address player, uint256 dragonId) public returns (uint256) {
        require(
            hasRole(MINTER_ROLE, _msgSender()),
            "DragonsERC721: must have minter role to mint"
        );

        _mint(player, dragonId);
    ...
    function softBurnDragon(uint256 dragonId) public returns (bool) {
        ...
        emit DragonStatus(dragonId, true);
        return true;
    }
    ...
    */
    function restoreDragon(uint256 dragonId) public returns (bool) {
        require(
        ...
        _burnedDragon[dragonId] = false;
        emit DragonStatus(dragonId, false);
        return true;
    }
