...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); // Set To Cake
...
contract UnvaxxedTurkey is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; // Cake Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Unvaxxed Turkey Sperm";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "nuBNB";
