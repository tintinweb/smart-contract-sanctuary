...
/**
    ...
    clean contract for degen call! (minishibafomo fork)
    tax 10%
    5% Reflect to holder
    5% back to liquidity
    3% max wallet
    ...
    then you can trade safely.
    Make sure everything before you buy it to keep it safu!
    
    same devs with minishibafomo (x16)
    devs from mars and uranus
*/
...
contract Shibafomonomic is Context, IERC20, Ownable { 
    ...
    string private _name = " Shibafomonomic"; 
    string private _symbol = "ShibFN"; 
    ...
    address public devWallet = 0xB0665d6f8fE61C30BdAb4Cda6BAc9a1bb83F8232; 
