...
contract CN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 138 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CN";
    ...
    address public ownerAddres = address(0x093e2d14aC230A7bEBAAa3902Cf83d457793149D);
    address public devAddress = address(0x93B0851581FCeECCb42aBc12060F0a0e705DeDe1);
    
    address public CN = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    ...
    uint256 public feeAllTotal = 3 * 10 **18;
