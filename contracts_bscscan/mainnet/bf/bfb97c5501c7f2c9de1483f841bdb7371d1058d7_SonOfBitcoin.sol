...
/* Token contract */
contract SonOfBitcoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Son Of Bitcoin";
    ...
    uint256 public swapThreshold = _totalSupply * 15 / 10000; // 0.2% of supply
