...
contract CUTE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x259f243E95d92711aA26c1B0F2FCdf9Ee2D4a7D3); // Marketing Address

    address payable public teamAddress =
        payable(0x4676aC5B932c18B4316Aa1B4f819DB5E16BFBC8F); // Team Address

    address payable public liquidityAddress =
        payable(0x8E565ED02176158467E026dE7addfBC556E3b0Ac); // Liquidity Address
