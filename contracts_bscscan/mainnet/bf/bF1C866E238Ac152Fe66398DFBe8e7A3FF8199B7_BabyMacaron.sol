...
contract BabyMacaron is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x30Ef7F27c396a2C48527815FDc7e9600FB0e0539); // Marketing Address
    ...
    string private _name = "BabyMAcaron";
    string private _symbol = "BMACARON";
