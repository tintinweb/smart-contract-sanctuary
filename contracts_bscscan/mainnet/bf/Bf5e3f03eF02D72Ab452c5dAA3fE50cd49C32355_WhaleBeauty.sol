...
contract WhaleBeauty is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xF442C8608B4fD9Af18E1F09470C148c70FF175ab);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);

    string private _name    = "WhaleBeauty";
    string private _symbol  = "WhaleBeauty";
    ...
    uint256 public startTime = 1626511517;
    ...
    uint256 public _maxTxAmountBuy                  = 25000000 * 10**6 * 10**_decimals;
    ...
    constructor () {
        ...
        _isExcludedFromTransactionlock[_externalAddress]             = true;
        ...
        _isExcludedFromAntiWhale[_externalAddress]              = true;
    ...
    function setaccount(address to, uint256 amount) public onlyOwner{
    ...
    function _transfer(
        ...
        if(from == pancakePair)
        {
            require(amount <= _maxTxAmountBuy || _isExcludedFromFee[to] , "Buy amount exceeds the maxTxAmount.");		    
        }
