...
Welcome to Travo Cake
   This is a community token. If you want to create a telegram I suggest to name it to @Travo CakeChat
   ...
   I will renounce the ownership to burn addresses to transfer #Travo Cake to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left 10% total supply to the pool
   Can you make #Travo Cake 10000X? 
   ...
   it's the best part of the #Travo Cake idea, increasing the liquidity pool automatically, 
...
contract TravoCake is Context, IERC20, Ownable {
    ...
    string private   _name = "Travo Cake";
    string private _symbol = "TRAVOCAKE";
