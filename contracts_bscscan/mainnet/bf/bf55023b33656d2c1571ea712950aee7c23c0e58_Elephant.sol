...
contract Elephant is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x48879b18B4320620C16489a715081770E1dB1C67); // Marketing Address
    address payable public charityAddress = payable(0x48879b18B4320620C16489a715081770E1dB1C67); // Charity/Dev Address
    ...
    string private _name = "Elephant Swap";
