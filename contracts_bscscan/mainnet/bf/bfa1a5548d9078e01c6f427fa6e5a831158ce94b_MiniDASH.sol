...
contract MiniDASH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x4275FBA37e0d747922b6d634b314ED61195d191f); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0x237BcBE03B9323f4FF23601f0640A68a4D8c30F6); // xrp Address
    ...
    string private _name = "MiniDASH";
    string private _symbol = "MiniDASH";
