...
TG: https://t.me/PocketADA

Web : www.PocketADA.xyz (progress)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BUSD = IERC20(0xCC42724C6683B7E57334c4E856f4c9965ED682bD);
...
// CHANGE
contract PocketADA is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address BUSD = 0xCC42724C6683B7E57334c4E856f4c9965ED682bD;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PocketADA";
    string constant _symbol = "$POCKETADA";
    ...
    uint256 totalFee = 1700; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x3eb10C5FF4a657Df7a62B3804ee75c6fb67FF75B);
