...
contract BabyCollieInu is IBEP20, Auth {
	...
	string constant _name = "BabyCollieInu";
    string constant _symbol = "BCI";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 private _maxTxAmountBuy = _totalSupply / 33;
    uint256 private _maxTxAmountSell = _totalSupply / 33;
	uint256 private _maxWalletAmount = _totalSupply / 33;
	...
	address public marketingWallet = payable(0xA80dE10d63DB98521fceA1703a1d34C6B33eEFc0);
    address private teamWallet = payable(0x380099eb6d88C284b449F4252E6f72793cE809a5);
	...
	constructor() Auth(msg.sender) {
		...
		_balances[msg.sender] = _totalSupply/ 1000000000 * 812975211;

        // Airdropping all previous holders
_balances[0xe6497e1F2C5418978D5fC2cD32AA23315E7a41Fb] = _totalSupply / 1000000000 *3094694;
_balances[0x9901967669574102B2C51906d43bf46F2829221B] = _totalSupply / 1000000000 *18867384;
_balances[0xA80dE10d63DB98521fceA1703a1d34C6B33eEFc0] = _totalSupply / 1000000000 *37051988;
_balances[0xa0224FA776b207bCD46D76aE00C57686e21783BB] = _totalSupply / 1000000000 *426869;
_balances[0xC29b637351779016bB15300B21393F8c732835BA] = _totalSupply / 1000000000 *15200393;
_balances[0x380099eb6d88C284b449F4252E6f72793cE809a5] = _totalSupply / 1000000000 *30000000;
_balances[0x792A60042Ed3fb8FdceB3A3cCda6399e489e1F32] = _totalSupply / 1000000000 *16545794;
_balances[0x4bA0D3F22ce7e0FAEB53a3D46d7147531bCa488d] = _totalSupply / 1000000000 *17393759;
_balances[0x68d9e03658F7f27d2Dc55bdc8C7A29a30bF97d96] = _totalSupply / 1000000000 *12507842;
_balances[0x68E0921e355B27B11362C5602215B85a85CBb259] = _totalSupply / 1000000000 *10429919;
_balances[0x0Dd1f34298Dd55f006A2e099170299935C5D7BC0] = _totalSupply / 1000000000 *8898902;
_balances[0x57Ac0EF73c2F7a53Abdf77Aa70DA37d610451942] = _totalSupply / 1000000000 *9607239;
	...
	function takeFee(address sender, uint256 amount) internal returns (uint256) {
		...
		if (block.number - launchedAt <= antiSniperBlocks || gasLimitActive && tx.gasprice >= antiSniperGasLimit) {
			...
			if (marketingFee > 0) {
                ...
                if(block.number - launchedAt <= 600 && isSell){
	...
	function marketing() internal swapping {
        uint256 amountToLiquidity = balanceOf(address(this)) / 15;
        uint256 amountToSwapForBNB = balanceOf(address(this))-amountToLiquidity;
        ...
        uint256 fourPercentOfTax = onePercentOfTax * 4;

        
        payable(devWallet).transfer(onePercentOfTax);
        payable(teamWallet).transfer(fourPercentOfTax);
