...
/**
 * Supermoonshiba
 * Symbol : supermoonshiba
 * Telegram : @supermoonshiba
 * 
 * We won't stop before we reach the Moon. Join us in this journey.
 *
 * Built for the community. 
 * Simply hold Supermoonshiba to join the journey and experience all of the benefit from Supermoonshiba.
 * 
 * 100% Unruggable
 * --------------- 
 * We will lock 100% LP on DXsale.app right after adding liquidity.
 * You are safe with Supermoonshiba!
 * Hold to Earn
 * 
 * Marketing
 * ---------------
...
contract Supermoonshiba is Context, IERC20, Ownable {
    ...
    string private _name = "Supermoonshiba";
    string private _symbol = "Supermoonshiba";
    ...
    address public charityWallet = 0xd9916bd4c9a7a10163b7d772eD9026e53B74A6dE;
