...
/**
 *Submitted for verification at BscScan.com for some updated mechanisms
 * RedSun is a sunrise will never fall. Respect for all developers.
*/
...
contract Ownable is Context {
    address private _owner = 0xb28fDf5Fccff2Fc55233021ca6Be8B231e3133FF;
...
contract RedSun is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x9aaf962a3D9cE73A2310E831C87Aaa0f0Ec354F3); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "RedSun"; // token name
    string private _symbol = "RedSun"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 1 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
	...
	*/
    ...
    function _transfer(
        ...
        {
            uint256 buyBackAmount = address(this).balance.div(5);
