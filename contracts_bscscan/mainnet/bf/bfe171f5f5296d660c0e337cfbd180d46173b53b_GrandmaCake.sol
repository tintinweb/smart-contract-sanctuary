...
/**
  ______                      _              ______      _          
 / _____)                    | |            / _____)    | |         
| /  ___  ____ ____ ____   _ | |____   ____| /      ____| |  _ ____ 
| | (___)/ ___) _  |  _ \ / || |    \ / _  | |     / _  | | / ) _  )
| \____/| |  ( ( | | | | ( (_| | | | ( ( | | \____( ( | | |< ( (/ / 
 \_____/|_|   \_||_|_| |_|\____|_|_|_|\_||_|\______)_||_|_| \_)____)
                                                                    
 Hold $GCAKE and get $CAKE automatically in your wallet every hour.
 
 Join our community on Telegram https://t.me/grandmacaketoken
*/
...
contract GrandmaCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Grandma Cake";
    string constant _symbol = "GCAKE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x939C9C1d25BE54da95e578cd5649f8bECBDB8AfF;
