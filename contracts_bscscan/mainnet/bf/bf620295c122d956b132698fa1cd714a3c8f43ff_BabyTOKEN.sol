...
//
// DIVIDEND YIELD PAID IN TOKEN! With the auto-claim feature,
// simply hold $BTOKEN and you'll receive TOKEN automatically in your wallet.
// 
// Hold BabyTOKEN and get rewarded in TOKEN on every transaction!
//
...
contract BabyTOKEN is ERC20, Ownable {
    ...
    address transferredOwner = address(0x13865b7Fa61ecdEb692F9b4f0B03659AAFEe7C3f);

    address public immutable TOKEN = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    uint256 public coreFee = 3;
    uint256 public liquidityFee = 1;
    uint256 public totalFees = dividendsFee.add(marketingFee).add(coreFee).add(liquidityFee);

    address payable public marketingWalletAddress = 0x80773A4Af053641D5b0300f63819dD18e0F88d96;
    address payable public coreWalletAddress = 0x80773A4Af053641D5b0300f63819dD18e0F88d96;
    ...
    constructor() public ERC20("BabyBNB", "BBNB") { 
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "BabyTOKEN: gasForProcessing must be between 200,000 and 600,000");
    ...
    function swapAndSendDividends(uint256 bnbForDividends) private {
        swapBnbForTOKEN(bnbForDividends);
...
contract BabyTOKENDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("BabyTOKEN_Dividen_Tracker", "BabyTOKEN_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2 * (10**18); //must hold 2+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "BabyTOKEN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BabyTOKEN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyTOKEN contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BabyTOKEN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BabyTOKEN_Dividend_Tracker: Cannot update claimWait to same value");
