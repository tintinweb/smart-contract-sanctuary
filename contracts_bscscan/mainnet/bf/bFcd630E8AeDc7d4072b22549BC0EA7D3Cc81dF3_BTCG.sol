...
7% rewards Fees in BTC - directly auto claimed into your wallet just by holding BitcoinGold Cardano Tokens !
5% to marketing and 5% to liquidity pool.
Diamond hands will be rewarded !!

Official Telegram group : https://t.me/BitcoinGold_bsc
...
import "./BTCGDividendTracker.sol";

contract BTCG is ERC20, Ownable {
    ...
    BTCGDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("BitcoinGold Cardano", "BTCG") {

    	dividendTracker = new BTCGDividendTracker();

        _marketingWalletAddress = 0x4152A83fEAfEd5Ed96570a4B7A204d859579Dffd;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BTCG: The dividend tracker already has that address");

        BTCGDividendTracker newDividendTracker = BTCGDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BTCG: The new dividend tracker must be owned by the BTCG token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BTCG: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BTCG: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BTCG: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BTCG: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BTCG: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BTCG: Cannot update gasForProcessing to same value");
