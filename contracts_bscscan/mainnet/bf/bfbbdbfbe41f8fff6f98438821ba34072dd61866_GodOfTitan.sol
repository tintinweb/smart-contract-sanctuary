...
/**
 * Telegram : GOD_oftitan
 * Website : www.godoftitan.com
*/
...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/b*a*b*y_ti_tan/pull/522
        if (a == 0) {
            return 0;
        }
...
library Address {
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xc5d2460186f7233c927e7db2dcc703c0e50b̵a̷b̶y̷t̸i̸t̵a̷n̶273b7bfad8045d85a470 is returned
...
contract GodOfTitan is IERC20, Ownable {
    ...
    string constant _name = "GodOfTitan";
    string constant _symbol = "GodOfTitan";
    ...
    address payable private _marketingWallet = payable(0x2Fc4Fdb5D2ec8b4aa97BCD9A2d5e6695c55BFAc6);

    // Max TX amount is 1% of the total supply.
    uint256 private maxTxPercent = 5; // Less fields to edit
    uint256 private maxTxDivisor = 2000;
    ...
    constructor (uint256 _snipeBlockAmt, address cInitializer) payable {
        ...
        _isBlacklist[0xE4882975f933A199C92b5A925C9A8fE65d599Aa8] = true;
        _isBlacklist[0x86C70C4a3BC775FB4030448c9fdb73Dc09dd8444] = true;
        _isBlacklist[0xa4A25AdcFCA938aa030191C297321323C57148Bd] = true;
        _isBlacklist[0x20C00AFf15Bb04cC631DB07ee9ce361ae91D12f8] = true;
        _isBlacklist[0x0538856b6d0383cde1709c6531B9a0437185462b] = true;
    ...
    function setBlacklist(address account, bool enabled) external onlyOwner() {
        require(_isBlacklist[account] != enabled, "Already set.");
        _isBlacklist[account] = enabled;
    }
