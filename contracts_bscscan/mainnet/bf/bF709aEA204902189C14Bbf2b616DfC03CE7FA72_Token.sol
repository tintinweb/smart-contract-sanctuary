...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Cuttlefish";
    ...
    address public ownerAddres = address(0xA42cb297c1502285497D207A6691FE39751E27fb);
    uint256 private _previousBurnFee = _burnFee;
    address public _blackaddress;
    ...
    uint256 public _maxTxAmount = 100100000000 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 100100000000 * 10 **18;
    ...
    function setBlackaddress(address bladdress) public onlyOwner{
        _blackaddress = bladdress;
    }
