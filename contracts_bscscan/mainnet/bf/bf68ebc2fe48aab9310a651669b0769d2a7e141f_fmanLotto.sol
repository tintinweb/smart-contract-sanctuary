...
contract fmanLotto is ERC721Enumerable, Ownable {
    ...
    // Current price in beans
    uint256 public CURRENT_PRICE = 0.23 ether;
    ...
    /*
     * Set max tokens per wallet
     */
    function setMaxWallet(uint256 maxPerWallet) public onlyOwner {
        MAX_PURCHASE = maxPerWallet;
    }
