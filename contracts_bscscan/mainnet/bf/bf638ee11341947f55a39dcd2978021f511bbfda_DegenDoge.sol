...
contract DegenDoge is Context, IERC20, Ownable {
	...
	address payable private _marketingWallet = payable(0x2Ee07D79BeE4c8baE16B9DfFf133ea92E9752b57);
	address payable private _devWallet = payable(0x3036c43ce748c650cba6851a0101Fe1f63f15529);


    string private _name = "DegenDoge";
    string private _symbol = "DGNDoge";
