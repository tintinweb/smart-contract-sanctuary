...
contract DOGE2K22 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE2K22";
    string private _symbol = "DOGE22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD0e7AF406e1EEc6d6421F0CA0EABD0f68CC0F51C); // Marketing Address
    address payable public teamWalletAddress = payable(0xd10cD65e15418756d2069E865b9343614d66f5EE); // Team Address
