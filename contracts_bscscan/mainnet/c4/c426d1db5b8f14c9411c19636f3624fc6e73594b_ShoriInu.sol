...
contract ShoriInu is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Shori Inu";
    string private constant _symbol   = "SHORI";
    ...
    uint256 public _marketingFee = 400; // 4% of every transaction is sent to BuyBack-Burn & marketing wallet
