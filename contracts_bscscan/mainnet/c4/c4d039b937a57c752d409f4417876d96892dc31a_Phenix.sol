...
contract Phenix is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5000000000000 * 10**6 * 10**7;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
     ...
     address payable public charityAddress = 0xb7570E5297AC71fbef7285Ebee8fB1F548bFbd04;
   ...
   function includeInFee(address account) external onlyOwner {
        (, uint256 rTransferAmount,, uint256 tTransferAmount,,) = _getValues(5000000000000);
