...
contract SURFVESTING is Ownable() {
    ...
    IERC20 public tokenSURF;

    constructor (address tokenSURFAddress) {
    ...
    function depositAndConfigureVesting(
        ...
        require(vestingAmount <= tokenSURF.balanceOf(address(this)), INVALID_VESTING_CONFIG_ERR);
    ...
    function _claim(address investor) internal {
        ...
        tokenSURF.transfer(investor, availableAmount);
    }
...

{
  ...
  "libraries": {
    "contracts/lib/Heap.sol": {
      "SummingPriorityQueue": "0x4b0876f5d03faa1e17939b6b032c811034538478"
    }
  }
}