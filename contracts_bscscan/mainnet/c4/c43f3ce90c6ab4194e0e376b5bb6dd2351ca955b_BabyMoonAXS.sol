...
contract BabyMoonAXS is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMoonAXS";
    string constant _symbol = "BMAXS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 900000000; 
