...
contract MoonDPET is Context, IERC20, Ownable {
    ...
    string private constant _name = 'MoonDPET';
    string private constant _symbol = 'MDP';
    ...
    // max transaction
    uint256 private _maxTxAmount = 5000 * _decimalFactor;
