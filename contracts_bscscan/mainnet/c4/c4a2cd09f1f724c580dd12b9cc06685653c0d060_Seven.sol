...
contract Seven is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xa3aa2FF5c64AA22a3D77Cc72e076C1043841913B); // Marketing Address
    ...
    uint256 private _tTotal = 300000000 * 10**2 * 10**9;
    ...
    uint256 public _maxTxAmount = 300000000 * 10**2 * 10**9;
