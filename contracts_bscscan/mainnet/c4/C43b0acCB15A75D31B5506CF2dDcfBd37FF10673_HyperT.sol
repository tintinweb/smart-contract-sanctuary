...
//XX Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract HyperT is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'HyperTax';
    string private constant _symbol = 'HyperT';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 10**9 * 10**_decimals;

    //Divider for the MaxBalance based on circulating Supply (2.5%)
    uint8 public constant MaxBalanceDivider=25;
    ...
    uint8 private constant _buyTax =70;
    uint8 private constant _sellTax =25;
    uint8 private constant _transferTax=50;

    uint8 private constant BurnTax=10;
    uint8 private constant LiquidityTax=90;
    ...
    modifier onlyCreatorOrOwner() {
        require(_isCreatorOrOwner(msg.sender), "Caller not Creator or Owner");
        _;
    }
    //Checks if address is in Team, is needed to give Team access even if contract is renounced
    //Team doesn't have access to critical Functions that could turn this into a Rugpull(Exept liquidity unlocks)
    function _isCreatorOrOwner(address addr) private view returns (bool){
        return addr==owner()||addr==contractCreator;
    }
    
    constructor () {
        ...
        balanceLimit=InitialSupply/MaxBalanceDivider;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private{
        ...
        //Pick transfer
        if(isContractTransfer || isExcluded)
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        uint256 pancakeToken=_calculateFee(amount, tax, LiquidityTax);
        //Subtract the Taxed Tokens from the amount
        uint256 taxedAmount=amount-(tokensToBeBurnt + pancakeToken);

        _balances[sender]-=amount;
        //Adds the taxed tokens to the contract wallet
        _balances[_pancakePairAddress] += pancakeToken;
        //Burns tokens
    ...
    function SwitchManualBNBConversion(bool manual) public onlyCreatorOrOwner{
        manualConversion=manual;
    }
    //Exclude/Include account from fees (eg. CEX)
    function ExcludeAccountFromFees(address account, bool exclude) public onlyCreatorOrOwner {
    ...
    function LockLiquidityForSeconds(uint256 secondsUntilUnlock) public onlyCreatorOrOwner{
    ...
    function LiquidityRelease() public onlyCreatorOrOwner {
    ...
    function SetupCreateLP() public payable onlyCreatorOrOwner{
