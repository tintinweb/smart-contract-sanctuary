...
/**
   ...
   Welcome to DogeSleep
   
   This is a community token. If you want to create a telegram I suggest to name it to @DogeSleep
...
contract DogeSleep is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Sleep";
