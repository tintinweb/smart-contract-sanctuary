...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAb29758D6ec51b08546E998A09ADE60a2dDBd74A;
...
contract POODLEINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBb5745b95Dd0E244Aa6111ce6009088f04eB22b1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Poodle Inu";
    string private _symbol = "PODDLE";
