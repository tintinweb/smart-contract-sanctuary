...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xe2E9aa62AbEc42EE6b43d991252077e58faC6E51;
...
contract ArenaCoin is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x402352DAFdDaF146342440Ba0ff5cb80aAB16Dea;   //prize pool funds
    ...
    string private _name = "Arena Coin Round 10";
    string private _symbol = "$ARENA";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _charityFee = 13; // prize pool tax
