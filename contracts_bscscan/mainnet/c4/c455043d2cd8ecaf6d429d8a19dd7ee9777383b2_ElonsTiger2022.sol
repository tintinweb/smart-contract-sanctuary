...
/**
ElonsTiger2022
Telegram - https://t.me/ElonsTiger2022
*/
...
contract ElonsTiger2022 is IBEP20, Auth {
    ...
    string constant _name = "ElonsTiger2022";
    string constant _symbol = "ET2022";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100;  //100% max tx
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100;  //100% max wallet
    ...
    address private marketingFeeReceiver =0xCa0664eb32821066632C4a1870E2A830B688C217;
    address private teamFeeReceiver =0xCa0664eb32821066632C4a1870E2A830B688C217;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xbd5A749B4c7C1b8F597DbBc5da1b52829c1450A0;
  ...
  //      require(Success3, "receiver rejected ETH transfer");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function manualSend() external authorized {
        ...
        payable(marketingFeeReceiver).transfer(contractETHBalance/2);
        payable(teamFeeReceiver).transfer(contractETHBalance/2);
    }
