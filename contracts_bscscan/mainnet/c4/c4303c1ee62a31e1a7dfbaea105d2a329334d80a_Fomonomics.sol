...
https://t.me/Fomonimics

Fomonimics Every day! Every transaction, holders of Fomonimics will receive tokens that were collected by the fees. Watch the number of tokens you own grows overnight.
...
*/
    ...
    contract Fomonomics is IBEP20, Ownable
    {
        ...
        string private constant _name = "Fomonomics";
        string private constant _symbol = "Fmonomics";
        ...
        address public constant TeamWallet=0x1eE6088626678F40dAD10ca4DCfdeC3a4381F089; //TEAMWALLET
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _circulatingSupply =InitialSupply;
        uint256 public  balanceLimit = 30_000_000 * 10**_decimals;
        uint256 public  sellLimit = 10_000_000 * 10**_decimals;
        ...
        constructor () {
            ...
            _burnTax=20;       // 
            _liquidityTax=30;  //liquidity+stake
            _stakingTax=10;    //
            _marketingTax=50;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private{
            ...
            if(isContractTransfer || isLiquidityTransfer || isExcluded){
                ...
                require(buybackEnabled,"AntiWhale not yet enabled");
    ...
    function SetupAntiBots() public onlyOwner{
        buybackEnabled=true;
    }

    function SetupAntiWhale() public onlyOwner{
