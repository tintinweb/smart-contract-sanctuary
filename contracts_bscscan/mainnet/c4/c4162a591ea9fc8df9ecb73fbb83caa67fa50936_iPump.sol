...
Buy tax is always 10%, sell tax can go from 10% at ATH to 90% depending on how far we are from ATH and what the impact on the price would be.
The maximum sell tax will be lowered in increments of 10% over the first hours of trading: 10% lower every 30 minutes of trading until we reach 10% maximum sell tax.
At that point, buy and sell tax will be 10% max.

Anti-Whale: Each wallet holder can only purchase up to 1% of total supply.

More details regarding the sell tax at launch:
...
• Anti-Panic Selling: If the price comes down from ATH, special selling TAX fee will be adjusted to 3 X % gap from ATH and apply to all sellers. For Example:

o Current Price is 10% below ATH, selling Tax is 30%.

o Current Price is 20% below ATH, selling Tax is 60%.

o Current Price is 30% below ATH, selling Tax is 90%.
...
contract iPump is Context, IBEP20, Ownable { 
    ...
    string private _name = "iPump";
    string private _symbol = "iPump";
    uint8 private _decimals = 9;    
    uint256 public _takerate = 1000;
    uint256 public _Oritakerate = 1000;
    uint256 public _Maxtakerate = 9000;
    uint256 public _PriceDownTaxPercent = 15;
    uint256 public _PriceDownImpactPercent = 100;
