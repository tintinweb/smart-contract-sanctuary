...
contract MANHATTANCAKE is ERC20, Ownable {
    ...
    constructor() ERC20("ManhattanCake", "MC") {
    ...
    uint256 private maxBuy = 10_000_000_000 * (1e18);
    uint256 private maxSell = 10_000_000_000 * (1e18);
    uint256 private maxWallet = 10_000_000_000 * (1e18);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "MANHATTANCAKE: The new dividend tracker must be owned by the MANHATTANCAKE token contract");
    ...
    function airdropToWallets(address[] memory airdropWallets, uint256[] memory amount) external onlyOwner() {
        require(airdropWallets.length == amount.length, "MANHATTANCAKE: airdropToWallets:: Arrays must be the same length");
        require(airdropWallets.length < 40, "MANHATTANCAKE: airdropToWallets:: Cannot airdrop more than 40 wallets due to gas limit restrictions");
...
contract MANHATTANCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("MANHATTANCAKE_Dividend_Tracker", "MANHATTANCAKE_Dividend_Tracker") {
    	claimWait = 1200;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "MANHATTANCAKE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
