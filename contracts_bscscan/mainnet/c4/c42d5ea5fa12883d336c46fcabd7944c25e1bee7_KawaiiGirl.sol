...
// SPDX-License-Identifier: MIT
    ...
    /*
    Kawaii Girl - Relaunching Soon
    Telegram : https://t.me/KawaiiGirlBSC
    */
    ...
    */
    ...
    contract KawaiiGirl is ERC20, Ownable {
        using SafeMath for uint256;
        ...
        uint256 public _maxWalletLimit = 3000000 * (10**9);

        uint256 public _liquidityFee = 5;
        uint256 public _marketingFee = 7;

        uint256 public _maxBuyLimit = 200000000 * (10**9);
        ...
        address public _marketingWalletAddress = 0x35263E68Df0787b2fA175B84E8943fd83Bbae409;
        address public _teamWalletAddress = 0x35263E68Df0787b2fA175B84E8943fd83Bbae409;
        ...
        constructor() ERC20("KawaiiGirl", "KawaiiGirl")  {
        ...
        function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
            ...
            function presaleDistribution() external onlyOwner{
            }
            ...
            function disableTaxSell() external onlyOwner{
            }

            function taxSell() external onlyOwner{
            }

            function renounceOwnership() public onlyOwner{
            }

            function setFees() public onlyOwner{
            }
            ...
            function setFeeReflection() public onlyOwner{
            }
        ...
        function setMaxWalletLimit(uint256 value) external onlyOwner{
            require(value >= 2000000000 * (10**9), "Minimum max wallet limit is 2 percent");
