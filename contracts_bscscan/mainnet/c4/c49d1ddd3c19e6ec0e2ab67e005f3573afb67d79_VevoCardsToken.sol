...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8f5195DDcDA6bbFb7FEB59279a70d89326F1EAc7;
...
contract VevoCardsToken is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xD8FD3D0ebE3B6aEb2b2ef573183CB26a1d0e0bE3;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "VevoCards Token";
    string private _symbol = "VEVOCARDS";
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**3 * 10**18;
