...
contract SHARINGAN is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = "Sharingan Shiba Inu";
    ...
    address public MarketingWallet=payable(0x853D036dd1d3EA2d42E85133B49d6652902917cc);
    address public devWallet=payable(0x15E95fA0e1658A575a5C9ACa722088035e00bfbE);
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==MarketingWallet||addr==devWallet;
    }
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(devWallet).transfer((amount*50) / 100);
    } 
    ...
    function TeamChangeDevWallet(address newDevWallet) public onlyOwner{
