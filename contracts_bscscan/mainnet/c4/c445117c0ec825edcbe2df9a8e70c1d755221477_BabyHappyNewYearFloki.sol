...
// Telegram  https://t.me/BabyHappyNewYearFloki
...
// CHANGE
contract BabyHappyNewYearFloki  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyHappyNewYearFloki";
    string constant _symbol = "BabyFloki22";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 2% MAX 200,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xd27E75B0D4332fD7a7d0696ed7c000A3f555898C); // Change
