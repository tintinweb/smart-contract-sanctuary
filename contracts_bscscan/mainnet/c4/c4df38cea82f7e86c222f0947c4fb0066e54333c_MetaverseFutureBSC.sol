...
contract MetaverseFutureBSC is MetaverseFutureETR, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtMetaverseFutureETR;
    address private CharityMetaverseFutureETR;
    ...
    string public override name = "Metabucks Rewards";
    string public override symbol = "Metabucks Rewards";
    ...
    constructor(uint totalSupplyValue, address TeamtMetaverseFutureETRAddress, address CharityMetaverseFutureETRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtMetaverseFutureETR = TeamtMetaverseFutureETRAddress;
        CharityMetaverseFutureETR = CharityMetaverseFutureETRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtMetaverseFutureETR] = totalSupply * 4 / 100;
        balances[CharityMetaverseFutureETR] = totalSupply * 4 / 100;
