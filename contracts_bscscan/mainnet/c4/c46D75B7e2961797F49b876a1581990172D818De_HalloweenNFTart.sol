...
/*
    ...
    🎃HalloweenNFTart🎃
    🎃FAİRLAUNCH 02.11.2021 at 16:00UTC 🎃
    
    When witches go riding, and black bats are seen,
    the moon laughs and whispers, ’tis near #Halloween.
    
    🎉Raffles; Daily raffles ensure a steady user base with a fun environment to propel community activity.
    🔑Security; Smart contract used are tried and true to protect all users from any malicious threats.
    🏆Bounties; Be a bounty hunter and collect rewards by completing desired tasks from developers.
    
    
    TOKENOMICS
    
    Total Supply: 1,313,131,313,131.313
    3 BNB will be added on liquidity pool.
    50% supply will be burnt after launch
    40% liquidity pool will be locked for 3 months
    ...
    🦈Website:       http://www.halloweennft.art
    🔎Telegram :    t.me/HalloweenNFTart
    🔎Twitter:      https://twitter.com/HalloweenNFTart
...
contract HalloweenNFTart is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1313131313131313 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name     = "HalloweenNFTart";
    string private constant _symbol   = "NFTart";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 40000000000000 * 10**9;
