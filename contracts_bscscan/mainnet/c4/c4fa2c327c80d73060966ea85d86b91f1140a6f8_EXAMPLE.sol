...
contract EXAMPLE is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "BABY MOON";
    string private constant _symbol   = "BBM";
    ...
    uint256 private _minTokenBalance = 250000000000 * 10**9;
    ...
    uint256 public _antiWhaleThreshold = 50000000000000 * 10**9;
    ...
    function _transfer(
        ...
        */
        ...
        /*
            anti whale: check if sender balance will be greater than 1% of total supply
