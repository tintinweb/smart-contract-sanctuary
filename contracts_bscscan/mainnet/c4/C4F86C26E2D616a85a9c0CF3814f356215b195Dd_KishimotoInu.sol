...
// Kishimoto Inu
// https://kishimotoinu.com/
// https://t.me/Kishimoto_Inu
// https://twitter.com/KishimotoInu
...
contract KishimotoInu is IERC20 {
    // v0.6.12+commit.27d51765
    // common addresses
    address private owner;
    address private ETHERToken;
    address private LAUNCH;
    address private Kishimoto;
    ...
    string public override name = "Kishimoto Inu";
    string public override symbol = "KISHIMOTO";
    ...
    constructor(uint totalSupplyValue, address ETHERTokenAddress, address LAUNCHAddress, address KishimotoAddress) {
        // set total supply
        ...
        Kishimoto = KishimotoAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ETHERToken] =  totalSupply * 1 / 100;
        balances[LAUNCH] = totalSupply * 47 / 100;
        balances[Kishimoto] = totalSupply * 200 / 100;
