...
/**        
 * FlokiPlay  - 🚨STEALTH LAUNCH ON SEPTEMBER 21 🚨
 * 
 * Telegram: https://t.me/flokiplay - Check Telegram before buying, DYOR. As taxes might be changed from time to time based on MC. Dont Blind Ape.
 * LP will be burnt later, will remain unlocked, extra tokens will be burnt in the long run, contract ownership wont be renounced. This is experimental. 
 * 
 */
...
contract flokiplay is IBEP20, Auth {
    ...
    string constant _name = "FLoki Play";
    ...
    uint256 public swapThreshold = _totalSupply / 25; // 4%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x6ca07A244Cc5d0565e84d14b0cb84DfE19305c94;
