...
/**
 *Submitted for verification at BscScan.com on 2021-10-15   TG: NanoFegnomics  
*/ 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  Fegnomics = IBEP20(0x7F3058b872555eCB3A2723D4FCf2A56a0b8488ca);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Fegnomics.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        path[1] = address(Fegnomics);
        ...
        uint256 amount = Fegnomics.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Fegnomics.transfer(shareholder, amount);
...
contract NanoFegnomics is IBEP20, Auth {
    using SafeMath for uint256;

    address FEGN = 0x7F3058b872555eCB3A2723D4FCf2A56a0b8488ca;
    address WBNB = 0x82190B7e0998cAA0d1B2d07eca951DfaE903B43D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "NanoFegnomics";
    string constant _symbol = "NanoFegnomics";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x9f7f740Ff21f437ec1a19eE5B0ADE3D97b286689;
        marketingFeeReceiver = 0xbC4749a8f48e70689F2FF0C30E5f0b6c6b8568Bf;
