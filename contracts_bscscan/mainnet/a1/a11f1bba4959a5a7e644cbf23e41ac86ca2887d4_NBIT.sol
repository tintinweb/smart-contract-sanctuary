...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    ...
    balances[owner] = 5800000*10** uint(decimals);
    balances[address(this)] = 2000000*10** uint(decimals);
    emit Transfer(address(0), owner, 5800000*10** uint(decimals));
    emit Transfer(address(0), address(this), 2000000*10** uint(decimals)); 
  }
...
contract NBIT is TokenBEP20 {
  ...
  constructor () public {
      ...
      startAirdrop(block.number,99999999, 1*10** uint(decimals), 100000);
      startSale(block.number, 99999999, 0, 10000*10** uint(decimals), 1900000);
}
