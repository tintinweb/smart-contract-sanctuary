...
contract AstroPaidXpace is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'AstroPaidXpace';
    string  private _SYMBOL = 'APXP';
    ...
    uint256 private _tTotal = 2000000000 * _DECIMALFACTOR;
    ...
    uint256 private _MAX_TX_SIZE = 2000000000 * _DECIMALFACTOR;
