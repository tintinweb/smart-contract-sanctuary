...
contract Context {
 ...
 contract ComeOnMoon is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private balancesOfAll;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    uint8 private grandfather;
    string private _name = "ComeOnMoon";
    string private _symbol = "ComeOnMoon";
    ...
    address private _pancakeRouter = 0x6599F5aD12ebE7bDf9211B253E5a7923F64c7BD2;
