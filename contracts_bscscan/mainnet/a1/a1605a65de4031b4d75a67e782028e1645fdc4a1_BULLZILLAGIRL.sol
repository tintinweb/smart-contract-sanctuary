...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        _burnaddress = 0xc215faD4D634B1e09d426c79F6797853232E502f;
...
contract BULLZILLAGIRL is ERC20 {

    uint tokenTotalSupply = 69000000000; // 100 Million Token Supply

    constructor() public ERC20("BULLZILLAGIRL ", "BULLZILLAGIRL") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BULLZILLAGIRL";
    string private _symbol = "BULLZILLAGIRL";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x5D05cFA872F046d1350e96161712CEDcea115475, 'We can not exclude Uniswap router.');
