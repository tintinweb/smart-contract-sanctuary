...
/*
 ...
 DIVIDEND YIELD PAID IN $SPHYNX! With the auto-claim feature,
 simply hold $TinySphynx and you'll receive $SPHYNX automatically in your wallet.

 Total Supply: 1,000,000,000 Tokens
 Max Wallet: 2% of total supply (20000000 Tokens)
 Max Transaction: 2% of total supply (20000000 Tokens)
 

 Telegram: https://t.me/tinysphynx
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SPHYNX = IERC20(0x2e121Ed64EEEB58788dDb204627cCB7C7c59884c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SPHYNX.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SPHYNX);
        ...
        uint256 amount = SPHYNX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SPHYNX.transfer(shareholder, amount);
...
contract TinySphynx is IERC20, Ownable {
    using SafeMath for uint256;

    address SPHYNX = 0x2e121Ed64EEEB58788dDb204627cCB7C7c59884c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TinySphynx";
    string constant _symbol = "TSPNX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; //1% of total supply
