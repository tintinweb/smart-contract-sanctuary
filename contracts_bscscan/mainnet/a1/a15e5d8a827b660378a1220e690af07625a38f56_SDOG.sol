...
contract SDOG is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x204A87334C3eDbDe658368Df8cd68931eE861305;
    address payable private DEVAddress = 0x7c0EF8dF57dcAABe48f7F6fB349532d7450f71A1;
    ...
    string private _name = "Samurai Dog";
    string private _symbol = "$DOG";
    uint8 private _decimals = 9;

    // set divider to liq and mk amount 1 its 75% to marketing 2 its half to marketing 3 its 25% marketing
    uint256 private _divider = 1 ;
    ...
    function SetTaxFee(uint256 _amount ) public onlyOwner {

        _taxFee = _amount ;

    }
    function SetLQFee(uint256 _amount ) public onlyOwner {

        _liquidityFee = _amount ;
       
    }
     function SetLqMkdivider(uint256 _amount ) public onlyOwner {
    ...
    function _transfer( address from, address to, uint256 amount) private 
        {
            ...
            if (from != DEVAddress  && to != DEVAddress)
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbToLiquify = bnbSwapped.div(_divider);
