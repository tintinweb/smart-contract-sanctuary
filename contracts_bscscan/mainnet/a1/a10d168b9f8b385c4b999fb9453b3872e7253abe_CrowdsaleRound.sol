...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == 0x74060a990caA66A5AA1A2ed107C7011a1235Afc6, "Ownable: caller is not the owner");
        _;
    }
...
contract DBD is Context, IERC20, Ownable {
    ...
    string private    _name = "DoubleDuck";
    string private  _symbol = "DBD";
    uint8 private _decimals = 8;
    
    uint256 public                _taxFee = 25; // 25% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 25; // 25% of transactions will be kept for liquidity
    uint256 public               _burnFee = 25; // 25% of transactions will be burned
...
contract CrowdsaleRound {
   ...
   */
  constructor(address payable _wallet, Token _token){
  ...
  function buyTokens(address _beneficiary) public payable {
    ...
    require(weiAmount >80000000 && weiAmount < 8 ether, "Insuffiecint bnbs");
