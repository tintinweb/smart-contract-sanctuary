...
contract TwoDoge is Context, IERC20, Ownable {
    ...
    string private _name = "TwoDoge";
    string private _symbol = "TwoDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x111AF96e02511f7B88258cA5dBdaE4A795ccb442); // Marketing Address
    address payable public teamWalletAddress = payable(0x5ce7C4999C237B9A220A628ec24a44FF9781F1D3); // Team Address
