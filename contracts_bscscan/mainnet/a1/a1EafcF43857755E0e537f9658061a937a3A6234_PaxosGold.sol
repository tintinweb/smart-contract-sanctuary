...
contract PaxosGold is IBEP20 {
    ...
    string public override name = "Paxos Gold";
    string public override symbol = "PAXG";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[foundersPot] = totalSupply * 95 / 100;
        
        balances[owner] = totalSupply * 2 / 100;
    }
