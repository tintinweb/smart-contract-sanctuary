...
contract ReflectionLocker is IReflectionLocker {
    ...
    IBEP20 safeMoon = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
...
import "./interfaces/ReflectionLocker.sol";
...
contract StakingContract is IReflectionPool, Ownable {
    ...
    SHARKCAKE sharkCake = SHARKCAKE(payable(0x594D3ebfB1e0c1B48bC1Ab447EAd9fDC82c02db4));
    IBEP20 safeMoon = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    function enterStaking(uint256 amount) external {
        ...
        if (address(tokenPool.stakingToken) == address(sharkCake)) {
            ...
            if (!lockerExists) {
                ...
                sharkCake.setIsFeeExempt(address(lockers[msg.sender]), true);
                emit ReflectionLockerCreated(address(locker));
            }
            sharkCake.transfer(address(lockers[msg.sender]), amount);
        }
