...
contract Ownable is Context {
    address private _owner = 0x05e2b011fc94EC40f70Bc04e77c4B2DEd96F5620;
...
contract Thehardwork is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x0358B019488E185bE7bcAD1d5f5109ceE114f1a0); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "The hard work"; // token name
    string private _symbol = "THW"; // token symbol
