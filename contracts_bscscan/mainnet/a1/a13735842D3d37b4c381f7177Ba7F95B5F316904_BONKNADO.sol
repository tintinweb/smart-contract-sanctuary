...
BONKNADO. BIG HEAVY WET REFLECTIONS. BE BONKY BROS
...
contract BONKNADO is Context, IERC20, Ownable {
    ...
    string private _name = 'BONKNADO';

    string private _symbol = 'BONKNADO';
