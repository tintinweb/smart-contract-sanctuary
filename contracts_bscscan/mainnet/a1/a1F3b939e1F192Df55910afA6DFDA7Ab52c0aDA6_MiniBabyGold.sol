...
Welcome to MiniBabyGold
   This is a community token. If you want to create a telegram I suggest to name it to @MiniBabyGoldChat
   ...
   I will renounce the ownership to burn addresses to transfer #MiniBabyGold to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left All (100%) total supply to the pool
   Can you make #MiniBabyGold 10000X? 
   ...
   it's the best part of the #MiniBabyGold idea, increasing the liquidity pool automatically, 
...
contract MiniBabyGold is Context, IERC20, Ownable {
    ...
    string private   _name = "MiniBabyGold";
    string private _symbol = "MBGold";
