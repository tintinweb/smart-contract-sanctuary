...
/**
    NeverWage BSC ----- For a comfy life -----
    8% BUSD Rewards
    4% Liquidity
    0.5% Marketing
    1.5% Max Wallet size
...
contract NeverWage is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xB21D255Ac7216B0eFD380Dc82b74cA785273561D;
 ...
 // ANTI-BOT MECHANISM TO PREVENT BOTS RUINING OUR LAUNCH. TAXES WILL BE CHANGED TO 13.5% THEN RENOUNCED. SEE READ CONTRACT FOR CURRENT VALUES
    uint256 liquidityFee    = 100;
    uint256 reflectionFee   = 100;
    uint256 marketingFee    = 9700;
    uint256 public totalFee = 9900;
