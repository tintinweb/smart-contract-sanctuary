...
╚═════╝░╚═╝░░╚═╝╚═════╝░░░░╚═╝░░░  ╚═════╝░╚═╝░░╚═╝╚═╝╚═════╝░╚═╝░░╚═╝  ╚═╝░░╚═╝╚═╝╚═╝░░╚══╝░╚═════╝░
    ...
    🎉3% to rewards
    💌2% to LP
    🚀5% to marketing and operations

*/
// 📱 Telegram: https://t.me/babyshibaking
// 
// 
...
interface IERC20 {
     ...
     */
    function transfer(address recipient, uint256 amount) external returns (bool);// 🌎 Website: https://www.kittycake.app/
...
contract BabyShibaKing is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 4000000000000 * 10**9;
  string private _symbol = "SHIBKING";
  string private _name = "Baby Shiba King";
