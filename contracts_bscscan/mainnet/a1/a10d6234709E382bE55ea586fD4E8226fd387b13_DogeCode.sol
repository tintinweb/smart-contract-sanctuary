...
contract DogeCode is Context, IERC20, Ownable {
    ...
    string private _name = "BUFFED FOREVER";
    string private _symbol = "buffedforever";
    ...
    address public charityWallet = 0x5Bd9b314973BfB7e801444C60d491abad3108EaB;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x5Bd9b314973BfB7e801444C60d491abad3108EaB, 'We can not exclude Pancake router.');
