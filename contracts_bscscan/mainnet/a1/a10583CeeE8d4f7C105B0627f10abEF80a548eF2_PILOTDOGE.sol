...
Token Name: PILOT DOGE
Earn $DOGE just by holding.$PilotDoge is a new generation of autonomous frictionless yield farming protocols.
Hold $PilotDoge in your wallet to Earn $DOGE. Claim your DOGE at any time.
...
contract PILOTDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "PILOT DOGE";
    string private _symbol = "PILOT DOGE";
    ...
    address _marketingWallet = 0x0817aF80319194E372A389A4ABaEdea56bB78499;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    // Max TX amount is 2.5% of the total supply.
    uint256 private maxTxX = 25000000; // Less fields to edit
