...
contract KittyToken is Context, IERC20, Ownable {
    ...
    uint256 public _charityFee = 1; // means 0.01 it menas burn 0.01%
    ...
    constructor()  {
        ...
        _reflectionBalance[owner()] =reflectionFromToken(800000000000e18,false);
        
        
        _reflectionBalance[airDropAddress] = reflectionFromToken(200000000000e18,false);
        
        emit Transfer(address(0),owner(), 800000000000e18);
        
        emit Transfer(address(0),airDropAddress, 200000000000e18);
    }
