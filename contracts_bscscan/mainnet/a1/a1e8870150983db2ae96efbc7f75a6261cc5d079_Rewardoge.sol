...
contract Rewardoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Rewardoge";
    string constant _symbol = "redoge";
    ...
    uint256 reflectionFee = 2100;
    uint256 marketingFee = 200;
    uint256 charityFee = 100;
    uint256 totalBuyFee = 3000;
    ...
    uint256 public swapThreshold = 100 * 10**6 * 10**9;
    bool inSwap;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _charityFee, uint256 _feeDenominator, uint256 _totalSellFee) external authorizedFor(Permission.AdjustContractVariables) {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        charityFee = _charityFee;
        totalBuyFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_marketingFee).add(_charityFee);
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _charityFeeReceiver) external authorizedFor(Permission.AdjustContractVariables) {
