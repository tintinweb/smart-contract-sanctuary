...
interface ERC20Metadata is ERC20 {
 ...
 contract BongoCha is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private susanu;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Bongo Cha Cha Cha";
    string private _symbol;
    uint256 private constant MAX = ~uint256(0);

    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWallet1 = 0xfB2c0FE8F0F76dFC41659B44E02920bD09d3F929;
    address private _feeAddrWallet2 = 0xfB2c0FE8F0F76dFC41659B44E02920bD09d3F929;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private _duduk = 0xfB2c0FE8F0F76dFC41659B44E02920bD09d3F929;
