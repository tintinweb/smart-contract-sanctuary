...
🐝BeeandBee !🐝 Great BNB REWARDS! 10% Rewards🐝

🐝Telegram: https://t.me/BeeandBee_Official 🐝
...
contract BeeAndBee is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    XBNBDividendTracker public dividendTracker;

    address private liquidityWallet;

    uint256 private _totalSup = 1000000 * (10**9);


    uint256 public maxSellTransactionAmount = (_totalSup * 1) / 400000; //2.5% of total supply // 4.000.000
    uint256 public swapTokensAtAmount = (_totalSup * 1) / 20000000; // 0.05% of total supply
    uint256 public _maxWalletToken = (_totalSup * 1) / 100; // 2% of total supply
    ...
    constructor() public ERC20("BeeandBee", "BeeandBee") {
        ...
        _marketingWallet = 0x3161060453a526B8cb6C1Fa52968291b07E58C4E;
        _devWallet = 0x3161060453a526B8cb6C1Fa52968291b07E58C4E;
    	dividendTracker = new XBNBDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        XBNBDividendTracker newDividendTracker = XBNBDividendTracker(payable(newAddress));
    ...
    function afterLaunch() external onlyOwner {
        maxSellTransactionAmount = (_totalSup * 1) / 40; //400
    }
...
contract XBNBDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("XBNB_Dividend_Tracker", "XBNB_Dividend_Tracker") {
    	claimWait = 1200;
