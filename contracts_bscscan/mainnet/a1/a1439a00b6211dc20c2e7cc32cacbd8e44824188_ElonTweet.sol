...
ElonTweet - a token with one purpose only. 
I have hundreds of accounts to comment on Elon tweets , we will blow this thing to 10k at least so buy early
LP locked for a ween, renounced ownership.
Slippage - 5%
...
contract ElonTweet is ERC20 {
    ...
    constructor() public ERC20("ElonTweet", "TELON") {
