...
contract SAJIDAFU is Context, IERC20, Ownable {
    ...
    address private _DonationWalletAddress = 0xAd1647e4ae4395D65Ec0058FE7b09466116242F0; // _DonationWalletAddress
    ...
    string private _name = "SAJIDAFU"; // Token name here
    string private _symbol = "AFU"; // Token Symbol Here
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 0; // Redistribution Fee %
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _DonationFee = 5; // DonationFee % 
    uint256 private _previousDonationFee = _DonationFee;
    uint256 public _liquidityFee = 1; // Liquidity percentage
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x802bFf721d997bd4504FD57770436506AE57D1F3, 'We can not exclude Uniswap router.');
