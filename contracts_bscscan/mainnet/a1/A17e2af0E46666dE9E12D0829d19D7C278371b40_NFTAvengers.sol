...
contract NFTAvengers is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8D7Ba4e17051A438554c71724923EBd237751893); // Marketing Address
    ...
    string private _name = "NFTAvengers";
    string private _symbol = "NFTA";
