...
contract SantaGoesParabolic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x99e937bE65a9f981C1506d2f908763cF798dDbea); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0xCe1d87A6F7A9c511bB02EB4211607384C5790177); // Liquidity Address
    ...
    string private constant _name = "Santa Goes Parabolic";
    string private constant _symbol = "SGP";
    ...
    constructor() {
        address newOwner = address(0x9c08aB9984b9485415e0f4C94532A002E4c0CD88);
        ...
        maxTransactionAmount = _tTotal * 1 / 100; // 2% maxTransactionAmountTxn
    ...
    function enableTrading() external onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + Sniperfuck;
    }
