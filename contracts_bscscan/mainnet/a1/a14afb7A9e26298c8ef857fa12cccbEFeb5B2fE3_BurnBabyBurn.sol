 ...
 * - Supply:            666 BABYBURN
 * - Initial Max TX:    0.666 BABYBURN (0.1% OF TOTAL TOKEN SUPPLY)
 * - Sell cooldown:     30 SECONDS 
 * - Buy cooldown:      10 SECONDS
 * - Fees:              10% burn // 5% liquidity
 * - LP initially locked for 3 days
 *
 * PoC community launches made with <3 
 * https://t.me/ThePillarsOfCreation   
 * 
 * Don't like a fun community and just want to ape? 
 * We've got you covered: https://t.me/GentlemanCalls
 *
 */
