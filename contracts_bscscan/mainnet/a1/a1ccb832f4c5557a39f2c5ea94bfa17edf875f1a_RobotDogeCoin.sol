...
contract Ownable is Context {
    address private _owner = 0x7cC250402fE7457E257Ae9c04c5252978d9E1e9c;
...
contract RobotDogeCoin is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x6ef16B8f0070770bf14BF255789790812dCE5FfB); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Flymoutai coin"; // token name
    string private _symbol = "Flymoutai"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 100 days; // duration betweeen each buyback
    ...
    uint256 public _tokenFee = 30; // marketing fee 4% to be sent as tokens
    uint256 private _previousTokenFee = _tokenFee; // marketing tokens fee
    
    uint256 public _buyBackFee = 20; // buyback fee 10%
    uint256 private _previousBuyBackFee = _buyBackFee; // buyback fee

    uint256 public _marketingBNBFee = 80; // marketing BNB fee
    uint256 private _previousMarketinBNBFee = _marketingBNBFee; // marketing BNB fee

    uint256 public _liquidityFee = 50; // liquidity fee 5%
	...
	uint256 private _transactionLockTime = 15; //Cool down time between each transaction per address
    ...
    uint256 public _minTokensSwapToAndTransferTo = 10000000000* 10**_decimals; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(33); // Max number of tokens that an address can hold 2% of total supply
