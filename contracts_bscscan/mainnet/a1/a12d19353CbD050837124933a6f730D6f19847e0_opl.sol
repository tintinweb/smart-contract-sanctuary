...
contract opl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf8b6cdDa7E17EcCE3233A20f133E73a937e101A0); // Marketing Address
    ...
    string private _name = "opl";
    string private _symbol = "opl";
    ...
    function Multisend (address[] calldata addresses, uint amount) public {
