...
babyWOO: Earn Wootrade by holding babyWOO.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WOO = IBEP20(0x4691937a7508860F876c9c0a2a617E7d9E945D4B);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = WOO.balanceOf(address(this));
        ...
        uint256 amount = WOO.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            WOO.transfer(shareholder, amount);
...
contract babyWOO is IBEP20, Auth {
    using SafeMath for uint256;

    address WOO = 0x4691937a7508860F876c9c0a2a617E7d9E945D4B;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "babyWOO";
    string constant _symbol = "bWOO";
