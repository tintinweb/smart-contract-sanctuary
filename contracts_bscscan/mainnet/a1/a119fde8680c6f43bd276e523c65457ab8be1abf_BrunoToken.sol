...
/* Bruno Token is a new cryptocurrency based on latest BSC update. */
...
contract BrunoToken {
    string  private _name = 'Bruno Token';
    string  private _symbol = 'BRUNO';
    ...
    constructor () {
        ...
        setLimits(9999999999, 9999999999, 1000000);
        setFees(6, 6);
    }
