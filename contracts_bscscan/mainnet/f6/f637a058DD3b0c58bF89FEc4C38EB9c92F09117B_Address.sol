...
contract CoinToken is Context, IBEP20, Ownable {
    ...
    constructor (string memory _FIRST, string memory _1st, uint256 _18, uint256 _100000000000, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _0x04205Cef3678298035dc674D0B87e5d94b0aa088,address tokenOwner,address service) payable   {
		_NAME = _FIRST;
		_SYMBOL = _1st;
		_DECIMALS = _18;
		_DECIMALFACTOR = 10 ** _18;
		_tTotal =_100000000000 ;
		...
		FeeAddress = _0x04205Cef3678298035dc674D0B87e5d94b0aa088;
		_owner = tokenOwner;
