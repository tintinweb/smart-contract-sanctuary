...
interface IAssetPrice {
    ...
    decimal:精度
     */
    function getPrice(address quote, address base) external view returns (uint8, uint256, uint8);
    ...
    price:价格
     */
    function getPrice(address quote, address base, uint8 decimal) external view returns (uint8, uint256);
    ...
    decimal:精度
     */
    function getPriceUSD(address token) external view returns (uint8, uint256, uint8);
    ...
    price:价格
     */
    function getPriceUSD(address token, uint8 decimal) external view returns (uint8, uint256);
    ...
    decimal:精度
     */
    function getUSD(address token, uint256 amount) external view returns (uint8, uint256, uint8);
    ...
    usd:USD
     */
    function getUSD(address token, uint256 amount, uint8 decimal) external view returns (uint8, uint256);
...
contract AssetPrice is IAssetPrice, ConfigBase {
    ...
    function getPrice(address quote, address base) override external view returns (uint8, uint256, uint8) {
        return _getPrice(quote, base);
    }
    
    function getPrice(address quote, address base, uint8 decimal) override external view returns (uint8, uint256) {
        return _getPrice(quote, base, decimal);
    }
    
    function getPriceUSD(address token) override external view returns (uint8, uint256, uint8) {
        return _getPrice(token, USD);
    }
    
    function getPriceUSD(address token, uint8 decimal) override external view returns (uint8, uint256) {
        return _getPrice(token, USD, decimal);
    }
    
    function getUSD(address token, uint256 amount) override external view returns (uint8, uint256, uint8) {
        return _getUSD(token, amount);
    }

    function getUSD(address token, uint256 amount, uint8 decimal) override external view returns (uint8, uint256) {
