...
contract HUMILITY is Context, IERC20, Ownable {
    ...
    string private _symbol = "HUMILITY";
    ...
    uint256 public _sellLiquidityFee = 12; //MARKETING 3% + BUYBACK 3%
    ...
    uint256 private minimumTokensBeforeSwap = 985621 * 10**9 * 10**9; 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 100000000 * 10**9 * 10**9;
    }
