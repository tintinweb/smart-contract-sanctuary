...
contract SANBINANCETOKEN {
    string public name = "SANBINANCE.COM";
    string public symbol = "SBN";
    uint256 public totalSupply = 100000000 * 10 ** 18;//1000000000000000000000000; // 100 Milion tokens
