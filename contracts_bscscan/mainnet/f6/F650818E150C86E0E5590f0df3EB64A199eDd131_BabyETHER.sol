...
// BabyETHERBSC @ https://t.me/BabyEtherBSC

// Earn 10% ETH reflections! 6% tax to LP, 2% to marketing wallet and 1% to dev wallet!
...
contract BabyETHER is ERC20, Ownable {
    ...
    address private _devWallet = address(0xA47F929f50A1156f29EA5D62FdB8C36B746beeBb);
    ...
    uint256 public _maxWalletToken = 10000000000000 * (10**18); // 1% totalSupply
    ...
    constructor() public ERC20("BabyETHER", "BabyETHER") {
