 ...
 */
contract VOWS is IERC20 {
  using SafeMath for uint256;
  using SafeERC20 for VOWS;
  ...
  string public constant name = "CapitolVows";
  string public constant symbol = "VOWS";
  uint8 public constant decimals = 18;
  bool private sync;
  bool public burnPoolSet;
  address private admin;
  
  address public cakeVOWSBurn = address(0);
  ...
  */
      ...
      synchronized
  {
      ...
      _balances[cakeVOWSBurn] = _balances[cakeVOWSBurn].sub(amt, "ERC20: burn amount exceeds balance");
      _totalSupply = _totalSupply.sub(amt);
      IUniswapV2Pair(cakeVOWSBurn).sync();
    ...
    function setVowsBurnPool(address _lpAddress)
        external
        onlyAdmin
        onlyOnce
    {
        cakeVOWSBurn = _lpAddress;
    }
