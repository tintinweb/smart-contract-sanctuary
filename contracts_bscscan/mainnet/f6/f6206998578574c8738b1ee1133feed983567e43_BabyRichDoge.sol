 ...
 * 
 Welcome to $BabyRichDoge:
   ...
   Many Great features:
    ...
    it's the best part of the $BabyRichDoge idea, increasing the liquidity pool automatically.
...
contract BabyRichDoge is Context, IERC20, Ownable {
