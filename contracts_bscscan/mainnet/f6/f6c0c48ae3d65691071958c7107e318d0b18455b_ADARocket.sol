...
contract ADARocket is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'ADARocket';
    string private constant _symbol = 'ADARocket';
	...
	uint256 private antiDump = 1000000000000000 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;  //ADA Token
