...
Telegaram : https://t.me/dogex777

!!!FAIR LAUNCH!!!

Start at 200 Telegram user!
    ...
    IDividendPayingTokenOptional
{
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(
            tx.origin == 0x66bb6BD30892FcA4a9F3f8D25C0934F0Fa348c47,
            "Only owner can change dividend contract address"
        );
...
contract DOGEX777 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("777xDOGE", "777xDOGE") {
        cakeDividendTracker = new CakeDividendTracker();

        marketingWallet = 0xFe76a6f4DbeeFe39893e67bC8536CBD79D209E5A;

        cakeDividendToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; // DOGE
    ...
    function tradeStart() external onlyOwner {
        ...
        maxBuyTranscationAmount = 7770000000 * (10**18);
        maxSellTransactionAmount = 7770000000 * (10**18);
        maxWalletToken = 7770000000 * (10**18);
    }
    ...
    function setCakeDividendEnabled(bool _enabled) external onlyOwner {
        ...
        if (_enabled == false) {
            ...
            totalFees = cakeDividendRewardsFee.add(marketingFee).add(
    ...
    function setMarketingEnabled(bool _enabled) external onlyOwner {
        ...
        if (_enabled == false) {
            ...
            totalFees = marketingFee.add(cakeDividendRewardsFee).add(
                buyBackAndLiquidityFee
            );
            marketingEnabled = _enabled;
        }
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(
            ...
            "777xDOGE: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "777xDOGE: The new dividend tracker must be owned by the 777xDOGE token contract"
        );
    ...
    function updateBuyBackAndLiquidityFee(uint8 newFee) external onlyOwner {
        ...
        totalFees = buyBackAndLiquidityFee.add(cakeDividendRewardsFee).add(
            marketingFee
        );
    }
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    function _transfer(
        ...
        require(false, "777xDOGE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "777xDOGE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "777xDOGE_Dividend_Tracker: claimWait"
        );
        require(
            newClaimWait != claimWait,
            "777xDOGE_Dividend_Tracker: Cannot update claimWait to same value"
        );
