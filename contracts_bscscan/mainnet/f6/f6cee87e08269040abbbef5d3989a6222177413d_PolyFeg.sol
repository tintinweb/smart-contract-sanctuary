...
Initial Token allocations: Initial Supply 1,000,000,000 Current Supply 500,000,000 Burned Supply 500,000,000 Liquidity Locked 390,000,000 Marketing  50,000,000‌
Polyfeg is a frictionless yield and liquidity generation smart contract which applies a 18% fee to each buy transaction; and 23% to each sell or wallet transfer. This transaction fee is split into four portions which serve separate functions:‌
Buy transactions:
10% of the total transaction value is redistributed, in MATIC/FEG, to wallets holding $PFEG tokens. The number of MATIC/FEG that each wallet receives is directly proportional to the percentage of the total $PFEG balance that is held in that wallet. This means that holders do not need to do anything other than hold PFEG tokens in their wallets to receive MATIC/FEG rewards.
3% of each transaction is added to the buyback function.
4% of the total transaction value is added to the Marketing Wallet, to provide funding for auditing, marketing, exchange listings and development team expenses.
1% of each transaction is added to the LP

https://www.poly-feg.com/
https://t.me/Polyfeg
https://twitter.com/polyfeg
*/
...
contract PolyFeg is Context, IERC20, Ownable {
    ...
    uint256 private _Giveaway = 0;
    uint256 private _previousGiveaway = _Giveaway;
    ...
    address _marketingWallet = 0x60BCF911Ce78F494EF0dA96e77528f419d47e3E4;
