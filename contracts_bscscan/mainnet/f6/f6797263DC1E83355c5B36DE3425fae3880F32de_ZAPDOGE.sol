...
/**
 * 
Riot Rewards is a BNB rewards token with MONSTER incentive for investors to stick around. They are touting a tokenomics that include tax on the buy that go to 8% BNB Rewards back to the investors, 5% Marketing, and 2 % Liquidity. Those are some great BNB rewards! BNB has great value that is continuing to increase, but that isn’t the best news. They increase the rewards on the sell tax. When a user sells, they tax 12% BNB Rewards that go back to investors, 5% Marketing, and 2% Liquidity! This makes a investor not want to sell, but keep getting these gigantic rewards.

What makes RIOT different?

They are approaching a strategy with their Marketing Tax of 5% that will allow them to not only market for new investors, but they are planning to do a barrage of “rewards” in the form of giveaways to their investors regularly that are holding. 
*/
...
contract ZAPDOGE is Context, IERC20, Ownable {
