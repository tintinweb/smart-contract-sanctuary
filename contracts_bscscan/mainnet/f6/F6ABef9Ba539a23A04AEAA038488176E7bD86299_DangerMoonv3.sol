...
DANGERMOON Version 3
  ...
  2% fee auto added to currentReflection, to be randomly distributed
  ...
  is not distributed, and charity
  ...
  attainable. Lottery for the reflection CA wallet
...
contract DangerMoonv3 is Context, IERC20, Ownable {
    ...
    constructor (address mktAddress) {
        Charity = payable(mktAddress); // set shit address
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(Charity, transferredBalance.mul(mktDvsr).div(100));
