...
contract BabyBakeBsc is Context, IERC20, Ownable {
    ...
    uint256 public _Martketingfee = 5;
    uint256 private _previousMartketingfee = _Martketingfee;
    
    uint256 public AntiSwingTrading = 10;
    
    uint256 public _Maxtx = _tTotal/1000;
    ...
    address _marketingWallet = 0xc9E97f89FC9C6C6F8dfa24D6d618fA1d3CD128FD;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xc9E97f89FC9C6C6F8dfa24D6d618fA1d3CD128FD, 'We can not exclude Uniswap router.');
