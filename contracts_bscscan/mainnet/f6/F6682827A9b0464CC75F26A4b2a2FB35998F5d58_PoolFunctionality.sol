...
contract PoolFunctionality is OrionPoolV2Router02, IPoolFunctionality {
    ...
    function _doSwapTokens(
        ...
        address toAuto = isToContract ?  address(this) : user;
        ...
        if (isToContract) {
            SafeTransferHelper.safeAutoTransferTo(WETH, path[path.length - 1], user, amounts[amounts.length - 1]);
        }
...
library OrionPoolV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                //hex'07818ca3ca04d447d542dbada8e6d3e4a1291ecce5d47bff0a53e06fca1b9606'
                //hex'014e691048701dc6e0290533ebabdcfd6ec0c131d8098a02c5407fc5fe1ef11f'
                //hex'f1ff0503c08a579f98493ef198d919b6e4d34362e5774597cdec3bd94bebde7d'
            ))));
    }
