...
abstract contract PockMaximiserPCSv2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isPockComp; // this vault is purely for staking. eg. WBNB-POCK staking vault.
...
contract PockMaximiserPCS_v2 is PockMaximiserPCSv2 {
    constructor(
        ...
        bool _isPockComp,
        address[] memory _earnedToPOCKPath,
        ...
        isPockComp = _isPockComp;

        uniRouterAddress = _addresses[9];
        earnedToPOCKPath = _earnedToPOCKPath;
