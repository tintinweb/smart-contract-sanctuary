...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #ShibaWorld

    I make this #ShibaWorld to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/ShibaWorld_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #ShibaWorld to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #ShibaWorld 10000000X? 
   ...
   it's the best part of the #ShibaWorld idea, increasing the liquidity pool automatically, 
...
contract ShibaWorld is Context, IERC20, Ownable, Pausable {
