...
contract DividendDistributor is IDividendDistributor {
    ...
    event Deposit(uint256 amountBNB, uint256 amountXRP);
...
contract SafeBabyXRP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SafeBabyXRP";
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        require(!_isBlacklisted[recipient], "To address is blacklisted!");        
