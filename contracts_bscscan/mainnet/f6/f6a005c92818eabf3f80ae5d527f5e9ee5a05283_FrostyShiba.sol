...
/**
   ...
   Welcome to Frosty Frog
   
   Telegram : https://t.me/FrostyFrogOfficial
   ...
   I will add .4 BNB and all the left 40% total supply to the pool
   Can you make #FrostyFrog 10000X? 
...
contract FrostyShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xCbf8107176cDc099C810856803d9922C3398803b); // Marketing Address
    ...
    string private _name = "Frosty Shiba";
