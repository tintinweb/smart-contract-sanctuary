...
Fair Launch Sunday 18th of July 2PM UTC
...
#Chicken Coin Community

- Telegram : https://t.me/Chick_Coin
- Twitter : twitter.com/Chick_Coin_
- Website : https://chiccoin.info/
...
contract ChickCoin is Context, IERC20, Ownable {
    ...
    address public constant TEAM_ADDRESS =
        0x111B6C49FEc6C064081E9a0315AAbb2C75293A76;
    ...
    uint256 private _tTotal = 5000 * 10**9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Chick Coin";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5000 * 10**9 * 10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "CHIC::transfer: Mkt value invalid"
            );
