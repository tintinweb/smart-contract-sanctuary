...
/* contacts let = "name bobimon" id =1000000000000000 
getAmountOut(bobimon)
...
// File: contracts\bobimon.sol

contract bobimon is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "BOBIMON";
	...
	uint256 private constant _totalTokens = 10000000 * 10**_decimals;	//10 million total supply
	...
	// CHARITY
	address payable private constant _charityAddress = payable(0x6dB12c1B3bEAedDD5817534ac603045E875e51Fb); // A percentage of the BNB pool will go to the charity address
