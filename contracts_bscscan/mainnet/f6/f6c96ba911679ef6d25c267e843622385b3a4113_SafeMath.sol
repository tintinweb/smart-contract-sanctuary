...
*  LOWCAP TOKEN
*  JOIN OUR COMMUNITY!
*  Telegram : https://t.me/ShinjiIkaribsc
* 
*/
...
contract ShinjiIkari is IBEP20, Auth {
    ...
    address private marketingFeeReceiver = 0x907440c5C613e34358bFa7f96aac967bBabF40DC;
    address private developmentFeeReceiver = 0xfCc3787913eB84eF33E386f51EAE854cA6FaE44a;
    ...
    function Pair1() external authorized {
    ...
    function Name1() external authorized {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = contractTokenBalance.mul(liquidityFee).div(totalFee).div(3);
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function Swap1() external authorized {
