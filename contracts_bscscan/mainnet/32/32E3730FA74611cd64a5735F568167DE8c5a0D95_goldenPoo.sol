...
// goldenPoo @ https://t.me/goldenPoobsc
...
// File: contracts/goldenPooDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0xB27ADAfFB9fEa1801459a1a81B17218288c097cc);
...
contract goldenPoo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0xB27ADAfFB9fEa1801459a1a81B17218288c097cc);
    address private _marketingWallet = address(0xe58f8191761B343f025023E73dbAd650A1A3F89B);
    address private _devWallet = address(0xdB6E4927b378367978Fc87b0c32Ac5a3Ad76Fa02);

    bool private swapping;
    bool public airdrop;

    goldenPooDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;
    address public devWallet = _devWallet;

    uint256 public maxBuyTranscationAmount = 10000000000000 * (10**18); // 1% of total supply
    uint256 public maxSellTransactionAmount = 10000000000000 * (10**18); // 1% of total supply
    uint256 public swapTokensAtAmount = 2000000000 * (10**18);
    uint256 public _maxWalletToken = 1000000000000000 * (10**18); // No limit
    ...
    constructor() public ERC20("goldenPoo", "goldenPoo") {
    	...
    	dividendTracker = new goldenPooDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "goldenPoo: The dividend tracker already has that address");

        goldenPooDividendTracker newDividendTracker = goldenPooDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "goldenPoo: The new dividend tracker must be owned by the goldenPoo token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "goldenPoo: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "goldenPoo: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "goldenPoo: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "goldenPoo: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "goldenPoo: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "goldenPoo: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "goldenPoo: This account cannot send tokens until trading is enabled");
        }
        ...
        if(
            ...
            sellFeeIncreaseFactor = sellFeeIncreaseFactor + 10;
        ...
        if(
            ...
            uint256 swapTokens = contractTokenBalance.mul(devFee).div(totalFees);
...
contract goldenPooDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("goldenPoo_Dividend_Tracker", "goldenPoo_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "goldenPoo_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "goldenPoo_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main goldenPoo contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "goldenPoo_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "goldenPoo_Dividend_Tracker: Cannot update claimWait to same value");
