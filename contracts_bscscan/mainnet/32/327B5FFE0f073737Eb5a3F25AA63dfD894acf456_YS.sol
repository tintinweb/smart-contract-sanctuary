...
contract YS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yay Switzerland";
    string private _symbol = "YS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEbc1EC25b1b88d9c564502F05BD1Aab9FD988cD0); // Marketing Address
    address payable public teamWalletAddress = payable(0x1FeE584aa6D04078b8873DEbDd8697C3D7503029); // Team Address
