...
contract SuperCAKE is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   SuperCAKEDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("SuperCAKE", "SuperCAKE") {
    	...
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x221D71a9026B5Acf6cC598B41E7Ac4D8C92d183a 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "SuperCAKE: The new dividend tracker must be owned by the SuperCAKE token contract");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SuperCAKE: The liquidity wallet is already this address");
    ...
    function swapTokensForCAKE(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of SuperCAKE
            path,
            recipient,
            block.timestamp
        );
...
contract SuperCAKEDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "SuperCAKE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
