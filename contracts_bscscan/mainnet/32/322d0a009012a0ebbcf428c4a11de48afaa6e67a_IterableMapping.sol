...
╚██████╔╝███████╗██║ ╚████║██║███████╗
 ╚═════╝ ╚══════╝╚═╝  ╚═══╝╚═╝╚══════╝ 
    ...
    3% marketing and development in BNB
    3% Liquidity In BNB
    3% Lottery Wallet In BNB
    10% bnb distribution   
*/
...
contract GENIETOKEN is ERC20, Ownable {
    ...
    address public devWallet = 0xd4fef6a3372E7DF4eD6c780733600d77ed24584B;
    ...
    uint256 public maxHoldAmount = 100 * 10 ** 12 * (10 ** 9);
    ...
    constructor() public ERC20("GENIETOKEN", "$GENIETOKEN") {
        ...
        */
        _mint(address(0x1857f1BFBC78D1b1C15e172F74e8523D59b440EC), 100 * 10 ** 12 * (10**9));
    }
