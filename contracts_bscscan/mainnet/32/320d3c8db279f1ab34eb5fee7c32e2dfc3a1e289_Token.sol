...
contract Context {
 ...
 contract Token is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private spreltaci;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Mini Shiba Gems";
    string private _symbol = "MiniShibaGems";
    uint256 private constant MAX = ~uint256(0);

    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWallet1 = 0x4DFD231F8cF57C32d3Aaf537Cd981889c3de0082;
    address private _feeAddrWallet2 = 0x10FCD6b95eb387148ccADE765cA9Ad18A5ad565c;
