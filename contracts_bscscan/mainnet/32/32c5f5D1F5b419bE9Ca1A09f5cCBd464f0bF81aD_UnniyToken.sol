...
// UNNIY TOKEN - Para enxergar de um jeito novo, criamos um novo jeito! 

// 09/12/2021 - The beginning of a great story!

//##UNNIY features:
//   1% fee auto add to the liquidity pool and locked for long years;
//   2% fee auto distribute to all holders;
//   2% fee intended to save and help people around the world;
...
contract UnniyToken is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee,uint256 _lpFee,uint256 _DexFee,address routerAddress,address feeaddress,address tokenOwner,address service) public {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
