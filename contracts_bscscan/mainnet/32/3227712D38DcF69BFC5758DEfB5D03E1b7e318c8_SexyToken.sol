...
contract SexyToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5A4A464c40c2D35334E253Cd99AD4E78BF4a69A3); // Marketing Address
    ...
    string private _name = "SEXY TOKEN";
    string private _symbol = "SEXY";
