 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/CyborgFloki
 * 
 * 
 * Cyborg Floki token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract CyborgFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cyborg Floki";
    string constant _symbol = "CGF";
