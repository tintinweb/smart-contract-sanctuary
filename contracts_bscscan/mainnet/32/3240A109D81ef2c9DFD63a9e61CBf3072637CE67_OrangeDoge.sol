...
contract OrangeDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Orange Doge";
    string constant _symbol = "OD";
   ...
   function setSwapAndLiquifyEnabled(bool _false) public onlyOwner {
