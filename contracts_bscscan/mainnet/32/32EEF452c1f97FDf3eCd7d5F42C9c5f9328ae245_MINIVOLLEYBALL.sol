...
contract MINIVOLLEYBALL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA87E29d39839F5cDcCA14e0798d4C7ca48800818); // Marketing Address
    ...
    string private _name = "MiniVolleyball";
    string private _symbol = "MINIVOLLEYBALL";
