...
ICEBERG Protocol is the first Smart Locker which holds auto-vested tokens for future burns.
🧊 TOKENOMICS:
...
abstract contract Auth {
    ...
    /**
     * Transfer ownership to new address. Caller must be owner. Leaves old owner unauthorized
     */
...
contract ICEBERG is IBEP20, Auth {
    ...
    string constant _name = "ICEBERG";
    string constant _symbol = "IceB";
    ...
    address public marketingFeeReceiver = 0x60563654a78f08032E54aa3369dC20799a5DC594;
    address public buybackFeeReceiver = 0x60563654a78f08032E54aa3369dC20799a5DC594;
