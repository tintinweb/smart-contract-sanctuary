...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xa0e52660e62eFA0F72A4736076b292c7630B01aC;
        _token = msg.sender;
    }
...
contract McShib2k22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "McShib2k22";
    string constant _symbol = "McShib2k22";
    ...
    event AntiSniper(address guest, uint256 rentPaid);
    ...
    uint256 public  sellLimit = rSupply.div(100).mul(3);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x19780dfF70Fc9699e9BCa3E9864472F130EB4a17;
        devFeeReceiver = 0x6242C215fdA3491F400ae9EdcF91B41120d8CFDb;
        devFeeReceiver2 = 0x6A5336694436C7E951c610daaBfb9bC92daAc16c;
    ...
    // plz ser, dont snipe with a bot
        if(SniperRektMode){
            ...
            if(tx.gasprice > maxRoomRent && sender == pair){
                ...
                emit AntiSniper(recipient, tx.gasprice);
            }
        }
    ...
    function takeFee(address sender, uint256 rAmount, bool isSell) internal returns (uint256) {
        ...
        if(isSell){
            require(rAmount<=sellLimit,"Dump protection");
    ...
    function setSellLimit_base1000(uint256 sellLimit_base1000) external onlyOwner() {
        sellLimit = rSupply.div(1000).mul(sellLimit_base1000);
    }
