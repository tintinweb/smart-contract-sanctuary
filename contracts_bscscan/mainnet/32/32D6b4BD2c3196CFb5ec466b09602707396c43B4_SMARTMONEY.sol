...
contract SMARTMONEY is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xF8Cbe89c156979A406b3DEf10D5cE2122884EF1a); // Marketing Address
    address payable public airdropAddress = payable(0x2cE720144C9337b56024618d75913F7efFF3C296); // Airdrop Address
    ...
    string private _name = "Smart Money";
