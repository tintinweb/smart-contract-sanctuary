    ...
    OwnableUpgradeable
{
    ...
    function initialize(address rewardsWallet_) public initializer {
        __ERC20Capped_init(100 * 1e6 * 1e18);
        __Ownable_init();
        __ERC20_init("BURG2 Token", "BURG2");
        ...
        // TODO:  REPASAR BILLETERAS

        // AntiWhale 2021-01-01 to 2100-01-01
        setAntiWhale(1641028005, 4102477605, 0 * 1e3 * 1e18); // 20
    ...
    function setPermissions() public onlyOwner {
        ...
        // TODO:  REVISAR SI SE NECESITAN MÁS BILLETERAS
    }
    ...
    function changeWhitelistAddresses(address _address, bool _allowed)
        public
        onlyOwner
    {
