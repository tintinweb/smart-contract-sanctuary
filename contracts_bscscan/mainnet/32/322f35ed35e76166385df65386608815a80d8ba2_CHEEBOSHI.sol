...
https://t.me/CheeBoshi



Welcome to CheeBoshi, presented by @ApeLoungeToken
(Daily Degen Play)
...
/* Token contract */
contract CHEEBOSHI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Cheeboshi";
    string constant _symbol = "Cheeboshi";
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 10000; // 0.1% of supply
