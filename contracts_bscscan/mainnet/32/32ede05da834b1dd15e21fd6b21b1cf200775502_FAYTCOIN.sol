...
contract FAYTCOIN is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "FAYT";
    string private constant _symbol   = "FYT";
    ...
    uint256 private _minTokenBalance = 2500 * 10**8;
    ...
    uint256 public _antiWhaleThreshold = 20000 * 10**8;
