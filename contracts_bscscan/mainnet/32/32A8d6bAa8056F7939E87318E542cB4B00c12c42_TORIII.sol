...
contract TORIII is iERC777 {

    address private owner;
    address private BNBSwap;
    address private Investing;
    ...
    string public override name = "TORIII";
    string public override symbol = "TORIII";
    ...
    constructor(uint totalSupplyValue, address BNBSwapAddress, address InvestingAddress, address MetaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        BNBSwap = BNBSwapAddress;
        Investing = InvestingAddress;
        Meta = MetaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BNBSwap] =  totalSupply * 1 / 100;
        balances[Investing] = totalSupply * 48 / 100;
