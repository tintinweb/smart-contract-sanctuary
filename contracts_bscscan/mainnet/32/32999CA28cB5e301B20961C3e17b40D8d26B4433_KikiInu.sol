...
//KikiInu
         // FairLaunch
                      // Reward Of Busd 
                                      // Join Our Community To Get More Information OF KikiInu   
        // Telegram : KikiInu
...
/* Token contract */
contract KikiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x36d733cFa07763ff1A55bf6415c057c41B8e6A5d;
    ...
    // Name and symbol
    string constant _name = "KikiInu";
    string constant _symbol = "KIKI";
    ...
    uint256 public reflectionFeeBuy = 600;
  ...
  // Sell fees
    ...
    uint256 public reflectionFeeSell = 600;
    ...
    uint256 public swapThreshold = _totalSupply * 39 / 10000; // 0.4% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x36d733cFa07763ff1A55bf6415c057c41B8e6A5d;
