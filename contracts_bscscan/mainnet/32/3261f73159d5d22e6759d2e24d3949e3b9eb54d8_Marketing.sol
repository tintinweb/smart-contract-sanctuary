...
contract Marketing {
    ...
    constructor(address founder1_, address founder2_, address founder3_, IERC20 MONOPOLYCOIN_) public {
            founder1 = founder1_;
            founder2 = founder2_;
            founder3 = founder3_;
            MONOPOLYCOIN = MONOPOLYCOIN_;
	...
	function transferTokens(uint256 _tokens) external returns (bool) {
		...
		MONOPOLYCOIN.transfer(msg.sender, _tokens);
		return true;
	}
}