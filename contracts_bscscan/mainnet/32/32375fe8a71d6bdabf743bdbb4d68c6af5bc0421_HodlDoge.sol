...
HodlDoge, earn $DOGE Just For Holding! 

Here at HodlDoge we want to develop an Application which allows holders of HodlDoge ($HDGE) to view there rewards for all the tokens there invested in. This means you can view not only your $DOGE rewards from us but also other projects. These statistics will be in real time and shown by just pasting a contract address into our dAPP. 📱 
...
- 🔥 25% Burned Tokens
- 🥞 65% Of Tokens For Pcs Liquidity
- 🗣 7% Marketing Wallet 
^  (Rewards only used for marketing non of tokens will be sold)
- 🔒 3% Legal Funds Locked

Tax on transaction broken down:
...
When does HodlDoge Launch? 

~ HodlDoge will be FairLaunching on PancakeSwap, 23/08/2021 @7pm UTC. 

🔒 Liquidity locked via DxSale (Links will be provided!)
...
(https://hodldoge.app/)
Twitter 
(https://twitter.com/HodlDogeBSC) 
HodlDoge Song!
(https://www.youtube.com/watch?v=f3e3EEWvo4E&t)
...
contract HodlDoge is Context, IERC20, Ownable {
    ...
    address _marketingWallet = 0x875B8CefC3b643D48bBda599a708e862DA3D257f;
