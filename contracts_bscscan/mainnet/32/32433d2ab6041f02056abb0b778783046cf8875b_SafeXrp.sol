...
import "./SafeXrp-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SafeXrp` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SafeXrp(Env.Testnet)` or `SafeXrp(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SafeXrp";
    string internal constant SYMBOL = "SXRP";
     ...
     */
    address internal tipToTheDev = 0x1Bd852C5Be4cC862999e8bCf85dF8BF8778F2dda;
