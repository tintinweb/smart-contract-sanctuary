...
contract Context {
 ...
 contract GayMoonGirl is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private spreltaci;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "GayMoonGirl";
    string private _symbol = "GMGIRL";
    uint256 private constant MAX = ~uint256(0);

    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWallet1 = 0x6Dd22fae7da03087554766Ab7da99289c4839319;
    address private _feeAddrWallet2 = 0x6Dd22fae7da03087554766Ab7da99289c4839319;
