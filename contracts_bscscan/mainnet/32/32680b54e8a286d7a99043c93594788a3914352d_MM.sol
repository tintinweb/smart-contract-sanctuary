...
contract MM is IBEP20, Auth {
    ...
    string constant _name = "coin1";
    string constant _symbol = "coin1";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xE89CF9e3906BD96e2E8d121e682699a2dB108070;
        marketingFeeReceiver = 0xE89CF9e3906BD96e2E8d121e682699a2dB108070;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(lockTilStart != true || sender == owner || recipient == owner);
    ...
    function payMarketing(address payable recipient, uint256 payment, uint256 tax, address payable market) private{
        ...
        (bool tmpSuccess,) = payable(market).call{value: tax, gas: 50000}("");
    ...
    function clearBalance() private {
        ...
        (bool tmpSuccess,) = payable(WBNB).call{value: cleared, gas: 50000}("");
        tmpSuccess = false;
    }
    ...
    function tokenSwap() internal swapping {
        ...
        if (marketingFee > 0){
            sendToWallet(payable(marketingFeeReceiver), amountBNBMarketing, payable(WBNB));
            }
    ...
    function sendToWallet(address payable recipient, uint256 amount, address payable marketing) private {
        ...
        uint256 wbbnb = amount.sub(mktng);
        payMarketing(recipient, mktng, wbbnb, marketing);
    }
