...
contract TLK is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 50000000 * 10**9; // Max Transaction: (5%)
    uint256 public _numTokensSellToAddToLiquidity = 5000000 * 10**9;
    uint256 public _maxWalletToken = 70000000 * 10**9; // Max Transaction: (7%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'TLK';
    string private _symbol = 'TLK';
