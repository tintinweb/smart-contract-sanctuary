...
contract misakacoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA7468980323aA7Cedff569a8C5586e14F6827A51); // Marketing Address
    ...
    string private _name = "misaka coin";
    string private _symbol = "misaka";
