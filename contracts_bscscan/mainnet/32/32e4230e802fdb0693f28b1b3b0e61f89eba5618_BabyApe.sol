...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 RWRD = IBEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95); 
...
contract BabyApe is IBEP20, Auth {
    using SafeMath for uint256;
  
 
     address RWRD = 0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95;  
     address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyApe";
    string constant _symbol = "BABYAPE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);  
    uint256 public _maxTxAmount = _totalSupply / 200;  // 0.5%         
    uint256 public _maxWallet = _totalSupply / 40; // 2.5%
