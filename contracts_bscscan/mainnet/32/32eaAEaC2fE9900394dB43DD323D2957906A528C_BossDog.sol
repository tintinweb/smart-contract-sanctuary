...
contract  BossDog is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x261C363b0CC4334f49E38c0C92b46c8cB6Af1A3B); // Marketing Address
    address payable public teamWalletAddress = payable(0xc28d9E897479f75c98f5b43cEb8C94BE3F744d53); // Team Address
