...
contract SantasLittleHelper is IBEP20, Auth {
    ...
    uint256 public marketingFee    = 65;
    uint256 public teamFee         = 10;
    uint256 public charityFee      = 15;
    uint256 public burnFee         = 0;
    uint256 public totalFee        = charityFee + marketingFee + liquidityFee + teamFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x87f6B429E08cC8f58c08eC9918Fea6f989c70D61;
        teamFeeReceiver = 0x14A8Af5760Bb0876E3fE2079bBcbb62e2ae249B4;
        charityFeeReceiver = 0xd558973eF499d186AFD065860F8fCd08528A3Cc4;
    ...
    function setFees(uint256 _liquidityFee, uint256 _charityFee, uint256 _marketingFee, uint256 _teamFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        charityFee = _charityFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_charityFee).add(_marketingFee).add(_teamFee).add(_burnFee);
