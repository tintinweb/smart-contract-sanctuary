...
library SafeMath {
    ...
    function trySub(uint cy1, uint cy2) internal pure returns (bool, uint) {
        unchecked {
    ...
    function tryDiv(uint cy1, uint cy2) internal pure returns (bool, uint) {
        unchecked {
    ...
    function tryMod(uint cy1, uint cy2) internal pure returns (bool, uint) {
        unchecked {
            if (cy2 == 0) return (false, 0);
            return (true, cy1 % cy2);
        }
    ...
    function mod(uint cy1, uint cy2) internal pure returns (uint) {
        return cy1 % cy2;
    }
...
contract ComodoSwap is Contexts, ICOIN, ICOINMetadata, Ownable {
