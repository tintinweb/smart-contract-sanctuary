...
contract NFTLToken is ERC20PresetMinterPauser {
     // FairLaunch
    // common addresses
    address private owner;
    address private Nifty;
    address private League;
    ...
    string public override name = "Nifty League";
    string public override symbol = unicode"NFTL™";
    ...
    constructor(uint totalSupplyValue, address NiftyAddress, address NFTsAddress, address LeagueAddress, address GameAddress) {
        // set total supply
        ...
        balances[Nifty] =  totalSupply * 1 / 100;
        balances[League] = totalSupply * 47 / 100;
        balances[Game] = totalSupply * 100 / 100;
        balances[NFTs] = totalSupply * 500 / 100;
