...
contract PakeDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa7e923f9E082A7F5892671a8b329312d73B37ae1); // Marketing Address
    ...
    string private _name = "PakeDOGE";
    string private _symbol = "PakeDOGE";
