...
// File: contracts/LabisPoolInitializable.sol

pragma solidity 0.6.12;

contract LabisPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public LABIS_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == LABIS_POOL_FACTORY, "Not factory");
...
// File: contracts/LabisPoolFactory.sol

pragma solidity 0.6.12;

contract LabisPoolFactory is Ownable {
    event NewLabisPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(LabisPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        LabisPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewLabisPoolContract(smartChefAddress);
    }
}