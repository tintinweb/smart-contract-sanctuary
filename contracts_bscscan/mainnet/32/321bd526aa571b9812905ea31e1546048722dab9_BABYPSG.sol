...
contract BABYPSG is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABYPSG";
    string constant _symbol = "BABYPSG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 35000000000; // 3.5%
    ...
    uint256 public swapThreshold = _totalSupply / 7000; 
    bool inSwap;
