...
* ||//$\                 ~|UNITED STATES OF ETHEREUM|~              /$\\||
* ||(100)===================  ONE HUNDRED NETHER  =================(100)||
* ||\\$//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\\$//||
* ||====================================================================||                                                                                                    
* 
*  Little Nether $NETH
*  8% Buy Back | 2% Liquidity | 4% ETH Earn
*  3% Max Txn | 3% Max Wallet
*  
*/
...
contract LittleNether is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Little Nether";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xdF02b5c0C6d9E04d955095e2EB09a13387892891;
