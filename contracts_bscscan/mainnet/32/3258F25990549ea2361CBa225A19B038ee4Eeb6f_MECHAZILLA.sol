...
/**
       ...
       Welcome to  MECHAZILLA
   
   This is a community token. If you want to create a telegram I suggest to name it to @MECHAZILLABSC
   ...
   I will renounce the ownership to burn addresses to transfer #MECHAZILLA to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #MECHAZILLA 10000X? 
   ...
   it's the best part of the #MECHAZILLA idea, increasing the liquidity pool automatically, 
