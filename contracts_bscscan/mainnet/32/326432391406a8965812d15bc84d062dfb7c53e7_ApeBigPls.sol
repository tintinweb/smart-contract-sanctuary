...
contract ApeBigPls is Context, IERC20, Ownable {
    ...
    string private _name = 'ApeBigPls';
    string private _symbol = 'ApeBigPls';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 14; // 4% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 18; // 9% of transactions will be kept for liquidity
