...
PapaFranku
Rewards PapaFranku for Holding - 4%
 4% Marketing | 3% LP
 
 Telegram : https://t.me/PapaFranku
 Website : TBA
...
/**
 OUR MAIN FEATURE :
 - Rewards 4% Each Hours
 - Auto Buy Back
 - Anti Whale Feature Max 5% Holding
 - Anti Sniper Bot
 - Anti Dump Feature That Is Anti Sells At Early
 - Max Tx Limit Anti Flash Pump & Dump
 */
 ...
 contract PapaFranku is IBEP20, Auth {
     
     using SafeMath for uint256;
 
     string constant _name = "PapaFranku"; // PapaFranku NAME
     string constant _symbol = "PapaFranku"; // PapaFranku SYMBOL
     uint8 constant _decimals = 9; // DECIMALS
 
     address DEAD = 0x000000000000000000000000000000000000dEaD;
     address ZERO = 0x0000000000000000000000000000000000000000;
     address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
     address RewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // REWARDS
 
     uint256 _totalSupply = 10000000000 * 10**5 * (10 ** _decimals);  // SUPPLY
     uint256 public _maxTxAmount = _totalSupply * 3 / 200; // MAX TX 1.5%
     uint256 public _walletMax = _totalSupply * 5 / 100;  //MAX HOLDING 5%
     ...
     uint256 public rewardsFee = 4; // REWARDS
     uint256 public extraFeeOnSell = 40; // ANTI BOT RUNNING
     ...
     constructor () Auth(msg.sender) {
         ...
         // NICE!
         autoLiquidityReceiver = 0x7F30DAB702b31aC37a22e6FE192a6211B0033d13; // DEV ADDRESS
         marketingWallet = 0xBBaa98fC2eeC27A9b2314f6aC37379c164C7c19E; 
         anothermarketingWallet = 0x72a22aA08B82d1187693b786CD2cfCf44e799A0d;
