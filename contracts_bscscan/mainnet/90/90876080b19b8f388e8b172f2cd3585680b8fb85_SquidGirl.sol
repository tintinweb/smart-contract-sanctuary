...
SquidGirl is a brand new utility token on BSC network.

$SQUIDGIRL is built on the newest and the safest pragma solidity version.

-Initial liquidity is 1 BNB.
-Our total supply is 69,000,000,000 tokens. 
-We have 0% for both - buy and sell tax, which turn your gains into pure profit.
-$SQUIDGIRL's liquidity is locked for 1 year on Mudra LP locker. It makes the token unruggable for at least a year.
...
contract SquidGirl is Context, IERC20, IERC20Metadata, Ownable {   
