...
contract BabyCircle is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "BABY CIRCLE";
    string public _symbol= "BCIRCLE";
     bool balances1 = true;

    address payable public charityAddress = payable(0x15544c1f87F6A8F878675148AFae273B41fCBB75); // Marketing Address
    uint256 public charityPercent = 1; 
    
    address public immutable burnAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public burnPercent = 11; 
