...
import "./MoonX-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MoonX` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MoonX(Env.Testnet)` or `MoonX(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MoonX";
    string internal constant SYMBOL = "MoonX";
     ...
     */
    address internal tipToTheDev =0xfceD6FdE9B3D4e738648F5cE1443446ce25175A1;
