...
import "./Lake721Tradable.sol";

contract Lake721Factory is Ownable {
    ...
    /// @notice Lake auction contract address;
    ...
    */
     ...
     */
    function updateTreasury(address payable _treasury)
        external
        onlyOwner
    {
        treasury = _treasury;
    ...
    /// @notice Method for deploy new Lake721Tradable contract
        ...
        returns (address)
    {
        ...
        Lake721Tradable nft = new Lake721Tradable(
            _name,
            _symbol,
            lake,
            auction,
