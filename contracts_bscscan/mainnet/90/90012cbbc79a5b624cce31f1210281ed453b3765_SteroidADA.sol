...
Make official telegram group, for example https://t.me/SteroidADA
Can you make x100 by promoting? I believe you can!

SteroidADA Token Features: 
4% fee burning SADA forever, reducing the total amount and icreasing the price with each transaction.
80% burn to the black hole and cant be restored to any wallet

I will lock LP tokens for a week, you can check on Mudra
I will renounce the ownership to Dead addresses to transferthe token to the community, make sure it's 100% safe.
Check it on any rug checker if you have any doubts
Initial LP - 1 BNB
...
contract SteroidADA is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("SteroidADA", "SADA") {
