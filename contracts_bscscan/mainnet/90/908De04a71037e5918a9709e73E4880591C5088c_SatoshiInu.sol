...
╚══════╝╚═╝  ╚═╝   ╚═╝    ╚═════╝ ╚══════╝╚═╝  ╚═╝╚═╝    ╚═╝╚═╝  ╚═══╝ ╚═════╝ 
    ...
    Satoshi Inu ($SATSINU) - A new decentralized Meme token that rewards holders in Bitcoin, with a whole ecosystem in development
    13% Total Transaction Tax
    Telegram: https://t.me/Satoshi_inu
...
contract SatoshiInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x42B69F03700Ce39d2BF371DfEbB42298493B2103); // Marketing Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public immutable BTCBAddress = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    ...
    string private _symbol = "SATSINU";
    ...
    uint256 private _buylpPajek = 12;
    
    uint256 private _botStartblock = 0;
    uint256 private _botEndblock = 13;
