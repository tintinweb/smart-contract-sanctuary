...
🔒 Lp Will be Locked for 7 days. Unlock time will be delayed to 1 mounth at 50k market cap.
...
Selling fee is x2 to prevent big dumps.
...
//SPDX-License-Identifier: MIT
    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        event Deposit(uint256 amountBNB, uint256 amountSHIBA);
    ...
    contract BabyShiba is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "Baby Shiba";
        ...
        function setFees(
            ...
            require(totalFee.add(liquidityFee) < feeDenominator/2);
