...
Official Telegram group : THE GROUP IS PRIVATE FOR NOW.
...
import "./DOXXEDDividendTracker.sol";

contract DOXXED is ERC20, Ownable {
    ...
    DOXXEDDividendTracker public dividendTracker;
    ...
    //Anti-Whale System
    uint256 public maxWalletTokens =  5000000 * (10**18);
    ...
    constructor() public ERC20("miniBabyDOXXED", "DOXXED") {

    	dividendTracker = new DOXXEDDividendTracker();

        _marketingWalletAddress = 0x062EE5D9b246f8Aa0585EdAcF0aa6084858a4414;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "DOXXED: The dividend tracker already has that address");

        DOXXEDDividendTracker newDividendTracker = DOXXEDDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "DOXXED: The new dividend tracker must be owned by the DOXXED token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DOXXED: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "DOXXED: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DOXXED: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DOXXED: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "DOXXED: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "DOXXED: Cannot update gasForProcessing to same value");
