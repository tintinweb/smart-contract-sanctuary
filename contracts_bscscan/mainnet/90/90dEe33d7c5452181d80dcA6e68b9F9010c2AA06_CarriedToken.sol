...
contract CarriedToken is OwnableContext {
    ...
    function initialize(address carrierAddress) public onlyOwner returns (bool) {
        require(carrierAddress != address(0), "Set carrier: carrier cannot be set to the 0 address");
        require(_carrier == address(0), "Set carrier: carrier already set");

        _carrier = carrierAddress;
