...
contract LotteryNFT is ERC721, Ownable {
    ...
    constructor() public ERC721("Fenix Lottery Ticket", "FLT") {}
...
contract Lottery is Ownable {
    ...
    function getRewardView(uint256 _tokenId) public view returns(uint256) {
        ...
        if (matchingNumber > 1) {
            ...
            reward = amount.mul(1e12).div(getMatchingRewardAmount(_issueIndex, matchingNumber)).mul(poolAmount); // CTK-FAM-7 scaling is done before
        }
    ...
    function seedLottery(uint256 _amount) external onlyOwner {
        ...
        olymp.safeTransferFrom(address(msg.sender), address(this), _amount);
    }
