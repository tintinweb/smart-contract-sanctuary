...
// CHANGE
contract DeadGirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DeadGirl";
    ...
    uint256 reflectionFee = 400; // 10%
    uint256 devFee = 500; // 4%
    uint256 totalFee = 1100; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xb5E94ADCA518b263394DA6a1C8F38dB6e039A7D3);
