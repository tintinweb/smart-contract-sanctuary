...
contract pumpone is Context, IERC20 {
    ...
    uint256 private startingSupply = 1000_000_000_000_000;

    string private _name = "pumpone";
    string private _symbol = "pumpone";
    ...
    address payable private _marketingWallet = payable(0xdEdF5156D7C53688f8524E0E78ae924D1B74d3d0);
    address payable private _ecosystemWallet = payable(0xdEdF5156D7C53688f8524E0E78ae924D1B74d3d0);
