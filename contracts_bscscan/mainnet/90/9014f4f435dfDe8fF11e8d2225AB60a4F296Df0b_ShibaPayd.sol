...
*
*  @
* Website:  shibapaid.digital   
* Telegram: t.me/ShibaPaidToken
* Twitter:  twitter.com/PaidShiba
*/
...
contract ShibaPayd is Context, IBEP20, Ownable {
    ...
    string public constant name     = "ShibaPaid";
    string public constant symbol   = "SHIBPAID";
