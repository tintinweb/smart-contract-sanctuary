...
contract VictoriaSecret is BEP20Interface, Math {
    string public tokenName = "Victoria Secret";
    string public tokenSymbol = "VS";
    uint public _tokenSupply = 1*10**10* 10**9;
