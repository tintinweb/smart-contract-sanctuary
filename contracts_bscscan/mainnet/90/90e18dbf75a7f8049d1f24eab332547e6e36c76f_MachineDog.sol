...
contract MachineDog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x215ba03DfE7daB250bc948fC563fE823d937c0CF); // Marketing Address
    ...
    string private _name = "MachineDog";
    string private _symbol = "MachineDog";
