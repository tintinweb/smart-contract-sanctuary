...
/**
Tokenomics
Token Name 		: LittleBabyPanda
Ticker 			: LittleBabyPanda
...
3.	LP Will be Lock for 1 Year
4.	No Dev Token
5.	Anti Whale Feature

Initial Liquidity will be start from 0.5 BNB
https://t.me/LittleBabyPandaBSC
*/
...
contract LittleBabyPanda is Context, IERC20, Ownable {
    ...
    string private _name = "LittleBabyPanda";
    string private _symbol = "LITTLEBABYPANDA";
