...
/**
 * 
Cryptolisting.com($CLISTING) is a portal for cryptocurrency with ERC20 utility token for crypto enthusiasts and investors who really want to get into crypto/defi space. 
Cryptolisting.com website/products which offers a wide range of functionality to measure and validate the cryptocurrency. In recent days, investing into crypto currency has become very challenging due to massive adoption and lack of tools to measure the genuineness of the tokens. Due to the huge number of fake/scam tokens, people are really hesitant/scared to invest into crypto. 
Cryptolisting.com provides various functionality to measure and validate the token before investing. Just Buy and Hold and receive the reward as ethereum. 
...
contract CLISTING is Context, IERC20, Ownable {
