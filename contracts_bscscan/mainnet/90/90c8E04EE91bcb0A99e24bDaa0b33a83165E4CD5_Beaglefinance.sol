...
/*
Welcome to BEAGLEFINANCE

While we see the future of the blockchain in projects with mass adoption of the blockchain technology, particulary in the metaverse, we cannot afford to fold our hands without tapping into this space and helping it to grow in many little ways we can to make a difference. 

Tokenomics

10% on buy and sell for marketing and liquidity 
Total supply=100000000000000
Max Tx =1000000000000
Max wallet =2000000000000

 Telegram : https://t.me/Beaglefinancebcs
 Website: http://Beaglefinance.net
*/
...
contract Beaglefinance is Context, IERC20, Ownable {
    ...
    string private _name = "BEAGLEFINANCE";
    ...
    constructor ()  {
        ...
        IUniswapV2Router02 _univ2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // bsc pcs v2
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (!inSwap && swapEnabled && overMinTokenBalance && sender != V2Pair) {
