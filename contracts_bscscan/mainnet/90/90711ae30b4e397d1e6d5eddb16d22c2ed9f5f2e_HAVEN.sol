...
contract DividendSafeHAVEN is IDividendSafeHAVEN {
    ...
    uint256 public minPeriod = 1440 minutes; // min 24 hours delay
...
contract HAVEN is IBEP20, HAVENAuth {
    ...
    constructor (address pinkAntiBot_) HAVENAuth(msg.sender) {
    ...
    function setEnableAntiBot(bool _enable) external authorizedFor(Permission.AdjustContractVariables) {
