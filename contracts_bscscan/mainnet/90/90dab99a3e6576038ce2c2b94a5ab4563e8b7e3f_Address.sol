...
/*
   ...
   Testing if everything will go fine
   
   #BYOB features:
   5% fee auto add to the liquidity pool
   5% fee auto distribute to all holders
   I created a wallet for donations to charity so it will gain the same as all holders
...
contract BYOB is Context, IERC20, Ownable {
    ...
    string private _name = "Be Your Own Boss";
    string private _symbol = "BYOB";
