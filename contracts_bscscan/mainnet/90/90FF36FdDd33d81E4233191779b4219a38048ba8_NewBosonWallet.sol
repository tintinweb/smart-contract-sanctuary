    ...
    function Marketingwallet (address payable _marketingwallet) onlyAdmin public
    {
        marketingwallet= _marketingwallet;
             ...
             address public admin;
              ...
              uint public timestampC;
              function withdrawmarketing() nonReentrant public onlyAdmin returns(bool){
                  require (block.timestamp>timestampC.add(2592000));
                  uint value = address(this).balance;
                  uint marketingfund = value.mul(2).div(100);
                 (bool success, ) = address(marketingwallet).call{ value: marketingfund }("");
            require(success, " Error: Cannot send");    
                  timestampC=block.timestamp;
                  return true;
              }
