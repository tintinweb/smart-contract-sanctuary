...
Ladies, Gentlemen and Pajeet, Little Lynx has arrived

7% to hodlers on every transaction
3% burned on every transaction
maxTxAmount = 2000000000000000000000

LP will be burned a few minutes after launch, and contract will be renounced after.
...
contract LittleLynx is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "LittleLynx";
    string private _symbol = "LLYNX";
