...
contract ShibaBullish is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("ShibaBullish", "ShibaBullish", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x9eaBf88aaBe369A02f655bECD9Abd0B7aF070e4b;
        marketingFeeReceiver = 0x70850E3500fa4313DD4D6f6cb3783B1Ae0a4517f;
        ecosystemFeeReceiver = 0x2Ba6dA3964B2D0D95f72f101F8eeBEc9fb6c72c5;
        buyBackFeeReceiver = 0x03e701277CA80067CbFa0cDD4dcf347DC0950f45;
