...
contract Ownable is Context {
    address private _owner = 0x583b6C951a10131d3f9f35F4E6c6dc090F9E52Ed;
...
contract RobotDogeCoin is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x8e62EeF2C4c6361E768f27e95E400A5eda5085Ad); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "AE86 coin"; // token name
    string private _symbol = "AE86"; // token symbol
    ...
    uint256 public _tokenFee = 40; // marketing fee 4% to be sent as tokens
    uint256 private _previousTokenFee = _tokenFee; // marketing tokens fee
    
    uint256 public _buyBackFee = 90; // buyback fee 10%
	...
	uint256 private _transactionLockTime = 300; //Cool down time between each transaction per address
