...
/**
�🪶FAIRLAUNCH🪶
Pheonix Will make you RICH
 The Pheonix ability to make this pump fast 🪶

It is a reflection meme token. Meme like doge and more with reflection features. This will moon the price of the token. 

The tokenmonics

Transaction fee - 8%
50% burn suply🔥
4% back to diamond hands 💎
4% to LP 🔐

Starting LP is going to be 5 BNB
Start LP will be burned. 
...
contract PHEONIX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 200 * 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 private _tLiquidTotal;

    string private _name = "Pheonix";
    string private _symbol = "PHEONIX";
    uint8 private _decimals = 18;
   
    //We built this token on Binance Smart Chain. Tax is Alloctaed on every Transfer:
    ...
    uint256 public _maxTxAmount = 200 * 10**3 * 10**18;
    ...
    private 
    liquidAddress 
    = 0xc25614e16822e5b1da7fb97A849eC7da968f5BEc; 
