...
Black Camel is built upon the fundamentals of Buyback and increasing the investor's value
...
contract Blackcamel is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0580e3F3e54609Aa99A3A011Fd38d2206EB8eB47); // Marketing Address
    ...
    string private _name = "Blackcamel";
    string private _symbol = "BCAM";
    ...
    uint256 private buyBackUpperLimit = 300 * 10**6 * 10**9;
