...
Welcome to BabySpace
   This is a community token. If you want to create a telegram I suggest to name it to @BabySpace
   ...
   I will renounce the ownership to burn addresses to transfer #BabySpace to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left All (100%) total supply to the pool
   Can you make #BabySpace 10000X? 
   ...
   it's the best part of the #BabySpace idea, increasing the liquidity pool automatically, 
...
contract BabySpace is Context, IERC20, Ownable {
    ...
    string private   _name = "BabySpace";
    string private _symbol = "BabySpace";
