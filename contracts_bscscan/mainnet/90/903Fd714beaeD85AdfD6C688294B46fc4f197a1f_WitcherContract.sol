...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public dividendsPerShareAccuracyFactor = 10 ** 33;
...
contract WitcherContract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Witcher Coin";
    string constant _symbol = "witchercoin";
