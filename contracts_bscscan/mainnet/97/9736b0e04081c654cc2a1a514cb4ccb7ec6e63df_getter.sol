...
contract getter{
    ...
    constructor() public {
        farm = DoubleFarm(address(0x60137D468A4c4aC2eC1BD6C7D7262286db0aB0D7));
    }
    ...
    function getStartBlock(uint256 _pid) view public returns(uint256){
        (,,,,,,,,,,,,,uint256 start) = farm.poolInfo(_pid);
        return start;
    }
    
    function getLastBlock(uint256 _pid) view public returns(uint256){
        (,,,,,,,,,,,,uint256 last,) = farm.poolInfo(_pid);
        return last;
    }
}