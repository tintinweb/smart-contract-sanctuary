...
/**
 Welcome to BabyHELP
   ...
   I will renounce the ownership to burn addresses to transfer #BabyHELP to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make BabyHELP 100X? 
   ...
   it's the best part of the #BabyHELP idea, increasing the liquidity pool automatically, 
