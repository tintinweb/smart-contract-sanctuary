...
// File: contracts/BabyRoboDoge.sol
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2f657932E65905eA09c7aacfe898bf79e207c1C0); //Robo Doge
...
contract BabyRoboDoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Robo Doge";
    string constant _symbol = "BabyRoboDoge";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2f657932E65905eA09c7aacfe898bf79e207c1C0;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xA5EE0A6B1d7f8Fe19bcf6650b3489B314efDAd43;  // marketingwallet
