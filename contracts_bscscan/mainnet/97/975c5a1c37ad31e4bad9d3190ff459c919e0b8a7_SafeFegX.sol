...
contract SafeFegX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SafeFegX";
    string private constant _symbol = "$SafeFegX";
    ...
    address payable constant private _marketingAddress = payable(0x731f399Bd06DB1e3a16f33Ba0D2825eCA4658aF1);
    address payable constant private _buybackAddress = payable(0x731f399Bd06DB1e3a16f33Ba0D2825eCA4658aF1);
    address payable constant private _projectMaintainence = payable(0x731f399Bd06DB1e3a16f33Ba0D2825eCA4658aF1);
    ...
    address public _oraclePriceFeed = 0x731f399Bd06DB1e3a16f33Ba0D2825eCA4658aF1;//rinkeby 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
