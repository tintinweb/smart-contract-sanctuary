...
contract CakeCrewDividendTracker is IDividendDistributor {
    ...
    IBEP20 Cake = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract GodOfCheems is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    address private marketing = address(0x869C4dDA0B4a89baA0f19126D6312565220baEDe);
    address private liquidity = address(0x6A5Cf27c8472300399db4C56e65C3e3F848D7F57);
