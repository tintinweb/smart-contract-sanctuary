...
contract UAEDOGE is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "UAEDOGE";
    string private _symbol = "UAEDOGE";
    ...
    uint256 private _maxWalletSize = (_tTotal * 40) / 1000;
