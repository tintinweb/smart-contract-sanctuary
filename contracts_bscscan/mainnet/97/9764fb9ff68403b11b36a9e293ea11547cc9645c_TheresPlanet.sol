...
contract TheresPlanet   is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TheresPlanetNoob";
    string constant _symbol = "TheresPlanet";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x9b1346DAd1e00756B2775a93265a30dC5a82F5E6;
