...
/**
   ...
   # website: www.carbon-netrual.com

    I make this #BCN to hand over it to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #BCN to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #BCN 10000000X?
...
contract BCNToken is Context, IERC20, Ownable {
    ...
    string private _name = "BCN Token";
