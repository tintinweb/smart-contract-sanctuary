...
contract _TradeFinance is ERC20, ERC20Detailed, ERC20Burnable {
    constructor() ERC20Detailed('Trade Finance', 'TDF', 18) public {
...
contract TradeFinance is Ownable,_TradeFinance {
      using SafeMath for uint256;
