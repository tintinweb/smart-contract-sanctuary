...
✅ 12 % LP Fee  =>  transferred to a marketing wallet for upcoming marketing!
✅ 90% tokens burned 
✅ 3% sell taxes => Sellers will add to supply of current token holders
✅ Reddit Posts in cms upcoming!
✅A+++ Dev Team 
✅UNIQUE FEATURES
...
contract StayHard is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'StayHard';
    string  private constant _SYMBOL = 'SHT';
    ...
    constructor() {
        ...
        liquidityWallet = 0xD3E4DddEEC510727d22A154f9E48C21Ea6f76fCa;
    }
