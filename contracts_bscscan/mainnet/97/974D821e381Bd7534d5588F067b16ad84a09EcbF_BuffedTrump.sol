...
$BuffedTrump is the newest buffed token on BSC. 
Love him or hate him, $BuffedTrump is nobody to mess with.
He'll grab all these Jeets by the pussy if he needs to!
...
🔈 Telegram = https://t.me/BuffedTrump
...
// CHANGE
contract BuffedTrump is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BuffedTrump";
