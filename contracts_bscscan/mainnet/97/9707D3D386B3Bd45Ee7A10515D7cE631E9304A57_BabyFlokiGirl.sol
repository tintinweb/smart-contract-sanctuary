...
/*
    ...
    🍼👶🐾BabyFlokiGirl🐾🍼👶Fairlaunch 24.11.21 at 16UTC
    🍼👶🐾BabyFlokiGirl🐾🍼👶Fairlaunch 24.11.21 at 16UTC

    🏦🏦BabyFlokiGirl DeFi ecosystem
    An ecosystem for everything DeFi platform and applications.
    
    🖼Metaverse and collectibles
    An advance digital platform for NFT, arts and virtual world.
    
    🎰BabyFlokiGirl Liquidity
    A large liquidity provider on #BSC based on his ecological products.
    
    🎰 #BABY-Swap; The core operating mechanism of BabyFlokiGirl's dex-swap is to establish a stable and liquid supply pool,
    and conduct "transactions" in a fund pool exchange model.
    BABY-SWAP is an automatic liquidity protocol supported by a constant product formula and implemented in a smart contract system on the blockchain.
    Not only supports Token exchange and LP, but also provides NFT SWAP
    
    🎮 #NFT+Metaverse
    🖼 Collectible #NFTs available in the #Game ; Buy and trade cat NFTs in the BabyFlokiGirl #Marketplace. 
    BabyFlokiGirl establishes a very strong community gameplay, bringing reality into NFT, users can complete various activities in BabyFlokiGirl's Metaverse
    
    🏦🏦 #Stake and #Farm; BabyFlokiGirl holders can earn 25% APY by staking their $BABY tokens in the BabyFlokiGirl. 
    (Stake for a minimum of 15 days; withdrawing prematurely results in a 8% penalty)
    Earn $BABY by just holding BabyFlokiGirl in your wallet. 4% of every buy and sell transaction is distributed to BabyFlokiGirl holders.
    
    #Launch and #contract details ;
    - Contract : 
    - Initial #LP will be 2500 USD and #LP will be locked launch.
    - #TaxFee '5' - Low Transactions Fee
    - #Coingecko and #CMC Fast Track
    
    🌍Web : BabyFlokiGirl.com
    🕊Twitter: www.twitter.com/BabyFlokiGirl
    🔎Telegram : t.me/BabyFlokiGirl
...
contract BabyFlokiGirl is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "BabyFlokiGirl";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 15000000000000000 * 10**9;
