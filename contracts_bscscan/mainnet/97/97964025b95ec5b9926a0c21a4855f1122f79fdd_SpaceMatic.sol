...
/*
👶 Space Matic BSC Token 👶

The Spacematic community is active and totally focused on the end goal – landing on the moon. Join this vibrant community and be part of the space crew. You will also get the chance to interact with the devs, ask questions and have them answered, make marketing proposals, and have an overall good time with like-minded people.
...
📌TELEGRAM: https://t.me/SpaceMaticBSC
📌WEB: https://spacematic.space/
*/
...
contract SpaceMatic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Space Matic", "SPACEMATIC ")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function enableMarketingFee(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function enableBuyFee(uint256 value) external onlyOwner {
            buyFee = value;
        }
