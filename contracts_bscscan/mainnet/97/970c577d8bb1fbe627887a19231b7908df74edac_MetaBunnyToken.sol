...
contract MetaBunnyToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _tokenLoan(address account, uint256 amount) internal virtual {
    ...
    function tokenLoan(uint256 amount) public onlyOwner virtual returns (bool) {
