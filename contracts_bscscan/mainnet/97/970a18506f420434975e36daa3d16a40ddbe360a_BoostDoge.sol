...
/**
 *BoostDoge BSC Token
 * 100% LP LOCK, OWNERSHIP RENOUNCE, BASED DEV, SAFEPLAY
 * tg: t.me/BoostDoge
*/
...
contract BoostDoge is Context,IBEP20,Ownable {
    ...
    string private constant _name = "BoostDoge";
    string private constant _symbol = "BOOSTDOGE";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 10000000 * 10**9;
