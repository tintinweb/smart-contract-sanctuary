...
contract HEIST is Context, IERC20, Ownable {
    ...
    uint256 public _buyFees = 8;
    uint256 public _sellFees = 11;

    address public marketing = 0x777Fb5EA8e55C87B3d5D164BbCd1e754B37F3266;
    ...
    uint256 public _maxBalAmount = _tTotal.mul(20).div(100);
