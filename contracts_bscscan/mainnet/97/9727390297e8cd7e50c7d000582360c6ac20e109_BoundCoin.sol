...
/**
   ...
   ** 1,000,000,000,000
   ...
   What we at Bound Coin has developed is a powerful app,
   a protocol created to maximize profit by shifting the
   invested capital around to different pools.
   
   By utilizing the power of smart contracts,
   we eliminate the need for manual research
   and allow users to earn a bigger income.

   Our immediate products to be launched include
   our own NFT marketplace, Live Crypto and Wallet Crypto.
...
contract BoundCoin is Context, IERC20, Ownable {
    ...
    string private _name = "BoundCoin";
