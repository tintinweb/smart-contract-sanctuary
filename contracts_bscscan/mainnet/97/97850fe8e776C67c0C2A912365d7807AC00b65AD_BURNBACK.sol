...
contract BURNBACK is Context, IERC20, Ownable {
    ...
    string private _name = "BurnBackToken";
    ...
    address public buybackv2Address  = 0x05051acef2Bd7cc047E6046880a6F2F5EA404bDb;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x284cf838fBC1612fB70677Ee0ecB4617dA3616D3;      // SMarketing Address
