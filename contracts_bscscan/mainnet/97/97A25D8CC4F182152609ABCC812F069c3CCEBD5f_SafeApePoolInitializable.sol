...
// File: contracts/SafeApePoolInitializable.sol

pragma solidity 0.6.12;

contract SafeApePoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public SAFEAPE_POOL_FACTORY;
    ...
    constructor() public {
        SAFEAPE_POOL_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == SAFEAPE_POOL_FACTORY, "Not factory");
...
// File: contracts/SafeApePoolFactory.sol

pragma solidity 0.6.12;

contract SafeApePoolFactory is Ownable {
    event NewSafeApePoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(SafeApePoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        SafeApePoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewSafeApePoolContract(smartChefAddress);
    }
}