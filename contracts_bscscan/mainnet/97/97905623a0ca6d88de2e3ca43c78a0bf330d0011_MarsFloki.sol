...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5ed870E9031A8cdD5Ffa43e056914aAa34c9d018;
...
contract MarsFloki is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCD95fC786BF0d7dD117C720B35a5ebd653FbCf1E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MarsFloki";
    string private _symbol = "MFLKI";
