...
🐦 Twitter: https://twitter.com/Babyironmanbsc
👽 Reddit: https://www.reddit.com/user/pikselpikseltv
📱 Telegram: https://t.me/babyironman

🤖👶 Baby Tony is coming to take control Defi and give BNB rewards in every 60 mins to supporters.

Here is offers to Investors by Stark Industries;
...
The contract is being audited by Techrate and CertiK (In progress).

🏦 Massive Marketing Plan
5% of every transaction is allocated to Marketing in BNB (swapped to BNB in real time to avoid dumps). 
So we can fuel the most ambitious projects and reward our active community.

💴 Tokenomics 💴 

✳️ Fairlaunch

🚢 Total Supply: 1,000,000,000,000,000 Baby Iron Man
⚡️Hyper Deflationary Farm Token
💵Initial Liquidity 20 BNB

💰 Tax: 20%
12% to Redistribution In BNB (Auto Paid Every 60 Minutes)
3% Auto Liquidty Pool
5% for Massive Marketing Marketing
2% Extra Sell Fee
...
contract BABYIRONMAN is IBEP20, Ownable {
