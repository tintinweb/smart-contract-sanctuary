...
BabySouthAmerica is a high reward dividend token created to guarantee automatic passive earnings to the community.
Earn ETH jusy by holding BabySouthAmerica.


Telegram: https://t.me/babysouthamerica
...
contract BabySouthAmerica is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabySouthAmerica";
    string constant _symbol = "BabySouthAmerica";
