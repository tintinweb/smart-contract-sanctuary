...
/**
   ...
   5% of transaction fee will be distributed to Holders
   ttl supply = 1,000,000,000,000.
   decimals 9
*/
...
contract $ATHMD is Context, IERC20, Ownable {
    ...
    string private _name = "ATHMiniDoge";
    string private _symbol = "$ATHMD" ;
