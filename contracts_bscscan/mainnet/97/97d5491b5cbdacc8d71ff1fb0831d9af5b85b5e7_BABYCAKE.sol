...
//
// $MAakeCakeMakeMoney SUPPORTS HODLERS!!!!!
//
// DIVIDEND YIELD PAID IN CAKE! With the auto-claim feature,
// simply HODL $MakeCakeMakeMoney and you'll receive CAKE automatically in your wallet.
// 
//
//   NOTEEEE:
//  EVERY TRANSCATION HELPS MAKE CAKE AND HENCE MAKE MONEY FOR UR VILLAGE <3
//
//
// 📱 Telegram: t.me/MakeCakeMakeMoney
...
contract BABYCAKE is ERC20, Ownable {
    ...
    constructor() public ERC20("MakeCakeMakeMoney", "MCMM") {
