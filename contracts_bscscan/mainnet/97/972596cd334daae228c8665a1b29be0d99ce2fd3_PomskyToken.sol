...
Pomsky is a protocol on the BSC with the latest technology - driven by experienced marketers and developers from the DeFi space. 
With pomsky, you earn BNB instantly by holding your tokens.

Tax:
12% Redistribution (BNB rewards instantly on every buy and sell transaction, so no more 60 min waiting time like most of the tokens!)
2% Auto Liquidity 
3% Buyback  
1% Marketing

Initial supply: 1.000.000.000.000.000 Pomsky tokens
Distribution :
