...
Official Telegram - https://t.me/stealthedbyadam
...
import "./REBATEDividendTracker.sol";

contract REBATE is ERC20, Ownable {
    ...
    REBATEDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Forever Adam", "REBATE") {

    	dividendTracker = new REBATEDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "REBATE: The dividend tracker already has that address");

        REBATEDividendTracker newDividendTracker = REBATEDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "REBATE: The new dividend tracker must be owned by the Forever Adam contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "REBATE: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "REBATE: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "REBATE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "REBATE: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "REBATE: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "REBATE: Cannot update gasForProcessing to same value");
