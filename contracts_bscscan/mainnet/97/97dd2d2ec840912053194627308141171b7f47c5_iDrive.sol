...
contract iDrive is ERC20, Ownable {
    // CONFIG START
    
    // TOKEM
    string tokenName = "iDrive";
    string tokenSymbol = "iDrive";
    uint256 tokenTotalSupply = 1_000_000_000 * (10**18);
    
    // ADRESSES
    address marketingWallet = 0xAd3e854eBBE1d2e86c853196Cb303fbE4C568681;
    address router02 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    
    // TAX (5%)
    uint8 marketingTax = 5;
    
    // BOT PREVENTION (set the bot prevention timer in ms, transaction will be reverted)
    uint256 flagLimit = 9000; 
    
    // WHALE PROTECTION
    uint256 maxTXAmount = 500_000_000 * (10**18);
