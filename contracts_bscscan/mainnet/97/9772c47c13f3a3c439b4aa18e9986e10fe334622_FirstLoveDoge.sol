...
contract FirstLoveDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FirstLoveDoge";
    string private _symbol = "FLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1fD192bD22Ab3F7bE288EC180C0027f43ab598b5); // Marketing Address
    address payable public teamWalletAddress = payable(0xB25AE4A54F73c17744552FbbaD99BBB00e2CbAaA); // Team Address
	address public OwnerAddress =0xC8eC916f92E464B674e27D77006D493e5ee73F4A;
    ...
    uint256 public _maxTxAmount = 100 * 10**6 *  10**_decimals; 
