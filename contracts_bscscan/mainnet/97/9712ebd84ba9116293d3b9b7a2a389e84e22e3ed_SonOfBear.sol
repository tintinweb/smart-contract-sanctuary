...
🐻 1BNB Initial Mcap                                                                                                   🐻LP Locked 2 Month
🐻 Based DEV
🐻 No DEV Wallet
🐻 50% Burn token at launch

JOIN US

Telegram : https://t.me/SonOfBearBSC
...
contract SonOfBear is Context, IERC20, Ownable {
    ...
    string private _name = "SonOfBear";
    string private _symbol = "SonOfBear";
    ...
    uint256 public maxBuyTranscationAmount = 250000000000 * 10**6 * 10**9; 
    uint256 public maxSellTransactionAmount = 5000000000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 500000000000 * 10**6 * 10**9;
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private BuyBackAddress = 0x1fb67566f62823907Dff6981354B1052D39376c0;
