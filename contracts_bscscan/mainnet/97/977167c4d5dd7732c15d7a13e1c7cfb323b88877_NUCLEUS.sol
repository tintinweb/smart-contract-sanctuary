...
4% Marketing: 0x097F4838635fe0f166f24E28D4eDdf446301F5Fe
4% Team allocation: 0xc66d393b3122aB411E83ad0cb53bcEdE28d8601C
...
contract NUCLEUS is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 5000000000000000 * 10**18; // 0.5 % Buy and sell
 ...
 //   function withdrawLPToken(uint256 _sid, uint256 _rate, uint256 _desirePrice, uint256 _slippage) external  {
  ...
  //  }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        _transferStandard(sender, TeamAllocationAddress, fundingPiece.mul(4));
