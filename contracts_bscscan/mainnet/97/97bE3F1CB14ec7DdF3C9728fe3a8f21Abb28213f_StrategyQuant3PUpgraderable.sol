...
// File: contracts/StrategyQuant3PUpgraderable.sol
...
contract StrategyQuant3PUpgraderable is ReentrancyGuardUpgradeSafe, OwnableUpgradeable , Pausable {
   ...
   address[] public earnedToGrandPath;
    ...
    function initialize(
        ...
        if (isGrandComp) {
            ...
            earnedToGrandPath = [earnedAddress, busd, wbnbAddress, GrandAddress];
        }
    ...
    function earn() public whenNotPaused {
        ...
        (earnedToFTokenPath[0], earnedToFTokenPath[1]) = (earnedAddress,busd);
        ...
        uint256 amt = IERC20(busd).balanceOf(address(this));
        if (amt > 0) {
            uint256[] memory amounts = new uint256[](4);

            (amounts[0], amounts[1], amounts[2],amounts[3]) = (0,IERC20(busd).balanceOf(address(this)), 0, 0);
