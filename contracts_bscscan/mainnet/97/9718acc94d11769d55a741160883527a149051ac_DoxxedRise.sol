...
contract DoxxedRise is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DoxxedRise";
    string constant _symbol = "DOXRISE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x18cFf4777a79eDB2ADbDFfd8378C47a43aB5E4a5;
