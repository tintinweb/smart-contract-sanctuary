...
contract SunglassesDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = 0x6dCa3AF5723f7Bd43FE14517Ed57302722822735;
    ...
    function setBuyFee(uint256 buyTaxFee, uint256 buyFomoFee,uint256 buyLiquidityFee,uint256 buyMarketingFee) external onlyOwner {
    ...
    function setSellFee(uint256 sellTaxFee, uint256 sellFomoFee,uint256 sellMarketingFee,uint256 sellLiquidityFee) external onlyOwner {
