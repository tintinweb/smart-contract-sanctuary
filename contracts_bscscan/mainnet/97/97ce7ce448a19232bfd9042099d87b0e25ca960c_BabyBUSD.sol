...
contract BabyBUSD is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "BabyBUSD";
   string constant _symbol = "BBUSD";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x9A380b4867DCDBA8cD88258687A23ABF69434fD6;
