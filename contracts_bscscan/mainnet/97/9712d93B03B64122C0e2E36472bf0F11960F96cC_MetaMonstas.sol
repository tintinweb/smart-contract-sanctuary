...
contract MetaMonstas is MetaDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamMeta;
    address private CharityMeta;
    ...
    string public override name = "Meta Monstas";
    string public override symbol = "Monstas Meta";
    ...
    constructor(uint totalSupplyValue, address TeamMetaAddress, address CharityMetaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamMeta = TeamMetaAddress;
        CharityMeta = CharityMetaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamMeta] =  totalSupply * 4 / 100;
        balances[CharityMeta] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TeamMeta pot
