...
SPONSEE is an iOS/Android mobile app that connects influencers with 
companies to create a sponsor-sponsee economy 
that is free of platform fees.
https://twitter.com/SponseeApp
https://web.facebook.com/SponseeApp?_rdc=1&_rdr
https://t.me/sponsee
https://www.instagram.com/sponsee_app/
https://discord.com/invite/uRC7USuw
Sponsee is the world's first fee-free marketplace that connects 
Influencers and Businesses. $SPON is the token that governs Sponsee and 
is the bridge that enables app functions like smart contracts, proprietary 
dispute resolution services and peer reviews. Building a fully transparent, 
integrated and smart ecosystem for influencer marketing. The Sponsee app has ranked 
8th on the App Store in Singapore 
against the likes of facebook, telegram and others.
*/
...
contract SPONSEE is IPOJ89 {
    ...
    // token title USDdata
    string public override name = "SPONSEE";
    string public override symbol = "SPON";
