...
contract Virtuous is Context, IBEPMEME, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000000 * 10**3 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Virtuous';
    string private _symbol = 'Virtuous';
