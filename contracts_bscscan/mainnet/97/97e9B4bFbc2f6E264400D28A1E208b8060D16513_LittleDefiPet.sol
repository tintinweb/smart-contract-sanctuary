...
/**
   ...
   I make this #LittleDefiPet to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/LittleDefiPet
   ...
   I will renounce the ownership to burn addresses to transfer #LittleDefiPet to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 10% total supply to the pool
   Can you make #LittleDefiPet 1000X? 
   ...
   it's the best part of the #LittleDefiPet idea, increasing the liquidity pool automatically, 
...
contract LittleDefiPet
 is Context, IERC20, Ownable {
    ...
    string private _name = "LittleDefiPet";
    string private _symbol = "Little Dpet";
