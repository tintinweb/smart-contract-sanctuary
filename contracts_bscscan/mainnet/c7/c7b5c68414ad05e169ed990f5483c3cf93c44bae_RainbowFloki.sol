...
/* 
    Telegram: https://t.me/RainbowFloki
    Website: https://RainbowFloki.com
*/
...
contract RainbowFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeCast for int256;
  
    string private _name = "Rainbow Floki";
    string private _symbol = "RNF";
    ...
    uint256 public _buyBackFee= 1300;
