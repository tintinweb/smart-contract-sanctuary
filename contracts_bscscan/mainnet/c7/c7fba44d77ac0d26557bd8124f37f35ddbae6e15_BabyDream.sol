...
contract BabyDream is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby DREAM";
    string private constant _symbol = "BabyDREAM";
    ...
    constructor () {
        ...
        emit Transfer(address(0x7494D75ec08E63c5618d70683591Cb743e141c9f), _msgSender(), _tTotal);
    }
