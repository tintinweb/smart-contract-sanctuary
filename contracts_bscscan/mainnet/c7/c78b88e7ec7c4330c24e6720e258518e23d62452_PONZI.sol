...
/**
 * 
Meet PONZI, dedicated to the biggest scam in the history of mankind.

Get passive income with $PONZI! PONZI allows you to earn. just keep the token in your wallet. Tokenomic is set up so that 5 percent of each transaction is distributed to all token holders.

Become the first investors and maximize your income today!
...
✅ Fair launch
✅ Community driven
✅ X100-X1000 growth potential


Tokenomics:
💠 Total offering: 64,800,000,000
💠 Anti-Fraud Fund 32,400,000,000 50% (rewards will be used for donations)
💠 Marketing Purse: 20% (rewards will be used for promotion)
💠 10% General tax | 5% Rewards | 5% Liquidity | 
*/
