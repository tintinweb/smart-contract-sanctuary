 ...
 * What is $BabyTRON?
 * As the name suggests, $BabyTRON is an intricately designed BSC contract and BSC based investment created in order to provide a passive income in one of BSC's favourite, most stable and future proof token.

 * Simply buy and hold 10,000+ $BabyTron token in your wallet and you'll receive $TRON directly in your wallet. You do not even need to lift a finger, let $BabyTRON do all the work while you enjoy that
...
contract BabyTRON is Context, IERC20, Ownable {
    ...
    address TRON = 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B; // TRON ADDRESS FOR REFLECTION
