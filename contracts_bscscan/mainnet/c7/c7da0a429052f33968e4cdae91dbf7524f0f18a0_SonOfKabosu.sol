...
//https://t.me/SonofKabosu
//https://twitter.com/AbanBerp
...
contract SonOfKabosu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Son of Kabosu";
    string private _symbol = "$SOB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAB171D0d10668a9cca837F6B1B3546FA2d8257cA); // Marketing Address
