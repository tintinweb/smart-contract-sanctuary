...
/* https://t.me/MysteryCAKE_BSC
Total Supply - 1,000,000,000
Max Wallet   -    20,000,000
Max Buy  Trx -    10,000,000
Max Sell Trx -    10,000,000
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD_TOKEN = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
...
contract ForeverCAKE is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD_TOKEN = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ForeverCAKE";
    string constant _symbol = "FCAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals); 
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; 
    uint256 public init_maxTxAmount = _totalSupply * 1 / 100; 
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;
    uint256 public init_maxWalletToken = ( _totalSupply * 2 ) / 100;
    ...
    uint256 public totalFee = 19;
    uint256 feeDenominator  = 100;

    uint256 init_liquidityFee    = 3; 
    uint256 init_reflectionFee   = 7; 
    uint256 init_marketingFee    = 9; 
    uint256 public init_totalFee = 19;
    uint256 init_feeDenominator  = 100;
    ...
    function removeAllFees() external authorized {
    ...
    function resetFees() external authorized {
      _maxTxAmount = init_maxTxAmount; //1% of total supply
      _maxWalletToken = init_maxWalletToken; // 2% of total supply
      liquidityFee    = init_liquidityFee;
      reflectionFee   = init_reflectionFee;
      marketingFee    = init_marketingFee;
      totalFee = init_totalFee;
      feeDenominator  = init_feeDenominator;
    }
