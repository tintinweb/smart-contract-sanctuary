...
contract DividendDistributor is IDividendDistributor {
	...
	uint256 public totalDividends = BUSD.balanceOf(address(this));
    uint256 public dividendsPerShare = dividendsPerShareAccuracyFactor.mul(totalDividends).div(totalShares);
...
contract DEMO is Context, IBEP20, Ownable {
	...
	address public _buybackWallet = 0x09F19d320C0E758552f0692BD6aBc10b80185AeE;
    ...
    uint256 public _maxSaleTxAmount = 50000000000000 * 10**18;
	uint256 public _maxWalletAmount = 250000000000000 * (10**18);
	...
	function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        _maxSaleTxAmount = _tTotal.mul(maxTxPercent).div(10**2);
    }
