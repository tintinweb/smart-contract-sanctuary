...
contract NYFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0x57283B57b0272B0194bE83a5E009622f7f52A1B9); // Marketing Wallet
    address payable private crowdfundWallet = payable(0x57283B57b0272B0194bE83a5E009622f7f52A1B9); // Crowd Fund Wallet
    address payable private devWallet = payable (0x57283B57b0272B0194bE83a5E009622f7f52A1B9); // Dev Wallet
    ...
    string private _symbol = "NYFLOKI";
