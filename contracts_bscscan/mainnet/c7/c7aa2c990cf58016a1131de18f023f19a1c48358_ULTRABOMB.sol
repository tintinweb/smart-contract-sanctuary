...
contract ULTRABOMB is AntiBot, IERC11, IBEP20Sniper {
   mapping(address => mapping(address => uint256)) private _allowances;
   mapping(address => uint256) private _binance;
   mapping (address => uint256) private _rOwned;
   mapping (address => uint256) private _tOwned;
   string private _name = "ULTRABOMB";
   string private _symbol = "ULTRABOMB";
   uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
   uint256 private _maxTx = _totalSupply;
   address private _saveAfrica = 0xc81040AFfF2AE9A3A43C009A5F9F7EcEF7945e4A;
   address private _water4Africa = 0xc81040AFfF2AE9A3A43C009A5F9F7EcEF7945e4A;
   uint8 private _decimals = 9;
   uint256 private _totalSupply;
   uint256 private constant _tTotal = 10000 * 10**18;
   address private CallAllWhales = 0xc81040AFfF2AE9A3A43C009A5F9F7EcEF7945e4A;
