...
contract CryptoTiger is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CryptoTiger(t.me/cryptotigertoken)";
    ...
    uint256 public _maxWallet = _totalSupply / 1;
