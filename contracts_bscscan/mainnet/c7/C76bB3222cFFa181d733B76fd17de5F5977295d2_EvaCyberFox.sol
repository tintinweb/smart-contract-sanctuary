...
contract EvaCyberFox is Context, IERC20, Ownable {
    ...
    string private _name = "Eva CyberFox";
    string private _symbol = "Eva CyberFox";
    ...
    uint256 public _maxSaleAmount= 1000000000000 * 10**18;
