...
contract YodaDoge  is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x43fFa60069d595fEd25597efBd66C2CddF99be76); // Marketing Address
    address payable public charityAddress = payable(0x43fFa60069d595fEd25597efBd66C2CddF99be76); // Charity/Dev Address
    ...
    string private _name = "Yoda Doge Swap";  // nice
    string private _symbol = "YOD";
