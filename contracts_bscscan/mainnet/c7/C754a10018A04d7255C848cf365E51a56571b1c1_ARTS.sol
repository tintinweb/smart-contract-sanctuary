...
contract ARTS is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "ARTS";
    string constant public symbol = "ARTS";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 30, "ARTS: transaction fee percentage exceeds 30");
        require(feePercentage_ >= 0, "ARTS: transaction fee percentage equals 0");
    ...
    function blacklist(address[] calldata addresses, bool isBlacklist) external {
        require(hasBlacklistPermission[msg.sender], "ARTS:insufficient permission");
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "ARTS: transfer from blacklisted address");
        require(!isBlacklisted[recipient], "ARTS: transfer to blacklisted address");
        require(!isBlacklisted[tx.origin], "ARTS: transfer called from blacklisted address");
