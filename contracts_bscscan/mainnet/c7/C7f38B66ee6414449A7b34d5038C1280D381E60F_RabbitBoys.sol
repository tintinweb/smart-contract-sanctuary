...
contract RabbitBoys is Context, IERC20, Ownable {
    ...
    string private _name = "Rabbit Boys";
    string private _symbol = "RABBITBOYS";
    ...
    uint256 private constant _Burn_FEE = 500; // 4%
	uint256 private minimumTokensBeforeSwap = 20000 * 10**9 * 10**9;
