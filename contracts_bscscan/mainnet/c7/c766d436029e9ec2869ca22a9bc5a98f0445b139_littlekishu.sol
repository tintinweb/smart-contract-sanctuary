...
Maxbuy/sell 3000000000000000000000 
note: That each wallet does not exceed 2%
JOIN TG : littlekishu
...
contract littlekishu is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "littlekishu";
    string private _symbol = "littlekishu";
