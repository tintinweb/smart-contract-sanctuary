...
/**
   ...
   Welcome to LittleStellar
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleStellar
...
contract LittleStellar is Context, IERC20, Ownable {
    ...
    string private _name = "Little Stellar";
    string private _symbol = "LTXLM";
