...
contract BabyDenmark is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyDenmark";
    string constant _symbol = "BBDENMARK";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 2000;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xe5983eC231331683Eb61fB7E4fEf577638c1dC71;
