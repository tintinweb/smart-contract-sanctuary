...
TG: https://t.me/SONOFFOXYOFFICIAL
...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 5 days");
...
contract SonofFoxy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x41FE8c376AB920358CF0194ae2c1c2Dd7b3246cF); // Marketing Address
    ...
    string private _name = "SON OF FOXY";
    string private _symbol = "SONOFFOXY";
