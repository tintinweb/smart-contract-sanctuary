...
// JOIN The party here TG: T.ME/Metaheroshiba

// Buy MetaHeroShiba to get BUSD passive incomes just ny holding
...
contract MetaHeroShiba is Context, IERC20, Ownable {
    ...
    string private _name = "MetaHeroShiba";
    string private _symbol = "METAHEROSHIBA";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10**9 * 10**_decimals;

    address payable public marketingAddress = payable(0xA0b1A0693Fd6f901CCe2c8AF65BDbE1f8c31810E);
    ...
    constructor () {
        ...
        _maxBalanceWallet = 20000 * 10**9 * 10**_decimals;
