...
contract WhaleCheems is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WhaleBONK";
    string private _symbol = "WhaleBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x036bA208EEe82fb014F5BdF5F9d9a2A2e1532804); // Marketing Address
    address payable public teamWalletAddress = payable(0xFe8B4425B587bAa71e063DB5D228B50480F4cE6B); // buyback Address
    ...
    uint256 private _totalSupply = 1000 * 10**9 * 10**9;
    uint256 public _maxTxAmount = 200000000000 * 10**9; 
    uint256 public _walletMax =  400000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 84000 * 10**9; 
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _liquidityFee.add(_marketingFee);
        _totalTaxIfSelling = _totalTaxIfBuying.add(_teamFee);
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBTeam = amountReceived.mul(_teamFee).div(totalBNBFee);
