...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //DSLV
...
contract BlueSky is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BlueSky";
    string constant _symbol = "BSKY";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x633316c17BDeF8A2b46AdB22339558c67D7E3B6A;  // teamwallet
        lotteryWallet = 0x633316c17BDeF8A2b46AdB22339558c67D7E3B6A;  // lotterywallet
