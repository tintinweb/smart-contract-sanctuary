...
contract ChikuKishu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chiku Kishu";
    string private _symbol = "CK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0D0Ff4caCef2C09916F294a62c46408824524Ac4); // Marketing Address
    address payable private buyBackWalletAddress = payable(0x0D0Ff4caCef2C09916F294a62c46408824524Ac4); // buyback Address
    ...
    uint256 public _walletMax = 1000000000000000 * 10**9; // 3%
