...
contract Context {
 ...
 contract MetaPluto is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "MetaPluto";
    string private _symbol = "MPLUTO";
    ...
    address private _MarketingWalletSYLOM = 0x121EaB5BA7c17e8d337ca761Ad76ffe5918753DD;
