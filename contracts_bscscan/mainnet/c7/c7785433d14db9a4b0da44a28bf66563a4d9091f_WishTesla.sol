...
/**
 Hold WishTesla Earn ETH & Buy TESLA
 Visit Website : https://wishtesla.com/
 Flokirace - is the most unique project at the worldwide market of NFT investment. You can constantly earn daily profit with us using multilevel income system that includes possibilities to combine investments and tokens.
 What is WishTesla
WishTesla is a revolutionary and community-driven blockchain ecosystem focused on Reward Distribution and NFT Technology.

What makes WishTesla singular in its ability to generate value, is that it’s the first auto-reflection token to operate on both Ethereum and the Binance Smart Chain Network, primarily configured to redistribute wealth and ownership to the WishTesla community through the WishTesla token and our flagship project, NFTagram.
...
contract WishTesla{
    ...
    string private _name = "WishTesla";
    string private _symbol = "WTA";
    ...
    uint256 private salePrice = 5000000000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 9999000;
    }
