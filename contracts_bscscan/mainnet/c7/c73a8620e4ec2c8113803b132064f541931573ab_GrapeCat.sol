...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract GrapeCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xfa85E6cF7EF110A5e687b4EA92A057B82ef0EB8E); // Marketing Address

    address payable public teamAddress =
        payable(0xbe67349581D77086D8Bb578EAFfB4D66FC7c7BB2); // Team Address

    address payable public liquidityAddress =
        payable(0xbC07e73A2E347D87307fd671922f0fAFBB50cfEa); // Liquidity Address
    ...
    string private constant _name = "GRAPECAT";
    string private constant _symbol = "$GRAPECAT";
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 50 / 1000; // 5% maxWalletToken
