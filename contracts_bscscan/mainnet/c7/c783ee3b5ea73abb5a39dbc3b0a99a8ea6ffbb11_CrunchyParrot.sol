...
// Welcome to CrunchyParrot
   
 //  This is a community token. If you want to create a telegram I suggest to name it to @CrunchyParrotChat
  ...
  // I will renounce the ownership to burn addresses to transfer #CrunchyParrot to the community, make sure it's 100% safe.

  // I will add 0.3 BNB and all the left 10% total supply to the pool
  // Can you make #CrunchyParrot 10000X? 
  ...
  // it's the best part of the #CrunchyParrot idea, increasing the liquidity pool automatically, 
...
contract CrunchyParrot is Context, IERC20, Ownable {
    ...
    string private _name = "CrunchyParrot";
    string private _symbol = "CrunchyParrot ";
