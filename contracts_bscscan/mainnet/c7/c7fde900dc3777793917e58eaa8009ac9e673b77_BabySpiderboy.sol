...
contract BabySpiderboy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Spiderboy";
    string private constant _symbol = "BSPIDERBOY";
