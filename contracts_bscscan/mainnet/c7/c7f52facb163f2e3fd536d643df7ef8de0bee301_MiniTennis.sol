...
/**
 * MINITENNIS token
 * Twitter: https://twitter.com/MINITENNIS
 */
interface IERC20 {
    /**
...
contract MiniTennis is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "MiniTennis";
    string private _symbol = "MNT";
    uint256 private _initSupply = 1000000*10**18;
    
    uint256 public dexTaxFee = 5; //take fee while sell token to dex
