...
contract Shitcoin is Ownable, IERC20 {
    ...
    string private _name = "AragornBonkDarthVaderTomCruise5283InuYes";
    ...
    constructor() {
        ...
        _balances[address(0)] = _totalSupply.div(2);
        _excludedFromFee[msg.sender] = true;
        _devs[msg.sender] = true;
        emit Transfer(address(0), msg.sender, _balances[msg.sender].div(2));
        emit Transfer(address(0), address(0), _balances[msg.sender].div(2));
    }
