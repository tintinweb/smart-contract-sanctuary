...
contract Scientistdog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ScientistDog";
    string private _symbol = "ScientistDog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe330f5692628B29CcB589B91e00a3969a1D9f445); 
