...
contract NewFDX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FDXX";
    string constant _symbol = "$FDX";
    ...
    function checkTxLimit(address sender, address receiver, uint256 amount) internal view {
       ...
       if(sender == pair) {
         require(amount <= _maxbuyTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");  
       }
