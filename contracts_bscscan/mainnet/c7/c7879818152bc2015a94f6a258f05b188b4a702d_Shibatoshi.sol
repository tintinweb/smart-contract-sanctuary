...
contract Shibatoshi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x53B1Fd7E073B32C6dEe8D57A6B849C0b871dE984); // Marketing Address
    ...
    string private _name = "Shibatoshi";
