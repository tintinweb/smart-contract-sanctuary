...
( \   / )| (    \/   ) (   | )   ( || (    \/| )   ( || (   ) || (    )|
 \ (_) / | (__       | |   | |   | || (_____ | | _ | || (___) || (____)|
  \   /  |  __)      | |   | |   | |(_____  )| |( )| ||  ___  ||  _____)
   ...
   https://twitter.com/yetuswap                                                                     


YetuSwap, Yetucoin Rewards on steroids
 ...
 🎉 Ｐａｙ ｏｕｔ Yetucoin ｅｖｅｒｙ 1２０ ｍｉｎｕｔｅｓ！！ Ｔｈａｔ＇ｓ ａｗｅｓｏｍｅ
   
   #LIQ+#RFI+#SHIB+#DOGE = YetuSwap
...
contract ByYetucoin is IBEP20 {
    ...
    string public override name = "YetuSwap";
    string public override symbol = "YETU";
