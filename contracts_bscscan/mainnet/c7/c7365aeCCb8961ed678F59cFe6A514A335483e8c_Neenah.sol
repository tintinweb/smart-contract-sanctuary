...
contract Neenah is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0x078787B8B694741751F70bb26a0EB3518199d253); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x078787B8B694741751F70bb26a0EB3518199d253); // Ecosystem Wallet
    address payable private devWallet = payable (0xed1828059c94D181c6f28e0b7626d1533BA755a8); // dev Wallet
    ...
    string private _name = "Neenah";
    string private _symbol = "Neenah";
    ...
    uint256 public _sellLiquidityFee = 30; //3%
    uint256 public _sellMarketingFee = 40;  //4%
    uint256 public _sellDevFee = 10;   //1%
    uint256 public _sellReflectionFee = 0;
    
    uint256 private ecosystemFee = 20;   //2% same for buys and sells
    ...
    function manage_untrusted(address[] calldata addresses) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            _isTrusted[addresses[i]]=false;
        }
    }
