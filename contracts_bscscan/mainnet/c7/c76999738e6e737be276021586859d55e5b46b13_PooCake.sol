...
contract PooCake is IBEP20, Auth {
    using SafeMath for uint256;
    
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "ZombieCake";
    string constant _symbol = "ZombieCake";
    ...
    function setLauNch() external onlyOwner {
        ...
        swE = true;
        _maxTxAmount = ( _totalSupply * 100 ) / 10000;
        _maxWalletToken = ( _totalSupply * 200 ) / 10000;
    }
