 ...
 *                                                                                                                                                                                                    
 *                                                                                                                                                                                                    
 *    PPPPPPPPPPPPPPPPP   lllllll                                                                 tttt               LLLLLLLLLLL                                                    ffffffffffffffff  
 *    P::::::::::::::::P  l:::::l                                                              ttt:::t               L:::::::::L                                                   f::::::::::::::::f 
 *    P::::::PPPPPP:::::P l:::::l                                                              t:::::t               L:::::::::L                                                  f::::::::::::::::::f
 *    PP:::::P     P:::::Pl:::::l                                                              t:::::t               LL:::::::LL                                                  f::::::fffffff:::::f
 *      P::::P     P:::::P l::::l   aaaaaaaaaaaaa  nnnn  nnnnnnnn        eeeeeeeeeeee    ttttttt:::::ttttttt           L:::::L                   eeeeeeeeeeee    aaaaaaaaaaaaa    f:::::f       ffffff
 *      P::::P     P:::::P l::::l   a::::::::::::a n:::nn::::::::nn    ee::::::::::::ee  t:::::::::::::::::t           L:::::L                 ee::::::::::::ee  a::::::::::::a   f:::::f             
 *      P::::PPPPPP:::::P  l::::l   aaaaaaaaa:::::an::::::::::::::nn  e::::::eeeee:::::eet:::::::::::::::::t           L:::::L                e::::::eeeee:::::eeaaaaaaaaa:::::a f:::::::ffffff       
 *      P:::::::::::::PP   l::::l            a::::ann:::::::::::::::ne::::::e     e:::::etttttt:::::::tttttt           L:::::L               e::::::e     e:::::e         a::::a f::::::::::::f       
 *      P::::PPPPPPPPP     l::::l     aaaaaaa:::::a  n:::::nnnn:::::ne:::::::eeeee::::::e      t:::::t                 L:::::L               e:::::::eeeee::::::e  aaaaaaa:::::a f::::::::::::f       
 *      P::::P             l::::l   aa::::::::::::a  n::::n    n::::ne:::::::::::::::::e       t:::::t                 L:::::L               e:::::::::::::::::e aa::::::::::::a f:::::::ffffff       
 *      P::::P             l::::l  a::::aaaa::::::a  n::::n    n::::ne::::::eeeeeeeeeee        t:::::t                 L:::::L               e::::::eeeeeeeeeee a::::aaaa::::::a  f:::::f             
 *      P::::P             l::::l a::::a    a:::::a  n::::n    n::::ne:::::::e                 t:::::t    tttttt       L:::::L         LLLLLLe:::::::e         a::::a    a:::::a  f:::::f             
 *    PP::::::PP          l::::::la::::a    a:::::a  n::::n    n::::ne::::::::e                t::::::tttt:::::t     LL:::::::LLLLLLLLL:::::Le::::::::e        a::::a    a:::::a f:::::::f            
 *    P::::::::P          l::::::la:::::aaaa::::::a  n::::n    n::::n e::::::::eeeeeeee        tt::::::::::::::t     L::::::::::::::::::::::L e::::::::eeeeeeeea:::::aaaa::::::a f:::::::f            
 *    P::::::::P          l::::::l a::::::::::aa:::a n::::n    n::::n  ee:::::::::::::e          tt:::::::::::tt     L::::::::::::::::::::::L  ee:::::::::::::e a::::::::::aa:::af:::::::f            
 *    PPPPPPPPPP          llllllll  aaaaaaaaaa  aaaa nnnnnn    nnnnnn    eeeeeeeeeeeeee            ttttttttttt       LLLLLLLLLLLLLLLLLLLLLLLL    eeeeeeeeeeeeee  aaaaaaaaaa  aaaafffffffff            
 *                                                                                                                                                                                                    
 *                                                                                                                                                                                                   
 *                                                                                                                                                                                                    
 */
...
contract PlanetLeaf is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 3014000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name     = "Planet Leaf";
    string private constant _symbol   = "PLT";
    uint8  private constant _decimals = 9;
    
    uint256 public _taxFee       = 100; // 1% of every (buying) transaction is redistributed to holders
    uint256 public _liquidityFee = 900; // 9% of every (buying) transaction will be converted into BNB

    uint256 public _sellTaxFee       = 200; // 2% of every selling transaction is redistributed to holders
    uint256 public _sellLiquidityFee = 1300; // 13% of every selling transaction will be converted into BNB

    uint256 public _burnFee      = 0; // 0% of every transaction is burned

    uint256 public _maxTxAmount                   = 3014000000000 * 10**9;
