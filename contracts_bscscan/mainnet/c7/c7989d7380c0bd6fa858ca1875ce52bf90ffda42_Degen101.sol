...
/*
Degen101, because, yeah. Low effort devving really.

I adjusted a contract to only have 4% autoliquidity. Nothing more, there is a marketingwallet, but that one does not gain any funds, same for the devfeewallet.

This stuff might last shortly, I can't pay for callers, and the autoliquidity does mean I will have more 'rug' when this is over.
Also be mindful that autoliq means contract sells. Read this all well, check the fees, they are what I just explained, check the wallets, they indeed receive no funds.

https://t.me/Degen101bsc
...
contract Degen101 is IBEP20, Auth {
    ...
    string constant _name = "Degen 101";
    string constant _symbol = "D101";
    ...
    address private marketingFeeReceiver =0x26c1e707C86b206Aea32adB69A610E9b10E9c127;
    address private teamFeeReceiver =0x26c1e707C86b206Aea32adB69A610E9b10E9c127;
