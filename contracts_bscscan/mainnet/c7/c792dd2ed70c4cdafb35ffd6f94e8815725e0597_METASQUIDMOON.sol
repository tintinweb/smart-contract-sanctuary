...
METASQUIDMOON is the first token rewarding holders at the end of its lifetime.
Buy and Hold until the end to open the Treasure Chest to claim your rewards!

Twitter : twitter.com/METASQUIDMOON
...
contract METASQUIDMOON is Context, IERC20, Ownable {
    ...
    string private _name = "METASQUIDMOON";
    ...
    address payable public marketingAddress = 0x07393AA7C1296e1DCcF7daaB99f42fEBfF871367;
    address payable public cancerAddress = 0x07393AA7C1296e1DCcF7daaB99f42fEBfF871367; // if ur snooping down here this guy has cancer and cannot afford surgery
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x07393AA7C1296e1DCcF7daaB99f42fEBfF871367, 'We can not exclude Uniswap router.');
