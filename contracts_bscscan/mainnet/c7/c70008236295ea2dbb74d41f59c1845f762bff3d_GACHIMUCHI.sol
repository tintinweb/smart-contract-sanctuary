...
// GACHIMUCHI HERE TO SAVE BSC

// SPDX-License-Identifier: MIT
// sit down and relax buddy, DEGEN
...
contract GACHIMUCHI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0xa279153421c374766B32129512624278f0118fcA);
    ...
    string private constant _name = "GACHIMUCHI";
    string private constant _symbol = "GACHI";
