...
/*
*   BATTERUP TOKEN   First Ever Basic Attention Token 
*       ($BATUP)
*
* Claim Basic Attention Token for holding!! 
* 
* Fair Launch
* Contract Verified
* LP Locked
...
* Total Supply:  80 Trillion (100% Locked)
* Max per Holder: 2 Trillion
* Max sell: 1 Trillion
* Max buy:  1 Trillion
* 
* https://t.me/batterupbsc
* 
*/
...
contract BatterUp is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BatterUp";
