...
/**
 * The most BASED token. Hold it to get BUSD and make normies seethe.
 */
...
contract BasedBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BasedBUSDDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("BasedBUSD", "BASED") {
        _ETHRewardsFee = 5;
        _liquidityFee = 5;
		_marketingFee = 1;
    	...
    	dividendTracker = new BasedBUSDDividendTracker();

    	liquidityWallet = owner();
		
		bulkSender = payable(0x89C3bE3A4A9163A4A9e7DC5d98d592a4ed33bb50);
		marketingWallet = payable(0x89C3bE3A4A9163A4A9e7DC5d98d592a4ed33bb50);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
       ...
       BasedBUSDDividendTracker newDividendTracker = BasedBUSDDividendTracker(payable(newAddress));
...
contract BasedBUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("BasedBUSD_Dividend_Tracker", "BasedBUSD_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "BasedBUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "BasedBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "BasedBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BasedBUSD_Dividend_Tracker: Cannot update claimWait to same value");
