 ...
 * 
 * The farming contract will have the minter role function. The mint function can only be called by a multi-sig
 * feature to ensure the safety of our investors, their funds and a healthy environment for Philanthropy_Finance.  
 ...
 * 
 * Tax BUY: 14%
 * (1% burn ~ 3% liquidity ~ 4% marketing ~ 6% reflection in BTCb)
 * 
 * Tax SELL: 16%
 * (1% burn ~ 3% liquidity ~ 4% marketing ~ 8% reflection in BTCb)
 * 
 * Reflections will be redistributed in BTCB (pegged to Bitcoin) to the holders.
 * by an automatic claim mechanism: every hour BTCB rewards will be send automatically to the holders.
 */
