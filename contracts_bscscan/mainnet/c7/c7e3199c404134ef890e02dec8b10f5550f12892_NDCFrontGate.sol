...
/**
  ...
  I'm glad you asked.
  The NDC Front Gate is actually proxy contract!

  We took this approach to be able to deploy further upgrades
  without the need of extensive migrations.

  You can check the active contract address at
  [Read Contract] > [implementation]

  Safe travels.

  Copyright (c) 2021 A7 Team.
 */
...
contract NDCFrontGate is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public liquidityFee = 5;
  uint256 public maxTxAmount = 5000000;
  uint256 public geUnlockTime = 0;
  uint256 public taxFee = 5;
  uint256 public numTokensSellDivisor = 10;
