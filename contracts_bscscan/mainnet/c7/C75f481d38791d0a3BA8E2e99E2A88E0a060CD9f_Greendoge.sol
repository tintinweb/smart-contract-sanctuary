...
contract Greendoge is IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7A9010396506C82dEbb29E257Bad83a481051332);
    ...
    function saveStuckedToken(address _token, address _to) public onlyOwner returns(bool _sent){
        require(_token != address(this), "Can't take out Greendoge.");
