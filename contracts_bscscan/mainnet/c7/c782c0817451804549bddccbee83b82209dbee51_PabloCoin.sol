...
Join the Medellin Cartel on:
https://t.me/PabloCoinCommunity
...
contract PabloCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public _maxTxAmount = _totalSupply * 50 / 100; // 0.05%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xE12a9a83aC4CA367B943b7C00922A941c4dBD1ac;
