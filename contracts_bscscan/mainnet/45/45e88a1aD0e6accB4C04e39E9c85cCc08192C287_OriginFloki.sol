...
________        .__       .__       ___________.__          __   .__ 
\_____  \_______|__| ____ |__| ____ \_   _____/|  |   ____ |  | _|__|
 /   |   \_  __ \  |/ ___\|  |/    \ |    __)  |  |  /  _ \|  |/ /  |
/    |    \  | \/  / /_/  >  |   |  \|     \   |  |_(  <_> )    <|  |
\_______  /__|  |__\___  /|__|___|  /\___  /   |____/\____/|__|_ \__|
        \/        /_____/         \/     \/                     \/   
...
Hold $OFL and receive $FLOKI directly to your BEP-20 wallet as a reward for holding.

Fee : 
4% Liquidity Fee
4% Reflection Fee

No Dev and Marketing Fee.
...
contract OriginFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "OriginFloki";
    string constant _symbol = "OFL";
    ...
    function takeFee(address sender, uint256 rAmount, bool notSell) internal returns (uint256) {
        ...
        if(notSell && (launchedAt + deadBlocks) < block.number){
