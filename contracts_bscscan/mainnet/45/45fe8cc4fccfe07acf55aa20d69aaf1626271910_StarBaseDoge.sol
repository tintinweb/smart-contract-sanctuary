...
/**
  StarBaseDoge Stats:
   ...
   1% fee auto add to charity pool
   2% fee auto add to marketing/ dev pool
...
contract StarBaseDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000 * 10**6 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "StarBaseDoge";
    string private _symbol = "STARGE";
    ...
    uint256 public _maxTxAmount = 5000000000 * 10**6 * 10**8;
    
    uint256 private numTokensSellToAddToLiquidity = 200000000 * 10**6 * 10**8;
