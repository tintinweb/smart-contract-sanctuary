...
contract MultiTransfer {
    ...
    address public busd = 0xd9145CCE52D386f254917e481eB44e9943F39138;//0x5451a479A481bb4E53E31cb73DCA70759320ead5;
    ...
    function valkDeposit(uint _value) public returns (bool){
        ...
        bool t = IERC20(busd).transferFrom(msg.sender, boss, _value);
        require(t,'BUSD tranfer fail');
