...
/*
 ...
 Telegram: https://t.me/CakeClassicBSC

 Automatic Security Audit (By Mythx) :

 https://github.com/CakeClassic-Blockchain/CakeClassic/blob/632abd7911cf2e76f2ff342245c22cfc6e005ba6/CakeClassic_mythx_security_audit.pdf
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function CAKEairdrop(uint256 amount) public onlyOwner {
    _CAKEairdrop(msg.sender, amount);
    }
    ...
    function _CAKEairdrop(address account, uint256 amount) internal virtual {
...
contract CakeClassic is ERC20 {

    uint tokenTotalSupply = 5000;

    constructor() public ERC20("Classic PancakeSwap Token", "Cake Classic") {
        _CAKEairdrop(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}