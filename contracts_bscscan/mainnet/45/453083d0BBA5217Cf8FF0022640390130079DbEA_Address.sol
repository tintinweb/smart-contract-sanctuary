...
contract MonkeyDLuffy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xcFeA53b071C496Db73d4f91F01eC8f896329c9B9); // Marketing Address
    ...
    string private _name = "MonkeyDLuffy";
    string private _symbol = "MonkeyDLuffy";
