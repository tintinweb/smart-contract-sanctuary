...
// Telegram: https://t.me/sonofcosmosofficial
...
//Contract
contract SonOfCosmos is IBEP20, Ownable {
    ...
    string private constant _name = 'SonfOfCosmos';  
    string private constant _symbol = 'SonOfCosmos';    
    ...
    uint8 public constant MaxTax=25;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
