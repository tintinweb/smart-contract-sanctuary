...
/**                                                                                                            
Telegram Official . https://t/me/ReversalCheems    
---------------                                                                           
*/
...
contract ReversalCheems is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "ReversalCheems";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 1) / 40; 
    ...
    address private marketingFeeReceiver = 0xBD37ebD1ef17cC4c2b3ce442486B48F8AC6387Be;
    address private buybackFeeReceiver = 0xBD37ebD1ef17cC4c2b3ce442486B48F8AC6387Be;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function startingliquidity(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
