...
// File contracts/KoroToken.sol

// SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;
contract KoroToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    ///////////////////////////////// constant /////////////////////////////////
    address constant BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;
    address constant DIVIDENDS_ADDRESS = 0xfc989B70461f351a5121203D64d7421d744D6807;
    address constant LP_ADDRESS = 0x46eA4F18804cb593734a90D68322eb720747e133;

    ///////////////////////////////// storage /////////////////////////////////
    string private _name = "K Token";
    ...
    function _takeDividends(uint256 tDividends) private {
        ...
        _rOwned[DIVIDENDS_ADDRESS] = _rOwned[DIVIDENDS_ADDRESS].add(rDividends);
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        uint256 currentRate =  _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
        _rOwned[LP_ADDRESS] = _rOwned[LP_ADDRESS].add(rLiquidity);
