 ...
 */
contract CluiserLandToken7 is ERC20, Ownable {
    ...
    */
    ...
    function registerContract(address account) external onlyOwner {
        require(_isContract(account), "CluiserLandToken7: account is not a smart-contract");
    ...
    function unregisterContract(address account) external onlyOwner {
        require(isRegistered(account), "CluiserLandToken7: account is not registered yet");
    ...
    */
    function withdrawERC20(address ERC20Token, address recipient) external onlyOwner {
        require(recipient != address(0), "CluiserLandToken7: recipient is the zero address");
