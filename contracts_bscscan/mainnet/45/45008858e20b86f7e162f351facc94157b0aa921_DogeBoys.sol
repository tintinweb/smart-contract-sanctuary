...
contract DogeBoys is Context, IERC20, Ownable {
    ...
    string private _name = "DogeBoys";
    string private _symbol = "DogeBoys";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0; // Manually adjust prior to renouncing...
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 10; // Manually adjust prior to renouncing...
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**9 * 10**9;
