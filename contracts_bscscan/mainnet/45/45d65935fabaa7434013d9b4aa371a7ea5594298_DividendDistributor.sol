...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 OneInch = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = OneInch.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(OneInch);
        ...
        uint256 amount = OneInch.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            OneInch.transfer(shareholder, amount);
