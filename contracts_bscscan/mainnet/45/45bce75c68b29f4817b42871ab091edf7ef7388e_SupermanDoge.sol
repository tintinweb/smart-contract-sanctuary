...
/**
     Welcome to SupermanDoge!
    The most powerfull Doge in Crypton universe!
    to the moon is an easy thing for super dogs to do.

    Fair Launch at 70 Members.  
 
    TOTAL SUPPLY 1,000,000,000,000  
 
    ⚙️ Tokenomics: 
 
    6% SupermanDoge buyback
    3% Cryptonite liquidity
    3% SupermanDoge marketing

    Initial LP will be 1bnb.
    Lock liquidity for 6 month.
    superman doge has a defense system from dump.
    with buyback wallet, superman doge will emit green laser from his eyes!
...
contract SupermanDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SupermanDoge";
    string constant _symbol = "SupermanDoge";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xE8bb9E39e7054BC290fD774319EFa3Cefd6b1298;
