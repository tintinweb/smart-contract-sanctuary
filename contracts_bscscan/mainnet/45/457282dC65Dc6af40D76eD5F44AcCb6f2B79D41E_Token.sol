...
contract Token is IBEP20, Auth {
    ...
    string private _name = 'BabyPikachu';
    string private _symbol = 'BPC';
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals); //1 trillion
    uint256 public _maxWalletAmount = 90 * 10**12 * (10 ** _decimals); //2% of total supply
    uint256 public _maxBuyTxAmount = 90 * 10**12 * (10 ** _decimals); //1% of total supply
    uint256 public _maxSellTxAmount = 50 * 10**10 * (10 ** _decimals); //0.5%% of total supply
