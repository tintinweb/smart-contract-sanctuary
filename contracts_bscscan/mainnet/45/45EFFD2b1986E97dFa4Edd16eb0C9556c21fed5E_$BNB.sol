...
contract $BNB is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x8839d2cd849c58deAcAEC7A60c1d6e16Fa999999;
    ...
    uint256 private numTokensSellToAddToLiquidity = 160000000 * 10**18;
	uint256 private numTokensBurn = 100000000000 * 10**18;
