...
contract DogeMusk is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 750 * 10**9 * 10**9; //750 Billion Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DogeMusk";
    string private _symbol = "DGMUSK";
    ...
    address payable public _marketingWallet = payable(address(0xa776d7A6ccF36Ce6862F3BBFF1948ea9Cd980137));

    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 750 * 10**9 * 10**9;
   ...
   function balanceOf(address account) public view override returns (uint256) {
    ...
    function setMinNumTokensSellToAddToLiquidity(uint256 numTokens) external onlyOwner {
