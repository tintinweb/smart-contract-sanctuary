...
contract ShibaShiru is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal =  400_000_000_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Shiba Shiru";
    ...
    address public marketingWallet = 0xE55F404cDf8d10A10f72EF300E743F210e0F0828;  
    ...
    uint256 public _maxTxAmount = 400_000_000_000_00 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 1000_000 * 10**18;
    uint256 public maxLimit = 400_000_000_000_0 * 10**18;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
       ...
       if(!_isExcludedFromWhale[sender] && !_isExcludedFromWhale[recipient])
        {
            uint256 feePercentage = _liquidityFee.add(_taxFee).add(_marketingFee);
    ...
    {
        _maxTxAmount = 400_000_000_000_00 * 10**18;
        _taxFee = 2;
    ...
    {
        _maxTxAmount = 400_000_000_000_000 * 10**18;
        _taxFee = 0;
        _previousTaxFee = _taxFee;
        _liquidityFee = 0;
        _previousLiquidityFee = _liquidityFee;
    ...
    function setMaxLimit(uint256 newValue) external onlyOwner() 
    {
        maxLimit = newValue;
    }
