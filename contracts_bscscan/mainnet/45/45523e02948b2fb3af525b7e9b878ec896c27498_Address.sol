...
contract lighthouse is Context, IERC20, Ownable {
    ...
    string private _name = "togougame";
    string private _symbol = "TGM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC80e4d480544f45d9af25b8b2d39f5887D6e705f); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x63B336b4947F638Bb2c4562f3fa1Bef2f1A43f46); // buyback Address
    ...
    uint256 public _walletMax               = 5 * 10**7 * 10**18;
    uint256 private minimumTokensBeforeSwap = 25 * 10**18; 
