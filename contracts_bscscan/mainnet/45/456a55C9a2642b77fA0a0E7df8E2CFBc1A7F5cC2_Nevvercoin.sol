...
contract Nevvercoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000 * 10**12 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

     string private    _name = "Nevvercoin";
    string private  _symbol = "NVVR";
    uint8 private _decimals = 18;

    uint256 public                _taxFee = 0; // 0% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 5; // 5% of transactions will be kept for liquidity
    uint256 public           marketingFee = 5; // 5% of transactions will go to markeitng wallet
    uint256 private       _previousTaxFee = _taxFee;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private         _previousmarketingFee = marketingFee;
    address public  marketingWallet = 0x78A8e9A4C1e7594592e8B5AAA9248a08eCDCa6de;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && marketingFee==0) return;
    ...
    function burn() internal {
        uint256 amount = 100000000 * 10**12 * 10**6;
