...
/**
    ...
    * Telegram: https://t.me/GrapeSafeMoon
...
abstract contract TradableErc20 is ERC20 {
    ...
    uint256 constant maxBuyIncrementMinutesTimer = 2; 
    uint256 constant maxBuyIncrementPercentage = 1;
    ...
    function getSellBurnCount(uint256 amount) internal view returns (uint256) {
        ...
        if (amount > vMax) return (amount * 35) / 100;
    ...
    function _getFeeSell(uint256 amount, address account)
        ...
        returns (uint256)
    {
        uint256 devFee = amount / 14;
        uint256 burnCount = getSellBurnCount(amount);
...
contract GrapeSafeMoon is TradableErc20 {
   address _owner;
    address _withdrawAddress =
        address(0x9425C05846e793650594c18d27850028476Ad0f0);
    uint256 maxContractLiquidityPercent = 4;

    constructor() TradableErc20("GrapeSafeMoon", "GSafeMoon") {
        _owner = msg.sender;
        _setMaxBuy(4);
    }
