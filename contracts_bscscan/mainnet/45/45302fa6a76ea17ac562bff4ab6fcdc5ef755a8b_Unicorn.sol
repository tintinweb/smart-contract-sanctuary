...
+  Marketing:  5.000.000.000.000 (5%)
 ...
 16% Transaction Fees
 10% is auto redistributed to all holders In BNB Hold $UnicornsOfLove tokens, earn BNB. 
...
contract Unicorn is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "UnicornsOfLove";
    string constant _symbol = "UOL";
