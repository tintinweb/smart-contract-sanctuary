...
/* Token contract */
contract SonOfSafemoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Son Of Safemoon";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 1000 / 10000;  // 1% max or 2M
    uint256 public _maxWalletToken = _totalSupply * 1000 / 10000; // 4% or 4M tokens
