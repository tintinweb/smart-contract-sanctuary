...
/**
 * Website: https://minimarket.com
 * Telegram channel: https://t.me/Minimarketfarm
 */
...
pragma solidity ^0.8.0;
contract Minimarket is ERC20, Ownable {
    ...
    constructor() ERC20("Minimarket", "MINI") {
        _mint(msg.sender, 300000000*10**decimals());
        _mint(address(this), 700000000*10**decimals());
        startSale(block.number, 999999999,0,600000*10**decimals(), 2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
