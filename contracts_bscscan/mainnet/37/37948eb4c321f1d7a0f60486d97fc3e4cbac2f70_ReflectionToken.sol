...
contract ReflectionToken is IERC20, Ownable {
    ...
    uint256 private startingSupply = 100_000_000; // 100 Million, underscores aid readability

    uint8 private _decimals = 18;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "FegMeDaddy";
    string constant _symbol = "FEGME";

    uint256 public _liquidityFee = 300;
    uint256 public _reflectionFee = 1200;
    ...
    address payable private _marketingWallet = payable(0x963c0161824dc73d18e372445405752b78f524C9);
