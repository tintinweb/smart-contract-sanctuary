...
import "./interfaces/IZoanRouter.sol";
    ...
    ERC721Upgradeable
{
    ...
    function merger(
        ...
        emit Merger(nextTokenId, receiver, tribe, _exp, _dna, _generation);
    }
    ...
    function _transfer(
        ...
        if (router.usersLock(to) || router.tokensLock(tokenId)) {
            revert("locked.");
        }
...
interface IZoanRouter {
    ...
    function managers(address _address) external view returns (bool);
