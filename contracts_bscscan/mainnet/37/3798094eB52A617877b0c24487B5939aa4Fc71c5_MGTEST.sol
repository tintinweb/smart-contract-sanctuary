...
contract MGTEST is Context, IERC20, Ownable {
    ...
    uint256 private constant MinBuy = 0 * 10 ** 6;
    ...
    string private constant _name = "MGTEST";
    string private constant _symbol = "MGTEST";
