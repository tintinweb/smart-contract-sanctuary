...
contract HappyJerry is Context, IBEP20, Ownable {
    ...
    string private _name = "Happy Jerry";
    string private _symbol = "HAPJER";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xb467Aa14AF701Ca9177784AE66D86588F96f1B04, 'We can not exclude Pancake router.');
