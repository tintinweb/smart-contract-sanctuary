...
library Address {
     ...
     * [IMPORTANT]
     * ====
     * Our team was tied - half said the dog's photo will be tweeted, the other half said it wouldn't. The betting is 1000$ 
Team members who guessed will get their money back, and the money of those who didn't will go to one lucky person who will keep the NYE Floki token no matter what.
...
contract NyeFloki is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NYE FLOKI";
    string constant _symbol = "NYEFLOKI";
    ...
    address payable public liquidityFeeReceiver = payable(0x5E90027A05b3f56985fd352472c4f0C720fe6e94);
    address payable public marketingFeeReceiver = payable(0x5E90027A05b3f56985fd352472c4f0C720fe6e94);
    ...
    //NYE FLOKI ONLY THIS ONE IS LEGIT NEW YEAR FLOKI TOKEN!
}