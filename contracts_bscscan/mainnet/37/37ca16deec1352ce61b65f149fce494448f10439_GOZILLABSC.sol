...
contract GOZILLABSC is ERC20 {

    uint tokenTotalSupply = 69000000000000; // 100 Million Token Supply

    constructor() public ERC20("GOZILLA BSC ", "GOZILLABSC") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GOZILLABSC";
    string private _symbol = "GOZILLABSC";
