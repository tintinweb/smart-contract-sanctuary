...
// $RICHCHEEMSINU proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN $RICHCHEEMSINU With the auto-claim feature,
// simply hold $RICHCHEEMSINU and you'll receive Reflections automatically in your wallet.
// 
// Hold RichCheemsInu and get rewarded in $RICHCHEEMSINU on every transaction!
//
//
// 📱 Telegram: https://t.me/RichCheemsInu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC5FEe414d47D305C4D7283809b9d3c3A40b6e4e4;
...
contract RICHCHEEMSINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC5FEe414d47D305C4D7283809b9d3c3A40b6e4e4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "RichCheemsInu";
    string private _symbol = "RICHCHEEMSINU";
