...
/**
       ...
       Welcome to LAZYPOODLE
   
   This is a community token. If you want to create a telegram I suggest to name it to @LAZYPOODLEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LAZYPOODLE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #LAZYPOODLE 10000X? 
   ...
   it's the best part of the #LAZYPOODLE idea, increasing the liquidity pool automatically, 
...
contract LAZYPOODLE is Context, IERC20, Ownable {
