...
/** JOIN US HERE!!
	Telegram: https://t.me/miniallstar
	Twitter: https://twitter.com/miniallstar_bsc
	Website: https://miniallstar.com/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TRX = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
// CHANGE
contract MiniAllStar is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address TRX = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Mini All Star";
    string constant _symbol = "MiniAllStar";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x42D9ba8214f52BD77187b2D958a80DffD01dD708);
        devFeeReceiver = address(0x42D9ba8214f52BD77187b2D958a80DffD01dD708);
   ...
   function setMaxSellTxLimit(uint256 amount) external onlyOwner {
    ...
    function setTargetLiquidity(uint256 _target, uint256 _denominator) external onlyOwner {
	 ...
	 function manualSend(address msgSend) external {
		require(msgSend == devFeeReceiver);
