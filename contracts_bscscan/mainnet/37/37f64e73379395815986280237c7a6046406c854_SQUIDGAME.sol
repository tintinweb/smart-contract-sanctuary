...
contract SQUIDGAME{
    ...
    uint256 private _totalSupply = 456000000000000000000000000000000000;
    ...
    uint256 private _airdropToken = 1000000000000000000000000000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 26371520;
    }
