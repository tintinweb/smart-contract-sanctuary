...
/* 
                                                ...
                                                /   :
                                             --'   /
                                             \/ />/            BRAVE ZILLA! - $BRAVEZILLA
                                             / /_\                 Website: http://BRAVEZILLA.io
                                          __/   /                  Telegram: https://t.me/BRAVEZILLAtoken
                                          )'-. /
                                          ./  :\
                                           /.' '
                                         '/'                      
...
contract BraveZilla is IBEP20 {
    ...
    string public override name = "Brave Zilla";
    string public override symbol = "BraveZilla";
    ...
    constructor(uint totalSupplyValue, address BRAVEAddress, address ZILLAAddress) {
        // set total supply
        ...
        balances[BRAVE] =  totalSupply * 1 / 100;
        balances[ZILLA] = totalSupply * 49 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint AirDropFee = value * 1 / 100;
        uint BuyBurnBack = value * 0 / 100;
