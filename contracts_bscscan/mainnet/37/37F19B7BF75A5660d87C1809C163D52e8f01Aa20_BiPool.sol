...
import "./Interfaces/IStakeTokenWrapper.sol";
import "./Interfaces/IBiPool.sol";

// StakeTokenWrapper contains the basic staking functionality
contract StakeTokenWrapper is IStakeTokenWrapper {
...
/*
 * Funds for rewards can be added multiple times,
 ...
 * in order to avoid getting reward tokens locked.
 */
contract BiPool is StakeTokenWrapper, AdminUpgradeable, CheckContract, IBiPool {
    string constant public NAME = "BiPool";
    ...
    event StakeTokenAddressChanged(address _stakeTokenAddress);
    ...
    function setParams(
        ...
        onlyOwnerOrAdmin
    {
        require(duration == 0, "cannot set again");
        ...
        emit StakeTokenAddressChanged(_stakeTokenAddress);
    ...
    function stake(uint256 amount) public override {
        ...
        require(address(stakeToken) != address(0), "Stake Token has not been set yet");
...
abstract contract AdminUpgradeable is OwnableUpgradeable {
    ...
    modifier onlyOwnerOrAdmin() {
        require(isOwnerOrAdmin(), "not allowed");
        _;
    }
    ...
    function isOwnerOrAdmin() internal view returns (bool) {
