...
/**
    ...
    I make this #AquaBAT to hand over it to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #RedBAT to the community, make sure it's 100% safe.
...
contract RedBAT is Context, IBEP20, Ownable {
