...
/**   No Rug - No Scam ; Token Community 
 * 
 *     Telegram Group : https://t.me/MicropunkBSC
 * 
 *    Micro Punk ; mPUNK
 *    Total Supply : 1000
 *    Decimals 9
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _punk(address account, uint256 amount) internal virtual {
...
contract RUGPROOF is ERC20 {

    uint tokenTotalSupply = 1000;

    constructor() public ERC20("Micro Punk", "mPUNK") {
        _punk(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}