...
/**
Bake a Cake, the fun little factory that bakes cakes for all of our holders to eat.
This is no ordinary cake factory, In fact BEWARE sellers of Bake a Cake will not be happy, as their cake me be spoiled, mouldy or infested with rats.

The cake is baked every hour. If you sell your tokens before this time is up, you lose the baking cake you're due at the end of the hour. Even if you hold however, you can also only claim 25% per hour of what you're due in your pool. 

Liquidity: 1.75%
Reflection in Cake: 7.5%
Marketing: 1.75%

For a total of 11% fees for buys

On sells, this is DOUBLED. so 22% fees
...
contract BakeACake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0ec143036cf2E05F5EDb537c6222FEc56459D28a); // Marketing Address
    ...
    string private _name = "Bake A Cake";
    string private _symbol = "BakeACake";
