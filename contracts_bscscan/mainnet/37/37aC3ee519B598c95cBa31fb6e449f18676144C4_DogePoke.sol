...
contract DogePoke is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogePokeUltra";
    string constant _symbol = "PDOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (9 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 2000000000000; // 2%
    ...
    function triggerRelaxoBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
