...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BabyHolo
...
contract BabyHolo is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Holo";
    string private _symbol = "BabyHot";
