...
/**
 ...
 > #RFI+#DOGE combine together to create $nDOGE designed

 10% DogeCoin rewards distributed automatically every hours

 1% Buy Back | 3% Liquidity | 4% Marketing
 3% Max Buy | 10% Max Wallet
 90% burnt to the black hole, with such big black hole the strong holder will get a valuable reward
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BDOGE = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BDOGE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BDOGE);
        ...
        uint256 amount = BDOGE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BDOGE.transfer(shareholder, amount);
...
contract nanoDOGE is IBEP20, Auth {
    ...
    address BDOGE = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NanoDoge";
    string constant _symbol = "nDOGE";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**6 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 10 / 100; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xCb34696a8ca5DD9deDc4C60C2b8a100fA77f5341;
