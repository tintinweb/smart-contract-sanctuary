...
contract MEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meo.tools";
    string private constant _symbol = "MEO";
    ...
    uint256 public _maxTxAmount = 1.25 * 10**5  * 10**_decimals; // 125,000
    uint256 public numTokensSellToAddToLiquidity = 1 * 10**6 * 10**_decimals; // 0.1%
