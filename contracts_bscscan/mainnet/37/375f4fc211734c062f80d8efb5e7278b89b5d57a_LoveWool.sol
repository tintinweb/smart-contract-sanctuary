...
Telegram: https://t.me/lovewool

Twitter: https://twitter.com/LoveWoolBSC
...
contract Context {
 ...
 contract LoveWool is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "LoveWool";
    string private _symbol = "LOVEWOOL";
    ...
    address private _Ownership = 0x3aC8f128E7a44c099BDBD0d1F33Ba72bdB4FbCE9; //Onwership
