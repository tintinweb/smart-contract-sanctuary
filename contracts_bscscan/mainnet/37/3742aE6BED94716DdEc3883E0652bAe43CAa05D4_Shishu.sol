...
contract Shishu is IBEP20, Auth {
    ...
    string constant _name = "Shishu";
    string constant _symbol = "SHSU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 _burntSupply = (_totalSupply * 10) /100;
    uint256 _liqSupply = (_totalSupply * 80) /100;
