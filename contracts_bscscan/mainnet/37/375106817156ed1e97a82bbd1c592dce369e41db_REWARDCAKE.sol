...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also REWARDCAKEed.
...
// File: contracts/REWARDCAKEDividendPayingToken.sol
...
contract REWARDCAKE is ERC20, Ownable {
	...
	address payable public MarketingWallet = payable(0x9d078189Cd913430900ad79ceb23faF52Cf3Ae66); // Marketing Address
    ...
    constructor() ERC20("REWARDCAKE", "REWARDCAKE") {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != PancakeSwapV2Pair, "REWARDCAKE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "REWARDCAKE: The liquidity wallet is already this address");
    ...
    function _transfer(
       ...
       if(from != owner()){
        ...
        if(!tradingOpen) {
            require(canTransferBeforetradingOpen[from], "REWARDCAKE: This account cannot send tokens until trading is enabled");
        }
...
contract REWARDCAKEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("REWARDCAKE_Dividend_Tracker", "REWARDCAKE_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(true, "REWARDCAKE_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1 && newClaimWait <= 86400, "REWARDCAKE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
