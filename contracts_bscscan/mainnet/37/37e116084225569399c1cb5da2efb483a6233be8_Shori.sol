...
contract Shori is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shori Inu";
    string private _symbol = "Shori";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2aF9C4D7C3295C350F4E73FBf097a18c3bd5333F); // Marketing Address
    address payable private buyBackWalletAddress = payable(0x2aF9C4D7C3295C350F4E73FBf097a18c3bd5333F); // buyback Address
    ...
    uint256 public _walletMax = 50000000000000 * 10**9; // 3%
