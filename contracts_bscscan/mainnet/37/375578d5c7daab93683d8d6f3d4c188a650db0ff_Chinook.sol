...
contract Chinook is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CHINOOK";
    string constant _symbol = "CHINOOK";
    ...
    uint256 public _maxTxAmount = 500 * 10**3 * (10 ** _decimals);
    uint256 public _walletMax = 500 * 10**3 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xc90791d5037c5b0c6cf6088aF462476d67Ea4af6;
        devWallet = 0xc90791d5037c5b0c6cf6088aF462476d67Ea4af6;
