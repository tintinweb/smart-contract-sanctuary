...
contract IDO is Ownable, ReentrancyGuard {
    ...
    function setFeeAddress (address _address) public onlyOwner {
     ...
     function setTokens(IERC20 _usdt,IERC20 _token) public onlyOwner {
        USDT = _usdt;
        idoToken = _token;
    }
    ...
    function setIgoAmount(IERC20 _usdt,IERC20 _token,uint256 _minAmount,uint256 _maxAmount,uint256 _price) public onlyOwner {
        USDT = _usdt;
        idoToken = _token;
        minAmount = _minAmount;
        maxAmount = _maxAmount;
