...
contract Ownable is Context {
    address private _owner = 0x8795c74edb3169aF58f2DBF3ba7a44Ce8C9a6561;
...
contract UNO1DOG is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x81F15F5f4189BEc7a61B8B6ca2A779cBc1bBFfcC); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "universe no1 dog"; // token name
    string private _symbol = "UNO1DOG"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback =  15 days; // duration betweeen each buyback
    ...
    uint256 public _marketingBNBFee = 100; // marketing BNB fee
