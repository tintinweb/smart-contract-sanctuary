...
contract FarmCupCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    FarmCupCakeDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x46c019673336A2AeE68Fd3FeF8429E8900Fe5938;
    ...
    constructor() public ERC20("FarmCupCake", "FARMCAKE") {

    dividendTracker = new FarmCupCakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        FarmCupCakeDividendTracker newDividendTracker = FarmCupCakeDividendTracker(payable(newAddress));
    ...
    function setAutomatedMarketMakerPair(address _pair, bool value) public onlyOwner {
        require(_pair != pair, "Token: The pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address _pair, bool value) private {
        require(automatedMarketMakerPairs[_pair] != value, "Token: Automated market maker pair is already set to that value");
...
dividendTracker.processAccount(msg.sender, false);
    ...
    function _transfer(
        ...
        if(amount == 0) {
         ...
         if (to == pair && !_isExcludedFromFees[from]) 
        {
...
contract FarmCupCakeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("FarmCupCake_Dividend_Tracker", "FarmCupCake_Dividend_Tracker") {
    claimWait = 3600;
