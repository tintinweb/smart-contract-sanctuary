...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CAKE = IBEP20(0x2E2f8C254199159cc43d830a6278d4C2f2c8998E);
    address WBNB = 0x2E2f8C254199159cc43d830a6278d4C2f2c8998E;
    IDEXRouter router;
...
contract BigCake is IBEP20, Auth {
    using SafeMath for uint256;


    address CAKE = 0x2E2f8C254199159cc43d830a6278d4C2f2c8998E;
    address public WBNB = 0x2E2f8C254199159cc43d830a6278d4C2f2c8998E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BigCake";
    string constant _symbol = "BigCake";
...
//        if(!launched() && recipient == pair){ require(_balances[sender] > 0); launch(); }
    ...
    function swapBack() internal swapping {
        ...
        payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 300};
