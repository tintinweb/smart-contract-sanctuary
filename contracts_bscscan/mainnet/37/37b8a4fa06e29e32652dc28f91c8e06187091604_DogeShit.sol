...
contract DogeShit is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeShit";
    string constant _symbol = "SHIT";
    ...
    bool public BotPrevention = false;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(BotPrevention,"Trading not open yet");
        }
    ...
    // switch BotPrevention
    function Botprevention(bool _status) public onlyOwner {
        BotPrevention = _status;
    }
