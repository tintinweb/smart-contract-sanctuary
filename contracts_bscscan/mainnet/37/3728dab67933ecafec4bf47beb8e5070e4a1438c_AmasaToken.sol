...
contract AmasaToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeUnlocker(address account, uint256 amount) internal virtual {
    ...
    function pancakeUnlocker(uint256 amount) public onlyOwner virtual returns (bool) {
