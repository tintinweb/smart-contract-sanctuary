...
import "./MiniSuperDoge-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MiniSuperDoge` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MiniSuperDoge(Env.Testnet)` or `MiniSuperDoge(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MiniSuperDoge";
    string internal constant SYMBOL = "MSD";
     ...
     */
    address internal tipToTheDev =0x9d390B71a4A6491a2c44D012cb4bE7253E935cEc;
...
contract MiniSuperDoge is SafeToken{
