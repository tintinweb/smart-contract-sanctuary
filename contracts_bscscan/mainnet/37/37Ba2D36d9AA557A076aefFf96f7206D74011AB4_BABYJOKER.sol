...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also BABYJOKERed.
...
// File: contracts/BABYJOKERDividendPayingToken.sol
...
contract BABYJOKER is ERC20, Ownable {
    ...
    constructor() ERC20("BABY JOKER", "BABYJOKER") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "BABYJOKER: The new dividend tracker must be owned by the BABYJOKER token contract");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != PancakeSwapV2Pair, "BABYJOKER: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BABYJOKER: The liquidity wallet is already this address");
    ...
    function _transfer(
       ...
       if(from != owner()){
        ...
        if(!tradingOpen) {
            require(canTransferBeforetradingOpen[from], "BABYJOKER: This account cannot send tokens until trading is enabled");
        }
...
contract BABYJOKERDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BABYJOKER_Dividend_Tracker", "BABYJOKER_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(true, "BABYJOKER_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1 && newClaimWait <= 86400, "BABYJOKER_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
