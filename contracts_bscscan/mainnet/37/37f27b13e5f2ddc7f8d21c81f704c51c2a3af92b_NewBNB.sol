...
contract NewBNB is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 2888 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 0 * 10 ** 9;
    uint256 MAX_LOCK   = 888 * 10 ** 9;
    ...
    constructor() ERC20("NewBNB", "NBNB") {
        addressForMarketing =address(0xe83e0234D7FD639EC6bC7B4BaE5195Bb740D6d2e);
