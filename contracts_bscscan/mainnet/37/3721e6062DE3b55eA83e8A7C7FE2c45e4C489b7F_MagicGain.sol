...
/**
                                      ...
                                      Welcome to Magic Gain ($MG)  

 
Telegram: 

Magic Gain is created by an experienced team of developers and managers who have supported and worked with numerous projects in the BSC space.

Our team’s focus is delivering and maintaining high quality standards and treat our Magic Gain’s community as our #1 asset
...
contract MagicGain is Context, ERC20Detailed, Ownable {
  ...
  string constant tokenName = "Magic Gain";
  string constant tokenSymbol = "MG";
