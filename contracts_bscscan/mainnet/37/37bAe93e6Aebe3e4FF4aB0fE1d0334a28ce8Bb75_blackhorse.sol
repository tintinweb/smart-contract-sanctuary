...
*╚═════╝ ╚══════╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝╚══════╝
                    ...
                    * only 6% buy fee,8% sell fee
                    * renounceOwnership
                    * LP locked 
                    
                    telegram: t.me/BlackHorseGlobal
...
contract blackhorse is Context, IERC20, Ownable {
    ...
    string private _name = "BlackHorse";
    ...
    address public burnAddress = address(0x7f27eC6E45e627C146dCd7092968dE2f83f402F7);
    address public shoubiAddres = address(0x7f27eC6E45e627C146dCd7092968dE2f83f402F7);
    ...
    constructor () public {
        ...
        _isExcludedFromFee[shoubiAddres] = true;
        _isExcludedFromFee[burnAddress] = true;
        _isExcludedFromFee[address(this)] = true;

        emit Transfer(address(0),shoubiAddres, _tTotal);
    }
