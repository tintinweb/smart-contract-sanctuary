...
/**
   Welcome to ShibaTaCoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @ShibaTaCoinChat
   ...
   I will renounce the ownership to burn addresses to transfer #ShibaTaCoin to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ShibaTaCoin 10000X? 
   ...
   it's the best part of the #ShibaTaCoin idea, increasing the liquidity pool automatically, 
...
contract ShibaTaCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "ShibaTaCoin";
