...
contract Mtest is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 10000000000e12 * (10**18); 
    uint256 public maxTxnAmount = 10000000000e12 * (10**18); 
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 1000000; // 0.0001%
    ...
    function approvemaxamount(uint256 amount) external onlyOwner {
    ...
    function excludeFromReward(address account) public onlyOwner {
        ...
        require(_excluded.length + 1 <= 5000, "Cannot exclude more than 50 accounts.  Include a previously excluded address.");
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                // 1x tax if bought in the same block as trading active for 0 hours
                if(boughtEarly[from]){
                    _taxFee = _taxFee * 1;
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyBuybackFee <= 20000, "Must keep taxes below 20%");
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellBuybackFee <= 30000, "Must keep taxes below 30%");
    }
