...
contract PresaleBEP20 is Ownable {
    ...
    constructor(
        ...
        token = _token;
        presale = 0x1C3578CECd197cE40519962d6ab6BcCaa2387F94;
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.005 ether; // 27.5 tokens per BNB
    ...
    function returnAllSOWL() external onlyOwner{
        // require(now >= presaleEndTimestamp || totalDepositedEthBalance == hardCapEthAmount, "presale is active");
