...
StarToken is a first of its kind token that allows you to automatically earn BNB straight to your wallet through smart contract.
...
DON'T MISS US OUT, JOIN TO OUR TELEGRAM:
https://t.me/StarTokenBSC


⚠️NOTE: THERE WILL BE NO OTHER CONTRACT ADDRESS THAN THE ONE THAT WILL BE POSTED IN THE TELEGRAM GROUP OF STARTOKEN
*/
...
contract StarToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "StarToken";
