...
contract SHIBACOLA is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x72c0F1b662ff48Af6fb798BF9D36E3486a71695C); // Marketing Address
    ...
    string private _name = "SHIBA COLA";
    string private _symbol = "SHIBACOLA";
