...
contract NFTToken is Ownable, ERC721 {
    ...
    {
        require(mintApproved[msg.sender] , "Not Authorized" );
  ...
  function _setMetDataURI(string memory _metaDataURI) public onlyOwner {
   ...
   function changeMintingStatus(address _approver, bool status) onlyOwner external {
