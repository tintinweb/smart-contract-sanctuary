...
contract MB is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Metabom';
    ...
    uint256 private     _TAX_FEE = 100; // 4% BACK TO HOLDERS
    uint256 private    _BURN_FEE = 100; // 4% BURNED
    uint256 private _CHARITY_FEE = 500; // 3% TO CHARITY WALLET
