...
contract DJAV is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Defi JAV';
    string  private constant _SYMBOL = 'DJAV';
    ...
    uint256 private _MAX_TX_SIZE = 1000000 * _DECIMALFACTOR;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'We can not exclude PancakeSwap Router v2.');
