...
contract BABYSHIBARISE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x206C23CC6c4046f7cE36EbBdF7cbaeDA12E87833); // Marketing Address
    ...
    string private _name = "BABYSHIBA RISE";
    string private _symbol = "BABYSR";
