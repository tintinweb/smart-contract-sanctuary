...
t.me/SuperUltraHyperMegaMetaLiquidity
by @STEALTHSxSELENE
15% lp tax
...
/* Token contract */
contract SuperUltraHyperMegaMetaLiquidity is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x89c75587CaF6585BD8D802b03Db7cD045F5bfa90;
    ...
    // Name and symbol
    string constant _name = "SuperUltraHyperMegaMetaLiquidity";
    string constant _symbol = "WET";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 600 / 10000; // 6%
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 3%
    uint256 public _maxWalletToken = ( _totalSupply * 600 ) / 10000; // 6%
    ...
    // Buy Fees
    uint256 public liquidityFeeBuy = 1500;
  ...
  // Sell fees
    ...
    uint256 public marketingFeeSell = 1800;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA2abb0040959F7C84412CD106595ceA7eDfd2C3f;
