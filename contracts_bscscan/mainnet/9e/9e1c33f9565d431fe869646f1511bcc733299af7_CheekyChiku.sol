...
CheekyChiku is a stealth launched low tax token and community-driven. Buy $CHCK and hold, your token will grow in every transaction.
Telegram. https://t.me/CheekyChiku
*/
...
contract CheekyChiku is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CheekyChiku";
