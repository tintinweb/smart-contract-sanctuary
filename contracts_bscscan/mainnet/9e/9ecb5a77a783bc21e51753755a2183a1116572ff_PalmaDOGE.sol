...
/**
 *🛎 Welcome to PalmaDOGE ($PALDOG) ! 💥
Welcome to [PALMA] Ecosystem  !!!
- [PALMA] is a streak-project paves the way for a series of projects we will carry out in the next 3 years

Stage 1: PalmaDOGE is the new project which paves the way for a series of projects we will carry out in the next 3 years.
With unlimited marketing budget & clearly roadmap, we will synchronize the features of traditional and new scheme. 
First time in your life, you will experience a new chain of features from Stake/Farm,NFT Game/Marketplace, Jackpot,
Swapmarket , App, Launchpad, and finally Blockchain as the way DOGECoin did. 

Stage 2: PalmaSwap will become Next-G with many outstanding feature.
 Start at the middle of November, launching new NFT Market feature where everybody can freely trade their own design, 
 fulfill your creativity and generate high profits.

Stage 3: PalmaLAND – we call it a special feature nowhere found in other projects will release on January 2022
Start with Child DOGE, you will use your NFT cards which owned to attack Zombies and get EXP & PalmaDOGE Coin
You can upgrade your DOGE and buy items to increase power.

Stage 4: PalmaAPP & Blockchain. Start on June, 2022, we will make a detail introduction once PalmaAPP has been launched
Join PalmaDOGE family at here : t.me/palmadogecoin 
...
contract PalmaDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = payable(0x818A6744563D05940609C586aceb2Dcf00932498); // Charity Address
    ...
    string private _name = "PalmaDOGE";
    string private _symbol = "PALDOG";
    ...
    uint256 public buyBackSellLimit = 500 * 10**9;
