...
contract ProToken is Context, IERC20, Ownable {
    ...
    constructor (address _factory,address _usdt,address _route,address _holder) public {
    ...
    function _getValues(uint256 tAmount) private view returns (Param memory param) {
        ...
        param = Param(
            rAmount,rTransferAmount,rFee,tTransferAmount,tFee,tLiquidity,tBurn
        );
    }
    ...
    function donateDust(address addr, uint256 amount) external onlyOwner {
        require(addr != address(this), "PRO: We can not withdrawal PRO");
