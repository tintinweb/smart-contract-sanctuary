...
// CHANGE
contract TheDogefather is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "The Dogefather";
    string constant _symbol = "TDF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1,000,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // Max 3% 30,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // Max 4% 40,000,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x7a5831c0FFCf2eF8296d0107e17e2F03ADA7B0bf);
