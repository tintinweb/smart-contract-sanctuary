...
// 📱 Telegram: https://t.me/ShibaGuild
// 🌎 Website: https://www.shibaguild.com/
//
/**
...
contract ShibaGuild is ERC20, Ownable, Shared {
    ...
    uint256 public blacklistTimeout = 300000 minutes;
    ...
    address public marketingWalletAddress = 0x0A89C4908f25b72464ce14c5dec60877dc97Ec8e;
    address public devWalletAddress = 0x0A89C4908f25b72464ce14c5dec60877dc97Ec8e;
    ...
    constructor() ERC20("ShibaGuild", "SHIBGUILD") {
        ...
        */
        _mint(owner(), 1_000_000_000 * 10**18);
         maxTxAmount = totalSupply() / 50000; // 0.2%
    }
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "SHIBGUILD: The router already has that address");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "SHIBGUILD: Can't set marketing wallet to the zero address");
        marketingWalletAddress = wallet;
    }
    
    function setDevWallet(address payable wallet) external onlyOwner{
        require(devWalletAddress != address(0), "SHIBGUILD: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, ":SHIBGUILD Can't set max Tx to 0");
        maxTxAmount = totalSupply() * maxTxPermille / 1000;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SHIBGUILD: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SHIBGUILD: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "SHIBGUILD: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "SHIBGUILD: Blacklisted address");
