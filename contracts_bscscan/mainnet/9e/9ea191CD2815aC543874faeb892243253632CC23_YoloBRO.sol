...
contract YoloBRO is Context, IERC20, Ownable {
    ...
    uint256 private constant MinimumBuy = 0 * 10 ** 9;
    ...
    string private constant _name = "YoloBRO";
    string private constant _symbol = "YoloBRO";
