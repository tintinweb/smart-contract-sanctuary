...
contract HUMMER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HUMMER";
    string private _symbol = "HUMMER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x093e2d14aC230A7bEBAAa3902Cf83d457793149D); // Marketing Address
