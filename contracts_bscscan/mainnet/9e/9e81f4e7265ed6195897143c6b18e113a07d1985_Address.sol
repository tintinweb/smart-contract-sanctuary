...
contract OKUU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public devWallet = payable(0xBE769dDB70D9f9E252A3576Cf6DfF3c5F1bbebe7); // dev wallet Address
    address payable public marketingWallet = payable(0xf92Ab8ab8D5A2Faae4C0C8feC98f6CF3992ccc4B); // marketing Address
    ...
    string private _name = "OKUU";
    string private _symbol = "OKU";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap 
    {
        ...
        transferToAddressETH(devWallet, ethForCharity);
