...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e0b7A7fBbfecccA16Ea412c4139A67845B5015C;
...
contract LAMBOCHEEMS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA39c6e4bC577869a8D96a677967A929c7A81E02E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LAMBO CHEEMS";
    string private _symbol = "LCHEEMS";
