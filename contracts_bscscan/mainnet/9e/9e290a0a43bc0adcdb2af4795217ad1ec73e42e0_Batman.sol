...
contract Batman is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Batman";
    string constant _symbol = "BTMAN";
    ...
    uint256 public BuyFee = 50; //  buy 
    uint256 public totalFee = 50; //  sell 
    ...
    constructor ()  {
        address marketingFeeReceiver = 0xcb0DAf24F8A973EDD2695bC65b15ef86c47d9400;
         owner = msg.sender;
