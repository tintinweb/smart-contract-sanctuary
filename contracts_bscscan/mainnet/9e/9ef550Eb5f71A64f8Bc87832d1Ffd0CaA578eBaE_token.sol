...
contract token is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x19d0B53fB33bf14cfD8A76d2642e80641f4Ab100;
	
	address private _burnWalletAddress = 0x000000000000000000000000000000000000dEaD;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 88888 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Rich Yfi";
    string private _symbol = "Rich Yfi";
    ...
    uint256 private numTokensSellToAddToLiquidity = 0.016 * 10**18;
	uint256 private numTokensBurn = 30000 * 10**18;
