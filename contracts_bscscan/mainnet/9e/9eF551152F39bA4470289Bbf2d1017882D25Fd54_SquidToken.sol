...
contract SquidToken is ERC20PresetMinterPauser, ERC20Capped, Ownable {
    constructor() public ERC20PresetMinterPauser("SquidSwap Token", "SQUID") ERC20Capped(1000000000*10**18) {
        _mint(0xBeaD00eCB6B7C1fCc761842e54A1B37e7a4bF8e8, 100*10**18);
    }
    ...
    {
            Updater();
            return (stakes[_stakeholder] / 10000000 * update());
    }
