...
//    ____  _______    __  _______  _   ______     ____  ____  ____________
//   / __ \/  _/   |  /  |/  / __ \/ | / / __ \   / __ \/ __ \/ ____/ ____/
//  / / / // // /| | / /|_/ / / / /  |/ / / / /  / / / / / / / / __/ __/   
// / /_/ // // ___ |/ /  / / /_/ / /|  / /_/ /  / /_/ / /_/ / /_/ / /___   
///_____/___/_/  |_/_/  /_/\____/_/ |_/_____/  /_____/\____/\____/_____/   
                                                                         

//
// DIAMONDDOGE proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN BITCOIN! With the auto-claim feature,
// simply hold DIAMONDDOGE and you'll receive $BTC automatically in your wallet.
// 
// Hold $DDOGE and get rewarded in $BTC on every transaction!
//
//
// 📱 Telegram: https://t.me/diamonddoge
//
...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
contract DiamondDOGE is ERC20, Ownable {
    ...
    constructor() ERC20("Diamond Doge", "DDOGE") {
    	...
    	operationsWallet = address(0xbc9F498cab7BE3CFB2e5b63C89DeEF2B77f071AB);
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the DiamondDOGE token contract");
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        uint256 devAmt = address(this).balance / 20;
