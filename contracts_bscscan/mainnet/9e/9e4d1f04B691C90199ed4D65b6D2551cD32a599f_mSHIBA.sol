...
/**
 *
 Mochishiba ( mSHIBA ) www.mochishiba.online
    Game Metaverse
    NFT
    T-shirt...
    Airdrop 
...
Auto generated token from website : https://novero.io/app/token
   Welcome 2022 $mSHIBA Tokenomics:
   Total supply: 2.022.197.385.460 $mSHIBA
   Burn: 10% upon Public Sales : 202,219,738,546 $mSHIBA
   Burn: 25% after 2 weeks : 505,549,346,365 $mSHIBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x01b0A3E1aB43FaC193830445b2aA5Fd358fd8790;
...
contract mSHIBA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =  0xD437CE3600acfD47d1C61eC2d13E155cBb4b4732;  uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2022197385460 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Mochi Shiba Inu";
    ...
    uint256 public _maxTxAmount = 2022197385460 * 10**18;
