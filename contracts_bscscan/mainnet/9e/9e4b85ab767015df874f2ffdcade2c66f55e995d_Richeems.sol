...
https://t.me/RicheemsOfficial

5% fee auto add to the liquidity pool to locked 
2% fee auto distribute to all holders
5% marketing fee destinated to help the project

I will lock LPs and extend as project grows.
I will renounce the ownership to burn addresses to transfer $Richeems to the community, make sure it's 100% safe.

100,000,000,000,000,000 total supply
1,000,000,000,000,000 FomoCheems max limit for trade
...
pragma solidity ^0.6.12;
    ...
    contract Richeems is Context, IERC20, Ownable {
        ...
        string private _name = 'Richeems';
        string private _symbol = '$Richeems';
        ...
        uint256 private _maxTxAmount = 50000000000000000000000000000000000000e9;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeFormarketing = 5 * 10**6 * 10**9;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if (sender != owner() && recipient != owner() && recipient !=address(this)&& recipient != uniswapV2Pair && recipient != _marketingWalletAddress) {
            require(balanceOf(recipient) + amount <= _maxWalletSize, "Transfer amount exceeds the bag size.");
            }
