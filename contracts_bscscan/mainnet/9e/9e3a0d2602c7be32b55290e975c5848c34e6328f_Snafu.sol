...
contract Snafu is ERC20, Ownable {
	using SafeMath for uint256;
	...
	CustomTaxPeriod private _launch1 = CustomTaxPeriod('launch1',3,0,2,100,1,0,3,0,2,0,4,0);
	CustomTaxPeriod private _launch2 = CustomTaxPeriod('launch2',0,3600,2,3,1,15,3,3,2,2,4,7);
	...
	event DividendTokensChange(address[] newValue, address[] oldValue);
	...
	//Launch2 Fees
	function setLaunch2FeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _buyBackFeeOnBuy,uint256 _charityFeeOnBuy,uint256 _holdersFeeOnBuy) public onlyOwner {
		_setCustomBuyTaxPeriod(_launch2, _liquidityFeeOnBuy, _marketingFeeOnBuy, _buyBackFeeOnBuy, _charityFeeOnBuy, _holdersFeeOnBuy);
		emit FeeChange('launch2Fees-Buy', _liquidityFeeOnBuy, _marketingFeeOnBuy, _buyBackFeeOnBuy, _charityFeeOnBuy, _holdersFeeOnBuy);
	}
	function setLaunch2FeesOnSell(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell, uint256 _buyBackFeeOnSell,uint256 _charityFeeOnSell, uint256 _holdersFeeOnSell) public onlyOwner {
		_setCustomSellTaxPeriod(_launch2, _liquidityFeeOnSell, _marketingFeeOnSell, _buyBackFeeOnSell, _charityFeeOnSell, _holdersFeeOnSell);
		emit FeeChange('launch2Fees-Sell', _liquidityFeeOnSell, _marketingFeeOnSell, _buyBackFeeOnSell, _charityFeeOnSell, _holdersFeeOnSell);
	}
	//Launch3 Fees
	function setLaunch3FeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _buyBackFeeOnBuy,uint256 _charityFeeOnBuy, uint256 _holdersFeeOnBuy) public onlyOwner {
		_setCustomBuyTaxPeriod(_launch3, _liquidityFeeOnBuy, _marketingFeeOnBuy, _buyBackFeeOnBuy, _charityFeeOnBuy, _holdersFeeOnBuy);
		emit FeeChange('launch3Fees-Buy', _liquidityFeeOnBuy, _marketingFeeOnBuy, _buyBackFeeOnBuy, _charityFeeOnBuy, _holdersFeeOnBuy);
	}
	function setLaunch3FeesOnSell(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell, uint256 _buyBackFeeOnSell,uint256 _charityFeeOnSell, uint256 _holdersFeeOnSell) public onlyOwner {
		_setCustomSellTaxPeriod(_launch3, _liquidityFeeOnSell, _marketingFeeOnSell, _buyBackFeeOnSell, _charityFeeOnSell, _holdersFeeOnSell);
		emit FeeChange('launch3Fees-Sell', _liquidityFeeOnSell, _marketingFeeOnSell, _buyBackFeeOnSell, _charityFeeOnSell, _holdersFeeOnSell);
	}
	// Golden Hour 1 Fees
	...
	function claimBNBOverflow(uint256 amount) external onlyOwner {
	    require(amount < address(this).balance, "Snafu: Cannot send more than contract balance");
	...
	function _adjustReflectionToken() private {
		...
		uint256 currentTimestamp = !isTradingEnabled && _tradingPausedTimestamp > _launchStartTimestamp  ? _tradingPausedTimestamp : _getNow();
		if (currentTimestamp.sub(_dividendTokenTimestamp) >= dividendTokenCycleInDays.mul(86400)) {
			if (dividendTokenIndex.add(1) < dividendTokens.length) {
				dividendTokenIndex = dividendTokenIndex.add(1);
			} else {
