...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x401867Bb899950F5b34C8ed70e5646441b88b03B;
...
contract BuffDiglett is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0x1380C0DB20a6F090b2195Ff1d100800D20AEe453);
    address payable private Wallet_Token_Burn = payable(0xBaa8c413DC8b7247E0732d4796D5b26FDab4531d);
    address payable private Wallet_Dev = payable(0xBaa8c413DC8b7247E0732d4796D5b26FDab4531d);
    ...
    string private _name = "Buff Diglett"; 
    string private _symbol = "BUDIG";  
