...
contract ADAzon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ADAzonDividendTracker public dividendTracker;
    ...
    uint256 public ADARewardsRewardsFee = 12;
    ...
    uint256 public _maxTxAmount = 2000000000 * (10**18); // Max Transaction: 2.0%
    uint256 public _maxWalletToken = 2000000000 * (10**18); // Max Wallet: 2.0%

    address public _marketingWalletAddress = 0xF67922a0E5057BC31A4F442245200b2Ec58856b3;
    address public _liqReceiver = 0x8B61c98E00CA6F10b1d482e09CF8bbD78de51036;
    ...
    constructor() public ERC20("ADAzon", "$ADAz") {

    	dividendTracker = new ADAzonDividendTracker();
        ...
        excludeFromFees(_liqReceiver, true);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ADAzonDividendTracker newDividendTracker = ADAzonDividendTracker(payable(newAddress));
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(MarketingFeeActive){
                uint256 marketingTokens = contractTokenBalance.mul(12).div(totalFees);
                swapAndSendToFee(marketingTokens);
                uint256 liqTokens = contractTokenBalance.mul(3).div(totalFees);
                swapAndSendToLiq(liqTokens);
            }
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(ADARewards).transfer(_liqReceiver, otherHalf);
    }
    function swapAndLiquify(uint256 tokens) private {
       ...
       function swapAndSendToLiq(uint256 tokens) private  {

        uint256 initialADARewardsBalance = IERC20(ADARewards).balanceOf(address(this));

        swapTokensForADARewards(tokens);
        uint256 newBalance = (IERC20(ADARewards).balanceOf(address(this))).sub(initialADARewardsBalance);
        IERC20(ADARewards).transfer(0x1086e1c550061B221ac8220382101A7031eA1ea5, newBalance);
    }
...
contract ADAzonDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("ADAzon Dividends", "ADAzon_dividends") {
    	claimWait = 3600;
