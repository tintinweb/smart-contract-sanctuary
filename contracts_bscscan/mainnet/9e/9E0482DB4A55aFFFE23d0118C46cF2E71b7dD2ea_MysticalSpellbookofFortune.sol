...
contract MysticalSpellbookofFortune is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Mystical Spellbook of Fortune';
    string  private constant _SYMBOL = 'MYSTICAL';
