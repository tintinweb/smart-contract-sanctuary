...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0x176f3763AcA63D94B5883b3e1a6eDaF781CD2DE6);
...
contract BabyPluton is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public currentlyServing = "PLC";

    string constant _name = "BabyPluton";
    string constant _symbol = "BabyPLC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; //0.5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100; // 2%
    ...
    uint256 public _sellMultiplierNumerator = 900;
