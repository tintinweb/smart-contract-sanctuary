...
contract CYBERARMYDOGE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "$CYBERARMYDOGE";
    string constant _symbol = "$CAD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 8) / 1000; //0.4% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 3) / 100; //3% of total supply
    ...
    address public marketingFeeReceiver = address(0x8cA62eeE3Ed694e48875401f6B7aF000e4E3b092);
    ...
    constructor () {
        ...
        // TargetToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        // router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        
        TargetToken =  0xbA2aE424d960c26247Dd6c32edC70B295c744C43;  //DOGE ADDRS REWARDS
