...
contract NFT is ERC721, Ownable {
    ...
    address PPOLLTOKEN = 0xc29000A4b1eCD326b6DafAE17bDA636475FeA1e7; //PANCAKEPOLL CONTRACT
    ...
    constructor() ERC721("PPOLLTEST", "PPOLLTEST") {
        _contractOwner = msg.sender;
        PancakePoll = IERC20(PPOLLTOKEN);
    }
    ...
    function _trade(uint _id) internal {
        ...
        PancakePoll.transferFrom(_owner, _sellerValue);
        PancakePoll.transferFrom(_contractOwner, _commissionValue);
