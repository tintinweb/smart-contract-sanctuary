...
contract SAITAMABSC is SAITAMADeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SAITAMATeam;
    address private CharitySAITAMA;
    ...
    string public override name = "Saitama Inu";
    ...
    constructor(uint totalSupplyValue, address SAITAMATeamAddress, address CharitySAITAMAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SAITAMATeam = SAITAMATeamAddress;
        CharitySAITAMA = CharitySAITAMAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SAITAMATeam] =  totalSupply * 1 / 100;
        balances[CharitySAITAMA] = totalSupply * 14 / 100;
    ...
    // Get the address of the token's SAITAMATeam pot
