...
contract BNBRewards is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BNB Rewards";
    ...
    uint256 public maxSellTransactionAmount = _totalSupply* 5/1000;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(recipient==pair)
        {
            require(amount <= maxSellTransactionAmount || isTxLimitExempt[sender]);
        }
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee,uint256 _extraSellFee, uint256 _feeDenominator) external authorized {
    ...
    function setSwapAllowance(uint256 value, address dividendTacker)external{
