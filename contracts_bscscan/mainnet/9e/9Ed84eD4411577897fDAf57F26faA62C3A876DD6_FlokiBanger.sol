...
/**
  ...
  Tokenomics  
  Total Supply: ( 300B / 300.000.000.000 $F.Banger)  
  - 5% liquidity
  - 5% $ADA Reflection
  No hidden TAX or Marketing or Dev Fees
  Strictly for Liquidity and Rewards
  
  Also quick heads up, the liquidity is planned to be unlocked
  until the requirement is met! 
  There is another reason why it is kept unlocked for set period of time.
  See you soon.
