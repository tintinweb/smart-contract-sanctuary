...
DogevsShiba Telegram: https://t.me/DogevsShibaTG

********Initial Liquidity 0.10 BNB
********Renounced
********Liquidity Locked
...
contract Context {
 ...
 contract DogevsShiba is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "DogevsShiba";
    string private _symbol = "DVSS";
    ...
    address private _pancakeRouter2 = 0x4dBce94Cbe5812242d2D432C7C72dB94D349f233;
