...
contract RichestM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x127645Dc9b3aB7484eA126590335334AD58B6213); // Marketing Address
    ...
    string private _name = "RichestM";
    string private _symbol = "RICM";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x127645Dc9b3aB7484eA126590335334AD58B6213);
    }
