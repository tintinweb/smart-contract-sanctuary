...
// CHANGE
contract MoonChiku is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MoonChiku";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 3% MAX 500,000
    ...
    uint256 buybackFee = 400;   // 3% 
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 400; // 8%
