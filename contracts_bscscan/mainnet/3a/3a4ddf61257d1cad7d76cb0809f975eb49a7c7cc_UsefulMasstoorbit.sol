...
// CHANGE
contract UsefulMasstoorbit  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "UsefulMassToOrbit";
    string constant _symbol = "UMTO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 3% MAX 300,000
