...
//Just launched in $SolonaPrinter. We have created a token so rewarding for everyone.
//SolonaPrinter Hold we will Tothemoon
//Telegram: https://t.me/SolonaPrinter
*/
...
contract SolonaPrinter is Context, IERC20, Ownable {
    ...
    string private _name = "SOLONA PRINTER";
    string private _symbol = "SolonaPrinter";
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private liquidAddress = 0x31Ab4E5822eE22A602F2Fa566B60785f246b9914;
