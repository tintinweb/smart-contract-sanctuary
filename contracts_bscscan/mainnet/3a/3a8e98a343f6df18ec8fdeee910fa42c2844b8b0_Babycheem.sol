...
contract Babycheem is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0x374cC445CEAF86ABD9371697083db27067273d66;
    ...
    string private _name = "Babycheem";
    string private _symbol = "BCHM";
    ...
    function setTokensForSwap(uint256 newVal) external onlyOwner() {
