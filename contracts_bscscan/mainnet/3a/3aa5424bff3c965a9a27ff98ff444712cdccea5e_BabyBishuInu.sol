...
/*
 * Website: https://www.bishu.fi/
 * Telegram: https://t.me/babybishuinu
 */
/*
...
contract BabyBishuInu is Context, IBEP20, Ownable {
  ...
  string private constant _name = "Baby Bishu Inu";
  string private constant _symbol = "BABYBISHU";
  uint8 internal _buyTax = 6;

  uint8 internal _sellTax = 10;
  uint8 internal _transferTax = 9; 
