...
contract FlokiBTCToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki-BTC";
    string constant _symbol = "FBTC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 5 * 10**12 * (10 ** _decimals);
