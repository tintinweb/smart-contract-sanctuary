...
contract LittleBaby is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "LittleBaby Cheems";
    string constant _symbol = "BABYCHEEM";
    ...
    uint256 public swapThreshold = _totalSupply * 2000 / 2000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xD5BfD9A86c68bebe6eeE2D8E829740a31f7e1b0e;  // teamwallet
        lotteryWallet = 0xD5BfD9A86c68bebe6eeE2D8E829740a31f7e1b0e;  // lotterywallet
