...
// File contracts/LottoMate.sol

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;
contract LottoMate is ERC20, Ownable {
    ...
    uint256 public buyLottoFee;
    
    uint256 public sellTotalFees;
    uint256 public sellMarketingFee;
    uint256 public sellLiquidityFee;
    uint256 public sellLottoFee;
    
    uint256 public tokensForMarketing;
    uint256 public tokensForLiquidity;
    uint256 public tokensForLotto;
    ...
    event LottoWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    event LottoTriggered(uint256 amount);
    ...
    constructor() ERC20("Andromeda V2", "M31") {
        ...
        buyLottoFee = _buyLottoFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyLottoFee;
        
        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellLottoFee = _sellLottoFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellLottoFee;
        
        blackListFee = 99;

    	marketingWallet = msg.sender; // set as marketing wallet
    	LottoWallet = msg.sender; // set as Lotto wallet
        ...
        excludeFromMaxTransaction(LottoWallet, true);
    ...
    function setBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _LottoFee) external onlyOwner {
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyLottoFee = _LottoFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyLottoFee;
    ...
    function setSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _LottoFee) external onlyOwner {
        sellMarketingFee = _marketingFee;
        sellLiquidityFee = _liquidityFee;
        sellLottoFee = _LottoFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellLottoFee;
    ...
    function setLottoWallet(address newWallet) external onlyOwner {
        emit LottoWalletUpdated(newWallet, LottoWallet);
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on sell
                ...
                tokensForLotto += fees * sellLottoFee / sellTotalFees;
            ...
            // on buy
                ...
                tokensForLotto += fees * buyLottoFee / buyTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForLotto;
        ...
        uint256 ethForLotto = ethBalance.mul(tokensForLotto).div(totalTokensToSwap);
        
        
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForLotto;
        ...
        // keep leftover ETH for Lotto
        (success,) = address(LottoWallet).call{value: address(this).balance}("");
    }
    
    // useful for Lottos or to reclaim any BNB on the contract in a way that helps holders.
    function LottoTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        emit LottoTriggered(bnbAmountInWei);
    }
}