...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ETHE = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    function deposit() external payable override {
        uint256 balanceBefore = ETHE.balanceOf(address(this));
        ...
        uint256 amount = ETHE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ETHE.transfer(shareholder, amount);
    ...
    event Deposit(uint256 amountBNB, uint256 amountETHE);
...
contract PIGGYDegen is IBEP20, Auth {
    using SafeMath for uint256;

    address ETHE = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PIGGY Degen";
    string constant _symbol = "PGD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000,000,000
