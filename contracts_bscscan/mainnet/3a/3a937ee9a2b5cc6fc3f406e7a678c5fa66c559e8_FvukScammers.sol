...
contract FvukScammers is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "fvckScammers";
    string private constant _symbol = "FKSCMS";
    ...
    uint256 private _reflectionFeeOnBuy = 7;
    uint256 private _taxFeeOnBuy = 14;
    
    
    uint256 private _reflectionFeeOnSell = 7;
    ...
    address payable public _mgcAddress = payable(0x74a0835F76245Ada913Dd06d0b0F8F8DB74250f3); 
    address payable public _mktgAddress = payable(0x74a0835F76245Ada913Dd06d0b0F8F8DB74250f3); 
    ...
    uint256 public _swapTokensAtAmount = 1000 * 1e6 * 1e9; //amount of tokens to swap for eth 0.1%
    ...
    function setFee(uint256 reflectionFeeOnBuy, uint256 reflectionFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(_reflectionFeeOnBuy + _taxFeeOnBuy <= 45, "Must keep buy taxes below 25%"); 
        require(_reflectionFeeOnSell + _taxFeeOnSell <= 45, "Must keep buy taxes below 25%"); 
    }
