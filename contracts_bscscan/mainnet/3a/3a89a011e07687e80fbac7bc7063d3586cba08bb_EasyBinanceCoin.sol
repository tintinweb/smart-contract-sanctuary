...
EasyBinanceCoin is the first Dynamic DeFi token that adjusts it’s
tax rates to sustain and rejuvenate supply pools,
building upon existing transaction tax systems used
by a large number of existing DeFi tokens by
introducing a revolutionary new mechanic:
Dynamic Tax Protocol.

📥Token Information📥

📍 Token Name : Easy Binance Coin
📍 Token Symbol: $EBC
📍 Max Supply : 420,000,000,000(420 billions)
📍 4,5% of total supply will be in marketing wallet
📍 Token Address: TBA
...
🌍 Website: https://easybinancecoin.co/
🌍 Telegram: https://t.me/Easy_Binance_coin
🌍 Twitter: https://twitter.com/BinanceEasy
...
contract EasyBinanceCoin is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 420_000_000_000;
    ...
    address _marketingWallet = 0x5B31F6bdaef419b02CA5528b6113622f3EEd3308;
