...
pragma solidity ^0.6.12;
    ...
    contract RakuCoin is Context, IERC20, Ownable {
        ...
        string private _name = 'Raku Doge BSC';
        ...
        uint256 private _buystaketaxFee = 0; 
        uint256 private _buyMarketingPoolFee = 0;
        uint256 private _selltaxFee = 0; 
        uint256 private _sellstaketaxFee = 0; 
        uint256 private _sellMarketingPoolFee = 0;
        ...
        uint256 public walletlimit = 10000 * 10**9;
        uint256 private _maxTxAmount = 5000 * 10**9;
        // We will set a minimum amount of tokens to be swaped => 500K
        uint256 private _numOfTokensToExchangeForMarketingPool = 1 * 10**9;
    ...
    // List of front-runner & sniper bots from t.me/FairLaunchCalls
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if(sender != owner() && recipient != owner() && !_isExcludedFromFee[recipient] && recipient != uniswapV2Pair && recipient != address(0x10ED43C718714eb63d5aA57B78B54704E256024E) 
