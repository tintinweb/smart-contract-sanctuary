...
BITCOINSPACEXV2 - 10% Bitcoin reflection automatically every hour
...
contract BitcoinSpaceXv2 is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "BitcoinSpaceXv2";
    string constant _symbol = "BSXV2";
