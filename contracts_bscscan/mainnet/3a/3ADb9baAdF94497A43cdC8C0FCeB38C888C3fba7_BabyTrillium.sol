...
contract BabyTrillium is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x23f4a25A2b64ADcA9057B78C2F1373e4940c4Fbf); // Marketing Address
    ...
    string private _name = "Baby Trillium";
