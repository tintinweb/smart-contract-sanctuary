...
/**
 ...
 ChainScanner Main Governence Token:
    4% BUSD
    2% Team 
    4% AUTOLP 
    2% Marketing 
  Will be used as the main voting token for the ChainScanner Platform
...
contract ChainScanner is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ChainScanner";
    string constant _symbol = "CSCAN";
    ...
    uint256 public swapThreshold = _totalSupply / 400000000; // 2.5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x75D2Ad716F3629387d1F17a7B8248B7CCff522D0;
