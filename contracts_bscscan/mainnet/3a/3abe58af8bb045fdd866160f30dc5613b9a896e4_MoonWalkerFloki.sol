...
/* Token contract */
contract MoonWalkerFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Moon Walker Floki";
    string constant _symbol = "MWF";
    ...
    uint256 reflectionFeeSell = 1500;
