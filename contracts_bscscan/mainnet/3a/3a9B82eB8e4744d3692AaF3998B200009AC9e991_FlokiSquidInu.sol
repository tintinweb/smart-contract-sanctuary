...
/*
⚡️WELCOME TO FLOKISQUIDINU⚡️

🚀FLOKISQUIDINU $FLSI is a deflationary BEP-20 Token based on Binance Smartchain that uses a reflection model and buyback model to benefit holders and guarantee the longevity of the project. Relive the Hype by starting at a low market cap with us. Build a foundation where everyone will HOLD for the long-term gains.

FLOKISQUIDINU uses a passive yield farming protocol. All you have to do is keep only $FLSI tokens in your wallet. 

💲BUYBACK💲
Auto Buyback every 30 transactions of selling funds is taken 80% of the wallet pool, this will ensure that prices continue to move in upward momentum and will prevent whales from manipulating price action
...
contract FlokiSquidInu is ERC20, Ownable {
    ...
    constructor() ERC20("Floki Squid Inu", "FLSI")  {
