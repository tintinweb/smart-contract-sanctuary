...
/**
 Welcome to FreshDoge
   ...
   I will renounce the ownership to burn addresses to transfer #FreshDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make FreshDoge 100X? 
   ...
   it's the best part of the #FreshDoge idea, increasing the liquidity pool automatically, 
