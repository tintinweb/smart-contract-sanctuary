...
contract Moonies is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xAe19341f84e14ae2f75A1c48250857a37BF2422c; // pyt _charityWalletAddress hhrer
    ...
    string private _name = "Pickem Sports"; // Token name here
    string private _symbol = "Pickem"; // Token Symbol Here
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 1; // Redistribution Fee %
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _charityFee = 10; // charityFee % 
    uint256 private _previousCharityFee = _charityFee;
    uint256 public _liquidityFee = 5; // Liquidity percentage
