...
contract Xmascaketoken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("XmasCakeToken", "XCT") public {
    ...
    function buyingFee(uint256 value) external onlyOwner {
        buyFee = value;
    }
            

    
    function sellingFee(uint256 value) external onlyOwner{
        marketingFee = value;
    }
