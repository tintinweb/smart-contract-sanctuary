...
/**
  CNEKO is the first meme token with a real use case built around Price Impact.
  Read more about it on our website and lightpaper!
  
  Fair Launch in BSC: December 3rd 5pm GMT (Liquidity will be created at this point)
