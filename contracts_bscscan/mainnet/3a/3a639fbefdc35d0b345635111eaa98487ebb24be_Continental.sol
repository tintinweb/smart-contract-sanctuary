...
contract Continental is CONTDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CONTTeam;
    address private CharityCONT;
    ...
    string public override name = "Continental";
    string public override symbol = "CONT";
    ...
    constructor(uint totalSupplyValue, address CONTTeamAddress, address CharityCONTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CONTTeam = CONTTeamAddress;
        CharityCONT = CharityCONTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CONTTeam] =  totalSupply * 45 / 100;
        balances[CharityCONT] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's CONTTeam pot
