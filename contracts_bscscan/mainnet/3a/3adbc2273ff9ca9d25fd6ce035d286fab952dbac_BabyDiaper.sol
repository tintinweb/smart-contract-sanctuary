...
contract BabyDiaper is Context, IBEP20, Ownable {
    ...
    address payable public _marketingWallet = payable(0x264976e12102a6961d0c30212bB2f10081B7D8Eb); // Marketing Address
    ...
    string private constant _name     = "BabyDiape";
    string private constant _symbol   = "BabyDiaper";
