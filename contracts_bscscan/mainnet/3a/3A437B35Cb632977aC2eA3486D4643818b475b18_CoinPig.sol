...
contract LockDataExt {
    ...
    function getLockInfo(address account, uint256 lockIndex) public view returns(uint256, uint256) {
        ...
        return (_lockList[account][lockIndex].lockTData, _lockList[account][lockIndex].lockStamp);
    }
...
contract LockProjectExt is LockDataExt{
    ...
    function _getProjectInfo(uint projectIndex) internal view returns(uint256, uint256){
        require(projectIndex<projectList.length, "the index of project no vaild");
...
contract CoinPig is Context, IERC20, Ownable, LockProjectExt {
    using SafeMath for uint256;
    ...
    constructor () {
        ...
        _symbol = "PIG";
        _decimals = 9;
        _tTotal = 2100000000000000000000;
        _rTotal = (MAX - (MAX % _tTotal));
        _taxFee = 5;
        _liquidityFee = 5;
        _previousTaxFee = 5;
        _previousLiquidityFee = 5;
        _maxTxAmount = 210000000000000000000;
        numTokensSellToAddToLiquidity = 21000000000000000;
