...
contract SCAPS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x91Dee23dc1957537F2AFCdb9c91f0bbb4bFfd938); // Marketing Address
    ...
    string private _name = "SCAPS";
    string private _symbol = "SCAPS";
