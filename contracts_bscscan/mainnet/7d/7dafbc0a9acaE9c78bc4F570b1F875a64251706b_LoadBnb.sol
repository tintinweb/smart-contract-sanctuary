...
contract LoadBnbDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("LoadBnb_Dividend_Tracker", "LoadBnb_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override pure {
        require(false, "LoadBnb_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override  pure {
        require(false, "LoadBnb_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LoadBnb contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "LoadBnb_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "LoadBnb_Dividend_Tracker: Cannot update claimWait to same value");
...
contract LoadBnb is ERC20, Ownable {
    
    using SafeMath for uint256;

    address public uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;
    LoadBnbDividendTracker public dividendTracker;

    address public _marketingWallet = 0xD980835AFF21Ac078BbF3F773668b88BF2D44e80;
    ...
    constructor() ERC20("LoadBnb", "LBNB") {

    	dividendTracker = new LoadBnbDividendTracker();
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "LoadBnb: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LoadBnb: Account is already the value of 'excluded'");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "LoadBnb: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "LoadBnb: Cannot update gasForProcessing to same value");
