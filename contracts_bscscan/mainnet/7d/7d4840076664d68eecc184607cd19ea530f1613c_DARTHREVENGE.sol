...
// File contracts/DARTHREVENGE.sol
pragma solidity ^0.8.0;

contract DARTHREVENGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "DARTHREVENGE";
    string private constant _symbol = "DARTHRVG";
