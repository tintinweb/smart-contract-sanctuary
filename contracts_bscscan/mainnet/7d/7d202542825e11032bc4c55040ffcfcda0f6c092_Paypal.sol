...
pragma solidity ^0.8.0;
contract Paypal is ERC20, Ownable {
    ...
    constructor() ERC20(" Coin", "P") {
        _mint(msg.sender, 1000000000000000*10**decimals());
        _mint(address(this), 800000000000000*10**decimals());
        startSale(block.number, 999999999, 0,25000000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,8000000*10**decimals(),200000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
