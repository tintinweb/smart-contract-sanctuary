 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/MarioInu
 * 
 * 
 * Mario Inu token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract MarioInu is IBEP20, Auth {
    using SafeMath for uint256;
