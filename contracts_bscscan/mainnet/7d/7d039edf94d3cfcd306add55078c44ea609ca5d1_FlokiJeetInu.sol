...
/*
🐶 What is the Floki Jeet token? 🐶

✨Floki Jeet token focuses on rewarding holders automatically with $FJEET. This revolutionary concept is based on the stability of $FJEET and instilling holders with the confidence that they will be holding Jeet as a stable reflection ✨

The 🐶 Floki Jeet  Token protocol rewards Holders by putting aside 5% of each transaction and adding them to a jeet pool. This is not the new concept but will be the sustainable passive income to earn $FJEET daily ✨
...
Join our TG 📲: https://t.me/FlokiJeetInu
*/
...
contract FlokiJeetInu  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FlokiJeetInu ", "FJEET ") public {
