...
/**
    ...
    BSC More Token, hold $BMT and earn any token as a reward
    Holding ecosystem that force buyers to hold the coins, just hold and claim a token at your choice at anytime you like
    
    Bsc More Token is token that rewards it's holders with any token at your choice at anytime.
    All you need to do is buy $ETM and hold it to accumulate rewards, for now you can manualy claim to reward from BSCScan.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
// BSC More Token Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract BSCMoreToken is IBEP20, Ownable
{
    ...
    //Token Info 
    string private constant _name = 'BSCMoreToken';
    string private constant _symbol = 'BMT';
    uint8 private constant _decimals = 9;
    uint8 private constant _ZEROES = 0;
    ...
    address public constant TeamWallet=0x6702a7b88D0d15d0C89Eb4c3aAB44b792edD4919;
    ...
    uint8 public constant MaxTax=0;
    ...
    constructor () {
        ...
        uint256 deployerBalance=_circulatingSupply*10/10;
       ...
       //Sets sellLockTime to be 2 seconds by default
        ...
        _buyTax=12;
        _sellTax=18;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=10;
        //97% gets burned
        _burnTax= 0;
    ...
    function _calculateFee(uint256 amount, uint8 tax, uint8 taxPercent) private pure returns (uint256) {
        return (amount*tax*taxPercent) / 1000000;
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //BNB Autostake/////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    function TeamUpdateSellLimitsToTargetSellLimit() public onlyTeam{
        //Calculates the target Limits based on supply
        uint256 targetSellLimit=(_circulatingSupply/SellLimitDivider)*_ZEROES;
        sellLimit = targetSellLimit;     
    }
