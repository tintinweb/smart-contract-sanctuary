...
contract ElemonFOMO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elemon FOMO";
    string private _symbol = "ELFOMO";
    ...
    address payable public marketingWalletAddress = payable(0x306814e902Bd141b3A116ff42682B4f953078972); 
    address payable public rewardsWalletAddress = payable(0x21738902523caB71302Ff0AAAB26C43bC7136409); 
