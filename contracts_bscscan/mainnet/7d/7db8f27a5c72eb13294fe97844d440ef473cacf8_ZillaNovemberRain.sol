...
tg: https://t.me/ZillaNovemberRain
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x03fF0ff224f904be3118461335064bB48Df47938); //Harmony
...
contract ZillaNovemberRain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ZillaNovemberRain";
    string constant _symbol = "ZNR";
    ...
    uint8 public cooldownTimerInterval = 15; //sec
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x45F1ded7579f5487A4B8DE232AD740e6B5023919;
        devFeeReceiver = 0x36Ad6aeE99cA1badA6BAb7AF7c3d50DF01D31AC0; // buyback
