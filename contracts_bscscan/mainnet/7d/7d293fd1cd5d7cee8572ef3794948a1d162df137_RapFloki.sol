 ...
 *
  ...
  Rap Floki
4% $FLOKI rewards on every transaction 

 https://t.me/rapflokii
 
 
Welcome to Rap Floki the most iced out dog from the HOOD!

Website: https://www.rapfloki.net
Twitter: https://twitter.com/rapfloki_bsc

Tokenomics
4% rewards in $FLOKI on every Transaction!
...
contract RapFloki   is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "RapFloki";
    string constant _symbol = "RapFloki";
