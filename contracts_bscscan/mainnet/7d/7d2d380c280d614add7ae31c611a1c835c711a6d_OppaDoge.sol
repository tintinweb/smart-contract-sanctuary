...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @OppaDoge
...
contract OppaDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Oppa Doge";
    string private _symbol = "OPPADOGE";
