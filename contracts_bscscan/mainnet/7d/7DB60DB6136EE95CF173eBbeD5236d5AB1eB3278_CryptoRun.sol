...
/*
- CryptoRun is a smart wallet on Bsc, ETH, Matic, and other networks
- Website: https://cryptorun.network
- Telegram: https://t.me/CryptoRunNFT
- Documents: https://docs.cryptorun.network

- THE NEW ERA OF SMARTNESS
*/
...
contract CryptoRun is Ownable, ERC20Burnable {
    using SafeMath for uint256;
    ...
    function _transfer(
        ...
        if (antiWhaleTime > block.timestamp && amount > antiWhaleAmount && _transactionFee[sender]) {
            revert("Anti Whale");
        }
        if (
            transferFeeRate > 0 &&
