...
// File contracts/specialMint.sol
...
contract exclusive_mint is ERC721Enumerable, Ownable{
    ...
    constructor(address _beneficiary, address _erc20) ERC721("Special mint CakePunks", "CakePunk") {
        _baseTokenURI = "https://app.cakepunks.finance/exclusive/";
    ...
    function mint_character() public returns (uint256){
        require(totalSupply() < 100, "enough minting");
        require(token.allowance(msg.sender, address(this)) >= 12e7 ether, "approve the contract");
        token.transferFrom(msg.sender, address(this), 12e7 ether);
