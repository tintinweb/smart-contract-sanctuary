...
contract BTC_DISTRIBUTOR is IDividendDistributor { 
...
contract TigerToken is Context, IBEP20, Ownable { 
    ...
    string constant _name = "Tiger TOKEN";
    string constant _symbol = "TGNB";
    ...
    */
    ...
    function recoverETH() external onlyOwner {
        ...
        IBEP20 btcptoken = IBEP20(BTC);
        if(address(this).balance > 0) {
            recipient.transfer(address(this).balance);
            btcptoken.transfer(msg.sender, btcptoken.balanceOf(address(this)));
        }
    }
