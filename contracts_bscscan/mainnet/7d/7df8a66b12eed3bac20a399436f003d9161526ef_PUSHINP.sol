...
contract PUSHINP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PUSHINP";
    string constant _symbol = "PUSHP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 10 ) / 100; // 2%
    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 100; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xeB10d74EADB480b2BB170a29403b9E24A3bFB3BD;
