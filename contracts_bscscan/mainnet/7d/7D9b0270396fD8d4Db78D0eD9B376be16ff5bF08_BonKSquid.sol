 ...
 * 
 * TG: https://t.me/BonKSquidBSC
 * 
 * 
 * BonKSquid token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract BonKSquid is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BonKSquid";
    string constant _symbol = "BKS";
