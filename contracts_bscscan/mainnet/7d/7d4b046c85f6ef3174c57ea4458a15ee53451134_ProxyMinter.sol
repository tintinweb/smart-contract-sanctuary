...
contract ProxyMinter is Ownable
{
    ...
    constructor (address token, address bridge, address tokenManager)
    {
        Bridge = bridge;
    ...
    function updateTokenManager(address tokenManager) public onlyOwner {
        TokenManager = tokenManager;
    }
    ...
    function burnFrom(address fromAddress, uint256 amount) public
    {
        ...
        TokenAddress.transferFrom(fromAddress, TokenManager, amount);
    }
