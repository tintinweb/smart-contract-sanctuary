...
contract TeslaStock is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TeslaStock";
	...
	function setWalletRewardStatus(address user, bool banned) external authorized {
		if (banned) {
