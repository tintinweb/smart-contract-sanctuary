...
contract Meleerock is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Meleerock";
    string constant _symbol = "$MELEE";
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver2 = 0x0000000000000000000000000000000000000000;
