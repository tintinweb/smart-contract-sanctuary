...
//
// $ShibaBake proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN BAKE! With the auto-claim feature,
// simply hold$ShibaBake and you'll receive BAKE automatically in your wallet.
// 
// Hold ShibaBake and get rewarded in Bake on every transaction!
//
//
// 📱 Telegram: https://t.me/shibabake
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ReflectionRewardsBake(uint256 amount) public onlyOwner {
...
contract SHIBABAKE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SHIBA BAKE", "SBAKE") {
