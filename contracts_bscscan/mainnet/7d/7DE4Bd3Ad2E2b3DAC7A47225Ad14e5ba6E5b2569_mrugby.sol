...
contract mrugby is Context, IERC20, Ownable {
    ...
    string private _name = "Mini Rugby";
    ...
    uint256 private numTokensSellToAddToLiquidity = 300000 * 10**6 * 10**8;
    ...
    function calculateLiquidityPlusCommunityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityFee + _communityFee + _marketingAndDevBudget).div(
            10**2
        );
    }
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _marketingAndDevBudget == 0 && _communityFee == 0) return;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 totalLiqFee = _marketingAndDevBudget + _liquidityFee + _communityFee;
