...
contract DogeT1mes is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x67ce7B0020DE707317AAd5721b6Fd1A35e276596;
    ...
    string private _name = "DogeT1mes";
    string private _symbol = "DogeT1mes";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**9 * 10**12;
    ...
    function _transfer(
        ...
        if (limitTheWhales) {
            if(from != owner() && to != owner()) {
                require(amount <= (totalSupply()) * (2) / (10**2), "Transfer amount exceeds the 2% of the supply.");
            }
