...
Telegaram : https://t.me/ADAFootballOfficial
...
contract ADAFootball is ERC20, Ownable {
    ...
    constructor() ERC20("ADAFootball", "ADAFootball") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0xf58bB649C636B8e9aede5E52043bfB99cfE049c1;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "ADAFootball: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "ADAFootball: The new dividend tracker must be owned by the ADAFootball token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ADAFootball_Dividend_Tracker", "ADAFootball_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 1200;
    ...
    function withdrawDividend() pure public override {
        require(false, "ADAFootball_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "ADAFootball_Dividend_Tracker: claimWait" );
