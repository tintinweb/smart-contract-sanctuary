...
//JOIN HERE : https://t.me/sonofyooshibsc
/** 
MISSED SON OF DOGE, SON OF SHIBA, AND SON OF FLOKI?
COME JOIN US ON SON OF YOOSHI.
THE NEWEST SON TOKEN IN BSC LAND!

This project is strongly inspired by the Son Of Doge token which is doing well on BSC network. We are a very competent team and have experience on past projects.

This project was designed with a marketing strategy of a minimum of x100 potential.

Our goal is to build a strong and vibrant community that will rise together, thrive and get stronger.

We have plans to integrate NFTs to into our project. This will be released shortly after launch!

Please kindly read pinned messages.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 YOOSHI = IBEP20(0x02fF5065692783374947393723dbA9599e59F591);
    ...
    function deposit() external payable override {
        uint256 balanceBefore = YOOSHI.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(YOOSHI);
        ...
        uint256 amount = YOOSHI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            YOOSHI.transfer(shareholder, amount);
    ...
    event Deposit(uint256 amountBNB, uint256 YOOSHI);
...
contract SONOFYOOSHI is IBEP20, Auth {
    using SafeMath for uint256;

    address YOOSHI = 0x02fF5065692783374947393723dbA9599e59F591;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SON OF YOOSHI";
    string constant _symbol = "$SOY";
