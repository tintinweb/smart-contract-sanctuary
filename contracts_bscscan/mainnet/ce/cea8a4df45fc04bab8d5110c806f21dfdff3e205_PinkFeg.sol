...
/*
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @PinkFegBSC
   ...
   I will renounce the ownership to burn addresses to transfer #PinkFeg to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make #MIGHTYCOIN 10000X? 
   ...
   it's the best part of the #PinkFeg idea, increasing the liquidity pool automatically, 
