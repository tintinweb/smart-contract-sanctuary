...
🔔 Fair-Launch will on October 2, 2021 ✅
...
✅2% Rewarding to holders

✅ 5% BURN

✅ 5% Development & Marketing

✅ AutoLocked LP FOR 35 YEAR 🔐

✅ Audit: TBA

🌐 Official Platforms

❄️ Telegram: https://t.me/Icephoenixofficial

❄️ Website : https://icephoenix.co

❄️ Twitter  : https://twitter.com/Icephoenix_ipx
...
contract IceFOMO is IBEP20 {
    ...
    string public override name = "Ice FOMO";
    string public override symbol = "$IFOMO";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress, address RebaseAddress) {
        ...
        balances[developmentPot] =  totalSupply * 2 / 100;
        balances[foundersPot] = totalSupply * 41 / 100;
        balances[Rebase] = totalSupply * 2 / 100;
        
        balances[owner] = totalSupply * 55 / 100;
    }
