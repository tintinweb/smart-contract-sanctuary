...
contract MyDeFiTeam_Lottery_FINAL {
    ...
    uint256 public maxUserDeposits = 3000000000000000000;
    ...
    function invest(
        ...
        require(getMyDeposits(msg.sender) + amountCAKE <= maxUserDeposits, "maximum reached");
    ...
    function getLotteryWalletBalance() public view returns(uint256) {
        require(started == true);
        return token_CAKE.balanceOf(lotteryWalletAddress);
    }
