...
/**
  ...
  ______    ______  ________  _______    ______          ______    ______   __    __  ________ 
 /      \  /      \|        \|       \  /      \        /      \  /      \ |  \  /  \|        \
|  $$$$$$\|  $$$$$$\\$$$$$$$$| $$$$$$$\|  $$$$$$\      |  $$$$$$\|  $$$$$$\| $$ /  $$| $$$$$$$$
| $$__| $$| $$___\$$  | $$   | $$__| $$| $$  | $$      | $$   \$$| $$__| $$| $$/  $$ | $$__    
| $$    $$ \$$    \   | $$   | $$    $$| $$  | $$      | $$      | $$    $$| $$  $$  | $$  \   
...
contract ASTROCAKE is IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 1% MAX .01
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 3% MAX .03
    ...
    uint256 liquidityFee = 10000; // 5%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; // 10%
    uint256 devFee = 0; // 0%
