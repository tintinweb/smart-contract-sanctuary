...
╚═════╝░░╚════╝░░╚═════╝░╚═╝╚═╝░░╚══╝╚═╝░░╚═╝
         ...
         "The first and hottest lady dog token released on the Binance Smart Chain."
         
         

     (___________________________()6 `-,                    <------- Dogina, say hi to her!
     (   ______________________   /''"`
     //\\                      //\\
    "" ""                     "" ""          
  Dogina features:
   10% Fee on all transactions
   7% auto added to the liquidity pool and locked forever
   3% auto distributed to all holders
   30% Supply burned at the start to create a blackhole 
 */
...
contract Dogina is Context, IERC20, Ownable {
