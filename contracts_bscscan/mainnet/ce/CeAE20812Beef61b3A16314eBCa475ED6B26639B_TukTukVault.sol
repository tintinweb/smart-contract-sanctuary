 ...
 */
contract TukTukVault is ERC20, Ownable {
     ...
     */
    constructor () ERC20(                                               
        string("TukVault TUK ttUSD-TUK"),
        string("TukVault ttUSDTUK")
    ) {
        token = IERC20(0x210eD92C507E93640cB869BAA890Bc6508642c52);
    }
    ...
    function withdraw(uint256 _shares) public {
        ...
        if (b < r) {
            ...
            IStrategy(strategy).withdraw(_withdraw, false);
    ...
    function upgradeStrat() public onlyOwner {
        ...
        if (IStrategy(strategy).balanceOf() > 0) {
