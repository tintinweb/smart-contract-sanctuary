...
Little Baby Cake is the BIGGEST  BSC token
...
contract LittleBabyCake is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby Cake";
    string private _symbol = "LilBabyCake";
