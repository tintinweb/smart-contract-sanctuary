...
/**
    ...
    Twitter : https://twitter.com/hmoonbsc
    Website : https://harvestmoonbsc.com
    Slippage : 14% or more.
    Simply Hold HMOON, Earn $ALICE
 
    Harvest Moon | $HMOON | The Next-Gen Alice Rewards Token | 8% Alice Reward
    
    Welcome to Harvest Moon; The Next-Gen Alice Reward Token. 
    Unique Yield-Generating System that Auto-distribute holders with $ALICE
    The More You HODL, The More $ALICE You Earn. Lets To The MOON
*/
...
contract HarvestMoon is ERC20, Ownable {
    ...
    constructor() ERC20("HarvestMoon", "HMOON") {
    	...
    	marketingWallet = 0x7f91564F4Cdca6e1C94876fe0C86bFB3b899566F; // Marketing Wallet
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("HarvestMoon_Dividend_Tracker", "HarvestMoon_Dividend_Tracker", 0xAC51066d7bEC65Dc4589368da368b212745d63E8) {
    	claimWait = 14400;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold Z00,000+ tokens
    }
