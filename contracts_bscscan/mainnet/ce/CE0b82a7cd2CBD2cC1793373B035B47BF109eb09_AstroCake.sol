...
contract Context {
 ...
 contract AstroCake is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "AstroCake";
    string private _symbol = "ASTROC";
    ...
    address private _MarketingWalletSYLOM = 0x764aFEc34A55d6368381d88F09d7451747A90670;
