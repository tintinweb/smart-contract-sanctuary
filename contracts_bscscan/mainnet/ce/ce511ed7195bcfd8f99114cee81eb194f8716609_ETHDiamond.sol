...
/**
   ...
   Welcome to ETHDiamond
   
   This is a community token. If you want to create a telegram I suggest to name it to @ETHDiamond
...
contract ETHDiamond is Context, IERC20, Ownable {
    ...
    string private _name = "ETH Diamond";
