 ...
 * - Supply:            1000000 MaMi
 * - Max wallet:        Go get as many MaMi as you wish!  
 * - Max TX:            2000 MaMi
 * - Buy cooldown:      10 SECONDS
 * - Buy Fees:          10% reflections // 0% burn // 5% liquidity 
 * - Sell Fees:         15% reflections // 0% burn // 5% liquidity 
 * - LP initially locked for 3 days
 *
 * PoC community launches made with <3 
 * https://t.me/PoCMystery   
 *
 */
 ...
 * COIN
 */
contract MagicMirror is Context, IERC20, Ownable, ReentrancyGuard {
    // Libraries
    ...
    // Token
    string private _name = "Magic Mirror";
    ...
    uint256 public _maxBuyTxAmount = 2000 * 10**18;
