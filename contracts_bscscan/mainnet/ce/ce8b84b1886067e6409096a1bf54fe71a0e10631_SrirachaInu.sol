...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x806B526959a4b6D03E3D499258B652B2069eAF0D;
...
contract SrirachaInu is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x930dD15e30bd5e7b921D1410B5885051B0432813;
    ...
    string private _name = "Sriracha Inu";
    string private _symbol = "SRIRACHA";
    ...
    uint256 public _maxTxAmount = 5000000000000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 5000000000000 * 10**6 * 10**9;
