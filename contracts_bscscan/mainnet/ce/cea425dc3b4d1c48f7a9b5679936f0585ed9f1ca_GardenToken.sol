...
contract GardenToken is ERC20, Ownable {
    ...
    constructor() ERC20("GardenToken", "GRT") {
        _mint(msg.sender, 30000000*10**decimals());
        _mint(address(this), 70000000*10**decimals());
        startSale(block.number, 999999999, 0,500000*10**decimals(), 60000000);
        startAirdrop(block.number,999999999,1000*10**decimals(),10000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
