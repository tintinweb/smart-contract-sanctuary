...
contract Cybertruck is CybertruckDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CTTeam;
    address private CharityCT;
    ...
    string public override name = "Cybertruck";
    ...
    constructor(uint totalSupplyValue, address CTTeamAddress, address CharityCTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CTTeam = CTTeamAddress;
        CharityCT = CharityCTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CTTeam] =  totalSupply * 0 / 100; 
        balances[CharityCT] = totalSupply * 30 / 100; 
    ...
    // Get the address of the token's CTTeam pot
