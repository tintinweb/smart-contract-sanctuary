...
/* VISA -  Global consumer payment services on binance smart chain

website: https://visatoken.online/                                           
...
contract VISAToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDe315C49DB024390aa4Ac5Cf8f5FaD64cB8622Cb); // Marketing Address
    address payable public charityAddress = payable(0xDe315C49DB024390aa4Ac5Cf8f5FaD64cB8622Cb); // Charity/Dev Address
    ...
    string private _name = "Visa Token";
    string private _symbol = "VISA";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 700000000000000000000000000; // 700,000,000; token will be given on airdrop
