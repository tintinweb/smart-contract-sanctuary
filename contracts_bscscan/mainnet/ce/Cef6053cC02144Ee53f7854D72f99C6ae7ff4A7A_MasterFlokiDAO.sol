/** 
MASTERFLOKIDAO 2022 Limited.

Telegram - MasterFlokiDAO

GAME

The native token $MFD will be imperative to the success of our project and play to earn game. 

How the P2E would work that the players ARE required to hold $MFD and also pay a small amount of tokens  each game which will then be sent into the "rewards" wallet which would then be distributed to X (still undecided) amount of players. This would work in favor for both traders and lovers of P2E games.

Set in the feudal era of Japan, our MasterFloki will go through different levels as he slowly progress into different levels.
In the first five levels there will be 3 different  Samurai Crocodile Monsters that you will have to face and at the end of every level there will be a final boss which you would have to defeat to carry on to the next floor. 

The launch of $MFD would be a stealth.

NFT

As we are still very early in development, we plan to also have NFTs where we will be able to implement it into our game. It means that there will be utility for those NFTs when we are are more further into development, how it will work is that there will be different types of "looks" which would range from low to high rarity, holding a more higher rarity NFT would give you a "in-game boost" and also give the NFT owner a competitive edge over others!
...
contract MasterFlokiDAO is ERC20Detailed, Ownable {
    ...
    uint256 public antiDumpPercentage = 18;
    ...
    constructor() ERC20Detailed("MasterFlokiDAO", "MFD", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0x81Ef38DA1269B9B6A1D757e6E65F3F8B3e041A9D;
        ecosystemFeeReceiver = 0x81Ef38DA1269B9B6A1D757e6E65F3F8B3e041A9D;
        buyBackFeeReceiver = 0x123682D4C5Be74A1B4bd567318587b9A932A8d33;
