...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x305c3A6fdd09498C9df7225679fd5D1928A7B383;
...
contract MINIFLOKI is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x305c3A6fdd09498C9df7225679fd5D1928A7B383);
    ...
    */
    ...
    // Max wallet holding (25% at launch)
    uint256 public _maxWalletToken = _tTotal.mul(20).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (25% at launch)
