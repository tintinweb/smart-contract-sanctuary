...
/**
   ...
   Welcome to ULTRAMOON            
   
   This is a community token. If you want to create a telegram I suggest to name it to @ULTRAMOONBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ROYALDROP to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ROYALDROP 10000X? 
   ...
   it's the best part of the #ROYALDROP idea, increasing the liquidity pool automatically, 
...
contract ULTRAMOON is Context, IERC20, Ownable {
    ...
    string private _name = "ULTRAMOON";
    string private _symbol = "ULMN";
