...
contract Gnu is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9dEe3D659afBc629482DB0D1A7cce46C8889088c); // Marketing Address
    address payable public charityAddress = payable(0x9dEe3D659afBc629482DB0D1A7cce46C8889088c); // Charity/Dev Address
    ...
    string private _name = "Gnu Coin"; // nice
    string private _symbol = "GUNC";
