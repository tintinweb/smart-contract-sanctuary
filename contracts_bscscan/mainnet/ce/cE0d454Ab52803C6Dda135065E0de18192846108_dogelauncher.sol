...
/**
 * Telegram: https://t.me/dogelaunchertoken
 * Website: https://www.dogelauncher.xyz/
 * 
 * HODL $DLH and get rewards in DOGE
 */
...
contract dogelauncher is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeLauncher";
    string constant _symbol = "DLH";
    ...
    uint256 reflectionFee = 700; //10% reward in $DOGE
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x626c5A22a91Bc0c882FbfF357BA14d096E398C0E;
