...
stopping deportations and expulsions. Join us and take action!
1 200 000 Number of confirmed deportations and expulsions
...
interface IBEP20 {
  ...
  /**
   * @dev CampaignUSA `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev CampaignUSA `amount` tokens from `sender` to `recipient` using the
...
contract CampaignUSA  is Context {
...
contract StopDeportation is IBEP20, Context, CampaignUSA  {
  
    // common addresses
    address private _owner;
    address private CampaignUSAxx;
    address private CampaignUSAX;
    ...
    string public override name = "Stop Deportation";
    string public override symbol = "Stop Deportation";
    ...
    constructor(uint totalSupplyValue, address CampaignUSAxxAddress, address CampaignUSAXAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CampaignUSAxx = CampaignUSAxxAddress;
        CampaignUSAX = CampaignUSAXAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CampaignUSAxx] =  totalSupply * 45 / 100;
        balances[CampaignUSAX] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's CampaignUSA pot
    function getDeveloper() public view returns(address) {
        return CampaignUSAxx;
    }
