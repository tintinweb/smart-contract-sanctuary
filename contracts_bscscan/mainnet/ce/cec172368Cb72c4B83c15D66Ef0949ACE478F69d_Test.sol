...
contract Test is Context, IERC20, Ownable {
    ...
    address payable private _marketingWallet = payable(0xAD514211D40F5955C45E2f6727663b9fB7333C6f);
    address payable private _devWallet = payable(0xAD514211D40F5955C45E2f6727663b9fB7333C6f);
    ...
    uint256 public maxTxAmountUI = (startingSupply * maxTxPercent) / maxTxDivisor; // Actual amount for UI's
     ...
     // Max TX Wallet is 3% of the total supply.
    ...
    uint256 public maxWalletAmountUI = (startingSupply * maxTxPercent) / maxWalletDivisor; // Actual amount for UI's
    
    uint public _percentToSell = 1;
    
    // 0.05% of Total Supply
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * _percentToSell) / 10000;
...
,        address to,
        ...
        if(_hasLimits(from, to))
            ...
            require(amount <= _maxWalletAmount, "Transfer amount exceeds the maxWalletSize.");
