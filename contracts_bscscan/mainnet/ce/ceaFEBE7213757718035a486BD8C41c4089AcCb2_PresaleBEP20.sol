...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public hardCapEthAmount = 4000 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x44f1B6135AFa23561D7048907A1E7F663D44c5ba;
    ...
    function deposit() public payable {
        require(stopPreSaleEn == false, "presale is not active");
        ...
        rewardTokenCount = 0.000001 ether; // 1,000,000 SOWL tokens per BNB
    ...
    function getDepositAmount() public view returns (uint256) {
        ...
        function runPreSale() external onlyOwner{
        stopPreSaleEn = false;
    }
