...
contract Pharaohcat is Context, IERC20, Ownable {
    ...
    string private _symbol = "Pharaoh cat";
    ...
    uint256 public marketingAndDevelopment = 10; // 2% Marketing and Development
    ...
    uint256 public _maxWalletToken = 10000000000000000 * 10**18;
