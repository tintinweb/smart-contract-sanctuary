...
// Vonder.Finnace: Mod-Salary for Developer Teams
...
contract ModSalary is Ownable {
    ...
    constructor(IBEP20 _paymentToken, address _devaddress) public { 
    ...
    function claim() public {
        ...
        if (reward > 0) {
            ...
            paymentToken.transferFrom(devaddress,msg.sender,reward);
