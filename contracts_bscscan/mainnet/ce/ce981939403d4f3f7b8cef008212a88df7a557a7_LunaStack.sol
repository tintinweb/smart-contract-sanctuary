...
contract LunaStack is Context, IERC20, Ownable {
    ...
    string private constant _name = "LunaStack"; // 
    string private constant _symbol = "LUNS"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x9041295fe0597ABF36a6A98cB3a772AaCebfF20A;
