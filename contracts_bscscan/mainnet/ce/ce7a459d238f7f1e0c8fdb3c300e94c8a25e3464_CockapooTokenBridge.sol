...
/*
    ...
    This will easily allow people to migrate from a V1 to a V2 token (or V2 to V3 :)), just read the comments and make the proper updates!
...
contract CockapooTokenBridge is Ownable {
    ...
    constructor() {
        ...
        // Token V1
        token1 = IERC20(address(0xB277Db4f19fc79F87569aC34EFF5d1D50d4AEb8b));
        
        // Token V2 -- will be updated to new Contract once live
        token2 = IERC20(address(0x71809c4fF017CEADE03038a8b597EcaBB6519918));
        
        // change to token owner or liquidity holder (usually the project owner, not the developer) before launch
        liquidityWalletForV2 = address(0x48d795a345fC2286D41395691ad38E9Ff277aFC0); 
