...
contract titenggalet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "titeng galet";
    string private _symbol = "$TG";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0xfa3C61eedd49aD7e3BB48cd9Fe10B65de20D48e6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xfa3C61eedd49aD7e3BB48cd9Fe10B65de20D48e6); // BuyBack Address
