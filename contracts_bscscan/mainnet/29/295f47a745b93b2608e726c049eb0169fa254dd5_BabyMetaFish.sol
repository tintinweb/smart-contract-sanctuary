...
https://t.me/BabyMetaFish
*/
/*
welcome to BabyMetaFish people who have received this token will be 
deemed to have accepted all the following conditions

because the market cap is low, the BabyMetaFish will rise and fall very quickly,
so the people who tweet institutions and organizations token holders
are not responsible for any damage

ABUNDANT EARNINGS FOR EVERYONE
*/
...
contract BabyMetaFish is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMetaFish Token";
    string constant _symbol = "BABYFISH";
