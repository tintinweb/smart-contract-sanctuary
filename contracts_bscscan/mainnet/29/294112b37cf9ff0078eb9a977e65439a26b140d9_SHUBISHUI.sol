...
Initial Supply: 8 000 000 000 000 000 000 000 tokens
Max Wallet: 3%

Tax: 
10% buy
40% sell at launch, declining 5% every 60 mins

https://t.me/ShubishuiArmy
*
*/
...
contract SHUBISHUI is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SHUBISHUI';
    string private constant _symbol = '$SHUI';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 8000000000000000000000 * 10**_decimals;//equals 500B tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0x91B61c73DfCF4603650A793Ccf0B66667Bd757Aa);
    address public walletTwo=payable(0x9707fd90AbFcC79800d6d072A9b329B55cD1E4a1);
    //TestNet
	...
	uint256 private antiWhale = 80000000000000000000 * 10**_decimals;
