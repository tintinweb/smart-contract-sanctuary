...
contract LadyUnicorn  is Context, IERC20, Ownable {
    ...
    string private _name = "LadyUnicorn";
    string private _symbol = "LADYUNICORN";	
    uint8 private _decimals = 18;
    
    uint256 public _StakingRewards = 7;
    uint256 private _previousReflection = _StakingRewards;
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function calculateReflection(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_StakingRewards).div(
            10**2
        );
    }
    ...
    function removeAllFee() private {
        if(_StakingRewards == 0 && LiquidityFee == 0) return;
        
        _previousReflection = _StakingRewards;
    ...
    function restoreAllFee() private {
        _StakingRewards = _previousReflection;
