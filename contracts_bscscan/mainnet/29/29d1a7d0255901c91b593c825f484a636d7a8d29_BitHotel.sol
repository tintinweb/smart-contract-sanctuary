...
contract BitHotel is BitDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamBit;
    address private CharityBit;
    ...
    string public override name = "Bit Hotel";
    string public override symbol = "Bit Hotel";
    ...
    constructor(uint totalSupplyValue, address TeamBitAddress, address CharityBitAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamBit = TeamBitAddress;
        CharityBit = CharityBitAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamBit] =  totalSupply * 4 / 100;
        balances[CharityBit] = totalSupply * 25 / 100;
        
        balances[_owner] = totalSupply * 71 / 100;
    }
    ...
    // Get the address of the token's TeamBit pot
