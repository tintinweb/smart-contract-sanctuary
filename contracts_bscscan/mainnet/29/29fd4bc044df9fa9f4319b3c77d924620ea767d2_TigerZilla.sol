...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 0.1 * (10 ** 9);
...
contract TigerZilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TigerZilla";
    string constant _symbol = "TigerZ";
    ...
    uint256 private sellMultiplier = 1000;
    ...
    uint256 private _maxTxAmount = rSupply.div(1000).mul(50);
    uint256 private _maxWalletToken = rSupply.div(1000).mul(100);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2de74071525874aEfC7B73cDf66207591095f85B;
        BuyBackReceiver = 0x2de74071525874aEfC7B73cDf66207591095f85B;
    ...
    function Change_sell_multiplier(uint256 Multiplier) external onlyOwner{
