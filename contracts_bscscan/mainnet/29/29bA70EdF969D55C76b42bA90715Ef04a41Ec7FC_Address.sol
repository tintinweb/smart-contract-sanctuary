...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xfD0Ed6906b1C5Df2a0ec72668638a4E0A818fA3f is returned
...
contract TESTING is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xfD0Ed6906b1C5Df2a0ec72668638a4E0A818fA3f); // Marketing Address
