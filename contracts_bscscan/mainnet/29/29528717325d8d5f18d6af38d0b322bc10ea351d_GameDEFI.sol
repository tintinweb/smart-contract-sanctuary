 ...
 * 
 Welcome to $GameDEFI:
   ...
   Many Great features:
    ...
    it's the best part of the $GameDEFI idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 70bnb in the pool. 
...
contract GameDEFI is Context, IERC20, Ownable {
