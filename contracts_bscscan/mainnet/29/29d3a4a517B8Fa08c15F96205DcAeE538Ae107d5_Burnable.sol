...
// File: contracts/token/BEP20/Burnable.sol
...
/**
 * @title Burnable
 * @dev Implementation of the Burnable
 */
contract Burnable is BEP20Burnable, ServicePayer {
    ...
    constructor (
        ...
        BEP20(name, symbol)
        ServicePayer(feeReceiver, "Burnable")
        payable
    {
        require(initialBalance > 0, "Burnable: supply cannot be zero");
