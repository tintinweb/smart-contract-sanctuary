...
// File: contracts/DogeRun NFT2.sol
...
contract DogeRunNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        uint256 price = (_mintAmount / 5) * 1 ether + cost * (_mintAmount % 5);
        require(msg.value >= price, "Infsufficient balance");
    }
