...
contract PI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3140000000 * 10**6 * 10**4;   
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Pi Network";
    ...
    uint256 public _maxTxAmount = 125600000 * 10**6 * 10**4;     
    uint256 private numTokensSellToAddToLiquidity = 1570000 * 10**6 * 10**4;  
    ...
    function _takeLiquidity(uint256 tLiquidity) private {  // 合约地址自己的!  address(this)!
        uint256 currentRate =  _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
