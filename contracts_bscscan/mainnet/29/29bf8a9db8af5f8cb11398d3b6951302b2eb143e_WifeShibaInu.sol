...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 10000000000 * (10**9); 
...
contract WifeShibaInu is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "WifeShiba Inu";
    string constant _symbol = "WIFESHIB";
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            (bool success, /* bytes memory data*/) = payable(marketing).call{value: amountBNBMarketing, gas: 30000}("");
