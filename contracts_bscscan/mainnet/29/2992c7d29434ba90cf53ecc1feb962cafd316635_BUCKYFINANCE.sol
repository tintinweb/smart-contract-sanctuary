...
/**
   #BUCKYFINANCE(BYF)
   2% fee auto add to the liquidity
...
contract BUCKYFINANCE is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x5C7e62EA136f84e930EaD030b4cF078E371efb4f;
    ...
    string private _name = "BUCKYFINANCE";
    string private _symbol = "BYF";
