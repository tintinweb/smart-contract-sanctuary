...
/**
 ‼️ Stealth Launch LittleElonGoat‼️

          - is a hyperdeflationary token, which rewards investors for holding tokens,. This token with x100 potential. LittleElonGoat is one of the trend of Bsc. Meme cryptocurrencies, both inspired by Elon Goat. 

The team believe that this meme coin has a high potential to make it 100KMC. The team who take over this project by building a community of passionate holding this coin 100K MC is possible.

⚓Tokenomics:

👉TOTAL SUPPLY: 1,000,000,000,000
🔥BURN SUPPLY: 400,000,0000,000
🛡️TAX: 10%
     -3% Auto distribute to all holder
     -7% Marketing

Hyper deflationary token.
🔐Locked Lp for 10 Days
💰NO MINT FUNCTION
✅Verified Contract
🔥Huge Marketing
🎯💯 SAFU
...
Telegram:  https://t.me/LittleElonGoat


Website: http://littleelongoat.com
*/
...
pragma solidity ^0.6.12;
    ...
    contract LittleElonGoat is Context, IERC20, Ownable {
        ...
        string private _name = 'Little Elon Goat';
        string private _symbol = 'Little EG';
