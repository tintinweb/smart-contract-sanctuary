...
NewYearNeko is a NewYear version of Neko,
community-driven token with reflection and small tax.
Your token amount will grow just by holding.

Telegram https://t.me/NewYearNeko
Website http://www.newyearneko.space/ ----> uploading process to hosting
...
contract NewYearNeko is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewYearNeko";
    string private _symbol = "NewYearNeko";
