...
contract Phuczilla is Context, IBEP20, Ownable {
    ...
    string private _name = "Phuczilla";
    string private _symbol = "PHUC";
    ...
    uint256 public _liquidityFee = 5; //consists of buyback + liq + dividends tax 
    ...
    uint256 public _maxWallet = 69000000000000 * 10**9;
    uint256 public _maxTxAmount = 69000000000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 69000000000000 * 10**9; 
    ...
    address payable public buybackAddress = payable(0x541c3ba41AA1be842A5ff6551660BDDf6DB1595F);
    address payable public lpAddress = payable(0x541c3ba41AA1be842A5ff6551660BDDf6DB1595F);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        transferToAddressETH(buybackAddress, buybackBalance.add(devBalance));
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 99, "tax too high");
        _taxFee = taxFee;
    }
        
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        require(liquidityFee < 99, "tax too high");
