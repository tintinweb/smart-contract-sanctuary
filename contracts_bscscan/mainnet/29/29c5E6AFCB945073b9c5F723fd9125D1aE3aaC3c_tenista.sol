...
contract tenista is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "tenista";
    string constant _symbol = "tenista";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 20; // 50%
    ...
    uint256 liquidityFee = 500; // 2.0% liquidity + 3.0% buyback manual
    uint256 buybackFee = 400; // 4.0& autobuyback
    uint256 reflectionFee = 400; //4.0% rewards ADA
    uint256 marketingFee = 700; //3.0% marketing + 4.0% developing
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xEA0a586BD65B33CB801A2702a1B40367c55d8867;
