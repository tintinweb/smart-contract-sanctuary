...
contract dogetradefinance is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "dogetradefinance";
   string constant _symbol = "DOGETFC";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x956d9D06a123aFd7084c0Ef3e775936F7DaF7B86;
