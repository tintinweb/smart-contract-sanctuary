...
contract ProtoLaw is
    ...
    UUPSUpgradeable
{
    using LawBEP20 for LawType.Universe;
    ...
    function claimDCELawTokens() external {
    ...
    function createProposal(address implementation) external returns (uint256) {
    ...
    function withdrawStakeFromVote(uint256 proposalId) external {
    ...
    function setProtoGoldFuel(address proxyAddress) external {
...
library LawGovernance {
    ...
    function isProposalAccepted(
        ...
        uint256 proposalId = state.proposalIdFromImplementation[implementation];
        LawType.Proposal memory currentProposal = state
            .proposalFromId[proposalId];
