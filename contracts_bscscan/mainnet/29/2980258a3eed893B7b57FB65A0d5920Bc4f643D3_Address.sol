...
contract SuperDoge is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 4500 * 10**9 * 10**_decimals;
    uint256 public _maxTxAmount = 4500 * 10**9 * 10**_decimals;
    uint256 public _walletMax = 4500 * 10**6 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 4500 * 10**5 * 10**_decimals; 
