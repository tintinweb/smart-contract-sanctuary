...
/**
 Welcome to Renegade Doge
   
   Telegram: https://t.me/RenegadeDoge
   ...
   I will renounce the ownership to burn addresses to transfer #RenegadeDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make Renegade Doge 100X? 
   ...
   it's the best part of the #RenegadeDoge idea, increasing the liquidity pool automatically, 
...
contract BEP20 {
    ...
    contract  RenegadeDoge is BEP20 {
