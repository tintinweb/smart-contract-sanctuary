...
contract Fortune is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x19d0B53fB33bf14cfD8A76d2642e80641f4Ab100); // Marketing Address
    address payable public teamWalletAddress = payable(0xE018110B70a2F5f6D8cFAA402874A790C9905321); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1888 * 10**3; 
