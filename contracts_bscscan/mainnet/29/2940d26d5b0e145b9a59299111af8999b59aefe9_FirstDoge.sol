...
//
First Doge 
is a new token that is growing each day. 
Built on a deflationary economy, 
each transaction rewards all holders with First Doge token.

4% goes to holders. 
2% to auto-locked liquidity. 
1% to charity wallet.

https://t.me/firstdogecoin
...
contract FirstDoge is Context, IERC20, Ownable {
    ...
    string private _symbol = "First Doge";
    ...
    uint256 private _Maxpertx = _tTotal/100;
    ...
    address _marketingWallet = 0x1D1845949DDB2B063451c1D693C5be0aE3e273db;
