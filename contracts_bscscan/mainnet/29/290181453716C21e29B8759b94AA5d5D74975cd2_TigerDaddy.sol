...
contract TigerDaddy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TigerDaddy";
    string private _symbol = "TD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd1D0De6d90C54768c5397c39967796332C7447B7); // Marketing Address
    address payable public teamWalletAddress = payable(0x429283254e448eD825591830851B25BeE8E4fF41); // Team Address
