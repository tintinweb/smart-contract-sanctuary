...
Built by DiaHands & Marketers
Non stop Fomo chrt
Unique Features: ask dev on TG

You can buy up to 100 Tokens.
You can sell 1 Token every day.
You can not transfer Tokens from wallet to wallet.
...
contract HarleyFomo is IBEP20, Auth {

	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

	string constant _name = "Harley Fomo";
    string constant _symbol = "HFX";
	...
	function marketing() internal swapping {
        ...
        payable(0xe6497e1F2C5418978D5fC2cD32AA23315E7a41Fb).transfer(devBNB);
        payable(0x0d32FC823D4A043DF5133Ff47D8238F1584b90b6).transfer(devBNB);
