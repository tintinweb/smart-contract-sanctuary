...
contract KLMKToken is Pausable {
    ...
    constructor(
        ...
        name = "KLMKToken";                                   // Set the name for display purposes
        symbol = "KLMK";                                  // Set the symbol for display purposes
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        uint previousBalances = balanceOf[_from] + balanceOf[_to] + taxvalue + charityvalue;
        ...
        assert(balanceOf[_from] + balanceOf[_to] + taxvalue + charityvalue == previousBalances);
    }
