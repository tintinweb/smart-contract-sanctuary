...
contract coinxpad is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    coinxpadDividendTracker public dividendTracker;
    ...
    uint256 public USDTRewardsFee = 6;
    uint256 public liquidityFee = 1;
    uint256 public marketingFee = 3;
    uint256 public totalFees = USDTRewardsFee.add(liquidityFee).add(marketingFee);

    address public _marketingWalletAddress = 0x0Ba6D5893166676B18Ab798a865671d36F11b793;
    ...
    constructor() public ERC20("coinxpad", "coinxpad") {

    	dividendTracker = new coinxpadDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        coinxpadDividendTracker newDividendTracker = coinxpadDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the coinxpad token contract");
...
contract coinxpadDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("coinxpad_Dividend_Tracker", "coinxpad_Dividend_Tracker") {
    	claimWait = 3600;
