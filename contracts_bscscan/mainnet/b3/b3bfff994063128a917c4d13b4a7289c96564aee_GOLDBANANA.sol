...
/*
 ...
 Telegram: https://t.me/GOLDBANANABSC
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BANANAairdrop(uint256 amount) public onlyOwner {
    _BANANAairdrop(msg.sender, amount);
    }
    ...
    function _BANANAairdrop(address account, uint256 amount) internal virtual {
...
contract GOLDBANANA is ERC20 {

    uint tokenTotalSupply = 350000000;

    constructor() public ERC20("GOLDBANANA", "GOLDBANANA") {
        _BANANAairdrop(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}