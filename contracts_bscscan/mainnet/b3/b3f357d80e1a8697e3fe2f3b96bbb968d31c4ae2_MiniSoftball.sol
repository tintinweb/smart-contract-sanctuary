 ...
 */
contract MiniSoftball is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "Mini-Softball";
    string private _symbol   = "MiniSB";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x7a11dE034955C9C9FB7F92E7409ccA9a822E6C37); // Marketing address used to pay for marketing
