...
First BEP-20 Smart Contract that Rewards Holders with NEAR
Usable Features: Auto Liquidity, Auto Buyback, Auto Token Rewards
Initial Dividends: 2% Liquidity / 2% Buyback / 8% Reflection / 2% Marketing
Telegram: t.me/cryptobabynear
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 NEAR = IBEP20(0x1Fa4a73a3F0133f0025378af00236f3aBDEE5D63);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = NEAR.balanceOf(address(this));
        ...
        uint256 amount = NEAR.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            NEAR.transfer(shareholder, amount);
...
contract BabyNEAR is IBEP20, Auth {
    using SafeMath for uint256;

    address NEAR = 0x1Fa4a73a3F0133f0025378af00236f3aBDEE5D63;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby NEAR";
    string constant _symbol = "BabyNEAR";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x73F1C93BE4321AEd9aC4f9E6598cA072Bb9D347d;
