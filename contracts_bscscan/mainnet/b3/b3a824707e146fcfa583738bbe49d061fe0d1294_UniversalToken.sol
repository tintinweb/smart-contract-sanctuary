...
interface IPancakeV2Pair {
    ...
    event Extra(address indexed sender, uint amount0, uint amount1, address indexed to);
    event Swap(
...
contract UniversalToken is Context, IBEP20, Ownable {
    ...
    address private _extraWalletAddress = 0x502F459CfA7dfB1d56e8A000c220dc343542d0bc;
    ...
    string private _name = "Universal";
    ...
    uint256 public _maxTxAmount = 4200 * 10**9;
    ...
    constructor () {
        ...
        //IPancakeV2Router02 _pancakeV2Router = IPancakeV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // Pancakeswap testnet
        IPancakeV2Router02 _pancakeV2Router = IPancakeV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Pancakeswap mainnet
    ...
    function setExtraWallet(address payable wallet) external onlyOwner{
        _extraWalletAddress = wallet;
    }
    ...
    function _takeExtra(uint256 tExtra) private {
        uint256 currentRate =  _getRate();
        uint256 rExtra = tExtra.mul(currentRate);
        _rOwned[_extraWalletAddress] = _rOwned[_extraWalletAddress].add(rExtra);
        if(_isExcluded[_extraWalletAddress])
            _tOwned[_extraWalletAddress] = _tOwned[_extraWalletAddress].add(tExtra);
    }
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, extra, liquidity fee
