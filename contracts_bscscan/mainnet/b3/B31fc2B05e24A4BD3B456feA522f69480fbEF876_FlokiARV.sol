...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x6679eB24F59dFe111864AEc72B443d1Da666B360);
...
contract FlokiARV is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x6679eB24F59dFe111864AEc72B443d1Da666B360;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

        string constant _name = "FlokiARV";
    string constant _symbol = "FARV";
