...
/**
    ...
    Paying tribute to the late singer and legend Michael Jackson
    Baby Michael Jackson is here to give you money in ETH rewards

    https://t.me/babymichaeljackson
...
contract BABYMJ is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMichaelJackson";
    string constant _symbol = "BABYMJ";
