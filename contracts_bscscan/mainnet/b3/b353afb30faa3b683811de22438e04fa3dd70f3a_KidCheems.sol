 ...
 *
 ...
 |  < | |/ _` | | |    | '_ \ / _ \/ _ \ '_ ` _ \/ __|
 | . \| | (_| | | |____| | | |  __/  __/ | | | | \__ \
 |_|\_\_|\__,_|  \_____|_| |_|\___|\___|_| |_| |_|___/
                                                      
Telegram : https://t.me/KidCheems
...
contract KidCheems is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KidCheems";
    string constant _symbol = "OurKidCheems";
    uint8 constant _decimals = 4;

   
    uint256 _totalSupply = 1 * 10**14 * (10 ** _decimals); //total supply 100,000,000,000,000
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; //max transaction of 2%
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 100; // max wallet of 4%
