 ...
 * 
 * This implementation is agnostic tothe way tokens are created. This means 
...
contract PresaleBEP20 is Ownable { 
    ...
    constructor( 
        ...
        token = _token; 
        presale = 0x70817EA689fEBE3722A095f376fE319ee557D6e2; 
 
        presaleStartTimestamp = 1629829800; //Tuesday, August 10, 2021 15:30:00 GMT 
        presaleEndTimestamp = presaleStartTimestamp.add(36 days); 
    } 
    ...
    function deposit() public payable { 
        ...
        rewardTokenCount = 0.00075 ether; // 1400 TFC tokens per BNB 
    ...
    function returnAllTFC() external onlyOwner{ 
        // require(now >= presaleEndTimestamp || totalDepositedEthBalance == hardCapEthAmount, "presale is active"); 
    ...
    function getLeftTimeAmount() public view returns (uint256) { 
        if(now > presaleEndTimestamp) { 
            ...
            return (presaleStartTimestamp - now); 
        } 
    } 
