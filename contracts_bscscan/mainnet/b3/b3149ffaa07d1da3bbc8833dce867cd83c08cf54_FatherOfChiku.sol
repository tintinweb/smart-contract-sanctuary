...
contract FatherOfChiku is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4; //Input the token address of whatever your reward is. leave 431,432,433 as is. FLOKI rewards.
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FatherOfChiku";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    //max wallet holding % 
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 100;  // 2 is the percentage of max wallet.
    ...
    uint256 private liquidityFee    = 2; //fees.
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // will start swapping once 0.01% of supply is in the swap wallet
    bool inSwap;
