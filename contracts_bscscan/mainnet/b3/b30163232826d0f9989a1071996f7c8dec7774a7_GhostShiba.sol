...
contract GhostShibaDividendDistributor is IDividendDistributor {
...
contract GhostShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GhostShiba";
    ...
    */
    ...
    GhostShibaDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new GhostShibaDividendDistributor(address(router), Shiba);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        Shiba = rewardToken;
        distributor = new GhostShibaDividendDistributor(address(router), rewardToken);
    }	
