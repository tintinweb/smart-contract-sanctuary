...
interface MetaCharity1 {
  ...
  /**
   * @dev MetaChain `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev MetaChain `amount` tokens from `sender` to `recipient` using the
...
contract MetaNite is MetaCharity1, Context, MetaChain  {
  
    // common addresses
    address private _owner;
    address private MetaCharity;
    address private MetaTeam;
    ...
    string public override name = "MetaNite";
    string public override symbol = "MetaNite";
    ...
    constructor(uint totalSupplyValue, address MetaCharityAddress, address MetaTeamAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MetaCharity = MetaCharityAddress;
        MetaTeam = MetaTeamAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MetaCharity] =  totalSupply * 45 / 100;
        balances[MetaTeam] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's MetaChain pot
