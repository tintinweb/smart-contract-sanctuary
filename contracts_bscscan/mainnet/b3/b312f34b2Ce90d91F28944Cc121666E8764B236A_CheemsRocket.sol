...
contract CheemsRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address payable public marketingAddress = payable(0xb857eee841859764c97E93a8C37146919704B8B7); // Marketing Address
    ...
    string private _name = "Cheems Rocket";
    string private _symbol = "$CheemsRocket";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xb857eee841859764c97E93a8C37146919704B8B7);
    }
