...
/*
* WINNIETHEPOOHCOIN ($POOH)
*
* Tokenomics will be a tax of 10% Buy, 20% Sell and 40% to transfer between wallets 
*
* 50% for liquidity 
* 10% to burn wallet 
* 20% to staking
...
*
* Total Supply 99
* Max per Holder: 1 for 10 mins, 2 for 20 mins then 3 forever
* Max sell: 1
* Sell cool down: 60 minutes
*
* Offers ETH rewards
*
* t.me/WinnieThePoohcoin
* 
*/
...
contract WINNITHEPOOHCOIN is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'WINNIETHEPOOHCOIN';
    string private constant _symbol = '$POOH';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 99 * 10**_decimals;//equals 10000 token

    //Divider for the MaxBalance based on circulating Supply 
    uint8 public constant BalanceLimitDivider=99;
    //Divider for sellLimit based on circulating Supply 
    uint16 public constant SellLimitDivider=99;
    //Sellers get locked for MaxSellLockTime so they can't dump repeatedly
    uint16 public constant MaxSellLockTime= 60 minutes;
    ...
    address public constant TeamWallet=0xCFA82983d028F846C69580d997b7c19a605bFB64;
    ...
    constructor () {
        ...
        //ets sellLockTime to be max by default
    ...
    //Contract, pancake and burnAddress are excluded, other adresses like CEX
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;  //Binance-Peg Ethereum Token
