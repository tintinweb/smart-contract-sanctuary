...
contract HERO is IBEP20, Auth {
    using SafeMath for uint256;

    address HERO = 0xe267018C943E77992e7e515724B07b9CE7938124;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Hero Shiba";
    string constant _symbol = "HERO SHIBA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 50; // 2000
    uint256 public _maxWalletToken = _totalSupply / 16; // 6250;
    ...
    uint256 public swapThreshold = _totalSupply / 40; 
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x50aC4D853C1dB42698626c657582648b84412EEe;
