...
/*   bnbssssssssss - Community Experimental yield farm on Binance Smart Chain.
 *   The only official platform of original bnbssssssssss team! All other platforms with the same contract code are FAKE!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://bnbssssssssss.finance                                     │
 *   │                                                                       │
 *   │                                                                       │
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 ...
 *   - Total income: based on your tarrif plan (from 25% daily) 
 *   - Earnings every moment, withdraw any time
 *
 *   [AFFILIATE PROGRAM]
 *
 *   - 3-level referral reward: 15%  6%  3%
 *
 *   [FUNDS DISTRIBUTION]
 *
...
contract bnbssssssssss {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 0.01 ether; // 0.01 bnb
	uint256[] public REFERRAL_PERCENTS = [150, 60, 30, 1, 1];
	...
	function withdraw() public {
		...
		commissionWallet.transfer(fee2);
