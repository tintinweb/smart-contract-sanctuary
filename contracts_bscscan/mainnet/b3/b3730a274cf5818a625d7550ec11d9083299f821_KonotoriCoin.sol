...
/**
 * Welcome to KonotoriCoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @KonotoriCoinChat
   ...
   I will renounce the ownership to burn addresses to transfer #KonotoriCoin to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 10% total supply to the pool
   Can you make #KonotoriCoin 10000X? 
   ...
   it's the best part of the #KonotoriCoin idea, increasing the liquidity pool automatically, 
...
contract KonotoriCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "KonotoriCoin";
