...
FuckSquidGame $FUCKSQUID is a brand new P2E token built on the newest and the safest pragma solidity version.
...
-0% buy tax.
-0% sell tax.
-$FUCKSQUID liquidity will locked for 1 year on Mudra LP locker. It makes the token unruggable.
...
contract FuckSquidFuckSquid is Context, IERC20, IERC20Metadata, Ownable {   
