 ...
 */
 ...
 contract TalkadoNFT is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("TalkadoNFT", "TNFT") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xf1Ef998e1283b72E215c270f13d28164629E9976); 
          _setupRole(MINTER_ROLE, 0xf1Ef998e1283b72E215c270f13d28164629E9976); 
          _setupRole(MINTER_ADMIN_ROLE, 0xf1Ef998e1283b72E215c270f13d28164629E9976); 
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xf1Ef998e1283b72E215c270f13d28164629E9976);  
     }
     ...
     function mint_by_id(address to, uint256 tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "TalkadoNFT/minter-role-required");
         _mint(to, tokenId);
     }      
     /**
