...
/**
SAFEMOONESPORT COIN
EARN SafeMoon + CAKE automatically on our wallet every 60 minutes
FAIRLAUNCH
burn 50%
Lp lock 3 years
no dev wallet
...
contract SAFEMOONESPORT is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _GetBuyBackTimeInterval = 1;
  uint256 public _Safemoon = 3;
