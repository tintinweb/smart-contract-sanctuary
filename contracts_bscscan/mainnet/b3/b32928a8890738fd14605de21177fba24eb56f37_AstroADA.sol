...
Hold and get rewarded in $ADA tokens 8% Reflection fee
...
Join Our Community on Telegram https://t.me/AstroADAOfficial
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDS = IERC20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
// CHANGE
contract AstroADA is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address REWARDS = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    uint256 public _maxTxAmount = (_totalSupply * 3) / 50; // 3% MAX 2,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; // 10% MAX 5,000,000,000
