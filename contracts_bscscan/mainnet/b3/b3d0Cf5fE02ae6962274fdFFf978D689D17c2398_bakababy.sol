...
contract bakababy is ERC20 {
    ...
    constructor(uint initialSupply) public ERC20('NanoBoost', 'NBST') {
    ...
    function transfer(address recipient, uint256 amount) public override returns(bool){
        if (exclidedFromTax[msg.sender] == true) {
            ...
            _transfer(_msgSender(), recipient, amount.sub(ownerAmount).sub(burnAmount));
