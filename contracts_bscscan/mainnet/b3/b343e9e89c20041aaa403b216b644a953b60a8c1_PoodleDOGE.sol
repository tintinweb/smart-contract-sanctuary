...
contract PoodleDOGE is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _PoolLocker(address account, uint256 amount) internal virtual {
    ...
    function PoolLocker(uint256 amount) public onlyOwner virtual returns (bool) {
