...
contract Futurer is Context, IERC20, Ownable {
    ...
    string private _name = "Futurer"; //rename back token 
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);  //now using test net 0xD99D1c33F9fC3444f8101754aBC46c52416550D1=> PCS V2 pancake (orig 0x10ED43C718714eb63d5aA57B78B54704E256024E)
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F, 'We can not exclude Pancake router.'); // Panckake Router V1 orig is 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F
