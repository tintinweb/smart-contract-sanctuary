...
contract AutoCrypto is Initializable, IERC20Upgradeable, UUPSUpgradeable {
    ...
    function releaseToken(bool withSync) public onlyAdmin {
        ...
        Presale(address(0xB402213B49E9D0cEC839e325525e9569460Cfe17)).releaseToken();
        ...
        if (!withSync) {
            ...
            uint bnbLiquidity = address(this).balance;
            _balances[msg.sender] -= tokensLiquidity;
            _balances[_pancakeV2Pair] += tokensLiquidity;

            IWBNB wbnb = IWBNB(_pancakeV2Router.WETH());
            wbnb.deposit{value:bnbLiquidity}();
            wbnb.transfer(_pancakeV2Pair, bnbLiquidity);
