...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Flying Chart";
    string private _symbol = "FCHART";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa7C7949840aa7fE96e40856deD834aF34984facE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x372d233c88C0a7242f322F2d7c2be6f116aD8eF6); // BuyBack Address
