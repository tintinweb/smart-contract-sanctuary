...
/*
The World's First Crypto Pup Is BTC Pup
BTC pup has the most insane Litecoin rewards that are generated from the 11% tax on each transaction. 
This is the highest BTC rewards of any reward coin released so far! You don’t need to do anything to claim your rewards, simply buy and hold BTC Pup in your wallet. 
...
💰Passive Income For Life in BTC, BTC, ETH, BNB, ADA and more every 60 mins for holders
...
contract BTC_DISTRIBUTOR is IDividendDistributor { // TO-DO change contract name
    ...
    IBEP20 BTC = IBEP20(0x4338665CBB7B2485A8855A139b75D5e34AB0DB94); // Reward address
...
contract BTCPup is IBEP20, Auth { // TO-DO change contract name
    ...
    address public BTC = 0x4338665CBB7B2485A8855A139b75D5e34AB0DB94; //Reward address
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address zeroAddress = 0x0000000000000000000000000000000000000000;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public externalAddress = 0x25cFeAe7B7529519AE0a508A088Db1e415e4711f; //TO-DO change external address
    address public autoLiquidityReceiver = 0x25cFeAe7B7529519AE0a508A088Db1e415e4711f; //TO-DO change liquidty owner address
    ...
    uint256 public _maxTokensPerAddress         = 2000000 * 10**8 * 10**_decimals; // Max number of tokens that an address can hold
