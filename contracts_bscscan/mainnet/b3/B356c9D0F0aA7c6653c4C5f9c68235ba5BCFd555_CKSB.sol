...
/**
   ...
   5% Distribute to Marketing wallet
   3% will be distributed between holders
...
contract CKSB  is Context, IERC20, Ownable {
    ...
    string private _name = "CAKESHIBA";
    string private _symbol = "CKSB";
