...
contract ZooMedia is IMedia, ERC721Burnable, ReentrancyGuard {
    ...
    modifier onlyZoo() {
        require(
            ...
            "ZooMedia: Only Zoo contracts can call this method"
        );
        _;
    }

    modifier onlyOwner() {
        require(_owner == msg.sender, "ZooMedia: Only owner has access");
        _;
    }
    ...
    /**
     * @notice On deployment, set the keeper contract address
     ...
     */
    function configure(address _keeperAddress)
        external
        onlyOwner
    {
        require(
    ...
    function mintToken(address owner, IZoo.Token memory token) external override nonReentrant returns (IZoo.Token memory) {
        ...
        _mintForCreator(owner, token.data, "");
