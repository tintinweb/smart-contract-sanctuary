...
contract DAC is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 120000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = 'DAC';
    string private _symbol = 'DAC';
    uint8 private _decimals = 18;

    address private _burnPool = 0xba3F76637Dfd00D7baD9c43205E8B20142e65D49;

    address private fundAddress = address(0x41E7971AE80CB08E17475A9DD8EE16BFFD781B1207);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 0 * 10**18;
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        emit Transfer(sender, _burnPool, tBurn.add(tFund));
