...
contract PAMPINUNFT is Context, IERC20, Ownable {
    ...
    string private    _name = "PAMPINUNFT";
    string private  _symbol = "PAMPINU";
    uint8 private _decimals = 9;
    
    uint256 public                _taxFee = 3; // 3% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 3; // 3% of transactions will be kept for liquidity
    uint256 public               _burnFee = 6; // 6% of transactions will be burned
