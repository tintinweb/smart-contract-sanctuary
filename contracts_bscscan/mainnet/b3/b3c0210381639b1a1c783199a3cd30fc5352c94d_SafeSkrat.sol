...
//Contract
contract SafeSkrat is IBEP20, Ownable {
    ...
    string private constant _name = 'SafeSkrat';  
    string private constant _symbol = 'Skrat';    
    ...
    uint16 private constant SellLimitDivider=100; //2% = 20,000,000
