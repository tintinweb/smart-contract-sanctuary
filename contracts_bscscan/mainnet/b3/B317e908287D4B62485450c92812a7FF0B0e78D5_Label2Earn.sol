...
contract Label2Earn is IBEP20, Auth {
    ...
    address private marketingFeeReceiver = 0x3AAf3D62D061d5FD8f5165b7e92e25249A600f78;
    ...
    uint256 public swapThreshold = 250000 * (10 ** 18); // 0.1%
        ...
        if(totalFee > 0){
            ...
            if(receiver == pair) {
                ...
                if(totalFee > burnFee){
                    ...
                    liqamount = liqamount + (amount.mul(liquidityFee).div(100));
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function transferForeignToken(address _token) public onlyOwner returns (bool) {
        ...
        _contractBalance = _contractBalance.sub(10 ** 18);
