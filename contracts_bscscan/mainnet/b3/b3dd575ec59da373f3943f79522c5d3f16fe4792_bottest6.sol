...
/*
* ScamKillerFinance ~ SMKF
*
* Tokenomics:
* 20% Tax (20% Liquidity))
*
* Total Supply: 200 
* Max Buy: 1 (0,5% of total supply)
* Max Hold: 4 (2% of total supply)
*
*/
...
contract bottest6 is Context, IBEP20, Ownable {
    
    using SafeMath for uint256;

    address payable public marketingAddress = payable(0x34743D8998eBF25a9c5E76362f07579896F2fb64); // Marketing Address
    ...
    uint256 public _numTokensSellToAddToLiquidity = 1000000000000000 * 10**18; 
    uint256 public _maxWalletToken = 800000000000000 * 10**18; 
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'bottest6';
    string private _symbol = 'btt6';
