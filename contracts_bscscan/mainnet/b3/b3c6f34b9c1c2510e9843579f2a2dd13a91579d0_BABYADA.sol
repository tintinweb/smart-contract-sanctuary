...
contract BABYADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABY ADA";
    string constant _symbol = "BabyADA";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xFF44a28b1e0E6e83Ef5d8B2A530EbFc6B7Bb92Cb;
