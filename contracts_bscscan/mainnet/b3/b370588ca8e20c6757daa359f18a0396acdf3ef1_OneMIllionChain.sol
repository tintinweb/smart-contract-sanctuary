...
contract OneMIllionChain is Context, IBEP20, Ownable {
    ...
    string private _name     = "One MIllion Chain";
    ...
    uint256 private _minTokenBalance = 5000 * 10**18;
