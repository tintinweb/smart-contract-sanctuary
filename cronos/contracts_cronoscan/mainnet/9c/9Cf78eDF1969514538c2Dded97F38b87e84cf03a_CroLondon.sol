...
contract CroLondon is IBEP20, Auth {
    ...
    string constant _name = "CroLondon";
    string constant _symbol = "$CroLDN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 6) / 100;  //1% max tx
    uint256 public _maxWalletSize = (_totalSupply * 6) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver = 0x3dC17aA11c4c33A2c5844C9737117E9fF179bd34;
    address private teamFeeReceiver = 0x3dC17aA11c4c33A2c5844C9737117E9fF179bd34;
