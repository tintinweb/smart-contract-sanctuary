 ...
 * ZEUS
 *
 * Welcome to most promising and exciting token on Cronos
 *
 * Join the movement and invest in ZEUS - most powerful Cronos's son!
 *
 * https://t.me/zeustokencro
 */
...
contract Zeus is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 44 * 10**8 * 10**_decimals;
