...
//
// The Cryptoback Gorillas Honorary NFT series is a limited collection of unique, custom designed NFTs made exclusive
// to Cryptoback Gorilla NFT holders.
//
// The Honorary Ebisu’s Bay Cryptoback Gorilla is among the first in our series of Honorary NFTs. 19 Honorary Ebisu
// Cryptoback NFTs were created and airdropped as part of our partnership with Ebisu’s Bay to celebrate the official
// listing of our NFT collection on the first and leading marketplace on Cronos.
// https://app.ebisusbay.com/collection/cryptoback-gorillas
//
// Cryptoback Gorillas - An enriched collection of 10,000 NFTs on the Cronos Chain. Join our members-only collective
// and gain access to the premier NFT project on Cronos.
// https://cryptobackgorillas.com/
//
//
...
contract CryptobackGorillasHonorary is ERC721Enumerable, Ownable, Withdraw {
    using SafeMath for uint256;
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI, uint256 _maxSupply) ERC721("CryptobackGorillasHonorary", "CBGH") {
        setBaseURI(_initBaseURI);
        CBGRemaining = _maxSupply;
        setSale("PUBLIC", Sale(3093527998800, 3093527998800, MAX_PUBLIC, 3, 500 ether, false));
    }
