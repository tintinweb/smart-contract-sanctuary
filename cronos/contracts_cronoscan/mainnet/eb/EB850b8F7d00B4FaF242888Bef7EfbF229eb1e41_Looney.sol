    ...
    ERC2981
{
    ...
    function mint(uint256 _mintAmount) public payable whenNotPaused {
        require(publicStartTime != 0 || block.timestamp >= whitelistStartTime, "not started");
    ...
    function setPublicStartTime(uint256 _startTime) external onlyOwner {
        ...
        whitelistStartTime = _startTime - 1 hours;
    }
...
// File contracts/drops/Looney.sol

// 
pragma solidity ^0.8.4;

contract Looney is Drop
{
    constructor(address _marketAddress) Drop(
        "Looney",
        "LC",
        "ipfs://QmevjA4WJNtxUtjwdZ12Nm8ywwMsyoqgW17ejYz4sHwKp1",
        2200,
        10,
        0,
        _marketAddress
