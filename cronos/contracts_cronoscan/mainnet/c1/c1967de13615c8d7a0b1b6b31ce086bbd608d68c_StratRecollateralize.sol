...
// File contracts/treasury/Strat_Recollateralize.sol
...
contract StratRecollateralize is Ownable {
    ...
    function recollateralize(uint256 _amount) external onlyOwner {
        ...
        treasury.requestFund(address(WethUtils.MMF), _amount);
        WethUtils.MMF.safeTransferFrom(address(treasury), address(this), _amount);

        WethUtils.MMF.safeIncreaseAllowance(address(pool), _amount);
