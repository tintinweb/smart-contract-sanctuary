...
contract SaharaDaoZapMMSwap is Ownable, ReentrancyGuard {
    ...
    address public constant mmfAddress = 0x97749c9B61F878a880DfE312d2594AE07AEd7656; // MMF
    ...
    function zap(
        ...
        IERC20(mmfAddress).safeTransferFrom(msg.sender, address(this), _ethIn);
        ...
        approveToken(mmfAddress, address(uniRouter), _ethAmtToAddLP);
        ...
        if (_transferResidual) {
            ...
            if (_ethAmtToAddLP > _ethAmtUsedInLp) {
                IERC20(mmfAddress).safeTransfer(msg.sender, _ethAmtToAddLP - _ethAmtUsedInLp);
            }
        }
    ...
    function doSwapETH(address _toToken, uint256 _ethAmt) internal returns (uint256 _tokenReceived) {
        ...
        approveToken(mmfAddress, address(uniRouter), _ethAmt);
