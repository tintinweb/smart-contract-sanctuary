...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract Epoch is Operator {
        ...
        modifier checkEpoch {
            ...
            if (now < _nextEpochPoint) {
                require(msg.sender == operator() || msg.sender == owner() || msg.sender == caller, 'Epoch: only operator allowed for pre-epoch');
                _;
            } else {
                _;
    ...
    contract Oracle is Epoch {
        ...
        /* ========== STATE VARIABLES ========== */
        address public constant dollar = address(0x6D6D6ba0c7e7DBaFffeC82b1ddF92e271650a63A);
