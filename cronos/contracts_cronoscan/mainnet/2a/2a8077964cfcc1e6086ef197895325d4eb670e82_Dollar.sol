...
contract Dollar is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 50000 ether; // 50000 of tokens
     ...
     */
    constructor() public ERC20("Pegasus MMF", "PMMF") {
        _mint(msg.sender, 60000 ether);//  Lauchpad & Init LP & DAO fund(60000 token)
    }
