...
// File contracts/SwapStrategyPOLMUSD.sol
...
*/
contract SwapStrategyPOLMUSD is ISwapStrategy, Ownable {
    using SafeERC20 for IERC20;
    ...
    function execute(uint256 _wethIn, uint256 _yTokenOut) external override {
        WethUtils.MUSD.safeTransferFrom(msg.sender, address(this), _wethIn);
    ...
    function addLiquidity(
        ...
        if (yTokenAmt > 0 && wethAmt > 0) {
            ...
            WethUtils.MUSD.safeIncreaseAllowance(address(swapRouter), wethAmt);
            (uint256 _amountA, uint256 _amountB, uint256 _liquidity) = swapRouter.addLiquidity(
                address(yToken),
                address(WethUtils.MUSD),
                yTokenAmt,
                wethAmt,
                _minYTokenOut,
                _minWethOut,
    ...
    function cleanDust() external onlyOwner {
        ...
        WethUtils.MUSD.safeTransfer(treasury, WethUtils.MUSD.balanceOf(address(this)));
    }
