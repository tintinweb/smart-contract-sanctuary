...
contract CROnetics is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CROnetics";
    string constant _symbol = "NETICS";
    ...
    uint256 public _maxTxAmount = 100 * 10**3 * (10 ** _decimals);
    uint256 public _walletMax = 350 * 10**3 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xC7fB2302846eA6318c726943601147B525294f7d;
        marketingWallet = 0x8a595AEffBcDabB9f86dFfA5AF0c0C035C2e2CB3;
        devWallet = 0xC7fB2302846eA6318c726943601147B525294f7d;
