...
contract FuckCelos is ICRC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FuckCelos";
    string constant _symbol = "FuckCelos";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x76F7E0A70806a22950e392dCb0076C6A62183FBc;
        marketingWallet = 0xE7FBB1B8f59A68e84491A31220D1c52e6ccB9C27;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
        ...
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee);
        totalFeeIfSelling = totalFee.add(extraFeeOnSell);
        require(totalFeeIfSelling <=20, "Total fee is over 20%");
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountCROMarketing.mul(3).div(4);
        uint256 devShare = amountCROMarketing.sub(marketingShare);
