...
contract RumbleRoosNFT is IERC721, Ownable {
    using Address for address;
    using Strings for uint256;

    string private _name = "Rumble Roos";
    string private _symbol = "Roos";

    uint16 public devSupply = 0;
    uint16 public pubsaleSupply = 2000;
