...
contract DUMMYv5Token is IBEP20, Auth {
    ...
    string constant _name = "DUMMYv5";
    string constant _symbol = "DUMMYv5";
    ...
    address private marketingFeeReceiver = 0x13aae1F2056957af66d028DEb617102fD03498C4;
    address private teamFeeReceiver = 0x13aae1F2056957af66d028DEb617102fD03498C4;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x11d51988A1332754c9Ee2C2F4aC6632DE5316327);
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >=  _totalSupply / 4 / 100, "CRONEX: Max Transaction cannot be below 250 CRONEX"); // _maxTxAmount can only be 250 CRONEX or above. Cannot be set to 0.
        _maxTxAmount = amount;
    }

   function setMaxWallet(uint256 amount) external onlyOwner() {
        require(amount >= _totalSupply * 2 / 100, "CRONEX: Max Wallet cannot be below 2000 CRONEX"); // _maxWalletSize can only be 2000 CRONEX or above. Cannot be set to 0.
    ...
    function rescueCRO() external authorized {
