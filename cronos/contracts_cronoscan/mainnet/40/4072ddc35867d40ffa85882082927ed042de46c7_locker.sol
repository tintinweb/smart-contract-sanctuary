...
contract locker{
    ...
    mapping(address=>bool) public emergencyVote;
    uint256 public emergencyUnlock =0;
    ...
    //deploy a new locker if unlocked in emergency
    function executeEmergencyUnlock() external{
        require(!emergencyVote[msg.sender],"You have already casted your vote");
        if(emergencyUnlock>1){
            unlockTime=0;
            emergencyUnlock=0;
