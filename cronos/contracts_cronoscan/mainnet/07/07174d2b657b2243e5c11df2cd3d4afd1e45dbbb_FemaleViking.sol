    ...
    ERC2981
{
    ...
    function mint(uint256 _mintAmount) public payable whenNotPaused {
        require(whitelistStartTime != 0 && block.timestamp >= whitelistStartTime, "not started");
...
// File contracts/drops/FemaleViking.sol


pragma solidity ^0.8.4;

contract FemaleViking is Drop {
     
    constructor(address _marketAddress) 
        Drop(
            "IcyValkyries",
            "ICYVALK",
            "https://javikantnft.mypinata.cloud/ipfs/QmPowhMyLxyiEjXkyAhoQM3fgkaDVvZEm6dNJ6JJfC9dPw",
            1000,
            8,
            0,
            _marketAddress
