...
contract RewardsContract is ReentrancyGuard, Ownable {
    ...
    address chef = 0xaBAD73Be9fd441731ADb007AdB6C1b03e730A8e0;
    address rewardToken = 0xA46d5775c18837e380eFB3d8Bf9D315bcd028AB1;
    address sphere = 0xc9FDE867a14376829Ab759F4C4871F67e2d3E441;
    address cro = 0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23;
    address mmf = 0x145677FC4d9b8F19B5D56d1820c48e0443049a30;
    address routerTwo = 0xD3B68a35002B1d328a5414cb60Ad95F458a8cf92;
    uint256 pid = 1;
    ...
    function distribute(uint256 amt) public onlyManager {
            accSpherePerShare = accSpherePerShare + amt / tvl();
        }
    ...
    function pendingReward(address _user) public view returns(uint256) {
            ...
            return user.stake * accSpherePerShare - user.rewardTally;
        }
