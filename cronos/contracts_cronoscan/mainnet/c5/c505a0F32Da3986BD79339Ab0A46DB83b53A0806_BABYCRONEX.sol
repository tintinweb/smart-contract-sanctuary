...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x11d51988A1332754c9Ee2C2F4aC6632DE5316327;
    IBEP20 RewardToken = IBEP20(0xDB2Bb0A1481FCF0df33720d80A660dD4d060B6c0);
...
contract BABYCRONEX is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABYCRONEX";
    string constant _symbol = "BCRONEX";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x11d51988A1332754c9Ee2C2F4aC6632DE5316327;
    address RewardToken = 0xDB2Bb0A1481FCF0df33720d80A660dD4d060B6c0; //CRONEX

    uint256 _totalSupply = 200 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = 6000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 6000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x039EC7Ad8Dd1F183DC3e31079b8f50c57Ff08bfB;
        devWallet = 0x039EC7Ad8Dd1F183DC3e31079b8f50c57Ff08bfB;
