 ...
 *                 DEERPROTOCOL
 *
 * Dividend Token that reward $DEER every!
 *
 * Fees on Buy&Sell: 15%
 *
 * OUR GOAL - LISTING - SAFE
 *
 *
 *
 *
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x6D6D6ba0c7e7DBaFffeC82b1ddF92e271650a63A) ; //DEER
...
contract DEERPROTOCOL is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "DEERPROTOCOL";
    string constant _symbol = unicode"DPTL🦌";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x145677FC4d9b8F19B5D56d1820c48e0443049a30;
    address RewardToken = 0x6D6D6ba0c7e7DBaFffeC82b1ddF92e271650a63A; //DEER
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x63298eDfcca1E147cb8b44626c16dbBe905c5A6c;  //
