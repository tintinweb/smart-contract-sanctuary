...
// Penguins Finance
contract PNGToken is ERC20Burnable, Operator {
    using SafeMath for uint256;

    
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 2000 ether; // 2000 of PNG

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the PNG ERC-20 contract.
     */
    constructor() public ERC20("Penguins Finance", "PNG") {
        _mint(msg.sender, 15000 ether);//  Lauchpad & Init LP & DAO fund
    }

    /**
     * @notice Operator mints PNG to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of PNG to mint to
