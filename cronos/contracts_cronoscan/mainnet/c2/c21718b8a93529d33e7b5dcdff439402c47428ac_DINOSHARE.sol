...
// ToxicDeer Finance
contract DINOSHARE is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 XDShare
    ...
    ) public ERC20("DinoPool  Share", "sDINO") {
        _mint(msg.sender, 1 ether); // mint 1 XDSHARE for initial liquidity deployment
