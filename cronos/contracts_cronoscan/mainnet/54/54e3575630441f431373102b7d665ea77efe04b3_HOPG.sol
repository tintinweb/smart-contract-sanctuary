...
contract HOPG is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x1b425b50731D15Daf3C9e45372CD37a2e711F485;
        marketingWallet = 0x3C87B00182dC8AfA2aB34B06D368c31ceAbeaCd4;
        devWallet = 0x5Bb48318A48e795e3Eb9d4D4d619De11F1e43733;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 totalFee = totalFee.sub(liquidityFee.div(2));
        
        uint256 amountLiquidity = amount.mul(liquidityFee).div(totalFee).div(2);
        uint256 amountReflection = amount.mul(rewardsFee).div(totalFee);
        uint256 amountMarketing = amount.sub(amountLiquidity).sub(amountReflection);

        try dividendDistributor.deposit{value: amountReflection}() {} catch {}
        
        uint256 marketingShare = amountMarketing.mul(3).div(4);
        uint256 devShare = amountMarketing.sub(marketingShare);
