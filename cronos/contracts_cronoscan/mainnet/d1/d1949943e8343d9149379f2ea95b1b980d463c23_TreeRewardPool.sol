...
contract TreeRewardPool is ReentrancyGuard {
    ...
    // The time when tree mining starts.
    uint256 public poolStartTime;

    // The time when tree mining ends.
    uint256 public poolEndTime;

    address public daoFundAddress;

    uint256 public bSharePerSecond = 0.003170 ether; // 100000 tree / (365 days * 24h * 60min * 60s)
