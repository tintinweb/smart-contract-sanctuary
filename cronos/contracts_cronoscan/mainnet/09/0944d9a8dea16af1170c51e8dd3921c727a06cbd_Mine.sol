...
contract Mine is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 MINE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Mine Shares", "MINE") {
        _mint(msg.sender, 1 ether); // mint 1 DARKCRYSTL Share for initial pools deployment
