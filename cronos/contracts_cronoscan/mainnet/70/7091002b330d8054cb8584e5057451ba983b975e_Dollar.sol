...
contract Dollar is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 100000 ether; // 100,000 of tokens
     ...
     */
    constructor() public ERC20("DinoPool Finance", "DINOP") {
        _mint(msg.sender, 200001 ether);//  Launchpad & Init LP & DAO fund(50,000 token)
    }
