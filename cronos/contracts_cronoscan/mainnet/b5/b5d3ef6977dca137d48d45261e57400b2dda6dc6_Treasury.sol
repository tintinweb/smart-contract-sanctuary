...
contract Treasury is ITreasury, ContractGuard, ReentrancyGuard {
    ...
    function togglePegTokenPriceUpdateDisabled(address _token)
        external
        onlyOperator
    {
        pegTokenPriceUpdateDisabled[_token] = !pegTokenPriceUpdateDisabled[
            _token
        ];
    }
    ...
    function _updatedarkPrice() internal {
        if (!pegTokenPriceUpdateDisabled[dark]) {
    ...
    function governanceUpdatePricePegToken(address _pegToken)
        public
        onlyStrategist
    {
