...
contract RewardsContract is ReentrancyGuard, Ownable {
    ...
    address public chef = 0xf6c3e1B489c1e634a3c66876d5A8E19B1A65B252;
    address public rewardToken = 0x6F715158d4B1468528DA002F5941c72fe4159520;
    ...
    function convertToSphere() public payable {
      ...
      IERC20(rewardToken).approve(mmf, rewardBal);
      uint[] memory amounts = IMeerkatRouter02(mmf).swapExactTokensForETH(rewardBal, 0, getPathForRewardToCro(), address(this), block.timestamp);
