...
/**
SUSHIBA Born as a token from the community of sushi and finance lovers.

Our project will operate as 
a Decentralized Autonomous Organization (DAO) with a community-supported governance model. 

web: https://sushiba.digital/
tg: https://t.me/SushibaCronos
╔═══╗╔╗ ╔╗╔═══╗╔╗ ╔╗╔══╗╔══╗ ╔═══╗
║╔═╗║║║ ║║║╔═╗║║║ ║║╚╣╠╝║╔╗║ ║╔═╗║
║╚══╗║║ ║║║╚══╗║╚═╝║ ║║ ║╚╝╚╗║║ ║║
╚══╗║║║ ║║╚══╗║║╔═╗║ ║║ ║╔═╗║║╚═╝║
...
contract SushibaCro is IERC20, Ownable {
