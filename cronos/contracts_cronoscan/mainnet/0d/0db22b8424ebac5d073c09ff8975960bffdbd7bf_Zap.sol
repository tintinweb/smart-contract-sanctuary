...
contract Zap is Ownable {
    ...
    constructor(address _svn) Ownable() {
        wcro = _svn;
        whitelistedRouters[address(0x145863Eb42Cf62847A6Ca784e6416C1682b1b2Ae)] = true; //VVS Router;
        whitelistedRouters[address(0xcd7d16fB918511BF7269eC4f48d61D79Fb26f918)] = true; //Crona Router;
        whitelistedRouters[address(0x145677FC4d9b8F19B5D56d1820c48e0443049a30)] = true; //MMF Router;
    }
