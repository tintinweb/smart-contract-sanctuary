...
contract LeafGenesisRewardPool is ReentrancyGuard {
    ...
    uint256 public totalAllocPoint = 50000;

    // The time when Leaf mining starts.
    uint256 public poolStartTime;

    // The time when Leaf mining ends.
    uint256 public poolEndTime;

    address public daoFundAddress;


    uint256 public basedPerSecond = 0.3472 ether; // 30000 Leaf / (24h * 60min * 60s)
