...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract Epoch is Operator {
        ...
        modifier checkEpoch {
            ...
            if (now < _nextEpochPoint) {
                require(msg.sender == operator()|| msg.sender == owner(), 'Epoch: only operator allowed for pre-epoch');
                _;
            } else {
                _;
    ...
    contract Oracle is Epoch {
        ...
        /* ========== STATE VARIABLES ========== */
        address public constant dollar = address(0xEF4E7B83C6167744C7e0E11cc3CE1CA8c2d2B289);
