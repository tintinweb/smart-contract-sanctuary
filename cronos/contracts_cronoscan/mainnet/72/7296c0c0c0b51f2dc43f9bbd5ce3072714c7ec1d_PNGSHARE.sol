...
contract PNGSHARE is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60000 PNGSHARE
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 40000 ether;
    uint256 public constant TREASURY_FUND_POOL_ALLOCATION = 15000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 3000 ether;
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _treasuryFund) public ERC20("Penguins Share", "SPNG") {
