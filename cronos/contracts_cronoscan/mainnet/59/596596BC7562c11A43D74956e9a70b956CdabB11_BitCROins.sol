...
Telegram: https://t.me/BitCROins

Hold $BITCRO to gain 10% BTC depends on volume and pool
...
contract BitCROins is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BitCROins";
    string constant _symbol = "BitCRO";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xA1Df2135d1B95C2EEa08907f500EAC4611a67B69;
        marketingWallet = 0x3DE181aDB7b0b1F6B984d8517cd64317efcB8f0b;
        devWallet = 0xA1Df2135d1B95C2EEa08907f500EAC4611a67B69;
