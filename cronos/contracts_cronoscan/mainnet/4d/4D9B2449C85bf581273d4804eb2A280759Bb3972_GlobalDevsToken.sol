...
contract GlobalDevsToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Global Devs Token";
    string private constant _symbol = "GDT";
