...
// File: contracts/CougarLiquidityLock.sol
...
/**
 * @dev CGOLiquidityLock contract locks the initial liquidity for a year (LP tokens).
 ...
 * A: If there is an upgrade of CGOSwap AMM, we can migrate the liquidity to our new version exchange.
 *
 */

contract CGOLiquidityLock is Ownable {
    using SafeERC20 for IERC20;

    uint256 public constant unlockTimeStamp = 1667743200;
    ...
    function unlock(IERC20 _token, address _recipient) public onlyOwner {
        require(_recipient != address(0), "CGOLiquidityLock::unlock: ZERO address.");
