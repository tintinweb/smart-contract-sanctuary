...
/*🟠 JUST FAIR LAUNCH Cronos
Roi Shiba is built by a strong team that aims to build a sustainable token for the long run. 
Join Roi Shiba now and become part of this revolution.
🔒 LP LOCKED
🚀 X20 EASY
💰 SHIBA REWARDS
🐕Strong Marketing
🐕Earn  AutoClaim Every 60min
💳 Name: Roi Shiba inu
💠 Symbol: $RoiShiba
💠https://t.me/RoiShiba
...
contract RoiShiba is ContextETH, BinanceBNB, OwnableETH {
    ...
    string private _name = 'Roi Shiba';
    string private _symbol = 'RoiShiba';
