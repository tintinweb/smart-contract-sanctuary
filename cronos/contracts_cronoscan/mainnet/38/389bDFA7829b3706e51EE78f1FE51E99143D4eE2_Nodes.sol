...
contract Nodes {
    ...
    function buyNode(string memory nameForNode, address referralAddr, address def) notPaused public returns (bool) {

        uint bal = erctoken.balanceOf(msg.sender);

        uint priceInUSD = nodePriceInUSD * (10**6);
        ...
        if(!affiliatePaused) {
            ...
            referralNodesTotal[def] = referralNodesTotal[def] + 1;
        }
