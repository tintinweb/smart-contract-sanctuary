...
// File contracts/treasury/Strat_ReduceReserveLP.sol
...
contract StratReduceReserveLP is Ownable {
    ...
    function reduceReserve(uint256 _amount, uint256 _minYTokenAmount) external onlyOwner {
        ...
        swapRouter.removeLiquidity(address(yToken), address(WethUtils.MMF), _amount, 0, 0, address(this), block.timestamp);

        // 2. swap Weth -> YToken
        swap(WethUtils.MMF.balanceOf(address(this)), _minYTokenAmount);
