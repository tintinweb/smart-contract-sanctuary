...
// File: contracts/Manual_Pool.sol
...
contract ManualPool is Ownable, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    
    address public wantAddress; // Staked LP
    address public CGOFarmAddress = 0x5795BE23A2C330209849e0D1D19cc05755E23Ca2;
    address public feeAddress = 0xfB60447C0E2F1F6EF16242741fa51bEa4fB1D805;
    address public govAddress = 0x2e4C48D9a4abde9cCCCF110Bf5F58636d49ef5ee; // Timelock

    uint256 public wantLockedTotal = 0;
    uint256 public sharesTotal = 0;

    uint256 public depositFee = 0;
    uint256 public constant MAX_DEPOSIT_FEE = 300;
        ...
        returns (uint256)
    {
        ...
        if (depositFee > 0) {
            uint256 fee = _wantAmt.mul(depositFee).div(1e4);
            IERC20(wantAddress).safeTransfer(feeAddress, fee);
            _wantAmt = _wantAmt.sub(fee);
        }
    ...
    function setDepositFee(uint256 _depositFee) external onlyAllowGov {
