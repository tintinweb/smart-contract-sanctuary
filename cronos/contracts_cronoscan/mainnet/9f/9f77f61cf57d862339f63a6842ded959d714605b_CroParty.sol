...
contract CroParty is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CRO Party";
    string constant _symbol = "CParty";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6004f7E0e1B4D3fc29ac5610210138599FDfa4F2;
        teamFeeReceiver = 0x6004f7E0e1B4D3fc29ac5610210138599FDfa4F2;
        giveawayFeeReceiver = 0x6004f7E0e1B4D3fc29ac5610210138599FDfa4F2;
 ...
 /*   // switch Trading
    ...
    function swapBack(bool isSell) internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).div(2);
        {
            ...
            uint256 amountBNBIDEXPair = amountBNBReflection.add(amountBNBMarketing).add(amountBNBTeam).add(amountBNBGiveaway);
