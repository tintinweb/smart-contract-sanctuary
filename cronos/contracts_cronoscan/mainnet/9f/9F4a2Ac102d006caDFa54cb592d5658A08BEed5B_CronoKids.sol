...
// File contracts/Drops/CronoKids.sol
...
contract CronoKids is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;
    string public baseURI = "ipfs://QmQMn1s5EKJcpVCTXE6mizSRVQp9117rm7UJ1hjg82cEKF";
    uint8 private currentChunkIndex;
    uint16[] internal order;
    Counters.Counter public _tokenIdCounter;
    
    constructor() 
        ERC721("Cronogodskids", "CGK")
    {}
