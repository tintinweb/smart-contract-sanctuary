...
The Next Generation of Croge.

TG: https://t.me/Crogebagofficial
Twitter: https://twitter.com/Crogebag
Website: TBA Soon
...
contract Crogebag is IBEP20, Auth {
    ...
    string constant _name = "CROGEBAG";
    string constant _symbol = "CROGEBAG";
    ...
    address private marketingFeeReceiver = 0x4c9B8fda042539a85E41D0d1f8D8286dD67802FD;
    address private teamFeeReceiver = 0x41081ef2b6cb45D3aecfA0b0e5443555332D25b3;
    ...
    uint256 public swapThreshold = _totalSupply / 10000000 * 2; // 0.2%
    bool inSwap;
