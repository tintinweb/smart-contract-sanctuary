...
contract PNGSHARE is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 80000 PNG SHARE
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _treasuryFund) public ERC20("Penguins Share", "PSHARE") {
