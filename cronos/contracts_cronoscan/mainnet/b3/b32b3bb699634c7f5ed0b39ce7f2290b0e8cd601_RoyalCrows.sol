...
contract RoyalCrows is ONFT721, ReentrancyGuard {
    ...
    uint256 public wlPrice = 300 ether;
    ...
    constructor()
        ONFT721("RoyalCrows", "RC", 0x1F9D367d68Fc68a30062166f73512e06840aB4a4)
    {
        setBaseURI("");
        setNotRevealedURI(
            "ipfs://QmQgp65nZettA1pxBt6UF1ndmiA39a3xh2i2XPKDF4C1ze/cronos.json"
        );
        nextMintId = 0;
        maxMintId = 300;
    }
