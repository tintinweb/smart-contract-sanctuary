...
//THE BLACK DOLLAR is a Frictionless Yield Redistribution Token on the CRONOS Chain. Simply hold the token to Gain Automatic Restribution Rewards

//🔥Introducing the birth of THE BLACK DOLLAR WITH $BTC!! 🔥
//Rewards are all AUTO Distribution
//TELEGRAM :https://t.me/TBDFINANCE
// TWITTER : https://twitter.com/TBDcrypto
// WEBSITE : BLACKDOLLAR.FINANCE
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x062E66477Faf219F25D27dCED647BF57C3107d52);
...
contract BDFINANCE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "THE BLACK DOLLAR";
    string constant _symbol = "TBD";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x145677FC4d9b8F19B5D56d1820c48e0443049a30;
    address RewardToken = 0x062E66477Faf219F25D27dCED647BF57C3107d52;

    uint256 _totalSupply = 69 * 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 2 * 10**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x621f0d9DBf9e63159bD9750A08582967F0b710F3;
        marketingWallet = 0x2C8C9D363497AA4f31D36aD701eC1428607A47A9;
        devWallet = 0xA88Dc0D00078F02587dEd31150eb7327CF254358;
