...
/**
FireFoxCro is a token born to be driven from his community.
We aim to make the difference in this crazy world of crypto. 
Holders will be rewarderd with 10% MMF token on every buy and sell.

Join Us on Telegram: https://t.me/firefoxcro
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x97749c9B61F878a880DfE312d2594AE07AEd7656);
...
contract Firefoxcro is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FireFoxCro";
    string constant _symbol = "FFC";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x145677FC4d9b8F19B5D56d1820c48e0443049a30;
    address RewardToken = 0x97749c9B61F878a880DfE312d2594AE07AEd7656; //MMF token

    uint256 _totalSupply = 200 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = 4000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 4000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xE92218A279913fdc995E8f5D6c1B65d8c58eB515;
        devWallet = 0xDf68343De0Bfe9062dC94fe34abc155cc130822C;
