/**
 *Submitted for verification at hooscan.com on 2021-06-27
*/
 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is Context, ERC165, AccessControl, IERC721, IERC721Metadata, IERC721Enumerable  {
    ...
    function tokensOf(address owner) external view returns(uint256[] memory ids, string[] memory urls) {       
       uint256 balance = balanceOf(owner);

       ids = new uint256[](balance);

       urls = new string[](balance);
    ...
    function setBaseURI(string memory baseUrl) external onlyRole(CONFIG_ROLE) 
    {
