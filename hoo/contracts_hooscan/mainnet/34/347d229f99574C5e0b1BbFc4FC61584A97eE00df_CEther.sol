...
import "./CETHToken.sol";
import "./ETHInterestRateModel.sol";

contract CEther is CETHToken {
    /**
    ...
    constructor(ComptrollerInterface comptroller_,
                ETHInterestRateModel interestRateModel_,
                uint initialExchangeRateMantissa_,
                string memory name_,
                string memory symbol_,
                uint decimals_) public
    CETHToken(comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_) {}
