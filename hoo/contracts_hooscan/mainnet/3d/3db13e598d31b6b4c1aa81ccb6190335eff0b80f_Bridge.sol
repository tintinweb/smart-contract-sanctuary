/**
 *Submitted for verification at hooscan.com on 2022-01-06
*/
...
contract Bridge is BridgeAdmin, Pausable {
    ...
    function depositNative(string memory _targetAddress, string memory chain, uint value, bool buyNative) public payable {
    ...
    function depositToken(address _token, uint value, string memory _targetAddress, string memory chain, bool buyNative) public payable returns (bool){
