...
contract Fuse is Ownable, ERC721Holder {
    ...
    function fuseNFT(uint[] memory _nftIds) public {
        ...
        nft.safeTransferFrom(address(msg.sender), address(this), _nftIds[1]);
        nft.safeTransferFrom(address(msg.sender), address(this), _nftIds[2]);
        nft.safeTransferFrom(address(msg.sender), address(this), _nftIds[3]);
    }
}
