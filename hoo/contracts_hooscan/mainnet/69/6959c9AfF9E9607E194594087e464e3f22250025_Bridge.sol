...
contract Bridge is Ownable {
    ...
    //mapping(uint256 => uint256) public destAmounts; // chainId -> destination Max Amount,
    ...
    uint256 public destinationAmount; // bu değer aslında bu ağdan çıkabilecek max WST miktarı
    ...
    function setChainId(uint256 _chainId, bool _value) public onlyOwner {
        ...
        require(_chainId != currentChainId, "Cannot add current chain ID.");
