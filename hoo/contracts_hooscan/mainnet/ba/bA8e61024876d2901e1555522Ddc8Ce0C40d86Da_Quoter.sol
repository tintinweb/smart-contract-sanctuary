...
import '@evodefi/evoswap-core/contracts/libraries/SafeCast.sol';
import '@evodefi/evoswap-core/contracts/libraries/TickMath.sol';
import '@evodefi/evoswap-core/contracts/interfaces/IUniswapV3Pool.sol';
import '@evodefi/evoswap-core/contracts/interfaces/callback/IUniswapV3SwapCallback.sol';
...
library PoolAddress {
    ...
    /// @param factory The Evo Swap factory contract address
...
/// @notice Provides validation for callbacks from Evo Swap Pools
library CallbackValidation {
    /// @notice Returns the address of a valid Evo Swap Pool
    /// @param factory The contract address of the Evo Swap factory
...
interface IPeripheryImmutableState {
    /// @return Returns the address of the Evo Swap factory
    function factory() external view returns (address);
