...
// Stealth Launched
// 2k$ Initial Liquidity [600FTM]
// https://t.me/graveyardfinance
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7); // TOMB
...
contract GRAVEYARD is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7; // TOMB
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GRAVEYARD Finance";
    string constant _symbol = "GRAVEYARD";
    ...
    address public autoLiquidityReceiver=0xc3d3604b22A8771f9cF0AAD3a5B989Ee0F693323; //liq address
    address public marketingFeeReceiver=0xc3d3604b22A8771f9cF0AAD3a5B989Ee0F693323; // marketing address
