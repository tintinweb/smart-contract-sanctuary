...
contract sToucanToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Toucan", "sCAN", 9) ERC20Permit() {
    ...
    /**
        @notice increases sCAN supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sCAN
