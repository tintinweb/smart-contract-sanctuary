...
// Stealth Launched
// 1k$ Initial Liquidity [240FTM]
// https://t.me/fantombtc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTC = IBEP20(0x321162Cd933E2Be498Cd2267a90534A804051b11); // BTC
...
contract ftmbtc is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BTC = 0x321162Cd933E2Be498Cd2267a90534A804051b11; // BTC
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FANTOM ETHPrinter";
    string constant _symbol = "FETHp";
    ...
    address public autoLiquidityReceiver=0xD2471938f2523cccC4543B87d39eAC49CCD76e40; //liq address
    address public marketingFeeReceiver=0xD2471938f2523cccC4543B87d39eAC49CCD76e40; // marketing address
