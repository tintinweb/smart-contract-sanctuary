...
/**
Fantomination, new NFT marketplace and swap platform in Fantom network.
*/
...
contract Fantomination is Context, DeployerCERTIK, Ownable {
    ...
    string private _name = 'Fantomination';
    string private _symbol = 'FDOM';
