...
contract FantomFloatyCapital is Context, IERC20, Ownable {
    ...
    string private constant _name = 'FantomFloaty Capital';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xdE44442243944Bdf3BCB2F9e01c02F98988340B1, 'We can not exclude router.');
