...
contract DemeterTest is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 public totalFee =
        liquidityFee.add(Marketing).add(RiskFreeValue);
    ...
    constructor() ERC20Detailed("DemeterTest", "DMTEST", uint8(DECIMALS)) {
        router = IDEXRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29); //Spooky 0xF491e7B69E4244ad4002BC14e878a34207E38c29 // Cake 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        MarketingReceiver = 0xc905d5E3065C0A2727D599F52db0E2cE1b2Ad3B7;
        RiskFreeValueReceiver = 0x66767698f2D545390F40982AC5e58A620b569117;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHMarketing = amountETH.mul(Marketing).div(
            totalETHFee
        );
    ...
    function setFees(
        ...
        sellFee = _sellFee;
        totalFee = liquidityFee.add(Marketing).add(RiskFreeValue);
