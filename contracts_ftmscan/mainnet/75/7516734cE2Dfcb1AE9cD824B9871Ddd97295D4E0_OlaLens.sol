...
contract OlaLens {
    ...
    function getRainBalanceAtRainMaker(DynamicRainMakerForOlaLens rainMaker, EIP20Interface rainyToken, ComptrollerOlaLensInterface comptroller, address account) external returns (RainBalances memory) {
