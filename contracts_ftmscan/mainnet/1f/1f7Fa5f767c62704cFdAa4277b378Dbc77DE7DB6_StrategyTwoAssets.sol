...
//    bytes32 public constant swapPool = 0x03c6b3f09d2504606936b1a4decefad204687890000200000000000000000015; // Beets-USDC pool
    address public constant depositTokenAddr = 0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e; // Beets
//    address public constant depositTokenAddr = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // USDC
    // Pool to deposit
    bytes32 public constant depositpool = 0xcde5a11a4acb4ee4c805352cec57e236bdbc3837000200000000000000000019;
    ...
    // Beets Bar
    address public constant beetsBarAddr = 0xfcef8a994209d6916EB2C86cDD2AFD60Aa6F54b1;
    address public constant beetsFtmAddr = 0xcdE5a11a4ACB4eE4c805352Cec57E236bdBC3837;

    address public multiHarvest = 0x0000000000000000000000000000000000000000;

    // Other constants
    uint256 public constant underlyingPoolId = 22;
    ...
    function harvest() public override nonReentrant {
        ...
        if (_rewardBalance > harvestCutoffBps){
            ...
            // Add liquidity
            addLiquidity();
            // Stake LP into fBeets
            uint256 _beetsFtmBal = IERC20(beetsFtmAddr).balanceOf(address(this));
            IERC20(beetsFtmAddr).safeApprove(beetsBarAddr, 0);
            IERC20(beetsFtmAddr).safeApprove(beetsBarAddr, _beetsFtmBal);
            IBeetsBar(beetsBarAddr).enter(_beetsFtmBal);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public LP_TOKEN = 0xfcef8a994209d6916EB2C86cDD2AFD60Aa6F54b1;
    constructor()
        public
