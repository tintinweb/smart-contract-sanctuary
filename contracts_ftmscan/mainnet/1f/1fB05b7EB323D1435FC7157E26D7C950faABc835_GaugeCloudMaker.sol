...
contract GaugeCloudMaker is SingleGaugeInteractor, CloudsMakerInterface {
    ...
    function condenseAndDispense() override external {
        // Safety
        ...
        // Dispense
        transferAllDistributionBalanceToTarget();
    }
    ...
    function transferAllDistributionBalanceToTarget() internal {
...
abstract contract CloudsMakerInterface {
     ...
     */
    function condenseAndDispense() virtual external;
}
