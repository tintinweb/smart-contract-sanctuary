...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x321162Cd933E2Be498Cd2267a90534A804051b11); // ETH
...
contract WraithBTCPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x321162Cd933E2Be498Cd2267a90534A804051b11; // ETH
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "WraithBTCPrinter";
    string constant _symbol = "WBTCp";
    ...
    address public autoLiquidityReceiver=0xE73f3c90F9F0719D1bd65dFEbDF9d1FC97C23CD8; //liq address
    address public marketingFeeReceiver=0xE73f3c90F9F0719D1bd65dFEbDF9d1FC97C23CD8; // marketing address
