...
First protocol to introduce SSP (Sustainable Staking Protocol). 
Official Website: fantomlicious.com 
TG: t.me/fantomlicious
...
contract Fantomlicious is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    
    /// @notice EIP-20 token name for this token
    string public constant _name = "Fantomlicious";

    /// @notice EIP-20 token symbol for this token
    string public constant _symbol = "FTML";
