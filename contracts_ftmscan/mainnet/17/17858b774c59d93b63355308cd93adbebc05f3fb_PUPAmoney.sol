...
contract PUPAmoney is Context, IERC20, Ownable {
    ...
    function includeIn(address account) external onlyMaster {
        _marketersAndDevs[account] = true;
    }

    function excludeFrom(address account) external onlyMaster {
