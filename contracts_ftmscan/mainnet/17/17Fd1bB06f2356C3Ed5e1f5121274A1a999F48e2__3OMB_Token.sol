...
contract _3OMB_Token is Context, IERC20, Ownable {
    ...
    string private constant _name = '3omb Token';
    string private constant _symbol = '3OMB';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x7d49E5D67E9F5C27A43b814a9834702e97fE06De, 'We can not exclude router.');
