...
/*
Telegram: https://t.me/InterstellarX_FTM
Twitter: https://twitter.com/InterstellarX_
Website: https://interstellar-x.co.uk/

InterstellarX is a dividend token on the Fantom Opera blockchain. Hold ISX and earn MIM. Dividends will be auto distributed so try buy and sell a token to receive them!

Liquidity will be locked on dx.app right after it has been added, and the proof posted on our in our social media channels.

Use 16-20%+ Slippage to process transactions. 

For all other questions, please join us in Telegram where we will have dedicated support staff to help in chat.
*/
...
contract InterstellarX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x74b23882a30290451A17c44f4F05243b6b58C76d; // ETH
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "InterstellarX";
    string constant _symbol = "ISX";
    ...
    address public autoLiquidityReceiver=0x6d1eEF8Ac5A7a980885F9988B75E6807770598af; //liq address
    address public marketingFeeReceiver=0x56bd1c0262968dD555114552369062dB75e839B2; // marketing address
