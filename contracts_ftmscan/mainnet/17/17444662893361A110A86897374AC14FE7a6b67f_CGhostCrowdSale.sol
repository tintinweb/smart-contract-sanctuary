...
contract CGhostCrowdSale is GhostCrowdSale {
...
contract GhostCrowdSale is Ownable, ReentrancyGuard {
    ...
    address public liquidityPoolFund;
    ...
    function _preValidatePurchase(address beneficiary, uint256 allowance, uint256 daiAmount) internal onlyWhileOpen view {
        ...
        require(allowance >= _minCap, "GhostCrowdSale: minCap breached");
        require(allowance <= _maxCap, "GhostCrowdSale: maxCap breached");
