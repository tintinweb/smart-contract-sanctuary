...
*/
contract Cowboy is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("COWBOY", "COWBOY") {
        _mint(msg.sender, 1 ether); // mint 1 COWBOY for initial pools deployment
