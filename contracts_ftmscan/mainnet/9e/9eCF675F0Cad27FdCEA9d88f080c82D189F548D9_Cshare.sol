...
contract Cshare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("CSHARE Token", "CSHARES") {
        _mint(msg.sender, 10 ether); // mint 1 CSHARE Share for initial pools deployment
