...
contract BondDepositoryDAI is Ownable{
    ...
    constructor(address _gatev2 ){
        ...
        uint _maxPayout = 500000;
        uint _fee = 500000;
        uint _maxDebt = 500000;
    ...
    function setPayout(uint _input) external onlyOwner{
    ...
    function deposit2( 
        ...
        value = ICollateralReserveV2( collateralReserveV2 ).valueOf( principle, _amount );
        // uint payout = payoutFor( value ); // payout to bonder is computed
        // return FixedPoint.fraction( _value, bondPrice() ).decode112with18().div( 1e16 );
        payout = FixedPoint.fraction( value, nativePrice ).decode112with18().div( 1e16 );

        maxpayout = maxPayout();
        // require( payout >= 10000000, "Bond too small" ); // must be > 0.01 COUSD ( underflow protection )
