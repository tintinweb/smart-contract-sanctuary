...
import "./LucidSale.sol";


contract LucidPublicSale is LucidSale, Ownable {
	...
	) LucidSale(_rate, _cap, _treasuryWallet, _token, _buyToken, _openingTime, _closingTime, _tokensForSale, emptyList){
	}
