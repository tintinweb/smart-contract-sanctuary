...
- You buy on Fantom, I farm on OLYMPUS DAO fork and return the profits to $RYOSHICP holders.

Tokenomics:
- 10% of each buy goes to existing holders.
- 15% of each sell goes into multi-chain farming to add to the treasury.

WAIT, THERE IS MORE. It's not just a copy paste contract 
+ Added Max wallet to prevent whale buying too much and dump on you
+ Added Max Sell to prevent hard dumping. We need whale involved, guys !
+ LP lock 1 months then extend to 1 year
+ Contract WILL BE RENOUNCED right after locking LP 

TO MAKE SURE IT'S SAFE JUST WAIT FOR LOCK LP + RENOUNCED BEFORE YOU BUY !
Contract renounce + LP lock you can check on Website 

Telegram: 
https://t.me/RyoshisCapitalFantom

Telegram: 
https://ryoshicapital.farm/
...
pragma solidity ^0.8.0;
    ...
    contract RyoshisCapital is Context, IERC20, Ownable {
        ...
        constructor () public {
            _MCCWalletAddress = payable(0x671DcC4C7408B86d3721D0b6B969d3C0688a2173);
            _marketingWalletAddress = payable(0x671DcC4C7408B86d3721D0b6B969d3C0688a2173);
