...
contract NativeFarm is Ownable, ReentrancyGuard {
    ...
    // Token address
    address public constant NATIVE = 0xD036B7a53073C829f4dEE3F3Ba2c66f622E55493;
    // Owner reward per block: 10% ==> 11.11%
    uint256 public constant ownerNATIVEReward = 1111;
    // Native total supply: 1.690420 mil = 1690420e18
    uint256 public constant NATIVEMaxSupply = 1510420e18;
    // Natives per block: (0.09648515981 - owner 10%)
    uint256 public constant NATIVEPerBlock = 96485159810000000; // NATIVE tokens created per block
    // Approx 15/7/2021
    uint256 public constant startBlock = 26506815; // https://ftmscan.com/block/26506815
