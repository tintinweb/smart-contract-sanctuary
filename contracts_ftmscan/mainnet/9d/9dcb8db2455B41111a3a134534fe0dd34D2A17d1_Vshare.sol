...
contract Vshare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 Vshare
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("VSHARE", "VSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 VEXA Share for initial pools deployment
