...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 public REWARD_TOKEN = IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
...
contract ReinDoge is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ReinDoge";
    ...
    uint256 public sellMultiplier  = 100; //1x i.e 5x4= 20% on Sell
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 25122021 * 10**_decimals;
    ...
    uint256 public _maxTxAmount = rSupply.div(100).mul(2);      //1%
    uint256 public _maxWalletToken = rSupply.div(100).mul(4); //2%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc4E044Cef5AAA72A6143e7D46e8Cb1d170559616;
        LotteryFeeReceiver = 0x56B37CE181D15359A2813791705BA04a38657B49;
