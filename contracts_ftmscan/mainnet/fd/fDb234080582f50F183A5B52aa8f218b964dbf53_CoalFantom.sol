...
/*
    Coal Fantom is the next fancy meme token in the Opera Chain.

    https://t.me/CoalFTM
   
    Taxes
    2% LP
    AND THAT’S ALL –applies for buys and sells-.
...
contract CoalFantom is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Fantom Space Moon';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xf8Cd3FAfDa88cD9fa5054a28aa90c5480Ca8d050, 'We can not exclude router.');
