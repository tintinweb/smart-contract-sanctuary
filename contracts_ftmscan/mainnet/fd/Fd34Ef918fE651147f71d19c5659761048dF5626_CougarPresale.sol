...
contract CougarPresale is ReentrancyGuard {
    ...
    // Price of presale COUGAR: 0.15 BuyToken
    uint256 private constant BuyTokenPerCGS = 15;

    // Time per percent
    uint256 private constant timePerPercent = 600;

    // Max Buy Per User
    uint256 public maxBuyPerUser = 200*(1e6); // decimal 6

    uint256 public firstHarvestTimestamp;

    address payable owner;

    uint256 public constant COUGAR_HARDCAP = 500*(1e6);
