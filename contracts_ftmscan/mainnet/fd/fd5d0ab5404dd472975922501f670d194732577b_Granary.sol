...
interface IMasterchef {
	...
	struct PoolInfo {
        ...
        uint256 allocPoint;         // How many allocation points assigned to this pool. BOOB to distribute per block.
        uint256 lastRewardTime;     // Last block time that BOOB distribution occurs.
        uint256 accBoobPerShare;    // Accumulated BOOB per share, times 1e12. See below.
	...
	*/
	...
	function info() public view returns (uint256, uint256, uint256, IMasterchef.UserInfo memory, IMasterchef.PoolInfo memory, uint256, bool, uint256)
	{
		...
		return(
			...
			mc.pendingToken(allnums[0],address(this))
		);
	}
