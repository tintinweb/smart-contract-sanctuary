...
// No frills, no BS, IronBank Printer token
// https://t.me/ironbank_printer
...
// Dependency file: contracts/baby/IronBankPRINTERDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeIronBankDividends(uint256 amount) public onlyOwner {
...
contract IronBankPRINTERDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main IronBankPRINTER contract."
        );
    }
...
// Root file: contracts/baby/IronBankPRINTER.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/IronBankPRINTERDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract IronBankPRINTER is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    IronBankPRINTERDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = IronBankPRINTERDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "IronBankPRINTER: The dividend tracker already has that address"
        );

        IronBankPRINTERDividendTracker newDividendTracker = IronBankPRINTERDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "IronBankPRINTER: The new dividend tracker must be owned by the IronBankPRINTER token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "IronBankPRINTER: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "IronBankPRINTER: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != UniswapV2Pair,
            "IronBankPRINTER: The Pancakeswap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "IronBankPRINTER: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "IronBankPRINTER: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "IronBankPRINTER: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialIronBankBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForIronBank(tokens);
        uint256 newBalance = (IERC20(rewardToken).balanceOf(address(this))).sub(
            initialIronBankBalance
        );
    ...
    function swapTokensForIronBank(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeIronBankDividends(dividends);
