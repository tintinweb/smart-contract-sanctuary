...
/**
 wen lunchhhhhh , this is a attemp to gain attention of andre , ser i have been awwake for 36 hours waiting for the lunch , i neeed sleep . but i want to feed the village too, 
 this is my way of doin a protest , wen lunch
 IF YOU ARE ALSO WAITING FOR THE LAUNCH ape this coin u degenerate and help in reaching andre
 tg:WENLAUNCHANDRE
*/
...
contract WENLAUNCHANDRE is IERC20, Auth {
    ...
    string constant _name = "WENLAUNCH";

    string constant _symbol = "ANDRE";
