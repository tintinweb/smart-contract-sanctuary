...
contract SpookyFantomTusdUsdcStrategy is MasterChefBaseStrategy {
    constructor() public {}
        ...
        initializer
    {
        ...
        uint256 poolId = 45; // TusdUsdc Pool id
        ...
        MasterChefBaseStrategy.initializeMasterChefBaseStrategy(
            ...
            _parentStrategy,
            underlying,
            address(0x2b2929E785374c651a81A63878Ab22742656DcDd), // SpookySwap MasterChef Staking Pool
        ...
        address tusd = address(0x9879aBDea01a879644185341F7aF7d8343556B7a);

        rewardRoutes[tusd] = [boo, wftm, usdc, tusd];
        rewardRoutes[usdc] = [boo, wftm, usdc];

        fromVaultAssetRoutes[dai][tusd] = [dai, wftm, usdc, tusd];
        fromVaultAssetRoutes[dai][usdc] = [dai, wftm, usdc];
        fromVaultAssetRoutes[usdt][tusd] = [usdt, wftm, usdc, tusd];
        fromVaultAssetRoutes[usdt][usdc] = [usdt, wftm, usdc];
        fromVaultAssetRoutes[usdc][tusd] = [usdc, tusd];

        toVaultAssetRoutes[dai][tusd] = [tusd, usdc, wftm, dai];
        toVaultAssetRoutes[dai][usdc] = [usdc, wftm, dai];
        toVaultAssetRoutes[usdt][tusd] = [tusd, usdc, wftm, usdt];
