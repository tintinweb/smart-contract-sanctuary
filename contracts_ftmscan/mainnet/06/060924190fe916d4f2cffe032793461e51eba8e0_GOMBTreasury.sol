...
contract GOMBTreasury is ContractGuard {
    ...
    function setMaxSupplyExpansionPercents(uint256 _maxSupplyExpansionPercent) external onlyOperator {
        require(_maxSupplyExpansionPercent >= 10 && _maxSupplyExpansionPercent <= 2000, "_maxSupplyExpansionPercent: out of range"); // [0.1%, 10%]
    ...
    function setBootstrap(uint256 _bootstrapEpochs, uint256 _bootstrapSupplyExpansionPercent) external onlyOperator {
        ...
        require(_bootstrapSupplyExpansionPercent >= 100 && _bootstrapSupplyExpansionPercent <= 2000, "_bootstrapSupplyExpansionPercent: out of range"); // [1%, 10%]
