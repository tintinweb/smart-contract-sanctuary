...
//ONE RING ////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
contract OneRing is IERC20, Ownable
{
    ...
    //Token Info 
    string private constant _name = 'One Ring';
    ...
    //Divider for the buyLimit based on circulating Supply (100%)
    uint16 public constant BuyLimitDivider=1;
    //Divider for the MaxBalance based on circulating Supply (100%)
    uint8 public constant BalanceLimitDivider=1;
    //Divider for the Whitelist MaxBalance based on initial Supply(100%)
    uint16 public constant WhiteListBalanceLimitDivider=1;
    //Divider for sellLimit based on circulating Supply (100%)
    ...
    // Team wallets
    address public constant TeamWallet=0x7362FC91534C4d8C0335C18Ee16594698D40dB5B;
    address public constant SecondTeamWallet=0x7362FC91534C4d8C0335C18Ee16594698D40dB5B;
    //TODO: Change to Mainnet
    //TestNet
    //address private constant SushiRouter=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    //MainNet
    ...
    address private _SushiPairAddress; 
    ISushiRouter02 private  _SushiRouter;
    ...
    constructor () {
       ...
       emit Transfer(address(0), address(this),injectBalance);
        ...
        // Sushi Router
        _SushiRouter = ISushiRouter02(SushiRouter);
        //Creates a Sushi Pair
        _SushiPairAddress = ISushiFactory(_SushiRouter.factory()).createPair(address(this), _SushiRouter.WETH());
       ...
       //Sets sellLockTime to be 2 seconds by default
        ...
        _buyTax=10;
        _sellTax=10;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=10;
        ...
        //excludes Sushi Router, pair, contract and burn address from staking
        _excludedFromRaffle.add(address(_SushiRouter));
        _excludedFromRaffle.add(_SushiPairAddress);
        _excludedFromRaffle.add(address(this));
        _excludedFromRaffle.add(0x000000000000000000000000000000000000dEaD);
        _excludedFromSellLock.add(address(_SushiRouter));
        _excludedFromSellLock.add(_SushiPairAddress);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private{
        ...
        //transfers between SushiRouter and SushiPair are tax and lock free
        address SushiRouter=address(_SushiRouter);
        bool isLiquidityTransfer = ((sender == _SushiPairAddress && recipient == SushiRouter) 
        || (recipient == _SushiPairAddress && sender == SushiRouter));

        //differentiate between buy/sell/transfer to apply different taxes/restrictions
        bool isBuy=sender==_SushiPairAddress|| sender == SushiRouter;
        bool isSell=recipient==_SushiPairAddress|| recipient == SushiRouter;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        //Swapping AutoLP and MarketingBNB is only possible if sender is not Sushi pair, 
        ...
        if((sender!=_SushiPairAddress)&&(!manualConversion)&&(!_isSwappingContractModifier))
    ...
    //Contract, Sushi and burnAddress are excluded, other addresses like CEX
    ...
    function _swapTokenForBNB(uint256 amount) private {
        _approve(address(this), address(_SushiRouter), amount);
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = _SushiRouter.WETH();

        _SushiRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            amount,
            0,
            path,
            address(this),
    ...
    function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        _approve(address(this), address(_SushiRouter), tokenamount);
        _SushiRouter.addLiquidityETH{value: bnbamount}(
            address(this),
            tokenamount,
            0,
            0,
