...
contract Wizshot2 
   
   {
    ...
    function initializeICO(uint256 _price, address _inputtoken, address _nftaddress, uint256 _icotarget, uint256 _maxinvestment, uint256 _nftstartingrange, uint256 _nftendrange) public onlyOwner 
    {
