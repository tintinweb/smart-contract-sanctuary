...
contract MShareRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 accMSharePerShare; // Accumulated tSHAREs per share, times 1e18. See below.
    ...
    uint256 public tSharePerSecond = 0.00186122 ether; // 59500 mshare / (370 days * 24h * 60min * 60s)
    ...
    // Safe mshare transfer function, just in case if rounding error causes pool to not have enough tSHAREs.
