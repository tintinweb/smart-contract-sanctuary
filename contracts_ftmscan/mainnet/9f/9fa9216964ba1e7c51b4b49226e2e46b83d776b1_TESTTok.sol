...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // USDC
...
contract TESTTok is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // USDC
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TESTtok";
    string constant _symbol = "testtok";
    ...
    address public autoLiquidityReceiver=0xdee8bCC55A0043c110a7cc56ad60A5A96A97E7d2; //liq address
    address public marketingFeeReceiver=0xdee8bCC55A0043c110a7cc56ad60A5A96A97E7d2; // marketing address
