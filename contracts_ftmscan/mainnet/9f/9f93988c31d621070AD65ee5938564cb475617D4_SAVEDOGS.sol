...
/*
    ...
    Save dogs token is committed to provide a secure token for the community through fostering trust and satisfaction among all members.
    Aspire to create a strong and respected community through charity, solidarity, increasing the appetite for caring amongst creatures, 
    and nurturing the ties between the real and virtual worlds.
...
contract SAVEDOGS is Context, IERC20, Ownable {
    ...
    string private constant _name = 'SAVE DOGS';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xF77DC76639f160ea1B66e6b222a0046BC8F2C1CF, 'We can not exclude router.');
