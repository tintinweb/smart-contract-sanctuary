...
/*
    ...
    The BLOOM Token is a traders token built to synergize with our ecosystem and help with the longevity of the overall ecosystem.
    7% taxes used to reflect rewards to holders, bolster the Liquidity Pool and strengthen the Tulip DAO Treasury.
...
contract TheTulipDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = 'The Tulip DAO';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x23C108f10184Ac36498152e398e8c0Cb47BCc1f6, 'We can not exclude router.');
