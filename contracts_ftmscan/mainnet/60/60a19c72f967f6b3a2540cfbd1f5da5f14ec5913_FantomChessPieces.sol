...
// File: contracts/FantomChessPieces.sol
...
contract FantomChessPieces is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(string memory baseUrl) ERC721("FantomChessPieces", "CHESSp") {
        _baseUrl = baseUrl;
    }
    ...
    function mint(address to) public payable onlyOwner {
        ...
        require(id < (maxMintable), "No more chess pieces are available");
