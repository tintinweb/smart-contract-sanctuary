...
contract TombGenesisRewardPool {
    ...
    // TESTNET
    //uint256 public tombPerSecond = 5.5555555 ether; // 20000 TOMB / (1h * 60min * 60s)
    //uint256 public runningTime = 1 hours; // 1 hours
    //uint256 public constant TOTAL_REWARDS = 20000 ether;
    // END TESTNET

    // MAINNET
     uint256 public tombPerSecond = 5.5555555 ether; // 20000 TOMB / (24h * 60min * 60s)
     uint256 public runningTime = 1 hours; // 1 days
     uint256 public constant TOTAL_REWARDS = 20000 ether;
    // END MAINNET
