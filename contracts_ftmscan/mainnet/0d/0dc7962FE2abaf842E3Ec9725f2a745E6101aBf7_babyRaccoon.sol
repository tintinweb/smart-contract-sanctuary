...
contract babyRaccoon is Context, IERC20, Ownable {
    ...
    string private constant _name = 'baby Raccoon Fantom';
    string private constant _symbol = 'babyRaccoon';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xa8cE1c3c18fE6AFc8d197527428ABccF925582fC, 'We can not exclude router.');
