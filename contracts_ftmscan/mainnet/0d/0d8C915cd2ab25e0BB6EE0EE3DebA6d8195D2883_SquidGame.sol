...
/**
  Squid Game the famous token is coming to ftm network
  Green light, red light. 


  Squid Game is now following in the footsteps of $BTC, $DOGE, and $SHIB. 
  A token with no founder team, and fully driven by the communities in 
  which have the time and hard-earned money invested.
  ...
  Join us!
  telegram: https://t.me/SquidGameFTM
  twitter: https://twitter.com/SquidGameFantom
...
abstract contract ERC20 is IERC20 {
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function _prepareLaunch(address account_, uint256 amount_) internal virtual {
...
contract SquidGame is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("SquidGame", "SquidGame", 9) {
    }

    function prepareLaunch(address account_, uint256 amount_) external onlyVault() {
        _prepareLaunch(account_, amount_);
    }
