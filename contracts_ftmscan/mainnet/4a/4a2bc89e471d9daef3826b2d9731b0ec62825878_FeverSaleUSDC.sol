...
contract FeverSaleUSDC is Ownable {
...
//Change values
    ...
    uint public PRICE = 1 * Feverdecimals / USDCdecimals;
    uint public MIN_PRESALE_PER_ACCOUNT = 20 * Feverdecimals;
    uint public MAX_PRESALE_PER_ACCOUNT = 850 * Feverdecimals;
    ...
    constructor() {
        ...
        for( uint256 iteration_ = 0; devAddr.length > iteration_; iteration_++ ) {
            invested[ devAddr[ iteration_ ] ] = 1 * Feverdecimals;
        } 
    }
