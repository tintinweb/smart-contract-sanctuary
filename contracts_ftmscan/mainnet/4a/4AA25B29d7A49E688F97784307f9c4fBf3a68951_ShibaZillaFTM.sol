...
contract ShibaZillaFTM is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1500000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'ShibaZilla Fantom';
    string private constant _symbol = 'SHIBZ';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 200;
    uint public max_tx_size = 1500000000 ether;
