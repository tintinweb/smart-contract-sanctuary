 ...
 *     [[cccc    ,[[ '[[,   [[[,/[[['    [[[[[. '[[    '[==/[[[[,[[[         [[[         
 *     $$""""   c$$$cc$$$c  $$$$$$c      $$$ "Y$c$$      '''    $$$$         $$$         
 *     888oo,__  888   888, 888b "88bo,  888    Y88     88b    dP`88bo,__,o, `88bo,__,o, 
 *     """"YUMMM YMM   ""`  MMMM   "W"   MMM     YM      "YMmMY"   "YUMMMMMP"  "YUMMMMMP"
 *
 *                                                          [ SCARY CHAIN CAPITAL ]
 *     TELEGRAM [ @EARNSCC ] 
 *     [ TOTAL ] TAX FEE 15%
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xa231D452e4bCA86672FD6109de94688d1E17Aae5); // SCCv2
    address WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEV = 0xfD9386F71Fd33098259Dc5B59058832997955eC9;
...
contract EARNSCC is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xa231D452e4bCA86672FD6109de94688d1E17Aae5; // SCCv2 (checksum)
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "EARNSCC";
    string constant _symbol = "eSCC";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100_000 * (10 ** _decimals); // 100k
    ...
    address public autoLiquidityReceiver=0x4430307f8560BF70065cca6038311bd8A0607A63;  //liq address
    address public treasuryFeeReceiver=0x4430307f8560BF70065cca6038311bd8A0607A63; // treasury address
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = treasuryFeeReceiver;
    ...
    function swapBack() internal swapping {
        ...
        payable(treasuryFeeReceiver).transfer(amountFTMTreasury);
