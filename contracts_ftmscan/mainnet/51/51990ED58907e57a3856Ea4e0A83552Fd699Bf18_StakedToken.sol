...
// File contracts/StakedToken/StakedToken.sol
...
contract StakedToken is ERC20Permit, Ownable {
  ...
  uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10 * 10**9;
  ...
  constructor(
    ...
    address DAO_
  ) ERC20(_name, _symbol, 9) ERC20Permit(_name) {
    initializer = DAO_;
  ...
  /**
        @notice increases sTOKEN supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sTOKEN
