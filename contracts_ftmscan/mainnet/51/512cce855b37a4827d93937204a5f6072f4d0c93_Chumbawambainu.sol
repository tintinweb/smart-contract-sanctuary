...
contract Chumbawambainu is IERC20, Auth {
    using SafeMath for uint256;

    address WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; 
    address DEV = 0xAEFA510d30F522115a21c612eB837102c54C0cAD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Chumbawamba INU";
    string constant _symbol = "Chumbawamba INU";
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountFTMMarketing, gas: 40000}("");
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _totalSupply.sub(balanceOf(DEV)).sub(balanceOf(ZERO));
    }
