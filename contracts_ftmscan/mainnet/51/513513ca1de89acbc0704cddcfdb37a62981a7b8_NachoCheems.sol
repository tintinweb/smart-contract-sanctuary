...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); // BOO
...
contract NachoCheems is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE; // BOO
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NachoCheems";
    string constant _symbol = "NachoCheems";
    ...
    address public autoLiquidityReceiver=0x8056A129fdb225644495098f7F67aEB1F11E0161; //liq address
    address public marketingFeeReceiver=0x8056A129fdb225644495098f7F67aEB1F11E0161; // marketing address
