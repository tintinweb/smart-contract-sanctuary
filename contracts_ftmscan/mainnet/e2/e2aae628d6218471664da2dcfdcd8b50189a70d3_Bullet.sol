...
*/
contract Bullet is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 24h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 50000 ether;
    // Initial distribution for the day 2-5 BULLET-WFTM LP -> TOMB pool
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("BULLET", "BULLET") {
        // Mints 1 BULLET to contract creator for initial pool setup
