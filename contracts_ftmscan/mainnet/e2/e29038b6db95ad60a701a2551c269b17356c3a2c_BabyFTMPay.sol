...
$FTMPAY is a reward token launching on the #FTM network! Buy $FTMPAY with $ftm to get rewards in $ETH.
...
contract BabyFTMPay is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyFTMPay";
    string constant _symbol = "BABYFTMP";
