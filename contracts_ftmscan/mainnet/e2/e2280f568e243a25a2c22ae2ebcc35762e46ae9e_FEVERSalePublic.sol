...
contract FEVERSalePublic is Ownable {
    using SafeERC20 for ERC20;
    using Address for address;

    uint constant MIMdecimals = 10 ** 18;
    uint constant FEVERdecimals = 10 ** 9;
    uint public constant MAX_SOLD = 150000 * FEVERdecimals;
    uint public PRICE = 2;
    ...
    function buyFEVER(uint256 amount) public {
    ...
    function buyFEVERWhitelist(uint256 amount, address _to) public onlyOwner {
