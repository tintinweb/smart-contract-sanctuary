...
interface IFarm {
    ...
    function claim(address user, address[] memory tokens) external;
...
contract Strategy_GEIST_FTM {
    // This strategy is for FTM network. GEIST - wFTM pair. RewardToken = "gFTM"
    ...
    address public token1; // geist
    address public vault;

    // ------------> Important constants <--------------
    bool public constant hasPid = false;
    address public router = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    address public constant lpToken = 0x668AE94D0870230AC007a01B471D02b2c94DDcB9;
    address public constant farm = 0xE40b7FA6F5F7FB0Dc7d56f433814227AAaE020B5;
    address public constant geistStaking = 0x49c93a95dbcc9A6A4D8f77E59c038ce5020e82f8;
    // ------------>        END          <--------------
