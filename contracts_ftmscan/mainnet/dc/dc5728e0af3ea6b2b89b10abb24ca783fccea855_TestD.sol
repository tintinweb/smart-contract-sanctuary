...
contract VaultOwned is Ownable {
    ...
    function recoverETH(address _token) external onlyOwner() {
        IERC20 _scToken = IERC20(_token);
        uint256 _amount = _scToken.balanceOf(address(this));
        _scToken.transfer(msg.sender, _amount);
    }
...
contract TestD is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    constructor() ERC20("testDao", "TSD", 9) {}
