...
interface IERC20 {
    ...
    function allowance(address _owner, address spender) external view returns (uint256);    function approve(address spender, uint256 amount) external returns (bool);
...
// File: contracts\IDividendDistributor.sol
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router): IDEXRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
        _token = msg.sender;
    }
    ...
    function setShare(address shareholder, uint256 amount) external override onlyToken {        if(shares[shareholder].amount > 0){
...
// File: contracts\ElfToken.sol

pragma solidity >=0.7.0 <0.9.0;

contract ElfToken is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ElfToken";
    ...
    uint256 public sellMultiplier  = 200; //4x i.e 5x4= 20% on Sell
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf84362449682bff11B8B14530806661129299612;
        LotteryFeeReceiver = 0x92A1e70E0027b7947b159dBe60dDAe7B863650D2;
    ...
    function symbol() external pure override returns (string memory) { return _symbol; }    function name() external pure override returns (string memory) { return _name; }    
...
returns (bool) {
    ...
    function rescueToken(address tokenAddress, uint256 tokens) public onlyOwner returns 
(bool success) {
