...
contract UltiBetsManchesterCityVSChelsea {
  enum Side { ManchesterCity, Chelsea }
  ...
  function claimBetCancelledEvent(Side _side) external {
    ...
    betsAmountPerBettor[msg.sender][Side.ManchesterCity] = 0;
    betsAmountPerBettor[msg.sender][Side.Chelsea] = 0;
