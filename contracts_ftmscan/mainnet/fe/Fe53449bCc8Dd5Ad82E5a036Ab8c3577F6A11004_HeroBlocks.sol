...
contract HeroBlocks is Initializable, UUPSUpgradeable, CryptoBlocksERC721Upgradeable {
    ...
    /**
     * @dev if address is whitelisted such as a contract then do not unequip
     */
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal virtual override {
        require(_attributes[tokenId][UnitBlocksConstants.UINT_STAKED] == 0, "Staked");
        if(_addressData[CryptoBlocksConstants.ADDR_DATA_WHITELIST][from] == 0 && _addressData[CryptoBlocksConstants.ADDR_DATA_WHITELIST][to] == 0) {
...
library UnitBlocksConstants {
    ...
    uint256 public constant UINT_STAKED = 30;       // staked in dungeon
    uint256 public constant UINT_BANNED = 31;       // banned for exploit
