...
contract PriceOracle is Governable {
    ...
    function calculateAssetPrice(address _asset) public view returns (uint256) {
        ...
        if(tokenType == AssetType.Token) {
            ...
            exchangeRate = underlyingDecimals == 18 ? exchangeRate * 1e10 : exchangeRate * (10 ** (18 - (cTokenDecimals + underlyingDecimals)));
            ...
            // token of the gauge and it's decimals for calculating the proper value.
