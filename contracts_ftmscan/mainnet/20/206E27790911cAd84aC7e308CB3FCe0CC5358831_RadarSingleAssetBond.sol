...
interface IRadarSingleAssetBond {
    ...
    struct BondTerms {
        ...
        uint256 minPriceLP; // minimum price in terms of RADAR/LP - then calculate with chainlink
        address priceLP; // LP used for pricing where the other asset is supported by chainlink
    }
    ...
    // This is for asset but same interface will be used
