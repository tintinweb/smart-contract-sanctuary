...
contract Merge2048 is ERC1155 {
        ...
        public
    {
        ...
        require(sum < currentMaxSum, "Merge2048NFT: No more tiles can be mint");
        require(amount > 0, "Merge2048NFT: Amount is zero");
        require(amount <= MAX_MINT, "Merge2048NFT: Amount exceeds the maximum number to mint");
        require(sum + amount <= currentMaxSum, "Merge2048NFT: Total supply will exceeds the max");
