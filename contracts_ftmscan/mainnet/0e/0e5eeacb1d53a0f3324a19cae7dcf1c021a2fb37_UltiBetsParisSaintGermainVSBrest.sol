...
contract UltiBetsParisSaintGermainVSBrest {
  enum Side { ParisSaintGermain, Brest }
  ...
  function claimBetCancelledEvent(Side _side) external {
    ...
    betsAmountPerBettor[msg.sender][Side.ParisSaintGermain] = 0;
    betsAmountPerBettor[msg.sender][Side.Brest] = 0;
