...
contract Fatime is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 50000 * 10**9;

  string private _symbol = "FATIME";

  string private _name = "Fantome Time";
