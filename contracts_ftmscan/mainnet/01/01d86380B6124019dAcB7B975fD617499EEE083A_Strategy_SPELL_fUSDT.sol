...
contract Strategy_SPELL_fUSDT {
    ...
    function _checkPrice(address[] memory path) internal {
        ...
        // TODO: check that path0 = Wrapped token
        // TODO: check that pathN = needed token
        // TODO: check deposit flow at first
        uint256 price = _getTokenPrice(path);
