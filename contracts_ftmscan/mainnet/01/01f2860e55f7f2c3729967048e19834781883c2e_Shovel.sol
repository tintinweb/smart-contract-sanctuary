...
contract Shovel is ERC20Burnable, Operator {
    ...
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("SHOVEL", "SHOVEL") {
    ...
    function _getTombPrice() internal view returns (uint256 _tombPrice) {
        try IOracle(tombOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("SHOVEL: failed to fetch SHOVEL price from Oracle");
        }
    }
