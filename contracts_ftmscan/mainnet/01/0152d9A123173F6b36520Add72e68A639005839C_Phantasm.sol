...
First FTM launch from an experienced ETH dev.

Liquidity locked on DxSale

Website will be up within 2 hours after launch
...
contract Phantasm is ERC20, Ownable {
    ...
    address private constant devAddress = address(0x06D8D184e40475dE4DC317101376F484a47CbB7e);
    ...
    constructor() ERC20("Phantasm", "PHANTASM") {
        ...
        uint256 _sellBuyBackFee = 8;
        
        uint256 totalSupply = 1 * 1e8 * 1e18; // 100 million
        
        maxTransactionAmount = totalSupply * 25 / 10000; // 0.5% maxTransactionAmountTxn
        ...
        excludeFromFees(address(0x06D8D184e40475dE4DC317101376F484a47CbB7e), true);
        ...
        excludeFromMaxTransaction(address(0x06D8D184e40475dE4DC317101376F484a47CbB7e), true);

        _isExcludedFromContractBuyingLimit[address(this)] = true;
        _isExcludedFromContractBuyingLimit[0xF491e7B69E4244ad4002BC14e878a34207E38c29] = true;
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x06D8D184e40475dE4DC317101376F484a47CbB7e) &&
                !swapping
            ){
                if(!tradingActive){
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            ...
            path,
            address(0x06D8D184e40475dE4DC317101376F484a47CbB7e),
            block.timestamp
        );
