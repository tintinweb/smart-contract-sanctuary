...
contract GSCARABp is Auth {
  ...
  string constant _name =  "hasu love";     //"GSCARAB Printer";
  string constant _symbol = "HLove";        //"GSCARp";
  ...
  // 4% goes to providing liquidity to the pair; 
  uint256 liquidityFee = 400;
  // 8% Goes to the reflections for token holders; 
...
contract DividendDistributor  {
    ...
    // Tshare Token; 
    IERC20 EP = IERC20(0x6ab5660f0B1f174CFA84e9977c15645e4848F5D6); // GSCARAB
    ...
    uint256 public minPeriod = 1 minutes; //1 hours;
