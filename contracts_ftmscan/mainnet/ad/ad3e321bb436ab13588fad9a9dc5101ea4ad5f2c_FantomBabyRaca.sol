...
contract FantomBabyRaca is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name     = "Fantom Baby Raca";
    string private _symbol   = "BRACA";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _spookyswapV2Router; // Spookyswap V2 Router
    address public _spookyswapV2LiquidityPair;     // Spookyswap V2 liquidity pairing for BRACA/WFTM
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x2e01D2f173Cdf8065377c8e8efF5818b02E7CEcF); // Marketing address used to pay for marketing
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of BRACA tokens for FTM
        ...
        // We now have 6/7ths left of FTM (converted from BRACA)
