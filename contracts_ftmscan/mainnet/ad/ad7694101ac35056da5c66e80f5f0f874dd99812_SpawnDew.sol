...
/*
 *10000000 SpawnDew with 1% dev fee on every Buy or Sell 
*/
...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); //USDC
...
contract SpawnDew is IERC20, Auth {
    ...
    string constant _name = "SpawnDew";

    string constant _symbol = "SPAWNDEW";
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0x19C3AAbE8BA3E8701d7EEb51d8E842F5cEE03434;
	...
	function setWalletBanStatus(address user, bool banned) external authorized {
		...
		if (banned) {
            ...
            require(	block.timestamp + 3 days > block.timestamp, "User was put in a cage.");
