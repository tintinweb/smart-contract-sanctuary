...
contract Strategy_Spirit is Strategy {
    constructor(
        ...
        bool _isTestVComp,
        address[] memory _earnedToTESTVPath,
        ...
        testVFarmAddress = _addresses[2]; // Vault Farming
        TESTVAddress = _addresses[3]; // Token
        ...
        isTestVComp = _isTestVComp;

        uniRouterAddress = _addresses[9]; // AMM Router (Ex: PCS)
        earnedToTESTVPath = _earnedToTESTVPath; 
        ...
        transferOwnership(testVFarmAddress);
    }
}
...
contract ERC20 is Context, IERC20 {
     ...
     * e.g. implement testVmatic token fees, slashing mechanisms, etc.
     *
     * Emits a {Transfer} event.
     *
     * Requirements:
     ...
     * e.g. set testVmatic allowances for certain subsystems, etc.
     *
     * Emits an {Approval} event.
     *
     * Requirements:
...
abstract contract Strategy is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isTestVComp; // this vault is purely for staking. eg. WBNB-TESTV staking vault.
    ...
    address public testVFarmAddress;
    address public TESTVAddress;
    ...
    address[] public earnedToTESTVPath;
    ...
    function _farm() internal virtual {
        require(isTestVComp, "!isTestVComp");
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(testVFarmAddress, _wantAmt);
