...
contract Master is Ownable {
    ...
    ICrobase public crobase;

    // Market oracle provides the CROBASE/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _crobase) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = crobase.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && crobase.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(crobase.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return crobase.totalSupply().toInt256Safe()
