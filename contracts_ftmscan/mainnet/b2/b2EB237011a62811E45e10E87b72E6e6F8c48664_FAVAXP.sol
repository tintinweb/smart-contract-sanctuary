...
contract FAVAXP is Ownable, IERC20 {
    ...
    string _name = "Famtom AVAX PRINTER";
    string _symbol = "fAvaxP";
    ...
    FAVAXPDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new FAVAXPDividendTracker();
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountFTMMarketing = address(this).balance;
        payable(marketing).call{value: amountFTMMarketing, gas: 30000}("");
    }
    ...
    event AutoLiquify(uint256 amountFTM, uint256 amountPPC);
}


contract FAVAXPDividendTracker is DividendPayingTokenInterface {
    using SafeMath for uint256;
    ...
    IERC20 AvaxToken = IERC20(0x511D35c52a3C244E7b8bd92c0C297755FbD89212);
    ...
    uint256 public minDistribution = 1200000 * (10 ** 9); // 0.0012 FTM minimum auto send  
    uint256 public minimumTokenBalanceForDividends = 79000 * (10**9); // Must hold 79000 PPC token to receive FTM
    ...
    function deposit() external payable onlyToken {
        uint256 balanceBefore = AvaxToken.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WFTM;
        path[1] = address(AvaxToken);
        ...
        uint256 amount = AvaxToken.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AvaxToken.transfer(shareholder,amount);
