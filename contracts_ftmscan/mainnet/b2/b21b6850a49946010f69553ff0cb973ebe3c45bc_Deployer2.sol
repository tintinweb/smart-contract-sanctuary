...
/*
    ...
    Void Dollar Protocol, standing on the shoulders of the Empty Set Squad 
...
library Constants {
    /* Chain */
    uint256 private constant CHAIN_ID = 250; // Mainnet
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 VOID -> 100M VOIDS
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 1e20; // 100 VOID
