...
import "./ERC20/ERC20VotesComp.sol";

/**
 * @title Creditum Governance Token
 * @author Creditum
 */
contract CreditumERC20 is ERC20VotesComp {
    /// @notice Initializes Creditum token and mints entire supply (50 million) to deployer
    /// @dev No more tokens can be minted after initialization
    constructor() ERC20("Creditum", "CREDIT") ERC20Permit("Creditum") {
