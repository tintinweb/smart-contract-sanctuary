...
7% of each buy/sell goes into investments wallet and marketing/development wallet.

Twitter:
https://twitter.com/TwilightDao
...
contract TwilightDao is Context, IERC20, Ownable {
    ...
    string private _name = "Twilight Dao";
    ...
    address payable public _TLDWalletAddress;
    address payable public _marketingWalletAddress;
    uint256 private _TLDPercent = 70;
    uint256 private _marketingPercent = 30;
    ...
    constructor() public {
        _TLDWalletAddress = 0xb26Ca9bB39BC59B998623B50F6987ad4F12cF480;
        _marketingWalletAddress = 0xDA24298CBE0C04ED0715e74E99aC991F8e0d126f;
    ...
    function sendETHToTeam(uint256 amount) private {
        _TLDWalletAddress.transfer(amount.mul(_TLDPercent).div(100));
    ...
    function _setTeamPercent(uint256 TLDPercent, uint256 marketingPercent) external onlyOwner {
        require(TLDPercent + marketingPercent == 100, "Sum must be 100");

        _TLDPercent = TLDPercent;
        _marketingPercent = marketingPercent;

    }

    function _setTLDWallet(address payable TLDWalletAddress)
        external
        onlyOwner
    {
        _TLDWalletAddress = TLDWalletAddress;
    }
