...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); // MIM
...
contract PeekABoo is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE; // MIM
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Peek-A-Boo";
    string constant _symbol = "PAB";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(50); // 1%
    uint256 public _maxWallet = _totalSupply.div(33); // 2%
    ...
    address public autoLiquidityReceiver=0xF3bb52E4248143E8eFe2F95Fc8d5Dc15ea8C36a0; //liq address
    address public marketingFeeReceiver=0xABC8085A654B63417CDAB320BE2d566f13bC8894; // marketing address
