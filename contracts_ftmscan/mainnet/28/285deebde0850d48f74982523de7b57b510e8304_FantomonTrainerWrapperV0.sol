...
// File contracts/FantomonTrainerWrapperV0.sol

contract FantomonTrainerWrapperV0 is ERC721 {
    ERC721Enumerable ftg1_;
    FantomonTrainerGraphicsProxy graphicsProxy_;

    constructor(ERC721Enumerable _ftg1, FantomonTrainerGraphicsProxy _graphicsProxy) ERC721("Wrapped0 Fantomon Trainer Gen1", "W0FTG1") {
        ftg1_ = _ftg1;
        graphicsProxy_ = _graphicsProxy;
    }

    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        return graphicsProxy_.tokenURI(_tokenId);
    }
    function ownerOf(uint256 _tokenId) public view virtual override returns (address) {
        return ftg1_.ownerOf(_tokenId);
    }
    function totalSupply() public view returns(uint256) {
        return ftg1_.totalSupply();
    }
    function balanceOf(address _owner) public view virtual override returns(uint256) {
        return ftg1_.balanceOf(_owner);
    }
}