...
import "./StrategyV1.sol";

contract StrategyV1_Spookyswap is StrategyV1 {
    ...
    constructor(
        ...
        earnedToWFTMPath = [earnedAddress, wftmAddress];
...
abstract contract StrategyV1 is Ownable, ReentrancyGuard, Pausable {
