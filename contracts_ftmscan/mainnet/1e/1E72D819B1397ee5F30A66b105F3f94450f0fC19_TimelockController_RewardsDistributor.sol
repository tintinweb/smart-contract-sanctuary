...
/**
 * @dev TestVFarm functions that do not require less than the min timelock
 */
interface ITestVFarm {
    function add(
        uint256 _allocPoint,
        address _want,
        bool _withUpdate,
    ...
    ReentrancyGuard
{
    ...
    function executeSet(
        ...
        _beforeCall(id, predecessor);
        ITestVFarm(_testVfarmAddress).set(_pid, _allocPoint, _withUpdate);
        _afterCall(id);
    }
    ...
    function add(
        ...
        ITestVFarm(_testVfarmAddress).add(0, _want, _withUpdate, _strat); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
