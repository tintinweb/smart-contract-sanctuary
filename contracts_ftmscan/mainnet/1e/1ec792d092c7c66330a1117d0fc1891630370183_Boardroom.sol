...
interface ITreasury {
    ...
    function getMonicsPrice() external view returns (uint256);
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getMonicsPrice() external view returns (uint256) {
        return treasury.getMonicsPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            monics.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        monics.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(monics), "monics");
