...
contract ProNFT is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
  ...
  string public _baseURI = "http://localhost/nft/";
  uint public maxTokensPerTransaction = 10;
  uint256 public tokenPrice = 0.1 ether;
  uint256 public nftsNumber = 100;
  uint256 public nftsPublicNumber = 110;
