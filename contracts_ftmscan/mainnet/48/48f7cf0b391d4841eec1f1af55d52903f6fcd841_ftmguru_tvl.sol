...
contract ftmguru_tvl
{
	...
	function ftmusd() public returns(uint256)
	{
		LPT lpt=LPT(wftmusd);
	...
	function tvlOf_ftm(address q) public returns(uint256)
	{
		return((address(q).balance)*ftmusd());
	}
	//Self.TVL Finder
	function _tvlOf_ftm(uint256 n) public returns(uint256)
	{
		return(tvlOf_ftm(_bankOf_ftm[n]));
	}
	//Self.TVL.total
	function _tvl_ftm() public returns(uint256)
	{
		uint256 tvl = 0;
	...
	function p_t_usd(address u, address lp) public returns(uint256)
	{
		LPT lpt=LPT(lp);
		(uint256 a, uint256 b,) = lpt.getReserves();
	...
	//Universal TVL Finder
	function tvlOf_t_usd(t_usd memory q) public returns(uint256)
	{
	...
	//Self.TVL Finder
	function _tvlOf_t_usd(uint256 n) public returns(uint256)
	{
		uint256 tvl = tvlOf_t_usd(_bankOf_t_usd[n]);
		return tvl;
	}
	//Self.TVL.total
	function _tvl_t_usd() public returns(uint256)
	{
		uint256 tvl;
	...
	function p_t_ftm_usd(address lp) public returns(uint256)
	{
		LPT lpt=LPT(lp);
		(uint256 a, uint256 b,) = lpt.getReserves();
		//pf: price of token in FTM; 1e18 === 1FTM
	...
	//Universal TVL Finder
	function tvlOf_t_ftm_usd(t_ftm_usd memory q) public returns(uint256)
	{
		uint256 tvl = LPT(q.asset).balanceOf(q.pool) * 10**(18-q.dec)
			* p_t_ftm_usd(q.lp);
		return tvl;
	...
	//Self.TVL Finder
	function _tvlOf_t_ftm_usd(uint256 n) public returns(uint256)
	{
		uint256 tvl = tvlOf_t_ftm_usd(_bankOf_t_ftm_usd[n]);
		return tvl;
	}
	//Self.TVL.total
	function _tvl_t_ftm_usd() public returns(uint256)
	{
		uint256 tvl;
	...
	function p_t_tt_usd(address qt, address lp_tt, address lp_bt_u, address u) public returns(uint256)
	{
		LPT lpt=LPT(lp_tt);
		uint256 a;
	...
	//Universal TVL Finder
	function tvlOf_t_tt_usd(t_tt_usd memory q) public returns(uint256)
	{
		uint256 tvl = LPT(q.asset).balanceOf(q.pool) * 10**(18-q.dec)
	...
	//Self.TVL Finder
	function _tvlOf_t_tt_usd(uint256 n) public returns(uint256)
	{
		uint256 tvl = tvlOf_t_tt_usd(_bankOf_t_tt_usd[n]);
		return tvl;
	}
	//Self.TVL.total
	function _tvl_t_tt_usd() public returns(uint256)
	{
		uint256 tvl;
	...
	//Assumes: Token qt does not have a direct USD or FTM pair. Uses bt to calculate.
	function p_t_tt_ftm_usd(address qt, address lp_tt, address lp_bt_f) public returns(uint256)
	{
		LPT lpt=LPT(lp_tt);
		uint256 a;
		uint256 b;//base reserve
	...
	//Universal TVL Finder
	function tvlOf_t_tt_ftm_usd(t_tt_ftm_usd memory q) public returns(uint256)
	{
		uint256 tvl = LPT(q.asset).balanceOf(q.pool) * 10**(18-q.dec)
	...
	//Self.TVL Finder
	function _tvlOf_t_tt_ftm_usd(uint256 n) public returns(uint256)
	{
		uint256 tvl = tvlOf_t_tt_ftm_usd(_bankOf_t_tt_ftm_usd[n]);
		return tvl;
	}
	//Self.TVL.total
	function _tvl_t_tt_ftm_usd() public returns(uint256)
	{
		uint256 tvl;
	...
	function p_lpt_usd(address u, address lp) public returns(uint256)
	{
		LPT lpt=LPT(lp);
		(uint256 a, uint256 b,) = lpt.getReserves();
	...
	//Universal TVL Finder
	function tvlOf_lpt_usd(lpt_usd memory q) public returns(uint256)
	{
		uint256 tvl = LPT(q.asset).balanceOf(q.pool) * 10**(18-q.dec)
			* p_lpt_usd(q.lp, q.lp);
		return tvl;
	...
	//Self.TVL Finder
	function _tvlOf_lpt_usd(uint256 n) public returns(uint256)
	{
		uint256 tvl = tvlOf_lpt_usd(_bankOf_lpt_usd[n]);
		return tvl;
	}
	//Self.TVL.total
	function _tvl_lpt_usd() public returns(uint256)
	{
		uint256 tvl;
	...
	function p_lpt_ftm_usd(address lp) public returns(uint256)
	{
		LPT lpt=LPT(lp);
		(uint256 a, uint256 b,) = lpt.getReserves();
		uint256 ts = lpt.totalSupply();
	...
	//Universal TVL Finder
	function tvlOf_lpt_ftm_usd(lpt_ftm_usd memory q) public returns(uint256)
	{
		uint256 tvl = LPT(q.asset).balanceOf(q.pool) * 10**(18-q.dec)
			* p_lpt_ftm_usd(q.lp);
		return tvl;
	...
	//Self.TVL Finder
	function _tvlOf_lpt_ftm_usd(uint256 n) public returns(uint256)
	{
		uint256 tvl = tvlOf_lpt_ftm_usd(_bankOf_lpt_ftm_usd[n]);
		return tvl;
	}
	//Self.TVL.total
	function _tvl_lpt_ftm_usd() public returns(uint256)
	{
		uint256 tvl;
	...
	function p_lpt_tt_usd(address bt, address lp_tt, address lp_bt_u, address u) public returns(uint256)
	{
		LPT lpt=LPT(lp_tt);
		address _t = lpt.token0();
		uint256 b;
	...
	//Universal TVL Finder
	function tvlOf_lpt_tt_usd(lpt_tt_usd memory q) public returns(uint256)
	{
		uint256 tvl = LPT(q.asset).balanceOf(q.pool) * 10**(18-q.dec)
	...
	//Self.TVL Finder
	function _tvlOf_lpt_tt_usd(uint256 n) public returns(uint256)
	{
		uint256 tvl = tvlOf_lpt_tt_usd(_bankOf_lpt_tt_usd[n]);
		return tvl;
	}
	//Self.TVL.total
	function _tvl_lpt_tt_usd() public returns(uint256)
	{
		uint256 tvl;
	...
	function p_lpt_tt_ftm_usd(address bt, address lp_tt, address lp_bt_f) public returns(uint256)
	{
		LPT lpt=LPT(lp_tt);
		address _t = lpt.token0();
		uint256 b;
	...
	//Universal TVL Finder
	function tvlOf_lpt_tt_ftm_usd(lpt_tt_ftm_usd memory q) public returns(uint256)
	{
		uint256 tvl = LPT(q.asset).balanceOf(q.pool) * 10**(18-q.dec)
	...
	//Self.TVL Finder
	function _tvlOf_lpt_tt_ftm_usd(uint256 n) public returns(uint256)
	{
		uint256 tvl = tvlOf_lpt_tt_ftm_usd(_bankOf_lpt_tt_ftm_usd[n]);
		return tvl;
	}
	//Self.TVL.total
	function _tvl_lpt_tt_ftm_usd() public returns(uint256)
	{
		uint256 tvl;
