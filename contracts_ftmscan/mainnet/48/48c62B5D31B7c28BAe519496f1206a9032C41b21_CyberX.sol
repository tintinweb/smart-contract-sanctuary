...
/*
    ...
    CyberX is the most influential crypto community!
     Full decentralization, privacy, and community power are what we strive for!
...
contract CyberX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'CyberX Token';
    string private constant _symbol = 'CX';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 200;
    uint public max_tx_size = 20000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x804D593DeE9E69F5C64bc40A59689911aF593b90, 'We can not exclude router.');
