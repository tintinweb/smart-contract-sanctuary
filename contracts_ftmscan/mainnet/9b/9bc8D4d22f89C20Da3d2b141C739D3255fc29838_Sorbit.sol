...
contract Sorbit is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 sORBIT
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("sORBIT", "sORBIT") {
        _mint(msg.sender, 1 ether); // mint 1 ORBIT Share for initial pools deployment
