...
/**
Telegram: https://t.me/SpookyELF                                                     
TotalFee: 9%                                                    
Reflections in $ELITE: 7%                                                    
Marketing: 1%                                                    
Buyback 0.5%                                                   
Liquidity: 0.5%                                                    
...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); //BOO
  ...
  address WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    ...
    constructor (address _router) {
        ...
        : IDEXRouter(0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52);
...
contract SpookyElf is IERC20, Auth {

    using SafeMath for uint256;



     address RWRD = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE;  //BOO
    ...
    string constant _name = "SpookyElf";

    string constant _symbol = "ELF";

    uint8 constant _decimals = 9;



    uint256 _totalSupply = 13371337 * (10 ** _decimals);  
    ...
    function getTotalFee() public view returns (uint256) {
        ...
        return totalFee.add(liquidityFee);
