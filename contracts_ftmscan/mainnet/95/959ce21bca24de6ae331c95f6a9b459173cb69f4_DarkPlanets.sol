...
contract DarkPlanets is ERC721Enumerable, Ownable {
    ...
    constructor() Ownable() ERC721("Dark Planet", "DP") {
    }
    ...
    function claim() public payable {
        ...
        require(_totalPlanets < maxPlanets, "no planets, error.");
    ...
    */
    ...
    function getClaimFee()public view returns(uint256){
        return ((100 + (totalSupply()/100) * 10) * 1e18);
    }
    ...
    function tokenURI(uint256 pID) public override view returns (string memory) {
        string memory show = string(abi.encodePacked(_planetsBaseURI, toString(_rdg.randomGuard(pID+1)),".png"));
