...
/**
 *
 *    Web:      https://evernode.cc/
 *    Telegram: https://t.me/evernode
 *    Discord:  https://discord.gg/9X9UDGjVEY
 *    Twitter:  https://twitter.com/ever_node
 */
...
contract EVERNODE is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address uniV2Router,
        uint256 snipeBlkAmt
    ) ERC20("EverNode", "FEVER") PaymentSplitter(payees, shares) {
        ...
        require(totalSupply() == 1100000e18, "CONSTR: totalSupply must equal 1.1 million");
    ...
    onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "TKN: The Spooky pair cannot be removed from automatedMarketMakerPairs"
        );
