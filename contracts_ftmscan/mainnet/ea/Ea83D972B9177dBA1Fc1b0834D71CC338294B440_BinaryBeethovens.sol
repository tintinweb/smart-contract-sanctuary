...
contract BinaryBeethovens is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {

  uint256 public tokenCounter;
  uint256 public maxSupply;
  uint256 public royaltyFee;
  uint256 public maxMintPerTrx;
  address public mintToAddress;
  address public royaltyAddress;
  bool public enableMinter;
  string public directory;
  ...
  event NewMintToAddress(address newMintToAddress);
  event NewMaxMintPerTrx(uint256 newMaxMintPerTrx);
  event MinterStatusUpdate(bool newEnableMinter);
  event UpdateDirectory(string newDirectory);
  ...
  constructor() ERC721("Binary Beethovens", "BEETS") {
    tokenCounter = 0;
    maxSupply = 10;
    royaltyFee = 7;
    maxMintPerTrx = 10;
    mintToAddress = 0x1F3433562D03C4ce046D81Bc2d37DfEbc4ca0F08;
    royaltyAddress = mintToAddress;
    enableMinter = true;
    directory = "https://ipfs.io/ipfs/QmWceA1xmVcRqJRPobMymF2dNjnTUrB5EkZf3d66aGYcnc/";

    // REC165 Interfaces Supported
    // Do not modify!
  ...
  function mint() public onlyOwner {
    ...
    for (uint i = 0; i <= maxMintPerTrx; i++) {
      if (tokenCounter == maxSupply) {
        enableMinter = false;
        break;
      }
      _mint(mintToAddress, tokenCounter);
  ...
  function setMaxMintPerTrx(uint256 _maxMintPerTrx) public onlyOwner {
    maxMintPerTrx = _maxMintPerTrx;
    emit NewMaxMintPerTrx(maxMintPerTrx);
  }

  function setMaxSupply(uint256 _maxSupply) public onlyOwner {
    maxSupply = _maxSupply;
    emit NewMaxSupply(maxSupply);
  }

  function setMintToAddress(address _mintToAddress) public onlyOwner {
  ...
  function setDirectory(string memory _directory) public onlyOwner {
    directory = _directory;
    emit UpdateDirectory(directory);
  }

  function setTokenURI(uint256 id, string memory dotJson) public onlyOwner {
