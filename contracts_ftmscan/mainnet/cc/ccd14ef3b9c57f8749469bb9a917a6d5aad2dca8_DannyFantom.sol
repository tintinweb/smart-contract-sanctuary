...
contract DannyFantom is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DannyFantom";
    string constant _symbol = "DFTM";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(67); // 1.5%
    ...
    address public autoLiquidityReceiver=0xB16a58aa8beF61f91d49476c2DD1CE2854bb8681; //liq address
    address public marketingFeeReceiver=0x0a06b7412c5bC940030288Cc290d612f0baAC815; // marketing address
