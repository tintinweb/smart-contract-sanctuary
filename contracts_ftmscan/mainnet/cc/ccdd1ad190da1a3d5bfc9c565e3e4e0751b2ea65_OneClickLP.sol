...
// File contracts/helpers/Context.sol
    ...
    contract OneClickLP is ReentrancyGuard, Ownable, Pausable {
        ...
        address private constant wftmAddress = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
        ...
        function _pullTokens(
            ...
            if (token == address(0)) {
                ...
                require(msg.value == 0, "FTM sent with token");
