...
// File contracts/sCharm.sol
//License-Identifier: MIT

// Staking in sCharm inspired by Chef Nomi's SushiBar - MIT license (originally WTFPL)
// modified by BoringCrypto for DictatorDAO

contract sCharmV1 is IERC20, Domain {
    using BoringMath for uint256;
    using BoringMath128 for uint128;
    using BoringERC20 for IERC20;

    string public constant symbol = "sCHARM";
    string public constant name = "Staked Charm Token";
