...
contract santaboyftm is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 2512 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "santaboyftm";
    string private _symbol   = "santaboyftm";
    ...
    uint256 public  _maxTxAmount     = 2512 * 10**9;
