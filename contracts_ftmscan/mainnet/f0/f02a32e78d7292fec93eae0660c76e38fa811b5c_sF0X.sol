...
contract sF0X is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked F0X", "sF0X", 9) ERC20Permit() {
    ...
    /**
        @notice increases sF0X supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sF0X
