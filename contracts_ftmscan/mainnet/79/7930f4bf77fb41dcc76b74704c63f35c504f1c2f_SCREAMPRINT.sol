...
// FAIR LAUNCH - In memories of Hairy Monkey
// Telegram - https://t.me/ScreamPRINT
// Twitter - https://twitter.com/ScreamPrint
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SCREAM = IBEP20(0xe0654C8e6fd4D733349ac7E09f6f23DA256bF475); // SCREAM
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SCREAM.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WFTM;
        path[1] = address(SCREAM);

        router.swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: msg.value
        }(0, path, address(this), block.timestamp);

        uint256 amount = SCREAM.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            SCREAM.transfer(shareholder, amount);
...
contract SCREAMPRINT is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address SCREAM = 0xe0654C8e6fd4D733349ac7E09f6f23DA256bF475; // SCREAM
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SCREAM PRINT";
    string constant _symbol = "SCREAMP";
    ...
    address public autoLiquidityReceiver =
        0xf1bbc583c4944f4B57c79508D04986f903BC42a4; //liq address
    address public marketingFeeReceiver =
        0xf1bbc583c4944f4B57c79508D04986f903BC42a4; // marketing address
