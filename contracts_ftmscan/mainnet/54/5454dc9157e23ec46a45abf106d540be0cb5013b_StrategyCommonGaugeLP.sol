...
// File contracts/BIFI/interfaces/common/gauge/IGaugeStaker.sol
...
// File contracts/BIFI/interfaces/common/gauge/IGaugeProxy.sol
...
// File contracts/BIFI/strategies/Common/StrategyCommonGaugeLP.sol



pragma solidity ^0.6.12;
contract StrategyCommonGaugeLP is StratManager, FeeManager, GasThrottler {
    ...
    function rewardsAvailable() public view returns (uint256) {
        return IGaugeProxy(gauge).earned(gaugeStaker);
    }
    ...
    function _giveAllowances() internal {
        IERC20(want).safeApprove(gaugeStaker, uint256(-1));
