...
contract GSCARABp is IERC20Metadata, Auth {
    using SafeMath for uint256;

    address pToken = 0x6ab5660f0B1f174CFA84e9977c15645e4848F5D6; // GSCARAB
    address public wFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GSCARAB Printer";
    string constant _symbol = "GSCARABp";
    ...
    constructor () Auth(msg.sender) {
        ...
        wFTM = router.WETH();
        distributor = new DividendDistributor(_router, pToken, wFTM);
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountFTMLiquidity}(address(this), amountToLiquify, 0, 0, autoLiquidityReceiver, block.timestamp);
    ...
    event AutoLiquify(uint256 amountFTM, uint256 amountPToken);
