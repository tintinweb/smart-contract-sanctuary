...
contract PShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund, address _team1Fund) public ERC20("PSHARE", "PEPPER SHARES") {
        _mint(msg.sender, 1 ether); // mint 1 CHRONUS Share for initial pools deployment
