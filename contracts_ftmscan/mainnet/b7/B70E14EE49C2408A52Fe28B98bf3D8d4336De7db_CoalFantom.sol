...
contract CoalFantom is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Coal Fantom';
    string private constant _symbol = 'COAL';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x47B8bE4c80937b7126Afa48955607f933DA9fc39, 'We can not exclude router.');
