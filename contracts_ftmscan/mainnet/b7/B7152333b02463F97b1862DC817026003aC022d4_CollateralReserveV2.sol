...
contract CollateralReserveV2 is Ownable {
  ...
  //   // // buyback coffin
  //   function buyBackCoffin(
  //     address _token,
  //     uint256 _amount,
  //     uint256 _min
  //   ) public onlyBuybackManagerOrOwner {
  //     require(_token != address(0), 'token address error');
  //     require(coffin != address(0), 'coffin address error');
  //     //rebalance(wftm, coffin, _amount, _min, true, spookyRouterAddress);
  //     rebalance(_token, coffin, _amount, _min, true, spookyRouterAddress);
  //     // address[] memory router_path = new address[](2);
  //     // router_path[0] = _token;
  //     // router_path[1] = coffin;

  //     // rebalanceWithRouterPath(
  //     //   _token,
  //     //   coffin,
  //     //   _amount,
  //     //   _min,
  ...
  //   // buyback
  //   //   function buyBackCoUSDwithUSDC(
  //   function buyBackCoUSD(
  //     address _token,
  //     uint256 _amount,
  //     uint256 _min
  //   ) public onlyBuybackManagerOrOwner {
  ...
  //     rebalance(_token, cousd, _amount, _min, true, spookyRouterAddress);
  //     // address[] memory router_path = new address[](2);
  //     // router_path[0] = _token;
  //     // router_path[1] = cousd;
