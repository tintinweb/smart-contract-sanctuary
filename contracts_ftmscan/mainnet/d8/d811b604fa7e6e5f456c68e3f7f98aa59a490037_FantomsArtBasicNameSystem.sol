...
contract FantomsArtBasicNameSystem is ERC721Enumerable, ERC165Storage, Ownable {
  ...
  function registerName(string memory _name) public payable {
    ...
    require(_reverseSearch[_name] == 0, "FNS: You cant take other peoples name");
    ...
    FantomsArtName memory _tempName = FantomsArtName(_name,_tokenIdCounter.current(),msg.sender);
