...
contract TaxOfficeV2 is Operator {
    ...
    address public rocket = address(0x71e2806E5AbBd2f40610073C52Db01B80489acD5);
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtRocket, resultAmtToken, liquidity) = IUniswapV2Router(uniRouter).addLiquidity(
            rocket,
            token,
            amtRocket,
            amtToken,
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtRocket, resultAmtFtm, liquidity) = IUniswapV2Router(uniRouter).addLiquidityETH{value: msg.value}(
            rocket,
            amtRocket,
            amtRocketMin,
            amtFtmMin,
