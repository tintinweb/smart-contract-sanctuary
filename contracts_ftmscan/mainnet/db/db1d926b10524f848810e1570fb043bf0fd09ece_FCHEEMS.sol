...
contract FCHEEMS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Fantom Cheems";
    string constant _symbol = "FCHEEMS";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 1%
    uint256 public _maxWallet = _totalSupply.div(67); // 1.5%
    ...
    address public autoLiquidityReceiver=0xfFdb54C7f8B6Febc6cB650d52FE6985f1443B8A3; //liq address
    address public marketingFeeReceiver=0xfFdb54C7f8B6Febc6cB650d52FE6985f1443B8A3; // marketing address
