...
// MushyBooster Token
contract MushyBooster is BEP20{
    
    // Burn address
    address public constant burnAddress = 0x000000000000000000000000000000000000dEaD;
    // DEV address
    address payable public constant devAddress = 0x2096aFDaA68EEaE1EbF95DFdf565eE6d9B1fbA37;
    // Fee address
    address public constant feeAddress = 0x45472B519de9Ac90A09BF51d9E161B8C6476361D;
    
    // Max transfer rate: 25%.
    uint16 public constant maxTransferRate = 2500;    
    // Max transfer rate: 20%.
    uint16 public constant minTransferRate = 2000;

    // Max transfer amount rate in basis points. 25%
    uint16 public maxTransferAmountRate = 2500;
    
    // Transfer Burn Rate: 25%.
    uint16 public constant BURN_RATE = 2500;    
    // Transfer FEE Rate: 25%.
    uint16 public constant FEE_RATE = 2500;
    ...
    // Constructs the MushyBooster contract.    
    constructor() public BEP20('MushyBooster', 'SBOOST') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual 
        override antiWhale(sender, recipient, amount) {
        ...
        if (_isNonTaxedTransfer ) {
            ...
            // 25% of every transfer burnt
            uint256 burnAmount = amount.mul(BURN_RATE).div(10000);            
            // 25% of every transfer ist sent to feeAddress
    ...
    // Returns the address is excluded from Tax or not.    
