...
contract FantomFrens is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Fantom Frens", "FFS") {
        ...
        marketingWallet = address(0xfB4d6d5E650f95067432B9bDEFF9dA180d94edcb); // set as marketing wallet
        vaultWallet = address(0x99dF1331FeBBACF6C4A1ae717623a908525d3390); // set as vault wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _vaultFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _vaultFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForVault;
        bool success;
