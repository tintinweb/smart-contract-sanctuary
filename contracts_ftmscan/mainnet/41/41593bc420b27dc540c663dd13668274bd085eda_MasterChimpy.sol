...
contract MasterChimpy is Ownable {
    using SafeMath for uint256;
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of CHIMPYs
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. CHIMPYs to distribute per block.
        uint256 lastRewardBlock;  // Last block number that CHIMPYs distribution occurs.
        uint256 accCakePerShare; // Accumulated CHIMPYs per share, times 1e12. See below.
    }
    ...
    // CHIMPY tokens created per block.
    ...
    // Update the given pool's CHIMPY allocation point. Can only be called by the owner.
    ...
    // View function to see pending CHIMPYs on frontend.
    ...
    // Deposit LP tokens to MasterChimpy for CHIMPY allocation.
    function deposit(uint256 _pid, uint256 _amount) public {

        require (_pid != 0, 'deposit CHIMPY by staking');
    ...
    // Withdraw LP tokens from MasterChimpy.
    function withdraw(uint256 _pid, uint256 _amount) public {

        require (_pid != 0, 'withdraw CHIMPY by unstaking');
    ...
    // Stake CHIMPY tokens to MasterChimpy
    ...
    // Withdraw CHIMPY tokens from STAKING.
  ...
  // Convert CHIMPY V1 to CHIMPY V2
    ...
    // Mints new Chimpy to make new investment phases in the future. PUBLICLY ANNOUNCED WHEN USED.
