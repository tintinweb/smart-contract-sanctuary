...
contract SpiritJoint is HedgilJoint {
    ...
    {
        _initalizeSpiritJoint(_masterchef, _pid);
    }
    ...
    function _initalizeSpiritJoint(address _masterchef, uint256 _pid) internal {
    ...
    function cloneSpiritJoint(
        ...
        SpiritJoint(newJoint).initialize(
            _providerA,
            _providerB,
            _router,
            _weth,
    ...
    function name() external view override returns (string memory) {
        ...
        return string(abi.encodePacked("HedgilSpiritJoint(", ab, ")"));
    }
