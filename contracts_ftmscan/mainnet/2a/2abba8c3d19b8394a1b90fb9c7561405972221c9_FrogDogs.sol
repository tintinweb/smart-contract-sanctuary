...
contract FrogDogs is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    
    /// @notice EIP-20 token name for this token
    string public constant _name = "Frog Dogs";

    /// @notice EIP-20 token symbol for this token
    string public constant _symbol = "FDOG";

    /// @notice EIP-20 token decimals for this token
    uint8 public constant _decimals = 18;

    /// @notice Total number of tokens in circulation
    uint public _totalSupply = 4200e18;
    
    uint256 public _cap = 1000000000000000000000000000000000000000000000000000e18;
