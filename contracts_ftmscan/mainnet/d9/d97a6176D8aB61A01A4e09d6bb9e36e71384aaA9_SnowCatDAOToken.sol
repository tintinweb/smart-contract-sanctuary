...
contract SnowCatDAOToken is LiquidityTrap, LiquidityActivityTrap {

    using SafeMath for uint256;

    constructor()
      ERC20("SnowCatDAO", "SCAT", 9) 
      LiquidityProtectedBase(0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3, 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83)
      LiquidityTrap(100)
    {}
