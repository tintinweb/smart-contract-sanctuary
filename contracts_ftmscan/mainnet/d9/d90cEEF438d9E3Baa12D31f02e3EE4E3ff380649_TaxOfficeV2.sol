...
contract TaxOfficeV2 is Operator {
    ...
    address public devilmons = address(0xefc3dE0898d18B456C36DC943F5469ceF0AE4cDD);
        ...
        )
    {
        ...
        IERC20(devilmons).transferFrom(msg.sender, address(this), amtTomb);
        ...
        if(amtTomb.sub(resultAmtTomb) > 0) {
            IERC20(devilmons).transfer(msg.sender, amtTomb.sub(resultAmtTomb));
        }
    ...
    function setTaxableTombOracle(address _devilmonsOracle) external onlyOperator {
        ITaxable(devilmons).setTombOracle(_devilmonsOracle);
    }
