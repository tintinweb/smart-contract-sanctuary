...
// Degen Scream Printer ($SDP) just stealth launched on Fantom

// $SDP holders will earn degen reflection in $SCREAM.

//Taxes - 2.5% Liquidity - 2.5% Marketing - 15% Reflection

// Initial Liquidity: 1000 FTM

// Slippage: 20%

// Website: no site ser, we are full degen

// Telegram: https://t.me/degenscream
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xe0654C8e6fd4D733349ac7E09f6f23DA256bF475); // SCREAM
...
contract DegenScream is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xe0654C8e6fd4D733349ac7E09f6f23DA256bF475; // SCREAM
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Degen Scream Printer";
    string constant _symbol = "DSP";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(66); // 1.5%
    uint256 public _maxWallet = _totalSupply.div(33); // 3.0%
    ...
    address public autoLiquidityReceiver=0x4a1d5015d831Cdbb2075E7584C19Df33FceA8F2B; // liq address
    address public marketingFeeReceiver=0x4a1d5015d831Cdbb2075E7584C19Df33FceA8F2B; // marketing address
