...
contract StrategyMasterChefLP is StratManager, FeeManager {
    ...
    constructor(
        ...
        address _keeper,
        address _strategist,
        address _numbaFeeRecipient
    ) StratManager(_keeper, _strategist, _unirouter, _vault, _numbaFeeRecipient)  {
        want = _want;
    ...
    function chargeFees() internal {
        ...
        uint256 numbaFeeAmount = wrappedBal.mul(numbaFee).div(MAX_FEE);
        IERC20(wrapped).safeTransfer(numbaFeeRecipient, numbaFeeAmount);
...
contract StratManager is Ownable, Pausable {
    ...
    address public numbaFeeRecipient;
     ...
     * @param _numbaFeeRecipient address where to send Beefy's fees.
     */
    constructor(
        address _keeper,
        address _strategist,
        ...
        vault = _vault;
        numbaFeeRecipient = _numbaFeeRecipient;
    }
    ...
    /**
     * @dev Updates numba fee recipient.
     * @param _numbaFeeRecipient new numba fee recipient address.
     */
    function setBeefyFeeRecipient(address _numbaFeeRecipient) external onlyOwner {
        numbaFeeRecipient = _numbaFeeRecipient;
    }
...
abstract contract FeeManager is StratManager {
    ...
    uint public numbaFee = MAX_FEE - STRATEGIST_FEE - callFee;

    function setCallFee(uint256 _fee) public onlyManager {
        require(_fee <= MAX_CALL_FEE, "!cap");
        
        callFee = _fee;
        numbaFee = MAX_FEE - STRATEGIST_FEE - callFee;
    }
