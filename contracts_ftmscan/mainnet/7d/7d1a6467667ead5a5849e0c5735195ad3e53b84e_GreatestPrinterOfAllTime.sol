...
// https://t.me/GreatestPrinterOfAllTime

// ENJOY THE UNENDING REWARDS: $ETH, $USDC, $BTC, $BOO
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BP = IBEP20(0x321162Cd933E2Be498Cd2267a90534A804051b11); // BTC
    IBEP20 TP = IBEP20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); // BOO
    IBEP20 UP = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // USDC
...
contract GreatestPrinterOfAllTime is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x74b23882a30290451A17c44f4F05243b6b58C76d; // ETH
    address BP = 0x321162Cd933E2Be498Cd2267a90534A804051b11; // BTC
    address TP = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE; // BOO
    address UP = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // USDC
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Greatest Printer Of All Time";
    string constant _symbol = "GPOAT";
    ...
    address public autoLiquidityReceiver=0x9fBDa8C29a801DE0311DFb595a386558f9177564; //liq address
    address public marketingFeeReceiver=0x9fBDa8C29a801DE0311DFb595a386558f9177564; // marketing address
