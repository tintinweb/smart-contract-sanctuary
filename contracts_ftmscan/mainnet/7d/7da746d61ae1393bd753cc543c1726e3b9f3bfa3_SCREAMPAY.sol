...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xe0654C8e6fd4D733349ac7E09f6f23DA256bF475); // HEC
...
contract SCREAMPAY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xe0654C8e6fd4D733349ac7E09f6f23DA256bF475; // ETH
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ScreamPay";
    string constant _symbol = "SCP";
    ...
    address public autoLiquidityReceiver=0xC4Ed4Ea3731D3924974aE004c0539150481cE303; //liq address
    address public marketingFeeReceiver=0xC4Ed4Ea3731D3924974aE004c0539150481cE303; // marketing address
