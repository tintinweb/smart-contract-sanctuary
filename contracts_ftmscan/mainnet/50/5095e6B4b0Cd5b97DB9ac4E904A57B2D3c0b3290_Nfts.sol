...
// File @openzeppelin/contracts/utils/math/S[email protected]
...
contract Nfts is NFTokenEnumerableMetadata, Ownable {
	...
	uint256 public priceStep = 50 ether;
	uint256 public maxSupply = 100;
	string public baseUri = 'https://fant.rocks/tokens.php?id=';
	uint16 public refShare = 1000; // in basis points, so it's 10%
	uint256 public startTime = 1637776800;
	uint256 public premint = 2;
	...
	function getNextPrice() internal returns (uint) {
	    return price + priceStep * (this.totalSupply() - premint);
	}
