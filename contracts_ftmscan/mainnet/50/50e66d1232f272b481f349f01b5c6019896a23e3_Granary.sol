...
contract Granary
{
	...
	*/
	...
	function info() public view returns (uint256, uint256, uint256, uint256, address, uint256, uint256, uint256, uint256)
	{
	...
	function tvl() public view returns(uint256)
	{
		...
		return ((tc.p_lpt_coin_usd(address(want))).mul(b)).div(1e18);
	}
