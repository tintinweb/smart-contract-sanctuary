...
// File contracts/oracles/FTMCurveGeistPoolOracle.sol
...
contract FTMCurveGeistPoolOracle is IOracle {
    ...
    function _get() internal view returns (uint256) {
        ...
        uint256 yVCurvePrice = geistPool.get_virtual_price() * minStable;
    ...
    function name(bytes calldata) public pure override returns (string memory) {
        return "Chainlink GeistPool";
    }

    /// @inheritdoc IOracle
    function symbol(bytes calldata) public pure override returns (string memory) {
        return "LINK/GeistPool";
    }
}