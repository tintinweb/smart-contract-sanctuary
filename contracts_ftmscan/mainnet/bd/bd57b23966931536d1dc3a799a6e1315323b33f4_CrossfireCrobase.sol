...
/**
 * @title CROBASE ERC20 token
 * @dev
 *      Based on the Ampleforth, Gravitoken, and Safemoon protocol.
 */
contract CrossfireCrobase is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("Crossfire Rebase", "CROBASE", uint8(DECIMALS))
        payable
        public
    {
  ...
  function burnCRO(address payable burnAddress) external onlyOwner {
