...
contract Tombheads is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage {
    ...
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Tombheads: caller is not admin");
        _;
    }
    ...
    function mint(string memory _tokenURI) public onlyAdmin {
        require(_tokenIdTracker.current() <= max_supply, "Tombheads: all tokens have been minted");
