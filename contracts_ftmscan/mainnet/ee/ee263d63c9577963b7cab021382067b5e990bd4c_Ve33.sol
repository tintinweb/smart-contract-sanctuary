...
/*
The Contract is Owned By: Ve(3,3)
*/
...
contract Ve33 is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "Ve33";
    string public constant symbol   = "ve33";
