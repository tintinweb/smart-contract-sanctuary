...
contract FEVERSaleV2 is Ownable {
    ...
    uint public constant PRICE = 1 * MIMdecimals / FEVERdecimals ;
    uint public constant MIN_PRESALE_PER_ACCOUNT = 50 * FEVERdecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 100 * FEVERdecimals;
...
//    ERC20 USDC;
    ...
    constructor() {
  //      USDC = ERC20(0x130966628846BFd36ff31a822705796e8cb8C18D);
