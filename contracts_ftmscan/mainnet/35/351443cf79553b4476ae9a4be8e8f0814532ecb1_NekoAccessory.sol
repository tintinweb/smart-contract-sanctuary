...
contract NekoAccessory is ERC1155SupplyUpgradeable, OwnableUpgradeable {
    ...
    uint256 public constant Yellow_Apricot = 0;
    uint256 public constant Bamboo_With_Coins = 1;
    uint256 public constant Cherry_Flower_Hairpin = 2;
    uint256 public constant Cherry_Flower_Rain = 3;
    uint256 public constant Falling_Coins = 4;
    uint256 public constant Hanging_Fireworks = 5;
    uint256 public constant Tiger_Glasses = 6;
    uint256 public constant Tiger_Hat = 7;
    uint256 public constant Tiger_Mask = 8;
    uint256 public constant Tiger_Tail = 9;
    uint256 public constant Tiger_Cap = 10;
    uint256 public constant Cherry_Tree = 11;
    uint256 public constant Golds_And_Red_Envelopes = 12;
    uint256 public constant Hanging_Ribbons = 13;
    uint256 public constant Row_Of_Lanterns = 14;
    uint256 public constant Hanging_Lanterns = 15;
    uint256 public constant Red_Envelope_Rain = 16;
    uint256 public constant Tiger_Suit = 17;
    uint256 public constant Fireworks_Moon = 18;
    uint256 public constant Moon = 19;
    ...
    function mintRandom(address minter, uint256 _numItems) public {
    ...
    function setMaxId(uint256 _id) public onlyOwner {
        maxId = _id;
    }
