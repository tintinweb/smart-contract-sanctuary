...
// Modern People / doublesharp / cipher0x
pragma solidity ^0.8.9;

import '@openzeppelin/contracts/utils/Counters.sol';
import '@openzeppelin/contracts/access/Ownable.sol';

import './interfaces/IPortalpassenger.sol';
...
/**************************************************************************************************
  ...
  |\   __  \|\   __  \|\   ____\ |\   ____\|\  ___ \ |\   ___  \|\   ____\|\  ___ \ |\   __  \    
  \ \  \|\  \ \  \|\  \ \  \___|_\ \  \___|\ \   __/|\ \  \\ \  \ \  \___|\ \   __/|\ \  \|\  \   
   \ \   ____\ \   __  \ \_____  \\ \_____  \ \  \_|/_\ \  \\ \  \ \  \  __\ \  \_|/_\ \   _  _\  
    \ \  \___|\ \  \ \  \|____|\  \\|____|\  \ \  \_|\ \ \  \\ \  \ \  \|\  \ \  \_|\ \ \  \\  \| 
     \ \__\    \ \__\ \__\____\_\  \ ____\_\  \ \_______\ \__\\ \__\ \_______\ \_______\ \__\\ _\ 
      \|__|     \|__|\|__|\_________\\_________\|_______|\|__| \|__|\|_______|\|_______|\|__|\|__|
                         \|_________\|_________|                                                  
/*************************************************************************************************/

contract Portalpassenger is IPortalpassenger, ERC721SplitWithdrawals, ERC721PresetMinterPauserAutoIdRoyalty, Ownable {
    ...
    constructor(
        ...
        ERC721PresetMinterPauserAutoIdRoyalty('Portalpassenger', 'PP', _baseTokenURI, 500)
        ERC721SplitWithdrawals(_recipients, _splits)
    {
        // state
        baseURI = _baseTokenURI;
        suffixURI = _suffixTokenURI;
    ...
    /**
     * @dev Go along for the journey.
     */
    function stowaway(address _target) external {
        require(hasRole(MINTER_ROLE, _msgSender()), 'Untrusted.');
        require(tokenIds.current() <= 3333, 'No more free rides.');
        tokenIds.increment();
         _safeMint(_target, tokenIds.current());
    }
    ...
    function tokenURI(uint256 _tokenId) public view override mustExist(_tokenId) returns (string memory) {
        ...
        return bytes(uri).length > 0 ? string(abi.encodePacked(uri, suffixURI)) : '';
    }
    ...
    /// @dev Set the suffix URI for the token, only by the owner
    function setSuffixURI(string memory _uri) external onlyOwner {
        suffixURI = _uri;
    }
    ...
    function setErc20RoyaltyTokens(address[] memory _royaltyERC20Tokens) external onlyOwner {
...
interface IPortalpassenger is IERC721, IERC721Enumerable {
    function stowaway(address _passenger) external;
    ...
    function setSuffixURI(string memory _uri) external;
}
...
abstract contract ERC721PresetMinterPauserAutoIdRoyalty is ERC2981Royalties, ERC721PresetMinterPauserAutoId {
    ...
    {
        return
            ERC2981Royalties.supportsInterface(_interfaceID) ||
            super.supportsInterface(_interfaceID);
    }

    /// @notice Minting is not allowed directly through mint()
