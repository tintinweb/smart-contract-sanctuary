...
contract Vesting {
    ...
    uint256 public start = 1640995200;  // 1/1/2022
    uint256 public end = 1704067200;    // 1/1/2024

    IERC20 public constant credit = IERC20(0x77128DFdD0ac859B33F44050c6fa272F34872B5E);

    mapping(address => uint256) private _vested;
    mapping(address => uint256) private _total;

    constructor() {
        _total[0x8881AcF21D569ec8182441eD381ff1945BFeC5E5] = 3750000 ether;
        _total[0x70f8892B9AEd192b3E794f9398B62D50Cf2fbBf8] = 3750000 ether;
        _total[0x2Fb95B3A73e3489A4edA4a800913f124f79D9660] = 500000 ether;
        _total[0x491385bD03e4328Ae52abA7663564ECfAfd1F728] = 250000 ether;
    }
    ...
    function vest() external {
        ...
        _vested[msg.sender] += toBeReleased;
        credit.safeTransfer(msg.sender, toBeReleased);
    }
