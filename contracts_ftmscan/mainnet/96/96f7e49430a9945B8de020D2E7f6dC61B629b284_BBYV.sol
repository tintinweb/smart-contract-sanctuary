...
contract BBYV is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xb1dC2768704936f342088D1131b21faF742922b4); // Marketing Address

    address payable public liquidityAddress =
        payable(0x6Fb33793cD5A8e518222e6f30B602FaD41488eF0); // Liquidity Address
    ...
    string private constant _name = "BabyVoorhees";
    string private constant _symbol = "BBYV";
