...
abstract contract ZapBaseV2_1 is Ownable {
    ...
    address internal constant ZapperAdmin =
        0xFa5Ebc2731ec2292bc4Cdc192d2a5f6F4B312e92; // multisig
...
interface ICoffinBondDepository {
    function deposit( uint _amount, uint _maxPrice, address _depositor) external returns ( uint );
}

contract CoffinZapIn is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;

    mapping (ICoffinBondDepository => address) public allowedPairs;
    mapping (ICoffinBondDepository => address) public allowedReserves;


    // spooky factory
    IUniSwapFactory private constant UniSwapFactory =
        IUniSwapFactory(0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3);
    ...
    constructor()
    {
        ...
        // //allowedPairs
        // allowedPairs[ICoffinBondDepository(0xaBAD60240f1a39fce0d828eecf54d790FFF92cec)] = 0x951BBB838e49F7081072895947735b0892cCcbCD; // BondDepository | Principle (FTM-LUX)
        // allowedPairs[ICoffinBondDepository(0x5612d83dfED9B387c925Ac4D19ED3aeDd71004A8)] = 0x46729c2AeeabE7774a0E710867df80a6E19Ef851; // BondDepository | Principle (DAI-LUX)

        // //allowedReserves
        // allowedReserves[ICoffinBondDepository(0x13729e99A7b77469f7FD204495a7b49e25e8444a)] = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; // BondDepository | WFTM
        // allowedReserves[ICoffinBondDepository(0xCf994423b39A6991e82443a8011Bf6749e19434b)] = 0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E; // BondDepository | DAI
    }
    ...
    function ZapInLp(
        ...
        ICoffinBondDepository _bondDepository,
        uint256 _amount,
    ...
    {
        IUniSwapPair uniPair = IUniSwapPair(_pairAddress);
