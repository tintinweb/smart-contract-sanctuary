...
// File: contracts/MouseSwap.sol


pragma solidity 0.6.12;


// MouseSwap with Governance.
contract MouseSwap is BEP20('MouseSwap', 'Mouse') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTMouse::transfer: Burn value invalid");
