...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x940F41F0ec9ba1A34CF001cc03347ac092F5F6B5); // USDT
    ...
    uint256 public minDistribution = 10 * (10 ** 17);
...
contract USDTPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x940F41F0ec9ba1A34CF001cc03347ac092F5F6B5; // USDT
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "USDTPRINTER";
    string constant _symbol = "USDTPRINTER";
    ...
    address public autoLiquidityReceiver=0xDc01940F69cdA9985386137DCDCEe7B9B09245A4; //liq address
    address public marketingFeeReceiver=0x97B8848D8D81930ba74e2CE816d88529a84270Ee; // marketing address
