...
contract SpectreFantom is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Spectre Fantom';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xB6f51FD16216888AdF175dcb5b006C4cD90d27fb, 'We can not exclude router.');
