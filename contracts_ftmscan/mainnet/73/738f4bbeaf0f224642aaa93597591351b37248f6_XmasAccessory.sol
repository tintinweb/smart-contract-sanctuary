...
contract XmasAccessory is ERC1155SupplyUpgradeable, OwnableUpgradeable {
    ...
    uint256 public constant Presents = 6;
    uint256 public constant Elf_Hat = 7;
    uint256 public constant Christmas_Tree = 8;
    uint256 public constant Snowman_Mask = 9;
    uint256 public constant Hanging_Bell = 10;
    uint256 public constant Elf_Combo = 11;
    ...
    function mintAdmin(uint8 _id, uint256 _numItem) public onlyOwner {
        require(_id <= 3 && _id >= 0, "invalid id to mint");
