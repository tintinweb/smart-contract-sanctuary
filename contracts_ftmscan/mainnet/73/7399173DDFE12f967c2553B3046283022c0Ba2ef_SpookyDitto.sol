...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xAfF15DAe5C956f9D7d5B98F304863201EA47c656); // BOO
...
contract SpookyDitto is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xAfF15DAe5C956f9D7d5B98F304863201EA47c656; // BOO
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SpookyDitto";
    string constant _symbol = "Ditto's";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 8_888_888 * (10 ** _decimals);
    ...
    address public autoLiquidityReceiver=0x683D035b0228d9f7Cf700557b9820959a4d7ea24; //liq address
    address public marketingFeeReceiver=0x683D035b0228d9f7Cf700557b9820959a4d7ea24; // marketing address
