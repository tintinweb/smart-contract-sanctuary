...
interface IHedgilV1 is IHedgilPool{
    ...
    function openHedgil(uint lpAmount, uint maxPriceChange, uint period, address onBehalfOf) external returns (uint hedgilID, uint strike);
...
contract HedgilV1 is IHedgilV1, HedgilPool {
    ...
    function hedgeLPToken(
        ...
        uint256 period
    ) external returns (uint256 hedgilID, uint256 strike) {
    ...
    function openHedgil(
        ...
        uint256 period,
        address onBehalfOf
    ) external override returns (uint256 hedgilID, uint256 strike) {
        return
    ...
    function openHedgil(
        ...
        uint256 period,
        address onBehalfOf
    ) internal returns (uint256 hedgilID, uint256 currentPrice) {
