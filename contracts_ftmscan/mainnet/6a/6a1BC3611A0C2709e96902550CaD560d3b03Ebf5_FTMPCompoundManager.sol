...
contract FTMPCompoundManager is Auth {
    ...
    function compoundDividend() external {
        ...
        IERC20(FantomPay).transferFrom(msg.sender, msg.sender, 1); //Workaround to claim dividend contractually.
        ...
        FTMPay(payable(FantomPay)).transfer(msg.sender, FTMPay(payable(FantomPay)).balanceOf(address(this))); //Send the FTMP.
