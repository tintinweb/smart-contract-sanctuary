...
contract FalconX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'FalconX Fantom';
    string private constant _symbol = 'FalconX';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x9EC498EF6270B986e710c561a873befCa7D42CE4, 'We can not exclude router.');
