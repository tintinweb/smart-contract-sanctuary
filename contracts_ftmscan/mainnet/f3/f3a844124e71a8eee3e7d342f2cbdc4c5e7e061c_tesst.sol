...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0x82f0B8B456c1A451378467398982d4834b6829c1); //MIM
...
contract tesst is IERC20, Auth {

    using SafeMath for uint256;



     address RWRD = 0x82f0B8B456c1A451378467398982d4834b6829c1;  
    ...
    string constant _name = "tesst";

    string constant _symbol = "tesst";

    uint8 constant _decimals = 9;



    uint256 _totalSupply = 9900000000000001000 * (10 ** _decimals);  
