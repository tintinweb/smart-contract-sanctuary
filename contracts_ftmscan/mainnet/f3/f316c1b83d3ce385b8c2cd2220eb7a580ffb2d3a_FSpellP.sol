...
contract FSpellP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xe1146b9AC456fCbB60644c36Fd3F868A9072fc6E; // Spell
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FANTOM SpellPrinter";
    string constant _symbol = "FSpellp";
    ...
    address public autoLiquidityReceiver=0x30405F7940c9FAff3F2FCadEd7f0574E2be23851; //liq address
    address public marketingFeeReceiver=0x30405F7940c9FAff3F2FCadEd7f0574E2be23851; // marketing address
