...
contract sTestD is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Token Staked Test", "sTestD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPID supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPID
