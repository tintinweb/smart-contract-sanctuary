...
contract HuskyDao is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'HuskyDao';
    string private constant _symbol = 'Husky';

    uint256 private _taxFee = 2;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 500 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x30112CBAFC61F680a40164048f744768665BaB4A, 'We can not exclude router.');
