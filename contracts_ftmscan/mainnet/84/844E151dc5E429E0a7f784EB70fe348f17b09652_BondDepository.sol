...
library SafeMath {
    ...
    function sub1(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMath: subtraction overflow1");
    }

    function sub2(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMath: subtraction overflow2");
    }

    function sub3(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMath: subtraction overflow3");
    }
...
contract BondDepository is Ownable {
    ...
    function deposit( 
        ...
        uint profit = value;
        profit = profit.sub1 ( payout );
        profit = profit.sub2 ( fee );
        ...
        if ( fee != 0 ) { // fee is transferred to dao 
            IERC20( Coffin ).safeTransfer( DAO, fee ); 
        }
