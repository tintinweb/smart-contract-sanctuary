...
contract Strategy_DAI_FTM {
    // This strategy is for FTM network. DAI - FTM pair. RewardToken = "Boo"
    ...
    address public constant lpToken = 0xe120ffBDA0d14f3Bb6d6053E90E63c572A66a428;
    ...
    function _swapExactETHForTokens(address _token, uint256 _amountETH) internal {
        ...
        if(_token != WETH) {
            path[1] = _token;
            amounts = IRouter(router).getAmountsOut(_amountETH, path);
