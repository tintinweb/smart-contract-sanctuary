...
/*
    ...
    Snorlax Fantom
    This token provide fast play token, this token will make you rich
...
contract Snorlex is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Snorlex Fantom';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xA47637F89e279f5D6A67A8e4364A537231829C1C, 'We can not exclude router.');
