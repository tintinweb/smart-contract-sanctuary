...
library Address {
    ...
    constructor () {
        _owner = 0xB8bCdc85352b530EFddd891c12b52e622F9d4898;
...
contract JeetsClub is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd57AbD006353c9833fA2d17f94015eF7375eD2aC; // dev/mark
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Jeets Club";
