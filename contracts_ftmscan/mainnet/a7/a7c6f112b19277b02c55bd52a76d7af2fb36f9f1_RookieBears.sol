...
// File: contracts/RookieBears.sol
...
contract RookieBears is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, Pausable {
  using Counters for Counters.Counter;

  Counters.Counter private _tokenIds;

  uint256 public presaleDate = 1642255200;
  uint256 public saleDate = 1642258800;

  address payable public depositAddress = payable(0x0F961f594450E67D78557b444b90EFF8EB7c5a34);
  address private devAddress = 0x0F961f594450E67D78557b444b90EFF8EB7c5a34;
  ...
  constructor() ERC721 ("RookieBears", "BEARS") {
    baseURI = "https://mint.rookiestudio.xyz/api/bear/";
    _pause();
  }
  ...
  function mintWhitelisted(uint8 amount) public payable whenNotPaused {
    ...
    require(msg.value == whitelistPrice * amount, "Invalid amount");

    depositAddress.transfer(whitelistPrice * amount);
  ...
  function bearsOwned(address _owner) external view returns (uint256[] memory) {
  ...
  function updatelPresaleDate(uint256 newDate) public onlyOwner {
    presaleDate = newDate;
  }

  function updatelSaleDate(uint256 newDate) public onlyOwner {
    saleDate = newDate;
  }

  function internalMint(address to) internal {
    require(totalSupply() < maxSupply, "All Bears have been minted!");
