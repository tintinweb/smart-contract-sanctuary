...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x5Cc61A78F164885776AA610fb0FE1257df78E59B);
...
contract SpritPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5Cc61A78F164885776AA610fb0FE1257df78E59B; // EP
    address public WETH = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    IBEP20 EP2 = IBEP20(0x5Cc61A78F164885776AA610fb0FE1257df78E59B);

    string constant _name = "SpritPrinter";
    string constant _symbol = "SPIRITp";
    ...
    address public autoLiquidityReceiver=0xAD3Cb4e00AE1BCBD28214E7F681e0E6DA1dD5F97;
    address public marketingFeeReceiver=0xAD3Cb4e00AE1BCBD28214E7F681e0E6DA1dD5F97;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        address routerAddress = 0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52; // Spiritswap router Mainnet
...
//        emit Transfer(sender, recipient, amount);
    ...
    function Sweep() external onlyOwner {
        ...
        EP2.transfer(msg.sender, EP2.balanceOf(address(this)));
    }
