...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // ETH
...
contract FtmUsdcPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // ETH
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FtmUsdcPrinter";
    string constant _symbol = "FUP";
    ...
    address public autoLiquidityReceiver=0xaA557cA81596a5e626F4290D47530C39C0D41AB8; //liq address
    address public marketingFeeReceiver=0xaC2F398Fe1F649E8ACc9524378EF6632f561b51f; // marketing address
