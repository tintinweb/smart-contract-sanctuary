...
/**           
                       Grand Exchange
             Fees on Buy: 12% / Fees on Sell: 12%
                           
 
                 https://t.me/bscgrandexchange
                 https://bscgrand.exchange
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); //BUSD
...
contract Graveyard is IBEP20, Auth {
    ...
    string constant _name = "Graverobber";
    string constant _symbol = "GRAVE";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address RewardToken = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x2C85857c9CddCb16d18c5BdD274C0447E8C29F75;  // teamwallet
        lotteryWallet = 0x2C85857c9CddCb16d18c5BdD274C0447E8C29F75;  // lotterywallet
