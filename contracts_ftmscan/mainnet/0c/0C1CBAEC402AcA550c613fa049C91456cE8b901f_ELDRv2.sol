...
// Eldritch v2: buybacks, automatic liquidity, passive dividend rewards!
...
contract ELDRv2 is Ownable, IBEP20 {
    ...
    string constant _name = "Test Token Dont Buy";
    // string constant _symbol = "ELDRITCHv2";
    ...
    uint256 public liquidityFee    = 100;   //  creates LP
    uint256 public buybackFee      = 100;   // pools wFTM for buybacks
    uint256 public reflectionFee   = 200;   //  dividends
    uint256 public marketingFee    = 100;   //  marketing
    ...
    constructor () public {
        ...
        marketingFeeReceiver = payable(0x06737F691E54Af68E51e14E9d48260A8dBf4daec); //  ELDR Dev 
        autoLiquidityReceiver = marketingFeeReceiver;
    ...
    function swapBack() internal swapping {
        ...
        try distributor.depositTreasure{value: amountBNBReflection}() {} catch {}
    ...
    function triggerEldrV2Buyback(uint256 amount, bool triggerBuybackMultiplier) external onlyOwner {
    ...
    function triggerEldrV1Buyback(uint256 amount) external onlyOwner {
    ...
    function keepBuybackSimple(bool simple_buyback_enabled) external onlyOwner {
...
contract DividendDistributor is IDividendDistributor {
    ...
    function depositTreasure() external payable override onlyToken {
...
interface IDividendDistributor {
    ...
    function depositTreasure() external payable;
