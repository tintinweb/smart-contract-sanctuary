...
contract Lumens is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Lumens", "LUM", 9) ERC20Permit() {
    ...
    /**
        @notice increases Lumens supply to increase staking balances relative to profit_
        @param profit_ uint
        @return uint
     */
    ...
    // Staking contract holds excess Lumens
