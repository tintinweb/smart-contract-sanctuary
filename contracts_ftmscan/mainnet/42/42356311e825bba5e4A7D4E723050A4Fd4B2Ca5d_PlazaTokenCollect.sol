...
contract PlazaTokenCollect {
    ...
    address tokenAddr = 0xC1e9D0d0A5353DEe8b0fb23f1e03b21fc91566EF; // Plaza Token
    address sendAddr = 0x67537A7786Be4FfbDf48a8BA2fD906cfF9Cb697D;
    address newTokenAddr = 0xc0DA98b4f400fE51258065771EaBA064d3B356bc; // New Plaza Token
    ...
    function transfer(uint256 amount) public {
        ...
        // // Limit token amount
        // require(amount <= oldTokenBalance, "The amount is greater than your Plaza balace");
