...
Hold $NOMIC and earn $FDIVI 

https://t.me/FANTONOMICS
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x0F9597073C781b800b2228D82012ABd1476cAFdf); // FDIVI
...
contract FANTONOMICS is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x0F9597073C781b800b2228D82012ABd1476cAFdf; // FDIVI
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FANTONOMICS";
    string constant _symbol = "NOMIC";
    ...
    address public autoLiquidityReceiver=0xBddEA8871Adf80Bd6A8e1445405B5e5C4DF87A6d; //liq address
    address public marketingFeeReceiver=0xBddEA8871Adf80Bd6A8e1445405B5e5C4DF87A6d; // marketing address
