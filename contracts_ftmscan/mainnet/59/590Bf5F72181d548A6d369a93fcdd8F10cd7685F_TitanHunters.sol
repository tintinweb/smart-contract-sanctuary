...
/*
    ...
    Titan Hunters is Token with Confidence Audited, Decentralized, Fair and Support sustainable communities.
        2% Auto Burn
        1% Auto Liquid
        1% Dev
...
contract TitanHunters is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Titan Hunter Fantom';
    string private constant _symbol = 'TITA';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xA69A4E8dB4a31644F0eA4ce3649d9ef3da9579b1, 'We can not exclude router.');
