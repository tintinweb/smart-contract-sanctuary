...
contract NovaNode is VaultOwned { 
    mapping(address => uint) public balances;
    mapping(address=> mapping(address => uint)) public allowance;
    uint public totalSupply = 100000000000 * 10**1;
    string public name = "NovaNode";
    string public symbol = "NovaNode";
