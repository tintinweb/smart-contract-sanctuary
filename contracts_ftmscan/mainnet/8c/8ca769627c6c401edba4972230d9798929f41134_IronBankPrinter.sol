...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x00a35FD824c717879BF370E70AC6868b95870Dfb); // ETH
...
contract IronBankPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x00a35FD824c717879BF370E70AC6868b95870Dfb; // ETH
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "IronBank Printer";
    string constant _symbol = "IB Printer";
    ...
    address public autoLiquidityReceiver=0x57dce0fbAAf7cdc843B3e1C9f4f91de60399996A; //liq address
    address public marketingFeeReceiver=0x57dce0fbAAf7cdc843B3e1C9f4f91de60399996A; // marketing address
