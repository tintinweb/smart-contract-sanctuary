...
interface ILuxorBondDepository {
...
contract LuxorZap is ZapInBaseV3_1 {
    ...
    function ZapInLp(
        ...
        ILuxorBondDepository _bondDepository,
        uint256 _amount,
    ...
    */
    function _token2Token(
        ...
        _approveToken(
            _FromTokenContractAddress,
            address(SoulSwapRouter),
            tokens2Trade
        );

        address pair =
            SoulSwapFactory.getPair(
                _FromTokenContractAddress,
        ...
        tokenBought = SoulSwapRouter.swapExactTokensForTokens(
            tokens2Trade,
            1,
            path,
            address(this),
