...
/**
GIZA liquidity pool for Gizacadabra on Spookyswap.

Unlocks yield bearing GIZA and boosts liquidity.

Website: https://app.gizadao.com/#/dashboard
...
contract GIZA is Context, IERC20, Ownable {
    ...
    string private constant _name = "GIZA";
    ...
    address payable public _gizaAddress = payable(0xeCe086dae6813c0467D53554B031b53a037C8349); //GIZA Team wallet
    ...
    event UpdatedGizaAddress(address giza); //investment wallet
    ...
    function sendETHToFee(uint256 amount) private {
        _gizaAddress.transfer(amount.div(2));
        _mktgAddress.transfer(amount.div(2));
    }

    function manualSwap() external {
        require(_msgSender() == _gizaAddress);
        uint256 contractBalance = balanceOf(address(this));
        swapTokensForEth(contractBalance);
    }

    function manualSend() external {
        require(_msgSender() == _gizaAddress || _msgSender() == _mktgAddress);
        uint256 contractETHBalance = address(this).balance;
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
     ...
     //set wallet address
    function _setGIZAAddress(address gizaAddress) external onlyOwner {
        require(_gizaAddress != address(0), "_gizaAddress cannot be 0");
        _isExcludedFromFee[gizaAddress] = false;
        gizaAddress = payable(_gizaAddress);
        _isExcludedFromFee[gizaAddress] = true;
        emit UpdatedGizaAddress(_gizaAddress);
    }
