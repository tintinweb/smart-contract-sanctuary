...
Earn BTC, ETH, and FTM by simply holding

First of its kind on Fantom
...
contract FBTCETHFTMPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x74b23882a30290451A17c44f4F05243b6b58C76d; // ETH
    address EPTWO = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; // FTM
    address EPTHREE = 0xe1146b9AC456fCbB60644c36Fd3F868A9072fc6E; // BTC
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BTCETHFTMPrinter";
    string constant _symbol = "BTCETHFTMP";
    ...
    address public autoLiquidityReceiver=0xeCCbB2690A38220e8ed5d6bAA5728dF081D4E676; //liq address
    address public marketingFeeReceiver=0xeCCbB2690A38220e8ed5d6bAA5728dF081D4E676; // marketing address
