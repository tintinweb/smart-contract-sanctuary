...
import "./Strategy_Base_Manual.sol";

contract Strategy_Manual is Strategy_Base_Manual {
    constructor(
...
abstract contract Strategy_Base_Manual is Ownable, ReentrancyGuard, Pausable {
