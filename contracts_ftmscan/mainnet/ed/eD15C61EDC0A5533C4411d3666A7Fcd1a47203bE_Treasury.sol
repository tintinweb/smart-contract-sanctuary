...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x4EAF0b76a8740e01C054c076E15A3eb758FFE535), // JONES Genesis Pool
        address(0xD534bC696D708Bd8E5f035e119D260D79c69F398) // JONES Reward Pool
    ];
    ...
    // 28 first epochs (1 week) with 4.5% expansion regardless of JONES price
    ...
    uint256 public mintingFactorForPayingDebt; // print extra JONES during debt phase
    ...
    function getTombPrice() public view returns (uint256 tombPrice) {
        try IOracle(tombOracle).consult(tomb, 1e18) returns (uint144 price) {
            ...
            revert("Treasury: failed to consult JONES price from the oracle");
        }
    }
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(tomb), "jones");
