...
//  HOLD OR DAI
//  FAIR LAUNCH
//  Telegram : https://t.me/HoldOrDai
//  Twitter : https://twitter.com/DaiHold
//  Reward : Hold and receive DAI 
//
//  #   #   ###   #      ####           ###   ####          ####     #     ## 
// #   #  #   #  #       #  #         #   #  #   #          #  #   # #     #   
// #   #  #   #  #       #  #         #   #  #   #          #  #  #   #    #   
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E); // DAI REWARD
...
contract HoldOrDAI is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E; // DAI
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "HoldOrDAI";
    string constant _symbol = "HOD";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(10); // 10%
    uint256 public _maxWallet = _totalSupply.div(10); // 10%
    ...
    address public autoLiquidityReceiver=0x7F1E712fAFB85ef02f332866410aBc2292a4cc52; //liq address
    address public marketingFeeReceiver=0x7F1E712fAFB85ef02f332866410aBc2292a4cc52; // marketing address
