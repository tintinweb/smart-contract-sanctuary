...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x11319cD0bA5e4ce6c302B275b613962B5cC00aDe); // $FROG - used to be wmemo
...
contract Microbuy is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x11319cD0bA5e4ce6c302B275b613962B5cC00aDe; // frog used to be wMEMO
    address public WBNB = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; // wFTM
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Microbuy";
    string constant _symbol = "MICROBUY";
