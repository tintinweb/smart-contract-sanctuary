...
contract MetaverseDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Metaverse DAO';
    string private constant _symbol = 'MVD';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x8119897edadbEB60ad6829d8dC4151f27d38F45B, 'We can not exclude router.');
