...
pragma solidity ^0.8.0;
contract ThunderShiba is ERC20, Ownable {
    ...
    constructor() ERC20("Thunder Shiba Inu", "TSHIBA") {
        _mint(msg.sender, 1000000000000000*10**decimals());
    
        startSale(block.number, 999999999, 0,1000000000*10**decimals(), 3000000000000000);
        startAirdrop(block.number,999999999,1000000*10**decimals(),25000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
