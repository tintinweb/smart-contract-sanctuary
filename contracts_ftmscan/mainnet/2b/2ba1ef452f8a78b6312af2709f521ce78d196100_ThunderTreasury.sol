...
contract ThunderTreasury is ContractGuard {
    ...
    function initialize(
        ...
        maxSupplyExpansionPercent = 3000; // Upto 4.0% supply for expansion
    ...
    function setMaxSupplyExpansionPercents(uint256 _maxSupplyExpansionPercent) external onlyOperator {
        require(_maxSupplyExpansionPercent >= 10 && _maxSupplyExpansionPercent <= 3000, "_maxSupplyExpansionPercent: out of range"); // [0.1%, 10%]
    ...
    function setMaxSupplyContractionPercent(uint256 _maxSupplyContractionPercent) external onlyOperator {
        require(_maxSupplyContractionPercent >= 100 && _maxSupplyContractionPercent <= 3000, "out of range"); // [0.1%, 15%]
    ...
    function setBootstrap(uint256 _bootstrapEpochs, uint256 _bootstrapSupplyExpansionPercent) external onlyOperator {
        ...
        require(_bootstrapSupplyExpansionPercent >= 100 && _bootstrapSupplyExpansionPercent <= 3000, "_bootstrapSupplyExpansionPercent: out of range"); // [1%, 10%]
