...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0xAd84341756Bf337f5a0164515b1f6F993D194E1f); //FUSD
...
contract Test is IERC20, Auth {
    ...
    using SafeMath for uint256;
     ...
     address RWRD = 0xAd84341756Bf337f5a0164515b1f6F993D194E1f;  
    ...
    uint256 public _maxWallet = _totalSupply / 10;  
    ...
    constructor () Auth(msg.sender) {
        ...
        router = IDEXRouter(0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52); 
