...
contract Market is IMarket, Ownable, ReentrancyGuard {
     ...
     */
    function removeAsk(address tokenAddress, uint256 tokenId)
        public
        override
        nonReentrant
        onlyApprovedOrOwner(msg.sender, tokenAddress, tokenId)
        ...
        onlyApprovedOrOwner(msg.sender, tokenAddress, tokenId)
    {
        ...
        removeAsk(tokenAddress, tokenId);
    ...
    IMedia
{
    ...
    function setAsk(uint256 tokenId, uint256 amount)
        ...
        onlyApprovedOrOwner(msg.sender, tokenId)
    {
        IMarket(marketContract).setAsk(address(this), tokenId, amount);
    }
...
interface IMarket {
    ...
    function removeAsk(address tokenAddress, uint256 tokenId) external;
