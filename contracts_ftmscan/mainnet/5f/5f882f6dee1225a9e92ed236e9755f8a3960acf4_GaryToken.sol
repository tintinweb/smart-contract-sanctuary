...
contract GaryToken is IERC20 {

    using SafeMath for uint256;
    address owner;

    constructor(){
        owner =0x9fd4B7a30c834CC83D534C36F5092888C7a806f9;
    }

    /* ===========ERC20 PARAMS========= */
    string constant _name = "GToken";
    ...
    uint leftAllowance = _allowance.sub(amount);
    require(_allowance >= amount, "not enough amount");
    _allowances[sender][msg.sender] = leftAllowance;
    
    require(_balances[sender]>= amount, "not enough amount");
