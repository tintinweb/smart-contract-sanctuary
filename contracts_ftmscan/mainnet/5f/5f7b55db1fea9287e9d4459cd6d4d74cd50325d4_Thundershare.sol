...
contract Thundershare is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("TSHARE Token", "TSHARES") {
        _mint(msg.sender, 0.5 ether); // mint 1 BOMB Share for initial pools deployment
