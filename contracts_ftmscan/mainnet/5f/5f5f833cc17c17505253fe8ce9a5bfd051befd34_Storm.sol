...
/*
            Discord: discord.com/invite/EuSE8fye
            Twitter: https://twitter.com/StormFinanceV2
*/

contract Storm is ERC20Burnable, Operator {
    ...
    // _taxRate 0
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("StormFinance", "STORM") {
    ...
    function _getTombPrice() internal view returns (uint256 _tombPrice) {
        try IOracle(tombOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("FRACTAL: failed to fetch FRACTAL price from Oracle");
        }
    }
