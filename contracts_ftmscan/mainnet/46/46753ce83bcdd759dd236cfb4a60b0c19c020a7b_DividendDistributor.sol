...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTC = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // usdc
...
contract ftms is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BTC = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // USDC
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FTMS";
    string constant _symbol = "FTMS";
    ...
    address public autoLiquidityReceiver=0x9d1383c2c6AfE2D2B74743C8396990770B08035e;
    address public marketingFeeReceiver=0x9d1383c2c6AfE2D2B74743C8396990770B08035e;
	address public devFeeReceiver=0xBf031EE6bA2f46Cf24B5535E464B3bF64707e437;
    ...
    function swapBack() internal swapping {
		...
		payable(devFeeReceiver).transfer(amountFTMDev);
