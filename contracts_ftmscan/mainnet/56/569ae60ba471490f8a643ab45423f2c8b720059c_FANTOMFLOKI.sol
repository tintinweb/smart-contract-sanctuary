...
contract FANTOMFLOKI is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1000 * 10**6 * (10**9);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0xf4176E3A8aC051388d7c5bfD532E8ECB2a7A9BD6);
    address public _projectWalletAddress = address(0xCB0f50225dD4Aa1F4ABAcDdc21a4cD3Fa0ff1666);
    ...
    constructor() ERC20("FantomFloki", "FANTOMFLOKI") {
