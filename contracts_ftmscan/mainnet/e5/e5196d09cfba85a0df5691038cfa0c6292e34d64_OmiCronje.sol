...
/*
OmiCronje (ANDRE) is a utility token to be used in our virus game based on Andre Cronje's Rarity. Which variant will reign supreme?
*/
...
contract OmiCronje is Context, IERC20, Ownable {
    ...
    string private  _name               = "OmiCronje";

    string private  _symbol             = "ANDRE";
    ...
    address payable private _wallet_charity = payable(0x4888fB6cb6c14153C9C3600751E830257d9359c2);
    ...
    address payable private _wallet_burn = payable(0xDFBF0bb6148BD1914cbd3dF812EA0117288C69e5);
    ...
    address payable private _wallet_team = payable(0xe90D76B3ae6e45147C0B1C79E4dbfac2DB808EeC);



    // Dev wallet

    address payable private _wallet_dev = payable(0x95fcD2E845B072577D7360EE90005D29CA6b04CB);

    

    // Auto LP

    uint256 public _fee_liquidity = 1500;
    ...
    address PCSRouter = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
