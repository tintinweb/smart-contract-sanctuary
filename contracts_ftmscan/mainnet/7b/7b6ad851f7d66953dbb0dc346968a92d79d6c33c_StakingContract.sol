...
/**
* Submitted for verification at blockscout.com on 2021-04-04 17:39:27.074965Z
*/
...
contract LPTokenWrapper {
    ...
    IERC20 public uniswapTokenExchange = IERC20(0x437A6b06Dc4f5e2B3C935082b6aB8C1f77cd05E3);
...
contract StakingContract is LPTokenWrapper {
    IERC20 public tradedToken = IERC20(0xF9B6d2AA551f783dc024ab4624CB900BFe571aC9);
    ...
    modifier _needsAdmin() {
        require(msg.sender == addrDev, "ALERT: No admin/dev rights");
...
// File: contracts/UnipoolBalanceProxy.sol
...
contract UnipoolBalanceProxy {
    ...
    IERC20 public tradedToken = IERC20(0xF9B6d2AA551f783dc024ab4624CB900BFe571aC9);
    StakingContract public pool;

    constructor(StakingContract _pool) public {
        pool = _pool;
    }
