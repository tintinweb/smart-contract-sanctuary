...
contract Baby2Shares is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Baby2Shares';
    string private constant _symbol = 'Baby2Shares';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x9205fE5F1D31Af425074AE2a67616DE6D95518EE, 'We can not exclude router.');
