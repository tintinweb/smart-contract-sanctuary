...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x82f0B8B456c1A451378467398982d4834b6829c1); // ETH
...
contract MIMmachine is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x82f0B8B456c1A451378467398982d4834b6829c1; // ETH
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MIMmachine";
    string constant _symbol = "MIMmachine";
    ...
    address public autoLiquidityReceiver=0xE551222aea5b3b834892269be8AC16020D694033; //liq address
    address public marketingFeeReceiver=0xE551222aea5b3b834892269be8AC16020D694033; // marketing address
