...
contract Holidays is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xcb051499a53173a5df0C990dCE07Ed5F3d6A0BDc); // Marketing Address
    ...
    uint256 private _tTotal = 100_000_000_000_000_000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Holidays";
    ...
    constructor () public {
        _rOwned[marketingAddress] = _rTotal;
