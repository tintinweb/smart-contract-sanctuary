...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x6a07A792ab2965C72a5B8088d3a069A7aC3a993B);
...
contract test is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE7a9635BB381725F7B69b6344b3d0b2e73A87376;
        devFeeReceiver = 0xE7a9635BB381725F7B69b6344b3d0b2e73A87376;
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(devFeeReceiver).call{value: amountFTMDev, gas: 30000}("");
