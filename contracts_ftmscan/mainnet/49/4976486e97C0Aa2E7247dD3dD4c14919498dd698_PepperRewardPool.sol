...
// File contracts/distribution/PepperGenesisRewardPool.sol
...
// Note that this pool has no minter key of PEPPER (rewards).
// Instead, the governance will call PEPPER distributeReward method and send reward to this pool at the beginning.
contract PepperRewardPool {
    using SafeMath for uint256;
