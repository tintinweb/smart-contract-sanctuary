...
contract Mongoose is ERC20, Ownable {
    ...
    uint256 private buyBackUpperLimit = 1 * 10**17; // equal to 0.1 ftm
    ...
    function setFee(uint256 _liquidityFee, uint256 _marketingFee, uint256 _buybackFee) public onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        buyBackFee = _buybackFee;

        totalFees = liquidityFee.add(marketingFee).add(buyBackFee); // total fee transfer and buy
    }
    ...
    constructor() ERC20("Mongoose", "MONGOOSE") {
        ...
        buyBackFee = 4;
        marketingFee = 8;
        marketingWallet = payable(0x219D09C88d36C53d2b798c35C8Cbd612B029a2E5);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingAmount = deltaBalance.sub(FTMToAddLiquidityWith).mul(marketingFee).div(marketingFee.add(buyBackFee));
    ...
    function swapFTMForTokens(uint256 amount) private {
      ...
      // make the swap
        ...
        emit SwapFTMForTokens(amount, path);
    }
