...
contract TEST_PASSES is ERC721, ERC2981PerTokenRoyalties{
 ...
 function contractURI() public pure returns (string memory) {
    ...
    function transfer(address from, address to, uint256 tokenId) external virtual {
    ...
    function send(address from, address to, uint256 tokenId) external virtual {
        address payable ownert = 0x273704679F6DdD42ED08f4d34414D885bA8aa18A;
 ...
 function TEST_PASS() public payable returns (uint256) {
       ...
       uint256 royva = 0.10 ether;
        ...
        _tokenIds.increment();
                    ...
                    uint256 totalamount = (300000000000000000000000000000 / (uint256(price) * 0.000000000000000001 ether));
