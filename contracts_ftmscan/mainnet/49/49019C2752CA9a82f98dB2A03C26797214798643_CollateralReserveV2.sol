...
contract CollateralReserveV2 is Ownable{
    ...
    address mim = 0x82f0B8B456c1A451378467398982d4834b6829c1;
    address wmemo = 0xDDc0385169797937066bBd8EF409b5B3c0dFEB52;
    address weth = 0x74b23882a30290451A17c44f4F05243b6b58C76d;
    address yvdai = 0x637eC617c86D24E421328e6CAEa1d92114892439;
    address xboo = 0xa48d959AE2E88f1dAA7D5F611E01908106dE7598;
    address yvusdc = 0xEF0210eB96c7EB36AF8ed1c20306462764935607;
    ...
    function addCollateralToken(address _token) public onlyOwner{
        ...
        if (collateralTokens[_token] == true) {
            // aready;
            return;
        }
    ...
    function removeCollateralToken(address _token) public onlyOwner {
        if (collateralTokens[_token] == false) {
            // it's not
            return;
        }
    ...
    function setXCoffin(address _xcoffin)public onlyOwner {
        require(_xcoffin != address(0), "invalid token");
        xcoffin = _xcoffin;
    }

    // function setCoffin(address _coffin)public onlyOwner {
    //     coffin = _coffin;
    // }
    // function setCoUSD(address _cousd)public onlyOwner {
    //     cousd = _cousd;
    // }
    function setCoffinTheOtherWorld(address _coffintheotherworld)public onlyOwner {
        coffintheotherworld = _coffintheotherworld;
    }

    function buyBackCoffin(uint _amount, uint _min) public onlyOwner {
    ...
    function buyBackCoUSDwithUSDC(uint _amount, uint _min) public onlyOwner {
    ...
    function buyBackCoUSDwithWFTM(uint _amount, uint _min) public onlyOwner {
        require(cousd!=address(0), "cousd address error");
        addCollateralToken(cousd);
    ...
    function stakeCoffin(uint _amount) public onlyOwner {
        require(coffin!=address(0), "coffin address error");
    ...
    function burnXCoffin(uint _amount) public onlyOwner {
