...
//Mpadao make profite again, create tg and shill ez moon i let 150dai and 150mpadao hope moon was close
...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0x74b23882a30290451A17c44f4F05243b6b58C76d); 
...
contract HUND is IERC20, Auth {
    using SafeMath for uint256;
 
     address RWRD = 0x74b23882a30290451A17c44f4F05243b6b58C76d;  
     address WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;  
     address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MpaDAO";
    string constant _symbol = "mpaDAO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 150 * (10 ** _decimals);  
