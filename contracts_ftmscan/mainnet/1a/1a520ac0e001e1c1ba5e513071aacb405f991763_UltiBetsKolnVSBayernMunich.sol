...
contract UltiBetsKolnVSBayernMunich {
  enum Side { Koln, BayernMunich }
  ...
  function claimBetCancelledEvent(Side _side) external {
    ...
    betsAmountPerBettor[msg.sender][Side.Koln] = 0;
    betsAmountPerBettor[msg.sender][Side.BayernMunich] = 0;
