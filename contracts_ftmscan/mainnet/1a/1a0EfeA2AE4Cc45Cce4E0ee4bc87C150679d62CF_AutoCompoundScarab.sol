...
/**
 * @dev Implementation of a strategy to get yields from farming LP Pools in SpiritSwap.
 * SpiritSwap is an automated market maker (“AMM”) that allows two tokens to be exchanged on Fantom's Opera Network.
 *
 ...
 */
contract AutoCompoundScarab is Ownable, Pausable {
    ...
    /**
     * @dev Scarab Finance Contracts:
     * {treasury} - Address of the Scarab Finance treasury
