...
contract Ichigo is ERC20, Ownable {
    ...
    constructor() ERC20("Ichigo", "ICHIGO") {
        ...
        marketingWallet = address(0x993BF63bceC05813378873a4abDce0c3df4A7e6c); // set as marketing wallet
        devWallet = address(0x993BF63bceC05813378873a4abDce0c3df4A7e6c); // set as dev wallet
