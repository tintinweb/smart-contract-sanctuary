...
// File: contracts/gg-final-unflattened.sol
...
contract GraffGremsEpisode1 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("GraffGrems-E1","GRF-E1") {
    cost = 25 ether;
    maxSupply = 500;
    nftPerAddressLimit = 1; // limit for presale
    reservedAmount = 18; // giveaways + team
    setBaseURI('ipfs://QmZASGVfGTGDUZbdufYeM9W98BPmvRmt3dkxr2wRrPPAJb/');
  }
