...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        unchecked {
            ...
            // benefit is lost if 'b' is also FantomInued.
...
contract FantomInu is Auth {
  ...
  string constant _name =  "FantomInu";    
  string constant _symbol = "FantomInu";        
