...
An insurance wallet collects tax fee from each transaction which is used to payout victims of rugs
incase a token reviewed by DefyMafia rugs.
...
contract MAFIACare is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = _tTotal.mul(4).div(100);
    uint256 public maxSellAmount = _tTotal.mul(2).div(100);
    ...
    string private constant _name = "MAFIACare";
