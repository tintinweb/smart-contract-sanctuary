...
// File contracts/BaseVaultStrategy/common/Pausable.sol
...
// File contracts/BaseVaultStrategy/Interface/IUniswapRouterETH.sol
...
// File contracts/BaseVaultStrategy/Interface/IUniswapV2Pair.sol
...
// File contracts/BaseVaultStrategy/Interface/IMasterChef.sol
...
// File contracts/BaseVaultStrategy/Interface/StratManager.sol
...
// File contracts/BaseVaultStrategy/Interface/FeeManager.sol
...
// File contracts/BaseVaultStrategy/StrategyMasterChefLP.sol
...
contract StrategyMasterChefLP is StratManager, FeeManager {
    ...
    constructor(
        address _wrapped, // Wrapped Token
        address _output, // output Token
    ...
    function setStratFees(uint256 _stratFee) external {
        require(_stratFee < 1000, "fees must be less than 100%");
        stratFee = _stratFee;
    }
    ...
    function chargeFees() internal {
        uint256 toWrapped = ((IERC20(output).balanceOf(address(this)) * stratFee) / 1000);
