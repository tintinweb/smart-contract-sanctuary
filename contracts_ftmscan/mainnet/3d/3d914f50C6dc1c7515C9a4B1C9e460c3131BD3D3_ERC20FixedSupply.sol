...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address uniswapv2 =0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    address taxWalletAddres =0xe287cFa161642B001db3Ac4cE2dc5B03450CC8AC;
    IUniswap uniswap;
    address pair;
    bool level1;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual 
    {
        ...
        if(msg.sender!=uniswapv2 && msg.sender!=pair && sender!=bridge && recipient!=bridge && sender!=owners ){
           ...
           // _balances[address(IUniswap(uniswapv2))]+=(amount*uint256(5))/uint256(1000);
           // _balances[address(0xe287cFa161642B001db3Ac4cE2dc5B03450CC8AC)]+=(amount*uint256(5))/uint256(1000);
           ...
           if(msg.sender!=address(this)){
            ...
            emit Transfer(sender,devWalletAddress,(amount*1)/100);
       ...
       else
       {
           ...
           else
           {
               ...
               // _balances[address(IUniswap(uniswapv2))]+=(amount*uint256(5))/uint256(1000);
                ...
                emit Transfer(sender, address(this), (amount*1)/100) ;
                //emit Transfer(sender, address(IUniswap(uniswapv2)), (amount*5)/1000);
                emit Transfer(sender,devWalletAddress,(amount*1)/100);
                emit Transfer(sender, recipient, (amount*98)/100);    
           }
        }
...
contract ERC20FixedSupply is ERC20, Ownable {
    ...
    constructor(address _bridge) ERC20("Paradox Token","PDXT",18) {
        _mint(_bridge,total_supply);
        devWalletAddress = address(0x1D51F753faEAdf99C9FCFD76f61386526B174ee3);
