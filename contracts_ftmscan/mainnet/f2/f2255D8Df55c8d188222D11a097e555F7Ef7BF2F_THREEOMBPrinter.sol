...
// No frills, no bs 3OMB printer token.
...
// Dependency file: contracts/baby/THREEOMBPrinterDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distribute3OMBDividends(uint256 amount) public onlyOwner {
...
contract THREEOMBPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main THREEOMBPrinter contract."
        );
    }
...
// Root file: contracts/baby/THREEOMBPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/THREEOMBPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract THREEOMBPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    THREEOMBPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = THREEOMBPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "THREEOMBPrinter: The dividend tracker already has that address"
        );

        THREEOMBPrinterDividendTracker newDividendTracker = THREEOMBPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "THREEOMBPrinter: The new dividend tracker must be owned by the THREEOMBPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "THREEOMBPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "THREEOMBPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != UniswapV2Pair,
            "THREEOMBPrinter: The Pancakeswap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "THREEOMBPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "THREEOMBPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "THREEOMBPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initial3OMBBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensFor3OMB(tokens);
    ...
    function swapTokensFor3OMB(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distribute3OMBDividends(dividends);
