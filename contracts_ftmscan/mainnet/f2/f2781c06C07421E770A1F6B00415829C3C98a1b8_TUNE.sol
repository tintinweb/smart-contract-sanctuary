...
contract TUNE is ERC721Enumerable, ReentrancyGuard, Ownable {
   ...
   string[] private lyrics = [
        ...
        " is getting coal",
        " born on December 24",
        " may or may not be the Grinch",
        " decorates November 1",
        " spun the dreidel, dreidel, dreidel",
        " played their halil in the corner"
    ];

    constructor(address _beneficiary) ERC721("TUNE Musical Christmas Cards", "TUNE") Ownable() {
