...
contract Token is ERC20Permit, VaultOwned {
    ...
    constructor() ERC20("Token", "TOKEN", 9) {
	...
	function enableTrading() external onlyVault() {
		tradingEnabled = true;
	}

	function canTrade() private view returns (bool) {
		if (msg.sender == vault() || tradingEnabled) {
			return true;
		}
		return false;
	}
	...
	function transfer(address recipient, uint256 amount) public override returns (bool) {
		require(canTrade(), "Trading isn't enabled yet.");
