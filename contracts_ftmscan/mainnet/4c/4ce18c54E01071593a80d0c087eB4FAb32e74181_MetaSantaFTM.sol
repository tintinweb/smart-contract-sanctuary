...
/*
    ...
    The Great $MSANTA protects the earth
     and responsible for uniting mankind and spirits when Christmas comes.
    t.me/MetaSantaFTM
...
contract MetaSantaFTM is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Meta Santa Fantom';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xFAC8C5113267375d00eA64fC3A6FBD6F38868878, 'We can not exclude router.');
