...
contract testSupply is Ownable{
    ...
    constructor(IERC20 _degen){
        degen = _degen;
    }

    function allocate(address[] memory _shoppers,uint256[] memory _credit) external onlyOwner {
    ...
    function claim() external {
        ...
        shopper.credit=0;
        degen.safeTransfer(address(msg.sender),cred);
    }
