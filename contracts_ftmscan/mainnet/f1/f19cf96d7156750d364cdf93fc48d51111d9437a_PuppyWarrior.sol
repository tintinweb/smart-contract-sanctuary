...
contract PuppyWarrior is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name     = "Puppy Warrior";
    string private _symbol   = "PUPPY WARRIOR";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _spookyswapV2Router; // Spookyswap V2 Router
    address public _spookyswapV2LiquidityPair;     // Spookyswap V2 liquidity pairing for PUPPYWARRIOR/WFTM
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x9d2EE8427098a4084F29C439cb87aE3E3ec06C49); // Marketing address used to pay for marketing
