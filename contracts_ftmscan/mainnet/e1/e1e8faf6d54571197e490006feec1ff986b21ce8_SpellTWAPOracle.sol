...
contract SpellTWAPOracle is IOracle {
    ...
    IWOHM public constant wSPA = IWOHM(0x89346B51A54263cF2e92dA79B1863759eFa68692);
    ...
    function get(bytes calldata data) external override returns (bool, uint256) {
        ...
        pairInfo.priceAverage = uint144(1e44 / (uint256(FixedPoint
            ...
            .mul(1e9)
            .decode144()).mul(uint256(DAI_USD.latestAnswer())).mul(1e18) / wSPA.sOHMTowOHM(1e9)));
        pairInfo.blockTimestampLast = blockTimestamp;
    ...
    function peekSpot(bytes calldata data) external view override returns (uint256 rate) {
        ...
        rate = 1e44 / ( uint256(1e18).mul( (reserve1.mul(1e9) / reserve0).mul(uint256(DAI_USD.latestAnswer()))) / wSPA.sOHMTowOHM(1e9) );
    ...
    function test5() public view returns (uint256){
        (uint256 reserve0, uint256 reserve1, ) = pair.getReserves();
        return uint256(1e18).mul( (reserve1.mul(1e9) / reserve0).mul(uint256(DAI_USD.latestAnswer()))) / wSPA.sOHMTowOHM(1e9) ;
    }
