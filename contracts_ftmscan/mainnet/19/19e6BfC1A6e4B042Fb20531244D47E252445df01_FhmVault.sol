...
contract FhmVault is Timelock, Ownable {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    address public fhm = 0xfa1FBb8Ef55A4855E5688C0eE13aC3f202486286;
    address public sfhm = 0x5E983ff70DE345de15DbDCf0529640F14446cDfa;
    address public staking = 0xcb9297425C889A7CbBaa5d3DB97bAb4Ea54829c2;
    address public router = 0xF491e7B69E4244ad4002BC14e878a34207E38c29; // Spookyswap
    ...
    constructor(uint256 _timelock_delay) Timelock(_msgSender(), _timelock_delay) {
        // initial token list
        tokenList[fhm] = true;
        tokenList[0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E] = true; // DAI
        tokenList[0x82f0B8B456c1A451378467398982d4834b6829c1] = true; // MIM
    }
    ...
    function stake(uint256 _amount) external onlyOwner {
        // approve
        IERC20(fhm).safeApprove(staking, _amount);
        ...
        // revoke
        IERC20(fhm).safeApprove(staking, 0);
    ...
    function unstake(uint256 _amount) external onlyOwner {
        // approve
        IERC20(sfhm).safeApprove(staking, _amount);

        // unstake
        IStaking(staking).unstake(_amount, true);

        // revoke
        IERC20(sfhm).safeApprove(staking, 0);
