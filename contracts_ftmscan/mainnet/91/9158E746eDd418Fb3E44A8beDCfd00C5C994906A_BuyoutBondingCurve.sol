...
contract BuyoutBondingCurve is ISaleModel, Ownable {
    ...
    ISaleFactory public constant SALE_FACTORY = ISaleFactory(0x97245dfdc0db3e028131e62a8d1CAAccBd6400ad);
    ...
    event Buyout(uint24 indexed amount);
    ...
    function init(
        ...
        emit Initiated(_collection, _startTime, _endTime);
    }   
     ...
     */
    function buyout(uint24 amountOfNfts) external onlyInit {
        Info memory mInfo = _info;
