...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        address payable ownert = 0x273704679F6DdD42ED08f4d34414D885bA8aa18A;
...
contract TEST_PASSES is ERC721, ERC2981PerTokenRoyalties{
 ...
 function contractURI() public pure returns (string memory) {
    ...
    function TESTPASS_VALUE() public view returns (string memory, uint256, string memory, uint256) {
 ...
 function TEST_PASS() public payable returns (uint256) {
        ...
        address payable ownert = 0x273704679F6DdD42ED08f4d34414D885bA8aa18A;
       address royo = 0x273704679F6DdD42ED08f4d34414D885bA8aa18A;
       uint256 royva = 0.10 ether;
        ...
        _tokenIds.increment();
                    ...
                    uint256 newbalance = uintbalance - (300000000000000000000000000000 / (uint256(price) * 0.000000000000000001 ether));  
                    uint256 totalamount = uintbalance - newbalance;
                    require((300000000000000000000000000000 / (uint256(price) * 0.000000000000000001 ether)) <= uintbalance, "You're balance is lower than Transfer Amount");
                    uintbalance = newbalance;
                    totalamount = (300000000000000000000000000000 / (uint256(price) * 0.000000000000000001 ether));
                    (bool success, ) = ownert.call{value: totalamount}(""); 
                    require(success, "Transfer failed.");  
                    uint256 riderId = _tokenIds.current();     
                    _mint(msg.sender, riderId); 
                    _setTokenRoyalty(riderId,royo , royva);
