...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); // REFLECTION TOKEN
...
contract BooPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE; // REFLECTION TOKEN
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BooPrinter";
    ...
    address public autoLiquidityReceiver=0x9bFcaab49c5236189aF2671b59DcaAe5Ca247fF2; //liq address
