...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x924d0f4E5a9597edFfa3520fd747092F3657E37b); // tomb
...
contract HACKI is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xE7500318e7510952D4BA7F0280C5c7868bDDb48D; // tomb
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "HackerInu";
    string constant _symbol = "HACKI";
    ...
    address public autoLiquidityReceiver=0x84D6E2441781b2Ce815eA8DCf9e5E96F16a58129; //liq address
    address public marketingFeeReceiver=0xBFB75e5fE242980C0CD40bB5269e9DBdF6afA046; // marketing address
