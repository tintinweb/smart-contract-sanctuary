...
contract BalV2SpotPriceOracle is SpotPriceOracle {
    ...
    function getPrice() public view override returns (int256){
        ...
        uint tokenValue = totalValue.mul(weights[tokenIndex]).div(1e18);
...
import "../BalV2SpotPriceOracle.sol";

contract MaiPriceProvider is BalV2SpotPriceOracle {
    constructor() BalV2SpotPriceOracle(){
    }
}
