...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant ethAddr = 0x74b23882a30290451A17c44f4F05243b6b58C76d;
    // Fee token
    ...
    address public constant feeTokenRouterAddr =
        0xF491e7B69E4244ad4002BC14e878a34207E38c29; // SpookySwap router
    address public constant pool = 0x3a1659Ddcf2339Be3aeA159cA010979FB49155FF; // Curve pool
        ...
        )
    {
        ...
        rewardToFarmTokenPath1[1] = ethAddr;
    }
    ...
    function harvest() public override nonReentrant {
        ...
        if (_rewardBalance > harvestCutoffBps) {
            ...
            // Add liquidity
            uint256 _eth = IERC20(ethAddr).balanceOf(address(this));
            IERC20(ethAddr).safeApprove(pool, _eth);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public FARM_MASTER_CHEF = 0x00702BbDEaD24C40647f235F15971dB0867F6bdB;
    address public LP_TOKEN = 0x58e57cA18B7A47112b877E31929798Cd3D703b0f;
