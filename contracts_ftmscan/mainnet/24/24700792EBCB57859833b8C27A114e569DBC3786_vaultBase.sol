...
abstract contract JarBase is ERC20, Ownable, Pausable, ReentrancyGuard {
    ...
    // Set surplus
    function setSurplus(uint256 amount) onlyOwner external {
      surplus = amount;
    }
    ...
    function deposit(uint256 _amount) public nonReentrant whenNotPaused onlyEOA {
        ...
        uint256 _afterPool = balanceStaked();
    ...
    function withdraw(uint256 _shares) public nonReentrant {
        uint256 r = (balanceStaked().mul(_shares)).div(totalSupply());
    ...
    function getRatio() external view returns (uint256) {
        ...
        return balanceStaked().mul(1e18).div(totalSupply());
    }
