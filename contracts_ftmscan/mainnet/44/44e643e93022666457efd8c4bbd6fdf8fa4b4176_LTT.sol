...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDC = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
...
contract LTT is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDC = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // USDC
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "LTT";
    string constant _symbol = "LTT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1); // 100%
	uint256 public _maxWallet = _totalSupply.div(1); // 100%
    ...
    address public autoLiquidityReceiver=0x11D60da0BE26Cd06fD6825f846771a3C02e7eEe5;
    address public marketingFeeReceiver=0x11D60da0BE26Cd06fD6825f846771a3C02e7eEe5;
