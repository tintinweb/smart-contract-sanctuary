...
contract BloomPresale is AccessControlEnumerable, ReentrancyGuard {
    ...
    function __BloomPresale_init_unchained() internal {
        ...
        _totalPresale = _totalPresale / 9;  // Bloom decimals
...
//        require(msg.value == _minBuy || msg.value == 100 ether || msg.value == 175 ether || msg.value == _maxBuy, "Incorrect amount");
        ...
        amount = amount * IERC20Metadata(_token).decimals();
        require((_amountBought[_msgSender()] * _price / IERC20Metadata(_token).decimals()) + msg.value <= _maxBuy, "Exceeds max buy limit");
