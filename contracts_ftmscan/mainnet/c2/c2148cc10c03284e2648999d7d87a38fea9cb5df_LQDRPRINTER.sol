...
// Dependency file: contracts/baby/LQDRPRINTERDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeLQDRDividends(uint256 amount) public onlyOwner {
...
contract LQDRPRINTERDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LQDRPRINTER contract."
        );
    }
...
// Root file: contracts/baby/LQDRPRINTER.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/LQDRPRINTERDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract LQDRPRINTER is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    LQDRPRINTERDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = LQDRPRINTERDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "LQDRPRINTER: The dividend tracker already has that address"
        );

        LQDRPRINTERDividendTracker newDividendTracker = LQDRPRINTERDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "LQDRPRINTER: The new dividend tracker must be owned by the LQDRPRINTER token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "LQDRPRINTER: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "LQDRPRINTER: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "LQDRPRINTER: The PanLQDRSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "LQDRPRINTER: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "LQDRPRINTER: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "LQDRPRINTER: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialLQDRBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForLQDR(tokens);
    ...
    function swapTokensForLQDR(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeLQDRDividends(dividends);
