...
/* earn one ghost (AAVE) on another ghost (FTM) */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6a07A792ab2965C72a5B8088d3a069A7aC3a993B); // AAVE
...
contract FTMAAVEP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6a07A792ab2965C72a5B8088d3a069A7aC3a993B; // AAVE
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FantomAAVEPrinter";
    string constant _symbol = "FTMAAVEP";
    ...
    address public autoLiquidityReceiver=0xa0940c069A471A50D6638d1e94fAb3F92e37BF23; //liq address
    address public marketingFeeReceiver=0xa0940c069A471A50D6638d1e94fAb3F92e37BF23; // marketing address
