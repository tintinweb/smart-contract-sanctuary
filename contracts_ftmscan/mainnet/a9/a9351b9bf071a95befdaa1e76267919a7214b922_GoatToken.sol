...
contract GoatToken is ERC20('BlackGoat', 'GOAT') {
    ...
    constructor() {
        _mint(_msgSender(), uint256(50000000000000000000)); // 50 tokens for initial liquidity
        _mint(address(0x99Fb7c32020680AB5bea10061f4f1AD0e44d8690), uint256(50000000000000000000)); // 50 tokens for treasury
    }
