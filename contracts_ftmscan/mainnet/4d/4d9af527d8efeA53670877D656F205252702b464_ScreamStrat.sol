...
contract ScreamStrat is StratManager, FeeManager {
    ...
    address[] public wrappedToBridgeTokenRoute;
    ...
    constructor(
        ...
        address[] memory _wrappedToBridgeTokenRoute,
        ...
        require(_wrappedToBridgeTokenRoute[0] == wrapped, "wrappedToBridgeTokenRoute[0] != wrapped");
        bridgeToken = _wrappedToBridgeTokenRoute[_wrappedToBridgeTokenRoute.length - 1];
        wrappedToBridgeTokenRoute = _wrappedToBridgeTokenRoute;
    ...
    function swapRewards() internal {
        ...
        IUniswapRouter(unirouter2).swapExactTokensForTokens(wrappedBal, 0, wrappedToBridgeTokenRoute, address(this), now);
    ...
    function _giveAllowances() internal {
        ...
        IERC20(wrapped).safeApprove(unirouter2, uint256(-1));
    ...
    function _removeAllowances() internal {
        ...
        IERC20(wrapped).safeApprove(unirouter2, 0);
    ...
    function wrappedToBridgeToken() external view returns(address[] memory) {
        return wrappedToBridgeTokenRoute;
    }
}