...
Every service availed from DefyMafia.com will be charged a specific fee from the Token/Developer
availing the service and will be used to buy and burn $MAFIA tokens. Let's make FTM safe again!
All reviews and ratings will be updated on the DefyMafia.com website for public reference!
...
contract DefyMafia is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 490000000 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0xE1f7effBF0c2F68582310D17ce8eEd6b972422a2;
    address public operationsAddress = 0xE1f7effBF0c2F68582310D17ce8eEd6b972422a2;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "DefyMafia";
