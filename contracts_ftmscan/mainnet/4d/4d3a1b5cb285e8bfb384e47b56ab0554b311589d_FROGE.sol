...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor(address _router) {
        router = _router != address(0)
            ...
            : IUniswapV2Router(0xF491e7B69E4244ad4002BC14e878a34207E38c29); // SpookySwap Router
        _token = msg.sender;
    }
...
contract FROGE is IBEP20, Auth {
    ...
    constructor() Auth(msg.sender) {
        address _router = 0xF491e7B69E4244ad4002BC14e878a34207E38c29; // SpookySwap Router
    ...
    function _transferFrom(
        ...
        // Max  tx check
        address routerAddress = 0xF491e7B69E4244ad4002BC14e878a34207E38c29; // SpookySwap Router
