...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83); // DAI
...
contract TESTDAI is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; // DAI
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TESTDAI";
    string constant _symbol = "TESTDAI";
    ...
    address public autoLiquidityReceiver=0x96D51548A91fe838c088abc141AFaf64E46Ad87e; //liq address
    address public marketingFeeReceiver=0x96D51548A91fe838c088abc141AFaf64E46Ad87e; // marketing address
