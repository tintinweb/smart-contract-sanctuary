...
contract GameContract is Ownable, ReentrancyGuard {
    ...
    uint256 public winDividerEth = 100;
     ...
     // burnPercent
    uint256 public feePercentEth = 1;
    ...
    function deposit() public payable {
        ...
        else if (msg.value >= betSizeEth * 50)
    ...
    function ethGame (uint256 yourNumber) public {
        require (balanceOf[msg.sender] >= betSizeEth, 'ethGame: Bet to Small');
