...
contract VED is ERC20Burnable, Operator {
    address public govAddress = 0x61AD6756ec3eaA44572839A08207bFD882c9BAC6;
    address public bonusAddress = 0x61AD6756ec3eaA44572839A08207bFD882c9BAC6;
    ...
    uint256 public constant tokenMaxNum =  10**18 *1000000000; //max limit
    ...
    constructor() public ERC20('veDNA', 'VED') {
    ...
    function mint(address recipient_, uint256 amount_)
        ...
        returns (bool)
    {
        uint256 tokentotalSupply =   totalSupply();//max limit
        if(tokentotalSupply>=tokenMaxNum)
        {
            return false;
        }

        if(tokentotalSupply.add(amount_)>tokenMaxNum && tokentotalSupply<tokenMaxNum)
        {
            amount_ = tokenMaxNum.sub(tokentotalSupply);
        }//max limit--
