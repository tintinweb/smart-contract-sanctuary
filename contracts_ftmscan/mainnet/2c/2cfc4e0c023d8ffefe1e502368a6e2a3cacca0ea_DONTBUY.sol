...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75); // usdc REWARD
...
contract DONTBUY is IBEP20, Auth {
    ...
    address EP = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; // DAI
    ...
    string constant _symbol = "DTB";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(2); // 50%
    uint256 public _maxWallet = _totalSupply.div(2); // 50%
    ...
    address public autoLiquidityReceiver=0x5Fe9C4d9ce0746e572A792cD0126BDBB3448FbfA; //liq address
    address public marketingFeeReceiver=0x5Fe9C4d9ce0746e572A792cD0126BDBB3448FbfA; // marketing address
