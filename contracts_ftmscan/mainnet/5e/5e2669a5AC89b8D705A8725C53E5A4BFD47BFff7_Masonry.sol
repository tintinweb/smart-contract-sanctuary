...
interface ITreasury {
    ...
    function getOrbitPrice() external view returns (uint256);
...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            orbit.safeTransfer(msg.sender, reward);
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 _amount, address _to) external onlyOperator {
        ...
        require(address(_token) != address(orbit), "orbit");
        require(address(_token) != address(share), "sorbit");
