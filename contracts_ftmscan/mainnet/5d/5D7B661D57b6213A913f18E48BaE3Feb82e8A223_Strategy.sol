...
import { ChefLike } from '../interfaces/ChefLike.sol';
...
contract Strategy is BaseStrategy {
	...
	ChefLike public constant masterchef = ChefLike(0xa7821C3e9fC1bF961e280510c471031120716c3d);
	IERC20 public constant emissionToken = IERC20(0xc165d941481e68696f43EE6E99BFB2B23E0E3114); // the token we receive for staking, 0XD
	...
	ICurveFi internal constant daiPool = ICurveFi(0x0fa949783947Bf6c1b171DB13AEACBB488845B3f); // Curve's Geist USDC-DAI-USDT pool

	// tokens
	IERC20 internal constant wftm = IERC20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
	IERC20 internal constant weth = IERC20(0x74b23882a30290451A17c44f4F05243b6b58C76d);
	IERC20 internal constant wbtc = IERC20(0x321162Cd933E2Be498Cd2267a90534A804051b11);
	...
	IERC20 internal constant mim = IERC20(0x82f0B8B456c1A451378467398982d4834b6829c1);
	...
	function clone0xDAOStaker(
		...
		Strategy(newStrategy).initialize(_vault, _strategist, _rewards, _keeper, _pid, _name);
	...
	function _initializeStrat(uint256 _pid, string memory _name) internal {
		...
		healthCheck = address(0x643FEc509A0DfeBc5a2E7f952cCF8223ACAD77cA); // Fantom common health check
		...
		returns (uint256 _liquidatedAmount, uint256 _loss)
	{
		...
		if (_amountNeeded > totalAssets) {
			...
			(uint256 deposited, ) = ChefLike(masterchef).userInfo(pid, address(this));
	...
	function prepareMigration(address _newStrategy) internal override {
		...
		emissionToken.safeTransfer(_newStrategy, emissionToken.balanceOf(address(this)));
	}
