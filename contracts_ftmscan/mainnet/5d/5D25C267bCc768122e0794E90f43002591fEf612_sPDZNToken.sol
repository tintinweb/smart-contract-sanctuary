...
contract sPDZNToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked PDZN", "sPDZN", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPDZN supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPDZN
