...
contract sBulloxToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Bullox", "sBULLOX", 9) ERC20Permit() {
    ...
    /**
        @notice increases sBULLOX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBULLOX
