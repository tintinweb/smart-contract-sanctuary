...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public REWARD_TOKEN = IBEP20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83);
...
contract Hehe is IBEP20, Auth {
    ...
    string constant _name = "hehe";
    string constant _symbol = "hehe";
    ...
    uint256 public fegRewardFee   = 2;
    uint256 public marketingFee    = 1;
    uint256 public LotteryFee      = 1;
    uint256 public totalFee = marketingFee + fegRewardFee + liquidityFee + LotteryFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7a15dEB0CaF9860Dc86503eaad437aaCE80de938;
...
function multiTransfer(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC * (10**_decimals), "Not enough tokens in wallet");
...
function multiTransfer_fixed(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountFTMReflection = amountFTM.mul(fegRewardFee).div(totalFTMFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _fegRewardFee, uint256 _marketingFee, uint256 _LotteryFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        fegRewardFee = _fegRewardFee;
        marketingFee = _marketingFee;
        LotteryFee = _LotteryFee;
        totalFee = _liquidityFee.add(_fegRewardFee).add(_marketingFee).add(_LotteryFee);
