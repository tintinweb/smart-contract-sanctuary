...
/**
 * 
   Welcome to DaoVersify on Fantom
    First MultiChain Farming-As-A-Service protocol on Fantom. Diversification is Decentralization. 
   https://twitter.com/Dao_Versify
   https://discord.gg/J6QJfqz3ef 
   https://www.daoversify.xyz/
 */
interface IERC20 {
    /**
...
contract DaoVersify is Context, IERC20, Ownable {
  ...
  string private _name = 'DaoVersify';
  string private _symbol = 'DFY';
  ...
  address payable public _DFYWalletAddress;
  ...
  constructor(
    address payable DFYWalletAddress,
    address payable marketingWalletAddress
  ) {
    _DFYWalletAddress = DFYWalletAddress;
  ...
  function sendETHToTeam(uint256 amount) private {
    _DFYWalletAddress.call{ value: amount.div(2) }('');
  ...
  function _setDFYWallet(address payable DFYWalletAddress) external onlyOwner {
    _DFYWalletAddress = DFYWalletAddress;
  }
