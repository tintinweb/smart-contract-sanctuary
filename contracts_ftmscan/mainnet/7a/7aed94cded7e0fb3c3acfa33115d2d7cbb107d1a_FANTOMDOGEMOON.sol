...
contract FANTOMDOGEMOON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FantomDogeMoon";
    string constant _symbol = "$FTMDGGMN";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(50); // 2.0%
    ...
    address public autoLiquidityReceiver=0x14775cB380C62Eb429E4bBbb2c5ce7817398f99d; //liq address
    address public marketingFeeReceiver=0x14775cB380C62Eb429E4bBbb2c5ce7817398f99d; // marketing address
