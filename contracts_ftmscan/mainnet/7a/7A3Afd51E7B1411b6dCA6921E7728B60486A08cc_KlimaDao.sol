...
contract KlimaDao is Context, IERC20, Ownable {
    ...
    string private constant _name = 'KlimaDaoFinance';
    string private constant _symbol = 'KLIMA';
