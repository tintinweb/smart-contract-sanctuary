...
contract SecondChance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 150000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'SecondChance(3DT)';
    string private constant _symbol = 'Chance';

    uint256 private _taxFee = 500;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 150000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xcD100b36C325DD09D5745c2AE3D7af75833d51fe, 'We can not exclude router.');
