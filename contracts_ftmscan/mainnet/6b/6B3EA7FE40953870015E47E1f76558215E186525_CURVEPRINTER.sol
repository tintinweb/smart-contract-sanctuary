...
// Dependency file: contracts/baby/CURVEPRINTERDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeCURVEDividends(uint256 amount) public onlyOwner {
...
contract CURVEPRINTERDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CURVEPRINTER contract."
        );
    }
...
// Root file: contracts/baby/CURVEPRINTER.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/CURVEPRINTERDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract CURVEPRINTER is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    CURVEPRINTERDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = CURVEPRINTERDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "CURVEPRINTER: The dividend tracker already has that address"
        );

        CURVEPRINTERDividendTracker newDividendTracker = CURVEPRINTERDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "CURVEPRINTER: The new dividend tracker must be owned by the CURVEPRINTER token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "CURVEPRINTER: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "CURVEPRINTER: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "CURVEPRINTER: The PanCURVESwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "CURVEPRINTER: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "CURVEPRINTER: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "CURVEPRINTER: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialCURVEBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForCURVE(tokens);
    ...
    function swapTokensForCURVE(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeCURVEDividends(dividends);
