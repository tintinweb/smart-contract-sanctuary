...
contract DAOInformationHelper {
    struct Information {
        ...
        uint256 blockPrecision;
        uint256 stakingBalance;
    }
    
    function info(address stakingContract, address stakedToken, address timeTracker, address stakingWallet) public view returns (Information memory) {
