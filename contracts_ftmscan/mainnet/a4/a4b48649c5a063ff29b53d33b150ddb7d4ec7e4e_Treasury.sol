...
contract Treasury is ContractGuard {
    ...
    function setMaxSupplyExpansionPercents(uint256 _maxSupplyExpansionPercent) external onlyOperator {
        require(_maxSupplyExpansionPercent >= 10 && _maxSupplyExpansionPercent <= 2500, "_maxSupplyExpansionPercent: out of range"); // [0.1%, 25%]
    ...
    function setMaxExpansionTiersEntry(uint8 _index, uint256 _value) external onlyOperator returns (bool){
        require(_index >= 0, "Index has to be higher than 0");
        require(_index < 9, "Index has to be lower than count of tiers");
        require(_value >= 10 && _value <= 2500, "_value: out of range"); // [0.1%, 25%]
    ...
    function setBootstrap(uint256 _bootstrapEpochs, uint256 _bootstrapSupplyExpansionPercent) external onlyOperator {
        ...
        require(_bootstrapSupplyExpansionPercent >= 100 && _bootstrapSupplyExpansionPercent <= 2500, "_bootstrapSupplyExpansionPercent: out of range"); // [1%, 25%]
