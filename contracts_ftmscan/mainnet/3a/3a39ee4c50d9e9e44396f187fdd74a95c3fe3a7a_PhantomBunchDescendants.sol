...
contract PhantomBunchDescendants is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 87 ether; // change price per unit
  uint256 public maxSupply = 1087; // max supply, contract will stop minting after this amount is reach in your open sea colection
