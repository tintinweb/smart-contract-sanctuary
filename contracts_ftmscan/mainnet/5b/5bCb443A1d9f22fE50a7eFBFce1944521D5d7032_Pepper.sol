...
// PEPPER FINANCE
contract Pepper is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the PEPPER ERC-20 contract.
     */
    constructor() public ERC20("PEPPER", "PEPPER") {
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints PEPPER to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of PEPPER to mint to
