...
contract SpellionaireDistributor {
...
contract Spellionaire is IBEP20, Auth {
    ...
    string constant _name = "Spellionaire";
    string constant _symbol = "spellionaire";
    ...
    address public marketingFeeReceiver=0x8724b613Af30A302c81FC854Fb014d8ff7A4918d; // marketing address 
    ...
    SpellionaireDistributor distributor;
    ...
    constructor (address distributorAddress) Auth(msg.sender) {
        ...
        distributor = SpellionaireDistributor(distributorAddress);
    ...
    function setLiqAddress(address liqAddress) external onlyOwner {
        autoLiquidityReceiver = liqAddress;
    } 
