...
import "./IOracle.sol";
import "./IPodPrediction.sol";

/**
 * @title FTM prediction
 */
contract PodPrediction is
    OwnableUpgradeable,
    PausableUpgradeable,
    ...
    IPodPrediction
{
        ...
        notContract
    {
        ...
        if (reward > 0) {
            _safeTransferFTM(address(msg.sender), reward);
        }
    }
    ...
    function claimTreasury() external nonReentrant onlyOwner {
        ...
        treasuryAmount = 0;
        _safeTransferFTM(owner(), currentTreasuryAmount);
