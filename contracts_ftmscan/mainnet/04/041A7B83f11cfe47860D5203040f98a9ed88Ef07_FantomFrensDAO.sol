...
contract FantomFrensDAO is Ownable, Pausable {
    ...
    function submitVote(uint proposalId, uint option) external whenNotPaused {
        ...
        require( block.timestamp > proposalList[proposalId].initiationTimestamp , "Proposal has not started yet");
