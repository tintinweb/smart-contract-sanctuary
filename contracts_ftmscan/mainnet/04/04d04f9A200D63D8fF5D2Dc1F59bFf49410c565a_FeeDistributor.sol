...
contract FeeDistributor is IFeeDistributor, Ownable {
    ...
    address public immutable override tarot;
    address public immutable override xTAROT;
    ...
    function claim() external override returns (uint amount) {
        ...
        lastClaim = block.timestamp;
        uint balance = IERC20(tarot).balanceOf(address(this));
        ...
        if (amount > 0) {
            IERC20(tarot).safeTransfer(xTAROT, amount);
        }
