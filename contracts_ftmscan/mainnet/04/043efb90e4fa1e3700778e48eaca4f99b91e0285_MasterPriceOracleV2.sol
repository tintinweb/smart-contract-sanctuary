...
import "../solc_v0.8.4/Interfaces.sol";
...
contract MasterPriceOracleV2 is PriceOracle, BasePriceOracle, Ownable {
  ...
  event UpdateFallbackOracle(BasePriceOracle oldFallbackOracle, BasePriceOracle newFallbackOracle);
  event SetOracles(address[] underlyings, BasePriceOracle[] oracles);

  constructor(BasePriceOracle _fallbackOracle) {
    fallbackOracle = _fallbackOracle;
  }

  function updateFallbackOracle(BasePriceOracle _fallbackOracle) external onlyOwner {
