...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.3.2/contracts/utils/math/SafeMath.sol
...
// File: contracts/Fantomized/fantomizedart.sol
...
abstract contract ERC721Tradable is ERC721Enumerable, Ownable {
     ...
     * @param tokenURI_ address of tokenurl
     */
    function mintTo(address _to, string memory tokenURI_) public onlyOwner {
 ...
 * FantomizedArt
 */
contract FantomizedArt is ERC721Tradable {


    constructor()
        ERC721Tradable("FantomizedArt", "FTZA")
    {}
