...
import "../token/ERC1155MultiWrapper.sol";

/// @title MetadataManagerDeployer
...
contract ERC1155MultiWrapperDeployer {
    ...
    function deploy(uint256 amount, uint256 salt) public onlyDeployer {
        bytes memory craetionCode = type(ERC1155MultiWrapper).creationCode;
