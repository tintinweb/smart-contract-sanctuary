    ...
    ERC721Burnable
{
    ...
    uint256 public presaleStart = 1639486800;
    uint256 public saleStart = 1639490400;
    string public baseURI;
    address private royaltyAddress;
    address private devAddress=0x1448600c20eEcD508B859a1FbEF29E895A7e6671;
    address private communityAddress=0x774eBBD90B811f1e3108D0b0EbEa95242D20C631;
    address private artAddress=0xEEB6364CEb1476B978BE103B264Ae6f33Ce1f630;
    ...
    constructor() ERC721("FantoFreidos", "FREIDO") {
    ...
    function buyWhitelistedFreido(uint8 amount) public payable {
        require(presaleStart <= block.timestamp, "Presale yet to start");
    ...
    function freidosOwned(address _owner)
        external
        view
    ...
    function setMaxSupply(uint256 newMaxSupply) public onlyOwner {
        require(newMaxSupply<3333, "Cannot Increase Supply!!");
    ...
    //Overrides
     ...
     function internalMint(address to) internal {
        require(totalSupply() < maxSupply, "All Freiods have been minted!");
 ...
 /// @dev withdraw native token
    function withdraw() public {
        ...
        payable(communityAddress).transfer(amount*10/100);
        payable(devAddress).transfer(amount*325/1000);
        payable(artAddress).transfer(amount*325/1000);
        payable(owner()).transfer(amount*25/100);
    }
