...
contract Masterchef is Ownable, ReentrancyGuard {
    ...
    uint256 private immutable LUANMAXSUPPLY;
    ...
    function updateEmissionRate(uint256 _luanPerSec) external onlyOwner {
        require(_luanPerSec >= MIN_PERSEC && _luanPerSec <= MAX_PERSEC, "Bad Emissions per sec");
        massUpdatePools();
        luanPerSec = _luanPerSec;
        emit UpdateEmissionRate(msg.sender, _luanPerSec);
    }
