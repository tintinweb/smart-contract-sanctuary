...
// I’m feeling Lazy af bros.. I’ve created this as a SAFU/Fun Degen Community Token because I CBA to do ‘Dev’ role.. just being honest kek.
//Everything needed for this Project I’m leaving down to the Community to sort out!

//I recommend starting with the tasks listed below…
...
//Consider me as the ‘Accountant’ once I see the Telegram made I will show up. I have the Marketing Wallet & Contract ownership to keep things SAFU! 

//I will be easily reachable @TheAccountantFTM buuuut…. only for a few Community selected ‘Leaders’.. they and only they will be the ones to DM me and organise Payments from Marketing! 

//P.S … some of you know me already.. but I will reveal my main when the Token hits 20k MC.. 

//Good luck Serrrrsssss!
...
contract CBA is IERC20, Auth {
    ...
    string constant _name = "CBA";
    string constant _symbol = "CBA";
    ...
    uint256 public totalFee = marketingFee + RewardFee + liquidityFee + DevFee;
    uint256 public feeDenominator  = 100;

    uint256 public sellMultiplier  = 200; //2x i.e 2x10 = 20% on Sell
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x79c59c2e79A3e9DbCae84682a1d6E5de4FE01997;
        DevFeeReceiver = 0xc139b6590623ACDb670Eca8D13889Fcc7A5b399b;
...
function multiTransfer(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountFTMDevFee = amountFTM.mul(DevFee).div(totalFTMFee);
        ...
        (tmpSuccess,) = payable(DevFeeReceiver).call{value: amountFTMDevFee, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _RewardFee, uint256 _marketingFee, uint256 _DevFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        RewardFee = _RewardFee;
        marketingFee = _marketingFee;
        DevFee = _DevFee;
        totalFee = _liquidityFee.add(_RewardFee).add(_marketingFee).add(_DevFee);
