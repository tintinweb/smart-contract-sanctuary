...
contract SUPAVortex is ERC721, ERC721URIStorage, ERC721Enumerable, Pausable, AccessControl, ERC2981ContractWideRoyalties {
    using Counters for Counters.Counter;
    using ECDSA for bytes32;
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant SIGN_ROLE = keccak256("SIGN_ROLE");
    uint256 private mintSize = 1000;
    ...
    constructor() ERC721("SUPA OG VORTEX", "SUPAVORTEX") {
    ...
    function _baseURI() internal view override onlyRole(MINTER_ROLE) returns (string memory) {
    return base;
  }
