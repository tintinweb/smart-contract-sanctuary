...
contract A23 is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 350000 * 10**_decimals;
    uint256 public _maxWalletSize = 210000000 * 10**_decimals; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x9Ca6BaAe306773f3eBffCE18c567610455e2EcaF;
    address public operationsAddress = 0x35eDDE73971Bf2B49c57296766bec782372B01FD;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "A23";
    string private constant _symbol = "A23";
    ...
    function startTrading(bool _enabled) external onlyOwner{
