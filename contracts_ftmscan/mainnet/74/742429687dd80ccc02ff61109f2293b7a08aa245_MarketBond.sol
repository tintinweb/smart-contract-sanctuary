...
// File contracts/MarketBond.sol

pragma solidity ^0.7.6;

contract MarketBond is Ownable {
    ...
    IERC20 immutable payoutToken = IERC20(0xe2fb177009FF39F52C0134E8007FA0e4BaAcBd07); // token paid for principal (SOUL)
    IERC20 immutable principalToken = IERC20(0xa2527Af9DABf3E3B4979d7E0493b5e2C6e63dC57); // inflow token (SOUL-FTM)
    ITreasury immutable customTreasury = ITreasury(0xE812066Ec065159959e9d8AfD3be67E6e772C328); // pays for and receives principal
    address immutable luxorDAO = 0xcB5ba2079C7E9eA6571bb971E383Fe5D59291a95;
    address luxorTreasury = 0xDF2A28Cc2878422354A93fEb05B41Bd57d71DB24; // receives fee
    ...
    struct Bond {
        ...
        uint paidPrice; // price paid (principal tokens per payout token) in ten-millionths - 4000000 = 0.4
    }
    ...
    /**
     *  @notice change address of Luxor Treasury
     *  @param _luxorTreasury uint
     */
    function changeLuxorTreasury(address _luxorTreasury) external {
        require( msg.sender == luxorDAO, "Only Luxor DAO" );
        luxorTreasury = _luxorTreasury;
    }
    ...
    function deposit(uint _amount, uint _maxPrice, address _depositor) external returns (uint) {
        ...
        /**
            principal is transferred in approved and deposited into the treasury, 
            returning (_amount - profit) payout token
         */
...
/**
     ...
     *  @notice protocols using Luxor Pro should be careful when quickly adding large %s to total supply
