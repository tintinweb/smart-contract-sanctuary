...
contract VotersBeer is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address public voteToken = 0x6659FB6d2b35a4618d8A3176b21c79AAe454D240;
  address public tokenBank = 0xfB14F91EB777Ab7e156255044754B169176A946b;
  ...
  function mint(address _to, uint256 _mintAmount) public {
    IERC20 tokenContract = IERC20(voteToken);
