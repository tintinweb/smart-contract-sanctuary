...
**/
contract WingswapPublicLotteryLaunchpadIDOFantomStarter is AccessControl {
    ...
    **/
    modifier onlyWinners() {
        require(lotteryContract.isAlreadyWinner(msg.sender), "The buyer is not a lottery winner");
        _;
    }
    ...
    **/
    function enableClaiming(uint256 _startDateOfClaimingTokens) public isAdmin {
        require(isClaimingOpen == false, "Claiming is already enabled");
    ...
    **/
    function getTotalIdoTokensBoughtAndPayTokensSpend() public view returns (uint256 idoTokens, uint256 payTokens) {
        ...
        return (_receiptTotalAmountSpendPayTokens, _receiptTotalAmountBoughtIdoTokens);
    }
    ...
    **/
    function buy(uint256 _amountInPayToken) external isFundingOpenAndRunning isFundingNotCanceledByAdmin isLotteryPlayedAndAllocationCalculated onlyWinners {
    ...
    **/
    function claimTokens() external isFundingClosed isFundingNotCanceledByAdmin isLotteryPlayedAndAllocationCalculated onlyWinners {
