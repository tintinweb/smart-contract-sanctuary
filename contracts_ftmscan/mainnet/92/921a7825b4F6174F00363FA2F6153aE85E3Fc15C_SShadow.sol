...
contract SShadow is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 sSHADOWs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SSHADOW", "SSHADOW") {
        _mint(msg.sender, 100 ether); // mint 1 SHADOW Share for initial pools deployment
