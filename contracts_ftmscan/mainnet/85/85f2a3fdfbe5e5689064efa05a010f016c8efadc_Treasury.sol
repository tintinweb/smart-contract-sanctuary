...
interface IMasonry {
    ...
    function getSpecterPrice() external view returns (uint256); //specter price
...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x9265B2dA24488A8260652B9E3B1107D60f454c34), // SpecterGenesisPool
        address(0xA732c95b8f46eDa1b974BaDC400f77E19091f154) // new SpecterFTMRewardPool
    ];
