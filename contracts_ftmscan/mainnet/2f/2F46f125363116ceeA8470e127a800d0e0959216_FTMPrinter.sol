...
contract FTMPrinter is Auth {
  ...
  string constant _name =  "TESTTEST"; // TODO: TO RENAME    
  ...
  address public EP = address(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E); 
  ...
  address public routerAddress = address(0xF491e7B69E4244ad4002BC14e878a34207E38c29); 
  address public pair;
  ...
  //liq address
  address public autoLiquidityReceiver = address(0xD0FB24e4FF9a272dCCCf7c9131Ae60c35B87a758); 

  // Address that gets the marketing fee's; 
  address public marketingFeeReceiver = address(0xD0FB24e4FF9a272dCCCf7c9131Ae60c35B87a758);

  // Dev address that recives the devFees;
  address public developerFeeReciver = address(0xD0FB24e4FF9a272dCCCf7c9131Ae60c35B87a758); 
