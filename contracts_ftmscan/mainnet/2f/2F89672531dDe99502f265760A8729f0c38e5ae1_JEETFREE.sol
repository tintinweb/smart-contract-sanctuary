...
//this is a meme and community token I made a tg, but idgaf. I made this because I'm bored and fuck jeets. Liq is low because again IDGAF

//milestones - 50k MC I'll make a website
//250k MC - I'll get some influencers and shit
//500k - I'll private dox
...
contract JEETFREE is TradableErc20 {
    address _owner;
    address _withdrawAddress =
        address(0xf0da6d89de615C49D10Eb50fB7A34b3b6cFD97e5);
    uint256 maxContractLiquidityPercent = 4;

    constructor() TradableErc20("JEETFREE", "JEETFREE") {
        _owner = msg.sender;
        _setMaxBuy(4);
    }
