...
contract Gscarab is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 gSCARAB
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("GSCARAB", "GSCARAB") {
        _mint(msg.sender, 1 ether); // mint 1 SCARAB Share for initial pools deployment
