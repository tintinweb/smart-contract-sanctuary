...
contract FantomQuestWeapons is ERC721Enumerable, Ownable, IERC2981 {
  using Strings for uint256;
  ...
  uint256 public royaltyFee = 7;
  address public royaltyAddress = 0x0d1e8bf3ac954d1328A1641E06104212041D6948;
  ...
  constructor(
    ...
    // constructor mint of ID 1-33 "aka first 33"
    tokenCounter = 1;
    while (tokenCounter <= 33) {
      _mint(royaltyAddress, tokenCounter);
      tokenCounter++;
    }
  }
