...
contract Chumbawamba is IERC20, Auth {
    ...
    string constant _name = "Chumbawamba";
    string constant _symbol = "Chumbawamba";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x67A937eA41Cd05ec8c832a044afC0100F30Aa4b5); // router
        ...
        devDeployReceiver = 0xAEFA510d30F522115a21c612eB837102c54C0cAD;
        marketingFeeReceiver = 0xAEFA510d30F522115a21c612eB837102c54C0cAD;
    ...
    event AutoLiquify(uint256 amountFTM, uint256 amountTo);
