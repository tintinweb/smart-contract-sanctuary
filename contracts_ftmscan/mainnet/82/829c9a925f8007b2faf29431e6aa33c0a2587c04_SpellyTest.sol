...
contract SpellyTestDistributor {
...
contract SpellyTest is IBEP20, Auth {
    ...
    string constant _name = "SpellyTest";
    string constant _symbol = "spellytest";
    ...
    SpellyTestDistributor distributor;
    ...
    constructor (address distributorAddress) Auth(msg.sender) {
        ...
        distributor = SpellyTestDistributor(distributorAddress);
    ...
    function checkIsFeeExempt(address holder) public view authorized returns(bool){
