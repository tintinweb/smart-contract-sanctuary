...
contract CollateralReserveV2 is Ownable{
    ...
    // benchmark currency. usdc by default. cuz of liqudity 
    ...
    modifier onlyOwnerOrManager() {
        require( gate == msg.sender, "Only owner or manager can trigger this function");
        _;
    }
    ...
    function setBenchmark(address _benchmark) public onlyOwner {
        require(_benchmark != address(0), "Invalid address");
        benchmark = IERC20(_benchmark);
    }
    ...
    // add a collatereal 
    function addCollateralToken(address _token) public onlyOwner{
        require(collateralTokens[_token] == false , "already exist");
    ...
    function removeCollateralToken(address _token) public onlyOwner {
        require(collateralTokens[_token] == true, "there is no");
        // Delete from the mapping
        delete collateralTokens[_token];
