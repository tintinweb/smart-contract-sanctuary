...
contract TwoShareRewardPool {
    ...
    uint256 public tSharePerSecond = 0.00190258 ether; // 65000 bshare / (90 days * 24h * 60min * 60s)
    uint256 public runningTime = 365 days; // 370 days
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 amount, address to) external onlyOperator {
        if (block.timestamp < poolEndTime + 365 days) {
