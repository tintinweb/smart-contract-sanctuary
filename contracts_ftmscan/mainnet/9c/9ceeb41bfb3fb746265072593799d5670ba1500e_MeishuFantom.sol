...
// Stealth Launch
// Reward: $SHOVEL
// Telegram : https://t.me/MeishuFantom
// Twitter : https://twitter.com/MeishuFantom
// Website: https://meishufantom.com/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SHOVEL = IBEP20(0x89d02C43c511727600a62755b3547fB11db7a83e); // SHOVEL
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SHOVEL.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WFTM;
        path[1] = address(SHOVEL);
        ...
        uint256 amount = SHOVEL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SHOVEL.transfer(shareholder, amount);
...
contract MeishuFantom is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address SHOVEL = 0x89d02C43c511727600a62755b3547fB11db7a83e; // SHOVEL
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Meishu Fantom";
