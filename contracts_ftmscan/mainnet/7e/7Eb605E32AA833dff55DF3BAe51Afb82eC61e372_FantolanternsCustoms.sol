...
contract FantolanternsCustoms is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage {
    ...
    modifier onlyAdmin() {
        require(
            ...
            "Fant-O-Lanterns Customs: caller is not admin"
        );
        _;
    }
    ...
    function mint(string memory _tokenURI) public onlyAdmin {
        require(
            ...
            "Fant-O-Lanterns Customs: all tokens have been minted"
        );
