...
//  Stealth Launch
//  x100Token With Rewards - $x100Token
//  Telegram: https://t.me/x100token
//  Initial Liquidity: 400 FTM
//  Reward: $CRV // 0x1E4F97b9f9F913c46F1632781732927B9019C68b
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x1E4F97b9f9F913c46F1632781732927B9019C68b); // CRV
...
contract x100Token is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x1E4F97b9f9F913c46F1632781732927B9019C68b; // CRV
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "x100 Token";
    string constant _symbol = "x100Token";
    ...
    address public autoLiquidityReceiver=0x494601d63e7420e507a65a93D4B9E212d6ff3a3C; //liq address
    address public marketingFeeReceiver=0x494601d63e7420e507a65a93D4B9E212d6ff3a3C; // marketing address
