...
// CHRONUS FINANCE
contract Chronus is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the CHRONUS ERC-20 contract.
     */
    constructor() public ERC20("CHRONUS", "CHRONUS") {
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints CHRONUS to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of CHRONUS to mint to
