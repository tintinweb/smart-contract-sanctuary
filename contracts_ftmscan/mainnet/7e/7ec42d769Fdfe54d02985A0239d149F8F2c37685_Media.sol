...
interface IMarket {
    ...
    event BidCreated(address indexed tokenAddress, uint256 indexed tokenId, Bid bid);
    event BidRemoved(address indexed tokenAddress, uint256 indexed tokenId, Bid bid);
    event BidFinalized(address indexed tokenAddress, uint256 indexed tokenId, Bid bid);
    event AskCreated(
