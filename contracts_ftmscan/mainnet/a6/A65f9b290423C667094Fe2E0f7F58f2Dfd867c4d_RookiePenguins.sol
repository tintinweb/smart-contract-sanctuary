...
// File: contracts/RookiePenguins.sol
...
contract RookiePenguins is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, Pausable {
  using Counters for Counters.Counter;

  Counters.Counter private _tokenIds;

  uint256 public presaleDate = 1637334000;
  uint256 public saleDate = 1637420400;
  ...
  constructor() ERC721 ("RookiePenguins", "PENGUINS") {
    baseURI = "https://dev.rookiepenguins.com/api/penguin/";
    _pause();
  }
  ...
  function penguinsOwned(address _owner) external view returns (uint256[] memory) {
  ...
  function internalMint(address to) internal {
    require(totalSupply() < maxSupply, "All Penguins have been minted!");
