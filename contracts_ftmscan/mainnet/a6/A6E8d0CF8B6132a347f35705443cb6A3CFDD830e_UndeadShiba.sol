...
/*
               ...
               UndeadShiba - The coin that never dies! (for real this time, kek)
               6% liquidity
               5% reflections in USDC
               4% treasury tax (devving and marketing)
              Join our community at: https://t.me/UndeadShiba
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDS = IERC20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
...
contract UndeadShiba is IERC20, Context {
    using SafeMath for uint256;

    address REWARDS = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0x0da580DE2F09776761059b0f05957aC50282779f;

    address routerv2 = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;

    string constant _name = "UndeadShiba";
