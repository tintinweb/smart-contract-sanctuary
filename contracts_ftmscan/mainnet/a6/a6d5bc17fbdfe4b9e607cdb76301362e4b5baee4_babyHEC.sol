...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        ? IRouter(_router)
        : IRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
        _token = msg.sender;
    }
...
contract babyHEC is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABY HEC";
    string constant _symbol = "BHEC";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(200); //0.55%
    uint256 public _maxWallet = _totalSupply.div(200); //0.55%
    ...
    address public autoLiquidityReceiver=0xb2fc73382ff51cff684Cb96D69ecAc3Fa069364c;
    address public marketingFeeReceiver=0xb2fc73382ff51cff684Cb96D69ecAc3Fa069364c;
