...
// File contracts/FantomonTrainerGraphicsV2.sol
...
contract FantomonTrainerGraphicsV2 is Ownable {
    ...
    function overlayURI(uint256 _tokenId) public view returns (string memory) {
    ...
    function iosOverlayURI(uint256 _tokenId) public view returns (string memory) {
        string[33] memory parts;
        uint8 x = 0;
        parts[x]  = '<svg style="width: 50vh; height: 100vh" preserveaspectratio="xMinYMin meet" viewbox="0 0 246 448" xmlns="http://www.w3.org/2000/svg">'
                    '<style>.base { fill: black; font-family: Courier; font-size: small; }'
                    '</style>'
                    '<style>.trailer { fill: white; font-family: Courier; font-size: x-small; }'
                    '</style>'
                    '<style>.trailerGen { fill: gold; font-family: Courier; font-size: x-small; }'
                    '</style>'; x++;
        parts[x]  = '<text x="50%" y="5%" text-anchor="middle" font-weight="bold" class="base">'; x++;
        parts[x]  =     getTrainerName(_tokenId); x++;
        parts[x]  = '</text>'
    ...
    function tokenURI(uint256 _tokenId) external view returns (string memory) {
        ...
        parts[x] = '", "overlay":"'                                  ; x++ ;
        parts[x] = overlayURI(_tokenId)                              ; x++ ;
        parts[x] = '", "iosOverlay":"'                               ; x++ ;
        parts[x] = iosOverlayURI(_tokenId)                           ; x++ ;
