...
contract StrategyCurvecUSD2Pool is StrategyCurveBase {
    ...
    // Curve stuff
    ICurveFi public constant curve = ICurveFi(0x78D51EB71a62c081550EfcC0a9F9Ea94B2Ef081c); // This is our pool specific to this vault.
    ICurveFi public constant curve2Pool = ICurveFi(0x27E611FD27b276ACbd5Ffd632E5eAEBEC9761E40); // Curve 2Pool
    ...
    IERC20 public constant c2pool = IERC20(0x27E611FD27b276ACbd5Ffd632E5eAEBEC9761E40);
        ...
        StrategyCurveBase(_vault)
    {
        ...
        c2pool.approve(address(curve), type(uint256).max);
        usdc.approve(address(curve2Pool), type(uint256).max);
        ...
        )
    {
        ...
        if (cusdBalance > 0) {
            // First mint curve2Pool token
            curve2Pool.add_liquidity([0, usdcBalance], 0);
            uint256 c2poolBalance = c2pool.balanceOf(address(this));

            // Then add liquidity to the cUSD2Pool
            if (c2poolBalance > 0) {
                curve.add_liquidity([0, c2poolBalance], 0);
            }
        }
