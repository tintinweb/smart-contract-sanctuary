...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public jewelSwapLottery;
     ...
     * @param _seed: seed provided by the JewelSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == jewelSwapLottery, "Only JewelSwapLottery");
    ...
    /**
     * @notice Set the address for the JewelSwapLottery
     * @param _jewelSwapLottery: address of the JewelSwap lottery
     */
    function setLotteryAddress(address _jewelSwapLottery) external onlyOwner {
        jewelSwapLottery = _jewelSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IJewelSwapLottery(jewelSwapLottery).viewCurrentLotteryId();
    }
}