...
// WELCOME TO Sushi Inu Print!! Stealth launched on the Fantom Blockchain!

//Earn $Sushiswap Token by simply holding $SIP
//Known as a based dev from AVAX, the community chooses the marketing path we go down!
//Liquidity will be locked as soon as we know everything is working okay!
//Enjoy hodling and earning some sweet Sushiswap :)
//16% Slippage should work, this is for the rewards to holders, marketing and a healthy LP :)

//**BEFORE YOU INVEST**
//Last words, that should always be in a contract. Do your own research, dont spend what you can't afford to lose!!
//This is a safe, non rug token, but there is always risks investing. Invest at your own risk, dev's won't take responsibility for your actions!

//Telegram - https://t.me/sushiinuprint 
//Twitter -  @sushiinuprint
...
contract SushiINUPrint is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Sushi Inu Print";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x6C92d8d29027aC3B19C125Ea2a49B92598791779;
