...
contract Market is IMarket, Ownable, ReentrancyGuard {
    ...
    function transfer(
        ...
        override
        nonReentrant
        onlyApprovedOrOwner(from, tokenAddress, tokenId)
    {
        require(from != address(0), "Market: from address cannot be 0");
        require(to != address(0), "Market: from address cannot be 0");
