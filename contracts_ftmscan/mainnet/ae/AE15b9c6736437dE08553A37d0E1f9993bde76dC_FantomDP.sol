...
//  ░█─── ▀──▀ ▀──▀ ──▀── ▀▀▀▀ ▀───▀ ░█▄▄▀ ▀▀▀▀ ─▀▀▀ ▀▀▀─ ▀▀▀ ▀▀▀ ░█─── ▀──▀ ▄▄▄█
//  Stealth Launch
//  Telegram: https://t.me/fantomdoublepay
//  Initial Liquidity: 300 FTM
//  Double rewards of $FTMP and $USDC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xAfF15DAe5C956f9D7d5B98F304863201EA47c656); // FTMP
...
contract FantomDP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xAfF15DAe5C956f9D7d5B98F304863201EA47c656; // FTMP
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FantomDoublePay";
    string constant _symbol = "FantomDP";
