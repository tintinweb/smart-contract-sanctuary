...
// Dependency file: contracts/baby/MIMPRINTERDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeMIMDividends(uint256 amount) public onlyOwner {
...
contract MIMPRINTERDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MIMPRINTER contract."
        );
    }
...
// Root file: contracts/baby/MIMPRINTER.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/MIMPRINTERDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract MIMPRINTER is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    MIMPRINTERDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = MIMPRINTERDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "MIMPRINTER: The dividend tracker already has that address"
        );

        MIMPRINTERDividendTracker newDividendTracker = MIMPRINTERDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "MIMPRINTER: The new dividend tracker must be owned by the MIMPRINTER token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "MIMPRINTER: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "MIMPRINTER: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != UniswapV2Pair,
            "MIMPRINTER: The PanMIMSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "MIMPRINTER: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "MIMPRINTER: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "MIMPRINTER: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialMIMBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeMIMDividends(dividends);
