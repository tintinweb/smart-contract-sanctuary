...
contract RebateTreasury is Ownable {
    ...
    constructor() {
        Tomb = IERC20(0x7a6e4E3CC2ac9924605DCa4bA31d1831c84b44aE);
        TombOracle = IOracle(0xcf80d06D38d63d4B4D0fc52D2F0CDe7EfA0fBf87);
    ...
    // Execute arbitrary call to external address with data and value
