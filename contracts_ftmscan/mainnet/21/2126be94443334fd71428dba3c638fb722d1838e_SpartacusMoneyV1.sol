...
// File @boringcrypto/boring-solidity/contracts/[email protected]2.2
// License-Identifier: MIT
...
contract SpartacusMoneyV1 is ERC20, BoringOwnable {
    using BoringMath for uint256;
    // ERC20 'variables'
    string public constant symbol = "LAMBDA";
    string public constant name = "Spartacus Money";
    ...
    function mint(address to, uint256 amount) public onlyOwner {
        require(to != address(0), "LAMBDA: no mint to zero address");
    ...
    function burn(uint256 amount) public {
        require(amount <= balanceOf[msg.sender], "LAMBDA: not enough");
