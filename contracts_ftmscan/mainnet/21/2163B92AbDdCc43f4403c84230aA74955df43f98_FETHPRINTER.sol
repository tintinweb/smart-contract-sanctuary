...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x658b0c7613e890EE50B8C4BC6A3f41ef411208aD); // FETH
...
contract FETHPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x658b0c7613e890EE50B8C4BC6A3f41ef411208aD; // FETH
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FETHPRINTER";
    string constant _symbol = "FETHPRINTER";
    ...
    address public autoLiquidityReceiver=0xB50EaF88B333988482dbD27ddAa3f6d28A7548b3; //liq address
