...
contract LuckyStakes is Ownable {

	IERC20 public erctoken;
	address public fractalWallet = 0x564e9155Ff9268B4B7dA4F7b5fCa000Ea0f46Ebb;
	address public burnWallet = 0x1fED77B0F7EF2addB8900DBe284B8ebA0cD5a1d9;
	address public communityWallet = 0x9A00aaC1409535CF598E7a0a3A9B4bFaFfeccD4D;
	address private token = 0x87d57F92852D7357Cf32Ac4F6952204f2B0c1A27; /** token **/
	/** default percentages **/
	uint256 public PROJECT_FEE = 10;
	uint256 public BURN_FEE = 10;
	...
	uint256 public MAX_WITHDRAW = 12000000;
	...
	function payFees(uint256 amounterc) internal returns(uint256) {
		...
		uint256 marketing = amounterc*(BURN_FEE)/(PERCENTS_DIVIDER);
		erctoken.transfer(fractalWallet, fee);
		erctoken.transfer(burnWallet, marketing);
    ...
    function CHANGE_BURN_FEE(uint256 value) external onlyOwner{
        require(value < 50);
        BURN_FEE = value;
    }
