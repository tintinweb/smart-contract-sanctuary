...
/*
    ...
    RaidsFinance
    $RAID
    t.me/RaidsFinance | Welcome to the most influential crypto community!
...
contract RaidsFinance is Context, IERC20, Ownable {
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xF8F0481625C8D4516A4aE4A54B9aFe2e854DEb7D, 'We can not exclude router.');
