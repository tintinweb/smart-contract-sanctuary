...
contract tevt is IBEP20, Auth {
    ...
    string constant _name = "tevt";
    string constant _symbol = "tevt";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 50 / 100; // 50%

    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 100; //104%
    ...
    uint256 public swapThreshold = _totalSupply * 10000 / 10000; // 100% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xbbd609c9d379d3aedCE16DA46Bd93F5206F6b2D2;
