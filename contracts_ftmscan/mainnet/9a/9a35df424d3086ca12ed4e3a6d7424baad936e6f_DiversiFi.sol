...
contract DiversiFi is ERC20, Ownable {
    ...
    // Friday, December 31, 2021 00:00:00 GMT
    uint public immutable forceStartTradingAt = 1640908800;
    ...
    function updateFees(
        ...
        require(
            FTMRewardsBuy >= 1 && FTMRewardsBuy <= 20,
            "FTM reward fees must be between 1 and 20"
        );
        require(
            FTMRewardsSell >= 1 && FTMRewardsSell <= 20,
            "FTM reward fees must be between 1 and 20"
        );
