...
╚██████╔╝███████╗██║ ╚████║╚██████╔╝██║  ██║██║  ██║    ╚██████╗╚██████╔╝██║██║ ╚████║
 ╚═════╝ ╚══════╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝     ╚═════╝ ╚═════╝ ╚═╝╚═╝  ╚═══╝
  ...
  The Official Contract For GengarCoin On Fantom.
  
  Join Our Telegram!: https://t.me/GengarHQ
  
  Visit The Website:  https://www.gengarcoin.com/

  0% Sell/Buy Tax. No Loss of Gains!                                              
*/
...
contract GengarCoin is Context, IERC20, Ownable {
    string public constant name = "GengarCoin";
    string public constant symbol = "GNGR";
