 ...
 * Website : https://snowbluefloki.quest
 *Telegram : t.me/snowbluefloki
 * No dev/team wallet
 * 15% buy tax
 * fBTC reward adress : 0xe1146b9AC456fCbB60644c36Fd3F868A9072fc6E
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xe1146b9AC456fCbB60644c36Fd3F868A9072fc6E); // fBTC
...
contract Snowbluefloki is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xe1146b9AC456fCbB60644c36Fd3F868A9072fc6E; // fBTC
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Snowbluefloki.quest";
    string constant _symbol = "SBF";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(2); // 1%
    ...
    address public autoLiquidityReceiver=0x22375923F7D0774A4B788370a20b7c154Dbb13D2; //liq address
    address public marketingFeeReceiver=0x22375923F7D0774A4B788370a20b7c154Dbb13D2; // marketing address
