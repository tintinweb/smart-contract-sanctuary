...
// File: contracts/MythicalBeingsContract.sol
...
contract MythicalBeingsContract is ERC721Tradable {
	using SafeMath for uint256;
	address constant WALLET1 = 0xffe5CBCDdF2bd1b4Dc3c00455d4cdCcf20F77587; // WenMInt
	address constant WALLET2 = 0xE3c2712Ac76A1C8a57b9628C07BE41304E214A3B; // Mythical Beings Team
	...
	uint256 public preSalePrice = 50000000000000000000; // e.g. 80000000000000000 for .08 FTM
	uint256 public pubSalePrice = 55000000000000000000; // e.g. 80000000000000000 for .08 FTM
	uint256 public maxSupply = 2222; // e.g. 10000
	bool public preSaleIsActive = true;
	bool public saleIsActive = false;
	string _baseTokenURI;

	constructor() ERC721Tradable("Mythical Beings", "BEINGS") {}
	...
	function mint(uint256 _quantity) public payable {
		...
		if (preSaleIsActive) {
			require(preSalePrice.mul(_quantity) <= msg.value, "FTM sent is incorrect.");
			...
			require(pubSalePrice.mul(_quantity) <= msg.value, "FTM sent is incorrect.");
	...
	function withdraw() external onlyOwner {
		...
		payable(msg.sender).transfer(balance.sub(wallet1Balance.add(wallet2Balance).add(wallet3Balance)));
	}
}