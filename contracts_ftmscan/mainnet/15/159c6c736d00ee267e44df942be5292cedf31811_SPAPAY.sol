...
// Earn passive income in $SPA with $SPAPAY
// Twitter: https://twitter.com/SPAPAYOFFICIAL
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SPA = IERC20(0x5602df4A94eB6C680190ACCFA2A475621E0ddBdc);
...
contract SPAPAY is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address SPA = 0x5602df4A94eB6C680190ACCFA2A475621E0ddBdc; // USDC
    address public WETH = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SPAPAY";
    string constant _symbol = "SPAPAY";
    ...
    address public autoLiquidityReceiver=0x3F8a35d2fa454612356C772BB72f5fcACc199AD3;
    address public marketingFeeReceiver=0x3F8a35d2fa454612356C772BB72f5fcACc199AD3;
