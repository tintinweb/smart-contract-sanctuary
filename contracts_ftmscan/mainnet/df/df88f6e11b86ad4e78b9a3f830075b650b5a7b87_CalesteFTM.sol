...
/**
 ...
 https://t.me/CalesteFTM
 
 Tokenomics
 Max buys 50,000,000,000
 Max sells 20,000,000,000
 3% Gone
 4% Community funds
 SLIPPAGE > 7
...
contract CalesteFTM is ERC20, Ownable, SafeToken {
    ...
    uint256 public maxBuyTransactionAmount = 50000000000 * (10**18);
    ...
    constructor() ERC20("CalesteFTM", "Caleste") {
        liquidityFee = 3;
        charityFee = 4;
        charityWallet = payable(0xa9aD02d85126238785a4A2A7bCb2eD02Fd6051BE);
