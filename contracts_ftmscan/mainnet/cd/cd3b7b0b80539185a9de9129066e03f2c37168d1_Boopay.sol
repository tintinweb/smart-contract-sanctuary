...
Tokenomics:
- Buy Tax / Sell Tax: 15%
    - 8% of each buy goes to Boo reflections
    - 5% of each sell to treasury wallet
    - 2% to the liquidity pool.

Website:
https://boopay.finance/

Telegram:
https://t.me/Boopaycommunity

Twitter:
https://twitter.com/BooPayCommunity

Medium:
https://medium.com/@BooPay
*/
...
contract BoopayDividendTracker is IDividendDistributor {
...
contract Boopay is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    address treasuryWallet = address(0xa2e7b9BaCeb64F3355E4CF87e5cc9761EC7F87F1); //change this
    ...
    BoopayDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new BoopayDividendTracker();
