...
interface IMasterChef {
    function deposit(uint256 poolId, uint256 _amount, address user) external;
    function withdraw(uint256 poolId, uint256 _amount, address user) external;
...
contract liquidStrategyLP is Ownable, Pausable {
