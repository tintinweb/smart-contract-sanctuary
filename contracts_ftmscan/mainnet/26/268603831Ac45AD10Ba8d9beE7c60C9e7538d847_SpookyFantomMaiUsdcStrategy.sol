...
contract SpookyFantomMaiUsdcStrategy is MasterChefBaseStrategy {
    constructor() public {}
        ...
        initializer
    {
        ...
        uint256 poolId = 42; // MaiUsdc Pool id
        ...
        address mai = address(0xfB98B335551a418cD0737375a2ea0ded62Ea213b);

        rewardRoutes[mai] = [boo, wftm, usdc, mai];
        rewardRoutes[usdc] = [boo, wftm, usdc];

        fromVaultAssetRoutes[dai][mai] = [dai, wftm, usdc, mai];
        fromVaultAssetRoutes[dai][usdc] = [dai, wftm, usdc];
        fromVaultAssetRoutes[usdt][mai] = [usdt, wftm, usdc, mai];
        fromVaultAssetRoutes[usdt][usdc] = [usdt, wftm, usdc];
        fromVaultAssetRoutes[usdc][mai] = [usdc, mai];

        toVaultAssetRoutes[dai][mai] = [mai, usdc, wftm, dai];
        toVaultAssetRoutes[dai][usdc] = [usdc, wftm, dai];
        toVaultAssetRoutes[usdt][mai] = [mai, usdc, wftm, usdt];
        toVaultAssetRoutes[usdt][usdc] = [usdc, wftm, usdt];
        toVaultAssetRoutes[usdc][mai] = [mai, usdc];
    }
}
