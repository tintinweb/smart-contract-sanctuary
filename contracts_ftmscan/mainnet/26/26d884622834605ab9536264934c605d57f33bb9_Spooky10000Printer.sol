...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x9E5A03a9A60ef33cc11A7E1d7D7abf8D575eFF6e); // ur mom reward 
...
contract Spooky10000Printer is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x9E5A03a9A60ef33cc11A7E1d7D7abf8D575eFF6e; // Spook10k
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Spooky10000Printer";
    ...
    address public autoLiquidityReceiver=0x47dc9c1DCEdD864ffd548838D778DcE6A6207f15; //liq address
    address public marketingFeeReceiver=0x47dc9c1DCEdD864ffd548838D778DcE6A6207f15; // marketing address
