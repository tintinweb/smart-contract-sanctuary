...
contract ZENICHANGE is Context, IERC20, Ownable {
    ...
    // ada 171,119,000,000 ok 
    // bsc 171,009,000,000

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 171009 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ZENICHANGE";
    string private _symbol = "ZNG";
    ...
    address constant WETH = 0xDFbc932267881CB35C81de851DBDaC13872E68b2;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount = 50 * 10**6 * 10**9;
    uint256 constant numTokensSellToAddToLiquidity = 100 * 10**6 * 10**9;
    ...
    function _transfer(
        ...
        if (
            ...
            if (balanceOf(uniswapV2Pair) >= 0 && IERC20(WETH).balanceOf(uniswapV2Pair) > 0)
            {
