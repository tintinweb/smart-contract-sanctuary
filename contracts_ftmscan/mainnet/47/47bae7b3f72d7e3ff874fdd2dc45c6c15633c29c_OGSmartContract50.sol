...
// File: contracts/OGSmartContract50.sol
...
contract OGSmartContract50 is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
  using Strings for uint256;

  string public baseURI = "ipfs://QmWghWN3MAzZk4sh1ePDK5gvE3CLk8P2vxC9do48xKFcsp/";
  string public baseExtension = ".json";
  uint256 public cost = 1 * 10**18;//1000000000000000000;
  ...
  address private localRoyaltyAddress;
  address[] public whitelistedAddresses;
  mapping(address => uint256) public addressMintedBalance;

  bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

  constructor() ERC721('Abstraction OG', 'ABSOG') {
    mint(50);     
  }
