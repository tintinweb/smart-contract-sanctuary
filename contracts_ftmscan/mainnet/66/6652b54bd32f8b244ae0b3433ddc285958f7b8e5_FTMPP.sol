...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xAfF15DAe5C956f9D7d5B98F304863201EA47c656); // FTMPay
...
contract FTMPP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xAfF15DAe5C956f9D7d5B98F304863201EA47c656; // FTMPay
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FantomPay Printer";
    string constant _symbol = "FTMPP";
    ...
    address public autoLiquidityReceiver=0x993BF63bceC05813378873a4abDce0c3df4A7e6c; //liq address
    address public marketingFeeReceiver=0x4dbFD7AEe8d308eC1d08E3CcDB38B05CD450196A; // marketing address
