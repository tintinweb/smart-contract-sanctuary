...
//STEALTH LAUNCH 
//Discord https://discord.gg/egCgHrtMJQ
//May have presale
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x01f793Ec4dB0ffAf350526ba7828D93C180dd97E); // JONES
...
contract JonesPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x01f793Ec4dB0ffAf350526ba7828D93C180dd97E; // JONES
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "JONESPRINTER";
    string constant _symbol = "JONESP";
