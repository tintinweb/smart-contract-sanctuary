...
/**
STEALTH Launched - Dividend Token 
Hold $EARNT and receive $TSHARE 

https://t.me/EARNTSHARE
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x4cdF39285D7Ca8eB3f090fDA0C069ba5F4145B37); // TSHARE
    ...
    function transferBEP20(address tokenAddress) external onlyToken {
...
contract EARNTSHARE is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x4cdF39285D7Ca8eB3f090fDA0C069ba5F4145B37; // TSHARE
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "EARN TSHARE";
    string constant _symbol = "EARNT";
    ...
    address public autoLiquidityReceiver=0xAB5242Ceb7ea102F1960B3dd8f41871D66cA37eA; //liq address
    address public marketingFeeReceiver=0xAB5242Ceb7ea102F1960B3dd8f41871D66cA37eA; // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    function manualBuyback(uint256 weiAmount) public onlyOwner {
