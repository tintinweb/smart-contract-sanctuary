...
/**
Multi-Ape Capital: $MAC
-You buy on Fantom, we farm on multiple chains and return the profits to $MAC holders.

Tokenomics:
10% of each buy goes to existing holders.
10% of each sell goes into multiple chains farming to add to the treasury and buy back MAC tokens.
*/
...
pragma solidity ^0.6.12;
    ...
    contract MultiApeCapital is Context, IERC20, Ownable {
        ...
        string private _name = 'MultiApeCapital';
        ...
        constructor (address payable MACWalletAddress, address payable marketingWalletAddress) public {
            _MACWalletAddress = MACWalletAddress;
            _marketingWalletAddress = marketingWalletAddress;
            _rOwned[_msgSender()] = _rTotal;

            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52); // Spirit router
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52, 'We can not exclude Uniswap router.');
        ...
        function _reflectFee(uint256 rFee, uint256 tFee) private {
         ...
         //to recieve FTM from uniswapV2Router when swaping
