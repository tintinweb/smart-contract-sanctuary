...
contract FANTOMreBOOt is IERC20, Auth {

    using SafeMath for uint256;



     address RWRD = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE;  
    ...
    string constant _name = "FANTOMreBOOt";

    string constant _symbol = "RBT";
    ...
    uint256 public _maxTxAmount = _totalSupply / 25;         

    uint256 public _maxWallet = _totalSupply / 25;  
