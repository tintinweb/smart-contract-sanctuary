...
// File @openzeppelin/contracts/token/ERC20/[email protected].4.2
...
contract CShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 cSHARE
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 85001 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("CSHARE", "CSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 CLOUD Share for initial pools deployment
