...
contract sinSpiritStrategy is OwnableUpgradeable {
    ...
    address public sinSpiritManager;
    ...
    modifier restricted {
        require(msg.sender == owner() || msg.sender == sinSpiritManager, "Auth failed");
        _;
    }
