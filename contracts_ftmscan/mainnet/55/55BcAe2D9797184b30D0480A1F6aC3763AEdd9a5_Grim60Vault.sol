 ...
 */
contract Grim60Vault is ERC20, Ownable, ReentrancyGuard {
    ...
    address public tombFtm = address(0x2A651563C9d3Af67aE0388a5c8F89b867038089e);
    ...
    function deposit(uint _amount) public nonReentrant {
        ...
        uint256 tshareAmount = _amount.mul(40).div(100);
        
        _amount = depositAmount.sub(tshareAmount);
