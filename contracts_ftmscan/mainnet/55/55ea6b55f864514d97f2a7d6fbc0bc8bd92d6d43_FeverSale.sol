...
//Change values
    ...
    uint constant Tempodecimals = 10 ** 18;
    uint public constant MAX_SOLD = 300000 * Tempodecimals;
    uint public constant PRICE = 442477876106194700; //* FTMdecimals / Tempodecimals
    uint public constant MIN_PRESALE_PER_ACCOUNT = 25 * Tempodecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 450 * Tempodecimals;
    ...
    constructor() {
        ...
        for( uint256 iteration_ = 0; devAddr.length > iteration_; iteration_++ ) {
            invested[ devAddr[ iteration_ ] ] = 100 * Tempodecimals;
        } 
    }
