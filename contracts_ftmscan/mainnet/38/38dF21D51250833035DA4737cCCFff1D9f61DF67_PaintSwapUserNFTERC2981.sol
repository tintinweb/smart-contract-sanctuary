...
contract PaintSwapUserNFTERC2981 is PaintSwapUserNFTBase, IERC2981 {
  uint public royalty; // base 10000
  ...
  function initialize(
    ...
    super.initialize(_marketplace, _royaltyRecipient, _royalty, _devAddr, _mintFee, _maxMints, _name, _owner);
    require(royalty <= 2000); // 20%
