...
contract BakerToken is BEP20('RECEIPT Token', 'RECEIPT TOKEN FOR BAKER') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BAKERs (not scaled);
