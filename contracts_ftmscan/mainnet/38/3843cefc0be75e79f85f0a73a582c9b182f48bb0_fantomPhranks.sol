...
contract fantomPhranks is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private _price = 66 ether;
    uint256 private _reserved = 20;

    string public PHRANK_PROVENANCE = "";
...
//address of wallets
    ...
    address t2 = 0x1e10b00026343E388b40f8500D77B5B7a6DA0A67;

    constructor() ERC721("PhantomFranks", "PHRANK") {
        _saleStarted = false;
    }
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        PHRANK_PROVENANCE = provenanceHash;
    }

    // Helper to list all the Phranks of a wallet
