...
//  Stealth Launch
//  Telegram: https://t.me/PrinterFTM
//  Buy $FTMPR, earn passive $FTM just by holding. 8% of all transactions go back to holders as $FTM tokens.
//  https://ftmprinter.xyz/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83); // WFTM
...
contract FTMPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83; // WTFM
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FTMPrinter";
    string constant _symbol = "FTMPR";
    ...
    address public autoLiquidityReceiver=0xC7DbD6F8E6e255cae73fcB264d312fB0dfDc4DDB; //liq address
    address public marketingFeeReceiver=0xC7DbD6F8E6e255cae73fcB264d312fB0dfDc4DDB; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 800; //
    bool inSwap;
