...
contract FantomonTrainerGraphicsV1 is Ownable {
    ...
    function tokenURI(uint256 _tokenId) external view returns (string memory) {
        ...
        parts[x]  = '<text x="27vh" y="5.58vh" text-anchor="middle" font-weight="bold" class="base">'; x++;
        parts[x]  =     getTrainerName(_tokenId); x++;
        parts[x]  = '</text>'
                    '<text x="3vh" y="54.24vh" font-weight="bold" class="base">'
                        'Kinship: '; x++;
        parts[x]  =     getKinship(_tokenId); x++;
        parts[x]  = '</text>'
                    '<text x="3vh" y="58.48vh" font-weight="bold" class="base">'
                        'Flare: '; x++;
        parts[x]  =    getFlare(_tokenId); x++;
        parts[x]  = '</text>'
                    '<text x="3vh" y="62.72vh" font-weight="bold" class="base">'
                        'Healing: '; x++;
        parts[x] =     getHealing(_tokenId); x++;
        parts[x] = '</text>'
                    '<text x="3vh" y="66.96vh" font-weight="bold" class="base">'
                        'Courage: '; x++;
        parts[x]  =    getCourage(_tokenId); x++;
        parts[x] = '</text>'
                    '<text x="3vh" y="71.20vh" class="base">'
                        'Wins: '; x++;
        parts[x] =     getWins(_tokenId); x++;
        parts[x] = '</text>'
                    '<text x="3vh" y="75.44vh" class="base">'
                        'Losses: '; x++;
        parts[x] =     getLosses(_tokenId); x++;
        parts[x] = '</text>'
                    '<text x="3vh" y="81.47vh" class="trailer">'
                        'Class: '; x++;
        parts[x] =     getClass(_tokenId); x++;
        parts[x] = '</text>'
                    '<text x="3vh" y="84.82vh" class="trailer">'
                        'Homeworld: '; x++;
        parts[x] =     getHomeworld(_tokenId); x++;
        parts[x] = '</text>'
                    '<text x="3vh" y="88.16vh" class="trailer">'
                        'Rarity: '; x++;
        parts[x] =     getRarity(_tokenId); x++;
        parts[x] = '</text>'
                    '<text x="3vh" y="92.85vh" class="trailer">'
                        'Status: '; x++;
        ...
        x++;
        parts[x] = '<text x="3vh" y="97vh" font-weight="bold" class="trailerGen">'
                        'Generation 1'
                    '</text>'
                    '<text x="52vh" y="97vh" text-anchor="end" class="trailer">#'; x++;
