...
contract NativeFarm is Ownable, ReentrancyGuard {
    ...
    // Token address
    address public constant NATIVE = 0x174c7106AEeCdC11389f7dD21342F05f46CCB40F; //DEVIL address
    // Owner reward per block: 10% ==> 11.11%
    uint256 public constant ownerNATIVEReward = 3229;
    // Native total supply: 66.666666 mil = 66666666e18
    uint256 public constant NATIVEMaxSupply = 66666666e18;
    // Natives per block: (0.09648515981 - owner 10%) 96485159810000000
    uint256 public constant NATIVEPerBlock = 1083156250000000000; // NATIVE tokens created per block
    // Approx 15/7/2021
    uint256 public constant startBlock = 27488534; // https://ftmscan.com/block/27488534    
