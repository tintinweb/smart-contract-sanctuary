...
interface IBandReference {
    ...
    function refs(string memory input) external view returns (Response memory);
}
...
contract CalculationsCurve is Ownable {
    ...
    IBandReference internal bandReference;
    ...
    constructor(
        ...
        bandReference = IBandReference(_bandReference);
    ...
    function isBasicToken(address tokenAddress) public view returns (bool) {
        ...
        return bandReference.refs(symbol).rate != 0;
    }
