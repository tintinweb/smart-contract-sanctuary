...
// File contracts/LIGHT/interfaces/common/IWrappedNative.sol
 ...
 */
contract LightVault is ERC20, Ownable, ReentrancyGuard {
    ...
    /**
     * @dev It initializes the vault's own 'light' token.
     ...
     */
    function withdrawAllFTM() external {
        withdrawFTM(balanceOf(msg.sender));
    }
     ...
     */
    function withdrawFTM(uint256 _shares) public {
        uint256 r = (balance().mul(_shares)).div(totalSupply());
        _burn(msg.sender, _shares);
