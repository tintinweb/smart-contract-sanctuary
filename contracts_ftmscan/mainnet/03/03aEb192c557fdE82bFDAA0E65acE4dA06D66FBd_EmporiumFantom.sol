...
contract EmporiumFantom is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Emporium';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x3A93dcFbFdd10D1725216B45d90A4cA573f882A3, 'We can not exclude router.');
