...
/*
Fantom based token, Safemoon tokenomics with USDT rewards instead of token redistribution..
5% usdt rewards 5% locked up in liquidity pool
...
contract FantomSafemooney is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Safemooney';
    string private constant _symbol = 'smooney';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x2f45A3a95d55B31e6AC826595aC69f47D1231339, 'We can not exclude router.');
