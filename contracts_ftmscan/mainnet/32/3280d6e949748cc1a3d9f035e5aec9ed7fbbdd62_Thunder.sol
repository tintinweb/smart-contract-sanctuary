...
contract Thunder is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 24h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 700 ether;
    // Initial distribution for the day 2-5 2OMB-WETH LP -> 2OMB pool
    uint256 public constant INITIAL_2OMB_POOL_DISTRIBUTION = 0 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("THUNDER", "THUNDER") {
