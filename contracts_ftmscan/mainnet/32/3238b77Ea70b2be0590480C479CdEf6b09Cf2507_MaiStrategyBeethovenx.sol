...
contract MaiStrategyBeethovenx is FeeManager {
    ...
    // Tokens used
    address public want;
    address public output = address(0x68Aa691a8819B07988B18923F712F3f4C8d36346);
    ...
    function deposit() public whenNotPaused {
        ...
        if (wantBal > 0) {
            IFarm(chef).deposit(chefPoolId, wantBal);
    ...
    function rewardsAvailable() public view returns (uint256) {
        return IFarm(chef).pending(chefPoolId, address(this));
    }
    ...
    function retireStrat() external {
        ...
        IFarm(chef).emergencyWithdraw(chefPoolId);
