...
//  Stealth Launch
//  Snoopy Inu - $SNOOPY $FTM 
//  Telegram: https://t.me/snoopyinuftm
//  Initial Liquidity: 150 FTM
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x0000000000000000000000000000000000000000);
...
contract SnoopyInu is IBEP20, Auth {
    ...
    address EP = 0x0000000000000000000000000000000000000000;
    ...
    string constant _symbol = "SNOOPY";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // 1.5%
    uint256 public _maxWallet = _totalSupply.div(40); // 3%
    ...
    address public autoLiquidityReceiver=0x4f456a3024beC98d35B6e34740946a323f294731; //liq address
    address public marketingFeeReceiver=0x4f456a3024beC98d35B6e34740946a323f294731; // marketing address
