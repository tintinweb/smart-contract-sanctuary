...
def deposit(_amount: uint256 = MAX_UINT256, recipient: address = msg.sender, referralCode: uint256 = 0) -> uint256:
    """
    @notice
    ...
    log Deposit(referralCode, recipient, amount, shares)
