...
contract Samuraikittens is ERC721Enumerable, Ownable{
    ...
    uint private reservePrice = 300 ether;
    ...
    uint256 private reservedPeriod = 33 * 3600;        // 24 hours
    uint256 private mintReservedTokenPeriod = 33 * 3600;        // 24 hours
    uint256 private initialTime;
    uint256 private initialReservePrice = 449 ether;
...
//        addressOfPumpkitten = 0x31EC182dfBc6B6B19D68419C0500067Ce000318d;
       ...
       _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmYsWPzR6uxJkfzeqAdwAr5EASacJCXaUviZcAFdnbAWWm/";
        addressOfPumpkitten = 0xF185cf59c710a0E83362fb7B8813b633Ba073600;
