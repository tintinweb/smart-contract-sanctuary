...
/*
The Contract is Owned By: vampires
*/
...
contract VampireGame is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "VampireGame";
    string public constant symbol   = "Vampire";
