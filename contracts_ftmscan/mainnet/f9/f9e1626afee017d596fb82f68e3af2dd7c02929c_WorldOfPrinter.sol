...
// Stealth Launched
// Initial Liquidity [700FTM]
// https://t.me/WorldOfPrinters_FTM

// ENJOY THE UNENDING REWARDS: $ETH, $BOO, $TOMB, $FUSDT
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x74b23882a30290451A17c44f4F05243b6b58C76d); // ETH
    IBEP20 BP = IBEP20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); // BOO
    IBEP20 TP = IBEP20(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7); // TOMB
    IBEP20 UP = IBEP20(0x049d68029688eAbF473097a2fC38ef61633A3C7A); // FUSDT
    ...
    function deposit4() external payable {
        uint256 balanceBefore = UP.balanceOf(address(this));
        ...
        uint256 amount =UP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            UP.transfer(shareholder, amount);
...
contract WorldOfPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xDa25293B6186d597ddf4986c82245f2A48cD6B4D; // ETH
    address BP = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE; // BOO
    address TP = 0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7; // TOMB
    address UP = 0x049d68029688eAbF473097a2fC38ef61633A3C7A; // FUSDT
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "World Of Printers";
    ...
    address public autoLiquidityReceiver=0x88060912C88E2C69e604301841b40597727585DA; //liq address
    address public marketingFeeReceiver=0x88060912C88E2C69e604301841b40597727585DA; // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountFTMReflection = amountFTM.mul(reflectionFee).div(totalFTMFee).div(4);
        uint256 amountFTMMarketing = amountFTM.mul(marketingFee).div(totalFTMFee).div(4);

        try distributor.deposit{value: amountFTMReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountFTMMarketing);

        try distributor.deposit2{value: amountFTMReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountFTMMarketing);

        try distributor.deposit3{value: amountFTMReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountFTMMarketing);

        try distributor.deposit4{value: amountFTMReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountFTMMarketing);
