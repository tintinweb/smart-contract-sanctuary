...
contract UltiBetsAstonVillaVSManchesterUnited {
  enum Side { AstonVilla, ManchesterUnited }
  ...
  function claimBetCancelledEvent(Side _side) external {
    ...
    betsAmountPerBettor[msg.sender][Side.AstonVilla] = 0;
    betsAmountPerBettor[msg.sender][Side.ManchesterUnited] = 0;
