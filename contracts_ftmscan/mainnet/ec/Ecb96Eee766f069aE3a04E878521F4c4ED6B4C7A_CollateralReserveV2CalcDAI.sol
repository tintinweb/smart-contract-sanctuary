...
contract CollateralReserveV2CalcDAI is CoffinBandOracle, ICollateralReserveV2Calc {
    using SafeMath for uint256;
    string public name = "CollateralReserveV2CalcDAI";
...
contract CoffinBandOracle is Ownable {
    uint256 internal constant PRICE_PRECISION6 = 1e6;
    uint256 internal constant PRICE_PRECISION18 = 1e6;
