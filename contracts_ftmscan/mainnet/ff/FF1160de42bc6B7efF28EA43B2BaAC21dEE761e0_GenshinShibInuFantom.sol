...
/*
    ...
    GenshinShibInu is Token with Confidence Audited, Decentralized, Fair and Support sustainable communities. GenshinShibInu is a community driven token.
    t.me/GenshinShibaOfficial
...
contract GenshinShibInuFantom is Context, IERC20, Ownable {
    ...
    string private constant _name = 'GenshinShibInu';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xe7a3baaA989B943DE47c7C447e62D38623114B6A, 'We can not exclude router.');
