...
contract SpookyLittleCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name     = "Spooky Little Cat";
    string private _symbol   = "SPOOKY CAT";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _spookyswapV2Router; // Spookyswap V2 Router
    address public _spookyswapV2LiquidityPair;     // Spookyswap V2 liquidity pairing for SPOOKYCASH/WFTM
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x6dFF657819152f66B1aAE8f2E158917d426b2D32); // Marketing address used to pay for marketing
