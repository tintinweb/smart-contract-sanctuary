...
contract Srocket is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 sROCKET
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SROCKET", "SROCKET") {
        _mint(msg.sender, 1 ether); // mint 1 ROCKET Share for initial pools deployment
