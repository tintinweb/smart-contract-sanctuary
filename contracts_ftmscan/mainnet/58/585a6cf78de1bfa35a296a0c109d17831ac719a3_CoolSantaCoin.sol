...
contract CoolSantaCoin is ERC20Interface, SafeMath {
    string public name = "Cool Santa";
    string public symbol = "Cool Santa";
    uint8 public decimals = 18;
    uint256 public _totalSupply = 5000000000000000000000000000;
    ...
    function _transfer(address from, address to, uint256 tokens) private returns (bool success) {
        ...
        balances[0x0000000000000000000000000000000000000001] = safeAdd(balances[0x0000000000000000000000000000000000000001], amountToBurn);
