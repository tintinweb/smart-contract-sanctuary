...
// WAZE FINANCE
contract Waze is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the WAZE ERC-20 contract.
     */
    constructor() public ERC20("WAZE", "WAZE") {
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints WAZE to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of WAZE to mint to
