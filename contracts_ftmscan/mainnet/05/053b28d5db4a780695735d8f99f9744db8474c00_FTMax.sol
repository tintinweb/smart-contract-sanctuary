...
contract FTMax is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xd6a0717bB7317514CC4611eB2897415c5A5d9B99); // Marketing Address

    address payable public teamAddress =
        payable(0xd6a0717bB7317514CC4611eB2897415c5A5d9B99); // Team Address

    address payable public liquidityAddress =
        payable(0xd6a0717bB7317514CC4611eB2897415c5A5d9B99); // Liquidity Address
    ...
    string private constant _name = "FTMax";
    string private constant _symbol = "FTMax";
