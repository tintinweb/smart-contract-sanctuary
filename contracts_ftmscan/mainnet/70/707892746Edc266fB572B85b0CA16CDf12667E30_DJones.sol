...
contract DJones is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 dJONES
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("DJONES", "DJONES") {
        _mint(msg.sender, 1 ether); // mint 1 JONES Share for initial pools deployment
