...
abstract contract CoreStrategy is BaseStrategy {
        ...
        )
    {
        ...
        if (totalAssets > totalDebt) {
            ...
            insurance.reportLoss(totalDebt, _profit);
        }
        ...
        returns (uint256 _amountFreed, uint256 _loss)
    {
        ...
        uint256 debtInShort = balanceDebtCurrentInShort();
    ...
    // value of borrowed tokens in value of want tokens
    function balanceDebtCurrentInShort() public returns (uint256) {
...
// File: WFTMUSDCScreamLqdrSpooky.sol
