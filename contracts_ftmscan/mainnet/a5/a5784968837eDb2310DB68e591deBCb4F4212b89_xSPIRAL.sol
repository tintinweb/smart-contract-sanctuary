...
contract xSPIRAL is FrozenToken {
    ...
    constructor() ERC20("xSPIRAL", "xSPR", 9) ERC20Permit() {
    ...
    /**
        @notice increases SPIRAL supply to increase staking balances relative to profit_
