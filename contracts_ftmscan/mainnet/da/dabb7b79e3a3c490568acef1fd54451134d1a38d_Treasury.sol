...
contract Treasury is ContractGuard {
    ...
    function getBondDiscountRate() public view returns (uint256 _rate) {
        ...
        if (_tombPrice <= tombPriceOne) {
            if (discountPercent == 0) {
                ...
                uint256 _bondAmount = tombPriceOne.mul(1e18).div(_tombPrice); 
    ...
    function initialize(
        ...
        maxSupplyExpansionPercent = 2000; // Upto 4.0% supply for expansion
    ...
    function setMaxSupplyExpansionPercents(uint256 _maxSupplyExpansionPercent) external onlyOperator {
        require(_maxSupplyExpansionPercent >= 10 && _maxSupplyExpansionPercent <= 2000, "_maxSupplyExpansionPercent: out of range"); // [0.1%, 20%]
    ...
    function setBootstrap(uint256 _bootstrapEpochs, uint256 _bootstrapSupplyExpansionPercent) external onlyOperator {
        ...
        require(_bootstrapSupplyExpansionPercent >= 100 && _bootstrapSupplyExpansionPercent <= 2000, "_bootstrapSupplyExpansionPercent: out of range"); // [1%, 20%]
