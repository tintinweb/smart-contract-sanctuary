...
interface ISoulDistributor {
    // Returns the IERC20 of the token distributed by this contract.
    function soul() external view returns (IERC20);
...
contract SoulDistributor is ISoulDistributor, Ownable {
    ...
    constructor() {
        // 8PM EST | JANUARY 8TH, 2022
        startTime = 1641690000;

        // 51 DAY DURATION
        duration = 51 days;
        
        // 8PM EST | FEBRUARY 28TH, 2022
