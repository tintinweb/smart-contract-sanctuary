...
interface IMarket {
    ...
    event BidCreated(address tokenAddress, uint256 indexed tokenId, Bid bid);
    event BidRemoved(address tokenAddress, uint256 indexed tokenId, Bid bid);
    event BidFinalized(address tokenAddress, uint256 indexed tokenId, Bid bid);
    event AskCreated(
