...
// Feeling down with the market? Looking for some stability?
// GET REWARDS IN BOO with GHOST
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BOO = IBEP20(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BOO.balanceOf(address(this));
        ...
        uint256 amount = BOO.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BOO.transfer(shareholder, amount);
...
contract GHOSTBUSTERS is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BOO = 0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE; // BOO
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GhostBuster";
    string constant _symbol = "GB";
    ...
    address public autoLiquidityReceiver=0xAdBF2509994C976A43e006f5113B1791E3ffFd59;
    address public marketingFeeReceiver=0x2A259eD970DB65Db38244CD7F22BCbe07285aE1e;
    ...
    constructor () Auth(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83, address(this));
        _allowances[address(this)][address(router)] = _totalSupply;
        WFTM = router.WETH();
        distributor = new DividendDistributor(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
        ...
        marketingFeeReceiver = 0x2A259eD970DB65Db38244CD7F22BCbe07285aE1e;

        approve(0xF491e7B69E4244ad4002BC14e878a34207E38c29, _totalSupply);
