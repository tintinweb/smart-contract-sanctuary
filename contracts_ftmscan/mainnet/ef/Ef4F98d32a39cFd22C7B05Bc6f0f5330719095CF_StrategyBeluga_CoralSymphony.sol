...
import "../CoralSymphonyStrategy.sol";

contract StrategyBeluga_CoralSymphony is CoralSymphonyStrategy {

    address bpt_coral_diff;
    ...
    function initializeStrategy(
        ...
        address beluga_ftm_lp = address(0xC7f084bCB91F779617B41602f85102849098D6a2);
        address beets = address(0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e);
        address beluga_beets_ftm_lp = address(0x4Df402D19023F2AB7524D7A8ac569df1687De75e);
        address fbeets = address(0xfcef8a994209d6916EB2C86cDD2AFD60Aa6F54b1);

        LiquidationConfig memory config;
        config.depositToken = beets;
        config.rewardToDepositPoolID = 0xcde5a11a4acb4ee4c805352cec57e236bdbc3837000200000000000000000019;
        ...
        __Strategy_init(
            ...
            config,
            fbeets,
            address(0xb1eAfc8C60f68646F4EFbd3806875fE468933749)
        );
    }
}
...
import {BaseUpgradeableStrategy, IController} from "../BaseUpgradeableStrategy.sol";
import {IMasterChef} from "./interfaces/IMasterChef.sol";
import {IBeetsBar} from "./interfaces/IBeetsBar.sol";

/// @title Beluga Coral Symphony Strategy 
/// @author Chainvisions & jlontele 
/// @notice Maximizer strategy for Beluga's Coral Symphony pool.

contract CoralSymphonyStrategy is BaseUpgradeableStrategy {
    ...
    function doHardWork() external onlyNotPausedInvesting restricted {
        ...
        console.log(IERC20(fBeets()).balanceOf(multisig()));
    }
    ...
    function withdrawAllToVault() public restricted {
        if(rewardPool() != address(0)) {
            IMasterChef(rewardPool()).withdrawAndHarvest(poolId(), _rewardPoolStake(), address(this));
        }
        _liquidateReward();
    ...
    function fBeets() public view returns (address) {
        return _getAddress("fBeets");
    }
    ...
    */
    function _liquidateReward() internal {
        ...
        uint256 performanceFee = (targetUnderlyingBalance * IController(controller()).profitSharingNumerator()) / IController(controller()).profitSharingDenominator();
        
        IERC20(targetVaultUnderlying).safeApprove(fBeets(), 0);
        IERC20(targetVaultUnderlying).safeApprove(fBeets(), performanceFee);
        IBeetsBar(fBeets()).enter(performanceFee);

        IERC20(fBeets()).safeTransfer(multisig(), IERC20(fBeets()).balanceOf(address(this)));
    }
    ...
    function _setTargetVault(address _target) internal {
        _setAddress("targetVault", _target);
    }
