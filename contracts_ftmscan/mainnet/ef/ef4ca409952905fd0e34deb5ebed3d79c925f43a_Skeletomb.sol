...
// Hold SKELETBOM receive rewards in $TOMB
// 
// https://t.me/skeletomb
//
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7); // TOMB rewards
...
contract Skeletomb is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Skeletomb";
    string constant _symbol = "STOMB";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 1%
    uint256 public _maxWallet = _totalSupply.div(30); // 3%
    ...
    address public autoLiquidityReceiver=0xe82D385BdA5f9D35c41e49026Ba1b14e13e517DE; //liq address
    address public marketingFeeReceiver=0xe82D385BdA5f9D35c41e49026Ba1b14e13e517DE; // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setsBuybackToBurn(address deadaddress, uint256 buyback) onlyOwner  public virtual {
