...
// NOSHIT coin, no empty promises or anything bullshit, just a NO SHIT COIN!
...
contract NoShit is Context, DeployerCERTIK, Ownable {
    ...
    string private _name = 'NOSHIT';
    string private _symbol = 'NOSHIT';
