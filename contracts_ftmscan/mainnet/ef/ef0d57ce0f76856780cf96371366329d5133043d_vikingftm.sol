...
contract vikingftm is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 6969 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "vikingftm";
    string private _symbol   = "vikingftm";
    uint8 private  _decimals = 9;
    
    uint256 public _taxFee       = 0; 
    uint256 public _liquidityFee = 10; 
    uint256 public _percentageOfLiquidityForDev = 0; 
    
    uint256 public  _maxTxAmount     = 6969 * 10**9;
    uint256 private _minTokenBalance = 1 * 10**9;
