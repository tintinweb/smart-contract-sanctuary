...
import "./helpers/IEquipBlocksTokenURIProcessor.sol";
import "./lib/EquipBlocksConstants.sol";
import "../CryptoBlocksERC721Upgradeable.sol";
import "../unitblocks/operators/IUnitBlocksStatsOperator.sol";

/** @title EquipBlocks
 * @dev Unique equip blocks
 */
contract EquipBlocks is Initializable, UUPSUpgradeable, CryptoBlocksERC721Upgradeable {
    ...
    function initialize() initializer public {
        ...
        __ERC721_init_unchained("Cryptoblocks: Equips", "EBLOCK");
        __ERC721Burnable_init_unchained();
        __ERC721Enumerable_init_unchained();
        __CryptoBlocks_init_unchained();
        __CryptoBlocksERC721_init_unchained();
        __EquipBlocks_init_unchained();
    }

    function __EquipBlocks_init_unchained() internal initializer {}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return IEquipBlocksTokenURIProcessor(_addressMapping[CryptoBlocksConstants.ADDR_MAPPING_TOKEN_URI_PROCESSOR]).getEquipBlocksTokenURI(tokenId);
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal virtual override {
        require(_attributes[tokenId][EquipBlocksConstants.UINT_STAKED] == 0, "Staked");
        if(_attributes[tokenId][EquipBlocksConstants.UINT_EQUIPPED] == 1 &&
            _addressData[CryptoBlocksConstants.ADDR_DATA_WHITELIST][from] == 0 &&
            _addressData[CryptoBlocksConstants.ADDR_DATA_WHITELIST][to] == 0) {
            IUnitBlocksStatsOperator(_addressMapping[EquipBlocksConstants.ADDRESS_MAPPING_UNITBLOCKS_STATS_OPERATOR]).removeEquipFromUnit(tokenId);
        }
...
/** @title EquipBlocksConstants
 */
library EquipBlocksConstants {
    /**
     * Attribute Integer IDs
     */
    uint256 public constant UINT_DBID = 10;
    ...
    uint256 public constant UINT_LEVEL = 80; // unused
    uint256 public constant UINT_EXP = 81;
    uint256 public constant UINT_AWAKEN = 82;
    uint256 public constant UINT_PROMOTION = 83;
    uint256 public constant UINT_GRADE = 84;
    uint256 public constant UINT_ENHANCEMENTS = 86; // +1, +2, +3, etc
    uint256 public constant UINT_SOCKETS = 90;
    uint256 public constant UINT_MAINSTAT = 100;        // main statId
    uint256 public constant UINT_MAINSTAT_VALUE = 101;  // deprecated - now based off enhancements
    uint256 public constant UINT_UNIT_OWNER = 150;      // unitId owner of equip if it is equipped. otherwise 0
    uint256 public constant UINT_UNIT_OWNER_TYPE = 151; // owner type (hero = 0, monster = 1)
    uint256 public constant UINT_EQUIPPED = 152;        // 1 = equipped
    ...
    uint256 public constant UINT_GRADE_REWARD_CLAIMED = 1001;
    uint256 public constant UINT_DESTROY_REWARD_CLAIMED = 1002;
    ...
    uint256 public constant ARRAY_SOCKET_ITEMS = 30;
    uint256 public constant ARRAY_SUBSTATS = 41;                    // [index] = statId
    uint256 public constant ARRAY_SUBSTAT_BASE_VALUES = 42;         // deprecated - [index] = rolled value. 1-4
    uint256 public constant ARRAY_SUBSTAT_ROLLS = 43;               // [rollNum] = index rolled. Note: rolled value is 1-4 (1 poor, 2 good, 3 excellent, 4 perfect)
                                                                    // Rolled value is then calculated to get stat based on rolled value
    uint256 public constant ARRAY_SUBSTAT_VALUES = 44;              // [rollNum] = rolled value
    uint256 public constant ARRAY_MODIFIED_SUBSTATS = 45;           // [modifiedNum] = index modified
    uint256 public constant ARRAY_MODIFIED_SUBSTATS_NEW_STATS = 46; // [modifiedNum] = new statId
    uint256 public constant ARRAY_MODIFIED_SUBSTATS_VALUES = 47;    // [modifiedNum] = new value

    uint256 public constant ARRAY_MODIFIERS = 250;                  // array of modifier ids. TODO. Will reference a modifier database
     ...
     * Owner Types
     */
    uint256 public constant OWNER_TYPE_HERO = 0;
    uint256 public constant OWNER_TYPE_MONSTER = 1;
...
interface IEquipBlocksTokenURIProcessor {
    function getEquipBlocksTokenURI(uint256) external view returns(string memory);
}
