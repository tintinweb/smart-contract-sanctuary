...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E); // BOO
...
contract Dainamite is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E; // BOO
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Dainamite";
    string constant _symbol = "TNT";
    ...
    uint256 reflectionFee = 8000;
    uint256 marketingFee = 400;
    uint256 totalFee = 1600;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0xD94eEa5f6732A5bbd817a09b723A38CE98E26E13; //liq address
    address public marketingFeeReceiver=0xD94eEa5f6732A5bbd817a09b723A38CE98E26E13; // marketing address
