...
contract LpAssetStrategyV2 is Ownable, Pausable {
    ...
    // Scarab addresses
    address public harvester = address(0x1BD12209c7304542e108Fd72E9daB5eb68D4a4b2);
    ...
    /** @dev Sets the scarab fee recipient */
    ...
    tokens sent to this address in the form of an airdrop of a different token type.  This will allow Scarab to convert
