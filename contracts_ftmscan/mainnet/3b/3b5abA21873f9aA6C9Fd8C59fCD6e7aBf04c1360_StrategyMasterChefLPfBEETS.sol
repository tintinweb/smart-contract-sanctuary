...
contract StratManager is Ownable, Pausable {
    ...
    address public unirouter = address(0x20dd72Ed959b6147912C2e529F0a0C651c33c9ce);
...
contract StrategyMasterChefLPfBEETS is StratManager {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address public want = address(0xcdE5a11a4ACB4eE4c805352Cec57E236bdBC3837);
    ...
    address public input = address(0xF24Bcf4d1e507740041C9cFd2DddB29585aDCe1e);
    ...
    function chargeFees() internal {
        ...
        if (input != wrapped) {
            towrapped = towrapped.mul(40).div(1000);
        }
        ...
        if (input == wrapped) {
            wrappedBal = wrappedBal.mul(40).div(1000);
        }

        address callFeeRecipient = tx.origin;
    ...
    function callReward() public returns (uint256) {
        ...
        return wrappedOut.mul(40).div(1000).mul(CALL_FEE).div(MAX_FEE);
    }
