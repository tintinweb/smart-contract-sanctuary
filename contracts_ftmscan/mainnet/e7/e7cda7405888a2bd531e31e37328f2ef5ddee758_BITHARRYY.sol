...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xC5e2B037D30a390e62180970B3aa4E91868764cD); // TAROT
...
contract BITHARRYY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xC5e2B037D30a390e62180970B3aa4E91868764cD; // TAROT
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BurnItHarry";
    string constant _symbol = "BITHARRYY";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(33); // 3%
    uint256 public _maxWallet = _totalSupply.div(33); // 3%
    ...
    address public autoLiquidityReceiver=0x3188A3A5633b8FdC9FF141d0fd5F435CeceaDc43; //liq address
    address public marketingFeeReceiver=0x3188A3A5633b8FdC9FF141d0fd5F435CeceaDc43; // marketing address
