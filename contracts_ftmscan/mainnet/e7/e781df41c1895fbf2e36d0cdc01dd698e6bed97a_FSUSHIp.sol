...
// Fantom Sushi Printer

// Yet another copy and paste printer, inspired by all the other copy and past printers

// Not Financial Advice, Do Your Own Research 
// So many printer rug recently, At least check the contract and make sure that the dev can not set the TxLimit to 0
// Always try to buy and sell in small quantity first, Make sure you can sell before you ape in more

// Stealth Launched
// Initial Liquidity [500FTM]
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xae75A438b2E0cB8Bb01Ec1E1e376De11D44477CC); // Sushi
...
contract FSUSHIp is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xae75A438b2E0cB8Bb01Ec1E1e376De11D44477CC; // Sushi
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FANTOM Sushi Printer";
    string constant _symbol = "FSUSHIp";
    ...
    address public autoLiquidityReceiver=0x97CA4f3636A9523B0014BC8c88180A7A48E27499; //liq address
    address public marketingFeeReceiver=0x97CA4f3636A9523B0014BC8c88180A7A48E27499; // marketing address
