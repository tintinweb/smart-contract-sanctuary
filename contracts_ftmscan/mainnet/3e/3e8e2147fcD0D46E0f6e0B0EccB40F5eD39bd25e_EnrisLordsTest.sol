...
// File contracts/EnrisLordsTest.sol

pragma solidity ^0.8.0;

contract EnrisLordsTest is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    IERC2981,
    ...
    ERC721Burnable
{
    ...
    address private devAddress=0x476e62b30E2587Ea937C19e2b60781e334fa29d7;
    address private communityAddress=0xA0fb2A642e88308E95AaF549E9C1cfFb41D9da43;

    mapping(address => uint8) public whitelistBalance;

    uint256 public royalty = 750;

    constructor() ERC721("EnrisLordsTest", "ELT") {
        _pause();
    }
    ...
    function summonWhitelistedLord(uint8 amount) public payable {
    ...
    function lordsOwned(address _owner)
        external
        view
    ...
    //Overrides
     ...
     function internalMint(address to) internal {
        require(totalSupply() < maxSupply, "All Lords have been summoned!");
