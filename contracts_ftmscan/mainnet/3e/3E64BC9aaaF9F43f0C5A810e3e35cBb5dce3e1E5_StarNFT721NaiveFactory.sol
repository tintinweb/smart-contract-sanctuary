...
import {StarNFT721} from "StarNFT721.sol";

contract StarNFT721NaiveFactory {
    ...
    function createStarNFT(address _minter, address _owner) external onlyNoPaused returns (address starAddr) {
        ...
        bytes memory bytecode = type(StarNFT721).creationCode;
        ...
        StarNFT721 snf = StarNFT721(starAddr);
