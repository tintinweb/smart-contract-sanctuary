...
| $$  | $$| $$\  $$$| $$      | $$            | $$  | $$ \ $$$         | $$  | $$  | $$| $$\  $$ | $$      | $$\  $$$ /$$  \ $$
|  $$$$$$/| $$ \  $$| $$$$$$$$| $$           /$$$$$$|  $$$$$$/         | $$  |  $$$$$$/| $$ \  $$| $$$$$$$$| $$ \  $$|  $$$$$$/
 \______/ |__/  \__/|________/|__/          |______/ \______/          |__/   \______/ |__/  \__/|________/|__/  \__/ \______/ 

Telegram: https://t.me/only10tokens
Twitter: https://twitter.com/Only10Tokens
...
// ONLY10
contract ONLY10TOKENS is BEP20("ONLY10 Tokens", "Ox10") { /*really waiting for Masterchef to own me here please */
    // @notice Creates `_amount` token to `address`. Must only be called by the owner (ONLY10Tokens AKA MASTERCHEF).

    address[] internal tokenAddressList;
    mapping(address => bool) internal tokenAddressExists; 

    uint256 public transBurnrate = 10; /* (100 /10 = 10% burn rate) */
    uint256 public maxtransBurnrate = 5; /* max 100 / 5 burn = 20% */
