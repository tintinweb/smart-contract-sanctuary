...
// GET REWARDS IN HEC with HECPAY
// Improved smart contract with instant $HEC rewards pay out.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 HEC = IBEP20(0x5C4FDfc5233f935f20D2aDbA572F770c2E377Ab0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = HEC.balanceOf(address(this));
        ...
        uint256 amount = HEC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            HEC.transfer(shareholder, amount);
...
contract HECPAY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address HEC = 0x5C4FDfc5233f935f20D2aDbA572F770c2E377Ab0; // HEC
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "HECPAY";
    string constant _symbol = "HECPAY";
    ...
    address public autoLiquidityReceiver=0x9e96d3FcE5cF3B62cE978b224e8ae65d4B0A3222;
    address public marketingFeeReceiver=0x9e96d3FcE5cF3B62cE978b224e8ae65d4B0A3222;
