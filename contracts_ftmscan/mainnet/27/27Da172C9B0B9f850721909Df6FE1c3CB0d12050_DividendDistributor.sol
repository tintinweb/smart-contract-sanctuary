...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SPA = IBEP20(0x5602df4A94eB6C680190ACCFA2A475621E0ddBdc);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SPA.balanceOf(address(this));
        ...
        uint256 amount = SPA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SPA.transfer(shareholder, amount);
