...
contract PantherToken is ERC20, Ownable {
    ...
    uint public constant maxSupply = 1000000000e18; // 1 billion Gateau
    ...
    // Burn rate % of transfer tax. (default 5% x 2% = 0.01% of total amount).
     ...
     */
    constructor() public ERC20("PantherSwap Token", "PANTHER") {
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        require(totalSupply() < maxSupply, "mint: max supply");
        _mint(_to, _amount);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (recipient == BURN_ADDRESS || transferTaxRate == 0) {
            ...
            // super._transfer(sender, devWallet, liquidityAmount);
     ...
     * Can only be called by the current operator.
     */
    function updateTransferTaxRate(address _devWallet) public onlyOperator {
