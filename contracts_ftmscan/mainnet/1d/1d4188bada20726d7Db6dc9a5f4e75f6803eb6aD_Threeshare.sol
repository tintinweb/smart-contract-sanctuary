...
contract Threeshare is Context, IERC20, Ownable {
    ...
    string private constant _name = '3SHARES Token';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xac8fB0133952d5c75B1DEdb1d424cAFFBE7C8DdA, 'We can not exclude router.');
