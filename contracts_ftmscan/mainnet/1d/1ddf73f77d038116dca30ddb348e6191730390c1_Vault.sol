...
abstract contract VaultBase is ERC20Upgradeable, IVault {
    ...
    function depositFor(
        ...
        uint256 _amount,
        uint256 _min_mint_amount
    ) public override checkContract() _non_reentrant_ returns (uint256 _mint_amount) {
    ...
    function withdrawFor(
        ...
        uint256 _shares,
        uint256 _min_output_amount
    ) public override _non_reentrant_ checkContract() returns (uint256 _output_amount) {
