...
contract NativeFarm is Ownable, ReentrancyGuard {
    ...
    // Token address
    address public constant NATIVE = 0xE447DB53a41EED47a6FF2CeB1a8Bcd1ee6dcC6Af; //HadicX Token
    // Owner reward per block: 13% ==> 13.13%
    uint256 public constant ownerNATIVEReward = 101313;
    // Native total supply: 6.660420 mil = 6660420e18
    uint256 public constant NATIVEMaxSupply = 6660420e18;
    // Natives per block: (0.09648515981 - owner 10%)
    uint256 public constant NATIVEPerBlock = 6666660000000; // NATIVE tokens created per block
    // Approx 15/7/2021
    uint256 public constant startBlock = 23522065; // https://ftmscan.com/block/23522065
