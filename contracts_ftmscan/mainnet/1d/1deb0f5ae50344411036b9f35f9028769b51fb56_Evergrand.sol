...
contract Evergrand is BEP20 {
    ...
    // Fee address
    address payable public tresAddr = 0x73A0EA40A130984b9156c6B8716750798e5D7c0a;
     ...
     */
    constructor() public BEP20("Evergrand", "Ever") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (recipient == brunAddr || sender == _operator || sender == noTaxContractAddr || recipient == noTaxContractAddr || transferTaxRate == 0 ) {
            ...
            require(taxAmount >= burnAmount + liqAmount + tresAmount - 10);

            // default 94% of transfer sent to recipient
            uint256 sendAmount = amount.sub(taxAmount);
            require(amount >= sendAmount + taxAmount - 10);
    ...
    function updateTransferTaxRate(uint16 _transferTaxRate) public onlyOperator {
        require(_transferTaxRate <= maxTaxRate);
    ...
    function updateBurnFee(uint16 _burnFee) public onlyOperator {
        require(_burnFee <= 100);
        require(_burnFee + liqFee + tresFee <=100);
    ...
    function updateLiqFee(uint16 _liqFee) public onlyOperator {
        require(_liqFee <= 100);
        require(_liqFee + burnFee + tresFee <=100);
    ...
    function updateTresFee(uint16 _tresFee) public onlyOperator {
        require(_tresFee <= 100);
        require(_tresFee + liqFee + burnFee <=100);
    ...
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) public onlyOperator {
        require(_maxTransferAmountRate <= 1000);
        require(_maxTransferAmountRate >= 100);
