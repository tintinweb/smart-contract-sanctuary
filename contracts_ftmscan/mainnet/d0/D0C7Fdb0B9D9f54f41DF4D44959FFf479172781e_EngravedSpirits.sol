...
{
    modifier onlyDevs {
         require(msg.sender == primaryDevAddress || msg.sender == secondaryDevAddress || msg.sender == tertiaryDevAddress || msg.sender == quaternaryDevAddress || msg.sender == quinaryDevAddress || msg.sender == senaryDevAddress, "Dev Only: caller is not the developer");
        _;
    }
    ...
    address  public quinaryDevAddress = 0x06F4E545378dc9697Df30F85B049621037f48176;
    address  public senaryDevAddress = 0x23F9eADB14945d3AbE1f2609497b038333D57B5D;
    ...
    uint256 public senaryDevFee = 2500;
    ...
    constructor() ERC721("Engraved Spirits", "ENGS") {
        _pause();
    }
    ...
    function splitFees(uint256 sentAmount) internal {
        ...
        uint256 senaryDevFeeAmount = sentAmount.mul(senaryDevFee).div(10000);
        ...
        devFees[senaryDevAddress] += senaryDevFeeAmount;
