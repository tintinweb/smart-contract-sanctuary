...
contract FantomFrenShip is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Fantom FrenShip";
    string private constant _symbol = "FrenShip";
    ...
    uint256 public _maxTxAmount = 2500000 * 10**9; //5%
