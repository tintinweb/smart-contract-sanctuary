...
contract TombRaider is Auth, IERC20 {
    ...
    string constant _name = "TOMB Raider ";
    string constant _symbol = "TRAIDER";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10**_decimals);
    uint256 public _maxTxAmount = _totalSupply.div(200); // 0.50%
    ...
    address public autoLiquidityReceiver =
        0xEb5e9e17714401D11C0367BFA33Ec4a2f1C87921;
    address public marketingFeeReceiver =
        0xC7EC17b10D8487ac82C8A420f69350F13eD61A4E;
    ...
    constructor(
        ...
        WFTM = _wFTM;
        pair = IDEXFactory(router.factory()).createPair(_wFTM, address(this));
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        // TODO: This doesn't make sense why check if you are just returning total fee
...
/// @title Dividend Distributor Contract
/// @author evm
/// @notice You can use this contract to pay dividends in a reflexive ways
contract DividendDistributor is IDividendDistributor {
    using SafeMath for uint256;

    // TODO: is this tomb raider:- I think yes?
    ...
    IERC20 internal TOMB = IERC20(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7);
    address internal WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    IDEXRouter router;
    ...
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29); // Spooky Swap Router address
        _token = msg.sender;
    }
