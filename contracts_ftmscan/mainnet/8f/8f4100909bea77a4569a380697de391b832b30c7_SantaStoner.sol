...
contract SantaStoner is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name     = "Santa Stoner";
    string private _symbol   = "SANTA STONER";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _spookyswapV2Router; // Spookyswap V2 Router
    address public _spookyswapV2LiquidityPair;     // Spookyswap V2 liquidity pairing for SANTASTONER/WFTM
