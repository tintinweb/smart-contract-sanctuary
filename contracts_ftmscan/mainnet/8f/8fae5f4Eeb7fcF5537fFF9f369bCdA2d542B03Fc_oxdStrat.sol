...
contract oxdStrat is Ownable, Pausable {
    ...
    constructor(
        ...
        outputToWrappedRoute = [output, address(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75), wrapped];
    ...
    function chargeFees(address _caller) internal {                   
        uint256 toWrapped = IERC20(output).balanceOf(address(this)).mul(PLATFORM_FEE).div(FEE_DIVISOR); 
