...
Website: http://www.shitcoin.support/
Telegram: https://t.me/shitcoinsupport
Main features are
...
contract ShitcoinSupport is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4d1006A014559951CD8590Cf7e0eF3d3C6551ae0); // Marketing Address
    address payable public devAddress = payable(0x4075AA51E49D48B3623F029eE1221F19Ff06AB68); // Marketing Address
    address payable public burnAddress = payable(0x4075AA51E49D48B3623F029eE1221F19Ff06AB68); // Marketing Address
    ...
    string private _name = "ShitcoinSupport";
    ...
    function _transfer(
		...
		require(!bots[from] && !bots[to], "Hello Bot");
