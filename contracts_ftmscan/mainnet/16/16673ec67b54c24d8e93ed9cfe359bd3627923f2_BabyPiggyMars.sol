...
contract BabyPiggyMars is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name     = "Baby Piggy Mars";
    string private _symbol   = "PIGGY MARS";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x13fE5ed90BD7C7E82fD31FEdaDee8c97cfBf605A); // Marketing address used to pay for marketing
