...
contract RibbitRibbit is Context, IERC20, Ownable {
    ...
    string private _name = "RibbitRibbit";
    ...
    function _transfer(
        ...
        //if any account bRosegs to _isExcludedFromFee account then remove the fee
