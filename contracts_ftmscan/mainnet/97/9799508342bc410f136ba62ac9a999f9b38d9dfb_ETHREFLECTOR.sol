...
//  Fair Launch
//  Twitter : https://twitter.com/EtHreflector
//  Telegram : https://t.me/+SClguU415Ik2NGVk
//  Reward: $ETH
...
contract ETHREFLECTOR is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ETH REFLECTOR";
    string constant _symbol = "ETHR";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(5); // 20%
    ...
    address public autoLiquidityReceiver=0xEc0bf7DD7e05178350f8065ed12fBD3631529176; //liq address
    address public marketingFeeReceiver=0xEc0bf7DD7e05178350f8065ed12fBD3631529176; // marketing address
