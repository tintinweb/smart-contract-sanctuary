...
//  Stealth Launch
//  BabySpirit - $BabyS $FTM 
//  Telegram: https://t.me/BabySpiritFTM
//  Initial Liquidity: 250 FTM
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x5Cc61A78F164885776AA610fb0FE1257df78E59B); // SPIRIT
    ...
    constructor (address _router) {
        ...
        : IUniswapV2Router(0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52);
        _token = msg.sender;
    }
...
contract BabySpirit is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5Cc61A78F164885776AA610fb0FE1257df78E59B; // SPIRIT
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabySpirit";
    string constant _symbol = "BabyS";
    ...
    address public autoLiquidityReceiver=0xB0Be168C378f5830D814BDb3DEB0F844e307DC9C; //liq address
    address public marketingFeeReceiver=0xB0Be168C378f5830D814BDb3DEB0F844e307DC9C; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 3000;
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        address _router = 0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52;
        ...
        autoLiquidityReceiver = 0xf03aA5DC0A0289f6cB708306E6391cbC164e5AB3;
