...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xb3654dc3D10Ea7645f8319668E8F54d2574FBdC8); // LINK
...
contract FLINKP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xb3654dc3D10Ea7645f8319668E8F54d2574FBdC8; // LINK
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FANTOM LINK Printer";
    string constant _symbol = "FLINKP";
    ...
    address public autoLiquidityReceiver=0x3909D5BFD531C9144f535c6A2d687F66679Ad360; //liq address
    address public marketingFeeReceiver=0x3909D5BFD531C9144f535c6A2d687F66679Ad360; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 500; // 2%
    bool inSwap;
