...
contract Strategy_SPIRIT_FTM {
    // This strategy is for FTM network. SPIRIT - FTM pair. RewardToken = "Boo"
    ...
    address public constant lpToken = 0x30748322B6E34545DBe0788C421886AEB5297789;
    address public constant farm = 0xEFe02cB895b6E061FA227de683C04F3Ce19f3A62;
    // ------------>        END          <--------------
    ...
    function autoCompound() external {
        ...
        if (amount > 0) {
            // ----> Important functions for getting rewards <---
            _getRewardsFromFarm();
            //  ---> END <---------------------------------------
