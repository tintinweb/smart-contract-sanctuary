...
contract BooStrategyFantom is OwnableUpgradeable {
    ...
    */
    function withdrawAllToVault() public onlyMultisigOrOwner {
        ...
        IERC20(boo).safeTransfer(vault, IERC20(boo).balanceOf(address(this)));
    }
    ...
    */
    function withdrawToVault(uint256 amount) public onlyVault {
        ...
        uint256 entireBalance = IERC20(boo).balanceOf(address(this));
    ...
    */
    function investedUnderlyingBalance() external view returns (uint256) {
        return booBalanceInXboo().add(IERC20(boo).balanceOf(address(this)));
    }
