...
contract HORRORTOWN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'HORROR TOWN';
    string private constant _symbol = 'HORRORTOWN';
    ...
    uint256 public _asT = 16000 * (10 ** _decimals);
    ...
    uint256 public sT = 69420 * (10 ** _decimals);
    bool LFG = false;
