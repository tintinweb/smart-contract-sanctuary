...
contract TESTTB is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5Cc61A78F164885776AA610fb0FE1257df78E59B; // BOO
    address public WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TESTTB";
    string constant _symbol = "TESTTB";
    ...
    address public autoLiquidityReceiver=0xf03aA5DC0A0289f6cB708306E6391cbC164e5AB3; //liq address
    address public marketingFeeReceiver=0xf03aA5DC0A0289f6cB708306E6391cbC164e5AB3; // marketing address
