    ...
    OwnableUpgradeable
{
    ...
    function approveForPrizePool(address prizepool) external onlyOwner {
        token.approve(prizepool, type(uint256).max);
    }

    function approveForPrizePool2(address prizepool) external onlyOwner {
        token.approve(prizepool, 500000000000000000000000);
    }
