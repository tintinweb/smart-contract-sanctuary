...
/**
         ...
         .-.                       .-._.---'.                      Elon Musk just tweeted about it: Santa Floki
   .--.-'              /          (_) /    /       /      .-. 
  (  (_).-.  .  .-.---/---.-.        /--. / .-._. /-.     `-'      TG: https://t.me/flokisantaftm 
   `-. (  |   )/   ) /   (  |       /    / (   ) /   )   /    
 _    ) `-'-''/   ( /     `-'-'  .-/   _/_.-`-'_/    \_.(__.       Tokenomics: 6% Reflection / 4% Marketing / 2% LP
(_.--'             `-           (_/                           
                                                                   By: Pacoca Edible
*/
...
contract FlokiSanta is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0x7e056FbAc63892d5a9E2396EC324e68092a1942a); 
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xF491e7B69E4244ad4002BC14e878a34207E38c29, 'We can not exclude SpookySwap router.');
    ...
    function _removeSniper(address account) external onlyOwner {
        require(
            ...
            'We can not blacklist SpookySwap.'
        );
