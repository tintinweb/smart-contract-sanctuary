...
contract GateV2 is Ownable,  ReentrancyGuard {
    ...
    // gateV1/TEST
    address public gatev1 = 0x5d77a7efDd038eb701eB44F2fb47FBEb4D4025B0;
    // gateV1/PROD
    ...
    mapping (address => uint256) public redeem_coffin_balances;
    ...
    function redeem(
        ...
        redeem_coffin_balances[msg.sender] = redeem_coffin_balances[msg.sender].add(coffin_out);
        if (redeem_coffin_limitation>0) {
            require(redeem_coffin_balances[msg.sender]<=redeem_coffin_limitation,
    ...
    function collectCoffin(bool stake) external nonReentrant {
        ...
        if (redeem_coffin_balances[msg.sender] > 0) {
            _share_amount = redeem_coffin_balances[msg.sender];
            redeem_coffin_balances[msg.sender] = 0;
