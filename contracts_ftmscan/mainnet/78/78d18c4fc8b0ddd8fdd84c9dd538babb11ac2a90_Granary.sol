...
NOTE: ftm.guru merely provides secure auto-compounding vaults for masterchefs. The VEDAO $WEVE is not the real Solidly project, neither associated with it.

				COME OVER TO OUR DISCORD SERS
