...
contract MoonFlip is Ownable, ReentrancyGuard {
    ...
    uint256[] public betAmounts = [0.05 ether, 0.1 ether, 0.5 ether, 1 ether, 2.5 ether, 5.0 ether];
    ...
    function flipCoin(CoinSide guess, uint256 betIndex) public payable gameChecks nonReentrant {
