/**
 *Submitted for verification at moonriver.moonscan.io on 2022-04-24
*/
...
contract Comptroller is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function _become(Unitroller unitroller) public {
        ...
        Comptroller(address(unitroller))._becomeG5();
    }

    function _becomeG5() public {
        require(msg.sender == comptrollerImplementation, "only brains can become itself");
        
        for(uint i = 0; i < allMarkets.length; i++){
            _initializeMarket(address(allMarkets[i]));
        }
    }
    ...
    function getCompAddress() public view returns (address) {
        return address(0x9A92B5EBf1F6F6f7d93696FCD44e5Cf75035A756);
    }
