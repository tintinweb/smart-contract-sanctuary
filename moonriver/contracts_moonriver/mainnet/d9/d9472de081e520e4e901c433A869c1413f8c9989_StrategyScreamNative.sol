...
contract StrategyScreamNative is StratManager, FeeManager {
    ...
    constructor(
        ...
        native = IWrappedNative(_outputToNativeRoute[_outputToNativeRoute.length - 1]);
    ...
    function _deleverage() internal {
        ...
        while (wantBal < borrowBal) {
            IVTokenNative(iToken).repayBorrow(wantBal);
        ...
        IVTokenNative(iToken).repayBorrow(uint256(-1));
