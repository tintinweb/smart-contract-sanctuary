...
contract Aniversario1F is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI = "https://gateway.pinata.cloud/ipfs/Qmdf2fPVgbcx73ugDpJJxUFLJMozyuxEcv5FEn7SuW1nFZ/";
//   string public baseExtension = ".json";                         
  uint256 public maxSupply = 50;                                                           
  address public walletMaster = 0x11c3e8eDCEd034cFCbCF88be14Dc19cB169d9951;  

  mapping(address => uint) public saleUser;              

  constructor() ERC721("Aniversario1F", "ANI1F") {
  }
  ...
  function setBaseURI(string memory _newBaseURI) public onlyOwner {
    ...
    function mintNft() public onlyOwner{
        ...
        saleUser[msg.sender] = maxSupply;
        uint _quantity = saleUser[msg.sender]; 
        require(supply < maxSupply, "Insuficiente supply");
