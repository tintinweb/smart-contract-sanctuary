...
contract BovineVerseLoyalty is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721('BovineVerseLoyalty', 'loyalty') {
        myBaseURI = "https://bv-test.blockpulse.net/api/nft/loyalty";
