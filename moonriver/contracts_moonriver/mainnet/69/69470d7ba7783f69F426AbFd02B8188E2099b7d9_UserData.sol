...
contract UserData is AdminAccesible, LandSaleCore {
    ...
    function _setUserDiscounts(address user, Discount[] calldata singleDiscounts, Discount[] calldata multiDiscounts) private {
        ...
        _setUserDiscounts(_userDiscountsSingle[user], singleDiscounts);
        _setUserDiscounts(_userDiscountsMulti[user], multiDiscounts);
    }

    function _setUserDiscounts(Discount[] storage localDiscounts, Discount[] calldata newDiscounts) internal {
