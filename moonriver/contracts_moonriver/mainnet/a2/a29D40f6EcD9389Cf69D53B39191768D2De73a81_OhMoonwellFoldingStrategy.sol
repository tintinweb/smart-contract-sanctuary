...
contract OhMoonwellFoldingStrategy is IStrategy, OhMoonwellHelper, OhStrategy, OhMoonwellFoldingStrategyStorage {
    ...
    function updateSupply() internal {
        _setSuppliedUnderlying(balanceOfUnderlying(derivative(), address(this)));
        _setBorrowedUnderlying(borrowBalanceCurrent(derivative(), address(this)));
    }
...
contract OhMoonwellFoldingStrategyStorage is Initializable, OhUpgradeable, IMoonwellFoldingStrategyStorage {
    ...
    function initializeMoonwellFoldingStorage(
        ...
        _setSuppliedUnderlying(0);
        _setBorrowedUnderlying(0);
    }
    ...
    function _setSuppliedUnderlying(uint256 suppliedUnderlying_) internal {
    ...
    function _setBorrowedUnderlying(uint256 borrowedUnderlying_) internal {
