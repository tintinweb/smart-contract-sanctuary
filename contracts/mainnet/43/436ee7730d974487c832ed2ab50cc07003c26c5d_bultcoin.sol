...
contract bultcoin is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10000000000000000000000000;
    ...
    function tokenFromReflection(uint256 rAmount) public view returns(uint256) {
        require(rAmount <= _rTotal, "Amount must be less than total tokens");
