...
//4,800 Stupid Fish Tanks that do not have fish inside and exist on the Ethereum Blockchain.
...
// File: contracts/StupidFishTank.sol
...
contract StupidFishTank is ERC721Enumerable, Ownable, RandomlyAssigned {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(totalSupply() + _mintAmount <= maxFISHTANK);
