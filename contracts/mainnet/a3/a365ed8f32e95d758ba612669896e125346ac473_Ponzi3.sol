...
Tax for Buying/Selling: 20%
    - 5% of each transaction sent to holders as ETH transactions
    - 10% of each transaction sent to Treasury Wallet
    - 5% of each transaction sent to the Liquidity Pool

50% of treasury is used to buy PONZI at random times every day.
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "PONZI_DividendTracker";
    string private _symbol = "PONZI_DividendTracker";
