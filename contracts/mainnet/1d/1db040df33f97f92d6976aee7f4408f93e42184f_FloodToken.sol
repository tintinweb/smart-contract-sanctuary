...
contract StandardToken is Token {
 ...
 contract FloodToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NewtonTree() {
        ...
        name = "Flood Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 5;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "FLT";                                             // Set the symbol for display purposes (CHANGE THIS)
