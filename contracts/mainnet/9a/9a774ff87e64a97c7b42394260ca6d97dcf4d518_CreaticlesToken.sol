...
contract ERC777Upgradeable is Initializable, ContextUpgradeable, IERC777Upgradeable, IERC20Upgradeable {
    ...
    function __ERC777_init(
        ...
        address registry_address_,
        address[] memory defaultOperators_
    ) internal initializer {
        __Context_init_unchained();
        __ERC777_init_unchained(name_, symbol_, registry_address_, defaultOperators_);
    }
    ...
    function __ERC777_init_unchained(
        ...
        _ERC1820_REGISTRY = IERC1820RegistryUpgradeable(registry_address_);
