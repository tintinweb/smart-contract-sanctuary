...
MonstaVerse
🚀 $MONSTAVERSE 
http://Monstaverse.com
https://www.instagram.com/monstaverse666/
https://twitter.com/monstaverse666?s=11
12% total tax - 6% marketing, 4% Liq tax, 2% rewards
*/
...
contract MonstaVerse is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public cooldown = 0 seconds;

    string private _name = "MonstaVerse";
    string private _symbol = "MONSTAVERSE";
