...
/*
The token issuance for this contract will be increased or decreased based on the amount of Ekta Tokens ($EKTA) staked in the smart contract on Ekta Chain mainnet where we asset proof for $EKTA on ETH and BSC.
Website: https://ekta.io & https://ektaworld.io
*/
...
contract EKTA is StandardToken, Ownable {
    string  public name;
