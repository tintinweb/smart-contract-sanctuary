...
// File contracts/helpers/CntrBalance.sol



pragma solidity 0.6.12;
contract CntrBalance {
    ...
    IERC20 public constant CNTR_WETH_LP = IERC20(0xa12b7a78a31854d2E9Ee8FBC92E262AAf4FCd4f1);
    
    function balanceOf(address _address) external view returns (uint) {
        // Address Balance
        uint balance = CNTR.balanceOf(_address);
        
        // LP balance
        (uint lpBalance,) = wheyFarm.userInfo(2, _address);
        lpBalance = lpBalance.add(CNTR_WETH_LP.balanceOf(_address));
        
        // Amount of CNTR in LP tokens
        balance = balance.add(lpBalance.mul(CNTR.balanceOf(address(CNTR_WETH_LP))).div(CNTR_WETH_LP.totalSupply()));
