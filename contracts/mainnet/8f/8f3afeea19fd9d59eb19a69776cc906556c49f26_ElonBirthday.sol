...
pragma solidity ^0.6.12;
    ...
    contract ElonBirthday is Context, IERC20, Ownable {
        ...
        string private _name = 'Elon Birthday';
        string private _symbol = 'ElonBirthday';
        ...
        uint256 private _maxTxAmount = 500000e9;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeForCharity = 1 * 10**5 * 10**9;
        ...
        // in case the token is highly valued and 1M becomes too much
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 500000e9 , 'maxTxAmount should be greater than 500000e9');
