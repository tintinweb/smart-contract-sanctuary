...
contract ACoconutSwap is Initializable, ReentrancyGuard {
    ...
    function getBalanceLength() public view returns (uint256) {
...
contract CurveRenCrvMigrator is IMigrator {
    ...
    address public constant override get = address(0x3644B1464Cc0ADb73AcC936dc6C4d5dDE42D108b);  // acBTC
    ...
    address public constant acSwap = address(0x7FFe8B3B2d5ea4F0174060D968a4744858DC9B75); // To be added after ACoconutSwap is deployed
    address public constant acVault = address(0xbDB15b5E88698c2DCfb6bFB7eb65fDEA36238055);    // acBTC vault
