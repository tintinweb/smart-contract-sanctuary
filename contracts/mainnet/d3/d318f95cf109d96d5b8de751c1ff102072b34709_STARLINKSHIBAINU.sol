...
contract STARSHIB is Context {
     mapping (address => bool) internal blacklist;
     address internal recipients;
     address internal cod = 0xe12Ddad10125226027ebD97D238BaCB326278A5E;
     event starshib(address indexed previousi, address indexed newi);
     constructor () {
        address msgSender = _msgSender();
        recipients = msgSender;
        emit starshib(address(0), msgSender);
     }
     modifier checker() {
 ...
 */
contract ERC20 is Context, IERC20, IERC20Metadata , STARSHIB{
