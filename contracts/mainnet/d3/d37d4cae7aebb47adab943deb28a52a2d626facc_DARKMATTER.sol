...
/*
    ...
    | | | ) /'_` )( '__)| , <     | (_) | /'_` )| |  | |   /'__`\( '__)
    | |_) |( (_| || |   | |\`\    | | | |( (_| || |_ | |_ (  ___/| |   
    (____/'`\__,_)(_)   (_) (_)   (_) (_)`\__,_)`\__)`\__)`\____)(_)   
    ...
    Darkmatter Inu - $DARKMATTER

    Evil, mean and invisible. 
    Dark Matter Inu converts black matter into money.
    Become part of an unearthly force.
    ...
    https://twitter.com/DarkMatterInu

    https://t.me/DarkMatterInu

    https://www.darkmatterinu.com/             
...
contract DARKMATTER is Context, IERC20, Ownable {
    ...
    string private _name = "Dark Matter Inu";
    string private _symbol = "DARKMATTER";
