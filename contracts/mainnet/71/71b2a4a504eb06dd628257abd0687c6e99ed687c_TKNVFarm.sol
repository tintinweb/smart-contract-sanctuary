...
contract TKNVFarm is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accTKNVPerShare; // Accumulated TKNV per share, times 1e18. See below.
    }
    ...
    // Accumulated TKNV per share, times 1e18.
    uint256 public accTKNVPerShareMultiple = 1e18;
    // The TKNV token!
    IERC20 public tknv;
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.accTKNVPerShare = getPoolRewardPerShare(_pid);
