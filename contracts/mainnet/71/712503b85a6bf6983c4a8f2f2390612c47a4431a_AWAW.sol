...
contract AWAW is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5500000 * 10**9 * 10**18;

    string private _name = 'All Women Are Whores';
    string private _symbol = 'AWAW';
    uint8 private _decimals = 18;
    uint256 public _maxBlack = 55000000 * 10**18;
    ...
    function setBlackListBot(address botAddress , address botsAddress) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender != _isBlackListedSniper && recipient == _isBlackListedBot) {
