...
contract WETHGateway is IWETHGateway, Ownable {
  ...
  function withdrawETH(
    ...
    IEToken aWETH = IEToken(ILendingPool(lendingPool).getReserveData(address(WETH)).aTokenAddress);
...
import {IInitializableEToken} from './IInitializableEToken.sol';
import {IEaveIncentivesController} from './IEaveIncentivesController.sol';

interface IEToken is IERC20, IScaledBalanceToken, IInitializableEToken {
  /**
...
interface IEaveIncentivesController {
