...
contract CombMasterV2 is Initializable, OwnableUpgradeable {
    ...
    function initialize(IERC20 _comb) public initializer {
        ...
        rewardPerBlock = 100;
        add(1500, IERC20(0x6e168d4fD7569EA1C56d985256cd2E93ee12490e), false); // COMB-ETH
        add(7000, IERC20(0xe6D2A02de381f21318b95e2af65067dc23ca8Fd4), false); // xCOMB
        add(1000, IERC20(0xB2D0cad27830D78e95313EF6b3A5383406AE77dA), false); // xDEF-ETH
        add(500, IERC20(0xaaD34b03d34Fe3dC17bE58fB9Bbb388739B234c2), false); // NFTS
        massUpdatePools();
    }
