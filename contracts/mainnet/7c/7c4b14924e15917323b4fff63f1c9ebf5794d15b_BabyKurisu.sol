...
contract BabyKurisu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Kurisu";
    string private constant _symbol = "Baby KSU";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x50503EF5B5858f8172491A0cA57c7eF39fB9E32E);
        _feeAddrWallet2 = payable(0x50503EF5B5858f8172491A0cA57c7eF39fB9E32E);
