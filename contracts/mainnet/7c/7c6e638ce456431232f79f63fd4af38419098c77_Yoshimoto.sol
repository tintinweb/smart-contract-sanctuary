...
contract Yoshimoto is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Yoshimoto";
    string constant _symbol = "YOMO";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 _maxTxAmount = _totalSupply / 400;
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xC5f4eB4DC154C97bCA50C3aB5Be39fc12CDfF93F);
	    teamFeeReceiver = address(0x2524045228A6f01Eb16a6Af9df7d25c391024e29);
