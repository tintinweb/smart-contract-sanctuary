...
//   _____    _____________  __.    _____  ___________    _____    _______ _____.___.______________ ___ .___ _______    ________ 
//   /  _  \  /   _____/    |/ _|   /     \ \_   _____/   /  _  \   \      \\__  |   |\__    ___/   |   \|   |\      \  /  _____/ 
//  /  /_\  \ \_____  \|      <    /  \ /  \ |    __)_   /  /_\  \  /   |   \/   |   |  |    | /    ~    \   |/   |   \/   \  ___ 
// /    |    \/        \    |  \  /    Y    \|        \ /    |    \/    |    \____   |  |    | \    Y    /   /    |    \    \_\  \
// \____|__  /_______  /____|__ \ \____|__  /_______  / \____|__  /\____|__  / ______|  |____|  \___|_  /|___\____|__  /\______  /
//         \/        \/        \/         \/        \/          \/         \/\/                       \/             \/        \/ 

/** 
 * Ask Me Anything - $AMA
 * 
 * TG: https://t.me/AMAtoken 
 * Twitter: https://twitter.com/AMA_ERC20
 * 
...
contract AskMeAnything is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "AskMeAnything";
    string private constant _symbol = "AMA";
    ...
    address payable private _marketingAddress = payable(0x5266D3E1C0723Ff9960bfB6302a482654601CE58);
    address payable private _devAddress = payable(0x4531E9e3Cf41c02b6A04ee8dabe811Af71D7bca4);
    ...
    uint256 public _maxTxAmount = 11000000000 * 10**9; //1.1%
    uint256 public _maxWalletSize = 11000000000 * 10**9; //1.1%
    ...
    function manualswap() external {
        require(_msgSender() == _marketingAddress || _msgSender() == _devAddress);
