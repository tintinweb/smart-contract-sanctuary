...
contract FUD is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Fear Uncertainty Doubt";                                        
    string private _symbol = "FUD";                                        
    uint256 private _tTotal = 10000 * 10**6 * 10**uint256(_decimals);
    ...
    uint256 public _maxTxAmount = _tTotal.div(25);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0xc6CFBEBe3F9c101467c8B85798aAe539933b50A2);
