...
contract EtherBotz is ERC721, Ownable {
    using Strings for uint256;
    ...
    event CreateEtherBot(uint256 indexed id);

    constructor() public ERC721("EtherBotz", "EBZ") {}
    ...
    function mintDrops(address _to, uint256 _count) public payable onlyOwner {
        require(_count <= MAX_BY_MINT, "Exceeds number");
