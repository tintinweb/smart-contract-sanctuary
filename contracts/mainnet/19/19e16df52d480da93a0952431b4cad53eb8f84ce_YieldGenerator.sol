...
contract YieldGenerator is IYieldGenerator, OwnableUpgradeable, AbstractDependant {
    ...
    function __YieldGenerator_init() external initializer {
        ...
        defiProtocols[uint256(DefiProtocols.AAVE)].whiteListed = false;
        ...
        defiProtocols[uint256(DefiProtocols.COMPOUND)].whiteListed = false;
        ...
        defiProtocols[uint256(DefiProtocols.YEARN)].whiteListed = false;
