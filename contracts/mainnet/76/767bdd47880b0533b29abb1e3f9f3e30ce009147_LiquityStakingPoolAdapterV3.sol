...
// File contracts/adapters/LiquityStakingPoolAdapterV3.sol
...
/// @title LiquityStakingPoolAdapterV3
///
/// @dev A vault adapter implementation which wraps a liquity vault.
contract LiquityStakingPoolAdapterV3 is IVaultAdapterV2 {
  ...
  /// @dev UniswapV2Pair for weth/lusd
  ...
  constructor(ILiquityStakingPool _vault, address _admin, address _sentinel, IUniswapV2Router02 _uniV2Router, IDetailedERC20 _lqtyToken, IDetailedERC20 _lusdToken, IDetailedERC20 _wethToken, IUniswapV2Pair _wethLusdPair, address _frontendTag, uint256 _slippage) public {
    vault = _vault;
    admin = _admin;
    sentinel = _sentinel;
  ...
  modifier onlyAdmin() {
    require(admin == msg.sender, "LiquityStakingPoolAdapterV3: only admin");
    _;
  }

  modifier onlySentinel() {
    require(sentinel == msg.sender, "LiquityStakingPoolAdapterV3: only sentinel");
    _;
  }
  ...
  function handoverSentinel(address newSentinel) public onlySentinel{
    require(newSentinel != address(0), "LiquityStakingPoolAdapterV3: sentinel address cannot be 0x0.");
