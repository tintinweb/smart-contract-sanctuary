...
contract BlissFeeHandlerProxy {
  bytes32 private constant implementationPosition = bytes32(uint256(keccak256("bliss.feehandler.impl")) - 1);
  bytes32 private constant proxyOwnerPosition = bytes32(uint256(keccak256("bliss.feehandler.owner")) - 1);
