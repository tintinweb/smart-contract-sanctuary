  ...
  AccessControl
{
  ...
  uint256 public constant MAX_NFT_PURCHASEABLE = 4;

  uint256 private _reserved = 15;
  ...
  constructor() ERC721("Buddies", "DB") {
    _metadataBaseURI = "https://api.moonwalk.com/v1/metadata/collection/61a7086264922f000e23ae54/token/";
