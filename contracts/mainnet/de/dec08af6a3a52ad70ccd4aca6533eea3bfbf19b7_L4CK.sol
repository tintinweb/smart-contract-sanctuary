...
/* ===============================================
*Welcome everyone to L4CK!
*Join Telegram now : https://t.me/L4ckprotocol
*No pre-sale, No minting, Contract Safe, Liquid Lock, 7.7% burning
...
contract L4CK is ERC20 {

    constructor () public ERC20("L4CK", "L4CK") {
    ...
    function _partialBurn(uint256 amount) internal returns (uint256) {
        uint256 burnAmount = amount.div(14);
