...
contract HulkInu is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Hulk Inu | hulkinu.com";
    string private constant _symbol = "HULKINU";
