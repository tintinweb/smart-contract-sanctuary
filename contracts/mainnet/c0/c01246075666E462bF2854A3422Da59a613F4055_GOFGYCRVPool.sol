...
contract GOFTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0xc63dAc4501665E64c7ae60b5860bBC0188687716);
...
contract GOFGYCRVPool is GOFTokenWrapper, IRewardDistributionRecipient {
    
    IERC20 public gof = IERC20(0x488E0369f9BC5C40C002eA7c1fe4fd01A198801c);
    uint256 public constant DURATION = 7 days;

    uint256 public constant startTime = 1603886400; //utc+8 2020-10-28 20:00:00
