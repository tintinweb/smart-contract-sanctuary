...
/**
    ...
    Telegram: https://t.me/hardrockinu

    Website: https://www.hardrockinu.com
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a HRI shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract HardRockInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Hard Rock Inu";
    string private constant _symbol = "HRI";
    ...
    address payable public marketingWallet = payable(0x8060b77E8c14E61033C8DDD6B292B53B32eAe39b);
    address payable public treasury = payable(0x8060b77E8c14E61033C8DDD6B292B53B32eAe39b);
    ...
    constructor (    ) Auth(0xF79062B69f2F319452098677D76de5134E31Fb5D) {
