...
Welcome to $FuckFlokiScam
   ...
   I'll renounce the ownership to burn addresses to transfer $FuckFlokiScam to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $FuckFlokiScam idea, increasing the liquidity pool automatically.
...
contract FuckFlokiScam is BEP20 {
     ...
     */
    constructor() public BEP20("FuckFlokiScam", "FuckFlokiScam") {
