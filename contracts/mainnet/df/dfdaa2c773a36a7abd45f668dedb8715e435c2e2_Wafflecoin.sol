...
contract Wafflecoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Wafflecoin() {
        ...
        name = "Wafflecoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WAFFL";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 715;                                      // Set the price of your token for the ICO (CHANGE THIS)
