...
contract BabyElon is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "BabyElon";                                                // name
    string private _symbol = "BABYELON";                                             // symbol
    ...
    address payable public marketingWallet = payable(0xbD254a25FCaBa747f3EF82c74ab27785A60d0292); // marketing wallet
