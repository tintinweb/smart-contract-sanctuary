...
contract LPTokenWrapper {
    ...
    // Uniswap v2 ETH/NMT pair token
    IERC20 public UNI = IERC20(0xF411b3DA76A265Ba1fA180BC4a6A0e27C0Feea36);
...
contract Unipool is LPTokenWrapper, ApproveAndCallFallBack {
    ...
    // Nova Mining Token
    IERC20 public NMT = IERC20(0xd9A6803f41A006CBf389f21e55D7A6079Dfe8DF3);
    ...
    function receiveApproval(address _from, uint256 _amount, address _token, bytes calldata) external updateReward(address(0)) {
        ...
        require(
            _token == msg.sender && _token == address(NMT),
            "Wrong token"
        );
        ...
        NMT.safeTransferFrom(_from, address(this), _amount);
