...
contract MININGWATCHDOG_SMART_CHAIN is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME   = 'MININGWATCHDOG SMART CHAIN';
    ...
    uint256 private _tTotal = 500000000 * _DECIMALFACTOR;
