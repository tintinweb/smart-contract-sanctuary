...
// ----------------------------------------------------------------------------
// 'KXSHI Token' contract
//
// Symbol      : KXSH
// Name        : KXSHI Token
// Total supply: 1 998 000
// Decimals    : 12
// ----------------------------------------------------------------------------
...
contract KXSH is BurnableToken {

    string public constant name = "KXSHI Token";
    string public constant symbol = "KXSH";
    uint public constant decimals = 12;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 1998000 * (10 ** uint256(decimals));
