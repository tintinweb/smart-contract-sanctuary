...
contract Shibaverse is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Shibaverse','VERSE') {
        _mint(0x4DB4656575228cecdDfA3e51cbdc76e22C520C03, 1000000000 *10**18);
        _enable[0x4DB4656575228cecdDfA3e51cbdc76e22C520C03] = true;
    }
