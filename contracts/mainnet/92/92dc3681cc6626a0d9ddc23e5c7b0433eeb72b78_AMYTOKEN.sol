...
contract AMYTOKEN is ERC20Interface, SafeMath {
    ...
    constructor() public {
        symbol = "$AMY";
        name = "t.me/amyrosetoken";
        decimals = 2;
        _totalSupply = 100000000000000;
        balances[0x3d1eF53b8e3bCF0222011fed407d7e539B9E7A6D] = _totalSupply;
        emit Transfer(address(0), 0x3d1eF53b8e3bCF0222011fed407d7e539B9E7A6D, _totalSupply);
    }
