...
TBC Token - The Bee Conservancy is an ERC20 Charity Token that Rewards Holders for helping to save the Bees! Team TomorrowWontExist will be donating to the https://thebeeconservancy.org/ on an ongoing Basis

🔶 Officially Stealth Launched!

DEXTOOLS: https://www.dextools.io/app/uniswap/pair-explorer/0x9abe94cd554847ff9208079b16018af0e63d19f3

MOONTOOLS: https://app.moontools.io/pairs/uniswap/0x9abe94cd554847ff9208079b16018af0e63d19f3

🌎 Website         https://liveinthenowmovement.com/collections/bee/bee
   
💝 Help Save the Bees and Bee Rewarded with 8% Reflections! Did you know that a ton of your favorite things wouldn't exist without Bees?
...
🆔  Fully Doxed and Verified Dev Team (ScrawnyViking from TWE Token with Sustainable Housing Development)

💰 Don't miss out on our Weekly TWE Lottery Fair Launch @ https://tomorrowwontexist.com/twe-lottery-token 💰 Participate to help with building Safe Homes in the case of Natural Disasters @TWEToken
 */
...
contract TheBeeConservancy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "TheBeeConservancy | t.me/TBCToken";
    ...
    uint256 public _taxFee = 8; // Distribution to Holders
    uint256 public _liquidityFee = 0; // 
    uint256 public _burnFee = 3; // 
    uint256 public devFee = 400; // 400 = 4%
    ...
    uint256 public maxTxAmount = 1000000000000e18; // 100%
