...
Welcome to PRADA Inu!
Liquidity locked, ownership renounced. 

 * PRADA Inu is a meme token with a twist!
 * PRADA Inu has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 *
 * TOKENOMICS:
...
contract PRADAinu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"PRADA";
