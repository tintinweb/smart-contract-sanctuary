 ...
 * LIF4.finance
 * 
 * An improved fork of LIF3.finance, which is yet to launch.
 * 
 * Total Supply = 15.000 LIF4
 * 
 * Buy/sell Limit = 250 LIF4
 * 
 * 10% of each transaction is burned.
 * Of which, 5% goes to burn address. Other 5% goes to reward wallet.
 * 
 * Every 15 minutes, the top holder wins 50% of reward wallet.
 * Winners of the prize, are excluded to win again for 24 hours.
 * 
 * Do not sell within 2 minutes after buying! Or else, 20% additional burn rate will apply to your transaction. 
 * 
 * Brought to you by Team 24Hours. 
 * 
 * Join our TG for updates: https://t.me/hours24
 * 
...
contract LIF4 is IERC20 {
    ...
    uint256 winnerCooldown = 24 hours; 
    ...
    uint256 private _totalSupply = 15000 ether;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (limitBuy) {
            if (amount > 250 ether && sender != __owner) {
