...
contract Hapebeast is ERC721Enumerable, Ownable {
  ...
  address private PartAddress = 0x4A8Cd98688914880eAD8671d9905c310C691137F;
  ...
  constructor(string memory baseURI) ERC721("HAPEBEAST", "HAB") {
    setBaseURI(baseURI);
  }
  ...
  function withdraw() external onlyAuthorized {
    ...
    payable(PartAddress).transfer(balance * 5000 / 10000);
    payable(owner()).transfer(balance * 5000 / 10000);
  }
}