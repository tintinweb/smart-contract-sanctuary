...
// File: contracts/JailToadz.sol



// Amended by GrundleTard
/**
    !Disclaimer!
    GrundleTard will not be liable in any way if for the use 
    of the code. That being said, the code has been thoroughly tested and
    to the best of the developers' knowledge works as intended.
*/
...
contract JailToadz is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public giftPercentage = 25;
  uint256 public headStart = block.timestamp + 14 days;
