...
contract KASSIAKOMMERCIALReserves {

    // Token that serves as a reserve for KASSIAKOMMERCIAL
        ...
        onlyGov
    {
        ...
        KASSIAKOMMERCIALTokenInterface(kassiakommercialAddress).decreaseAllowance(oldRebaser, uint256(-1));
        rebaser = rebaser_;
        KASSIAKOMMERCIALTokenInterface(kassiakommercialAddress).approve(rebaser_, uint256(-1));
