...
contract EIPToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "Elastic IP Address";
    string public constant symbol = "EIP";
    ...
    function EIPToken() public CappedToken(TOKEN_CAP) {
