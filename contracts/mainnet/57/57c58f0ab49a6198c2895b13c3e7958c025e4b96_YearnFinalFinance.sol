...
contract YearnFinalFinance is ERC20, ERC20Detailed {
  using SafeMath for uint;
  ...
  constructor () public ERC20Detailed("Yearn Final Finance", "YFIN", 18) {
      _initMint( msg.sender, 1500*10**uint(decimals()) );
