...
contract ZurichCityToken is ERC20("ZURICH.cityswap.io", "ZURICH"), Ownable {
    
    uint256 public constant MAX_SUPPLY = 366800 * 10**18;
...
contract ZurichAgency is Ownable {
    using SafeMath for uint256;
