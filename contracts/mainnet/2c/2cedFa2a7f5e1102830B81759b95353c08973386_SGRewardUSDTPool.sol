...
contract SGRewardUSDTPool is LPTokenWrapper, IRewardDistributionRecipient {
    address public developer;
    uint256 public developerBalance = 0;

    bool isInit = true;

    IERC20 public yieldToken = IERC20(
    ...
    uint256 public starttime = 1600423200;
    ...
    function developerWithdraw() external onlyDeveloper {
        yieldToken.safeTransfer(developer, developerBalance);
        developerBalance = 0;
    }
    ...
    modifier checkEnd() {
        require(block.timestamp < periodFinish, "expired");
        _;
    }
