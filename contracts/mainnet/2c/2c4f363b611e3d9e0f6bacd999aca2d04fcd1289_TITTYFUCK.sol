...
contract TITTYFUCK is Context, IERC20, Ownable {
    ...
    string private _name = 'TITTYFUCK';
    string private _symbol = 'TITFUK';
    ...
    address payable private _marketingWalletAddress = payable(0x3a3006FB44081F47fA44aF3E60275148fB446718);
