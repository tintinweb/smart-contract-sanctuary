...
contract OneYear is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 private _maxMint = 5;
    uint256 private _price = 25 * 10**16; //0.25 ETH;
    bool public _paused = false;
    uint public constant MAX_ENTRIES = 366;

    constructor() ERC721("One Year", "YEAR")  {
        setBaseURI("https://api.oneyear.app/");
    }
