...
// File: contracts/FreddieToken.sol

/*
 * FreddieToken is a standard ERC20 token with some additional functionalities:
...
contract FreddieToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "FREDDIE";
	string public constant name = "FREDDIE CHAIN";
	...
	*/
	function FreddieToken(address admin) public {
	...
	* @param value Amount of freddietokens to send
	*/
