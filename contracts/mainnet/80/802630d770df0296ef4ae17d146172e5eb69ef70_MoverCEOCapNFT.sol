...
contract MoverCEOCapNFT is Context, Ownable, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    ...
    function mint(address to) public virtual {
        ...
        require(totalClaimed < CLAIM_LIMIT, "claim limit reached");
