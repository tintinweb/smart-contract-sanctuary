...
contract wowQToken is TimeLockToken, FreezableToken, PausableToken, BurnableToken {
    string public constant name = "wowbio Coin";
    string public constant symbol = "wowQ";
