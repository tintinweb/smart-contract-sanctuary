...
// File contracts/Tigers.sol

// SPDX-License-Identifier: MIT

/*
Degenerate Tiger Country Club... come golf with the big boys.
*/
...
contract Tigers is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Degenerate Tiger Country Club", "DTCC") {
    }
    ...
    function reserveTokens() public onlyOwner {
        ...
        require(supply < 300, "More than 300 tokens have already been reserved or minted.");
        uint i;
        for (i = 0; i < 100; i++) {
