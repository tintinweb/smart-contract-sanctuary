...
contract IDF is ERC20, ERC20Detailed, ERC20Mintable, ERC20Capped, ERC20Pausable, ERC20Burnable  {
    uint256 public constant INITIAL_SUPPLY = 24000 * 1000000000000000000;
    uint256 public constant CAP = 2400000 * 1000000000000000000;

    constructor() public
        ERC20Detailed("Islamic Digital Finance", "IDF", 18)
        ERC20Capped(CAP)
        { 
