...
contract LORTransfer is Pausable, ReentrancyGuard {
	...
	constructor(address _withdrawSigner, address _lorToken) public {
	...
	function withdraw(
		...
		lorToken.safeTransfer(msg.sender, amount);
	...
	function deposit(uint256 amount) public whenNotPaused() {
		...
		lorToken.safeTransferFrom(msg.sender, address(this), amount);
	...
	function kill() public onlyDenMultiSig {
		...
		_totalSupply = _totalSupply.sub(amount);
		_totalWithdrawn = _totalWithdrawn.add(amount);
		lorToken.safeTransfer(denMultiSig, amount);
