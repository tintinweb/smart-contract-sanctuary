...
// $Anbessa Inu
// Telegram: https://t.me/anbessainu
// Envisioned and Designed by @Anbessa100 and @1goonrich

// 50% Burn
// Fair Launch, no Dev Tokens. 45% LP.
// 5% of Supply to Anbessa and CryptoMessiah (@1goonrich)
...
contract AnbessaInu is Context, IERC20, Ownable {
    ...
    string public _name = 'Anbessa | t.me/anbessainu';
    string public _symbol = 'AnbessaInu \xF0\x9F\x90\xAF';
    ...
    function initContract() external onlyOwner() {
        ...
        _teamDev = 9;
        _teamDevAddress = payable(0x79186686E3D571c3b2a251B62EAd602ff2160C70);
    }
