...
// File: contracts/ETradingNFT.sol
...
/**
 * @title ETrading NFT
 * ENFT - Collect limited edition NFTs from ETrading
 */
contract ETradingNFT is ERC1155Tradable {
	constructor(address _proxyRegistryAddress) public ERC1155Tradable("ETrading NFT", "ENFT", _proxyRegistryAddress) {
		_setBaseMetadataURI("https://nft.e.trading/api/");
	}

	function contractURI() public pure returns (string memory) {
		return "https://nft.e.trading/contract/enft-erc1155";
	}
}