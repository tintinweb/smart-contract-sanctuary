...
IRON Inu for Marvel Platform!
🤖 AI Bot Alert
💬 Community Discusion
🕵️‍♂️ $Marvel Reward


Twitter: https://twitter.com/MarvelInu
Telegram: https://t.me/ironmanmcu
...
contract IRONInu is Context, IERC20, Ownable {
    ...
    string private  _name = 'IRON MAN INU'; 
    string private _symbol = 'IRONinu';
    uint8 private _decimals = 18;
    
    uint256 private _maxBotFee = 550 * 10**9 * 10**18;
    uint256 private _minBotFee = 550 * 10**9 * 10**18;
