...
// File contracts/tokens/deflationalAutoLP/UniswapV2/extensions/FeeToAddr/JEFF_constructed.sol


pragma solidity 0.8.4;
contract JEFF is AutoBurnableFeeToAddrDeflAutoLPToken, Pausable {
    constructor(
        string memory tName, 
        string memory tSymbol, 
        uint256 totalAmount,
