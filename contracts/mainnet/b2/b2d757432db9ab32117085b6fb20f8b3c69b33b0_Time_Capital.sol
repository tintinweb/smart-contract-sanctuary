...
Capital Investing in Time 
 
 https://t.me/Time_Capital
...
contract Time_Capital is Context, IERC20, Ownable {
    ...
    string private constant _name = "Time Capital";
    string private constant _symbol = "TIMEC";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xc364f680e5079FF1aB883BF7f09055AaCADA832c);
        _feeAddrWallet2 = payable(0xc364f680e5079FF1aB883BF7f09055AaCADA832c);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xc364f680e5079FF1aB883BF7f09055AaCADA832c), _msgSender(), _tTotal);
    }
