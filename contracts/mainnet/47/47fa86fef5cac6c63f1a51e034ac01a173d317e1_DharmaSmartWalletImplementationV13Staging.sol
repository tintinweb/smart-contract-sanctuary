...
/**
 * @title DharmaSmartWalletImplementationV13 (staging version)
 * @author 0age
 * @notice The V13 implementation for the Dharma smart wallet is a non-custodial,
 ...
 * smart wallet instance. V13 deprecates automatic dToken conversion.
 */
contract DharmaSmartWalletImplementationV13Staging is
  ...
  uint256 internal constant _DHARMA_SMART_WALLET_VERSION = 1013;

  // DharmaKeyRegistryV2Staging holds a public key for verifying meta-transactions.
  ...
  // controlled by Dharma and implementing appropriate timelocks. (staging version)
  ...
  function escape() external {
    ...
    _transferMax(_CDAI, msg.sender, true);

    // Attempt to transfer any residual cUSDC to the caller.
    _transferMax(_CUSDC, msg.sender, true);
