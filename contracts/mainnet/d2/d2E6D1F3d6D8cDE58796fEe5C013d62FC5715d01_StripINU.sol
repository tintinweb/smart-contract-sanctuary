...
contract StripINU is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public marketingAddress =
    payable(0x5eD2b122f00ecE2d53E9440820eF960C138eCDbC);
  ...
  string private _name = 'StripINU';
  string private _symbol = 'STRIP';
