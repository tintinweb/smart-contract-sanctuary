...
contract ShibculesInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 89000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "Shibcules";
    ...
    uint256 public numTokensSellToAddToLiquidity = 890000000000000000000 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 89000000, "Max Tx Amount cannot be less than 89 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 89000000, "Swap Threshold Amount cannot be less than 89 Million");
