...
contract JungleFreaks is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address kingAndQueenWallet = 0xeE412c8Fb245363AcE4e7212BDB6c3c2163bB6bc;
    ...
    function withdraw() public onlyOwner {
        ...
        payable(princeWallet).transfer((balance * 355) / 1000);
        payable(kingAndQueenWallet).transfer((balance * 355) / 1000);
