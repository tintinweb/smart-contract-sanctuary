...
// Join the Shar Pei Pup community via t.me/SharPeiPup
// Visit my site
// And please promote
// 
// Fair launch, locked within minutes, no team or dev tokens issued. 5% tax
// Join us and catch the next ride to the moon!
//
 */
...
contract SharPeiPup is Context, IBEP20, Ownable {
    ...
    string  private constant     _NAME = 'Shar Pei Pup';
    string  private constant   _SYMBOL = 'SharPeiPup';
    ...
    uint256 private constant   _Charity_FEE = 550; 
