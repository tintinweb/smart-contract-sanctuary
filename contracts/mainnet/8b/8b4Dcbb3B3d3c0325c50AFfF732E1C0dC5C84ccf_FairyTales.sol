...
// File: Tales/interfaces/IFairyTalesMetadata.sol


pragma solidity ^0.8.0;

interface IFairyTalesMetadata {
...
// File: Tales/interfaces/IFairyTales.sol


pragma solidity ^0.8.0;

interface IFairyTales {
...
// File: Tales/FairyTales/FairyTales.sol
...
contract FairyTales is ERC721Enumerable, Ownable, IFairyTales, IFairyTalesMetadata {
  ...
  */
  ...
  function gift(address[] calldata to) external override onlyOwner {
    require(totalSupply() < FTAlE_MAX, 'All tokens have been minted');
    require(totalGiftSupply + to.length <= FTAlE_GIFT, 'Not enough tokens left to gift');
