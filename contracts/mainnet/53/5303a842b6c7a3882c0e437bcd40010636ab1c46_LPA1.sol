...
contract LPA1 is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateLPA1(uint256 indexed id);
	
    constructor(string memory baseURI, uint256 maxNFT, uint256 maxByMint, uint256 GiveawayNFT, uint256 Price) ERC721("Lionshare Poker Academy", "LPA1") {
        MAX_NFT = maxNFT;
