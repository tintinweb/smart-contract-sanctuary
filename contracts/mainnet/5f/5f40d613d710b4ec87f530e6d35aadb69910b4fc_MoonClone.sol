...
/**
* * 
* In the depths of Elon's lab in the wee hours of the night he finally cracked the code. ELon cloned Moon! 
* Now better, stronger and faster, his Moon Clone is taking over Ehterum and is increasing his wealth every second.
* Tokenomics at launch :
* Total Supply : 15 Billion
* Max Buy: 1.5 Billion (~10 % of Total Supply)
* Max Hold: 1.5 Billion (~10 % of Total Supply)
*
* Standard burn : (6% LP, 2% Redistribution)
* Sell within 12h : (30% LP, 10% Redistribution)
* Sell within 1D : (24% LP, 8% Redistribution)
* Sell within 3D : (18% LP, 6% Redistribution)
* Sell within 7D : (12% LP, 4% Redistribution)
* 
* Website : https://ethmoonclone.com
* Tg : https://t.me/ethmoonclone
* 
* 
...
contract MoonClone is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 15 * 10**8 * 10**9; // Max Transaction: 1.5B (10%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 15 * 10**8 * 10**9; // Max Transaction: 1.5B (10%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

     string private _name = "EthMoonClone.com";
    string private _symbol = "MClone";
