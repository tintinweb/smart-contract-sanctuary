...
contract OSSToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "Object Storage Service";
    string public constant symbol = "OSS";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 210000 * (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 210000 * (10 ** uint256(decimals));

    function OSSToken() public CappedToken(TOKEN_CAP) {
