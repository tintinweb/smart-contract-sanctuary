...
/* 
** FX Capital
** Blockchain Meets Artificial Intelligence Software Trading
** Self Sustaining Eth Rewards
** Website : https://fxctoken.com/
** Whitepaper : https://fxctoken.com/pdfs/FXCWhitepaper.pdf
** Telegram : https://t.me/fxcapitaltoken
*/
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a FXC shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract FXC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "FX Capital";
    string private constant _symbol = "FXC";
    ...
    address payable public marketingWallet = payable(0x899F4950cDda8fE2bbC42Fa98fafc51387492587);
    address payable public treasury = payable(0xF2173Aa3C80C9A1b2F96c4dA451A97aBFCa6E22e);
    ...
    bool private inSwap;
    bool private _swapForEthEnabled=true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(shouldSwapBack && _swapForEthEnabled){ swapBack(); }
    ...
    function setTreasurySwapEnabled(bool enabled) external onlyOwner {
        _swapForEthEnabled = enabled;
    }
