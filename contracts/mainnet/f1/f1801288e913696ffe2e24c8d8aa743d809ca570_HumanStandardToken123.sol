...
contract HumanStandardToken123 is StandardToken { 
    ...
    function HumanStandardToken123(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
