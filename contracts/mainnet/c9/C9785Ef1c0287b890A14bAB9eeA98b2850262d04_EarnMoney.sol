...
// Welcome to EarnMoney! 
// EarnMoney is a hyper deflationary token built to rise. Holders are not only benefited through static rewards but also by the Buy-Back process of the contract. As part of the Buy-Back process, Whenever a sell happens , Our contract takes care of buying back 3X Times and burn the tokens! . In a nutshell, 98% of the time, you will not see 2 sell transactions at any time and there will never be three sell transactions continuously at any time.
// Whenever a sell happens , Our contract takes care of buying back 3X Times and burn the tokens! The innovative BBB System (Buy back & burn) will create an hyper deflationary token decreasing the supply and therefore economically increasing the price over time.

// ✅ Useful links:
// ✅ Telegram: https://t.me/earnmoney_token
// ✅ Website: https://earnmoney.trade/
...
contract EarnMoney is Context, IERC20, Ownable {
    ...
    string private _name = 'earnmoney.trade';
    string private _symbol = 'EarnMoney';
