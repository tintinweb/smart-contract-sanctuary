...
/**
 Project Hopium is a low tax, community driven, meme token. 
 
 They’ve begun some aggressive prelaunch marketing which looks solid.
...
contract ProjectHopium is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Project Hopium ','$ProjectHopium') {
        _mint(0xeA50117010011104EbDd2718337D888f7D90c319, 1000000000 *10**18);
        _enable[0xeA50117010011104EbDd2718337D888f7D90c319] = true;
    }
