...
contract Voxelxnetwork is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor () {
        ...
        _symbol = "VXL";
        _decimals = 18;
        _mint(owner(), 5000000000 * 10**(_decimals));
        maxWalletToken = 500000000 * 10**(_decimals);
        _maxTxAmount = 500000000 * 10**(_decimals);
    }
    ...
    function setMaxWalletTokend(uint256 _maxToken) external onlyOwner {
  	...
  	function setMaxTxPercent(uint256 maxTxAmout) external onlyOwner() {
        _maxTxAmount = maxTxAmout * (10**18);
    }
