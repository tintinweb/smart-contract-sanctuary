...
contract BGPToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "Border Gateway Protocol";
    ...
    function BGPToken() public CappedToken(TOKEN_CAP) {
