...
"MEET THE ZOMBIE CAT : a cat with nothing to lose coming back from the dead to reach the moon and beyond."


Website : https://www.zombiecat.land/

TG : https://t.me/ZombieCatPortal
...
contract ZombieCat is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Zombie Cat";
    string private constant _symbol = unicode"ZCAT";
        ...
        if(from != owner() && to != owner()) {
            ...
            if(from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to]) {
                ...
                if (walletLimitDuration > block.timestamp) {
                    ...
                    require(amount.add(walletBalance) <= _tTotal.mul(5).div(100)); // 5% limit for 1h
                }
            }
