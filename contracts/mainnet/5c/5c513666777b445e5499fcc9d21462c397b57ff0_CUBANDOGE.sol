...
$$ |  $$\ $$ |  $$ |$$ |  $$ |$$  __$$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$   ____|
\$$$$$$  |\$$$$$$  |$$$$$$$  |\$$$$$$$ |$$ |  $$ |$$$$$$$  |\$$$$$$  |\$$$$$$$ |\$$$$$$$\ 
 \______/  \______/ \_______/  \_______|\__|  \__|\_______/  \______/  \____$$ | \_______|
                                                                      $$\   $$ |          
                                                                      \$$$$$$  |          
                                                                       \______/           
...
contract CUBANDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xF1E1Bd4079960A1510b0433Ff86601071FFdBa6a); // Marketing Address
    address payable public satoshiAddress = payable(0x16DF707f3D64a901752e91B1Df5E8ea4133F4f79); // Animal House Address
    ...
    string private _name = "CubanDoge";
    string private _symbol = "CUBAN";
    ...
    uint256 public satoshiDivisor = 1;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(satoshiAddress, transferredBalance.div(_liquidityFee).mul(satoshiDivisor));
    ...
    function setSatoshiAddress(address _satoshiAddress) external onlyOwner() {
        satoshiAddress = payable(_satoshiAddress);
    }
