...
/**
  _____                     _             _____             
  \_   \___  ___  _ __ ___ | | ___   _    \_   \_ __  _   _ 
   / /\/ __|/ _ \| '__/ _ \| |/ / | | |    / /\/ '_ \| | | |
/\/ /_ \__ \ (_) | | | (_) |   <| |_| | /\/ /_ | | | | |_| |
\____/ |___/\___/|_|  \___/|_|\_\\__,_| \____/ |_| |_|\__,_|
...
contract ISINU is Context, IERC20, Ownable {
  ...
  string private _name = 'Isoroku Inu';
  string private _symbol = 'ISINU';
