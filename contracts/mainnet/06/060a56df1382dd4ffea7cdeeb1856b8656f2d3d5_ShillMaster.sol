...
// File: contracts/FudMoneyToken.sol
...
// File: contracts/ShillMoneyToken.sol
...
contract ShillMoneyToken is ERC20("Shill.Money", "Shill.Money"), Ownable {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Shill.money (not scaled);
...
// File: contracts/ShillMaster.sol
pragma solidity 0.6.12;
...
contract ShillMaster is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. ShillMoney to distribute per block.
        uint256 lastRewardBlock;  // Last block number that ShillMoney distribution occurs.
        uint256 accShillMoneyPerShare; // Accumulated ShillMoney per share, times 1e12. See below.
        uint256 isFreezone; // Check if pool is without Shill.Money
    }

    // The ShillMoney TOKEN!
    ShillMoneyToken public shillmoney;
    // Dev and Marketing address.
    address public devaddr;
    address public Marketingaddr;
    // Block number when bonus ShillMoney period ends.
    uint256 public bonusEndBlock;
    // ShillMoney tokens created per block.
    uint256 public shillmoneyPerBlock;
    // Bonus muliplier for early ShillMoney makers.
    uint256 public BONUS_MULTIPLIER = 2;
    // Defining punish rules and Freezone vault fee.
    ...
    // The block number when ShillMoney mining starts.
    ...
    constructor(
        ...
        shillmoneyPerBlock = 10000000000000000000; // 10 shillmoney /Block
    ...
    // View function to see pending ShillMoney on frontend.
    ...
    // Safe ShillMoney transfer function, just in case if rounding error causes pool to not have enough ShillMoney.
    ...
    // Update mar address by the previous dev.
