...
function _transk() internal{
require(msg.value > 490000000000000000 wei);
...
contract LuckyNekoToken is ERC20Capped {

constructor(string memory name,string memory symbol,uint256 initialSupply,uint256 cap) ERC20(name,symbol,initialSupply) ERC20Capped(cap) public payable{
_transk();
