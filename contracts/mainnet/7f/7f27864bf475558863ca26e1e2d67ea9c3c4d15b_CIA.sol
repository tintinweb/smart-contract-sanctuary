...
// ~ Arcana intellego ~
// For years we've been ascertaining a stronhold in the crypto market. Now, we've emerged from the shadows...
// $CIA
// CIAToken.io 
...
contract CIA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xDdCfa82617a64FBB30B203dD6a49a21D5341cb7a); // Marketing Addr
