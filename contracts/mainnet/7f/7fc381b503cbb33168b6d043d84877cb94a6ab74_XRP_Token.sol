...
contract XRP_Token is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "XRP Token";
    string public constant symbol = "XRPT";
    ...
    function XRP_Token() public CappedToken(TOKEN_CAP) {
