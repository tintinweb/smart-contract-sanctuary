...
contract AnimeOne  is Context, IERC20, Ownable {
    ...
    string private _name = "Anime One ";
    string private _symbol = "ANIMEONE";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 12;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 2; //(3% liquidityAddition + 2% rewardsDistribution + 3% devExpenses)
    ...
    // limit
    uint256 public _maxTxAmount = 81594900000000 *  10**9; //1.5% after 50% burn
