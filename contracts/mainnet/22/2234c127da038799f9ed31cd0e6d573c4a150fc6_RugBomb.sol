...
contract RugBomb is Context, IERC20{
    ...
    string private _name = "RugBomb II";
    string private _symbol = "RUGBOMB2";
    ...
    constructor() {
        _epoch = 0;
        _epochTimestamp[0] = 1630771200;
        _epochTimestamp[1] = 1630774800;
        _epochTimestamp[2] = 1630778400;
        _epochTimestamp[3] = 1630782000;
        _epochTimestamp[4] = 1630785600;
        _epochTimestamp[5] = 1630789200;
        _epochTax[0] = 5;
        _epochTax[1] = 2;
        _epochTax[2] = 0;
        _epochTax[3] = 2;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (sender != _lpWallet && recipient != _lpWallet && recipient != _uniRouter)
        {
            ...
            require (amount <= (_totalSupply * 5 / 1000) || block.timestamp > 1630772100);
        }
