...
contract CubanDoge is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Cuban Doge';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x267567890CAB5795B98B30c5C24dFB9C803838E1, 'We can not exclude Uniswap router.');
    ...
    function setAsCharityAccount(address account) external onlyOwner() {
        require(account != 0x0A3C12F2872c2A41E7B628Dad16BaeF53cbD5096, 'The Uniswap router can not be the charity account.');
