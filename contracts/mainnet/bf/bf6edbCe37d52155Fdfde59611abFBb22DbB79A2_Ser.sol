...
contract Ser is Context, IERC20, Ownable {
    ...
    string private _name = "hello $SER";
    ...
    uint256 public _liquidityFee = 7; //(4% liquidityAddition + 2% rewardsDistribution + 2% devExpenses)
    ...
    uint256 private minTokensBeforeSwap = 7;
    ...
    constructor () public {
        ...
        wallet = payable(0xF0336aC0FB674ac0b718A0f5d41E7C65e6828A7d);
        rewardsWallet = payable(0xF0336aC0FB674ac0b718A0f5d41E7C65e6828A7d);
    ...
    // @dev set Reward Wallet
    function setRewardWallet(address payable newWallet) external onlyOwner {
        wallet = newWallet;
