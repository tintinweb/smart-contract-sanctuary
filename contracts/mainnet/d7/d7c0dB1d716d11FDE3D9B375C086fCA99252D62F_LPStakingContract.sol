...
contract LPStakingContract is Roles {
    ...
    constructor(address _fightToken, address _lpToken) public {
        ...
        notPaused
    {
        require(
            _amount >= minStake,
            "You need to stake at least the min lp"
        );
