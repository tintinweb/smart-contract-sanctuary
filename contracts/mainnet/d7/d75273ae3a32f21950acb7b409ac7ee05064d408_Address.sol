...
contract Loot2000 is ERC721Enumerable, ReentrancyGuard, Ownable {

    ERC721 y2kloot = ERC721(0xFF9C1b15B16263C61d017ee9F65C50e4AE0113D7);
    ...
    string[] private superpower = [
        ...
        "Girlfriend Who Takes Mushrooms With You",
        "Crushed Pack of Smokes",
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[5] = getTransportation(tokenId);

        parts[6] = '</text><text x="10" y="80" class="base">';

        parts[7] = getAccessory(tokenId);
    ...
    function claimForLoot(uint256 tokenId) public nonReentrant {
        ...
        require(y2kloot.ownerOf(tokenId) == msg.sender, "Not Loot owner");
        _safeMint(_msgSender(), tokenId);
    }  
    ...
    constructor() ERC721("Loot 2000", "Y2KLOOT") Ownable() {}
}
