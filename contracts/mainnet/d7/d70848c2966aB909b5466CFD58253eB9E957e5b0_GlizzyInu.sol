...
contract GlizzyInu is IERC20, Context, ERC20Ownable {
    ...
    string private constant _nomenclature = "GLIZZY INU";
    string private constant _ticker = "GLIZZY";
    uint8 private constant _decis = 18;
    ...
    constructor() {
        ...
        feeWallet = payable(0xD429daC27CeFCC74FA6eC20866DA903E0907F966);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_limitBuys == true && from == pcsV2Pair) {
			require(amount <= 5000000000 * 10**18, "Limits are in place, please lower buying amount");
		}
