...
🔥 Pug Of Wall Street 🔥 $POWS 
   _______    ______    __   __  ___   ________  
  |   __ "\  /    " \  |"  |/  \|  "| /"       ) 
  (. |__) :)// ____  \ |'  /    \:  |(:   \___/  
  |:  ____//  /    ) :)|: /'        | \___  \    
  (|  /   (: (____/ //  \//  /\'    |  __/  \\   
...
Launch: 20th January @ 11pm UTC

Website: www.pugofwallstreet.com
Telegram: @PugOfWallstreet

We are introducing a unique crypto utility that will give every single n00b 
a trading advantage in the DeFi realm. The pug of wall street will give you an 
automated trading tool that will allow you to trade like your favorite whale. 

More information and demos in our Telegram group.
...
contract PugOfWallStreet is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal/125; 
    uint256 public maxTxAmountSell = _tTotal/250; 
    ...
    string private constant _name = "Pug Of Wall Street";
