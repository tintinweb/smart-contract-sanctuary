...
contract uStakedEth {
    ...
    function mint(address dst, uint rawAmount) external {
        ...
        emit Transfer(address(0), dst, amount);
         ...
         /**
     * @notice Burn tokens
     * @param src The address of the origin account
     * @param rawAmount The number of tokens to be minted
     */
    ...
    function burn(address src, uint rawAmount) external {
        ...
        // transfer the amount to the recipient
        balances[src] = sub96(balances[src], amount, "Uni::burn: transfer amount overflows");
...
contract uPool is Ownable, ReentrancyGuard {
    ...
    using SafeMath for uint;
     /* ========== STATE VARIABLES ========== */
    address public depositContractAddress = 0x8c5fecdC472E27Bc447696F431E425D02dd46a8c;
