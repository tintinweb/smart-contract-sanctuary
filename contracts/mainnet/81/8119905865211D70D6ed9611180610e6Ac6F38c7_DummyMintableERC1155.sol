    ...
    IMintableERC1155
{
    ...
    constructor(string memory _name, string memory _symbol, string memory contractUri_, string memory uri_) public ERC1155(uri_) {
        name = _name;
        symbol = _symbol;
    ...
    function setContractURI(string calldata _contractUri) external only(DEFAULT_ADMIN_ROLE) {
        cUri = _contractUri;
    }
