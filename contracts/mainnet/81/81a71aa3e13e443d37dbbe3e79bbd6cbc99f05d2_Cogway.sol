...
contract Cogway is ERC20,Ownable,ReentrancyGuard{

    using SafeMath for uint;
    address private donationWallet=0x407Fc8F547aa5F9f89DD6130E7EecC252B12C581;
    address private liquidityWallet=0x407Fc8F547aa5F9f89DD6130E7EecC252B12C581;
    /**
    ...
    //1000000000000000000000000000000 1 Trillion Token
    //1000000000000000000000000000 1 Billion Tokens
    uint256 donationFee=0; //100 is 1 percent, 50 is 0.5 percent and 125 is 1.25 percent
    ...
    function collectFee(uint256 amount) internal returns (uint256){
        ...
        uint256 tokensToTransfer = amount.sub(burnAmount);
    ...
    function transferFromWithFee(address recipient, uint256 amount) public nonReentrant returns (bool) {
