...
contract FriezaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Frieza Inu";
    ...
    address payable private _marketingAddress = payable(0xD293AE87937f46ad60F57E6dEc75Ce41b6b4E0FE);
