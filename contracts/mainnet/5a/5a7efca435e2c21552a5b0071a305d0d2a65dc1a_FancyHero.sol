...
📘 Information:
FancyHero is born to be a strategy game where it is combined the distinctive elements of Idle RPG and the tactics of auto chess, connected with blockchain technology. 
With the advantage of the Non-Fungible Token (NFT) characteristic to create characters and items and Play-2-Earn elements, users will be able to earn a good income through DeFi integrations, 
it is so-called Play to earn, with fun.
Moreover, the game is developed on Unity engine with modern gameplay and cutting-edge graphics, secluding it from the rest. 
Simultaneously with a system of mutual and contrasting characters, FancyHero easily won the hearts of players not only through different tactics but also through many game modes.
With FancyHero, players will collect and upgrade heroes, gears, and tools from different tournaments and types. 
Each hero has its own abilities and characteristics. At the same time, players constantly increase the power of the heroes, participate in PVE, PVP battles and earn rewards.
Each hero and gear is backed by a unique NFT built on the ERC-20 standard.


🔥 Social links:
Website: https://fancyhero.io/
TG Ann Channel: https://t.me/FancyHero_ETH
TG Chat: https://t.me/FancyHero
LaunchApp: https://fancyhero.io/launch-app.html
...
contract FancyHeroEth is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , FancyHeroEth{
...
contract FancyHero is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10 ** 18;

    constructor () ERC20('FancyHero', unicode'FHT') {
