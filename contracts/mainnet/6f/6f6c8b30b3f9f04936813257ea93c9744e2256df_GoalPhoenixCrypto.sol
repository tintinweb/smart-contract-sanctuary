...
contract GoalPhoenixCrypto is ERC20 {

    constructor () ERC20("Goal Phoenix Crypto", "GPC") {
        _mint(msg.sender, 23000000000000 * (10 ** uint256(decimals())));
    }
    // @dev By default, ERC20 uses a value of 18 for decimals.
    // @param bypass, To use a different value, 
    // you will need to override the decimals() function in your contract.
