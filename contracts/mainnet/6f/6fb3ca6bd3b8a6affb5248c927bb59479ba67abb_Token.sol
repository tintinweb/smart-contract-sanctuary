...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _taxFee; //SET TO PRIVATE
    uint256 private _provisionsFee; //SET TO PRIVATE
    uint256 private _burnFee; //SET TO PRIVATE
    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousProvisionsFee = _provisionsFee;
    uint256 private _previousBurnFee = _burnFee;

    address payable public _provisionsWallet;
    ...
    constructor (
        ...
        emit Transfer(address(0), reqOwner, _tTotal);
    }
