...
contract TastyDip is Context, IERC20, Ownable {
    ...
    string private constant _name = "TastyDip";
    string private constant _symbol = unicode'TastyDip 👅';
