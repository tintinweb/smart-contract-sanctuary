...
// First NFT dickpic marketplace token.
// Dickpics are one of the most common pictures in the world so it would only make sense to have an NFT marketplace for them. 
// That's where Big Cock Inu cums in.
// Liqudity Locked after launch
// Website in development: BigDickInu.art
...
contract BCINU is Context, IERC20 {
