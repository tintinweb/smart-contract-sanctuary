 ...
 */
contract CryptoBuds is Context, Ownable, ERC165, ICryptoBuds, IERC721Metadata {
    ...
    // This is the provenance record of all Cryptobuds artwork in existence
    string public constant Cryptobuds_PROVENANCE = "3109bd92478cf7f73814afa2e73246623a36541fff04be2f0f50ed1c98da2d19";

    uint256 public constant SALE_START_TIMESTAMP = 1616205600; // March 19 2021 9p EST.

    // Time after which hash masks are randomized and allotted (21 days)
    ...
    // Mapping from token ID to whether the Cryptobud was minted before reveal
    ...
    constructor () {
        _name = "CryptoBuds";
        _symbol = "CBUDS";
        _baseTokenUri = "https://thecryptobuds.com/api/tokens/"; // api url
