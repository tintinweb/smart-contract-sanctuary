...
*
* Name: ibDFD (0x08cA5E242486931B63811C370b5da1a1f31690e4)
*
    ...
    */
    ...
    function migrate() external {
        ...
        uint r = balance()
            ...
            .div(totalSupply());
        _burn(msg.sender, _shares);
        address _stakingV2 = stakingV2();
        dfd.safeApprove(_stakingV2, r);
        IStakingV2(_stakingV2).stakeFor(r, msg.sender);
        emit Withdrawn(msg.sender, r);
    }

    /* ##### Admin ##### */

    function setStakingV2(address _stakingV2) external onlyOwner {
        setStore(0, uint(_stakingV2));
        require(address(getStore(0)) == _stakingV2, "Sanity check failed");
    }

    /* ##### View ##### */

    function stakingV2() public view returns(address) {
