...
contract ERC20Base is ERC20Capped, ERC20Burnable, ERC1363, Roles, TokenRecover {
    ...
    /**
     * @dev Emitted during transfer disabling
     */
     ...
     * See {ERC20-_burn}.
     */
    function burn(uint256 amount) public virtual override(ERC20Burnable) canTransfer(_msgSender()){
        super.burn(amount);
    }
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount) public virtual override(ERC20Burnable) canTransfer(account){
     ...
     * - `spender` cannot be the zero address.
     */
    function approve(address spender, uint256 amount) public virtual override canTransfer(spender) returns (bool) {
