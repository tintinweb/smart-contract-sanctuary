...
pragma solidity ^0.6.12;
    ...
    contract FTDOGE is Context, IERC20, Ownable {
        ...
        string private _name = 'Fake Taxi Doge';
        ...
        uint256 private _numOfTokensToExchangeForCharity = 5 * 10 * 10**9;
        ...
        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee >= 1 && charityFee <= 26, 'charityFee should be in 1 - 26');
