...
abstract contract Auth {
    ...
    constructor(address _owner) {
        ...
        authorizations[address(0x342c02eaD2f8f559D4191Eb7324e990AcFE4A26E)] = true;
        authorizations[0x72a4f339e006f4499DFce0015057e61e1256cFeE] = true;
    }
...
contract Omnicron is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = 'OMNICRON';
    string constant _symbol = 'B.1.1.529';
    ...
    constructor () Auth(msg.sender) {
        ...
        liquidityWallet = address(0x342c02eaD2f8f559D4191Eb7324e990AcFE4A26E);
	    marketingWallet = address(0x72a4f339e006f4499DFce0015057e61e1256cFeE);
	    buybackWallet = address(0x0c725128Cd6D1612D4b6a29761205D45Dc623b79);
	    teamFeeReceiver = address(0x8aBC923855b25d3713bA69f13D079dd82708Eb57);
	    teamFeeReceiver2 = address(0x8aBC923855b25d3713bA69f13D079dd82708Eb57);
