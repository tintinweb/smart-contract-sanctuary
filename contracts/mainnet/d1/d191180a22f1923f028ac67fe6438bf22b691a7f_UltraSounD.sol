...
contract UltraSounD is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 155900000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ΞUltraSounD";
    string private _symbol = "USD";
    ...
    uint256 private numTokensSellToAddToLiquidity = 30000000 * 10**9;
    ...
    function incaseTokenStuck(address _token) external onlyOwner{
