...
/*****
miniShinji Inu ($miniSHINJI)
Elon Musk showing his support https://twitter.com/elonmusk/status/1483717933700366336
We are part of the original Shinji Inu Team who have broken off to make miniShinji a possiblity
***/
...
contract miniSHINJI is Context, IERC20, Ownable {
   ...
   constructor() {
        _name = "mini Shinji Inu";
        _symbol = "miniSHINJI";
        _decimals = 18;
        _totalSupply = 69000000000000000000000 * 1e18;
        ...
        emit Transfer(address(0x1F31DD60b84ea2a273cfC56876437E069aE80afd), owner(), _totalSupply.mul(1000).div(1e3));
