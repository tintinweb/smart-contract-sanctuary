...
contract blackholeswap is ERC20Mintable {
    ...
    IERC20 constant token0 = ERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); //USDC
    IERC20 constant token1 = ERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7); //USDT
    ...
    constructor() public {
        symbol = "BHS USDC/USDT";
        name = "BlackHoleSwap USDC/USDT";
        decimals = 6;
        admin = msg.sender;
        vault = msg.sender;
    }
