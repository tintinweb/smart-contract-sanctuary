...
contract PeekingPunks is ERC721Enumerable, Ownable, ReentrancyGuard {
  using SafeMath for uint256;
  
  bool public saleIsActive = false;
  uint256 public constant tokenPrice = 20000000000000000;
  uint public constant maxTokenPurchase = 36;
  ...
  constructor() ERC721("Peeking Punks", "PEEKPUNK") {
    setBaseURI("https://blam.io/api/0dc53b62-3fec-4c3c-b850-13610614ff10/token/");
  ...
  function mintToken(uint numberOfTokens) public payable nonReentrant {
    ...
    require(mintedCount[msg.sender].add(numberOfTokens) < maxTokenPurchase, "You can't mint any more.");
    ...
    mintedCount[msg.sender] += numberOfTokens;
  }
