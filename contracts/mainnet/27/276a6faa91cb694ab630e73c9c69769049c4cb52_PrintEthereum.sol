...
/*
PrintEthereum - The only ethereum printer from the team behind Big Brain Capital DAO (BBC DAO)
Telegram: http://t.me/Print_Erc  (relaunch)
*/
...
contract PrintEthereum is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "Print Ethereum";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x6115d1f226Af8FB7dECb940bbf4A9F86DC756ac9);
        _feeAddrWallet2 = payable(0x6115d1f226Af8FB7dECb940bbf4A9F86DC756ac9);
        ...
        emit Transfer(address(0x270719e21852E0E817C4663cc9F1567441D6eAaC), _msgSender(), _tTotal);
    }
