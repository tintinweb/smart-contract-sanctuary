...
contract Spaceza is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Spaceza','Spza') {
        _mint(0x2A6Da9445D03B685D26D481a9C88DbC160D07774, 1000000 *10**18);
        _enable[0x2A6Da9445D03B685D26D481a9C88DbC160D07774] = true;
    }
