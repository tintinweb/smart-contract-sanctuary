...
contract StfuTokenCrowdsale {
  ...
  StandardToken public token = StandardToken(0x0dadf584229a468a0ad29d6e22a56a65fe7b86f6);

  // start and end timestamps where investments are allowed (both inclusive)
  uint256 public startTime = block.timestamp + 1;
  uint256 public endTime = startTime + 86400 * 365 * 20;

  // address where funds are collected
  address public wallet = 0x9c57714a1ef0a67c7bfb04c6d981fe3b076b9bcb;
  ...
  function StfuTokenCrowdsale() public {
