...
contract GMDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "GM Doge";
    string private constant _symbol = "GMDOGE";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x7212d61612475A4f6e64D5465DE67F4112C0255e);
        _feeAddrWallet2 = payable(0xE2Dc4b12d988FFE071602846B54D21d76C8DE719);
