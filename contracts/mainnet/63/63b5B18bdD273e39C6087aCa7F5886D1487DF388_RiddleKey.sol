...
contract RiddleKey is ERC1155, Ownable, MinterRole {
	...
	constructor() public ERC1155('https://riddle-backend.herokuapp.com/nfts/') {
	...
	*/
	...
	function uri(uint256 tokenId) external view override returns (string memory) {
		return string(abi.encodePacked('https://riddle-backend.herokuapp.com/nfts/', toString(tokenId)));
	}
	/**
