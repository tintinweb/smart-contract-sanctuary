...
// ECL Token with Governance.
contract ECL is ERC20("eclypse.finance", "ECL"), Ownable {
    uint256 private _cap = 10000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "ECL::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ECL::delegateBySig: invalid nonce");
        require(now <= expiry, "ECL::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ECL::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ECL::_writeCheckpoint: block number exceeds 32 bits");
