...
contract SquidRaffle is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    address payable private donator;
    uint256 public roundWinnerBonus = 100000; //Squid ERC20 token bonus per round winner
    ...
    mapping(uint => RoundWinner) public winners; // roundId => Winner
    ...
    mapping(uint => SquidBonus) public squidPrizes; // tokenId -> squid erc20 bonus paid to
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        require(picked, 'Callback funcion failed');
    }
    ...
    function requestRoundWinner(uint8 _roundId) public {
    ...
    function withdraw() external onlyOwner { 
        require(ethPayDone == true || ethWithdrawTime < block.timestamp, 'waiting time');
    ...
    function withdrawSquid() external onlyOwner {
        require(ethWithdrawTime + 30 days < block.timestamp, 'waiting time');
