...
contract Leafty is Context, IERC20 {
        ...
        */
        ...
        uint256 private _maxTxAmount = 2100000000 * 10**9;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeForCharity = 5 * 10**5 * 10**9;
        ...
        constructor (address payable charityWalletAddress, address payable owner) public {
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 2100000000e9 , 'maxTxAmount should be greater than 2100000000e9');
