...
// File: contracts\farming\FarmMainRegular.sol
...
contract FarmMainRegular is IFarmMainRegular {
    ...
    function _withdrawReward(uint256 positionId, uint128 liquidityToRemove) private {
        ...
        _retrieveGen2LiquidityAndFees(positionId, farmingPosition.tokenId, farmingPosition.uniqueOwner, liquidityToRemove);
    ...
    function _retrieveGen2LiquidityAndFees(uint256 positionId, uint256 tokenId, address recipient, uint128 liquidityToRemove) private {
