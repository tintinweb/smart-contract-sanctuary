...
// File: contracts/token/ERC20/EasyGroupCoin.sol
...
/**
 * @title EasyGroupCoin
 * @dev Implementation of the EasyGroupCoin
 */
contract EasyGroupCoin is ERC20Decimals, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover, Roles {
     ...
     * @param amount The amount of tokens to mint
     */
    function _mint(address account, uint256 amount) internal override(ERC20) onlyMinter {
