...
contract Origins is ERC721Burnable, Ownable {
    uint256 constant public PRICE = 0.05 ether;
    uint256 constant public TOTAL_SUPPLY = 8000;
    ...
    constructor(address payable _claimEthAddress) public ERC721("Origins", "Origin") {
        claimEthAddress = _claimEthAddress;
    }

    function reserveOrigins(address addr, uint256 amount) public onlyOwner {
    ...
    * Mint Origins
    */
    function mintOrigins(uint numberOfTokens) public payable {
