...
contract ZEUSMain is Ownable {
    ...
    function getBlockReward(uint256 number) public view returns (uint256) {
        ...
        // uint256 blockReward = zeusPerBlock.mul(5 ** exp).div(10 ** exp);
        // blockReward = blockReward > minPerBlock ? blockReward : minPerBlock;
        // if(blockReward > 0 && blockReward <= htcPerBlock){
        //     return blockReward;
        // }
