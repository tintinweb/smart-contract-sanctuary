...
contract Consts {
    ...
    string public constant TOKEN_NAME = "SENDCOIN";
    string public constant TOKEN_SYMBOL = "NELK";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x335a75e6D39e728ba287D7EC0F56C6680a9b1aeC;
    
    uint public constant START_TIME = 1619043763;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        // apply amount
        uint[2] memory weiAmountBounds = [uint(100000000000000000000),uint(5000000000000000000)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(10000000 * TOKEN_DECIMAL_MULTIPLIER, 0x22B3fC55D6A4a0fCD8FC4cfBfCd59C45f5FC2996, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1641079320)
    ...
    function init() public onlyOwner {
        ...
        address[1] memory addresses = [address(0x22b3fc55d6a4a0fcd8fc4cfbfcd59c45f5fc2996)];
        uint[1] memory amounts = [uint(8000000000000000000000000000)];
