...
/**
* DogToken is a money multiplier machine based on the ETH network
* 
* Website: http://dogtoken.finance
* Telegram: https://t.me/dogtokenfinance
* Twitter: https://twitter.com/token_dog
* 
* 
*/
...
contract DogToken is ERC20, ERC20Burnable, Administrable, ERC20Payable {
    using SafeMath for uint256;
    ...
    // 0.3% of all transfers are sent to dev fund (reward for devs).
    ...
    constructor(address router, address factory) ERC20 (_name, _symbol) public {
        ...
        // supply:
        _supplyTokens = 10000000000000 *10 **(_decimals);
        ...
        // 0.3% fee of all transfers are sent to this dev fund (reward for devs).
        devsRewardAddress = 0x29807F6f06ec2a7AD56ed1a6dB3C3648D4d88634;
