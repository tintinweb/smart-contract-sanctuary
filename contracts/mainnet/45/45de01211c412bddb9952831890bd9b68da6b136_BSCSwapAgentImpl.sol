...
// File: node_modules\openzeppelin-solidity\contracts\proxy\Proxy.sol
...
// File: node_modules\openzeppelin-solidity\contracts\proxy\UpgradeableProxy.sol
...
// File: contracts\BSCSwapAgentUpgradeableProxy.sol
...
// File: contracts\BSCSwapAgentImpl.sol
...
contract  BSCSwapAgentImpl is Context, Initializable {
    ...
    */
    ...
    function createSwapPair(bytes32 ethTxHash, address erc20Addr, string calldata name, string calldata symbol, uint8 decimals) onlyOwner external returns (address) {
        ...
        BSCSwapAgentUpgradeableProxy proxyToken = new BSCSwapAgentUpgradeableProxy(bep20Implementation, bep20ProxyAdmin, "");
