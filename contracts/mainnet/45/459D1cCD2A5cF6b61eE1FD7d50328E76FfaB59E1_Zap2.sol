...
contract OpethZap {
    ...
    /**
    * @notice Purchase oToken with ETH and mint opeth.
      Use when underlying is weth and user sends unwrapped eth
    */
    function mintWithEth(
        ...
        WETH9(address(weth)).deposit{value: _opeth.mul(1e10)}();
        IERC20(oToken).safeApprove(address(opeth), _opeth);
    ...
    /**
    * @notice Purchase oToken with ETH and mint opeth.
      Can be used for any underlying including weth
    */
    function mint(
        address oToken,
        uint _opeth,
        ...
        (address underlying,,uint _underlying) = opeth.getOpethDetails(oToken, _opeth);
    ...
    */
    function _mint(
        ...
        // Purchase oToken
        (bool success, bytes memory returnData) = exchange.call{value: _0xFee}(_0xSwapData);
        require(success, string(abi.encodePacked("SWAP_CALL_FAILED: ", returnData)));
