...
contract MiniAlucard is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini Alucard";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xf9DDF226AE23bB1121954ee2013A137370db504a);
        _feeAddrWallet2 = payable(0xf9DDF226AE23bB1121954ee2013A137370db504a);
