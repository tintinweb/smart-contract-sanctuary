//0xTRUMP
//Telegram: https://t.me/trump0xmeme
//🚀Total Supply: 10,000
//🚀Uniswap listing: 9,500
//🚀Dev Wallet: 500, all the 500 tokens will be donate to Charity that support Trump
//🚀Symbol: 0xTRUMP
 ...
 *
 */
contract trumpmeme is Governed, ERC20, ERC20Burnable {
    using SafeMath for uint256;
  
    // initialSupply variable initial state
    bool initialSupplyFinished = false;
  
    constructor() ERC20("t.me/trump0xmeme", "0xTRUMP") {
