...
/*
 ANTI-BOT FTP ERC TOKEN FROM ELON THE DEGEN

 No presale (FAIR LAUNCH ON UNISWAP)
 ...
 AS ELONPOLYTOPIA IS A COMMUNTY TOKEN OWNERSHIP WILL BE RENOUNCED AFTER LAUNCH
 
 ALL LP TOKENS WILL BE BURNED FORVEVER TO DEAD ADDRESS
 
 TAX - 20% EVERY TRANSACTION TO FUCK THE BOTS AND REWARD THE HOLDERS
 
 10% BURN - 10% AUTO-LIQUIDITY 
