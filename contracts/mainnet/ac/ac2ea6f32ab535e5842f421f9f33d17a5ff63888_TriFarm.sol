...
Tri-Farm Seed Capital | $TRIFARM
Till | Seed | Cultivate | Farm | Stake | Fund | Repeat

https://t.me/trifarm
https://trifarmcapital.com

Copyright 2022 TriFarm Seed Capital
...
contract TriFarm is Ownable, IERC20 {
    address UNISWAPROUTER = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "TriFarm Seed Capital";
    string private _symbol = "TRIFARM";

    uint256 public treasuryFeeBPS = 1200;
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "TRIFARM: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "TRIFARM: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "TRIFARM: Sender is blacklisted");
        require(!isBlacklisted[recipient], "TRIFARM: Recipient is blacklisted");

        require(sender != address(0), "TRIFARM: transfer from the zero address");
        require(recipient != address(0), "TRIFARM: transfer to the zero address");
        ...
        require(
            ...
            "TRIFARM: transfer amount exceeds balance"
        );
        ...
        if (block.number <= (launchedAt) && recipient != address(uniswapV2Router) && recipient != address(dividendTracker) && recipient != address(uniswapV2Pair)) {
    ...
    function _approve(
        ...
        require(owner != address(0), "TRIFARM: approve from the zero address");
        require(spender != address(0), "TRIFARM: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }

    function _mint(address account, uint256 amount) private {
        require(account != address(0), "TRIFARM: mint to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) private {
        require(account != address(0), "TRIFARM: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "TRIFARM: burn amount exceeds balance");
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "TRIFARM: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "TRIFARM: DEX pair can not be removed");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "TRIFARM: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "TRIFARM: the router is already set to the new address"
        );
    ...
    function compound() public {
        require(compoundingEnabled, "TRIFARM: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "TRIFARM_DividendTracker";
    string private _symbol = "TRIFARM_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "TRIFARM_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "TRIFARM_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "TRIFARM_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "TRIFARM_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("TRIFARM_DividendTracker: method not implemented");
    }
