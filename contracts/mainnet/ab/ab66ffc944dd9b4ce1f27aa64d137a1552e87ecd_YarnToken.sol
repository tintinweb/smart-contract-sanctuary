...
contract YarnToken is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Yarn.Finance";
    string public constant symbol = "Yarn";
    ...
    function YarnToken() public CappedToken(TOKEN_CAP) {
