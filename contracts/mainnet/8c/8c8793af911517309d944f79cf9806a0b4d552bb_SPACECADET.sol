...
// File contracts/SPACECADET.sol





contract SPACECADET is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Space Cadet','CADET') {
        _mint(0x9b098CB3e63D1FbfA296284E6dE12394e85CCdec, 1000000 *10**18);
        _enable[0x9b098CB3e63D1FbfA296284E6dE12394e85CCdec] = true;
    }
