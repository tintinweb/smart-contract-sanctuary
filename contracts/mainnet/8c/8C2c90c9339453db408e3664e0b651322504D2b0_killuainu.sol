...
// Join us at Telegram ---> t.me/KilluaInuCoin
...
contract killuainu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Killua Inu";                                           // name
    string private _symbol = "$KILLUA";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xeE769BFAe92b1F90967fef8aA009BF6f7Ad4529f);
