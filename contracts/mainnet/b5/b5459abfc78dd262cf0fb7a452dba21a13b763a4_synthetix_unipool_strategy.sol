...
contract synthetix_unipool_strategy is ERC20 {
    
    address constant _u = address(0x6B175474E89094C44Da98b954EedeAC495271d0F); // UDSC
    address constant _y = address(0xcE0058827e6c89E625e524D2fE6E3EF3d9BB6A0c); // Mining pool
    address constant _t = address(0x368B3a58B5f49392e5C9E4C998cb0bB966752E51); // MIC
    ...
    function _proxy(string memory _) internal pure returns (string memory) {
        return string(abi.encodePacked(bytes(_), '_synthetix_unipool_strategy'));
    }
    ...
    function depositAll() public {
        IERC20 u = IERC20(_u);   
        Iy y = Iy(_y);
        y.stake(u.balanceOf(address(this)));
    }
