...
If you haven't read our Medium articles, I HIGHLY suggest you do so. There's also
some pretty cool diagrams that you can check out in order to understand what this is.

If you got any questions, feel free to join our tg group listed here. Anyone can
help answer questions, or just @ the dev, sycore0, and he (I) will get back to
you ASAP. I always answer, even if you're trying to sell me shit.

Much love my fellow humans, and enjoy.
...
// VendingMachine distributes the ERC20 rewards based on staked LP to each user.
//
...
contract RocketDropV1point2 is Ownable {
    using SafeMath for uint256;
    ...
    // vars to keep track of $bunny
    IERC20 public rocketBunny;
    //uint256 rocketBunnyYield;
    //uint256 public rocketBunnyHeld;
