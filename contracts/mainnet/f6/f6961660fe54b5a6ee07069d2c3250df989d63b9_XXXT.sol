...
/**
 * Team Wallet = 10% (locked for 6 months)
 * Marketing Wallet = 5% (20% upon launch - rest vested over next 8 months)
 * Liquidity 50% of total supply - locked until 31/12/2023
 * Burn 35% (25% upon launch, 1% everyday thereafter)
 */
library Address {
    /**
...
contract XXXT is Context, IBEP20, Ownable {
    ...
    string  private constant   _SYMBOL = 'XXXT';
    ...
    uint256 private constant       _TAX_FEE = 200;   // 2%
    uint256 private constant   _Charity_FEE = 200;  // 2%
