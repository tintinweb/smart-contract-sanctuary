...
/*🐱 Neko Atsume 🐱
An Amazing Moonshot Token with 100x Potential!
🏁 Locked Liquidity
✅ Renounced Ownership
🚀 LOW MARKET CAP! READY TO MOON!

ℹ️ In development is a two-way staking system and a Neko Atsume NFT collection that will be 
based on ERC-721 slated for release on Wednesday, January 19th, 2022 at 5:30 PM EST. You can 
mint 0/9999 Neko Atsume NFTs using the ATSUME token!

There is no doubt that this token will possibly 5-10x by the end of the day. 
Don't miss out! CALLS WILL BE INCOMING AFTER LIQUIDITY LOCK. @NekoAtsumeToken
*/
...
contract NA is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 70000000000 * 10 ** 18;

    constructor () ERC20('NekoAtsume','ATSUME') {
