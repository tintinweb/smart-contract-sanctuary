...
// Modified to work in the GAMER system

// all votes work on underlying _gamerBalances[address], not balanceOf(address)
...
//    Since GAMER supply changes, updated quorum & proposal requirements
//    If any uint96, changed to uint256 to match GAMER as opposed to comp
