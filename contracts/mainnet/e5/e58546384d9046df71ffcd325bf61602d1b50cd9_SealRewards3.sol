...
contract LPTokenWrapper {
    ...
    IERC20 public LP_TOKEN = IERC20(0xb723E7AEb820eB8B92B3a679d139DF5E7A5d9f30); // Stake LP token
...
contract SealRewards3 is LPTokenWrapper, Ownable {
    IERC20 public CTSL_TOKEN = IERC20(0x2Eb80b3c9c630a48c553eD3ef99fb5480cAEBF3f); // cuteseal token
    uint256 public constant DURATION = 7 days;

    uint256 public initreward = 4000 * 1e18;
    uint256 public starttime = 1603299600; // GMT September 2, 2020 2:00:00 PM
    ...
    function getReward() public updateReward(msg.sender) checkhalve {
        ...
        if (reward > 0) {
            ...
            CTSL_TOKEN.safeTransfer(msg.sender, reward);
    ...
    modifier checkhalve(){
        if (block.timestamp >= periodFinish) {
            ...
            CTSL_TOKEN.mint(address(this),initreward);
        ...
        updateReward(address(0))
    {
        ...
        CTSL_TOKEN.mint(address(this), reward.add(devNewAmt));
    ...
    function devWithdrawFund(uint256 amt) external
    {
        ...
        CTSL_TOKEN.safeTransfer(devVestingAddr, amt);
    }
}