...
/*
   ...
   Welcome to $DirtyChicken
   
   I'm doing a social experiment and thanks for joining me:
   This is a community token. So there is no official group.
   If someone wants to create one to communicate, do your publicity in other groups, and then establish a consensus group. 
   
   There is only one channel recording the information when I released this coin. 
   If you want to view all the information about this coin, please check https://t.me/Dirty_Chicken
   
   I'll lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   I'll renounce the ownership to burn addresses to transfer $DirtyChicken to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $DirtyChicken idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 10ETH in the pool. 
...
contract DirtyChicken is BEP20 {
     ...
     */
    constructor() public BEP20("https://t.me/Dirty_Chicken", "Dirty🐔") {
