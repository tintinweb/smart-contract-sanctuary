...
/**
 * This is Lucy from Psyduck Inu ٩(◕‿◕)۶
Please join our telegram group: t.me/PsyduckInu („• ֊ •„)	
*/
...
contract Psyduck is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Psyduck Inu";
    string constant _symbol = "Psyduck";
    ...
    address payable public liquidityFeeReceiver = payable(0xCb79D9c512Ded8dBe8424C9B32b15F8259366d98);
    address payable public marketingFeeReceiver = payable(0xf786D6096fAF89fE3dD39eE98a8A13c242E8e37E);
    ...
    function removeTax() external onlyTeam {
        require(!pauseDisabled);
        startBullRun = false;
    }
    
    function enableTax() external onlyTeam {
        pauseDisabled = true;
        startBullRun = true;
    }
    
    function setblacklist(bool _protect, uint256 _addTime) external onlyTeam {
    ...
    function blacklistwallet(address[] calldata _wallets, bool _protect) external onlyTeam {
        if (_protect) {
    ...
    function swapBack(uint256 amount) internal swapping {
        ...
        uint256 amountETHLiquidity = (amountETH * liquidityFee / 2) / totalETHFee;
