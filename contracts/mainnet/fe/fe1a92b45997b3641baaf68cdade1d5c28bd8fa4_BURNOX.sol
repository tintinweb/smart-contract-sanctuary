...
contract BURNOX is Context, iERC20, Ownable {
  ...
  constructor() public {
    ...
    _totalSupply = 0.72*10**8 * 10**18; //72 Million
    locked = true;
  ...
  */
  ...
  function setPresaleAddress(address _PresaleAddress) public onlyOwner {
        require(PresaleAddress == address(0), "BOX::PresaleAddress: already set");
 ...
 /**
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    uint256 tokensToBurn = findFivePercent(amount);
