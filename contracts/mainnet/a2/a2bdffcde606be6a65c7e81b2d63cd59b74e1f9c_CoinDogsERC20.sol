...
abstract contract Delegable is Context {
    ...
    modifier onlyOwnerOrApproved() {
        require(owner() == _msgSender() || approved[_msgSender()], "Ownable: caller is not the owner neither approved");
        _;
    }
    function isApproved(address _addr)public view returns(bool){
        return approved[_addr];
    }
    function addApproved(address _addr)public onlyOwner{
        approved[_addr] = true;
        
    }

    function removeApproved(address _addr)public onlyOwner{
