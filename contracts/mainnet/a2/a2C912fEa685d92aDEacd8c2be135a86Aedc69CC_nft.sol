...
contract nft is ERC721Enumerable, Ownable {
    ...
    uint private constant mintCost_ = 0.04 ether;
    
    //maximum amount of mints allowed per person
    uint256 public constant maxMintPresale = 2;
    ...
    //variable that determines if NFTs have been revealed or not
    bool private reveal;
    ...
    constructor() ERC721('Shark Game', 'SG') {
        maxTotalTokens = 3300;

        //initially NFTs will not have been revealed
        reveal = false;
        unrevealedURI = "ipfs://QmatLZzWoPWxDxE9u8Ldn7QXaP7PMCvYFDbKbj51m6sk28/";
    ...
    function setStakingPoolAddress(address stakingPool_) public {
    ...
    function switchToPresale() public onlyOwner {
        ...
        publicSaleLaunchTime = presaleLaunchTime + 1;
    }
    ...
    */
    ...
    function tokenURI(uint256 tokenId_) public view virtual override returns (string memory) {
        ...
        if (!reveal && totalSupply() < maxTotalTokens) {
