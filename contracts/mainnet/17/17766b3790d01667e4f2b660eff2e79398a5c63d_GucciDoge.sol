...
contract GucciDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "Gucci Doge";
    ...
    uint256 public _maxTxAmount = 100000000 * 10**2 * 10**9; // max transaction amount
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to] && cooldownEnabled) {
                ...
                defaultMarketingFee = 10;
                _marketingFee4Sellers = 10;
            }
        }
