...
.----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |      __      | || |   ______     | || |  _________   | || |   ______     | || |  _______     | || |     ____     | |
| |     /  \     | || |  |_   __ \   | || | |_   ___  |  | || |  |_   __ \   | || | |_   __ \    | || |   .'    `.   | |
| |    / /\ \    | || |    | |__) |  | || |   | |_  \_|  | || |    | |__) |  | || |   | |__) |   | || |  /  .--.  \  | |
| |   / ____ \   | || |    |  ___/   | || |   |  _|  _   | || |    |  ___/   | || |   |  __ /    | || |  | |    | |  | |
| | _/ /    \ \_ | || |   _| |_      | || |  _| |___/ |  | || |   _| |_      | || |  _| |  \ \_  | || |  \  `--'  /  | |
| ||____|  |____|| || |  |_____|     | || | |_________|  | || |  |_____|     | || | |____| |___| | || |   `.____.'   | |
| |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
*/
...
contract ApePro is Context, IERC20, Ownable {
    ...
    string private constant _name = "ApePro";
    string private constant _symbol = 'APEPRO';
