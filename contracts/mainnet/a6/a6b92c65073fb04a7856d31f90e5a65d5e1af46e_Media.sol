...
/**
 * @title Interface for Musicbee Protocol's Media
 */
interface IMedia {
...
contract Media is IMedia, ERC721Burnable, ReentrancyGuard {
     ...
     */
    // constructor(address marketContractAddr) public ERC721("Musicbee", "MBEE") {
    //     marketContract = marketContractAddr;
    //     _registerInterface(_INTERFACE_ID_ERC721_METADATA);
    // }
    constructor() public ERC721("Musicbee", "MBEE") {
        _registerInterface(_INTERFACE_ID_ERC721_METADATA);
    }
