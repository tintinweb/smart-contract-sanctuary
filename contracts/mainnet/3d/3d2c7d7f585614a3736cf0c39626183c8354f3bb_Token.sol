...
/**
 * @title BaseERC20
 * @dev Implementation of the BaseERC20
 */
abstract contract BaseERC20 is ERC20Burnable, Ownable, Roles {
     ...
     * See {ERC20-_burn}.
     */
    function _burn(address account, uint256 amount) internal override onlyOwner {
