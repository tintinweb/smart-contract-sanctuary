...
contract ERC20Rastafari is Context, ERC20 {
    constructor(
...
contract RastafariInu is ERC20Rastafari {
    constructor() ERC20Rastafari("Rastafari Inu", "RASTAFARINU", false, true, 1000, 70, msg.sender, 42000000000 * 10 ** 18, msg.sender, 420) {
    }
}