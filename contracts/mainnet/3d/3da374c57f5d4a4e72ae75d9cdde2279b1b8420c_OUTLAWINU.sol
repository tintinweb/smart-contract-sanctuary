...
/*
    ...
    Outlaw Inu - $OUTLAWINU

    The only rebel in the galaxy. Saving crypto and the universe.

    Abilities:

    💰 Collector: 2% Reflection for all holders. Hold the coin and get free rewards.

    🗡 Nuker: Stricted buylimits and additional botblocker in the contract.

    🌏 Maintainer: Autoadding liquidity after each transaction, creating a stable pricefloor and marketcap.

    🔋 Fuel: Small tax to have a marketing fund. Our only resource to maintain Outlaw Inus goals!

    Twitter: https://twitter.com/OutlawInuETH

    Website: https://www.outlawinu.com/

    Telegram: https://t.me/OutlawInuETH
*/
...
contract OUTLAWINU is Context, IERC20, Ownable {
    ...
    string private _name = "Outlaw Inu";
    string private _symbol = "OUTLAWINU";
