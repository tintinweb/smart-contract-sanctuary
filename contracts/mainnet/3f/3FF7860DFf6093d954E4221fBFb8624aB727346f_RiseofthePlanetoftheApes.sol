...
// so I created these ApePunks. Our goal is to witness the bright future of NFT through decades.
// distant guide.
pragma solidity ^0.8.0;
...
contract RiseofthePlanetoftheApes is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  function Officialcasting() public onlyOwner {        
  ...
  // metadata URI
  string private _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmdxbD4pLvCt9BgnfYvobzS2xT2EiGS3yGszL7aarDhCaq/";
