...
/**
    ...
    Telegram | https://t.me/yatatoken

    Tokenomics:
    Total Supply | 1000000000000
    Maxtx | 5000000000 (.5% Max buy)
    Max Wallet | 4%
    9% Marketing 1% Liquidity
...
contract YatagarasuToken is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Yatagarasu Token";
    string constant _symbol = "YATA";
    ...
    uint256 marketingFee = 90;
    uint256 teamFee = 0;
    uint256 totalFee = 100; // 100 = 10%
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0x4BaaD3522888fE53A2a5DF7941b6B3f869472c6c);
	    teamFeeReceiver = address(0x4BaaD3522888fE53A2a5DF7941b6B3f869472c6c);
    ...
    function launchMode() internal view returns(bool) {
        return launchedAt !=0 && launchedAt + 2 < block.number && launchedTime + 3 minutes >= block.timestamp ;
    }
