...
contract TheHoldersClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "The Holders Club";
    string private constant _symbol = "THC";
    ...
    address payable private _developmentAddress = payable(0xE37C5Ebc26A12b36e98a80A9d5C7F9832f01848f);
