...
is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 88 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Dime";
    string private _symbol = "Dime";
    uint8 private _decimals = 18;
    
    uint256 private constant DIVISION_FACTOR = 4;   // fee precision up to 2 decimals
    uint256 public _taxFee = 200;                   // 25 = 2.50%
    ...
    function setCharityWallet(address _charitywallet) public onlyOwner {
        CHARITY_WALLET = 0x47E0C47E96ebaEB5264a3b493e777fde7c5D22F9;
    }
