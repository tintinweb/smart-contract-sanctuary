...
// File: contracts\AllOriginals.sol
 ...
 */
 ...
 contract AllOriginals is Context, AccessControl, ERC721, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() public ERC721("All Originals", "AO") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xB0F7F2A2D56849200A72693B1c34695419d5F584);
          _setupRole(MINTER_ROLE, 0xB0F7F2A2D56849200A72693B1c34695419d5F584);

         _setBaseURI("https://alloriginals.io/token/");
         transferOwnership(0xB0F7F2A2D56849200A72693B1c34695419d5F584);
     }
     ...
     function mint(address to) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "AllOriginals/minter-role-required");
      ...
      * - the caller must have the `MINTER_ROLE`.
      */
     function bulk_mint(address to, uint256[] memory tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "AllOriginals/minter-role-required");
