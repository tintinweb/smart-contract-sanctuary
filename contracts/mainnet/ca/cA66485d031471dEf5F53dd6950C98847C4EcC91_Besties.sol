...
contract Besties is ERC721Enumerable, Ownable {
    ...
    uint256 public constant bestiesSupply = 20000;
    uint256 public constant bestiesPrice = 70000000000000000; //0.07 ETH
    bool public saleActive = false;



    constructor(string memory baseURI) ERC721("Besties", "BEST")  {
        setBaseURI(baseURI);
    }
