...
contract Arb {
    ...
    UniswapLens LENS = UniswapLens(0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6);
    UniswapRouter ROUTER = UniswapRouter(0xE592427A0AEce92De3Edee1F18E0157C05861564);
    UniswapReserve USDCETH = UniswapReserve(0x8ad599c3A0ff1De082011EFDDc58f1908eb6e6D8);
    uint160 internal constant MAX_SQRT_RATIO = 1461446703485210103287273052203988822378723970342;
    CurveLike CURV = CurveLike(0xEd279fDD11cA84bEef15AF5D39BB4d4bEE23F0cA);
    BAMMLike BAMM = BAMMLike(0x0d3AbAA7E088C2c82f54B2f47613DA438ea8C598);
    ...
    function swap(uint ethQty) external returns(uint) {
        USDCETH.swap(address(this), false, int256(ethQty), MAX_SQRT_RATIO - 1, bytes(""));
    ...
    function uniswapV3SwapCallback(
        ...
        BAMM.swap(LUSDReturn, 1, address(this));
