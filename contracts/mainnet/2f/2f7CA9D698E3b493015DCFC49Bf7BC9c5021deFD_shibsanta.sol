...
contract shibsanta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Shib is my Santa";
    string private constant _symbol = "shibsanta";
    ...
    address payable private _developmentAddress = payable(0xD882FfC26Dfdb426cF94804E1E9E4223C9b1A357);
