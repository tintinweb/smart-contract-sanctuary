...
Twitter: https://twitter.com/@SeiyaInuErc20
Medium: https://medium.com/@SeiyaInu
Github: https://github.com/SeiyaInu
Instagram: https://www.instagram.com/seiyainu/
Reddit: https://www.reddit.com/user/SeiyaInu
...
contract SeiyaInu is Context, IERC20 {
    ...
    string private _name = "Seiya Inu";
    string private _symbol = "SeiyaInu";
    ...
    address payable private _marketingWallet = payable(0xcaC1DB2CC7EAc4eF9928db10A1907174fe3f744E);
        ...
        if (sniperProtection){
            ...
            if (!_hasLiqBeenAdded) {
                ...
                if (_liqAddBlock > 0 
                    ...
                    if (block.number - _liqAddBlock < snipeBlockAmt + 4) {
                        _isSniper[to] = true;
                        snipersCaught ++;
