...
https://twitter.com/burgerking/status/1485992575152668677?s=21
...
contract Dogepper is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Dogepper";//
    string private constant _symbol = "DOGEPPER";//
    ...
    address payable private _developmentAddress = payable(0xBf4CC2145B62Fd1A46a0b9e4F031e7002529A992);//
    address payable private _marketingAddress = payable(0x476F90e50195CE3051c427793A2Ad5904A187bd4);//
