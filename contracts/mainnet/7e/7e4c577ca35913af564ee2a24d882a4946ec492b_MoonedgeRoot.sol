...
// File: contracts/MoonedgeRoot.sol

contract MoonedgeRoot is AccessControl, ERC20Capped, ERC20Fallback, Ownable {
    ...
    constructor (
        ...
        ERC20Fallback()
    {
        require(initialAccount != address(0), "MoonedgeRoot: initialAccount is a zero address");
        _decimals = decimals_;
