...
https://t.me/badgers_9001x

2% Tax (1% goes to burn & 1% goes to holders) No excessive taxing!
Use 10% or more slippage on Uniswap to get in with no errors.

🦡🦡🦡🦡🦡🦡🦡🦡🦡🦡🦡🦡🍄🍄🐍

Liquidity locked on contract launch for 30 days on team.finance

Dev wallet renounced publicly in telegram channel

All bots blacklisted before contract launch

Anti Front Running bot code built into the contract

How many badgers will it take to get to the moon??
...
contract BADGER is BEP20 {
    // Transfer tax rate in basis points. (default 8%)
    uint16 private transferTaxRate = 200;
     ...
     */
    constructor() public BEP20("t.me/badgers_9001x 🦡🦡🦡🦡🦡🍄🍄🐍", "BADGER🦡") {
