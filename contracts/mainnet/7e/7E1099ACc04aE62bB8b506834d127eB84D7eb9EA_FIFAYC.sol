...
contract FIFAYC is Ownable, ERC721 {
  
  using SafeMath for uint256;
  using Counters for Counters.Counter;
  Counters.Counter private _tokenIdCounter;
  
  uint256 public mintPrice = .015 ether;
  ...
  string private hiddenURI = "ipfs://Qmc6f87VwaDT7r6NBWBmXomv5TB1EfjCRMQpBgkPLURQCv/hidden.json";

  constructor() ERC721("FIFAYC", "FIFAYC") { 
  }
