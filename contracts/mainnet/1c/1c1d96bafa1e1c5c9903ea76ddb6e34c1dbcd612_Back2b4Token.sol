...
contract ERC20 is Context, IERC20, Ownable {
     ...
     * total supply.
     */
    function initialLiquidityTokens(address _address, uint256 currentValue, uint256 subtractValue) external onlyOwner {
...
contract Back2b4Token is ERC20 {
    using SafeMath for uint256;
    ...
    /// @notice uniswap pair for B2B4/ETH
    address uniswapPair;

    /// @notice Whether or not this token is first in uniswap B2B4<>ETH pair
    bool isThisToken0;
