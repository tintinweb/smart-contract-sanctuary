...
contract MOONMUSK is Context, IERC20, Ownable {
    ...
    //Total 0 => 0% goes to liquidity providers and 0% are added to liquidity pool
    uint256 public _liquidityFee = 0;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    //means 87% from total collected liquidity(8% on every Transfer) will be used to rewarded liquidity providers
