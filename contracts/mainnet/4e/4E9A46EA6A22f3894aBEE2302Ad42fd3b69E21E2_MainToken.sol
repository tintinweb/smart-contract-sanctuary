...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Binance Smart Chain Girl";
    string public constant TOKEN_SYMBOL = "BSCGIRL";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x10ef43d90ca8baf45f7a753b931bc064a0ac1ebd;
    
    bool public constant CONTINUE_MINTING = false;
    uint256 public constant TOTAL_SUPPLY = 12000000000000000;
}
    ...
    
{
    ...
    constructor() public {
        ...
        balances[msg.sender] = balances[msg.sender].add(TOTAL_SUPPLY);
        emit Mint(msg.sender, TOTAL_SUPPLY);
