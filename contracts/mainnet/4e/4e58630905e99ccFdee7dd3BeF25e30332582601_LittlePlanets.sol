...
contract LittlePlanets is ERC721, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://ipfs.io/ipfs/QmeQXg2raRYrRj7FCDtmuiEfyWGBmGsEiX7ereJyhmeTeh";
    ...
    constructor(
    ) ERC721("LittlePlanets", "LittlePlanets") {
    }
