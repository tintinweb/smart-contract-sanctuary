...
contract BitSelectArrojado is StandardToken {
...
//make sure this function name matches the contract name above. So if you&#39;re token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function BitSelectArrojado(
        ...
        name = "Bit Select Arrojado";                                   // Set the name for display purposes
        decimals = 10;                            // Amount of decimals for display purposes
        symbol = "BSAC";                               // Set the symbol for display purposes
    }
