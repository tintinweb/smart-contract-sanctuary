...
contract LohkoNFT is ERC1155PresetMinterPauser {
  ...
  constructor(string memory uri, address _proxyRegistryAddress, string memory _contractURI) public ERC1155PresetMinterPauser(uri) {
        proxyRegistryAddress = _proxyRegistryAddress;
        contract_URI = _contractURI;
  }
  
  function setContractURI(string memory _contractURI) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "LohkoNFT: Need admin");
        contract_URI = _contractURI;
  }
