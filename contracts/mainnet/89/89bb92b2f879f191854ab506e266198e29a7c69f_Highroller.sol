...
/**
 *Highroller is here to rule all the Dogecoins.
*/
...
contract Highroller is Context, IERC20, Ownable {
    ...
    string private _symbol = "Highroller";
    ...
    address payable public marketingWallet = payable(0x14A83B9A425Aac51B2894615E8fAF2108724d221);
