...
contract KangarooHeroesV2 is ERC721, Ownable {
    ...
    uint256 public MAX_KANGAROO_HEROES = 3600;
    ...
    constructor(address _companyWallet) ERC721("KangarooHeroesV2", "KangarooHeroesV2") {
    ...
    function claimCompanyReserve(uint256 noOfItems) public onlyOwner{
        require(noOfItems.add(totalCompanyClaimed) <=511,"Max Claim for Company Exceeds");
    ...
    */
    ...
    function setMaxKangarooHeroesPerWallet(uint num) public onlyOwner {
      maxKangarooHeroesPerWallet = num;
    }
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(balanceOf(msg.sender).add(numberOfTokens) <= maxKangarooHeroesPerWallet, "Max Hold Limit Exceeds");
        require(numberOfTokens.mul(kangarooHeroesPrice) <= msg.value, "Invalid Ether Amount");
    ...
    function _mintKangarooHeroes(address to) internal {
 	...
 	function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        if(isReserved[_tokenId]){
            return string(abi.encodePacked(reservedURI, _tokenId.toString(), ".json"));
        }
