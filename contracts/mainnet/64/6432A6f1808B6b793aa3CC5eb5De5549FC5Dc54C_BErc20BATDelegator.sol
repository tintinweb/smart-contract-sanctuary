...
/**
 * @title Bird's BErc20BATDelegator Contract
 * @notice BTokens which wrap an EIP-20 underlying and delegate to an implementation
 */
contract BErc20BATDelegator is BTokenInterface, BErc20Interface, BDelegatorInterface {
    /**
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "BErc20BATDelegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"BErc20BATDelegator:fallback: cannot send value to fallback");
