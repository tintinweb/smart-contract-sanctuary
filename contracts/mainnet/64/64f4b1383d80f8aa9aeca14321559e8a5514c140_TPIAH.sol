...
// ----------------------------------------------------------------------------
// 'The Pandemic Is A Hoax' token contract
//
// Symbol      : TPIAH
// Name        : The Pandemic Is A Hoax
// Total supply: 19 000 000
// Decimals    : 18
// ----------------------------------------------------------------------------
...
contract TPIAH is BurnableToken {

    string public constant name = "The Pandemic Is A Hoax";
    string public constant symbol = "TPIAH";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 19000000 * (10 ** uint256(decimals));
