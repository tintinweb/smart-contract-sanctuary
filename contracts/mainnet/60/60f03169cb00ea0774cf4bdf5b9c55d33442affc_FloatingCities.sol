...
contract FloatingCities is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address wallet1 = 0xcBF18174054a53C023dCc69c538BC81AA724F823;
    address wallet2 = 0x099EdBA8aB454cc47B940f543D5432C41A69Cf55;
    address wallet3 = 0xBE6C3FFEcFE01DeD5DdC97c1Bd4fceef4B9240d8;
    address wallet4 = 0xAaAb59789e69F18d3Cd3C3aC0269e3AbAEDC331d;

    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Floating Cities', 'CITIES') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 1; i++) internalMint(to);
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(wallet1).transfer((balance * 250) / 1000);
        payable(wallet2).transfer((balance * 250) / 1000);
        payable(wallet3).transfer((balance * 250) / 1000);
        payable(wallet4).transfer((balance * 250) / 1000);
    }
