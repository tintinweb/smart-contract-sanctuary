...
contract Strategy is CurveVoterProxy {
    ...
    // address public constant reward = address('[reward token address]');

    constructor(address _vault) public CurveVoterProxy(_vault) {
        curve = address(0xA50cCc70b6a011CffDdf45057E39679379187287);
        gauge = address(0x64E3C23bfc40722d3B649844055F1D51c1ac041d);
        keepCRV = 1000;
