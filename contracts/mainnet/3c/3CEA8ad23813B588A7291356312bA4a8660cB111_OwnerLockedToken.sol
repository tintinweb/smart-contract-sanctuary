...
// File: contracts\OwnerLockedToken.sol
...
contract OwnerLockedToken is Owned {
    ...
    function release() public virtual {
        ...
        require(_approved, "OwnerLock: owner has not approved the release");

        uint256 amount = token().balanceOf(address(this));
        require(amount > 0, "OwnerLock: no tokens to release");
