...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 private MAXCAPSUPPLY=100000*10**18;
     ...
     * construction.
     */
    constructor(string memory name, string memory symbol, uint256 maxCapSupply) public {
        _name = name;
        _symbol = symbol;
        MAXCAPSUPPLY = maxCapSupply;
        _decimals = 18;
    }
...
contract FarmToken is BEP20 {
    using SafeMath for uint256;

    constructor(string memory _name, string memory _symbol, uint256 _maxCapSupply) BEP20(_name, _symbol, _maxCapSupply) public {}
