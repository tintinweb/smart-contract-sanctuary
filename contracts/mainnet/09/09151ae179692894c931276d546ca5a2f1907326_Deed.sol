...
contract Deed is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private dwellingPrefixes = [
        "Ancient",
        "Abandoned",
        "Blessed",
        "Condemned",
    ...
    string[] private dwellingSuffixes = [
        "of the Mages",
        "of the Hunters",
        "of the Shamans",
        "of the Assassins",
    ...
    function getWeapon(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "WEAPON", weaponry);
    }
    ...
    constructor() ERC721("Deed", "DEED") Ownable() {}
}
