...
contract CPFINANCE is ERC20 {
    string public constant name = "CPFINANCE";
    string public constant symbol = "CPF"; 
    uint8 public constant decimals = 18; 
    uint256 public constant initialSupply = 8000000 * (10 ** uint256(decimals));
