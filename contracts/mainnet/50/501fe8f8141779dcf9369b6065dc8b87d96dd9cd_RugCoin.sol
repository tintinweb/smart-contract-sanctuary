...
/**
 RugCoin.com - A Test of low IQ bots. 
 Warning - This will be rugged
 Website - there is no Website
 Telegram - No Telegram Either
...
Tokenomics - 
1% Transaction Fee directly rewarded to holders
5% Transaction Fee sent direct to dev wallet.
90% Supply Burnt
*/
...
pragma solidity ^0.6.12;
    ...
    contract RugCoin is Context, IERC20, Ownable {
        ...
        string private _name = 'RugCoin.com t.me/youwillberugged';
        string private _symbol = 'RUGGED';
        ...
        uint256 private _MarketingPoolFee = 2;
