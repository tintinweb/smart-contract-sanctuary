...
contract FoxGameNFT is IFoxGameNFT, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  bool private eosOnlyEnabled = true;
  ...
  // Initialize
  constructor(address carrot, address game, address traits) ERC721("FoxGame NFT", "FOXGAME") {
    ...
    // Fur
    rarities[0] = [ 255, 204, 153, 153 ];
    aliases[0] = [ 0, 0, 1, 1 ];
    // Paws
    rarities[1] = [ 255, 255, 229, 204, 229, 204, 179, 255, 255, 128 ];
    aliases[1] = [ 0, 0, 1, 2, 3, 2, 3, 0, 0, 4 ];
    // Mouth
    rarities[2] = [ 255, 204, 204, 204, 127, 102, 51, 255, 255, 26 ];
    aliases[2] = [ 0, 0, 1, 0, 2, 0, 1, 0, 0, 4 ];
    // Nose
    rarities[3] = [ 255, 102, 255, 255, 204, 153, 102, 255, 51, 51, 255, 204, 255, 204, 153, 204, 153, 51, 255, 51 ];
    aliases[3] = [ 0, 2, 0, 2, 3, 2, 4, 6, 6, 6, 0, 7, 11, 12, 13, 7, 11, 13, 0, 14 ];
    // Eyes
    rarities[4] = [ 56, 255, 179, 153, 158, 112, 133, 112, 112, 56, 250, 224, 199, 122, 240, 214, 189, 112, 112, 163, 112, 138 ];
    aliases[4] = [ 1, 0, 1, 2, 3, 1, 4, 3, 6, 12, 6, 10, 11, 12, 13, 14, 15, 12, 13, 16, 21, 19 ];
    // Ears
    rarities[5] = [ 153, 153, 255, 102, 77, 230 ];
    aliases[5] = [ 2, 2, 0, 2, 3, 3 ];
    // Head
    rarities[6] = [ 61, 184, 122, 122, 61, 255, 204, 122, 224, 255, 214, 184, 235, 61, 184, 184, 184, 122, 122, 184, 153, 245, 143, 224 ];
    aliases[6] = [ 6, 8, 8, 9, 10, 0, 5, 15, 6, 8, 9, 15, 10, 20, 20, 12, 21, 22, 23, 23, 15, 20, 21, 22 ];

    // FOX

    // Furr
    rarities[7] = [ 191, 77, 191, 255, 38, 115, 204, 153, 191, 38, 64, 115, 77, 115, 128 ];
    aliases[7] = [ 3, 3, 3, 0, 7, 7, 3, 6, 7, 10, 8, 13, 14, 10, 13 ];
    // Feet
    rarities[8] = [ 255, 242, 153, 204, 115, 230, 230, 115, 115 ];
    aliases[8] = [ 0, 0, 1, 2, 0, 0, 0, 2, 3 ];
    // Neck
    rarities[9] = [ 77, 255, 128, 77, 153, 153, 153, 77, 153, 230, 77, 77, 77, 204, 179, 230, 77, 179, 128, 179, 153, 230, 77, 77, 102, 77, 153, 153, 204, 77 ];
    aliases[9] = [ 3, 0, 1, 2, 13, 13, 13, 13, 14, 14, 18, 19, 20, 3, 13, 20, 24, 14, 17, 18, 19, 20, 25, 25, 21, 24, 25, 26, 26, 28 ];
    // Mouth
    rarities[10] = [ 41, 61, 102, 204, 255, 102, 204, 204 ];
    aliases[10] = [ 5, 5, 5, 5, 0, 4, 5, 5 ];
    // Eyes
    rarities[11] = [ 87, 255, 130, 245, 173, 173, 191, 87, 176, 128, 217, 43, 173, 217, 92, 217, 43 ];
    aliases[11] = [ 1, 0, 3, 1, 6, 6, 3, 9, 6, 8, 9, 9, 9, 9, 9, 9, 14 ];
    // Cunning
    rarities[12] = [ 255, 153, 204, 102 ];
    aliases[12] = [ 0, 0, 0, 1 ];

    // HUNTER

    // Clothes
    rarities[13] = [ 128, 255, 128, 64, 255 ];
    aliases[13] = [ 2, 0, 1, 2, 0 ];
    // Neck
    rarities[14] = [ 102, 255, 26, 153, 255 ];
    aliases[14] = [ 1, 0, 3, 1, 0 ];
    // Mouth
    rarities[15] = [ 255, 229, 179, 179, 89, 179, 217 ];
    aliases[15] = [ 0, 0, 0, 6, 6, 6, 1 ];
    // Hat
    rarities[16] = [ 191, 38, 89, 255, 191 ];
    aliases[16] = [ 3, 4, 4, 0, 3 ];
    // Eyes
    rarities[17] = [ 191, 255, 38, 77, 191, 77, 217, 38, 153, 191, 77, 191, 204, 77, 77 ];
    aliases[17] = [ 1, 0, 4, 4, 1, 4, 5, 5, 6, 5, 5, 6, 8, 8, 12 ];
    // Marksman
    rarities[18] = [ 255, 153, 204, 102 ];
    aliases[18] = [ 0, 0, 0, 1 ];
  }
   ...
   * @param sig signature 
   */
  function presaleMint(uint32 amount, bool stake, bool membership, uint48 expiration, uint256 seed, bytes calldata sig) external payable nonReentrant _eosOnly {
   ...
   * @param sig signature 
   */
  function mint(uint32 amount, bool stake, uint256 seed, uint48 expiration, bytes calldata sig) external payable nonReentrant _eosOnly {
