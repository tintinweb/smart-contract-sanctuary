...
contract EndangeredMint is ERC721MetadataEnumerable {
    ...
    constructor(
        ...
        _conservationClose = _conservationOpen + 2 weeks; // Special release lasts 2 weeks for holidays
        // Second release has a 4 week window for reward distribution and metadata updates
        _conservationLock = _conservationClose + 4 weeks;
