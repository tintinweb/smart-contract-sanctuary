...
contract Puxxies is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 public limit = 999;
    uint256 public _reserved = 99;
    uint256 private _price = 0.01 ether;
    bool public _paused = true;
    uint256 public maxPerTx = 5;

    uint per1 = 35; uint per2 = 35; uint per3 = 20; uint per4 = 5; uint per5 = 3; uint per6 = 2;
    address public wallet1 = 0xe548BC7E002c8dFcD3f9Dc85834ad6378da973d4;
    address public wallet2 = 0x511206e0e69E37CBd338f17B436B5900e7967032;
    address public wallet3 = 0x8CCd7fE0e34ECcb3fE0c55e5Ae6ed9ffCB48575e;
    address public wallet4 = 0xb761B096602aABE7E6Dc51425A386b2619165624;
    address public wallet5 = 0xdEFBd0EBc0E5caA1ab313ABd7cd9111705878a2E;
    address public wallet6 = 0x9a7Cc48d3BFa0CF7eE7913dCEaAeCffad59601cB;

    uint maxWithdrawWallets = 6;

    address public fundWallet;
    
    mapping(address => bool) public WL; 
    
    constructor(string memory baseURI) ERC721("Puxxies", "Puxxies") {
        setBaseURI(baseURI);
    ...
    function withdraw() public payable onlyOwner {
        uint256 _puxxy1 = (address(this).balance * 350) / 1000;  // 35%  
        uint256 _puxxy2 = (address(this).balance * 350) / 1000;  // 35%
        uint256 _puxxy3 = (address(this).balance * 200) / 1000;  // 20%
        uint256 _puxxy4 = (address(this).balance * 50 ) / 1000;  // 5%
        uint256 _puxxy5 = (address(this).balance * 30 ) / 1000;  // 3%
        uint256 _puxxy6 = (address(this).balance * 20 ) / 1000;  // 2%

        payable(wallet1).transfer(_puxxy1);
        payable(wallet2).transfer(_puxxy2);
        payable(wallet3).transfer(_puxxy3);
        payable(wallet4).transfer(_puxxy4);
        payable(wallet5).transfer(_puxxy5);
