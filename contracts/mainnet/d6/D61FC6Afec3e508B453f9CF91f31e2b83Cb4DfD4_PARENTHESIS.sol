...
6% token burn per transfer for PARENTHESIS

50,000 PARENTHESIS initial supply

FAIR LAUNCH FEATURE - Any Buys above 1000 Tokens within the first 20 Blocks(5 Minutes) 
pay marginal 16% burn fee for the amount above 1000
...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        uint earlyPenalty = 16; //on any tokens above 1000 before the 15th block
        uint amountRec = amount;
        uint amountLimit = 1000e18;
        uint amountBurn = 0;
...
contract PARENTHESIS is ERC20, ERC20Detailed {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint;

  
  constructor () public ERC20Detailed("UniLaunchpad.com | PARENTHESIS", "(())", 18) {
      admin = msg.sender;
