...
Stable Blockchain Ecosystem
The goal of our project is to provide the user of the Stable Blockchain ecosystem with a full range of tools for handling cryptocurrencies (SBW-SBS-SBL-SBC)


Official site - https://stable-blockchain.io
Telegram Channel - https://t.me/stableblockchain
Twitter - https://twitter.com/S_Blockchain_io


A reliable financial ecosystem is required that would allow to safely and conveniently process all popular cryptocurrencies and unlimitedly use them for payments without a need to leave the ecosystem.
It is also important for such a platform to provide secure access to funds from all platforms to make users confident in its reliability and allow them to choose the right product for themselves.
...
contract SBC is Context, IERC20, Ownable {
    ...
    string private _name = 'Stable Blockchain';
