...
contract Drip is Context, IERC20, Ownable {
    ...
    // Start with 2%
    uint256 private _inverseFeeRate = 50;
    uint256 private _inverseFeeRateTimes100 = 100 * 50;

    string private _name = 'dripper.finance';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        // whitelist
        if (_noFeeOnSend[sender] || _noFeeOnReceive[recipient]) {
    ...
    function _ceil(uint256 a, uint256 m) public pure returns (uint256) {
        return ((a + m - 1) / m) * m;
    }
}