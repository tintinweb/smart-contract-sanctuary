...
contract SHIBALIEN is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "SHIBALIEN";
    string constant _symbol = "SHIBALIEN";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xb5C5631726ED45467F4ee3d9dad71D77943A1387);
	    teamFeeReceiver = address(0xb5C5631726ED45467F4ee3d9dad71D77943A1387);
