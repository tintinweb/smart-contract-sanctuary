...
// File: contracts/IBeardGangLandNFTToken.sol
 ...
 */
interface IBeardGangLandNFTToken {
    /**
...
contract Crowdsale is Context, ReentrancyGuard  {
     ...
     */
    constructor (address payable __wallet, IBeardGangLandNFTToken __token) public {
     ...
     */
    function token() public view virtual returns (IBeardGangLandNFTToken) {
        return _token;
    }
...
abstract contract TimedCrowdsale is Crowdsale {
    ...
    constructor (uint256 __openingTime, uint256 __closingTime) {
        ...
        require(__closingTime > __openingTime, "TimedCrowdsale: secondary sale time is not before closing time");
...
// File: contracts/BeardGangLandNFTICO.sol
...
contract BeardGangLandNFTICO is
    Crowdsale,
    CappedCrowdsale,
    TimedCrowdsale,
    Ownable
        ...
        internal virtual override onlyWhileOpen
    {
        ...
        require(currentMinted() <= _cap, "BeardGangLandNFTICO: cap exceeded");
        require(weiAmount.div(mintAmount) == rate(), "BeardGangLandNFTICO: Invalid ETH Amount");

        // Validate inputs
        require(weiAmount != 0, "BeardGangLandNFTICO: ETH sent 0");
        require(_beneficiary != address(0), "BeardGangLandNFTICO: beneficiary zero address");
