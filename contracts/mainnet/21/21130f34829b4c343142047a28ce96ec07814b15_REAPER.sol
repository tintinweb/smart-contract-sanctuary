...
/**
    REAPER (R3P) is a soft fork of Reflect (RFI) that incorporates adjustable
    yield rates (so early buyers can continue to earn reasonable yields as
    more holders enter the ecosystem). REAPER (R3P) also has a deflationary supply 
    and fair-launch mechanisms to ensure a healthy distribution of tokens.
    
    Website: https://reaper.finance
    Telegram: https://t.me/reaperfinance
...
contract REAPER is Context, IERC20, Ownable {
    ...
    string private _name = 'reaper.finance';
    string private _symbol = 'R3P';
