...
contract Wojak is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2000000000 * 10**18;
    ...
    bool private takefeeEnabled = false;
    ...
    function setFeeEnabled(bool onoff) external onlyOwner() {
        takefeeEnabled = onoff;
    }
