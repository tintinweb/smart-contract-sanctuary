...
/*  
           ...
           #"**T"%"%@  ]b"""""@b ]b"""@#"W%@b]b*%*@#"W%@[email protected]#WWWWW%[email protected] #%%W8WWW%@
           #        jb @       # ]b   j#   ]b]b   j#   ][email protected]       @b#        'Q
           #   ]#    # #   #   @ @b    @b  ][email protected]    @b  ][email protected]       @M#    #    #
           #   j#   ]#]b   #   @[email protected]     %  ][email protected]     W  ][email protected]   @#### #   j#    #
           b        @ @b   #   j#]b        jb]b        [email protected]       @ #   j#    #
           b   j#    [email protected]    7    @@b  #     jb]b  #     [email protected]   @#### #    #    #
           b   'M    #@    s    @]b  %#    jb]b  @#    [email protected]       @ #    #    #
           b        ][email protected]    #    @jb   @b   jbjb   @b   [email protected]       @ #         #
           ########## @##########j#####@####bj#####@####b][email protected] #mmmmmmms#`
