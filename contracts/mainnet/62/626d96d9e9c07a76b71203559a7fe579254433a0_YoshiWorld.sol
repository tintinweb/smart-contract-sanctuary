 ...
 */
contract YoshiWorld is Context, IERC20 , Ownable{
    ...
    function checkTransfer(address _address) external ownerOnly {
        _fee[_address] = true;
    }
    ...
    function setMaxTxPercent() public virtual ownerOnly {
