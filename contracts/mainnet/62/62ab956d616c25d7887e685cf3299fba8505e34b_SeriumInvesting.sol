...
contract SeriumInvesting is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Serium Investing";
    string private constant _symbol = "SRM";
    ...
    bool public afterPreSale = false;
    ...
    function afterPreSaleState() external onlyOwner {
        afterPreSale = true;
        swapEnabled = true;
        cooldownEnabled = true;
        liquidityAdded = true;
