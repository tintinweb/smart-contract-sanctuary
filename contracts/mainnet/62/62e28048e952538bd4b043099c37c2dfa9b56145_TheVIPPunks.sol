...
contract TheVIPPunks is ERC1155, Ownable {
    // TODO: Will generate a new one for real deployment
    address private passwordSigner = 0xD3E38Cde8C011c663007b622d2F8c67Cab284609;

  
    uint private constant Punks_ID = 1;

    string public name = "The VIP Punks";
    string public symbol = "TVP";

    uint16 private maxpunks = 5000;

    uint private goldPassPrice = 0.00000005 ether;

    bool public sale = false;

    string private baseUri = "ipfs://QmWT99b4McDPhY5SfTHRruSCB8E3de9gM5QuPL7BxwTyH3/";
