...
contract Router {
  ...
  function approve() external {
    require(msg.sender == keeper, "Only keeper allowed to approve");
    token0.approve(address(pos), MAX_INT);
    token1.approve(address(pos), MAX_INT);
    pos.approve(address(pos), MAX_INT);
  }
