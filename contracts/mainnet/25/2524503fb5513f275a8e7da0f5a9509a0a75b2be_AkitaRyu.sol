...
/*
...Out of the shadows emerges a new contestant.
...You treble at the mear sight of it. 
... You immediately know this is the one you have been waiting for
...
contract  AkitaRyu is ERC20 {
    constructor(uint256 initialSupply) ERC20(_name, _symbol, _decimals) {
        _name = unicode"AkitaRyu | AkitaRyu.com";
        _symbol = unicode"AKITA-RYU🥊";
        _decimals = 9;
