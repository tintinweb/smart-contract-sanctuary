...
contract ARABMETA is ERC721Enumerable, Ownable {
    ...
    uint16 public maxMintAmountPerWalletWL = 10;
    ...
    constructor(string memory _notRevealedUrl) ERC721("ARAB META", "AMSC") {
    ...
    function mintWhitelist(uint256 mintAmount,bytes32[] calldata proof) public payable onlyEOA(){
		...
		if (msg.sender != owner()) {
            ...
            require(msg.value >= whitelistCost * mintAmount, "Insufficent funds");

            if(WHITELISTTRACKER[msg.sender]._ISEXIST){

                require((WHITELISTTRACKER[msg.sender]._AMOUNT + mintAmount) <= maxMintAmountPerWalletWL, "Sorry you cant mint any more"); 
                 ...
                 require(mintAmount <= maxMintAmountPerWalletWL, "Sorry you cant mint more"); 
    ...
    function mint(uint256 _mintAmount) public payable onlyEOA(){
        ...
        if (msg.sender != owner()) {
            ...
            require(_mintAmount <= maxMintAmountPerTransaction, "Sorry you cant mint more than this amount at once");
    ...
    function airdrop(address[] memory _airdropAddresses) public onlyOwner {
        ...
        require(supply + _airdropAddresses.length <= maxSupply, "Exceeds Max Supply");
