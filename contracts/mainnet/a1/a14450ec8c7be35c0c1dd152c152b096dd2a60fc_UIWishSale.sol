...
/**
 * The UIWishSale smart contract is used for selling UIWish tokens (UI).
...
contract UIWishSale is Pausable {
    ...
    /**
     * Constructor for a crowdsale of UIWish tokens.
     *
     ...
     * @param rateUIToEther                 the conversion rate from UI to Ether
    ...
    function () public payable whenNotPaused beforeDeadline afterStartTime saleNotClosed nonReentrant {
        ...
        // and UI have the same number of decimal places (18)
