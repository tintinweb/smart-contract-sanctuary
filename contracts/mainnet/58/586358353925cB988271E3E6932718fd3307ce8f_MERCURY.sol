...
7% token burn per transfer for MERC

100,000 MERC initial supply
...
contract MERCURY is ERC20, ERC20Detailed {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint;

  
  constructor () public ERC20Detailed("UniLaunchpad.com | MERCURY", "MERC", 18) {
      admin = msg.sender;
