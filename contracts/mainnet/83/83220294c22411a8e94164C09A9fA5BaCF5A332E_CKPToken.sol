...
contract CKPToken is TimeLockToken, FreezableToken, PausableToken, BurnableToken {
    string public constant name = "CKP Token";
    string public constant symbol = "CKP";
    uint public constant decimals = 18;

    uint public constant INITIAL_SUPPLY = 50000 * (10 ** decimals);
