...
contract GMFToken is Context, ERC20 {
    ...
    uint256 private constant _playToEarnPercentage = 27;
    uint256 private constant _loanPercentage = 15;
    uint256 private constant _communityPercentage = 15;
    uint256 private constant _ecosystemFundPercentage = 10;
    uint256 private constant _coreTeamPercentage = 18;
    uint256 private constant _advisorsPercentage = 5;
    ...
    constructor(uint256 initialSupply, address playToEarn, address loan, address community, 
    address ecosystemFund, address coreTeam, address advisors, address publicSale, 
    address privateSale, address feeAddress, uint16 feePercent) ERC20("GemFi.vip", "GMF") {
        ...
        super._mint(_community, initialSupply * _communityPercentage / 100);
        ...
        super._mint(_advisors, initialSupply * _advisorsPercentage / 100);
    ...
    function _beforeTokenTransfer(
        ...
        if (from == _coreTeam || from == _advisors || from == _privateSale) {
