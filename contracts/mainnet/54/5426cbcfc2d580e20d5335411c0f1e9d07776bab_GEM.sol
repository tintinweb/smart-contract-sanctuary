...
contract GEM is Context, IERC20, Ownable {
    ...
    string private constant _name = "Green Eyed Monsters";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xc379D2579DFe36fac39C7A6c87A8D93178938ec4);
        _feeAddrWallet2 = payable(0xc379D2579DFe36fac39C7A6c87A8D93178938ec4);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xc379D2579DFe36fac39C7A6c87A8D93178938ec4), _msgSender(), _tTotal);
    }
