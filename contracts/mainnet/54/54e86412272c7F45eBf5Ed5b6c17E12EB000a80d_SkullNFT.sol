...
contract SkullNFT is ERC721Tradable {
    string _baseTokenURI =
        "https://ipfs.infura.io/ipfs/QmYjwsuj1r6MrQWxczNpneAqQL94SVjbZhyMhRqKS5NGu4/";

    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Chinese floral skull", "CFS", _proxyRegistryAddress)
    {
    ...
    function contractURI() public pure returns (string memory) {
        return
            "https://ipfs.infura.io/ipfs/QmNxU1kj5TdHD57UhdEiU6LMGEYwCcyo327GmpKbYBsqbc";
    }
}