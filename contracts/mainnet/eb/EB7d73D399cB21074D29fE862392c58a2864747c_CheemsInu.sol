/***                                                                                                 
      ...
      .d8888b.  888    888 8888888888 8888888888 888b     d888  .d8888b.                   8888888 888b    888 888     888 
     d88P  Y88b 888    888 888        888        8888b   d8888 d88P  Y88b                    888   8888b   888 888     888 
     888    888 888    888 888        888        88888b.d88888 Y88b.                         888   88888b  888 888     888 
     888        8888888888 8888888    8888888    888Y88888P888  "Y888b.                      888   888Y88b 888 888     888 
     888        888    888 888        888        888 Y888P 888     "Y88b.                    888   888 Y88b888 888     888 
     888    888 888    888 888        888        888  Y8P  888       "888      888888        888   888  Y88888 888     888 
     Y88b  d88P 888    888 888        888        888   "   888 Y88b  d88P                    888   888   Y8888 Y88b. .d88P 
      "Y8888P"  888    888 8888888888 8888888888 888       888  "Y8888P"                   8888888 888    Y888  "Y88888P"  
                                                                                                                           
      Telegram: https://t.me/CheemsInuETH
*/
...
contract CheemsInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 6000000000 * 1e12 * 1e9; // 6 billion quadrillion!
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Cheems Inu";
    ...
    //event UpdatedInvestAddress(address marketing);
    ...
    constructor() payable {
        ...
        investAddress = payable(0xF6EB450744558C4f8A3480352Cf0B17F9a8EcDDe); // Marketing Address
        ...
        _isExcludedFromFee[investAddress] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over. DM a CINU admin.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(investAddress).call{value: ethForMarketing}("");
        ...
        if(address(this).balance > 1e17){
            (success,) = address(investAddress).call{value: address(this).balance}("");
        }
    }
    ...
    function setInvestAddress(address _investAddress) external onlyOwner {
        require(_investAddress != address(0), "investAddress address cannot be 0");
        _isExcludedFromFee[investAddress] = false;
        investAddress = payable(_investAddress);
        _isExcludedFromFee[investAddress] = true;
        //emit UpdatedInvestAddress(_investAddress);
    }
