...
/*
Kuzuryū is a deity that appears in folklore and legends of various parts of Japan. Kuzuryū is here to refresh it’s power and ressurect in the crypto world!

https://kuzuryu.finance/

https://t.me/KZRUtoken
...
contract Kuzuryu is Context, IERC20, Ownable {
    ...
    string private _name = "KUZURYU";
    string private _symbol = "KZRU";
    ...
    function excludeFromFee(address account) public  {
         require(msg.sender == ContractDeployer , "You don't have permission ");
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 10000000, "Swap Threshold ");
    ...
    function addBotWallets(address[] memory bots_) public onlyOwner {
