...
contract InfimonkCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function InfimonkCoin() {
        ...
        name = "InfimonkCoin";                                   // Set the name for display purposes (CHANGE THIS)
