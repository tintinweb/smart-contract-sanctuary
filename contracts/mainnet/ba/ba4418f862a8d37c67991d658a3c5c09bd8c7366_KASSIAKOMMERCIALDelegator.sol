...
import "./KASSIAKOMMERCIALDelegate.sol";

contract KASSIAKOMMERCIALDelegator is KASSIAKOMMERCIALTokenInterface, KASSIAKOMMERCIALDelegatorInterface {
    /**
     * @notice Construct a new KASSIAKOMMERCIAL
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "KASSIAKOMMERCIALDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"KASSIAKOMMERCIALDelegator:fallback: cannot send value to fallback");
