...
/**
 * @title Compound's CPoRDelegator Contract
 * @notice CPoRTokens which wrap an EIP-20 underlying and delegate to an implementation
 *  and checks a proof-of-reserves feed before minting.
 * @author Compound
 */
contract CPoRDelegator is CPoR, CDelegatorInterface {
    /**
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "CPoRDelegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"CPoRDelegator:fallback: cannot send value to fallback");
