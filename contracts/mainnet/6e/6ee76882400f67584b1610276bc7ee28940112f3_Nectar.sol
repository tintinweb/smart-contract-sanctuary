...
contract Nectar is ERC20Detailed, ERC20Pausable, ERC20Burnable {
    ...
    constructor() ERC20Detailed("Nectar Token", "NTA", 10) public  {

        _mint(0xB6Bc51B3ca9cc11D99b7F53E6aFF4FD1166640c7, 27060000000 * (10 ** 10));
        _mint(0x657e42fB820B5BCaD47BfF757e737B455c04AFDc, 18009000000 * (10 ** 10));
        _mint(0xF60bf94295eC62A21B271c5d17A5692261a2C34a, 9240000000 * (10 ** 10));
        _mint(0xcC56180dD17D37dfFc87E1F49e990E7D6286502A, 7452000000 * (10 ** 10));
        _mint(0x9457a6bb4A2F7AFA6331992E5c8199B536521d06, 6003000000 * (10 ** 10));
        _mint(0x8364e27647acD1dd3A2461990322396999E6fe17, 3920000000 * (10 ** 10));
        _mint(0xfe494883F2a5AB8154157FBDb8fBE8b583572755, 3883320000 * (10 ** 10));
        _mint(0x5343995f03677f0810AA7AB0fc0d5E4fdD68dE25, 3640000000 * (10 ** 10));
        _mint(0x6Ba4E9d85Db3239205130a8405886f74f3dAB0C4, 1912680000 * (10 ** 10));
        _mint(0xBD555475D029A741E8d5DF1391DdF2EE6072DF0a, 1680000000 * (10 ** 10));
