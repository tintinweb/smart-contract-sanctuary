...
/**
    ...
    ᴡᴏᴊᴀᴋ ʙʀᴀɪɴ ᴄᴀᴘɪᴛᴀʟ ᴅᴀᴏ

    Telegram | https://t.me/wbcdportal

    Website | https://www.wojakbraincapital.net/
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a WBCD shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract WojakBrainCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Wojak Brain Capital DAO";
    string private constant _symbol = "WBCD";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 4200000000000 * (10 ** _decimals);
    ...
    address payable public marketingWallet = payable(0x68891E0C80fb240769aE74Bbad73f1fbc4d7DECa);
    address payable public treasury = payable(0x68891E0C80fb240769aE74Bbad73f1fbc4d7DECa);
    ...
    uint256 private maxBuy = 84000000000 * (10 ** _decimals);
    ...
    constructor (    ) Auth(0x147Af2f525F1bb0188b7e107D27fAA213f7aA2D3) {
        address _owner = 0x147Af2f525F1bb0188b7e107D27fAA213f7aA2D3;
