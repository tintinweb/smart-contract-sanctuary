...
contract DonDogelon is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Dondogelon';
    string  private constant _SYMBOL = 'dondogelon';
    ...
    uint256 private _tTotal = 400000000 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 400000000 * _DECIMALFACTOR;
