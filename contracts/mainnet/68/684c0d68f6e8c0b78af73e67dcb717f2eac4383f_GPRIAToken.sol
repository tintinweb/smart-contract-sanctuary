...
contract GPRIAToken is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = " GPRIA";
    string public constant symbol = " GPRIA";
    ...
    function  GPRIAToken() public CappedToken(TOKEN_CAP) {
