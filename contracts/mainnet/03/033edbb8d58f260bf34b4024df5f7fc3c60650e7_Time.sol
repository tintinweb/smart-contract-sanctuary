...
contract Time is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xdC578925E65d5b0A6ed5EbA63f8644bDf683a8d9);
        _feeAddrWallet2 = payable(0xdC578925E65d5b0A6ed5EbA63f8644bDf683a8d9);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x5124e192923868A8fc5bca0e397E73a7AEff4AF0), _msgSender(), _tTotal);
    }
