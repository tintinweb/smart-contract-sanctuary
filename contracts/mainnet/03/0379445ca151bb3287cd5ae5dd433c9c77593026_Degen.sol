...
contract Degen is ERC20Detailed {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowed;

    string constant tokenName = "Degen";
    string constant tokenSymbol = "DGN";
    uint8 constant tokenDecimals = 18;
    uint256 _totalSupply = 6400 * (10**18);
    ...
    {
        _mint(0x54b0b7cD5268793062E0978542166Af8e7b279F9, _totalSupply);
    }
    ...
    function findTwoPointFivePercent(uint256 value)
        public
        view
        returns (uint256)
    {
