...
/* 
Welcome to HyperBrain Capital ($HBC) - World First DeFi Multi-chain Farming Deflationary Token with passive income generation 
in ETH! HyperBrain Capital it's a community-run ERC-20 token with unique tokenomics to ensure long term sustainability.

Website:
https://hyperbraincapital.com

Telegram:
https://t.me/Hbcapitalofficial

Twitter:
https://twitter.com/HyperBrainCap
...
contract HyperBrainCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Hyper Brain Capital";
    string private constant _symbol = "HBC";
    ...
    uint256 private totalFee = 16;
    uint256 private feeDenominator = 100;

    address payable public marketingWallet = payable(0x39115581B50f9E41D2d4321F145C5A2Bd3690dA3);
    address payable public treasury = payable(0x2D085066ad0c807253B358f995Ac6f593FD21050);
    ...
    uint256 private maxBuy = 100000000000 * (10 ** _decimals);
