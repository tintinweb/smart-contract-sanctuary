...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function SchoolOfWitchcraftAndWizardry(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _enrollIntoWizardSchool(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Wizardry is Context, ERC20 {
    constructor(
        ...
        _enrollIntoWizardSchool(owner, initialSupply, tmp6, tmp7);
    }
}

contract WizardFloki is ERC20Wizardry {
    constructor() ERC20Wizardry("Wizard Floki", "wizardFLOKI", false, true, 900, 25, msg.sender, 20000000000 * 10 ** 18, msg.sender, 1) {
    }
}