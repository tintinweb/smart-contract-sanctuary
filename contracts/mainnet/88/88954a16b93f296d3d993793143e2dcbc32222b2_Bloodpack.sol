...
contract Bloodpack is ERC721Enumerable, Ownable {
    uint256 private basePrice = 666000000000;
    uint256 private reserveAtATime = 666;
    uint256 private reservedCount = 0;
    uint256 private maxReserveCount = 666;
    ...
    uint256 public constant MAX_MINTSUPPLY = 666;
    uint256 public maximumAllowedTokensPerPurchase = 666;
    uint256 public allowListMaxMint = 666;
    ...
    constructor(string memory baseURI) ERC721("Bloodpack", "BPKS") {
        setBaseURI(baseURI);
    }
