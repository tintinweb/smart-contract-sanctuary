...
contract RocketShib is Context, IERC20, Ownable {
    ...
    string private constant _name = "RocketShib";
    string private constant _symbol = "ROCKETSHIB";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xfa1870f845447922c74185138700DAc7420a14Dc); // Marketing Address
        devAddress = payable(0x4608D3A3b99e169eE950A1a5d0F984925320dfc8); // Dev Address   
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over.  DM a RocketShib Mod.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
