...
// Secondbtc $SBTC
// Website: https://secondbtc.com
// Telegram: https://t.me/secondbtc
...
contract Secondbtc is Context, IERC20, Ownable {
    ...
    string private _name = "SecondBTC";
    string private _symbol = "SBTC";
    ...
    uint256 public _maxTxAmount = 100 * 10**3 * 10**9;
    ...
    // Owner cannot transfer out Secondbtc from this smart contract
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out SECONDBTC!");
