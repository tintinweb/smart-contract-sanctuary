...
contract XQSTME is ERC721Enumerable, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount + _reserved <= maxSupply, "No more XQST.ME to Mint");
  ...
  function preSaleMint(uint256 _mintAmount) public payable {
    uint256 supply = totalSupply();
    require(!paused_premint, 'Premint for XQST.ME is not active');
