...
contract DP is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dont Panic";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5B9183D0b88AA40dfCcBc43DD1e740E04FC9c09D);
        _feeAddrWallet2 = payable(0x5B9183D0b88AA40dfCcBc43DD1e740E04FC9c09D);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xB32B4350C25141e779D392C1DBe857b62b60B4c9), _msgSender(), _tTotal);
    }
