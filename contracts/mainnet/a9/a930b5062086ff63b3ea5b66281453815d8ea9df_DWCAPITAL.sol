...
From the devs of CAT (Capital Aggregator)
We present DW Capital - Dont worry your profits are SAFU
...
contract DWCAPITAL is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "DONT WORRY CAPITAL";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0xd5ab171Ec8165C2245b5c5457b50740FA4750EBE);
        _feeAddrWallet2 = payable(0xd5ab171Ec8165C2245b5c5457b50740FA4750EBE);
        ...
        emit Transfer(address(0x7786B2455637420c7752D48bEe485F00E4c6aa6a), _msgSender(), _tTotal);
    }
