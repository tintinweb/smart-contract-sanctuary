...
// $PUSSC | Pussy Credit V2
// Envisioned & Designed by @1goonrich
// Telegram: https://t.me/PussyCredit
// Website: https://PussyCredit.com

// Originally Fair Launched, redeployed due to contract bug.

// Supply re-scaled to 1Q tokens, converted to deflationary.
// Holders airdropped with 60% supply (scaled to liquidity), 40% LP

// Slippage Recommended: 11%
...
contract PussC is Context, IERC20, Ownable {
    ...
    string private _name = 'PussyCredit V2 | PussyCredit.com';
