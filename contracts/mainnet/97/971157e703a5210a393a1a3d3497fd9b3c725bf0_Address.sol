...
contract Ninja_Mouse is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.063 ether;
  ...
  constructor() ERC721("Ninja_Mouse", "SHNM") {
    setHiddenMetadataUri("ipfs://QmVdpgitQ8zHv9L5PKuWupEcZUm762mc6vpimnJkwFr8KG/hidden.json");
  }
