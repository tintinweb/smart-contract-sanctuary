...
/**
- Piranhas Finance 🐟🐠🐡🦈 
- Web - https://piranhas.finance
- Ethereum based DeFi project with gamification.
- Go hard or go home.
- Contact: @fisherman_dave
 * 
*/
...
contract PIR is Context, IERC20, Ownable {
    ...
    string private _name = 'Piranhas Finance piranhas.finance';
    string private _symbol = 'PIR';
