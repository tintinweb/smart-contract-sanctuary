...
/**
 *  Website: https://icediamond.finance/
 *  Telegram: imond_official
*/
...
contract PETUSINU is Context, IERC20, Ownable {
    ...
    string private _name = 'PETUS Inu'; 
    string private _symbol = 'PETUS';
