...
// File: contracts/BMITokenVestingV2.sol
...
contract BMITokenVestingV2 is Initializable, OwnableUpgradeable {
  ...
  function applyChangesV2() external onlyOwner {
    address[4] memory cancelBeneficiaries = [
      address(0xF4DCfDed946A669d0017C3C81496db20B6d2371d),
      address(0x266B5cc9A2F86D63E53169C30258E36D214FeFA6),
      address(0x0c73E0F016ddE008822897dbDc3C3Ea0d2f96aAf),
      address(0x56Ef1cb175b52Bf144e4855bf399a51138CEF229)
    ];
    uint256[4] memory cancelVestingIds = [
      uint256(15),
      uint256(16),
      uint256(157),
      uint256(180)
    ...
    for (i = 0; i < 4; i++) {
      uint256 vestingId = cancelVestingIds[i];
      Vesting storage vesting = getVesting(vestingId);
      require(vesting.beneficiary == cancelBeneficiaries[i], "Beneficiary is not expected");
      _forceCancelVesting(vestingId, vesting);
    }

    address[4] memory changeFromBeneficiaries = [
      address(0xBd8fC01D8f6C2d027B601c9CAb32e635bdD47179),
      address(0x9fAf98B9B3C52af5D6F251e29Cc1B8C01D8c96F7),
      address(0xFe8Be8DdCc9B4b022B421c17e16602be48dd4C65),
      address(0x896D672217433135E7fEbec1fDfBD7fd04Ce572d)
    ];

    address[4] memory changeToBeneficiaries = [
      address(0xc58d5e3e19A62FcB14ac393661d3a6b870A49Ec7),
      address(0x23aAC8D32888D2C176D7b4Fb764c70061f0533A2),
      address(0xb193e62e80C82b4a691282208fE21De8C7557a5f),
      address(0x3A407BBC7559d89956A48b75be3BF41D23372Ee1)
    ];

    uint256[4] memory changeVestingIds = [
      uint256(97),
      uint256(120),
      uint256(210),
      uint256(194)
    ...
    for (i = 0; i < changeVestingIds.length; i++) {
