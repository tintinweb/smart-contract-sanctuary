...
// File: contracts/strategies/StabilizeStrategyXUSDWithdraw.sol

pragma solidity =0.6.6;

// This is a strategy used to allow users to withdraw their underlying tokens from the pool

contract StabilizeStrategyXUSDWithdraw is Ownable {
    using SafeMath for uint256;
    ...
    function finishChangeZSToken() external onlyGovernance timelockConditionsMet(2) {
