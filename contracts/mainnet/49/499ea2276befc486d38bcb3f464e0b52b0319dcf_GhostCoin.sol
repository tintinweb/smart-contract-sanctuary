...
//Official Telegram --- https://t.me/GhostCoinERC
//Official Website  ---  https://www.ghostcoinerc20.com
...
contract GhostCoin  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "GhostCoin";                                          
    ...
    uint256 public _maxTxAmount = _tTotal.div(1).div(40);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0x8216e1998Dff54dc4e651B0Fed4905E60CB89C1a);
