...
contract GADOSHI is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'GaDoShi';
    string  private constant _SYMBOL = 'GADOSHI';
    ...
    uint256 private _MAX_TX_SIZE = 50000000 * _DECIMALFACTOR;
