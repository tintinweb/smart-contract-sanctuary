...
contract SNOWKI is Context, IERC20, Ownable {
    ...
    address private _owner = 0x8Ead0DFab2eAC56126888Fa22ABB1f02225570f2; //owner of the contract
    ...
    string private constant _name = "SNOWKI";
    string private constant _symbol = "SNOWKI";
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 0;
        _rOwned[address(this)] = _rTotal / 100 * 100;
        
         
        _maxTransactionAmount = _tTotal * 5 / 1000; // 0.5% max trx 
        _maxWalletAmount = _tTotal * 10 / 1000; // 1.0% max Wallet
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x1108A47FABF5D0D1a049Dd1301698e5Fe62B3A3f); // Marketing Wallet
        
        devAddress = payable(0xB8C365690fF6f9EEB3fc3D80d31642D1a19E6dcC); // TEAM Wallet 
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 0 / 1000);
    ...
    //change wallet and maxtrx
    function changeMaxTransaction(uint256 newLimit) public onlyOwner {
    _maxTransactionAmount = newLimit * 10**9;
    }

    function changeMaxWallet(uint256 newLimit) public onlyOwner {
    _maxWalletAmount  = newLimit * 10**9;
    }
