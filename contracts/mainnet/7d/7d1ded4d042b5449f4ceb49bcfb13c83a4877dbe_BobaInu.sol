...
contract BobaInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xAC9e2A03c2669324Bb071059b0e0932199849A1b);
        _feeAddrWallet2 = payable(0xAC9e2A03c2669324Bb071059b0e0932199849A1b);
