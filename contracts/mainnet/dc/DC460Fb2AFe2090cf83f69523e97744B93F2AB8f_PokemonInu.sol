...
/*
    TG: https://t.me/PokemonInuToken
    WEB: http://pokemoninutoken.com
*/
...
contract PokemonInu is Context, IERC20, Ownable {
    ...
    uint256 public swapThreshold = 5e9 * 10**9;

    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 public _feeAddr1 = 1;
    uint256 public _feeAddr2 = 12;
    address payable private _feeAddrWallet1;
    address payable private _feeAddrWallet2;

    string private constant _name = "PokemonInu";
    string private constant _symbol = "$PokemonInu";
    ...
    event SwapThresholdUpdated(uint tokens);
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x2e46A548D63EC5d38C864eB37D58E08830664c42);
        _feeAddrWallet2 = payable(0x91F07eEe0767F6B5139a01461D5b4765b6Cf79d0);
    ...
    function setSwapThreshold(uint tokens) external onlyOwner() {
        swapThreshold = tokens;
        emit SwapThresholdUpdated(tokens);
    }
