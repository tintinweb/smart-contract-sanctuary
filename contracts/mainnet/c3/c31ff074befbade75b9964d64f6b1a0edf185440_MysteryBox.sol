...
contract MysteryBox is ERC721Enumerable, Ownable {
    ...
    uint public constant MAX_ENTRIES = 7777;

    constructor() ERC721("Mystery Box", "MBOX")  {
        setBaseURI("https://api.mysteryboxnft.net/");
    }
