...
contract NorthAmericaPoolToken is ERC20, ERC20Detailed, ERC20Pausable, Ownable {
    // metadata
    string public constant tokenName = "NorthAmericaPoolToken";
    string public constant tokenSymbol = "NAP";
