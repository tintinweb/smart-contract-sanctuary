...
/*
https://twitter.com/boruto_inu?s=21
https://t.me/borutoinu

3 Protections:
1. Antisnipe - Prevents trading or transfers of any kind if bought in the first few blocks since liquidity is added.
2. Antigas - Rejects transactions that use too high of a gas price value.
3. Antiblock - Rejects multiple transactions in the same block by the same user.
