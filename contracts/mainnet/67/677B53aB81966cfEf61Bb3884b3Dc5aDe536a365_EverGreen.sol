...
// EverGreen is a proprietary, deflationary token dedicated to saving our planet and giving bonus rewards to our holders every 12 hours in the form of ETH automatically deposited into their wallet! We at EverGreen also have Anti-Bot and Anti-Whale features built into our contract to prevent pump & dumps.

// ✅ Useful links:
// ✅ Telegram: https://t.me/evergreen_erc20
// ✅ Website: https://evergreentoken.cc/
...
contract EverGreen is Context, IERC20, Ownable {
    ...
    string private _name = 'evergreentoken.cc';
    string private _symbol = 'EverGreen';
