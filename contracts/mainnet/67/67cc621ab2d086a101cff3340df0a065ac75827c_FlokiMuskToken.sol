...
contract FlokiMuskToken is ERC20Interface, SafeMath {
    ...
    constructor (address developerWalletAddress) public {
        symbol = "FLOKI";
        name = "Floki Musk";
        decimals = 18;
        _totalSupply = 1000000000000* 10**18;
        _balances[developerWalletAddress] = _totalSupply;
        emit Transfer(address(0), developerWalletAddress, _totalSupply);
    }
