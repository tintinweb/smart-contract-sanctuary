...
contract Roaring20s is Context, IERC20, Ownable {
    ...
    string private constant _name = "Roaring 20s";
    string private constant _symbol = "R20";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xDE45F63CfB6095B87DB1658ade55780430694a68);
        _feeAddrWallet2 = payable(0xDE45F63CfB6095B87DB1658ade55780430694a68);
