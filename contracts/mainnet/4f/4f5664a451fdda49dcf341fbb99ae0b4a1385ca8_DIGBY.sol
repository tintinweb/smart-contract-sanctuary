...
// https://en.wikipedia.org/wiki/Digby,_the_Biggest_Dog_in_the_World

// First there was Clifford, then there was Fluffy, now there is Digby.

// Digby is the big dog token to end all big dog tokens. DIGBY IS THE BIGGEST DOG IN THE WORLD.

// TELEGRAM: https://t.me/DIGBYTOKEN
// WEBSITE: https://bigdogdigby.com/ 
...
contract DIGBY is Context, IERC20, Ownable {
    ...
    string private _name = "DIGBY INU";
    string private _symbol = "DIGBY";
