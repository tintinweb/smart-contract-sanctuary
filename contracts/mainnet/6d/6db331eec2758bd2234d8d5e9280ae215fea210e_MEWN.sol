...
contract MEWN is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public constant uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

    uint256 public txFees = 6;

    uint256 public _tTotal = 7e10 * 10**9;                         
    uint256 public swapAtAmount = _tTotal.mul(1).div(1000);      
    uint256 public maxTxLimit = _tTotal.mul(3).div(100);        
    ...
    constructor(address _dev) public ERC20("Mew Inu", "MEW") {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(
            ...
            from == uniswapV2Pair && 
            to != uniswapV2Pair && 
            block.number < launchDeadBlock + 5 &&
