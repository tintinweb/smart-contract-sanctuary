...
contract FourTwentyPepeERC is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        emit Transfer(address(0x7902377F66763Eb1d5688Df0F8bAaFf30cF7bC38), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external {
        //Trading can not be closed once opened!
        require(!tradingOpen,"trading is already open");
        require(_msgSender() == owner(),"Only owner can open the trade.");
