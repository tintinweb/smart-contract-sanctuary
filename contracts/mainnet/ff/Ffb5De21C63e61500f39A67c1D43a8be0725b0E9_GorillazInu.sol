/***
    ...
    Gorillaz Inu - $GORILLAZINU                                  
     
    Telegram: https://t.me/GorillazInu
*/
...
contract GorillazInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 444 * 1e12 * 1e9; // 200 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Gorillaz Inu!";
    string private constant _symbol = "GORILLAZINU";
    ...
    uint256 public _sellMarketingFee = 13;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x1F61aF860dA4B8D49fA4b28803dDe29A063c7514); // Marketing Address
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 20 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 980 / 1000);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over. DM a GORILLAZINU admin.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
