...
// File contracts/MallowPunks.sol
...
contract MallowPunks is ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    string public _baseTokenURI;
    uint256 public _price = 20000000000000000; // 0.02 Ether
    uint256 public _maxPreSaleSupply = 2000;
    uint256 public _maxSupply = 10000;
    bool public _preSaleIsActive = false;
    bool public _saleIsActive = false;

    address a1 = 0x1c61A3982f82fAc5794b0217579b2929edb1d5C5;
    address a2 = 0x3A4253d427763f94616D8BBF7D4D0483adf0F29F;
    address a3 = 0x4651E1e7515AF040e139988CD2d8c5417F758D34;

    constructor(string memory baseURI) ERC721("MallowPunks", "MALLOW") {
        setBaseURI(baseURI);
    }
    ...
    function preSaleMint(uint256 mintCount) public payable {
        ...
        require(supply + mintCount <= _maxPreSaleSupply,    "max_token_supply_exceeded");
    ...
    function setMaxPreSaleSupply(uint256 maxPreSaleSupply) public onlyOwner {
        require(maxPreSaleSupply <= _maxSupply, "max_token_supply_exceeded");
        _maxPreSaleSupply = maxPreSaleSupply;
    }
