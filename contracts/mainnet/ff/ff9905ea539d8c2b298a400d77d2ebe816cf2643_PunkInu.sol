...
/**
 *PunkInu is here to rule all the Doggies.
*/
...
contract PunkInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "PunkInu";
    string private _symbol = "Punk Inu";
    ...
    uint256 public _marketingFee4Buyers = 5;
    ...
    address payable public marketingWallet = payable(0x39680713fF9378eDE6E45CdE8dA241c76c7Ac07e);
