...
contract SGRewardSGETHPool is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    // init 5600, total 28000. 30% reduction in production every 7 days
    uint256 public initreward = 5600 * 1e18;
