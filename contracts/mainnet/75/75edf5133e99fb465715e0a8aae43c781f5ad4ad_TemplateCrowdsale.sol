...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Bor Protocol";
    string public constant TOKEN_SYMBOL = "BRP";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0xf5aF490a53e8B87eC26733D8Ea39BcaF7EEeb689;
    
    uint public constant START_TIME = 1617966000;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(4900 * TOKEN_DECIMAL_MULTIPLIER, 0xbD256a6F505F8E179B3D3b709Fb1823Dde71889B, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1618084800)
        CappedCrowdsale(816326530612244897959)
    ...
    function init() public onlyOwner {
        ...
        address[4] memory addresses = [address(0xf5af490a53e8b87ec26733d8ea39bcaf7eeeb689),address(0x4e27d74c6435b85ea56bf2d7e10b6c090a6a3e58),address(0xf5af490a53e8b87ec26733d8ea39bcaf7eeeb689),address(0xf5af490a53e8b87ec26733d8ea39bcaf7eeeb689)];
        uint[4] memory amounts = [uint(500000000000000000000000),uint(1500000000000000000000000),uint(1000000000000000000000000),uint(3000000000000000000000000)];
        ...
        internal
    {
        ...
        require(msg.value <= 15000000000000000000);
