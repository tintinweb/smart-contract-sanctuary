...
contract Core_V3_Finance is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Core V3 Finance";
    string public constant symbol = "C3F";
    ...
    function Core_V3_Finance() public CappedToken(TOKEN_CAP) {
