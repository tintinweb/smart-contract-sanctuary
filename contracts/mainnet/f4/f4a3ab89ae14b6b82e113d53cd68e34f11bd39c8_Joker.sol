...
// Name: Joker token
// Telegram: https://t.me/jokertokeneth
// Website: https://jokertoken.live/
...
contract Joker is Context, IERC20, Ownable {
    ...
    string private _name = "Joker Token";
    ...
    uint256 public _liquidityFee = 10; //liquidity + marketing
    ...
    function blacklistAdress(address addr, bool value) external onlyOwner{
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 liqPart = contractTokenBalance.mul(_marketingDivisor).div(_liquidityFee);
        uint256 halfOfLiquify = liqPart.div(2);
        uint256 otherHalfOfLiquify = liqPart.div(2);
        uint256 marketingPart = contractTokenBalance.sub(halfOfLiquify).sub(otherHalfOfLiquify);
        ...
        sendETHToMarketing(marketingPart);
