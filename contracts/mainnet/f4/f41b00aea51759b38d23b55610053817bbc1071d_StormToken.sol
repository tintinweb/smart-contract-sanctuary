...
contract StormToken is ERC20("Storm Finance", "STORM"), Ownable {
    using SafeMath for uint256;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "Storm Finance::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Storm Finance::delegateBySig: invalid nonce");
        require(now <= expiry, "Storm Finance::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "Storm Finance::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "Storm Finance::_writeCheckpoint: block number exceeds 32 bits");
