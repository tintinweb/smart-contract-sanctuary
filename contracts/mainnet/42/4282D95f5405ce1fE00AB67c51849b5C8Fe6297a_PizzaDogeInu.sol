...
/*
🔥 50% BURN OF TOTAL SUPPLY - TOKENS ARE MORE VALUABLE
🔒 CONTRACT RENOUNCED AND LIQUIDITY LOCKED FOR SIX MONTHS
✨ DAILY COMMUNITY EVENTS
🛠 PIZZADOGE UNDER CONSTRUCTION ETA THE NEXT FEW DAYS FOR RELEASE - EARN PASSIVE INCOME
🚀 FAIR AND SILENT LAUNCH!

TG: t.me/pizzadogeinu
Site: www.pizzadogeinu.com
*/ 
...
contract PizzaDogeInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10* 100 * 10**9 * 10**18;

    string private _name = 'PizzaDogeInu.com';
    string private _symbol = 'PIZZD';
