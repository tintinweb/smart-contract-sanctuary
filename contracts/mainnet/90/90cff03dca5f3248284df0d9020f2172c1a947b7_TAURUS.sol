 ...
 * 
 * 
 * THIS CONTRACT IS A COPY OF HOGE WITH THE FOLLOWING MODIFICATIONS
 *      The fee has been increased from 2% to 3%
 *      The name and symbol have been changed
 *      The initial dsitribution has been changed
...
contract TAURUS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 21 * 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'CosmicBull.finance';
    string private _symbol = 'TAURUS';
