...
contract LoadingDots is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public maxSupply = 3333;
    uint256 public presalePrice = 60000000000000000;
    uint256 public publicPrice = 70000000000000000;
    bool public saleOpen = false;
    bool public presaleOpen = false;
    string public baseURI;

    address wallet1 = 0xb0672c640512ED9677c0047ed6D63ED0cfba068F;
    address wallet2 = 0xA6F3F11E16c5f2F0AB684aa7894D5B1aAa271ca7;

    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Loading Dots', 'DOTS') {}
    ...
    function withdraw() public onlyOwner {
        ...
        payable(wallet1).transfer((balance * 500) / 1000);
        payable(wallet2).transfer((balance * 500) / 1000);
    }
    ...
    function mint(uint256 amount) public payable {
        if (!saleOpen) {
            require(msg.value >= presalePrice * amount, 'Insufficient ETH amount');
        ...
        require(amount <= 30, 'Only 30 per transaction allowed');
        for (uint256 i = 0; i < amount; i++) internalMint(msg.sender);
    }
