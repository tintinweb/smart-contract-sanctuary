...
contract EthereumShiba is Context, IERC20, Ownable {
    ...
    uint256 private _taxFee = 2; // 1% reflection fee for every holder and 1% burn for the dead address
    ...
    address payable private _marketingWalletAddress = payable(0x2E8d0D59998B0AaFb7D3f09A8CbA7711C96B8F53);
