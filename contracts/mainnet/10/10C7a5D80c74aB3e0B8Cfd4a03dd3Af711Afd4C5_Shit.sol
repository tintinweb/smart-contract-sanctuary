...
// File contracts/SHIT/shit.sol



pragma solidity ^0.8.0;

contract Shit is ERC721URIStorage{

  uint256 public totalSupply;

  constructor () ERC721("Sticky Shit", "STST"){
  }
  ...
  function tokenURI(uint256 tokenId) public view override returns(string memory){
      return "https://gateway.pinata.cloud/ipfs/QmeK3WAmWX2mK9eyYb1ooA1C9zmmq3aiqMBk51EGKNEoGs";
  }

  function _transfer(address from, address to, uint256 tokenId) internal override {
      revert("hahaha, you can't move this sh*t!");
  }
