...
contract Keetsu is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 private maxBuyLimit = 7000000000000 * (10**18);
    uint256 public maxWallet = _tTotal.div(10000).mul(105);

    string private _name = "Keetsu";
    ...
    uint256 public _marketingFee = 130;
    ...
    uint256 private routerselllimittokens = 100000000000 * 10**18;
