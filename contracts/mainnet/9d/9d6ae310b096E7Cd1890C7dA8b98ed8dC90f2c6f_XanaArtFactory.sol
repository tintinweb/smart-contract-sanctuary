...
import "./XanaArtTradable.sol";

contract XanaArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new XanaArtTradable contract
        ...
        returns (address)
    {
        ...
        XanaArtTradable nft = new XanaArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing XanaArtTradable contract
    ...
    /// @notice Method for disabling existing XanaArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title XanaArtTradable
 * XanaArtTradable - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract XanaArtTradable is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // Xana Marketplace contract
    address marketplace;
    // Xana Bundle Marketplace contract
    ...
    /**
     * Override isApprovedForAll to whitelist Xana contracts to enable gas-less listings.
     */
    ...
    {
        // Whitelist Xana marketplace, bundle marketplace contracts for easy trading.
