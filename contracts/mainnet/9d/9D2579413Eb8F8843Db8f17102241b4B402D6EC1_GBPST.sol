 ...
 * @title GBPST
 * @author WALLEXTRUST
 * @dev Implementation of the GBPST stablecoin.
 */
contract GBPST is ERC20, AccessControl, Claimer {
    ...
    /**
     * @dev Sets {name} as "GBP Stable Token", {symbol} as "GBPST" and {decimals} with 18.
    ...
    ) public ERC20("GBP Stable Token", "GBPST") {
