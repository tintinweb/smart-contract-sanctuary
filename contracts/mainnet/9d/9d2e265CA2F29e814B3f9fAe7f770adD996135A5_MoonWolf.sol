...
// Welcome to MoonWolf 🐺! 
// MOONWOLF is a community driven project built on Ethereum ERC-20 (ETH). Two functions occur during each trade: Reflection & Burn. MOONWOLF brings the most revolutionary mechanism to ETH ecosystem.

// Every sell and buy transaction is taxed a 7% fee:
// 4% redistributed to holders
// 3% of token will be added into the liquidity pool

// ✅ Useful links:
// ✅ Telegram: https://t.me/moonwolf_one
// ✅ Website: https://MoonWolf.one/
...
contract MoonWolf is Context, IERC20, Ownable {
    ...
    string private _name = 'MoonWolf.one';
    string private _symbol = 'MoonWolf';
