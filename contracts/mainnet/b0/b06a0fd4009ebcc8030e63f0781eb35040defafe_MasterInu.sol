...
/**
    ...
    The master of all inus.
    
    Twitter: @MasterInuToken
    Telegram: https://t.me/MasterInuToken
...
contract MasterInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Master Inu";                                       // name
    string private _symbol = "Master Inu";                                     // symbol
    ...
    address payable public marketingWallet = payable(0x797D8a34AFDF7AF242C4F7E43Fe50a45E6de02Be);   // marketing
