...
// Decimals    : 18
// 
// https://t.me/Doge_Father_Official
...
contract DogeFather is ERC20Interface, Owned, SafeMath {
    ...
    function DogeFather() public {
        ...
        balances[0xC0b5221DDAf215C421fd50Cf12701d9B12894686] = _totalSupply;
        Transfer(address(0), 0xC0b5221DDAf215C421fd50Cf12701d9B12894686, _totalSupply);
    }
