...
contract FLOKIRAI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0x08676BBD598480a1Ec3907c5f3D5f76d3e1A39De); // Marketing Wallet
    address payable private devWallet = payable (0x05f479f5AF507b4C846a680a632180Ef549eBdb4); // dev Wallet
    ...
    uint256 private _tTotal = 10000000000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FLOKIRAI";
    ...
    uint256 public _buyReflectionFee = 20;

    uint256 public _sellLiquidityFee = 60;
