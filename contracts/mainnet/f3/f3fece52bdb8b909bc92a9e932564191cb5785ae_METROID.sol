...
contract METROID is Context, IERC20, Ownable {
    ...
    string private constant _name = "Metroid Dread";
    string private constant _symbol = "METROID";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xaE2eFDB8CbD69D7D948F6f39B9f8bAd527E1AEd7);
        _feeAddrWallet2 = payable(0xA76e90d16601D9b58253748c340e22b3fbdaCCaD);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 45% WHO SELL WITHIN 24 HOURS
            if (_buyMap[from] != 0 &&
