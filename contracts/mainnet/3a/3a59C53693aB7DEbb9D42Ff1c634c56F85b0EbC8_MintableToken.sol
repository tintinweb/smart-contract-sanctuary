...
contract MintableToken is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
    ...
    event SystemSignerChanged(address oldSigner, address newSigner);

    function changeSystemSigner(address _newSystemSigner) public onlyOwner{
    ...
    function mint(uint256 tokenId, uint8 v, bytes32 r, bytes32 s, Fee[] memory _fees, string memory tokenURI) public {
        require(systemSigner == StringLibrary.getAddress(abi.encodePacked(this, tokenId), v, r, s), "owner should sign tokenId");
