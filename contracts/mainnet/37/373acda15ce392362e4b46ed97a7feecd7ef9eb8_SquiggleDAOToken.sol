...
// File contracts/SquiggleDAOToken.sol

pragma solidity >=0.6.0 <0.8.0;

// SquiggleDAOToken on a fixed supply.



contract SquiggleDAOToken is ERC20PresetMinterPauser {    
    // _amount = 100000000000 (mints 10M tokens right away)

    constructor(
        address _vestingBeneficiary,
        uint256 _amount
    ) ERC20PresetMinterPauser('Squiggle DAO Token', 'SQUIG') {
