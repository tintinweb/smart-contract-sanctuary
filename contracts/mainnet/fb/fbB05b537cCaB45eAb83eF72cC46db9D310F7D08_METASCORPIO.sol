...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xbC1fE0400fD81b05729F19Eb8f31841064cB306d), 5000);
        m_DidDeploy = true;
    }
...
contract METASCORPIO is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "META SCORPIO";
    string private m_Symbol = "METCO";
