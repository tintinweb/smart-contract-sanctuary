...
contract MBe is ERC20, Manageable {
    ...
    constructor() ERC20("MegaCryptoPolis Ethereum Token", "$MEGA") public {
        _mint(address(this), cap - 10000*1e18);
        _mint(address(0x333e3763085FC14854978f89261890339cB2F6a9), 10000*1e18);
    }
