...
/**
 * @title Juggernaut XP DeFi ERC20 Token Contract
 * @author 
 *
 * @dev Implementation of the Juggernaut XP DeFi Token.
 */
contract JuggernautXPToken is ERC20Detailed, ERC20Capped, ERC20Burnable, ERC20Pausable {
    string  private constant  TOKEN_NAME     = "Juggernaut XP";
    string  private constant TOKEN_SYMBOL   = "jXP";
