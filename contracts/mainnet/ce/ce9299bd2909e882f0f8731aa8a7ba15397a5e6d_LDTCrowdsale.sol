...
//   }
  ...
  // To start next period at an exact time， third part is better.
 ...
 * NOTICE: HERE we change it as a PeriodCrowdsale
 */
...
contract LDTCrowdsale is TimedCrowdsale {
  ...
  uint256 public openTime = 1538359200; // 2018-10-01 10:00:00
  uint256 public closeTime = 1567303200; // 2019-9-01 10:00:00
  uint256 public _maxPeriodSalesLimit = 10000 *(10 ** 18);

  /**
   * @dev check crowdsale status
   */
