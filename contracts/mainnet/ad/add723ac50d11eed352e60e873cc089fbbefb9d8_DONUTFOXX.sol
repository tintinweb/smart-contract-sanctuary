...
contract DONUTFOXX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"Donut Foxx";
    string private constant _symbol = "Foxx \xF0\x9F\x8D\xA9";
