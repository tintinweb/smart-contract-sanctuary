...
contract  KOBRAKAIMBE  is ERC721Enumerable, Ownable
{
    using SafeMath for uint256;


    uint public constant _TOTALSUPPLY =9100;
    uint public maxQuantity =20;
    uint256 public price = 0.06 ether; 
    bool public isPaused = true;
    uint public reserve = 111;
    uint private tokenId=1;
       

    constructor(string memory baseURI) ERC721("Kobra Kaimbe", "KOKA")  {
        setBaseURI(baseURI);
    }
