...
contract OG is Context, IERC20, Ownable {
    ...
    string private constant _name = "Crypto Twitter OG";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4192990364F1A2e2A948e3f6331Ee52CC76f769A);
        _feeAddrWallet2 = payable(0xB0f365889255F78C7c74598a140c7b26d7d6F6ac);
