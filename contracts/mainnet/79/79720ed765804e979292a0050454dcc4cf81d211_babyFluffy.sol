...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a babyFLUFFY shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract babyFluffy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "babyFluffy Inu";
    string private constant _symbol = "babyFLUFFY";
    ...
    address payable public marketingWallet = payable(0xA85e239FA30e97c637c4EE521b9df1551f08c1d3);
    ...
    constructor (    ) Auth(0x74bef3aA82AB0003C4a8198A96DF8A18b9ce6B75) {
        address _owner = 0x74bef3aA82AB0003C4a8198A96DF8A18b9ce6B75;
