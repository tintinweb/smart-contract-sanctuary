...
// File: contracts/HCLD lowgas.sol
...
contract HypecloudGenesisClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HYPECLOUD GENESIS CLUB", "HGC") {
    setHiddenMetadataUri("ipfs://QmZgGkQwBCm2sS7kotvzcAvAx3qgC3TFaGJA9NXNNawJT9/hidden.json");
  }
