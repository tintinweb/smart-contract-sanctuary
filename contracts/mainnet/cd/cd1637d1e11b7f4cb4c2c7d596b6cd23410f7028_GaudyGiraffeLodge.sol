...
contract GaudyGiraffeLodge is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;

    uint256 public MAX_ELEMENTS = 9876;
    uint256 public PRICE = 2 * 10**16;
    uint256 public MAX_BY_MINT = 5;
    uint256 public giraffe = 30;
	uint256 public giveAways = 1;
	address[] public whitelistedAddresses;
    string public baseTokenURI = "https://gaudygiraffelodge.com/api/giraffe/";
    bool public presale = true;
    address public creatorAddress = 0x4b138Ca2346ECA5b52BAc6f12ac7636494D959a0;
    address public devAddress = 0x3715FBC58Cfd097Fa420961075A3c940c3eB50E4;

    mapping(address => uint256) public userBalance;
    
    constructor() ERC721("Gaudy Giraffe Lodge", "GGL") {
    }
    ...
    function mint(uint256 _count) public payable {
        ...
        require(giraffe + _count <= MAX_ELEMENTS, "Max limit");
	...
	function giveAway(address to) public onlyOwner {
	    require(giveAways <= 30, "max 30 allowed");
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(devAddress, balance.mul(5).div(100));
