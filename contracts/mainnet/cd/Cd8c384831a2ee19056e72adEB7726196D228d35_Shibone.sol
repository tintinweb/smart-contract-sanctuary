...
/*
https://t.me/https://t.me/shibone


We have a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, as a result; $SHIBONE is designed to reward holders and discourage dumping.
...
5. 0,5% transaction limit on launch - You can only buy 5000000000 $SHIBONE until it's lifted
...
8. Sell cooldown increases on consecutive sells, 3 sells within a 4 hour period are allowed
9. 2% redistribution to holders on all buys
10. 6% redistribution to holders on the first sell, increases 2x, 3x on consecutive sells
...
contract Shibone is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Bones for Shiba";
    string private constant _symbol = "\xF0\x9F\x90\x95SHIBONES\xF0\x9F\xA6\xB4";
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                ...
                if (sellnumber[from] == 0) {
                    ...
                    sellnumber[from]++;
                    sellcooldown[from] = firstsell[from] + (4 hours);
                }
