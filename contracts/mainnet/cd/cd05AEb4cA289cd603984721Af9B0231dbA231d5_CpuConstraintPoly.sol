...
contract CpuConstraintPoly {
    ...
    // [0x440, 0x2fc0) - coefficients.
    // [0x2fc0, 0x4960) - oods_values.
    // ----------------------- end of input data - -------------------------
    // [0x4960, 0x4980) - composition_degree_bound.
    // [0x4980, 0x49a0) - intermediate_value/cpu/decode/opcode_rc/bit_0.
    // [0x49a0, 0x49c0) - intermediate_value/cpu/decode/opcode_rc/bit_1.
    // [0x49c0, 0x49e0) - intermediate_value/cpu/decode/opcode_rc/bit_2.
    // [0x49e0, 0x4a00) - intermediate_value/cpu/decode/opcode_rc/bit_4.
    // [0x4a00, 0x4a20) - intermediate_value/cpu/decode/opcode_rc/bit_3.
    // [0x4a20, 0x4a40) - intermediate_value/cpu/decode/opcode_rc/bit_9.
    // [0x4a40, 0x4a60) - intermediate_value/cpu/decode/opcode_rc/bit_5.
    // [0x4a60, 0x4a80) - intermediate_value/cpu/decode/opcode_rc/bit_6.
    // [0x4a80, 0x4aa0) - intermediate_value/cpu/decode/opcode_rc/bit_7.
    // [0x4aa0, 0x4ac0) - intermediate_value/cpu/decode/opcode_rc/bit_8.
    // [0x4ac0, 0x4ae0) - intermediate_value/npc_reg_0.
    // [0x4ae0, 0x4b00) - intermediate_value/cpu/decode/opcode_rc/bit_10.
    // [0x4b00, 0x4b20) - intermediate_value/cpu/decode/opcode_rc/bit_11.
    // [0x4b20, 0x4b40) - intermediate_value/cpu/decode/opcode_rc/bit_12.
    // [0x4b40, 0x4b60) - intermediate_value/cpu/decode/opcode_rc/bit_13.
    // [0x4b60, 0x4b80) - intermediate_value/cpu/decode/opcode_rc/bit_14.
    // [0x4b80, 0x4ba0) - intermediate_value/memory/address_diff_0.
    // [0x4ba0, 0x4bc0) - intermediate_value/rc16/diff_0.
    // [0x4bc0, 0x4be0) - intermediate_value/pedersen/hash0/ec_subset_sum/bit_0.
    // [0x4be0, 0x4c00) - intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0.
    // [0x4c00, 0x4c20) - intermediate_value/pedersen/hash1/ec_subset_sum/bit_0.
    // [0x4c20, 0x4c40) - intermediate_value/pedersen/hash1/ec_subset_sum/bit_neg_0.
    // [0x4c40, 0x4c60) - intermediate_value/pedersen/hash2/ec_subset_sum/bit_0.
    // [0x4c60, 0x4c80) - intermediate_value/pedersen/hash2/ec_subset_sum/bit_neg_0.
    // [0x4c80, 0x4ca0) - intermediate_value/pedersen/hash3/ec_subset_sum/bit_0.
    // [0x4ca0, 0x4cc0) - intermediate_value/pedersen/hash3/ec_subset_sum/bit_neg_0.
    // [0x4cc0, 0x4ce0) - intermediate_value/rc_builtin/value0_0.
    // [0x4ce0, 0x4d00) - intermediate_value/rc_builtin/value1_0.
    // [0x4d00, 0x4d20) - intermediate_value/rc_builtin/value2_0.
    // [0x4d20, 0x4d40) - intermediate_value/rc_builtin/value3_0.
    // [0x4d40, 0x4d60) - intermediate_value/rc_builtin/value4_0.
    // [0x4d60, 0x4d80) - intermediate_value/rc_builtin/value5_0.
    // [0x4d80, 0x4da0) - intermediate_value/rc_builtin/value6_0.
    // [0x4da0, 0x4dc0) - intermediate_value/rc_builtin/value7_0.
    // [0x4dc0, 0x4de0) - intermediate_value/ecdsa/signature0/doubling_key/x_squared.
    // [0x4de0, 0x4e00) - intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0.
    // [0x4e00, 0x4e20) - intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0.
    // [0x4e20, 0x4e40) - intermediate_value/ecdsa/signature0/exponentiate_key/bit_0.
    // [0x4e40, 0x4e60) - intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0.
    // [0x4e60, 0x5120) - expmods.
    // [0x5120, 0x5400) - denominator_invs.
    // [0x5400, 0x56e0) - denominators.
    // [0x56e0, 0x5840) - numerators.
    // [0x5840, 0x5b40) - adjustments.
    // [0x5b40, 0x5c00) - expmod_context.
    ...
    fallback() external {
        ...
        assembly {
            ...
            calldatacopy(0x0, 0x0, /*Input data size*/ 0x4960)
            let point := /*oods_point*/ mload(0x3c0)
            // Initialize composition_degree_bound to 2 * trace_length.
            mstore(0x4960, mul(2, /*trace_length*/ mload(0x80)))
            function expmod(base, exponent, modulus) -> result {
              let p := /*expmod_context*/ 0x5b40
...

            {
              ...
              mstore(0x4e60, expmod(point, /*trace_length*/ mload(0x80), PRIME))

              // expmods[1] = point^(trace_length / 16).
              mstore(0x4e80, expmod(point, div(/*trace_length*/ mload(0x80), 16), PRIME))

              // expmods[2] = point^(trace_length / 2).
              mstore(0x4ea0, expmod(point, div(/*trace_length*/ mload(0x80), 2), PRIME))

              // expmods[3] = point^(trace_length / 8).
              mstore(0x4ec0, expmod(point, div(/*trace_length*/ mload(0x80), 8), PRIME))

              // expmods[4] = point^(trace_length / 4).
              mstore(0x4ee0, expmod(point, div(/*trace_length*/ mload(0x80), 4), PRIME))

              // expmods[5] = point^(trace_length / 256).
              mstore(0x4f00, expmod(point, div(/*trace_length*/ mload(0x80), 256), PRIME))

              // expmods[6] = point^(trace_length / 512).
              mstore(0x4f20, expmod(point, div(/*trace_length*/ mload(0x80), 512), PRIME))

              // expmods[7] = point^(trace_length / 128).
              mstore(0x4f40, expmod(point, div(/*trace_length*/ mload(0x80), 128), PRIME))

              // expmods[8] = point^(trace_length / 4096).
              mstore(0x4f60, expmod(point, div(/*trace_length*/ mload(0x80), 4096), PRIME))

              // expmods[9] = point^(trace_length / 32).
              mstore(0x4f80, expmod(point, div(/*trace_length*/ mload(0x80), 32), PRIME))

              // expmods[10] = point^(trace_length / 8192).
              mstore(0x4fa0, expmod(point, div(/*trace_length*/ mload(0x80), 8192), PRIME))

              // expmods[11] = trace_generator^(15 * trace_length / 16).
              mstore(0x4fc0, expmod(/*trace_generator*/ mload(0x3a0), div(mul(15, /*trace_length*/ mload(0x80)), 16), PRIME))

              // expmods[12] = trace_generator^(16 * (trace_length / 16 - 1)).
              mstore(0x4fe0, expmod(/*trace_generator*/ mload(0x3a0), mul(16, sub(div(/*trace_length*/ mload(0x80), 16), 1)), PRIME))
              ...
              mstore(0x5020, expmod(/*trace_generator*/ mload(0x3a0), mul(4, sub(div(/*trace_length*/ mload(0x80), 4), 1)), PRIME))

              // expmods[15] = trace_generator^(255 * trace_length / 256).
              mstore(0x5040, expmod(/*trace_generator*/ mload(0x3a0), div(mul(255, /*trace_length*/ mload(0x80)), 256), PRIME))

              // expmods[16] = trace_generator^(63 * trace_length / 64).
              mstore(0x5060, expmod(/*trace_generator*/ mload(0x3a0), div(mul(63, /*trace_length*/ mload(0x80)), 64), PRIME))

              // expmods[17] = trace_generator^(trace_length / 2).
              mstore(0x5080, expmod(/*trace_generator*/ mload(0x3a0), div(/*trace_length*/ mload(0x80), 2), PRIME))

              // expmods[18] = trace_generator^(128 * (trace_length / 128 - 1)).
              mstore(0x50a0, expmod(/*trace_generator*/ mload(0x3a0), mul(128, sub(div(/*trace_length*/ mload(0x80), 128), 1)), PRIME))

              // expmods[19] = trace_generator^(251 * trace_length / 256).
              mstore(0x50c0, expmod(/*trace_generator*/ mload(0x3a0), div(mul(251, /*trace_length*/ mload(0x80)), 256), PRIME))

              // expmods[20] = trace_generator^(8192 * (trace_length / 8192 - 1)).
              mstore(0x50e0, expmod(/*trace_generator*/ mload(0x3a0), mul(8192, sub(div(/*trace_length*/ mload(0x80), 8192), 1)), PRIME))

              // expmods[21] = trace_generator^(256 * (trace_length / 256 - 1)).
              mstore(0x5100, expmod(/*trace_generator*/ mload(0x3a0), mul(256, sub(div(/*trace_length*/ mload(0x80), 256), 1)), PRIME))
...

            {
              ...
              mstore(0x5400,
                     addmod(/*point^trace_length*/ mload(0x4e60), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5420,
                     addmod(
                       /*point^(trace_length / 16)*/ mload(0x4e80),
                       sub(PRIME, /*trace_generator^(15 * trace_length / 16)*/ mload(0x4fc0)),
                       PRIME))
              ...
              mstore(0x5440,
                     addmod(/*point^(trace_length / 16)*/ mload(0x4e80), sub(PRIME, 1), PRIME))
              ...
              mstore(0x54a0,
                     addmod(/*point^(trace_length / 2)*/ mload(0x4ea0), sub(PRIME, 1), PRIME))
              ...
              mstore(0x54e0,
                     addmod(/*point^(trace_length / 8)*/ mload(0x4ec0), sub(PRIME, 1), PRIME))

              // Denominator for constraints: 'rc16/perm/step0', 'rc16/diff_is_bit'.
              // denominators[8] = point^(trace_length / 4) - 1.
              mstore(0x5500,
                     addmod(/*point^(trace_length / 4)*/ mload(0x4ee0), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5520,
                     addmod(
                       point,
                       sub(PRIME, /*trace_generator^(4 * (trace_length / 4 - 1))*/ mload(0x5020)),
                       PRIME))
              ...
              mstore(0x5540,
                     addmod(/*point^(trace_length / 256)*/ mload(0x4f00), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5560,
                     addmod(
                       /*point^(trace_length / 256)*/ mload(0x4f00),
                       sub(PRIME, /*trace_generator^(63 * trace_length / 64)*/ mload(0x5060)),
                       PRIME))
              ...
              mstore(0x5580,
                     addmod(
                       /*point^(trace_length / 256)*/ mload(0x4f00),
                       sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x5040)),
                       PRIME))
              ...
              mstore(0x55a0,
                     addmod(/*point^(trace_length / 512)*/ mload(0x4f20), sub(PRIME, 1), PRIME))
              ...
              mstore(0x55e0,
                     addmod(/*point^(trace_length / 32)*/ mload(0x4f80), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5600,
                     addmod(
                       /*point^(trace_length / 8192)*/ mload(0x4fa0),
                       sub(PRIME, /*trace_generator^(251 * trace_length / 256)*/ mload(0x50c0)),
                       PRIME))
              ...
              mstore(0x5640,
                     addmod(
                       /*point^(trace_length / 4096)*/ mload(0x4f60),
                       sub(PRIME, /*trace_generator^(251 * trace_length / 256)*/ mload(0x50c0)),
                       PRIME))
              ...
              mstore(0x5680,
                     addmod(/*point^(trace_length / 8192)*/ mload(0x4fa0), sub(PRIME, 1), PRIME))
              ...
              mstore(0x56a0,
                     addmod(/*point^(trace_length / 4096)*/ mload(0x4f60), sub(PRIME, 1), PRIME))
              ...
              mstore(0x56c0,
                     addmod(
                       point,
                       sub(PRIME, /*trace_generator^(256 * (trace_length / 256 - 1))*/ mload(0x5100)),
                       PRIME))
...

            {
              ...
              let prod := 1
              let partialProductEndPtr := 0x5400
              for { let partialProductPtr := 0x5120 }
              ...
              let firstPartialProductPtr := 0x5120
              ...
              let currentPartialProductPtr := 0x5400
...

            {
              ...
              mstore(0x5780,
                     addmod(
                       /*point^(trace_length / 512)*/ mload(0x4f20),
                       sub(PRIME, /*trace_generator^(trace_length / 2)*/ mload(0x5080)),
                       PRIME))
              ...
              mstore(0x57a0,
                     addmod(
                       point,
                       sub(PRIME, /*trace_generator^(128 * (trace_length / 128 - 1))*/ mload(0x50a0)),
                       PRIME))
              ...
              mstore(0x5800,
                     addmod(
                       point,
                       sub(PRIME, /*trace_generator^(8192 * (trace_length / 8192 - 1))*/ mload(0x50e0)),
                       PRIME))
              ...
              mstore(0x5840,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 16), /*trace_length*/ mload(0x80)), PRIME))
              ...
              mstore(0x5860,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x5880,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x58a0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x58c0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 0, 1), PRIME))
              ...
              mstore(0x58e0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, 1), PRIME))
              ...
              mstore(0x5900,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 2)), PRIME))
              ...
              mstore(0x5920,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 8)), PRIME))
              ...
              mstore(0x5940,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 4)), PRIME))
              ...
              mstore(0x5960,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x5980,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 256), /*trace_length*/ mload(0x80)), PRIME))
              ...
              mstore(0x59a0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x59c0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), div(/*trace_length*/ mload(0x80), 512), div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x59e0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 512)), PRIME))
              ...
              mstore(0x5a00,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 1, div(/*trace_length*/ mload(0x80), 128)), PRIME))
              ...
              mstore(0x5a20,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 128)), PRIME))
              ...
              mstore(0x5a40,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 4096), div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x5a60,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 8192), div(/*trace_length*/ mload(0x80), 32)), PRIME))
              ...
              mstore(0x5a80,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
              ...
              mstore(0x5aa0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 4096)), PRIME))
              ...
              mstore(0x5ac0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
              ...
              mstore(0x5ae0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 4096)), PRIME))
              ...
              mstore(0x5b00,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), sub(/*trace_length*/ mload(0x80), 1), 1, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
              ...
              mstore(0x5b20,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4960), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 256)), PRIME))
...

            {
              ...
              let val := addmod(
                /*column0_row0*/ mload(0x2fc0),
                sub(
                  PRIME,
                  addmod(/*column0_row1*/ mload(0x2fe0), /*column0_row1*/ mload(0x2fe0), PRIME)),
                PRIME)
              mstore(0x4980, val)
              }
              ...
              let val := addmod(
                /*column0_row1*/ mload(0x2fe0),
                sub(
                  PRIME,
                  addmod(/*column0_row2*/ mload(0x3000), /*column0_row2*/ mload(0x3000), PRIME)),
                PRIME)
              mstore(0x49a0, val)
              }
              ...
              let val := addmod(
                /*column0_row2*/ mload(0x3000),
                sub(
                  PRIME,
                  addmod(/*column0_row3*/ mload(0x3020), /*column0_row3*/ mload(0x3020), PRIME)),
                PRIME)
              mstore(0x49c0, val)
              }
              ...
              let val := addmod(
                /*column0_row4*/ mload(0x3040),
                sub(
                  PRIME,
                  addmod(/*column0_row5*/ mload(0x3060), /*column0_row5*/ mload(0x3060), PRIME)),
                PRIME)
              mstore(0x49e0, val)
              }
              ...
              let val := addmod(
                /*column0_row3*/ mload(0x3020),
                sub(
                  PRIME,
                  addmod(/*column0_row4*/ mload(0x3040), /*column0_row4*/ mload(0x3040), PRIME)),
                PRIME)
              mstore(0x4a00, val)
              }
              ...
              let val := addmod(
                /*column0_row9*/ mload(0x30e0),
                sub(
                  PRIME,
                  addmod(/*column0_row10*/ mload(0x3100), /*column0_row10*/ mload(0x3100), PRIME)),
                PRIME)
              mstore(0x4a20, val)
              }
              ...
              let val := addmod(
                /*column0_row5*/ mload(0x3060),
                sub(
                  PRIME,
                  addmod(/*column0_row6*/ mload(0x3080), /*column0_row6*/ mload(0x3080), PRIME)),
                PRIME)
              mstore(0x4a40, val)
              }
              ...
              let val := addmod(
                /*column0_row6*/ mload(0x3080),
                sub(
                  PRIME,
                  addmod(/*column0_row7*/ mload(0x30a0), /*column0_row7*/ mload(0x30a0), PRIME)),
                PRIME)
              mstore(0x4a60, val)
              }
              ...
              let val := addmod(
                /*column0_row7*/ mload(0x30a0),
                sub(
                  PRIME,
                  addmod(/*column0_row8*/ mload(0x30c0), /*column0_row8*/ mload(0x30c0), PRIME)),
                PRIME)
              mstore(0x4a80, val)
              }
              ...
              let val := addmod(
                /*column0_row8*/ mload(0x30c0),
                sub(
                  PRIME,
                  addmod(/*column0_row9*/ mload(0x30e0), /*column0_row9*/ mload(0x30e0), PRIME)),
                PRIME)
              mstore(0x4aa0, val)
              }
              ...
              let val := addmod(
                addmod(
                  /*column17_row0*/ mload(0x3bc0),
                  /*intermediate_value/cpu/decode/opcode_rc/bit_2*/ mload(0x49c0),
                  PRIME),
                1,
                PRIME)
              mstore(0x4ac0, val)
              ...
              let val := addmod(
                /*column0_row10*/ mload(0x3100),
                sub(
                  PRIME,
                  addmod(/*column0_row11*/ mload(0x3120), /*column0_row11*/ mload(0x3120), PRIME)),
                PRIME)
              mstore(0x4ae0, val)
              }
              ...
              let val := addmod(
                /*column0_row11*/ mload(0x3120),
                sub(
                  PRIME,
                  addmod(/*column0_row12*/ mload(0x3140), /*column0_row12*/ mload(0x3140), PRIME)),
                PRIME)
              mstore(0x4b00, val)
              }
              ...
              let val := addmod(
                /*column0_row12*/ mload(0x3140),
                sub(
                  PRIME,
                  addmod(/*column0_row13*/ mload(0x3160), /*column0_row13*/ mload(0x3160), PRIME)),
                PRIME)
              mstore(0x4b20, val)
              }
              ...
              let val := addmod(
                /*column0_row13*/ mload(0x3160),
                sub(
                  PRIME,
                  addmod(/*column0_row14*/ mload(0x3180), /*column0_row14*/ mload(0x3180), PRIME)),
                PRIME)
              mstore(0x4b40, val)
              }
              ...
              let val := addmod(
                /*column0_row14*/ mload(0x3180),
                sub(
                  PRIME,
                  addmod(/*column0_row15*/ mload(0x31a0), /*column0_row15*/ mload(0x31a0), PRIME)),
                PRIME)
              mstore(0x4b60, val)
              }
              ...
              let val := addmod(/*column18_row2*/ mload(0x4100), sub(PRIME, /*column18_row0*/ mload(0x40c0)), PRIME)
              mstore(0x4b80, val)
              }
              ...
              let val := addmod(/*column19_row6*/ mload(0x4200), sub(PRIME, /*column19_row2*/ mload(0x4180)), PRIME)
              mstore(0x4ba0, val)
              }
              ...
              let val := addmod(
                /*column4_row0*/ mload(0x3320),
                sub(
                  PRIME,
                  addmod(/*column4_row1*/ mload(0x3340), /*column4_row1*/ mload(0x3340), PRIME)),
                PRIME)
              mstore(0x4bc0, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4bc0)),
                PRIME)
              mstore(0x4be0, val)
              }
              ...
              let val := addmod(
                /*column8_row0*/ mload(0x35a0),
                sub(
                  PRIME,
                  addmod(/*column8_row1*/ mload(0x35c0), /*column8_row1*/ mload(0x35c0), PRIME)),
                PRIME)
              mstore(0x4c00, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c00)),
                PRIME)
              mstore(0x4c20, val)
              }
              ...
              let val := addmod(
                /*column12_row0*/ mload(0x3820),
                sub(
                  PRIME,
                  addmod(/*column12_row1*/ mload(0x3840), /*column12_row1*/ mload(0x3840), PRIME)),
                PRIME)
              mstore(0x4c40, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c40)),
                PRIME)
              mstore(0x4c60, val)
              }
              ...
              let val := addmod(
                /*column16_row0*/ mload(0x3aa0),
                sub(
                  PRIME,
                  addmod(/*column16_row1*/ mload(0x3ac0), /*column16_row1*/ mload(0x3ac0), PRIME)),
                PRIME)
              mstore(0x4c80, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4c80)),
                PRIME)
              mstore(0x4ca0, val)
              }
              ...
              let val := /*column19_row12*/ mload(0x42a0)
              mstore(0x4cc0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value0_0*/ mload(0x4cc0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column19_row28*/ mload(0x4360),
                PRIME)
              mstore(0x4ce0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value1_0*/ mload(0x4ce0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column19_row44*/ mload(0x43a0),
                PRIME)
              mstore(0x4d00, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value2_0*/ mload(0x4d00),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column19_row60*/ mload(0x43c0),
                PRIME)
              mstore(0x4d20, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value3_0*/ mload(0x4d20),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column19_row76*/ mload(0x43e0),
                PRIME)
              mstore(0x4d40, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value4_0*/ mload(0x4d40),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column19_row92*/ mload(0x4400),
                PRIME)
              mstore(0x4d60, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value5_0*/ mload(0x4d60),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column19_row108*/ mload(0x4420),
                PRIME)
              mstore(0x4d80, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value6_0*/ mload(0x4d80),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column19_row124*/ mload(0x4440),
                PRIME)
              mstore(0x4da0, val)
              }
              ...
              let val := mulmod(/*column19_row7*/ mload(0x4220), /*column19_row7*/ mload(0x4220), PRIME)
              mstore(0x4dc0, val)
              }
              ...
              let val := addmod(
                /*column20_row30*/ mload(0x4660),
                sub(
                  PRIME,
                  addmod(/*column20_row62*/ mload(0x46c0), /*column20_row62*/ mload(0x46c0), PRIME)),
                PRIME)
              mstore(0x4de0, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x4de0)),
                PRIME)
              mstore(0x4e00, val)
              }
              ...
              let val := addmod(
                /*column20_row2*/ mload(0x44e0),
                sub(
                  PRIME,
                  addmod(/*column20_row18*/ mload(0x45e0), /*column20_row18*/ mload(0x45e0), PRIME)),
                PRIME)
              mstore(0x4e20, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4e20)),
                PRIME)
              mstore(0x4e40, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x4980),
                  /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x4980),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x4980)),
                PRIME)
              ...
              let val := /*column0_row0*/ mload(0x2fc0)
                  ...
                  addmod(
                    mulmod(
                      addmod(
                        mulmod(
                          addmod(
                            mulmod(/*column0_row0*/ mload(0x2fc0), /*offset_size*/ mload(0xa0), PRIME),
                            /*column19_row4*/ mload(0x41c0),
                            PRIME),
                          /*offset_size*/ mload(0xa0),
                          PRIME),
                        /*column19_row8*/ mload(0x4240),
                        PRIME),
                      /*offset_size*/ mload(0xa0),
                      PRIME),
                    /*column19_row0*/ mload(0x4140),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column17_row8*/ mload(0x3cc0), /*half_offset_size*/ mload(0xc0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
              ...
              let val := addmod(
                addmod(/*column17_row4*/ mload(0x3c40), /*half_offset_size*/ mload(0xc0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_rc/bit_1*/ mload(0x49a0),
                        /*column19_row9*/ mload(0x4260),
                        PRIME),
                      mulmod(
                        addmod(
                          1,
                          sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_1*/ mload(0x49a0)),
                          PRIME),
                        /*column19_row1*/ mload(0x4160),
                        PRIME),
                      PRIME),
              ...
              let val := addmod(
                addmod(/*column17_row12*/ mload(0x3d00), /*half_offset_size*/ mload(0xc0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
                      addmod(
                        addmod(
                          mulmod(
                            ...
                            PRIME),
                          mulmod(
                            /*intermediate_value/cpu/decode/opcode_rc/bit_4*/ mload(0x49e0),
                            /*column19_row1*/ mload(0x4160),
                            PRIME),
                          PRIME),
                        mulmod(
                          /*intermediate_value/cpu/decode/opcode_rc/bit_3*/ mload(0x4a00),
                          /*column19_row9*/ mload(0x4260),
                          PRIME),
                        PRIME),
                      mulmod(
              ...
              let val := addmod(
                /*column19_row5*/ mload(0x41e0),
                sub(
                  PRIME,
                  mulmod(/*column17_row5*/ mload(0x3c60), /*column17_row13*/ mload(0x3d20), PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  addmod(
                    1,
                    sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4a20)),
                    PRIME),
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_rc/bit_5*/ mload(0x4a40),
                        addmod(/*column17_row5*/ mload(0x3c60), /*column17_row13*/ mload(0x3d20), PRIME),
                        PRIME),
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_rc/bit_6*/ mload(0x4a60),
                        /*column19_row5*/ mload(0x41e0),
                        PRIME),
                      PRIME),
                    mulmod(
                        ...
                        sub(
                          ...
                          addmod(
                            addmod(
                              ...
                              /*intermediate_value/cpu/decode/opcode_rc/bit_6*/ mload(0x4a60),
                              PRIME),
                            /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4a20),
                            PRIME)),
                        PRIME),
                      /*column17_row13*/ mload(0x3d20),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row3*/ mload(0x41a0),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4a20),
                    /*column17_row9*/ mload(0x3ce0),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row11*/ mload(0x4280),
                sub(
                  PRIME,
                  mulmod(/*column19_row3*/ mload(0x41a0), /*column19_row13*/ mload(0x42c0), PRIME)),
                PRIME)
                ...
                addmod(
                  ...
                  mulmod(
                    ...
                    addmod(
                      ...
                      sub(
                        PRIME,
                        addmod(/*column17_row0*/ mload(0x3bc0), /*column17_row13*/ mload(0x3d20), PRIME)),
                      PRIME),
                    PRIME),
                  PRIME),
                sub(
                  ...
                  addmod(
                      ...
                      mulmod(
                        addmod(
                          ...
                          sub(
                            ...
                            addmod(
                              addmod(
                                /*intermediate_value/cpu/decode/opcode_rc/bit_7*/ mload(0x4a80),
                                /*intermediate_value/cpu/decode/opcode_rc/bit_8*/ mload(0x4aa0),
                                PRIME),
                              /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4a20),
                              PRIME)),
                          PRIME),
                        /*intermediate_value/npc_reg_0*/ mload(0x4ac0),
                        PRIME),
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_rc/bit_7*/ mload(0x4a80),
                        /*column19_row13*/ mload(0x42c0),
                    ...
                    mulmod(
                      /*intermediate_value/cpu/decode/opcode_rc/bit_8*/ mload(0x4aa0),
                      addmod(/*column17_row0*/ mload(0x3bc0), /*column19_row13*/ mload(0x42c0), PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                ...
                addmod(
                  /*column17_row16*/ mload(0x3d40),
                  sub(PRIME, /*intermediate_value/npc_reg_0*/ mload(0x4ac0)),
                  PRIME),
                PRIME)
                  ...
                  addmod(
                    addmod(
                      addmod(
                        /*column19_row1*/ mload(0x4160),
                        mulmod(
                          /*intermediate_value/cpu/decode/opcode_rc/bit_10*/ mload(0x4ae0),
                          /*column19_row13*/ mload(0x42c0),
                          PRIME),
                        PRIME),
                      /*intermediate_value/cpu/decode/opcode_rc/bit_11*/ mload(0x4b00),
                      PRIME),
                    mulmod(/*intermediate_value/cpu/decode/opcode_rc/bit_12*/ mload(0x4b20), 2, PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                      ...
                      mulmod(
                        addmod(
                          ...
                          sub(
                            PRIME,
                            addmod(
                              /*intermediate_value/cpu/decode/opcode_rc/bit_12*/ mload(0x4b20),
                              /*intermediate_value/cpu/decode/opcode_rc/bit_13*/ mload(0x4b40),
                              PRIME)),
                          PRIME),
                        /*column19_row9*/ mload(0x4260),
                        PRIME),
                    ...
                    mulmod(
                      /*intermediate_value/cpu/decode/opcode_rc/bit_12*/ mload(0x4b20),
                      addmod(/*column19_row1*/ mload(0x4160), 2, PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_rc/bit_12*/ mload(0x4b20),
                addmod(/*column17_row9*/ mload(0x3ce0), sub(PRIME, /*column19_row9*/ mload(0x4260)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_rc/bit_14*/ mload(0x4b60),
                addmod(
                  /*column17_row9*/ mload(0x3ce0),
                  sub(PRIME, /*column19_row13*/ mload(0x42c0)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(/*column19_row1*/ mload(0x4160), sub(PRIME, /*initial_ap*/ mload(0xe0)), PRIME)
              ...
              let val := addmod(/*column19_row9*/ mload(0x4260), sub(PRIME, /*initial_ap*/ mload(0xe0)), PRIME)
              ...
              let val := addmod(/*column17_row0*/ mload(0x3bc0), sub(PRIME, /*initial_pc*/ mload(0x100)), PRIME)
              ...
              let val := addmod(/*column17_row0*/ mload(0x3bc0), sub(PRIME, /*final_pc*/ mload(0x140)), PRIME)
                    ...
                    mulmod(
                      addmod(
                        ...
                        sub(
                          PRIME,
                          addmod(
                            /*column18_row0*/ mload(0x40c0),
                            mulmod(
                              /*memory/multi_column_perm/hash_interaction_elm0*/ mload(0x180),
                              /*column18_row1*/ mload(0x40e0),
                              PRIME),
                            PRIME)),
                        PRIME),
                      /*column21_inter1_row0*/ mload(0x48e0),
                      PRIME),
                    /*column17_row0*/ mload(0x3bc0),
                    PRIME),
                  mulmod(
                ...
                mulmod(
                  addmod(
                    ...
                    sub(
                      PRIME,
                      addmod(
                        /*column18_row2*/ mload(0x4100),
                        mulmod(
                          /*memory/multi_column_perm/hash_interaction_elm0*/ mload(0x180),
                          /*column18_row3*/ mload(0x4120),
                          PRIME),
                        PRIME)),
                    PRIME),
                  /*column21_inter1_row2*/ mload(0x4920),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    addmod(
                      ...
                      sub(
                        PRIME,
                        addmod(
                          /*column17_row2*/ mload(0x3c00),
                          mulmod(
                            /*memory/multi_column_perm/hash_interaction_elm0*/ mload(0x180),
                            /*column17_row3*/ mload(0x3c20),
                            PRIME),
                          PRIME)),
                      PRIME),
                    /*column21_inter1_row0*/ mload(0x48e0),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/memory/address_diff_0*/ mload(0x4b80),
                  /*intermediate_value/memory/address_diff_0*/ mload(0x4b80),
                  PRIME),
                sub(PRIME, /*intermediate_value/memory/address_diff_0*/ mload(0x4b80)),
                PRIME)
              ...
              let val := mulmod(
                addmod(/*intermediate_value/memory/address_diff_0*/ mload(0x4b80), sub(PRIME, 1), PRIME),
                addmod(/*column18_row1*/ mload(0x40e0), sub(PRIME, /*column18_row3*/ mload(0x4120)), PRIME),
                PRIME)
              ...
              let val := addmod(/*column18_row0*/ mload(0x40c0), sub(PRIME, 1), PRIME)
              ...
              let val := /*column17_row2*/ mload(0x3c00)
              ...
              let val := /*column17_row3*/ mload(0x3c20)
                ...
                addmod(
                  mulmod(
                    addmod(
                      ...
                      sub(PRIME, /*column19_row2*/ mload(0x4180)),
                      PRIME),
                    /*column21_inter1_row1*/ mload(0x4900),
                    PRIME),
                  /*column19_row0*/ mload(0x4140),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  addmod(
                    /*rc16/perm/interaction_elm*/ mload(0x1c0),
                    sub(PRIME, /*column19_row6*/ mload(0x4200)),
                    PRIME),
                  /*column21_inter1_row5*/ mload(0x4940),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    addmod(
                      /*rc16/perm/interaction_elm*/ mload(0x1c0),
                      sub(PRIME, /*column19_row4*/ mload(0x41c0)),
                      PRIME),
                    /*column21_inter1_row1*/ mload(0x4900),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc16/diff_0*/ mload(0x4ba0),
                  /*intermediate_value/rc16/diff_0*/ mload(0x4ba0),
                  PRIME),
                sub(PRIME, /*intermediate_value/rc16/diff_0*/ mload(0x4ba0)),
                PRIME)
              ...
              let val := addmod(/*column19_row2*/ mload(0x4180), sub(PRIME, /*rc_min*/ mload(0x200)), PRIME)
              ...
              let val := addmod(/*column19_row2*/ mload(0x4180), sub(PRIME, /*rc_max*/ mload(0x220)), PRIME)
              ...
              let val := mulmod(
                /*column11_row255*/ mload(0x3800),
                addmod(
                  /*column4_row1*/ mload(0x3340),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column4_row192*/ mload(0x3360),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column15_row255*/ mload(0x3a80),
                    addmod(
                      /*column4_row192*/ mload(0x3360),
                      sub(
                        PRIME,
                        addmod(/*column4_row193*/ mload(0x3380), /*column4_row193*/ mload(0x3380), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column15_row255*/ mload(0x3a80),
                addmod(
                  /*column4_row193*/ mload(0x3380),
                  sub(PRIME, mulmod(8, /*column4_row196*/ mload(0x33a0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column4_row251*/ mload(0x33e0),
                      sub(
                        PRIME,
                        addmod(/*column4_row252*/ mload(0x3400), /*column4_row252*/ mload(0x3400), PRIME)),
                      PRIME),
                    addmod(
                      /*column4_row196*/ mload(0x33a0),
                      sub(
                        PRIME,
                        addmod(/*column4_row197*/ mload(0x33c0), /*column4_row197*/ mload(0x33c0), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column4_row197*/ mload(0x33c0),
                  sub(PRIME, mulmod(18014398509481984, /*column4_row251*/ mload(0x33e0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4bc0),
                addmod(
                  /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4bc0),
                  sub(PRIME, 1),
                  PRIME),
              ...
              let val := /*column4_row0*/ mload(0x3320)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column3_row0*/ mload(0x32e0),
                    addmod(
                      /*column1_row0*/ mload(0x31c0),
              ...
              let val := addmod(
                mulmod(/*column3_row0*/ mload(0x32e0), /*column3_row0*/ mload(0x32e0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4bc0),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4bc0),
                  addmod(/*column2_row0*/ mload(0x3260), /*column2_row1*/ mload(0x3280), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column3_row0*/ mload(0x32e0),
                    addmod(/*column1_row0*/ mload(0x31c0), sub(PRIME, /*column1_row1*/ mload(0x31e0)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0*/ mload(0x4be0),
                addmod(/*column1_row1*/ mload(0x31e0), sub(PRIME, /*column1_row0*/ mload(0x31c0)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0*/ mload(0x4be0),
                addmod(/*column2_row1*/ mload(0x3280), sub(PRIME, /*column2_row0*/ mload(0x3260)), PRIME),
                PRIME)
              ...
              let val := addmod(
                /*column1_row256*/ mload(0x3220),
                sub(PRIME, /*column1_row255*/ mload(0x3200)),
                PRIME)
              ...
              let val := addmod(
                /*column2_row256*/ mload(0x32c0),
                sub(PRIME, /*column2_row255*/ mload(0x32a0)),
                PRIME)
              ...
              let val := mulmod(
                /*column3_row255*/ mload(0x3300),
                addmod(
                  /*column8_row1*/ mload(0x35c0),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column8_row192*/ mload(0x35e0),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column7_row255*/ mload(0x3580),
                    addmod(
                      /*column8_row192*/ mload(0x35e0),
                      sub(
                        PRIME,
                        addmod(/*column8_row193*/ mload(0x3600), /*column8_row193*/ mload(0x3600), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column7_row255*/ mload(0x3580),
                addmod(
                  /*column8_row193*/ mload(0x3600),
                  sub(PRIME, mulmod(8, /*column8_row196*/ mload(0x3620), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column8_row251*/ mload(0x3660),
                      sub(
                        PRIME,
                        addmod(/*column8_row252*/ mload(0x3680), /*column8_row252*/ mload(0x3680), PRIME)),
                      PRIME),
                    addmod(
                      /*column8_row196*/ mload(0x3620),
                      sub(
                        PRIME,
                        addmod(/*column8_row197*/ mload(0x3640), /*column8_row197*/ mload(0x3640), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column8_row197*/ mload(0x3640),
                  sub(PRIME, mulmod(18014398509481984, /*column8_row251*/ mload(0x3660), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c00),
                addmod(
                  /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c00),
                  sub(PRIME, 1),
                  PRIME),
              ...
              let val := /*column8_row0*/ mload(0x35a0)
              ...
              // res += val * (coefficients[124] + coefficients[125] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column7_row0*/ mload(0x3560),
                    addmod(
                      /*column5_row0*/ mload(0x3440),
                      sub(PRIME, /*periodic_column/pedersen/points/x*/ mload(0x0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column7_row0*/ mload(0x3560), /*column7_row0*/ mload(0x3560), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c00),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c00),
                  addmod(/*column6_row0*/ mload(0x34e0), /*column6_row1*/ mload(0x3500), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column7_row0*/ mload(0x3560),
                    addmod(/*column5_row0*/ mload(0x3440), sub(PRIME, /*column5_row1*/ mload(0x3460)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_neg_0*/ mload(0x4c20),
                addmod(/*column5_row1*/ mload(0x3460), sub(PRIME, /*column5_row0*/ mload(0x3440)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_neg_0*/ mload(0x4c20),
                addmod(/*column6_row1*/ mload(0x3500), sub(PRIME, /*column6_row0*/ mload(0x34e0)), PRIME),
                PRIME)
              ...
              // res += val * (coefficients[134] + coefficients[135] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column5_row256*/ mload(0x34a0),
                sub(PRIME, /*column5_row255*/ mload(0x3480)),
                PRIME)
              ...
              let val := addmod(
                /*column6_row256*/ mload(0x3540),
                sub(PRIME, /*column6_row255*/ mload(0x3520)),
                PRIME)
              ...
              // res += val * (coefficients[142] + coefficients[143] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := mulmod(
                /*column20_row145*/ mload(0x4700),
                addmod(
                  /*column12_row1*/ mload(0x3840),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column12_row192*/ mload(0x3860),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column20_row17*/ mload(0x45c0),
                    addmod(
                      /*column12_row192*/ mload(0x3860),
                      sub(
                        PRIME,
                        addmod(/*column12_row193*/ mload(0x3880), /*column12_row193*/ mload(0x3880), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column20_row17*/ mload(0x45c0),
                addmod(
                  /*column12_row193*/ mload(0x3880),
                  sub(PRIME, mulmod(8, /*column12_row196*/ mload(0x38a0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column12_row251*/ mload(0x38e0),
                      sub(
                        PRIME,
                        addmod(/*column12_row252*/ mload(0x3900), /*column12_row252*/ mload(0x3900), PRIME)),
                      PRIME),
                    addmod(
                      /*column12_row196*/ mload(0x38a0),
                      sub(
                        PRIME,
                        addmod(/*column12_row197*/ mload(0x38c0), /*column12_row197*/ mload(0x38c0), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column12_row197*/ mload(0x38c0),
                  sub(PRIME, mulmod(18014398509481984, /*column12_row251*/ mload(0x38e0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c40),
                addmod(
                  /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c40),
                  sub(PRIME, 1),
                  PRIME),
              ...
              let val := /*column12_row0*/ mload(0x3820)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column11_row0*/ mload(0x37e0),
                    addmod(
                      /*column9_row0*/ mload(0x36c0),
                      sub(PRIME, /*periodic_column/pedersen/points/x*/ mload(0x0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column11_row0*/ mload(0x37e0), /*column11_row0*/ mload(0x37e0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c40),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c40),
                  addmod(/*column10_row0*/ mload(0x3760), /*column10_row1*/ mload(0x3780), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column11_row0*/ mload(0x37e0),
                    addmod(/*column9_row0*/ mload(0x36c0), sub(PRIME, /*column9_row1*/ mload(0x36e0)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_neg_0*/ mload(0x4c60),
                addmod(/*column9_row1*/ mload(0x36e0), sub(PRIME, /*column9_row0*/ mload(0x36c0)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_neg_0*/ mload(0x4c60),
                addmod(/*column10_row1*/ mload(0x3780), sub(PRIME, /*column10_row0*/ mload(0x3760)), PRIME),
                PRIME)
              ...
              // res += val * (coefficients[170] + coefficients[171] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column9_row256*/ mload(0x3720),
                sub(PRIME, /*column9_row255*/ mload(0x3700)),
                PRIME)
              ...
              let val := addmod(
                /*column10_row256*/ mload(0x37c0),
                sub(PRIME, /*column10_row255*/ mload(0x37a0)),
                PRIME)
              ...
              // res += val * (coefficients[174] + coefficients[175] * adjustments[12]).
              res := addmod(res,
                            mulmod(val,
              ...
              // res += val * (coefficients[178] + coefficients[179] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := mulmod(
                /*column20_row209*/ mload(0x4720),
                addmod(
                  /*column16_row1*/ mload(0x3ac0),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column16_row192*/ mload(0x3ae0),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column20_row81*/ mload(0x46e0),
                    addmod(
                      /*column16_row192*/ mload(0x3ae0),
                      sub(
                        PRIME,
                        addmod(/*column16_row193*/ mload(0x3b00), /*column16_row193*/ mload(0x3b00), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column20_row81*/ mload(0x46e0),
                addmod(
                  /*column16_row193*/ mload(0x3b00),
                  sub(PRIME, mulmod(8, /*column16_row196*/ mload(0x3b20), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column16_row251*/ mload(0x3b60),
                      sub(
                        PRIME,
                        addmod(/*column16_row252*/ mload(0x3b80), /*column16_row252*/ mload(0x3b80), PRIME)),
                      PRIME),
                    addmod(
                      /*column16_row196*/ mload(0x3b20),
                      sub(
                        PRIME,
                        addmod(/*column16_row197*/ mload(0x3b40), /*column16_row197*/ mload(0x3b40), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column16_row197*/ mload(0x3b40),
                  sub(PRIME, mulmod(18014398509481984, /*column16_row251*/ mload(0x3b60), PRIME)),
                  PRIME),
                PRIME)
              ...
              // res += val * (coefficients[190] + coefficients[191] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4c80),
                addmod(
                  /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4c80),
                  sub(PRIME, 1),
                  PRIME),
              ...
              // res += val * (coefficients[192] + coefficients[193] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := /*column16_row0*/ mload(0x3aa0)
              ...
              // res += val * (coefficients[196] + coefficients[197] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column15_row0*/ mload(0x3a60),
                    addmod(
                      /*column13_row0*/ mload(0x3940),
                      sub(PRIME, /*periodic_column/pedersen/points/x*/ mload(0x0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column15_row0*/ mload(0x3a60), /*column15_row0*/ mload(0x3a60), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4c80),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4c80),
                  addmod(/*column14_row0*/ mload(0x39e0), /*column14_row1*/ mload(0x3a00), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column15_row0*/ mload(0x3a60),
                    addmod(/*column13_row0*/ mload(0x3940), sub(PRIME, /*column13_row1*/ mload(0x3960)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_neg_0*/ mload(0x4ca0),
                addmod(/*column13_row1*/ mload(0x3960), sub(PRIME, /*column13_row0*/ mload(0x3940)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_neg_0*/ mload(0x4ca0),
                addmod(/*column14_row1*/ mload(0x3a00), sub(PRIME, /*column14_row0*/ mload(0x39e0)), PRIME),
                PRIME)
              ...
              // res += val * (coefficients[206] + coefficients[207] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column13_row256*/ mload(0x39a0),
                sub(PRIME, /*column13_row255*/ mload(0x3980)),
                PRIME)
              ...
              let val := addmod(
                /*column14_row256*/ mload(0x3a40),
                sub(PRIME, /*column14_row255*/ mload(0x3a20)),
                PRIME)
              ...
              // res += val * (coefficients[210] + coefficients[211] * adjustments[12]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(/*column17_row7*/ mload(0x3ca0), sub(PRIME, /*column4_row0*/ mload(0x3320)), PRIME)
              ...
              let val := addmod(
                /*column17_row135*/ mload(0x3ec0),
                sub(PRIME, /*column8_row0*/ mload(0x35a0)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row263*/ mload(0x3f80),
                sub(PRIME, /*column12_row0*/ mload(0x3820)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row391*/ mload(0x3fe0),
                sub(PRIME, /*column16_row0*/ mload(0x3aa0)),
                PRIME)
              ...
              // res += val * (coefficients[222] + coefficients[223] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column17_row134*/ mload(0x3ea0),
                sub(PRIME, addmod(/*column17_row38*/ mload(0x3da0), 1, PRIME)),
                PRIME)
              ...
              // res += val * (coefficients[224] + coefficients[225] * adjustments[14]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[224]*/ mload(0x2040),
                                       mulmod(/*coefficients[225]*/ mload(0x2060),
                                              /*adjustments[14]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[226] + coefficients[227] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column17_row71*/ mload(0x3e00),
                sub(PRIME, /*column4_row256*/ mload(0x3420)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row199*/ mload(0x3f40),
                sub(PRIME, /*column8_row256*/ mload(0x36a0)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row327*/ mload(0x3fc0),
                sub(PRIME, /*column12_row256*/ mload(0x3920)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row455*/ mload(0x4040),
                sub(PRIME, /*column16_row256*/ mload(0x3ba0)),
                PRIME)
              ...
              // res += val * (coefficients[234] + coefficients[235] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column17_row70*/ mload(0x3de0),
                sub(PRIME, addmod(/*column17_row6*/ mload(0x3c80), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row39*/ mload(0x3dc0),
                sub(PRIME, /*column1_row511*/ mload(0x3240)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row167*/ mload(0x3f20),
                sub(PRIME, /*column5_row511*/ mload(0x34c0)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row295*/ mload(0x3fa0),
                sub(PRIME, /*column9_row511*/ mload(0x3740)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row423*/ mload(0x4020),
                sub(PRIME, /*column13_row511*/ mload(0x39c0)),
                PRIME)
              ...
              // res += val * (coefficients[244] + coefficients[245] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column17_row38*/ mload(0x3da0),
                sub(PRIME, addmod(/*column17_row70*/ mload(0x3de0), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*intermediate_value/rc_builtin/value7_0*/ mload(0x4da0),
                sub(PRIME, /*column17_row103*/ mload(0x3e80)),
                PRIME)
              ...
              // res += val * (coefficients[248] + coefficients[249] * adjustments[15]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column17_row230*/ mload(0x3f60),
                sub(PRIME, addmod(/*column17_row102*/ mload(0x3e60), 1, PRIME)),
                PRIME)
              ...
              // res += val * (coefficients[250] + coefficients[251] * adjustments[14]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                addmod(
                  addmod(
                    addmod(
                      /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4dc0),
                      /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4dc0),
                      PRIME),
                    /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4dc0),
                    PRIME),
                ...
                sub(
                  PRIME,
                  mulmod(
                    addmod(/*column19_row15*/ mload(0x42e0), /*column19_row15*/ mload(0x42e0), PRIME),
                    /*column20_row0*/ mload(0x44a0),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column20_row0*/ mload(0x44a0), /*column20_row0*/ mload(0x44a0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column19_row7*/ mload(0x4220), /*column19_row7*/ mload(0x4220), PRIME),
                    /*column19_row23*/ mload(0x4320),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column19_row15*/ mload(0x42e0), /*column19_row31*/ mload(0x4380), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column20_row0*/ mload(0x44a0),
                    addmod(
                      /*column19_row7*/ mload(0x4220),
                      sub(PRIME, /*column19_row23*/ mload(0x4320)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              // res += val * (coefficients[258] + coefficients[259] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
              ...
              // res += val * (coefficients[260] + coefficients[261] * adjustments[17]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[260]*/ mload(0x24c0),
                                       mulmod(/*coefficients[261]*/ mload(0x24e0),
                                              /*adjustments[17]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              let val := /*column20_row30*/ mload(0x4660)
              ...
              // res += val * (coefficients[264] + coefficients[265] * adjustments[18]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column20_row14*/ mload(0x45a0),
                    addmod(
                      /*column20_row6*/ mload(0x4520),
              ...
              let val := addmod(
                mulmod(/*column20_row14*/ mload(0x45a0), /*column20_row14*/ mload(0x45a0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x4de0),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x4de0),
                  addmod(/*column20_row22*/ mload(0x4620), /*column20_row54*/ mload(0x46a0), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    ...
                    addmod(
                      /*column20_row6*/ mload(0x4520),
                      sub(PRIME, /*column20_row38*/ mload(0x4680)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0*/ mload(0x4e00),
                addmod(
                  /*column20_row38*/ mload(0x4680),
                  sub(PRIME, /*column20_row6*/ mload(0x4520)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0*/ mload(0x4e00),
                addmod(
                  /*column20_row54*/ mload(0x46a0),
                  sub(PRIME, /*column20_row22*/ mload(0x4620)),
                  PRIME),
                PRIME)
              ...
              // res += val * (coefficients[278] + coefficients[279] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := /*column20_row2*/ mload(0x44e0)
              ...
              // res += val * (coefficients[282] + coefficients[283] * adjustments[19]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4e20),
                  addmod(
                    /*column20_row4*/ mload(0x4500),
                    sub(PRIME, /*column19_row15*/ mload(0x42e0)),
                    PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column20_row12*/ mload(0x4580),
                    addmod(/*column20_row8*/ mload(0x4540), sub(PRIME, /*column19_row7*/ mload(0x4220)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column20_row12*/ mload(0x4580), /*column20_row12*/ mload(0x4580), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4e20),
                    addmod(
                      addmod(/*column20_row8*/ mload(0x4540), /*column19_row7*/ mload(0x4220), PRIME),
                      /*column20_row24*/ mload(0x4640),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4e20),
                  addmod(/*column20_row4*/ mload(0x4500), /*column20_row20*/ mload(0x4600), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column20_row12*/ mload(0x4580),
                    addmod(
                      /*column20_row8*/ mload(0x4540),
                      sub(PRIME, /*column20_row24*/ mload(0x4640)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0*/ mload(0x4e40),
                addmod(
                  /*column20_row24*/ mload(0x4640),
                  sub(PRIME, /*column20_row8*/ mload(0x4540)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0*/ mload(0x4e40),
                addmod(
                  /*column20_row20*/ mload(0x4600),
                  sub(PRIME, /*column20_row4*/ mload(0x4500)),
                  PRIME),
                PRIME)
              ...
              // res += val * (coefficients[294] + coefficients[295] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
              ...
              // res += val * (coefficients[298] + coefficients[299] * adjustments[18]).
              res := addmod(res,
                            mulmod(val,
              ...
              // res += val * (coefficients[302] + coefficients[303] * adjustments[19]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column20_row8182*/ mload(0x4880),
                sub(
                  PRIME,
                  addmod(
                    /*column20_row4084*/ mload(0x4760),
                    mulmod(
                      /*column20_row8161*/ mload(0x47e0),
                      addmod(
                        /*column20_row8166*/ mload(0x4800),
                        sub(PRIME, /*column20_row4088*/ mload(0x4780)),
                        PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column20_row8161*/ mload(0x47e0), /*column20_row8161*/ mload(0x47e0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column20_row8166*/ mload(0x4800), /*column20_row4088*/ mload(0x4780), PRIME),
                    /*column19_row4103*/ mload(0x4460),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column20_row8182*/ mload(0x4880), /*column19_row4111*/ mload(0x4480), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column20_row8161*/ mload(0x47e0),
                    addmod(
                      /*column20_row8166*/ mload(0x4800),
                      sub(PRIME, /*column19_row4103*/ mload(0x4460)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(
                  /*column20_row8180*/ mload(0x4860),
                  /*ecdsa/sig_config.shift_point.y*/ mload(0x300),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column20_row4092*/ mload(0x47c0),
                    addmod(
                      /*column20_row8184*/ mload(0x48a0),
                      sub(PRIME, /*ecdsa/sig_config.shift_point.x*/ mload(0x2e0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column20_row4092*/ mload(0x47c0), /*column20_row4092*/ mload(0x47c0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
              ...
              let val := addmod(
                mulmod(/*column20_row30*/ mload(0x4660), /*column20_row4080*/ mload(0x4740), PRIME),
                sub(PRIME, 1),
                PRIME)
              ...
              // res += val * (coefficients[318] + coefficients[319] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                mulmod(/*column20_row2*/ mload(0x44e0), /*column20_row4090*/ mload(0x47a0), PRIME),
                sub(PRIME, 1),
                PRIME)
              ...
              // res += val * (coefficients[320] + coefficients[321] * adjustments[21]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[320]*/ mload(0x2c40),
                                       mulmod(/*coefficients[321]*/ mload(0x2c60),
                                              /*adjustments[21]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              let val := addmod(
                /*column20_row8176*/ mload(0x4840),
                sub(
                  PRIME,
                  mulmod(/*column19_row7*/ mload(0x4220), /*column19_row7*/ mload(0x4220), PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column19_row15*/ mload(0x42e0), /*column19_row15*/ mload(0x42e0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
                      mulmod(/*column19_row7*/ mload(0x4220), /*column20_row8176*/ mload(0x4840), PRIME),
                      mulmod(/*ecdsa/sig_config.alpha*/ mload(0x2c0), /*column19_row7*/ mload(0x4220), PRIME),
                      PRIME),
              ...
              // res += val * (coefficients[324] + coefficients[325] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
              ...
              // res += val * (coefficients[326] + coefficients[327] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column17_row4118*/ mload(0x4060),
                sub(PRIME, addmod(/*column17_row22*/ mload(0x3d60), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row8214*/ mload(0x40a0),
                sub(PRIME, addmod(/*column17_row4118*/ mload(0x4060), 1, PRIME)),
                PRIME)
              ...
              // res += val * (coefficients[330] + coefficients[331] * adjustments[22]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[330]*/ mload(0x2d80),
                                       mulmod(/*coefficients[331]*/ mload(0x2da0),
                                              /*adjustments[22]*/mload(0x5b00),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              let val := addmod(
                /*column17_row4119*/ mload(0x4080),
                sub(PRIME, /*column20_row30*/ mload(0x4660)),
                PRIME)
              ...
              let val := addmod(
                /*column17_row23*/ mload(0x3d80),
                sub(PRIME, /*column19_row7*/ mload(0x4220)),
                PRIME)
              ...
              // res += val * (coefficients[334] + coefficients[335] * adjustments[18]).
              res := addmod(res,
                            mulmod(val,
              ...
              // res += val * (coefficients[338] + coefficients[339] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := addmod(
                /*column17_row86*/ mload(0x3e20),
                sub(PRIME, addmod(/*column17_row150*/ mload(0x3ee0), 1, PRIME)),
                PRIME)
              ...
              // res += val * (coefficients[340] + coefficients[341] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
              ...
              let val := mulmod(
                addmod(
                  /*column17_row406*/ mload(0x4000),
                  sub(PRIME, /*column17_row150*/ mload(0x3ee0)),
                  PRIME),
                addmod(
                  /*column17_row406*/ mload(0x4000),
                  sub(PRIME, addmod(/*column17_row150*/ mload(0x3ee0), 2, PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column17_row151*/ mload(0x3f00),
                  sub(PRIME, /*column17_row0*/ mload(0x3bc0)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column17_row87*/ mload(0x3e40),
                  sub(PRIME, /*column19_row9*/ mload(0x4260)),
                  PRIME),
                PRIME)
              ...
              // res += val * (coefficients[346] + coefficients[347] * adjustments[23]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[346]*/ mload(0x2f80),
                                       mulmod(/*coefficients[347]*/ mload(0x2fa0),
                                              /*adjustments[23]*/mload(0x5b20),
                      PRIME)),
                      PRIME),
                      PRIME)
