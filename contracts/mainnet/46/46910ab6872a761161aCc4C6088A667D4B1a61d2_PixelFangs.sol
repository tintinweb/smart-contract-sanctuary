...
contract PixelFangs is ERC721Enumerable, Ownable {  
    ...
    constructor (string memory newBaseURI, address fngAddress) ERC721 ("PixelFangs", "PXF") {
        setBaseURI(newBaseURI);
        
        // Deploy with the Fang Gang contract address
        fg = fng(fngAddress);

        // Reserve 4 special Pixel Fangsters as a prize
        for (uint256 i; i < 4; i++) {
            claimed[i] = true;
