...
/**
 * @title Propel Token
 * @dev Propel ERC20 Token
 */
contract PropelToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Propel Token", "PEL") {
     ...
     * Owner is assumed to be governance or Propel trusted party for helping users
