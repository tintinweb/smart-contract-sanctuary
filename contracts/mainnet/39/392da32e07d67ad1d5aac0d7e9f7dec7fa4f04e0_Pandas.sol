...
contract Pandas is ERC721URIStorage, Ownable {
    ...
    uint256 public phaseAmount = 1000; 
    ...
    function resetPhase(uint256 _phaseAmount) public onlyOwner {
        phaseAmount = _phaseAmount;
        phase += 1;
    }
 
    function mintPandas(uint256 _times) payable public mintEnabled {
        require(phaseAmount - _times >= 0, "Phase limit met");
