...
contract PlasmaCoreToken is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Plasma Core";
    ...
    function PlasmaCoreToken() public CappedToken(TOKEN_CAP) {
