...
/**
 * The HTEST Token itself is just a standard ERC20, with:
 * No minting.
 * Public burning.
 * Transfer fee applied.
 */
contract HTESTM is DeflationaryERC20 {

    constructor() DeflationaryERC20("Hype TESTM", "HTESTM") {
