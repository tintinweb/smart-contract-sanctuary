...
contract BoredSkullsYachtClub is ERC721Enumerable, OpenSea, Ownable, PaymentSplitter {
    ...
    ) ERC721("Bored Skulls Yacht Club", "BSYC") PaymentSplitter(_payees, _shares) {
    ...
    function mint(uint256 count) public payable {
        ...
        if (supply < 2001 && supply + count > 2001) {
            uint256 payCount = supply + count - 2001;
