...
contract RIPToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "Routing Information Protocol";
    ...
    function RIPToken() public CappedToken(TOKEN_CAP) {
