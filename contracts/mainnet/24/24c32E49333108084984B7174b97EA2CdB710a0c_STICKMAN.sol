...
// SafeMath library, we all be sucking at maths.
library SafeMath {
...
// String operations library because who doesn't want strings attached?
library Strings {
...
contract STICKMAN is ERC721Enumerable, Ownable{
    ...
    constructor() ERC721("STICKMAN", "STKMN"){
    }
    ...
    function mint(uint numberOfTokensMax5) public payable {
        ...
        require(NFT_PRICE.mul(numberOfTokensMax5) == msg.value, "Not enough ether was sent");
