...
/** 🐕MoonDoggy🐕
 * MOONDOGGY is the future of dogecoins 🐶. Doggymon came from another planet that everyone has heard of, but with a kind of spaceship 🚀 that no human can build, with a CRAZINESS that no man has ever seen. BUT...there is a little problem...he is trapped here, in our planet, in our world, and we can not take the craziness these beings have, so we ALL have to help MoonDoggy to get him back to the MOON 🌑...to get him back where he belongs!!!
 * We like crazy spirits like our mascot MoonDoggy and we ALL have to be crazy ourselves to make the chart go CRAZY.
 * How about MoonDoggy and Doge mixed in one giving amazing rewards in doge!?
 * Hop in!
 * 📤Total Supply: 100,000,000,000 tokens
 * 💰Tokenomics:💰
 * 🐶 8% Doge rewards
 * 1% Buy Back | 6% Liquidity | 4% Marketing
 * 🔓Liquidity will be locked on Unicrypt 🔓
 * 💰 Marketing paid
 * 🐶 BIG Dogecoin rewards
 * 
 * Earn one of the Elon's favourite out there!
 * 
 * Website: https://moondoggy.dog
 * Join our Telegram: https://t.me/moondoggyerc
*/
...
contract MOONDOGGY is Context, IERC20, Ownable {
    ...
    string private _name = 'MoonDoggy';
    string private _symbol = 'MOONDOGGY';
