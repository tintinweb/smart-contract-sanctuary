...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("CLONEX RTFKT", "RTFKT") {
    setHiddenMetadataUri("ipfs://Qma2LFHvJcms9XKAaAtEK2ndb56F7nefrLzcWqGVcVYSct/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xe041669B0155E42598c96CA512D49dD1A779de9d).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
