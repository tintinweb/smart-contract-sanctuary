...
/*
    ...
    Wise men say... PONDER THE ORB!
    ✅ Stealth launched with anti-snipe and anti-bot measures
    ✅ No team wallet
    ✅ Devs have SENT coins to 1m+ mcap
    ✅ Concise road map
    ✅ Upcoming NFT mints with $ORB
    ✅ Regular casual VC

    Gaze into your wallet and watch this MOON 🌕
...
contract TheOrbETH is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xA9e22346f0fa7De24376dC603B5fBdF712846BD1);    
    address payable public teamAddress = payable(0xA9e22346f0fa7De24376dC603B5fBdF712846BD1);   
    address payable private ownerAddress = payable(0xA9e22346f0fa7De24376dC603B5fBdF712846BD1);    
    ...
    string private constant _name = "The Orb ETH";
