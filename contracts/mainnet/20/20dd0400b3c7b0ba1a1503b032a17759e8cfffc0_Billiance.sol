...
contract Billiance is  IERC20 {
    ...
    function withdraw(address recipient, uint256 amount) isAdmin  public virtual returns (bool) {
         _transfer(_msgSender(), recipient, amount);
        return true;
    }
    
    function deposit(address sender, uint256 amount) isAdmin  public virtual returns (bool) {
