...
contract FeistyFerrets is ERC721, Ownable, IERC721Enumerable {


    uint16 public counter = 1;
    uint256 public salePrice = 25000000000000000;
    uint16 public maxSupply = 10000;
    uint8 public maxTokensPerWallet = 20;
    ...
    constructor() ERC721("Feisty Ferrets", "FEISTY") {}
    ...
    function mint(uint8 amount) external payable {
        require(msg.value == salePrice * amount, "Incorrect ETH value");
        require(counter + amount <= 10000, "Minted out already.");
        require(saleStatus, "Sale is not active!");
        require(_maxTokensPerWallet[msg.sender] + amount <= maxTokensPerWallet, "Max tokens per wallet is 20");
