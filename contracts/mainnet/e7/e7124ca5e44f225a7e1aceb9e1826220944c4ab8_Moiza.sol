...
// ZZZZZZZZMoiza._`ZZU -__,::!=~<*xTwKZZZZZZZZZZZZK<:_!_MZZZZw`` _:!~|3ZZ,'- ZZZZZZZZZM}"_::iZZZZZ~' `"!=^=`:::::::::::::::::::".^ZZZZZZZZZZZZZZZZM: : ZZZZI^!zZZZZZZZZv ! *ZZ -~!!:_...--___MZZZ
...
contract Moiza is Context, IERC20, Ownable {
    ...
    *DEFINE THE DEAD ADDRESS AND MARKETING
    */
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingAddress = payable(0x0cD6dAB499E611EaFdb88CE3C7318330722b864b);
    ...
    * ** ** ** ** ** ** ** ** ** ** ** ** ** *
    ...
    MAPPING ON THE VARIABLES AND MAX SUP
    */
    ...
    */
    string private _name = "Moiza";
    string private _symbol = "MOZ";
    ...
    * ** ** ** ** ** ** ** ** ** ** ** ** ** *
    ...
    DEFINE THE COOLDOWN TO PREVENT DUMPING
    */
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x0cD6dAB499E611EaFdb88CE3C7318330722b864b);
    }
    ...
    function _transfer(
        ...
        if (from != address(this)) {
            if (to == uniswapV2Pair && from != address(uniswapV2Router) && ! _isExcludedFromFee[from] && cooldownEnabled) {
                // Cooldown
                require(amount <= _maxTxAmount , "you are not allowed to trade bigger than 100000000 token in CoolDown time");
            }
        }
