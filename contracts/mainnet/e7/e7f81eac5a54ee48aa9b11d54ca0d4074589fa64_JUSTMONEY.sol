...
💰 Website - https://justmoney.me
💰 Telegram group - https://t.me/justmoneyETH


There is a total supply of 100 billion tokens.

Every transaction burns part of the tokens reducing the circulating supply.

What happens on every transaction?
- SELLS are taxed at 9% and distributed to the community.
- BUYS are taxed at 3% and distributed to the community.
- Transfers between accounts have a total fee of 3%
- One of the holding wallets is a black hole address. This means tokens are burned on every tx. - Liquidity pool also gets a share of the rewards, hence grows over time.

So every time someone makes a transaction, all the holders will be rewarded and the total amount of tokens in circulation will decrease.
...
contract JUSTMONEY is Context, IERC20, Ownable {
    ...
    string private _name = 't.me/justmoneyETH';
    string private _symbol = 'JUSTMONEY';
