...
pragma solidity ^0.6.12;
    ...
    contract ZOIDS is Context, IERC20, Ownable {
        ...
        string private constant _name = 'ZOIDS';
        string private constant _symbol = 'ZOIDS';
        ...
        uint256 private _maxTxAmount = 20000000000 * 10**18;
        uint256 private constant _numOfTokensToExchangeForTeam = 5000000 * 10**18;
        uint256 private _maxWalletSize = 50000000000 * 10**18;
        ...
        function sendETHToTeam(uint256 amount) private {
            ...
            _marketingWalletAddress.transfer(amount.div(5).mul(4));
        }
