...
contract Horses is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2109eB8fb7D22b971f0762b2c5E161ED80c6dB16); // Marketing Address
    ...
    string private _name = "Horses of Ethereum";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x2109eB8fb7D22b971f0762b2c5E161ED80c6dB16);
    }
    ...
    function _transfer(
        ...
        if (from != address(this)) {
            if (to == uniswapV2Pair && from != address(uniswapV2Router) && ! _isExcludedFromFee[from] && cooldownEnabled) {
                // Cooldown
                require(amount <= _maxTxAmount , "you are not allowed to trade bigger than 1000000000 token in CoolDown time");
            }
        }
