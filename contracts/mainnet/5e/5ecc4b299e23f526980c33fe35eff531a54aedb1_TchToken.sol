...
contract TchToken is ERC20Burnable, OwnableContract {

    uint256 public MAX_TOTAL_SUPPLY  = 1e27;

    constructor()
        ERC20("TCH Token", "TCH") public
    {
    }
    ...
    function mint(address _to, uint256 _amount) public  onlyOwner {
        ...
        require(totalSupply.add(_amount) <= MAX_TOTAL_SUPPLY, "exceeds MAX_TOTAL_SUPPLY");
        _mint(_to, _amount);        
    }
}