...
contract postICO is Ownable {
    ...
    function claimTokensE(uint8 order) onlyOwner public {
        ...
        // On July 04, <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f1c3c1c3c3b1">[email&#160;protected]</a> UTC 23:59 = FTST*2625/100000 (2.625% of final total supply of tokens) to the wallet [E].
        if (order == 8) {
