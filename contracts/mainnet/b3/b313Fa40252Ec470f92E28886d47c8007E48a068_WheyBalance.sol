...
// File contracts/helpers/WheyBalance.sol



pragma solidity 0.6.12;
contract WheyBalance {
    using SafeMath for uint;
    using SafeERC20 for IERC20;
    
    WheyFarm public constant wheyFarm = WheyFarm(0x7f99c3E587A168aea5fF1Fc0f840Ba7A0163d00A);
    IERC20 public constant WHEY = IERC20(0xCa5d29B3e74D59EBcDF09111495d86F319886A40);
    IERC20 public constant WHEYV2 = IERC20(0x072cFb8233680B7B196fC8bA6E1aF76CBB5c49E6);
    IERC20 public constant WHEY_WETH_LP = IERC20(0xbC9bF17f37b5dD6df961233240aDE103b41c521E);
    
    function balanceOf(address _address) external view returns (uint) {
        // Address Balance
        uint balance = WHEY.balanceOf(_address);
        balance = balance.add(WHEYV2.balanceOf(_address));
        
        // Whey Farm Balance
        (uint amount, ) = wheyFarm.userInfo(0, _address);
        balance = balance.add(amount);
        
        // LP balance
        (uint lpBalance,) = wheyFarm.userInfo(1, _address);
        lpBalance = lpBalance.add(WHEY_WETH_LP.balanceOf(_address));
        
        // Amount of WHEY in LP tokens
        balance = balance.add(lpBalance.mul(WHEY.balanceOf(address(WHEY_WETH_LP))).div(WHEY_WETH_LP.totalSupply()));
