...
/**
  Telegram: t.me/WillysToken
  Website: WillysToken.com
...
contract WillysToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Willys Token";
    string private constant _symbol = "WILLYS";
    ...
    uint256 public _maxTxAmount = 3000 * 1e5 * 1e9; //max transaction set to 3%
    uint256 public _maxWalletSize = 5000 * 1e5 * 1e9; //max wallet set to 5%
    uint256 public _swapTokensAtAmount = 1000 * 1e4 * 1e9; //amount of tokens to swap for eth 0.1%
    ...
    constructor(address payable Mktg) {
