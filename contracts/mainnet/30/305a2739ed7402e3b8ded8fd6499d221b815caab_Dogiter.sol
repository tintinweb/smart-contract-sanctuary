...
/*
 ...
 |  __ \ / __ \ / ____|_   _|__   __|  ____|  __ \ 
 | |  | | |  | | |  __  | |    | |  | |__  | |__) |
 | |  | | |  | | | |_ | | |    | |  |  __| |  _  / 
 | |__| | |__| | |__| |_| |_   | |  | |____| | \ \ 
 |_____/ \____/ \_____|_____|  |_|  |______|_|  \_\
    
Dogiter - $Dogiter

https://dogiter.com

https://t.me/DogiterToken

[Announcements 🗣](https://t.me/DogiterTokenAnnouncements)
[Twitter 🐦](https://twitter.com/DogiterToken)
[Chinese Group 🇨🇳](https://t.me/DogiterTokenCN)
[Litepaper 🔖](https://drive.google.com/file/d/19Odx0LjU1jswZsJTAh_WDYn4nifOSiOK/view)
[Github 🛠](https://github.com/DogiterTeam)
*/
...
contract Dogiter is Context, IERC20, Ownable {
    ...
    string private _name = "Dogiter";
    string private _symbol = "DOGITER";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 3;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public marketingFeePercent = 55; // from the 10% liquidity fee
    ...
    function setMarketingFeePercent(uint256 fee) public onlyOwner {
        require(fee < 55, "Marketing fee cannot be more than 55% of liquidity");
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 12, "Tax fee cannot be more than 12%");
        _taxFee = taxFee;
    }
