...
//                                                                        
//  FCX automatically burns 4% of the total supply and
//  applies a 5% tax upon each transaction. This tax is
...
contract FissionCash is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5.4 * 10**6 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Fission Cash';
    string private _symbol = 'FCX';
