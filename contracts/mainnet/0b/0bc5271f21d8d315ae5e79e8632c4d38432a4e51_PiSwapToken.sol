...
contract PiSwapToken is ERC20("Pi Swap", "PI"), Ownable {
    using SafeMath for uint256;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "Pi Swap::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Pi Swap::delegateBySig: invalid nonce");
        require(now <= expiry, "Pi Swap::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "Pi Swap::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "Pi Swap::_writeCheckpoint: block number exceeds 32 bits");
