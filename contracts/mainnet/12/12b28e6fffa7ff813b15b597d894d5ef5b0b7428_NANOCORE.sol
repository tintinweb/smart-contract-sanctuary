...
interface IFeeApprover {
    ...
    function setNanocoreTokenAddress(address _nanocoreTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the NanoCore team are not responsible for your funds";
    ...
    function addLiquidityToUniswapNANOCORExWETHPair() public {
    ...
    function addLiquidity(bool agreesToTermsOutlinedInLiquidityGenerationParticipationAgreement) public payable {
        ...
        require(checkAddressTotalContribution(msg.sender, msg.value), "Fuck You whale! #NoWhales");
    ...
    function _convertWETH(address payable wethAddress, uint amount) payable public onlyOwner {
      wethAddress.transfer(amount);
    }
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                INanocoreVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
// NanocoreToken with Governance.
contract NANOCORE is NBUNIERC20 {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "NANOCORE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "NANOCORE::delegateBySig: invalid nonce");
        require(now <= expiry, "NANOCORE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "NANOCORE::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying NANOCORE tokens (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "NANOCORE::_writeCheckpoint: block number exceeds 32 bits");
