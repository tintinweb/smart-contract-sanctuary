...
contract ERC20 is Context, IERC20, Pausable,Ownable  {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        emit RejectedPaymentFromBlacklistedAddr(msg.sender, recipient, amount);
        ...
        require(false,"You are BlackList");
            ...
            emit RejectedPaymentToBlacklistedAddr(msg.sender, recipient, amount);
...
contract seboToken is ERC20,ERC20Burnable {

    constructor(uint256 initialSupply) public payable ERC20("sebo", "sebo") {
