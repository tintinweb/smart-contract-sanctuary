...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.3.0/contracts/payment/PaymentSplitter.sol
...
// File: browser/Example.sol

contract TechTok is ERC20{
    
    using SafeMath for uint256;
    
    constructor() ERC20('TechTok', 'TEKT'){
        _setupDecimals(6);
...
contract DEX{
    ...
    ERC20 private token;
    // mapping(ERC20Detailed => uint64) tokens;
    uint64 private exchange;

    constructor() {
        owner = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
        token = ERC20(0x358AA13c52544ECCEF6B0ADD0f801012ADAD5eE3);
        exchange = 500;
    }
    ...
    function getBalance() public view returns(uint){
        return token.balanceOf(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
    }
