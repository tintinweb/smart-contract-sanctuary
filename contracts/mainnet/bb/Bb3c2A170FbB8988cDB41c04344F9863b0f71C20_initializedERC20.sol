...
contract TokenFoundry is Ownable, CloneFoundry {
  ...
  // NOTE: This MUST be the address of the ERC20 master contract initialized
  address payable public masterContract = 0x67d7FE7dE625311f6298fd70516d5C34A9427D72; // PROD ETH MasterContract for kovan.eth testnet jacinto factory
  
  // address to receive fees
  address payable public tokenfoundryboss = 0xAc808a628E0A26F3E2FB95eB8CD35835565Ee8B6; // this has to be the owner of contract (Account 1 on MetaMask)
  
  address payable public tokenfoundryreferrer;

  //uint256 public fee = 200000000000000000;
  uint256 public fee = 50000000000000000; // ros factory traganiquel (this equates to 0.05 ETH)
