...
contract MajinInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Majin Inu";
    string private constant _symbol = "MBINU";
    ...
    address payable private _marketingAddress = payable(0xe982Da95d31BEC123F2901395CaD6a21f62CAa44);
