...
contract BattleRoyaleMintPass is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    constructor(string memory baseURI) ERC721("BattleRoyaleMintPass", "BattleRoyaleMintPass") {
        setBaseURI(baseURI);
        pause(true);
        sale = true;
    }
    ...
    function mintPass(address _to, uint256 _count) public onlyOwner {
        for (uint256 i = 0; i < _count; i++) {
            _mintAnElement(_to);
        }
    }
