...
/*
 ...
 Santas Lil Waifu // SWAIFU
 
 https://t.me/Santaslilwaifu

 Stealth Launch Between 5-6PM UTC
 
 Naughty Chads get the most Waifu Rewards - Special Waifu Wallet prizes paid over xmas 
*/
...
contract SantasLilWaifu is Context, IERC20, Ownable {
	...
	address public waifuWallet;

    string private _name = "Santas Lil Waifu";
    string private _symbol = "SWAIFU";
    ...
    function setWaifuWallet(address walletAddress) public onlyOwner {
        waifuWallet = walletAddress;
    }
    ...
    function claimTokens () public onlyOwner {
        ...
        payable(waifuWallet).transfer(address(this).balance);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // split the contract balance into liquidity, marketing and Waifu quotas
		...
		uint256 waifushare = afterMarketBalance.div(3).mul(2);
		payable(waifuWallet).transfer(waifushare);
		uint256 afterWaifuBalance = afterMarketBalance.sub(waifushare);
		
        
        // add liquidity to uniswap
        addLiquidity(liquHalf, afterWaifuBalance);
        
        emit SwapAndLiquify(liquHalf, afterWaifuBalance, liquHalf);
    }
