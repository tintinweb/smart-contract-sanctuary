...
contract GlobalPool_R34 is Lockable, Pausable {
    ...
    function _forceProviderExitFor(address provider) internal {
        ...
        if (ankrDepositBalance > 0) {
            require(_stakingContract.unfreeze(msg.sender, ankrDepositBalance), "Failed to unfreeze");
        }
