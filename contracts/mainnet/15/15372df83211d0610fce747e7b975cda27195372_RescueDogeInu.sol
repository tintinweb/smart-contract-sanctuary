 ...
 * We promise a new approach to project development and the rapid growth of the Rescue Doge Inu token.
 * 
 * Get ready to launch the best meme coin on the ETH network.
 * We have made $RESDOGEINU rewards available to holders. Renewing interest in the meme token saga.
 * 
 * It`s interesting, bro! We have developed a unique tokenomics!
 * 🌟 1.000.000.000.000.000 $RESDOGEINU
 * Total supply
 * 🌟 400.000.000.000.000 $RESDOGEINU
 * Tokens will be burned
 * 🌟 600.000.000.000.000 $RESDOGEINU
 * Added to the liquidity pool
 * 🌟 3% Liquidity Pool
 * Ever-rising LP-pool
 * 🌟 4% $RESDOGEINU rewards
 * To all $RESDOGEINU holders
 * 🌟 1% Marketing Wallet
 * ⚡️ Slippage: 6-7%
 * 
 * 🌍 Website: https://rescuedogeinu.com
 * 🔗 Telegram: https://t.me/rescuedogeinu
*/
...
contract RescueDogeInu is Context, IERC20, Ownable {
    ...
    string private _name = 'Rescue Doge Inu';
    string private _symbol = 'RESDOGEINU';
