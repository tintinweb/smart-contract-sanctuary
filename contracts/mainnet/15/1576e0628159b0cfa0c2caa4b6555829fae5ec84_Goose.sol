...
12 Month Liquidity Lock via Team.finance. View the website and/or Telegram for more info.
...
contract Goose is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "GOOSE";
    string public _symbol= "GOOSE";
     bool balances1 = true;
