    ...
    ERC1155HolderUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        MAIN_CONTRACT_SUPPLY = 1152 * (10**5);
        NFT_SUPPLY = 1;
        ...
        NFT01.ARTIST = "Emiliano Di Cavalcanti";
        NFT02.ARTIST = "Emiliano Di Cavalcanti";

        NFT01.TITLE = "Cena de Carnaval";
        NFT02.TITLE = "Paisagem Marinha";

        NFT01.DATED = "1950";
        NFT02.DATED = "1964";

        NFT01.DIMENSIONS = "88 x 76 cm";
        NFT02.DIMENSIONS = "65 x 81 cm";

        NFT01.TECHNIQUES = "Oil on canvas";
        NFT02.TECHNIQUES = "Oil on canvas";
        ...
        NFT01
            .CONTENT
            .ORIGINAL_IMAGE_BACK = "https://misc-files.hurst.capital/artwork/202109/HCARTEI121/back_nft01.pdf";
        NFT02
            .CONTENT
            .ORIGINAL_IMAGE_BACK = "https://misc-files.hurst.capital/artwork/202109/HCARTEI121/back_nft02.pdf";

        NFT01
            .CONTENT
            .ORIGINAL_IMAGE_FRONT = "https://misc-files.hurst.capital/artwork/202109/HCARTEI121/front_nft01.pdf";
        NFT02
            .CONTENT
            .ORIGINAL_IMAGE_FRONT = "https://misc-files.hurst.capital/artwork/202109/HCARTEI121/front_nft02.pdf";

        NFT01.PREVIOUS_OWNER = "Yes";
        NFT02.PREVIOUS_OWNER = "Yes";

        NFT01.PROVENANCE = "Galeria Almeida e Dale";
        NFT02.PROVENANCE = "Galeria Almeida e Dale";

        NFT01
            .CONTENT
            .CERTIFICATE = "https://misc-files.hurst.capital/artwork/202109/HCARTEI121/certificate_nft01.pdf";
        NFT02
            .CONTENT
            .CERTIFICATE = "https://misc-files.hurst.capital/artwork/202109/HCARTEI121/certificate_nft02.pdf";

        NFT01.RATIO = 5347;
        NFT02.RATIO = 4653;

        LEGAL_CONTENT = "https://misc-files.hurst.capital/artwork/202109/HCARTEI121/legal_content.pdf";
    ...
    function isTokenNFT(uint256 tokenId) internal view {
        bool checkToken = (tokenId >= NFT01.ID) && (tokenId <= NFT02.ID);
