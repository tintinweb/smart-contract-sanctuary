...
contract WormHole is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'WormHole Finance';
    ...
    uint256 private _tTotal = 8000 * _DECIMALFACTOR;
    uint256 private _rTotal = (_MAX - (_MAX % _tTotal));
    
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    
    //Distribution Reward Rate * 100
    ...
    //Whale Protection - Max BUY/SELL of 100 WORM per TX
