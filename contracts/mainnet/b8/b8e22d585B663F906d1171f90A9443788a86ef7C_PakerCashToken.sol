...
contract PakerCashToken is ERC20, Ownable {
    using SafeMath for uint256;
    bool public rewardPoolDistributed = false;

    function initialize() public initializer {
        Ownable.__Ownable_init();
        ERC20.__ERC20_init("PakerCash", "PKC");

		// 1.5M for initial liquidity provider, (10M-1.5M) for the liquidity farm.
        _mint(msg.sender, 1500000 * 1e18);
    }
    ...
    function distributeReward(address _farmPool) external onlyOwner {
        ...
        _mint(_farmPool, (10000000-1500000) * 1e18);
    }
