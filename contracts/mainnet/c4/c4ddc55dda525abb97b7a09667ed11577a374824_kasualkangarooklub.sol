...
// @title: KangarooClub.sol



contract kasualkangarooklub is ERC721, Ownable {
    using Strings for uint256;
    ...
    address public dev = 0x2c637B4f0819743bb23B1CD633f026E89f4b6351; //address to withdraw to
    ...
    constructor(string memory _baseuri) ERC721("Kasual Kangaroo klub", "KK") {
