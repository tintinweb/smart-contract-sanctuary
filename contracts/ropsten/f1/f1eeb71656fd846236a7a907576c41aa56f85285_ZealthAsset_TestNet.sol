...
contract ZealthAsset_TestNet is ERC20, ERC20Detailed,
    ...
    uint256 public genesisMintingBlockNumber;
    ...
    constructor() public ERC20Detailed("ZealthAsset_TestNet","ZLTH", 18){
        owner = msg.sender;
...
//--------------------------------------------------------------------------------------
    ...
    function transferToAddress(address sender, address recipient, uint256 value) internal {
        ...
        uint256 burnToken = value.mul(burnRate).div(1e4); {
            ...
            if(excluded[recipient] == true) burnToken = 0;
