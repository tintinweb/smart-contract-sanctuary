...
contract EscrowDemo {
    ...
    function createEscrowOrder(string calldata escrowId, address payable receiver, bytes32 hash, uint sendersTokens, uint8 tokenStandard,  address tokenContract, uint lockTimeOut) payable external{
        ...
        //check sender has approved these specific number of tokens to THIS CONTRACTS Address.
            ...
            //check balance equals or exceeds sendersTokens
                ...
                listOfEscrowOrders[escrowId].tokenContractAddress = tokenContract;                
    ...
    function closeEscrowOrder(string calldata escrowId, string calldata hashInput) external payable {
