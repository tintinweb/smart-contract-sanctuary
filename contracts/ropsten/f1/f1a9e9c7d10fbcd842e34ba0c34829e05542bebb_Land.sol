...
contract Land is ERC721Enumerable, Ownable {
  ...
  uint256 public maxBearDragonSupply = 1700;
  uint256 public maxEnvironmentSupply = 2000;
...
function BearWhitelistMint(uint bearId, uint _mintAmount) public payable {
    ...
    require(BearDragonSupplyMinted + _mintAmount <= maxBearDragonSupply, "No more BearDragon supply left");
