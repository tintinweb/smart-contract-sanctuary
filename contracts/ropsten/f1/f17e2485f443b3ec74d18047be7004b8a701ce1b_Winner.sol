...
interface WinnerInterface {
    ...
    function assign(uint256 _roundID) external;
...
contract Winner is Events, WinnerInterface {
    ...
    uint256     constant private    MAX_DURATION = 5 days;                                  // max duration every round
     ...
     * @dev bet
     */
    function bet() external payable isHuman isActivated isWithinLimits(msg.value)
    {
