...
contract SpaceCoinToken is BurnableToken, UpgradeableToken {
  ...
  function SpaceCoinToken(address _owner, string _name, string _symbol, uint _totalSupply, uint _decimals)  UpgradeableToken(_owner) {
    name = _name;
    symbol = _symbol;
