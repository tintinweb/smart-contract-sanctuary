...
contract Prosperity {
	...
	uint256 constant internal antiPumpAndDumpTime_ = 5 minutes;								// remember it is constant, so it cannot be changed after deployment
	...
	uint constant internal ACTIVATION_TIME = 1539373500;
