...
contract BearX is ERC721Enumerable, Ownable {
    ...
    function MINT(uint256 num) public payable {
        ...
        require( num <= _maxperWallet,                              "You can mint a maximum of 2 BEARX" );
        require( perWallet[msg.sender] + num <= _maxperWallet,      "You are exceeding limit of per wallet BEARX" );
