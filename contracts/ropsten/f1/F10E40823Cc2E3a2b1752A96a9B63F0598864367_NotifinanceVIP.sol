...
contract NotifinanceVIP is ERC1155, Ownable, ERC2981Base {
    ...
    constructor() ERC1155("https://mocki.io/v1/15f9b51c-0cdc-4e4b-bdbf-31e2b2d0a08d") {
        _setRoyalties(0x4C252eA359FAf44467895c387CD9101c2357c7Ce , 1000);
    ...
    function publicMint(uint256 amount) public payable mintable(amount) {
        ...
        require(amount <= maxPublicMintPerTx, "5 mints per transaction.");
        mint(amount);
    }
    ...
    function contractURI() public view returns (string memory) {
        return "https://mocki.io/v1/15f9b51c-0cdc-4e4b-bdbf-31e2b2d0a08d";
    }
