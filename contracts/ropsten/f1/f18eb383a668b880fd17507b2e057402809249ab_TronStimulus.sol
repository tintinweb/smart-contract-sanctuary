...
/*    uint constant public MAX_CONTRACT_PERCENT = 500;
    ...
    function set(uint x, uint y)  public onlyOwner{
     ...
     function setbase(uint base_percent)  public onlyOwner{
...
/*        if (contractPercent < BASE_PERCENT.add(MAX_CONTRACT_PERCENT)) {
    ...
    function getSiteStats() public view returns (uint, uint, uint, uint, uint) {
        return (totalInvestors,totalInvested, totalDeposits, address(this).balance, contractPercent);
    }
