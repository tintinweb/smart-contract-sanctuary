...
contract NEWC is owned {
    ...
    uint256 public buyPrice = 1045; // Ethereum Price
...
contract NEWCICO is owned, Killable {
    ...
    uint public endsAt = 1532695758; /// End DateTime

    /// the price of token
    uint256 public TokenPerETH = 1045; /// Toekn Per Ethereum

    /// Tokens funding goal in wei, if the funding goal is reached, ico will stop
    uint public MAX_GOAL_EBC = 300000000e18;
    ...
    function NEWCICO(address _token) {
        token = NEWC(_token);
    }
