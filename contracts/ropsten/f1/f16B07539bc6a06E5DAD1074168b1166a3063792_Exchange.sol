...
contract TransferSafe {
    ...
    function erc1155safeMintTransferFrom(IShizukaniStore token, address from, address to, uint256 id, uint256 value,
        ...
        if(order.key.sellAsset.assetType == AssetType.ERC721){
            if(order.orderType == 1 || order.orderType == 3) {
                if(!isStore){
                    ...
                    erc1155safeMintTransferFrom(IShizukaniStore(order.key.sellAsset.token), order.key.owner, buyer, order.key.sellAsset.tokenId, 1, 
                ...
                if(!isStore){
                    ...
                    erc1155safeMintTransferFrom(IShizukaniStore(order.key.buyAsset.token), buyer, order.key.owner, order.key.buyAsset.tokenId, 1,
                                                storeParams.blockExpiry,storeParams.v,storeParams.r, storeParams.s, storeParams.uri);
            ...
            if(order.orderType == 1 || order.orderType == 3) {
                if(!isStore){
                    ...
                    erc1155safeMintTransferFrom(IShizukaniStore(order.key.sellAsset.token), order.key.owner, buyer, order.key.sellAsset.tokenId, order.selling,
                                                storeParams.blockExpiry,storeParams.v,storeParams.r, storeParams.s, storeParams.uri);
                ...
                if(!isStore){
                    ...
                    erc1155safeMintTransferFrom(IShizukaniStore(order.key.buyAsset.token), buyer, order.key.owner, order.key.buyAsset.tokenId, order.buying,
                                                storeParams.blockExpiry,storeParams.v,storeParams.r, storeParams.s, storeParams.uri);
