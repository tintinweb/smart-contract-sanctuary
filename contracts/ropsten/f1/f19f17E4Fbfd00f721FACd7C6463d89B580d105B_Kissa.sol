    ...
    ContextMixin
{
        ...
        external
    {
        ...
        uint256 mittenzAllowance = IERC20(mittenzToken).allowance(depositor, address(this));
        ...
        IERC20(mittenzToken).safeTransferFrom(depositor, address(this), amountInMittenz);
        _mint(depositor, amountInKissa);
        _floatingReserve += amountInKissa;
        emit Exchange(depositor, mittenzToken, amountInMittenz, address(this), amountInKissa);
    }
