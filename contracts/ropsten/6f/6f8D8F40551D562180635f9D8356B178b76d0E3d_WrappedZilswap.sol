...
/**
* @title WrappedZilswap - Zilswap Token wrapped on Ethereum.
*
...
*/
contract WrappedZilswap is ERC20, ERC20Detailed {
  using SafeMath for uint256;

  address public lockProxyAddress;

  constructor(address _lockProxyAddress) ERC20Detailed("Ethereum-bridged ZWAP Token", "ZWAP", 12) public {
    lockProxyAddress = _lockProxyAddress;
  }

  function _transfer(address sender, address recipient, uint256 amount) internal override {
      if (sender == lockProxyAddress) {
          require(recipient != lockProxyAddress, "WrappedZilswap: lockProxy should not call transfer to self");
