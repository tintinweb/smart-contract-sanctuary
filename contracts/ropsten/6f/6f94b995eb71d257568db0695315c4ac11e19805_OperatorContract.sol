...
contract OperatorContract{
    ...
    modifier LocationAccess(){
        require(Operators[msg.sender].operator == msg.sender || Locations[msg.sender].location == msg.sender);
        _;
    }

    modifier ManagerAccess(){
         require(Operators[msg.sender].operator == msg.sender || Locations[msg.sender].location == msg.sender || Managers[msg.sender].manager ==msg.sender);
        _;
    }
