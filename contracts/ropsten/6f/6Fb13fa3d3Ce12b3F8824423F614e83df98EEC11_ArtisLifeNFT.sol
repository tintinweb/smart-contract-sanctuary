    ...
    ERC2771Context
{
    ...
    string tokenURI = "https://us-central1-artis-life-network.cloudfunctions.net/tokenURIv2?contractId=1&id={id}";
    ...
    function contractURI() public pure returns (string memory) {
        return
            "https://us-central1-artis-life-network.cloudfunctions.net/contractURIv3?contractId=1";
    }
