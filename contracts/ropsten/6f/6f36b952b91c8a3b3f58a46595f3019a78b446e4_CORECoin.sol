...
contract CORECoin is ERC20 {
    ...
    string public constant name = "CORECoin"; //* Token Name *//
    string public constant symbol = "CRN"; //* CORECoin Symbol *//
    uint public constant decimals = 8; //* Number of Decimals *//
    uint256 public totalSupply = 220000000000000000; //* total supply of CORECoin *//
    uint256 public totalDistributed = 150000000000000000 ;  //* Initial CORECoin that will give to contract creator *//
    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for CORECoin //
    uint256 public tokensPerEth = 80000000000000; //* CORECoin Amount per Ethereum *//
