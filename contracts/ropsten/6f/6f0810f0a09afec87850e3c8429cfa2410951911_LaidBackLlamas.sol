...
contract LaidBackLlamas is ERC721, BAYC, ContractURI, IMAX721, IMAX721Whitelist, Whitelist, ERC165Storage, ReentrancyGuard, PaymentSplitter, Developer, Ownable {
  ...
  uint private constant MINT_FEES = 0.01 ether;
  uint private constant PRESALE_MINT_FEES = 0.01 ether;
  ...
  bool private lockedProvenance = true;
  bool private lockedPayees = true;
