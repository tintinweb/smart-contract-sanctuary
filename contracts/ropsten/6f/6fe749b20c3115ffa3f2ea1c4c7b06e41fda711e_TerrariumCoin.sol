...
contract TerrariumCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TerrariumCoin() {
        ...
        name = "TerrariumCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TRT";                                             // Set the symbol for display purposes (CHANGE THIS)
