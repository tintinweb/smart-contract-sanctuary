...
//    function ERC20Token(
    function TJ2(
        ...
        balances[msg.sender] = 21987654321000000000000000000;               // Give the creator all initial tokens (100000 for example)
        totalSupply = 21987654321000000000000000000;                        // Update total supply (100000 for example)
        name = "TJ2Token";                                   // Set the name for display purposes
        decimals = 18;                            // Amount of decimals for display purposes
        symbol = "TJ2";                               // Set the symbol for display purposes
    }
