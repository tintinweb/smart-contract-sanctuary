...
contract BridgedLMLT is  IERC20, Ownable {
    ...
    constructor(address swapRouter
        ...
        _liquidityFee = 250;  //2.5%
        _previousLiquidityFee = _liquidityFee; 

        _charityAddress = 0xfb4b62Cd980a7415c39df889aA1E0016D352AACc;
        _charityFee = 250;  //2.5%
        ...
        if (_sentAmount > 0) {
          payable(0xfb4b62Cd980a7415c39df889aA1E0016D352AACc).transfer(_sentAmount);
        }
    ...
    function mint(address to, uint amount) external onlyOwner override{
      
      _mint(to, amount);
    }

    function burn(address owner, uint amount) external onlyOwner override {
