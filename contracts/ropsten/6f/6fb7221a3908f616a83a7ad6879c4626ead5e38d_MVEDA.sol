...
contract MVEDA is ERC20Interface, Owned, SafeMath {
    ...
    function MVEDA() public {
        symbol = "MVEDA10";
        name = "MedicalVeda Test 10";
        decimals = 8;
        _totalSupply = 8800000000000000;
        balances[0xDD76822450987d8e929F17aE50e7D9f0B99fBB96] = _totalSupply;
        Transfer(address(0), 0xDD76822450987d8e929F17aE50e7D9f0B99fBB96, _totalSupply);
    }
    ...
    function transferAnyERC20Token(address tokenAddress, uint tokens) public onlyOwner returns (bool success) {
     ...
     function burn(uint tokens) public onlyOwner{
        ...
        balances[burner] = safeSub(balances[owner], tokens);
        Burn(burner, balances[owner]);
        
        _totalSupply = safeSub(balances[burner], tokens);
    }
}