...
abstract contract ERC1271Validator is EIP712 {
...
abstract contract ERC1155Lazy is ERC1155BaseURI, Mint1155Validator, RoyaltiesV2, RoyaltiesV2Impl
{
    ...
    uint256 public minPrice = 230082033517790; // 1 USD
...
contract ERC1155BaseURI is ERC1155 {
...
abstract contract ERC1155Base is Ownable, ERC1155DefaultApproval, ERC1155Burnable, ERC1155Lazy, HasContractURI {
    ...
    function isApprovedForAll(address _owner, address _operator) public override(ERC1155, ERC1155DefaultApproval) view returns (bool) {
        return ERC1155DefaultApproval.isApprovedForAll(_owner, _operator);
    }

    function _mint(address account, uint256 id, uint256 amount, bytes memory data) internal virtual override(ERC1155, ERC1155Lazy) {
    ...
    function uri(uint id) external view override(ERC1155BaseURI, ERC1155) virtual returns (string memory) {
        return _tokenURI(id);
    }
    uint256[50] private __gap;
}
