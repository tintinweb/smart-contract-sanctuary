...
** Using FTPEthReflect to give 0.10% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xC6C7208d6F3Ee59805c78BED6Dc242af40811344), 4000);
        m_DidDeploy = true;
    }
...
contract InTime is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "In Time";
    ...
    function _walletCapped(address _recipient) private view returns (bool) {
        return _recipient != m_UniswapV2Pair && _recipient != address(m_UniswapV2Router) && block.timestamp <= m_Launched.add(100000000000000 hours);
    }
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 100, m_UniswapV2Pair, m_UniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
