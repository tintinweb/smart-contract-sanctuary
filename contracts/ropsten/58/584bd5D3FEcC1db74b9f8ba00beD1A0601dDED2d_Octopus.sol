...
contract Octopus is Ownable {
    ...
    ERC20 usdtToken = ERC20(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8); //0x1777cb74B2eF67BDC89864b8CeAce2d35ed30E96
    ...
    function getHowMuchToClaimForSellers(address _optionAddress, address _seller) public view returns (uint256) {
        ...
        uint256 totalToReturn = seller.usdtCollateral - seller.notional.mul(optionWorth).div(1e18);
