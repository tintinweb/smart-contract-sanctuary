...
contract EthereumCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**2;
    ...
    address payable private _marketingWalletAddress = payable(0x4989Fa255359B73891A90066E172dcF1285D202c);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 100 * 10**2;
