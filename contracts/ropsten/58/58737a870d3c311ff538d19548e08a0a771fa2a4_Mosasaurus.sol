...
With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, Moso was designed to reward holders and discourage dumping.
...
contract Mosasaurus is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"Mosasaurus Token";
    string private constant _symbol = "MOSA";
