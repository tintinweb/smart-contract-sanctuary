...
contract Escrow {
    ...
    enum state{AWAITING_PARTIES,AWAITING_BUYER_PAYMENT,AWAITING_DELIVERY,AWAITING_FUND_RELEASE,COMPLETE}//state of the smart contract
    
    //AWAITING_PARTIES - initial state
    //AWAITING_BUYER_PAYMENT - waiting for buyer
    ...
    constructor () {
        ...
        current=state.AWAITING_PARTIES;
    }

    // Define Seller
    function set_seller(address payable _seller) public {
        seller = _seller;
    } 

    function set_buyer(address payable _buyer) public {
        buyer = _buyer;
    }

    function check_parties_exist() public {
