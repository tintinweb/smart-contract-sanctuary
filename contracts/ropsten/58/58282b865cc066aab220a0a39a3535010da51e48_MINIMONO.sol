...
contract MINIMONO is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "MiniMononoke";                                           // name
    string private _symbol = "MINIMONO";                                            // symbol
    ...
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100000);
