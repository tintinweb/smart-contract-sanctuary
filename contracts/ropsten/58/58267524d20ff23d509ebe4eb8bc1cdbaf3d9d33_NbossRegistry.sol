...
contract NbossRegistry {
   ...
   */
   ...
   mapping(address => bool) validNbossKeys;
    ...
    */
    ...
    function isValidNbossSender(address sending_key) public view returns (bool) {
      return(validNbossKeys[sending_key]);
    }
      ...
      /**
       * @dev Functions to add and remove snowDAQ keys
       */
       
       function addNbossKey(address new_sending_key) external onlyOwner {
           validNbossKeys[new_sending_key] = true;
       }
       
       function removeNbossKey(address sending_key) external onlyOwner {
           validNbossKeys[sending_key] = false;
       }
   ...
   /// @dev Contract constructor sets initial owners and required number of confirmations.
        ...
        public
    {
        ...
        for (uint i=0; i<signing_keys.length; i++) {
            ...
            validNbossKeys[signing_keys[i]] = true;
        }
    }
