...
contract AA_TEST is Context, IERC20, Ownable { 
    ...
    */
    ...
    uint256 public _Split_BNB           = 100;       // Percent of fee that goes to external BNB wallet
    uint256 public _Split_Tokens        = 0;       // Percent of fee that goes to external token wallet
