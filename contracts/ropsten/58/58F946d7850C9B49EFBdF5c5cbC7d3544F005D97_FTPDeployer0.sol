...
FTPDeployer0 Socials:
Telegram: dfsdfs
Twitter: sdfsdff
Website: sdfsdffs
Whitepaper: fsdfdsfdsf
...
contract FTPDeployer0 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "FTPDeployer0";
    string private m_Symbol = "FTP0";
