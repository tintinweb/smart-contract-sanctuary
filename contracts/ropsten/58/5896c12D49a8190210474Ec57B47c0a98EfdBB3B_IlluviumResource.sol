...
import {ImmutableMintableERC20} from "../interfaces/ImmutableSpec.sol";
import "./ERC20Asset.sol";

/**
 * @title Immutable ERC20 Asset
 *
 * @notice IMX compatible ERC20 Asset
 *
 * @author Basil Gorin
 */
abstract contract ImmutableERC20Asset is ImmutableMintableERC20, ERC20Asset {
	/**
	 * @dev Creates/deploys an Immutable ERC20 asset
	 *
	 * @param _name asset name
	 * @param _symbol asset symbol
	 */
	constructor(string memory _name, string memory _symbol) ERC20Asset(_name, _symbol) {}
	...
	function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
		...
		return interfaceId == type(ImmutableMintableERC20).interfaceId || super.supportsInterface(interfaceId);
	}

	/**
	 * @inheritdoc ImmutableMintableERC20
	 *
	 ...
	 */
	function mintFor(address to, uint256 amount, bytes memory mintingBlob) public virtual override {
 ...
 * @author Basil Gorin
 */
abstract contract ERC20Asset is IERC165, ERC20, AccessControl {
	/**
	...
	/**
	 * @dev Creates/deploys an ERC20 asset
	 *
	 * @param _name asset name
	 * @param _symbol asset symbol
	 */
