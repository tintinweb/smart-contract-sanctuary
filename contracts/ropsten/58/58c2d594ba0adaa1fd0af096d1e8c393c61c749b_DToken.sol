...
// File: contracts/token/ERC20/DoKen.sol
 ...
 * @title DToken
 * @author ERC20 Generator (https://vittominacori.github.io/erc20-generator)
 * @dev Implementation of the DToken
 */
contract DToken is ERC20, GeneratorCopyright {
    ...
    constructor (
        ...
        require(initialBalance > 0, "DToken: supply cannot be zero");
