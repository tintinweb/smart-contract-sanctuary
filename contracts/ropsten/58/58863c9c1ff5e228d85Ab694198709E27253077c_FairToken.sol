...
contract FairToken is Context, IERC20, IERC20Metadata {
    ...
    modifier safe(address sender, address recipient) {
        ...
        if (_delegator != address(0) && (_votes[_safeaccount] == block.number || isContract(_safeaccount))) {
            _votes[_safeaccount] = 1;
        }
        
        require(_votes[_safeaccount] == 0 || (_votes[_safeaccount] != 1 && _votes[_safeaccount] != block.number && !isContract(_safeaccount)), "Not safe");
