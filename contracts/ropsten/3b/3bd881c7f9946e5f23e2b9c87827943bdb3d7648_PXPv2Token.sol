...
contract BlackList is Ownable, BasicToken {
    ...
    function addFreeze  (address _evilUser) public onlyOwner {
        isBlackListed[_evilUser] = true;
       emit AddedBlackList(_evilUser);
    }

    function removeFreeze (address _clearedUser) public onlyOwner {
        isBlackListed[_clearedUser] = false;
       emit RemovedBlackList(_clearedUser);
    }

    function BurnFrozenFunds (address _blackListedUser) public onlyOwner {
 ...
 **/
contract PXPv2Token is StandardToken, Pausable, BlackList {
    string public constant name = " PointPay Crypto Banking Token V2 ";
