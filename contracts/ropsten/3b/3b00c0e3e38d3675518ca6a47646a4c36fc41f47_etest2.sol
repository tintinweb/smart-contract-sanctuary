...
contract etest2 is Context, IERC20, Ownable {
    ...
    string private _name = 'eTest2';
    string private _symbol = 'eTest';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 0; // 4% reflection fee to avoid increasing the total supply
    ...
    uint256 private _numTokensSellToAddToLiquidity = 1 * 10**9;
