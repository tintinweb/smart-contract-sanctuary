...
contract Webtoken is Context, IERC20, Ownable {
    ...
    address private _owner = 0xe1E340c332Ff2f13F110f708Ea2B26ba99E4F2f8;
    ...
    string private constant _name = "WebToken";
    string private constant _symbol = "WEB";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 1 / 100; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 2 / 100; // 1.5% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0xEAFee36EBf1292aD105aCCA1E5AF6F1183a93Fb4); // Marketing Address
        
        devAddress = payable(0xEAFee36EBf1292aD105aCCA1E5AF6F1183a93Fb4); // Dev Address
        ...
        emit Transfer(address(0), _owner, _tTotal * 500 / 1000);
