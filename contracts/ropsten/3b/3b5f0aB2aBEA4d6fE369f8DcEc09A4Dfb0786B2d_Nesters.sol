...
contract Nesters {
    ...
    /**
    User makes an offer to rent the house
     */
    function makeOffer() public {}

    /**
    Landlord accepts the offer, save the trasansaction history
     */
    function acceptOffer() public {}

    /**
    BACKLOG: Deactivate the house
     */
    function deactiveHouse() public {}
