...
abstract contract USEPool is USEPoolAlgo,ContractGuard,AccessControl {
    ...
    uint256 public pool_ceiling = 1000000000e18;
    ...
    function mintFractionalUSE(uint256 collateral_amount, uint256 shares_amount, uint256 use_out_min) external onlyOneBlock notMintPaused {
        ...
        (uint256 mint_amount, uint256 shares_needed) = calcMintFractionalUSE(input_params);
    ...
    //update Required Reserve Ratio 
    function updateRequiredReserveRatio () public onlyByOwnerOrGovernance{
        last_required_reserve_ratio = requiredReserveRatio();
    }
