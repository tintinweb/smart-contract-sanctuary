...
contract Catoshi is Context, IERC20, Ownable {
    ...
    address private _charityWallet = 0x6b0C1a8d88d7e72205C253363DA257Ff4548e036;
    ...
    constructor() {
        ...
        _maxTxAmount = _tTotal;  // 0.25 percent of totalsupply, max transfer per wallet
    ...
    {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeam, uint256 tBurn) =
            _getTValues(tAmount, _taxFee, _teamFee, _burnFee);
        uint256 currentRate = _getRate();
