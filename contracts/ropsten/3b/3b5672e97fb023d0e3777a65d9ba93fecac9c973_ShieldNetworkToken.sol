...
contract ShieldNetworkToken is IERC20, Ownable {
    ...
    string private constant _name = "TestShield";
    string private constant _symbol = "SHIELDTEST";
    ...
    function setWalletSettings(address marketingWallet, address devFundWallet) external onlyOwner {
        require(marketingWallet != address(0xa964CAc3e7365FCa6dBEAe630A63EFabbA26ACe3), "marketingWallet: zero address");
        require(devFundWallet != address(0x4a3c5417C1Be29c668A9a720CEa49F0715BC8B6e), "devFundWallet: zero address");
