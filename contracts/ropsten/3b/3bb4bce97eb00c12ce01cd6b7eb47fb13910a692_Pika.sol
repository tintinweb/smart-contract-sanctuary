...
contract Pika is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 932_000_000_000e9;
    ...
    uint256 public minTokensBeforeSwap = 250000000;
    uint256 public minEthBeforeSwap = 250000000;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(
            ...
            "PIKA: Uniswap router cannot be excluded."
        );
        require(account != address(this), 'PIKA: The contract it self cannot be excluded');
        require(!_isExcluded[account], "PIKA: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "PIKA: Account is already included");
    ...
    function _transfer(
        ...
        //@dev Limit the transfer to 6000 tokens for first 5 minutes
        require(now > liquidityAddedAt + 5 minutes  || amount <= 20_000_000_000e9, "You cannot transfer more than 20000000000 tokens.");
