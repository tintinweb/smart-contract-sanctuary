...
contract Factory is Configurable, ContextUpgradeSafe, Constants {
    ...
    function swapRoute(SwapRouteParam calldata s) internal nonReentrant returns (address call, address put, int dUnd, int dCur) {
    ...
    function swapRoute2(address[2] calldata und_cur, uint[2] memory floor_cap, int[2] calldata dCallPut, int[2] calldata maxes, bytes calldata data, address[][2] calldata paths) external payable returns (address[2] memory call_put, int[2] memory dUndCur) {
