 ...
 * {ERC721Enumerable}.
 */
contract ERC721Initializable is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Log the creator of the contract for access control to initializer
    ...
    function initialize(string memory name_, string memory symbol_) public {
        require(_initializer != address(0x00), "ERC721Initializable: already initialized");
        require(_initializer == msg.sender, "ERC721Initializable: sender is not initializer");
        _initializer = address(0x00);
        _name = name_;
        _symbol = symbol_;
    }
