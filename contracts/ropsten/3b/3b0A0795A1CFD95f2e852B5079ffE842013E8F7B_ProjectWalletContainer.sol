...
contract ProjectWalletContainer is AuthorizedList {
    ...
    EnumerableSet.AddressSet private projectTeam;
    ...
    constructor(address _tokenAddress) AuthorizedList() payable {
        ...
        projectTeam.add(0x6e61665eb04E6229138df2b4c6d4A5c9606f6C0a);
        projectTeam.add(0xcFbA019149Af2Ab7A3e65DC90f4FE8b1eEF1c73E);
        projectTeam.add(0x2AA102Aff74e54A52d67c1a28827013ca88d9F32);
        projectTeam.add(0x855B455B08095AEf99eC151e4051fD32D1d61631);
        projectTeam.add(0x0fE3E2826827CC859773833111f68F585e4a834a);
        projectTeam.add(0xC030f718f1EeDfac5638153013A54487A238dc67);
        projectTeam.add(0xDEdF5bf60A4B24f744dCEB248bBE4b69e06DB05e);
    ...
    function collect() external authorized{
        ...
        for(uint256 i = 0; i < teamCount; i++){
            teamMember = payable(projectTeam.at(i));
            if(ethBal > 0){
            ...
            if(tokenBal > 0){
                ...
                token.transfer(teamMember, tokenShare);
            }
        }
    }
    ...
    function addSubAddress(address subAddress) external authorized {
        if(projectTeam.contains(_msgSender())){
