...
import "./IERC721.sol";
import "./Ownable.sol";
import "./GratiaWalletStorage.sol";

contract GratiaWalletBase is GratiaWalletStorage, Ownable {
    using SafeMath for uint256;
...
contract GratiaWalletEvents {
    event GratiaWalletSupported(
        address indexed host
    );

    event GratiaWalletUnsupported(
        address indexed host
    );

    event GratiaWalletSwapChanged(
        address indexed previousGratiaSwap,
        address indexed newGratiaSwap
    );

    event GratiaWalletLocked(
    ...
    event GratiaWalletOpened(
        address indexed owner,
        address indexed host,
        uint256 id
    );

    event GratiaWalletClosed(
        address indexed owner,
        address indexed host,
        uint256 id
    );

    event GratiaWalletETHDeposited(
        address indexed owner,
        address indexed host,
        uint256 id,
        uint256 amount
    ...
    event GratiaWalletETHWithdrawn(
        address indexed owner,
        address indexed host,
        uint256 id,
        uint256 amount,
    ...
    event GratiaWalletETHTransferred(
        address indexed owner,
        address indexed host,
        uint256 id,
        uint256 amount,
    ...
    event GratiaWalletERC20Deposited(
        address indexed owner,
        address indexed host,
        uint256 id,
        address erc20Token,
    ...
    event GratiaWalletERC20Withdrawn(
        address indexed owner,
        address indexed host,
        uint256 id,
        address erc20Token,
    ...
    event GratiaWalletERC20Transferred(
        address indexed owner,
        address indexed host,
        uint256 id,
        address erc20Token,
    ...
    event GratiaWalletERC721Deposited(
        address indexed owner,
        address indexed host,
        uint256 id,
        address erc721Token,
    ...
    event GratiaWalletERC721Withdrawn(
        address indexed owner,
        address indexed host,
        uint256 id,
        address erc721Token,
    ...
    event GratiaWalletERC721Transferred(
        address indexed owner,
        address indexed host,
        uint256 id,
        address erc721Token,
    ...
    event GratiaWalletERC1155Deposited(
        address indexed owner,
        address indexed host,
        uint256 id,
    ...
    event GratiaWalletERC1155Withdrawn(
        address indexed owner,
        address indexed host,
        uint256 id,
        address erc1155Token,
    ...
    event GratiaWalletERC1155Transferred(
        address indexed owner,
        address indexed host,
        uint256 id,
        address erc1155Token,
    ...
    event GratiaWalletERC20Swapped(
        address indexed owner,
        address indexed host,
        uint256 id,
        address inToken,
    ...
    event GratiaWalletERC721Swapped(
        address indexed owner,
        address indexed host,
        uint256 id,
        address inToken,
    ...
    event GratiaWalletERC1155Swapped(
        address indexed owner,
        address indexed host,
        uint256 id,
        address inToken,
...
contract GratiaWalletStorage {
    ...
    mapping(address => mapping(uint256 => uint256)) internal _ercBalances;

    address public gratiaSwap;
