...
contract ERC20 {
    ...
    string private constant _symbol = "gUNIV3";
    ...
    Ownable
{
    ...
    uint256 private _supplyCap = 20000 * 10**18; // default: 20,000 gUNIV3
    uint256 private _heartbeat = 86400; // default: one day
    int24 private _minTickDeviation = 120; // default: ~1% price difference up and down
    int24 private _maxTickDeviation = 7000; // default: ~100% price difference up and down
    uint32 private _observationSeconds = 300; // default: last five minutes;
    uint160 private _maxSlippagePercentage = 5; //default: 5% slippage
    ...
    constructor(
        ...
        _currentLowerTick = _initialLowerTick;
        _currentUpperTick = _initialUpperTick;
    ...
    function mint(uint128 newLiquidity) external returns (uint256 mintAmount) {
        ...
        uint256 supply = totalSupplyInternal();
        if (supply == 0) {
    ...
    function _adjustCurrentPool(
        ...
        if (
            _currentLowerTick != newLowerTick || _currentUpperTick != newUpperTick
        ) {
            (_currentLowerTick, _currentUpperTick) = (newLowerTick, newUpperTick);
        }
