...
contract CasinoVisarHatDM is MinterAccess, ERC721 {

    // Base Token URI
    string private _baseTokenURI;

    constructor (address newOwner, string memory tokenURIPrefix) ERC721("Decentraland Casinovisar Hat DM", "DCTR CVH DM") {
