...
//
//    function createItem(uint256 _rarity, uint256 _class, uint256 _type, uint256 _targetBlock) external {
//        uint256 _identity = ItemUtils.createItem(_rarity, _class, _type, _targetBlock);
//        safeTransferFrom(0, msg.sender, _identity);
//    }
}