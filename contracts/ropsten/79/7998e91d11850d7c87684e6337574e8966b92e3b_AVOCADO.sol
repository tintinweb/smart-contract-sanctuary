...
contract AVOCADO is Context, IERC20, Ownable {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of ETH ( TODO : note from reviewer: this is dangerous especially on large transactions( acceptable in this case since the transaction is most likely small)
            path,
            address(this),
            block.timestamp
        );
