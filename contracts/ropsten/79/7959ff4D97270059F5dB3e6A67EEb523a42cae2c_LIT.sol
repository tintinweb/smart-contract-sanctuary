...
contract LIT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Lit Coin";
    ...
    uint256 public _totalDonated = 0;
    uint256 public _charityFee = 2;
    uint256 private _previousCharityFee = _charityFee;
    uint256 public _liquidityFee = 5;
    uint256 private _previousLiquidityFee = _liquidityFee;

    //wallets can hold max 5% of the supply (can still earn autodistribution)
    uint256 public _whaleThreshold = 4 * 10**9 * 10**9;
