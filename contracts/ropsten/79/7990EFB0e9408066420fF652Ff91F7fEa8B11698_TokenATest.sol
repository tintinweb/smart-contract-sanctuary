...
contract TokenATest is ERC721, ERC721Pausable, Ownable {
    ...
    constructor(string memory baseTokenURI, string memory name, string memory symbol) ERC721("Token A", "TKNA") {
    ...
    function setTokenNameAndSymbol(string memory newName, string memory newSymbol) public onlyOwner {
        _name = newName;
        _symbol = newSymbol;
    }
