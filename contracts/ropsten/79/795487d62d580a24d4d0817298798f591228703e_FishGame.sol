...
contract FishGame is ERC1155, Ownable, ReentrancyGuard{
    ...
    mapping (address => bool) public gameInitiated;
    ...
    function initiateGame(uint _tokenId) external {
        ...
        require(!gameInitiated[_msgSender()], "Game already initiated");
        gameInitiated[_msgSender()] = true;
        level[_tokenId]++;
    ...
    function Cook() external nonReentrant{
        require(gameInitiated[_msgSender()], "Game not Initiated");
