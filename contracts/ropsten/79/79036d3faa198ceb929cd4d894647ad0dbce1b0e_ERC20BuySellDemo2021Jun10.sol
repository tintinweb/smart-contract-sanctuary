...
contract ERC20BuySellDemo2021Jun10
{
        ...
        if (AmountEnteredInETH > 0)
        {
            ...
            if (TokensCurrentLevel == 1)
            {
                ...
                if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                {
                    ...
                    emit chkEtherLeftForNextLevel(incomingEther,AppproxNoOfTokensToSend,NoOfTokensAvailableAtCurrentLevel,AmountInEtherLeftForNextLevel);
   ...
   /*** on Sell Event */
     ...
     event chkEtherLeftForNextLevel(
         ...
         uint256 NoOfTokensAvailableAtCurrentLevel,
