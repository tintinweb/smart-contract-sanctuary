...
interface IBEP20 {
    /**
     * @dev Returns the amount of tokens in exisCryptoSwapce.
     */
 ...
 * by lisCryptoSwaping to said events. Other implementations of the EIP may not emit
...
// CryptoSwap with Governance.
contract CryptoSwap is BEP20("CryptoSwap Finance Token", "CSF"), Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    uint256 private _cap = 2000000 *10**18;
    uint256 private _totalLock;

    uint256 public lockFromBlock = 5782630;
    uint256 public lockToBlock = 110902630;
    ...
    // hCryptoSwapFIps://github.com/yam-finance/yam-protocol/blob/master/contracts/token/YAMGovernanceStorage.sol
    // hCryptoSwapFIps://github.com/yam-finance/yam-protocol/blob/master/contracts/token/YAMGovernance.sol
    // Which is copied and modified from COMPOUND:
    // hCryptoSwapFIps://github.com/compound-finance/compound-protocol/blob/master/contracts/Governance/Comp.sol
    ...
    mapping (address => uint) public nonces;
      ...
      /// @notice An event thats emiCryptoSwapFIed when an account changes its delegate
    event DelegateChanged(address indexed delegator, address indexed fromDelegate, address indexed toDelegate);

    /// @notice An event thats emiCryptoSwapFIed when a delegate account's vote balance changes
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "CryptoSwapFI::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "CryptoSwapFI::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "CryptoSwapFI::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "CryptoSwapFI::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "CryptoSwapFI::_writeCheckpoint: block number exceeds 32 bits");
