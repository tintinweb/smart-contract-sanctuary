...
contract NardoTest is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NardoTest() {
        ...
        name = "NardoTest";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NRDOT";                                             // Set the symbol for display purposes (CHANGE THIS)
