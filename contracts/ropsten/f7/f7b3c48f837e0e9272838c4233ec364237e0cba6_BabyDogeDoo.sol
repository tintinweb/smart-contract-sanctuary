...
/**
 *Submitted for verification at Etherscan.io on awoo~
*/

// SPDX-License-Identifier: Unlicensed
// 
// https://t.me/kyotoinuerc
//: https://kyotoinu.net/
//: KYOTO INU: arf arf awoo~
...
contract BabyDogeDoo is Context, IERC20, Ownable {
    ...
    string public constant _name = "teh!!!";
    string public constant _symbol = "tehhHh!!!!";
