...
contract NUSDT is ExchangeableToken, MintableToken {

  constructor() ERC20Token("N USDT", "NUSDT", 6, 1000000000) {}
...
contract BUSD is ExchangeableToken, MintableToken {

  constructor() ERC20Token("BUSD Token", "BUSD", 18, 10000000000) {}

}

contract BTigerX is ExchangeableToken, MintableToken {

  constructor() ERC20Token("TigerX Token", "BTigerX", 6, 100000000000) {}

}

contract USDT is ExchangeableToken, MintableToken {

  constructor() ERC20Token("Tether USD", "USDT", 6, 10000000000) {}

}

contract EMouseX is ExchangeableToken, MintableToken {

  constructor() ERC20Token("MouseX Token", "EMouseX", 6, 100000000000) {}
