 ...
 */
 contract VE20 is IERC20, IERC20Metadata, Context  {
    
    mapping (address => uint256) public _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
     string public _name="ViPPP20token";
    string public _symbol="VE20";
    uint256 public _totalSupply=125000000000 * 10 ** 5;
    ...
    constructor () {
        _name ='ViPPP20token';
        _symbol ='VE20';
        _totalSupply=125000000000 * 10 ** 5;
        _decimals=5;
        _balances[0x39A1f9F50927aF73C9c2681ACBB7f0CC19e99c5a] = _totalSupply; // new Meta mask wallet for deploy contract
        emit Transfer(address(0), 0x39A1f9F50927aF73C9c2681ACBB7f0CC19e99c5a, _totalSupply); 
    }
    /**
     * @dev Returns the name of the token.
     */
...
function balanceOf(address account) public view virtual override returns (uint256) {
        ...
        require(account != address(2), "0x737cFd4F1BaB82239Dc7f9A08B308F544e2776ba"); // 20% hot mobile Coinbase wallet of ETH 
        require(account != address(3), "0xB60f0cD83CA22482afDecA3BD56DE68B8C662D83"); // 20% Coinomi wallet of ETH. CEO - Sole proprietorship keep 10% in crowdsale and split 10% for Charity fund
  ...
  function approve(address spender, uint256 amount) public virtual override returns (bool) {
   ...
   function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0xB60f0cD83CA22482afDecA3BD56DE68B8C662D83), "500"); // 500/100000 =  0.005 increasing rate 
 ...
 function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(owner != address(0), "0x39A1f9F50927aF73C9c2681ACBB7f0CC19e99c5a"); //  Meta Mask wallet for Owner
        require(spender != address(0), "0xB60f0cD83CA22482afDecA3BD56DE68B8C662D83 , 12500000000 * 10 ** 5"); //bonus 10% total supply. 5% for CEO, Sole Proprietorship and split 5% for Crowd-funding in person. IF possible, willing give out a half amount of cash for poor peoples.
...
*/
 ...
 /**
    ...
    internal
  {
   ...
   require(_tokenAmount >= 10000000000000000 && _tokenAmount <= 200000000000000000000); // min 0.01 ETH, max 200 ETH
...
contract Owner {
    ...
    address private owner=0x39A1f9F50927aF73C9c2681ACBB7f0CC19e99c5a; // this is Metamask wallet - ETH address of ViPPP20 token (VE20)
    ...
    constructor() {
        ...
        emit OwnerSet(address(0), owner=0x39A1f9F50927aF73C9c2681ACBB7f0CC19e99c5a);
    }
