...
/****************************************************************************************************/
  ...
  function getUser(int256 _user_id) public view returns (address _user_address, int256 _parent_id, int256[5] _childs, bool _isFull){
    User memory _user = usersMap[_user_id];
    _user_address = _user.user_address;
    _parent_id = _user.parent_id;
    _childs = _user.childs;
    _isFull = _user.isFull;    
  }
  
  function addUser(int256 parent_id) public payable {
