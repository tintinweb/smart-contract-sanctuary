...
contract HordTicketManager is HordUpgradable, ERC1155HolderUpgradeable {
    ...
    event MinTimeToStakeSet(uint256 minTimeToStake);
    event MinAmountToStakeSet(uint256 minAmountToStake);
    event TokensStaked(
        address user,
        uint amountStaked,
     ...
     */
    function setHordTicketFactory(address _hordTicketFactory) external {
    ...
    onlyHordCongress
    {
        ...
        emit MinAmountToStakeSet(minAmountToStake);
    }
    ...
    public
    {
        ...
        bool checkTransfer = stakingToken.transferFrom(
            msg.sender,
            address(this),
            amountOfTokensToStake
        );

        require(checkTransfer, "Transfer failed.");
    ...
    public
    {
        ...
        if(totalStakeToWithdraw > 0) {
            ...
            bool checkTransfer = stakingToken.transfer(msg.sender, totalStakeToWithdraw);
            require(checkTransfer, "Transfer failed");
        }
