...
abstract contract Ownable is Context {
    ...
    */
    ...
    /**
    * Added modifier for external access to taxfee and reflection modifications within allowed range or exclude exchange wallet addresses to avoid fees on transfers.
    */    
    modifier onlyAdmins() {
...
contract test333333 is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "test333333";                                           // name
    string private _symbol = "test333333";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xca2bad11037E7ae2c6e7A855dC6A020926384e38);
    ...
    function _transfer(
        ...
        //Limitation on the maximum wallet balance (for first 6 hours)
