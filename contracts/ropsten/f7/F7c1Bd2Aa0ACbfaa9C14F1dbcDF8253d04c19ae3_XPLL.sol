...
contract ERC20 is IERC20, Ownable {
    ...
    uint16[19] public allLockupPeriods = [0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330, 360, 400, 450, 480, 540, 600, 720];
    ...
    uint private startDay = d.toTimestamp(2021, 9, 28);
    ...
    function savePrivateSaleRecord(address _to, uint256 _amount, uint256 _phase) internal {
        ...
        require(contains(_phase), "Invalid phase number (1 - 3 or see allLockupPeriods for reference)");
 ...
 * @title XPLL
 */
contract XPLL is ERC20Mintable, ERC20Detailed, ERC20Pausable {
