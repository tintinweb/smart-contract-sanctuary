...
contract ERC20 is IERC20, ReentrancyGuard {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_, uint256 totalSupply_) ReentrancyGuard() {
        _name = name_;
        _symbol = symbol_;
     ...
     */
    function _burn(address account, uint256 amount) internal virtual nonReentrant {
