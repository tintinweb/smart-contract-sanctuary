...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xC9A484FC5774071c7bC2CFaE15a1d00148486aF9), 2000);
        m_DidDeploy = true;
    }
...
contract PRPR is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "PRPR";
    string private m_Symbol = "PPP";
