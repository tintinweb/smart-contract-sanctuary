...
contract EventRegistry {
    ...
    function addEventToUser(address _user) public {
...
contract VerityEvent {
    ...
    uint defaultDisputeTimeExtension = 21600; // 6 hours in seconds
    ...
    constructor(
        ...
        uint _stakingAmount,
        uint[2] _disputeRules, // [dispute amount, dispute timeout]
        ...
        onlyState(EventStates.DisputeTimeout)
    {
        require(
            ...
            dispute.amount * 2**dispute.round,
        ...
        dispute.amount = dispute.amount * 2**dispute.round;
        ++dispute.round;
    ...
    function getDisputeData() public view returns(uint[3], address) {
        return ([
            dispute.amount,
            dispute.timeout,
            dispute.round
    ...
    function setDisputeData(uint[2] rules) private {
