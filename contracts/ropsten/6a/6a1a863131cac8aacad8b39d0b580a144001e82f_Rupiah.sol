...
contract Rupiah is Context, Ownable, ERC20, ERC20Detailed, PoSTokenStandard {
...
//----------------------------------------------------------------------------------------------------
    ...
    constructor() public ERC20Detailed ("Rupiah", "IDR", 18) {
        
        //Balances for Presale
        balances[address(this)] = 670000e18;
        mint(address(this),670000e18);
        
        balances[msg.sender] = 330000e18;
        mint(msg.sender, 330000e18);
...
//----------------------------------------------------------------------------------------------------
    ...
    uint public constant minimumContribution = 0.001 ether;
    uint public constant maximumContribution = 100 ether;

    uint256 public PriceRate = 100; //1 ETH = 100 IDR
    ...
    function() public payable {
        ...
        if (purchasedAmount > balances[this]) {revert();} // too much ETH sent
