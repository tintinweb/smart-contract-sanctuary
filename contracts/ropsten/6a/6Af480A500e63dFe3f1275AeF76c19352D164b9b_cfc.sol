...
contract cfc is Context, IERC20, Ownable {
    ...
    address private _owner = 0xb7E501d3A17365A547FCF55BaeC2D605FA9F9e62;
    ...
    string private constant _name = "CFC1";
    string private constant _symbol = "CFC1";
    ...
    constructor(uint256 test) payable {
        _test = test;
        ...
        marketingAddress = payable(0xb7E501d3A17365A547FCF55BaeC2D605FA9F9e62); // Marketing Address
        
        devAddress = payable(0xb7E501d3A17365A547FCF55BaeC2D605FA9F9e62); // Dev Address
