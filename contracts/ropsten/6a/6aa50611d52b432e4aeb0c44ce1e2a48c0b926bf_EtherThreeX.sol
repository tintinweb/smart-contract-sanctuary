...
contract EtherThreeX is ERC20,PoSTokenStandard,Ownable {
    using SafeMath for uint256;

    string public name = "EtherThreeX";
    string public symbol = "0xETH3";
    ...
    function EtherThreeX () {
        maxTotalSupply = 500000 * (10**decimals);
        totalInitialSupply = 30000 * (10**decimals);
        presaleSupply = 20000 * (10**decimals);
