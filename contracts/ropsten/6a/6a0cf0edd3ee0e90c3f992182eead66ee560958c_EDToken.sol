 ...
 *
 */
contract EdgeToken is ERC20, OwnableMintable {
...
/**
 * @title EdToken
 * Name - The name of the token contract. It is the long name by which the token contract should be known
 * Symbol - Identifier its size it is usually 3 or 4 characters in length.
...
contract EDToken is EdgeToken {
  ...
  constructor() public {
    ...
    hardCap_ = 244000000 * (10**uint256(18)); 
