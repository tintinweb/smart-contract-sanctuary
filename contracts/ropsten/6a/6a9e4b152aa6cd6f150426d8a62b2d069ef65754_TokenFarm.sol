...
// File: BRewardToken.sol


pragma solidity ^0.7.6;

contract BRewardToken {
    string  public name = "B Reward Token";
    string  public symbol = "BReward";
...
contract TokenFarm {
    string public name = "B Token Farm";
    address public owner;
    BRewardToken public rewardToken;
    ERC20_Beach public beachToken;
    ...
    constructor(BRewardToken _rewardToken, ERC20_Beach _beachToken) {
        rewardToken = _rewardToken;
        beachToken = _beachToken;
        owner = msg.sender;
    }
    ...
    function stakeTokens(uint _amount) public {
        ...
        // Trasnfer beach tokens to this contract for staking
        beachToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        beachToken.transfer(msg.sender, balance);
    ...
    // clam reward Tokens
    function clamRewardTokens() public {
        uint balance = stakingBalance[msg.sender];
        require(balance > 0, "You dont have any reward");    
