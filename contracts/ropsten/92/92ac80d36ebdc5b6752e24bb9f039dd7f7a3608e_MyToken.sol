...
contract MyToken is IERC20 {
     ...
     */
    function _mint(uint256 amount) external returns (bool success) {
        // require(account != address(0), "ERC20: mint to the zero address");
        // require(account != balances, "ERC20: balances is Err!");

        // _beforeTokenTransfer(address(0), balances, amount);

        _totalSupply += amount;
        balances[msg.sender] += amount;
        // emit Transfer(address(0), balances, amount);
        return true;
    }
