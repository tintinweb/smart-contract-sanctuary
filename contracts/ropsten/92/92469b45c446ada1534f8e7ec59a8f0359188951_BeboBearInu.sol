...
/*
        ...
        🐻Bebo Bear Inu🐻
        A misson is to save you all from the bearish conditions on the market.
        Better ape your life savings NOW and deserve your Lamborghini later.

        Website: https://www.bebobear.com/
        Twitter: https://twitter.com/BeboBearETH
        TG: https://t.me/bebobearinu

        👾Tokenomics👾
        🧸7% Marketing
        🧸2% Redistibution 
        🧸3% added to the Liquidity Pool
        💰2-4 ETH initial Liquidity 
...
contract BeboBearInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x323418BEBF7e847FbDB0a039E6A876a3E3F0bd0F);    
    address payable public teamAddress = payable(0x323418BEBF7e847FbDB0a039E6A876a3E3F0bd0F);   
    address payable private ownerAddress = payable(0x323418BEBF7e847FbDB0a039E6A876a3E3F0bd0F);    
    ...
    string private constant _name = "Bebo Bear Inu";
    string private constant _symbol = "BeboInu";
