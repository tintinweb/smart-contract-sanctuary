...
contract RockyDoge is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0xc87F7A232E86dC7449aC5fAf968524179F66B62d);
    ...
    address payable private _DeadWalletAddress = payable(0xA27cE787629b3d3a5Ae5Ea411DDd16cc1EA801b2); 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(_isBlackListedBot[sender] ||  _isBlackListedBot[recipient] ||  _isBlackListedBot[tx.origin]) {
...
//      _MarketingAddress.transfer(amount);
    ...
    // in case the token is highly valued and 5% becomes too much
