...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    address public vaultMaxFarmAddress;
    ...
    uint256 public controllerFee = 20; // 0.2%
    ...
    uint256 public entranceFeeFactor = 9995; // < 0.1% entrance fee - goes to pool + prevents front-running
    ...
    constructor(
        address _vaultMaxFarmAddress,
        address _VMAXAddress,
        bool _isCAKEStaking,
        bool _isAutoComp,
        ...
        vaultMaxFarmAddress = _vaultMaxFarmAddress;
        VMAXAddress = _VMAXAddress;
        ...
        if (isAutoComp) {
            ...
            earnedToAUTOPath = [earnedAddress, wbnbAddress, VMAXAddress];
            if (wbnbAddress == earnedAddress) {
                earnedToAUTOPath = [wbnbAddress, VMAXAddress];
            }
        ...
        transferOwnership(vaultMaxFarmAddress);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(vaultMaxFarmAddress, _wantAmt);
