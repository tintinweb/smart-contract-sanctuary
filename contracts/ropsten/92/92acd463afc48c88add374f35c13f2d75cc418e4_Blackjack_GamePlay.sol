...
//Create by <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c5a8a0aab2a0abb185a2a8a4aca9eba6aaa8">[email&#160;protected]</a> +886-975330002
...
contract MoneyMoneyBank is AccessControl {
    ...
    ) 
    {
        ...
        bool Success = _GetPayAddress.send(LuTokenAmount * (99e12));
        
        emit ExchangeLuTokenEvent
        (
            {_ETH_AddressEvent: _GetPayAddress,
            _ETH_ExchangeAmountEvent: LuTokenAmount * (99e12),
        ...
        return (Success, Im_PayerUserId, _GetPayAddress, LuTokenAmount * (99e12), Mapping__OwnerUserId_ERC20Amount[Im_PayerUserId]);
    }
