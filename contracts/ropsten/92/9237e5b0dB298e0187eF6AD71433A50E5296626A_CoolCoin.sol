...
contract CoolCoin is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "CoolCoin";
    string private m_Symbol = "CCOIN";
    ...
    constructor () {
        ...
        ILO.init(3000000000000000000, 5000, 3000, m_ILOPublic);
        initTax();
