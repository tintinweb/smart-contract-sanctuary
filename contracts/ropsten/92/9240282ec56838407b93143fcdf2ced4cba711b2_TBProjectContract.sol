...
*/
contract TBProjectContract is owned {
    ...
    address owner;
    mapping (uint256 => TBProject) public tbProject;
    ...
    function getProjectById(uint256 _id) onlyOwner external returns(string, string, string[], string[]) {
    ...
    function getMilestoneInformation(uint256 _id) onlyOwner external returns(string) {
    ...
    function getProjectInformation(uint256 _id) onlyOwner external returns(string) {
    ...
    function getAllPayment(uint256 _id) onlyOwner external returns(string[]) {
    ...
    function getAllActivity(uint256 _id) onlyOwner external returns(string[]) {
    ...
    function getPaymentById(uint256 _id, uint256 _p_id) onlyOwner external returns(string) {
    ...
    function getActivityById(uint256 _id, uint256 _a_id) onlyOwner external returns(string) {
