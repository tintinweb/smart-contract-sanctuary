...
contract PO8PrivateSale2612 is Ownable{
    using SafeMath for uint256;
    ...
    constructor() public {
        ...
        token.approve(address(this), 1250000000000000000000000000);
    }
    ...
    function () public payable {
        ...
        require(token.allowance(owner, address(this)) >= currentRate.mul(msg.value));
