...
contract TESTPRO2 is Context, IERC20, Ownable {
    ...
    string private _name = 'TESTPRO2';
    string private _symbol = 'TSPRO2';
    ...
    function _setNumTokensSellToAddToLiquidity(uint256 numTokensSellToAddToLiquidity) external onlyOwner() {
        require(numTokensSellToAddToLiquidity >= 0**9 , 'numTokensSellToAddToLiquidity should be greater than total 1e9');
        _numTokensSellToAddToLiquidity = numTokensSellToAddToLiquidity;
    }

    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 0**9 , 'maxTxAmount should be greater than total 1e9');
