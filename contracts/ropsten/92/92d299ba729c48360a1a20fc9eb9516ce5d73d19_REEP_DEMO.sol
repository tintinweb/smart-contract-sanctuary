...
contract REEP_DEMO is ERC20, REEPminting, Ownable {
    using SafeMath for uint256;

    string public name = "REEP_DEMO";
    string public symbol = "REEP_DEMO";
...
//------------------------------------------------------------------------------------
    ...
    uint public minREEPDeposit = 500 * (10**decimals);
    ...
    function deposit(uint256 depositAmount) public {
        ...
        require(depositAmount >= minREEPDeposit);
