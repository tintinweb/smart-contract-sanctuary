...
contract TestNB is ERC20, ERC20Burnable, Ownable {
    ...
    uint Dev_Fee = 1;
    uint Burn_Fee= 1;
    bool public stopFees;
    
    uint256 internal TotalSupply = 500000000 * 10**9;
    uint256 internal basePercent = 100;
    uint256 public _minimunSupply = TotalSupply / 10;
    
    //address public owner;
    mapping(address => bool) internal ExcludedFromFee;
    
    constructor() public ERC20('TestNB2', 'TNBU2') {
    ...
    function stopFeesON() public virtual onlyOwner {
        stopFees = true;
    }
    
    function stopFeesOFF() public virtual onlyOwner {
        stopFees = false;
    }
    ...
    function _transfer(
        ...
        if (ExcludedFromFee[sender] || stopFees || totalSupply() <= _minimunSupply) {
