  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xB48f39edAF753a13C946aDEcCCA8eAa714fd5573);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 9');
    ...
    // File: contracts/eggNftContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract EggNftContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Egg NFT", "EGG", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://ipfs.io/ipfs/QmZ4g9ffkNdHmy5CPXMFKkyTUYLRVwanCvjALvh7Hdt73r/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/QAHxq4iKUSySaliV1LVv/contract-metadata";
        }
    }