...
contract Deedstack {
	...
	Deed private _deed1;
	function ActUp() public view returns (Deed memory) {
			return _deed1;
	}
	Deed private _deed2;
	function GreenStream() public view returns (Deed memory) {
			return _deed2;
	}
	Deed private _deed3;
	function LawnHero() public view returns (Deed memory) {
			return _deed3;
	}
	Deed private _deed4;
	function EarthCalling() public view returns (Deed memory) {
			return _deed4;
	}
	Deed private _deed5;
	function ListenUp() public view returns (Deed memory) {
			return _deed5;
	}
	Deed private _deed6;
	function LaudableBrand() public view returns (Deed memory) {
			return _deed6;
	}
