...
// File: contracts/token_3DABFL.sol
...
abstract contract token_3DABFL{
    ...
    function getDNA(uint256 tokenId) public view returns (string memory) {
        return
            string(
                    ...
                    R(string(abi.encodePacked(XYZ[8], tokenId.toString()))).toHexString()
        ...
        returns (string memory)
    {
        ...
        for (uint8 i = 0; i < 36; i++) {
            ...
            if (i<6){
                Ls2[5] = size[i];
                M_1 = string(abi.encodePacked(M_1,Ls2[0],Ls2[1],Ls2[2],Ls2[3],Ls2[4],Ls2[5],Ls2[6]));
            }else if(i<21){
                Ls2[5] = size[i];
                if(i==7){
                    if(getAttr1(tokenId)){
                        M_2 = string(abi.encodePacked(M_2,Ls2[0],Ls2[1],Ls2[2],Ls2[3],Ls2[4],Ls2[5],Ls2[6]));
                ...
                }else{M_2 = string(abi.encodePacked(M_2,Ls2[0],Ls2[1],Ls2[2],Ls2[3],Ls2[4],Ls2[5],Ls2[6]));}
            }else if(i>20){
                Ls2[5] = size[y];
                if(i==22){
                    if(getAttr1(tokenId)){
                        M_3 = string(abi.encodePacked(M_3,Ls2[0],Ls2[1],Ls2[2],Ls2[3],Ls2[4],Ls2[5],Ls2[6]));
                ...
                }else{M_3 = string(abi.encodePacked(M_3,Ls2[0],Ls2[1],Ls2[2],Ls2[3],Ls2[4],Ls2[5],Ls2[6]));}
                y+=1;  
            }
            if (i==20){
                L_1 = string(abi.encodePacked(Ls3[0],"Pwj",Ls3[1],M_2,Ls3[2],sports[0],Ls3[3],"Pwj",Ls3[4]));
            }
            if(i==35){
                L_2 = string(abi.encodePacked(Ls3[0],"PcQ",Ls3[1],M_3,Ls3[2],sports[1],Ls3[3],"PcQ",Ls3[4]));
            }
        }
        return string(abi.encodePacked(Ls1[0],Ls1[1],Ls1[2],Ls1[3],Ls1[4],M_1,L_1,L_2,Ls3[5]));
    }
}
