...
contract NFTMarket is Ownable
{
    ...
    struct SaleData {
        ...
        uint256 volume;      // number of nft,  volume >= 2 -> isAuction=false
        address erc20;       // payment erc20 token 
        uint256 price;       // auction : starting price, fixed_price : sellig total price 
        uint256 bid;         // bidding price            
        address buyer;       // fixed_price: 최종구매자, auction : bidder, 최종구매자 
    ...
    /* Keccak256 
        ...
        Buy(uint256,address)                                        : 0x7534e9c9396820aad756ba27f82162930f80bef863aabdf311e7dce26a79bccd
    ...
    */
     ...
     *     price : auction : starting price, fixed_price : sellig total price 
     *   
     *
     * Requirements:
     *
    ...
    function settle(uint256 id) private {
        ...
        uint256 amount = sd.isAuction ? sd.bid : sd.price;
        ...
        _nftBase.safeTransferFrom(address(this),sd.buyer,sd.nftId,sd.volume,"");

        _sales[id].isSettled = true;
    }
