...
// $tarcoin Token contract based on the full ERC 20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Symbol: $TARCOIN
// Status: ERC20 Verified

contract $TARCOINToken { 
...
/**
 * $TARCOIN Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract TarStandardToken is $TARCOINToken, Ownable {
    
    using TARMaths for uint256;
...
contract $TARCOIN is TarStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 6 * (10**6) * 10**8 ; // 6 million tokens, 8 decimal places
    string constant public name = "$TAR COIN"; //fancy name: eg $TARCOIN
    string constant public symbol = "$TARCOIN"; //An identifier: eg $TARCOIN
