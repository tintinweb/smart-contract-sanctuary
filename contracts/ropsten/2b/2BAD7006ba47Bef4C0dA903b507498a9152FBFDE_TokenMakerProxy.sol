...
/**
 * @title TokenMaker, create your own ethereum tokens without coding, support erc20 and erc233
 * @dev To Use this Dapp: https://tokenmaker.app
 */
...
contract UpgradeabilityProxy is Proxy {
  ...
  bytes32 private constant implementationPosition =
    keccak256('tokenmaker.app.proxy.implementation');
   ...
   */
  function _upgradeTo(address _newImplementation, string memory _newVersion)
    internal
  {
...
/**
 * @title TokenMakerProxy
 * @dev This contract combines an upgradeability proxy with basic authorization control functionalities
 */
contract TokenMakerProxy is UpgradeabilityProxy {
  /**
  ...
  bytes32 private constant proxyOwnerPosition =
    keccak256('tokenmaker.app.proxy.owner');

  /**
   * @dev the constructor sets the original owner of the contract to the sender account.
   */
  constructor(address _implementation, string memory _version) public {
   ...
   */
  function upgradeTo(address _implementation, string memory _newVersion)
    public
    onlyProxyOwner
  {
