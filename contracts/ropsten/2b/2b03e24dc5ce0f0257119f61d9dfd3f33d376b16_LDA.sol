...
contract LDA is ERC20,Ownable {
    ...
    uint256 price;
    constructor()  ERC20("Alejandro Digital Assets","LDA") public {
        //_totalSupply = 100 * (10 **uint256(decimals()));
        _mint(owner(), 5000000000*10**uint256(decimals()));
    ...
    function BuyToken() public payable returns (bool) {
        ...
        _transfer(owner(),msg.sender,final_price);
