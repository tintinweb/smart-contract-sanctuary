...
/**
 * [email protected]/contracts/token/ERC20/TreasureBox.sol
 */
 ...
 */
contract TreasureBox is ERC20Basic {
 ...
 */
contract StandardToken is ERC20, TreasureBox {
 ...
 */
contract BurnableToken is TreasureBox {
 ...
 */
contract DncToken is BurnableToken, CappedToken(10000000) {
    string public name = "TSBox";
