    ...
    Ownable
{
    ...
    int24 public maxTickDeviation = 7000; // ~100% price difference up and down
    int24 public minTickDeviation = 60; // one initializable tick
    uint256 public lastRebalanceTimestamp;
    bool public disablePoolSwitch;
