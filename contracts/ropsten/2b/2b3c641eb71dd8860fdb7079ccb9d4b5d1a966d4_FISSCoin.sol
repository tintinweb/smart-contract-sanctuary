 ...
 */
contract FISSCoin is IBEP20, Ownable, MinterRole, PauserRole, Pausable {
    ...
    string public _name = "FISSCoin";
    
    string public _symbol = "FISS";
    
    uint8 public _decimals = 18;
    
    uint256 public _totalSupply = 3 * 10**6 * 10**(_decimals);
