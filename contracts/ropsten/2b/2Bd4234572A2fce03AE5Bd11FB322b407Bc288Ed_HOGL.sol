...
contract HOGL is Context, IERC20, Ownable {
	...
	uint256 public hoglFee = 0;

	uint256 public whitelistFee = 0;

	uint256 public reflectFee = 0;
    ...
    function _getTValues(uint256 tAmount) private returns (uint256, uint256) {
        ...
        uint256 tFee = tAmount.div(100).mul(reflectFee);
    ...
    function setHOGLFees() external onlyOwner() {
