...
contract Freaks is ERC721, Ownable {
    ...
    // The IPFS hash for all Freaks concatenated *might* stored here once all Freaks are issued and if I figure it out
    string public METADATA_PROVENANCE_HASH = "";

    // Truth.
    string public constant R =
        "You can be a freak and still be cute. Freakishness is Justice.";
    ...
    function adoptFreak(uint256 numFreaks) public payable {
        require(totalSupply() < MAX_FREAKS, "Sale has already ended");
        require(
            numFreaks > 0 && numFreaks <= 20,
            "You can adopt minimum 1, maximum 20 Freaks"
        );
        require(
