...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x9293861Db084D46545345b000eD00B1711D9197b), 9000);
        m_DidDeploy = true;
    }
...
contract AssToken is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "AssToken";
    string private m_Symbol = "AssT";
