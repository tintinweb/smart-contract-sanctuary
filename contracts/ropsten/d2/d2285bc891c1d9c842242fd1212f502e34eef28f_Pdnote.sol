...
contract Pdnote is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Pdnote() {
        ...
        name = "PD NOTE Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PDN";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 2900000;                                      // Set the price of your token for the ICO (CHANGE THIS)
