...
contract MNIST8x8NeuralNet {
    ...
    int128[] _conv1_biases = [int128(119), 63, 207, -96];
    ...
    int128[] _fc1_biases = [int128(-115), -104, -50, 84, 209, 105, 22, -97, -116, -63];

    function get_ex_predict_proba() public view returns (int128[] memory) {
    ...
    function get_ex_predict() public view returns (uint) {
        return predict(
            ex_image,
            _conv1_weights,
            _conv1_biases,
