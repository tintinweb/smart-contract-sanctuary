...
contract PolkaDex is ERC20 {
    ...
    constructor() ERC20("Polkadex", "PDEX", 20000000) {
        ...
        owner = _msgSender();
        addMemberToTeam(owner);
        addMemberToTeam(AhmetAddress);
    ...
    function addMemberToTeam(address memberAddress) public onlyOwner returns (bool) {
    ...
    function deleteMemberFromTeam(address memberAddress) public onlyOwner returns (bool) {
         require(memberAddress != address(0));
