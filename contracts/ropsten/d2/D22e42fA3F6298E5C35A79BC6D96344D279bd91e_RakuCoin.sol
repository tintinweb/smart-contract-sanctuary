    ...
    // List of front-runner & sniper bots from t.me/FairLaunchCalls
        ...
        function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
            (uint256 tTransferAmount, uint256 tFee, uint256 tMarketingPool, uint256 tStakePool) = _getTValues(tAmount, _taxFee, _MarketingPoolFee, _staketaxFee);
             ...
             (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getValues2(tAmount,tFee);
            
            return (rAmount, rTransferAmount, rFee, tTransferAmount, tFee, tMarketingPool, tStakePool);
        }
        
        function _getValues2(uint256 tAmount,uint256 tFee) private view returns (uint256, uint256, uint256) {
