...
contract InterswapFactory is IUniswapV2Factory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        require(getPair[token0][token1] == address(0), 'Interswap: PAIR_EXISTS'); // single check is sufficient
...
contract InterswapPair is IUniswapV2Pair, InterswapERC20 {
...
contract InterswapERC20 is IUniswapV2ERC20 {
    using SafeMath for uint;
