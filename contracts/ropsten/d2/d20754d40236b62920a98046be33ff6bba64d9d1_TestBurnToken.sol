...
contract TestBurnToken is Context, IERC20 {
    ...
    constructor (
        ...
        _icoSupply = icoSupply_;
        _totalBurnableToken = (totalBurnableToken_ * (10 ** uint256(decimals())));
        _remainningBurnableToken = totalBurnableToken();
        _circulationSupply = circulationSupply_;
        _ownersSupply = ownersSupply_;
