 ...
 * @dev Adds burnFrom method to BEP20 implementations
 */
...
/**
 * A base token for the LONGAsset (or any other coin with similar behavior).
 * Compatible with contracts and UIs expecting a BEP20 token.
 ...
 */
contract BaseBEP20Token is StandardBurnableToken, PausableToken, DetailedBEP20 {
  ...
  constructor(
    ...
    string _tokenName,
    string _tokenSymbol
  ) DetailedBEP20(_tokenName, _tokenSymbol, _decimalUnits) public {
...
contract LONGAsset is BaseBEP20Token {
  constructor() BaseBEP20Token(500000000000000000000000000, 18, "LONG Asset", "LONG") public {
    // nothing else needed
  }
}