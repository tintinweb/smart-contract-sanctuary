...
contract TokenName is Context, IERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 3 * 10**5 * 10**9;//i use 0.03% of the total supply to do threshold
    ...
    function sendBNBToMarketingWallet(uint256 amount) private { 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendBNBToMarketingWallet(portionForFees);
