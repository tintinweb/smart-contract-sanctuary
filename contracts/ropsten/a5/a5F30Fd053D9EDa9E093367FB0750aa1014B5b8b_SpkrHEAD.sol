...
contract SpkrHEAD is ERC721Enumerable, Ownable {
    ...
    event HeadsMinted(uint256 totalMinted);

    constructor(string memory baseURI) ERC721("SPKRHEAD", "SPKR") {
        setBaseURI(baseURI);
    }
    ...
    function mintHeads(uint256 _count) public payable {
        if (msg.sender != owner()) {
