...
contract cmtFoundingToken is ERC20, ERC20Detailed {
    ...
    //address constant public usdt = address(0xdAC17F958D2ee523a2206206994597C13D831ec7);   //Tether USD (USDT)  6 point mainnet
    address constant public usdt = address(0x017888Fd0c91C3f11Ef03b8873CD3cB98eC7f337);     //Tether USD (USDT) 6 point  Ropsten
    address public bonus = usdt;                                                            // 分红token,默认usdt    


    constructor () public ERC20Detailed("Polynomial.2101.ABS.CM.finance", "POLYN", 6) {
        governance = 0x59c8F1a700dD17B45287108DDf8D593719c88a43;
        uint256 coinAmount = 3000 * 10 ** uint256(6);
    ...
    function setOpenDeposit(uint _isOpenDeposit) external {
        require(msg.sender == governance, "!governance");
        isOpenDeposit = _isOpenDeposit;
    }
    
    function setOpenWithdraw(uint _isOpenWithdraw) external {
        require(msg.sender == governance, "!governance");
    ...
    function claimTokenByEpoch() public {
        require(isOpenWithdraw == 1, "!isOpenWithdraw");
        ...
        //先将分红的USDT存入合约
        IERC20 claim_token = IERC20(bonus);
        ...
        //判断是否已经有分红
        require(bonusList[bonus][epoch][msg.sender] == 2, "!Had bonus");
        
        //设置已经提取分红
        bonusList[bonus][epoch][msg.sender] = 1; 
