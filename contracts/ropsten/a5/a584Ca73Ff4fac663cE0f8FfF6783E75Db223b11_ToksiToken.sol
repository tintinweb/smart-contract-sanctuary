...
contract ToksiToken is ReleasableToken, MintableToken, UpgradeableToken {
    ...
    public UpgradeableToken(msg.sender) {
        ...
        if (_initialSupply > 0) {
            ...
            mint(MarketingWallet, _initialSupply.mul(20).div(100));
            
            mint(ReserveWallet, _initialSupply.mul(128).div(1000));

            mint(PresaleWallet, _initialSupply.mul(12).div(1000));

            mint(FounderWallet, _initialSupply.mul(5).div(100));

            mint(ecosystemWallet, _initialSupply.mul(10).div(100));
            
            mint(owner, _initialSupply.mul(51).div(100));
