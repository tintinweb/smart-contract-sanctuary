...
contract AirDrop is OwnableWithAdmin {
 ...
 /**
  ...
  function transferDirect(address _recipient,uint256 _tokens) public{
    ...
    totalClaimed[_recipient] = totalClaimed[_recipient].add(_tokens);
    ...
    emit LogTokenClaimed(_recipient, _tokens, allocationsTotal[_recipient], grandTotalClaimed);
