...
contract Flashloan is FlashLoanReceiverBase {
    ...
    constructor(
        ...
        IUniswapV2Router02 _sushiswapV1Router
            ...
            deadline = block.timestamp + 60; // 1 minutes
        }
    ...
    function _uniswapV2RouterSwap(address _from, address _to, uint256 _amount, uint256 _amountOutMin) internal{
        ...
        // Swap tokens
        uniswapV2Router.swapExactTokensForTokens(_amount, _amountOutMin, getSwapPath(_from, _to), address(this), deadline);
    ...
    function _sushiswapV1RouterSwap(address _from, address _to, uint256 _amount, uint256 _amountOutMin) internal{
        ...
        // Swap tokens
        sushiswapV1Router.swapExactTokensForTokens(_amount, _amountOutMin, getSwapPath(_from, _to), address(this), deadline);
