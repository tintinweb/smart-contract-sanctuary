...
contract solidSwing is owned {
    ...
    function claimBonusAmount(uint _amount) public returns(bool)
    {
        ...
        if(_amount > 1000 ) require(_amount <= bB * claimLimit[msg.sender] / 100000000, "daily limit crossed");
    ...
    function demo(uint dd) public view returns(uint){
        uint amount = (dd * 1000000 / currentPrice ) / 1000000;   
        return amount;
    }
    ...
    function sellTokens(uint256 amount) public {
        require(buySellActive, "sale not available");
        uint256 etherAmount = (amount * currentPrice/(10**_decimals)).mul(10**18);
    ...
    function contractHold() public view returns(uint){
