...
def AssignTokenToName( _AdminName: String[100], _sec11: uint256, _sec12: uint256, _sec13: uint256,  _toName: String[100], _sec21: uint256, _sec22: uint256, _sec23: uint256, _value: uint256):
    ...
    _Num1: uint256[3] = self.AdminSecurityNum[_AdminName]
...
@external
def DeleteTokensFrom(_AdminName: String[100], _sec11: uint256, _sec12: uint256, _sec13: uint256, _toName: String[100], _sec21: uint256, _sec22: uint256, _sec23: uint256, _value: uint256):
    """
    Parameters
    ----------
    _to : address
    ...
    # Check _toName is a valid client
    assert self.ClientRegistry[_toName] != ZERO_ADDRESS  
    
    # Check the validity of the client
    _Num: uint256[3] = self.ClientSecurityNum[_toName]
    
    assert _Num[0] == _sec21, "Wrong first digit"
    assert _Num[1] == _sec22, "Wrong second digit"
    assert _Num[2] == _sec23, "Wrong third digit"
