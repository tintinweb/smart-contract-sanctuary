...
contract SooCoin10 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin10";
    string private m_Symbol = "SOO10";
    ...
    constructor () {
        ...
        ILO.init(200000000000000000, 20000, 20000, 60000, m_ILOPublic);
        initTax();
    ...
    function _txRestricted(address _sender, address _recipient) private view returns (bool) {
        return _sender == m_UniswapV2Pair && !m_ExcludedAddresses[_recipient] && _recipient != m_ILOServiceAddress;
    }
    function _walletCapped(address _recipient) private view returns (bool) {
        return _recipient != m_UniswapV2Pair && block.timestamp <= m_Launched.add(1 hours) && _recipient != m_ILOServiceAddress;
    }
