...
contract BillHenryTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BillHenryTestCoin() {
        ...
        name = "BillHenryTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BHTC";                                             // Set the symbol for display purposes (CHANGE THIS)
