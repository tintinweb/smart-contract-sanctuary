...
contract HelloWorld {
   ...
   // The keyword `public` makes variables accessible from outside a contract and creates a function that other 
   // contracts or clients can call to access the value.
