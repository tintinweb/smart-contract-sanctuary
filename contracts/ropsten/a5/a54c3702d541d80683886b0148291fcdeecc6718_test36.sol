...
contract test36 is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "test36";
    string private constant _symbol = "test36";
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
			require(amount <= 250000000000002 * 10**9, "Limits are in place, please lower buying amount");
		}
