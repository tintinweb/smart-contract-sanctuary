...
·▀▀▀  ▀  ▀ ▀▀ █▪▀▀▀▀▀• ▀▀▀▀▀▀▀▀•     ·▀▀▀  ▀  ▀ ·▀▀▀  ▀▀▀ ▀▀▀    ·▀▀▀ .▀  ▀ ▀▀▀  ▀▀▀▀ ▀▪
                        ...
                        Candid Cacti Crew | 2021  | version 3.0 | ERC 721
...
contract CandidCactiCrew is ERC721Enumerable, Ownable {
    ...
    uint256 public constant SALE_PRICE = 0.035 ether;
    uint256 public constant MAX_PER_TXN = 20;

    string private _contractURI =
        "https://candidcacti.world/api/metadata/contract";
    string private _tokenBaseURI = "https://candidcacti.world/api/metadata/";
    string private _buyCode;
    string public proof;
    ...
    constructor(address signerAddress, string memory buyCode)
        ERC721("Candid Cacti Crew", "CandidCactiCrew")
    {
     ...
     */
    function Buy(uint256 tokenQuantity, string memory buyCode)
        external
        payable
    {
        ...
        require(compareStrings(_buyCode, buyCode), "CODE_ERROR");
     ...
     */
    function presaleBuy(uint256 tokenQuantity, string memory buyCode)
        external
        payable
    {
        uint256 tokenQty = tokenQuantity;
    ...
    /**
     * @dev change buycode for buy and presale buy functions
     */
    function setBuyCode(string calldata buyCode) external onlyOwner {
        _buyCode = buyCode;
    }
