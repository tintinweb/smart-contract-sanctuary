  ...
  event Burned(address burner, uint burnedAmount);
    ...
    function _setTimes() internal {
       // firststageopeningTime    = 1539561600; // 15th OCT 2018 00:00:00 GMT   
        firststageopeningTime = 1539129600; //testing
    ...
    function stopICO() public onlyOwner{
        Open = false;
        if(_totalRemaining != 0){
            // _transfer(owner, (balances[this].mul(10)).div(100)); // 10% of remaining tokens sending to owner
            // _transfer(wallet, (balances[this].mul(20)).div(100)); // 20% of remaining tokens sending to eth receiving wallet
            ...
            _burnRemainingTokens(_totalRemaining); // burn the remaining tokens
        }
    }
