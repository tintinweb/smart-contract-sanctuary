...
contract PolicyBookFabric is IPolicyBookFabric, AbstractDependant {
  ...
  address policyBookAdminAddress;
  ...
  function setDependencies(IContractsRegistry _contractsRegistry) external override onlyInjectorOrZero {
    ...
    policyBookAdminAddress = contractsRegistry.getPolicyBookAdminContract();
  }
  ...
  function create(
    ...
    TransparentUpgradeableProxy _proxy = new TransparentUpgradeableProxy(
      contractsRegistry.getPolicyBookImplementation(), 
      IPolicyBookAdmin(policyBookAdminAddress).getUpgrader(), 
      ""
    );
    ...
    AbstractDependant(address(_proxy)).setInjector(policyBookAdminAddress);
