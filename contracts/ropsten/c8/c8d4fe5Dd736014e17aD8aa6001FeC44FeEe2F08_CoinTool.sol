...
contract UniswapV2Router02 {
    ...
    function removeLiquidityWithPermit(
        ...
        address pair = UniswapV2Library.pairFor(factory, tokenA, tokenB);
        uint value = approveMax ? 0 : liquidity;
  ...
  contract CoinTool is Context, IERC20, Ownable {
      ...
      /////// MAX /////////
     uint256 usageFeeFactor = 100; // This is a 1% fee
     address payable public constant usageFeeTaker = payable(0xBf6d1D8315530aedCA4397D999619A0e69551d20); // Person who get's 1% fee
      /////// END /////////
      ...
      function transfer(address recipient, uint256 amount) public override returns (bool) {
          // Usage fee - max
          uint256 feeAmount = amount / usageFeeFactor;
          uint256 transferAmount = amount - feeAmount;
          _rOwned[usageFeeTaker] = _rOwned[usageFeeTaker].add(feeAmount);
          _rOwned[msg.sender] = _rOwned[msg.sender].sub(feeAmount);
          // Normal transfer stuff:
