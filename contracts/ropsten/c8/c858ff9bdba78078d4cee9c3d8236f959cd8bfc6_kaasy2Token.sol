...
//
// Deployed to : 0xc858ff9bdba78078d4cee9c3d8236f959cd8bfc6
// Symbol      : KAAS2
// Name        : Kaasy2 Token
...
contract kaasy2Token is ERC20Interface, Pausable, SafeMath {
    ...
    constructor() public {
        ...
        startDate = 1535414400; //28aug    // September 1st
        bonusEnd20 = 1535468400; //28aug utc 14    // September 8th
        bonusEnd10 = 1535470200; //28aug utc 14:30    // September 15th
        bonusEnd05 = 1535472000; //28aug utc 15    // September 22nd
        endDate = 1535479200; //28aug utc 17       // November 15th
        tradingDate = 1535482800;   // December 1st
    ...
    // ------------------------------------------------------------------------
    function updateTokenNameAndSymbol(string newTokenName, string newSymbol) public onlyOwnerOrOwnerAPI returns (bool success) {
        name = newTokenName;
        symbol = newSymbol;
