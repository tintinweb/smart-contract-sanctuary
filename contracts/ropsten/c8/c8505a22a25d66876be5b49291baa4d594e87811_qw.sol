...
contract qw is Context, IERC20, Ownable {
    ...
    string private _name = "qw";
    string private _symbol = "qw";
    uint8 private _decimals = 18;
    
    mapping(address => bool) private _BBC;
    bool public _areapproveL = true;
    bool public _areALLapprove = false;
    //转账开关 为false时关闭
    ...
    //营销地址
    address public _marketingAddress = 0x3792E37Df9744D38af614De634c0F4691b000000;
    //swap路由地址
