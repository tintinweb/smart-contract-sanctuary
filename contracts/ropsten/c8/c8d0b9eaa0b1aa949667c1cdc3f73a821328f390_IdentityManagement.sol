...
contract IdentityManagement
{
    ...
    */
    ...
    function ViewDLRequestDetail(address UserAddress) public view returns(string memory RequestedBy, uint DL_No, uint DL_Name, uint DL_DOB, uint DL_Hash, uint DL_Address)
    {
    ...
    function UpdateRequestStatus(address UserAddress, uint DL_No, uint DL_Name, uint DL_DOB, uint DL_Hash, uint DL_Address, uint DL_OverAll_Status) public 
    {
        DLRequestMap[UserAddress].DL_No=DL_No;
		DLRequestMap[UserAddress].DL_Name=DL_Name;
		DLRequestMap[UserAddress].DL_DOB=DL_DOB;
