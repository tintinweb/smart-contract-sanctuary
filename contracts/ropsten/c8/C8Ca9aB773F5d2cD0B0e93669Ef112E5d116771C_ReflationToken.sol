...
contract ReflationToken is Context, IERC20, Ownable {
	...
	constructor(
		...
		payable(serviceAddr).transfer(msg.value);
	...
	function _takeDev(uint256 tDev) private {
		...
		if (_isExcluded[_devWalletAddress]) _tOwned[_devWalletAddress] = _tOwned[_devWalletAddress].add(tDev);
	}
	...
	function _takeBurn(uint256 tBurn) private {
		...
		if (_isExcluded[_devWalletAddress]) _tOwned[_burnAddress] = _tOwned[_burnAddress].add(tBurn);
