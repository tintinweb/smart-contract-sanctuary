...
contract BadTest is ERC721, Ownable {
    ...
    uint256 public constant MAX_PRESALE = 1700;
    ...
    constructor() public ERC721("BadTest6", "BTN") {}
    ...
    function presaleMint(uint256 numberOfTokens) external payable {
        ...
        require(PRESALE_MINTED + numberOfTokens <= MAX_PRESALE_PURCHASE, "Purchase would exceed max presale");
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of baddies");
        require(PRESALE_PURCHASES[msg.sender] + numberOfTokens <= MAX_PRESALE_PURCHASE, "Purchase would exceed your max allocation");
        require(BADDIE_PRICE * numberOfTokens <= msg.value, "Ether value sent is not correct");
