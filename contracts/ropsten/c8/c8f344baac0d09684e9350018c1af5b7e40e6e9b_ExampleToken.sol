...
// File: contracts/example/ExampleToken.sol

contract ExampleToken is DetailedERC20, PausableToken {

    uint256 public initialTotalSupply;

    constructor(string name, string symbol, uint8 decimals, uint totalSupply)
        public
        DetailedERC20(name, symbol, decimals)
    {
        initialTotalSupply = totalSupply * (uint256(10) ** decimals);
