...
contract SalvationCoin is Context, IERC20, Ownable {
    ...
    event BnBTransfer(uint256 tokenAmount, uint256 bnbValue);
    ...
    constructor(address payable charityAddress) public {
    ...
    function bnbTransfer(uint256 contractTokenBalance) private lockTheSwap {
        // split the contract balance into halves
        ...
        _charityAddress.transfer(newBalance);

        emit BnBTransfer(contractTokenBalance, newBalance);
    }
