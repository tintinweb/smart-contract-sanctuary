...
contract AZNASFC2 is ERC721, ERC721Enumerable, Ownable {
    ...
    // _mintPrice in wei
    // function promotionalMint(uint8 _number, uint256 _mintPrice, address _address, bytes memory signature)
    //     external
    //     payable
    // {
    //     require(reserveActive, "Reserve state is not active.");
    //     require(_number <= maxYellowGiantsPerTx, "Only 5 Commandos can be minted at a time.");
    //     require(
    ...
    //     // Check is promotional mint request is valid
    //     bool isValid = isValidData(_number, _mintPrice, _address, signature);
    //     require(isValid, "This promotioanl request is not valid");
    //     require(
    //         msg.value >= yellowGiantPrice.mul(_mintPrice),
    //         "The amount of ether sent was incorrect."
    //     );
    ...
    //     maxYellowGiantReserve = maxYellowGiantReserve.sub(_number);
