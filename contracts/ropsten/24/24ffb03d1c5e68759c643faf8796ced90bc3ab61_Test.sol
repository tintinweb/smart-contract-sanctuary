...
contract Test is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x3626dba46EFa18a5CDb56922487DD84643bB9F8b); // Marketing Wallet
    address payable public prizeRewardWallet = payable (0x5a26EF1b80d36C65eab637707D7ADA2ABEbA8A29); // prizeReward Wallet
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(15); 

    uint256 private reflectionFee=0; 

    uint256 public liquidityFee = 0;
    uint256 public marketingFee = 7;
    uint256 public prizeRewardFee = 3;
    ...
    function setMaxTxAmount(uint256 maxTxAmount_base1000) external onlyOwner() {
        _maxTxAmount = _tTotal.div(1000).mul(maxTxAmount_base1000);
    }
