...
contract MedinomicsHealthToken is ERC20,
    ...
    constructor() public ERC20("Medinomics Health Token", "MHT") ERC20Capped(100000000 * (10**uint256(8))) {
        _setupDecimals(8);
        _mint(0xF0899812A83907E4b389F0e16aA09D806868D1f3, 10000000 * (10**uint256(8)));
        _mint(0x8648D731cFEf82B09d4A564693e251Ef0Cddff14, 20000000 * (10**uint256(8)));
        _mint(0xDD4A17F0704b53709F0aeEA3e90d7F79c8C8ac01, 70000000 * (10**uint256(8)));
    }
