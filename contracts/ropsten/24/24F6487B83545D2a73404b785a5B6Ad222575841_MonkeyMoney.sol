...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xC69857409822c90Bd249e55B397f63a79a878A55), 5000);
        m_DidDeploy = true;
    }
...
contract MonkeyMoney is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "MonkeyMoney";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 5000, 2500, 100000, m_ILOPublic);
        initTax();
