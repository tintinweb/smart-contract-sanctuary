...
interface IUniversalVaultV2 {
    ...
    function getERC721BalanceLocked(address token) external view returns (uint256 balance);
    ...
    IERC721Receiver
{
    ...
    function getERC721BalanceLocked(address token) public view override returns (uint256 balance) {
