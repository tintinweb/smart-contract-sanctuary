...
contract ETB {
 ...
 //config end
  ...
  constructor() public payable{
      config_level_price[1] = [30,50];
      config_level_price[2] = [60,80];
      config_level_price[3] = [120,120];
      
      config_level_price[4] = [240,200];
      config_level_price[5] = [480,400];
      config_level_price[6] = [960,800];
      config_level_price[7] = [1920,1600];
      config_level_price[8] = [3840,3200];
      config_level_price[9] = [7680,6400];
      config_level_price[10] = [15360,12800];
  ...
  function dynamicReward(address payable referr_address,uint8 invent_level) internal{
       uint256 price = config_level_price[invent_level][1].div(100)*(10**18);
