...
contract NewReal{ // this the sub contract that will generated by the main contract RealPrimary
   ...
   function cancelOffer() public { // cancel this offer.
    ...
    require(available == true,' The offer can not be canceled owing to the offer has been sold!');// the offer can be canceled only if the property is still for sale. 
    valid = false;
