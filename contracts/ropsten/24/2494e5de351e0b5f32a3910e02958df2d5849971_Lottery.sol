...
contract Lottery {
    ...
    uint256 public constant DURATION = 3500; //5520; // One Day
    uint256 public constant ROUND_DURATION = 3100; //5300; 23 hours
    ...
    function random(bytes32 _seed1, uint32 _seed2) public pure returns(uint32 _number){
