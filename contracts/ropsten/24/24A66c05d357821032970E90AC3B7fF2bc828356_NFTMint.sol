...
contract Sale is ERC721, Ownable{
    ...
    function saleToken(address payable admin,uint256 value, uint256 tokenId) public{
        require(value > order_place[_tokenOwner[tokenId]][tokenId].price , "Insufficent found");
