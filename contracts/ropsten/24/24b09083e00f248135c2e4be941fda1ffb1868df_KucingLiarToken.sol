...
contract SelfDropICOToken is StandardToken, Configurable, Ownable {
    ...
    /**
     * @dev constructor of SelfDropICOToken
     **/
    constructor() public {
...
/**
 * @title KucingLiarToken
 * @dev Contract to create the Sekem Token
 **/
contract KucingLiarToken is SelfDropICOToken {
    string public constant name = "KucingLiarToken";
