...
contract TacticalTangrams is /*ERC721Tradable,*/ Base64Metadata {
    ...
    function contractURI() external view returns (string memory) {
        return encodeData(
            bytes(
                abi.encodePacked(
                    '{"name":"TacticalTangrams","description":"Tactical Tangrams NFT collection","image":"https://de.wikipedia.org/wiki/Tangram#/media/Datei:Tangram_diagram.svg","external_link":"https://tacticaltangrams.io","seller_fee_basis_points": 100, "fee_recipient": "bla"',
//                    getAddressString(),
                    '"}')
                ));
    }
...
contract Base64Metadata {
	function encodeData(bytes memory data) internal pure returns (string memory) {
