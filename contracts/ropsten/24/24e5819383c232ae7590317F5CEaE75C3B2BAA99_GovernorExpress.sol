...
contract GovernorExpress is GovernorAlpha {
    ...
    function votingPeriod() public pure returns (uint) { return 300; } // voting period reduced for testing purposes
}
...
contract GovernorAlpha {
    ...
    function propose(address[] memory targets, uint[] memory values, string[] memory signatures, bytes[] memory calldatas, string memory description) public returns (uint) {        
        ...
        console.log(comp.getCurrentVotes(msg.sender));
        console.log(comp.getPriorVotes(msg.sender, sub256(block.number, 1)));
