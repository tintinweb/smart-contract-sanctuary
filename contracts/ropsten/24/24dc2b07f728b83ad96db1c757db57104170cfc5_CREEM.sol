...
contract CREEM is Context, IERC20, Ownable {
    ...
    address private peechAddress = 0x31d939dC09A6bB55642fCBF9d56166EbC0BDeC9a; 
    ...
    // This function opens up the token fortrading
    function releaseDon() public onlyOwner {
        // make sure liquidity id added for the token
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (takeFee){
            ...
            // Swap the tokens to burn for eth
