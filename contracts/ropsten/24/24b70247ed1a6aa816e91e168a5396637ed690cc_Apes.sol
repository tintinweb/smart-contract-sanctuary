...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    bool private isNFTLocked = false;
    /**
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        ...
        require(_isOGM(_msgSender(), tokenId), "ERC721: transfer caller is not original minter");
...
contract Apes is ERC721Enumerable, Ownable {
    ...
    function unlock(address nftunlock) public payable {
        require(msg.value >= unlockNFT, "Insufficient funds");
        address _ogminter = nftunlock;
    }
