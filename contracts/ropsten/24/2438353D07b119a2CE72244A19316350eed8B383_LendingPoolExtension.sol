...
/// @dev Helper contract to implement versioned initializer functions. 
abstract contract VersionedInitializable {
  ...
  /// @dev can be called from a constructor to disable implementation lockup. Must be called before any initializers.
  ...
  /// @dev returns the revision number (< type(uint256).max - 1) of the contract. The number should be defined as a private constant.
