...
contract StupidInuToken is Context, IERC20, Ownable {
    ...
    address payable public _devwallet =
        payable(address(0x62C6d2B0599ef204af36EaddE896161FCE21a61E));
    ...
    string private _name = "StupidInu";
    string private _symbol = "StupidInu";
