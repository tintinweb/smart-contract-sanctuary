...
contract ProjectName is AdminRole, VerifySignature{
  ...
  constructor () public {
    ...
    _token_price = 1000000000000000000; //0.10 USDT * (10**18) = 100000000000000000 wei, where 18 is decimal of USDT

    // set the address that stores Tokens and signs data from the white list
    _signer_address = address(0xD8611100cF06cc8bF83e8AEb9b573404f6C1F9C2);
    ...
    currency_token_address = address(0xEa75D0c4e47D875cdd13dF4b3019295AeB397E9c);
    ...
    project_token_address = address(0xEa75D0c4e47D875cdd13dF4b3019295AeB397E9c);
