...
contract StakeCOC is Owned { 
    ...
    uint256 UnstakingFee = 20; // 2.0% 
    uint256 private TeamFeesCollector = 0;
    address public stakeTokenAdd = 0x4e91480d7320dfACE7fA5eCfE325aabd7FF0D45A;//0x10cd4d351F3fE18E32dc714563F2B8F7fFA378db
    address public rewardToken = 0xD32B104ff42E0BC88381e60791d7C19670Cd2A00;//0xB49C6B26B22b3f336A0EcC01048E36761d8243bE;//0x48053434418A019aA21a3E1BFBDdA278f088B24B;//0xDF55df527D8A2a5279450bD271af2F2bde9521Fa;//0x389649bFeD6987Be7e47B72035c89Ce013F8A611;
...
//2 check if person claoming the reward has any thing staked 
//3 check how many days did that persons payment is remaining 
//4 calculate the payment for each day on base of his stake amount and day 
//5 check his stake date 
 ...
 function MyTotalRewards(address user) external view returns(uint256 poolreward)
  ...
  function calculateReward(uint timeday, address user) private view returns(uint256 rew){
      ...
      }else
      {
          ...
          if(somthing == 0 )
          {
             daystogive = 86400 - daysCountInSec;
          }
          else{
