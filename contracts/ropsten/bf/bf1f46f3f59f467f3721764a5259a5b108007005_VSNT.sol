...
contract VSNT is BurnableToken {

    string public constant name = "Vassanatoken";
    string public constant symbol = "VSNT";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 365000000 * (10 ** uint256(decimals));
