...
contract RPS is ERC1155 {
    ...
    function play_player1(string memory choice) external {
        require(msg.sender == player1, "You're not player 1");
    ...
    function play_player2(string memory choice) external {
    ...
    function getWinner(address player1, address player2) external returns (string memory) {
