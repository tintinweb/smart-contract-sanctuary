...
contract PZG is Ownable, IERC20, IERC20Metadata {
    ...
    address feeWallet = 0xB40889D60317d74Aa511f7734AFD5C4c56558ec9;
    address dev = 0xCE083AC41eb5fcB12EE32C159cBa8d8C4e662019;
    uint256 private constant basePercent = 1000;
     uint256 openingTime = 111; 
     uint256 closingTime = 111;    
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual returns (bool) {
        ...
        uint256 tokensToRedistribute = onePercent * 5;
