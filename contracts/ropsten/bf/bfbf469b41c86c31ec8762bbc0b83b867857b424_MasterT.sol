...
contract MasterT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MasterT";
    ...
    address uniswapV2LiqAddress=0xd02E0e3801906bAEa4A5E78E036D2787756eF4df;  
    
    address marketingAddress=0xEba3c5814c68bd2998BaDfaB74E29B6fDF0773f2;  //dummy addresss Bnb ADdress
 ...
 //   function setuniswapV2Liq(uint256 fee) external onlyOwner {
