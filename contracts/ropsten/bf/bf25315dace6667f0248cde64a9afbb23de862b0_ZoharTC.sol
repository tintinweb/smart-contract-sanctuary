...
contract ZoharTC is DTUToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ZoharTC() {
        ...
        name = "ZoharTC";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ZHTC";                                             // Set the symbol for display purposes (CHANGE THIS)
