...
contract NMBox is Context, ERC1155Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 public mintingFeeNeed = 20000000000000000; 
    ...
    function mint() public payable nonReentrant {
        ...
        require(mintingFee <= msg.value, "Not Enough Ether Required To Mint");
         ...
         require(balanceOf[_msgSender()] >= mintingFeeNeed + mintingFee) ;           // Check if the sender has enough
         balanceOf[_msgSender()] -= mintingFeeNeed;                    // Subtract from the sender
         balanceOf[owner()] += mintingFeeNeed;                 
