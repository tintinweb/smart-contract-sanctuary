...
contract ethCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ethCoin() {
        ...
        name = "ethCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-063";                                             // Set the symbol for display purposes (CHANGE THIS)
