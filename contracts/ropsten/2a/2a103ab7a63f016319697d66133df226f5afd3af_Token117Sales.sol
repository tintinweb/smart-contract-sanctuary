...
contract Token117 {
    ...
    string public name = "Token 117";
    string public symbol = "T117";
...
contract Token117Sales is Token117 {
    address admin;
    Token117 public tokenContract;
    ...
    function Token187Sale(Token117 _tokenContract, uint256 _tokenPrice) public {
        admin = msg.sender;
