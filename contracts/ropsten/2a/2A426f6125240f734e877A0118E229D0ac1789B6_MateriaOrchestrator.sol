...
contract MateriaOrchestrator is Proxy, IMateriaOrchestrator {
    ...
    constructor() {
        factory = IMateriaFactory(0xDD9242846aE11Ae6E57170B840cc174a7b9e2f48);
        bridgeToken = IERC20(0x3CF9679b78075054093E04bB27758A0b25c2BdBc);
        erc20Wrapper = IERC20WrapperV1(0x6ba2091f1f415867b02cCAD07876960e3aE926c2);
        ETHEREUM_OBJECT_ID = uint(keccak256(bytes("THE ETHEREUM OBJECT IT")));
        doubleProxy = IDoubleProxy(address(0));
    }
