...
contract MateriaLiquidityRemover is MateriaOperator {
    ...
    function removeLiquidity(
        ...
        require(amountBridge >= bridgeAmountMin, 'Materia: INSUFFICIENT_BRIDGE_AMOUNT');
        require(amountToken >= tokenAmountMin, 'Materia: INSUFFICIENT_TOKEN_AMOUNT');
    }
    ...
    function removeLiquidityETH(
        ...
        require(amountBridge >= bridgeAmountMin, 'Materia: INSUFFICIENT_BRIDGE_AMOUNT');
        require(amountEth >= ethAmountMin, 'Materia: INSUFFICIENT_TOKEN_AMOUNT');
