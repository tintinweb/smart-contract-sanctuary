...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public mintTime = block.timestamp;
  uint256 public mintWhitelistTime = block.timestamp + 1 days;
  uint256 public mintWhitelistTimeEnd = block.timestamp + 2 days;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= maxSupply, "All sold out");
  ...
  function whitelistMint(uint256 _mintAmount) public payable {
    ...
    require(whitelisted[msg.sender] == true, "User is not in whitelist");
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function checkWhitelisteStatus() public view returns (bool){
	  return whitelisted[msg.sender];
  }

  function checkSupply() public view returns (uint){
	  return maxSupply - mintCounter;
  }
