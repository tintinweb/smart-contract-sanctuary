...
contract MasterChef is Ownable, ReentrancyGuard, IMasterChef, Constants {
    ...
    struct UserInfo {
        ...
        uint128 rewardPoolShare;        // Share of reward pool.
        ...
        for (uint8 i=0; i < length; i++){
            ...
            for(uint32 j; j< userLength; j++){
                ...
                if(user.stakedSince > 0){
                    ...
                    rewardUser.rewardPoolShare = rewardUser.rewardPoolShare + uint128(user.amount * 1e12 / lpSupply * pool.allocPoint / totalAllocPoint * timeReward / poolTimeReward);
