...
library SafeMath {
    ...
    */
    function mul(uint256 a, uint256 b) internal pure returns (uint256){
        ...
        uint256 c = a * b;
        require(c / a == b,"Calculation error in token mul");
        return c;
    }
    ...
    */
    function div(uint256 a, uint256 b) internal pure returns (uint256){
        ...
        require(b > 0,"Calculation error in token div");
        uint256 c = a / b;
    ...
    */
    function sub(uint256 a, uint256 b) internal pure returns (uint256){
        require(b <= a,"Calculation error in token sub");
        uint256 c = a - b;
        return c;
    }
    ...
    */
    function add(uint256 a, uint256 b) internal pure returns (uint256){
        uint256 c = a + b;
        require(c >= a,"Calculation error in token add");
        return c;
    }
