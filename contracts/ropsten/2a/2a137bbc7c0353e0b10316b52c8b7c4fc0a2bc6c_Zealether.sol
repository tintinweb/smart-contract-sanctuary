...
//--------------------------------------------------------------------------------------
//
//Created and assembly by Herzahargun
//
//--------------------------------------------------------------------------------------
...
contract Zealether is ERC20, ProofOfAgeProtocolLayer,
    ...
    string public name = "Zealether";
    string public symbol = "ZELTH";
...
//--------------------------------------------------------------------------------------
    ...
    uint256 public tokensStored = 15000 * (10**decimals);
    ...
    uint256 public rewardsPerBlock = 12900 * (10 ** decimals);
...
//--------------------------------------------------------------------------------------
    ...
    uint256 internal mintingTier = 31250000 * (10 ** decimals);
...
//--------------------------------------------------------------------------------------
    ...
    function excludedNotes(address account) external onlyOwner {
...
//--------------------------------------------------------------------------------------
    ...
    function blacklistNotes(address account) external onlyOwner {
