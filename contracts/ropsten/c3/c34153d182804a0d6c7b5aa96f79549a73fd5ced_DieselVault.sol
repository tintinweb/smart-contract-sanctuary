...
contract DieselVault is Ownable {
    using SafeMath for uint;
    IERC20 public DieselAddress;
    ...
    constructor(IERC20 _DieselAddress) {
        DieselAddress = _DieselAddress;
        admin = _msgSender();
    }
    ...
    function shareReward(address[] memory _accounts, uint[] memory _rewards) public {
        ...
        DieselAddress.transferFrom(_msgSender(), address(this), _totalRewards);
    ...
    function withdrawRewards(uint _amount) public {
        ...
        DieselAddress.transfer(_msgSender(), _totalBalance);
    }
    ...
    function timeLock(uint _duration, uint _amount) private {
        ...
        DieselAddress.transferFrom(_msgSender(), address(this), _amount);
    ...
    function releaseTokens() public {
        ...
        DieselAddress.transfer(_msgSender(), _amount);
