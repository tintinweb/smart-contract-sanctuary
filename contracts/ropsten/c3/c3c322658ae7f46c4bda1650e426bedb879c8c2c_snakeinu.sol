...
contract snakeinu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 public maxTaxFee = 1;                // Transaction fee % that would be distributed to holders (0-10)
    ...
    uint8 public minMxWalletPercentage = 5;     // The maximum supply % that a wallet can hold (1-100). Anti-Whale mechanics
    uint8 public maxBuybackFee = 5;            // Transaction fee % that would be used to buyback tokens on sell (Hyper-deflation) (0-10)
