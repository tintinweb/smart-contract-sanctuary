...
/**
 Elon loves Art Deco. We love the community.
 
 Ownership renounced and liquidity burned on launch.
 
 t.me/ArtDecoBSC
    
    
    P.S.: This is a SafeFairMoon clone, if anybody is curious about the tokenomics.
 */
...
contract ArtDeco is Context, IERC20, Ownable {
    ...
    string private _name = "ArtDeco";
    string private _symbol = "ARTDECO";
