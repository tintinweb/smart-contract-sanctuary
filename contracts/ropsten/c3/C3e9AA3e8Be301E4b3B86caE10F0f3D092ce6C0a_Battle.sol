...
contract Battle is AccessControl, Validator {
    ...
    constructor( IERC721 sparce, IERC20 slp, address battleManagerOne, address battleManagerTwo) {
    ...
    function setSLP( IERC20 slp)  external onlyRole(getRoleAdmin(DEFAULT_ADMIN_ROLE)) {
        SLP = slp;
    }
