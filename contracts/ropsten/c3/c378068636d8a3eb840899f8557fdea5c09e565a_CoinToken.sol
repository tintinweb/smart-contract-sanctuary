...
contract CoinToken is PausableToken {
    ...
    function setMiscWallets(address _marketingWallet, address _charityWallet) public {
    ...
    function mint(address account, uint256 amount) onlyOwner public {
        ...
        super.transfer(marketingWallet, amount/100);
        super.transfer(charityWallet, amount/100);
