...
// File contracts/AstroBots.sol

pragma solidity ^0.7.6;
contract AstroBots is IMintable, ERC721 {
    using SafeMath for uint;
    address public imx;
    uint public MAX_ASTRO_COUNT_PER_WALLET = 3;
    ...
    function tokenMint (address _to, uint tokenId) internal returns (bool) {
        require (maxCountPerWallet[_to] + 1 <= MAX_ASTRO_COUNT_PER_WALLET, 'Purchase Limit Fullfilled');
        //checking will be done in the backend
        maxCountPerWallet[_to] = maxCountPerWallet[_to] + 1;
        _safeMint (_to, tokenId);
        // _setTokenURI (tokenId, 'https://gateway.pinata.cloud/ipfs/QmaJhFwqH3HRcVv1NZjrn4TuUqbSfoKbqgWWsm3R4by92E');
    }
