...
contract SwdStaking is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        // uint256 swdReward =
        //     multiplier.mul(swdPerBlock).mul(pool.allocPoint).div(
        //         totalAllocPoint
        //     );
        uint256 swdReward =
            swdPerBlock.mul(pool.allocPoint).div(
        ...
        // swdToken.mint(devaddr, swdReward.div(10)); //TODO no minting but transfer
        // swdToken.mint(address(this), swdReward); //Mints new SUSHI but we have the SWC so can be skipped //TODO balance check?
        // swdToken.safeTransferFrom(address(this), swdReward);
