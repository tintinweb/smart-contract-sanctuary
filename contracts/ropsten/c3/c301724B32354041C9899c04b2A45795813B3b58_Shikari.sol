...
contract Shikari is Context, IBEP20, Ownable {
    ...
    string  private _NAME="Shikari";
    string  private _SYMBOL="SLLC";
    ...
    uint256 public     _TAX_FEE = 400;
    uint256 public    _BURN_FEE = 400;
    ...
    function _setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee >=0 && taxFee <= 9, 'taxFee should be in 1 - 5');
        _TAX_FEE = taxFee* 100;
        ORIG_TAX_FEE = _TAX_FEE;
    }

    function _setBurnFee(uint256 burnFee) external onlyOwner() {
        require(burnFee >=0 && burnFee <= 9, 'burnFee should be in 1 - 5');
        _BURN_FEE = burnFee* 100;
        ORIG_BURN_FEE = _BURN_FEE;
    }
    
    function _setCharityFee(uint256 charityFee) external onlyOwner() {
        require(charityFee >=0 && charityFee <= 9, 'charityFee should be in 1 - 5');
