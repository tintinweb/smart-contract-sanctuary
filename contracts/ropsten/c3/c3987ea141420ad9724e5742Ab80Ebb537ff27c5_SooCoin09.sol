...
contract SooCoin09 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin09";
    string private m_Symbol = "SOO09";
    ...
    constructor () {
        ...
        ILO.init(200000000000000000, 10000, 5000, 75000, m_ILOPublic);
        initTax();
