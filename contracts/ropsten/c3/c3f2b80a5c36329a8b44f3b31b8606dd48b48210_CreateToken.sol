...
contract CreateToken is ERC20{
    ...
    function returnAmountmsg() payable public returns (uint256) {
       return msg.value/1000000000000000000*conversionRate;
    }
    
    function returnMsgValue() payable public  returns (uint256) {
       return msg.value;
    }
