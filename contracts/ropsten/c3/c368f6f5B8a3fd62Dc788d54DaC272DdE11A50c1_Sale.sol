...
*/
abstract contract Depositable is AccessControl {
     ...
     */
    function changeDepositToken(IERC20 _depositToken)
        external
...
*/
abstract contract MaxDepositable is AccessControl, Depositable {
    // the total amount deposited
     ...
     */
    constructor(uint256 _maxTotalDeposit) {
...
*/
abstract contract MaxTierDepositable is AccessControl, Depositable {
    using SafeMath for uint256;
     ...
     */
    constructor(ITierable _lockedToken, uint256[] memory _tiersMaxDeposit) {
...
*/
abstract contract Schedulable is AccessControl {
    // the start date
 ...
 */
abstract contract Suspendable is AccessControl, Pausable {
...
*/
abstract contract Collectable is AccessControl, Depositable {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
...
*/
abstract contract Authorizable is AccessControl, EIP712 {
    ...
    constructor(address _authorizer) EIP712("Launchblock", "1.0") {
