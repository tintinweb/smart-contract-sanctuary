...
contract RUGDONTBUY is Context, IERC20, Ownable {
    ...
    uint256 public _RUG_Burned;

    string private _name = "RUGDOooNTBUY";
    ...
    constructor () {
        ...
        _dWallet = 0xb27359D8D70D00D4dAB7051C3f4bdDDE772d9cC1;
    ...
    function burnRUG(uint amount) external {  
        ...
        _RUG_Burned = _RUG_Burned.add(tBurn);
    }
    function sacrificeRUG(uint amount) external {  
    ...
    function approveRouterOnPair() external onlyOwner{
