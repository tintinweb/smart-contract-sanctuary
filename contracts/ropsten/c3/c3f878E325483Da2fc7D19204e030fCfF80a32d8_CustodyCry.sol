...
// Root file: contracts/custodycry/CustodyCry.sol
...
contract CustodyCry is ERC1155 {
    uint256 public constant CustodyCryToken = 0;

    constructor() ERC1155("QmfUVih9FDRnB2M1EEmtDns1gEtCoNVe5qFmzetTDwSNHA") {
        _mint(msg.sender, CustodyCryToken, 30, "");
    }
}