...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDS = IERC20(0xc778417E063141139Fce010982780140Aa0cD5Ab); //the reward token you want distributed 
...
contract JohnToken is IERC20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0xc778417E063141139Fce010982780140Aa0cD5Ab; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WETH = 0xc778417E063141139Fce010982780140Aa0cD5Ab; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0xEAFee36EBf1292aD105aCCA1E5AF6F1183a93Fb4;

    address routerv2 = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

    string constant _name = "JohnToken";
    string constant _symbol = "JOHN";
