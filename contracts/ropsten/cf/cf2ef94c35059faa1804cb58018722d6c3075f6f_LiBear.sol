    ...
    IERC865
{
    ...
    function transferPreSigned(
        ...
        require(to != address(0), "Invalid _to address");
        require(
            signatures[signature] == false,
            "signature hash was already used"
        );

        bytes32 preSignedHashedMessage =
            getEthSignedMessage(address(this), to, amount, fee, nonce);
        ...
        require(
            ...
            "The amount you can pay is not enough."
        );
    ...
    function getEthSignedMessage(
        ...
        bytes32 hashedMessage =
            getTransferPreSignedHash(token, to, amount, fee, nonce);
        return
            keccak256(
                abi.encodePacked(
