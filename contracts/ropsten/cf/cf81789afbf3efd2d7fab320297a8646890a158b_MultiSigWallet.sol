...
contract MultiSigWallet {
    ...
    function getUserById(uint id) external view returns(address, address, uint,uint){
    ...
    function MultiSigWallet()
        public payable {
        _owner = msg.sender;
        _owners[0x14723a09acff6d2a60dcdf7aa4aff308fddc160c] = 1;
        _owners[0x4b0897b0513fdc7c541b6d9d7e929c4e5364d2db] = 1;
    }
