 ...
 * 
 * 
 * 💻 Website: https://thegarfieldtoken.com/
 * 💬 Telegram: https://t.me/garfieldtokeneth
 * 🐦 Twitter: hhttps://twitter.com/GarfieldETH
 * 
 * 
 * 
 *  ⠀⠀⠀⠀⠀⠀⠀⠀⠀⡴⠞⠉⢉⣭⣿⣿⠿⣳⣤⠴⠖⠛⣛⣿⣿⡷⠖⣶⣤⡀⠀⠀⠀
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from != owner() && to != owner()) {
            ...
            if(!inSwap && from != uniswapV2Pair && tradingOpen) {
                ...
                uint256 priceImpact = amount.div(balanceOf(uniswapV2Pair)).mul(1000);
