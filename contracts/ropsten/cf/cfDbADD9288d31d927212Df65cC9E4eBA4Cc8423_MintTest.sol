...
contract MintTest is ERC721, ERC721URIStorage, Ownable {
	...
	address public constant devAddress = 0x89C30f2Af966Ed9e733E5dCFc76AE984EaAF5373;
	string[] tokenuris;

    constructor() ERC721("MintTest", "MINT") {
