...
contract L1L2Example {
    ...
    uint256 private firstUserId=10000;
    ...
    */
    ...
    function registUser()external{
        addressToUserId[msg.sender]=firstUserId;
        firstUserId++;
    }
 ...
 function withdraw(
        ...
        external
    {
        ...
        uint256 user=addressToUserId[msg.sender];
        require(user!=0,"user is exist");
