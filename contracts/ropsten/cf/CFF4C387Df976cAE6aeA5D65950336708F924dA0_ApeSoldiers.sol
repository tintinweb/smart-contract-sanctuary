 ...
 * {ERC721Enumerable}.
 */
contract ApeSoldiers is Context, ERC165, IERC721, IERC721Metadata {
    using Address for address;
    using Strings for uint256;
    using SafeMath for uint256;

    // Token name
    string private _name = "Soldier Apes Army";

    // Token symbol
    string private _symbol = "SAA";
    ...
    // Date of release;
    uint public releaseTimestamp = 1641996000; 
    ...
    // Token Price
    uint256 public tokenPrice = 250000000000000000;
    ...
    address private royaltyAddress = 0x524432d2F97DF33bc1847a1cCA616E05E18788BE;
    ...
    */
    ...
    function getCurrentPrice() public view returns (uint256) {
         if (preSaleActive) { 
          return presalePrice; 
           ...
           if(block.timestamp - publicSaleStartTimestamp > 300 && block.timestamp - publicSaleStartTimestamp < 600){
               return 200000000000000000;
           }
           if(block.timestamp - publicSaleStartTimestamp > 600){
    ...
    function changeRoyaltyData(address royalyAddr, uint256 percent) public onlyOwner {
      royaltyAddress = royalyAddr;
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address receiver, uint256 royaltyAmount) {
        ...
        uint256 amount = _salePrice.mul(ROYALTY_SIZE).div(ROYALTY_DEMONINATOR);
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://therangers.io/api/ranger/";
    }
