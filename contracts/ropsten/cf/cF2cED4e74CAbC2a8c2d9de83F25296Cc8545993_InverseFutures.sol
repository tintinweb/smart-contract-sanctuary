...
contract InverseFutures {
    ...
    //mapping(address => UniswapOracle) public oracleByPair;
    ...
    /*function updatePrice(UniswapOracle oracle) public {
        oracle.update();
    }*/
    ...
    function addInstrument(address pair, uint256 tokenAInit, uint256 tokenBInit) external {
