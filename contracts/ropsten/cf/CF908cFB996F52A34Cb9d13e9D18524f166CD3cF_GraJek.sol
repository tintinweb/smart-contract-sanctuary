...
contract GraJek {
    ...
    constructor (address payable _passenger, uint _durationMin, uint distanceKm, uint _startPostal, uint _endPostal) { 
        passenger = _passenger; // this sets the passenger wallet address as a public variable that can be accessed 
