...
{   
    ...
    function approveBRT() private onlyOwner { IERC20(_ERC20_BRT_TokenAddress).approve(_ArtBlocksMintingContractAddress, 1000000000000000000); }
    ...
    function sendTo(address to, uint tokenID) private onlyOwner { IERC721(_ArtBlocksCoreContractAddress).safeTransferFrom(address(this), to, tokenID); }
}
