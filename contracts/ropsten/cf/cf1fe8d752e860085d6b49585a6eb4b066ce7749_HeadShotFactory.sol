...
contract HeadShotFactory is Context, Ownable {
    ...
    function getTrackerFieldNumber(address ledger_, address address_, string memory key_) public view returns (uint256){
        IHeadShotLedger headShotLedger = IHeadShotLedger(getLedger(ledger_));
        return headShotLedger.getTrackerFieldNumber(address_, key_);
    }
    function getTrackerFieldAddress(address ledger_, address address_, string memory key_) public view returns (address){
        IHeadShotLedger headShotLedger = IHeadShotLedger(getLedger(ledger_));
