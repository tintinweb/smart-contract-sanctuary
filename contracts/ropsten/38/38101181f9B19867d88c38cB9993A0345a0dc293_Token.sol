...
contract MinterRole is ERC20{
  ...
  function mint(uint256 value) public onlyMinter {
...
contract Token is ERC20,ERC20Detailed,ERC20Mintable,Ownable{
    ...
    constructor()public ERC20Detailed("mulierum" , "DIVA", 8){
            
            uint256 maximumcoin=50000000000;
            uint8 decimals =8;

            _totalSupply = _balances[msg.sender] = maximumcoin*(10**uint256(decimals));
    }
