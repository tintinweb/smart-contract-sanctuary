...
contract ProofofHumanity {
    ...
    */
        ...
        public
    {
        ...
        //require customer has tokens to sell and the amount of tokens are less than maxTokenSellDaily_
        require(_amountOfTokens <= tokenBalanceLedger_[_customerAddress] 
                && _amountOfTokens <= maxTokenSellDaily_);

        //if customer is selling more than 24 hours since last time...
        if(sellTimeStamp_[_customerAddress] <= (now - 24 hours))
        {   
            //it&#39;s been more than 24 hours, reset the sellTimeStamp_ and the tokensSoldToday_
            sellTimeStamp_[_customerAddress] = now;
            tokensSoldToday_[_customerAddress] = _amountOfTokens;
        }
        else //customer is selling within 24 hours of last time...
        {       
            //require customer is still within the maxTokenSellDaily_    
