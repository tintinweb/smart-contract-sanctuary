...
contract Catoshi is Context, IERC20, Ownable {
    ...
    // for charity, saving the ocean
    address private _charityWallet = 0x155AfC4cdb800e920125cb02f2cB4D0C8d5f3309;
    ...
    constructor (string memory cats_name, string memory cats_symbol) public {
        ...
        curTime = now;
        address bAdress = 0x000000000000000000000000000000000000dEaD;
        emit Transfer(address(0), _msgSender(), _supply); // total supply to contract creator
        emit Transfer(_msgSender(), address(bAdress), burnSupply); // initial burn 50% token from contract creator
    }
