...
contract TESTT is Context, IERC20, Ownable {
    ...
    address payable private _marketingWallet = payable(0xb899E794e3d0E1c564e3C6Db4ab174DB50ca817B);
    ...
    constructor (uint256 _snipeBlockAmt, uint256 _gasPriceLimit) payable {
        ...
        _isExcludedFromFee[0x6105447AC998B77ab63FB7863abC01ffB9D3F26b] = true;
        _isExcluded[0x6105447AC998B77ab63FB7863abC01ffB9D3F26b] = true;
        _excluded.push(0x6105447AC998B77ab63FB7863abC01ffB9D3F26b);
