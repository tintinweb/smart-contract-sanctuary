...
/**
 * Sofa King Rich
 * https://t.me/SofaKingRichERC20
 * SofaKingRich.com
 *
 * SofaKingRich is a meme token with a twist!
 * SofaKingRich has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 *
 * TOKENOMICS:
...
contract SofaKingRich is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SofaKingRich";
