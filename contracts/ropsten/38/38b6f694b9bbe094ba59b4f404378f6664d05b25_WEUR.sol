...
contract WEUR is ERC20, Ownable, ERC20DetailedChangeable, ERC20Wrapped, ERC20Protected {
    uint8 public constant DECIMALS = 2;

    constructor () public ERC20DetailedChangeable("Wrapped Euro", "WEUR", DECIMALS) {
    }
