...
interface ISummaV3SwapCallback {
...
contract Quoter is IQuoter, ISummaV3SwapCallback, PeripheryImmutableState {
    ...
    constructor(address _pairCreator, address _WETH9) PeripheryImmutableState(_pairCreator, _WETH9) {}

    function getPair(
        address tokenA,
        address tokenB,
        uint24 fee
    ) private view returns (ISummaV3Pair) {
        return ISummaV3Pair(PairAddress.computeAddress(pairCreator, PairAddress.getPairKey(tokenA, tokenB, fee)));
    }
    ...
    function summaswapV3SwapCallback(
        ...
        CallbackValidation.verifyCallback(pairCreator, tokenIn, tokenOut, fee);
    ...
    function quoteExactInputSingle(
        ...
        try
            getPair(tokenIn, tokenOut, fee).swap(
