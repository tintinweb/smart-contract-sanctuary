...
contract CarRacing is ERC721, ERC721URIStorage, Ownable{
    ...
    event RaceWinner(uint256 _carId);
    ...
    function startRacing(uint _carId, uint _targetId) external payable returns (string memory){
