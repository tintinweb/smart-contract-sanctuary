...
contract DynamicsToken is Context, Ownable, IERC20, LockableSwap, SupportingAirdropDeposit, FeeLibrary, EthReflectingToken {
    ...
    constructor (uint256 _supply) payable {
        ...
        maxNumTokensSellToAddToLiquidity = numTokensSellToAddToLiquidity.mul(1000);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!inSwapAndLiquify && from != uniswapV2Pair && tradingOpen && !takeFee){
            selectSwapEvent();
        }
    ...
    function selectSwapEvent() private lockTheSwap {
        ...
        } else if(contractTokenBalance >= numTokensSellToAddToLiquidity && shouldSwap){
    ...
    function buyBackTokens(uint256 amount) private {
        ...
        swapETHForTokens(amount, address(this));
