...
/*
Contract TODO:
  - define reveal timestamp passed in (REVEAL_TIMESTAMP = saleStart + (86400 * 9);)
    - should this be automatically set based on sale state?
    - bayc has an explicit setter in addition to constructor for reveal
  - add comments as needed

General TODO:
  - reserve token count in admin
  - add reveal timestamp in admin
  - build tool for generating provenance hashes
  - changed logic around image generation rules  - reveal reveal Time Stamp
    - startingIndex
  - optimizer
...
contract SlobberCrew is ERC721, ERC721Enumerable, Ownable {
  ...
  uint256 public constant TOKEN_PRICE = 500000000000000; // 0.05 ETH public sale
