...
contract Poodle is Context, IERC20, Ownable {
    ...
    uint256 public _rebalanceCallerFee = 300;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'PODL: The contract it self cannot be excluded');
        require(!_isExcluded[account], "PODL: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "PODL: Account is already included");
