...
/*
    ...
    THALES token 0xaA1EbB42Cc13D72E25A3DB6Aa1c7d688cF7A4D58
...
contract Staking is Ownable {
 ...
 string public name = "Staked THALES";
 ...
 function withdraw() onlyDivis public {
  ...
  if(stakedAmount[msg.sender] > _dividends)
 ...
 function sell(uint256 _amountOfTokens) onlyTokenHolders public {
  ...
  if(tokenBalanceLedger_[_customerAddress] == 0) {
      stakedAmount[_customerAddress] = 0;
  }
