...
contract Lottery100Places {
    ...
    function buyTicket(uint16 _ticket) payable public returns (bool) {
      ...
      require(_ticket > 0 && _ticket < ticketMax + 1, 'CANT USE TICKET NUMBER < 0 AND > 9');
    ...
    function sendReward() public allTicketsSold returns (address) {
      ...
      uint256 totalAmount = ticketMax * ticketPrice / 6;
      ...
      emit LotteryAmountPaid5(winner5, winningNumber5, totalAmount);
    }
