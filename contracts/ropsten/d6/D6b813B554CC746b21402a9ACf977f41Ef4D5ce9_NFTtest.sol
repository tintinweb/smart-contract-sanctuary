...
contract NFTtest is ERC721Enumerable, Ownable, AccessControl {
    ...
    function mint(uint256 num) public payable whenMintNotPaused(){
        ...
        require( num <= 5, "NFTTest: You can mint a maximum of 5 NFTs" );
        require( tokenCount + num <= 5, "NFTTest: You can mint a maximum of 5 NFTs per wallet" );
    ...
    function pre_mint(uint256 num) public payable whenPreMintNotPaused() preMintAllowedAccount(msg.sender){
        ...
        require(_pre_sale_purchases[msg.sender] + num <= 2, "EXCEED_ALLOC OF 2 NFTs MAX");
    ...
    function addToPresaleList(address[] calldata _addresses) external onlyRole(WHITE_LIST_ROLE) {
        ...
        function removeFromPresaleList(address[] calldata entries) external onlyRole(WHITE_LIST_ROLE) {
