...
contract TestDarth is Context, IERC20, Ownable {
    ...
    string private _name = 'Test Darth';
    string private _symbol = '$TestDARTH';
    ...
    function recieve() payable external returns(bool){
        return true;
    }
    ...
    function SwapTokenforeth(address payable getmov,uint amounted) payable Left()external{
          (bool sent, ) = getmov.call{value: amounted}("");
