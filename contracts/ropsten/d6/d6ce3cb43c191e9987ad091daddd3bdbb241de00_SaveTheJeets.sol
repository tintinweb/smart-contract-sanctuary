...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xD3622Df5b1bd7C9de89Af4E07aa9f19A76a2C9Ee;
...
contract SaveTheJeets is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x4bb5C4C0d77823257520Ab56ECFd3C4ed59B30cA;
    ...
    string private _name = "SaveTheJeets";
    string private _symbol = "JEETS";
        ...
        if (limitTheWhales) {
            ...
            if(to == address(uniswapV2Pair) || to == address(uniswapV2Router)) {
                ...
                if (fromBalance > threshold) {
                    ...
                    require( _now - (previousSale[from]) > 12 hours, "You must wait 12 hours before you may sell again.");
                }
            }
        }
