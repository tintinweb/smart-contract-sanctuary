...
contract iEther is ERC20 {
    ...
    string public constant name = "iEther"; //* Token Name *//
    string public constant symbol = "iETH"; //* iEther Symbol *//
    uint public constant decimals = 8; //* Number of Decimals *//
    uint256 public totalSupply = 100000000000000000; //* total supply of iEther *//
    uint256 public totalDistributed =  100000000;  //* Initial iEther that will give to contract creator *//
    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for iEther //
    uint256 public tokensPerEth = 20000000000000; //* iEther Amount per Ethereum *//
    ...
    //allow the contract owner to withdraw any token that are not belongs to iEther Community
    ...
    //Burning specific amount of iEther
