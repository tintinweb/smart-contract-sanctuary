...
contract ETS is ERC20, Owned {
    ...
    string public constant name = "ETS";
	...
	function openDistribution() onlyOwner canDistr public returns (bool) {
        distributionOpen = true;
        return true;
    }
    
    function closeDistribution() onlyOwner canDistr public returns (bool) {
        distributionOpen = false;
        return true;
    }
    
    function changeMinContribution(uint _minContribution) onlyOwner public returns (bool) {
