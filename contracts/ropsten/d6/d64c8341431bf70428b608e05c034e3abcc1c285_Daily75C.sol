...
contract Daily75C {
    ...
    uint256 public step1 = constantvalue.div(40);
    uint256 public min = constantvalue.div(200);
    uint256 public med = constantvalue.div(40);
    uint256 public max = constantvalue.div(20);
    ...
    function buy(address _referredBy) public payable {
       ...
       promoter1.transfer(msg.value.div(2).mul(5));
       promoter2.transfer(msg.value.div(2).mul(1));
