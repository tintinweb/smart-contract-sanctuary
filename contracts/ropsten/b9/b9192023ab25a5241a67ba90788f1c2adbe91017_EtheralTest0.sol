...
contract EtheralTest0 is ERC20,PoSTokenStandard,Ownable {
    using SafeMath for uint256;

    string public name = "EtheralTest0";
    string public symbol = "ETHAL0";
    ...
    event ChangeStakeMinAge(uint256 value);
    ...
    function EtheralTest0 () {
        maxTotalSupply = 50000000*10**18;
        totalInitialSupply = 5000000*10**18;
...
//------------------------------------------------------------------------------
    ...
    function getProofOfStakeReward(address _address) internal returns (uint) {
        ...
        if((_now.sub(stakeStartTime)).div(365) == 0) {
            // 1st year effective annual interest rate is 100%
            interest = (1000 * maxMintProofOfStake).div(100);
            // Example #1 : User have 100 tokens with Coin Age 1 Day
            // 100 token x 1 of Min CoinAge = 100
            // Interest = (1000 x 0.1) / 100 = 1 (100%)
            // Reward = 100 x 1 / 365 = 0.2739
            // 100 token + 0.2739 = 100.2739 token
            //
            // Example #2 : User have 100 tokens with Coin Age 10 Days
            // 100 token x 10 of Max CoinAge = 1,000
            // Interest = (1000 x 0.1) / 100 = 1 (100%)
            // Reward = 1,000 x 1 / 365 = 2,739
            // 100 token + 2,739 = 102,739 token
            //
            // Example #3 : User have 100 tokens with Coin Age 30 Days
            // 100 token x 30 of Max CoinAge = 3,000
            // Interest = (1000 x 0.1) / 100 = 1 (100%)
            // Reward = 3,000 x 1 / 365 = 8.2191
            // 100 token + 8.2191 = 108.2191 token
...
//------------------------------------------------------------------------------
    ...
    //Dev will mint supply for external stake contract if neccesary
    ...
    function changeStakeMinAge(uint256 _stakeMinAge) public onlyOwner {
        stakeMinAge = _stakeMinAge;
        ChangeStakeMinAge(stakeMinAge);
    }
