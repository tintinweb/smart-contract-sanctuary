...
contract Ooh is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(tx.origin != owner() && (sender != owner() && recipient != owner()) && (sender != _dxSaleRouterWalletAddress && recipient != _dxSaleRouterWalletAddress) && (sender != _dxSalePresaleWalletAddress && recipient != _dxSalePresaleWalletAddress)) {
