...
/**
* ~ Midi-Chlorian (FORCE) features ~
* 
* Instant staking and burn on each transaction
* 5% tax (2.5% burn, 2.5% auto distributed to holders)
* Be the proud owner of the FORCE
* 
* Website - https://midi-chlorians.com/
* 
*/
...
contract FORT3 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 521832000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'midi-chlorians T3';
    string private constant _symbol = 'FORT3';

    uint256 private _taxFee = 250;
    uint256 private _burnFee = 250;
    uint public max_tx_size = 521832000000000;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != owner() && recipient != owner())
            require(amount <= max_tx_size, "Transfer amount does not exceed Max Tx Size.");
