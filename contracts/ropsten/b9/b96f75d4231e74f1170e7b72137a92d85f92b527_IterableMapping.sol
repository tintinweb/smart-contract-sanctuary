...
contract DottyDoge is ERC20, Ownable {
    ...
    constructor() ERC20("DottyDoge", "$MBY") {
    	...
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F); //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 0x10ED43C718714eb63d5aA57B78B54704E256024E
...
contract DogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DottyDoge_Dogeereum_Dividend_Tracker", "DottyDoge_Dogeereum_Dividend_Tracker", 0xaD6D458402F60fD3Bd25163575031ACDce07538D) {
    	claimWait = 60;
...
contract PolkaDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DottyDoge_Polka_Dividend_Tracker", "DottyDoge_Polka_Dividend_Tracker", 0xFab46E002BbF0b4509813474841E0716E6730136) {
    	claimWait = 60;
        minimumTokenBalanceForDividends = 200000 * (10**12); //must hold 10000+ tokens
    }
