...
contract GreenEyedMonsters is Context, IERC20, Ownable {
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 20, "Must keep taxes 10%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 30, "Must keep taxes below 100%");
