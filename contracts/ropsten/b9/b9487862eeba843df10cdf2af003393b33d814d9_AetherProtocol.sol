...
contract AetherProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Aether Protocol";
    ...
    uint256 internal _tokenTotal = 100_0e18;
    ...
    uint256 public _buybackFee = 300;
    //5%
