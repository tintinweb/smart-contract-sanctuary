...
contract RaphtaliaInu is ERC20, Ownable {
        ...
        onlyOwner
    {
        ...
        address _pair = IUniswapV2Factory(_uniswapV2Router.factory()).getPair(
            address(this),
    ...
    // send tokens and ETH for liquidity to contract directly, then call this (not required, can still use Uniswap to add liquidity manually, but this ensures everything is excluded properly)
    function supplyLiquidity() external onlyOwner returns (bool){
        setRouterVersion(address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D));
