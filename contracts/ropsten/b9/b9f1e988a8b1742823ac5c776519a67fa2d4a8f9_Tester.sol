...
contract TestERC20 is ERC20("tester", "test"), Ownable {
...
contract Tester is Ownable {
  ...
  // Migrate lp token to another lp contract. Can be called by anyone. We trust that migrator contract is good.
    ...
    function setPerBlock(uint256 _cheroesPerBlock) public onlyOwner {
        require(_cheroesPerBlock > 0, "!CheroesPerBlock-0");
        cheroesPerBlock = _cheroesPerBlock;
    }

    function test(IERC20 _lpToken) public onlyOwner{
