...
pragma solidity ^0.6.12;
    ...
    contract WOOFF is Context, IERC20, Ownable {
        ...
        string private _name = 'WOOF Finance';
        string private _symbol = 'WOOFF';
        ...
        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee >= 1 && charityFee <= 10, 'charityFee should be in 1 - 10');
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 1000000000000e18 , 'maxTxAmount should be greater than 1000000000000e18');
