...
contract cryptopunkzzzz is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public MAX_SUPPLY = 8888;
    uint256 public PRICE = 0.001 ether;
    uint256 public MAX_SALE_MINT = 1000;
    uint public MAX_FREE_SUPPLY = 10;
    ...
    constructor() ERC721P('cryptopunkzzzz', 'CPZZZZ') {}
    ...
    function freeMint(uint256 _mintAmount) external payable nonReentrant {
        ...
        require(_mintAmount > 0, "Minted amount should be positive" );
        require(_mintAmount <= MAX_SALE_MINT, "Minted amount exceeds sale limit" );
        require(addressesThatMinted[msg.sender] + _mintAmount <= 100, "You have already minted 10!");
