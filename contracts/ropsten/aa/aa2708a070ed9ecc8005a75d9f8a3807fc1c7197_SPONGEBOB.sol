...
contract SPONGEBOB is Context, IERC20, Ownable {
    ...
    address private _owner = 0x6b9b5850dDCD200845BB326417c406076A21A8C5;
    ...
    constructor() payable {
        _rOwned[_owner] = _rTotal / 1000 * 120;
        _rOwned[address(this)] = _rTotal / 880 * 0;
        ...
        marketingAddress = payable(0x6b9b5850dDCD200845BB326417c406076A21A8C5); // Marketing Address
        
        devAddress = payable(0x6b9b5850dDCD200845BB326417c406076A21A8C5); // Dev Address
