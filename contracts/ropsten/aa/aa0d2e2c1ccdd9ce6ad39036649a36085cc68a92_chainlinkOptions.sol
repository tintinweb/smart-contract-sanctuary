...
contract chainlinkOptions {    
    ...
    function writeOption(address baseTokenAddress, address quoteTokenAddress, uint256 baseTokenPrice, uint strike, uint premium, uint expiry, uint tknAmt) public payable {
        ...
        tokenOpts.push(option(baseTokenAddress, quoteTokenAddress, baseTokenPrice, strike, premium, expiry, tknAmt, false, false, latestCost, payable(msg.sender), payable(address(0))));
    }
    
    //Purchase a call option, needs desired token, ID of option and payment
    function buyOption(address quoteTokenAddress, uint256 ID) public payable {
    ...
    function updateExerciseCost(uint256 ID, uint256 baseTokenPrice) public {
