...
contract CryptoDucksGenesis is ERC721, Ownable {
  ...
  uint128 public maxMintAmountPerTx = 6;
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require(!onlyWhitelisted, "Use MintWl function!");
  ...
  function setMaxMintAmountPerTx(uint128 _maxMintAmountPerTx) public onlyOwner {
