...
contract XTKN031009Liquidity is Context, Ownable{
    // lib
...
// main contract []
contract XTKN031009 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        ...
        // interfaces
            XTKN031009Liquidity private _liquidity;
        ...
        // addresses
            ...
            address public ADDRESS_STAKING_DAYS180; // staking for half a yeaer, locked no owner
    ...
    // private properties
        // tokenomics
            string private _name = "XTKN031009";
            string private _symbol = "XTKN031009";
    ...
    function initLiquidity(address pAddress) public onlyOwner{
        ...
        if(ADDRESS_LIQUIDITY.balance > 0){
            ...
            _liquidity = new XTKN031009Liquidity();

            // initialize liquidity contract
            _liquidity.init(address(this));

            // get swap pair address from liquidity
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "XTKN031009: approve from the zero address");
        require(spender != address(0), "XTKN031009: approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "XTKN031009: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "XTKN031009: transfer amount exceeds allowance"));
        return(true);
    }
