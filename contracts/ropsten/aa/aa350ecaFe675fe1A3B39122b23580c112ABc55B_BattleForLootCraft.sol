...
contract BattleForLootCraft is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 ennemyId, uint256 lootId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="#1a1433" />';
        parts[1] = '<text font-size="30" font-weight="normal" fill="#FFFFFF"><tspan x="10" y="20">Battle!</tspan><tspan x="100" y="20" font-size="10"> for Loot Craft</tspan></text><text x="10" y="40" class="base" style="fill: #64D98A;">VICTORY';
        parts[2] = '</text><text x="10" y="60" class="base">You defeated </text><text class="base" x="120" y="60" ';
        ...
        parts[17] = '</text><text x="10" y="160" class="base"';
        parts[18] = getItemRarity(ennemyId, "V2NATURE3");
        parts[19] = getNature3(ennemyId);

        parts[20] = '</text><text x="10" y="180" class="base"';
