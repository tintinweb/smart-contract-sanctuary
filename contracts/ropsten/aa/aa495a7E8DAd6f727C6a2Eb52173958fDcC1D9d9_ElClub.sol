...
contract ElClub is ERC721Enumerable, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner() && airdropList[msg.sender] != 1) {
      ...
      require(msg.value >= cost * _mintAmount, "insufficientxx funds");
    }
...
console.log('total:', _total  );
 ...
 uint256 _total_owner = address(this).balance;
    ...
    (bool all1, ) = payable(0x2f35B6e91a9253D6607d26ecF1F46dbecA08ba86).call{value: _total_owner * 1/3}(""); //polygon
    require(all1);
    (bool all2, ) = payable(0xEb38abf2E58D297C5AB88b0FC6747e258642B671).call{value:  _total_owner * 1/3}(""); //aaa
    require(all2);
    (bool all3, ) = payable(0x989B3607Ef77c372f4E059e92270b1491aC1978a).call{value:  _total_owner * 1/3}(""); //aaa1
    require(all3);
  }
}
