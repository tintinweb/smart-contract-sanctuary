...
contract Token is Context, IERC20, IERC20Metadata { //собственно сам контракт токена
    ...
    string public _name = "GOG2"; //Полное имя токена
    
    string public _symbol= "GOG2";//краткое имя токена
    
    address payable public marketingAddress = payable(0xA0D0de1070948cF0CBD6Bdf4fB34D4D056bE7bC5); // Marketing Address
    ...
    function _transfer(
        ...
        marketingAmount = marketingPercent / 100; 
