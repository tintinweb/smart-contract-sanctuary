...
contract Operator is Context, Ownable {
  address private _owner;
  mapping (address => bool) public _farmAddresses;
  ...
  function isFarmContract() public view returns (bool) {
    return _farmAddresses[_msgSender()];
  }

  function setFarmAddress(address farmAddress, bool status) public onlyOwner {
    require(
      farmAddress != address(0),
      'Ownable: farm address is the zero address'
    );
    _farmAddresses[farmAddress] = status;
  }
}
...
// File: contracts/GumToken.sol

pragma solidity >=0.4.22 <0.9.0;



contract GumToken is ERC20("Gum Token", "GUM"), Operator {
    ...
    uint public teamReleased = 0;
    uint public communityReleased = 0;
    uint public adviserReleased = 0;
    uint public farmingReleased = 0;
    uint public marketingReleased = 125000 * 1e18; // TGE
    uint public privateSaleReleased = 2e6 * 1e18;

    uint public lastTeamReleased = now + 30 days;
    uint public lastCommunityReleased = now + 30 days;
    uint public lastAdviserReleased = now + 30 days;
    uint public lastMarketingReleased = now + 30 days;
    uint public lastPrivateSaleReleased = now + 30 days;
    ...
    constructor(
        ...
        _mint(msg.sender, 20e6 * 1e18);

        _transfer(msg.sender, _marketingTGEAddress, marketingReleased);
        _transfer(msg.sender, _privateSaleTGEAddress, privateSaleReleased);
        _transfer(msg.sender, _publicSaleTGEAddress, publicSaleAllocation);
    }
    ...
    function releaseFarmAllocation(address _farmAddress, uint256 _amount) public onlyFarmContract {
        ...
        _transfer(msg.sender, _farmAddress, _amount);
    ...
    function releaseTeamAllocation(address _receiver) public onlyOwner {
        ...
        _transfer(msg.sender, _receiver, amountEachTeamRelease);
    ...
    function releaseCommunityAllocation(address _receiver) public onlyOwner {
        ...
        _transfer(msg.sender, _receiver, amountEachCommunityRelease);
    ...
    function releaseAdviserAllocation(address _receiver) public onlyOwner {
        ...
        _transfer(msg.sender, _receiver, amountEachAdviserRelease);
    ...
    function releaseMarketingAllocation(address _receiver) public onlyOwner {
        ...
        _transfer(msg.sender, _receiver, amountEachMarketingRelease);
    ...
    function releasePrivateSaleAllocation(address _receiver) public onlyOwner {
        ...
        _transfer(msg.sender, _receiver, amountEachPrivateSaleRelease);
