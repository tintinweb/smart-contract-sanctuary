...
//
// Deployed to : 0xaa0bf64c90ac0151c04a6a112ec86f8fd887543e
// Symbol      : STAKE17
// Name        : STAKE17 Token
...
contract stake17Token is StandardToken {

    // metadata
    string  public constant name = "STAKE17 Token";
    string  public constant symbol = "STAKE17";
    ...
    function transferETHtoContract(uint _amt) isOwner external {
          require(_amt > 0);
