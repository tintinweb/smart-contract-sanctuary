...
contract INU is Context, IERC20, Ownable {
    ...
    //Sell Fee
    uint256 private _redisFeeOnSell = 5; // 1st
    uint256 private _taxFeeOnSell = 10; //1st
    ...
    uint256 private _MaxIndividualFee = 10;
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy <= _MaxIndividualFee && taxFeeOnBuy <= _MaxIndividualFee && taxFeeOnSell <= _MaxIndividualFee && redisFeeOnSell <= _MaxIndividualFee);
