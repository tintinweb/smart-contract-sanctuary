...
// File contracts/interfaces/ITaalRouter01.sol
...
// File contracts/interfaces/ITaalRouter02.sol
...
// File contracts/ETHXswapBridge.sol
...
contract ETHXswapBridge is Ownable {
    ...
    function swapETHForExactTokens(uint amountOutMin, address[] calldata path, address[] calldata pathx, address to, uint deadline)
        external
        virtual
        payable
        ensure(deadline)
    {
        ...
        uint256 _amount = 11111;
        this.transit(taal, _amount);
        emit SwapETHForExactTokens(msg.sender, _amount, pathx);
    }
    
    function swapExactETHForTokensSupportingFeeOnTransferTokens(uint amountOutMin, address[] calldata path, address[] calldata pathx, address to, uint deadline)
        external
        virtual
        payable
        ensure(deadline)
