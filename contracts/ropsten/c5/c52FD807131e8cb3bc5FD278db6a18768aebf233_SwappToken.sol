...
abstract contract Declaration is Global {
    ...
    ILiquidityGuard public LIQUIDITY_GUARD = ILiquidityGuard(
        // 0xcFde9648fa0f49efD4a12a1fD68cC4C4833f6424 //kovan
        0xFFc949C505A07293992eBa76488aa532B876bF46 //Ropsten
    );
    ...
    constructor() {
        LAUNCH_TIME = 1620482400; // 2021.05.09
    }
...
abstract contract StakingToken is ReferralToken {
    ...
    function createStake(
        ...
        require(msg.sender != _referrer && notContract(_referrer), "SWAPP: Invalid referral address");
        require(_lockDays >= MIN_LOCK_DAYS && _lockDays <= MAX_LOCK_DAYS, "SWAPP: Invalid lock day");
        require(_stakedAmount >= MIN_STAKE_AMOUNT, "SWAPP: Invalid stake amount");
...
contract SwappToken is StakingToken {
    ...
    constructor() ERC20("Swapp Token", "SWAPP") {
        ...
        _mint(0xE4dEc5FB434272A8c4c031bB70E798ed44D28013, 5000000E18);
    }
