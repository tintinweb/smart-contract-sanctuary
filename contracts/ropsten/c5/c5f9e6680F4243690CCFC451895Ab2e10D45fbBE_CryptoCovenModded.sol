...
contract CryptoCovenModded is ERC721, ERC721URIStorage, ERC721Burnable, IERC2981, Ownable, ReentrancyGuard {
    ...
    mapping (uint256 => bytes32) public tokenToURI;
        ...
        maxRugsPerWallet(numberOfTokens)
    {
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            forSale[keccak256(abi.encodePacked(tokenURI(token)))] = false;
        }
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked(baseURI, tokenToURI[tokenId-1])); // arrays start at 0
    }
