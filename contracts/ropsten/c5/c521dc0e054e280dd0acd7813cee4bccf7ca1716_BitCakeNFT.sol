...
contract BitCakeNFT is ERC721, Ownable {
    ...
    constructor() public  ERC721("BitCakeNFT", "BitCakeNFT")  {
        _contractOwner = msg.sender;
        WETHAddress = 0x02d4418C5eeb5BeF366272018F7cD498179FE98B;
    }

    
    function mint(string memory _tokenURI, address _toAddress,  uint256 _price, bool _isListOnMarketplace) public payable {
        ...
        emit Minted(_toAddress,  _price, _tokenId, _tokenURI, _isListOnMarketplace);
    }
