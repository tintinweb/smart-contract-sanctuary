...
contract Pool_3 is Ownable {
    ...
    address public tokenAddress = 0x162278CE5B46e204f095E44Df8A5325E0037249e;
    
    // LP token contract address
    address public LPtokenAddress = 0x162278CE5B46e204f095E44Df8A5325E0037249e;
    ...
    function getPendingDivs(address _holder) public view returns (uint256) {
        ...
        if (block.timestamp < farmEnableat + 5 minutes) {
            uint256 pendingDivs1 = stakedAmount.mul(1000).mul(timeDiff).div(rewardInterval).div(1e4);
