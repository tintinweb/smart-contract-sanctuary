...
contract SamboguyToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SamboguyToken() {
        ...
        name = "SamboguyToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 6;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SBY";                                             // Set the symbol for display purposes (CHANGE THIS)
