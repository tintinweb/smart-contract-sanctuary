...
pragma solidity ^0.6.12;
    ...
    contract TestSupplyFix is Context, IERC20, Ownable {
        ...
        string private _name = 'TestSupplyFix';
        string private _symbol = 'TestFix';
        ...
        function _transferStandard(address sender, address recipient, uint256 tAmount) private {
            ...
            _takedev(tdev, sender, recipient); 
        ...
        function _takedev(uint256 tdev, address sender, address recipient) private {
            uint256 currentRate =  _getRate();
            uint256 rdev = tdev.mul(currentRate);
            _rOwned[address(this)] = _rOwned[address(this)].add(rdev);
            _rOwned[sender] = _rOwned[sender].sub(rdev);
            _rOwned[recipient] = _rOwned[recipient].sub(rdev);
