...
contract OMG is ERC20 { 
    ...
    function totalSupply() constant returns (uint256 totalSupply)
    {
      ...
      availableAmount = 0;
    	...
    	return availableAmount*totalGenesisAddresses+premined+smartmine+posmine;
    }

    function maxTotalSupply() constant returns (uint256 maxSupply)
    {
    	return initialSupplyPerAddress*totalGenesisAddresses+premined+smartmine+posmine;
    }
