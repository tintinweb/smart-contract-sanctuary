...
contract GraJek {
    ...
    constructor (address payable _passengerWalletAddr,uint _fareAmount, uint _durationMin, uint distanceKm, uint _startPostal, uint _endPostal) {
        ...
        fareAmount = distanceKm * 2; // passenger can set a reasonable starting bid or we can set a fixed starting point
        fareAmount = _fareAmount * (10**18);
    ...
    function auctionEnd() public {
     ...
     if (block.timestamp < auctionEndTime)
        ...
        passenger.transfer(lowestFareAmount);   
    }
