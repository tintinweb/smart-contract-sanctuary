...
contract Moon is Context, IERC20 {
    ...
    string private _name = "plswork";
    string private _symbol = "plswork";
    ...
    uint256 public _buyMarketingFee = 750;
    uint256 public _buyDevelopmentFee = 50;

    uint256 public _sellReflectFee = 200;
    uint256 public _sellLiquidityFee = 300;
    uint256 public _sellMarketingFee = 650;
    ...
    uint256 private maxDevelopmentFee = 1000;
    ...
    address payable private _marketingWallet = payable(0x3251b3C75861f43bD201fDd7409208aF7b012265);
    address payable private _developmentWallet = payable(0x21761dcf46E69299A6101b2537208232EE404113);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;
    
    uint256 private maxTxPercent = 125;
