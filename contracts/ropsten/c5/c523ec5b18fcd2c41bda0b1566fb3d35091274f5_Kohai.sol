...
contract Kohai is IERC20, Context {
    ...
    IERC20 public token = IERC20(0x3B90752fC85a6D92C4EC9e86C599ff21A1b0e310);
...
modifier onlyOwner(){
    ...
    ****************************************/
    ...
    function lock(uint256 amount) external {
        ...
        lockingTimeStarts[msg.sender] = now;
        lockingTimeEnds[msg.sender] = now + 1800;
    ...
    function _harvest(address sender) internal{
        ...
        uint256 locktime = now - lockingTimeStarts[msg.sender];
