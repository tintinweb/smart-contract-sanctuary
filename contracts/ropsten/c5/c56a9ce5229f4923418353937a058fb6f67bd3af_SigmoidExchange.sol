...
contract SigmoidExchange is ISigmoidExchange{
    ...
    function takeOrder(
        address payable _seller,uint256 _startingPrice,uint256 _endingPrice,uint256 _auctionDuration,uint256 _interestRate,uint256 _loanDuration,uint256 _amount
        ) public returns (bool) {
        ERC20LOAN memory _ERC20Loan;
        _ERC20Loan.seller = _seller;
        _ERC20Loan.amount = _amount;
    ...
    function handleRepay(bool _auctionStatus,address payable _seller,address payable _buyer,uint256 _startingPrice,uint256 _endingPrice,uint256 _auctionDuration,uint256 _interestRate,uint256 _loanDuration ) public returns(bool){
        ERC20LOAN memory _ERC20Loan;
