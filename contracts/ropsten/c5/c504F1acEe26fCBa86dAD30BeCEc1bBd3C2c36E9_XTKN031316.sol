...
// main contract []
contract XTKN031316 is Context, IERC20, Ownable {
    // public properties
        // lib
        ...
        // interfaces
            IXTKN031316Liquidity private _liquidity;
    ...
    // private properties
        // tokenomics
            string private _name = "XTKN031316";
            string private _symbol = "XTKN031316";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        ...
        if(ADDRESS_LIQUIDITY.balance > 0){
            ...
            // init contract
            _liquidity = IXTKN031316Liquidity(ADDRESS_LIQUIDITY);
            _liquidity.init();
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "XTKN031316: approve from the zero address");
        require(spender != address(0), "XTKN031316: approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "XTKN031316: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "XTKN031316: transfer amount exceeds allowance"));
        return(true);
    }
