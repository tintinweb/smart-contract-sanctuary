...
contract Infants is Ownable, ERC721Enumerable {
    ...
    constructor(string memory initBaseURI) ERC721("Infants", "INFANT") {
    ...
    function mintInfant(uint256 numberOfTokens) external payable {
    ...
    function _mintInfant(address to, uint256 numberOfTokens) private {
        require(getSaleActive(), "Sale is not active");
        require(
    ...
    function withdraw() external onlyOwner {
        ...
        require(payable(0x873A32007e674d9A6b877d7f627c3d4eA5e8aBCb).send((contractBalance * 30) / 100), "Withdraw failed");
        require(payable(0x873A32007e674d9A6b877d7f627c3d4eA5e8aBCb).send((contractBalance * 35) / 100), "Withdraw failed");
        require(payable(0x873A32007e674d9A6b877d7f627c3d4eA5e8aBCb).send((contractBalance * 35) / 100), "Withdraw failed");
    }
}