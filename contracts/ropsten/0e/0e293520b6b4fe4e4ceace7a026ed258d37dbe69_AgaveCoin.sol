...
contract AgaveCoin is Ownable, StandardToken {
    ...
    constructor () public {
        ...
        balances[PartnersAddress] = 3150 * (10**6) * (10**18); //Partners
        balances[TeamAddress] = 1750 * (10**6) * (10**18); //Team and Advisers
        balances[PrivateSaleAddress] = 2100 * (10**6) * (10**18); //Private Sale
        balances[ReserveAddress] = 4900 * (10**6) * (10**18); //Reserve
    }
