...
contract MechaApe9000 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "MechaApe9000";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xA529d7343dBd3434F2cF30AA78139A8fDA8dbc81);
    ...
    constructor () {
        ...
        ILO.init(100000000000000000, 5000, 2500, 100000, m_ILOPublic);
        initTax();
