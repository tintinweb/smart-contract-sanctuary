...
contract BookLibrary is BookLibraryBase {
      ...
      currentlyBorrowedBook(bookId, borrower, false)
    {
        ...
        //uint fee = uint(0.001 ether) / 10;
        _tokens.burn(borrower, _borrowFee);
        //_tokens.transferFrom(borrower, address(this), fee);
...
abstract contract BookLibraryBase is Ownable{
    ...
    uint8 constant _borrowFee = (uint8(1) / 10);
...
contract BookLibraryToken is ERC20Permit {
	constructor()
		ERC20("Book Library Token", "BLT")
		ERC20Permit("Book Library Token")
	{
	}
