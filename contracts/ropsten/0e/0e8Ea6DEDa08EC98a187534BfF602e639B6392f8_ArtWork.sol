...
contract ArtWork is ERC721URIStorage, Ownable {
    ...
    function mint(string memory tokenURI, uint256 startingBidValue, uint256 bidTimeInSeconds, string memory category, string memory media, string memory size) external onlyOwner {
