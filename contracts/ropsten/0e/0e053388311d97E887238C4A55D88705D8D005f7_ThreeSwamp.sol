...
contract ThreeSwamp is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("SwampWater", "THREESWAMP") {    	
        ...
        // exclude from paying fees and cooldown period
    ...
    function swapAndSend(uint256 tokens) private {
        ...
        address payable team = 0x4cd741067b6bEB538d3ed8710B8d4E93b9860b08;
