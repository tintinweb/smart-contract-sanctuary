...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = _totalSupply.div(1000).mul(10); //2% for first few mins
    ...
    uint256 public swapThreshold = _totalSupply.div(10000).mul(20); //0.2% first few mins
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        uint256 xferLiquidityFee = calculateLiquidityFee(tAmount);
        uint256 amountForRecipient = tAmount.sub(xferLiquidityFee);

        _transfer(sender, recipient, amountForRecipient);
        _transfer(sender, address(this), xferLiquidityFee);
    ...
    function multiTransfer_fixed(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {
     ...
     function setTaxesBuy( uint256 _liquidityFee, uint256 _teamFee,uint256 _marketdevFee) external onlyOwner {
    ...
    function setTaxesSell(uint256 _liquidityFee, uint256 _teamFee,uint256 _marketdevFee) external onlyOwner {
