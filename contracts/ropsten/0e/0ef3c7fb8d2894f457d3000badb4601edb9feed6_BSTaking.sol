...
// 
contract BSTaking is TwoStageOwnable, UniStakingTokensStorage {
    using SafeMath for uint256;
...
// 
contract UniStakingSyntheticToken is BSTaking {
    ...
    constructor(
        ...
        IERC20 stakingToken_,
        address owner_
    ) public BSTaking(rewardsToken_, stakingToken_, owner_) {
        name = name_;
        symbol = symbol_;
        decimals = decimals_;
    }
