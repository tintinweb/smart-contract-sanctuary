...
contract BlockchainUniversity {
    ...
    function getAnswerFromQuestionId(uint256 questionId) public view returns (bytes32) {
        return getAnswerFromPointerWord(answers[questionId]);
    }

    function getAnswersSeedDistribution() public view returns (bytes1[256] memory) {
    ...
    function getDistribution() public view returns (bytes1[256] memory) {
        uint256 offset = uint256(keccak256(abi.encodePacked(teacher)));
    ...
    function getPointerFromSeed(bytes1 rune) public view returns (bytes1) {
    ...
    function generateAnswerPointerWord(bytes32 answer) public view returns (bytes32) {
    ...
    function getAnswerFromPointerWord(bytes32 pointerHash) public view returns (bytes32) {
        bytes1[256] memory distribution = getDistribution();
