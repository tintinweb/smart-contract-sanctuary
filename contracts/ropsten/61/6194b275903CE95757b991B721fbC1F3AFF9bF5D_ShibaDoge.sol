...
contract ShibaDoge is Context, IERC20, Ownable {
    ...
    function setRecordSniper(bool isOn) public onlyOwner {
        recordSniper = isOn;
    }
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _rOwned[address(0x000000000000000000000000000000000000dEaD)] = _rOwned[address(0x000000000000000000000000000000000000dEaD)].add(amount);
    }
