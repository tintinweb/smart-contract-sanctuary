...
contract Mint is ERC20, ProofOfAgeProtocol, TimeLockedWallet, Ownable {
    using SafeMath for uint256;
    using Address for address;
...
//--------------------------------------------------------------------------------------
    ...
    uint256 public proofOfAgeRewards = 250000000 * (10**decimals);
...
//--------------------------------------------------------------------------------------
    ...
    uint256 internal proofOfBlockRewards = 250000000 * (10**decimals);
