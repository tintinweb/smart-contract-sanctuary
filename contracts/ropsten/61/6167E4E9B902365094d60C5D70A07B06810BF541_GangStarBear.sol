...
contract GangStarBear is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(address payable fundsTo_, uint256 maxSupply_, uint256 maxPerTx_, uint256 pricePer_) ERC721("GangStarBear", "GANGSTARBEAR") {
        fundsTo = fundsTo_;
