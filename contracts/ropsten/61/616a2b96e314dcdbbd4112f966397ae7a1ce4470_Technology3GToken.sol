...
/*
 * Bou is a standard ERC20 token with some additional functionalities:
...
contract Technology3GToken is StandardToken, Ownable {
    ...
    // Address of token Crowdsale
	  address public tokenCrowdsaleAddr;

    // Enable transfers after conclusion of token Crowdsale
    ...
    /**
     * Check if token Crowdsale address is set or not
     */
...
contract Technology3GCrowdsale is Pausable {
    ...
    // Min contribution is 0.05 ether
