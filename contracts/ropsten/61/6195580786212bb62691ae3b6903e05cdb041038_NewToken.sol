...
contract NewToken is UnlimitedAllowanceToken {

    uint8 constant public decimals = 3;
    uint public totalSupply = 210000000000; // 210 billion tokens
    string constant public name = "New Token";
    string constant public symbol = "NT";
    string constant public images = "./images/eth_logo.svg";
    string messageString = "Welcome to the Project New Token";
