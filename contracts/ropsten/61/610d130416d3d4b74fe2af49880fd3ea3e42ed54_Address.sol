...
contract OneUpToken is IERC20, RetrieveTokensFeature {
    using SafeMath for uint256;
    using Address for address;
    ...
    string private _name = "1UP Token";
    string private _symbol = "1UP";
...
contract TokenReplacementConfigurator is RetrieveTokensFeature {
    ...
    address private constant TEAM_WALLET_OWNER_ADDRESS = address(0x6612945dcF5781854e63960d200eB5E46e87d713);
    ...
    address private constant DEPLOYER_ADDRESS          = address(0xD2E731eEbeafF70EAD4a4fC78710754292Ac8f4b);

    uint256 private constant STAGE1_START_DATE         = 1612116000;    // Jan 31 2021 19:00:00 GMT+0100

    OneUpToken public token;
    ...
    constructor () public {
        ...
        token = new OneUpToken(addresses, amounts);
