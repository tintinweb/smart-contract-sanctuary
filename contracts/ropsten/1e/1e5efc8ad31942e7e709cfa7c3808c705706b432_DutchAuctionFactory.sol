...
contract DutchAuctionFactory is Ownable {
    ...
    */
    event DutchAuctionCreated(address proxy);

   /**
    * @dev Internal implementation address used to specify where implementation is.
    */
    ...
    */
    ...
    /**
    * @dev Upgrade the backing implementation of the factory.
    ...
    * @return Address of the new proxy.
    */
    function _createProxy(address _implementation) internal returns (AdminUpgradeabilityProxy) {
        AdminUpgradeabilityProxy proxy = new AdminUpgradeabilityProxy(_implementation);
        emit DutchAuctionCreated(proxy);
        return proxy;
    }
