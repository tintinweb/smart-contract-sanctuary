...
contract EtherTwoX is ERC20,PoSTokenStandard,Ownable {
    using SafeMath for uint256;

    string public name = "EtherTwoX";
    string public symbol = "0xETH2";
    uint public decimals = 18;

    uint public chainStartTime; //chain start time
    uint public chainStartBlockNumber; //chain start block number
    uint public stakeStartTime; //stake start time
    uint public minCoinAge = 1 days; // minimum age for coin age: 3D
    uint public maxCoinAge = 10 days; // stake age of full weight: 90D
    ...
    function EtherTwoX() {
        ...
        balances[address(this)] = presaleSupply;
...
//------------------------------------------------------------------------------
    ...
    function multiTransfer(address[] memory _recipients, uint[] memory _values) onlyOwner returns (bool) {
