  ...
  contract AVEC{
          ...
          returns(bool)
      {
          ...
          && msg.sender != from){
              ...
              = addi(GUsers[to].TokenBalanceLedgersTotal, tokens);
              ...
              += _Lvalue;
              GUsers[from].PropertyAvecBalance[_propertyUniqueID]
              = subt(GUsers[from].PropertyAvecBalance[_propertyUniqueID], _Lvalue);
              GUsers[to].PropertyAvecBalance[_propertyUniqueID]
              = addi(GUsers[to].PropertyAvecBalance[_propertyUniqueID], tokens);
              GUsers[msg.sender].transferingPropertyid_ = 0x676c6f62616c0000000000000000000000000000000000000000000000000000;
