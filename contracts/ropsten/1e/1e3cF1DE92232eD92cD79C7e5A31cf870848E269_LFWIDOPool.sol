...
contract LFWIDOPool is
    Ownable,
    ReentrancyGuard,
    ERC20("LFW LFW IDO Pool", "LFW-LFW")
{
    ...
    // The block number when LFW mining ends.
    uint256 public bonusEndBlock;

    // The block number when LFW mining starts.
