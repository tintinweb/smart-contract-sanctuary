...
contract GRN is ReleasableToken, MintableToken, UpgradeableToken {
    ...
    address public gridCommunityWallet;
    address public capitalReserveWallet;
    address public grnLabsExpensesWallet;
    address public charityReserveWallet;
    address public liquidityListingReserveWallet;
    ...
    public UpgradeableToken(msg.sender) {
        ...
        preSaleReserveWallet = _preSaleReserveWallet; //10
        gridCommunityWallet = _gridCommunityWallet; //50
        capitalReserveWallet = _capitalReserveWallet; //10
        ...
        if (_initialSupply > 0) {
            ...
            mint(gridCommunityWallet, fiftyPerCent);
