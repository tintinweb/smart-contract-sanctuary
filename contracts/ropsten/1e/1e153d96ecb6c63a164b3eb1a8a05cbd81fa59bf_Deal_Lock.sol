...
/** 
 * Solidity 101 Practice Examples
 * 
 */
contract Deal_Lock {
    ...
    uint locked = 0; //reentrancy guard; locked when equal to 1 
...
///////////////////////////////////////
    ...
    function reject(address payable _creator, uint _contractID) public {
        ...
        //Update state of contract
        if ((myAgreements[_creator][_contractID].selleracceptreject == AcceptReject.Rejected) && (myAgreements[_creator][_contractID].buyeracceptreject == AcceptReject.Accepted)) {
...
///////////////////////////////////////
    ...
    //incomplete
    function availableclaim(address payable _creator, uint _contractID) internal{
...
///////////////////////////////////////
    ...
    function claimlockbox() public {
        ...
        //require(claim_amount < lockbox_claimable, "Claim exceeds max. available in lockbox");
        collectExpired();
