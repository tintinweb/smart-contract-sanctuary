...
// ELPH Token: Worlds First Awareness Token
//                                                 
// Telegram: https://t.me/ElephantsFinance
// Website: https://elephants.finance
...
contract Elephants is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Elephants.Finance';
    string  private constant _SYMBOL = 'ELPH';
    ...
    uint256 private     _TAX_FEE = 400; // 4% BACK TO HOLDERS
    uint256 private    _BURN_FEE = 400; // 4% BURNED
    uint256 private _CHARITY_FEE = 400; // 4% TO CHARITY WALLET
