...
contract HSDJCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HSDJCoin() {
        ...
        name = "HSDJCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HSDJ";                                             // Set the symbol for display purposes (CHANGE THIS)
