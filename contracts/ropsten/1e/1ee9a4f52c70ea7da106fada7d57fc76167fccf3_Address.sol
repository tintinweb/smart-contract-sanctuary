...
interface IJoeRouter01 {
    ...
    function WLNiST() external pure returns (address);
    ...
    function addLiquidityLNiST(
        address token,
        uint256 amountTokenDesired,
        uint256 amountTokenMin,
        uint256 amountLNiSTMin,
        address to,
        uint256 deadline
    )
    external
    ...
    function removeLiquidityLNiST(
        ...
        address to,
        uint256 deadline
    ) external returns (uint256 amountToken, uint256 amountLNiST);
    ...
    function removeLiquidityLNiSTWithPermit(
        address token,
        uint256 liquidity,
        uint256 amountTokenMin,
        uint256 amountLNiSTMin,
    ...
    function swapExactLNiSTForTokens(
        uint256 amountOutMin,
        address[] calldata path,
        address to,
        uint256 deadline
    ...
    function swapTokensForExactLNiST(
        uint256 amountOut,
        uint256 amountInMax,
        address[] calldata path,
        address to,
    ...
    function swapExactTokensForLNiST(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
        address to,
    ...
    function swapLNiSTForExactTokens(
        uint256 amountOut,
        address[] calldata path,
        address to,
        uint256 deadline
...
interface IJoeRouter02 is IJoeRouter01 {
    function removeLiquidityLNiSTSupportingFeeOnTransferTokens(
        address token,
        uint256 liquidity,
        uint256 amountTokenMin,
        uint256 amountLNiSTMin,
        address to,
        uint256 deadline
    ) external returns (uint256 amountLNiST);

    function removeLiquidityLNiSTWithPermitSupportingFeeOnTransferTokens(
        address token,
        uint256 liquidity,
        uint256 amountTokenMin,
        uint256 amountLNiSTMin,
    ...
    function swapExactLNiSTForTokensSupportingFeeOnTransferTokens(
        uint256 amountOutMin,
        address[] calldata path,
        address to,
        uint256 deadline
    ...
    function swapExactTokensForLNiSTSupportingFeeOnTransferTokens(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
        address to,
...
contract ThorV2 is ERC20, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        .createPair(address(this), _uniswapV2Router.WLNiST());
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        ...
        .createPair(address(this), uniswapV2Router.WLNiST());
        uniswapV2Pair = _uniswapV2Pair;
    }
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WLNiST();

        _approve(address(this), address(uniswapV2Router), tokenAmount);

        uniswapV2Router.swapExactTokensForLNiSTSupportingFeeOnTransferTokens(
            tokenAmount,
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        uniswapV2Router.addLiquidityLNiST{value: ethAmount}(
            address(this),
            tokenAmount,
