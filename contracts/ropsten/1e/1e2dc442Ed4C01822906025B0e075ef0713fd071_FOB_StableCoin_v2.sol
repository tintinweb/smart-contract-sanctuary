...
//     ///////////////////////////   Modifiers  ///////////////////
    ...
    // function chkStatesOR(uint[] memory StatesToBeChk) private view returns (bool){
    //     bool res = false;
    //     for (uint i=0;i<StatesToBeChk.length;i++){
    //         if (StatesArray[StatesToBeChk[i]]){
    //             res=true;
    //             i=StatesToBeChk.length;
    //         }
    //     }
    //     return res;
    // }
    // function chkStatesAND(uint[] memory StatesToBeChk) private view returns (bool){
    //     bool res = true;
    //     for (uint i=0;i<StatesToBeChk.length;i++){
    //         if (!StatesArray[StatesToBeChk[i]]){
    //             res=false;
...
//      ///////////////////////////  Functions (Write) ///////////////////
    ...
    function contract_finalization() public only_platform{
        ...
        emit Contract_Finalization(StatesArray[9]);
    }
...
//      ///////////////////////////  Functions (Read) ///////////////////
    ...
    function get_total_amount() public view returns(string memory) {
        return convertTokenBalance(total_amount,token_symbol,token_decimals);
    }

    function get_seller_penalty() public view returns(string memory) {
        return convertTokenBalance(seller_penalty,token_symbol,token_decimals);
    }
