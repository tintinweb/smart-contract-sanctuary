...
pragma solidity ^0.6.12;
    ...
    contract ViagraT3 is Context, IERC20, Ownable {
        ...
        uint256 private _tTotal = 100000000000000000000000;  //1,000,000,000,000
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;

        string private _name = 'ViagraT3';
        string private _symbol = 'ViagraT3';
        ...
        uint256 private _numOfTokensToExchangeForCharity = 5000000;
        uint256 public maxlimit = 5000000000000000000;
       ...
       function sendETHToCharity(uint256 amount) private {
            _charityWalletAddress.transfer(amount.div(13).mul(9));
            _marketingWalletAddress.transfer(amount.div(13).mul(4));
        }
