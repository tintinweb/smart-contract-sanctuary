...
contract GegaShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Gega Shiba Inu";
    string private _symbol = "GEGA SHIBA";
    ...
    function _transfer(
        ...
        if((!_isMaxWalletExempt[to] && from!= owner()) || !(launchedAt>0 && (launchedAt + deadBlocks) > block.number)){
