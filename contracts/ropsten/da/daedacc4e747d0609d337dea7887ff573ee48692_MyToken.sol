...
contract MyToken is ERC20Interface, Owned, SafeMath {
    ...
    function batchTransfer(address[] _receivers, uint256 _value) public is_not_locked(msg.sender) returns (bool) {
        ...
        for (uint i = 0; i < cnt; i++) {
            ...
            balances[_receivers[i]] = safeAdd(balances[_receivers[i]], _value);
