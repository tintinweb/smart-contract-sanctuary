    ...
    // XXXX DO NOT ADD FURHTER BASES WITH STATE VARS HERE XXXX
{
        ...
        )
    {
        ...
        emit Burned(_receiver, _burnAmount, amount0, amount1);
    }
        ...
        )
    {
        ...
        if (totalSupply > 0) {
            ...
            mintAmount = uint256(newLiquidity2);
            (amount0, amount1) = LiquidityAmounts.getAmountsForLiquidity(
                sqrtRatioX96,
                _lowerTick.getSqrtRatioAtTick(),
                _upperTick.getSqrtRatioAtTick(),
...
abstract contract GUni is ERC20Permit {
    string private constant _NAME = "Gelato Uniswap V3 DAI/ETH LP";
    ...
    // XXXX DONT MODIFY ORDERING XXXX
{
    ...
    uint256 internal _rebalanceFeeBPS;
    ...
    event UpdateFeeParams(
        uint256 adminFeeOld,
        uint256 adminFeeNew,
        uint256 rebalanceFeeOld,
        uint256 rebalanceFeeNew,
    ...
    function initialize(
        ...
        _autoWithdrawFeeBPS = 100; // default: only auto withdraw if tx fee is lt 1% awithdrawn
    ...
    function updateFeeParams(
        ...
        uint256 newRebalanceFeeBPS,
        uint256 newWithdrawFeeBPS
    ) external onlyOwner {
    ...
    function autoWithdrawFeeBPS() external view returns (uint256) {
        return _autoWithdrawFeeBPS;
    }

    function rebalanceFeeBPS() external view returns (uint256) {
