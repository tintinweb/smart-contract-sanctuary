...
contract Zatan is ER20, ProofOfAgeProtocolLayer,
    ...
    string public name = "Zatan";
    string public symbol = "ZATAN";
...
//--------------------------------------------------------------------------------------
    ...
    function getProofOfHoldMinting(address account) internal returns (uint) {
        ...
        //Excluded accounts from triggering internal Proof-of-Block
        ...
        if(totalSupply < 62500000 * (10**decimals)) {
            ...
            blocksRewardsReleases = rewardsPerBlock.div(4); //Block reward halving
