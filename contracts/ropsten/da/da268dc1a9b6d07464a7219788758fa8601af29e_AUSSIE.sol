...
contract Ownable is Context {
    ...
    address private _previousMarketingWallet;
...
contract AUSSIE is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 amountForETH = contractTokenBalance.div(3);
        
        swapTokensForEth(amountForETH);
        uint256 balanceForETH = address(this).balance;
        _transfer(address(this), owner(), balanceForETH);
        ...
        uint256 restOfToken = contractTokenBalance.sub(amountForETH);
        uint256 half = restOfToken.div(2);
        uint256 otherHalf = restOfToken.sub(half);
