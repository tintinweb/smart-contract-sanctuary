...
contract AGVPublicSale {
    ...
    constructor() {
        tokenGenerateTime = 1640001031; // 23 Dec 2021
        vestingTimeStartFrom = 1640011831; // 31 Jan 2022
        vestingDuration = 6;
        tgePercentage = 20;
        ...
        usdt_address = 0x66C6E46fC57819bbA55711387c3BCBd55553B734;
    }
    ...
    function buyAGVWithUSDT(uint256 _amount)  external  {
        uint _usd = (_amount.mul(agv_in_usd)).div(100);
        _usd = (_usd.div(10**12));
        IERC20(usdt_address).transferFrom(_msgSender(),address(this), _usd);
        addInvestor(_msgSender(),_amount);    
    }
