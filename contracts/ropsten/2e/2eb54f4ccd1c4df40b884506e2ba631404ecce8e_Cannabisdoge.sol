...
// 2% total tax on every transfer
// - 1% fee to liquidity pool
// - 1% fee sent to the marketing wallet
...
contract Cannabisdoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1.5 * (10**15) * (10**8);
   
    string private _name = "Cannabisdoge";
    ...
    uint256 public _marketingFee = 0;
     // TODO: Update this to a marketing wallet
    ...
    // TODO: Determine max tx amount
    uint256 public _maxTxAmount = 5000000 * (10**6) * (10**8);
    // TODO: Determine this too
    ...
    function _transfer(
        ...
        // transfer amount, it will burn & take liquidity fee
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent > 10, "Cannot set maximum transaction amount less than 10 percent!");
