...
// SPDX-License-Identifier: MIT
    ...
    /**
    - https://www.eqifi.com/
    - Earn up to 70% APY on Yield Farming
    - 100% Lock Liquidity
    - Renounce Ownership
    - 95% in uniswap / 5% Team
    - 0% TAX for sale/buy
     */
...
contract EQIFI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet) ERC20("EQIFI DeFi", "EQIFI") {
