...
contract PhotoNFTData is PhotoNFTDataStorages {
     ...
     */
    function updateOwnerOfPhotoNFT(PhotoNFT _photoNFT, address _newOwner) public payable returns (bool) {
     ...
     */
    function updateStatus(PhotoNFT _photoNFT, string memory _newStatus) public payable returns (bool) {
        /// Identify photo's index
        uint photoIndex = getPhotoIndex(_photoNFT);
