...
contract Testeroo is Context, IERC20, Ownable {
    ...
    string private _name = 'AlphaTesteroo';
    string private _symbol = 'ATRO';
    ...
    uint256 private _numOfTokensToExchangeForDevelopment = 1000000000000 * 10**9;
    ...
    constructor (address payable developmentWalletAddress, address payable charityWalletAddress) public {
