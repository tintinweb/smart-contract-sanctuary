...
/*
    ...
    ➡️ Redistribution  -> 2%
    ➡️ lP Fee          -> 10% (5 Developer, 5 sent to burn address 0x000000000000000000000000000000000000dead)
    ➡️ Burn            -> 0% (useless to burn tokens beforehand if they don't represent actual liquidity value)
...
lowering the total supply in circulation, and hereby having a positive effect on the 'coinvalue')
    ...
    ➡️ Initial buy limit of 2% (2,000,000 tokens) [First to 10th transaction]
    ➡️ Upgraded buy limit of 10% (10,000,000 tokens) [11th-25th transaction]
    ➡️ Unlimited buy limit of 100% whenever the 26th transaction takes place
    
    Scared for liquidity drain, happening with most 'fee' tokens nowadays?
    ➡️ Use our 'manualswap' function whenever you want to sell accumulated tokens obtained through fees (50/50% ratio)
    ➡️ This function no longer has any requirements to use
                          ...
                          \ r-7  `-. ._  ' .  `\
                           \`,      `-.`7  7)   )
                            \/         \|  \'  / `-._
                                ...
                                For more information join our telegram:       ➡️ https://t.me/qilintoken     
                                Website will be posted upon or after launch:  ➡️TBA 
                                Qilin Twitter:                                ➡️TBA 
