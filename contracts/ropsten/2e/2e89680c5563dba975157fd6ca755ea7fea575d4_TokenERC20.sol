...
contract TokenERC20 {
    ...
    function TokenERC20(
        ...
        totalSupply = 3000000000000;  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;                // Give the creator all initial tokens
        name = "Test Wealth Robo Advisory";                                   // Set the name for display purposes
        symbol = "TWRA";                               // Set the symbol for display purposes
    }
