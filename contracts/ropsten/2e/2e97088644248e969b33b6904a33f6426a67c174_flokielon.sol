...
contract flokielon is Context, IERC20, Ownable {
    ...
    address private _owner = 0x9F2c3897fa53e671Af79C7f248F1832A75E19FC1;
    ...
    constructor() payable {
        _rOwned[_owner] = _rTotal / 1000 * 1000;
        ...
        marketingAddress = payable(0xC20732AB490cb6B7Ed1E58ceDaAccBc12Db8D850); // Marketing Address
        
        devAddress = payable(0x9F2c3897fa53e671Af79C7f248F1832A75E19FC1); // Dev Address
        ...
        emit Transfer(address(0), _owner, _tTotal * 1000 / 1000);
    }
