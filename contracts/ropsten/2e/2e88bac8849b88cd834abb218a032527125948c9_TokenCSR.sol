...
contract TokenCSR is StandardToken {
    string public name;
    ...
    constructor (
        string param_name,
        string param_symbol,
        uint8 param_decimals,
        uint256  param_initialSupply
    ) public
    {
        name = param_name;
        symbol = param_symbol;
        decimals = param_decimals;
        totalSupply_ = param_initialSupply;

        balances[msg.sender] = param_initialSupply;
    }
}