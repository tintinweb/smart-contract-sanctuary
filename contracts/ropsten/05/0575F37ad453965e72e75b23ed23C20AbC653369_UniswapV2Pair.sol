...
interface IUniswapV2Factory {
    ...
    function test_blockTimeStamp() external view returns (uint);
    function test_TwoDays() external view returns (uint);
    function test_DiffDays() external view returns (uint);
