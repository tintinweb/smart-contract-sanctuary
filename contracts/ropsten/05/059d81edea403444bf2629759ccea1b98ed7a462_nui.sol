...
contract nui is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public marketingAddress =
    payable(0x1de1539F713368fD47aE8A79735988BE9f9016Ad); // Marketing Address
    
//new
  address payable public lpAddress =
    payable(0xC89c2d56F55f5e654Fdd0e129Ad32127Fb56adC4); // LP
  ...
  string private _name = 'nui';
  string private _symbol = 'nui';
...
// limit
  ...
  function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
    ...
    if (contractETHBalance > 0) {
     ...
     transferToAddressETH(lpAddress, transferredBalance.div(2));
    }
  }
