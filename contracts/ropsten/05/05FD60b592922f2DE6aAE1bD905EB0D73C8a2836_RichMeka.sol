...
contract RichMeka is ERC721Enumerable, Ownable {
    ...
    uint256 public _coloredMekaRate = 8000000000000000000000; // 8 000 SERUM;
    uint256 public _monochromeMekaRate = 5000000000000000000000; // 5 000 SERUM;
    ...
    function mintMekas(uint256 numberOfTokens, bool stakeTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (stakeTokens) {
                _safeMint(address(0), _tokenIdTracker.current());
                _stake(_tokenIdTracker.current());
            }
            else {
