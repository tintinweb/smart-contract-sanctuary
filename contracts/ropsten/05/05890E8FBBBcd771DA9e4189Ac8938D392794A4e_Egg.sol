...
interface IEgg is IERC20 {
  // Only the ants contract can call this function
  error OnlyAnts();

  // An address passed in is equal to zero (and shouldn't be)
  error ZeroAddress();

  /// @notice Mint new eggs
  /// @dev Only callable by ants contract
  /// @param to address receiving new eggs
  /// @param amount amount of eggs to mint
  function mint(address to, uint256 amount) external;

  /// @notice Burn eggs
  /// @dev Only callable by ants contract
  /// @param owner address from where burning eggs
  /// @param amount amount of eggs to burn
