...
contract SooCoin14 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin14";
    string private m_Symbol = "SOO14";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x44Fc079735DAa21Be6d5D09f962721f7C78085ec);
    ...
    constructor () {
        ...
        ILO.init(500000000000000000, 10000, 7230, 50000, m_ILOPublic);
        initTax();
