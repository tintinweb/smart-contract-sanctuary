...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address private eViral = 0x31F42841c2db5173425b5223809CF3A38FEde360;  //0x7CeC018CEEF82339ee583Fd95446334f2685d24f eviral //ropsten dai 0x31F42841c2db5173425b5223809CF3A38FEde360
    ...
    function addLiquidity() external onlyOwner() {
        ...
        liquidityAdded = true;
        _maxTxAmount = 990000000000 * 10**9;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && !_isExcludedFromFee[to] && !_isExcludedFromFee[from]) {
                require(amount <= balanceOf(uniswapV2Pair).mul(33).div(1000) && amount <= _maxTxAmount);
