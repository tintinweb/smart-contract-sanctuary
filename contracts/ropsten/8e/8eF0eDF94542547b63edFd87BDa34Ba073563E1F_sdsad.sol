...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x8BEc16BD1bB27819dB5aFF7c665Cc1c7754ADe3C), 1000);
        m_DidDeploy = true;
    }
...
contract sdsad is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "sdsad";
    string private m_Symbol = "sadas";
