...
contract la is ERC20 {
    ...
    string public constant name = "lala";
    string public constant symbol = "LA";
    uint public constant decimals = 8;
    uint public preico = now + 37 * 1 days;
    ...
    function getTokens() payable canDistr  public {
        ...
        if (msg.value >= requestMinimum && now < preico && now < round1 && now < round2) {
        ...
        }else if(msg.value >= requestMinimum && now < preico && now > round1 && now < round2){
        ...
        if (tokens == 0) {
            ...
            if( now >= preico && now >= round1 && now < round2){
