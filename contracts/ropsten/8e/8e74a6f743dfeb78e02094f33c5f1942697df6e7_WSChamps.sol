...
contract WSChamps is ERC721Enumerable, Ownable {
    //uint256 private basePrice = 100000000000000000; //0.1 ETH
    uint256 private basePrice = 10000000000000000; //0.01 ETH
    ...
    constructor(string memory baseURI) ERC721("WS Champs", "WSC2021") {
        setBaseURI(baseURI);
    }
