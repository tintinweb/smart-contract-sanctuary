...
A proxy contract that is ERC20 compliant for Dijets.

If a called function is not recognised, it passes all
value and call data to an underlying target contract.

The ERC20 standard has been explicitly implemented to ensure
contract to contract calls are compatible on MAINNET
...
contract ProxyERC20 is Proxy, IERC20 {
    ...
    */
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        // Event emitting will occur via Dijets.Proxy._emit()
        return true;
    }
