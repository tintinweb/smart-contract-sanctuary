...
contract ChikoT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function burn(uint256 tokenId, uint256 Confirmation) public onlyOwner {
      require(Confirmation == 1235 , "Invalid Confirm Please Enter 1235");
      _burn(tokenId);
  }
 ...
 function getBalance() public view onlyOwner returns (uint256) {
  ...
  function withdrawAdmin() public payable  onlyOwner {
    address payable receiver = payable(admin);
