...
contract TrapDogs is Context,  AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage{
  ...
  function mint() public payable {
    ...
    require(_tokenIdTracker.current() < _max, "TrapDogs: all TrapDogs have been minted");
  ...
  function mintMultiple(uint256 number) public payable {
	uint256 expectedPrice = _price;
    require(msg.value == (expectedPrice*number), "TrapDogs: must send correct price");
    require(_tokenIdTracker.current() < (_max - number + 1), "TrapDogs: all TrapDogs have been minted");
  ...
  function mintMultipleTest(uint256 number) public payable {
    require(msg.value == number*30000000000000000, "TrapDogs: must send correct price");
    require(_tokenIdTracker.current() < (_max - number + 1), "TrapDogs: all TrapDogs have been minted");
  ...
  function mintMultipleTestTwo(uint256 number) public payable {
    require(msg.value == (number*3/10), "TrapDogs: must send correct price");
    require(_tokenIdTracker.current() < (_max - number + 1), "TrapDogs: all TrapDogs have been minted");
