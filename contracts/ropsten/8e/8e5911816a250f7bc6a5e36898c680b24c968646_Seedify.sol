...
//testing with the two address for owner2 and owne3
 ...
 // function to transfer the funds to founders account
  function fundTransfer(uint256 weiAmount) internal {
     ...
     if(msg.sender == addrToWhitelist1 && weiAmount >= 1){
     ...
     }else if(msg.sender == addrToWhitelist2 && weiAmount >= 1 && weiAmount<=3 ){
         fundDivision(weiAmount);
        //   uint dividedAmount1 = weiAmount*50 / 100 ;
        //   uint dividedAmount2 = weiAmount*25 / 100 ;
        //   uint dividedAmount3 = weiAmount*15 / 100 ;
        ...
        //     owner3.transfer(dividedAmount3);
        //     owner4.transfer(dividedAmount4);
     }else if(msg.sender == addrToWhitelist2 && weiAmount >= 3 && weiAmount<=5 ){
          fundDivision(weiAmount);
    //   uint dividedAmount1 = weiAmount*50 / 100 ;
    //   uint dividedAmount2 = weiAmount*25 / 100 ;
    //   uint dividedAmount3 = weiAmount*15 / 100 ;
...
//   // function to transfer the funds to founders account
  function fundDivision(uint256 weiAmount) internal {
