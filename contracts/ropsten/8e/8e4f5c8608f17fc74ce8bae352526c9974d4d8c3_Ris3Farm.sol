...
contract Ris3Farm is Ownable {
    ...
    ris3Gov public government = ris3Gov(0x4816f1738DC07FB0EE1440230CD6065276011632);
    IERC20 public ris3 = IERC20(government.getRis3Address());
    ...
    function stake(uint256 amount) public {
        ...
        ris3.burn(_amount); //burn tokens for permanent staking
    ...
    function calculateReward(address userAddress) public view returns (uint256 _reward, uint256 _tax) {
        ...
        if (now < government.getWithdrawingStartTime() || userRewardInfo[userAddress].lastWithdrawTime >= govElectionStartTime || percnt == 0){
            ...
            uint256 tax = amount.mul(taxRates).div(100);
    ...
    function governmentBurnTokens() public {
        ...
        require(msg.sender == address(government), "Only government can burn tokens in farm");
    ...
    function setGovernmentAddress(address _govAddress) public onlyOwner {
        government = ris3Gov(_govAddress);
        ris3 = IERC20(government.getRis3Address());
