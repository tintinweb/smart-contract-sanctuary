...
contract Sunny {
  ...
  string public                        name               = "Sunny";
  string public                        symbol             = "SNY";
  ...
  SunnyDividendCards                   divCardContract;
  ...
  public
  {
    ...
    divCardContract = SunnyDividendCards(_divCardAddress);
  ...
  returns(uint)
  {
    ...
    if (toBankRoll != 0) { SunnyBankroll(bankrollAddress).receiveDividends.value(toBankRoll)(); }
