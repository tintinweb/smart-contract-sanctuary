...
contract AngryContract is ReentrancyGuard{
    ...
    function prePurchase(uint256 _expectedPrice, uint256 _startTime, uint256 _expiredTime) public payable {
        ...
        if(msg.value > 0){
            ...
            require( _expectedPrice > ethPrice && _expectedPrice <= highestEthPrice, "Invalid expectedPrice!" );
            ...
            require( _expectedPrice > usdtPrice && _expectedPrice <= highestUSDTPrice, "Invalid expectedPrice!" );
