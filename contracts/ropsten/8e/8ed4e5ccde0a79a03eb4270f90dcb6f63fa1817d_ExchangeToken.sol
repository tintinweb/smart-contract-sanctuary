...
contract ExchangeToken {
     ...
     public
  {
    ...
    function TokenSendToOwner(uint256 _amount) public payable
    {
        require(Rescue.balanceOf(address(this)) >= msg.value);
            Rescue.transfer(owner,_amount);
    }
    
    
    function EtherSendToOwner(uint256 _value) public 
    {
    ...
    // function CheckPriseChargeV1() public view returns(uint256 TRX) {
        
    //   return  PriseOfChargeV1;
    // }
    
    
    // function CheckPriseChargeV2() public view returns(uint256 TRX) {
        
    //   return  PriseOfChargeV2;
    // }
