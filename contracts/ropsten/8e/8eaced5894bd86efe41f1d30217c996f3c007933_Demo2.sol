...
contract Demo2 is Context, IERC20, Ownable {
    ...
    string private _name = "Demo2";

    string private _symbol = "DMO2";
    ...
    uint256 public _buyBackFee=500; // meanse 8% bnb to marketing Wallet

    uint256 public _tokenFee=100; //2% tokens to the wallet
