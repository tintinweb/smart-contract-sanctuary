...
contract Token is Initializable, ContextUpgradeable, AccessControlUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable {
    ...
    function initialize(address send) public virtual initializer {
        __Context_init_unchained();
        __AccessControl_init_unchained();
        __ERC20_init_unchained("XSToken", "XS");
        __ERC20Burnable_init_unchained();
        __Pausable_init_unchained();
        __ERC20Pausable_init_unchained();
        ...
        // _mint(send, 100000000 * (10 ** uint256(decimals())));
    }
