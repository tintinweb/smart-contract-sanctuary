...
contract BEEZ is Context, IERC20, Ownable {
    ...
    uint256 public constant _base = 100;
    uint256 private _taxFee = 4;
    uint256 private _burnFee = 4;
    uint256 public _beeFee = 2;
    uint256 public _subBeeFee = _base-_beeFee;
    bool public noBeeFee = false;

    
    uint256 private _maxTxAmount = 2500e8;
    address payable public constant SafeBeez = 0xfc4Cb035E6D5336ef95742842f9207806a3B4030; //dummie address for now 
    
    function transfer(address recipient, uint256 amount) public override returns (bool) {
    if(noBeeFee = false) {
    _transfer(_msgSender(), SafeBeez, amount * _beeFee / _base);
    _transfer(_msgSender(), recipient, amount * _subBeeFee / _base);
    } else { _transfer(_msgSender(), recipient, amount);}
    }
    
      function _noBeeFee(bool _xbeeFee) public onlyOwner () {
         noBeeFee = _xbeeFee;
      }
