...
// File: contracts/LoyaltyPoints.sol

pragma solidity ^0.6.0;

contract LoyaltyToken is ERC20("Loyalty Points", "LOYAL"), ERC20Burnable, Ownable {
    ...
    //Admins or Owner can add/remove whitelisted contracts + invite/revoke other admins
    ...
    // Admin or Owner adds contract to whitelist
    function addToWhitelist(address newContract) public {
        require(msg.sender == owner() || isAdmin(msg.sender), "Insufficient Permissions");
        whitelist[newContract] = true;
    }

    // Admin or Owner removes contract from whitelist
