...
abstract contract StoreBase is IStore, Pausable, Ownable {
  ...
  bytes32 private constant _KP_MEMBERS = "proto:members";

  constructor() {
    boolStorage[keccak256(abi.encodePacked(_KP_MEMBERS, msg.sender))] = true;
  }
  ...
  function isProtocolMember(address contractAddress) public view returns (bool) {
    return boolStorage[keccak256(abi.encodePacked(_KP_MEMBERS, contractAddress))];
  }
