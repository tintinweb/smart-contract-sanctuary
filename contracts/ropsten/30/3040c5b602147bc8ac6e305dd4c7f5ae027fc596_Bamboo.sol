...
contract Bamboo is ERC20("Bamboo Token", "$Bamboo"), Ownable {
    ...
    function setCliamEndTime(uint256 _time) public onlyOwner{
        cliamEndTime = _time;    
    }
    
    function setClaimPeriod(uint256 _period) public onlyOwner{
        cliamUnitPerPeriod = _period;
    }
    
    function setCliamUnitPerPeriod(uint256 _amount) public onlyOwner {
        cliamUnitPerPeriod = _amount;
    }
