...
contract NftpadFarmingPool is ReentrancyGuard, Ownable {
    ...
    function setRewardDistributionAddress(address rewardsDistribution_)
        public
        onlyOwner
    {
        ...
        updateReward(address(0))
    {
        require(
            ...
            "Caller is not Reward distribution address"
        );
