...
contract P2PBetting is Ownable, ERC165 {
    ...
    function claimETHs() external onlyOwner {
        require(payable(owner()).send(address(this).balance),"claimETH :: transaction failed");
        emit ClaimEth(msg.sender, address(this).balance);
    }
