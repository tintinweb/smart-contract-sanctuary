...
contract AMIGOLD is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit {
    constructor() ERC20("AMI GOLD", "ANG") ERC20Permit("AMI GOLD") {}
    ...
    function mintMany(address[] memory to, uint256[] memory amount) public onlyOwner {
