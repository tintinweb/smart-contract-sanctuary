...
contract TESTVAULT is Context, IERC20, Ownable {
    ...
    //
    string private _name = "TESTVAULT";                                       // name
    string private _symbol = "VLT";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x9cdfe3C8Bde65F13805CdaDAD13c6e238A197795 );   // marketing
