...
contract BitcoinMars {
    string public symbol = "BMRS";
    string public name = "BitcoinMars";
    uint8 public constant decimals = 8;
    uint256 _totalSupply = 0;
	uint256 _maxTotalSupply = 2100000000000000;
	uint256 _adminsupply = 500000000000000;//Admin Supply of 5 Million Coins
	uint256 _miningReward = 10000000000; //1 BMRS - To be halved every 4 years
	uint256 _maxMiningReward = 1000000000000; //50 BMRS - To be halved every 4 years
