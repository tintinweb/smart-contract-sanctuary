 ...
 //--------------------------------------constructor, misc-------------------------------------
  ...
  function updateClaimable() public whenNotPaused {
    ...
    if(thisBlock-lastUpdateBlock > blocksBetweenUpdate) {
      ...
      require(address(this).balance - totalContractUnclaimedWinnings - totalClaimableRewards > 0, "Overclaimed, deposit more until address(this).balance - totalContractUnclaimedWinnings - totalClaimableRewards > 0");
