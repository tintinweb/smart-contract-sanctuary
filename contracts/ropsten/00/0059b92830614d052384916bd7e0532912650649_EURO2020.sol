...
contract EURO2020 {
    ...
    uint8 constant private MAX_AVALIABLE = 1;
    uint8 constant private NUM_TEAMS = 4;
    ...
    mapping (address => mapping (string => uint8)) private bets;
    /*
    NOTE:
    ...
    */
    ...
    function bet(string _team, uint8 _amount) public payable returns (bool success) {
    ...
    function retrive(string _team) public returns (bool success) {
        ...
        uint8 amount = bets[msg.sender][_team];
