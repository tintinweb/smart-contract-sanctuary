...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    function withdrawRequest(uint withdrawAmounts, string calldata _userID,uint time) external payable{
        ...
        require(msg.value >1000,"Transaction Fee Very Low");
        require(withdrawAmounts < limit,"Withdraw Limit Exceeded");
        
       string memory userID = _userID;
        
        address recipient = msg.sender;
        uint amountToSend = withdrawAmounts*amount;
        
        _balances[_owner] = _balances[_owner].sub(amountToSend, "BEP20: transfer amount exceeds balance");
    ...
    mapping (address => string) private _addressToString;
