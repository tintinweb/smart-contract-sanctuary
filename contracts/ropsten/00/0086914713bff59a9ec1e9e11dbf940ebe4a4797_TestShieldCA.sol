...
contract TestShieldCA is IERC20, Ownable {
    ...
    string private constant _name = "TestShieldCA";
    string private constant _symbol = "TestShieldCA";
    ...
    function setWalletSettings(address marketingWallet, address devFundWallet, address liquidityWallet)
        external
        onlyOwner
    {
        ...
        if (_marketingWallet != owner()) _isExcludedFromFee[_marketingWallet] = false;
        if (_devFundWallet != owner()) _isExcludedFromFee[_devFundWallet] = false;
        if (_liquidityWallet != owner()) _isExcludedFromFee[_liquidityWallet] = false;
