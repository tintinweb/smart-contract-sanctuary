...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0xBEaDCd9f89B444B0CE60073A85B05744cD874942);
...
contract RewardPool is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public yfi = IERC20(0xb7A0B7ED2862449eDBe79cdEEf764a0e4Ef263fe);
    uint256 public constant DURATION = 60 days;

    uint256 public periodFinish = 1614293950;
    uint256 public rewardRate = 8333333333000000000;
