...
contract rmo is Context, IERC20, Ownable {
    ...
    string private _name = "rmo";
    string private _symbol = "rmo";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 2000000000 * 10**5 * 10**9;
    uint256 private constant numTokensSellToAddToBuyback = 0 * 10**5 * 10**9;
