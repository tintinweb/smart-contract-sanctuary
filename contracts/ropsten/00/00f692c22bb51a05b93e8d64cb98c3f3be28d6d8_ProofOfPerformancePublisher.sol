...
contract ProofOfPerformancePublisher{
    ...
    event newProofOfPerfBlockHiddenRecord(uint32 _date, string _index_name, bytes32 _proofOfPerfBlockHash, bytes32 _obfuscatedRawDataHash, bytes32 _obfuscatedDerivativeDataHash, bytes32 _previousProofOfPerfBlockHash);
    event newProofOfPerfBlockRevealedRecord(uint32 _date, string _index_name, bytes32 _proofOfPerfBlockHash, bytes32 _outputDataHash, bytes32 _rawDataHash, bytes16 _rawDataSecret, bytes32 _derivativeDataHash, bytes16 _derivativeDataSecret, bytes32 _previousProofOfPerfBlockHash);
    ...
    function getProofOfPerfBlockStateState(bytes32 _proofOfPerfBlockHash)
      ...
      onlyAuthorized
      constant
      returns(uint32,string,bytes32,bytes32,bytes32)
    {
      return(
    ...
    function addProofOfPerfBlock(uint32 _date, string _index_name, bytes32 _obfuscatedRawDataHash, bytes32 _obfuscatedDerivativeDataHash, bytes32 _previousProofOfPerfBlockHash) public onlyAuthorized {
    ...
    function revealProofOfPerfBlock(uint32 _date, string _index_name, bytes32 _rawDataHash, bytes16 _rawDataSecret, bytes32 _derivativeDataHash, bytes16 _derivativeDataSecret, bytes32 _previousProofOfPerfBlockHash, bytes32 _outputDataHash) public {
