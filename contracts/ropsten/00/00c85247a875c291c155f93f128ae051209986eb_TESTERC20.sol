...
contract TESTERC20 is Context, IERC20, Ownable {
    ...
    uint256 public _TESTERC20_Burned;
    ...
    function burnTESTERC20(uint amount) external {  
        ...
        _TESTERC20_Burned = _TESTERC20_Burned.add(tBurn);
    }
    function sacrificeTESTERC20(uint amount) external {  
