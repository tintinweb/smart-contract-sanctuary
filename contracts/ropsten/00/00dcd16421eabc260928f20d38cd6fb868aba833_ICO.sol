...
contract ICO is Ownable{
    ...
    constructor() public{
        ...
        //for first phase
        phase_name = "phase1";
        phase_start_date_time = 1543579200;
        max_token_cap = 10000000000;
        bonus_percentage = 10;
        min_investment_tokens = 10000000;
        ...
        //for second phase
        phase_name = "phase2";
        phase_start_date_time = 1543622400;
        max_token_cap = 10000000000;
        bonus_percentage = 5;
        min_investment_tokens = 10000000;
        token_lockup_period = 9693621963;   //timestamp
    ...
    function BuyTokens(address beneficiary) public payable {
        ...
        var (cPhase, bonus) = getCurrentPhase();
