...
contract FiveItemSale {
    ...
    string public hello1 = "hello1";
    string public hello2 = "hello2";
    ...
    function getItems() public view returns(string memory ret1,
                                            string memory ret2,
                                            string memory ret3,
                                            string memory ret4,
                                            string memory ret5){
        ret1 = itemToString(items["AAA"]);
        ret2 = itemToString(items["BBB"]);
        ret3 = itemToString(items["CCC"]);
        ret4 = itemToString(items["DDD"]);
        ret5 = "HE";
    }
