...
contract Marx is IERC20, IERC20Metadata, Context, Ownable{
    ...
    //função para reinvindicar dividendos
    function withdrawDividends(address _dividends, address _communist, uint256 _myDividends) public isCommunist(msg.sender) {
        _dividends = _dividendsAccount;
        _communist = msg.sender;
        uint256 dividends = _balances[_dividendsAccount];
        _myDividends = dividends.div(accounts.length);
        
        _transfer(_dividends, _communist, _myDividends);
    }
