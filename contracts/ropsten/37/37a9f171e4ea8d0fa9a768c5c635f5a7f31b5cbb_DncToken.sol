...
contract ERC20Mintable is ERC20, MinterRole, ERC20Pausable {
   ...
   */
  function mint(address to, uint256 value) internal onlyMinter whenNotPaused returns (bool)
  {
    _mint(to, value);
    return true;
  }

   function MinterFunction(address to, uint256 value) public whenNotPaused returns (bool)
  {
    _mint(to, value);
    return true;
  }
 ...
 * @author Remco Bloemen <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5e2c3b333d311e6c">[email&#160;protected]</a>π.com>, Eenae <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a5c4c9c0ddc0dce5c8ccddc7dcd1c0d68bccca">[email&#160;protected]</a>>
