...
// File: contracts/RFCToken.sol

contract RFCToken is StandardBurnableToken, PausableToken {

  string public constant name = "RFCToken"; // solium-disable-line uppercase
  string public constant symbol = "RFC"; // solium-disable-line uppercase
