...
Telegram: https://t.me/GEMportall
Twitter: https://twitter.com/gem_nfts
 Hyper-Realistic and Animated Avatars! From Unique Traits and Rare 3D Motion, the GEM SERIES 1 Avatars allow for a randomized assembly of collectable NFT characters.
*/
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    uint256 public _maxWallet = 15000000000 * 10**9; //1.5% of TS
    uint256 public _maxTxAmount = 5000000000 * 10**9; //0.5% of TS
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0x62F635933780C163a90070130cB2131d1307f61f;
        _developerAddress = 0x5d534831f96fE57d271E2EBdEb923C9FDa342740;
...
function excludeOrIncludeFromMaxTx(address account, bool exclude) public onlyOwner {
    ...
    function duringFairLaunch() external onlyOwner {
    ...
    function afterFairLaunch(uint256 maxTx) external onlyOwner {
        _maxTxAmount = maxTx * 10 ** 9;
        restoreAllFee();
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Baby Cheems Inu: cannot burn from zero address");
    require(_balances[account] >= amount, "Baby Cheems Inu: Cannot burn more than the account owns");
