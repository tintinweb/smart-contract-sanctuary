...
contract TaxableTeamToken is IERC20, Context, Ownable {
    ...
    constructor(
        ...
        address owner,
        address feeWallet
    ) public checkIsAddressValid(owner) checkIsAddressValid(feeWallet) {
        ...
        _rOwned[owner] = _rTotal*995/1000;
        _rOwned[feeWallet] = _rTotal*5/1000;
        
        emit Transfer(address(0), owner, _tTotal*995/1000);
        emit Transfer(address(0), feeWallet, _tTotal*5/100);
    }
