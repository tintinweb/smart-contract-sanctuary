...
/// @author Global Group - <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7116161d1e13101d180b141531161c10181d5f121e1c">[email&#160;protected]</a>>
library SafeMath {
...
contract Lottery is Owned{
	...
	function checkMyTicket(uint32 _ticketNumber) public {
		...
		if(winningNum == 2) {
			MEGIngerface(moneyManager).addBalance(t.participant, 6 finney);
