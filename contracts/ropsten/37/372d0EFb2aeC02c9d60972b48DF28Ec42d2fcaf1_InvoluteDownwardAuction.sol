...
contract InvoluteDownwardAuction {
    ...
    mapping (bytes16 => Auction) auctions;
    ...
    event LowestBidDecreased(bytes16 auctionId, address bidder, uint256 amount);
    event AuctionEnded(bytes16 auctionId, address winner, uint256 amount);
    ...
    function createAuction(bytes16 _auctionId, bytes32 _auctionChecksum, uint256 _biddingTime, uint256 _minDecrease) public {
    ...
    function getLiveAuction(bytes16 _auctionId) public view returns (bytes32, uint256, uint256, uint256){
    ...
    function withdraw(bytes16 _auctionId) public returns (bool) {
