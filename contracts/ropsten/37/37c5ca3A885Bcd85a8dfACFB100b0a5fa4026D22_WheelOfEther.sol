...
contract WheelOfEther {
        ...
        returns (uint256)
    {
        ...
        return this.balance.sub(ethBalanceOf(_customerAddress)).sub(devFeeBalance)/10;
    }
    ...
    */
        ...
        returns (uint256 resultNum)
    {
        ...
        spinResult(_customerAddress, resultNum, result, betEth, returnedEth, now);
        return resultNum;
    }
