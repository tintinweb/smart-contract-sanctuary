...
contract LuckyEver is ERC20("LUCKYEVER", "LUCKYEVER"), Ownable {
    ...
    uint256 public rewardThreshold = 5*1e16;
    uint256 public threshHoldTopUpRate = 1; // anti-whale
    uint256 public minTokenNumberToSell = (totalSupply() / 10000) / 10;

    bool public swapAndLiquifyEnabled = false;
    bool inSwapAndLiquify;

    QueueAddressFuns.QueueAddress luckyDogs;
    QueueAddressFuns.QueueAddress winners;
    QueueUintsFuns.QueueUints dogsTime;
    uint256 queueLength = 500;
    ...
    function activateContract() public onlyOwner {
        ...
        // IERC20(usdt).approve(address(pancakeRouter), MAX);
        // _approve(address(this), address(pancakeRouter), MAX);
        // require(
        //     IERC20(usdt).allowance(address(this), address(pancakeRouter)) == MAX,
        //     "router's usdt allowance for this insufficent"
        // );
        // require(
        //     allowance(address(this), address(pancakeRouter)) == MAX,
        //     "router's lucky allowance for this insufficent"
        // );
    }
