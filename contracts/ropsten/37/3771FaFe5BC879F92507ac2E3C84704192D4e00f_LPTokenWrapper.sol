...
contract LPTokenWrapper is Governance {
    ...
    // 开始合约
    function startReward(bool bStart) external onlyGovernance{
        _bStart = bStart;
    }
    //转移代币
    ...
    function addWhiteAccount(address account) external onlyGovernance{
    ...
    function removeWhiteAccount(address account) external onlyGovernance{
