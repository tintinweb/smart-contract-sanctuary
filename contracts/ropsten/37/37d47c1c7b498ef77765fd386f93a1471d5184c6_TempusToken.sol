...
contract TempusToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TempusToken() {
        ...
        name = "tempustoken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TPS";                                             // Set the symbol for display purposes (CHANGE THIS)
