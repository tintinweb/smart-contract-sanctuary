...
contract DERF is ERC20, Ownable {
    ...
    function getCirculatingSupply() public view returns (uint) {
        ...
        if(block.number > startBlockMining){
            circulatingSupply = circulatingSupply + (block.number - startBlockMining) * DERFPerBlock;
        }
