...
contract BEP20Detailed is StandardToken {
...
contract Configurable {
    ...
    uint256 public constant tokenReserve = 3000000*10**18;
...
contract BEP20Token is BEP20Detailed, CrowdsaleToken,PausableToken, MintableToken {
    // public variables
  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "ACMtest";
  string constant tokenSymbol = "ACM FINANCE";
