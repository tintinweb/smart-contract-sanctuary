...
// File: contracts/RisuToken.sol

/*
 * RisuToken is a standard ERC20 token with some additional functionalities:
...
contract RisuToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "RISU";
	string public constant name = "RISU COIN";
	...
	*/
	function RisuToken(address admin) public {
	...
	* @param value Amount of risutokens to send
	*/
