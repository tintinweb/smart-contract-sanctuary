...
contract TrustLogics is ERC20
{
   ...
   /**
     ...
     */
        ...
        require(investorDetails[msg.sender].transferEnabled || msg.sender == owner||(balances[msg.sender]>0 &&investorDetails[msg.sender].investorAddress != msg.sender));
        _;
    }
   ...
   function investor(address _investorAddress,uint _lockPeriod,uint _tokens) public onlyOwner{
       ...
       investorDetails[_investorAddress].endTime = _lockPeriod * 1 seconds;
