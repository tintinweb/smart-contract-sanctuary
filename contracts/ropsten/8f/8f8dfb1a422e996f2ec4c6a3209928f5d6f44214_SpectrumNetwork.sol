...
The Spectrum Network is a global decentralized GIS ecosystem. Our ultility tokens makes GIS mapping even more possible without needing to physically be in the field, by enabling a full integrity data capture using our importable tokens.

Website: https://spectrumnetwork.org/
...
contract SpectrumNetwork {
    ...
    function SpectrumNetwork() public {
        owner = msg.sender;
    }
