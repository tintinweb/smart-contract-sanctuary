...
contract UniverseChain is ERC20 {
    ...
    string public constant name = "UniverseChain";
    string public constant symbol = "XUCH";
    uint public constant decimals = 8;
    uint public deadline = now + 37 * 10 days;
