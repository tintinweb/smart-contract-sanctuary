...
contract Inventory is ERC1155Base {
    /// @notice Event emitted when a game is approved for templateId range.
    ...
    /// @notice Event emitted when owner adds a new template.
...
abstract contract ERC1155Base is Ownable, ERC1155 {
    ...
    /**
     * @dev External function to get the token URI with token Id.
