...
contract SalaryContract {
    ...
    // release days
    uint256 public releaseInterval = 2;
    
    // release token amount
    uint256 public releaseAmount = 2000e18;
    ...
    function release() public {
        ...
        require(curTimestamp >= lastTimestamp + releaseInterval * 1 minutes, "can't release");
        ...
        lastTimestamp = lastTimestamp + releaseInterval * 1 minutes;
