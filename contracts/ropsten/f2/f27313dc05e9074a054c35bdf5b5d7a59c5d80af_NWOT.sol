...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory NWOT_, string memory NWO_) {
        _NWOT = NWOT_;
        _NWO = NWO_;
...
/**
 * @dev Contract for NWOT token
 */
contract NWOT is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 1_000_000_000e18;

    constructor() ERC20("NWOT", "NWO") {
