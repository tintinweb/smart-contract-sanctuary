...
// File: src\contracts\NFTCollection.sol
...
contract NFTCollection is ERC721, ERC721Enumerable {
    ...
    function safeMint(string memory _tokenURI) public {
        ...
        _NFTs[_id].minter = msg.sender;
        _NFTs[_id].borrower = msg.sender;
        _NFTs[_id].startDate = block.timestamp;
        _NFTs[_id].duration = 0;

        _safeMint(msg.sender, _id);
        _tokenURIExists[_tokenURI] = true;
    }

    function getNFTInfo(uint256 id)
        public
        view
        returns (
            address minter,
    ...
    {
        minter = _NFTs[id].minter;
        borrower = _NFTs[id].borrower;
        startDate = _NFTs[id].startDate;
        duration = _NFTs[id].duration;
    }
}
