...
contract StakingReward is Ownable{
    ...
    constructor(address _stakingToken,address _tokenFeeAddress) public {
    ...
    function updateAccount(address account) private {
        ...
        if (pendingDivs > 0) {
            stakingToken.safeTransfer(account, pendingDivs);
    ...
    function stake(uint256 amountToStake) public{
        ...
        stakingToken.safeTransferFrom(msg.sender, address(this), amountAfterFee);
