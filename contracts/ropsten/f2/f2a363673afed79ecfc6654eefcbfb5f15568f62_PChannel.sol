...
contract PChannel is Ownable {
    ...
    // fixed 15 deposits amount in USD cents
    uint private depositAmount = 75000;

    // max 15 deposits amount in USD cents
    uint private maxDepositAmount = 93750;
    ...
    function() payable public {
        ...
        uint fixedAmount = amount / 15;
        for (uint8 i = 0; i < 15; i++) {
            refProgram.invest.value(fixedAmount)(msg.sender, i);
        }
    }
