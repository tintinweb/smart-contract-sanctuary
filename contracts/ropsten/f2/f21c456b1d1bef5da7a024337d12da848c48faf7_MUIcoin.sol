...
contract MUIcoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MUIcoin() {
        ...
        name = "MUIcoin";                                   		// Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT18-057";                                     // Set the symbol for display purposes (CHANGE THIS)
