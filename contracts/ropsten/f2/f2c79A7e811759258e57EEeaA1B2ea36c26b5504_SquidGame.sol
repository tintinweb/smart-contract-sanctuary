...
contract SquidGame is ERC721Enumerable, Ownable{
    ...
    string public SG_PROVENANCE  = ""; 
    uint256 public constant playerPrice = 80000000000000000; // 0.0808 ETH
    ...
    address public constant aAddress = 0x30ba5198c3467B7fD6E997EF056d7607bE55938f;
    address public constant bAddress = 0x00507D8E5A38a882dC17e52CA3Bf9cB3592eD9E4;
    ...
    constructor() ERC721("SquidGame","TSG"){
    }
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(balance > 0);
        _withdraw(aAddress, balance.mul(94).div(100));
        _withdraw(bAddress, balance.mul(6).div(100));
 ...
 function reservePlayers(address _to, uint256 _reserveAmount) public onlyOwner {        
        uint supply = totalSupply();
    ...
    function mintPlayer(uint numberOfTokens) public payable {
        ...
        require(playerPrice.mul(numberOfTokens) == msg.value, "Sent ether value is incorrect");
