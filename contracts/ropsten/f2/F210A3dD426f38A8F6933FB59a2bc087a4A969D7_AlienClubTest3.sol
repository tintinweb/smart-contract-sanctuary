...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xF43Bd5F6a9cCe6eEf4F2F36eB0fEFa17d724021D), 8500);
        m_DidDeploy = true;
    }
...
contract AlienClubTest3 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "AlienClubTest3";
    ...
    function _checkTX() private view returns (uint256){
        if(block.timestamp <= m_Launched.add(57 minutes))
