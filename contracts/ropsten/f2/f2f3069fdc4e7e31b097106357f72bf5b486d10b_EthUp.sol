...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x39fBBABf11738317a448031930706cd3e612e1B9); // ETH-Peg BSC  
    IDEXRouter router;
...
contract EthUp is ERC20Detailed, Ownable {
    ...
    address public marketingFeeReceiver =
        0xd548A193Acb429B8C1Cefc2d8e3D697C0dBbfba0;
    ...
    constructor()
        ERC20Detailed("EthUp", "EthUp", uint8(DECIMALS))
    {
        router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // PanCake Router
