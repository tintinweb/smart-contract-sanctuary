...
contract Game {
    ...
    function buyCore(address _playerAddress,address _inviteAddress) private {
        ...
        roundInfoXRound[totalRoundNumber].ethCount = roundInfoXRound[totalRoundNumber].ethCount.add(msg.value.div(100).mul(distributionForPot).div(getBuyPrice()).mul(1 ether));
    }
    ...
    function buyCoreWithBalance(address _playerAddress,address _inviteAddress,uint256 _amount) private {
        ...
        roundInfoXRound[totalRoundNumber].ethCount = roundInfoXRound[totalRoundNumber].ethCount.add(_amount.div(100).mul(distributionForPot).div(getBuyPrice()).mul(1 ether));
