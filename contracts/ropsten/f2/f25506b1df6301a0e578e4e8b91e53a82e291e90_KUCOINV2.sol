...
/** 
 *  SourceUnit: /Users/gaoyang/ETHProjects/kucoin/contracts/KUCOINV2.sol
*/
...
contract KUCOINV2 is Initializable, ERC20PresetMinterPauserUpgradeable{
    function initialize(
        string memory name,
    ...
    function getCount() public pure returns(string memory){
        return "v2";
    }
