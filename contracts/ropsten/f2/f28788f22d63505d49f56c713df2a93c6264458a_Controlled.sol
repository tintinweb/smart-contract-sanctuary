...
contract iTradeGraphToken is StandardToken, Controlled {
    
    using SafeMath for uint;

    string public constant name = "iTradeGraph Token";

    string public constant symbol = "ITG";
    ...
    // for token circulation on platforms that integrate iTradeGraph Token before unlockTime
    mapping (address => bool) internal precirculated;

    function iTradeGraphToken(uint _unlockTime) public {
