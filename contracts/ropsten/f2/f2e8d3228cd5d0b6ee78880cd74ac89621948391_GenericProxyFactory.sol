...
contract GenericProxyFactory{
  ...
  function fuk(address _master, bytes32 _salt, address _deployere) public view returns (address) {
    return ClonesUpgradeable.predictDeterministicAddress(_master, _salt, _deployere);
  }
