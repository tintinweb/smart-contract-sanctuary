...
contract Masks is Context, Ownable, ERC165, IMasks, IERC721Metadata {
    ...
    uint256 public constant SALE_START_TIMESTAMP = 1612540473; //set sale time here in unix

    // Time after which hash masks are randomized and allotted
    uint256 public constant REVEAL_TIMESTAMP = SALE_START_TIMESTAMP + (1200 * 1); //unix seconds and amount of days
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 4) {
            return 700000000000000000; // 16381 - 16383 100 ETH
        } else if (currentSupply >= 3) {
            return 600000000000000000; // 16000 - 16380 3.0 ETH
        }   else if (currentSupply >= 2) {
            return 300000000000000000; // 7000 - 10999 0.5 ETH
        } else if (currentSupply >= 1) {
            return 200000000000000000; // 1 0.3 ETH
        } else {
            return 100000000000000000; // 0  0.1 ETH 
        }
    }
