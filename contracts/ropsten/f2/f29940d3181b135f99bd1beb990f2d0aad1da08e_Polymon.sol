...
contract Polymon is ERC721Enumerable, Ownable{
    ...
    uint256[5] genderRarity = [2, 2, 3, 4, 5];
    ...
    uint256 public constant MAX_NFT_PURCHASE = 50; //20
    ...
    function getGender(uint256 tokenId) private view returns (Gender) {
        uint256 _currentGen = uint256(getGeneration(tokenId));
        return (Gender)(tokenId % genderRarity[_currentGen]);
    }
