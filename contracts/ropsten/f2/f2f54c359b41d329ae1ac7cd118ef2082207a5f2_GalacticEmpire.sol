...
contract GalacticEmpire is ERC721, Ownable {
    ...
    uint256 private constant _maxPresaleTokens = 2222;
    ...
    function withdraw(address payee) public payable onlyOwner {
        ...
        uint256 one = total * 3;
        uint256 two = total * 97;

        require(payable(0x387950f231F0AD9519627f9efAa4cac60abA40d9).send(one / 100));
        require(payable(payee).send(two / 100));
    }
}