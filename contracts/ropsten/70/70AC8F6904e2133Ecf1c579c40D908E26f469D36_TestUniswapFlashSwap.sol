...
contract TestUniswapFlashSwap is IUniswapV2Callee {
    ...
    function uniswapV2Call(address _sender, uint _amount0, uint _amount1, bytes calldata _data) external override {
        ...
        // IERC20(tokenBorrow).approve(ROUTER, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
        ...
        emit Log("amount for profit", amountAfter - (amountBorrow + fee));
        
        // IERC20(tokenBorrow).approve(address(this), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
