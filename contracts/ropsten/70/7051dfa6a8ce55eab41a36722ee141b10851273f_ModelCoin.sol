...
ModelCoin is deflationary, the total supply will decrease over time.
...
No fee to transfer between wallets
...
contract ModelCoin is Context, IERC20, Ownable { 
    ...
    string private _name = "ModelCoin"; 
    string private _symbol = "Model";  
    ...
    uint256 public _FeeMaxPossible = 10;
    ...
    */
    ...
    // Prevents double processing as the tokens update faster than the trigger count
    ...
    */
    ...
    // Set the maximum permitted wallet holding (percent of total supply x 100)
     function set_Max_Wallet_Holding_Percent_X100(uint256 max_Wallet_Holding_Percent) external onlyOwner() {
        // Buyer protection - Max Holding can never be set to 0
        require(max_Wallet_Holding_Percent > 0, "Max holding must be greater than zero!");
