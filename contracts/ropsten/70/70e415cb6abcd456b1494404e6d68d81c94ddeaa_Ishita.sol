...
// The Ishita Token Contract
contract Ishita is ERC20Interface{
    string public name = "Ishita";
    string public symbol = "ISTA";
...
contract IshitaICO is Ishita{
    address public admin;
    address payable public deposit;
    uint tokenPrice = 0.001 ether;  // 1 ETH = 1000 ISTA, 1 ISTA = 0.001
   ...
   receive () payable external{
    ...
    function transfer(address to, uint tokens) public override returns (bool success){
        ...
        super.transfer(to, tokens);  // same as Ishita.transfer(to, tokens);
        return true;
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success){
        ...
        Ishita.transferFrom(from, to, tokens);  // same as super.transferFrom(to, tokens);
        return true;
