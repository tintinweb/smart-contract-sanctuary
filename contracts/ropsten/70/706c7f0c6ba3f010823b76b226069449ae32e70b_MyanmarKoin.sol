...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract MyanmarKoin is Context , IERC20, Ownable {
    ...
    string private _name = "MyanmarKoin";
    ...
    address public CharityWallet = 0x421F17a999150bECbbe33bd76ca5F4Ef5C9607EF; //2% for charity 
    ...
    uint256 public _maxTxAmount = 10000000000 * 10**9;   //ANTIDUMP
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D, 'We can not exclude uniswap router.'); //v2
