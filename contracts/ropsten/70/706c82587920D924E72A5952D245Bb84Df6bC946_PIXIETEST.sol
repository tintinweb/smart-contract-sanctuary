...
contract PIXIETEST is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pixie Inu Test";
    string private constant _symbol = "PIXIE_TESTFINAL";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isBot[to], "Your address has been marked as a bot, please contact staff to appeal your case.");
    ...
    function initContract(address payable feeAddress) external onlyOwner() {
        ...
        initialLimitDuration = launchTime + (5 minutes); //REMEMBER TO CHANGE
    }
