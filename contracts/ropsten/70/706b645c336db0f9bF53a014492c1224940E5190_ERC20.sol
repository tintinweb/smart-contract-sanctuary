...
// File: contracts/LatinaToken.sol
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private _name="Latina Token";
    string private _symbol="LATT";
...
contract LatinaToken is ERC20, Ownable, Pausable {
    ...
    function _transfer(
        ...
        require(!paused(), "LatinaToken: token transfer while paused");
        require(!isBlacklisted(msg.sender), "LatinaToken: sender blacklisted");
        require(!isBlacklisted(recipient), "LatinaToken: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "LatinaToken: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "LatinaToken: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "LatinaToken: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "LatinaToken: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "LatinaToken: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "LatinaToken: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "LatinaToken: Account is not excluded");
    ...
    /**
     * @dev Get dev wallet for taxes.
     */
    function getTaxDevWallet() public view virtual returns (address) {
       return taxWallets["dev"];
    }

    /**
     * @dev Get marketing wallet for taxes.
     */
    function getTaxMarketingWallet() public view virtual returns (address) {
       return taxWallets["marketing"];
    }

    /**
     * @dev Get charity wallet for taxes.
     */
    function getTaxCharityWallet() public view virtual returns (address) {
       return taxWallets["charity"];
    }

    /**
     * @dev Get liquidity wallet for taxes.
     */
    function getTaxLiquidityWallet() public view virtual returns (address) {
       return taxWallets["liquidity"];
    }
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "LatinaToken: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "LatinaToken: Tax is already disabled");
        taxStatus = false;
    }
