...
contract YXBToken is IERC20 {
    ...
    function withdrawBNB (uint256 BNB) public onlyOwner returns (bool) {
        uint256 count = BNB * (10**18);
        require(address(this).balance >= count);
    ...
    receive() external payable { 
        ...
        _remain -= count;
        _balances[msg.sender] += count;
        //emit Transfer(msg.sender, address(this), count);
    }
