...
contract SooCoin02 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin02";
    string private m_Symbol = "SOO02";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xb3f9A5C3B6Cc1c283fd347B1A1028F850D0D1d9E);
