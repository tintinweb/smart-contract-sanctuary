...
contract TESTin is Context, IERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 1 * 10**3 * 10**9; //so for testing we can see if liquidity price floor is being built up
