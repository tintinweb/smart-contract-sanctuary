...
contract Hatchlingz is ERC721, ERC721Enumerable, Ownable {
   ...
   //should think of a way to be able to properly update all metadata if full image refresh needed, while holding full token -> hatchling mapping
    ...
    bytes32 public testString1;
    bytes32 public testString2;
...
//Testing functions
    ...
    function setTestStrings() public  onlyOwner {
        
        testString1 = keccak256(abi.encodePacked("egg"));
        testString2 = keccak256(abi.encodePacked(_tokenMetadata[1]));
    }
