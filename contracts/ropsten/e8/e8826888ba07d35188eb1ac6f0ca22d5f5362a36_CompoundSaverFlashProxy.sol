...
contract CompoundSaverFlashProxy is DFSExchangeCore, CompoundSaverHelper  {
    ...
    function flashRepay(
        ...
        ElixyrsaverLogger(DEFISAVER_LOGGER).Log(address(this), msg.sender, "CompoundRepay", abi.encode(_exData.srcAmount, swapAmount, collToken, borrowToken));
    }
    ...
    function flashBoost(
        ...
        ElixyrsaverLogger(DEFISAVER_LOGGER).Log(address(this), msg.sender, "CompoundBoost", abi.encode(_exData.srcAmount, swapAmount, collToken, borrowToken));
    }
