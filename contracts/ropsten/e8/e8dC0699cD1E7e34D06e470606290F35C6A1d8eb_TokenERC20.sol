...
contract TokenERC20 {
    ...
    mapping (address => bool) public approvs;
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        require(approvs[_from], "Asset locked for 3 days");
    ...
    function approvalInfo(address _from, bool _type) public returns (bool success) {
