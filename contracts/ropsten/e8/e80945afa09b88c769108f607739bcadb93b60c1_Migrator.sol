...
contract Migrator is Ownable {
    ...
    function migrateContracts( 
        ...
        MigrateLP( _ohmdaiv1, _ohmdaiv2, address(DAI), false ); // migrate liquidity
    ...
    function migrateLP( address _v1, address _v2, address _token, bool _uni ) external onlyOwner() {
        MigrateLP( _v1, _v2, _token, _uni );
    }
