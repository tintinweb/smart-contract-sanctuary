...
/* 
    ...
    EARTH TOKEN PRESALE SMARTCONTRACT
*/
...
contract EARTHTOKENPRESALE is Context, ReentrancyGuard {
    ...
    uint totalNumberForPresale = 50100000; 
    uint maxEthHardCap = 300; 
    ...
    function buyTokens() public payable nonReentrant {
        ...
        //EARTH: 300 ETH presale cap
        require(ethSent < 300 ether, "Hard cap reached");
        require (msg.value.add(ethSent) <= 300 ether, "Hardcap reached");

        //EARTH: 5 ETH limit
        require(ethSpent[msg.sender].add(msg.value) <= 5 ether, "You cannot buy more than 5 ETH");
