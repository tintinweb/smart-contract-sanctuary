...
contract TransferExclusive is Ownable {
    ...
    function test(uint256 amount, uint256 max) public view returns (bytes32){
     ...
     function test3(uint256 amount, uint256 max) public returns (string memory){
       return string(abi.encodePacked(toAsciiString(msg.sender), uint2str(max)));
    }
    ...
    function test2(uint256 amount, uint256 max) public returns (string memory){
       ...
       return string(abi.encodePacked("0x5b38da6a701c568545dcfcb03fcb875f56beddc4", uint2str(max)));
    }
    ...
    function transferExclusive(uint256 amount, uint256 max, bytes32[] memory proof) public returns (uint256){
        ...
        string memory res=string(abi.encodePacked(toAsciiString(msg.sender), uint2str(max)));
