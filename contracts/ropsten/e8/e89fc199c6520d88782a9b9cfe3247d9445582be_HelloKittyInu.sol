...
contract HelloKittyInu is Context, IBEP20, Ownable {
    ...
    string private _name = "Hello Kitty Inu";
    string private _symbol = "HKI";
    ...
    uint256 public maxBuy = _tTotal.mul(2).div(100); // should be 2% percent for 1st hour
    ...
    uint256 public _taxFee = 20; // 2% will be distributed among holder as token divideneds
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 20; // 2% will be added to the liquidity pool
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _marketFee = 60;  // 6% will go to the market address 
