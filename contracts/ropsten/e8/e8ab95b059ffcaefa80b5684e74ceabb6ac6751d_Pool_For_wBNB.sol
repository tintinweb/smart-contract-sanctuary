...
contract Pool_For_wBNB is Ownable {
    ...
    address public tokenAddress = 0xa815309Ed4F95B9B0582b1146A1d68e5e12A16AD;
    
    // TBAKE/BNB LP token contract address
    address public LPtokenAddress = 0x84Ee64540575722621829Af8C238C0239eA4e66c;
    
    // reward rate 108 % per year
    uint256 public rewardRate = 10800;
    ...
    function setLPtokenAddress(address Address) public onlyOwner {
        require(!farmEnabled);
