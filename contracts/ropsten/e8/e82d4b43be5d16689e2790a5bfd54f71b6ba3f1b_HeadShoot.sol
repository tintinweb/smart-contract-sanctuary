...
contract HeadShoot is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        IUniswapV2Router02 _pancakeSwapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //BSC Ropsten
        
        pancakeswapV2Pair = IUniswapV2Factory(_pancakeSwapV2Router.factory())
        .createPair(address(this), _pancakeSwapV2Router.WETH());
        //only utility is to have the pair at hand, on bscscan...
    ...
    */
    ...
    function setWallets(address _dev) public onlyOwner {
        devWallet = _dev;
