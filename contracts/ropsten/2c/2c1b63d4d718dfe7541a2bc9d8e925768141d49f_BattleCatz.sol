...
contract BattleCatz  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0x498532a054f1218b899FcC9e28e1384A403b235F); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x498532a054f1218b899FcC9e28e1384A403b235F); // Ecosystem Wallet
    address payable private devWallet = payable (0xda26a27dc7F7C34C1126561a8157d7B345714Fe3); // dev Wallet
    ...
    string private _name = "BattleCatz ";
    string private _symbol = "$BCZ";
    

    uint256 public _maxWalletToken = _tTotal.div(100).mul(1); //1% for first few mins

    uint256 public _buyLiquidityFee = 20;
    uint256 public _buyDevFee = 20;     //5% 
    uint256 public _buyMarketingFee = 50;   //4.5%
    uint256 public _buyReflectionFee = 10;

    uint256 public _sellLiquidityFee = 30;
    uint256 public _sellMarketingFee = 60;  //10%
    uint256 public _sellDevFee = 30;   //10%
    uint256 public _sellReflectionFee = 30;
