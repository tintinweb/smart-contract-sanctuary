...
// File: eth-token-recover/contracts/EthRecover.sol
...
/**
 * @title EthRecover
 * @dev Allows owner to recover ETH sent into the contract
 */
contract EthRecover is Ownable {

    /**
     * @dev Remember that only owner can call so be careful when use on contracts generated from other contracts.
     * @param ethAmount Number of eth to be sent
     */
    function recoverEth( uint256 ethAmount) public virtual onlyOwner {
...
// File: contracts/token/ERC20/FalconToken.sol
...
/**
 * @title FalconToken
 * @dev Implementation of the FalconToken
 */
contract FalconToken is ERC20Decimals, ERC20Capped, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover, EthRecover, Roles {
