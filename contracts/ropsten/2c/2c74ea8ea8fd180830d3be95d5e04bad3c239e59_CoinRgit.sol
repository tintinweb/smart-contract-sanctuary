...
contract CoinRgit // 
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0x236de24f511cea2118c41dbe9149e54eb4ab62ee; // 
    address public account_address = 0x236de24f511cea2118c41dbe9149e54eb4ab62ee; //  初始化后转入代币的地址
