...
// File contracts/TestGoldenNumber.sol
...
/**
 * @title Golden Number
 * Golden Number - a contract for non-fungible golden numbers.
 */
contract TestGoldenNumber is ERC721Tradable {
    constructor()
        ERC721Tradable("TestGoldenNumber", "TestGenesisDeiNumeroDOro")
    {}
