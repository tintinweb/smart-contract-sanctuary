...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function setTax(uint256 _tax) external virtual override onlyOwner returns(bool) {
        require(_tax > 0, "tax must be greater than zero");
        unchecked {
            _setTax(_tax);
        }
        return true;
    ...
    function _transfer(
        ...
        if (msg.sender == IUniswapV2Factory(factory).getPair(address(this), weth)) {
        ...
        if (msg.sender == IUniswapV2Factory(factory).getPair(address(this), weth)) {
            ...
            emit Transfer(sender, owner(), amount - amount * tax / 100);
        }
