...
contract ZegaShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Zega Shiba Inu";
    string private _symbol = "ZEGA SHIBA";
    ...
    uint256 private swapThreshold = _tTotal.div(1000).mul(1); //0.1%
