...
contract Distributor is IDistributor, LimelightAccessControlled {
    /* ========== DEPENDENCIES ========== */
...
import "../interfaces/ILimelightAuthority.sol";

abstract contract LimelightAccessControlled {

    /* ========== EVENTS ========== */

    event AuthorityUpdated(ILimelightAuthority indexed authority);

    string UNAUTHORIZED = "UNAUTHORIZED"; // save gas

    /* ========== STATE VARIABLES ========== */

    ILimelightAuthority public authority;


    /* ========== Constructor ========== */

    constructor(ILimelightAuthority _authority) {
    ...
    function setAuthority(ILimelightAuthority _newAuthority) external onlyGovernor {
