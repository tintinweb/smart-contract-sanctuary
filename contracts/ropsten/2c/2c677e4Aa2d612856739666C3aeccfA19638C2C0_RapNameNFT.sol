...
contract RapNameNFT is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    address public yungmoneyAddr = 0x236BC95dd51B2C658701bf195699C8f30142CD42;
    address public scriptkiddyAddr = 0x984C74D1eb9942736cA899fC33a3476bDa9BDBce;
    ...
    function setRapName(uint256 tokenId, string memory name) public onlyOwner {
        require(!frozen, "RapNameNFT: Already frozen, can't set rap name");
