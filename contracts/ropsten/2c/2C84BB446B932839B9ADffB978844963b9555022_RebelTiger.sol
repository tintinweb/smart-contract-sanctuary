...
contract RebelTiger is ERC721, Ownable, PaymentSplitter {
    ...
    uint256 constant MAX_SUPPLY_SHIFTED = 7778; // total number of purchasable tigers is 7777
    uint256 constant NUM_TIGERS_SHIFTED = 8001; // total number of tigers is 8000 including gifts
    ...
    address[] private teamAddresses = [
        ...
        0x4f46b417e07b513Db5eeeFA97a2A09219006c01E, // CEO
    ...
    function mintPreSale(uint256 amount, bytes32[] calldata merkleProof) external payable {
        ...
        require(currentId + amount < MAX_SUPPLY_SHIFTED, "RTC: Purchasable NFTs are all minted.");
