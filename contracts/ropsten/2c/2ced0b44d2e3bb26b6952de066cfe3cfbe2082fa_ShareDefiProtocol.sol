...
contract ShareDefiProtocol is Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual returns(uint256) {
        ...
        _transfer(msg.sender,_team, amountBuyTax);
        
        remainingAmount = amount-amountBuyTax;
         _transfer(recipient, msg.sender, remainingAmount);
        ...
        _transfer(msg.sender,_team, amountSellTax);
        
        remainingAmount = amount-amountSellTax;
         _transfer(msg.sender,recipient, remainingAmount);
