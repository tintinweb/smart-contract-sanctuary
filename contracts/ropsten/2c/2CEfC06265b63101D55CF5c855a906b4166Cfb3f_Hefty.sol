...
contract Hefty is ERC721Enumerable, Ownable{
    ...
    function preSale(uint256 numberOfTokens, bytes32[] memory proof) external payable {
        ...
        require(proof.verify(merkleRoot, keccak256(abi.encodePacked(msg.sender))), "You are not in the whitelist");
