...
contract ERC721 is Context, ERC165, IERC721 {
    ...
    enum STATUS{BASIC, SALE, AUCTION}
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        ...
        require(tokenStatus[tokenId] == STATUS.BASIC, "ERC721: token is on Sale or Auction");
...
contract ERC721Base is HasSecondarySaleFees, ERC721, HasContractURI, HasTokenURI, ERC721Enumerable {
    ...
    function getRoyaltyFee(uint256 id) public view returns (uint256) {
        return fees[id][0].value;
    }

    function getRoyaltyAddress(uint256 id) public view returns (address payable) {
        return fees[id][0].recipient;
    }
...
contract SingleToken is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
    ...
    address public signer = 0xa3A6064A20700e4ed956569190345094Bf4af370;
