...
contract TokenSale {
    ...
    function sellTokens0(uint256 numberOfTokens) public {
        ...
        require(tokenContract.balanceOf(msg.sender) >= scaledAmount);
     ...
     function sellTokens2(uint256 numberOfTokens, address ad) public view returns(bool) {
         uint256 scaledAmount = numberOfTokens *
            (uint256(10) ** tokenContract.decimals());
        require(tokenContract.balanceOf(ad) >= scaledAmount);
        return true;
    }
