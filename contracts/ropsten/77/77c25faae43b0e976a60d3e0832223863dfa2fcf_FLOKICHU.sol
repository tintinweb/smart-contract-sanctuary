...
/*
 * Copyright 2021 FLOKIMON. ALL RIGHTS RESERVED.
 */
...
contract FLOKICHU is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x55E693Ae7424FdF4c6a0538f2EF6f1D147e2Ca69); // Marketing Wallet
    address payable public teamWallet = payable (0x34F5329991528cf82C586BB0804c51ffBb60Ccc2); // Team Wallet
    ...
    string private _name = "flchu_test";
    string private _symbol = "FLCHU_test";
    ...
    uint256 public totalFee =
        liquidityFee.add(marketingFee).add(teamFee);
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //Send to marketing wallet and team wallet
        uint256 contractETHBalance = address(this).balance;
        if(contractETHBalance > 0) {
            sendETHToFee(amountETHMarketing,marketingWallet);
            sendETHToFee(amountETHteam,teamWallet);
        }
