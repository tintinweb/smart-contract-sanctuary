...
contract IDO is Ownable{
    ...
    constructor() public {
        ...
        startHeightOfPubIEO = endHeightOfPriIEO;
    ...
    function initEnvForPri(uint256 startH,uint256 endH,uint256 unlockH, uint256 supplyYou) inWhiteList external{
    ...
    function initEnvForPub(uint256 startH,uint256 endH,uint256 unlockH, uint256 targetU,uint256 targetYou) inWhiteList external{
    ...
    function privateOffering(uint256 amountOfYou) inWhiteList external returns (bool)  {
        ...
        uint256 amountOfUsdt = amountOfYou*youPriceOfPriIEO*10**17 /10**6;
