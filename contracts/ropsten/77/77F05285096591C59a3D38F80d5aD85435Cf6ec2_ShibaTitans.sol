...
contract ShibaTitans is ERC721Enumerable, EIP712, Ownable {
    ...
    function mint(uint256 n) public payable {
        ...
        require(n <= 10, "Too many tokens");
        require(msg.value >= tokenPrice * n, "Didn't send enough ETH");
        require(totalSupply() + n <= maxTokens, "Can't fulfill requested tokens");
        require(totalSupply() + n <= batchCap, "Can't fulfill requested tokens");
