...
contract Stake is  Ownable{
    ...
    function TVL() public view returns (uint256 tvl){
        return totalStake;
    }
    
    function getStakerERC() public view returns (bool , uint256 , uint256 , uint256){
        return  (stakerERC[msg.sender].isExist, stakerERC[msg.sender].stake , stakerERC[msg.sender].stakeTime , stakerERC[msg.sender].harvested );
    }
    
    function getStakerLP() public view returns (bool , uint256 , uint256 , uint256 , address){
        return  (stakerLP[msg.sender].isExist, stakerLP[msg.sender].stake , stakerLP[msg.sender].stakeTime , stakerLP[msg.sender].harvested, stakerLP[msg.sender].LPtoken );
