 ...
 */
contract SRQuarry5 is ERC721Enumerable, IERC2981, Ownable, ReentrancyGuard {
    ...
    address private dev2 = 0xb79CC2409231d0647aED3cB1C4A44154E9e327A4;
    address private creator = 0x5dfD9Ebaf998EDc9d85291e1AF4b2ebF7e2Aae4B;
    address private community = 0x41cF69033470843fe53A10a36678348EaF474033;
    address private marketing = 0x436736639eaACdC344Db6aAe2679858BF419D748;
    address private expenses = 0xC3A289a4A4576DA6DA2414B70df7efb367Ea8C89;
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(community, split3);

        uint256 split4 = (balance * 10) / 100;
        _widthdraw(marketing, split4);

        uint256 split5 = (balance * 5) / 100;
        _widthdraw(expenses, split5);

        uint256 split6 = address(this).balance;
        _widthdraw(creator, split6);

        emit SplitsWithdrawn(
            [dev1, dev2, community, marketing, expenses, creator],
    ...
    {
        return (address(this), (salePrice * 500) / 10000); // 5%
    }
