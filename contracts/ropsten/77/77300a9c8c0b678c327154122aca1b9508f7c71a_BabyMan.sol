...
/**
 * @title BabyManStandard
 * @dev the interface of BabyManStandard
 */
contract BabyManStandard {
...
contract BabyMan is ERC20,BabyManStandard,Ownable {
    using SafeMath for uint256;

    string public name = "BabyMan";
    string public symbol = "MANB";
