...
contract AdeelaTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AdeelaTestCoin() {
        ...
        name = "AdeelaTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT2018-01";                                             // Set the symbol for display purposes (CHANGE THIS)
