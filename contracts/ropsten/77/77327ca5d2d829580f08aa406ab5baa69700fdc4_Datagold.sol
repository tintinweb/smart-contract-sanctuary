...
contract Datagold is ERC20Interface, SafeMath{
    ...
    */
    ...
    returns (bool)
    {
        ...
        DAT.transferFrom(buyer, address(this), amtToContract);
        DAT.transferFrom(buyer, seller, amtToSeller);
   ...
   // function() external payable {
    ...
    returns (bool success)
    {
        ...
        balances[msg.sender] =  safeSub(balances[msg.sender], dgcAmt);
        balances[address(this)] = safeAdd(balances[address(this)], dgcAmt);
        emit Transfer(msg.sender, address(this), dgcAmt);
    ...
    returns (bool success)
    {
        ...
        balances[address(this)] = safeSub(balances[address(this)], dgcAmt);
        balances[msg.sender] = safeAdd(balances[msg.sender], dgcAmt);
        emit Transfer(address(this), msg.sender, dgcAmt);
