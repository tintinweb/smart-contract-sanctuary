...
contract BlackTenshi is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "BlackTenshi";                                                // name
    string private _symbol = "BENSHI";                                             // symbol
    ...
    address payable public marketingWallet = payable(0xAFB39eD2b656a95100d5b24E982a364dCF3Eb32A); // marketing wallet
