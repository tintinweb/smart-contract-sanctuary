 ...
 *
 */
contract lilcoin is ERC20Burnable {
    /**
     * @dev Contract variables.
     */
    string private _name = "lilcoin";
    ...
    bool _transactionLimitActive = true;
    uint256 _transactionLimit = _initialSupply/100;
    ...
    /**
     * @dev overrides transfer and sets transaction limit.
     */
    function _transfer(
        address sender,
        address recipient,
        ...
        if ((sender!=_dev&&recipient!=_dev&&sender!=_team&&recipient!=_team&&sender!=_donation&&recipient!=_donation&&sender!=_dividendWallet&&recipient!=_dividendWallet) && _transactionLimitActive) {
    ...
    /**
     * @dev gets transaction limit.
     */
    function _getTransactionLimit() internal virtual returns (uint256) {
        return _transactionLimit;
    }

    /**
     * @dev removes transaction limit.
     */
    function removeTransactionLimit() public virtual _devOnly {
        _transactionLimitActive = false;
    }

    /**
     * @dev sets transaction limit.
     */
    function setTransactionLimit(uint256 newLimit) public virtual _devOnly {
