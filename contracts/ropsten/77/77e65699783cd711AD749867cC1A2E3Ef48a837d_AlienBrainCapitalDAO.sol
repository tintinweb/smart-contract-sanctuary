...
ALIEN BRAIN CAPITAL DAO 

https://www.AlienBrainDAO.com

https://t.me/AlienBrainCapitalDAO
...
contract DividendDistributor is IDividendDistributor {
        ...
        returns (uint256)
    {
        require(
            ...
            "You're not a ABCD shareholder!"
        );
        return shares[shareholder].totalClaimed;
    }
}

contract AlienBrainCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _name = "Alien Brain Capital DAO";
    ...
    address payable public marketingWallet =
        payable(0xdC12ea64fbe3A96a4AC47113F63E42d6de162A77);
    ...
    constructor() Auth(0xdC12ea64fbe3A96a4AC47113F63E42d6de162A77) {
        address _owner = 0xdC12ea64fbe3A96a4AC47113F63E42d6de162A77;
    ...
    function _transferFrom(
        ...
        bool shouldSwapBack = (recipient == pair && /*!inSwap &&*/
