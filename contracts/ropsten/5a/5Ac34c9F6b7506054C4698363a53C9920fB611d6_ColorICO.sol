 ...
 **/
contract ColorICO is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public constant RATE = 3000; // Number of tokens per Ether
  uint256 public constant CAP = 5350; // Cap in Ether
  uint256 public constant START = 1632673068; // Sep 26, 2021
  uint256 public constant DAYS = 45; // 45 Day
  
  uint256 public constant initialTokens = 740465500 * 10**18; // Initial number of tokens available that 10 million 
   ...
   **/
  function Color_ICO(address _tokenAddr) public {
