...
contract SwampGoldTest is Context, Ownable, ERC20 {
    address public lootContractAddress =
        0xD2F15DBf80F16aA8AC277E8336202E25d5A13D0c;
    IERC721Enumerable public lootContract;

    // Give out 7,000 Adventure Gold for every Loot Bag that a user holds
    ...
    */
    ...
    constructor() Ownable() ERC20("Swamp Test", "SGLDTEST2") {
    ...
    /// @param SwampGoldTestDisplayValue The amount of Loot a user can claim.
    ...
    /// SwampGoldTest variables directly. It is better practice for security,
