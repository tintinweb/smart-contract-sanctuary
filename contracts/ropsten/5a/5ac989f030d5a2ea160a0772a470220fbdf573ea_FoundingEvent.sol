...
contract FoundingEvent {
	...
	function _createLiquidity() internal {
        ...
        address pair = I(factory).getPair(_letToken,WFTM); if (pair == address(0)) {pair=I(factory).createPair(_letToken, WFTM);}
		pair = pairFor(factory, _letToken, WFTM);
        ...
        assert(I(WFTM).transfer(pair, address(this).balance));
