...
contract SmartEdMatrix {
    ...
    function userDetails() public view returns(uint256, uint256){
        return(users[msg.sender].dividends,users[msg.sender].totalwithdrawn);
    }
    ...
    function getdividends() public returns(uint256){
        //require(matrix == 1||matrix == 2,"invalid Matrix");
        uint256 amount;
