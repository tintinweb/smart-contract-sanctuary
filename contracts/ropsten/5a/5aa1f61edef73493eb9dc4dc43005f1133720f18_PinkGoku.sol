...
contract PinkGoku is Context, IERC20, Ownable {
    ...
    uint256 public _buyBackFee=0;// meanse 8% bnb to marketing Wallet

    uint256 public _tokenFee=0; //2% tokens to the wallet

    

    address tokenFeeAddress=0x5d977e32Ba21C438588F910651C90EA70c1CcD1B;  //dummy address

    address marketingAddress=0x5d977e32Ba21C438588F910651C90EA70c1CcD1B;  //dummy addresss Bnb ADdress
