...
Telegram: @dogpoundtg
Twitter: @dogpound
Website: dogpound.com
Whitepaper: dogpound.com/wp

** Secured With FTPAntibot **
** Using FTP ILO to provide up to 25.00% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x9000ab6dB5d47C58b424Ef91Ea9136D19d55106c), 100);
        m_DidDeploy = true;
    }
...
contract dogpound is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "dog pound";
    string private m_Symbol = "DOGS";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 25000, 25000, m_ILOPublic);
        initTax();
