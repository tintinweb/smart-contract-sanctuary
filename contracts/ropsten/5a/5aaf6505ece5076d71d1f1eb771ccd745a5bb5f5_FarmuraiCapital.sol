...
contract FarmuraiCapital is Context, IERC20, Ownable {
    ...
    address payable public _mgcAddress = payable(0x6e937840D62ED53Fa6C194bf6c691a5e7f9359B7); //this is the multichain investment wallet
    ...
    uint256 public _maxTxAmount = 4500 * 1e3 * 1e7 * 1e9; //max transaction set to 4.5%
    uint256 public _maxWalletSize = 4500 * 1e3 * 1e7 * 1e9; //max wallet set to 4.5%
    uint256 public _swapTokensAtAmount = 5000 * 1e3 * 1e6 * 1e9; //amount of tokens to swap for eth 0.5%
