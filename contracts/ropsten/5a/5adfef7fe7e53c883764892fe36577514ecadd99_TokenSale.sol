...
interface stake {
    function yourStakedCLOCK(address staker) external returns(uint256 stakedCLOCK);
}
...
contract TokenSale is Owned{
    ...
    uint256 public price = 14;              // 1eth = 14 tokens
    uint256 public decimals = 18;
    
    stake public clockStake;
    ...
    constructor(IERC20Token _tokenContract, uint256 _maxEthAmount) {
        ...
        minStaked = 5000000000000000000;
        clockStake = stake(0x90C2B592C45b7EfC2D9F303D5BB7BbC9Bd40a206);
    }
    ...
    function changeStakeContract(stake newStake) external onlyOwner{
        clockStake = newStake;
    }
    
    function changeMinStaked(uint256 _minStaked) external onlyOwner{
    ...
    function buyTokensWithETH(address _receiver) public payable {
        ...
        uint256 stakeAmount = clockStake.yourStakedCLOCK(msg.sender);
        require(stakeAmount >= minStaked, "Error: your staked amount is lesser");
