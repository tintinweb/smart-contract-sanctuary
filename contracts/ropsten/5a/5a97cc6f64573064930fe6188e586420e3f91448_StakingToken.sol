...
contract Owned {
  ...
  contract StakingToken is ERC20, Owned {
    constructor(uint256 intialsupply)   ERC20("stake", "STK") Owned(msg.sender){
        _mint(msg.sender, intialsupply) ;
        
    }
    function burn(address spender, uint256 amount)internal onlyOwner {
