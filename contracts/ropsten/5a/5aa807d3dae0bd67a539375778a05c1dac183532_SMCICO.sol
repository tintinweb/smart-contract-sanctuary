 ...
 */
 //define the name of our coin 
contract SMC is ERC20Interface{
    ...
    // tokens available that the onwer allow spender to withdraw
    ...
    */
    ...
    /*
    The following steps are used to move tokens, but those tokens don’t necessarily need to belong to the person calling the contract. 
    */
...
/*
As an investor, I want to send ETH to token's contract address and get the SMC token 
...
contract SMCICO is SMC{
    ...
    uint tokenPrice = 0.001 ether; //1 SMC = 0.001ETH or 1ETH = 1000SMC
    uint public hardCap = 10000 ether; //Max amount
    
    uint public raisedAmount; //Total amount of ETH sent to ICO
    uint public saleStart = block.timestamp;
    uint public saleEnd = block.timestamp + 1296000; //ICO ends in half a month
    ...
    */
    ...
    It is possible that the ICO has recived less than 300ETH, and the rest of the tokens are in the token owner 
