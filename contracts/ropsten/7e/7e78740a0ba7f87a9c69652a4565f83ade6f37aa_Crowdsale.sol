...
contract Crowdsale {
  ...
  // Max crowdsale
  uint256 public maxCrowdSale = 200000000;
   ...
   */
    ...
    internal
    {
      ...
      MintableToken(token).updateInvestAmount(_beneficiary, _tokenAmount);
    }
    ...
    internal view returns (uint256)
  {
    ...
    //uint256 valueUSD = _weiAmount.div(usdRate);

    //return _weiAmount.mul(rate);
    return (_weiAmount.mul(4)).div(usdRate.mul(100));
  }
