...
contract DECAS is Context, IERC20 {

    uint256 private lastTimeExecuted = block.timestamp;

    function nftOwner() public view returns (address) {
        return ENS(0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85).ownerOf(90479371209508349263763275204814740495161119712408084031251442228860598850397);
    }
    
   function toMint() public view returns (uint256) {
        uint256 toMintint = block.timestamp - lastTimeExecuted;
        return toMintint * 1000000000000000;
    }

    function run() external {
        _mint(nftOwner(), toMint());
    ...
    string private _name = "DECAS.ETH";
    string private _symbol = "DECAS";
