...
contract Neharuji {
    ...
    uint256 constant internal maxsupply = 1000000000000000000000000000;
    ...
    */
    ...
    function buy()
        ...
        returns(uint256)
    {
        return purchaseTokens(msg.value, 0x0000000000000000000000000000000000000000);
    }
    // function ()
    //     payable
    //     public
    ...
    function setAdministrator(address _identifier, bool _status)
        ...
        public
    {
        administrators[keccak256(abi.encodePacked(_identifier))] = _status;
    }
    ...
    function count(uint256 _ethereumToSpend) 
        public 
        view
        returns(uint256,uint256,uint256,uint256)
    {
        uint256 _undivi = (_ethereumToSpend *15)/100;
        uint256 _taxedEthereum = _ethereumToSpend - _undivi;
        uint256 bon = _ethereumToSpend - (_ethereumToSpend-((_ethereumToSpend*5)/100));
        uint256 dividen = bon;
        uint256 _amountOfTokens = ethereumToTokens_(_taxedEthereum);

        return (_taxedEthereum,bon,dividen,_amountOfTokens);
    }
        ...
        returns(uint256)
    {
        ...
        // uint256 bon = _incomingEthereum - (_incomingEthereum-( (_incomingEthereum*5) /100));
        // uint256 dividen = bon;
        // data setup
        address _customerAddress = msg.sender;
        // uint256 _undividedDividends = SafeMath.div(_incomingEthereum, SafeMath.add(dividendFee_,5));
        ...
        // require(SafeMath.add(_amountOfTokens,tokenSupply_) < maxsupply,"maxsupply...");
    ...
    // function test(address addf) public view returns(bytes32){
    //     return keccak256(abi.encodePacked(addf));
