...
// ######################
    ...
    // Send & Read MishkaChat Functionality
    ...
    function aaaReadMessage(address sentFromAddress, address sentToAddress) external view returns (string memory) {
        return m_Chat[sentToAddress].m_Message[sentFromAddress];
    }
