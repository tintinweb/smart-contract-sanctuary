...
// File: contracts\lib\prb-math\PRBMathCommon.sol
...
//        }
    ...
    /// @notice Calculates floor(x*y├Àdenominator) with full precision.
    ///
...
//        }
    ...
    /// @notice Calculates floor(x*y├À1e18) with full precision.
    ///
...
//        }
        ...
        // Compute the absolute value of (x*y)├Àdenominator. The result must fit within int256.
...
// File: contracts\lib\prb-math\PRBMathUD60x18.sol
