...
contract RewardManagement is Ownable{
    ...
    uint256 constant ONE_MONTH_TIME                 = 60;//2592000;                              // seconds for one month
    uint256 THREE_MONTH_PRICE                       = 20 * 10**4; //20 * 10**6;             // 40 USD
    uint256 CLAIM_FEE                               = 5 * 10**4;  //5 * 10**6;              // 5 USD
    ...
    constructor(FireToken tokenContract, FireNFT nftContract) { 
        ...
        _joe02Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); /// test ----
        _usdcToken = IERC20(0x07865c6E87B9F70255377e024ace6630C1Eaa37F);  /// test----
    ...
    function addLiquidity(uint256 tokenAmount, uint256 avaxAmount) private {
        ...
        // test ---
        _joe02Router.addLiquidityETH{value: avaxAmount}(
