...
contract Pool {
    ...
    address private InvestmentToken; // this would be marked address(0) if ether is supported
    ...
    uint256 _startDate, uint256 _endDate, address[10] memory _whitelisted, 
    uint256 _token
    ) public{
