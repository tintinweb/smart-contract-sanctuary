...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract TestPOIS is ERC20, Ownable {
        using SafeMath for uint256;
    ...
    string private    _name = "TestPOIS";
    string private  _symbol = "POISV3";
    ...
    address payable marketingWallet = payable(0x19E271898513fF09249D298832D3c55C8f3d7309);
    address payable deployerWallet = payable(0xf0Ae076B7D3Bdc9f4bd711e008d67961709FDc2a);
    address payable developmentWallet = payable(0xF875E11158eC932D2AF3508341c324598Edc6074);
    ...
    constructor () ERC20("TestPOIS", "POISV3", 9) {
