...
contract BettingMonkey is Owned {
    ...
    function bet(uint _selectedTeam) public payable {
        ...
        require(!checkPlayerExists(msg.sender), "Player has already bet");
        // Condition 2. bet > minimumBet
        require(msg.value >= minimumBet, "Need to bet an amount > minimumBet");
        // Make sure _selectedTeam is ether 1 or 2
        require(_selectedTeam == 1 || _selectedTeam == 2, "We only have 2 team");
