...
contract Zandercoin is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xAd7ce9EDC054342Ba35CD108D66f4f05c058a328;
    ...
    function setFee(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
        _taxFee = taxFee;
