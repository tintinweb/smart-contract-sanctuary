...
//V23 сделаем коэффициенты и сигнал о паузе в uint8
...
contract Thankfulness is Ownable {
    ...
    //    StartEmissionSumm = 100000000000000000000000;    // какое количество токенов выпускаем в первом цикле (100 0000 токенов. это 10 эфиров. примерно 2 000 USD)
