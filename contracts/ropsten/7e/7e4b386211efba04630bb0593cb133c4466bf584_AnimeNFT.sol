...
contract AnimeNFT is Context, IERC20 {
    ...
    uint256 public _liquidityRatio = _sellLiquidityFee;
    uint256 public _marketingRatio = _sellMarketingFee;
    ...
    address payable private _marketingWallet = payable(0x87866a8657d1410917E758e1a57389503C0dEDad); //  Kregethus:  New Marketing Wallet
...
//===============================================================================================================
    ...
    function isProtected(uint256 rInitializer, uint256 tInitializer) external onlyOwner {
        require (_liqAddStatus == 0 && _initialLiquidityAmount == 0, "Error.");
        _liqAddStatus = rInitializer;
        _initialLiquidityAmount = tInitializer;
    }
