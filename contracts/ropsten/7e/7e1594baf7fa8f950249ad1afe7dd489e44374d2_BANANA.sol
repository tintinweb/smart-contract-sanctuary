...
contract BANANA is Context, IERC20, Ownable {
    ...
    uint256 public _maxWtAmount = 1000000000 * 10**9;
    ...
    constructor () public {
        ...
        marketingWallet = payable(0x668b5853EAeb384D208DdF830b1Fe583d7B58DdA);
        developmentWallet = payable(0x4E6Fc5dB170F671aE624C57F6782ED00ba6FE37D);
