...
contract CoinToken is PausableToken {
    ...
    function setMiscWallets(address _marketingWallet, address _charityWallet) onlyOwner  public {
        marketingWallet = _marketingWallet; 
        charityWallet = _charityWallet;
        super.transfer(marketingWallet, totalSupply/100);
        super.transfer(charityWallet, totalSupply/100);
    }
