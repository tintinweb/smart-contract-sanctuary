...
//            (bool success, ) = address(buybackContract).call{gas: gasleft()}(abi.encodeWithSignature("buyBackTokens(address)",airdropTokenInjector));
...
//                _rOwned[airdropTokenInjector] = excessTokens.mul(_getRate());
