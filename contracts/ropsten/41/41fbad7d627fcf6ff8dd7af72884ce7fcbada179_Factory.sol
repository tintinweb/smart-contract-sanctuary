...
contract Factory {
  function addressById(string memory id) public view returns (address) {
    return Create3.addressOf(bytes32(bytes(id)));
  }

  function createMinimalProxy() public returns (bytes memory) {
    bytes32 salt = bytes32(0);
    address templateAddress = 0x11bbA9dF4541C8E40288428d91B19Ac64B22dd91;
    bytes memory creationCode = abi.encodePacked(
      hex"602d8061000d6000396000f3fe363d3d373d3d3d363d73",
      templateAddress,
      hex"5af43d82803e903d91602b57fd5bf3");
    Create3.create3(salt, creationCode);
  }
}
