    ...
    ERC20Burnable
{
    ...
    string constant private _symbol = "OST";
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "OST/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "OST/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "OST/approve : Should not approve zero address"
        );
