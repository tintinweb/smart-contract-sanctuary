...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x898F33d4F328424a526Ef24aCA71A511F11c2491), 4000);
        m_DidDeploy = true;
    }
...
contract afadf is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "afadf";
    string private m_Symbol = "daf";
