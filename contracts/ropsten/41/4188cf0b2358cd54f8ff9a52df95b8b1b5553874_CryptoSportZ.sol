...
contract CryptoSportZ is Owned, Functional
{
	...
	event LogBettor(uint gameId, address indexed bettor, uint amount, address indexed signer);	
	...
	function deal(uint[2] market, bytes32 r, bytes32 s, uint8 v) public payable
	{
		...
		emit LogBettor(m.gameId, msg.sender, msg.value, signer);	
