...
contract TokenDispenserSeed is TokenDispenserBase {
    ...
    uint public constant d1rate = p1VestRatio / 12 hours;
    uint public constant d2rate = p2VestRatio / 12 hours;
    ...
    constructor (address kine_, uint startTime_) public {
        ...
        phase2EndTime = startTime_.add(24 hours);
    }
