...
contract SooCoin2 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin2";
    string private m_Symbol = "SOO2";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 10000, 5000, 10000, m_ILOPublic);
        initTax();
