...
contract OpenPresale is Pausable {
    ...
    // lock end time
    uint256 public tokenLockEndTime         = 1534564800;

   


    //2500  tokens per 1 ETH
    ...
    function() public payable isInSaleTime isCanSold isOnSale whenNotPaused freezeable(msg.sender){
