...
contract RealV2 {
   ...
   function setReal(address payable _owner_1, uint256 _value ,uint _id, bytes16 _md5_hash_picture) payable public {
       
      newReals.push( new NewReal(_owner_1, _value, _id, _md5_hash_picture));
...
contract NewReal{
   ...
   function getThisContractAddress() public view returns (address payable) {
    
    return address(this);
   }
   
   function setUnavailable() public payable {
