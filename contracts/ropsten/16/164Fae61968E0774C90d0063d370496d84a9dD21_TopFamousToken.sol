...
// TopFamousToken - Stealth launch - No TG, No Website, No Marketing
...
contract TopFamousToken is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x94fcE8B94eFae56bd0b4417919fa56D4B984144b);
        _feeAddrWallet2 = payable(0x94fcE8B94eFae56bd0b4417919fa56D4B984144b);
    ...
    function _getTValues(uint256 tAmount, uint256 feeAddr1, uint256 TeamFee) private pure returns (uint256, uint256, uint256) {
        uint256 tFee = tAmount.mul(feeAddr1).div(100);
