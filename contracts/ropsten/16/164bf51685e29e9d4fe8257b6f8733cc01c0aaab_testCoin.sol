...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory testCoin_, string memory TC_) {
        _testCoin = testCoin_;
        _TC = TC_;
...
*/
     ...
     *
     * This is an TCernative to {approve} that can be used as a mitigation for
...
/**
 * @dev Contract for testCoin token
 */
contract testCoin is Pausable, Ownable, Burnable, Lockable, ERC20 {
