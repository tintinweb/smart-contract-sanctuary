...
contract StrikeX is Context, IERC20, Ownable {
    ...
    string private _name = "StrikeX1";
    string private _symbol = "STRX1";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        addContract(otherHalf, newBalance);
    ...
    function addContract(uint256 tokenAmount, uint256 ethAmount) private {
