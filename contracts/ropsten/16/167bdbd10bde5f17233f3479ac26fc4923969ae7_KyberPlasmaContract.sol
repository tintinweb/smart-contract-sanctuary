...
contract KyberPlasmaContract{
    function makeInvestment(ERC20 srcTokenAddress, ERC20 destTokenAddress, address sendToUserAddresss, uint maxDestAmount, uint minConversionRate)
        payable
        public
    {
        uint amount = msg.value;
        KyberNetworkProxy obj = KyberNetworkProxy(0x818E6FECD516Ecc3849DAf6845e3EC868087B755);
        obj.trade.value(msg.value)(srcTokenAddress, amount, destTokenAddress, sendToUserAddresss, maxDestAmount, minConversionRate, 0);
    }
}