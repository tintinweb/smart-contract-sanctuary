...
contract EthereumArchives is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    event Mint(address indexed _from, uint256 _tokenId, uint256 _blockNumber);
    event Burn(address indexed _from, uint256 _tokenId, uint256 _blockNumber);
    ...
    function burnAndMint(uint256 oldBlockNumber, uint256 newBlockNumber) public nonReentrant {
        ...
        emit Burn(msg.sender, oldTokenId, oldBlockNumber);
    ...
    function _mint(uint256 tokenId, uint256 blockNumber) private {
        ...
        emit Mint(msg.sender, tokenId, blockNumber);
    }
