...
contract GovernorAlpha {
    ...
    function votingPeriod() public pure returns (uint) { return 60; } // ~40 minutes in blocks

    /// @notice The address of the Uniswap Protocol Timelock
    TimelockInterface public constant timelock = TimelockInterface(0x9aC9e6ca2F55949B568021e3c27A44d1B99EFF62);

    /// @notice The address of the Uniswap governance token
    UniInterface public constant uni = UniInterface(0x07284122ac3c6937511bD5791E594eaf7d3482a5);
