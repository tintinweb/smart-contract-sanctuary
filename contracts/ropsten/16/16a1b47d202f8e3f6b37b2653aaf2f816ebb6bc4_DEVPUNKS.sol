...
contract DEVPUNKS is Ownable, ERC721 {
    ...
    uint public _mintFee = 0.00008 ether;
    ...
    constructor() payable ERC721("DEV Punks", "DEVPUNKS") {}
    ...
    function _mint(uint _punkId, address to) internal {
        ...
        require(!_exists(_punkId), "DEVPUNK already minted");
