...
interface IHPoolFactory {
    function deployHPool(uint256 hPoolId, address championAddress, IUniswapV2Router02 uniswapRouter) external returns (address);
}
...
contract HPoolManager is ERC1155HolderUpgradeable, HordUpgradable {
        ...
        onlyMaintainer
    {
        ...
        IHPool hpContract = IHPool(hPoolFactory.deployHPool(poolId, hp.championAddress, uniswapRouter));
