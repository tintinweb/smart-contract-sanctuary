...
contract Owned {
    ...
    constructor()  {
        owner = 0x15F52E64a3B925A2C48d68A93D6410163B6d2272;
    }
...
contract ZeroDollarCoin is IERC20, Owned, SafeMath {
 ...
 constructor() {
    ...
    // ------------------------------------------------------------------------
    //uint8 public multi = 1;
    
    //function changemulti() public virtual onlyOwner {multi = 2;}
