...
contract CSDCrowdsale is Context, ReentrancyGuard, Ownable {
    ...
    uint256 public maxAmountToBuyPerTransaction = 10**7 * 10**9;
    uint256 public maxAmountToSell = 5 * 10**7 * 10**9;
    ...
    constructor (uint256 tokenrate, address payable fundswallet, IERC20 tokenAddress) {
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        return weiAmount.div(1e9).mul(_rate);
    }
