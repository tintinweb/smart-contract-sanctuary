...
contract TetsuInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _marketingFeeAddr = payable(0x3fdDD9790290e6126b00b047818D30d9504AAe1B); // multisig requiring 3/4 signatures for transaction
        _devFeeAddr = payable(0xd8B924446A4Ef94Ec1Dab5BA54bAe70674bAe484);       // multisig requiring 4/4 signatures for transaction
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_marketingFeeAddr] = true;
        _isExcludedFromFee[_devFeeAddr] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // taxes 20% on sells that occur within 24h of buy time
            if (_buyMap[from] != 0 &&
