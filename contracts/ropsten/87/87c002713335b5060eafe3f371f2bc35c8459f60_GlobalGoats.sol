...
contract GlobalGoats is ERC721Enumerable, Ownable {
    ...
    string private _metaBaseUri = "https://globalgoats.io/meta/";
    ...
    // function reserveGoldenGoatsMint(uint16 tokenId , address _toAddress) external onlyOwner {
    //     require(goldenGoatsCount.add(1) <= MAX_MintedGoldenGoats, "Cannot mint more Golden goats");
