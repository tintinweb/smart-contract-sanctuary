...
contract LightYagamiInu is Context, IERC20, Ownable, VRFConsumerBase {
    ...
    string private constant _name = "Light Yagami Inu | https://t.me/lightyagamiinu";
    string private constant _symbol = "LYAGAMI";
    ...
    function attemptLottery()  private  {
        ...
        if (LINK.balanceOf(address(this)) > (2 * 10 ** 18)) {
            ...
            lotteryBuybackTime = block.timestamp + (4 hours);
        }
    }
