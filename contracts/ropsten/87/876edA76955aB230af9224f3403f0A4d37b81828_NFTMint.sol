...
contract ERC721{
    ...
    event OrderCancel(address indexed from, uint256 indexed tokenId);
    event PriceChange(address indexed from, uint256 indexed tokenId, uint256 indexed value);
     // Token name
...
abstract contract Sale is ERC721, Ownable{
   ...
   // mapping (uint256 => address) public _tokenOwner;
    ...
    function cancelOrder(uint256 tokenId) public{
        ...
        emit OrderCancel(msg.sender, tokenId);
    }
    function changePrice(uint256 value, uint256 tokenId) public{
        ...
        emit PriceChange(msg.sender, tokenId, value);
    }
