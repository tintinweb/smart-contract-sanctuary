...
contract BIO is TRC20("BITONE", "BIO") {
    ...
    function burn(address account, uint256 amount) public  permissionCheck returns (bool) {
        _burn(account, amount);
        return true;
    }

    function mint(address account, uint256 amount) public  permissionCheck returns (bool) {
