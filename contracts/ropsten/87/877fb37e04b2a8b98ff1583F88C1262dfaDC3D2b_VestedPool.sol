...
contract VestedPool is Pool {
    ...
    function nextClaimingAt() public view returns (uint256) {
    ...
    {
        return (allocations[wallet].amount, allocations[wallet].claimed, remained(wallet), getClaimableTokens(wallet), canClaim(wallet), nextClaimingAt());
    }
}
