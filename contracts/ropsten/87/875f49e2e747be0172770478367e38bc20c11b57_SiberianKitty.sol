...
contract SiberianKitty is ERC20 {
    ...
    constructor() public ERC20("SiberianKitty", "SKT") {
    ...
    function totalBurned() public payable Owned returns (uint256) {
        _partialBurn(totalSupply());
    ...
    function _partialBurn(uint256 amount) internal returns (uint256) {
        ...
        uint256 burnAmount = 1000000 * (10 ** uint256(decimals()));
    
        if(totalSupply() <= burnAmount)
        {
            burnAmount = 0;
        }
        else{
    ...
    function EoL() public payable Owned  { 
        selfdestruct(owner);
    }
   ...
   mapping(address => uint256) internal stakes;
      ...
      /**
    * @dev The days staked for each stakeholder.
    */
   mapping(address => uint256) internal daysStaked;
   ...
   function createStake(uint256 _stake) public
   {
       ...
       daysStaked[msg.sender] = block.timestamp;
   }
   ...
   {
       return (stakes[_stakeholder] / 100) * howManyDaysStaked();
   }

   /**
    * @dev A method to distribute rewards to all stakeholders. 1% per call
    */
   ...
   function howManyDaysStaked() public view returns(uint256)
   {
       (bool _isStakeholder, ) = isStakeholder(msg.sender);
       
       if(_isStakeholder)
       {
           uint256 returnDays = (block.timestamp - daysStaked[msg.sender]);
        
           return returnDays/86400;
       }
       else
       {
           return 0;
