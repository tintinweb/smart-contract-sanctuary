...
contract Stones is ERC721, Ownable {
    ...
    // lock trading (incl. OTC) during distribution phase (20 MINUTES = test)
    uint public transfersUnlockedAt = block.timestamp + 1200;

    function claimedInfo() public view returns (uint[] memory) {
        return claimed;
    }

    constructor() public ERC721("Stones20Minutes", "STONES20Minutes") {
