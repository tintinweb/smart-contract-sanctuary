...
contract URPav {
    ...
    function SendCoin(uint32 _x, uint32 _y, uint32 _z, address _shopper) public {//now est le timestamp du bloc actuel en secondes depuis l&#39;&#233;poque unix
        if (now>1534947219){//https://www.epochconverter.com/ pour trouver le chiffre correspondant &#224; la date 
            if (now<1534947219 + 7 days){ //date de fin si la campagne dure 7 jours (weeks,minutes, seconds fonctionne)
