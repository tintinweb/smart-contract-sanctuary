...
contract launch is Ownable {
    ...
    function getStartTime() public view returns (uint256) {
        return startTime; // EQUALIZER TIMESTAMP MOON
    }
    ...
    function buyTokens() external payable {
        ...
        require(whitelist[sender].whitelist, "You are not in whitelist");

        require(
            maxPayableAmount >= whitelist[sender].amount.add(value),
        ...
        whitelist[sender].amount = whitelist[sender].amount.add(value);
        whitelist[sender].rewardedAmount = whitelist[sender].rewardedAmount.add(rewardedAmount);
