...
contract HpbNodes {
    ...
    function addHpbNodeByStr(
        ...
        nodeStages[currentStageNum].hpbNodes.push(HpbNode(
            coinbase,
            stringToBytes32(cid1),
            stringToBytes32(cid2),
            stringToBytes32(hid)
        ));
        emit AddHpbNode(currentStageNum,coinbase,cid1.toSlice().concat(cid2.toSlice()),hid);
    }
    ...
    function updateHpbNode(
     ...
     function updateHpbNodeByStr(
        ...
        nodeStages[currentStageNum].hpbNodes[index].coinbase=coinbase;
        nodeStages[currentStageNum].hpbNodes[index].cid1=stringToBytes32(cid1);
        nodeStages[currentStageNum].hpbNodes[index].cid2=stringToBytes32(cid2);
        nodeStages[currentStageNum].hpbNodes[index].hid=stringToBytes32(hid);
        emit UpdateHpbNode(currentStageNum,coinbase,cid1.toSlice().concat(cid2.toSlice()),hid);
    }
