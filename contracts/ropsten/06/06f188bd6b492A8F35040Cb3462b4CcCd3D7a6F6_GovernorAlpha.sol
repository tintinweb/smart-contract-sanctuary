...
contract GovernorAlpha {
    ...
    function quorumVotes() public view returns (uint) { return vault.getUSDVTotalSupply() * 4 / 100; } // 4 % of USDV

    // @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public view returns (uint) { return vault.getUSDVTotalSupply() / 100; } // 1 % of USDV
