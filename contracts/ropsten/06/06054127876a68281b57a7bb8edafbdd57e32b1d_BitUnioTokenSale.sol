  ...
  private {
    ...
    */  
    constructor (address _tokenToBeUsed, address _wallet)public nonZeroAddress(_tokenToBeUsed) nonZeroAddress(_wallet){
        ...
        //phase-1
        startTimes[0] = 1544077800; //JANUARY 10, 2010 12:00:00 AM GMT
        endTimes[0] = 1544085000; //FEBUARY 09, 2019 11:59:59 PM GMT
        cummulativeHardCaps[0] = 72727272700000000000000 wei;
        bonusPercentages[0] = 10;
        rates[0] = 50000 ;
        
        //phase-2
        startTimes[1] = 1544085060; //FEBUARY 10, 2019 12:00:00 AM GMT 
        endTimes[1] = 1544092260; //MARCH 09, 2019 11:59:59 PM GMT
