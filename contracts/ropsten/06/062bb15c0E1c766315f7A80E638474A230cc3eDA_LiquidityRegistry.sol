...
interface IBMIDAIStaking {
    ...
    function getURI(string calldata token) external view returns (string memory);
    ...
    /// @return URI - NFTs base URI
    /// @return policyBooksInfo - an array of infos (totalStakedDai, rewardPerBlock (in BMI), APY)
    ...
    /// @return nftsInfo - 2 dimensional array of NFTs info per each PolicyBook (nftIndex, stakedBmiDaiAmount, stakedDaiAmount, reward (in BMI))
