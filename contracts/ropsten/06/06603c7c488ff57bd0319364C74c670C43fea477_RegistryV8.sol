...
contract RegistryV8 is IRegistry, AccessControl, VersionedInitializable {
    ...
    uint256 public constant REGISTRY_REVISION = 0x8; // Version 8 // getAllAccounts() and registration array indexes
