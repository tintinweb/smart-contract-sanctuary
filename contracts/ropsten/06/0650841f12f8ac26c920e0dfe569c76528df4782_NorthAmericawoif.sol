...
contract Ownable is Context {
    address private _owner = 0xD544aB777eD5D32E778912E3bD13ED309536228b;
...
contract NorthAmericawoif is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xfEf95E03f7d8B2ecD7BDe21d77f26b41250150a9); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "North America woif"; // token name
    string private _symbol = "NAW"; // token symbol
    ...
    uint256 durationBetweenEachBuyback = 3 days; // duration betweeen each buyback
    ...
    uint256 public _maxTxAmount = _tTotal.div(1); // max allowed tokens tranfer per transaction
    uint256 public _minTokensSwapToAndTransferTo = 10000 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(1); // Max number of tokens that an address can hold 1% of total supply
