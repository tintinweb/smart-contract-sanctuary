...
Contact e-mail: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d0bdb1a2b9b4b5beb4b9b5a290bfa0b5bebdb1b9bcb2bfa8febfa2b7">[email&#160;protected]</a>
*/
 ...
 function createBet(uint _referrerID) public payable {
  ...
  function getRewardForAddress(address _address) public {
        ...
        if(toPay.add(jackpotBank) >= address(this).balance ){
            toPay = address(this).balance.sub(toPay);
            gameRound = 2;
        }
