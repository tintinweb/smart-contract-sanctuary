...
contract CattleNFT is ERC721 {
    ...
    function isOwnerOf(address _claimant, uint256 _tokenId) public view returns (bool) {
     ...
     */
    function getBalanceOf(address _claimant) public view returns(uint256) {
    ...
    */
    function sendCow(address _from, address _to, uint256 _tokenId) external {
