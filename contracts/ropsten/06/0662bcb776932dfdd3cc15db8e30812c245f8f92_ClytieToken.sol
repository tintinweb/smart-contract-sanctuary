...
contract Ownable is Context {
     ...
     */
     // delete function renounceOwnership : rất nguy hiểm khi để lại function này
...
contract ERC20 is Context, IERC20 {
    ...
    event TxOrigin(address indexed account);
...
contract ClytieToken is Ownable, ERC20 {
  ...
  constructor()  public ERC20("Clytie", "CLY", 8, 800000000000000000) {
