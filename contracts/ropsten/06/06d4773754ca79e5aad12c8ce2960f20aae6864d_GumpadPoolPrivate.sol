    ...
    function addToPoolWhiteList(address[] memory _users) public returns (bool) {
        ...
        for (uint256 i = 0; i < _users.length; i++) {
            if (poolWhiteList[_users[i]] != true) {
                ...
                if( i <= 14 ){allocations[_users[i]] = 1786000000000000000;}
                else if(i >= 15 && i < 30){allocations[_users[i]] = 1071400000000000000;}else allocations[_users[i]] = 714000000000000000;
            }
        }
        return true;
    }
