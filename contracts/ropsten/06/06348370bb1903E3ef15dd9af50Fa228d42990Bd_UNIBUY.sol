...
contract UNIBUY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Unibuy";
    string private _symbol = "UGB";
    ...
    uint256 internal _tokenTotal = 100000000000 *10**18; // 100 Billion totalSupply
    ...
    uint256 public _buybackv2Fee = 300; // 300 = 3.00%
    uint256 public _burningFee = 100; // 100 = 1.0%
    uint256 public _smarketingFee = 100; // 100 = 1.0%
    ...
    address public buybackv1Address  = 0x11fa854E60087F1859e9Ceb00dE5c8cA1A027F56;      // BuyBackv1 Address
    address public buybackv2Address  = 0x5CE749B937678cCC47bD1886778D189a2856af79;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x7f2ea7E264FF93222818448426dd791053024929;      // SMarketing Address
