...
abstract contract AbstractAccessControl is AccessControl {
    ...
    /**
     * @notice allows admin to grant admin role to others
     * @param admin the admin address from whom you want to grant the role.
     */
    function grantAdminRole(address admin) public onlyAdmin(msg.sender) {
        _setupRole(DEFAULT_ADMIN_ROLE, admin);
    }

    /**
     * @notice allows admin to revoke admin role from others
     * @param admin the admin address from whom you want to revoke the role.
     */
    function revokeAdminRole(address admin) public onlyAdmin(msg.sender) {
