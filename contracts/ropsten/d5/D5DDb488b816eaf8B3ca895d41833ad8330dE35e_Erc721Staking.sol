...
contract Erc721Staking is Context, AccessControl, SupportsERC721Depositable {
    ...
    constructor(address _erc721Contract) {
        ...
        unlockPeriod = 2 minutes; // this is decided unilaterally and is the same for everybody
    }
    ...
    function setUnlockPeriod(uint64 period) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Erc721Staking: You don't have the admin role to perform this operation");
    ...
    function requestWithdraw() external {
        ...
        require(ds.lockedUntil == 0, "You already requested to unlock it"); 
