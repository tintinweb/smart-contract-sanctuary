...
contract IDO3 is AdminRole, VerifySignature{
  using SafeMath for uint256;
  ...
  constructor () public {
    ...
    _signer_address = address(0x16A2C4E3aC22EAC8E56f7F8410D9bDF7115653DA);

    // set the address of a currency smart contract
    // e.g. Token Tether (USDT) address is 0xdAC17F958D2ee523a2206206994597C13D831ec7
    currency_token_address = address(0x7B06c1f09097c86dA10bbDF4C3B4Ed788Fd97b24);
