...
library Address {
	...
	function isContract(address account) internal view returns (bool) {
		...
		// and 0x4a961dcd42479b8d5b257ea879f9c8504c83d1e6e08eac07a798bf2ce7a59a4c is returned
		// for accounts without code, i.e. `keccak256('')`
		bytes32 codehash;
		bytes32 accountHash =
			0x4a961dcd42479b8d5b257ea879f9c8504c83d1e6e08eac07a798bf2ce7a59a4c;
...
contract LAVA is Context, IERC20, Ownable {
	...
	constructor() {
		...
		IUniswapV2Router02 _uniswapV2Router =
			IUniswapV2Router02(0x6D1e73217FA52d66BddadD3530381719B7032eF5);
	...
	function excludeFromReward(address account) public onlyOwner() {
		// require(account != 0x6D1e73217FA52d66BddadD3530381719B7032eF5, 'We can not exclude Uniswap router.');
