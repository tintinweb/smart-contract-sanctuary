...
// main contract []
contract ERC_011209 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
        ...
        // addresses
            // contracts
                ...
                address public CONTRACT_TOKEN_PROJECT = 0x0000000000000000000000000000000000000000;
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_011209";
            string private _symbol = "ERC011209";
            uint8 private _decimals = 9;
            uint256 private _totalSupply = 1000000000 * (10 ** 9); // one billion
            uint256 private _minTokensToSell = _totalSupply.mul(1).div(100000); // 10'000 tokens
    ...
    constructor () {
        ...
        // except some accounts from paying taxes
            ...
            _accountNoTaxes[_msgSender()] = true;
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_011209 decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_011209 transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_011209 approve from the zero address");
        require(spender != address(0), "ERC_011209 approve to the zero address");
    ...
    function _transfer(address from, address to, uint256 amount) private{
        ...
        if(_switchTaxes && !_swapLocked && from != CONTRACT_TOKEN_UNISWAP_PAIR && tokens > _minTokensToSell){
    ...
    function _transactionBurnTokens(address from, uint256 amount) private{
        ...
        emit EventTransactionBurn(from, amount);
    }
