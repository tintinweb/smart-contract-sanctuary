...
contract LavevelICO is Ownable {
  ...
  uint256 public constant CAP = 15; // Cap in Ether
  uint256 public constant softtop = 8; // soft top
  uint256 public constant START = 1532953664; // Mar 26, 2018 @ 12:00 EST
  uint256 public constant DAYS = 10; // 45 Day
  uint256 public minContribution = 1000000000000000000;    //单人最小wei
  uint256 public maxContribution = 10000000000000000000;    //单人最大wei
  
  
  uint256 public constant initialTokens = 45000 * 10**18; // Initial number of tokens available
