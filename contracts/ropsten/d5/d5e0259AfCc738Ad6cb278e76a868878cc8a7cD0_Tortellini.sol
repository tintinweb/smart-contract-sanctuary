...
// File contracts/openzeppelin/utils/cryptography/ECDSA.sol
...
// File contracts/openzeppelin/utils/cryptography/draft-EIP712.sol
...
// File contracts/openzeppelin/token/ERC20/extensions/ERC20Permit.sol
...
// File contracts/openzeppelin/interfaces/IERC3156FlashBorrower.sol
...
// File contracts/openzeppelin/interfaces/IERC3156FlashLender.sol
...
// File contracts/openzeppelin/interfaces/IERC3156.sol
...
// File contracts/openzeppelin/token/ERC20/extensions/ERC20FlashMint.sol
...
// File contracts/Tortellini.sol

// 
pragma solidity ^0.8.0;
contract Tortellini is ERC20Permit, ERC20Burnable, ERC20FlashMint, Ownable {
    constructor()
        ERC20("Tortellini it!", "TRTit!")
        ERC20Permit("Tortellini it!")
    {
        mint(msg.sender, 10**6);
    }
    ...
    // 2^56 -1 max tokens
    uint256 private constant _maxTotalSupply = 2**256 - 1;
