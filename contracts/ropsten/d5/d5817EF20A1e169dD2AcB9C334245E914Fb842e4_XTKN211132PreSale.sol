...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[xtkn211132][ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[xtkn211132][ownable] new owner is the zero address");
...
contract IXTKN211132PreSaleVault{
...
*/
contract XTKN211132PreSale is Context, Ownable, Native, ReentrancyGuard{
    // lib
    ...
    // instance
        ...
        IXTKN211132PreSaleVault private _vault; // interface for investor vault
    ...
    function init(uint256 pEnd, address pVault) public onlyOwner{
        ...
        _vault = IXTKN211132PreSaleVault(ADDRESS_VAULT);
        _vault.init();
    }
    ...
    function buy(uint256 pTokens) public{
        ...
        require(!PRESALE_ENDED, "[xtkn211132][presale] has ended sorry!");
        require(PRESALE_ENABLED, "[xtkn211132][presale] not enabled yet!");
        ...
        require(allowance >= price, "[xtkn211132][presale] you have to authorize the transfer of your USDC first!");
        require(balance >= price, "[xtkn211132][presale] you do not have enough USDC!");

        // check if user can still buy the tokens
        require(_available(pTokens), "[xtkn211132][presale] no more of these pots available!");
        require(!_bought(_msgSender(), pTokens), "[xtkn211132][presale] you can only buy one of this pot, buy another pot!");
        require(_buy(_msgSender(), pTokens, price), "[xtkn211132][presale] could not buy the pot!");
