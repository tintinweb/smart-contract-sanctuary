...
contract GoatSplitter is ERC1155, ERC1155Holder {
    ...
    /** ====================  Event  ==================== */
    event LogSplit(address indexed token, uint256 indexed id, uint256 parts, uint256[] fragments, string[] uris, address receiver);
    event LogRestore(address indexed token, uint256 indexed id, uint256 parts, uint256[] fragments, address receiver);
        ...
        returns (uint256[] memory) 
    {
        ...
        emit LogSplit(_token, _id, _parts, info.fragments, _uris, _receiver);
        ...
        external 
    {
        ...
        emit LogRestore(info.token, info.id, info.parts, info.fragments, msg.sender);
    }
