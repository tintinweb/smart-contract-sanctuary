...
interface IBuyback {
    ...
    function tokenTreasury(address _token) external view returns (uint256);
    ...
    function deposit(address _token, uint256 _deposit) external returns (bool);
    ...
    function transferMoneyToReserve() external;
}
