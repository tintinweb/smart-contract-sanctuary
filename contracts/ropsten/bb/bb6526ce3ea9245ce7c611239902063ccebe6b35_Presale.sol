...
contract Presale is ReentrancyGuard {
  ...
  uint256 tokensPerETH = 24; //24/100
  ...
  function buy (address beneficiary) public payable nonReentrant {
    ...
    uint256 tokens = _ethSent.mul(tokensPerETH).div(100);
    
    
    require (_ethSent >= 0.01 ether, "ETH is lesser than min value");
    require (_ethSent <= 0.5 ether, "ETH is greater than max value");
    require (ethReceived <= 1 ether, "Hardcap reached");
