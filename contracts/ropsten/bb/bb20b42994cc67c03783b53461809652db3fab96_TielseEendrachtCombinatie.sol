...
contract TielseEendrachtCombinatie is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TielseEendrachtCombinatie() {
        ...
        name = "TielseEendrachtCombinatie";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TEC";                                             // Set the symbol for display purposes (CHANGE THIS)
