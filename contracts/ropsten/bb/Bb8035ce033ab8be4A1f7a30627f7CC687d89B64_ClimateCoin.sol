...
ClimateCoin Socials:
Telegram: climatecoin
Twitter: https://twitter.com/token_project?s=20
...
contract ClimateCoin is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ClimateCoin";
    string private m_Symbol = "Climate";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 25000, 25000, 75000, m_ILOPublic);
        initTax();
