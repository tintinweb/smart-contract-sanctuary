...
pragma experimental ABIEncoderV2;
import "@pooltogether/pooltogether-contracts/contracts/builders/PoolWithMultipleWinnersBuilder.sol";
import "@pooltogether/pooltogether-contracts/contracts/external/compound/CTokenInterface.sol";
import "@pooltogether/yield-source-interface/contracts/IYieldSource.sol";

import "./IPoolTogetherData.sol";

interface IPoolTogether is IPoolTogetherData {
    // 0xB852Bb662B692146BEC334A9E91C8e2e6e64FCdc
...
pragma experimental ABIEncoderV2;
// import "https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/release-v3.2.0/contracts/utils/SafeCastUpgradeable.sol";
// import "https://github.com/pooltogether/pooltogether-pool-contracts/blob/master/contracts/builders/PoolWithMultipleWinnersBuilder.sol";
import "@pooltogether/pooltogether-contracts/contracts/external/compound/CTokenInterface.sol";
import "@pooltogether/yield-source-interface/contracts/IYieldSource.sol";


interface IPoolTogetherData {
  /// @notice The configuration used to initialize the Compound Prize Pool
  struct CompoundPrizePoolConfig {
    CTokenInterface cToken;
    uint256 maxExitFeeMantissa;
