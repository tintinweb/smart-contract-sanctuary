...
contract INUCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SuperUltraPowerCoin() {
        ...
        name = "INUCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "INU";                                             // Set the symbol for display purposes (CHANGE THIS)
