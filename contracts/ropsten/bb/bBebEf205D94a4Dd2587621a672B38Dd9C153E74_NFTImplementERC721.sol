...
// File: contracts\NFTImplementERC721.sol
...
contract NFTImplementERC721 is ERC721, Ownable {
  ...
  constructor() ERC721("Test NFT","NFT") {
    admin = msg.sender;
    setBaseURI("https://raw.githubusercontent.com/tathithuyvn89/card-test/master/");
    
  }

  function mint (address to) external {
   require(msg.sender==admin,'Only owner have permission to mint');
   _safeMint(to,nextTokenId );
   nextTokenId++;
  }

  function setBaseURI(string memory baseURI) public {
     require(msg.sender==admin,'Only owner have permission to setBaseUrl');
