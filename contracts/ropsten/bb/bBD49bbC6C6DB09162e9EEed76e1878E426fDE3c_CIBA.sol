...
contract CIBA is Context, IERC20, Ownable {
	...
	uint256 public defaultWhaleTaxFee = 5;
    uint256 public _whaleTaxFee = defaultWhaleTaxFee;
    uint256 private _previousWhaleTaxFee = _whaleTaxFee;
	//uint256 public _whaleTaxFee = 5;
	
    uint256 public _maxTxAmount = 1000 * 10**12 * 10**18;
    uint256 public _whaleTaxPoint = _whaleTaxFee * 10**12 * 10**12;
	...
	function setDefaultWhaleTaxFee(uint256 WhaleTaxFee) external onlyOwner {
        defaultWhaleTaxFee = WhaleTaxFee;
    }
