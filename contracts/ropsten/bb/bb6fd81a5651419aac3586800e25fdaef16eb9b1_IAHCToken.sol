...
contract IAHCToken is StandardToken {
    ...
    address public constant ESCROW_WALLET = 0x6c145DDeD66003C1b2C3449098c07FAc973d7CAd;
    ...
    function IAHCToken(){
        whiteListTime = preSaleListTime= now;
        preSaleListTime = 
        crowdSaleTime =
        crowdSaleEndTime =
        icoEndTime =
        guarenteedPaybackTime =
        now + 1 days;
    ...
    function finalizeTime() public onlyOwner() {
        whiteListTime = 
        preSaleListTime = 
        crowdSaleTime =
        crowdSaleEndTime =
