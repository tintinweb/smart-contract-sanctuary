...
contract TestInu16 is Context, IERC20, Ownable {
    ...
    string private _name = "TestInu 16";
    string private _symbol = "Tinu16";
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal.div(10**3).mul(5);
