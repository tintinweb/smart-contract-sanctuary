...
/**
 * @title SafeMath send 10,000 tokens to this contract to initiate
...
/**
 * @title Token
 * @dev API interface for interacting with the TEST Token contract 
 */
interface Token {
...
contract TestICO is Ownable {
  ...
  uint256 public constant START = 1635869633; // Nov 2, 2021
  uint256 public constant DAYS = 4; // 45 Day
  
  uint256 public constant initialTokens = 10000 * 10**18; // Initial number of tokens available
  ...
  /**
   * TestICO
   * @dev TestICO constructor
   **/
  function TestICO(address _tokenAddr) public {
