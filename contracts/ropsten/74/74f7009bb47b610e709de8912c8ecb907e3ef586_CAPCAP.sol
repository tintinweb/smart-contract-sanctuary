...
contract CAPCAP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xab7Fd835383Abd5Debb8969D475faFa54FB1F617); // Marketing Wallet
    address payable private ecosystemWallet = payable(0xab7Fd835383Abd5Debb8969D475faFa54FB1F617); // Ecosystem Wallet
    address payable private devWallet = payable (0xab7Fd835383Abd5Debb8969D475faFa54FB1F617); // dev Wallet
    ...
    string private _name = "CAPCAP";
    string private _symbol = "$CAP";
    
    uint256 public _maxWalletToken = _tTotal.div(1000).mul(10); //1% for first few mins
