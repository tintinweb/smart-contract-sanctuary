...
// Part: OpenZeppelin/openzeppelin-contracts-upgra[email protected]/MathUpgradeable
    ...
    FundStorage
{
    ...
    function processFees() internal {
        ...
        for (uint256 i = 0; i < getStrategyCount(); i++) {
            ...
            if (profit > 0) {
                strategyCreatorFee = profit
                    ...
                    .div(MAX_BPS);
                if (strategyCreatorFee > underlyingBalanceInFund()) {
        ...
        if (fundManagerFee > underlyingBalanceInFund()) {
        ...
        if (platformFee > underlyingBalanceInFund()) {
