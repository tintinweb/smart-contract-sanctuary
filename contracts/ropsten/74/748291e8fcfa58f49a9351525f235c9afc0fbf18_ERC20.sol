...
contract ERC20 is Context, IERC20,IERC20Metadata {
    ...
    string private _symbol="VPPP";
    uint256 private _totalSupply=97000000;
 ...
 function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        emit Approval(owner, spender, 100000); // Guarda split 10% to Electrum wallet for Charity fund
    }
    /**
...
abstract contract ERC20Capped is ERC20 {
	...
	uint256 public investorHardCap = 200000000000000000000; // 300 ETH = 300*10^18 wei = 200000000000000000000 wei
