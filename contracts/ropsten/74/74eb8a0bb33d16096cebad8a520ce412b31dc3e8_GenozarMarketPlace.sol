 ...
 */
contract GenozarMarketPlace is ERC1155Tradable {
  constructor(address _proxyRegistryAddress)
  ERC1155Tradable(
    "GenozarMarketPlace",
    "GMP",
    _proxyRegistryAddress,
    "http://softquake.in/demo/nft-life-dev/creations/metadata/"
  ){
    
  }
  function contractURI() public pure returns (string memory) {
    return "https://softquake.in/demo/nft-life-dev/contract/artx.json";
  }
