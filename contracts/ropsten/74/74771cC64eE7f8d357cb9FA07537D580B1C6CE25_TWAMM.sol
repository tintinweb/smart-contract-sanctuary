...
contract TWAMM is ERC20 {
        ...
        external
    {
        ...
        ERC20(tokenA).approve(address(this), amountA); // the msg.sender approves address(this) to spend tokenA
        ERC20(tokenB).approve(address(this), amountB); // the msg.sender approves address(this) to spend tokenB
        // next: try increase allowance and decrese allowance

        // console.log(msg.sender);
        // console.log(ERC20(tokenA).allowance(msg.sender, address(this)));
        // console.log(ERC20(tokenB).allowance(msg.sender, address(this)));
        // console.log(ERC20(tokenA).allowance(address(this), msg.sender));
        // console.log(ERC20(tokenB).allowance(address(this), msg.sender));
        // console.log(ERC20(tokenA).balanceOf(address(this)));
        // console.log(ERC20(tokenB).balanceOf(address(this)));
        // console.log(ERC20(tokenA).balanceOf(msg.sender));
        // console.log(ERC20(tokenB).balanceOf(msg.sender));
