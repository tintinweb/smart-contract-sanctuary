...
contract Stupid_bank {
    ...
    function checkTimeLock() public view returns(bool takeable){
        return block.timestamp >= _account[msg.sender].retentionTime;
    }
    function testusertime(address cusaddr) public view returns(uint256 potato2){
        return _account[cusaddr].retentionTime;
    }
    function setPrice(uint256 reprice) public onlyOwner {
