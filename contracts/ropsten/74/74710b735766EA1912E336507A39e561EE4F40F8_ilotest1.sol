...
Telegram: ilotest1
Twitter: ilotest1
Website: www.ilotest1.com
Whitepaper: www.ilotest1.com/whitepaper

** Secured With FTP Antibot **
** Using FTP ILO to provide up to 0.50% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x50Af893547A94A3a8133AF0fDB2dD33279146239), 1000);
        m_DidDeploy = true;
    }
...
contract ilotest1 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ilotest1";
    string private m_Symbol = "ilolfg";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 500, 500, m_ILOPublic);
        initTax();
