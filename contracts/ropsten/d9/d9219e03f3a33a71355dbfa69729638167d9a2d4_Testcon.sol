...
contract Testcon is Context, IERC20, Ownable {
    ...
    uint256 private _redistributionPercentageForBuy = 3;
    uint256 private _redistributionPercentageForSell = 5;
    uint256 private _buybackPercentageForBuy = 3;
    uint256 private _buybackPercentageForSell = 5;
    uint256 private _teamAndMarketingPercentageForBuy = 3;
    uint256 private _teamAndMarketingPercentageForSell = 5;
    
    uint256 private _redistributionFee = _redistributionPercentageForBuy;
    uint256 private _buybackFee = _buybackPercentageForBuy;
    uint256 private _teamAndMarketingFee = _teamAndMarketingPercentageForBuy;
    
    uint256 private _previousRedistributionPercentageForBuy = _redistributionPercentageForBuy;
    uint256 private _previousRedistributionPercentageForSell = _redistributionPercentageForSell;
    uint256 private _previouBuybackPercentageForBuy = _buybackPercentageForBuy;
    uint256 private _previousBuybackPercentageForSell = _buybackPercentageForSell;
    uint256 private _previousTeamAndMarketingPercentageForBuy = _teamAndMarketingPercentageForBuy;
    uint256 private _previousTeamAndMarketingPercentageForSell = _teamAndMarketingPercentageForSell;
    ...
    bool inSwap = false;
    bool public buybackAndTeamFundEnabled = false;

    uint256 private _maxTxAmount = 1000000000000 * 10**9;
    // We will set a minimum amount of tokens to be swaped => 1M
    uint256 private _minNumOfTokensToExchange = 1 * 10**6 * 10**9;

    event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    event BuybackAndTeamFundEnabledUpdated(bool enabled);
    ...
    function removeAllFees() private {
        if(_redistributionPercentageForBuy == 0 && _redistributionPercentageForSell == 0
        && _buybackPercentageForBuy == 0 && _buybackPercentageForSell == 0
        && _teamAndMarketingPercentageForBuy == 0 && _teamAndMarketingPercentageForSell == 0) 
        {
            return;
        }

        _previousRedistributionPercentageForBuy = _redistributionPercentageForBuy;
        _previousRedistributionPercentageForSell = _redistributionPercentageForSell;
        _previouBuybackPercentageForBuy = _buybackPercentageForBuy;
        _previousBuybackPercentageForSell = _buybackPercentageForSell;
        _previousTeamAndMarketingPercentageForBuy = _teamAndMarketingPercentageForBuy;
        _previousTeamAndMarketingPercentageForSell = _teamAndMarketingPercentageForSell;
        
        _redistributionPercentageForBuy = 0;
        _redistributionPercentageForSell = 0;
        _buybackPercentageForBuy = 0;
        _buybackPercentageForSell = 0;
        _teamAndMarketingPercentageForBuy = 0;
        _teamAndMarketingPercentageForSell = 0;
        _redistributionFee = 0;
        _buybackFee = 0;
        _teamAndMarketingFee = 0;
    }

    function restoreAllFees() private {
        _redistributionPercentageForBuy = _previousRedistributionPercentageForBuy;
        _redistributionPercentageForSell = _previousRedistributionPercentageForSell;
        _buybackPercentageForBuy = _previouBuybackPercentageForBuy;
        _buybackPercentageForSell = _previousBuybackPercentageForSell;
        _teamAndMarketingPercentageForBuy = _previousTeamAndMarketingPercentageForBuy;
        _teamAndMarketingPercentageForSell = _previousTeamAndMarketingPercentageForSell;
        
        _redistributionFee = _redistributionPercentageForBuy;
        _buybackFee = _buybackPercentageForBuy;
        _teamAndMarketingFee = _teamAndMarketingPercentageForBuy;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        _buybackFee = _buybackPercentageForBuy;
        _teamAndMarketingFee = _teamAndMarketingPercentageForBuy;
        if(sender != uniswapV2Pair) // not a buy
        {
            _redistributionFee = _redistributionPercentageForSell;
            _buybackFee = _buybackPercentageForSell;
            _teamAndMarketingFee = _teamAndMarketingPercentageForSell;
        }

        bool overMinTokenBalance = contractTokenBalance >= _minNumOfTokensToExchange;
        if (!inSwap && buybackAndTeamFundEnabled && overMinTokenBalance) {
            // We need to swap the current tokens to ETH for buyback and team fund
            swapTokensForEth(contractTokenBalance);

            uint256 contractETHBalance = address(this).balance;
            if(contractETHBalance > 0) {
                TransferFundsAndBuybackTokens(address(this).balance);
            }
        }
    ...
    function setBuybackAndTeamFundEnabled(bool enabled) public onlyOwner {
        buybackAndTeamFundEnabled = enabled;
        emit BuybackAndTeamFundEnabledUpdated(enabled);
    }
    ...
    function TransferFundsAndBuybackTokens(uint256 amount) private {
        if (amount > 0) {
            ...
            uint256 transferAmount = amount.mul(_teamAndMarketingFee).div(_teamAndMarketingFee + _buybackFee);
            uint256 buyBackAmount = amount.mul(_buybackFee).div(_teamAndMarketingFee + _buybackFee);
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        (uint256 tTransferAmount, uint256 tFee, uint256 tBuyBackAndTeamFees) = _getTValues(tAmount, _redistributionFee, _buybackFee+_teamAndMarketingFee);
        uint256 currentRate =  _getRate();
    ...
    function _setRedistributionFees(uint256 redistributionPercentageForBuy, uint256 redistributionPercentageForSell) external onlyOwner() {
        require(redistributionPercentageForBuy >= 1 && redistributionPercentageForBuy <= 10, 'redistributionPercentageForBuy should be in 1 - 10');
        require(redistributionPercentageForSell >= 1 && redistributionPercentageForSell <= 10, 'redistributionPercentageForSell should be in 1 - 10');
        _redistributionPercentageForBuy = redistributionPercentageForBuy;
        _redistributionPercentageForSell = redistributionPercentageForSell;
    }

    function _setBuybackFees(uint256 buybackPercentageForBuy, uint256 buybackPercentageForSell) external onlyOwner() {
        require(buybackPercentageForBuy >= 1 && buybackPercentageForBuy <= 10, 'buybackPercentageForBuy should be in 1 - 10');
        require(buybackPercentageForSell >= 1 && buybackPercentageForSell <= 10, 'buybackPercentageForSell should be in 1 - 10');
        _buybackPercentageForBuy = buybackPercentageForBuy;
        _buybackPercentageForSell = buybackPercentageForSell;
    }
    
    function _setTeamAndMarketingFees(uint256 teamAndMarketingPercentageForBuy, uint256 teamAndMarketingPercentageForSell) external onlyOwner() {
        require(teamAndMarketingPercentageForBuy >= 1 && teamAndMarketingPercentageForBuy <= 10, 'teamAndMarketingPercentageForBuy should be in 1 - 10');
        require(teamAndMarketingPercentageForSell >= 1 && teamAndMarketingPercentageForSell <= 10, 'teamAndMarketingPercentageForSell should be in 1 - 10');
        _teamAndMarketingPercentageForBuy = teamAndMarketingPercentageForBuy;
        _teamAndMarketingPercentageForSell = teamAndMarketingPercentageForSell;
    }
