...
contract TacticalTangrams is ERC721 {
	...
	function mint() public payable {
		require(msg.value > 0 && msg.value % MINT_PRICE == 0, "Wrong amount paid");
	...
	function getShapeForTanId(uint16 tanId) public view returns (uint8) {
		uint8 shapeNum = uint8(tanId % MAX_SHAPES);
		return uint8(SHAPE_TYPE[shapeNum]);
	}
