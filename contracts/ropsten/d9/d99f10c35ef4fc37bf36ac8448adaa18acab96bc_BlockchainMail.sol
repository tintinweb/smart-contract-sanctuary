...
// File: contracts\BlockchainJournal.sol
...
contract BlockchainMail is Ownable {
  ...
  function sendLetter(address receiverAddress, string memory _mail) public {
    postBox[receiverAddress].mail[msg.sender] = _mail;
  }

  function receiveLetter(address senderAddress) public view returns (string memory){
