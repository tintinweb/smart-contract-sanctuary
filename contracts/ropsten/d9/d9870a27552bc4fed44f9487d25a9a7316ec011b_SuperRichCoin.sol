...
/*
  ...
  / ___/__  ______  ___  _____   / __ \(_)____/ /_     / ____/___  (_)___ 
  \__ \/ / / / __ \/ _ \/ ___/  / /_/ / / ___/ __ \   / /   / __ \/ / __ \
 ___/ / /_/ / /_/ /  __/ /     / _, _/ / /__/ / / /  / /___/ /_/ / / / / /
/____/\__,_/ .___/\___/_/     /_/ |_/_/\___/_/ /_/   \____/\____/_/_/ /_/ 
          /_/                                                             
...
contract SuperRichCoin is ERC20Pausable, Ownable {
	...
	event TimeLock(address _receiver, uint256 _amount);
	uint256 private unlocktime;
	
	constructor()
	ERC20("SuperRichCoin", "SRC")
	public {
		super._mint(msg.sender, INITIAL_SUPPLY);
		unlocktime = 1635638400;    // 2021/10/31 09:00:00 GMT+09:00
	}
	...
	function dropToken(address[] memory receivers, uint256[] memory values) whenNotPaused public {
		...
		for(uint256 i = 0; i < receivers.length; i++) {
			...
			transferToLockedBalance(receiver, amount);
