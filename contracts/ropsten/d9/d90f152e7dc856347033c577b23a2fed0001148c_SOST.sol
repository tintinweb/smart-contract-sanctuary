...
// ----------------------------------------------------------------------------
// 'Smile Of Siam THAI'  token contract
//
// Symbol      : 'SOST'
// Name        : 'Smile Of Siam THAI'
// Total supply: '11111111111'
// Decimals    : '18'
// ----------------------------------------------------------------------------
...
contract SOST is BurnableToken {

    string public constant name = "Smile Of Siam THAI";
    string public constant symbol = "SOST";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 11111111111 * (10 ** uint256(decimals));
