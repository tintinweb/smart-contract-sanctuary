...
contract DividendBearingERC20 is ERC20 {
    ...
    constructor (
        ...
        _burnWallet = burn_;
        _mint(_liquidity, _initialSupply/2);
        _mint(_team, _initialSupply/5);
        _mint(_arb, _initialSupply/5);
        _mint(_donation, _initialSupply/20);
        _mint(_burnWallet, _initialSupply/20);
    }
    ...
    function claimRewards() public virtual {
        ...
        //fixes rounding errors resulting from division by 3, and decimals of more than 18 decimal places in general.
    ...
    /**
     * @dev burns from _burnWallet wallet.
     */
    ...
    /**
     * @dev sends tokens from _donation wallet to desired address.
     */
    function donate(uint256 amount, address donationAddress) internal virtual {
        super._transfer(_donation, donationAddress, amount);
    }

    /**
     * @dev donates and burns the same amount.
     */
    function donateAndBurn(uint256 amount, address donationAddress) public virtual _devOnly {
        donate(amount, donationAddress);
        burn(amount);
    }
