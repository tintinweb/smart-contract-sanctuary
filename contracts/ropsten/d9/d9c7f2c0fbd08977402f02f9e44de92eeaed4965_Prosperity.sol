    ...
    */
        ...
        returns(uint256)
    {
        ...
        uint256 _etherReceived =
            ...
            SafeMath.sub(
                (
                            ((tokenPriceIncremental_) * (_tokens) * 1e18 * (tokenSupply_)) / 1e18
                            +
                            ((tokenPriceInitial_) * (_tokens) * 1e18) / 1e18
                            +
                            ((tokenPriceIncremental_) * (_tokens) * 1e18) / (2 * 1e18)
                            
                ),(         ((tokenPriceIncremental_) * (_tokens) * 1e18)
                            +
                            ((tokenPriceIncremental_) * (((_tokens) * 1e18) **2)) / (2 * 1e18)
                    )   );
