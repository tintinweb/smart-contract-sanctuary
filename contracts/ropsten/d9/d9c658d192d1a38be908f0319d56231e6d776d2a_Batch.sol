...
contract Batch {
  ...
  function test() public
  {
            ...
            (bool success2, bytes memory data2) = address(staking).delegatecall(
            //in abi sig we need to pass in the function signature that we are calling
            abi.encodeWithSignature("stakeOf(address)", 0xa92611d05F3d5dA5fc22CedB3c453f5e586675Ba)
            );
            amount = abi.decode(data2, (uint256));
  }
