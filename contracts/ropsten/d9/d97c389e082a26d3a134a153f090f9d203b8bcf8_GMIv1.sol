...
contract GMIv1 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xb0D6FD18d8cd827af62DEeCee5a4CbFF3Fa2258A); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0xb0D6FD18d8cd827af62DEeCee5a4CbFF3Fa2258A); // xrp Address
    ...
    string private _name = "GonnaMakeIt";
    ...
    uint256 public _xrpCharityFee = 2;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Prod
