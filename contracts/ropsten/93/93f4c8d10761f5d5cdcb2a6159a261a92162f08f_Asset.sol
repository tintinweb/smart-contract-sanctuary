...
contract Estate 
{
    ...
    // key value mapping of address with land array
    mapping (address => Land[]) public __ownedLands; 
    

    //1. FIRST OPERATION
    //owner shall add lands via this function
    function addLand(string memory _location, uint _cost) public isOwner
    {
    ...
    function getLand(address _landHolder, uint _index) public returns (string memory, uint, address, uint)
    {
