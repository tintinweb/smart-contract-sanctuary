 ...
 * `ERC20` functions.
 */
contract EEFF is ERC20, ERC20Detailed, ERC20Pausable, ERC20Burnable, Ownable {
    ...
    constructor () public ERC20Detailed("EEFF Token", "EEFF", 18) {
    ...
    function transferFrom(address from, address to, uint256 value) public notFrozen(msg.sender) notFrozen(to) returns (bool) {
