...
contract IcyIgloos is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public lastSoldPrice = 5 * (10**18);
    ...
    function price() public view returns (uint256) {
        ...
        uint256 numUpdates = 3 * secondsSinceSale; // / 240;  // update price every 4 minutes
        uint256 currentPrice = lastSoldPrice; // + lastSoldPrice/2;
        uint256 priceDropAmount = numUpdates * (10 ** 17);
