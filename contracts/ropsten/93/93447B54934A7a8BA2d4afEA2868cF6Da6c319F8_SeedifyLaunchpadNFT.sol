...
contract SeedifyLaunchpadNFT is ERC1155, Ownable, Pausable, ERC1155Burnable {
    ...
    function mintAndPassToMarketPlace(address account, string memory _uri, bytes memory data, uint256 _editions,uint256 _pricePerNFT,uint256 _saleType, uint256 _startTime)
        public
        whenNotPaused
    {        
    ...
    function importAndPassToMarketPlace(address _creator, uint256 _tokenId, string memory _uri, uint256 _editions, uint256 _pricePerNFT, uint256 _saleType, uint256 _startTime)
        public
        whenNotPaused
    {        
        require(checkWhitelist(msg.sender), "You are not eligible to Mint item");
