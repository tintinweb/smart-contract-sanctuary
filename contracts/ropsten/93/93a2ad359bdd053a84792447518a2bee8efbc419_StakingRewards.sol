    ...
    ReentrancyGuardUpgradeable
{
    ...
    function rewardRatePerTokenStaked() external override view returns (uint256) {
        if (totalStakes == 0) {
            return MAX_UINT256;
        } else {
    ...
    function grantFlurryInternal(address user, uint256 amount) nonReentrant internal returns (uint256)
    {
