...
contract Staking is ReentrancyGuard {
    ...
    uint256 public thirdReferrerRewardPercentage;
    ...
    constructor () {
        epoch1Start = 1623697200;//block.timestamp; // to test ???
        epochDuration = 900;

        _owner = msg.sender;

        firstReferrerRewardPercentage = 200;
        secondReferrerRewardPercentage = 100;
        thirdReferrerRewardPercentage = 50;
    }
    ...
    function updateReferresPercentage(uint256 first, uint256 second, uint256 third) external {
        ...
        thirdReferrerRewardPercentage = third;
    }
