...
contract RKTXBridge is ERC20 {
    ...
    constructor(ERC20 _erc20) public ERC20("RKTX BRIDGE", "BRIDGE"){
        erc20 = _erc20;
    }
  
    function transferRKTX(uint256 amount) public {
        ...
        emit _transferRKTX(_msgSender(), amount);
    }
