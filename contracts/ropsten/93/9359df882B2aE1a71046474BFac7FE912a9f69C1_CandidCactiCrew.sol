...
·▀▀▀  ▀  ▀ ▀▀ █▪▀▀▀▀▀• ▀▀▀▀▀▀▀▀•     ·▀▀▀  ▀  ▀ ·▀▀▀  ▀▀▀ ▀▀▀    ·▀▀▀ .▀  ▀ ▀▀▀  ▀▀▀▀ ▀▪
                        ...
                        Candid Cacti Crew | 2021  | version 6.0 | ERC 721

*/

import "./ERC721EnumMongo.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";

contract CandidCactiCrew is ERC721Enum, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    uint256 public constant MAX = 10000;
    uint256 public constant MAX_PRESALE = 5000;
    ...
    uint256 public constant PRESALE_MAX_WALLET = 20;
    uint256 public constant TIMEOUT = 45;
    uint256 public tokensMinted;
    
    string private _contractURI = "https://candidcacti.world/api/metadata/contract";
    ...
    function hashTransaction(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(
                ...
                keccak256(abi.encodePacked(sender, tokenQuantity, timeStamp))
            )
        );
    ...
    /**
     * @dev Pre-Sale Buy/Mint function - INTRODUCE PRESALE AMOUNT -> 50%? and max per txn is
     */
    function presaleBuy(
        uint256 tokenQuantity,
        uint256 timeStamp,
        ...
        require(totalMinted + tokenQty <= MAX_PRESALE, "OUT_OF_STOCK");
        require(tokenQty <= MAX_PER_TXN, "EXCEED_MAX_PER_TXN");
 ...
 * account.
 */
abstract contract ERC721Enum is ERC721, IERC721Enum {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, ERC721) returns (bool) {
        return interfaceId == type(IERC721Enum).interfaceId || super.supportsInterface(interfaceId);
    }
 ...
 */
interface IERC721Enum is IERC721 {
    /**
