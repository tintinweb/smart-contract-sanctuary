...
contract NFT is ERC1155, Ownable {
    ...
    function randomNewId(uint256 _blindboxId) public view returns(uint256){
    ...
    function blindBoxInfo(uint256 _blindBoxId ) public view returns(uint256,uint256,uint256,uint256,uint256){
        return (_blindMap[_blindBoxId].blindAmount, _blindMap[_blindBoxId].soldAmout, _blindMap[_blindBoxId].starSaleTime, _blindMap[_blindBoxId].endSaleTime, _blindMap[_blindBoxId].blindPrice);
    }
