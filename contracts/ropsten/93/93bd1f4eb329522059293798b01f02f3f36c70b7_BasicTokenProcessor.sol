...
contract BasicTokenProcessor is MyVeriable{
    ...
    function addTokenSupport(
        string memory _symbol1, address _tokenAddress1,
        string memory _symbol2, address _tokenAddress2) public returns(bool)
    {
        addTokenSupport(_symbol1, _tokenAddress1);
        addTokenSupport(_symbol2, _tokenAddress2);
        return true;
    }

    function addTokenSupport(
        string memory _symbol1, address _tokenAddress1,
        string memory _symbol2, address _tokenAddress2,
        string memory _symbol3, address _tokenAddress3) public returns(bool)
    {
        addTokenSupport(_symbol1, _tokenAddress1);
        addTokenSupport(_symbol2, _tokenAddress2);
        addTokenSupport(_symbol3, _tokenAddress3);
        return true;
    }
