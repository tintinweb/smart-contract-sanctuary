...
interface ICowNFT {
function mintNFT (string memory _NLIS, string memory _PIC, bytes32 _DNAHash, address ownerAddress) external returns (uint256);

function hashDNA (string memory DNAData) external pure returns (bytes32);

function setNewIdentity (uint256 _tokenCounter, string memory _NLIS, string memory _PIC, bytes32 _DNAHash) external;

function TokenIDToDNAHash (uint256 tokenId) external view returns (bytes32);

function NLISToPIC (string memory NLISID) external view returns (string memory);

function TokenIDToNLIS (uint256 tokenId) external view returns (string memory);

function NLISToDNAHash (string memory NLISID) external view returns (bytes32);

function DNAHashToPIC (bytes32 DNAData) external view returns (string memory);

function TokenIDToOwner(uint256 TokenId) external view returns (address);

function TokenIDToPIC(uint256 TokenId) external view returns (string memory);

function NLISToTokenID (string memory NLISID) external view returns (uint256);

function DNAHashToTokenID (bytes32 DNAData) external view returns (uint256);

function isOwnerOf(address _claimant, uint256 _tokenId) external view returns (bool);

function getBalanceOf(address _claimant) external view returns(uint256);
