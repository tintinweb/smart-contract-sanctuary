...
contract BurnProxy is Ownable{
    ...
    function burnMultiple(uint256[] calldata tokenIDs, bool secondContract) external onlyOwner {
    ...
    function burnToken(uint256[] calldata tokenIDs, bool secondContract) external {
        GalaxiatorsContract _contract = _contract1;
        if (secondContract) {
            _contract = _contract2;
        }
