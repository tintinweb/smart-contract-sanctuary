...
contract ERC20AndBEP2AtomicSwapper {
    ...
    ///
    /// @param _swapID The unique atomic swap id.
    function audit(bytes32 _swapID) external view returns (uint256 timelock, uint256 value, address from, address to, address BEP2Addr, bytes32 secretHashLock) {
    ...
    /// @notice Generates the hash of secretKey, for test only
    ///
