...
import {MockBTC} from "../token/MockBTC.sol";
import {PeriodicFaucet} from "./PeriodicFaucet.sol";

contract WBTCPeriodicFaucet is PeriodicFaucet {
    constructor(MockBTC _token, uint256 _startTime) public PeriodicFaucet(_token, 2 * (uint256(10)**7), _startTime) {}
}
