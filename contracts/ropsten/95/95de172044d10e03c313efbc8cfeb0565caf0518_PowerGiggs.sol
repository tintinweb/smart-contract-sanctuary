...
contract PowerGiggs is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PowerGiggs() {
        ...
        name = &quot;PowerGiggs&quot;;                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 14;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = &quot;PWG&quot;;                                             // Set the symbol for display purposes (CHANGE THIS)
