...
contract MegaTokens is ERC1155PresetMinterPauser, IERC2981 {
  ...
  constructor(string memory uri, address royaltyFeeRecipient,
        uint8 royaltyFee) public ERC1155PresetMinterPauser(uri) {
  ...
  function contractURI() public view returns (string memory) {
        return "https://megatokens.megacatstudios.com/metadata";
  }
  ...
  */
  ...
  function setRoyaltyFeeRecipient(address royaltyFeeRecipient) public {
    require(hasRole(CAT_ROLE, _msgSender()), "MegaTokens: must have cat role to set royalty fee recipient");
  ...
  function setRoyaltyFee(uint8 royaltyFee) public {
    require(hasRole(CAT_ROLE, _msgSender()), "MegaTokens: must have cat role to set royalty fee");
