...
contract Staking {
  ...
  uint256 constant public PERIOD_SERENITY             = 1;            // variable constant for time period managemnt
  ...
  uint256 constant public WITHDRAW_TIME_SERENITY      = 1 * 1 days;            // variable constant to manage withdraw time lock up for silver
