...
contract airdrop is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(sent){
            _tokenTransfer(address(this), 0x0000000000000000000000000000000000000000, charityPortion, false);
            emit Transfer(address(this), 0x0000000000000000000000000000000000000000, charityPortion);
        } else {
        ...
        if(sent){
            _tokenTransfer(address(this), 0x0000000000000000000000000000000000000000, marketingPortion, false);
            emit Transfer(address(this), 0x0000000000000000000000000000000000000000, marketingPortion);
        } else {
