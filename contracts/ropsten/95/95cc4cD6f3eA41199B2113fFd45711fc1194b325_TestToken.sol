...
contract TestToken is ERC20 {
    ...
    bool _tradingOpen;
    bool _tradingPaused;
    bool _enableTradingFxnUsed;
    bool _pauseTradingFxnUsed;
    ...
    constructor(uint256 unlockTimestamp) ERC20("AntiBotTestToken", "ABTT") {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if(msg.sender != _owner) {
            ...
            require(!_tradingPaused, "TRADING IS CURRENTLY PAUSED!");
            require(getTime() > _unlockTimestamp, "CURRENT TIME IS NOT HIGHER THAN UNLOCK TIMESTAMP");
        }
        _transfer(_msgSender(), recipient, amount);
        return true;
    }
    ...
    function enableTrading() external onlyOwner() {
        ...
        _tradingOpen = true;
        _enableTradingFxnUsed = true;
    }

    function pauseTrading() external onlyOwner() {

        _tradingPaused = true;
        _pauseTradingFxnUsed=true;
    }
    ...
    function getTimeLeft() public view returns (uint256) {
        ...
        return _unlockTimestamp - getTime();
    }
}