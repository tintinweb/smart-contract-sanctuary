...
// File: ..\node_modules\@openzeppelin\contracts\token\ERC721\utils\ERC721Holder.sol
...
// File: ..\gpu\contracts\ArteonGPU.sol
...
contract ArteonGPU is ERC721, Ownable {
  ...
  constructor(string memory name, string memory symbol, uint256 cap, string memory tokenURI_) ERC721(name, symbol) {
    _tokenURI = tokenURI_;
    _cap = cap;
  }
...
// File: ..\token\contracts\ARTEON.sol
...
contract ArteonMiner is Context, ERC165, ERC721Holder, Ownable {
  ...
  constructor() {
    address token = 0xBa174aAead58DF2951Ff9F80D00BfdCBfa74AA67;
    address gpu = 0x3E81B5325847B6680dbF3e7d58CB2D573F25a513;
  ...
  function getReward() public updateReward(msg.sender) checkhalve {
    ...
    if (reward > 0) {
      ...
      ARTEON_TOKEN.safeTransfer(msg.sender, reward);
