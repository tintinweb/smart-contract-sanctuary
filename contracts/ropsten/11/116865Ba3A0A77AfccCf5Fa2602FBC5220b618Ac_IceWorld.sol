...
contract IceWorld is ERC721Enumerable, Pausable, PaymentSplitter {
   ...
   function giftReserve(address[] memory _address, uint256[] memory _id)
        external
        onlyOwner
        whenNotPaused
    {
    ...
    function giftMint()
        ...
        whenNotPaused
    {
     address[] memory _address = _giftAddress;
     uint256[] memory _id = _giftIds;
