...
// File contracts/hPools/HPoolToken.sol
...
contract HPoolToken is Context, IERC20Metadata {
     ...
     * construction.
     */
    function createToken(string memory name_, string memory symbol_, uint256 totalSupply_, address beneficiary) internal {
        _name = name_;
        _symbol = symbol_;
...
// File contracts/hPools/HPool.sol
