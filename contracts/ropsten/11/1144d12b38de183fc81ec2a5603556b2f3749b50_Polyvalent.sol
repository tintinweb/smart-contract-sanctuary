...
contract Polyvalent is ERC20, ERC20Detailed, Ownable {
    constructor () public ERC20Detailed("Polyvalent", "POLVT", 18) {
        _mint(_msgSender(), 12612500000 * (10 ** uint256(decimals())));
    }
