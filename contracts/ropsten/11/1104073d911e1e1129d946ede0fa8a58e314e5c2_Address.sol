...
// File contracts/BitCrawlerSyndicate.sol
...
/**
 * @title BitCrawlerSyndicate contract
 */
contract BitCrawlerSyndicate is Mintable, ERC721 {
    string private _baseURIPath;

    constructor(address _owner, address _imx) ERC721("BitCrawlerSyndicate", "BCS") Mintable(_owner, _imx) {}
