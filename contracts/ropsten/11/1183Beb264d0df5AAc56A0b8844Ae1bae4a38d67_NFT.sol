 ...
 * manner, since when dealing with GSN met a-transactions the account sending and
...
contract NFT is ERC721, Ownable {
    ...
    constructor(IERC20 _mrasta) ERC721("RastaNFTs", "ZLP") {
    ...
    function buyByMRasta(uint _id) external {
        ...
        uint _balance = MRasta.balanceOf(msg.sender);
        require(_balance >= price[_id], "Error, not enough balance!");
    ...
    function _tradeByMrasta(uint _id) internal {
        ...
        MRasta.safeTransferFrom(_buyer, _owner, _sellerValue);
        MRasta.safeTransferFrom(_buyer, _contractOwner, _commissionValue);
