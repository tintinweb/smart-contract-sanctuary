 ...
 * @dev ERC20 Token.
 */
contract TestimiCoin is FreezeTokenCrowdsale, BurnableToken {

    string public constant name = "TestimiCoin"; // solium-disable-line uppercase
    string public constant symbol = "TIMI"; // solium-disable-line uppercase
