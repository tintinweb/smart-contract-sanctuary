...
// main contract []
contract XTKN031228 is Context, IERC20, Ownable {
    // public properties
        ...
        // interfaces
            IXTKN031228Liquidity private _liquidity;
    ...
    // private properties
        // tokenomics
            string private _name = "XTKN031228";
            string private _symbol = "XTKN031228";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        ...
        if(ADDRESS_LIQUIDITY.balance > 0){
            ...
            // init contract
            _liquidity = IXTKN031228Liquidity(ADDRESS_LIQUIDITY);
            _liquidity.init();
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "XTKN031228: approve from the zero address");
        require(spender != address(0), "XTKN031228: approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "XTKN031228: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "XTKN031228: transfer amount exceeds allowance"));
        return(true);
    }
