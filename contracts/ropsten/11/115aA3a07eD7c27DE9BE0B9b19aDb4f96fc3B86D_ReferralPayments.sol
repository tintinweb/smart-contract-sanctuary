...
contract ReferralPayments is ReentrancyGuard {
    ...
    SupportedToken private stackETH;
    SupportedToken private stackUSDC;
    SupportedToken private stackWBTC;
    ...
    constructor() {
        ...
        _addToken(stackETH.location, stackETH.symbol);
        _addToken(stackUSDC.location, stackUSDC.symbol);
        _addToken(stackWBTC.location, stackWBTC.symbol);
    }
