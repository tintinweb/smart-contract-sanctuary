...
contract Ownable is Context {
    ...
    function AlteraLock(uint256 time) public virtual onlyOwner {
...
contract TestAltera is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x72943ec660341bdb373C3860C1ebbc2dAB6495d0); // Marketing Address
    ...
    string private _name = "TEST Altera";
    ...
    function removeGravity() private {
    ...
    function restoreGravity() private {
    ...
    function AlteraFrictionless() external onlyOwner {
        setAlteraRefuelEnabled(false);
        _taxFee = 0;
        _liquidityFee = 0;
