...
contract LockProxyBridgeWETH is LockProxyBridge {
    constructor(address _xvault)
        public
        LockProxyBridge(
            address(0xb603cEa165119701B58D56d10D2060fBFB3efad8), // WETH
            _xvault, // 0xD38fc89febb12e5D32FAa72e07d486a268b9C63A XWETH
            address(0xD8aE73e06552E270340b63A8bcAbf9277a1aac99), // https://github.com/polynetwork/docs/blob/master/config/README.md#ethereum Lock Proxy
            address(0xf989E80AAd477cB6059f366C0170a498909C4a55),  // https://github.com/polynetwork/docs/blob/master/config/README.md#ethereum 
            88
        )
    {}
}
...
contract LockProxyBridgeWBTC is LockProxyBridge {
    constructor(address _xvault)
        public
        LockProxyBridge(
            address(0x65058d7081FCdC3cd8727dbb7F8F9D52CefDd291), // WBTC
            _xvault, // 0x447b931Cc604A30dC16c49002f35a7AAb7888b78 XWBTC
            address(0xD8aE73e06552E270340b63A8bcAbf9277a1aac99), // https://github.com/polynetwork/docs/blob/master/config/README.md#ethereum Lock Proxy
            address(0xf989E80AAd477cB6059f366C0170a498909C4a55),  // https://github.com/polynetwork/docs/blob/master/config/README.md#ethereum ECCM
            88
        )
    {}
}
...
contract LockProxyBridgeUSDT is LockProxyBridge {
    constructor(address _xvault)
        public
        LockProxyBridge(
            address(0x6EE856Ae55B6E1A249f04cd3b947141bc146273c), // USDT
            _xvault, // 0xf15b5430321F4e51F5f534CeDAda7FbB78fA6680 XUSDT
            address(0xD8aE73e06552E270340b63A8bcAbf9277a1aac99), // https://github.com/polynetwork/docs/blob/master/config/README.md#ethereum Lock Proxy
            address(0xf989E80AAd477cB6059f366C0170a498909C4a55),  // https://github.com/polynetwork/docs/blob/master/config/README.md#ethereum ECCM
            88
        )
