...
contract UnityPresale is ReentrancyGuard {
     ...
     */
    constructor (uint256 token_rate, address payable receive_address, address token_addr, address[] memory _owners) {
    ...
    function _whiteListAddress(address addressToWhitelist) public onlyOwner {
        require(_openToPublic == false, "Presale: is already open to public");
