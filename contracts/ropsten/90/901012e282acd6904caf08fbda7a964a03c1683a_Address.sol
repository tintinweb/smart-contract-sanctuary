...
contract YUMMYToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 250 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "WEHUB Token";
    string private _symbol = "WEHUB";
    ...
    uint256 public _maxTxAmount = 250 * 10**1 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**1 * 10**9;
    ...
    constructor (address payable charityWalletAddress) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Uniswap address for all networks
