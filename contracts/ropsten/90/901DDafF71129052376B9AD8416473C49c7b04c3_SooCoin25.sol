...
contract SooCoin25 is Context, IERC20, Taxable {
    ...
    constructor () {
        ...
        ILO.init(100000000000000000, 20000, 20000, 80000, m_ILOPublic);
        initTax();
    ...
    function _swapTokensForETH(uint256 _amount) private lockTheSwap {
        ...
        // _approve(address(this), address(m_UniswapV2Router), _amount); //not needed, leaving commented for test
