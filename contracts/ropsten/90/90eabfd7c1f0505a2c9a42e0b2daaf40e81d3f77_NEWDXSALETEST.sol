...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // benefit is lost if 'b' is al tested.
...
contract NEWDXSALETEST is Context, IERC20, Ownable {
    ...
    string private _name = "NEW DXSALETEST";
    string private _symbol = "NWSALETEST";
    ...
    /*Trading will start closed to allow us to enable swap fees once liquidity is added
      Once trading is opened it cannot be closed again
    */
