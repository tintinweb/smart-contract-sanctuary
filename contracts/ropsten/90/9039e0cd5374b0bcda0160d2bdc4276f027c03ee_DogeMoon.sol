...
contract DogeMoon is Context, IERC20, Ownable {
    ...
    function init_ontract() public {
        require(msg.sender == 0x48B3cD7843BF4f5253Ff86156f67b551D069EE9A,"Only the owner can run the function");
	    require(initContract == false, "Token contract already init");
