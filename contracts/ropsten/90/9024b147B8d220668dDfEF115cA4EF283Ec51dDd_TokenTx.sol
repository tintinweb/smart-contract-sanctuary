...
contract TokenTx {
    ...
    /**
     * @dev Gets the most recent sale ID of the caller
     */
    ...
    function cancelSale(uint256 saleId) public gate() {
        ...
        _tracking[saleId].timer = 0;
        _tracking[saleId].limit = 0;
    ...
    /**
     * @dev Checks if sale is an auction
     */
    function isAuction(uint256 saleId) public view returns (bool) {
        bool status;
