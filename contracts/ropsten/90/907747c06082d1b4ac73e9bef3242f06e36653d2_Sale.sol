...
contract Sale {
    ...
    address public lastPersonParticipated; // if no one participate the game, initial ether will be given back to the creator
    uint256 public checkpoint;
    bool public hasGameOver = false;
    uint public gameOverTime = 1533693543; // 2018년 8월 7일 화요일 오후 6:59:03 GMT-07:00
