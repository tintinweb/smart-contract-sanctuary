...
contract Barn is Ownable, IERC721Receiver, Pausable {
   ...
   */
  constructor() { 
	address _woolf = 0xF085331d2Bcc405bF0b70ba346cf2174440A8A78;
...
contract Woolf is IWoolf, ERC721Enumerable, Ownable, Pausable {
  ...
  // mint price
  uint256 public constant MINT_PRICE = .00000069420 ether;
  ...
  function mint(uint256 amount, bool stake) external payable whenNotPaused {
    ...
    require(amount > 0 && amount <= 1000, "Invalid mint amount: The quantity cannot be more than 10000");
