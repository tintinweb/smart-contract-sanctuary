...
contract Staked is ERC20,PoSTokenStandard,Ownable {
    using SafeMath for uint256;

    string public name = "Staked";
    string public symbol = "STAKED";
    ...
    uint public stakeMaxAge = 10 days; // stake age of full weight: 90D
    ...
    function Staked() {
        maxTotalSupply = 500**21; // 10 Mil.
        totalInitialSupply = 20**21; // 1 Mil.
