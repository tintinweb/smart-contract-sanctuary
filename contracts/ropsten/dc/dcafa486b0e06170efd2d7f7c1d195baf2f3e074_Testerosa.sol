...
contract Testerosa is Context, IERC20 {
    ...
    string private _name = "Testerosasn";
    string private _symbol = "Testerosasnone";
    ...
    address payable private _marketingWallet = payable(0xCCF6ebfcA4437690f10af5754D508fa0C012F6EA);
