...
contract AntiWhale is Ownable {
    ...
    function activateAntiWhale() onlyOwner public {
        require (AntiWhaleActivated == false);
        AntiWhaleActivated = true;
    }
    
     function deActivateAntiWhale() onlyOwner public {
        require (AntiWhaleActivated == true);
        AntiWhaleActivated = false;
    }
    
    function setAntiWhale(uint256 _startDate, uint256 _endDate, uint256 _limitWhale) onlyOwner public
    {
    ...
    {
        if (msg.sender == owner() || AntiWhaleActivated == false || amount <= limitWhale)
        return false;
