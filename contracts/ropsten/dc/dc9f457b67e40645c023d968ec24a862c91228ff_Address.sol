...
EarlyRiser is built upon the fundamentals of Buyback and increasing the investor's value
...
contract EarlyRiser is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x35E8c87675b61be94bF639F3EfF36f6DFb90aB6B); // Marketing Address
    ...
    string private _name = "EarlyRiser";
