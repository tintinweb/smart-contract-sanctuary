...
contract CampaignFactory {
    ABRAND[] public deployedCampaigns;

    function createCampaign(string memory campaigntitle) public {
        ABRAND newCampaign = new ABRAND(campaigntitle);
        deployedCampaigns.push(newCampaign);
    }

    function getDeployedCampaigns() public view returns (ABRAND[] memory) {
...
contract ABRAND {
    ...
    function payInfluencer(address payable influencerAddress, uint totalLikesGet) public OnlyOwner payable returns(bool){
