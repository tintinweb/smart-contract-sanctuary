 ...
 */
abstract contract ERC721BMPStorage is ERC721 {
    using Strings for uint256;

    // Optional mapping for token URIs
    mapping(uint256 => string) private _tokenURIs;
    mapping(uint256 => bytes) private _tokenBMPs;
     ...
     * - `tokenId` must exist.
     */
    function _setTokenURI(uint256 tokenId, string memory _tokenURI, bytes memory _tokenBMP) internal virtual {
        require(_exists(tokenId), "ERC721URIStorage: URI set of nonexistent token");
        _tokenURIs[tokenId] = _tokenURI;
        _tokenBMPs[tokenId] = _tokenBMP;
    }
    ...
    // 32x32 pixel BMP header
    bytes private _header = hex"424d461000000000000046000000380000003000000030000000010020000300000000100000ec040000ec04000000000000000000000000ff0000ff0000ff000000000000ff";

    /**
     * @dev function to return base64 encoded string of icon
     */
    function tokenB64(uint256 tokenId) public view returns (string memory) {
        require(_exists(tokenId), "ERC721Portrait: B64 query for nonexistent token");
        bytes memory _tokenBMP = _tokenBMPs[tokenId];
        return string(encode(abi.encodePacked(_header, _tokenBMP)));

    }

    /**
     * @dev function to return bytes of icon including header
     */
    function tokenBMP(uint256 tokenId) public view returns (bytes memory) {
        require(_exists(tokenId), "ERC721Portrait: BMP query for nonexistent token");
        bytes memory _tokenBMP = _tokenBMPs[tokenId];
        return bytes(abi.encodePacked(_header, _tokenBMP));
