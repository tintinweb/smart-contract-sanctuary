...
//    	}
    ...
    function setStatus(uint8 col, uint8 row, string _s) public payable // setting status costs 1 eth to prevent spam
    {
//    	if(isOOB(col,row)) // row and/or col was not between 0-mapsize
//    	{
...
//    	}
    ...
    function buyTile(uint8 col, uint8 row) payable
    {    	
//    	if(isOOB(col,row)) // row and/or col was not between 0-mapsize
//    	{
//    		tx.origin.send(msg.value);              // return their money, if any
