...
contract RUBTCW is IERC20, Initializable {
    using SafeMathUpgradeable for uint256;

    string private constant _name = "Wrapped RUBTC";
    string private constant _symbol = "RUBTCW";
    uint8 private constant _decimals = 8;
    uint16 private constant WHOLE_TOKENS_NUM = 10000;
    ...
    function initialize() external initializer {
        founder = msg.sender;
        supply = WHOLE_TOKENS_NUM * (10 ** _decimals);
    ...
    function mint(uint256 amount) public onlyOwner {
        ...
        balances[founder] = balances[founder].add(amount);
        emit Transfer(address(0), founder, amount);
    }
