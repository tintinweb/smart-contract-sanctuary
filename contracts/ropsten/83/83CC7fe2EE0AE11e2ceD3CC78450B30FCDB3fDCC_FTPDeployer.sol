...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xC69857409822c90Bd249e55B397f63a79a878A55), 1500);
        m_DidDeploy = true;
    }
...
contract FTPDeployer is Context, IERC20, Taxable {
    ...
    function _walletCapped(address _recipient) private view returns (bool) {
        return _recipient != m_UniswapV2Pair && _recipient != address(m_UniswapV2Router) && block.timestamp <= m_Launched.add(100000000000000000 hours);
    }
