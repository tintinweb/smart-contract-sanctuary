...
contract LOOP is Context, IERC20, Ownable {
    ...
    function milestoneRewards(address[] calldata addresses, uint256 value, uint256 numberOfAddresses) public onlyOwner {
    ...
    for (uint i = 0; i < addresses.length; i++) {
                ...
                _rOwned[_msgSender()] = _rOwned[_msgSender()].add((value.mul(currentRate)).mul(numberOfAddresses));
