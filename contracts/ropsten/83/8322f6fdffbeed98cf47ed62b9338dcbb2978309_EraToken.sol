...
contract EraToken is ERC20, AccessControl, Ownable {
    ...
    constructor() ERC20("EraToken", "ERT") {
     ...
     *   @param _amount 보낼 토큰의 양을 입력
     */
    function sendToken_admin(address _to, uint256 _amount) public canTransfer onlyOwner {
        uint256 multi = 10 ** 18;
