...
contract AWF is Ownable, IERC20, IERC20Metadata {
    ...
    modifier isBlackListed(address sender, address recipient) {
        require(_blacklist[sender] == false && _blacklist[recipient] == false,'ERC20: Account is blacklisted from transferring');
        _;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual isBlackListed(sender, recipient) {
