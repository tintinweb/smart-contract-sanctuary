...
contract CryptoAnts is ERC721, ICryptoAnts, ReentrancyGuard {
  ...
  constructor(address _eggs, address _governanceAddress) ERC721('Crypto Ants', 'ANTS') {
    eggs = IEgg(_eggs);
  ...
  modifier onlyGovernance() {
    //solhint-disable-next-line
    require(msg.sender == governanceAddress, 'The function can only be called by governance');
    _;
  }
}
