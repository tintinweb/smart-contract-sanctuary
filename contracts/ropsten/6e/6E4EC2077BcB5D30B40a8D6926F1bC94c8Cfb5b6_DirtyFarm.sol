...
contract DirtyFarm is Ownable, ReentrancyGuard {
    ...
    function getDirtyPerBlock() public view returns (uint256, bool) {
        ...
        uint256 poolReward = 10000000000000000000000;
        if (poolReward == 0) {
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        user.rewardDebt = 0; // user.amount.mul(pool.accDirtyPerShare).div(1e12);
    ...
    function withdraw(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        user.rewardDebt = 0; //user.amount.sub(tempRewards).mul(pool.accDirtyPerShare).div(1e12);
