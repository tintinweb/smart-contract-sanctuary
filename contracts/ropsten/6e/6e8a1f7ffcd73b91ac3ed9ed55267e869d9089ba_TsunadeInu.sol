...
contract TsunadeInu is Context, IERC20, Ownable {
    ...
    string private _name = "Tsunade Inu";
    string private _symbol = "TSUNADE";
    ...
    event TransferInfo(bool overMinTokenBalance, address fromAddr, uint256 tokenBalance, uint256 minTokensBeforeSwap);
    function _transfer(
        address from,
        address to,
        uint256 amount
        ...
        emit TransferInfo(overMinTokenBalance, from, contractTokenBalance, minTokensBeforeSwap);
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            from != pancakePair &&
