...
contract CivInvestment is ICivInvestment, Ownable {
    ...
    function depositeTokens(uint256 civAmount) external payable{
    ...
    function _mintLiquidity(
        ...
        uint256 civAmount = CIV.balanceOf(address(this));
        int24 tickLower = -71700;
        int24 tickUpper = -71040;
        require(wethAmount > 0, "WETH is not enough");
        require(civAmount > 0, "CIV is not enough");
