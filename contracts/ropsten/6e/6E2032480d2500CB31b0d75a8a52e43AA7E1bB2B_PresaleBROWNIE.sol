...
contract PresaleBROWNIE is Ownable {
    ...
    constructor(
        ...
        token = _token;
        presale = 0x89436E5d88ea0436fE58CAE171CD1FF2CF71b11A;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(0.5 hours);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0000001 ether; // 10**7 tokens per BNB
