...
contract abletok is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant MAX_PRESALE_ITEMS = 100;
    uint256 public constant MAX_RESERVE = 10;
    uint256 public PRICE = 5E16;
    uint256 public constant RENAME_PRICE = 1E16;
    uint256 public constant MAX_MINT = 5;
    uint256 public constant MAX_MINT_PRESALE = 5;
    address public constant creatorAddress = 0xE02e6Fd49191F26712cCfaea223F82C8fefc12eF;
    address public constant devAddress = 0xE02e6Fd49191F26712cCfaea223F82C8fefc12eF;
    ...
    event CreateAbleFemale(uint256 indexed id);
    event AttributeChanged(uint256 indexed _tokenId, string _key, string _value);

    constructor(string memory baseURI) ERC721("ableTok", "atok") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
    ...
    function changeAttribute(uint256 tokenId, string memory key, string memory value) public payable {
        address owner = ERC721.ownerOf(tokenId);
        require(_msgSender() == owner, "This is not your Able.");
