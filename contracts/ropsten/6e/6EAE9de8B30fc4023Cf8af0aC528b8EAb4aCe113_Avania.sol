...
/**
 * @dev Interface of the IAvania.
 */
interface IAvania is IERC721 {
    struct Character {
        uint256 class;
        uint256 level;
        uint256 xp;
    ...
    /**
     * @dev Gets last pray timestamp
     */
    function lastPray(uint256 tokenId) external view returns (uint256);

    /**
     * @dev Gets pray experience
     */
    ...
    /**
     * @dev Gets required pray experience
     */
    function rquiredXP(uint256 level) external view returns (uint256);
     ...
     * @dev Gets full hero
     */
    function fullHero(address account) external view returns (bool);

    /**
     * @dev Gets character
     */
    function character(uint256 tokenId) external view returns (Character memory);

    /**
     * @dev Mints a character
     */
    function mint(uint256 classId) external returns (bool);

    /**
     * @dev Prays to earn xp
     */
    function pray(uint256 tokenId) external returns (bool);
     ...
     * @dev Sets hero class
     */
    function setHeroClass(uint256 heroClass_) external returns (uint256);
    ...
    /**
     * @dev Emitted when pray.
     */
    event Pray(address indexed account, uint256 indexed tokenId, uint256 indexed xp);

    /**
     * @dev Emitted when level up.
     */
    event LevelUp(address indexed account, uint256 indexed tokenId, uint256 indexed level);
}
