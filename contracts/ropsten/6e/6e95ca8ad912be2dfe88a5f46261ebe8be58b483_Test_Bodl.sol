...
contract Test_Bodl is Context, IERC20, Ownable { // change contract name
    ...
    address payable public _charityAddress = payable(0xeA450Af1E3ACC791bfA94a271D91f1346BFB34C7); // charity Address
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Test_Bodl"; // token name
    string private _symbol = "TEST_BODL"; // token symbol
    ...
    uint256 public _maxTokensPerAddress            = 1000000 * 10**6 * 10**_decimals; // Max number of tokens that an address can hold
