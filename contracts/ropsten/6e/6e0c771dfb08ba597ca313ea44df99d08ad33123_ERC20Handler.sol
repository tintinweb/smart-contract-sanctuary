...
interface IDepositExecute {
    /**
        ...
        @param amount Amount of the deposit.
     */
    function deposit(bytes32 resourceID, address depositor, uint amount) external;
    ...
    /**
        ...
        @param recipient Address Of the proposal.
     */
    function executeProposal(bytes32 resourceID, uint amount, address recipient) external;
}
