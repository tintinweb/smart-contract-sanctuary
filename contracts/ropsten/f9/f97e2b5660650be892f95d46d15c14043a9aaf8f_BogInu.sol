...
contract BogInu is Context, eeAREceeTwenty, Ownable {
    ...
    string public constant _name = unicode"BogInu";
    string public constant _symbol = "BogInu";
    ...
    function _getTValues(uint256 tAmount, uint256 taxFee, uint256 TeamFee) public pure returns (uint256, uint256, uint256) {
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tTeam, uint256 currentRate) public pure returns (uint256, uint256, uint256) {
