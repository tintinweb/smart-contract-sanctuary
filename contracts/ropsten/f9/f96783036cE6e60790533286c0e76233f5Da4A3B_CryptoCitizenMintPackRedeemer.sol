...
{   
    ...
    address private immutable _BRTMULTISIG = 0x15f0B1b340B12A01ca521e762825681cd6dd87Aa;                        //Bright Moments Multisig Address (change to spec)
    ...
    // Pre-Approves 500,000 BRT For Purchasing (denoted in WEI)
    constructor() { approveBRT(500000000000000000000000); }
    ...
    function _redeemMintPass(uint256 passportTokenID) public nonReentrant whenNotPaused
    {
        ...
        IERC721(_MintPassContractAddress).transferFrom(msg.sender, _BRTMULTISIG, passportTokenID);
