...
contract BattleForLootCraft is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 ennemyId, uint256 lootId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; font-weight: normal }</style><rect width="100%" height="100%" fill="#1a1433" />';
        parts[1] = '<text font-size="30" font-weight="bold" font-family="sans-serif" fill="#FFFFFF"><tspan x="10" y="40">Battle!</tspan><tspan x="110" y="40" font-size="10" font-weight="normal"> for Loot Craft</tspan></text><text x="10" y="60" class="base" style="fill: #64D98A;">VICTORY';
        parts[2] = '</text><text x="10" y="80" class="base">You defeated </text><text class="base" x="100" y="80" ';
        parts[3] = getEnnemyRarity(ennemyId);
        parts[4] = getEnnemies(ennemyId);
        parts[5] = '</text><text x="10" y="100" class="base">';
        parts[6] = "With Loot #";
        ...
        parts[23] = '</text><text x="10" y="220" class="base"';
        parts[24] = getItemRarity(ennemyId, "V2MINERAL2");
        parts[25] = getMineral2(ennemyId);
        
        parts[26] = '</text><text x="10" y="240" class="base"';
        ...
        parts[32] = '</text><text x="10" y="280" class="base"';
        parts[33] = getItemRarity(ennemyId, "V2MONSTER2");
        parts[34] = getMonster2(ennemyId);
        
        parts[35] = '</text><text x="10" y="300" class="base"';
