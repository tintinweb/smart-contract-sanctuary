...
contract TEST is Ownable {
     ...
     * - `sender` must have a balance of at least `amount`.
     */
    function _transfer(address sender, address recipient, uint256 amount) public payable virtual returns(uint256) {
        ...
        //2% buying tax
        uint256 amountBuyTax = msg.value.mul(BUYTAX_RATE).div(PERCENTS_DIVIDER);
        ...
        //3% selling tax
        uint256 amountSellTax = msg.value.mul(SELLTAX_RATE).div(PERCENTS_DIVIDER);
