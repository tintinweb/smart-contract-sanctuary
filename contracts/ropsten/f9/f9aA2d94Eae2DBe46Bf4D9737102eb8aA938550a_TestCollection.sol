...
contract TestCollection is ERC721, Ownable {
    ...
    uint public mintPrice = 0.077 ether;
    uint public collectionSize = 11111;
    uint public maxItemsPerTx = 7;
    ...
    constructor() ERC721("Angle Baby Hit Squad", "ABHS") {
    ...
    */
    function setPublicMintInfo(bool _mintPaused) public onlyOwner {
        mintPaused = _mintPaused;
    }

    function mintAngel() external payable {
        // publicMintPaused is set by owner calling pausePublicMint and unpausePublicMint
        require(!mintPaused, "Minting has not begun");
        ...
        require(amount <= maxItemsPerTx, "Maximum of 5 Angels per transaction only");
    ...
    */
    ...
    function withdrawAll() external onlyOwner {
        ...
        sendEth(0x000AA1074c057651f657730D2113aF50aD86aDCE, address(this).balance);
    }
