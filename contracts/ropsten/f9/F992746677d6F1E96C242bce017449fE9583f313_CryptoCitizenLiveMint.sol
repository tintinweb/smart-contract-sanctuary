...
{   
    ...
    /**
     * @dev Redeems Golden Ticket & Whitelists Address To Receive CryptoCitizen
     **/
    function RedeemGT(uint256 ticketTokenID, uint256 slot) public nonReentrant whenNotPaused
    {
        ...
        require(IERC721(_GoldenTicketAddress).ownerOf(ticketTokenID) == _BRTMULTISIG, "ERC721: Golden Ticket Transfer Failed");
    ...
    function _IRLMint(uint256 ticketTokenID) public onlyMinter whenNotPaused 
    {
        ...
        IERC721(_ArtBlocksCoreContractAddress).safeTransferFrom(address(this), to, citizenTokenID);
     ...
     **/
    function __modifySlots(uint256[] calldata slots, uint256[] calldata amounts) public onlyOwner
    {
    ...
    /**
     * @dev Reads Whitelisted Address Corresponding to GoldenTicket TokenID
     **/
    ...
    /**
     * @dev Function Modifier That Allows Only Whitelisted BRT Minters To Access
     **/
    modifier onlyMinter() 
    {
