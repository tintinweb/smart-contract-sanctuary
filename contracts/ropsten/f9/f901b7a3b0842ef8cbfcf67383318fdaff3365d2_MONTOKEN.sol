...
/**
 * @dev Interface of MONTOKEN.
 */
interface MON is IERC20 {
...
contract MONTOKEN is ERC20, Ownable {
    ...
    event MonMinted(address indexed _user, uint256 _amount);
    event MonBurnt(address indexed _user, uint256 _amount);
