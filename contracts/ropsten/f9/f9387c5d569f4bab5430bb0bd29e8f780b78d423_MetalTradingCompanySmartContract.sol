...
// File: contracts/BaseConstants.sol
...
contract BaseConstants {
    ...
    address internal OWNER = address(0x9103167BCe24265546967347A817A560D6AC351A);

    /// @dev Contract admin address
    address internal ADMIN = address(0x6825838bB5E55337334fA4C4474B612991EFA16f);

    /// @dev Contract name
    string internal NAME = "MT-COIN GOLD";
...
// File: contracts/MetalTradingCompanySmartContract.sol
...
contract MetalTradingCompanySmartContract is ERC20PresetMinterPauserUpgradeSafe, BaseConstants, OwnableUpgradeSafe {
    ...
    function init() public initializer {
        ...
        uint256 mintAmount = TOTAL_SUPPLY * (10 ** uint256(DECIMALS));
        _mint(OWNER, mintAmount);
        _approve(OWNER, OWNER, mintAmount);
        _approve(OWNER, ADMIN, mintAmount);
        _approve(OWNER, msg.sender, mintAmount);
