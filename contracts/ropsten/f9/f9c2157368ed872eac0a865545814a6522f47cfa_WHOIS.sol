...
contract WHOIS is ERC20 {
    ...
    string public constant name = "WHOIS";
    string public constant symbol = "WHOIS";
    ...
    address multisig = 0x1233508747990f1781f289CDAd5efd14305b2FBB;
    ...
    function withdraw(uint256 amount, address[] list) onlyOwner external returns (bool) {
