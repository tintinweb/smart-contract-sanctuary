...
contract BabyTTTT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0x7f5a752BDadB1422c8cd1629B48303Cd2bE017A9); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x486DB40e941cFBE8c1826004bAa12F015F42a702); // Ecosystem Wallet
    address payable private devWallet = payable (0x362300aAa22c09d1Ef49082104808a76338E9F65); // dev Wallet
    ...
    string private _name = "BabyTTT";
    string private _symbol = "BBYTTT";
    ...
    uint256 private sellMaxTxPercent = 10; // Less fields to edit
