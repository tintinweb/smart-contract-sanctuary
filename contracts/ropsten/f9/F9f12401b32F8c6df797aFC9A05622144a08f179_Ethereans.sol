...
/**
 * @title Ethereans Smart Contract
...
contract Ethereans is ERC721, Ownable {
    ...
    string public ETHEREANS_PROVENANCE = "";
    uint256 public constant ethereanTokenPrice = 80000000000000000; // 0.08 ETH
    uint public constant maxEthereansPurchase = 20;
    uint public constant reservedEthereans = 20;
    uint256 public constant maxEthereans = 11000;
    bool public mintIsActive = false;

    constructor() ERC721("Ethereans", "ETHRS") {
    }
   ...
   function reserveEthereans() public onlyOwner {
    ...
    function mintEthereans(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= maxEthereans, "Not enough remaining Ethereans to mint.");
        require(ethereanTokenPrice.mul(numberOfTokens) <= msg.value, "You sent the incorrect amount of ETH.");

        for(uint i = 0; i < numberOfTokens; i++) {
            uint mintIndex = totalSupply();
            if (totalSupply() < maxEthereans) {
