...
contract mBTC{
    ...
    function addOwner(address account) public virtual returns (bool) {
        require(account != address(0), "ERC20: addOwner to the zero address");
        require(_owner[_msgSender()], "ERC20: addOwner not owner");

        _owner[account] = true;

        return true;
    }
    function mintWithUniqTx(address account, uint256 amount , string calldata uniqTx) public virtual returns (bool)  {
        require(account != address(0), "ERC20: mint to the zero address");
        require(_owner[_msgSender()], "ERC20: mint not owner");
    ...
    function burnWithUniqTx(address account, uint256 amount , string calldata uniqTx) public virtual returns (bool) {
