...
contract DarkMatter is DelegateERC20, Ownable {
    uint256 private constant preMineSupply = 5000000 * 1e18; // initial supply  minted 5.000.000 KDM
   ...
   event SetDeflationController(address indexed _addresss);
    ...
    function mint(address account, uint256 _amount) public{
        require(totalSupply().add(_amount) <= maxSupply, "KDM: Minting this amount exceeds max supply");
  ...
  function setDeflationController(address _address ) external {
    ...
    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "DarkMatter: _delMinter is the zero address");
