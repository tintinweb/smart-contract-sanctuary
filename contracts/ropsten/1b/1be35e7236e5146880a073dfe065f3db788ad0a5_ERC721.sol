...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Pausable, MinterRole, PauserRole, Ownable {
    ...
    */
    ...
    function admin_burn(uint256 tokenId) public onlyOwner {
        require(_exists(tokenId), "ERC721: operator query for nonexistent token");
        _burn(tokenId);
    }
