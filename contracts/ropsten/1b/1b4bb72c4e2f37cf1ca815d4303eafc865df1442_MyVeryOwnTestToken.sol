...
contract MyVeryOwnTestToken is Context, IERC20, Ownable {
	...
	string private _name = "MyVeryOwnTestToken";
	string private _symbol = "MYTEST";
	...
	function _transfer(address from, address to, uint256 amount) private {
		...
		if (from != owner() && !tradingEnabled) require(tradingEnabled, "Trading is not enabled yet");
