...
contract EthMiners is ERC721Enumerable, ReentrancyGuard, Ownable {
    using Strings for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;

    address public constant OG_MINER = 0xE0c73218b3b9A5A71e9d654f2E38c1Bbf238311d;
    uint256 public constant PUBLIC_SALE_ENDING_PRICE = 0.0893 ether;
    uint256 public constant MAX_MINER = 8930;
    ...
    constructor() ERC721("ETH Miners", "ETHM") {
    }

    function forAirdrop() public onlyOwner{
        for (uint256 i; i < 30; i++) {
            _safeMint(OG_MINER, i);
        }
    }
    ...
    function preSale(uint256 count) public payable nonReentrant {
        ...
        require(minted + count < MAX_MINER, "total supply is 8930");
    ...
    function _distribute() internal {
        payable(address(OG_MINER)).transfer(address(this).balance);
    }
