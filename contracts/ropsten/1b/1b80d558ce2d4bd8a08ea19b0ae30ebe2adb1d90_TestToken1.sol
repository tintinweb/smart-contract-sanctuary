...
contract TestToken1 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100000000000000 * 10**9; // One hundred trillion
    ...
    string private constant _name = "TestToken1";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                ...
                if(contractETHBalance > 400000000 * 10**9) {
