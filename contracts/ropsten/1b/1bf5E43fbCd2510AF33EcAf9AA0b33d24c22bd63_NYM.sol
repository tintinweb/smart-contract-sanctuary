...
contract NYM is Context, Ownable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    function _createNym(string memory newName) internal {
        ...
        require(balanceOf(sender) == 0, "NYM NFT: It's not allowed to own multiple NYM tokens");
    ...
    */
    ...
    function _safeTransfer(address from, address to, uint256 tokenId, bytes memory _data) internal virtual {
        require(balanceOf(to) == 0, "NYM NFT: It's not allowed to own multiple NYM tokens");
