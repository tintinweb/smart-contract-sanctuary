...
contract VineAuction is ERC721 {
    ...
    constructor () ERC721 ("Vina Vepar", "VEPAR"){
        ...
        auctionEndTime = block.timestamp + 600;
        //_safeMint(beneficiary, 0);//creator NFT
        //_setTokenURI(0, "https://ipfs.io/ipfs/QmXi44R136Xtht9bfsRijQ442H1HyaoYatpCbY5xQp9JRY?filename=hvar.json");
    }

    function inssuranceDeposit(address payable _to, uint deposit) public payable {
        // Call returns a boolean value indicating success or failure.
        // This is the current recommended method to use.
        (bool sent, bytes memory data) = _to.call{value: deposit}("");
    ...
    function claimPhysicalItem() public {
        ...
        inssuranceDeposit(payable(address(this)), inssurance);
        itemClaimed=true;
    }
