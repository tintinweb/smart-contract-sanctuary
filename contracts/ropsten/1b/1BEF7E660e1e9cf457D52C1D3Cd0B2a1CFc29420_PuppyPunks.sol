...
contract PuppyPunks is ERC721, Ownable {
    ...
    uint256 public publicTokenPrice = 0.000015 ether;
	uint public maxPerTx = 40;
	uint public maxFreeMintPerWallet = 20;
	uint public amountAvailableFreeMint = 20;
    ...
    function mint(uint numberOfTokens) external payable {
        ...
        require(numberOfTokens <= maxPerTx, "You can mint 5 at a time.");
