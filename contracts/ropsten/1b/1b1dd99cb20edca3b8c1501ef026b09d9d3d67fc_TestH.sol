...
contract TestH is Context, IERC20, Ownable {
    ...
    uint256 private startingSupply = 100_000_000_000; //100_B, underscores aid readability
    ...
    string private _name = "TestH";
    string private _symbol = "TestH";
    ...
    address payable private _marketingWallet = payable(0xC48778DC431FE25899AC8b35E245b53C1e3dfBfB);
