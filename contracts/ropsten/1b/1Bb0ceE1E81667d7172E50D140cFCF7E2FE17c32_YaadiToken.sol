...
contract YaadiToken is Context, IERC20, Ownable {
    ...
    address  public communityAddress = 0xF9D4cC7D127dD4A8B9Ce8e4400e5E5CdAb381c76;
    ...
    constructor() public {
        ...
        address _uniswapV2RouterAddr= 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //Ropsten test net
        ...
        sPrice = 59880*10**18;
        //startSale(block.number, 999999999, 0,5898*10**9, 50000000000);
    }
    ...
    function _takecharity(uint256 tcharity) private {
        uint256 currentRate =  _getRate();
        uint256 rcharity = tcharity.mul(currentRate);
        _rOwned[communityAddress] = _rOwned[communityAddress].add(rcharity);
        if(_isExcludedFromReward[communityAddress])
            _tOwned[communityAddress] = _tOwned[communityAddress].add(tcharity);
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if (tcharity > 0) emit Transfer(sender, communityAddress, tcharity);
    }
