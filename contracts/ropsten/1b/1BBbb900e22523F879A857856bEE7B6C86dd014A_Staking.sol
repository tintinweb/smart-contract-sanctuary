...
library SafeERC20 {
     ...
     *
     * Whenever possible, use {safeIncreaTokenllowance} and
...
contract Staking is Ownable, ReentrancyGuard {
    ...
    // Token tokens created per block. default 1.
    ...
    function updatePool() internal {
        ...
        rewardToken.mint(address(this), tokenPerBlock);
        
        accTokenPerShare = accTokenPerShare.add(tokenPerBlock.mul(1e12).div(tokenSupply));
        lastRewardBlock = block.number;
    }
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        if (_amount > 0) {
            ...
            _amount = stakingToken.balanceOf(address(this)).sub(balanceBefore);   
