...
contract Genesis_Voxmon is ERC721, Ownable {
    ...
    */
    ...
    uint public constant REROLL_COST = 10000000 gwei; // 0.01 ether
    ...
    string public __baseURI = "https://voxmon.com/token/";

    // this will let us differentiate that a token has been locked for 3D art visually
    string public __lockedBaseURI = "https://voxmon.com/locked/";
    ...
    address[] votedWL = [
        0xa018D14C7516f11526A70c8f83B654b4f06b9F5a
    ];

    address[] earlyDiscordWL = [
        0xc43314B6f3c945e222528D63f8FaDE8E59f47B98
    ];

    address[] foundingMemberWL = [
        0xF16a69F293EAbF3595dd0e92dbDB94C8E9C295ad
    ];
    ...
    */
    ...
    function tokenHaRequested3DArt(uint256 tokenId) external view returns (bool) {
    ...
    */  
    ...
    function reroll(uint256 tokenId) payable public returns (uint256) {
        require(ownerOf(tokenId) == msg.sender);
        require(msg.value >= REROLL_COST, "not enough ether, rerolling costs 0.01 ether");
        require(tokenIdToFrozenForArt[tokenId] == false);
