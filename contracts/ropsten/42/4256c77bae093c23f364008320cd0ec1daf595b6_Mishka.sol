...
// For every transaction, 2.4% goes to holders, and 0.1% goes to our teddy bear charity wallet.
...
contract Mishka is Context, IERC20, Ownable {
    ...
    address private constant _cBoost = 0xdD870fA1b7C4700F2BD7f44238821C26f7392148; // Charity Wallet
   ...
   address[] private _excluded;
    ...
    string private _name = 'Mishka';

    string private _symbol = 'MISHKA';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256) {
        ...
        uint256 tFee = tAmount.mul(24).div(1000);
