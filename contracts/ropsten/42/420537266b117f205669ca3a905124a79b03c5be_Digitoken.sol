...
contract Digitoken is ERC20Interface, SafeMath {
    ...
    constructor() {
        ...
        daoSupply = 50000000;
        devFund = 50000000;
        digidao_address = 0xBbbc2C8D646a6905889dE1Ac8Cc5e965A0cFb0bE; //Change to hardcoded dao controller address 
        devFund_address = 0x6DcC9B0F2737207C432a8253037e7F8DE97fF982; //Change to hardcoded dev address
