...
contract etest4 is Context, IERC20, Ownable {
    ...
    string private _name = 'eTest4';
    string private _symbol = 'eTest4';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 0; // 
    uint256 private _marketingFee = 4; // 4% marketing
    uint256 private _liquidityFee = 6; // 6% into liquidity

    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    address payable private _marketingWalletAddress = payable(0x5F2384B31D9B3AF5e864356200EEC6B29A59245b);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 1000000 * 10**9;
    ...
    function _setNumTokensSellToAddToLiquidity(uint256 numTokensSellToAddToLiquidity) external onlyOwner() {
        require(numTokensSellToAddToLiquidity >= 1000000000 * 10**9 , 'numTokensSellToAddToLiquidity should be greater than total 1e9');
