...
contract NetflixNShill is Context, IERC20, Ownable {
    ...
    string private _name = "NetflixNShill";
    ...
    uint256 public _liquidityFee = 9; //(2% liquidityAddition + 5% rewardsDistribution + 2% marketing/dev)
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 forRewards = contractTokenBalance.div(6);
        // split the liquidity
