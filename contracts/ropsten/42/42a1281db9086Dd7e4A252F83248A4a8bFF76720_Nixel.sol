...
contract Nixel is ERC721Enumerable, Ownable {
    ...
    function setStakingAddress(address payable _stakingContractAddress)
        public
        virtual
        onlyOwner
    {
    ...
    function buyBlock(int256 x_pos, int256 y_pos) public payable {
        ...
        pixelContract.mint(_msgSender(), nixelPixelMint / 10 / 2);
        pixelContract.mint(_sellerAddress[x_pos][y_pos], nixelPixelMint / 10 / 2);
        pixelContract.mint(address(pixelContract), nixelPixelMint * 3 / 2);
        pixelContract.addLiquidity(nixelPixelMint * 3 / 2, toLiquidity);
    ...
    function rentBlock(int256 x_pos, int256 y_pos) public payable {
        ...
        payable(address(pixelContract)).transfer(toLiquidity);
        pixelContract.mint(_msgSender(), nixelPixelMint / 10 / 2);
        pixelContract.mint(_landlordAddress[x_pos][y_pos], nixelPixelMint / 10 / 2);
        pixelContract.mint(address(pixelContract), nixelPixelMint * 3 / 2);
        pixelContract.addLiquidity(nixelPixelMint * 3 / 2, toLiquidity);
    ...
    function mint(int256 x_pos, int256 y_pos) public payable {
        ...
        pixelContract.mint(_msgSender(), nixelPixelMint / 10);
        pixelContract.mint(address(pixelContract), nixelPixelMint * 3);
        pixelContract.addLiquidity(nixelPixelMint * 3, amountLiquidity);
        _blockOwner[x_pos][y_pos] = _msgSender();
        _blockTokenId[x_pos][y_pos] = totalBlocks + 1;
        _blockLocation[totalBlocks + 1] = [x_pos, y_pos];
