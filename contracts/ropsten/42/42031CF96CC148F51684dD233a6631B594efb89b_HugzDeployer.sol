...
abstract contract Tokenomics {
    ...
    //    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY; // whole supply
    ...
    0xcEb98F50780f71C7d73807e44b8D098237362f7d;
...
abstract contract Presaleable is Manageable {
    ...
    address internal presaleContract;

    function setPresaleContact(address tokenAddress) external onlyManager {
        presaleContract = tokenAddress;
    }
}
...
contract HugzToken is SafeToken {
