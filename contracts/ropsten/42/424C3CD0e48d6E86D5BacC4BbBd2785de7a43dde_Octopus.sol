...
contract Octopus is Ownable {
    ...
    function sell(address _optionAddress, uint256 _weiNotional) payable public {
        ...
        if (IOption(_optionAddress).isPut()) {
            usdCollateral = calculateCollateralForPut(_optionAddress, _weiNotional) * 1e6;
    ...
    function _withdrawUSDTFees() public onlyOwner {
    ...
    function _withdrawETHFees() public onlyOwner {
