...
contract ShkoobyStake is Ownable {
    ...
    function getUserStakeDetails(uint256 _stakeId) public view returns(uint256[] memory, uint256[] memory){
        ...
        uint [] memory userStakeDetailsArray = new uint[](8);
        ...
        userStakeDetailsArray[4] = getUnclaimedRewards(userStakeDetails.stakePoolId);   
    	userStakeDetailsArray[5] = userStakeDetails.lastClaimedTime;
        userStakeDetailsArray[6] = userStakeDetails.status;
        userStakeDetailsArray[7] = userStakeDetails.createdTime;
