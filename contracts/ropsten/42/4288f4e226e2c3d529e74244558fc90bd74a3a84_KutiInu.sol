...
/* 
    ...
    Telegram: https://t.me/Kutiinu
    Twitter: https://twitter.com/KutiInu
...
contract KutiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kuti-Inu";
    string private constant _symbol = "Kuti";
    ...
    uint256 public _buyLiquidityFee = 1e15;
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 120;
        _rOwned[address(this)] = _rTotal / 1000 * 880;
        ...
        marketingAddress = payable(0x936ff23DAe7c040459255819437392CFB32a8c61); // Marketing Address
        
        devAddress = payable(0x936ff23DAe7c040459255819437392CFB32a8c61); // Dev Address
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 120 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 880 / 1000);
    }
