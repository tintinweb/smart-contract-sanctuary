...
contract Envision is IERC20, Ownable {
      ...
      returns (bool)
    {
        ...
        emit Transfer(msg.sender, burnWalletAdress, _value.mul(burnWalletFee).div(totalFeePercent));
   ...
   function transferFrom(
      ...
      returns (bool) 
    {
        ...
        emit Transfer(_from, burnWalletAdress, _value.mul(burnWalletFee).div(totalFeePercent));
