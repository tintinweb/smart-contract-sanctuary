...
contract Mit is Context, IERC20, Ownable {
    ...
    address payable public maintainanceAddress = payable(0xc48f641d4d473DD0C469aD2372E72D9A6e1BE6F1); // Maintainance Address
    address payable public developmentAddress  = payable(0xc48f641d4d473DD0C469aD2372E72D9A6e1BE6F1); // Development Address
    address payable public marketingAddress    = payable(0xc48f641d4d473DD0C469aD2372E72D9A6e1BE6F1); // Marketing Address

    string private _name = "Mit"; //token name
    string private _symbol = "$Mit"; // token symbol
