...
contract Fleurons is ERC721, ERC721Enumerable, Ownable {
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    // Background-color
    parts[1] = string(abi.encodePacked('<path d="M0 0h500v500H0V0z" style="fill:', bg, '#6abd45" />'));
    ...
    parts[8] = string(abi.encodePacked('<text fill="rgba(255,255,255,.9)" transform="translate(19.033 482.207)" font-weight="bold" font-size="12" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, monospace">', year, ' Fleuron #', count, '</text>'));
    parts[9] = '</svg>';
