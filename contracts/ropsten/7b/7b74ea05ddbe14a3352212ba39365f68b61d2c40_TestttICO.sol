...
/**
 * @title Token
 * @dev API interface for interacting with the TESTTT Token contract 
 */
interface Token {
...
/**
 * @title TestttICO
 * @dev TestttICO contract is Ownable
 **/
contract TestttICO is Ownable {
  ...
  /**
   * TestttICO
   * @dev TestttICO constructor
   **/
  function TestttICO(address _tokenAddr) public {
