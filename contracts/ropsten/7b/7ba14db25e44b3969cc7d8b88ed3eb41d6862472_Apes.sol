...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(uint256 => address) private _isOGMinter;
    ...
    function Originalminter(uint256 tokenId) public view virtual returns (address) {
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        ...
        require(_isOGM(_msgSender(), tokenId), "ERC721: transfer caller is not original minter, unlock NFT with unlock function");
        
        _transfer(from, to, tokenId);
    }
    function unlock(uint256 tokenId, address to) public payable  {
    ...
    function _isOGM(address spender, uint256 tokenId) internal view virtual returns (bool) {
        ...
        address isOG = ERC721.Originalminter(tokenId);
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    address[] private _isOG;
    address[] private _isOGMinter;
...
contract Apes is ERC721Enumerable, Ownable {
    ...
    uint256 public unlockNFT = 100000000000000000;
