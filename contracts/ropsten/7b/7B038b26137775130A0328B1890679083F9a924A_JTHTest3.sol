...
contract JTHTest3 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "JTHTest3";
    string private m_Symbol = "JTH3";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 5000, 2000, m_ILOPublic);
        initTax();
