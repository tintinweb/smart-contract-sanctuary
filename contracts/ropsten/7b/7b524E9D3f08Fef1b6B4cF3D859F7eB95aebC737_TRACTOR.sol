...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0xB553398041991941707D075cEA123335130B879B;
...
contract TRACTOR is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x8047F98eA4aA0A03078e14F2E3D7F67C8e7F45FB;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TRACTOR2 N";
    string private _symbol = "TRACTOR2";
