...
//SPDX-License-Identifier: MIT
    ...
    contract DaasFinance is Context, IERC20, Ownable {
        ...
        uint256 private _maxTxAmount = _tTotal.mul(150).div(10000); 
        uint256 private _maxWalletLimit = _tTotal.mul(300).div(10000);
    ...
    function delBot(address notbot) public onlyOwner {
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if(recipient != uniswapV2Pair) {
                require(balanceOf(recipient).add(amount) <= _maxWalletLimit, "Transfer will exceed wallet limit");
            }
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= _tTotal.mul(100).div(10000), 'maxTxAmount should be greater than 1%');
            _maxTxAmount = maxTxAmount;
        }

        function setMaxWalletLimit(uint256 newLimit) external onlyOwner() {
            require(_maxWalletLimit >= _tTotal.mul(200).div(10000), 'maxTxAmount should be greater than 1%');
            _maxWalletLimit = newLimit * (10**9);
        }
    }