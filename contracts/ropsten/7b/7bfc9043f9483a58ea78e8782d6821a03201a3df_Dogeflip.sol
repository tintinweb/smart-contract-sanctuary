...
contract Dogeflip is SafeMath, ERC20Interface {
	...
	uint public MaxAmountToBet = 20000000000000000000000; //Max bet is currently 20,000 Dogeflip (We can make it variable- to be discussed)
    ...
    // Information to inteface to the Website and/or App
    event Status(
		string _msg, 
		address user, 
		uint amount,
