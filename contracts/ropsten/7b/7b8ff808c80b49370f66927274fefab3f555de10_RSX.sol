...
contract RSX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0x308FB53a0B199aB5C2e6EE863D020E85893d071d); 
    ...
    string private _name = "RSX";
    string private _symbol = "RSX";
    ...
    uint256 private minimumTokensBeforeSwap = 100000000 * 10**6 * 10**9; 
