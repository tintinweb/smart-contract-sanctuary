...
contract Helkin  is IBEP20, Auth {
    using SafeMath for uint256;
    address DOGE = 0xdAC17F958D2ee523a2206206994597C13D831ec7;
    address WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Helkin";
    string constant _symbol = "HK";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 222222 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x583dd101087608c68c5DEC86454506b004F127AA;
