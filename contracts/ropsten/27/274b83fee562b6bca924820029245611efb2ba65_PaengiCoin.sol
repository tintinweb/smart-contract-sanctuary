...
contract PaengiCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PaengiCoin() {
        ...
        name = "PaengiCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PCO";                                             // Set the symbol for display purposes (CHANGE THIS)
