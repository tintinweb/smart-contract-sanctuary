...
contract IDO is Ownable{
    ...
    uint256 public supplyYouForPriIEO = 5*10**11;//50万
    uint256 public reservedYouOfPriIEO = 0;
    uint256 public constant upperLimitUsdtOfPriIEO = 500*10**6;//500USDT
    ...
    uint256 public targetUsdtAmountOfPubIEO = 5*10**10;//5万USDT
    uint256 public targetYouAmountOfPubIEO = 5*10**11;//50万YOU
    ...
    uint256 public constant bottomLimitUsdtOfPubIEO = 100*10**6; //100USDT
    ...
    address private constant _usdtAddress = 0xFA8B1212119197eC88Fc768AF1b04aD0519Ad994;
    address private constant _youAddress = 0x7C8D25108E588f858c80f3451F32748382851609;
    ...
    function initOrder(address account) external {
        delete _ordersOfPriIEO[account];
        delete _ordersOfPubIEO[account];
    }
    //=======================
    ...
    function privateOffering(uint256 amountOfUsdt) inWhiteList external returns (bool)  {
        ...
        require(amountOfUsdt <= upperLimitUsdtOfPriIEO,'YouSwap: EXCEED_THE_UPPER_LIMIT');

        require( supplyYouForPriIEO > reservedYouOfPriIEO,'YouSwap:INSUFFICIENT_YOU');
        uint256 amountOfYou = 10 * amountOfUsdt;//0.1YOU/USDT
        if(amountOfYou + reservedYouOfPriIEO > supplyYouForPriIEO){
            amountOfYou = supplyYouForPriIEO - reservedYouOfPriIEO;
            amountOfUsdt = amountOfYou/10;

            priOfferingFinished = true;
        }
        _transferFrom(_usdtAddress,amountOfUsdt);

        _ordersOfPriIEO[msg.sender] = amountOfYou;
