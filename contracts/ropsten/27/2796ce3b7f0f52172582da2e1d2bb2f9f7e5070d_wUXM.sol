...
contract ERC20Permit is ERC20, ERC20Detailed {
    ...
    function chainID() public pure returns (uint256 _chainID) {
        assembly {
            _chainID := chainid()
        }
    }
...
contract wUXM is ERC20, ERC20Detailed, ERC20Permit {
    ...
    constructor(INXM _nxm) public ERC20Detailed("Wrapped UXM", "wUXM", 18) {
        NXM = _nxm;
    }
