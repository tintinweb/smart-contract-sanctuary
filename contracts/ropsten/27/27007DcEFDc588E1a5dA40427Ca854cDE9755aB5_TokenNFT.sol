...
contract TokenNFT is ERC721, ERC721Metadata, SquareFactory, StringUtils {
    address proxyRegistryAddress;

    mapping(uint256 => uint256) public _sTokenPositionsSquare;
    mapping(uint256 => bool) public _sPositionsSquare;
    ...
    function _mint(
        ...
        require(!_sPositionsSquare[positionSquare], "Already minted");
        require(
        ...
        _sPositionsSquare[positionSquare] == true;
    ...
    function isAvailableSquare(uint256 positionSquare)
        public
        view
        returns (bool)
    {
        return _sPositionsSquare[positionSquare];
    }
