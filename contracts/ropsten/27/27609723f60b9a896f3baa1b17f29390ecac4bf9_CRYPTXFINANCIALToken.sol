...
//safe maths ensures that the mathematical operations work as intended
contract SafeMath {                 
...
contract CRYPTXFINANCIALToken is Interface, SafeMath {
    ...
    constructor() public {
        ...
        balanceOf[0xE184B6Ab25b93af0C69d861AE3fb04Ed46e975BE] = 162500000000000000000000000; // Number of tokens for the crowd sale
        balanceOf[0xee8E5F10D7af6b24D975437113DF615e8AaDdd68] = 87500000000000000000000000; // Number of tokens retained 
        emit Transfer(address(0), 0xE184B6Ab25b93af0C69d861AE3fb04Ed46e975BE, 162500000000000000000000000);
        emit Transfer(address(0), 0xee8E5F10D7af6b24D975437113DF615e8AaDdd68, 87500000000000000000000000);
    }
