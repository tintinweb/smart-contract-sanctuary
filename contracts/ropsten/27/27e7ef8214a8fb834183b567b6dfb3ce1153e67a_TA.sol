...
contract TA is Ownable{
    ...
    function setApprovedAddress(address _transferAgentAddress) private onlyOwner {
        require(!approvedAddressList[_transferAgentAddress]);
        approvedAddressList[_transferAgentAddress] = true;
    }
    
    function removeApprovedAddress(address _transferAgentAddress) private onlyOwner{
        require(approvedAddressList[_transferAgentAddress]);
