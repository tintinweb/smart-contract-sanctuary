...
contract PhlippedLarvaBrats is ERC721Enumerable, Ownable {
    ...
    string public baseExtension = ".svg";
    uint16 public counter = 0;
    uint8 public giveaway = 2;
    uint8 public constant maxPublicPurchase = 1;
    ...
    constructor(string memory tokenBaseUri) ERC721("PhlippedLarvaBrats", "BRATS") {
        counter = counter + 1;
