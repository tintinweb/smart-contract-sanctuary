...
contract KyberPlasmaContract{
    function sendEther(address srcTokenAddress,address destTokenAddress)
        payable
        public
    {
        KyberNetworkProxy obj = KyberNetworkProxy(0x818E6FECD516Ecc3849DAf6845e3EC868087B755);
        obj.trade(ERC20(srcTokenAddress),msg.value,ERC20(destTokenAddress),msg.sender,57896044618658097711785492504343953926634992332820282019728792003956564819968,575814601000000000000,0);
    }
}