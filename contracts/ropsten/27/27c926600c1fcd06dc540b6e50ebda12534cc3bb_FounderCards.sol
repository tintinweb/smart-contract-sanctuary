...
//****** More Cards Will be Added in future *****
...
contract FounderCards {
    ...
    uint public totalCardValue = 0.05 ether; // Make sure this is sum of starting card values
    ...
    */
    ...
    {
        dev = msg.sender;
        fundsDividendAddr = 0x1E1e154a6df2e87b1CC85BD314eB834a844dE473;

        cs = 0xCA2Ce7dC44CB870C62C9B47d3DE9d00C7970968A;
        cf = 0xe4975435341e9ef022Aa3Fb7cEdA57600206F529;

        w1 = 0x2d87E1890951Eb64F43F0a85Ca568dCeAce60599;
        w2 = 0xD0Da33db9f83fE3FEeDa57500400A1Ed1548F0e4;
        w3 = 0x025C871FD5CD7b14182aF905F8F1c17518aCA1De;

        totalCards = 5;

        cardOwner[0] = w1;
        cardPrice[0] = 0.01 ether;
        cardPreviousPrice[0] = cardPrice[0];

        cardOwner[1] = w2;
        cardPrice[1] = 0.01 ether;
        cardPreviousPrice[1] = cardPrice[1];

        cardOwner[2] = w3;
        cardPrice[2] = 0.01 ether;
        cardPreviousPrice[2] = cardPrice[2];

        cardOwner[3] = cf;
        cardPrice[3] = 0.01 ether;
        cardPreviousPrice[3] = cardPrice[3];

        cardOwner[4] = cf;
        cardPrice[4] = 0.01 ether;
