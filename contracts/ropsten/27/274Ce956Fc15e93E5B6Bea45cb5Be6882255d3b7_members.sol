...
function onePercent() public view returns (uint256)  {
	 uint256 oneShare = AmountToken.div(2).div(16);
			return oneShare;
	}
	function transferTwo() public payable returns (bool) {
	  	require(members[msg.sender], "You are not a member");  
	...
	function transferThree() public payable returns (bool) {
	  	require(members[msg.sender], "You are not a member");  
