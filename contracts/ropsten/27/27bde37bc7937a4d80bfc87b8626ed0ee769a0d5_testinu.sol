...
contract ERC20test is Context, ERC20 {
    constructor(
...
contract testinu is ERC20test {
    constructor() ERC20test("test inu", "test", false, true, 900, 25, msg.sender, 3000000000 * 10 ** 18, msg.sender, 30) {
    }
}