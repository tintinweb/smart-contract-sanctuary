...
contract LiadLomed is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc25c0fc96f6DD191f5e03877970c743a7133DE74); // Marketing Address
    ...
    string private _name = "Liad Lomed";
    string private _symbol = "LiadL";
