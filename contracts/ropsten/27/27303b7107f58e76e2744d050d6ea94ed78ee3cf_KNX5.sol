...
contract KNX5{
    ...
    function betfortoken() public payable {
        require(msg.value >= 0.01 ether && msg.value <= address(this).balance);
        ...
        ERC20Interface(0x82d987E8c27DB4a75Dd22D770335a5E5435252CD).transferFrom(address(this), msg.sender, 150000000000000000000);
        win = msg.value;
        uint8 _random = random();
