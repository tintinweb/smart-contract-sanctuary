...
contract stake {
    ...
    IBEP20 private busd = BEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); 
    ...
    constructor(LandToken _token, address _buyback, address _owner) public {
        owner = _owner; 
        token = _token; 
        buyback = _buyback;
    }
