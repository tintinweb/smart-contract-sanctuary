...
contract ERC20 is Context, IERC20 {
    ...
    uint public stakingFee = 60; //0.6% divisor 100
    uint public liquidityFee = 60; //0.6% divisor 100
    uint public teamFee = 40; //0.4% divisor 100
...
contract Tenup is ERC20 {
    constructor() public ERC20("Tenup", "TUP") {
        _mint(msg.sender, 200000000 ether); // Mint fixed supply of 150 Million FKX
    }
}