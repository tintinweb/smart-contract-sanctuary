...
contract Kryptopunk is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Kryptopunk", "KP") {
    setHiddenMetadataUri("ipfs://QmRjNQUzeDcriFrhtj1tqa8euFw4ajsYVSLmVkeED4qeFB/hidden1.json");
  }
