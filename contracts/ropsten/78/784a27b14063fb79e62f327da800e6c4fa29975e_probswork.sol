...
contract probswork is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "plswork2";                                           // name
    string private _symbol = "plswork2";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x2a52ea10083A9712cD110475e4793699459a9000);
