...
contract LPTokenWrapper is Ownable, ReentrancyGuard {
    ...
    IERC20 public BSKTASREWARD = IERC20(0x3d3c60970D3369e48f79664787433fc0d2B7C44b);  // Approve and Transfer BSKT-ETH-LP Token for stake
...
contract BsktEthLPPool is LPTokenWrapper {
    ...
    IERC20 public STAKEBSKT = IERC20(0x4Bec13aB192280763A201a30ca093a3d0a15b3DC); // Basket token address
