...
contract TheDogePound is ERC721, Ownable {
    ...
    constructor(string memory _name, string memory _symbol) ERC721(_name, _symbol) {
        ...
        mintPrice = 90000000000000000; // 0.09 ETH
        maxToPurchase = 30;
        saleIsActive = false;
    }
     ...
     */
    function setMaxToPurchase(uint256 _maxValue) external onlyOwner {
        maxToPurchase = _maxValue;
    }

    /**
     * Mint Doges by owner
     */
    function reserveDoges() external onlyOwner {        
        uint256 supply = totalSupply();
        uint256 i;
        for (i = 0; i < maxToPurchase; i++) {
    ...
    */
    function mintDoges(uint256 numberOfTokens) external payable {
        ...
        require(numberOfTokens <= maxToPurchase, "Can only mint 20 tokens at a time");
