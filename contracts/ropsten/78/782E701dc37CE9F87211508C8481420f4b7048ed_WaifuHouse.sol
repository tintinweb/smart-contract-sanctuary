    ...
    Ownable
{
    ...
    event WaifuBuilt(uint256 firstTokenId, uint256 secondTokenId, uint256 builtWaifuTokenId);
  ...
  event Claim(IERC721 indexed token, uint256 id, bytes32 indexed hash, address seller, address taker, uint256 price);
    ...
    constructor(
        ...
        _shareholders[0] = 0xeEEb5a14ff494A8D20F90CF12Be73Cd8b1c9A74D;
        _shareholders[1] = 0xd0fFF29a9bB5C3D8AFeB0FBC5c5272614C2300d8;
        _shareholders[2] = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db; //Test address
    ...
    function buidWaifu(uint256 firstTokenId, uint256 secondTokenId) public {
        require(buildingIsActive && !saleIsActive, "Either sale is currently active or cooking is inactive");
