...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x9000ab6dB5d47C58b424Ef91Ea9136D19d55106c), 5500);
        m_DidDeploy = true;
    }
...
contract FTPNo1 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "FTPNo1";
    string private m_Symbol = "FTPNO1";
