...
contract Sin is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "test1";                                           // name
    string private _symbol = "test1";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xDA4C05505348C8BCF89b9a9aF3e37d7d15f33F23);
