...
// Telegram: @GenshinNinjas
/**
 
   # GenshinNinjas deflationary tokenomics
   
   3% fee auto add to the liquidity pool 
   5% fee auto moved to dev wallet
   1% going to the holders
   1% going to burn wallet
...
contract GenshinNinjas is Context, IERC20, Ownable {
...
mapping (address => bool) public _isBlacklisted;
    ...
    address public _devWalletAddress = 0xF43Bd5F6a9cCe6eEf4F2F36eB0fEFa17d724021D;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000 * 10**12 * 10**9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GenshinNinjas";
    string private _symbol = "NINJAS";
