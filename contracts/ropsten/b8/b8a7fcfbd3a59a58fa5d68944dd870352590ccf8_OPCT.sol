...
contract OPCT is Log, Ownable {
    ...
    function SetApplicant(string _name, string _birth, string _fingerprint, string _portfolioURL) external {
    ...
    function GetApplicant(address _applicant) external view returns(string, string, string, string) {
