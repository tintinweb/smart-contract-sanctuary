...
contract BoringBananasCo is ERC721, Ownable {
    ...
    uint256 public constant bananaPrice = 12000000000000000; // 0.012 ETH

    uint public constant maxBananaPurchase = 20;

    uint256 public constant MAX_BANANAS = 128;
    ...
    constructor() ERC721("Boring Bananas Co. 2 test", "BBC2") { }
