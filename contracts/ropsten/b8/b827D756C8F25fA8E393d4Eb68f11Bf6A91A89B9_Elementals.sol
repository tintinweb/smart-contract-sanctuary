...
contract Elementals is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function reserveEarth() public onlyOwner {
        _mintEarth(20);
    }

    function reserveWater() public onlyOwner {
        _mintWater(20);
    }

    function reserveFire() public onlyOwner {
        _mintFire(20);
    }

    function reserveWind() public onlyOwner {
        _mintWind(20);
    }

    function reserveLightning() public onlyOwner {
        _mintLightning(20);
    }
