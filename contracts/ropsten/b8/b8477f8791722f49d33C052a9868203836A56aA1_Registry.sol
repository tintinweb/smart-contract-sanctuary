...
contract Registry is IRegistry, AccessControl, VersionedInitializable {
    ...
    **/
        ...
        override
    {
        ...
        require(r.user == address(0), "register: address is already registered");
    ...
    function removeRegisteration(bool approve)
        external
    {
        REGISTRATION storage r = registry[_msgSender()];

        require(r.approved == true, "removeRegisteration: registration already deactivated");
