...
contract Foufoul is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address public tikiContract1 = address(this);
    address payable public tikiContract = payable(tikiContract1); 
    address payable public marketingAddress = payable(0xB294f94b7111051F963083c1eDA1199b212e0390); // Marketing Address
...
// Anti-bot and anti-whale mappings and variables    
    ...
    string private _name = "Foufoul";
    string private _symbol = "FOU";
    ...
    address private constant _addressUniswapV2Router02 = 0xf164fC0Ec4E93095b804a4795bBe1e041497b92a;  
 ...
 /* Mainnet router: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function callMoonShot(uint256 amount) external onlyOwner(){
        // MoonShots will be activated at holder milestones during RiseMyTiki launch phase, but eventually will be controlled through a community-consensus based dApp.
    ...
    function activateTrading() external onlyOwner {
        ...
        _maxWalletAmount = 1100000 * 10**6 * 10**9;
        TDEnabled = true;
        setTDTime(45 seconds);
    }
