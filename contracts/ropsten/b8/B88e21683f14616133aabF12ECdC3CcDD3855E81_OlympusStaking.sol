...
contract OlympusStaking is OlympusAccessControlled {
    ...
    function unstake(
        ...
        sOHM.transferFromStaking(msg.sender, address(this), _amount);
    ...
    function _send(
        ...
        sOHM.transferStaking(_to, _amount); // send as sOHM (equal unit as OHM)
        return _amount;
    ...
    function setDistributor(address _distributor) external onlyGovernor {
        ...
        sOHM.approve(_distributor, sOHM.totalSupply());
