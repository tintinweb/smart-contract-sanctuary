...
interface INoBSFactory {
    ...
    function createReflector(address requester, address tokenToReflect) external payable returns(address);
    function createAdditionalReflector(address requester, address tokenToReflect) external payable returns(address);
...
import "./INoBSRouterV1.sol";

interface INoBSMultiReflectionRouterV1 is INoBSRouterV1 {
