...
// File: localhost/contract/implement/YouswapAssetManagerV1.sol
...
contract YouswapAssetManagerV1 is IYouswapAssetManagerV1 {
    ...
    mapping(address => bool) public minters;//提取资产名单
    ...
    function withdraw(address _token, address _to, uint256 _amount) override external returns (bool) {
    ...
    function mintYou(uint256 amount) override external returns (bool) {
        you.mint(address(this), amount);
        return true;
    }
