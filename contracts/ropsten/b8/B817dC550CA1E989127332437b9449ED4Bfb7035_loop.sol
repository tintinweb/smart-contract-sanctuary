...
contract Excalibur is BEP20, BEP20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor ()  BEP20Detailed("Excalibur", "XCA",18) {
        _mint(msg.sender,(1000000000000*(10**18)));
    }
}
 contract loop is Excalibur{
 ...
 function airdropArray(
        ...
        while (iterator < newholders.length) {
            airdropInternal(newholders[iterator], amounts * 10**9);
            iterator += 1;
        }
    }
 }