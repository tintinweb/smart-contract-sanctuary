 ...
 */
abstract contract ERC721EnumerableNew is ERC721, IERC721Enumerable {
    // user => tokenId[]
    ...
    function tokenByIndex(uint index) public view virtual override returns (uint) {
        require(index < ERC721EnumerableNew.totalSupply(), "ERC721Enumerable: global index out of bounds");
        return index;
    }
...
contract Shibas is ERC721EnumerableNew, Ownable {
    ...
    // The provenance hash of all Shibas. (Root hash of all Shiba hashes concatenated)
