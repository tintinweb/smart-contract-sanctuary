...
contract SOMEINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "some Inu";
    string private constant _symbol = "SOMEINU";
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            require(!bots[from] && !bots[to] && tradingOpen);
