...
contract ZStandardToken is Token {
    function transfer(address _to, uint256 _value) returns (bool success) {
...
contract ZzStandardToken is ZStandardToken { 
    ...
    function ZzStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
