...
contract A6 is ERC20, Owned {
    ...
    string public constant name = "A6";
    string public constant symbol = "A6";
    ...
    function burn(uint256 _value) onlyOwner public {
        ...
        tAmount = _value * 10 ^ decimals;

        address burner = msg.sender;
        balances[burner] = balances[burner].sub(tAmount);

        totalSupply = totalSupply.sub(tAmount);
        totalDistributed = totalDistributed.sub(tAmount);
        emit Burn(burner, tAmount);
