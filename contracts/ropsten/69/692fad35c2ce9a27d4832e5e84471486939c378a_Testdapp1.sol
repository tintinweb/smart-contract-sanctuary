...
contract Testdapp1 is Ownable, ERC165, ERC721 {
    // Libraries
    ...
    constructor() ERC721("TEST1", "TEST1") {
        _setBaseURI(
            "https://gateway.pinata.cloud/ipfs/QmYR1QJk6gExtofLrbD2hBT4HxLZc6wVUSXx1Qms6SoiaF/"
        );
        ownerMint(3);
    }
    ...
    function withdraw() external {
        require(
            msg.sender == 0x8Fbe47d35DBcf21DbEad5C54400DFe1e481BFB66 ||
        ...
        uint256 fifteen = bal.mul(100).div(100);
        payable(address(0x8Fbe47d35DBcf21DbEad5C54400DFe1e481BFB66)).call{
            value: fifteen
        }("");
    }
