...
contract ElonsRockets is Context, IERC20, Ownable, VRFConsumerBase {
    ...
    string private _name = "Light Yagami Inu";
    string private _symbol = "LYAGAMI";
    ...
    uint256 constant INITIAL_BUYBACK_DELAY = 4 minutes;
    uint256 constant MIN_LAUNCH_DELAY = 1 minutes;
    uint256 constant MAX_LAUNCH_DELAY = 12 minutes;
    ...
    function iLoveInari() external onlyOwner() {
        ...
        launchTime = block.timestamp.add(INITIAL_BUYBACK_DELAY);
    }
