...
contract AbyssSafe1 is AbyssSafeBase {
    // uint256 private constant unlockTime_ = 86400; // mainnet
    uint256 private constant unlockTime_ = 60; // testnet

    constructor(address token, address lockup, uint256 abyssRequired) AbyssSafeBase(token, lockup, unlockTime_, abyssRequired) {
    }
}
