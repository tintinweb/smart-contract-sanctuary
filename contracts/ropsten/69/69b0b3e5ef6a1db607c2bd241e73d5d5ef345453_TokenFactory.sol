...
// File: DressShow/source/SafeMath.sol
...
// File: DressShow/source/IERC20.sol
...
// File: DressShow/source/Context.sol
...
// File: DressShow/source/Ownable.sol
...
// File: DressShow/source/Token.sol
...
contract Token is Context, IERC20, Ownable {
    ...
    function initialize(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) public onlyOwner {
        require(_totalSupply == 0, "Already Initialize");
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
...
// File: DressShow/source/TokenFactory.sol
...
contract TokenFactory is Ownable {
    ...
    function Create(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) public onlyOwner{
        ...
        token.initialize(name_, symbol_, decimals_, totalSupply_);
