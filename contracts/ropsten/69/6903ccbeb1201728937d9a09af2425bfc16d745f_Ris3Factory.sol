...
contract Ris3Factory is Ownable {
    ...
    ris3Gov public government = ris3Gov(0x0F90202C9899EF170B51F762266cD5E1aef201ef);
    IERC20 public ris3 = IERC20(government.getRis3Address());
    IERC20 public lpToken = IERC20(0x9B22F9A64534f49734c250C49767687E8935f436);
    ...
    function governmentBurnTokens() public {
        ...
        require(msg.sender == address(government), "Only government can burn tokens in factory");
