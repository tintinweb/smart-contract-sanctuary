...
contract MockUSDTMintable is ERC20Capped {
    ...
    */
    constructor ()
        public ERC20Capped(100000000e6)    // sets cap to 100 million USDT
        ERC20("Fake-USDT", "FAKEUSDT")      // sets name and symbol to "Fake-USDT" and "FAKEUSDT"
    {
        _setupDecimals(6);  //sets the stored value (`_decimals`) to 6 to match USDT
        presetMintAmount = 1000e6; //allows users to mint 1000 USDT
