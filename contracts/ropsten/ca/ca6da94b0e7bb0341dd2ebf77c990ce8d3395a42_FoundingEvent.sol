...
interface I{
	...
	function addLiquidityFTM(address token,uint amountTokenDesired,uint amountTokenMin,uint amountETHMin,address to,uint deadline)external payable returns(uint amountToken,uint amountETH,uint liquidity);
...
contract FoundingEvent {
	...
	function _createLiquidity() internal {
        ...
        I(router).addLiquidityFTM{value: address(this).balance}(_letToken,1e6,0,0,staking,1e50);
