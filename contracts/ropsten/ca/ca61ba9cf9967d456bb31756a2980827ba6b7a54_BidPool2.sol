...
contract DebugUtil{
        ...
        event DebugValue(address indexed from, address indexed to, uint value);
        event DebugString(address indexed from, address indexed to, uint value, string  str);
...
contract SwapETHOptimal is ReentrancyGuard , DebugUtil{
    ...
    constructor(address _bid) public {
        ...
        weth = router.WETH();
        lptoken = factory.getPair(weth, bid);
    }
        ...
        nonReentrant
    {
        ...
        if (wethBalance > 0) {
                IWETH(weth).deposit.value(wethBalance)();
        }
...
contract BidPool2 is LPTokenWrapper, Ownable,SwapETHOptimal{
    ...
    address public constant bidaddress=0x0B9e3B13d0B462608A8516AEA1114ea7B9bb5a6F;
    ...
    function autoStakeETHPool2() external payable {
        doETH2UniswapStake();
