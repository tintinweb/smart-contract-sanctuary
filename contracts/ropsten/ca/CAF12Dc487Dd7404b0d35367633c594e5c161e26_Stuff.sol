...
//TODO Permit users to mint tokens
//TODO collect eth and make sure
//TODO reserve first 100 0-99
//TODO Be able to change the purchase price or do a sale
//TODO set account(s) to receive the eth
//TODO limit number that can be limited by an address
//TODO write tests
...
contract Stuff is ERC721Enumerable, Ownable {
    ...
    // Team addresses for withdrawals   //ropsten
    ...
    address public Treasury = 0x1737c4c2beadAA82E4E07bE25c58b4eC2a22C639;

    constructor () ERC721 ("Stuff", "STF") {
        setBaseURI("ipfs://x/");
        setNotRevealedURI("ipfs://xyz/hidden.json");
    }
