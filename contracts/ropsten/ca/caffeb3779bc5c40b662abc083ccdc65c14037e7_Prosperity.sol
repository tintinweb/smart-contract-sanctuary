         ...
         (
            (
                ...
                SafeMath.sub(
					...
					(sqrt
                        (
                            1e18*(_tokenPriceInitial**2)
                            +
                            1e18*(2*(_tokenPriceIncremental)*(_ethereum * 1e18))
                            +
                            1e18*(((_tokenPriceIncremental)**2)*(_tokenSupply**2))
                            +
                            1e18*(2*(_tokenPriceIncremental)*_tokenPriceInitial*_tokenSupply)
                        )
