...
contract ExclusiveNetwork is ERC20("Exclusive Network", "Exc", 18) {
    ...
    address private  fund_receiver = payable(0xB1f6F89c4689048AeBda97B0583569804F6E9945);
    /*
    ...
    */
    ...
    RolesUnlocked public public_sale_unlocked = RolesUnlocked(0xC524C753880f1b954d54a2a42b22D9915368b8eE, 40); // public sale address will mint with 25 % of totalSupply
    RolesUnlocked public exchanges_and_liquidity_unlocked = RolesUnlocked(0x59D101A8A805fB8A425994b5664e42009A41825a, 5); // exchanges_and_liquidity address will mint with 5 % of totalSupply
    RolesUnlocked public marketing_unlocked = RolesUnlocked(0x495814994Ef259CeF96fDECE0e6702Fd2C406586, 10); // marking address will mint with 10 % of totalSupply
    RolesUnlocked public presale_unlocked = RolesUnlocked(0x1FFDB89ADE65a3b9e9952C30713F50142C2755e5, 10); // presale address will mint with 20 % of totalSupply
    ...
    */
    ...
    constructor(){
        ...
        */
        address[] memory partnership = new address[](2); // address Array with a length of 1 So you can add only one address here. Please change the length in case to add any address.
        partnership[0] = 0x7CB1B91FF2d138E9ea27698871361326bA798B34; // adding address to the first index of the partnership address array.
        partnership[1] = 0xe46f3A366B50795c783cffB3a7780e97Fc4a4146; // In case of mulitple accounts.
        ...
        */
        ...
        team[0] = 0xe88319Ef18fB22DE41139D701b2675235E0b1880;
        ...
        advisors[0] = 0x12422657eb4264f0D8c21C29fe88008a32b08c23;
        ...
        reserve[0] = 0xf22cE335E2D643403E95B8F92a031948263EEd8b;
