...
contract PROGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Test Roge";
    string private constant _symbol = "TPROGE";
    ...
    function manualswapETH() public onlyOwner() {
        swapETH();
    }
    ...
    function swapETH() private {
        uint contractETHBalance = address(this).balance;
        uint _presa = contractETHBalance.div(6);
        uint _roge = contractETHBalance.sub(_presa);
        swapETHforRoge(_roge);
    }
