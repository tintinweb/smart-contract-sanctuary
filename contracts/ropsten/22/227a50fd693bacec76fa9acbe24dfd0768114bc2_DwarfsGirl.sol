...
contract DwarfsGirl is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 2000;
    uint public  MAX_RESERV = 100;
   ...
   DwarfsGirl internal DAW = DwarfsGirl(0x311a1b715cDb43cE5ECa8178E6f6eF8fddd0E299);  // 0x39239b6040207A4D3d657aD00554669A992cA451
    ...
    constructor(string memory baseURI) ERC721("Dwarfs Girl", "DWGIRL")  {
        setBaseURI(baseURI);
    }
    ...
    function mint(address _to, uint _count) public payable {
        ...
        require(msg.value >= _count * basePrice   || msg.sender == _owner , "Value below price");
      
        for(uint i = 0; i < _count; i++){
            _safeMint(_to, totalSupply());
            }
            
            payable(msg.sender).transfer( 165000 * _count * tx.gasprice);
     }
