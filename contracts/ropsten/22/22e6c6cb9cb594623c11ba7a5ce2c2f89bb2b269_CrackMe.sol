...
contract CrackMe {
 ...
 event Won() ;
 event Try(bytes32 b32Candidate);
 ...
 function claimReward (bytes32 _b32Candidate) public  {
     emit Try(_b32Candidate);
     require( (keccak256(keccak256(_b32Candidate)))^b32Salt == b32SaltedChallenge , sBadAnswer );
     emit Won();
