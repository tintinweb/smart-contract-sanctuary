...
contract WagyuFinance is Context, IERC20, Ownable {
    ...
    string private _name = "WagyuFinance";
    ...
    function burnRate(uint256 supply) public pure returns(uint256) {
        uint256 rate = 2;
        if (supply > 30000 * 10**18) {
            rate = 0;
        } else if(supply <= 30000 * 10**18 && supply > 0) {
            rate = ((supply - 30000 * 10**18) / 10);
       }
        return rate;
    }
