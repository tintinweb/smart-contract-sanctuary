...
modifier onlyOwner(){
    ...
    ****************************************/
    ...
    function lock(uint8 _days, uint256 amount) external {
        ...
        lockingTimeEnds[msg.sender] = block.timestamp + (_days * 86400);
    ...
    ****************************************/
    ...
    {
        require(transferFrom(msg.sender, address(this), _amount), "Transfering not approved!");
    }
    ...
    {
        require(transfer(receiver, _amount), "Not enough tokens on contract!");
    }
