...
contract PolygonPunksMarket is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public claimPrice = 10**16;
    ...
    constructor () ERC721("PolyPunks", "\xCF\x81") {
    ...
    function buyPunk(uint256 tokenId) payable public {
        ...
        require(ERC721.ownerOf(tokenId) == offer.seller, "Not punk seller");
    ...
    function withdrawBidForPunk(uint256 tokenId) public {
        require(tokenId < 10000, "Out of tokenId");
        require(ERC721.ownerOf(tokenId) != _msgSender(), "Invalid bid");
