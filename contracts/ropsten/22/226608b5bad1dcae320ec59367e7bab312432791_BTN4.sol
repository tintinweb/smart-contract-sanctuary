...
contract BTN4 {
    ...
    string public name = "BITCHAIN4";
    string public symbol = "BTN4";
    uint8 public decimals = 18;
    // 18 decimals is the strongly suggested default
    uint256 public totalSupply;
    uint256 public btnSupply = 100000000;
    ...
    /// @notice Buy tokens from contract by sending ethereum no minimum contribution
    function () payable internal {
        ...
        require(msg.value >=0);                        // so any person who wants to put more then 0.1 ETH has time to think about what they are doing
