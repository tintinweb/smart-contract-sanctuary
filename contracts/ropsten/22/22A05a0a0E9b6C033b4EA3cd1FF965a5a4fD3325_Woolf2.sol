...
contract Woolf2 is IWoolf, ERC721Enumerable, Ownable, Pausable {
    // mint price
    ...
    function convertBytesToBytes32(bytes memory inBytes) internal pure returns (bytes32 outBytes32) {
    if (inBytes.length == 0) {
        return 0x0;
    }
    assembly {
