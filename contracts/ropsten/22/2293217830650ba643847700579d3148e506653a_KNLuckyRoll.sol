...
contract KNLuckyRoll{
    ...
    function PlayX5() public payable {
        ...
        if (_random +20 >= 100) {
            if(win < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, win);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
        } else {
            emit PlayResult(msg.sender, msg.value, false, 0x0);
        }
    }
    ...
    function Playforfreetoken() public payable {
        ...
        require(ERC20Interface(0x82d987E8c27DB4a75Dd22D770335a5E5435252CD).balanceOf(address(this)) >= 150000000000000000000);
        ...
        if (_random + 50 >= 100) {
            if(msg.value < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
            ...
            emit PlayResult(msg.sender, msg.value, false, 0);
        }
    }
