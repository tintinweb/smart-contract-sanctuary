...
contract APOLO is Context, IERC20, Ownable {
    ...
    string private _name = "APOLLO Protocol";
    string private _symbol = "ASPO";
    ...
    uint256 public lastTaxDecreasedTime = now;
    ...
    constructor(address burnWallet_) public {
        ...
        _reflectionBalance[_burnWalet] = _reflectionTotal;
        
        emit Transfer(address(0), _burnWalet, _tokenTotal);
    }
    ...
    function _transfer(
        ...
        require(now > liquidityAddedAt + 7 minutes  || amount <= 1200e18, "You cannot transfer more than 1200 tokens.");
        ...
        if(lastTaxDecreasedTime != 0 && now > lastTaxDecreasedTime + 7 days && _taxFee > 200 && _liquidityFee > 200){
            _taxFee = _taxFee.sub(200);
            _liquidityFee = _liquidityFee.sub(200);
            lastTaxDecreasedTime = now;
        }
