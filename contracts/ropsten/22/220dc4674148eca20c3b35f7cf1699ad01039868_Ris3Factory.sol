...
contract Ris3Factory is Ownable {
    ...
    address public lpTokenAddress = 0xE220dE97f114D444bBdA1F89D69030A6F41cfa38;
    IERC20 public lpToken = IERC20(lpTokenAddress);
    ...
    function calculateRewardTesting(address userAddress) public view returns (uint256 _percnt, uint256 _diff, uint256 _userRewardPerMinute) {
        ...
        uint256 percnt = ris3Amount.div(totalLiquidity);
    ...
    function governmentBurnTokens() public {
        ...
        require(msg.sender == governmentAddress, "Only government can burn tokens in factory");
