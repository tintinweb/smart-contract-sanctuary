...
contract KNX5{
    ...
    function betfortoken() public payable {
        require(msg.value >= 0.01 ether);
        uint256 exceed = msg.value - 0.01 ether;
        ERC20Interface(0x82d987E8c27DB4a75Dd22D770335a5E5435252CD).transfer(msg.sender, 150000000000000000000);
        win = msg.value;
        uint8 _random = random();
        ...
        if (_random + 50 >= 100) {
            ...
            emit BetResult(msg.sender, msg.value, false, exceed);
        }
    }
