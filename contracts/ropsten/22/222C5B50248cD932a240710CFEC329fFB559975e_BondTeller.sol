...
contract BondTeller is ITeller, AccessControlled {
    ...
    IStaking internal staking; // contract to stake payout
    ITreasury internal treasury;
    IERC20 internal OHM;
    IsOHM internal sOHM; // payment token
    ...
    function setContract(address _depository, address _staking, address _treasury) public {
        require(_depository != address(0), "Zero address: Depository");
        depository = _depository;
        require(_staking != address(0), "Zero address: Staking");
        staking = IStaking(_staking);
