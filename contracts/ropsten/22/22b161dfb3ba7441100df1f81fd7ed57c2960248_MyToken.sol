...
contract MyToken is ERC721 {
    ...
    constructor(IStudentsRegistry registry, ReplyCoin coin) ERC721("MyToken", "MT") {
        _registry = registry;
        _coin = coin;
    }
    ...
    function createToken(uint256 value) public returns(uint256) {
        ...
        require(_registry.isStudent(msg.sender), "Only registered students can create tokens");
    ...
    function _transfer(address sender, address recipient, uint256 id) internal virtual override {
