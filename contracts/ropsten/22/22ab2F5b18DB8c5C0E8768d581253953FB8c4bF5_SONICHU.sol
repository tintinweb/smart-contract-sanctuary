...
contract SONICHU is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "Sonichu";
    string private m_Symbol = "SONICHU";
    ...
    address payable m_EthReflectSvcAddress = payable(0x7EE2Fae03007431A758e187dff538405dDE8Ca5A);
    uint256 m_EthReflectAlloc;
    uint256 m_EthReflectAmount;
    // ANTIBOT
    FTPAntiBot private AntiBot;
    address private m_AntibotSvcAddress = 0x590C2B20f7920A2D21eD32A21B616906b4209A43;
