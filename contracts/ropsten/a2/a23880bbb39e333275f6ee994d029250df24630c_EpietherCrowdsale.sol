...
contract EpietherToken is MintableToken {
...
contract EpietherCrowdsale is Ownable {

    using SafeMath for uint256;

    EpietherToken public token;
    ...
    function EpietherCrowdsale() public {
        token = new EpietherToken();  
        startTime = now; 
        rate = 62360;
        wallet = 0xD394bEB1D5059D4Cd21f3797Ef9b189dC524b22f;
