...
contract Freezable is Ownable {
        ...
        event MultiFreezed(address[] indexed targets);
        event MultiUnfreezed(address[] indexed targets);
...
contract MTCT09 is StandardToken, Pausable, Freezable {
        using SafeMath for uint256;

        string  public  name = "MTCT09";
        string  public  symbol = "MTCT09";
        uint256 public  constant decimals = 12;
        
        event MultiTransfer(address[] indexed recipients, uint256[] values, uint256 totalTransfered, bool[] result);
