...
contract TogashiInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x8a436C58fe104294A99Eb3ef7f6deD27C0a77b43);
        _feeAddrWallet2 = payable(0x8a436C58fe104294A99Eb3ef7f6deD27C0a77b43);
   ...
   function relaunchMode() internal view returns(bool){
	return relaunchTime!=0 && block.timestamp <= relaunchTime + 30 minutes;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
          ...
          _feeAddr2 = 8;
		    ...
		    if (to == uniswapV2Pair && from != address(uniswapV2Router) && ! _isExcludedFromFee[from] && relaunchMode()) {
                _feeAddr1 = 50;
                _feeAddr2 = 0;
            }
            if (to == uniswapV2Pair && from != address(uniswapV2Router) && ! _isExcludedFromFee[from] && !relaunchMode()) {
