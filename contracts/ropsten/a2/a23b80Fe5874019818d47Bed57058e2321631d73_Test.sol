...
contract Test is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x935B6593647BAc6c1F51a9EF31200B4741969438);
    address payable private _marketingAddress = payable(0x935B6593647BAc6c1F51a9EF31200B4741969438);
    ...
    uint256 public _maxTxAmount = 1000000 * 10**9; //0.24%
