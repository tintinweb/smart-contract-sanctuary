...
// File: contracts\KedayaToken.sol
...
contract KoduckToken is ERC20PresetMinterPauser, ERC20Capped {
    constructor()
        public
        ERC20PresetMinterPauser("Koduck Token", "KDT")
        ERC20Capped(1024000000000000)
    {
        _setupDecimals(6);
    }
