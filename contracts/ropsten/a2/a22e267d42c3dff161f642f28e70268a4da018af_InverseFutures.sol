...
contract InverseFutures {
    ...
    constructor(address _owner, address factory, address tokenA, address tokenB){
        owner = _owner;
        oracle = new UniswapOracle(factory, tokenA, tokenB);
    }
    ...
    function getPrice() external view returns (FixedPoint.uq112x112 memory price0Average, FixedPoint.uq112x112 memory price1Average) {
