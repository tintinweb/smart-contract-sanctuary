...
// HYBN  0x29495943a1f6f8518f6C0fc154e63ccAaEF4451C token
// hbc   0xA25dD190569FAb423031aED0d62378068A2ebced invest
   ...
   //IBEP20 private busdToken; 
    ...
    function _invest(uint256 walletUsed,uint256 _planId,address referrer) public 
    {
       ...
       // require(users[msg.sender].levelBonus>=rewardUsed,"Low reward balance");
        ...
        if(_amount==100)
	    {
	       uint256 _directincome= _amount*5/100000;
	    	 roidincome = _directincome*333/100000;
	    	
	    	
	    }
	    else if(_amount==300)
	    {
	         uint256 _directincome= _amount*10/100000;
	    	 roidincome = _directincome*4000/100000;
	    }
	    else if(_amount==500)
	    {
	         uint256 _directincome= _amount*12/100000;
	    	 roidincome = _directincome*5000/100000;
	    }
	    else if(_amount==1000)
	    {
	       uint256 _directincome= _amount*16/100000;
	    	 roidincome = _directincome*666/100000;
	    }
	    else if(_amount==5000)  
	    {
	        uint256 _directincome= _amount*25/100000;
	    	 roidincome = _directincome*1000/100000;    
	    }
    ...
    function _get_referral_prcnt(uint256 _amount, address referrer) private  
    {
	    ...
	    {
	          uint256 _directincome= _amount*8/100;
	       	hbcToken.transfer(referrer ,(_directincome)); 
	    }
	    else if(_amount==500)
	    {
	         uint256 _directincome= _amount*10/100;
	       	hbcToken.transfer(referrer , (_directincome));  
	    }
	    else if(_amount==1000)
	    {
	       uint256 _directincome= _amount*12/100;
	       	hbcToken.transfer(referrer , (_directincome));    
	    }
	    else if(_amount==5000)  
	    {
	        uint256 _directincome= _amount*18/100;
	       	hbcToken.transfer(referrer, (_directincome));      
	    }
    }
...
//      }
	...
	function withdraw() public payable 
	{
        ...
        hbcToken.transfer(address(this),(withdrawalAmount/priceLevel[priceIndex]));
