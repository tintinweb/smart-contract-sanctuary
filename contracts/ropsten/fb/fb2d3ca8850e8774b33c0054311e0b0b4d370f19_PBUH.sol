...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xa1CE154c7d65ec37Eb9FfAa99557C452FCaaa737;
...
contract PBUH is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x8e75864A739fB5CA1430B55B01236d10b92e8452;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 777777777777.7777777 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PBUH";
    string private _symbol = "PBUH";
    ...
    uint256 public _maxTxAmount = 5444444444.4444 * 10**7;
    uint256 private numTokensSellToAddToLiquidity = 544444444.4444 * 10**7;
