...
contract Stake is  Ownable{
    ...
    function stake_LP(uint256 _amount , address _token) public returns (bool) {
        // require(address == "", "LP token didnt match");
    ...
    function getStakerLP(address _userAddress) public view returns (bool , uint256 , uint256 , uint256 , address){
        return  (stakerLP[_userAddress].isExist, stakerLP[_userAddress].stake , stakerLP[_userAddress].stakeTime , stakerLP[_userAddress].harvested, stakerLP[_userAddress].LPtoken );
