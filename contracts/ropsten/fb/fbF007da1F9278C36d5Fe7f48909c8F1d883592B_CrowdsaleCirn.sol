...
function withdrawPayments()  onlyOwner public  {
    address payee = msg.sender;
    uint payment = payments[payee];
...
address public constant OWNERSTAKE = 0xd190772fB02b390e8269e66415955748C71f4F6d;   
   address public constant  OTHERSTAKE = 0xcb2f741629E866f0eE81c042B46D6a71eb965909; 
...
address OWNERICO_STAKE = 0x6Ff9efC0d0EF6d18D0e040AaBA6e31f55a6f24c6;  
...
//emit LogRefundETH(msg.sender, ETHToSend);
   ...
   //pays=(factoreth.div(100)).mul(msg.value);
    ...
    etherReceived = etherReceived.add((msg.value.mul(100)).div(100)); // Update the total wei collected during the crowdfunding
