...
contract Degen is Router, Ownable {
   ...
   modifier onlySystem() {
    ...
    function _swap( 
        ...
        // distribution in case of oneInch required, can be empty array in other cases
    ...
    function executeCrossExchange(
        ...
        if(path[0] == USDT) {
            ...
            uint256 minAmountExpected = _swap(orderType, path, assetInOffered, minExpectedAmount, msg.sender, address(this), dexId, minAmount, distribution);
