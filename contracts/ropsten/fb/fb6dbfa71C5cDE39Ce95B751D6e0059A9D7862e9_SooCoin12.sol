...
contract SooCoin12 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin12";
    string private m_Symbol = "SOO12";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x7ce04a405425D6c1FDfB3e1855BDBE8E8EA497Fe);
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 10000, 5000, 50000, m_ILOPublic);
        initTax();
