...
//    |___  /____/\____/ \___  >__|_ \ |__|  (____  /\___  >___  >____  >
//        \/                 \/     \/            \/     \/    \/     \/ 
...
contract sophiafaces is ERC721Enumerable, Ownable {
    ...
    uint256 private _holderprice = 0.03 ether;
    ...
    constructor(string memory baseURI) ERC721("Sophiafaces","SOPHIAFACES")  {
        setBaseURI(baseURI);
    ...
    function adopt(uint256 numfaces) public payable {
        ...
        require(numfaces < 11,                              "only up to 10 Sophias at once");
