...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x250E75B9F33940506D1cF31FaB63cFAA5ad98C95), 500);
		setTaxAlloc(payable(0x9E9afF402641B749e0f20D6285Aed457982EAa9A), 500);
        m_DidDeploy = true;
    }
...
contract TestToken is Context, IERC20, Taxable {
    ...
    string private m_Name = "TestToken";
