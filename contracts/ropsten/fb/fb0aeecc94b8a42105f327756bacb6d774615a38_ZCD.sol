...
contract ZCD is Context, IERC20, Ownable {
    ...
    string private _name = "ZCD";
    string private _symbol = "ZCD";
    ...
    uint256 private numTokensSellToAddToLiquidity = 300000 * 10**1 * 10**9;
