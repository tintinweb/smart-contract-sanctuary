...
library Constants {
    ...
    /* Oracle */
    address private constant USDC = address(0x820f7CBbCeF0114E146843C12B7d140e29016b68);
    ...
    /* Deployed */
    address private constant DAO_ADDRESS = address(0xFb17C8Baae6a944658b7860E3a6dE1e1432d12d9);
    address private constant DOLLAR_ADDRESS = address(0x688dF41F07cFc88909b42439f7c8e37b882637ef);
    address private constant PAIR_ADDRESS = address(0xbd63e26333eF6C529b7912C55F6Fd5cC192AC478);
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable {
    ...
    constructor()
    ERC20Detailed("New Empty Set Dollar", "NESD", 18)
    Permittable()
    public
    { }
