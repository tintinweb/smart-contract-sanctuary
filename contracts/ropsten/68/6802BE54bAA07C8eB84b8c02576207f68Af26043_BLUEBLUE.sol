...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x82cdc6459300DFef2907526EdA98BC916e04F778), 5000);
        m_DidDeploy = true;
    }
...
contract BLUEBLUE is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "BLUEBLUE";
    string private m_Symbol = "BLUE";
