...
contract Staking is Ownable {
    ...
    IERC20 private _PIXIEAddress = IERC20(0x98129D8078a666f2A4bF54BfDAE245B6f8955105); //REMEMBER TO CHANGE
    ...
    function setDailyRewards() public {
        ...
        for (uint i = 0; i < _usersStaked.length; i += 1) {
            ...
            if (_userTimeStamp == _timestamp) {
                ...
                _stakeDay = _userStakeDayTimestamp.div(10 minutes); //REMEMBER TO CHANGE
