...
contract Souvenir is Ownable, ERC721, IRaribleRoyaltiesV2 {
    ...
    function mint(uint quantity) public payable onlyActive onlyNonPaused {
        ...
        emit Debug("mint: quantity check completed");
        ...
        emit Debug("mint: checks starting");
        ...
        emit Debug("mint: checks completed");

        emit Debug("mint: minting starting");
        ...
        emit Debug("mint: minting completed");

        invocations = invocations.add(quantity);

        emit Debug("mint: payouts starting");
        ...
        emit Debug("mint: payouts completed");
    }
