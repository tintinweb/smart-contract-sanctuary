...
contract TMOON is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 200000000000000 * 20**18;
	...
	uint256 public _maxTxAmount = 200000000000000 * 20**14;
	uint256 public numTokensSellToAddToLiquidity = 2 * 20**14;
	uint256 public _maxWalletToken = 200000000000000 * 20**14; // 0.25% of total supply after burn
