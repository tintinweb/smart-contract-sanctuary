...
contract MintableProxyContract is IMintable, Ownable, ReentrancyGuard {
    ...
    constructor(address _owner, address _imx, MpiV1 _mpiAddress) Ownable(){
        imx = _imx;
        mpiAddress = _mpiAddress;
    ...
    function updateContractAddress(MpiV1 _contract_address) public returns(bool){
        mpiAddress = _contract_address;
        return false;
    }
    ...
    function _mintFor(
        ...
        mpiAddress._safeMint(user, id, "");
        string memory _uri = uriConcate(mpiAddress.beforeUri(), id, mpiAddress.afterUri());
        mpiAddress._setTokenURI(id, _uri);
    }
