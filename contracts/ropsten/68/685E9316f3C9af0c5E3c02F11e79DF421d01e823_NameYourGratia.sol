...
contract ERC20 is Context, IERC20 {
     ...
     */
    function setGratiaAddress(address _gratiaAddress) public {
        require(gratiaAddress == address(0), "Already set");

        gratiaAddress = _gratiaAddress;
    }
}
