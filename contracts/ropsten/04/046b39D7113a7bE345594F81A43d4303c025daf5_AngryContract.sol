...
contract AngryContract is ReentrancyGuard{
    ...
    event CheckInvoiceChange(bool _oldVal, bool _newVal);
    ...
    function setCheckInvoice(bool _bVal) public onlyExecutor {
        emit CheckInvoiceChange(bCheckInvoice,_bVal);
        bCheckInvoice = _bVal;
    }
}