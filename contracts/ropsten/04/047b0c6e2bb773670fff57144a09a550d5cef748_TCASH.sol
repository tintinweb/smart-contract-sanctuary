...
contract TCASH is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TCASH() {
        ...
        name = &quot;TCASH&quot;;                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = &quot;TCAS&quot;;                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 650000;                                      // Set the price of your token for the ICO (CHANGE THIS)
