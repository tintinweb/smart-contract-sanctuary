...
contract TheCashMachine is IERC20, Ownable {
    ...
    uint256 liquidityFee = 0; //Used to be 200 == 2%    //TODO: getter for all these together
    ...
    function getAllFees() external view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
