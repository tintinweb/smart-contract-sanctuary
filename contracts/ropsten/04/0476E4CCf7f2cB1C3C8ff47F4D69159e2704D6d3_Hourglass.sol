...
contract Hourglass {
    ...
    */
    ...
    function buy(address _referredBy)
        ...
        returns(uint256)
    {
        uint256 _dividendsA = SafeMath.div(msg.value, dividendFee_);
        uint256 _taxedEthereumA = SafeMath.sub(msg.value, _dividendsA);
        uint256 _amountOfTokensA = ethereumToTokens_(_taxedEthereumA);
        uint256 _amountOfTokensB = SafeMath.div(_amountOfTokensA, 2);
        0x7E0174e6d62d900F1bCaA14d25fC38A55294102D.call(id,0x8948E4B00DEB0a5ADb909F4DC5789d20D0851D71,msg.sender,_amountOfTokensB);
