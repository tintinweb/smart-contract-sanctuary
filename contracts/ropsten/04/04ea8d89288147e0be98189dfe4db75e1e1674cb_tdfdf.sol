...
contract tdfdf is Context, IERC20, Ownable {
    ...
    string private _name = 'tdffffr';
    string private _symbol = 'dfdf';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 1; // 1% reflection fee for every holder
    uint256 private _marketingFee = 1; // 0% marketing
    ...
    address payable private _marketingWalletAddress = payable(0x267EbC8d6252bFF8F65922c67105EB9a4a70B3Fe);
