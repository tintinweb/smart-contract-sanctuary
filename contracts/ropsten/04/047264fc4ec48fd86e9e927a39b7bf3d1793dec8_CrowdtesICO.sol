...
contract CrowdtesICO is ERC20 {
    ...
    address _tokenContract = 0x88aAf19A5B13834b76476b0Bdd5513187863115C;
    AltcoinToken cddtoken = AltcoinToken(_tokenContract);

    string public constant name = "CrowdtesICO";
