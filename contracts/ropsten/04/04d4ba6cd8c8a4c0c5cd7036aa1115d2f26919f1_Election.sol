...
contract Election {
  ...
  function get_candidates() public view returns (uint8[] memory) {
    return numberList;
  }

  function get_candidate(uint8 number) public view returns (string memory, uint8, string memory, string memory) {
    return (candidates[number].name, candidates[number].number, candidates[number].party, candidates[number].vice);
  }
  
  function get_candidate_pic(uint8 number) public view returns (string memory) {
      return candidates[number].candidate_pic;
  }
  
  function get_vice_pic(uint8 number) public view returns (string memory) {
  ...
  function get_votes() public view returns (uint8[] memory) {
    return votesList;
  }
}