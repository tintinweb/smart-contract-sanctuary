...
contract TopCoinTest is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    string public version = 'TopCoinTest1.0'; 
    ...
    constructor() {
        ...
        name = "TopCoinTest";                                   // Set the name for display purposes (CHANGE THIS)
