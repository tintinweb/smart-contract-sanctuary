...
contract EscrowManager {
    ...
    //      address _tokenAddressBuy: contract address of the buy unit
    // outputs:
    //     uint[] sellAmts: list of the all the amounts in terms sell units in the list of escrow orders
    //     uint[] buyAmts: list of the all the amounts in terms buy units in the list of escrow orders
