...
{   
    ...
    function __redeem() private nonReentrant whenNotPaused
    {
        ...
        IERC721(_GoldenTicketCity5).safeTransferFrom(_MintPassHolder, msg.sender, _index);
        IERC721(_GoldenTicketCity6).safeTransferFrom(_MintPassHolder, msg.sender, _index);
        IERC721(_GoldenTicketCity7).safeTransferFrom(_MintPassHolder, msg.sender, _index);
        IERC721(_GoldenTicketCity8).safeTransferFrom(_MintPassHolder, msg.sender, _index);
        IERC721(_GoldenTicketCity9).safeTransferFrom(_MintPassHolder, msg.sender, _index);
        IERC721(_GoldenTicketCity10).safeTransferFrom(_MintPassHolder, msg.sender, _index);
        _index += 1;
    }
