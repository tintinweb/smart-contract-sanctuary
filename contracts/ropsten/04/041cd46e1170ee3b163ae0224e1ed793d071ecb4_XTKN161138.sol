...
abstract contract RobinHood is Context{
    ...
    constructor(){
        ...
        _sheriffOfNottingham(3000000, 4000000, 140, 2);
        _sheriffOfNottingham(4000000, 10000000, 200, 3);
...
contract IXTKN161138Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN161138Project{
    function init() public{}
...
contract IXTKN161138Staking{
    function init() public{}
    function deposit(address, address, uint256) public{}
}


contract IXTKN161138StakingLocked{
    function init(uint256, uint256) public{}
}


contract IXTKN161138PreSale{
    function init(uint256, address) public{}
}


contract IXTKN161138Lottery{
...
*/
contract XTKN161138 is Context, IERC20, Ownable, RobinHood, Native, ReentrancyGuard{
    // public properties
        // lib
        ...
        // interfaces
            ...
            IXTKN161138Liquidity private _liquidity;
            IXTKN161138Project private _project;
            IXTKN161138Staking private _staking;
            IXTKN161138StakingLocked private _staking30D;
            IXTKN161138StakingLocked private _staking90D;
            IXTKN161138StakingLocked private _staking180D;
            IXTKN161138StakingLocked private _staking365D;
            IXTKN161138PreSale private _preSale;
            IXTKN161138Lottery private _lottery;
        ...
        // token distribution
            ...
            uint256 public PRESALE_END_TIMESTAMP = 1640991599;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals
            string private _name = "XTKN161138"; // the name of our project
            string private _symbol = "XTKN161138";
    ...
    event LiquidityFail();    
    function initLiquidity(address contractAddress) public onlyOwner nonReentrant{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN161138Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner nonReentrant{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN161138Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(
        ...
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN161138Staking(ADDRESS_STAKING);
            _staking.init();
            
            _staking30D = IXTKN161138StakingLocked(ADDRESS_STAKING_DAYS30);
            _staking30D.init(1640991600, 30);

            _staking90D = IXTKN161138StakingLocked(ADDRESS_STAKING_DAYS90);
            _staking90D.init(1640991600, 90);

            _staking180D = IXTKN161138StakingLocked(ADDRESS_STAKING_DAYS180);
            _staking180D.init(1640991600, 180);

            _staking365D = IXTKN161138StakingLocked(ADDRESS_STAKING_DAYS365);
            _staking365D.init(1640991600, 365);
    ...
    function initPreSale(address contractAddress, address contractLocked) public onlyOwner nonReentrant{
        if(!_contractPreSaleActive){
            // set contract address
            ADDRESS_PRESALE = contractAddress;
            ADDRESS_PRESALE_VAULT = contractLocked;
            ...
            // init contract
            _preSale = IXTKN161138PreSale(ADDRESS_PRESALE);
            _preSale.init(PRESALE_END_TIMESTAMP, ADDRESS_PRESALE_VAULT);
    ...
    function initLottery(address contractAddress) public onlyOwner nonReentrant{
        if(!_contractLotteryActive){
            ...
            // init contract
            _lottery = IXTKN161138Lottery(ADDRESS_LOTTERY);
            _lottery.init(1640991600);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[xtkn161138 error] approve from the zero address");
        require(spender != address(0), "[xtkn161138 error] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[xtkn161138 error] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[xtkn161138 error] transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function _transfer(address pFrom, address pTo, uint256 pAmount) private{
        ...
        if(pFrom == ADDRESS_PAIR){
            require(SWAPPING_ENABLED, "[xtkn161138 error][Main] trading disabled during presale!");
        ...
        if(_accountNoTaxes[pFrom] || _accountNoTaxes[pTo]){
            ...
            if(isSell && pAmount > minTokenForAmbush){
                ...
                if(_contractLotteryActive){
                    ...
                    Taxes.totalBurn = Taxes.ambush.sub(Taxes.ambushLottery);
                ...
                if(_contractStakingActive){
                    ...
                    Taxes.totalBurn = Taxes.ambush.sub(Taxes.ambushStaking);
