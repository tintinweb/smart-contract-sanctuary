...
contract TokenLock is Ownable {
        ...
        onlyOwner
    {
        ...
        require(_vestingCliffInDays <= 1*182, "Cliff greater than half a year");
        require(_DurationInDays <= 3*365, "Duration greater than 3 years");
    ...
    function calculateTokenClaim(address _recipient) private view returns (uint16, uint256) {
        ...
        require(tokenRelease.totalClaimed < tokenRelease.amount, "Grant fully claimed");
