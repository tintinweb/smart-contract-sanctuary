...
** Using FTP EthReflect to give 9.00% of ALL transactions to holders. **
** Using FTP LPAdd to recycle 9.00% of ALL transactions back into the liquidity pool. **
** Using FTP ILO to provide up to 9.00% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x411cEFFdea5467869ba4d5c60D80417439DCA62d), 1000);
        m_DidDeploy = true;
    }
...
contract JimToken3 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "JimToken3";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 9000, 9000, 0, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 9000, m_UniswapV2Pair, m_UniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
