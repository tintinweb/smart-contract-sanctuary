...
░░███     ███ ░███    ░███  ░███  ░███    ░███ ░░███     ███ 
 ░░█████████  █████   █████ █████ █████   █████ ░░░███████░  
  ...
  telegram : https://t.me/AtestTokenuETH
  twitter : https://twitter.com/AtestTokenETH
*/
...
contract AI2TokenAI2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI2TokenAI2";
    string private constant _symbol = "AI2TokenAI";
    ...
    uint256 public maxTransactionAmount = (_tTotal * maxTxPercent) / 1000; // 0.5% maxTransactionAmountTxn
    mapping (address => bool) public _isExcludedMaxTransactionAmount;
    
    uint256 private maxWalletPercent = 10;
    uint256 public maxWalletSize = (_tTotal * maxWalletPercent) / 1000; // 1% maxWalletSize of Total Supply
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 230;
        _rOwned[address(this)] = _rTotal / 1000 * 770;
        
        
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x8047F98eA4aA0A03078e14F2E3D7F67C8e7F45FB); // Marketing Address
        
        devAddress = payable(0x8047F98eA4aA0A03078e14F2E3D7F67C8e7F45FB); // Dev Address
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 230 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 770 / 1000);
    }
    ...
    function launchWithPresale(address[] memory presaleWallets, uint256[] memory amounts) external onlyOwner returns (bool){
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                if(boughtEarly[from] && earlyBuyPenaltyEnd > block.timestamp){
                    _taxFee = _taxFee * 9;
                    _liquidityFee = _liquidityFee * 10;
                }
