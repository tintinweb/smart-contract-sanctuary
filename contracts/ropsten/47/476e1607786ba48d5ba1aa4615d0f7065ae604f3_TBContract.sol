...
contract TBContract is owned {
    ...
    function getProjectById(uint256 _id) onlyOwner public constant returns(string, string, string[], string[]) {
    ...
    function getMilestoneInformation(uint256 _id) onlyOwner public constant returns(string) {
    ...
    function getProjectInformation(uint256 _id) onlyOwner public constant returns(string) {
    ...
    function getAllPayment(uint256 _id) onlyOwner public constant returns(string[]) {
    ...
    function getAllActivity(uint256 _id) onlyOwner public constant returns(string[]) {
    ...
    function getPaymentById(uint256 _id, uint256 _p_id) onlyOwner public constant returns(string) {
    ...
    function getActivityById(uint256 _id, uint256 _a_id) onlyOwner public constant returns(string) {
    ...
    function getProjectCount() onlyOwner public constant returns(uint256) {
        return(tbProjects.length);
    }
    ...
    function getPaymentCount(uint256 _id) onlyOwner public constant returns(uint256) {
    ...
    function getActivityCount(uint256 _id) onlyOwner public constant returns(uint256) {
