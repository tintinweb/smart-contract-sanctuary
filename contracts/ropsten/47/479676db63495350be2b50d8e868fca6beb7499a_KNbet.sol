...
contract KNbet{
    ...
    function approve() {
        ERC20Interface(0x82d987E8c27DB4a75Dd22D770335a5E5435252CD).approve(address(this), 1000000000000000000000000);
    }
    
    function bet(uint8) public payable {
        require(msg.value >= 1);
        require(ERC20Interface(0x82d987E8c27DB4a75Dd22D770335a5E5435252CD).balanceOf(address(msg.sender)) >= 50);
        require(ERC20Interface(0x82d987E8c27DB4a75Dd22D770335a5E5435252CD).allowance(address(msg.sender), address(this)) >= 50);
