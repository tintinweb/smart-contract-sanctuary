...
contract FORT2 is Context, IERC20, Ownable {
    ...
    string private constant _name = 'midi-chlorians T2';
    string private constant _symbol = 'FORT2';

    uint256 private _taxFee = 250;
    uint256 private _burnFee = 250;
    uint public max_tx_size = 100;
