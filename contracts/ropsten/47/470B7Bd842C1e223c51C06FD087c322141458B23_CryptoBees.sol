...
contract CryptoBees is ERC721, Ownable, Pausable {
  ...
  ERC20 private honey = ERC20(0x3b6F57900FAb6f0EC8D3d1d3538159eE96B5c105);
  ...
  function mintForHoney(uint256 amount, bool stake) external payable whenNotPaused {
    ...
    if (minted < PAID_TOKENS) {
      require(minted + amount <= PAID_TOKENS, 'All tokens on-sale already sold');
      require(amount * MINT_PRICE_HONEY == msg.value, 'Invalid payment amount');
    }
    ...
    // _burn(_msgSender(), totalHoneyCost);
  }
