...
contract WHALEALERT is Context, IERC20, Ownable {
    ...
    string private _name = "WHALEALERT";
    string private _symbol = "WHALEALERT";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 halfOfLiquify = contractTokenBalance.div(5).mul(2);
        uint256 otherHalfOfLiquify = contractTokenBalance.div(5).mul(2);
