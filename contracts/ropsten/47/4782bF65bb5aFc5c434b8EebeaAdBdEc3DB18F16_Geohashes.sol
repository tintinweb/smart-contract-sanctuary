...
contract Geohashes is ERC721URIStorage, Ownable, Pausable {
        ...
        returns (string memory)
    {
        ...
        parts[
            2
        ] = '<circle fill="#FFFFFF" stroke="#202A88" stroke-width="3" cx="258.5" cy="255.5" r="178" />';
        parts[
            3
        ] = '<text fill-rule="nonzero" font-family="HelveticaNeue-Medium, Helvetica Neue" font-size="64" font-weight="400" fill="#212B88">';
        parts[4] = '<tspan x="174.708" y="278">';
        parts[5] = getTokenIdAsString(tokenId);
        parts[6] = "</tspan>";
        parts[7] = "</text>";
        parts[8] = "</svg>";
