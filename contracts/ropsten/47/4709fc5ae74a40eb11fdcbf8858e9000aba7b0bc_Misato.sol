...
contract Misato is Context, IERC20, Ownable {
    ...
    string private constant _name = "MISATO";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5fbF11EC1e96e0EB82b3C288F0690A84C7453B3E);
        _feeAddrWallet2 = payable(0x07baE437c5Ec786d4346e336Ac37ABB95AB4ed90    );
