...
contract Arkhanum is ERC20, ProofOfAgeProtocol, TimeLockedWallet, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string public name = "Arkhanum";
    string public symbol = "ARKHA";
...
//--------------------------------------------------------------------------------------
    ...
    modifier BlockMinter{
        require(blockMinter[msg.sender]);
        _;
    }
    function blockMinting() BlockMinter public returns (bool) {
