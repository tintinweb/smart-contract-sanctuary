...
//Burnable - Token holders will be able to destroy their tokens. https://docs.openzeppelin.com/contracts/4.x/api/token/erc1155#ERC1155Burnable
//Pausable - Privileged accounts will be able to pause the functionality marked as whenNotPaused. Useful for emergency response. https://docs.openzeppelin.com/contracts/4.x/api/utils#Pausable
//Access Control - Ownable - Simple mechanism with a single account authorized for all privileged actions. https://docs.openzeppelin.com/contracts/4.x/api/access#Ownable
//Upgradeability - UUPS https://docs.openzeppelin.com/contracts/4.x/api/proxy#UUPSUpgradeable
