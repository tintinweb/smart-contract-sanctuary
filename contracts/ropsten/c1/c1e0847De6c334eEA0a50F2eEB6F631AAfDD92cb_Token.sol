...
contract Token is ERC721, Ownable {
    ...
    function playerMint(
        ...
        //payable(address(arena)).transfer(msg.value); //10% of mint price sent as prize
...
interface IArena {
  function addManyToArenaAndPlay(address account, uint16[] calldata tokenIds) external;
  function claimManyFromArenaAndPlay(address account ,uint16[] calldata tokenIds) external;
}