...
contract ProjectName is AdminRole, VerifySignature{
  ...
  constructor () public {
    ...
    _token_price = 100000000000000000; //0.1 USDT * (10**18) = 100000000000000000 wei, where 18 is decimal of USDT

    // set the address that stores Tokens and signs data from the white list
    _signer_address = address(0x9B6F5E2BC3621D49DCD34909E6F2a9c63982171c);
