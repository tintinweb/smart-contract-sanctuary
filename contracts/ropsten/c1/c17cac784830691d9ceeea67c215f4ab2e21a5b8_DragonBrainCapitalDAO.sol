...
contract DragonBrainCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Dragon Brain Capital DAO";
    string private constant _symbol = "DBC DAO";
    ...
    address payable public marketingWallet = payable(0xAd79804981061FC7707fdFb25fcd0d72F5e8A9bD);
    address payable public treasury = payable(0x8696135c7cB588333d4E08F040b5E016372481B1);
