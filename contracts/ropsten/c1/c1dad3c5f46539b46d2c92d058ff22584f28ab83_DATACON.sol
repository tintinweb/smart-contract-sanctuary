...
contract Members is Organization {
    ...
    constructor () {
        ...
        _setupMember(MINTER_ROLE, ContextMsgSender());
    }

    modifier onlyMinter() {
        require(isMember(MINTER_ROLE, ContextMsgSender()), "Members: caller does not have the MINTER role");
        _;
    }
}
...
contract DATACON is ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover, Members {

    // constructor (uint256 initialBalance) ERC1363() payable {
    //     _mint(ContextMsgSender(), initialBalance);
    // }
    constructor () ERC1363() payable {
        _mint(ContextMsgSender(), 5000000000000000000000000000);
    }
