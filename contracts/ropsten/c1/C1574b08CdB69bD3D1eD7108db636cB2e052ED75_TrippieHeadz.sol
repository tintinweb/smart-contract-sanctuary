...
contract TrippieHeadz is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_SUPPLY = 9900; // Maximum amount of TH

    uint256 public constant PRICE = 0.099 ether;
    address private constant _a1 = 0xc3E7456FAC3C2f7D737CF0B016fbB250F7650204; // middle wallet 
    ...
    function claimReservedHeart(uint256 quantity, address addr) external onlyOwner {
        ...
        require(totalSupply() < TOTAL_TRIPPIEHEADZ, "SOLD_OUT");
        require(totalSupply() + quantity <= TOTAL_TRIPPIEHEADZ, "EXCEEDS_TOTAL_SUPPLY");
