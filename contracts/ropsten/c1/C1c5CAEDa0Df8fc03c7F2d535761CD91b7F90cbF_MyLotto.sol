...
contract MyLotto is IERC20 {
    ...
    */
    function purchaseTicket(uint256 _ticketNumbers, uint256 ticketCount) external payable returns(bool){
        ...
        //   }
        uint64 ticketNumbers = uint64(_ticketNumbers);
        uint8 i;
        for( i =0 ; i < ticketCount; i++) {
            ticketNumberByAddress[saleId][msg.sender].push(ticketNumbers%1000000000000);
            ticketNumbers = ticketNumbers / 1000000000000;
        }
        if(ticketCount == 6){
