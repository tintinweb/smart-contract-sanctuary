...
// File: contracts/SuperGremlin.sol
...
contract SuperGremlins is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxFreeMint = 500;
...
mapping(address => uint) public addressToFreeMinted;
  ...
  constructor() ERC721("Super Gremlins", "GREMLIN") {
    setHiddenMetadataUri("ipfs://QmTV7MxG4zqXArcV7yffuKZkQKyiLbyZxNJGQGZut4N46x");
  }
