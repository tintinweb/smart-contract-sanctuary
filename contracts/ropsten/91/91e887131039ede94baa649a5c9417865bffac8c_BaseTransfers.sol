...
if (gn.isGenesisAddressLevel1(_from) || gn.isGenesisAddressLevel2(_from)) revert('ERROR You must upgrade to Level 3 to allow transfers. Visit https://bsc.minereum.com for more info');
