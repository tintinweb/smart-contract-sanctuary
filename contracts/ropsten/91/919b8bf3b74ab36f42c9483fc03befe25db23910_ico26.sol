...
contract ico26 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ico26() {
        ...
        name = "ico26";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ubit-026";                                             // Set the symbol for display purposes (CHANGE THIS)
