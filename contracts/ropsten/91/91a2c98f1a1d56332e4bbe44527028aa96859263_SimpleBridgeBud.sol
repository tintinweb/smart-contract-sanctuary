...
// File: contracts\SimpleBudBase.sol
...
contract SimpleBudBase is Ownable {
    using SafeMath for uint256;
...
// File: contracts\SimpleBudToken.sol

pragma solidity ^0.6.12;



contract SimpleBudToken is SimpleBudBase, ERC1155("") {
    /* ========== EVENTS ========== */
...
// File: interfaces\ISimpleBridgeBud.sol

pragma solidity ^0.6.12;

interface ISimpleBridgeBud {
    function mint(
        uint256 _id,
        uint256 _birthTime,
        uint256 _matronId,
...
// File: contracts\SimpleBudCore.sol
...
abstract contract SimpleBudCore is SimpleBudToken, ISimpleBridgeBud, ReentrancyGuard {
...
contract BridgeRole {
    ...
    function transferBridgeRole(address newBridge) public onlyBridge {
...
// File: contracts\SimpleBridgeBud.sol

pragma solidity ^0.6.12;



contract SimpleBridgeBud is BridgeRole, SimpleBudCore {
    function mint(
        uint256 _id,
        uint256 _birthTime,
        uint256 _matronId,
    ...
    function burn(uint256 _tokenId) external override onlyBridge {
        require(isOwnerOf(msg.sender, _tokenId));
         // remove bud from storage
        delete buds[_tokenId];
