...
contract STEW is ERC20, Ownable {
    ...
    /**
     * @dev Sets the values for {name = StewCoin}, {totalSupply = 210000} and {symbol = STEW}.
     *
     * All two of these values are immutable: they can only be set once during
     * construction.
     */
    constructor(uint256 fixedSupply) public ERC20("StewCoin", "STEW") {
        tokenDecimals = 18;
