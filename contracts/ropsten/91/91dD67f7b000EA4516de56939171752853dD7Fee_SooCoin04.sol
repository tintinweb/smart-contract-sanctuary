...
** Using FTP EthReflect to give 1.11% of ALL transactions to holders. **
** Using FTP LPAdd to recycle 3.33% of ALL transactions back into the liquidity pool. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x250E75B9F33940506D1cF31FaB63cFAA5ad98C95), 2220);
        m_DidDeploy = true;
    }
...
contract SooCoin04 is Context, IERC20, Taxable {
	...
	// LP ADD
    IWETH private WETH;
    uint256 private m_LiqAlloc = 3330;
	// ILO
    FTPILO private ILO;
    ...
    constructor () {
        ...
        ILO.init(100000000000000000, 10000, 10000, 65000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 1110, m_UniswapV2Pair, m_UniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
