...
contract Farming is IFarming, Ownable, ReentrancyGuard {
    ...
    uint256 public stakingFeesPercent = 2; 
    uint256 public lastUpdateTime;
    uint256 public rewardPerTokenStored;
    uint256 public startFarmingTime;
    ...
    function stake(uint256 amount) external nonReentrant startFarming updateReward(msg.sender) {
        ...
        uint256 feeToPay = amount.div(100).mul(stakingFeesPercent);
        uint256 amountToStake = amount.sub(feeToPay);
        ...
        stakingToken.safeTransferFrom(msg.sender, feeRecepient, feeToPay);
        emit Staked(msg.sender, amount.sub(feeToPay));
    }
