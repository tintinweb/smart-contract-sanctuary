...
contract ERC20 is ERC165, IERC20, Ownable {
    ...
    constructor() public {
        ...
        // Crowd Sale Wallet
        _cardioWallet[0x1BF01cC0ad12C49Fb9bfe8b7De29050b6701499B] = 1;
        // Team & Advisors
        _cardioWallet[0x2D67C9A96D748CCE703CfdF783df93C6052c5b85] = 2;
        // Ecosystem Activation
        _cardioWallet[0x483e4e4EE3bcdd8A28553D419bC1010F9be11812] = 3;
        // Business Development
        _cardioWallet[0x91D51Cb29a7e88c2Ca069d9727BC6Ee8aa1A2717] = 4;
    }
...
contract BurnableToken is ERC20 {
    ...
    modifier onlyCardioWallet() {
        require(msg.sender == 0x483e4e4EE3bcdd8A28553D419bC1010F9be11812
            || msg.sender == 0x91D51Cb29a7e88c2Ca069d9727BC6Ee8aa1A2717
        ); _; }
    ...
    // 0x483e4e4EE3bcdd8A28553D419bC1010F9be11812
    // Business Development - 4
    // 0x91D51Cb29a7e88c2Ca069d9727BC6Ee8aa1A2717
