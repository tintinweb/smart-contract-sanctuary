...
** Using FTP ILO to provide up to 1.50% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract ILOTest is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOTest";
    string private m_Symbol = "ILO";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1500, 450, m_ILOPublic);
        initTax();
