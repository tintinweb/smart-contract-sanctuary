...
contract IncreasingTokenPriceCrowdsale is TimedCrowdsale
{
  ...
  /**
   * @dev Constructor, takes intial and final rates of wei contributed per token.
...
contract FOIChainCrowdsaleTest1 is TimedCrowdsale, MintedCrowdsale, IncreasingTokenPriceCrowdsale, PostDeliveryCrowdsale, CappedTokenCrowdsale, FinalizableCrowdsale
{
    using SafeMath for uint256;

    constructor()
        public
        Crowdsale(0x4133cbd34Ceeb27724cca11062729C7f748B7dA5)
        TimedCrowdsale(1534047600, 1534051000)
    ...
    // Once the token contract is ready and deployed, update it here.
    // When the ICO ends, the tokens will then be able to be delivered to this contract.
    ...
    */
    ...
    function finalization() internal
    {
        //Tokens used for development, marketing, etc.
        uint256 reserve = 50000;

        //Team gets remaining tokens in addiciton to reserve
