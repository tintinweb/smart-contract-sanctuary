...
contract AurumPresale is Ownable {
        ...
        minThreshold(20 finney)
    {
        ...
        totalWeiRaised = totalWeiRaised.add(newWeiRaised);

        // calculate token amount
        uint256 tokenAmount = getTokenAmount(newWeiRaised);

        require(token.transfer(_beneficiary, tokenAmount));
        emit TokenPurchase(msg.sender, _beneficiary, newWeiRaised, tokenAmount);
