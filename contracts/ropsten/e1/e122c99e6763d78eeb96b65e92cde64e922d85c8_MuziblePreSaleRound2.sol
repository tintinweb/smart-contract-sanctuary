...
contract MuziblePreSaleRound1 is PreSaleRound {

  // Tokenomy
  uint256 constant STAGE_CAPACITY     = 2e6 ether;
  uint256 constant STAGE_PRICE        =    30; // USDc
  uint256 constant STAGE_MIN_PURCHASE =   200; // USD
  uint256 constant STAGE_MAX_PURCHASE =  2000; // USD
...
contract MuziblePreSaleRound2 is PreSaleRound {
...
contract MuziblePreSaleRound3 is PreSaleRound {

  // Tokenomy
  uint256 constant STAGE_CAPACITY     = 2e6 ether;
  uint256 constant STAGE_PRICE        =    75; // USDc
  uint256 constant STAGE_MIN_PURCHASE =   200; // USD
  uint256 constant STAGE_MAX_PURCHASE = 13000; // USD
...
contract MuziblePreSaleRound4 is PreSaleRound {
