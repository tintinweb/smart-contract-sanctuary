...
contract CryptoMountainsToken is owned, SafeMath, StandardToken {
    ...
    mapping (address => bool) public NuovoNegozio;
    event Negoziante(address target, bool negozio);
    
    function AggiungiNegoziante (address target, bool negoziante) onlyOwner public {
        NuovoNegozio[target] = true;
    ...
    function setGasForCMT(uint newGasAmountInWei) onlyOwner public {
