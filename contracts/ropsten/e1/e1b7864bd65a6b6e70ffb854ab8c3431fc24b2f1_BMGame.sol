...
contract BMGame is BMEvents {
    ...
    public
    {
        ...
        fees_[0] = BMDatasets.TeamFee(36);
        //61% to pot, 2% to com, 1% to air drop pot
        fees_[1] = BMDatasets.TeamFee(43);
        //54% to pot, 2% to com, 1% to air drop pot
        fees_[2] = BMDatasets.TeamFee(66);
        //31% to pot, 2% to com, 1% to air drop pot
        fees_[3] = BMDatasets.TeamFee(51);
        //46% to pot, 2% to com, 1% to air drop pot

        // how to split up the final pot based on which team was picked
        potSplit_[0] = BMDatasets.PotSplit(25);
        //48% to winner, 25% to next round, 2% to com
        potSplit_[1] = BMDatasets.PotSplit(25);
        //48% to winner, 25% to next round, 2% to com
        potSplit_[2] = BMDatasets.PotSplit(40);
        //48% to winner, 10% to next round, 2% to com
        potSplit_[3] = BMDatasets.PotSplit(40);
        //48% to winner, 10% to next round, 2% to com
    }
