...
contract XLiquid is ERC20, Ownable {
    ...
    */
    ...
    uint8 public feeDecimals = 1;
    uint32 public feePercentage = 100;
    uint128 private minTokensBeforeSwap = 0;
    ...
    */
    function _transfer(
        ...
        _transfer(from, address(this), tokensToLock);
