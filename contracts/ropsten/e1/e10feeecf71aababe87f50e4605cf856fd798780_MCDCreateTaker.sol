...
contract DFSExchangeHelper {
    ...
    address public constant DISCOUNT_ADDRESS = 0x2595fD53d19CC1c7463f8c832d138304B636f14E;
...
contract MCDSaverProxyHelper is DSMath {
    ...
    function getManagerAddr(ManagerType _managerType) public pure returns (address) {
        if (_managerType == ManagerType.MCD) {
            return 0x67690df94D16D84b99a2a2a5d4236b3B7aB9A459;
...
contract MCDSaverProxy is DFSExchangeCore, MCDSaverProxyHelper {
    ...
    address public constant VAT_ADDRESS = 0xb191a35D85347914Ff65Dfa4e61cc72170e5c364;
    address public constant SPOTTER_ADDRESS = 0x805745Cc35d2EA80AfC4eA7EEB1151D45669F80D;
    address public constant DAI_JOIN_ADDRESS = 0x9759A6Ac90977b93B58547b4A71c78317f391A28;
    address public constant JUG_ADDRESS = 0x19c0976f590D67707E62397C87829d896Dc0f1F1;
    address public constant DAI_ADDRESS = 0x6B175474E89094C44Da98b954EedeAC495271d0F;
    address public constant ETH_JOIN_ADDRESS = 0xC2078E16B13de25D0DB6DD091c7f59040B86E7D8;

    address public constant BOT_REGISTRY_ADDRESS = 0x9599d6B626eea1921314F9982F7858D150A10E5a;

    Vat public constant vat = Vat(VAT_ADDRESS);
    DaiJoin public constant daiJoin = DaiJoin(DAI_JOIN_ADDRESS);
    Spotter public constant spotter = Spotter(SPOTTER_ADDRESS);

    ElixyrsaverLogger public constant logger = ElixyrsaverLogger(0xeA343bA3d6b9800845Ba9390bf73cF1ad0980B71);
...
contract MCDCreateTaker is GasBurner {
    ...
    address payable public constant MCD_CREATE_FLASH_LOAN = 0x805273081476AA6E9dDe0651A8EEFeD7f33546E9;
    ...
    // solhint-disable-next-line const-name-snakecase
    Manager public constant manager = Manager(0x67690df94D16D84b99a2a2a5d4236b3B7aB9A459);
