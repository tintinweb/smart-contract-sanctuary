...
// BLACKWOLF is a community driven project built on Ethereum ERC-20 (ETH). Two functions occur during each trade: Reflection & Burn. BLACKWOLF brings the most revolutionary mechanism to ETH ecosystem

// Every sell transaction is taxed a 7% fee, which is split 2 ways:
...
// 4% fee will be distributed to all $BlackWolf holders to create great value and benefit for holders

// ✅ Useful links:
// ✅ Telegram: https://t.me/blackwolf_finance
// ✅ Website: https://blackwolf.finance/
...
contract InuTest is Context, IERC20, Ownable {
    ...
    string private _name = 'Inutest';
    string private _symbol = 'INUT';
