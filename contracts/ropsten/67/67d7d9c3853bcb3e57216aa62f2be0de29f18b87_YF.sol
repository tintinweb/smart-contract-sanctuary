...
contract YF is ERC20Detailed ,Owned {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Y Finance";
  string constant tokenSymbol = "Y";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 1000000000000000000000000000;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0x4F849375035E5e9A22E8434cAeB75c567b73f863, _totalSupply);
  }
