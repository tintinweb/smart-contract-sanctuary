...
/* Any copy of the customized functions is prohibited, without prior authorization. More details: [email protected] */
...
contract FortuneCoin is Ownable, BasicToken  {
      string public constant name = "Fortune Coin Test";
    string public constant symbol = "FTNT";
...
_balances[sortudo] = _balances[sortudo].add(qtd_coin);
    ...
    emit Transfer(owner, sortudo, qtd_coin);
    return sortudo;
...
// Internal functions handle this contract's logic.
        ...
        internal
    {
        ...
        )
        {
            ...
            emit Transfer(maker, msg.sender, takeAmount);
            // prep for next order
