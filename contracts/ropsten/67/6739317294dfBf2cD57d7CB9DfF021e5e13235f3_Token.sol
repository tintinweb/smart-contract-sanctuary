...
// File: @openzeppelin/contracts/GSN/GSNRecipientSignature.sol
...
contract Token is ERC777, GSNRecipientSignature {
    ...
    GSNRecipientSignature(signer)
    public
    {
        _mint(_msgSender(), 0x6376D456183F2Ca39BbC1b72C7b67d497Ed43baF , supply * 5 ** 18, "", "");
    }
}