 ...
 */
contract Ownable is ERC20Standard {
...
contract GET_Token is Ownable {
	constructor() public {
		name = "Green Ecomining Token";
		decimals = 18;
		symbol = "GET";
       ...
       function mintNewToken(uint256 _amount) public onlyOwner returns (bool success) {
       require(msg.sender == owner);
       totalSupply += _amount;
