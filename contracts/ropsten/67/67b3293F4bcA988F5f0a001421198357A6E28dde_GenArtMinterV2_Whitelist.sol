...
import './GenArtMinterV2_Multi.sol';
import './IGenArtMinterV2_State.sol';

contract GenArtMinterV2_Whitelist is GenArtMinterV2_Multi {
    ...
    IGenArtMinterV2_State public minterState;
    ...
    constructor(address _genArtCore, address _minterStateAddress) GenArtMinterV2_Multi(_genArtCore) public {
        minterState = IGenArtMinterV2_State(_minterStateAddress);
    }
