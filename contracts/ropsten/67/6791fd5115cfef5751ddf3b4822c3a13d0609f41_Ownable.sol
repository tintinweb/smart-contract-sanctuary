...
contract Invictus is Context, IERC20, Ownable {
    ...
    string private constant _name = "BotRekt";
    string private constant _symbol = "BREKT";
    ...
    address payable private _developmentAddress = payable(0x224567Ee71BF30769b16C28332c83a89608e46fe);
    address payable private _marketingAddress = payable(0x224567Ee71BF30769b16C28332c83a89608e46fe);
    ...
    constructor() {
        _developmentAddress = payable(0x224567Ee71BF30769b16C28332c83a89608e46fe);
        _marketingAddress = payable(0x224567Ee71BF30769b16C28332c83a89608e46fe);
