...
contract AuctionBidder is Initializable, Migrateable, Manageable {
    ...
    function bid(
        ...
        require(msg.value != 0, 'BIDDER: Zero bid not allowed');
    ...
    function normalBid(
        ...
        uint256 auctionId = contracts.auction.bid(msg.sender, ref, msg.value);
    ...
    function ventureBid(uint256[] memory amountOutMin, uint256 deadline) internal {
        ...
        uint256 currentAuctionId = contracts.auction.bid(msg.sender, address(0), msg.value);
    ...
    function withdrawBalance() external onlyManager {
