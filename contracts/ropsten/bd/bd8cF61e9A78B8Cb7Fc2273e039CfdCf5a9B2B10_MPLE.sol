...
contract MPLE is StandardToken, Ownable, Haltable {

  //define MPLE
  string public constant name = "MPLE";
  string public constant symbol = "MPLE";
  ...
  uint public INITAL_SUPPLY = 1000000000*(10**18);

  constructor () public {
    totalSupply_ = totalSupply_.add(INITAL_SUPPLY);
    balances[address(this)] = INITAL_SUPPLY;
  }
