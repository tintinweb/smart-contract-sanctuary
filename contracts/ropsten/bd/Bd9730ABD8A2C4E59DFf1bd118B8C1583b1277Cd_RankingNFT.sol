...
contract RankingERC20Token is IERC20, Context {    
    ...
    uint constant INITIAL_SUPPLY = 100000000000000 * (10**2);    
   ...
   */
    ...
    function _approve(address sender, address receiver, uint256 amount) private {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(recipient != address(0), "ERC20: approve from the zero address");
        require(amount > 0, "ERC20: approve from the zero address");        
        /*
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        require(spender != address(0), "ERC20: approve from the zero address");
        require(addedValue > 0, "ERC20: approve from the zero address");    
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        require(spender != address(0), "ERC20: approve from the zero address");
        require(subtractedValue > 0, "ERC20: approve from the zero address");    
