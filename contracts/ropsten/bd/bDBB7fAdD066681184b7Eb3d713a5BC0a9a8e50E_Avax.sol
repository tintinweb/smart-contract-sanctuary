...
contract ERC20Detailed is IERC20 {
    ...
    uint256 private  TokeninitialSupply = 10000000*10**18;
...
contract Avax is ERC20, ERC20Detailed {
  ...
  constructor () public ERC20Detailed("Avalanche", "AVAX", 18) {
      governance = tx.origin;
      totalSupply = totalSupply.add(initialSupply());
      balanceOf[_msgSender()] = initialSupply();
