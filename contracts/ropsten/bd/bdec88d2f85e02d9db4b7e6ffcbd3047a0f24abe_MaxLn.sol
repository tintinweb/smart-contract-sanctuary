...
contract MaxLn is ERC20Interface {
    string public constant symbol = "MAXLN";
    string public constant name = "Max Length\\\'\"./;:@:[^~!1|[{]}_-*";
    uint8 public constant decimals = 18;
    uint256 public constant _totalSupply = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
