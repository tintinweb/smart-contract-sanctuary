...
contract SingleRedemptionService {
    ...
    function redeem(address genArtCoreAddress, address singleRedemptionAddress, uint256 tokenId, uint256 variationId) public payable  {
        ...
        uint256 priceInWei = singleRedeemableProductContract.getVariationPriceInWei(genArtCoreAddress, projectId, variationId);
        ...
        singleRedeemableProductContract.incrementRedemptionAmount(msg.sender, genArtCoreAddress, tokenId, variationId);
        recipientAddress.transfer(msg.value);
        emit Redeem(genArtCoreAddress, singleRedemptionAddress, projectId, tokenId, redemptionCount.add(1), variationId);
    }
}