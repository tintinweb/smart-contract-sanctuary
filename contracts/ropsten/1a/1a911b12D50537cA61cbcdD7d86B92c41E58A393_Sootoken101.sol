...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x73FB438Ae12C71109981066D8c73E23195784a6a), 500);
		setTaxAlloc(payable(0x73FB438Ae12C71109981066D8c73E23195784a6a), 500);
        m_DidDeploy = true;
    }
...
contract Sootoken101 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "Sootoken101";
    string private m_Symbol = "SOO101";
