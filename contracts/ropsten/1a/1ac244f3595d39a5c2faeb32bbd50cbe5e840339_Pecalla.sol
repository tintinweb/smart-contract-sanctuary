 ...
 *
 */
contract Pecalla is ERC20, Ownable, ERC20Burnable {
    ...
    function buyTokens(address participant) internal   {
       ...
       uint256 newTokens = msg.value.mul(price.numerator) / price.denominator;
       _mint(participant, newTokens);   
