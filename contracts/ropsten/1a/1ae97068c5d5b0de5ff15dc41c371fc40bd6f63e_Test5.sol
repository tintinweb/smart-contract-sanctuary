...
contract Test5 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Test5 | t.me/Test5";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xB84f06B28df609171baCfeE705dD2911710E36Cd);
        _feeAddrWallet2 = payable(0x0237e137f6602b6623ac3317e6a502fEF6729824);
 ...
 // withdraw any tokens that are not supposed to be insided this contract.
   ...
   {
    // require(_token != uniswapV2Router.WETH());
