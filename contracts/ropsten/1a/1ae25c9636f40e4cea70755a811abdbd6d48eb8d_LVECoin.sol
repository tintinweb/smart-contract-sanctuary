...
contract LVECoin is ERC20Token, Pausable, Dealershipable {
    ...
    constructor() public{
        ...
        // DEBUG-S
        // // FoundingTeam Address
        // foundingTeamAddr = 0xa82a51e59741640F32F036a33Bd3f81838433AB9;
        // // Company Address
        ...
        // DEBUG-F
        // FoundingTeam Address
        foundingTeamAddr = 0x708ce7c6d547Cbd4C7fD889619c50e9d55471ED7;
        // Company Address
        companyAddr = msg.sender;
        ...
        // Locked warehouse
        // lock endTime
        uint256 endTime = now + 35 minutes;
        // uint256 endTime = 1533207600;
    ...
    function addlockAccount(address _lockAddr, uint256 _endTime, uint256 _lockAmount) internal returns(bool){
        ...
        lockedAccount.investAmount = lockedAccountMap[_lockAddr].investAmount.add(_lockAmount);
    ...
    function getSingleLocker(address _addr) public view returns(uint256 _rEndTime, address _rAddr, bool _rIsLocked, uint256 _lockAmount, uint256 _rInvestAmount){
        require(_addr != address(0));
        LockedAccount memory locker = lockedAccountMap[_addr];
        return(locker.endTime, locker.addr, locker.isLocked, locker.lockAmount, locker.investAmount);
    }
