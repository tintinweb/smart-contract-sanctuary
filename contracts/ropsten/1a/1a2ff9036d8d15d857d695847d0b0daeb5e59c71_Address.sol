...
/**
   ...
   2% fee auto moved to mkt wallet
*/
...
contract OneToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 11111111 * 10**9;
    ...
    uint256 public _maxTxAmount = 111111 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 111111 * 10**9;
