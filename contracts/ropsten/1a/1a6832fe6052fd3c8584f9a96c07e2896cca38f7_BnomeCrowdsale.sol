...
contract MintedCrowdsale is Crowdsale {
    ...
    internal
  {
    ...
    require(MintableToken(token).mint(wallet, _tokenAmount.div(78).mul(100)));
  }
}
...
// File: contracts/BnomeCrowdsale.sol

contract BnomeCrowdsale is Crowdsale, TimedCrowdsale, CappedCrowdsale, MintedCrowdsale {
