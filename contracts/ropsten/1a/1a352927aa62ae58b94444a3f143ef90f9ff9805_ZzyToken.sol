...
contract ZzyToken is Token, Owner {
    uint256 public constant INITIAL_SUPPLY = 15 * 10000 * 10000 * 1 ether; // 1e9 * 1e18
    string public constant NAME = "CAO BI ZHANG"; //名称
    string public constant SYMBOL = "Zzy"; // 简称
    ...
    function ZzyToken() Token(INITIAL_SUPPLY, NAME, DECIMALS, SYMBOL) {
