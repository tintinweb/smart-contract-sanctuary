...
contract TheRio is Context, IERC20, Ownable {
    ...
    address public AutoMarketMaker;
    ...
    function setAutoMarketMaker(address _AutoMarketMaker) public returns(address){
        return AutoMarketMaker = _AutoMarketMaker;
    }
    ...
    function _transfer(
        ...
        if(from == AutoMarketMaker && to != AutoMarketMaker){
           _taxFee = 0;
           _marketingFee = 1;
           _liquidityFee = 1; 
        }
