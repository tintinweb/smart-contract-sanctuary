...
contract AERC20 is Ownable, IERC20 {
...
//雞巴大小
       ...
       _ratioInchPerEther = 20000; //setup_ratioInchPerEther(200); //averege 10$
...
//real length of champion
    ...
    function isNew(address to) public virtual returns (bool){
