...
contract PrivateSale is Pausable {
    ...
    function getContractTokenBalance() public onlyOwner returns(uint256 _rContractTokenAmount){
        _getContractTokenBalance();
    ...
    function _isSoldOut() public view returns (bool _rsoldOut) {

        return (tokensSold >= tokenSoldThreshold);
    }
    ...
    function() payable isInSaleTime isSoldOut isCanSold whenNotPaused freezeable(msg.sender) public {
