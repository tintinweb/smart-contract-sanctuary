...
contract IWillRevertOnCondition is IERC20 {
    ...
    */
    string public name = 'IWillRevertOnCondition'; //fancy name: eg OVM Coin
    uint8 public decimals = 18; //How many decimals to show.
    string public symbol = 'IWRC'; //An identifier: eg OVM
