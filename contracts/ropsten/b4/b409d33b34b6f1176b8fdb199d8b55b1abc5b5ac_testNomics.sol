...
contract testNomics is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"testNomics" ;
    string private constant _symbol = unicode"testNomics";
    uint8 private constant _decimals = 9;

    uint256 private _baseTaxFee = 1;
    uint256 private _baseTeamFee = 9;
    ...
    function setFee(uint256 impactFee) private {
        ...
        _taxFee = (_impactFee.mul(_baseTaxFee)).div(10);
        _teamFee = (_impactFee.mul(_baseTeamFee)).div(10);
    }
    ...
    function setBaseTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 1 && taxFee <= 9, 'taxFee should be in 1 - 9');
        _baseTaxFee = taxFee;
    }
    
    function setBaseTeamFeePercent(uint256 teamFee) external onlyOwner() {
        require(teamFee >= 1 && teamFee <= 9, 'teamFee should be in 1 - 9');
        _baseTeamFee = teamFee;
    }
