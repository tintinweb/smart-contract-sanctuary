...
/**
 * @title ExdollarToken 
 * @dev Contract to create the ExdollarToken
 **/
contract ExdollarToken is CrowdsaleToken {
    string public constant name = "Exdollar";
    string public constant symbol = "EXDOLLAR";
