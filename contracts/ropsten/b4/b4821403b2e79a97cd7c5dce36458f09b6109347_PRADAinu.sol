 ...
 * https://t.me/PRADAinu
 *
 * PRADAinu is a meme token with a twist!
 * PRADAinu has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 *
 * TOKENOMICS:
...
contract PRADAinu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PRADA Inu || t.me/PRADAinu";
    string private constant _symbol = unicode"PRADAinu";
