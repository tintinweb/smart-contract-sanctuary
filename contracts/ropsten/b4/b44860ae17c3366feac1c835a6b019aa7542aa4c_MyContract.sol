...
contract MyContract{
    ...
    function my_status (uint give_me_something_bigger_than_1) public view returns (bool do_i_have_a_token, uint the_token_index, uint256 my_current_balance){
        if (give_me_something_bigger_than_1 > 1){
