...
contract ShariqCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ShariqCoin() {
        ...
        name = "ShariqCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-052";                                             // Set the symbol for display purposes (CHANGE THIS)
