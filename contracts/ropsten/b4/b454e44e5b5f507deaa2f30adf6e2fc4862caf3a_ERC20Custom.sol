...
contract ERC20 is IERC20 {
    ...
    */
    ...
    /**
     * @dev Internal function that s an amount of the token and assigns it to
     * an account. This encapsulates the modification of balances such that the
     * proper events are emitted.
     * @param account The account that will receive the created tokens.
     * @param value The amount that will be created.
     */
    function _(address account, uint256 value) internal {
        require(account != address(0));
...
contract ERC20Custom is ERC20Detailed, ERC20Pausable {
    ...
    constructor(
        ...
        _(msg.sender, initialSupply * (10 ** uint256(decimals)));
    }
