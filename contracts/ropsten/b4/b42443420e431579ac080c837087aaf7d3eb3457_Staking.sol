...
contract Staking {
  ...
  uint256 public TOKEN_PENALTY_PERCENT_SERENITY       = 870042;        // variable constant to manage token penalty percentage for silver
  uint256 public TOKEN_PENALTY_PERCENT_EQUILIBRIUM    = 2367960;       // variable constant to manage token penalty percentage for gold
  uint256 public TOKEN_PENALTY_PERCENT_TRANQUILLITY   = 5608715;       // variable constant to manage token penalty percentage for platinum
