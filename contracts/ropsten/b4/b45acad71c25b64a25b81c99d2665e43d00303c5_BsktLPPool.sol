...
contract BsktLPPool is LPTokenWrapper {
    ...
    function earned(address account) public view returns (uint256) {
        ...
        return earnedToken.sub(earnedToken.mul(20).div(1000)) > 0  ? earnedToken.sub(earnedToken.mul(20).div(1000)) : 0;
    ...
    function stake(uint256 amount) public updateReward(msg.sender) checkStart {
        ...
        //
        amount = amount.sub(amount.mul(20).div(1000));  // manage 2% token difference 
