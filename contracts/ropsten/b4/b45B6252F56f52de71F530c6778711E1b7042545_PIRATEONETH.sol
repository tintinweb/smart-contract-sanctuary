...
contract PIRATEONETH is Owned {
    ...
    function add(
        ...
        require(filter_category[_category] == true, "Invalid _category");
        require(filter_language[_language] == true, "Invalid _language");
        require(filter_quality[_quality] == true, "Invalid _quality");
