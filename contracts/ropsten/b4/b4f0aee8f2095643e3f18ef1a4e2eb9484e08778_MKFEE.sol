...
contract MKFEE  is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "MKFEE";                                           // name
    string private _symbol = "$MKF";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x850aDe8D50260b2087E62D2fa0805BCEC7F9F7Cc);
