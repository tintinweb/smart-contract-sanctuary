...
contract RarePepe is ERC721Enumerable, Ownable {
    ...
    constructor(string memory contractMetadataHash, string memory tokenMetadataHash)
    ...
    function initializePepes(uint16[] memory availablePepeIds)
        external
        onlyOwner
    {
    ...
    function updateIpfsPrefix(string memory ipfsPrefix)
        external
        onlyOwner
    {
