...
/**
 * Missed GM and all the other Clown coins?
 * Starting Liquidity with 4 ETH
 * Charity Wallet will be used for Calls + Marketing
 * This can't be happening without the Community
 * 
 * W(ill) I() N(ever) G(onna) M(ake) I(t)
 * 
 * t.me/WINGMI
 */
...
contract WINGMI is Context, IERC20, Ownable {
    ...
    string private _name = "WINGMI";
    string private _symbol = "WINGMI";
