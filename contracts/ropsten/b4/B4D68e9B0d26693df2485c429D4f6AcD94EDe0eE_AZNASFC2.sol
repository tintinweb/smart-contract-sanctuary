...
contract AZNASFC2 is ERC721, ERC721Enumerable, Ownable {
        ...
        payable
    {
        ...
        require(
            totalSupply().add(_number) <=
                maxSupply.sub(maxReserve),
            "There are no more commandos left to be minted."
        );
        ...
        //maxYellowGiantTeamReserve = maxYellowGiantTeamReserve.sub(_number);
