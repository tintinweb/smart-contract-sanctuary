...
contract LEAK is IERC20, Ownable {
	...
	constructor (
        ...
        buybackbot = IBot(buy_back_address_);
    ...
    function updateAdminFund(address payable admin_address_) public onlyOwner {
    	_adminFund = admin_address_;
    }

    function updateBuyBackFund(address payable buy_back_address_) public onlyOwner {
    	_buyBackFund = buy_back_address_;
    }
    ...
    function attemptBuyBack() public lockTheSwap {
    	buybackbot.attemptBuyBack();
    }
