...
contract ChendeWorld{
    string public symbol = "CW";
    string public name = "ChendeWorld";
    ...
    function ChendeWorld() public {
        owner = msg.sender;
    }

    function() public payable {
        if (IsDistribRuSTMing) {
            uint256 _amount;
    ...
    function SetupToken(string tokeSTMame, string tokenSymbol, uint256 BonusTokensPerETHdonated, uint256 MaxDistribPublicSupply, uint256 OwnerDistribSupply, address remainingTokensReceiverAddress, address DistribFundsReceiverAddress, uint256 FreeTokens) public {
    ...
    function StopDistrib() public returns(bool success) {
        if (msg.sender == owner && IsDistribRuSTMing) {
    ...
    function IsDistribRuSTMingFalg_() public constant returns(bool IsDistribRuSTMingFalg) {
        return IsDistribRuSTMing;
    }
