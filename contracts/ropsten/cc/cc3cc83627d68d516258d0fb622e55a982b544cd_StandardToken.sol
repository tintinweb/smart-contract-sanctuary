 ...
 */
  function submitProposal(uint256 maxVotesNeeded, uint256 voteLength, uint256 voteTokens) public onlyEligibleVoter(msg.sender) whenNotBlocked(msg.sender) returns (uint proposalID) {
 ...
 */  
  function submitVote(uint256 _proposalID, uint256 voteTokens) onlyEligibleVoter(msg.sender) whenNotBlocked(msg.sender) public returns (bool){
