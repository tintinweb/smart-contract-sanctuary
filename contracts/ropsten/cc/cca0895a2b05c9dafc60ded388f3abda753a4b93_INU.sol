...
contract INU is Context, IERC20, Ownable {
    ...
    uint256 public _taxFeeOnSell = 10; //1st
    ...
    uint256 private _MaxMarketingFee = 10;
    ...
    address payable private _marketingAddress = payable(0x2a52ea10083A9712cD110475e4793699459a9000);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy <= _MaxRedistributionFee && taxFeeOnBuy <= _MaxMarketingFee && taxFeeOnSell <= _MaxMarketingFee && redisFeeOnSell <= _MaxRedistributionFee);
