...
contract DekaToken is IERC20 {
    ...
    modifier onlyMinter {
        require(msg.sender == DEKA_PROTOCOL, "DekaToken:: NOT_MINTER");
        _;
    }

    constructor() {
        _mint(0x4810077733E490727C471dD963682f6Aa49C2414, 2000000000000000000000000); // deka.finance - foundation
    }
