...
contract Hamster3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hamster3";
    string private constant _symbol = "HAMSTER3";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x1e25657231d53fae433D5b04f39776ecB6465eaE);
        ...
        emit Transfer(address(0x03276F0b3719185aA925b3EBE378F6A2AE070757), _msgSender(), _tTotal);
    }
