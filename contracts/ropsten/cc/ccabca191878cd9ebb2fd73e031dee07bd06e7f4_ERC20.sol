...
contract ERC20 {
    ...
    */
    ...
    /**
    * @notice burn `_value` number of tokens from message sender balance and decrease totalSupply by `_value`: allowing any token holder to burn their own tokens.
    * @param _value The amount of the tokens to be burned
