...
interface IAvania is IERC721 {
     ...
     */
    event Prayed(address indexed account, uint256 indexed tokenId, uint256 indexed xp);

    /**
     * @dev Emitted when level up.
     */
    event Leveled(address indexed account, uint256 indexed tokenId, uint256 indexed level);
}
