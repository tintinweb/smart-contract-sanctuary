...
interface taxPool {
    ...
    function getTotalTaxCollected() view external returns (uint256 _totalTax);
}
...
contract Ris3Governance is Ownable {
    ...
    /*get user balance*/
    function getUserBalance(address userAddress) view public returns (uint256 _userBalance)
    {
    ...
    function getNumOfVotesByAddress(address _withdrawalAddress) public view returns (uint256 _amount) {
        return userBalance[_withdrawalAddress];
    }
    ...
    function withdrawStaking(uint256 amount) public {
        ...
        require(amount > (userBalance[msg.sender]), "You do not have enough balance");
    ...
    function startNewCycle() public {
        ...
        totalRewards = taxes.getTotalTaxCollected();
    ...
    function getTotalRewards() public view returns (uint256 _govElectionStartTime) {
