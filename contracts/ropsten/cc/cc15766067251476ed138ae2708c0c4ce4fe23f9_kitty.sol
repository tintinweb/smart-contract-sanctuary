...
contract DividendDistributor is IDividendDistributor {
    ...
    address WETH = 0xc778417E063141139Fce010982780140Aa0cD5Ab; // 0xc778417e063141139fce010982780140aa0cd5ab ropsten
...
contract kitty is IERC20, Auth {
    ...
    // 25% fee
    uint256 public constant AD_24HR_reflectionFee = 434;
    uint256 public constant AD_24HR_marketingFee = 1639; // 17.39%
    uint256 public constant AD_24HR_liquidityFee = 100;
    uint256 public constant AD_24HR_devFee = 327; // 3.27%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xbEf80e9C01CDC5359B9FfDd05d3d1Fb3fbe0bD0e;
        devFeeReceiver = 0xfC250A6adc1Ca8F6a3f23926621FA9764c51ffbE;
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        if (originalPurchase(sender) !=0 &&
            ((originalPurchase(sender) + (10 minutes)) >= block.timestamp)) {
                feeAmount = amount.mul(totalFee = AD_24HR_totalFee).div(10000);
