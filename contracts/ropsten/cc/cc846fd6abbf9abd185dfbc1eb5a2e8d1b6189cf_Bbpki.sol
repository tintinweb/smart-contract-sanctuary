...
certificates[serialNumber].blockNumber = block.number;
  ...
  //  certificates[noOfcertificates] = certificate(serialNumber, subjectName, organisation, issuer, expiry, noOfSignatures,defaultStatus,signatures);
     emit certificateSigned(serialNumber, subjectName, issuer, expiry,Status,certificates[noOfcertificates].signatures, blockNumber);
     return (serialNumber, subjectName, issuer, expiry,Status,certificates[noOfcertificates].signatures, blockNumber );
    }
