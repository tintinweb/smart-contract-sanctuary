 ...
 * @author Remco Bloemen <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="394b5c545a56790b">[email&#160;protected]</a>π.com>, Eenae <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cdaca1a8b5a8b48da0a4b5afb4b9a8bee3a4a2">[email&#160;protected]</a>>
...
contract Crowdsale is ReentrancyGuard {
  ...
  {
    value = value.mul(1 ether);
    require(value <= _token.totalSupply());
  ...
  function increaseAllowanceToken(address spender, uint256 addedValue) public {
    addedValue = addedValue.mul(1 ether);
    require(addedValue <= _token.totalSupply());
  ...
  function decreaseAllowanceToken(address spender,uint256 subtractedValue) public {
     subtractedValue = subtractedValue.mul(1 ether);
    require(subtractedValue <= _token.totalSupply());
