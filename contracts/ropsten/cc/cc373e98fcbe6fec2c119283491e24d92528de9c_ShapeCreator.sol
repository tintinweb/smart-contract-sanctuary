...
contract ShapeCreator {
    ...
    string svgWrapperStart = '<svg viewBox="0 0 65536 65536" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="65536" height="65536" fill="white"/>';
    ...
    uint256 baseX = 24;
    uint256 stepX = 24;
    uint256 baseWidth = 65488;
    uint256 stepWidth = 48;
    uint256 subshapeCount = 1024;
