...
contract Time is ERC20 {
    ...
    event RewardSent(address timeMiner, uint256 reward, uint256 timeReleased, uint gasPrice );
    ...
    function unlockTime() public {
        ...
        uint256 reward = ( block.timestamp  - lastTimeClaim - timeFrequency)* 10 ** uint(decimals()) ;
        uint256 timeReleased = timeFrequency * 10 ** uint(decimals()); 
        ...
        emit RewardSent(msg.sender, reward , timeReleased,gasPrice*(gasUsed+21000) );
    }
