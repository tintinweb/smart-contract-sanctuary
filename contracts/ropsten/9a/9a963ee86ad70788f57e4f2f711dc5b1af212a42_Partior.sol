...
/* Copyright (C) 2021 PAWAN PANDEY - All Rights Reserved
...
contract BasicToken is Ownable, ERC20Basic, ReentrancyGuard{
    ...
    function setdonationWallet(address newWallet) public onlyOwner() {
     ...
     * @param feeEnabled The FLAG TO ENABLE/DISABLE Fee Calculation.
     */
    function setFeeEnabled(bool feeEnabled) public onlyOwner returns (bool) {
    ...
    function donate(address to, uint256 value) private  returns (bool) {
 ...
 */
contract Partior is BasicToken {
