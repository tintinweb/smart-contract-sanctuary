...
contract TegTokens {
    ...
    address public salesaccount;           // Where should the raised ETH go?
    ...
    function TegTokens(
        ...
        totalEthInWei = 1000000000000000000;                                    // The owner of the contract gets ETH
    }
    ...
    // transfer balance to owner withdraw owner
  	function withdrawEther(uint256 amount) public returns (bool success){
  		require(msg.sender == fundsWallet);
      //require(msg.value == multiply(amount, totalEthInWei));
      amount = amount * totalEthInWei;
    ...
    //  investreturns = msg.value + totalEthInWei;
      investreturns = investreturns + msg.value;
      uint256 amount = investreturns * coinunits;
