 ...
 * @author Rifi
 */
contract Cointroller is CointrollerStorage, CointrollerInterface, CointrollerErrorReporter, ExponentialNoError {
...
contract RToken is RTokenInterface, Exponential, TokenErrorReporter {
    ...
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, RTokenInterface rTokenCollateral) internal returns (uint, uint) {
        ...
        if (allowed != 0) {
            return (failOpaque(Error.COINTROLLER_REJECTION, FailureInfo.LIQUIDATE_COINTROLLER_REJECTION, allowed), 0);
        }
        ...
        require(amountSeizeError == uint(Error.NO_ERROR), "LIQUIDATE_COINTROLLER_CALCULATE_AMOUNT_SEIZE_FAILED");
        ...
        /* We call the defense hook */
        // unused function
        // cointroller.liquidateBorrowVerify(address(this), address(rTokenCollateral), liquidator, borrower, actualRepayAmount, seizeTokens);
...
contract TokenErrorReporter {
    enum Error {
        ...
        UNAUTHORIZED,
        BAD_INPUT,
        COINTROLLER_REJECTION,
        COINTROLLER_CALCULATION_ERROR,
    ...
    enum FailureInfo {
        ...
        BORROW_COINTROLLER_REJECTION,
        LIQUIDATE_ACCRUE_BORROW_INTEREST_FAILED,
        LIQUIDATE_ACCRUE_COLLATERAL_INTEREST_FAILED,
        LIQUIDATE_COLLATERAL_FRESHNESS_CHECK,
        LIQUIDATE_COINTROLLER_REJECTION,
        ...
        LIQUIDATE_SEIZE_COINTROLLER_REJECTION,
        LIQUIDATE_SEIZE_LIQUIDATOR_IS_BORROWER,
        LIQUIDATE_SEIZE_TOO_MUCH,
        MINT_ACCRUE_INTEREST_FAILED,
        MINT_COINTROLLER_REJECTION,
        ...
        REPAY_BORROW_COINTROLLER_REJECTION,
        ...
        TRANSFER_COINTROLLER_REJECTION,
...
contract RBep20Interface is RBep20Storage {
