...
contract DinoCrypto is ERC721, Ownable {
    using SafeMath for uint256;
 
    uint256 public immutable pricePerKILLA;
    uint256 public immutable maxPerTx;
    uint256 public immutable maxDinoCrypto;
    ...
    function reserveDinoCrypto() public onlyOwner {   
     ...
     function mintDinoCrypto(uint256 numberOfTokens) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 20 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxDinoCrypto, "Purchase would exceed max supply of DinoCrypto");
