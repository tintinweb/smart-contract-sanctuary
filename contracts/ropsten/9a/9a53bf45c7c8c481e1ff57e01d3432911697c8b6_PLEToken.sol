...
contract PLEToken is ERC20Interface, Owned, Pausable, ERC1132 {
    ...
    /* always capped by 100M tokens */
    uint256 internal constant MAX_TOTAL_SUPPLY = 100_000_000;
        ...
        returns (bool success)
    {
        if (approve(_spender, _value)) {
            require(ApproveAndCallFallBack(_spender).receiveApproval(msg.sender, _value, address(this), _data) == true);
            return true;
        }
        return false;
    }
