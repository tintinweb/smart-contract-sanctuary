...
contract TrapDogs is Context,  AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage{
  ...
  function mintMultipleTestTwo(uint256 number) public payable {
	uint256 targetSupply = _max - number + 1;
    require(_tokenIdTracker.current() < targetSupply, "TrapDogs: all TrapDogs have been minted");
  ...
  function mintMultipleTestThree(uint256 number) public payable {
