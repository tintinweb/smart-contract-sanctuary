...
contract NftBattleArena is Ownable, ERC721
{
	...
	uint256 public firstStageDuration = 12 minutes;      	//todo:change time //3 days;    // Duration of first stage(stake).
	uint256 public secondStageDuration = 12 minutes;      	//todo:change time //7 days;    // Duration of second stage(DAI).
	uint256 public thirdStageDuration = 10 minutes;       	//todo:change time //2 days;    // Duration of third stage(Pair).
	uint256 public fourthStageDuration = 12 minutes;       	//todo:change time //5 days;    // Duration fourth stage(ZOO).
	uint256 public fifthStageDuration = 12 minutes;        	//todo:change time //2 days;    // Duration of fifth stage(Winner).
