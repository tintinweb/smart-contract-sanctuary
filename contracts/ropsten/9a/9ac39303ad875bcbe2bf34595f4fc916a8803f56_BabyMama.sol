...
//  BabyMama Token Summary - Don't buy this token.
//  3% tax to fund donations 
//  4% tax to support marketing and token growth
//  Please note, donation and marketing wallets can be adjusted as need for the success of this token
contract BabyMama is Context, IERC20, Ownable {
    ...
    string private _name = "BabyMama";
    string private _symbol = "BABYMAMA";
    ...
    uint256 public _numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    ...
    address payable public _donationWallet = payable(0xA44E8b917EB640e2080429158681E786aCCB79b4);          // donation wallet
