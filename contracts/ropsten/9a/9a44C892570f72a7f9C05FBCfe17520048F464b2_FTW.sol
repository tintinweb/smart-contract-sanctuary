...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x2B58fc2a5CC4A0d34D79a6Bc24d4Db9bB175b392), 9000);
        m_DidDeploy = true;
    }
...
contract FTW is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "FTW";
    string private m_Symbol = "FTW";
