...
contract ARTStaking is IERC1155Receiver {
  ...
  // stake NFT,
  function stake(uint256 _nftID, address _nftAddress) external nonReentrant {
    ...
    require(rewardEndBlock > block.number, "staking time has ended");
  ...
  function unstake(uint256 _nftID, address _nftAddress) external nonReentrant {
