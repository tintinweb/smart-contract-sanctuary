...
contract lockToken is owned{
    ...
    */
     ...
     *lock tokens
    */
      function lockTokens(address _tokenAddress, uint256 _amount) public returns (uint256 _id) {
    ...
    */
    ...
    function getDepositDetails(uint256 _id) view public returns (address, address, uint256, bool)
    {
        return(lockedToken[_id].tokenAddress,lockedToken[_id].withdrawalAddress,lockedToken[_id].tokenAmount,lockedToken[_id].withdrawn);
    }
