...
contract Moons is ERC20Burnable, Ownable {
    /*
     ______             _             
    (____  \           (_)            
    ...
    */
    ...
    address public THEMOONMONSTERAddress;
    ...
    constructor() ERC20("Moons", "MOONS") {}

    function setTHEMOONMONSTERAddress(address _THEMOONMONSTERAddress) public onlyOwner {
        THEMOONMONSTERAddress = _THEMOONMONSTERAddress;
        return;
    }
    ...
    function stakeByIds(uint256[] memory tokenIds) public {
        for (uint256 i = 0; i < tokenIds.length; i++) {
            require(
                IERC721(THEMOONMONSTERAddress).ownerOf(tokenIds[i]) == msg.sender &&
                    tokenIdToStaker[tokenIds[i]] == nullAddress,
                "Token must be stakable by you!"
            );

            IERC721(THEMOONMONSTERAddress).transferFrom(
                msg.sender,
                address(this),
                tokenIds[i]
            );
