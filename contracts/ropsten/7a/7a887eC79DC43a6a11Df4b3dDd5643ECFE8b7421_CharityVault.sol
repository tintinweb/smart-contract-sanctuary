...
contract CharityVault {
    ...
    function createVault(
        ...
        address payable charityAddress
            ...
            vault.createdAt = getBlockTimestamp();
    ...
    function checkEthRate() public returns (uint256)
    {
        CEth cToken = CEth(_cEtherContract);
    ...
    function distributeFundsBack(uint256 vaultId) public payable {
        Vault storage vault = vaults[vaultId];
    ...
    function getBlockWeek() public view returns (uint) {
