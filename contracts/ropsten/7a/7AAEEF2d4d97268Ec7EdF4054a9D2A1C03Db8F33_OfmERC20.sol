...
contract OfmERC20 is IERC20, AccessControl {
   ...
   *
   * @dev ERC20 `function max_total_supply() public view returns (uint256)`
   *
   * @dev Field is declared public: getter max_total_supply() is created when compiled,
   *      it returns the maximum amount of tokens that can be minted.
   */
  uint256 public constant max_total_supply = 50_000_000e18; // is set to 50 million * 10^18
  ...
  function mint(address _to, uint256 _value) public {
    ...
    require(_totalSupply + _value <= max_total_supply, "max total supply set to 50 million");
