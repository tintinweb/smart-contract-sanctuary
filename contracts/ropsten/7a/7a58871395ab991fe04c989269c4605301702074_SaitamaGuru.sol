...
contract SaitamaGuru is Context, IERC20, Ownable {
    ...
    uint256 public _whaleTaxPoint = 5 * 10**12;
    ...
    function setWhaleTaxPercent(uint256 whaleTaxPercent) external onlyOwner {
        _whaleTaxPoint = whaleTaxPercent * 10**12;
    }
