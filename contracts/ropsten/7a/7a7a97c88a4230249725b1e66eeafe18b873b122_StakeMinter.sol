...
contract StakeMinter is IStakeMinter, Pausable, ExternallyCallable {
    ...
    */
    ...
    function mintExistingLegacyStake(uint256 id) external pausable {
        mintExistingLegacyStakeInternal(msg.sender, payable(msg.sender), id, true);
    }
    ...
    function mintExistingLegacyStakeFrom(
        ...
        mintExistingLegacyStakeInternal(from, to, id, false);
    }
...
interface IStakeCustodian {
    ...
    function isOwnerOfStake(address account, uint256 stakeId) external view returns (bool);
}
