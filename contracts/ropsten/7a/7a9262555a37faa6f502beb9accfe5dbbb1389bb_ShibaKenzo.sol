...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner =0xa14eF51954504A4c9d41c87f309eb92f024fDF03;
...
contract ShibaKenzo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    uint256 Rate = 1000000000;

    string private _name = "ShibaKenzo";
    ...
    uint256 internal _tokenTotal = 1000000000000000*(10**decimals());
    ...
    uint256 public _taxFee = 5; // means 5% which distribute to all holders
    uint256 public _liquidityFee = 5; // means 5% add liquidity on each buy and sell
    uint256 public _burnFee = 0; // means 0% it menas no burn 
    
    
    
    address preSale =0x68362a53b4090c29DAb4dE8190aB4d2fBEd23BA6;
                //0x68362a53b4090c29DAb4dE8190aB4d2fBEd23BA6;
    ...
    //     uniswapV2Router = _uniswapV2Router;
        ...
        _reflectionBalance[owner()] = reflectionFromToken(500000000000000e9,false);
        _reflectionBalance[preSale] = reflectionFromToken(500000000000000e9,false);
        
        emit Transfer(address(0),owner(), 500000000000000e9);
        emit Transfer(address(0),preSale, 500000000000000e9);
    }
    ...
    function burnPreSaleTokens() external onlyOwner {
        uint256 balance=balanceOf(preSale);
        _transfer(preSale,address(0),balance);
        preSaleFinalize=true;
    }
    ...
    receive() external payable {
        require(preSaleFinalize == false,"pre sale is finalize");
        require(msg.value>2e17 || msg.value<2e18,"in Valid bnb amount");
        uint256 amount=msg.value*Rate;
        _transfer(preSale,msg.sender,amount.div(1e9));
