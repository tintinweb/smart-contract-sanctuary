...
contract rmo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x77B60264b18eAd30eD9Df56A5ac25Eed5550886e); 
    //Send to Payback address
    address payable public paybackAddress = payable(0x77B60264b18eAd30eD9Df56A5ac25Eed5550886e);// 
    ...
    string private _name = "rmo2";
    string private _symbol = "rmo2";
    ...
    function prepareForPreSale() external onlyOwner {
     ...
     function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 8;
        _maxTxAmount = 20000000000 * 10**6 * 10**9;
    }
