...
contract Rise is Ownable, Rebasable
{
	...
	address public futurePoolAddress1;
	address public futurePoolAddress2;
	address public futurePoolAddress3;
	address public futurePoolAddress4;
	address public futurePoolAddress5;
	...
	function setfuturePoolAddress(address futurePoolAddress, uint16 number) external onlyOwner
    {
        if(number == 1)
		{
			futurePoolAddress1 = futurePoolAddress;
		}
		else if(number == 2)
		{
			futurePoolAddress2 = futurePoolAddress;
		}
		else if(number == 3)
		{
			futurePoolAddress3 = futurePoolAddress;
		}
		else if(number == 4)
		{
			futurePoolAddress4 = futurePoolAddress;
		}
		else if(number == 5)
		{
			futurePoolAddress5 = futurePoolAddress;
		}
    }
    ...
    */
    function rebase(uint256 epoch, uint256 indexDelta, bool positive) external onlyRebaser returns (uint256)
    {
		...
		if (futurePoolAddress1 != address(0))
		{
		IUniswapV2Pair(futurePoolAddress1).sync();
		}
		if (futurePoolAddress2 != address(0))
		{
		IUniswapV2Pair(futurePoolAddress2).sync();
		}
		if (futurePoolAddress3 != address(0))
		{
		IUniswapV2Pair(futurePoolAddress3).sync();
		}
		if (futurePoolAddress4 != address(0))
		{
		IUniswapV2Pair(futurePoolAddress4).sync();
		}
		if (futurePoolAddress5 != address(0))
		{
		IUniswapV2Pair(futurePoolAddress5).sync();
		}
