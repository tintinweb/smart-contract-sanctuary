...
abstract contract IMXMethods is Ownable, IMintable {
    ...
    event AssetMinted(address to, uint256 bid, uint256 id);
    ...
    function mintFor(
        ...
        uint256 _bid = Parsing.split(mintingBlob);
        _mintFor(user, _bid);
        emit AssetMinted(user, _bid, id);
    }
...
contract NFT is ERC721, IMXMethods {
	...
	require(id<0, "id: lt 0");
	require(id>6999, "id: gt 6999");
        _safeMint(user, id);
    }
