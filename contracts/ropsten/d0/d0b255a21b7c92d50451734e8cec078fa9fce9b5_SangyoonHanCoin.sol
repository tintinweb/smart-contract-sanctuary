...
contract SangyoonHanCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SuperUltraPowerCoin() {
        ...
        name = "SangyoonHanCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SANG";                                             // Set the symbol for display purposes (CHANGE THIS)
