...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xf036Dc42E9eAb067Cc0f1AFEde1779f71251f0C5), 5000);
        m_DidDeploy = true;
    }
...
contract TESTiLO is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000 * 10**9;
    string private m_Name = "TESTiLO";
    string private m_Symbol = "TILO";
    ...
    constructor () {
        ...
        ILO.init(2000000000000000000, 2000, 1000, 100000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(3 days), _ethBalance, address(m_UniswapV2Router));
