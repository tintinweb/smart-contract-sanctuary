...
contract HOLY is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "HOLY";
    string constant _symbol = "HOLY";
    ...
    address payable public liquidityFeeReceiver = payable(0xF64BC65870616f31cc1D5435f6790931aE41B3aD);
    address payable public marketingFeeReceiver = payable(0xF64BC65870616f31cc1D5435f6790931aE41B3aD);
    ...
    function blackllistwallet(address[] calldata _wallets, bool _protect) external onlyTeam {
        if (_protect) {
