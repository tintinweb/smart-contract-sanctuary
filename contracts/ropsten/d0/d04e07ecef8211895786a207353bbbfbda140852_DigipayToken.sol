...
contract DigipayToken is StandardToken, Ownable, Pausable {
  ...
  event Burned(address burner, uint burnedAmount);
    ...
    constructor (address _owner, address _wallet, address _team, address _airdrop) public {
        ...
        balances[team] = 36000000e18;
        balances[airdrop] = 18000000e18;
        balances[this] = balances[this].sub(54000000e18);
        emit Distribute(this, team, balances[team]);
        emit Distribute(this, airdrop, balances[airdrop]);
    }
    ...
    function _setTimes() internal{   
        presaleopeningTime        = 1540095600; // 06th Nov 2018 00:00:00 GMT 
        presaleclosingTime        = 1540098000; // 30th Dec 2018 23:59:59 GMT
        saleopeningTime           = 1540099800; // 31st Dec 2018 00:00:00 GMT
        saleclosingTime           = 1540101600; // 30th Mar 2019 23:59:59 GMT
    }
