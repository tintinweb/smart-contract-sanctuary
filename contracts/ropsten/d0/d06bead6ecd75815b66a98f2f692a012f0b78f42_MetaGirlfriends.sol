...
contract MetaGirlfriends is ERC721, Ownable {
    ...
    uint public presale_price = 0.07 ether;
    ...
    uint16[10] traitQuantities_0 = [700, 300, 125, 75, 150, 0, 0, 0, 0, 0]; // Background
    uint16[10] traitQuantities_1 = [6000, 600, 200, 0, 0, 0, 0, 0, 0, 0]; // Tail
    uint16[10] traitQuantities_2 = [8500, 1000, 100, 200, 0, 0, 0, 0,0,0]; // Back
    uint16[10] traitQuantities_3 = [700, 1500, 500, 400, 300, 200, 100, 0, 0, 0]; // Skin
    uint16[10] traitQuantities_4 = [3000, 2000, 1500, 1500, 1000, 500, 300, 200, 0, 0]; // Vag
    uint16[10] traitQuantities_5 = [2500, 500, 300, 150, 100, 50, 0, 0, 0, 0]; // Tattoos
    uint16[10] traitQuantities_6 = [700, 1300, 500, 400, 300, 100, 200, 0, 0, 0]; // Eyes
    uint16[10] traitQuantities_7 = [300, 200, 100, 50, 25, 0, 0, 0, 0, 0]; // Mouth
    uint16[10] traitQuantities_8 = [0, 75, 70, 75, 70, 60, 65, 40, 30, 10]; // Hair
    uint16[10] traitQuantities_9 = [3000, 1500, 1000, 500, 0, 0, 0, 0, 0, 0]; // Piercings
    uint16[10] traitQuantities_10 = [1500, 800, 700, 500, 300, 150, 100, 0, 0, 0]; // Face
    uint16[10] traitQuantities_11 = [1500, 1200, 750, 500, 400, 500, 0, 0, 0, 0]; // Neck
    uint16[10] traitQuantities_12 = [4000, 2500, 1500, 500, 0, 0, 0, 0, 0, 0]; // Earrings
    uint16[10] traitQuantities_13 = [0, 1000, 650, 500, 400, 0, 0, 0, 0, 0]; // Panties
    uint16[10] traitQuantities_14 = [0,1200, 700, 500, 400, 0, 0, 0, 0, 0]; // Bra
    uint16[10] traitQuantities_15 = [500, 750, 500, 250, 125, 0, 0, 0, 0, 0]; // Shoes
    uint16[10] traitQuantities_16 = [0, 500, 300, 200, 100, 0, 0, 0, 0, 0]; // Full outfit
    uint16[10] traitQuantities_17 = [0, 600, 400, 150, 125, 0, 0, 0, 0, 0]; // Clothing bottom
    uint16[10] traitQuantities_18 = [0, 400, 500, 400, 200, 100, 50, 0, 0, 0]; // Clothing top    
    uint16[10] traitQuantities_19 = [1000, 300, 250, 350, 200, 350, 150, 100, 0, 0]; // Head
    ...
    uint8[10] traitNumbers_8 =[1,8,8,24,28,20,40,24,9,5];
    ...
    uint8[10] traitNumbers_13 =[1,6,4,2,1,0,0,0,0,0];
    uint8[10] traitNumbers_14 =[1,6,2,2,1,0,0,0,0,0];
    ...
    */    
    ...
    /*
    *    @dev Generate pseudo random number using sender, serial number, and nonce
    *    (not using block number to avoid node bribing)
    */
    ...
    /*
    *    @dev Returns a random trait between 0 and sum(traitQuantities*traitNumbers) 
    */
    // traitQuantities*traitNumbers must sum up to 10k
    ...
    function _hairAllowsHat(uint8 t8, uint8 t19) internal pure returns (bool){
        return !(( (t8>=17 && t8<=32) || (t8>=65 && t8<=80) || (t8>=97 && t8<=120) || (t8>=137 && t8<=152) || (t8>=153 && t8<=158) ) && ((t19>=1 && t19<=10) || t19==32) );
    }
    ...
    function _generateGirlFriend(uint256 tokenId) internal view returns (uint256) {
        ...
        traits[0] = _randomTrait( _concatBytes(hash[0], hash[1]), traitQuantities_0, traitNumbers_0);
        traits[1] = _randomTrait( _concatBytes(hash[2], hash[3]), traitQuantities_1, traitNumbers_1);
        traits[2] = _randomTrait( _concatBytes(hash[4], hash[5]), traitQuantities_2,traitNumbers_2);
        traits[3] = _randomTrait( _concatBytes(hash[6], hash[7]), traitQuantities_3, traitNumbers_3);
        traits[4] = _randomTrait( _concatBytes(hash[8], hash[9]), traitQuantities_4, traitNumbers_4);
        traits[5] = _randomTrait( _concatBytes(hash[10], hash[11]), traitQuantities_5, traitNumbers_5);
        traits[6] = _randomTrait( _concatBytes(hash[12], hash[13]), traitQuantities_6, traitNumbers_6);
        traits[7] = _randomTrait( _concatBytes(hash[14], hash[15]), traitQuantities_7, traitNumbers_7);
        traits[8] = _randomTrait( _concatBytes(hash[16], hash[17]), traitQuantities_8, traitNumbers_8);
        traits[9] = _randomTrait( _concatBytes(hash[18], hash[19]), traitQuantities_9, traitNumbers_9);
        traits[10] = _randomTrait( _concatBytes(hash[20], hash[21]), traitQuantities_10, traitNumbers_10);
        traits[11] = _randomTrait( _concatBytes(hash[22], hash[23]), traitQuantities_11, traitNumbers_11);
        traits[12] = _randomTrait( _concatBytes(hash[24], hash[25]), traitQuantities_12, traitNumbers_12);
        traits[13] = _randomTrait( _concatBytes(hash[26], hash[27]), traitQuantities_13, traitNumbers_13);
        traits[14] = _randomTrait( _concatBytes(hash[28], hash[29]), traitQuantities_14, traitNumbers_14);
        traits[15] = _randomTrait( _concatBytes(hash[30], hash[31]), traitQuantities_15, traitNumbers_15);

        hash = _pseudoRandomHash(tokenId, 2);
        // deal with incompatible traits : full suit vs top+bottom
        if(uint8(hash[8])>=128){
            traits[16] = _randomTrait( _concatBytes(hash[0], hash[1]), traitQuantities_16, traitNumbers_16);
        }else{
            traits[17] = _randomTrait( _concatBytes(hash[2], hash[3]), traitQuantities_17, traitNumbers_17);
            traits[18] = _randomTrait( _concatBytes(hash[4], hash[5]), traitQuantities_18, traitNumbers_18);            
        }
        traits[19] = _randomTrait( _concatBytes(hash[6], hash[7]), traitQuantities_19, traitNumbers_19);
    ...
    function _mint(uint256 quantity, uint256 _price) internal {
        require(quantity > 0, "MG: Invalid quantity");        

        require(tokensMinted+quantity <= maxSupply - tokensReserved, "MG: Max supply exceeded");
        require(quantity <= buyLimit, "MG: Buy limit per txn exceeded");
        require(_price*quantity == msg.value, "MG: invalid price");
    ...
    */
    ...
    function setPresalePrice(uint256 newPrice) external devOrOwner{
