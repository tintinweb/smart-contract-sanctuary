...
contract VariChainCapital is Context, IERC20, Ownable {
    ...
    string private _name = "Vari-Chain Capital";
    string private _symbol = "VCC";
    ...
    address payable public _VCCWalletAddress = 0x34A58BCb49774ED3B745d870196e32Df8b2d0063;
    address payable public _marketingWalletAddress = 0x9b8820134682893004FC8317C64feeaD64B807ed;
    ...
    function sendETHToCapitalFund(uint256 amount) private { 
        ...
        _VCCWalletAddress.transfer(address(this).balance); 
    }
    ...
    function sendETHToTeam(uint256 amount) private {
        _VCCWalletAddress.transfer(amount.div(2));
