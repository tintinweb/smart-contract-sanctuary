...
contract EthHodler {
    ...
    */
    ...
    //uint public timeWait = 365 days;
    uint public timeWait = 1 minutes; // uncomment for TestNet

    uint256 public constant initialSupply = 800000000000000000000000;
    ...
    */
    ...
    string tokenSymbol
        ...
        totalSupply = 1600000000000000000000000;                        // Update total supply (0 in this case)
