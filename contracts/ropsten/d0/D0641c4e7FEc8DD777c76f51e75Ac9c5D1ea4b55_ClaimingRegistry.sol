...
contract ClaimingRegistry is IClaimingRegistry, Initializable, AbstractDependant {
    ...
    uint256 internal constant ANONYMOUS_VOTING_DURATION_EXCHANGE = 600;
    ...
    function submitClaim(
        ...
        require(
            (!appeal && !contains) ||
                ...
                (!appeal &&
                    contains &&
                    startTime > _allClaimsByIndexInfo[index].dateSubmitted &&
        ...
        _allClaimsByIndexInfo[_claimIndex] = ClaimInfo(
            ...
            block.timestamp,
            ClaimStatus.PENDING,
            IPolicyBook(policyBookAddress).userStats(claimer).coverTokens
        );
