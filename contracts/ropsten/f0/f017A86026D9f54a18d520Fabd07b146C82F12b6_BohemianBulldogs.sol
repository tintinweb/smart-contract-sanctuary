...
contract BohemianBulldogs is Ownable, ERC721Enumerable, ReentrancyGuard, ERC721URIStorage, PaymentSplitter {
   ...
   using Counters for Counters.Counter;
    ...
    // Sale settings
    uint256 public constant MAX_BULLDOGS = 100;
    uint256 public constant PRESALE_BULDOGS_AMOUNT = 40;
    uint256 public constant RESERVED_BULDOGS_AMOUNT = 10; // for SPC keys & BB team
    ...
    // Splitting payments
    uint256[] private _teamShares = [90, 5, 5];
    //address[] private _team = [0x368cc743F5D477D0cFd133Ef0c2a74470b0a62b8, 0x19B5Ca7135859D3AEBD36228E0C6DE2756f1c658, 0x17895988aB2B64f041813936bF46Fb9133a6B160];
    address[] private _team = [0x368cc743F5D477D0cFd133Ef0c2a74470b0a62b8, 0x0F1c40619320AF362Bf48eebCAF2a6E8CCfC5DA8, 0x46547d9B8244Cf0800a9df6F69350d7c1884ad7a];
   ...
   function mintBohemianBulldog(uint256 numBulldogs, address referrer) public payable nonReentrant {
       ...
       // Checking whether the sale or presale is active
        ...
        if (presaleIsActive) {
            require(numBulldogs <= 2, "You can mint minimum 1, maximum 20 Bohemian Bulldogs");
        }
        
        require(totalSupply().add(numBulldogs) <= MAX_BULLDOGS - RESERVED_BULDOGS_AMOUNT, "Purchase would exceed max supply of Bohemian Bulldogs");
