...
contract TestingCoin is StandardToken, Owned {
    ...
    function buy() payable public {
        require(block.timestamp > 1543536000); // seconds since 01.01.1970 to 30.11.2018 (18:00:00 o&#39;clock GMT)
    ...
    modifier lockTokenTransferBeforeStage4{
        if(msg.sender != owner){
           require(block.timestamp > 1533513600); // Locking till stage 4 starting date (ICO).
        }
        _;
    }
