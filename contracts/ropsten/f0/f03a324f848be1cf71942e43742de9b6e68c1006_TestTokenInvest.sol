...
contract TestTokenInvest is Owned, TestStop, Utils {
    ERC20Interface public testTokenAddress;

    function TestTokenInvest(ERC20Interface _testTokenAddress) public{
    ...
    function buyToken() internal
    {
        ...
        uint amount = msg.value * 150000;
        assert(testTokenAddress.transfer(msg.sender, amount));
    }
