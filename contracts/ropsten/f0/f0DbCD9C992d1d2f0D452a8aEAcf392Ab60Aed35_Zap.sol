...
contract Zap is Ownable {
    ...
    IUniswapV2Router02 private ROUTER;  // = ITangleseaRouter02(0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607);
    ...
    constructor(
        ...
        setNotFlip(WETH);
        for(uint i = 0; i < _notFlipTokens.length; i++) {
            setNotFlip(_notFlipTokens[i]);
        }
    }
