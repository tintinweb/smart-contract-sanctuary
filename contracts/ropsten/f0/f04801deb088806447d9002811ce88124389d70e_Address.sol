...
contract DPGT is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Pound";
    string private _symbol = "DPGT";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 60;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _burnpoolFee = 20;
    ...
    function calculateBurnpoolFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_burnpoolFee).div(10**3);
    }
