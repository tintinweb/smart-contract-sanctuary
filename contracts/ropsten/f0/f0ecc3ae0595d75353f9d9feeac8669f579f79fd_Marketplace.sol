...
contract Marketplace is ERC1155, ERC2981Base, Ownable {
    ...
    function transferNFT(string memory _tokenHash, uint256 price, uint8 kind) public payable {
        require(msg.sender != address(0), "Invalid address...");
        ...
        safeTransferFrom(ownerOfNFT, msg.sender, indexOfToken, 1, '');
        ...
        allSpectraNFT[indexOfToken].currentOwner = payable(msg.sender);
