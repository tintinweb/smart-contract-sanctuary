...
contract CurrencyToken {
    ...
    function CurrencyToken ()
        public
    {
        server = 0xf8B3d742B245Ec366288160488A12e7A2f1D720D;
        name = 0x474250; // Set the name for display purposes
        decimals = 6; // Amount of decimals for display purposes
        symbol = 0x474250; // Set the symbol for display purposes
    ...
    function mintTokens(uint amount) public onlyPopulous {
        balances[populous] = safeAdd(balances[populous], amount);
