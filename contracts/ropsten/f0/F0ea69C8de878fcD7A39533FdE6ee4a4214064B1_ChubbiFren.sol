...
contract ChubbiAuction is ChubbiReserve {
    ...
    function isAuctionActive() external view returns (bool) {
        return _isAuctionActive && tokensAuctioned() < maxLimit();
    }

    /**
     * @dev Bid for tokens.
     * @param _amount the amount of tokens to bid.
     */
    function bid(uint256 _amount) external payable whenNotPaused {
        require(_isAuctionActive, "Auction is not active");
        require(tokensAuctioned() < maxLimit(), "Auction completed");
        require(
     ...
     */
    function maxLimit() internal view returns (uint256) {
     ...
     */
    function tokensAuctioned() internal view returns (uint256) {
