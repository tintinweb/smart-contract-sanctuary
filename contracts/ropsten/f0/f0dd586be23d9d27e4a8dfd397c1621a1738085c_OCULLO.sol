...
// OCULLO Token contract based on the full ERC 20 Token standard
// Symbol: OCO
// Status: ERC20 Verified

contract OCULLOToken { 
...
/**
 * OCO Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract OCOStandardToken is OCULLOToken, Ownable {
    
    using OCOMaths for uint256;
...
contract OCULLO is OCOStandardToken {
    ...
    */
    ...
    string constant public name = "OCULLO"; //fancy name: eg OCULLO
    string constant public symbol = "OCO"; //An identifier: eg OCO
