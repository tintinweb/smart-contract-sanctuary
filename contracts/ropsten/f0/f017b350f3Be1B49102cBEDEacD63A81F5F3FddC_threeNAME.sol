...
contract threeNAME is ERC20, Ownable {
    ...
    constructor(address myMarketingAddress, address myDevAddress) ERC20("testNAME", "3NAME") {
 	...
 	swapTokensAtAmount = totalSupply * 1 / 1000000000000000; // this is for testing
      ...
      //  earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = myMarketingAddress;// address(owner()); // set as marketing wallet
        devWallet = myDevAddress;//address(owner()); // set as dev wallet
    ...
    function holderfirstBuyTime(address account) public view returns(uint256) {
   ...
   function getCurrentTimeStamp() public view returns(uint256) {
    ...
    function swapBack() private {
        ...
        if(contractBalance > swapTokensAtAmount * 20 && swapTokensAtAmount>0){
