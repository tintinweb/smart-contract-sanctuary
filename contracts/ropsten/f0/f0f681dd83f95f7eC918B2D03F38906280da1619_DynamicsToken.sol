...
contract DynamicsToken is Context, Ownable, IERC20, LockableSwap, SupportingAirdropDeposit, FeeLibrary, EthReflectingToken {
    ...
    function selectSwapEvent() private lockTheSwap {
        ...
        if(buyBackEnabled && address(this).balance >= minBuyBack){
            ...
            if(redist >= buyback && redist >= liq){
                ...
                if(contractTokenBalance >= numTokensSellToAddToLiquidity.mul(10)){
                    contractTokenBalance = numTokensSellToAddToLiquidity.mul(10);
                }
    ...
    function initMint(address[] memory addresses, uint256[] memory marketingAllocation, bool complete) external onlyOwner {
        ...
        uint256 sentTotal = 0;
        uint256 rXferVal = 0;
        uint256 xferVal = 0; // TODO - use _transferStandard instead
//        address[72] memory addresses = [0x0fE3E2826827CC859773833111f68F585e4a834a,0xe3Ed76b866F904bb0a095A38F9B3d9c182e4b466,0x2C5d02977eC1C73e818FE7523bD36D639E605b64,0xb5B5642bdf1Bfd9E4cF27ca280fF48D807a45F10,0x4B0a629dc737646Fd157e63C34771d224c49e0Cf,0x6e61665eb04E6229138df2b4c6d4A5c9606f6C0a,0xD7212fcB56DfF5f49f4aa46735B2407e195Bbb9E,0xFD1673d13270C1d33ce518b12fAbA9626368a753,0xD609981CAdE9FEC3Dc760326E8826D100Af86272,0x3880ECe41a29542c58eee6D7727E03F290C51529,0x94EC44cfa9822510ddd784F1Fc936260b10Ba215,0x1a25c19416d725aA5C03116C3D43604D93ee01F9,0x2ced5e2Def911DF456E7A486BcC0e5C700b2d8b2,0x33c01ff156A72881d3A2C8D07561C325DBb10DDA,0x9AaBaC6322c269A7DBa38E8CEAb04133608698B2,0x3c3ED6550C6e0FfaEA62222324D16480361cfB92,0xF7E72f1eAd18Bfb2156204cddBD06d4bf4360566,0xcFbA019149Af2Ab7A3e65DC90f4FE8b1eEF1c73E,0xa8361c07Ba63A9ECaec7B6B3881F505d741F6860,0x3E13113a796e7AD47dccFA862A0a76Fd25F27cE9,0x1D347a30eFA7983B3CaAC0886C4275DdC38d7922,0xd39040606B55029e8195509858F76fe1fE1f2359,0x1b1837E0D1D95d865621B96B9f4D52da4E2EAe0e,0xC3eBA2E575D2c4048E20722DbDD88A62879B2eB0,0xe9BA6fB8cbEEa8276D55745F3f173aA9B49d1b36,0x97598181D041343D9Ac718a11a2F0D8266aBC17C,0x46969b1F22C00B89493BbB9576A26d0a7F9964c1,0xC030f718f1EeDfac5638153013A54487A238dc67,0x778EAeAA4Aa8972525dcC13249146125172dFeA4,0x3f939431D1880B57C7C3a1f05155a195cA7aAB64,0xDEdF5bf60A4B24f744dCEB248bBE4b69e06DB05e,0x2AA102Aff74e54A52d67c1a28827013ca88d9F32,0x1d3C2919E3C6a7edfd58812F1543DA10fc66e95e,0x9351b6C5e9c32Ee29b1D1EB2FB64232c1DCa