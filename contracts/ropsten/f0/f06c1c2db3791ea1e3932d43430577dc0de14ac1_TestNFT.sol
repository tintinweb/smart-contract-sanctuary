...
contract TestNFT is ERC721, Ownable {
  ...
  uint256 public maxPreMintAmountPerAddr = 3;
  ...
  modifier preMintCompliance(uint256 _preMintAmount) {
    require(_preMintAmount > 0 && _preMintAmount <= maxPreMintAmountPerAddr, "Invalid mint amount!");
  ...
  function setMaxPreMintAmountPerAddr(uint256 _maxPreMintAmountPerAddr) public onlyOwner {
    maxPreMintAmountPerAddr = _maxPreMintAmountPerAddr;
  }
