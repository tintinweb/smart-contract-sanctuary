...
contract AETHER is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 600_000e9;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(
            ...
            "AETHER: Uniswap router cannot be excluded."
        );
        require(account != address(this), 'AETHER: The contract it self cannot be excluded');
        require(!_isExcluded[account], "AETHER: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "AETHER: Account is already included");
