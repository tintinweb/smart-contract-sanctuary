...
** Using FTP EthReflect to give 4.00% of ALL transactions to holders. **
** Using FTP ILO to provide up to 15.00% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x250E75B9F33940506D1cF31FaB63cFAA5ad98C95), 1300);
        m_DidDeploy = true;
    }
...
contract SooCoin18 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "SooCoin18";
    string private m_Symbol = "SOO18";
    ...
    constructor () {
        ...
        ILO.init(250000000000000000, 15000, 10000, 18000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 4000, m_UniswapV2Pair, m_UniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
