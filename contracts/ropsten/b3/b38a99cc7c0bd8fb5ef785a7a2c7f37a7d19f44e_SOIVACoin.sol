...
contract SOIVACoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SOIVACoin() {
        ...
        name = "SOIVACoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 6;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SOV";                                             // Set the symbol for display purposes (CHANGE THIS)
