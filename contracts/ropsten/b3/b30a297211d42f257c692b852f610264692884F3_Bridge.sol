...
//    event BridgeAdded();
    ...
    mapping (uint256 => uint256) public global_tx_amount;
...
//	tx_id = tx_id.add(1);
    ...
    function TxInfoById(uint256 id)public view returns(address sender,address origin,address token,uint256 amount,uint32 network,uint256 block,uint256 time)
    {
