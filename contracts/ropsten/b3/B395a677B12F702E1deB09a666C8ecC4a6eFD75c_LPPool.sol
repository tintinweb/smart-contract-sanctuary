...
contract LPPool is ILPPool, LPTokenWrapper, IRewardDistributionRecipient {
    ...
    // Immutable
    IERC20 public immutable override wexos;
    ...
    constructor(address _wexos, address _lpt, uint256 _startTime, uint256[] memory _rewards, uint256 _totalReward) public {
        require(
            _rewards.length > 0,
        ...
        checkStart
    {
        ...
        if (reward > 0) {
            ...
            wexos.safeTransfer(msg.sender, reward);
