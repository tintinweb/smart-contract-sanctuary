...
contract IPv6Token is ERC20StandardToken, Ownable {

    // token information
    string public constant name = "IPv6Token";
    string public constant symbol = "IPv6";
    ...
    function IPv6Token() public onlyOwner{
