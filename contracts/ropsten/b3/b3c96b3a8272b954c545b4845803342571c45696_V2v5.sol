...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory V2v5_, string memory VV_) {
        _V2v5 = V2v5_;
        _VV = VV_;
...
/**
 * @dev Contract for V2v5 token
 */
contract V2v5 is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 2_000_000_000e18;

    constructor() ERC20("V2v5", "V2v5") {
