...
contract MoveAsset is IERC1155Receiver {
  ...
  function _calculateFee()   public view returns (uint256){
      (uint128 value, uint128 timestamp)  = DIAOracleV2(gasOracle).getValue("GAS_ARB");
  ...
  function isFeeRequired(address _nftAddress,  uint256 _nftID) public view returns(bool){
