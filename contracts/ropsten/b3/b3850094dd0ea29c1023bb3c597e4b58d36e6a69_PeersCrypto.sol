...
// Peer-to-peer trading simply means that the transacting parties are trading direct with each other, without relying on third-party intermediaries 
...
contract PeersCrypto is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    using TransferHelper for address;

    string private _name = 'PeersCrypto';
    string private _symbol = 'PCRYPTO';
    ...
    constructor() public {
        ...
        address _owner = 0x14d3761edF7013b897621B6ef01A6dBebDCee739;
        cake = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        marketingWallet = 0x0bE4E8bFC680f587310116e2A6B7177D1d8Dbd2D;
        insuranceWallet = 0x18B2245B95aDbCe8CADe7461FfA1Be6a6eb7981e;
