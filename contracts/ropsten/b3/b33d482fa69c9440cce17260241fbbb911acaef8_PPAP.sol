...
contract PPAP is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "PPAP Coin"; // token name
    string private _symbol = "PPAP"; // token symbol
