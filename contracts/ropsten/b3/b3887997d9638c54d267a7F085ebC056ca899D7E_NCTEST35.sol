...
contract NCTEST35 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, UUPSUpgradeable {
       constructor() initializer {}
   
    /// @custom:oz-upgrades-unsafe-allow constructor
 
    function initialize() initializer public {
        __ERC20_init("NCTEST35", "NTEST35");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("NCTEST35");
