...
/**
* @title ICO CONTRACT - TEST DEPLOYMENT ROPSTEN
...
contract ICO is admined {
    ...
    */
    function contribute(address _ref) public notFinished payable {
        ...
        if(msg.value >= 5 ether ){
          ...
          tokenBought = tokenBought.div(100); //1.02 = +5%
        }
    ...
    */
    function checkIfFundingCompleteOrExpired() public {
        ...
        } else if(now > stage5Deadline && state!=State.Successful ){ //if we reach ico deadline and its not Successful yet
