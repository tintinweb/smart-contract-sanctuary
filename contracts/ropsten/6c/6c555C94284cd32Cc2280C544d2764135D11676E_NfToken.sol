...
contract NfToken is ERC721Enumerable {
    ...
    constructor() ERC721("NfToken", "NFT") {
        ...
        //Hat
        TIERS[0] = [4700, 2000, 1000, 1000, 200, 50, 25, 25];
        //Antlers
        TIERS[1] = [2500, 1000, 25000, 1000, 1000, 1000, 1000];
        //Earrings
        TIERS[2] = [7000, 500, 500, 500, 500, 500, 500];
        //Neck
        TIERS[3] = [4000, 2500, 1500, 1500, 400, 100];
        //Eyes
        TIERS[4] = [50, 100, 150, 200, 500, 500, 1000, 1500, 1500, 1500, 1500, 1500];
        //Mouth
