...
contract ETHhomepage19 {
    ...
    modifier isOwner(){
        require(msg.sender == owner, "Only for the creator");
        _;
    }
    mapping (uint => Collage) Collages;
    uint[] public contador;

    function guardarimagen (uint _address, string _coordenadas, string _imagen, string _url) public isOwner{
