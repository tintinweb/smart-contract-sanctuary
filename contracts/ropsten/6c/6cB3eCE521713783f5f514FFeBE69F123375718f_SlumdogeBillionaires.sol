...
contract SlumdogeBillionaires is ERC721, Ownable {
    ...
    uint256 public constant SBPrice = 69000; //0.069 ETH

    uint public constant maxSBPurchase = 50; // Max 10 NFTs per purchase
    ...
    constructor() ERC721("Slumdoge Billionaires", "SDB") {
        MAX_SBS = 10000;
