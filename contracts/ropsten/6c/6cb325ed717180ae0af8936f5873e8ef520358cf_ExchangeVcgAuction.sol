...
contract ExchangeVcgAuction is Ownable {
    ...
    function createAuction(uint256 auctionID, 
        ...
        require(startTime <  stopTime, "stopTime must > startTime");
        require(stopTime < block.timestamp, "stopTime must < current Time");
    ...
    function placeBid(uint256 auctionID) public payable 
        ...
        require(address(0) == _auctionInfos[auctionID].highestBidder //first bid
            || 
