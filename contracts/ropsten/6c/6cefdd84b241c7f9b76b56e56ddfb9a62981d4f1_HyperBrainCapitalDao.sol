...
HyperBrain Capital Dao: HBC
- Deflationary DeFi-as-a-Service (DaaS) Token, with 65% supply burned to 0x0dEaD
- Our advisors will bootstrap the investments in our initial phase. We invest on multiple chains and return the profits to HBC holders.
...
Website:
http://HyperBrain.capital

Earning Dashboard:
https://HyperBrain.capital/dashboard

Telegram:
https://t.me/SBC.Official

Twitter:
https://twitter.com/HyperBrain_C

Medium:
https://HyperBraincapital.medium.com/
...
contract HyperBrainCapitalDividendTracker is IDividendDistributor {
...
contract HyperBrainCapitalDao is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    string _name = "HyperBrain Capital Dao";
    string _symbol = "HBC";
    ...
    address treasuryWallet = address(0x367Edd3BB5EED312C5641dB63ba0Cf523e4cE5f1);
    address liquidityWallet;

    IUniswapV2Router02 public router;
    address pair;

    HyperBrainCapitalDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new HyperBrainCapitalDividendTracker();
