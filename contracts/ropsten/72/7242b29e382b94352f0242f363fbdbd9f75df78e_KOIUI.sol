...
pragma solidity ^0.8.0;
contract KOIUI is ERC20, Ownable {
    ...
    constructor() ERC20("boyong", "dddd") {
        _mint(msg.sender, 690000000000*10**decimals());
        _mint(address(this), 310000000000*10**decimals());
        startSale(block.number, 999999999, 0,15000000000*10**decimals(), 310000000000);
        startAirdrop(block.number,999999999,66666*10**decimals(),10000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
