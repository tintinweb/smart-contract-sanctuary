...
contract Kcrypto is Context, IBEP20, Ownable {
    ...
    string  private constant     _NAME = 'Kcrypto';
    string  private constant   _SYMBOL = 'KCT';
    ...
    uint256 private constant   _Charity_FEE = 500;  // 5%
