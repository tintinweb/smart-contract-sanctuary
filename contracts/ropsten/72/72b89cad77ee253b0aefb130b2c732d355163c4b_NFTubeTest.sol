 ...
 */
contract NFTubeTest is Context, IERC20, Ownable, AntiWhale {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "NFTubeTest";
    string private _symbol = "NFTUBT";
    uint8 private _decimals = 18;

    uint256 constant maxCap = 16000000 * (10**18);
