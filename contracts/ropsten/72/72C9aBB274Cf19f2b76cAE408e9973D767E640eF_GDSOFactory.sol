    ...
    Pausable
{
    ...
    function createGDSO(
        ...
        // creator has no initial lock period to transfer the new token
        _tokenLockTime[newItemId] = 0;
    ...
    function transferFrom(
        ...
        require(
            _tokenLockTime[tokenId] <= block.timestamp,
            "GDSOFactory: Unable to transfer. Locking period is still running."
        );
        _tokenLockTime[tokenId] = block.timestamp + _lockingPeriodSeconds;
