...
contract CoinBet is StandardToken, Ownable {
  ...
  uint256 public constant minAcceptedTokenInPreSale = 40000 * (10 ** decimals); // 40,000 token is mininum requirement in presale
  ...
  uint256 public constant minAcceptedAmountInPublicSale = 0.1 * (1 ether); // 0.1 ether for mininum ether acception in public sale
  ...
  function initTokenAndBrackets() private {
    ...
    // allocate private sale
    privateSaleRemain = privateSaleAllocation;

    // allocate presale bracket
