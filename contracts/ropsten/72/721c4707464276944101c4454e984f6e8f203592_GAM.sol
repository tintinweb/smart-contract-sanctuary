...
contract GAM is Ownable, ERC20Interface {
    ...
    uint256 private _unmintedTokens = 3000000000000*uint(10)**decimals;
    ...
    /**
     * @dev Mint GAM tokens. No more than 3,000,000,000,000 GAM can be minted
     ...
     * No more than 3,000,000,000,000 GAM can be minted
     * @param _target The address to which new tokens will be minted
     * @param _mintedAmount The amout of tokens to be minted
