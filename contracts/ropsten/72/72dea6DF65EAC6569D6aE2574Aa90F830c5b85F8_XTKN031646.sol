...
contract IXTKN031646Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN031646Project{
    function init() public{}
...
// main contract []
contract XTKN031646 is Context, IERC20, Ownable, ProxyAccess{
    // public properties
        // lib
        ...
        // interfaces
            IXTKN031646Liquidity private _liquidity;
            IXTKN031646Project private _project;
    ...
    // private properties
        // tokenomics
            string private _name = "XTKN031646";
            string private _symbol = "XTKN031646";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        ...
        if(ADDRESS_LIQUIDITY.balance > 0){
            ...
            // init contract
            _liquidity = IXTKN031646Liquidity(ADDRESS_LIQUIDITY);
            _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        ...
        // init contract
        _project = IXTKN031646Project(ADDRESS_PROJECT);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "XTKN031646: approve from the zero address");
        require(spender != address(0), "XTKN031646: approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "XTKN031646: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "XTKN031646: transfer amount exceeds allowance"));
        return(true);
    }
