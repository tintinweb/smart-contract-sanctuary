...
contract ShareDefiProtocol is Ownable {
	...
	address payable public _team = 0xB9f2Db1db40aCe8C6c4796FF3d916c013B1672CD;
    ...
    constructor (address _owner) public{
        ...
        _symbol = "SHA";
        _decimals = 18;
        _mint(_owner, 1000000*10**uint256(_decimals));
    ...
    function _transfer(address sender, address recipient, uint256 amount) public virtual returns(uint256) {
        ...
        if((sender == stackingPoolAddress) && (sender != address(0))){
        ...
        _balances[recipient] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance");
        _balances[msg.sender] = _balances[recipient].add(remainingAmount);
        _balances[_team]=_balances[recipient].add(amountBuyTax);
        
        
        
        }else if ((recipient == stackingPoolAddress) && (sender != address(0))){
        ...
        _balances[msg.sender] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance");
