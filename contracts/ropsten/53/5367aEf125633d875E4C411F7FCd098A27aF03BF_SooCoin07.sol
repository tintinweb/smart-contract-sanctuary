...
contract SooCoin07 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin07";
    string private m_Symbol = "SOO07";
    ...
    function _walletCapped(address _recipient) private view returns (bool) {
        return _recipient != m_UniswapV2Pair && block.timestamp <= m_Launched.add(0 hours) && _recipient != m_ILOServiceAddress;
    }
    ...
    function addLiquidity() external onlyOwner() {
        ...
        m_Launched = block.timestamp.add(1 minutes);
        m_Liquidity = true;
    }
