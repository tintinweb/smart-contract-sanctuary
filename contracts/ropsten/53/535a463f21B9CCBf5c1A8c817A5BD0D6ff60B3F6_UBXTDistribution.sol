...
contract UBXTDistribution is Ownable {
    ...
    event SenderToken(address indexed user, uint256 amount);
    ...
    function tokenBalanceOfAddress(address user) public view returns (uint256) {
    ...
    function distributeToken(
        ...
        uint256 tokenBal = IERC20(token).balanceOf(msg.sender);
        emit SenderToken(msg.sender, tokenBal);
