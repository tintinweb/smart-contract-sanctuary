...
contract BunnyMembership is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl {
    ...
    string [MAX_MEMBERSHIP_TYPES] private _membershipURI = [ "", "", "", "", "" ];              // membership URI
    ...
    uint private constant MAX_DISCOUNT_TYPES = 5;                                               // maximum number of discounts
    ...
    constructor() ERC721("BunnyMembership", "BMT") {
        ...
        configureDiscountTable( 0, 
                    _memebershipPrice[0],
                    (_memebershipPrice[0]/4) * 2,
                    _memebershipPrice[0]/2,
                    _memebershipPrice[0]/4,
                    0
        );

        configureDiscountTable( 1, 
                    _memebershipPrice[1],
                    (_memebershipPrice[1]/4) * 2,
    ...
    function configureMembership( uint _mType, uint _mSupply, uint _mReserved, uint _mPrice ) public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        _memebershipPrice[_mType] = _mPrice * 0.00001 ether; // set the retail price of memberships TODO reality
   }
    ...
    function setAvailableForSale( uint _mType, bool _avail )  public onlyRole(DEFAULT_ADMIN_ROLE) {
