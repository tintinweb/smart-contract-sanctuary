...
contract SigmoidExchange is ISigmoidExchange{
    ...
    function _addPledgedERC20Asset( ERC20LOAN memory _ERC20Loan) private returns(bool) {
        ...
        require(IERC20(_ERC20Loan.seller).transferFrom(_ERC20Loan.seller, address(this),_ERC20Loan.amount),"can't move to custody");
        return(true);
    }
    ...
    function createERC20Loan (address payable _seller,uint256 _startingPrice,uint256 _endingPrice,uint256 _auctionDuration,uint256 _interestRate,uint256 _loanDuration,uint256 _amount) public returns(bool){
