...
contract Vault is Ownable, ReentrancyGuard
{
    ...
    // The constant number of seconds in a day for time conversions.
    ...
    function scaleTokenAmount(uint256 _amount) public view returns(uint256)
    {
    ...
    function daysToSeconds(uint256 _days) public pure returns(uint256)
    {
        // Returns the number of seconds in the given number of days.
        return _days.mul(SECONDS_PER_DAY);
    }
