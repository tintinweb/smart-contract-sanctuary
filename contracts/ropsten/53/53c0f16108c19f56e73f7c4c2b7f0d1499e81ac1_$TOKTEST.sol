...
/*
    TOKTEST - SMARTCONTRACT
    
    website: TOKTEST.finance
...
contract $TOKTEST is Context, IERC20, Ownable {
    ...
    string private _name = 'TOKTEST.finance';
    string private _symbol = 'TOKTEST';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if((_msgSender() == currentPoolAddress || _msgSender() == address(_uniswapV2Router)) && !tradingEnabled)
                require(false, "TOKTEST: trading has not been enabled.");
