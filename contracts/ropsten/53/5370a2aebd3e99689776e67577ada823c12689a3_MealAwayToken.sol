...
contract BlackList is Ownable, IERC20{
...
contract ERC20Detailed is IERC20, BlackList {
...
contract MealAwayToken is ERC20Detailed {
  ...
  string constant tokenName = "MealAwayToken";
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    require(!isBlackListed[from], "The account you applied for is on the blacklist and cannot be transferred");
