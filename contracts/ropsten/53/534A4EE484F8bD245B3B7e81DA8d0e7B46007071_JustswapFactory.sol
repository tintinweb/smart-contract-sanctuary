...
contract JustswapExchange is TRC20,ReentrancyGuard {
  ...
  ITRC20 token;                // address of the ERC20 token traded on this contract
...
//    require(token.transferFrom(buyer, address(this), tokens_sold));
  ...
  function addLiquidity(uint256 min_liquidity, uint256 max_tokens, uint256 deadline) public payable nonReentrant returns (uint256) {
    ...
    if (total_liquidity > 0) {
      ...
      //uint256 token_amount = (msg.value.mul(token_reserve) / trx_reserve).add(1);
...
//      require(token.transferFrom(msg.sender, address(this), token_amount));
      ...
      //TODO: TOBEDISCUSSED
      require(address(factory) != address(0) && address(token) != address(0) && msg.value >= 1_000_000_000, "INVALID_VALUE");
...
library TransferHelper {
    ...
    address constant USDTAddr = 0xEF851114Db6b24d984e74cF450E462a33dDCD64e;
