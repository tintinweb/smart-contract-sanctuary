...
/**
   ...
   I created a black hole so #Donaswap token will deflate itself in supply with every transaction.
   Sincerely yours
   ...
   Reddit: https://www.reddit.com/r/DonaSwap/
...
contract TestBoyz2 is Context, IERC20, Ownable {
    ...
    string private _name = "TestBoyz2";
    string private _symbol = "TEBO2";
