...
contract GameTokenWithdraw is Pausable, AccessControl {
    ...
    event Withdraw(address indexed _sender, string indexed _orderId,  address _token , uint256 _amount);
    ...
    mapping (string => uint256) private orders;
    ...
    {
        // TODO 验证签名
        // require(hasRole(SIGNATURE_ROLE, account), "Withdraw");
