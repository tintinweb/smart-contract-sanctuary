...
// File: contracts/Mandrake2.sol

/************************************
* Copyright © 2021 Mandrake2 COIN. ALL RIGHTS RESERVED.
***************************************/
...
contract Mandrake2 is IERC20, Ownable {
    ...
    string private _name      = 'Mandrake2';
    string private _symbol    = 'Mandrake2';
    ...
    ******************************************************
    BASE FUNCTIONS
    Tested in '/test/Mandrake2_base.test.js
    ******************************************************
    *****************************************************/

    // TEST FUNCTION #1 '/test/Mandrake2_base.test.js
    // READ: return the name of the contract - Mandrake2
    function name() public view returns (string memory) {
        return _name;
    }
    // TEST FUNCTION #2 '/test/Mandrake2_base.test.js
    // READ: return the symbol of the contract - Mandrake2
    function symbol() public view returns (string memory) {
        return _symbol;
    }
    // TEST FUNCTION #3 '/test/Mandrake2_base.test.js
    // READ: return the  decimals of the contract - 18
    function decimals() public view returns (uint8) {
        return _decimals;
    }
    // TEST FUNCTION #4 '/test/Mandrake2_base.test.js
    // READ: return the current supply in existence - starts with 1 trillionc
    function totalSupply() public view override returns (uint256) {
        return currentSupply;
    }

    // TEST FUNCTION #6 '/test/Mandrake2_base.test.js
    // READ: return the balance of Mandrake2 that an address has
    ...
    ******************************************************
    ALLOWANCES
    Tested in '/test/Mandrake2_allowance.js
    ******************************************************
    *****************************************************/

    // TEST FUNCTION #1 '/test/Mandrake2_allowance.test.js
    ...
    // TEST FUNCTION #2 '/test/Mandrake2_allowance.test.js
    ...
    ******************************************************
    TRANSFERS FUNCTIONS
    d in '/test/Mandrake2_transfer.js
    ******************************************************
    *****************************************************/
