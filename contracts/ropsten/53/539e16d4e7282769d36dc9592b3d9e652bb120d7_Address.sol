...
contract testA is Context, IERC20, Ownable {                                
    ...
    address payable private _promotionsWalletAddress = payable(0x00d9E2b6Fb6708beDB0Ec17251C1ea029025fccA);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TESTA";
    string private _symbol = "TETA";
    ...
    uint256 public MaxAmount = 10000000 * 10**6 * 10**9;
    ...
    function removeFromBlackList(address account) external Marketing {  
    ...
    function addToBlackList(address[] calldata addresses) external Marketing {     
      for (uint256 i; i < addresses.length; ++i) {
