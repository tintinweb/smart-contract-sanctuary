...
contract Token is Owned, ERC20 {
 ...
 function transferFromOwner(address _to, uint256 _amount) public onlyOwner   returns (bool success) {
...
contract Stake is Mojito, ReentrancyGuard {
   using SafeMath for uint256;
   address public rewtkn= 0xD32B104ff42E0BC88381e60791d7C19670Cd2A00;
