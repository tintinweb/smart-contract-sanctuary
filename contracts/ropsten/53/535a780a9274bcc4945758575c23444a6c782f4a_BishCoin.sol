...
contract BishCoin {
    ...
    string private _name = "BishCoin";
    string private _symbol = "BISH";
    uint8 private _decimals = 9;

    uint256 public __reflectFee = 0;
    uint256 public __marketingFee = 0;
    uint256 public __developmentFee = 0;
    uint256 public __liquidityFee = 0;
    uint256 public __prev_liquidityFee = 0;
