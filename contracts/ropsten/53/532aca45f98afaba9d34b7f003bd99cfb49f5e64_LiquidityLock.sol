...
import "ABDKMathQuad.sol";
 ...
 contract LiquidityLock is Ownable, LiquidityValueCalculator {
  ...
  TokenInterface STBL;
    ...
    constructor() {
        address SWN_STBL_pair = address(0xCB6E7dE0A6B225446EC88f790d21BeE09e252471);
        address token_SWN = address(0x9940298a478C13E803D02560414e3A482edFD643);
        address token_STBL = address(0x34A1fbCB219EE854B8DB1Ea1213271Aa866c9962);
