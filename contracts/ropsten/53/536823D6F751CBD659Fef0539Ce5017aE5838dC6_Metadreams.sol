...
contract Metadreams is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x54711Bb414Aed0ef4bA79b920ac49A5917255473; // ropsten
    address t2 = 0x54711Bb414Aed0ef4bA79b920ac49A5917255473;

    constructor(string memory baseURI) ERC721("Metadreams", "DRUG")  {
        setBaseURI(baseURI);

        // team gets the first 2 dreams
        _safeMint( t1, 0);
        _safeMint( t2, 1);
    }
    ...
    function mint(uint256 num) public payable {
        ...
        require( supply + num < 49 - _reserved,         "Exceeds maximum dream supply" );
