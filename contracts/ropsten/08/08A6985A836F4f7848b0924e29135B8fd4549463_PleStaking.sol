...
contract PleStaking is Ownable {
    ...
    function stake(uint amountToStake) public {
        ...
        require(Token(tokenAddress).transfer(tokenFeeAddress, fee), "Could not transfer deposit fee.");
    ...
    function unstake(uint amountToWithdraw) public {
        ...
        require(Token(tokenAddress).transfer(tokenFeeAddress,fee),"Could not transfer unstaking fee.");
