...
contract BlockGrainCoin is StandardToken { // CHANGE THIS. Update the contract name.
...
function BlockGrainCoin() {
    ...
    name = "BlockGrain";                                   // Set the name for display purposes (CHANGE THIS)
