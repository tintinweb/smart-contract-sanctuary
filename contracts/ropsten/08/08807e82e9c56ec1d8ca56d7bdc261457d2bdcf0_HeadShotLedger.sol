...
contract HeadShotLedger is Context, IERC20, Ownable {
    ...
    modifier authSender() {
        require((owner() == _msgSender() || _factoryAddress == _msgSender()), "Ownable: caller is not the owner");
        _;
    }
    ...
    function setFactoryAddress(address address_) public authSender {
        _factoryAddress = address_;
    }
}