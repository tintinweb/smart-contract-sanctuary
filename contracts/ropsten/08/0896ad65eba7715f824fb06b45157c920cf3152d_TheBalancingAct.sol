...
contract TheBalancingAct is Context, IERC20, Ownable {
  ...
  address payable private feeWallet1 = payable(0x92c65FE7af76B04A3Cdbc7B52a12019C880fbABb); // 6% dividend storage wallet | pays out every hour to all holders
  address payable private feeWallet2 = payable(0xC93d62b5356e8aa125Ba619dC46b0EF2eCE85d6b); // 2% Marketing wallet
  ...
  function swapAndSell(uint256 contractTokenBalance) private lockTheSwap {
        ...
        feeWallet1.transfer(newBalance.mul(15).div(10).div(2)); // 75%
        feeWallet2.transfer(newBalance.mul(5).div(10).div(2));  // 25%
