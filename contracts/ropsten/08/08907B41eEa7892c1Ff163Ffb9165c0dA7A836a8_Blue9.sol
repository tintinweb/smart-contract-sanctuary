...
Blue9 Socials:
Telegram: BLUNINETG
Twitter: twitter.com/blunine
Website: blunine.com
Whitepaper: blunine.com/wp

** Using FTP ILO to provide up to 12.00% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x9000ab6dB5d47C58b424Ef91Ea9136D19d55106c), 3000);
        m_DidDeploy = true;
    }
...
contract Blue9 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "Blue9";
    string private m_Symbol = "BLUNINE";
    ...
    constructor () {
        ...
        ILO.init(100000000000000000000, 12000, 1000, 65000, m_ILOPublic);
        initTax();
