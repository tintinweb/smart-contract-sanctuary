...
contract DMMPool is IDMMPool, ERC20Permit, ReentrancyGuard, VolumeTrendRecorder {
    ...
    IDMMFactory public immutable override factory;
    ...
    uint32 public immutable override ampBps;
    ...
    constructor() public ERC20Permit("KyberDMM LP", "DMM-LP", "1") VolumeTrendRecorder(0) {
        ...
        (address _token0, address _token1, uint32 _ampBps) = IDMMFactory(msg.sender).getParameters();
