...
// File: contracts/token/BEP20/Shereni.sol
...
/**
 * @title Shereni
 * @dev Implementation of the Shereni
 */
contract Shereni is BEP20Capped, BEP20Mintable, BEP20Burnable, ServicePayer {
    ...
    constructor (
        ...
        BEP20(name, symbol)
        BEP20Capped(cap)
        ServicePayer(feeReceiver, "Shereni")
        payable
    {
