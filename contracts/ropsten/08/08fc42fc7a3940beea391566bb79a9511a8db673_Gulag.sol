...
contract Gulag is IERC20, Context, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        bool isSellTransaction = recipient == address(uniswapV2Pair) || recipient == address(uniswapV2Router);
        bool isBuyTransaction = sender == address(uniswapV2Pair) || sender == address(uniswapV2Router);
    ...
    // Lottery management to take actions against frauds
