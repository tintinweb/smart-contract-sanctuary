...
contract FeederWrapper is Ownable {
    ...
    /**
     * @dev 0. fAsset/mAsset -> FeederPool BoostedVault
     * @param  _feeder  FeederPool address
     * @param  _asset   Asset address of given FeederPool; fAsset, mAsset or mpAsset
     * @param  _vault   BoostedVault address (with stakingToken of `_feeder`)
     * @param  _amt     Amount of bAsset sent
     * @param  _minOut  Min amount of fpToken to be minted
     */
    function mintAndStake(
        ...
        IERC20(_asset).transferFrom(msg.sender, address(this), _amt);
        // 1. Mint the fpToken and transfer here
        uint256 fpTokenAmt = IFeederPool(_feeder).mint(_asset, _amt, _minOut, address(this));
