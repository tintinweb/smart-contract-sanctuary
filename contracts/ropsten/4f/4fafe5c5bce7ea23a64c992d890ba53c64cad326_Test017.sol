...
contract Test017 is Context, IERC20, Ownable {
    ...
    string private constant _name = "T17 Inu";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x1F0Aa8B6962871f5D995848442ba4aE52f1a747A); // Marketing Address
        
        devAddress = payable(0x1F0Aa8B6962871f5D995848442ba4aE52f1a747A); // Dev Address
