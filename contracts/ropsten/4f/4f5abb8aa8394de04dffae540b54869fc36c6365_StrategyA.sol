...
contract StrategyA  {
    ...
    address public constant cake = address(0x8a61951c879fD53b6Caf4CD60310EA969B220A26);
    address public constant cakeChef = address(0x5a71D5404AD53682476e2164a6E6A4C52515E672);
    address public constant pancakeSwapRouterV2 = address(0xE592427A0AEce92De3Edee1F18E0157C05861564);
    ...
    constructor(address _governance, address _strategist, address _controller, address _want, address _tokenA, address _tokenB, uint256 _cakeChefPid) public {
        want = _want;
        tokenA = _tokenA;
        tokenB = _tokenB;
