...
// File @openzeppelin/contracts/token/ERC721/[email protected].3.2
...
// File contracts/BadGrandmaIMX.sol
...
/**
 * @title BadGrandmaIMX contract
 */
contract BadGrandmaIMX is Mintable, ERC721 {
    string private _baseURIPath;

    constructor(address _owner, address _imx)
        ERC721("BadGrandmaIMX", "BGX")
    ...
    // With Immutable X the payments are handled differently, so there should not be anything to withdraw on this
    // contract. However, leaving this function here just in case.
