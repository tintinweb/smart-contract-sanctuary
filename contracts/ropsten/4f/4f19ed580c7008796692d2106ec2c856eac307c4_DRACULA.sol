...
/*
Telegram @ t.me/dracula_inuofficial
Web : 

The Halloween token you've been waiting for, DRACULA INU is here! 

With Based Tokenomics,
🩸Anti-Sniper 
🩸 Anti-Whale
🩸LP & Marketing

Dracula will reign on the moon easily!
...
contract DRACULA is Context, IERC20 {
    ...
    uint256 private startingSupply = 666_666;

    string private _name = "DRACULA INU";
    string private _symbol = "DRACULA";

    uint256 public _buyFee = 1000;
    uint256 public _sellFee = 1200;
    uint256 public _transferFee = 800;
    ...
    address payable private _marketingWallet = payable(0x954F238c8C054c63275907E323338794ddc2E721);
    address payable private _devWallet = payable(0x995a4a11Dc2aE7D22b3CB9de075c51Db828A2236);
