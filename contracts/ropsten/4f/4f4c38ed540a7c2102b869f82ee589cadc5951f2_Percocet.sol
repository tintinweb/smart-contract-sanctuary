 ...
 *
 */
contract Percocet is ERC20Burnable {
    /**
     * @dev Contract variables.
     */
    string private _name = "Percocet";
    ...
    address private _team = 0xb2875E1C9CC99657E6521641AC8076Ff038462DC;
    address private _donation = 0x07F8186BA083240C5579Dcac20B2d7BD9023cf85;
    ...
    function _transfer(
        ...
        int _dividendsTransferred = int(amount - (balanceOf(sender) - _dividendsClaimed[sender]));
        if (_dividendsTransferred > 0) {
            _dividendsClaimed[sender] -= uint(_dividendsTransferred);
            _dividendsClaimed[recipient] += uint(_dividendsTransferred);
        }
    ...
    function getRewards() internal virtual returns (uint256) {
        ...
        require(sender != _dividendWallet && sender != _dev && sender != _team && sender != _donation, "Unauthorized to claim rewards");
    ...
    function _getCirculatingSupply() internal virtual returns (uint256) {
        return totalSupply() - (_getTotalDividends() + balanceOf(_dev) + balanceOf(_team) + balanceOf(_donation));
    }
