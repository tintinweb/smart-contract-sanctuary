...
/*
The Contract is Owned By: https://incomeisland.org
*/
...
contract IncomeIslandToken is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "IncomeIslandToken";
    string public constant symbol   = "INCOME";
    ...
    // reinvest fee
    uint256 public _taxFeeReinvest       = 200;
    ...
    // sell fee
    uint256 public _taxFeeSell       = 400;
    ...
    // When IncomeIsland becomes an utility token with 0% tax, withdrawToken function will allow us to remove the remaining token inside the contract address.
