...
contract Files {
    ...
    function addFile(string[] memory _metadata) public returns (uint256){
        ...
        // filesMetadata[size].ipfsHash = dataConvert(_metadata[5]);
        ...
        // filesMetadata[size].blockchain_date = dataConvert8(_metadata[9]);
        ...
        // bytes32 _id = getIpfsHashUniqId(_ipfsHash);
        // filesByIpfsHash[_id].push(filesMetadata[size]);
