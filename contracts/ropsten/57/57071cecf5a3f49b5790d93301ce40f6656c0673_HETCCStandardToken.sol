...
contract HETCCStandardToken is StandardToken { 
    ...
    string public version = &#39;HETCC0.1&#39;;    //版本

    function HETCCStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
