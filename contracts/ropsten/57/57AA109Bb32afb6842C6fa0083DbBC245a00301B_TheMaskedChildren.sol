...
contract TheMaskedChildren is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_CHILDREN = 5000;
    uint256 public constant PRICE = 5 * 10**16; // .05 ETH
    uint256 public constant MAX_TO_MINT = 5;
    ...
    function mintChildren(uint amountToMint) public payable {
        uint256 total = totalSupply();
        require(saleIsActive, "Sale is not active, you can't mint any children.");
        require(amountToMint > 0, "You have to mint at least 1 child.");
        require(amountToMint <= MAX_TO_MINT, "Can only mint 5 tokens at a time.");
