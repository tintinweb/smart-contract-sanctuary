	...
	TrusteeManagedSC
{
	...
	string  public standard = "SmartTrust Settlor Token v1.0";

	uint256 public settlorID;
	string  public settlorNameHash;
	...
	constructor (uint256 _settlorID, string memory _settlorNameHash, address[] memory _trustees) public {
		...
		settlorNameHash = _settlorNameHash;
		documentsTotal = 0;
	...
	function settlorNameHashUpdate(string memory _settlorNameHash)
		public
		onlyTrustee()
	{
		settlorNameHash = _settlorNameHash;
		emit SettlorNameHashUpdate(_settlorNameHash);
	}
