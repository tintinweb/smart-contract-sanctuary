...
contract Arbitrage is Ownable {
    ...
    event Log(uint256 _scxAmount, uint256 _ethInPool, uint256 _outputETHAmount);
    ...
    function uniToBehodler(uint256 expectETH, uint deadline, uint256 passes) public payable onlyOwner {
        ...
        emit Log(scxAmount, ethInPool, outputETHAmount);
        // has assert in this function
        behodler.withdrawLiquidity(behodler.Weth(), expectETH);
        msg.sender.transfer(address(this).balance);
    }
}