...
contract ColorCube is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("ColorCube", "COLORCUBE") {}
    ...
    function mint(uint256 amountToMint) public payable {
        ...
        require(amountToMint > 0, "You must mint at least one ColorCube.");
        require(amountToMint <= MAX_PURCHASABLE, "You cannot mint more than 30 ColorCubes.");
        require(totalSupply() + amountToMint <= MAX_NFT_SUPPLY, "The amount of ColorCubes you are trying to mint exceeds the MAX_NFT_SUPPLY.");
