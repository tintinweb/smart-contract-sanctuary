    ...
    AccessControlUpgradeable
{
        ...
        returns (bool)
    {
        if (
            ...
            bool isRecipient; // allow infinite buys but limit sells and transfers.
            ...
            if (_timeOfLastTransfer[toDisable] == 0) {
                ...
                if (block.timestamp == _timeOfLastTransfer[toDisable]) {
                    // Same block transfer? Byebye bottie
                    _blacklist[toDisable] = true;
                    return false;
                }
