...
contract BrixxToken is Context, IERC20, Ownable {
    ...
    string private _name = 'BrixxToken';
    string private _symbol = 'BRIXX';
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _transferToRewardPool(sender, rReserve, tReserve);
