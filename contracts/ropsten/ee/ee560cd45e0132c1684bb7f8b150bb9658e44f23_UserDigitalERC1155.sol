...
contract DigitalERC1155 is Ownable{
    ...
    */
    ...
    function burn(address _operator, uint256 _id, uint256 _value) public {

        require(operatorApproval[_operator][msg.sender] == true, "Need operator approval for 3rd party burns.");
