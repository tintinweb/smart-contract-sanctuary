...
contract Crowdsale is Ownable {
    ...
    SMSToken public token = new SMSToken(myAddress);
    ...
    constructor() public {
        ...
        //uint sendTokens = 1000000;
        giveTokens(address(teamAddress), 1000000);
    ...
    function calcBonus () public view returns(uint256) {
        ...
        if (amountToken < 400000 * (1 ether)){ 
            actualBonus = 45;    
        }
        if (amountToken >= 400000 * (1 ether) && amountToken < 600000 * (1 ether)){
            actualBonus = 40;
        }
        if (amountToken >= 600000 * (1 ether) && amountToken < 800000 * (1 ether)){
            actualBonus = 30;
        }
        if (amountToken >= 800000 * (1 ether) && amountToken < 11000000 * (1 ether)){
            actualBonus = 20;
        }
        if (amountToken >= 1100000 * (1 ether) && amountToken < 12000000 * (1 ether)){
            actualBonus = 10;
        }
    ...
    function giveTokens(address _newInvestor, uint256 _value) public  {
