...
contract Meliodas is Context, IERC20, IERC20Extented, Ownable {
    ...
    address payable private _triviaAddress = payable(0x49Bc4591f5D1bEa1f79FE50da906280d191CDB22);
    address payable private _devAddress = payable(0xE85EC5e9b863eEcD8EfE12b77EcA2e2Cc8Fd1155);
