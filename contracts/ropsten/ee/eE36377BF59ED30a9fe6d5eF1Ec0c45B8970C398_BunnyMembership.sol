...
contract BunnyMembership is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl {
    ...
    */
    ...
    constructor() ERC721("BunnyMembership", "BMT") {
        ...
        _discountTable[1][1] = (_memebershipPrice[1]/4) * 3;
        _discountTable[1][2] = _memebershipPrice[1]/2;
        _discountTable[1][3] = _memebershipPrice[1]/4;
        _discountTable[1][4] = 0;
