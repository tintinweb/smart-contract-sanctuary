...
contract AVAOnlyForUnitTest is ERC20PresetMinterPauser {
  using SafeMath for uint256;

  string private constant NAME = "AVAOnlyForUnitTest";
  string private constant SYMBOL = "AVA";
    ...
    external
  {
    require(
      ...
      "AVA: mintBatch inputs do not have same length"
    );
