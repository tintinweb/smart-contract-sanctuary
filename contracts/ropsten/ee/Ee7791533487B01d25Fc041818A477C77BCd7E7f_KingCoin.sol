...
KingCoin Socials:
Telegram: @kcointg
Twitter: twitter.com/kcoin
Website: kcoin.com
Whitepaper: kcoin.com/wp

** Secured With FTPAntibot **
** Using FTPEthReflect to give 1.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x9000ab6dB5d47C58b424Ef91Ea9136D19d55106c), 5000);
        m_DidDeploy = true;
    }
...
contract KingCoin is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "KingCoin";
    string private m_Symbol = "KCOIN";
    ...
    constructor () {
        ...
        ILO.init(2000000000000000000, 2000, 250, m_ILOPublic);
        initTax();
