...
contract MojoHeads is ERC721URIStorage, AccessControl, IERC2981, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 artistTokenReserve_, uint256 royaltyPercentage_) ERC721(name_, symbol_) {
    ...
    function revealToken(uint256 tokenId, string calldata tokenUri) public onlyRole(CAMPAIGN_ADMIN_ROLE) {
        ...
        require(tokenId > artistTokenReserve, "Artist token uri can not be changed.");
