...
contract ProxyController is AccessControl, IProxyController {
    ...
    function startOrder(uint256 amountIn, OrderInput memory input) public virtual onlyRole(EXECUTOR_ROLE) {
        ...
        emit OrderCreated(orderId, borrower, input.tokenA, input.tokenB, amounts[0], 20, 20, 12345678, true);
        ...
        orders[orderId] = Order(orderTokenA, orderTokenB, borrower, 20, 20, 12345678, true);
