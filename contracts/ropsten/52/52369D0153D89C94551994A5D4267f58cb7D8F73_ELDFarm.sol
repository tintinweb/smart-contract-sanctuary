...
//  IERC20 constant lpToken = IERC20(0x54d5230d16033eb03ffbaB29FCc09Ac54Df6F812);
  ...
  IERC20 constant eldToken = IERC20(0x55a1AAE174bd679A37865568a2a9C92706D29B37);
  ILPToken constant lpToken = ILPToken(0xE8A77F8dF2544daf58d59eE45F84603304334bE9);
...
//  }
  ...
  function getUSDTFromLPToken(uint _lpTokenAmount) public returns (uint) {
    ...
    uint112 _reserveELD;
    uint32 _no;
    (_reserveELD, reserveUSDT, _no) = lpToken.getReserves();
    return _lpTokenAmount * uint(reserveUSDT) / totalSupply;
  }
