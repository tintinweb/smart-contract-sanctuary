 ...
 *
 * This will give Asset Managers or anyone with the Approved Role to destroy a real
 * world asset after its lifetime has exceeded or is put out of service.
 *
 */
abstract contract BurnableAsset is ERC1155 {
	function burn(
		address account,
		uint256 id,
		uint256 value
