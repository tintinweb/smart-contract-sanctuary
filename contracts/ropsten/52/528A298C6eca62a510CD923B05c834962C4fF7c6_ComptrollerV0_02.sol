        ...
        if (!markets[cToken].accountMembership[borrower])
{
    ...
    function _supportNewMarket(address underlying,
        ...
        if (marketsForAssets[underlying][contractNameHash] != address(0)) {
        ...
        marketsForAssets[underlying][contractNameHash] = deployedCToken;
...
contract ComptrollerStorageOlaV0_02 is ComptrollerV5Storage {
    ...
    mapping(address => mapping(bytes32 => address)) public marketsForAssets;
