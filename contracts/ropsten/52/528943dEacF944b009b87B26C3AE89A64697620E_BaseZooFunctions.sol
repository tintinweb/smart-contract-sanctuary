...
contract NftBattleArena is Ownable
{
	...
	function updateEpoch() public {
		...
		require(block.timestamp >= epochDuration || numberOfPlayedPairsInEpoch[currentEpoch] == pairsInEpoch[currentEpoch].length, "error msg"); // Requires fourth stage to end, or determine every pair winner.
