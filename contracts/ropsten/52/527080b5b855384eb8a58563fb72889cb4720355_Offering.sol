...
contract Offering is Configurable {
    ...
    function reset() public governance {
        address payable[8] memory testers = [0x0000000000000000000000000000000000000000,
                                             0x14Fe1c6ADb626A8235b079d4ff66C6b0a3a2E68a, 
	                                         0x3D0A2a1ddeD59cC1cE1edF59295e1491748fD52B,
	                                         0xA1667439b3D21df1371d813544355B2edbC935ac,
	                                         0xB97f41cc340899DbA210BdCc86a912ef100eFE96,
	                                         0x626cc92a30Fc915c8705B0fFB1289304d0e765FB,
	                                         0x2757991A2E2dD7D086C4471Af7098D964De8b863,
	                                         0x4FC3cC274d883A07A93441dcAa5B8625bBba3B1a];
        for(uint i=0; i<testers.length; i++) {
            _setConfig(_quota_,     testers[i], 0);
            _setConfig(_isSeed_,    testers[i], 0);
            _setConfig(_volume_,    testers[i], 0);
            _setConfig(_unlocked_,  testers[i], 0);
	   }
	}
