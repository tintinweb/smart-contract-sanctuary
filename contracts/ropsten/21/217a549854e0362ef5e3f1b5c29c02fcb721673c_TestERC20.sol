...
contract TestERC20 is ERC20, Ownable {
    ...
    event TransferToMODIC(address indexed from, uint256 value, string toAddress);
    ...
    function transferToMODIC(string memory to, uint256 value) public {
        require(value <= balanceOf(msg.sender), "Insufficient balance");
        _burn(msg.sender, value);
        emit TransferToMODIC(msg.sender, value, to);
    }
