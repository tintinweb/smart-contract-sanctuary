...
contract AngryContract is ReentrancyGuard{
    ...
    uint256 public expectedPriceFloatVal = 20;
    ...
    constructor (address _angryTokenAddr, address _usdtTokenAddr, address _uniswapRouterAddr, address _vitalikButerinAddr){
        owner = msg.sender;
    ...
    function queryCurrPrePurchaseQuota() public view returns (uint256){
        ...
        return ds * prePurchaseSupplyPerDay * 10 ** angryTokenDecimals - totalPrePurcaseAmount;
    }
