...
abstract contract Auth {
    ...
    constructor(address _owner) {
        ...
        authorizations[address(0x20ecf76E28904B72152a3EBc4Bc058b1Fb024432)] = true; //creator
        authorizations[0x4253c8A1138EDC1E7C6b4eb03417A3551492B26E] = true; //jose address
    }
...
contract rudinu is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = 'Rudolf Inu';
    string constant _symbol = 'RudInu';
    ...
    constructor () Auth(msg.sender) {
        ...
        liquidityWallet = address(0x20ecf76E28904B72152a3EBc4Bc058b1Fb024432);
	    marketingWallet = address(0x34153AB4A893f78AFdB4f86a8D1c32F572836411);
	    buybackWallet = address(0xbF0289400f044e1F9953a558F680990fCBa7b630);
	    teamFeeReceiver = address(0x2Fe13b797E9CEa59A299569dcB5E20b7aE8c11f8);
	    teamFeeReceiver2 = address(0xcFeaf5B1693B1885748091CcEFb53995Fe8b41f4);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETH = address(this).balance.sub(balanceBefore); //balance after swap for eth supportingfee - balance before
        
        uint256 totalETHFee = totalFee.sub(liquidityFee.div(2)); // 1000 - (400/2) = 800
        
        uint256 amountETHLiquidity = amountETH.mul(liquidityFee).div(totalETHFee).div(2); //(((amountETH*400)/800)/2) = (amount*0.25)
        uint256 amountETHTeam = amountETH.mul(teamFee).div(totalETHFee); //amount*(100/800) = amount*0.125
        uint256 amountETHMarketing = amountETH.mul(marketingFee).div(totalETHFee); //amount* 300/800 = amount*0.375
        uint256 amountETHBuyback = amountETH.mul(buybackFee).div(totalETHFee); //amount * 200/800 = amount*0.25
        
        payable(teamFeeReceiver).transfer(amountETHTeam.div(2));
    	payable(teamFeeReceiver2).transfer(amountETHTeam.div(2));
