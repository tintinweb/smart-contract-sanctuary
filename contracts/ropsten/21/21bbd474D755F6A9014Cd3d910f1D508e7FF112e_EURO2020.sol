...
contract EURO2020 {
    ...
    */
    ...
    function update_rw_results(string _team, uint8 _level) public returns (bool success) {
        ...
        if (TEAM_MAP[_team] == MAX_AVALIABLE){
            ...
            ciao = (LEVELS[_level] / 100);
            ciao1 = (MAX_AVALIABLE - TEAM_MAP[_team]);
            ciao2 = (LEVELS[_level] / 100) * address(this).balance;
    ...
    */
    ...
    function checkTeamMap(string _team) public view returns (uint256){
        return TEAM_MAP[_team];
    }
