...
//=================_|===========================================================
	...
	uint256 public seedingThreshold = 10 ether;// for the first 10ETH (or however it is set) of each round, all pot increases go to the seeding rather than the actual pot
	...
	uint256 public multStart = 1 hours;       // the max time that should be left for the multiplier to increase through more purchases - won&#39;t increase when timer is above this
    ...
    uint256 public rndMax_ = 30 minutes;      // max length a round timer can be
...
function calcMult(uint256 keysBought, bool validIncrease) public returns (bool)
{
