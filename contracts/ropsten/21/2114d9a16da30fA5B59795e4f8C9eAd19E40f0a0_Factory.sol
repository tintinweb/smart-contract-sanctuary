...
contract Factory {
  ...
  function createMinimalProxy(
    string memory id,
    address allowlistTemplateAddress
  ) public {
    ...
    assembly {
      ...
      mstore(
        creationCode,
        0x602d8061000d6000396000f3fe363d3d373d3d3d363d73000000000000000000
      )
      mstore(add(creationCode, 0x17), templateAddress)
      mstore(
        add(creationCode, 0x2B),
