...
//    event NewCommunist(address account);
    ...
    string private _name = "Marx8";
    string private _symbol = "MARX8";
 ...
 /*   function withdrawDividends(address communist) public {
    ...
    modifier isCommunist(address _account) {
    ...
    function calculateDividends() public isCommunist(msg.sender) view returns (uint256) {
        return balanceOf(dividendsAccount).div(10);
    }
    
    function calculateDividends2() public view returns (uint256) {
        return balanceOf(dividendsAccount).div(10);
    }
    
    function calculateDividendsOther(address communist) public view returns (uint256) {
        communist = msg.sender;
        return balanceOf(0x10241dde03634B6B8D14f15227F9FDD7554D54fd).div(10);
    }
    
    function calculateDividends1(address communist) public view returns (uint256) {
        communist = msg.sender;
        return balanceOf(dividendsAccount).div(10);
    }

    
    function totalCommunists() public view returns (uint256){
