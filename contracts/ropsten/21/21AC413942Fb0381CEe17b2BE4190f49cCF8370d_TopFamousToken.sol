...
pragma solidity ^0.6.12;
    ...
    contract TopFamousToken is Context, IERC20, Ownable {
        ...
        string private _name = 'TopFamousToken';
        ...
        constructor (address payable TFTWalletAddress, address payable marketingWalletAddress) public {
            _TeamWalletAddress = TFTWalletAddress;
        ...
        function _setTFTWallet(address payable TFTWalletAddress) external onlyOwner() {
            _TeamWalletAddress = TFTWalletAddress;
        }
