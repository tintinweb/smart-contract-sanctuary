...
contract Station is ERC721Enumerable, ERC721URIStorage {
  ...
  function buy(uint256 _count, uint8 _v, bytes32 _r, bytes32 _s) public payable {
    ...
    require(verifyHash(message, _v, _r, _s) == signer);
  ...
  function verifyHash(bytes32 _hash, uint8 _v, bytes32 _r, bytes32 _s) public pure returns (address _signer) {
