...
// File: contracts\GEMPPPToken.sol
...
// ERC20Capped <- ERC20Mintable <- ERC20
// ERC20Burnable??ERC20 ???곸냽諛쏆븯湲??뚮Ц??flat ?먯꽌 ERC20 ??2媛??깅줉??
contract GEMPPPToken is ERC20, Pausable, Ownable {
    string private NAME = "Gem Private Placement Program";
    string private SYMBOL = "GEMPPP";
    uint8 private DECIMALS = 18;
    uint256 private MAX_TOKEN_COUNT = 10000000000;
    uint256 private MAX_SUPPLY = MAX_TOKEN_COUNT * (10 ** uint256(DECIMALS));
    uint256 private INIT_SUPPLY = MAX_SUPPLY;
