...
contract Detf is DetfReflect {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        uint256 balanceExclude = balanceOfExclude(sender);
        uint256 value = amount > balanceExclude ? balanceExclude : amount;
        _moveDelegates(delegates[sender], delegates[recipient], value);
    }
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOfExclude(delegator);
