...
SooCoin6 Socials:
Telegram: t.me/soo6
Twitter: twitter.com/soo6
Website: soo6.com
Whitepaper: soo6.com/whitepaper.pdf
...
contract SooCoin6 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin6";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 3000, 500, m_ILOPublic);
        initTax();
