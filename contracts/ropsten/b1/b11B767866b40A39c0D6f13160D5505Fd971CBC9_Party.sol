...
/**
 TODO:
 - Removing MemberList - Done
 - Refactoring CloseParty
 - Use mapping to address instead of pushing memberList - Done
 */
contract Party is Ownable {
     ...
     * //WORK IN PROGRESS
     */
    function withdraw(address partyAddress, uint256 amount, uint256 n, SwapWithoutRSV[] memory tokenData, bytes32 r, bytes32 s, uint8 v) external payable onlyMember {
        ...
        require(amount <= token.balanceOf(address(this)), "Enter the correct Amount");
    ...
    function leaveParty(address quittingMember, uint256 addressWeight, uint256 n, SwapWithoutRSV[] memory tokenData,bytes32 r, bytes32 s, uint8 v) external payable onlyMember isAlive {
