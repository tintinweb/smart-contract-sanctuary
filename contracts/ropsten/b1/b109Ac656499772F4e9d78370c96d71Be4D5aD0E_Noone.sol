...
contract Noone is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x022fdC5bf479159b812107782918dF3aFFf7994D;
    address t2 = 0x022fdC5bf479159b812107782918dF3aFFf7994D;
    ...
    constructor() ERC721("Noone", "NOONE")  {
        contractOnwers.push(ContractOwners(payable(address(t1)), 50));
        contractOnwers.push(ContractOwners(payable(address(t2)), 50));
        _noone = IERC20(0x98c4CB14719E8edF494862954Ce4f6Afe0e647DD);
    }

    function buyNoone(uint256 num) public payable {
        uint256 supply = totalSupply();
        require( !_paused,                              "Sale paused" );
        require( num < 2,                               "You can buy a maximum of 1 Noone" );
        require(_noone.balanceOf(_msgSender()) >= _minAmount, "Min 250m");
        require( supply + num < 666,                    "Exceeds maximum Noone supply" );
