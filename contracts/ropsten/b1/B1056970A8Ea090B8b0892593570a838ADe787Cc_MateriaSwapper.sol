...
contract MateriaSwapper is MateriaOperator {
    ...
    function swapExactTokensForTokens(
        ...
        require(amounts[amounts.length - 1] >= amountOutMin, 'Materia: INSUFFICIENT_OUTPUT_AMOUNT');
    ...
    function swapTokensForExactTokens(
        ...
        require(amounts[0] <= amountInMax, 'Materia: EXCESSIVE_INPUT_AMOUNT');
    ...
    function swapTokensForExactETH(
        ...
        amounts = MateriaLibrary.getAmountsIn(factory, amountOut, path);
        require(amounts[0] <= amountInMax, 'Materia: INSUFFICIENT_INPUT_AMOUNT');
    ...
    function swapETHForExactTokens(
        ...
        amounts = MateriaLibrary.getAmountsIn(factory, amountOut, path);
        require(amounts[0] <= msg.value, 'Materia: INSUFFICIENT_INPUT_AMOUNT');
