...
contract TokensFarmFactory is TokensFarmUpgradable, Initializable {
    ...
    event TokensFarmImplementation(address indexed farmImplementation);
    event FeeCollector(address indexed feeCollector);
    ...
    */
        ...
        onlyTokensFarmCongress
    {
        ...
        farmImplementation = _farmImplementation;
        emit TokensFarmImplementation(farmImplementation);
    }
    ...
    */
        ...
        onlyTokensFarmCongress
    {
        ...
        feeCollector = _feeCollector;
        emit FeeCollector(feeCollector);
    }
