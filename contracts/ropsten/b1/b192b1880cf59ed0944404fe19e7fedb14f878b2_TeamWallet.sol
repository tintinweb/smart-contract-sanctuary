...
/// @author Hung Le - <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f199849f969d9cb1878b9e8590df929e9cdf879f">[email&#160;protected]</a>>
contract TeamWallet {
    ...
    event OwnerRemoval(address indexed owner, string name);
        ...
        ownerExists(owner)
    {
        ...
        emit OwnerRemoval(owner, ownerNames[owner]);
    }
