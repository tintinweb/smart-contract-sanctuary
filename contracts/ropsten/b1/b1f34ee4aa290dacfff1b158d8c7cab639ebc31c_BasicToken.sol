...
/**
 * iVTS Token, totalSupply 100000000000000000
 */
contract iVTSToken is BurnableToken, CappedToken(100000000000000000) {
    string public name = "iVTS Token";
    string public symbol = "iVTS";
