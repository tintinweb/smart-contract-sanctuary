    ...
    TokensPreset
{
    ...
    constructor(uint256 _networkThis) {
        setup();
    ...
    function setup() private {
        ...
        _addToken(
            0xe8a259C6B609a9B8a78f65c8D5E8D44cc2192d01, // Ethereum Ropsten
            //0x27cd7375478F189bdcF55616b088BE03d9c4339c, // Ethereum Mainnet
            "Cosmo Token (COSMO)"
        );
        _addToken(
            0x2817775227F6AC6eA3a4b1ad842946Bd7fEd0d15, // Ethereum Ropsten
    ...
    function withdrawUnaccountedTokens(address token) public onlyOwner {
        uint256 unaccounted = tokensUnaccounted(token);
