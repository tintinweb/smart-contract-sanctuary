...
contract NFT is ERC721Enumerable, Ownable {
    ...
    function reserve(uint256 _numberOfTokens) public onlyOwner {
        require(
            reserved + _numberOfTokens <= 100, // reserved Number of NFTs
    ...
    function preSaleBuy(uint8 _amount) external payable {
        ...
        require(
            preSaleCount + _amount  <= preSaleLimit,
    ...
    function checkinarr(address _addr) view internal returns(uint8) {
