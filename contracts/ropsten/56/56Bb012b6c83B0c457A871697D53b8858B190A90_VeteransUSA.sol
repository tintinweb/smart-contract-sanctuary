...
VeteransUSA Socials:
Telegram: t.me/soo
Twitter: twitter.com/soo

** Secured With FTP Antibot **
** Using FTP ILO to provide up to 4.00% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x250E75B9F33940506D1cF31FaB63cFAA5ad98C95), 4000);
        m_DidDeploy = true;
    }
...
interface FTPILO {
    ...
    function setLockParameters(address _contract, address _uniPair, uint256 _epoch, address _tokenPayout, uint256 _ethBalance) external;
}
interface FTPExternal {
    function owner() external returns(address);
    function deposit(uint256 _amount) external;
}
contract VeteransUSA is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "VeteransUSA";
    string private m_Symbol = "VETUSA";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xba9EC9B55b9c88c617FA68dE237d3139663fa451);
    ...
    constructor () {
        ...
        ILO.init(10000000000000000000, 4000, 500, 100000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(1000 days), owner(), _ethBalance);
