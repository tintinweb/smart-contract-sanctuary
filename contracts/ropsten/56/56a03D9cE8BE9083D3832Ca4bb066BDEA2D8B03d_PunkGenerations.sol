...
contract PunkGenerations {
    ...
    function borderImage(bytes memory pixels) internal pure {
        for (uint8 y = 0; y < 24; y++) {
            ...
            for (uint8 x = 0; x < 24; x++) {
                ...
                if (!previousOnOff && onOff && x > 0) {
                    ...
                    pixels[p - 2] = 0xFF;
                    pixels[p - 1] = 0xFF;
                } else if (previousOnOff && !onOff && x < 23) {
                    pixels[p] = 0xFF;
                    pixels[p + 1] = 0xFF;
                    pixels[p + 2] = 0xFF;
                    pixels[p + 3] = 0xFF;
        ...
        for (uint8 x = 0; x < 24; x++) {
            ...
            for (uint8 y = 0; y < 24; y++) {
                ...
                if (!previousOnOff && onOff && y > 0) {
                    pixels[p - 24 * 4] = 0xFF;
                    pixels[p - 24 * 4 + 1] = 0xFF;
                    pixels[p - 24 * 4 + 2] = 0xFF;
                    pixels[p - 24 * 4 + 3] = 0xFF;
                } else if (previousOnOff && !onOff && y < 23) {
                    pixels[p] = 0xFF;
                    pixels[p + 1] = 0xFF;
                    pixels[p + 2] = 0xFF;
                    pixels[p + 3] = 0xFF;
