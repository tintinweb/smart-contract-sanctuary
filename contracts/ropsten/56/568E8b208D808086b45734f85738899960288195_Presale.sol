...
//        require(_tokenLaunchTime < block.timestamp);
    ...
    function deployInitialLiquidity() private {
        ...
        uniswapV2Router.addLiquidityETH{value: liquidEthAmount }(pasv_token,totalLiquidityPoolAmount,liquidTokenAmount,liquidEthAmount, marketing_wallet, block.timestamp);
