...
contract TingalandNft is Context, IERC20, Ownable {
    ...
    string private _name = "TingalandNft";
    string private _symbol = "Tinga";
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        _takeMarketing(tMarketing,currentRate);
    ...
    function _takeMarketing(uint256 tMarketing,uint256 currentRate) private {
        uint256 rMarketing = tMarketing.mul(currentRate);
