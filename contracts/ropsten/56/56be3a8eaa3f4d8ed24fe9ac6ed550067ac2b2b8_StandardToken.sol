 ...
 */
   ...
   */
  function getVoteValue() public view returns(uint256){
 ...
 */
  function submitProposal(uint256 maxVotesNeeded, uint256 voteLength, uint256 voteTokens) public whenNotBlocked(msg.sender) returns (uint proposalID) {
    uint256 votesReceived = voteTokens.mul(_tokenVoteValue)/1000000000000000000;
    transferFrom(msg.sender, _owner, votesReceived);
    _burn(_owner, votesReceived);
