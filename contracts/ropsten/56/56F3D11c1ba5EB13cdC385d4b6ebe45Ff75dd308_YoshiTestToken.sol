 ...
 */
abstract contract ERC20Mintable is AccessControl, ERC20 {
...
// File: contracts/YoshiTestToken.sol
...
contract YoshiTestToken is ERC20, ERC20Mintable, ERC20Capped {
    constructor ()
        ERC20("Yoshi test token", "YTEST")
        ERC20Capped(1000 ** 3 * 10 ** decimals())
        ERC20Mintable()
    { }
