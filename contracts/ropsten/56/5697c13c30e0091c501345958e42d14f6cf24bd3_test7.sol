...
contract test7 is Context, IERC20, Ownable {
    ...
    string private constant _name = "test7";
    string private constant _symbol = "test7";
    ...
    address payable private _developmentAddress = payable(0x3142872D7EBFc5b889E391C1385D65283f85A395);
    address payable private _marketingAddress = payable(0x0F769546cd7F84F8E57A4ABD724B51e8a4e66499);
