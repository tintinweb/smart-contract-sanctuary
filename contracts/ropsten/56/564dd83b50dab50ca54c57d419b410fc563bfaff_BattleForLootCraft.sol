...
contract BattleForLootCraft is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 ennemyId, uint256 lootId) override public view returns (string memory) {
        ...
        parts[1] = '<text font-size="30" font-weight="bold" font-family="sans-serif" fill="#FFFFFF"><tspan x="10" y="40">Battle!</tspan><tspan x="110" y="40" font-size="10" font-weight="normal"> for Loot Craft</tspan></text><text x="10" y="60" class="base" font-family="sans-serif" style="fill: #64D98A;">VICTORY';
        parts[2] = '</text><text x="10" y="80" class="base" font-family="sans-serif">You defeated </text><text class="base" x="90" y="80" ';
        parts[3] = getEnnemyRarity(ennemyId);
        parts[4] = getEnnemies(ennemyId);
        parts[5] = '</text><text x="10" y="100" class="base" font-family="sans-serif" >';
        parts[6] = "With Loot #";
