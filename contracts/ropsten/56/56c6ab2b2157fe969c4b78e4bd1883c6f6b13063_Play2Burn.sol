...
contract Play2Burn is Context, IERC20, Ownable {
    ...
    function setBuyFee(uint16 liq, uint16 market, uint16 tax) external onlyOwner {
        buyFee.liquidityFee = liq;
        buyFee.marketingFee = market;
        buyFee.taxFee = tax;
    }

    function setSellFee(uint16 liq, uint16 market, uint16 tax) external onlyOwner {
