...
contract PreSale is ERC20 {
    ...
    uint256 public MAX_CAP_PERSON = 2000*10**18;
    uint256 public MAX_SUPPLY = 350*1000*10**18;

    uint256 public SALE_START = 1638211004;

    constructor() ERC20("Claimable COCA", "cCOCA", 18) {
        MIM = IERC20Metadata(0xaD6D458402F60fD3Bd25163575031ACDce07538D);
    }
    ...
    function presale(uint256 mimAmount) external {
        ...
        require(caps[msg.sender] + mimAmount <= MAX_CAP_PERSON, "MIM Amount exceed");
