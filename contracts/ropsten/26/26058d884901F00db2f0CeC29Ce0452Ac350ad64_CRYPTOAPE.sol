...
contract CRYPTOAPE is Context, IERC20, Ownable {
    ...
    function fees() public view returns (string memory, string memory, string memory, string memory, string memory)  {
        
        string memory a = " _fundingWalletFee = ";
        string memory b = " _minimumToDistribute = ";
        string memory c = " _liquidityFee = ";
        string memory d = " _burnFee = ";
        string memory e = " _feeTotal = ";
        
        return (string(abi.encodePacked(a, uint2str(_fundingWalletFee))),
                string(abi.encodePacked(b, uint2str(_minimumToDistribute))),
                string(abi.encodePacked(c, uint2str(_liquidityFee))),
                string(abi.encodePacked(d, uint2str(_burnFee))),
                string(abi.encodePacked(e, uint2str(_feeTotal))));
    }
