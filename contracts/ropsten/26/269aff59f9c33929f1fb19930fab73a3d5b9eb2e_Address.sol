...
/**
 *Submittedor verification at BscScan.com on 2021-02-06
*/
...
contract PegazusFinance is Context, IERC20, Ownable {
    ...
    string private _name = "cryptokenup";
    string private _symbol = "CTUP";
    ...
    uint256 public _maxTxAmount = 1 * 10**15 * 10**4;
    uint256 private minimumTokensBeforeSwap = 3 * 10**11 * 10**4; 
    
    address payable public charityAddress1 = 0xb677638fc7AD0E9F0BaceD78F43aC8f19F46d6e7;
    address payable public charityAddress2 = 0x57a91d0Ff82B9047d05922C5666ed46bd7aD6A5d;
    address payable public charityAddress3 = 0x9b6B83d5134104a46929393F93330f92C89a46A5;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9b6B83d5134104a46929393F93330f92C89a46A5);
