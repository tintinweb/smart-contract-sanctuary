...
contract Vault is OwnableUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, VaultStorage {
    ...
    function initialize(address _token) public initializer {
        __Ownable_init();
        __Pausable_init();
        string memory name = string(abi.encodePacked(IERC20Detailed(_token).name(), " sVault"));
        string memory symbol = string(abi.encodePacked("sv", IERC20Detailed(_token).symbol()));
