...
contract Dice2Win {
    ...
    constructor () {
        ...
        secretSigner = 0xC86E9aBfbf265D34f6de3608Cc4e0a9E2886756f;
        croupier = 0x1388f1a909F073f9f90b0B177106de1730D88A2D;
    }
...
// ----------------Added------end------------------
    ...
    function settleBetCommon(Bet storage bet, uint reveal, bytes32 entropyBlockHash) private {
        ...
        sendFunds(payable(gambler), diceWin + jackpotWin == 0 ? 1 wei : diceWin + jackpotWin, diceWin);
    }
    ...
    function refundBet(uint commit) external {
        ...
        // Send the refund.
        sendFunds(payable(bet.gambler), amount, amount);
    }
    ...
    function requireCorrectReceipt(uint offset) view private {
        ...
        require (logAddress == uint256(uint160(address(this))));
    }
