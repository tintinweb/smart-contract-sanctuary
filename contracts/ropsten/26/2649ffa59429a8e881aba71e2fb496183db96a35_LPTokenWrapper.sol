...
contract BsktEthLPPool is LPTokenWrapper {
    IERC20 public STAKEBSKT = IERC20(0x4Bec13aB192280763A201a30ca093a3d0a15b3DC); // BSKT-ETH-LP TOKEN ADDRESS
    ...
    function stake(uint256 amount) public updateReward(msg.sender) checkStart {
        ...
        require(!minimumBsktStakingEntry[_msgSender()] && ( amount >= 1 * 10 ** 1 ) , "Error:For Initial entry 5000 token must be required.");
        super.stake(amount);
    }
    ...
    function notifyRewardRate(uint256 _reward) public updateReward(address(0)) onlyOwner{
        ...
        require(!firstNotify, "Error : Notify rewards not allowed");
