...
contract NFHoneyBadgers is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("NFHoneyBadgers", "NFHB") {
        setBaseURI("https://nfhoneybadgers.com/metadata/");
    }
        ...
        returns (string memory)
    {
        ...
        if (unreveal) {
            ...
            return "https://ipfs.io/ipfs/QmXz9C4FBo64TvmtyBdW6uBWeVmgLBpofs55u1fynRRFaf";
        }
    }
    ...
    function preSaleBuy(uint8 _amount) external payable {
        ...
        require(
            preSaleCount + _amount  <= 350 , //preSaleLimit 500 
