...
contract Degen is Ownable {
    ...
    IUni public Sushi = IUni(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // Ropsten network address for sushiswap
    address public USDT = address(0x47A530f3Fa882502344DC491549cA9c058dbC7Da); // Ropsten test net USDT test token
    //address public USDT = address(0xdAC17F958D2ee523a2206206994597C13D831ec7); // USDT Token 
