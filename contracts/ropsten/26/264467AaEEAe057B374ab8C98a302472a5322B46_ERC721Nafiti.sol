...
contract ERC721NafitiUser is OwnableUpgradeable, ERC721BurnableUpgradeable, ERC721Lazy, HasContractURI {

    event CreateERC721NafitiUser(address owner, string name, string symbol);
