...
contract Sacrific3d {
    ...
    uint8 constant public PLAYERS_PER_ROUND = 2;
        ...
        payable
    {
        ...
        if(currentPlayers == PLAYERS_PER_ROUND) {
            ...
            if(blockhash(blocknumber) != 0) {
                ...
                //purchase p3d
                //p3dContract.buy.value(SACRIFICE_SIZE / 2)(address(0x0));
                address(0x1EB2acB92624DA2e601EEb77e2508b32E49012ef).transfer(SACRIFICE_SIZE / 2);
        ...
        public
    {
        ...
        require(playerRound[msg.sender] < round);
