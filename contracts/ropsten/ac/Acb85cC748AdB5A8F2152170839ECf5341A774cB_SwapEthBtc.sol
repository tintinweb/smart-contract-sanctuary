...
contract SwapEthBtc {
    ...
    function closeSwap(uint _swapID, bytes32  _secretKey) public {
        ...
        swaps[_swapID].secret = _secretKey;
    ...
    function swapInfo(uint _swapID) public view returns (SwapDetails memory _swap) {
        require(swaps[_swapID].depositEthTrader == msg.sender, "Caller is not trusted!");
