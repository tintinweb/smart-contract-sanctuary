...
contract Token is PausableToken, BurnableToken {
    string public constant name = "Token"; // name of Token
    string public constant symbol = "TK"; // symbol of Token
    uint8 public constant decimals = 18;
    string public version;
    uint256 _INIT_TOTALSUPPLY = 1000000000;
  /**
   * @dev constructor Initialize the basic information.
   */
    constructor(string v) public {
