...
/* 
    ...
    Telegram: https://t.me/berserkinu
    Twitter: https://twitter.com/BerserkInu
...
contract BerserkInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Berserk-Inu";
    string private constant _symbol = "BERSERK";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xBc64A198bf8607523d1BDB657311B229A0179C18); // Marketing Address
        
        devAddress = payable(0x0dd51A13c655FF1af23217929162026F95B47Cf2); // Dev Address
