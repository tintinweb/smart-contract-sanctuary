...
contract BLABLA is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0x49BE89682318bc5B79fCf33c51eE2bc518FBa992);
    ...
    function _setMarketingFee(uint256 marketingFee) external onlyOwner() {
        require(marketingFee >= 0 && marketingFee <= 49, 'marketingFee should be in 1 - 49');
        _marketingFee = marketingFee;
    }

    function _setLiquidityFee(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee >= 0 && liquidityFee <= 49, 'liquidityFee should be in 1 - 49');
