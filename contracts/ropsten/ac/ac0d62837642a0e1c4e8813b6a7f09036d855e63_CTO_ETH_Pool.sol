...
contract CTO_ETH_Pool is Ownable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint256 amount);
    
    // CTO token contract address
    address public tokenAddress = 0x110db3aacC2d49a66f05D2F074064FA0ab4491F6;
    ...
    function deposit(uint256 amountToStake) public {
        ...
        Token(tokenAddress).Approve(address(this), amountToStake);
