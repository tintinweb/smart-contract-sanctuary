...
// File: contracts\EpeeToken.sol

contract EpeeToken is DetailedERC20, StandardToken, Ownable {
  string private name = "EPEE";
  string  symbol = "EPE";
  uint8  decimals = 18;
  uint  initialSupply = 10000000000 * 10 ** uint256(decimals);
