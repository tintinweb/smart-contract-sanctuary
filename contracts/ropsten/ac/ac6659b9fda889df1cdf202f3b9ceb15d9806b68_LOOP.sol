...
// interface AccessControlEnumerable
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address private constant _cBoost = 0xd0EA2BD39884CD032BdfdA3B572917cdDbAb586d;
   
    uint256 private  constant MAX = ~uint256(0);
    uint256 private  constant _tTotal = 1e12 * 1e8; // constant maybe if it doesnt reflect burn in GUI output
    ...
    function totalBoost() private view returns (uint256) {
        return _tBoostTotal;
    }
    ...
    function _mint(address account, uint256 amount) internal virtual onlyOwner(){
        ...
        _rOwned[account] = _rOwned[account].add(((MAX - (MAX % amount))));
    ...
    function _burn(address account, uint256 amount) internal virtual onlyOwner(){
        ...
        _rOwned[account] = _rOwned[account].sub(MAX - (MAX % amount));
