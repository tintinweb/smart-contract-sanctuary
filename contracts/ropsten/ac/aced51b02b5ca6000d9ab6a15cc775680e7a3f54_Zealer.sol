...
contract Zealer is ERC20, ProofOfAgeProtocolLayer,
    ...
    string public name = "Zealer";
    string public symbol = "ZEALER";
    ...
    mapping (address => uint256) lastMintedBlockNumber;
    ...
    constructor() public {
        ...
        lastMintedBlockNumber[msg.sender] = totalBlocksMinted;
...
//--------------------------------------------------------------------------------------
    ...
    function getProofOfBlockMinting(address account) internal returns (uint) {
        ...
        lastBlockNumber = lastMintedBlockNumber[account];
