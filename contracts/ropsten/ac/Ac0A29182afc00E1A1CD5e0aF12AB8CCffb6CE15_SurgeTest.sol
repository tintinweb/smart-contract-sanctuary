...
interface FTPILO {
    ...
    function unstake(address _contract, address payable _address) external;
...
contract SurgeTest is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SurgeTest";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x28c4aD7a95B432B3FA97806881e3716d1439d9e1);
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1000, 10, 100000, m_ILOPublic);
        initTax();
	...
	function unstake() external {
        ...
        ILO.unstake(address(this), _sender);
    }
