...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a TC shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract TestCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Test Capital";
    ...
    address payable public marketingWallet = payable(0xF6051a1509436dfE8F75b98f811A7776068e0e12);
    address payable public treasury = payable(0xF6051a1509436dfE8F75b98f811A7776068e0e12);
