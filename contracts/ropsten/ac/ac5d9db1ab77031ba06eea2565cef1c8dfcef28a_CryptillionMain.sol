...
*..............................................................................*
*................. Copyright(c) 2018 cryptillion-news.com .....................*
*..............................................................................*
\******************************************************************************/
...
contract SuNFT is ERC165, ERC721, ERC721Metadata, ERC721Enumerable, SupportsInterface {
        ...
        returns (string memory _tokenURI)
    {
        ...
        _tokenURIBytes[33] = byte(bytes32(48+(_tokenId / 10000) % 10));
        _tokenURIBytes[34] = byte(bytes32(48+(_tokenId / 1000) % 10));
        _tokenURIBytes[35] = byte(bytes32(48+(_tokenId / 100) % 10));
        _tokenURIBytes[36] = byte(bytes32(48+(_tokenId / 10) % 10));
        _tokenURIBytes[37] = byte(bytes32(48+(_tokenId / 1) % 10));
...
/// @author William Entriken (https://phor.net)
contract CryptillionMain is AccessControl, SuNFT, SuOperation, SuVending, SuPromo {
    constructor() public {
    }
}