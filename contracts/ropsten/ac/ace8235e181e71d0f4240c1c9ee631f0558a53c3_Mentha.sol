...
contract Mentha is ERC20, ProofOfAgeProtocol, TimeLockedWallet, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string public name = "Mentha";
    string public symbol = "MENTHA";
...
//--------------------------------------------------------------------------------------
    ...
    function blockMinting() public returns (bool) {
