...
contract GaiusDAO is BasicToken, Ownable{

using SafeMath for uint256;

//token attributes

string public name = "GaiusDAO";                 //name of the token

string public symbol = "Gai";                      // symbol of the token

uint8 public decimals = 18;                        // decimals

uint256 public totalSupply = 220000000 * 10**uint256(decimals);  // total supply of Gai Tokens
...
uint256 tokenPrice = 25;

//events
event LogNewAllocation(address indexed _recipient, uint256 _totalAllocated);
event LogGaiReleased(address indexed _recipient, uint256 _amountClaimed, uint256 _totalAllocated, uint256 _grandTotalClaimed);

///////////////////////////////////////// CONSTRUCTOR for Distribution //////////////////////////////////////////////////

  function GaiusDAO  () public {
...
// Checks modifier and allows transfer if tokens are not locked.
  ...
  function releaseVestedTokens(address _tokenAddress) onlyOwner public{
    ...
    LogGaiReleased(_tokenAddress, tokensToTransfer, newAmountClaimed, grandTotalClaimed);
  }
  ...
  function distributeToken(address[] _addresses, uint256[] _value) onlyOwner public {
    ...
    function getNoOfTokensTransfer(uint32 _exchangeRate , uint256 _amount) internal pure returns (uint256) {
