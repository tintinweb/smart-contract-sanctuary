...
contract Digitoken  {
    ...
    uint256 public totalSupply = 1_000_000_000e18; // 1 billion Digi
    uint public daoSupply = 50_000_000e18;  
    uint public devFund = 50_000_000e18;
    address digidao_address;
    uint current_rate;
    string public constant name = "Digitrade";
    ...
    constructor() public{
    digidao_address = msg.sender;
    devFundLock = true;
    devFundUnlockBlock = (block.number + 155200);
    lockMint = true;
    mintUnlockBlock = (block.number +155200);
    rateLock = true;
    rateUnlockBlock = (block.number +155200);
    current_rate = div(1,90); //.011 % of Operator Transaction value burned
