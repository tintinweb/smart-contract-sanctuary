...
interface IDegen {
    ...
    function callbackCrossExchange(OrderType orderType, address[] memory path, uint256 assetInOffered, address user, uint8 dexId, uint256[] memory distribution, uint256 deadline)
...
contract DegenBridge is Ownable {
    ...
    */
    ...
    function swap(address tokenA, address tokenB, uint256 amount, address user, uint8 crossOrderType, uint8 dexId, uint256[] memory distribution, uint256 deadline) 
    ...
    function claimTokenBehalf(address[] memory path, address user, uint256 amount, uint8 crossOrderType, uint256 nonce, uint8 dexId, uint256[] memory distribution, uint256 deadline)
    ...
    function _claim (address[] memory path, address user, uint256 amount, uint8 crossOrderType, uint8 dexId, uint256[] memory distribution, uint256 deadline) 
