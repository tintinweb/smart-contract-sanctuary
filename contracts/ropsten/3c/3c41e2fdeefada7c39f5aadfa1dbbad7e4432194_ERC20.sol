...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
     ...
     function refund (address payable recipient) external{
        require(msg.sender == recipient , "NOT adres yanlis Accessable");
        require((_TotalSaled < 980e8) , "cap not reached dostum");
         require(block.timestamp >= contractcreationtime ,"time limit not reached wait 6 minutes after contract deployment ");
