...
contract Configurable {
    uint256 public constant cap = 210000*10**18;
 ...
 **/
contract DogeLendFinance is CrowdsaleToken {
    string public constant name = "Doge Lend Finance";
    string public constant symbol = "DLF";
