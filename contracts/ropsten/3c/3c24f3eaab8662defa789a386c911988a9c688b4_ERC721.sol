...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function setTokenBids(bool value) public onlyOwner {
        allowTokenBids = value;
    }

    function setCreateAuction(bool value) public onlyOwner {
    ...
    function placeBid(uint256 tokenId, uint256 tokensAmount) public payable {
