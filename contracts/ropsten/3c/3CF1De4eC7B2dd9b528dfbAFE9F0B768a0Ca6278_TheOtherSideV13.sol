...
contract TheOtherSideV13 is ERC721EnumerableT, Delegated {
  ...
  /**
    ...
    */
    ...
    function getAllStakeAddressSnapshot() external onlyDelegates view returns( address[] memory) {
      return stakeHoldersAddress;
    }

    function getAllStakeTokensSnapshot() external view returns( uint256[] memory) {
      return stakeHoldersTokenIds;
    }
}
