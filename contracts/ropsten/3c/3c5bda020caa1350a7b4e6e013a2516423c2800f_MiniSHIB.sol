...
contract MiniSHIB is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiniSHIB";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x490196aA064E2582500Ca00a9884Adc930E4799f); // Marketing Address
        
        devAddress = payable(0x2fa9895642c198786FA12EF3Bf6C68075dC81881); // Dev Address
