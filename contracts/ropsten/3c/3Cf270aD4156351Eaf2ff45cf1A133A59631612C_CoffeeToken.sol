...
contract Token {
  ...
  /// @param _miner The address of the account miner
  /// @param _amount The amount of token to be minted
  /// @return Whether the mint was successful or not
  function mint(address _miner, uint256 _amount) public returns (bool success) {}

  event Burn(uint256 _value);
  event Mint(address _miner, uint256 _value);
...
contract StandardToken is Token {
  ...
  // function mint(address _miner, uint256 _amount) public returns (bool success) {
  //   require(msg.sender == address(0), "ERC20: only zero address can mint");
  //   _totalSupply = _totalSupply.add(_amount);
  //   balances[_miner] = balances[_miner].add(_amount);
  //   emit Mint(_miner, _amount);
  //   return true;
  // }
...
// File: contracts/COFFEE_TOKEN.sol
...
contract CoffeeToken is StandardToken {
  ...
  */
  ...
  constructor() public {
    ...
    name = "Coffee Finance";             // Set the name for display purposes
    decimals = 18;                                 // Amount of decimals for display purposes
    symbol = "CFE";                               // Set the symbol for display purposes
  }
}