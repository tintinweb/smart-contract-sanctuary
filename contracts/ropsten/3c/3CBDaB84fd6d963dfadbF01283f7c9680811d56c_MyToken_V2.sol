...
contract Versionable is OwnableUpgradeable {
    int8 public version;

    // function __Versionable_init(int8 _version) internal initializer {
    //     __Versionable_init_unchained(_version);
    // }

    // function __Versionable_init_unchained(int8 _version) internal initializer {
    //     version = _version;
    // }
    ...
    function setVersion(int8 _version) public onlyOwner {
        version = _version;
    }
}
