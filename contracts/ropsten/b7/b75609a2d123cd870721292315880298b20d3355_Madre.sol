...
contract Madre is Context, IERC20, Ownable {
    ...
    string private _name = 'Madre token';
    string private _symbol = 'MADRE';
    ...
    function postInit() external onlyOwner() {
        _taxFee = 20;
        _teamDev = 5;
        _teamDevAddress = payable(0xc06372D3Ac7e02957621121b8fBC1f021f9D1061);
    }
