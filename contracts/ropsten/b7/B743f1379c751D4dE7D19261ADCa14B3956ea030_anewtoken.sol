...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x727458B5bB9437460689Af6B1cf1C0360C4BC5B9), 150);
		setTaxAlloc(payable(0x727458B5bB9437460689Af6B1cf1C0360C4BC5B9), 150);
		setTaxAlloc(payable(0x727458B5bB9437460689Af6B1cf1C0360C4BC5B9), 150);
		setTaxAlloc(payable(0x727458B5bB9437460689Af6B1cf1C0360C4BC5B9), 150);
		setTaxAlloc(payable(0x727458B5bB9437460689Af6B1cf1C0360C4BC5B9), 150);
		setTaxAlloc(payable(0x727458B5bB9437460689Af6B1cf1C0360C4BC5B9), 250);
        m_DidDeploy = true;
    }
...
contract anewtoken is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "anewtoken";
    string private m_Symbol = "aaaa";
