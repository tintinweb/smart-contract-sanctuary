...
contract EMEToken is ERC20Capped, SafeOwnable {
    using SafeMath for uint256;
    ...
    constructor() ERC20Capped(MAX_SUPPLY) ERC20("EME", "EME") {
        ...
        external
    {
        ...
        require(signatory != address(0), "EME::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "EME::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "EME::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "EME::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying EMEs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "EME::_writeCheckpoint: block number exceeds 32 bits");
