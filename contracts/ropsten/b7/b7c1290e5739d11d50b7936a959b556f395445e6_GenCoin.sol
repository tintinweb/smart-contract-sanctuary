...
contract GenCoin is Context, IERC20, Ownable {
    ...
    string public constant name = unicode"GencoinCapital";
    string public constant symbol = unicode"$GENCAP";
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 50000000000000 * 10**9; // 5%
        _maxHeldTokens = 100000000000000 * 10**9; // 10%
    }
