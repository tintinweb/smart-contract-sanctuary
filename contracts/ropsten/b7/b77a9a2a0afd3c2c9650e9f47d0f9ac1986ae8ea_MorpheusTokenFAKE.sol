...
/**
 * Morpheus.Network.MultipleFAKE token smart contract.
 */
contract MorpheusTokenFAKE is AbstractToken {
  /**
  ...
  /**
   * Create new Morpheus.Network.MultipleFAKE token smart contract and make msg.sender the
   * owner of this smart contract.
   */
  function MorpheusTokenFAKE () public {
    owner = msg.sender;
  }
