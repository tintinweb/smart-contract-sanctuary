...
contract ILOTest10 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOTest10";
    string private m_Symbol = "ILO10";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x6A80d875B293a93019a12d3DD5b9a03BB8C66869);
