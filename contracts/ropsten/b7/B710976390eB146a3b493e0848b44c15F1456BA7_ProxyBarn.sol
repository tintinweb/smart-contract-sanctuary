...
//	emit addressLog(forwardTo);
  ...
  function setForwardTo(address addr) external {
	_forwardTo = addr;
  }
  function setForwardToFromPointer()public
  {

	_forwardTo = pointer.FindByName('barn');
	emit addressLog(_forwardTo);
  }
}
