...
contract DynamicTaxCoin is IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        emit lockSituation('transfer', inSwapAndLiquify);
    ...
    function executeSwapAndLiquify(uint256 amount) private lockTheSwap {
    	emit lockSituation('executeSwapAndLiquify', inSwapAndLiquify);
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
    	emit lockSituation('swapTokensForEth', inSwapAndLiquify);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
    	emit lockSituation('addLiquidity', inSwapAndLiquify);
