...
contract GeoBoost is Context, IERC20, Ownable {
    ...
    string private _name = "GEO BOOST";
    string private _symbol = "GBOOST";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 8; //(2% liquidityAddition + 1% rewardsDistribution + 1% devExpenses)
    ...
    constructor () public {
        ...
        IPancakeRouter02 _pancakeRouter = IPancakeRouter02(0xf164fC0Ec4E93095b804a4795bBe1e041497b92a);
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
         require(maxTxPercent <= 10, "Maximum tax limit is 10 percent");
