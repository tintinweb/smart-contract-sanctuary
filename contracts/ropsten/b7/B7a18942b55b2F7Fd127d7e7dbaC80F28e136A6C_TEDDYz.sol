...
contract TEDDYz is ERC721Enumerable, Ownable {
  ...
  string public METADATA_PROVENANCE_URI = "";
  ...
  /**
   * @dev Set metadata provenance hash
   */
  function setProvenanceHash(string memory _hash) public ownersOnly {
    METADATA_PROVENANCE_URI = _hash;
    setBaseURI(_hash);
  }
