...
contract sWOM is FrozenToken {
    ...
    constructor() ERC20("sWOM", "sWOM", 9) ERC20Permit() {
    ...
    /**
        @notice increases sWOM supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sWOM
