...
contract SwapBloexToken is ERC20, ERC20Detailed {
    ...
    uint public btRate = 2179;              //bt founding value
    uint constant public rateBase = 10000; 

    address constant public usdt = address(0xf6783C2764A66f449011635e55cB013640f75BB0);      //Tether USD (USDT) Ropsten 
    address constant public bt = address(0x421D236E481e8fA12aBaC103004E4a868EE2e55d);        //Bloex Token (BT) Ropsten 
