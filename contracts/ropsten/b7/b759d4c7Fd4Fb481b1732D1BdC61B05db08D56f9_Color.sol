...
contract Color is ERC721, Ownable {
    ...
    function mint(string memory _color) public payable{
        ...
        string memory imageURI = svgToImageURI(_color);
    ...
    string memory svgString_1 = "<svg width='302' height='302' viewBox='0 0 302 302' fill='none'> <rect width='302' height='302' rx='16' fill='";
