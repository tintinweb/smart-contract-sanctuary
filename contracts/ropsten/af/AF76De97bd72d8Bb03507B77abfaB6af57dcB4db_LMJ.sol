...
contract LMJ is ERC20Pausable {
  string public constant name = "LMJ token";
  string public constant symbol = "LMJ";
  uint256 private constant MAX_TOKEN_COUNT = 20000000000;
  uint public constant decimals = 18;

  uint public constant INITIAL_SUPPLY = MAX_TOKEN_COUNT * (10 ** decimals);
