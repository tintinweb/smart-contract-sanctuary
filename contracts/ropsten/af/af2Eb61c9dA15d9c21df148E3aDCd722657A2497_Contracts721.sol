...
// File: tcoan\Contracts721.sol

pragma solidity >=0.6.0;

//import "@chainlink/contracts/src/v0.6/VRFConsumerBase.sol";

contract Contracts721 is ERC721/*, VRFConsumerBase*/ {
...
//        bytes32 requestId = requestRandomness(keyHash, fee, userProvidedSeed);
        bytes32 requestId = keccak256(abi.encodePacked(block.difficulty, block.timestamp, userProvidedSeed));
    ...
    function fulfillRandomness(bytes32 requestId) internal {
