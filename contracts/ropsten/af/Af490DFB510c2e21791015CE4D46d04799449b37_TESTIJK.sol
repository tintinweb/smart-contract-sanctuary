...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract TESTIJK is ERC20, Ownable {
        using SafeMath for uint256;
    ...
    string private    _name = "TestIJK";
    string private  _symbol = "IJK";
    uint8 private _decimals = 9;
    
  
    uint256 public _marketingFee = 3;
    uint256 public _deployerFee = 2;
    ...
    address payable marketingWallet = payable(0x9B097019fA7ea03D881dCA0D1d0135dEA1BC20B7);
    address payable deployerWallet = payable(0xfaD1C71eC8231Ff57f808701497D14E99CB8C543);
    address payable developmentWallet = payable(0x2bf58C0d8670569A266ADBd19e26F7Ef1fa6Cd06);
    ...
    constructor () ERC20("TestIJK", "IJK", 8) {
