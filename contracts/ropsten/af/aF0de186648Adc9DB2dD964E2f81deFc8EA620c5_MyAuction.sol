...
contract MyAuction is ERC721Token{
    ...
    function createAuction(
        ...
        newAuction.metaData = tokenURI(_tokenId);
    ...
    function itemRegister(string memory _tokenUri) public returns(bool){
    ...
    function getAuctionLeftTime(uint _auctionId) public view returns(uint){
        ...
        return leftTime < now ? 0 : auctions[_auctionId].auctionEndTime - now;
    }
