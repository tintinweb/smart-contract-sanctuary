...
contract Money is Context, IBEP20, Ownable {
    ...
    uint256 public _taxFee       = 7; // Reflection 
    uint256 public _liquidityFee = 6; 
    uint256 public _percentageOfLiquidityForGiveaway = 7 ; 
    
    uint256 public  _maxTxAmount     = 10000000000000 * 10**9;
    uint256 private _minTokenBalance = 10000000000000 * 10**9;
    ...
    event GiveawayFeeSent(address to, uint256 bnbSent);
    ...
    constructor (address cOwner, address GiveawayWallet) Ownable(cOwner) {
    ...
    function setGiveawayWallet(address GiveawayWallet) external onlyOwner {
        _GiveawayWallet = GiveawayWallet;
    }
    ...
    function setPercentageOfLiquidityForGiveaway(uint256 GiveawayFee) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        // take Giveaway fee
        uint256 GiveawayFee          = newBalance.mul(_percentageOfLiquidityForGiveaway).div(100);
        uint256 bnbForLiquidity = newBalance.sub(GiveawayFee);
        if (GiveawayFee > 0) {
            payable(_GiveawayWallet).transfer(GiveawayFee);
            emit GiveawayFeeSent(_GiveawayWallet, GiveawayFee);
        }
