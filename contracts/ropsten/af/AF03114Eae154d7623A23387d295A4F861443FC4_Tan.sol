...
contract Tan is ERC721, Ownable {
    ...
    function createWhitelist(uint256 code) external payable {
        ...
        uint256 whitelistHash = uint256(keccak256(abi.encodePacked(msg.sender, hashSalt, MINT_PRICE_WHITELIST)));
    ...
    function getWhitelistcodeFor(address addr) external view returns (uint256) {
        return uint256(keccak256(abi.encodePacked(addr, hashSalt, MINT_PRICE_WHITELIST)));
    }
