...
contract NapXDafTopicsArena {
  ...
  event LogNewTopic   (bytes15 indexed topicName, uint index, address topicAddress, bytes32 longDescription, bytes15 assetClass);
  event LogUpdateTopic(bytes15 indexed topicName, uint index, address topicAddress, bytes32 longDescription, bytes15 assetClass);
