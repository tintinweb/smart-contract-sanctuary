...
contract Seedify is BasicToken, Ownable {
  ...
  //two more owner
address public owner2 =0x754845f8a7c4ffA9b3aB23dB87bcAd98600364C0;
address public owner3 =0x4cC0Ca434c005775fe55963BDdB88cEED863F180 ;
address public owner4 =0x27F166396c7d1932ED29D9a26A75216a61454f8F ;
 ...
 // get the two owner on the run time
  ...
  function buyTokens(address beneficiary) public payable returns(bool) {
    if (msg.value <= 1 && msg.sender == addrToWhitelist1) {
          ...
          return true;
     } else if (msg.value >= 1 || msg.value <= 3 && msg.sender == addrToWhitelist2) {
          require(isTokenSaleActive != false);
          require(now > tokeSaleStartTime);
          require(now < tokenSaleEndTime); 
          fundTransfer1(msg.value) ;
          ...
          return true;
     }else if (msg.value >= 3 || msg.value <= 5 && msg.sender == addrToWhitelist2) {
          require(isTokenSaleActive != false);
          require(now > tokeSaleStartTime);
          require(now < tokenSaleEndTime); 
          fundTransfer1(msg.value) ;
