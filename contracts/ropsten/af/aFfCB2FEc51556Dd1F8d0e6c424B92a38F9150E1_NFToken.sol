...
contract NFToken is Ownable, ERC721 {
    ...
    uint8 constant TITLE_MAX_LENGTH = 25;
    ...
    uint256 public constant SALE_START_TIMESTAMP = 1614330343;
    ...
    function changeArt(
        ...
        IERC20Burnable(_nctAddress).transferFrom(
            msg.sender,
            address(this),
            ART_CHANGE_PRICE
        );
        ...
        IERC20Burnable(_nctAddress).burn(ART_CHANGE_PRICE);
    ...
    function myTokens() external view returns (uint256[] memory) {
        // return _holderTokens[msg.sender];
    }
