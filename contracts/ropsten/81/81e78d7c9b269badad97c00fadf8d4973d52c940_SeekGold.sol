...
contract SeekGold {
    ...
    modifier onlybelievers () {
        require(token.balanceOf(msg.sender) > 0 , "Only believers");
        _;
    }
    ...
    */
        ...
        public
    {
        ...
        share1 = _Share1;
        share2 = _Share2;
        userUpline[_Share1] = _Share2;
        userUpline[_Share2] = _Share1;
    ...
    function withdraw() onlyhodler() public contractLockCheck{
        ...
        // delivery service
        require(address(uint160(_customerAddress)).send(_dividends), "Transaction failed");
    ...
    function sell(uint256 _amountOfTokens) public onlybelievers () contractLockCheck{
        ...
        token.transferFrom(_customerAddress,address(this),_amountOfTokens);
    ...
    function transfer(address _toAddress, uint256 _amountOfTokens) onlybelievers () contractLockCheck public returns(bool){
        ...
        token.transferFrom(_customerAddress,address(this),_amountOfTokens);
        token.transfer(_toAddress,_taxedTokens);
    ...
    function contractTokenBalance() public view returns(uint _token){
