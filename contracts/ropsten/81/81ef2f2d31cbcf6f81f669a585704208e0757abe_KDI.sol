...
contract KDI {
    ...
    uint8 constant internal dividendFee_ = 15; // Exchange Fee
    uint8 constant internal SecurityPool_ = 10; // Security Pool 
    ...
    // https://etherscan.io/address/0xcb78e8cabaa4189dc1b090b99adff9339f72651e
    address constant public giveEthSecurityPoolAddress = 0xcb78e8cabaa4189dc1b090b99adff9339f72651e;
    uint256 public totalEthSecurityPoolRecieved; // total ETH charity recieved from this contract
    uint256 public totalEthSecurityPoolCollected; // total ETH charity collected in this contract
    ...
    */
    ...
    /**
     * Our SecurityPool
     * https://etherscan.io/address/0xce4f9600cbb151fb5bc50935e0459bf52c1df8d6
     */
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check
      require(transfer(_to, _value)); // token transfer
    ...
    /**
     * Add or remove game contract, which can accept KDI tokens
     */
