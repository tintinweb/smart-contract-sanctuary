...
//    function registerSwap(address inputToken, address outputToken, uint256 amountIn, uint256 minAmountOut) external;
    function buyAssetOnBehalf(address inputToken, address outputToken, address userAddress, uint256 usdcAmount) external;
    function issueOwnershipNft(address userAddress, address token, uint256 amount) external;

    event BuyAssetOnBehalf(address, address, uint256);
    event RegisterSwap(address, address, uint256);
}
