...
contract TokenWraper {
    ...
    IERC20 public _token = IERC20(0xffD1c60a0f74ac07C97280450Af404BaCb6095D2);
...
contract Saving is TokenWraper {
    ...
    IERC20 public token = IERC20(0xffD1c60a0f74ac07C97280450Af404BaCb6095D2);
    ...
    function save(uint256 _amount) public {
        require(getUserTotalSupply() <= limitAmountSaved, "Exceed amount limit");
