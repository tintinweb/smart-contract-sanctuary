...
//      ///////////////////////////  Functions (Write) ///////////////////
    ...
    function deposit_to_contract() public inState(State.contract_created) {
        ...
        if(msg.sender == buyer)
        {
            ...
            require(Token.approve(address(this), buyer_share), "Deposit_to_contract: Failed on transferFrom Buyer!");
            require(Token.allowance(msg.sender, address(this))>0, "Deposit_to_contract: Failed on transferFrom Buyer!");
        ...
        else if(msg.sender == seller)
        {
            ...
            require(Token.approve(address(this), seller_share), "Deposit_to_contract: Failed on transferFrom Seller!1");
            require(Token.allowance(msg.sender, address(this))>0, "Deposit_to_contract: Failed on transferFrom Seller!2");
            require(Token.transferFrom(msg.sender, address(this), seller_share), "Deposit_to_contract: Failed on transferFrom Seller!3");
