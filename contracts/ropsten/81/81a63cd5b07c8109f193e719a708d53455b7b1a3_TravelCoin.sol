...
contract TravelCoin is StandardToken { 
    ...
    */
    ...
    function TravelCoin() {
        ...
        name = "TravelCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-016";                                             // Set the symbol for display purposes (CHANGE THIS)
