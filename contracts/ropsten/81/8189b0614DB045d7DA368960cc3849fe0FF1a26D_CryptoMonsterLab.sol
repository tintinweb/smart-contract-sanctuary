...
contract CryptoMonsterLab is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public constant PRESALE_TOKEN_PRICE = 80000000000000000; // 0.08 ETH
    uint256 public constant MAX_TOKENS_PURCHASE_PRESALE = 2;
    bool public presaleIsActive = false;
    mapping (address => bool) public presaleWhitelist;

    // DISCORD PRESALE
    uint256 public constant DISCORD_PRESALE_TOKEN_PRICE = 66600000000000000; // 0.0666 ETH
    uint256 public constant MAX_TOKENS_PURCHASE_DISCORD_PRESALE = 5;
    uint256 public constant MAX_DISCORD_PRESALE_TOKENS = 3000;
    ...
    // BAYC PRESALE
    // Mainnet BAYC contract - 0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D
    // localhost BAYC - 0x5FbDB2315678afecb367f032d93F642f64180aa3
    // ropsten BAYC - 0xA0a62B858C559e56d8eB7be600EeF42BcE5D0d20
    BoredApeYachtClub private bayc = BoredApeYachtClub(0xA0a62B858C559e56d8eB7be600EeF42BcE5D0d20);
    // Mainnet MAYC contract -https://etherscan.io/address/0x60E4d786628Fea6478F785A6d7e704777c86a7c6
    // localhost MAYC - use BAYC
    BoredApeYachtClub private mayc = BoredApeYachtClub(0xA0a62B858C559e56d8eB7be600EeF42BcE5D0d20);
    uint256 public constant MAX_BAYC_TOKENS = 2000;
    uint256 public constant MAX_TOKENS_PURCHASE_BAYC = 2;
    ...
    // Live
    // https://etherscan.io/address/0x97CA7FE0b0288f5EB85F386FeD876618FB9b8Ab8
    // CollectionContract private ethercards = CollectionContract(0x97CA7FE0b0288f5EB85F386FeD876618FB9b8Ab8);
    // https://etherscan.io/address/0xfd3fd9b793bAc60e7F0a9b9fB759DB3e250383cB
    // CollectionContract private ethereans = CollectionContract(0xfd3fd9b793bAc60e7F0a9b9fB759DB3e250383cB);
    // https://etherscan.io/address/0x18Df6C571F6fE9283B87f910E41dc5c8b77b7da5
    // CollectionContract private animetas = CollectionContract(0x18Df6C571F6fE9283B87f910E41dc5c8b77b7da5);
    // https://etherscan.io/address/0x85f740958906b317de6ed79663012859067E745B
    // CollectionContract private wickedCraniums = CollectionContract(0x85f740958906b317de6ed79663012859067E745B);
    // https://etherscan.io/address/0x6fC355D4e0EE44b292E50878F49798ff755A5bbC
    // CollectionContract private deadheads = CollectionContract(0x6fC355D4e0EE44b292E50878F49798ff755A5bbC);

    // test
    CollectionContract private ethercards = CollectionContract(0xA0a62B858C559e56d8eB7be600EeF42BcE5D0d20);
    CollectionContract private ethereans = CollectionContract(0xA0a62B858C559e56d8eB7be600EeF42BcE5D0d20);
    CollectionContract private animetas = CollectionContract(0xA0a62B858C559e56d8eB7be600EeF42BcE5D0d20);
    CollectionContract private wickedCraniums = CollectionContract(0xA0a62B858C559e56d8eB7be600EeF42BcE5D0d20);
    CollectionContract private deadheads = CollectionContract(0xA0a62B858C559e56d8eB7be600EeF42BcE5D0d20);
    ...
    function mintCryptoMonster(uint256 numberOfTokens) external payable {
    ...
    function checkDiscordPresaleWalletStatus(address _owner) external view returns (bool) {
        return discordPresaleWalletsMinted[_owner];
    }
    ...
    function mintDiscordPresaleToken(uint256 numberOfTokens) external payable nonReentrant{
	    ...
	    require(numTokensMinted + numberOfTokens <= MAX_TOKENS, "Not enough tokens left to mint that many");
	    require(discordPresaleNumTokensMinted + numberOfTokens <= MAX_DISCORD_PRESALE_TOKENS, "BAYC Presale is over");
    ...
    function checkBAYCWalletStatus(address _owner) external view returns (bool) {
        return baycWalletsMinted[_owner];
    }

    function numberBAYCOwned() external view returns (uint256) {
        return bayc.balanceOf(msg.sender);
    }

    // need to check MAX_TOKENS minted and MAX_BAYC_TOKENS  iminted
    ...
    // EtherCards, Ethereans, Animeta Premint
    // EtherCards private ethercards = EtherCards(0x97CA7FE0b0288f5EB85F386FeD876618FB9b8Ab8);
    // uint256 public constant MAX_COLLECTION_PRESALE_TOKENS = 1000;
    // uint256 public constant MAX_TOKENS_PURCHASE_COLLECTION_PRESALE = 2;
    // uint256 public collectionPresaleNumTokenMinted = 0;
    // bool public collectionPresaleIsActive = false;
    ...
    function checkCollectionWalletStatus(address _owner) external view returns (bool) {
        return baycWalletsMinted[_owner];
    }
