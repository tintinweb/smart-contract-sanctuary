...
contract HyunCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HyunCoin() {
        ...
        name = "HyunCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 10;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HYCN";                                             // Set the symbol for display purposes (CHANGE THIS)
