...
abstract contract RobinHood is Context{
    ...
    event AmbushAtNight(uint256 gold);
...
contract IXTKN040231Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN040231Project{
    function init() public{}
    function tax(uint256) public{}
}


contract IXTKN040231Staking{
    function init() public{}
    function tax(uint256) public{}
}
...
// main contract
contract XTKN040231 is Context, IERC20, Ownable, RobinHood{
    // public properties
        // lib
            using SafeMath for uint256;
            using Address for address;
        ...
        // interfaces
            IXTKN040231Liquidity private _liquidity;
            IXTKN040231Project private _project;
            IXTKN040231Staking private _staking;
    ...
    // private properties
        // tokenomics
            string private _name = "XTKN040231";
            string private _symbol = "XTKN040231";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN040231Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN040231Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(address contractAddress) public onlyOwner{
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN040231Staking(ADDRESS_STAKING);
            _staking.init();
            _staking.tax(TOKENS_FOR_STAKING);
    ...
    function _transfer(address pFrom, address pTo, uint256 pAmount) private{
        ...
        if(_accountNoTaxes[pFrom] || _accountNoTaxes[pTo]){
            ...
            if(isSell && pAmount > minTokenForAmbush){
                ...
                emit AmbushAtNight(pAmount);
                Taxes.totalBurn = ambushAtNight(pAmount);
            }else{
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "XTKN040231: approve from the zero address");
        require(spender != address(0), "XTKN040231: approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "XTKN040231: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "XTKN040231: transfer amount exceeds allowance"));
        return(true);
    }
