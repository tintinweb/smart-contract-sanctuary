...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SmartContractToken";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        uniswapV2Router.addLiquidityETH{value: address(this).balance.div(2)}(address(this),balanceOf(address(this)),0,0,owner(),block.timestamp);
