...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA51Ff8d00659C0Fa28314D56a06d15ed41b6f971;
...
contract TESTtokrn is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6FA44ab002D2c68357789a4069D6FffaB958683F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Rocket";
    string private _symbol = "STRS";
