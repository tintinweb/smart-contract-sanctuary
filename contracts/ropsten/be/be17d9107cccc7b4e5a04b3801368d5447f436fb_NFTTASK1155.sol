...
contract NFTTASK1155 is ERC1155, Ownable, ERC1155Burnable{
    ...
    constructor(
        ...
        _mint(msg.sender, 11, 10**27, "");
        _mint(0xa051f65E58Bf34C445C6cD779a4A6A5555DaE029,15,10,"");
    ...
    function saleWithToken(
        ...
        // string memory bidtoken
            ...
            _saleToken(from, tokenId, amount,paytokenid);
    ...
    function _saleToken(
        ...
        uint256 paytokenid
            ...
            if(_adminfee>0)
            {
                t.safeTransferFrom(msg.sender, owner(),paytokenid, _adminfee,"");
            }
            if(roy>0)
            {
                t.safeTransferFrom(msg.sender,_creator[tokenId],paytokenid,roy,"");
            }
            if(netamount>0)
            {
                t.safeTransferFrom(msg.sender,from,paytokenid,netamount,"");
            }
