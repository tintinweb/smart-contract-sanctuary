...
contract test17 is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "test17";
    string private constant _symbol = "test17";
    ...
    constructor() {
        ...
        devAddress = payable(0x3142872D7EBFc5b889E391C1385D65283f85A395);
        marketingAddress = payable(0x0F769546cd7F84F8E57A4ABD724B51e8a4e66499);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
			require(amount <= 250000000000001 * 10**9, "Limits are in place, please lower buying amount");
		}
