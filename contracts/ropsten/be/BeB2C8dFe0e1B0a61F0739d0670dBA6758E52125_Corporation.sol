...
contract Corporation {
    ...
    function uncheckedMint(
        ...
        return _series.restricted.mint(_who, _data);
    }
...
// superuser override).
contract RestrictedStockSeries is ERC721 {
    bool initialized;
    Corporation corp;
    ...
    mapping(uint256 => RestrictedStockUnit) private rsus;
