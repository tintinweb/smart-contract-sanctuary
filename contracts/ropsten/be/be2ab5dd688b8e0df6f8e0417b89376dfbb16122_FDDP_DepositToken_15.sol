...
contract FDDP_DepositToken_15 {
    ...
    function buy() public payable {
        ...
        _money = _money.add(msg.value.mul(925).div(1000));
        
        // отправить прибыль на контракт собствеников системы
        theStocksTokenContract.call.value(msg.value.mul(75).div(1000)).gas(53000)(); // 2.5% commision system
        ...
        emit FullEventLog("buy", _sellprice, _sellprice.mul(100).div(85), now, _value, msg.value);
    ...
    function sell (uint256 countTokens) public {
        ...
        emit FullEventLog("sell", _sellprice, _sellprice.mul(100).div(85), now, countTokens, _value);
