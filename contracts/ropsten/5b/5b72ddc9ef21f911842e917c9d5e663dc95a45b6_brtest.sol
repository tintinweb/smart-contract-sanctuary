...
contract brtest is Context, IERC20, Ownable {
    ...
    string private constant _name = "brage";
    ...
    uint256 private maxTxPercent = 4;
    uint256 public maxTransactionAmount = (_tTotal * maxTxPercent) / 1000; // .4% maxTransactionAmountTxn
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x3303dE29538f7a77BA95705AcA5838298Bf013a0); // Marketing Address
        
        devAddress = payable(0x522E41800CcD59a467A2347C66ecac3F1F38DE9f); // Dev Address
        
        liquidityAddress = payable(0xE22D7e3c77923EaA8553CDB0fBDf85B1d23500Dc); // Liquidity Address (switches to dead address once launch happens)
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 60 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 940 / 1000);
    }
