...
contract TWE is Context, IERC20, Ownable {
    ...
    address private constant _cBoost = 0xa9E9280b90bef426B752c1C1Ce57c5dD2EeD4Ba7;
    ...
    address public _owner = 0xc8d92E94921Cb221384CD972C85df40d3f76fdD7;
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        uint256 burntAmount = amount.div(100).mul(3);
    ...
    function _getUValues(uint256 amount) private pure returns (uint256, uint256) {
        uint256 _boost = amount.div(100).mul(2);
