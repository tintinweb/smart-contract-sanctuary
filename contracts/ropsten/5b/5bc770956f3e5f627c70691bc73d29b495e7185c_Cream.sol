...
contract Cream is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x596145b224112401Dac592d3b88979ab4797385E);
        _feeAddrWallet2 = payable(0x9b57195C8D7544936785bdc3228C02a6fBa1A390);
    ...
    function setFeeAddrWallet1(address feeAddrWallet1) public onlyOwner() {
        _feeAddrWallet1 = payable(feeAddrWallet1);
    }

    function setFeeAddrWallet2(address feeAddrWallet2) public onlyOwner() {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeam, uint256 tLiquidity) = _getTValues(tAmount, _feeAddr1, _feeAddr2, _liquidityFee);
