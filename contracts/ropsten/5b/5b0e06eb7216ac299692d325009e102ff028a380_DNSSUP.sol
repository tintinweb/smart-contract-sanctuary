...
contract DNSSUP is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DNSSUP() {
        ...
        name = "DNSSUP TOKEN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DNSSUP";                                             // Set the symbol for display purposes (CHANGE THIS)
