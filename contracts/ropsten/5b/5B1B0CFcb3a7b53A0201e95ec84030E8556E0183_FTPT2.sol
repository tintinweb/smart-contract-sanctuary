...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x83Dad3A6D9347338D915F214e8aDA590266e0fCa), 5000);
        m_DidDeploy = true;
    }
...
contract FTPT2 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "FTPT2";
    string private m_Symbol = "FTPT3";
