...
contract WSTA is Context, ERC20Detailed, ERC20Mintable, ERC20Burnable
{
    ...
    constructor()
        public
        ERC20Detailed("Wrapped STA", "WSTA", 18)
    { 
        STA = ERC20Mintable(0xdBA49cEFA5210cD248bb718fB0E7Ebf5ADA20e9e);
    ...
    function unwrap(uint _amount)
        public
    {
        uint balanceBefore = STA.balanceOf(msg.sender);
        STA.transfer(msg.sender, _amount);
        uint realAmount = STA.balanceOf(msg.sender).sub(balanceBefore);
