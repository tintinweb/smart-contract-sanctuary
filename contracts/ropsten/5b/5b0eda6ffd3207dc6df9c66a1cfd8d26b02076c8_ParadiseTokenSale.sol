...
contract ParadiseTokenSale is Pausable {
    ...
    uint public fundingGoal = 500 ether;   // Base on 680$ per ether
    ...
    uint public startTime = 1526056311;  //Fri, 11 May 2018 18:31:51 UTC+0200 (CEST)
    uint public endTime;
    ...
    uint public constant HIGH_RANGE_RATE = 30000;   // 100% bonus for 2 weeks
