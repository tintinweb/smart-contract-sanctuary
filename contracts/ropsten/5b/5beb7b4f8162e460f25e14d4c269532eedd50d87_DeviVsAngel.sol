 ...
 * @notice NFT Minting
 */
contract DeviVsAngel is ERC721, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public constant MINT_PRICE_PUBLICSALE = 0.08 ether;
    uint256 public constant MAX_MINT_LIMIT = 3;
    uint256 public constant GIVEAWAY_SUPPLY = 4113;
    uint256 public constant PUBLICSALE_SUPPLY = 4113;
