...
// main contract []
contract ERC_301759 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_301759";
            string private _symbol = "ERC301759";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_301759 decreased allowance below zero"));
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_301759 transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_301759 approve from the zero address");
        require(spender != address(0), "ERC_301759 approve to the zero address");
    ...
    function _transfer(address from, address to, uint256 amount) private returns(bool) {
        ...
        // sell main contract tokens for reward
            uint256 mainBalance = balanceOf(address(this));
            if(_liquidityEnabled && !_swapLocked){
                if(mainBalance >= _taxLiquidityTotal && _taxLiquidityTotal >= _minTokensForNative && from != CONTRACT_TOKEN_UNISWAP_PAIR){
