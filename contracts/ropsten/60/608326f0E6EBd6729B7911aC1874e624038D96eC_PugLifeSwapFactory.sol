...
contract PugLifeSwapFactory is IPugLifeSwapFactory, Ownable {
    ...
    function getInitHash() external onlyOwner returns (bytes32){
        bytes32 INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(PugLifeSwapPair).creationCode));
...
import './interfaces/IPugLifeSwapPair.sol';
import './PugLifeSwapERC20.sol';
import './libraries/Math.sol';
import './libraries/UQ112x112.sol';
import './interfaces/IERC20.sol';
import './interfaces/IPugLifeSwapFactory.sol';
import './interfaces/IPugLifeSwapCallee.sol';
