...
contract IXTKN161138PreSaleVault{
...
*/
contract XTKN161138PreSale is Context, Ownable, Native, ReentrancyGuard{
    // lib
    ...
    // instance
        ...
        IXTKN161138PreSaleVault private _vault; // interface for investor vault
    ...
    function init(uint256 pEnd, address pVault) public onlyOwner{
        ...
        _vault = IXTKN161138PreSaleVault(ADDRESS_VAULT);
        _vault.init();
    }
    ...
    function buy(uint256 pTokens) public{
        ...
        require(!PRESALE_ENDED, "[xtkn161138 error][presale] has ended sorry!");
        require(PRESALE_ENABLED, "[xtkn161138 error][presale] not enabled yet!");
        ...
        require(allowance >= price, "[xtkn161138 error][presale] you have to authorize the transfer of your USDC first!");
        require(balance >= price, "[xtkn161138 error][presale] you do not have enough USDC!");

        // check if user can still buy the tokens
        require(_available(pTokens), "[xtkn161138 error][presale] no more of these pots available!");
        require(!_bought(_msgSender(), pTokens), "[xtkn161138 error][presale] you can only buy one of this pot, buy another pot!");
        require(_buy(_msgSender(), pTokens, price), "[xtkn161138 error][presale] could not buy the pot!");
