...
contract BLUTEST is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "BLUTEST";
    string private m_Symbol = "BLUTE";
    uint8 private m_Decimals = 9;
    // EXCHANGES
    address private m_UniswapV2Pair;
    IUniswapV2Router02 private m_UniswapV2Router;
    // TRANSACTIONS
    uint256 private m_WalletLimit = TOTAL_SUPPLY.div(4);
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 20000, 20000, m_ILOPublic);
        initTax();
