...
contract GameTokenSafe is TokenSafe {
    ...
    public
  {
    ...
    init(
      0, // Group Id
      1532307600 // Release date = 23 Jul 2018 01:00 UTC
    );
    add(
      0, // Group Id
      0x2604Ad5B73C179479961c36fE19872afc9B1C975, // Token Safe Entry Address
      300000000000000000000  // Allocated tokens
    );
  }
}
...
contract GameTokenFundraiser is MintableTokenFundraiser, PresaleFundraiser, IndividualCapsFundraiser, CappedFundraiser, RefundableFundraiser, WhitelistFundraiser, GasPriceLimitFundraiser {
    ...
    public
  {
    ...
    initializeBasicFundraiser(
      1532308200, // Start date = 23 Jul 2018 01:10 UTC
      1535765400,  // End date = 01 Sep 2018 01:30 UTC
      1, // Conversion rate = 1 GT per 1 ether
      0x2604Ad5B73C179479961c36fE19872afc9B1C975     // Beneficiary
    );

    initializeIndividualCapsFundraiser(
      (0.1 ether), // Minimum contribution
      (1 ether)  // Maximum individual cap
    );
