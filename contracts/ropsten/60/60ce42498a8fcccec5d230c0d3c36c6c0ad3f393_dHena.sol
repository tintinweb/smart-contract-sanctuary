...
contract MilestoneLockToken is StandardToken, Ownable {
    ...
    /**
     * @dev Distribute the amount of tokens to from owner&#39;s balance with the milestone policy to a policy-free user.
     * @param _to The address to transfer to.
     * @param _value The amount to be transferred.
    ...
    /**
     * @dev set account&#39;s milestone policy.
     * @param _policy number of milestone for LockedBalance applied.
    ...
    */
     ...
     * @param _account address for applied milestone policy remove.
     */
