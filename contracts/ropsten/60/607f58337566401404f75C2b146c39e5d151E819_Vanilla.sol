...
contract Vanilla is Context, IERC20, Ownable {
    ...
    uint256 public SELLFEEDENOM = 100;
    uint256 public constant DENOMINATOR = 10000;

    address public marketingWallet = 0xc762879Edd0a994e349F475E99Efe0C2cfc0fb32;
    ...
    uint256 public _maxTxAmount = 3 * 10 ** 3 * 10 ** uint256(_decimals);
    uint256 private _numTokensSellToAddToLiquidity = 3 * 10 ** 3 * 10 ** uint256(_decimals);
...
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // testnet PCS V2
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // testnet ropsten
...
//        _isExcludedFromFee[0xD99D1c33F9fC3444f8101754aBC46c52416550D1] = true; //testnet
        _isExcludedFromFee[0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D] = true; //ropsten
