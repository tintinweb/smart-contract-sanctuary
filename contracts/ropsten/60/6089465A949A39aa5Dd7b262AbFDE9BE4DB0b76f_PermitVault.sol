...
abstract contract Permit721 is Ownable, EIP712WithNonce {
    bytes32 private immutable _PERMIT721_TYPEHASH =
        keccak256(
            "Permit721(address registry,uint256 tokenid,address to,uint256 platformFee,uint256 ownerFee,uint256 nonce,uint256 deadline,address relayer)"
        );
    ...
    function transfer721WithSign(
        ...
        // Valid if the signature was signed for gotcha address
        require(
