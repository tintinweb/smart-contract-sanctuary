...
contract Crazyboop is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint public max_mint_allowed = 25;
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("Crazy Boop", "CBC") PaymentSplitter(_team, _teamShares) {
