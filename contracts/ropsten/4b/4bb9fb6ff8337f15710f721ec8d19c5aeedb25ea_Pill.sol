...
contract Pill is IBEP20, Auth, IERC721Receiver {
    ...
    constructor (
        ...
        approve(_uniswapRouter, _totalSupply);
    ...
    function setPositionManager(INonfungiblePositionManager _nonfungiblePositionManager) external onlyOwner {
      nonfungiblePositionManager = _nonfungiblePositionManager;
      _allowances[address(this)][address(_nonfungiblePositionManager)] = _totalSupply;
    }
        ...
        if(amountToLiquify > 0){
            INonfungiblePositionManager.IncreaseLiquidityParams memory params =
              INonfungiblePositionManager.IncreaseLiquidityParams({
                  tokenId: tokenId,
                  amount0Desired: amountBNBLiquidity,
                  amount1Desired: amountToLiquify,
                  amount0Min: 0,
                  amount1Min: 0,
