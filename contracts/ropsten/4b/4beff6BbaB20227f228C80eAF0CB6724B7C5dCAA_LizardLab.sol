...
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
 ...
 contract LizardLab is ERC721, Ownable {
    ...
    address redLizard = 0x1d4649d324852689cE69D09c3401f63f4b1b1C5e;
    address blueLizard = 0x87E9Ab2D6f4f744f36aad379f0157da30d3E2670;
    address greenLizard = 0xc3bE75aF49A71bd36B08C513cc4520b5E5290928;
    ...
    function claim() public {
        uint256 supply = totalSupply;
        require(presaleActive,                              "Presale period must be active to claim");
        require(claimWhitelist[msg.sender],                 "No claim available for this address");
        require(supply.add(1) <= maxSupply,                 "Claim would exceed max supply of tokens");
    ...
    //..and now for the rest of you
    function mintBeano(uint256 numberOfMints) public payable {
        uint256 supply = totalSupply;
