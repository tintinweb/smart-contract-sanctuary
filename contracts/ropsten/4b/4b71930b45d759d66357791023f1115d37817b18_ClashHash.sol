...
/*
* @author Hamdi Allam <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e88089858c81c68984848985d1dfa88f85898184c68b8785">[email&#160;protected]</a>
...
contract ClashHash is Ownable {
    ...
    function tempSetWinner(uint256 blockNumber, address winOption) public onlyOwner {
        Round storage round = rounds[blockNumber];
        require(block.number <= blockNumber - MIN_BLOCKS_BEFORE_ROUND, "Please wait a little bit");
        require(block.number >= blockNumber + MAX_BLOCKS_AFTER_ROUND, "It&#39;s too late, absolutely");
