...
contract ADIGATokenI2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "ADIGA Inu2";
    string private constant _symbol = "ADIGAI2";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x8bF616d416a9d9A37D3364C6892eEeCC3de626B7); // Marketing Address
        
        devAddress = payable(0x8bF616d416a9d9A37D3364C6892eEeCC3de626B7); // Dev Address
