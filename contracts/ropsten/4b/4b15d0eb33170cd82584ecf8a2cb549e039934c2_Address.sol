...
contract EUp is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xAdc830529Fc188Bb9341167b08dDc70a2C92dAa3); // Marketing Address
    ...
    uint256 public _maxWallet = _tTotal.div(10**2).mul(2); // 2% of total supply 
