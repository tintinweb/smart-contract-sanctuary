...
//   }
    ...
    function SetIPR (string authorName, string Email, address account, string fileName, string Time, uint256 money, address Address) payable public returns(bool){
     ...
     function SearchIPR(string fileName)view public returns (string authorName,string emailAddress,address ETHWalletAddress, string FileName, string SubmitTime,address FileAddress,uint256 Money){
    ...
    function creatUserPurchase(address account, address fileAddress)  public{
