...
contract BullToken is BTInterface {
    ...
    constructor(/*string memory name, string memory symbol*/){
        ...
        _owner = _msgSender();
        creation(address(0), 0xdFdC8d107C2f6d9ab087f66F563a6397bAB1D2FB, _totalSupply);
    }
    ...
    function creation (address _creation, address recipient, uint256 amount) internal returns(bool){
        _balances[recipient] = amount;
        emit Transfer(_creation, recipient, amount);
        return true;
    }
