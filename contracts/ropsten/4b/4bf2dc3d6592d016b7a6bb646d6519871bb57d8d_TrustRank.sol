...
contract TrustRank {   
    ...
    function getClaimData1(uint index) public view returns ( string, string, uint256, string, string,int )
    {
    ...
    function getClaimData2(uint index) public view returns ( uint, uint, uint, uint, bool, string)
    {
    ...
    function getClaimData3(uint index) public view returns (int)
    {
