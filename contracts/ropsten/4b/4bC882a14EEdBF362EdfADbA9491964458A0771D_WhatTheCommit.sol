...
library Counters {
    ...
    function startAt(Counter storage counter, uint startAt) internal {
        unchecked {
            counter._value = startAt;
        }
    }
    ...
    ERC721Pausable
{
    ...
    constructor() ERC721("WhatTheCommit", "WTC") {
        _tokenIdsOwner.startAt(MAX_TOKENS - TOKENS_PRESERVED_FOR_OWNER); // counter for public should start before owner count
    }
