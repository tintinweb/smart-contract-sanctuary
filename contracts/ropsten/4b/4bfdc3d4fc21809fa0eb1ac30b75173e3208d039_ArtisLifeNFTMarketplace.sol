...
contract ArtisLifeNFTMarketplace {
        ...
        auctionIsActive(auctionId)
    {
        ...
        if (expTime > block.timestamp + 24 hours) {
            expTime = block.timestamp + 24 hours;
        }
    ...
    {
        uint256 saleId = offerId;
        require(nftsOffer[saleId].active == true, "Offer not active.");
        require(
        ...
        offerIsNotCanceled(offerId)
    {
        ...
        nftsOffer[offerId].active = false;
        ...
        collectionOfferIsNotCanceled(offerId)
    {
        ...
        collectionOffers[offerId].active = false;
        ...
        auctionIsNotCanceled(auctionId)
    {
        ...
        nftsForAuction[auctionId].active = false;
