...
contract KwikSilverCoin is ERC20Interface {
    ...
    address myAddress = 0x671446f120539cBBa92655082c881f18BF334001;
    ...
    constructor() public {
        ...
        inputs[myAddress][block.number/blockGroupSize] = _totalSupply;
        emit Transfer(address(0), myAddress, _totalSupply);
    }

    // The implementation for these ERC-20 standard functions was borrowed from ConsenSys:
