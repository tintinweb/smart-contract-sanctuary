...
contract RNBBridgeProxyE {
    ...
    uint256 lockFee=0;
    uint256 unlockFee=0;
    event ethReceived(address requestor, bytes32 bridgeHash, uint256 value);
    ...
    function EthToBsc (string memory salt,uint256 amount) public
    {
        ...
        emit ethReceived(msg.sender,newBridgeHash,amountMinusFees);
