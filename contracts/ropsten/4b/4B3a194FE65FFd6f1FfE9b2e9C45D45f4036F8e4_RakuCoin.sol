...
pragma solidity ^0.6.12;
    ...
    contract RakuCoin is Context, IERC20, Ownable {
        ...
        string private _name = 'Raku Coin test';
        string private _symbol = 'RAKUCT';
        ...
        uint256 public walletlimit = 5000000000 * 10**9;
        uint256 private _maxTxAmount = 2500000000 * 10**9;
        // We will set a minimum amount of tokens to be swaped => 500K
        uint256 private _numOfTokensToExchangeForMarketingPool = 500000 * 10**9;
        ...
        constructor (address payable MarketingPoolWalletAddress,address payable StakePoolWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // PancakeV2 for BSC network
    ...
    // List of front-runner & sniper bots from t.me/FairLaunchCalls
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            uint256 stakefreeamount = 0;
            if(sender != owner() && recipient != owner() && !_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient]) {
            
            stakefreeamount = amount.mul(_staketaxFee).div(10**2);
            transfer(_StakePoolWalletAddress,stakefreeamount);

             }
            uint256 samount = amount.sub(stakefreeamount);
            
            if(sender != owner() && recipient != owner() && recipient != uniswapV2Pair && recipient != address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) 
            ...
            _tokenTransfer(sender,recipient,samount,takeFee);
        }
        ...
        function _setStakeFee(uint256 stakeFee) external onlyOwner() {
            require(stakeFee >= 0 && stakeFee <= 11, 'stakeFee should be in 0 - 11');
