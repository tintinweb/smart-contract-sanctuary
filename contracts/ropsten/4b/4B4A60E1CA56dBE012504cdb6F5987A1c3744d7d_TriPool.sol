...
contract TriPool is PoolBaseERC20{

    constructor() public PoolBaseERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48) {
        name = "3";
        crv_pool_addr = address(0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7);
        lp_token_addr = address(0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490);
        crv_gauge_addr = address(0xbFcF63294aD7105dEa65aA58F8AE5BE2D9d0952A);
    }
    ...
    function deposit_to_pool(uint256 _amount) internal {
        ...
        AgentInterface(agent_addr).exec(
            crv_pool_addr, 
            abi.encodeWithSignature("add_liquidity(uint256[3],uint256)", uamounts, 0)
        );
    }
    ...
    function withdraw_from_pool(uint256 _amount) internal {
        ...
        AgentInterface(agent_addr).exec(
            crv_pool_addr, 
            abi.encodeWithSignature("remove_liquidity_one_coin(uint256,int128,uint256)", _amount, 1, 0)
        );
    }
    ...
    function get_virtual_price() public view returns(uint256) {
        return PriceERC20Interface(crv_pool_addr).get_virtual_price();
    }
}