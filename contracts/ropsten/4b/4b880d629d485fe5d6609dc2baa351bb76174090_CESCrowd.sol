...
contract CESCrowd is DSAuth, DSMath {
    ...
    uint public pieceSupply;     // total piece of the sell token
    uint public pieceSell;       // how much piece was sold
    uint public pieceGoalReached;// how much piece must to be sold
    uint public gotETH;          // how much ETH was got by crowdsale
    uint public leftETH;         // how much ETH is left
