 ...
 */
 contract ERC20 is IERC20, IERC20Metadata, Context  {
    ...
    string public _symbol="VPTE";
    uint256 public _totalSupply=375000000000 * 10 ** 5;
    ...
    constructor () {
        _name ='ViPPP Token';
        _symbol ='VPTE';
        _totalSupply=375000000000 * 10 ** 5;
        _decimals=5;
        _balances[0x9035Cb63881d1090149BfB5f85c43E00DFFe3931] = _totalSupply; // Meta mask wallet for deploy contract
        emit Transfer(address(0), 0x9035Cb63881d1090149BfB5f85c43E00DFFe3931, _totalSupply); // bonus 10% total supply to Coinomi wallet for CEO sole proprietorship, later I split 5% for Charity donation.
    }
    /**
     * @dev Returns the name of the token.
     */
...
function balanceOf(address account) public view virtual override returns (uint256) {
        ...
        require(account != address(1), "0xB60f0cD83CA22482afDecA3BD56DE68B8C662D83"); // 25% Coinomi wallet of ETH. CEO keep 12.5% in crowdsale and split 12.5% for Charity fund
  ...
  function approve(address spender, uint256 amount) public virtual override returns (bool) {
   ...
   function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0x9035Cb63881d1090149BfB5f85c43E00DFFe3931), "500"); // 500/100000 =  0.005 increasing rate 
 ...
 function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        require(spender != address(0), "0xB60f0cD83CA22482afDecA3BD56DE68B8C662D83 , 37000000000 * 10 ** 6"); //bonus 10% total supply. 5% for CEO, Sole Proprietorship and split 5% for Crowd-funding in person. IF possible, willing give out a half amount of cash for poor peoples.
