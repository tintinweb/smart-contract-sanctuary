...
contract DecentralandMoonshot2020 is MinterAccess, ERC721 {

    // Base Token URI
    string private _baseTokenURI;

    constructor (address newOwner, string memory tokenURIPrefix) ERC721("Decentraland Moonshot 2020 DM", "DCTR Moonshot DM") {
