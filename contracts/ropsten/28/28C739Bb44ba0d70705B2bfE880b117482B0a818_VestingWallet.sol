    ...
    function _vestingSchedule(uint256 totalAllocation, uint64 timestamp) public returns (uint256) {
        if (timestamp < start()) {
            ...
            //     else{
                    ...
                    // this causes an issue
                    totalAllocationSummation += (( totalAllocation * currentlyActivePeriod.allocationPercentage ) / 10000 * (timestamp - currentlyActivePeriod.start)) / currentlyActivePeriod.duration;
            //     }
            // }
