...
contract Lottery is Ownable {
    ...
    event NewEntry(uint256 lotteryId,
    ...
    function _emitInfoEvent() internal {
        ...
        uint256 _lotteryId = lotteryId;
        uint256 _endingTimeStamp = endingTimeStamp;
        STATE _currentState = currentState;
        uint256 _balanceOfPrizePool = balanceOfPrizePool;
        emit NewEntry(_lotteryId, _endingTimeStamp, _currentState, _candsOfWin, _putIns, _timestamps, _willWins, _balanceOfPrizePool);
    }
