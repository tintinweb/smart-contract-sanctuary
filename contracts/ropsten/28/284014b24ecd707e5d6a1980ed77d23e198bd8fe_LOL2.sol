...
contract LOL2 is SafeMath {

    string public name = "LOL2";        //  token name
    string public symbol = "LOL2";      //  token symbol
    ...
    // 结束时间 2018-07-15 12:00:00
    uint public closeTime = 1531656000;
    // 价格
    uint public price = 100000000000000;

    // 私募和ICO解锁时间 2018-07-15 00:00:00
    uint public unlockTime = 1531656000;

    // 团队解锁时间 2019-01-10 00:00:00
    uint public unlockTeamTime = 1547049600;

	// 团队解锁时间 2019-01-10 00:00:00
    uint public unlockDevTime = 1531656000;
	
	// 团队解锁时间 2019-01-10 00:00:00
    uint public unlockBountyTime = 1531656000;
