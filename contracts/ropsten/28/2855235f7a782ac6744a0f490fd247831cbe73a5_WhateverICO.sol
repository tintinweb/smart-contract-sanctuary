...
/**
 * @title Token
 * @dev API interface for interacting with the Whatever Token contract 
 */
interface Token {
...
/**
 * @title WhateverICO
 * @dev WhateverICO contract is Ownable
 **/
contract WhateverICO is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public constant RATE = 5672120; // Number of tokens per Ether
  uint256 public constant CAP = 4000; // Cap in Ether
  uint256 public constant START = 1620032400; // May 29, 2021 @ 9PM EST
  uint256 public constant DAYS = 2; //  Days
  
  uint256 public constant initialTokens = 20000000000 * 10**18; // Initial number of tokens available
  ...
  /**
   * WhateverICO
   * @dev WhateverICO constructor
   **/
  function WhateverICO(address _tokenAddr) public {
