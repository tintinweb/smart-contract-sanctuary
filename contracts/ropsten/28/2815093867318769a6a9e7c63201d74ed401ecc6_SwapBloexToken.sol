...
contract SwapBloexToken is ERC20, ERC20Detailed {
    ...
    address constant public bt = address(0x31Aa941848ae571509e880075230A21109dD8f67);        //Bloex Token (BT) Ropsten 
    ...
    constructor () public ERC20Detailed("BloexSwap", "BTSwap", 18) {
        ...
        governance = 0x59c8F1a700dD17B45287108DDf8D593719c88a43;  //0x1360CFA0606E5b057df468D540fA81F75d8146E3
    }
    ...
    function deposit(uint _amount) public {
        ...
        //pay bt
        btToken.transfer(msg.sender, bt_amount);
        
    }
    
    
    //buy bt with usdt
    function depositBT(uint _amount) public {
        require(isOpenDeposit == 1, "!isOpenDeposit");
        ...
        //pay bt
        btToken.approve(msg.sender,bt_amount);
        btToken.transfer(msg.sender, bt_amount);
