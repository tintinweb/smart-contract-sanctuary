...
contract XYZToken is Context, IBEP20, Ownable {
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    uint256 public DecrementalPrice = 2 wei;
    uint256 public incrementalPrice = 1 wei;
    uint256 public BuyPrice = 1 wei ;
    ...
    view  onlyOwner returns (uint256,uint256,uint256,uint256 )
    {
            return (BuyPrice,SellPrice,DecrementalPrice,incrementalPrice);
  ...
  function transferForBuy() public payable returns (bool) {
        ...
        public
    {
        ...
        uint256 _etron = fulltokensToEtron_(_amountOfTokens);
        ...
        returns(uint256)
    {
        ...
        if(_currentPrice > ((_tokens-1)*_tokenPriceIncremental)){
            ...
            require(false,"Wait For Liquidity");
             ...
             require(a > _tokenPriceIncremental,"Wait For Liquidity Add");
