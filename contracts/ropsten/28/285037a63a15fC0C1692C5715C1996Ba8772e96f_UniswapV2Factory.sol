...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    function test_Require(uint256 _delay) external override
    {
        // uint256 diffTime = block.timestamp - _delay;
        // require(diffTime <= lockTime, 'current time is before release time');
        uint256 a = 1;
        uint256 b = 2;
