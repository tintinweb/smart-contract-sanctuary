...
contract AutoConters {
    ...
    uint public constant ARTIST_PRINTS = 64; // 2 for testing, 64 for prod;

    uint public constant PRICE = 500 finney;

    // The beneficiary is Creator
    address public constant BENEFICIARY = 0x39781F4C1401a09B2a4eFA063b6F1DD732847022;
    ...
    string internal nftName = "AutoConters";
    ...
    function createConters(uint seed) external payable returns (string) {
