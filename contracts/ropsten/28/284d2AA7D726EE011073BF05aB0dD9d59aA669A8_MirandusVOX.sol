    ...
    ReentrancyGuard
{
    ...
    uint256 public numberForSale = 8888;
    bool isPause;
    ...
    function setNumberforSale(uint256 _numberForSale) public onlyOwner {
        numberForSale = _numberForSale;
    }
    ...
    function onERC1155Received(
        ...
        require(tokenId < numberForSale, "!tokenId");
        ...
        if (balance + value == balanceAter) {
            uint256 leftTokenSale = numberForSale - tokenId;
            if (value > leftTokenSale) {
                // _withdrawERC1155(
                //     erc1155Token,
                //     msg.sender,
                //     erc1155TokenId,
    ...
    function onERC1155BatchReceived(
        ...
        if (balance + totalValue == balanceAter) {
            uint256 leftTokenSale = numberForSale - tokenId;
            if (totalValue > leftTokenSale) {
                //   _withdrawERC1155(
                //     erc1155Token,
                //     msg.sender,
                //     erc1155TokenId,
                //     totalValue - leftTokenSale,
                //     data
                // );
                totalValue = leftTokenSale;
            }
