...
contract YoloDice is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    function mintAirdrop(uint256 amount) public onlyOwner {
        ...
        require(currentTotalSupply < AIRDROP_QUANTITY, "Yolo Dice: Max quantity reached");
    ...
    function mintPresale(uint256 amount) public payable {
        ...
        require(presaleTimestamp <= block.timestamp, "Yolo Dice: Pre-sale not started");
        ...
        require(isRegisteredForPresale(msg.sender), "Yolo Dice: Not registered");

        /// @notice Cannot exceed the pre-sale supply.
        require(currentTotalSupply + amount <= AIRDROP_QUANTITY + PRE_SALE_QUANTITY, "Yolo Dice: Not enough left");

        /// @notice Cannot mint more than the max mint per transaction.
        require(amount <= MAX_MINT_AMOUNT, "Yolo Dice: Amount exceeds limit");

        /// @notice Must send the correct amount.
        require(msg.value > 0 && msg.value == amount * PRESALE_PRICE, "Yolo Dice: Price not met");
