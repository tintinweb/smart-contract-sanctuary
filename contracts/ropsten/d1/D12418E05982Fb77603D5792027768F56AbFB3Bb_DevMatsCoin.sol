...
contract DevMatsCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    constructor() {
        ...
        name = "DevMatsCoin";                                        // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DVMC";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 10;                                      // Set the price of your token for the ICO (CHANGE THIS)
        fundsWallet = address(0x1b9e321fc43863DB994ed174B5F071A7E90e662A) ;                                    // The owner of the contract gets ETH
    }
