...
contract ScamFaucet {
	...
	{
	    if (!addressUsed[adr] && (BEP20(ScamToken).balanceOf(adr) == 0))
	    {
	        return true;
	    }
	    else
	...
	function airdrop() public 
    {
        ...
        // No airdrop from this address again, and no airdrop until 2 seconds passed
        addressUsed[msg.sender] = true;
        lockedUntil = lockedUntil.add(2);
