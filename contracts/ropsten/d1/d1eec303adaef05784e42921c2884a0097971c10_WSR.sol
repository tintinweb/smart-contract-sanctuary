...
contract WSR is StandardToken {
    ...
    function WSR (address administrativeAddress) {
    ...
    function giveReward(address awardee) public checkNumberOfDownloaders checkOwner payable {
