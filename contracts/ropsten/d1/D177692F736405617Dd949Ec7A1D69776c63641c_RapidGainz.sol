...
contract RapidGainz is ERC20 {
  ...
  uint256 public maxTransferAmountInPercentage = 1010;
  ...
  function _transfer(address sender, address recipient, uint256 amount) override internal virtual {
    if(isLaunchFinished){
        ...
        require(amount <= maxTransferAsPercentOfSupply, "Cannot transfer more then certain percent of total supply.");
    }
