...
contract SHINU is Context, IERC20, Ownable {
    ...
    string private _charityAddress = "0xc99dA7fC1c2c3BCd46B3469A13bAA373144fFF25";
    ...
    function _takeBurn(uint256 tBurnFee) private view {
        _tBurnTotal.add(tBurnFee);
    }

    function _takeCharity(uint256 tCharity) private {
        _rOwned[_charityWallet] = _rOwned[_charityWallet].add(tCharity);
    }
