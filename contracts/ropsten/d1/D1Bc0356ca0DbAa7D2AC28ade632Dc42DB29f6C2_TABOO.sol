...
contract TABOO is NFTokenMetadata {
 
 
 uint256 _tokenId;
  constructor() {
    nftName = "TABOO Painting";
    nftSymbol = "TABOO";
    _tokenId=1;
  }
 
   function mintNFT (address _to,uint256 no_of_tokens_to_create, string calldata _uri , uint256 _basicprice,string memory _title)  external onlyOwner {
