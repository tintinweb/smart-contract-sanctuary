...
contract Masquerade is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "Ipfs://QmbTfNropCEj2bz2iqHqP4ho6ZPRwPDP2AZnMKtYXwa9zo/";
    }
    ...
    function safeMint(address to) public onlyOwner {
        require(totalSupply() < MAX_SUPPLY, "MAX SUPPLY = 1");
