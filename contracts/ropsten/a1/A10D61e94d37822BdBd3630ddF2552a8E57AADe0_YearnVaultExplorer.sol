...
contract YearnVaultExplorer is Ownable {
    ...
    function exploreByTokenIndex(uint tokenIndex, uint numTokens) public view returns (TokenInfo[] memory tokens, VaultInfo[] memory vaults) {
    ...
    function exploreByTokenAddress(address[] memory inputTokens) public view returns (TokenInfo[] memory tokens, VaultInfo[] memory vaults) {
        IYRegistry registry = resolveYearnRegistry();
    ...
    function resolveVaults(IYRegistry registry, TokenInfo[] memory tokens, uint totalVaults) internal view returns (VaultInfo[] memory vaults) {
