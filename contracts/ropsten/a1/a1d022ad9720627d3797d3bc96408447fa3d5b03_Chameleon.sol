...
contract Chameleon is Context, IERC20, Ownable, LockToken 
{
	...
	uint256 public totalBuyFee = _taxFee.add(_liquidityFee).add(_marketingFee).add(_BuyBackFee); //12% Total Buy Fee
	...
	address payable public BuyBackWallet =  payable(0xcbFA1ce0b8bFb9C09E713162771C31F176fB1ADE);
    ...
    constructor () 
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);  //Prod PCS = 0x10ED43C718714eb63d5aA57B78B54704E256024E  Dev PCS =0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
