...
// File @0xcert/ethereum-erc721/src/contracts/tokens/[email protected]
...
// File @0xcert/ethereum-erc721/src/contracts/utils/[email protected]
  ...
  SupportsInterface
{
   ...
   * @dev Mapping from owner address to mapping of operator addresses.
   */
  mapping (uint256 => bool) public blockedTokenId;
  ...
  )
  {
    address tokenOwner = idToOwner[_tokenId];
    require(
      blockedTokenId[_tokenId] == false , "Token has been blocked/frozen. Contact site administrator"
    );
    _;
  }
  ...
  /**
   *┬á@dev Helper function that gets NFT count of owner. This is needed for overriding in enumerable
...
// File @0xcert/ethereum-erc721/src/contracts/ownership/[email protected]
