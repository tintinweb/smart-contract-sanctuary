...
contract ERC721 is  ERC165, IERC721{
    ...
    function approve(address to, uint256 tokenId) public virtual override{
        ...
        require(msg.sender== owner || isApprovedForAll(owner, msg.sender), "ERC721: Aprove caller is neither owner nor approved for all");
        _approve(to, tokenId);
    }
    ...
    function mint(uint _tokenId, string memory tokenURI_) public {
