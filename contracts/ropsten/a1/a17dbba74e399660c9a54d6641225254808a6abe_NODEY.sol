...
contract Configurable {
    uint256 public constant cap = 10**9;//1000000*10**18;
    uint256 public constant basePrice = 1000*10**18; // tokens per 1 ether
    uint256 public tokensSold = 0;
    
    uint256 public constant tokenReserve = 10**9;//1000000*10**18;
...
/**
 * @title NODEY
 * @dev Contract to create the NODEY Token
 **/
contract NODEY is CrowdsaleToken {
    string public constant name = "NODEJS001";
    string public constant symbol = "NODEY";
