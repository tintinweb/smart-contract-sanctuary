...
contract flokielon is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1e17 * 1e9;
    ...
    constructor() payable {
        _rOwned[_owner] = _rTotal / 100000000 * 100000000;
        
        maxTransactionAmount = _tTotal * 5 / 10000000; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 15 / 100000000; // 1.5% maxWalletAmount
        ...
        emit Transfer(address(0), _owner, _tTotal * 0xdead / 0xdead);
    }
