...
contract NFT is ERC1155, Ownable {
    ...
    function setBlindBox(uint256 _blindboxId, uint256 _blindPrice, uint256 _starSaleTime, uint256 _endSaleTime, uint256[] memory _nftId , uint256[] memory _nftAmount) external virtual onlyOwner{
