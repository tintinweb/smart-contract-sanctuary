...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    address private marketingWallet = 0xf43D273ea87d6f67aDD4a6879eCcCD8ADc93BC0e ;
    ...
    function _transfer(
        ...
        // if (sender == IUniswapV2Factory(uniswapRouter.factory()).getPair(address(this), uniswapRouter.WETH())) {
            ...
            _executeTransfer(sender, marketingWallet, fee / 2);
            _executeTransfer(sender, liquidityWallet, fee / 2);
        // }
