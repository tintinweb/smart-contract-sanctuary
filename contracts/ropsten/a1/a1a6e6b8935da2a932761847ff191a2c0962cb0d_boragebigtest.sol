...
contract boragebigtest is Context, IERC20, Ownable {
    ...
    string private constant _name = "brage brest";
    ...
    uint256 private maxTxPercent = 40;
    uint256 public maxTransactionAmount = (_tTotal * maxTxPercent) / 10000; // 1% maxTransactionAmountTxn
