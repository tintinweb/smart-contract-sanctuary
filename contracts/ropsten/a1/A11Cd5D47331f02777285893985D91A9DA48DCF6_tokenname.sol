...
** Using FTPEthReflect to give 7.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x1011f61Df0E2Ad67e269f4108098c79e71868E00), 7000);
        m_DidDeploy = true;
    }
...
contract tokenname is Context, IERC20, Taxable {
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 7000, m_UniswapV2Pair, _uniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
