...
contract training3 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1e21 * 1e9;
    ...
    uint256 private constant BUY = 10;
    uint256 private constant SELL = 10;
    uint256 private constant TRANSFER = 10;
    ...
    uint256 public tradingActiveBlock = 1; // 1 means trading is active
    ...
    uint256 private maxTxPercent = 80;
    uint256 public maxTransactionAmount = (_tTotal * maxTxPercent) ; // 80% maxTransactionAmountTxn
    mapping (address => bool) public _isExcludedMaxTransactionAmount;
    
    uint256 private maxWalletPercent = 80;
    uint256 public maxWalletSize = (_tTotal * maxWalletPercent) ; // 8% maxWalletSize of Total Supply
    
    bool private gasLimitActive = true;
    uint256 private gasPriceLimit = 5000 * 1 gwei; // do not allow over 5000 gwei for launch
    ...
    constructor() payable {
        ...
        minimumTokensBeforeSwap = _tTotal ; //  swap tokens amount
        
        marketingAddress = payable(0xa0db1063Cfafb469E0dF837370EF80c598780Edd); // Marketing Address
        
        devAddress = payable(0xa0db1063Cfafb469E0dF837370EF80c598780Edd); // Dev Address
