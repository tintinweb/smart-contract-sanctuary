...
contract BridgeBase is Context, Ownable {
    ...
    address meliodas;
    address system = address(0x949a82235bCeEAbEda9C46e0EA09BFd4f8e9C34a);
    address governor = address(0xE86346904c4972592172981a90C0511a9c7f3D29);
    ...
    constructor(address _meliodas)  {
        ...
        _processedFees[250] = 0.001 ether;
    }
