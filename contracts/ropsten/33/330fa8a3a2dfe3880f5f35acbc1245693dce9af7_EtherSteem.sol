...
contract EtherSteem {//is inherently ERC20
    ...
    */
    ...
    string constant public name = "EtherSteem";

    string constant public symbol = "ESTM";
    ...
    function EtherSteem() public {balanceOf[msg.sender] = totalSupply;}
