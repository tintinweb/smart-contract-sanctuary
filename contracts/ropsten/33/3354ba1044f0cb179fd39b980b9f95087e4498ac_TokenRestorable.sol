    ...
    AccessControlUpgradeable
{
    ...
    EnumerableSetUpgradeable.AddressSet internal notTimeLimited;
    bool timeLimited;
    address pair;
    address router;
    uint256 private transferTime;
    ...
    function _setTimeLimited(bool _timeLimited) external onlyManager() {
