...
contract ERC20 is Context, IERC20 {
        ...
        returns (bool)
    {
        ...
        if (
            ...
            !checkWhiteListed(_msgSender())
               ...
               _transfer(_msgSender(), recipient, (amount.div(100)).mul(98));
    ...
    function checkWhiteListed(address _checkAddress)
        public
        view
        returns (bool)
    {
        ...
        for (i = 0; i < whiteListed.length; i++) {
            if (_checkAddress == whiteListed[i]) {
                return true;
            }
        }
        return false;
...
contract OilToken is ERC20 {
    ...
    function setBurnStatus(bool status) public onlyAdmin {
        _burnStatus = status;
    }
