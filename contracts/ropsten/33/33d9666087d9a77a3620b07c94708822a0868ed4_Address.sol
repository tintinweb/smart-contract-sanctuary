...
// File: contracts/BoredApeTestYachtClub.sol
...
/**
 * @title BoredApeTestYachtClub contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract BoredApeTestYachtClub is ERC721, Ownable {
    using SafeMath for uint256;

    string public BATYC_PROVENANCE = "";
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        BATYC_PROVENANCE = provenanceHash;
    }
