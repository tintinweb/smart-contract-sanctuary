...
contract SIMP is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000_000_000_000; //1 Trillion, underscores aid readability
    ...
    string private _name = "TheSimpleToken";
    ...
    uint256 public _marketingFee = 70; // 7%, divisor is 1000
    ...
    address payable private _marketingWallet = payable(0x6abf4969887f783A937226CFD31B9B41756f28fD);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;
    
    // Max TX amount is 0.3% of the total supply.
    uint256 private maxTxPercent = 3; // Less fields to edit
