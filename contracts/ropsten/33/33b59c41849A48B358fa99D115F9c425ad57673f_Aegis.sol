...
/**
 * @title The Aegis BSC token
 * @dev DAO for the Aegis Ecosystem on the Binance Smart Chain.
 *
 *      Each transaction that is not sent from the mapping of nonTaxedAddresses (initially owner and BNB/Aegis PancakeSwap pair also including our stealth launch tokens Aegis/Simba pair)
 *      will be taxed at a rate of 1% paid out in Aegis to the taxReceiveAddress.
 *
 */
...
// File: contracts/Aegis/Aegis.sol


/**
 * @title The Aegis BSC token
 * @dev DAO for the Aegis Ecosystem on the Ethereum Protocol.
 *
 *      Each transaction that is not sent from the mapping of nonTaxedAddresses (initially owner and BNB/Aegis PancakeSwap pair)
 *      will be taxed at a rate of 1% paid out in AEGIS to the taxReceiveAddress.
 *
 */
contract Aegis is Initializable, ContextUpgradeSafe, IERC20, OwnableUpgradeSafe {
