...
interface ISingleRemeption {
    ...
    function incrementRedemptionAmount(address genArtCoreAddress, uint256 tokenId, string  calldata attributes) external;
...
contract SingleRedemptionService {
    ...
    function redeem(address genArtCoreAddress, address singleRedemptionAddress, uint256 tokenId, string memory attributes) public payable  {
        ...
        singleRedeemableProductContract.incrementRedemptionAmount(genArtCoreAddress, tokenId, attributes);
