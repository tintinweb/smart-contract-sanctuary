...
contract Oasis{
	...
	function myshowindex(address user) public view returns(uint totaleths,uint lttime,uint ltmoney,address ltaddr,uint myeths,uint mycans,uint dayuserget,uint dayusereth,uint keyprices,uint mykeynum,uint ltkeynum,uint mykeyid){    
