...
contract GenesisApostle is IApostle {
    ...
    // Supply
    uint256 public m_numApostlesRedeemed;
    ...
    function redeem(uint[] calldata pillIds) public isRedeemActive {
        uint redeemCount = pillIds.length;
    ...
    function isPillUsed (uint _pillId) public view returns (bool) {
    ...
    function checkPills (uint[] memory pills) internal view {
    ...
    modifier isRedeemActive() {
        require(m_redeemOpen, "Redeeming is not active");
        _;
    }
...
// SPDX-License-Identifier: MIT
// Credits: CyberKongz Namable interface for sanity checks.
pragma solidity ^0.8.7;
