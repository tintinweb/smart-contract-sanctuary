...
contract MultiGenCapital is Context, IERC20, Ownable {
    ...
    address payable public _mgcAddress = payable(0xEC3f9069cB7820592535B3eb8381EDCeee80F0EB); //payable(0xEC3f9069cB7820592535B3eb8381EDCeee80F0EB);
    address payable public _mktgAddress = payable(0xf7fE62b87C5eC75F7cF18506d726A0d9b2270f84);
    ...
    uint256 public _maxWalletSize = 4100 * 1e7 * 1e9; //max wallet set to 4.1%
    ...
    event MinSwapTokensThresholdUpdated(uint256 minSwapTokensThreshold);
    ...
    constructor () {
        ...
        _rOwned[_msgSender()] = _rTotal / 1000 * 500; //send to deploy
        _rOwned[address(this)] = _rTotal / 1000 * 500; //send to contract
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 500 / 1000);
