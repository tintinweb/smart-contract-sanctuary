...
contract StakeableDailyReward {
    ...
    * @notice Staked event is triggered whenever a user stakes tokens, address is indexed to make it filterable
    ...
    /**
     * @notice
      rewardPerHour is 48667 because it is used to represent 18% pa, since we only use integer numbers
      This will give users 18% reward for each staked token / Y
     */
    uint256 internal rewardPerDay = 2028;
