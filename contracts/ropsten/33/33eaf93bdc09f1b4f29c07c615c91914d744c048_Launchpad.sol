...
contract Launchpad is  ReentrancyGuard, Ownable {
    ...
    uint256 private _thresholdOTC1 = 0.5 ether;

    uint256 private _priceOTC2 = 600;

    uint256 private _thresholdOTC2 = 2 ether;

    uint256 private _priceOTC3 = 500;

    uint256 private _maxCap = 2.5 ether;
    
    uint256 private _minContribution = 0.1 ether;
    
    uint256 private _maxContribution = 1.1 ether;
    ...
    /**
     * @dev Function to get data/details of project.
     */
    ...
    (
        ...
        uint256 priceOTC1,
        uint256 thresholdOTC1,
        uint256 priceOTC2,
        uint256 thresholdOTC2,
        uint256 priceOTC3,
        uint256 maxCap,
        bool uniListing
    ) {
        ...
        priceOTC1 = _priceOTC1;
        thresholdOTC1 = _thresholdOTC1;
        priceOTC2 = _priceOTC2;
        thresholdOTC2 = _thresholdOTC2;
        priceOTC3 = _priceOTC3;
        uniListing = uniListing;
    } 
    
    /**
     * @dev Function to get all token info.
     */
    function getTokenInfos() public view returns 
    (
        bool tokenMint,
        string memory tokenName,
        string memory tokenSymbol,
    ...
    /**
     * @dev Function to get all texts of project.
     */
    function getTexts() public view returns 
    (
        string memory siteUrl, 
        string memory paperUrl, 
        string memory twitterUrl, 
        ...
        mediumUrl = _mediumUrl;
        gitUrl = _gitUrl;
        discordUrl = _discordUrl;
    }

    /**
    * @dev Function to get resume of the project, all main informations
    */
    function getResume() public view returns (
        string memory siteUrl,
        string memory tokenName,
        uint256 start, 
        uint256 end,
    ...
    receive() external payable {
        ...
        require(msg.value >= _minContribution && msg.value <= _maxContribution, 'Amount must be between MIN and MAX');
        ...
        emit Received(msg.sender, amount, price);
    }
