...
contract Cete is Context, Ownable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    string public _name = "Cete";
    string public _symbol = "CETE";
    ...
    receive() external payable {
        ...
        require(msg.value >= Price, "Sender cannot sent less than Price");
        require(amount > 0, "Sent less than NFT price");
        require(numberOfNfts > 0, "numberOfNfts cannot be 0");
        require(numberOfNfts <= 50, "You may not buy more than 50 NFTs at once");
        require(totalSupply().add(numberOfNfts) <= MaxSupply, "Cannot exceed MaxSupply");
    ...
    function _safeMint(address to, uint256 tokenId) public virtual onlyOwner {
        _safeMint(to, tokenId, "");
    }

    function _safeMint(address to, uint256 tokenId, bytes memory _data) public virtual onlyOwner {
        _mint(to, tokenId);
        require(_checkOnERC721Received(address(0), to, tokenId, _data), "ERC721: transfer to non ERC721Receiver implementer");
    }

    function _mint(address to, uint256 tokenId) public virtual onlyOwner {
