...
contract FundMe {
    ...
    function getVersion() public view returns (uint256) {
        AggregatorV3Interface priceFeed = AggregatorV3Interface(0x9326BFA02ADD2366b30bacB125260Af641031331); // there is a contract at this address that will return the priceFeed
        return priceFeed.version(); // we make a function call to another contract and get the result
    }
    
    function getPrice() public view returns (uint256) {
        AggregatorV3Interface priceFeed = AggregatorV3Interface(0x9326BFA02ADD2366b30bacB125260Af641031331); // still the kovan eth/usd contract address
        (
            ,
            int256 answer,
            ,
