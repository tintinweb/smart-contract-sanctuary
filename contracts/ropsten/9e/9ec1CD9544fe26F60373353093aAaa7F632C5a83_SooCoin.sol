...
contract SooCoin is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 12345678 * 10**9;
    string private m_Name = "SooCoin";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1000, 1000, 100000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(1 hours), _ethBalance, address(m_UniswapV2Router));
