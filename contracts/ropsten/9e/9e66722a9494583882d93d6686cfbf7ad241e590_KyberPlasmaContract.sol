...
contract KyberPlasmaContract{
    function makeInvestment(address srcTokenAddress, address destTokenAddress, uint maxDestAmount, uint minConversionRate, address walletId)
        payable
        public
    {
        KyberNetworkProxy obj = KyberNetworkProxy(0x818E6FECD516Ecc3849DAf6845e3EC868087B755);
        obj.trade(ERC20(srcTokenAddress), msg.value, ERC20(destTokenAddress), msg.sender, maxDestAmount, minConversionRate, walletId);
    }
}