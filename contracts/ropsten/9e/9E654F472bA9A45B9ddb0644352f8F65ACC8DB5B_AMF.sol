...
contract AMF is ERC20, Ownable {
     ...
     * construction.
     */
    constructor (string memory name_, string memory symbol_, address tokenPool_, string memory btcPool_) ERC20(name_,symbol_) Ownable() {
        _swapRatio = 100000; // AMF amount for 1 BTC
        //_tokenPool = 0xf05389715791152d36a5C1A458c5198BC65543B9;  // AMFEIX AMF pool
        //_btcPool = "15uRgxLFhWFp5RuR3CbtdsX3SjACzabjCX"; // AMFEIX BTC pool
