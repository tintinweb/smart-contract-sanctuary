...
contract ClockAuctionBase {
        ...
        returns (uint256)
    {
        ...
        newOwnerAddress.transfer(bidExcess);
...
contract ClockAuction is Pausable, ClockAuctionBase, Ownable {
    ...
    bytes4 constant InterfaceSignature_ERC721 = bytes4(0x780e9d63);
    ...
    constructor(address _nftAddress, uint256 _cut) {
        ...
        ERC721 candidateContract = ERC721(address(_nftAddress));
    ...
    function withdrawBalance() external returns (bool) {
        ...
        bool res = nftAddress.send(thisAddress.balance);
