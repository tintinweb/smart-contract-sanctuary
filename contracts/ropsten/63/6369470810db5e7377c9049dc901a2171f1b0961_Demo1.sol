...
contract Demo1 is Context, IERC20, Ownable {
    ...
    string private _name = "Demo1";

    string private _symbol = "DMO";
    ...
    uint256 public _taxFee = 0; // means 0% which distribute to all holders reflection fee

    uint256 public _buyBackFee=800;// meanse 8% bnb to marketing Wallet

    uint256 public _tokenFee=200; //2% tokens to the wallet

    

    address tokenFeeAddress = 0xd02E0e3801906bAEa4A5E78E036D2787756eF4df;   //dummy address

    address marketingAddress = 0xa7155AcB6F4CCA6Ff39A6073d21A247e10Ab7f36;  //dummy addresss Bnb ADdress
    ...
    uint256 public minTokensBeforeSwap = 10_000_000e9;
        ...
        if(_taxFee != 0){
         ...
         if(_buyBackFee != 0){
            ...
            if (_isExcluded[address(this)]) {
                ...
                _tokenBalance[address(this)] = _tokenBalance[address(this)].add(buyBackFee);
          ...
          if(_tokenFee != 0){
            ...
            _reflectionBalance[tokenFeeAddress] = _reflectionBalance[tokenFeeAddress].add(tokenFee.mul(rate));

            if (_isExcluded[tokenFeeAddress]) {

                _tokenBalance[tokenFeeAddress] = _tokenBalance[tokenFeeAddress].add(tokenFee);

            }

            emit Transfer(account,tokenFeeAddress,tokenFee);
