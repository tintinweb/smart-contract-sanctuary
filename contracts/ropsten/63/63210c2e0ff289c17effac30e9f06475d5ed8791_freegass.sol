...
contract freegass is ERC20TokenInterface {

  //// Constants ////
  string public constant name = 'freegass';
  uint256 public constant decimals = 18;
  string public constant symbol = 'fgs';
  string public constant version = '1.0';
  string public constant note = 'freegass';
  string public constant exchange = 'wei';
  string public constant weivalue  ='1000000000';
  string public constant spend  = '0 gas';
  string public constant transformation  = '1fgs=1eth';
    

 // One billion coins, each divided to up to 10^decimals units.
  uint256 private constant totalTokens = 1000000000000 * (10 ** decimals);
  ...
  //// Public functions ////
  function freegass(address _migrationInfoSetter) {
  ...
  // not aware of fgs, the tokens will remain locked away in the contract forever.
