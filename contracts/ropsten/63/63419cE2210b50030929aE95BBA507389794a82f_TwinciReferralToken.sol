...
// File: contracts/standards/Pausable.sol
...
// File: contracts/TwinciReferralToken.sol
...
contract TwinciReferralToken is ERC20Pausable {
    string constant public name = "Twinci";
    string constant public symbol = "CI";
    ...
    modifier onlyMinter() {
        require(msg.sender == _minter, "Mint not permitted");
        _;
    }
