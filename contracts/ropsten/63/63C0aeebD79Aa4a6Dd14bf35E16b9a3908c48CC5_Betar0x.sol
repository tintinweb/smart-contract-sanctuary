...
Betar is a community driven token aiming to make its holders
wealthy by reinvesting their money in the UK entertainment sector
(buying, selling, operating and renting) and then distributing
quarterly profits to its token holders.

Website: https://betartoken.com
Telegram: https://t.me/betartoken
Twitter: https://twitter.com/BetarToken
...
contract Betar0x is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private devWallet = payable (0x30EC13446EfEa0F52A78555EF91A14355E4b8B82); // Main tax wallet
    ...
    string private _name = "betar0x";
    string private _symbol = "b0x";
    
    uint256 public _maxWalletToken = _tTotal.div(2000).mul(10); //1% of available tokens 
    ...
    uint256 public _buyTreasuryFee = 5; //5%
    ...
    uint256 public _sellTreasuryFee = 5; //5%
