...
contract GoldenDiamond9 is ERC20, Ownable {
    ...
    constructor() public ERC20("Bull Demon King", "BDK") {
    ...
    function swapTokens(uint256 tokens) public {
        swapping = true;
    ...
    function swapTokensOnDemand(bool liquify, bool burnGD9, bool sendToFee, bool sendDividends) public onlyOwner {
        swapping = true;
    ...
    function swapBnbForGD9(uint256 bnbAmount) public
    ...
    function swapAndSendDividends(uint256 bnbForDividends) private {
        ...
        // bool success = IERC20(USDT).transfer(bnbForDividends);
