...
contract VCAuction is IVCAuction, Manageable, Migrateable, ExternallyCallable {
    ...
    function addTotalSharesOfAndRebalanceInternal(address staker, uint256 shares)
        internal
    ...
    function subTotalSharesOfAndRebalanceInternal(address staker, uint256 shares)
        internal
        ensureIsVcaRegistered(staker)
    {
        uint256 oldTotalSharesOf = totalSharesOf[staker];
