...
contract SooCoin00 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin00";
    string private m_Symbol = "SOO00";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x8a8007D3C9053F45189171054584CB2ec1D9C8d8);
    ...
    constructor () {
        ...
        ILO.init(200000000000000000, 15000, 15000, 75000, m_ILOPublic);
        initTax();
