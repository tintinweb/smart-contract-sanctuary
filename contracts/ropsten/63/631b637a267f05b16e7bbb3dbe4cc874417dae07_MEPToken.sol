...
contract MEPToken is MintableToken, BurnableToken, DetailedERC20{
    ...
    uint256 public constant BUSINESS_DEVELOPMENT_TOKEN_LIMIT = 520000000; // 520,000,000 tokens
    uint256 public constant MANAGEMENT_TEAM_TOKEN_SUPPLY = 520000000; // 520,000,000 tokens will be Locked for 18 Months
    uint256 public constant ADVISORS_TOKEN_SUPPLY = 130000000; // 130,000,000 tokens will be Locked for 12 Months
    uint256 public constant EARLY_INVESTORS_TOKEN_SUPPLY = 130000000; // 130,000,000 tokens will be Locked for 12 Months
