...
contract Staking {
    ...
    uint256[6] public periods = [15 days, 30 days, 60 days, 90 days, 180 days, 360 days];
    uint8[6] public rates = [104, 108, 116, 124, 149, 200];
    uint256[6] public amounts = [100000000e18, 200000000e18, 500000000e18, 1000000000e18, 250000000e18, 500000000e18];
