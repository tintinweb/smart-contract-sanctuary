...
contract SolusToken is StandardToken { 
    ...
    */
    ...
    function SolusToken() {
        ...
        name = "Solus Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SOL";                                             // Set the symbol for display purposes (CHANGE THIS)
