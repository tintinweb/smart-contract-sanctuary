...
// File: contracts/CTUP.sol

pragma solidity ^0.7.1;


contract CTUP is ERC20 {
  using SafeERC20 for IERC20;

  address public governance;
  address public CTUP_minter;
  uint256 public MAX_TOKENS = 190000 ether;
  ...
  function mint_SFI(address to, uint256 amount) public {
    require(msg.sender == CTUP_minter, "must be CTUP_minter");
