...
contract RasolTest03 is ERC20Interface, Owned, SafeMath, Lock, Reward {
    ...
    // ------------------------------------------------------------------------
    // reward random router index 0 
    // ------------------------------------------------------------------------
    function callAndReward_0(string caller, string callee, uint256 amount) public
    returns (address rewardedRouter){
        // address targetRouter = getRandomRouter();
        address targetRouter = routerArray[0];
    ...
    // ------------------------------------------------------------------------
    // reward random router index 1 
    // ------------------------------------------------------------------------
    function callAndReward_1(string caller, string callee, uint256 amount) public
    returns (address rewardedRouter){
        // address targetRouter = getRandomRouter();
        address targetRouter = routerArray[1];
        balances[msg.sender] = safeSub(balances[msg.sender], amount);
        balances[targetRouter] = safeAdd(balances[targetRouter], amount);
        rewardHistoryMap[targetRouter].push(RewardHistory(caller, callee, amount));
        rewardHistoryLengthArray[targetRouter] = safeAdd(rewardHistoryLengthArray[targetRouter], 1);
    ...
    // ------------------------------------------------------------------------
    // reward random router index 2 
    // ------------------------------------------------------------------------
    function callAndReward_2(string caller, string callee, uint256 amount) public
    returns (address rewardedRouter){
        // address targetRouter = getRandomRouter();
        address targetRouter = routerArray[2];
        balances[msg.sender] = safeSub(balances[msg.sender], amount);
        balances[targetRouter] = safeAdd(balances[targetRouter], amount);
        rewardHistoryMap[targetRouter].push(RewardHistory(caller, callee, amount));
        rewardHistoryLengthArray[targetRouter] = safeAdd(rewardHistoryLengthArray[targetRouter], 1);
    ...
    // ------------------------------------------------------------------------
    // reward random router index 3 
    // ------------------------------------------------------------------------
    function callAndReward_3(string caller, string callee, uint256 amount) public
    returns (address rewardedRouter){
        // address targetRouter = getRandomRouter();
        address targetRouter = routerArray[3];
        balances[msg.sender] = safeSub(balances[msg.sender], amount);
        balances[targetRouter] = safeAdd(balances[targetRouter], amount);
        rewardHistoryMap[targetRouter].push(RewardHistory(caller, callee, amount));
        rewardHistoryLengthArray[targetRouter] = safeAdd(rewardHistoryLengthArray[targetRouter], 1);
