...
contract AlkomVault is Ownable {
    using SafeMath for uint256;
    ...
    struct VaultInfo {
        ...
        // address[] gamers;   // User address who deposited coin
    ...
    // The  token
    IBEP20 public ALKONToken;
  
    // Keep track of number of tokens depositedn and withdrawal;
   ...
   // mapping (address => UserInfo) public userInfo;
    ...
    function deposit(uint256 _amount) public {
        ...
        VaultInfo storage pool = vaultInfo[0];
    ...
    /// @dev Obtain the balance of this contract
    /// @return wei balace of contract
    function totalVaultBalance() public view returns (uint256) {
        // Return BEO20 balance
        return ALKONToken.balanceOf(address(this));
    }

    /// @dev Obtain the total deposited to vault
    /// @return wei balance of deposited token

    function totalDeposidted() public view returns (uint256){
        return totalDeposited;
    }
    
    /// @dev Obtain the total withdrawal to vault
    /// @return wei balance of withdrawal token
