...
// Contract link : https://ropsten.etherscan.io/address/0x10bae5fd9ba024993622790f6d2e8610462ff5ce
...
contract CocoBank_PonziScheme{
    ...
    //  Introducing
    function IMPORTANT_Read_Me_How_To_Use() public pure returns(string memory,string memory,string memory) {
    ...
    function Withdraw(string memory PressEnterYourDepositorName) IsRegister external returns(string memory){
        ...
        require(Tool.Compare_Str(d.name,PressEnterYourDepositorName),"You are not the owner!");
