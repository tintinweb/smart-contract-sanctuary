...
contract NiftyNft is NiftyGenerator {
  ...
  uint256 public startsAt = 1633803433;
  uint public constant maxMintCount = 20;
  constructor() NiftyGenerator("NiftyNft", "NIFTY", totalSupply, mintPrice, maxMintCount, startsAt) PaymentSplitter(wallets, splits) {}
}
...
abstract contract NiftyGenerator is ERC721URIStorage, Ownable, PaymentSplitter {
  ...
  uint256 public nftUnitPrice; //0.08 ETH
  ...
  constructor (string memory _name, string memory _symbol, uint256 maxNftSupply, uint256 unitPrice, uint maxMintCount, uint256 startsAt) ERC721(_name, _symbol) {
    maxSupply = maxNftSupply;
    nftUnitPrice = unitPrice;
    mintStartsAt = startsAt;
    maxMints = maxMintCount;
  }
  ...
  function setMintStartsAt(uint256 startsAt) external onlyOwner {
    mintStartsAt = startsAt;
  }
  ...
  function mint(uint numberOfTokens) public payable
  {
    ...
    require(block.timestamp >= mintStartsAt , "Minting has not yet started");
