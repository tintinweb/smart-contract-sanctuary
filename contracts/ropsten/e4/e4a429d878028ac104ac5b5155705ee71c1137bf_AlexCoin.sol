...
contract AlexCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AlexCoin() {
        ...
        name = "AlexCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ACN";                                             // Set the symbol for display purposes (CHANGE THIS)
