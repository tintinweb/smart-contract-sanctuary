...
library KiboConstants {
    ...
    IERC20 constant public wBTCToken = IERC20(0x8227632F10741Cb89892De0Bc1622d48796a5Aa8);
    IERC20 constant public polygonToken = IERC20(0xa4FcBB640E765c9016d4A8F6C64Bd3B837D3F9f5);
}
...
library PriceConsumer {
    IPriceConsumer constant priceConsumerETH = IPriceConsumer(0x17A8402bF6BeA74535c9ff69648EBb6Ede7399e3);
    IPriceConsumer constant priceConsumerwBTC = IPriceConsumer(0x48B895Fd679596236747D8e9E8Af9c32b77BFD7F);
    IPriceConsumer constant priceConsumerPolygon = IPriceConsumer(0xa25dda2d9224A4CdA8A8E639B131564F30396244);
