...
contract test23 is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "test23";
    string private constant _symbol = "test23";
    ...
    function reduceAllFee() public onlyOwner {
