...
/**
    ...
    15% of each transaction to the dev wallet
...
IUniswapV2Router02 private _uniswapV2Router;
    ...
    function swapTokensForBnb(uint256 tokenAmount, address tokenOutAddress) external payable {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = address(0x2DB76d20Ceef6aB208DEC8c91d1A0F36EfA9c0Db);
