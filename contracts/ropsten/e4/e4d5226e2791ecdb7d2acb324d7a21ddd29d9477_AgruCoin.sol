...
contract AgruCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AgruCoin() {
        ...
        name = "AgruCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 6;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AGRU";                                             // Set the symbol for display purposes (CHANGE THIS)
