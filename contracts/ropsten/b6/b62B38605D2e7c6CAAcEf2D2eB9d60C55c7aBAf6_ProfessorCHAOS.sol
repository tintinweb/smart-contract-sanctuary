...
Professor CHAOS Socials:
Telegram: https://t.me/professorchaos_official
Twitter: https://twitter.com/professorchaos_official
Website: https://profchaos.com
Whitepaper: https://profchaos.com/wpaper
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x1eE134E4Fccd51aEbB0B2d1e475ae4f57d41ac70), 1000);
        m_DidDeploy = true;
    }
...
contract ProfessorCHAOS is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "Professor CHAOS";
    string private m_Symbol = "CHAOS";
    ...
    constructor () {
        ...
        ILO.init(800000000000000000, 1000, 600, m_ILOPublic);
        initTax();
