...
contract Test is Pausable, IERC20 {
    using SafeMath for uint256;
    string  private _name = "Test";
    string  private _symbol = "tst";
    string  private _standard = "Token v1.0";
    uint8 private _decimals = 4;
    uint256 private _totalSupply = 20000000000 * 10 ** 4;
    ...
    /**
     * @dev Sets the values for {totalSupply} and transafer those created tokens to creator.
     *
        ...
        whenNotPaused
    {
        uint256 decreasedAllowance = allowance(account, _msgSender())
            .sub(amount, 'ERC20: burn amount exceeds allowance');
    ...
    function _approve(
        ...
        require(
            amount > 0 && _balances[owner] >= amount,
