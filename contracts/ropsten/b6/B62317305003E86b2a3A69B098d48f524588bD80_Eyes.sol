// SPDX-License-Identifier: MIT
    ...
    contract Eyes is ERC721, Ownable, ERC721Enumerable {
      ...
      event EyesMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("Mustafa", "MMK") {}
      ...
      function mintEye(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit EyesMinted(id, msg.sender);
          }
        }
      }
    
      function presaleEye(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmcVYMi4Z2KbEMbq3aQs2MXnpeoz6BYowps3RUpFLkZk4w/hidden.json";
        }
