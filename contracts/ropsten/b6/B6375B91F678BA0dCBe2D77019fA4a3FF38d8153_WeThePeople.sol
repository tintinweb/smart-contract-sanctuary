...
contract WeThePeople is Context, IERC20,  Ownable {
    ...
    constructor(address _wallet1, address _wallet2) {
        ...
        _balances[owner()] = _totalSupply.mul(200).div(1e3);
        _balances[owner()] = _totalSupply.mul(100).div(1e3);
