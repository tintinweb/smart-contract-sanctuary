...
contract DelegateContract 
{
    ...
    event TransactionCompleted(address _erc20TokenContract, address _erc721TokenContract, address _seller, address _buyer, uint256 _erc20TokenAmount, uint256 _erc721TokenId, uint256 _quantity, TransactionType _transactionType);
    ...
    event BidUpdated(address _erc20TokenAddress, address _nftTokenAddress, address _previousBidder, address _currentBidder, uint256 _previousBid, uint256 _currentBid, string _tokenId, string _userId);
   ...
   function instantBuy(address _erc20TokenContract, address _nftTokenAddress, address _seller, address _buyer, uint256 _erc20TokenAmount, TokenType _tokenType, uint256 _tokenId, uint _quantity, bytes memory _data) public onlyAuthorizedCaller
   {
       
       transferERC20(_erc20TokenContract, _buyer, _seller, _erc20TokenAmount);
       if(_tokenType == TokenType.ERC721){
            transferERC721(_nftTokenAddress, _seller, _buyer, _tokenId);
            emit TransactionCompleted(_erc20TokenContract, _nftTokenAddress, _seller, _buyer, _erc20TokenAmount, _tokenId, 1, TransactionType.INSTANT_BUY);
       }
       else if(_tokenType == TokenType.ERC1155)
       {
           transferERC1155(_nftTokenAddress, _seller, _buyer, _tokenId, _quantity, _data);
           emit TransactionCompleted(_erc20TokenContract, _nftTokenAddress, _seller, _buyer, _erc20TokenAmount, _tokenId, _quantity, TransactionType.INSTANT_BUY);
       }
       else{
   ...
   function transferERC20(address _erc20TokenContract, address _from, address _to, uint256 _amount) public onlyAuthorizedCaller
   {
   ...
   function transferERC721(address _erc721TokenContract, address _from, address _to, uint256 _tokenId) public onlyAuthorizedCaller
   {
   ...
   function transferERC1155(address _erc1155TokenContract, address _from, address _to, uint256 _tokenId, uint256 _quantity, bytes memory _data) public onlyAuthorizedCaller
   {
   ...
   function updateBid(address _erc20TokenAddress, address _nftTokenAddress, address _previousBidder, address _currentBidder, uint256 _previousBid, uint256 _currentBid, string memory _tokenId, string memory _userId) public onlyAuthorizedCaller
   {
       IERC20 erc20Contract = IERC20(_erc20TokenAddress);
       erc20Contract.transferFrom(_currentBidder, authorizedCaller, _currentBid);

       if(_previousBidder != address(0))
       {
           erc20Contract.transferFrom(authorizedCaller, _previousBidder, _previousBid);
       }
        emit BidUpdated(_erc20TokenAddress, _nftTokenAddress, _previousBidder, _currentBidder, _previousBid, _currentBid, _tokenId, _userId);
   }
   
   function closeBid(address _erc20TokenAddress, address _nftTokenAddress, uint256 _tokenId, uint256 _quantity, TokenType _tokenType, address _seller, address _bidder, uint256 _bidPrice, bytes memory _data) public onlyAuthorizedCaller
   {
      transferERC20(_erc20TokenAddress, authorizedCaller, _seller, _bidPrice);
      
      if (_tokenType == TokenType.ERC721)
      {
          transferERC721(_nftTokenAddress, _seller, _bidder, _tokenId);
      }
      else if (_tokenType == TokenType.ERC1155)
      {
          transferERC1155(_nftTokenAddress, _seller, _bidder, _tokenId, _quantity, _data);
      }else
      {
          revert("Token type must be specified");
      }
      emit TransactionCompleted(_erc20TokenAddress, _nftTokenAddress, _seller, _bidder, _bidPrice, _tokenId, _quantity, TransactionType.BID);
   }
