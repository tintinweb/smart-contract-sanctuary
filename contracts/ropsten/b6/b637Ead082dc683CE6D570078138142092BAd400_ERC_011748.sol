...
// main contract []
contract ERC_011748 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_011748";
            string private _symbol = "ERC011748";
        ...
        // helpers
            ...
            bool private _lockSwapAndLiquifyEngaged;
    ...
    // events
        ...
        event EventDebugSwapAndLiquify(
                    bool _lockSwapAndLiquifyEngaged,
    ...
    // modifier
        modifier lockSwapAndLiquify{
            _lockSwapAndLiquifyEngaged = true;
            _;
            _lockSwapAndLiquifyEngaged = false;
        } 
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_011748: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_011748: transfer amount exceeds allowance"));
        return(true);
    }
    ...
    // setter
        function setInitialLiquidity() public onlyOwner{
            require(!_initialLiquidity, "ERC_011748: Initial liquidity already set!");
    ...
    function _tokenInit() private onlyOwner{
        // contract
        uint256 tokenInitMain =  _totalSupply.div(10000);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_011748: approve from the zero address");
        require(spender != address(0), "ERC_011748: approve to the zero address");
    ...
    function _transfer(address from, address to, uint256 amount) private{
        ...
        if(TAX_ENABLED && !_lockSwapAndLiquifyEngaged && from != PROXY_UNISWAP_PAIR){
            uint256 tokens = _balances[address(this)];
            if(tokens > _minTokensToSell){
                // contract has enough tokens to sell and is currently not selling
                emit EventDebugSwapAndLiquify(
                    _lockSwapAndLiquifyEngaged,
                    from,
                    tokens,
                    _minTokensToSell
                );
    ...
    function _transactionSwapAndLiquify(uint256 amount) private lockSwapAndLiquify{
