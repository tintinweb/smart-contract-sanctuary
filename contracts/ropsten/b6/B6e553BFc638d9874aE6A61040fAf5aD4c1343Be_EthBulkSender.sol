...
/**
 * Contract acts as an interface between the EthBulkSender contract and all ERC20 compliant
 * tokens.
 * */
...
contract EthBulkSender is Ownable {
    ...
    string public constant website = "www.cryptobulksender.com";
