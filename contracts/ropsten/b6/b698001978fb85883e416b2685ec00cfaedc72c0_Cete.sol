...
contract Cete is Context, Ownable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    string public constant _name = "Cete";
    string public constant _symbol = "CETE";
    ...
    uint256 public constant MaxContribution = 50 ether;
    ...
    receive () external payable {
        ...
        require(msg.value <= MaxContribution, "You may not buy more than 50 NFTs at once");
