...
contract MoonToken is ERC20Detailed 
{
    ...
    string constant tokenSymbol = "MT5";//"MT5"; 
    ...
    *   6% are split to be burnt and distributed to stakers, as evenly as possible
    *   due to precision loss when dividing total reward to rewards per unit, 
    *   lower than 3% stakers rewards will occur. the rest is burnt accordingly to fill up the 6%
    *   This is by design
    */
