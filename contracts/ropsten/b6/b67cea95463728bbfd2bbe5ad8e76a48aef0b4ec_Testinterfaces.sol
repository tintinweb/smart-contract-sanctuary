...
contract Testinterfaces {
    ...
    // input amountIn without 10 ** 18 and only use integer
    // TokentoToken address[](3); most of pair
    function dragMostofTokenwithDai(uint amountIn, uint amountOutMin, address targetToken) public view returns(bytes memory){
    ...
    function getdaiPerTokenRate1(address targetToken) public view returns(string memory) { 
     address[] memory path = new address[](2);
     path[0] = dai;
     path[1] = targetToken;
     uint amountsIn = 10**18;
     uint[] memory expectedAmountsOut = UniswapV2Library.getAmountsOut(UniswapV2Factory,amountsIn,path);
    ...
    function getdaiPerTokenRate2(address targetToken) public view returns(uint) { 
     address[] memory path = new address[](2);
     path[0] = dai;
     path[1] = targetToken;
     uint amountsIn = 10**18;
    ...
    function getdaiPerTokenRate3(address targetToken) public view returns(address) {
     address[] memory path = new address[](2);
     path[0] = dai;
     path[1] = targetToken;
     address pairAddress = UniswapV2Library.pairFor(UniswapV2Factory,dai,targetToken);
     return pairAddress;
    }

    function getdaiPerTokenRate4(address targetToken) public view returns(uint Res0, uint Res1) { 
     address[] memory path = new address[](2);
     path[0] = dai;
     path[1] = targetToken;
     address pairAddress = UniswapV2Library.pairFor(UniswapV2Factory,dai,targetToken);
