...
// https://t.me/DegenerateMoney
// https://degenerate.money
...
contract DEGENR is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 37000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'DEGENR';
    string private constant _symbol = 'DEGENR';

    uint256 private _taxFee = 6;
    uint256 private _burnFee = 6;
    uint public max_tx_size = 370000 ether;
