...
pragma solidity ^0.6.12;
    ...
    contract RakuCoin is Context, IERC20, Ownable {
        ...
        string private _name = 'Raku test Coin';
        string private _symbol = 'testRAKUC';
        ...
        uint256 private _numOfTokensToExchangeForMarketingPool = 5 * 10**3 * 10**9;
        ...
        function _setMarketingPoolFee(uint256 MarketingPoolFee) external onlyOwner() {
            require(MarketingPoolFee >= 1 && MarketingPoolFee <= 11, 'MarketingPoolFee should be in 1 - 11');
