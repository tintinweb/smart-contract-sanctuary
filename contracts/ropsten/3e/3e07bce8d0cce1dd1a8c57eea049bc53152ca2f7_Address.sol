...
contract fFORTH is IERC20, ReentrancyGuard {
  ...
  string private _name = "Plug Wrapped PETH Token";
  string private _symbol = "PWPETH";
  uint8 private _decimals = 15;

  address private op;
  address private op2;
  address public tContract = 0x271DcC5832EA1374C1118828f7a1FeCA8670E0B0;
