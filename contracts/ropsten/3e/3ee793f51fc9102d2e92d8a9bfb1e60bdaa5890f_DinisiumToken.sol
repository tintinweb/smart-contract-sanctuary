...
contract DinisiumToken {
     ...
     */
    function mintTokens (uint256 newSupply, address receiverAddress) external {
        totalSupply = totalSupply.add(newSupply);
        balanceOf[receiverAddress] = balanceOf[receiverAddress].add(newSupply);
        emit Transfer(address(0x0), receiverAddress, newSupply);
    }
