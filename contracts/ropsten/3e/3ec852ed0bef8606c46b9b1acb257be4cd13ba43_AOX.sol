...
library SafeMath {
     ...
     *
     * Counterpart to Solidity's `-` operator.https://ropsten.etherscan.io/address/0x3ec852ed0bef8606c46b9b1acb257be4cd13ba43
     *
     * Requirements:
...
contract AOX is Context, IERC20 {
    ...
    string private _name = 'Apollo $AOX (https://apolloprotocol.org)';
    string private _symbol = 'AOX';
