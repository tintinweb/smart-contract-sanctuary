...
interface IInvestmentStrategy {
    ...
    function makeInvestment(Investment[] calldata investments, bytes calldata data) external returns (uint);

    function withdrawInvestment(Investment[] calldata investments, bytes calldata data) external;
