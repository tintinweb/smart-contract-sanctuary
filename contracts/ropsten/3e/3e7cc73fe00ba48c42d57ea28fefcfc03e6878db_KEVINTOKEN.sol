...
contract KEVINTOKEN is StandardToken, BurnableToken, Ownable {
    ...
    string constant public symbol = "KEVIN3";
    string constant public name = "KEVINTOKEN";

    uint8 constant public decimals = 18;
    uint256 INITIAL_SUPPLY = 3000000000e18;

    uint constant ITSStartTime = 1542856200; 
    uint constant ITSEndTime = 1542856500; 
    uint constant unlockTime = 1542856800; 
