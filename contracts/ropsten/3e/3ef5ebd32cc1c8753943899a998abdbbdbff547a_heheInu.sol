...
/* 
    ...
    Telegram: https://t.me/heheinu
    Twitter: https://twitter.com/heheInu
...
contract heheInu is Context, IERC20, Ownable {
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 99, "Must keep buy taxes below 99%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 99, "Must keep sell taxes below 99%");
