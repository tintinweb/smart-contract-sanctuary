...
Website: soo.com
Whitepaper: soo.com/whitepaper.pdf

** Secured With FTP Antibot **
** Using FTP EthReflect to give 0.10% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x250E75B9F33940506D1cF31FaB63cFAA5ad98C95), 250);
        m_DidDeploy = true;
    }
...
contract FireCoin is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "FireCoin";
    string private m_Symbol = "FIRE";
    ...
    constructor () {
        ...
        ILO.init(5000000000000000000, 1000, 1000, 50000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(5000 days), owner(), _ethBalance);
