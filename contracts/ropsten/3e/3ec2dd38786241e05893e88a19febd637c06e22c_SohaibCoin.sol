...
contract SohaibCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SohaibCoin() {
        ...
        name = "SohaibCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-072";                                             // Set the symbol for display purposes (CHANGE THIS)
