...
contract FootScoutCrowdsale is Ownable {
    ...
    uint256 public constant FOUNDERS_TOKENS_LOCK_PERIOD = 60 * 60; // 1 year
    uint256 public constant COMPANY_TOKENS_LOCK_PERIOD = 60 * 60; // 180 days
    uint256 public constant RESERVE_TOKENS_LOCK_PERIOD = 60 * 60; // 180 days
    uint256 public constant SOFT_CAP = 9180000e18; // 9 180 000
    uint256 public constant ICO_TOKENS = 163100000e18; // 163 100 000
    uint256 public constant START_TIME = 1531044924; // 07/01/2018 @ 10:00am (UTC)
    uint256 public constant RATE = 51000000;  // 1 ETH = 5100 FTSC

    uint256 public icoEndTime = 1531053924; // 2018/05/31 10:00 UTC +0
    ...
    */
    ...
    function FootScoutCrowdsale() public {
        stages.push(Stage({ till: 1531046724, bonus: 34, cap: 163100000e18 }));    // 07/02/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531048524, bonus: 21, cap: 0 }));               // 07/05/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531050924, bonus: 13, cap: 0 }));               // 07/10/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531051524, bonus: 5, cap: 0 }));                // 07/18/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531053924, bonus: 0, cap: 0 }));                // 08/01/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: ~uint64(0), bonus: 0, cap: 0 }));                // unlimited

        token = FootScoutToken(0x096c430dEB11948e95236dD58d3dF4383d92bBE2);
