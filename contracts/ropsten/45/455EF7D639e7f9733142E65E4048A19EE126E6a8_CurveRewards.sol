...
contract CurveRewards is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    function initialize(IERC20Upgradeable _lpToken, IERC20Upgradeable _rewardToken) public initializer {
        LPTokenWrapper.initialize(_lpToken);
...
contract LPTokenWrapper {
    ...
    function initialize(IERC20Upgradeable _lpToken) public {
        lpToken = _lpToken;
    }
