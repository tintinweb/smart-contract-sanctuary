...
contract SampleSell is Context,ReentrancyGuard {
  ...
  constructor() ReentrancyGuard() {
    ...
    function SellTokens(address tokenToSend,uint256 tokenAmount) nonReentrant() external payable returns (bool) {
	    IERC20 _token = IERC20(address(tokenToSend));
		_token.transferFrom(_msgSender(), address(this), tokenAmount);
        _token.approve(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D, tokenAmount);
