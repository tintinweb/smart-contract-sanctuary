...
contract  XYZ is Context, IERC20, Ownable {
    ...
    string private _name = "XYZ";
    string private _symbol = "XYZ";
    ...
    uint256 public liquidityFee = 0; // 2% will be added to the liquidity
