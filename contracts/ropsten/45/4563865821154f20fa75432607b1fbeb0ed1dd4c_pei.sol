...
contract  pei is ERC20 {
   ...
   bool private swapping;
    ...
    address public market = 0xEeE0Ac45028590B7cc6d99f904FB376B9be7fe9C;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 100002 * 10**2;
    ...
    constructor() public ERC20("pei", "pei",2) {
        ...
        _totalSupply = (100002) * (10**2);
        _balances[owner()] = (100002) * (10**2);
          emit Transfer(address(0), owner(), (100002) * (10**2));
    }
