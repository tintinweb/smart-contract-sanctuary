...
contract RegistryV7 is IRegistry, AccessControl, VersionedInitializable {
    ...
    // Version 7
    // pending user registration flag shown when calling getAccount()
    uint256 public constant REGISTRY_REVISION = 0x7; 
    ...
    **/
        ...
        onlyOwners
    {
        ...
        if (!approve) {
            ...
            registry[clientOrSatellite].pending = false;
            ...
            if (s.acc_type == ACCOUNT_TYPE.CLIENT) {
                ...
                if (
                    ...
                    registry[clientOrSatellite].pending = true;
                } else if (
                    registry[clientOrSatellite].approvedBy[1] != address(0) &&
                    registry[clientOrSatellite].approvedBy[0] != address(0)
                ) {
