...
contract XamppCapital {
    ...
    constructor(address _XamppToken) public {
        XamppToken = ERC20Interface(_XamppToken);
    }
    ...
    function invest(uint256 amount) public {
		...
		XamppToken.transferFrom(msg.sender, address(this), received);
    ...
    function withdraw() public {
        ...
        uint256 contractBalance = XamppToken.balanceOf(address(this));
		...
		XamppToken.transfer(msg.sender, totalAmount);
