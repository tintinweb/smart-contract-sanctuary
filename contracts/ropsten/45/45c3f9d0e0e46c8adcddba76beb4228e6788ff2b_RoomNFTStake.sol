...
contract RoomNFTStake is IERC1155Receiver, ReentrancyGuard {
    ...
    IERC1155 public constant NFTToken = IERC1155(0xA0b3B37178FEFAA04a65bf592ad2E96279bAa9Ec);

    uint256 public finishBlock;
    address public roomTokenRewardsReservoirAddress = 0x59fA53e793C0786cFa78c274C379aC99a8d183F6;
