...
pragma experimental ABIEncoderV2;
    ...
    function addSale(address _seller, string memory _location, string memory _items, string memory _sellerId)public returns (bytes32  _record){
        _record = keccak256(abi.encodePacked(_sellerId,_location,_items,_seller));
