...
ILOMADNEZZ Socials:
Telegram: http://t.me/imad
Twitter: http://twitter.com/imad
Website: http://imad.com
Whitepaper: http://imad.com/paper
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xda46eee9b7E7f5d40d599c778a5E607F7e8242BD), 1200);
		setTaxAlloc(payable(0xb849fBBfB25b679ADdFAD5Ebe94132c9ec7803aa), 1799);
        m_DidDeploy = true;
    }
...
contract ILOMADNEZZ is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOMADNEZZ";
    string private m_Symbol = "IMAD";
    ...
    constructor () {
        ...
        ILO.init(2000000000000000000, 5000, 1200, 100000, m_ILOPublic);
        initTax();
