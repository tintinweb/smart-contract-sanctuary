...
contract BigPresaleTest is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "BigPresaleTest";
    string private m_Symbol = "BIG";
    ...
    constructor () {
        ...
        ILO.init(2500000000000000000, 10000, 2000, 75000, m_ILOPublic);
        initTax();
