...
contract InbestDistribution is Ownable {
  ...
  /**
    ...
    */
  constructor(uint256 _startTime, address _companyWallet) public {
    ...
    emit LogNewAllocation(companyWallet, AllocationType.COMPANY, tokensToAllocate, grandTotalAllocated());
  }
  ...
  function setAllocation (address _recipient, uint256 _totalAllocated) public onlyOwnerOrAdmin {
    ...
    emit LogNewAllocation(_recipient, AllocationType.PRESALE, _totalAllocated, grandTotalAllocated());
  }
 ...
 function transferTokens (address _recipient) public {
   ...
   emit LogIBSTClaimed(_recipient, allocations[_recipient].allocationType, tokensToTransfer, newAmountClaimed, grandTotalClaimed);
 }
 ...
 function manualContribution(address _recipient, uint256 _tokensToTransfer) public onlyOwnerOrAdmin {
   ...
   emit LogIBSTClaimed(_recipient, uint8(AllocationType.COMPANY), _tokensToTransfer, allocations[companyWallet].amountClaimed, grandTotalClaimed);
 }
  ...
  */
  ...
  function setAdmin(address _admin, bool _allowed) public onlyOwner {
    ...
    admins[_admin] = _allowed;
     emit SetAdmin(msg.sender,_admin,_allowed);
  }
...
contract InbestTokenDistributor  is Ownable {
   ...
   */
  constructor (InbestDistribution _inbestDistribution) public {
