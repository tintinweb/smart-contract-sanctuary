...
contract ChannelSeason0 is ERC721, Ownable {
    ...
    function _mintRequires(uint256 numToMint) private view {
    ...
    function _isValidData(
        ...
        return _recoverSigner(ethSignedMessageHash, _signature) == validSigner;
    }
    ...
    function greenlistMint(
        ...
        require(
            _isValidData(receiver, numToMint, signedMessage),
