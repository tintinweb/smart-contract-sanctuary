...
contract TShare is ERC20BurnableUpgradeable, Operator {
...
/*
    constructor(uint256 _startTime, address _communityFund, address _devFund) ERC20("TSHARE", "TSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 PEAK Share for initial pools deployment
...
*/
    function initialize(uint256 _startTime, address _communityFund, address _devFund) public initializer {
        __Context_init_unchained();
        __Operator_init_unchained();
        __ERC20_init_unchained("TSHARE", "TSHARE");
        __ERC20Burnable_init_unchained();
        __TShare_init_unchained(_startTime, _communityFund, _devFund);
    }

    function __TShare_init_unchained(uint256 _startTime, address _communityFund, address _devFund) internal onlyInitializing {
