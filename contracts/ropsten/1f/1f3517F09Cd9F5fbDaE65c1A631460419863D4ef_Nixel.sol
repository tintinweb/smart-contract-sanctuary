...
contract Nixel is ERC721Enumerable, Ownable {
    ...
    function buyBlock(int256 x_pos, int256 y_pos) public payable {
        ...
        pixelContract.mint(address(pixelContract), msg.value * nixelPixelMint / 100 * 2 * 33);
        pixelContract.addLiquidity(msg.value * nixelPixelMint / 100 * 2 * 33, toLiquidity);
    ...
    function mint(int256 x_pos, int256 y_pos) public payable {
        ...
        pixelContract.mint(_msgSender(), nixelPixelMint * msg.value);
        pixelContract.mint(
            address(pixelContract),
            nixelPixelMint * msg.value * 33
        );
