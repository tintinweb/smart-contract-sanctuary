...
contract ForeignBridge {
    ...
    function () public payable onlyAuthority {
    ...
    function transferHomeViaRelay(address recipient, uint256 homeGasPrice) public payable {
        require(msg.value > 0);

        Withdraw(recipient, msg.value, homeGasPrice);
    }
