...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract TestEEE is ERC20, Ownable {
        using SafeMath for uint256;
    ...
    address payable deployerWallet = payable(0x22106E76763B1F1f31a9Dc2530E00efCf101cc06);
    address payable marketingWallet = payable(0x0b7b059d37984c16Ce5b512c57efF429f9f84909);
    address payable developmentWallet = payable(0x8951365410aA57E384C58bB8C5bB66756Ef08178);
    ...
    constructor () ERC20("TestEEE", "EEE", 9) {
