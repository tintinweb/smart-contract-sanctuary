 ...
 */
abstract contract ERC20 is Pausable, IERC20, IERC20Metadata {
...
contract BaseContract is Ownable {
    ...
    function getManagerAddress() public view onlyOwner returns(address){
...
contract GETS is ERC20, BaseContract {
     ...
     */
    function buyGets(uint256 amount) external payable {
        ...
        string memory userType = userStorage.getUserType(msg.sender);
        uint256 rmmPrice = 10;
        require(msg.value == rmmPrice * amount, "GETS: Not enough ether");

        reservation[categories[userType]] -= amount;
