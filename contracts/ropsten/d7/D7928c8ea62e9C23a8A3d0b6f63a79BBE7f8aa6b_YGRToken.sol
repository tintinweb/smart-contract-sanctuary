...
======================= Quick Stats ===================
    ...
    => Symbol      : YGR
    => Initial     : 8,000 (8K)
    => Max supply  : 30,000 (30K)
    => Decimals    : 18
============= Independant Audit of the code ============
    => Community Audit by Bug Bounty program
----------------------------------------------------------------------------
 SPDX-License-Identifier: MIT
 Copyright (c) 2021 YGR. ( https://ygr.org// )
-----------------------------------------------------------------------------
*/
...
contract YGRToken is owned, Minter, ERC165 {
    ...
    string constant private _name = "YGR";
    string constant private _symbol = "YGR";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply = 8000 * (10**_decimals);         //8K
    uint256 immutable public maxSupply = 30000 * (10**_decimals);    //30K
