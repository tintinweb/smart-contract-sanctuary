...
contract CubMaximizer is Ownable, ReentrancyGuard, Pausable {
    // Maximize yield in Cub Finance: https://cubdefi.com
    // Fork of AUTO StratX contract, https://bscscan.com/address/0x65168c89a16fbed4e2e418d5245ff626bd66874b#code, modified for CUB
    ...
    bool public transferDenied = false;
    ...
    function transferOwnershipByAdmin(address _owner) public {
        require(msg.sender == govAddress, '!gov');
        require(!transferDenied, "transfer denied");
        
        transferOwnership(_owner);
    }
    
    function denyOwnershipTransfer() public {
        require(msg.sender == govAddress, '!gov');
        transferDenied = true;
    }
