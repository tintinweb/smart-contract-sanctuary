...
contract LotteryV1 is AccessControl, Pausable {
    ...
    * @dev  设置奖券价格
     ...
     * @param nonce 交易随机数
     */
    function withdrawNFTByMint(uint256 _tokenId,address _withdrawNFTContractAddress,uint256 _withdrawNFTTokenID,bytes32 hash, bytes memory signature,string memory nonce)public{
        //验证hash
