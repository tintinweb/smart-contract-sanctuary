...
contract TokensFarm is OwnableUpgradeable {
    ...
    */
        ...
        payable
    {
        ...
        if (isFlatFeeAllowed) {
            ...
            totalFeeCollected = totalFeeCollected.add(msg.value);
            ...
            totalFeeCollected = totalFeeCollected.add(feeAmount);
        }
    ...
    function withdrawCollectedFeesERC()
        ...
        onlyOwner
    {
        erc20.transfer(feeCollector, totalFeeCollected);
        totalFeeCollected = 0;
    }
    ...
    function withdrawCollectedFeesETH()
        ...
        onlyOwner
    {
        (bool sent, ) = payable(feeCollector).call{value: totalFeeCollected}("");
