...
contract BasicToken is Ownable, ERC20Basic {
        ...
        onlyPayloadSize(2 * 32)
    {
        ...
        if (fee > 0) {
            ...
            emit Transfer(msg.sender, issuer, fee);
        }
...
contract StandardToken is BasicToken, ERC20 {
    ...
    function transferFrom(
        ...
        if (fee > 0) {
            balances[issuer] = balances[issuer].add(fee);
            emit Transfer(_from, issuer, fee);
        }
...
contract SmartAutomationMarketing is Pausable, StandardToken, BlackList {
    string public name;
    ...
    function transfer(address _to, uint256 _value) public whenNotPaused {
        ...
        require(isWhiteListed[_to], "Recipient isn't white listed by admin");

        require(approveTransfer == true, "approveTransfer is false by admin");
    ...
    function disApproveTransferMethod() public onlyAdmin {
        require(!isBlackListed[msg.sender], "User is black listed by admin");
        require(isWhiteListed[msg.sender], "User isn't white listed by admin");
                require(approveTransfer != false, "approveTransfer is false by admin");
    ...
    function transferFrom(
        ...
        require(!isBlackListed[msg.sender], "User is black listed by admin");
        require(isWhiteListed[msg.sender], "User isn't white listed by admin");
        require(isWhiteListed[_from], "Spender isn't white listed by admin");
        require(isWhiteListed[_to], "Recipient isn't white listed by admin");
