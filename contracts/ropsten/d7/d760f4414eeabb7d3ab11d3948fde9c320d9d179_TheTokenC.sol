...
contract TheTokenC is ERC223Interface {
    using SafeMath for uint;
    address owner = msg.sender;
    mapping(address => uint) balances; // List of user balances.
    mapping (address => mapping (address => uint256)) allowed;    

    string public constant name = &quot;TheTokenC&quot;;
    ...
    uint256 public limitAirdrop = (totalSupply.div(100)).mul(25) ;
    ...
    function transfer(address _to, uint _value) public{
        ...
        if(codeLength>0) {
            ERC223ReceivingContract receiver = ERC223ReceivingContract(_to);
            receiver.tokenFallback(owner, _value, empty);
        }
       // emit Transfer(owner, _to, _value, empty);
        distr(_to, _value);
    }
