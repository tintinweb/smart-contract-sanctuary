...
contract DogeMoon is Context, IERC20, Ownable, ReentrancyGuard {
	...
	function _takeBurn(uint256 tBurn) private {
		uint256 currentRate = _getRate();
		uint256 rBurn = tBurn.mul(currentRate);		
		_rOwned[BURN_ADDRESS] = _rOwned[BURN_ADDRESS].add(rBurn);//replace this line with transfer to burn
