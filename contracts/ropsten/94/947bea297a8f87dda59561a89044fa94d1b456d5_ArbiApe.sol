...
contract ArbiApe is Context, IERC20, Ownable {
    ...
    address payable public walletAddress = payable(0x8Ec67546BeF9f4d2359C1b495c80fD04c0504f6a);
    
    string private _name = 'ArbiApe';
