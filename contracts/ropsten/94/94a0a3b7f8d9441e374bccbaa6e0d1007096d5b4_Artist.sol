...
contract Artist is ArtistBase,IERC721,IERC721Metadata,IERC721Enumerable {
    ...
    {
        return ((_interfaceID == InterfaceSignature_ERC165) || (_interfaceID == InterfaceSignature_ERC721)||(_interfaceID == _INTERFACE_ID_ERC721_ENUMERABLE)||(_interfaceID == _INTERFACE_ID_ERC721_METADATA));
    }
    function totalSupply() public view returns (uint256){
        return curid;
    }
