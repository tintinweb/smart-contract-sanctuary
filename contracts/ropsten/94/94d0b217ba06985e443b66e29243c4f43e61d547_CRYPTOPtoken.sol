...
contract CRYPTOPtoken {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'CRYPTOP: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'CRYPTOP: INVALID_SIGNATURE');
