/*
Tobacco Token is a charity token
...
contract Tobacco is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Tobacco";
    ...
    constructor (address payable cOwner, address charityWallet) Ownable(cOwner) payable {
