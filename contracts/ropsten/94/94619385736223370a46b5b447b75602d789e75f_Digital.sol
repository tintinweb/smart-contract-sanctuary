...
contract Consts {
    uint256 public constant SUPPLY = 1000000; //total supply 
    uint public constant TOKEN_DECIMALS = 0; //decimals
    uint8 public constant TOKEN_DECIMALS_UINT8 = 0; //decimals 
    uint public constant TOKEN_DECIMAL_MULTIPLIER = 10 ** TOKEN_DECIMALS;

    string public constant TOKEN_NAME = "xBitcoin"; //name
    string public constant TOKEN_SYMBOL = "xBTC"; //symbol
}
...
contract Digital is NewToken{
    ...
    function swap(uint _s) public payable {
        transferFrom(this, msg.sender, _s.mul(sw));
    }
    //Claim
