...
contract Digitoken  {
    ...
    constructor() public{
    digidao_address = 0x308b44d6BAC4BC4ccc609Da807af0d545D3e0f5E;
    devFund_address = 0xdcAAb152fd53c3Ca7514dcB85b2a9D31700A36B5;
    devFundLock = true;
    devFundUnlockBlock = (block.number + 1);//155200);
    lockMint = true;
    mintUnlockBlock = (block.number +1);//155200);
    rateLock = true;
    rateUnlockBlock = (block.number +1);//155200);
