...
contract  FINALTEST2 is Context, IERC20, Ownable {
    ...
    string private _name = "FinalTest2";
    string private _symbol = "FinalTest2";
    ...
    uint256 public marketFee = 5; // 4% will be added to the market address
    uint256 public liquidityFee = 0; // 2% will be added to the liquidity
    uint256 public devFee = 5; // 4% will be added to the development address
