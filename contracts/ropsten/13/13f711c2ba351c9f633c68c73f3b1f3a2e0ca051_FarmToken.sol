 ...
 *
 */
contract FarmToken is ERC20Burnable {
    /**
     * @dev Contract variables.
     */
    string private _name = "FarmToken";
    string private _symbol = "HERBZZ";
    ...
    function _transfer(
        ...
        uint256 _dividendsTransferred = (amount - (balanceOf(sender) - _dividendsClaimed[sender]));
