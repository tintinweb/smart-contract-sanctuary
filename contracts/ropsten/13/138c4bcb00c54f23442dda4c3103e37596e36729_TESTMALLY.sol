...
contract TESTMALLY is IERC20, Auth {
    ...
    string constant _name = "TESTMALLY";
    string constant _symbol = "TESTM";
    ...
    address private marketingFeeReceiver = 0xf57bfcE9be858a6179F13b6901ad417E318f9A12;
    address private GiveawayFeeReceiver = 0x990BCB112ad48E2947365A5570B61F23c3DcFDc0;
    address private DevFeeReceiver = 0x990BCB112ad48E2947365A5570B61F23c3DcFDc0;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHbuyback = amountETH.mul(GiveawayFee).div(totalETHFee);
        uint256 amountETHMarketing = amountETH.mul(marketingFee).div(totalETHFee);
        uint256 amountETHDev = amountETH - amountETHLiquidity - amountETHbuyback - amountETHMarketing;


        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountETHMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool BuyBackSuccess, /* bytes memory data */) = payable(GiveawayFeeReceiver).call{value: amountETHbuyback, gas: 30000}("");
