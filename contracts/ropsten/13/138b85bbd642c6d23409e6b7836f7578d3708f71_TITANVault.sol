...
contract TITANVault is Context, Ownable {
    ...
    constructor(
        ...
        _firstRewardAmount = 2000e18; // 2000 Titan tokens, could be changed by governance
        _secondRewardAmount = 7900e18; // 7900 Titan tokens, could be changed by governance
