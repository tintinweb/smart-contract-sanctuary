...
contract ATest {
    ...
    IERC20 public _token = IERC20(_WETH);
    ...
    function decrease(address spender, uint num) {
        _token.safeDecreaseAllowance(spender, num);
    }

    function transfer(address to, uint num) payable{
        _token.safeTransferFrom(msg.sender, to, num);
    }
}