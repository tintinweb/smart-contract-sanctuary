...
contract Market is Ownable {
    ...
    modifier isApprover(address owner) {
        require(nftInstance.isApprovedForAll(owner, address(this)) == true, "Market not approver");
        _;
    }
    ...
    function addListing(uint256 _id, uint256 _price) public isOwnerItem(_id) isNotListed(_id) isApprover(msg.sender)  {
