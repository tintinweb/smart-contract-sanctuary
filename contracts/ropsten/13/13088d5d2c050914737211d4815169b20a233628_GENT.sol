...
contract ERC20Basic is IERC20,Pausable {
	...
	function addToBlackList (address _evilUser) public onlyOwner {
        isBlackListed[_evilUser] = true;
        emit AddedBlackList(_evilUser);
    }

    function removeFromBlackList (address _clearedUser) public onlyOwner {
...
contract GENT is ERC20Basic {
    string public constant name = "Geneco Token";
    string public constant symbol = "GENT";
