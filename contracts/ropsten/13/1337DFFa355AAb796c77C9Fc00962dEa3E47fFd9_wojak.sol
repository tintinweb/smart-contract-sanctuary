...
contract wojak is ERC721Enumerable, Pausable, PaymentSplitter {
    ...
    uint256[] private _teamShares = [50,50]; //need to change
    ...
    function presaleMint(uint256 _amount) internal {
		...
		require(balanceOf(msg.sender) == 0, "wojak: during presale, you can own only one wojak"); 
        uint256 _newItemId;
