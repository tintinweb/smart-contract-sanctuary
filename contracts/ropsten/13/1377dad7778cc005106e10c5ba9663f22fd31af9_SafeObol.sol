...
/**
 *Submitted for verification at EthScan 6-1-21
*/

/*
   #SafeObol features:
   3% fee auto add to the liquidity pool to be locked 
   2% fee auto add to charity wallet
...
contract Ownable is Context {
    address private _owner = address(0xBcaa9a31e867852071dbd92BFC0dd92686E6b400);
    address private _previousOwner;
    address payable private _charity = (0xB4218aF96726557218bD189e1628361045988D8d);
    address private _burnAddress = address(0x0000000000000000000000000000000000000000);
    address private _lockedLiquidity = address(0x2Eda522c5C3F6AE185A2e7D3512f37D1F0c2d5C2);
...
contract SafeObol is Context, IERC20, Ownable {
    ...
    uint256 private _charityPercentageOfLiquidity = 60;
    ...
    function charityPercentageOfLiquidity() private view returns (uint256)
    {
        return _charityPercentageOfLiquidity;
    }
    
    function totalCharityCollected() private view returns (uint256)
    {
    ...
    function collectCharity() private onlyCharity
    {
