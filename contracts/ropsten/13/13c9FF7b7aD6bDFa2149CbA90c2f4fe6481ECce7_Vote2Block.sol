...
contract Vote2Block {
    ...
    function Voting(
        ...
        PemilihData memory pemilih = pemilihData[voterAddress];
        require(!pemilih.votingStatus, "Pemilih sudah menggunakan hak pilih");
        require(pemilih.hakPilih != 0, "Pemilih tidak memiliki hak pilih");
        pemilih.votingStatus = true;
        pemilih.kandidatPilihan = _kandidatID;
        uint256 kandidatIndex = _kandidatID - 1;
        kandidat[kandidatIndex].totalVote += pemilih.hakPilih;
