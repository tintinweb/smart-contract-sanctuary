...
contract USEComptrollerV2 is AccessControl{ 
    ...
    uint256 public sharePriceLevelPercent = 97;  //3%
    ...
    function getSharePrice() public view returns(uint256){
        ...
        uint256 _collateral_price = IUSEPool(useVaultPool).getCollateralPrice();
        return _amount.mul(_collateral_price).div(1e18);
    }
