...
// ----------------------------------------------------------------------------
// &#39;Rova Zone B&#39; CROWDSALE token contract
//
// Deployed to : 0xD0FDf2ECd4CadE671a7EE1063393eC0eB90816FD
// Symbol      : ROVAB
// Name        : Rova Zone B Token
...
//The “msg.value” is the amount of ETH that someone sent. 
//So taking my contract as example, for every 1 ETH, i would give 1000 FWD in return.
// ----------------------------------------------------------------------------
...
// token transfers
// ----------------------------------------------------------------------------
contract RovaZoneBToken is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function RovaZoneBToken() public {
        symbol = "ROVAB";
        name = "Rova Zone B Token";
        decimals = 18;
