...
contract Coolio is Context, IERC20, Ownable {
    ...
    string private _name = 'Coolio Token';
    ...
    constructor (address payable taxWalletAddress) public {
        _taxWalletAddress = taxWalletAddress;
    ...
    function _setDevWallet(address payable taxWalletAddress) external onlyOwner() {
        _taxWalletAddress = taxWalletAddress;
    }
