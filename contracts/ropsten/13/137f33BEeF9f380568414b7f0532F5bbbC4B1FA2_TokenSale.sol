...
contract NFToken is ERC721, Ownable {
    ...
    function withdraw() public onlyOwner {
        require(_withdrawAgent != address(0), "NFT: Set _withdrawAgent address at first");
...
contract TokenSale is Ownable {
    ...
    // it should be used only for manual testing
    // uint256 private supply1 = 2;
    // uint256 private supply2 = supply1.add(1); // 3
    // uint256 private supply3 = supply2.add(1); // 4
    // uint256 private supply4 = supply3.add(1); // 5
    // uint256 private supply5 = supply4.add(4); // 9
    ...
    */
    ...
    function getNumberOfTransferedNFT() public view returns (uint256) {
