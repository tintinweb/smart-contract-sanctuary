...
contract BoringStoneSpecialEditions is ERC1155, ERC1155Supply, ERC1155Burnable, Ownable, ReentrancyGuard {
    ...
    uint256 public maxTokensPublic  = 4000;
    ...
    uint256 public maxTokensPresale = 4000;
    ...
    */
     ...
     */
    function mintPresaleMerkle(uint256 numberOfTokens, bytes32[] calldata _merkleProof) external payable {
