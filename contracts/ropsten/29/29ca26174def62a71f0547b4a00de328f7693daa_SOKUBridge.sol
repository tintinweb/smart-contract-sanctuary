...
contract SOKUBridge is Ownable {
    using SafeMath for uint256;

    address payable public admin; // Admin account/server that calls withdrawTo
    ERC20 public token; // Token that will be withdrawn/deposited. This should be soku token.
    ...
    function depositFrom(uint256 amount) public payable {
        ...
        require(
            ...
            "Cannot deposit more than your balance"
        );
    ...
    function withdrawTo(
        ...
        require(
            ...
            "Cannot withdraw more than the vault balance"
        );
        require(
    ...
    function releaseFunds() external onlyOwner {
        uint256 soku = token.balanceOf(address(this));
        IERC20(token).transfer(admin, soku);
    }
