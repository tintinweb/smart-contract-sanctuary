...
/*
	This ERC20 Token: Hitchhiker&#39;s Guide to the Galaxy (H2G2) is NOT meant to have any intrinsic (fundamental) value nor any monetary value whatsoever.
	It is designed to honour the memory of Douglas Noel Adams. However, it is possible that this token may accrue value over time, although this is
	HIGHLY UNLIKELY. Any such valuation would likely be based entirely upon speculation, current market condtions, the actions of other fanatical
	Douglas Adams fans (such as myself) and a myriad of other such conditions and/or factors. These factors and conditions may include, but are not
	limited to, the magnitude (quantity) and frequency (volume) of funds being traded for this token, if any. In the unlikely event that this token
	should gain monetary value at some future date, then a novel use of this token might be to trade value and/or pay for memorabilia between fans and
	collectors of Douglas Adams memorabilia, publications and so forth. Again, do NOT count on this token to aquire any value of any kind as it has
	been created solely for the purpose of honouring the memory of Douglas Adams. Should you decide to purchase this token which, again, is NOT
	...
	utility of this Token, as there are far more than 42 fans of Douglas Adams in this Universe. The following text has been lifted from WikiPedia on
	...
	2005. In 2017, BBC Radio 4 announced a 40th-anniversary celebration with Dirk Maggs, one of the original producers, in charge. This sixth series of
	the sci-fi spoof has been based on Eoin Colfer&#39;s book And Another Thing, with additional unpublished material by Douglas Adams. The first of six new
	episodes was broadcast on 8 March 2018. The broad narrative of Hitchhiker follows the misadventures of the last surviving man, Arthur Dent,
	following the demolition of the planet Earth by a Vogon constructor fleet to make way for a hyperspace bypass. Dent is rescued from Earth&#39;s
	...
	hitchhiking onto a passing Vogon spacecraft. Following his rescue, Dent explores the galaxy with Prefect and encounters Trillian, another human that
	had been taken from Earth prior to its destruction by the President of the Galaxy, the two-headed Zaphod Beeblebrox, and the depressed Marvin, the
	Paranoid Android. Certain narrative details were changed between the various adaptations.
	...
	for each new adaptation. Throughout all versions, the series follows the adventures of Arthur Dent, a hapless Englishman, following the destruction
	of the Earth by the Vogons, a race of unpleasant and bureaucratic aliens, to make way for an intergalactic bypass. Dent&#39;s adventures intersect with
	several other characters: Ford Prefect (who named himself after the Ford Prefect car to blend in with what was assumed to be the dominant life form,
	automobiles), an alien from a small planet somewhere in the vicinity of Betelgeuse and a researcher for the eponymous guidebook, who rescues Dent
	from Earth&#39;s destruction; Zaphod Beeblebrox, Ford&#39;s eccentric semi-cousin and the Galactic President; the depressed robot Marvin the Paranoid
	...
	Hungarian (Galaxis &#218;tikalauz stopposoknak), Italian (Guida galattica per gli autostoppisti), Japanese (銀河ヒッチハイク・ガイド), Korean (은하수를 여행하는
	히치하이커를 위한 안내서), Latvian (Galaktikas ceļvedis stopētājiem), Norwegian (Haikerens guide til Galaksen, first published as P&#229; tommeltotten til
