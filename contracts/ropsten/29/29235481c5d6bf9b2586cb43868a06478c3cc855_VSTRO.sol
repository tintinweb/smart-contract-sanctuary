...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory VSTRO_, string memory VST_) {
        _VSTRO = VSTRO_;
        _VST = VST_;
...
/**
 * @dev Contract for VSTRO token
 */
contract VSTRO is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 2_000_000_000e18;

    constructor() ERC20("VSTRO", "VST") {
