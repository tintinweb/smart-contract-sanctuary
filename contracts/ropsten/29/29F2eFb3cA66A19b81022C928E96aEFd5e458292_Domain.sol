...
//ERC721("Domain Name Token", "DOMAIN")
//ERC721Enumerable,
/*
...
contract Settings is AccessControlEnumerable {
    ...
    /*  
        mapping(bytes32=>uint256) uintSettingsPrivilege;
        mapping(bytes32=>uint256) addressSettingsPrivilege;
        enum Privilege {
        OWNER,
        VOTER,
        CONSTANT,
...
/*
.call(bytes4(keccak256("method(uint,uint,uint)")))
