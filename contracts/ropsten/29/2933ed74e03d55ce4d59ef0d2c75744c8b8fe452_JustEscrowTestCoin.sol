...
contract JustEscrowTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function JustEscrowTestCoin() {
        ...
        name = "JustEscrowTestCoin";                                 // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "JECN";                                             // Set the symbol for display purposes (CHANGE THIS)
