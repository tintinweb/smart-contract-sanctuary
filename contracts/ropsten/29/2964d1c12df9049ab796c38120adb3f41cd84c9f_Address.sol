...
contract Raverse is Context, IERC20, Ownable {
	...
	uint256 public _devFee = 1; // 1% to dev wallet
	uint256 private _previousDevFee = _devFee;
	address public devWallet = address(0x9649d8CF7AD76cB886eBe58c47e66cC349aca4B7);
	...
	function _takeDevFee(address sender, uint256 tAmount) private {
		...
		emit Transfer(sender, devWallet, tDevFee);
	}
