...
contract MasterCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MasterCoin() {
        ...
        name = "MasterCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-003";                                             // Set the symbol for display purposes (CHANGE THIS)
