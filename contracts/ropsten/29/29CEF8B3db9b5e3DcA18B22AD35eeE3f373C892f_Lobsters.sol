...
contract Lobsters is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Date of release;
    uint public releaseTimestamp = 1638183600;
    ...
    address private royaltyAddress = address(0);
    uint256 private ROYALTY_SIZE = 125; // 2.5%
    uint256 private constant ROYALTY_DEMONINATOR = 5000;
