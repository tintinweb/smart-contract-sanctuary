...
interface ICryptoAnts is IERC721 {
  ...
  /**
   * @dev Returns the actual max amount of eggs an ant can product from hatching.
   */
  function getMaxEggsPerHatch() external view returns (uint256);

  /**
   * @dev Sets the actual max amount of eggs an ant can product from hatching.
   *
   * Requirements:
   * - Only governance can execute this call.
   */
  function setMaxEggsPerHatch(uint256 _newPrice) external;

  /**
   * @dev Returns the actual probability of an ant dying after hatching.
   */
  function getDeathHatchProb() external view returns (uint256);

  /**
   * @dev Sets the actual probability of an ant dying after hatching.
   *
   * Requirements:
   * - Only governance can execute this call.
   */
  function setDeathHatchProb(uint256 _newPrice) external;
   ...
   */
  event EggsHatched(address caller, uint256 antId, uint256 eggsToHatch);
  /**
