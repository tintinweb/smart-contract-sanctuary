...
contract SnowDaqRegistry {
   ...
   */
   ...
   mapping(address => bool) validSnowDaqKeys;
    ...
    */
    ...
    function isValidSnowDaqSender(address sending_key) public view returns (bool) {
      return(validSnowDaqKeys[sending_key]);
    }
       ...
       */
       ...
       function addSnowDaqKey(address new_sending_key) external onlyOwner {
           validSnowDaqKeys[new_sending_key] = true;
       }
       
       function removeSnowDaqKey(address sending_key) external onlyOwner {
           validSnowDaqKeys[sending_key] = false;
       }
   ...
   /// @dev Contract constructor sets initial owners and required number of confirmations.
        ...
        public
    {
        ...
        for (uint i=0; i<signing_keys.length; i++) {
            ...
            validSnowDaqKeys[signing_keys[i]] = true;
        }
    }
