...
contract xxxLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function claim(uint256 tokenId) public nonReentrant {
        require(tokenId > 0 && tokenId < 7878, "Token ID invalid");
        if (block.timestamp < openSale) {
            require(lootContract.ownerOf(tokenId) == msg.sender, "Not your loot.  Wait until the Looter mint ends");
        }
    ...
    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
        // Let Dom claim some
        require(tokenId > 7877 && tokenId < 8001, "Token ID invalid");
