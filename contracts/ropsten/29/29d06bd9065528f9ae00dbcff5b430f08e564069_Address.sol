...
library Address {
     ...
     *
     * Among others, `contract will return false for the following
     * types of addresses:
     *
...
contract TINVILLETOKEN is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 375e10;
    uint256 private numTokensSellToAddToLiquidity = 375e9;
...
function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        require(balanceOf(recipient)+tAmount <= buyLimit || block.timestamp > (startTime+buyLimitTimeSec));
        uint256 currentRate =  _getRate();
