...
contract NFTMarketplaceStorage {
    ...
    event OfferBought(address _contract, uint256 _tokenId, uint256 _buyPrice, address from);
    event OfferCanceled(address _contract, uint256 _tokenId, address from);
