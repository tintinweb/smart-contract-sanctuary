...
contract VestingWallet is Context {
    ...
    uint64 private immutable _window;
    ...
    modifier releaseWindow() {
        require(block.timestamp - _lastRelease >= _window, "You must wait for the next release window");
     ...
     */
    function release() public virtual releaseWindow() {
     ...
     * Emits a {TokensReleased} event.
     */
    function release(address token) public virtual releaseWindow() {
