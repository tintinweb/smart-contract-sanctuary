...
contract eGold is BEP20Interface, Tokenlock, UserLock {
    ...
    constructor(address account) public {
        _name = "eGold";  //Token Name
        _symbol = "eGold"; //Token Symbol
        _decimals = 18;  //Decimals
         _totalSupply = 1000000000000 * 10**18;  //Total Supply
