...
contract Ownable {
    ...
    function Ownable() public {tokenOwner = msg.sender;}
...
contract PoSMiningStandard {
    ...
    event PublicMining(address indexed _address, uint _reward);
}
...
contract BlockMiner is ERC20, PoSMiningStandard, Ownable {
...
//--------------------------------------------------------------------------------------
    ...
    function publicMining() public onlyMiner returns (bool) {
        ...
        emit PublicMining(msg.sender, reward);
        return true;
    }
    
    function Minter(address tokenOwner) internal {
