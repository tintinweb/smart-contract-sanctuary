...
contract FruitFarm is Ownable {
	...
	address payable public stackingPoolAddress = 0xce6B5a26AE356C21aD061DB305Af97e686DfE159;
    ...
    constructor (address _owner) public{
        ...
        _symbol = "FRUIT";
        _decimals = 18;
        _mint(_owner, 2000000*10**uint256(_decimals));
        _mint(_team, 500000*10**uint256(_decimals));
