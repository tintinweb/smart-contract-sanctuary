...
contract BookStore is Ownable {
    ...
    string constant private NOT_ENOUGH_BALANCE = "Not enough balance";
    ...
    function rentBook(uint _bookId) external {
        ...
        // LIBToken.approve(spender, amount);

        // uint256 allowance = LIBToken.allowance(msg.sender, address(this));
