...
contract EthRewardPool is Ownable {
  ...
  function stake() external payable {
    ...
    rewardDiscount[msg.sender] = rewardDiscount[msg.sender].add(rewardPerToken.mul(msg.value).div(decimalFactor));
  ...
  function withdraw() external {
    ...
    uint256 rewardAmount = userBalance.mul(rewardPerToken).div(decimalFactor);
