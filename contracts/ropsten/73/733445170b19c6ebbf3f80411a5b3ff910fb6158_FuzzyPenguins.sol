...
contract FuzzyPenguins is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    uint public constant AIRDROP_QUANTITY = 50;
    ...
    constructor() ERC721("FuzzyPenguins", "FPS") {
    }
    ...
    function mintPresale(uint256 amount) public payable {
        ...
        require(balanceOf(msg.sender) + amount <= 5, 'Each address may only buy 5 FuzzyPenguins in presale');
