...
contract Pinguin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pinguin-Coin";
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 105;
        _rOwned[address(this)] = _rTotal / 1000 * 695;
        ...
        marketingAddress = payable(0x2cDD71A66C576A96D8562f72E9dF3402A8217D41); // Marketing Address
        
        devAddress = payable(0x2cDD71A66C576A96D8562f72E9dF3402A8217D41); // Dev Address
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 105 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 695 / 1000);
    }
