...
contract Cete is Context, Ownable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    receive() external payable {
        ...
        require(numberOfNfts <= balanceOf(address(this)), "Not have enough available tokens");
        require(amount <= 50, "You may not buy more than 50 NFTs at once");
        require(MaxSupply <= totalSupply().add(numberOfNfts), "Cannot exceed MaxSupply");
        ...
        emit Transfer(address(this), msg.sender, mintIndex);
