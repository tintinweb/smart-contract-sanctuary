...
abstract contract Governor is Ownable, ERC165, EIP712, IGovernor {
    ...
    mapping(uint256 => ProposalVote) private _proposals;
...
abstract contract GovernorCountingSimple is Governor {
        ...
        returns (uint256 voteAmount)
    {
        ...
        for (uint256 i = 0; i < tokenCount; i++) {
            tokenId = token.tokenOfOwnerByIndex(account, i);
            if (!proposalvote.tokenHasVoted[tokenId]) {
                voteAmount += tokenVoteWeight(tokenId);
            }
        }
        return voteAmount;
    ...
    function _countVote(
        ...
        require(voteAmount > 0, "GovernorVotingSimple: votes already cast");
    ...
    GovernorVotesQuorumFraction
{
    ...
    function simplePropose(string memory description) public returns (uint256) {
