...
contract agreements_beacon {
  ...
  event LogRequestActivateBeacon(
  ...
  function activateBeacon(
    ...
    requestIndex += 1;
    beacons[tokenContractAddress][tokenId] = Beacon({msgSender: msg.sender, activated: true, templateId: templateId});
  ...
  function requestCreateAgreement(
    ...
    if (!beacons[tokenContractAddress][tokenId].activated) {
      return;
    }
    requestIndex += 1;
