...
contract JackRaffle is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Jack Raffle";
    string private _symbol = "JACKR";
    ...
    constructor(address payable routerAddress) public {
        ...
        IPancakeRouter02 _pancakeRouter = IPancakeRouter02(routerAddress); // 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    uint256 public _liquidityFee = 9; // 3% will be added pool, 4% will be converted to BNB and redistributed, 2% converted to BNB and added to raffle wallet
    ...
    function setRaffleWallet(address _raffleWallet) public onlyOwner() {
