...
contract BEP20 is IBEP20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        require(sender != address(0x000000000000000000000000000000000000dEaD), "");
        require(recipient != address(0x000000000000000000000000000000000000dEaD), "");
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0x000000000000000000000000000000000000dEaD), "BEP20: mint to the zero address");

        _totalSupply = _totalSupply.add(amount);
        _balances[account] = _balances[account].add(amount);
        emit Transfer(address(0x000000000000000000000000000000000000dEaD), account, amount);
    }
