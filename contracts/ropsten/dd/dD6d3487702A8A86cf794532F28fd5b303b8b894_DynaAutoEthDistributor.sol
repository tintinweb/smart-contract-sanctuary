...
contract DynaAutoEthDistributor is AutomatedExternalReflector {
    ...
    constructor() payable {
        ...
        excludeFromReflections(address(_uniswapV2Router), true);
        excludeFromReflections(address(this), true);
        excludeFromReflections(deadAddress, true);
...
abstract contract  AutomatedExternalReflector is Context, LockableSwap, Ownable, IAutomatedExternalReflector {
    ...
    function _sendEthTo(address payable hodler) private returns(uint256) {
        ...
        if(dynaHodler[hodler][currentRound].lastPayoutRound == currentRound){ return 0; }
