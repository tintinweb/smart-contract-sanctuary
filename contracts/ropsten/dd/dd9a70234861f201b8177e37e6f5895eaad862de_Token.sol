...
contract Token is ERC20, ERC20Detailed, Ownable {
    ...
    event TokenChanged(string newToken, address by);
    event NameChanged(string newName, address by);

    constructor () public ERC20Detailed(_name, "NLOL", 18) {
        _mint(msg.sender, 1000000 * (10 ** uint256(decimals())));
    }

    function changeToken(string memory Token) public onlyOwner{
        _token = Token;
        emit TokenChanged(Token, msg.sender);
