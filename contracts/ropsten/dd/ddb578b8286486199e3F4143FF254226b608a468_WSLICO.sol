 ...
 */
contract WSL is ERC20Interface{
    
    string public name = "WenShan Lake";
...
contract WSLICO is WSL{
    ...
    uint tokenPrice = 0.1 ether; //1 WSL = 0.001ETH or 1ETH = 1000WSL
    uint public hardCap = 20210611 ether; //Max amount
    
    uint public raisedAmount; //Total amount of ETH sent to ICO
    uint public saleStart = block.timestamp;
    uint public saleEnd = block.timestamp + 2592000; //ICO ends in one month
    uint public tokenTradeStart = saleEnd + 2592000; //transferable in a well after sale end    
