...
contract HumanStandardToken is StandardToken {
    ...
    */
    string public constant name = "RopstenHydra";                   //fancy name.
    uint256 public constant decimals = 12;                //How many decimals to show.
    ...
    function HumanStandardToken() public {
        totalSupply = 33550336 * 10**decimals;                        // Update total supply
