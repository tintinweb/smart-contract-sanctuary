...
contract test is Token {
    ...
    string public name = "My MBTT"; //名称，例如"My test token"
    uint256 public decimals = 18; //返回token使用的小数点后几位。比如如果设置为3，就是支持0.001表示.
    string public symbol = "MBTT"; //token简称,like MTT
