...
contract chetan is EIP20Interface {
...
contract EIP20Factory {
    ...
    function EIP20Factory() public {
        ...
        address verifiedToken = createEIP20(2000000000000, &quot;chetan&quot;, 5, &quot;che&quot;);
    ...
    returns (address) {
        ...
        chetan newToken = (new chetan(_initialAmount, _name, _decimals, _symbol));
