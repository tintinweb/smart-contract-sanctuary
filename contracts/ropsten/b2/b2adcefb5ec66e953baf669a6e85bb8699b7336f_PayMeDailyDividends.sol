...
/**
*
* ETH CRYPTOCURRENCY "Pay Me Daily Dividents" PROJECT
* Web              - https://amisolution.github.io/ERC20-AMIS/pmdd
* Twitter          - https://twitter.com/amis_erc20
* 
*  - GAIN 3,33% PER HOUR (every 246 blocks)
*  - Life-long payments
*  - The "Pay Me Daily Dividents" PMDD reliability
*  - Minimal contribution 0.001 eth
*  - Currency and payment - ETH
*  - Contribution allocation schemes:
*    -- 90% payments
*    -- 10% Marketing + Operating Expenses
*
*   ---About the "Pay Me Daily Dividents" Project
*  Blockchain-enabled smart contracts have opened a new era of trustless relationships without 
*  intermediaries. This technology opens incredible financial possibilities. The "PMDD" automated investment and
*  divident payment distribution model is written into a smart contract, uploaded to the Ethereum blockchain and can be 
*  freely accessed online. In order to insure our investors&#39; complete security, full control over the 
*  project has been transferred from the organizers to the smart contract: nobody can influence the 
*  "Pay Me Daily Dividents" PMDD&#39;s engine.
* 
* ---How to use:
*  1. Send from ETH wallet to the smart contract address 
*     any amount from 0.001 ETH.
...
* 
* Main contract - PayMeDailyDividends. Scroll down to find it.
*/
...
contract PayMeDailyDividends is Accessibility, PaymentSystem {
  ...
  uint public constant pauseOnNextWave = 8 hours; 
  ...
  function payout() public notOnPause onlyAdmin(AccessRank.Payout) atPaymode(Paymode.Push) balanceChanged {
    ...
    if (m_paysys.latestKeyIndex == m_investors.iterStart()) {
      require(now>m_paysys.latestTime+2 hours, "the latest payment was earlier than 2 hours");
