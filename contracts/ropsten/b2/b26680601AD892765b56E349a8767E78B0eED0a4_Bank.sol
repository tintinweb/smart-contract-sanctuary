...
contract Bank is Ownable, SafeMath {
    ...
    string public bankOwnerName;
    
    event Deposit(address account, uint amount);
    event Withdraw(address account, uint amount);
    
    // Set initial bank owner name
    constructor() {
        bankOwnerName = "Bernard";
    }
    
    function setBankOwnerName(string memory _bankOwnerName) public onlyOwner {
        bankOwnerName = _bankOwnerName;
    }
    ...
    function myBalance() public view returns (uint) {
        return sub(deposits[msg.sender], withdrawals[msg.sender]);
    }
}