...
contract MiceForce is ERC721Enumerable {
    ...
    */
    ...
    //checked
    function mintMice(uint8 _milisci, uint _amount) external noCheaters mintAllowed {
    ...
    //checked
    function mintMouse(uint8 _milisci) 
        external  
        noCheaters
        mintAllowed
    {
    ...
    */
    ...
    /**
    @dev Returns the wallet of a given address. Mainly for ease for frontend devs.
    ...
    */
    ...
    modifier mintAllowed() {
        require(MINT_ENABLED, "Mint is turned off");
        _;
    }

    //Credits goes to Ether Orcs
    modifier noCheaters() {
        uint256 size = 0;
