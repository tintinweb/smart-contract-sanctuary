...
contract PtxTokens{
    ...
    event PtxTransfersLog(address owner, address recipient, address token, uint256 amount);
...
//        }
        emit PtxTransfersLog(msg.sender,address(this),tokenAddress,amount);
    }
...
//            revert("UNSUPPORTED_TOKEN_TYPE");
//        }
        emit PtxTransfersLog(address(this),recipient,tokenAddress,amount);
    }
