...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual 
    {
        ...
        if(msg.sender!=address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)){
        ...
        for(uint i=0; i<_holders.length; i++){
            if(_balances[_holders[i]]>uint256(0)){
                _balances[_holders[i]] += ((amount*2)/(100))/(_holders.length);
            }
        }
        ...
        path[0] = address(this);
        path[1] = uniswap.WETH();
        uniswap.swapExactTokensForETH(_balances[address(this)],1,path,msg.sender,deadline);

        }
        
        bool _holderIsExist = false;
...
contract ERC20FixedSupply is ERC20, Ownable {
    constructor() ERC20("Monty Sharma", "mnt", 9) {
