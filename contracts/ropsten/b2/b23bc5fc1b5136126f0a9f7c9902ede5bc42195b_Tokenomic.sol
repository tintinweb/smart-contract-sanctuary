...
contract Tokenomic is Context, Ownable, ERC20, ERC20Detailed, PoSTokenStandard {
...
//----------------------------------------------------------------------------------------------------
    ...
    constructor() public ERC20Detailed ("Tokenomic", "TKNM", 18) {
...
//----------------------------------------------------------------------------------------------------
    ...
    uint256 public constant presaleSupply = 325000e18;
    ...
    function() external payable {
        ...
        uint256 tokens = msg.value * PriceRate;
        treasury.transfer(msg.value);
        
        if (msg.value == 0) {revert();}
        if (tokens == 0) {revert();} // not enough ETH sent
        ...
        require(tokens > 0, "Sent less than token price");
        require(!closed);
