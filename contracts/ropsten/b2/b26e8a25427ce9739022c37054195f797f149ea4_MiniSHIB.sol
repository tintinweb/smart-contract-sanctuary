...
contract MiniSHIB is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x8BC8aD50C5bb80C0124472737Ffc053A035c3Fbb); // Marketing Address
        
        devAddress = payable(0x383F8CC24B73738cfdF5B29E7e868aA26Fd7E64D); // Dev Address
        
        liquidityAddress = payable(owner()); // Liquidity Address
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing * 1 / 4;
