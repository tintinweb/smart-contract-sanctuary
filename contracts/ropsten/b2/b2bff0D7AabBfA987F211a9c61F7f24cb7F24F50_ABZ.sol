...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ETH = IBEP20(0x0a180A76e4466bF68A7F86fB029BEd3cCcFaAac5);
...
contract ABZ is IBEP20, Auth {
    using SafeMath for uint256;

    address ETH =  0x0a180A76e4466bF68A7F86fB029BEd3cCcFaAac5;
    address WETH = 0x0a180A76e4466bF68A7F86fB029BEd3cCcFaAac5;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ABZ TOKEN";
    string constant _symbol = "ABZ";
   ...
   // buy fee
    ...
    //PreSale settings
    uint256 public preSale_RATE = 1000; //per Bnb
    bool public enablePresale =false;
    uint256 private maxBNBPurchaseLimit = 1e18; // 1 BNB
    mapping (address => uint256) _maxPresaleBnb;
    ...
    address public Owner=0x7FFC0CBB10311217911AFCd559253B2A516E356C; 
    ...
    constructor () Auth(Owner) {
        router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Pcs v2 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        devFeeReceiver = 0x4a9fA60F52b772126C4Cfe5912Fd8b74B462F91A; //Dev address
    ...
    function setFeeReceivers(address _autoDeadWallet, address _marketingFeeReceiver) external authorized {
    ...
    function setPresaleEnable(bool _val) external authorized {
        enablePresale = _val;
    }

    /*
        put _rate value like ( 1 Bnb = _rate) where as _rate is the token amount 

        you want to set for 1 bnb
    */
    function setPresaleRate(uint256 _rate) external authorized {
        preSale_RATE = _rate;
    }

    function setMaxBnBLimit(uint256 _value) external authorized {
        maxBNBPurchaseLimit =_value;
    }
   
    receive() external payable {
        if(!inSwap){
        require( !enablePresale ,"pre sale is finalize");
        require(_maxPresaleBnb[msg.sender] <= maxBNBPurchaseLimit && msg.value <= maxBNBPurchaseLimit,"Max purchasing limit exceeds");
        _maxPresaleBnb[msg.sender] +=msg.value;
