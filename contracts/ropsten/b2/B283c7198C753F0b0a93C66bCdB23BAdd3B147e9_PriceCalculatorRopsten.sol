...
contract PriceCalculatorRopsten is Initializable, PriceCalculator{
  ...
  // USDC is default
  address  constant public DEFAULT_BASE_TOKEN = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F;

  function initialize(address _controller) public initializer {
    PriceCalculator.initializeBase(_controller);
    //USDC
    addKeyToken(0x07865c6E87B9F70255377e024ace6630C1Eaa37F);
    //WETH
    addKeyToken(0x0a180A76e4466bF68A7F86fB029BEd3cCcFaAac5);
