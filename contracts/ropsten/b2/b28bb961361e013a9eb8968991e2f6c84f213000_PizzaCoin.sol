...
contract Teamable is ERC20Token {
    ...
    event NewTeam(string indexed name, uint256 indexed index, address indexed creator);
    event NewMember(string indexed name, uint256 indexed teamIndex, address indexed userAddress);
