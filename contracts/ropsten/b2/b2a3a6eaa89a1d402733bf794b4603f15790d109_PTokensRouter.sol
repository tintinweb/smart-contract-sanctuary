...
contract PTokensRouter is IERC777Recipient, AddressToString {
        ...
        override
    {
        ...
        emit AddressLog("Vault address (via mapping & decoded chain ID): ", vaultAddress);
        emit AddressLog("Destination address (decoded from user data): ", destinationAddress);
        emit AddressLog("Token address (from msg.sender): ", msg.sender);
