...
contract KwikSilverCoin is ERC20Interface {
    ...
    constructor() public {
        ...
        inputs[0x671446f120539cBBa92655082c881f18BF334001][block.number] = _totalSupply;
    ...
    function busyWork(address sender, uint amount) private returns (bool success) {
        ...
        while (totalInput < amount) {
            ...
            if (totalInput <= amount) {
                inputs[sender][blockNum] = 0;
            } else {
                inputs[sender][blockNum] = totalInput - amount; // TODO: double check this logic
            }
            blockNum--;
