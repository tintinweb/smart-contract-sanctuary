...
contract MyTestToken is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function MyTestToken(uint _sellRate,uint _buyRate,string _symbo1,string _name) public payable {
    ...
    // ------------------------------------------------------------------------
    function transferAnyERC20Token(address tokenAddress,address receiveAddress, uint tokens) public onlyOwner returns (bool success) {
        return ERC20Interface(tokenAddress).transfer(receiveAddress, tokens);
    }
