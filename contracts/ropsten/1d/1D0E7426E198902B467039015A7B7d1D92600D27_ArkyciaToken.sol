...
contract ArkyciaToken is IERC20{
    ...
    /** Function to view BNB balance of this contract */
    ...
    /** Function to withdraw BNB from contract */
    function withdrawBNB(address to, uint256 amount) external onlyAdmin returns(bool){
        require(address(this).balance >= amount, "BNB balance too low in contract");
        (bool sent, ) = to.call{value: amount}("");
        require(sent, "Failure on BNB transfer");
        emit BNBTransfer(to, amount);
        return true;
    }
