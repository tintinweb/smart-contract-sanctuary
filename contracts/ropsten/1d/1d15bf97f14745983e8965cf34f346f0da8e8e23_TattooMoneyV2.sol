...
contract TattooMoneyV2 is IERC20, Owned, DAO {
    ...
    uint256 private _FeeTotalCollected;
    ...
    */
    ...
    function transferFrom( address sender, address recipient, uint256 amount ) external override returns (bool) {
        uint256 amt = allowed[sender][msg.sender];
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external returns (bool) {
        require( allowed[msg.sender][spender] >= subtractedValue, "ERC20: decreased allowance below zero" );
    ...
    function burnFrom(address account, uint256 amount) external {
        ...
        require(allowed[account][msg.sender] >= amount, "ERC20: burn amount exceeds allowance");
    ...
    function _transfer( address sender, address recipient, uint256 Amount ) private {
        ...
        if (Amount > 0) {
            if (isFeeFree[sender]){
                ...
                _FeeTotalCollected += _FeesToTake;
                balances[sender] -= _totransfer;
    ...
    */
    ...
    function setfeesfree() private{
        ...
        isFeeFree[dao] = true;
        isFeeFree[charityaddress] = true;
        isFeeFree[rewardsaddress] = true;
        isFeeFree[systemaddress] = true;
        isFeeFree[stakingaddress] = true;
    }
