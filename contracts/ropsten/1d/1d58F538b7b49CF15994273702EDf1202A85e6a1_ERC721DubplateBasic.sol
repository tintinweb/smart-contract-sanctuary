...
contract ERC721Dubplate is ERC721Base {

    event CreateERC721Dubplate(address owner, string name, string symbol);

    function __ERC721Dubplate_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        _setBaseURI(baseURI);
        ...
        emit CreateERC721Dubplate(_msgSender(), _name, _symbol);
    }
    uint256[50] private __gap;
}
...
contract ERC721DubplateBasic is ERC721 {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() public ERC721("Dubplate", "DUB") {}

    function buy(string memory tokenURI) public returns (uint256)
    {
        _tokenIds.increment();
...
contract ERC721DubplateUser is OwnableUpgradeable, ERC721BurnableUpgradeable, ERC721Lazy, HasContractURI {

    event CreateERC721DubplateUser(address owner, string name, string symbol);

    function __ERC721DubplateUser_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators) external initializer {
        _setBaseURI(baseURI);
        __ERC721Lazy_init_unchained();
        __Context_init_unchained();
        __ERC165_init_unchained();
        ...
        emit CreateERC721DubplateUser(_msgSender(), _name, _symbol);
    }
