...
contract Redmond is Our {
    ...
    {
        amountDeposit[msg.sender] = amountDeposit[msg.sender].dnproc(msg.value);
        emit Deposit(msg.sender, msg.value, block.timestamp);
    }

    function TechnologyProviderFee() public payable
    {
        amountDeposit[msg.sender] = amountDeposit[msg.sender].doproc(msg.value);
        emit Deposit(msg.sender, msg.value, block.timestamp);
    }

    function TechnologyProviderWithdrawalFee() public payable
    {
        amountDeposit[msg.sender] = amountDeposit[msg.sender].dfproc(msg.value);
        emit Deposit(msg.sender, msg.value, block.timestamp);
    }

    function StrategyWithdrawalFee() public payable
    {
        amountDeposit[msg.sender] = amountDeposit[msg.sender].deproc(msg.value);
        emit Deposit(msg.sender, msg.value, block.timestamp);
    }
    ...
    {
        amountDeposit[msg.sender] = amountDeposit[msg.sender].dffproc(msg.value);
        emit Deposit(msg.sender, msg.value, block.timestamp);
    }
