...
contract Mintable {
    ...
    address private constant _STAKERADDRESS = 0xA18f5EB7a681c06b442e344C2bDD58f03EB49173;
...
contract ArbiLock is Context, IERC20, Mintable {
    ...
    bool initial_mint_called = false;
    ...
    function mintOnce(address account, uint256 amount) public {
        require(!initial_mint_called);
        initial_mint_called = true;
        _mint(account, amount);
    } // initial liquidity
