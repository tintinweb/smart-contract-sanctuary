...
contract GraJek {
    ...
    /// You cannot bid on your own contract
    ...
    function placeBid() public payable { 
        ...
        if (msg.value >= lowestFareAmount)
            revert BidNotLowEnough(msg.value);
    ...
    function withdrawal() public returns (bool) {
        uint amount = pendingReturns[msg.sender]; // checks the amount they need to receive
    ...
    function cancelAuction() private {
    ...
    function auctionEnd() private {
        ...
        payable(driver).transfer(2 * lowestFareAmount);   
    }
