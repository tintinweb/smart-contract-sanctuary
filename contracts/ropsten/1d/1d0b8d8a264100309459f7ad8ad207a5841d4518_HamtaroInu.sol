...
contract HamtaroInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x498532a054f1218b899FcC9e28e1384A403b235F));
    address payable public devWallet =
        payable(address(0x498532a054f1218b899FcC9e28e1384A403b235F));
    address public liquidityReceiver =
        0x498532a054f1218b899FcC9e28e1384A403b235F;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = false;

    string private _name = "HamtaroInu";
    string private _symbol = "HAMINU";
