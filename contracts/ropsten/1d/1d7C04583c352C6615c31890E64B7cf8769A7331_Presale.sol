...
//        require(_tokenLaunchTime < block.timestamp);
    ...
    function deployInitialLiquidity() private {
        ...
        uint256 liquidTokenAmount = (totalLiquidityPoolAmount * 95) / 100;
        uint256 liquidEthAmount = (contractBalance * 95) / 100;
        ...
        uniswapV2Router.addLiquidityETH{value: liquidEthAmount }(pasv_token,totalLiquidityPoolAmount,liquidTokenAmount,liquidEthAmount, manager_1, block.timestamp);
