...
contract ColorByNumberOnEth is ERC721, Ownable {
    ...
    uint256 public constant nftPrice = 25000000000000000; // 0.025 ETH

    uint public constant maxNftPurchase = 5;

    uint256 public constant MAX_UNITS = 8888;
    ...
    constructor() ERC721("Color by Number on ETH", "CBN") { }
    ...
    function mintNft(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_UNITS, "Purchase would exceed max supply of Nfts");
        require(msg.value >= nftPrice.mul(numberOfTokens), "Ether value sent is not correct");
        
        for(uint i = 0; i < numberOfTokens; i++) {
            uint mintIndex = totalSupply();
            if (totalSupply() < MAX_UNITS) {
