...
contract NFTMint is ERC721,Sale{
    ...
    function mint(string memory _name, string memory tokenuri, uint256 tokenId, uint256 royal) public returns (bool){
    ...
    function mintwithsale(string memory _name, string memory tokenuri, uint256 value, uint256 tokenId, uint256 royal) public returns (bool){
        require(!_nameexits[_name]);
        _mint(msg.sender, tokenId);
        _creator[tokenId]=msg.sender;
        _royal[tokenId]=royal;
