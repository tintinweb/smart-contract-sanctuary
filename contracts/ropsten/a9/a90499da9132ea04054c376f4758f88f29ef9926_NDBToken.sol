...
contract NDBToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "NDB";
    string  public constant symbol = "NDBCoin";
    ...
    uint256 public tokenExchangeRate = 101;             // 101 NDB 兑换 1 ETH
    ...
    {
        require(currentSupply <= totalSupply,"currentSupply must less than totalSupply");
    ...
    function migrate() external {
        require(!isFunding);
        require(newContractAddr != address(0));
