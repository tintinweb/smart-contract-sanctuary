...
contract RPS { 
    ...
    function createRoom (Hand _hand) external payable isValidHand(_hand) returns (uint roomNum) {
        rooms[roomLen] = Game({
            betAmount: msg.value,
    ...
    function joinRoom(uint roomNum, Hand _hand) external payable isValidHand( _hand) {
