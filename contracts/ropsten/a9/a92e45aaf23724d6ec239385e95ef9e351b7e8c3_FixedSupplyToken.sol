...
contract WithdrawConfirmation is Owned {
	...
	function addOwner(address owner) public ownerDoesNotExist(owner) onlyOwner {
		isOwner[owner] = true;
		owners.push(owner);
		emit OwnerAddition(owner);
	}
	
	function removeOwner(address owner) public ownerExists(owner) onlyOwner {
        isOwner[owner] = false;
...
// fixed supply
// ----------------------------------------------------------------------------
contract FixedSupplyToken is ERC20Interface, Owned, WithdrawConfirmation {
