...
contract StandardToken is IERC20 {
  ...
  address public _crowdsaleAddress;                                                       // Crowdsale Contract address
  ...
  */
  ...
  modifier onlyOwnerOrCrowdsale() {
    require(ownerOrCrowdsale(),"You are not authenticate to make this transfer, Only owner or crowdsale contract can call this");
    _;
  }
   ...
   * @dev Internal function for modifier
   */
  function ownerOrCrowdsale() internal view returns (bool) {
      if(msg.sender == _owner || msg.sender == _crowdsaleAddress){
          return true;
      }
      return false;
  }
   ...
   */
  function burn(uint256 _value) public onlyOwnerOrCrowdsale {
