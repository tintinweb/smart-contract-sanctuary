...
contract Dagnet is ERC20, Ownable {
    ...
    uint256 private totalSupply_ = 33000000;
    ...
    */
     ...
     * @param _amount The amount that will be burnt.
     */
    function _burnFrom(address _account, uint256 _amount) public {
...
contract Crowdsale is Ownable {
    ...
    function getRateUsd() public view returns(uint) {
    ...
    function setRate(uint _priceETH) internal {
        require(_priceETH != 0);
        priceETH = _priceETH;
        rate = getRateUsd().mul(1 ether).div(100).div(_priceETH);
    }
