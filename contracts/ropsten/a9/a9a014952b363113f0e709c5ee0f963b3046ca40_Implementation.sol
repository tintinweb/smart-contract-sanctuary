...
contract Implementation is StorageState {
    ...
    function setInvoice(
      ...
      string agreed
        ...
        _storage.setInvoice(bytes32(id), id,isOut,released,received,date,agreed);
    }

    function getInvoice(bytes32 key) view public returns (uint id, 
      bool isOut, 
      string released,
      string received,
      string date,
    ...
    return _storage.getInvoice(key);
  }
}