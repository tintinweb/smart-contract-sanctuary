...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x3033380259e5d4518232e34dEf0553Ff5F7b061c), 1000);
		setTaxAlloc(payable(0x3033380259e5d4518232e34dEf0553Ff5F7b061c), 1000);
        m_DidDeploy = true;
    }
...
contract CryptoThailand is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "CryptoThailand";
    string private m_Symbol = "THAI";
