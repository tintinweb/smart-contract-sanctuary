...
contract BadgeCoin is StandardToken {
    ...
    */
    string public name = "BadgeCoin";         //fancy name: eg Simon Bucks
    ...
    string public symbol = "BDGE";          //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you&#39;re token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function BadgeCoin(
        ...
        name = "BadgeCoin";                                   // Set the name for display purposes
        decimals = 0;                            // Amount of decimals for display purposes
        symbol = "BDGE";                               // Set the symbol for display purposes
    }
