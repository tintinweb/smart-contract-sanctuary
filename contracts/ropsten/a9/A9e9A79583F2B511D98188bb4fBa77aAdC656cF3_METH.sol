...
** Using FTP LPAdd to recycle 20.00% of ALL transactions back into the liquidity pool. **
...
contract METH is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "METH";
    string private m_Symbol = "METH";
	...
	// LP ADD
    IWETH private WETH;
    uint256 private m_LiqAlloc = 20000;
    // MISC
    ...
    function _walletCapped(address _recipient) private view returns (bool) {
        return _recipient != m_UniswapV2Pair && _recipient != address(m_UniswapV2Router) && block.timestamp <= m_Launched.add(6 hours);
    }
