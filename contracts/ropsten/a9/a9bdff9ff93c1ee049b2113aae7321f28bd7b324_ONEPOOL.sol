...
contract Operable is Ownable {
    ...
    */
    function transferOperatorRole(address newOperator) public onlyOwner {
        ...
        emit OperatorRoleTransferred(operator, newOperator);
 ...
 * allowances. See {IERC20-approve}.
 */
contract ERC20Basic is Context, IERC20 , Ownable, Operable{
    using SafeMath for uint256;
    using Address for address;
...
contract ONEPOOL is ERC20Basic  {
    ...
    constructor () public ERC20Basic ("oneToken", "op") {
       // uint256 _totalSupply = 2500000 * 10 ** 18; // premine
       // _mint(msg.sender, _totalSupply);
       // _moveDelegates(address(0), _delegates[msg.sender], _totalSupply);
    }
   ...
   function burn(uint256 _value) public onlyOperator {
    ...
    function mint(address _account, uint256 _value) public onlyOperator returns(bool) {
