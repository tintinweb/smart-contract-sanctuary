...
contract VladToken is IERC20 {
    ...
    */
    string public name = 'VladToken'; //fancy name: eg OVM Coin
    uint8 public decimals = 18; //How many decimals to show.
    string public symbol = 'VLAD'; //An identifier: eg OVM
    ...
    function sendBalance(address payable receiver) external payable {
