...
https://www.reddit.com/r/xxxxxx



Contract employs a dynamic sell limit based on price impact, increasing sell cooldowns, and redistribution taxes on consecutive sells. This contract is designed to reward project supporters and discourage dumping.
...
7. Sells limited to 2% of the Liquidity Pool, <1.9% price impact 
...
10. 4% redistribution to holders on the first sell, increases 2x, 3x, 4x on consecutive sells
11. Redistribution actually works!
12. 5% developer fee split within the team
...
contract ELITEx is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"ELITEx";
    string private constant _symbol = "ELITEx";
