...
contract bettingInu is ERC20("WOOINU used for betting", "BINU"), ERC20Snapshot{
    ...
    */
    event userBet(uint256 index, uint256 amount, address sender, uint256 choice);
    ...
    * @param snapshotID: Snapshot to store everyones balances for voting
    */
    struct _bet {
        uint256 totalReward;
        uint256 choices;
    ...
    * @param choice: The choice he voted
    * @param amount: Amount of tokens voted
    */
    struct _bet_{
        uint256 choice;
        uint256 amount;
    ...
    * _totalBetted: A mapping of Bet index => Choice => Total amount voted
    */
    _bet[] private _bets;
    ...
    */
    ...
    /**
    * @dev Creates a bet for people to vote on and takes a snapshot of balances(See [email protected]) and emits betcreated
    ...
    */
    ...
    /**
    * @dev Bets on a NFT and emits userBet(), gets balance from snapshot. amount can be 0 to change the choice
    * @param index: The index of the bet
    ...
    */
    ...
    /**
    * @dev Redeems the wrapped tokens for the ERC20
    ...
    */
    ...
    /**
    * @dev Unlocks the users tokens, should cost a bit of gas
    ...
    */
    function collectRewards(uint256 index) external exists(index){
        ...
        require (bets_[sender][index].amount != 0, "BINU: You have not voted on that");
