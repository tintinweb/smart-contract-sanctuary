...
contract CyberAssassins is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, PaymentSplitter {
  ...
  address[] private _creators = [
                                    ...
                                    0x20E84d35D6c1fC7b945AF47D1F027939c9AD55BB, // GalaxyBuilder
                                    0x5A3293DaCa51715c6D1D4a99f99b6A9E336054Fa, // CryptoBull
                                    0xEB3B6049B103FADf19E72557E96d4c23962438Cb, // Topsniper496
                                    0x968e37D83AC8f536779EF2088b5C49C3127438E3, // Okawa
  ...
  function reserveAssassins() external onlyOwner {
    ...
    for (uint256 i = 0; i < _creators.length; i++) {
      ...
      for (k = 0; k < 5; k++) {
        ...
        tokenId = _tokenIdRegularTracker.current();
      ...
      for (k = 0; k < 2; k++) {
        ...
        // Mint super assassin
        tokenId = _tokenIdSuperTracker.current() + SUPER_START_AT;
        _safeMint(wallet, tokenId);
      }
      ...
      tokenId = _tokenIdUltimateTracker.current() + ULTIMATE_START_AT;
      _safeMint(wallet, tokenId);
    }
  ...
  */
   ...
   */
  function mintSuperTokens(uint256 _tokenIdRegular1, uint256 _tokenIdRegular2) external saleIsOpen saleIsOpenForSuper
  {
    address wallet = _msgSender();
