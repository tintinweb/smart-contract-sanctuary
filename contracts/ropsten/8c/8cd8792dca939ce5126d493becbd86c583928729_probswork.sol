...
contract probswork is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "plswork3";                                           // name
    string private _symbol = "plswork3";                                            // symbol
    uint256 private _tTotal = 69 * 10**9;
    ...
    address payable public marketingWallet = payable(0x3251b3C75861f43bD201fDd7409208aF7b012265);
