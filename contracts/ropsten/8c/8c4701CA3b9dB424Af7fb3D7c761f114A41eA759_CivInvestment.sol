...
contract CivInvestment is ICivInvestment, Ownable {
    ...
    function _mintLiquidity(
        ...
        WETH.approve(address(v3NftManager), wethAmount);
        CIV.approve(address(v3NftManager), civAmount);
        ...
        liquidity = liquidity.add(
            _liquidityForAmounts(pool, tickLower, tickUpper, wethAmount, civAmount)
        );
