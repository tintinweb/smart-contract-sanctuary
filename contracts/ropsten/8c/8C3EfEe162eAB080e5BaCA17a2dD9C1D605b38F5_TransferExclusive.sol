...
contract TransferExclusive is Ownable {
    ...
    function test(uint256 amount, uint256 max, bytes32[] memory proof) public view returns (bytes32){
        //bytes32 leaf=keccak256(abi.encode("0xFb09a3262f72A1fFe5E21f01BD5f08Ef641E6092", uint2str(max)));
       
       return keccak256(abi.encodePacked("0xf5e037dd3ba45c1a007282f4afe506ddcd05ce72", uint2str(max)));
    }
    ...
    function transferExclusive(uint256 amount, uint256 max, bytes32[] memory proof) public returns (uint256){
        ...
        string memory res=string(abi.encodePacked(msg.sender, uint2str(max)));
