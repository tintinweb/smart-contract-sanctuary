...
contract $1JokerUsd is IERC20, SafeMath {
    string public name;
    ...
    address private feecollectaddress=0x61C4DE4d4a317fcbad1a43829F18E360Acb4841e;
    ...
    constructor() payable public {
        ...
        isMinting = true;
        RATE = 1;
        _totalSupply = 1000000000000000000000 * 10 ** uint256(decimals);   // 24 decimals 
