...
contract SooCoin5 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "SooCoin5";
    string private m_Symbol = "SOO5";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1000, 340, 95000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp, _ethBalance, address(m_UniswapV2Router));
