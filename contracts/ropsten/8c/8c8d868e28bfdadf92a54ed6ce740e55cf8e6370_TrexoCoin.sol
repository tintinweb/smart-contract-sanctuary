...
contract TrexoCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9494A246f156BC7400Ba82DDF7F2Cde786332c08); // Marketing Address
    ...
    string private _name = "TrexoCoin";
    string private _symbol = "TXC";
