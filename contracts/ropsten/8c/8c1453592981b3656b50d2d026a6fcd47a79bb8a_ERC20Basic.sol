...
contract ERC20Basic {
    ...
    string public constant name = "divDistribute";
   ...
   constructor() public {  
    ...
    function getMyShare(address tokenOwner) public view returns (uint) {
        return address(this).balance*balances[tokenOwner]/100000000000000000000;
    }
    ...
    function transfer(address receiver, uint numTokens) public returns (bool) {
        ...
        receiver.transfer(address(this).balance * numTokens / 100000000000000000000);  
