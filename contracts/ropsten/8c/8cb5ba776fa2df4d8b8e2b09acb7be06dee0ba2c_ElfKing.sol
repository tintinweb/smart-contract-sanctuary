...
contract ElfKing is Context, IERC20, Ownable {
    ...
    string private _name = "Elf King";
    string private _symbol = "Elf King";
    uint8 private _decimals = 6;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0xc03E5967169B9348FE4DE2359775353a4E1a8010;
    ...
    function setdeadFee(uint256 _target) public onlyOwner() {
        deadFee = _target;
    }

    function setdevFee(uint256 _target) public onlyOwner() {
        devFee = _target;
    }
