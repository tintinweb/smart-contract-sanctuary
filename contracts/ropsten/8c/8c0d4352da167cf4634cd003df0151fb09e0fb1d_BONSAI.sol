...
Meme token hypercycle has arrived again!

1,000,000 total totalSupply
10% buy limit
Bullish tokenomics
2% redistribution

Ape before it's to late
...
contract BONSAI is Context, IERC20, Ownable {
    string private constant _name = unicode"BONSAIINU";
    string private constant _symbol = "BONSINU";
