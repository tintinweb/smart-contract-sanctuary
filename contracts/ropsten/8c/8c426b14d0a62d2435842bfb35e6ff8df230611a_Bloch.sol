...
contract Bloch is ERC20, ERC20Detailed,
    ...
    address internal teamDevs = 0x14Dfa531FafEb382971A834A68a26C9af77De655;
    
    //Vault wallet locked automatically until specified time 
    
    address internal vaultWallet = 0x1DAEcc5bb51E8AFD12fACF1E2044546E53B6B7ed;
    ...
    constructor() public ERC20Detailed("Bloch","BLOCH", 18){
        owner = msg.sender;
...
//--------------------------------------------------------------------------------------
    ...
    function() external payable {
        ...
        circulatingSupply = circulatingSupply.add(purchasedAmount);
