...
contract TokenLock {
  ...
  constructor(IERC20 token_, address beneficiary_, address owner_, uint256 releaseTime_, bool ownable_) public {
    _owner = owner_;
    _token = token_;
    _beneficiary = beneficiary_;
    _releaseTime = releaseTime_;
...
contract HanamQuokkaToken is  IERC20, ERC20, Pausable, AccessControl, Ownable{
    uint public INITIAL_SUPPLY = 2100000;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    

    constructor() ERC20("HanamQuokkaToken","HQT"){
