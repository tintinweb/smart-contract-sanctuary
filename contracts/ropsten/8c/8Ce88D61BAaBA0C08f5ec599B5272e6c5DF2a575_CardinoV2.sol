...
// Contract implementation
    contract CardinoV2 is Context, IERC20, Ownable {
        ...
        address payable paymentContractAddress = payable(0x5CC78dF1948B92f7F46ba80C3337C6E76283B7BD);
        address v1Address = address(0x6728B4ea78D0375D155e5d06Da506d663B18f34d);
        ...
        constructor ( ) public {
            ...
            uint256 casinoShare = 51000000000 * 10 ** 18;
            ...
            uint256 cinoInLP = 11456781457 * (10 ** 18);
            uint256 distroTokens = 43473285744 * (10 ** 18);
            ...
            _tOwned[_msgSender()] = tokensForWallet; 
            ...
            emit Transfer(address(0), _msgSender(), tokensForWallet);
        }
