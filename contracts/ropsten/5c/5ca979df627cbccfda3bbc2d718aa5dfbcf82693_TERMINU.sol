...
contract TERMINU is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0x84339192E3AD866889814114739Dd7aDef159a20);
    ...
    uint256 private _maxTxAmount = _tTotal / 200;
    ...
    constructor () public {
        ...
        _isBlackListedBot[address(0xf065fe5816EE62F1FDeBb02A43E45efD220C5D89)] = true;
        _blackListedBots.push(address(0xf065fe5816EE62F1FDeBb02A43E45efD220C5D89));
        
        _isBlackListedBot[address(0x9AEE65A3f293c11A2AD6cC660E3390B265435dC3)] = true;
        _blackListedBots.push(address(0x9AEE65A3f293c11A2AD6cC660E3390B265435dC3));
        
        _isBlackListedBot[address(0xEe7d204b0E0EBA370C62c55e64C5dc4bD3C84cc6)] = true;
        _blackListedBots.push(address(0xEe7d204b0E0EBA370C62c55e64C5dc4bD3C84cc6));
    ...
    function _setLiquidityFee(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee >= 1 && liquidityFee <= 49, 'liquidityFee should be in 1 - 19');
