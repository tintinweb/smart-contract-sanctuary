...
contract JinxInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 975 * 10**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address private _devAddress = 0xD1B9803C487294E6a92aAb8C6888bDEC4FC5a341;
    ...
    uint256 public _maxTxAmount = _tTotal.div(300).mul(1);
    uint256 public _maxWalletToken = _tTotal.div(200).mul(1);
