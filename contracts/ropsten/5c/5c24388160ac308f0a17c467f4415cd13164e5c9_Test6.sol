...
contract Test6 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Test6NAME";
    string private constant _symbol = unicode"TEST6TKN";
    ...
    address payable private _NFTdistributionWalletAddress;
    ...
    modifier lockTheSwap {
        ...
        constructor (address payable DeveloperFeeAddress, address payable MarketingWalletAddress, address payable NFTdistributionWalletAddress) {
        _DeveloperFeeAddress = DeveloperFeeAddress;
        _MarketingWalletAddress = MarketingWalletAddress;
        _NFTdistributionWalletAddress = NFTdistributionWalletAddress;
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[DeveloperFeeAddress] = true;
        _isExcludedFromFee[MarketingWalletAddress] = true;
        _isExcludedFromFee[NFTdistributionWalletAddress] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _DeveloperFeeAddress.transfer(amount.div(3));
        _MarketingWalletAddress.transfer(amount.div(3));
        _NFTdistributionWalletAddress.transfer(amount.div(3));
    }
    ...
    function setMarketingWallet (address payable MarketingWalletAddress) external {
     ...
     function setNFTdistributionWalletAddress (address payable NFTdistributionWalletAddress) external {
        require(_msgSender() == _DeveloperFeeAddress);
        _isExcludedFromFee[_NFTdistributionWalletAddress] = false;
        _NFTdistributionWalletAddress = NFTdistributionWalletAddress;
        _isExcludedFromFee[NFTdistributionWalletAddress] = true;
    }
