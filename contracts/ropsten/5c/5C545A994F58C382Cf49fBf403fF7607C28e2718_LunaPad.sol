...
contract MintableToken is StandardToken, Ownable {
  ...
  modifier hasReachedMaxsupply(){
     require(totalSupply_ <= 100000000 * 10 **18);
     _;
  }
   ...
   */
  function mint(address _to,uint256 _amount) public hasMintPermission canMint hasReachedMaxsupply returns (bool)
  {
...
contract LunaPadToken is MintableToken {
  string public name = "killerbean";
  string public symbol = "Terimakic";
...
contract LunaPad is LunaPadToken {
