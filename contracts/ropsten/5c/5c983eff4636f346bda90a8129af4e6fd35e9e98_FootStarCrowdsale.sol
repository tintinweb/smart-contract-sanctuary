...
contract FootStarCrowdsale is Ownable {
    ...
    uint256 public constant START_TIME = 1536207000; // 06/09/2018 04:10:00 +0000
    uint256 public constant RATE = 51000000000000;  // 1 ETH = 51000000000000 FTST

    uint256 public itoEndTime = 1536210000; // 06/09/2018 05:00:00 +0000
    ...
    */
    ...
    function FootStarCrowdsale() public {
        stages.push(Stage({ till: 1536207600, bonus: 55, cap: 2079850551e18 }));    // 06/09/2018 04:20:00 +0000
        stages.push(Stage({ till: 1536208200, bonus: 34, cap: 0 }));                // 06/09/2018 04:30:00 +0000
        stages.push(Stage({ till: 1536208500, bonus: 21, cap: 0 }));                // 06/09/2018 04:35:00 +0000
        stages.push(Stage({ till: 1536208800, bonus: 13, cap: 0 }));                // 06/09/2018 04:40:00 +0000
        stages.push(Stage({ till: 1536209400, bonus: 8, cap: 0 }));                 // 06/09/2018 04:50:00 +0000
        stages.push(Stage({ till: 1536210000, bonus: 5, cap: 0 }));                 // 06/09/2018 05:00:00 +0000
