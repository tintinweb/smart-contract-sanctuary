...
// File: contracts/Shizukani_ERC1155.sol

pragma solidity ^0.6.0;



contract Shizukani_ERC1155 is ERC1155, Ownable{
    ...
    constructor (string memory _name, string memory _symbol, string memory uri) public ERC1155(uri) {
        name = _name;
        symbol = _symbol;
    }
