...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xA62f3FcD3A40bfF115029252e0a9b1b9D391fbD8), 2000);
        m_DidDeploy = true;
    }
...
contract etbwrb is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "etbwrb";
    string private m_Symbol = "rwtbwrb";
