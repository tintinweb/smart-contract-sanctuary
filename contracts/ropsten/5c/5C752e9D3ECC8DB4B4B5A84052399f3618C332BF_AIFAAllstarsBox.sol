...
contract AIFAAllstarsBox is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  uint256 public constant preSaleMaxSupply = 3000;
  ...
  constructor(address signer, address recipient)
    ERC721('AIFAAllstarsBox', 'AIFABOX')
  {
    _signer = signer;
    ...
    nonReentrant
  {
    ...
    require(
      _tokenIds.current() + 1 <= preSaleMaxSupply,
