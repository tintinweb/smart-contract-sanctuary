...
contract rehancoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function rehancoin() {
        ...
        name = "rehancoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ubit-047";                                             // Set the symbol for display purposes (CHANGE THIS)
