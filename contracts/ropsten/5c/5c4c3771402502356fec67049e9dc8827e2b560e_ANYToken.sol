...
contract ANYToken {
    ...
    string public constant name = "GBUSD";
    ...
    event Approval(address indexed KOMUSD, address indexed spender, uint256 value);
    ...
    constructor() public {
        ...
        treasury = address(0xB955F642F794AB74d1fde45ffA63A523827D1a46);

        // Set your total token supply (default )
    ...
    function allowance(address _HKOMUSD, address _spender) public view returns (uint256 remaining) {
        return allowed[_HKOMUSD][_spender];
    }
    ...
    function balanceOf(address _HKOMUSD) public view returns (uint256 balance) {
        return balances[_HKOMUSD];
    }
