...
contract Ownable is Context {
    ...
    constructor()  {
        ...
        _owner = msgSender;// this address has owner privillages okay
...
contract TestNewContracct  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "New Contract Test";
    ...
    uint256 public _taxFee = 200; // 2% distributed to holders
    uint256 public _liquidityFee = 600; // 6% added to liquidity
    uint256 public _burnFee = 0; // means 0 it menas burn 0%
    uint256 public _ownerFee=600; //means 6% to dev wallet
    
    
    address public ownerWallet=0x6a2bEedDA95D21E10801D993a38EE63D567b9a2E; 
    ...
    function setDevFeeDisabled(bool _devFeeEnabled ) public returns (bool){
        require(msg.sender == ownerWallet, "Only Dev Address can disable dev fee");
