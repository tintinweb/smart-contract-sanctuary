...
contract Polkadoge is Context, IERC20, Ownable {
    ...
    uint256 public liquidityAddMaxGasPrice = 30 * 1000000000;

    uint256 public _maxTxAmount = 10000000 * 10**3 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 12500000 * 10**3 * 10**9;
    ...
    // Owner cannot transfer out Polkadoge from this smart contract
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Polkadoge!");
    ...
    function _transfer(
        ...
        if (
            ...
            liquidityAddMaxGasPrice > tx.gasprice
        ) {
            contractTokenBalance = numTokensSellToAddToLiquidity;
            //add liquidity
    ...
    //set max gas fee in gwei
    function setLiquidityAddGasMax(uint256 _gas) public onlyOwner {
        liquidityAddMaxGasPrice = _gas * 1000000000;
    }
