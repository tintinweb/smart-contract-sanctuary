...
contract vaultbank  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("vaultbank", "VAULT") {
    	...
    	dev1Wallet = payable(0xe8bf6B3d8ebee78093bd07204Ef9c4ce4171d9Ed);  // set as dev1 wallet
        dev2Wallet = payable(0xe8bf6B3d8ebee78093bd07204Ef9c4ce4171d9Ed);  // set as dev2 wallet
        dev3Wallet = payable(0xe8bf6B3d8ebee78093bd07204Ef9c4ce4171d9Ed);  // set as dev3 wallet
        dev4Wallet = payable(0xe8bf6B3d8ebee78093bd07204Ef9c4ce4171d9Ed);  // set as dev4 wallet
        dev5Wallet = payable(0xe8bf6B3d8ebee78093bd07204Ef9c4ce4171d9Ed);  // set as dev5 wallet

        marketingWallet = payable(0xe8bf6B3d8ebee78093bd07204Ef9c4ce4171d9Ed); //marketing wallet
