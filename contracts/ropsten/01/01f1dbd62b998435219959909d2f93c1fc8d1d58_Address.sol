...
contract CandyToken is ERC20("CandyToken", "CNDY"), Ownable, Authorizable {
...
contract CandyMasterFarmer is Ownable, Authorizable {
    ...
    constructor(
        ...
        uint256  _halvingAfterBlock = block.number + 11500;
        devaddr = _devaddr;
    ...
    // function executeRewardMultiPlier() external {
    //     for (uint256 i = 0; i < REWARD_MULTIPLIER.length-1; i++) {

    //         uint256 halvingAtBlock = halvingAfterBlock.add(i + 1).add(START_BLOCK);
    //         HALVING_AT_BLOCK.push(halvingAtBlock);
    //     }
    // }
