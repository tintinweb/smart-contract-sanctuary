...
WINNTOKEN Socials:
Telegram: @winntokentg
Twitter: twitter.com/winn
Website: winn.io
Whitepaper: winn.io/wp
...
contract WINNTOKEN is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000 * 10**9;
    string private m_Name = "WINNTOKEN";
    string private m_Symbol = "WINN";
    ...
    constructor () {
        ...
        ILO.init(50000000000000000000, 5000, 500, m_ILOPublic);
        initTax();
