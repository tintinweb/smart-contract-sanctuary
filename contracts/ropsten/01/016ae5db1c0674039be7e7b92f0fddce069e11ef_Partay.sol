...
pragma solidity 0.5.0;
    ...
    contract ERC20 is Context, IERC20 {
        ...
        uint256 private _totalSupply;
            ...
            uint256 admin_fee=10;     //admin fees in number
            uint256 production_fee=20;  //production fees in number
            uint256 market_fee=30;    //marketing fees in number
            address payable public admin = address(uint160(address(0x0e5Ad520c0fc85Ef31A4550A2D2972f26d8E8097))); 
            ...
            address payable public production = address(uint160(address(0x0e5Ad520c0fc85Ef31A4550A2D2972f26d8E8097)));   //production team wallet address
            function team_address(address payable _admin, address payable _maketing, address payable _production) public returns (bool){
                admin=_admin;
                marketing=_maketing;
            ...
            function BuyToken() public payable returns(bool){
                ...
                admin.transfer(msg.value.mul(admin_fee).div(100));
        ...
        contract Partay is ERC20Mintable, ERC20Burnable {
            string public name="Partay Token";
