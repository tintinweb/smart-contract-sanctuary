...
contract ChelleToken is StandardToken {
    ...
    function ChelleToken() {
        ...
        totalSupply = 10000000;                        // Update total supply (10000000 for example)

        name = "ChelleCoin";                                   // Set the name for display purposes

        decimals = 10;                            // Amount of decimals for display purposes

        symbol = "CHL";                               // Set the symbol for display purposes
