...
contract NiftyNft is NiftyGenerator {
  constructor() NiftyGenerator("NiftyNft", "NIFTY", 100, 0.005 ether) {}
}
...
contract NiftyGenerator is ERC721Uriable {
...
abstract contract ERC721Uriable is ERC721, Ownable {
    // Base URI
    ...
    // Added back in tokenURI functionality since openzepplin removed these methods
