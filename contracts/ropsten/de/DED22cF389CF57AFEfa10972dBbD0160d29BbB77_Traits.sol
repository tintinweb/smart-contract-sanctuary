...
interface IGNG is IERC721Enumerable {
    ...
    function getTokenTraits(uint256 tokenId) external view returns (FarmBranch memory);
    function getTokenWriteBlock(uint256 tokenId) external view returns(uint64);
    function isFarm(uint256 tokenId) external view returns(bool);
