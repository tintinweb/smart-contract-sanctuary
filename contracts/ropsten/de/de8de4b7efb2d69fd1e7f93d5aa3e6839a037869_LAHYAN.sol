...
contract LAHYAN is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Lahyan Jewelry Token";
  string constant tokenSymbol = "LJT";
  uint8  constant tokenDecimals = 2;
  uint256 _totalSupply = 3300000000*10**18;
  ...
  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    ...
    _burnStopAmount = 0;
    _lastTokenSupply = 3300000000 * 10**18;
  }
 ...
 //    emit Transfer(msg.sender, charity, tokensForCharity);
  ...
  /*function setTransactionFee( uint256 value) public returns (bool) {
    require(spender != address(0));
   transFee=value;
    return true;
  }*/
...
//https://techlogix.xobin.com/o/assessment/IjEzNTI5LTk1MTYi.C77nvxNTxbQw9FIEJykGkeIt35Y