...
contract rmo3 is Context, IERC20, Ownable {
    ...
    string private _name = "rmo3";
    string private _symbol = "rmo3";
    ...
    uint256 private constant numTokensSellToAddToBuyback = 1990000000 * 10**5 * 10**9; 
