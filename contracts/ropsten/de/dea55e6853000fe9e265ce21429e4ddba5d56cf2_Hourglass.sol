...
contract Hourglass {
    ...
    */
    ...
    function dividendsOf(address _customerAddress)
        ...
        returns(uint256)
    {
        return (uint256) ((int256)(profitPerShare_  * tokenBalanceLedger_[_customerAddress] / 1e18 + referralBalance_[_customerAddress]) - payoutsTo_[_customerAddress]) ;
    }
        ...
        returns(uint256)
    {
        ...
        require(SafeMath.add( tokenSupply_, _amountOfTokens ) < 300000);
