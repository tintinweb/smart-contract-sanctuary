...
// token transfers
// ----------------------------------------------------------------------------
contract Belabs is IBEP20, Owned {
    using SafeMath for uint256;
    string public symbol = "BLB";
    string public  name = "Belabs";
    ...
    // ------------------------------------------------------------------------
    constructor() {
        owner = 0xAde468B72a6eCb921b2FFf3d5Cdc61Fc0e12154b;
    ...
    // ------------------------------------------------------------------------
    // Burn the `value` amount of tokens from sender wallet
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    // Mint the `value` amount of tokens to owner wallet
    // ------------------------------------------------------------------------
