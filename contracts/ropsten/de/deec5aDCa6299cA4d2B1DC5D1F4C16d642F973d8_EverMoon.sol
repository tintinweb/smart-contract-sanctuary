...
contract EverMoon is Context, IERC20, Ownable {
    ...
    uint256 public _minTransferAmountToBuyBack = 1000000 * 10**6 * 10**9;
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > uint256(1 * 10**18)) {
              ...
              if (balance > buyBackUpperLimit && amount >= _minTransferAmountToBuyBack) {
    ...
    function setMinTransferAmountToBuyBack(uint256 minTransferAmountToBuyBack) external onlyOwner() {
        _minTransferAmountToBuyBack = minTransferAmountToBuyBack;
    }
