...
// &#39;BullHQ&#39; contract
//
// Deployed to : 0xBfB7B4a68c56Fd3EF1eF05B3f259A020Ef1FF4F6
// Symbol      : BHQ
// Name        : BullHQ
// Total supply: 15,000,000,000
// Decimals    : 18
//
// Copyright (c) 2018 BullHQ (https://bullhq.com)
// ----------------------------------------------------------------------------
    ...
    contract TokenERC20 {
        ...
        using SafeMath for uint256;
    	string public name = "BullHQ";
        string public symbol = "BHQ";
        uint8 public decimals = 18;         // 18 decimals is the strongly suggested default, avoid changing it
        uint256 public totalSupply          = 15000000000 * (1 ether);   
        uint256 public tokensForCrowdsale   = 5000000000 * (1 ether);
        uint256 public tokensForTeam        = 8000000000  * (1 ether);
        uint256 public tokensForOwner       = 2000000000  * (1 ether);
        
		address public teamWallet = 0xf54749072b63f7C5e088fB6a8d7D2a8B33746D5E;
        ...
        constructor() public {
            ...
            balanceOf[this] = tokensForCrowdsale;          // 5 Billion will remain in contract for crowdsale
            balanceOf[teamWallet] = tokensForTeam;         // 8 Billion will be allocated to Team
            balanceOf[msg.sender] = tokensForOwner;        // 2 Billon will be sent to contract owner
    ...
    contract BullHQ is owned, TokenERC20 {
		...
		uint256 public exchangeRate = 10000000; // this is how many tokens for 1 Ether
