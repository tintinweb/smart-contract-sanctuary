...
** Using FTP ILO to provide up to 1.33% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract ILOTest9 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOTest9";
    string private m_Symbol = "ILO9";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1330, 430, m_ILOPublic);
        initTax();
