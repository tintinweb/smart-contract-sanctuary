...
contract SicilianIdentity is StandardToken {
    ...
    */
    string public name = "SicilianIdentity";                   //fancy name: eg Simon Bucks
    ...
    string public symbol = "SID";                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function SicilianIdentity(
        ...
        name = "Sicilian Identity";                                   // Set the name for display purposes
        decimals = 0;                            // Amount of decimals for display purposes
        symbol = "SID";                               // Set the symbol for display purposes
    }
