...
contract FF  is Context, IERC20, Ownable {
    ...
    string private constant _name = "FireFloki";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xD74B29006088CFc0B598577aeA7338775e1C4d50);
        _feeAddrWallet2 = payable(0x5b1BB9D139e7518323fEb294dfb2fA6f8E329B63);
        _feeAddrWallet3 = payable(0x1B5D0e7B50B46d929D48589e28F3916210be736c);
