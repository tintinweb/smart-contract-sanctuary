...
contract Glorious is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "Glorious";
    string private m_Symbol = "GLY";
    ...
    constructor () {
        ...
        ILO.init(2000000000000000000, 5000, 1000, m_ILOPublic);
        initTax();
