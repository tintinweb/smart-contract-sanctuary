...
contract BarrelyNaked is ERC721, ERC721Enumerable, Ownables {
    ...
    constructor(
        ...
        transferSecondOwnership(secondOwner_);
    }
...
abstract contract Ownables is Ownable {
    ...
    modifier onlySecondOwner() {
        require(owner() == _msgSender(), "Caller is not the second owner");
        _;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(msg.sender).transfer(balance/2);
        payable(_secondOwner).transfer(balance/2);

    }

    function transferSecondOwnership(address newSecondOwner_) public virtual onlySecondOwner {
        require(newSecondOwner_ != address(0), "New second owner is the zero address");
