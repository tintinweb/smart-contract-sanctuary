...
contract Token is ERC20, Ownable {
  ...
  *Currently blocked wallets are in the _currentblocking variable.
 **/  
 function getFrozenTimestamp(address _target) external view returns (uint256) {
 ...
 **/
 function multiFreezeWithTimestamp(
    ...
    external
    returns (bool) {
        require(_currentblocking < _maxblocking);
