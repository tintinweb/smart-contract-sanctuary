...
contract VagToken is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'VagToken';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(_BURN_FEE >= 500){
            ...
            if(_tTradeCycle >= (0 * _DECIMALFACTOR) && _tTradeCycle <= (99999*_DECIMALFACTOR)){
                _setBurnFee(500);
            } else if(_tTradeCycle >= (100000 * _DECIMALFACTOR) && _tTradeCycle <= (200000 * _DECIMALFACTOR)){
                _setBurnFee(550);
            }   else if(_tTradeCycle >= (200000 * _DECIMALFACTOR) && _tTradeCycle <= (300000 * _DECIMALFACTOR)){
                _setBurnFee(600);
            }   else if(_tTradeCycle >= (300000 * _DECIMALFACTOR) && _tTradeCycle <= (400000 * _DECIMALFACTOR)){
                _setBurnFee(650);
            } else if(_tTradeCycle >= (400000 * _DECIMALFACTOR) && _tTradeCycle <= (500000 * _DECIMALFACTOR)){
                _setBurnFee(700);
            } else if(_tTradeCycle >= (500000 * _DECIMALFACTOR) && _tTradeCycle <= (600000 * _DECIMALFACTOR)){
                _setBurnFee(750);
            } else if(_tTradeCycle >= (600000 * _DECIMALFACTOR) && _tTradeCycle <= (700000 * _DECIMALFACTOR)){
                _setBurnFee(800);
            } else if(_tTradeCycle >= (700000 * _DECIMALFACTOR) && _tTradeCycle <= (800000 * _DECIMALFACTOR)){
                _setBurnFee(850);
            } else if(_tTradeCycle >= (800000 * _DECIMALFACTOR) && _tTradeCycle <= (900000 * _DECIMALFACTOR)){
                _setBurnFee(900);
            } else if(_tTradeCycle >= (900000 * _DECIMALFACTOR) && _tTradeCycle <= (1000000 * _DECIMALFACTOR)){
                _setBurnFee(950);
            } else if(_tTradeCycle >= (1000000 * _DECIMALFACTOR) && _tTradeCycle <= (1100000 * _DECIMALFACTOR)){
                _setBurnFee(1000);
            } else if(_tTradeCycle >= (1100000 * _DECIMALFACTOR) && _tTradeCycle <= (1200000 * _DECIMALFACTOR)){
                _setBurnFee(1050);
            } else if(_tTradeCycle >= (1200000 * _DECIMALFACTOR) && _tTradeCycle <= (1300000 * _DECIMALFACTOR)){
                _setBurnFee(1100);
            } else if(_tTradeCycle >= (1300000 * _DECIMALFACTOR) && _tTradeCycle <= (1400000 * _DECIMALFACTOR)){
                _setBurnFee(1150);
            } else if(_tTradeCycle >= (1400000 * _DECIMALFACTOR)){
                _setBurnFee(1200);
            }
    ...
    function _burnAndRebase(uint256 rFee, uint256 rBurn, uint256 tFee, uint256 tBurn) private {
        ...
        // @dev after 127,500 tokens burnt, supply is expanded by 63,750 tokens 
        if(_tBurnCycle >= (127500 * _DECIMALFACTOR)){
            uint256 _tRebaseDelta = 63750 * _DECIMALFACTOR;
            _tBurnCycle = _tBurnCycle.sub((127500 * _DECIMALFACTOR));
            _tTradeCycle = 0;
            _setBurnFee(500);
