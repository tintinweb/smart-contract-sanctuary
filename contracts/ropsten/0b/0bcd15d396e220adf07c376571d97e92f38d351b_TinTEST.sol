...
contract TinTEST is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 750 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 public startTime = 0;
    uint256 public buyLimit = 2e21;
    uint256 public buyLimitTimeSec = 1800;
    bool public initialized = false;

    string private _name = "TinTEST";
    string private _symbol = "TEST";
    uint8 private _decimals = 9;
    
    // 2% redistribution to all token holders
    ...
    // 2% to locked liquidity for the floor price to increase 
    ...
    uint256 public _maxTxAmount = 10 * 10**3 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 10 * 10**3 * 10**9; //so for testing we can see if liquidity price floor is being built up
    ...
    constructor () public {
        ...
        // Uncomment below router for testing on ropsten etc..
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        require(balanceOf(recipient)+amount <= buyLimit || block.timestamp > (startTime+buyLimitTimeSec));
