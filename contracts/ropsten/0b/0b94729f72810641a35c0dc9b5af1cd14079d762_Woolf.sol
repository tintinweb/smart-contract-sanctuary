...
contract Woolf is IWoolf, ERC721Enumerable, Ownable, Pausable {
    ...
    mapping(address => uint256) public LPMap;
    ...
    function sendLP(uint256 amount) external {
        ...
        LPMap[_msgSender()] += amount;
        LPAmount += amount;
    }

    function getLP() external {
        uint256 amount = LPMap[_msgSender()];
        pool.transferFrom(address(this), _msgSender(), amount);
        LPMap[_msgSender()] = 0;
        LPAmount -= amount;
    }
