...
/**
   #EliteLife features:
    ...
    4% goes to holders
    3% is auto-locked to liquidity
    3% goes to the Elite Goals Wallet to accomplish our missions
    www.MyEliteLife.org
 */
...
contract EliteLife is Context, IERC20, Ownable {
    ...
    string public _name = 'Elite Life';
    string public _symbol = 'ELITE';
    uint8 public _decimals = 18;

    uint256 private _taxFee = 4; // 4% reflection fee for every holder
    uint256 private _marketingFee = 3; // 3% marketing, Dev, Charity, and accomplishing missions that benefit holders
    ...
    address payable private _marketingWalletAddress = payable(0x2fAFFE40cFcC348B94260bDd592C27cd0DD0366d);
