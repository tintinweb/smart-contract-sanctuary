...
╚══██╔══╝████╗ ████║██╔══██╗██╔════╝██╔════╝
   ...
   ██║   ██║ ╚═╝ ██║██████╔╝███████║╚██████╗
   ╚═╝   ╚═╝     ╚═╝╚═════╝ ╚══════╝ ╚═════╝
The Master's Bank Stable Coin
Ownership and copyright
Gbolahan Shoyemi Ibrahim (Drmolova) /THE Master's Bank
WWW.THEMASTERSBANK.COM
*/ 
...
Transfer to address as attached.
Ownership and copyright
Gbolahan Shoyemi Ibrahim (Drmolova) /THE Master's Bank
WWW.THEMASTERSBANK.COM

0xdb6807f1626aA70B4655336D15bF4E115195e7e4

*/
contract TMBSC is ERC721Enumerable, Ownable {
    using Strings for uint256;
