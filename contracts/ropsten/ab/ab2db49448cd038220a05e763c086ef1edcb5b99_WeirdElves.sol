...
contract WeirdElves is ERC721Enumerable, Ownable, CybermonValues {
    ...
    uint256 public constant NFT_PRICE_PUBLIC = 35000000000000000; // 0.035 ETH
    uint256 public constant NFT_PRICE_WHITELIST = 30000000000000000; // 0.03 ETH
    uint256 public constant MAX_NFT_PURCHASE = 20;
    uint256 public constant MAX_NFT_WHITELLIST = 10;
    ...
    function mintChecks(uint256 numberOfTokens, uint256 msgVal, address sender, bool whiteList) private view {
        ...
        if(whiteList) {
            ...
            require((MAX_NFT_WHITELLIST - balanceOf(msg.sender)) >= numberOfTokens, "Cant mint that much");
