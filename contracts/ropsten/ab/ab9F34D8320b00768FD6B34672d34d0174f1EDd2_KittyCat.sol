...
contract KittyCat is Context, IERC20, Ownable {
    ...
    uint256 private maxWalletPercent = 1000;
    ...
    constructor() payable {
        ...
        _rOwned[_msgSender()] = _rTotal / 1000 * 100;
        _rOwned[address(this)] = _rTotal / 1000 * 900;
        
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0xFA4a2c7e03C927636DB0587e62d3e29E91A543f3); // Marketing Address
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 100 / 1000);
