...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 public maxSellPerDay = 50000 * 10**18;
        ...
        returns (bool)
    {
        ...
        //  if(11000000000000000 - totalSupply() > 502700000000000 ){
        //     if(spender == pancakePair){
    ...
    function _transfer(
        ...
        if (recipient == pancakePair) {
            ...
            if(_msgSender() != liquidityWallet || _msgSender() != address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)  || sender !=  address(0x11cFc68B96A4da8BE01b6450b9bb34fE524cDe91) ) {

                // if (getPrice(maxSellPerDayLimit) > maxSellPerDay) {
                //     require(block.timestamp > timeLimit + 24 * 1 hours);
                //     timeLimit = block.timestamp;
                //     maxSellPerDayLimit = 0;
                // }
        ...
        //     require(_includeInSell[sender], "ERC20:Not allowed to sell");
        //     if (block.timestamp < _firstBuy[sender] + 24 * 1 hours) {
        //         require(
        //             getPrice(_totBuy[sender] + amount) <= buyLimit,
        //             "You can't sell more than maxSellPerDay"
        //         );
        //         _totBuy[sender] += amount;
        //     } else {
        //         require(
        //             getPrice(_totBuy[sender] + amount) <= buyLimit,
        //             "You can't sell more than maxSellPerDay"
        //         );
        //         _firstBuy[sender] = block.timestamp;
        //         _totBuy[sender] = amount;
        //     }
        // }
