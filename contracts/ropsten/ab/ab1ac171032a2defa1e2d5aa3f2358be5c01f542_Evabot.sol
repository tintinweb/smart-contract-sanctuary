  ...
  */
  ...
  function startCycle() onlyAdmin() public {
      ...
      for(uint256 i = 0; i < whitelists.length; i++) {
          ...
          totalInvested[whitelists[i]] = totalInvested[whitelists[i]].add(pendingToken[whitelists[i]]);
  ...
  function stopCycle() onlyAdmin() public {
      ...
      for(uint256 i = 0; i < whitelists.length; i++) {
          if(isAutoInvest[whitelists[i]] == true) {
            ...
            myEthBalance[whitelists[i]] = myEthBalance[whitelists[i]].add(profit);
            dailyEthProfit[whitelists[i]] = profit;
            totalProfit[whitelists[i]] = totalProfit[whitelists[i]].add(profit);
            
            pendingToken[whitelists[i]] = pendingToken[whitelists[i]].add(activeToken[whitelists[i]]);
