...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[xtkn161035 error][Ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[xtkn161035 error][Ownable] new owner is the zero address");
...
contract IXTKN161035PreSaleVault{
...
*/
contract XTKN161035PreSale is Context, Ownable, Native, ReentrancyGuard{
    // lib
    ...
    // instance
        ...
        IXTKN161035PreSaleVault private _vault; // interface for investor vault
    ...
    function init(uint256 pEnd, address pVault) public onlyOwner nonReentrant{
        ...
        _vault = IXTKN161035PreSaleVault(ADDRESS_VAULT);
        _vault.init();
    }
    ...
    function stats() public view returns(uint256 tokensAvailable, uint256 tokensSold){
        return(
    ...
    function buy(uint256 pTokens) public nonReentrant{
        ...
        require(!PRESALE_ENDED, "[xtkn161035 error][presale] has ended sorry!");
        require(PRESALE_ENABLED, "[xtkn161035 error][presale] not enabled yet!");
        ...
        require(allowance >= price, "[xtkn161035 error][presale] you have to authorize the transfer of your USDC first!");
        require(balance >= price, "[xtkn161035 error][presale] you do not have enough USDC!");

        // check if user can still buy the tokens
        require(_available(pTokens), "[xtkn161035 error][presale] no more of these pots available!");
        require(!_bought(_msgSender(), pTokens), "[xtkn161035 error][presale] you can only buy one of this pot, buy another pot!");
        require(_buy(_msgSender(), pTokens, price), "[xtkn161035 error][presale] could not buy the pot!");
