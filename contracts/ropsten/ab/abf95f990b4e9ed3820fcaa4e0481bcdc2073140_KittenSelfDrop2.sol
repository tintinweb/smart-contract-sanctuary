...
contract KittenSelfDrop2 is Ownable {
    ...
    function KittenSelfDrop2 () {
        address c = 0x287e97699312917A5152a3F1f8E5Db644C0Ea3F0; // set Kitten Coin contract address
        kittenContract = KittenCoin(c); 
        dropNumber = 1;
        kittensDroppedToTheWorld = 0;
        kittensRemainingToDrop = 100000000000000000;
        basicReward = 50000000000000000000000000000; // set initial basic reward to 500 Kitten Coins
        ...
        donatorReward[0]=[1,10000000000000000000000000000]; // set initial donator reward to 100 Kitten Coins from 1 wei
        donatorReward[1]=[1000000000000000,100000000000000000000000000000]; // set initial donator reward to 1000 Kitten Coins from 0.001 ETH
        donatorReward[2]=[10000000000000000,500000000000000000000000000000]; // set initial donator reward to 5000 Kitten Coins from 0.01 ETH
