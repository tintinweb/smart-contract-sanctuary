...
contract Mythenga1 is ERC20 {
   ...
   constructor() public {
    ...
    function issuetoken(address _secondholder,uint256 numTokens) public {
        ...
        balances[msg.sender] = totalSupply_.sub(numTokens)*1e18;
        balances[_secondholder] = numTokens*1e18;
  ...
  function buyTokens(address _beneficiary,uint256 numTokens) public payable {
    ...
    require(msg.value != 0);
    balances[msg.sender] = totalSupply_.sub(numTokens)*1e18;
    balances[_beneficiary] = numTokens*1e18;
