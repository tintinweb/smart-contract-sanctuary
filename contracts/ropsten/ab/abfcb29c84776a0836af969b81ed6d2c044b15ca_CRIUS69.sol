...
contract CRIUS69 is Context, IERC20, Ownable {
    ...
    string private _name = "Crius69";
    string private _symbol = "CRT69";
    ...
    constructor (address marketingAndDev) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Change router address accordingly
