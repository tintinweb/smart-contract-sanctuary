 ...
 */
 ...
 contract BurnableToken is StandardToken, Ownable {
   ...
   * @param _from The address that will loss the tokens.
  ...
  function burn(address _from, uint256 _amount) onlyOwner canBurn public returns (bool) {
    ...
    Burn(_from, _amount);
    Transfer(address(0), _from, _amount);
    return true;
  }

  /**
   * @dev Function to stop burning more tokens.
   * @return True if the operation was successful.
   */
 ...
 */
contract ICOToken is MintableToken, BurnableToken, Pausable {
