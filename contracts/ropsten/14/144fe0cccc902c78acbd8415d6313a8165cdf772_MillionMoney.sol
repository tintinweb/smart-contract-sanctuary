...
contract MillionMoney {
    ...
    constructor() public {
        ...
        LEVEL_PRICE[1] = 1e3 wei;
        LEVEL_PRICE[2] = 2e3 wei;
        LEVEL_PRICE[3] = 3e3 wei;
        LEVEL_PRICE[4] = 4e3 wei;
        LEVEL_PRICE[5] = 5e3 wei;
        LEVEL_PRICE[6] = 1 ether;
        LEVEL_PRICE[7] = 2 ether;
        LEVEL_PRICE[8] = 3 ether;
        LEVEL_PRICE[9] = 4 ether;
        LEVEL_PRICE[10] = 5 ether;
