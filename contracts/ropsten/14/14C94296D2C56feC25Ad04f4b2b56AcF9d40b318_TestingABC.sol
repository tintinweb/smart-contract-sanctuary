...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract TestingABC is ERC20, Ownable {
        using SafeMath for uint256;
    ...
    string private    _name = "Testing ABC";
    ...
    address payable deployerWallet = payable(0x01F02E00bCB3B559076aBDD3B0fb213CB5CA8306);
    address payable marketingWallet = payable(0x87C2D215a3A2e36702227fFB52047c69389dB7f3);
    address payable developmentWallet = payable(0x2044156ADEE9637ca9abE83977A0A16452A4a97e);
    ...
    constructor () ERC20("Testing ABC", "ABC", 9) {
