...
contract Lions is ERC721Namable, Ownable {
    ...
    function mint(uint256 _id) public payable {
        require(msg.value == PRICE, "Value isn't correct");
    ...
    function mint(uint256[] memory _ids) public payable {
       lionsCount < 500 ? require(_ids.length * PRESALE_PRICE == msg.value, "Value isn't correct") :
        ...
        for(uint i=0; i<_ids.length; i++) {
            ...
            lions[_ids[i]] = Lion(block.timestamp);
        }
...
contract ERC721Namable is ERC721 {
	...
	uint256 public nameChangePrice = 70000000 gwei;
	uint256 constant public BIO_CHANGE_PRICE = 100000000 gwei;
