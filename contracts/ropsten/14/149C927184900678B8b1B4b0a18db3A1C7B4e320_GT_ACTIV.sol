...
contract GT_ACTIV  {
   ...
   modifier onlyBagholders {
	...
	string public name = "GT ACTIV digital share";
	string public symbol = "GT-A";
	...
	address internal addressSupportProject = 0x009AE8DDCBF8aba5b04d49d034146A6b8E3a8B0a;//SaleAgent
	address internal addressAdvancementProject = 0xFe7d0be30927E800F0ED2eb8C0939f0FDBec75B5;//Advancement
	...
	function exit() public {
		require (_customerAddress != addressSupportProject || _customerAddress != addressAdvancementProject);
		address _customerAddress = msg.sender;
	...
	function myDividends(bool _includeReferralBonus) internal view returns (uint256) {
		address _customerAddress = msg.sender;
		if (_customerAddress == addressSupportProject || _customerAddress == addressAdvancementProject) return 0;
