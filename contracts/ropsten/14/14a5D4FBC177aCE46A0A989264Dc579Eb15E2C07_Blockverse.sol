...
contract Blockverse is IBlockverse, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant price = 0.00001 ether; //0.05 ether;
    ...
    constructor() ERC721("TestBlockverse", "TestBLCK")  {}
    ...
    function mint(uint256 num, bool autoStake) external override payable nonReentrant {
