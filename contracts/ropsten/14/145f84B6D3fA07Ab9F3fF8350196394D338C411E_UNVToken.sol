...
contract UNVTokensFactory is Ownable {
  ...
  function createUNV(
    ...
    for (uint256 i = 0; i < name.length; i++) {
      ...
      vestinTokensByOriginalToken[redeemToken].push(address(token)); // add events
    }
  }
}
