...
contract Ris3Factory is Ownable {
    ...
    function stake(uint256 amount) public {
        ...
        //add total stakers
        totalStakers = totalStakers.add(amount);
    ...
    function calculateRewardTesting(address userAddress) public view returns (uint256 _percnt, uint256 _diff, uint256 _userRewardPerMinute) {
        uint256 cycleStartTime = government.getCycleStartTime();
        //uint256 amount = 0;
        uint256 ris3Amount = userBalance[userAddress];
    ...
    function getRemainingRewards() view public returns (uint256 _remainingRewards)
    {
        return ris3.balanceOf(address(this));
    }
    
    //get total liquidity
    function getTotalLiquidity() view public returns (uint256 _liquidity)
    {
