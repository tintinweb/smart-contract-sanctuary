...
contract Lottery {
    ...
    function activateLottery(uint256 maxEntries, uint256 ethRequired, uint256 creatorFee)
        public
        restricted
    {
        isLotteryLive = true;
    ...
    function declareWinner() public restricted {
        ...
        lotteryBag[index].transfer(this.balance * (100 - creatorFee) / 100);
        manager.transfer(this.balance * creatorFee / 100);
