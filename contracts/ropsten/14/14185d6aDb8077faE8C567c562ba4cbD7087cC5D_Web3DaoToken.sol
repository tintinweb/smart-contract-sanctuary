...
contract Web3DaoToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    // total supply be 21 million
    // 50% Airdrop To Web3 Users,80% eth: 20% polygon
    // 20% Staking Incentive
    // 15% WEB3 DAO Governance Treasury
    // 10% LP Tncentive
    // 5% Development Committee
    uint256 constant airdropSupply = 10_500_000e8;
    uint256 constant daoSupply = 10_500_000e8;//Staking/Governance Treasury/LP/Dev
    ...
    function claimTokens(uint256 amount, bytes32[] calldata merkleProof) public {
        ...
        require(valid, "Web3Dao: Valid proof required.");
    ...
    function setMerkleRoot(bytes32 _merkleRoot) public onlyOwner {
        require(merkleRoot == bytes32(0), "Web3Dao: Merkle root already set");
