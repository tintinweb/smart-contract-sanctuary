...
contract ExchangeContract is Sale{
    ...
    constructor() public{}
    function mint(address token ,string memory tokenuri, uint256 value, uint256 tokenId, uint256 royal, uint256 _type, uint256 supply) public returns (bool){
       if(_type == 1){
         ERC721(token).mint(msg.sender, tokenId, tokenuri);
