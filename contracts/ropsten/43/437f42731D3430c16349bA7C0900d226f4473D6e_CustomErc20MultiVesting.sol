...
contract CustomErc20MultiVesting is Erc20MultiVesting {
    ...
    bool public allowRevoke;
    bool public allowAllocate;
    ...
    constructor (
        ...
        allowAllocate = allowAllocate_;
        allowRevoke = allowRevoke_;

        if (allowRevoke) {
            require(allowAllocate, "allowAllocate flag must be true for revokable vesting");
        }
...
abstract contract Erc20MultiVesting is Context, Ownable {
    ...
    uint256 public totalAllocatedSupply;
