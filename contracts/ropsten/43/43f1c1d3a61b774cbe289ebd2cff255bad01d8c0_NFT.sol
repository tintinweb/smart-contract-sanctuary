...
contract NFT is ERC1155, Ownable {
    ...
    function buyBlindBox(uint256 _blindboxId) public returns(bool){
        ...
        _blindMap[_blindboxId].soldAmout = _blindMap[_blindboxId].soldAmout.add(1);
    ...
    function randomNewId(uint256 _blindboxId) internal view returns(uint256){
        ...
        for( uint256 i = length - 1 ; i >= 0; i--){
            ...
            if(index + 1 >= blindAmount && _blindMap[_blindboxId].nftAmount[_blindMap[_blindboxId].nftKeys[i]] > 0){
