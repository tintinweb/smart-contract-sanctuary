...
contract Radical3 is Context, IERC20, Ownable {
    ...
    string private _name = "Radical3";
    string private _symbol = "RADCL3";
    ...
    function enableTrading() external onlyOwner() {
        ...
        buyLimitEnd = block.timestamp + (480 seconds);
    }
          
  function setCooldown(bool _setcooldown) external onlyOwner() {
 
    _cooldownEnabled = _setcooldown;
    ...
    function initContract() external onlyOwner() {
        ...
        teamDevAddress = payable(0x6020827cbF79ff84De9B3f7f3A641F1305aD8823);
    }
