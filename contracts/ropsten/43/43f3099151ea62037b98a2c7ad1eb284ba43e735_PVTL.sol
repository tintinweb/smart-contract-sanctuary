...
contract ERC20 is Context, IERC20, IERC20Metadata {
   ...
   address payable public maintenanceWallet = payable(0xF7234F7AbDEf394F57B8bcdB5E8C88674Ba16CD2);
    ...
    function changeLiquidityFee(uint256 liqFee) public onlyOwner
    {
        _liquidityFee = liqFee;
    }

    function changeMaintenanceFee(uint256 mainFee) public onlyOwner
    {
        _maintenanceFee = mainFee;
    }
    ...
    function AfterPresale(uint256 liquidityFee, uint256 maintenanceFee, uint256 maxtxAmount) external onlyOwner
    {
    ...
    function _transfer(
        ...
        if(takeFee)
            ...
            super._basictransfer(from, address(this), FeeAmount);
