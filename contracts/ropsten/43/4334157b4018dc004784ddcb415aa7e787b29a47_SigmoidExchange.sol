...
/* 
    take order
点击take order 是 需要把自己的DBIT给转出来   msg.sender

1、take order 时授权
2、msg.sender 转给 seller dbit
3、seller 变成 msg.sender | 增加一个currentOwner 设置成msg.sender;



假设owner 为 A账号 sender 是 B账号  seller是C账号

A账号没有DBIT  B账号有1000DBIT  C账号没有

B委托A账号转给C账号100DBIT
B账号和A账号建立委托关系 approve(A,100);
1. 转dbit: 出钱的人msg.sender, 进钱的人：从Loan中拿地址。
