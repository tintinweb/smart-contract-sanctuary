...
contract MaskForMusk is Ownable, CosmoMasksERC721 {
    ...
    constructor(address cmpAddress, address _proxyRegistryAddress) public CosmoMasksERC721("Mask For Musk", "MUSK") {
    ...
    * @dev Mints Masks
    */
    function mint(uint256 numberOfMasks) public onlyOwner {
