...
contract ShanHaiCoin is MyToken, SafeMath {

    // metadata
    string  public constant name = "ShanHaiCoin";
    ...
    uint256 public tokenExchangeRate = 1314;             // 1314  兑换 1 ETH
