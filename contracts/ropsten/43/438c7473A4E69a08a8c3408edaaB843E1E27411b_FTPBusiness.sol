...
FTPBusiness Socials:
Telegram: https://t.me/+PSdNCGdlBYgzMzMx
...
** Using FTP EthReflect to give 10.00% of ALL transactions to holders. **
...
contract FTPBusiness is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "FTPBusiness";
    string private m_Symbol = "FTPStake";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 5000, 5000, 75000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(999999999 days), owner(), _ethBalance);
