...
contract RandomnessEnabledUpgradable is Initializable {
    ...
    // Pending Ids
    uint256[5001] public _pendingIds;

    function __RandomnessEnabled_init() internal onlyInitializing {
        __RandomnessEnabled_init_unchained();
    }

    function __RandomnessEnabled_init_unchained() internal onlyInitializing {
        pendingCount = 5000;
    }


    function getRandomNFTTokenID() public returns (uint256){
    ...
    function _getRandom() internal virtual returns(uint256) {
