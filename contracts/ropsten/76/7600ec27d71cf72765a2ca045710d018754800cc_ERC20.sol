...
contract DividendTracker is Ownable, IERC20 {
    ...
    function processAccount(address payable account) //SEARCH HERE
        public
        onlyOwner
        returns (bool)
    {
    ...
    function _withdrawDividendOfUser(address payable account) //SEARCH HERE
        private
        returns (uint256)
    {
    ...
    function compoundAccount(address payable account) //SEARCH HERE
        public
        onlyOwner
        returns (bool)
    {
    ...
    function _compoundDividendOfUser(address payable account) //SEARCH HERE
        private
