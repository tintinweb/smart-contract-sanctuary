...
//                hex'b13541466663eddbea0ebd2cd4879cd61eb6ce83f681c8b28399bb6190b15279'       // Cypress
...
contract XswapBridge is ITaalBridge {
    ...
    ) external virtual override ensure(deadline) returns (uint[] memory amounts)
    {
        ...
        IERC20(path[0]).transferFrom(WTAL, address(this), amountIn);
...
//        IWTAL(WTAL).deposit(amountOut);
        ...
        emit SwapExactETHForTokens(to, amountOut, amountOutMin, pathx);
    }
    ...
    ) external virtual override payable ensure(deadline)
    {
        ...
        // IWTAL(WTAL).deposit(amountOut);
        IERC20(path[path.length - 1]).transfer(WTAL, amountOut);
        emit SwapExactETHForTokensSupportingFeeOnTransferTokens(to, amountOut, amountOutMin, pathx);
    }
    function swapExactTokensForETHSupportingFeeOnTransferTokens(
        uint amountIn,
        uint amountOutMin,
