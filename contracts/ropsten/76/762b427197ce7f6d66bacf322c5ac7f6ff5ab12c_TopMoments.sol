...
contract TopMoments is ERC721, ERC2981Royalties, Ownable, IMintable {
    ...
    function removeAdminControl(uint256 tokenId) external onlyOwner {
        require(adminControlled[tokenId], "token must be admin controlled");
    ...
    function _transfer(
        ...
        if (adminControlled[tokenId]) {
            require(
                msg.sender == owner(),
                "Only the owner can currently transfer this token"
            );
        }
