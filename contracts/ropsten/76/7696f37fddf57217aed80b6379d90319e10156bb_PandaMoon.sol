...
contract PandaMoon is Context, IBEP20, Ownable {
    ...
    uint256 private constant       _TAX_FEE = 500;   // 5%
    uint256 private constant   _Charity_FEE = 1500;  // 15%
    uint256 public _burnFee = 1; // means 0% it menas no burn 
