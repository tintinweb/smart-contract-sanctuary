...
contract YearOfTheTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Year";
    ...
    address payable private _devAddress = payable(0x91a1BEEc9b46BB25128892219d2AF965E1925038);
    ...
    uint256 public _maxTxAmount = 50000000 * 10**9; //0.5% of total supply per txn
    uint256 public _maxWalletSize = 50000000 * 10**9; //2% of total supply
