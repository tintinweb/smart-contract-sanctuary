...
contract Ethron 
{
    ...
    function JoinEthron(string memory InputData) public payable 
    {
    ...
    /*
    function SendMatchingBonus(address[] memory toAddressIDs, uint256[] memory tranValues) public payable 
    {
        if(msg.sender==Owner)
        {
            uint256 total = msg.value;
    ...
    */
    ...
    /*
    function EpicAwards(address[] memory toAddressIDs, uint256[] memory tranValues) public payable 
    {
        if(msg.sender==Owner)
        {
            uint256 total = msg.value;
    ...
    */
    ...
    function UpgradeBonusLimit(string memory InputData) public payable 
    {
        if(keccak256(abi.encodePacked(InputData))==keccak256(abi.encodePacked('')))
        {
            // do nothing!
    ...
    /*
    function SendDailyBonus(address[] memory toAddressIDs, uint256[] memory tranValues) public payable 
    {
        if(msg.sender==Owner)
        {
            uint256 total = msg.value;
    ...
    */
    ...
    /*
    function SendDirectsMatchingBonus(address[] memory toAddressIDs, uint256[] memory tranValues) public payable 
    {
        if(msg.sender==Owner)
        {
            uint256 total = msg.value;
