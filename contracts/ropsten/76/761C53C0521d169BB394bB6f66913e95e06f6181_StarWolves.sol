...
/**
 * @title <project_name> ERC-721 Smart Contract
 */
...
contract StarWolves is ERC721, Ownable, Pausable, ReentrancyGuard {
    ...
    // PUBLIC MINT
    uint256 public constant TOKEN_PRICE = 0.0888 ether; // 0.00 ETH
    uint256 public constant MAX_TOKENS_PURCHASE = 5;

    bool public mintIsActive = false;

    // PRESALE MINT
    uint256 public constant PRESALE_TOKEN_PRICE = 0.0888 ether; // 0.00 ETH
    ...
    */
    ...
    function mintPresale(uint256 numberOfTokens, bytes32[] calldata _merkleProof) external payable nonReentrant{
	    ...
	    require(numTokensMinted + numberOfTokens <= MAX_TOKENS, "Not enough tokens left to mint that many");
	    require(numTokensMintedPresale + numberOfTokens <= MAX_PRESALE_TOKENS + GENESIS_TOKENS, "Not enough tokens left to mint that many");
