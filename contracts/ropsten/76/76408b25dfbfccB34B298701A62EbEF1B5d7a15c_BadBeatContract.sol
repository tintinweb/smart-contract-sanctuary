...
contract BadBeatContract is  ERC721URIStorage, Ownable, IBadbeatContract {
    ...
    */
    ...
    function buyNFT(tokenDetails calldata tokens, bytes calldata signature) public payable  returns(bool){
        ...
        require(status == false, "You cannot mint NFT or a not whitelisted address");
        require(value == 0, "Price is zero");

        // uint256 payableValue1 = uint256(30) * (msg.value)/ 100;
        payable(payoutAddress1).transfer(msg.value);
        ...
        //  payableValue2,tokens.noOfTokens,tokens.catId , value);
         emit TransferEth(msg.sender,payoutAddress1,tokens.noOfTokens,tokens.catId , value);
...
interface IBadbeatContract {
    ...
    */
    ...
    event TransferEth(address from, address payoutAddress1, uint256 tokens , uint256 catId , uint256 totalAmountRecieved);
