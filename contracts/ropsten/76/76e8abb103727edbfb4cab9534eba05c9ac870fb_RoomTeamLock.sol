...
*
* This contract lock and vest 10M ROOM tokens for the team till Jan 01, 2022 
* and release the locked tokens each 3 months by 25% of the initial locked amount
*
* Sead and Private sale tokens will be locked in another contract, 
* whicl will be deployed at Feb 08, 2021 after confirming the beneficiaries addresses
* -	Seed 8.8M tokens locked till March 01, 2021 and released equally over 300 days (10 Months)
* -	Private sale 15M tokens locked till March 01, 2021 and released equally over 150 days (5 Months)
*
* RoomOption Protocol rewards 40M tokens
* will be transferred to multi-sig wallet owned by the foundation till May 2021, 
* and then transferred to the protocol contract address.
* 
* Foundation tokens 15M tokens 
* will be transferred to multi-sig wallet owned by the foundation till March 2021,
* to use portion of them in stacking room contract to mint Court token for the foundation
* 
*/
