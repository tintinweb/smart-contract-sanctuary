...
contract LoadOutToken is Context, IBEP20, Ownable {
    ...
    uint256 public _taxFee       = 0; // 1% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 0; // 1% of every transaction is kept for liquidity
    uint256 public _marketingFee = 0; // 1% of every transaction is sent to marketing wallet

    uint256 private _previousTaxFee       = _taxFee;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _maxTxAmount                   = 11000000000 * 10**18; // 55 Million 0.5% ot total Supply
