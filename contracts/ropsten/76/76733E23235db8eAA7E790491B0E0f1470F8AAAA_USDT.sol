 ...
 * SmartContract: ropsten.org/usdt
 * website : ropsten.org/usdt
...
contract USDT is ERC20Interface, Tokenlock, UserLock {
    ...
    constructor() public {
        ...
        _totalSupply = 1001000 * 10**uint(decimals);
