...
contract myTestToken is Context, IERC20, Ownable {
    ...
    string private _name = "myTestTokenV21";
    string private _symbol = "MTTV21";
    ...
    function _transfer(
        ...
        // Balance + ( Buy Amount - Fees ) <= _maxBalance
        require(
    ...
    function maxBalanceInPercent() public view returns (uint256) {
        return _maxBalance.div(_totalSupply);
    }
