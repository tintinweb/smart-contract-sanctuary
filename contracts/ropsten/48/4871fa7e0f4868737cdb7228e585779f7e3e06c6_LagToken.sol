...
contract LagToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LagToken() {
        ...
        name = "LagToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LTN";                                             // Set the symbol for display purposes (CHANGE THIS)
