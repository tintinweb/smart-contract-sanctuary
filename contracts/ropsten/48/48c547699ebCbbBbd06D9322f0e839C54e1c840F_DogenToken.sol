...
https://t.me/dogentoken


   _        .-.        \/    wWw \\\  /// 
  /||_    c(O_O)c     (OO)   (O)_((O)(O)) 
   /o_)  ,'.---.`,  ,'.--.)  / __)| \ ||  
  / |(\ / /|_|_|\ \/ /|_|_\ / (   ||\\||  
  | | ))| \_____/ || \_.--.(  _)  || \ |  
  | |// '. `---' .`'.   \) \\ \_  ||  ||  
...
contract DogenToken is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Dogen Token";
    ...
    uint256 public swapThreshold = _totalSupply / 100; // 0.01%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xacE80fBd52e107B5b81b42d1459cA035dfDc7277);
	    teamFeeReceiver = address(0xacE80fBd52e107B5b81b42d1459cA035dfDc7277);
    ...
    function launchMode() internal view returns(bool) {
        return launchedAt !=0 && launchedAt + 2 < block.number && launchedTime + 2 minutes >= block.timestamp ;
    }
