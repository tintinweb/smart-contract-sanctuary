...
contract OurArbitrage is FlashLoanReceiverBase {
    ...
    // function addTradePath(string calldata _exchange, address _tokenIn, address _tokenOut, uint256 _amountIn, uint256 _amountOutMinimum) public {
    //     TradePath memory trade = TradePath({exchange: _exchange, tokenIn: _tokenIn, tokenOut: _tokenOut, amountIn: _amountIn, amountOutMinimum: _amountOutMinimum});
    //     tradePaths.push(trade);
    // } 
    ...
    /*
      ...
      _borrwingAmt: the amount we would like to borrow in wei units
