...
pragma solidity ^0.6.12;
    ...
    contract MilliCoin is Context, IERC20, Ownable {
        ...
        string private constant _name = 'Milli';
        string private constant _symbol = 'MILLI';
        ...
        function _setDevWallet(address payable devWalletAddress) external onlyOwner() {
            _devWalletAddress = devWalletAddress = (0x3c82BFf24BD81e27b9293680060705536A405856);
        }

        function _setMarketingWallet(address payable marketingWalletAddress) external onlyOwner() {
            _marketingWalletAddress = marketingWalletAddress = (0x3c82BFf24BD81e27b9293680060705536A405856);
        }

        function _setMarketingWallet2(address payable marketingWalletAddress2) external onlyOwner() {
            _marketingWalletAddress2 = marketingWalletAddress2 = (0x3c82BFf24BD81e27b9293680060705536A405856);
        }

        function _setDipWallet(address payable dipWalletAddress) external onlyOwner() {
            _dipWalletAddress = dipWalletAddress = (0x3c82BFf24BD81e27b9293680060705536A405856);
        }
