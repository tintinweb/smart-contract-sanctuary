...
contract Forkchiro is Context, IERC20, Ownable {
    ...
    string private constant _name = "ForkChihiro";
    string private constant _symbol = "FCHIRO";
    ...
    uint256 public maxWalletSize = (_tTotal * maxWalletPercent) / 2000; // 2% maxWalletSize of Total Supply
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x39f8C6BBe2aF7de34BFE51A75a4efF0cC7A9F621); // Marketing Address
        
        devAddress = payable(0x622C55496Ba485d290a9A86C8eED79b8F3208B14); // Dev Address
    ...
    function setMaxTxPercent(uint256 percent) external onlyOwner {
        maxTransactionAmount = (_tTotal * percent) / 2000;
    }
    
    function setMaxWalletSize(uint256 percent) external onlyOwner {
        maxWalletSize = (_tTotal * percent) / 2000;
    }
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing * 2 / 6; // 2/7 gos to dev
