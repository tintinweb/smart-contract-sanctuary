 ...
 * Simply hold BNBD to join the journey and experience all of the benefit from BNB Diamond.
 * 
 * 100% Unruggable
 * --------------- 
 * We will lock 100% LP on Unicrypt right after adding liquidity.
 * You are safe with BNB Diamond!
 * 
 * Stabilizes Price
 * ---------------- 
 * BNB Diamond adds 5% of each transaction to the liquidity pool 
 ...
 * Marketing
 * ---------------
 * 1% will be sent to marketing BNB Diamond.
 * 
 * Tokenomics
 * ----------
...
contract BNBDiamond is Context, IERC20, Ownable {
    ...
    string private _name = "BNB Diamond";
    string private _symbol = "BNBD";
