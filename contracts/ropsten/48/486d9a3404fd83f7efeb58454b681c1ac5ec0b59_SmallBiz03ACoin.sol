...
contract SmallBiz03ACoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTestCoin() {
        ...
        name = "Small Biz Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SBT03A";                                             // Set the symbol for display purposes (CHANGE THIS)
