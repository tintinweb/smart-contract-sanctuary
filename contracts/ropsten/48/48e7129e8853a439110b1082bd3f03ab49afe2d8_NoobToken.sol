...
contract NoobToken is Context, Ownable, IERC20 {
    ...
    string private _name = "Noob";
    string private _symbol = "NOOB";
    ...
    function getTotalFunds() public view returns (uint256) {
    	uint256 communityNoobFund = burnableFund.add(operationalFund).add(communityFund).add(liquidityPoolFund);
    	return communityNoobFund;
    }
    ...
    function withdrawOperationFund(uint256 amount, address walletAddress, string memory reason) public onlyOwner() {
        require(amount < operationalFund, "You cannot withdraw more funds that you have in the community noob fund");
    ...
    function withdrawCommunityFund(uint256 amount, address walletAddress, string memory reason) public onlyOwner() {
        require(amount < communityFund, "You cannot withdraw more funds that you have in the community noob fund");
    	require(amount <= _balance[address(this)], "You cannot withdraw more funds that you have in the fund");
    ...
    function hydrateLiquidityPool(uint256 amount, address walletAddress, string memory reason) public onlyOwner() {
        require(amount < liquidityPoolFund, "You cannot withdraw more funds that you have in the community noob fund");
    	require(amount <= _balance[address(this)], "You cannot withdraw more funds that you have in the fund");
