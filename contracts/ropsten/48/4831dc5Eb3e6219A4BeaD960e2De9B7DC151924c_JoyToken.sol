...
contract BaseERC20Token is AccessControl, ERC20Pausable {
    ...
    constructor(string memory _name, string memory _symbol, uint8 decimals_, uint256 _initialSupply)
        ERC20(_name, _symbol) {
        _decimals = decimals_;
    ...
    function burn(address _from, uint256 _amount) public onlyAdminRole {
        _burn(_from, _amount);
    }
