...
contract CivInvestment is ICivInvestment, Ownable {
    ...
    function mintNewPosition(
        ...
        WETH.deposit{value: amount0ToMint}();

        TransferHelper.safeApprove(_WETH, address(v3NftManager), amount0ToMint);
        TransferHelper.safeApprove(_CIV, address(v3NftManager), amount1ToMint);
