...
contract AdventureCompanions is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private suffixes = [
       ...
       "from Hill Forest",
       "from Grail Fort",
       "from Mystic Hill Fort",
       "from Old Fate Lake",
       "from Grail Forest",
       "from Diamond Lake",
       "from Trinity Peaks",
       "from New Dripping Fort",
       "from New Halo Village",
       "from Dragon Island",
       "from Holy Fort",
       "from Oake Castle",
       "from Dragon Lake",
       "from Creater Springs",
       "from Holy Loch",
       "from Hill Hall"
    ];
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "PET #', toString(tokenId), '", "description": "Every adventure needs a companion. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use your companion in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("AdventureCompanions", "ACOM") Ownable() {}
}
