...
// File: gist-93cc6447162a8ffd1a88992ba6170fd6/contracts/Interfaces/ITokenRecipient.sol

pragma solidity ^0.4.13;

contract ItokenRecipient {
  
  function receiveApproval(address _from, uint256 _value, address _token, bytes _extraData) public returns (bool success);
  
}

// File: gist-93cc6447162a8ffd1a88992ba6170fd6/contracts/Token.sol
...
// File: gist-93cc6447162a8ffd1a88992ba6170fd6/contracts/MyToken.sol

pragma solidity ^0.4.13;


contract Tolsis is Token {
  ...
  function Tolsis(address _crowdsaleAddress) public {
    standard = "Tolsis Token v1.0";
    name = "Tolsis Token";
    symbol = "TOLSIS"; // token symbol
    decimals = 18;
