...
// ----------------------------------------------------------------------------
// 'TKN-Brotherhood' token contract
//
// Deployed to : 0x7b12aD20282912153B9Fd6901672A9eD9F5dB473
// Symbol      : BRO
// Name        : Brotherhood
...
contract GGMToken is ERC20Interface, Owned, SafeMath {
    ...
    // ------------------------------------------------------------------------
    // CONSTRUCTOR
    // My MetaMask receiving wallet address
    // ------------------------------------------------------------------------
    constructor() public {
        symbol = "BRO";
        name = "Brotherhood";
        ...
        balances[0x7b12aD20282912153B9Fd6901672A9eD9F5dB473] = _totalSupply;
    ...
    // ------------------------------------------------------------------------
    // FUNCTION - Get the token balance for account tokenOwner
    // ------------------------------------------------------------------------
