...
contract Sale {
    ...
    function Sale(address _wallet) {
        ...
        maxMintable = 20000000000000000000000000000; // 3 million max sellable (18 decimals)
        ETHWallet = _wallet;
        isFunding = true;
        creator = msg.sender;
        createHeldCoins();
        exchangeRate = 12000000;
    }
    ...
    function createHeldCoins() internal {
        ...
        createHoldToken(0x551c38aFa5eF471b19Eae9f8CD276261bB307EbD, 100000000000000000000000);
        createHoldToken(0xAd9353b3a547617B165F74d9C403DFC521cA02dC, 100000000000000000000000);
    }
