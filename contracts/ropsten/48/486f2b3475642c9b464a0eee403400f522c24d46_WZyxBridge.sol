...
library ChainId {
    int public constant zyxChainId = 88;
...
contract WZyxBridge is Ownable,Pausable {
    using SafeMath for *;
    ...
    function newTransfer(Swap calldata swapInfo) public onlyOracle supportedToken(swapInfo.token) isPause {
