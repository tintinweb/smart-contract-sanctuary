...
contract TMNK1 is IERC20, Auth {
	using SafeMath for uint256;
	string constant _name = "Test TMNK1";
	string constant _symbol = "TMNK1";
	...
	address payable private _taxWallet1 = payable(0xd95dE4DBa6ac67f78e5508757e62A04f428D28D8); //marketing
	address payable private _taxWallet2 = payable(0x4d9043eb01e4Cf5BaD8b4574418f2562661C036C); //team
    address payable private _taxWallet3 = payable(0x4d9043eb01e4Cf5BaD8b4574418f2562661C036C); //dev
...
// constructor () Auth(msg.sender) {
    ...
    function unclogTaxRouter() external {
        ...
        require(taxTokenBalance > (_totalSupply * 1 / 100), "Tax token balance too low");
