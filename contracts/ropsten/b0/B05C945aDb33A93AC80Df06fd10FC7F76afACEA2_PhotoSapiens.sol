...
contract PhotoSapiens is ERC721Enumerable {
    ...
    function mint(
        ...
        if (block.timestamp <= _launchDate + _whitelistTime) {
            ...
            require(ecrecover(whitelistHash, whitelistSignature.v, whitelistSignature.r, whitelistSignature.s) == _signerAddress, "not whitelisted");
        }
        ...
        require(signer == _signerAddress, "signature does not match");
