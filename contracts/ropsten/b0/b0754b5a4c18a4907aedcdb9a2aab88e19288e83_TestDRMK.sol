...
contract TestDRMK is ERC20 {
    ...
    function name() public constant returns (string) { return "TestDRMK"; }
    function symbol() public constant returns (string) { return "TEST"; }
