    ...
    OwnableUpgradeable
{
    ...
    function initialize(IERC20 _lfwAddress) public initializer {
        __Context_init();
        __Ownable_init();
        require(address(_lfwAddress) != address(0));
        lfwToken = _lfwAddress;
    }
        ...
        validNFTContractAddress(_nftAddress)
    {
        ...
        lfwToken.safeTransferFrom(msg.sender, _listing.owner, _listing.price);
