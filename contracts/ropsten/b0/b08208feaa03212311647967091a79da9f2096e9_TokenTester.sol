...
contract TokenTester is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Token Tester Protocol";
    ...
    function buyAndBurnToken(uint256 contractBalance) public lockTheSwap {
        lastRebalance = now;
