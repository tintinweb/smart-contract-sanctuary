...
contract SuperToken is Ownable {
    ...
    constructor (address addr) public { Super = IERC20(addr); }
    ...
    function withdrawUnsold(uint256 amount) public onlyOwner {
        require(amount <= Super.balanceOf(address(this)).sub(totalOwed), "insufficient balance");
        Super.transfer(msg.sender, amount);
    }

    

    // the amount of Super purchased
    ...
    function claim() public {
        ...
        // send owed tokens
        require(Super.transfer(msg.sender, amount), "failed to claim");
    }
