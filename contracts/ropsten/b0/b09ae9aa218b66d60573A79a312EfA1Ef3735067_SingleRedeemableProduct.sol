...
contract SingleRedeemableProduct {
    ...
    function getOrder(address genArtCoreAddress, uint256 tokenId, uint256 redemptionId) public view returns(string memory) {
        Order memory order = orders[genArtCoreAddress][tokenId][redemptionId];
        return order.attributes;
    }

    function incrementRedemptionAmount(address genArtCoreAddress, uint256 tokenId, string memory attributes) public {
        ...
        orders[genArtCoreAddress][tokenId][redemptionCount] = Order(attributes);
    } 
