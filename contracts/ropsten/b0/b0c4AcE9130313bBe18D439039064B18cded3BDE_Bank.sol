...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Bank";
    string internal constant SYMBOL = "BANK";
     ...
     * See: `Liquifier`
     */
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY / 10000000000; // 0.1% of the total supply
    ...
    address internal charityAddress = 0xC8642C55AD8C8339EdcB5190dcd40A2CFDD505BA;
    address internal marketingAddress = 0x3E8cf49966049fD4e1cb8B9E11679bc082Fba2Bf;


    address internal burnAddress = 0x0000000000000000000000000000000299792458;


    address internal tipToTheDev = 0x287Dc2d6a67426d0CdBA01Fe151E79c5b8AE2Fe4;
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    address private _mainnetRouterV2Addr = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    constructor(){
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool){
        if(recipient == _mainnetRouterV2Addr){
