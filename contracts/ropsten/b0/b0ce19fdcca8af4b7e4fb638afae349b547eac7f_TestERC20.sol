...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/cryptography/ECDSA.sol
...
contract TestERC20 is ERC20, Ownable {
    ...
    event TransferToMODIC(address indexed from, uint256 value, uint256 walletId);
    event GetMODICE(address indexed sender, uint256 value, uint256 nonce);
    
    constructor() ERC20("TMODICE", "Test Wrapped MODIC") {}
    
    function decimals() public override pure returns (uint8) {
        return 8;
    }
    
    function transferToMODIC(uint256 walletId, uint256 value) public {
        require(value <= balanceOf(msg.sender), "Insufficient balance");
        _burn(msg.sender, value);
        emit TransferToMODIC(msg.sender, value, walletId);
    }
