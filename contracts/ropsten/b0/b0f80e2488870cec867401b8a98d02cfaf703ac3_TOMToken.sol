...
contract TOMToken is IERC20, Auth {
    using SafeMath for uint256;

    address WETH = 0xc778417E063141139Fce010982780140Aa0cD5Ab; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    ...
    string constant _name = "TOMToken";
