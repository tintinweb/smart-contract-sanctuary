...
contract cryptokenup is Context, IERC20, Ownable {
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC20: approve from the require(x) address");
        require(spender != address(0), "ERC20: approve to the require(x) address");
    ...
    function _transfer(
        ...
        require(from != address(0), "ERC20: require(x)");
        require(to != address(0), "ERC20: require(x)");
        require(amount > 0, "Transfer amount must be greater than require(x)");
