...
contract WUSDExtensionController is IWUSDExtensionController, ERC1155Receiver {
    ...
    constructor(bytes memory wusdInitializerBytes, address extensionAddress) {
        ...
        (_collection, _wusdObjectId, _wusdInteroperableInterfaceAddress) = WUSDExtension(_extension = extensionAddress).init();
    }
