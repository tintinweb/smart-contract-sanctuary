...
contract Bridge is ReentrancyGuard, Ownable {
    ...
    constructor(address _token) public {
        token = _token;
        holdTimeOptions.push(HoldTimeOption(1619827200, DECIMAL_PRECISION_MULTIPLIER.mul(10), [0, 500, 700, 1200, 2500, 6000])); // Before 1st May 2021
        holdTimeOptions.push(HoldTimeOption(1622505600, DECIMAL_PRECISION_MULTIPLIER.mul(9), [0, 400, 500, 1000, 2000, 5000])); // Before 1st June 2021
        holdTimeOptions.push(HoldTimeOption(1625097600, DECIMAL_PRECISION_MULTIPLIER.mul(8), [0, 300, 400, 900, 1800, 4500])); // Before 1st July 2021
        holdTimeOptions.push(HoldTimeOption(1627776000, DECIMAL_PRECISION_MULTIPLIER.mul(7), [0, 200, 400, 800, 1600, 4000])); // Before 1st August 2021
        holdTimeOptions.push(HoldTimeOption(1630454400, DECIMAL_PRECISION_MULTIPLIER.mul(6), [0, 100, 300, 600, 1400, 3500])); // Before 1st September 2021
        holdTimeOptions.push(HoldTimeOption(1633046400, DECIMAL_PRECISION_MULTIPLIER.mul(5), [0, 100, 200, 500, 1200, 3000])); // Before 1st October 2021
        holdTimeOptions.push(HoldTimeOption(1635724800, DECIMAL_PRECISION_MULTIPLIER.mul(4), [0, 100, 100, 400, 1100, 2500])); // Before 1st November 2021
        holdTimeOptions.push(HoldTimeOption(1638316800, DECIMAL_PRECISION_MULTIPLIER.mul(3), [0, 100, 100, 300, 1000, 2000])); // Before 1st December 2021
        holdTimeOptions.push(HoldTimeOption(1640995200, DECIMAL_PRECISION_MULTIPLIER.mul(2), [0, 100, 100, 200, 900, 1500])); // Before 1st January 2022
        holdTimeOptions.push(HoldTimeOption(1643673600, DECIMAL_PRECISION_MULTIPLIER.mul(1), [0, 100, 100, 100, 800, 1000])); // All time after (this time never use)
