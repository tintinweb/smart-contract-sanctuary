...
** Using FTP ILO to provide up to 1.23% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract ILOTest16 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOTest16";
    string private m_Symbol = "ILO16";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xa69043a7E0e03DF300beAA3c179886A9140734DB);
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1230, 400, m_ILOPublic);
        initTax();
