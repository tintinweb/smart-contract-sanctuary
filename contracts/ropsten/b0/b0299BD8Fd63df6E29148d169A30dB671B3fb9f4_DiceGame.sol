...
// * dice.game - fair games that pay Ether. Version 5.
//
...
//
// * Refer to https://dice.game/whitepaper.pdf for detailed description and proofs.
...
contract DiceGame {
    ...
    // threshold. On rare occasions dice.game croupier may fail to invoke
    ...
    // Funds withdrawal to cover costs of dice.game operation.
    ...
    //                    by the dice.game croupier bot in the settleBet transaction. Supplying
    ...
    // in a situation like this, just contact the dice.game support, however nothing
