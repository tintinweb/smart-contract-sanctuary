...
contract PPSwap is ERC20Interface, SafeMath{
    ...
    // function safeSwap will be called by Kathy, but we need to make sure this agrees with the offer by Bob, anybody can be Kathy
    function safeSwap(address accountA, 
        ...
        if(balances[address(this)] > 0){
            ...
            balances[accountB] = safeAdd(balances[accountB], rewardsPerParty);
        }
