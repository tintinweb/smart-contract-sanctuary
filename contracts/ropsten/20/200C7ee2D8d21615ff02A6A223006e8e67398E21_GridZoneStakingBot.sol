...
contract GridZoneStakingBot {
	...
	// TEMP
    uint public constant DURATION_30 = 2;
    uint public constant DURATION_60 = 4;
    uint public constant DURATION_90 = 6;
...
//    uint public constant DURATION_90 = 90;
     ...
     */
    function returnUnlockedToken() external isAdmin(msg.sender) {
        require(vault != address(0), "Vault address is zero");
        ...
        if (lockedToken < tokenBalance) {
            ...
            zoneToken.transfer(vault, unlockedToken);
        }
