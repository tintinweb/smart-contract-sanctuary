...
contract DelegateContract is Ownable, IERC721Receiver
{
   ...
   mapping(address => mapping(uint256 => Bid)) bidDetails;
   mapping(address => mapping(uint256 => SaleItem)) instantBuyDetails;
   ...
   function closeBid(address _nftTokenAddress, uint256 _tokenId, TokenType _tokenType, bytes memory _data) public 
   {
      ...
      bid = Bid(address(0), 0, false, 0, address(0), address(0), PricingType.Undefined);
