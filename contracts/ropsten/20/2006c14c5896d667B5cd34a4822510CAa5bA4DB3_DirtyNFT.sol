...
contract DirtyNFT is Ownable, Authorizable, Whitelisted, ERC721Enumerable, ReentrancyGuard  {
    ...
    function setCreatorInfo(address _creator, string memory _collectionName, string memory _nftName, string memory _URI, uint256 _price, uint256 _splitPercent, uint256 _mintLimit, bool _redeemable, bool _mintInitial) public onlyWhitelisted returns (uint256) {
    ...
    function getAllNFTbyAddress(address _address) public view returns (uint256[] memory) {
