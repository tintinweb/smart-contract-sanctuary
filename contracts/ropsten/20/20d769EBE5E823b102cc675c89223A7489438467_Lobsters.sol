...
contract Lobsters is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Date of release;
    uint public releaseTimestamp = 1637764200000;
    ...
    address private constant royaltyAddress = address(0);
    uint256 private constant ROYALTY_SIZE = 125; // 2.5%
    ...
    */
    ...
    modifier onlyOwner() {
     ...
     modifier afterRelease {
      require((block.timestamp * 1000) >= releaseTimestamp, "It is not salesmode yet");
      _;
   }
    ...
    function buyTokens(uint tokensNumber) public payable afterRelease {
