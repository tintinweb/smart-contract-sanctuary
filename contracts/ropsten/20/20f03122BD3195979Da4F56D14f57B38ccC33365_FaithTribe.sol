...
contract FaithTribe is ERC20, ERC20Snapshot, AccessControl, Pausable {
    ...
    constructor(uint256 _maxSupply, address adminRole, address snapshotRole, address pauserRole, address burnerRole, address minterRole) ERC20("Tribe", "TRIBE") {
