...
/**
 *Submitted for verification at BscScan.com on 2021-22-04
 */

/**
   #DaCoin. 
  
   Important: The early you create a group that shares DaCoin, the more gain you got.
   ...
   I make this #DaCoin to hand over to DaCommunity.
   Create DaCommunity by yourself if you are interested.   

   DaFeatures:
   7% fee auto add to the liquidity pool to locked forever when selling
   3% fee auto distribute to DaHolders
   50% burn.


   I will add 1 BNB and all the left 49% total supply to the pool
   Can you make #DaCoin 1000X? 
   ...
   and the contract will sell it and add to DaLiquidity automatically.
 */
