...
contract sestraSwap {
    ...
    event sellingHistory(address userAddress, uint256 sellAmount, uint256 receivingAmount, uint256 time);
    event buyingHistory(address userAddress, uint256 buyingAmount, uint256 sendAmount, uint256 time);
    event liquidityHistory(address tokenAddress, uint256 tokenAmount, uint256 time);
    event withdrawHistory(address tokenAddress, uint256 tokenAmount, uint256 time);
    
    constructor(address _usdt, address _sestra, uint256 _sestraPrice) payable {
