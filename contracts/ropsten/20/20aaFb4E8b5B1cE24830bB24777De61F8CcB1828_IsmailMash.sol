...
contract IsmailMash is Context, IERC20, Ownable 
{
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = 'IsmailMash';
    string private _symbol = 'MSH';
    uint8 private _decimals = 9;
    
    address payable public marketingAddress = payable(0x82428b52952D0884f06a44863B1280474669737f);
