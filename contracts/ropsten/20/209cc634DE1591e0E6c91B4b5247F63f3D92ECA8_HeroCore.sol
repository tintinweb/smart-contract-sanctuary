...
contract HeroMinting is HeroAuction {
    ...
    uint256 public constant GEN0_CREATION_LIMIT = 2100;
...
contract HeroAuction is HeroBreeding {
    ...
    function setBreedingAuctionAddress(address _address) external onlyOwner {
        ...
        require(candidateContract.isBreedingClockAuction(), "Candidate contract is illegal.");
...
//        console.log("target block:", targetBlock);
    ...
    function _rand(uint256 _range) public view returns (uint256) {
...
contract BreedingAuction is AuctionCore {
    ...
    function isBreedingClockAuction() external pure returns (bool) {
        return true;
    }
...
contract AuctionCore is AuctionBase, Ownable, Pausable {
    ...
    bytes4 public constant INTERFACE_SIGNATURE_ERC721 = bytes4(0x80ac58cd);
