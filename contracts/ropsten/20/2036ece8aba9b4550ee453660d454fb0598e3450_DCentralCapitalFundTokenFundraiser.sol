...
/**
 * @title DCentralCapitalFundToken
 */
...
/**
 * @title DCentralCapitalFundTokenSafe
 */
 
contract DCentralCapitalFundTokenSafe is TokenSafe {
    ...
    public
  {
    ...
    add(
      0, // Group Id
      0x34e96114B9B5E67090DF7F4b9f0d20E78AC720b3, // Token Safe Entry Address
      1000000000000000000000000  // Allocated tokens
    );
  }
}
...
/**
 * @title DCentralCapitalFundTokenFundraiser
 */

contract DCentralCapitalFundTokenFundraiser is MintableTokenFundraiser, CappedFundraiser, RefundableFundraiser, GasPriceLimitFundraiser {
  DCentralCapitalFundTokenSafe public tokenSafe;

  constructor()
    HasOwner(msg.sender)
    public
  {
    token = new DCentralCapitalFundToken(
      
      address(this)  // The fundraiser is the minter
    );

    tokenSafe = new DCentralCapitalFundTokenSafe(token);
    MintableToken(token).mint(address(tokenSafe), 1000000000000000000000000);

    initializeBasicFundraiser(
      1532512800, // Start date = 25 Jul 2018 10:00 UTC
      1542358800,  // End date = 16 Nov 2018 09:00 UTC
      350, // Conversion rate = 350 DCEN per 1 ether
