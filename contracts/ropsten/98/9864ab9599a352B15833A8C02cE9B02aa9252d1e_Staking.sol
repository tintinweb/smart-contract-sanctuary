...
contract Staking is Ownable {
    ...
    IERC20 private _PIXIEAddress = IERC20(0xD1075C2084B87bF093117601545EfF792f1e6320); //REMEMBER TO CHANGE
    ...
    function setDailyRewards() public {
        if (_usersStaked.length < 1) return;
        ...
        for (uint i = 0; i < _usersStaked.length; i += 1) {
            ...
            uint _stakeDay = _userStakeDayTimestamp / 10 minutes; //REMEMBER TO CHANGE
