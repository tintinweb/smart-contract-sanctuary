...
contract sOmicron is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Omicron", "sOMIC", 9) ERC20Permit() {
    ...
    /**
        @notice increases sOMIC supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sOMIC
