...
contract testtax is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "testtax";                                           // name
    string private _symbol = "testtax";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x4Fb4938EDAf088dea704362Ee183603Be5868019);
