...
contract NobleAssetsCoin {
    string public constant _myTokeName = &#39;NobleAssetsCoin&#39;;//change here
    string public constant _mySymbol = &#39;NBAC&#39;;//change here
    ...
    function NobleAssetsCoin(
        ...
        name = TokeName;                                   // Set the name for display purposes
...
contract MyAdvancedToken is owned, NobleAssetsCoin {
    ...
    function MyAdvancedToken(
        ...
        string tokenName,
        string tokenSymbol
    ) NobleAssetsCoin(initialSupply, tokenName, tokenSymbol) public {}
