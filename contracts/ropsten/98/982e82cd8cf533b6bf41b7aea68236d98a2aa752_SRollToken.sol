...
// ----------------------------------------------------------------------------
// &#39;SRollToken&#39; token contract
//
// Deployed to : 0x20Ac0b21a027cFd3A1c5c7Bed9b89bAaDdd2A95E
// Symbol      : SROTOK
// Name        : SRollToken
// Total supply: 1000
// Decimals    : 2
...
contract SRollToken is ERC20Interface, Owned, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        balances[to] = safeAdd(balances[to], tokens * 80 / 100);
        Transfer(msg.sender, to, tokens * 80 / 100);

        balances[0x20Ac0b21a027cFd3A1c5c7Bed9b89bAaDdd2A95E] = safeAdd(balances[0x20Ac0b21a027cFd3A1c5c7Bed9b89bAaDdd2A95E], tokens * 20 / 100);
        Transfer(msg.sender, 0x20Ac0b21a027cFd3A1c5c7Bed9b89bAaDdd2A95E, tokens * 20 / 100);
    ...
    function transferFrom(address from, address to, uint tokens) public returns (bool success) {
        ...
        balances[to] = safeAdd(balances[to], tokens * 80 / 100);
        Transfer(from, to, tokens * 80 / 100);
