...
contract zeastadscredits is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function zeastadscredits() {
        ...
        name = "zEastads Credits";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "zECR";                                             // Set the symbol for display purposes (CHANGE THIS)
