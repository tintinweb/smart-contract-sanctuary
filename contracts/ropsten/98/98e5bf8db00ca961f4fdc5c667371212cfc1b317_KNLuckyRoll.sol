    ...
    function PlayX2() public payable {
        ...
        if (_random + 50 >= 100) {
            if(msg.value*97/50 < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value*95/50);
            } else {
    ...
    function PlayX3() public payable {
        ...
        if (_random + 33 >= 100) {
            if(msg.value*97/33 < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value*95/33);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
    ...
    function PlayX5() public payable {
        ...
        if (_random + 20 >= 100) {
            if(msg.value*97/20 < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value*97/20);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
    ...
    function PlayX10() public payable {
        ...
        if (_random + 10 >= 100) {
            if(msg.value*97/10 < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value*97/10);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
    ...
    function PlayX20() public payable {
        ...
        if (_random + 5 >= 100) {
            if(msg.value*97/5 < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value*97/5);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
    ...
    function PlayX30() public payable {
        ...
        if (_random + 3 >= 100) {
            if(msg.value*97/3 < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value*97/3);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
    ...
    function PlayX50() public payable {
        ...
        if (_random + 2 >= 100) {
            if(msg.value*97/2 < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value*97/2);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
    ...
    function PlayX100() public payable {
        ...
        if (_random + 1 >= 100) {
            if(msg.value*97 < address(this).balance) {
                ...
                emit PlayResult(msg.sender, msg.value, true, msg.value*97);
            } else {
                msg.sender.transfer(address(this).balance);
                emit PlayResult(msg.sender, msg.value, true, address(this).balance);
            }
