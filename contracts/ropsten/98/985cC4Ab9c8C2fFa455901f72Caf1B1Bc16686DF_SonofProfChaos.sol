...
SonofProfChaos Socials:
Telegram: https://t.me/sonofchaos
Twitter: https://twitter.com/sonofchaos
Website: https://sonofchaos.com
Whitepaper: https://sonofchaos.com/paper

** Using FTP ILO to provide up to 3.40% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract SonofProfChaos is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "SonofProfChaos";
    string private m_Symbol = "CHAOS2";
    ...
    constructor () {
        ...
        ILO.init(1100000000000000100, 3400, 3320, m_ILOPublic);
        initTax();
