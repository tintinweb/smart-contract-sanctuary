...
import "./ISITHToken.sol";
import "./SITHTokenPool.sol";
...
contract SITHToken is ISITHToken, ReentrancyGuard {
        ...
        )
    {
        ...
        uint256 j = userStakes[addr].length.sub(1);
        while (shares > 0) {
            Stake storage s = userStakes[addr][j];
...
import "./ISITHTokenFactory.sol";
import "./SITHToken.sol";


contract SITHTokenFactory is ISITHTokenFactory {
    // fields
