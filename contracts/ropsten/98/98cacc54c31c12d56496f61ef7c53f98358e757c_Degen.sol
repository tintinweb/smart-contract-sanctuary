...
contract Degen is Router, Ownable {
   ...
   modifier onlySystem() {
    ...
    function executeCrossExchange(
        ...
        processFee(feesPrice[0], feesPrice[1], feesPrice[2], licenseeVault, msg.sender);
    }
