...
contract UnlimitedMCSToken is BurnableToken{
...
contract Crowdsale is Ownable, IDMCOSAS {
  ...
  function MCSToken() public onlyOwner {
 ...
 mapping(address => uint) public balances;
  ...
  function CrowdsaleMCS () public {
	 token = IDMCOSAS(0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFfF);	
