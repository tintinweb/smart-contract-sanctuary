...
contract Guesses is Ownable{
   ...
   // uint internal maxId = 4*(10**9);//最大id 4亿
    ...
    struct Guess {
        address drawer;//发起人
        uint id; //竞猜id
        uint256 price;//竞猜每张票的价格（单位finny）
	 ...
	 * 
	 */
	function createGuess(uint _id,uint256 _price, uint _startTimestamp, uint _endTimestamp, uint _totOptionNum) public returns (uint){
...
*/
    ...
    function guess(string bet) public payable{
        ...
        uint256 overspend = msg.value - totPrice;
