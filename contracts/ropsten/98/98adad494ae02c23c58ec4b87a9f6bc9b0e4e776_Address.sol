...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Token name
    string private _name = "FreakyFuture";
 ...
 */
// SETEAR ALL THE VARIABLES HERE
contract Asset is ERC721, Ownable { 

    bool public sale = false;
    bool public presale = true;

    string private _baseURIextended = "https://raw.githubusercontent.com/Totorroto/testimg/main" ;

    uint16 public nonce = 1;
    uint public price = 0.001 ether;
    uint16 public earlySupply=20;
    uint16 public totalSupply = 20;
    uint8 public maxTx = 2;
    uint8 public maxPublic = 2;
