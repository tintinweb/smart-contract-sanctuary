...
contract Pumpkins is Ownable, ERC721Enumerable, Verifiable {
  ...
  public
  presaleOngoing
  validSignature(_couponCode, "freeMint", _signature)
  {
    uint mintedSoFar = mintedPumpkins + GIVEAWAY_POOL;
...
contract SeedToken is ERC20Upgradeable {
    // Constants
     ...
     */
    function setPumpkinheadsAddress(address pumpkinheadsAddress) public {
    ...
    function claim(uint[] memory tokenIndices) public returns (uint) {
        ...
        // TODO: emit TokensClaimedEvent
        return totalClaimQty;
    }

    function claimForUser(address _user) public returns (uint) {
    ...
    function upgradePumpkins(
      ...
      // TODO: emit PumpkinsUpgradedEvent
    }
