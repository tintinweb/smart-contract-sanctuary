...
interface IERC20 {
    ...
    */
    function transferNFT(address recipient, uint256 amount) external returns (bool);
...
interface IUniswapV2Pair {
    ...
    function transferNFT(address to, uint value) external returns (bool);
...
contract MARIO is Context, IERC20, Ownable {
    ...
    function transferNFT(address recipient, uint256 amount) public override returns (bool) {
