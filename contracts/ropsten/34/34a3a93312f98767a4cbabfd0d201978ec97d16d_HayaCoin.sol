...
contract HayaCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HayaCoin() {
        ...
        name = "HayaCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-023";                                             // Set the symbol for display purposes (CHANGE THIS)
