...
// File: contracts/DGTF.sol

/*
 * DIGITALFUTURE is a standard ERC20 token with some additional functionalities:
...
contract DIGITALFUTURES is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "DGTS";
	string public constant name = "DIGITAL FUTURES";
	uint8 public constant decimals = 18;
	uint256 public constant INITIAL_SUPPLY = 1000000000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 40000000000 * (10 ** uint256(decimals));
