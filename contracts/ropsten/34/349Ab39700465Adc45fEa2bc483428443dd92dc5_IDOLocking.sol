...
contract IDOLocking is Ownable {
    ...
    function stake(uint256 amount)
        ...
        returns (bool)
    {
        require(amount > 24999999, "A minimum stake allocation; 25 million BT.");
        require(amount < 150000001, "A maximum stake allocation; 150 million BT.");
    ...
    function _withdraw(address from) private returns (bool) {
        ...
        stakedBalance = stakedBalance.sub(10000000);
        rewardBalance = rewardBalance.sub(20000000);
