...
abstract contract EthReflectingToken is Ownable, ISupportingExternalReflection {
    ...
    bool internal distributionRoundCompleted = false;
    ...
    function reflectRewards() internal returns(bool) {
        return distributionRoundCompleted = reflectionContract.reflectRewards();
    }
