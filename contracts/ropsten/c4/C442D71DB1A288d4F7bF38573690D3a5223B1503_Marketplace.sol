...
contract Marketplace is AccessControlUpgradeable, MarketplaceSignature {
    ...
    function addAuctionLot(
        ...
        require(
            ...
            "Caller does`t have enough accessible token`s"
        );
        require(
...
interface IERC1155Implementation is IERC2981 {
    ...
    function tokenAmount(uint256 tokenId) external returns (uint256 amount);
