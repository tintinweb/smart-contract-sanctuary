...
string memory val2 = uintToString(divuu(luckAmount , (10 ** decimals)),false);
string memory time = uintToString(block.timestamp,false);

luckyWinners = string(abi.encodePacked(luckyWinners  ,"Time : ", time, ", Address : " , addr , " , Luck Reward : " , val2, " : ", val, "\n"));  
