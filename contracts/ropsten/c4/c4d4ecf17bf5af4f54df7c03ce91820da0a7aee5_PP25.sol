...
contract PP25 is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public PirateReserve = 150; // Reserve 150 Pirates for team & community (Used in giveaways, events etc...)

    event licenseisLocked(string _licenseText);

    constructor() ERC721("PP25", "PP25s") {}
    

       function withdraw() external {
        require(
                msg.sender == 0xE1318338E9969D69bb06A5Fce50501A4D72Ae342 ||
                msg.sender == 0x672c36FA22029369490BB5e33e6d16a7E1309c1e ||
                msg.sender == 0xbff1d50d3877E41046a8102103eBabe4835C3042 
        );

        uint256 bal = address(this).balance;

        uint256 FortyFive = bal.mul(45).div(100);
        payable(address(0xE1318338E9969D69bb06A5Fce50501A4D72Ae342)).call{
            value: FortyFive
        }("");
        ...
        payable(address(0xbff1d50d3877E41046a8102103eBabe4835C3042)).call{
            value: Ten
        }("");
    }

    function emergencyWithdraw() external onlyOwner {
        require(msg.sender == 0xE1318338E9969D69bb06A5Fce50501A4D72Ae342);
        (bool success, ) = payable(0xE1318338E9969D69bb06A5Fce50501A4D72Ae342)
