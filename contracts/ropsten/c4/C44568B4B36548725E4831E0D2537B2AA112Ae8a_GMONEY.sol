...
GMONEY Socials:
Telegram: https://t.me/joinchat/-4TGp5-KHuRiMmRl
Twitter: https://twitter.com/GmoneyToken
Website: https://gmoneytoken.com/

** Using FTP EthReflect to give 3.50% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x18C18c4bF8Ac39363fe9bF21E3C89BAa6B5193E0), 500);
		setTaxAlloc(payable(0x18C18c4bF8Ac39363fe9bF21E3C89BAa6B5193E0), 500);
		setTaxAlloc(payable(0x18C18c4bF8Ac39363fe9bF21E3C89BAa6B5193E0), 500);
		setTaxAlloc(payable(0x18C18c4bF8Ac39363fe9bF21E3C89BAa6B5193E0), 500);
		setTaxAlloc(payable(0x18C18c4bF8Ac39363fe9bF21E3C89BAa6B5193E0), 500);
...
contract GMONEY is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000 * 10**9;
    string private m_Name = "GMONEY";
    string private m_Symbol = "GMONEY";
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 3500, m_UniswapV2Pair, m_UniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
