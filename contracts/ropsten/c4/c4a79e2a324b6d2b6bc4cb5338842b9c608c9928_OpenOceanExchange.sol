...
contract OpenOceanTransactionRelay is EIP712, Permitable, Predicates {
    ...
    bytes32 public constant OPENOCEAN_TRANSACTION_TYPEHASH =
        keccak256(
            "OpenOceanTransaction(uint256 salt,address initiator,address payingAsset,address payingAmount,bytes payingAssetData,bytes transactionData,bytes predicate,bytes permit)"
        );
