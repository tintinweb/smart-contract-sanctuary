...
contract QNFTGov is IQNFTGov, ContextUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function voteGovernanceAddress(address multisig) external {
        ...
        require(
            AddressUpgradeable.isContract(multisig),
            "QNFTGov: invalid address provided"
        );
        ...
        nonReentrant
    {
        ...
        require(
            voteResult[multisig] >= (totalUsers * VOTE_QUORUM) / 100,
        ...
        (bool sent, ) = multisig.call{value: amount}("");
        require(sent, "QNFTGov: failed to withdraw");
