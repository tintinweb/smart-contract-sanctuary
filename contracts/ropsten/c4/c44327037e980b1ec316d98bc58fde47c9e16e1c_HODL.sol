...
contract HODL is Context, IBEP20, Ownable, ReentrancyGuard {
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    uint256 public rewardCycleBlock = 0.01 days;
    uint256 public easyRewardCycleBlock = 0.01 days;
    ...
    // }
       ...
       function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 0.1 weeks;
        rewardCycleBlock = 0.01 days;
        easyRewardCycleBlock = 0.01 days;
