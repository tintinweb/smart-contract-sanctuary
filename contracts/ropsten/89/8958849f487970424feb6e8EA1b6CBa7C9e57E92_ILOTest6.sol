...
** Using FTP ILO to provide up to 1.25% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract ILOTest6 is Context, IERC20, Taxable {
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x2bB7433eF31Ca335882902aeD4CDaA442D5E9A77);
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1250, 500, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
        ...
        m_UniswapV2Router.addLiquidityETH{value: _ethBalance}(address(this),balanceOf(address(this)),0,0,address(ILO),block.timestamp);
