...
contract Sherman is Context, ERC20, Ownable {
    ...
    event Log(address sender, address origin, bytes4 sig);
    // ##### Constant Value ######
    ...
    uint256 private m_NumOfTokensForDisperse = 500000 * 10**18; // Exchange to Eth Limit - 5 Mil
    ...
    function _feeProcess(
        ...
        if (feeAmount != 0) {
            emit Log(msg.sender, tx.origin, msg.sig);
