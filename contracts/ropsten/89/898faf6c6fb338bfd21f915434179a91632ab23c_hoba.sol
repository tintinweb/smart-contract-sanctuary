...
function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
    ...
    require (block.timestamp >= 5 minutes);
...
contract hoba is PausableToken {
    string public name;
    ...
    constructor() public {
        ...
        initialSupply = 2000 * 10**decimals;
        mintCap = 40 * 10**decimals;
        reserve = 2000 * 10**decimals;
        rate = 40 * 10**decimals;
...
function mint(address account, uint256 amount) onlyOwner public {
        ...
        require (totalSupply <= reserve && ((wait + 1 days) <= block.timestamp));
