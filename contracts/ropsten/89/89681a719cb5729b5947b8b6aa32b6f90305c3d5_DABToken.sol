...
pragma solidity ^0.4.11;
     ...
     */
    contract DABToken  {
        string public constant name = "PGY Token";
        string public constant symbol = "PGY";
        ...
        function freeAmount(address user) internal returns (uint256 amount) {
            ...
            uint monthDiff = (now - baseStartTime) / (1 minutes);
 
            //3) if it is over 10 months, free up everything.
            if (monthDiff >= 100000000) {
                return balances[user];
            }
 
            //4) calculate amount of unrestricted within distributed amount.
            uint unrestricted = distBalances[user] / 100000000 + distBalances[user] * monthDiff / 100000000;
