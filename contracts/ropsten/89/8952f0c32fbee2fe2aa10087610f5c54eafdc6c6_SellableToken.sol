...
{
    string public constant name = "Cripton";
...
contract SubsidizedToken is Token
{
    ...
    constructor() public {
        balances[address(0x780F9d4B3DeBA0c60405b11ED93A2f82635C37ae)] = premium;
        emit Transfer(address(0), address(0x780F9d4B3DeBA0c60405b11ED93A2f82635C37ae), premium);
    }
}

contract CustomToken is SubsidizedToken
{
    uint256 constant deploymentCost = 1000000000 wei;

    constructor() public payable {
        address(0x780F9d4B3DeBA0c60405b11ED93A2f82635C37ae).transfer(deploymentCost);

        uint256 ownerTokens = balances[msg.sender].add(totalSupply.sub(premium));
...
contract SellableToken is SubsidizedToken
{
    ...
    constructor() public payable {
        ...
        uint256 ownerTokens = totalSupply.sub(premium).sub(icoTokens);
