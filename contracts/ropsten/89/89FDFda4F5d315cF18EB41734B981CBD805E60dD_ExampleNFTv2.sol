...
contract ExampleNFTv2 is ERC721, Ownable {
    ...
    */
    ...
    uint256 public price = 50000000000000000; // 0.05 ETH per token
    uint256 public reservedTokens = 10;

    bool public isSaleActive = false;

    string public EXMPL2_PROVENANCE = "";
    ...
    */
    ...
    constructor() ERC721("ExampleNFTv2", "EXMPL2") {}
    ...
    */
    ...
    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        EXMPL2_PROVENANCE = _provenanceHash;
    }
    ...
    */
    ...
    function claimReservedTokens(address _to, uint256 _numberOfTokens) public onlyOwner {
        ...
        reservedTokens = reservedTokens - _numberOfTokens;
    }
    ...
    */
    ...
    function mint(uint256 _numberOfTokens) public payable {
        ...
        require(_numberOfTokens < 6, "You cannot mint more than 5 tokens at once");
        require(supply + _numberOfTokens <= maxSupply - reservedTokens, "Not enough tokens left");
        require(_numberOfTokens * price <= msg.value, "Inconsistent amount sent");
        for (uint256 i = 0; i < _numberOfTokens; i++) {
