...
contract ZeonToken is UpgradeableToken, ReleasableToken {
  ...
  uint public totalSupply = 50000000000 * (10 ** decimals); 
  ...
  function ZeonToken() UpgradeableToken(msg.sender) {
  ...
  /* A dispense feature to allocate some addresses with SQC tokens 
