...
contract ERC_030950_LIQUIDITY is Context, Ownable{
    // lib
...
// main contract []
contract ERC_030950 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        ...
        // interfaces
            ERC_030950_LIQUIDITY private _liquidity;
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_030950";
            string private _symbol = "ERC030950";
    ...
    function initLiquidity(address pAddress) public onlyOwner{
        ...
        _liquidity = new ERC_030950_LIQUIDITY();
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_030950: approve from the zero address");
        require(spender != address(0), "ERC_030950: approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_030950: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_030950: transfer amount exceeds allowance"));
        return(true);
    }
