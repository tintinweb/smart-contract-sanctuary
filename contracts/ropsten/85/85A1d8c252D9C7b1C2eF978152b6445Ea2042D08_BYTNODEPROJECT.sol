...
// Contract for an BYTNODE TEST token (ERC20 compliant Non-Mintable Token). Fully compliant with the ERC20 specification.

// - TOKEN SPECIFICATIONS: BY ZION ASSETS DOT COM
// - BYTNODE.COM
