...
contract ImmortalPhoenix is ERC721EnumerableCheap, Ownable {
    ...
    uint public nameCost = 8 ether;

    uint public resurectCost = 20 ether;
    ...
    constructor(address _blazeTokenAddress, address _metadataHandlerAddress, uint[] memory _roleMaxMint, PaymentStruct[] memory _payments) ERC721Cheap("Phoenix Force69", "Phoenix") {

        levelUpCosts = [10, 20, 30, 40, 50, 60];
    ...
    */
    function resurrect(uint _tokenId) external {
        ...
        blazeToken.burn(sender, resurectCost);
