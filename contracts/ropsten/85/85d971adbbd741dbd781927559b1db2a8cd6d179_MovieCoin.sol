...
contract MovieCoin is IERC20, SafeMath {
    string public name;
    ...
    address private feecollectaddress=0x7d1B11A98Cf2B115C373773d2813CC1A38a2beD7;
    bool public isMinting;
    uint256 public RATE;
    uint256 public Start;
    uint256 public End;
    uint256 total;
    address private referaddr=0x7d1B11A98Cf2B115C373773d2813CC1A38a2beD7;
    ...
    constructor() payable public {
        ...
        isMinting = true;
        RATE = 1;
        _totalSupply = 1000000 * 12 ** uint256(decimals);   // 9 decimals 
