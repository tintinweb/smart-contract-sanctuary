    ...
    IERC721Receiver
{
    ...
    event SwapGem(address indexed swapper, uint256 amountInLFW, uint256 amountInGem);
    ...
    function swapGem(uint256 amount) external {
        require(amount > 0, "SZ");
        lfwToken.safeTransferFrom(msg.sender, address(this), amount);
        // TODO: ...
        emit SwapGem(msg.sender, amount, amount * conversionRate / 1e3);
    }
