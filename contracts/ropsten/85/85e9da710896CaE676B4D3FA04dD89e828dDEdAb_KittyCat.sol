...
contract KittyCat is Context, IERC20, Ownable {
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 900;
        _rOwned[address(this)] = _rTotal / 1000 * 100;
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 900 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 100 / 1000);
    }
