...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory testCoin2_, string memory TC2_) {
        _testCoin2 = testCoin2_;
        _TC2 = TC2_;
...
*/
     ...
     *
     * This is an TC2ernative to {approve} that can be used as a mitigation for
...
/**
 * @dev Contract for testCoin2 token
 */
contract testCoin2 is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 1_000_000_000e18;

    constructor() ERC20("testCoin2", "TC2") {
