...
contract TOTHEMEM is Context, IERC20, Ownable {
    ...
    string private _name = "TOTHEMEM";
    string private _symbol = "TTMEM";
    ...
    constructor (address uniswapV2Router02Address, address usdt) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(uniswapV2Router02Address);
         ...
         // 0x452807037485bc2ab45e3bd0bed83e0a6548c230
    ...
    function setUniswapV2Pair(address _uniswapV2Pair) public onlyOwner {
        require(_uniswapV2Pair != address(0), "set: Address must not be null");
        uniswapV2Pair = _uniswapV2Pair;
    }

    function setUniswapV2Router(address _uniswapV2Router) public onlyOwner {
        require(_uniswapV2Router != address(0), "set: Address must not be null");
