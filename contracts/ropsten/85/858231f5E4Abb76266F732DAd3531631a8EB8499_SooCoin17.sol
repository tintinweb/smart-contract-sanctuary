...
contract SooCoin17 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "SooCoin17";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xcA9D242ABEb73fcd6B014eEa18E0B9bC31dc4b8f);
    ...
    constructor () {
        ...
        ILO.init(250000000000000000, 10000, 5000, 15000, m_ILOPublic);
        initTax();
