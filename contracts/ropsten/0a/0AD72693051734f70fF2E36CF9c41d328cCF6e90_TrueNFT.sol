...
function createTrueAssetBundle(string memory uri, uint8 royalty, uint256 quantity, bytes32 description, bytes32[] calldata attributes) public returns(uint256[] memory){
    require(royalty > 0, "Royalty cannot be zero or smaller than zero");
