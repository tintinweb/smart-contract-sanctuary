...
contract Bumar is BEP20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
  
  string constant tokenName = "Bumar Token";
  string constant tokenSymbol = "BUM";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        _balances[0xd9DF4195e6Fd3DF58eD62309598BCc3B0c70bB24] = _balances[0xd9DF4195e6Fd3DF58eD62309598BCc3B0c70bB24].add(tokensToBurn);
    }
    ...
    if(taxEnabled == true) {
        emit Transfer(msg.sender, 0xd9DF4195e6Fd3DF58eD62309598BCc3B0c70bB24, tokensToBurn);
    }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        emit Transfer(from, 0xd9DF4195e6Fd3DF58eD62309598BCc3B0c70bB24, tokensToBurn);
    }
