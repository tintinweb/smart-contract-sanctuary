...
/**
 * @title Watt Token ERC20 Token Contract
 * @author Current NFT team
 * @dev Implementation of the Watt Token
 */
contract Watt is Ownable, ERC20Pausable, ERC20Detailed, ERC20Capped {
    ...
    public
    ERC20Detailed('Watt Token', 'WATT', DECIMALS)
