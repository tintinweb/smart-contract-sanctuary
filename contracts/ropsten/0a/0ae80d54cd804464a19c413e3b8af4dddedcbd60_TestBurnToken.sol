...
contract TestBurnToken is Context, IERC20 {
    ...
    constructor (
        ...
        _totalBurnableToken = totalBurnableToken_;
    ...
    function ico() public view returns (uint256) {
        return _icoSupply;
    }
    ...
    function owners() public view returns (uint256) {
    ...
    */
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(account == _owner, "ERC20: burn access only allowed for owner address");
