...
contract SwapBloexToken is ERC20, ERC20Detailed {
    ...
    //return bt rate
    function getPricePerFullShareq() public view returns (uint) {
      return btRate.mul(1e6).div(rateBase);
    }

    //return bt rate
    function getPricePerFullShareqq() public view returns (uint) {
      return btRate.mul(1e8).div(rateBase);
    }
