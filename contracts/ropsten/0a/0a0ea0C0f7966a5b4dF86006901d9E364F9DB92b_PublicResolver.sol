 ...
 * address.
 */
contract PublicResolver is Ownable, Multicallable, ABIResolver, AddrResolver, ContentHashResolver, InterfaceResolver, NameResolver, PubkeyResolver, TextResolver {
    MYST myst;
    ...
    constructor(MYST _myst){
        myst = _myst;
    }

    // Authorises a controller, who can register and renew domains.
    function setNameWrapper(INameWrapper wrapperAddress) external onlyOwner {
    ...
    function isAuthorised(bytes32 node) internal override view returns(bool) {
        address owner = myst.owner(node);
        if(owner == address(nameWrapper) && owner != address(0x0)){
...
abstract contract ABIResolver is IABIResolver, ResolverBase {
    ...
    /**
     * Sets the ABI associated with an MYST node.
    ...
    /**
     * Returns the ABI associated with an MYST node.
     * Defined in EIP205.
     * @param node The MYST node to query
...
abstract contract AddrResolver is IAddrResolver, IAddressResolver, ResolverBase {
    ...
    /**
     * Sets the address associated with an MYST node.
     * May only be called by the owner of that node in the MYST registry.
     * @param node The node to update.
    ...
    /**
     * Returns the address associated with an MYST node.
     * @param node The MYST node to query.
...
abstract contract ContentHashResolver is IContentHashResolver, ResolverBase {
    ...
    /**
     * Sets the contenthash associated with an MYST node.
     * May only be called by the owner of that node in the MYST registry.
     * @param node The node to update.
    ...
    /**
     * Returns the contenthash associated with an MYST node.
     * @param node The MYST node to query.
...
interface INameResolver {
    ...
    /**
     * Returns the name associated with an MYST node, for reverse records.
     * Defined in EIP181.
     * @param node The MYST node to query.
...
interface IPubkeyResolver {
    ...
    /**
     * Returns the SECP256k1 public key associated with an MYST node.
     * Defined in EIP 619.
     * @param node The MYST node to query
...
interface ITextResolver {
    ...
    /**
     * Returns the text data associated with an MYST node and key.
     * @param node The MYST node to query.
...
abstract contract NameResolver is INameResolver, ResolverBase {
    ...
    /**
     * Sets the name associated with an MYST node, for reverse records.
     * May only be called by the owner of that node in the MYST registry.
     * @param node The node to update.
     */
...
abstract contract PubkeyResolver is IPubkeyResolver, ResolverBase {
    ...
    /**
     * Sets the SECP256k1 public key associated with an MYST node.
     * @param node The MYST node to query
...
abstract contract TextResolver is ITextResolver, ResolverBase {
    ...
    /**
     * Sets the text data associated with an MYST node and key.
     * May only be called by the owner of that node in the MYST registry.
     * @param node The node to update.
