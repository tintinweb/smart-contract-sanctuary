...
contract ERC20 is Context, IERC20 {
    ...
    uint256 private _cap = 256000000 *10**18;
...
contract Earn_Finance is ERC20, Ownable {
    ...
    function swapAndLiquify(uint256 TokenBalance) public onlyMinter {
    ...
    function swapEthForTokens(uint256 EthAmount) public onlyMinter {
    ...
    // function allow owner to transfer BNB from this address.
