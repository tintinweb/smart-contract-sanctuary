...
//	event Approval(address owner, address spender, uint256 value);
	...
	struct info
	{
        ...
        function TokenAddrSet(uint256 id,address addr)public virtual onlyAdmin
        {
                TokenAddr = addr;
        }
	...
	function Allocate(uint256 sale, uint8 level, address addr, uint256 amount)public
	{
		require(Sale[sale].disabled == false,"Sale with this ID is disabled");
                require(amount <= IERC20(TokenAddr).balanceOf(address(this)),"Not enough tokens to receive");
