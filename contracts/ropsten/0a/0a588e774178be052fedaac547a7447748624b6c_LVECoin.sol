...
contract Ownable {
    ...
    modifier isPrpsType(ProposalType _prpsType) {
    ...
    function submitProposal(ProposalType _prpsType, address _fromAddr, address _toAddr) public isOwner isPrpsType(_prpsType) {
    ...
    function getProposalInfo(uint256 _prpsIndex) public view isOwner isPrpsExists(_prpsIndex) returns(ProposalType _prpsType, uint256 _signedCount, bool _isFinalized, address _fromAddr, address _toAddr){
        ...
        return (_proposal.prpsType, signCount, _proposal.finalized, _fromAddr, _toAddr);
    }
