...
contract LYToken is StandardToken { 
   ...
   /*  function LYToken() {
        balances[msg.sender] = 100000000000000; // 初始token数量给予消息发送者
        totalSupply = 100000000000000;         // 设置初始总量
        name = "liyang";                   // token名称
        decimals = 8;           // 小数位数
        symbol = "LY";             // token简称
    }*/

    function LYToken(uint256 _initialAmount,string _tokenName,uint8 _decimalUnits,string _tokenSymbol){
