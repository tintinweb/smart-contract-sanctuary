...
/**
Transaction Tax:
    2% auto yield to holders for every buy/sell paid directly to wallet
...
contract Okami is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 19740 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Ōkami";
    string private _symbol = "🐺Ōkami";
