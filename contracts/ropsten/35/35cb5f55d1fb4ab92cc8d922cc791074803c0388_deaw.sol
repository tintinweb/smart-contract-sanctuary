...
contract deaw is BurnableToken {

    string public constant name = "deaw";
    string public constant symbol = "deaw";
    uint public constant decimals = 15;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 210 * (10 ** uint256(decimals));
