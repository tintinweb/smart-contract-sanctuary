...
contract NTT is Context, IERC20, Ownable {
    ...
    string private _name = "NEW toKEN TEST";
    ...
    address payable public _devWalletAddress = 0xe40d41Edc0596C0d56B97bD2739B82B7Bd51c541;
    address payable public _burnWalletAddress = 0xF9001b0F3FB3B473ef196C4bcA1522072bf63e24;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(tokenBalance); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
