...
contract WhitelistedPresale is Ownable {
    ...
    uint constant TESTdecimals = 10 ** 9;
    uint public constant MAX_SOLD = 70000 * TESTdecimals;
    uint public constant PRICE = 5 * DAIdecimals / TESTdecimals ;
    uint public constant MAX_SALE_PER_ACCOUNT = 100 * TESTdecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 200 * TESTdecimals;
    ...
    function buyTEST(uint256 amount) public onlyEOA {
    ...
    function claimTEST() public onlyEOA {
      ERC20(TEST).transfer(msg.sender, invested[msg.sender]);
