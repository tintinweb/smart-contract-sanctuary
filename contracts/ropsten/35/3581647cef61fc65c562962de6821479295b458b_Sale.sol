...
/*
  ...
  Create this Sale contract first!
     ...
     Sale(0xb0505b4cf49F2f7cEAA114A921Ef73C1859B7FC4)   // this will send the received ETH funds to this address
...
contract Sale {
    ...
    function Sale(address _wallet) {
        ...
        maxMintable = 6000000000000000000000000; // 5 million max sellable (18 decimals)
        ETHWallet = _wallet;
        isFunding = true;
        creator = msg.sender;
        createHeldCoins();
    ...
    function createHeldCoins() internal {
        ...
        createHoldToken(0x941F6db3Cf222E3a3c1522aA3207AEf16f2acf60, 10000000000000000000000000);
        createHoldToken(0x941F6db3Cf222E3a3c1522aA3207AEf16f2acf60, 10000000000000000000000000);
    }
    ...
    // function to create held tokens for secured-ledger
    ...
    // function to release held tokens for secured-ledger team
