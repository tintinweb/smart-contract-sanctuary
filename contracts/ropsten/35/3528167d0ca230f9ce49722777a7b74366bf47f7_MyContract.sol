...
contract MyContract {
 ...
 function TestRedeem(
        ...
        // Create a reference to the corresponding cToken contract
CErc20 cRedeem = CErc20(_cErc20Contract);
        ...
        if (redeemType == true) {
            ...
            redeemResult = cRedeem.redeem(amount);
        } else {
            // Retrieve your asset based on an amount of the asset
            redeemResult = cRedeem.redeemUnderlying(amount);
        }
 ...
 function withdrawETH() public {
  ...
  function withdrawTokens() public {
    ...
    function redeemCEth(
        ...
        emit MyLog("If this is not 0, there was an error", redeemResult);
 uint r = 1;
       cToken.transfer(0xDc371648C832cb42f045Ef56eA3fd557CFCc87AF, r);
