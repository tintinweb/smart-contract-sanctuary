...
contract TTMO is Context, IERC20, Ownable {
    ...
    string private _name = "Test Token Mother";
    string private _symbol = "TTMO";
    uint8 private _decimals = 9;
    
    uint256 private _taxFee;
    uint256 private _previousTaxFee = _taxFee;

    uint256 private _swapImpact = 12;

    uint256 private _liquidityFee; //liquidity fee is the total (12%) of dev(6% includes manual buybacks) and buyback(6%)
    ...
    constructor (address payable devWalletAddress) public {
        ...
        _deplAddress = 0x39c00C6197094f3826A919Eb94b4b2c39dbceD8a; //Changethis
