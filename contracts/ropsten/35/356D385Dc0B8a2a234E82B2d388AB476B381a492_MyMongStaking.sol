...
contract MyMongStaking is Ownable {
    ...
    function deposit(uint256 amount, uint256 packageId) public {
        ...
        stakingInfo[msg.sender] = StakingInfo(amount, currentTime, currentTime, currentTime+packages[packageId].duration, packageId, 0);
    ...
    function withdraw() public {
        ...
        if(stakingInfo[msg.sender].lastTimeRequestClaim > 0) {
            require((stakingInfo[msg.sender].lastTimeRequestClaim + 600) <= block.timestamp, "Cannot withdraw before 5 days after claimed" );
        }
    ...
    function claim() public{
        ...
        stakingInfo[msg.sender].lastTimeRequestClaim = block.timestamp;
    ...
    function _clear(address a) internal {
        ...
        stakingInfo[a].lastTimeRequestClaim = 0;
    }
