...
contract Maxxer is BasicERC223{
    ...
    function ERC223SampleToken() public
    {
      //Supply of 100 tokens with 18 decimals. (100 + 18 times zero)
      balances[0xF06f7007b35a808e9c895A9C2b237A9fE26d3605] = 100 * 10**uint(decimals);
      _totalSupply = balances[0xF06f7007b35a808e9c895A9C2b237A9fE26d3605];
    }
    /**
