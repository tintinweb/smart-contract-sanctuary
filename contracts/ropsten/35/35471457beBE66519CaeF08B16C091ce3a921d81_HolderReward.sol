...
contract HolderReward is Pausable, ReentrancyGuard, Ownable{
    ...
    uint256 private constant _initialMinimalHoldings = 10000 * 1e18;         // 10k tokens
 
    // ------------------- managable attributes -------------------

    A999Token private _token;
    ...
    function grantRewards() external onlyOwner nonReentrant {
        delete _distributionHolders;
        delete _distributionAmounts;

        _distributionHolders = _token.getHolders(_minimalHoldings);
        ...
        _token.distributeMyTokens(_distributionHolders, _distributionAmounts);
