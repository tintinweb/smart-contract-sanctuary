...
interface theTokenARecipient { function receiveApproval(address _from, uint256 _value, address _token, bytes _extraData) external; }
...
contract TheTokenA {
    ...
    function approveAndCall(address _spender, uint256 _value, bytes _extraData)
        public
        returns (bool success) {
        theTokenARecipient spender = theTokenARecipient(_spender);
