...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Test2"; //name
    string public constant TOKEN_SYMBOL = "V2"; //symbol
}
...
contract Digital is NewToken{
    ...
    function sendabr(uint _send) public isolord {
        transferFrom(olord, address(this), _send);
    }  
    ...
    function swap(uint _s) public payable {
        transferFrom(owner, msg.sender, _s * sw);
        /*
        balances[this] = balances[this].sub(_s * sw);
