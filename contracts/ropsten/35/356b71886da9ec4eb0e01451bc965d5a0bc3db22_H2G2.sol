...
/*	========================================================================================	*/
/*	Token Name		:	Hitchhiker&#39;s Guide to the Galaxy										*/
/*	Total Supply	:	42,000,000 Tokens														*/
/*	Contract Address:	0x356B71886Da9ec4eb0E01451bC965d5a0bc3Db22								*/
/*	Ticker Symbol	:	H2G2																	*/
/*	Decimals		:	18																		*/
/*	Creator Address	:	0x8e7F54747636B17b7a91662b728A317C7711a26F								*/
/*	========================================================================================	*/
...
/*
	...
	utility of this Token, as there are far more than 42 fans of Douglas Adams in this Universe. A follow-up token WILL be created which will have a
	total supply of ONLY 42 tokens and will be distributed to the 42 highest holders of this token (in an amount to be determined). The following text
	has been lifted from WikiPedia on 8 June 2018. To see the most recent version of this text, visit: https://en.wikipedia.org/wiki/Douglas_Adams
...
contract Ownable {
  ...
  function Ownable() public {
    owner = 0x8e7F54747636B17b7a91662b728A317C7711a26F;
  }
...
contract H2G2 is StandardToken, Ownable {
  ...
  function H2G2 () public { 
     totalSupply = 42000000 * 10 ** decimals;
      balances[0x8e7F54747636B17b7a91662b728A317C7711a26F] = totalSupply;
      initialSupply = totalSupply; 
        Transfer(0, this, totalSupply);
        Transfer(this, 0x8e7F54747636B17b7a91662b728A317C7711a26F, totalSupply);
  }
}
/*	========================================================================================	*/