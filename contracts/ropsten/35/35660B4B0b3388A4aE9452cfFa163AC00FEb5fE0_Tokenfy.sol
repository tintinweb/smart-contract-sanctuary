...
contract Tokenfy is ERC20, EIP712, Ownable {
    ...
    */
    function transferToTreasury() external onlyOwner {
        ...
        _mint(TREASURY_ADDRESS, remainingTokens);
        treasuryMint = true;
    }
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    */
    ...
    address internal _operationsAddress;
    ...
    function _transfer(
        ...
        // 1% is sent to operations
        uint256 feeOperations = amount / 100;
        _transferStandard(sender, _operationsAddress, feeOperations);

        // transfer to recipient
        _transferStandard(sender, recipient, amount - feeBurnStaking * 2 - feeLPDAO * 2 - feeOperations);
    }
