...
contract ZCXD is Context, IERC20, Ownable {
    ...
    string private _name = "ZCXD";
    string private _symbol = "ZCXD";
    ...
    uint256 public _maxTxAmount = 1 * 10**1 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 3 * 10**1 * 10**3;
