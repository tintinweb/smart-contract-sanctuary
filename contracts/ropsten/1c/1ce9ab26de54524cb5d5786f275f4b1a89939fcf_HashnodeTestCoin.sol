...
contract HashnodeTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTestCoin() {
        ...
        totalSupply = 10000000000000000000000000000000000000000000;                        // Update total supply (1000 for example) (CHANGE THIS)
        name = "PEREX";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PSK";                                             // Set the symbol for display purposes (CHANGE THIS)
