...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor () public {
        _name = "Ice Cube";
        _symbol = "iCube";
        _totalSupply = 2100000000000 * (10**18);
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        if(address(this) == msg.sender){
            ...
            require(now >= releaseTime,"Token is Paused");
    ...
    function noPausedtransfer(address recipient, uint256 amount) internal /*override*/ returns (bool) {
        require(amount <= cap,"Cap amount exceeded...");
    ...
    function mint(address account, uint256 amount) public onlyOwner{
        ...
        require(_totalSupply <= cap,"Amount Exceeded");
        _totalSupply += amount;
    ...
    // THIS WILL SET THE CAPPED VALUE
    function setCapAmount(uint256 _cap) public onlyOwner{
        cap = _cap;
    }
