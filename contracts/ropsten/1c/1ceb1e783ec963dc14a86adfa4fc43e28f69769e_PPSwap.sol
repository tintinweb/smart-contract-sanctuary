...
contract PPSwap is ERC20Interface, SafeMath{
    ...
    function makeOffer(address tokenA, 
         ...
         offerStatus[lastOfferID] = 0; // order created
         
         ERC20Interface A = ERC20Interface(tokenA);
         A.approve(address(this), amtA);
    ...
    {
        require(offerStatus[offerID] == 0, "This offer has already been filled or canceled.");
        require(offers[offerID]['accountA'] == msg.sender, "Ony the offer maker can cancel this offer.");
        
        offerStatus[offerID] = -1;
    ...
    function acceptOffer(uint offerID)
                        ...
                        returns(bool)
                        {
        require(offerStatus[offerID] == 0, 'This order has been either canceled or filled.');
