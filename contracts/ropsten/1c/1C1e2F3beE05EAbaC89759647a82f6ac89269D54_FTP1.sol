...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x83Dad3A6D9347338D915F214e8aDA590266e0fCa), 9000);
        m_DidDeploy = true;
    }
...
contract FTP1 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "FTP1";
    string private m_Symbol = "FTPT1";
