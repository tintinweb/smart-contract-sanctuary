...
contract Party is Ownable {
     ...
     */
    function withdraw(address partyAddress,uint256 withdrawPercentage, uint256 amount, uint256 n, SwapWithoutRSV[] memory tokenData, bytes32 r, bytes32 s, uint8 v) external payable isAlive onlyMember {
