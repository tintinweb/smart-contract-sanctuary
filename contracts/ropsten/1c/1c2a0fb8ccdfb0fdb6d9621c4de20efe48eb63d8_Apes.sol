...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function original(uint256 tokenId) public view virtual returns (address) {
        address og = _ogminter[tokenId];
        require(og != address(0), "ERC721: owner query for nonexistent token");
        return og;
    }
    /**
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        ...
        require(_isOG(_msgSender(), tokenId), "ERC721: transfer caller is not original minter");
        require(isNFTLocked = false);
    ...
    function _isOG(address spender, uint256 tokenId) internal view virtual returns (bool) {
        require(_existi(tokenId), "ERC721: operator query for nonexistent token");
        address owner = ERC721.original(tokenId);
        return (spender == owner || getApproved(tokenId) == spender || isApprovedForAll(owner, spender));
    }
...
contract Apes is ERC721Enumerable, Ownable {
    ...
    function unlock() public payable {
        ...
        require(msg.value >= unlockNFT, "Not enough to unlock NFT.");
        isNFTLocked = false;
    }
    ...
    */ 
    ...
    function setNFTLocked(bool isLocked) public onlyOwner {
        isNFTLocked = isLocked;
    }
