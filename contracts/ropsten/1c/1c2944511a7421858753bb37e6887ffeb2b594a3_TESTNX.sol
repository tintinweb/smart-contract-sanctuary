...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaa29C7768F51BAC3501448707Cc87d11F4ed6eef;
...
contract TESTNX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xaa29C7768F51BAC3501448707Cc87d11F4ed6eef;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TESTNX";
    string private _symbol = "TESTNX";
