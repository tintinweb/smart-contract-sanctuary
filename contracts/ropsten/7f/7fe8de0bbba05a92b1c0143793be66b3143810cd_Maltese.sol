...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.2.0/contracts/token/ERC20/extensions/ERC20Burnable.sol
pragma solidity ^0.8.0;
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.2.0/contracts/token/ERC20/presets/ERC20PresetFixedSupply.sol
pragma solidity ^0.8.0;
...
contract Maltese is ERC20PresetFixedSupply {
    constructor() ERC20PresetFixedSupply("Maltese", "MALTESE", 14000000 * 10 ** decimals(), msg.sender) {
    }
}