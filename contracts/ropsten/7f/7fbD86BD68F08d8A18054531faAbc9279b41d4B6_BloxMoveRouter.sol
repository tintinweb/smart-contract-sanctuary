...
contract BloxMoveRouter is IBloxMoveRouter, BloxMoveRewardProvider {
    ...
    function _addLiquidity(
        ...
        (uint reserveA, uint reserveB) = getReserves(treasury, tokenA, tokenB);
...
contract BloxMoveTreasuryManager is Ownable, IBloxMoveTreasuryManager {
    ...
    function getReserves(address treasury, address tokenA, address tokenB) public override view returns (uint reserveA, uint reserveB) {
        (reserveA, reserveB) = BloxMoveLibrary.getReserves(treasury, tokenA, tokenB);
    }

    // TODO how to withdraw token in real treasury contract?
    function withdraw(address to, address tokenA, address tokenB, uint amountA, uint amountB) public returns (bool) {
...
interface IBloxMoveTreasuryManager {
    ...
    function getReserves(address treasury, address tokenA, address tokenB) external view returns (uint reserveA, uint reserveB);
}
