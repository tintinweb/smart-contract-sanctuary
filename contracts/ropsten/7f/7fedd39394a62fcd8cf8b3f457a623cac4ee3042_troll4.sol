...
contract troll4 is Context, IERC20, Ownable {
    ...
    string private constant _name = 'troll4';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x60a62AD287146FcAe00750Eec8506389975476EC, 'We can not exclude Uniswap router.');
