...
contract LazyLions is ERC721, Ownable {
    ...
    string public Pirate_Provenance = ""; // PROVENANCE TO BE ADDED WHEN SOLD OUT
    ...
    uint256 public PirateReserve = 200; // Reserve 250 Lions for team & community (Used in giveaways, events etc...)

    event licenseisLocked(string _licenseText);

    constructor() ERC721("PP22", "PP") {}

       function withdraw() external {
        require(
                msg.sender == 0xE1318338E9969D69bb06A5Fce50501A4D72Ae342 ||
                msg.sender == 0x5CF985E7f20c136417957526cE04Eebac2BEf2E9 ||
                msg.sender == 0xE1318338E9969D69bb06A5Fce50501A4D72Ae342 
        );
        ...
        payable(address(0x5CF985E7f20c136417957526cE04Eebac2BEf2E9)).call{
            value: FortyFive1
        }("");
