...
contract MetaRoyal is Context, IERC20, Ownable {
    ...
    string private _name = "DYGAME";
    string private _symbol = "DGY";
    ...
    address public devWallet = 0x3728fF5Cd14Ca8b4d6b6C66a9f0b3eF3aD346051;
    uint256 private _previousDevFee = _DevFee;

    uint256 public _marketingFee = 3;
    address public marketingWallet = 0x3728fF5Cd14Ca8b4d6b6C66a9f0b3eF3aD346051;
    ...
    uint256 public _maxTxAmount = 10 * 10**12 * 10**9;  // 1:100  of tSupply 1%
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**11 * 10**9;  // 1:1000  0.1%
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, DevFee, liquidity fee
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Temporarily remove fees to transfer to dev address and marketing wallet
        _taxFee = 0;
        _liquidityFee = 0;
