...
contract KhanCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KhanCoin() {
        ...
        name = "KhanCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-039";                                             // Set the symbol for display purposes (CHANGE THIS)
