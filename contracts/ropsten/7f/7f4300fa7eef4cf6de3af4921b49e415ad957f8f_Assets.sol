...
contract Assets is Ownable, BaseContract {
    ...
    event BuyEvent(
        address indexed assetOwnerAddress,
        string assetTitle,
    ...
    function buyAsset(
        ...
        BLCKT.transferPrice(
            msg.sender,
            assetOwnerAddress,
            initailAssetTokenAmount
        );
        BLCKT.transferPrice(msg.sender, owner(), feeTokenAmount);
        BLCKT.transferPrice(msg.sender, owner(), taxTokenAmount);
        emit BuyEvent(
            _msgSender(),
            assetTitle,
            initailAssetTokenAmount,
