...
contract EINTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EINTestCoin() {
        ...
        name = "EINTestCoin";                                        // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "EIN";                                              // Set the symbol for display purposes (CHANGE THIS)
