...
contract BOLD is ERC20, CoinAgeMintableStandard, CoinRateMintable, Ownable {
    using SafeMath for uint256;

    string public name = "BOLD";
    string public symbol = "BOLD";
...
//--------------------------------------------------------------------------------------
//Internal CoinRate PoHAMR (Proof-of-Hold-Age-Minting-and-Repeat) pool
//--------------------------------------------------------------------------------------

    uint public coinRateRewards = 30000000 * (10**decimals);
    uint public coinRateStartTime;
    
    uint public coinRate = 20 * (10**decimals);
    uint public minInterval = 1 days;
    uint public maxInterval = 180 days;

    uint public onlyStrongHolder = 300 * (10**decimals);
