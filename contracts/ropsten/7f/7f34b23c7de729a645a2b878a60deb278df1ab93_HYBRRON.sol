...
contract HYBRRON is SafeMath {
    string public constant name                         = "HYBRRON";                    // Name of the token
    string public constant symbol                       = "HYB";                            // Symbol of token
    uint256 public constant decimals                    = 18;                               // Decimal of token
    uint256 public _totalsupply                         = 1250000000 * 10 ** decimals;       // Total supply
    uint256 public _circulatingSupply                   = 0;        // Circulating supply
    uint256 public _initialTransfer                     = 1250000000 * 10 ** decimals;        // Initiral tokens
    address public owner                                = msg.sender;                       // Owner of smart contract
    uint256 public _price_token                         = 3240000;                            // 1 Ether = 3240000 tokens in ICO
    uint256 no_of_tokens;
    address public admin                                = 0x216ac8e5Ac211378B8159CD12D52543A4c16579E;   
