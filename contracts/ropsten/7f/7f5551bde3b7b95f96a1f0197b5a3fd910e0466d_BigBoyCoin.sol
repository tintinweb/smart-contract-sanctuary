...
contract BigBoyCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BigBoyCoin() {
        ...
        name = "BigBoyCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BBC";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 68;                                      // Set the price of your token for the ICO (CHANGE THIS)
