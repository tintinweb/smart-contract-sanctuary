...
abstract contract PreSale is Context{
    ...
    function preSaleBuyBag(uint256 pSize) public returns(bool){
        ...
        emit DebugPreSaleBuy(allowance, _preSaleBagPrice[pSize]);
        require(allowance >= _preSaleBagPrice[pSize], "[XTKN061351::ERROR] you have to authorize the transfer of your BUSD first or you do not have enough BUSD!");
        require(_preSaleBagsAvailableCheck(pSize), "[XTKN061351::ERROR] no more of these bags available!");
        require(!_preSaleInvestorHasThisBag(_msgSender(), pSize), "[XTKN061351::ERROR] you can only buy one of this bag!");
        require(_preSaleBuyBag(_msgSender(), pSize), "[XTKN061351::ERROR] could not buy the bag!");
        return(true);
    }
    ...
    function _preSaleToWeiToken(uint256 pHumanTokens) private view returns(uint256){
    ...
    function _preSaleAddBag(uint256 pSize, uint256 pMax, uint256 pPrice) private{
        ...
        _preSaleBagPrice[index] = _preSaleToWeiToken(pPrice);
...
contract IXTKN061351Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN061351Project{
    function init() public{}
...
*/
contract XTKN061351 is Context, IERC20, Ownable, RobinHood, PreSale{
    // public properties
        // lib
            using SafeMath for uint256;
            using Address for address;
        ...
        // interfaces
            ...
            IXTKN061351Liquidity private _liquidity;
            IXTKN061351Project private _project;
            IXTKN061351Staking private _staking;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals instead of the 18
            string private _name = "XTKN061351"; // the name of our project
            string private _symbol = "XTKN061351";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN061351Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN061351Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(address contractAddress) public onlyOwner{
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN061351Staking(ADDRESS_STAKING);
            _staking.init();
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[XTKN061351::ERROR] approve from the zero address");
        require(spender != address(0), "[XTKN061351::ERROR] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[XTKN061351::ERROR] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[XTKN061351::ERROR] transfer amount exceeds allowance"));
        return(true);
    }
