...
*/
    ...
    //address
    address gateAddress;
    address secret = 0x5768617420686170706e7320696e204C61623739;
    address _owner;
...
|_||_||_|_|_| |_|\___)       
   ...
   */
    ...
    function claimMice(address claimer, uint8 num) external onlyGate {
        uint256 _startMintId = totalSupply();
        require(
            _startMintId + num <= MAX_SUPPLY,
     ...
     */
    function claimMouse(address claimer) external onlyGate {
