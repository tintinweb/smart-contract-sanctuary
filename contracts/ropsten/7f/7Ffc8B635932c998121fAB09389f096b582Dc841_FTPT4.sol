...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x83Dad3A6D9347338D915F214e8aDA590266e0fCa), 7000);
        m_DidDeploy = true;
    }
...
contract FTPT4 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "FTPT4";
    string private m_Symbol = "FTPT4";
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 9000, m_UniswapV2Pair, _uniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
