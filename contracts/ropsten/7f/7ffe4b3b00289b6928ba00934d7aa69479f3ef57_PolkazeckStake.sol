...
contract PolkazeckStake is Ownable {
    ...
    function toRewardMode(uint256 _amount, address _token) public view returns(uint256[] memory) {
    ...
    function testAmountOuts(uint256 _amount, address[] calldata path) public view returns(uint256[] memory amounts) {
