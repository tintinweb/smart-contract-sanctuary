...
contract SWATInu is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SWATInu() {
        ...
        name = "SWATInu";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SINU";                                             // Set the symbol for display purposes (CHANGE THIS)
