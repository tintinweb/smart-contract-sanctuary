...
contract COVIDPunks is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  uint256 private _price = 0 ether; // 30000000000000000
  
  string public punkcontractURI;
  
  constructor() ERC721("COVIDPunks", "PUNK-2019") {}

  // for wd
  address oaf = 0x10DcE6B2d236B5e2F9Ef260f75A3857F525e7D16;
  address quack = 0x10DcE6B2d236B5e2F9Ef260f75A3857F525e7D16;
