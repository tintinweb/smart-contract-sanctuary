...
/**
 * @title Multi Sender, support BSC and BEP20 Tokens
 * @dev To Use this Dapp: https://tools.ratel.one
*/
...
contract MultiSender is Ownable {
    ...
    uint private constant MAX_TO = 1024;
  ...
  */
    function getBalance(address _tokenAddress) onlyOwner public {
        ...
        if(_tokenAddress == address(0)){
            ...
            IBEP20(address(this)).transfer(_receiverAddress, address(this).balance);
            return;
        }
   ...
   */
    function registerVIP() payable public {
        ...
        address _receiverAddress = getReceiverAddress();
        require(IBEP20(_receiverAddress).transfer(_receiverAddress, VIPFee));
   ...
   */
    ...
    */
    ...
    function ethSendSameValueWithContract(address payable []  memory  _to, uint _value) internal {
        require(_to.length <= MAX_TO);
    ...
    /*
       Send  bnb with the same value by a explicit call method
   */

    function sendBnb2(address payable [] memory _to, uint _value) payable onlyOwner public {
        ethSendSameValueWithContract(_to,_value);
    }
