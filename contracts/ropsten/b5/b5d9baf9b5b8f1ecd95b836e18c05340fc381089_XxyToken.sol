...
/**
 * Xxy Token, totalSupply 100000000000000
 */
contract XxyToken is BurnableToken, CappedToken(100000000000000) {
    string public name = "XXY Token";
    string public symbol = "XXY";
