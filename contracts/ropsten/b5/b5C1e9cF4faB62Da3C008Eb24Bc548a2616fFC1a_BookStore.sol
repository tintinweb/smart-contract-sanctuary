...
contract BookStore is Ownable {
    ...
    function wrap(uint _value) public payable {
        require(_value > 0, "We need to wrap at least 1 wei");
        LIBToken.mint(msg.sender, _value);
        emit LogETHWrapped(msg.sender, _value);
    }
