...
Telegram: @FAIRTPTG
Twitter: @FAIRTOKENP
Website: FAIRTOKENP.com
Whitepaper: FAIRTOKENP.com/wp
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x8BEc16BD1bB27819dB5aFF7c665Cc1c7754ADe3C), 2000);
        m_DidDeploy = true;
    }
...
contract FAIRTOKENP is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "FAIRTOKENP";
    string private m_Symbol = "FAIRTP";
