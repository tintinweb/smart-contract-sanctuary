...
contract contract123 is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , contract123{
...
contract TestingCA is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 500000000 * 10 ** 18;

    constructor () ERC20('TestingCA', unicode'TestingCA') {
