...
abstract contract Ownable is Context {	
     ...
     */
    constructor () {
        _owner = 0xfA394e4390DA412d7Fba300328a05d419e0E95e2;
...
contract Barilla is Context, IBEP20, Ownable {
    ...
    mapping (address => uint256) private _lastTran;
    ...
    string private _name = "Barilla";
    string private _symbol = "BAR";
    ...
    address public marketing = 0x37bb2Eac7f2fBdD815511f7040f19286795F459B;
    address public treasury = 0xe8380A2f6b4b93fEeBF98A892b8C71ADbf3C03B2;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    bool public removeFee = false;
    ...
    function setAntiBot ( bool _enabled) public onlyOwner {
        antiBot = _enabled;
    }
    ...
    function disableFee(bool _enabled) public onlyOwner {
        removeFee = _enabled;
    }
    ...
    function _transfer(
        ...
        if( from != owner() && to != owner() && to != address(0) && from != marketing)
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
        if(removeFee) setfees();
        if( antiBot == true) if ( block.timestamp <  _lastTran[from] + 1 seconds  ) revert(" Illegal Transaction");
        if( antiBot == true) _lastTran[from] = block.timestamp;
