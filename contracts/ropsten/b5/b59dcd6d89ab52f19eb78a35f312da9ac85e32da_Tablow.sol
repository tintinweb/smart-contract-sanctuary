...
contract Tablow is ERC223  {
    ...
    uint256 internal totalSupply_= 60000000e8;
    uint256 public toGiveBase = 5000e8;
    uint256 public increaseBase = 500e8;


    uint256 public OfficalHold = totalSupply_.mul(8).div(100);
