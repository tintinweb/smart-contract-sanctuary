...
contract NfToken is ERC721Enumerable {
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
     ...
     */
    function mintDiff() public view returns (uint256) {
     ...
     * @dev Returns the current ETH price to mint
     */
    function tiersComplete() public view returns (uint256) {
        return (block.timestamp - MINT_START) % MINT_DELAY;
    }
