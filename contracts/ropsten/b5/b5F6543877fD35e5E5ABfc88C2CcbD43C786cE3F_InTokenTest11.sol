...
contract InTokenTest11{
    ...
    function InTokenTest11(uint256 initialSupply, 
                          string tokenName, 
                          uint8 decimalUnits, 
    ...
    function lockTransfer() nolyOwner public returns (bool){
       isLockTransfer = true;
       return true;
    }

    function unlockTransfer() nolyOwner public returns (bool){
