...
contract MisteryCoin is Context, IERC20, Ownable {
    ...
    string private _name = 'MisteryCoin';
    string private _symbol = 'MSTCOIN';
    ...
    function setExcludeFromFee(address account, bool excluded) external onlyOwner() returns (bool) {
        _isExcludedFromFee[account] = excluded;
        return true;
    }

    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner returns (bool) {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() returns(bool) {
        _maxTxAmount = maxTxAmount;
        return true;
    }

    function setNumofTokensForExchange(uint256 numOfTokensToExchangeForMarketing) external onlyOwner() returns(bool) {
