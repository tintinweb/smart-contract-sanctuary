...
contract Time is ERC20 {
    ...
    event RewardSent(address timeMiner, uint256 reward, uint256 timeReleased, uint gasPrice , uint startGas , uint gasFinish );
    ...
    function unlockTime() public {
        ...
        uint gasFinish = gasleft();
        emit RewardSent(msg.sender, reward , timeReleased,gasPrice, startGas , gasFinish);
    }
