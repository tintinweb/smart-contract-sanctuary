...
contract AdrCrowdsale is Whitelisted {
    ...
    event Status(bool crowdsaleClosed, uint256 value, uint256 convertedVal);
    ...
    function () payable public {
        ...
        uint256 val = SafeMath.div(SafeMath.mul(msg.value, 100000000000000), price);
        
        emit Status(crowdsaleClosed, msg.value, val);
        
        require(!crowdsaleClosed);
        
        emit Status(crowdsaleClosed, msg.value, val);
    
        require(isValidUser(msg.sender, val));
