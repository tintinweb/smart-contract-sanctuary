...
contract DRise is Context, IERC20, Ownable {
    ...
    string private _name = "DRise";
    string private _symbol = "DRise";
    ...
    function initContract() external onlyOwner() {
        ...
        teamDevAddress = payable(0xAdc830529Fc188Bb9341167b08dDc70a2C92dAa3);
    }
    ...
    function _transfer(
        ...
        if(
           ...
           require(balanceOf(recipient).add(amount) <= _maxWallet, "Transaction will exceed Maxmimum allowed wallet balance");
            if (!tradingOpen) {
