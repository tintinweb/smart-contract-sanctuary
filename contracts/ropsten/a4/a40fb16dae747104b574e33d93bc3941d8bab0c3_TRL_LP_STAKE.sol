...
contract TRL_LP_STAKE is Owned {
    using SafeMath for uint256;
    
    address public TRL_LP;
    address public RW;
    
    uint256 private rewardPerTRL = 10000000000000000; // 0.01
    ...
    constructor(address _lpAddress, address _rewardsWallet) public {
        TRL_LP = _lpAddress;
        RW = _rewardsWallet;
    }
    ...
    function STAKE_PLS(uint256 _amount) external {
        ...
        IERC20(TRL_LP).transferFrom(msg.sender, address(this), _amount);
    ...
    function UnStake() public {
        ...
        IERC20(TRL_LP).transfer(msg.sender, stakedAmount);
    ...
    function pendingReward(address user) public view returns (uint256 _pendingReward) {
        ...
        uint256 reward = stakers[user].stakedAmount.mul(rewardPerTRL).mul(totalDays); 
