...
contract puff2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0350515e6afe533EDB5afc2bf3EFc4Fc1Ae5Aa86); // Marketing Address
    ...
    string private _name = "puff2";
    string private _symbol = "puff2";
