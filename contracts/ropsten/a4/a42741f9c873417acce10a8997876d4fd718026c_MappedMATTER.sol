...
contract MappedToken is ContextUpgradeSafe, AuthQuota {
    ...
    function redeem(address authorizer, address to, uint256 volume, uint256 chainId, uint256 txHash, uint8 v, bytes32 r, bytes32 s) internal virtual {
...
contract MappingToken is ERC20CappedUpgradeSafe, AuthQuota {
    ...
    function mint(address authorizer, address to, uint256 volume, uint256 chainId, uint256 txHash, uint8 v, bytes32 r, bytes32 s) internal virtual {
