...
contract RatchetAuction is IERC721Receiver {
    ...
    uint16 public minPercentRaise; // decimal 3, 1000 -> 1%
    // The percent of the purchase that goes to the previous owner
    uint16 public ownerFee; // decimal 3, 1000 -> 1%
    // The erc20 that must be paid to purchase from this auction
    IERC20 public auctionToken;
    // The nft being sold
    bool public nftReceived;

    address public owner; // The current owner of the NFT in the auction
    address public initiator; // The address that deposited the NFT and started the auction

    uint256 public lastPrice; // The last price paid by the buyer
