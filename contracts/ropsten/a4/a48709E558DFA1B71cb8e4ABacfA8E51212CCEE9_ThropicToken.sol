...
contract ThropicToken is Context, IERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 10**11; //1000000 * 10**12;
    ...
    constructor () {
        transferOwnership(0x2C4C168A2fE4CaB8E32d1B2A119d4Aa8BdA377e7);
        // bsc mainnet
//      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

        // bsc testnet in ropsten
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    ...
    function setnumTokensSellToAddToLiquidity(uint256 bbb) external onlyOwner() {
        numTokensSellToAddToLiquidity = bbb;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            //add liquidity
            aaa1 = numTokensSellToAddToLiquidity;
