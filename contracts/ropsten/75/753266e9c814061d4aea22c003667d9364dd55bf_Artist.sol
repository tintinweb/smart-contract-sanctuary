...
contract ArtistBase is Ownable,ERC721Full,RadicalNFT,ReentrancyGuard {
    ...
    //event LOG_BIDAUTH(       uint256 _lastBidTime,       uint256 _bidInterval  );
    ...
    mapping(uint256=>string) private artIpfs;
        ...
        returns (uint256)
    {
        ...
        curid = uint48(arts.push(_art)) ;
        artIpfs[curid-1]=ipfsaddr;
    ...
    function openBidTokenAuthority() 
        ...
        onlyCLevel
        {
            ...
            //emit LOG_BIDAUTH(lastBidTime,1);
        }
    ...
    function setBidInterval(uint256 interval) 
        ...
        onlyCLevel
        {
            ...
            // emit LOG_BIDAUTH(1,bidInterval);
        }
...
*/
    ...
    IERC20 public bidtoken;
     function ()  external whenNotPaused 
     {
    ...
    function _bid(address inviterAddress, uint256 artid) nonReentrant internal
     {
         ...
         Art memory _art=arts[artid];
         address preOwner=ownerOf(artid);
         
         require(preOwner!=msg.sender, "ERR_CAN_NOT_PURCHASE_OWN_ART");
    
         require(_art.bidStartTime<now,"ERR_BID_NOT_START_YET");
         uint256 r=_art.round;
         ...
         if(r==0){
            ...
            _transferFrom(preOwner, msg.sender, artid);
            
            arts[artid]=_art;

            emit LOG_AUCTION(artid, payprice,payprice,x,preOwner,msg.sender,inviterAddress );
            return;
         }
        ...
        emit LOG_AUCTION(artid, curprice,payprice,x,preOwner,msg.sender,inviterAddress );
