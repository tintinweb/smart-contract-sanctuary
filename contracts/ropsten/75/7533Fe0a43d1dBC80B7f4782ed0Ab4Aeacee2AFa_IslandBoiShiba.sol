...
contract IslandBoiShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Islan Boi Shiba";
    string private _symbol = "IBShiba";
    ...
    function setRouter(address _newPancakeRouter) external onlyOwner {
        IUniswapV2Router02 _uniswapRouter = IUniswapV2Router02(_newPancakeRouter);
