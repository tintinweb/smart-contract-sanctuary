...
contract ETHSwapAgentImpl is Context {
    ...
    function fillOPC2ETHSwap(bytes32 opcTxHash, address erc20Addr, address toAddress, uint256 amount) onlyOwner external returns (bool) {
    ...
    function swapETH2OPC(address erc20Addr, uint256 amount) payable external notContract returns (bool) {
        require(registeredERC20[erc20Addr], "not registered token");
