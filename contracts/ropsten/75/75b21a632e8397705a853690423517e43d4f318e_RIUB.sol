 ...
 * Residual Income Tokens offered by IBBT
 * 
 * Decentralized Autonomous Organization (B)eta
 * 
 * 
*/
...
contract  AcceptEth is Regulated {
    ...
    // Make ETH deposits provided by the RUI Payout Program
    ...
    // Withdraw ETH deposits made by the RUI Payout Program
...
contract RIUB is ERC20, Regulated, AcceptEth {
  ...
  constructor() public {
    symbol = "RIU";                                     // Create the Residual Income Token Symbol Here
    name = "Residual Income Unit - DAO Beta (B)";      // Description of the Securetized Tokens
    // In our sample we have created passive income tokens
    ...
    _totalShares = 50000 * 10**uint(decimals);         // Total Number of RIU Issued (example 100,000 of RIU)
