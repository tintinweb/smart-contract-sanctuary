...
// File: interfaces/infini/IController.sol
...
// File: contracts/controllers/Reservoir/IRewardDistributionRecipient.sol
...
// File: contracts/controllers/Reservoir/LPTokenWrapper.sol
...
// File: contracts/controllers/Reservoir/Reward.sol
...
contract RewardPool is LPTokenWrapper, IRewardDistributionRecipient, Controllable {
...
//        recordSmartContract();
    ...
    // todo: 暂未增加控制权限（应该是管理器或者控制器来限制调用，实现自动质押）
    function stakeFor(address recipient, uint256 amount) public updateReward(recipient) {
        require(amount > 0, "Cannot stake 0");
//        recordSmartContract();

        super.stakeFor(recipient, amount);
    ...
    // todo: 暂时去掉onlyRewardDistribution
