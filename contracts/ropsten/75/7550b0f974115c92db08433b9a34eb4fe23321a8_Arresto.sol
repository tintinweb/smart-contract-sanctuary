...
contract Arresto is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x690a02A7Bc2190f517984400533a6464DeDd2902); // Marketing Address
    ...
    string private _name = "Arresto Momentum";
    string private _symbol = "AM";
    ...
    uint256 public _maxTxAmount = 0; // 3000000 * 10**6 * 10**9;
