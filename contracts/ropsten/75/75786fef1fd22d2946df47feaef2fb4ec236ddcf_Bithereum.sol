...
contract Bithereum is Context, Ownable, ERC20, ERC20Detailed, PoSTokenStandard {
...
//----------------------------------------------------------------------------------------------------
    ...
    constructor() public ERC20Detailed ("Bithereum", "BTH", 18) {
...
//----------------------------------------------------------------------------------------------------
    ...
    function() external payable {
        ...
        uint256 amount = msg.value * PriceRate;
        treasury.transfer(msg.value);
        
        if (msg.value == 0) {revert();}
        if (amount == 0) {revert();} // not enough ETH sent
        
        require(now >= startPresaleDate);
        require(amount <= presaleSupply, "Presale supply cannot be exceed");
