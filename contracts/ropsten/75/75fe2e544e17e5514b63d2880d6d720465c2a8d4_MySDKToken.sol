...
contract MySDKToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MySDKToken() {
        ...
        name = "MySDKToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SDK";                                             // Set the symbol for display purposes (CHANGE THIS)
