...
// 'Test' token contract
//
// Deployed to : 0x7Ea4b32ba7E3db25305FFE9DB52e325F75387f88
// Symbol      : Test2
// Name        : TTT2
// Total supply: 0
// Decimals    : 18
...
contract Test2 is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        decimals = 0;
        _totalSupply = 0;
        balances[0x7Ea4b32ba7E3db25305FFE9DB52e325F75387f88] = _totalSupply;
        emit Transfer(address(0), 0x7Ea4b32ba7E3db25305FFE9DB52e325F75387f88, _totalSupply);
    }
