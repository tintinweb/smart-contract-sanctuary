...
contract Tiger1 is ERC20 {
    constructor() ERC20("Tiger1", "Tiger1") {
        _mint(msg.sender, 1000000*10**18);
    }
}

contract Tiger2 is ERC20 {
    constructor() ERC20("Tiger2", "Tiger2") {
        _mint(msg.sender, 1000000*10**18);
    }
}
...
// File contracts/TigerAtomicSwap.sol

// MIT
pragma solidity ^0.8.0;


contract TigerAtomicSwap is Ownable {
  ...
  modifier onlyInvalidSwaps(bytes32 _swapID) {
    require (swapStates[_swapID] == States.INVALID, "Only new swaps");
    _;
  }

  modifier onlyOpenSwaps(bytes32 _swapID) {
    require (swapStates[_swapID] == States.OPEN, "Only open swaps");
    _;
  }
