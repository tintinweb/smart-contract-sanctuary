...
contract CurseNFTTicket is ERC721 {
    ...
    string public metadataA = "A";
    string public metadataB = "B";
    string public metadataC = "C";
    ...
    uint private _mintPrice = 5 * 10 ** 16;
    ...
    function mint() public payable  {
        ...
        require(msg.value == _mintPrice, "Mint price is not correct.");
    ...
    function getMintCntByType(uint token_type) public view returns (uint) {
        require(token_type <= 3, "Unknow ticket type.");
        
        return tokenCntByType[token_type];
    }
