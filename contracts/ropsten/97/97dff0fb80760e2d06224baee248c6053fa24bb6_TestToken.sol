...
// File: contracts\token\TestToken.sol
...
contract TestToken is ERC20,
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "TestToken: must have admin role to mint");
        _mint(to, amount);
    }

    function burn(address from, uint256 amount) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "TestToken: must have admin role to burn");
        _burn(from, amount);
    }
