...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #sempak  

    I make this #sempak to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/sempaktoken
   ...
   I will renounce the ownership to burn addresses to transfer #sempak to the community, make sure it's 100% safe.

   I will add 0.44 BNB and all the left 49% total supply to the pool
   Can you make #sempak 10000000X? 
   ...
   it's the best part of the #sempak idea, increasing the liquidity pool automatically, 
...
contract sempakToken is Context, IERC20, Ownable {
    ...
    string private _name = "sempak Token";
