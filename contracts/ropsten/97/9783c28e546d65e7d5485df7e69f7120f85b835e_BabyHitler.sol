...
$BabyHitler ~ Killing baby hitler
...
pragma solidity ^0.6.12;
    ...
    contract BabyHitler is Context, IERC20, Ownable {
        ...
        string private _name = 'BabyHitler';
        string private _symbol = 'BabyHitler';
        ...
        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee >= 1 && charityFee <= 10, 'charityFee should be in 1 - 5');
