...
//         token = new ERC20Basic();
    ...
    uint256 newInterests = calculateMyInterest();
 ...
 function isStakeholder(address _address)
       ...
       returns(uint256)
   {
    ...
    uint256  newInterests = (daysSinceLastCollect * (((balanceOf(_stakeholder) * interestRatePerYear ) / 100) / 365));
       ...
       function calculateMyInterest()
       public
       view
       returns(uint256)
   {
       uint256 lastCollectedAt = interestCollectedAt[msg.sender];
    ...
    uint256  newInterests = (daysSinceLastCollect * (((balanceOf(msg.sender) * interestRatePerYear ) / 100) / 365));
