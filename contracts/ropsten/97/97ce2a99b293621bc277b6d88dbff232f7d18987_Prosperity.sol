...
/**
 * Definition of contract accepting AcceptsTHC tokens
...
contract Prosperity {
    ...
    uint8 constant internal dividendFee_ = 17;	// 17% divvies => divisor is something about 5.88...
	uint8 constant internal fundFee_ = 3; 		// 3% investment fund fee on each buy
    ...
    */
    ...
    function()
        ...
        public
    {
		address lastRef = handleLastRef(0x0);	// hopefully you used a referral somewhere in the past
        ...
        public
    {
		...
		address _lastRef = handleLastRef(0x0);	// hopefully you used a referral somewhere in the past
    ...
    */
        ...
        returns(uint256)
    {
        ...
        uint256 _dividends = SafeMath.sub(_undividedDividends, referralBonus_);										// 12% => 17% - 5%
        ...
        if(
            ...
            referralBalance_[_referredBy] = SafeMath.add(referralBalance_[_referredBy], referralBonus_);
        } else {
            // no ref purchase
            // add the referral bonus back to the global dividends cake
            _dividends = SafeMath.add(_dividends, referralBonus_);
