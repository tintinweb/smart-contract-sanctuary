 ...
 */
   ...
   contract SafeMoon is Context, IERC20, Ownable {
       ...
       event Price(uint reserveA, uint reserveB);
       ...
       function calculateTaxFee(uint256 _amount) private returns (uint256) {
           (uint reserveA, uint reserveB) = UniswapV2Library.getReserves(uniswapV2Router.factory(), address(this), uniswapV2Router.WETH());
           emit Price(reserveA, reserveB);
