...
contract MyMongStaking is Ownable {
    ...
    uint256 public durationAfterDeposit; // ngay muon test
    uint256 public durationAfterClaim; // ngay tru di sau khi claim

    function setTest(uint256 durationAfterDeposit_, uint256 durationAfterClaim_)  public  {
          durationAfterDeposit = durationAfterDeposit_;
          durationAfterClaim = durationAfterClaim_;
    }
    ...
    constructor(address tokenAddress, uint8 decimals_ , uint256 earlyFeePercentage_) {
        ...
        durationAfterDeposit = 4*86400; //
        durationAfterClaim = 86340; //
    }
    ...
    function deposit(uint256 amount, uint256 packageId) public {
        ...
        uint256 currentTime=block.timestamp - durationAfterDeposit; // test  thì thêm cái -86400 (1 ngày) vào 
    ...
    function claim() public{
        ...
        stakingInfo[msg.sender].lastTimeClaim= stakingInfo[msg.sender].lastTimeClaim.add(totalDivideReward.mul(timeDivide) -durationAfterClaim );
    }
