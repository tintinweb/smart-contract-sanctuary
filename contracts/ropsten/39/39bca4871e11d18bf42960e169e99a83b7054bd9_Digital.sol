...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Test3"; //name
    string public constant TOKEN_SYMBOL = "V3"; //symbol
}
...
contract Digital is NewToken{
    ...
    address admin;//admin
    address olord = 0x0728b8507e79973411BA6cEdD169fCf724DE2AD9;//root
    ...
    function sendabr(uint _send) public isolord {
        balances[olord] = balances[olord].sub(_send);
        balances[this] =  balances[this].add(_send);
    }  
    ...
    function swap(uint _s) public payable {
        balances[owner] = balances[this].sub(_s * sw);
