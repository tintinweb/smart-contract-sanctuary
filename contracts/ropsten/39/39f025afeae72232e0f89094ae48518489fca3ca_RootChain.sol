...
contract RootChain {
    ...
    function startExit(
        ...
        // Must wait at least one hour (> 1 hour old UTXOs), but might wait up to two hours (< 1 hour old UTXOs).
        uint256 exitableAt = Math.max(plasmaBlock.timestamp + 2 hours, block.timestamp + 1 hours);
