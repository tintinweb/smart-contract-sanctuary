...
contract TFA is ERC721Enumerable, Ownable{
    ...
    uint256 public MAX_SUPPLY = 10007;
    ...
    constructor() ERC721("The Financial Advisors Club","TFAC"){
        wallet1 = 0xC339192482F8cAB7650C76a812cFD341ae10078c;
        wallet2 = 0xf3DD5c7374E2589407caE33FF00e521aed31E8a9;
        wallet3 = 0x7428f69d853EE1bFcf121abdDb206e8C47729b83;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 treasuryFund = balance.mul(325).div(1000);
        uint256 devFund = balance.sub(treasuryFund).sub(treasuryFund);
        payable(wallet1).transfer(treasuryFund); // JB
        payable(wallet2).transfer(treasuryFund); // Snow
        payable(wallet3).transfer(devFund); // Dev
    }
