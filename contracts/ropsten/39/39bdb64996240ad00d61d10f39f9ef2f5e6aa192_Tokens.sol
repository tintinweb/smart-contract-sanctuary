...
contract Tokens {
    ...
    uint256  public oneTokenPrice=100;        //1 Token = 0.01 Wei
    constructor(IERC20 _token) public {     //1 Wei = 100 Tokens
        admin=msg.sender;
        Token=_token;
    }
    event Transfer(address indexed from, address indexed to, uint256 value);
    ...
    function buyTokens() payable public {
        ...
        tokens = msg.value.mul(oneTokenPrice);
    ...
    function sellTokens(uint256 noOfTokens) public {
        ...
        uint256 returnEther = noOfTokens.div(oneTokenPrice);
