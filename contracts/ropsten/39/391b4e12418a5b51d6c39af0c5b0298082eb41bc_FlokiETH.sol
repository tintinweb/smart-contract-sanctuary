...
contract FlokiETH is ERC20, Ownable {
    ...
    uint256 public MAX_SELL_TRANSACTION_AMOUNT = 30000000 * (10**18); // 100 Million (0.1%)
    uint256 public MAX_WALLET_AMOUNT = 10000000000 * (10**18); // 1 Billion (1%)
    ...
    constructor() ERC20("FlokiETH", "FLOETH") {
        ...
        */
        _mint(owner(), 10000000000 * (10**18)); // 100 Billion (100%)
    }
