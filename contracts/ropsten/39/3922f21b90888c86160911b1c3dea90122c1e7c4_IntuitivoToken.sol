...
contract IntuitivoToken is ERC20 {

    mapping (address => uint256) private blacklist;
    address private owner;

    constructor() ERC20("Intuitivo", "ito") public {
        owner = _msgSender();
    ...
    function addToBlocklist (address _user) public {
        require(_msgSender() == owner, "ITO: Not allowed");
        blacklist[_user] = 1;
    }
    ...
    //     require(blacklist[from] == 0 && blacklist[to] == 0, "ITO: Transfer Not allowed"); 
    // }
}