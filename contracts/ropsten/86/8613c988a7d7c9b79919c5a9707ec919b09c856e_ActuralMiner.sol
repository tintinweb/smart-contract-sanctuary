...
contract ActuralMiner is Ownable{
    ...
    constructor() public{
        ...
        IntervalETHUSD = 60;
        //The Price of maintenance of each hashrate (10e-18USD per 0.001 mh/s per seconds)
        // 8*P104, 320mh/s, 100 USD per month/ 2592000 seconds
    ...
    //The Price of maintenance of each hashrate (10e-18USD per 0.001 mh/s per seconds)
    // 8*P104, 320mh/s, 100 USD per month/ 2592000 seconds
    //MaintenanceFee = 100*1e18/320/1000/259200 ~ 1.205e9;
