...
contract StealthRise is Context, IERC20, Ownable {
    ...
    string private _name = "StealthRise";
    string private _symbol = "StealthRise";
    ...
    function _transfer(
        ...
        if(sender != owner() && recipient != owner()) {
            ...
            require (balanceOf(msg.sender) +  amount <= _maxWallet, "Exceeds maximum wallet token amount");
            if (!tradingOpen) {
