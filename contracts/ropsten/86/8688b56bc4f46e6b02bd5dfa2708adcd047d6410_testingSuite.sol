...
//ARRAY VARIABLE SECTION:
    ...
    //set and increased with addEth and addEthWithParams functions
    uint256 public weiAdded;
    event weiAddedEvent(uint256 added, uint256 value, string message, bool boolGiven);
...
//ARRAY VARIABLE SECTION:
    ...
    function addBoolArrayFixed(bool[3] calldata newBool) external {
    ...
    function addUint256ArrayFixed(uint256[3] calldata newUint) external {
    ...
    function addUintArrayFixed(uint[3] calldata newUint) external {
    ...
    function addUint16ArrayFixed(uint16[3] calldata newUint) external {
    ...
    function addInt256ArrayFixed(int256[3] calldata newInt) external {
    ...
    function addIntArrayFixded(int[3] calldata  newInt) external {
    ...
    function addInt16Array(int16[3] calldata newInt) external {
    ...
    function addDifferentIntegersArrayFixed(uint256[2] calldata newUint1, int16[3] calldata newInt2) external {
    ...
    function addBytes32ArrayFixed(bytes32[3] calldata newbytes) external {
    ...
    function addBytes5ArrayFixed(bytes5[3] calldata newbytes) external {
    ...
    function addDifferentTypesArrayFixed(uint256[2] calldata newUint, bytes32[3] calldata newbytes, bool[4] calldata newBool) external {
    ...
    function addEth() payable external {
        weiAdded = weiAdded + msg.value;
    }
    
    function addEthWithParams(string calldata newMessage, bool newBool) payable external {
        weiAdded = weiAdded + msg.value;
        emit weiAddedEvent(msg.value, weiAdded, newMessage, newBool);
    }
