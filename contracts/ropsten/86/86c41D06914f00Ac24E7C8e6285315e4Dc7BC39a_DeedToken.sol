...
contract DeedToken is ERC721, ERC165 {
    ...
    function projectScriptByIndexX(uint256 _projectId) view public returns (uint8){
    // function projectScriptByIndex(uint256 _projectId, uint256 _index) view public returns (asset memory) {
        ...
        // }
        return allTokens[_projectId].x;
    }

    function projectScriptByIndexY(uint256 _projectId) view public returns (uint8){
        return allTokens[_projectId].y;
    }
    function projectScriptByIndexZ(uint256 _projectId) view public returns (uint8){
        return allTokens[_projectId].z;
    }
