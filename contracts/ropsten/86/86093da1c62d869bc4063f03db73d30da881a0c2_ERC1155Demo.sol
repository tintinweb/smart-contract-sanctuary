...
contract ERC1155Demo is ERC1155 {
    ...
    function setURI(string memory _uri, uint256 _id)external{
    ...
    function getUri(uint256 _id)external view returns(string memory){
     ...
     function mintToken(address _address,uint256 _id, uint256 _amount/*, bytes memory _data*/) external onlyAdmin(){
     ...
     function mintBatchToken(address _to,uint256[] calldata _ids, uint256[] calldata _values/*, bytes memory data*/) external onlyAdmin(){
