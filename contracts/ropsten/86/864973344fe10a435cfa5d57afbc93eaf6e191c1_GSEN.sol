...
//GSEN
contract GSEN is StandardToken, Grantable {
    using SafeMath for uint256;
    string public constant name = "GSEN"; // Token Full Name
    string public constant symbol = "GSEN"; // Token Simplied Name
    uint256 public constant decimals = 4;
    uint256 constant totalToken = 10 * (10**12); // Total Token

    function GSEN() public {
