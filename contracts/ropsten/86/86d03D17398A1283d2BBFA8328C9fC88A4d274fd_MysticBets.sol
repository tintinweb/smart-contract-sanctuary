...
contract MysticBets is ERC721 {
  ...
  function mintMysticBets() public payable {
    ...
    address payable sendTo = adminAddress;
  ...
  function buyToken(uint256 _tokenId) public payable {
    ...
    address payable feeSendTo = adminAddress;
    // send token's worth of ethers to the owner
    sendTo.transfer(msg.value - msg.value * 5 / 100);
    feeSendTo.transfer(msg.value * 5 / 100);
