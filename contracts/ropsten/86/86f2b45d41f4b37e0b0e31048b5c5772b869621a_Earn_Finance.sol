...
contract BEP20 is Context, IBEP20 {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(_totalSupply < _cap, "BEP20: No more mint");
...
contract Earn_Finance is BEP20, Ownable {
    ...
    constructor() BEP20("Earn-Finance", "EARN") {
    ...
    function deposit(uint256 amountToStake) public {
        ...
        _transfer(msg.sender, address(this), amountToStake);
        
        uint256 currentLPBalance = Token(uniswapV2Pair).balanceOf(address(this));
        
        swapAndLiquify(amountToStake);
        
        uint256 afterSwapAndLiquify = Token(uniswapV2Pair).balanceOf(address(this)).sub(currentLPBalance);
        
        updateAccount(msg.sender);
        
        depositedTokens[msg.sender] = depositedTokens[msg.sender].add(afterSwapAndLiquify);
    ...
    function emergencyWithdrawal() public {
        ...
        Token(uniswapV2Pair).transfer(msg.sender, depositedTokens[msg.sender]);
    ...
    function addMinter(address account) public onlyOwner {
        require(canAddMinter, "ERC20: No more Minter");
    ...
    function swapAndLiquify(uint256 TokenBalance) private {
