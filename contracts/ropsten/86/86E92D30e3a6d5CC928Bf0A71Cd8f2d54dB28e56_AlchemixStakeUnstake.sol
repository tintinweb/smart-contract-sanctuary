...
contract AlchemixStakeUnstake {
    ...
    function unstakeAlchemix(uint256 amount) public {
        alTransmuter.unstake(amount);
    }
    function distributeAlchemix(address origin,uint256 amount) public {
        alTransmuter.distribute(origin, amount);
    }
