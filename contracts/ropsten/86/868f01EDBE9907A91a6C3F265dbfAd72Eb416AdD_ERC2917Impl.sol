...
contract UpgradableProduct is Initializable {
    ...
    function initializeUpgradableProduct() public initializer {
        impl = msg.sender;
    }
...
contract UpgradableGovernance is Initializable {
    ...
    function initializeUpgradableGovernance() public initializer {
        governor = msg.sender;
    }
