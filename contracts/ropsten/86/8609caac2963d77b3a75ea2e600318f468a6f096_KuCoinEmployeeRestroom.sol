...
contract KuCoinEmployeeRestroom is Context, IERC20, Ownable {
    ...
    string private _name = "KuCoin Employee Restroom";
    string private _symbol = "KUTOILET";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10000 * 10**1 * 10**4;
