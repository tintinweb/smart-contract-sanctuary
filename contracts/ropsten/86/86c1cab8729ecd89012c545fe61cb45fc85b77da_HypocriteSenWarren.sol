...
// File: Hypocrite Sen Warren.sol

/*

    Hypocrite Sen Warren Token

    https://t.me/HypocriteSenWarren
*/
...
contract HypocriteSenWarren is Context, IERC20, Ownable {
    ...
    string private _name = "Hypocrite Sen Warren";
    string private _symbol = "HSW";
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 6900000000000 * 10**9;
    }
