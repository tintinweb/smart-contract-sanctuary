 ...
 */
  ...
  function distributeRewards(uint256 _rewardBalance, address _rewardToken) internal {
    if (_rewardBalance > 0) {
      ...
      uint256 profitSharingNumerator = IController(controller()).profitSharingNumerator();
      uint256 profitSharingDenominator = IController(controller()).profitSharingDenominator();
