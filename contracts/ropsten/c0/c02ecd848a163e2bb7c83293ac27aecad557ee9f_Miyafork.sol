...
contract Miyafork is Context, IERC20Upgradeable {
    ...
    address payable private _marketingWallet = payable(0xed254990Ec81AbB5887765845bEa1c5b17A79D21);
...
//===============================================================================================================
    ...
    function setMaxTxPercent(uint256 percent, uint256 divisor) external onlyOwner {
        ...
        require(check >= (_tTotal / 10000), "Max Transaction amt must be above 0.1% of total supply.");
        _maxTxAmount = check;
        maxTxAmountUI = (startingSupply * percent) / divisor;
    }
    ...
    function setMaxWalletSize(uint256 percent, uint256 divisor) external onlyOwner {
        uint256 check = (_tTotal * percent) / divisor;
        require(check >= (_tTotal / 25000), "Max Wallet amt must be above 0.1% of total supply.");
