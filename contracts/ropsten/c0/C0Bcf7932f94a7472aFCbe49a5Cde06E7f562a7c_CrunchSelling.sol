...
contract CrunchSelling is Ownable, Pausable, IERC677Receiver {
    ...
    /** @dev Cached value of 1 USDC (1**6). */
    uint256 public oneUsdc;
     ...
     *
     * @param inputAmount input value (in CRUNCH) to convert.
     * @return outputAmount the converted amount (in USDC).
     */
     ...
     * Emits a {UsdcChanged} event.
     *
     * @dev this will update the `oneUsdc` value.
     *
     * @param newUsdc new USDC address.
     */
