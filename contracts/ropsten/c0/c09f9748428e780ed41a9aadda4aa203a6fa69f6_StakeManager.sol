...
contract StakeManager is IStakeManager, StakeBase {
    ...
    */
    function addDailyInterest() public {
        ...
        uint256 todaysSharePayout = 34885952500978473581214;
        // uint256 interest = 179885952500978473581214; // 179885952500978473581214
        ...
        //         ((interest * (10**26)) / ((statFields.sharesTotalSupply * 1e12)));
        // } else {
        //     todaysSharePayout = (interest * (10**26)) / ((statFields.sharesTotalSupply * 1e12));
        // }
