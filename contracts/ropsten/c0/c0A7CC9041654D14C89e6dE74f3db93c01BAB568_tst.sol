...
** Using FTPEthReflect to give 4.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xb7003f292bF1b8F13c51710a64C9994Dd7A20eF4), 6000);
        m_DidDeploy = true;
    }
...
contract tst is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 10000000000000 * 10**9;
    string private m_Name = "tst";
    string private m_Symbol = "tstz";
