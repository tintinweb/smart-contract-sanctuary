...
contract FlowFields is ERC721Enumerable, Ownable{
    ...
    // constants
    uint256 constant FREE_ELEMENTS = 9;
    ...
    function publicMint(uint256 numberOfTokens) external payable {
        ...
        if (totalSupply() < FREE_ELEMENTS) {   // Free Mint
            require(totalSupply() + numberOfTokens <= FREE_ELEMENTS, 'Purchase would exceed max supply');
