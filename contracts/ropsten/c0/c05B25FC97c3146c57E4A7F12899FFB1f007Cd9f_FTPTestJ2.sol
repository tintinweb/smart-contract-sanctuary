...
FTPTestJ2 Socials:
Telegram: https://t.me/joinchat/PSdNCGdlBYgzMzMx
Twitter: https://twitter.com/token_project?lang=en
Website: https://public.fairtokenproject.com/
...
contract FTPTestJ2 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 55000000000000 * 10**9;
    string private m_Name = "FTPTestJ2";
    string private m_Symbol = "FTPJJ";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(1 days), msg.sender, address(m_UniswapV2Router));
