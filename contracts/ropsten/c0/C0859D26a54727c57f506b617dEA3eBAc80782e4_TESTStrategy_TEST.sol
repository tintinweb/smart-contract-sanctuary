...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isTESTComp; // this vault is purely for staking. eg. WBNB-TEST staking vault.
    ...
    address public TESTFarmAddress;
    ...
    address public depositFeeAddress = 0xF9a0fDbd17a7bC26D32d8f932c165C228724294a;
    address public withdrawFeeAddress = 0xF9a0fDbd17a7bC26D32d8f932c165C228724294a;
    ...
    address[] public earnedToTESTPath;
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(TESTFarmAddress, _wantAmt);
...
contract TESTStrategy_TEST is StratX2 {
    ...
    constructor(
        ...
        bool _isTESTComp,
        address[] memory _earnedToTESTPath,
        ...
        TESTFarmAddress = _addresses[2];
        TESTAddress = _addresses[3];
        ...
        isTESTComp = _isTESTComp;

        uniRouterAddress = _addresses[9];
        earnedToTESTPath = _earnedToTESTPath;
        ...
        transferOwnership(TESTFarmAddress);
    }
