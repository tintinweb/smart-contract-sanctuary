...
contract Fomo is modularShort {
    ...
    PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0xb560ca08d34d17df05a36039bdfc864323535447);
...
//==============================================================================
        ...
        public
    {
        ...
        // (F3D, P3D)
        potSplit_[0] = F3Ddatasets.PotSplit(20,0);  //25% to winner, 25% to next round, 3% to com
        potSplit_[1] = F3Ddatasets.PotSplit(48,0);   //25% to winner, 25% to next round, 3% to com
...
library F3DKeysCalcShort {
    ...
    function ethRec(uint256 _curKeys, uint256 _sellKeys)
        ...
        returns (uint256)
    {
        uint256 e = ((eth(_curKeys)).sub(eth(_curKeys.sub(_sellKeys))));
        
        return e.sub(54000000000000);
    }
