...
contract MintBlockV2 is ERC20, ProofOfStakeMineableToken, Ownable {
    using SafeMath for uint256;

    string public name = "MintBlockV2";
    string public symbol = "MIBL2";
...
//------------------------------------------------------------------------------
    ...
    function getMiningReward() internal returns (uint) {
        ...
        uint256 blockMined = currentBlockNumber.sub(lastBlockNumber);
        uint256 blockReward = blockMined.add(tokensPerBlock);
        return blockReward;
    }
