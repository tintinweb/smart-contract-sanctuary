...
//
// Copyright of The W3INU
//
//
// 
// W3INU has 7% tax split across 7 protocols
...
/**
 * @dev The official W3INUToken smart contract
 */
contract W3INU is Context, IERC20, Ownable {
    ...
    // General Info
    string private _name     = "W3INU";
    string private _symbol   = "W3INU";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for W3INU/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x973fab1b8560EaD1DCE89476638a9348aFEe2963); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion W3INU will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-W3INU tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts W3INU balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns W3INU tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of W3INU tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from W3INU)
