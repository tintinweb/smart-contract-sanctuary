...
contract WaterToken is Context, IERC20 {
    ...
    string constant private _name = "Water Token";
    string constant private _symbol = "Water";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x85A20A9F8e7b5797F824731eD2a29231D474938E),
        Buyback: payable(0x5a4863Af2e27169Ce9ffC63f0BC5374236F8Ec4c),
        dev: payable(0x776F529d06a1479cEAd2dcA3bdA1F52ECeA24920)
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 Buyback, uint16 dev, uint16 burn) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0) {
            _taxWallets.Buyback.transfer(_ratios.Buyback * amountETH / (_ratios.total));
