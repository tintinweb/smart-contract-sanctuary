...
contract KORO is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 10; //(1% liquidityAddition + 1% rewardsDistribution + 8% devExpenses)
    ...
    // limit
    uint256 public _maxTxAmount = 25000000000000; //.25% of supply
