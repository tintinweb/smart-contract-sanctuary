...
contract Testcoin is StandardToken {
    ...
    */
    ...
    function Testcoin(
        ...
        balances[msg.sender] = 100000000000000;               // Cantidad de tokens que existiran al inicio
        totalSupply = 1000000000000000;                        // Cantidad de tokens que existiran 
        name = "Testcoin";                                   // Nombre del token 
        decimals = 9;                            // Cantidad de decimales
        symbol = "TCN";                               // Simbolo de la moneda 
    }
