...
contract InvoluteDownwardAuction {
    ...
    function bid(bytes16 _auctionId) public payable {
        ...
        a.lowestBidEUR = msg.value * a.ETHConversionRate;
        
        a.bids[msg.sender].timestamp = block.timestamp;
        a.bids[msg.sender].amount = msg.value;
        a.bids[msg.sender].lowestBidEUR = msg.value * a.ETHConversionRate;

        emit LowestBidDecreased(_auctionId, msg.sender, msg.value, msg.value * a.ETHConversionRate);
    ...
    function auctionEnd(bytes16 _auctionId) public {
        ...
        // 2. Effects
        a.auctionEnded = true;
        emit AuctionEnded(_auctionId, a.lowestBidder, a.lowestBid, a.lowestBid * a.ETHConversionRate);
