...
contract Billion  is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Billion() {
        ...
        name = "Billion";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BLN";                                             // Set the symbol for display purposes (CHANGE THIS)
