...
contract GTW is Context, IERC20, Ownable {
    ...
    address payable public devWallet = payable(0x1Bb4C586ae31d910287A19344BeA2Be7e5b9E4b0); // charity Address
    address payable public marketingWallet = payable(0xeB37Ad189b3672896d805FAa6e2E27F89D7AD3aA); // marketing Address
    ...
    returns (uint256, uint256)
    {
        ...
        uint256 tCharity = tAmount.div(10000).mul(_devFee.add(_marketingFee));
