...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    string private _name = "Green Eyed Monster";
    ...
    uint256 public _maxWallet = 10000000000 * 10**9; //1% of TS
    uint256 public _maxTxAmount = 10000000000 * 10**9; //1% of TS
    // set this number to adjust the rate of swaps
    uint256 public numTokensSellToAddToLiquidity = 1250000000* 10**9;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Green Eyed Monster: cannot burn from zero address");
    require(_balances[account] >= amount, "Green Eyed Monster: Cannot burn more than the account owns");
