...
contract InfinityDeposit is RetrieveTokensFeature, Package {
    ...
    event LogDeposit(uint256 Id, uint256 IndexPackage, address WithdrawalAddress, uint256 Amount, uint256 UnlockTime);
    ...
    function makeDeposit(address _withdrawalAddress, uint256 _idxPackage, uint256 _amount) public canBuy(_idxPackage, _amount) returns(uint256 _id) {
        ...
        emit LogDeposit(_id, _idxPackage, _withdrawalAddress, tensetFixedBalance, lockedToken[_id].unlockTime);
    }
