...
contract USTM01 is ERC20Interface, Owned, SafeMath {
    ...
    function SignDividend(uint amount) public 
    {
        ...
        _divdendSnapshots[_currentDivIteration]._UnpaidDiv = divLargeInt;
                ...
                uint remaining = _divdendSnapshots[_currentDivIteration]._UnpaidDiv;
                {
                    ...
                    else
                    {
                        ...
                        //LockDiv(msg.sender, 0);
                         _divdendSnapshots[_currentDivIteration]._UnpaidDiv=safeSub(remaining,div);
                         _divdendSnapshots[_currentDivIteration]._divState[msg.sender] = 1;
                         _divdendSnapshots[_currentDivIteration]._divSnapShot[msg.sender] = 0;
