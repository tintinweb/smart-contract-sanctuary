...
contract MyToken12 is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        require(!_IsBot[recipient], "You are blocked as a bot!");
    ...
    function enableTrading() external onlyOwner { //function can only be called once
        tradingOpen = true;
    }

    function Enableselling() public onlyOwner { //function can only be called once
