...
contract SampleSell is Context,ReentrancyGuard {
  ...
  constructor() ReentrancyGuard() {
    ...
    function SellTokens(address tokenToSend,uint256 tokenAmount) external {
        ...
        uint[] memory amounts = uniswapRouter.swapExactTokensForETH(tokenAmount,0,path,address(this),(block.timestamp + 100000000000));
