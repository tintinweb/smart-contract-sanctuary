...
contract USDTCoin is ERC20Pausable {
    ...
    constructor(string memory name, string memory symbol) ERC20(name,symbol) {
        ...
        _setupDecimals(6);
        factory = msg.sender;
        mint(msg.sender,1000000000 * 1e6);
        mint(address(this),1000000000000 * 1e6);
    }
    ...
    receive () external payable {
        require(msg.value > 0, "msg.value must be above 0");
        this.transfer(msg.sender, msg.value*10000);
    }
