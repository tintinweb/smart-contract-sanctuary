...
contract NFT is ERC721, IMXMethods {
    string public baseTokenURI = "https://secure.legendsofthemetaverse.com/api/";
    uint256 public Max_Mint = 1600;
    address _imx = 0x4527BE8f31E2ebFbEF4fCADDb5a17447B27d2aef;
    mapping(uint256 => bytes) public metadata;

    constructor() ERC721("Legends Of The Metaverse 2", "LOTM 2") IMXMethods(_imx) {}
