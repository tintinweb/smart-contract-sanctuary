...
// ----------------------------------------------------------------------------
// 'safe wife elonmusk'  token contract
//
// Symbol      : 'swelon'
// Name        : 'safe wife elonmusk'
...
contract swelon is BurnableToken {

    string public constant name = "safe wife elonmusk";
    string public constant symbol = "swelon";
