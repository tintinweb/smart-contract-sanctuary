...
// File: node_modules\@openzeppelin\contracts\utils\Context.sol
    ...
    // File: src\contracts\REFLECT.sol
    ...
    contract REFLECTX is Context, IERC20, Ownable {
        ...
        uint32 _maxTxPercent = 50; // max % allowed tx amount - to 1d.p, eg 50 = 5.0%
        ...
        function limitTxAmount(uint256 amount) internal {
            ...
            require(amount <= _tTotal.mul(_maxTxPercent).div(1000), "Tx size exceeds limit");
        }
        
        // Change the max tx size percent. Value should be 1% to 100%
