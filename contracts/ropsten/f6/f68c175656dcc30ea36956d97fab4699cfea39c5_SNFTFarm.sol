...
contract SNFTFarm {
    ...
    event YieldWithdraw(address indexed from, address indexed to, uint256 amount);
    ...
    function withdrawYield() public {
        ...
        startTime[msg.sender] = block.timestamp;
        SNFTToken.transferFrom(address(this), msg.sender, toTransfer);
        emit YieldWithdraw(address(this), msg.sender, toTransfer);
    } 
