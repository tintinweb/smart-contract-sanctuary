...
// File: contracts/Floor.sol

pragma solidity >=0.6.0 <0.8.0;

// uncomment if you are using truffle to deploy, you would need to install the openzepplin contracts library from // npm
//import "@openzeppelin/contracts/token/ERC721/ERC721.sol";
//import "@openzeppelin/contracts/utils/Counters.sol";
//import "@openzeppelin/contracts/access/Ownable.sol";

// comment out if you are not going to use truffle
...
contract DiamondBoys is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() public ERC721("DiamondBoys", "DB") {}
    ...
    function mintNFTFromOwner(address recipient, string memory uri)
        public
        payable
        onlyOwner
        returns (uint256)
