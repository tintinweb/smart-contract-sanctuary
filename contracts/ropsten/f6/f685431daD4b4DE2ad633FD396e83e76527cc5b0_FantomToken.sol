...
contract FantomIcoDates is Owned {
    ...
    uint public dateMainStart = 1528855146; // 13-JUN-2018 01:59 UTC
    uint public dateMainEnd   = 1528941546; // 14-JUN-2018 01:59 UTC
...
contract FantomToken is ERC20Token, Wallet, LockSlots, FantomIcoDates {
    ...
    uint public tokensPerEth = 50000000;

    uint public constant MINIMUM_CONTRIBUTION = 0.2 ether;
    uint public constant MAXIMUM_FIRST_DAY_CONTRIBUTION = 0.5 ether;
