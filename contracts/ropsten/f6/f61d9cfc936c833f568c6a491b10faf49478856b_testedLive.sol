...
contract testedLive  is ERC721Enumerable, Ownable
{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    uint public constant _TOTALSUPPLY = 12;
    uint256 public price = 150000000000000000; // 0.1 ETH
    uint256 WHITE_LIST_DISCOUNT = 30;
    bool public isPaused = true;
    
    mapping(address => bool) discounters;

    constructor(string memory baseURI) ERC721("The Tester Collection", "TESTSYM")  {
        setBaseURI(baseURI);
    }
