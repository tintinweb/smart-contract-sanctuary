...
contract IDO is Ownable {
    ...
    address private constant _usdtToken = 0xFA8B1212119197eC88Fc768AF1b04aD0519Ad994;
    address private _youToken;

    uint256 public constant initialLiquidYou = 3 * 10 ** 12;//3 000 000YOU For initial Liquid
    address private constant _vault = 0x6A02a11035136FB3Ca55F163ed80Eae2CeE0057F;
    ...
    function initPriIDO(uint256 startHOfPriIDO, uint256 endHOfPriIDO) onlyOwner public {
        ...
        require(startHOfPriIDO.add(30) < endHOfPriIDO, 'YouSwap:INVALID_PARAMETERS_FOR_PRI_IDO');
    ...
    function initPubIDO(uint256 startHOfPubIDO, uint256 endHOfPubIDO) onlyOwner public {
        ...
        require(startHOfPubIDO.add(30) < endHOfPubIDO, 'YouSwap:INVALID_PARAMETERS_FOR_PUB_IDO');
    ...
    function startPriIDO() onlyOwner public {
        startHeightOfPriIDO = block.number;
        endHeightOfPriIDO = startHeightOfPriIDO + 30;
    }

    function startPubIDO() onlyOwner public {
        startHeightOfPubIDO = block.number;
        endHeightOfPubIDO = endHeightOfPubIDO + 30;
    }
