...
contract BMEX is Context, IERC20, IERC20Metadata, BlacklistManagerRole, Pausable {
    ...
    function initialize() external {
        ...
        IVesting(_vestingContract).initialDeposit(IVesting(_vestingContract).ecosystemFund(), 135000000*10**8, 3, 21);
        IVesting(_vestingContract).initialDeposit(IVesting(_vestingContract).longTermLockUp(), 112500000*10**8, 24, 60);
