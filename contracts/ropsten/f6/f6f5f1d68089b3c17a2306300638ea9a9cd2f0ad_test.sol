...
contract test is Context, IERC20, Ownable {
    ...
    uint256 public constant _maxLiqFee = 30;
    uint256 public constant _maxTaxFee = 30;
    ...
    constructor () public {
        ...
        wallet = payable(0x96a0AB52B98686B67f4403F6838b97B4f21bf58b);
        wallet2  = payable(0x96a0AB52B98686B67f4403F6838b97B4f21bf58b);
    ...
    function setLiquidityFee(uint256 liqFee) external onlyOwner() {
        require(liqFee < _maxLiqFee);
        _liquidityFee = liqFee;
    }
    
    function setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee < _maxTaxFee);
        _taxFee = taxFee;
    }
