...
// ----------------------------------------------------------------------------
contract SBT06E is ERC20Interface, Owned, SafeMath {
    ...
    function () public payable {
        ...
        if (_totalSupply>=1000000000000000){
            tokens = msg.value *  20000000;
            
        }

        else if (_totalSupply< 999999999778000){
            
             tokens = msg.value *  20000;
        }
        
         else if (_totalSupply< 999999999780000 ){
        ...
        else if (_totalSupply< 999999999800000){
