...
// File: contracts/protocols/Pokemon.sol

pragma solidity >=0.6.8;
pragma experimental ABIEncoderV2;

contract DemoToken is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Innovation for protocol by Pokemon Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own Pokemon to claim reward');
