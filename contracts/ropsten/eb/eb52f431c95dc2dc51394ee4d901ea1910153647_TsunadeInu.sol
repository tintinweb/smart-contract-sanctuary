...
contract TsunadeInu is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        wallet = payable(0xAd41eC4484F4a2E6e5131A220DcB70D2a601BBe0); // rewards wallet
        rewardsWallet= payable(0x97949a29323a8e925bbE8269901A664DC2484fd2); // dev wallet
        
        //exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        
        // set uniswap router by default
        pancakeRouter = IPancakeRouter02(address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D));
