...
contract HodlBabaNFT is ERC721, Ownable, Pausable, ReentrancyGuard {
    ...
    address[] private _royaltyAddresses = [
        ...
        0x428826457A3B8FD4dcBE22c26eF330c2Af417F6c  // Dev wallet address
    ];
    ...
    constructor(
        ...
        _royaltyShares[_royaltyAddresses[1]] = 1; //  Royalty for Dev wallet
    }
        ...
        payable
    {
        ...
        require(!transferred[msg.sender], "ALREADY_TRANSFERRED");
        require(
        ...
        require(
            _count > 0 && ownerTokenCount + _count <= MAX_MINT_PER_PRESALE,
            "COUNT_INVALID"
        );
        require(totalSupply + _count <= MAX_SUPPLY, "MAX_SUPPLY_REACHED");
        // require(totalSupply >= GIVEAWAY_SUPPLY, "GIVEAWAY_NOT_MINTED");
