...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'3a4c46bcf018de018fa49b4bc4f325b7111aeac3047ae54b3b849aa408458ef4' // init code hash
            ))));
    }
...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    {
        return UniswapV2Library.getAmountOut(amountIn, reserveIn, reserveOut, getFees());
    }
    ...
    {
        return UniswapV2Library.getAmountIn(amountOut, reserveIn, reserveOut, getFees());
    }
    ...
    function getAmountsOut(uint amountIn, address[] memory path)
        ...
        returns (uint[] memory amounts)
    {
        return UniswapV2Library.getAmountsOut(factory, amountIn, getFees(), path);
    }
        ...
        returns (uint[] memory amounts)
    {
        ...
        return UniswapV2Library.getAmountsIn(factory, amountOut, getFees(), path);
    }

	function getFees()public view  returns(uint fee)
	{
		if(address(distributor) != address(0))
			fee = IDistributor(distributor).FeePercentage();
		else
			fee = 100;
	}
}