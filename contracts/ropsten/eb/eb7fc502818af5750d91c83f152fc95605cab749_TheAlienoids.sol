...
// File: contracts/thealienoids.sol
...
contract TheAlienoids is ERC721, Ownable {
    using Address for address;
    ...
    uint256 public constant price = 8000000000000000; // 0.08 ETH
    ...
    address private _signerAddress = 0xbe720615913cD6A458663432f8B2581BaA4248b9; 

    constructor() ERC721("The Alienoids ", "ALNDS") {
    }
