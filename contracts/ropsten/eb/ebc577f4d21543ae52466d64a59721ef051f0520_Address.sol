 ...
 */
contract TESTTOKEN is BEP20Mintable, BEP20Burnable, BEP20Operable, TokenRecover, ServicePayer {
    constructor(
        string memory name_,
    ...
    ) payable BEP20(name_, symbol_) ServicePayer(feeReceiver_, "TESTTOKEN") {
