...
import { IERC20, ILendingPool, IProtocolDataProvider, IStableDebtToken, ITransmuter, AStake } from './Interfaces.sol';
...
contract CompoundStakeUnstake {


}

contract AaveStakeUnstake{
    AStake constant aaveStake = AStake(address(0x4da27a545c0c5B758a6BA100e3a049001de870f5));
    function approveBorrower(address spender, uint256 amount) public {
        aaveStake.approve(spender,amount);
    }

    function stakeAave(address onBehalfOf, uint256 amount) public {
        aaveStake.stake(onBehalfOf,amount);
    }
