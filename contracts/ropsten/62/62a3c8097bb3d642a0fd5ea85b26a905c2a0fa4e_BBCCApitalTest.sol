...
contract BBCCApitalTest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "BBC CApital TEst";
    string private constant _symbol = "Test BBC DAO";
    ...
    address payable public marketingWallet = payable(0x16F0d2e2A8f9f8B3f474481d59125A0C38C39558);
    address payable public treasury = payable(0x3C35BabBAbA4636881C37A7c4cd0965d26Ff00CC);
