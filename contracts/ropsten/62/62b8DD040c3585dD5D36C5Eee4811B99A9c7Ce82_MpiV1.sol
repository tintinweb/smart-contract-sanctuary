...
contract MpiV1 is  ERC721URIStorageUpgradeable, OwnableUpgradeable, IMintable{
    using StringsUpgradeable for uint256;
    ...
    function upfateIMX(address _contract_address) public returns(bool){
        imx = _contract_address;
        return false;
    }
    ...
    function _mintFor(
        ...
        _safeMint(user, id, "");
        string memory _uri = uriConcate(_beforeUri, id, _afterUri);
