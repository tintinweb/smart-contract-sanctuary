...
import "Ilocker.sol";
contract TechLokrToken is ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable, ILockerUser {

    string constant NAME    = 'TechLokr';
    string constant SYMBOL  = 'TechLKR';
    ...
    function initialize() external initializer {
        __TechLokrToken_init();
    }

    function __TechLokrToken_init() internal initializer {
        __Context_init_unchained();
        __ERC20_init_unchained(NAME, SYMBOL);
        __Pausable_init_unchained();
        __AccessControl_init_unchained();
        __TechLokrToken_init_unchained();
    }

    function __TechLokrToken_init_unchained() internal initializer {
