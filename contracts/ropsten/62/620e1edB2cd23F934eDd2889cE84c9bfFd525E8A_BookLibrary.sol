...
contract BookLibrary is BookFactory {
    ...
    function borrowBook(
        ...
        // require(LIBToken.allowance(msg.sender, address(this)) >= books[_bookId].price, "Token allowance too low");
...
contract LToken is ERC20PresetMinterPauser {
	...
	constructor(uint256 initialSupply) ERC20PresetMinterPauser("Libras", "LIS") {
