...
contract Minter is owned {
    ...
    function transferMintingOwnership(address payable _newMintingOwner)
        external
        onlyOwner
    {
...
contract NEXTToken is owned, Minter, ERC165 {
    ...
    string private constant _name = "NEXT";
    string private constant _symbol = "NEXT";
    uint256 private constant _decimals = 18;
    uint256 private _totalSupply = 8000000 * (10**_decimals); //8M
    uint256 public immutable maxSupply = 30300000 * (10**_decimals); //30,3M
     ...
     */
    function increase_allowance(address spender, uint256 value)
        external
        returns (bool)
    {
     ...
     */
    function decrease_allowance(address spender, uint256 value)
        external
        returns (bool)
    {
        require(spender != address(0));
