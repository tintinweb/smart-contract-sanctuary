...
/************************************
* Copyright © 2021 Mandrake4 COIN. ALL RIGHTS RESERVED.
***************************************/
...
contract Mandrake4 is IERC20, Ownable {
    ...
    string private _name      = 'Mandrake4';
    string private _symbol    = 'Mandrake4';
    ...
    ******************************************************
    BASE FUNCTIONS
    Tested in '/test/Mandrake4_base.test.js
    ******************************************************
    *****************************************************/

    // TEST FUNCTION #1 '/test/Mandrake4_base.test.js
    // READ: return the name of the contract - Mandrake4
    function name() public view returns (string memory) {
        return _name;
    }
    // TEST FUNCTION #2 '/test/Mandrake4_base.test.js
    // READ: return the symbol of the contract - Mandrake4
    function symbol() public view returns (string memory) {
        return _symbol;
    }
    // TEST FUNCTION #3 '/test/Mandrake4_base.test.js
    // READ: return the  decimals of the contract - 18
    function decimals() public view returns (uint8) {
        return _decimals;
    }
    // TEST FUNCTION #4 '/test/Mandrake4_base.test.js
    // READ: return the current supply in existence - starts with 1 trillionc
    function totalSupply() public view override returns (uint256) {
        return currentSupply;
    }

    // TEST FUNCTION #6 '/test/Mandrake4_base.test.js
    // READ: return the balance of Mandrake4 that an address has
    ...
    ******************************************************
    ALLOWANCES
    Tested in '/test/Mandrake4_allowance.js
    ******************************************************
    *****************************************************/

    // TEST FUNCTION #1 '/test/Mandrake4_allowance.test.js
    ...
    // TEST FUNCTION #2 '/test/Mandrake4_allowance.test.js
    ...
    ******************************************************
    TRANSFERS FUNCTIONS
    d in '/test/Mandrake4_transfer.js
    ******************************************************
    *****************************************************/
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, msg.sender, _allowances[sender][msg.sender].sub(amount, "Insufficient Funds For Transfer From"));
