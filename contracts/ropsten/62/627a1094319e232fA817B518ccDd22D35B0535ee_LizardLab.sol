...
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
 ...
 contract LizardLab is ERC721Enumerable, Ownable {
    ...
    function claim() public {
        uint256 supply = totalSupply();
        require(claimActive,                              "Claim period must be active to claim");
        require(claimWhitelist[msg.sender],               "No claim available for this address");
        require(supply.add(1) <= maxSupply,               "Purchase would exceed max supply of tokens");
    ...
    //quick, grab them, they are running
