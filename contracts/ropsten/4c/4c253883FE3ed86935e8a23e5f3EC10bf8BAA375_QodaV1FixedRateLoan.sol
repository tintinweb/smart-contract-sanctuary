...
contract QodaV1FixedRateLoan is IQodaV1FixedRateLoan, ErrorCode {
  ...
  function getOutstandingLoan(bytes memory signature) external returns(
                                                                       uint,
                                                                       uint,
                                                                       uint,
                                                                       uint,
  ...
  function getAccountBorrows(address account) external returns(bytes[] memory){
    return accountBorrows[account];
  }
  
  function getAccountLends(address account) external returns(bytes[] memory){
...
library SigVerify {
  ...
  /// @param loanTokenAddress Address of the ERC20 token which the loan will be denominated
