...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private    _name = "Paul";
    string private  _symbol = "PAUL";
    uint8 private _decimals = 8;
    
  
    uint256 public _marketingFee;
    uint256 public _deployerFee;
    ...
    address payable marketingWallet = payable(0x3d6A1A2f83b3707AF0A9724a9e91758d875aadE6);
    address payable deployerWallet = payable(0x6EFc5f74837F0271ff9D8E9DECC025F4cD91123F);
    address payable developmentWallet = payable(0x2BB30694f081Bd3AC9C50Db7dfa8647f8f37585B);
    ...
    uint256 MaxWalletLimit = 1000000 * 10**8;
    ...
    function swapBack(uint256 tokensToLiquify) internal lockTheSwap {
        ...
        uint256 bnbFeeFactor = totalFees();

   
        uint256 bnbForMarketing = bnbBalance.mul(_marketingFee).div(bnbFeeFactor);
        uint256 bnbForDeployers = bnbBalance.mul(_deployerFee).div(bnbFeeFactor);
        uint256 bnbForDevelopment = bnbBalance.mul(_developmentFee).div(bnbFeeFactor);
      

        payable(marketingWallet).transfer(bnbForMarketing);
        payable(deployerWallet).transfer(bnbForDeployers);
