...
contract culaRewards {
    ...
    function payRewards(address _token, bytes32[] memory _addressesAndAmounts, uint256 rewardDistribution) public restricted returns(bool)
    {
        uint toReturn = rewardDistribution;
