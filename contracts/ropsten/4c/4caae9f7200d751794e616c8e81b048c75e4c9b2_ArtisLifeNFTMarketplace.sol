...
contract ArtisLifeNFTMarketplace {
    ...
    function newAuction(
        ...
        if (erc == 1155) {
            ...
            require(nftObject.balanceOf(sender, id) > 0, "Not enough balance.");
            require(
    ...
    {
        address sender = msg.sender;
        require(sender == nftsForAuction[auctionId].owner, "Not Auction Owner");
        ...
        notPaused
    {
        uint256 auction = auctionId;
        require(
            block.timestamp > nftsForAuction[auction].expirationTime,
