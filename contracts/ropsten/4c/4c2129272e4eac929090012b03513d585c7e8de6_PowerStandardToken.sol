...
contract PowerStandardToken is StandardToken { 
    ...
    function PowerStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
