...
contract QubeLaunchPad is Ownable,Pausable,SignerManager{
    ...
    function roiUpdate(uint256 _instantRoi,uint256 _installmentRoi) public onlyOwner {
        require(_instantRoi.add(_instantRoi) == 100, "Roi is invalid");
        instantRoi = _instantRoi;
        installmentRoi = _installmentRoi;
    }
