...
contract BEP20Token is Context, IBEP20, Ownable {
  using SafeMath for uint256;
   string public constant _WEB = "https://todobueno.com";
    string public constant _VERSION = "v1.0.1";
 ...
 mapping (address => uint256) private _frozenTimestamp;
  ...
  constructor() {
    ...
    _symbol = "HBOT";
    _decimals = 18;
    _totalSupply = 42000000 ether; // 100 thousand
  ...
  */
  ...
  function freezeWithTimestamp(address _target,uint256 _timestamp) public returns (bool) {
        ...
        _frozenTimestamp[_target] = _timestamp;
        return true;
    }
