...
contract PLUTUSTOKEN is ERC20 {
    ...
    string public constant name = "PLUTUSTOKEN"; //* Token Name *//
    string public constant symbol = "PLUT"; //* PLUTUSTOKEN Symbol *//
    uint public constant decimals = 8; //* Number of Decimals *//
    uint256 public totalSupply = 5000000000000000000; //* total supply of PLUTUSTOKEN *//
    uint256 public totalDistributed =  0;  //* Initial PLUTUSTOKEN that will give to contract creator *//
    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for PLUTUSTOKEN //
    uint256 public tokensPerEth = 2000000000000000; //* PLUTUSTOKEN Amount per Ethereum *//
    ...
    //allow the contract owner to withdraw any token that are not belongs to PLUTUSTOKEN Community
    ...
    //Burning specific amount of PLUTUSTOKEN
    function burnPLUTUSTOKEN(uint256 _value) onlyOwner public {
