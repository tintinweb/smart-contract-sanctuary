...
contract ProjectName is AdminRole, VerifySignature{
  ...
  constructor () public {
    ...
    // set administrators
    _addAdmin(address(0x277D7e76705cb61d0A828e81Cf1713fCd8c5d024));
    _addAdmin(address(0xAdCB9A2366adB963dE52cF57Fe0e168b3a7818dd));
    _addAdmin(address(0x47357118eFa5E72eca1d104Ea4f2409FA25De735));
