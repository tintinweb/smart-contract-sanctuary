...
contract DogeVille is ERC721Enumerable, Mintable {
    string private _baseURIExtended;
    string private _contractURIExtended;
     address public dev1Address = 0x2CaC6CD7D90E7F0993bD2c060F3C476Da1EBcA85;
    address payable private devguy1 = payable(dev1Address);
         address public dev2Address = 0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b;
    address payable private devguy2 = payable(dev2Address);
    ...
    function transferBalance()public payable{
        uint dev1Part = address(this).balance / 100 * 75;
        devguy1.transfer(dev1Part);
        uint dev2Part = address(this).balance / 100 * 80;
        devguy2.transfer(dev2Part);
