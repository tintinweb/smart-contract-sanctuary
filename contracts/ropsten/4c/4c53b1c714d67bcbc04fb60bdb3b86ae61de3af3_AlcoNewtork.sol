...
****Main features of ALCO Network****
    
1) 3% tax is distributed to holders
2) 2 % AutoBurn
3) 15%  marketing tax is sent for marketing fund (in BNB)
...
contract AlcoNewtork is Context, IERC20, Ownable {
    ...
    string private _name = "ALCONetwork";
    ...
    address public marketingAddress = payable(0xb533b5CD719b980595F177Ed71c5c316349ece45); // Marketing Address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferMarketingETH(payable(marketingAddress), address(this).balance);
    }
