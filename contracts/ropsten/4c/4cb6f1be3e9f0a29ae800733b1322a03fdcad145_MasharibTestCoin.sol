...
contract MasharibTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MasharibTestCoin() {
        ...
        name = "MasharibTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT:043";                                             // Set the symbol for display purposes (CHANGE THIS)
