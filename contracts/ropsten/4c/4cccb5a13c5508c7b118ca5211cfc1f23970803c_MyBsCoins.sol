...
contract MyBsCoins is StandardToken {

    string public constant name = "MyBsCoins";
    ...
    constructor (address tokenOwner, uint _endDate) public{
...
contract SalesManager is Ownable {
     ...
     *
        ...
        Token exchange rate: 1 ETH = 2400 MyBsCoins
    ...
    **/
    ...
    constructor () public{
        tokenAddress = new MyBsCoins(tokenOwner, endDate);
    }
    ...
    function sendTokens(uint _amount, uint _ethers) internal {
        MyBsCoins tokenHolder = MyBsCoins(tokenAddress);
