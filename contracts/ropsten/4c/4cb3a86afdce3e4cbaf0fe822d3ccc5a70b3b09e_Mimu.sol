...
contract Mimu {
    ...
    string private _name = "CuriosityToken";
    string private _symbol = "CURS";
    uint8 private _decimals = 2;
    uint256 private _totalSupply;
    uint256 public price =0.001 ether; //0.001*10**18
    ...
    //создание токенов (определенное количество) при создании контракта 
    constructor(){
        uint256 supply = 1000000 * 10**_decimals;
