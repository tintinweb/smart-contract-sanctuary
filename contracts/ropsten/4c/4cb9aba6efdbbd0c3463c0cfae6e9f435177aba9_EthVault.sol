...
contract EthVault {
    ...
    function sellPower(uint256 _powerAmount) hasDripped external {
        ...
        require(SafeMath.add(powerSells, _ethAmount) < powerBuys / 4);
