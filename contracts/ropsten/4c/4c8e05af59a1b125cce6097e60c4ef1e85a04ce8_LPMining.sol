...
contract LPMining is Ownable {
	...
	struct VestingModel {
		uint tokenLockPeriod; // in days
		uint vestingPeriod; // in days
		uint stakingCap;
		uint rewardPerToken;
		uint amountStaked;
	}
	...
	constructor(IERC20 _stakingToken, IERC20 _rewardToken) public {
		...
		_addVestingModel(30,90,5000 ether, 23);
		_addVestingModel(90,180,2500 ether, 150);
		_addVestingModel(180,360,1250 ether, 461);
	}
