...
contract testbinopt {
    ...
    function addGameInQueue() private {
        Games.push(Game(0, 0, 0, 0, 0, false, block.timestamp+intervalSeconds+transactionTime, block.timestamp+transactionTime+intervalSeconds+intervalSeconds, 0, 0, false));
    }
    ...
    function NextCurrentGame() external {
        ...
        Game storage game3 = Games[currentGameId+1];
        game3.startTimestamp = game2.endTimestamp;
