...
contract SQIDCOIN is Context, IERC20, Ownable {
    ...
    // Start with 1%
    uint256 private _inverseFeeRate = 100;
    uint256 private _inverseFeeRateTimes100 = 100 * 100;
    // burn div
    bool public _closeFee = false;
    uint256 public _burndiv  = 0;
    string private _name = 'SqidCoin';
    string private _symbol = 'SQID';
