...
interface IMarket {
    ...
    event AskCreated(uint256 indexed tokenId, uint256 amount);
    event AskRemoved(uint256 indexed tokenId, uint256 amount);
    ...
    function setBid(uint256 tokenId, Bid memory bid) external payable;
