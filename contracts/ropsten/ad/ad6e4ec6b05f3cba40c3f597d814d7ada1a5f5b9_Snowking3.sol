...
contract Snowking3 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Snowking token fork dinger";
    string private constant _symbol = unicode"SNWKNG2";
