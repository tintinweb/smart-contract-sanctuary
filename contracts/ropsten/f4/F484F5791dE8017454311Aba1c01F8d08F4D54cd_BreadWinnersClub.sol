...
contract BreadWinnersClub is ERC721Enumerable, Ownable {
    ...
    uint256 public presaleStartDate = 1639283168;       // 15 Dec 2021
    uint256 public publicStartDate = 1639369568;        // 17 Dec 2021       // second

    uint256 public preSalePrice = 0.00 ether;
    uint256 public batchPublicSalePrice = 0.001 ether;
    uint256 public maxPreSaleMint = 7;
    uint256 public maxPublicSaleMint = 20;
    uint256 public batchPublicSaleMint = 3;
    ...
    */
    ...
    constructor() ERC721("BreadWinnersClub", "BWC") {
        //setBaseURI(baseURI);
    }
    ...
    function mint(uint256 _mintCount) public payable {
        ...
        require(_mintCount <= maxPublicSaleMint,           string(abi.encodePacked('You can only mint ', maxPublicSaleMint.toString(), ' BreadwinnersNFT in PublicSale')));
