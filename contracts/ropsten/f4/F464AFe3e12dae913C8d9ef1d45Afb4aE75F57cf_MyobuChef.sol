...
//--------------------------------------------------------PUBLIC FUNCTIONS --------------------------------------------------------
    ...
    function addLiquidityNoFeeAndStake(uint256 amountTokensIn, uint256 amountETHMin, uint256 amountTokenMin, uint256 lockTime) public payable nonReentrant {
        ...
        require(lockTime >= 600 || userInfo[0][msg.sender].lockedUntil >= block.timestamp, "addLiquidityNoFeeAndStake : Can't lock tokens for less than 1 week");
        updatePool(0);
    ...
    function reinvestETHRewards(uint256 amountOutMin) public nonReentrant {
            ...
            userInfo[1][msg.sender].amount += amountSwapped;
...
//--------------------------------------------------------RESTRICTED FUNCTIONS --------------------------------------------------------	
    ...
    function depositFor(address sender, uint256 _pid, uint256 amount, uint256 lockTime) public onlyAuthorized {        _deposit(sender, _pid, amount, lockTime);
    }
