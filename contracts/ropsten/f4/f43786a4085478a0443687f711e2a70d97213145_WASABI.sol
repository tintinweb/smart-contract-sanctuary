 ...
 * https://t.me/WASABI
 * wasabi.com
 * twitter.com/wasabitoken
 * 
 * WASABI is a meme token with a twist!  
 * WASABI has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 * 
 * TOKENOMICS:
...
contract WASABI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WASABI";
