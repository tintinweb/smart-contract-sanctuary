...
/**
 *Submitted for verification at hecoinfo.com on 2021-09-03
 */
...
contract ploot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenAttr(uint256 tokenId) public view returns (string memory) {
        string[17] memory parts;
        parts[0] = "";
    ...
    function claim() public nonReentrant {
        ...
        require(
            times < 1 ||
                ...
                (ddddAmount < 4000000e18 &&
                    ddddAmount >= 400000e18 &&
                    times < 3) ||
