...
contract Radical2 is Context, IERC20, Ownable {
    ...
    string private _name = "Radical2";
    string private _symbol = "RADCL2";
    ...
    function initContract() external onlyOwner() {
        ...
        _isSniper[address(0x71848fF346C47C427B89139655bFCcAD5Ab4BA93)] = true;
        _confirmedSnipers.push(address(0x71848fF346C47C427B89139655bFCcAD5Ab4BA93));

        teamDevAddress = payable(0x5C6b14E2c5C2e37D33701E05De738347EeaA2007);
    }
