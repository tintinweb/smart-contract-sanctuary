...
** Using FTPEthReflect to give 24.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x250E75B9F33940506D1cF31FaB63cFAA5ad98C95), 5000);
        m_DidDeploy = true;
    }
...
contract soo12 is Context, IERC20, Taxable {
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 24000, m_UniswapV2Pair, _uniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
