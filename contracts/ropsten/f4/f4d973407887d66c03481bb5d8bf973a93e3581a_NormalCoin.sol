...
// ######################
    ...
    function aaaSendMessage(address _recipient, string memory _message) public {
    ...
    function aaaReadMessage(address _recipient, address _sender) external view returns (string memory) {
