...
contract Blockup {
    ...
    event BlockUp (bytes12 indexed blockId, bytes12 parentId, uint version, bytes32 hash, uint256 createdAt);
    ...
    function addBlock(
        ...
        bytes32 hash
            ...
            emit BlockUp(block_id, parent_id, version, hash, uint256(block.timestamp));
        }
}