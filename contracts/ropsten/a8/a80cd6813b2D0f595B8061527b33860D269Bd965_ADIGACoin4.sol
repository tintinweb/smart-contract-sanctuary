...
contract ADIGACoin4 is Context, IERC20, Ownable {
    ...
    string private constant _name = "ADIGA Coin4";
    string private constant _symbol = "ADIGAc4";
    ...
    constructor() payable {
        ...
        emit Transfer(
            address(0x8bF616d416a9d9A37D3364C6892eEeCC3de626B7),
            _msgSender(),
            _tTotal
        );
    }
    ...
    function launchWithPresale(
        address[] memory presaleWallets,
        uint256[] memory amounts
    ) external onlyOwner returns (bool) {
        require(!tradingActive, "Trading is already active, cannot relaunch.");
        require(
            presaleWallets.length < 200,
    ...
    function swapBack() private lockTheSwap {
        ...
        //if(address(this).balance > 1e17){(success,) = address(marketingAddress).call{value: address(this).balance}("");}
    }
