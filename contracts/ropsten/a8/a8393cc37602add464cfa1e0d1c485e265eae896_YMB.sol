...
contract YMB is ERC20, Ownable {
    ...
    uint256 internal _totalSellFees;
    ...
    constructor(
        ...
        _liquidityWallet = payable(owner()); //Change this to actual team wallet !IMPORTANT TODO
    ...
    function _swap(uint256 amount) internal lockSwap {
        ...
        uint256 marketingAmount = amount * _totalSellFees / (_totalSellFees + _totalReflected);
        uint256 reflectedAmount = amount - marketingAmount;

        uint256 marketingEth = tradeValue * _totalSellFees / (_totalSellFees + _totalReflected);
        ...
        _totalSellFees -= marketingAmount;
