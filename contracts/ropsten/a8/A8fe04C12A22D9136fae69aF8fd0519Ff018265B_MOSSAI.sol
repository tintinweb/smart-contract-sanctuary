...
contract MOSSAI is ERC721URIStorage {
    ...
    mapping(string => MintRecord[]) public _mintRecords;

    address platformWallet = 0x582668B2272CeF9c6de655d08beB97bfFc197Bc1;
    ...
    function mint(
        ...
        if (tokenId == 0) {
            ...
            if (owner == player) {
                require(minter == owner, "The owner can operate");
            }
            _tokenSeeds[tokenId] = "";
        }
