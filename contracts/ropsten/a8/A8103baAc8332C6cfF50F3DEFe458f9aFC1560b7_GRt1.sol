...
contract GRt1 is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "GRT1";
    string private constant _symbol = "GRT1";
    uint8 private constant _decimals = 9;

    // RFI
    mapping(address => uint256) private _rOwned;
    mapping(address => uint256) private _tOwnedH;
    ...
    uint256 private _taxFee = 1; // 1%
    uint256 private _teamFee = 2; // 2% Marketing and Development Fee
    ...
    address payable private _GRDev;
    ...
    constructor(address payable marketfund, address payable goldtax, address payable grdev) {
        ...
        _isExcludedFromFee[_GRDev] = true;
