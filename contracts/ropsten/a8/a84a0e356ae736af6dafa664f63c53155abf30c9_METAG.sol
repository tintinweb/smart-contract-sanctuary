...
contract METAG is ERC20, Ownable {
    ...
    function initSupply(address _teamAddr,
          ...
          isInit = true;
          _mint(_teamAddr, total.mul(5).div(100));
          _mint(_marketingAddr, total.mul(10).div(100));
          _mint(_ecoFundAddr, total.mul(20).div(100));
          _mint(_partnersAddr, total.mul(5).div(100));
          _mint(_playToEarnAddr, total.mul(10).div(100));
          _mint(_nftPoolAddr, total.mul(10).div(100));
          _mint(_privateSaleAddr, total.mul(40).div(100));
    }
