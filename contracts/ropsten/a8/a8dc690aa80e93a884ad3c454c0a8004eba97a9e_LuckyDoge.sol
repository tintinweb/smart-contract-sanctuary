...
contract Pausable is Ownable {
     ...
     */
    function Maintenance() onlyOwner whenNotPaused public {
      paused = true;
      emit Pause();
    }
...
contract LuckyDoge is Context, IERC20, Ownable, Pausable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x95cb5B922b287c9FED91FC88764F91c915301bD1); // Marketing Address
    ...
    string private _name = "LuckyDoge";
