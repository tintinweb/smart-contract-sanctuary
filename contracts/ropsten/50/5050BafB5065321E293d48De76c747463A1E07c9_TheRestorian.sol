...
contract TheRestorian is Context, Ownable, ERC165, IERC721Metadata, IERC721Enumerable {
    ...
    string public constant THE_RESTORIAN_PROVENANCE = "df760c771ad006eace0d705383b74158967e78c6e980b35f670249b5822c42e1";

    uint256 public constant SALE_START_TIMESTAMP = 1616119180;

    // Time after which TheRestorian are randomized and allotted
...
//    uint256 public constant MAX_NFT_SUPPLY = 4096;
    ...
    function getNFTPrice() public view returns (uint256) {
        require(minted < MAX_NFT_SUPPLY, "Sale has already ended");
    ...
    */
    function mintNFT(uint256 numberOfNfts) public payable {
        ...
        require(minted.add(numberOfNfts) <= MAX_NFT_SUPPLY, "Exceeds MAX_NFT_SUPPLY");
    ...
    function merge(uint firstId, uint secondId) external payable {
        ...
        require(minted == MAX_NFT_SUPPLY, "Game has not started");
        ...
        _burn(firstId);
        _burn(secondId);
        _safeMint(msg.sender, totalSupply(), currentLevel++);
    }
