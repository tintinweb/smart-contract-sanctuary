...
contract InvoluteDownwardAuction {
    ...
    // Events
    event AuctionStarted(uint auctionId, uint auctionChecksum, uint endTime, uint minDecrease);
    ...
    function createAuction(uint _auctionId, uint _auctionChecksum, uint _biddingTime, uint _minDecrease) public {
    ...
    function getLiveAuction(uint _auctionId) public view returns (uint, uint, uint, uint){
