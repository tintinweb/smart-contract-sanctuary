...
import {BulletLoans} from "BulletLoans.sol";
import {ProtocolConfig} from "ProtocolConfig.sol";
import {BP} from "BP.sol";

string constant DEPOSIT_MESSAGE = "deposit message";

contract ManagedPortfolioFactory {
    BulletLoans public bulletLoans;
    ProtocolConfig public protocolConfig;
    ManagedPortfolio[] public portfolios;

    event PortfolioCreated(ManagedPortfolio newPortfolio, address manager);

    constructor(BulletLoans _bulletLoans, ProtocolConfig _protocolConfig) public {
        bulletLoans = _bulletLoans;
        protocolConfig = _protocolConfig;
    }
    ...
    function getPortfolios() public view returns (ManagedPortfolio[] memory) {
        return portfolios;
    }
}