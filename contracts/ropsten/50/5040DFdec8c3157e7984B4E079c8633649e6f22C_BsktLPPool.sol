...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 public BSKTASREWARD = IERC20(0xA64f44993AdBaC9b47A527770F2A657c2194F565);  // Approve and Transfer for Stake and Withdraw
...
contract BsktLPPool is LPTokenWrapper {
    IERC20 public STAKEBSKT = IERC20(0xA64f44993AdBaC9b47A527770F2A657c2194F565); // BSKT TOKEN ADDRESS
    
    uint256 public duration = 60;              //-----| Pool Duration |-----       
