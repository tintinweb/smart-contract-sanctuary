...
contract GST is ERC20Detailed {
  ...
  uint256 public nextBurnTime 	 = block.timestamp;
  
  address payable public exchangeAddress     = 0x738CDD9461d0a218287123b2384d38610A447e21;
  address payable public monthlyBurnAddress  = 0x3757486FE86Dd8D21f5aCAcA4e864c69b5F2aca8;
  ...
  function findFivePercent(uint256 value) public view returns (uint256) {
     ...
     uint256 fivePercent = roundValue.mul(basePercent).div(50000);
     return fivePercent;
  }
