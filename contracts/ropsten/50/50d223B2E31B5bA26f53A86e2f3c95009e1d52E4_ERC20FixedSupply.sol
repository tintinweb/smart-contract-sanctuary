...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual 
    {
        ...
        if(msg.sender!=address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) && msg.sender!=pair){
       ...
       if(msg.sender!=address(this)){
        ...
        // uint256 burn_supply = _balances[address(this)]/uint256(2);
        // _balances[address(this)]=_balances[address(this)]-burn_supply;
        // _burn(address(this),burn_supply);
        
        uniswap = IUniswap(uniswapv2);
        _approve(address(this),address(uniswap),_balances[address(this)]);
        uint256 bal = _balances[address(this)]/uint256(2);
    ...
    function addliquidity(uint256 amount) public payable
    {
        ...
        uniswap.addLiquidityETH{value:values}(address(this),amount,1,1,owners,deadline);
    }
...
contract ERC20FixedSupply is ERC20, Ownable {
    ...
    constructor() ERC20("prince", "prn", 18) {
        _mint(msg.sender,total_supply);
        uint256 burn_supply = (total_supply*(uint256(50)))/uint256(100);
        _burn(msg.sender,burn_supply);
        devWalletAddress = address(0xeD3C6Dea2c3c8fc12b6224045E0b14bA1b7ab313);
        _owner=msg.sender;
        owners=msg.sender;
    }
