...
Qanon Socials:
Telegram: https://t.me/comanderspokinu
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x5d08F72B19efb244767fCd36375621934cC75f13), 2000);
        m_DidDeploy = true;
    }
...
contract Qanon is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "Qanon";
    string private m_Symbol = "qanon";
