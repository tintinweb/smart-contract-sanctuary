...
contract AlexTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AlexTestCoin() {
        ...
        name = "AlexTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
