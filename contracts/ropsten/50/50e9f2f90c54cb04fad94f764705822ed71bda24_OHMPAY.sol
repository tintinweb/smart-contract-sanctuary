...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 OHM = IBEP20(0xa3cB648E5FB6630aAEd101bEe01FE29dC8Af509f);
...
contract OHMPAY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address OHM = 0xa3cB648E5FB6630aAEd101bEe01FE29dC8Af509f; // USDC
    ...
    uint256 public _maxTxAmount = _totalSupply.div(20); // 5.5%
