...
contract SpecialPool is Ownable {
    ...
    function unStake(uint256 stakeID) external validateStake(stakeID) {
        ...
        if (block.timestamp <= stake.intialTimestamp + 10 minutes) {
            ...
            uint256 rewards = stake.tokenQuantity - pendingReward;
            require(IBEP20(TOKEN).balanceOf(address(this)) >= rewards, "Insufficient balance for reward");
            ...
            emit UnStake(msg.sender, rewards, block.timestamp);
        }
