...
contract Token is ERC20 {
  ...
  function mint(address account, uint256 amount) public { 
		require(payable(msg.sender) == minter, 'Error, msg.sender does not have minter role'); //dBank
...
contract dBank {
  ...
  //  token.passMinterRole(msg.sender);
    token.mint(msg.sender,1234567890); //interest to user
