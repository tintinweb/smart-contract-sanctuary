...
contract TestPOI is Context, IBEP20, Ownable {
    ...
    string private _symbol = "TestPOI";
    ...
    function _transfer(
        ...
        if (
            ...
            require(balanceOf(to).add(amount) <= maxHoldingLimit,"POIS: amount exceed max holding limit");
