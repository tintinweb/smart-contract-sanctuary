...
library UniswapV2Library {
    ...
    // hex"9ffddf09ccfd47b30be400245472aa0039a20ad1934ea4bee5ada41e0b8a6aa4" // init code hash local test
    // hex"94c35ca57507bf0f70af3163dbc8cd649dba1d517c737a855ef1e7429120ae1a" // init code hash test net
    // hex"fea293c909d87cd4153593f077b76bb7e94340200f4ee84211ae8e4f9bd7ffdf" // init code hash from Bien - failed
    // hex"d0d4c4cd0848c93cb4fd1f498d7013ee6bfb25783ea21593d5834f5d250ece66" // init code hash from indexer - failed
    function pairFor(
        address factory,
        address tokenA,
        address tokenB
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f" //init code hash test net uniswap v2
                        )
                    )
                )
            )
