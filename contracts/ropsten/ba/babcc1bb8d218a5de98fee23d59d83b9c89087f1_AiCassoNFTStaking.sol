...
contract AiCassoNFTStaking is Ownable, IAiCassoNFTStaking {
    ...
    function stake(uint256 _tokenId, address _owner) external override onlyParent {
        _stake(_msgSender(), _tokenId);
    }
