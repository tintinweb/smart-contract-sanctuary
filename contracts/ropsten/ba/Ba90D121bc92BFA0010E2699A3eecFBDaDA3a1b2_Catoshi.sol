...
contract Catoshi is Context, IERC20, Ownable {
    ...
    address public _bridgeFeesAddress = address(0x7929742c134d28e6D11c76640aa6Ed42dFD3B04e);
    address public _swapContractAddress;
    
     
     address private _uni = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // uniswapV2Router on ropsten
    ...
    function _transfer(address sender, address recipient, uint256 amount) private  {
        ...
        bool useRFI;
        if(recipient == uniswapV2Pair || sender == _swapContractAddress) {
            useRFI = false;
        }
        else {
            useRFI = true;
