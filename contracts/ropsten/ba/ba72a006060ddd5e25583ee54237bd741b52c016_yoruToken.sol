...
contract yoruToken {
    ...
    constructor()    {
        ...
        balanceOf[msg.sender] = totalSupply/4;                // Give the creator the half of initial tokens
        meltedTokens = 3*(totalSupply/4);                       // The other half is given to the 
