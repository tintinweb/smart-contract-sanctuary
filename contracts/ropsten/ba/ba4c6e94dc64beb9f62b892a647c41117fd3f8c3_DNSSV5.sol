...
contract DNSSV5 is MintableToken, BurnableToken, Blacklisted {
    ...
    */
    ...
    function DNSSV5() {
        ...
        name = "DNSSV5 TOKEN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DNSSV5";                                             // Set the symbol for display purposes (CHANGE THIS)
