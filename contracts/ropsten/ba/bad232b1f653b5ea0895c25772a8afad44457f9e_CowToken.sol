...
// File: contracts/CowToken.sol

/// @title CowToken Contract
/// For more information about this token sale, please visit https://Cow.pro
/// @author reedhong
contract CowToken is PausableToken {
    using SafeMath for uint;

    /// Constant token specific fields
    string public constant name = "CowToken";
    string public constant symbol = "Cow";
    uint public constant decimals = 18;

    /// Cow total tokens supply
     ...
     * CONSTRUCTOR
     *
     * @dev Initialize the Cow Token
     * @param _minter The CowCrowdSale Contract
     * @param _maxTotalSupply total supply token
     */
    function CowToken(address _minter, address _admin, uint _maxTotalSupply)
    public
    validAddress(_admin)
     ...
     * EXTERNAL FUNCTION
     *
     * @dev CowCrowdSale contract instance mint token
