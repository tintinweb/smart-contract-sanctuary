...
contract KCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KCoin() {
        ...
        name = "KCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-025";                                             // Set the symbol for display purposes (CHANGE THIS)
