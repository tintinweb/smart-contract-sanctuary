...
contract SwapETHOptimal is ReentrancyGuard{
        ...
        nonReentrant
    {
        ...
        uint256 left=0;
        {
            ...
            uint256 amountOutMin=swapAmt.mul(97).div(100).mul(bidReserve).div(wethReserve);
            uint[] memory am=router.swapExactTokensForTokens(swapAmt, amountOutMin, path, address(this), now);
            uint256 nbid=am[1];
 ...
 //   address _pool
  ...
  //    bonusPool=_pool;
        ...
        external
    {
        ...
        IERC20(lptoken).safeTransfer(bonusPool,balance);
