...
contract AAA is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public charityAddress = 0x7D0bd3C748040A624F8d030166702147364Ae3AF;
    ...
    // Innovation for protocol by AAA Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own AAA to claim reward');
