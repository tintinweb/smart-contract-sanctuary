...
contract Gralaxious is ERC20 {
    ...
    string public constant name = "Gralaxious";
    ...
    uint256 public constant minContribution = 1 ether / 100; // 0.001 Eth
