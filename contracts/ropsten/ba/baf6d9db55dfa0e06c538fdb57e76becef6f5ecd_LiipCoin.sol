...
contract ERC20Interface {
    ...
    function transfer(address to, uint tokens) public returns (bool success); //Tranfers a number of tokens directly from the message sender to another address
...
// token transfers
// ----------------------------------------------------------------------------
contract LiipCoin is ERC20Interface, Owned, SafeMath {
