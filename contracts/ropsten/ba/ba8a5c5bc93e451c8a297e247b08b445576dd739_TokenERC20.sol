...
function TokenERC20(uint256 initialSupply, string tokenName, string tokenSymbol, uint8 tokendecimals, uint tokenPrice, bool allowManualTokensGeneration) public {
...
function mint() payable external {
        require(msg.value > 0 && msg.value/10**18 >= _tokenPrice);
