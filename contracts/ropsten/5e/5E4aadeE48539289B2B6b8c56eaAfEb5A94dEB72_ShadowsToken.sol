    ...
    ERC20PausableUpgradeable
{
    ...
    uint256 constant releaseTime = 1614533400;
    ...
    function initialize() external initializer {
        ...
        // _mint(address(0), 2000000000000000000000000);
        // _mint(address(0), 2000000000000000000000000);
        // _mint(address(0), 63000000000000000000000000);
        ...
        vestingTypes.push(
            VestingType(416e16, 0, 300 minutes, false, true)
        ...
        returns (uint256)
    {
        ...
        uint256 months = diff.div(30 minutes).add(delay);
