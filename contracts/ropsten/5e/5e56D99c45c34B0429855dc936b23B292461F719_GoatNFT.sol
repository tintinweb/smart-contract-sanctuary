...
contract GoatNFT is ERC1155, Ownable{
	...
	event LogCreate(address indexed creator, uint256 indexed id, uint256 totalSupply, uint256 tokenType, string uri, bytes data);
		...
		returns (uint256) 
	{
		...
		emit LogCreate(msg.sender, _id, _totalSupply, _tokenType, _uri, _data);
