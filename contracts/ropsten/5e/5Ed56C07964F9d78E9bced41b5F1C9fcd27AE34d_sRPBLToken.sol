...
contract sRPBLToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked RPBL", "sRPBL", 9) ERC20Permit() {
    ...
    /**
        @notice increases sRPBL supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sRPBL
