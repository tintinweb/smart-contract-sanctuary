...
require(msg.sender != owner,"This address belongs to Owner.");
uint userBalance;
...
emit Transfer(owner,careFund,careFundAmount);
 ...
 function isStakeholder(address _address)
   ...
   function addStakeholder(address _stakeholder)
       public
   {    require(_stakeholder != owner && _stakeholder != careFund && _stakeholder != luckFund, "This address belongs to Internal.");
   ...
   function calculateInterest(address _stakeholder)
       ...
       returns(uint256)
   {
           uint256 daysSinceLastCollect = ((block.timestamp - (lastCollectionTime) ) /  1 days);
