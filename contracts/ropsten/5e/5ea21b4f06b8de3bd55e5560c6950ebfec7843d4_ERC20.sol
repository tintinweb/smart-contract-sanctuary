...
abstract contract Pausable is Context {
     ...
     * - The contract must not be paused.
     */
    function _pause(address account) internal virtual whenNotPaused {
        _paused = true;
        emit Paused(account);
    }
     ...
     * - The contract must be paused.
     */
    function _unpause(address account) internal virtual whenPaused {
        _paused = false;
...
contract ERC20 is Context, IERC20, IERC20Metadata, Pausable {
     ...
     */
    function pauseContract(address account) public virtual {
        _pause(account);
    }
     ...
     * See {ERC20Pausable-_pause}.
     */
    function unPauseContract(address account) public virtual {
        _unpause(account);
    }
