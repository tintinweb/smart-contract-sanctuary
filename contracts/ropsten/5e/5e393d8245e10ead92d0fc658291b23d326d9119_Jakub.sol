...
Twitter:
https://twitter.com/GogetaInu

Reddit:
https://www.reddit.com/user/GogetaInuETH/
...
contract Jakub is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Jakub Inu";
    string private constant _symbol = "JakubETA";
    ...
    address payable private _developmentAddress =
        payable(0x1E34a5860a88d6997903BdF322Cb8494BAC0d61c);
    address payable private _marketingAddress =
        payable(0xd57357c2c52781ac85E594Fe28b4F3457AFCdb7e);
