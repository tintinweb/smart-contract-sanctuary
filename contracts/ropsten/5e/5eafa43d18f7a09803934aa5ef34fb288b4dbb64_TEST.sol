...
contract TEST {
    ...
    function getExitFee() public view returns (uint8) {
        ...
        if (tsupply <= 1e18) { 
            ...
            return exitFee_; // 2% with a token supply of over 1000
        }
    }
