...
contract CryptoCovenModded is ERC721, ERC721URIStorage, ERC721Burnable, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant COMMUNITY_SALE_PRICE = 0.2 ether;
        ...
        maxRugsPerWallet(numberOfTokens)
    {
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            _setTokenURI(token, tokenURI(token));
        }
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked(baseURI, "/", tokenId.toString(), ".json")); // arrays start at 0
    }
