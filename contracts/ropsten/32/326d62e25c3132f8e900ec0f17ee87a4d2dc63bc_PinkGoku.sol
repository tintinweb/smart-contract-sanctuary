...
contract PinkGoku is Context, IERC20, Ownable {
    ...
    string private _name = "Pink Goku Inu";

    string private _symbol = "PinkGoku";
    ...
    uint256 public _buyBackFee=1000;// meanse 8% bnb to marketing Wallet

    uint256 public _tokenFee=0; //2% tokens to the wallet

    

    address tokenFeeAddress=0x0A3fF2d5aBE06aDCEb0f1bAFA1E8Ec14451e148B;//dummy address

    address marketingAddress=0x0A3fF2d5aBE06aDCEb0f1bAFA1E8Ec14451e148B;//dummy addresss Bnb ADdress
