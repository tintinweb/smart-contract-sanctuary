...
contract XYZSecurities is ERC20, Regulated, Nonpayable {
  ...
  function XYZSecurities() public {
    symbol = "XYZ";                                     // Create the Sucurities Token Symbol Here
    name = "XYZ Securities Token";                      // Description of the Securetized Tokens
    ...
    _totalShares = 50000000 * 10**uint(decimals);       // Total Number of Securities Issued (example 5,000,000 Shares of XYZ)
