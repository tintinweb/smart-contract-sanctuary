...
contract ACF is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public whitelistReserved = 4000;
    ...
    function addWhitelist(address _address) public onlyOwner {
        require(whitelist[_address] != true, "The address is already on the list");
