...
contract Evoai {
  ...
  // set initial fee
  function setETHFee(uint256 amount) onlyOwner() public {
    feeETH = amount;
  }
  
  // set initial token fee
  function setTokenFee(uint256 amount) onlyOwner() public {
    feeEVOT = amount;
  }
  
  //change the admin account
  function changeAdmin(address admin_) onlyOwner() public {
    admin = admin_;
  }

  // change the ether fee
  function changeFeeETH(uint256 feeETH_) onlyOwner() public {
    feeETH = feeETH_;
  }

  // change the token fee
  function changeFeeEVOT(uint256 feeEVOT_) onlyOwner() public {
    feeEVOT = feeEVOT_;
  }
  ...
  // withdraw ether fee
  function feeWithdrawEthAmount(uint256 amount) onlyOwner() public {
  ...
  function feeWithdrawEthAll() onlyOwner() public {
  ...
  // withdraw token fee
  function feeWithdrawTokenAmount(address token, uint256 amount) onlyOwner() public {
  ...
  function feeWithdrawTokenAll(address token) onlyOwner() public {
