...
contract KingToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "King Token";
    string private constant _symbol = "KingToken";
    ...
    constructor () {
        _feeAddrMarketing = payable(0x62C6d2B0599ef204af36EaddE896161FCE21a61E);
        _feeAddrTeam = payable(0x62C6d2B0599ef204af36EaddE896161FCE21a61E);
