...
contract BsktLPPool is LPTokenWrapper {
    ...
    uint256 public duration = 1 days;     //-----| Pool Duration |-----       
    ...
    function earned(address account) public view returns (uint256) {
        ...
        // manage 2% token difference
        return earnedToken.sub(earnedToken.mul(20).div(20)) > 0  ? earnedToken.sub(earnedToken.mul(20).div(20)) : 0;
