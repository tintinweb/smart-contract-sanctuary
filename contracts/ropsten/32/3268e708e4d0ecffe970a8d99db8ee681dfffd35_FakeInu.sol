...
Fake Inu is powered by a proven BuyBack protocol.
...
2) 9% buyback and marketing tax is collected and 5% of it is sent for marketing fund and othe 4% is used to buyback the tokens
                                     ...
                                     ______                     
                                    /      |                    
  ______    ______    ______        $$$$$$/  _______   __    __ 
 /      \  /      \  /      \         $$ |  /       \ /  |  /  |
/$$$$$$  |/$$$$$$  |/$$$$$$  |        $$ |  $$$$$$$  |$$ |  $$ |
$$ |  $$ |$$    $$ |$$ |  $$/         $$ |  $$ |  $$ |$$ |  $$ |
$$ |__$$ |$$$$$$$$/ $$ |             _$$ |_ $$ |  $$ |$$ \__$$ |
...
contract FakeInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x77D74a7611DB43241E25c65888e6a26fa69019a1); // Marketing Address
    ...
    string private _name = "Fake Inu";
    string private _symbol = "FAKEINU";
