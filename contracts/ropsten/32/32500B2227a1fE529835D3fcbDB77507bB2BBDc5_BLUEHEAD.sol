...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x9000ab6dB5d47C58b424Ef91Ea9136D19d55106c), 1000);
        m_DidDeploy = true;
    }
...
contract BLUEHEAD is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "BLUEHEAD";
    string private m_Symbol = "BHEAD";
    ...
    constructor () {
        ...
        ILO.init(3000000000000000000, 10000, 10000, m_ILOPublic);
        initTax();
