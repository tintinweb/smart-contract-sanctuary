...
interface IUniswapV2Pair {
    ...
    function jijiMUM_LIQUIDITY() external pure returns (uint);
...
contract jijiCoin is Context, IERC20, Ownable {
    ...
    string private _name = "jiji Coin";
    string private _symbol = "jijiCoin";
