...
contract CrazyInu is Context, IERC20, Ownable {
    ...
    //20 000 000 000 000
    uint256 public _maxTxAmount = _tTotal.div(1).div(50); //100
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0x33A503C72296725CcA93bbBC81d6F085c486F51b);
