...
library SafeMath {
     ...
     * message unnecessarily. For custom revert Reason provided by the contract: "SafeERC20s use {trySub}.
     *
     * Counterpart to Solidity's `-` operator.
     *
     * Requirements:
...
contract NftContract is ERC721, Ownable {
    ...
    uint256 public constant nftPrice = 800000000000000; //0.08 ETH
