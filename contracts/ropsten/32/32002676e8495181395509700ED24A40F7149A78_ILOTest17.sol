...
contract ILOTest17 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOTest17";
    string private m_Symbol = "ILO17";
    ...
    bool private m_ILOPublic = false;
    // MISC
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 2000, 1000, m_ILOPublic);
        initTax();
