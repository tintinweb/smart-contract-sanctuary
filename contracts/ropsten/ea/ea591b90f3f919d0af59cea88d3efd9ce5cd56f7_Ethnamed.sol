...
contract Issuer {
    ...
    address internal issuer = 0xad69f2ffd7d7b3e82605f5fe80acc9152929f283;
...
contract DEX is ERC20 {
    ...
    function salers(uint index) public view returns (address) {
    ...
    function addSaler(address item) private {
    ...
    function removeSaler(address item) private {
