...
contract BookStore is Ownable {
    LibraryToken private token;
    ETHWrapper private wrapper;
    
    constructor(address payable ETHWrapperAddress, address payable LIBTokenAddress) public {
        wrapper = ETHWrapper(ETHWrapperAddress);
        token = LibraryToken(LIBTokenAddress);
    }
