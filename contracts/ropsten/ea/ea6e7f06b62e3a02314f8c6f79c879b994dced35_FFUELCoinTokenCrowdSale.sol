...
contract FFUELCoinTokenCrowdSale is FinalizableCrowdsale {
    ...
    **/
    ...
    function buyTokens(address beneficiary) public payable {
        ...
        uint256 contributorGet = tokens.mul(contributor_get).div(100);
...
//
        runPreMint(0xA442c1B21012270F9DB3496d3334CeB1cf857929,37500000000000000000000000);  // preSale
        runPreMint(0xdD082C6DfC4f895647CA5077f7736752825A0b11,50000000000000000000000000);  // reserved
        runPreMint(0x7d29a3f6d65EFfb3F7e9C67dd49B396d00f50A16,5000000000000000000000000);   // bounty
        runPreMint(0x24c1eD87Dfb152d89D45F7A6899b35DBA8aC1c62,5000000000000000000000000);   // team
        runPreMint(0x021837f30455F53Ab75E4075e4248D7e45966D88,5000000000000000000000000);   // advisors
