...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private _MyPetProTest;
    string private _MPPT;
     ...
     * construction.
     */
    constructor(string memory MyPetProTest_, string memory MPPT_) {
        _MyPetProTest = MyPetProTest_;
        _MPPT = MPPT_;
...
/**
 * @dev Contract for MyPetProTest token
 */
contract MyPetProTest is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 1_000_000_000e18;

    constructor() ERC20("MyPetProTest", "MPPT") {
    ...
    function addInvestorLock(
        ...
        _addInvestorLock(account, amount, startsAt, period, count);
    }
