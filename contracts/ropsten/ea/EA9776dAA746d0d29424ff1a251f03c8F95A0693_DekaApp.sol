...
contract Pool is PoolERC20, IPool {
    ...
    address public constant DEKA_TOKEN = 0x992d63281EbF61061fd79623F294d0F0296BeF81;
    address public constant DEKA_PROTOCOL = 0x88629f11e22861043B2E701207a19Aeb743562F9;
    ...
    function getLPFee() public view returns (uint256) {
        uint256 fpy = IDekaProtocol(DEKA_PROTOCOL).getFPY(0);
...
contract PoolERC20 is IERC20 {
    ...
    // bytes32 private constant NAME_HASH = keccak256("DEKA-ALT-LP")
    bytes32 private constant NAME_HASH = 0x28e5b4ede899ece85c7604592998bd023f73e10e1cb161de93d0baa68eb3aed8;
    ...
    string public constant name = "DEKA-ALT-LP";
