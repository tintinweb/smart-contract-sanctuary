...
contract SAFEGEO is Context, IERC20, Ownable {
    ...
    string private _name = "Safe Geo";
    string private _symbol = "SAFEGEO";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 8; //(5% liquidityAddition + 1% rewardsDistribution + 1% devExpenses)
