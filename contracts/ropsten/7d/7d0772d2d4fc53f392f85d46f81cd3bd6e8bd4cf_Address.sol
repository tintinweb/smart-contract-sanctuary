...
╰╯╰╯╰┻━━━╯╱╰╯╱╰╯╱╰╯╰╯╱╱╰━━━╯╱╰╯╱╱╰━━━┻╯╱╰┻╯╱╰┻━━┻╯╱╰━╯
Meta Pet Chain: $MPC
-You buy on BSC, we farm on multiple chains and return the profits to $MPC holders.
...
contract MetaPetChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Meta Pet Chain (Metapetchain.com)";
    ...
    address public farmAndBuybackWallet = 0x721b70301cd16140f67570123a493323Ba1F4cFA;
    address public marketingWallet = 0x973fab1b8560EaD1DCE89476638a9348aFEe2963;
    address public devWallet = 0x27835F5e5c63d20469E2a4828ABA337fEF917c37;
