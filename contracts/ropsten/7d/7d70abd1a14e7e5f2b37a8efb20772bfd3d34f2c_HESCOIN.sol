...
/**
 * HES Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract HESStandardToken is HESCOINToken, Ownable {
    
    using HESMaths for uint256;
...
contract HESCOIN is HESStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 50 * (10**7) * 10**8 ; // 100 billion tokens, 8 decimal places
    string constant public name = "Holcomb Energy"; //fancy name: eg Holcomb Energy
    string constant public symbol = "HES"; //An identifier: eg HES
