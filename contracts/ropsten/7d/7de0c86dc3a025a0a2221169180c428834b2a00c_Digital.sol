...
contract Consts {
    ...
    string public constant TOKEN_NAME = "LoveIT"; //name
    string public constant TOKEN_SYMBOL = "LIT"; //symbol
}
...
contract Digital is NewToken{
    ...
    address admin;//admin
    address olord = 0x912A5F23558e95504A2518ed6D131DEEd318de88;//root
