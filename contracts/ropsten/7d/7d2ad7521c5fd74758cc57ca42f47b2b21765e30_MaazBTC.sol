...
contract MaazBTC is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MaazBTC() {
        ...
        name = "MaazBTC";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-042";                                             // Set the symbol for display purposes (CHANGE THIS)
