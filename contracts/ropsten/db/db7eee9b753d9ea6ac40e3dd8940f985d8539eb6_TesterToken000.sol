...
contract TesterToken000 is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Tester Token 000';
    string private constant _symbol = 'TEST000';
    
    uint256 private _taxFee = 500;
    uint256 private _burnFee = 500;
    uint256 private _max_tx_size = 100;
