...
contract CrackCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Crack Coin 420";
    string private constant _symbol = "CRCK420";
