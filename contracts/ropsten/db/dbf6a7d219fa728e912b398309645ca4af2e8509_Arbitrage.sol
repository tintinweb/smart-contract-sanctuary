...
contract Arbitrage is Ownable {
    ...
    function behodlerToUni(uint256 expectETH, uint deadline) public payable onlyOwner {
        ...
        uniRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(scxAmountAfterBurn, expectETH, path, msg.sender, deadline);
    }
    ...
    function uniToBehodler(uint256 expectETH, uint deadline) public payable onlyOwner {
        ...
        path[1] = _behodler;
        uniRouter.swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(0, path, address(this), deadline);
