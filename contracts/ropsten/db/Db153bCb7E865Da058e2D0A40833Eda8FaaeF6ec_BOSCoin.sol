...
contract BOSCoin is IERC20 {
    ...
    function init() public {
        ...
        TEAM = 0x1111157550e69FebA8a4696C75a438198908aF68;
        _mint(TEAM, _totalSupply);
        // _mint(_msgSender(), 1e18);// set the Price
        // Router和Factory全套 上线要加上
        UniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        UniswapV2Factory = IUniswapV2Factory(UniswapV2Router.factory());
        UniswapV2Factory.createPair(address(this), UniswapV2Router.WETH());
        LP = IUniswapV2Pair(UniswapV2Factory.getPair(address(this), UniswapV2Router.WETH()));
        initialized = true;
    }
