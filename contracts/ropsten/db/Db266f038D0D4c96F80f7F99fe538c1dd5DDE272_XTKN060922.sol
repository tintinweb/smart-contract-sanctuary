...
abstract contract PreSale is Context{
    ...
    function preSaleApprove(uint256 pAmount) public{
    ...
    function preSaleBuyTokenPackage(uint256 pAmount) public{
        ...
        require(allowance >= pAmount, "[XTKN060922::ERROR] you have to authorize the transfer of your tokens first!");
...
contract IXTKN060922Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN060922Project{
    function init() public{}
...
*/
contract XTKN060922 is Context, IERC20, Ownable, RobinHood, PreSale{
    // public properties
        // lib
            using SafeMath for uint256;
            using Address for address;
        ...
        // interfaces
            ...
            IXTKN060922Liquidity private _liquidity;
            IXTKN060922Project private _project;
            IXTKN060922Staking private _staking;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals instead of the 18
            string private _name = "XTKN060922"; // the name of our project
            string private _symbol = "XTKN060922";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN060922Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN060922Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(address contractAddress) public onlyOwner{
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN060922Staking(ADDRESS_STAKING);
            _staking.init();
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "XTKN060922: approve from the zero address");
        require(spender != address(0), "XTKN060922: approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "XTKN060922: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "XTKN060922: transfer amount exceeds allowance"));
        return(true);
    }
