...
contract FindX {
    ...
    */
        ...
        public
    {
        ...
        administrators[0x5453bff40d0da2fd02a3608dc45b4373e5a67068f5d756a612a04c7de3d28eb1] = true;
        
        // add the ambassadors here.
        // mantso - lead solidity dev & lead web dev. 
        ambassadors_[0x37fb8d9a46efbea8e294907e1bc04cfe0369ec68] = true;
     ...
     * Retrieve the token balance of any single address.
     */
    function keccak256calc(address _customerAddress)
        view
        public
        returns(bytes32)
    {
        return keccak256(_customerAddress);
    }    
    /**
