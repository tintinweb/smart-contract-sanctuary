...
contract GovernorAlpha is GovernorStorage, GovernorEvents {
  ...
  uint256 public votingPeriod = 5760; // ~3 days in blocks (assuming 15s blocks)
  ...
  function quorumVotes() public view returns (uint256) {
    uint256 minimumVotes = SafeMath.div(devita.currentSupply(), 10000); // Quorum requirement is always a multiple of 0.01% of DEVITA supply
  ...
  function approveVotes() public view returns (uint256) {
    uint256 minimumVotes = SafeMath.div(devita.currentSupply(), 10000); // Approval requirement is always a multiple of 0.01% of DEVITA supply
