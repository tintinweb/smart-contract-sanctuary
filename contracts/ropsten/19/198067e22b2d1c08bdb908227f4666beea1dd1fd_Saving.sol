...
contract Saving is TokenWraper {
    ...
    function _rewardEarnedPerSecond(address account) public view returns(uint256) {
        ...
        uint256 _reward = _expectedRewardYearly.div(_yearly);
        return _reward;
    }
    ...
    function rewardEarned(address account) public view returns(uint256) {
        ...
        uint256 _rewardEarned = _rewardPerSecond.mul(_rangeTime);
    ...
    function getReward() public {
        require(rewardEarned(msg.sender) == 0, "Doesn't have a reward.");
