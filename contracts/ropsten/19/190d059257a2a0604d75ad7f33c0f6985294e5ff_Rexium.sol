...
contract Rexium is Context, IERC20, Ownable {
    ...
    address tokenFeeAddress=0x70Eff610dD4Ee242a921D0331983f8DDbDdB0960;//dummy address
    address marketingAddress=0x23872e3Ed07361bE065D678D06d05CccaD8B5454;//dummy addresss Bnb 
    address liquidityAddress=0x70Eff610dD4Ee242a921D0331983f8DDbDdB0960;// dummy address  Bnb
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        payable(liquidityAddress).transfer(otherHalf);
    ...
    function setLiquidityAddress(address add) external onlyOwner {
        liquidityAddress=add;
    }
