...
// File: contracts/token/ERC1155/presets/ERC1155PresetMinterPauser.sol + setURI => WhoImNFT
 ...
 */
contract WhoImNFT is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    ...
    function setURI(string memory uri_) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "WhoImNFT: must have admin role to setURI");
    ...
    function mint(address to, uint256 id, uint256 amount, bytes memory data) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "WhoImNFT: must have minter role to mint");
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "WhoImNFT: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "WhoImNFT: must have pauser role to unpause");
        _unpause();
    }
