...
contract BunnyMembership is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl {
    ...
    uint [MAX_MEMBERSHIP_TYPES] private _membershipSupply = [1,1,1,1,1];                        // how many memberships, per type
    uint [MAX_MEMBERSHIP_TYPES] private _reservedSupply = [1,1,1,1,1];                         // howmant are available
    uint [MAX_MEMBERSHIP_TYPES] private _forSaleSupply = [1,1,1,1,1];                           // how many available for sale
    uint [MAX_MEMBERSHIP_TYPES] private _memebershipPrice = [1,1,1,1,1];                        // how much retail price
    ...
    */
    ...
    function configureMembership( uint _mType, uint _mSupply, uint _mReserved, uint _mPrice ) public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        require( _membershipSupply[_mType] != 1,    "Membership already configured" );
