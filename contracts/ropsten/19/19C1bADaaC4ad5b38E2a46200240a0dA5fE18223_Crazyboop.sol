...
contract Crazyboop is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint public max_mint_allowed = 30;
    //Price of one NFT in presale
    uint public pricePresale = 0.00001 ether;
    //Price of one NFT in sale
    uint public priceSale = 0.00002 ether;
    ...
    address[] private _team = [
        0x5950EE276cC49b6beb8E59Bd3789391709fe7206,
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("Crazyboop", "CZB") PaymentSplitter(_team, _teamShares) {
