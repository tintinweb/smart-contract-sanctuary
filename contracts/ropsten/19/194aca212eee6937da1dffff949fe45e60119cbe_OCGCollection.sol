...
library Address {
    ...
    function isValidContract(address account) internal view returns (bool) {
...
contract MinterRole is Context {
    ...
    constructor (address artist) internal {
        _addMinter(artist);
    }
...
contract ERC165 is IERC165 {
    ...
    uint256 interfaceRegistered;

    event MyInterfaceRegistered(bytes4 interfaceId);
    ...
    function _registerInterface(bytes4 interfaceId) internal {
        ...
        interfaceRegistered += 1;
    }

    function getRegisterCount() external view returns (uint256) {
...
contract ERC721EnumerableRoyalties is ERC165 {
    /*
...
contract OCGCollection is ERC721, ERC721Enumerable, ERC721MetadataMintable {
    constructor(
        address artist,
        string memory name,
        string memory symbol
    ) public ERC721Metadata(name, symbol) MinterRole(artist) {
        // solhint-disable-previous-line no-empty-blocks
    }
}