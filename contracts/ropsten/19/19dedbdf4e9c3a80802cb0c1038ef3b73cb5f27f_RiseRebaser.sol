...
contract RiseRebaser {
        ...
        public
    {
        ...
        if (positive) {
            require(Rise.RiseScalingFactor().mul(uint256(10**18).add(indexDelta)).div(10**18) < Rise.maxScalingFactor(), "new scaling factor will be too big");
        }
      ...
      function getPrice() public view returns (uint256) {
        ...
        uint RisePrice = ethReserve.mul(10**18).div(RiseReserve);
        return RisePrice;
    }
