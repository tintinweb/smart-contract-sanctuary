...
contract NFTStake is IERC1155Receiver {
    ...
    IERC20  roomToken = IERC20(0x49dc61732780785dEc733703637115A9401463f9);  // correct 0xAd4f86a25bbc20FfB751f2FAC312A0B4d8F88c64

    // todo: set the correct ROOM NFT
    IERC1155 NFTToken = IERC1155(0xe6cF27d2f3a05ce3dF5047Fb62bdB6b9D000f339);
    ...
    constructor () public {
        ...
        _finishBlock = blockNumber() + 1000000;
        _rewardPerBlock[0] = 1e18*1e18;
        _rewardPerBlock[1] = 2e18*1e18;
        _rewardPerBlock[2] = 3e18*1e18;
        _rewardPerBlock[3] = 4e18*1e18;
        _rewardPerBlock[4] = 5e18*1e18;
    ...
    function increaseBlockNumber(uint256 count) public{
        cBlock+=count;
    }
