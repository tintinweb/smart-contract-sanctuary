...
contract ReepTest is ERC20, REEPminting, Ownable {
    ...
    string public name = "Reep_Test";
    string public symbol = "REEPTEST";
...
//------------------------------------------------------------------------------------
    ...
    function maxTotalSupply() internal {
        ...
        //1st - 3rd year maximum supply is 20,000,000
        if((_now.sub(mintingStartTime)).div(1 years) == 0) {
        ...
        //4th - 6th year maximum supply is 40,000,000   
        } else if((_now.sub(mintingStartTime)).div(1 years) == 3) {
        ...
        //7th - 9th year maximum supply is 60,000,000 
        } else if((_now.sub(mintingStartTime)).div(1 years) == 6) {
        ...
        //10th - 12th year maximum supply is 80,000,000 
        } else if((_now.sub(mintingStartTime)).div(1 years) == 9) {
        ...
        //13th - end maximum supply is 100,000,000
        } else if((_now.sub(mintingStartTime)).div(1 years) == 12) {
            ...
            maxTotalSupply = 100000000 * (10**decimals);
        } else if(_now.sub(mintingStartTime) > 16 years) {
            maxTotalSupply = 100000000 * (10**decimals);
        }
    }
