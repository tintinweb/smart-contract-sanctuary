...
/**
* @title WrappedPLAYToken - Ethereum-bridged PLAY Token for Ethereum.
*
...
*/
contract WrappedPLAYToken is ERC20, ERC20Detailed {
  using SafeMath for uint256;

  address public lockProxyAddress;

  constructor(address _lockProxyAddress) ERC20Detailed("Ethereum-bridged PLAY Token", "ePLAY", 5) public {
    lockProxyAddress = _lockProxyAddress;
  }

  function _transfer(address sender, address recipient, uint256 amount) internal override {
      if (sender == lockProxyAddress) {
          require(recipient != lockProxyAddress, "WrappedPLAYToken: lockProxy should not call transfer to self");
