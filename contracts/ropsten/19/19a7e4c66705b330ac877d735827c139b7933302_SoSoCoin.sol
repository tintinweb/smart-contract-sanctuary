...
contract SoSoCoin is StandardToken { 
    ...
    */
    ...
    function SoSoCoin() {
        ...
        name = "SoSoCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SSC";                                             // Set the symbol for display purposes (CHANGE THIS)
