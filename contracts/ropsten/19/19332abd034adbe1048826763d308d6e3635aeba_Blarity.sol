...
contract Blarity {
  ...
  function donateToken(KyberNetworkProxyInterface network, ERC20 src, uint srcAmount, uint maxDestAmount, uint minConversionRate, address walletId) payable public {
    bytes memory hint;
