...
contract AfroFuturism is ERC721Enumerable, Ownable{
    ...
    uint private MAX_TOKEN_SUPPLY = 100;
    uint256 private max_BulkTokenCount = 30;
    uint256 private reservedPeriod = 60;               // 30 days
    ...
    constructor() ERC721
        ("AfroFuturism", "AF") 
    {
//      _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmegkvuVRpmC8LXop4vxokYhXA2Nch9fEMJbLvqGd8bG2W/Vision";
