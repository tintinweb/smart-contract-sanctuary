...
contract Party is Ownable {
    ...
    event WithdrawEvent(address userAddress, uint256 weight, address partyAddress, uint256 amount, uint256 cut, uint256 penalty);
     ...
     * //WORK IN PROGRESS
     * TODO: Change for loop to swapplaceholder & test it
     */
    function withdraw(address partyAddress,uint256 weight, uint256 amount, uint256 n, SwapWithoutRSV[] memory tokenData, bytes32 r, bytes32 s, uint8 v) external payable isAlive onlyMember {
        ...
        emit WithdrawEvent(msg.sender, weight, partyAddress, amount, cut, penalty);
    }
     ...
     * TODO: Add onlyMember modifier
     */
    function deposit(address partyAddress, uint256 amount) external onlyMember isAlive {
