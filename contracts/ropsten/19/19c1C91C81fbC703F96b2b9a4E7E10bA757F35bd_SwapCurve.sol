...
contract SwapCurve is ISwapper, Initializable, AccessControlUpgradeable {
    ...
    function swapToken(
        ...
        IERC20Upgradeable(_from).transferFrom(
            _msgSender(),
            address(this),
            _amount
        );
        ...
        uint256 balanceTokenTo = IERC20Upgradeable(_to).balanceOf(
            address(this)
        );

        IERC20Upgradeable(_to).transfer(_msgSender(), balanceTokenTo);
    }
