...
// File: contracts/CloudPhoenixNFT.sol
...
contract testmoney2NFT is NFTokenMetadata, Ownable {
 
  constructor() {
    nftName = "YOOOOOO";
    nftSymbol = "Tesssstttttt";
  }
  
  uint256 public MINT_COST = 0.1 ether;
 
  function mint(uint256 _tokenId, string calldata _uri) external payable {
    
    require(msg.value >= MINT_COST, "you broke boiiii");
