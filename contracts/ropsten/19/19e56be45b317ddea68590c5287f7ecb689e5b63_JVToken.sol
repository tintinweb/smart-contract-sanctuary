...
contract JVToken is StandardToken {
  ...
  function JVToken(address _privatesale_beneficiary, address _projectoperation_beneficiary, address _team_and_angel_beneficiary, uint256 _releaseTime) public {
