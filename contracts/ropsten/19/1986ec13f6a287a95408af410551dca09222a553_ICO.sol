...
contract ICO is ERC20{
    ...
    uint initialRate = 10**16;  // rate is scaled by 10**18;
    uint public CureentRate;
    uint  totalTokenSupply = 100*10**24;
    uint Token = totalTokenSupply / 100*10**24;
  ...
  receive() external payable {
    ...
    function changeRate(uint _Ratefactor) external returns(uint) {
   ...
   */
  function buyTokenFirst(address buyer, uint _tokensToBuy) public payable {
  ...
  function buyTokenSecond(address buyer, uint _tokensToBuy) public payable{
  ...
  function buyTokenFinal(address buyer, uint _tokensToBuy) public payable{
