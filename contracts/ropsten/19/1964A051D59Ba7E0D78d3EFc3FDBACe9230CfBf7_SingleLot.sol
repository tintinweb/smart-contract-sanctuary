 ...
 * @author Akshat Chhajer, Shivansh Seth, Istasis Mishra
  * @dev A smart contract to manage lots for Parallel
 */
contract SingleLot is Ownable {
     ...
     * @param _priceFeed Address of chainlink pricefeed to get prices
     * @param _collateralToken Address of the token to be used as the collateral
     * @param _feePercentage Percentage of platform fee
    */ 
    constructor(
        address _priceFeed,
    ...
    /**
     * @dev Utility to calculate min of 2 values
    */
    ...
    /**
     * @dev Utility to abs of an integer
    */
    ...
    */
    ...
    /**
     * @dev To be called to create a lot
     * @param _tokenA name of first token
     * @param _tokenB name of second token
     * @param _size size of the lot
     * @param _duration duration in seconds of the lot
     * @param _expireEpoch epoch when the lot will expire
    */
    function createLot(
    ...
    /**
     * @dev to be called to join an existing lot as userB
     * @param _lotId lotId of the lot to be joined
     */
    ...
    /**
     * @dev to be called to resolve the lot after duration (can be called by anyone)
     * @param _lotId lotId of the lot to be resolved
     */
    ...
    /**
     * @dev to be called to withdraw deposit in the case that lot expires
     * @param _lotId lotId of the lot from which deposit is withdrawn
     */
    ...
    /**
     * @dev to be called to withdraw claim (winnings) from a lot
     * @param _lotId lotId of the lot from which claim is withdrawn
     */
    ...
    /**
     * @dev to be called by the owner to withdraw platform fee
     */
