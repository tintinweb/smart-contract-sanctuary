...
*/
    ...
    // IMPORTANT: call DelayedExchangePool(pool).processDelayedOrders() before use this method
    ...
    internal view returns (uint reserveA, uint reserveB) {
        ...
        uint reserve0 = totalBalance0.sub(balance0Locked);
        uint reserve1 = totalBalance1.sub(balance1Locked);
