...
contract PlanetBull is Context, IERC20 {
    ...
    string constant private _name = "PlanetBull";
    string constant private _symbol = "$PB";
    ...
    struct TaxWallets {
        ...
        address payable reflection;
        address payable charity;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x9b98D2EAf90D56440b6349627b33706Ae47B39e4),
        reflection: payable(0x1Ba6A756ad26966E7e99e1ce5000a58AF72A4268),
        charity: payable(0xcC3f98ECF4523Ef0a70B13729b311246135C3121)
        });
    
    bool inSwap;
    bool public contractSwapEnabled = false;

    uint256 private _maxWalletSize = (_tTotal * 19) / 1000;
    ...
    constructor () payable {
        ...
        } else if (block.chainid == 1 || block.chainid == 3) {
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 reflection, uint16 charity, uint16 burn) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.reflection = reflection;
        _ratios.charity = charity;
        _ratios.burn = burn;
        _ratios.total = marketing + reflection + charity;
    }
    ...
    function setWallets(address payable marketing, address payable reflection, address payable charity) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.reflection = payable(reflection);
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0) {
            ...
            _taxWallets.reflection.transfer(_ratios.reflection * amountETH / (_ratios.total));
