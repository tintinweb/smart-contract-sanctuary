...
contract FoMo3DSoon is F3Devents{
	...
	DiviesInterface constant private Divies = DiviesInterface(0xf6ca35fca9effb7370d2ba812537d813583f6938);
	...
	PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0x794f76350887b856771303f9aa5757a28b579556);
//==============================================================================
//     _ _  _  |`. _     _ _ |_ | _  _  .
...
//====================/=========================================================
        ...
        public
    {
        ...
        require(
            ...
            msg.sender == 0xFb925DE3d2C738b3c687C6a36C093fe0aD3fc9da,
            "only team just can activate"
        );
