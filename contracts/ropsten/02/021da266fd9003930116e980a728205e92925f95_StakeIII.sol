...
contract StakeIII is ERC20, PoSTokenStandard, Ownable {
    using SafeMath for uint256;

    string public name = "StakeIII";
    string public symbol = "STAKEIII";
    ...
    uint public presaleSupply = 165**22; // 1,650,000.000000000000000000
...
//------------------------------------------------------------------------------
    ...
    function StakeIII() {
        ...
        totalInitialSupply = 2335**22; // Total Initial Supply is 23,350,000.000000000000000000
        // 825,000 for Add Liqudity
        // 25,000 for Team and Development
        // 22,500,000 for LPs External Staking Rewards
