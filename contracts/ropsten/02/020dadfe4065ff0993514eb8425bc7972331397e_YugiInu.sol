...
contract YugiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "YUGI Inu";
    ...
    {
        uint256 tFee = tAmount.mul(devFee).div(100);
    ...
    function setFee(uint256 devFeeOnBuy, uint256 devFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell, uint256 lpFeeOnBuy, uint256 lpFeeOnSell) public onlyOwner {
        ...
        _lpFeeOnBuy = lpFeeOnBuy;
        _lpFeeOnSell = lpFeeOnSell;
    ...
    function potOfGreedBuy() public onlyOwner{
        ...
        _taxFeeOnBuy = _taxFeeOnBuy/2;
        _lpFeeOnBuy = _lpFeeOnBuy/2;
    ...
    function potOfGreedSell() public onlyOwner{
        ...
        _taxFeeOnSell = _taxFeeOnSell * 2;
        _lpFeeOnSell= _lpFeeOnSell * 2;
