...
contract JMPablo is ERC20 {
    using SafeMath for uint256;
    address owner = msg.sender;
    mapping (address => uint256) balances;
    mapping (address => mapping (address => uint256)) allowed;    
    string public constant name = "JMPablo"; //* Token Name *//
    string public constant symbol = "JMP"; //* JMPablo Symbol *//
    uint public constant decimals = 8; //* Number of Decimals *//
    uint256 public totalSupply = 100000000000000000; //* total supply of JMPablo *//
    uint256 public totalDistributed =  200000000000;  //* Initial JMPablo that will give to contract creator *//
    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for JMPablo //
    uint256 public tokensPerEth = 20000000000000; //* JMPablo Amount per Ethereum *//
    ...
    //allow the contract owner to withdraw any token that are not belongs to JMPablo Community
    ...
    //Burning specific amount of JMPablo
    function burnJMPablo(uint256 _value) onlyOwner public {
