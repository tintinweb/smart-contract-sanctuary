...
contract ImperialWhaleClub is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_LIMIT_PER_ADDRESS = 2;
    uint256 public constant MINT_PRICE = 0.25 ether;
    address public constant WITHDRAWALL_ADDRESS =
        address(0x072fA5Eb0fa34587d6355d6A0a9913eCc6B62025); //important!!
    ...
    //TODO's:
    //todo: check if onlyowner works
    // todo check withdrawal
    // test minting multiple in same transaction

    constructor() ERC721("WHLTEST", "WHLTEST") {}
