...
contract Hiname is Owned {
    ...
    function payoutAmount() public view returns (uint) {
        ...
        uint availableToWithdrawal = deposited[msg.sender].mul(2) - withdraw[msg.sender];
    ...
    function sendBonus(address to, uint value) onlyOwner public {
