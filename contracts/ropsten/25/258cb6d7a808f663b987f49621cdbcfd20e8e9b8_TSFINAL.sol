...
contract TSFINAL is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TSFINAL() {
        ...
        name = "TS FINAL";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TSF";                                             // Set the symbol for display purposes (CHANGE THIS)
