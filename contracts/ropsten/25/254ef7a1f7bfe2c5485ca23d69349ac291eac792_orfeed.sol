...
contract orfeed {
    ...
    function getExchangeRateEd(uint256 amount) public constant returns(uint) {
        IKyberNetworkProxy ki2 = IKyberNetworkProxy(0xd719c34261e099Fdb33030ac8909d5788D3039C4);
        (uint expectedRate, uint slippageRate) = ki2.getExpectedRate(ERC20(ethAddress), ERC20(kncAddress), amount);
        return expectedRate;
    }
}