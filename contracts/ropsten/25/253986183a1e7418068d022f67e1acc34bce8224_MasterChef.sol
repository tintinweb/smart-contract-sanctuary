...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    event FeeAddressUpdate (address indexed user, address indexed newAddress);
    event BossAddressUpdate (address indexed user, address indexed newAddress);
  ...
  // Update reward variables of the given pool to be up-to-date.
   ...
   // Withdraw without caring about rewards. EMERGENCY ONLY.
    ...
    function setBossAddress (address _BossAddress) public {
        ...
        emit BossAddressUpdate(msg.sender, _BossAddress);
    }
    ...
    function setFeeAddress(address _feeAddress) public{
        ...
        emit FeeAddressUpdate(msg.sender, _feeAddress);
    }
