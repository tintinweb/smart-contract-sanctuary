...
contract BigPublicPresale is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "BigPublicPresale";
    string private m_Symbol = "BIGG";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000000, 10000, 1000, 50000, m_ILOPublic);
        initTax();
