...
contract ChestSeller is  AccessControlEnumerable {
    ...
    ) 
    {
        ...
        _spayaddress=SPAY(0x0Bb7DD2B4C3792Bf259899df4a83a3cD9DC48E58);
        setMinesharePerMillion(_minesharePerMillion);
    }
    ...
    function buyAsset(string memory optionID,uint256 quantity) public {
        ...
        require(_spayaddress.allowance(_msgSender(),address(this))>=totalPrice,"ERC20: must approve enough SPAY");
        require(_spayaddress.transferFrom(_msgSender(),address(this),totalPrice), "ERC20: SPAY transfer failed");
