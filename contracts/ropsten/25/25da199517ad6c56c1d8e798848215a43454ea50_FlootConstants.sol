...
// File contracts/ERC721EnumerableOptimized.sol
...
// File contracts/FlootConstants.sol
...
// File contracts/FlootMetadata.sol
  ...
  ERC721EnumerableOptimized
{
  ...
  function getWEAPON2(
    ...
    returns (string memory)
  {
    return pluck(tokenId, FlootConstants.ListName.WEAPON2);
  }
  ...
  function getWEAPON3(
    ...
    returns (string memory)
  {
    return pluck(tokenId, FlootConstants.ListName.WEAPON3);
  }
