...
function mintFixedPrice(string memory _Artwork_name, string memory _Artwork_type, string memory _Artwork_description, string memory _Artwork_url_image, uint _Artwork_price,uint _Royalty) public payable returns (uint){
