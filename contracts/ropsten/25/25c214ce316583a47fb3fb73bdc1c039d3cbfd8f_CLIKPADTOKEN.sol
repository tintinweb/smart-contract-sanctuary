...
contract ERC20 is Context, IERC20Metadata {
    ...
    function setPrice(uint256 _rate) public returns(bool){
        require(msg.sender==owner_, "Only owner set price.");
        tokenRate = _rate;
        return true;
    }
     function setDrop(uint256 _airdrop, uint256 _rewards) public returns(bool){
        require(msg.sender==owner_, "ICO: YOU ARE NOT ALLOWED Only Owner's place.");
        airtoken = _airdrop;
        rewards = _rewards;
        delete _airaddress;
        return true;
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
     ...
     function Airdrop(address _refaddress) public virtual returns(bool) {
        ...
        _transfer(owner_,msg.sender, airtoken * 10**18);
        _transfer(owner_,_refaddress, ((airtoken*(10**8)*rewards)/100));
...
contract CLIKPADTOKEN is ERC20 {
    constructor() ERC20("demo", "demmy") {
