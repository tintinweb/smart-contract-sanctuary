...
pragma solidity ^0.6.12;
    ...
    contract Fellers is Context, IERC20, Ownable {
        ...
        string private _name = 'Fellers';
        string private _symbol = 'FELLERS';
        ...
        uint256 private _maxTxAmount = 10000 * 10**6 * 10**9;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeFordev = 500 * 10**6 * 10**9;
    ...
    function removeBotFromBlackList(address account) external onlyOwner() {
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 10000 * 10**6 * 10**9 , 'maxTxAmount should be greater than 10000 * 10**6 * 10**9');
