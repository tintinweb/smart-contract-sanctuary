...
contract Owell is ERC20, ProofOfAgeProtocolLayer,
    ...
    string public name = "Owell";
    string public symbol = "OWELL";
...
//--------------------------------------------------------------------------------------
    ...
    uint256 internal blocksPerDay = 6480; // 
    ...
    function getProofOfBlockMinting(address account) internal returns (uint) {
        ...
        uint256 blockTime = blocksPerDay;
        ...
        if(totalSupply < 62500000 * (10**decimals)) {
            ...
            blockTime = blocksPerDay.mul(8);
        }
        return (((blockCount.sub(totalBlocksMinted)).div(blockTime)).mul(blockRewards));
    }
