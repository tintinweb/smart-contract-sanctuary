...
contract SavitarToken is owned {
  ...
  function invest() public payable {
    ...
    require(balanceOf[owner] >= equivalent_tokens);
    require(givenICO.add(equivalent_tokens) <= totalICO.add(allowedLastOver));

    balanceOf[owner] = balanceOf[owner].sub(equivalent_tokens);
    balanceOf[msg.sender] = balanceOf[msg.sender].add(equivalent_tokens);
    givenICO = givenICO.add(equivalent_tokens);
