...
contract GovernorAlpha is GovernorStorage, GovernorEvents {
        ...
        public
    {
        ...
        require(state != ProposalState.Canceled, "GovernorAlpha::cancel: proposal already cancelled");
        require(state != ProposalState.Defeated, "GovernorAlpha::cancel: cannot cancel defeated proposal");
        require(state != ProposalState.Expired, "GovernorAlpha::cancel: cannot cancel expired proposal");
