...
contract Potions is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[2] = '</text><text x="10" y="140" class="base">';

        parts[3] = getStrength(tokenId);

        parts[4] = '</text><text x="110" y="280" class="base">';

        parts[5] = getInvisibility(tokenId);

        parts[6] = '</text><text x="220" y="281" class="base">';
        
        parts[7] = getMindcontrol(tokenId);

        parts[8] = '</text><text x="-5" y="430" class="base">';
        
        parts[9] = getPoison(tokenId);

        parts[10] = '</text><text x="110" y="140" class="base">';
        
        parts[11] = getHealth(tokenId);

        parts[12] = '</text><text x="220" y="140" class="base">';
        ...
        parts[16] = '</text><text x="210" y="430" class="base"></text><image href="https://picsvg.com/svg/jdOlqq01.svg" /></svg>';
