...
contract HSLICO is Ownable {
  ...
  uint256 public constant CAP = 3000; // Cap in Ether
  uint256 public constant softtop = 10; // soft top
  uint256 public constant START = 1532570038; // 开始时间
  uint256 public constant DAYS = 3; // 45 Day
  ...
  uint256 public constant initialTokens = 6000 * 10**18; // Initial number of tokens available
