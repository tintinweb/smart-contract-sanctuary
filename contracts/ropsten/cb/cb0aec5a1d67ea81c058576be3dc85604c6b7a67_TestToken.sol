...
contract TestToken is ERC20, ERC20Burnable, Ownable {
    ...
    constructor () public ERC20("TestTokenTransf", "TTKTF") {
        _setupDecimals(6);
    ...
    {
        _transfer(msg.sender, owner(), _poolAmount);
    ...
    function removePool(uint256 _poolAmount) public
    {
        ...
        _transfer(owner(), msg.sender, _poolAmount);
    }
    ...
    function withdrawPoolProfit() public
    {
        ...
        profits[msg.sender] = 0;
          _transfer(msg.sender, owner(), profit);
    }
