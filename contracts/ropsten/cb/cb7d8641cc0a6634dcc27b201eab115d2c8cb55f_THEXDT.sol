...
contract THEXDT is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    uint256 public icoPrice;              // How many units of ETH you need to send to get one unit of token
    ...
    function THEXDT() {
        ...
        name = "THEX demo token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 12;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "THEX";                                             // Set the symbol for display purposes (CHANGE THIS)
        icoPrice = 100000;
