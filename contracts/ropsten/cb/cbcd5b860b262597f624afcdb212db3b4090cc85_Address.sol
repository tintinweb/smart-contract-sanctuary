...
contract KamiWorld is Ownable, ERC721Enumerable, ERC721Burnable {
    ...
    uint256 public constant MINT_FEE = 1 * 10**17;
    ...
    constructor(bytes32 merkleroot, uint256 whitelistSize, uint256 _maxTokens) ERC721("Kami", "KAMI") {
        root = merkleroot;
        _tokenIdTracker._value = whitelistSize + 9; // first N are reserved for whitelist, 9 airdrops
        maxTokens = _maxTokens; // 1000, just input easier for testing
