...
contract TestNyan {
    ...
    address public farmContractAddress = 0x9b1fe17875Adf1388f6850Cb416e142DcE693f70;

    function setWant(address _want) public {
        wantAddress = _want;
    }
    
    function setFarm(address _farm) public {
        farmContractAddress = _farm;
    }
    ...
    function farm() public {
        ...
        INyanFarm(farmContractAddress).stake(_w);
    }
}