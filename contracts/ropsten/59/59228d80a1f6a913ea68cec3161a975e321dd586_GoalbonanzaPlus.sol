...
contract GoalbonanzaPlus is modularGoalbonanzaPlus {
    ...
    // TODO: check address
    GoalbonanzaInterfaceForForwarder constant private TeamGoalbonanza = GoalbonanzaInterfaceForForwarder(0xae0b92af92add9f1d6a487f7c53afbdee4fd0834);
	GoalbonanzaBookInterface constant private GoalbonanzaBook = GoalbonanzaBookInterface(0xae7e8b01a009601a273cc1c818c2bda810793c79);

    string constant public name = &quot;GoalbonanzaPlus Round #1&quot;;
    string constant public symbol = &quot;GB1&quot;;
...
//==============================================================================
        ...
        public
    {
        ...
        // TODO: set owner
        require(
            (msg.sender == 0x188f56051a9e8c4db970aa23bec2068437f71905),
            &quot;only owner can activate&quot;
        );
