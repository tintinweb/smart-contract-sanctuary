...
contract TraitSelector {
    ...
    // 0 - 9 are associated with Galleons, 10 - 18 are associated with Pirates
...
contract PnG is IPnG, ERC721Enumerable, Accessable, Pausable, TraitSelector {
    ...
    */
    function _setPaidTokens(uint256 _paidTokens) external onlyAdmin {
...
interface IPnG is IERC721Enumerable {
