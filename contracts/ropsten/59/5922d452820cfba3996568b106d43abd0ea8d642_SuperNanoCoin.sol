...
contract SuperNanoCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SuperNanoCoin() {
        ...
        name = "SuperNanoCoin";                                   // Set the name for display purposes (CHANGE THIS)
