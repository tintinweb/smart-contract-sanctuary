...
contract CabanaAirdrop is ReentrancyGuard, Context, Ownable{
    ...
    function stopAirdrop(IERC20 tokenAddress) public onlyOwner{
        require(airdropLive == true, 'Airdrop not running');
        _token = tokenAddress;
        airdropLive = false;
    }
    ...
    function claimTokens() public nonReentrant {
        require(airdropLive == true, 'Airdrop not active');
        require(Claimed[msg.sender] == false && Claimed[msg.sender] == false, 'Airdrop already claimed!');
