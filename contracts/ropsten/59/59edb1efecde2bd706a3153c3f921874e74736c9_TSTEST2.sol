...
contract TSTEST2 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TSTEST2() {
        ...
        name = "TSTEST2";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TSTEST2";                                             // Set the symbol for display purposes (CHANGE THIS)
