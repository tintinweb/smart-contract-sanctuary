...
contract BC {
    ...
    constructor(string _name, string _symbol, uint8 _decimals,uint256 _totalSupply, uint256 _releaseTime) public {
    name = _name;
    symbol = _symbol;
    decimals = _decimals;
...
contract ABC is Ownable, BC {
  ...
  event FrozenFunds(address target, bool frozen);
    ...
    constructor (
        ...
        uint256  totalSupply,
        uint256  releaseTime
    ) BC(name, symbol, decimals, totalSupply,releaseTime) public {}
