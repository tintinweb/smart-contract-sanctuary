...
contract test20 is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "test20";
    ...
    constructor() {
        ...
        charityAddress = payable(0x3142872D7EBFc5b889E391C1385D65283f85A395);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
			require(amount <= 100000000000001 * 10**9, "Limits are in place, please lower buying amount");
		}
