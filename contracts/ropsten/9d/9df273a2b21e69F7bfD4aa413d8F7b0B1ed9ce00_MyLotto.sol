...
contract MyLotto is IERC20 {
    ...
    constructor (string memory name, string memory symbol, uint8 decimals, uint256 totalSupply, uint256 ticketPrice, uint256 purchaseTokenAmount, /*address buyerPoolAddress, */address owner, address _poolToken) public {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
    ...
    */
    function purchaseTicket(uint256 _ticketNumbers, uint256 ticketCount) external payable returns(bool){
        ...
        // for( uint256 i =0 ; i < ticketCount; i++) {
            ...
            // _ticketNumbers = _ticketNumbers.div(1000000000000);
        // }
        if(ticketCount == 5){
