...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner =0xA4FAa8761b1a85aBe3A7A5836854034Cd78061d3; 
...
contract PerroCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2100000000000000;  //21 millones + decimals
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'PerroCoin';
    string private constant _symbol = 'PRC';

    uint256 private _taxFee = 1000;  //10%
    uint256 private _burnFee = 500;  //5%
    uint public max_tx_size = 2100000000000000 ; //transaction size --- antiwhale

    bool public isPaused = false;
    constructor () public {   //give the owner all the supply and devfee
