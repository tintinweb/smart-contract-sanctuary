...
contract ChronoDragonPowerCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ChronoDragonPowerCoin() {
        ...
        name = "ChronoDragonPowerCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CDPC";                                             // Set the symbol for display purposes (CHANGE THIS)
