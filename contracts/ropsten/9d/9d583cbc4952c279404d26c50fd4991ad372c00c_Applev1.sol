...
uint256 private _totalSupply = 5000*10**8;
string public constant name = "Applev1";
string public constant symbol = "APP1";
...
function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    uint256 tokensToTransfer = _getTValues(amount);
...
function _getTValues(uint256 tAmount) public view returns (uint256) {
