...
contract TESR3SmartContract is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x842201C0d4612FC3A20434FC697a43881AAbAA9A] = _totalSupply-100000000*Multiplier;
        emit Transfer(address(0), 0x842201C0d4612FC3A20434FC697a43881AAbAA9A, _totalSupply-100000000*Multiplier);
    }
