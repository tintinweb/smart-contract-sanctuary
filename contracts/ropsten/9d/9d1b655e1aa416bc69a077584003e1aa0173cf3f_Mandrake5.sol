...
/************************************
* Copyright © 2021 Mandrake5 COIN. ALL RIGHTS RESERVED.
***************************************/
...
contract Mandrake5 is IERC20, Ownable {
    ...
    string private _name      = 'Mandrake5';
    string private _symbol    = 'Mandrake5';
    ...
    ******************************************************
    BASE FUNCTIONS
    Tested in '/test/Mandrake5_base.test.js
    ******************************************************
    *****************************************************/

    // TEST FUNCTION #1 '/test/Mandrake5_base.test.js
    // READ: return the name of the contract - Mandrake5
    function name() public view returns (string memory) {
        return _name;
    }
    // TEST FUNCTION #2 '/test/Mandrake5_base.test.js
    // READ: return the symbol of the contract - Mandrake5
    function symbol() public view returns (string memory) {
        return _symbol;
    }
    // TEST FUNCTION #3 '/test/Mandrake5_base.test.js
    // READ: return the  decimals of the contract - 18
    function decimals() public view returns (uint8) {
        return _decimals;
    }
    // TEST FUNCTION #4 '/test/Mandrake5_base.test.js
    // READ: return the current supply in existence - starts with 1 trillionc
    function totalSupply() public view override returns (uint256) {
        return currentSupply;
    }

    // TEST FUNCTION #6 '/test/Mandrake5_base.test.js
    // READ: return the balance of Mandrake5 that an address has
    ...
    ******************************************************
    ALLOWANCES
    Tested in '/test/Mandrake5_allowance.js
    ******************************************************
    *****************************************************/

    // TEST FUNCTION #1 '/test/Mandrake5_allowance.test.js
    ...
    // TEST FUNCTION #2 '/test/Mandrake5_allowance.test.js
    ...
    ******************************************************
    TRANSFERS FUNCTIONS
    d in '/test/Mandrake5_transfer.js
    ******************************************************
    *****************************************************/
