...
contract MainMapped is MainMappedBase, Proxy {
    ...
    function _calcDelayReward(uint vol, uint fee, uint factor, uint toTotalSupply, uint toTotalMapped) virtual public view returns (uint reward, uint f) {      // called by sender or receiver
