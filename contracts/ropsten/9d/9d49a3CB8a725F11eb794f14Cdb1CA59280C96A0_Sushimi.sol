...
contract Sushimi is ERC721Enumerable, Ownable {  
  ...
  constructor(string memory _baseURI, address _sushimiToken) ERC721("Sushimi", "SHM") {
    baseURI = _baseURI;
  ...
  function mint(uint _amount) external {
    require(IERC20(sushimiToken).transferFrom(msg.sender, address(this), _amount * 1e18), "Invalid SushimiToken amount.");
