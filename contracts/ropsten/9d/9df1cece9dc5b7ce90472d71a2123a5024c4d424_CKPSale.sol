...
/**
 * @title CKPSale contract
 * @author https://grox.solutions
 */
contract CKPSale is Ownable {
    ...
    constructor(address USDTAddr, address CKPAddr, address initialOwner, address initialFeeWallet, address initialFundWallet) public Ownable(initialOwner) {
        require(USDTAddr != address(0) && CKPAddr != address(0) && initialFeeWallet != address(0) && initialFundWallet != address(0));
