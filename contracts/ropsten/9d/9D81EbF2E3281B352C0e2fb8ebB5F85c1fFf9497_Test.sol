...
//            _tTotal,      // Commented out since not used in called function
            balanceOf(address(ofAddress)),
            address(this).balance,
            total_Supply    // Removed commad since last parm not used
//            ofAddress     // Commented out since not used in called function
        );
    }
...
//        uint256 _tTotal,      // NOT USED IN FUCNTION
        uint256 currentBalance,
        uint256 currentETHPool,
        uint256 _totalSupply    // Removed comma since last parm not used
//        address ofAddress     // NOT USED IN FUCNTION
    ...
    function swapTokensForEth(
        ...
        IUniswapRouter02 _UniswapRouter = IUniswapRouter02(routerAddress);  // Added _ to UniswapRounter
        ...
        _UniswapRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,                                                        // Added _ to UniswapRounter
    ...
    function swapETHForTokens(
        ...
        // generate the Uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = _UniswapRouter.WETH();        // Added _ to UniswapRounter
        path[1] = address(this);

        // make the swap
        _UniswapRouter.swapExactETHForTokensSupportingFeeOnTransferTokens{value: ethAmount}(
            0, // accept any amount of ETH                                                                                                                  
            path,                                                                               // Added _ to UniswapRounter
            address(recipient),
            block.timestamp + 360
        );
    }
    ...
    function addLiquidity(
        ...
        IUniswapRouter02 _UniswapRouter = IUniswapRouter02(routerAddress);   //  Removed the // that was commenting out this line - Not sure if it was intended to be or not // Added _ to UniswapRounter

        // add the liquidity
        _UniswapRouter.addLiquidityETH{value : ethAmount}(
            address(this),                                            // Added _ to UniswapRounter
            tokenAmount,
