...
contract RealT is ERC20, Ownable, IACPI {
    ...
    ACPIOne private acpiOne;
    ACPITwo private acpiTwo;
    ACPIThree private acpiThree;
    ACPIFour private acpiFour;
    ...
    function setACPI(uint8 currentACPI) external onlyOwner returns (uint8) {
...
interface IACPI {
     ...
     * @dev Returns the amount of tokens invested by `account`.
     */
    function investOf(address account) external view returns (uint256);
