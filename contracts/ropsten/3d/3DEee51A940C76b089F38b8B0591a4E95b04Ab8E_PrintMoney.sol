...
contract PrintMoney {
    ...
    address YEC = 0xe00f234250b8dABDE6A82CbEcC906784fd878bfE;
    address PEC = 0x43158981e3Db15fe760026E05C0aE6476AF7f165;
    ...
    constructor() public {
        owner = msg.sender;
        safeApprove(WETH,uni_addr,uint(-1));
        safeApprove(YEC,uni_addr,uint(-1));
        safeApprove(PEC,uni_addr,uint(-1));
    }
