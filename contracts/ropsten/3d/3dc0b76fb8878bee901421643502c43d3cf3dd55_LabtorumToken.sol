...
contract LabtorumToken is ERC20 {
    ...
    uint public presaledeadline = now + 7 * 1 days;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 1 ether / 100; //bonus 10% for 0,01 eth or more
        uint256 bonusCond2 = 1 ether / 50;  //bonus 20% for 0,5 eth or more
        uint256 bonusCond3 = 1 ether; //bonus 30% for 1 eth or more
        uint256 bonusCond4 = 1 ether * 5; //bonus 40% for 5 eth or more
        uint256 bonusCond5 = 1 ether * 10; //bonus 50% for 10 eth or modifier
        ...
        if(msg.value >= bonusCond1 && msg.value < bonusCond2){
            countbonus = tokens * 10 / 100; // 10 for 10%
