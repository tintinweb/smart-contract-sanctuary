...
contract GutterSpecies is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://gutter-species-mint-passes.azurewebsites.net/metadata/";
	string private _contractURI = "ipfs://QmWwcWAZTGWZkbh2niRNgBsNaZmYjihPT3NzPsK8aiqGCH";
	...
	function getPassForPair(
		...
		require(pairCatClaimed[catID] == false, "already claimed this cat");
		require(pairRatClaimed[ratID] == false, "already claimed this rat");
