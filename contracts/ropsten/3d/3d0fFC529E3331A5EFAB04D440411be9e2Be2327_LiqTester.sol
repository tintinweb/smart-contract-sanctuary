...
contract Taxable is Ownable {
    ...
    function setTaxAlloc(address payable _address, uint256 _alloc) internal virtual onlyOwner() {
        require(m_TotalAddresses < 3, "Too many addresses on roster");
...
contract LiqTester is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "LiqTester";
    ...
    function _depositWETH(uint256 _amount) private {                ///////////PARSE
        ...
        WETH.approve(address(this), _wethBal);                      ///////////PARSE
