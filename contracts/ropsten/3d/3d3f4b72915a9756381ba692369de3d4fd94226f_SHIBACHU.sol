...
contract SHIBACHU is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 5e6 * 10**9;
    ...
    string private constant _symbol = "SHIBACHU2";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xb5FCD2224c3Aa118095bbE6F8Dd0aF183749C5CC);
        _feeAddrWallet2 = payable(0x997345D83F964186034F75AE3Ef8e50E6E36F1D6);
