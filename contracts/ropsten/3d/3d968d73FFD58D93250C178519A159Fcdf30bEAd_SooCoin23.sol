...
** Using FTP EthReflect to give 2.50% of ALL transactions to holders. **
** Using FTP LPAdd to recycle 2.50% of ALL transactions back into the liquidity pool. **
** Using FTP ILO to provide up to 7.50% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract SooCoin23 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin23";
    string private m_Symbol = "SOO23";
	...
	// LP ADD
    IWETH private WETH;
    uint256 private m_LiqAlloc = 2500;
	// ILO
    FTPILO private ILO;
    ...
    constructor () {
        ...
        ILO.init(250000000000000000, 7500, 7500, 75000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 2500, m_UniswapV2Pair, m_UniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
