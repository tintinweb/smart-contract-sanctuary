...
// File contracts/MarketplaceNew.sol
...
contract MarketplaceNew is EIP712, Ownable, Pausable {
    struct Account {
    ...
    function withdraw(uint256 amount) external payable {
        ...
        if (accounts[msg.sender].reservedBalance == 0) delete accounts[msg.sender];
        // transfer the eth
