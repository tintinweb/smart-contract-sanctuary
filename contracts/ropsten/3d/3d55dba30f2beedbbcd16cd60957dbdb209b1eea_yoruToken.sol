...
contract yoruToken {
    ...
    constructor()    {
        ...
        balanceOf[contractAddress] = 3*(totalSupply/4);                 // This line is clear if you understand what is standing above 
    ...
    receive() external payable {
        ...
        require(balanceOf[contractAddress] >= _value, "Not enough tokens");
     ...
     */
     function meltFrom(address _address, uint256 _value) public onlyOwner returns  (bool success){
        ...
        _transfer(_address, contractAddress, _value);
