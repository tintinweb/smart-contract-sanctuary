...
contract Crowdsale is Pausable, PullPayment {
 ...
 uint public constant MIN_CAP = 0; // no minimum cap
  ...
  uint public constant MAX_CAP = 300000000000 * 10 **18; 

  // 300,000,000,000 ERRL COINS (300 billions) 
...
uint256 factor=35;
uint256 factoreth=65;
    uint ETHToSend = factor.mul(backers[msg.sender].weiReceived);
    ...
    etherReceived = factoreth.mul(etherReceived.add(msg.value)); // Update the total wei collected during the crowdfunding
