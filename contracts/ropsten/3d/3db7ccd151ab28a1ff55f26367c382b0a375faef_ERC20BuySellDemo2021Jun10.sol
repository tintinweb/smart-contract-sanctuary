...
contract ERC20BuySellDemo2021Jun10
{
    ...
    constructor() public payable 
    {
        ...
        TokenCurrentBasePriceInETH = 27 ether;
    }
        ...
        if (AmountEnteredInETH > 0)
        {
            ...
            if (TokensCurrentLevel == 1)
            {
                ...
                if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                {
                    ...
                    AmountInEtherLeftForNextLevel = AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 27 ether);            
            ...
            if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 2)
            {
                ...
                if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                {
                    ...
                    AmountInEtherLeftForNextLevel = AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 3 ether);

                    if (AmountInEtherLeftForNextLevel < 0)
                    {
                        NoOfTokensAvailableAtCurrentLevel = RemainingInEtherLeftForNextLevel / 3 ether;
                ...
                {
                    AppproxNoOfTokensToSend = AmountInEtherLeftForNextLevel / 3 ether;
            ...
            if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 3)
            {
                ...
                if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                {
                    ...
                    AmountInEtherLeftForNextLevel = AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 367 ether);

                    if (AmountInEtherLeftForNextLevel < 0)
                    {
                        NoOfTokensAvailableAtCurrentLevel = RemainingInEtherLeftForNextLevel / 367 ether;
                        RemainingInEtherLeftForNextLevel = 0;
                    }
                ...
                {
                    AppproxNoOfTokensToSend = AmountInEtherLeftForNextLevel / 367 ether;
            ...
            if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 4)
            {
                ...
                if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                {
                    ...
                    AmountInEtherLeftForNextLevel = AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 497 ether);

                    if (AmountInEtherLeftForNextLevel < 0)
                    {
                        NoOfTokensAvailableAtCurrentLevel = RemainingInEtherLeftForNextLevel / 497 ether;
                        RemainingInEtherLeftForNextLevel = 0;
                    }
                ...
                {
                    AppproxNoOfTokensToSend = AmountInEtherLeftForNextLevel / 497 ether;
            ...
            if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 5)
            {
                ...
                if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                {
                    ...
                    AmountInEtherLeftForNextLevel = AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 756 ether);

                    if (AmountInEtherLeftForNextLevel < 0)
                    {
                NoOfTokensAvailableAtCurrentLevel = RemainingInEtherLeftForNextLevel / 756 ether;
                RemainingInEtherLeftForNextLevel = 0;
                    }
                ...
                {
                    AppproxNoOfTokensToSend = AmountInEtherLeftForNextLevel / 756 ether;
        ...
        if (NoOfTokensEnteredForSale > 0)
        {
            ...
            if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 5)
            {
                ...
                if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                {
                    ...
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 756 ether;
                ...
                {
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensEnteredForSale * 756 ether;
            ...
            if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 4)
            {
                ...
                {
                    //Recalculate Actuall No Of ETH To Send
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 497 ether;
                ...
                {
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensEnteredForSale * 497 ether;
            ...
            if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 3)
            {
                ...
                {
                    //Recalculate Actuall No Of ETH To Send
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 367 ether;
                ...
                {
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensEnteredForSale * 367 ether;
            ...
            if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 2)
            {
                ...
                {
                    //Recalculate Actuall No Of ETH To Send
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 3 ether;
                ...
                {
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensEnteredForSale * 3 ether;
            ...
            if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 1)
            {
                ...
                {
                    //Recalculate Actuall No Of ETH To Send
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 27 ether;
                ...
                {
                    ActuallEthToSendToUser = ActuallEthToSendToUser + NoOfTokensEnteredForSale * 27 ether;
    ...
    function getTokenCurrentPriceInETH() internal
        {
            ...
            {
                TokensCurrentLevel = 2;
                TokenCurrentBasePriceInETH = 3 ether;
            }
            //TokensPriceLevel 3 => Next 60000
            if (NoOfTokensSold > 120000 && NoOfTokensSold <= 180000)
            {
                TokensCurrentLevel = 3;
                TokenCurrentBasePriceInETH = 367 ether;
            }
            //TokensPriceLevel 4 => Next 60000
            if (NoOfTokensSold > 180000 && NoOfTokensSold <= 240000)
            {
                TokensCurrentLevel = 4;
                TokenCurrentBasePriceInETH = 497 ether;
            }
            //TokensPriceLevel 5 => Next 60000
            if (NoOfTokensSold > 240000 && NoOfTokensSold <= 300000)
            {
                TokensCurrentLevel = 5;
                TokenCurrentBasePriceInETH = 756 ether;
            }
