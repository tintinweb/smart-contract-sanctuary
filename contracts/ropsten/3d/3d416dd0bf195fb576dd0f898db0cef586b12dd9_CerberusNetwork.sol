...
contract CerberusNetwork is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Beonbox() {
        ...
        name = "CerberusNetwork";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CERB";                                             // Set the symbol for display purposes (CHANGE THIS)
