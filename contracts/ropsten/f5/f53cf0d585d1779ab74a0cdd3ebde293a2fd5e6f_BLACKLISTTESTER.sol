...
contract BLACKLISTTESTER is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Blacklisttest";                                           // name
    string private _symbol = "BLT";                                            // symbol
    ...
    uint256 public _maxTxAmount = _tTotal.div(1).div(33);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0xdAcad46E644210Dcdee0deCa73B2B10d708d4beE);
