...
contract CoinXII is ERC20, COINXminting, Ownable {
    using SafeMath for uint256;

    string public name = "CoinXII";
    string public symbol = "COINX2";
...
//------------------------------------------------------------------------------------
    ...
    function changeBonusRate(uint256 _bonusRate) public onlyOwner {
        bonusRate = _bonusRate;
        emit ChangeBonusRate(bonusRate);
    }
