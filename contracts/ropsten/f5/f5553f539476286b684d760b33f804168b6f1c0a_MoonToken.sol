...
contract MoonToken is ERC20Detailed 
{
    ...
    string constant tokenSymbol = "MT3";//"MT3"; 
    ...
    function _executeTransfer(address from, address to, uint256 value) private
    {
        ...
        uint256 amountToBurn = sixPercent.sub(stakingRewards);
    ...
    function payoutRewardsFor(address staker) public
    {
        ...
        uint256 initalBalance_staker = _balances[staker];
        ...
        _balances[staker] = newBalance_staker;
        emit Transfer(address(this), staker, rewards);
    }
