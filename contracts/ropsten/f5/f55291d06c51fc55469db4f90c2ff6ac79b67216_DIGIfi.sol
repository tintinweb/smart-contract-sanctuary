...
contract DIGIfi is DIGIfiAdmin, DIGIfiSigningUtils, ERC721 {
    ...
    function beginLoan(
        ...
        TransferHelper.safeTransferFrom(loan.loanERC20Denomination, _lender, msg.sender, loan.loanPrincipalAmount);
    ...
    function payBackLoan(uint256 _loanId) external nonReentrant {
        ...
        TransferHelper.safeTransferFrom(loan.loanERC20Denomination, loan.borrower, lender, payoffAmount);
        ...
        TransferHelper.safeTransferFrom(loan.loanERC20Denomination, loan.borrower, owner(), adminFee);
