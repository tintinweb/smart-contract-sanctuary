...
contract CashMoney is ERC20 {
    ...
    string public constant name = "CashMoney";
    string public constant symbol = "CMY";
    uint public constant decimals = 8;
    uint public deadline = now + 4 * 1 days;
    uint public round2 = now + 3 * 1 days;
