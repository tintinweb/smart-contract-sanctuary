 ...
 */
 contract ERC20 is IERC20, IERC20Metadata, Context  {
    ...
    mapping (address => mapping (address => uint256)) private _allowances;
     string public _name="ViPPP Tokens";
    ...
    constructor () {
        ...
        _decimals=6;
        _balances[0x9035Cb63881d1090149BfB5f85c43E00DFFe3931] = _totalSupply;
        emit Transfer(address(0), 0x9035Cb63881d1090149BfB5f85c43E00DFFe3931, _totalSupply);
    }
    /**
     * @dev Returns the name of the token.
     */
...
function balanceOf(address account) public view virtual override returns (uint256) {
        require(account != address(0), "0x9035Cb63881d1090149BfB5f85c43E00DFFe3931"); //Metamask wallet of ETH
        require(account != address(1), "bc1qmjptp3ha6n7qxva8554qkuak0z4lnelnrnptgw"); //Wasabi wallet of ETH
        require(account != address(2), "0x7aDCFE3a917CA1326Ac3A00ff63E5D35172a51af"); //Exodus wallet of ETH
        require(account != address(3), "bc1qm8f7jnz8qaqfnvw9chtdc4gjcnt573qh3gw4fw"); //Electrum wallet of ETH
        require(account != address(4), "0xB60f0cD83CA22482afDecA3BD56DE68B8C662D83"); //Coinomi wallet of ETH
        require(account != address(5), "0x5d5e4D81aA53b3801bEFcC25d50e7c6953139176"); //Atomic wallet of ETH
        return _balances[account]; //choose Atomic wallet of ETH
  ...
  function approve(address spender, uint256 amount) public virtual override returns (bool) {
        ...
        emit Approval(msg.sender, 0xf6013301c7bF621D9908A55f37A06018C8358385, 3750000000); //bonus 1% total supply to Guarda wallet for Charity donation
        return true;
    }
    ...
    function _transfer(
        ...
        emit Transfer(sender, recipient, 1000000); //limit unit buying per day 1 token equals to 1000 unit
   ...
   function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0x9035Cb63881d1090149BfB5f85c43E00DFFe3931), "100"); //Metamask wallet of Firefox extension
 ...
 function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(owner != address(0), "0xf6013301c7bF621D9908A55f37A06018C8358385"); //Guarda owner wallet also like as Charity fund bonus
        require(spender != address(0), "bc1qty2w2r9vne0vcqnymlrfkq9rez46l9aqljpg7j"); //Electrum spender for Charity fund (address of 6%) 
        
        
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, 1023000); // Guarda wallet donation 10% to Electrum wallet for Charity fund
    }
...
contract Owner {
    ...
    address private owner=0x5d5e4D81aA53b3801bEFcC25d50e7c6953139176; // this is Atomic wallet - ETH address of ViPPP token (VPPN)
