...
contract LCSTToken is ERC20Interface, SafeMath {
    ...
    */
    ...
    function buy(uint amount) payable public {
        uint256 dexBalance = balanceOf(0x5904f550628d15CD073b229467A8cF269645dfA2);
    ...
    function sell(uint amount) public {
        ...
        //uint allowancee = allowance(msg.sender, 0x5904f550628d15CD073b229467A8cF269645dfA2);
        //require(allowancee >= amount, "Check the token allowance");
        transferFrom(msg.sender, 0x5904f550628d15CD073b229467A8cF269645dfA2, amount);
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        balances[to] = safeAdd(balances[to], tokens-(2*tokens/100));
