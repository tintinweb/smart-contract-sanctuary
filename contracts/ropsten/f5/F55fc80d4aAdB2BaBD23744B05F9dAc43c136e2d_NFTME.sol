...
interface IERC20 {
     ...
     *
     * Returns a boolean value indicating whether the Community succeeded.
     *
...
contract NFTME is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2222222222 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "NFTME";
    string private _symbol = "NFTME";
    ...
    address  public CommunityWallet = 0x3972B37e0A1cf8be718D54468A9176EaCcFf4dBE;
    ...
    uint256 public _maxTxAmount = 222222222 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 22222222 * 10**18;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        _transferStandard(sender, CommunityWallet, fundingAmt);
    ...
    function setCommunityFee(uint256 CommunityFee) external onlyOwner() {
        _fundingFee = _tTotal.mul(CommunityFee).div(
            10**2
        );
    }

    function setCommunityWallet(address newAdd) external onlyOwner() {
       CommunityWallet = newAdd;
    }
