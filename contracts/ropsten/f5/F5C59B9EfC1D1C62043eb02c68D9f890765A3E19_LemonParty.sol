...
contract LemonParty is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000000000; // 1T
    ...
    string private _name = 'Lemon Party | lemonparty.co';
    ...
    uint256 private _numOfTokensToExchangeForTeamDev = 5000000000000000; // 5M
    ...
    function initContract() external onlyOwner() {
        ...
        _teamDevAddress = payable(0xA94011611d190C8C655a64A8754246D6ed5Df54e);
    }

    function liftOpeningTXLimits() external onlyOwner() {
        _maxTxAmount = 100000000000000000000;
    }
