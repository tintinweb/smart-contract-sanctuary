...
contract HyunJaeToken is ERC20Interface, OwnerHelper // SimpleToken이 ERC20Interface 및 OwnerHelper를 상속하여 ERC20Interface 및 OwnerHelper 함수를 사용가능하게 함
{
    ...
    function HyunJaeToken () public
    {
    	...
    	owner = msg.sender; //컨트래트를 실행하는 사람이 관리자
        ...
        privateSaleStartDate = 1528070400; // 2018-06-04
        privateSaleEndDate = 1528588800; // 2018-06-10
    
        preSalePrimaryStartDate = 1528675200; // 2018-06-11
        preSalePrimaryEndDate = 1528934400; // 2018-06-14
    
        preSaleSecondStartDate = 1529020800; // 2018-06-15
        preSaleSecondEndDate = 1529280000; // 2018-06-18
    
        crowdSalePrimaryStartDate = 1529366400; // 2018-06-19
        crowdSalePrimaryEndDate = 1529625600; // 2018-06-22
    
        crowdSaleSecondStartDate = 1529712000; // 2018-06-23
        crowdSaleSecondEndDate = 1529971200; // 2018-06-26
    }
