...
pragma solidity ^0.6.12;
    ...
    contract ViagraT2 is Context, IERC20, Ownable {
        ...
        string private _name = 'ViagraT2';
        string private _symbol = 'ViagraT2';
        ...
        function sendETHToCharity(uint256 amount) private {
            _charityWalletAddress.transfer(amount.div(13).mul(4));
            _marketingWalletAddress.transfer(amount.div(13).mul(9));
        }
