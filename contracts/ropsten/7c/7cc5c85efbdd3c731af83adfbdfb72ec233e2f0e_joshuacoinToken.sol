...
/**
 * @title Joshua Coin
 * @dev Contract to create the Joshua Coin
 **/
contract joshuacoinToken is CrowdsaleToken {
    string public constant name = "Joshua Coin";
    string public constant symbol = "JSHCN";
