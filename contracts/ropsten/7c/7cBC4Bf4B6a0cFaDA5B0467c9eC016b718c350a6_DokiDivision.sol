...
contract DokiDivision is ERC721PresetMinterPauserAutoId {
  ...
  uint[3] private presaleAccrued;
  uint[3] private presaleCap;
  ...
  constructor(
    ...
    shareholders[0] = 0x866aE03EC5F52452Ac527023BcE1E94b347099A5; //Niqhtmare
    shareholders[1] = 0x46169Da5A6056b6Fcb64412c27097418cc163667; //Slothrop

    shares[0] = 9500;
    shares[1] = 500;

    presaleShareholders[0] = 0x866aE03EC5F52452Ac527023BcE1E94b347099A5; //Niqhtmare
    presaleShareholders[1] = 0x49282E5E05fE59A724641eE867641b5883C02E58; //Foudres
    presaleShareholders[2] = 0x46169Da5A6056b6Fcb64412c27097418cc163667; //Slothrop

    presaleShares[0] = 9050;
    presaleShares[1] = 450;
    presaleShares[2] = 500;
    ...
    presaleCap[0] = 0;
    presaleCap[1] = 5000000000000000000;
    presaleCap[2] = 0;
    ...
    if (presaleIsActive && !saleIsActive ) {
      for (uint256 i = 0; i < PRESALE_SHAREHOLDERS; i++) {
          ...
          if (presaleCap[i] > 0) {
            ...
            if ((presaleAccrued[i] + payment) > presaleCap[i]) {

              if (presaleCap[i] - presaleAccrued[i] > 0) {

                payment = presaleCap[i] - presaleAccrued[i];
                Address.sendValue(payable(presaleShareholders[i]), payment);
                presaleAccrued[i] += payment;
