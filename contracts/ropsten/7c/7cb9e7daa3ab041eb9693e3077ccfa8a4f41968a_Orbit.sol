...
/**
 * @title Orbit Protocol ERC20 Token Contract
 * @author Orbit Protocol Team
 * @dev Implementation of the Orbit.
 */
contract Orbit is Ownable, ERC20Pausable, ERC20Burnable, ERC20Detailed, ERC20Capped {
    
    using SafeMath for uint256;
    
    uint8 constant DECIMALS = 18;
    uint256 constant CAP = 100000000;
    ...
    address contractOwner = 0x599A832646aF44a8109dbD71A21a3AeABB7A9E3A;
    /**
     * @dev Orbit constructor
     */
    constructor()
    public
    ERC20Detailed('Orbit', 'ORT', DECIMALS)
