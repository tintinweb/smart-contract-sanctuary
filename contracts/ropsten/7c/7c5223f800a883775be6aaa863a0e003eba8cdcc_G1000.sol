...
/**
 * SmartContract: 0x7c5223f800a883775be6aaa863a0e003eba8cdcc
 * ETH : G1000.diem.eth
...
contract G1000 is ERC20Interface, Tokenlock, UserLock {
    ...
    constructor() public {
        ...
        _totalSupply = 300000 * 10**uint(decimals);
