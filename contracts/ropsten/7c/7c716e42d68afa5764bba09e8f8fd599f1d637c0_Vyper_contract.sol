...
# Participate in this crowfunding campaign
@external
@payable
def participate():
...
# Not enough money was raised! Refund everyone (max 30 people at a time to avoid gas limit issues)
@external
def refund():
