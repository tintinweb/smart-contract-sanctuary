...
contract CrowdswapV1 is Ownable, ICrowdswap {
    ...
    external override payable returns (uint256 returnAmount){
        ...
        if (_dexFlag == _UNISWAPV2 || _dexFlag == _SUSHISWAP) {
            ...
            IUniswapV3Router.ExactInputSingleParams memory uni3Params = IUniswapV3Router.ExactInputSingleParams(
                address (_fromToken),
                address (_destToken),
                0,
                address(this),
            ...
            dexResult[0] = IUniswapV3Router(_dexAddress).exactInputSingle{value : msg.value}(
                uni3Params
            );
        }
