...
contract Toknify is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, Ownable, ReentrancyGuard {
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 999999) {
            return 700000000000000000; // 0.10 ETH
        } else if (currentSupply >= 500000) {
            return 600000000000000000; // 0.10 ETH
        } else if (currentSupply >= 100000) {
            return 500000000000000000; // 0.10 ETH
        } else if (currentSupply >= 50000) {
            return 400000000000000000; // 0.10 ETH
        } else if (currentSupply >= 10000) {
            return 300000000000000000; // 0.10 ETH
        } else if (currentSupply >= 1000) {
            return 200000000000000000; // 0.10 ETH
        } else {
