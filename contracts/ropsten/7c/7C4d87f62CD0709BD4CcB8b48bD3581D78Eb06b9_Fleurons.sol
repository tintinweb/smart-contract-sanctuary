...
contract Fleurons is ERC721, ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("Fleurons", "FLRNS") {}
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500" xml:space="preserve">';
    // Background-color
    parts[1] = string(abi.encodePacked('<path d="M0 0h500v500H0V0z" style="fill:', bg, '" />'));

    // Gradient
    parts[2] = '<linearGradient id="a" gradientUnits="userSpaceOnUse" x1="91.3" y1="260.2" x2="430.1" y2="260.2">';
    parts[3] = string(abi.encodePacked('<stop offset="0" style="stop-color:', c0, '"/>'));
    parts[4] = string(abi.encodePacked('<stop offset="1" style="stop-color:', c1, '"/>'));
    parts[5] = '</linearGradient>';
    parts[6] = '<path d="M278.4 243.2c-1.7.2-4.2.3-7.6.3-8.6 0-19.3-2.7-32.1-8.2 5.3 6.9 7.9 15.5 7.9 25.8 0 2.5-.2 5-.5 7.4s-.6 4.4-.9 6c-.3 1.6-.5 2.5-.5 2.7.8 0 2.6.3 5.2.9 2.6.6 6.4 2.4 11.3 5.2 4.9 2.8 9.5 6.5 13.7 10.9s7.9 11 11 19.9c3.2 8.8 4.7 18.9 4.7 30.2 0 10.9-2.5 21.2-7.4 30.7-4.9 9.6-10.4 17.1-16.4 22.7s-11.9 11.2-17.6 17c-5.8 5.8-9.2 10.6-10.2 14.3-1.7-3.8-5.5-8.7-11.5-14.7s-11.9-11.8-17.8-17.3-11.2-13.1-15.9-22.5-7.1-19.5-7.1-30.2c0-11.3 1.5-21.4 4.6-30.1 3-8.7 6.8-15.3 11.2-19.8s8.8-8.2 13.2-11 8.1-4.7 11-5.5l4.7-.9c1.9-3.8 2.8-8.6 2.8-14.5 0-10.7-3.8-20.3-11.3-28.7-7.6-8.4-18.2-12.6-31.8-12.6-18.3 0-34 6.9-47.3 20.8-15.3 16.2-23 34.4-23 54.8v5.7l.3.9H91.3c0-29.4 10.9-55 32.8-76.9 10.7-10.7 30.3-24.3 58.8-40.6s47.1-29 55.9-37.8c14.1-14.1 21.1-31 21.1-50.7 0-1-.1-2-.2-3-.1-.9-.2-1.7-.2-2.4v-.6l31.2.3c0 9.4-2.3 21-6.9 34.7s-12.8 26.1-24.6 37.2c-6.9 6.5-15 12.7-24.3 18.4-9.2 5.8-19.6 11.6-31 17.3-11.4 5.8-17.9 9.1-19.4 9.9 2.9-.6 5.3-.9 6.9-.9 10.7 0 24.3 3.9 40.8 11.7s29.3 11.7 38.6 11.7c1.5 0 3.9-.2 7.2-.6.2-1.1.6-2.5 1.1-4.4s2.3-5.2 5.2-10.1c2.9-4.8 6.6-9 11-12.6s11-6.9 19.8-9.9 18.9-4.6 30.3-4.6c10.7 0 20.8 2.2 30.2 6.6s17 9.3 22.5 14.8c5.6 5.5 11.3 11 17.3 16.7s10.9 9.2 14.7 10.7c-3.4.8-7.2 3.2-11.3 7.1-4.2 3.9-8.6 8.1-13.1 12.6s-9.6 9-15.1 13.6c-5.6 4.5-12.3 8.3-20.2 11.3-7.9 3.1-16.2 4.6-25 4.6-8.4 0-16.1-.8-23-2.4s-12.7-3.7-17.2-6.3c-4.5-2.6-8.5-5.5-11.8-8.7-3.4-3.2-5.9-6.3-7.7-9.4-1.8-3.2-3.3-6-4.4-8.7-1.2-2.6-1.9-4.7-2.4-6.1l-.5-2.7z" style="fill:url(#a)"><animateTransform accumulate="none" additive="replace" attributeName="transform" calcMode="linear" dur="5s" fill="remove" repeatCount="indefinite" restart="always" type="translate" values="0 -5;0 5;0 -5"/></path>';
    parts[7] = '<path d="M19 473.6h202.2v29.9H19v-29.9z" style="fill:none"/>';
    parts[8] = string(abi.encodePacked('<text fill="', c0 ,'" transform="translate(19.033 482.207)" font-weight="bold" font-size="12" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, monospace">', year, ' Fleuron #', count, '</text>'));
    parts[9] = '</svg>';
    ...
    // Note: Below is necessary if we need to add more parts
