...
contract MVND is Pausable, StandardToken, BlackList {
    using SafeMath for uint;
    ...
    function transfer(address _to, uint _value) public virtual override whenNotPaused {
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function transferFrom(address _from, address _to, uint _value) public virtual override whenNotPaused {
