...
// hevm: flattened sources of src/VatandaslikNFT.sol
    ...
    ReentrancyGuard
{
    ...
    // At the time of writing, a new VatandaslikNFT costs 0.25 ether.
    ...
    mapping(uint256 => string) private VatandaslikNFTDescriptions;
    //Initialisation
    bool private contractInitialized;
    uint256 private reservedCitizenships;

    /// @notice Initialise VatandaslikNFT smart contract with the appropriate address and ItemIds of the
        ...
        ERC1155("")
    {
        ...
        VatandaslikNFTDescriptions[CITIZEN_NFT_ID] = "SehrimBenim Vatandaslik";
        VatandaslikNFTDescriptions[FOUNDING_NFT_ID] = "SehrimBenim Kurucu Vatandaslik";
        VatandaslikNFTDescriptions[FIRST_NFT_ID] = "SehrimBenim Ilk Vatandaslik";
    ...
    ///@notice Mint new VatandaslikNFTs to an address, usually that of SehrimBenim.
    ...
    function awardCitizenship(
        ...
        address SehrimBenim = this.owner();
    ...
    function uri(uint256 _VatandaslikNFTId)
        public
        view
        override
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    abi.encodePacked(
                        '{ "name": "',
                        VatandaslikNFTDescriptions[_VatandaslikNFTId],
                        '", ',
                        '"description" : ',
                        '"A Citizen of SehrimBenim holds governance in the operations and activities of SehrimBenim.",',
                        '"image": "',
                        tokenURIs[_VatandaslikNFTId],
                        '"'
                        "}"
                    )
                )
    ...
    /// @param _VatandaslikNFTIds Array of citizen NFT Ids (69 OR 42 OR 7) for the respective URIs
    function changeURIs(
        string[] calldata _tokenURIs,
        uint256[] calldata _VatandaslikNFTIds
    ) external onlyOwner {
        for (uint256 i = 0; i < _tokenURIs.length; i++) {
            tokenURIs[_VatandaslikNFTIds[i]] = _tokenURIs[i];
        }
    }
