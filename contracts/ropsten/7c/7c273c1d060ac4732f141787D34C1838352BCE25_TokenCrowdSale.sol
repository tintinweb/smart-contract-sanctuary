...
contract MinterRole is Context {
    ...
    function renounceMinter() internal {
...
contract WhitelistedRole is Context, WhitelistAdminRole {
    ...
    function renounceWhitelisted() internal {
...
contract WhitelistAdminRole is Context {
    ...
    function isWhitelistAdmin(address account) internal view returns (bool) {
        return _whitelistAdmins.has(account);
    }

    function addWhitelistAdmin(address account) internal onlyWhitelistAdmin {
        _addWhitelistAdmin(account);
    }

    function renounceWhitelistAdmin() internal {
