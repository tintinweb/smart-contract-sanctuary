...
contract PolyGem is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeCast for int256;
  
    string private _name = "PolyGem";
    ...
    uint256 public _taxFee = 0; // means 5% which distribute to all holders
    uint256 public _buyBackFee=500;//meanse 5 goes to buyback wallet
    
    address buyBackAddress; //Dummy wallet
