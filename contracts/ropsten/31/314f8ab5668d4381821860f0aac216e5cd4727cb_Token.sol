...
contract Token is SafeMath{
  ...
  event hashlog(string _txhash);
  function txhash(string _txhash) returns (bool success) {
     require(logaddr == msg.sender);
    hashlog(_txhash);
    return true;
  }
  function setlogaddr(address _addr)returns (bool success){
