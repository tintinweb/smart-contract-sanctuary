    ...
    IERC721Enumerable
{
    ...
    uint256 WHITE_LIST_DISCOUNT = 20;
    bool private _paused = true;
 
    uint256 HARD_CAP;
    // IDiscountWhiteListContract discountWhiteListContract;
    ...
    constructor(
        ...
        string memory uri_,
        uint256 hardCap_
        // address _discountWhiteListContract
    ) public {
        _name = name_;
        _symbol = symbol_;
        _baseURI = uri_;
        ...
        // discountWhiteListContract = IDiscountWhiteListContract(
        //     _discountWhiteListContract
        // );
    ...
    function mint(address _to, uint256 _tokenId) public payable {
        ...
        uint256 value;
        // bool isDiscountUser = discountWhiteListContract.isUser(_to);
        bool isDiscountUser = users[_to];
        if (isDiscountUser) {
            value = SALE_PIRCE.mul(100 - WHITE_LIST_DISCOUNT).div(100);
        } else {
            value = SALE_PIRCE;
        }
    ...
    function approve(address to, uint256 tokenId) public override {
        ...
        require(
            sender == owner || ERC721.isApprovedForAll(owner, sender),
