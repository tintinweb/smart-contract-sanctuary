...
contract Prime is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Prime";                                           // name
    string private _symbol = "Prime";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x9e676630c0Ae2806DDA698d667916DAdd0111Dc3);
