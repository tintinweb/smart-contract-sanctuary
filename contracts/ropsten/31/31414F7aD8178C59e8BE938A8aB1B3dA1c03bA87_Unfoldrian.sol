...
contract Unfoldrian is UnfoldrianPricing, EIP712 {
    ...
    {
        metadataUri = "https://arweave.net/NJ_K7p0iFTsgjdhfSfnc-FpWhJWjHi14C7RGsHndcUU/";
    ...
    function canMint(address account, bytes calldata data) public view virtual override returns (bool) {
        ...
        if(nSale && nBalance > 0 && totalMintsAvailable() > 0 && balance < derivativeParams.maxMintAllowance) {
           return true;
        }
        if(preSale && totalMintsAvailable() > 0 && balance < derivativeParams.maxMintAllowance) {
    ...
    function contractURI() public view returns (string memory) {
        return "https://arweave.net/6e9T0SWi_Lr4A0vyn8McC5dVZS-laUbwVO9iYjTRqNU/metadata.json";
    }
}
