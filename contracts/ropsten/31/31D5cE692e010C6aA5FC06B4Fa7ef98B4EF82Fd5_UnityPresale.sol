...
contract UnityPresale {
    ...
    modifier paymentModifiers() {
        ...
        require(msg.value >= 10000000 && msg.value <= 100000000, "Min Purchase: 0.1 BNB, Max Purchase: 1 BNB");
        require(allocationPurchaseOccupied = false, "Someone else is buying UNITY tokens right now, please try again in a few minutes.");
        require(msg.value % 10000000 == 0, "Only purchases divisible by 0.1 BNB can be made. Contact the team with this error msg.");
        _;
    }
