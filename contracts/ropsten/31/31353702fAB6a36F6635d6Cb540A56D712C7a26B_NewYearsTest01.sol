...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x68B70feE8939Cb3A1385d14472Ba206EC75E3d86), 500);
        m_DidDeploy = true;
    }
...
contract NewYearsTest01 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 200000000000000 * 10**9;
    string private m_Name = "NewYearsTest01";
    string private m_Symbol = "NewYear";
    ...
    constructor () {
        ...
        ILO.init(2000000000000000000, 5000, 5000, 75000, m_ILOPublic);
        initTax();
