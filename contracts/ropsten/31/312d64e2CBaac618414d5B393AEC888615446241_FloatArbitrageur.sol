...
contract FloatArbitrageur is Arbitrageur, IAuction {
    ...
    address private constant usdt = address(0x6EE856Ae55B6E1A249f04cd3b947141bc146273c);
    ...
    function testMyself() private {
        ...
        require(balanceOf(usdt) == usdtAmount, "USDT buy failed");
        ...
        require(balanceOf(usdt) == 0, "USDT sell failed");
