...
// File: contracts/token/FidelityHouseCoin.sol

// solium-disable-next-line max-len
contract FidelityHouseCoin is DetailedERC20, RBACMintableToken, BurnableToken, ERC1363BasicToken, TokenRecover {
  ...
  constructor(uint256 _lockedUntil)
    DetailedERC20("FidelityHouse Coin", "FIH", 18)
    public
  {
