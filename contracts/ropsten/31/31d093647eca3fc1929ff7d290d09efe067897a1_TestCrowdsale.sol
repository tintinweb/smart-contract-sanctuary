...
contract TestCrowdsale is CappedCrowdsale, RefundableCrowdsale {
  ...
  uint256 public tokensForEcosystem = 10000000000000000000000000; // is ju 20 eko systemai
  uint256 public tokensForTeam = 10000000000000000000000000; //10 is ju komandai
  uint256 public tokensForBounty = 10000000000000000000000000; //nera bounty pas mus reik kazkokiu analiniu budu isimti.
  uint256 public totalTokensForSale = 45000000000000000000000000; // 60 is ju bus parduota per crowdsale
  uint256 public totalTokensForSaleDuringPreICO = 15000000000000000000000000; // 20 is ju parduota per pre ico
  // ==============================
  ...
  // =================
  function createTokenContract() internal returns (MintableToken) {
    return new TestToken(); // Sukuria tokena automatiskai kai sukuriams crowdsaleas
  }
  // ==================
