...
contract IMETACoin223Token_14 is ERC20, ERC223, Standard223Receiver, SafeMath {
    ...
    function getLast24hSendingValue(address _from) public view returns (uint totVal) {
        ...
        if(tc > 0) {
            for(uint i = tc ; i >= 1 ; i--) {
                ...
                require(tc - i >= 100);     // to limit the number of loops to 100, it means durring 24 hours, max 100 transfers can be done from a given "_from"
