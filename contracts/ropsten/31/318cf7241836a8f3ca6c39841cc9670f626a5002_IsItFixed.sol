...
contract IsItFixed is Context, IERC20, Ownable {
    ...
    string private _name = 'Is It Fixed'; 
    string private _symbol = 'FixedOrNo';
    ...
    function _takedev(uint256 tBurn) private {
        uint256 currentRate =  _getRate();
        uint256 rBurn = tBurn.mul(currentRate);
    ...
    function _setDevFee(uint256 burnFee) external onlyOwner() {
        require(burnFee >= 0 && burnFee <= 10, 'Dev Fee max is 10');
        _burnFee = burnFee;
    }
