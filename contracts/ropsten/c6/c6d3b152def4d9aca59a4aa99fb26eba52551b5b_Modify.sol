...
contract Modify is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Modify";
    ...
    uint256 internal _tokenTotal = 1000e18;
    ...
    uint256 public _rebalanceCallerFee = 200;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'MOD: The contract it self cannot be excluded');
        require(!_isExcluded[account], "MOD: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "MOD: Account is already included");
