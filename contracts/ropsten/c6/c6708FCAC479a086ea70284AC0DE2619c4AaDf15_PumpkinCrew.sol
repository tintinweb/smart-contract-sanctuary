...
abstract contract Drainer is Ownable {

  using SafeERC20 for IERC20;

  function drainEth(address payable _beneficiary) external onlyOwner {
  ...
  function drainTokens(address _token, address _beneficiary, uint256 _amount) external onlyOwner {
