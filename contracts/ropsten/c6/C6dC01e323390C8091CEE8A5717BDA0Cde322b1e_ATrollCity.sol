...
interface IATrollCity {
    ...
    event SetWhiteList (address[] newAddresses);

    event RemoveWhiteList (address[] currentAddresses);

    event NewPriceAndSupplyCap ();
    ...
    function setPriceAndSupplyCap(uint256 newPrice, uint256 newSupplyCap) external;
