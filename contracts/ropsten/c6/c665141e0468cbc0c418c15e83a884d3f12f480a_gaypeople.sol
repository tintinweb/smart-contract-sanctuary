...
/**
 finally a gay ass coin for all gays lets do gay stuff @gaystufftogetha
*/
...
contract gaypeople is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "gay people coin";
    string private _symbol = "gays";
    ...
    uint256 public _marketingFee4Buyers = 10;
    ...
    address payable public marketingWallet = payable(0x67865B3FF224Bed7b545937CaF6800199710Dc75);
