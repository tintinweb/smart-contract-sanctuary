...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private _MyPetProTest2;
    string private _MPPT2;
     ...
     * construction.
     */
    constructor(string memory MyPetProTest2_, string memory MPPT2_) {
        _MyPetProTest2 = MyPetProTest2_;
        _MPPT2 = MPPT2_;
...
/**
 * @dev Contract for MyPetProTest2 token
 */
contract MyPetProTest2 is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 2_000_000_000e18;

    constructor() ERC20("MyPetProTest2", "MPPT2") {
