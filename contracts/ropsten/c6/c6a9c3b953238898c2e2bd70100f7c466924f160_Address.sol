...
/*  
    Welcome to the #DwayneCoin Project!
    
    Website: https://dwaynecoin.com
    Telegram: https://t.me/DwayneCoin
    Reddit: https://www.reddit.com/r/DwayneCoin

    .___                                                      .__         
  __| _/__  _  _______   ___.__.  ____    ____   ____   ____  |__|  ____  
 / __ | \ \/ \/ /\__  \ <   |  | /    \ _/ __ \_/ ___\ /  _ \ |  | /    \ 
/ /_/ |  \     /  / __ \_\___  ||   |  \\  ___/\  \___(  <_> )|  ||   |  \
\____ |   \/\_/  (____  // ____||___|  / \___  >\___  >\____/ |__||___|  /
     \/               \/ \/          \/      \/     \/                 \/ 
...
contract DwayneCoin is Context, IERC20, Ownable {
    ...
    string private _name = "DwayneCoin";
    ...
    address payable public advertisingAddress = 0xb5d85CBf7cB3EE0D56b3bB207D5Fc4B82f43F511; // marketing wallet, used for paying for celebrities and a-listers (and nothing else)
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferAdvertisingBNB(advertisingAddress, donationTransfer); 
    ...
    function setDonationAddress(address payable marketing) external onlyOwner() {
        advertisingAddress = marketing;
    }
    ...
    function TransferAdvertisingBNB(address payable recipient, uint256 amount) private {
