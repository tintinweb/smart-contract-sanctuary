...
contract TomorrowWontExist is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 3; // means 3% which distributes to all holders
    uint256 public _liquidityFee = 0; // means 0% auto LP
    uint256 public _burnFee = 3; // means 3% burn
    uint256 public devFee = 400; //400 means 4% will send to developer Fee
    ...
    uint256 public maxTxAmount = 5000000000e18; // .5% of total supply limit 
