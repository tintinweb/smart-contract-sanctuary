...
contract knjiznica{
    ...
    function ustvariKnjigo(string memory isbn, string memory naslov, string memory avtor) public{
    
        Knjiga(isbn, naslov, avtor, 0, false, 0, 0);
        knjige[stknjig] = Knjiga(isbn, naslov, avtor, 0, false, 0, 0);
        stknjig++;

    }
     function ustvariKnjigo(string memory ime) public{
    
        Izposojevalec(stIzpo+1, ime);
        izposojevalci[stIzpo] = Izposojevalec(stIzpo+1, ime);
        stIzpo++;
