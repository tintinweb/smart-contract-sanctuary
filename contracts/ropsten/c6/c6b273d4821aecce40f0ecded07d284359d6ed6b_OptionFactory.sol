...
contract OptionFactory is IOptionFactory, Initializable, ReentrancyGuard, Ownable {
  ...
  ) external override onlyOptionCreator nonReentrant
  {
    ...
    require(_expirationDelay >= 0, "ZOOM: invalid _expirationDelay(value less than zero)");
    require(_optionTokenDecimals >= 0, "ZOOM: invalid _optionTokenDecimals(value less than zero)");
