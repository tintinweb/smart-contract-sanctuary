    ...
    // }
     ...
     function buyNFT(tokenDetails calldata tokens, bytes calldata signature) payable external returns(bool){
       ...
       // bool status = SignatureCheckerUpgradeable.isValidSignatureNow(owner(), tokens.signKey, signature);
        ...
        payable(0xfe1EBe6fE7AE02A2aae240332f40246cE2E877B7).transfer(payableValue1);

        uint256 payableValue2 = msg.value - payableValue1;
        payable(0x25fC99eF8C2bE73c303f7e54A0c2Da423E48326b).transfer(payableValue2);
        emit TransferEth(msg.sender,0xfe1EBe6fE7AE02A2aae240332f40246cE2E877B7, payableValue1, 0x25fC99eF8C2bE73c303f7e54A0c2Da423E48326b, payableValue2, tokens.noOfTokens,tokens.catId, msg.value);
