...
//Donate : 0xCF4856CFbd78151982bf53C0aBF5Cf1d5C49f7aE
//-----------------------------------------------------------------------
...
contract ABE_Protocol is ERC20, ERC20Detailed,
    ...
    address internal contractOwner = 0xCF4856CFbd78151982bf53C0aBF5Cf1d5C49f7aE;
    address internal teamDevs = 0xCF4856CFbd78151982bf53C0aBF5Cf1d5C49f7aE;
    ...
    constructor() public ERC20Detailed("ABE_Protocol","ABE", 18){
        ...
        circulatingSupply = 9000000 * (10**18); //4 Million
...
//--------------------------------------------------------------------------------------
    ...
    uint256 public blockTransactionRewards = 100 * (10**18);
...
//--------------------------------------------------------------------------------------
    ...
    uint256 internal epochRate = 5000; //50%
