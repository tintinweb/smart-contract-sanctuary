...
contract ScamFaucet {
    ...
    address public constant ScamToken = 0x51Ea02C339c6cd4DFEB64449da5341627d1E97Bb;
    ...
    {
        require(block.timestamp >= lockedUntil, "Time Lock!");
        require(canAddressReceive(msg.sender), "Address Not Eligible!");
        
        // No airdrop from this address again, and no airdrop until 2 seconds passed
        addressUsed[msg.sender] = true;
        lockedUntil = block.timestamp.add(2);
