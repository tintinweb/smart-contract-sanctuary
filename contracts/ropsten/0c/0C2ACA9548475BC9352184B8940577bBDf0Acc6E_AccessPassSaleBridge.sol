...
contract AccessPassSale is AccessControl {
    ...
    function initTiers() public onlyAdmin {
        ...
        stars.transferFrom(msg.sender, address(this), 180000000 ether);
        tiers[4] = Tier(25, 50 ether, 2000000 ether, false);
        tiers[3] = Tier(100, 25 ether, 500000 ether, false);
        tiers[2] = Tier(250, 10 ether, 100000 ether, false);
        tiers[1] = Tier(2000, 1 ether, 5000 ether, false);
        tiers[0] = Tier(45000000, 0.0003 ether, 1 ether, false);
    }
