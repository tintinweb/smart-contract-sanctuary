...
contract Planet766 is ERC721Enumerable, Ownable {
        ...
        payable
    {
        ...
        require(totalSupply() + 1 <= 1500,"Purchase will exceed NFTs alloted for presale");
        require(
            MerkleProof.verify(
                _proof,
                merkleRoot,
    ...
    function mintPlanet766(uint256 _count) external payable {
        ...
        if (_to  != owner()) {
            ...
            require(
                _count <= 2,
                "Maximum 2 Planet 766 can be minted per transaction"
            );
            require(2>=publicSaleNftCount[_to] + _count,"Maximum 2 Planet 766 can be minted per address");
            require(
