...
contract ADF is ERC20, ERC20Detailed {
    ...
    // Modifiers
    modifier onlyGov() {
        require(msg.sender == governance, "ADF: !governance");
        _;
    }

    constructor () public ERC20Detailed("ADF", "ADF", 18, 100000000 * 10 ** 18) {
    ...
    function mint(address _account, uint256 _amount) public {
        require(minters[msg.sender], "ADF: !minter");
    ...
    function acceptGov()
        external {
        require(msg.sender == pendingGov, "ADF: !pending");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal {
        ...
        if (from == address(0)) { // When minting tokens
            require(totalSupply().add(amount) <= cap(), "ADF: Cap exceeded");
        }
    }
    
    function withdrawERC20(IERC20 token) public onlyGov {
