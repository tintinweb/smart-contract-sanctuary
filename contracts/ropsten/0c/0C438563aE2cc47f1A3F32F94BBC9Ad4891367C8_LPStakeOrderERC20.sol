...
contract StakeOrderFactory
{
  ...
  function deployERC20Staking(address LPToken, address rewardToken, uint rewardAmount, uint numBlocks, uint stakingFee, uint entranceFee, address entranceFeeToken, address premiumToken, uint premiumAmount, uint minStake, bool featured) public returns(address)
  {
    require(_isActive);
