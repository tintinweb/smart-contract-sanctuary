...
contract HappyFeet is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0x80194AbD8b691f2635f04D6b5fD2cF47156C5008;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 charityAmt = amount.mul(_charityFee).div(10);
        uint256 burnAmt = amount.mul(_burnFee).div(10);
