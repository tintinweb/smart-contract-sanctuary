...
contract Ownable {
    ...
    constructor() public {
        owner = address(0xF4ae690f7f641295e7EE66093e19DA6fbFC620Ab);
    }
...
contract MyDBaseToken is ERC20 {
...
contract MyDToken is MyDBaseToken("MyD Token", "MyD", 18, 10000000000000000000000000000), Ownable {
    ...
    constructor() public {
        founderAddress = address(0xF4ae690f7f641295e7EE66093e19DA6fbFC620Ab);
...
contract MyDPreSale is Ownable{
    using SafeMath for uint256;

    MyDToken public token;
    ...
    constructor() public {
        currentRate = 45000;
        wallet = address(0xF4ae690f7f641295e7EE66093e19DA6fbFC620Ab); //address of founder
        limitTokenForSale = 1250000000000000000000000000;
        token = MyDToken(0x324600d4D02652A04EB695C8e2830CAd91DD8E59);// address of MyD Token
    }
