...
library PrivateSaleKeeper {
    ...
    //  1: seed, 2: private sale 1, 3: private sale 2.
...
contract ERC20 is IERC20, Ownable {
    ...
    uint public startDay = d.toTimestamp(2021, 6, 1); // (yyyy, m, d)
    // uint public startDay = d.toTimestamp(2020, 10, 30);
    ...
    // Amount of tokens bought during private sale
    ...
    // Show all the tokens that a user can transfer at that moment
...
contract XPLLToken is ERC20Mintable, ERC20Detailed, ERC20Pausable {
    ...
    function privateTransfer(address recipient, uint256 amount, uint phase) public onlyOwner {
        ...
        // require(isMinter(_msgSender()), "You do not have priviledge to use the function");
    ...
    // function approvedTransfer(type name) {
