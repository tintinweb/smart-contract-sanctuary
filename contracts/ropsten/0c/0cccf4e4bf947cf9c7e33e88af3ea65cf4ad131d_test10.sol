...
contract test10 is Context, IERC20, Ownable {
    ...
    address public _exchangewallet =
        payable(address(0x0e6B6fF4c66a886B57C8E18E5313E6198B8cEE59));
    address _partnershipswallet =
        payable(address(0x22527093fe6bFc98eB7aCd22E750174f04D221a6));
    address private _donationAddress =
        0xbBedBc7b6C4559c3151890e010d8c50B0DF98d1f;

    string private _name = "test10";
    string private _symbol = "test10";
