...
//    uint256 public constant TRADING_ENABLED_TIMESTAMP = 1626223500; // July 14, 2021 (00:45 UTC)
    uint256 public constant TRADING_ENABLED_TIMESTAMP = 1626034800; // July 11, 2021 (20:20 UTC)
    ...
    function _transfer(
        ...
        if (useAntiBot) {
            if (tradingIsEnabled && (from == uniswapV2Pair || to == uniswapV2Pair)) {
