...
contract bizu is StandardToken, BurnableToken, Ownable {
    // Constants
    string  public constant name = "bizu";
    string  public constant symbol = "bzu";
    uint8   public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY      = 1000000000 * (10 ** uint256(decimals));

    uint public amountRaised;
    uint256 public buyPrice = 1212;
    bool public crowdsaleClosed;

    function bizu() public {
