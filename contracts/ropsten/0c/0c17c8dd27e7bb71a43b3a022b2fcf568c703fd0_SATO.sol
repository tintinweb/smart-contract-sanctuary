...
pragma solidity ^0.8.9;
    ...
    contract SATO is Context, IERC20, Ownable {
        ...
        string private _name = 'Satoru Inu';
        ...
        uint256 private _marketingFeeForSell = 8;
        uint256 private _previousTaxFee = _taxFee;
        uint256 private _previousmarketingFee = _marketingFee;
        uint256 private _previousmarketingFeeForSell = _marketingFeeForSell;

        address payable public _marketingWalletAddress = payable(0x6c9e9eFBb4D1d0b373d927437133761dB4cbF31e);
        ...
        uint256 private _numOfTokensToExchangeForCharity = _tTotal.div(10000);
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if(takeFee)
            {
                ...
                {
                    _marketingFee = _marketingFeeForSell;
                }
            }
        ...
        function _setSellMarketingFee(uint256 SellMarketingFee) external onlyOwner() {
         
            _marketingFeeForSell = SellMarketingFee;
        }
