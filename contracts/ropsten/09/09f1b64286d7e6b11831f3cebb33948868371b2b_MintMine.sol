...
contract MintMine is ERC20, REEPminting, REEPmining, Ownable {
    using SafeMath for uint256;

    string public name = "MintMine";
    string public symbol = "MINTNE";
...
//------------------------------------------------------------------------------------
    ...
    function mintingStart() public onlyOwner {
        ...
        require(mintingStartTime >= chainStartTime);
...
//------------------------------------------------------------------------------------
    ...
    function miningStart() public onlyOwner {
        ...
        require(miningStartTime >= chainStartTime);
        miningStartTime = now;
    }
