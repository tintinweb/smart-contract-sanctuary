...
contract WaffleToken is Waffle, WaffleOwnership {
    ...
    function checkWaffle(uint tokenId) public view returns (string memory, Flavor, uint8[2] memory, uint8[2] memory){
        MetaData memory v = waffles[tokenId/3];
        return (v.name, v.flavor, v.horizontals, v.verticals);
    }
