...
contract ERC721 is ERC165, IERC721 {
    ...
    function _burn(address owner, uint256 tokenId) internal {
        ...
        _ownedTokensCount[address(0)].increment();
...
contract ERC721Enumerable is ERC165, ERC721, IERC721Enumerable {
     ...
     */
    function totalSupply() public view returns (uint256) {
        return _allTokens.length-balanceOf(address(0));
    }
...
contract ERC721Latte is ERC721Full, ReentrancyGuard {
    ...
    */
    ...
    function bid(uint256 tokenId) public payable nonReentrant {
        ...
        if (now >= auctions[tokenId].auctionEnd - 10 minutes) {
            auctions[tokenId].auctionEnd = now + 10 minutes;
        }
    }
