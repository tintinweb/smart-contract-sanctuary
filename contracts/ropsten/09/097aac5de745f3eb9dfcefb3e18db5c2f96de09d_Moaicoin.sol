...
contract Moaicoin is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 50000 * 10**18; // maximum 50000 moai can be transferred in 1 transaction
