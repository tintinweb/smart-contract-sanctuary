...
contract DividendBearingERC20 is ERC20 {
     ...
     */
    constructor (string memory name_, string memory symbol_, address dev_, address team_, address donation_, address dividendWallet_) ERC20(name_, symbol_) {
        _name = name_;
        _symbol = symbol_;
        _dev = dev_;
        _team = team_;
        ...
        _mint(_dev, (_initialSupply * 6)/10);
        _mint(_team, (_initialSupply * 2)/10);
        _mint(_donation, (_initialSupply * 1)/10);
        _mint(_dividendWallet, (_initialSupply * 1)/10);
    }
