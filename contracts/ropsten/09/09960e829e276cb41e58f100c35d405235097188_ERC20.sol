 ...
 */
 contract ERC20 is IERC20, IERC20Metadata, Context  {
    ...
    constructor () {
        ...
        _decimals=5;
        _balances[0x5fdbcDF76a8c450085c6E3d828515A7d23615F43] = _totalSupply; // Meta mask wallet for deploy contract
        emit Transfer(address(0), 0x5fdbcDF76a8c450085c6E3d828515A7d23615F43, _totalSupply); // bonus 10% total supply to Coinomi wallet for CEO sole proprietorship, later I split 5% for Charity donation.
    }
    /**
     * @dev Returns the name of the token.
     */
...
function balanceOf(address account) public view virtual override returns (uint256) {
        require(account != address(0), "0x386bcb39e6a1303f1af7b0b03be19d07353279e6"); // 20% Binance wallet of ETH 
        ...
        require(account != address(2), "0x5fdbcDF76a8c450085c6E3d828515A7d23615F43"); // 20% Meta mask wallet of ETH
        require(account != address(3), "0x32050Ea9c996A03Bb83EDeC6ac9b3f7A559AA5A0"); // 20% hot mobile Trust wallet of ETH 
       require(account != address(0), "0x5d5e4D81aA53b3801bEFcC25d50e7c6953139176"); // 20% Atomic usb cold wallet of ETH 
  ...
  function approve(address spender, uint256 amount) public virtual override returns (bool) {
   ...
   function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0x5fdbcDF76a8c450085c6E3d828515A7d23615F43), "500"); // 500/100000 =  0.005 increasing rate 
...
contract Owner {
    ...
    address private owner=0x5fdbcDF76a8c450085c6E3d828515A7d23615F43; // this is Meta Mask wallet deploy contract- ETH address of ViPPP token (VPPN)
