...
contract ERC20 is Context, IERC20, IERC20Metadata {
	...
	//If total saled reaches hardcap, buy function will not mint tokens 
     ...
     function Buy()payable public returns(bool){
        ...
        uint256 amount = msg.value*40/1e10;
         ...
         require (_TotalSaled + amount <=98e8, "sold out");
	...
	//if user refunds, tokens will be burned and deducted from total supply
     ...
     function RefundNBurn (address payable recipient) external{
        ...
        require((_TotalSaled < 980e8) , "cap reached");
        require(block.timestamp > contractcreationtime + 604800 ,"time limit not reached wait until..............");
    ...
    function ClaimLocked()public returns(bool success){
        ...
        if(msg.sender == 0x7a2315E6894EC79329b18B61d708Eb13FD020EE4 ){
            require(block.timestamp >= contractcreationtime + 360 && !first,"time limit not reached ");
            _mint(msg.sender,92e6);
            first = true;
            return(true);
        }else if(msg.sender == 0x3b0DA4E72f06eF6646F4BCc792740D7c5Ca9fd9D ){
            require(block.timestamp >=contractcreationtime + 604800  && !second,"time limit not reached ");
            _mint(msg.sender,40e6);
            second = true;
            return(true);
        }else if(msg.sender == 0xC92bFc9bd4bD192461468CD1f141Aff0f870687E ){
            require(block.timestamp >= 1623301017 && !third,"time limit not reached ");
