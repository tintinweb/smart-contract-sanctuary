...
contract Escrow {
    ...
    function addProduct(address seller, string memory ProductName, uint ProductPrice, uint ProductQuantity, uint temp, uint humid) public onlySeller returns(bool){
