...
contract GelatoKrystal is ServicePostExecFee {
    ...
    function submit(
        ...
        Order memory order =
            Order({
                ...
                lastExecutionTime: block.timestamp // solhint-disable-line not-rely-on-time
            });
        ...
        returns (uint256 minReturn)
    {
        ...
        if (_order.minSlippage > timeSinceCanExec) {
            slippage = _order.minSlippage - timeSinceCanExec;
        }
        ...
        minReturn = idealReturn - ((idealReturn * slippage) / 10000);
    }
