...
contract Corporation {
    event SuperuserChanged(address indexed superuser, bool empowered);
    ...
    function changeSuperuser(address _operator, bool _empowered) external {
        require(
    ...
    // components.
    function createSeries(string memory _name)
        external
        returns (
            uint256 _seriesId,
