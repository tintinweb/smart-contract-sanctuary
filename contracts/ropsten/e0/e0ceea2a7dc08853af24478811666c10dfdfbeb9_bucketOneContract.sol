...
contract gameContract is usingOraclize, Mortal {
	...
	uint256 public callbackGas = 3000000; /* The gas amount required to call oraclize function */
...
contract bucketOneContract is Mortal {
	...
	/*bool public stopBet; stop betting when _callback of oraclize is called in game contract*/
	...
	function betbucketOne() public payable /*gameRunning*/ {
	...
	function resetBucket() public {
	    ...
	    //stopBet = false;/* stop betting when _callback of oraclize is called in game contract*/
	    totalBalance = 0;
	}
...
/*	modifier gameRunning {
	...
	function betbucketTwo() public payable /*gameRunning*/ {
		require (msg.value >= gameContractObject.getPrice());
		assert(gameContractObject.canBet());
		if (hasBet[msg.sender] == false) {
			betters.push(msg.sender);
