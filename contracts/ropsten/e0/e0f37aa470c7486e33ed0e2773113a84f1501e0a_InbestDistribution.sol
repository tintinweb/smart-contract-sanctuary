...
contract InbestToken is StandardToken {
  ...
  // TBD
  uint256 public constant INITIAL_SUPPLY = 14e11 * (10 ** uint256(decimals));
...
contract InbestDistribution is Ownable {
  ...
  // Total of tokens
  uint256 public constant INITIAL_SUPPLY   =    14e11 * DECIMALFACTOR; // 14.000.000.000 IBST
  // Total of available tokens
  uint256 public AVAILABLE_TOTAL_SUPPLY    =    14e11 * DECIMALFACTOR; // 14.000.000.000 IBST
  // Total of available tokens for presale allocations
  uint256 public AVAILABLE_PRESALE_SUPPLY  =    0.5e11 * DECIMALFACTOR; // 500.000.000 IBST, 18 months vesting, 6 months cliff
  // Total of available tokens for company allocation
  uint256 public AVAILABLE_COMPANY_SUPPLY  =    13.5e11 * DECIMALFACTOR; // 13.500.000.000 INST at token distribution event
