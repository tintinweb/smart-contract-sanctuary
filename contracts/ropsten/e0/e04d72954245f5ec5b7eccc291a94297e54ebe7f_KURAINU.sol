...
contract KURAINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500000000000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Kura Inu";
    string private _symbol = "KURA";
    ...
    address public CharityWallet = 0x0cD0a57607f39bAA35AF70DD5da8EC12cA54ac9E;
    ...
    uint256 public _maxTxAmount = 500000000000000000000000;
    ...
    constructor () public {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  // PCS V2 TESTNET
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);  // UNI V2 TESTNET
