...
contract swag is ERC20, ERC20Detailed, ERC20Burnable {

    constructor () public ERC20Detailed("SWAGGERverify", "VSWAG", 18) {
        _mint(msg.sender, 280000000000000000 * (10 ** uint256(decimals())));
    }
}