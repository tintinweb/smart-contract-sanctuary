...
contract TOURISTOKEN is ERC20Token, Ownable {
  ...
  function BitEyeToken() public {
    ...
    symbol = "TUS";
    decimals = 18;
    totalSupply = 777777777 * 1e18;
  }

  function distribute(address _TOURISTOKENAddr) public onlyOwner {
    require(!distributed);
    distributed = true;

    balances[_TOURISTOKENAddr] = 777777777 * 1e18;
    Transfer(address(0), _TOURISTOKENAddr, 777777777 * 1e18);
