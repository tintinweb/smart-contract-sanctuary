...
contract MovementDAONFT is Ownable, SignerRole, ERC1155Base {
    string public name;
...
contract MovementDAOMemberNFT is MovementDAONFT {
    event CreateERC1155_v1(address indexed creator, string name, string symbol);

    constructor(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) MovementDAONFT(name, symbol, signer, contractURI, tokenURIPrefix) public {
