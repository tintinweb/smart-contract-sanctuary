   ...
   //  * @param unitNumber : alphaNumeric value of the asset
    // */
      ...
      function buyAsset(
        ...
        uint256 fee = (initialAssetTokenAmount*feePercentage)/1000000;
        uint256 amountAfterAddingFee = initialAssetTokenAmount + fee;
        
        uint256 Discount = (amountAfterAddingFee*discountPercentage)/1000000;
        uint256 amountAfterAddingDiscount = amountAfterAddingFee - Discount;
        
        uint256 Tax = (amountAfterAddingDiscount*taxPercentage)/1000000;
