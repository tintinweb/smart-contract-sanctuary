...
contract Company {
    ...
    function create_Order(address payable buyer, uint256 stamp) public onlyVerifiedOwner returns(Order newContract)
  { 
  ...
  function ss() public view  returns(address d){                                         //remove both
    address fd=msg.sender;
    return fd;
}
