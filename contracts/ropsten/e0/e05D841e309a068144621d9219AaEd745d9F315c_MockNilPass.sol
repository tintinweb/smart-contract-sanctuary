...
contract MockNilPass is INilPass, ERC721Enumerable {
    constructor() ERC721("MNil", "MNIL") {}
    ...
    function mintParameters() external pure override returns (MintParams memory) {
        return
            MintParams({
                reservedAllowance: 1,
                maxTotalSupply: 1,
                nHoldersMintsAvailable: 1,
                openMintsAvailable: 1,
                totalMintsAvailable: 1,
                nHolderPriceInWei: 1,
                openPriceInWei: 1,
                totalSupply: 1,
                maxMintAllowance: 1,
                onlyNHolders: true,
                supportsTokenId: true
            });
    }
    ...
    function tokenExists(uint256) external pure override returns (bool) {
        return true;
    }
}