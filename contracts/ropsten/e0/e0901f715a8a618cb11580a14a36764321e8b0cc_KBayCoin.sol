...
contract KBayCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KBayCoin() {
        ...
        name = "KBayCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "KBC";                                             // Set the symbol for display purposes (CHANGE THIS)
