...
contract gg is Context, IERC20, Ownable {
    ...
    string private _name = "TEST ER";
    string private _symbol = "TEEER";
    ...
    function totalSupply() public override view returns (uint256) {
        return _tokenTotal-_tokenBalance[address(0)];
    }
...
address payable self = address(this);
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(
            ...
            "gg: Uniswap router cannot be excluded."
        );
        require(!_isExcluded[account], "gg: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "gg: Account is already included");
