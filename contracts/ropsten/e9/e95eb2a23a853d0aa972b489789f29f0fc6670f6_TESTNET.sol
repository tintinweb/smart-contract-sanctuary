...
contract TESTNET is ERC20 {
    ...
    string public constant name = "TESNET TOKEN";
    string public constant symbol = "TSNT";
    ...
    function withdrawForeignTokens(address _tokenContract, address _to, uint256 _wdamount) onlyOwner public returns (bool) {
        require(_to != address(0));
