...
// File: INafterRoyaltyRegistry.sol
...
abstract contract Context {
    function _msgSender() external view virtual returns (address payable) {
...
abstract contract AccessControl is Context {
    ...
    function grantRole(bytes32 role, address account) public virtual {
        require(hasRole(_roles[role].adminRole, msgSender()), "AccessControl: sender must be an admin to grant");
    ...
    function revokeRole(bytes32 role, address account) public virtual {
        require(hasRole(_roles[role].adminRole, msgSender()), "AccessControl: sender must be an admin to revoke");
...
// File: NafterRoyaltyRegistry.sol
