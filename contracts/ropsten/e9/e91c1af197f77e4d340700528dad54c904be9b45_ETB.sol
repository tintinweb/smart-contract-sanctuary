...
contract ETB {
  ...
  mapping(uint256=>uint256) private config_static_level_price;
  mapping(uint256=>uint256) private config_dynamic_level_price;
 ...
 //config end
  ...
  mapping(uint256=>uint256) private static_head_index;
  ...
  constructor() public payable{
      config_static_level_price[1]= 30;
      config_static_level_price[2] =60 ;
      config_static_level_price[3] =120 ;
      config_static_level_price[4] =240 ;
      config_static_level_price[5] =480 ;
      config_static_level_price[6] =960 ;
      config_static_level_price[7] =1920 ;
      config_static_level_price[8] =3840 ;
      config_static_level_price[9] =7680 ;
      config_static_level_price[10] =15360 ;
      
      config_dynamic_level_price[1] = 50;
      config_dynamic_level_price[2] = 80;
      config_dynamic_level_price[3] = 120;
      config_dynamic_level_price[4] = 200;
      config_dynamic_level_price[5] = 400;
      config_dynamic_level_price[6] = 800;
      config_dynamic_level_price[7] = 1600;
      config_dynamic_level_price[8] = 3200;
      config_dynamic_level_price[9] = 6400;
      config_dynamic_level_price[10] = 12800;
    ...
    function checkStaticValuePrice(uint256 invent_level) internal{
        uint256 pay_value = msg.value * 100;
         require(invent_level>0,"level can not be zero ");
        require(pay_value>=config_static_level_price[invent_level],"eth is small");
    }
    function checkDynamicValuePrice(uint256 invent_level) internal{
        uint256 pay_value = msg.value * 100;
         require(invent_level>0,"level can not be zero ");
         require(pay_value>=config_dynamic_level_price[invent_level],"eth is small");
    }
   ...
   function setStaticPrice(uint256 level,uint256 price) public {
       config_static_level_price[level] = price;
   }
    function setDynamicPrice(uint256 level,uint256 price) public {
       config_dynamic_level_price[level] = price;
   }
   ...
   function staticLevelPrice(uint256 level) public view returns(uint256){
       return config_static_level_price[level];
   }
    function dynamicLevelPrice(uint256 level) public view returns(uint256){
       return config_dynamic_level_price[level];
   }
  

  function staticInvest(uint256 invent_level) public payable{
  ...
  function staticWithDraw(uint256 invent_level) internal{
  ...
  function staticReward(address payable head_account,uint256 invent_level) internal{
        uint256 price = config_static_level_price[invent_level].div(100)*(10**18);
  ...
  function dynamicReward(address payable referr_address,uint256 invent_level) internal{
       uint256 price = config_dynamic_level_price[invent_level].div(100)*(10**18);
  ...
  function staticFutou(uint256 invent_level,address payable account) internal{
  ...
  function staticUser(uint256 level) public view returns(address account,uint256 back_num){
  ...
  function dynamicInvest(uint256 invent_level,address payable referr_address ) public payable{
      ...
      dynamic_level_address[referr_address].sonnum.add(1);
     
      dynamic_pay_total.add(msg.value);
  ...
  function sendStaticToken(address account,uint256 num) internal {
      token.safeTransfer(account,num);
      total_etbnum.add(num);
      static_sy_etb_total.add(num);
      static_sy_etb_address[account].add(num);
   ...
   function sendStaticValue(address payable recipient, uint256 amount) internal {
        ...
        (bool success, ) = recipient.call.value(amount)("");
        require(success, "Address: unable to send value, recipient may have reverted");
        static_sy_eth_address[recipient].add(amount);
        static_sy_eth_total.add(amount);
    }
  ...
  function sendDynamicToken(address account,uint256 num) internal {
      token.safeTransfer(account,num);
      total_etbnum.add(num);
      dynamic_sy_etb_address[account].add(num);
      dynamic_sy_etb_total.add(num);
    }
   function sendDynamicValue(address payable recipient, uint256 amount) internal {
        ...
        (bool success, ) = recipient.call.value(amount)("");
        require(success, "Address: unable to send value, recipient may have reverted");
        dynamic_sy_eth_address[recipient].add(amount);
        dynamic_sy_eth_total.add(amount);
    }
