...
contract UniProxy {
	...
	address private USDC = 0xDBC941fEc34e8965EbC4A25452ae7519d6BDfc4e;
	...
	function swapDAIForTokens(address buyToken, uint sellAmount, uint minBuyAmount) external {
		_swapTokensForTokens(DAI, buyToken, sellAmount, minBuyAmount);
	}

	function swapTokensForDAI(address sellToken, uint sellAmount, uint minBuyAmount) external {
		_swapTokensForTokens(sellToken, DAI, sellAmount, minBuyAmount);
	}

	function swapUSDCForTokens(address buyToken, uint sellAmount, uint minBuyAmount) external {
		_swapTokensForTokens(USDC, buyToken, sellAmount, minBuyAmount);
	}

	function swapTokensForUSDC(address sellToken, uint sellAmount, uint minBuyAmount) external {
		_swapTokensForTokens(sellToken, USDC, sellAmount, minBuyAmount);
	}
