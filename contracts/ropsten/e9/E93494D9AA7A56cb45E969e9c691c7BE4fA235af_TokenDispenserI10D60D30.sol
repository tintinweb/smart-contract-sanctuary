...
contract TokenDispenserI10D60D30 is TokenDispenserBase {
    ...
    uint public constant d1rate = d1VestRatio / 2 hours;
    uint public constant d2rate = d2VestRatio / 2 hours;

    constructor (address kine_, uint startTime_) public {
        kine = IERC20(kine_);
        startTime = startTime_;
        transferPaused = false;
        day1EndTime = startTime_.add(2 hours);
        day2EndTime = startTime_.add(4 hours);
    }
