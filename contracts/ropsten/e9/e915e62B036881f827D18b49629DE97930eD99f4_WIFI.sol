...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x82cdc6459300DFef2907526EdA98BC916e04F778), 4000);
        m_DidDeploy = true;
    }
...
contract WIFI is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "WIFI";
    string private m_Symbol = "WIFI";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 10000, 10000, m_ILOPublic);
        initTax();
