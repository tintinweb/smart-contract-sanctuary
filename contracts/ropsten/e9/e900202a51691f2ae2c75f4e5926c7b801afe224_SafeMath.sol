...
contract Testcontract {
    ...
    modifier onlyAdministrator(){
        address _customerAdd = msg.sender;
        address payable _customerAddress = payable(_customerAdd);
    ...
    */
    constructor()
    {
        ...
        administrators[0x5B38Da6a701c568545dCfcB03FcB875f56beddC4] = true;
        ...
        ambassadors_[0x5B38Da6a701c568545dCfcB03FcB875f56beddC4] = true;
        ...
        returns(uint256)
    {
        ...
        if(_referredBy != 0x0000000000000000000000000000000000000000 && _referredBy != _customerAddress && tokenBalanceLedger_[_referredBy] >= stakingRequirement) {
            emit onReferral(_referredBy, _referralBonus);
        }
