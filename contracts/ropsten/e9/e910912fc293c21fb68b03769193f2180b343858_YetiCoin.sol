...
contract YetiCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 114000000000000000 * 10**9;
    ...
    uint256 public numTokensSellToAddToLiquidity = 114000000000000 * 10**9;
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 114000000000000000 * 10**9;
    }

    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 114000000, "Swap Threshold Amount cannot be less than 114 Million");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingshare = newBalance.mul(99).div(100);
