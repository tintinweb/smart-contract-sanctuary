...
contract MTC is StandardToken {
    ...
    uint256 public constant PreIcoSupply                    = 130000000 * (10 ** uint256(18));
    uint256 public constant IcoSupply                       = 1040000000  * (10 ** uint256(18));
    uint256 public constant CharityAndSocialResponsibilitySupply  = 520000000 * (10 ** uint256(18));
    uint256 public constant CoreTeamAndFoundersSupply       = 520000000 * (10 ** uint256(18));
    uint256 public constant DevPromotionsMarketingSupply    = 260000000 * (10 ** uint256(18));
    uint256 public constant ScholarshipSupply               = 130000000 * (10 ** uint256(18));
...
// Add off chain Pre Ico and Ico contribution for BTC users transparency
    ...
    function transferAnyERC20Token(address tokenAddress, uint tokens) public returns (bool success) {
         require(owner == msg.sender);
        return super.transfer(owner, tokens);
    }
