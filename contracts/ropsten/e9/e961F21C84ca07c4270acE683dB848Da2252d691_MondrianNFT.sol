...
contract MondrianNFT is MasterCopy, ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    // address constant devPoolAddress=0xd979F42b2FF6151aD32C8F96BBceE68D1F8Eef92;  
     address  bidToken;//=0x00000000000045166C45aF0FC6E4Cf31D9E14B9A;  
    ...
    address  bonusPoolAddress;//=0xC37f3a8c511329C9028b8D82f491847256B56dE7;
    address  devPoolAddress;//=0xC37f3a8c511329C9028b8D82f491847256B56dE7;  
    ...
    constructor(address _bid) ERC721("Mondrian Minimized Version1", "NFT") Ownable() {
        bidToken=_bid;
