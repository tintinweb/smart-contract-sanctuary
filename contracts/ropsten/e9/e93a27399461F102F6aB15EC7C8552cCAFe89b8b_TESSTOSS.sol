...
contract TESSTOSS is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "TESSTOSS";
    string private constant _symbol   = "TESS";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 200; // % of every transaction is redistributed to holders
    uint256 public _liquidityFee = 400; // % of every transaction will be converted into BNB. Within that 5%, 3% will go towards charitable donations and 2% will go towards marketing and the team
    uint256 public _burnFee      = 400; // % of every transaction is burned
