...
contract Reep_Demos is ERC20, REEPminting, Ownable {
    using SafeMath for uint256;

    string public name = "Reep_Demos";
    string public symbol = "REEPOS";
...
//------------------------------------------------------------------------------------
    ...
    uint public lockTime = 2190 hours; //Locking time before withdraw after deposit
    ...
    function withdraw(uint depositWithdraw) public {
    ...
    function miningREEP(address account) internal {
        uint coinMining = getREEPmining(account);
        account = msg.sender;
