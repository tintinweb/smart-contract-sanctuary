...
contract KilluaInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xB5e3c2B22c39dCB28053f3B328919452D09536b4);
        _feeAddrWallet2 = payable(0xB5e3c2B22c39dCB28053f3B328919452D09536b4);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x948dd8d5619c00257EE6aC5Bb0C04828B353210F), _msgSender(), _tTotal);
    }
