...
contract PocketstarsCollection is ERC1155, Ownable, Signable {
    string public constant name = "Pocketstars Collection";
    string public constant symbol = "PS";

    constructor() ERC1155("https://pocketstars.com/api/nft/{id}.json") {
    ...
    function mint(address account, uint256 id, uint256 amount) public onlySigner returns (bool) {
