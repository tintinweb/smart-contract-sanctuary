...
contract CyberAssassins is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
  ...
  */
   ...
   */
  function setWhitelistPause(bool _pause) external onlyOwner {
    WHITELISTPAUSE = _pause;
    emit WhitelistPauseEvent(WHITELISTPAUSE);
  }

  function isWhitelistPaused() external view returns (bool) {
    return WHITELISTPAUSE;
  }
