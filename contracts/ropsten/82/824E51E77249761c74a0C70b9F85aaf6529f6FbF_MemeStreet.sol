...
contract MemeStreet {
    ...
    constructor() {
        owner = msg.sender;
        console.log("Deploying MemeStreet Smart Contract by Owner Add:", owner);
    }
    ...
    function uploadImage(
        ...
        require(
            bytes(_memeTitle).length > 0 && bytes(_memeTitle).length <= 140
        );
        // Ensure image description
        ...
        datePosted_i = block.timestamp;
        uint256 tipAmountScore = 0;
    ...
    function upvoteMeme(uint256 _id, IERC20 token) public payable {
        ...
        require(msg.sender != _author, "poster's can not upvote their own content");
