...
contract PartyFactory is Ownable {
    ...
    function createParty(
        ...
        emit CreateEvent(msg.sender, _partyInfo.partyName, _partyInfo.idParty, _partyInfo.ownerId);
    ...
    function deposit(address _partyAddress, uint256 _amount) external{
    ...
    function closeParty(address _partyAddress, Party.Sig memory _closeRSV) external {
