...
contract Meditoken is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 350000000000000000 * 10**9; //3.5
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address payable private charityWallet = payable(0x6c79496140848FaCa2721139bD7C7A4eBD9B2e4C);
    address payable private devWallet = payable(0x6c3116da9054aE64E89284aaC5248415E2f55ee4);
    address payable private marketingWallet = payable(0x0FE2A7Ba7f4451c35E7b782828D91E697F857bD6);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        devWallet.transfer(amount.mul(_feeDevMarketing).div(_feeCharity + _feeDevMarketing).div(2));
        marketingWallet.transfer(amount.mul(_feeDevMarketing).div(_feeCharity + _feeDevMarketing).div(2));
    }
