...
contract MockERC20 is ERC20Burnable , DSPausable{
    //address _owner;
    constructor(uint256 initialSupply,string memory tokenName,string memory tokenSymbol,uint8 decimals, address ownable) public
        ERC20(tokenName, tokenSymbol)  DSPausable()
    {
...
// File: instances/MockVaultToken.sol

pragma solidity ^0.6.12;


contract MockVaultToken is MockERC20 {
    constructor()
        public
        MockERC20(
            0,
