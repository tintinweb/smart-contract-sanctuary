...
//testing with the two address for owner2 and owne3
 ...
 // function to transfer the funds to founders account
  function fundTransfer(uint256 weiAmount) internal {
     require ((msg.sender == addrToWhitelist1 && weiAmount <= 1 ) || 
             ( msg.sender == addrToWhitelist2 && weiAmount >=1 || weiAmount<=3 )||
             (msg.sender == addrToWhitelist3 && weiAmount >=3 || weiAmount<=5),"address is not valid");
