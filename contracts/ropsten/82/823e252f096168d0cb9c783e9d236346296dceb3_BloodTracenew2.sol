...
contract BloodTracenew2 {
   ...
   struct Bloodprovided {
    ...
    event donoradd(uint _did, string  _dname, string  _dgender, uint _dage, uint _dweight, string  _bloodtype, bool _donated);
    ...
    function addDonor(string memory _dname, string memory _dgender, uint _dage, uint _dweight, string memory _bloodtype) public 
    {
              ...
              emit donoradd(donorCount, _dname,  _dgender, _dage, _dweight, _bloodtype,false);
    }
