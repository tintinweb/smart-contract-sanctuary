...
// hevm: flattened sources of contracts/ERC721Adaptor.sol
...
contract ERC721Adaptor is PausableDSAuth, SettingIds {
    ...
    */
    ...
    function changeOrininNft(address _originNft) public auth {
        originNft = ERC721(_originNft);
    }
