...
//==============================================================================
    constructor()
        public
    {
        PoEIFContract = PoEIF(0x5706E4602643eFd7c49D1E25e4e32BD1a3eb1A41);
        PlayerBook = PlayerBookInterface(0x89F89e569C8021D0579092e7Db40751635eE97Db);
...
function calcMult(uint256 keysBought, bool validIncrease) internal returns (bool)
{
	...
	if ((thresholdReached || multLinear == 2) && validIncrease) {
	    ...
	    //now apply increase
	        ...
	        if (multCurrent > 1000000) multCurrent = 1000000;
	    }
    }
