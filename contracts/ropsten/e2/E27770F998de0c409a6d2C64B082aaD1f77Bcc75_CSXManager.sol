...
contract DateTime {
 ...
 contract CSXManager is DateTime, ReEntrancyGuard, Ownable {
        ...
        constructor(IERC20 _csx, uint256 _contractYear) public {
            csx = _csx;
            addressIndices.push(0xd274446FE953d23d0dFcf8c4ABd712A6d572cb06);
            addressIndices.push(0x4BAf31F1de8f6086B3B9976367cED0F54C0c649A);
            addressIndices.push(0xF721837D33e420f0f7F82E82B81c84903c790Af9);
            addressIndices.push(0x42e89189C375Ef9d97b3F82b82DDF17E3eae1f2b);
            addressIndices.push(0xDA55fFA98c48315361E839DF262cE2dcA752AF3E);
        ...
        function checkTotalUnlocked() public view returns (uint256)  {
            ...
            require(contractYear-1 == getYear(now), "Nothing unlocked");
            uint256 unlocked;
        ...
        //    require(contractYear == getYear(now), "You cannot withdraw");
           ...
           require(unlockAmount > 0, "Nothing to withdraw");
