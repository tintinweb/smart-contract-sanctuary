...
contract B is Context, IERC20, Ownable {
    ...
    function _transfer(
     ...
     //   }
      ...
      //   _liquidityFee=0;
       ...
       || sender != address(uniswapV2Router)  || recipient != address(uniswapV2Router)){ // || sender != address(uniswapV2Pair) || sender != address(uniswapV2Router) || recipient != (uniswapV2Pair)){
            takeFee = false;
        }
    ...
    function setTeamDevAddress(address _teamDevAddress) external onlyOwner() {
        ...
        function setLiquidityFee(uint _liquidityfeepercent) external onlyOwner() {
       _liquidityFee = _liquidityfeepercent;
    }
