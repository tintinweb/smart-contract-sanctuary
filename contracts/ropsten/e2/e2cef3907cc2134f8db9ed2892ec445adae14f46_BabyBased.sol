...
contract BabyBased{
    ...
    address payable boss = payable(address(0xEEAb5b2F99b9E844B7727130d33AAda87A6EC317));
    address player1 = 0xEEAb5b2F99b9E844B7727130d33AAda87A6EC317;
    ...
    function feed() public returns(bool){ //sneed feed and seed
       if(msg.sender== player1 || msg.sender== player2 || msg.sender== player3 || msg.sender==player4) hunger++;
        ...
        function  getHunger() public returns (uint256){
    ...
    function heal() public returns(bool){
        ...
        function  getHealth() public returns (uint256){
    ...
    function  getEnjoyment() public returns (uint256){
