...
contract LAPTOPTOKEN is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LAPTOPTOKEN() {
        ...
        name = "LAPTOPTOKEN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LTT";                                             // Set the symbol for display purposes (CHANGE THIS)
