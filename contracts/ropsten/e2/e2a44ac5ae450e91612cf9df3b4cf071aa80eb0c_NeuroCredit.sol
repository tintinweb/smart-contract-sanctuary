...
/// @notice This contract mints Neuro Credits for bloot holders and provides
/// administrative functions to the bloot DAO. It allows:
/// * gear holders to claim Based Credits
/// * A DAO to set seasons for new opportunities to claim Neuro Credits
/// * A DAO to mint Neuro Credits for use within the bloot ecosystem
/// @custom:unaudited This contract has not been audited. Use at your own risk.
contract NeuroCredit is Context, Ownable, ERC20 {
    // bloot contract is available at https://etherscan.io/address/0xff796cbbe32b2150a4585a3791cadb213d0f35a3
    address public gearContractAddress =
        0x0F0516B372B4ABC788C706c56C9AED17FB5E84d8;
    IERC721Enumerable public gearContract;

    // Give out 10,000 Neuro Credit for every bloot Bag that a user holds
    ...
    */
    ...
    /// @notice Claim Neuro Credits for a given bloot ID
    ...
    /// @param gearContractAddress_ The new contract address for bloot
