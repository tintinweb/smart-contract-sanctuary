...
contract SatoshiART1155 is ERC1155, AccessControl {
    ...
    function tokenCount(uint256 _id) external view returns (uint256) {
        return _token[_id].count;
    }
