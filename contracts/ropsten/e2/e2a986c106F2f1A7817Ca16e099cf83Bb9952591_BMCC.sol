 ...
 * operation overflows.
 *
 * Using this library instead of the unchecked operations elBMCCnates an entire
...
library SafeMath {
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    // Gas optBMCCzation: this is cheaper than requiring 'a' not being zero, but the
...
contract BMCC is Context, IBEP20, Ownable, LGEWhitelisted {
