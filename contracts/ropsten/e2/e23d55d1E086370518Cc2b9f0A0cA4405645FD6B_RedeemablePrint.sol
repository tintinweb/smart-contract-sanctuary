...
contract RedeemablePrint {
    ...
    mapping(address => mapping(uint256 => string)) public productName;
    ...
    function getProductName(address genArtCoreAddress, uint256 projectId) public view onlyGenArtWhitelist returns(string memory _productName) {
    ...
    function getOrderInfo(address genArtCoreAddress, uint256 tokenId, uint256 redemptionCount) public view returns(address redeemer, string memory _productName, string memory variant, uint256 priceInWei) {
    ...
    function incrementRedemptionAmount(address redeemer, address genArtCoreAddress, uint256 tokenId, uint256 variationId) public onlyRedemptionService {
        ...
        string memory _productName = productName[genArtCoreAddress][projectId];
