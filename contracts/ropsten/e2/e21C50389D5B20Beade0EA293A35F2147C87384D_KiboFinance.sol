...
library KiboConstants {
    ...
    IERC20 constant public usdtToken = IERC20(0x28a4399F5056a074dA5FBD7a24a9b3Ad0737a33c);
}
...
contract KiboFinance is KiboFees, KiboRewards, KiboCompound, KiboStorage, KiboAdmin {
    ...
    function _TEST_APPROVE(address _token, address _spender, uint256 _amount) public {
