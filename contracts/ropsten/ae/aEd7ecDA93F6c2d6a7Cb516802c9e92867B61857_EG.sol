...
contract EG is ERC721 {
    uint256 constant SALE_PRICE = 100000000000000000; // 0.05 ether
    ...
    function mint() public payable returns (uint256) {
        ...
        require(_tokenIds.current() < 1024, "Max supply is 1024");
        ...
        _seeds[newTokenId] = "0x123";
        _transfers[newTokenId] = 1;
