...
//    event NewCommunist(address account);
    ...
    string private _name = "Marx10";
    string private _symbol = "MARX10";
   ...
   function withdrawDividends1(address communist) public isCommunist(msg.sender) {
        require(balanceOf(communist) > 0,"MARX: Communist non detected");
        require(balanceOf(dividendsAccount) > 0, "MARX: Dividends non detected");
        uint256 _dividends = balanceOf(dividendsAccount);
        //uint256 myDividends = _dividends.div(_accounts.length);
        uint256 myDividends = _dividends.div(10);
        _transfer(dividendsAccount, communist, myDividends);
        
        emit DividendPayment(communist, myDividends);
    }
    
       function withdrawDividends2(address communist) public isCommunist(msg.sender) {
        require(balanceOf(communist) > 0,"MARX: Communist non detected");
        require(balanceOf(dividendsAccount) > 0, "MARX: Dividends non detected");
        uint256 _dividends = balanceOf(dividendsAccount);
        uint256 myDividends = _dividends.div(_accounts.length);
   ...
   function withdrawDividends3(address communist) public isCommunist(msg.sender) {
        require(balanceOf(communist) > 0,"MARX: Communist non detected");
        require(balanceOf(dividendsAccount) > 0, "MARX: Dividends non detected");
        uint256 _dividends = balanceOf(dividendsAccount);
        //uint256 myDividends = _dividends.div(_accounts.length);
