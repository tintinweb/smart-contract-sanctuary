...
contract LibertyNFT is ERC721Pausable, AccessControl, Ownable {
    ...
    event BlurToken(uint256 indexed tokenId, uint256 updateTime);
    event ResetToken(uint256 indexed tokenId, uint256 updateTime);
    ...
    function blurNFT(uint256 tokenId) public whenNotPaused {
        ...
        liberty.blur = true;
        liberty.updateTime = block.timestamp;
        emit BlurToken(tokenId, block.timestamp);
    }
    ...
    function resetNFT(uint256 tokenId) public {
        ...
        liberty.blur = false;
        liberty.updateTime = block.timestamp;
        emit ResetToken(tokenId, block.timestamp);
    }
