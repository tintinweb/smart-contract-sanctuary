...
contract IMI is Context, IERC20, Ownable {
    ...
    string private _name = "IMI";
    string private _symbol = "IMI";
    ...
    address public charityWallet = 0xe04e714859293ABA69ba39a8D57257c915fa1c9a;
    ...
    function setIMICharityWallet(address newWallet) external onlyOwner() {
