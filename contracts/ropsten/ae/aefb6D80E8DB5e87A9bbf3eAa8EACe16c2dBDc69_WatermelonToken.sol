...
import "../NFT/interfaces/BeepBoopNFTInterfaceUser.sol";

/**
 * @title BeepBoop contract
...
contract WatermelonToken is ERC20PresetMinterPauserUpgradeable {
    ...
    BeepBoopNFTInterfaceUser public diamondNFT;
    ...
    function setNFTContractAddress(address _address) external {
        ...
        diamondNFT = BeepBoopNFTInterfaceUser(_address);
    }
...
/**
 * @title BeepBoop NFT Interface
 * @dev Extends ERC721 Non-Fungible Token Standard basic interface
 */
interface BeepBoopNFTInterfaceUser {
    ...
    /*
     * Get's the max token mint per transaction
     */
    function getMaxTokenMintPerTransaction() external view returns (uint);
