...
contract Voting {
    ...
    function getElection(address _organiser_address, uint _election_id) public view returns (uint, string, address[]) {
        return (election_serials[_organiser_address].elections[_election_id].id,
            election_serials[_organiser_address].elections[_election_id].election_title, 
            election_serials[_organiser_address].elections[_election_id].all_candidates);
    }
