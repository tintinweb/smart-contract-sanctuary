...
contract Defly is Ownable, IERC20 {
    ...
    function monthlock(uint256 amount) public virtual {
    ...
    function weeklock(uint256 amount) public virtual {
        address user = _msgSender();
        uint256 lockAmount = amount;
        uint256 timestamp = block.timestamp;
        uint256 unlockTimestamp = timestamp.add(7 days);
