    ...
    AbstractSlasher
{
    ...
    function _transferProfit(uint256 tokenId, bool onlyProfit) internal {
        ...
        uint256 bmiStakingProfit = _getSlashed(
            totalProfit,
            liquidityMining.startLiquidityMiningTime()
        );
    ...
    function restakeBMIProfit(uint256 tokenId) public override {
        ...
        uint256 totalProfit = rewardsGenerator.withdrawReward(
            _stakersPool[tokenId].policyBookAddress,
            tokenId
        );
