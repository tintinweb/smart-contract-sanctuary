...
contract SnipePl0x is Context, IERC20, Ownable {
    ...
    uint256 private startingSupply = 1_337; //1 Quadrillion, underscores aid readability
    ...
    string private _symbol = "SnipeItHardBaby_JustLikeThat_omg_soooo_fast";
