...
contract ASHMO is ERC20 {
    string public constant symbol = "JAM";
    string public constant name = "ASHMO";
    ...
    //the creater of the contract has the total supply and no one can create tokens
    constructor() public {
        __balanceOf[msg.sender] = __totalSupply;
    }
    
    //  constant value that does not change/  returns the amount of initial tokents to display
    ...
    // allows a spender address to spend a specif amount of value
    function approve(address _spender, uint _value) external returns (bool success) {
