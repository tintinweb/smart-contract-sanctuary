...
contract malangtoken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function malangtoken() {
        ...
        name = "malangtoken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "mlg";                                             // Set the symbol for display purposes (CHANGE THIS)
