...
contract Token is ERC20Capped, ERC20Burnable, ERC1363, Roles, TokenRecover {
     ...
     */
    modifier canMint() {
        require(!_mintingFinished, "ACXToken: minting is finished");
        _;
    }
    ...
    modifier canTransfer(address from) {
        require(
            ...
            "ACXToken: transfer is not enabled or from does not have the OPERATOR role"
        );
        _;
    }
        ...
        ERC1363(name, symbol)
    {
        require(
            ...
            "ACXToken: if finish minting, cap must be equal to initialSupply"
        );
