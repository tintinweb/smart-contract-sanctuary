 ...
 * this contract.
 */
contract BetaRYPToken is StandardToken, Pausable {

  string public constant name = 'BetaRYP';                              // Set the token name for display
  string public constant symbol = 'BRYP';                                  // Set the token symbol for display
