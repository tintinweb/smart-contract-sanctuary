...
contract MyToken is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function MyToken(uint _sellRate,uint _buyRate,string _symbo1,string _name,uint _endTime) public payable {
    ...
    // set rate
    function setConfig(uint _buyRate,uint _sellRate,string _symbol,string _name,uint _endTime) public onlyOwner {
