...
contract PhotoNFTTradable {
     ...
     */
    function transferOwnershipOfPhotoNFT(PhotoNFT _photoNFT, uint256 _photoId, address _buyer) public payable {
    ...
    function _updateSeller(PhotoNFT photoNFT, uint256 _photoId, address _newSeller)  public payable {
        Trade storage trade = trades[_photoId];
...
// File: contracts/PhotoConsole.sol
...
contract PhotoNFTMarketplace is PhotoNFTTradable, PhotoNFTMarketplaceEvents {
    ...
    function getPhotoNFTPrice(PhotoNFT _photoNFT) public view returns  (uint256) {
 ...
 function getTradeSell(PhotoNFT photoNFT, uint256 _photoId) public payable returns (address,address){
        photoNFTData.updateStatus(photoNFT, "Open");

        Trade storage trade = trades[_photoId];
        return (trade.seller,msg.sender);
