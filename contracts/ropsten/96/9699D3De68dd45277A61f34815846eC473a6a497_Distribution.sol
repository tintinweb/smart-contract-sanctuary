...
function transferToUser( address _contractAddress,address _userAddress,uint _amount) public onlyOwner {
   IERC20(_tokenAddress).transferFrom(_contractAddress , _userAddress , _amount);
