...
interface IMultiToken {
    function tieCombo(string memory _NLIS, uint256 _amount) external;
    function transferToMulti(uint256 amount) external;
    function transferFromMulti(uint256 amount) external;
    function getMultiAssets(address owner, uint256 tokenID) external returns(uint256, uint256);
    function getUserTokenPool(address user) external returns(uint256);
    function userPool(address user) external returns(uint256, uint256);
    function allMultiTokens(address user) external returns(uint256[] memory); 
