...
// File contracts/HotProspectsToken.sol
...
/**
 * @dev {HotProspectsCRM} token, including:
 *
...
contract HotProspectsCRM is Context, AccessControlEnumerable, ERC20, Pausable {
   ...
   */
  constructor() ERC20("HotProspectsCRM", "CRM") {
