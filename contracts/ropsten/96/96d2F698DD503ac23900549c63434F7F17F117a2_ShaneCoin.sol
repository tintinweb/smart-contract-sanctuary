...
// File: gist-99fa090066a23acd961590f25bfbb5e4/contracts/shanecoin/ABDKMath64x64.sol
...
// File: gist-99fa090066a23acd961590f25bfbb5e4/contracts/shanecoin/ShaneCoin.sol
...
contract ShaneCoin is IERC20, BaseRelayRecipient, AccessControl {
    ...
    constructor(address QUICKSWAP, address MATIC) {
        theTotalSupply = 0;
        name = "ShaneCoin";
        symbol = "SHANE";
        ...
        thePaymaster = new ShaneCoinPaymaster(ISwapRouter(QUICKSWAP), this, MATIC);
        _setupRole(MINTER_ROLE, address(thePaymaster));
    }
...
contract ShaneCoinPaymaster is BasePaymaster {
    ...
    constructor(ISwapRouter _swapRouter, ShaneCoin _shanecoin, address _matic) {
