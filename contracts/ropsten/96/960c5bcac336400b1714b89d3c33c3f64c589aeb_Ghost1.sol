...
contract Ghost1 is Context, IERC20, Ownable {
    ...
    string private _name = 'Ghost1';
    string private _symbol = 'Ghst1';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (contractTokenBalance >= _numTokensSellToAddToLiquidity && DynamicTaxEnabled){
