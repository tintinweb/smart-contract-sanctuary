...
contract game{
    ...
    mapping(bytes32 => Moves) moves;
    mapping(bytes32 => ChallengeState) pendingGame;
    mapping(address => uint) moneys;
    mapping(bytes32 => mapping(bytes32 => EvalState)) evulationMapping;
    address owner;
