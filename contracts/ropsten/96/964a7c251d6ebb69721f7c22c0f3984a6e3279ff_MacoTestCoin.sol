...
contract MacoTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MacoTestCoin() {
        ...
        name = "Maco";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MCX";                                             // Set the symbol for display purposes (CHANGE THIS)
