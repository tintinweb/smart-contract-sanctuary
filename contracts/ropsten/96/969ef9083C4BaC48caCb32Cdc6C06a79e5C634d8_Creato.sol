...
// File: contracts/ICreatoMarketAuction.sol



pragma solidity 0.6.12;

interface ICreatoMarketAuction {
    /**
...
contract Creato is ERC1155, Ownable, ICreato {
    ...
    ICreatoMarketAuction marketAuction;
    IMarketplaceSettings marketplaceSettings;
    ICreatoRoyaltyRegistry royaltyRegistry;
    ICreatoTokenCreatorRegistry tokenCreatorRigistry;
    ...
    function restore(address _oldAddress, uint256 _startIndex, uint256 _endIndex) external onlyOwner {
        Creato oldContract = Creato(_oldAddress);
    ...
    function setMarketAddresses(address _marketAuction, address _marketplaceSettings, address _tokenCreatorRigistry, address _royaltyRegistry) external onlyOwner {
        marketAuction = ICreatoMarketAuction(_marketAuction);
        marketplaceSettings = IMarketplaceSettings(_marketplaceSettings);
        tokenCreatorRigistry = ICreatoTokenCreatorRegistry(_tokenCreatorRigistry);
        royaltyRegistry = ICreatoRoyaltyRegistry(_royaltyRegistry);
    }
