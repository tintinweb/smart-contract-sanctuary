...
contract FutureTokenFactory is IFutureTokenFactory, Ownable {
    ...
    mapping(address => mapping(address => mapping(uint256 => address))) futureToken;  // To be replaced
    ...
    function getFutureToken(address tokenIn, address tokenOut, uint256 expiryDate) public override view returns(address) {
        ...
        //}
        //return address(0);
        return futureToken[tokenIn][tokenOut][expiryDate];
    }
    ...
    //        hex'ff',
    //        address(this),
    //        keccak256(abi.encodePacked(tokenIn, tokenOut, expiryDate)),
    //        keccak256(type(FutureToken).creationCode)
    //    ))));
    //}
    ...
    function createFutureToken(
        ...
        futureToken[tokenIn][tokenOut][expiryDate] = futureTokenAddress;
    }
