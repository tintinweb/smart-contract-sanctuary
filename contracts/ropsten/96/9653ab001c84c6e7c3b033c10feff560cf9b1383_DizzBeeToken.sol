...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0xb3EA6E6196C6Eb6AF85936aD0054Ac6222DFdf11;
...
contract DizzBeeToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    uint256 Rate = 1000000000;

    string private _name = "DizzBeeToken";
    ...
    uint256 internal _tokenTotal = 2000000000000000*(10**decimals());
    ...
    uint256 public _taxFee = 3; // means 5% which distribute to all holders
    uint256 public _liquidityFee = 3; // means 5% add liquidity on each buy and sell
    uint256 public _burnFee = 2; // means 0% it menas no burn 
    
    
    
    address preSale =0xA6b8b86F3bA88eE00f73D05E552c326fa3198dcD;
    ...
    //     uniswapV2Router = _uniswapV2Router;
        ...
        _reflectionBalance[owner()] = reflectionFromToken(1500000000000000e9,false);
        _reflectionBalance[preSale] = reflectionFromToken(500000000000000e9,false);
        
        emit Transfer(address(0),owner(), 1500000000000000e9);
