...
pragma solidity 0.6.12;
    ...
    */
    ...
    contract GCBVault is Ownable {
        ...
        address public constant tokenAddress = 0x0CdcE124f5fe4Fa30394e9A6b9EEb40F3fCB19cC;
        
        uint public vaultLimit = 1e21;
        ...
        function oneDeposit(uint _amount) public  returns (bool)   {
                    ...
                    require(vaultLimit >= amount , "Can't deposit more than limit") ;
                    ...
                    vaultLimit = vaultLimit.sub(amount) ;
