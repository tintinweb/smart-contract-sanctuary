...
//     _symbol = symbol_;
       ...
       _kingsize = 700;
       _micropenis = 300;
       _limitICO = 700000000; //setup_limitICO(700000000);
       _ratioInchPerEther = 200; //setup_ratioInchPerEther(200); //averege 10$
...
//real length of champion
    ...
    function isNew(address to) internal virtual returns (bool){
...
// Size without decimals
    function mySizeInInch() public  view virtual returns (uint256) {
        return balanceOf(_msgSender()).div(10**_decimals);
    }
    
// Size in centimeters without decimals
    function mySizeInCM() public  view virtual returns (uint256) {
