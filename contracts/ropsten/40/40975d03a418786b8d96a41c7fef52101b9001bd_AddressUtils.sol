...
/**
 * @title EthereumPsy
 * EthereumPsy - a non-fungible token smart contract for 
 * paintings from the www.eth.hn collection
 */
contract EthereumPsy is ERC721Token, Ownable {

    // Token id to painting image file hash mapping
    mapping (uint256 => uint256) public tokenIdToHash;

    constructor() ERC721Token("EthereumPsy", "ETHN") public { }
