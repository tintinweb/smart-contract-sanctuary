...
contract TokenWithdrawable is Ownable {
    ...
    /**
     * @notice Blacklist a token to be withdrawn
     */
    ...
    /**
     * @notice Withdraw IERC20 compatible token
     */
    function withdrawToken(IERC20 _token, uint256 _amount, address _to) external onlyOwner {
        require(!tokenBlacklist[address(_token)], "Withdrawable: Forbid to withdraw blacklisted token");
