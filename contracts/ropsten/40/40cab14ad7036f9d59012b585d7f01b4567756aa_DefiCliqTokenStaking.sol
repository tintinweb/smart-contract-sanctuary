...
contract DefiCliqTokenStaking {
  ...
  uint256 constant public WITHDRAW_TIME_GOLD       = 30 ;   // variable constant to manage withdraw time lock up
  uint256 constant public WITHDRAW_TIME_PLATINUM   = 45 ;   // variable constant to manage withdraw time lock up
  uint256 constant public TOKEN_REWARD_PERCENT_SILVER    = 1740084;      // variable constant to manage token reward percentage for silver
  uint256 constant public TOKEN_REWARD_PERCENT_GOLD      = 4735920;      // variable constant to manage token reward percentage for gold
  uint256 constant public TOKEN_REWARD_PERCENT_PLATINUM  = 11217430;     // variable constant to manage token reward percentage for platinum
  uint256 constant public TOKEN_PENALTY_PERCENT_SILVER   = 870042;       // variable constant to manage token penalty percentage for silver
  uint256 constant public TOKEN_PENALTY_PERCENT_GOLD     = 2367960;      // variable constant to manage token penalty percentage for silver
  uint256 constant public TOKEN_PENALTY_PERCENT_PLATINUM = 5608715;      // variable constant to manage token penalty percentage for silver
