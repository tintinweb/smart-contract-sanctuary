...
contract APOLO is Context, IERC20, Ownable {
    ...
    string private _name = "APOLLO Protocol_TESTnet";
    string private _symbol = "ASPO2";
    ...
    constructor(address burnWallet_, address _dev) public {
    ...
    function _transfer(
        ...
        if(tradingEnabled && lastTaxDecreasedTime != 0 && now > lastTaxDecreasedTime + 7 days && _taxFee > 200 && _liquidityFee > 200){
