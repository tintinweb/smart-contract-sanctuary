...
** Using FTP ILO to provide up to 1.42% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract ILOTest is Context, IERC20, Taxable {
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1420, 300, m_ILOPublic);
        initTax();
