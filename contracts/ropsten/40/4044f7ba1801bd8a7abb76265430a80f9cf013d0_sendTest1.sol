...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory sendTest1_, string memory ST1_) {
        _sendTest1 = sendTest1_;
        _ST1 = ST1_;
...
*/
     ...
     *
     * This is an ST1ernative to {approve} that can be used as a mitigation for
...
/**
 * @dev Contract for sendTest1 token
 */
contract sendTest1 is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 1_000_000_000e18;

    constructor() ERC20("sendTest1", "ST1") {
