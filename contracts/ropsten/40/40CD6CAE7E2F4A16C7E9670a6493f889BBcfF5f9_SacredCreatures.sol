...
contract SacredCreatures is ERC721Enumerable, ReentrancyGuard, Ownable  {
    ...
    function _createCreature(uint256 _tokenId, string memory _name) internal {
        ...
        creatures[_tokenId].defense = randomFromString(string(abi.encodePacked("defense", toString(_tokenId), family)), rangeValues.defenseMax - rangeValues.defenseMin) + rangeValues.defenseMin;
        creatures[_tokenId].attack = randomFromString(string(abi.encodePacked("attack", toString(_tokenId), family)), rangeValues.attackMax - rangeValues.attackMin) + rangeValues.attackMin;
        creatures[_tokenId].soul = randomFromString(string(abi.encodePacked("soul", toString(_tokenId), family)), rangeValues.soulMax - rangeValues.soulMin) + rangeValues.soulMin;
        creatures[_tokenId].wisdom = randomFromString(string(abi.encodePacked("wisdom", toString(_tokenId), family)), rangeValues.wisdomMax - rangeValues.wisdomMin) + rangeValues.wisdomMin;
