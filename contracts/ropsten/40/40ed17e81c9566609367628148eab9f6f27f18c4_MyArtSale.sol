...
contract MyArtSale is  NFTokenMetadata, Ownable {
  uint256 public tokenCounter = 1000000;
    ...
    external payable
  {
    ...
    priceOfTokenId[newNFTTokenId] = _price;
    
    super._mint(_to, newNFTTokenId);
    super._setTokenUri(newNFTTokenId, _uri);
  ...
  function setPrice(uint256 _tokenId, uint256 _price) public onlyOwner {
    priceOfTokenId[_tokenId] = _price;
  }
