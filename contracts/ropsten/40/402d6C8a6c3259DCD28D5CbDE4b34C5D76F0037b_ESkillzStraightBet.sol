...
contract ESkillzStraightBet is Ownable {
    ...
    uint256 [] private table_fee = new uint[](0); // 0 => amatuer, 1 => professional, 2 => championship
    ...
    function getDistrubuteAmount(uint256 game_id) public returns(uint256, uint256, uint256) {
