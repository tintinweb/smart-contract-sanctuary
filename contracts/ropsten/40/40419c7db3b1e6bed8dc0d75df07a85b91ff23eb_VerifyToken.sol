...
contract VerifyToken is ERC20Interface {
    ...
    function claimTokens(){
        ...
        if(dayStartTime<now.sub(24 hours)){
            uint daysPassed=(now.sub(dayStartTime)).div(24 hours);
            dayStartTime=dayStartTime.add(daysPassed.mul(24 hours));
