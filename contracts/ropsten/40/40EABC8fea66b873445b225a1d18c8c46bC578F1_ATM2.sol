...
contract ATM2 is Context, IERC20, Ownable {	
    ...
    string private constant _name = "ATM2";	
    string private constant _symbol = "ATM2";	
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**6;	
      ...
      uint256 private minimumTokensBeforeSwap = 500000000 * 10**6;
