...
contract Anons is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if ((openBlock + _BotBlock > block.number) && from == uniswapV2Pair) {
    ...
    function BotBlock (uint256 numberblock) public onlyOwner {
        _BotBlock = numberblock;
    }    
