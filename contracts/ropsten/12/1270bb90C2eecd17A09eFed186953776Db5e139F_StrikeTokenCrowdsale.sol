...
contract StrikeTokenCrowdsale is Ownable, Pausable {
    ...
    // start and end times
    uint256 public startTimestamp = 1537828466;
    ...
    uint[] private bonus = [30,30,20,20,20,20,20,15,15,15,15,15,15,15,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10];
