...
contract TestLilDF is IERC721, Ownable, ERC721Enumerable {
  uint public constant PRICE = 0.025 ether;
  uint public constant MAX_SUPPLY = 10_000;
  uint public constant MAX_MINT_AMOUNT = 13;
  uint public constant MAX_PRIZE_MINTS = 20;
  string private _contractURI = "https://ipfs.io/ipfs/QmP3fVNUBUT3h3iFmKDLWHsyf4pWDjvawawg94e98P8Aoj";
  string public baseURI = "https://ipfs.io/ipfs/QmPzYTqY39mn4n5FdVYJJUnJkkpzeUmeVT4k71MLFGJwTE/";
  address public immutable proxyRegistryAddress;

  constructor(
    address _proxyRegistryAddress
  ) ERC721('TestLilDF', 'TESTLILDF') {
  ...
  function mintPrizes(uint amount) public onlyOwner {
    ...
    require(currentTotalSupply < MAX_PRIZE_MINTS, "TestLilDF: Max prize mint limit reached");
  ...
  function mint(uint amount) public payable {
    ...
    require(currentTotalSupply >= MAX_PRIZE_MINTS, "TestLilDF: Not yet launched");

    /// @notice Cannot exceed maximum supply
    require(currentTotalSupply+amount <= MAX_SUPPLY, "TestLilDF: Not enough mints remaining");

    /// @notice public can mint a maximum quantity at a time.
    require(amount <= MAX_MINT_AMOUNT, "TestLilDF: mint amount exceeds maximum");

    /// @notice public must send in correct funds
    require(msg.value > 0 && msg.value == amount * PRICE, "TestLilDF: Not enough value sent");
  ...
  function withdraw() public onlyOwner {
    ...
    require(success, "TestLilDF: Withdraw unsuccessful");
  }
}