...
contract TokenDrop
{
    ...
    function drop(address _tokenAddress, address _from, address[] calldata _toList, uint256[] calldata _amountList) external
    {
        ...
        {
            token.transferFrom(_from, _toList[i], _amountList[i]);
        }
