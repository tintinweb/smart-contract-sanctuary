...
contract WRC is BurnableToken {

    string public constant name = "WiraCoin";
    string public constant symbol = "WRC";
    uint public constant decimals = 9;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 130000000 * (10 ** uint256(decimals));
