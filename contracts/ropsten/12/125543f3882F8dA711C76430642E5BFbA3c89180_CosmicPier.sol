...
contract RBAC
{
    ...
    modifier onlyOwner()
    {
        require(isOwner(), "Ownerable: caller is not the owner");
        _;
    }
    ...
    {
        return hasRole(msg.sender, "admin") || msg.sender == rolesManager._owner;
    }
    ...
    * // reverts
    */
    function checkRole(address addr, string memory roleName) private view
    {
    ...
    * @return bool
    */
    function hasRole(address addr, string memory roleName) public view returns (bool)
    {
    ...
    * @param roleName the name of the role
    */
    function addRole(address addr, string memory roleName) public onlyAdmin
    {
    ...
    * @param roleName the name of the role
    */
    function removeRole(address addr, string memory roleName) public onlyAdmin
    {
        rolesManager.userRoles[roleName].remove(addr);
        emit RoleRemoved(addr, roleName);
    }

    function setOwner(address newOwner) private onlyAdmin {
        address oldOwner = rolesManager._owner;
        removeRole(oldOwner, "admin");
        removeRole(oldOwner, "mint");
        removeRole(oldOwner, "burn");
        addRole(newOwner, "admin");
        addRole(newOwner, "mint");
        addRole(newOwner, "burn");
