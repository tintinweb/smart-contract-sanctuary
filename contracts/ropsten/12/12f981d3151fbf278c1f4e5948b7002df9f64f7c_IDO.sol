...
contract IDO is Ownable {
    ...
    function claim() inWhiteList external {
        ...
        if (block.number >= endHeightOfPriIDO && youAmountOfPriIEO > 0) {
            _mintYou(_youToken, youAmountOfPriIEO);
            emit PrivateOfferingClaimed(msg.sender,youAmountOfPriIEO);
        ...
        if (block.number >= endHeightOfPubIDO && amountOfUsdtPayed > 0) {
            ...
            if (totalUsdtAmountOfPubIDO > targetUsdtAmountOfPubIDO) {
                ...
                youAmountOfPubIDO = availableAmountOfUsdt * targetYouAmountOfPubIDO / targetUsdtAmountOfPubIDO;
                ...
                youAmountOfPubIDO = amountOfUsdtPayed * targetYouAmountOfPubIDO / targetUsdtAmountOfPubIDO;
            }

            _mintYou(_youToken, youAmountOfPubIDO);
            emit PublicOfferingClaimed(msg.sender,youAmountOfPubIDO);
