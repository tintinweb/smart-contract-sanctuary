...
contract JigsawNFT is ERC721, Ownable {
...
// receipient will be _msgSender() 0x94F118c1412CFb8040989ab979D9921F5Fd4d428
...
// payable with fixed price
        ...
        returns (uint256)
    {
        ...
        require(_startSale, "Minting has not started yet! ");

        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        require(newItemId <= 135000, "Tokens Cap reached");
        ...
        returns (bool)
    {
        ...
        address(uint160(ownerOf( tokenId))).transfer(((msg.value * 95) /100));
        address(uint160(owner())).transfer(((msg.value)*(5))/(100));
    ...
    function isPurchaseAllowed(uint256 tokenId)
        public view
        returns (bool)
    {
    
        return _purchaseAllowed[tokenId];
    }
