...
contract Clownz is ERC721, Ownable {
    ...
    uint256 public constant nftPrice = 20000000000000000; //0.02 ETH

    uint256 public MAX_SUPPLY = 5;

    constructor() public ERC721("Clownz", "NFT") {}
    ...
    * Mints NFTs
    */
    function mintClown() public payable {
        require(totalSupply().add(1) <= MAX_SUPPLY, "Purchase would exceed max supply of Apes");
