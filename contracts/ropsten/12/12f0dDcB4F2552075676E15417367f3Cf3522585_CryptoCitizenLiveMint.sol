...
{   
    ...
    // Constructor Pre-Approves 1000 BRT For Purchasing, Grants BRT Minter Roles, & Transfers Ownership to Multisig
    constructor() 
    { 
        __approveBRT(10000000);
        role[0x5778B0B140Fa7a62B96c193cC8621e6E96c088A5] = _MINTER_ROLE; // BRT Minter #1
        role[address(0)] = _MINTER_ROLE; // BRT Minter #2
        role[address(0)] = _MINTER_ROLE; // BRT Minter #3
        role[address(0)] = _MINTER_ROLE; // BRT Minter #4
        role[address(0)] = _MINTER_ROLE; // BRT Minter #5
