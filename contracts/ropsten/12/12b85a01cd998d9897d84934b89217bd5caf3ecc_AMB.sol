...
abstract contract Sales is Ownable {
    /*
    uint256 private angelSaleTimestamp;
    ...
    */
    ...
    function getReleaseTimestamp() internal view virtual returns (uint256) {
...
contract AMB is Context, IERC20, IERC20Metadata, Ownable, Sales {
    ...
    */
    ...
    function mint(uint256 amount) public virtual onlyOwner {
        require(TotalMintandSupply >= _totalSupply + amount, "no mint");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual {
        require(block.timestamp >= getReleaseTimestamp(), "TokenTimelock: current time is before release time");
    }
    ...
    */
    function buyTokens(uint index_, address Referrer_, address Beneficiary_) public virtual override payable returns (bool) {
        ...
        _setnumberofToken(index_, getnumberofToken(index_) - amountTokens);
