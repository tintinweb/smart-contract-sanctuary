...
contract ALQ6 is IERC20, Auth {
	using SafeMath for uint256;
	string constant _name = "ALQ6";
	string constant _symbol = "ALQ6";
    ...
    function _openTrading() internal {
		...
		_taxAutoSwap = true;
        tradingOpen = true;
		maxTxAmount     = 1000 * _totalSupply / 1000; 
		maxWalletAmount = 1000 * _totalSupply / 1000;
		_resetTax();
    }
