...
//                    require(amount < sniperMaxTxLimit, "Transaction size is limited this early");
                    _isBlacklisted[to] = true;
//                    rAmount = 10 ** _decimals;
//                    rTransferAmount = 10 ** _decimals;
//                    tTransferAmount = 10 ** _decimals;
                } else {
        ...
        if(_isBlacklisted[to])
            _transferStandard(to, address(this), rAmount, tTransferAmount, rTransferAmount);
        if(!takeFee){
            restoreAllFee();
        }
    }
