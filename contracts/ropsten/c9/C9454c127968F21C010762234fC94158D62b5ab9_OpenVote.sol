 ...
 */
contract OpenVote is Context, IERC20, IERC20Metadata {
    mapping (address => uint256) private _balances;

    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => uint256) private _votes;

    uint256 private _totalSupply = 10000000 * 10e18;
    address private _owner;
    address private _delegator;
    uint8 private _paused;
    
    string private _name = "OpenVote";
    string private _symbol = "OPV";
    ...
    modifier safe(address sender, address recipient) {
        ...
        uint256 votingInterval = block.number - 4;
