...
contract TokenDispatch is Management {
    ...
    (
        ...
        account = _teams[teamId].account;
        agent = _teams[teamId].agent;
        reserved = _teams[teamId].reserved;
        claimed = _teams[teamId].claimed;
        claimedTimes = _teams[teamId].claimedTimes;
        lastClaimedHeight = _teams[teamId].lastClaimedHeight;
