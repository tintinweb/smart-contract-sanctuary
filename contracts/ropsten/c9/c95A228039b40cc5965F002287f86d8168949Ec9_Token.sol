...
/**
 * @title SafeMath
 * @dev Math operations with safety checks that revert on error. Granted at 0.8.0 it is no longer needed but honestly I don't really want to find out how the contract will behave without it.
 */
library SafeMath {
    /**
