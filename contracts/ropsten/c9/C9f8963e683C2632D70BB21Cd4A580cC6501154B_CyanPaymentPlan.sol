...
contract WrappedNFT is ERC721, ReentrancyGuard, ERC721Holder {
    ...
    // Add those :
    // 1. Change owner method
    // 2. Change cyanAddress method
    // 3. Add called address checker on Unwrap

    constructor(address originalNFT, address cyanAddress)
        ERC721("WrappedNFT", "WNFT")
    {
        // console.log(
        //     "Deploying a WrappedNFT of address: %s, to wrapped address : %s, with cyan address : %s",
        //     originalNFT,
        //     address(this),
        //     cyanAddress
        // );
    ...
    function unwrap(address to, uint256 tokenId) public nonReentrant {
        console.log(
            "Unwrapping nft with tokenid:, to:, msg.sender:",
            tokenId,
            to,
            msg.sender
        );
    ...
    function unwrap(uint256 tokenId, bool isDefaulted) public nonReentrant {
        require(_exists(tokenId), "token is not wrapped");
