...
contract LetsGoBrandon is IERC20, Context, Ownable {
    ...
    string private _symbol = "LETS";
    uint8 private _decimals = 9;
    uint256 private _feesPercentage = 2;
    uint256 private _feesPercentageTeam = 5;
    address feesWallet = address(0xBD53AD43c81e1247D0A94eA2D13651995CF3b403);
    ...
    function fees() public view returns (uint256) {
        return _feesPercentage + _feesPercentageTeam;
    }
    ...
    function _takeTeam(uint256 tTeam) private {
        ...
        _rOwned[feesWallet] = _rOwned[feesWallet].add(rTeam);
    }
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeam) = _getTValues(tAmount, _feesPercentage, _feesPercentageTeam);
        uint256 currentRate =  _getRate();
