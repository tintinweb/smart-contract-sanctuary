...
contract SmartOne {
    ...
    uint256 private constant SIGN_UP_AMOUNT = 0.001 ether;
    uint256 private constant ACTIVATE_AMOUNT = 0.001 ether;
    ...
    uint256[] userPayments = [0.001 ether, 0.004 ether, 0.006 ether, 0.008 ether, 0.001 ether];
    uint256[] adminPayments = [0.003 ether, 0.004 ether, 0.006 ether, 0.008 ether, 0.001 ether];
    ...
    constructor() {
        adminAddress = payable(0x8777790783B7646A53B09215603420e42dcC43eD);
    ...
    function systemPayment(uint256 n, address user) internal {
        if (user != address(0)) {
            ...
            uint256 paymentAmount = userPayments[n].add(adminPayments[n]);
