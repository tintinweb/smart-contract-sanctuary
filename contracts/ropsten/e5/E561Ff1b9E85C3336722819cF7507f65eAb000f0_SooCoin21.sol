...
** Using FTP ILO to provide up to 0.01% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract SooCoin21 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin21";
    string private m_Symbol = "SOO21";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 10, 10, 10, m_ILOPublic);
        initTax();
