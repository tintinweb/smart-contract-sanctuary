...
contract ABE_Protocol is ERC20, ERC20Detailed,
    ...
    uint256 public genesisMintingBlock;
...
//--------------------------------------------------------------------------------------
    ...
    function holderMintingInfo(address account) external view returns (address, uint256, uint256, uint256) {
        uint256 blocksCount = block.number.sub(genesisMintingBlock);
        uint256 transactionRewardsReleases = blockTransactionRewards;
...
//--------------------------------------------------------------------------------------
    ...
    function setMintingBlock(uint256 _genesisMintingBlock) external onlyOwner {
