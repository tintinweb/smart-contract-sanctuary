...
contract BEP20 is StandardToken, Ownable {
    ...
    function BEP20 () public {
        decimals        = 9;
        totalCoin       = 1000000000000000;                       // Total Supply of Coin
        ...
        exchangeRate    = 0;                            // 100 Coins per ETH   (changable)
        symbol          = "MoonStar";                       // Your Ticker Symbol  (changable)
        name            = "MOONSTAR";             // Your Coin Name      (changable)
    }
