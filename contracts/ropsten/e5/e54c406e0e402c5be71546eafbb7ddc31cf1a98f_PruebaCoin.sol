...
contract PruebaCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PruebaCoin() {
        ...
        name = "PruebaCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BcN";                                             // Set the symbol for display purposes (CHANGE THIS)
