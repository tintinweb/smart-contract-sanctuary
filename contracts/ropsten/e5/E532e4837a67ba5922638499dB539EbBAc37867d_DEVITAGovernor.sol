...
// all votes work on underlying _lifeBalances[address], not balanceOf(address)
...
contract DEVITAGovernor is GovernorStorage, GovernorEvents {
  ...
  function propose(
    ...
    require(
      ...
      "DEVITAGovernor::propose: proposal function information arity mismatch"
    );
    require(
      targets.length != 0,
      "DEVITAGovernor::propose: must provide actions"
    );
    require(
      targets.length <= proposalMaxOperations(),
      "DEVITAGovernor::propose: too many actions"
    );
    ...
    if (latestProposalId != 0) {
      ...
      require(
        ...
        "DEVITAGovernor::propose: one live proposal per proposer, found an already unapproved proposal"
      );
      require(
        proposersLatestProposalState != ProposalState.Active,
        "DEVITAGovernor::propose: one live proposal per proposer, found an already active proposal"
      );
      require(
        proposersLatestProposalState != ProposalState.Created,
        "DEVITAGovernor::propose: one live proposal per proposer, found an already created proposal"
      );
    }
  ...
  function approve(uint256 proposalId) public {
    ...
    require(
      life.getPriorVotes(msg.sender, SafeMath.sub(block.number, 1)) >=
        approveVotes(),
  ...
  function _queueOrRevert(
    ...
    require(
      ...
      "DEVITAGovernor::_queueOrRevert: proposal action already queued at eta"
    );
  ...
  function cancel(uint256 proposalId) public {
    ...
    require(
      msg.sender == guardian ||
        ...
        life.balanceOf(proposal.approver) < approveVotes(),
  ...
  function _castVote(
    ...
    require(
      ...
      "DEVITAGovernor::_castVote: voter already voted"
    );
    uint256 votes = life.getPriorVotes(voter, proposal.startBlock);
  ...
  function _setVotingDelay(uint256 newVotingDelay) external {
    ...
    require(
      ...
      "DEVITAGovernor::_setVotingDelay: invalid voting delay"
    );
  ...
  function _setVotingPeriod(uint256 newVotingPeriod) external {
    ...
    require(
      ...
      "DEVITAGovernor::_setVotingPeriod: invalid voting period"
    );
  ...
  function _setApprovePercent(uint256 newApprovePercent) external {
    ...
    require(
      ...
      "DEVITAGovernor::_setProposalThreshold: invalid approve threshold"
    );
  ...
  function _setQuorumPercent(uint256 newQuorum) public {
    ...
    require(
      ...
      "DEVITAGovernor::_setQuorumPercent: invalid quorum percent"
    );
  ...
  function _acceptAdmin() external {
    ...
    require(
      ...
      "DEVITAGovernor:_acceptAdmin: pending admin only"
    );
    ...
    public
  {
    require(
      msg.sender == guardian,
      "DEVITAGovernor::__queueSetTimelockPendingAdmin: sender must be gov guardian"
    );
