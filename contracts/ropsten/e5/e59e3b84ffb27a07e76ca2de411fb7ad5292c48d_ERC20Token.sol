...
contract StandardToken  {
    ...
    function getValueSubFee(uint256 _value) public view returns (uint256 valueSubFee) {
        uint256 _fee = _value.mul(prizingPercent).div(100);
...
contract ERC20Token is StandardToken, Ownable {
    ...
    function getTotalSupplySubOwner() public isOwner view returns (uint) {
