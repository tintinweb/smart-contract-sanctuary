 ...
 */
contract UTPL is StandardToken, Ownable {
  string public constant name = "Utopialand";
  string public constant symbol = "UTPL";
  ...
  /* Crowdsale start time */
	...
	*/
	...
	/*
  	 ...
  	 * 1) backer call the "approve" function of the manus token contract with the amount of all utcoin they got in order to be refund
