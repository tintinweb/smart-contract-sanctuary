...
// Root file: contracts/ChfryImplementationM1.sol
...
contract Constants is Variables {
	address internal immutable chfryIndex;
	// Connectors Address.
	address public immutable connectorsM1;

	constructor(address _chfryIndex, address _connectors) {
		connectorsM1 = _connectors;
		chfryIndex = _chfryIndex;
	}
}

contract ChfryImplementationM1 is Constants {
	constructor(address _chfryIndex, address _connectors) Constants(_chfryIndex, _connectors) {}
	...
	function cast(
		...
		require(_auth[msg.sender] || msg.sender == chfryIndex, '1: permission-denied');
