...
// import "./imx_upgradable/IMintableUpgradable.sol";
...
contract MonsterbudsFunctions is ERC721URIStorageUpgradeable, IMonsterBudsV2, MonsterBudHolders{
...
interface IMintableUpgradable {
    event console(uint256 _number);
...
import "./MonsterbudsFunctions.sol";
import "./imx_upgradable/IMintableUpgradable.sol";
import "./imx_upgradable/utils/MintingUpgradable.sol";

contract MonsterbudsV2 is MonsterbudsFunctions, IMintableUpgradable{
