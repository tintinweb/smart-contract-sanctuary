...
contract Zealthest is ERC20, ERC20Detailed,
    ...
    constructor() public ERC20Detailed("Zealthest","ZEALTHEST", 18){
        owner = msg.sender;
...
//--------------------------------------------------------------------------------------
    ...
    function transferToAddress(address sender, address recipient, uint256 value) internal returns (bool) {
