...
contract BitTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BitTiger";
    string private _symbol = "BT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9a57132eee677b709326EF613944019851190fA5); // Marketing Address
    address payable public teamWalletAddress = payable(0x0a38De8C48c9e53E7e69508b7518eB4ccaaa38B2); // Team Address
