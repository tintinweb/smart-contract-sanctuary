...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 public launchBlockNumber = block.number;
   ...
   // address payable maintenanceWallet = payable(0xF7234F7AbDEf394F57B8bcdB5E8C88674Ba16CD2);
    ...
    address payable maintenanceWallet = payable(0x250F42397DBE44FD50Fc48DC1F19E7101971c761);
    ...
    function updateFee(uint256 liquidity, uint256 maintenance) internal 
    {
        _liquidityFee = liquidity;
        _maintenanceFee = maintenance;
    ...
    function _transfer(
        ...
        if(block.number <= launchBlockNumber + 3 )
        {
            updateFee(0, 45);
        }
