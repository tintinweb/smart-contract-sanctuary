...
interface ISpaceOperatorRegistry {
    /// @notice Returns if the supplied address is a space operator.
    /// @param _operator The address being checked.
    /// @return True if the address is a space operator, false otherwise.
    function isSpaceOperator(address _operator) external view returns (bool);
    ...
    function setOperatorForSpace(address _operator, address _space) external;
    ...
    function setSpaceCommission(address _operator, uint8 _commission) external;
