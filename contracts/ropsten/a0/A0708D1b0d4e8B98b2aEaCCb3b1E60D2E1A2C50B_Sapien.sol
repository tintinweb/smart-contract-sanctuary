...
contract Sapien is ERC721Enumerable, Ownable{
    ...
    */
    function isWhitelisted(bytes calldata _signature) public view returns(address) {
        return msg.sender; //abi.encodePacked(msg.sender,MAX_SUPPLY); //.toEthSignedMessageHash().recover(_signature) == pubkey;
    }
