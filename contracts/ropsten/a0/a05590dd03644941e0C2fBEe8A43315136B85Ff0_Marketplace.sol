...
contract Marketplace is Ownable, Pausable {
    ...
    address public immutable SOS_CONTRACT;
    ...
    function transactOnBid(
        ...
        if (block.timestamp > _transaction.timestamp) {
            require(
    ...
    function transactSos(
        ...
        IERC20(SOS_CONTRACT).transferFrom(
            _transaction.buyer,
            _transaction.seller,
            _transaction.price
        );
