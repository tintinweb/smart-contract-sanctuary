...
contract Wrapper is Utils {
    ...
    function getListReserves(KyberNetwork network, ERC20 token) public view returns(uint, uint) {
        ...
        address[] memory src = new address[](srcCount);
        ...
        address[] memory dest = new address[](destCount);
