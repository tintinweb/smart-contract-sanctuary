...
contract ArtContract is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint16[] memory eyes_p, uint8[] memory eyes_a) ERC721("Art", "ART") {
        ...
        me = 0x26C437D224EfED14e6772DD3F67C8b17092332Ac;
    ...
    function mintThreeTokens() public payable nonReentrant() {
        require(saleIsActive, "Sale must be active to mint Duck");
    ...
    function mintTenTokens() public payable nonReentrant() {
        require(saleIsActive, "Sale must be active to mint Duck");
    ...
    function getTraits(uint tokenId) public view returns (uint, uint, uint, uint, uint, uint){
        ...
        require(msg.sender == me, "Unauthorized");
