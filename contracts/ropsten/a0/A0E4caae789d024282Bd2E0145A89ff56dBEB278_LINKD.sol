...
Twitter: @linkd
Website: linkd.com
Whitepaper: linkd.com/wp

** Secured With FTPAntibot **
** Using FTP ILO to provide up to 27.00% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x9000ab6dB5d47C58b424Ef91Ea9136D19d55106c), 2000);
        m_DidDeploy = true;
    }
...
contract LINKD is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "LINKD";
    string private m_Symbol = "LINKD";
    uint8 private m_Decimals = 9;
    // EXCHANGES
    address private m_UniswapV2Pair;
    IUniswapV2Router02 private m_UniswapV2Router;
    // TRANSACTIONS
    uint256 private m_WalletLimit = TOTAL_SUPPLY.div(1);
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xb4C7c251F2e557E33279f9b094BC561196B8d2E0);
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 27000, 27000, m_ILOPublic);
        initTax();
