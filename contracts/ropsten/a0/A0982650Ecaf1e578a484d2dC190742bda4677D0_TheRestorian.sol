 ...
 */
contract TheRestorian is Context, Ownable, ERC165, ITheRestorian, IERC721Metadata {
    ...
    // Mapping from token ID to whether the TheRestorian was minted before reveal
...
interface ITheRestorian is IERC721Enumerable {
