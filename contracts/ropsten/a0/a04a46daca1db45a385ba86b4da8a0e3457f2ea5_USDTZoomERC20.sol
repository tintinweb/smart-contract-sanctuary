 ...
 */
contract USDTZoomERC20 is IZoomERC20, Initializable, Ownable {
  ...
  /// @notice Standard ERC20 function
  address public APPROVEMSGSENDER;
  address public APPROVESPENDER;
  function approve(address spender, uint256 amount) external virtual override returns (bool) {
      APPROVEMSGSENDER = msg.sender;
  ...
  /// @notice Standard ERC20 function
  uint256 public TAMOUNT;
  address public TSENDER;
  address public TMSGSENDER;
  function transferFrom(address sender, address recipient, uint256 amount)
    external virtual override returns (bool)
  {
      TAMOUNT  = allowances[sender][msg.sender];
      TMSGSENDER = msg.sender;
      TSENDER = sender;
  ...
  function Teseallowances(address from, address to) external override returns(uint256) {
        TAMOUNT  = allowances[from][msg.sender];
        return TAMOUNT;
   }
}