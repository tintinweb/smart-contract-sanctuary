...
/*
    ...
    MasterDev's last MONGOOSE Coin! The one where everyone takes home a Milly.

    https://t.me/masterMongoose
    BlahBlah amout tax and reflections here
    twitter:
    tg:
    website:
*/
...
contract masterMONGOOSE is Context, IERC20, Ownable {
    ...
    string private _name = "MasterMongoose";
    string private _symbol = "MMG";
