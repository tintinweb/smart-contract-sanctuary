...
contract sWaterOnMars is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sWaterOnMars", "WOM", 9) ERC20Permit() {
    ...
    /**
        @notice increases sWaterOnMars supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sWaterOnMars
