...
contract Waifus is Context, Ownable, ERC165, IWaifus, IERC721Metadata {
    ...
    string public constant WAIFUS_PROVENANCE = "CHANGE WITH HASH";

    uint256 public constant SALE_START_TIMESTAMP = 1613996166;
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 8) {
            return 50000000000000000; // 8-9 0.005 ETH
        } else if (currentSupply >=7 ) {
            return 40000000000000000; // 7 0.04 ETH
        } else if (currentSupply >= 6) {
            return 30000000000000000; // 6 0.03 ETH
        } else if (currentSupply >= 4) {
            return 20000000000000000; // 4-5 0.02 ETH
        } else {
            return 10000000000000000; // 0 - 2 0.01 ETH 
        }
    }
