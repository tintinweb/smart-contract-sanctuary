...
contract LibertyNFT is ERC721Pausable, AccessControl, Ownable {
    ...
    event MintedToken(address indexed owner, uint256 indexed tokenId, uint256 index, string tokenURI, uint256 startX, uint256 startY, uint256 xLength, uint256 yLength, uint256 createTime, uint256 updateTime);
    ...
    function mint(address to, string memory URI, uint256 index, uint256 startX, uint256 startY, uint256 xLength, uint256 yLength) public returns (uint256 tokenId) {
        ...
        emit MintedToken(_msgSender(), tokenId, index, URI, startX, startY, xLength, yLength, block.timestamp, block.timestamp);
    }
