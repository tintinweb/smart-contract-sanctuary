...
contract RichMeka is ERC721Enumerable, Ownable {
    ...
    function setMaxNumberOfTokens(uint256 maxNumberOfTokens) external onlyOwner {
    ...
    function setMinClaim(uint256 minClaim) external onlyOwner {
        _minClaim = minClaim;
    }

    function setColoredMekaRate(uint256 coloredMekaRate) external onlyOwner {
        _coloredMekaRate = coloredMekaRate;
    }

    function setMonochromeMekaRate(uint256 monochromeMekaRate) external onlyOwner {
        _monochromeMekaRate = monochromeMekaRate;
    }

    function setMinStakeTime(uint256 minStakeTime) external onlyOwner {
