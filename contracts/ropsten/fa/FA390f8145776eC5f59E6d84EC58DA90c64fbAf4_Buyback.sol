...
contract Buyback is IBuyback, Ownable, Pausable {
    ...
    //keeps record of which tokens were swapped for money
        ...
        returns (uint256 amountOut)
    {
        ...
        require(
            ...
            "Buyback:buyMoney:: ERR_NOT_MONEY"
        );
        require(
            token != address(0),
        ...
        tokenTreasury[token] = tokenTreasury[token].add(toSwap);
        ...
        returns (uint256 amount0Out, uint256 amount1Out)
    {
        ...
        require(
            ...
            "Buyback:buyMoney:: ERR_INVALID_AMOUNTS"
        );
        ...
        returns (uint256 toTransfer)
    {
        ...
        tokenTreasury[money] = tokenTreasury[money].add(toTransfer);
