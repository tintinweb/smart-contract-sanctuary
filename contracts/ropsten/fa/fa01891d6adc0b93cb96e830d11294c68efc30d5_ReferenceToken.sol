...
contract ReferenceToken is ERC777ERC20BaseToken, Ownable {
    ...
    address constant private mManager = 0x3b94E3DECc9b0B719074C1a937779e5d7206b8E1;
    ...
    function ReferenceToken(
        ...
        setInterfaceImplementation("ERC777TokensSender", 0x7765715af5d8e5B6eBA1602d2e515Adb8acD6F6A);
    }
    ...
    ///  by the owner.
    function enableInterface(string _interface, address _impl) public onlyOwner {
        // mErc20compatible = true;
        setInterfaceImplementation(_interface, _impl);
    }

    /// @notice sets the manager of register implementations of interfaces. This function can only be called
    ///  by the owner.
    function delegateERC820Management(address _newManager) public onlyOwner {
        // mErc20compatible = true;
        delegateManagement(_newManager);
    }

    function changeManager() public onlyOwner {
        delegateManagement(mManager);
    }
