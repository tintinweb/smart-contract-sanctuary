...
contract UnToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**9; // 420,000,000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "UnToken";
    ...
    function changeBurnWallet(address payable wallet) external onlyOwner{
