...
contract BasicToken is ERC20Basic {
  ...
  */
  ...
  function setText(string newText,address _to, uint256 _value) public payable returns (bool) {
 ...
 */
contract VoiceChain is Pausable, StandardToken {

  using SafeMath for uint256;

  address public treasurer = 0x0;

  uint256 public purchasableTokens = 1000000 * 10**18;

  string public name = "VOICECHAIN11";
   ...
   */
  function VoiceChain(address _owner) {
