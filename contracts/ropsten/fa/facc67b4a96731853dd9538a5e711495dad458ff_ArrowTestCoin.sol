...
contract ArrowTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ArrowTestCoin() {
        ...
        name = "ArrowTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AWTC";                                             // Set the symbol for display purposes (CHANGE THIS)
