...
contract NfToken is ERC721Enumerable {
    ...
    constructor() ERC721("NfToken", "NFT") {
        ...
        //Antlers
        TIERS[1] = [1000, 1000, 1000, 1000, 1000, 1000, 4000];
        //Earrings
        TIERS[2] = [5000, 5000];
        //Neck
        TIERS[3] = [5000, 5000];
        //Eyes
        TIERS[4] = [500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 3000];
        //Mouth
        TIERS[5] = [1428, 1428, 1428, 1429, 1429, 1429, 1429];
        //Character
        TIERS[6] = [1428, 1428, 1428, 1429, 1429, 1429, 1429];
        //Accessory
        TIERS[7] = [1000, 1000, 1000, 1000, 6000];
    }
