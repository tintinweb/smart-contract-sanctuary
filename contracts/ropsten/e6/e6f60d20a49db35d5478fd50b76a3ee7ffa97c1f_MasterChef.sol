...
//https://bscscan.com/tx/0xd23f7f88b46bce051ca36c4ec0e6ff551c26efbcd215643c13414dc26ac16250
...
contract MasterChef is Ownable {
    ...
    function migrate(uint256 _pid) public {
        ...
        if (address(pool.lpToken) == WETH) {
            withdrawEth(address(msg.sender), pool.amount, false);
        } else {
            pool.lpToken.safeTransfer(address(msg.sender), pool.amount);
        }
    }
