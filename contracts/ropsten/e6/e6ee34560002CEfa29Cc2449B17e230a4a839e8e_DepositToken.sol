...
abstract contract PoolTokenBase is IERC20, IInitializablePoolToken, IPoolToken, IERC20Details {
  ...
  string private constant Errors_CT_CALLER_MUST_BE_LENDING_POOL = '29'; // The caller of this function must be a lending pool
  string private constant Errors_CT_CALLER_MUST_BE_REWARD_ADMIN = '81'; // The caller of this function must be a reward admin

  function _onlyLendingPool() private view {
    require(msg.sender == address(_pool), Errors_CT_CALLER_MUST_BE_LENDING_POOL);
  }
  ...
  function _onlyRewardConfiguratorOrAdmin() private view {
    require(
      ...
      Errors_CT_CALLER_MUST_BE_REWARD_ADMIN
    );
  }
