...
contract RoomNFTStake is IERC1155Receiver, ReentrancyGuard {
    ...
    IERC20 public constant roomToken = IERC20(0x49dc61732780785dEc733703637115A9401463f9);

    // todo: set the correct ROOm NFT
    IERC1155 public constant NFTToken = IERC1155(0x8Af05aF4B16B9F56bbfC9B96B59fd26dD92C28f6);
