...
contract AutomaticProxyV2 is MCDSaverProxy {
    ...
    address payable public constant MCD_SAVER_FLASH_LOAN = 0x9fbD80E580f4e0e3585c6d3449ffF38F43905976;
    ...
    function automaticBoost(
        ...
        if (maxDebt >= debtAmount) {
            //boost(_data, _joinAddr, _callData,_exchangeAddress,ManagerType.MCD);
            return;
        }
