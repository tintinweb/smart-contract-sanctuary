...
// File: contracts/MetaberseBuilders.sol
 ...
 */
contract MetaverseBuilders is Initializable, ContextUpgradeSafe, OwnableUpgradeSafe, AccessControlUpgradeSafe, ERC721BurnableUpgradeSafe, ERC721PausableUpgradeSafe {
    ...
    function initialize(string memory name, string memory symbol, string memory baseURI) public {
        __MetaverseBuilders_init(name, symbol, baseURI);
    }

    function __MetaverseBuilders_init(string memory name, string memory symbol, string memory baseURI) internal initializer {
        __Context_init_unchained();
        __Ownable_init();
        __AccessControl_init_unchained();
        __ERC165_init_unchained();
        ...
        __Pausable_init_unchained();
        __ERC721Pausable_init_unchained();
        __MetaverseBuilders_init_unchained(baseURI);
    }

    function __MetaverseBuilders_init_unchained(string memory baseURI) internal initializer {
     ...
     */
    function mint(uint256 tokenId, address to, string memory tokenURI) public {
