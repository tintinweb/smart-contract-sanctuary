...
contract BSCGame {
    ...
    uint constant MIN_JACKPOT_BET = 0.01 ether;
    ...
    address constant DUMMY_ADDRESS = 0x027C586E235aefcf54D4f428a18923b47421a49E;
    ...
    //CHANGE MINIMUM BET AMOUNT
    function setMIN_BET(uint newMIN_BET) external onlyOwner {
        MIN_BET = newMIN_BET;
    }
