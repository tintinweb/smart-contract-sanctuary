...
contract SwapToken is AccessControlUpgradeable {
    ...
    constructor(address npxs, address xs) public {
    ...
    IERC20Upgradeable(XS).transfer(msg.sender, amount.div(rate));
    ...
    IERC20Upgradeable(XS).transfer(sender, amount.div(rate));
    totalSwappedAmount = totalSwappedAmount.add(amount);
