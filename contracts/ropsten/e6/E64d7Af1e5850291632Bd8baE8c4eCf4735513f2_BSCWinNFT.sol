...
contract DataLayout is LibraryLock {
    ...
    //ALL NEW VARIABLES MUST BE ADDED BELOW THIS COMMENT(Reposition below added variables)
    uint256 public mintLimit = 2000;
    
    //New Variable additions below
} 
...
contract BSCWinNFT is ERC721Enumerable, DataLayout, Proxiable, Ownable {
    ...
    constructor() ERC721("BSCWin", "BSCWin") {
    ...
    function NFTConstructor(address _manager) public payable {
        ...
        proxyConstructor("BSCWin", "BSCWin");
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory URI = string(abi.encodePacked(gateWay, CIDMappings[tokenId], "/", uint2str(uint(tokenId)), ".json"));
        return URI;
    }
