...
contract Auction {
    ...
    function push(string memory nft, uint256 lowestPrice, uint256 time, address settle, uint256 timeBuffer, uint256 percentage,uint256 decimal) public isOwner {
    ...
    function withDraw(string memory nft, address _to) public payable isOwner isExpired(nft) {
        require(_to != address(0),"Addr not allowed null");
