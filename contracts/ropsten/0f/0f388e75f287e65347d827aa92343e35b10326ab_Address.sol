...
contract BEP20 is Context, IBEP20 {
    ...
    event BurnFeeUpdated(uint256 burnFeePercentage);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        charityFee = circulation <= 500000000000 * (10 ** 18) ? 5 : 10;
        JBCHubFee = circulation <= 1000000000 * (10 ** 18) ? 10 : 20;
        burnFee = circulation <= 50000000000000 * (10 ** 18) ? 0 : _burnFee;

        
        if(_lockTime[JBC_HUB] >= block.timestamp) {
            liquidityFee = 0;
        }
...
contract hello is BEP20 {
    ...
    constructor (address charity, address JBC_HUB, address referral) BEP20("hello", "JBC", 18, charity , JBC_HUB, referral) {
