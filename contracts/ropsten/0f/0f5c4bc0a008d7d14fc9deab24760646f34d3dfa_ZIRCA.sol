...
contract ZIRCA is ER20, ProofOfAgeProtocolLayer,
    ...
    string public name = "Zirca";
    string public symbol = "ZIRCA";
    ...
    constructor() public {
        owner = msg.sender;
        maxTotalSupply = 10000000 * (10**decimals); //1 Billion
        circulatingSupply = 40000 * (10**decimals); //4 Million
