...
contract Furute1exchange {
    ...
    function batchconsumerAction(bytes16[] memory _tradeId, address payable[] memory _seller, address payable[] memory _buyer, uint256[] memory _amount, uint16[] memory _gasFee, uint128[] memory _additionalFee, uint8[] memory _actionByte) public returns(bool[] memory)
    {
    ...
    function createEscrow(bytes16 _tradeId, address _seller, address _buyer, uint256 _amount, uint16 _gasFee, uint32 _sellerCancelInSeconds, uint32 _expiryTime)  payable external returns(bool)
    {
    ...
    function releseFunds(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee) external returns (bool)
    {
    ...
    function disableSellerCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee) external returns (bool) 
    {
    ...
    function buyerCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee) external returns (bool) {
      
      return _buyerCancel(_tradeId,_seller,_buyer,_amount,_gasFee,0);
      
    }
    
    function sellerCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee) external returns (bool) {
     
      return _sellerCancel(_tradeId,_seller,_buyer,_amount,_gasFee,0);
      
    }
    
    function sellerRequestCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee) external returns (bool) 
    {
    ...
    function consumeBuyerCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) external returns (bool) 
    {
    ...
    function consumeRelease(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) external returns (bool) 
    {
    ...
    function consumeSellerCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) external returns (bool) 
    {
    ...
    function consumeSellerRequestCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) external returns (bool) 
    {
    ...
    function consumeDispute(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) external returns (bool) 
    {
    ...
    function disputeByMediator(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _buyerPercent) external onlyMediator returns(bool)
    {
   ...
   // Withdraw fees collected by the contract. Only the owner can call this.
    ...
    function _releseFunds(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) private returns(bool)
    {
        require(msg.sender == _seller, "Invalid User.. ");
    ...
    function _disableSellerCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) private returns(bool)
    {
       bytes32 _tradeHash = keccak256(abi.encodePacked(_tradeId,_seller,_buyer,_amount,_gasFee));
    ...
    function _buyerCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) private returns(bool)
    {
       bytes32 _tradeHash = keccak256(abi.encodePacked(_tradeId,_seller,_buyer,_amount,_gasFee));
    ...
    function _sellerCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) private returns(bool)
    {
       bytes32 _tradeHash = keccak256(abi.encodePacked(_tradeId,_seller,_buyer,_amount,_gasFee));
    ...
    function _sellerRequestCancel(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) private returns(bool)
    {
       bytes32 _tradeHash = keccak256(abi.encodePacked(_tradeId,_seller,_buyer,_amount,_gasFee));
    ...
    function disputeCall(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee) private returns (bool)
    {
        bytes32 _tradeHash = keccak256(abi.encodePacked(_tradeId,_seller,_buyer,_amount,_gasFee));
    ...
    function consumerAction(bytes16 _tradeId, address payable _seller, address payable _buyer, uint256 _amount, uint16 _gasFee, uint128 _additionalFee, uint8 _actionByte,  uint128 _maxGas) private returns(bool)
    {
