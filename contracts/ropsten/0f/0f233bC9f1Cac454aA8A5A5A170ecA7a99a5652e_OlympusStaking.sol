...
contract OlympusStaking is OlympusAccessControlled {
    ...
    function setToken(address _ohm, address _sOHM, address _gOHM) public onlyGovernor {
        require(_ohm != address(0), "Zero address: OHM");
        OHM = IERC20(_ohm);
        require(_sOHM != address(0), "Zero address: sOHM");
        sOHM = IsOHM(_sOHM);
    ...
    function setEpoch(uint256 _epochLength, uint256 _firstEpochNumber, uint256 _firstEpochTime) public onlyGovernor {
