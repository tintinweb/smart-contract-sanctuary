...
// File: contracts/FederatedReserveWish.sol
 ...
 */
contract FederatedReserveWish is Initializable, ContextUpgradeSafe, OwnableUpgradeSafe, AccessControlUpgradeSafe, ERC721BurnableUpgradeSafe, ERC721PausableUpgradeSafe {
    ...
    function initialize(string memory name, string memory symbol, string memory baseURI) public {
        __FederatedReserveWish_init(name, symbol, baseURI);
    }

    function __FederatedReserveWish_init(string memory name, string memory symbol, string memory baseURI) internal initializer {
        __Context_init_unchained();
        __Ownable_init();
        __AccessControl_init_unchained();
        __ERC165_init_unchained();
        ...
        __Pausable_init_unchained();
        __ERC721Pausable_init_unchained();
        __FederatedReserveWish_init_unchained(baseURI);
    }

    function __FederatedReserveWish_init_unchained(string memory baseURI) internal initializer {
    ...
    function setAllowMintToAll(bool allow) public onlyOwner {
        allowMintToAll = allow;
    }
