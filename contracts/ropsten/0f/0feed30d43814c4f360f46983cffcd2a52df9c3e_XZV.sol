...
// ----------------------------------------------------------------------------
// 'XZVINC'  token contract
//
// Symbol      : 'XZV'
// Name        : 'XZVINC'
// Total supply: '77630000'
// Decimals    : '18'
// ----------------------------------------------------------------------------
...
contract XZV is BurnableToken {

    string public constant name = "XZVINC";
    string public constant symbol = "XZV";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 77630000 * (10 ** uint256(decimals));
