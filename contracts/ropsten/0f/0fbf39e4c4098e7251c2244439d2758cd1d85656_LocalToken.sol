...
//
// Deployed to : 0x6d2B528b957b2596C1eE1DFe91B873cf0682Ca00
// Symbol      : LOT
// Name        : Local Token
...
contract Owned {
    ...
    function acceptOwnership() public {
        ...
        owner = newOwner;
        newOwner = address(0x6d2B528b957b2596C1eE1DFe91B873cf0682Ca00);
    }
}
...
contract LocalToken is ERC20Interface, Owned, SafeMath {
    ...
    // ------------------------------------------------------------------------
    function totalSupply() public constant returns (uint) {
        return _totalSupply  - balances[address(0x6d2B528b957b2596C1eE1DFe91B873cf0682Ca00)];
    }
    ...
    function () public payable {
        ...
        Transfer(address(0x6d2B528b957b2596C1eE1DFe91B873cf0682Ca00), msg.sender, tokens);
