...
contract Quadrumzzz is ERC721, Ownable {
    ...
    string public GENERATOR_ADDRESS =
        "https://ropsten.quadrums.art/api/generator/";
    string public IPFS_GENERATOR_ADDRESS = "";
    string public SCRIPT = "";

    // e.s added minter address to hash algorithm
    constructor() ERC721("Quadrumzzz", "QDRMZZZ") {
        setBaseURI("https://ropsten.quadrums.art/api/token/");
