 ...
 *
 */
contract SuperSale is Ownable, Haltable, SafeMath {
   ...
   */
  function supersale(address _owner, uint _freezeEndsAt, uint _weiMinimumLimit, uint _weiMaximumLimit, uint _weiCap) {
