...
▀▀███▀▀▀     ███    ███ ███    ███ ▀▀███ ████▄  ▀▀███▀▀▀     
  ...
  ██████████ ████████▀   ▀██████▀    ████████▀    ██████████
*
* Tokenomics initially will be a tax of 35% Buy and Transfer 20% Sell (90% for Liquidity, 8% for Staking and 2% to Burn)
*
* After Liquidity is built up Tokenomics will be locked at the following values:
* Tokenomics: 10% Tax Total (60% Liquidity, 30% Staking, 10% Burn)
* 
* Max per Holder: (~1% of Total Supply)
*
* TG: t.me/EarnDogeChat
* Website: https://www.earndoge.shop/
*
* Stay calm and hodl!
*/
...
contract EarnDOGE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'EarnDOGE';
    ...
    address public constant TeamWallet=0x4ca0531621ca33B64a3c147e4eE0FCa6Cb827981;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimDOGE(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawDOGE(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimDOGE(address addr) private{
        ...
        path[1] = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;  //Binance-Peg DOGE Token
        ...
        emit OnWithdrawDOGE(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function DOGEWithdraw() public{
        claimDOGE(msg.sender);
    }
