...
contract DTestingFinancePresale {
    ...
    function buy() external payable {
        uint256 valueInEther = msg.value/(0.1 ether);
        uint256 tokensToSend = valueInEther.mul(tokensPerBnb)*(0.1 ether);
