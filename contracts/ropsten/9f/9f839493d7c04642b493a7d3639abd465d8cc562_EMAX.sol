...
contract Owned {
    ...
    function transferOwnership(address payable _newOwner) public onlyOwner {
        require(_newOwner != address(0), "Invalid owner account");
        owner = _newOwner;
...
// ----------------------------------------------------------------------------
// 'ETHMax' token contract

// Symbol      : EMAX
// Name        : ETHmax
// Total supply: 20,000,000 (20 M)
// Decimals    : 18
...
// token transfers
// ----------------------------------------------------------------------------
contract EMAX is IERC20, Owned {
    using SafeMath for uint256;
   
    string public symbol = "EMAX";
    string public  name = "ETHmax";
    uint256 public decimals = 18;
    uint256 _totalSupply = 20000000 * 10 ** (decimals); // 20,000,000 
    ...
    // ------------------------------------------------------------------------
    constructor() public {
        //owner = 0xadd517001D6f6653929926533923d2BD5Aede840;
    ...
    function Mint(address to, uint256 tokens) external onlyMinter returns(bool){
        _mint(to, tokens);
