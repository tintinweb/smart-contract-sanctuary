...
contract Rafaido is BurnableToken, Ownable {

    string public constant name = "RAFAIDO DAO";
    string public constant symbol = "RFDD";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 195000000 * (10 ** uint256(decimals));
