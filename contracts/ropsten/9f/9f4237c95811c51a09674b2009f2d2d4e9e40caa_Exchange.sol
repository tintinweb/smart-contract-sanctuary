...
contract Exchange {
   ...
   /*================================
    ...
    uint8 internal fundFee_ = 5; // 5% Fund fee rate on each buy and sell for future game
    uint8 internal altFundFee_ = 0; //  Booster fund fee on each buy and sell
    ...
    mapping(address => address) public stickyRef;
     ...
     address public FundFeeAddress = 0xc2bed2fd22171302179d2AF94FFc94Bdf737046e;    // FundFee
     address public altFundAddress = 0xc2bed2fd22171302179d2AF94FFc94Bdf737046e;    //Booster Fund for Potential Future Use
    ...
    */
    ...
    onlyAdministrator()
    {
        ...
        if (altFundFee_ > 0){
            _FundFeeEthToPay = SafeMath.sub(ethToPay,altEthToPay);
        } else{
            _FundFeeEthToPay = 0;
        }
        ...
        if(!FundFeeAddress.call.value(_FundFeeEthToPay).gas(400000)()) {
            totalEthFundRecieved = SafeMath.sub(totalEthFundRecieved, _FundFeeEthToPay);
        }
    ...
    */
    ...
    function setFundFeeAddress(address _newFundFeeAddress)
        ...
        public
    {
        FundFeeAddress = _newFundFeeAddress;
    }
