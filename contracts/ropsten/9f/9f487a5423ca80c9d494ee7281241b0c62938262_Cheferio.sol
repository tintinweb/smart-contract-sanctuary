...
contract Cheferio is ERC20 {
  ...
  constructor() ERC20("Cheferio", "CHEFIO") {
    _rewardsAddress = address(0x5F71658403e6Cc6c2381dF7891fa38f58A9589B5);
    _shibaBurnAddress = address(0x66D4dA37c7aeb9B5c3156C584bc6BA7a015BfCF7);
  ...
  function ensureOneHuman(address _to, address _from) internal virtual returns (address) {
    require(!Address.isContract(_to) || !Address.isContract(_from), 'Chefio says: No bots allowed!');
  ...
  function ensureOneTxPerBlock(address addr) internal virtual {
    ...
    require(isNewBlock, 'Chefio says: Only one transaction per block!');
  }
