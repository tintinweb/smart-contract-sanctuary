...
/**
 * @title Token
 * @dev API interface for interacting with the TESTT Token contract 
 */
interface Token {
...
/**
 * @title TesttICO
 * @dev TesttICO contract is Ownable
 **/
contract TesttICO is Ownable {
  ...
  /**
   * TesttICO
   * @dev TesttICO constructor
   **/
  function TesttICO(address _tokenAddr) public {
