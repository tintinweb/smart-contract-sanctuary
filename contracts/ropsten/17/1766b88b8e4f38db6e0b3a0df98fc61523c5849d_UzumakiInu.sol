...
contract UzumakiInu is Context, IERC20, Ownable {
    ...
    string private _name = "Uzumaki Inu";
    string private _symbol = "UZUMAKI";
...
//------
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            ...
            if (from == pancakePair && to != address(pancakePair) && !_isExcludedFromFee[to] && cooldownEnabled) {
