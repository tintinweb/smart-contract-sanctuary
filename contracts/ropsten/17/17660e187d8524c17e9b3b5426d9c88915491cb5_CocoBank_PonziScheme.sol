...
contract CocoBank_PonziScheme{
    ...
    function IMPORTANT_Read_Me_How_To_UseTest_in1varnoeName() public pure returns(string memory Step0,string memory Step1) {
        string memory step0 = "Wellcome to CocoBank_PonziScheme, you can get 10% reward everyday!";
        string memory step1 = "RegisterDepositor : Add a new depositor for yourself.";
        return (step0,step1);
    }
    function IMPORTANT_Read_Me_How_To_UseTest_1HafveName() public pure returns(string memory,string memory) {
        string memory step0 = "Wellcome to CocoBank_PonziScheme, you can get 10% reward everyday!";
        string memory step1 = "Hello";
        return (step0,step1);
    }
