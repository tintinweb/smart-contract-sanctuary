...
import "../token/OLIVTokenInterface.sol";

contract OLIVReserves {

    // Token that serves as a reserve for OLIV
    ...
    constructor(
        ...
        address olivAddress_
    )
        public
    {
        reserveToken = reserveToken_;
        olivAddress = olivAddress_;
        gov = msg.sender;
    }
        ...
        onlyGov
    {
        ...
        OLIVTokenInterface(olivAddress).decreaseAllowance(oldRebaser, uint256(-1));
        rebaser = rebaser_;
        OLIVTokenInterface(olivAddress).approve(rebaser_, uint256(-1));
...
contract OLIVGovernanceStorage {
