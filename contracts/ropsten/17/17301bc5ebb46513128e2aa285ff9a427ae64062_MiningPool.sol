...
contract MiningPool is Ownable,TimeHelper {
    ...
    //pipe: [5787037037037037,964506172839506,826719576719576,496031746031746,165343915343915,165343915343915]
    //pipe-ht: [3472222222222222,578703703703703,496031746031746,297619047619047,99206349206349,99206349206349]
    //pipe-usdt: [4050925925925925,675154320987654,578703703703703,347222222222222,115740740740740,115740740740740]
    //pipe-husd: [4050925925925925,675154320987654,578703703703703,347222222222222,115740740740740,115740740740740]
    ...
    function set(
        ...
        poolInfo[_pid].freezeperiod = _freezeperiod;
    }
    ...
    function stake(uint256 amount,uint256 pid) public updateReward(msg.sender,pid) {
        ...
        userInfo[pid][msg.sender].staketime = block.timestamp;
    }
    
    function withdraw(uint256 amount,uint256 pid) public updateReward(msg.sender,pid) {
        require(amount > 0, "Cannot withdraw 0");
        require((userInfo[pid][msg.sender].staketime+poolInfo[pid].freezeperiod)<block.timestamp,"not allowed now");
