...
contract SooCoin3 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin3";
    string private m_Symbol = "SOO3";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x4bdEeDaA876E36CFa0CC1caD5EcBe7781D438526);
