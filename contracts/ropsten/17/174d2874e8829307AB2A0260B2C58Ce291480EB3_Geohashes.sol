...
contract Geohashes is ERC721URIStorage, Ownable, Pausable {
        ...
        returns (string memory)
    {
        ...
        parts[
            1
        ] = '<g id="geo-hashes-metadata-simple" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">';
        parts[
            2
        ] = '<rect fill="#FFFFFF" x="0" y="0" width="512" height="512"></rect>';
        parts[
            3
        ] = '<circle id="Oval" stroke="#202A88" stroke-width="3" cx="258.5" cy="255.5" r="178"></circle>';
        parts[
            4
        ] = '<text id="9mue" fill-rule="nonzero" font-family="HelveticaNeue-Medium, Helvetica Neue" font-size="64" font-weight="400" fill="#212B88">';
        parts[5] = '<tspan x="174.708" y="278">';
        parts[6] = getTokenIdAsString(tokenId);
        parts[7] = "</tspan>";
        parts[8] = "</text>";
        parts[9] = "</g>";
        parts[10] = "</svg>";
        ...
        for (uint256 i = 0; i < geohashb.length; i++) {
            ...
            if (arri >= 0) {
                if (i < geohashb.length - 1) {
                    uint256 pow = geohashb.length - i - 1;
                    uint256 l = arri * (chars.length**pow);
                    index += l;
                } else {
                    index += arri;
                }
