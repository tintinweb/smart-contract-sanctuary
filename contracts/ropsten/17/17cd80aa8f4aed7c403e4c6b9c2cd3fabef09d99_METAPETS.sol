...
contract METAPETS is Context, IERC20, Ownable {
    ...
    uint256 public maxTxnAmount = 100 * 10**6 * 10**_decimals; // max allowed tokens tranfer per transaction
    ...
    uint256 public maxTokensPerAddress            = 1000 * 10**6 * 10**_decimals; // Max number of tokens that an address can hold
