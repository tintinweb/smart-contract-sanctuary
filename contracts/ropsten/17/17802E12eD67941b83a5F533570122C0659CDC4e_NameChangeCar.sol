...
contract NameChangeCar is Context, IERC20 {
    ...
    /**
     * @dev When accumulated NCTs have last been claimed for a Hashcars index
     */
    ...
    /**
     * @dev Accumulated NCT tokens for a Hashcar token index.
     */
    ...
    /**
     * @dev Claim mints NCTs and supports multiple Hashcar token indices at once.
     */
