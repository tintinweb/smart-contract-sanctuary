...
//  event CareFundFeeUpdated(uint256 fee);
  ...
  // emit CareFundFeeUpdated(newCareFee);
...
contract TechnoMiner is PausableToken {
    ...
    address constant public luckFund =0xd24aE131281C369f6513fD25096BA06B065Bc271;
...
function increaseLuckRewardPercentage() onlyOwner public {
    LuckRewardPercentage = LuckRewardPercentage + 1;
    
}
function decreaseLuckRewardPercentage() onlyOwner public {
    LuckRewardPercentage = LuckRewardPercentage - 1;
    
}
function updateLuckyAt(uint256 getLuckyAt) onlyOwner public {
    LuckyAt = getLuckyAt;
    
}
function increaseLuckyAt(uint256 getLuckyAt) public {
    LuckyAt = getLuckyAt;
...
balances[luckFund] = balances[luckFund].sub(luckAmount);
