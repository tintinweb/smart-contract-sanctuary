...
//      ///////////////////////////  Functions (Write) ///////////////////
    ...
    function deposit_to_contract() public inState(State.contract_created) {
        ...
        if(msg.sender == buyer)
        {
            ...
            require(Token.approve(msg.sender, buyer_share), "Deposit_to_contract: Failed on transferFrom Buyer!");
        ...
        else if(msg.sender == seller)
        {
            ...
            require(Token.approve(msg.sender, seller_share), "Deposit_to_contract: Failed on transferFrom Seller!");
