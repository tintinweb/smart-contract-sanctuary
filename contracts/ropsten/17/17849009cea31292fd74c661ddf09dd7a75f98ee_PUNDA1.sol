...
contract PUNDA1 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PUNDA1 COIN";
    string private _symbol = "PUNDA1";
    ...
    uint256 public _maxTxAmount = 100000 * 10**1 * 10**9;
