...
contract Ress is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        marketingAddress = 0x4d5149B4024e6dE73b491aed63a096FD8ccC6EF8;
        _name = "Reign of Swords";
        _symbol = "ReSs";
        _decimals = 9;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xeCe339C8d66f1262B1492665aa9133Cc044e2e62,
            block.timestamp
        );
    }
