...
// ----------------------------------------------------------------------------
// 'TESTER' token AND staking contract
...
// token transfers
// ----------------------------------------------------------------------------
contract Tester is IERC20, Owned {
    ...
    uint256 _totalSupply = 100000000 * 10 ** (16); // 984,476.85 
    ...
    constructor( address _airdropContract) public {
        ...
        owner = 0xAa2aEFb387807980cA19C77c1E78517C5fD0Be43;
        
        
        balances[address(owner)] =   100000000  * 10 ** (16); // 541,956.64
