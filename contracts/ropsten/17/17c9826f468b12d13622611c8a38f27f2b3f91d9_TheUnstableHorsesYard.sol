...
contract TheUnstableHorsesYard is ERC721URIStorage {
    ...
    uint public total_No_Horses = 19;
    ...
    function Breed(address player, uint token1_ID, uint token2_ID) public {
        require(farmJucies_Own[msg.sender] == true, "User should own farm Jucie for Breeding"); 
...
//   "0x38BC7B6A1CcfE29c9bDe80a21C46881898561Fc3","https://metadata.theunstablehorsesyard.com/horse/","https://gateway.pinata.cloud/ipfs/QmdhG6LFoKXJkvLPwPnh1849KR2vFH2F6UkJUpRBiew8Es","https://theunstablehorseyard.herokuapp.com/breed/"