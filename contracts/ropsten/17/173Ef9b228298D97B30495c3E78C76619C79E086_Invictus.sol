...
contract Invictus is Context, IERC20, Ownable {
    ...
    string private constant _name = "newbn";
    string private constant _symbol = "nbn";
    ...
    uint256 public _maxTxAmount = 3000000000000000 * 10**9; //0.3
    ...
    constructor() {
        _developmentAddress = payable(0xB7739f38FEcbF36Ce647cb8D58b01F05ca756144);
        _marketingAddress = payable(0xB7739f38FEcbF36Ce647cb8D58b01F05ca756144);
