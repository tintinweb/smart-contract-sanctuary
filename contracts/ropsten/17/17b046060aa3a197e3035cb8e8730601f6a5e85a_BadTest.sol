...
contract BadTest is ERC721, Ownable {
    ...
    uint256 public constant BADDIE_PRICE = 0.06 ether; // 0.06 ETH
    uint256 public constant NUM_TO_RESERVE = 40;

    constructor() public ERC721("BadTest4", "BTN") {}
    ...
    function mintBaddies(uint256 numberOfTokens) public payable returns (uint256) {
        require(SALE_STARTED, "Sale must be started to mint baddies");
        require(
