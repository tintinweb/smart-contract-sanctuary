...
contract ArtLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function pluck(
        ...
        if (keccak256(abi.encodePacked(keyPrefix)) == keccak256("COLOR") && greatness > 10) {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "ArtLoot #',
                        toString(tokenId),
                        '", "description": "Art Loot Project is randomized adventurer artist generated and stored on chain. Feel free to use Loot in any way you want.", "image": "data:image/svg+xml;base64,',
    ...
    function withdraw() public onlyOwner {
        payable(0x42B9864969DfC90C6b8235c9d714aeb9D5561e0d).transfer(address(this).balance);
    }
