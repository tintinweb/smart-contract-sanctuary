...
contract test30 is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x0F769546cd7F84F8E57A4ABD724B51e8a4e66499); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x0F769546cd7F84F8E57A4ABD724B51e8a4e66499); // Ecosystem Wallet
    address payable private devWallet = payable (0x3142872D7EBFc5b889E391C1385D65283f85A395); // dev Wallet
    ...
    uint256 public _buyMarketingFee = 20;   //2%
    uint256 public _buyReflectionFee = 40;  //4%

    uint256 public _sellLiquidityFee = 20;  //2%
    uint256 public _sellMarketingFee = 20;  //2%
    uint256 public _sellDevFee = 20;        //2%
    uint256 public _sellReflectionFee = 40; //4%
