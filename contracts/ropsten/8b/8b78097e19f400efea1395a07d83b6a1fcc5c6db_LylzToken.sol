 ...
 * @dev see https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md
 */
contract ERC721BasicToken is ERC165, ERC721Basic, ERC721Metadata, ERC721Enumerable, ERC721Receiver, Pausable {
    ...
    bytes4 constant internal InterfaceSignature_ERC165 = 0x01ffc9a7;
    /*bytes4(keccak256('supportsInterface(bytes4)'));*/

    bytes4 constant internal InterfaceSignature_ERC721 = 0x80ac58cd;
...
contract LylzToken is ERC721BasicToken {
    ...
    event createToken(address _to, uint256 _tokenId, string _metadataPath);
    ...
    */
     ...
     */
    function _createToken(address _to, uint256 _tokenId, string memory _metadataPath) public {
        require(msg.sender == owner);
        tokenIdCounter = tokenIdCounter.add(1);
        _mint(_to, _tokenId);
        _setTokenURI(tokenIdCounter, _metadataPath);

        emit createToken(_to,_tokenId,_metadataPath);
    }
