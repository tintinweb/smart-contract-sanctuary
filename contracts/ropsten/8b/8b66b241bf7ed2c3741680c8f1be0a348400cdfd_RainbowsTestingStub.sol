...
// File: contracts/RainbowTestingStub.sol
...
contract RainbowsTestingStub is ERC20, Ownable, Pausable {
    ...
    constructor(address evilNoundlesAddress) ERC20("NoundlesRainbows", "Rainbows") {
    ...
    */
    ...
    function claimReward() external whenNotPaused {
        ...
        _mint(msg.sender, evilNoundleLists.length);
    }
}