...
contract Mtrshirazi6 is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    constructor() ERC20("mtrshirazi6", "m6t") {
        _mint(msg.sender, 50000 * 1 ** decimals());
    }
