...
contract ERC721 is Context ,ERC165, IERC721, IERC721Metadata, Ownable, Pausable {
    ...
    event PaymentTokenWhitelistChanged(address indexed paymentToken, bool isERC20);
    ...
    function createToken() public  {
        ...
        function unplace(uint256 tokenId) private {
            ...
            function setWhitelistedPaymentToken(address paymentToken, bool isERC20) external onlyOwner {
                _whitelistedERC20[paymentToken] = isERC20;

                emit PaymentTokenWhitelistChanged(paymentToken, isERC20);
            }

            function whitelistedPaymentToken(address paymentToken) external view returns (bool) {
