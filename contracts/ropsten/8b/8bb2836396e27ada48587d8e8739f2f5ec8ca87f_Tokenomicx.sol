...
contract Tokenomicx is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Tokenomicx() {
        ...
        name = &quot;Tokenomicx&quot;;                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 4;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = &quot;NOMX&quot;;                                             // Set the symbol for display purposes (CHANGE THIS)
