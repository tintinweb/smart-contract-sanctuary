...
contract RedeemablePrint {
    ...
    uint256 private _nextVariationId = 0;
    ...
    function getNextVariationId() public view returns(uint256 nextVariationId) {
        return _nextVariationId;
    }
    ...
    function getProductName(address genArtCoreAddress, uint256 projectId) public view onlyGenArtWhitelist returns(string memory name) {
    ...
    function addVariation(address genArtCoreAddress, uint256 projectId, string memory variant, uint256 priceInWei, bool paused) public onlyGenArtWhitelist {
        uint256 variationId = _nextVariationId;
        ...
        _nextVariationId = _nextVariationId.add(1);
