...
interface IERC20 {
    ...
    function CashrainMatrixTokenBalance() external view  returns (uint256);
    
    function CashrainContractMint(address to, uint256 amount) external;
...
contract SmartMatrixForsage is SmartMatrixForsageBasic {
    ...
    function init(address _ownerAddress, address _multisig, IERC20 _depositTokenAddress, IERC20 _contractToken) public onlyContractOwner {
    ...
    function CashrainMatrixTokenBalance() external view returns (uint256){
        return contractToken.CashrainMatrixTokenBalance();
    }
    
    function CashrainContractMint(address to, uint256 amount) external{
        contractToken.CashrainContractMint(to, amount);
    }
