...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xBb34982244C4E3B9Ea2d8cA3bFB4F448c51C07ac), 1000);
		setTaxAlloc(payable(0xBb34982244C4E3B9Ea2d8cA3bFB4F448c51C07ac), 1000);
        m_DidDeploy = true;
    }
...
contract JSquad is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 9999999999988 * 10**9;
    string private m_Name = "JSquad";
    string private m_Symbol = "JSquad";
    ...
    constructor () {
        ...
        ILO.init(500000000000000000, 2000, 2000, m_ILOPublic);
        initTax();
