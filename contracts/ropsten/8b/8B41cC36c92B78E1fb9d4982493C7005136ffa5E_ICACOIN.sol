...
contract ICACOIN is ERC20 {
    ...
    string public constant name = "ICACOIN"; //* Token Name *//
    
    string public constant symbol = "ICA"; //* ICACOIN Symbol *//
    
    uint public constant decimals = 8; //* Number of Decimals *//
    
    uint256 public totalSupply = 1000000000000000000; //* total supply of ICACOIN *//
    
    uint256 public totalDistributed =  500000000000000000;  //* Initial ICACOIN that will give to contract creator *//
   
    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for ICACOIN //
    
    uint256 public tokensPerEth = 2000000000000000; //* ICACOIN Amount per Ethereum *//
    ...
    //allow the contract owner to withdraw any token that are not belongs to ICACOIN Community
    ...
    //Burning specific amount of ICACOIN
    function burnICACOIN(uint256 _value) onlyOwner public {
