...
using SafeMath for uint256;
	...
	constructor() public {
		...
		adPriceWeek = 1000000000000000000;
		adPriceMultiple = 1;
	...
	// get last purchaseTimestamp
	function getPurchaseTimestamp() public view returns (uint _purchaseTimestamp) {
		return purchaseTimestamp;
	}

	// get last owner
	function getLastOwner() public view returns (address _lastOwner) {
		return lastOwner;
	}

	// get dapp id advertising
	function getDappId() public view returns (uint _dappId) {
		return dappId;
	}

	// get seconds ad was purchased for
	function getPurchaseSeconds() public view returns (uint _purchaseSeconds) {
	...
	function getTheInvestor() public view returns (address _theInvestor) {
		return theInvestor;
	}

	function getInvestmentMin() public view returns (uint _investmentMin) {
		return investmentMin;
	}

	function getAdPriceHour() public view returns (uint _adPriceHour) {
		return adPriceHour;
	}

	function getAdPriceHalfDay() public view returns (uint _adPriceHalfDay) {
		return adPriceHalfDay;
	}

	function getAdPriceDay() public view returns (uint _adPriceDay) {
		return adPriceDay;
	}

	function getAdPriceWeek() public view returns (uint _adPriceWeek) {
		return adPriceWeek;
	}

	function getAdPriceMultiple() public view returns (uint _adPriceMultiple) {
		return adPriceMultiple;
	}
