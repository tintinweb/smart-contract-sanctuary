...
// ----------------------------------------------------------------------------
// 'Multiple' token contract
//
// Deployed to : 0x09d5291C6313dC6a42317C814BDE827EBACDB658
// Symbol      : Multiple
// Name        : MTT
// Total supply: 100
// Decimals    : 18
...
contract Multiple is ERC20Interface, Owned, SafeMath {
  ...
  function isActive() public view returns (bool) {
    ...
    if(tokensAvailable() >= tokensToSend) {
      transfer(recipient, tokensToSend);
  ...
  function tokensAvailable() public view returns (uint256) {
   ...
   function sendTokens(address[] calldata dests, uint256[] calldata values) whenDropIsActive onlyOwner external {
    uint256 i = 0;
