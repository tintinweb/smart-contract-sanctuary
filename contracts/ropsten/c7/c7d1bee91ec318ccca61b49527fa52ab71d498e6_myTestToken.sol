...
contract myTestToken is Context, IERC20, Ownable {
    ...
    string private _name = "myTestTokenV3";
    string private _symbol = "mTTv3";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000 * 10**6 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x508E3a9B9C84f0F4163D148BC75082ebCd8d289C);
    address public marketingWalletToken = 0xaD6D458402F60fD3Bd25163575031ACDce07538D;
    ...
    uint256 private constant _maxFees = 8;
    ...
    constructor () {
        ...
        _liquifyThreshhold = 1 * 10**4 * 10**_decimals;
    ...
    function _transfer(
        ...
        if(
            ...
            assert(amount.add(feesToContract).add(toBurnAmount) == amountBefore);   // TODO delete
