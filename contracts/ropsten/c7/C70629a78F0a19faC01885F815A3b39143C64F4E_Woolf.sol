...
//  uint256 public constant MINIMUM_TO_EXIT = 2 days;
   ...
   */
address public _woolf;
address public _wool;
  constructor() { 
//	address _woolf = 0xF085331d2Bcc405bF0b70ba346cf2174440A8A78;
//	_wool = 0x3d9C5491847d4f53CCC238DbF22e53b1950De12f;
	setWool(0x3d9C5491847d4f53CCC238DbF22e53b1950De12f);
//    wool = WOOL(_wool);
  }
  function setWoolf(address addr)public onlyOwner {
	_woolf = addr;
   	 woolf = Woolf(_woolf);
  }

  function setWool(address addr)public onlyOwner {
	_wool = addr;
	 wool = WOOL(_wool);
  }
...
//  uint256 public constant MINT_PRICE = .00000069420 ether;
  uint256 public constant MINT_PRICE = .0000002 ether;
...
address public _traits;
  constructor() ERC721("Wolf Game", 'WGAME') { 
	...
	setTraits(0x2FBe18e09B4Ab9196E34fB35817C28F56d551064);
...
//    traits = ITraits(_traits);
  ...
  function mint(uint256 amount, bool stake) external payable whenNotPaused {
    ...
    require(amount > 0 && amount <= 10000, "Invalid mint amount: The quantity cannot be more than 10000");
