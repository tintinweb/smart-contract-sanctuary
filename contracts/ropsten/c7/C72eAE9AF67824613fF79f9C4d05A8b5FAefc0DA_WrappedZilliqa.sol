...
/**
* @title WrappedZilliqa - Zilliqa Token for Ethereum.
*
...
*/
contract WrappedZilliqa is ERC20, ERC20Detailed {
  using SafeMath for uint256;

  address public lockProxyAddress;

  constructor(address _lockProxyAddress) ERC20Detailed("Ethereum-bridged ZIL Token", "ZIL", 12) public {
    lockProxyAddress = _lockProxyAddress;
  }

  function _transfer(address sender, address recipient, uint256 amount) internal override {
      if (sender == lockProxyAddress) {
          require(recipient != lockProxyAddress, "WrappedZilliqa: lockProxy should not call transfer to self");
