...
contract ACLYDcidTOKEN is ERC20Interface, Owned, SafeMath {
    ...
    string public cidTokenSym = "ACLYDcid";
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function ACLYDcid() public {
        companyName = "The Aclyd Project LTD.";
        cidTokenSym = "ACLYDcid";
        decimals = 0;
        _cidTokenSupply = 11;
        balances[0xf4484D07E97681CF1BdBbd3d1e4884cfE97B1762] = _cidTokenSupply;
        Transfer(address(0), 0xf4484D07E97681CF1BdBbd3d1e4884cfE97B1762, _cidTokenSupply);
    }
