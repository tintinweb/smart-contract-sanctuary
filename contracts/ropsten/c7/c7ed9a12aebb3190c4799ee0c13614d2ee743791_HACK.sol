...
contract HACK is ERC20 {
    ...
    // The initial mint.
    uint public constant INITIAL_MINT = 1000000;   // 1M
    ...
    mapping(uint16 => uint) public mapYearlyMint;    // Will have a problem from year 65536 :)
    ...
    constructor () ERC20("Hackout", "HACK") {
        ...
        // require(startYear == 2021, "start year error!");
