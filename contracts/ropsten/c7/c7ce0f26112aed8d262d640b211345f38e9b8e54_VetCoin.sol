pragma solidity >=0.4.22 <0.6.0;
 ...
 contract VetCoin {
    ...
    mapping (address => uint256) public balanceOf;
     string public name = "VetCoin";
    string public symbol = "Vets";
