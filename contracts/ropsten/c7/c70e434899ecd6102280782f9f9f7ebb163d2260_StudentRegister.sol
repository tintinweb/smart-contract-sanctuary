 ...
 */
   ...
   */
     ...
     */
    function register(address studentId,string memory name,string memory course,uint256 mark1,uint256 mark2,uint256 mark3) public  {
            /**
        ...
        function update(address studentId,string memory name) public  {

            require(students[studentId].isExist==true,"ha.. ha... Fraud Not Possible,student details already registered and cannot be altered");
   ...
   function getStudentDetailsName(address studentId) public view returns (address,string memory){
