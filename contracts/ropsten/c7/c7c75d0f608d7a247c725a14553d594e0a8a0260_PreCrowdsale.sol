...
contract PreCrowdsale is Context, ReentrancyGuard {
    ...
    function _preValidatePurchase(address _beneficiary, uint256 _weiAmount) internal view {
        ...
        require(_weiAmount >= 50*1e18, "PreCrowdsale: weiAmount should be atleast 50 BUSD");
        require(_weiAmount <= 5000*1e18, "PreCrowdsale: weiAmount should be atleast 5000 BUSD");
