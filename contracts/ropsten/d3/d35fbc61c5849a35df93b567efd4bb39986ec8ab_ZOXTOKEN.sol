...
contract ZOXTOKEN is ERC20 {
    ...
    string public constant name = "ZOX";
    string public constant symbol = "ZOX";
    uint public constant decimals = 8;
    uint public deadline = now + 39 * 1 days;
    uint public round2 = now + 34 * 1 days;
    uint public round1 = now + 24 * 1 days;
