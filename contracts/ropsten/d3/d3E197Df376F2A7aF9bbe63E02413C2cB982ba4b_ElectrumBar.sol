...
// File @lydiaswap/lydia-swap-lib/contracts/GSN/[email protected]
...
// File @lydiaswap/lydia-swap-lib/contracts/access/[email protected]
...
// File @lydiaswap/lydia-swap-lib/contracts/token/ERC20/[email protected]
...
// File @lydiaswap/lydia-swap-lib/contracts/math/[email protected]
...
// File @lydiaswap/lydia-swap-lib/contracts/utils/[email protected]
...
// File contracts/LydToken.sol

pragma solidity 0.6.12;

// LydToken with Governance.
contract LydToken is ERC20('LydiaFinance Token', 'LYD') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (Croesus).
...
// File contracts/ElectrumBar.sol

pragma solidity 0.6.12;

// ElectrumBar with Governance.
contract ElectrumBar is ERC20('ElectrumBar Token', 'ELECTRUM') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (Croesus).
    function mint(address _to, uint256 _amount) public onlyOwner {
        _mint(_to, _amount);
        _moveDelegates(address(0), _delegates[_to], _amount);
    ...
    function safeLydTransfer(address _to, uint256 _amount) public onlyOwner {
