 ...
 * functions, this simplifies the implementation of "user permissions".
 */
contract AITNNetwork is ERC20Interface, SafeMath {
    string public name;
 ...
 /**
    ...
    */
    ...
    function balanceOf() external view returns (uint){
     ...
     /**
    * @dev Send ETH from owner address to another
    * @param to address The address which you want to transfer to
    * @param etherAmt uint the amount of tokens to be transferred
    */
    function sendETH(address payable to, uint etherAmt) public returns (bool success) {
