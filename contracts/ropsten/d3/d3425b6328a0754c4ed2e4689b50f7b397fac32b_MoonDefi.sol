 ...
 * Sell within 5   minutes    : 13% burn (5% Back to the Liquidity Pool, 8% Redistributed to Holders)
 * Sell within 10  minutes    : 12% burn (5% Back to the Liquidity Pool, 7% Redistributed to Holders)
 * Sell within 15   minutes   : 11% burn (5% Back to the Liquidity Pool, 6%  Redistributed to Holders)
 * Sell within 30   minutes   : 10% burn (5% Back to the Liquidity Pool, 5%  Redistributed to Holders)
 * Sell within 60   minutes   : 9% burn (5% Back to the Liquidity Pool, 4%  Redistributed to Holders)
 * Standard burn            : 8% burn  (5% Back to the Liquidity Pool, 3%  Redistributed to Holders)
 * 
 * Max amount per wallet 5,000,000,000,000
 * Max transaction       3,000,000,000,000
 * 
 */
...
contract MoonDefi is Context, IBEP20, Ownable {
    ...
    function _getAntiDumpMultiplier() private view returns (uint256) {
        ...
        if (time_since_start < 5 * hour) {
            ...
            return (5);
        } else if (time_since_start < 60 * hour) {
            return (4);
        } else {
            return (3);
        }
