...
contract Staking {
    ...
    uint256[2] public aprs = [5 * 60, 90 * 6];
    ...
    function stake(uint8 _class, uint _amount) public {
        ...
        uint256 _finalAmount = _amount + (_amount * aprs[_class]) / denomenator;
    ...
    function prolong(uint256 _index) public {
        ...
        uint256 _newFinalAmount = _s.finalAmount + (_s.finalAmount * aprs[_s.class]) / denomenator;
