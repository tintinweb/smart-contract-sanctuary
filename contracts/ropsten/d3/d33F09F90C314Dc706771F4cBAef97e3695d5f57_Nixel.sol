...
contract Nixel is ERC721Enumerable, Ownable {
    ...
    address public pixelContractAddress;
    ...
    function createSpawn(int256 x_pos, int256 y_pos) public onlyOwner {
        require(pixelContractAddress != address(0), "Pixel contract not set");
        ...
        pixelContract.mint(_msgSender(), nixelPixelMint);
    ...
    function setPixelContract(address contractAddress) public onlyOwner {
        ...
        pixelContractAddress = contractAddress;
    }
    ...
    function mint(int256 x_pos, int256 y_pos) public payable {
        ...
        pixelContract.mint(_msgSender(), nixelPixelMint);
        pixelContract.mint(address(pixelContract), nixelPixelMint / 2);
        pixelContract.addLiquidity(nixelPixelMint / 2, amountLiquidity);
        _blockOwner[x_pos][y_pos] = _msgSender();
        _blockTokenId[x_pos][y_pos] = totalBlocks + 1;
        _blockLocation[totalBlocks + 1] = [x_pos, y_pos];
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    /**
     * @dev Returns Data for a given token location.
     ...
     */
    function blockOwner(int256 x_pos, int256 y_pos) public view virtual returns (address)
    {
    ...
    /**
     * @dev Returns Data for a given token location.
     * @param tokenId int location of the token to query // e.g. location_x = "0"
     */
    ...
    function transferFrom(
        ...
        require(_blockOwner[blockLocation(tokenId)[0]][blockLocation(tokenId)[1]] == _msgSender(),"Cannot transfer block you do not own");
