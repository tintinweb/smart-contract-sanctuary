...
contract Beru is ERC20, CoinRateMintableStandard, Ownable {
    using SafeMath for uint256;

    string public name = "Beru";
    string public symbol = "BERU";
...
//--------------------------------------------------------------------------------------
    ...
    uint256 public eraInterval = 180 * (10**decimals);
    ...
    function getCoinRateMinting() internal view returns (uint) {
        ...
        uint blockRate = totalSupply / coinRateRewards;
        uint rewardRate = blockRate * eraInterval;
        uint coinRateMinting =  coinRate * rewardRate;
