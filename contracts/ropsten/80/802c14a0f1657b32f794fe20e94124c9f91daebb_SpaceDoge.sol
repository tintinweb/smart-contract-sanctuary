...
contract SpaceDoge is Context, IERC20, Ownable {
  ...
  uint allTheEth;
    ...
    uint256 public _liquidityFee = 3; //(1% liquidityAddition + 1% CommunityFund)
