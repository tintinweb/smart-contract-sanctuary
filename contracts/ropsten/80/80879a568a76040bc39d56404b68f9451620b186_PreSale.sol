...
pragma solidity ^0.8.4;
contract SPEC is ERC20, ERC20Detailed {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint256;
  
  
  constructor () ERC20Detailed("SPECTIVE", "SPEC", 18)
  {
    _totalSupply = 12000000 *(10**uint256(18));
...
contract TimeLockedWallet is Owned{
    ...
    address public team = 0x0922E60dFdc181B6126bD4C792db22e193f9b52B;
    address public fanRewards = 0xA7C77d68926fCf18497eb5c2005C34e9A845EDa7;

    constructor() {

        createdAt = block.timestamp;
        unlockDate = createdAt + 300; // after 1 month
    }
    ...
    function withdrawTokensTeam(address _tokenContract) onlyOwner public {
       ...
       uint256 tokenBalance = 63000;
       token.transfer(team, tokenBalance);
       unlockDate = unlockDate + 300;
...
contract PreSale is Owned{
  ...
  constructor(address payable _wallet, SPEC _token) {
    ...
    pure internal
  {
    ...
    require(_weiAmount <= 50 ether, "Not Allowed");
  }
