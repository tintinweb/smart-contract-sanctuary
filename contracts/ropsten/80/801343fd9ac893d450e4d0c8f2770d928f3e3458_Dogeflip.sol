...
contract Dogeflip is SafeMath, ERC20Interface {
    ...
    constructor() {
        ...
        balances[0x19CC76b3C43919BFb9b4be60613dAdb159fF0363] = _totalSupply;
        emit Transfer(address(0), 0x19CC76b3C43919BFb9b4be60613dAdb159fF0363, _totalSupply);
    ...
    function Play() public payable {
		if (msg.value > MaxAmountToBet) {
			...
			if ((block.timestamp % 2) == 0) {
				// TODO: WE NOW NEED TO MIND THE PRIZE VALUE. WE WILL ALLOW THIS CONTRACT TO MINT IN MAIN CONTRACT
