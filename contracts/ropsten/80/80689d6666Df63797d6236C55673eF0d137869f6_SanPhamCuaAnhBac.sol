...
contract SanPhamCuaAnhBac{
    ...
    function createProduct(string _name, string _serialNo, string _price, string _dateCreate) public {
        ...
        emit ProductCreated(productCount, _name, _serialNo, _price,_dateCreate);
    }
