...
contract Mythies is ERC721Enumerable, ERC721URIStorage, Ownable {
  ...
  function mintMythie(address recipient, string memory _tokenURI) public returns (uint256) {
    ...
    console.log('mintMythie', newMythieId, _exists(newMythieId));
    console.log('mythieExists[newMythieId]', mythieExists[newMythieId]);
    ...
    tokenURItoTokenId[_tokenURI] = newMythieId;
