...
contract CtrToken is Ownable, ERC20Burnable {
    ...
    constructor(address wallet, uint256 initialSupply) Ownable() ERC20("Creator Chain","CTR") {
        require(initialSupply <= MAX_TOTAL_SUPPLY, "ERC20: mint amount exceeds MAX_TOTAL_SUPPLY");
