...
contract EthosOri_411 is ERC20,PoSTokenStandard,Ownable {
    using SafeMath for uint256;

    string public name = "EthosOri_411";
    string public symbol = "ET0R411";
...
//------------------------------------------------------------------------------
    ...
    function annualInterest() constant returns(uint interest) {
        ...
        if((_now.sub(stakeStartTime)).div(365) == 0) {
            ...
            interest = (125 * maxMintProofOfStake).div(100);
        }
    }
    ...
    function burnSupply(uint _value) onlyOwner {
        require(_value > 0);
