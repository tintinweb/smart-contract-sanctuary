...
contract MasterChef is Ownable {
        ...
        returns (uint256)
    {
        ...
        return user.amount.mul(accMobiFiPerShare).div(1e12).sub(user.rewardDebt);
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        // MobiFi.mint(devaddr, MobiFiReward.div(10));
    ...
    function safeMobiFiTransfer(address _to, uint256 _amount) internal {
        ...
        uint256 MobiFiSupply = MobiFi.totalSupply();
        if (MobiFiSupply.add(_amount) > MaxSupply) {
            MobiFi.transfer(_to, 0);
        } else {
