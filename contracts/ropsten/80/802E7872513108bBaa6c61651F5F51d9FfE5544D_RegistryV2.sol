...
contract RegistryV2 is IRegistry, AccessControl, VersionedInitializable {
    ...
    uint256 public constant REGISTRY_REVISION = 0x2; // Version 2

    function getRevision() internal override pure returns (uint256) {
        return REGISTRY_REVISION;
    }

    function getRevisionV2() external pure returns (uint256) {
        return REGISTRY_REVISION;
    }
