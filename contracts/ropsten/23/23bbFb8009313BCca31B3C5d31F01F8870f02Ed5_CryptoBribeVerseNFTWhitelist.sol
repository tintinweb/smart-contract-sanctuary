...
contract CryptoBribeVerseNFTWhitelist is ERC721Enumerable, Ownable {
    ...
    address public constant creator1Address = payable(0x8B7229bb7CbC23d9dB404704FF1BefF705226006);
    address public constant creator2Address = payable(0xF34b0b6A3F07C35E933e380777a65f733C483ABA);
    address public constant devAddress = payable(0x627306090abaB3A6e1400e9345bC60c78a8BEf57);
    ...
    function cost(uint256 _count) public view returns (uint256) {
    ...
    //     require(paused, "Pause is disable");
