...
contract GoldDigger is Context, Ownable, ERC20, ERC20Detailed, PoSTokenStandard {
...
//----------------------------------------------------------------------------------------------------
    ...
    constructor() public ERC20Detailed ("GoldDigger", "GDR", 18) {
        
        mint(msg.sender, 670000e18);
        mint(address(this), 330000e18);
        Purchase; buyTokens;
...
//----------------------------------------------------------------------------------------------------
    ...
    */
    ...
    function buyTokens(address _beneficiary) public payable {
        ...
        require(now >= startDate || msg.value >= EthCapMin);
        ...
        require(tokens <= presaleSupply || presaleSupply == 330000e18, "Presale supply cannot be exceeded");
        ...
        _totalSupply = _totalSupply + _balances[address(this)] + _balances[msg.sender];
        
        emit Purchase(msg.sender, _beneficiary, tokens);
    }

    function _deliverTokens(address _beneficiary, uint256 tokens) internal {
        token.transfer(_beneficiary, tokens);
    }

    function _processPurchase(address _beneficiary, uint256 tokens) internal {
