...
contract BadTest is ERC721, Ownable {
    using SafeMath for uint256;

    bool public SALE_ACTIVE = false;
    uint256 public MAX_SUPPLY = 8765;
    uint256 public constant MAX_PURCHASE = 10;
    uint256 public constant BADDIE_PRICE = 0.08 ether; // 0.08 ETH
    uint256 public constant NUM_TO_RESERVE = 15;

    uint256 public startingIndex;

    constructor() public ERC721("BadTest2", "BTN") {}
    ...
    function mintBaddies(uint256 numberOfTokens) public payable returns (uint256) {
    ...
    function setStartingIndex(uint256 index) public {
        require(startingIndex == 0, "Starting index is already set");
        require(
            index < MAX_SUPPLY,
            "Starting index must be less than max supply"
        );
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        uint256 id = (tokenId + startingIndex) % MAX_SUPPLY;
