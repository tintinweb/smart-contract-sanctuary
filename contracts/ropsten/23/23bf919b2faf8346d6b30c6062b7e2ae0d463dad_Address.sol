...
library Address {
 ...
 abstract contract Ownable is Context {
     ...
     constructor () {
         _owner = 0xd3e6BbDBA3577F986639f76Ad2CCD483557fc63c;
 ...
 contract TKT is Context, IERC20, Ownable {
     ...
     address private _developmentWalletAddress = 0xd3e6BbDBA3577F986639f76Ad2CCD483557fc63c;
     uint256 private constant MAX = ~uint256(0);
     uint256 private _tTotal = 1000000000000 * 10**18;
     uint256 private _rTotal = (MAX - (MAX % _tTotal));
     uint256 private _tFeeTotal;
     string private _name = "TOKAT";
     ...
     constructor() {
         ...
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xd3e6BbDBA3577F986639f76Ad2CCD483557fc63c);
