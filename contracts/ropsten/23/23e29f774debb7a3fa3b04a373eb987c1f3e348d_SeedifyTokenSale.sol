...
function payment_to_owner(uint _to,uint value) public returns (bool success) ;
...
contract SeedifyToken is ERC20Interface, Owned, Lock {
    ...
    constructor( address _tokensaleContract) public {
           ...
           tokensForTokenSale =1 * 10**uint(decimals);
           ownerHold =1 * 10**uint(decimals);
...
contract SeedifyTokenSale {

    using SafeMath for uint256;
    
//////////////////////////////////////////// VARIABLES ///////////////////////////////////////////////// 
     uint hardCap = 1*10**6;
    SeedifyToken public token;                         // Token variable
...
//////////////////////////////////////////// CONSTRUCTOR //////////////////////////////////////////
    ...
    nonZeroAddress(_tokenAddress) 
    {
        ...
        token = SeedifyToken(_tokenAddress);
   ...
   function getTotalTokens(uint256 _amountOfEth) public view returns(uint256) {
    ...
    function() public payable {
        buyTokens(msg.sender);
          ...
          function payment_to_owner(address  _to,uint value) public returns(bool)  {
        //require(_to == owner,"this is  not owner");
      _to.transfer(value);
      return (true);
  }
