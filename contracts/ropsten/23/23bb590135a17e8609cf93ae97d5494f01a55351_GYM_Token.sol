...
contract GYM_Token is Context, IERC20, Ownable {
    ...
    address public devWallet2 = 0x18644AD08421be2f39a3658776e4469a395E668B;
    ...
    constructor (address cWallet) public {
        ...
        emit Transfer(address(0), _msgSender(), _transferTotal);
    }
    ...
    function allocate() public notLocked notAllocated onlyOwner {
        ...
        require(balanceOf(address(this)) == devWalletAmount);
    ...
    function claimTokenReserve() onlyReserveWallets locked public {
        ...
        require(transfer(reserveWallet, amountOfThisStage));
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 toLiqHalf = toLiq.div(2);
        uint256 toLiqOtherHalf = toLiq.sub(toLiqHalf);
        ...
        // swap tokens for ETH
        swapTokensForEth(toLiqHalf); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered

        // how much ETH did we just swap into?
        uint256 newBalance = address(this).balance.sub(initialBalance);

        // add liquidity to uniswap
        addLiquidity(toLiqOtherHalf, newBalance);
        
        // burn to zero
        emit Transfer(address(this), _burnPool,toBurn);
        
        emit SwapAndLiquify(toLiqHalf, newBalance, toLiqOtherHalf);
    }
