...
contract FlokiSlayer is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private dividendsToken = 0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984;
    address public marketingFeeWallet = 0xA52E7E158727E888C816060e4C51282db7082786;


    constructor() public ERC20("Floki Slayer", "FSL") {
       ...
       address _liquidityReceiver = 0xf7910d70C60E35F6973A00465dD976A0B8b4D21e;
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 newBalance = (IERC20(dividendsToken).balanceOf(address(this))).sub(initialTokenBalance);
        IERC20(dividendsToken).transfer(marketingFeeWallet, newBalance.mul(6));
    ...
    function swapETHForTokens(uint256 ethAmount, address account) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
