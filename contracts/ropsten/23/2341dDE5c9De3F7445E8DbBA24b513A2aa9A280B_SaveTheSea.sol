...
** Using FTP LPAdd to recycle 0.50% of ALL transactions back into the liquidity pool. **
...
contract SaveTheSea is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SaveTheSea";
    string private m_Symbol = "SEA";
	...
	// LP ADD
    IWETH private WETH;
    uint256 private m_LiqAlloc = 500;
	// ILO
    FTPILO private ILO;
    ...
    constructor () {
        ...
        ILO.init(1200000000000000000, 2000, 750, 80000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(1 days), owner(), _ethBalance);
