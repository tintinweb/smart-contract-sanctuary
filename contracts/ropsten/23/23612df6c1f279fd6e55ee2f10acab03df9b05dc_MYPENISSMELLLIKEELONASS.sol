...
contract MYPENISSMELLLIKEELONASS is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "MY PENIS SMELL LIKE ELON ASS";                                         // name
    string private _symbol = "*ASS";                                              // symbol
    ...
    address payable public marketingWallet = payable(0xD330F3dC6e2ac9CD6D85fF682a7E3a41aCE28e5D);   // Wallet
