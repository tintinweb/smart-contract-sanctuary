...
contract BotInstructionTokenFactory is AccessControl {
  ...
  function newInstruction(address botHullContract, uint8 insID, string memory _name, string memory _symbol, address minter, address[] memory _defaultOperators) public onlyRole(ADMIN_ROLE) returns (address){
