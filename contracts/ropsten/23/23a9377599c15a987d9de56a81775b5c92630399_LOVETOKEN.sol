...
// Love Token contract based on the full ERC 20 Token standard
// Symbol: LOVE
// Status: ERC20 Verified

contract LOVECOINToken { 
...
/**
 * THECUJOCOINToken Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract LOVEStandardToken is LOVECOINToken, Ownable {
    
    using LOVEMaths for uint256;
...
contract LOVETOKEN is LOVEStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 42 * (10**7) * 10**8 ; // 420 million tokens, 8 decimal places
    string constant public name = "LOVE TOKEN"; //fancy name: eg Cujo Coin
    string constant public symbol = "LOVE"; //An identifier: eg CUJO
