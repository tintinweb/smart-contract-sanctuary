...
/**
   ...
   I love NFT, NFT is the future of crypto, are you an NFT lover?
   ...
   I suggest a telegram group name for you to create: https://t.me/BSCNFT1000X
   ...
   I will add 0.1 BNB and all the left 49% total supply to the pool
   ...
   it's the best part of the #NFT1000X idea, increasing the liquidity pool automatically, 
...
contract NFT1000X is Context, IERC20, Ownable {
    ...
    string private _name = "NFT 1000X Token";
    string private _symbol = "NFT1000X";
