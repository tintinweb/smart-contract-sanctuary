...
contract MALTESE is ERC20, Ownable {
    ...
    uint256 public _tokenLiquidityThreshold = 5000e18;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        require(lastTransaction[sender] + transfertimeout >= block.timestamp || sender == pair, "currently in transfer timeout");
