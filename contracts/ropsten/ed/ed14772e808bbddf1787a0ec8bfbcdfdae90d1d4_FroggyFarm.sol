...
//    }
    ...
    function formatScript (uint256 tokenId) internal view returns (string memory){
        ...
        string memory hashyString = string(abi.encodePacked("let tokenData={'hash':'",toHexA(tokenId),"'};"));
    ...
    function formatSVG (uint256 tokenId) internal view returns (string memory){
