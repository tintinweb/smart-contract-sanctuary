...
With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, DrunkDOGE was designed to reward holders and discourage dumping.
...
contract DrunkDoge is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Some new BEP20 token";
