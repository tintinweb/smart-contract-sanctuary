...
contract Deserializer {
    ...
    uint256 internal constant SWAP_BYTES_SIZE = 16; 
    uint256 internal constant ADD_LIQUIDITY_BYTES_SIZE = 26; 
    uint256 internal constant REMOVE_LIQUIDITY_BYTES_SIZE = 21; 
    uint256 internal constant TX_COMMITMENT_SIZE = 32;

    uint256 internal constant DEPOSIT_BYTES_SIZE = 6;
    uint256 internal constant WITHDRAW_BYTES_SIZE = 11;
...
contract L2 is ILayer2, Deserializer, PermissionGroups, ReentrancyGuard {
    ...
    bytes32 private immutable EMPTY_OPERATION_COMMIMENT_ROOT;
    bytes32 private immutable EMPTY_TX_COMMIMENT_ROOT;
    bytes32 private immutable EMPTY_HIDDEN_TX_COMMIMENT_ROOT;
    ...
    constructor(
        ...
        bytes memory data = new bytes(NUM_TX_IN_BLOCKS * OPERATION_COMMITMENT_SIZE);
        EMPTY_OPERATION_COMMIMENT_ROOT = sha256(data);
        data = new bytes(NUM_TX_IN_BLOCKS * TX_COMMITMENT_SIZE);
        EMPTY_TX_COMMIMENT_ROOT = sha256(data);
        data = new bytes(NUM_TX_IN_BLOCKS * 32);
        EMPTY_HIDDEN_TX_COMMIMENT_ROOT = sha256(data);
    }
    ...
    function depositNewUser(
        ...
        uint32 padding = 0; // pad to 768 bits
        depositHashes[depositID] = sha256(abi.encodePacked(depositID, publicKey, withdrawTo, tokenID, amount, padding));
        numDeposits += 1;
    ...
    function deposit(
        ...
        uint48 depositID = numDeposits;
        uint256 padding1 = 0;
        uint160 padding2 = 0; // pad to 768 bits
        depositHashes[depositID] = sha256(abi.encodePacked(depositID, accountID, tokenID, amount, padding1, padding2));
    ...
    function submitZkProof(uint256 batchNumber, uint256[] calldata zkProof) external onlyOperator {
        ...
        bytes32 batchCommitment = bytes32(0);
        ...
        )
    {
        ...
        while (operationPtr < operationPtrEnd) {
            ...
            if (opType == OpType.Deposit || opType == OpType.DepositToNew) {
                ...
                withdrawRequest.executed = uint8(BitStream.readBits(operationPtr, 14, 2)) == 1;
...
contract KeysWithPlonkVerifier is VerifierWithDeserialize {
    ...
    function isBlockSizeSupportedInternal(uint32 _size) internal pure returns (bool) {
        if (_size == uint32(32)) { return true; }
        else { return false; }
    }

    function getVkBlock(uint32 _chunks) internal pure returns (VerificationKey memory vk) {
        if (_chunks == uint32(32)) { return getVkBlock32(); }
    }

    
    // MAX_BLOCKS_IN_BATCH=4 MAX_TXS_IN_BLOCK=4 MAX_OPERATIONS_IN_BLOCK=4 VALIDATORS_SIZE=4
    function getVkBlock32() internal pure returns(VerificationKey memory vk) {
        vk.domain_size = 16777216;
        vk.num_inputs = 1;
        vk.omega = PairingsBn254.new_fr(0x1951441010b2b95a6e47a6075066a50a036f5ba978c050f2821df86636c0facb);
        vk.selector_commitments[0] = PairingsBn254.new_g1(
            0x1f42470f3042c138fb273f43ed590a9dc7502094ead0c412f575ffa233c827ab,
            0x06abaaa341c56da3d006524a1ffd448b229379cdcd16d0ef998ff1fd44a58c83
        );
        vk.selector_commitments[1] = PairingsBn254.new_g1(
            0x16e6f4a1e942c1e7db6b9056d82d8baf592c1f7fec1f8b7ff84f3c14094d961d,
            0x1ee579ea8fb99e41f89a334e08bed82f7152fe47a6cab4373a0c351063fc18ae
        );
        vk.selector_commitments[2] = PairingsBn254.new_g1(
            0x2d88b46a2f6019d30a3e9c0d533c34c1b49c4f6c6a2856b68fa562bc204db9e2,
            0x2839cbe6d82bb472a2bcd7a24513f3fcab47147d1328b282384ed079cd12e1bb
        );
        vk.selector_commitments[3] = PairingsBn254.new_g1(
            0x196be35e09ff54150e21e4ed761c655a6db019bbd131da4a4a7cd34e6b4abcc2,
            0x263fc14743df6d5aa8d3c2bc4d3f98368ed66b8c0aab14a8eb59bc942c8f60da
        );
        vk.selector_commitments[4] = PairingsBn254.new_g1(
            0x245ecc02faa611e9ca46c89bad9cc0a0f06411b661fbd1a4b97c6b4258397216,
            0x18b5981f0012d16409b9d11308c2efb11a35c2314ae1736ef235d471ac0f47e2
        );
        vk.selector_commitments[5] = PairingsBn254.new_g1(
            0x1677a56adbde82000870fd1e93cbb4855f953bdad8bfd6a2fa3403525795624c,
            0x0ceb73493002f13633881595a24c64937d779e83410ca08143e0441128c4293a
        );
        ...
        vk.next_step_selector_commitments[0] = PairingsBn254.new_g1(
            0x199af6c1c772c46adfde2843a06e4d69b996c4aa589d559dbc2021cac20a8bfc,
            0x1d02d0c9b9e32d593ee2edbf14d1a91eb74ba8eb0da136dfa19b82047910f9b8
        );

         vk.permutation_commitments[0] = PairingsBn254.new_g1(
            0x0a9f06190d6063810dc70ab562f2df0a8904ba971a109a8deaa19963ebd6798f,
            0x25683547fa17d021e554633a1e1676a72e5833611e1139f6b7b820dbd553422e
        );
        vk.permutation_commitments[1] = PairingsBn254.new_g1(
            0x2512a80748687c8ada80d77b052f0cff027e7e56b6ac894009ad6a244a5d72b5,
            0x2ee28b4e3030540f0ef99fd89133cb3702dcc09a10a8311fb85846121224aa01
        );
        vk.permutation_commitments[2] = PairingsBn254.new_g1(
            0x0a2a2af69b443026cc3cb95dc3d2f8d3ead85380d860bb4e5d75ca4fb98b665a,
            0x07afb453f81d350b6c00ef9e74ff570536fcc6f0f872c574d1ff3397fda88145
        );
        vk.permutation_commitments[3] = PairingsBn254.new_g1(
            0x05628efd743b804483ce12631b24b7b175bd2c454f4c0ab984f3c1cae630a4b1,
            0x1bc4741f14e9848ea6603c9f3b24782bb6a436479e304b37ce924ee76e458525
        );
