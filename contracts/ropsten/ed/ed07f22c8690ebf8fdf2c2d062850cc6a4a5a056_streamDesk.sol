...
byte constant public coinReturn         = 0x07;
    ...
    function addDeal(uint _value, string _seller, string _buyer, uint _commission, string _coinName, bytes32 _hashDeal, string _temporaryWallet) public  {
    ...
    function getDealData(bytes32 _hashDeal) public view returns(uint256, uint256,string,string, byte, uint256, string, string) {
