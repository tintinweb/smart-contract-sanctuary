...
contract BlockplotsGlobalMarket is AccessControl, Initializable {
    ...
    function initialize() public initializer {
        ...
        blockplots = Blockplots(0x95a2f7B60557227937Abb1cdc4a5EA17C9106CBF);
        mapElevationRetriever = MapElevationRetriever(0x5401689755C9cf3E536eF436d1b41e0e1857A0C3);
    ...
    function bid(uint8 col, uint8 row) external payable {
    ...
    function globalbid() external payable {
        require(msg.value >= minBid, "BID::Value should be greater than ETH 0.1");
