...
contract AuctionV21 is IAuctionV21, Initializable, AccessControlUpgradeable {
    ...
    /** Mapping */
    mapping(uint256 => AuctionReserves) public override reservesOf; // [day],
    mapping(address => uint256[]) public auctionsOf;
    mapping(uint256 => mapping(address => UserBid)) public override auctionBidOf;
    ...
    function burnTokenBalance() external onlyMigrator {
        IToken axn = IToken(addresses.mainToken);
        axn.burn(address(this), axn.balanceOf(address(this)));
    }
}
