    ...
    function _bid(address inviterAddress, uint256 artid) nonReentrant internal
     {
         ...
         require(r<241,"ERR_ROUND_REACH_MAX");
        ...
        require(msg.value>payprice, "ERR_NOT_ENOUGH_MONEY");
         ...
         //require(success,"ERR contract transfer eth to bonusPoolAddress fail,maybe gas fail");
         address(uint160(bonusPoolAddress)).transfer(smoney.mul(18).div(100));
...
contract DigitalIdentity is ArtistBase{
