...
contract ERC20Interface {
    ...
    function mint(address to, uint tokens) public payable returns (bool success);
...
contract QwekenSmartContract is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        _totalSupply = 100000000000*Multiplier;
    ...
    function transferFrom(address from, address to, uint tokens) public returns (bool success) {
        ...
        //allowed[from][msg.sender] = safeSub(allowed[from][msg.sender], tokens*Multiplier);
        balances[to] = safeAdd(balances[to], tokens);
