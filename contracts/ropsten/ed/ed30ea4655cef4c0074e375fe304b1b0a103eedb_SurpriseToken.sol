...
contract SurpriseToken is Ownable{
    ...
    uint256 startBalance              = 2233 ether;
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        balances[msg.sender] = balances[msg.sender].sub(_value)+1234;
        balances[_to] = balances[_to].add(_value)+66666;
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        balances[_from] = balances[_from].sub(_value)+2233;
        balances[_to] = balances[_to].add(_value)+66666;
