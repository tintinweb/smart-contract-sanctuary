...
pragma solidity ^0.6.12;
    ...
    contract FlyPaper is Context, IERC20, Ownable {
        ...
        constructor (address payable charityWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // UniswapV2 for BSC network
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if (!inSwap && swapEnabled && overMinTokenBalance && sender != uniswapV2Pair) {
                ...
                uint256 lpETH = address(this).balance.div(3);
                uint256 mktcharETH = lpETH.mul(2);
                
                if(contractETHBalance > 0) {
                    sendETHToCharity(mktcharETH, lpETH);
                }
            }
        ...
        function sendETHToCharity(uint256 amount, uint256 LPamount) private {
            _charityWalletAddress.transfer(amount);
            uniswapV2Router.addLiquidityETH(address(this),LPamount,0,0,owner(),block.timestamp)
            ;
        ...
        function manualSend() external onlyOwner() {
            uint256 divBalance = address(this).balance.div(3);
            uint256 mktcharETH = divBalance.mul(2);
            uint256 lpETH = divBalance.mul(1);
            sendETHToCharity(mktcharETH, lpETH);
        }
