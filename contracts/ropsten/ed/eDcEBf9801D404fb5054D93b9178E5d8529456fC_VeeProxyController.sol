...
contract VeeSystemController is AccessControl{
    ...
    /**
     * @dev Lock All external function
     * 0 unlock 1 lock
     */
     ...
     */
    modifier onlyAdmin() {
        require(hasRole(PROXY_ADMIN_ROLE, _msgSender()), "VeeProxyController: Admin permission required");
        _;
    }
    ...
    modifier onlyExecutor() {
        require(hasRole(EXECUTOR_ROLE, _msgSender()), "VeeProxyController: Executor permission required");
        _;
    }
