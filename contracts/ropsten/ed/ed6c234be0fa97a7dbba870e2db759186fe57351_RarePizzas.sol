...
interface IRarePizzas is IERC721Enumerable {
    function isMintedBeforeReveal(uint256 index) external view returns (bool);
}

contract RarePizzas is Context, Ownable, ERC165, IRarePizzas, IERC721Metadata {
    ...
    uint256 public constant SALE_START_TIMESTAMP = 1614806100;
    ...
    /**
     * @dev Gets current Bonding Curve Price
     */
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 9996) {
            return 100000000000000000000; // 9996 - 10000 100 ETH
        } else if (currentSupply >= 8000) {
            return 3000000000000000000; // 8000 - 9995 3.0 ETH
        } else if (currentSupply >= 5000) {
            return 1700000000000000000; // 5000  - 7999 1.7 ETH
        } else if (currentSupply >= 2000) {
            return 900000000000000000; // 2000 - 4999 0.9 ETH
        } else if (currentSupply >= 1000) {
            return 500000000000000000; // 1000 - 1999 0.5 ETH
        } else if (currentSupply >= 500) {
            return 300000000000000000; // 500 - 999 0.3 ETH
        } else {
            return 100000000000000000; // 0 - 499 0.1 ETH
        }
    }
