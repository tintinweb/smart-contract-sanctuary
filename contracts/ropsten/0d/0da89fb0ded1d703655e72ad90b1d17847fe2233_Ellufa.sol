...
contract Ellufa {
    ...
    constructor() public {
        ...
        companyaddress = 0x706Df7e819E6e6FF0e142FA701202C7bF0A6877c;

        usdt_address = 0x20E59Ee844e5DAEcAE6e6b20f5AB66dbA7974d7d;
    ...
    function initDeposit() external {
        ...
        if (tokendebit == 1) {
            ...
            current_staked = current_staked.add(current_staked);
        }
    }
