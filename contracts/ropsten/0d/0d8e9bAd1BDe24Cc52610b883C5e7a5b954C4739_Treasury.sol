...
import "./mixins/roles/OperatorTreasuryRole.sol";
import "./mixins/CollateralManagement.sol";
import "./mixins/WithdrawFromEscrow.sol";

/**
 * @notice The treasury which collects fees generated by the market.
 * @dev The core responsibility of this contract is collecting fees.
 */
contract Treasury is AdminTreasuryRole, OperatorTreasuryRole, CollateralManagement, WithdrawFromEscrow {
    function initialize(address admin) public initializer {
        AdminTreasuryRole._initializeAdminRole(admin);
    }
}
...
abstract contract CollateralManagement is AdminTreasuryRole {
     ...
     */
    function withdrawFunds(address payable to, uint256 amount) public onlyTreasuryAdmin {
        if (amount == 0) {
 ...
 */
abstract contract WithdrawFromEscrow is AdminTreasuryRole {
    function withdrawFromEscrow(ISendValueWithFallbackWithdraw market) external onlyTreasuryAdmin {
        market.withdraw();
    }
}
 ...
 */
abstract contract AdminTreasuryRole is Initializable, AccessControlUpgradeable {
 ...
 */
abstract contract OperatorTreasuryRole is Initializable, AccessControlUpgradeable {
