...
uint256 _minDecrease) public returns(bool) {
...
stableCoinContract.approve(msg.sender, amount);
...
/// @param _auctionId The GUID of the auction, transformed to uint
function _auctionEnd(bytes16 _auctionId) internal returns(bool) {
...
// 3. Interaction
stableCoinContract.approve(beneficiary, a.lowestBid);
...
//  External functions
//
function auctionEnd(bytes16 _auctionId) external returns(bool){
return _auctionEnd(_auctionId);
}
