...
contract CCC is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Innovation for protocol by CCC Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own CCC to claim reward');
