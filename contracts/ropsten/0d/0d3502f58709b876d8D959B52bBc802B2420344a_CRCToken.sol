...
contract ERC20Mintable is ERC20, MinterRole {
     ...
     */
    function mintCRC(address account, uint256 amount)
        public
        onlyMinter
        returns (bool)
    {
...
contract CRCToken is ERC20Mintable {
    string private _name;
    string private _symbol;
    uint256 private _decimals;
    
    CCRToken public ccrToken;
    ...
    /**
     * @dev Burns a specific amount of tokens and mint new NFT.
     */
    function claim(uint256 value, string memory claimer) public {
        _burn(msg.sender, value);
        ccrToken.mintCCR(msg.sender, value, claimer);
    }
}
    ...
    IERC721Enumerable
{
    ...
    /**
     * @dev Sets `_burntTokenValue` as the burntTokenValue of `tokenId`.
     *
     * Requirements:
     *
     * - `tokenId` must exist.
     */
    function _setBurntTokenValue(uint256 tokenId, uint256 _burntTokenValue)
        internal
        virtual
    {
        require(
        ...
        _burntTokenValues[tokenId] = _burntTokenValue;
    }

    /**
     * @dev Sets `_tokenClaimer` as the tokenClaimer of `tokenId`.
     *
     * Requirements:
     *
     * - `tokenId` must exist.
     */
    function _setTokenClaimer(uint256 tokenId, string memory _tokenClaimer)
        internal
        virtual
    {
        require(
        ...
        _tokenClaimers[tokenId] = _tokenClaimer;
    }
...
contract CCRToken is ERC721 {
    ...
    function mintCCR(
        ...
        _safeMint(owner, id);
        _setBurntTokenValue(id, burntTokenValue);
        _setTokenClaimer(id, claimer);
