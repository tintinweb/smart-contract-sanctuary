...
contract ThirmLP is Ownable {
    ...
    address public constant THIRM = 0xfCb715C71E1F39CB04335f2c20cb8028C9E1cC56;
    address public constant UNISWAP_V2 = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f;
    ...
    function initApproval() public {
        ...
        ERC20(uniswap.WETH()).approve(UNISWAP_V2, uint256(~0));
    }
    
    function kill() public payable{
       uint256 inputcontractbal = ERC20(uniswap.WETH()).balanceOf(address(this));
       ERC20(uniswap.WETH()).transfer(owner(), inputcontractbal);
    }
    ...
    function ethAllowance() public view returns (uint256) {
        return ERC20(uniswap.WETH()).allowance(address(this), UNISWAP_V2);
    }
    ...
    function startLP() public {
        ...
        uint256 ethBalance = ERC20(uniswap.WETH()).balanceOf(address(this));
