...
contract ILOTest15 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOTest15";
    string private m_Symbol = "ILO15";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x174fb1C329C24636c83cb63727a4C29e8D95DdFd);
