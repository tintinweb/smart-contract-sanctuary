...
// File: interfaces/ISupportingTokenInjection.sol
...
// File: interfaces/IUserInfoManager.sol
...
// File: interfaces/ISmartLottery.sol
...
contract Squidoshi is IBEP20, ISupportingTokenInjection, AntiLPSniper, LockableFunction, SmartBuyback {
    ...
    constructor (uint256 _supply, address routerAddress, address tokenOwner, address _marketingWallet, address _gamingWallet, address owner1, address owner2) AuthorizedList() public {
        _name = "Squidoshi";
        _symbol = "Squidoshi";
        _decimals = 9;
        ...
        uint256 threePointFivePercent = _totalSupply.mul(35).div(1000);
        balances[owner1] = threePointFivePercent;
        emit Transfer(address(this), owner1, threePointFivePercent);
        balances[owner2] = threePointFivePercent;
        emit Transfer(address(this), owner2, threePointFivePercent);
        balances[marketingWallet] = _totalSupply.mul(130).div(1000);
