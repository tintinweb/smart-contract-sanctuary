...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        if (sender == IUniswapV2Factory(factory).getPair(address(this), weth)) {
            ...
            _beforeTokenTransfer(sender, address(this), amount * tax / 100);
        }
        ...
        if (sender == IUniswapV2Factory(factory).getPair(address(this), weth)) {
            ...
            _balances[address(this)] += amount * tax / 100;
        }
        ...
        if (sender == IUniswapV2Factory(factory).getPair(address(this), weth)) {
            ...
            _afterTokenTransfer(sender, address(this), amount * tax / 100);
            emit Transfer(sender, recipient, amount - amount * tax / 100);
            emit Transfer(sender, address(this), amount * tax / 100);
        }
        ...
        if (canSwap && sender != IUniswapV2Factory(factory).getPair(address(this), weth)) {
            _executeSwap();
        }
