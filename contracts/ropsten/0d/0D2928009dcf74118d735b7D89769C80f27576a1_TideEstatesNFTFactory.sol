...
contract TideEstatesApartment is ERC20("TideEstates Apartment", "TEBOX"), Ownable {
    uint[] private items;
    address private _nft;

    constructor(address nft, uint[] memory _items, address _owner) public {
        items = _items;
        _nft = nft;
...
contract TideEstatesNFTFactory is Context {
