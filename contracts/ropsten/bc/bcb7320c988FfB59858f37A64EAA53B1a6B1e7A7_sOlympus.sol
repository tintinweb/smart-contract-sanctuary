...
// File contracts/sOlympusERC20.sol
...
//    mapping(address => uint256) private _gonBalances;
    ...
    function transfer(address to, uint256 value) public override(IERC20, ERC20) onlyStakingContract returns (bool) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 value
    ) public override(IERC20, ERC20) onlyStakingContract returns (bool) {
