...
contract TBond is ERC20BurnableUpgradeable, Operator {
    /**
    ...
    function initialize() public initializer {
        __Context_init_unchained();
        __Operator_init_unchained();
        __ERC20_init_unchained("TBOND", "TBOND");
        __ERC20Burnable_init_unchained();
        __TBond_init_unchained();
    }

    function __TBond_init_unchained() internal onlyInitializing {
    }
