...
library Buffer {
    ...
    /**
     * @dev Appends a byte array to the end of the buffer. Reverts if doing so would exceed the capacity of the buffer.
...
contract HivelocityNetworkTokenSale is usingOraclize {
    ...
    function getEtherPrice() payable public {
        if (oraclize_getPrice("URL") > address(this).balance) {
            emit LogEtherPriceUpdate("Oraclize query was NOT sent");
        } else {
