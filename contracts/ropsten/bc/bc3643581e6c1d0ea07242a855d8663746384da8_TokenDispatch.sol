...
contract TokenDispatch is Management {
    ...
    uint256 private constant _blocksOfMonth = 6;//3600/15*24*30;
    ...
    constructor() public {
        ...
        //_approveTeam(0xd76ea05E548D9D72B5c3b644367aDC8e31a2d8a1, 0xfCa8243ADc135E043D73a6F68DEc771F086277F2, 2500000000000);
        // _approveTeam(0xA1495825865790E5CaB1C00AF620fc73A26D5F0c, 0xfCa8243ADc135E043D73a6F68DEc771F086277F2, 2500000000000);
        // _approveTeam(0x591d4298a8952eCb5a7d8614cF7f02a6dD78C619, 0xfCa8243ADc135E043D73a6F68DEc771F086277F2, 2500000000000);
        // _approveTeam(0xba468580B83f6a93e3a70796D4a861F34F8340a8, 0xfCa8243ADc135E043D73a6F68DEc771F086277F2, 2500000000000);

        // //Core teams
        // _approveTeam(0x8D087B31F94DAAeffbd74770367D4B74e6a06805, 0xfCa8243ADc135E043D73a6F68DEc771F086277F2, 5800000000000);
        // _approveTeam(0x7Be1bC358b677B848bD246BAC48ba04170d13A9b, 0xfCa8243ADc135E043D73a6F68DEc771F086277F2, 5000000000000);
        // _approveTeam(0xD7B6d0190c38a9c2A4CB596d21F1c557d892b681, 0xfCa8243ADc135E043D73a6F68DEc771F086277F2, 6000000000000);
        // _approveTeam(0x9c6A9fB2FE9Bbc64b9eAE4BbcfD0F37823ae9D66, 0xfCa8243ADc135E043D73a6F68DEc771F086277F2, 9000000000000);
    }

    function approveTeam(address account, address agent, uint256 reserved) public onlyOwner {
        _approveTeam(account, agent, reserved);
    }

    function _approveTeam(address account, address agent, uint256 reserved) private {
        require(approvedForTeam.add(reserved) <= totalSupply, 'YouSwap: EXCEEDS_THE_TOTAL_SUPPLY_FOR_TEAM');
        _teamId ++;
        _teams[_teamId].approved = true;
        _teams[_teamId].account = account;
        _teams[_teamId].agent = agent;
        _teams[_teamId].reserved = reserved;

        _teams[_teamId].packageI = reserved.mul(12).div(100);
        _teams[_teamId].packageII = reserved.mul(27).div(100);
        _teams[_teamId].packageIII = reserved.mul(24).div(100);
        _teams[_teamId].packageIV = reserved.mul(37).div(100);

        _teams[_teamId].lastClaimedHeight = startHeight;
        approvedForTeam = approvedForTeam.add(reserved);

        emit ApproveTeam(_teamId, account, agent, reserved);
    }
