...
contract LinkTest is Chainlinked, Ownable {
    bytes32 public SPEC_ID = bytes32("df8d0c29eb26488585444289d74f0019");
    uint public price;
    event PriceReceived(uint price);
    
    constructor() public {
        setLinkToken(0x20fE562d797A42Dcb3399062AE9546cd06f63280);
        setOracle(0x89736523dE51baf4914cc57721651Df72E4F1b4B);        
    }
    
    function setSpecID(bytes32 _specId) public onlyOwner {
        SPEC_ID = _specId;
    }
