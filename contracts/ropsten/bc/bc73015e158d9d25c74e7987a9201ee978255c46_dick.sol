...
contract dick is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "dick";
    string private m_Symbol = "dick";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x74Be98Ce482dF6f59B3c01FCfdCF9b9EddBB4A98);
