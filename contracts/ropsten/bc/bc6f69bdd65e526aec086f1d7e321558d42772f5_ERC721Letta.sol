...
contract ERC721Letta is ERC721Mochi, ReentrancyGuard {
    ...
    function bid(uint256 tokenId, uint256 bid_value) public nonReentrant {
        ...
        // bid at last x minutes, extend endtime y minutes
        if (block.timestamp >= auctions[tokenId].auctionEnd - 10 minutes) {
            auctions[tokenId].auctionEnd = block.timestamp + 10 minutes;
        }
