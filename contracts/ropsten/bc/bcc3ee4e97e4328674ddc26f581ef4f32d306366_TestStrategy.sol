...
contract TestStrategy is BaseStrategy {
    ...
    uint256 public _estimatedTotalAssets;
    constructor(address _vault) public BaseStrategy(_vault) {}
    ...
    function generateLoss(uint256 loss) public onlyOwner {
        _estimatedTotalAssets = loss;
    }

    function estimatedTotalAssets() public override view returns (uint256) {
        
        return _estimatedTotalAssets;//want.balanceOf(address(this));
    }
    ...
    function moveToVault() external onlyOwner {
