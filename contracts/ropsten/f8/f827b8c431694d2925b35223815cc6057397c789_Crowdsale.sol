...
contract TestoToken is Token {
   string public name = 'TestoToken';
...
contract Crowdsale {
   ...
   TestoToken public token;
   address public owner;
   uint256 public tokensSold;
   uint256 public limitCrowdsale = 500e16;
   ...
   constructor(uint256 _tokenRate, address _tokenAddress) public {
      ...
      token = TestoToken(_tokenAddress);
      owner = msg.sender;
   }
