...
contract Youdeum {
    ...
    function SetupYOU(string tokenName, string tokenSymbol, uint256 ExtraTokensPerETHSended, uint256 MaxDistribPublicSupply, uint256 OwnerDistribSupply, address remainingTokensReceiverAddress, address DistribFundsReceiverAddress, uint256 FreeYOU) public {
    ...
    function SetFreeYOU(uint256 FreeYOU) onlyOwner public {
        _FreeYOU = FreeYOU;
    }
