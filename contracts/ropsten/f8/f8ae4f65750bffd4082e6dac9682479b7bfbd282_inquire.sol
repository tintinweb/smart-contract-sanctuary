...
contract inquire is owned{
    ...
    function withdraw_token(address contract_address, uint _amount, uint _decimals)
    onlyOwner public{
        require(erc20Interface(contract_address).transfer(owner, _amount*10**_decimals));
    }
