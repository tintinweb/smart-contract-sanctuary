...
contract Trex is Context, IERC20, Ownable {
    ...
    address public _charityWalletAddress = 0x29D9A1C688DdfF8Fb9B470B0C1200BB0c5b9F7a7;
  ...
  function setNumtokentoLiq(uint256 numToken) external onlyOwner() {
    ...
    receive() external payable {}
      ...
      function withdrawBNB() external onlyOwner{
        ...
        require(_self.balance > 0 , " withdrawBNB : no fund left.");
