...
contract SlimeVerse is ERC721, Ownable, ERC721Enumerable, Pausable  {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("SlimeVerse", "Slime") {}

    // Maximum limit of tokens that can ever exist
    uint16 constant MAX_SUPPLY =16 ; //its 5500 
    uint16 constant MAX_MINT = 2; //its 20
 ...
 ////////ONLY OWNER BELOW SOZ
    ...
    //IN WEI Monies go back into development
