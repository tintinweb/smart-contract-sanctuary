...
contract Factory is Configurable, ContextUpgradeSafe, Constants {
    ...
    function swap(address underlying, address currency, uint priceFloor, uint priceCap, int dCall, int dPut, int undMax, int curMax) public returns (address call, address put, int dUnd, int dCur) {
    ...
    function mint4(address underlying, address currency, uint priceFloor, uint priceCap, int volCall, int volPut, int undMax, int curMax) public returns (address call, address put, int dUnd, int dCur) {
        return swap(underlying, currency, priceFloor, priceCap, volCall, volPut, undMax, curMax);
    }
    function mint(address callOrPut, int volCall, int volPut, int undMax, int curMax) external returns (int dUnd, int dCur) {
    ...
    function mintCall4(address underlying, address currency, uint priceFloor, uint priceCap, int volCall, int undMax, int curMax) public returns (address call, int dUnd, int dCur) {
        (call, , dUnd, dCur) = swap(underlying, currency, priceFloor, priceCap, volCall, 0, undMax, curMax);
    }
    function mintCall(address call, int volCall, int undMax, int curMax) public returns (int dUnd, int dCur) {
        (, , dUnd, dCur) = swap(Call(call).underlying(), Call(call).currency(), Call(call).priceFloor(), Call(call).priceCap(), volCall, 0, undMax, curMax);
    }
    function mintCall_(address sender, address call, int volCall, int undMax, int curMax) public returns (int dUnd, int dCur) {
    ...
    function mintPut4(address underlying, address currency, uint priceFloor, uint priceCap, int volPut, int undMax, int curMax) public returns (address put, int dUnd, int dCur) {
        (, put, dUnd, dCur) = swap(underlying, currency, priceFloor, priceCap, 0, volPut, undMax, curMax);
    }
    function mintPut(address put, int volPut, int undMax, int curMax) external returns (int dUnd, int dCur) {
        (, , dUnd, dCur) = swap(Put(put).underlying(), Put(put).currency(), Put(put).priceFloor(), Put(put).priceCap(), 0, volPut, undMax, curMax);
    }
    function mintPut_(address sender, address put, int volPut, int undMax, int curMax) external returns (int dUnd, int dCur) {
    ...
    function burn4(address underlying, address currency, uint priceFloor, uint priceCap, int volCall, int volPut, int undMax, int curMax) public returns (address call, address put, int dUnd, int dCur) {
        return swap(underlying, currency, priceFloor, priceCap, volCall, volPut, undMax, curMax);
    }
    function burn(address callOrPut, int volCall, int volPut, int undMax, int curMax) external returns (int dUnd, int dCur) {
        (, , dUnd, dCur) = swap(Call(callOrPut).underlying(), Call(callOrPut).currency(), Call(callOrPut).priceFloor(), Call(callOrPut).priceCap(), volCall, volPut, undMax, curMax);
    }

    function burnCall4(address underlying, address currency, uint priceFloor, uint priceCap, int volCall, int undMax, int curMax) public returns (address call, int dUnd, int dCur) {
        (call, , dUnd, dCur) = swap(underlying, currency, priceFloor, priceCap, volCall, 0, undMax, curMax);
    }
    function burnCall(address call, int volCall, int undMax, int curMax) external returns (int dUnd, int dCur) {
    ...
    function burnCall_(address sender, address call, int volCall, int undMax, int curMax) external returns (int dUnd, int dCur) {
        require(msg.sender == call, 'Only Call');
    ...
    function burnPut4(address underlying, address currency, uint priceFloor, uint priceCap, int volPut, int undMax, int curMax) public returns (address put, int dUnd, int dCur) {
        (, put, dUnd, dCur) = swap(underlying, currency, priceFloor, priceCap, 0, volPut, undMax, curMax);
    }
    function burnPut(address put, int volPut, int undMax, int curMax) external returns (int dUnd, int dCur) {
        (, , dUnd, dCur) = swap(Put(put).underlying(), Put(put).currency(), Put(put).priceFloor(), Put(put).priceCap(), 0, volPut, undMax, curMax);
    }
    function burnPut_(address sender, address put, int volPut, int undMax, int curMax) external returns (int dUnd, int dCur) {
        require(msg.sender == put, 'Only Put');
        (, , dUnd, dCur) = _swap(sender, Put(put).underlying(), Put(put).currency(), Put(put).priceFloor(), Put(put).priceCap(), 0, volPut, undMax, curMax);
    }
...
contract Call is ERC20UpgradeSafe {
    ...
    function mint(int volume, int undMax, int curMax) external returns (int dUnd, int dCur) {
        return Factory(factory).mintCall_(_msgSender(), address(this), volume, undMax, curMax);
    }
    
    function burn(int volume, int undMax, int curMax) external returns (int dUnd, int dCur) {
        return Factory(factory).burnCall_(_msgSender(), address(this), volume, undMax, curMax);
    }
    function burnAll(int undMax, int curMax) external returns (int dUnd, int dCur) {
        return Factory(factory).burnCall_(_msgSender(), address(this), int(balanceOf(_msgSender())), undMax, curMax);
    }
...
contract Put is ERC20UpgradeSafe, Constants {
    ...
    function mint(int volume, int undMax, int curMax) external returns (int dUnd, int dCur) {
        return Factory(factory).mintPut_(_msgSender(), address(this), volume, undMax, curMax);
    }
    
    function burn(int volume, int undMax, int curMax) external returns (int dUnd, int dCur) {
        return Factory(factory).burnPut_(_msgSender(), address(this), volume, undMax, curMax);
    }
    function burnAll(int undMax, int curMax) external returns (int dUnd, int dCur) {
        return Factory(factory).burnPut_(_msgSender(), address(this), int(balanceOf(_msgSender())), undMax, curMax);
    }
