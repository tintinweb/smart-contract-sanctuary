...
contract Squares is ERC721, ERC721Enumerable, Ownable {
    ...
    string private URI = "https://gateway.pinata.cloud/ipfs/QmdX8X3Cv7e8Vu9m8bVUAYjHCvAT2ouFJ8YWi6WFUS4Cod";
    ...
    function mint(address to, uint256 amount) external payable {
        ...
        require(amount <= MAX_PER_TXN, "Exceeds max mint per txn");
        require((mintPerWallet[_msgSender()] + amount) <= MAX_WALLET,"Exceeded mint per wallet");
