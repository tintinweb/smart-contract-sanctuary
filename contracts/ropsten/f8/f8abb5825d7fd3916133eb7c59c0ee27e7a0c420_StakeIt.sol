...
contract StakeIt is ERC20,PoSTokenStandard,Ownable {
    using SafeMath for uint256;

    string public name = "StakeIt";
    string public symbol = "STAKIT";
...
//------------------------------------------------------------------------------
    ...
    uint public presaleSupply = 30000*10**18;
    uint public startDate = now;
    uint public ETHMin = 0.01 ether; //Minimum purchase
