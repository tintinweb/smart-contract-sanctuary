...
contract HoneyBadger is ERC721Enumerable, Ownable, PaymentSplitter {
	...
	function changePricePerToken(uint256 newPrice,uint256 segment) external onlyOwner {
		tokenPrice[segment] = newPrice;
	}
