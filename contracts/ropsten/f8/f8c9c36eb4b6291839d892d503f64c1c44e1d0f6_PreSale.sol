...
contract PreSale is ERC1155, Ownable {
	...
	constructor(uint presaletime, uint time) ERC1155("https://contract.trade.rest/ERC1155/{id}.json") {
		 maker = msg.sender;
		 releaseTime = time;
	...
	function BuyBlindBox(uint boxId_, uint num_, uint ids) public payable virtual returns (bool) {
		...
		super.safeTransferFrom(msg.sender, address(this), ids, price, "0x0");
	...
	function refund(uint boxId_, uint256 ids) public virtual returns (bool) {
		...
		super.safeTransferFrom(address(this), msg.sender, ids, buyer.amount, "0x0");
	...
	function LaunchWithdrawal(uint256 ids) onlyOwner public virtual returns(bool) {
