...
library CrimeAssets {
  ...
  function getIndexes(Asset storage _asset) public view returns(uint256[] memory _indexes) {
    _indexes = _asset.indexes;
  }
