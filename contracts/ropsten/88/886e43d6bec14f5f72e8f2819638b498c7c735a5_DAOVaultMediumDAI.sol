...
contract DAOVaultMediumDAI is ERC20, Ownable {
...
/*     constructor(address _token, address _strategy) ERC20("DAO Vault Medium DAI", "dvmDAI") {
        _setupDecimals(18);
    ...
    function initialize(address _token, address _strategy) public initializer {
        ERC20.initialize("DAO Vault Medium DAI", "dvmDAI");
        //_setupDecimals(18); //defaults to 18 decimals
