...
contract NewReal{ // this the sub contract that will generated by the main contract RealPrimary
   ...
   function cancelOffer() public { // cancel this offer.
    require(valid == true, 'The offer has already been canceled');
    require(available == true,' The offer can not be canceled owing to the offer has already been sold!');// the offer can be canceled only if the property is still for sale. 
    valid = false;
