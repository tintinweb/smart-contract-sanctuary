...
contract Waifus is Context, Ownable, ERC165, IWaifus, IERC721Metadata {
    ...
    string public constant WAIFUS_PROVENANCE = "481fdd1d07e7912479a77fb060ac089403deadbcefbb34ca05315d51db78cbb8";

    uint256 public constant SALE_START_TIMESTAMP = 1613996166; //set sale time here in unix

    // Time after which waifus are randomized and allotted
    uint256 public constant REVEAL_TIMESTAMP = SALE_START_TIMESTAMP + (86400 * 1); //unix seconds and amount of days

    uint256 public constant NAME_CHANGE_PRICE = 1830 * (10 ** 18);

    uint256 public constant MAX_NFT_SUPPLY = 15;
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 11) {
            return 30000000000000000; // 16381 - 16383 100 ETH
        } else if (currentSupply >= 5) {
            return 20000000000000000; // 16000 - 16380 2.0 ETH
        } else {
            return 10000000000000000; // 0 - 2999 0.1 ETH 
        }
    }
