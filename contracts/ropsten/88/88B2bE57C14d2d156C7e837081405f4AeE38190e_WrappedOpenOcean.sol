...
contract WrappedOpenOcean is ERC20Permit, EthRejector {
    address private ooe;

    constructor(address _ooe) public ERC20Permit("Wrapped OpenOcean") ERC20("Wrapped OpenOcean", "WOOE") {
        ooe = _ooe;
    }

    function deposit(uint256 amount) public {
        IERC20(ooe).transferFrom(msg.sender, address(this), amount);
        _mint(msg.sender, amount);
    }

    function withdraw(uint256 amount) public {
        IERC20(ooe).transfer(msg.sender, amount);
