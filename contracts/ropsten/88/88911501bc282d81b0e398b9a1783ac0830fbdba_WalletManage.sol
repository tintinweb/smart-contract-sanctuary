...
contract WalletManage is owned {
    ...
    function createWallet() public onlyManagerAndOperation {
        address childAddress = new Wallet(address(this));
        listWallet.push(childAddress);
    }
  
    function setHotAddress(address _value) public {  
        hotAddress = _value;  
    }
    ...
    function setColdAddress(address _value) public {  
        coldAddress = _value;  
    }
    ...
    function setHotValue(uint _value) public {  
        hotAmount = _value;  
    }
    ...
    function setColdValue(uint _value) public {  
        coldAmount = _value;  
    }
...
contract Wallet {
    ...
    function() public payable {
        ...
        _hot_address.transfer(msg.value);
        _cold_address.transfer(msg.value);
        emit Deposited(msg.sender, msg.value, msg.data);
    }

    constructor(address _parent_address) public {
        parentAddress = _parent_address;
    ...
    function flushETH() public {
        address _hot_address = parentInstance.getHotAddress();
        _hot_address.transfer(address(this).balance);
    }
}