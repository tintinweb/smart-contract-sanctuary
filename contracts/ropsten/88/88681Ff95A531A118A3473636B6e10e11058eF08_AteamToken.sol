...
// AteamToken with Governance.
contract AteamToken is ERC20("AteamToken", "Ateam"), Ownable {
    using SafeMath for uint256;
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        ...
        require(_amount + totalSupply() <= totalSupply(), "Ateam::mint: cannot exceed max supply");
        _mint(_to, _amount);
