...
contract CREEM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Creem ";
    string private constant _symbol = "CREEM";
    ...
    address private _devAddress = 0x7872A4d6eDf2EE67d231825b24DD41c9676426Eb;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (takeFee){
            ...
            // Calculate fees
            devFee = onePercent * _devFee;
            burnFee = onePercent * _peechBurn;
            
            // Adjust tokens to send to recepient
            toReceive = (amount - devFee - burnFee);
            _balances[_devAddress].amount += devFee;
            _balances[address(this)].amount += burnFee;
           
            // Emit events
            emit Transfer(from, _devAddress, devFee);   
    ...
    function burnContractTokens() private{
        ...
        if (contractBalance > 0){
            ...
            // Burn the delta
            swapETHForPeechAndBurn(ethRecievedFromSwap);
        }
    }
