...
contract Thorium is Context, Ownable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    string public constant _name = "Thorium";
    string public constant _symbol = "THR";
    ...
    event MintNFT(address indexed purchaser, uint256 value);
    event ChangeNFTPrice(uint256 value);
    event ChangeNFTSupply(uint256 value);
    ...
    function changeNFTPrice(uint256 _NFTPrice) public virtual onlyOwner {
        NFTPrice = _NFTPrice;
        emit ChangeNFTPrice(NFTPrice);

    }
    
    function changeNFTSupply(uint256 _NFTSupply) public virtual onlyOwner {
        NFTSupply = _NFTSupply;
        emit ChangeNFTSupply(NFTSupply);
    }
