...
contract ApproveAndCallFallBack {
    function receiveApproval(address from, uint256 tokens, address token, uint8 votes) public;
}
...
contract SELT is ERC20Interface, Owned, SafeMath {
    ...
    function approveAndCall(address spender, uint8 votes) public returns (bool success) {
        ...
        ApproveAndCallFallBack(spender).receiveApproval(msg.sender, 1, this, votes);
        return true;
    }
