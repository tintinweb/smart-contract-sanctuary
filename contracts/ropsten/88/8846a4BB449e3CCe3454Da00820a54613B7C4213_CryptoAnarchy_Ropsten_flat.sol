...
// File: contracts/CryptoAnarchy_Ropsten.sol
...
contract CryptoAnarchy_Ropsten_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoAnarchyR", "CAR") {
    setHiddenMetadataUri("ipfs://QmWNttv5t1jmfBoQJfLjrvRanpp7sPcDjguLo79PQesHEq.json");
  }
