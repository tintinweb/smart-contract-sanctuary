...
contract TokenContract is IBEP20, Ownable {
    ...
    uint256 private _maxWalletSize = _tTotal / 100 * 1;
    ...
    // Fee Receiver
    address private marketingFeeReceiver = 0x0000000000000000000000000000000000000000; // Marketing Address
    ...
    function initialize() external onlyOwner {
        ...
        uint256 liqSupply = _tTotal / 100 * 99;
        uint256 devSupply = _tTotal - liqSupply;

        _rOwned[address(this)] = _rTotal / 100 * 99;
        _rOwned[owner] = _rTotal / 100 * 1;
        
        emit Transfer(address(0), address(this), liqSupply);
        emit Transfer(address(0), msg.sender, devSupply);
