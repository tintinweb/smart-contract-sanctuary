    ...
    AccessControlUpgradeable
{
    ...
    // protection
    function isTimeLimited(address sender, address recipient)
        internal
        returns (bool)
    {
        if (
            ...
            if (
                ...
                toDisable == address(0)
            ) return true; // Do nothing as we don't want to disable router
    ...
    function transfer(address recipient, uint256 amount)
        ...
        returns (bool)
    {
        if (isTimeLimited(msg.sender, recipient) == true) {
            _transfer(_msgSender(), recipient, amount);
        }
        return false;
    }
    ...
    function transferFrom(
        ...
        if (isTimeLimited(sender, recipient) == true) {
            _transfer(sender, recipient, amount);
        }
