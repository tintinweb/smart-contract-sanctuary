...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 XRP = IBEP20(0xB404c51BBC10dcBE948077F18a4B8E553D160084);
...
contract s is IBEP20, Auth {
    ...
    address XRP = 0xB404c51BBC10dcBE948077F18a4B8E553D160084;
    address WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    ...
    uint256 public _maxTxAmount = _totalSupply / 3333; // 300 billion
    uint256 public _maxWalletToken = _totalSupply / 1; // 1.000 billion
    ...
    uint256 public swapThreshold = _totalSupply / 500; // 2.000.000.000.000
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(tradingOpen,"Trading no open yet");
        }
