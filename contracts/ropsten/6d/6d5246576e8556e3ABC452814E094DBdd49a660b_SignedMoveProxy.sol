...
contract SignedMoveProxy is AccessControlEnumerable, EIP712 {
    ...
    bytes32 public immutable AUTHORIZED_SENDER = keccak256("AUTHORIZED_SENDER");
    ...
    modifier onlyAuthorizedSender() {
        require(msg.sender == _msgSender(), "SignedMoveProxy: caller is not an AUTHORIZED_SENDER");
        _;
    }
