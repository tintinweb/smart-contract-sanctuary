...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xF362cCc3f7C1DF1df903D95b9Bbc767625Fb2A5c), 2000);
        m_DidDeploy = true;
    }
...
contract rt4 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "rt4";
    string private m_Symbol = "RT4";
