...
NUNCHUCKS Socials:
Telegram: @nunchuckstg
Twitter: twitter.com/nunchucks
Website: nunchucks.io
Whitepaper: nunchucks.io/whitepaper
...
contract NUNCHUCKS is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "NUNCHUCKS";
    string private m_Symbol = "CHUCKS";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 1000, 250, m_ILOPublic);
        initTax();
