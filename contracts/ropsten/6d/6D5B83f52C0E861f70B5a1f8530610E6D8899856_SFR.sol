...
// File: contracts/safri.sol

pragma solidity ^0.7.1;



contract SFR is ERC20 {
  using SafeERC20 for IERC20;

  address public governance;
  address public SFR_minter;
  uint256 public MAX_TOKENS = 2000000 ether;
  ...
  function mint_SFR(address to, uint256 amount) public {
    require(msg.sender == SFR_minter, "must be SFR_minter");
