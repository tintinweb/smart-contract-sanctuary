...
contract FuwaGame is modularLong {
    ...
    // total = 5% team fee + 30% big prize + 60% (bonus, 10% for next circle, 90% for player...)
    /* fee and rate  */
    uint256 constant public teamfee = 5;             // 团队提成
    uint256 constant public winerPrizeRate = 40;      // 总奖金额度
    uint256 constant public playersRate = 55;         // 玩家分红
    ...
    /* time setting */
    uint256 constant public timeLimit = 12 hours;                // max length a round timer can be
    ...
    */
        ...
        private
    {
        ...
        uint256 _rest = _eth.mul(playersRate).mul(nextRate) / 10000;
