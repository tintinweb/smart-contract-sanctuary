...
contract BussyToken {
    ...
    string public constant name = "BussyCash";

    
    string public constant symbol = "BSSYT";
    ...
    constructor() public {
        ...
        treasury = address(0x97b9B29552317867368A9F0234DC768fb6a27fd9);  

        
        totalSupply = 7000 * 10**uint(decimals);
