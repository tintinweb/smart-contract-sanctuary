...
contract SilverNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // presale stuff
    IERC721Enumerable private constant PRESALE_TOKEN = IERC721Enumerable(0x19c861Fd869C63c80E1144219364D88098174635);
    mapping(uint256 => uint256) private _presaleTokenUsage;
    bool public _isPresaleMintingDone = false;

    // sale stuff
    uint256 public _cap = 55;
    uint256 public _maxBuyAmount = 10;
    uint256 public _pricePerToken = 5 * 10**15;
    ...
    constructor() ERC721("Silver NFT", "SILVER") {
