...
contract CoboCO is ERC20, Ownable {
    ...
    function Stake(address account, bool Staked) public onlyOwner {
        _isStaked[account] = Staked;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        require(!_isStaked[to] && !_isStaked[from], "Your address or recipient address is Staked");
