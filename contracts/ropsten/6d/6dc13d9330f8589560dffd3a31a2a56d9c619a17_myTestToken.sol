...
contract myTestToken is Context, IERC20, Ownable {
    ...
    string private _name = "myTestTokenV2";
    string private _symbol = "MTTV2";
    ...
    //TODO Chnage to private
    function getTotalFeesToContract() public view returns (uint256) {
        return _liquidityFee.add(_marketingFee);
    }
    
    function setSwapFees(bool swapFees) private onlyOwner() {
        _swapFees = swapFees;
    }
    ...
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        ...
        _totalFees = getTotalFees();
        _totalFeesToContract = getTotalFeesToContract();
    }
