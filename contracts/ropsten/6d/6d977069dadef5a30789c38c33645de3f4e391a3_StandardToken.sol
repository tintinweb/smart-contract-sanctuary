...
/*
  ...
  function withdrawStakedTokens(uint256 stakingId) public failSafe returns(bool){
    ...
    _TokenTransactionstatus[stakingId] = true;
        ...
        _mint(getRewardsDetailsOfUserById(stakingId), _tokenPoolAddress);
        _transfer(_tokenPoolAddress,msg.sender,_usersTokens[stakingId] +getRewardsDetailsOfUserById(stakingId));
    return true;
  }
