...
contract Jays is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Jays", "Jays") {
    }

    function _baseURI() internal view virtual override returns (string memory) {
        return "https://jays.nft";
    }
   ...
   function mint(uint256 amountToMint) public payable {
        ...
        require(amountToMint <= MAX_PURCHASABLE, "You cannot mint more than 10 Shovels.");
