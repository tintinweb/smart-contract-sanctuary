...
contract TmoneyTest2 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TmoneyTest2() {
        ...
        name = "TmoneyTest2";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TMONEY";                                             // Set the symbol for display purposes (CHANGE THIS)
