...
We are Testing TESTING More Ropsten Test 3
...
contract poc_platinum {
    ...
    //  0.150% per hour
    uint public dailyStartPercent = 150;    //  3.6%
    uint public dailyLowPersent = 275;      //  6.6%
    uint public dailyMiddlePersent = 375;   //  9.0%
    uint public dailyHighPersent = 525;     // 12.6%

    uint public stepLow = 1250 ether; //  6.6%
    uint public stepMiddle = 5000 ether; //  9.0%
    uint public stepHigh = 10000 ether; // 12.6%
    ...
    function investETH(address referral) public payable {
        ...
        uint256 commision = amount.div(40); //affiliate commission 100/40 is 2.5% 
  ...
  function withdraw() public{
    ...
    function getProfit(address customer) public view returns(uint256){
        ...
        uint256 hourDifference = now.sub(lastActionTime).div(60);   // TODO: 3600
