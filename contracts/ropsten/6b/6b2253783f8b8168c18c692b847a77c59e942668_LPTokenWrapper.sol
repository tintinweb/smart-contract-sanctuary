...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 public BSKTASREWARD = IERC20(0x4Bec13aB192280763A201a30ca093a3d0a15b3DC);  // Approve and Transfer for Stake and Withdraw
...
contract BsktEthLPPool is LPTokenWrapper {
    IERC20 public STAKEBSKT = IERC20(0x3d3c60970D3369e48f79664787433fc0d2B7C44b); // BSKT-ETH-LP TOKEN ADDRESS
