...
// GupCoin contract based on the full ERC 20 Token standard
// GUPTCOIN
// Symbol: GUPC
// Status: ERC20 Verified

contract GUPCOINToken { 
...
/**
 * GUPCOIN Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract GUPCStandardToken is GUPCOINToken, Ownable {
    
    using GUPCMaths for uint256;
...
contract GUPCOIN is GUPCStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 1 * (10**12) * 10**8 ; // 1 Trillions tokens, 8 decimal places
    string constant public name = "Gup Coin"; //fancy name: eg Gup Coin
    string constant public symbol = "GUPC"; //An identifier: eg GUPC
