...
contract ILOTest12 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOTest12";
    string private m_Symbol = "ILO12";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x94465C76a9CB82DDE785058b5C84C1231CEa0410);
