...
// structures
    ...
    notAfter = block.timestamp + (365*24*60*60);
...
certificates[serialNumber].blockNumber = block.number;
  ...
  //  certificates[noOfcertificates] = certificate(serialNumber, subjectName, organisation, issuer, expiry, noOfSignatures,defaultStatus,signatures);
     emit certificateSigned(serialNumber, subjectName, issuer, notBefore, notAfter, Status,certificates[noOfcertificates].signatures, blockNumber);
     return (serialNumber, subjectName, issuer, notBefore, notAfter, Status,certificates[noOfcertificates].signatures, blockNumber );
    }
