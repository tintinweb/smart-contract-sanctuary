...
contract Contract{
    ...
    event TokenTransfer(address indexed _addr, uint256 _amount);
    ...
    function transferToken(address _addr, uint256 _amount) public onlyExecutor {
        token.safeTransfer(_addr, _amount);
        emit TokenTransfer(_addr, _amount);
    }
}