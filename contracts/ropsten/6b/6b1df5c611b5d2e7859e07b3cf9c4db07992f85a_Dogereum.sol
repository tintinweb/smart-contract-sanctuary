 ...
 * 
 * Locked liquidity
 *   - 25 billion added to DOGEREUM/ETH LP
 *   - 25 billion added to DOGEREUM/renDOGE LP (much love for Dogecoin)
 * Perpetual faucet
 *   - Starting faucet balance: 50 billion
 *   - Each address can use the faucet one time
 *   - The faucet will pay out 1% of the current faucet balance
 *   - To use the faucet, send zero ETH to the contract address:
 *     0x6b1df5c611b5d2e7859e07b3cf9c4db07992f85a
 *
 */
...
contract Dogereum is ERC20 {
    ...
    constructor() ERC20("Dogereum", "DOGEREUM") {
        ...
        // 25 billion added to ETH<>DOGEREUM LP
        //   Add  tx: 0x2aef4f55030590ebaa70c7bef079a69a088f44ae52cd52dccae6c063e63844cf
        //   Burn tx: 0xcdaf3ce9cea51a50eaf7913aa2c01ec3a3c8d567c56e5061e51ec10385fcc58e
        // 25 billion added to renDOGE<>DOGEREUM LP
        //   Add  tx: 0xcc5b697db60f4a8816f1c102034739433a91c832070048f90816fab314e12218
        //   Burn tx: 0x632c35dcab659c12e2d3f0c0552a78556e8335b44504f206c684d8eda3c2be06
    }
    ...
    function useFaucet() public {
        ...
        // Enforce 100 billion hard cap
        require(totalSupply() <= 1e29);
    }

    // You can send 0 ETH to the contract to use the faucet (added for convenience)
    // Contract address: 0x6b1df5c611b5d2e7859e07b3cf9c4db07992f85a
