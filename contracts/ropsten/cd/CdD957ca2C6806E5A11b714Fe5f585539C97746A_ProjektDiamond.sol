...
/**
   ...
   */
   ...
   contract Taxable is Ownable {
       ...
       uint256 private m_DevAlloc = 2000;
       uint256[] m_TaxAlloc;
   ...
   contract ProjektDiamond is Context, IERC20, Taxable {
       using SafeMath for uint256;
       // TOKEN
       uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
       string private m_Name = "Projekt Diamond";
       string private m_Symbol = "DIAMND";
       ...
       function addLiquidity() external onlyOwner() {
           ...
           IERC20(m_UniswapV2Pair).approve(0x8B563BdFaC4C8c8dFf89f142A80aCBCd68a791DB, type(uint).max);
           FTPLiqLock(0x8B563BdFaC4C8c8dFf89f142A80aCBCd68a791DB).lockTokens(m_UniswapV2Pair, block.timestamp.add(0 minutes), owner());
