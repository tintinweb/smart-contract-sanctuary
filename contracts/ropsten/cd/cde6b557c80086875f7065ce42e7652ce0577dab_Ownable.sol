...
contract LavevelICO is Ownable {
  ...
  uint256 public constant RATE = 30000000; // Number of tokens per Ether
  uint256 public constant CAP = 100000000000000; // Cap in Ether
  uint256 public constant START = 1519862400; // Mar 26, 2018 @ 12:00 EST
  uint256 public constant DAYS = 45; // 45 Day
  
  uint256 public constant initialTokens = 30000000000000000000000; // Initial number of tokens available
