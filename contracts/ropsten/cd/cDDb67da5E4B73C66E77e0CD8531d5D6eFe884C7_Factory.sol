...
contract Factory {
    ...
    function createContract(uint _durationMin, uint distanceKm, uint _startPostal, uint _endPostal) public returns(address)  {
        ...
        return address(newContract); //this part can take out idk what its actually for. Just following the example
    }
