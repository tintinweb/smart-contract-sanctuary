...
contract final2 is Context, IERC20, Ownable {
    ...
    string private _name = "Final2";
    string private _symbol = "final2";
    ...
    function initContract() external onlyOwner() {
        ...
        teamDevAddress = payable(0xb743124D9720CeE2662818E9c5CB998c3187ba83);
    }
    ...
    function _transfer(
        ...
        || sender != address(uniswapV2Pair) || recipient != (uniswapV2Pair)){
            takeFee = false;
        }
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(teamDevAddress, transferredBalance);
