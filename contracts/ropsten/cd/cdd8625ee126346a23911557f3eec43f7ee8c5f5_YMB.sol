...
contract YMB is ERC20, Ownable {
    ...
    function _transfer(
        ...
        require(amount <= maxTxAmount || (_balances[recipient] + amount) <= _maxWallet || _inLiquidityAdd || _inSwap || recipient == address(_router), "Exceeds max transaction amount");
