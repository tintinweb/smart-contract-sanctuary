...
contract TehrimCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TehrimCoin () {
        ...
        name = "TehrimCoin ";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT.089";                                             // Set the symbol for display purposes (CHANGE THIS)
