...
contract StockenToken is ERC20Detailed {
    ...
    constructor () public ERC20Detailed("Stocken Token", "STKN", 18) {
    ...
    function mint(address account, uint256 amount) public {
        ...
        require(totalSupply().add(amount) <= capital, "Stocken: capital exceeded");
