...
contract Game {
    ...
    uint256 constant private roundInitTime = 2 minutes;
    ...
    function getRoundResultInfoWithRoundID(uint256 _roundID) public view returns(uint256,uint256,uint256,uint256,uint256) {
    ...
    function getUserEarningsInfo() public view returns(uint256,uint256,uint256,uint256,uint256,uint256) {
        return(getPlayerInfoWithRoundID(totalRoundNumber));   
    }
