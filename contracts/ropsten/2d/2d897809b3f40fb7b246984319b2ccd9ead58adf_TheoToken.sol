...
contract TheoToken {
    string constant public name = "TheoToken";
    string constant public symbol = "THT";
    ...
    constructor() {
      address _uniRouter = 0xD00918448f6C9Ee8f0E11F189ca15f5403B1bf14;
      uint256 _totalSupply = 10000000000 * (10 ** 18); // 1 billion
