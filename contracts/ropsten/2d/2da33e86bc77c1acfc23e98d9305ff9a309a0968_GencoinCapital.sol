...
contract GencoinCapital is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = _tTotal.div(1000).mul(200); //2% 

    address[] path;
    bool public timedWalletHolding = true;
    ...
    function setTimedWalletHolding(bool timedholding) external onlyOwner {
        timedWalletHolding = timedholding;
    }    
