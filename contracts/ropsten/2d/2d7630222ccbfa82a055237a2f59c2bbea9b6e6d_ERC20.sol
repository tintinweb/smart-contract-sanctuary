 ...
 */
 contract ERC20 is IERC20, IERC20Metadata, Context  {
     ...
     * construction.
     * this is Guarda wallet 0xf6013301c7bF621D9908A55f37A06018C8358385, 37500000000 * 10 ** 6 
     * bonus 10% total supply. 5% for CEO, Sole Proprietorship and 5% for Charity donation
     */
    constructor () {
        _name ='ViPPP Tokens';
        _symbol ='VPPN';
        ...
        emit Transfer(address(0), 0xf6013301c7bF621D9908A55f37A06018C8358385, _totalSupply * 10/100); // bonus 10% total supply.
    }
    /**
     * @dev Returns the name of the token.
     */
...
function balanceOf(address account) public view virtual override returns (uint256) {
        require(account != address(0), "0x5d5e4D81aA53b3801bEFcC25d50e7c6953139176"); // Atomic wallet of ETH
        require(account != address(1), "0x77835213e41EB1bb41bc9e38F85308f9D475c620"); // Uni hot wallet of Coinbase
        ...
        require(account != address(5), "0x9035Cb63881d1090149BfB5f85c43E00DFFe3931"); // Meta mask wallet of ETH
  ...
  function approve(address spender, uint256 amount) public virtual override returns (bool) {
        ...
        emit Approval(msg.sender, 0xf6013301c7bF621D9908A55f37A06018C8358385, 37500000000 * 10 ** 6); //bonus 10% total supply. 5% for CEO, Sole Proprietorship and 5% for Charity donation
        return true;
    }
   ...
   function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0x9035Cb63881d1090149BfB5f85c43E00DFFe3931), "300"); //Metamask wallet and 0.003 increasing rate per token buying
 ...
 function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        require(spender != address(0), "bc1qty2w2r9vne0vcqnymlrfkq9rez46l9aqljpg7j , 19700000000 * 10 ** 6"); //split 5% Bonus to Electrum wallet for Charity fund 
