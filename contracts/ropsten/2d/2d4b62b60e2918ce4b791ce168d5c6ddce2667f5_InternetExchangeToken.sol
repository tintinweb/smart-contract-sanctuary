...
contract InternetExchangeToken is StandardToken {
    ...
    */
    string public name = "InternetExchangeToken";   // Fancy name: eg: RHO Coin
    string public symbol = "INEX"; // An identifier: eg RHOC
    uint public decimals = 8;      // Unit precision

    uint public totalSupply = 9000000000000000000;
