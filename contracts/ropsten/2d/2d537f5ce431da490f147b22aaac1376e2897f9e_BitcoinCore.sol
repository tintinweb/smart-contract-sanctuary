...
contract ERC20Basic {
    ...
    function balanceOf(address tokenOwner) constant returns (uint256 balances);
...
contract BitcoinCore is ERC20, PoSTokenStandard, Ownable {
    using SafeMath for uint256;

    string public name = "BitcoinCore";
    string public symbol = "BTCR"; // Etsi
...
//------------------------------------------------------------------------------
    ...
    function transfer(address to, uint256 value) canPoSMint returns (bool) {
    ...
    function coinAge() constant returns (uint256 myCoinAge) {
...
//------------------------------------------------------------------------------
    ...
    function transferFrom(address from, address to, uint256 value) canPoSMint returns (bool) {
