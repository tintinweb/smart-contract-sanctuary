...
contract PIXIETEST is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_bots[from], "Your address has been marked as a bot, please contact staff to appeal your case.");
    ...
    function initContract(address payable feeAddress) external onlyOwner() {
        ...
        initialized = true;
        initialLimitDuration = block.timestamp + (5 minutes); //REMEMBER TO CHANGE
    }
