...
contract eaglesDream is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x7Ef8E5643424bed763dD1BdE66d4b2f79F9EDcd8;

    constructor(string memory baseURI) ERC721("EaglesDream", "Eagle")  {
        setBaseURI(baseURI);

        // owner gets the first 10 Eagles
    }

    function mint(uint256 num) public payable {
        uint256 supply = totalSupply();
        require( !_paused, "Sale paused" );
        require( supply + num < 4000, "Exceeds maximum Eagles supply" );
        require( num < 11, "You can mint a maximum of 10 Eagles" );
