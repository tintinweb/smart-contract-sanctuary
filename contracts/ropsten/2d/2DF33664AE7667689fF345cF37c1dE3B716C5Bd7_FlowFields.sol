...
contract FlowFields is ERC721Enumerable, Ownable{
    ...
    // constants
    uint256 constant MAX_FREE_ELEMENT = 8;    // 250
    uint256 constant MAX_ELEMENT_PER_USER = 5;

    uint256 constant MAX_ELEMENTS = 50;     // 1250
    ...
    function freeMint(uint256 numberOfTokens) external payable {
        ...
        require(freeMemberList[msg.sender] + numberOfTokens <= MAX_ELEMENT_PER_USER, 'Your free purchase would exceed max supply');
