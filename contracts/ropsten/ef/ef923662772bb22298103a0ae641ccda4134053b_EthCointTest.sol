...
/**
 * EthCoinTest Official Contract
  Features:
   3% fee auto added to the liquidity pool
   2% fee auto distributed to all hodlers
   3% fee added to marketing wallet for continous promotion funds
   12% burnt
*/
...
contract EthCointTest is Context, IERC20, Ownable {
    ...
    address payable charityWallet = 0x9F8f66BbddACd435D6B2E920df12870957159DaB;
    address payable marketingWallet =
        0x9F8f66BbddACd435D6B2E920df12870957159DaB;

    uint8 private constant _DECIMALS = 8;
    uint256 private constant _DECIMALFACTOR = 10**uint256(_DECIMALS);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100_000_000_000_000_000 * _DECIMALFACTOR;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    // 3% of the supply
    uint256 public _maxTxAmount = 3_000_000_000_000_000 * _DECIMALFACTOR;
    ...
    string private constant _name = "EthCoinTest";
    string private constant _symbol = "EthCoinTest";
