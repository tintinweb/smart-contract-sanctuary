...
function read(uint256 _id) public view returns (address writer, string memory massage, string memory _name) {
        return (data[_id].writer, data[_id].massage, names[data[_id].writer]);
    }
