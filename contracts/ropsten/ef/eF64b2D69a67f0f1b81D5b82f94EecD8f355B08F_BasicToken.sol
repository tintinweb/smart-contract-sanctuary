...
/*
 * DockROZ is a standard ERC20 token with some additional functionalities:
 * - Transfers are only enabled after contract owner enables it (after the ICO)
 *
 * Note: Token Offering == Initial Coin Offering(ICO)
 */

contract DockROZ is StandardToken, Ownable {
    string public constant symbol = "DROZ";
    string public constant name = "DockROZ";
    uint8 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY = 1000000000000 * (10 ** uint256(decimals));
    uint256 public constant TOKEN_OFFERING_ALLOWANCE = 1000000000000 * (10 ** uint256(decimals));
     ...
     */
    function DockROZ(address admin) public {
