...
·▀▀▀  ▀  ▀ ▀▀ █▪▀▀▀▀▀• ▀▀▀▀▀▀▀▀•     ·▀▀▀  ▀  ▀ ·▀▀▀  ▀▀▀ ▀▀▀    ·▀▀▀ .▀  ▀ ▀▀▀  ▀▀▀▀ ▀▪
                        ...
                        Candid Cacti Crew | 2021  | version 4.0 | ERC 721
...
contract CandidCactiCrew is ERC721Enumerable, Ownable {
        ...
        payable
    {
        ...
        uint256 newWalletMinted = _walletMinted[msg.sender] + tokenQty;
        ...
        require(newWalletMinted <= MAX_PER_WALLET, "EXCEED_MAX_PER_WALLET");
        require(SALE_PRICE * tokenQty <= msg.value, "INSUFFICIENT_ETH");

        _walletMinted[msg.sender] = newWalletMinted;
        delete newWalletMinted;
        ...
        payable
    {
        ...
        require(compareStrings(_buyCode, buyCode), "CODE_ERROR");
        require(totalMinted + tokenQty <= MAX, "OUT_OF_STOCK");
        require(newWalletMinted <= MAX_PER_WALLET, "EXCEED_CCC_PER_WALLET");
