    ...
    function checklock() internal {
        ...
        if(
            ...
            (
                ...
                block.timestamp.sub(deployTime) >= 155520000    // 86400 * 30 * 12 * 1  Automatically unlock after 5 years
            )
        )
        {
            isLocked = false;
...
contract XXToken is BEP20Detailed {

    constructor() BEP20Detailed("xx", "xx", 18) public {
