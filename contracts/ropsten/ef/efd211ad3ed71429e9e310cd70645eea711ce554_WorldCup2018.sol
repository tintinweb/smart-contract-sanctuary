...
contract WorldCup2018 is Base, AccessControl {
    ...
    function init() 
        ...
        // 3	5 vs 6	    1529074800
        initRegistMatch(3, 5, 6, 1529074800);
        // 4	7 vs 8	    1529085600
        initRegistMatch(4, 7, 8, 1529085600);
        // 5	9 vs 10	    1529143200
        initRegistMatch(5, 9, 10, 1529143200);
        // 6	11 vs 12	1529154000
        initRegistMatch(6, 11, 12, 1529154000);
        // 7	13 vs 14	1529164800
        initRegistMatch(7, 13, 14, 1529164800);
        // 8	15 vs 16	1529175600
        initRegistMatch(8, 15, 16, 1529175600);
        // 9	17 vs 18	1529236800
        initRegistMatch(9, 17, 18, 1529236800);
        // 10	19 vs 20	1529247600
        initRegistMatch(10, 19, 20, 1529247600);
        // 11	21 vs 22	1529258400
        initRegistMatch(11, 21, 22, 1529258400);
        ...
        // 15	29 vs 30	1529409600
        initRegistMatch(15, 29, 30, 1529409600);
        // 16	31 vs 32	1529420400
        initRegistMatch(16, 31, 32, 1529420400);
        // 17	1 vs 3	    1529431200
        initRegistMatch(17, 1, 3, 1529431200);
        // 18	4 vs 2	    1529496000
        initRegistMatch(18, 4, 2, 1529496000);
        // 19	5 vs 7	    1529506800
        initRegistMatch(19, 5, 7, 1529506800);
        // 20	8 vs 6	    1529517600
        initRegistMatch(20, 8, 6, 1529517600);
        // 21	9 vs 11	    1529582400
        initRegistMatch(21, 9, 11, 1529582400);
        // 22	12 vs 10	1529593200
        initRegistMatch(22, 12, 10, 1529593200);
        // 23	13 vs 15	1529604000
        initRegistMatch(23, 13, 15, 1529604000);
        // 24	16 vs 14	1529668800
        initRegistMatch(24, 16, 14, 1529668800);
        // 25	17 vs 19	1529679600
        initRegistMatch(25, 17, 19, 1529679600);
        // 26	20 vs 18	1529690400
        initRegistMatch(26, 20, 18, 1529690400);
        // 27	21 vs 23	1529755200
        initRegistMatch(27, 21, 23, 1529755200);
        // 28	24 vs 22	1529766000
        initRegistMatch(28, 24, 22, 1529766000);
        // 29	25 vs 27	1529776800
        initRegistMatch(29, 25, 27, 1529776800);
        // 30	28 vs 26	1529841600
        initRegistMatch(30, 28, 26, 1529841600);
        // 31	29 vs 31	1529852400
        initRegistMatch(31, 29, 31, 1529852400);
        // 32	32 vs 30	1529863200
        initRegistMatch(32, 32, 30, 1529863200);
        ...
        // 41	20 vs 17	1530108000
        initRegistMatch(41, 20, 17, 1530108000);
        // 42	18 vs 19	1530108000
        initRegistMatch(42, 18, 19, 1530108000);
        // 43	24 vs 21	1530122400
        initRegistMatch(43, 24, 21, 1530122400);
        // 44	22 vs 23	1530122400
        initRegistMatch(44, 22, 23, 1530122400);
        // 45	28 vs 25	1530194400
        initRegistMatch(45, 28, 25, 1530194400);
        // 46	26 vs 27	1530194400
        initRegistMatch(46, 26, 27, 1530194400);
        // 47	32 vs 29	1530208800
        initRegistMatch(47, 32, 29, 1530208800);
        // 48	30 vs 31	1530208800
        initRegistMatch(48, 30, 31, 1530208800);
        // 49				1530367200
    ...
    function feesTakenFromPrize(uint _totalInvestForMatch, uint _totalInvestForWinners) 
        ...
        if (_totalInvestForWinners > 0) {
            if (_totalInvestForMatch == _totalInvestForWinners) {
                prizeDistributionTotal = _totalInvestForWinners;
            } else {
