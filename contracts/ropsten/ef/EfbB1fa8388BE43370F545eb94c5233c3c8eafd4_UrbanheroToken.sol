...
// File: zeppelin-solidity/contracts/ownership/Whitelist.sol
...
// File: contracts/UrbanheroToken.sol
...
/**
 * @title UrbanheroToken
 * @dev Burnable pausable mintable token with reclaim function and whtelisted owners
 */
contract UrbanheroToken is Whitelist, CanReclaimToken, BurnableToken, PausableToken, MintableToken {
    
    string public name = "Urbanhero";
    string public symbol = "UBH";
    uint8 public decimals = 18;
    // uint256 public constant totalSupply_ = 10000 * (10 ** uint256(decimals));
