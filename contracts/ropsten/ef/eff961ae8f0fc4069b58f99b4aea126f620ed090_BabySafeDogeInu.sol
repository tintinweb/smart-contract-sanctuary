...
contract BabySafeDogeInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "BabySafeDogeInu";
    string private _symbol = "BSAFEDOGEINU";
    ...
    address payable public marketingWallet = payable(0xdd86E41c7818c1ec5462d47a55B5B72dBE239152);
