...
contract StandardToken is IERC20,DateTimeLib {
    ...
    string public constant symbol = "NMCTEST";
    
    string public constant name = "NamyChainTestCoin";
...
contract OwnableToken is TradeableToken {
    ...
    address internal owner = 0xaA9cf884AA7afcb2B8c2D7FAa1be389D96309469;
...
contract NMCTEST is OwnableToken {
