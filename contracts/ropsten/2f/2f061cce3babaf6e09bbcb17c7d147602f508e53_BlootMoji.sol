...
contract BlootMoji is ERC721Enumerable, ReentrancyGuard, Ownable {
    uint256 public constant PUBLIC_MINT_PRICE = 8000000000000000; //0.008 eth
    ...
    uint private blootOwnersSupply = 1;
    uint private publicOwnersSupply = 1;
    uint private creatorSupply = 1;
    ...
    function publicClaim() public nonReentrant payable {
        require(publicOwnersSupply < 2, "No more tokens to mint");
        require(totalSupply() < maxSupply, "No more tokens to mint");
    ...
    function ownerClaim() public nonReentrant onlyOwner {
        require(creatorSupply < 1, "No more tokens to mint");
        require(totalSupply() < maxSupply, "No more tokens to mint");
        uint index = totalSupply();
