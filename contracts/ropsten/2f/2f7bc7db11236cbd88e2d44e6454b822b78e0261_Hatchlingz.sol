...
contract Hatchlingz is ERC721, ERC721Enumerable, Ownable {
   ...
   //test vars end
    ...
    string[] public _phoenixMetadata = ["phoenix1","phoenix2","phoenix3"];
    string[] public _dragonMetadata = ["dragon1","dragon2","dragon3","dragon4"];
    string[] public _chickenMetadata = ["chicken1","chicken2","chicken3","chicken4","chicken5"];
