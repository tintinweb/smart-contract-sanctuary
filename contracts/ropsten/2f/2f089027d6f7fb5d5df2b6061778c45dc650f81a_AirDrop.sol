...
contract BonBonToken is PausableToken {
    ...
    // function BonBonToken(address _DistributionContractAddress) public {
    //  require(_DistributionContractAddress != address(0));
    //  totalSupply = INITIAL_SUPPLY;
    //  balances[_DistributionContractAddress] = totalSupply;
    //  Transfer(address(0), _DistributionContractAddress, totalSupply);
    // }
