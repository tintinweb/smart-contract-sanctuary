 ...
 * {ERC721Enumerable}.
 */
contract CryptoFaces is Context, ERC165, IERC721, IERC721Metadata {
    using Address for address;
    using Strings for uint256;
    using SafeMath for uint256;

    // Token name
    string private _name = 'CryptoFaces';
    ...
    // Date of release;
    uint public releaseTimestamp = 1639486200; 
    ...
    uint256 public constant presalePrice = 100000000000000000;
    ...
    */
    ...
    function getCurrentPrice() public view returns (uint256) {
         if (preSaleActive) { 
          return presalePrice; 
           ...
           if(block.timestamp - publicSaleStartTimestamp > 900){
    ...
    function buyTokensOnPresale(uint256 tokensNumber, bytes calldata signature) public payable {
      ...
      require(_mintedTokens[msg.sender].add(tokensNumber) <= 5, 'You cannot purchase more then 5 tokens on presale');
