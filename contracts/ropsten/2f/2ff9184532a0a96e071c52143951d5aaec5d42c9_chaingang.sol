...
contract chaingang {
    ...
    address public constant BENEFICIARY = 0x356b93BEc5554021b7434dd6516B4099abcd601C;
    ...
    function createPiece(uint seed) external payable returns (string) {
