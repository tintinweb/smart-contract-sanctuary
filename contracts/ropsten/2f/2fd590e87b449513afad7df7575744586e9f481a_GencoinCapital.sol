...
contract GencoinCapital is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = _tTotal.div(2000).mul(10).div(87).mul(100); //1% of available supply (after max 13% fee)
    ...
    function setMaxWalletBase1000(uint256 maxWallet) external onlyOwner() {
