...
contract HWS is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address constant team_address = 0x7b913d0D8aA13007fa3De65c3D0fF04d28833074;
    ...
    bool public whitelistIsSoldOut = false;
    ...
    function presaleMint(uint256 ammount, bytes32[] calldata _merkleProof) external payable nonReentrant
    {
        ...
        require(whitelistIsSoldOut, "HWS: Presale is SOLD OUT!");
