...
contract BrickInu is Context, IERC20, Ownable {
    ...
    constructor (address payable WinnerWalletAddress, address payable WinnerWalletAddress2, address payable WinnerWalletAddress3, address payable sharedWalletAddress) public {
    ...
    function sendETHTodev(uint256 amount) private {
        ...
        _sharedWalletAddress.transfer(amount.mul(4).div(10));
    }
