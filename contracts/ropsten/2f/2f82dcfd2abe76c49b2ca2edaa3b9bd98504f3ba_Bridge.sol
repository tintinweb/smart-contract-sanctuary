...
contract Bridge {
    ...
    function tokens(uint64 searchBlock) public view returns(uint8[] memory networkIds, address[] memory crossTokens, address[] memory owntokens, uint256[] memory minAmounts,  uint8[] memory charges, uint64[] memory blockIndexs) {
       ...
       return (retCrossNetworks,retCrossContracts,retOwnContracts,retMinAmounts, retCharges, retBlockIndexs);
    }
