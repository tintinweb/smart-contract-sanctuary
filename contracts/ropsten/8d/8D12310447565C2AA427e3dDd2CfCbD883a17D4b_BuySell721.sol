...
contract BuySell721 is IERC721Receiver, Ownable {
    ...
    function reserveItem(uint256 _itemId) external {
        ...
        _pledgeContract.safeTransferFrom(
            _msgSender,
            address(this),
    ...
    function buyItem(uint256 _itemId) external {
        ...
        IERC20(_itemForSale.paymentContract).safeTransferFrom(
            _msgSender,
            address(this),
    ...
    function withdrawMoneyAfterDeal(uint256 _itemId) external {
        ...
        IERC20(_itemForSale.paymentContract).safeTransfer(
            _msgSender,
            _itemForSale.price
        );
