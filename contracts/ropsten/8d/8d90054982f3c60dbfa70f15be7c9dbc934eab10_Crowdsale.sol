...
contract Crowdsale {
    ...
    address payable private _wallet = 0x5cDC8AC3e5aEA29cDf7fa62ac8Dd5dE475F7384a; // our wallet address
    address payable private ceo = 0x5cDC8AC3e5aEA29cDf7fa62ac8Dd5dE475F7384a; // ceo address
    address payable private fas = 0x2F7dCf9414A1D1f2E83f36a828a00DE48F962a1c; // fas address
    address payable private tresor = 0x122611B0AffBaFAB0fa9c68c790194517633d2eB; // tresor address
    address payable private dev = 0x80D45fC9fA18213b9d4f6A70641012Bc1c7CFaB1; // dev address
    address payable private staking = 0x81E690Ab07a12EF57C17979E90eb34446754a751; // staking address
    ...
    uint256 public target = 5000000000000000000000;
    ...
    constructor () public {
        _rate = 10000;
        _wallet = msg.sender;
        _token = IERC20(0x9Bf491403bFd9040630301dA977F6Cd710050819);
        owner = msg.sender;
    }
modifier onlyOwner(){
