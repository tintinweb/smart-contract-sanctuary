 ...
 * @title DoKen
 * @author ERC20 Generator (https://vittominacori.github.io/erc20-generator)
 * @dev Implementation of the DoKen
 */
contract DoKen is ERC20, GeneratorCopyright {
    
    string public _name = "DoKen";
    string public _symbol = "DKN";
    uint256 public _initialSupply = 100000000000000000000000000;
    
    constructor()  ERC20(_name, _symbol, _initialSupply) {
