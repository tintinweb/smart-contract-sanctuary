...
// File: contracts/WaffleOwnership.sol
...
// File: contracts/WaffleToken.sol
...
contract WaffleToken is Waffle, WaffleOwnership {
    ...
    function checkWaffle(uint _tokenId) public view returns (string memory, Flavor, uint8, uint8){
        MetaData memory v = waffles[_tokenId/3];
        return (v.name, v.flavor, v.horizontals[0], v.horizontals[0]);
    }
