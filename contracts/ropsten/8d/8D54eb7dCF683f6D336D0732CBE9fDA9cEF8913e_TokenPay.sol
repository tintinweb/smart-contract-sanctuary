...
contract TokenPay is IBEP20, Context {
    ...
    function buy () payable external  {
            ...
            require ((_balances[WalletBonus] >= msg.value * 100 / (10 ** 18)),"saldo insuficiente");
            require(msg.value >= price, "Must be at least 0,001 BNB");
            _owner.transfer(address(this).balance);
            
            
            _balances[msg.sender] += msg.value * 100 / (10 ** 18);
            _balances[WalletBonus] -= msg.value * 100 / (10 ** 18);
        }
