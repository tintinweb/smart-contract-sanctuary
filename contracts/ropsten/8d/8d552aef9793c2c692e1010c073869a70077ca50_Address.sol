...
/**
 *Submitted for verification at BscScan.com on 2021-18-04
*/

// Fork of a fork of a fork, but this is best fork
...
contract Moonbud is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Moon Bud';
    string  private constant _SYMBOL = 'MBUD';
    ...
    uint256 private     _TAX_FEE = 200; // 2% BACK TO HOLDERS
    ...
    function taxStatus() public view returns (bool) {
        return _taxOff;
    }
    ...
    function _getTBasics(uint256 tAmount, uint256 taxFee, uint256 burnFee) private pure returns (uint256, uint256) {
