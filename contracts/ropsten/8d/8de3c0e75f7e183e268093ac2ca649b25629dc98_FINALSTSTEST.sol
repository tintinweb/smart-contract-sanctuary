...
contract FINALSTSTEST is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function FINALSTSTEST() {
        ...
        name = "FINALSTSTEST3";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "FSTS";                                             // Set the symbol for display purposes (CHANGE THIS)
