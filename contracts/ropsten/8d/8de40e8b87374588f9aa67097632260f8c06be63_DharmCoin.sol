...
contract DharmCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DharmCoin() {
        ...
        name = "DharmCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DNCN";                                             // Set the symbol for display purposes (CHANGE THIS)
