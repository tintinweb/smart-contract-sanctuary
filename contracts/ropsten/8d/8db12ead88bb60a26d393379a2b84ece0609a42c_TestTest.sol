...
contract TestTest is Context, IERC20, Ownable, LockToken 
{
    ...
    string private _name = "TestTest";
    string private _symbol = "TestTest";
    ...
    address payable public marketingWallet =  payable(0xD8fbBb895eb82384eBCFC0cf35b76c91A7967c98);
