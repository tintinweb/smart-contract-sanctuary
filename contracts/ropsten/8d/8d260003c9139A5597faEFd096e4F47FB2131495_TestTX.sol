...
//    uint8 private initSteps = 2;
    ...
    function _calculateFees(uint256 amount, Fees memory _fees) private view returns(uint256 liquidityFee, uint256 marketingFee, uint256 reflectionFee, uint256 burnFee) {
...
//        require(initSteps == 0, "Contract is not fully initialized");
    ...
    function selectSwapEvent() private lockTheSwap {
        ...
        if(_tokenTracker.reward >= minTokenSpendAmount){
            ...
            reflector.process(gasForProcessing);
        }
    }
...
abstract contract NoBSReflections is Ownable {
    INoBSRouterV1 public noBSRouter = INoBSRouterV1(0x2089C6aA5d08C22FD7748Cab9005De8d45aE018d);
