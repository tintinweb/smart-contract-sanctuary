...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _baseTokenURI = "http://nft.vcg.com/nft/nft721/";
    }
...
contract VcgERC721Token is IVcgERC721Token, ERC721Enumerable, Ownable {
  ...
  string private _baseTokenURI;
  string constant private _NFT_NAME = "Vcg's NFT";
  string constant private _NFT_SYMBOL = "[email protected]";

  constructor() ERC721(_NFT_NAME, _NFT_SYMBOL) {
    _baseTokenURI = "https://nft.vcg.com/nft/nft721/";
  }
...
/**
    * @dev isVcgNftToken： 判断合约是否是VcgNftToken合约
  ...
  function isVcgNftToken(address tokenAddress) public view override(IVcgERC721Token)returns(bool) {
      ...
      /* 当name,symbol和接口都一致时，才是VcgNftToken，返回true. */
