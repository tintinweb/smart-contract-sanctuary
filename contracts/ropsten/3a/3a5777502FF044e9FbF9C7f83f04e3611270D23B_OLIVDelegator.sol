...
import "./OLIVTokenInterface.sol";
import "./OLIVDelegate.sol";

contract OLIVDelegator is OLIVTokenInterface, OLIVDelegatorInterface {
    /**
     * @notice Construct a new OLIV
     * @param name_ ERC-20 name of this token
     * @param symbol_ ERC-20 symbol of this token
     * @param decimals_ ERC-20 decimal precision of this token
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "OLIVDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"OLIVDelegator:fallback: cannot send value to fallback");
