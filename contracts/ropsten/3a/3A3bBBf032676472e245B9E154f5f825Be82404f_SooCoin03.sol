...
contract SooCoin03 is Context, IERC20, Taxable {
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xFb73019FABB03863D491B639b5C26da6e46C0a9B);
    ...
    constructor () {
        ...
        ILO.init(100000000000000000, 10000, 10000, 64000, m_ILOPublic);
        initTax();
