...
contract CallistoTokens is ERC20("Callisto", "CTO"), Ownable {
    using SafeMath for uint256;
    
    uint256 private _cap = 10000000000 *10**18;
    
    mapping (address => bool) public minters;
    bool canAddMinter = true;
    ...
    function addMinter(address account) public onlyOwner {
        require(canAddMinter, "No more minters");
    ...
    function noMoreMinters() public onlyOwner {
        canAddMinter = false;
    }
