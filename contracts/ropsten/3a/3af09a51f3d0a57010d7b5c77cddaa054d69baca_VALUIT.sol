...
// Valuit token contract based on the full ERC 20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Symbol: Valuit
// Status: ERC20 Verified

contract VALUITToken { 
...
/**
 * VALUIT Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract VtsStandardToken is VALUITToken, Ownable {
...
contract VALUIT is VtsStandardToken {
    ...
    */
    ...
    string constant public name = "VALUIT Token"; //fancy name: eg VALUIT
    string constant public symbol = "VALUIT"; //An identifier: eg VALUIT
