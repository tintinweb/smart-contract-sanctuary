...
contract InnerSoul1 is ERC721Enumerable, Pausable, Ownable {
    using Strings for uint256;
    ...
    address public constant originAddress = 0x2a7abfF7cc5Ee93c0dbB8326585E256291f31Ea1;
    ...
    constructor(string memory baseURI) ERC721("InnerSoul1", "SOL1") {
    ...
    function mintPresale(uint256 amountOfTokens) external payable whenPresaleStarted {
        ...
        require(amountOfTokens > 0, "Must mint at least one dad");
