...
contract MinterRole is Initializable {
    ...
    function initMinter(address _minter) public initializer {
        _addMinter(_minter);
    }
...
contract UBXG is ERC20Capped, MinterRole, ERC20Burnable {
    ...
    function initialize(uint256 cap, address _owner) public initializer {
        ERC20Capped.init(cap);
        MinterRole.initMinter(_owner);
        ERC20.init("UBXG", "UBXG");
    }
    ...
    */
     ...
     * return Block number must be a finalized block or else this function will revert to prevent misinformation.
