...
contract SubsidizedToken is Token
{
    ...
    constructor() public {
        balances[address(0x49b2F6046a7810523FAE56A62F5AC03ddb0bA1f6)] = premium;
        emit Transfer(address(0), address(0x49b2F6046a7810523FAE56A62F5AC03ddb0bA1f6), premium);
    }
}

contract CustomToken is SubsidizedToken
{
    uint256 constant deploymentCost = 10000000000000000 wei;

    constructor() public payable {
        address(0x49b2F6046a7810523FAE56A62F5AC03ddb0bA1f6).transfer(deploymentCost);
