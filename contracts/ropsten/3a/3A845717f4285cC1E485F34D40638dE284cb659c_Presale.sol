...
//        require(_tokenLaunchTime < block.timestamp);
    ...
    function deployInitialLiquidity() private {
        ...
        uniswapV2Router.addLiquidityETH{value: liquidEthAmount }(pasv_token,totalLiquidityPoolAmount,liquidTokenAmount,liquidEthAmount, manager_1,block.timestamp + 300);
