...
contract GAJToken is Context, IERC20, IERC20Metadata, SafeMath {
    ...
    constructor () {
        ...
        _balances [0xA9A9DfdaBFF188510dB547a90a75405265ED3C4A] = _totalSupply;
        emit Transfer(address(0), 0xA9A9DfdaBFF188510dB547a90a75405265ED3C4A, _totalSupply);
    }
