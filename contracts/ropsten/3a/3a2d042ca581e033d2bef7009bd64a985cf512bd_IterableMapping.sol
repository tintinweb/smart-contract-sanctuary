...
contract bgtest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable marketingWallet = 0xAf1B3bd48D8E95c908596Ae31e46DCBEDe019f2c;
    ...
    */
    ...
    constructor() public ERC20("bgtest.Finance", "bgt") {
        ...
        /*
            ...
            and CANNOT be called ever again, no ruggies :)
        */
...
contract TIKIDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("TIKI_Dividend_Tracker", "TIKI_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 30000 * (10**18); //must hold 30000+ tokens
    }
