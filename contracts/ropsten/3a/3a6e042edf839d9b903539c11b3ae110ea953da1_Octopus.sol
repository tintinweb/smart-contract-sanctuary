...
contract Octopus is Ownable {
    ...
    function buyWithUSDT(address _optionAddress, uint256 _usdtAmount) payable public {
        ...
        SafeERC20.safeTransferFrom(usdtToken, msg.sender, address(this), _usdtAmount);
    ...
    function buyTokensInUniswap(address _optionAddress, uint256 _tokensAmount) public returns (uint256)  {
        address[] memory path = new address[](2);
        path[0] = address(usdtToken);
