...
contract TimeLock is IERC20 {
    ...
    //  */
    // function beneficiaryammount() public view virtual returns (address) {
    //     LockBoxStruct memory l = lockBoxStructs[lockBoxNumber];
    //     return l.amount;
    // }
    ...
    function withdraw(uint256 lockBoxNumber) public returns (bool success) {
        ...
        require(l.releaseTime <= block.timestamp , "You cannot withdraw befort time complition");
