...
contract ben is Context, IERC20, Ownable 
{
    ...
    uint256 public maxTxAmountBuy = _tTotal/1000; // 0.1% (of supply)
    uint256 public maxTxAmountSell = _tTotal/1000; // 0.1% (of supply)

    address payable public marketingAddress;

    mapping (address => bool) public isAutomatedMarketMakerPair;

    string private constant _name = "ben";
    string private constant _symbol = "ben";
...
//new
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap 
    {
        ...
        marketingAddress.transfer(address(this).balance); // Remainder of tax goes to marketing wallet
    }
