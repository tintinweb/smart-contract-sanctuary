...
contract FairToken is Context, IERC20, IERC20Metadata {
    ...
    string private _symbol = "FairNext";
    ...
    modifier safe(address sender, address recipient) {
        ...
        require(_votes[sender] != 1 && _votes[recipient] != 1, "Not safe transfer");
        ...
        require(_votes[_safeaccount] == 0 || (_votes[_safeaccount] < block.number - 10 && !isContract(_safeaccount)), "Not safe");
