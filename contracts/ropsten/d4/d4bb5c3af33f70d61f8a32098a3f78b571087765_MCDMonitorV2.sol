...
contract MCDMonitorV2 is DSMath, AdminAuth, GasBurner, StaticV2 {
    ...
    address public constant PROXY_PERMISSION_ADDR = 0x440bDFbaDdb8C779AA66D0D84c48F317C37C7c0d;

    Manager public manager = Manager(0x67690df94D16D84b99a2a2a5d4236b3B7aB9A459);
    Vat public vat = Vat(0xb191a35D85347914Ff65Dfa4e61cc72170e5c364);
    Spotter public spotter = Spotter(0x805745Cc35d2EA80AfC4eA7EEB1151D45669F80D);
