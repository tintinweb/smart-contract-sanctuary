...
contract GenericCrowdsale is TimedCrowdsale, FinalizableCrowdsale {
    address payable founderWallet;
	SimpleToken leftover;
  ...
  {      
    ...
    function finalization() internal {
      uint256 remaining = leftover.balanceOf(address(this));
      leftover.burn(remaining);
    }
}