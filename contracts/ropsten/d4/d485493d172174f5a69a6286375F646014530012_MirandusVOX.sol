    ...
    ReentrancyGuard
{
    ...
    function onERC1155Received(
        ...
        require(
            block.timestamp < timePhase1,
            "time expired for buying with ERC1155"
        );
    ...
    function buyTokenWithETH(uint256 amountToken) public payable nonReentrant {
        require(isPause, "!isPause");
        ...
        require(
            amountToken <= limitNumber - buyLimit[msg.sender],
            "!amountToken"
        );
