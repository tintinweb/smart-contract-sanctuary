...
contract PixelSlimezz is ERC721, Ownable {
    ...
    string public notRevealedURI = "ipfs://Qmd7EJGCzw4Lci3AQvXVYuMmtTp2EGe8HH3qaFgud44tDA";
    ...
    function mint(uint _amount) public payable {
        ...
        if(_tokenIds.current() > 10) {
            require(msg.value >= 20000000000000000, "Value is too low, mint is .01");
        }
