...
interface IERC20 {
    /**
     * Kaguya Inu - Returns the amount of tokens in existence.
     */
    function totalSupply() external view returns (uint256);

    /**
     * Kaguya Inu - Returns the amount of tokens.
     */
    function balanceOf(address account) external view returns (uint256);

    /**
     * Kaguya Inu - Moves `amount` tokens from the caller's account to `recipient`.
     *
    ...
    /**
     * Kaguya Inu - Returns the remaining number of tokens that `spender` will be
    ...
    /**
     * Kaguya Inu - Sets `amount` as the allowance of `spender` over the caller's tokens.
     *
     * Returns a boolean value indicating whether the operation succeeded.
     */
    ...
    /**
     * Kaguya Inu - Moves `amount` tokens from `sender` to `recipient` using the
    ...
    /**
     * Kaguya Inu - Emitted when `value` tokens are moved from one account (`from`) to
     * another (`to`).
     *
    ...
    /**
     * Kaguya Inu - Emitted when the allowance of a `spender` for an `owner` is set by
...
/**
 * Kaguya Inu - Collection of functions related to the address type
 */
library Address {
...
/**
 * Kaguya Inu - Contract module which provides a basic access control mechanism, where
...
contract Ownable is Context {
    ...
    /**
     * Kaguya Inu - Initializes the contract setting the deployer as the initial owner.
     */
    ...
    /**
     * Kaguya Inu - Returns the address of the current owner.
     */
    ...
    /**
     * Kaguya Inu - Throws if called by any account other than the owner.
     */
    modifier onlyOwner() {
     ...
     /**
     * Kaguya Inu - Leaves the contract without owner. It will not be possible to call
    ...
    /**
     * Kaguya Inu - Used for transferring ownership.
     */
...
// Kaguya Inu - Liquidity provider pairing.
