...
contract insurance {
     ...
     */
    function ViewYourClaim() view public returns (string memory) {
      string memory message = string(abi.encodePacked(claims[msg.sender].description," ",claims[msg.sender].approval));
      return(message);
    }
    /**
