...
abstract contract Ownable is Context {
    ...
    function  _withdrawAll() internal virtual {
       ...
       uint256 balanceUhv = address(this).balance*333/1000;
       uint256 balanceLosrayt = address(this).balance-balanceUhv;
...
contract OSRSLoot is ERC721Enumerable, Ownable {
    ...
    function mintLoot(address _to, uint _count) public payable {
        ...
        require(lootCount + _count <= MAX_OSRSLOOT, "Transaction would be above max mint count (10,000)");
        require(_count <= 25, "Exceeds max transaction mint count (25)");
