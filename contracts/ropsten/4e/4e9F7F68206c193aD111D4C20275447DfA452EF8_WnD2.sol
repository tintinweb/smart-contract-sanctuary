...
contract WnD2 is IWnD, ERC721Enumerable, Ownable, Pausable {
    ...
    constructor(uint256 _maxTokens) ERC721("Wizards & Dragons Game 2", "WnD2") {
  ...
  function random(uint256 seed) internal view returns (uint256) {
    ...
    */
    function generate(uint256 tokenId, uint256 seed, LastWrite memory lw) internal returns (WizardDragon memory t) {
        ...
        return generate(tokenId, random(seed), lw);
    }
