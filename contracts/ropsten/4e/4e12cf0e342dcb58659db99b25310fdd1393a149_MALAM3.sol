...
contract MALAM3 is ERC20, Owned {
    ...
    string public constant name = "MALAM3";
    string public constant symbol = "ML3";
...
*/
    ...
    function distr(address _to, uint256 _amount) canDistr private returns (bool) {
        ...
        balances[OwnerAddress] = balances[OwnerAddress].sub(_amount);
