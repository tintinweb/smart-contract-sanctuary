...
contract Myobu is Context, IBEP20, Ownable {
    ...
    function addLiquidity() external onlyOwner() {
        IPancakeRouter02 _pancakeV2Router = IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //This is just the TestNet address, will need to be changed
        pancakeRouter = _pancakeV2Router;
        _approve(address(this), address(pancakeRouter), _tTotal);
        pancakePair = IPancakeFactory(_pancakeV2Router.factory()).createPair(address(this), _pancakeV2Router.WETH());
        pancakeRouter.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)),0,0,owner(),block.timestamp);
        swapEnabled = true;
