...
contract CivInvestment is ICivInvestment, Ownable {
    ...
    function _mintLiquidity(
        ...
        // TransferHelper.safeApprove(_WETH, _WETH, amount0);
        WETH.deposit{ value: amount0 }();

        // IUniswapV3Pool pool = IUniswapV3Pool(v3Factory.getPool(_WETH, _CIV, poolFee));

        // liquidity = liquidity.add(
        //         _liquidityForAmounts(pool, tickLower, tickUpper, amount0, amount1)
        //     );
        // require(liquidity > 0, "Need liquidity");
        // require(msg.sender.balance > liquidity, "Not enough balance for liquidity");


        // TransferHelper.safeApprove(_WETH, _WETH, liquidity);
