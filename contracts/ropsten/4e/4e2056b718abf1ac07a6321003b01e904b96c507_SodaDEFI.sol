...
/**
 *Submitted for verification at BscScan.com on 10/6/21
*/
...
contract SodaDEFI is Ownable {
    ...
    constructor(address payable adminAccount, address payable marketingAccount, address payable teamAccount, uint256 price, IERC20 SODA_ADDRESS) public {
