    ...
    IERC721Receiver
{
    ...
    function buyOffer(address _nftContract, uint256 _tokenId) public payable {
        ...
        emit OfferBought(_nftContract, _tokenId, msg.value);
    }
    ...
    function cancelOffer(address _nftContract, uint256 _tokenId) public {
        ...
        emit OfferCanceled(_nftContract, _tokenId);
    }
...
contract NFTMarketplaceStorage {
    ...
    event OfferCanceled(address indexed _contract, uint256 indexed _tokenId);
