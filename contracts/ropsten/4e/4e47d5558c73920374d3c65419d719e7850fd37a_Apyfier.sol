...
contract Apyfier is Ownable {
    ...
    */
    ...
    function strategiesAAA(uint256 _id) public view returns(uint256 _lastBalance, uint256 _shareValue, uint256 _shareTotal, uint256 _pendingBalance, uint256 _lockedBalance){
       ...
       return (_lastBalance,_shareValue,_shareTotal,_pendingBalance,_lockedBalance);
    }
