...
contract TOKEN is Context, IERC20 {
    ...
    string private _name = "McP";
    string private _symbol = "McP";
    ...
    uint256 private _liquidityRatio = 250;
...
//===============================================================================================================
    ...
    function setRatios(uint256 liquidity, uint256 marketing, uint256 dev1, uint256 dev2) external onlyOwner {
        require (liquidity + marketing + dev1 + dev2 == 1000, "Must add up to 100%");
