...
contract StakeOnev4 is ERC20, ProofOfStakeToken, Ownable {
    using SafeMath for uint256;

    string public name = "StakeOnev4";
    string public symbol = "SONE4";
    uint public decimals = 18;

    uint public chainStartTime; //Chain start time
    uint public chainStartBlockNumber; //Chain start block number
    uint public stakeStartTime; //Stake start time
    uint public tokenHold;
...
//------------------------------------------------------------------------------
    ...
    function mint() public PoSMinter returns (bool) {
        ...
        uint mintReward = getMintReward(msg.sender);
    ...
    function getMintReward(address _address) internal constant returns (uint256) {
