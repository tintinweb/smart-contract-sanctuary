...
contract MasterCopy is Ownable {
    ...
    function setTimelock(address timelock_) public onlyOwner {
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken, bool _withUpdate) public onlyOwner {
        ...
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("add(uint256,IERC20,bool)"))), abi.encode(_allocPoint), abi.encode(_lpToken), abi.encode(_withUpdate));
        bytes memory data_ = abi.encodeWithSignature("add(uint256,address,bool)", _allocPoint, address(_lpToken), _withUpdate);
        
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    }
    
    function add_2(uint256 _allocPoint, IERC20 _lpToken, bool _withUpdate) public onlyOwner {
        /*
        require(poolIsAdded[address(_lpToken)] == false, 'add: pool already added');
        poolIsAdded[address(_lpToken)] = true;
        if (_withUpdate) {
        ...
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("add(uint256,IERC20,bool)"))), abi.encode(_allocPoint), abi.encode(_lpToken), abi.encode(_withUpdate));
        bytes memory data_ = abi.encodeWithSignature("add(uint256,address,bool)", _allocPoint, _lpToken, _withUpdate);
    ...
    function addWithRestaking(uint256 _allocPoint, bool _withUpdate, IStakingAdapter _adapter) public onlyOwner validAdapter(_adapter) {
        ...
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("addWithRestaking(uint256,bool,IStakingAdapter)"))), abi.encode(_allocPoint), abi.encode(_withUpdate), abi.encode(_adapter));
        bytes memory data_ = abi.encodeWithSignature("addWithRestaking(uint256,bool,address)", _allocPoint, _withUpdate, address(_adapter));
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    ...
    function set(uint256 _pid, uint256 _allocPoint, bool _withUpdate) public onlyOwner {
        ...
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("set(uint256,uint256,bool)"))), abi.encode(_pid), abi.encode(_allocPoint), abi.encode(_withUpdate));
        bytes memory data_ = abi.encodeWithSignature("set(uint256,uint256,bool)", _pid, _allocPoint, _withUpdate);
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    ...
    function setRestaking(uint256 _pid, IStakingAdapter _adapter, bool _claim) public onlyOwner validAdapter(_adapter) {
        ...
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("setRestaking(uint256,IStakingAdapter,bool)"))), abi.encode(_pid), abi.encode(_adapter), abi.encode(_claim));
        bytes memory data_ = abi.encodeWithSignature("setRestaking(uint256,IStakingAdapter,bool)", _pid, _adapter, _claim);
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    ...
    function removeRestaking(uint256 _pid, bool _claim) public onlyOwner {
        ...
        */
        bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("removeRestaking(uint256,bool)"))), abi.encode(_pid), abi.encode(_claim));
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    ...
    function changetokensPerBlock(uint256 _newTPB) public onlyOwner {
        ...
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("changetokensPerBlock(uint256)"))), abi.encode(_newTPB));
        bytes memory data_ = abi.encodeWithSignature("changetokensPerBlock(uint256)", _newTPB);
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    ...
    function changetransBurnrate(uint256 _newtransBurnrate) public onlyOwner returns (bool) {
        ...
        return true;
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("changetransBurnrate(uint256)"))), abi.encode(_newtransBurnrate));
        //bytes memory data_ = abi.encodeWithSignature("changetransBurnrate(uint256)", _newtransBurnrate);
        bytes memory data_ = abi.encodeWithSignature("changetransBurnrate(uint256)", _newtransBurnrate);
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
    ...
    function changedecayBurnrate(uint256 _newdecayBurnrate) public onlyOwner returns (bool) {
        ...
        return true;
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("changedecayBurnrate(uint256)"))), abi.encode(_newdecayBurnrate));
        bytes memory data_ = abi.encodeWithSignature("changedecayBurnrate(uint256)", _newdecayBurnrate);
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    ...
    function changeteamMintrate(uint256 _newTMR) public onlyOwner {
        ...
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("changeteamMintrate(uint256)"))), abi.encode(_newTMR));
        bytes memory data_ = abi.encodeWithSignature("changeteamMintrate(uint256)", _newTMR);
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    ...
    function burntoken(address account, uint256 amount) public onlyOwner returns (bool) {
        ...
        return true;
        */
        //bytes memory data_ = abi.encodePacked(bytes4(keccak256(bytes("burntoken(address,uint256)"))), abi.encode(account), abi.encode(amount));
        bytes memory data_ = abi.encodeWithSignature("burntoken(address,uint256)", account, amount);
        Txn memory tmp = Txn({to:target, value:0, signature:"", data:data_, eta:now + timelock.delay()});
        en += 1;
        Txns[en] = tmp;
        timelock.queueTransaction(tmp.to, tmp.value, tmp.signature, tmp.data, tmp.eta);
    ...
    function refresh() public {
        ...
        while(st<=en){
            if(Txns[st].eta>now) break;
            timelock.executeTransaction(Txns[st].to, Txns[st].value, Txns[st].signature, Txns[st].data, Txns[st].eta);
            st ++;
        }
