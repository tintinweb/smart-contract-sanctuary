...
contract LoremIpsum is ERC721, Ownable {
    ...
    uint public constant NUMBER_OF_TEAM_TOKENS = 5;

    uint256 private priceInEther = 0.01 ether;
    ...
    function reserveTeamTokens() public onlyOwner saleIsOpen {        
        uint supply = totalSupply();
        uint i;
        for (i = 0; i < NUMBER_OF_TEAM_TOKENS; i++) {
    ...
    function mint(uint _count) public payable saleIsOpen {
        ...
        require(msg.value >= priceInEther * _count, "Ether sent below price");
