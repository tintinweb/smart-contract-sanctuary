...
contract TinTEST is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 750 * 10**3 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 10 * 10**1 * 10**9; //so for testing we can see if liquidity price floor is being built up
