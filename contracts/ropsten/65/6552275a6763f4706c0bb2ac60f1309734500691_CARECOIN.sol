...
contract Ownable {
    ...
    event ChangeInterestFrequency(
        uint256 previousInterestFrequency,
        uint256 newInterestFrequency
    );
    ...
    function changeInterestFrequency(uint256 newInterestFrequency)
        public
        onlyOwner
    {
...
contract CARECOIN is ERC20, Pausable {
    ...
    function DonateToCareFund(address from, uint256 amount)
        public
        returns (bool)
    {
