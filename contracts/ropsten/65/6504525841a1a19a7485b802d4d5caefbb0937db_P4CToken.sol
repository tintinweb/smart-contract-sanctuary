...
abstract contract Liquifier is Ownable, Manageable {
    ...
    function _setPairAddress(address pair) private {
        _pair = pair;
    }
    ...
    function setPairAddress(address pair) external onlyManager() {
        _setPairAddress(pair);
    }
    ...
    contract P4CToken is BaseRfiToken, Liquifier {
