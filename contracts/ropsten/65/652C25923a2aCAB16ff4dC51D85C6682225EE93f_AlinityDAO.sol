...
contract AlinityDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmU3vTgHo4sr11sJBFRzQ9vpFsLbf1tQeq69gN7BJtd1Hq";
  ...
  // Fuck me daddy
    ...
    constructor(
    ) ERC721A("AlinityDAO", "ALINITY", 100, maxSupply) {}
