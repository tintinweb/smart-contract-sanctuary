...
contract test is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "test INU";                                           // name
    ...
    uint256 private maxMarketingFeeIfBuyFeeIsSmall = 16; // check settingFees
    uint256 private maxMarketingFee = maxMarketingFeeIfBuyFeeIsSmall/2; // 8% for sells & buys
    uint256 public defaultMarketingFee = 5;
    uint256 public _marketingFee = defaultMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _marketingFee4Sellers = 16;
    ...
    function chartDumped_LetsPump(uint256 marketingFee4Sellers, uint256 marketingFee, uint256 taxFee) external onlyOwner() {
        require(marketingFee4Sellers <= maxMarketingFeeIfBuyFeeIsSmall
        && marketingFee <= 5
        && taxFee <= maxReflection
        );
        _marketingFee4Sellers = marketingFee4Sellers;
        defaultMarketingFee = marketingFee;
        _taxFee = taxFee;
