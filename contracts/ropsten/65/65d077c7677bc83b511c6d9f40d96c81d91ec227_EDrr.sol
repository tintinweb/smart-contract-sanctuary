...
contract EDrr is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'EDrr';
    string  private constant _SYMBOL = 'EDrr';
    ...
    uint256 private _tTotal = 700000000 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 7000000 * _DECIMALFACTOR;
