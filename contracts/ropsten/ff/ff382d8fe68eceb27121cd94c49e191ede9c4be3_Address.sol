...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2F26B104d3dc65dd0Bb4E1a064De63E1D321E154;
...
contract SwooseToken is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0x2F26B104d3dc65dd0Bb4E1a064De63E1D321E154;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SwooseToken.com";
