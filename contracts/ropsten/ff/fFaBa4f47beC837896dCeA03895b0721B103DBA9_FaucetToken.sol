...
import "../tests/Contracts/BEP20.sol";

/**
 * @title The Rifi Faucet Test Token
 * @author Rifi
...
/**
 * @title The Rifi Faucet Test Token (non-standard)
 * @author Rifi
 * @notice A simple test token that lets anyone get more of it.
 */
...
/**
 * @title The Rifi Faucet Re-Entrant Test Token
 * @author Rifi
