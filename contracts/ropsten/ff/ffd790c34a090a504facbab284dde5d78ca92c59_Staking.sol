...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 public APE_APE = IERC20(0xB4eBDc4a776C23Cdd856ac9D9B497685E96DFC70); // Must be changed with Presale
...
contract Staking is LPTokenWrapper {
    IERC20 public ape = IERC20(0xB4eBDc4a776C23Cdd856ac9D9B497685E96DFC70); // Must be changed with Presale
    uint256 public constant duration = 3 minutes; //7 days;                          
    ...
    function calculateTenPercent(uint256 amount) internal pure returns (uint256)
    {
        return amount.mul(100).div(1000);
    }

    function calculateNinetyPercent(uint256 amount) internal pure returns (uint256)
    {
