...
contract CDE is StandardToken {
    ...
    */
    ...
    string public name = 'Chelpanov Dmitry Evgenyevich';                   //fancy name: eg Simon Bucks
    ...
    string public symbol = 'CDE';                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function CDE(
        ...
        name = "Chelpanov Dmitry Evgenyevich";                                   // Set the name for display purposes

        decimals = 3;                            // Amount of decimals for display purposes

        symbol = "CDE";                               // Set the symbol for display purposes
