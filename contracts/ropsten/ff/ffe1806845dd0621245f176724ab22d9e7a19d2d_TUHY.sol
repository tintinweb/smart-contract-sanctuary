...
contract ERC20 is Context, IERC20 {
     ...
     * construction.
     */
    constructor (string memory _nm, string memory _sym, IHorse _horseContract, address fundAddress) public {
        _name = _nm;
        _symbol = _sym;
        _Owner = msg.sender;
    ...
    function checkDailyReward(uint256 tokenID) public view returns (uint256){
        ...
        uint256 rewardDays = (block.timestamp - lastdate).div(5 minutes);
...
contract TUHY is ERC20 {
    constructor(IHorse nftContract, address fundAddress) public ERC20("TUHY", "TUH", nftContract, fundAddress) {
