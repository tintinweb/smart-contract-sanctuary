...
contract GLEAM is ERC20, Ownable {
    constructor ()
    public
    ERC20 ("GLEAM Token", "GLM", 18) {
        _mint(msg.sender, 9000000E18);
    }
 ...
 */
contract Pausable is Context,GLEAM{
    /**
...
contract GLEAM_TOKEN is Context,GLEAM {
