...
contract TopPayCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TopPayCoin() {
        ...
        name = &quot;TopPayCoin&quot;;                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = &quot;TOPA&quot;;                                             // Set the symbol for display purposes (CHANGE THIS)
