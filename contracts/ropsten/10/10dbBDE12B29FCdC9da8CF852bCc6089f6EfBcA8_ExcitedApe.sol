...
contract ExcitedApe is ERC721Update, Ownable {
    ...
    function privateMint(uint256 _count) public payable checkPrivateSaleIsActive onlyWhiteList {
        ...
        require(_count <= maxPerPresaleTx, "Should not more than 3");
    ...
    function publicMint(uint256 _count) public payable checkPublicSaleIsActive {
        ...
        require(msg.value >= getMintPrice(_count), "Not enough eth sent");
...
abstract contract ERC721Update is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721Update.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(ERC721Update.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721Update.ownerOf(tokenId), to, tokenId);
    }
