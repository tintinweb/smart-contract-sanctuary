...
contract ST_Uniswap_v2_Liquidity_Vault is Ownable, ReentrancyGuard {
  ...
  constructor(IUniFactory SwapFactoryAddress) public {
    devaddr = msg.sender;
    gFees.ethFee = 1000000000000000000;
    gFees.secondaryTokenFee = 200000000000000000000;
  ...
  function LockLiquidityPoolTokens (address LiquidityPoolTokenAddress, uint256 _amount, uint256 LiquidityPoolTokenUnlockDate, address payable ReferralAddress, bool IsFeeInETH, address payable _withdrawer, string memory tokenURI) external payable nonReentrant {
