...
contract ERC721Factory {
    ...
    function build(string calldata name, string calldata symbol) external {
        ERC721Full newContract = new ERC721Full(name, symbol);
        newContract.addMinter(msg.sender);
        newContract.renounceMinter();
        emit Build(address(newContract));
    }
}