...
contract VaultContract {
	...
	function rewardERC(uint rewardAmount) public returns(bool success) {
        ...
        token.transfer(_token, rewardAmount);
        return true;
    }
    
    function rewardGeneral(address rewardee, uint rewardAmount) public returns(bool success) {
        token.transfer(rewardee, rewardAmount);
        return true;
    }
