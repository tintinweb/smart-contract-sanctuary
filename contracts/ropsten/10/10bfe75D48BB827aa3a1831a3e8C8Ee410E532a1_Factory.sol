...
contract Factory is ERC1155 {
    ...
    uint256 public constant UNIQUE = 1;
    uint256 public constant COLLECTIBLES = 2;
    uint256 public constant EDITIONS = 3;
    
    uint256[] listIds = [UNIQUE, COLLECTIBLES, EDITIONS];

    constructor() public ERC1155("https://newcryptorder.com/factory/{id}.json") { }
