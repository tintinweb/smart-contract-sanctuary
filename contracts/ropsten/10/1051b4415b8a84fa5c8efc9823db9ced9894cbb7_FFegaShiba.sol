...
contract FFegaShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWallet = payable(0xf1e106aADd3CDfC960727f1D4774e4CeDFF0982A); // Marketing Wallet
    address payable public prizeRewardWallet = payable (0xc66Acf28cF5E3eCc94759B098255b02763d5e361); // prizeReward Wallet
    ...
    string private _name = "FFega Shiba Inu";
    string private _symbol = "FFEGA SHIBA";
    

    uint256 public _maxWalletToken = _tTotal.div(1000).mul(3); //0.3% for first few mins

    uint256 private reflectionFee=0; 

    uint256 public liquidityFee = 4;
    uint256 public marketingFee = 4;
    uint256 public prizeRewardFee = 1;
    ...
    uint256 private _feeRate = 2; //contract can sell max 0.2% price impact in a single transaction
    ...
    function _transfer(
        ...
        if((!_isMaxWalletExempt[to] && from!= owner()) || (launchedAt + deadBlocks) > block.number){
