...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
      //send ETH from msg.sender to contract.  Send Tokens from Vendor to msg.sender.
  ...
  function sellTokens(uint256 amountOfTokens) public {
      ...
      //Transfer tokens from msg.sender to vendor
      require(yourToken.allowance(msg.sender, address(this)) >= amountOfTokens, "Not approved!");
      bool sent = yourToken.transferFrom(msg.sender, address(this), amountOfTokens);
      require(sent, "Token transfer failed");

      //Transfer ETH from vendor to msg.sender
      uint256 paymentAmount = (amountOfTokens / tokensPerEth);
      (bool success, ) = msg.sender.call{value: paymentAmount}("");
      require(success, "Failed to send Ether");
      emit SellTokens(msg.sender, amountOfTokens, paymentAmount);
  }
