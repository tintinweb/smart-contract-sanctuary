...
contract AromaTest1 is StandardToken,Ownable {
   ...
   address public founder =0x4b0897b0513FDc7c541b6d9d7e929c4e5364d2db; //test  //创始人
   uint public sellPrice = 2500;
   uint public buyPrice = 2500;
   ...
   constructor () public  {
	...
	function setSellPrices(uint256 newSellPrice) onlyOwner public returns(bool){
	    sellPrice = newSellPrice;
        return true;
	}

    function setBuyPrice(uint newBuyPrice) onlyOwner public returns(bool){
     ...
     */
    function sell(uint amount) payable  public returns (uint revenue) 
    {
