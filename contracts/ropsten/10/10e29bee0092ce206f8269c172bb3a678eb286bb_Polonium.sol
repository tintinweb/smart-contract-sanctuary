...
contract Polonium is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Polonium.Finance";
    string private _symbol = "POLO";
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'POLO: The contract it self cannot be excluded');
        require(!_isExcluded[account], "POLO: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "POLO: Account is already included");
