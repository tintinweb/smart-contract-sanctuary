...
contract HipisToken is ERC20Detailed, ERC20Mintable, ERC20Pausable, ERC20Burnable, Ownable {
    event MintFinished();
    ...
    */
    ...
    //	require(totalSupply().add(value) > 0, "ERC20Mintable: add value");
