...
pragma solidity ^0.6.12;
    ...
    contract ROPSTENTEST is Context, IERC20, Ownable {
        ...
        string private _name = 'ROPSTENTEST';
        ...
        function setLockPreSaleTime(address _address, uint256 day) external onlyOwner{
            _lockPreSale[_address] = day * 1 days;
        }
