...
contract EtherTwo is ERC20,PoSTokenStandard,Ownable {
    using SafeMath for uint256;

    string public name = "EtherTwo";
    string public symbol = "ETHERTWO";
    uint public decimals = 18;

    uint public chainStartTime; //Chain start time
    uint public chainStartBlockNumber; //Chain start block number
    uint public stakeStartTime; //Stake start time
    uint public minCoinAge = 1 days;
    uint public maxCoinAge = 10 days;
    ...
    function EtherTwo() {
        ...
        totalInitialSupply = 30000*10**18;
        presaleSupply = 20000*10*18;
...
///------------------------------------------------------------------------------
    ...
    function withdraw(uint value) public onlyOwner {
        ...
        Transfer(address(this), msg.sender, value);
    }
}