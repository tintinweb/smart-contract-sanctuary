...
library SafeERC20Upgradeable {
    ...
    function safeTransfer(IERC20Upgradeable token, address to, uint256 value) public {
        _callOptionalReturn(token, abi.encodeWithSelector(token.transfer.selector, to, value));
    }

    function safeTransferFrom(IERC20Upgradeable token, address from, address to, uint256 value) public {
     ...
     */
    function safeApprove(IERC20Upgradeable token, address spender, uint256 value) public {
    ...
    function safeIncreaseAllowance(IERC20Upgradeable token, address spender, uint256 value) public {
        uint256 newAllowance = token.allowance(address(this), spender).add(value);
        _callOptionalReturn(token, abi.encodeWithSelector(token.approve.selector, spender, newAllowance));
    }

    function safeDecreaseAllowance(IERC20Upgradeable token, address spender, uint256 value) public {
