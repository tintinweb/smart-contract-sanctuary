...
contract Token30 is IERC20, Auth {
	string _name = "Token 30";
	string _symbol = "T30";
	...
	function changeTaxDistribution(uint16 sharesTokenWallet, uint16 sharesBurnedTokens, uint16 sharesAutoLP, uint16 sharesEthWallet1, uint16 sharesEthWallet2, uint16 sharesEthWallet3) external {
        _checkAuth();
	...
	function setTaxWallets(address newEthWallet1, address newEthWallet2, address newEthWallet3, address newTokenTaxWallet) external {
        _checkAuth();
	...
	function taxTokensSwap() external {
		require(msg.sender == _ethTaxWallet1 || msg.sender == _ethTaxWallet2 || msg.sender == _ethTaxWallet3 || msg.sender == _operator || msg.sender == owner, "403" );
