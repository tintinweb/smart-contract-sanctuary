...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory MyPetPro_, string memory MPP_) {
        _MyPetPro = MyPetPro_;
        _MPP = MPP_;
...
/**
 * @dev Contract for MyPetPro token
 */
contract MyPetPro is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 1_000_000_000e18;

    constructor() ERC20("MyPetPro", "MPP") {
