...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x1a3CE30c4e14c9FD813aa0Ab1DCb08a350A4d0a2), 4000);
        m_DidDeploy = true;
    }
...
contract dasda is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "dasda";
    string private m_Symbol = "dasd";
