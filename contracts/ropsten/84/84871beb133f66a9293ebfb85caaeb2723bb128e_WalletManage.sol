...
contract WalletManage is WalletOwned {
    ...
    event ForwardTo(address _wallet,address _to, uint _amount);
    ...
    function setHistory(address _from,address _wallet,address _to, uint _amount) walletOnly public {
        emit Deposited(_from,_wallet,_amount);
        emit ForwardTo(_wallet,_to,_amount);
    }
...
contract Wallet {
    ...
    function() public payable blockDeposit {
        ...
        parentInstance.setHistory(msg.sender,address(this),forwardAddress,msg.value);
    }
