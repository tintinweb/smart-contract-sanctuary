...
// File: contracts\WalkToken.sol


pragma solidity ^0.8.0;


contract WalkTest is ERC20PresetMinterPauser {
    // Initializing the maximum supply of 1 billion to WALK token 
    uint256 private immutable MAXSUPPLY = 1000000000 * 10 ** 18;

    constructor() ERC20PresetMinterPauser("WalkTest", "WALKTV1") {
    }
