...
contract FlokiRamen is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Ramen";
    string private constant _symbol = 'FLRA️';
    ...
    uint256 private _maxTxAmount = 200000000 * 10**2 * 10**18;
    ...
    constructor (address payable FeeAddress, address payable tWallet) public {
    ...
    function _setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <= 35, 'taxFee should be in 0 - 35');
        _taxFee = taxFee;
    }

    function _setTeamFee(uint256 teamFee) external onlyOwner() {
        require(teamFee >= 0 && teamFee <= 35, 'teamFee should be in 0 - 35');
        _teamFee = teamFee;
    }
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _tWallet.transfer(amount.div(2));
    }
