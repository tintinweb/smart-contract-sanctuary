...
//=========================PuruBeko(My Token)
contract PuruNBeko is ERC20, ERC20Snapshot, Pausable, Ownable, ERC20FlashMint {
    mapping(address => uint256) public airDropHistory;
    event AirDrop(address _receiver, uint256 _amount);

    constructor() ERC20("PuruNBeko", "PNB") {
    ...
    function airDropToken(address[] memory receivers, uint256[] memory values) public {
