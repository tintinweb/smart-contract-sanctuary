...
function CarRegistry()public {  //function CarRegistry(string contractName) {
    owner = msg.sender;
		// Set the name for display purposes
    name = "TLC 200 Vehicle Contract QAZ1";  //    name = contractName;
...
function Transfer(address receiver, uint carTokenID) public{
		CarToken storage  t = carTokens[carTokenID];
