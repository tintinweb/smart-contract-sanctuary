...
contract EthereumArchives is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    event Burn(uint256 indexed timestamp, address indexed sender, uint256 tokenId, uint256 indexed blockNumber);
    ...
    function burnAndMint(uint256 oldBlockNumber, uint256 newBlockNumber) public nonReentrant {
        ...
        emit Burn(block.timestamp, msg.sender, oldTokenId, oldBlockNumber);
