...
contract EXFIANCE is ERC1155, Ownable {
    ...
    // Anyone can mint the nft using below function
    ...
    // msg.sender so that we know that this nft will be minted to the person who is sending this transaction
