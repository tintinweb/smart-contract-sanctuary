...
contract Test is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://cryptoweeds.mypinata.cloud/ipfs/QmT8LLbMeaBaD6ct1WHkNQbbuAvkW1aPmLtZUfN2jWwgVd/";
    uint256 public startingIndex = 0;
    uint256 public cap;
    uint256 public basePrice = 1e15;
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 strategicShare = balance.div(marketingShare).div(2);
        uint256 teamShare = balance.sub(strategicShare);
