...
/* 
    ...
    Telegram: https://t.me/bruhinu
    Twitter: https://twitter.com/bruhInu
...
contract bruhInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bruh-Inu";
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 50, "Must keep buy taxes below 50%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 50, "Must keep sell taxes below 50%");
