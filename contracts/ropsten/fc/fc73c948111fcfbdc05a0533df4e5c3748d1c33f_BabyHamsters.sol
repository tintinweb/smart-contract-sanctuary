...
contract BabyHamsters is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 10000000 * 10**6 * 10**9; // Max Transaction: 1 Trillion (1%)
    uint256 public _maxWalletToken = 30000000 * 10**6 * 10**9; // Max Wallet: 3 Trillion (3%)
...
// This contract created by (instagram:@childrenofsun) Kadir Han. All rights reserved. 
