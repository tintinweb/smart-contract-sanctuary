...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[XTKN061630::ERROR][Ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[XTKN061630::ERROR][Ownable] new owner is the zero address");
...
contract IXTKN061630Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN061630Project{
    function init() public{}
...
*/
contract XTKN061630 is Context, IERC20, Ownable, RobinHood{
    // public properties
        // lib
            using SafeMath for uint256;
            using Address for address;
        ...
        // interfaces
            ...
            IXTKN061630Liquidity private _liquidity;
            IXTKN061630Project private _project;
            IXTKN061630Staking private _staking;
            IXTKN061630PreSale private _preSale;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals instead of the 18
            string private _name = "XTKN061630"; // the name of our project
            string private _symbol = "XTKN061630";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN061630Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN061630Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(address contractAddress) public onlyOwner{
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN061630Staking(ADDRESS_STAKING);
            _staking.init();
    ...
    function initPreSale(address contractAddress) public onlyOwner{
        if(!_contractPreSaleActive){
            ...
            // init contract
            _preSale = IXTKN061630PreSale(ADDRESS_PRESALE);
            _preSale.init(1638403199, ADDRESS_STAKING);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[XTKN061630::ERROR] approve from the zero address");
        require(spender != address(0), "[XTKN061630::ERROR] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[XTKN061630::ERROR] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[XTKN061630::ERROR] transfer amount exceeds allowance"));
        return(true);
    }
