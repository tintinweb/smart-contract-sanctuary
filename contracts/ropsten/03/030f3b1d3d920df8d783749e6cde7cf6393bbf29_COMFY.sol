...
/**
    ComfyDoge (COMFY) is a soft fork of Reflect (RFI) that incorporates adjustable
    yield rates (so early buyers can continue to earn reasonable yields as
    more holders enter the ecosystem). ComfyDoge (COMFY) also has a deflationary supply
    and fair-launch mechanisms to ensure a healthy distribution of tokens.
    
   
    Telegram: https://t.me/comfydoge
...
contract COMFY is Context, IERC20, Ownable {
    ...
    string private _name = 'Comfy Doge';
