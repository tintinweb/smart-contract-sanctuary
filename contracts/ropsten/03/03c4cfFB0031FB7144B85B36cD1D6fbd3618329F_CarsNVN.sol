 ...
 */
contract CarsNVN is NPassCore {
    bool public publicSale = false;
    using Strings for uint256;
    string public baseURI;

    constructor(string memory baseURI_) NPassCore("NVN", "nVn", IN(0x2269F599C4e09975861BF0613880b454243a8c83), true, 8888, 8888, 15000000000000000, 15000000000000000) {
        baseURI = baseURI_;
    }
