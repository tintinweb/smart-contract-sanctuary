...
contract Whimpy is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Whimpy";
    string private constant _symbol = "Whimpy";
    ...
    address payable private _Whimpy;
    ...
    constructor(address payable marketfund, address payable frementax, address payable whimpy) {
        ...
        _isExcludedFromFee[_Whimpy] = true;
