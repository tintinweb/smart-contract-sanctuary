...
contract BTADP_Token is Context, IERC20, Ownable {
    ...
    address public charityaddress = 0x33Bc71bB9aBf03e08CA43f2506650DEA6fA421F9;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != address(this), 'BTADP: The contract it self cannot be excluded');
        require(!_isExcluded[account], "BTADP: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "BTADP: Account is already included");
