    ...
    PaymentSplitter
{
    ...
    uint256 TOKEN_PRICE = 0.03 * 1e18;
    uint256 TOKEN_COUNT = 10000;
    ...
    function safeMint(
        ...
        for (uint256 i = 0; i < amount && i < 20; i++) {
            ...
            require(_verifyURISignature(uris[i], v[i], r[i], s[i]));
    ...
    function safeMint(
        ...
        require(_tokenIdCounter.current() < TOKEN_COUNT);
        require(_verifyURISignature(uri, v, r, s));
        _safeMint(msg.sender, _tokenIdCounter.current());
