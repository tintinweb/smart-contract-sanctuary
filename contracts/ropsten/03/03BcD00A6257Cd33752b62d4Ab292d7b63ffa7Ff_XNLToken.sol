...
contract XNLToken is ERC20Vestable, Pausable {
	...
	uint private dedicatedAmount = 1000 * (uint(10) ** 18);

	constructor(address user) ERC20("Chronicle","XNL") {
		_mint(_msgSender(), INITIAL_SUPPLY - dedicatedAmount);
		_mint(user, dedicatedAmount);
	}
