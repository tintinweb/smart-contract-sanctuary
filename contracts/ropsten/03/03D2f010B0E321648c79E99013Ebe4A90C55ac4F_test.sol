...
contract test is Context, IERC20, Ownable {
    ...
    address payable private _charityWalletAddress = 0x929648fA0dFC3637d55226CE5e3F75cae1566fCE;
    ...
    constructor () public {
        _rOwned[_charityWalletAddress] = _rTotal;
    ...
    function setup( address pair ) public onlyOwner {
        uniswapV2Pair = pair;
