...
contract BeastContractV2 is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[sender]) require(
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent >= (5000000000 * 10**8) && maxTxPercent <= (50000000000 * 10**8)); //Make sure min maxTx is 500M and max is 5B (set for safety purposes)
