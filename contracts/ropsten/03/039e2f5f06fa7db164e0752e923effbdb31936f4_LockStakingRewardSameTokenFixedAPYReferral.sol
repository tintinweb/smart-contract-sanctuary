...
contract LockStakingRewardSameTokenFixedAPYReferral is ILockStakingRewards, ReentrancyGuard, Ownable {
    ...
    function updateRewardRate(uint256 _rewardRate) external onlyOwner {
        require(_rewardRate != 0, "LockStakingRewardSameTokenFixedAPYReferral: Reward rate cannot be equal to 0");
        rewardRate = _rewardRate;
    }
    ...
    function _getUserReferralId(address account) public view returns (uint256 id) {
