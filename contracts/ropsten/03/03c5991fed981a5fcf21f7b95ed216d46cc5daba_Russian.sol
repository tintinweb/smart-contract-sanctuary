...
contract Russian is Context, Ownable, ERC20Detailed, GasPump {
    ...
    constructor() public ERC20Detailed("Russian L3", "RTKL3", 18) {    // For naming the token and specifying it's decimals
