...
contract kkkkkkk is StandardToken, Ownable {

    string public constant name = "kkkkkkk"; // solium-disable-line uppercase
    string public constant symbol = "kkk"; // solium-disable-line uppercase
