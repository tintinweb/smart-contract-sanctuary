...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address payable deployerWallet = payable(0x340e6172F0d8124140b151847259F3a33d8A4fd0);
    address payable marketingWallet = payable(0xDa16D532953bf218DB890986039c9A6109f74323);
    address payable developmentWallet = payable(0x88a740a7C4B5Bc2bBE6a94996b8FD1250a7D529d);
    ...
    address public _add = address(this);
    function _transfer(
        address from,
        address to,
        uint256 amount
