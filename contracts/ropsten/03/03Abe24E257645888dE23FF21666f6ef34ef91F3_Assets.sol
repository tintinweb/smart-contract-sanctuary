...
//    checking will be done in the backend
    ...
    constructor (address _imx) ERC721 ('AstroBots NFT', 'ABN') {
        imx = _imx;
        startTime = block.timestamp;
        owner = msg.sender;
    }
    // address payable private receiver = payable(0x95e1E5452F6E9150718DF69a9d29cFC8c3C2ec56);
    // address payable private secondOwner = payable(0x3d1a5308f3f0e6ec12808207dbd732fe7cac95ad);
    ...
    function tokenSale (address _to, uint tokenId) internal returns (bool) {
        if (isPreSaleActive()) {
            ...
            _setTokenURI (tokenId, 'https://gateway.pinata.cloud/ipfs/QmSUvFVSExddCZfrfDTDfpEfNTpuKAVRksiJsrHidAwsXh');
            return true;
        }
        else {
