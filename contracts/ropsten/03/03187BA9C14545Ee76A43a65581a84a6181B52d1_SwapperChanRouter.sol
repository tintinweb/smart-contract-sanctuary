...
library SwapperChanLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'34fabb11b0122bd8f4e39ec4030037f53a069abda65e2f0af6d8fb9373f804de' // init code hash
            ))));
    }
...
contract SwapperChanRouter {
        ...
        returns (uint[] memory amounts)
    {
        ...
        amounts = SwapperChanLibrary.getAmountsOut(factory, msg.value, path);
        require(amounts[amounts.length - 1] >= amountOutMin, 'SwapperChan: INSUFFICIENT_OUTPUT_AMOUNT');
