...
contract HPoolManager is ERC1155HolderUpgradeable, HordUpgradable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    isPoolIdValid(poolId)
    {
        ...
        require(block.timestamp > hp.privateSubscriptionEndTime || numberOfTicketsUsed[poolId] < maxTicketsToUse,
            "Time expired, or all tickets have been used.");
    ...
    isPoolIdValid(poolId)
    {
        ...
        allHPoolTokens.push(address(hpContract));
