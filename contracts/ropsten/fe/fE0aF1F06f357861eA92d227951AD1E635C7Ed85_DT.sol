...
contract DT is Context, Ownable, IERC20, LockableSwap, FeeLibrary, EthReflectingToken {
    ...
    function initMint(address[] memory addresses, uint256[] memory values, address ownerAddress, address reflectorAddress) external onlyOwner {
