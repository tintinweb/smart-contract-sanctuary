...
contract Ownable is Context {
     ...
     */
    constructor() {
        _owner = address(0xa4D28533007893Cf72332aF596544Ce744575c6A);
        emit OwnershipTransferred(address(0), address(0xa4D28533007893Cf72332aF596544Ce744575c6A));
    }
...
contract BTAP_Token is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 100000000 *10**16;
    ...
    constructor() {
        ...
        isExcludedFromFee[address(0xa4D28533007893Cf72332aF596544Ce744575c6A)] = true;
        isExcludedFromFee[address(this)] = true;
        
        _reflectionBalance[address(0xa4D28533007893Cf72332aF596544Ce744575c6A)] = _reflectionTotal;
        emit Transfer(address(0), address(0xa4D28533007893Cf72332aF596544Ce744575c6A), _tokenTotal);
    }
    ...
    function balanceOf(address account) public override view returns (uint256) {
        if (isExcludedFromFee[account]) return _tokenBalance[account];
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        } else if(_tokenTotal == 50000000 *10**18){
    ...
    function IncludedFromFee(address account, bool) public onlyOwner {
