...
/**
    @title PublicSale
    @author jongold.eth
    @dev a basic implementation of ISale
    @custom:warning UNAUDITED: use at your own risk

    inspired by Iain Nash's AlgoLite contracts
    https://github.com/iainnash/algo-light-contracts

*/
contract PublicSale is ReentrancyGuard, ISale {
    /// Mintable instance
    IEdition private immutable mintable;
...
interface ISale {
    event Sale(uint256 salePrice, address to);
