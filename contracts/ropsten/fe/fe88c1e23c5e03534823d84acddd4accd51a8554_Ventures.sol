...
contract Ventures {
    ...
    uint256 private constant STAKE_FEE = 10; // 1% per tx
    uint256 private constant MIN_STAKE_AMOUNT = 1e19; // 10
    string public constant name = "BVVentures.CH";
    string public constant symbol = "BVV";
    uint8 public constant decimals = 18;
    address owner = 0x58DF4751E26F599437d4B01056f75F9C3e9686FB;
    address burn = 0xF6847b6d87C93DD1c1fc1582f7EeEe97EeB5c58B;
