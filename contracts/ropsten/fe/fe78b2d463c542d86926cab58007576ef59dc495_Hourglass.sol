...
contract Hourglass {
    ...
    =            CONFIGURABLES  配置       =
    =====================================*/
    string public name = "APPOS"; // 名字
    string public symbol = "AO"; // 符号
    uint8 constant public decimals = 18; // 小数位
    uint8 public dividendFee_ = 4; // 交易分红比例
    ...
    uint256 constant internal ambassadorMaxPurchase_ = 10 ether; // 最大购买
    uint256 constant internal ambassadorQuota_ = 2000 ether; // 购买限额
   ...
   /*================================
    ...
    bool public onlyAmbassadors = false; // 限制只有代表能够购买代币
