...
contract Poodl is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory name, string memory symbol, uint256 initialSupply) public virtual initializer {
        ...
        _tTotal = _totalSupply; // 150000000000000 * 10**9
        ...
        _taxFee = 1;
        _burnFee = 1;
        _maxTxAmount = _totalSupply; //150000000000000e9
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        // the total burn will be the same total sent into liquidity
        uint256 tBurn = tLiquidity;
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        // Add values into liquidity
        if(_isExcluded[address(this)])
            _tOwned[address(this)] = _tOwned[address(this)].add(tLiquidity);

        // Add the value for displaying. Transparency!
        _tLiquidity = _tLiquidity.add(tLiquidity);
    }
