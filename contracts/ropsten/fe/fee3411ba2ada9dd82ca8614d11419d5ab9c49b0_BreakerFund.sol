...
// File: contracts/deployer/TokitDeployerOneUser.sol
 ...
 */
contract TokitDeployerOneUser is Ownable {
    ...
    /**
     * @dev Deploys a fund and token contracts. There is only one token holder in the token contract
     ...
     * @param _wallet An address of a token holder
     * @param _name A name of a token
     * @param _symbol A symbol of a token
     * @param _totalSupply A total supply of tokensr
     */
    function deployToken(
        ...
        BreakerToken token = new BreakerToken(address(fund), _wallet, _name, _symbol, _totalSupply);
