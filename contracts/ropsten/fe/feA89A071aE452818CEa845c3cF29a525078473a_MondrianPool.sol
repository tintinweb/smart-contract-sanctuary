...
contract vBid {
    ...
    function vstake(uint256 bidAmount,uint256 stakeTime) internal {
        ...
        uint256 muliplier=stakeTime/DURATION;
    ...
    function increaseStakeAndTime(uint256 bidAmount,uint256 stakeTime1) internal {
        ...
        uint256 amountNew=bidAmount.mul(_startTimes[msg.sender]+newStakeTime-block.timestamp).div(DURATION);
        uint256 amountOri=_bidBalances[msg.sender].mul(stakeTime1).div(DURATION);
