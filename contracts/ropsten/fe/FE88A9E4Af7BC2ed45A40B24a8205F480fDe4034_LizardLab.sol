...
import "@openzeppelin/contracts/access/Ownable.sol";
 ...
 contract LizardLab is ERC721, Ownable {
    ...
    uint256 public constant MAX_LIZARDS = 15;
    ...
    function mintPresale(uint256 numberOfMints) public payable {
        ...
        require(PRICE * numberOfMints >= msg.value,                 "Ether value sent is not correct"); //TODO: Evaluate paying too much
    ...
    function mint(uint256 numberOfMints) public payable {
        ...
        require(totalSupply + numberOfMints <= MAX_LIZARDS,         "Purchase would exceed max supply of tokens");
        require(PRICE * numberOfMints == msg.value,                 "Ether value sent is not correct");  //TODO: make sure this matches mintpresale after testing
