...
//==============================================================================
        ...
        public
    {
        ...
        plyr_[1].addr = 0x1205aD1D20342b48d8125A8Eac901C668CD4178d;
        plyr_[1].name = "east";
        plyr_[1].names = 1;
        plyr_[1].laff = 0;
        pIDxAddr_[0x1205aD1D20342b48d8125A8Eac901C668CD4178d] = 1;
        pIDxName_["east"] = 1;
        plyrNames_[1]["east"] = true;
        plyrNameList_[1][1] = "east";

        plyr_[2].addr = 0x6F1a8a52ddc4CDac80be37c48d60fF663B945663;
        plyr_[2].name = "west";
        plyr_[2].names = 1;
        plyr_[2].laff = 0;
        pIDxAddr_[0x6F1a8a52ddc4CDac80be37c48d60fF663B945663] = 2;
        pIDxName_["west"] = 2;
        plyrNames_[2]["west"] = true;
        plyrNameList_[2][1] = "west";

        plyr_[3].addr = 0x3DF088Ea6Fd433DA95B714933D2C3Da2ecb00A3f;
        plyr_[3].name = "south";
        plyr_[3].names = 1;
        plyr_[3].laff = 2;
        pIDxAddr_[0x3DF088Ea6Fd433DA95B714933D2C3Da2ecb00A3f] = 3;
        pIDxName_["south"] = 3;
        plyrNames_[3]["south"] = true;
        plyrNameList_[3][1] = "south";

        plyr_[4].addr = 0x19c3c58452eD2908C6ceb3b25E3E46ECf8C56915;
        plyr_[4].name = "north";
        plyr_[4].names = 1;
        plyr_[4].laff = 3;
        pIDxAddr_[0x19c3c58452eD2908C6ceb3b25E3E46ECf8C56915] = 4;
        pIDxName_["north"] = 4;
        plyrNames_[4]["north"] = true;
        plyrNameList_[4][1] = "north";
