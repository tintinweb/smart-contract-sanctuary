...
🌠 Punk Bomb is a Deflationary token with periodic lottery winnings distributed to holders.
...
contract  PunkExplosion is ERC20 {
    constructor(uint256 initialSupply) ERC20(_name, _symbol, _decimals) {
        _name = unicode"💣 Punk Explosion 💥";
        _symbol = unicode" 💣 PunkExp 💥";
        _decimals = 9;
