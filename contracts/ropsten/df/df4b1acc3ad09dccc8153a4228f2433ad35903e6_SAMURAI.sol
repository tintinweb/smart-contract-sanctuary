...
contract SAMURAI is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmountSell = 1000 * 10**9 * 10**9;
    uint256 private _numOfTokensToExchangeForMarketing = 5 * 10**9 * 10**9;
    ...
    constructor () public {
        ...
        _marketingFee = 5;
        _marketingWalletAddress = payable(0xBF1952A46554b6f2441E1D52fA8db4F3c4f20900);
