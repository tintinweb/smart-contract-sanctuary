...
contract SunflowerFarmersPotatoStatue is ERC721, Ownable {
    address public minter;
    uint public totalSupply;

    constructor() public ERC721("Sunflower Farmers OG Potato Statue", "SFPS") {
        minter = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return "https://sunflower-farmers.com/play/nfts/og-potato-statue/metadata";
    }
