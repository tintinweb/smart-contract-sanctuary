...
contract SCARABToken2 is StandardToken {
...
//make sure this function name matches the contract name above. So if you&#39;re token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function SCARABToken2(
        ...
        name = "SCARABToken2";                                   // Set the name for display purposes
        decimals = 4;                            // Amount of decimals for display purposes
        symbol = "SCARAB3";                               // Set the symbol for display purposes
    }
    ...
    contract TokenSale is SCARABToken2 {
    SCARABToken2 public tokenContract ;  // the token being sold
    ...
    function TokenSale(SCARABToken2 _tokenContract, uint256 _price) public {
        owner = msg.sender;
