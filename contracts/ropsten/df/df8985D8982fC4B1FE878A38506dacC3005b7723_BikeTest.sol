...
contract BikeTest is Context, IBEP20, Ownable {
    ...
    string private _name = "BikeTest";
    string private _symbol = "BIKE";
    uint8 private _decimals = 18;
    
    uint256 public _BNBFee = 5;
    uint256 private _previousBNBFee;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    address payable public fundraisingAddress = payable(0x1f43cE90a924224518EE7Dd998f492F185dDFe77);    
    ...
    function reduceBNBFee(uint256 BNBFee) external authorized() {
        bool underMaxBNBTax = BNBFee < 5;
        if (underMaxBNBTax == true)
        _BNBFee = BNBFee;
    }
   
    //function setMaxTxPercent(uint256 maxTxPercent) external authorized() {
       // _maxTxAmount = _tTotal.mul(maxTxPercent).div(
        //    10**3
      //  );
    //}
    
    function setminTokensBeforeSwap(uint256 _minTokensBeforeSwap) external authorized() {
        minTokensBeforeSwap = _minTokensBeforeSwap;
    }
    
    function setSwaptoBNBEnabled(bool _enabled) public authorized {
    ...
    function setfundraisingAddress(address payable _fundraisingAddress) public authorized {
