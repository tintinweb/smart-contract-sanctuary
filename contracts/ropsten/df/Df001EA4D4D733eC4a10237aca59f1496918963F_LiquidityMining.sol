    ...
    AbstractDependant
{
    ...
    uint256 public constant LM_DURATION = 4 weeks;
        ...
        returns (UserRewardsInfo memory userRewardInfo)
    {
        ...
        userRewardInfo.claimedBMI =
            usersTeamInfo[user].countOfRewardedMonth == MAX_MONTH_TO_GET_REWARD;
...
interface ILiquidityMining {
    ...
    struct UserRewardsInfo {
        ...
        bool claimedBMI; // true if user claimed all his BMI
