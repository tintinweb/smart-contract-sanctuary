...
contract RandiveBhToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function RandiveBhToken() {
        ...
        name = "RandiveBhToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "RBT";                                             // Set the symbol for display purposes (CHANGE THIS)
