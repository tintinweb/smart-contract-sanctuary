...
contract SLICE is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Slicelife";
    string private _symbol = "SLICE";
    ...
    uint256 public _holderDistributionFee = 50; // 5% will be distributed among holder as token divideneds
