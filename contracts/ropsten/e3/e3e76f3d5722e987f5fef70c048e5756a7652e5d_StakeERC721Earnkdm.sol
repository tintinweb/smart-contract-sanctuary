...
// File: contracts/IStakeERC721Earnkdm.sol


pragma solidity =0.6.6;

interface IStakeERC721Earnkdm {
...
// File: contracts/StakeERC721Earnkdm.sol


pragma solidity =0.6.6;

contract StakeERC721Earnkdm is IStakeERC721Earnkdm,ERC20,Ownable,ERC721Holder,Pausable,ReentrancyGuard{
    ...
    IMasterNFT public immutable kdmMaster;
    ...
    constructor(
        ...
        kdmMaster = IMasterNFT (_kdmMaster);
    ...
    function emergencyUnstakeAllFromkdm(uint256 _amount) external override nonReentrant onlyOwner whenPaused {
