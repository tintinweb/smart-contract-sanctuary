...
contract IDO3 is AdminRole, VerifySignature{
  ...
  event DebugLog(uint8 index);


  function debug_tokenPurchase(uint256 require_token_value, uint256 holder_max_project_tokens, bytes memory signature, uint8 debugmode) public returns (bool){
    ...
    */
    ...
    require(false, "debugmode must be 1 - 8");
