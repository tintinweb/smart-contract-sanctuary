...
contract StakeInMe is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "StakeInMe";
    string private m_Symbol = "STAKE";
    ...
    constructor () {
        ...
        ILO.init(1000000000000000000, 1000, 1000, 100000, m_ILOPublic);
        initTax();
