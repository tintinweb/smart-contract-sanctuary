...
contract TaiyakiFISHSwap is ReentrancyGuard, Pausable, Ownable {
    ...
    function swap(address tokenAddress, address account, uint256 amount) external nonReentrant whenNotPaused {
        ...
        require(token.transferFrom(account, swapper, amount), "Could not retrieve tokens");
        ERC20PresetMinterPauser(taiyakiAddress).mint(account, taiyakiAmount);
