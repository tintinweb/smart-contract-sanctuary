...
contract ThePlanetOfHares is ERC721Enumerable, Ownable {
    ...
    uint public constant MIN_NFT_PURCHASE_PRESALE = 10;
    uint public constant MAX_NFT_PURCHASE_PRESALE = 30;
    ...
    constructor() ERC721("The Planet of Hares","TPOH"){
    }
    ...
    function mintHare(uint numberOfTokens) public payable {
        ...
        require(totalSupply() + numberOfTokens <= MAX_SUPPLY - boarReserve, "Purchase would exceed max supply of Boars");
