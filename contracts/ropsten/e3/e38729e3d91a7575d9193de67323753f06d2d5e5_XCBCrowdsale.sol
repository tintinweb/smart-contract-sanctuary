...
contract XCBToken is MintableToken, DetailedERC20, PausableToken{
    constructor(string _name, string _symbol, uint8 _decimals, uint256 initialSupply) 
...
// File: contracts\XCBCrowdsale.sol

contract XCBCrowdsale is Crowdsale, TimedCrowdsale, PostDeliveryCrowdsale {
    constructor(
        uint256 _rate,
        address _wallet, 
