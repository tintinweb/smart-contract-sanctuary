...
contract GENEOSSale is DSAuth, DSExec, DSMath {
    ...
    uint     public  numberOfDays = 5;        // Number of windows except last
    uint     public  startTime;                 // Time of window 1 opening
    uint     public  finalWindowTime = startTime + (numberOfDays * 5 minutes);           // Time of window 176 opening
    uint     public  finishTime = finalWindowTime + 20 minutes;
