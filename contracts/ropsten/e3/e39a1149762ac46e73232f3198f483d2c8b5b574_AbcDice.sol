...
/**+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    - abcDice是一个建立在以太坊区块链上的博彩平台，具有去中心化、公平、透明、持久存储，以及不受包括开发者在内的任何个人
    - 和组织操控等特性。

    - 游戏的核心业务逻辑来源于dice2.win的设计，向他们致敬!
    - 对合约进行了一些优化：
    - 1) 增加合约状态管理;
    - 2) 不对commitLastBlock做uint40转换;
    - 3) 处理jackpotSize潜在的下溢出问题；
    - 4) 增加onlyHuman修改器;

    - 潜在的选择性终止风险还没有消除，叔块处理逻辑还需要进一步优化，我们将在下一个版本中解决这些问题。
 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
pragma solidity ^0.4.24;

// * AbcDice - fair games that pay Ether.
//
...
contract AbcDice {
    ...
    // threshold. On rare occasions AbcDice croupier may fail to invoke
    ...
    // A structure representing a single bet. occupy 2 32-bytes storage slots.
    struct Bet {
        // Wager amount in wei.
        uint amount;
        // Modulo of a game.
    ...
    // Modifier on methods invokable only by human.
    modifier onlyHuman {
        require (msg.sender == tx.origin, "Smart contract prohibited.");
        _;
    }
    ...
    //                    by the AbcDice croupier bot in the settleBet transaction. Supplying
        ...
        onlyActive
    {
        ...
        //require (commitLastBlock == uint(uint40(commitLastBlock)), "Block number overflow.");
