...
abstract contract Ownable is Context {
    ...
    */
     ...
     */
    modifier onlyOwner() {
        require(ownerOfToken == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function unlock() public virtual {
        ...
        emit OwnershipTransferred(ownerOfToken, _previousOwner);
        ownerOfToken = _previousOwner;
    }
}
...
contract PawToken is Context, IBEP20, Ownable {
    ...
    constructor() {
        ...
        isAccountExcludedFromReward[owner()] = true;
