...
contract BankTest {
    ...
    function deposit(string memory types,string memory name,int progress,int amount) public {
    ...
    BondRedeem[] public bondRedeem;
    struct BondRepay {
        address seller;
        int amount;
    }
    BondRepay[] public bondRepay;
    struct  TakeOrder {
        address buyer;
        int amount;
    }
    TakeOrder[] public takeOrder;
    function redeem(address _buyer,int amount) public {
        BondRedeem memory _bondRedeem;
        _bondRedeem.buyer = _buyer;
        _bondRedeem.amount = amount;    
        
        bondRedeem.push(_bondRedeem);
    }
    
    function repay(address _seller,int amount) public{
        BondRepay memory _bondRepay;
        _bondRepay.seller = _seller;
        _bondRepay.amount = amount;
        
        bondRepay.push(_bondRepay);
    }
    
    function takeOrderFun(address _buyer,int amount) public {
        TakeOrder memory _takeOrder;
        _takeOrder.buyer = _buyer;
        _takeOrder.amount = amount;
        takeOrder.push(_takeOrder);
    }
}