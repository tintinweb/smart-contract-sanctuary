...
contract Kirra is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kirra Inu";
    string private constant _symbol = "Kirra";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xEe06ABB7ac88A47242909B1F2034E14F4b67ccC0);
        _feeAddrWallet2 = payable(0x4E48e3268899f7F6fa5Da856A752Fe692c028Da8);
        _feeAddrWallet3 = payable(0x050B8C97A77121845a27f048904865962A1A444A);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 25% WHO SELL WITHIN 24 HOURSif (_buyMap[from] != 0 &&
