...
contract HPoolFactory is PausableUpgradeable, HordUpgradable {
    ...
    event HPoolImplementationChanged(address _newImplementation);
    event HPoolManagerSet(address _hPoolManager);
    event HPoolDeployed(address _hPoolAddress);
        ...
        initializer
    {
        ...
        require(_hPoolImplementation != address(0), "HPool implementation can not be 0x0 address.");
    ...
    */
    ...
    onlyHordCongress
    {
        ...
        hPoolImplementation = _hPoolImplementation;
        emit HPoolImplementationChanged(_hPoolImplementation);
    }

    /**
        * @notice          Function to initialize hPool contract, only callable by HPoolManager.
        * @dev             Function uses clone factory pattern
     */
