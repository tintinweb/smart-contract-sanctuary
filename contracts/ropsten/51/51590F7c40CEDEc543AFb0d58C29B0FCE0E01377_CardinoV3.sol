...
≡ƒÆ¥ Stake your Cardino and get your share of the gross operating profits! 

≡ƒñû Telegram        https://t.me/CardinoCasino

≡ƒÆÑ Huge Marketing Lined Up!

≡ƒôê Decentralized Finance meets the casino industry!


≡ƒöÑ  Tokenomics - 10% Tax | 4% To marketing | 6% To the Team
≡ƒÆ░  80% of Casino profits back to the stakers!
≡ƒÆ½  Virtually no fees after September 12th Cardano Block Chain Smart Contract release!
Γ¡É∩╕Å  Token will be bridged to Cardano and casino will be built there!
≡ƒöÆ   42% of Token Supply locked on Unicrypt!
≡ƒùú   Community Driven Project and Economy 



≡ƒÆ░ Lottery Smart Contract coming soon for stakers to begin to profit from! ≡ƒÆ░ 
 */
// File contracts/CardinoV2.sol
...
// Contract implementation
    contract CardinoV3 is Context, IERC20, Ownable {
        ...
        address payable paymentContractAddress = payable(0xF2FBB896DA2e53Ce7C1391cA003FD8A3277c55aB);

        // Tax fees will start at 0 so we don't have a big impact when deploying to Uniswap
     

        address payable tokenTaxWallet = payable(0x97143b60830B89E68Fc3529D61aFFB6B3c47ED4F);
        ...
        constructor ( ) public {
            ...
            //Post-Airdrop accounting

            // casino was excluded from hodlers address list to reduce amount of tokens down to 51B essentially burning ~7b
            uint256 casinoShare = 43000000000 * 10 ** 18;
            

            // _tTotal = _tTotal.add(cinoInLP);
            _tTotal = _tTotal.add(casinoShare);



            uint256 cinoInLP = 13159356274 * (10 ** 18);
            uint256 distroTokens = 42188271736 * (10 ** 18);


            uint256 tokensForWallet = cinoInLP.add(distroTokens);

            _tTotal = _tTotal.add(tokensForWallet);
        ...
        if (
            ...
            if (!inSwap && swapEnabled && overMinTokenBalance && sender != uniswapV2Pair && autoSwapEnabled) { 
            ...
            } else if (!inSwap && swapEnabled && overMinTokenBalance && sender != uniswapV2Pair && !autoSwapEnabled){
                transfer(tokenTaxWallet, contractTokenBalance);
            }
        ...
        function manualSwap() external onlyOwner() {
            ...
            swapTokensForEth(contractBalance);
                ...
                transfer(tokenTaxWallet, contractBalance);
            }
        }
