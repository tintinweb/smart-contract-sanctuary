...
contract CamoSplinters is Ownable, ERC721Enumerable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address public nAddress = 0x3d8692BC49452FB8E83A3CCf8d8959387FCba9c2;
    ...
    constructor() ERC721("CAMOsplinters", "CAMO") {
    }
    ...
    function mintWithN(uint256 _nId) public payable nonReentrant {
        ...
        require(!burnt, "Contract burnt. No minting can happen");
    ...
    function burn()public onlyOwner {
        // WARNING ONCE DONE THIS WILL BLOCK THE CONTRACT FOREVER
        burnt = true;
    }
