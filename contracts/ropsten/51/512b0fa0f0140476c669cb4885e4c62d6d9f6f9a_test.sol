...
contract test is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "testinu";                                           // name
    string private _symbol = "testinu";                                            // symbol
    ...
    uint256 public _MaxPerWallet = _maxTxAmount * 2;
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0x1d2A19F0281067E9351530DA66E7c21140B13996);
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // 0xF491e7B69E4244ad4002BC14e878a34207E38c29 // 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from != owner() && to != owner())
            ...
            require(contractBalanceRecipient + amount <= _MaxPerWallet);
