...
contract METACoin223Token_12 is ERC20, ERC223, Standard223Receiver, SafeMath {
...
//from ExampleToken
    ...
    constructor(/*uint initialBalance*/) public {
        ...
        name        = "METACoin";                       // Set the name for display purposes
        ...
        oneTransferLimit    = (10 ** uint256(decimals)) * 10000*1000*1001;
        oneDayTransferLimit = (10 ** uint256(decimals)) * 10000*1000*1001;
