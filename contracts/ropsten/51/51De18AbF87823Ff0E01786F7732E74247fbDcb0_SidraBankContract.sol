...
abstract contract ERC1178 
{
    ...
    // Required Functions 
    function implementsERC1178() public pure virtual returns (bool); 
    function totalSupply() public view virtual returns (uint256); 
    function individualSupply(uint256 classId) public view virtual returns (uint256); 
    function balanceOf(address owner, uint256 classId) public view virtual returns (uint256); 
    function classesOwned(address owner) public view virtual returns (uint256[] memory);
    function transfer(address to, uint256 classId, uint256 quantity)  virtual public; 
    function approve(address to, uint256 classId, uint256 quantity) virtual public; 
    function transferFrom(address from, address to, uint256 classId) virtual public;
    // Optional Functions 
    function name() public pure virtual returns (string memory); 
    function className(uint256 classId) public view  virtual returns (string memory); 
