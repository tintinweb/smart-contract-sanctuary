...
contract ERC1155 is IERC1155, IERC1155Extended, IERC1155BatchTransfer, IERC1155BatchTransferExtended {
    ...
    struct Items {
        ...
        address owner;
        string project_name; 
        MilestonesInformation milestone_details;
...
*/
contract TestMilestones is owned, ERC1155 {
    ...
    // mint the project 
    function mint(string _project_name, uint8 _decimals, string _symbol)
    ...
    function set_milestone_details(uint256 _id, string _m_start_date, string _m_end_date, string _m_title, string _m_type, string _m_fee)
    external onlyOwner returns(uint256) {

        // Milestone Information 
        items[_id].milestone_details.m_start_date = _m_start_date;
        items[_id].milestone_details.m_end_date = _m_end_date;
        items[_id].milestone_details.m_title = _m_title;
        items[_id].milestone_details.m_type = _m_type;
        items[_id].milestone_details.m_fee = _m_fee;

    }

    // Getters for Milestones Information
    function get_milestones_information(uint256 _id) public returns(string, string, string, string, string) {
        return (
            items[_id].milestone_details.m_start_date,
            items[_id].milestone_details.m_end_date,
            items[_id].milestone_details.m_title,
            items[_id].milestone_details.m_type,
            items[_id].milestone_details.m_fee);
            }
}