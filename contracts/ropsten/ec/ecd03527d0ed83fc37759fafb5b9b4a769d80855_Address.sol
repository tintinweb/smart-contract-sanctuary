...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0xC7027D23D723811765D6ca1e1E42966F471b5a2d;
...
contract EthereumGOAT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Ethereum GOAT";
    ...
    mapping(address => uint256) public developerLock;
    ...
    address charityAddress = 0x36a251471f624Ebb66C681ACdca9E5EC23f6b30E; // charity address
    ...
    function setCharity(uint256 amount) external onlyOwner {
        charityFee = amount;
    }
