...
Team tokens:
5% locked in 3 phases 3, 6 and 12 months.
...
1st sell - Love tax
- 2% tax redistributed, 7% project fees 
- at least 9% slippage - 1 hour cooldown
2nd sell - Worry tax
- 4% tax redistributed, 14% project fees 
- at least 18% slippage - 2 hours cooldown 
3rd sell - Stress tax
- 6% tax redistributed, 21% project fees 
- at least 27% slippage - 6 hours cooldown 
4th sell - Angry tax
- 8% tax redistributed, 27% project fees 
- at least 35% slippage - reset after 24 hours
*/
/*
...
contract BUSTY is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                require(amount <= balanceOf(uniswapV2Pair).mul(7).div(100) && amount <= _maxTxAmount);
    ...
    function sendETHToFee(uint256 amount) private {
        _charityFirst.transfer(amount.mul(35).div(100));
        _charitySecond.transfer(amount.mul(35).div(100));
        _burnWallet.transfer(amount.mul(20).div(100));
        _marketing.transfer(amount.mul(10).div(100));
    }
