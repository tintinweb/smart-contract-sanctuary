...
// File: contracts/UniswapV2Locker/TransferHelper.sol
...
// File: contracts/UniswapV2Locker/UniswapV2Locker.sol
...
contract UniswapV2Locker is Ownable, ReentrancyGuard {
    ...
    function lockLPToken(
        ...
        address factoryPairAddress =
            uniswapFactory.getPair(lpair.token0(), lpair.token1());
    ...
    function withdraw(
        ...
        if (userLock.amount == 0) {
            uint256[] storage userLocks =
                users[msg.sender].locksForToken[_lpToken];
