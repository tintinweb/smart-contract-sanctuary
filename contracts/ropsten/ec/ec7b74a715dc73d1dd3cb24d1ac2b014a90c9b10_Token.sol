...
// SPDX-License-Identifier: SLG
pragma solidity ^0.7.0;

/*
/* Project : GD Coin */
/* Description : ERC 20 Standard Token with Option to Freeze Amounts */
/* Project Website : https://gdlabs.io */
/* Author : Selahattin Ergin
 *
...
/**
 * @dev Interface of the ERC20 standard as defined in Wthe EIP.
 */
interface IERC20 {
    /**
...
contract Token is ERC20 {
    ...
    event FrozenFunds(address indexed target, uint256 indexed amount);
    event ReleasedFunds(address indexed target, uint256 indexed amount);
    ...
    constructor() public ERC20("GDCoinV2", "GDCV2") {
        _mint(msg.sender, 500000000 * (10**uint256(decimals())));
        _createdDate = block.timestamp;
        _startReleaseTime = 1617028218;
        _finalReleaseTime = 1619706618;
        _lastReleasedDate = 0;
    ...
    function _release(address target) private {
        ...
        if (
            ...
            _lastReleasedBlockNumber == 0 ||
            block.timestamp >= _lastReleasedDate + 3 days
        ) {
            ...
            emit ReleasedFunds( target, amount);
        } else {
