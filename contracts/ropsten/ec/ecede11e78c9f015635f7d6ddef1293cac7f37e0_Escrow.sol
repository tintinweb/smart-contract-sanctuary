...
contract Escrow {
    ...
    function addProduct(address seller, string memory ProductName, uint ProductId, uint ProductPrice, uint ProductQuantity, uint temp, uint humid) public onlySeller returns(bool){
    ...
    function createOrder(address buyer, uint productId) public onlyBuyer returns(bool){
        require(productId != 0, "Invalid Id");
