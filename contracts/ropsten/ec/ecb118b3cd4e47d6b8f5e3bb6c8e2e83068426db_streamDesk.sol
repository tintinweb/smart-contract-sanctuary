...
byte constant public coinReturn         = 0x07;
    ...
    event newDeal( bytes32, bytes32, bytes32);
    ...
    function addDeal(uint _value, bytes32 _seller, bytes32 _buyer, uint _commission, bytes32 _hashDeal, bytes32 _temporaryWallet) public  {
    ...
    function getDealData(bytes32 _hashDeal) public view returns(uint256, uint256,bytes32,bytes32, byte, uint256,  bytes32) {
