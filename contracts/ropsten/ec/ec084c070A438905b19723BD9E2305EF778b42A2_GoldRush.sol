...
contract GoldRush is Context, IERC20, Ownable {
    ...
    address payable private _GoldRushDev;
    address payable private _GoldTax;
    ...
    constructor(address payable marketfund, address payable goldtax, address payable goldrushdev) {
        _Marketingfund = marketfund;
        _GoldRushDev = goldrushdev;
        _GoldTax = goldtax;
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_Marketingfund] = true;
        _isExcludedFromFee[_GoldTax] = true;
        _isExcludedFromFee[_GoldRushDev] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _GoldTax.transfer(amount.div(2));
    }
    ...
    function setSwapEnabled(bool enabled) external {
        require(_msgSender() == _GoldRushDev);
        swapEnabled = enabled;
    }
