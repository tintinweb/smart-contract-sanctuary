...
contract SooCoin19 is Context, IERC20, Taxable {
    ...
    constructor () {
        ...
        ILO.init(100000000000000000, 15000, 15000, 75000, m_ILOPublic);
        initTax();
    ...
    function _isExchangeTransfer(address _sender, address _recipient) private view returns (bool) {
        return _sender == m_UniswapV2Pair || _recipient == m_UniswapV2Pair && (_recipient != m_ILOServiceAddress && _sender != m_ILOServiceAddress);
    }
