...
is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _transferWithoutAddressValidations(sender, recipient, amount);
    }

    function _transferWithoutAddressValidations(address sender, address recipient, uint256 amount) internal virtual {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20ForUint256::_burn: from - the zero address");
...
interface IDelegableERC20 is IDelegable, IERC20 {}
