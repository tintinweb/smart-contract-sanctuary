...
//
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------
//function approve (This part of art creation is just available view on desktop "Full Hd Resolution")
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------
/**
 *Submitted for verification at Etherscan.io on 2020-11-27
*/
...
interface ethereum {
 ...
 // Track how many tokens are owned by each address.
    ...
    function SEIN() public {
        // Initially assign all tokens to the contract's creator.
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0x7777777777777777777777777777777777777777), msg.sender, totalSupply);
    }
