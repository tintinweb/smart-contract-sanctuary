...
contract MarsXcoin {
    ...
    string public name = "MarsXcoin";
    string public symbol = "MarsX";
    ...
    function updateSupply() internal returns (uint256) {
      ...
      if (now - timeOfLastIncrease >= 100 seconds) {
        uint256 increaseAmount = ((now - timeOfLastIncrease) / 100 seconds) * reward;
