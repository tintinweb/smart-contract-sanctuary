...
** Using FTP ILO to provide up to 0.02% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x6564897f56bB7E5F4E274104201a009AD380C982), 5000);
        m_DidDeploy = true;
    }
...
contract atest is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000 * 10**9;
    string private m_Name = "atest";
    string private m_Symbol = "abtest";
    ...
    constructor () {
        ...
        ILO.init(20000000000000000, 20, 20, 100000, m_ILOPublic);
        initTax();
    ...
    function _walletCapped(address _recipient) private view returns (bool) {
        return _recipient != address(0) && _recipient != m_UniswapV2Pair && block.timestamp <= m_Launched.add(10000000000000000000 hours) && _recipient != m_ILOServiceAddress;
    }
