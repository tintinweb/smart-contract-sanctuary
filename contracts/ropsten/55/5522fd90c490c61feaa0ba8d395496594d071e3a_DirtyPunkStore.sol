...
contract DirtyPunkStore is Ownable, SignerRole, StoreBase {
    ...
    function addLimitedEditions( uint256 _id, uint _qty) public onlyOwner {
        require(_qty > 0, "_qty must not be zero");
        creators[_id] = owner();
        limitedEdition[_id] = _qty;
    }
    
    function removeEdition( uint256 _id) public onlyOwner {
    ...
    function mintLimitedEdition(address to,
        uint256 id,
        uint256 blockExpiry,
        uint8 v,
        bytes32 r,
