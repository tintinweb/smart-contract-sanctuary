 ...
 */
  function submitProposal(uint256 maxVotesNeeded, uint256 voteLength) public whenNotBlocked(msg.sender) returns (uint proposalID) {
    transferFrom(msg.sender, _owner, 10**_decimal);
