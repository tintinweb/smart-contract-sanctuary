...
With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, this contract was designed to reward holders and discourage dumping.
...
contract CactusMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"CactusMoon";
    string private constant _symbol = "CACT";
