...
uint256 _ETHConversionRateInCents,
...
_escrow(address(nonFungibleContract), _tokenId);
...
bids[_auctionId][msg.sender].amount = msg.value;
bids[_auctionId][msg.sender].amountEurCents = msg.value * a.ETHConversionRateInCents / 1 ether;
...
// 3. Interaction
_transfer(a.lowestBidder, a.tokenId);
...
contract InvoluteDownwardNFTAuction is Pausable, Ownable, InvoluteBaseAuctionInteraction {

constructor(address _beneficiary, address _nftAddress) {
