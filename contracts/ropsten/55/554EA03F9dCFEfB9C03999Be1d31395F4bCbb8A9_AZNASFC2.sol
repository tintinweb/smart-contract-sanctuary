...
contract AZNASFC2 is ERC721, ERC721Enumerable, Ownable {
    ...
    function isValidData(uint256 _mintPrice, string memory _address, bytes memory sig) public view returns(bool){
        bytes32 hashedAddress = keccak256(abi.encodePacked(_mintPrice, _address));
