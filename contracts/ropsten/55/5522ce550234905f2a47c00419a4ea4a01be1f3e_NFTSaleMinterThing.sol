...
contract NFTSaleMinterThing is IERC721, Ownable, Functional {
    ...
    constructor() {
        ...
        _founder = 0xA02b2E3f7b2CCaB3F27A4D2E8B69f166E2d8D243; // The Founder
        _dev = 0x3166d83B39B8F405Cf4D571df06D68Fd45d8DD7E; // The Developer
        _artist = 0x15982ec2F53d1C5567190002DCEAa997F50eF005; // The artist
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == NFTSaleMinterThing.onERC721Received.selector;
    }
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 foundercash = (address(this).balance * 33) / 100;
        uint256 artistcash = (address(this).balance * 33) / 100;
 
        (bool success, ) = _founder.call{value: foundercash}("");
        require(success, "Transaction Unsuccessful");
        (success, ) = _dev.call{value: devcash}("");
        require(success, "Transaction Unsuccessful");
        (success, ) = _artist.call{value: artistcash}("");
        require(success, "Transaction Unsuccessful");
    }
