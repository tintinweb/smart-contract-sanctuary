...
/**
 * @title DORO COIN ERC20 Token Contract
 * @author MIKE LARY DRAW
 * @dev Implementation of the Ocean Token.
 */
contract MIKELARRYDRAW is Ownable, ERC20Pausable, ERC20Detailed, ERC20Capped {
    
    using SafeMath for uint256;
    
    uint8 constant DECIMALS = 18;
    uint256 constant CAP = 500000000000000000000000000;
    uint256 TOTALSUPPLY = 500000000000000000000000000;
    ...
    public
    ERC20Detailed('DORO', 'MLD', DECIMALS)
