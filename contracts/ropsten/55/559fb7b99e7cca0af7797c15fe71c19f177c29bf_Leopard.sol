...
contract Leopard is Context, IERC20, Ownable {
    ...
    string private _name = "Leopard Finance";
    ...
    uint256 public _taxFee = 0;             // means 6% which distribute to all holders reflection fee
    uint256 public _tokenFee = 0; 
    uint256 public _BuyBackFee = 1000;
    uint256 public _liquidityFee = 0;      // means 2% add liquidity on each buy and sell
    uint256 public _burnFee = 0;           // means 3% it menas burn

    

    address tokenFeeAddress = 0xe5D2e109869b3791B9Fd5a2806085765AeB2690D;     // token wallet
    address marketingAddress = 0xe5D2e109869b3791B9Fd5a2806085765AeB2690D;   //bnb wallet
