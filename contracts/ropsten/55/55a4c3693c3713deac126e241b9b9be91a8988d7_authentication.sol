...
contract authentication{
    ...
    */
    ...
    returns(bool flag){
        ...
        if(decode(hash_temp,Sign_TS) != msg.sender)
        return false;
    ...
    //--------------------------------PPT12页--------------------------------//
     ...
     新建一个任务，返回值bool
     */
    function boardcast_task(uint b_task_id,uint b_tuav_id ,uint b_cerdit_req,uint b_msg,uint T,bytes Sign) 
    returns(bool flag)
    {
       bytes32 hash_temp;
