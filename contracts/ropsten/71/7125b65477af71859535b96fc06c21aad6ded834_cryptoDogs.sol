...
pragma solidity >=0.4.16 <0.7.0;
  ...
  contract ERC721MetadataAttributes {
           
    string private _color;
 
    function color() external view returns(string) { return _color; }

    function color(string value) public { _color = value; }
     
  }  
  
  contract cryptoDogs is ERC721, ERC721Metadata, Ownable, ERC721MetadataAttributes {
  
    using SafeMath for uint256;
    string public name = "cDogs";
    string public symbol = "CDG";
    uint256 private _totalSupply;
    uint256 private _nextTokenId;
    address public owner = address(0xd325765C388CB205a03556EAB331ffA80Acf5130);
    constructor() ERC721Metadata(name, symbol) public Ownable(owner) 
    {
