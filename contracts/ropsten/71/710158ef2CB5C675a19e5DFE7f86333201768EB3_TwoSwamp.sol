...
contract TwoSwamp is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("SwampWater", "TWOSWAMP") {    	
    ...
    function _transfer(
        ...
        if(takeFee && !swapping && !_isExcluded[from] && !_isExcluded[to]) {
