...
contract ERC20BuySellDemo2021Jun10
{
    ...
    function PurchaseTokens(uint256 deposit) public  returns(uint256 calculatedTokens) 
    {
        return calculatedTokens = etherToToken(deposit);
    }
    
    function SellTokens(uint256 tokens) public  returns(uint256 calculatedEthers) 
    {
        return calculatedEthers = etherToToken(tokens);
    }
    
    
    function etherToToken(uint256 incomingEther) public returns(uint256)  //tokensCalculated  
    {
        ...
        if (AmountEnteredInETH > 0)
                {
                    ...
                    if (TokensCurrentLevel == 1)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .00027 ether);                            
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 2)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .0003 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 3)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .000367 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 4)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .000497 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 5)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .000756 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 6)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .00127 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 7)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .00124 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 8)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .00387 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 9)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .0073 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 10)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * .0142 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 11)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 0.0281 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 12)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 0.0502 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 13)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 0.0945 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 14)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 0.1831 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 15)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 0.3602 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 16)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 0.7144 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 17)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 1.245 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 18)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 2.308 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 19)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 4.434 ether);
                    ...
                    if (AmountInEtherLeftForNextLevel > 0 && TokensCurrentLevel == 20)
                    {
                        ...
                        if (AppproxNoOfTokensToSend > NoOfTokensAvailableAtCurrentLevel)
                        {
                            ...
                            AmountInEtherLeftForNextLevel =
                                AmountInEtherLeftForNextLevel - (NoOfTokensAvailableAtCurrentLevel * 8.865 ether);
    ...
    function tokenToEther(uint256 tokenToSell) public returns(uint256)  //EthersCalculated
    {
        ...
        if (NoOfTokensEnteredForSale > 0)
        {
            ...
            uint256 NoOfTokensAvailableAtCurrentLevel = 0;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 19)
                    {
                        ...
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser = 
                                ActuallEthToSendToUser+NoOfTokensAvailableAtCurrentLevel * 4.434 ether;
                        ...
                        {
                            ActuallEthToSendToUser = 
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 4.434 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 18)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 2.308 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 2.308 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 17)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 1.245 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 1.245 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 16)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.7144 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.7144 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 15)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.3602 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.3602 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 14)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.1831 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.1831 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 13)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.0945 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.0945 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 12)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.0502 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.0502 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 11)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.0281 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.0281 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 10)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.0142 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.0142 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 9)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.0073 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.0073 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 8)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.00387 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.00387 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 7)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.00124 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.00124 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 6)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.00127 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.00127 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 5)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.000756 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.000756 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 4)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.000497 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.000497 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 3)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.000367 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.000367 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 2)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.0003 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.0003 ether;
                    ...
                    if (NoOfTokensEnteredForSale > 0 && TokensCurrentLevel == 1)
                    {
                        ...
                        if (NoOfTokensEnteredForSale > NoOfTokensAvailableAtCurrentLevel)
                        {
                            //Recalculate Actuall No Of ETH To Send
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensAvailableAtCurrentLevel * 0.00027 ether;
                        ...
                        {
                            ActuallEthToSendToUser =
                                ActuallEthToSendToUser + NoOfTokensEnteredForSale * 0.00027 ether;
