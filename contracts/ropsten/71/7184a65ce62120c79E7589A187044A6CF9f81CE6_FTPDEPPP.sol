...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x8BEc16BD1bB27819dB5aFF7c665Cc1c7754ADe3C), 5000);
        m_DidDeploy = true;
    }
...
contract FTPDEPPP is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "FTPDEPPP";
    string private m_Symbol = "FTPPPP";
