    ...
    UUPSUpgradeable
{
    ...
    string public GOVERNANCE_RULES;
    ...
    function initialize() public initializer {
        ...
        NFT01.SIGNATURE = "verse";
        NFT02.SIGNATURE = "verse";
        NFT03.SIGNATURE = "verse";

        NFT01.ORIGINAL_IMAGE = "EnderecoParaFotoEmAltaNaNuvem";
        NFT02.ORIGINAL_IMAGE = "EnderecoParaFotoEmAltaNaNuvem";
        NFT03.ORIGINAL_IMAGE = "EnderecoParaFotoEmAltaNaNuvem";
        ...
        LEGAL_CONTENT = "CONTEUDO LEGAL";

        GOVERNANCE_RULES = "REGRAS DE GOVERNANCA";
