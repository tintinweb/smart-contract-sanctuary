...
abstract contract NoBSReflections is Ownable {
    ...
    INoBSRouterV1 public noBSRouter = INoBSRouterV1(0xd95A1a4443E65848cD433E772F3C0fBE250f3692);
    ...
    function updateReflectionRouter(address newRouterAddress) external onlyOwner {
        noBSRouter = INoBSRouterV1(newRouterAddress);
        init();
    }
