...
contract TetsuInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TETSUV3";
    ...
    constructor () {
        _marketingFeeAddr = payable(0x001da4f27b8e5B75AA5621a77307cf0BC6d98381);
        _devFeeAddr = payable(0x2c5B9dd42d0510C43f1d6d672bD56A7DE0716c91);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            require(!bots[from], "Flagged as bot!");
