...
contract SooCoin04 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin04";
    string private m_Symbol = "SOO04";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xcC04D1d9A4e70Ce391c17De4cF4B39eaEe874FFF);
    ...
    constructor () {
        ...
        ILO.init(200000000000000000, 20000, 20000, 75000, m_ILOPublic);
        initTax();
