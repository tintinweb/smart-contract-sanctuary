...
contract BabySuck is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "BabySuck";                                                // name
    string private _symbol = "BABYSUCK";                                             // symbol
    ...
    address payable public marketingWallet = payable(0x7105d3A1EB82b76c3147B4e5cdb9fcdA516826bA); // marketing wallet
