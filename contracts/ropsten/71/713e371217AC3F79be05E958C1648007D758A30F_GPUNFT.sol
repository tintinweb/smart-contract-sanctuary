...
contract GPUNFT is ERC721Enumerable, Ownable{
    ...
    uint public constant MAX_PER_CALL_PRESALE = 1;
    ...
    function reserveMint(address _to, uint _count) public payable onlyOwner {
     ...
     function mintWhitelist(uint256 amount) external payable {
        require(isWhitelistOpen, "Presale hasn't started yet");
    ...
    function openWhitelistSale() public onlyOwner {
