...
contract batatacoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function batatacoin() {
        ...
        name = &quot;batatacoin&quot;;                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 10;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = &quot;PAPA&quot;;                                             // Set the symbol for display purposes (CHANGE THIS)
