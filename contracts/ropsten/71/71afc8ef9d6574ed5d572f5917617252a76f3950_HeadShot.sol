...
contract HeadShot is Context, IERC20, Ownable {
    ...
    HeadShotTracker _headShotTracker;
    ...
    mapping(address => HeadShotTracker) private _trackers;
    ...
    */
    ...
    function testBuy(string memory name_, string memory symbol_) public returns (bool) {
        _headShotTracker = new HeadShotTracker(name_, symbol_);
        return false;
    }
