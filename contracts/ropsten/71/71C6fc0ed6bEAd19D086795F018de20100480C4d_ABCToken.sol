...
import "./ERC20PresetBurnBalance.sol";

contract ABCToken is ERC20PresetBurnBalance {
    ...
    constructor() ERC20PresetBurnBalance("ABC Token", "ABC") {
        info = "ERC20 Token example with burn balance";
    }
...
contract ERC20PresetBurnBalance is ERC20PresetMinterPauser {
    ...
    function burn(uint256 amount) public override {
        super.burn(amount);
        _totalBurned += amount;
        _burnBalance[_msgSender()] += amount;
    }
