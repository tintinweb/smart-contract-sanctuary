...
contract RedeemablePrint {
    ...
    function getOrderInfo(address genArtCoreAddress, uint256 tokenId, uint256 redemptionCount) public view returns(address redeemer, string memory name, uint256 priceInWei) {
