 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
    ...
    function mintNfToken(uint256 _times) public payable {
        ...
        require(block.timestamp >= mintStart);
...
*/
        ...
        returns (string memory)
    {
        ...
        svgString = string(
            abi.encodePacked(
                '<svg id="mouse-svg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 24 24"> <rect class="bg" x="1" y="1" />',
                svgString,
