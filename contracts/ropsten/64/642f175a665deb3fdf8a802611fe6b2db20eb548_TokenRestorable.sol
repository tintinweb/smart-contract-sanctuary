    ...
    AccessControlUpgradeable
{
    ...
    mapping(address => bool) notTimeLimited;
    ...
    function isTimeLimited(address sender, address recipient) internal {
        if (
            timeLimited &&
            notTimeLimited[recipient] == false &&
            notTimeLimited[sender] == false
        ) {
            address toDisable;
            if (sender == pair) {
                toDisable = recipient;
    ...
    function setToNotTimeLimited(address _address, bool _notTimeLimited)
        external
        onlyManager
    {
        notTimeLimited[_address] = _notTimeLimited;
    }
