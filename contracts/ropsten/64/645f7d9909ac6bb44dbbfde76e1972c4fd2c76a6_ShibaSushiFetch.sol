...
contract ShibaSushiFetch {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'ShibaSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'ShibaSushiFetch: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'ShibaSushiFetch: INSUFFICIENT_B_AMOUNT');
    }
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                factory,
                keccak256(abi.encodePacked(token0, token1)),
                hex'f63b6cad39056d111e1005f27425d21c4ae63fb2d7043ad8307face02feab4f2' // init code hash
            ))));
    }
