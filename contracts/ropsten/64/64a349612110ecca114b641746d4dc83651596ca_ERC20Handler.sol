...
interface IDepositExecute {
    /**
        ...
        @param amount Amount of the deposit.
     */
    function deposit(bytes32 resourceID, address depositor, uint amount) external returns (bytes memory);

    /**
        @notice It is intended that proposals are executed by the Bridge contract.
        @param amount Amount Of the Proposal
     */
    function executeProposal(bytes32 resourceID, uint amount, address recipientAddress) external;
}
...
contract HandlerHelpers is IERCHandler {
    ...
    function withdraw(address tokenAddress, address recipient, uint amount) external virtual override {}
