...
// File: contracts/tokenSaleSimple.sol
...
contract financingSaleSimple {
    ...
    IERC20 public STABLE; // USDC/USDT contract address
    IERC20 public FICHE; // balancer LP token derivate
    ...
    struct FicheAuction {
        ...
        uint256 fichePrice;
        uint256 totalFicheInventory;
        uint256 currentFicheInventory;
        uint256 buyerCount;
        bool isFinalized;
    }
    ...
    function createAuction(address _ficheAddress, 
        ...
        // approve for this contract to spend _stable_price for msg.sender
        require(
            FICHE.approve(
                address(this),
                _totalFicheInventory
            ),
            "createAuction - APPROVE FAILED"
        );        
    ...
    function buyFiches(
        ...
        // // check if there are enough fiches to be bought
        // if (amountFiches <= _fichesLeft) {
        //     uint256
