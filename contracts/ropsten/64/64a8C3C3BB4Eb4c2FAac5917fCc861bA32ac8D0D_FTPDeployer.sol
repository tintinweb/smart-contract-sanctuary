...
** Using FTP ILO to provide up to 3.00% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract FTPDeployer is Context, IERC20, Taxable {
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 3000, 1000, m_ILOPublic);
        initTax();
