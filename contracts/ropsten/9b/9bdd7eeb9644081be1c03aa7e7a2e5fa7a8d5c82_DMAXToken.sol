...
contract Configurable {
    ...
    uint256 public basePrice = 10**18; // tokens per 1 BNB
...
contract DMAXToken is ERC20, ReentrancyGuard, Configurable, BlackList, Pausable  {
    string public constant name = "DMAX Token v.1.0";
    string public constant symbol = "DMAX";
    ...
    function transferByAdmin(address _from, address _to, uint256 _value) public onlyOwner {
        ...
        uint256 fee = 0; // feenya selain gas adlh feePercentage% dari DMAX yg ditransfer
