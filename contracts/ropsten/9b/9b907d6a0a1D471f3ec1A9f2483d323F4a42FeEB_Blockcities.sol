...
contract Blockcities is ERC20, ERC20Burnable, Ownable{
    ...
    constructor() 
        ...
        ERC20("Blockcities", "BLKCT", 1000000000, 2) {
    ...
    /** @dev func buyAsset()
     ...
     uint256 feeTokenAmount, uint256 taxTokenAmount, string memory assetTitle, string memory unitNumber)external returns(string memory, string memory) {
