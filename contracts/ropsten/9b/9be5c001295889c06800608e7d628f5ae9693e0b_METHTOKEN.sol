 ...
 * ----------------------------------------------------------------------------
 * 
 * Deployed to : 0xF44C6539194GAAAyYYEd99938CE6ABAFe519C0e8
 * Symbol : METH
 * Name : Meth Token
 * Total supply: 100,000,000
 * Decimals : 18
 * 
 * 2% fee auto dick to the liquidity pool
 * 2% fee cum distribute to all holders
 * 2% fee auto porn
...
/**
ITS NOT AN ADDICTION ITS QUALITY OF LIFE
 */
contract METHTOKEN is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    string private constant _name = "Meth Token";
