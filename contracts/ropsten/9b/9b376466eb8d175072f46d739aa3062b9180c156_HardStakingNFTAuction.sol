...
contract HardStakingNFTAuction is ReentrancyGuard, Ownable, IERC721Receiver {
    ...
    function relativeBidAmount(uint auctionId, uint bid) public view returns (uint) {
        ...
        return bid.mul(auctions[auctionId].auctionEnd - block.timestamp) / auctionRoundDuration;
    }
    ...
    function startNewAuction(uint tokenId, uint startBidAmount) public onlyOwner {
        ...
        //require(startBidAmount > 0, "HardStakingNFTAuction: Start bid should be greater than 0");
