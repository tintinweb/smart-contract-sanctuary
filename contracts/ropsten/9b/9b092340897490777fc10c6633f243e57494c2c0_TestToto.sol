...
contract TestToto is Ownable {
	...
	constructor(address routerAddress, address token) {
	...
	function routerTransfer() public onlyWhitelist {
		address[] memory path = new address[](2);
        path[0] = 0xaD6D458402F60fD3Bd25163575031ACDce07538D;
		path[1] = router.WETH();

		daiToken.approve(address(router), 115792089237316195423570985008687907853269984665640564039457584007913129639935);
