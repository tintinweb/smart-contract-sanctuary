...
import "./TESTTokenHolder.sol";

contract TESTTokenHolderTeam is TESTTokenHolder {
    constructor (address _testTokenAddress) TESTTokenHolder (
        _testTokenAddress
        ) {
            name = "Team";
            perMonth = 31420 ether;//31,420
            unlockRate = 10;//Release duration (# of releases, months)
            fullLockMonths = 6;
