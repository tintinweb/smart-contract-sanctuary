...
contract MultiSig2of3 {
    ...
    event Wrong(address addr1, address addr2);
    ...
    function spend(
        ...
        public
    {
        // This require is handled by generateMessageT"oSign()
    ...
    {
        bytes32 message = messageToRecover(destination, value);
        ...
        address addr2 = ecrecover(
           ...
           emit Wrong(addr1, addr2);
       
        require(_distinctOwners(addr1, addr2), "addr1+addr2");
        ...
        private view returns (bool)
    {
        ...
        require(addr1 != addr2, "addr1+addr2");
        // Check that both addresses are owners
        require(owners[addr1], "addr1+addr2");
        require(owners[addr2], "addr1+addr2");
        return true;
    }
    ...
    // Convert from byte to ASCII of 0-fa
