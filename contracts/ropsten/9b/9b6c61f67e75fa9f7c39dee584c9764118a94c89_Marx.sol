...
contract Marx is IERC20, IERC20Metadata, Context, Ownable{
   ...
   function withdrawDividends(address communist) public isCommunist(msg.sender) {
    ...
    function _updateCommunist(address _communist, address _camrade) private view {
        require(balanceOf(_communist) > 0 || balanceOf(_camrade) == 0);
        _totalCommunists.add(1);
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        _updateCommunist(_msgSender(), recipient);
        return true;
    }
