...
contract SuperFuelReflector is ISuperFuelReflector, LPSwapSupport, AuthorizedListExt {
    ...
    function setRewardToCurrency() external override authorized {
    ...
    function resetToCurrency() private lockTheSwap {
        ...
        if(contractBalance > rewardsToken.decimals())
    ...
    function setRewardToToken(address _tokenAddress) external override authorized {
