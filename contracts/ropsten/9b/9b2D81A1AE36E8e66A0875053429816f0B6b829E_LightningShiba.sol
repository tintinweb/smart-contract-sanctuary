...
// ####################
    ...
    function _swapTokensForUSDC(uint256 _amount) private lockTheSwap {                           // If you want to do something like add taxes to Liquidity, change the logic in this block
        ...
        uint256 _marketingFee = _amount.sub(_devFee);
...
// ######################
    ...
    function setMarketingWallet(address payable _address) external onlyOwner() {                  // Use this function to assign Dev tax wallet
