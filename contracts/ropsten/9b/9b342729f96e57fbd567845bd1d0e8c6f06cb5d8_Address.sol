...
contract Airseeker is ERC721, ERC721Enumerable, Ownable,ERC721Burnable {
    ...
    address  devAddr = 0xef231D7020994aDb50d1BeDC1aa7D4C50d9bCB31;
    ...
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("Airseekertoken", "Airseeker") { 
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 balance = address(this).balance;
        require(balance > 0);
        payable(devAddr).transfer(balance);
    }
