...
contract MoonBoys is ERC721Enumerable, Ownable {
	...
	constructor(string memory baseURI) ERC721("MoonBoys", "MB")  {
		setBaseURI(baseURI);
		t1 = msg.sender;
	}
