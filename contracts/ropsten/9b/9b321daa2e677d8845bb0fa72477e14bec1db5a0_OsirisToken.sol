...
contract OsirisToken is ERC20Upgradeable, AccessControlUpgradeable, OwnableUpgradeable, Pauseable {
    ...
    function initialize(
        ...
        _whitelist[address(this)] = true; // whitelist for swaps
    ...
    */
    ...
    /** @dev liquify
        @param to {address}
    */
    function swap(address to) internal {
        ...
        if (
            ...
            // uint256 halfBNB = contractBalance / 2;
    ...
    /** @dev Swap and liquify
        @param contractTBalance {uint256}
    */
    function swapAndLiquify(uint256 contractTBalance) private lockTheSwap {
        ...
        /** Check allowance */
        if (IERC20(address(this)).allowance(address(this), address(uniswapV2Router)) < 2**255) {
            IERC20(address(this)).approve(address(uniswapV2Router), 2**255);
        }
        ...
        emit SwapTokensForETH(contractTBalance, path);
    }
 ...
 * the pauser.
 */
abstract contract Pauseable is Initializable, ContextUpgradeable {
