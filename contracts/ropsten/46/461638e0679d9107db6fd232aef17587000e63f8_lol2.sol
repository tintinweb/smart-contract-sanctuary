...
/**
 ...
 .----------------.  .----------------.  .----------------.  .----------------.    .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. |  | .--------------. || .--------------. || .--------------. || .--------------. |
| |    _______   | || |      __      | || | ____   ____  | || |  _________   | |  | |   ______     | || |  _________   | || |   ______     | || |  _________   | |
| |   /  ___  |  | || |     /  \     | || ||_  _| |_  _| | || | |_   ___  |  | |  | |  |_   __ \   | || | |_   ___  |  | || |  |_   __ \   | || | |_   ___  |  | |
| |  |  (__ \_|  | || |    / /\ \    | || |  \ \   / /   | || |   | |_  \_|  | |  | |    | |__) |  | || |   | |_  \_|  | || |    | |__) |  | || |   | |_  \_|  | |
| |   '.___`-.   | || |   / ____ \   | || |   \ \ / /    | || |   |  _|  _   | |  | |    |  ___/   | || |   |  _|  _   | || |    |  ___/   | || |   |  _|  _   | |
| |  |`\____) |  | || | _/ /    \ \_ | || |    \ ' /     | || |  _| |___/ |  | |  | |   _| |_      | || |  _| |___/ |  | || |   _| |_      | || |  _| |___/ |  | |
| |  |_______.'  | || ||____|  |____|| || |     \_/      | || | |_________|  | |  | |  |_____|     | || | |_________|  | || |  |_____|     | || | |_________|  | |
| |              | || |              | || |              | || |              | |  | |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' |  | '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'    '----------------'  '----------------'  '----------------'  '----------------' 

                                        
 Telegram: https://t.me/SavePepeOfficial
 Twitter: https://twitter.com/Save_Pepe_
 Website: http://www.savepepe.net/

Our mission is to save all future Pepe's!
...
interface IUniswapV2Router02 {
...
}contract lol2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "lol2";
    string private constant _symbol = "lol2";
    ...
    constructor () {
        _taxWallet = payable(0x1C3168dC0399501121F889eAC08D8A10a9Ec09C9);
        _liqWallet = payable(0x1C3168dC0399501121F889eAC08D8A10a9Ec09C9);
        _liqFee = 8;
        _taxFee = 4;
    ...
    function assalamAlaikum() external onlyOwner() {
        ...
        _maxTxAmount = 476100000000 * 10**9;
        tradingOpen = true;
