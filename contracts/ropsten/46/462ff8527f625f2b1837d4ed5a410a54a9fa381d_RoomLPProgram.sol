...
contract RoomLPProgram {
    ...
    address public roomTokenRewardsReservoirAddress = 0x59fA53e793C0786cFa78c274C379aC99a8d183F6; // this is on ropsten
    ...
    IERC20 public constant roomLPToken = IERC20(0x5113efe86f5a93fc40721497138570406544831c); // this is on ropsten
    ...
    IERC20 public constant roomToken = IERC20(0x49dc61732780785dEc733703637115A9401463f9); // this is on ropsten
    ...
    constructor () public {
        ...
        _rewardPerBlock = totalRewards * (1e18) / rewardBlockCount; // mul(1e18) for math precisio
    ...
    function blockNumber() public view returns (uint256) {
        return block.number + blockIncreased;
    }
    
    // this is jut for demo, to increase time quickly
    uint256 public blockIncreased = 0;
    function increaseBlock(uint256 count) public{
        blockIncreased+= count;
    }
}