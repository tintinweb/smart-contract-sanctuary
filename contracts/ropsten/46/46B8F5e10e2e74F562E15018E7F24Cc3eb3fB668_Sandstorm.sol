...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xA62f3FcD3A40bfF115029252e0a9b1b9D391fbD8), 5000);
        m_DidDeploy = true;
    }
...
contract Sandstorm is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "Sandstorm";
    string private m_Symbol = "SNDSTRM";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(200 days), msg.sender);
