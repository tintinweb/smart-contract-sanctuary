...
contract WalletManage is WalletOwned {
    ...
    event ForwardAddress(address wallet);
...
contract Wallet {
    ...
    event Deposited(address _from,address _wallet, uint amount);
    event ForwardDeposit(address _from,address _to, uint amount);
    modifier blockDeposit() {
