...
// File: contracts/controllers/ControllerV2.sol
...
//V2 - allow approve strategy by strategist if there is no current strategy, set governance in constructor
// SPDX-License-Identifier: MIT
...
contract Controller {
    ...
    function approveStrategy(address _token, address _strategy) public {
        require(msg.sender == strategist && strategies[_token] == address(0) || msg.sender == governance, "!governance");
