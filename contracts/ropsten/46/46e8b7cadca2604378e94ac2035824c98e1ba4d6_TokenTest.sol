...
contract TokenTest is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TTEST3";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x00A5d81be4c49f2D96Da379eDaF3307378460373); // Marketing Address
        
        devAddress = payable(0x882b1A9F8a423552FEA15160Bd5f7a38bB17Fa80); // Dev Address
