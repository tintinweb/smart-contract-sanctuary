...
Twitter: https://twitter.com/wenerc20
...
contract Wen is Context, IERC20 {
    ...
    uint256 private sellTaxMultiplier = 17000;
...
//===============================================================================================================
    ...
    function _finalizeTransfer(address from, address to, uint256 tAmount, bool takeFee) internal returns (bool) {
        ...
        ExtraValues memory values = _getValues(tAmount, takeFee, sellTax);
    ...
    function _getValues(uint256 tAmount, bool takeFee, bool sellTax) internal view returns (ExtraValues memory) {
        ...
        if(takeFee) {
            if (sellTax) {
                values.tFee = (tAmount * _reflectFee) * sellTaxMultiplier / masterTaxDivisor;
                values.tMarketing = (tAmount * _marketingFee) * sellTaxMultiplier / masterTaxDivisor;
            } else {
