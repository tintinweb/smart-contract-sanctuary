...
contract HasContractURI is ERC165 {
    ...
    constructor() public {
        contractURI = "https://api-testnet.grate-estate.com/contractMetadata/myjason.json";
 ...
 */
contract UCAssetToken is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
    ...
    function mint(uint256 tokenId, string memory tokenURI) public {
        require(minters[msg.sender], "UCAssetToken:minter is require");
        Fee[] memory fees=new Fee[](0);
        _mint(msg.sender,tokenId,fees);
