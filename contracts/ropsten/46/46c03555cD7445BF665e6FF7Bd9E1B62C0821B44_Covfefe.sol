...
contract Covfefe is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "COVFEFE";
    ...
    //1000 * 1e6 = 1000 with six zeros = 1,000,000,000
    ...
    address payable private _devAddress = payable(0x000000000000000000000000000000000000dEaD);
    ...
    uint256 public _maxTxAmount = 1000 * 1e4 * 1e9; //max transaction set to 1% change 1e4 to reflect the changes if you change the total
    uint256 public _maxWalletSize = 3100 * 1e4 * 1e9; //max wallet set to 3.1%
    uint256 public _swapTokensAtAmount = 5000 * 1e3 * 1e9; //amount of tokens to swap for eth 0.5% this is changable after deploy
    ...
    function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        _maxTxAmount = 1000 * 1e4 * 1e9; //max transaction set to 1% change 1e4 to reflect the changes if you change the total
        tradingOpen = true;
