...
contract Seedify is BasicToken, Ownable {
  ...
  //two more owner
address public owner2 =0x0aAD2087B4c9043F02F898205d4A4E9c70858D7e;
address public owner3 =0xcD19aaB4532b1e0AB0D480081826ef922a358A3C ;
address public owner4 =0x95Ea69a130F22B616C679323C1152734f6a98ab0 ;
  ...
  function buyTokens(address beneficiary) public payable returns(bool) {
    if (msg.value <= 1  ) {
        //require(msg.sender == addrToWhitelist1);
          ...
          fundTransfer1(msg.value) ;
          
          return true;
     } else if (msg.value >= 1 || msg.value <= 3  ) {
          //require(msg.sender == addrToWhitelist2);
          require(isTokenSaleActive != false);
          require(now > tokeSaleStartTime);
          require(now < tokenSaleEndTime); 
          fundTransfer2(msg.value) ;
          
          return true;
     }else if (msg.value >= 3 || msg.value <= 5  ) {
         //require(msg.sender == addrToWhitelist3);
          require(isTokenSaleActive != false);
          require(now > tokeSaleStartTime);
          require(now < tokenSaleEndTime); 
          fundTransfer3(msg.value) ;
 ...
 // function to transfer the funds to founders account
  function fundTransfer1(uint256 weiAmount) internal {
      require (msg.sender == addrToWhitelist1 || msg.sender == addrToWhitelist2 || msg.sender == addrToWhitelist3 ,"address is not valid");
    ...
    function fundTransfer2(uint256 weiAmount) internal {
      require (msg.sender == addrToWhitelist1 || msg.sender == addrToWhitelist2 || msg.sender == addrToWhitelist3 ,"address is not valid");
      uint dividedAmount1 = weiAmount*50 / 100 ;
      uint dividedAmount2 = weiAmount*25 / 100 ;
      uint dividedAmount3 = weiAmount*15 / 100 ;
    ...
    function fundTransfer3(uint256 weiAmount) internal {
      require (msg.sender == addrToWhitelist1 || msg.sender == addrToWhitelist2 || msg.sender == addrToWhitelist3 ,"address is not valid");
      uint dividedAmount1 = weiAmount*50 / 100 ;
      uint dividedAmount2 = weiAmount*25 / 100 ;
      uint dividedAmount3 = weiAmount*15 / 100 ;
