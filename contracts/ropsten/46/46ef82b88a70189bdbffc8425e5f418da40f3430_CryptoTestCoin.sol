...
contract CryptoTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CryptoTestCoin() {
        ...
        name = "CryptoTestCoin";                                    // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                      // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CPCN";                                   // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 10;                            // Set the price of your token for the ICO (CHANGE THIS)
        fundsWallet = msg.sender;                          // The owner of the contract gets ETH
    }

    function() payable{
        // Here decimals are not considered  msg.value is in wei and unit is for one ether but since balance also are store in 18 decimals it works fine
