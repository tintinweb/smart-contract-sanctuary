...
contract WhatTest is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "WhatTest";
    ...
    // MISC
    address private m_LiqLockSvcAddress = 0xbe3101cEAe798a14f0d1FD613fC55DE8b90DC8b1;
