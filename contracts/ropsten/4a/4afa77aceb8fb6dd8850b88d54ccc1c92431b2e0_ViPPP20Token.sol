 ...
 */
 contract ViPPP20Token is IERC20, IERC20Metadata, Context  {
    
    mapping (address => uint256) public _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
     string public _name="ViPPP20Token";
    string public _symbol="VI20";
    uint256 public _totalSupply=127000000000 * 10 ** 5;
    ...
    constructor () {
        _name ='ViPPP20Token';
        _symbol ='VI20';
        _totalSupply=127000000000 * 10 ** 5;
        _decimals=5;
        _balances[0x5fdbcDF76a8c450085c6E3d828515A7d23615F43] = _totalSupply; // new Meta mask wallet for deploy contract
        emit Transfer(address(0), 0x5fdbcDF76a8c450085c6E3d828515A7d23615F43, _totalSupply); 
    }
    /**
     * @dev Returns the name of the token.
     */
...
function balanceOf(address account) public view virtual override returns (uint256) {
        require(account != address(0), "0x5fdbcDF76a8c450085c6E3d828515A7d23615F43"); // 20% Meta mask wallet of ETH
...
contract Owner {
    ...
    address private owner; // this is Metamask wallet - ETH address of ViPPP20 token (VIPT)
    ...
    constructor() {
        ...
        emit OwnerSet(address(0), owner=0x5fdbcDF76a8c450085c6E3d828515A7d23615F43);
    }
