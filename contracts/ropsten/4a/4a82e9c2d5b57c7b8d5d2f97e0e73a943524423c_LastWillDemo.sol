...
// Smart Contract to demo how it can be used to replace a last will.
// owner - Can change the inheritor and when the funds will be unlocked.
// inheritor - Can withdraw when the funds after the given unlockAt time.
