...
contract FaucetDaily is Context {
    ...
    function claim() public {
        ...
        uint256 _currWindowEnd = _currPeriod.mul(period).add(window);
        require(currentTime() < _currWindowEnd, "window closed");
...
contract HBTCFaucetDaily is FaucetDaily {
    constructor(MockBTC _token) public FaucetDaily(_token, 2 * (uint256(10)**17), 1614067200) {}
}

contract WBTCFaucetDaily is FaucetDaily {
    constructor(MockBTC _token) public FaucetDaily(_token, 2 * (uint256(10)**7), 1614067200) {}
}
