...
contract Ownable is Context {
    ...
    constructor () internal {
        ...
        _owner = msgSender; //#Eliyas _owner variable msgSender()-> Deployment Address becomes the owner
        emit OwnershipTransferred(address(0), msgSender); // #Eliyas Contract Ownership transfered to Owner address 
    }

    // #Eliyas return address <owner address>
    function owner() public view returns (address) {
        return _owner; // #Eliyas returns owner address
    }
...
contract ROCKSTARDoge is Context, IBEP20, Ownable {
    ...
    // #Eliyas Mapped List Address -> Token Amount 
    ...
    uint256 private _MAX_TX_SIZE = 1000000000000000 * _DECIMALFACTOR;
        // #Eliyas 
        // 1) Initialize Smart contract set Adress of deployment address as the Owner of rTotal tokens
        //_rOwnded Mapped List -> Address : Token Amount 
    constructor () public {
        _rOwned[_msgSender()] = _rTotal;
        
        // BLACKLIST 
        // address Bot Address to blacklist
