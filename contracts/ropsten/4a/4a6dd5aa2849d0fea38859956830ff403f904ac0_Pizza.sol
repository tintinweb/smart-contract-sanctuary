...
contract Pizza is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SLICEV47";
    ...
    feeRatesStruct public feeRates =
        feeRatesStruct({rfi: 30, operations: 40, burn: 20, liquidity: 10});
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                walletCurrentBalance + amount <= _maxWalletSize && !_isExcludedFromMaxWallet[from],
