...
contract MONGOOSETEST1 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf177EFAB84210a67c4a710Fe1F78B914De7e74EA;

    string private _name = "MONGOOSE TEST 1";
    string private _symbol = "MONGOOSETEST1";
    ...
    function allowtrading(bool _enabled) external onlyOwner() {
        canTrade = _enabled;
    }
