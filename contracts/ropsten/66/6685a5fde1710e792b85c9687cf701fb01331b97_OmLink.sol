...
contract OmLink is Fiber, SignVerifier, Tracked
{
    ...
    function depositNative(
        ...
        returns (bool) {
            ...
            emit NativeLinkStarted(toChain,msg.sender,to,amount,getNativeDepositNonce());
    ...
    event NativeLinkStarted(uint256 toChain, address from, address to, uint256 amount, uint256 depositNonce);
    event NativeLinkFinalized(uint256 chainId, address from, address to, uint256 amount, uint256 indexed nonce, address signer);
