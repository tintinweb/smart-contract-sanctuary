...
interface ICounter {
    ...
    function zero() external view returns(bool);
...
contract CResolver {
                                              ...
                                              bytes memory execPayload1)
    {
        ...
        execPayload = abi.encodeWithSelector(ICounter.zero.selector, uint256(100));
        execPayload1 = abi.encodeWithSelector(ICounter.increaseCount.selector, uint256(100));
    }
}