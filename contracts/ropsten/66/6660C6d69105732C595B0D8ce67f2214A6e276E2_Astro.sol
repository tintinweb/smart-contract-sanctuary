...
contract Astro is ERC721, Ownable {
    ...
    uint constant public PRESALE_MAX_PURCHASE = 4;
    uint constant public MAX_NUM_OF_TAGS = 10001;
    uint constant public MAX_NUM_OF_PRESALE_TAGS = 1001;
    uint256 constant public TAG_PRICE = 0.05 ether;
    uint256 constant public PRESALE_TAG_PRICE = 0.03 ether;
    ...
    function presaleMintAstroTags(uint numOfTags) public payable {
        ...
        require(PRESALE_TAG_PRICE.mul(numOfTags) == msg.value, "Ether value sent is not correct");
