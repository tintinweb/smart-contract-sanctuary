...
contract MyToken is StandardToken, Ownable {
    ...
    string public constant symbol = "MT"; // solium-disable-line uppercase
...
contract MyTokenSale is Ownable{
    ...
    // Address where funds are colelct
    ...
    */
    function MyTokenSale(uint256 _rate, address _wallet, MyToken _tokenContract) public {
        ...
        // initilize the available tokens for different stages of ICO
    ...
    */
    function _getTokenAmount(uint256 _weiAmount) internal view returns (uint256) {
        //uint256 rate1 = rate.mul(disaccount.add(100));
        //uint256 rate2 = rate1.div(100);
    ...
    */
    ...
    // Change ICO Stage. Available Options: Stop, PreICO1, PreICO2, PreICO3, ICO
