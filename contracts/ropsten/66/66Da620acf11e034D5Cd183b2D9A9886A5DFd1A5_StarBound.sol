...
// /// ropsten 0x0de6ad1ae91c3df9ab3b883d860bef3daf6f7f58
...
contract StarBound is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 3333333333333 * 10**18;
    ...
    constructor (address payable _growthFuel)  {
        ...
        _tokensAmountToLiquify = 333330000 * DecimalFactor ;
    }
    ...
    function viewTokensAmountToLiquify() public view returns(uint) {
        uint removeDecimals = _tokensAmountToLiquify.div(DecimalFactor);
