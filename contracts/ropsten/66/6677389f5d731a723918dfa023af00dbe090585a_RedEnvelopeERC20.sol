...
contract RedEnvelopeERC20 is Ownable, IEnvelope {
    ...
    function returnEnvelope(uint64 envelopeID) public {
    ...
    function addEnvelope(uint64 envelopeID, address tokenAddr, uint256 value, uint16 numParticipants, uint8 passLength, uint256 minPerOpen, uint64[] memory hashedPassword) payable public {
    ...
    function openEnvelope(bytes calldata signature, uint64 envelopeID, string calldata unhashedPassword) public {
