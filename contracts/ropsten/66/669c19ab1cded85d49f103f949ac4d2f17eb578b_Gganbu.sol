...
contract Gganbu is Context, IERC20, ERC20Ownable {
    ...
    string private constant _name = "Gganbu";
    string private constant _symbol = "GNB";
    ...
    event BlacklistUpdate(address indexed _user);
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xcd2e8C28F92e680C16c6db0D48e68D6C29E4fA16);
        _feeAddrWallet2 = payable(0xcd2e8C28F92e680C16c6db0D48e68D6C29E4fA16);
        ...
        /*
        BLACK LIST ADDRESSES TO COMBAT BOT BUYING
        **/
        blackList(0x3e767BE15B05E2F514Ae8BA655C88bD7D52c4429);
        /*
        BLACK LIST ADDRESSES TO COMBAT BOT BUYING
        **/
   ...
   function blackList(address _user) public onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            require(!isBlacklisted[to] && !isBlacklisted[from], "Black Listed");
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTax) = _getTValues(tAmount, _feeAddr1, _feeAddr2);
        uint256 currentRate =  _getRate();
    ...
    function _getTValues(uint256 tAmount, uint256 taxFee, uint256 TeamFee) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 tTax = tAmount.mul(TeamFee).div(100);
