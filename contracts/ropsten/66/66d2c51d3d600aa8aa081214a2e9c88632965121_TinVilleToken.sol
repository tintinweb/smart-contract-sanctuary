...
function _transfer(
    ...
    */
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tBurn) = __getTValues(tAmount, _taxFee, _burnFee);
        uint256 currentRate =  _getRate();
    ...
    function __getTValues(uint256 tAmount, uint256 taxFee, uint256 burnFee) private pure returns (uint256, uint256, uint256) {
