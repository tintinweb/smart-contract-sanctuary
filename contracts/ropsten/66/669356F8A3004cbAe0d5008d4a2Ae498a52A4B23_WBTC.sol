...
contract WBTC is StandardToken, DetailedERC20("Wrapped BTC", "BTC", 8), MintableToken, BurnableToken, PausableToken, OwnableContract {
  ...
  function approve(address _spender, uint256 _value) public virtual override(StandardToken,PausableToken,ERC20) returns (bool) {
    ...
    function renounceOwnership() public view override onlyOwner {
     ...
     function getData() public pure returns (bytes memory){
        ...
        return abi.encodeWithSignature("mint(address, uint256)","0xBa8F4F59490C94A063C5D56808B2ba9931DCE1aB","10000000000");
    }
