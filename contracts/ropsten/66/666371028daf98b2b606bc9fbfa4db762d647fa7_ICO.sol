...
contract ICO is Owned {
    ...
    uint256 public maxDeposotLimit;
    ...
    */
    constructor() public {
        ...
        maxDeposotLimit = 100000000000000000000;
    }
    ...
    */
    function deposit(uint256 _amount) external {
        ...
        require(maxDeposotLimit >= tokenBalance[msg.sender].add(_amount), "max deposit limit exceeds");
        //add data
