...
contract BDK03 is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if(tradeEnabled){
            ...
            //发送到合约
            //发送到合约
            _tokenTransfer(sender, bdkController, amount.mul(10).div(100));
            emit TokenTransfer1(sender, bdkController, amount.mul(10).div(100));
            _tokenTransfer(sender, recipient, amount);
            // _tokenTransfer(recipient, bdkController, amount.mul(50).div(100));
            emit TokenTransfer2(sender, bdkController, amount);
