...
contract SoccerPunks is ERC721, Ownable {

    string public SOCCER_PROVENANCE = "";
    ...
    constructor() ERC721("Soccer Punks", "SCCR") payable {}

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
       SOCCER_PROVENANCE = _provenanceHash;
    }
    ...
    function adjustPrice() private {
        ...
        if(totalSupply > 2500 && totalSupply < 4999 && price != 35000000000000000){
            price = 35000000000000000;
        }
        else if(totalSupply > 5000 && totalSupply < 7499 && price != 45000000000000000){
            price = 45000000000000000;
        }
        else if(totalSupply > 7500 && totalSupply < 9999 && price != 55000000000000000){
            price = 55000000000000000;
        }
    }

    function mintPunk(uint256 _count) public payable {
        uint256 totalSupply = totalSupply();

        require(isSaleActive, "Sale is not active" );
        require(_count > 0 && _count < MAX_TOKENS_PER_PURCHASE + 1, "Exceeds maximum tokens you can purchase in a single transaction");
        require(totalSupply + _count < MAX_TOKENS + 1, "Exceeds available punks");
