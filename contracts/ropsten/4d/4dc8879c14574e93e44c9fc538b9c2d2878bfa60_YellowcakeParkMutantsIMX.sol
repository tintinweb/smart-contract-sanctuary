...
// File contracts/YellowcakeParkMutantsIMX.sol
...
/**
 * @title YellowcakeParkMutantsIMX contract
 */
contract YellowcakeParkMutantsIMX is Mintable, ERC721 {
    string public _baseURIPath;

    constructor(address _owner, address _imx) ERC721("YellowcakeParkMutantsIMX", "YCPM") Mintable(_owner, _imx) {}
