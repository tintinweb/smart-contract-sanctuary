...
contract LPTokenWrapper is Ownable, ReentrancyGuard {
    ...
    IERC20 public BSKTETHLPToken = IERC20(0x4Bec13aB192280763A201a30ca093a3d0a15b3DC);  // Uniswap V2 - Approve and Transfer BSKT-ETH-LP Token for stake
...
contract BsktEthLPPool is LPTokenWrapper {
    ...
    IERC20 public BSKTREWARD = IERC20(0x3d3c60970D3369e48f79664787433fc0d2B7C44b);  // Basket token address, distribute token as reward
    
    uint256 public constant duration = 0.1 days;     //-----| Pool Duration |-----       
