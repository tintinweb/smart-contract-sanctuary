 ...
 */
contract CityView is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    */
    ...
    function setTokenURIs(string[] memory tokenURIs)  public onlyOwner {        
        for (uint256 index = 0; index < tokenURIs.length; index++) {
             _setTokenURI(index,tokenURIs[index]);
        }
    }
    ...
    * Mints Bored Apes
    */
    function mintCtc(uint numberOfTokens) public onlyOwner payable {
