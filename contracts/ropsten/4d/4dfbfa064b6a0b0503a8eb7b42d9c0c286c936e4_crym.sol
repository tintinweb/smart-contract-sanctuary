...
contract crym is Context, Ownable, ERC20 {
    ...
    */
    ...
    constructor() Ownable() ERC20("Cryminals", "CRYM") {
        ...
        lootContract = IERC721Enumerable(cryminalsContractAddress);
    }
    ...
    function daoSetTokensPerTokenId(uint256 adventureGoldDisplayValue)
        public
        onlyOwner
    {
        tokensPerTokenId = adventureGoldDisplayValue * (10**decimals());
    }
    ...
    /// @param season_ The season to use for claiming tokens
    /// @param adventureGoldDisplayValue The amount of tokens a user can claim.
    /// This should be input as the display value, not in raw decimals. If you
    /// want to mint 100 Tokens, you should enter "100" rather than the value of
    /// 100 * 10^18.
    ...
    function daoSetSeasonAndAdventureGoldPerTokenID(
        ...
        daoSetTokensPerTokenId(adventureGoldDisplayValue);
    }
}