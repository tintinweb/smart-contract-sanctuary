...
// ----------------------------------------------------------------------------
// &#39;TokenJZ&#39; token contract
//
// Deployed to : 0x159822DE6dAF9dA1388E54373416cCD107c3D894
// Symbol      : JZTOK
// Name        : Token of JZ
// Total supply: 1000
// Decimals    : 2
...
// token transfers
// ----------------------------------------------------------------------------
contract TokenJZ is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function TokenJZ() public {
        symbol = "TOKJZ";
        name = "Token of JZ";
        decimals = 2;
        _totalSupply = 100000;
        balances[0x159822DE6dAF9dA1388E54373416cCD107c3D894] = _totalSupply;
        Transfer(address(0), 0x159822DE6dAF9dA1388E54373416cCD107c3D894, _totalSupply);
    }
