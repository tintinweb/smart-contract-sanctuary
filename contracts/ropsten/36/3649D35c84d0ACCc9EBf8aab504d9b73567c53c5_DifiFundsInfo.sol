...
contract DifiFundsPresale {
    ...
    uint256 private DifiDevFeePercentage; // dev fee to support the development of Difi Investments
...
contract DifiFundsFactory {
    ...
    function createPresale(
        ...
        presale.setDifiInfo(address(0), Difi.getDevFeePercentage(), Difi.getMinDevFeeInWei(), DifiId);        
