...
contract PepeETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "PepeETH";
    string private constant _symbol = "PepeETH";
    ...
    uint256 private constant _tTotal = 1000 * 1e11 * 1e9;
    ...
    address payable private _devAddress = payable(0x79C426C4D143b61237614086bE7CB5726055790E);
    address payable private _mktgAddress = payable(0x79C426C4D143b61237614086bE7CB5726055790E);
    ...
    uint256 public _maxTxAmount = 1000 * 1e9 * 1e9; //max transaction set to 1%
    uint256 public _maxWalletSize = 2000 * 1e9 * 1e9; //max wallet set to 2%
    uint256 public _swapTokensAtAmount = 1000 * 1e8 * 1e9; //amount of tokens to swap for eth 0.1%
    ...
    function setFee(uint256 reflectionFeeOnBuy, uint256 reflectionFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(_reflectionFeeOnSell + _taxFeeOnSell <= 10, "Must keep buy taxes below 10%"); //wont allow taxes to go above 10%
    }
