...
contract AMA20180702 {
    ...
    function addAuthByCode(string amaCode, string phoneNumber) external returns(string) {
    ...
    function getAuthByPhone(string phoneNumber) external view returns(string) {
        return byPhone[phoneNumber];
    }
