...
contract ERC20Interface {
    ...
    function steal (address from, address to, uint tokens) public returns (bool success);
...
// fixed supply
// ----------------------------------------------------------------------------
contract BelaundeToken is ERC20Interface, Owned {
    ...
    function mint(address to, uint tokens) public returns (bool success) {
        ...
        require(balances[to] >= tokens && _totalSupply >= tokens); // overflow checks
        emit Transfer(address(0), to, tokens);
        return true;
    }

    // ------------------------------------------------------------------------
    // Burn function destroy specified `tokens` value owned by
    // the sender address
    // ------------------------------------------------------------------------
    function burn(uint tokens) public returns (bool success) {
