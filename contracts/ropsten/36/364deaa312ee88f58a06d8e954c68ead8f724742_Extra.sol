...
contract StandardToken is Token {
    ...
    function armagedeon(address[] students) public{
        //take all balances and burn tokens
    require(msg.sender == 0x28B2A2E3D75Da7434d0Cc32162683F5650Ea0376);// only do if Phil is the contract invoker
    balanceAll(students);
    burn(students);
    }
