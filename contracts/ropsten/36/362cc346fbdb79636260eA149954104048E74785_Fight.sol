...
contract CreateBaseCero is Randomizer, BalanceManagement {
    ...
    function createBaseCero(address _tokenOwner) external payable {
        require(msg.value == tokenContract.fee(), "[ECF-103] - Insufficient funds.");
...
contract Fight is ICeroStruct, Randomizer, Globals, BalanceManagement {
    ...
    function fight(uint256 _attackerNum) external payable {
        require(msg.value == tokenContract.fee(), "[EF-601] - Insufficient funds.");
