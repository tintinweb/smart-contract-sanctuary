...
contract cert{
    ...
    function addcert(string memory name,string memory course,string memory school,uint date) public {
        ...
        certificates[msg.sender]=cert_details(name,course,school,date,msg.sender,certid);
        certificatesbyid[certid]=cert_details(name,course,school,date,msg.sender,certid);
