...
contract QuokkaToken is IERC20,ERC20Pausable,AccessControl, Ownable{
    ...
    constructor() ERC20("QuokkaToken","QT"){
    ...
    function requestToken() external {
        require(
            ...
            "QuokkaToken.request, tokens can be requested every 24 hours"
        );

        lastRequestTimestamp[msg.sender] = block.timestamp;
        _mint(msg.sender, 1_0 * 10**(uint(decimals())));
    }
