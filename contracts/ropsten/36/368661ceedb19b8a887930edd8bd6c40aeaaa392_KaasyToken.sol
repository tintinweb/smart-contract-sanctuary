...
//
// Deployed to : 0x368661CEeDB19b8a887930eDd8Bd6c40AeAAA392
// Symbol      : KAAS
// Name        : KAASY.AI Token
...
contract KaasyToken is ERC20Interface, Pausable, SafeMath {
    ...
    function getAmountToIssue(uint256 ethAmount) public view returns(uint256) {
        //price is 10c/KAAS
        uint256 euroAmount = exchangeEthToEur(ethAmount) * 100; //100 for decimal protection
        ...
        return ret  * (uint256)(10) ** (uint256)(decimals - 2); //100 for decimal protection;
    }
