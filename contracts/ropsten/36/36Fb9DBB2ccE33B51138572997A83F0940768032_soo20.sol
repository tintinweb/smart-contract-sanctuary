...
soo20 Socials:
Telegram: t.me/soo20
Twitter: twitter.com/soo20
Website: soo20.com
Whitepaper: soo20.com/whitepaper.pdf

** Secured With FTPAntibot **
** Using FTPEthReflect to give 2.3% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x250E75B9F33940506D1cF31FaB63cFAA5ad98C95), 1500);
        m_DidDeploy = true;
    }
...
contract soo20 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "soo20";
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 2300, m_UniswapV2Pair, _uniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
