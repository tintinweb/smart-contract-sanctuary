...
contract BlindBoxExchange721 is AccessControl, Pausable {
    using SafeMath for uint256;
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    string  public name = "BlindBoxExchange721";
    ...
    function _mintNft(uint256[] memory mintNftTokenIds)internal whenNotPaused returns(bool) {
        ...
        for (uint256 i = 0; i < mintNftTokenIds.length; i++){
            Common721NFTContract.mint(msg.sender,mintNftTokenIds[0]);
        }
        return true;
    }
