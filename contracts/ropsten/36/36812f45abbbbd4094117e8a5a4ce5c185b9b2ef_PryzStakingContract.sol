...
contract PryzStakingContract is Ownable, ReentrancyGuard {
    ...
    constructor() {
        pryzToken = IERC20(0x786c48C671B6B72cC76C9A13387DF29438571eaB);
        rewardPerBlock = 0.5 ether; // 0.5 token per block
    ...
    function updateRewardPerBlock(uint256 _rewardPerBlock) external onlyOwner {
        require(rewardPerBlock >= 0.5 ether, "Check minimum reward per block");
