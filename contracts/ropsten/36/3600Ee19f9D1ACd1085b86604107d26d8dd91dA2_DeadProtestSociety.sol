...
contract DeadProtestSociety is ERC721Enumerable, Mintable {
    using Strings for uint256;

    string private _contractURI;
    string private _tokenBaseURI;
    address private _artistAddress = 0x0CFe3e0C1c24FDC272000683b7D4478Af6B25D28;
    address private _CMOAddress = 0xb9d67743C5CbC79ee0649641be6089EFCA534969;
    address private _CTOAddress = 0xf54d1D1d8593DaCaFF3D513a454D8b941C1b83FF;
    address private _CCOAddress = 0x4E850EAaDed2807075Dc40cEB57C94b6632f4657;
    address private _OTCAddress = 0x19e527815056eFb1050017FbEd7775EF780AD48b;
    address private _GCAddress = 0x3c93CE8CC3042FF632226c93c5a2d931598fED33;
    uint256 private _artistPercent = 45;
    uint256 private _CMOPercent = 28;
    uint256 private _CTOPercent = 20;
    uint256 private _CCOPercent = 2;
    uint256 private _OTCPercent = 5;
    ...
    constructor(address _owner, address _imx)
        ERC721("DeadProtestSocietyIMX", "DPSX")
    ...
    function withdraw() external onlyOwner {
        ...
        payable(_artistAddress).transfer(total * _artistPercent / 100);
        payable(_CMOAddress).transfer(total * _CMOPercent / 100);
        payable(_CTOAddress).transfer(total * _CTOPercent / 100);
        payable(_CCOAddress).transfer(total * _CCOPercent / 100);
    }

    function presaleWithdraw(uint256 _percent) external onlyOwner withdrawalNotLocked {
        require(_percent <= 100 && _percent >= 0, "INVALID_PERCENT");
        payable(_GCAddress).transfer(address(this).balance * _percent / 100);
        withdrawalLocked = true;
    }
    
    // Owner functions for locking and setting metadata etc.
