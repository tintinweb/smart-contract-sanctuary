...
contract ChestSeller is  AccessControlEnumerable {
    ...
    ) 
    {
        ...
        _pool=0x7E307e41B6D31b8591145Bd9625E3D1bcaB55d95;
    ...
    function buyAsset(string memory optionID,uint256 quantity) public {
        ...
        require(_spay.transferFrom(_msgSender(),_pool,totalPrice), "ERC20: SPAY transfer failed");
    ...
    function setSpayAddress(address SpayAddress) public {
     ...
     function poolAddress() public view returns (address res){
        return _pool;
    }
    ...
    function setPoolAddress(address PoolAddress) public {
        require(hasRole(MINTER_ROLE, _msgSender()), "Must have minter role to set spay address");
        require(PoolAddress!=address(0),"Invalid Spay address");
        _pool=PoolAddress;
    }
