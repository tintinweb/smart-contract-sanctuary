...
contract Bank is Ownable {
    ...
    IERC20Mintable public _psyduckToken;
   ...
   function startStaking(uint256 startBlock) external onlyOwner {
    ...
    constructor(address rewardToken,  address psyduckToken,
            uint256 stakeRewardCap, uint256 stakeRewardPerBlock) {
        _rewardToken = IERC20Mintable(rewardToken);        
        _psyduckToken = IERC20Mintable(psyduckToken);    
    ...
    function setPsyduckToken(address psyduckToken) public onlyOwner {
        _psyduckToken = IERC20Mintable(psyduckToken);
    } 
    ...
    function stake(uint256 amount) external {
        ...
        _psyduckToken.safeTransferFrom(msg.sender, address(this), amount); // move staking amount in
    }
    ...
    function unstake(uint256 amount) external {
        ...
        _psyduckToken.safeTransfer(msg.sender, amount);
    }
