...
contract Sukiyaki is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Sukiyaki() {
        ...
        name = "Sukiyaki";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SKYK";                                             // Set the symbol for display purposes (CHANGE THIS)
