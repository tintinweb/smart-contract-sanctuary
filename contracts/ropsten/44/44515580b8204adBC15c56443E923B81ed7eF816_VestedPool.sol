...
contract VestedPool is Pool {
    ...
    uint256 public tokensToClaimAfterPurchase;
    ...
    constructor(
        ...
        tokensToClaimAfterPurchase = (allocations[msg.sender].amount * initialUnlock) / ONE_HUNDRED_PERCENT;
    }
    ...
    function getClaimableTokens(address user) public view returns (uint256) {
        ...
        uint256 claimable = ((block.timestamp - startDate - cliff) / unlockPeriod) * unlockPerPeriod + tokensToClaimAfterPurchase - claimed;
