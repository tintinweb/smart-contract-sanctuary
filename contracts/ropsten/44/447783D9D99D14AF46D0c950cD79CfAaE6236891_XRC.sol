...
contract XRC is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PRICE = 0.001 ether; // 0.0502 * 10**18; // 0.0502 ETH
    ...
    constructor() ERC721A("Test Rabbits Club", "TXRC", 2, 7502) {
        baseURI = "ipfs://QmdGvTo2vSzGAM1e3rqfrW7T3NPBTY7ZvjVVKsWaBRwFJw/";
        _signer = 0x26767625c1C4318bb7Ac3A1d8248C16937BfD03C;
        maxMint = 2;
        maxSupply = 7502;
        reserveAmount = 502;
    }
