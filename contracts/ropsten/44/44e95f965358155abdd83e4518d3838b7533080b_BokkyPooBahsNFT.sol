 ...
 * _Available since v3.1._
 */
contract ERC1155MINT is Context, ERC165, IERC1155, IERC1155MetadataURI {
 ...
 * _Available since v3.1._
 */
abstract contract ERC1155Burnable is ERC1155MINT {
 ...
 * _Available since v3.1._
 */
abstract contract ERC1155Pausable is ERC1155MINT, Pausable {
    /**
...
contract BokkyPooBahsNFT is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
     ...
     */
    constructor(string memory uri) ERC1155MINT(uri) {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControlEnumerable, ERC1155MINT) returns (bool) {
    ...
    function _beforeTokenTransfer(
        ...
        internal virtual override(ERC1155MINT, ERC1155Pausable)
    {
        super._beforeTokenTransfer(operator, from, to, ids, amounts, data);
    }
}