...
contract Escrow {
    ...
    function createOrder(address buyer, uint productId) public returns(bool){
        ...
        orderBook[orderId] = Order(OrderState.ORDER_CREATION, buyer, productId);
        orders.push(orderId);
    ...
    address public delegateContract = 0x6EE856Ae55B6E1A249f04cd3b947141bc146273c;
    ...
    function setOrderAnalytic(uint256 orderId, uint256 temperature, uint256 humidity) external validation onlyCarrier returns(bool){
