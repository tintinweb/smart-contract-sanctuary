...
contract BitcoinMoon is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BitcoinMoon() {
        ...
        name = "BitcoinMoon";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BTCM";                                             // Set the symbol for display purposes (CHANGE THIS)
