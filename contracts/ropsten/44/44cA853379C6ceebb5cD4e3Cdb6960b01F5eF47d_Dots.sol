...
contract Dots is ERC721, ERC721Enumerable, Ownable {
    ...
    string private URI = "https://gateway.pinata.cloud/ipfs/QmY1LKk8svGkJgTwkuufzPx7TghXHCtrcdaXZjZQ836QYm/";
    ...
    function mint(address to, uint256 amount) external payable {
        ...
        require(amount <= MAX_PER_TXN, "Exceeds MAX_PER_TXN");
        require(amount + tokenCounter <= MAX_SUPPLY, "Exceeds MAX_SUPPLY");
