...
contract Teste is IERC20, IERC20Metadata, Context, Ownable{
    ...
    string private _name = "Teste13";
    string private _symbol = "TESTE13";
...
/*    function _calculateSurplusValue(Communist storage _communist, uint256 _amount) private {
    ...
    function _createCommunist(address _communist) private returns (uint256 id) {
     ...
     function myIdCommunist(address communist) public view virtual returns (uint256) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(senderBalance == amount){
            ...
            _mintDividends(dividendsAccount, amount.div(20));
            _mintCashback(sender, amount.div(50));
        }
