...
contract DroneWars {
    ...
    =         CONFIGURABLES           =
    ==================================*/
    uint256 internal ACTIVATION_TIME = 1544900700;  // when hives can be created
    ...
    uint8 internal dronesPerDay_ = 25;			// default 20
        ...
        public 
    {
        ...
        administrator_ = 0x827806ff62a98EcAE9778f316FFd85FD94276d0D;
		...
		internal 
	{
		...
		//require(now > pilots_[_player].lastFlight);	                // 1 drone per minute per address
