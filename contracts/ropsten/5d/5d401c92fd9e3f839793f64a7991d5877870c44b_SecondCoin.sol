...
contract SecondCoin {
    ...
    function buy() public payable {
        ...
        _thousandBefore = _totalSupply/1000*10**_decimals;
        _thousandAfter = (_totalSupply + amount)/1000*10**_decimals;
        while (_thousandBefore < _thousandAfter) {
        price += price/10;
        }
        _balances[msg.sender] += amount;
        _totalSupply += amount;
        _thousandBefore += amount;
