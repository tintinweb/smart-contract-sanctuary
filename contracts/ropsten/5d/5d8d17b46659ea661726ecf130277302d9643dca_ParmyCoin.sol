...
contract Token
{
    ...
    /// @param _value The amount o ftoken to be transferred
...
contract StandardToken is Token
{
    ...
    function transfer(address _to, uint256 _value) returns (bool success)
    {
        ...
        // If your token leaves our totalSupply and can issue more tokens as time goes on, you need to check if it doesn't wrap.
...
contract ParmyCoin is StandardToken
{
    function ()
    {
    ...
    // make sure this function name matches the contract name above. So if your token is called TutorialToken
    // make sure the contract name above is also TutorialToken instead of ERC20Token
    
    function ParmyCoin()
    {
        balances[msg.sender] = 10000; // Give the creator all initial tokens
        totalSupply = 100000; // update total supply
        name = "ParmyCoin"; // name for display purposes
        decimals = 3;
        symbol = "PMC"; // symbol for display purposes
    }
