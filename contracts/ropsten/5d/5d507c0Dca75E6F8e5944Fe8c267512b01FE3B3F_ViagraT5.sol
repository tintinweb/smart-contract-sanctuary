...
pragma solidity ^0.6.12;
    ...
    contract ViagraT5 is Context, IERC20, Ownable {
        ...
        string private _name = 'ViagraT5';
        string private _symbol = 'ViagraT5';
        ...
        uint256 private _taxFee = 0;  //Not used in this contract
        uint256 private _devFee = 4;        // This portion goes to dev / Marketing Wallet
        uint256 private _whaleFee = 9;      // This portion wil go to Viagra Wallet for Buybacks and lottery
        uint256 private _charityFee = _devFee.add(_whaleFee);
        ...
        function removeAllFee() private {
            ...
            _previousCharityFee = _devFee.add(_whaleFee);
        ...
        function _setDevFee(uint256 devFee) external onlyOwner() {
         ...
         function _setWhaleFee(uint256 whaleFee) external onlyOwner() {
            require(whaleFee >= 1 && whaleFee <= 11, 'whaleFee should be in 1 - 11');
            _whaleFee = whaleFee;
        }
        
        function _getTotalTaxAmount() private view returns(uint256) {
            return _devFee.add(_whaleFee);
        }
