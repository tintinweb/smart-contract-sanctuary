...
contract MomentousV1 is ERC721URIStorage, Mintable {
    ...
    */
    ...
    function _mintFor(
        ...
        // If the collection does not have a valid creator id yet...
        // Then, set the creator id and add the collection to the mapping of collections for this creator,
        // And, also set its run size
