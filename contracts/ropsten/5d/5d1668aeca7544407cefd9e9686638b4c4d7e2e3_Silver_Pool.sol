...
contract Silver_Pool is IERC20{
    
    string public constant name="Silver_Pool";
    string public constant symbol="STSVP";
    string public constant decimals="18";
    uint256 totaleSupply_ =100000000000000000000000000;
