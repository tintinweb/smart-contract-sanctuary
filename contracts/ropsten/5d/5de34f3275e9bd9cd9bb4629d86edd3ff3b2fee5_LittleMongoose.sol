...
/*
Little Mongoose will one day grow old and become bigger than its father Mongoose
*/
...
contract LittleMongoose is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Little Mongoose";
    string private constant _symbol = "Little Mongoose";
    ...
    address payable public marketingWallet = payable(0x8F84983bcaC4693C4eDD8fFef6F597BB5305798E);
    address payable public treasury = payable(0x8F84983bcaC4693C4eDD8fFef6F597BB5305798E);
    ...
    constructor (    ) Auth(0x8F84983bcaC4693C4eDD8fFef6F597BB5305798E) {
        address _owner = 0x8F84983bcaC4693C4eDD8fFef6F597BB5305798E;
