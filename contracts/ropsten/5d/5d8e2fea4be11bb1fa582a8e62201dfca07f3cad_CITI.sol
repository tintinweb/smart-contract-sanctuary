...
contract CITI is StandardToken , Math {
    ...
    function applicantDetails(address contributorsAddress) internal _onlyCreator  returns (address addr /**,uint amount,uint citizenID, string memory eMailID*/) {
...
contract  infraDev is CITI{
    ...
    function vote(uint voteIndex) public {
        ...
        require(applicantDetails(msg.sender) == msg.sender, "you are not a registered Citizen" );
