...
contract MBSibalCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MBSibalCoin() {
        ...
        name = "MBSibalCoin";                                             // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MBSC";                                             // Set the symbol for display purposes (CHANGE THIS)
