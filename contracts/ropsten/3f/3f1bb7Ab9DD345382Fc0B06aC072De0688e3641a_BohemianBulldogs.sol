...
contract BohemianBulldogs is Ownable, ERC721Enumerable, ReentrancyGuard, ERC721URIStorage, PaymentSplitter {
   ...
   using Counters for Counters.Counter;
    ...
    uint256 public constant PRESALE_BULDOGS_AMOUNT = 500;
    uint256 public constant RESERVED_BULDOGS_AMOUNT = 500;
    ...
    uint256 private LAUNCHPAD_PROJECT_ID = 1;
    
    // Splitting payments
    uint256[] private _teamShares = [95, 5];
    address[] private _team = [0x368cc743F5D477D0cFd133Ef0c2a74470b0a62b8, 0x7eC2710ce334d7e2811Ac9d3dc20431317b3A9dE];
