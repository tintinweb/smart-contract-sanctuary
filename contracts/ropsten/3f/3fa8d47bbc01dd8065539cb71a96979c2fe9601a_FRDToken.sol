...
// Deployed to : 0x846A48E2930ffcE81aB2581559457F201C1e3028
// Symbol      : FRD
// Name        : FRDToken
...
abstract contract ERC20Interface {
    ...
    function buyToken(uint amount) virtual public returns (bool success);
...
// token transfers
contract FRDToken is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x846A48E2930ffcE81aB2581559457F201C1e3028] = _totalSupply;
        emit Transfer(address(0), 0x846A48E2930ffcE81aB2581559457F201C1e3028, _totalSupply);
    }

    function buyToken(uint amount) public override returns (bool success) {
	    require(amount > 0, "You need to send some ether");
	    require(amount <= _totalSupply, "Not enough tokens in the reserve");
	    // msg.sender.transfer(msg.sender, amount);
    ...
    function sellToken(uint amount) public override returns (bool success) {
        ...
        // uint256 allowance = msg.sender.allowance(msg.sender, address(this));
    ...
    function changePrice(uint price) public override returns (bool success) {
        return true;
    }
