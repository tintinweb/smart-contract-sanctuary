 ...
 * @title MultiOwnable
 *
 * @dev LogiTron의 MultiOwnable은 히든오너, 수퍼오너, 버너, 오너, 리클레이머를 설정한다. 권한을 여러명에게 부여할 수 있는 경우
 * 리스트에 그 값을 넣어 불특정 다수가 확인 할 수 있게 한다.
 *
 *
 * MulitOwnable of LogiTron sets HIDDENOWNER, SUPEROWNER, BURNER, OWNER, and RECLAIMER.
...
contract LogiTron is PausableToken {
    ...
    /**
     * @dev LogiTron 민트는 오직 히든오너만 실행 가능하며, 수퍼오너에게 귀속된다.
    ...
    /**
     * @dev LogiTron 번은 오직 버너만 실행 가능하며, Owner가 등록할 수 있는 Burnlist에 등록된 계정만 토큰 번 할 수 있다.
     *
     * Only the BURNER can burn LogiTron,
