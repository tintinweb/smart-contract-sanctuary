...
contract BlockMinerV2 is ERC20, ProofOfStakeMineableToken, Ownable {
    using SafeMath for uint256;

    string public name = "BlockMinerV2";
    string public symbol = "BlockMinerV2";
