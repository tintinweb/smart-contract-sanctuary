...
contract XEXHolder{
    ...
    constructor() public{
        token_=address(0x28bf1ef36aE486810792bbfdD707C5dCCc85c96D);
        holder1_=msg.sender;
        holder2_=address(0);
        holder3_=address(0);
        holder1Reset_=false;
    ...
    function startTransaction(address _address, uint256 _value) public onlyHolder{
        require(_address != address(0) && _value > 0 && msg.sender!=address(0));
    ...
    function confirmTransaction(uint256 _nonce, bool _vote) public onlyHolder{
        require(transactionNonce_==_nonce && msg.sender!=address(0));
