...
contract NOVO is INOVO, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    function __NOVO_init_unchained(address _router) internal initializer {
        ...
        _targetSupply = 10000 * 10**6 * 10**9;

        _antiWhaleAmount = 500 * 10**6 * 10**9;
        numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    ...
    function __NOVO_tiers_init() internal initializer {
        _defaultFees = _addTier(0, 100, 50, 50, 0, 0x927A100BCB00553138C6CFA22A4d3A8dbe1156D7, 0x38900F0891895C294B039920167Cc9e580bB16ca);
        _addTier(50, 200, 100, 100, 50, 0x927A100BCB00553138C6CFA22A4d3A8dbe1156D7, 0x38900F0891895C294B039920167Cc9e580bB16ca);
    }
    ...
    function setOwnerFeeAddress(uint256 _tierIndex, address _owner) external onlyOwner() checkTierIndex(_tierIndex) {
        require(_owner != address(0), "NOVO: Address Zero is not allowed");
