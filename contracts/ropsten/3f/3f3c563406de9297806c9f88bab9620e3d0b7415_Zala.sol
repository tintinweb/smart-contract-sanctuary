...
contract Zala is ERC20, ProofOfAgeProtocolLayer,
    ...
    string public name = "Zala";
    string public symbol = "ZALA";
...
//--------------------------------------------------------------------------------------
    ...
    function getProofOfBlockMinting(address account) internal returns (uint) {
        ...
        return (currentBlockNumber.div(maxTotalSupply)).mul(blockRewards);
    }
    ...
    function blockInfo(address account) public view returns (address, uint256, uint256) {
        ...
        return (account, currentBlockNumber, blockCount);
    }
