...
contract Donaswaptest1 is Context, IERC20, Ownable {
    ...
    string private _name = "DONASWAPtest1";
    string private _symbol = "DONAT1";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**16 * 10**9;    
