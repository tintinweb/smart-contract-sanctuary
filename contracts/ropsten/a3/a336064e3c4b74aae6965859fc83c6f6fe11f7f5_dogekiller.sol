...
contract dogekiller is IERC20 {
    
    using SafeMath for uint256;
    
    //dogekiller, creator will take 0.6% fee
    address public feeTo = 0xee54a2095EA167B2287c3001178E140F1d8BB8E9;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1000000; // minimum 0.000000000001 dogekiller
