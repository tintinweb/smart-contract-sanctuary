...
contract SooCoin08 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "SooCoin08";
    string private m_Symbol = "SOO08";
    ...
    constructor () {
        ...
        ILO.init(200000000000000000, 20000, 20000, 100000, m_ILOPublic);
        initTax();
