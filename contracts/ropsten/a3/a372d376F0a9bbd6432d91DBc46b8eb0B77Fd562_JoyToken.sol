...
import "./interfaces/IJoyToken.sol";

contract JoyToken is Context, AccessControlEnumerable, ERC20Votes, IJoyToken {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");

    modifier onlyHasRole(bytes32 _role) {
        require(hasRole(_role, _msgSender()), "JoyToken.onlyHasRole: msg.sender does not have role");
        _;
    }
...
interface IJoyToken is IERC20, IERC20Permit {
