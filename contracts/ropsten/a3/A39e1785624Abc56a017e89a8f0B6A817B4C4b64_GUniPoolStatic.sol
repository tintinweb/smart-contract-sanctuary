    ...
    // XXXX DO NOT ADD FURHTER BASES WITH STATE VARS HERE XXXX
{
        ...
        )
    {
        ...
        if (totalSupply > 0) {
            ...
            amount0 = FullMath.mulDiv(amount0Current, mintAmount, totalSupply);
            amount1 = FullMath.mulDiv(amount1Current, mintAmount, totalSupply);
        } else {
        ...
        )
    {
        ...
        amount0 = FullMath.mulDiv(mintAmount, amount0Current, totalSupply);
        amount1 = FullMath.mulDiv(mintAmount, amount1Current, totalSupply);
    }
