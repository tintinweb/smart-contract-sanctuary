...
contract ChocoTruffle is Context, IERC20, Ownable {
    ...
    address MARKET_ADDRESS = 0x3583897da27973256B384Ab0Ff31Ec132A68467B;
    ...
    string private _name = "ChocoTruffle";
    string private _symbol = "CHOCOTRUFFLE";
    uint8 private _decimals = 18;

    uint256 public _taxFee = 3; //3%
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _burnFee = 3; //3%
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _marketFee = 3; //3%
