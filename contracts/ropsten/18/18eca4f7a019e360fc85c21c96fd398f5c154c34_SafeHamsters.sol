...
// File contracts/SafeHamsters.sol
...
contract SafeHamsters is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2500000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BURATINO";
    string private _symbol = "BURATINO";
