...
contract Ownable is Context {
    ...
    constructor() {
        ...
        _owner = 0xaa9A9Ec97D7ecd25134D30bCfb0B98471E66D55c;
...
contract BTAP_Token is Context, IERC20, Ownable {
    ...
    //@dev The tax fee contains two decimal places 50 = 0.5%
    ...
    // Charity address
    address public charityaddress = 0xf7e9C4D5DdfeC5768420FD1E91e50e983f34A1Bb;
    
    // Burn address
    address public burnaddress = 0xf655172B4dD0178B6A7C85D59c3b235C6A8cE68a;
    ...
    constructor() {
        ...
        emit Transfer(address(0), address(0xaa9A9Ec97D7ecd25134D30bCfb0B98471E66D55c), _tokenTotal);
    }
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        if(_charityFee != 0){
            ...
            _reflectionTotal = _reflectionTotal.sub(charityFee.mul(rate));
    ...
    function setFeeDecimal(uint256 fee) public onlyOwner {
        _feeDecimal = fee;
    }
