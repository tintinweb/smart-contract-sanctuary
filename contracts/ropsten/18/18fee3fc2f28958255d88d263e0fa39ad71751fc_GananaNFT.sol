...
contract GananaNFT is ERC721, Ownable, Whitelist, ReentrancyGuard {
    ...
    mapping (uint => bool) public currency;
 ...
 // A mapping of all of the auctions currently running.
    ...
    function mint(string memory _tokenURI, address _toAddress, bool _currency,  uint256 _price, bool _isListOnMarketplace, uint256 royalties) public payable {
        ...
        if (royalties > 0) {
            ...
            require(IERC20(paymentTokenAddress).transferFrom(msg.sender, address(this), royalties));
        }
        _safeMint(_toAddress, _tokenId);
        _setTokenURI(_tokenId, _tokenURI);

        emit Minted(_toAddress, _currency,  _price, _tokenId, _tokenURI, _isListOnMarketplace, royalties);
    }
