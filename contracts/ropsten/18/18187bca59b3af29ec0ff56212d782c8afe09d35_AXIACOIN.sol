...
contract AXIACOIN is ERC223, Ownable {
    ...
    function AXIACOIN(
      ...
      address _lockedAddress
        ...
        balanceOf[founderAddress] = 18000000000 * DECIMALS; //180 million
        balanceOf[airdropAddress] = 20000000000 * DECIMALS; //200 million
        balanceOf[lockedAddress] = 2000000000 * DECIMALS; //20 million
    }
