...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x73FB438Ae12C71109981066D8c73E23195784a6a), 1000);
		setTaxAlloc(payable(0x898F33d4F328424a526Ef24aCA71A511F11c2491), 1000);
		setTaxAlloc(payable(0x250E75B9F33940506D1cF31FaB63cFAA5ad98C95), 2000);
        m_DidDeploy = true;
    }
...
contract sootoken19 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "sootoken19";
    string private m_Symbol = "soo19";
