...
contract BuilderShop {
   ...
   address snowDaqRegistryContract = 0x58267524D20Ff23D509EBE4Eb8bC1cDBaF3D9d33;

   modifier onlyValidSender() {
       NbossRegistry nftg_registry = NbossRegistry(snowDaqRegistryContract);
   ...
   public onlyValidSender returns (NbossBuilderInstance tokenAddress) {

       contractId = contractId + 1;

       NbossBuilderInstance new_contract = new NbossBuilderInstance(
           _name,
           _symbol,
           contractId,
           num_nifties,
...
contract NbossBuilderInstance is ERC721Full {
...
//   string public creatorName;
   ...
   address public snowDaqRegistryContract = 0x58267524D20Ff23D509EBE4Eb8bC1cDBaF3D9d33;

   //master builder - ONLY DOES STATIC CALLS
   address public masterBuilderContract = 0x67eA96e4bE7140D3c0A14BB4BDAec7b4be11d849;
