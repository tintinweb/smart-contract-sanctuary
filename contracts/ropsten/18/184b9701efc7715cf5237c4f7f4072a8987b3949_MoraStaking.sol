...
contract MoraStaking{
  ...
  function Stake(uint256 _amount) external returns(bool success) {
    ...
    if ( _amount >= 2000 * (10**18) && _amount < 7000 * (10**18) ) { _rewardRate = 5800;} // Multiply 10**4 - APY 50 %  - Hourly 0.0058
    if ( _amount >= 7000 * (10**18) && _amount < 16000 * (10**18) ) { _rewardRate = 8100;} // Multiply 10**4 - APY 70 %  - Hourly 0.0080
    if ( _amount >= 16000 * (10**18)) { _rewardRate = 10400;}                              // Multiply 10**4 - APY 90 %  - Hourly 0.0104
