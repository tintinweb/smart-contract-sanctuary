...
contract OneCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function OneCoin() {
        ...
        name = "OneCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "OC";                                             // Set the symbol for display purposes (CHANGE THIS)
