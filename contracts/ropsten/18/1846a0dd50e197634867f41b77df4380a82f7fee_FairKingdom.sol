 ...
 * 
    ______        _          __ __  _                    __                
   / ____/____ _ (_)_____   / //_/ (_)____   ____ _ ____/ /____   ____ ___ 
  / /_   / __ `// // ___/  / ,<   / // __ \ / __ `// __  // __ \ / __ `__ \
 / __/  / /_/ // // /     / /| | / // / / // /_/ // /_/ // /_/ // / / / / /
/_/     \__,_//_//_/     /_/ |_|/_//_/ /_/ \__, / \__,_/ \____//_/ /_/ /_/ 
                                          /____/                                                                                                      
 *   
 *  Warning:
 *     
 *  Fair Kingdom is a system designed to explore human behavior
...
contract FairKingdom {
    using SafeMath for uint256;
    
    /*------------------------------
                CONFIGURABLES
     ------------------------------*/
    string public name = "FairKingdom";    // Contract name
    string public symbol = "FairK";
        ...
        public
    {
        ...
        require(activated == false, "Kingdom already activated");
