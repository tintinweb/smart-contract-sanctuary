...
// File: LiquidationController.sol
...
FlashLoanReceiverBase(0x506B0B2CF20FAA8f38a4E2B524EE43e1f4458Cc5)
{
    ...
    constructor(){
        poolFee[0xfA3545f9Cca55088B30223bc86BE1AEe0F86eE62] = 100; //USDC-DAI
    ...
    function executeOperation(
        ...
        for (uint j = 0; j < _bdCollaterals.length; j++) {
            ...
            //Swapping any other ERC20 type for DAI
                ...
                IERC20(_bdCollaterals[j]).approve(address(swapRouter), collateralAmount);

                //Define Swap Params
                params =
                ISwapRouter.ExactInputSingleParams({
                    tokenIn: _bdCollaterals[j],
                    tokenOut: address(DAI),
                    fee: poolFee[_bdCollaterals[j]],
                    recipient: msg.sender,
                    deadline: block.timestamp,
