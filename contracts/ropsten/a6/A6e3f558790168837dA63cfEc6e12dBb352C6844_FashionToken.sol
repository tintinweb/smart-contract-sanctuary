...
// File: contracts/FFashionToken.sol

// SPDX-License-Identifier: MIT
pragma solidity >=0.4.22 <0.8.0;


contract FashionToken is StandardToken {
  /*
  NOTE:
  ...
  */
  ...
  constructor() public {
    ...
    name = "Fashion Finance";             // Set the name for display purposes
    decimals = 18;                                 // Amount of decimals for display purposes
    symbol = "FSH";                               // Set the symbol for display purposes
  }
}