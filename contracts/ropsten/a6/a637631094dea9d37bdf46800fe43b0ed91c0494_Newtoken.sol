...
contract Newtoken is ERC20 , ERC20Detailed , ERC20Pausable , ERC20Mintable , ERC20Burnable , ERC20Capped  
{
    constructor (uint256 _totalsuply , string memory _name, string memory _symbol , uint8 _decimals , uint _cap)
