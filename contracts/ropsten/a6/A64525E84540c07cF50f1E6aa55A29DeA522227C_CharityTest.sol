...
contract CharityTest is Context, IERC20 {
    ...
    string constant private _name = "Charity Test";
    string constant private _symbol = "CHARITYTEST";
    ...
    // PCS ROUTER
    //address private _routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //mainnet
    address private _routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //testnet

    address constant public DEAD = 0x000000000000000000000000000000000000dEaD;
    address payable private _marketingWallet = payable(0x6cDF92E465947e4771621268D6DA078A5EBA657B);
    address payable private _developmentWallet = payable(0x9D0faeeB5a2Fd0d4e11AD9fF0EC19DaEB5F40EaA);
    address payable private _buybackWallet = payable(0xcdfBB4B1329d728Cbb1bC999f3E2B3E01A1994eA);
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 development, uint16 buyback) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.development = development;
        _ratios.buyback = buyback;
        _ratios.total = liquidity + marketing + development + buyback;
    }
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0) {
            ...
            _developmentWallet.transfer((currentBalance * _ratios.development) / (_ratios.total - _ratios.liquidity));
            _buybackWallet.transfer((currentBalance * _ratios.buyback) / (_ratios.total - _ratios.liquidity));
