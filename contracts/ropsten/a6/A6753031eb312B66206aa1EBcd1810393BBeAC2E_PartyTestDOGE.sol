...
contract PartyTestDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x52216d36A48b1A2fb3698C9793BD8C160D3C4ED0); // Marketing Address
    ...
    string private _name = "PTDOGE";
    string private _symbol = "PTDOGE";
