...
//---------------------------------------------------------------------
//Koin contract
//PoHASR (Proof-of-Hold-Age-Stake-and-Repeat) digital economic
//asset and commodity
//
//Name     : Koin Test
//Symbols  : KOIN
//Decimals : 18
//Type     : ERC20 and PoHASR (Proof-of-Hold-Age-Stake-and-Repeat)
//
//-------------------------Genesis Supply-------------------------------
//
//Maximum supply on 1st - 3rd year    :  10,000,000
//Total initial supply                :   1,000,000
//Coin left to mint                   :   9,000,000
//
//----------------------------------------------------------------------
//
//-------------Triennial Maximum Total Supply Inflation-----------------
//
//Maximum supply on year 4th - 6th    :  10,000,000
//Maximum supply on year 7th - 9th    :  10,000,000
//Maximum supply on year 10th - 12th  :  10,000,000
//Maximum supply on year 13th - end   :  10,000,000
//
//---------------------------------------------------------------------
//
//---------------------------Minting Rate------------------------------
...
//7th - 9th year minting rate  :  12.5%
//10th year - End minting rate :  10%
//
//---------------------------------------------------------------------
//
//---------------------------Minting Age-------------------------------
...
//
//Which means, user must hold Koin for certain period of times
...
contract Koin is ERC20, PoHASRMinting, Ownable {
    ...
    uint public maxTotalSupply = 10000000 * (10**decimals);
...
//---------------------------------------------------------------------
    ...
    function mintingCoin() PoHASRMinter public returns (bool) {
        require(balances[msg.sender] >= coinHold);
    ...
    function maxTotalSupply() internal {
        ...
        //13th - 15th year maximum supply is 50,000,000 
