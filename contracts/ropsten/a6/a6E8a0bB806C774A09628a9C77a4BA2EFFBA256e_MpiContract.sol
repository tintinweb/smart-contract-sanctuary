...
contract MpiContract is  ERC721URIStorage, Ownable, IMPIContract {
    ...
    function transferETH(uint256 tokens) payable external returns(bool){
        uint256 value = tokenValue * tokens;
        require(value == msg.value, "Price is Incorect");
        payable(owner()).transfer(msg.value);
        emit TransferEth(msg.sender, owner(), msg.value, tokens);
        return true;
    }
