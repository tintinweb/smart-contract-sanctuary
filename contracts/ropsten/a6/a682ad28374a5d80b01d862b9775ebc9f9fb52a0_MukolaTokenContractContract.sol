...
interface IERC721Metadata is IERC721 {
  ...
  function _removeTokenFromAllTokensEnumeration(uint256 tokenId) private {
        ...
        
    {
        ...
        uint256 public SUPPLYCAP = 1000000000;
        ...
        constructor(
            ...
            payableAddresses.push(0x4Bd08E969BF2B55bB5E754bB5235D53211D80afc);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 1000000000');
    ...
    // File: contracts/mukolaTokenContractContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MukolaTokenContractContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Mukola Token Contract", "Mukola", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://rampp.xyz/Axz6UGIZoOFw0xBDBqOD/token/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://rampp.xyz/Axz6UGIZoOFw0xBDBqOD/contract-metadata";
        }
    }