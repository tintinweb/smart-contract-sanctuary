...
contract KeiCoinv3 is Context, IERC20, Ownable {
    ...
    uint256 public totalFeePercentage = _txFee + _burnFee;
    ...
    function reflect(uint256 tAmount) public {
        ...
        (uint256 rAmount,,,) = _getValues(tAmount, totalFeePercentage);
    ...
    function reflectionFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
        ...
        if (!deductTransferFee) {
            ...
            (,uint256 rTransferAmount,,) = _getValues(tAmount, totalFeePercentage);
    ...
    function updatetxFee(uint256 _newtxFee) external onlyOwner() {
        _txFee = _newtxFee;
    }
