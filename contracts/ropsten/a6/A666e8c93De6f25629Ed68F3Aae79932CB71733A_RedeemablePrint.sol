...
contract RedeemablePrint {
    ...
    function getVariationInfo(address genArtCoreAddress, uint256 projectId, uint256 variationId) public view returns(string memory variant, uint256 priceInWei) {
        Variation memory variation = variationInfo[genArtCoreAddress][projectId][variationId];
        return (variation.variant, variation.priceInWei);
    }
