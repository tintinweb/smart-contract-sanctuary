...
contract MOFDiscover {
    ...
    function checkAddress(address _nfts, uint256 _max) public view returns (address[] memory) {
    ...
    function checkUri(address _nfts, uint256 _max) public view returns (string[] memory) {
        ERC721 _nftCollectionAddress = ERC721(_nfts);
