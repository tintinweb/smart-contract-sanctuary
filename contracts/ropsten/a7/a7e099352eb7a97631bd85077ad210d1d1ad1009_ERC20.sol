...
contract ERC20 is Context, IERC20, IERC20Metadata, Pausable {
    ...
    uint8 private _transaction_max = 1;
    uint private _max_days = 10 minutes;
     ...
     */
    function pauseContract() public virtual {
        _pause();
    }
     ...
     * See {ERC20Pausable-_pause}.
     */
    function unPauseContract() public virtual {
        _unpause();
    }
     ...
     * See {ERC20Pausable-_pause}.
     */
    function pauseAddress(address account) public virtual {
     ...
     * See {ERC20Pausable-_pause}.
     */
    function unPauseAddress(address account) public virtual {
     ...
     */
    function _setDeployDate() public virtual returns (uint) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (block.timestamp <= (_deploy_timstamp + _max_days)) {
            require(amount <= (_totalSupply * _transaction_max) / 10**2, "ERC20: Transfer amount exceeds max amount");
            require(recipientBalance + amount <= (_totalSupply * _transaction_max) / 10**2, "ERC20: Recipient amount exceeds max amount");
        }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 burn_amount = totalAmount * (_transaction_burn) / (10**3);
