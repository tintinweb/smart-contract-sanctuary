...
library PairAddress {
    bytes32 public constant PAIR_INIT_CODE_HASH = keccak256(abi.encodePacked(type(PocketSwapPair).creationCode));
...
contract PocketSwapFactory is IPocketSwapFactory {
    ...
    bytes32 public constant INIT_CODE_HASH = keccak256(abi.encodePacked(type(PocketSwapPair).creationCode));
