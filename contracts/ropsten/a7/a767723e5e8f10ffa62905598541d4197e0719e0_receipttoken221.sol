...
contract receipttoken221 is ERC721Token {

  constructor() public ERC721Token("receipttoken221","receipttoken221") { }
  ...
  function create(address paid1, address paid2, address paid3, address paid4, address paid5, address paid6, address paid7, string FortuneCookie, string Letter) public payable returns (uint256 _tokenId) {
    ...
    //Emit The Token
    emit Create(_tokenId,msg.sender,UplinePaid,amt,FortuneCookie,Letter,tokenUri);
    return _tokenId;
  }
