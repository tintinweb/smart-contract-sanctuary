...
contract v2_test is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public _rewardThreshold = 1 ether; //threshold after which 20% of the BNB is taken to buy tokens, these tokens get burned

    uint256 _minTokenNumberToSell = _tTotal.mul(1).div(100000); // 0.001% max tx amount will trigger swap and add liquidity. Should always be lower than maxTxAmount!
    ...
    string private _name = "v2_test Token";
    string private _symbol = "v2_test";
    uint8 private _decimals = 9;

    address public charityWallet = address(0x173f47c48ED932a7f13FaC2d3bA3453035168F08); //to be changed!!
    ...
    uint256 public _maxTotalSupplyPrct = 10; // 1/10000 = 0.1%
    ...
    function set_rewardThreshold(uint256 rewardThreshold) public onlyOwner {
    ...
    function activateContract() public onlyOwner {
        ...
        set_rewardThreshold(20);

        // set _minTokenNumberToSell
        setMinTokenNumberToSell(100 * 10**12);
