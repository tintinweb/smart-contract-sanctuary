...
/**
🐶 Taghi Inu 🐶
$LittleShibaInu is one of the most innovative crypto projects to date, integrating charity with cryptocurrencies for a more impactful future.
Contract :
Website : http://inrichtingVUGHT.com/
TG : https://t.me/VUGHTRAAM23
✅ PCS LAUNCH
✅ WEBSITE LAUNCH
✅ LIQUIDITY LOCKED
✅ X100 POTENTIAL
...
contract TaghiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Taghi Inu";
    string private constant _symbol = "TANU";
    ...
    address payable private _marketingAddress = payable(0x28F21335F8CB52c30dC1989518D288E050bE6284);
    ...
    uint256 public _maxTxAmount = 7500 * 10**9; //0.75
