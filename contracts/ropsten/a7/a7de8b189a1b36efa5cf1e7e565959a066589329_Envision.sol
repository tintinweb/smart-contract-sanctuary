...
contract Envision is IERC20, Ownable {
    ...
    uint public burnWalletFee = 5;
    uint public poolWalletFee = 5;
    uint public marketingWalletFee = 5;
      ...
      returns (bool)
    {
        ...
        uint256 remainFee = 100 - burnWalletFee - poolWalletFee - marketingWalletFee;
        _balances[_to] = _balances[_to].add(_value.mul(remainFee).div(100));
        _balances[burnWalletAdress] = _balances[burnWalletAdress].add(_value.mul(burnWalletFee).div(100));
        _balances[poolWalletAddress] = _balances[poolWalletAddress].add(_value.mul(poolWalletFee).div(100));
        _balances[marketingWalletAddress] = _balances[marketingWalletAddress].add(_value.mul(marketingWalletFee).div(100));
        
        emit Transfer(msg.sender, _to, _value.mul(remainFee).div(100));
   ...
   function transferFrom(
      ...
      returns (bool) 
    {
        ...
        emit Transfer(_from, _to, _value.mul(remainFee).div(100));
