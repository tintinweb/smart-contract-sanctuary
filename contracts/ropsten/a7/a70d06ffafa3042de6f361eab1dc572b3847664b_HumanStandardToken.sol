...
contract HumanStandardToken is StandardToken {
    ...
    /*
    NOTE:
    We&#39;ve included the following variables as OPTIONAL vanities. 
    ...
    */
    ...
    function HumanStandardToken() {
		uint256 _initialAmount=1000000000000;
        balances[msg.sender] = _initialAmount;               // Give the creator all initial tokens
        totalSupply = _initialAmount;                        // Update total supply
        name = "Smart City Coin Test Net 3";                                   // Set the name for display purposes
        decimals = 2;                            // Amount of decimals for display purposes
        symbol = "SCCTN3";                               // Set the symbol for display purposes
    }
