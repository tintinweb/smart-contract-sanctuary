...
contract ILOTest18 is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "ILOTest18";
    string private m_Symbol = "ILO18";
    ...
    constructor () {
        ...
        ILO.init(10000000000000000, 1000, 500, m_ILOPublic);
        initTax();
