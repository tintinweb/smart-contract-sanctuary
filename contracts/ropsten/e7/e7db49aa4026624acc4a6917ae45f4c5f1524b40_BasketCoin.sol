...
contract BasketCoin is ERC20, Ownable {
    ...
    uint256 public preSaleRate = 1e4;                   // 10000 BSKT per 1 ETH
    ...
    function purchase() public payable {
        uint256 purchaseTokenAmount = msg.value.mul(preSaleRate);
        super._transfer(address(this), _msgSender(), purchaseTokenAmount);

        Purchased(_msgSender(), msg.value);
    }
