...
contract NDCtest is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'ATestV1';
    string  private constant _SYMBOL = 'Atest1';
    ...
    uint256 private _tTotal = 6900000000 * _DECIMALFACTOR;
    ...
    uint256 private _CHARITY_FEE = 200; // 2% TO CHARITY WALLET
    uint256 private constant _MAX_TX_SIZE = 69000000000 * _DECIMALFACTOR;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        bool takeFee = true;
        if (_isCharity[sender] || _isCharity[recipient] || _isExcluded[recipient] || _taxOff) {
            takeFee = false;
        }
