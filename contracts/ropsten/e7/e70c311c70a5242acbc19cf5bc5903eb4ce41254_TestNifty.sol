...
contract TestNifty is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public maxSupply = 10;
    uint256 public price = 7000000000000000;
    bool public saleOpen = false;
    bool public presaleOpen = false;
    string public baseURI;

    address devWallet = 0xdC0fc8e057BB7fFBBdebE3Eb3d3A433870b9C9b8;

    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Test Nifty', 'TNFT') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 2; i++) internalMint(to);
    }
