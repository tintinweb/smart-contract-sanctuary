...
contract Alabay is Context, IERC20, Ownable {
    ...
    string private _name = "Alabay";
    string private _symbol = "ALABAY";
    ...
    uint256 internal _tokenTotal = 100_000_000_000_000*(10**decimals());
    ...
    uint256 public _liquidityFee = 1; // means 1% adds to liquidity on each buy and sell
    uint256 public _burnFee = 2; // 2% burn fee however burn wallet receives redistribution 


    address liquidityWallet=0x20AeF1a2D8F8cE4032fD7C70093de3eCFC288E66;
