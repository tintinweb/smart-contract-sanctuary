...
*     90% to Buy Tokens from the exchange to be transferred to DDT Surplus and fund other DividendFacial Games
 ...
 * DDT Lending and other games can reuse this contract to support DividendFacial tokens
 */
...
contract DividendFacial {
    ...
    uint ACTIVATION_TIME = 1539282000;
    ...
    */
    ...
    /**
     * Sends FUND TAX to the FUND TAX addres. (Remember 90% of the Fund is used to support DDT Lending and other platform games)
     * This is the FUND TAX address that splits the ETH (90/10): https://etherscan.io/address/0xd9092D94F74E6b5D408DBd3eCC88f3e5810d1e98
     */
