...
contract kumb is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function kumb() {
        ...
        name = "kumb";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 10;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "kumb";                                             // Set the symbol for display purposes (CHANGE THIS)
