...
contract TelewaveCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TelewaveCoin() {
        ...
        name = "TelewaveCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TLC";                                             // Set the symbol for display purposes (CHANGE THIS)
