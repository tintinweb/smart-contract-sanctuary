...
contract mrmeme is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 100000000 * 10 ** uint256(_decimals);
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;
    uint256 public _tBurnTotal;

    string public constant _name = 'mrmeme';
    string public constant _symbol = 'mmmm';
    
    uint256 public _taxFee = 200;
    uint256 public _burnFee = 20;
    uint public _max_tx_size = 10000000 * 10 ** uint256(_decimals);
