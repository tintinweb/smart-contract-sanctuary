...
contract ERC20 is Context, IERC20 {
    ...
    function decreaseAllowance(address spender, uint256 substractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(substractedValue, "ERC20: decreased allowance below zero"));
        return true;
    }
...
contract Protocol is ERC20 {
    constructor () public ERC20("Protocol", "PRCL") {
