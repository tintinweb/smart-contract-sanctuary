...
contract EURO2020 {
    ...
    uint256 constant public PRICE_PER_UNIT = 0.03 ether;
    ...
    */
    ...
    function checkToken(address _address, string _team) public view returns (uint256){
    ...
    function getRemainingTokens(string _team) public view returns (uint256){
        return TEAM_MAP[_team];
    }
    
    function checkPayback(string _team) public view returns (uint256){
