...
contract MintableToken is StandardToken, Ownable {
    string public constant name = "Shano Token";
...
contract PHICrowdsale is Ownable, Crowdsale, MintableToken {
    ...
    address addressFundTeam = 0x769c65e4A7A2dc525bd02eD8eE465169862B7583;
    address addressFundAirdropPreIco = 0x769c65e4A7A2dc525bd02eD8eE465169862B7583;
    address addressFundAirdropIco = 0x769c65e4A7A2dc525bd02eD8eE465169862B7583;

    address addressFundBounty =  0x769c65e4A7A2dc525bd02eD8eE465169862B7583;
    address addressFundAdvisor = 0x769c65e4A7A2dc525bd02eD8eE465169862B7583;
    address addressFundReferal = 0x769c65e4A7A2dc525bd02eD8eE465169862B7583;
