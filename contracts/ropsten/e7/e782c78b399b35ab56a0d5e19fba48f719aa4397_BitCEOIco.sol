...
contract BitCEOIcoBase is Ownable {
  ...
  uint256 public REVERSE_WITHDRAW_PER_MONTH    = 11316666  * (10 ** uint256(decimals)); // 11.316.666 BCEO
  ...
  function convertIcoBalance100to70() public onlyOwner returns (bool) {
    require(Ico100PercentBalance >= 0);
    // Transfer amount BCEO from Ico100 to Ico70
    Ico70PercentBalance = Ico70PercentBalance.add(Ico100PercentBalance);
    Ico100PercentBalance = 0;
  }
...
contract BitCEOIco is BitCEOIcoBase {
  ...
  constructor() BitCEOIcoBase (
    [
      uint256(1525107600), //  May 1 st, 2019 00:00:00 GMT+07:00 WITHDRAW_BEGIN
      uint256(1525366799), //  May 3 rd, 2019 23:59:59 GMT+07:00 WITHDRAW_ETH_END
      uint256(1512061200), //  Dec 1 st, 2019 00:00:00 GMT+07:00 TEAM_WITHDRAW_BEGIN
      uint256(1512061200), //  Dec 1 st, 2018 00:00:00 GMT+07:00 REVERSE_WITHDRAW_BEGIN
      uint256(1511287871), //  Nov 22nd, 2018 01:11:11 GMT+07:00 PRESALE_WITHDRAW_BEGIN
      uint256(1512061200), //  Dec 1 st, 2018 00:00:00 GMT+07:00 ICO_BEGIN
