 ...
 */
contract Strips is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    */
    function mintStrip() public {
        require(mintIsActive, "Genesis strip minting is not active");
        require(!minted[msg.sender],"Only one Genesis strip mint per wallet is allowed");
        require(whitelisted[msg.sender],"Not eligible to mint Genesis strip");
        require(totalSupply().add(1) <= MAX_STRIPS, "Purchase would exceed max supply of Genesis strips");
