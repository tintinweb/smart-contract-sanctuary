...
contract ChosunCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ChosunCoin() {
        ...
        name = "Chosun Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "sun";                                             // Set the symbol for display purposes (CHANGE THIS)
