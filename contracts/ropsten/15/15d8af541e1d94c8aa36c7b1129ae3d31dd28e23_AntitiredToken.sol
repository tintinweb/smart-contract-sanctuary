...
contract AntitiredToken is StandardToken { 
    ...
    function AntitiredToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol)  payable {
