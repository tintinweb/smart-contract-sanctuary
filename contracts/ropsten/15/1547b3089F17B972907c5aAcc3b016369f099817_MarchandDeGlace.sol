    ...
    PausableUpgradeable
{
    ...
    function initialize(
        ...
        require(_ethPerGEL > 0, "Ether to Gel price cannot be settable to 0");
        require(
    ...
    function setEthPerGel(uint256 _ethPerGEL) external onlyProxyAdmin {
        ethPerGEL = _ethPerGEL;
    }
        ...
        nonReentrant
    {
        ...
        uint256 gelBought = _wmul(msg.value, ethPerGEL);
    ...
    function getGELToBuy(uint256 _ethToSell) public view returns (uint256) {
        return _wmul(_ethToSell, ethPerGEL);
    }
