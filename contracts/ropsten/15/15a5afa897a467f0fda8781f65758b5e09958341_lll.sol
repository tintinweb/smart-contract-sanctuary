...
// ----------------------------------------------------------------------------
// 'Bank lll'  token contract
//
// Symbol      : 'lll'
// Name        : 'Bank lll'
// Total supply: '13000000'
// Decimals    : '20'
// ----------------------------------------------------------------------------
...
contract lll is BurnableToken {

    string public constant name = "Bank lll";
    string public constant symbol = "lll";
    uint public constant decimals = 20;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 13000000 * (10 ** uint256(decimals));
