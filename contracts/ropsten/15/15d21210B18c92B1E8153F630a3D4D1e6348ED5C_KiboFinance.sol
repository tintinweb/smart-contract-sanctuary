...
contract KiboAdmin is Ownable, KiboStorage, KiboUniswap {
    ...
    function enableUnderlying(address _underlying, address _cToken, bool _stakeCollateral, address _priceConsumer) external onlyOwner {
    ...
    function disableUnderlying(address _underlying) external onlyOwner {
