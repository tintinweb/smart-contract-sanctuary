...
contract KiboAdmin is Ownable, KiboStorage, KiboUniswap {
    ...
    function _setFinalPriceAtMaturity(address _optionAddress) external onlyOwner {
        ...
        uint256 spotPrice = KiboConstants.priceConsumer.getSpotPrice(IKToken(_optionAddress).getUnderlying()); // In USD, 8 decimals
...
library KiboConstants {
    ...
    PriceConsumer constant public priceConsumer = PriceConsumer(0x7D63b2D4998616931b1512C6d091ED535d25157D);
}
