 ...
 * VA Dollar Digital
 * € VAD = € Euro
 * SmartContract: contract.VAD.digital
 * website : www.VAD.Digital
 * Phone : +61. 420 252 759
...
// Owned contract ([email protected])
...
contract DUC1 is ERC20Interface, Tokenlock, UserLock {
    ...
    constructor() public {
        ...
        name = "DUC1.VAD.digital";

        decimals = 2;

        _totalSupply = 3 * 10**uint(decimals);
