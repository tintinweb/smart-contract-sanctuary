...
contract testbinopt {
    ...
    function addGameInQueue() private {
        Games.push(Game(0, 0, 0, 0, 0, false, 0, 0, 0, 0, false));
    }
    ...
    function NextCurrentGame() external {
        ...
        game2.startTimestamp = block.timestamp + transactionTime + intervalSeconds;
        game2.endTimestamp = game2.startTimestamp + intervalSeconds;
