...
Telegram: https://t.me/KyobuOfficial
Website: https://kyobu.io 

Kyōbu are celestial fox spirits with lush purple fur and full, fluffy tails reminiscent of lavender petals. They are holy creatures, and bring happiness and blessings to those around them.

With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, Kyōbu was designed to reward holders and discourage dumping.
...
interface IUniswapV2Router02 {
    ...
    contract freakertest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"frekertest";
    string private constant _symbol = "frktr";
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                ...
                if (sellnumber[from] == 0) {
                    ...
                    sellnumber[from]++;
                    sellcooldown[from] = block.timestamp + (2 seconds);
                }
                    ...
                    sellnumber[from]++;
                    sellcooldown[from] = firstsell[from] + (2 seconds);
                }
