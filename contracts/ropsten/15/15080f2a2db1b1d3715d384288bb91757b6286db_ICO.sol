...
contract ICO is Pausable{
    ...
    public {
        ...
        minPurchase = _minPurchase; // minPurchase in eth
    ...
    function buyPrivateSale()
        ...
        privateSaleActive() 
    {
        uint256 totalUserETH = (msg.value/1e18);
        
        require(
          totalUserETH >= (minPurchase/1e18), 
          'have to buy between minPurchase and maxPurchase'
        );
        uint tokenAmount = totalUserETH.div(tokenPrice/1e18);
        require(
