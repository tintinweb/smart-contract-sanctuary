...
contract Degen is Router, Ownable {
   ...
   modifier onlySystem() {
    ...
    function executeCrossExchange(
        ...
        processFee(feesPrice[0], feesPrice[1], proccessingFee, licenseeVault, msg.sender);
    }
