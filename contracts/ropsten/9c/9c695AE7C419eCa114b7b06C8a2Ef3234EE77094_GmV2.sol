...
contract GmV2 is ERC721, IERC1155Receiver, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public maxNormalTokens = 7; // v2 tokens that correspond directly to existing v1 tokens
    uint256 public maxSpecialTokens = 3; // special edition 1/1 tokens that can be created from burned tokens
