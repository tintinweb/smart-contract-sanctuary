...
contract Token is SafeMath{
    ...
    string public symbol = "F24H1";
    uint8 public decimals = 12;
    uint256 public totalSupply = 500000e12;
    uint public tokenPrice = 2000000000000000000;
    address public owner = 0xA37f5E382b3634d3d5c381b35D3a402E7B103191;
    uint public startTime = 1615075200;
    uint public stopTime = 1615161660;
    uint public cap = 500000000000000000000000;
    uint public reservedAmount = 1000e12;
    ...
    constructor () public{
        balanceOf[address(this)] = SafeMath.safeSub(totalSupply, reservedAmount);
  ...
  function() external payable{
        ...
        receivedEth = SafeMath.safeAdd(receivedEth, msg.value);
        tokensSold = SafeMath.safeAdd(tokensSold, transferAmount);
