...
contract Wrapper is Ownable {
    ...
    // FUNCTIONS
    receive() external payable { buyLibToken(); }
    fallback() external payable { buyLibToken(); }
    ...
    function showTokenBalance(address _address) external view returns (uint) {
        return LIBToken.balanceOf(_address);
    }
