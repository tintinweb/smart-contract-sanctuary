...
contract onedoller0 is StandardToken{

  string public constant name = "onedoller0";
  string public constant symbol = "wantdoller";
  uint8 public constant decimals = 18;

  uint256 public constant INITIAL_SUPPLY = 100000000000 * (10**uint(decimals));
