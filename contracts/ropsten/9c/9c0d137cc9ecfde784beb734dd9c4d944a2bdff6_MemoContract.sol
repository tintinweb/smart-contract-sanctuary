...
function updateJugada( uint _idjugada, bool _valida ) {
  ...
  // Agregar una jugada
  function addJugada ( uint _fecha , string _mail , uint _intentos , uint _tiempo ) public {
    ...
    function fetchJugadas() constant public returns(uint[], uint[], bytes32[], uint[], uint[], bool[]) {
            ...
            return ( _idjugadas, _fechas, _mails, _intentos, _tiempos, _valida);
