...
contract matrixplay {
    ...
    constructor() public {
        ...
        dev_stak_address = 0xc122e5a96104a11e8BE06d954d64351Aa8bd7F7a;
        ...
        cycles.push(0x2540BE400); //10K
        cycles.push(0xBA43B7400); //50K
        cycles.push(0x174876E800); //100K
        cycles.push(0x746A528800); //500K
        cycles.push(0xE8D4A51000); //1M
    }
    ...
    */
    ...
    function transferToDevFund() external {
        ...
        tokenContract.safeTransfer(dev_stak_address,devfund[msg.sender].total_fund);
    ...
    function depositToken(address _upline) external
    {
       ...
       uint256 dev_fund = (_amount * 15 /100); 
        ...
        tokenContract.safeTransfer(admin_fee,chain_fun_amount);
