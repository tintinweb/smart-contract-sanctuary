...
contract HARAMBE is ERC20 {
  ...
  string public override name = '(harambe.me)';
  string public override symbol = 'HARAMBE &#128053;';

  address private constant UNISWAP_ROUTER = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
  address private constant WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

  uint private constant SUPPLY = 1e7 ether;
  ...
  function _beforeTokenTransfer (
    ...
    if (from == _pair) {
      ...
      cooldownOf[to] = block.timestamp + (3 minutes);
