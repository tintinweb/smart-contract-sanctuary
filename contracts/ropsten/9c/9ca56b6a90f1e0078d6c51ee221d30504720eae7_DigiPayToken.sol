...
contract DigiPayToken is StandardToken, Ownable, TokenSaleKYC, Pausable {
  ...
  bool    public   locked;
    ...
    function _setTimes() internal {   
        presaleStartTime          = 1540408500; // 01st Nov 2018 09:00:00 GMT
        presaleEndTime            = 1540461600; // 29th Nov 2018 08:59:59 GMT
        mainsaleStartTime         = 1540472400; // 20th Dec 2018 09:00:00 GMT
        mainsaleEndTime           = 1540904340; // 24th Jan 2019 08:59:59 GMT
    }
    ...
    function _getTokenAmount(uint256 _weiAmount) internal view returns (uint256) {
        ...
        if(now >= mainsaleStartTime && now < (mainsaleStartTime + 1 days)) {
            RATE = 6000; // @dev 1 ETH = 6000 DIP
        }
        
        if(now >= (mainsaleStartTime + 1 days) && now < (mainsaleStartTime + 2 days)) {
            RATE = 5750; // @dev 1 ETH = 5750 DIP
        }
        
        if(now >= (mainsaleStartTime + 2 days) && now < (mainsaleStartTime + 3 days)) {
            RATE = 5500; // @dev 1 ETH = 5500 DIP
        }
        
        if(now >= (mainsaleStartTime + 3 days) && now < (mainsaleStartTime + 4 days)) {
            RATE = 5250; // @dev 1 ETH = 5250 DIP
        }
        
        if(now >= (mainsaleStartTime + 4 days) && now <= mainsaleEndTime) {
