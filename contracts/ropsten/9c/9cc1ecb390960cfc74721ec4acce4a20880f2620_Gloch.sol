...
//--------------------------------------------------------------------------------------
//GLOCH (aGe, bLOck, epoCH) Minting Protocol 
//Author, constructed, recoded and assembly by Azreh Ahargun
//Twitter @azrehargun
//LinkedIn https://linkedin.com/azrehargun
//Donate : 0x8Cb1ebF174d6c4BC22217c3E5e75aDD4934f6418
//--------------------------------------------------------------------------------------
...
contract Gloch is ERC20, ERC20Detailed,
    ...
    address internal contractOwner = 0x8Cb1ebF174d6c4BC22217c3E5e75aDD4934f6418;
    
    //Vault wallet locked automatically until specified time 
    
    address internal vaultWallet = 0xc282D909A860130D564Ab284a8C004F492Fbe3e4;
    ...
    constructor() public ERC20Detailed("Gloch","GLOCH", 18){
        owner = msg.sender;
...
//--------------------------------------------------------------------------------------
    ...
    function transfer(address to, uint256 value) onlyPayloadSize(2 * 32) external returns (bool) {
        ...
        require(balances[msg.sender] >= value, "Token holder does not have enough balance");
