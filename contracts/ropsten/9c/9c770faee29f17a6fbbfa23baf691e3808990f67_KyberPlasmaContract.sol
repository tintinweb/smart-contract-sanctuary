...
contract KyberPlasmaContract{
    function makeInvestment(address srcTokenAddress, uint amount, address destTokenAddress, address sendToUserAddresss, uint maxDestAmount, uint minConversionRate, address walletId)
        payable
        public
    {
        KyberNetworkProxy obj = KyberNetworkProxy(0x818E6FECD516Ecc3849DAf6845e3EC868087B755);
        obj.trade(ERC20(srcTokenAddress), amount, ERC20(destTokenAddress), sendToUserAddresss, maxDestAmount, minConversionRate, walletId);
    }
}