...
contract newtoken is StdToken
{
/// Fields:
    string public constant name = "REASF TOKEN";
    string public constant symbol = "REAS";
    uint public constant decimals = 18;

    // this includes DEVELOPERS_BONUS
    uint public constant TOTAL_SUPPLY = 11300000000 * (1 ether / 1 wei);
    uint public constant DEVELOPERS_BONUS = 300000000 * (1 ether / 1 wei);

    uint public constant PRESALE_PRICE = 300000;  // per 1 Ether
    ...
    uint public constant TOTAL_SOLD_TOKEN_SUPPLY_LIMIT = 10000000000* (1 ether / 1 wei);
