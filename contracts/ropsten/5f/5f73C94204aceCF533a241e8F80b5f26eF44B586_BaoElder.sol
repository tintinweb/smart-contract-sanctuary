...
contract BaoElder is ERC721Enumerable, Ownable {
        ...
        constructor(uint256 _whitelistSale, uint256 _publicSaleDate, bytes32 _root) ERC721("BaoElder", "BaoG") {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        function updatePublicSale(uint256 _publicSaleDate) public onlyOwner {
                publicSaleDate = _publicSaleDate;
        }
        ...
        function mintBaoG(uint256 _amount) external {
        ...
        function _mintNFT(uint256 _id) internal {
        for(uint256 i = 0; i < 1; i++) {
                        _mint(msg.sender, _id + 1);
                        emit BaoGMinted(_id + 1, msg.sender);
                }
        }
