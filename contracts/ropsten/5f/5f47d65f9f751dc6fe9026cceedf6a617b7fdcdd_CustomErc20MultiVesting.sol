...
abstract contract Erc20MultiVesting is Context, Ownable {
     ...
     */
    function releaseFor(address beneficiary) public onlyOwner {
...
contract CustomErc20MultiVesting is Erc20MultiVesting {
     ...
     * @param allocation_ beneficiary allocation
     */
    function allocate(allocation memory allocation_) public onlyOwner {
        require(_allowAllocate, "contract does not allow to allocate");
        _allocate(allocation_.beneficiary, allocation_.amount);
    }
