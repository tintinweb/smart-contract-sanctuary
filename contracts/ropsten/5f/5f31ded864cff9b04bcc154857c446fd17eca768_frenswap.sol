...
contract frenswap is Ownable {
    ...
    */
    ...
    function TESTgetCurrentBid() public view returns(uint256, uint256, uint256, uint256, uint256) {
        /**
        ...
        */
        ...
        return(currentBidAmount, hoursSinceBidAccepted, calculatedBidAmount, maximumPossibleBid, address(this).balance);
    }
