...
contract IFTK is ERC721Token, ERC165, Whitelist {
  ...
  */
  ...
  /**
   * @dev Throws if not called by a IFTK token holder
   */
  ...
  /**
   * @dev Utility function for updating a IFTK assets token URI
   * @dev Reverts if not called by management
   * @param _tokenId the IFTK token ID
  ...
  /**
   * @dev Return blockhash of the IFTK token
   * @param _tokenId the IFTK token ID
   */
