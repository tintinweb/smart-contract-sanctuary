...
contract Nixel is ERC721Enumerable, Ownable {
    ...
    event MintNixel(address indexed sender, uint256 startWith, uint256 times);
    ...
    function mint(uint256 _times) payable public {
        ...
        require(totalBlocks + _times <= totalCount, "max supply reached!");
        require(msg.value == _times * price, "value error, please check price.");
        payable(owner()).transfer(msg.value);
        emit MintNixel(_msgSender(), totalBlocks+1, _times);
