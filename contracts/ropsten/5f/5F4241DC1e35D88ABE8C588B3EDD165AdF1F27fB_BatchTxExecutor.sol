...
contract BatchTxExecutor is Ownable {
     ...
     */
    function addTransaction(address destination, uint256 value, bytes calldata data) external onlyOwner {
        transactions.push(Transaction({enabled: true, destination: destination, value:value, data: data}));
    }
