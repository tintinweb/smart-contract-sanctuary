...
//VIEW FUNCTIONS
    function getUnSoldNFTs(address _nftContract, uint256 _fromSaleId) external view returns(uint256, Sale[10] memory){
        uint256 toSaleId = whitelistedContracts[_nftContract].totalListed;
    ...
    // function totalNFTListed(address _nftContract) external view returns(uint256, uint256, uint256){
    //     uint256 totalListedLast24Hours = 0;
    //     uint256 totalListedLast7Days = 0;
    //     uint256 totalListedLast30Days = 0;
    //     uint256 currentTime = block.timestamp;
    //     for(uint256 i = whitelistedContracts[_nftContract].totalListed; i >= 1; i--){
    ...
    // function totalUnsold(address _nftContract) external view returns(uint256, uint256, uint256){
