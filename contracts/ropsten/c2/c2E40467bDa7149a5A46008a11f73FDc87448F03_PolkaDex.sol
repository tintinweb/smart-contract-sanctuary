...
contract PolkaDex is ERC20 {
    ...
    constructor() ERC20("Polkadex", "PDEX", 20000000) {
        ...
        //transferFrom(address(this), owner, 100);
    ...
    // function addMemberToAdvisors(address memberAddress) public onlyOwner returns (bool) {
    //     require(memberAddress != address(0));
    ...
    // function deleteMemberFromAdvisors(address memberAddress) public onlyOwner returns (bool) {
    //      require(memberAddress != address(0));
    ...
    // function addMemberToPartnerships(address memberAddress) public onlyOwner returns (bool) {
    //     require(memberAddress != address(0));
    ...
    // function deleteMemberFromPartnerships(address memberAddress) public onlyOwner returns (bool) {
    //      require(memberAddress != address(0));
    ...
    // function addMemberToInvestors(address memberAddress) public onlyOwner returns (bool) {
    //     require(memberAddress != address(0));
    ...
    // function deleteMemberFromInvestors(address memberAddress) public onlyOwner returns (bool) {
    //      require(memberAddress != address(0));
    ...
    //         if(compareStrings(investors[memberAddress], "seed")) {
    //             investorsSeedMemberCounter -= 1;
    //         } else if (compareStrings(investors[memberAddress], "strategic")) {
    //             investorsStrategicMemberCounter -= 1;
    //         } else if (compareStrings(investors[memberAddress], "private")) {
    //             investorsPrivateMemberCounter -= 1;
    //         }
