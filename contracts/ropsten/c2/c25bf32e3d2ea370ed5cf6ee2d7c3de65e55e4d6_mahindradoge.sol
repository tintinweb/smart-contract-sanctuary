...
contract mahindradoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "mahindradoge | t.me/mahindradogeToken";
    string private constant _symbol = "mahindradoge";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isExcludedFromFee[to] && cooldownEnabled) {
                ...
                cooldown[to] = block.timestamp + (20 minutes);
            }
