...
contract IndexC1 is ERC20, Ownable {
  ...
  uint256 internal constant CONVERSION_RATE = 100000000000000000; // 10 tokens per Ether
  ...
  function enterMarket() public payable {    
    ...
    // Compute the LP Tokens for the given deposit
    uint256 lpTokens = totalEther.div(CONVERSION_RATE);
  ...
  function exitMarket() public {
    ...
    // Compute the LP Tokens for the given withdraw
    uint256 lpTokens = totalEther.div(CONVERSION_RATE);
