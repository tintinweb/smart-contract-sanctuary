...
contract test is BEP20 {
    ...
    modifier antiWhale(address sender, address recipient, uint256 amount) {
        if (maxTransferAmount() > 0) {
            require(amount <= maxTransferAmount() && _excludedFromAntiWhale[sender] == false && _excludedFromAntiWhale[recipient] == false, "DYN::antiWhale: Transfer amount exceeds the maxTransferAmount");
        }
        _;
    }
     ...
     */
    constructor() public BEP20("test7", "test7") {
