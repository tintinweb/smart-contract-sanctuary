...
library LibAddress {
    ...
    bytes32 private constant _ADDRESS_STORAGE =
        keccak256("diamond.standard.address.storage");
    ...
    function addressStorage()
        internal
        pure
        returns (AddressStorage storage srs)
    {
