...
contract MultiSigWalletWithTimeLockWithCustomValues is MultiSigWalletWithCustomTimeLocks {
    ...
    constructor(address[] _owners, uint _required, uint _secondsTimeLockedDefault)
        public
        MultiSigWalletWithCustomTimeLocks(_owners, _required, _secondsTimeLockedDefault)
    {
