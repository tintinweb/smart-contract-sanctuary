 ...
 */
contract lilitoken is StandardToken, Ownable {
...
contract DatCrowdPreSale is Ownable {
  ...
  uint256 public minimumParticipationAmount = 1000000000000000000 wei; //0.01 ether

  // Maximum amount to participate
  uint256 public maximalParticipationAmount = 50000000000000000000000 wei; //5000 ether
...
// creates the token to be sold. 
  ...
  function createTokenContract() internal returns (lilitoken) {
    return new lilitoken();
}
