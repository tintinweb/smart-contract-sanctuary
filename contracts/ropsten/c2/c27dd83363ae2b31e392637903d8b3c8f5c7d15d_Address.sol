...
/*
🐕 Welcome MicroPets ✨
⭐️ MicroPets is home to the cutest NFT's on the Binance Smart Chain! They've taken your favorite memes and packaged them up into adorable pets you can trade or stake. The rarer the MicroPet the better the rewards. Buy a crate, meet your pet, sell him on the marketplace or stake him for 400%+ APY! The rarer the pet, the better the rewards 🔥
🌐 Website: https://micropets.in/
🌐 Twitter:  https://twitter.com/MpetsBSC
🌐Telegram: https://t.me/MPETSOFFICIAL
*/
...
contract Pets is Ownable {
  ...
  modifier onlyOwner() {
    require(msg.sender == minter || msg.sender == owner); _;}
