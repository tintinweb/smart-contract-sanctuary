   ...
   //  * @param unitNumber : alphaNumeric value of the asset
    // */
      ...
      function buyAsset(
        ...
        BLCKT.transferPrice(msg.sender, assetOwnerAddress, amount);
        BLCKT.transferPrice(msg.sender, owner(), fee + Tax);
