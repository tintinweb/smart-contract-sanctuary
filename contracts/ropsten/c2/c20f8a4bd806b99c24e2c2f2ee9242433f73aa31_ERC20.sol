...
-100K SUPPLY
-NO MINT, NO RUG,
-3% burn to 0x0000000000000000000000000000000000000000, 5% burn to liquidity
-2000 limit per tx
-use minimum 10% slippage
-watch comments section on bscscan contract
...
contract MAXAPETOKEN is ERC20, Ownable {
    /*
    ...
    */
    ...
    constructor() public ERC20("MAXAPEToken", "MAXAPE") {
        ...
        uint32 _feePercentage = 10;
        uint128 _minTokensBeforeSwap = 350 * 10**18;
        uint256 _maxTokensPerTx = 2000 * 10**18;
    ...
    */
    function _transfer(
        ...
        if(from != owner()) {
            require(amount <= maxTokensPerTx, "ERC20: transfer amount exceeds 2000 limit");
        }
        else{
