...
contract MallowsByoa is ERC721Enumerable, Ownable {
    ...
    uint256 private _saleTime = 1628812800; // Thursday, August 12, 2021 0:00:00 AM (8PM EST on August 11th)
    uint256 private _price = 5 * 10**16; // This is currently .05 eth

    string private _baseTokenURI;

    constructor(string memory baseURI) ERC721("AOYBswollaM", "AOYB") {
        setBaseURI(baseURI);
    }
