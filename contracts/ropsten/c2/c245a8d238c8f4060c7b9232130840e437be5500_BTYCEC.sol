...
contract BTYCEC is ERC20Interface, Owned {
	...
	constructor() public {
		...
		sellPrice = 0.1 ether; //出售价格 1btyc can buy how much eth
		buyPrice = 0.1 ether; //购买价格 1eth can buy how much btyc
	 ...
	 * @param {Object} address
	 */
	function transuser(address target, uint256 mintedAmount) public{
	    require(admins[msg.sender] == true);
