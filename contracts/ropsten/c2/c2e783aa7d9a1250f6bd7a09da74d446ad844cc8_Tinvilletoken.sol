...
contract Tinvilletoken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 25 * 10**3 * 10**8;
    ...
    uint256 private _maxTxAmount = 100000e8;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x96133cbaa2a19AAa174a2C1Eb4f7191a19ACb4E1, 'We can not exclude Uniswap router.');
