...
import {ImmutableMintableERC721} from "../interfaces/ImmutableSpec.sol";
import "./ERC721Asset.sol";

/**
 * @title Immutable ERC721 Asset
 *
 * @notice IMX compatible ERC721 Asset
 *
 * @author Basil Gorin
 */
abstract contract ImmutableERC721Asset is ImmutableMintableERC721, ERC721Asset {
	/**
	 * @dev Creates/deploys an Immutable ERC721 asset
	 *
	 * @param _name asset name (ERC721Metadata)
	 * @param _symbol asset symbol (ERC721Metadata)
	 */
	constructor(string memory _name, string memory _symbol) ERC721Asset(_name, _symbol) {}
	...
	function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
		...
		return interfaceId == type(ImmutableMintableERC721).interfaceId || super.supportsInterface(interfaceId);
	}

	/**
	 * @inheritdoc ImmutableMintableERC721
	 *
	 * @dev Role ROLE_TOKEN_CREATOR must be granted to Immutable X contract:
	 ...
	 */
	function mintFor(address to, uint256 id, bytes memory mintingBlob) public virtual override {
		// mintingBlob is not used by base impl
 ...
 * @author Basil Gorin
 */
abstract contract ERC721Asset is ERC721Enumerable, ERC721URIStorage, AccessControl {
	/**
	 ...
	 * @dev Example value: 0x6b321616d2290b9c4f49275beb592a618d1d59773ac7b08da77a6a519a3298fb
	 */
	...
	/**
	 * @dev Creates/deploys an ERC721 asset
	 *
	 * @param _name asset name (ERC721Metadata)
	 * @param _symbol asset symbol (ERC721Metadata)
	 */
	 ...
	 */
	function safeMint(address _to, uint256 _tokenId, bytes memory _data) public virtual {
