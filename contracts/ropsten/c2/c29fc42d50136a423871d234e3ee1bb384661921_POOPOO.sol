...
contract POOPOO is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function POOPOO() {
        ...
        name = "POOPOO";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "POOPOO";                                             // Set the symbol for display purposes (CHANGE THIS)
