...
//
// Deployed to : 0xd543EeF9084BAa016C164c5D5547A7ac896b2f2E
// Symbol      : DIIP
// Name        : DiipCoin
// Decimals    : 0
//
...
contract DiipCoin is ERC20Interface, Owned, SafeMath {
    ...
    function DiipCoin() public {
        ...
        balances[0xd543EeF9084BAa016C164c5D5547A7ac896b2f2E] = _totalSupply;
        emit Transfer(address(0), 0xd543EeF9084BAa016C164c5D5547A7ac896b2f2E, _totalSupply);
