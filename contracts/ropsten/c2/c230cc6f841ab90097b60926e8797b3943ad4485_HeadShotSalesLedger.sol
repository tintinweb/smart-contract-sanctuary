...
contract HeadShotSalesLedger is Context, IERC20, Ownable {
    ...
    function buy(address account_, uint256 code_, uint256 count_) public returns (bool) {
    ...
    function spend(address account_, uint256 code_, uint256 count_) public returns (bool) {
        if (getSalesCode(code_) == code_){
