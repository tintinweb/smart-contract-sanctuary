...
contract HOWL is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 900 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HOWL.FI";
    string private _symbol = "HOWL";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 6;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 3; //(1.5% LP Burn, 0.75% Buyback Burn, 0.75% Marketing Wallet)
    ...
    uint256 public _maxTxAmount = 900 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 90 * 10**3 * 10**9;
    ...
    constructor () public {
        ...
        buyback = 0xF5430813877DC1f886D8Ef033A324b217a668dC8;
        marketing= 0xAE5D4bdC53816D91140786dc15D7458247eC26f8;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquiditys = contractTokenBalance.div(2);
        uint256 buybacks = contractTokenBalance.div(4);
        uint256 marketings = contractTokenBalance.div(4);
        uint256 half = liquiditys.div(2);
        uint256 otherHalf = liquiditys.sub(half);
        uint256 initialBalance = address(this).balance;
        swapTokensForEth(half.add(buybacks).add(marketings)); 
