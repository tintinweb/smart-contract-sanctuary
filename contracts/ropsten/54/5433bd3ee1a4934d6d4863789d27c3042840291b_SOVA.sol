...
// token transfers
// ----------------------------------------------------------------------------
contract SOVA is IERC20, Owned {
    using SafeMath for uint256;

    string public symbol = "SOVA";
    string public  name = "SOVA";
    uint256 public decimals = 18;
    uint256 _totalSupply = 1500000 * 10 ** (decimals);

    uint256 unLockPercentage = 10; // 10 percent per month
    uint256 unLockPeriod =  30 minutes; // per month
