...
contract IceBreakR is Context, IERC20, Ownable {
    ...
    string private _name = "IceBreak-R";
    string private _symbol = "ICEBRK";
    ...
    address payable public sendWallet1;
    address payable public sendWallet2;
    
    function setSendWallets(address payable _sendWallet1, address payable _sendWallet2) public onlyOwner {
        sendWallet1 = _sendWallet1;
        sendWallet2 = _sendWallet2;
    }
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public lockTheSwap {
        ...
        uint256 tenth = contractTokenBalance.div(10);
        swapTokensForEth(tenth.mul(4));
        _tDonationTotal = _tDonationTotal.add(tenth.mul(2));
        
        TransferCharityETH(sendWallet1, (address(this).balance).div(2));
        TransferCharityETH(sendWallet2, address(this).balance);
