...
abstract contract Pausable is Context {
     ...
     */
    modifier whenPaused() {
        require(isPaused(), "LOOP: not paused");
        _;
    }
...
contract LOOP is Context, IERC20, Pausable, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, uint8 decimals_, address _Owner, uint256 _totalReflection) {
        ...
        _rOwned[_Owner] = _rOwned[_Owner].add(_totalReflection.mul(currentRate));
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual {
        ...
        require(!isPaused(), "LOOP: token transfer while paused");
    }
}