...
// File contracts/sone-token-sale/WhitelistRoleUpgradeable.sol
...
// File contracts/sone-token-sale/MutiSenderUpgradeable.sol
...
// File contracts/sone-token-sale/SoneToken.sol
...
contract SoneToken is Initializable, OwnableUpgradeable, ERC20Upgradeable, ERC20CappedUpgradeable, ERC20BurnableUpgradeable, WhitelistRoleUpgradeable, MutiSenderUpgradeable {
    ...
    function __SoneToken_init(uint256 lockFromBlock_, uint256 lockToBlock_, address dev_) public initializer{
        _cap = 100000000e18;
        ...
        __WhitelistRole_init();
        __MutiSenderUpgradeable_init(dev_, address(this));
    }
