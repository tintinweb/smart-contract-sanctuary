...
contract ERC20 is Context, IERC20, IERC20Metadata {
	...
	//address 0x3737373737373737373737373737373737373737 will be used as a crematoryum of tokens
	//if a user wants to burn tokens, they will send tokens to crematorium 
	//ones a month, this function will called and burn tokens inside
    function Crematorium(uint256 amount) public virtual {
     require(block.timestamp > _burningtime ,"Burning time not reached, tokens are resting in crematoryum");
