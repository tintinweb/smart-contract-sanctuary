...
contract ATHLON_TOKEN is ERC20 {
    ...
    string public constant name = "ATHLON";
    string public constant symbol = "0xATH";
    ...
    address multisig = 0x014f733ba0769003360cf070a584d98403f5a6be;
    ...
    function ClaimAirdrop(address _participant, uint _amount) public onlyOwner {        
        doAirdrop(_participant, _amount);
    }

    function ClaimAirdropMultiple(address[] _addresses, uint _amount) public onlyOwner {        
