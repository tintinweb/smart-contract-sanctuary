...
contract chainlinkOptions {    
    ...
    function writeOption(address baseTokenAddress, uint256 baseTokenPrice, uint strike, uint premium, uint expiry, uint tknAmt) public payable {
...
// make the quote token ether
// make it payable with ether
// make the price of the token very small 0.00000001 sth like that
// how to do a put option?
// fix the fee so that when you send 2 in the opion it's actually 2 not 1...
