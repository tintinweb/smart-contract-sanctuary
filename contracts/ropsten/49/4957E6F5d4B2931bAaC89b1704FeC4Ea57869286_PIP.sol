...
contract PIP is BurnableToken, DetailedERC20, ERC20Token, TokenLock { // 코인 이름 수정 
  using SafeMath for uint256;
  // events
  event Approval(address indexed owner, address indexed spender, uint256 value);
  string public constant symbol = "PIP"; // 코인 이름 수정 
  string public constant name = "Point integrated Payment"; // 코인 이름 수정 
  uint8 public constant decimals = 18;
  uint256 public constant TOTAL_SUPPLY = 1*(10**8)*(10**uint256(decimals)); // 맨 앞에 5개는 5억게 
