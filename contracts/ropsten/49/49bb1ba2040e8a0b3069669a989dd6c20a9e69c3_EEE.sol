...
contract EEE is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    ...
    // Innovation for protocol by EEE Team
    ...
    function claimBNBReward() public isHuman nonReentrant {
        ...
        require(balanceOf(msg.sender) >= 0, "must own EEE to claim reward");
