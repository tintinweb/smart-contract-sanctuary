...
// contracts/DecentralizedIdentityToken.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract DecentralizedIdentityToken is ERC721, Ownable {

    constructor() ERC721("DecentralizedIdentity", "DID") {}
    ...
    function issue(address to) public onlyIssuer returns (uint256) {
        _tokenIds.increment();

        uint256 newDID = _tokenIds.current();
        _mint(to, newDID);
