...
contract TheTreasureSale {
    ...
    IERC20 public token;
    uint constant private FULL_TOKEN = 10**18;
    ...
    function buyTokens() payable public whileSale {
        ...
        emit Contribute(msg.sender, contributed_);
    }
    ...
    function reset(uint hardCap_) external onlyOwner {
        require(sale.done, "Test: End the sale first.");
        sale.started = false;
        sale.done = false;
        sale.raised = 0;
        sale.sold = 0;
