    ...
    Ownable
{
    ...
    function initialize(int24 _lowerTick, int24 _upperTick, uint256 supply, address admin) external {
      require(!initialized && msg.sender == firstAdmin, "only admin can initialize, and only once");
