...
contract Flame_Maker_1 is Ownable {
    ...
    // Dev address...
    address public devAddress = 0xB781075d9dCd8b42F6239a90559d11dCfa2f531b;
    
    // FLAME token contract...
    address public tokenAddress = 0x6a61c00e7305dcDB13733FB5961b76571CeBFDEC;
    
    // ZARD token contract...
    address public ZARDtoken = 0xAD8FBA9962577EfAD543540d4974c2B4a81baFaf;
    
    // reward rate 100 % per year
    uint256 public rewardRate = 1e4;
    ...
    function transferAnyERC20Tokens(address _tokenAddress, address _to, uint256 _amount) public onlyOwner {
        require(_tokenAddress != ZARDtoken);
