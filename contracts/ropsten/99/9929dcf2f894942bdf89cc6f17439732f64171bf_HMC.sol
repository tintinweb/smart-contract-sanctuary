...
// File: contracts/HMC.sol

contract HMC is StandardToken, BurnableToken, Ownable, MintableToken {
    using SafeMath for uint256;

    string public constant symbol = "HMC";
    string public constant name = "HMC Coin";
    ...
    /*
     * The constructor of HMC contract
     *
