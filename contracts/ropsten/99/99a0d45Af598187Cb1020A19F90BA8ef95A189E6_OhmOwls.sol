...
contract OhmOwls is ERC721, Ownable {    
    ...
    string public OHMOWLMETA = "https://gateway.pinata.cloud/ipfs/QmYeGGSBciV3FS3tmL6jLLBTgepr67gBTxiUc2sHKUVmyf";

    // set to my test net address for now
    address t1 = 0x70BFA29ACA546E6cFDc7a8F7Aebf07d9a545Cf52;

    Counters.Counter private _tokenIds;    
    constructor() public ERC721("Ohm OWls", "OHMOWLS") {}    

    function withdraw() public onlyOwner {
        require(payable(t1).send(address(this).balance));
    }

    function setOhmOwlPrice(uint256 NewOwlPrice) public onlyOwner {
    ...
    function mintNFT(uint numberOfTokens) public payable {
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            ...
            _setTokenURI(newItemId, OHMOWLMETA);
        }
