...
contract Se7enGreedyGame is modularLong {
    ...
    uint256 private roundExtra = 1000; // extSettings.getLongExtra();     // length of the very first ICO
    uint256 private roundGap = 1000; // extSettings.getLongGap();         // length of ICO phase, set to 1 year for EOS.
