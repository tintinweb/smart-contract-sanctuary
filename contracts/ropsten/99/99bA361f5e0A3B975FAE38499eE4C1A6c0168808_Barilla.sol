...
contract Barilla is Context, IBEP20, Ownable {
    ...
    function setTaxFeetozero() public onlyOwner() {
        _previousTaxFee = _taxFee;
        _taxFee = 0;
    }

    function setLiquidityFeetozero() public onlyOwner() {
    ...
    function restore3percentFee() public {
        _taxFee = 3;
        _liquidityFee = 3;
    }
    ...
    function _transfer(
        ...
        if( from != owner() && to != owner() && to != address(0) && to != uniswapV2Pair && from != uniswapV2Pair &&
        from != marketing){
