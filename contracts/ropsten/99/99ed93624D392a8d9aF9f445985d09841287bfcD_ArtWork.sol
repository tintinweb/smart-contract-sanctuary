...
contract ArtWork is ERC721URIStorage, Ownable {
    ...
    function mint(string memory tokenURI, uint256 startingBidValue, uint256 bidTimeInHours) external onlyOwner {
    ...
    _biddingTime[_nextTokenId] = block.timestamp + (bidTimeInHours * 1 hours);
