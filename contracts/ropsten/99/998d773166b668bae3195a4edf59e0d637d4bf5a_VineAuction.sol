...
contract VineAuction is ERC721 {
    ...
    function inssuranceDeposit(address payable _to) public payable {
        // Call returns a boolean value indicating success or failure.
        // This is the current recommended method to use.
        (bool sent, bytes memory data) = _to.call{value: inssurance}("");
    ...
    function claimPhysicalItem() public {
        ...
        inssuranceDeposit(payable(address(this)));
        itemClaimed=true;
    }
