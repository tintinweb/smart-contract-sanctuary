...
contract SwapAndLiquifyV3 is SwapAndLiquifyStorageV3, SwapAndLiquifyEvent, Initializable, Ownable {
    ...
    function initialize(address _ggrtAddress, address _swapRouter, address _nonFungible) public initializer{
        ...
        ggrtAddress = address(_ggrtAddress);
...
contract SwapAndLiquifyStorageV3 {
    bool public _initialized;
    address public ggrtAddress;
...
contract SwapAndLiquifyEvent {
    event Initialized(address ggrtAddress, address uniswapV2RouterAddress);
