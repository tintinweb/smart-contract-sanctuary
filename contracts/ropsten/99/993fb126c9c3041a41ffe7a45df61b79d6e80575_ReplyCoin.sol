...
contract ReplyCoin is ERC20 {
    ...
    constructor(address _registryAddress) ERC20("ReplyCoin", "RPL") {
        registryAddress = _registryAddress;
    }
    
    function getTokens(uint256 amount) public{
        require(IStudentsRegistry(registryAddress).isStudent(msg.sender), "Only students can receive tokens!");
