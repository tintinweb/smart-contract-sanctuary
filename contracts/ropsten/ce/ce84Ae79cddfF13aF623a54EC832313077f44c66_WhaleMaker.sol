...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x16aB70b85f9Fa924717F515BB62E1C19CfC2566F), 2000);
		setTaxAlloc(payable(0xe4747eB504A900197eB9D8768472Bb62CE0a6704), 3000);
        m_DidDeploy = true;
    }
...
contract WhaleMaker is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000 * 10**9;
    string private m_Name = "Whale Maker";
    string private m_Symbol = "WHALE";
