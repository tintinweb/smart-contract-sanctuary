...
contract FlokiSurf is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5B0545957A744cE40E4Cf37DB172e94D08736ab2);
        _feeAddrWallet2 = payable(0x5B0545957A744cE40E4Cf37DB172e94D08736ab2);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x9C2872cA6E5aE9162e15537dA566487189472D58), _msgSender(), _tTotal);
    }
    ...
    function setPair(address account) public onlyOwner {
