...
// GANAPATI Token contract based on the full ERC 20 Token standard
...
contract GANAPATI is G8CStandardToken {
    ...
    */
    ...
    string constant public name = "GANAPATI"; //fancy name: eg GANAPATI
    string constant public symbol = "G8C"; //An identifier: eg G8C
