...
contract HuuumanStandardToken is StandardToken { 
    ...
    function HuuumanStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
