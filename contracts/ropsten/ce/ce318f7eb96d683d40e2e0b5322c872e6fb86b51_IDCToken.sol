...
contract IDCToken is BurnableToken, Pausable, Saleable {
  ...
  uint256 constant private DAY_10 = 10 minutes;
  uint256 constant private DAY_90 = 90 minutes;
  uint256 constant private DAY_120 = 120 minutes;
  uint256 constant private DAY_150 = 150 minutes;
  uint256 constant private DAY_180 = 180 minutes;
  uint256 constant private DAY_360 = 360 minutes;
  uint256 constant private DAY_720 = 720 minutes;
...
contract IDCSale is Pausable {
  ...
  uint256 public stageLength = 30 minutes;
  ...
  uint256 constant private DAY_10 = 10 minutes;
  uint256 constant private DAY_20 = 20 minutes;
  uint256 constant private DAY_30 = 30 minutes;

  uint256 constant private MIN_ANGLE = 500 wei;
  uint256 constant private MIN_PRIV = 50 wei;
