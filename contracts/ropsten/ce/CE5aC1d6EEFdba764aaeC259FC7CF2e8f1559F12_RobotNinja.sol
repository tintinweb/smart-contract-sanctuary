...
contract RobotNinja is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
  ...
  /**
   * @dev The tracker of ninjas (Regular, Super, Ultimate)
   */
  ...
  /**
   * @dev The count of minted ninjas (Regular, Super, Ultimate)
   */
  ...
  /**
   * @dev Mint regular ninja with count
   */
  function mintRegularTokens(uint256 _count) external payable saleIsOpen {
    ...
    // Set max limit of regular ninjas
    ...
    for (uint256 i = 0; i < _count; i++) {
      // Increase tracker and counter of regular ninja
  ...
  /**
   * @dev Mint super ninja using 2 regular ninjas
   */
  function mintSuperTokens(uint256 _tokenIdRegular1, uint256 _tokenIdRegular2) external saleIsOpen
  {
    ...
    // Set max limit of super ninjas
    require(total + 1 <= MAX_SUPER_TOKENS, "Max limit of Super");
    // Check the owner of regular ninja 1
    ...
    // Check the owner of regular ninja 2
    ...
    // Burn 2 regular ninjas and decrease the count of regular ninjas
    burn(_tokenIdRegular1);
    burn(_tokenIdRegular2);
    _regularTokenCounter -= 2;

    // Increase tracker and counter of super ninja
  ...
  /**
   * @dev Mint ultimate ninja using 1 super ninja and 1 regular ninja
   */
  function mintUltimateTokens(uint256 _tokenIdSuper, uint256 _tokenIdRegular) external saleIsOpen
  {
    ...
    // Check the owner of super ninja
    ...
    // Check the owner of regular ninja
    require(ownerOf(_tokenIdRegular) == wallet && _tokenIdRegular > 0 && _tokenIdRegular <= MAX_REGULAR_TOKENS, "Not the owner of this token");

    // Burn 1 regular ninja, 1 super ninja and decrease the count of regular and super ninja
    burn(_tokenIdSuper);
    burn(_tokenIdRegular);
    _regularTokenCounter -= 1;
    _superTokenCounter -= 1;

    // Increase tracker and counter of ultimate ninja
