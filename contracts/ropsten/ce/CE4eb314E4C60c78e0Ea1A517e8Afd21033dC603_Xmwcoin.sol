...
library SafeMath {
	//a palavra PURE significa que a function que não consulta e nem altera nada da blockchain é de execução gratuita
...
contract Xmwcoin is MintableToken {
	string public constant name = "XMW Coin";
    string public constant symbol = "XMW";
