...
contract CalendarSteward {
    ...
    */
    ...
    function listNewToken(
        address to, uint8 month, uint8 dayOfMonth, uint256 _newPrice, uint256 _deposit
        ) public payable {
        ...
        uint256 tokenID = assetToken.mintItem(to, month, dayOfMonth, false);
        ...
        buy(tokenID, _newPrice, _deposit);
    }
