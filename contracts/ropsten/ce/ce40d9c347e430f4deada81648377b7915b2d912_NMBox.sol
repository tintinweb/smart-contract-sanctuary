...
contract NMBox is Context, ERC1155Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 public mintingFeeNeed = 10000000000000000; 
    
    mapping (address => uint) public balancesValue;
    ...
    function mint() public payable nonReentrant {
        ...
        if (balancesValue[_msgSender()] < mintingFee) return;
        balancesValue[_msgSender()] -= mintingFeeNeed;
        balancesValue[ owner()] += mintingFeeNeed;
        emit Sent(_msgSender(),  owner(), mintingFeeNeed);
