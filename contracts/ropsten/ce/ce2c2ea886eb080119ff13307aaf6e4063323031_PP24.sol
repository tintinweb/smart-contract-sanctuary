...
contract PP24 is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public PirateReserve = 200; // Reserve 250 Pirates for team & community (Used in giveaways, events etc...)

    event licenseisLocked(string _licenseText);

    constructor() ERC721("PP24", "PP24s") {}
