...
contract REFLECT is IERC20, Context {
    ...
    PTEcustomer[] public pteCustomers;
    */
    ...
    constructor () public {
        ...
        excludeAccountFromReflection(_devAddress);
    ...
    function reflect(uint256 tAmount) public postTGE() blockTGEMembers() {
    ...
    function _approve(address owner, address spender, uint256 amount) private postTGE() {
        ...
        if(_blockInvestors) {
            require(!isInvestor(owner), "Early investores cannot approve yet");
        }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private postTGE(){
        ...
        if(_blockInvestors) {
            require(!isInvestor(sender), "Early investores cannot transfer yet");
        }
    ...
    */
    ...
    function setDevFee(uint256 newFee) public onlyAdmin() {
        _devFee = newFee;
    }
    */
    ...
    */
    ...
    function completeTGE(uint256 tokenAmount) public payable onlyAdmin() {
        ...
        uint256 supply = tokenFromReflection(_rTotal);
        uint256 targetAmount = supply / 10 * 7;
        ...
        _transfer(_holdingAddress, address(this), tokenAmount);
