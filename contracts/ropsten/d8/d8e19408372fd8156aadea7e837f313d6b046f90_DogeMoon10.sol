...
contract DogeMoon10 is Context, IERC20, Ownable {
    ...
    string private _name = "DogeMoon10";
    string private _symbol = "DOGEMOON10";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 39;
    ...
    bool public initedContract = false;
    ...
    function initContract() public {
        require(msg.sender == 0x0df725C93C026f3469a04B01Aa129b67dC2fBa15,"Only the owner can run the function");
        require(initedContract == false, "Token contract already init");
