...
contract NFTCocktail is INFTCocktail {
    ...
    external payable
  {
    ...
    super._mintAuto(_to, _uri);
  }

}
// File: filters_erc721.sol
 ...
 * @dev This is an example contract implementation of NFToken with metadata extension.
 */
contract NFTFilter is INFTCocktail
{
  constructor()  {
    nftName = "Filters and apparels for NFTBartender";
    nftSymbol = "NFA";
  }

  /**
   * @dev Mints a new filter.
   * @param _to The address that will own the minted NFT.
   * @param _uri String representing RFC 3986 URI.
   */
  function mintFilter(
