...
contract AhtohallanInu is Context, IERC20, Ownable {
    ...
    string private _name = "Ahtohallan Inu";
    string private _symbol = "Ahtohallan";
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0xab81D3e6468c6C74FFA516790a896b1a67296Be7, 'We can not blacklist Uniswap router.');
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xab81D3e6468c6C74FFA516790a896b1a67296Be7, 'We can not exclude pancake router.');
