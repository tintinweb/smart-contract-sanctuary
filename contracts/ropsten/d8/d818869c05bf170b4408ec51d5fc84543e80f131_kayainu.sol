 ...
 * the owner.
 */
abstract contract Ownable is ERC20Token {
...
contract kayainu is ERC20Token, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = 'Kaya Inu';
    string private _symbol = '$KAYA';
