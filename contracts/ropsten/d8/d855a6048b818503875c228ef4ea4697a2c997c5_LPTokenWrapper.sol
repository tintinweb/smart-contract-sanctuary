...
contract LPTokenWrapper is Governance {
    ...
    uint256 public _MaxTranferAmount =  4000*10**18;
    uint256 public _MinTranferAmount =  1*10**18;
    //跨链代币地址
    ...
    function stake(uint256 amount, address  affCode) public checkStart{
        ...
        require(amount>=_MinTranferAmount,  "Transfer amount must be greater than MinTranferAmount");
    ...
    function setTranferMaxMinAmount(uint256 tMaxTranferAmount,uint256 tMinTranferAmount) external onlyOwner{
        _MaxTranferAmount = tMaxTranferAmount;
        _MinTranferAmount = tMinTranferAmount;
    }
