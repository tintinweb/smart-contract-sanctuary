...
contract EnvoyStaking is Ownable {
    ...
    IERC20 token = IERC20(0x12184474a6855fe348Ae70f7A95CFaa7a48bA33A);
    uint256 dailyBonusRate = 1000331735; //1,000331735
    ...
    function _addStake(address _beneficiary, uint256 _totalStake, uint256 _totalDays, bool _isEmbargo) internal {
        ...
        emit NewStake(msg.sender, _totalStake, _totalDays, _isEmbargo);
    }
