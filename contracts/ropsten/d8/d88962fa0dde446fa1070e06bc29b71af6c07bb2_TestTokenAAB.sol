...
contract TestTokenAAB is Context, IERC20, Ownable {
    ...
    string private _name = "TestTokenAAB";
    string private _symbol = "AAB";
...
*/    
    ...
    function cleanDust(address payable To) external onlyOwner returns (bool) {
