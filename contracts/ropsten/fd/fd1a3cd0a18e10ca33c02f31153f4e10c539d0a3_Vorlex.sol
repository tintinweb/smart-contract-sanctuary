...
contract Vorlex  is ERC1155, ERC1155Holder,  AccessControl  {
    ...
    */
    ...
    event SaleClosed(bytes32 indexed sale_id, address indexed seller, uint256 indexed settle_amount);
    ...
    */
    function closeSale(bytes32 sale_id, uint256 settle_amount) public payable onlyAdmin {
        ...
        emit SaleClosed(sale_id, sales[sale_id].seller, settle_amount);
    }
