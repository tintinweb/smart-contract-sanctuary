...
/*
 * TS3 Token Smart Contract.
 * Copyright (c) 2018 by TS1
...
/**
 * okcash Smart Contract: EIP-20 compatible token smart contract that
 * manages TS1 tokens.
 */
contract TS8Token is AbstractToken {
  /**
  ...
  /**
   * Create TS8 Token smart contract with message sender as an owner.
   */
  constructor () {
    owner = msg.sender;
  }
