...
contract LuckyBananaApes is Context, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    /**
    * Can only be called twice. Gives 42 total tickets to devs for giveaways, marketing purposes and team members.
    */
    function give42TicketsToDevs() external onlyOwner {
        require(saleStarted == false,"Sale has already started");
        require(devSupplyAwarded < 1,"Dev supply has already been awarded");
        uint i;
        uint id;
    ...
    function mint(address to, uint amount) external payable{
        ...
        //dont overmint
        require(amount <= TOKEN_LIMIT-nextTokenId,"Not enough Tickets left to mint");
    ...
    */
    function startSale(uint256 mintPrice) external virtual onlyOwner {
        ...
        require(mintPrice > 0.05 ether,"Price too low");
