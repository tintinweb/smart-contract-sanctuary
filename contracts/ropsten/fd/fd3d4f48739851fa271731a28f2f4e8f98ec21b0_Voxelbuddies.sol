...
// File: contracts/Voxibuddies.sol

// contracts/Voxelbuddies.sol
pragma solidity ^0.7.0;



// Inspired/Copied fromm BGANPUNKS V2 (bastardganpunks.club)
contract Voxelbuddies is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    // Truth.　
    string public constant R = "Voxel Buddies!";

    constructor(string memory baseURI) ERC721("Voxibuddies","VOXIBUDDIES")  {
        setBaseURI(baseURI);
    }
