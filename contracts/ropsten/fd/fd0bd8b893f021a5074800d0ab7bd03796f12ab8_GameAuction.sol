...
contract GameAuction {
        ...
        onlyIfTeamIsValid(_teamName)
    {
        ...
        if ((numberOfBidsP >=3) && (numberOfBidsE >=3)) { // TESTINGTODO:Change numbers accordingly
            stage = 2;
        ...
        onlyBefore(revealEnd)
    {
        ...
        if ((numberOfRevealsP >= 3) && (numberOfRevealsE >=3)) { // TESTINGTODO:Change numbers accordingly
            stage = 0;
            auctionEnd();
        }
    }
