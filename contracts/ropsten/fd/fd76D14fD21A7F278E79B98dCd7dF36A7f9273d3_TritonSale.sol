...
contract TritonSale is Pausable, ReentrancyGuard, Ownable{
    ...
    function distributePurchasedTokensAndBurnTheRest() external onlyOwner whenNotPaused {
        ...
        _token.burn(tokenAmountNotSold);
    }
}
...
contract TritonToken is ERC20, Pausable, ReentrancyGuard, Ownable {
    ...
    uint256 private constant _initialSupply = 600000000 * 1e18; // mint 600M of tokens on day-0
    ...
    EnumerableSet.AddressSet private _accountsExcludedFromFee;  // list of adresses excluded from fee mechanism ; contract owner is also added here during deployment.
