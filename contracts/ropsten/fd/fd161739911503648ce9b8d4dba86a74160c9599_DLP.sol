...
interface DLRNFT {
    ...
    function resetReward(uint256 tokenId) external;
    function addReward(uint256 tokenId,uint256 newReward) external;
}
...
contract DLP is Ownable {
    ...
    constructor() public 
    {
        dLRNFT = DLRNFT(0xE2ab79bF6BaD709f7975E02AA41B9E72130701d0);
    }
