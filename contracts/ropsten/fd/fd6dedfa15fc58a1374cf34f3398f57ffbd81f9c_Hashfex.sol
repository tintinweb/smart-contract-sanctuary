...
contract Hashfex is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Hashfex() {
        ...
        name = "Hashfex";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HFX";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 13800;                                      // Set the price of your token for the ICO (CHANGE THIS)
