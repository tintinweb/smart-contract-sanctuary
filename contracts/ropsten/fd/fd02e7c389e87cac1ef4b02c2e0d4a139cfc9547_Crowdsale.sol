...
contract Pozess is ERC20, Ownable {
  ...
  uint256 public constant INITIAL_SUPPLY = 1174209525 * 10**18;
...
contract Crowdsale is Pozess{
    ...
    constructor() public {
        ...
        startPreSaleDate = 1543622400; // 01/12/2018 @ 12:00am (UTC)
        endPreSaleDate = 1551398399; // 28/02/2019 @ 23:59am (UTC)
        preSaleGoal = 321000000; // pre-sale goal
        preSaleRaised = 0; // raised on pre-sale stage
        
        startPreIco1Date = 1551398400; // 03/01/2019 @ 12:00am (UTC)
        endPreIco1Date = 1554076799; // 03/31/2019 @ 23:59am (UTC)
        preIco1Goal = 106250000; // pre ico 1 phase goal 
        preIco1Raised = 0; // raised on pre ico stage 1
        
        startIco1Date = 1554076800; // 04/01/2019 @ 12:00am (UTC)
        endIco1Date = 1556668799; // 04/30/2019 @ 23:59am (UTC)
        ico1Goal = 135600000; // ico phase 1 goal 
        ico1Raised = 0; // raised on ico stage 1
        
        startIco2Date = 1556668800; // 05/01/2019 @ 12:00am (UTC)
        endIco2Date = 1559347199; // 31/05/2019 @ 23:59am (UTC)
        ico2Goal = 74842000; // ico phase 2 goal 
        ico2Raised = 0; // raised on ico stage 2
        
        startIco3Date = 1559347200; // 01/06/2019 @ 12:00am (UTC)
        endIco3Date = 1560556799; // 14/06/2019 @ 23:59am (UTC)
        ico3Goal = 68040001; // ico phase 3 goal 
        ico3Raised = 0; // raised on ico stage 3
        
        startIco4Date = 1560556800; // 15/06/2019 @ 12:00am (UTC)
        endIco4Date = 1561939199; // 30/06/2019 @ 23:59am (UTC)
        ico4Goal = 34020000; // ico phase 4 goal 
        ico4Raised = 0; // raised on ico stage 4
        
        softCap = 25000 * 10**18; // 5 000 000$ (1 ether = 200$) 2500000/100
        hardCap = 400000 * 10**18; // 40 000 000$ (1 ether = 200$) 40000000/100
        totalCap = 0;
        price = 700000; //gwei per token
        crowdsaleFinished = false;
        reserved = (2*117420953 + 105678857 + 35226286 + 58710476 ) * 10**18;
    }
    ...
    function addInvestor(address _sender, uint _value) private {
        ...
        setFrozen(_sender, 1564531199);// freeze tokens until one month after ICO finished
