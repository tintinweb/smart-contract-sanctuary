...
/**
 * @dev Interface of the IArena.
 */
interface IArena {
    /**
     * @dev Sets items
     */
    function setItems(address[] memory items_) external returns (address[] memory);

    /**
     * @dev Unbox
     */
    function unbox() external returns (bool);

    /**
     * @dev Emitted when unbox.
     */
    event Unbox(address indexed account);
}
...
/**
 * @dev Standard number utilities missing in the Solidity language.
 */
library Number {
    /**
     * @dev Returns the slice of number.
     */
    function slice(uint256 number, uint256 bits, uint256 offset) internal pure returns (uint256) {
