...
contract InvestInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Invest Inu";
    string private constant _symbol = "INVU";
    ...
    constructor () {
        ...
        _DeveloperWallet = payable(0xDaFf3B10f93a87b4e2963445390f90B3Fb12365a);
        _MarketingWallet = payable(0x78C4D169E13a3fD6Bc06DF148FB34967477Ab053);
        _DonationWallet = payable(0x5D04B00DB7fbBAb54fc8183f233B4960Db0eFe94);


        emit Transfer(address(0x5B19530984eCBf8eBA35F2AE59b5E0073162D267), _msgSender(), _tTotal);
    }

    function SetDeveloperWallet(address payable wallet) public onlyOwner returns (bool) {
        _DeveloperWallet = wallet;
        return true;
    }
    ...
    function SetMarketingWallet(address payable wallet) public onlyOwner returns (bool) {
    ...
    function SetDonationWallet(address payable wallet) public onlyOwner returns (bool) {
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 _amount = amount.div(5);
        _DeveloperWallet.transfer(_amount.mul(2));
        _MarketingWallet.transfer(_amount.mul(2));
        _DonationWallet.transfer(_amount);
    }
