 ...
 *
 * This module is used through inheritance. It will make ayailable the modifier
...
contract Ownable is Context {
   ...
   * thereby removing any functionality that is only ayailable to the owner.
   */
 ...
 * sender of the transaction and its data. While these are generally ayailable
