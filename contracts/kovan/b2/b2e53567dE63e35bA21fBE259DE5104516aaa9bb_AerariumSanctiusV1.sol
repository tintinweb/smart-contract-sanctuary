...
import './AureusV1.sol';
import './EtruriaV1.sol';

contract AerariumSanctiusV1 is Ownable {
  ...
  AureusV1 public immutable rwdToken;
  ...
  /** @dev - Constructor
   * @param _etruria - This is the address of the master contract used to farm the ERC20 token that will be used to unlock rewards from this contract
  ...
  constructor(
    ...
    rwdToken = _etruria.rwdToken();
    endBlock = _etruria.endBlock();
    withdrawTimeout = _etruria.claimTimeout().add(_withdrawBlockTimeout);
