...
contract FeeDistributor is Ownable {
    ...
    OptionsMarketToken public osmToken;
    ...
    function seed(
        ...
        osmToken = OptionsMarketToken(_osmToken);
    ...
    function distributeFees() external seeded {
        uint balance = osmToken.balanceOf(address(this));
        ...
        if (recipients.liquidVaultShare > 0) {
            ...
            require(
                osmToken.transfer(recipients.liquidVault, liquidShare),
...
contract OptionsMarketToken {
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) public {
        ...
        require(block.timestamp <= expiry, "OptionsMarket::delegateBySig: signature expired");
