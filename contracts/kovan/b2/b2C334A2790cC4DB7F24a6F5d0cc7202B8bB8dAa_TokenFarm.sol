...
contract TokenFarm is Ownable {
    ...
    function getUserTotalStakedValue(address _user) public returns (uint256) {
        ...
        returns (uint256)
    {
        ...
        return (price * stakingBalance[_token][msg.sender]/(10 **decimals));
    }

    function getTokenValue(address _token) view public returns (uint256, uint256) {
        // price feed address
