...
contract Africoin {
    ...
    /// @param _from, where funds coming from the sender
    /// @param _to receiver of token
    /// @param _value amount value of token to send
    // Internal fnction transfer can only be called by this contract
    ...
    // Allow _sender to spend up to _value on your behalf
    ...
    /// @notice transfer by approved from original address of an amount within approved limit
    /// @param _from, address sending to and the amount to send
    /// @param _to receiver of token
    /// @param _value amount of value of token to send
    /// @dev internal helper transfer function with required safety checks
