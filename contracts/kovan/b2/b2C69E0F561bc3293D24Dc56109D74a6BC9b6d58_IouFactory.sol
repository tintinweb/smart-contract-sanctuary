 ...
 */
contract IouFactory is IIouFactory, Context {
    ...
    function createIou(
        ...
        Iou(clone).init(name, symbol, _msgSender(), _collateralToken);
        emit IouCreated(clone);
        return clone;
    }
}
...
/**
 * @dev ERC20 token to represent a single tranche for a HourGlass bond
 *
 */
