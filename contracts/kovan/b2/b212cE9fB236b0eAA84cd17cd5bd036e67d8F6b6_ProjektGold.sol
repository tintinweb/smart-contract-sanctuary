...
// ####################
    ...
    function addStake(uint256 _stakeAmount, address payable _payoutAddress) external onlyInvestor{
        require(m_Staked[_payoutAddress] = false && m_investorCount <= 2, "Already Staked");
        require(_stakeAmount < m_MinStake, "Please enter minimum investment");
        m_InvestorPayout[_msgSender()] = _payoutAddress;
        address(this).balance.add(_stakeAmount);
