...
contract SquidGame is ERC721, ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable, VRFConsumerBase {
  ...
  // Constants
  uint256 public constant NUM_ROUNDS = 5; // Number of rounds this game will last
  ...
  uint256 public constant MAX_BY_MINT = 32; // Max number of tokens to be minted in a single transaction
  ...
  function _beforeTokenTransfer(
    ...
    // Disable token transfers while the burn is happening.
  ...
  function burnSupply() public onlyOwner {
    ...
    uint256 startingIndex = 39823132870121533625013374506686670131543281483716942563457581429463327892338 % 2;
