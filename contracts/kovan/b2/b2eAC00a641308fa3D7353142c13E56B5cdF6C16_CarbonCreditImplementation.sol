...
contract CarbonCreditImplementation {
    ...
    */
     ...
     * Lack of nested array support i_transferhe delgatedTransfer msg.
    ...
    */
    ...
    uint a = 10000000000000000000 ;
     uint b = 20000000000000000000 ;
      uint c = 30000000000000000000 ;
       uint d = 40000000000000000000 ;
        uint e = 500000000000000000000 ;

    uint [] commission = [a,b,c,d,e];
     uint rbalance;
