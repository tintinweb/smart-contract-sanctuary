...
contract GasDaoToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    uint256 constant airdropSupply = 550000000000000043028034298900;
    ...
    // this allows for 20% immediately vested, then linearly over a year
    bool public vestStarted = false;

    uint256 public constant claimPeriodEnds = 1619479085; // april 26, 2022
    ...
    function startVest(address tokenLockAddress) public onlyOwner {
        ...
        GasDaoTokenLock(tokenLockAddress).lock(0x75afe4437c5A1808Fc52B12D94fAEF3AfFeb641A, 30_000_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0x7AeaCECc5D9831f9507256CB86Ec24eDD69a14E9, 20_500_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0xcA38B710828Bf7D696Da40785AbE27387c7823c7, 20_000_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0xcA38B710828Bf7D696Da40785AbE27387c7823c7, 20_000_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0xcA38B710828Bf7D696Da40785AbE27387c7823c7, 10_500_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0xcA38B710828Bf7D696Da40785AbE27387c7823c7, 10_500_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0xcA38B710828Bf7D696Da40785AbE27387c7823c7, 10_000_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0xcA38B710828Bf7D696Da40785AbE27387c7823c7, 10_000_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0xcA38B710828Bf7D696Da40785AbE27387c7823c7, 5_000_000_000e18);
    }
    ...
    function claimTokens(uint256 amount, bytes32[] calldata merkleProof) public {
        ...
        if (msg.sender != 0x7AeaCECc5D9831f9507256CB86Ec24eDD69a14E9 && msg.sender != 0xDcE09fCbe86B054E856c730a811e49a1E3De110e) {
