...
contract Consumer is ChainlinkClient {
  ...
  function validateName(string memory _name) public returns (bytes32 requestId) {
  ...
  function fulfill(bytes32 _requestId, bool _clean) public recordChainlinkFulfillment(_requestId) {
    clean = _clean;
  }
}
