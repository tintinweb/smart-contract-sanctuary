...
contract Precog {
    ...
    function invest(
        ...
        futureExchange.swapFuture(pairs[1], pairs[0], deadline, address(this), amounts[1]);
        _swapTradingFee();
        
        investAmount[user] += availableAmount[user];
        tradingAmount[user] += availableAmount[user];
