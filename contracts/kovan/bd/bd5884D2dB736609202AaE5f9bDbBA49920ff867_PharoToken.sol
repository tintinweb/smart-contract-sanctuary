...
contract PharoToken is ERC20Burnable, Ownable, ReentrancyGuard, AccessControl {
    ...
    */
        ...
        ReentrancyGuard()
    {
        ...
        // uint256 initialQntyToMint = 740000000 ether;
        ...
        //_mint(0xDbE2F64680C965Cf52dBD493B4a821B5cDbB9ee2, 60000000 ether);
        // Sean CEO - 60,000,000
        // _mint(, 60000000 ether);
        // Deryck Market Manager - 5,000,000
        // _mint(, 5000000 ether);
        // The rest of the team tokns to be given at a later time
        // _mint(, 75000000 ether);
        ...
        // ADD PharoStakePool to the MINTER_ROLE
        // _setupRole(MINTER_ROLE, 0x);
        ...
        _setupRole(DISTRIBUTOR_ROLE, 0x3f15B8c6F9939879Cb030D6dd935348E57109637);

        // For mainnet ~ DAO ~ 0x13BAF955FdfEd5a68D80430422766f54Aea86d22
        _setupRole(DISTRIBUTOR_ROLE, 0x13BAF955FdfEd5a68D80430422766f54Aea86d22);
        _setupRole(DEFAULT_ADMIN_ROLE, 0x13BAF955FdfEd5a68D80430422766f54Aea86d22);
        _setupRole(MINTER_ROLE, 0x13BAF955FdfEd5a68D80430422766f54Aea86d22);
        // ADD PharoStakePool to the MINTER_ROLE
        // _setupRole(MINTER_ROLE, 0x);
        //transferOwnership(0x13BAF955FdfEd5a68D80430422766f54Aea86d22);
    ...
    function mintForContract(address contractAddress, uint256 amount)
        ...
        nonReentrant
    {
        // must assing any contract needing too mint PHRO tokens the MINTER_ROLE
