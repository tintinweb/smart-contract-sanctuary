...
contract Pool is Ownable {
 ...
 // Tracks the details of participants
  ...
  constructor (
    IERC20 _token,   // Token to used to buy the tickets
    uint256 _lockStartBlock, // Start time
    uint256 _lockEndBlock,  // End time
    uint256 _ticketPrice,   // Price of the ticket in terms of _token
    uint256 _fee,            // Fee for the pool
    uint256 _treeKey
    ) public {
