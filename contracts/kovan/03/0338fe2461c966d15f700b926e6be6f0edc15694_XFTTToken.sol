...
contract XFTTToken is ERC20Pausable {
    address factory;
    address _operator;
    address _pauser;
    uint256 private constant _preMineSupply = 0;   //预先发放量0枚
    uint256 private constant _maxSupply = 2100000 * 1e18;     //总量2100000枚

    constructor(address operator,address pauser) public ERC20("Fly Financial X Token","XFFT") {
        _operator = operator;
        _pauser=pauser;
        _setupDecimals(18);
        factory=msg.sender;
