...
2% fee from each transaction will be spread as airdrop to all hodlers.
...
contract casting1 is Context, IERC20, Ownable {
    ...
    string private _name = 'casting1';
    string private _symbol = 'cast1';
