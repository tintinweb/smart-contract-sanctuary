...
contract Vesting is Ownable {
    ...
    /**
     * @param _tokenAddress The address of the OPSK token
     * @param _cumulativeAmountsToVest The cumulative amounts for each vesting period
     */
    constructor(address _tokenAddress, uint256[24] memory _cumulativeAmountsToVest) public {
    ...
    function calculateAmounts() internal view returns (uint256 _owedAmount, uint256 _calculatedAmount) {
        ...
        uint256 calculatedAmount =
            PercentageCalculator.div(cumulativeAmountsToVest[period], recipients[msg.sender].withdrawPercentage);
...

{
  ...
  "libraries": {
    "contracts/PercentageCalculator.sol": {
      "PercentageCalculator": "0x379deb47211baf4c417ff89c6798b06182f1d9ef"
    }
  }
}