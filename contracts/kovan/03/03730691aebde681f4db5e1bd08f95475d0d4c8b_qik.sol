...
contract qik is ERC20, ERC20Burnable, Ownable, ERC20Pausable {
    constructor(
        string memory name,
        ...
        _setTotalSupply(initialSupply); // 100 million

        // public stake 
        uint256 icoTokens = 41180000; // 5100000/1000000 = 41.18 million
        _initialTransfer(
            0x1568b6c0CF7b0CE96A39a9105cf41Ba0939a5038,
            (icoTokens * decimalFactor)
        );
        // staking
        uint256 foundCommTokens = 41180000; // 41.18 million
        _initialTransfer(
            0xe1B16df896c83997fdbD48852Efae7Ff3Be14FA7,
            (foundCommTokens * decimalFactor)
        );
        // Reserve and Exchange
        uint256 reserveExTokens = 17650000; // 17.65 million
        _initialTransfer(
