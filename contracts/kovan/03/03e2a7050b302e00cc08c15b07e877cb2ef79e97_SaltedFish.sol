...
contract SaltedFish is ERC20Pausable {
    ...
    uint256 _feePart = 3000; //手续费比例
    address _feeAddress = 0x980f9dC46Ecf3Fc0fA972f1Cf0B02442C05A4f2D;
    uint256 _blackHolePart = 2000; //黑洞比例
    uint256 _liquidityPart = 5000; //流动性比例
    address _liquidityAddress=0x96187B32ded805179376D517dbAB1F0986310b2A;
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        super.transfer(address(0), blackHoleAmout);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        super.transferFrom(sender,address(0), blackHoleAmout);
    ...
    *
    */
    function getFeePart() public onlyOperator view returns(uint256,uint256,uint256){
       return (_feePart,_blackHolePart,_liquidityPart);
    }
    ...
    *
    */
    function getFeeAddress() public onlyOperator view returns(address,address){
       return (_feeAddress,_liquidityAddress);
    }
}