...
contract LiquidityVault is ERC20, ReentrancyGuard {
    ...
    function initialize(
        ...
        int24 lowerTick_ = TickMath.getTickAtSqrtRatio(sqrtPriceA);
        int24 upperTick_ = TickMath.getTickAtSqrtRatio(sqrtPriceB);
        
        int24 lowerTickCorrection_ = lowerTick_ % 200;
        int24 upperTickCorrection_ = upperTick_ % 200;

        if (lowerTickCorrection_ != 0) {
            lowerTickCorrection_ = lowerTickCorrection_ < 0 ? -lowerTickCorrection_ : lowerTickCorrection_;
            lowerTickCorrection_ = lowerTickCorrection_ > 100 ? lowerTickCorrection_ - 200 : lowerTickCorrection_;
        }

        if (upperTickCorrection_ != 0) {
            upperTickCorrection_ = upperTickCorrection_ < 0 ? -upperTickCorrection_ : upperTickCorrection_;
            upperTickCorrection_ = upperTickCorrection_ > 100 ? upperTickCorrection_ - 200 : upperTickCorrection_;
        }

        lowerTick = lowerTick_ - lowerTickCorrection_;
        upperTick = upperTick_ - upperTickCorrection_;
    }
