...
contract Bank{ //อ่านทำไม
    mapping (address => uint256) public balances;
    address[] accounts;
    uint256 rate = 3; //3% APR
    
    function deposit() public payable{//การฝากเงิน
    ...
    function withdraw(uint256 amount) public  {
        require(balances[msg.sender] >= amount , "Your balances is not enough!");
