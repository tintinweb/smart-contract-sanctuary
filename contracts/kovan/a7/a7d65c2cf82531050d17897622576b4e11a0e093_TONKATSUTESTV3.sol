...
contract TONKATSUTESTV3 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tonkatsu Inu TEST V3";
    string private constant _symbol = unicode"TONKATSUTESTV3";
