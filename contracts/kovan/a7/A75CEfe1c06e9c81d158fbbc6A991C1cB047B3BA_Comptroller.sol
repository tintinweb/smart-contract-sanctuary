 ...
 * GTokens should reference this contract as their comptroller.
 */
...
contract GTokenInterface is GTokenStorage {
     ...
     */
    event Borrow(address borrower, uint borrowAmount, uint accountBorrows, uint accountBorrowIndex, uint totalBorrows, string channel);
...
/**
 * @title GandalfLending's GToken Contract
