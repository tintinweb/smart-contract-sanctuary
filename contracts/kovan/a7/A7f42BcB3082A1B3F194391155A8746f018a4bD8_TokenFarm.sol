...
contract TokenFarm is Ownable {
    ...
    // user address =>  amount of unique tokens staked
    mapping (address => uint256) public uniqueTokensStaked;

    // token address => priceFeed contract address
    ...
    // TODO: (Igor) Choose amount of unsake
    function unstakeTokens(address _token) public {
        ...
        // TODO: (igor) remove user fdom stakers list if no more unique tokens staked.
    }
