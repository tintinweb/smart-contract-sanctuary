...
contract SportPlayers is ERC721, Ownable {
    ...
    constructor() ERC721("SportPlayers", "SPL") {
    ...
    function mintSportPlayers(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint SportPlayers");
        require(numberOfTokens <= MAX_ITEMS_PER_MINT, "Can't mint more than 10 SportPlayers");
        require(totalSupply().add(numberOfTokens) <= TOTAL_ITEMS, "Purchase would exceed max supply of SportPlayers");
