    ...
    IDistributor
{
  ...
  */
   ...
   function buyCover(
        ...
        ( uint256 buyCoverValue, address  coverAsset) = _defineBuyingCoverValue(coverAsset,coverPrice,_priceInNXM);

        uint256 sum = buyCoverValue.add(coverPrice);

        uint256 _maxNXMinCoverPrice = _howManyTokensAinB(address(wNXMToken),coverAsset,buyCoverValue);
