...
contract CLRDeployer is Ownable {
    ...
    function setCLRImplementation(address _clrImplementation) onlyOwner public {
        clrImplementation = _clrImplementation;
    }

    function setsCLRTokenImplementation(address _sCLRTokenImplementation) onlyOwner public {
        sCLRTokenImplementation = _sCLRTokenImplementation;
    }
}
