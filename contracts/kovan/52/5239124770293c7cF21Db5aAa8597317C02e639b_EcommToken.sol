...
contract EcommToken {
    ...
    //address [] private whoBuy = [0x0000000000000000000000000000000000000000];
    ...
    function requestToBuy() public {
        AMAZON.requestPrice();
        deadline = now + (1 * 90 days);
        customerData[msg.sender] = AccountData(0, false, index, deadline);
        index += 1;
    }

    function requestToPay() public view returns (string memory){
