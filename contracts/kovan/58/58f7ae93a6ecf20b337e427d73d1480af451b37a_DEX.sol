...
contract DEX is Ownable {
    ...
    function calculateInterest(address user, uint256 _rate) internal returns(uint256) {
        ...
        // uint256 initial_funds = balances[user];
        // uint256 increase_factor = pow(add(div(_rate, 100), 1), _years);
        // uint256 amount_after = initial_funds.mul(increase_factor);
        // uint256 interest = amount_after.sub(initial_funds);
