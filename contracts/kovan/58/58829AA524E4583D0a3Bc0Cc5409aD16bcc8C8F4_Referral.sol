    ...
    Roles
{
    ...
    /**
     * @notice sets referral for given user if not yet set
     * @param userAccount address from the user being referred
     * @param referralAccount address from the user referring
     */
