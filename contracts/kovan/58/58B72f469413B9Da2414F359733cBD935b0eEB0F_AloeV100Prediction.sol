...
contract AloeV100Prediction is IAloeV100PredictionEvents {
    ...
    function claimReward(uint256 inEpoch, uint16 idx) external {
        ...
        UINT512 memory sumOfSquaredErrors = Equations.eqn1(
        ...
        UINT512 memory sumOfSquaredErrorsWeighted = Equations.eqn1(
        ...
        (denom.LS, denom.MS) = denom.sub(
            sumOfSquaredErrorsWeighted.LS,
            sumOfSquaredErrorsWeighted.MS
        );
