...
contract Yieldswap {
    ...
    IUniswapV2Factory
    private constant uniSwapFactoryAddress = IUniswapV2Factory(
        0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f
    );
    address
    private constant wethTokenAddress = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    ...
    Sushiswap_ZapOut public z0 = Sushiswap_ZapOut(0x28d7A6b956AB7f748C09F278942A435751af9a07);
    Sushiswap_ZapIn public z1 = Sushiswap_ZapIn(0xB424ed35B0252bA291768bad8e1569d7B12D5475);
