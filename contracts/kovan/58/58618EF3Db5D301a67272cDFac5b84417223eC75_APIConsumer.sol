...
contract APIConsumer is ChainlinkClient {
     ...
     */
    function _requestTweetAuthor() internal returns (bytes32 requestId) {
        ...
        request.add("queryParams", "tweetId=1427769115582910468");
     ...
     */
    function fulfill(bytes32 _requestId, uint256 _authorId)
        public
        recordChainlinkFulfillment(_requestId)
    {
        emit Callback(_requestId, _authorId);
        requests[_requestId] = _authorId;
    }
