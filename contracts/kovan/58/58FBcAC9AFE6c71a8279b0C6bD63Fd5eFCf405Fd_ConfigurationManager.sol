 ...
 * @author Pods Finance
 * @notice Allows contracts to read protocol-wide address modules
 */
 ...
 * @title ModuleStorage
 * @author Pods Finance
 * @notice Stores addresses from address modules
 */
contract ModuleStorage {
    ...
    /**
     * @dev Get a address module address
    ...
    /**
     * @dev Set a address module address
     * @param name The name of a module
