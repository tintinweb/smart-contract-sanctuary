...
contract Jackpot is Context, Ownable, IERC20, IERC20Metadata, VRFConsumerBase {
    ...
    uint256 private _totalSupply = uint256(100_000_000);
    ...
    function getFees(uint256 amount) internal pure returns (uint256, uint256, uint256, uint256, uint256) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        (uint256 aFee, uint256 hFee, uint256 cFee, uint256 mFee, uint256 transferredAmount) = getFees(amount);
        _poolForActors += aFee;
