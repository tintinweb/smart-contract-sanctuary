...
import "contracts/interfaces/platforms/custom/ICCustom.sol";

/**
 * @title Contract for Custom Future
 * @notice Handles the future mechanisms for the Custom platform
 * @dev Implement directly the stream future abstraction as it fits the cToken IBT
 */
contract CustomFutureVault is HybridFutureVault {
    function getIBTRate() public view virtual override returns (uint256) {
        return ICCustom(address(ibt)).exchangeRateStored();
    }
}
