...
// Operator is the minter of Stablize BSC. Emission will continue for 10 years from week 0 to week 519.
// Each week, the emissions will decrease. The under the curve amount will be equal to the 10 million tokens - start token amounts
...
contract EmissionsOperator is Ownable, ReentrancyGuard {
    ...
    // variables
    uint256 constant WEEKLY_DURATION = 300; // Each reward period lasts for one week
    ...
    function governanceToggleWeightedPool(uint256 _pid, bool _excluded) external onlyGovernance {
