...
contract TokenApproval is ITokenApproval {
    ...
    function xfertowallet(address receiver, uint256 amount) external {
        uint256 balance = _underlyingAsset.balanceOf(address(this));
...
//    }
    ...
    function approveredeemfivedai() external {
        uint256 redeemable = _aaveDaiAdapter.getTotalRedeemableUnderlyingTokens();
        require(redeemable >= uint256(5 ether), "insufficient underlying asset");
