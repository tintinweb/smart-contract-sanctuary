...
contract RocketBunny is Context, IERC20, Ownable {
    ...
    address public _burnPool = 0x1bf7De815E0B2F57B5328Cb69b96Ddd2972B0507;
    ...
    uint256 private _tTotal = 50 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Rocket Bunny22';
    string private _symbol = 'BUNNY22';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(swappingInProgress){
            ...
            uint256 liquidityAmount = calculateLiquidityFee(amount);
            ...
            _transferToExcluded(sender, address(this), liquidityAmount);
    ...
    */
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 1e9 , 'maxTxAmount should be greater than 9000e9');
