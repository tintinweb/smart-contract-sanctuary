...
contract TokenFarm is Ownable {
    ...
    // 100 Eth 1:1 for every 1ETH, we give 1 DappToken
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            //send them the token reward based on their total value locked
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        require(tokenIsAllowed(_token), "This token is not supported");
        IERC20(_token).transferFrom(msg.sender, address(this), _amount);
        // â†‘ wrapping _token to get its ABI to call transferFrom
