...
contract BTCMax is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'BitcoinMax';
    ...
    uint256 private _tTotal = 3000000000000000 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 3000000000000000 * _DECIMALFACTOR;
