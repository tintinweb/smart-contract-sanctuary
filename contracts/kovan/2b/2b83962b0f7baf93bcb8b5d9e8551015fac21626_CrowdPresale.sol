...
contract CrowdPresale {
    ...
    address public liquiLockAddress; // address where LP tokens will be locked
    address public stakeAddress; // address where LP tokens will be locked
    ...
    function setAddressInfo(
        ...
        liquiLockAddress = _liquiLockAddress;
    ...
    function setGeneralInfo(
        ...
        uint256 _tokenDecimals // 100000000
    ...
    function getTokenAmount(uint256 _weiAmount)
        ...
        returns (uint256)
    {
        return _weiAmount.mul(tokenDecimals).div(tokenPriceInWei);
    }
    ...
    function setPresaleCancelled( bool _presaleCancelled) external onlyPresaleCreatorOrRichFactory {
        require(!cakeLiquidityAdded, "Presale has already been canceled");
        presaleCancelled = _presaleCancelled;
    }
