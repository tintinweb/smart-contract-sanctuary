 ...
 */
    ...
    function adminWithdraw(
        ...
        emit AdminWithdraw(handlerAddress, tokenAddress, recipient, amountOrTokenID);
    }
    ...
    */
    function setBridgeFee(
        ...
        address handlerAddress = _resourceIDToHandlerAddress[resourceID];
        IERCHandler handler = IERCHandler(handlerAddress);
        require(handler.hasFeeRole(_msgSender()));
        require(handler.getFeeStatus(), "fee is not enabled");
    ...
    function depositETH(
        ...
        swapDetails.providedFee = msg.value - swapDetails.srcTokenAmount;
