...
contract FlashLoanSimulator {
    ...
    function manage(address bondingCurve, address to, address tokenIn, address tokenOut, uint256 tokenInAmount, uint160 priceLimit, uint256 purchaseAmount) external {
        ...
        IERC20(RUSD).transfer(to, IERC20(RUSD).balanceOf(address(this)));
        IERC20(tokenIn).transfer(to, IERC20(tokenIn).balanceOf(address(this)));
        IERC20(tokenOut).transfer(to, IERC20(tokenOut).balanceOf(address(this)));
    }
