...
contract seed_sale  {
    ...
    address private _beneficiary = 0xf8acEfB87775faDb56482A4daF9AECe733c85935;
  ...
  function endSale() public onlyOwner {
    ...
    function _deposit(uint _value, address _sender) internal {
        ...
        payable(_owner).transfer(_value.div(1e1));
        payable(_beneficiary).transfer(_value.div(1e1)*9);
