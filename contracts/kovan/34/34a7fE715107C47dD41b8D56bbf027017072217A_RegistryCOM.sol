...
contract RegistryCOM is ERC721Burnable {
    ...
    event NewDomain(uint256 tokenId, string domain, bytes32 indexed hash);
    ...
    // Resolver Managment - Start

    function setResolver(uint256 tokenId, address resolver) public {
