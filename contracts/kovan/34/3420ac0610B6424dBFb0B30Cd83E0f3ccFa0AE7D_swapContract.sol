...
contract swapContract is AccessControl, Pausable, ECDSAOffsetRecovery{
    ...
    mapping(uint128 => IERC20) public blockchainPools;
...
//      */
    ...
    external whenNotPaused
    {
        ...
        require(tokenInAddress.approve(address(blockchainRouters[numOfThisBlockchain]), tokenInAmount), 'approve failed.');
        uint256[] memory amounts = blockchainRouters[numOfThisBlockchain].swapTokensForExactTokens(ExactRBCtokenOut, tokenInAmount,
                                                                firstPath, address(blockchainPools[numOfThisBlockchain]),
        ...
        whenNotPaused
    {
        ...
        require(IERC20(path[0]).transferFrom(address(blockchainPools[numOfThisBlockchain]), address(this), amountWithoutFee),
    ...
    function setPoolAddressOfBlockchain(uint128 _blockchainNum,IERC20 _poolAddress) external onlyOwnerAndManager{
