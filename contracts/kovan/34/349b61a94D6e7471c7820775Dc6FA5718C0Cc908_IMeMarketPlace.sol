...
contract IMeMarketPlace is Ownable {
    ...
    constructor(
        ...
        periodToPrice[30] = 1000000000000000000000; // 18 decimals
        periodToPrice[90] = 2700000000000000000000; // 18 decimals
        periodToPrice[180] = 4800000000000000000000; // 18 decimals
        periodToPrice[360] = 8400000000000000000000; // 18 decimals
    }
    ...
    function offerBot(
        ...
        uint256 _priceUSD = periodToPrice[period];
        require(_priceUSD > 0, "No such period");
        LIME.safeTransferFrom(msg.sender, LIMEFeeAddress, _priceUSD);
