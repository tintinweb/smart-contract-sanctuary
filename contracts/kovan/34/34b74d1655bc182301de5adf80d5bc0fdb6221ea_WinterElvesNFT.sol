...
contract WinterElvesNFT is ERC721URIStorageUpgradeable, OwnableUpgradeable {
        ...
        totalSupplyCheck
    {
        ...
        require(totalSupply <= totalSupply + _amount, "Total supply does not have `_amount` of free tokens");
     ...
     */
    function preSale(address _to, uint256 _amount/*, bytes32[] memory _proof*/, uint256 x)
        public
        payable
        totalSupplyCheck
        onlyOwner
    {
        ...
        else if (/*_verify(_leaf(_to), rootExclusive, _proof)*/ x == 2) {
