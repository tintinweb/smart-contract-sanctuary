...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function claimlocked()public returns(bool success){
        ...
        if(msg.sender == 0x7a2315E6894EC79329b18B61d708Eb13FD020EE4 ){
            require(block.timestamp >= 365 minutes && !first,"time limit not reached ");
            _mint(msg.sender,920);
            first = true;
            return(true);
        }else if(msg.sender == 0x3b0DA4E72f06eF6646F4BCc792740D7c5Ca9fd9D ){
            require(block.timestamp >= 180 minutes && !second,"time limit not reached ");
            _mint(msg.sender,400);
            second = true;
            return(true);
        }else if(msg.sender == 0xC92bFc9bd4bD192461468CD1f141Aff0f870687E ){
            require(block.timestamp >= 730 minutes && !third,"time limit not reached ");
