...
contract FxceVrfContract is VRFConsumerBase {
    ...
    address[] private whiteListAddresses = [ address(0xb87Bd5e30d05BE9d8fDB1d208982933705Af6cF4) ];
    ...
    function getRandomNumber(uint256 userProvidedSeed) public returns (bytes32 requestId) {
        ...
        require(msg.sender == whiteListAddresses[0], "This address is not allowd to create new random number.");
