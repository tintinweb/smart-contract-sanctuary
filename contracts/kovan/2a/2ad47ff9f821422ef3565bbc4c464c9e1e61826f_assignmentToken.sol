...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require(minter==msg.sender,"Minter can only mint tokens");
        require(supply+amount<=MAXSUPPLY,"Beyond supply limit");
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(msg.sender==minter,"Only minters can burn tokens");
    ...
    function transferMintership(address newMinter) public returns (bool) {
        ...
        require(minter==msg.sender,"incumbentminter can only transfer mintership");
        address previousMinter=minter;
        minter=newMinter;
        emit MintershipTransfer(previousMinter,minter);
        return true;
    }
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(balances[msg.sender] >= _value+1,"Not enoguh tokens to complete the transfer");
    ...
    function transferFrom(
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require(balances[_from] >= _value+1, "Balance is not enough to complete transfer");
        require(allowances[_from][msg.sender] >= _value+1, "Allowance is not enough to complete transfer");
