...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #WCT

    I make this #PF to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/PFTokenHECO
   ...
   I will renounce the ownership to burn addresses to transfer #PF to the community, make sure it's 100% safe.

   I will add 1 HT and all the left 49% total supply to the pool
   Can you make #PF 100X? 
...
contract WCTToken is Context, IERC20, Ownable {
    ...
    string private _name = "Welsh corgi Token";
