...
// File contracts/CentaurLPToken.sol
...
// File contracts/libraries/CentaurMath.sol
...
// File contracts/interfaces/ICentaurFactory.sol
...
interface ICentaurFactory {
    ...
    function initContracts(address settlement, address payable router) external;
...
// File contracts/interfaces/ICentaurPool.sol
...
// File contracts/interfaces/ICentaurSettlement.sol
...
// File contracts/CentaurPool.sol
...
contract CentaurPool is Initializable, CentaurLPToken {
    ...
    function getOraclePrice() public view returns (uint) {
        (uint price, uint timestamp) = IOracle(oracle).getPrice();

        // require ((block.timestamp).sub(timestamp) < 5 minutes, "CentaurSwap: ");
