...
contract SmartTreasuryV2Test is ERC20PresetMinterPauserUpgradeableDecimals, ERC20PermitUpgradeableDecimals {
    ...
    function setBonusBalanceTest(uint256 _balance) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "admin only");
        bonusBalance = _balance;
    }
