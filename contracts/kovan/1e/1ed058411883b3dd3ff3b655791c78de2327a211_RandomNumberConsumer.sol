...
contract RandomNumberConsumer is VRFConsumerBase {  
    ...
    // mapping(bytes32 => uint256) public apiRequestId;
     ...
     mapping(address => bytes32) public requestoAddressToRandom;
    constructor() 
        VRFConsumerBase(
        ...
        )
    {
       ...
       function getRandomNumber() public returns (bytes32) {
        ...
        return random;
        requestoAddressToRandom[msg.sender]=random;
    }
  ...
  function getMap1(address _adr) public view returns(bytes32){
  return requestoAddressToRandom[_adr];
  }
