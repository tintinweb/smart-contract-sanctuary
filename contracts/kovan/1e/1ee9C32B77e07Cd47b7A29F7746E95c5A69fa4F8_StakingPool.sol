...
contract StakingPool is IStakingPool, PermissionGroup {
    ...
    /**
     * @dev Harvest all time for upgrade star and reward earned from a Hero.
     * @param heroId id of hero.
     */
    ...
    /**
     * @dev Gets status of upgrade star and KABY earned by a hero so far.
     * @param heroId id of hero.
     */
    ...
    /**
     * @dev Gets total KABY staked of a Hero.
     * @param heroId id of hero.
     * @param account wallet address of user, who want to get total KABY staked of a Hero.
     */
