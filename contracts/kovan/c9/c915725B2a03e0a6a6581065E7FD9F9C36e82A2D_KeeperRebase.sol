...
contract KeeperRebase is KeeperCompatibleInterface, ChainlinkClient, Ownable {
    ...
    Benchmark immutable BENCHMARK;
    Sync public SYNC;

    address private oracle;
    uint256 private fee;
    bytes32 private jobId;
    bytes32 private latestRequestId;
    ...
    constructor(address _benchmark, address _sync, address _link, int256 _targetPrice, uint256 _interval) {
        ...
        */
        ...
        jobId = "0dccf381bb00449c83aeceb0f7f0fdf7";
        fee = 0.1 * 10 ** 18;
...
/******************************************/
    ...
    function rebaseCallback(bytes32 _requestId, uint256 _price) external {
        ...
        int256 rebasePercentage = (latestPrice - targetPrice) / targetPrice;
        uint256 absolutePercentage = uint256(abs(rebasePercentage));
        uint256 supplyDelta = BENCHMARK.totalSupply() * absolutePercentage / 1e10;
