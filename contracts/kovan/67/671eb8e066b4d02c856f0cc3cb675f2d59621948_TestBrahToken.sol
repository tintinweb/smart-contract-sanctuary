...
/**
   ...
   42% liqueidy at start
   3% dev
   1.5% Charity
   1.5% marketing
   2% pool for previous token holders
...
/**
 * @dev Contract module which provides a basic access control mechanism for renouncing 
 * the current owner.
 *
 * By default, the owner account will be the one that deploys the contract. This
 * can later be changed with {renounceOwnership}.
 *
 ...
 */
 contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked. Please view the getUnlockTime() method to see when it will be unlocked. Note the value will be a UTC Timestamp.");
...
contract TestBrahToken is Context, IERC20, Ownable {
	...
	HARD WIRED CONFIGS
	*/
    string private _name = "TestBrahCoin";
    string private _symbol = "TESTBRAHC";
    uint256 private _decimals = 18;
    uint256 private _supply = 1000000000 * 10**3 * 10**18;
    ...
    address private tokenOwner = 0xa6dcec288F08DdFD7700E634d148d1308E5fEB3B;
    address private _charityAddress = 0x397f8E72785bCaddaCbE1670E9E4025436390c10;
    address private _marketing = 0x5359e6f1d8333E8d60CEd242e2ab407F110528CC;
    address private _pool1 = 0x22313476263C4F9E607B5e387E9B1A445CaD6E18;
    address private _pool2 = 0x16B182c5940ED0E3DcaF94Cf1D5244af032a82F2;
    address private _pool3 = 0x969697720C66A85d6e785b878C83542418F1b77c;
    ...
    function totalBurn() public view returns (uint256) {
        return _rOwned[address(0x0dead)];
    }
    ...
    */
    ...
    function _burn(address _who, uint256 _value) internal {
        ...
        emit Transfer(_who, address(0x0dead), _value);
    }
