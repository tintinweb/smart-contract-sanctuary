...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function pairFor(address token1, address token2) external view returns(address) {
            ...
            uint160( bytes20(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"c0c50a9a2e3f0d80a5df6660614af71665b2defd085feb98744e671731679084" // init code hash
                    )
                )
            ))
        );
