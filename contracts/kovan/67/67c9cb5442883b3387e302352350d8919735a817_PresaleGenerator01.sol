...
contract Presale01 is ReentrancyGuard {
  ...
  constructor(address _presaleGenerator) public {
    ...
    PRESALE_SETTINGS = IPresaleSettings(0xd250677151849ea3872E03252B1e38744B338966);
    PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0x1277ae2EfA9b0B2D0563BE18B69468af25082d7d);
...
contract PresaleGenerator01 is Ownable {
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0xA160199C3b68ee0ebe95b78Ca3377dFFf6948329);
        PRESALE_SETTINGS = IPresaleSettings(0xd250677151849ea3872E03252B1e38744B338966);
    }
