...
import "ERC721.sol";
import "Strings.sol";
import "TestEIP712Whitelist.sol";

contract TEST is ERC721, TestEIP712Whitelist {
    ...
    constructor(string memory baseURI, address withdrawer, address signer) ERC721("TestERC721", "ERC721") TestEIP712Whitelist() {
...
contract TestEIP712Whitelist is Ownable {
