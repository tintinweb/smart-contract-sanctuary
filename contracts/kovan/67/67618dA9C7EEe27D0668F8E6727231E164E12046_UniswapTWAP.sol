...
contract UniswapTWAP is IUniswapTWAP, Ownable {
    ...
    **/
    function getVaderEthSpotPrice() public view returns (uint256) {
        ...
        (uint vaderReserve, uint ethReserve) = pairData.isFirst ? (reserve0, reserve1) : (reserve1, reserve0);
        return FixedPoint.fraction(ethReserve, vaderReserve).mul(ONE_VADER).decode144();
    }
