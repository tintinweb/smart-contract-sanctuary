...
import "./FeeToAddrDeflAutoLP.sol";
...
contract BurnableFeeToAddrDeflAutoLPToken is FeeToAddrDeflAutoLPToken, AbstractBurnableDeflToken {
    ...
    function totalSupply() external view override(AbstractDeflationaryToken, AbstractBurnableDeflToken) returns(uint256) {
        return _tTotal - totalBurned;
    }
}
...
contract DeflationaryAutoLPToken is AbstractDeflationaryToken {
