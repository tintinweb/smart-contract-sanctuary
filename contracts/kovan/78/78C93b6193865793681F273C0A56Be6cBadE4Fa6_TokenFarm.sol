...
contract TokenFarm is Ownable {
    ...
    {
        address priceFeedAddresss = tokenPriceFeedMapping[_token];
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        require(tokenAllowed(_token), "this Token is not allowded to stake.  ");
    ...
    function unstakeTokens(address _token) public {
        ...
        require(balance > 0, "staking balance of this token is 0 for you ");
