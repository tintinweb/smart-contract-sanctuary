...
contract GROToken is Constants, ERC20, Ownable {
    ...
    // inflation variables initated to 0 and cannot be update until INFLATION_START_TIME
    ...
    event LogMinter(address newMinter);
    ...
    function setInflationRate(uint256 rate) public onlyOwner {
        ...
        require(currentTime > INFLATION_START_TIME, 
                "setInflationRate: Cannot set inflationrate before inflation start time");
