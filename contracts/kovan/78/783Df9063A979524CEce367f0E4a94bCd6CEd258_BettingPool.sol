...
contract BettingPool is Ownable {
    ...
    uint256 private fee;
    uint256 private maxTimeWaitForRefunding = 30 * 60 * 60 * 24;
    ...
    constructor(
        ...
        fee = _fee;
        rewardRate[PrizeBetting.GuaranteedPrizeBettingContract] = [0, 95, 5, 0];
        rewardRate[PrizeBetting.StandardPrizeBettingContract] = [1, 975, 25, 1];
    }
