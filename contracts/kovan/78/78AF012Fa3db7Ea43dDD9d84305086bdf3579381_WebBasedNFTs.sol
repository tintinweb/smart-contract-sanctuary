...
import "../contracts/interfaces/IPaymentSplitter.sol";
...
contract WebBasedNFTs is ERC721Enumerable, Ownable, ChainlinkClient {
    ...
    constructor(string memory _baseTokenURI, address paymentSplitter)
    ...
    function mintWebToken(
       ...
       _tokenInfo[_webCode] = metadata(_webCode, webOwner, 0, 0, webURL);
        require(IPaymentSplitter(_paymentSplitter).addWebAccount(webOwner, _webCode) == _webCode,"Error in creating account in payments");
        _safeMint(webOwner, _webCode);
        return _webCode;
    }
