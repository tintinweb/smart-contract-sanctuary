...
contract TRENDY is Context, IERC20, Ownable {
    ...
    string private _name = "Trendy Test 4";
    string private _symbol = "TRENDY4";
    ...
    function sellTokensFromTrendyStoreToBuyProducts(uint256 tokenAmount) external onlyTrendyAdmin {
        ...
        _approve(trendyAdmin, address(this), tokenAmount);
        transferFrom(trendyAdmin, address(this), tokenAmount);
