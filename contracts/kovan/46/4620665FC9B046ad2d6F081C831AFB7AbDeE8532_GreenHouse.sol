...
contract GreenHouse is Ownable {
    ...
    event Stake(address indexed sender, uint256 amount, address referrer);
    event Unstake(address indexed sender, uint256 amount);
    event WithdrawReward(address indexed sender, uint256 amount);
    event DistributeBonusRewardPool();
    event DistributeMonthlyRewardPool();
    ...
    function withdrawReward() external {
        ...
        emit WithdrawReward(msg.sender, withdrawable);
    }
    ...
    function distributeMonthlyRewardPool() external {
        ...
        emit DistributeMonthlyRewardPool();
    }
    ...
    function distributeBonusRewardPool() external {
        ...
        emit DistributeBonusRewardPool();
    }
