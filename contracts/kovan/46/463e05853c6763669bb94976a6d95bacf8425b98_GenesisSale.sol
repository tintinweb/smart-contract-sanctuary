...
contract GenesisSale is ReentrancyGuard {
    ...
    */
    ...
    modifier isWhitelisted(address _user){
        require(whitelisted[_user],"Address not verified");
        _;
    }
    ...
    function purchase(address _reciever) public  payable nonReentrant returns(bool){
        ...
        require(whitelisted[_reciever],"Address not verified");
    ...
    */
    ...
    function whitelist(address _user) public onlyGovernor isZero(_user) returns(bool){
