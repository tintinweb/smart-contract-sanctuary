...
contract LessLibrary is Ownable {
    ...
    uint256 private minStakeTime = 1; //one day
    uint256 private minUnstakeTime = 1; //six days

    address private factoryAddress;

    uint256 private minVoterBalance = 500 * 1e18; // minimum number of  tokens to hold to vote
    uint256 private minCreatorStakedBalance = 5000 * 1e18; // minimum number of tokens to hold to launch rocket
