...
contract FSDGovernor is GovernorSettings, GovernorCountingSimple, GovernorProposalThreshold, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(ERC20Votes _token, TimelockController _timelock)
	Governor("FSDGovernor")
	GovernorVotes(_token)
	GovernorVotesQuorumFraction(25)
	GovernorTimelockControl(_timelock)
	// delay = 1 block, period = 1 week (13.2 secs / block), threshold 1M
	GovernorSettings(1, 45818, 1000000 ether)
    {
    }
