...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    // Event we use to fake Oracle Response in testnet/dev
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        // 50/2,000
        // 50 * 100000 / 2000
        // Note : we should adapt to use safemath here.
        uint256 costToEnter = (usdEntryFee * 10**18) / adjustedPrice;
        return costToEnter; // Fee in Wei
    }
    ...
    function endLottery() public onlyOwner {
        // This is a vulnerable approche to get a random number (aka chose the winner in this case)
        ...
        // Emit an event to signal ourself that it's time to create a fake random. (Check deploy.py)
