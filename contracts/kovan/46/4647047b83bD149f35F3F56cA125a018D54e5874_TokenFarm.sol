...
contract TokenFarm is ChainlinkClient {
//contract TokenFarm is ChainlinkClient, Ownable {
    ...
    //constructor(address _dappTokenAddress, uint _deposit) public{
    ...
    /*function depositTest(uint256 amount, address user) public {
        ...
        IERC20(daiAddress).approve(provider.getLendingPool(), depositAmount);
    
        lendingPool.deposit(daiAddress, amount, address(this), referral);
    ...
    /*function depositCollateral(address _asset, uint256 _amount, bool _isPull) external returns (bool) {
        ...
        //safeTransferFrom(_asset, msg.sender, address(this), _amount); 
        //IERC20(_asset).safeApprove(msg.sender, _amount);
