    ...
    SuperAppBase
{
    ...
    function issueNft(address to, string memory tokenURI) external payable onlyMinterOrOwner { // return id too 
    ...
    function setFlowRate(int96 flowRate) public returns (int96 newFlowRate) {
