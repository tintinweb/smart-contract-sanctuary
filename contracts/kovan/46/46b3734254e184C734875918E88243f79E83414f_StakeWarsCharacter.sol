...
contract StakeWarsCharacter is Administerable {
    ...
    function RegisterStakeWarrior(address player) public {
        ...
        _registeredStakeWarriors[player] = player;
    }
    ...
    {
        return
            StakeWarsInternals(_registeredStakeWarriors[warrior]).getRaritySeed(
                securityKey
            );
    }
    ...
    {
        (uint8 rarity, uint8 index) = StakeWarsInternals(
            _registeredStakeWarriors[warrior]
    ...
    function GetClass(address warriorAddr, uint8 index)
        ...
        returns (string memory, uint8)
    {
        uint8 classIndex = StakeWarsInternals(
            _registeredStakeWarriors[warriorAddr]
        ).class(index);
    ...
    function GetLand(address warrior, uint8 index)
        ...
        returns (string memory, uint8)
    {
        uint8 land = StakeWarsInternals(_registeredStakeWarriors[warrior]).land(
            index
        );
    ...
    {
        return
            StakeWarsInternals(_registeredStakeWarriors[warrior]).getLevels(
                game,
                securityKey
            );
    }
    ...
    function _setClass(
        ...
        StakeWarsInternals(_registeredStakeWarriors[warrior]).setClass(
            newClass,
            index,
            securityKey
        );
    ...
    function _setLand(
        ...
        StakeWarsInternals(_registeredStakeWarriors[warrior]).setLand(
            newLand,
            index,
            securityKey
        );
    ...
    function _updateExperience(
        ...
        StakeWarsInternals(_registeredStakeWarriors[warrior]).updateExperience(
            changedExperience,
            amount,
            increase,
            securityKey
    ...
    function _updateLevel(
        ...
        StakeWarsInternals(_registeredStakeWarriors[warrior]).updateLevel(
            changedExperience,
            amount,
            increase,
            securityKey
