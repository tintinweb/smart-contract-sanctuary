...
contract assignmentToken {
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        // Assume that the transaction fee is 1%
        require(balances[msg.sender] >= (_value*101/100+1));
        balances[_to] += _value;
        balances[msg.sender] -= (_value+1);
        balances[minter] +=1;
        emit Transfer(msg.sender, _to, _value*101/100);
    ...
    function transferFrom(
        ...
        require(balances[_from] >= (_value*101/100+1));
        require(allowances[_from][msg.sender] >= (_value*101/100+1));
        balances[_to] += _value;
