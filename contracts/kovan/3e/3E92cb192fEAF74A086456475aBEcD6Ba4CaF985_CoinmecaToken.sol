 ...
 */
contract TokenBase is Context, IERC20, TokenLocker {
    ...
    returns(bool) {
        ...
        (uint iterRemains, uint lockAmount) = getLockDetails(_account);
        uint userBalance = balanceOf(_account);
...
contract CoinmecaToken is TokenBase {

  constructor()
  TokenBase("Coinmeca Standard Token", "CMST") {
