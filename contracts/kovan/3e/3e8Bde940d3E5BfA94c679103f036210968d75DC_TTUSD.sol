...
contract Share is ERC20Custom, Ownable, Initializable {
    ...
    uint256 public constant genesis_supply = 1000 ether; // 1000 will be mited at genesis for liq pool seeding

    // CONTRACTS
    address public treasury;

    // DISTRIBUTION
    uint256 public constant COMMUNITY_REWARD_ALLOCATION = 70_000_0000 ether; // 80M
    uint256 public constant TREASURY_FUND_ALLOCATION = 30_000_0000 ether; // 30M
    uint256 public constant TREASURY_FUND_VESTING_DURATION = 730 days; // 24 months
...
contract TTUSD is ERC20Custom, IDollar, Ownable, Initializable {
    // ERC20
    string public symbol;
    string public name;
    uint8 public constant decimals = 18;
