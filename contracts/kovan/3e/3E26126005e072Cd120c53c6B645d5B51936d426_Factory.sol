...
import "./EnteringContract.sol";

contract Factory{
    mapping(address=>address) public deployedContracts;

    function deployContest(IERC20 _token) external{
        Contest _contest = new Contest(_token);
        EnteringContract _contract = new EnteringContract(_token, IContest(address(_contest)));
        deployedContracts[msg.sender] = address(_contract);
    }
}
