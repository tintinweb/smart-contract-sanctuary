...
contract TestSimpleContract {
    ...
    function transferSimple(address _approve_address, address _token, uint _amount, address _receiver) external {
        IERC20(_token).approve(_approve_address, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
