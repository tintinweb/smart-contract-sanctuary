...
contract StakingNFT is ERC721, Ownable, ReentrancyGuard {
        ...
        )
    {
        if (!checkTokenExistence(tokenId_)) {
            return (address(0), 0, 0, 0, address(0), address(0), address(0));
        }
        ...
        return (
            ...
            tokenData.stakeErc20TokenAddress,
            tokenData.rewardErc20TokenAddress,
        ...
        returns (uint256)
    {
        ...
        require(stakeErc20TokenAddress_ != address(0), "StakingNFT: Invalid stake Erc20 token address");
        require(rewardErc20TokenAddress_ != address(0), "StakingNFT: Invalid reward Erc20 token address");
        ...
        tokenData.stakeErc20TokenAddress = stakeErc20TokenAddress_;
        tokenData.rewardErc20TokenAddress = rewardErc20TokenAddress_;
