...
// File contracts/PublicDistribution.sol

contract PublicDistribution is Ownable {
    ...
    uint256 private constant _remainingDistroPercentage = 60;
    uint256 private constant _noOfRemaingDays = 90;
    uint256 private constant SECONDS_PER_DAY = 24 * 60 * 60;
    uint256 private constant _durationDays = 30;
        ...
        returns (uint256 availablePercentage)
    {
        ...
        uint256 vestingDuration = _initialTimestamp + 90 days;
        ...
        if (currentTimeStamp > _initialTimestamp) {
            if (currentTimeStamp <= oneDays) {
                ...
                uint noOfPeriods = noOfDays / 30;
                uint256 currentUnlockedPercentage = noOfPeriods *
                    everyPeriodReleasePercentage;
                return (uint256(40) * 1e18) + currentUnlockedPercentage;
            } else {
