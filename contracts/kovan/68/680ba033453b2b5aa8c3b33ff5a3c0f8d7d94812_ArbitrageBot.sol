...
contract ArbitrageBot is AccessControl {
    ...
    //  */
    constructor() {
        bPool = IBPool(0x1492B5b01350b7C867185a643F2E59F7BE279Fd3);
        tokens[0xd0A1E359811322d97991E03f863a0C30C2cF029C] = ERC20(0xd0A1E359811322d97991E03f863a0C30C2cF029C);
        tokens[0x1528F3FCc26d13F7079325Fb78D9442607781c8C] = ERC20(0x1528F3FCc26d13F7079325Fb78D9442607781c8C);
        tokens[0xef13C0c8abcaf5767160018d268f9697aE4f5375] = ERC20(0xef13C0c8abcaf5767160018d268f9697aE4f5375);
        weth = IWeth(0xd0A1E359811322d97991E03f863a0C30C2cF029C);
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }
    // constructor(address _bPool, address _deus, address _dea, address _sdea, address _suni_dd, address _suni_de, address _suni_du, address _sdeus) {
    //     bPool = IBPool(_bPool);
