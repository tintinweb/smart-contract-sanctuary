...
contract GasBurner {
    ...
    GasTokenInterface public constant gasToken = GasTokenInterface(0x0000000000170CcC93903185bE5A2094C870Df62);
...
contract DFSExchangeHelper {
    ...
    IFeeRecipient public constant _feeRecipient = IFeeRecipient(0x0FcE5cfd2FaA2AD94944250F85190e1625Ba27c5);

    address public constant DISCOUNT_ADDRESS = 0x44af87c877924543E8c031a1a1BDFC92cB63c38A;
    address public constant SAVER_EXCHANGE_REGISTRY = 0x6a2cF2dcC82Bda5975B2B21e6d76461689fD6A13;

    address public constant ZRX_ALLOWLIST_ADDR = 0x7756FA471FbA3EbB01294f8626547591c2a70e51;
...
contract ProxyPermission {
    address public constant FACTORY_ADDRESS = 0x69C97753Aecb1a1f865A0890216aC08894c4b089;
...
contract LoanShifterTaker is AdminAuth, ProxyPermission, GasBurner {
    ...
    address public constant CETH_ADDRESS = 0x41B5844f4680a8C38fBb695b7F9CFd1F64474a72;
    address public constant DAI_ADDRESS = 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa;

    address public constant MCD_SUB_ADDRESS = 0x220B185Eae9930c42fb44B10Fc66C25D317A66De;
    address public constant COMPOUND_SUB_ADDRESS = 0x962C005Dd53BDe5afdF0c616cac8F7Ad0661eBAF;

    address public constant MANAGER_ADDRESS = 0x934F16B859795B2186826bb8A094468A9Ac0DFd1;

    address public constant ELIXYRSAVER_LOGGER = 0x5B62F141997f7f4015034fB3992C8aeC0002AFbd;

    Manager public constant manager = Manager(MANAGER_ADDRESS);
    ShifterRegistry public constant shifterRegistry = ShifterRegistry(0x242136db2D4f7A29eDCAe30Af5De3Be8c30b6FB2);
    ...
    function logEvent(
        ...
        ElixyrsaverLogger(ELIXYRSAVER_LOGGER)
...
contract LoanShifterReceiver is DFSExchangeCore, FlashLoanReceiverBase, AdminAuth {
    address public constant DISCOUNT_ADDR = 0x44af87c877924543E8c031a1a1BDFC92cB63c38A;

    ILendingPoolAddressesProvider public LENDING_POOL_ADDRESS_PROVIDER =
        ILendingPoolAddressesProvider(0x506B0B2CF20FAA8f38a4E2B524EE43e1f4458Cc5);
    address public constant ETH_ADDRESS = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;

    uint public constant SERVICE_FEE = 400; // 0.25% Fee

    ShifterRegistry public constant shifterRegistry =
        ShifterRegistry(0x242136db2D4f7A29eDCAe30Af5De3Be8c30b6FB2);
