...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    mapping (uint256 => uint256) public tokenAttrRand;
    ...
    */
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        tokenAttrRand[tokenId] = random(tokenId);

        emit Transfer(address(0), to, tokenId);
    }

    function random(uint256 tokenId) private view returns (uint256) {
        return uint256(keccak256(abi.encodePacked(block.timestamp, block.difficulty, tokenId)));
    }
...
contract BoredApeYachtClub is ERC721, Ownable {
    ...
    uint256 public constant apePrice = 40000000000000000; //0.04 ETH
    ...
    */
    function mintApe(uint numberOfTokens) public payable {
        ...
        if (startingIndexBlock == 0 && totalSupply() == MAX_APES) {
