...
contract ShirtumSale is ReentrancyGuard, Ownable {
    ...
    // General conditions
    uint256 generalMinBuy = 20000000000000000; // 0.02 ETH
    uint256 generalMaxBuy = 200000000000000000; // 0.20 ETH
    uint256 generalClaimMaxWaitTime = 10 minutes;
    uint256 claimTiming = 10 minutes ;
    uint256[] generalVestingClaim = [2000, 2000, 2000, 2000, 2000];
    mapping(address => uint256) public generalParticipants;

    // Corportative conditions
    uint256 corpMinBuy = 20000000000000000;
    uint256 corpMaxBuy = 200000000000000000;
    uint256 corpClaimWaitTime = 10 minutes;
    uint256[] corpVestingClaim = [837, 833, 833, 833, 833, 833, 833, 833, 833, 833, 833, 833];
    ...
    function pendingToClaim(address wallet) public view returns (uint256) {
