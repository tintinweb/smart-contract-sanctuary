...
contract CopperProxy {
    ...
    // todo remove me. This is a test function that should be remove once proved it is working
    ...
    function noTransferCreateLBPFactoryFromProxy(PoolLBPFactoryConfig memory poolLBPFactoryConfig) external {
        ...
        console.log("process of LBPFactory creation done");
    }

    function createLBPFactoryFromProxy(PoolLBPFactoryConfig memory poolLBPFactoryConfig) external {
        ...
        console.log("LBPFactory started");
        // 2: pool creation
        console.log(LBPFactoryAddress);
    ...
    function createAuction(PoolConfig memory poolConfig) external {
        ...
        // set pool access control
        // todo: add pool enumeration
        poolOwner[pool] = poolConfig.owner; /// TODO: What is the diffence between poolConfig.owner and address(this) ??? why do we pass it then?

        console.log("Join pool about to start");
        ...
        console.log("updateWeightsGradually about to");
        // 4: configure weights
    ...
    // todo: add ability to deposit more liquidity

    function exitPool() external {
        // todo: check what happens if third party deposits liquidity
        // withdraw liquidity from pool
        // transfer liquidity to pool owner
        // transfer fee to fee recipient
        // todo require withdraw can only be done by the owner (onlyPoolOwner)
    }
}
