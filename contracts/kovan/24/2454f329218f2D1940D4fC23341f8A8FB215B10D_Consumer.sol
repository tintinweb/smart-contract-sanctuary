...
contract Consumer is ChainlinkClient {
  ...
  function fulfillValidateName(bytes32 _requestId, bool _clean) public recordChainlinkFulfillment(_requestId) {
    address(registry).call(abi.encodeWithSignature("fulfillRequest(bytes32,bool)", _requestId, _clean));
  }
}
