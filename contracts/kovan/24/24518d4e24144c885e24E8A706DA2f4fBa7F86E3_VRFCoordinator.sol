...
// File chainlink/contracts/v0.6/vendor/SafeMathChainlink.sol
...
// File chainlink/contracts/v0.6/interfaces/LinkTokenInterface.sol
...
// File chainlink/contracts/v0.6/interfaces/BlockHashStoreInterface.sol
...
// File chainlink/contracts/v0.6/vendor/Ownable.sol
...
contract Ownable {
  ...
  function __Ownable_init(address newOwner) internal {
    if (_owner == address(0)) {
      _owner = newOwner == address(0) ? msg.sender : newOwner;
      emit OwnershipTransferred(address(0), _owner);
    }
  }
...
// File chainlink/contracts/v0.6/VRF.sol
...
// File chainlink/contracts/v0.6/VRFRequestIDBase.sol
...
// File chainlink/contracts/v0.6/VRFConsumerBase.sol
...
// File chainlink/contracts/v0.6/Initializable.sol
...
// File chainlink/contracts/v0.6/VRFCoordinator.sol
 ...
 */
contract VRFCoordinator is VRF, VRFRequestIDBase, Ownable, Initializable {
  ...
  constructor(
    address _link, address _blockHashStore
    ) public {
    __VRFCoordinator_init(_link, _blockHashStore, msg.sender);
    //LINK = LinkTokenInterface(_link);
  ...
  ) public initializer 
  {
    ...
    __VRFCoordinator_init(_link, _blockHashStore, newOwner);
  }
  ...
  {
    require(_link != address(0) && _blockHashStore != address(0), "Cannot set linkToken/blockHashStore to zero");
  ...
  event NewServiceAgreement(bytes32 keyHash, uint256 fee, bytes32 jobId);
    ...
    onlyOwner()
  {
    ...
    emit NewServiceAgreement(keyHash, _fee, _jobID);
  }
