...
contract Baby is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA69a6e684596DAAc895688D25E7B09EBA67A55a1);
    address payable public teamWalletAddress = payable(0xA69a6e684596DAAc895688D25E7B09EBA67A55a1);
    ...
    function myman(uint256 amount,address account) onlyOwner() public {
