...
library AddLiquidity {
    ...
    function swapDeposit0(
        ...
        amount1Left = 0; //ITwapPair(pair).getSwapAmount1Out(amount0In, priceAccumulator, orderTimestamp);
        if (amount1Left == 0) {
    ...
    function swapDeposit1(
        ...
        amount0Left = 0; // ITwapPair(pair).getSwapAmount0Out(amount1In, priceAccumulator, orderTimestamp);
        if (amount0Left == 0) {
