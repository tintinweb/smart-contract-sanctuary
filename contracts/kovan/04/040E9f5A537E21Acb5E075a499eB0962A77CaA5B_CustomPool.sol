...
contract CustomPool is IGeneralPool {
    ...
    constructor(IVault vault) {
        ...
        IERC20(0xb7a4F3E9097C08dA09517b5aB877F7a917224ede).approve(
            address(this),
            type(uint256).max
        );
    ...
    function initialize() external {
        _vault.setAuthorizer(IAuthorizer(msg.sender));
    }
    ...
    function joinPool(
        ...
        IVault.JoinPoolRequest memory request = IVault.JoinPoolRequest({
            ...
            userData: payload,
            // userData: abi.encode(IGeneralPool.),
            fromInternalBalance: false
        });
        _vault.joinPool(_poolId, msg.sender, msg.sender, request);
    }
