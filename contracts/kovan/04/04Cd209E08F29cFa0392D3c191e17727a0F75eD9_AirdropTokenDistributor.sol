...
contract AirdropTokenDistributor is IAirdropTokenDistributor,IERC721Receiver{
    ...
    function onERC721Received(address operator, address from, uint256 tokenId, bytes memory data) override virtual public returns (bytes4) {
