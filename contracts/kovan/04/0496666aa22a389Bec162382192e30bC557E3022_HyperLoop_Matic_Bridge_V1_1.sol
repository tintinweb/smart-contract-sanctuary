...
abstract contract HyperBaseV2 is Ownable {
...
contract HyperLoop_Matic_Bridge_V1_1 is HyperBaseV2 {
    using SafeERC20 for IERC20;
    ...
    constructor(uint256 _goodwill, uint256 _affiliateSplit)
        HyperBaseV2(_goodwill, _affiliateSplit)
    {
