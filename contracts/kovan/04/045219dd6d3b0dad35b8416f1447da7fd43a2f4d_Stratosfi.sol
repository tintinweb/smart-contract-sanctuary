...
/** For simplicity's sake, the charity wallet referenced in the code is used for operations and charity rather 
 ...
 * for all to see.
 * 
 * The 'tax' you see in the code is actually for the reflection function. 2% of the tokens from each transaction are distributed
