...
contract OceanToken is ERC20, Ownable {
    ...
    */
    function processReserves() public {
        swapHundler.swapToNativeWrappedToken(taxReserved);
        taxReserved = 0;
    }
...
contract SwapHandler is Ownable {
    ...
    function swapToNativeWrappedToken(
        ...
        if (amount_ > 0){
            totalToHoldersInERC20 += amount_;
            uint256 balanceBefore = address(erc20.hodlRewardDistributor()).balance;
            _swap(
                amount_,
