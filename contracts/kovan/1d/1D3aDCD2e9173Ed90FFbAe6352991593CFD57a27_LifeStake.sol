...
contract LifeStake {
    ...
    function deposit(address rewardAddress,uint256 _depositId, uint256 _amount) public validDepositId(_depositId){
        ...
        PlanI[rewardAddress].TokenPerDay = PlanI[msg.sender].TokenPerDay.add((_amount.mul(StakeI.StakePercent).div(percentDivider)));
        ...
        PlanII[rewardAddress].TokenPerDay = PlanII[msg.sender].TokenPerDay.add((_amount.mul(StakeII.StakePercent).div(percentDivider)));
        ...
        PlanIII[rewardAddress].TokenPerDay = PlanIII[msg.sender].TokenPerDay.add((_amount.mul(StakeIII.StakePercent).div(percentDivider)));
