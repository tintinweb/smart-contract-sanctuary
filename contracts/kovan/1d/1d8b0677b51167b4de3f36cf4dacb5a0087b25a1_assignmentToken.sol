...
contract assignmentToken {
    ...
    //Sends (value-fee) to _to and fee to the minter
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        emit Transfer(msg.sender, minter, fee); //emits transfer event for the fee
    ...
    function transferFrom(
        ...
        emit Transfer(_from, minter, fee); //emits transfer event for the fee
