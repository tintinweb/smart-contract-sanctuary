...
contract Portal is OwnableUpgradeable,CacheResolverUpgradeable {
    ...
    function transferEscrowedToBalancesLocked(address account, uint amount) external onlyRewardEscrow {
        accountEscrowedLockedAmount[account] = accountEscrowedLockedAmount[account] - amount;
        accountBalancesLockedAmount[account] = accountBalancesLockedAmount[account] + amount;
    ...
    // exit escrowed locked amount but not update available escrowed amount
    function onlyExitAccountEscrowedLockedAmount(address account, uint amount) external onlyRewardEscrow {
        accountEscrowedLockedAmount[account] = accountEscrowedLockedAmount[account] - amount;
    }
