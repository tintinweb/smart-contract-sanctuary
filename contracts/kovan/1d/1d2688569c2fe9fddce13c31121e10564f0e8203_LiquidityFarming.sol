...
import "ABDKMathQuad.sol";
 ...
 contract LiquidityFarming is Ownable, LiquidityValueCalculator {
  ...
  address LGE;
    ...
    constructor() {
        ...
        address token_STBL = address(0x17bDfc4651ddc6dC3D8730BF5A9b2B39903CeFe3);
        SWN = TokenInterface(token_SWN);
        STBL = TokenInterface(token_STBL);
        LGE = address(0xe83A374595d0902c89Fa0296e51D2F1597c66A0f);
    }
