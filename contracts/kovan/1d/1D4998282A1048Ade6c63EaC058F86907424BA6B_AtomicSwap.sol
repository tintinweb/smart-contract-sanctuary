...
contract AtomicSwap {
    ...
    )
  {
    ...
    uint256 leftover =
      uniswapRouter.getAmountsOut(tokenAmountIn, tokenSwapPath)[0];
    ...
    if (leftover != 0) {
      inputTokenInstance.safeTransfer(msg.sender, leftover);
    }
    ...
    )
  {
    ...
    uint256 leftover =
      uniswapRouter.getAmountsOut(collateralRedeemed, tokenSwapPath)[0];
    ...
    if (leftover != 0) {
      collateralInstance.safeTransfer(msg.sender, leftover);
    }
    ...
    )
  {
    ...
    uint256 leftover = uniswapRouter.getAmountsOut(msg.value, tokenSwapPath)[0];
