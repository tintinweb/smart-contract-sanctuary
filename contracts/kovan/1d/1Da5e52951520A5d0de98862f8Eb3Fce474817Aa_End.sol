...
// hevm: flattened sources of /nix/store/07p0c2i79x0cv84yjvg1wbhgn4ixi8hs-dss/dapp/dss/src/end.sol
...
////// /nix/store/07p0c2i79x0cv84yjvg1wbhgn4ixi8hs-dss/dapp/dss/src/end.sol
...
contract End is LibNote {
    ...
    function file(bytes32 what, address data) external note auth {
        ...
        else if (what == "cat")  cat = CatLike_1(data);
