...
/** 
 *  FerrariF12Oracle - Ferrari F12 TDF price oracle
 */
contract FerrariF12Oracle is Ownable, ChainlinkClient {
    using SafeERC20 for IERC20;

    string public constant ORACLE_NAME = "CurioInvest - Ferrari F12 TDF price";
    ...
    event FulfilledFerrariPrice(bytes32 requestId, uint256 price, uint256 timestamp);
    ...
    function latestAnswer() external view returns (int256) {
        return int256(ferrariPrice);
    }


    // onlyAdmin function
    function requestFerrariPrice() external onlyAdmin returns (bytes32 requestId) {
    ...
    function fulfillFerrariPrice(bytes32 _requestId, uint256 _price) external recordChainlinkFulfillment(_requestId) {
        ...
        emit FulfilledFerrariPrice(_requestId, _price, curTimestamp);
    }
