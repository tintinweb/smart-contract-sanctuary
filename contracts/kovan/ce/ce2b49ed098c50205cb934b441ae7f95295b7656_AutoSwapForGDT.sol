...
contract AutoSwapForGDT {
  ...
  function transferFrom(uint amountIn) public payable returns(bool){
      require(gorillaDiamondInstance.transferFrom(msg.sender, address(this), amountIn), 'transferFrom failed');
      return true;
  }
