...
// use lastest version at time of writing, need not to worry about overflow and underflow
...
contract Token {
    ...
    // Keep track balances and allowance approved
    ...
    /// @param _to receiver of token
    /// @param _value amount value of token to send 
    /// Internal function transfer can only use be called by this contract
    ...
    /// @param _value amount value of token to spend
    ...
    /// @notice transfer by approval person from original address of an amount within approved limit
