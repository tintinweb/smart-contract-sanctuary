...
contract CharacterDetailsV1 is Administerable {
    ...
    function determineRarity(uint48 rareValue) public view returns (Rarity) {
     ...
     * To String Methods
     */
    function toRarityEnglish(Rarity value) public view returns (string memory) {
    ...
    function toClassEnglish(Class value) public view returns (string memory) {
    ...
    function toLandEnglish(Lands value) public view returns (string memory) {
     ...
     * Character Functions
     */
    function getRaritySeed(address character)
        public
        view
...
contract StakeWarsV1 is ERC721Enumerable, Administerable, VRFConsumerBase {
        ...
        override
    {
        ...
        stakeWarrior[sender][tokenId] = new CharacterDetailsV1(
            randomness,
            rare48,
            root,
            this.isAfterReveal
    ...
    //     require(
    //         supply + numberOfMints <= maxSupply,
    ...
    function reserve(uint256 num) public {
        require(
        ...
        for (uint256 i = 0; i < num; i++) {
            ...
            requestIdToUser[requestId] = User(me, supply);
    ...
    function preMint(uint256 numberOfMints) public payable {
        uint256 supply = totalSupply();
        require(saleActive);
    ...
    function getStakeWarrior(address warrior, uint256 tokenId)
        public
        view
        returns (CharacterDetailsV1)
    {
        isAfterReveal();
        return stakeWarrior[warrior][tokenId];
    }
