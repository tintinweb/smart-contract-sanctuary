...
interface TinlakeManagerFabLike {
    function newTinlakeManager(address dai_, address daiJoin_, address drop_,  address pool_, address tranche_, address end_, address vat_, address vow_) external returns (address);
}
