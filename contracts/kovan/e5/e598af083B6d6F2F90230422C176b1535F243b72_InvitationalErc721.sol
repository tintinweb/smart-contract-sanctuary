...
// File: InvitationalErc721.sol

contract InvitationalErc721 is
    ERC721Burnable,
    ERC721URIStorage,
    AccessControl
{
    ...
    modifier onlyMinterBurner() {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()) || hasRole(MINTER_BURNER_ROLE, _msgSender()),
    ...
    /* function _beforeTokenTransfer(
        ...
        revert("This NFT token is not transferrable.");
    } */
    ...
    function mint(
        ...
        // Give rights to user to mint token?
    }
