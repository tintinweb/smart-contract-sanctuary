...
import "./interfaces/IidoMaster.sol";
 ...
 contract IDOPool is Ownable, Pausable, ReentrancyGuard, Whitelist {
    ...
    function pay() payable external virtual  onlyWhitelisted whenNotPaused nonReentrant{
   ...
   // function withdrawETH(uint256 amount) external onlyOwner {
    ...
    // function withdrawETH(uint256 amount) external onlyOwner  whenNotPaused nonReentrant{
    //     // This forwards all available gas. Be sure to check the return value!
    //     // (bool success, ) = msg.sender.call{value: amount}("");
    //      (bool success, ) = msg.sender.call.value(amount)("");
    //     require(success, "Transfer failed.");
    ...
    // function withdrawFunds() external onlyOwner whenNotPaused nonReentrant { //isSaleFinalized {
