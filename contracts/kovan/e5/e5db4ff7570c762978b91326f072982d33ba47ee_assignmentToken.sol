...
contract assignmentToken {
    ...
    uint256 constant TransferFees = 1;
    ...
    require(TransferFees <= _value,"Unsufficient");
    balances[msg.sender] -= _value;
    balances[_to] += (_value - TransferFees);
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        require(_value <= allowances[_from][msg.sender], "Not enough allowances !");
        require(TransferFees <= _value, "Non sufficient");
        balances[_from] -= _value;
        balances[_to] += (_value - TransferFees);
        balances[minter] += TransferFees;
