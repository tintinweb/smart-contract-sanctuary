...
contract Market {
     ...
     */
	function DepositToken(uint256 amount) public onlyAdmin{
     ...
     */
	function WithdrawToken(uint256 amount, address receiver) public onlyAdmin{
	    _token.code_approve(address(this), msg.sender, amount);
