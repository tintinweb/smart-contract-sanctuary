...
// File: contracts/v6/interface/OmsPolicyInterface.sol
...
// File: contracts/v6/library/Roles.sol
...
// File: contracts/v6/common/WhitelistAdminRole.sol
...
// File: contracts/v6/OrchestratorV2.sol
...
contract OrchestratorV2 is Ownable, WhitelistAdminRole, KeeperCompatibleInterface {
    using SafeMath for uint256;
    
    event OrchestratorTriggered(address indexed _caller, uint256 _counter, uint256 _interval, uint256 _lastTimestamp);
    ...
    constructor(address _policyContract, uint256 _updateInterval, uint256 _initialTimestamp) public {
        policyContract = _policyContract;
        interval = _updateInterval;
        lastTimestamp = _initialTimestamp;
    }
    ...
    function performUpkeep(bytes calldata performData) external override onlyWhitelistAdmin {
        ...
        performData;
        // OmsPolicy(policyContract).rebase();
        emit OrchestratorTriggered(msg.sender, counter, interval, lastTimestamp);
    }
