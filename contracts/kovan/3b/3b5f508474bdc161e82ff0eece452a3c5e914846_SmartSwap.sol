...
// ============================ Events ============================
    ...
    */
    ...
    function claimFee() external returns (uint256 feeAmount, uint256 processingFeeAmount)
    {
        ...
        TransferHelper.safeTransferETH(msg.sender, feeAmount + processingFeeAmount);
    }
