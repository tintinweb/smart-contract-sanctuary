...
contract StandardPrizeBettingContract is AbstractBettingContract {
        ...
        onlyLock
    {
        ...
        upfrontLockedFunds = _maxEntrant * ticketPrice * rewardForCreator / 1000;
    }
    ...
    function close() external override onlyPriceClosed onlyOpen {
        ...
        uint256 reward = 0;
        if (winers.length > 0) {
            reward = (getTotalToken() - upfrontLockedFunds) * rewardForWinner / 1000 / winers.length;
...
contract StandardPrizeBettingFactory is IBettingFactory {
