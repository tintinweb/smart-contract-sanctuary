...
contract TokenFarm is Ownable {
    ...
    //Unstaketokens -
    //issuetokens - DONE
    //addallowed tokens - DONE
    //get value - DONE

    //100 ETH 1:1 (every one eth one our token)
    //50 ETH and 50 DAI staked, give reward of 1 our token / 1 DAI (convert all eth in DAI to get correct ratio)

    constructor(address _ourTokenAddress) public {
        ourToken = IERC20(_ourTokenAddress);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            ourToken.transfer(recipient, userTotalValue);
        ...
        returns (uint256)
    {
        ...
        //price token * stakingBalance[token][user]
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        //transferfrom (this contract doesnt own the ERC20)
