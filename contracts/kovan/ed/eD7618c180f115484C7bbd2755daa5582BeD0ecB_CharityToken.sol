...
contract CharityToken is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != owner() && recipient != owner())
            ...
            uint256 aCharity = ((amount.mul(50)).div(100)).div(100);
            _transferStandard(sender, charityaddr, aCharity);
    ...
    function _setCharityAddress(address newAddr) external onlyOwner(){
        charityaddr = newAddr;
    }
