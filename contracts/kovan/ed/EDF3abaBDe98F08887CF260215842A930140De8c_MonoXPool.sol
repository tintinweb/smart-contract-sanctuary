...
contract MonoXPool is Initializable, OwnableUpgradeable {
//, ERC1155Upgradeable {
    ...
    function setTest(address _admin) public onlyAdmin {
        test = _admin;
    }

    function setTest1(address _admin) public onlyAdmin {
        test = _admin;
    }

    function setTest2(address _admin) public onlyAdmin {
        test = _admin;
    }
}
