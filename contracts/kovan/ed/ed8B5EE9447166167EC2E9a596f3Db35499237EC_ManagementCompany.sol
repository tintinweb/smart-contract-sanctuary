...
contract ManagementCompany is IManagementCompany {
    ...
    ///@notice necessary LRSCAddressVoteFlags getter function for array
    function getLRSCAddressVoteFlags() external view returns(address[] memory result) {
        return LRSCAddressVoteFlags;
    }
}
