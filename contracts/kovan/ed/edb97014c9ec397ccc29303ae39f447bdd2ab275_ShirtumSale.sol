...
contract ShirtumSale is ReentrancyGuard, Ownable {
    ...
    // General conditions
    uint256 public generalMinBuy = 10000000000000000; // 0.01 ETH
    uint256 public generalMaxBuy = 1000000000000000000; // 1 ETH
    uint256 public generalClaimMaxWaitTime = 4 days;
    uint256 public claimTiming = 10 minutes; // 30 days;
    ...
    uint256 public corpMinBuy = 96000000000000000000; // 96 ETH
    uint256 public corpMaxBuy = 480000000000000000000; // 480 ETH
    ...
    constructor(
        ...
        minimalGoal = 100000000000000000;    // .1 ETH
        hardCap = 500000000000000000;   // .5 ETH
