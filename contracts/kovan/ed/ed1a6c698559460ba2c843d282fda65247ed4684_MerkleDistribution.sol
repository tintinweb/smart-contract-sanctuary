...
// File contracts/Interface/IDCT.sol
...
// File contracts/MerkleDistribution.sol

pragma solidity ^0.8.0;
contract MerkleDistribution is IMerkleDistribution {
    ...
    constructor(address _token, bytes32 _merkleRoot, address _holdertoken) {
        token = _token;
    ...
    function holdertokenvaults(address account) public view override returns (uint, uint) {
    ...
    function claimoflandholder(address _holder) override external {
