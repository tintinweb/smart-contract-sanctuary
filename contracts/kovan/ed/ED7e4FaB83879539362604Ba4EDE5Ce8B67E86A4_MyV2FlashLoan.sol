...
contract MyV2FlashLoan is FlashLoanReceiverBase {
    ...
    IUniRouter02 public router;
    constructor(ILendingPoolAddressesProvider _addressProvider, IUniRouter02 _router) FlashLoanReceiverBase(_addressProvider) public {
        router = _router;
    }
        ...
        returns (bool)
    {
        ...
        path[0] = address(0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD);
        path[1] = address(0x075A36BA8846C6B6F53644fDd3bf17E5151789DC);
        
        
            
        for (uint i = 0; i < assets.length; i++) {
            router.swapExactTokensForTokens(amounts[i], 0, path, address(this), block.timestamp);
