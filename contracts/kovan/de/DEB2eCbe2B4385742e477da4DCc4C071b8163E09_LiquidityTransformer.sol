...
contract LiquidityTransformer is usingProvable {
    ...
    address payable constant TEAM_ADDRESS = 0x6bDcb2F88fDc200eAa21368E2c506dCd97C591d8;
    address public TOKEN_DEFINER = 0x6bDcb2F88fDc200eAa21368E2c506dCd97C591d8;
    ...
    uint128 constant TEAM_ETHER_MAX = 20 ether; // test, should be 2000 in mainnet
    ...
    function forwardLiquidity() external afterInvestmentPhase {
        ...
        require (
            g.preparedReferrals == referralAccountCount,
            'SWAPP: must prepare all referrals'
        );

        require (
            g.totalTransferTokens > 0,
            'SWAPP: must have tokens to transfer'
        );
        ...
        (
            ...
            0,
            // address(0x0),
            address(0x6bDcb2F88fDc200eAa21368E2c506dCd97C591d8), // to test
