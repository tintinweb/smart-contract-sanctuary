...
contract RewardDistribution is Ownable {
  ...
  function addPool(
    ...
    emit PoolUpdate(pools.length, _pair, _token, _isSupply, _points, _withUpdate);
  }
  ...
  function setReward(
    ...
    emit PoolUpdate(pid, _pair, _token, _isSupply, _points, _withUpdate);
  }
  ...
  function updatePool(uint _pid) public {
    ...
    require(pool.pair != address(0), "RewardDistribution: invalid pid");
    _updatePool(_pid);
  }
  ...
  function pendingTotalReward(address _account, address _pair, address _token) public view returns(uint) {
