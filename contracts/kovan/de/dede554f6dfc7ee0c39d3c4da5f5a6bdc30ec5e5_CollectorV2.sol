...
contract CollectorV2 is AccessControlEnumerableUpgradeable {

    uint8 public flag;
    uint256 public constant COLLECTOR_REVISION = 0x2;
    ...
    function withdraw(address asset, uint256 amount) public onlyCollectorAdmin {
