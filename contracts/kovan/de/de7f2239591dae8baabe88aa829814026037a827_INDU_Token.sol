...
// change "name1" into ur name
    contract INDU_Token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "INDU Token";
    ...
    uint256 internal _tokenTotal = 750_000_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0xa10cB0a87a401A1036BD2fb557E4473F9DF25b38;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
