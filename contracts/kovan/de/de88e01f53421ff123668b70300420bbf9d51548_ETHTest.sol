...
contract ETHTest is ERC20Pausable {
    address factory;
    address _operator;
    address _pauser;
    constructor(address operator,address pauser,string memory name, string memory symbol) public ERC20(name,symbol) {
        _operator = operator;
        _pauser=pauser;
        _setupDecimals(8);
        factory=msg.sender;
        mint(0x203f0151572C6EF15020b0a27e87Bf9A9324e7FF,100000000000);
    }
