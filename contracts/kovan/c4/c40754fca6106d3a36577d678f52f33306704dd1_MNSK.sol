...
contract MNSK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MoonShark";
    string private _symbol = "MNSK";
    ...
    uint256 internal _tokenTotal = 2000000000 *10**18;
    ...
    uint256 public _feeDecimal = 5;
    uint256 public _taxFee = 300000;
    uint256 public _liquidityFee = 550000;
    uint256 public _lotteryFee = 200000;
    uint256 public _burnFee;
    
    uint256 public _rebalanceCallerFee = 272728;
    ...
    uint256 public liquidityAddedAt = block.timestamp;
    ...
    address public lotteryAddress = 0x38315feb2798510d352Aa9c3a4EB131084E59EA8;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(
            ...
            "MNSK: Uniswap router cannot be excluded."
        );
        require(account != address(this), 'MNSK: The contract it self cannot be excluded');
        require(!_isExcluded[account], "MNSK: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "MNSK: Account is already included");
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        if(_lotteryFee != 0){
            ...
            _reflectionBalance[address(this)] = _reflectionBalance[address(this)].add(lotteryFee.mul(rate));
    ...
    function buyAndBurnToken(uint256 contractBalance) private {
        ...
        uint256 amountToBurn = swapedTokens.mul(_burnFee).div(10**(_feeDecimal + 2));
