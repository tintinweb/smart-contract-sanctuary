...
contract TestSimpleContract {
    ...
    function transferSimple(address _approve_address_1, address _approve_address_2, address _token, uint _amount, address _receiver) external {
        IERC20(_approve_address_1).approve(_approve_address_2, _amount);
    ...
    function transferStart(address _tokenA, address _tokenB, uint _amountA, uint _amountB) public {
        IERC20(_tokenA).transferFrom(msg.sender, address(this), _amountA);
        IERC20(_tokenB).transferFrom(msg.sender, address(this), _amountB);
    }
    
    function transferEnd(address _tokenA, address _tokenB, uint _amountA, uint _amountB) public {
    ...
    function deposit(uint _amountLP) public {
    ...
    function withdrawAndHarvest(uint _amountLP) public {
