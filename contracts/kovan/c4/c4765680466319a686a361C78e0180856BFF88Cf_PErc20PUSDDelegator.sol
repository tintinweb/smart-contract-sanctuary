...
/**
 * @title Pesa's PErc20PUSDDelegator Contract
 * @notice PTokens which wrap an EIP-20 underlying and delegate to an implementation
 */
contract PErc20PUSDDelegator is PTokenInterface, PErc20Interface, PDelegatorInterface {
    /**
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "PErc20PUSDDelegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"PErc20PUSDDelegator:fallback: cannot send value to fallback");
