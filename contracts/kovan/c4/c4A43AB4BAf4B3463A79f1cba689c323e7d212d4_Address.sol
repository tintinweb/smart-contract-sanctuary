...
BULLDOG is built upon the fundamentals of Buyback and increasing the investor's value
...
contract BULLDOG is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x884FF2A87d0E4349445bC91dEF1ebdF2B6cbefd4); // Marketing Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xc0fFee0000C824D24E0F280f1e4D21152625742b);
