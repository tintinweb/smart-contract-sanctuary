...
// ============================ Events ============================
    ...
    event ClaimApprove(address indexed hashAddress, uint64 claimID, uint256 amount, bool isInvestment);
...
// ============================ Internal functions ============================
        ...
        internal
    {
        ...
        uint64 claimID = uint64(++claimIdCounter);
        ...
        internal 
    {
        ...
        emit ClaimApprove(hashAddress, c.claimID, amount, c.isInvestment);
    }
