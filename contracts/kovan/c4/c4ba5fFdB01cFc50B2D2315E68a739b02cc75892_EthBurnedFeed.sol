...
contract EthBurnedFeed is ChainlinkClient, Owned {
    ...
    function requestSportsWinner() external {
        Chainlink.Request memory req = buildChainlinkRequest(jobId, address(this), this.fullfillEthBurned.selector);
     ...
     * Callback function
     */
    function fullfillEthBurned(bytes32 _requestId, bytes32 _result) external recordChainlinkFulfillment(_requestId) {
        result = _result;
    }
}
