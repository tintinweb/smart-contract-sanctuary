...
contract PositionHelper {
    ...
    function batchQuery(IOpenLev openLev, uint16 marketId, address[] calldata traders, bool[] calldata longTokens, bytes calldata dexData) external view returns (Vars[] memory results){
