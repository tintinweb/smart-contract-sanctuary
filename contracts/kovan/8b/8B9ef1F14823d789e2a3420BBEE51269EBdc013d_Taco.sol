...
// File contracts/governanceToken/Go
...
// File contracts/hifi/Taco.sol

/**
 * @title Hifi Token
 * @notice The governance token of the Hifi protocol
 * @author Hifi
 */
contract Taco is GovernanceToken {
    /**
     * @param mftToHifiMigrator The address of the MFT to HIFI migrator contract
     */
    constructor(
        address mftToHifiMigrator
    ) GovernanceToken("taco.finance", "TACO", 18) {
        // 10 000 000 HIFI are minted into the MFT to HIFI migrator contract for the migration
        mintInternal(mftToHifiMigrator, 10000000 ether);
    }
}