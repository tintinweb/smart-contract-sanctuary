...
import "../../../abstract/AbstractAutoBurnableDeflToken.sol";
import "../../abstract/AbstractDeflationaryAutoLPToken.sol";
import "../DeflationaryAutoLPToken.sol";

contract AutoBurnableDeflAutoLPToken is DeflationaryAutoLPToken, AbstractAutoBurnableDeflToken {
...
import "../../abstract/AbstractDeflationaryAutoLPToken.sol";
import "./AutoBurnable.sol";

contract COVD$ is AutoBurnableDeflAutoLPToken, Pausable {
    constructor(
        string memory tName, 
        string memory tSymbol, 
        uint256 totalAmount,
