...
// File: contracts/BlockhainRegistryContract.sol
struct IdentityData {
    string title;
    string firstName;
    string lastName;
...
contract BlockhainRegistryContract is AccessControl {
    ...
    function editIdentityInformation(
        ...
        string memory placeOfLiving, 
        string memory countryOfLiving, 
        string memory email, 
        string memory birthday) public {
    ...
    function getIdentityId(address querryAddress) public view returns(uint) {
        ...
        require(identityId != 0, "Address has no Identity!");
        return identityId;
    }
