...
contract ReethMonetaryPolicyV1 is Ownable, ReentrancyGuard {
        ...
        public
    {
        ...
        // Faster rebases on test net
        
        minRebaseTimeIntervalSec = 10 minutes;
        rebaseWindowOffsetSec = 0; // 12:00 UTC rebase
        ...
        // 60 minutes
        rebaseWindowLengthSec = 2 minutes;
        ...
        public
    {
        ...
        if(spentEthOracle != address(0)){
            ...
            spent.addUserETHSpent(_msgSender(), gasUsed);
        }
    }
