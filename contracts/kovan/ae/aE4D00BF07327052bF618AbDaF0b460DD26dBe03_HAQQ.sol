...
contract HAQQ is ERC20, Pausable, Ownable {

    AggregatorV3Interface internal priceFeed;

    uint public tier1minPurchase;
    uint public tier2minPurchase;
    uint public tier3minPurchase;
    uint public tier1priceUSD;
    uint public tier2priceUSD;
    uint public tier3priceUSD;
    uint public tier1endsAt;
    uint public tier2endsAt;

    constructor() ERC20("HAQQ", "HAQQ") {
        // all token transfers are paused
        _pause();
        ...
        if (block.chainid == 42) {
            ...
            */
            ...
            tier2priceUSD = 10;
            tier2priceUSD = 18;
            tier1minPurchase = 25000;
            tier2minPurchase = 10000;
            tier3minPurchase = 2500;
            tier1endsAt = 10000000;
            tier2endsAt = 20000000;
        }
    }
    ...
    */
    ...
    uint public currentPriceInUSD = tier1priceUSD;
    uint public currentMinPurchase = tier1minPurchase;

    function upgradeTier() private {
        if (totalSupply() > tier2endsAt) {
            currentPriceInUSD = 18;
            currentMinPurchase = tier3minPurchase;
        } else if (totalSupply() > tier1endsAt) {
            currentPriceInUSD = 10;
            currentMinPurchase = tier2minPurchase;
        }
    }
    ...
    */
    ...
    function buy() public payable returns (bool success){
        ...
        // price of 1 wei in USD :
        uint weiPriceInUSD = uint(getLatestEthUsdPrice());
        uint amount = msg.value / (currentPriceInUSD * weiPriceInUSD * (10 ** decimals()));
        require(amount >= currentMinPurchase, "The purchased amount is less than the minimum ");
