...
/*
    ...
    */
    ...
    function deployBalancerPool() public {
      ...
      bPoolSTBL.setSwapFee(0);
      bPoolSTBL.bind(address(poolToken1), decimals.mul(100), 1);
      bPoolSTBL.bind(address(poolToken2), decimals.mul(100), 1);
      bPoolSTBL.bind(address(poolToken3), decimals.mul(100), 1);
      bPoolSTBL.finalize();
    }
