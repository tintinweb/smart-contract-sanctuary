...
contract OptimalLendingRate{
    ...
    IERC20 DAI = IERC20(DAIAddrAave);
    IERC20 DAICOMP = IERC20(DAIAddrComp);
    ...
    function deposit(uint256 amount) external {
        ...
        // } else {
        //     require(DAICOMP.allowance(tx.origin, cDAIAddr) >= amount, "User needs to approve to spend Token on his behalf");
        //     cDAI.mint(amount);
        //     // address(cDAI).delegatecall(abi.encodeWithSignature("mint(uint266)",amount));
        // }
    }
