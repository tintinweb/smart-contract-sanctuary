...
contract MuskRatTestv8 is Context, IERC20, Ownable {
    ...
    string private _name = "TEST v8";
    string private _symbol = "TSTV8";
 ...
 function NextSellTime(address _key) public view returns (uint) {
    ...
    function _transfer(
        ...
        if (
            ...
            // lets check here for more than 25% balance per swap
           ...
           //user passed checks - add liquidity
