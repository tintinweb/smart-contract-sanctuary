...
interface IApeBetBookMaker {
    ...
    function updateMaxPoolPayout(uint256 amount, bool remove) external;
...
contract ApeBetPool is Ownable {
    ...
    function changeBookMaker(address _bookMakerAddress) external onlyOwner {
        ...
        bookMaker.updateMaxPoolPayout(address(this).balance, true);
    }

    receive() external payable {
        bookMaker.updateMaxPoolPayout(msg.value, false);
