...
contract Controller is Initializable, RegistryStorage {
     ...
     * @dev should only be called if there is a need of arbitrarily chaging the indexes in the FYT/APWIBT naming
     */
    ...
    /* Future Vault rewards mecanisms */
     ...
     */
    function terminateFuture(IFutureVault _futureVault) external onlyAdmin {
