...
contract FramToken is Ownable {
    address[] public allowedTokens;
    address[] public stakers;
    mapping(address => uint256) public uniqueTokensStaked;
    // mapping token address => staker address => amount
    mapping(address => mapping(address => uint256)) public stakingBalance;
    IERC20 public drappToken;
    mapping(address => address) public tokenPriceFeedMapping;

    constructor(address _dappTokenAddress) public {
        drappToken = IERC20(_dappTokenAddress);
    }
    ...
    function unstackTokens(address _token) public {
        ...
        require(balance > 0, "Staking balanc cannot be 0");
        IERC20(_token).transfer(msg.sender, balance);
        stakingBalance[_token][msg.sender] = 0;
        uniqueTokensStaked[msg.sender] = uniqueTokensStaked[msg.sender] - 1;
    }

    // 100 ETH 1:1 every one ETH, we give 1 DappToken
    ...
    function issueToken() public onlyOwner {
        ...
        for (
            ...
            drappToken.transfer(recipient, userTotalValue);
        }
    }
