...
contract ATestnetConsumer is ChainlinkClient, Ownable {
  ...
  function requestTheWinner(address _oracle, string memory _jobId)
    public
    onlyOwner
  {
  ...
  function fulfillTheWinner(bytes32 _requestId, uint256 _theWinner)
    public
    recordChainlinkFulfillment(_requestId)
  {
    emit RequestEthereumPriceFulfilled(_requestId, _theWinner);
    theWinner = _theWinner;
  }
