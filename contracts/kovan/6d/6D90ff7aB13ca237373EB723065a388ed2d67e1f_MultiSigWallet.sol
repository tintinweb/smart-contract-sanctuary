...
contract MultiSigWallet {
    ...
    event MultiERC20Transfer(address indexed _from, address _to, uint _amount, ERC20 _token);
    ...
    function multiERC20Transfer(ERC20 _token, address[] _addresses, uint[] _amounts)
      public
      payable
      onlyWallet
    {
