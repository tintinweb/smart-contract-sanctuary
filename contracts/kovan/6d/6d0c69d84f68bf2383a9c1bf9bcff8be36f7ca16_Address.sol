...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @COINSKYBSC
   ...
   I will renounce the ownership to burn addresses to transfer #COINSKY to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #COINSKY 10000X? 
   ...
   it's the best part of the #COINSKY idea, increasing the liquidity pool automatically, 
...
contract COINSKY is Context, IERC20, Ownable {
    ...
    string private _name = "COINSKY";
    string private _symbol = "COINSKY";
