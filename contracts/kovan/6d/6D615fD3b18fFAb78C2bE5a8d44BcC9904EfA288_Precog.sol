...
contract Precog is IPrecog {
    ...
    function sendCollateralToLendingPlatform(uint256 amount, address lendingPlatform) external{
        require(availableAmount[msg.sender] >= amount , "PrecogV2: AVAILABLE_AMOUNT_NOT_ENOUGH");
        IERC20(usdc).transfer(lendingPlatform, amount);
    }
