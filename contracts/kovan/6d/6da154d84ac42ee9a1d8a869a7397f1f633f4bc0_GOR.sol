...
contract GOR is Context, IERC20, Ownable {
    ...
    string private _name = 'GOR test';
    string private _symbol = 'GOR';
    ...
    uint256 public _maxTxAmountSell = 1000000000000000000000;
    uint256 private _numOfTokensToExchangeForMarketing = 5000000000000000000;
    bool _txLimitsEnabled = true;
    bool _txBoundedSellLimits = true;
    ...
    constructor () public {
        ...
        _marketingFee = 4;
        _marketingWalletAddress = payable(0x7c85b4597663d88d16e4e13c418246372E0eEe9B);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(_txBoundedSellLimits && sender != owner() && recipient == uniswapV2Pair) {
    ...
    function _useGlobalLimitTx() external onlyOwner() {
        _txBoundedSellLimits = false;
    }
