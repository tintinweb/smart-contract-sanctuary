...
contract MaxxerICO is Ownable,ERC223ReceivingContract{
  ...
  */
   ...
   */
  function Setvaluesfortime(address payable _wallet, address _token,uint256 _tokenPrice,uint256 _etherCaps,uint256 _openingTime, uint256 _closingTime) external onlyOwner {  
  ...
  function tokenFallback(address, uint256 _value, bytes calldata) external {
