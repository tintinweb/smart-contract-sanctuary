...
contract InsaneBoxKids is ERC721Enumerable, Ownable, ERC721Burnable,ERC721Pausable {
    ...
    address public constant creatorAddress = 0xbFDA34C2A61CA1F2141E0c5613d57fbc17b2Dc64; // 45%
    ...
    uint private saleTime;
    uint private preSaleTime;
  
    string public baseTokenURI;
    
    mapping(address => bool) addressToPreSaleEntry;
    //address[] memory preSaleWalletAddresses;
