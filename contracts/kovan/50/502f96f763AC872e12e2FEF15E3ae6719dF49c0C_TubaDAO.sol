...
contract TubaDAO is ERC721Enumerable, ReentrancyGuard, Ownable {
    constructor() ERC721("TubaDAO", "TUBADAO") Ownable() {}
    ...
    //                     '", "description": "TubaDAO is a global grassroots movement aimed at disrupting the creator economy. TubaDAO is for the people, by the people. Our core values are: Sincerity, Integrity, Meaning, and Purpose.", "image": "',
    //                     output,
    //                     '"}'
    //                 )
    //             )
