...
contract BondDepository is IBondDepository, Factory, Governable {
    ...
    constructor(address governance, address solace, address xsolace, address pool, address dao) Governable(governance) {
        _setAddresses(solace, xsolace, pool, dao);
    }
    ...
    ***************************************/
     ...
     * @param solace Address of the DAO.
     */
    function setAddresses(address solace, address xsolace, address pool, address dao) external override onlyGovernance {
        _setAddresses(solace, xsolace, pool, dao);
    }
     ...
     * @param solace Address of the DAO.
     */
    function _setAddresses(address solace, address xsolace, address pool, address dao) internal {
...
interface IBondDepository {
    ...
    ***************************************/
     ...
     * @param solace Address of the DAO.
     */
    function setAddresses(address solace, address xsolace, address pool, address dao) external;
