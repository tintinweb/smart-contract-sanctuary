...
abstract contract LeverageAcc is RoleAware, PriceMath {
    ...
    /// @dev internal function adjusting holding and credit balances when debt extinguished
    ...
    /// sets credit and holding to zero
...
contract LeverageTrading is LeverageMarginCall, IMarginTrading {
    ...
    /// @dev admin function to set credit percent
    ...
    function _listLoan(
        ...
        credit(account, borrowToken, borrowAmount);
    }
    ...
    /// @dev gets called by router to register a trade and credit and extinguish as necessary
        ...
        returns (uint256 extinguishableDebt, uint256 borrowAmount)
    {
        ...
        if (borrowAmount > 0) {
            credit(account, tokenFrom, borrowAmount);
        }
    }
...
///    how much a trader can credit need not be extremely current and precise, mainly
