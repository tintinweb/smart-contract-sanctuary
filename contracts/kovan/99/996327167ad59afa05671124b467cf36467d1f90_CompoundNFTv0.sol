...
contract CompoundNFTv0 is MerkleDistributedNFT {
    ...
    function claim(uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof) external override {
        ...
        require(block.timestamp < activationTime + 20 minutes, "CompoundNFTv0::claim: claiming period is over");
    ...
    function activate() external {
        require(ITimelock(0xE3e07F4F3E2F5A5286a99b9b8DEed08B8e07550B).admin() == 0x100044C436dfb66FF106157970bC89f243411Ffd, "CompoundNFTv0::activate: bravo not yet active");
