...
contract Cascade is IStaking, Ownable {
    ...
    event Staked(address indexed user, uint256 amount, uint256 total, uint256 mintedStakingShares);
    event Unstaked(address indexed user, uint256 amount, uint256 total, bytes data);
    event TokensClaimed(address indexed user, uint256 amount);
    event TokensLocked(uint256 amount, uint256 durationSec, uint256 total);
    // amount: Unlocked tokens, total: Total locked tokens
    event TokensUnlocked(uint256 amount, uint256 total);
    event UserStakeUpdatedStake(uint256 timesStaked, uint256 stakingShares, uint256 timestampSec);
    event UserTotalsUpdatedStake(uint256 stakingShares, uint256 stakingShareSeconds, uint256 lastAccountingTimestampSec);
    event UserTotalsUpdatedUnstake(uint256 stakingShares, uint256 stakingShareSeconds, uint256 lastAccountingTimestampSec);
    event UserTotalsUpdatedAccountingBefore(uint256 stakingShares, uint256 stakingShareSeconds, uint256 lastAccountingTimestampSec);
    event UserTotalsUpdatedAccountingAfter(uint256 stakingShares, uint256 stakingShareSeconds, uint256 lastAccountingTimestampSec);
    event GlobalTotalsAccountingBefore(uint256 totalLockedShares, uint256 totalStakingShares, uint256 totalStakingShareSeconds, uint256 lastAccountingTimestampSec);
    event GlobalTotalsAccountingAfter(uint256 totalLockedShares, uint256 totalStakingShares, uint256 totalStakingShareSeconds, uint256 lastAccountingTimestampSec);
    ...
    function _stakeFor(address beneficiary, uint256 amount) private {
        ...
        emit UserTotalsUpdatedStake(totals.stakingShares, totals.stakingShareSeconds, totals.lastAccountingTimestampSec);

        Stake storage lastStake = _users[beneficiary].userStakes[_users[beneficiary].userStakes.length - 1];
        emit UserStakeUpdatedStake(_users[beneficiary].userStakes.length, lastStake.stakingShares, lastStake.timestampSec);
        ...
        emit Staked(beneficiary, amount, totalStakedFor(beneficiary), mintedStakingShares);
    }
    ...
    function _unstake(uint256 amount) private returns (uint256 rewardAmount) {
        ...
        emit UserTotalsUpdatedUnstake(totals.stakingShares, totals.stakingShareSeconds, totals.lastAccountingTimestampSec);
    ...
    function updateAccounting() public returns (
        ...
        emit GlobalTotalsAccountingBefore(totalLockedShares, totalStakingShares, _totalStakingShareSeconds, _lastAccountingTimestampSec);
        ...
        emit UserTotalsUpdatedAccountingBefore(totals.stakingShares, totals.stakingShareSeconds, totals.lastAccountingTimestampSec);
        ...
        emit GlobalTotalsAccountingAfter(totalLockedShares, totalStakingShares, _totalStakingShareSeconds, _lastAccountingTimestampSec);
        emit UserTotalsUpdatedAccountingAfter(totals.stakingShares, totals.stakingShareSeconds, totals.lastAccountingTimestampSec);
