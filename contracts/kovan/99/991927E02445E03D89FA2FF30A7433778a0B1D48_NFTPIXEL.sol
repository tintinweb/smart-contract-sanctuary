...
contract NFTPIXEL is ERC721, Ownable {
    ...
    constructor() ERC721("1M-NFT","PIXEL")  {
        ...
        _safeMint(address(0xb03eb1Ef9b1E6bf114d78EceFCB43be5163cE14f), 3);
        _safeMint(address(0xb03eb1Ef9b1E6bf114d78EceFCB43be5163cE14f), 4);
        _safeMint(address(0xb03eb1Ef9b1E6bf114d78EceFCB43be5163cE14f), 5);
    ...
    */
    ...
    function adoptPixel(uint256[] memory _tokenId) public payable {
        require(totalSupply() < MAX_PIXELS, "Sale has already ended");
        require(_tokenId.length > 0 && _tokenId.length <= 25, "You can adopt minimum 1, maximum 25 pixels");
