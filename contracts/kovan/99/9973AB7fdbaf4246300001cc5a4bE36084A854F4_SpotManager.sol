...
contract SpotManager is BaseRouter {
    using SafeERC20 for IERC20;
    address public immutable WETH;
    event SpotTrade(
    ...
    function swapExactTokensForTokens(
        ...
        require(
            ...
            "SpotManager: INSUFFICIENT_OUTPUT_AMOUNT"
        );
    ...
    function swapTokensForExactTokens(
        ...
        require(
            ...
            "SpotManager: EXCESSIVE_INPUT_AMOUNT"
        );
    ...
    function swapExactETHForTokens(
        ...
        require(tokens[0] == WETH, "SpotManager: INVALID_PATH");
    ...
    function swapTokensForExactETH(
        ...
        require(tokens[tokens.length - 1] == WETH, "SpotManager: INVALID_PATH");
    ...
    function swapETHForExactTokens(
        ...
        require(amounts[0] <= msg.value, "SpotManager: EXCESSIVE_INPUT_AMOUNT");
