...
contract AdvancedCollectibleETHDirectOffset is ERC721, VRFConsumerBase, OnePlanetConnected {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal OnePlanetCarbonOffsetDirect override {
