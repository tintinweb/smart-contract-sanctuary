...
library SafeMath {
     ...
     * - Subtraction cannot overflow.
     */
    function sub(uint256 a, uint256 b, string memory errorMessage) external pure returns (uint256) {
     ...
     * - The divisor cannot be zero.
     */
    function div(uint256 a, uint256 b, string memory errorMessage) external pure returns (uint256) {
     ...
     * - The divisor cannot be zero.
     */
    function mod(uint256 a, uint256 b, string memory errorMessage) external pure returns (uint256) {
        require(b > 0, errorMessage);
        return a % b;
    }
}
...
contract Greeter {
  ...
  event GreetingChanged(address sender, string newGreeting);
...

{
  ...
  "libraries": {
    "contracts/Greeter.sol:Greeter": {
      "SafeMath": "0xa20DF5F211Ce5c262b62dcAb702E4Daf56015B83",
