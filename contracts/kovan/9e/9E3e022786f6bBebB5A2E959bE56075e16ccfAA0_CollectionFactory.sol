...
contract CollectionFactory is AccessControl {
    ...
    function createERC721Collection(
        ...
        if (
            userSub.subscriptionTier ==
            ISubscriptionTier.SubscriptionTier.LevelOne
        ) {
            require(
                _minters.length == 0,
        ...
        emit ERC721CollectionDeployed(clone, _name, _symbol, _owner, _minters);
    }
    ...
    function createERC1155Collection(
        ...
        emit ERC1155CollectionDeployed(clone, _owner, _minters);
    }
        ...
        external
    {
        require(
            ...
            "MediaEyeCollectionFactory: must have owner role to change 721 implementation."
        );
        ...
        external
    {
        require(
            hasRole(OWNER_ROLE, _msgSender()),
            "MediaEyeCollectionFactory: must have owner role to change 1155 implementation."
        );
    ...
    function updateFeeContract(address _newFeeContract) external {
        require(
            hasRole(OWNER_ROLE, _msgSender()),
            "MediaEyeCollectionFactory: must have owner role to change fee contract."
        );
