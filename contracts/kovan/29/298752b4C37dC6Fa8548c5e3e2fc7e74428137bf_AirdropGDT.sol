...
contract AirdropGDT {
    ...
    function popFromArray() public onlyOwner returns(bool) {
        smallAccounts.pop();
        return true;
    }

    function setSingleAddress(uint arrayPosition, address address1) public onlyOwner returns(bool) {
        accounts[arrayPosition] = address1;
        return true;
    }

    function setSingleAddressSmall(uint arrayPosition, address address1) public onlyOwner returns(bool) {
        smallAccounts[arrayPosition] = address1;
        return true;
    }
    

    function setArray1(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
        accounts[0] = address1;
        accounts[1] = address2;
        accounts[2] = address3;
        accounts[3] = address4;
    ...
    function setArray2(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
    ...
    function setArray3(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
    ...
    function setArray4(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
    ...
    function setArray5(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
    ...
    function setArray6(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
    ...
    function setArray7(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
        ...
        return true;
    }function setArray8(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
        ...
        return true;
    }function setArray9(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
    ...
    function setArray10(address address1, address address2, address address3, address address4, address address5, address address6, address address7, address address8, address address9, address address10) public returns(bool) {
    ...
    function transferToAllSmall() public onlyOwner returns(bool) {
        for (uint i = 0; i < smallAccounts.length; i++) {
            require(gorillaDiamondInstance.approve(address(this), 1000000000000), 'approve failed');
            require(gorillaDiamondInstance.transfer(smallAccounts[i], 1000000000000), 'transferFrom failed');
        }
        return true;
    }
