...
// Root file: contracts/ProphetPoolFactory.sol
...
/**
 * @title ProphetPoolFactory
 * @author Prophecy
 *
 * ProphetPoolFactory is a smart contract used to deploy new ProphetPool contracts.
 */
contract ProphetPoolFactory {
    /* ============ Events ============ */

    event ProphetPoolCreated(address indexed _prophetPool, address _manager);
    ...
    function create(
        ...
        require(_buyToken != address(0), "Buy Token must be set");
        require(_poolToken != address(0), "Buy Token must be set");
        ...
        emit ProphetPoolCreated(address(prophetPool), _manager);
