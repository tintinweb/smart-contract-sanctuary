...
contract TestSwapUSDT is ERC20 {
    event LogChangeMPCXOwner(address indexed oldOwner, address indexed newOwner, uint indexed effectiveHeight);
    ...
    constructor() ERC20("ECO USDT", "eUSD") {
    ...
    function changeMPCXOwner(address newOwner) public onlyOwner returns (bool) {
        require(newOwner != address(0), "new owner is the zero address");
        _oldOwner = owner();
        _newOwner = newOwner;
        _newOwnerEffectiveHeight = block.number + 1;
        emit LogChangeMPCXOwner(_oldOwner, _newOwner, _newOwnerEffectiveHeight);
        return true;
    }
