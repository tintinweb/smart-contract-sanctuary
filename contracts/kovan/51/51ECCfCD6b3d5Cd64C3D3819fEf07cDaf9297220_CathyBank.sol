...
contract CathyBank is Ownable {
    ...
    function getPHXRewardsShare(
        ...
        require(PHXIncome > 0, "No income yet");
    ...
    function payLoanFullPHX() public payable {
    ...
    function withdrawPHX(uint256 _PHXAmount) public {
        uint256 _depositInterest = getaccruedInterest(msg.sender);
        ...
        PHXIncome = PHXIncome.sub(_depositInterest);
        PHXReserves = PHXReserves.add(_depositInterest).sub(_PHXAmount);
        lastActionTime[msg.sender] = block.timestamp;
