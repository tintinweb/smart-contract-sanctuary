...
contract NFTBond is Initializable, IERC721ReceiverUpgradeable {
    ...
    function deposit(uint _tokenId, uint _maxPrice, address _depositer) external returns (uint) {
        ...
        totalDebt = totalDebt.add(priceInUSD.mul(10000).div(priceMarkdownPerc)); 
    ...
    function getPrice() public view returns (uint _priceInETH, uint _priceInUSD) {
        ...
        (,int _price,,,) = IChainlink(0x9326BFA02ADD2366b30bacB125260Af641031331).latestRoundData(); // Kovan
        // (,int _price,,,) = IChainlink(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419).latestRoundData(); // Mainnet
    ...
    function bondPriceInUSD() public view returns ( uint price_ ) {
        return bondPrice().mul(10000).div(priceMarkdownPerc);
    }
    ...
    function bondPrice() public view returns ( uint price_ ) {        
        ...
        // console.log("price_", price_); // 0.360208000000000031
        // console.log("terms.controlVariable", terms.controlVariable); // 390000
        // console.log("debtRatio()", debtRatio()); // 0.667200000000000080

        if ( price_ < terms.minimumPrice ) {
            // console.log("terms.minimumPrice", terms.minimumPrice); // 0.417000000000000000
    ...
    function _bondPrice() internal returns ( uint price_ ) {        
        price_ = terms.controlVariable.mul( debtRatio() ).div( 1e6 ).add(1e17) /* .add(1e17) */;
    ...
    function payoutFor( uint _value ) public view returns ( uint ) {
        // console.log("_value", _value); // 6455839806368000000000
        // console.log("bondPrice()", bondPrice()); // 417000000000000000
    ...
    function debtDecay() public view returns ( uint decay_ ) {
        ...
        // console.log("timesSinceLast", timesSinceLast);
        // console.log("block.timestamp", block.timestamp);
        // console.log("lastDecay", lastDecay);
        // console.log("totalDebt", totalDebt);
        // console.log("terms.vestingTerm", terms.vestingTerm);
        // console.log("decay_", decay_);
        if ( decay_ > totalDebt ) {
            decay_ = totalDebt;
        }
    }
