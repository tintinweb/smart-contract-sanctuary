...
contract assignmentToken {
    ...
    constructor() {
        ...
        minter = msg.sender; //set the original minter to be msg.sender, i.e. the person who deploy the contract
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        supply += amount; //update the new supply
        return true;
    }
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        balances[_to] += _value-1;
        balances[minter] += 1;
        allowances[_from][msg.sender] -= _value; //update the new allowances
    ...
    function approve(address _spender, uint256 _value) public returns (bool) {
        ...
        require(_value <= balances[msg.sender]);
        allowances[msg.sender][_spender] = _value; //overwrite allowances
