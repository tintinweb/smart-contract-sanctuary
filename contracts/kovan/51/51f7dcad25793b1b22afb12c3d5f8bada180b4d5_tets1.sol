...
ZombieNFT comes on BSC
Round 1 - get a whitelist of early supporters 
Round 2 - airdrop ZombieNFTs to all holders addresses
Round 3 - Build a Metaverse with all the minted Zombie ZombieNFTs
...
contract tets1 is ERC20 {

    uint tokenTotalSupply = 100;

    constructor() public ERC20("ZombieNFT", "ZNFT") {
