...
contract Presale is Ownable {
    ...
    uint256 public fundingGoal = 25 ether;    // 200 ETH
    ...
    uint256 public price = 5333333;       // 1 ETH = 1000 $KATA
    ...
    uint256 public tgeTime = 1647691200;
    uint256 public duration = 60 * 60 * 24 * 30 * 5;    // 5 months

    constructor(uint256 _startTime, uint256 _endTime, uint256 _whitelistTime, uint256 _tgeTime) {
