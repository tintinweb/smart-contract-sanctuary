...
contract Consts {
    ...
    string public constant TOKEN_NAME = "CCC_token";
    string public constant TOKEN_SYMBOL = "CCC";
...
contract CCC_token is Consts, FreezableMintableToken, BurnableToken, Pausable
