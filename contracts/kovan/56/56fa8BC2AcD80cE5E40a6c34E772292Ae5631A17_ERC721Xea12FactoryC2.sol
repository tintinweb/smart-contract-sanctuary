...
import "../erc-721/ERC721Xea12.sol";
 ...
 *
 */
contract ERC721Xea12FactoryC2 is Ownable {
    address public beacon;
    address transferProxy;
    address lazyTransferProxy;

    event Create721Xea12Proxy(address proxy);
    ...
    function getData(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) pure internal returns(bytes memory){
        return abi.encodeWithSelector(ERC721Xea12(0).__ERC721Xea12_init.selector, _name, _symbol, baseURI, contractURI);
    }
}
