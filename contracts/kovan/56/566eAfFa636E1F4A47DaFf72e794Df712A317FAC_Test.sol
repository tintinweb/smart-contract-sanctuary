...
contract Test {
   ...
   function deposit(address _erc20Contract, uint256 _amount) public returns(bool success){
...
//       ILendingPool iLendingPool = ILendingPool(lendingPoolAddress);
       IERC20 token_ = IERC20(_erc20Contract);
//       token_.approve(msg.sender,_amount);
//       token_.approve( address(this),_amount);
//   token_.transferFrom(msg.sender, address(this), _amount);
       token_.transfer(address(this), _amount);
//       bool approve = IERC20(_erc20Contract).approve(lendingPoolAddress,_amount);
//       ILendingPool(lendingPoolAddress).deposit(_erc20Contract, _amount, msg.sender,0);
       return true;
   }

    function balanceOf(address _erc20Contract) public view returns(uint256){
        uint256 balance = IERC20(_erc20Contract).balanceOf(msg.sender);
        return balance;
    }

    function withdraw(address _erc20Contract, uint256 _amount) public returns(uint256 amountWithdrawn){
        return ILendingPool(0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe).withdraw(_erc20Contract, _amount, msg.sender);
    }

    function checkCollateralValueInEth() public view returns(uint256 amountInEth){
        (uint256 result, , , , , ) = ILendingPool(0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe).getUserAccountData(msg.sender);
        return result;
    }
...
//    function getAddress() public returns(bool){
//        ILendingPoolAddressesProvider iLendingPoolAddress = ILendingPoolAddressesProvider(0x88757f2f99175387aB4C6a4b3067c77A695b0349);
//        address result = iLendingPoolAddress.getLendingPool();
//        ILendingPool iLendingPool = ILendingPool(result);
//        bool approve = IERC20(0x13512979ADE267AB5100878E2e0f485B568328a4).approve(0xCbb1C8AAc6f6a157c6A4233EbB5E8073dE15f7a1,100000000);
//        iLendingPool.deposit(0x13512979ADE267AB5100878E2e0f485B568328a4,100000000,0xCbb1C8AAc6f6a157c6A4233EbB5E8073dE15f7a1,0);
//        return approve;
//    }
