...
// File: contracts\MultiSwapPerTranaction.sol
...
contract MultiSwapPerTx is Ownable {
    ...
    function swapAndDistribute() external payable {
        ...
        while (paidBalance > 0){
            ...
            // if (paidBalance > amountsIn[0])
            //     inputAmount = amountsIn[0];
            // else
            //     inputAmount = paidBalance;

            uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: _onetimeTranactionAmount}(
                0,
                path,
                address(this),
                block.timestamp
            ...
            paidBalance = paidBalance.sub(_onetimeTranactionAmount);
        }
