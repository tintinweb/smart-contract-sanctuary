...
// File: FestiveTicketsFactory.sol
...
contract FestiveTicketsFactory is Ownable {
    ...
    function createNewFest(
        ...
        FestivalNFT newFest =
            new FestivalNFT(
                festName,                festSymbol,                ticketPrice,                totalSupply,                msg.sender
            );
        ...
        activeFestsMapping[newFestAddress] = Festival({
            festName: festName,            festSymbol: festSymbol,            ticketPrice: ticketPrice,            totalSupply: totalSupply,            marketplace: address(newMarketplace)
        });
    ...
    function getFestDetails(address festAddress)
        ...
        view
        returns (
            string memory,            string memory,            uint256,            uint256,            address
        )
    {
        return (
