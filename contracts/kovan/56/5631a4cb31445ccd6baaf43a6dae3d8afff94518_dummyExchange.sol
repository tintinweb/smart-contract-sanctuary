...
contract dummyExchange {
    ...
    function doStep1() internal {
        ...
        IERC20(workingToken2).transfer(msg.sender, bal);                //Step1: accept token1, transfer token2
    }
    
    function doStep2() internal {
        uint256 bal = IERC20(workingToken1).balanceOf(address(this));
        IERC20(workingToken1).transfer(msg.sender, bal);            //Step2: accept token2, transfer token1
    }
}