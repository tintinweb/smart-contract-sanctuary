...
contract ShirtumSale is ReentrancyGuard, Ownable {
    ...
    bool public claimEnabled = false;
     ...
     // General conditions
    uint256 public generalMinBuy = 100000000000000000; // 0.1 BNB
    uint256 public generalMaxBuy = 5000000000000000000; // 5 BNB
    uint256 public generalClaimMaxWaitTime = 30 days;
    // uint256 public claimTiming = 30 days;
    uint256 public claimTiming = 10 minutes;
    uint256[] public generalVestingClaim = [2000, 1600, 1600, 1600, 1600, 1600];
    mapping(address => uint256) public generalParticipants;

    // Corportative conditions
    uint256 public corpMinBuy = 300000000000000000; // 0.3 BNB
    uint256 public corpMaxBuy = 500000000000000000;
    // uint256 public corpClaimWaitTime = 182 days;
    uint256 public corpClaimWaitTime = 30 minutes;
    uint256[] public corpVestingClaim = [10000];
    mapping(address => uint256) public corpParticipants;

    constructor(
        ERC20Burnable _token
    ) public {
        minimalGoal = 1000000000000000000;    // 1 BNB
        hardCap = 4000000000000000000;   // 4 BNB
        buyPrice = 83333333330000;  // 0,00008333333333 BNB = 0.02705 EUR
        totalTokens = 22800000000000000000000000;  // 22,800,000.00 TOKEN
