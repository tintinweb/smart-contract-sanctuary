...
contract Vault {
    ...
    address public immutable STAKE_AUCTION;

    constructor(address stakeAuction) {
        STAKE_AUCTION = stakeAuction;
    }

    modifier onlyStakeAuction() {
        require(msg.sender == STAKE_AUCTION, Errors.NOT_STAKE_AUCTION);
        _;
    }
