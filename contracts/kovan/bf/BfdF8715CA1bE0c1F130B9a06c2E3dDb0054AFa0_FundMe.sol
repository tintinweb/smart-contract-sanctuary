...
contract FundMe is Ownable {
    ...
    function getEntranceFee() public view returns (uint256) {
        uint256 minimumUSD = minUSDValue;
        console.log(minimumUSD);
        uint256 price = getLatestPrice(); // usd per eth
        console.log(price);
        uint256 precision = 1 * 10**8;
        console.log(precision);
        console.log(minimumUSD * precision);
        console.log((minimumUSD * precision) / price);
        console.log(((minimumUSD * precision) / price) * 10**18);
        return ((minimumUSD * precision) / price) * 10**18; // return in wei
    }
}
