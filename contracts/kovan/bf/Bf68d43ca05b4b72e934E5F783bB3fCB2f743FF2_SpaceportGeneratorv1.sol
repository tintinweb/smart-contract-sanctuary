...
contract SpaceportGeneratorv1 is Ownable {
    ...
    constructor() public {
        SPACEPORT_FACTORY = ISpaceportFactory(0x40938fDADe5c73F60B869292f09fB1B36753804d);
        SPACEPORT_SETTINGS = ISpaceportSettings(0x097188e4E3D5C1128F213733a58543A89F6fe308);
    }
...
contract Spaceportv1 is ReentrancyGuard {
  ...
  constructor(address _spaceportGenerator) public {
    ...
    SPACEPORT_SETTINGS = ISpaceportSettings(0x097188e4E3D5C1128F213733a58543A89F6fe308);
    SPACEPORT_LOCK_FORWARDER = ISpaceportLockForwarder(0x8656E1e8C45b1B7f5cD8755a04d8063e7A11c463);
...

{
  ...
  "libraries": {
    "/Users/pavelbulochkin/plasmapay/Launchpad-testdev/contracts/Spaceport-v1-periphery/contracts/SpaceportHelper.sol": {
      "SpaceportHelper": "0x27d29308C0cF631Ab70c91E93be85BeB30Af6124"
    }
  },
  "outputSelection": {
    "*": {
