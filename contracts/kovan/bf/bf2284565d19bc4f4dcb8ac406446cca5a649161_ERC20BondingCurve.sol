...
interface IPCVDeposit {
    ...
    function burnAndReset(uint160 _baseSqrtPriceX96Lower, uint160 _baseSqrtPriceX96Upper, uint24 _fee) external;

    // ----------- Getters -----------


    function baseSqrtPriceX96Lower() external view returns (uint160);

    function baseSqrtPriceX96Upper() external view returns (uint160);
