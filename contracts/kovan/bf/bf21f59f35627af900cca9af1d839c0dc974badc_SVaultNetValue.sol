...
contract Controller is ControllerStorage {
    ...
    function earn(
        ...
        takeTokenFromPool(_pool0, _strategy, token0, _amount0);
        takeTokenFromPool(_pool1, _strategy, token1, _amount1);
    ...
    function withdraw(
        ...
        //IFundPool(_pool0).returnToken(amount0);
        ...
        //IFundPool(_pool1).returnToken(amount1);
