...
abstract contract TraderRelaysHandler {
  ...
  function _relay(
    ...
    // address transactionSigner = ITrader(address(this)).followedTrader();
    // ITradingStrategy followedStrategy =
    //   ITrader(address(this)).tradingStrategy();
...

{
  ...
  "libraries": {
    "contracts/lib/PricesLib.sol": {
      "PricesLib": "0xd5117f88ff6f2b2421ffc0af51557c19162e9136"
    }
  }
}