 ...
 */
    ...
    */
    ...
    function executeProposal(
        ...
        settlementToken = depositHandler.executeProposal(swapDetails, resourceID);
...
interface IDepositExecute {
     ...
     */
    function executeProposal(SwapInfo calldata swapDetails, bytes32 resourceID) external returns (address);
}
