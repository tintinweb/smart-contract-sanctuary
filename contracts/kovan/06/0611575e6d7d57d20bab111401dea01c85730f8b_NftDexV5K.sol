...
// File: contracts/NftDexV5 Kovan.sol
...
contract NftDexV5K is ERC721Full, ERC721MetadataMintable, Ownable {
  ...
  constructor() ERC721Full("TAL", "TAL") public {
    ALIA = IERC20(0x73Eb1A25d4fe6Ef499A851c8a2F69BbFd25D5e2E);
    isInitialized = true;
 ...
 // events
  ...
  function initialize() public {
    ...
    require(!isInitialized, "NFTv1: already initialized");
    ALIA = IERC20(0x73Eb1A25d4fe6Ef499A851c8a2F69BbFd25D5e2E);
    isInitialized = true;
    _addMinter(msg.sender);
    _name = "TESTING";
