...
contract Quantum is Context, IERC20, Ownable {
    ...
    uint256 private minTokensBeforeSwap = 30000000 * 10**18; // 30m
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _studioWallet.transfer(newBalance); // ToDo test
    ...
    function setStudioWallet(address payable _address) public onlyOwner() {
        _studioWallet = _address;
    }

    function setGameWallet(address payable _address) public onlyOwner() {
