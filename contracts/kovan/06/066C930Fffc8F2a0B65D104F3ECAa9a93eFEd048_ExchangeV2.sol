...
import "./Xea12TransferManager.sol";
import "../royalties/IRoyaltiesProvider.sol";

contract ExchangeV2 is ExchangeV2Core, Xea12TransferManager {
    function __ExchangeV2_init(
        ...
        __Xea12TransferManager_init_unchained(newProtocolFee, newDefaultFeeReceiver, newRoyaltiesProvider);
...
abstract contract Xea12TransferManager is OwnableUpgradeable, ITransferManager {
    ...
    function __Xea12TransferManager_init_unchained(
        uint newProtocolFee,
        address newDefaultFeeReceiver,
        IRoyaltiesProvider newRoyaltiesProvider
