...
contract BoringBatchableWithDai is BaseBoringBatchable {
    IDaiPermit constant dai = IDaiPermit(0xbe42ef7BE71B4ad204A5a8679C83b91704b996c1); // DAI token contract
...
contract Sushiswap_ZapIn_General_V3 {
    ...
    address constant sushiSwapFactory = 0xc35DADB65012eC5796536bD9864eD8773aBc74C4; // SushiSwap factory contract
    ISushiLiquidityZap constant sushiSwapRouter = ISushiLiquidityZap(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // SushiSwap router contract
...
contract InariV1 is BoringBatchableWithDai, Sushiswap_ZapIn_General_V3 {
    ...
    IERC20 constant sushiToken = IERC20(0x11cb374BeEE797dBBB4c848195bf24D7085acd68); // SUSHI token contract
    address constant sushiBar = 0x921496CA04caF4a2858A7EbB6D35F721B70B5993; // xSUSHI staking contract for SUSHI
    IMasterChefV2 masterChefv2; // SUSHI MasterChef v2 contract
    ISushiSwap constant sushiSwapSushiETHPair = ISushiSwap(0x3DfE799797191f6FCC81F1b9eB0641A0e9B537A2); // SUSHI/ETH pair on SushiSwap
    IAaveBridge constant aave = IAaveBridge(0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe); // AAVE lending pool contract for xSUSHI staking into aXSUSHI
    ...
    address constant wETH = 0xd0A1E359811322d97991E03f863a0C30C2cF029C; // ETH wrapper contract (v9)
