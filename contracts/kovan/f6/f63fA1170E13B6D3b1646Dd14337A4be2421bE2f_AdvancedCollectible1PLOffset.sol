...
contract OnePlanetConnected is StringUtils, Owned{
   ...
   //OnePlanet Modifiers
    ...
    modifier OnePlanetCarbonOffset {
        ...
        gasEstOffset = gasAtStart.sub(gasleft());
    ...
    modifier OnePlanetCarbonOffsetDirect {
        ...
        if(gasEstModifier != 0){     // maybe remove ths if statement? if modifier eqals zero the add function will be negated anyway... what uses less gas?
        gasEstOffset = gasEstOffset.add(gasEstModifier);
        }
