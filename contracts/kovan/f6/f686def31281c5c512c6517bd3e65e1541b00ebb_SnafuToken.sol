...
contract SnafuToken is Context, IBEP20, Ownable {
    ...
    address private constant _ddVault = 0x060920dA49612A4F73Df4cbC1d7f33c9A59facac;
    ...
    string private _name     = "afuToken";
    string private _symbol   = "afu";
    uint8 private  _decimals = 9;

    uint256 public  _taxFee       = 2; // redistributed to holders
    uint256 public  _liquidityFee = 5; // kept for liquidity
    uint256 public  _ddVaultFee   = 2; // DD-Vault wallet
    uint256 public  _burnFee      = 0; // burned
    

    uint256 private _previousTaxFee         = _taxFee;
    uint256 private _previousLiquidityFee   = _liquidityFee;
    uint256 private _previousDdVaultFee     = _ddVaultFee;
    ...
    constructor () {
        ...
        // uniswap main/testnet router  0xf164fC0Ec4E93095b804a4795bBe1e041497b92a  
        ...
        _isExcludedFromFee[_ddVault] = true;
    ...
    function setDdVaultFeePercent(uint256 ddVaultFee) external onlyOwner {
        _ddVaultFee = ddVaultFee;
        _previousDdVaultFee = ddVaultFee;
    }
    ...
    function removeAllFee() private {
        ...
        _previousDdVaultFee     = _ddVaultFee;
    ...
    function restoreAllFee() private {
        ...
        _ddVaultFee     = _previousDdVaultFee;
    ...
    function _getTValues(uint256 tAmount) private view returns (feeData memory) {
        ...
        fd.tDdVault = calculateFee(tAmount, _ddVaultFee);
        ...
        fd.tTransferAmount = fd.tTransferAmount.sub(fd.tDdVault);
    ...
    function _getRValues(feeData memory fd, uint256 currentRate) private pure returns (feeData memory) {
        ...
        fd.rDdVault = fd.tDdVault.mul(fd.currentRate);
        ...
        fd.rTransferAmount = fd.rTransferAmount.sub(fd.rDdVault);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        takeTransactionFee(address(_ddVault), fd.tDdVault, fd.currentRate);
