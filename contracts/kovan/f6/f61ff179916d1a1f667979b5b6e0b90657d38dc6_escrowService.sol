...
contract escrowService is Ownable{
    ...
    function withdrawETH(uint256 amount, address payable receiveAddress) internal returns(bool){
        ...
        require(aToken.transferFrom(receiveAddress, address(this), amount), "Transfer failed !");
    ...
    function getContractAaveInfo() public view returns(uint256, uint256, uint256, uint256,uint256, uint256, uint256){
