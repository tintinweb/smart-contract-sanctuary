...
// File contracts/interfaces/INostraSwapFactory.sol
...
// File contracts/interfaces/IExternalNostraSwapFactory.sol

pragma solidity >=0.5.0;

interface IExternalNostraSwapFactory {
    event PairCreated(address indexed token0, address indexed token1, address pair, uint);
...
// File contracts/NostraSwapERC20.sol
...
// File contracts/interfaces/INostraSwapCallee.sol
...
// File contracts/interfaces/IExternalNostraSwapPair.sol
...
// File contracts/NostraSwapPair.sol
...
// File contracts/NostraSwapFactory.sol
...
contract NostraSwapFactory is INostraSwapFactory {
    ...
    address public override externalFactory0;
    address public override externalFactory1;
    ...
    constructor(address _feeToSetter, address _owner, address _externalFactory0, address _externalFactory1) public {
        feeToSetter = _feeToSetter;
        owner = _owner;
        externalFactory0 = _externalFactory0;
        externalFactory1 = _externalFactory1;
    }
    ...
    function createPair(address tokenA, address tokenB) external override returns (address pair) {
        ...
        NostraSwapPair(pair).initialize(token0, token1, IExternalNostraSwapFactory(externalFactory0).getPair(tokenA, tokenB), IExternalNostraSwapFactory(externalFactory1).getPair(tokenA, tokenB));
    ...
    function setExternalFactories(address _externalFactory0, address _externalFactory1) external override onlyOwner {
        externalFactory0 = _externalFactory0;
        externalFactory1 = _externalFactory1;
    }
}