...
// token transfers
// ----------------------------------------------------------------------------
contract OnePlanetCarbonOffsetV3 is ERC20Interface, OwnableUpgradeable, UUPSUpgradeable {
...
function initialize() public initializer {
		...
		daiAddress = payable(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa); // Kovan address only
