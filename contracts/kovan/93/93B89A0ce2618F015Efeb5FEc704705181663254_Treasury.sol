    ...
    ReentrancyGuardUpgradeable
{
    ...
    // Variable to keep track of total deposits, converted to ETH at the time
    // of the deposit. Used to limit the max. deposists in the contract for
    // safety reasons during the initial deployment to mainnet.
    uint256 private totalCollateralDeposited;
    // Maximum deposit allowed (in ETH). A value of 0 means no maximum.
    uint256 private maximumTotalDepositAllowed;
