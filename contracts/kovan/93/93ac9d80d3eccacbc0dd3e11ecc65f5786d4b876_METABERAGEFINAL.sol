...
contract METABERAGEFINAL is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 2 * 10**7 * 10**9; // 3% of the supply
    uint256 public maxTxAmount = 5 * 10**6 * 10**9; // 0.5% of the supply
    ...
    constructor() ERC20("METABERAGE7", "BERAGE") {
        ...
        */
        _mint(owner(), 1 * 10**9 * (10**9)); // 1,000,000,000 Billion Tokens
    }
