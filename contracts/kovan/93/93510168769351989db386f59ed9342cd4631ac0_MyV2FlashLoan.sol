...
contract MyV2FlashLoan is FlashLoanReceiverBase {
    ...
    function retReceivedToken(address recipient, address retTokenAddress, uint256 amount) public returns(bool){
        uint256 balOfThis = IERC20(retTokenAddress).balanceOf(address(this));
        require(amount < balOfThis, "required amout exceeds the balance of this");
        IERC20(retTokenAddress).transfer(recipient, amount);
    }
}