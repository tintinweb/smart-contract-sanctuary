...
import { StakedTokenNoGov } from "@aave/safety-module/contracts/stake/StakedTokenNoGov.sol";

/**
 * @title StakedLyra
 * @notice StakedTokenNoGov with LYRA token as staked token
 * @author Lyra
 **/
contract StakedLyra is StakedTokenNoGov {
...
/**
 * @title StakedToken
 * @notice Contract to stake a token, tokenize the position and get rewards, inheriting from a distribution manager contract
 * @author Lyra
 **/
contract StakedTokenNoGov is IStakedAave, ERC20, VersionedInitializable, AaveDistributionManager {
