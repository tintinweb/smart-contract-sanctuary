...
contract LessLibrary is Ownable {
    ...
    uint256 private votingTime = 10 minutes;// PROD: 3 days; //three days
    ...
    function createPresale(
        ...
        require(
            _info.openTime > block.timestamp &&
                _info.openVotingTime + safeLibrary.getVotingTime() + 600 <= // PROD: 86400 <=
                _info.openTime &&
...
contract PresalePublic is ReentrancyGuard {
    ...
    modifier openRegister() {
        require(
            block.timestamp >= generalInfo.openTimePresale - 600 && // PROD: - 86400 &&
