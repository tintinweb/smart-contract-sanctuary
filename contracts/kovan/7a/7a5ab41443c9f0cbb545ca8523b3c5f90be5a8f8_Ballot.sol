...
contract Ballot {
    ...
    function startVote(address litionTokenAddress)
        public
        ...
        onlyOfficial //only owner can start vote
    {
        ...
        litionTokenSmartContractAddress = litionTokenAddress;
        ...
        notAlreadyVoted() //vote can by only once
    {
        ...
        uint tokenBalance = ERC20Interface(litionTokenSmartContractAddress).balanceOf(msg.sender);
