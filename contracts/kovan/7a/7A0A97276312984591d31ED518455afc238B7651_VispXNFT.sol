...
contract VispXNFT is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    uint256 public constant NFT_PRICE = 0; //5000000000000000; // 0.005 ETH
    uint public constant MAX_NFT_PURCHASE = 10000;
    ...
    constructor() ERC721('VispXNFT', 'VISPX') {}
