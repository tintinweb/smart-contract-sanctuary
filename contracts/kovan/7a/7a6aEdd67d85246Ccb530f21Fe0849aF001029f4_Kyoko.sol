...
contract Kyoko is Ownable, ERC721Holder {
    ...
    mapping(address => mapping(uint256 => ASSETS)) public AssetsMap;
    ...
    function repay(
        ...
        AssetsMap[_nft.lender][_nft.lTokenId] = _assets;
    ...
    function claimERC20(uint256 _lTokenId) public {
        ...
        ASSETS storage _assets = AssetsMap[msg.sender][_lTokenId];
        require(
            _assets.repayAmount != 0 && !_assets.hasClaim,
            "This debt is not clear"
        );
