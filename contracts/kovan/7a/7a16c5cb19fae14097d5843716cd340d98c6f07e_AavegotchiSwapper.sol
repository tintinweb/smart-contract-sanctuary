...
contract AavegotchiSwapper {
     ...
     * price is set to 0
     */
    function createSwap(uint256 id, string calldata desiredName) external {
     ...
     */
    function createSale(uint256 id, uint256 price) external {
    ...
    * @dev Take up an existing swap that's a sell. Only swaps the taker's name to the swap creator's name.
     */
    function takeSell(uint256 swapId, uint256 takerId, string calldata placeholder) external {
    ...
    function swapOwn(uint256 swapId, uint256 takerId, string calldata placeholder) external {
        require(!nameUsed(placeholder), 'placeholder error');
