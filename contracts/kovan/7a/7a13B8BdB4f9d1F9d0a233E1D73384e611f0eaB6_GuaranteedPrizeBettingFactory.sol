...
contract GuaranteedPrizeBettingContract is AbstractBettingContract {
    ...
    function close() external override onlyPriceClosed onlyOpen {
        ...
        uint256 reward = 0;
        if (winers.length > 0) {
            reward = upfrontLockedFunds * rewardForWinner / 1000 / winers.length;
    ...
    function buyTicket(uint256 _bracketIndex) public override onlyOpen onlySlotAvailable betable {
...
import "../GuaranteedPrizeBettingContract.sol";
import "../interface/IBettingFactory.sol";

contract GuaranteedPrizeBettingFactory is IBettingFactory {
    function createNewBettingContract(
        address payable _owner,
        address payable _creator
    ) public override returns (address) {
        GuaranteedPrizeBettingContract betting = new GuaranteedPrizeBettingContract(
            _owner,
            _creator
        );
