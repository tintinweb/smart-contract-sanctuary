...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    function setFeeRate(
        ...
        external;
    function feeRate() external pure returns (uint);  
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'6085cf5424949cc3fb5de15a04c9b8a05190354a7724fc25424494b3f1f19a2c' // init code hash
            ))));
    }
...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function swapExactTokensForTokens(
        ...
        amounts = UniswapV2Library.getAmountsOut(factory, amountIn, path, feeRate);
    ...
    function swapTokensForExactTokens(
        ...
        amounts = UniswapV2Library.getAmountsIn(factory, amountOut, path, feeRate);
        ...
        returns (uint[] memory amounts)
    {
        ...
        amounts = UniswapV2Library.getAmountsOut(factory, msg.value, path, feeRate);
        require(amounts[amounts.length - 1] >= amountOutMin, 'UniswapV2Router: INSUFFICIENT_OUTPUT_AMOUNT');
    ...
    function _swapSupportingFeeOnTransferTokens(address[] memory path, address _to) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            amountOutput = UniswapV2Library.getAmountOut(amountInput, reserveInput, reserveOutput, feeRate);
            }
    ...
    function getAmountsOut(uint amountIn, address[] memory path)
        ...
        returns (uint[] memory amounts)
    {
        return UniswapV2Library.getAmountsOut(factory, amountIn, path, feeRate);
    }
    ...
    function getAmountsIn(uint amountOut, address[] memory path)
        ...
        returns (uint[] memory amounts)
    {
        return UniswapV2Library.getAmountsIn(factory, amountOut, path, feeRate);
    }
}