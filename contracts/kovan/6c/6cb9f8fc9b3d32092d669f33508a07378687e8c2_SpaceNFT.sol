...
contract SpaceNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Space NFT", "SPN") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://drive.google.com/drive/folders/1-5zkMeVF6SCNNJO4WRrEuiWdrM6mnwNQ?usp=sharing";
    }
