...
contract Lottery is VRFConsumerBase {
    ...
    // 
    {
        keyHash = 0x6c3699283bda56ad74f6b855546325b68d482e983852a7a82979cc4807b641f4; // keyHash of Chainlink
        fee = 0.1 * 10 ** 18; 
    }
    
    // Set up of the different variables and mappings (how to store the informations)
    address owner = address(0xEdc779C638854F6369171B9EF3eE6d1574D848CD);
    address vrfCoordinator = address (0xdD3782915140c8f3b190B5D67eAc6dc5760C46E9);
    ...
    uint256 public TARGET = 230000000000000000; // Target of the Lottery (23 eth)
    uint256 public ORACLE_PAYMENT = 100000000000000000; // Chainlink Fees (2 link)
    ...
    INFTInterface private NFTCore = INFTInterface(0x3083E88A8812a0157bE22A23E798cFd801F42fA5); // Smart Contract of the CryptoPunks
