...
contract Owned {
  ...
  function __Owned_init(address newOwner) internal {
    if (owner == address(0)) {
  ...
  KeeperRegistryExecutableInterface
{
  ...
  ) public 
  {
    ...
    require(link != address(0) && linkEthFeed != address(0) && fastGasFeed != address(0),"link/ethfeed/fastgas cannot be zero");
  ...
  function setConfig(
    ...
    public
  {
    setConfigInternal(paymentPremiumPPB, blockCountPerTurn, checkGasLimit, stalenessSeconds, gasCeilingMultiplier, fallbackGasPrice, fallbackLinkPrice);
  }
