...
import {DataTypes} from "./libraries/external/aave/types/DataTypes.sol";
import {WadRayMath} from "./libraries/external/aave/math/WadRayMath.sol";
...
contract AavedaiAdapter is AdapterBase {
        ...
        returns (uint256)
    {
        ...
        _underlyingAsset.safeApprove(aavePoolAddress, amount);
        ...
        uint256 receivedWrappedTokenQuantity = afterBalance.sub(beforeBalance);
