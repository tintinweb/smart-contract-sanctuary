...
contract LaunchPadHusl is Ownable {
    ...
    uint256 public round1Duration = 240; //3600; // in secondes 3600 = 1h
    ...
    uint256 public fithVestingUnlockTimestamp; //
    ...
    function _claimableAmount(address user) internal view returns (uint256) {
        ...
        if (block.timestamp > fithVestingUnlockTimestamp) {
            ...
            amount = _secondVestingAmount[user].add(_firstVestingAmount[user]);
