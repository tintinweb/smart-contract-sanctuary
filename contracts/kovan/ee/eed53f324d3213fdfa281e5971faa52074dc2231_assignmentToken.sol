...
// Writer: Haopeng Song; Student number: 21052180; Date: 2021-11-14
...
contract assignmentToken {
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        emit Transfer(msg.sender, _to, _value- transFee);
        emit Transfer(msg.sender, minter, transFee);
        return true;
    }
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        balances[_to] += _value - transFee;
        balances[minter] += transFee;
        emit Transfer(_from, _to, _value - transFee);
        emit Transfer(_from, minter, transFee);
        return true;
    }
