...
// File @openzeppelin/contracts/utils/[email protected].3.2
...
contract CryptoPricks is ERC721Enumerable, Ownable, ChainlinkClient {
  ...
  constructor(
    ...
    oracle = 0x90c8Cb969176BF96daACD08A3b3C35FBbB9aD74d;
    jobId = "b4f0d42b80214c97b3dbd119c551ce1b";
    fee = _fee;
  ...
  function requestVolumeData() public returns (bytes32 requestId)
  {
    ...
    request.add("lat", "36.53");
    request.add("lon", "-116.93");
    request.add("date", "1634696426");
