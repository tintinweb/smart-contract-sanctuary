...
contract FlashLoanTemplate is ICallee {
    ...
    IWETH private WETH = IWETH(0xd0A1E359811322d97991E03f863a0C30C2cF029C); // testnet
    // IWETH private WETH = IWETH(0x4d1Dbf4DCAAa3562C5c65aa2c34b28dba863eaA3); // dev
    ...
    ISoloMargin private soloMargin = ISoloMargin(0x4EC3570cADaAEE08Ae384779B0f3A45EF85289DE);  // testnet
    ...
    receive() external payable {
    	// do nothing; we need to be able to accept ETH deposits to unwrap WETH
    }
    ...
    function callFunction(address sender, Account.Info memory accountInfo, bytes memory data) external override {
        ...
        WETH.withdraw(WETH.balanceOf(address(this))); // unwrap everything. this should cause a fail
