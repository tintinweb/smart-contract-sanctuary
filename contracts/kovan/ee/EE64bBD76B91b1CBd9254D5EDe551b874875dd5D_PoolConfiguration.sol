...
contract PoolConfiguration {
	...
	constructor(string memory name, string memory symbol, address _ASTRTokenAddress) public {
	 ...
	 * @dev Only DAO can update the Managment fees. This will only be called by creating proposal.
	...
	/** 
	 * @dev Get the managment fees. This will be called by the poolV1 contract to calculate managment fees.
	 * This feature is now deprecated.
	 */ 
	 ...
	 */
	  ...
	  /** 
	 * @dev Get the Distributo contract Address. Earlier this was called by PoolV1 but now this is deprecated.
	 */
