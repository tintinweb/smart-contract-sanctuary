...
contract Vault 
{
    ...
    function deposit() public payable {
        address RECEIPT_TOKEN_ADDRESS = address(0x2e9d894BfEa1C85FCD789f547E34f4b7c9462F18);
    ...
    function rebalancePortfolio() public returns (bool success)
    {
        ...
        require(totalCheck == excessWei, "Sum of amount to buy does not equal total");
