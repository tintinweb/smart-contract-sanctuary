...
contract ERC1155Xea12User is OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI {

    event CreateERC1155Xea12User(address owner, string name, string symbol);

    string public name;
    string public symbol;

    function __ERC1155Xea12User_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators) external initializer {
        __ERC1155Xea12User_init_unchained(_name, _symbol, baseURI, contractURI, operators);
        emit CreateERC1155Xea12User(_msgSender(), _name, _symbol);
    }

    function __ERC1155Xea12User_init_unchained(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators) internal {
        ...
        __ERC1155Xea12User_init_unchained(_name, _symbol);
        _setBaseURI(baseURI);
    ...
    function __ERC1155Xea12User_init_unchained(string memory _name, string memory _symbol) internal initializer {
        name = _name;
        symbol = _symbol;
    }
...
contract RoyaltiesV2Impl is AbstractRoyalties, RoyaltiesV2 {
    ...
    function getXea12V2Royalties(uint256 id) override external view returns (LibPart.Part[] memory) {
        return royalties[id];
    }
...
interface RoyaltiesV2 {
    ...
    function getXea12V2Royalties(uint256 id) external view returns (LibPart.Part[] memory);
}
...
library LibRoyaltiesV2 {
    /*
     * bytes4(keccak256('getXea12V2Royalties(uint256)')) == 0x720464a7
     */
