...
// Root file: contracts/mocks/MockERC20Token.sol
...
contract MockERC20Token is Context, IERC20 {
    ...
    function mint(address account, uint256 amount) public onlyWhiteListedMinter returns(bool) {
