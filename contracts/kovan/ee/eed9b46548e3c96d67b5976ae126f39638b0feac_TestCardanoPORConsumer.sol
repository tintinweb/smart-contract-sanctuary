...
contract TestCardanoPORConsumer is ChainlinkClient {
    using Chainlink for Chainlink.Request;
    ...
    function requestBalance(uint256 _chainID, string calldata _contractAddress) public returns (bytes32 requestId) 
    {
        Chainlink.Request memory request = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);
        request.addUint("chainID", _chainID);
        request.add("contractAddress", _contractAddress);
