...
abstract contract Tokenomics {
     ...
     * See: `Liquifier`
     */
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY / 500; // 0.2% of the total supply = 400,000 tokens
    ...
    address internal burnAddress = 0x0000000000000000000000000000000000000000;
      ...
      // Project wallets 
    address internal Gameplay = 0x817B96EdCbBb448e9905c9741173Fd01498D32c8;
    address internal Farming = 0x335D15Ba7b624f30D7065541c771dEBC882f24E1;
    address internal Development = 0xe70Ed740A7d505327E4c4d7929d3dBA46383735d; 
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
  ...
  function setmaxTransactionAmount(uint256 TransactionLimit) external onlyOwner() {
    ...
    function _isUnlimitedRecipient(address account) internal view returns(bool){
        // the owner should be a whitelisted recipient
        // and anyone should be able to burn as many tokens as 
        // he/she wants
        // locked project wallets have to be whitelisted here so its tokens won't be locked forever in the locking contracts due to transaction limit
        return (account == owner() || account == burnAddress || account == Gameplay || account == Development || account == Farming);
    }
