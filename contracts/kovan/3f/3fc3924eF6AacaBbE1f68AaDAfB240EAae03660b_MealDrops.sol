...
import "./MealDropsAccessControl.sol";


/// @title MealDrops tokens
/// @author Valerio Leo @valeriohq
contract MealDrops is ERC721, MealDropsAccessControl {
    ...
    string memory baseTokenURI
		...
		MealDropsAccessControl(msg.sender, "MEALDROPS")
		ERC721(name, symbol)
	{
...
contract MealDropsAccessControl is AccessControl {
