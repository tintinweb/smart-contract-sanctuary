...
contract PreUseAirdrop {
  ...
  constructor(IGovernanceAddressProvider _addresses) public {
    ...
    payouts.push(Payout(0x002F042Dc7622cD8426457df28525692B3CaCc5E, 542346000625030458354920651));
    payouts.push(Payout(0x71fE6c4abAfEF47CF23C4b9fB45f7fcBc238d624, 1000000000000000000000000));
  }
