...
contract HedgeyPutsFactoryV2 {
    ...
    mapping(address => mapping(address => address)) public putContracts;
    ...
    event newPairCreated(address _asset, address _pymtCurrency, address _putContract);
}