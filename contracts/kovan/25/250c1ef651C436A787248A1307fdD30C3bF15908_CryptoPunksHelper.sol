...
/**
 * CryptoPunks IERC721 compatibility.
...
contract CryptoPunksHelper is NFTEscrow, OwnableUpgradeable {
    ...
    //If the owner is this contract, we return the address of the owner
    //to allow compatibility with NFTVault
    ...
    //We aren't calling onERC721Received on the _to address because punks don't implement
    //the ERC721 interface, but we are including this function for compatibility
