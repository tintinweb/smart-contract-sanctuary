...
contract GluonBinaryOptions {
    ...
    event OptionPaid(bytes32 identifier, int marketPrice, address indexed winner, uint value, uint totalPot, uint ratio, uint commissionAmount);
    ...
    function receivePayment(bytes32 identifier) public returns (bool success) {
        ...
        emit OptionPaid(option.identifier, latestPrice, msg.sender, payoutAmount, option.totalPot, r, commissionAmount);
        return true;
    }
