...
contract CrazyBrain is IBEP20, Auth {
    ...
    address payable public marketingWallet = payable(0xf2274a6622488EDF48b9dbd376C5Ab8851DBF5b1);
    address payable public treasury = payable(0x77aA25eE288DF77347218f6a2fa8E524235B2d5D);
    ...
    constructor (    ) Auth(0x24C547f5bF5C21027A2Dc6e7abe3D91A9fbBea36) {
        address _owner = 0x24C547f5bF5C21027A2Dc6e7abe3D91A9fbBea36;
