...
\__|      \__|\__|       \_______|\_______/  \_______|\__|\__|
    ...
    YOU ALL WANTED BONFIRE ON STEROIDS SO WE CREATED FIREBALL!!
    
   #Fireball features:
   
   5% fee auto added to the liquidity pool and locked forever
   2% fee auto distributed to all holders
   5% burn on transactions
   10% Supply is burned at the start.
...
contract BRNING is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        // LIVE PANCAKESWAP V2 // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //testnet BSC
