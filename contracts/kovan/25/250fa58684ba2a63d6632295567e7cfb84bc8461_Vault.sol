...
contract Vault 
{
    ...
    function deposit() public payable {
        address RECEIPT_TOKEN_ADDRESS = address(0xc136c4eC9dF159035A0D23BB6DE0A9a5F7b193ed);
    ...
    function getTotalSupplyOfToken(address tokenAddress) private view returns (uint256 vaultAmount) {
