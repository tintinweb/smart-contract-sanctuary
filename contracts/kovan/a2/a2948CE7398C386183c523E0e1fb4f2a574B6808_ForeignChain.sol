...
contract ForeignChain is BaseChain {
  ...
  constructor(
    ...
    ForeignChain oldChain = ForeignChain(Registry(_contractRegistry).getAddress("Chain"));

    lastBlockId = 250444; // address(oldChain) != address(0x0) ? oldChain.lastBlockId() : 0;
    blocks[lastBlockId] = Block(0xea12bb43a99f933544aa6001d0276e52137fec5b3066e9d996ce6ca0cab7ed59, 1631601613);
  ...
  function deprecate() external {
    ...
    require(msg.sender == address(newChain), "only new chain can deprecate chain contract");
    require(newChain.isForeign(), "only foreign chain can deprecate me");
