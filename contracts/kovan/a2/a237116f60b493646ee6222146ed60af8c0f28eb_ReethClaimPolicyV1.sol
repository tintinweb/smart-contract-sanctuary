...
contract ReethClaimPolicyV1 is Ownable, ReentrancyGuard {
    ...
    uint256 public maxAccumulatedClaim = 46500; // Total maximum accumulation claim back
    ...
    address constant WETH_ADDRESS = address(0xd0A1E359811322d97991E03f863a0C30C2cF029C); // WETH address
    ...
    function finishChangeClaimFactors() external onlyGovernance timelockConditionsMet(4) {
