...
contract SecurityTokenSBT is ERC20Token, Ownable, IERC1594,IERC1644 {
     ...
     */
    function canTransfer(address _to, uint256 _value, bytes calldata _data) internal view returns (bool, bytes1, bytes32) {
        // Add a function to validate the `_data` parameter
     ...
     * @return bytes32 Application specific reason code 
     */
    function canTransferFrom(address _from, address _to, uint256 _value, bytes calldata _data) internal view returns (bool, bytes1, bytes32) {
        // Add a function to validate the `_data` parameter
    ...
    function balanceOfByPartition(bytes32 _partition, address _tokenHolder) external view returns (uint256) {
        if(userRegistry.checkTransferByPartition()){
...
interface IUserRegistry {
    ...
    function checkTransferByPartition() external view returns (bool);
...
interface IERC1410Registry {
   ...
   function balanceOfByPartition(bytes32 _partition, address _tokenHolder) external view returns (uint256);
    ...
    // Token Transfers
    // function _validPartition(bytes32 _partition, address _holder) external returns(bool);
    function transferByPartition(address _from, address _to, uint256 _value, bytes32 _partition, bytes memory _data, address _operator, bytes memory _operatorData) external returns (bytes32);
    function operatorTransferByPartition(bytes32 _partition, address _from, address _to, uint256 _value, bytes calldata _data, bytes calldata _operatorData) external returns (bytes32);
    function canTransferByPartition(address _from, address _to, bytes32 _partition, uint256 _value, bytes calldata _data) external view returns (bytes1, bytes32, bytes32);    
    ...
    // // Issuance / Redemption
    function issueByPartition(bytes32 _partition, address _tokenHolder, uint256 _value, bytes calldata _data) external returns (bool);
    function redeemByPartition(bytes32 _partition, address _from, address _operator, uint256 _value, bytes memory _data, bytes memory _operatorData) external;
    function operatorRedeemByPartition(bytes32 _partition, address _tokenHolder, uint256 _value, bytes calldata _data, bytes calldata _operatorData) external;
