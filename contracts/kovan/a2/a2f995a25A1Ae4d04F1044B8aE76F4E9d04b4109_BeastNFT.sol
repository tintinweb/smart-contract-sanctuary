...
contract BeastNFT is Context, IERC721, Ownable {
    ...
    function mint(uint256 amount) external {
        ...
        for(uint i=0; i<amount; i++) {
            ...
            if (randNum==0&&randNum<5) {
                beast = Beast("FFF", 6, 20, "QmTyQ3Mab2711GWGMyvXqMVCQpK49WH1KQRzhUBJS96Q7W");
            } else if (randNum>=5&&randNum<100) {
                beast = Beast("EEE", 5, 5, "QmcNEMp12fU7tNyTt8oRBKeW7QjXR9gLKwJoXPYAav86XV");
            } else if (randNum>=100&&randNum<800) {
                beast = Beast("DDD", 4, 4, "QmZwioRnSrxDUcDK1e4LNkvGi7WW9eJXnHrEwXavathiwe");
            } else if (randNum>=800&&randNum<2200) {
                beast = Beast("CCC", 3, 3, "Qmbdyp864SwZZ2X3yBWKX1YeSax4BRj8F3yvLM9PcgAXYw");
            } else if (randNum>=2200&&randNum<5000) {
                beast = Beast("BBB", 2, 2, "QmPbsQEreJNFVRkNkgyzDNTgkQ6Xt6GrPQXjz83FYTyQMi");
            } else {
                beast = Beast("AAA", 1, 1, "QmRXAzXAA8oiuMxe9m8Tdp9oq4tsBXgDjkpNz3Tz5uuRj2");
            }
    ...
    function getBloodstoneAmount(uint256 _mintingAmount) private view returns (uint256) {
        ...
        if(_mintingAmount==1) {
            ...
            mintingPrice.mul(_mintingAmount);
        }
    }
