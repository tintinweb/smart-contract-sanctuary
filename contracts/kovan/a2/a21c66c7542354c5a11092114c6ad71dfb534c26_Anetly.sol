...
contract Anetly is Context, IERC20, Ownable {
    ...
    uint256 public _convertBNBFee = 6;
    ...
    uint256 public numTokensSellToAddToLiquidity = 300000000000 * 10**9;      // 0.03%
