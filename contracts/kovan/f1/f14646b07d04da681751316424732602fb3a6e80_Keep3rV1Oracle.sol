...
library UniswapV2OracleLibrary {
    ...
    function currentCumulativePrices(
        ...
        if (fetchOnly && (blockTimestampLast != blockTimestamp)) {
...
*/
   ...
   // IKeep3rV1 public constant KP3R = IKeep3rV1(0x1cEB5cB57C4D4E2b2433641b95Dd330A33185A44);
    ...
    function add(address tokenA, address tokenB, bool doAll) external {
        ...
        (uint price0Cumulative, uint price1Cumulative,) = UniswapV2OracleLibrary.currentCumulativePrices(pair,doAll);
    ...
    */
    ...
    function _update(address pair, bool fetchOnly) internal returns (bool) {
       ...
       // if (timeElapsed > periodSize) {
            (uint price0Cumulative, uint price1Cumulative,) = UniswapV2OracleLibrary.currentCumulativePrices(pair,fetchOnly);
            //observations[pair].push(Observation(block.timestamp, price0Cumulative, price1Cumulative));
    ...
    function current(address tokenIn, uint amountIn, address tokenOut) external view returns (uint amountOut) {
        ...
        (uint price0Cumulative, uint price1Cumulative,) = UniswapV2OracleLibrary.currentCumulativePrices(pair,true);
