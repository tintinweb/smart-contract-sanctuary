...
/**
 * @title Dfyn Token
 * @dev Dfyn ERC20 Token
 */
contract DfynToken is ERC20Permit, Ownable {
    uint256 public constant MAX_CAP = 250 * (10**6) * (10**18); // 250 million
    ...
    constructor() ERC20("DfynToken", "DFYN") {
     ...
     * Owner is assumed to be governance or Dfyn trusted party for helping users
