...
/**
    ...
    6% total liquidity FEE
        40% of fee to marketing wallet
        40% of fee to charity wallet
        20% for liquidity
...
contract X15 is Context, IERC20, Ownable {
    ...
    string private _name     = "X15";
    string private _symbol   = "X15";
