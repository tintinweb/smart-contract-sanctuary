...
contract ToyDOGE is Context, IERC20, Ownable {
    ...
    address payable public _wallet_marketing = payable(0xD227b769a137Af21D80032F78a8d878f72F120Ea);

    // for burn
    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0x642DD054Ca7edf7cdE53B6130D9D77A845Bf5528);

    // for buyback
    uint256 public _fee_buyback = 0;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0x5CBa5976b553B7fFcC82b409980772679D5FE93f);
