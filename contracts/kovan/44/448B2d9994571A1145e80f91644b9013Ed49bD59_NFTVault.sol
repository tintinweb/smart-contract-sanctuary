...
import "../interfaces/IFloorOracle.sol";
...
contract NFTVault is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    IFloorOracle public floorOracle;
    ...
    function _updateOracle() internal {
        floorOracle.update();
        nftTypeValueETH[bytes32(0)] = floorOracle.floor_eth_18();
    }
    ...
    function setNFTType(uint256 _nftIndex, bytes32 _type)
        ...
        onlyRole(DAO_ROLE)
    {
        require(nftTypeValueETH[_type] > 0, "invalid_nftType");
        ...
        returns (uint256)
    {
        ...
        return
            nftType == CUSTOM_NFT_HASH
                ? nftValueETH[_nftIndex]
                : nftTypeValueETH[nftType];
    }
    ...
    function _ethPriceUSD() internal view returns (uint256) {
        return uint256(ethAggregator.latestAnswer()) * 10 ** 10;
    }

    function _jpegdPriceUSD() internal view returns (uint256) {
        return uint256(jpegdAggregator.latestAnswer()) * 10 ** 10;
    }
