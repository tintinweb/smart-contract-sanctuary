...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0xd0A1E359811322d97991E03f863a0C30C2cF029C); //kovan wrapped eth
    address WBNB = 0xd0A1E359811322d97991E03f863a0C30C2cF029C; //kovan wrapped eth
    INYANRouter router;
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 lottoAllocation = _available.mul(30);
        uint256 marketingAllocation = _available.mul(50); 
...
contract NYAN_WETH is IERC20, Ownable {
    using Address for address;
    using SafeMath for uint256;

    address REWARD = 0xd0A1E359811322d97991E03f863a0C30C2cF029C; //kovan wrapped eth
    address WBNB = 0xd0A1E359811322d97991E03f863a0C30C2cF029C; //kovan wrapped eth
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address MAAA = 0x59221824c952FDC03917C9b545eab7C938dC7A84; //set marketing address

    string constant _name = "tNYAN";
    string constant _symbol = "tNYAN";
    ...
    uint256 public tradeSwapVolume = 50000 * 10**9;
    ...
    constructor () {
        router = INYANRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); //kovan router address 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(_tTradeCycle > tradeSwapVolume) {
            ...
            _tTradeCycle = 0; //reset trade cycle
    ...
    event AutoLiquify(uint256 amountREWARD, uint256 amountBOG);
