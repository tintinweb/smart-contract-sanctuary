...
contract PrivateDistribution is Ownable {
    ...
    IERC20 private _matrixToken;
    address[] public investors;

    enum AllocationType { PRIVATE }
    ...
    function withdrawTokens() external onlyInvestor() initialized() {
        ...
        _matrixToken.safeTransfer(_msgSender(), tokensAvailable);
        ...
        returns (uint256 availablePercentage)
    {
        ...
        uint256 vestingDuration = _initialTimestamp + 270 days + 1 days;
