...
contract BabyDogeManager is Ownable, KeeperCompatibleInterface {
    ...
    uint256 public triggerAmount = 1 * 10**18;
    address public immutable WBNB = 0xd0A1E359811322d97991E03f863a0C30C2cF029C; //rplace with real one later
    ...
    function setTriggerAmount(uint256 _triggerAmount) public onlyOwner {
    ...
    function checkUpkeep(bytes calldata /* checkData */) external override returns (bool upkeepNeeded, bytes memory /* performData */) {
        upkeepNeeded = IERC20(lpTokenAddress).balanceOf(address(this)) >= (triggerAmount); // change on actualy deployment to 10k
...
// interface IBabyDoge is Ownable{
//      /**
//      * @dev Leaves the contract without owner. It will not be possible to call
//      * `onlyOwner` functions anymore. Can only be called by the current owner.
//      *
...
//     function renounceOwnership() public virtual onlyOwner; //can't renounce contract and still get income. 
//     function lock(uint256 time) public virtual onlyOwner;
