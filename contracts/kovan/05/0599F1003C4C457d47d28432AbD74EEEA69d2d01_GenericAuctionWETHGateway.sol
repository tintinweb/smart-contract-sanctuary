 ...
 *
 * @notice Simple gateway to allow bidding in generic auctions denominated in WETH using ETH.
 */
contract GenericAuctionWETHGateway is WETHGatewayBase {
     ...
     * @param nft The NFT address of the auction to bid on.
     * @param nftId The NFT ID of the auction to bid on.
     */
    function bidWithEth(
        address auction,
        address onBehalfOf,
        ...
        IAuctionBase(auction).bid(onBehalfOf, nft, nftId, msg.value);
    }
}
