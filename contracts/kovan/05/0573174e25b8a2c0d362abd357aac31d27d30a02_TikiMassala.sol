...
contract TikiMassala is ERC20, Ownable {
    ...
    */
    ...
    uint8 _feeDecimalsInitial = 2;
    uint32 _feePercentageInitial = 100;
    uint128 _minTokensBeforeSwapInitial = 100 * 10**6 * 10**18; // 100 million mininum
    ...
    constructor(
        ...
        updateFee(_feeDecimalsInitial, _feePercentageInitial);
        updateMinTokensBeforeSwap(_minTokensBeforeSwapInitial);
