...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
     ...
     function Buy()payable public returns(bool){
        ...
        _saleSupply=_saleSupply+amount;
        require (_saleSupply<=98e8);
        ...
        require (_saleSupply<=98e8);
        require(block.timestamp >= contractcreationtime + 60 && !first,"time limit not reached wait 1 minutes after contract deployment ");
    ...
    function Withdraw (uint256 amount) public returns(bool){
        require(msg.sender == _owner , "NOT Accessable");
        require((_saleSupply >= 98e7) , "cap not reached");
