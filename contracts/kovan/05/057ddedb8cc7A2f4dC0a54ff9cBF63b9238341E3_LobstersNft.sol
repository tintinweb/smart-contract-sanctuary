...
import "./interface/ILobstersNft.sol";

contract LobstersNft is ILobstersNft, Ownable, ERC721Enumerable, VRFConsumerBase {
    ...
    function mintMultiple(address _to, uint256 _count) external override {
