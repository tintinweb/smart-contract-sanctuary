...
contract FarmToken is BEP20('Bone Token', 'BONE') {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    event UpdateEmissionRate(address indexed user, uint256 BonePerBlock);
    ...
    function updateEmissionRate(uint256 _BonePerBlock) public onlyOwner {
        massUpdatePools();
        BonePerBlock = _BonePerBlock;
