    ...
    BlackholePrevention
{
    ...
    function _transfer(
        ...
        if (
            ...
            //burn
            _totalSupply -= (amount * burnFee) / 10000;
            //treasury
            _balances[stakingRewardTreasury] += (amount * stakeFee) / 10000;
            //liquidityFee
            _balances[address(liquidityHolder)] += (amount * liquidityFee) / 10000;

            _balances[recipient] +=
                amount -
                (amount * (burnFee + stakeFee + liquidityFee)) /
                10000;
        } else {
