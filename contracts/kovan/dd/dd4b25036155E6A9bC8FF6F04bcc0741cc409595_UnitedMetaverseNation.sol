...
contract UnitedMetaverseNation is ERC721("United Metaverse Nation", "UMN"), ERC721Enumerable, Ownable, Pausable {
    ...
    */
    ...
    uint256 public BUY_LIMIT_PER_TX = 5; //10;
    uint256 public MAX_NFT = 10; //11111;
    ...
    */
    ...
    //     if (tokenId < 2000) {
    //         return bytes(baseURI[0]).length > 0 && totalSupply() >= 2000 ? string(abi.encodePacked(baseURI[0], 
    //             tokenId.toString())) : string(abi.encodePacked(blindURI, tokenId.toString()));
    //     } else if (tokenId >= 2000 && tokenId < 4000) {
    //         return bytes(baseURI[1]).length > 0 && totalSupply() >= 4000 ? string(abi.encodePacked(baseURI[1], 
    //             tokenId.toString())) : string(abi.encodePacked(blindURI, tokenId.toString()));
    //     } else if (tokenId >= 4000 && tokenId < 7000) {
    //         return bytes(baseURI[2]).length > 0 && totalSupply() >= 7000 ? string(abi.encodePacked(baseURI[2], 
    //             tokenId.toString())) : string(abi.encodePacked(blindURI, tokenId.toString()));
    //     } else if (tokenId >= 7000 && tokenId < 10000) {
    //         return bytes(baseURI[3]).length > 0 && totalSupply() >= 10000 ? string(abi.encodePacked(baseURI[3], 
    //             tokenId.toString())) : string(abi.encodePacked(blindURI, tokenId.toString()));
    //     } else if (tokenId >= 10000 && tokenId < 11000) {
    //         return bytes(baseURI[4]).length > 0 && totalSupply() >= 11000 ? string(abi.encodePacked(baseURI[4], 
    //             tokenId.toString())) : string(abi.encodePacked(blindURI, tokenId.toString()));
    //     } else if (tokenId >= 11000 && tokenId < 11100) {
    //         return bytes(baseURI[5]).length > 0 && totalSupply() >= 11100 ? string(abi.encodePacked(baseURI[5], 
    //             tokenId.toString())) : string(abi.encodePacked(blindURI, tokenId.toString()));
    //     } else {
