...
contract ShirtumSale is ReentrancyGuard, Ownable {
    ...
    bool public claimEnabled = false;
     ...
     // General conditions
    uint256 public generalMinBuy = 50000000000000000; // 1.5 BNB
    uint256 public generalMaxBuy = 1000000000000000000; // 150 BNB
    ...
    constructor(
        ...
        minimalGoal = 10000000000000000;    // 1 BNB
        hardCap = 2000000000000000000;   // 8333,333333 BNB
        buyPrice = 83333333330000;  // 0,00008333333333 BNB = 0.02705 EUR
        totalTokens = 24001000000000000000000;  // 100,000,000.00 TOKEN
