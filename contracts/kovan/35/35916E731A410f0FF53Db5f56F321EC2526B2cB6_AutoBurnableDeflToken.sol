...
// File contracts/tokens/deflational/DeflationaryToken.sol
...
// File contracts/tokens/deflational/extensions/AutoBurnableDefl.sol


pragma solidity 0.8.4;
contract AutoBurnableDeflToken is DeflationaryToken, AbstractAutoBurnableDeflToken {
    constructor(
        string memory tName, 
        string memory tSymbol, 
        uint256 totalAmount,
    ...
    function _getTransferAmount(uint256 tAmount, uint256 totalFeesForTx, uint256 rate) 
    internal override(DeflationaryToken, AbstractAutoBurnableDeflToken) view 
    returns(uint256 tTransferAmount, uint256 rTransferAmount) {
    ...
    function _recalculateRewardPool(
        ...
        uint256 rAmount,
        uint256 tTransferAmount,
        uint256 rTransferAmount) internal override(DeflationaryToken, AbstractAutoBurnableDeflToken) {
