...
import "./interfaces/IGlueDeposit.sol";
...
contract GlueDeposit is IGlueDeposit {

    /**
     * @inheritdoc IGlueDeposit
     */
    function deposit(
        uint256 ogAmount,
...
/**
 * @dev GlueDeposit between the OG ButtonTranche bond system and the HourGlass bond system
 */
interface IGlueDeposit {
