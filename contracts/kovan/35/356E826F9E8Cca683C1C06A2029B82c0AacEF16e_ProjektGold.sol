...
contract ProjektGold is Context, IERC20, Ownable {
    ...
    constructor () {
        AntiBot _antiBot = AntiBot(0x88C4dEDd24DC99f5C9b308aC25DA34889A5073Ab);
        m_AntiBot = _antiBot;
...
// ######################
    ...
    function assignAntiBot(address _address) external onlyOwner {
        AntiBot _antiBot = AntiBot(_address);
        m_AntiBot = _antiBot;
    }
}