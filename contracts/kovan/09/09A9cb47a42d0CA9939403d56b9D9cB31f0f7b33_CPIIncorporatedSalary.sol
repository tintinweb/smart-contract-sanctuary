    ...
    KeeperCompatibleInterface
{
    ...
    function payEmployee() public {
        for (uint256 i = 0; i < employeesToPayLength; i++) {
            ...
            // Paying.
            employeePaymentToken.approve(address(this), salaryInToken);
            employeePaymentToken.transferFrom(address(this), employee, salaryInToken);
            // // Do not delete. Needing for payment automatisation.
            //} else {
            //    TokenSwap swap;
