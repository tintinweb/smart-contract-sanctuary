...
interface IERC20 {
    ...
    /**
     * @dev Returns the remachrome-extension://nkbihfbeogaeaoehlefnkodbefgpgknn/images/eth_logo.svgining number of tokens that `spender` will be
...
contract SCOREtest is Context, IERC20, Ownable {
    ...
    string private _name = "Score TEST";
    string private _symbol = "SCOREtest";
