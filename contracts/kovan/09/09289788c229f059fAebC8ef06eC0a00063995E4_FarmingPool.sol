...
contract FarmingPool is Pausable, ReentrancyGuard, IFarmingPool {
    ...
    event DebugFarmingPoolRepayFail(
        address indexed account,
        uint256 underlyingAssetBalanceOfFarmingPool,
        uint256 loanPrincipalToRepay,
        uint256 payableInterest,
    ...
    event DebugFarmingPoolInsuranceFundFail(
        address indexed account,
        uint256 underlyingAssetBalanceOfFarmingPool,
        uint256 amountToReceive,
        uint256 timestamp
    ...
    event DebugFarmingPoolInsuranceFundOk(
        address indexed account,
        uint256 underlyingAssetBalanceOfFarmingPool,
        uint256 amountToReceive,
        uint256 timestamp
    ...
    event DebugFarmingPoolMsgSenderFail(
        address indexed account,
        uint256 underlyingAssetBalanceOfFarmingPool,
        uint256 amountToReceive,
        uint256 timestamp
    ...
    event DebugFarmingPoolMsgSenderOk(
        address indexed account,
        uint256 underlyingAssetBalanceOfFarmingPool,
        uint256 amountToReceive,
        uint256 timestamp
        ...
        nonReentrant
    {
        ...
        _totalTransferToAdapter[msg.sender] = _totalTransferToAdapter[
            ...
            .sub(repaymentDetails.underlyingAssetInvested);
        ...
        if (
            underlyingAssetBalanceOfFarmingPool <
            repaymentDetails.loanPrincipalToRepay.add(
                repaymentDetails.payableInterest
            )
        ) {
            emit DebugFarmingPoolRepayFail(
                address(this),
                underlyingAssetBalanceOfFarmingPool,
        ...
        uint256 farmingPoolUnderlyingAssetBalanceInsuranceFund =
            IERC20(underlyingAssetAddress).balanceOf(address(this));
        if (
            farmingPoolUnderlyingAssetBalanceInsuranceFund <
            repaymentDetails.taxAmount
        ) {
            emit DebugFarmingPoolInsuranceFundFail(
                address(this),
                farmingPoolUnderlyingAssetBalanceInsuranceFund,
                repaymentDetails.taxAmount,
                block.timestamp
            ...
            emit DebugFarmingPoolInsuranceFundOk(
                address(this),
                farmingPoolUnderlyingAssetBalanceInsuranceFund,
                repaymentDetails.taxAmount,
                block.timestamp
        ...
        uint256 farmingPoolUnderlyingAssetBalanceMsgSender =
            IERC20(underlyingAssetAddress).balanceOf(address(this));
        if (
            farmingPoolUnderlyingAssetBalanceMsgSender <
            repaymentDetails.amountToReceive
        ) {
            emit DebugFarmingPoolMsgSenderFail(
                address(this),
                farmingPoolUnderlyingAssetBalanceMsgSender,
                repaymentDetails.amountToReceive,
                block.timestamp
            ...
            emit DebugFarmingPoolMsgSenderOk(
                address(this),
                farmingPoolUnderlyingAssetBalanceMsgSender,
                repaymentDetails.amountToReceive,
                block.timestamp
