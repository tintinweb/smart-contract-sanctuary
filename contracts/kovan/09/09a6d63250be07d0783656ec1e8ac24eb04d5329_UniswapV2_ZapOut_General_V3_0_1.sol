...
// File contracts/UniswapV2_ZapOut_General_V3_0_1.sol
...
//based on Zapper.fi's code here: https://etherscan.io/address/0x69090d6968b12b79cd403ee33e871284dc7e92f6#code
    ...
    */
        ...
        returns (uint256 amountA, uint256 amountB)
    {
        ...
        if (token0 == wethTokenAddress || token1 == wethTokenAddress) {
            ...
            AddressOld.sendValue(msg.sender, amountB.sub(ethGoodwill));
        } else {
