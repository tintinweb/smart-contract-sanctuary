...
contract ERC20UniswapPCVController is IUniswapPCVController, UniRef, Timed {
    ...
    uint256 internal _reweightDuration = 10 minutes;
    ...
    uint160 public override sqrtPriceLimitX96;
    ...
    /// @param _sqrtPriceLimitX96 Swap price limit
    constructor(
        address _core,
        address _pcvDeposit,
        address _oracle,
    ...
    function forceReweight() external override {
        _reweight();
    }

    /// @notice sets the target PCV Deposit address
    function setPCVDeposit(address _pcvDeposit) external override {
        pcvDeposit = IPCVDeposit(_pcvDeposit);
        emit PCVDepositUpdate(_pcvDeposit);
    }

    /// @notice sets the target PCV Deposit parameters
    function setPCVDepositParameters(uint24 _fee, int24 _tickLower, int24 _tickUpper) external override {
    ...
    /// @notice sets the swap price limit
    function setSqrtPriceLimitX96(uint160 _sqrtPriceLimitX96) external override {
        sqrtPriceLimitX96 = _sqrtPriceLimitX96;
        emit SwapPriceLimitUpdate(_sqrtPriceLimitX96);
    }
...
interface IUniswapPCVController {
    ...
    event SwapPriceLimitUpdate(uint160 _sqrtPriceLimitX96);
    ...
    function setSqrtPriceLimitX96(uint160 _sqrtPriceLimitX96) external;
...
abstract contract CoreRef is ICoreRef, Pausable {
    ...
    function setCore(address _newCore) external override {
