...
contract TestMaker is ERC1155Tradable {
    string private _contractURI;

    constructor(address _proxyRegistryAddress) public ERC1155Tradable("Test-Mutant", "TestNFT", _proxyRegistryAddress) {
        _setBaseMetadataURI("https://salvation.finance/api/Test/");
        _contractURI = "https://salvation.finance/api/Test-erc1155";
    }
