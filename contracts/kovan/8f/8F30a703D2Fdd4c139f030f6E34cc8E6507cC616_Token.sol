...
contract Token is Ownable {
    ...
    constructor(
        ...
        //0x5B0276e89137b52F4B913A7C0182f27E1E1A9AF8
    }
    ...
    function payRent(uint256 _USDT) public payable onlyAdmin {
    ...
    function endOfLife(uint256 _USDT) public payable onlyOwner {
        //IMPORTANT! how we know we are checking (balanceOf) the balance of the IB token? now we have two erc20 tokens around this contract. Maybe we need to separate them.
        ...
        for (uint256 i = 0; i < whiteList.length; i++) {
            if (balanceOf(whiteList[i]) > 0) {
                ...
                //we burn the IB tokens sending them to the zero address.
                transferFrom(
                    whiteList[i],
                    zeroAddress,
    ...
    function sendUSDT(address _to, uint256 _amount) public onlyAdmin {
