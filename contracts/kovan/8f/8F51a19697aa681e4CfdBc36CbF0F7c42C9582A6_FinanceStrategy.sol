...
contract FinanceStrategy is IFinanceStrategy {
    ...
    uint256[] public pool_DEK_rewards = [
        ...
        33750000000000000000,     //	33.75	DEK -	dai uni
        33750000000000000000,     //	33.75	DEK -	usdc uni
    ...
    start_date: 1621036800,   // 15/06/2021 @ 12:00am (UTC)
    ...
    constructor(address _dek_address, address _team_address, bool epoch_cycle_reset) {
        ...
        epoch_cycle.start_date = (epoch_cycle_reset ? (block.timestamp) - (4 * epoch_cycle.duration) : 1621036800); // Make testing previous epochs easier
    }
