...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private constant _maxWalletDuringLaunch = 5500000000 * 10**18;
    ...
    function whitelistAddresses() private{
        _whitelisted[0xb8337760cD5102fB02A8EA843b8B08296434263F] = true;
        _whitelisted[0xB29b760b89c5E5f7c4005c7F7555a33B059272Ed] = true;
    }

    // remove this
    function set(uint256 secs) external onlyOwner{      
        _communityLaunchDuration = secs;
    }
}