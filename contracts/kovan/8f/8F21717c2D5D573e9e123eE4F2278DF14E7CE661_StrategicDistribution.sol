...
// File contracts/StrategicDistribution.sol


contract StrategicDistribution is Ownable {
    ...
    uint256 private constant _noOfRemaingDays = 5412;
        ...
        returns (uint256 availablePercentage)
    {
        ...
        uint256 vestingDuration = _initialTimestamp + 12 days;
