...
pragma solidity ^0.8.0;
contract LEET is ERC721Enumerable, Ownable {
    uint public constant MAX_1337 = 1337;
    string _baseTokenURI;
    bool public paused = true;

    constructor(string memory baseURI) ERC721("1337", "1337")  {
        setBaseURI(baseURI);
    }

    modifier saleIsOpen{
        require(totalSupply() < MAX_1337, "Sale end");
        _;
    }
    ...
    function mintSPOOK(address _to, uint _count) public payable saleIsOpen {
        ...
        require(totalSupply() + _count <= MAX_1337, "Max limit");
        require(totalSupply() < MAX_1337, "Sale end");
