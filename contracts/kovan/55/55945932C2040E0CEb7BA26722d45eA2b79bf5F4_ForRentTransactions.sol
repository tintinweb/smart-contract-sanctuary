...
contract ForRentTransactions is ForRentFactory {
    ...
    function reserve(uint256 _forRentId) external {
        ...
        approved = drentalToken.approve(address(this), amountExpected + 1);
        require(approved, "Approve operation unsucceeded");

        approved = drentalToken.approve(msg.sender, amountExpected + 1);
        require(approved, "Approve operation unsucceeded");
        allowanceDebug = drentalToken.allowance(msg.sender, address(this));
