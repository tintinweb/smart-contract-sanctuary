...
import { RollOverBaseMCP15Min } from "RollOverBaseMCP15Min.sol";
...
contract CallCreditSpreadAction is IAction, AirswapBase, RollOverBaseMCP15Min {
...
contract RollOverBaseMCP15Min is Ownable {
  struct Spread {
    address shortOtoken;
    address longOtoken;
  }
  ...
  uint256 constant public MIN_COMMIT_PERIOD = 15 minutes;
