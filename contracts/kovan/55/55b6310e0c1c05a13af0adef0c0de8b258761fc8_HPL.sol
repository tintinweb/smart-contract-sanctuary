...
contract HPL is HPLBase {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "DRACE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "DRACE::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "DRACE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "DRACE::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying DRACE (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "DRACE::_writeCheckpoint: block number exceeds 32 bits");
 ...
 */
abstract contract TokenBurnableUpgradeable is Initializable, ContextUpgradeable, TokenUpgradeable {
 ...
 */
contract TokenUpgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
