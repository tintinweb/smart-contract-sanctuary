...
// File: ../deepwaters/contracts/DToken.sol
...
contract DToken is ERC20 {
    ...
    **/
    ...
    modifier onlyLendingContract {
        require(msg.sender == lendingContractAddress, "The caller of this function must be a DeepWatersLending contract");
        _;
    }
    
    modifier onlyVault {
        require(msg.sender == vaultAddress, "The caller of this function must be a DeepWatersVault contract");
        _;
    }
    ...
    * NOTE: This is not standard ERC20 behavior
    **/
    function _transfer(address _from, address _to, uint256 _amount) internal override {
        IDeepWatersLending lendingContract = IDeepWatersLending(lendingContractAddress);
        lendingContract.beforeTransferDToken(basicAsset, _from, _to, _amount);
        super._transfer(_from, _to, _amount);
    }

    /**
    * @notice change DeepWaters contracts
    * @param _newLendingContractAddress the address of new DeepWatersLending contract
    * @param _newVaultAddress the address of new DeepWatersVault contract
    **/
    function changeDeepWatersContracts(address _newLendingContractAddress, address payable _newVaultAddress) external onlyVault {
