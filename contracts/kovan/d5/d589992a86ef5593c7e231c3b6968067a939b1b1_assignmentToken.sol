...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
     ...
     require ((supply + amount) <= MAXSUPPLY,"not sufficient");
    ...
    function burn(uint256 amount) public returns (bool) {
     ...
     require(amount <= balances[msg.sender],"no sufficient token");
     balances[msg.sender] -= amount;
     supply -= amount;
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
     ...
     require(_value<= balances[msg.sender], "out of limit");
     require(TRANSFEE <= _value, "no sufficient transfee");
    ...
    function transferFrom(
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
     require(_value<=balances[_from], "no sufficient tokens");
