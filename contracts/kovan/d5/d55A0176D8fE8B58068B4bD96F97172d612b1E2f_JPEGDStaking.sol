 ...
 */
contract JPEGDStaking is ERC20, VotesSnapshot, ReentrancyGuard {
    ...
    constructor(address _jpegd)
        ERC20("sJPEG\xE2\x80\x99d", "sJPEGD")
        ReentrancyGuard()
    {
        jpegd = IERC20(_jpegd);
    }
    ...
    function stake(uint256 _amount) external {
        ...
        jpegd.safeTransferFrom(msg.sender, address(this), _amount);
    ...
    function unstake(uint256 _amount) external nonReentrant {
        ...
        jpegd.safeTransfer(msg.sender, _amount);
    ...
    function _beforeTokenTransfer(
        ...
        _updateVotes(from, to, uint224(amount));
    }
}
