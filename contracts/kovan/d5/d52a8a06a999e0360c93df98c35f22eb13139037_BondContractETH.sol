...
contract BondContractETH is Initializable {
    ...
    function bondPriceInUSD() public view returns ( uint price_ ) {
        if( isLiquidityBond ) {
            ...
            // console.log("---");
            // console.log(bondPrice()); // 0.000278000000000000
            // console.log(IBondCalculator( BondCalculator ).getRawPrice( )); // 3275.820000000000000000
            // console.log(price_); // 910677.960000000000000000
            // console.log("---");
        } else {
    ...
    function bondPrice() public view returns ( uint price_ ) {        
        ...
        // console.log("----");
        // console.log(terms.controlVariable);
        // console.log(debtRatio());
        // console.log(price_);
        // console.log(terms.minimumPrice); // 0.000278000000000000
        // console.log("----");
