...
contract ERC20 is Context, IERC20, WhitelistedRole {
    ...
    function chekTransferable(address _user) internal {
...
contract BroxToken is ERC20, Ownable, ERC20Mintable, ERC20Capped, ERC20Burnable {
    ...
    constructor(uint256 _maxCap, uint _lockUpPeriod) public ERC20("Brox Token", "BROX", _lockUpPeriod) ERC20Capped(_maxCap) {
    }
