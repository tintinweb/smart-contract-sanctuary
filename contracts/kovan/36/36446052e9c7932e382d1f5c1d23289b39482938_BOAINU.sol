...
contract BOAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Boa Inu";
    string private constant _symbol = "BOAINU";
    ...
    address payable private _developmentAddress = payable(0x5c931E2Fa4fc5cBDE5EFF326C7dB46EA46fC80E0);
    address payable private _marketingAddress = payable(0x7760B4A60DA569021Bf167B3E0821b2aA04a737f);
    ...
    uint256 public _maxTxAmount = 500000000000 * 10**12; //0.5
    uint256 public _maxWalletSize = 1000000000000 * 10**12; //1
    uint256 public _swapTokensAtAmount = 10000000000 * 10**12; //0.1
