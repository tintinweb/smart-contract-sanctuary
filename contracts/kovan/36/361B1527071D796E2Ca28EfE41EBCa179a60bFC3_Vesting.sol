...
contract Vesting is PausableUpgradeable, BumperAccessControl {
    ...
    ///      Can only be invoked if the escrow is NOT paused.
    ///      Can only be invoked if the investor is NOT paused.
    /// @param _to Serial number of proof
    /// @param _toke Investor address to which funds will be transferred
    /// @param _amount The number of funds to be transferred
    function withdraw(
        address _to,
        address _toke,
        uint256 _amount
