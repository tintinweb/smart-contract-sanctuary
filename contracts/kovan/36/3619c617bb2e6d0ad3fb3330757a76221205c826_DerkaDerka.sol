...
contract DerkaDerka is Context, IERC20, Ownable {
    ...
    string private _name = "Derka Derka";
    string private _symbol = "DERKADERKA";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000 * 10**8 * 10**9; //1 order of magnitude smaller than the max tx amount (so, div by 10, sort of)
    ...
    /* TODO Checklist after deploying the TestingCoin token, and preparation for a smooth presale.
