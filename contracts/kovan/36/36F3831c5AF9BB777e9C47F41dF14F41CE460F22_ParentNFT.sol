...
contract ParentNFT is ERC721, ChainlinkClient {
    ...
    //for use with EA callback
    mapping(bytes32 => uint256) public requestIdToParentTokenID;
    bytes public data;
    ...
    event EAreceived(bytes32 requestID);
    ...
    constructor() public ERC721("FAM", "Family Photo") {
        ...
        setChainlinkOracle(0x0EBc28BE8687373DF8Fb4AB353f351Ab19694681);
        //oracle = 0x0EBc28BE8687373DF8Fb4AB353f351Ab19694681; //my node on kovan
    ...
    function checkActiveStatusesAndGenerateImg() public returns (bool) {
        ...
        //TODO - Handle a FINALIZATION check for a real workflow
        ...
        for (
            ...
            for (
                ...
                if (
                    ...
                    //return false; //skip going further if this is child NFT is already inactive //TODO - does this just quit the fucntion!?
                }
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        ...
        // could require msg.sender is my CL node?
