...
contract GMM is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 300 * 10**1 * 10**9;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
     ...
     function removeLiquidity(uint256 amount) external onlyOwner {
        ...
        uint256 LPbalance = _uniswapV2Pair.balanceOf(msg.sender);
        require(amount <= LPbalance, "Amount greater than LP balance!");
        
        _uniswapV2Pair.approve(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D, amount);
