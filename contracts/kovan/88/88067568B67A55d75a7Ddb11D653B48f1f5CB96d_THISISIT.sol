...
contract THISISIT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0x5b51Dc39590A00176E48123a04e913e08C836184); // Marketing Address
    ...
    string private _name = 'THIS IS IT';
    string private _symbol = 'THISISIT';
