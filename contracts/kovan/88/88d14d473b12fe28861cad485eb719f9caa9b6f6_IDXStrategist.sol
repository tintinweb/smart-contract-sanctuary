...
function initialize(
  ...
  cCOMP = CErc20(0x70e36f6BF80a52b3B46b3aF8e106CC0ed743E8e4);  
    ...
    function createVault(
      ...
      string memory name
       ...
       // vault.symbol = symbol;
        ...
        vault.logic.initialize(address(this), cToken, asset, fees, feeBase, symbol, name);
    ...
    /// @notice UPDATE VAULT.
    /// @param _vaultId The asset we update the pool on
    /// @dev each vault start with a ratio of one to one

    function updateCompoundVault(uint256 _vaultId) public {
        _Vaults storage vault = vaults[_vaultId];
    ...
    AccessControlUpgradeable
{
    ...
    function mint(
        ...
        STRATEGIST.updateVault(address(this));
