...
// File: contracts/CrateMarket.sol
...
contract CrateMarket {
    ...
    constructor(Token token, CrateNFT crate, AkitaNFT akita, KishuNFT kishu) {
        _token = token;
        _crate = crate;
		_akita = akita;
		_kishu = kishu;
