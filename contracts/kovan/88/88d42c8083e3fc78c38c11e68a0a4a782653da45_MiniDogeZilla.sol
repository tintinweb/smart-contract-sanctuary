...
contract MiniDogeZilla is IERC20, Authorized {
    ...
    address public marketingAddress = address(0x3a9c3e947490dA949393330B6213767E07e022aE);
    address public keyBoxAddress = address(0x4BDb58e753fA282A97AE10bc6B1effE8461E053E);
    ...
    function swapTokens(uint256 tokens) inSwap private {
        ...
        uint256 bnbForMarketingAndKeyBox = newBalance - bnbForLP;

        uint256 bnbForMarketing = bnbForMarketingAndKeyBox / 2;

        uint256 bnbForKeyBox = bnbForMarketingAndKeyBox - bnbForMarketing;
        
        (bool temp,) = payable(marketingAddress).call{value: bnbForMarketing, gas: 30000}(""); temp; //warning-suppresion 

        (bool temp2,) = payable(keyBoxAddress).call{value: bnbForKeyBox, gas: 30000}(""); temp; //warning-suppresion 
