...
contract TestBrah is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Test Brah";
    string private constant _symbol = "TSTBRAH";
