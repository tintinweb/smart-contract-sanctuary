...
{
    function getHash(address user, uint256 amountWithFee, bytes32 originalTxHash) public pure returns (bytes32)
    {
        return keccak256(abi.encode(user, amountWithFee, originalTxHash));
    }
...
contract swapContract is AccessControl, Pausable, ECDSAOffsetRecovery
{
        ...
        onlyRelayer
    {
        ...
        bytes32 hashedParams = getHash(user, amountWithFee, originalTxHash);
