...
contract Paymaster is BasePaymaster {
    ...
    function preRelayedCall(
        ...
        if (approvalData.length == 160) {
            ...
            IERC2612Permit token2612 = IERC2612Permit(_bytesToAddress(relayRequest.relayData.paymasterData));
            token2612.permit(account, address(this), value, deadline, v, r, s);
        }
