/**
 * 
 * $BFSHIB - BLACK FRIDAY SHIBA
 *
 * 
 * 
 * 💻 Website: https://blackfridayshiba.com/
 * 💬 Telegram: https://t.me/blackfridayshiba
 * 🐦 Twitter: hhttps://twitter.com/bfshib
 * 
 * 
 * 
* 
 ...
 *
 * BLACK FRIDAY SHIBA integrates with Chainlink to create a automated, randomised way to give deals.
 *
 * Tokenomics:
 * 
 ...
 * 
 * Black Friday Shiba integrates with the oracle provider CHAINLINK which,
...
contract BlackFridayShiba is Context, IERC20, Ownable, VRFConsumerBase {
    ...
    string private constant _name = unicode"Black Friday Shiba";
    ...
    constructor () VRFConsumerBase(
        ...
        _FeeAddress = payable(0xb4eab55e4D6d4d3A062919D5498343B8929f6f56);
        _marketingWalletAddress = payable(0xb4eab55e4D6d4d3A062919D5498343B8929f6f56);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_FeeAddress] = true;
        _isExcludedFromFee[_marketingWalletAddress] = true;
        _isExcludedFromFee[address(0xdD3782915140c8f3b190B5D67eAc6dc5760C46E9)] = true; //chainlink VRFCoordinator
    ...
    function requestBuybackRandomNumber()  private  {
        if (lastRequestId != 0 && block.timestamp < lastRequestAt + 2 minutes) return;
