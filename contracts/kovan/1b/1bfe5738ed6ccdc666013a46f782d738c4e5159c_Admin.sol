...
contract Admin{
    ...
    function createNft( address _nftTokenAddress,
        ...
        = address(_nftTokenAddress).delegatecall(abi.encodeWithSignature("create(address,uint256,uint256,string,bytes)", _initialOwner,_initialSupply,_cap,_uri,_data));
