...
contract TokenFactory is Ownable {
    ...
    /// @param symbol The symbol of the token
    /// @param supply The totalSupply of the token
    function createToken(string calldata name, string calldata symbol, uint256 supply) external returns (address) {
        Token token = new Token(name, symbol, msg.sender, supply);
