 ...
 * - Updates de admin of the LEND migrator to the Long Executor of Aave Governance
 * @author Miguel Martinez
 **/
contract ProposalMigratorAdmin is IProposalExecutor {
  event ProposalExecuted();

  address payable public constant LEND_TO_AAVE_MIGRATOR_ADDRESS =
    0x317625234562B1526Ea2FaC4030Ea499C5291de4;
  address payable public constant LONG_EXECUTOR = 0x61910EcD7e8e942136CE7Fe7943f956cea1CC2f7;

  /**
   * @dev Payload execution function, called once a proposal passed in the Aave governance
   */
  function execute() external override {
    InitializableAdminUpgradeabilityProxy(LEND_TO_AAVE_MIGRATOR_ADDRESS).changeAdmin(LONG_EXECUTOR);
