...
contract PolkaDex is ERC20 {
    ...
    function ClaimAfterVesting() public {
        // The second tranch of vesting happens after 3 months (1 quarter = (3*30*24*60*60)/13.14 blocks) from TGE 591781
        require(block.number > InitialBlockNumber + 1, "Time to claim vested tokens has not reached");
