...
contract TokenFarmUP is Initializable, OwnableUpgradeable {
    // stakeTokens
    // unstakeTokens
    // issueTokens
    // AddAllowedTokens
    ...
    function initialize(address _mockTokenAddress, address owner) public initializer {
    ...
    function getConstValue() public view returns (uint256) {
        return 55;
    }
    ...
    function checkOwner() public view returns (address, address, bool) {
        address own = owner();
