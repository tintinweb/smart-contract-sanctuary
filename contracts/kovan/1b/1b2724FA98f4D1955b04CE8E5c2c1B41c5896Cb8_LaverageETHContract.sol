...
contract LaverageETHContract {
    ...
    mapping(address => uint256) private laverageBalance;
    ...
    function initialBalanceOf(address _address) public view returns (uint256) {
        return initialBalance[_address];
    }

    function laverageBalanceOf(address _address) public view returns (uint256) {
    ...
    function cEthBalance() public view returns (uint256) {
    ...
    function swapAllDaiToETH() internal returns (uint256) {
    ...
    function swapSpecificDaiToETH(uint256 _amountIn)
        internal
        returns (uint256)
    {
        // swap dai to eth
    ...
    function repayDai() internal returns (bool) {
    ...
    function getAvailableLiquidity() private returns (uint256) {
