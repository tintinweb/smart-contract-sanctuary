...
contract DependencyManager is RoleAware, IDependencyManager {
    ...
    function executeAsOwner(address performer) external onlyOwnerExec {
        uint256[] memory requiredRoles = Performer(performer).requiredRoles();
