...
contract MarginSwapPool is IMSPInterface, Tools, Ownable, Exponential, ErrorReporter {
    ...
    function redeemMargin(
        ...
        if (mspconfig.isAutoSupply) {
            (uint256 error,, uint256 actualPToken) = capital.redeemUnderlying(msg.sender, _id, _modifyToken, _amount);
        ...
        capital.doTransferOut(msg.sender, _modifyToken, _amount);
        //如果全部取出，则删除记录
