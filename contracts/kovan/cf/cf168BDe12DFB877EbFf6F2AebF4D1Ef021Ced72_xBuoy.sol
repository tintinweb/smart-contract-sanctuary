...
contract xBuoy is ERC721 {
    ...
    mapping (address => uint[]) activeStakes;
    ...
    struct NFT {
        ...
        uint256 rewarded;     //how many tokens they have claimed
    ...
    function craftNFT(
        ...
        activeStakes[_sender].push(_id);
        nfts.push(NFT(true, _contributed, _allotment, _rewards, 0, _payouts, _nextClaim, _platform));
    }
