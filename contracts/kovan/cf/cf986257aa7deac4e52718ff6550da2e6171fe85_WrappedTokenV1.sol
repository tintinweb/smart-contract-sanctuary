    ...
    RevocableToAddress
{
    ...
    */
    ...
    function _checkOracle(AggregatorV3Interface _reserveFeed)
        internal
        view
        returns (bool, string memory)
    {
        try _reserveFeed.latestRoundData() returns (
            uint80,
            int256 answer,
            uint256,
            uint256,
    ...
    function _updateOracleAddress(address newAddress) internal {
        reserveFeed = AggregatorV3Interface(newAddress);
        (bool success, string memory error) = _checkOracle(reserveFeed);
