...
// $ 1.00 - divisible by 100 
//  1.000000000000000000 ING  -> 1000000000000000000 ING (decimal place not supported)

// require -> evaluated the expression inside the () and stops executing if it evaluates to false