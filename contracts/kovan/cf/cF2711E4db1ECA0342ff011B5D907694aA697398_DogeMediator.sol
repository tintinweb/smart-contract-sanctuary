...
contract DogeMediator is AccessControl{
    ...
    function deposit(
        ...
        uint256 mintedAmount =
            registry.getGatewayBySymbol("DOGE").mint(
                pHash,
                _amount,
                _nHash,
                _sig
        ...
        registry.getTokenBySymbol("DOGE").transfer(msg.sender, mintedAmount);
    ...
    function withdraw(
        ...
        registry.getTokenBySymbol("DOGE").transferFrom(
            msg.sender,
            address(this),
            _amount
        );
        uint256 burnedAmount =
            registry.getGatewayBySymbol("DOGE").burn(_to, _amount);
    ...
    function emergencyWithdraw(uint256 _amount) public {
        ...
        registry.getTokenBySymbol("DOGE").transfer(msg.sender, _amount);
    }

    function balance() public view returns (uint256) {
        return registry.getTokenBySymbol("DOGE").balanceOf(address(this));
    }
}
