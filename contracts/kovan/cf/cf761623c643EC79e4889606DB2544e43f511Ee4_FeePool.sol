...
contract Boring {
    ...
    string public name = "boring";

    /// @dev EIP-20 token symbol for this token
    string public symbol = "BORING";
...
contract FeePool {
    ...
    address constant public boringBTC   = address(0x9522AFFe079A544938DCF9496f0D008D3D3F9Fa2); // Pledge Provider Token BTC
    constructor() public {

    }
    function claimFee() external {
        Boring(boring).mint(msg.sender, 1e18);
        // Boring(boringBTC).mint(msg.sender, 1e18);
    }
