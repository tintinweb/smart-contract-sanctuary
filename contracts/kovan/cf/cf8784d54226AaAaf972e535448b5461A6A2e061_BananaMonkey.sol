...
contract BananaMonkey is ERC721, Ownable, ERC721Enumerable {
    ...
    event BananaMinted(uint256 tokenId, address owner);

    constructor() ERC721("BananaMonkey", "BMN") {}
    ...
    function mintbanana(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_TOKENS) {
                ...
                emit BananaMinted(id, msg.sender);
            }
        }
    }

    function presalebanana(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
    {
        ...
        if (isRevealed == false) {
            return
                "ipfs://QmWobfHFum3SVYr5C8zuNTJUgUNHFXsPW1chh7Rz5kQyW7/hidden.json";
        }
