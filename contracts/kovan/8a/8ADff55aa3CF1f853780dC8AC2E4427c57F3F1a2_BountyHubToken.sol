...
contract BountyHubToken is ERC20Detailed, ERC20Capped, ERC20Pausable, MinterRole {

    string constant private NAME = "BountyHUBToken";
    string constant private SYMBOL = "BHT";
    uint8 constant private DECIMALS = 18;
    uint256 constant private CAP = 100000000 * (10 ** uint256(DECIMALS));
    ...
    function pause() public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC20PresetMinterPauser: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC20PresetMinterPauser: must have pauser role to unpause");
        _unpause();
    }
