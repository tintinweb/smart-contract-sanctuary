...
contract Vault is ERC20, ERC20Detailed, ControllableInit, VaultStorage, IVault {
    ...
    event TTT(uint256 underlyingAmountToWithdraw,uint256 calculatedSharePrice,uint256 underlyingUnit,uint256 numberOfShares);
    ...
    function withdraw(uint256 numberOfShares) external {
        ...
        uint256 underlyingAmountToWithdraw = numberOfShares.mul(calculatedSharePrice).div(underlyingUnit);
        emit TTT(underlyingAmountToWithdraw, calculatedSharePrice, underlyingUnit, numberOfShares);
