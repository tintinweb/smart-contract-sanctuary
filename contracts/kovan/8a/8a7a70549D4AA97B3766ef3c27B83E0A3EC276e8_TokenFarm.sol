...
contract TokenFarm is Ownable {
    ...
    function getUserSingleTokenValue(address _user, address _token) public view returns (uint256) {
        ...
        // 10000000000000000000 ETH  --> We get the eth value in wei so 10 eth is 10 * 10^18 wei
        // ETH/USD -> 100000000      --> Decimal value of the pricefeed 1 * 10^8
        // 10 * 100 = 1,000
        // stakingBalance[_token][_user] --> 10000000000000000000 WEI!!
        // price                         --> 100000000 ETH/USD
