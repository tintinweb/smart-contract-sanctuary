...
contract BuryLeash is ERC20("BuryLeash", "xLeash"){
    ...
    // Define the Bone Leash contract
    constructor(IERC20 _leash, IERC20 _bone, IERC20 _usdc) public {
        bone = _bone;
        leash = _leash;
        usdc = _usdc;
    ...
    function enter(uint256 _amount) public {
        ...
        user.rewardUsdcDebt = user.amount.mul(poolInfo[1].accRewardPerShare).div(1e12);
    }
    ...
    function sendRewards(uint256 _pid, uint256 _share) internal {
        ...
        if(_pid == 0)
            ...
            what = user.amount.mul(pool.accRewardPerShare).div(1e12).sub(user.rewardUsdcDebt);
        ...
        if(_pid == 0)
            ...
            user.rewardUsdcDebt = user.amount.mul(pool.accRewardPerShare).div(1e12);
    }
