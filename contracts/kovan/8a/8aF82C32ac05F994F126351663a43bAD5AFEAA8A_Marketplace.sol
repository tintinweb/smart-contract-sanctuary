...
contract DragonFactory is Ownable, ERC721Enumerable, ERC721URIStorage {
    ...
    mapping(uint256 => HideIPFS) public hideIPFSs;
...
constructor(address initialRoyaltiesReceiver) ERC721("Dragon Rascal", "DNFT") {
    ...
    function GetMaxStatsIPFSByToken(uint256 _tokenId) onlyOwner public view returns (HideIPFS memory _hideIpfs){
        HideIPFS storage result =hideIPFSs[_tokenId];
        return result;
    }
}
