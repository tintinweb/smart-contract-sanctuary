...
contract OpynImpl is IProtocol {
    ...
    string private constant _name = "Opyn-Impl-v1";
    ...
    constructor(
        ...
        require(address(optionRegistry_) != address(0x0), "OpynImpl::zero-addr");
        require(address(opynController_) != address(0x0), "OpynImpl::zero-addr");
        require(address(opynWhitelist_) != address(0x0), "OpynImpl::zero-addr");
        require(address(oTokenFactory_) != address(0x0), "OpynImpl::zero-addr");
        require(marginPool_ != address(0x0), "OpynImpl::zero-addr");
        require(usdc_ != address(0x0), "OpynImpl::zero-addr");
    ...
    function mint(
        ...
        require(collateral.balanceOf(address(this)) >= collateralRequired, "OpynImpl::missing-collateral");
    ...
    function redeem(
        ...
        uint256 collateralRequired = getMintAmt(data, optionAmt * (10 ** 10), "");
    ...
    function claimCollateral(
        ...
        bytes32 optionId = keccak256(abi.encode(data));
        require(userCollaterals[optionId][msg.sender] > 0, "OpynImpl::no-coll");
    ...
    function _claimCollateral(
        ...
        require(hasSettled[optionId], "OpynImpl::settlement-pending");
