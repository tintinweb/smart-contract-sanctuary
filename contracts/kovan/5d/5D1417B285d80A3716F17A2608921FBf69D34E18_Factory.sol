...
contract Factory is IFactory {
    ...
    //TODO: deploy new vault, update the manager mappings
    ...
    function setPeriphery(address _periphery) public override onlyGovernance {
        require(
            _periphery != address(0),
            "Factory : setPeriphery :: address cannot be zero"
        );
...
interface IFactory {
    ...
    /// @notice Returns the address of Periphery contract
    /// @return _periphery Address of Periphery contract
    ...
    /// @notice Allows to upgrade the periphery contract to a new one
    /// @param _periphery Address of the new periphery contract
...
interface IVault is IERC20 {
    ...
    /// @notice Retrieve address of current Periphery in Aastra
    /// @return Periphery address of Aastra periphery contract
