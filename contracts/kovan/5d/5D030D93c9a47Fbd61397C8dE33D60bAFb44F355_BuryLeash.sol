...
contract BuryLeash is ERC20("BuryLeash", "xLeash"){
    using SafeMath for uint256;
    ...
    constructor(IERC20 _leash, IERC20 _usdc) public {
        leash = _leash;
        usdc = _usdc;
    }
    ...
    function leave(uint256 _share) public {
        ...
        UserInfo storage user = userInfo[msg.sender];
        uint256 whatUsdc = user.amount.mul(accRewardPerShare).div(1e12).sub(user.rewardDebt);
        usdc.transfer(msg.sender, whatUsdc);
    ...
    function updatePool() public {
        ...
        uint256 lpSupply = leash.balanceOf(address(this));
