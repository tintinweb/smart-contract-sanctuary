...
contract BonusRewards is IBonusRewards, Ownable, ReentrancyGuard {
    ...
    // use array to allow convenient replacement. Size of responders should be very small to 0 till a reputible responder multi-sig within DeFi or Yearn ecosystem is established
