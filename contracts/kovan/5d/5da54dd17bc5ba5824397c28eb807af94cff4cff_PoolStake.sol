...
contract PoolStake is Owned {
    ...
    constructor(address _token, address _Owner) public Owned(_Owner) {
        ...
        uToken = 0x3f0e4df8689573DF9A5362d57465B7Fc14e66B0D;
        wallet = 0xE06553a9E0B7d5A0A018965D7fc85E2aB2d6EE51;
        multiplier = Multiplier(0x5c92d4573755Cf09E822fed0A83c88234aeb713c);
