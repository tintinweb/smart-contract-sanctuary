...
contract EddaNFTMarket is ERC1155Holder, Ownable, Pausable, ReentrancyGuard {
	...
	constructor(address _eddaNFT, address _eddaTreasury) public {
		...
		isWhiteListPaymentMethod[0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa] = true;
		IERC20(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa).safeApprove(uniswapRouter, uint256(-1));
	}
