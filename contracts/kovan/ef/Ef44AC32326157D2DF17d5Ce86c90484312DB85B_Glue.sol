...
contract Glue is IGlue {
    ...
    function borrow(
        ...
        for (uint256 i = ogTrancheCount; i < ogTrancheCount + trancheCount; i++) {
            tokens[i] = IERC20(bond.ious(i));
        }
...
/**
 * @dev Glue between the OG ButtonTranche bond system and the CAGS bond system
 */
interface IGlue {
