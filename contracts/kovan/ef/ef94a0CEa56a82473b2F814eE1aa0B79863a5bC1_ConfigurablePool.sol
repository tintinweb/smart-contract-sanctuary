...
// NOTE: WIP 
contract ConfigurablePool is Context, ERC20, Ownable, Pausable {
    ...
    function checkEligible(address erc20Addr) internal view returns (bool) {
        ...
        // Matching based on attributes (nothing is allowed in the beginning)
        if (isAttributeBenchMarkPool==true) {
            // Check is CO2KEN contract
            if (previouslyAcceptedContracts[erc20Addr]==true)return true;
        ...
        // If pool is of whitelist configuration (also for external contracts)
