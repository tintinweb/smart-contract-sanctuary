...
contract BirdOracle is Unlockable {
    ...
    function seeReward(address _sender) public view returns (uint256) {
        return seeReward(_sender, MAX_UINT);
    }
        ...
        returns (uint256)
    {
        ...
        for (
            ...
            totalAnswersGivenByThisProvider += answersGivenBy[_provider][
                onThisPortion
            ];
    }
    ...
    function totalAnswersGivenByAllProviders() public view returns (uint256) {
        ...
        for (
            ...
            onThisPortion < onPortion;
            onThisPortion++
        ) theTotalAnswersGiven += totalAnswersGiven[onThisPortion];
