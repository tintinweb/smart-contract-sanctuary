...
contract BasicFYToken is IFYToken, ERC20, Ownable {
  using SafeMath for uint256;
    ...
    ERC20(name, symbol)
  {
    ...
    _maturity = maturity_;
    _rate = (10 ** ERC20(underlying_).decimals());
  }
