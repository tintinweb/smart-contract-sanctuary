...
// File contracts/TeamDistribution.sol
...
contract TeamDistribution is Ownable {
    ...
    uint256 private constant _noOfRemaingDays = 7;
    uint256 private constant SECONDS_PER_DAY = 24 * 60 * 60;
    uint256 private _cliffPeriod = 2;
        ...
        returns (uint256 availablePercentage)
    {
        ...
        uint256 cliffDuration = _initialTimestamp + 2 days;
        uint256 vestingDuration = _initialTimestamp + 2 days + 7 days;
