...
contract Arbitrage {
    ...
    function swapAtDexNickRouter(uint256 amount) public returns(uint256) {
        ...
        uint amountOutMin = IMySwapRouter(nickRounter).getAmountsOut(
            amount,
            path
        )[1];
        ...
        uint256[] memory amounts = IMySwapRouter(nickRounter).swapExactTokensForTokens(
            amount,
            amountOutMin,
            path,
            address(this),
    ...
    function swapAtDexDreamRouter(uint256 amountBNB) public returns(uint256)  {
        ...
        uint amountOutMin = IMySwapRouter(dreamRounter).getAmountsOut(
            amountBNB,
            path
        )[1];
        
        IERC20(wbnb).approve(address(dreamRounter), amountBNB);
        IMySwapRouter(dreamRounter).swapExactTokensForTokens(
            amountBNB,
            amountOutMin,
            path,
            address(this),
