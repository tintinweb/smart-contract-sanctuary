...
contract stETH is ERC20 {
    constructor() public ERC20("liquid staked Ether 2.0", "stETH") {}
    ...
    function getPooledEthByShares(uint256 _wstETHAmount) external view returns (uint256) {
        if (_wstETHAmount == 1 ether) {
            return 1 ether;
        } else {
