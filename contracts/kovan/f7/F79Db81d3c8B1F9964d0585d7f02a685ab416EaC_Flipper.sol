...
// hevm: flattened sources of /nix/store/07p0c2i79x0cv84yjvg1wbhgn4ixi8hs-dss/dapp/dss/src/flip.sol
...
////// /nix/store/07p0c2i79x0cv84yjvg1wbhgn4ixi8hs-dss/dapp/dss/src/flip.sol
...
contract Flipper is LibNote {
    ...
    VatLike_4 public   vat;            // CDP Engine
    ...
    CatLike_2 public   cat;            // cat liquidation module
    ...
    function file(bytes32 what, address data) external note auth {
        if (what == "cat") cat = CatLike_2(data);
        else revert("Flipper/file-unrecognized-param");
    }
