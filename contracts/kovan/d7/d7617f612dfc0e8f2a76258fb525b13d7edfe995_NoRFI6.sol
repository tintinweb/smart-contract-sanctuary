...
contract NoRFI6 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"NoRFI6";
    string private constant _symbol = unicode"NORFI6";
    ...
    /* function theTaxFee() public view returns (uint256) {
        return _taxFee;
    } */
