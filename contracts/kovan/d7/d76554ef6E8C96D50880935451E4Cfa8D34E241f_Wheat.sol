...
contract Wheat is ERC777, IERC777Recipient, ReentrancyGuard, IERC721Receiver, ERC165, ERC721Holder  {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        uint256 combinedMultipliers = getCombinedMultipliers(targetAddress);
        ...
        )
    {
        ...
        uint256 combinedMultipliers = compostMultiplier.div(_percentMultiplier).mul(
                                      maturityMultiplier).div(_percentMultiplier).mul(
                                      equipmentMultiplier).div(_percentMultiplier);
