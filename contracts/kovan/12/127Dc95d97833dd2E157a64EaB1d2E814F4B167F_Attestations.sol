...
contract Attestations is ChainlinkClient, Ownable {
    using Chainlink for Chainlink.Request;

    bytes32 public verificationResponse;
    ...
    modifier onlyProvider() {
        require(
            providers[msg.sender].addr != address(0),
    ...
    constructor() {
        ...
        // @todo: get details for other networks
        // this is Chainlink Kovan Oracle - DevRel
        // https://market.link/nodes/7607c57d-62b8-4c1b-9894-ff9e25d47107/metrics?start=1642189976&end=1642794776
        oracle = 0xc57B33452b4F7BB189bB5AfaE9cc4aBa1f7a4FD8;
        // @todo: only HTTP GET for this job, if we need to do a POST, we need to find another oracle/job
        jobId = "d5270d1c311941d0b08bead21fea7747";
        fee = 0.1 * 10**18; // varies by network and job
    }

    function indexOf(address _user, address _provider)
        internal
        view
        returns (uint256)
    {
    ...
    function exists(address _user, address _provider)
        public
        view
        returns (bool)
    {
    ...
    function isPending(address _user, address _provider)
        public
        view
        returns (bool)
    {
    ...
    // @todo: remove "public" - only for testing right now (should be "internal")
    function callVerification() public returns (bytes32 requestId) {
        // @todo: test this functionality on testnet (kovan)
        ...
        // @todo: call correct Proofi endpoint (with "address _user" as parameter)
    ...
    function fulfillVerification(bytes32 _requestId, bytes32 _response)
        public
