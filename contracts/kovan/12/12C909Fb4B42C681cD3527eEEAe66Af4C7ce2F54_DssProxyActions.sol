...
// hevm: flattened sources of /nix/store/zf71y787fq3q2vla4byhkk1rahz8jb0f-dss-proxy-actions-optimized/dapp/dss-proxy-actions-optimized/src/DssProxyActions.sol

pragma solidity >=0.5.12;

////// /nix/store/zf71y787fq3q2vla4byhkk1rahz8jb0f-dss-proxy-actions-optimized/dapp/dss-proxy-actions-optimized/src/DssProxyActions.sol
...
contract DssProxyActionsEnd is Common {
    ...
    function pack(
        ...
        daiJoin_join(daiJoin, address(this), wad);
        VatLike_14 vat = DaiJoinLike(daiJoin).vat();
