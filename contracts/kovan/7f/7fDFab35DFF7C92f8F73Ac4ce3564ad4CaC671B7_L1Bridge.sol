...
contract L1Bridge is AccessControl {
    ...
    //todo: this is temporary variable for debugging purposes
    bytes public autoParams;
    ...
    function setAutoParams(bytes calldata _autoParams) external {
...
contract DeBridgeGateMock {
    ...
    function send(
        ...
        console.log("ExecFee: %s", autoParams.executionFee);
