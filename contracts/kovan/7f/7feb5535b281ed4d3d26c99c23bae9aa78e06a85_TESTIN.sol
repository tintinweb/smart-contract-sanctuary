...
contract TESTIN is Context, IERC20, Ownable {
    ...
    function includeInReward(address account) external onlyOwner() {
        ...
        _takeLiquidity(tLiquidity.div(2));
        _reflectFee(rFee, tFee);
        _burn(msg.sender,tLiquidity.div(2));
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount.sub(tFee).sub(tLiquidity.mul(2));
