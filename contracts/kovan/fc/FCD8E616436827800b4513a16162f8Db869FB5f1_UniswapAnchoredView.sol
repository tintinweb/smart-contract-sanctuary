...
contract UniswapAnchoredView is UniswapConfig {
    ...
    function getUnderlyingPrice(address cToken) external returns (uint) {
        console.log("get underlying price");
        address socksPair = 0xD52184b08398510a6C8D9f6Cb157973284273D84;
        // TokenConfig memory config = getTokenConfigByCToken(cToken);
        // if(config.cToken == 0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5){
            // return 0;
            return getOSSocksTokenPrice();
        // }
        // return 0;
    ...
    function getOSSocksTokenPrice() public returns (uint112) {
        IUniswapV2Pair pair = IUniswapV2Pair(0xD52184b08398510a6C8D9f6Cb157973284273D84);
        IERC20 token1 = IERC20(pair.token1());
        (uint112 Res0, uint112 Res1,) = pair.getReserves();
        // decimals
        // uint8 res0 = Res0 * (10 ** token1.decimals());
        // return ((1 * res0) / Res1); // return amount of token0 needed to buy token1
        return Res0;
    }
