...
contract PermanentStorage is IPermanentStorage {
    ...
    *************************************************************/
    ...
    function initialize(address _operator) external {
        ...
        // There are no curve contracts on Kovan
        ...
        // // register stETH pool
        // // coins, exchange
        // AMMWrapperStorage.getStorage().curveWrappedTokenIndexes[CURVE_stETH_POOL][ETH] = 1; // ETH
        // AMMWrapperStorage.getStorage().curveWrappedTokenIndexes[CURVE_stETH_POOL][stETH] = 2; // stETH
        // AMMWrapperStorage.getStorage().curveSupportGetDx[CURVE_stETH_POOL] = false;
    }
