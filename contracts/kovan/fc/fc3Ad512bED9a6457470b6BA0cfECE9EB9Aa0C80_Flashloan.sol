...
/**
    ...
    - DAI Token Address:                    0xff795577d9ac8bd7d90ee22b6c1703490b6512fd
    - Uniswap V2 Router:                    0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    - Sushiswap V1 Router:                  0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506

    - ETH:                                  0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE
    - Aave LendingPoolAddressesProvider:    0x506B0B2CF20FAA8f38a4E2B524EE43e1f4458Cc5
...
contract Flashloan is FlashLoanReceiverBase {
    ...
    function flashloan(
        ...
        uint amount = _flashAmount;

        // call lending pool to commence flash loan
        ILendingPool lendingPool = ILendingPool(addressesProvider.getLendingPool());
        lendingPool.flashLoan(address(this), _flashAsset, amount, data);
    }
    ...
    function executeArbitrage() public {
        ...
        uint256 tokenAmountInWEI = tokensOut; //convert into Wei
