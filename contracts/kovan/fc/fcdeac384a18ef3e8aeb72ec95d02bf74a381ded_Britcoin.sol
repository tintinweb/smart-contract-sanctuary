...
contract Britcoin is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xC1057a45E17462ffb47529BD5F6e629E8aE74E3B;
    ...
    function calculateTaxFee(uint256 _amount) private view returns (uint256) {
        ...
        //if txamount is bigger than 0.1%, fee is 30%
        if(_amount.mul(100000).div(_tTotal)>100){
            return _amount.mul(_taxFee).div(10**3);
        }
        else{
            return _amount.mul(_amount).mul(_taxFee).div(_tTotal).div(
                10**2
            );
        }
