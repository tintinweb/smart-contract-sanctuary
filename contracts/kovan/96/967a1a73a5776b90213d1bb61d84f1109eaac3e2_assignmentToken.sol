...
mapping (address => mapping(address => uint)) public allowances;
    ...
    require(amount < 1e60);
    require(supply+amount <= MAXSUPPLY, "Exceeding MAXSUPPLY");
    ...
    require (_value >= fee,"Not sufficient to cover transfer fee");
    ...
    require (_value<=allowances[_from][msg.sender], "Insufficient allowances");
    require (_value>= fee,"Not sufficient to cover transfer fee");
