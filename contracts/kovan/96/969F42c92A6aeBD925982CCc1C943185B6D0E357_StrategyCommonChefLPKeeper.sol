...
// File contracts/BIFI/interfaces/common/KeeperCompatibleInterface.sol
pragma solidity ^0.6.0;
...
// File contracts/BIFI/strategies/Common/StrategyCommonChefLPKeeper.sol

pragma solidity ^0.6.0;
contract StrategyCommonChefLPKeeper is StratManager, FeeManager, KeeperCompatibleInterface {
    ...
    uint256 public harvestThreshold = 10793285679655677588; // random low number for now
    ...
    function setHarvestThreshold(uint256 _newThreshold) external onlyManager {
        harvestThreshold = _newThreshold;
    }
