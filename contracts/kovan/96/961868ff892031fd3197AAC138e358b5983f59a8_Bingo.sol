...
contract Bingo is ERC721, VRFConsumerBase, KeeperCompatibleInterface {
    ...
    string public baseUri = 'https://api.bingoswap.art/bingo-json/';
    ...
    */
    function claimBingo(uint256 cardId) public payable {
        ...
        require(BingoGenerate.validateWinner(cardRandomness[cardId], Balls, pattern), "NW");
        require(cardId > gameFloor, "NC");

        payable(msg.sender).transfer(prizePool);
        emit BingoWinner(_gameIds.current(), msg.sender, cardId);
