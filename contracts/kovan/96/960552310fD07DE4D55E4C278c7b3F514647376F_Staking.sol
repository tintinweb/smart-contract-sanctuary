...
contract Staking is Ownable, ReentrancyGuard {
    ...
    uint256 private _reserveLp;
    uint256 private _reserveLess;
    ...
    function _rewriteTodayVars() private {
        ...
        if (
            ...
            /* if(participants == 0 && totalLpRewards + totalLessRewards > 0) {
            ...
            //DepositReward storage deposit = DepositReward(allLp, allLess, _todayPenaltyLp, _todayPenaltyLess);
    ...
    /* function _rewriteReserveRewards() private {
        if(participants == 0) {
            _reserveLess += totalLessRewards;
            _reserveLp += totalLpRewards;
        }
    } */
}
