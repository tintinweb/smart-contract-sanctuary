...
// File: contracts/PYUK/interfaces/common/IUniswapRouterETH.sol
...
// File: contracts/PYUK/interfaces/common/IUniswapV2Pair.sol
...
// File: contracts/PYUK/interfaces/alpaca/IFairLaunch.sol
...
// File: contracts/PYUK/utils/IGasPrice.sol
...
// File: contracts/PYUK/utils/GasThrottler.sol
...
contract GasThrottler {
    ...
    address public gasprice = address(0xA0702Fe3972C92FdF7fcFE38F830183011f62CC9);
...
// File: contracts/PYUK/strategies/Alpaca/StrategyStronkAlpaca.sol
...
contract StrategyStronkAlpaca is Ownable, Pausable, GasThrottler {
     ...
     * {pYUK} - pYUK token, used to send funds to the treasury.
    ...
    address constant public pYUK = address(0xD5274121b933d4621d65337365712cD024F45332); //kovan
     ...
     * {treasury} - Address of the pYUK treasury
     * {vault} - Address of the vault that controls the strategy's funds.
     * {strategist} - Address of the strategy author/deployer where strategist fee will go.
     * {keeper} - Address used as an extra strat manager. 
     */
    address constant public rewards  = address(0xd74A936B07282D5472d92BCe65E7686462ca3196); //kovan
    address constant public treasury = address(0xd7739E13d4c791646cDbAA8eC6263dfedba3Dfb1); //kovan 
     ...
     * {rewardsFee} - 3% that goes to PYUK holders. Can be increased by decreasing {callFee}.
    ...
    function chargeFees() internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToPyukRoute, treasury, now.add(600));
