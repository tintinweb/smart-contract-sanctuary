...
contract TokenFarm is Ownable{
    ...
    // how many unique tokens has user
    ...
    // send users daap tokens based on how much value in assets they have
    function rewardsStakersWithDaapTokens() public onlyOwner{
    ...
    function stakeTokens(uint256 _amount, address _token) public{
        // how much token user can stake?
        require(_amount > 0, 'Amount must be more that 0!');
        //what token can user stake?
    ...
    function getTokenValue(address _token) public view returns(uint256, uint256){
        ...
        uint256 decimals = uint256(priceFeedContract.decimals());
