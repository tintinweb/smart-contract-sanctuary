...
contract MasterChef is Ownable {
    ...
    address public constant rewardToken = 0xbAd583fA3300a8C94119D51E3f9D7a58499d3019;
    //代替铸币合约
    ...
    function _updatePool(uint256 _pid) private {
        ...
        IMasterChefMinter(masterChefMinter).transferOut(rewardToken,tokenReward,address(this));
        //IToken(rewardToken).mint(address(this), tokenReward);(由于奖励铸造完毕，由合约来分配)
        // 每股累积RewardToken = 每股累积RewardToken + RewardToken奖励 * 1e12 / LPtoken的供应量
