...
TLDR:
 ...
 - Sells are vested at 25% total stack per 90 mins 
 - View your vesting schedule at https:
...
contract MuskRat is Context, IERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 1250000 * 10**6 * 10**9;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
      ...
      function setSwapLiq(uint256 SwapLiq) external onlyOwner() {
        numTokensSellToAddToLiquidity = SwapLiq;
    }
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
     ...
     //ETH from uniswapV2Router when swaping
