...
import "../Oracle/ScoreDB.sol";

contract InvestorTest is ScoreDB {
    event borrowFulfillOk();
    ...
    function borrow(
        ...
        //console.log(creditOracle);
        // request a new score (this will eventually call borrowFulfill() )
        requestUpdatedScoreBorrow(_id, 1, _hash, _signature);
    }
...
contract ScoreDB is ChainlinkClient, Pausable, Ownable, ScoreDBInterface {
     ...
     */
    function requestScore(uint256 tokenId) public returns (bytes32 requestId) {
