...
contract Gambling is Context, VRFConsumerBase {
    ...
    uint immutable public N;
    uint immutable public minStake;
    address public owner;
    address public winner;
    address[] public playerAddress;
    mapping (address => bool) public playerReg;
    mapping (address => uint256) public playerStake;
    uint8 public gameStage = 0;
    ...
    function stake() public payable {
        require((playerStake[_msgSender()] + msg.value) >= minStake, "Insufficient stake amount");
        ...
        playerStake[_msgSender()] += msg.value;
    }
    ...
    function getRefund() public {
        ...
        payable(_msgSender()).transfer((playerStake[_msgSender()] - minStake));
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        winner = playerAddress[randomness%N];
