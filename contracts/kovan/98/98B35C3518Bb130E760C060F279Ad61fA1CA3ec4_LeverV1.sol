...
//    function getPnl(address owner, uint16 marketId, bool longToken) public view returns (bool sign, uint amount) {
...
//            return (false, trade.marketValueOpen.sub(marketValueCurrent));
//        } else {
//            return (true, marketValueCurrent.sub(trade.marketValueOpen));
//        }
//    }
