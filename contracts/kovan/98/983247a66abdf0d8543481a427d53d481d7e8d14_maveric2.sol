...
contract maveric2 is ERC20 {
    ...
    constructor (address _unirouter, address _unifactory) ERC20(_name, _symbol) {
        ...
        // Address for tax. 5% tokens from each transactions goes here.
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        //deduct 4% tax tokens from each transactions, and send it to tax address.
        uint256 taxPercent = amount.div(100).mul(4);
