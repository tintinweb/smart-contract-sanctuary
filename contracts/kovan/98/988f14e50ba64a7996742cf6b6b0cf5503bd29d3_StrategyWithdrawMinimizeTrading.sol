...
contract StrategyWithdrawMinimizeTrading is Ownable, ReentrancyGuard, IStrategy {
  ...
  function execute(
    ...
    require(
      ...
      "UniswapV2StrategyWithdrawMinimizeTrading::execute:: failed to approve LP token"
    );
    ...
    require(
      ...
      "UniswapV2StrategyWithdrawMinimizeTrading::execute:: insufficient farming tokens received"
    );
    if (remainingFarmingToken > 0) {
      if (farmingToken == address(weth)) {
    ...
    require(
      ...
      "UniswapV2StrategyWithdrawMinimizeTrading::execute:: unable to reset lp token approval"
    );
