...
interface IReBakedDAO {
	...
	*/
	function getMgp(bytes32 projectId_, bytes32 packageId_) external returns(uint256 amount_);
    ...
    * @return amount_ mgp amount paid
	*/
	function getMgps(bytes32 projectId_, bytes32[] memory packageIds_) external returns(uint256 amount_);
	...
	*/
	function getBonus(bytes32 projectId_, bytes32 packageId_) external returns(uint256 amount_);
    ...
    * @return amount_ bonus amount paid
	*/
	function getBonuses(bytes32 projectId_, bytes32[] memory packageIds_) external returns(uint256 amount_);
