...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require(msg.sender == minter); //ensures the minter is minting
        require(supply+amount <= MAXSUPPLY);//ensures that the new supply wont exceed maxsupply
    ...
    function transferMintership(address newMinter) public returns (bool) {
        ...
        require(msg.sender == minter); //make sure that the incumbent is transferring
        minter = newMinter;
