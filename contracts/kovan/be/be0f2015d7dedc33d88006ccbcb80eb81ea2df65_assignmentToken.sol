...
contract assignmentToken {
    ...
    // to do sepficy fee for each transfer
    ...
    // to do: specify eve,t transfer of mintership
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        // NOTE: total supply must not exceed `MAXSUPPLY` (1000000)
    ...
    function burn(uint256 amount) public returns (bool) {
        // TODO: burn tokens by sending tokens to `address(0)` so function tranfer to address 0 = burn
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
           //require(_value > 1)
        require(_value <= balances[msg.sender], "not sufficent balance");
        require (fee <= _value);
    ...
    function transferFrom(address _from,address _to,uint256 _value) public returns (bool) {
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require (_value<= balances[_from], "not sufficent tokens");
        require (allowances[_from][msg.sender]>=_value, "insufficent allowances");
        require (fee<=_value);
