...
// File: contracts/CreatoRoyaltyRegistry.sol
 ...
 * @title IERC1155 Non-Fungible Token Creator basic interface
 */
contract CreatoRoyaltyRegistry is Ownable, ICreatoRoyaltyRegistry {
    ...
    function setPercentageForTokenRoyalty(
        ...
        require(
            ...
            msg.sender == owner() ||
            msg.sender == creato,
            "setPercentageForTokenRoyalty::Must be contract owner or creator or creato"
        );
        require(
            _percentage <= 100,
    ...
    function restore(address _oldAddress, address _oldCreatoAddress, uint256 _startIndex, uint256 _endIndex) external onlyOwner {
        CreatoRoyaltyRegistry oldContract = CreatoRoyaltyRegistry(_oldAddress);
