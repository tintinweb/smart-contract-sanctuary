...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xa61C7b04a4dB693ADc2A7E5c6e902b31b788C44c); // BOO 0xa61c7b04a4db693adc2a7e5c6e902b31b788c44c
    ...
    uint256 public minPeriod = 1 hours; // originally 1 hours 
    ...
    constructor (address _router) {
        ...
        : IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //uniswap kovan router 
        _token = msg.sender;
    }
...
contract LoliPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xa61C7b04a4dB693ADc2A7E5c6e902b31b788C44c; // BOO
    address public DAI = 0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD; // DAI 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "LoliPrinter";
    string constant _symbol = "LOLIPOP";
    ...
    uint256 totalFee = 1100; // 11% Fee
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0x8CA25F2feEdc5D258E581BA1e1c771dC1f8EDb67; //liq address
    address public marketingFeeReceiver=0x51DB2Ad2E7eDBcD2143F3C0DCf399Efd863172ea; // marketing address
    ...
    constructor () Auth(msg.sender) {
        address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // kovan uniswap router 
        router = IUniswapV2Router(_router);
        pair = IUniswapV2Factory(router.factory()).createPair(DAI, address(this));
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // kovan router 
