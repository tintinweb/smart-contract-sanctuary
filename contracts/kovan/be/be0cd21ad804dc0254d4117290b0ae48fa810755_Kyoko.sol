    ...
    AccessControlEnumerableUpgradeable
{
    ...
    bytes32 public constant ROLE_TRANSFER_FEE_MANAGER =
        keccak256("ROLE_TRANSFER_FEE_MANAGER");
    ...
    modifier onlyTransferFeeManager() {
        require(
            hasRole(ROLE_TRANSFER_FEE_MANAGER, _msgSender()),
            "only the transfer fee manager perform this operation."
        );
        _;
    }
    ...
    function transferFee(address asset, address to, uint256 amount) public onlyTransferFeeManager {
