...
contract OceanToken is ERC20, Ownable {
    ...
    constructor(
        ...
        hodlRewardDistributor = new HODLRewardsDistributor(wfuse_);

        hodlRewardDistributor.excludeFromRewards(wfusePair);
        hodlRewardDistributor.excludeFromRewards(swapRouter_);
...
interface IOceanToken {
    ...
    function wfuse() external returns(address);
...
contract SwapHandler is Ownable {
    ...
    constructor (address wfuse_,address swapRouter_) {
