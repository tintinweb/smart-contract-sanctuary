...
contract TestInsurance {
    ...
    constructor(address token, address priceConverter) public {
        ...
        basketCoins = ['BTC', 'ETH', 'BNB', 'SOL', 'ADA', 'XRP', 'LINK', 'DOT', 'AVAX', 'DOGE'];
...
//      basket["LUNA"] = 1894;
        ...
        */
        ...
        priceFeed["LINK/ETH"] = AggregatorV3Interface(0x91E9331556ED76C9393055719986409e11b56f73);
    ...
    function getXUsdPrice(string memory coin) internal view returns (int) {
        if (
            ...
            (,int linkToEth,,,) = priceFeed["LINK/ETH"].latestRoundData();
...
contract Token is Context, ERC20 {
     ...
     */
    constructor () public ERC20("Testing", "EDT") {
    ...
    function burn(address account, uint amount) external {
        require(msg.sender == owner, "Permission required");
