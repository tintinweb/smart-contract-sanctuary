...
contract CreateFreezer {
    ...
    event CreatedFreezer(
        address indexed DeepFreezeOwner,
        DeepFreeze indexed DeepFreezeAddress
    );
    ...
    function createFreezer(string memory _hint, bytes32 _answer) public {
        ...
        emit CreatedFreezer(msg.sender, new_freezer_address);
    }
}