...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accRewardPerShare; // Accumulated mgts per share, times 1e12. See below.
    }

    // Reward TOKEN!
    address public rewardToken=0x641846EA5D0cC18EB040F424961558E184762ce7;
    //收入统计合约 
    address public constant incomePool = 0xA2E76e05686561AFaeCd58F2fEf73904f2c7F5DB;
    ...
    function _updatePool(uint256 _pid) private {
        ...
        uint256 rewardAmount = multiplier.mul(rewardPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        if (rewardAmount>0){
          IToken(rewardToken).mint(address(this), rewardAmount);
        }
    ...
    function setBlockReward(uint256 _rewardPerBlock) public  onlyOwner{
