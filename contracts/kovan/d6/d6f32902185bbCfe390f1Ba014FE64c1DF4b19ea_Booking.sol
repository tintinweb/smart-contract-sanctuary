...
contract Booking is Ownable {
    ...
    address address_guia = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    uint256 amount = 100000000000000000000; //USD
    string Excursion_ID = "25456465422135";
    uint256 Delta = 2; //Days to excursion to be further calculated
    address owner_Lati;
    address owner_admin;
    ...
    function book_excursion(
        ...
        History[_Excursion_ID].Guide = address_guia;
        ...
        History[_Excursion_ID].Delta_toExcursion = Delta * 1 days; //Coming from site
