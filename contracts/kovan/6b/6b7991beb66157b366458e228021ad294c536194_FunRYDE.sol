...
FunRYDE is built upon the fundamentals of Buyback and increasing the investor's value
...
contract FunRYDE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD289257a2eC27a7e832C427Ae6824243c6956A54); // Marketing Address
    ...
    string private _name = "FunRYDE";
    string private _symbol = "RYDE";
    ...
    uint256 public _buybackPercent =5;
    ...
    function buyBackTokens(uint256 amount) private lockTheSwap {
    	if (amount > 0) {
    	    swapETHForTokens(amount.mul(_buybackPercent).div(100));
	    }
    }
    ...
    function setBuybackPercent(uint256 buybackPercent) external onlyOwner {
