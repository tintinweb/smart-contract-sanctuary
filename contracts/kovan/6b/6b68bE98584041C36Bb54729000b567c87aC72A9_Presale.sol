...
contract Presale is Ownable {
    ...
    uint256 public tge = 50;
    uint256 public duration = 60 * 60 * 24 * 30 * 6;    // 6 months (180 days)

    constructor(address _kata, uint256 _startTime, uint256 _endTime) {
    ...
    function getClaimable() public view returns(uint256) {
        ...
        uint256 _tge = 100 - tge;
        uint256 unlockedPercent = _tge * timeElapsed / duration;
        unlockedPercent = unlockedPercent + tge;
    ...
    function setSalesTime(uint256 _startTime, uint256 _endTime) public onlyOwner {
    ...
    function setETHrange(uint256 _minETHAmount, uint256 _maxETHAmount) public {
    ...
    function setVesting(uint256 _tge, uint256 _duration) public {
        tge = _tge;
        duration = _duration;
    }
}
