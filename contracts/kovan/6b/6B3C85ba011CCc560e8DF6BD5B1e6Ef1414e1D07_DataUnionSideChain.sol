...
contract DataUnionSideChain is IERC677Receiver{
    ...
    function transferToMemberInContract(address recipient, uint amount) public {
        ...
        require(IERC20(tokenAddress).transferFrom(msg.sender, address(this), amount), "error_transfer");
    ...
    function withdrawAll(address member, bool sendToMainnet) external returns (uint256){
        ...
        IERC20(tokenAddress).transfer(member, amount);
        return amount;
    }
