...
import '@uniswap/v2-core/contracts/interfaces/IMaticFactory.sol';
import '@uniswap/lib/contracts/libraries/TransferHelper.sol';

import './interfaces/IMaticRouter02.sol';
import './libraries/MaticLibrary.sol';
...
import '@uniswap/v2-core/contracts/interfaces/IMaticPair.sol';
...
library MaticLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'a9951b47fa4e8575cf344d078398cb664d9651be0f30d2cafa09e0ef04fda9ad' // init code hash
            ))));
    }
