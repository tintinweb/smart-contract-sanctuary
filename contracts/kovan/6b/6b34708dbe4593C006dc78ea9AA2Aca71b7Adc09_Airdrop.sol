...
abstract contract LockSmartContract {
    function depositToken(address likeAddr, uint amount, uint256 expire) public virtual  returns (bool);
    function requestWithdraw(address likeAddr) public virtual  returns (bool);
    function withdrawToken(address likeAddr, uint amount) public virtual  returns (bool);
    function getLock(address likeAddr, address _sender) public view  virtual returns (uint256);
    function getWithdraw(address likeAddr, address _sender) public view virtual  returns (uint8);
    function getAmount(address likeAddr, address _sender) public view virtual  returns (uint256);
    function getDepositTime(address likeAddr, address _sender) public view virtual returns (uint256);
    function getActiveLock(address likeAddr) public view virtual  returns (uint256);
}

abstract contract LBankInterface {
    function totalLIKE() public view virtual returns (uint256);
}
abstract contract Loan {
    function contractLoans(address _borrower) public view virtual returns (address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint8);
}
...
contract Airdrop is Ownable{
   ...
   struct expire {
    ...
    function getLBank(address _addr, address lock) public returns (uint256) {
