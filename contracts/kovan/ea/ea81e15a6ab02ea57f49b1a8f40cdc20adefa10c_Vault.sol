...
contract Vault is IVault, PausableUpgradeable, AccessControlEnumerableUpgradeable, IKeeper {
    ...
    // Keeper Compatible Items for Daily Rebasing:
    uint public interval; // Daily rebasing interval with 1 = 1 second
    ...
    function checkUpkeep(bytes calldata checkData) external override returns (bool upkeepNeeded, bytes memory performData) {
        uint untilKeepNeeded = block.timestamp - lastTimeStamp;
