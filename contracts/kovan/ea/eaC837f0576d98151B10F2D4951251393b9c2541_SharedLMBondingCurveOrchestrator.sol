...
contract SharedLMBondingCurveOrchestrator is ISharedLMBondingCurveOrchestrator {
    ...
    function init(
        ...
        public
        override
        returns (address liquidityMakerBondingCurve)
    {
        uint256[] memory ratios = new uint256[](1);
        ratios[0] = SPLITTER_GRANULARITY; // 100% to the erc20UniswapPCVDeposit
        address[] memory allocations = new address[](1);
        allocations[0] = address(erc20UniswapPCVDeposit);
        liquidityMakerBondingCurve = address(
            new ERC20LiquidityMakerBondingCurve(
                core,
                allocations,
                ratios,
