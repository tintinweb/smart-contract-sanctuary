...
contract Lottery is VRFConsumerBase, Ownable{
    ...
    constructor(address _vrfCoordinator, address _link, bytes32 _keyHash, address _asset) 
        VRFConsumerBase(
            _vrfCoordinator,
            _link
        )
        ...
        KeyHash = _keyHash;
        asset = ERC20(_asset); // ASSET
    }

    function enter() public {
        require(lotteryState == LOTTERY_STATE.OPEN, "Can't end lottery yet");
        asset.transferFrom(address(msg.sender), address(this), 1000000000000000000); // 1 DAI
