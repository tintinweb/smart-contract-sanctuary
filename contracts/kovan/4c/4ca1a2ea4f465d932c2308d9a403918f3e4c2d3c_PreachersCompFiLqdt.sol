...
/**********************************************************
 * Main Contract: PreachersCompFiLqdt v1.0.9 AL
 **********************************************************/
...
contract PreachersCompFiLqdt {
    ...
    ****************************************************************************/
    ...
    function executeKyberSwap( address SrcToken, uint256 srcQty, address DestToken, 
        ...
        // emit KyberSwapETH( destAddress, SrcToken, srcQty, DestToken, maxDestAmount);
        ...
        emit DebugLineNo( uiLineNo );
        emit ExpectedRate( minConversionRate );
