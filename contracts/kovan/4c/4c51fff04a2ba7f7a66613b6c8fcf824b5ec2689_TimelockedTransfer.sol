...
contract TimelockedTransfer is Context {
	...
	function queueSend(address _sender, address _reciever, uint256 _amountSent, uint256 _delay) public {
		...
		require(isWaitingForTransfer[_reciever] = false, "TimelockedTransfer: reciever already waiting for a transaction"); //sending a 2nd transaction to the same address would result in a loss of funds
