...
contract RaribleToken is Ownable, SignerRole, ERC1155Base {
    ...
    function simpleMint(uint256 id, Fee[] memory fees, uint256 supply, string memory uri) public {
        _mint(id, fees, supply, uri);
    }
}
...
contract RaribleUserToken is RaribleToken {
    ...
    constructor() RaribleToken("para", "LL", 0xbd0F4E7d13EA1A395ADA33A75C80A12f8f3999F0, "https://test.com", "ipfs:/") public {
        emit CreateERC1155_v1(msg.sender, "para", "LL");
    }
