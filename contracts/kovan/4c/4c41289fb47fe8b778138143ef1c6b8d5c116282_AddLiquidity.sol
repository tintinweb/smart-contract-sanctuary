...
library AddLiquidity {
    ...
    function swapDeposit0(
        ...
        uint256 amount0In = 0; // ITwapPair(pair).getDepositAmount0In(amount0, priceAccumulator, orderTimestamp);
    ...
    function swapDeposit1(
        ...
        uint256 amount1In = 0; // ITwapPair(pair).getDepositAmount1In(amount1, priceAccumulator, orderTimestamp);
