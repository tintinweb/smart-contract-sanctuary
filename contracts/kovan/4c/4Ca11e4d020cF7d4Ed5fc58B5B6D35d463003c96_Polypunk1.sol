...
contract Polypunk1 is IERC721 {
    ...
    uint256 private mintPrice = 100000000000000;
    ...
    constructor(address payable _marketer, address payable _developer,address payable _deployer, string memory _imageHash) {
    ...
    function mint(uint256 numberOfNfts) external payable reentrancyGuard {
        ...
        uint256 boxPrice = getLatestPrice();
