...
contract LiquidityExamples is IERC721Receiver {
        ...
        )
    {
        ...
        TransferHelper.safeTransferFrom(TOKEN1, msg.sender, address(this), amount0ToMint);
        TransferHelper.safeTransferFrom(TOKEN2, msg.sender, address(this), amount1ToMint);

        // Approve the position manager
        TransferHelper.safeApprove(TOKEN1, address(nonfungiblePositionManager), amount0ToMint);
        TransferHelper.safeApprove(TOKEN2, address(nonfungiblePositionManager), amount1ToMint);
        ...
        if (amount1 < amount1ToMint) {
            TransferHelper.safeApprove(TOKEN2, address(nonfungiblePositionManager), 0);
            uint256 refund1 = amount1ToMint - amount1;
            TransferHelper.safeTransfer(TOKEN2, msg.sender, refund1);
        }
    }
