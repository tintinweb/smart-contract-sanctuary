...
contract CowBlah is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "CowBlah";
    string private constant _symbol = "COWBLAH";
    ...
    function _reflectFee(uint256 rFee, uint256 tDynamic) private {
        ...
        _tFeeTotal = _tFeeTotal.add(tDynamic.sub(tDynamicOneThird));
    }
