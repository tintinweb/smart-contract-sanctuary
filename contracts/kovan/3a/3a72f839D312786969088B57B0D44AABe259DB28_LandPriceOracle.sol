...
contract LandPriceOracle is ChainlinkClient, Ownable {
    ...
    function OilpricePerEth() public returns (uint256) {
        requestLandData();
        uint256 ManaETHPrice = getLatestManaPrice();
        return landPriceInMana * ManaETHPrice;
    }

    function requestLandData() public returns (bytes32 requestId) {
    ...
    // function LandIndexInMana() public onlyOwner view returns (uint256) {
    //     return index;
    // }
}
