...
contract CitadelStrategyKovan is Ownable {
    ...
    function _getLPTokenPrice() private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 _dpiPrice = _getTokenPriceFromChainlink(0x22B58f1EbEDfCA50feF632bD73368b2FdA96D541); // DPI/ETH
        uint256 _daiPrice = _getTokenPriceFromChainlink(0x22B58f1EbEDfCA50feF632bD73368b2FdA96D541); // DAI/ETH
