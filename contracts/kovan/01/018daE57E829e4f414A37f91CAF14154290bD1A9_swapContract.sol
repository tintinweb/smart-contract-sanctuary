...
contract swapContract is AccessControlEnumerable, Pausable, ECDSAOffsetRecovery
{
    ...
    ) external whenNotPaused
    {
        ...
        address validatorAddress = ecOffsetRecover(hashedParams, signature, SIGNATURE_LENGTH);
        ...
        TransferHelper.safeTransfer(address(xdceAddress), signedAddress, xdceAmountNew);
