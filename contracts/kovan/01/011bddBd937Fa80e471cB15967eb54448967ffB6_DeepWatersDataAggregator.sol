...
contract DeepWatersDataAggregator is IDeepWatersDataAggregator {
    ...
    **/
    ...
    /**
    * @dev get the user total collateral balance, borrow balance and the health factor
    * @param _user the address of the user
    * @return total collateral balance, borrow balance, collateral ratio and the health factor of the user
    **/
    function getUserData(address _user)
        public
        view
