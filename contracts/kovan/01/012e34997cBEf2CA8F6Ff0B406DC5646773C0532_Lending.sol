...
contract Lending is ILending {
    ...
    uint public compoundBorrowLimit = 80;
    ...
    function setCompoundBorrowLimit(uint _limit) external onlyAdmin {
        compoundBorrowLimit = _limit;
    }
    ...
    function createLoan(uint platformIndex, address borrowToken, uint borrowAmount) external override{
        ...
        if (platformIndex == 1) {
            ...
            require(borrowAmount <= availableBorrowAmount * compoundBorrowLimit / 100, "LENDING: Borrow more than collateral");
    ...
    function getBorrowableAmount(uint platformIndex, address borrowToken) override external view returns (uint availableBorrowAmount) {
        ...
        if (platformIndex == 2) {
            ...
            return _getCompoundAvailableBorrowAmount(borrowToken, false) * compoundBorrowLimit / 100;
        }
    }
