...
contract ExchangeRateMechanism is Ownable, ReentrancyGuard {
    ...
    function stabilizeExchangeRate() external nonReentrant {
        require(msg.sender == address(usdh) || msg.sender == owner(), "Only owner and USDH can stabilize");
