...
*/
contract Vault {
    using SafeERC20 for IERC20; // TODO: use safeIncreaseAllowance
    using FixedPoint for FixedPoint.Unsigned;
    ...
    */
    function deposit(
        ...
        require(USDC.allowance(msg.sender, address(this)) >= amount, "INSUFFICIENT_APPROVAL");
        ...
        USDC.safeTransferFrom(msg.sender, address(this), mintUSDC + longValue + shortValue);
        ...
        /**
        Have to split to save stack space, so this doesn't fully follow checks + effects + interactions pattern. Don't
        call this contract if you don't trust the LSP's collateralToken (should be USDC) or the staking contracts.
        // TODO: reentrancy check for CIP
        */
        ...
        { // pool and stake the long tokens.
            ...
            address recipient = address(longStaking) == address(0) ? msg.sender : address(this);
            router.addLiquidity(
                address(long),
                address(USDC),
                tokensToMint,
        ...
        { // pool and stake short tokens
            ...
            address recipient = address(shortStaking) == address(0) ? msg.sender : address(this);
            router.addLiquidity(
                address(short),
                address(USDC),
                tokensToMint,
    ...
    */
    ...
    ///@notice an EIP-712 signature for use with Uniswap permits
    struct Signature {
        uint8 v;
        bytes32 r;
        bytes32 s;
    ...
    */
    function withdraw(
        ...
        IERC20 USDC = lsp.collateralToken(); // TODO: make sure user can't enter invalid withdrawmode and strand USDC
