 ...
 mapping (address => mapping(address => uint)) public allowances;
  ...
  return balances[_owner];
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require(supply + amount < MAXSUPPLY,"Amount exceeding maximum allowed");
        require(msg.sender == minter,"You are not allowed to do this");
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(balances[msg.sender] >= amount, "Amount to burn Exceeding balance");
        supply -= amount;
    ...
    function transferFrom(
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require(_value+1<=balances[msg.sender], "Amount exceeding balance or cannotcover fee");
