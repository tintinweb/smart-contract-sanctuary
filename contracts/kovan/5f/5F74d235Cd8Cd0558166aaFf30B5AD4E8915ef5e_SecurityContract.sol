...
contract SecurityContract is Ownable {
  ...
  function executeBot(
    ...
    require(maxGasPrice >= gasPrice, "Transaction gas price is more than user specified");
    require(
      user ==
        recoverSigner(
          asset,
      ...
      "user is not signer of signature"
    );
    ...
    (bool feeTransferred, ) = payable(msg.sender).call{
      value: gasPrice * (gasLeftBefore - gasLeftAfter + 50000)
    }("");
  ...
  function example() public payable onlyOwner {
