...
contract Maastricht is ERC20("Jarvis Synthetic Franc", "jFRF") {
    ...
    function wrap(uint256 _amount) public {
        uint256 amountTokens = _amount.mul(rate).div(1e18);
    ...
    function unwrap(uint256 _amount) public {
        ...
        uint256 ratio = _amount.mul(1e18).div(balanceOf(msg.sender));
        uint256 amountTokens = userFunds[msg.sender].mul(ratio).div(1e18);
