...
contract APIFlight is ChainlinkClient {
    ...
    /**
     * Network: Kovan (FlightAware API)
     * Oracle: 0x2f90A6D021db21e1B2A077c5a37B3C7E75D15b7e
     * Job ID: a644d4e30977459d9a596bef89c09e71
     * Fee: 0.1 LINK
     */
    constructor() {
     ...
     */
    function requestFlight(string memory _flight, uint256 _departure) public {
        Chainlink.Request memory request = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);

        request.add("flight", _flight);
        request.addUint("departure", _departure);
