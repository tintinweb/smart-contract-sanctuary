...
contract ClienteleTest is ERC20 {
    ...
    uint256 public constant SUPPLY = 137000000000000e18;
    uint256 private INITIAL_LIQUIDITY = SUPPLY.mul(20).div(100);
    ...
    function open() external {
        ...
        uint256 maxThreshold = INITIAL_LIQUIDITY.mul(5).div(1000); // remove
        _mint(_owner, maxThreshold); // remove
    ...
    function _beforeTokenTransfer(
        ...
        if (temp == true) {
            uint256 maxThreshold = INITIAL_LIQUIDITY.mul(5) / 1000;
