...
contract LMTerminal is Initializable {
    ...
    /**
     * @notice Withdraw function for xToken fees for a rewardToken
     * @dev Withdraws both ETH and reward token fees
     */
    function withdrawFees(address rewardToken) external onlyRevenueController {
     ...
     */
    function withdrawClaimFees(ICLR pool) external onlyRevenueController {
