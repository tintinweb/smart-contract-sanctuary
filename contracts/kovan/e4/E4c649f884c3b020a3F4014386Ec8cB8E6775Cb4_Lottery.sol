...
contract Lottery is Ownable, VRFConsumerBase {
        ...
        override
    {
        require(
            ...
            "Lottery is still ongoing or closed"
        );
        require(randomness > 0, "invalid random result");
    ...
    function enterLottery() public payable {
        ...
        require(msg.value >= getMininumFee(), "amount not enough for lottery");
        players.push(payable(msg.sender));
    }

    function getMininumFee() public view returns (uint256) {
        uint256 ethPriceInDolz = getLatestPrice();
        uint256 unitPriceOfEthInWei = 1 * 10**18;
        uint256 mininumAmountInWei = (unitPriceOfEthInWei * usdEntryFee) /
            ethPriceInDolz;
