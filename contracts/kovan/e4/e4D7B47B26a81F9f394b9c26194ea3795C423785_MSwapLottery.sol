 ...
 */
contract MSwapLottery is ReentrancyGuard, IMSwapLottery, Ownable {
        ...
        nonReentrant
    {
        ...
        uint32 finalNumber = uint32(1000000 + getRandomNumber());
  ...
  function getRandomNumber() internal view returns(uint256){
    ...
    return uint256(keccak256(abi.encodePacked(groupBlockHash))) % 1000000;
  }
