...
contract Portal is OwnableUpgradeable,CacheResolverUpgradeable {
    ...
    function withdrow(address player, uint value, bool withdrawall) public {
        ...
        require(_removeRegisterPortalLock(player, balancesLockedAmount, escrowedLockedAmount, value, withdrawall) == true, "FAIL TO CALL");
    ...
    function _remaininigAvailaleAmount(address account) public view returns (
