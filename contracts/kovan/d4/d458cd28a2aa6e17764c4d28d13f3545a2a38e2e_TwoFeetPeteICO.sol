...
// File: contracts\TwoFeetPete-ICO.sol
...
contract TwoFeetPeteICO is Ownable {
    ...
    function confirmPresale() external onlyOwner{
        require(!_isSettingConfirmed, "Presale Config is already defined!");
    ...
    function tokenTotalSupply() public view returns(uint256){
        require(_isSettingConfirmed, "Presale Config is not setted yet!");
    ...
    function softHardCap() public view returns(uint256, uint256){
        require(_isSettingConfirmed, "Presale Config is not setted yet!");
    ...
    function minMaxContribution() public view returns(uint256, uint256){
        require(_isSettingConfirmed, "Presale Config is not setted yet!");
        return (_minContribution, _maxContribution);
    }

    function presaleStartEndTime() public view returns(uint256, uint256){
        require(_isSettingConfirmed, "Presale Config is not setted yet!");
        return (_startPresaleTime, _endPresaleTime);
    }
    ...
    function addLiquidityAndShareDesposite() external _validateClaimTokenAndSale() onlyOwner{
        ...
        payable(_feePresaleManagerAddress).transfer(feePresaleManager);        
        payable(_feeTokenOwnerAddress).transfer(feeTokenOwner);      
