    ...
    BumperAccessControl
{
    ...
    ///@notice Withdraws USDC from yearn vault, send to address and burn yUSDC tokens
    ///@param receiver Recipient's address.
    ///@param _amount Amount of yUSDC tokens you want to burn
    ///@return Returns the amount of USDC redeemed.
    function withdrawUSDCFromYearnVaultToAddress(address receiver, uint256 _amount)
        external
        virtual
        onlyGovernance
        returns (uint256)
    {
        ...
        emit TransferUsdc(receiver, tokensWithdrawn);
