...
contract CdaiAdapter is AdapterBase {
    ...
    function supplyErc20ToCompound(uint256 amount) external {
    ...
    event ExchangeRate(string, uint256 exchangeRateMantissa);

    function findExchangeRate(address cErc20Contract) external {
        ICErc20 cToken = ICErc20(cErc20Contract);
        uint256 exchangeRateMantissa = cToken.exchangeRateCurrent();
        emit ExchangeRate("Exchange Rate (scaled up):", exchangeRateMantissa);
    }
