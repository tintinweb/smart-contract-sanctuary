...
interface IMediaEyeSubRecieverMed {
    function subscribeLevelOneFromHomeRelay(
        address account,
...
contract MediaEyeHomeMediator {
    ...
    function subscribeLevelOne(
        ...
        bytes4 methodSelector = IMediaEyeSubRecieverMed(address(0))
            .subscribeLevelOneFromHomeRelay
            .selector;
        // bytes4 methodSelector = IMediaEyeSubscription(address(0)).subscribeLevelOneByBridge.selector;
