...
contract DynamicConsumer is ChainlinkClient {
    ...
    mapping(address => string) public minterToNFT;
    ...
    function requestVolumeData() public returns (bytes32 requestId)
    {
        ...
        request.add("get", "https://organicziplab.com/api/generate");
