...
contract RibbonThetaVaultYearn is DSMath, OptionsVaultStorage {
    ...
    function _withdraw(uint256 share, bool unwrap) private returns (uint256) {
        ...
        console.log("amountAfterFee is %s", amountAfterFee);
        console.log("feeAmount is %s", feeAmount);
    ...
    function rollToNextOption() external onlyManager nonReentrant {
        ...
        console.log("currentBalance is %s", currentBalance);
        console.log("locked amount is %s", lockedAmount);
        console.log("pricePerShare is %s", collateralToken.pricePerShare());
