...
contract NFTMarket is IMarket, ReentrancyGuard, TwoStageOwnable, ChainlinkClient {
    ...
    function initialize(address market) external whenNotStopped onlyOperator returns (bool) {
    ...
    function migrateTo(address market) external onlyOperator returns (bool) {
