...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 ethDol = uint256(price) * (10**10); // 18 decimals
        // 50, 2000/ ETH
        // 50/2000
        // 50 * 1000... / 2000
        uint256 costToEnter = (usdMinimum * (10**18)) / ethDol;
        return costToEnter;
    }
    ...
    function startLottery() public onlyOwner {
        require(
            lottery_state == LOTTERY_STATE.CLOSED,
            "Cant't start a new lottery yet!"
        );
    ...
    function endLottery() public onlyOwner {
        ...
        //                 block.difficulty, // can actually be manipulated by de miners!
