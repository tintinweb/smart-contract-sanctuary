...
/*
   ...
   #SpaceMonkey - Skill based P2E gaming. It's bananas! B-A-N-A-N-A-S!:
   3% fee is taken to market the project!
   3% fee is held in trust, to provide further gaming rewards!
...
contract SpaceMonkey is Context, IERC20, Ownable {
    ...
    string private _name = "Space Monkey";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the BNB -> MONKE swap when swap+liquify is triggered
