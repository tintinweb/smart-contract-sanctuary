...
/**
 * @title Royal Token
 * @dev Royal ERC20 Token
 */
contract RoyaleToken is ERC20Permit, Ownable {
    uint256 public constant MAX_CAP = 72 * (10**6) * (10**18); // 100 million
     ...
     * Owner is assumed to be governance or Royal trusted party for helping users
