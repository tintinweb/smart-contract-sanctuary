    ...
    function claimAll() public {
        ...
        for(i = 0 ; i < arrayId.length ; i++){
            ...
            if(lockTokensClaimed[_lockId] == false && now >= (lockInfo._timestamp + lockingPeriodHere)){
                ...
                // uint256 element = unclaimedLockIdByUsers[msg.sender][i];
                unclaimedLockIdByUsers[msg.sender][i] = unclaimedLockIdByUsers[msg.sender][unclaimedLockIdByUsers[msg.sender].length - 1];
                delete unclaimedLockIdByUsers[msg.sender][unclaimedLockIdByUsers[msg.sender].length - 1];
                unclaimedLockIdByUsers[msg.sender].pop();
