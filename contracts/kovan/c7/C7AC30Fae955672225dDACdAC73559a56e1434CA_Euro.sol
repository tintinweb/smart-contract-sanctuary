...
contract Euro is ERC20, Ownable {
    ...
    function mint(uint256 amount) public {
        ...
        uint256 euroAmount = amount.mul(10 ** feedDecimals).div(ratio);
    ...
    function burn(uint256 amount) public {
        ...
        // Get the EURO from customer
        IERC20(this).safeTransferFrom(address(this), msg.sender, amount);


        // Get the Ratio for the customer
        uint256 ratio = getLatestPrice();
        uint256 decimals = uint256(priceFeed.decimals());
        uint256 euroAmount = amount.mul(ratio).div(10 ** decimals);
    ...
    function inCaseTokensAreStuck(address token, address to) public onlyOwner {
