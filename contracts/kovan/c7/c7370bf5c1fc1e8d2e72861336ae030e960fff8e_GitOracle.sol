...
contract GitOracle is ChainlinkClient {
     ...
     *         ----------------------------------------------------------               *
     ************************************************************************************/
    function requestVolumeData(string memory repo, string memory repo_owner, string memory user_name) public returns (bytes32 requestId) 
    {
        Chainlink.Request memory request = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);
        
        // Set the URL to perform the GET request on
        request.add("get", append("http://oracle.gittoken.tech/github/get_commits?repo=", repo, "&repo_owner=", repo_owner, "&user=", user_name));
