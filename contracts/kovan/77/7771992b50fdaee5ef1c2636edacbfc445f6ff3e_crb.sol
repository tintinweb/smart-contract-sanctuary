...
// File contracts/tokens/deflationalAutoLP/UniswapV2/extensions/FeeToAddr/crb_constructed.sol


pragma solidity 0.8.4;
contract crb is FeeToAddrDeflAutoLPToken, AbstractBurnableDeflToken {
    constructor(
        string memory tName, 
        string memory tSymbol, 
        uint256 totalAmount,
