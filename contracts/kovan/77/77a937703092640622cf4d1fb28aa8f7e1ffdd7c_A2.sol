...
contract A2 is Context, IERC20, Ownable {
    ...
    // Token detalis.
    string private _name = 'o2';
    string private _symbol = 'o22';
    ...
    uint256 public burnRatePercents = 2;
    ...
    constructor (address router) public {
        ...
        // Social URL links.
        urlLinks memory socialUrlLinks;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256) {
        // tokens burn rate 2% for stacking/airdrops.
        uint256 tFee = tAmount.div(1000).mul(burnRatePercents);
