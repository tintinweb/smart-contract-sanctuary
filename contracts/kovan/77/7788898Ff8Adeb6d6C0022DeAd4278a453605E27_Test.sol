...
//           SafeERC20(0x13512979ADE267AB5100878E2e0f485B568328a4).approve(msg.sender, _amount);
           IERC20(_erc20Contract).safeApprove(msg.sender, _amount);
...
//           iLendingPool.deposit(_erc20Contract, _amount, msg.sender,0);
    ...
    function approve(address user,uint256 _amount) public returns(bool){
        IERC20(0x13512979ADE267AB5100878E2e0f485B568328a4).safeApprove(user, _amount);
        return true;
    }

//    function allowance(address user1,address user2) public view returns(bool){
//        SafeERC20(0x13512979ADE267AB5100878E2e0f485B568328a4).allowance(user1, user2);
//        return true;
//    }

//   function deposit(address _erc20Contract,uint256 _amount) public returns(bool success){
//       if(IERC20(_erc20Contract).allowance(address(this),msg.sender)< _amount){
//           IERC20(_erc20Contract).approve(msg.sender,_amount);
//       }
