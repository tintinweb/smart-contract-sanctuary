...
contract Arbitrage {
  ...
  address public bakeryFactory;
  uint constant deadline = 10 days;
  IUniswapV2Router02 public bakeryRouter;

  constructor(address _pancakeFactory, address _bakeryFactory, address _bakeryRouter) public {
    pancakeFactory = _pancakeFactory;  
    bakeryFactory = _bakeryFactory;  
  ...
  function pancakeCall(
    ...
    uint amountRequired = bakeryRouter.getAmountsOut(
      bakeryFactory,
      amountToken,
      path
    )[1];
