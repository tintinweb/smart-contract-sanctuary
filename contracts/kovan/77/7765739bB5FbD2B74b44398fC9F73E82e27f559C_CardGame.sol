...
contract CardGame is IERC721Receiver, Context, CardGameS1  {
    ...
    //初级版
    // 复合卡升级
    function reCombination(uint256 tokenIdA,uint256 tokenIdB,string memory tokenURI)public virtual {
     ...
     // 繁殖新生卡
     function reProduction(uint256 tokenIdA,uint256 tokenIdB,string memory tokenURI) public virtual{
