...
interface IStaking {
    function getStakedSafeBalance(address _sender) external view returns(uint256, uint256, uint256);
...
contract LessLibrary is Ownable {
        ...
        returns (uint256)
    {
        ...
        (balance, lastStakedTimestamp, ) = safeStakingPool.getStakedSafeBalance(
            sender
        );
