...
contract BitBTCL1BridgeOpImp is IL1ERC20Bridge {
  ...
  function _initOpBridge(address l1messenger_, address l2TokenBridge_) internal virtual {
...
contract BitBTCL1Bridge is UUPSUpgradeable, OwnableUpgradeable, BitBTCL1BridgeOpImp {
  ...
  function initOpBridge(address l1messenger_, address l2TokenBridge_) public {
    _initOpBridge(l1messenger_, l2TokenBridge_);
  }
