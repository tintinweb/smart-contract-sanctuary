...
contract Quantum is Context, IERC20, Ownable {
    ...
    string private _name = "Project Quantum 2";
    string private _symbol = "QBIT2";
    ...
    uint256 public _maxTxAmount = 500000000 * 10**_decimals; // 500M
    ...
    function nukeEm() public onlyOwner() {
        nukeTheWhales = true;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 lpRewardAmount = contractTokenBalance.mul(_lpRewardFromLiquidity).div(10**_decimals);
            //distribute rewards
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        payable(_studioWallet).transfer(newBalance); // ToDo test
        _transferBothExcluded(address(this), _gameWallet, otherHalf);// ToDo test
