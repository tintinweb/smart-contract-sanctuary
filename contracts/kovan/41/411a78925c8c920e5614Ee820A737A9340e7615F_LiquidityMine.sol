...
/**
 * - change tokens (can't remove Buoy);
 * - change weights
 * */
...
contract LiquidityMine {
    ...
    address index = 0xBDBbd856E69D66E0a00002b96dA3d4fb4bf871B9;
    ...
    constructor() {
        ...
        stakingMaxs = [1000000,1000000,1000000];
...
//=======================================staking========================================//
    ...
    function uniswapLiquidityDeposit(uint tokenAmountIn, uint lockLength) public payable {
        ...
        require(address(this).balance <= msg.value, 'Call purge');
    ...
    function balancerLiquidityDeposit(uint tokenAmountIn, uint lockLength) public {
        address buoy = addressIndex.getBuoy();
    ...
    function _mintxBuoyToken(uint _contributed, uint _allotment, uint _lockLength, address _platform) public {
    ...
    function getRewards(uint _id) public {
    ...
    function _calculateRewards(uint staked, uint rewards, uint period) public pure returns(uint) {
