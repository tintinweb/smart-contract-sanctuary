...
contract R34P is Context, IERC20, Ownable {
    ...
    uint256 private _minTokensBeforeSwap = 10000e9;
    ...
    string private _name = 'R34P54';
    string private _symbol = 'R34P54';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 0;
    uint256 private _burnFee = 30;
    uint256 private _liquidityFee = 20;
    uint256 private _maxTxAmount = 50000000e9;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(swappingInProgress){
            ...
            if (contractTokenBalance >= _maxTxAmount && _maxTxAmount >= _minTokensBeforeSwap) {
            ...
            _transferToExcluded(sender, address(this), liquidityFee);
    ...
    function updateMinTokensBeforeSwap(uint256 minTokensBeforeSwap) public onlyOwner {
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 1500e9 , 'maxTxAmount should be greater than 1500e8');
