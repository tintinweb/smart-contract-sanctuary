...
// File contracts/CappedMROwnableToken.sol
...
contract CappedMROwnableToken is ERC20Base, ERC20Capped, ERC20Mintable, ERC20Recoverable, FeeProcessor {
    constructor(
        string memory name,
        ...
        FeeProcessor(feeReceiver, "CappedMROwnableToken")
        payable {

        require(initialSupply > 0, "CappedMROwnableToken: initial supply cannot be zero");
