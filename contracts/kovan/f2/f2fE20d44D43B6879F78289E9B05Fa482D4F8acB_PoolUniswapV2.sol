...
contract PoolUniswapV2 {
    address public uniTokenAddress;
    ...
    constructor() public {
        ...
        uniToken = IERC20(uniTokenAddress);
    ...
    function getUNIBalance() public view returns (uint256) {
    ...
    function swap() public {
        ...
        path[0] = uniTokenAddress;
        path[1] = wethTokenAddress;

        uint256 amount = uniToken.balanceOf(address(this));
        uniToken.approve(uniswapRouterAddress, amount);
