...
contract APIConsumer is ChainlinkClient, Ownable, TokenHolder {
    ...
    mapping(bytes32 => claimInfo) claimRecord;
    ...
    constructor(address _node) public Ownable() TokenHolder(_node) {
    ...
    function requestNFTClaim(
        ...
        // );
        req.add("get", "https://immense-mesa-34535.herokuapp.com/check/nft/0xcfdf8fffaa4dd7d777d448cf93dd01a45e97d782/LINK");
        req.add("path", "result");
        bytes32 requestId =
