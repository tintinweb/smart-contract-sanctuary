...
contract Staking is IERC721Receiver, Ownable, ReentrancyGuard {
    ...
    function stake(uint256 stakeAmount_) public nonReentrant returns (uint256) {
        ...
        uint256 nftTokenId = stakingNFT.mintToken(_msgSender(), _stakingErc20Address, _rewardErc20Address, stakeAmount_, _rewardPercent);
    ...
    function withdraw(uint256 nftTokenId_) public nonReentrant returns (bool) {
        ...
        stakingNFT.burnToken(nftTokenId_);
    ...
    function updateRewardPercent(uint16 rewardPercent_) public onlyOwner {
        require(rewardPercent_ > 0 && rewardPercent_ <= 10000, "Staking: Invalid rewardPercent");
...
interface IStakingNFT is IERC721 {
    ...
    function getStakeTokenData(uint256 tokenId_)
        ...
        returns (
            ...
            uint256 stakeAmount,
            uint16 rewardPercent,
            address stakeErc20TokenAddress,
    ...
    function mintToken(
        address addressTo_,
        address stakeErc20TokenAddress_,
