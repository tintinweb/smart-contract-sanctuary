...
contract Dog is ERC721URIStorage, Ownable {
    ...
    constructor() 
        ...
        _acceptedToken = ISuperToken(WETH);
    ...
    function issue(address newOwner, uint256 tokenId, uint256 amount, string memory tokenURI) external payable onlyMinterOrOwner {
