...
// hevm: flattened sources of src/OpynV2OTokenMock.sol
pragma solidity =0.6.7 >0.4.13 >=0.4.23;
...
contract OpynV2OTokenMock is OpynV2OTokenLike, DSToken {
    ...
    constructor(address _collateralAsset, address _underlyingAddress, address _strikeAsset, uint256 _strikePrice, uint256 _expiryTimestamp, bool _isPut) DSToken("oToken-TEST") public {
    ...
    function setCollateralAsset(address _collateralAsset) public ownerOnly {
        collateralAsset = _collateralAsset;
    }

    function setUnderlyingAsset(address _underlyingAsset) public ownerOnly {
    ...
    function getOtokenDetails() external view override returns (address, address, address, uint256, uint256, bool) {
