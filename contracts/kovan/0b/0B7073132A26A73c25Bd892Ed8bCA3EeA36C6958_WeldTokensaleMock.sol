...
import "../WeldTokensale.sol";

contract WeldTokensaleMock is WeldTokensale {
    ...
    function initializeMock(
        ...
        address _DAIToken,
        address WELD, 
         uint pre_start, uint pre_end, uint pub_start, 
        uint pub_end, uint withdrawal_period, uint pre_pool, uint public_pool, uint vest_duration) public initializer
    {
        this.initialize(_USDTToken, _USDCToken, _DAIToken, WELD, pre_start, pre_end, pub_start,
            pub_end, withdrawal_period, pre_pool, public_pool, vest_duration);
    }
...
contract WeldTokensale is OwnableUpgradeable, PausableUpgradeable {
    ...
    */
     ...
     */
    function adminSetVestingStart(uint256 _vestingStart) virtual public onlyOwner{
    ...
    function adminAddStageAndResetVestingStart(uint _start, uint _end, uint _pool, uint _vestingStart) public onlyOwner{
    ...
    */
    ...
    function adminAddWhitelist(address _user) virtual external onlyOwner {
        isWhitelisted[_user]=true;
    }

    function adminRemoveWhitelist(address _user) virtual external onlyOwner {
