...
contract GUMBY is ERC20, ERC20Burnable, Ownable, ERC20Pausable {
    constructor(
        ...
        _setTotalSupply(initialSupply); // 1 trillion 

        // sale to public
        uint256 icoTokens = 450000000000; // 5100000/1000000 =  four billion five hundred million.
        _initialTransfer(
            0xA9065B57fEC5B2A8F65e4522c04cb0E102134652,
            (icoTokens * decimalFactor)
        );
        // Friends,family and facilators
        uint256 foundCommTokens = 50000000000; // fifty billion
        _initialTransfer(
            0x848f3cFaE7196f60E8f09ae995B51B50c5ACB14e,
            (foundCommTokens * decimalFactor)
        );
        // Retain by developer
        uint256 reserveExTokens = 500000000000; // five hundred billion
        _initialTransfer(
