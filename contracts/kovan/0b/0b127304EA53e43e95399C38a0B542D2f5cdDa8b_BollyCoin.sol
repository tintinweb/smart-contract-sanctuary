...
contract BollyCoin is IBollycoin, Context {
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        _approve(msgSender(), spender, allowances[msgSender()][spender] + addedValue);
        return true;
    }
    ...
    function burn(uint256 amount) public virtual onlyGovernor returns (bool) {
        ...
        _beforeTokenTransfer(msgSender(), address(0), amount);
     ...
     *
     * `governors` can mint / burn bollycoins
     */
