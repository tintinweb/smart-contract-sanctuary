...
contract BaseContract {
    ...
    function createRequest (Req memory _req) public
    {
        ...
        newRequest.elementId=  _req.elementId;
        newRequest.elementValue= _req.elementValue;
        newRequest.attribute = _req.attribute;
        newRequest.quorum[address(0xb30C592b27c2198c9DaE167a8F348A798FB4260e)] = 1;
        emit NewRequest (
            newRequest.id,
            newRequest.url,
            newRequest.elementId,
            newRequest.elementValue,
            ...
            for(uint i = 0; i < totalOracleCount; i++){
                ...
                if(keccak256(a) == keccak256(b)){
                    ...
                    if(currentQuorum >= minQuorum){
                        currRequest.returnValue = _valueRetrieved;
                        emit UpdatedRequest (
                            currRequest.id,
                            currRequest.returnValue
                        );
                    }
                }
            }
