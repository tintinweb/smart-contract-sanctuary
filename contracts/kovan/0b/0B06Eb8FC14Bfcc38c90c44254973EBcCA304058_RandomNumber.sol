...
contract RandomNumber is VRFConsumerBase,Ownable {
     ...
     */
    function getRandomNumber(uint256 userProvidedSeed,address _poolAddress) external returns (bytes32 requestId) {
         _setPoolContract(_poolAddress);
         return requestRandomness(keyHash, fee, userProvidedSeed);
    }

    /**
    * Sets the pool contract address
    */
     
    function _setPoolContract(address _poolAddress) private onlyOwner {
