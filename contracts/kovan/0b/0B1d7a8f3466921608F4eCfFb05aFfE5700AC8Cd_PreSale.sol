...
contract PreSale is Context, ReentrancyGuard {
    ...
    /**
     * @dev returns the balance that are unclaimed.
     */
    ...
    function buyBollycoin() public payable virtual nonReentrant returns (bool) {
        ...
        _balances[msgSender()] += bollycoins;
    ...
    /**
     * @dev allows users to claim their bollycoins at a later stage.
     */
    function claim() public virtual nonReentrant returns (bool) {
        uint256 bollycoins = _balances[msgSender()];
        require(bollycoins > 0, "Error: purchase bollycoins to claim");

        _balances[msgSender()] = 0;
    ...
    /**
     * @dev sets the bollycoin token contract in future.
     */
    function setContract(address _tokenContract) public virtual onlyGovernor returns (bool) {
        bolly = IBollycoin(_tokenContract);
        return true;
    }
