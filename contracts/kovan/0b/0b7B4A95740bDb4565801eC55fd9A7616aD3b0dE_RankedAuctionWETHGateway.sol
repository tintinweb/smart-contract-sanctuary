 ...
 *
 *
 * @notice Simple gateway to allow bidding in Stake ranked auctions denominated in WETH using ETH.
 */
contract RankedAuctionWETHGateway is WETHGatewayBase {
    ...
    function bidWithEth(
        ...
        IRankedAuction(auction).bid(onBehalfOf, msg.value);
    }
}
...
interface IRankedAuction {
    function bid(address onBehalfOf, uint256 amount) external;
}
