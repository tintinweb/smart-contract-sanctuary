...
import "@openzeppelin/contracts/math/SafeMath.sol";
import "../../persistent/fund-value-calculator/IFundValueCalculator.sol";
...
contract FundValueCalculator is IFundValueCalculator {
    // TODO: take Synth finality into account? If not, add notes to file and functions as appropriate
        ...
        returns (address denominationAsset_, uint256 netValue_)
    {
        ...
        // Does not account for fee shares outstanding to the _sharesHolder
        // TODO: confirm we should use the final shares balance rather than prior shares balance
        netValue_ = ERC20(_vaultProxy).balanceOf(_sharesHolder).mul(netShareValue).div(
            SHARES_UNIT
        );
