...
contract Mappy is Context, IERC20, Ownable, Pausable {
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        uint256 antiDumpMultiplier = _getAntiDumpMultiplier();
    ...
    function _blockedBot(address account) public onlyOwner() {
    ...
    function _freeAccount(address account) public onlyOwner() {
