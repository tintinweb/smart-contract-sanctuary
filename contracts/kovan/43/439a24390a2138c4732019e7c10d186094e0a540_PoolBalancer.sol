...
contract PoolBalancer is IPoolBalancer, Timed, ControllerRef {
    ...
    function rebalance() public override nonContract whenNotPaused {
...
interface IPoolWrapper {
    ...
    function swapForRebalance() external;
}
...
interface IPoolBalancer {
    ...
    function transferToken(address token, address dst, uint256 amount) external;

    function transferEth(address dst, uint256 amount) external;
