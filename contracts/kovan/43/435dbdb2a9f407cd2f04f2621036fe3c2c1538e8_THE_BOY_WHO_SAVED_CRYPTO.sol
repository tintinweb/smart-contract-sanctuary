...
abstract contract ERC20 is IERC20 {
    uint256 internal constant _totalSupply = 1234567890e18;
    string _name;
    string _symbol;
...
abstract contract TradableErc20 is ERC20, Ownable {
    ...
    function _transfer(
        ...
        console.log("_transfer: ", from, "->", to);
        console.log("amount: ", amount);
        // get start balances
        uint256 startBalanceFrom = _balances[from];
        uint256 startBalanceTo = _balances[to];
        console.log("startBalanceFrom ", startBalanceFrom);
        console.log("startBalanceTo ", startBalanceTo);
        ...
        if (!_inSwap && uniswapV2Pair != address(0) && to == uniswapV2Pair) {
            ...
            uint256 lastContractBalance = contractBalance;
            ...
            if (contractBalance > 0) {
                ...
                uint256 maxSwapCount = amountTransfered;
                if (maxSwapCount > lastContractBalance)
                    swapCount = lastContractBalance;
                //if (maxSwapCount > (lastContractBalance) / 2)
                //    swapCount = (lastContractBalance) / 2;
            ...
            /*(uint256 r1, uint256 r2, uint256 ts) = IUniswapV2Pair(uniswapV2Pair)
                .getReserves();
            console.log("r1 ", r1);
            console.log("r2 ", r2);
            console.log("ts ", ts);*/
        ...
        emit Transfer(from, to, amount);
        console.log("simple transfer end");
    }
