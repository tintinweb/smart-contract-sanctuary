...
/**
 *Submitted for verification at hecoinfo.com on 2021-4-13
*/

/**
   #CatCoin
   
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #CAT  

    I make this #CAT to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/Catcoin_english
	Cat's official website will be www.catcoin.xyz, please wait and see.
   ...
   I will renounce the ownership to burn addresses to transfer #CAT to the community, make sure it's 100% safe.

   I will add 1 HT and all the left 49% total supply to the pool
   Can you make #CAT 100X? 
   ...
   it's the best part of the #CAT idea, increasing the liquidity pool automatically, 
