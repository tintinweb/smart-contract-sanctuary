...
//        lockPeriod = _lockPeriod;
    ...
    {
       uint256 lpFraction = amount.div(IERC20(lockToken).totalSupply());
       uint256 tokenIdx = 0;
       ...
       uint256 [] memory tokenAmounts = IEmiRouter(emiRouter).getAmountsOut(rsv, pathToStables);
       return tokenAmounts[tokenAmounts.length-1].mul(2).mul(lpFraction).div(10**tokenDec);
    }
