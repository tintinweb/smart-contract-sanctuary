...
contract DFToken is IERC20
{
    ...
    address _owner;
    uint256 _maxSupply= 88000000 * 1e18;
    ...
    mapping(address=>bool) public _pairMap; //DEX 收取手续费交易对地址
    address public poolOwner=0xE4608b078bF6456E6Fe2861AFD7E47073A5C5B02; //分红池地址
    uint256 public poolRatio=3; //分红池比率
    address public feeOwner=0x265c460Fa9c4E3503CEFA416dE6D59Fe3389872C; //平台手续费地址
    uint256 public feeRatio=3; //平台手续费比率
    address public partnerOwner=0xa19EC028853eB3024e0891eCf10892938F12d1ed; //合伙人地址
    ...
    {
         require(msg.sender==_owner,"Only the owner can perform the operation");
         _banneduser[account]=flag;
    }

    //设置地址
    function setOwners(address poolAddr,address feeAddr,address partnerAddr) public
    {
        require(msg.sender==_owner,"Only the owner can perform the operation");
        poolOwner=poolAddr;
        feeOwner=feeAddr;
   ...
   function increaseAllowance(address spender, uint256 addedValue) public  returns (bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(_banneduser[sender]==false,"sender is banned transfer");
  
        uint256 toamount = amount;
        if(_pairMap[recipient])
        {
