...
contract BasicDB_Kovan is Ownable {
    ...
    ILendingPool _lendingPool = ILendingPool(0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe);
...
//   // important to receive ETH
  receive() payable external {}
    ...
    function b2(address borrowAsset1, uint256 borrowAmt1,address borrowAsset2, uint256 borrowAmt2) public {
         borrow(_lendingPool, borrowAsset1, borrowAmt1);
         borrow(_lendingPool, borrowAsset2, borrowAmt2);
    }

    function depositDai(uint256 depositAmount) public {
        IERC20(kovanDai).approve(lendingPoolAddr, depositAmount);
        _lendingPool.deposit(kovanDai, depositAmount, address(this), uint16(0));
    }
    
    function borrow(ILendingPool _lendingPool, address _borrowAsset, uint256 _borrowAmt) public {
        _lendingPool.borrow(
            _borrowAsset, 
            _borrowAmt, 
            2, 
