...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = address(0x9510DA2498808CE304c5d78A91907D990B563cb5);
...
contract BullRock is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100000000000*10e7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BullRock";
    string private _symbol = "BLR";
    ...
    uint256 public _maxTxAmount = 100000000*10e7;
    uint256 private _numTokensSellToAddToLiquidity = 1000000*10e7;
    ...
    constructor () public {
        _rOwned[address(0x9510DA2498808CE304c5d78A91907D990B563cb5)] = _rTotal;
        ...
        emit Transfer(address(0), address(0x9510DA2498808CE304c5d78A91907D990B563cb5), _tTotal);
    }
    ...
    function _takeDevFee(address sender, uint256 tAmount) private {
		...
		if (_isExcluded[owner()]) {
			_tOwned[owner()] = _tOwned[owner()].add(tDevFee);
			_rOwned[owner()] = _rOwned[owner()].add(rDevFee);
		} else {
			_rOwned[owner()] = _rOwned[owner()].add(rDevFee);
		}
		emit Transfer(sender, owner(), tDevFee);
	}
    ...
    function burn(uint256 burningAmount) external onlyOwner {
