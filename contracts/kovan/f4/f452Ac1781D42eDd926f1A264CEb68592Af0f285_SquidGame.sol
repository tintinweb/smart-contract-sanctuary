...
contract SquidGame is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address payable private holderReflection = payable(0x70177c395dE3E3785a6997d46D47212C6b0BD51b);
    address payable private treasury = payable(0x70177c395dE3E3785a6997d46D47212C6b0BD51b);
    ...
    function openTrading() private onlyOwner {
    ...
    function removeBuyLimit() private onlyOwner {
        buyLimit = false;
    }
}