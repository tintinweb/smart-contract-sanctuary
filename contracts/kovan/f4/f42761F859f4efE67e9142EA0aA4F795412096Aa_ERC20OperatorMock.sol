...
import "../tokens/ERC20Operator.sol";
 ...
 */
contract ERC20OperatorMock is ERC20Operator {

    constructor (address recipient, uint256 amount) public {
 ...
 * At construction time, the deployer of the contract is the only burner.
 */
contract ERC20Operator is IERC20Operator, OperatorRole, ERC20 {
