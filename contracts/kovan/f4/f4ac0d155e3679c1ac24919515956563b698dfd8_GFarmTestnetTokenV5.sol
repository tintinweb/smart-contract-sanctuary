...
// File: contracts\GFarmTestnetTokenV5.sol



pragma solidity 0.8.7;

contract GFarmTestnetTokenV5 is ERC20, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");

    constructor() ERC20("Gains V2", "GFARM2") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _mint(msg.sender, 1000*1e18); // for AMM liquidity
    }

    function giveRoles(address tradingStorage, address trading, address callbacks, address pool, address vault) external{
    ...
    // Burn GFARM tokensradingV3 contract)
