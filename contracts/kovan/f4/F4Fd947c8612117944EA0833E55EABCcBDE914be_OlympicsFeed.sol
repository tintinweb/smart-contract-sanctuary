...
contract OlympicsFeed is ChainlinkClient {
    ...
    bytes32[3] public result;

    constructor() public {
        setPublicChainlinkToken();
        oracle = 0x56dd6586DB0D08c6Ce7B2f2805af28616E082455;
        jobId = "94fbeeb6292946729957b97a980dfec5";
     ...
     * Callback function
     */
    function fulfillOlympicsWinner(bytes32 _requestId, bytes32[3] memory _result) public recordChainlinkFulfillment(_requestId) {
        result = _result;
    }
