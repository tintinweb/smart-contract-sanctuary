...
contract StakingNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    event StakeTokenCreated(uint256 tokenId, uint256 startAt, uint256 stakeAmount, uint256 rewardPercent);
    ...
    constructor (
        ...
        require(minterAddress_ != address(0), "StakingNFT: Invalid minterAddress");
        ...
        returns (uint256)
    {
        ...
        require(_minterAddress == _msgSender(), "StakingNFT: Minter address does not match");
        ...
        emit StakeTokenCreated(tokenId, tokenData.startAt, tokenData.stakeAmount, tokenData.rewardPercent);
