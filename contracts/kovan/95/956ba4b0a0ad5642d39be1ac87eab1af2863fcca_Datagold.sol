...
contract Datagold is ERC20Interface, SafeMath{
   ...
   // datagold coins
    ...
    mapping(uint => address) listingDatasetOwners; // need to record of the owner of a dataset when it is listed.
    ...
    public returns (uint){
        ...
        listingDatasetOwners[lastListingID] =  datasetOwners[datasetID];
    ...
    returns (address)
    {
      return listingDatasetOwners[listingID];
    ...
    public returns(bool)
    {
          ...
          require(listingDatasetOwners[listingID] == msg.sender, "Only the owner of the listing can unlist it.");
    ...
    returns (bool)
    {
        ...
        require(listingDatasetOwners[listingID] == datasetOwners[datasetID], "The owner of the dataset has changed, the listing is not valid anymore.");
