...
contract HasTokenURI is ERC165 {
...
contract DIREBEAR is Ownable, ERC1155Base {
    ...
    constructor(string memory _name, string memory _symbol,string memory tokenURIPrefix,address payable wallet) ERC1155Base(tokenURIPrefix) public {
        name = _name;
        symbol = _symbol;
        bearWallet = wallet;
        _registerInterface(bytes4(keccak256('GENRATE_BEAR_TOKEN')));
    }
    ...
    function GenrateBearToken() external payable returns(bool){
        ...
        _mint(bearLength,1,bearLength.toString());
