...
*
*   1. Gets a batch flash loan of Enj, DAI and LINK
...
*   5. Withdrawls all of the deposited collateral (Enj/DAI/LINK)
...
contract BatchFlashDemo is FlashLoanReceiverBase, Ownable {
    ...
    address kovanEnj = 0xC64f90Cd7B564D3ab580eb20a102A8238E218be2;
    address kovanDai = 0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD;
    address kovanLink = 0xC64f90Cd7B564D3ab580eb20a102A8238E218be2;
        ...
        returns (bool)
    {
        ...
        // // deposits the flashed Enj, DAI and Link liquidity onto the lending pool
        ...
        // // withdraws the Enj, DAI and LINK collateral from the lending pool
    ...
    /*
    * Deposits the flashed Enj, DAI and LINK liquidity onto the lending pool as collateral
    */
    function flashDeposit(ILendingPool _lendingPool) public {
        ...
        // deposit the flashed Enj, DAI and LINK as collateral
    ...
    */
    function executeFlashLoans(uint256 _flashEnjAmt0, uint256 _flashDaiAmt1/*, uint256 _flashLinkAmt2*/) public onlyOwner {
