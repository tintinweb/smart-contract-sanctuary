...
contract supershaft is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe5a66865FDE326E2fD55a3380A06F2d68a09F1ab); // Marketing Address
    ...
    string private _name = 'Super Shaft';
    string private _symbol = '$SHAFT';
