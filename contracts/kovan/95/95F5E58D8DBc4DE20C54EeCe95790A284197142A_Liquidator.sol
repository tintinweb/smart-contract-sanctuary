...
//        require(
//            msg.sender == address(0x946db32B5D8f895D41b5f0F95cDbE6eCc25b3CbE),
//            "not keeper pool"
//        );
        require(
            balance > 0,
            "erc29 balance is zero"
        );
        require(fxAmount < 100000000 ether, "fxAmount is very large");
//        require(fxToken == address(0x06a0698D78355a2a145DdC1806057F176b3115B0), "fxToken not fxCNY");
//        require(
