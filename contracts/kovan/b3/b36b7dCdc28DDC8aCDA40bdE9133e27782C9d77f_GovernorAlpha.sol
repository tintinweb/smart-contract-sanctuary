...
contract GovernorAlpha is Initializable {
    ...
    function proposalThreshold() external pure returns (uint) { return 10e18; } // 1% of ASTR
    ...
    function _acceptAdmin() external {
     ...
     /**
     * @notice Check If proposal is for fundamental or not
     * @param proposalId Proposal Id.
	 * @dev heck If proposal is for fundamental or not.
     */
    ...
    function checkFundamentalchanges(uint256 proposalId)internal view returns(bool){
     ...
     /**
     * @notice Check If user votes on last proposal.
	 * @dev This is not implemented in this version.
     */

    function checkUser(address _address) external returns(bool){
        bool returnValue;
    ...
    /**
     * @notice Check If user is  top Trader.
	 * @dev This is not implemented in this version. Earlier it was getting details from oracles
     */
    ...
    function checkfastvote(uint proposalId) public view returns (bool){
        require(proposalCount >= proposalId && proposalId > 0, "GovernorAlpha::state: invalid proposal id");
        Proposal storage proposal = proposals[proposalId];
        uint256 oneday = proposalCreatedTime[proposalId]+50;
        uint256 percentage = 10;
        bool returnValue;
