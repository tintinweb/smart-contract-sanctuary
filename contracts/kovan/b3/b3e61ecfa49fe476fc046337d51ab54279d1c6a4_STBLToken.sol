...
contract STBLToken is Context, ERC20, Ownable, AccessControl {
  ...
  constructor() ERC20("Stable","STBL") {
      ...
      STBLCreationInterface = LiquidityInterface(0x8116c88b3a152B8058A16DdE05BA04bFfF0b9340); // Add BalancerSTBL address
    }
    ...
    function createSTBL(address _tokenIn, uint256 _amountIn, uint256 _slippagePercentage) public returns(uint256) {
        ...
        require(token.allowance(msg.sender, address(STBLCreationInterface)) >= _amountIn, "Amount exceeds allowance!");
