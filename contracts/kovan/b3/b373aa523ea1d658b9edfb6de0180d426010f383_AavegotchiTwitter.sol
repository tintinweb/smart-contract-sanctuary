...
contract AavegotchiTwitter {
    ...
    function addExperience(uint256[] calldata _tokenIds, uint256[] calldata _followers) external onlyManager {
    ...
    function setAavegotchi(address _aavegotchi) external onlyOwner {
        require(_aavegotchi != address(0));
        aavegotchi = IAavegotchi(_aavegotchi);
    }
