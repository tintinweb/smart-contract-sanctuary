...
contract TestnetTroveLinkMultiSignatureWallet is TroveLinkMultiSignatureWallet {
    ...
    function proposalDuration() public view override(TroveLinkMultiSignatureWallet) returns (uint256) {
        return 10 minutes;
    }
}
...
contract TroveLinkMultiSignatureWallet is ITroveLinkMultiSignatureWallet, Initializable {
    ...
    function proposalDuration() public view virtual returns (uint256) {
        return 24 hours;
    }
