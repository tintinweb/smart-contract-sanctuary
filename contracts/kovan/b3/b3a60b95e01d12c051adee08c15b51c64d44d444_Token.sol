...
// Starfish - ERC-20 token 

contract Token {

    // My Variables
    string public name; // "Starfishes";
    string public symbol; // "STF";
    uint256 public decimals;// 18;
    uint256 public totalSupply; // 1000000000000000000000000; // how many decimals (18) + the supply of 1 million
    ...
    function transfer(address _to, uint256 _value) external returns (bool success) {
        // require function ensures that the requester actually has tokens 
        // otherwise the transaction would revert
