...
contract BettingPool is Ownable {
    ...
    constructor(address _priceContract, address _tokenPool) {
    ...
    function createNewFreeBetting(
        ...
        IFreeBettingContract(betting).setMinEntrant(_minEntrant);
    ...
    function getTokenPool() public view returns (address) {
        return tokenPool;
    }
...
interface IFreeBettingContract {
    ...
    function setMinEntrant(uint256 _minEntrant)
        external;
