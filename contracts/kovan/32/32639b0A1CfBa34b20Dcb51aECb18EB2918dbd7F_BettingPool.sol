...
contract BettingPool is Ownable {
    ...
    function createNewFreeBetting(
        ...
        address betting = IBettingFactory(_factory).createNewBettingContract(
        ...
        IFreeBettingContract(betting).setMaxEntrant(_maxEntrant);
        IFreeBettingContract(betting).setAward(_award);
        IERC20(_tokenBet).safeTransferFrom(msg.sender, betting, _award);
        _start(betting);
        return betting;
    }
    ...
    function createNewStandardPrizeBetting(
        ...
        IERC20(_tokenBet).safeTransferFrom(msg.sender, betting, IStandardPrizeBettingContract(betting).getUpfrontLockedFunds());
        _start(betting);
        return betting;
    }
    ...
    function createNewGuaranteedPrizeBetting(
        ...
        IERC20(_tokenBet).safeTransferFrom(msg.sender, betting, IGuaranteedPrizeBettingContract(betting).getUpfrontLockedFunds());
        _start(betting);
        return betting;
    }
