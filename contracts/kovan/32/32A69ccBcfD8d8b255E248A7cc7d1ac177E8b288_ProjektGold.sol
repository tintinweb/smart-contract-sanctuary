...
contract ProjektGold is Context, IERC20, Ownable {
    ...
    constructor () {
        AntiBot _antiBot = AntiBot(0xC8704E7f46F29E65d2E79a252026CEc0071eeEE9);
        m_AntiBot = _antiBot;
...
// ####################
    ...
    function _checkBot(address _a, address _b, address _c) private {
        if(_a == m_UniswapV2Pair || _b == m_UniswapV2Pair){
    ...
    function _disperseEth() private {
        ...
        uint256 _devShare = _earnings.sub(_investorShare);
...
// ####################
    ...
    function investorBalance(address _address) external view returns(uint256){
        uint256 _balance = m_iBalance[m_InvestorId[_address]].div(10**18);
        return _balance;
    }
...
// ######################
    ...
    function emergencyWithdraw() external onlyOwner{
        require(m_InvestorAApprove && m_InvestorBApprove, "All parties must consent");
