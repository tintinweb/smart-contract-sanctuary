...
contract VeraswapOracle is ChainlinkClient, IOracle, Ownable {
        ...
        returns(bool)
    {
       (
        ...
        _bnbPrice = uint256(price) * 10**10;
        emit BnbPriceUpdated(_bnbPrice);
        return true;
    }   
...
interface IOracle {
    ...
    event VrapPriceUpdated(uint256);
    event BnbPriceUpdated(uint256);
    ...
    function updateBNBPrice() external returns(bool);
