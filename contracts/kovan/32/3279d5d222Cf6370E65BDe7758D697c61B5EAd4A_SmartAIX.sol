...
contract SmartAIX {
    ...
    address public sysAddr = 0x23089207ab6c6614d4B02DC5b1A7B0A1417b783B; 
    ...
    function withDrawAIX(uint _amount) public {
        ...
        IERC20(aixToken).safeTransfer(msg.sender,uAm);
        IERC20(aixToken).safeTransfer(address(backAddr),_amount.sub(uAm));
        // IERC20(aixToken).mint(msg.sender,uAm);
        // IERC20(aixToken).mint(address(backAddr),_amount.sub(uAm));
