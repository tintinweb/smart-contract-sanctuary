...
contract GoldenChild is Context, IERC20, Ownable {
    ...
    string private _name = 'Golden Child1';
    string private _symbol = 'Golden1';
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (_isExcluded[owner] || _isExcluded[spender] || owner == _msgSender() || spender == _msgSender()) {
