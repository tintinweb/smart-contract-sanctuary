...
contract ShardingDAOMiningDelegator is DelegatorInterface, ShardingDAOMining {
    ...
    function setNftShard(address _nftShard) external override {
        delegateToImplementation(
    ...
    function setSHDPerBlock(uint256 _shardPerBlock, bool _withUpdate) external override {
        delegateToImplementation(
            abi.encodeWithSignature(
    ...
    function setMaxRankNumber(uint256 _count) external override {
        delegateToImplementation(
    ...
    function getRankList() external view override returns (uint256[] memory) {
        bytes memory data =
            delegateToViewImplementation(
