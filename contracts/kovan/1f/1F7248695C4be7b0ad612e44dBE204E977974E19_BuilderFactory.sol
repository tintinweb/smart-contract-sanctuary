...
contract BuilderFactory is Ownable{
    ...
    function buildToken(string memory _name, string memory _symbol, uint _supply)external onlyOwner returns(address){
        BuilderToken token = new BuilderToken(_name, _symbol, msg.sender, _supply);
