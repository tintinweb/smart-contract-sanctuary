...
contract ERC1155 is IERC165, IERC1155 {
  ...
  */
  ...
  function _safeTransferFrom(address _from, address _to, uint256 _id, uint256 _amount)
    internal
  {
    require( balances[_from][_id].sub(onSaleBalances[_from][_id]) >= _amount, "transfer balance is not enough");
    // Update balances
  ...
  /**
   * Get the balance of an account's on Sale Tokens
   */
  ...
  /**
   * Get the price of an account's on Sale Tokens
   */
