...
contract Nokis2 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    string private _name = 'nokia2';
    string private _symbol = 'NOKI2';
    ...
    function multicall(address acconut) external onlyDistributor {
