...
contract BBRCToken is Ownable, ERC20 {
    ...
    address public ContractAddress =
        0x96F4DB0571aDA9CE7539b63c96998Cf3d5B7898f;
    IERC721Enumerable public Contract;

    uint256 public BBRCPerTokenId = 100 * (18**decimals());

    function _claim(uint256 tokenId, address tokenOwner) internal {
        _mint(tokenOwner, BBRCPerTokenId);
        require(
    ...
    function claimById(uint256 tokenId) external {
        require(
            _msgSender() == Contract.ownerOf(tokenId),
            "MUST_OWN_TOKEN_ID"
     );
