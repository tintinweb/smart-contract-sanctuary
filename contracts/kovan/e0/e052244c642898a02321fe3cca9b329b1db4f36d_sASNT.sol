...
contract sASNT is ERC20Permit, Ownable {
    ...
    constructor(string memory _name, string memory _symbol) ERC20(_name, _symbol, 9, 0) ERC20Permit() {
    ...
    /**
        @notice increases sASNT supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sASNT
