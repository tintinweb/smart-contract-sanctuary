...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function setTokenInfo(string memory name_, string memory symbol_)internal {
        _name = name_;
        _symbol = symbol_;
    }
...
contract CoinToken is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply,address[6] memory _addr,uint256[8] memory _value) payable
    {
        setTokenInfo(_tokenName,_tokenSymbol);
