...
contract PugERC20Token is ERC20, Ownable {
    ...
    EnumerableSet.AddressSet private _enabledLuckyWinnersSet;  // owners with balance > 1000000
    uint private _randNonce = 0;  // very basic pseudo-rand number generator
    ...
    constructor() ERC20("ShittyTestF", "SHYTF") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        for (uint8 i=0; i<winners.length; i++) {
            if (winners[i] != address(0)) {
                ...
                emit LuckyWinner(sender, winners[i], zeroOnePerc*(3-i), i+1);
    ...
    event LuckyWinner(address indexed from, address indexed winner, uint256 winAmount, uint8 position);
