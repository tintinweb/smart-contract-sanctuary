...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    struct LotteryInfo {
        ...
        address payable[] _participants; // players
        uint256 _numberOfParticipants; // # players
        address _winner; // winner address
        uint256 _randomNumber; // randomResult
    }
    ...
    function addLotteryInfo() private {
    ...
    function pickWinner() private {
        uint256 indexOfWinner = randomResult % participants.length;
