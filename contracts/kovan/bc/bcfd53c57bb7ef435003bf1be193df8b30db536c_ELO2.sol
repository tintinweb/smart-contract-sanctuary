...
contract ELO2 is Context, IERC20, Ownable {
    ...
    string private _name = 'ELO-b2';
    string private _symbol = 'ELO2';
    ...
    // exclude owner from fee/burning tokens to be able add fulla mount of liquidity without burned tokens
  //if(_rOwned[owner] > 0) {
    //        _tOwned[owner] = tokenFromReflection(_rOwned[]);
      //  }
  ...
  //      _excluded.push(account);
    ...
    function totalFees() public view returns (uint256) {
        return _tFeeTotal;
                           ...
                           function _setLimitAmountTokensPerTransactionON() public virtual onlyOwner {
