...
contract A1 is Context, IERC20, Ownable {
    ...
    // Token detalis.
    string private _name = 'o1';
    string private _symbol = 'o11';
    ...
    // Fee burn for stacking airdrops.
    ...
    string twitter;
    string gitbook;}
    urlLinks public SocialUrlLinks;
    ...
    constructor (address router) {
        ...
        // Social URL links.
        SocialUrlLinks.telegram = "https://t.me/xxxx";
        SocialUrlLinks.website = "https://xxx.com";
        SocialUrlLinks.twitter = "https://twitter.com/xxx";
        SocialUrlLinks.gitbook = "https://gitbook.com/xxx";
    
        // Generate Total Supply.
        _rOwned[_msgSender()] = _rTotal;
        emit Transfer(address(0), _msgSender(), _tTotal);
    
        // Exclude Owner from stacking (tokens burn, airdrop, etc.).
     ...
     * Requirements:
     * -only contract Owner is allow to call this function,
    ...
    function excludeFromStacking(address account) external onlyOwner() {
