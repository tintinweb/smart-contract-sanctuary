...
contract PPSwap is ERC20Interface, SafeMath{
    ...
    */
    ...
    function acceptOffer(uint offerID)
       ...
       require(balanceOf(msg.sender) >= 10*10**6*10**18, 'Error: the PPSwap servcie is available only to 10M PPS holders.');
        /*     
    ...
    returns (bool)
    {
        ...
        require(balanceOf(msg.sender) <= 1*10**9*10**18,  "Maximum buy: 1B PPS.");
