...
// uncomment this and 2 fields in subscription1/2
...
contract MediaEyeFee is AccessControl {
    ...
    function addPaymentMethod(
        ...
        require(
            ...
            "Payment method is already accepted."
        );
    ...
    function updateMultipleTokenAmounts(
        ...
        for (uint256 i = 0; i < _paymentMethods.length; i++) {
            require(
                ...
                "One of the payment method does not exist."
            );
     ...
     */
    function payFeatureFee(address _paymentMethod, uint256 _featureId)
        external
        payable
    {
        require(
     ...
     * _paymentMethod: type of payment Method
     */
    function paySubscriptionLevelOneFee(address _paymentMethod)
        external
        payable
    {
        require(
     ...
     * _paymentMethod: type of payment Method
     */
    function paySubscriptionLevelTwoFee(address _paymentMethod)
        external
        payable
    {
        require(
