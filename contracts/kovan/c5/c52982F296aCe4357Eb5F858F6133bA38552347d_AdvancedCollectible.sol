...
abstract contract OnePlanetConnected is StringUtils, Owned{
   ...
   //OnePlanet Modifiers
    ...
    modifier OnePlanetCarbonOffset {                    
        ...
        else if (offsetSwitch == 1 && address(this).balance >= 1e16 && transferCounter < counterStop){
    ...
    // This CarbonOffset mmodifier has limited error handling and no offset message concatination to minimize gas usage.
    ...
    function offsetWith1PLminGas(uint256 gasEstOffset) internal {
        ...
        gasEstOffset = gasEstOffset.add(gasEstModifier1PL);
        CO2offset = gasEstOffset.mul(gasCO2factor); //gas used multiplied by C02 coversion factor
