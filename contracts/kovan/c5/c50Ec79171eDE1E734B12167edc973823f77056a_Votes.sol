...
contract Votes is Ownable, Initializable {
  ...
  function createNftEvent (string memory _nftUrl, uint _start, uint _end, uint _minParticipants, uint _maxParticipants, uint _rewardAmount) public payable canCreate(msg.sender, _rewardAmount) {
    transfer(msg.sender, payable(address(this)), _rewardAmount);
