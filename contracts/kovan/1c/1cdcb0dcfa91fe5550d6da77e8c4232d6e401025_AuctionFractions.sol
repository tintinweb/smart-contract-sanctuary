...
contract AuctionFractions
{
	fallback () external payable
	{
		assembly {
			...
			let result := delegatecall(gas(), 0x9F4C469EbB4701B55461a640Fe7b283581020290, 0, calldatasize(), 0, 0) // replace 2nd parameter by AuctionFractionsImpl address on deploy
