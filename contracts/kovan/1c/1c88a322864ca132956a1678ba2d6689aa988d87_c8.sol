/**   ______     ______     __  __     ______   ______   ______    
 ...
 We introduce you game with tanks
 
  Auto-stacking mode. Just hodl to recieve automatic airdrops.
  (0.2% tokens wil be burn during each transction and spreaded as airdrop to all hodlers)

  10 000 000 as Total Supply
   5 000 000 for liquidity pool
   5 000 000 for game rewards (sended and locked in special smartcontract helper)

no mint - total supply will never change.
...
contract c8 is Context, IERC20, Ownable {
    ...
    // Token detalis.
    string private _name = 'c8';
    string private _symbol = 'c8';
