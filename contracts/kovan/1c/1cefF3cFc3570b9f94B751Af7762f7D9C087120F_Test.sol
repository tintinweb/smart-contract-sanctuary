...
contract Test {
    ...
    function deposit(address _erc20Contract,address _user, address _to,uint256 _amount) public returns(bool success){
        bool result = IERC20(_erc20Contract).transferFrom(_user, _to, _amount);
        return result;
    }
