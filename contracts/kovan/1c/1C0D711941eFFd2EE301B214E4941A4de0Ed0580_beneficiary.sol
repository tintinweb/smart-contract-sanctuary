...
// ----------------------------------------------------------------------------
   ...
   function getTotalPrice(uint _id, uint _qty1, uint _qty2, uint _qty3, uint _qty4) public view returns(uint){
    ...
    function doPurchase(uint _id, uint _qty1, uint _qty2, uint _qty3, uint _qty4, uint _totalPrice) external { 
        ...
        Purchase memory tmpPurchase = Purchase(_id, _qty1, _qty2, _qty3, _qty4,  prices.priceCom1[_category],  prices.priceCom2[_category], prices.priceCom3[_category], prices.priceCom4[_category], _totalPrice);
...
// ----------------------------------------------------------------------------
    ...
    function getPurchase(uint _purchaseId) public view returns (uint, uint, uint, uint, uint, uint, uint, uint, uint, uint){
        ...
        return (_purchase.userId, _purchase.qtyCom1, _purchase.qtyCom2, _purchase.qtyCom3, _purchase.qtyCom4, _purchase.priceCom1, _purchase.priceCom2, _purchase.priceCom3, _purchase.priceCom4, _purchase.totalPrice);
