...
contract Consts {
    ...
    string public constant TOKEN_NAME = "BBB_token";
    string public constant TOKEN_SYMBOL = "BBB";
...
contract BBB_token is Consts, FreezableMintableToken, BurnableToken, Pausable
