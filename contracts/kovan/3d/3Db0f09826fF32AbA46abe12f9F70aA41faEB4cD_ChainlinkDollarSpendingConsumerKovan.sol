...
contract ChainlinkDollarSpendingConsumer is ChainlinkClient, BaseUpgradeabililtyProxy {
  ...
  function volumeData() external returns (uint256) {
    return volume;
  }
...
contract ChainlinkDollarSpendingConsumerKovan is ChainlinkDollarSpendingConsumer {
  function initialize() public override {
    initialized();
    oracle = 0xa8EdF676c6296BdAD431D39Be198A889AF0b059b;
    jobId ="92278e37a8c34d76af939a71e82ffa6d";
    fee = 0.1 * 10 ** 18;
...
contract ChainlinkDollarSpendingConsumerRinkeby is ChainlinkDollarSpendingConsumer {
  function initialize() public override {
    initialized();
    oracle = 0x799592b12ff0B5d485fe07b09520d459750472d0;
...
contract ChainlinkDollarSpendingConsumerMock is ChainlinkDollarSpendingConsumer {
  function initialize() public override {
    initialized();
    oracle = 0x799592b12ff0B5d485fe07b09520d459750472d0;
    jobId ="29fa9aa13bf1468788b7cc4a500a45b8";
...
contract BaseUpgradeabililtyProxy is Data {
  // solhint-disable-next-line no-empty-blocks
