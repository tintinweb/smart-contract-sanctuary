...
contract BrightRiskToken is ERC20Upgradeable, OwnableUpgradeable, IBrightRiskToken {
    ...
    function stakeAt(address _controllerAddress, uint256 _amount) external {
        ...
        _mintIndex(_controllerAddress, _amount);
    }
    ...
    function _mintIndex(address _controllerAddress, uint256 _baseAmount) internal {
        _mint(_msgSender(), convertPositionToIndex(_controllerAddress, _baseAmount));
        _accrueManagerFee();
    }
