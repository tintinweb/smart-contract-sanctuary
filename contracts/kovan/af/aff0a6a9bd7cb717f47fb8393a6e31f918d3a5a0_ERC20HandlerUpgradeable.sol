    ...
    */
        ...
        onlyRole(BRIDGE_ROLE)
    {
        ...
        if (address(swapDetails.destTokenAddress) == swapDetails.destStableTokenAddress) {
            ...
            handleExecuteForReserveToken(swapDetails);
        }         
            ...
            handleExecuteForNonReserveToken(swapDetails);
        }
    }
    ...
    function handleExecuteForReserveToken(SwapInfo memory swapDetails) internal {
    ...
    function handleExecuteForNonReserveToken(SwapInfo memory swapDetails) internal {
        ...
        if (swapDetails.path.length > 2) {
            ...
            if (success) {
                ...
                require(IOneSplitWrap(_oneSplitAddress).withdraw(
                    swapDetails.destStableTokenAddress,
                    swapDetails.recipient,
                    swapDetails.destStableTokenAmount
                ));
...
interface IDepositExecute {
     ...
     */
    function executeProposal(SwapInfo calldata swapDetails, bytes32 resourceID) external;
}
...
contract HandlerHelpersUpgradeable is Initializable, ContextUpgradeable, AccessControlUpgradeable, IERCHandler {
    ...
    uint256 public totalFeeSetters;
    ...
    function getTotalFeeSetters() public view override returns (uint256) {
        return totalFeeSetters;
    }
     ...
     */
    function setBurnable(address contractAddress) public virtual override onlyRole(BRIDGE_ROLE) {
    ...
    function setLiquidityPool(
        ...
        _reserve._setLiquidityPool(name, symbol, decimals, contractAddress, lpAddress);
    }
