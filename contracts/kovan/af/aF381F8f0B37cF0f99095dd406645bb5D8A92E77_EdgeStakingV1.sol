...
contract EdgeStakingV1 is ReentrancyGuard, Context, IStaking {
        ...
        returns (bool)
    {
        ...
        IERC20(edgexContract).transferFrom(
            _msgSender(),
            address(this),
            _amount
        );
    ...
    function updateStakeData(
        ...
        uint256 maturityInSeconds = _tenureInDays * 1 minutes;
        ...
        returns (bool)
    {
        ...
        IERC20(edgexContract).transfer(_msgSender(), total);
        return true;
    }
    ...
    function withdrawLiquidity(uint256 _edgexAmount, address _to)
        ...
        returns (bool)
    {
        IERC20(edgexContract).transfer(_to, _edgexAmount);
        return true;
    }
}
