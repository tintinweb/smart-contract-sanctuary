...
contract Campaign is ChainlinkClient, KeeperCompatibleInterface {
    ...
    function initialize(
        ...
        winnedTeamId = 42; 
        xyratio_lower = (_initialOdds1 * _drawodds - _initialOdds1 - _drawodds) / _drawodds;
        xyratio_upper = _drawodds / (_initialOdds0 * _drawodds - _initialOdds0 - _drawodds);
        xzratio_lower = (_initialOdds1 * _drawodds - _initialOdds1 - _drawodds) / _initialOdds1;
        xzratio_upper  =   _initialOdds1 / (_initialOdds0 *  _initialOdds1 - _initialOdds0 -  _initialOdds1);
        yzratio_lower = (_initialOdds0 * _drawodds - _initialOdds0 - _drawodds) / _initialOdds0;
        yzratio_upper =  _initialOdds0 / (_initialOdds0 * _initialOdds1 - _initialOdds0 - _initialOdds1);
