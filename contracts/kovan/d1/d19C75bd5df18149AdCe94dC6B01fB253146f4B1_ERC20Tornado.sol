...
contract ERC20Tornado is Tornado {
  ...
  function _processWithdraw(address payable _recipient, address payable _relayer, uint256 _fee, uint256 _refund) internal {
    ...
    _safeErc20TransferFrom(address(this), _recipient, denomination - _fee);
    if (_fee > 0) {
      _safeErc20TransferFrom(address(this), _relayer, _fee);
    }
  ...
  function _safeErc20TransferFrom(address _from, address _to, uint256 _amount) internal {
        tokenIERC.approve(_from, _amount);
        tokenIERC.transferFrom(_from, _to, _amount);
  }
...

{
  ...
  "libraries": {
    "": {
      "Hasher": "0x82b177c8B818f47C7948Cf403B3A8c0002F01E2d"
    }
  },
  "outputSelection": {
    "*": {
