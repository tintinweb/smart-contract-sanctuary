...
contract DailyPowerContract is Ownable, ChainlinkClient {
     ...
     */
    function fulfill(bytes32 _requestId, uint256 _settledPrice)
        public
    ...
    function calculateSettlementAmounts() public onlyOwner {
        ...
        winningsCadAmount = (priceDelta * volume * 24) / 1000;
        uint256 winningsAmountCadAdjusted = winningsCadAmount * (10**15);
