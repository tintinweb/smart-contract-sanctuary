...
contract TokenFactory {
    function createToken(string memory _name, string memory _symbol, address _owner, uint256 _totalSupply) public returns (address) {
        Single single = new Single(_name, _symbol, _owner, _totalSupply);
