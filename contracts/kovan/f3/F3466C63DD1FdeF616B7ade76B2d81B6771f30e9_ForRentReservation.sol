...
contract ForRentFactory {
    ...
    function _createForRent(
        ...
        forRentToOwner[forRentArray.length] = msg.sender;
    }
...
contract ForRentReservation is ForRentFactory {
    DRTToken drtToken;

    constructor(address _tokenAddress) {
        drtToken = DRTToken(_tokenAddress);
    }
    ...
    function reserve(uint256 _forRentId) public {
        ...
        uint256 renterBalance = drtToken.balanceOf(msg.sender);
        require(
        ...
        bool sent = drtToken.transferFrom(
            msg.sender,
