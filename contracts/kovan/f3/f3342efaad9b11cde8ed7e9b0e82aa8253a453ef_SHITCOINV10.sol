...
contract SHITCOINV10 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shitcoin v10";
    string private constant _symbol = unicode"SHITCOINV10";
    ...
    function openTrading() public onlyOwner {
        ...
        _launchFeeEnd = block.timestamp + (15 minutes);
    }
    ...
    // this doesnt work when fee variable is set in the _transfer function itself
