...
contract PPET_TESTNET is Ownable, IERC20 {
    ...
    modifier onlyNFT() {
        require(NFT == _msgSender(), "only nft contract can use this function");
        _;
    }
    ...
    function xMint(address account, uint256 amount) public onlyNFT {
        require(!mintingDisabled);
        _mint(account, amount);
    }
