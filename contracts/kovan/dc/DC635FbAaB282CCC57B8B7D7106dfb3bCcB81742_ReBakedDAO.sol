...
contract Packages is Collaborators {
	...
	*/
	function createPackage(
		...
		virtual
	{
		packageData[projectId_][packageId_].createPackage(projectId_, packageId_, budget_, bonus_);
	}
...
contract Projects is Packages, Observers {
	...
	*/
	function createPackage(
		...
		override
	{
		projectData[projectId_].createPackage(budget_, bonus_);
		super.createPackage(projectId_, packageId_, budget_, bonus_);
	}
