...
contract TokenRegistry is ITokenRegistry, Ownable
{
  ...
  function isValidPair (address tokenA, address tokenB) external view override returns (bool)
  {
    return  _whitelistedTokens.contains(tokenA) && _whitelistedTokens.contains(tokenB) && !(_stableTokens.contains(tokenA) && _stableTokens.contains(tokenB));
  }
