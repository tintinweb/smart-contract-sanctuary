...
// hevm: flattened sources of /nix/store/07p0c2i79x0cv84yjvg1wbhgn4ixi8hs-dss/dapp/dss/src/cat.sol
...
////// /nix/store/07p0c2i79x0cv84yjvg1wbhgn4ixi8hs-dss/dapp/dss/src/cat.sol
...
contract Cat is LibNote {
    ...
    VatLike_1 public vat;    // CDP Engine
    VowLike_1 public vow;    // Debt Engine
    ...
    function file(bytes32 what, address data) external note auth {
        if (what == "vow") vow = VowLike_1(data);
