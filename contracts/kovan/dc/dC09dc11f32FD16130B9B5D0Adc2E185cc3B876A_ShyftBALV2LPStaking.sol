  ...
  function getTwoTokensReward(
    ...
    if (pendingUSD > 0 && priceA > 0 && priceB > 0) {
      ...
      if (totalValue > 0) {
        ...
        amountA = shareA.mul(pendingUSD).div(priceA).div(1e16); // div(1e18) for pendingUSD - on frontend, div(1e16) for shareA(:priceA)
        amountB = shareB.mul(pendingUSD).div(priceB).div(1e16); // div(1e18) for pendingUSD - on frontend, div(1e16) for shareB(:priceB)
      }
    }
  }
  ...
  function getTwoTokensReward2(
    ...
    if (pendingUSD > 0 && priceA > 0 && priceB > 0) {
      ...
      if (totalValue > 0) {
        ...
        amountA = shareA.div(1e18).mul(pendingUSD).div(priceA).div(1e18).div(1e16); // div(1e18) for pendingUSD - on frontend, div(1e16) for shareA(:priceA)
        amountB = shareB.div(1e18).mul(pendingUSD).div(priceB).div(1e18).div(1e16); // div(1e18) for pendingUSD - on frontend, div(1e16) for shareB(:priceB)
      }
    }
  }
  ...
  function getTwoTokensReward3(
    ...
    if (pendingUSD > 0 && priceA > 0 && priceB > 0) {
      ...
      if (totalValue > 0) {
        ...
        amountA = shareA.div(1e18).mul(pendingUSD).div(priceA).div(1e16); // div(1e18) for pendingUSD - on frontend, div(1e16) for shareA(:priceA)
        amountB = shareB.div(1e18).mul(pendingUSD).div(priceB).div(1e16); // div(1e18) for pendingUSD - on frontend, div(1e16) for shareB(:priceB)
      }
    }
  }

  // Get reward with several tokens
  function getTwoTokensReward4(
    uint256 _balPoolId, 
    address _tokenA, 
    address _tokenB
  ) external view returns (uint256 amountA, uint256 amountB) {
    ...
    if (pendingUSD > 0 && priceA > 0 && priceB > 0) {
      ...
      if (totalValue > 0) {
        ...
        amountA = shareA.div(1e18).mul(pendingUSD).div(priceA); // div(1e18) for pendingUSD - on frontend, div(1e16) for shareA(:priceA) - on frontend
        amountB = shareB.div(1e18).mul(pendingUSD).div(priceB); // div(1e18) for pendingUSD - on frontend, div(1e16) for shareB(:priceB) - on frontend
      }
    }
  }
