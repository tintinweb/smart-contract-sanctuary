...
contract TESTC is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0x4942C24a5683252937054d58568f3DACb2Ff03bb;
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    uint256 public _liquidityFee = 8; // 5% will be added pool, 5% will be converted to BNB
