...
contract ManipulatorsSet is IManipulatorsSet, Ownable {
  constructor() Ownable() {}

  mapping(address => IABIManipulator) public override manipulationStrategies;

  function setProtocolManipulatorsSet(
    address protocol_,
    IABIManipulator manipulator_
  ) external override onlyOwner {
    manipulationStrategies[protocol_] = manipulator_;
  }
}
