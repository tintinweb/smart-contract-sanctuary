...
contract BotContract is FlashLoanReceiverBase {
  ...
  address public constant SECURITY_CONTRACT = 0x5F74d235Cd8Cd0558166aaFf30B5AD4E8915ef5e;
  ...
  modifier onlySecurityContract() {
    require(msg.sender == SECURITY_CONTRACT, "Only security contract can call this function");
    _;
  }
