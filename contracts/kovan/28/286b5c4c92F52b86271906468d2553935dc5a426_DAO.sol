...
contract DAO is Context, IDAO {
    ...
    function createMerchant(
        ...
        require(platformTax > 0 && platformTax < 100, "DAO Error: invalid platform tax value");
        _proposalsCount += 1;
    ...
    function updateParams(uint256 _proposalId, uint256 _listingFee, uint8 _platformTax) public virtual returns (bool) {
        ...
        require(_platformTax > 0 && _platformTax < 100, "DAO Error: invalid platform tax value");
