...
contract TestPool is Ownable, VRFConsumerBase {
    ...
    uint256 public _ticketPrice = 10 ** 16; // 0.01 ETH/BNB
    uint256 public _tokenBuyBackFee = 10; // 10%
    uint256 public _pricePoolTarget = 1000 * 10 ** 18;
    ...
    function getRandomNumber() public returns (bytes32 requestId) {
        require(randomResult == 0, 'random result is not 0');
    ...
    function startNewGame() public onlyAdmin {
        ...
        _totalTickets = _pricePoolTarget / (_ticketPrice / 100 * (100-_tokenBuyBackFee));
    ...
    function buyTickets(uint256 amount) public {
        ...
        require(getAvailableTickets() > 0, "No more tickets available");
    ...
    function withdrawWin() public {
        //require(_isEnabled, "Lottery is not enabled");
        //require(_isCompleted, "Lottery is not completed");
        require(_wins[msg.sender] > 0, "Nothing to withdraw for you");
    }
    ...
    function getWinningTicketId() public view returns(uint256) {
        return randomResult % _totalTickets;
    }
