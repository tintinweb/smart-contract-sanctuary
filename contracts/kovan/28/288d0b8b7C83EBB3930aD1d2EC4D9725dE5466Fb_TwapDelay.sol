...
contract TwapDelay is ITwapDelay {
    ...
    uint256 public constant ORDER_CANCEL_TIME = 48 hours;
    uint256 public constant BOT_EXECUTION_TIME = 30 minutes;
    uint256 private constant ORDER_LIFESPAN = 24 hours;
