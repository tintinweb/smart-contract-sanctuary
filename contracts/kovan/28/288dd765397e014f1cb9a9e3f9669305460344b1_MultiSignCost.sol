...
contract MultiSignCost is EIP712 {
    ...
    function hashData(address token,uint amount) external view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(token,amount)));
    }
