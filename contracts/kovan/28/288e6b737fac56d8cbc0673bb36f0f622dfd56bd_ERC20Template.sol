...
contract ERC20 is Context, IERC20, BlackList {
    ...
    function _destroyBlackFunds(address _blackListUser) internal virtual {
...
abstract contract ERC20Pausable is ERC20, Pausable {
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        ...
        require(blacklist[from] == 0 && blacklist[to] == 0, "Transfer Not allowed"); 
    }
}
...
contract ERC20Template is ERC20Pausable {
    ...
    function destroyBlackFunds(address _blackListUser) public onlyFactory{
        require(blacklist[_blackListUser] == 0, "You can only clear the money of users in the blacklist");
        _destroyBlackFunds(_blackListUser);
    }
