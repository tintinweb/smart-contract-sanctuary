...
contract ShirtumSale is ReentrancyGuard, Ownable {
    ...
    // General conditions
    uint256 public generalMinBuy = 240000000000000000; // 0.24 ETH
    uint256 public generalMaxBuy = 24000000000000000000; // 24 ETH
    ...
    constructor(
        ...
        hardCap = 1560000000000000000000;   // 2,400 ETH
