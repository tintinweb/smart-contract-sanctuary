...
contract SwapTokensForExactTokens  {
  ...
  function getFarmingBal(address farmingToken) public view returns(uint256) {
  ...
  function execute(
    ...
    path[0] = farmingToken;
    path[1] = baseToken;
    console.log(farmingToken.myBalance());
    console.log(baseToken.myBalance());
    router.swapTokensForExactTokens(0.01 ether, farmingToken.myBalance(), path, address(this), now);
    console.log(baseToken.myBalance());
  }
