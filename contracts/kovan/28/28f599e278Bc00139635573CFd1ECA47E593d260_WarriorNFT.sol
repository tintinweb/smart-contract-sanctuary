...
contract WarriorNFT is ERC721, Ownable {
    ...
    function mint(uint256 amount) external {
        ...
        bloodstone.transferFrom(msg.sender, address(this), bloodstoneAmount*10**18);
        for(uint i=0; i<amount; i++) {
            ...
            if (randNum==0&&randNum<5) {
                warrior = Warrior("AAA", 6, 45000+genRand(5001), "QmTyQ3Mab2711GWGMyvXqMVCQpK49WH1KQRzhUBJS96Q7W");
            } else if (randNum>=5&&randNum<100) {
                warrior = Warrior("AAA", 5, 4000+genRand(1501), "QmcNEMp12fU7tNyTt8oRBKeW7QjXR9gLKwJoXPYAav86XV");
            } else if (randNum>=100&&randNum<800) {
                warrior = Warrior("AAA", 4, 3000+genRand(1000), "QmZwioRnSrxDUcDK1e4LNkvGi7WW9eJXnHrEwXavathiwe");
            } else if (randNum>=800&&randNum<2200) {
                warrior = Warrior("AAA", 3, 2000+genRand(1000), "Qmbdyp864SwZZ2X3yBWKX1YeSax4BRj8F3yvLM9PcgAXYw");
            } else if (randNum>=2200&&randNum<5000) {
                warrior = Warrior("AAA", 2, 1000+genRand(1000), "QmPbsQEreJNFVRkNkgyzDNTgkQ6Xt6GrPQXjz83FYTyQMi");
            } else {
                warrior = Warrior("AAA", 1, 400+genRand(600), "QmRXAzXAA8oiuMxe9m8Tdp9oq4tsBXgDjkpNz3Tz5uuRj2");
            }
