...
contract Liquidation is ILiquidationInterface, Tools, ErrorReporter, CarefulMath {
    ...
    function liquidateBorrowDrectlyFresh(
        ...
        */
        ...
        capital.setAccountMspConfig(_borrower, _id, mspconfig);

        console.log("uniqueName:", mspconfig.uniqueName);
        capital.setAccountRecordExistFlag(_borrower, mspconfig.uniqueName, false);

        // 6. 维护当前持仓的ID列表
        capital.deleteClosedAccountRecord(_borrower, _id);
    }
