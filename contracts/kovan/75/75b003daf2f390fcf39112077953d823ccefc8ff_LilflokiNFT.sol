...
contract LilflokiNFT is ERC721Enumerable {
using Strings for uint256;

    address private admin;

    string private _nftName = "Lil Floki";
    string private _nftSymbol = "lilfloki";
    uint256 private mintCost = 2*10**17;
    ...
    constructor(string memory _base, address _admin) ERC721(_nftName, _nftSymbol)  {
        admin = _admin;
        __baseURI = _base;
        // ipfs://CID/
    }
  ...
  function setBaseUriExtention(string memory _newBaseExtension) public onlyAdmin {
    ...
    function everyMintCost() public view returns(uint256){
        return mintCost;
    }
