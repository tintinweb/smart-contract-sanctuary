...
contract hfp is ERC20, Ownable {
    ...
    address payable marketingWallet = 0x009f1D5aDf0dba4bBec722Bf050932B7C73138aD;
    ...
    constructor() public ERC20("hfpv5", "hfpv5") {
        uint256 _BNBRewardsFee = 6;
        uint256 _liquidityFee = 2;
        uint256 _buyBackFees = 1;
