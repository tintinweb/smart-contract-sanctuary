...
contract AttraCampaign is KeeperCompatibleInterface, FundManager, Lottery {
        ...
        returns (AttraLib.CampStatus)
    {
        ...
        require(cfg.ownerFee < 5000, "The owner fee must be lower than 50%");
...
contract AttraFinance is Ownable {
    ...
    event Refund(uint256 campaignId);
    ...
    function contribute(uint256 _campaignId) public payable {
        ...
        emit Contribution(_campaignId, msg.value, msg.sender);
    }
