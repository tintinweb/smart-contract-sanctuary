...
// File: contracts/ShirtumSale.sol
...
contract ShirtumSale is ReentrancyGuard, Ownable {
    ...
    bool public claimEnabled = false;
     ...
     // General conditions
    uint256 public generalMinBuy = 15000000000000000; // 1.5 BNB
    uint256 public generalMaxBuy = 150000000000000000000; // 150 BNB
    uint256 public generalClaimMaxWaitTime = 30 days;
    uint256 public claimTiming = 30 days;
    uint256[] public generalVestingClaim = [10000];
    mapping(address => uint256) public generalParticipants;

    // Corportative conditions
    uint256 public corpMinBuy = 606000000000000000000;
    uint256 public corpMaxBuy = 3000000000000000000000;
    uint256 public corpClaimWaitTime = 365 days;
    ...
    constructor(
        ...
        minimalGoal = 100000000000000000;    // 1 BNB
        hardCap = 233333333300000000;   // 8333,333333 BNB
        buyPrice = 83333333330000;  // 0,00008333333333 BNB = 0.02705 EUR
        totalTokens = 2799999999712000000000; // 100,000,000.00 TOKEN
