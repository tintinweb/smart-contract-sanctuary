...
contract DealCreator is IDealCreator, Ownable {
    ...
    event DealCreated(address _paymentToken,
        uint256 _tokenPrice,        
    ...
    function createDeal(
        ...
        emit DealCreated(address(_paymentToken),
                        _tokenPrice,        
                        address(_rewardToken),
                        _startTimestamp,
                        _finishTimestamp,
    ...
    function updateTier(uint256 index, uint256 timeLockups) external onlyOwner{
        require(index < allTiers.length , "Incorrect index");        
