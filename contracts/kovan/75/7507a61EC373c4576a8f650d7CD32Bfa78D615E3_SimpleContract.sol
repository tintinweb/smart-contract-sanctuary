...
contract SimpleContract is VRFConsumerBase {
    event Alert(address from, string sentence);
    ...
    function getLatestPrice() public view returns (int) {
        ...
        function alert(string memory sentence) public {
        emit Alert(msg.sender, sentence);
    }
