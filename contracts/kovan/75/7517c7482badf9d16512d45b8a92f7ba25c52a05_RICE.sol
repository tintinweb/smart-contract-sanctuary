...
contract RICE is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = _tokenTotal.mul(3).div(10000);// no limit
    ...
    constructor() public {
        ...
        address _owner = 0x3896Bb8d21c81A489817Bd02C89132C67CD5659A;
    ...
    function _transfer(
        ...
        if(isFeeActive && sender != uniswapV2Pair && !isTaxless[_msgSender()] && !isTaxless[recipient] && !inSwapAndLiquify){
