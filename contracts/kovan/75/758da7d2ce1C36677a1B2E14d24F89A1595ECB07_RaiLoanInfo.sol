...
contract RaiLoanInfo is DSMath {
    ...
    function getSafeInfo(uint256 _safeId) public returns (SafeInfo memory safeInfo) {
        ...
        CollInfo memory collInfoTest; 
        RaiInfo memory raiInfoTest;
        (collInfoTest, raiInfoTest) = getCollAndRaiInfo(collType);
        ...
        safeInfo = SafeInfo({
            ...
            safeAddr: safeAddr,
            collType: collType,
            collMulCollPrice: collInfoTest.assetPrice,
            debtMulRaiPrice: raiInfoTest.currRaiPrice
        });
    }
