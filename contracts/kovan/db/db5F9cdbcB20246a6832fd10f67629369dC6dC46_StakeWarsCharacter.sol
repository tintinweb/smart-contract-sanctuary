...
contract StakeWarsCharacter is Administerable {
    ...
    mapping(address => StakeWarInternals) public _registeredStakeWarriors;
    ...
    function RegisterStakeWarrior(address player) public {
        ...
        StakeWarInternals character = StakeWarInternals(player);
    ...
    function getRarityReadable(address warriorAddr)
        ...
        returns (string memory)
    {
        StakeWarInternals warrior = _registeredStakeWarriors[warriorAddr];
        return
