...
contract CoreOrchestrator is Ownable {
    ...
    uint256 public constant DAO_TIMELOCK_DELAY = 10 minutes;

    uint256 public constant STAKING_REWARDS_DURATION = 2 * 365 days;

    uint256 public constant STAKING_REWARDS_DRIP_FREQUENCY = 10 minutes;

    uint32 public constant UNI_ORACLE_TWAP_DURATION = 10 minutes; // 10 min twap

    uint256 public constant BONDING_CURVE_ALLOCATE_INCENTIVE_FREQUENCY = 10 minutes; // 1 day duration
