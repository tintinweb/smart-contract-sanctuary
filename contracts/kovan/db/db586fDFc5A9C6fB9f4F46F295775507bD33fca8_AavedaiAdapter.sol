...
contract AavedaiAdapter is AdapterBase {
        ...
        returns (uint256)
    {
        ...
        uint256 originalPrice =
            _aavedai
                .getReserveNormalizedIncome(underlyingAssetAddress)
                .rayToWad();
        ...
        returns (uint256)
    {
        ...
        uint256 beforeBalance =
            IAToken(aTokenAddress).scaledBalanceOf(address(this));
        _aavedai.deposit(
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 underlyingtokenamt =
            getRedeemableUnderlyingTokensForCore(maxAmount);
    ...
    function setReferralCode(uint16 code) external onlyBy(governanceAccount) {
        referralCode = code;
    }
}
