...
contract EthLottery is Ownable, ChainlinkClient {
    ...
    constructor(address _oracle) {
        oracle = _oracle;
        numberOfWinnersJobId = "b1f14b6918884459a3446970620efad4";
        getWinnetsJobId = "92540b16fe944577a5f2f378031907ae";
        lotteryState = LOTTERY_STATE.CLOSED;
        ticketValue = 0.001 * 10**15; //in wei (0.001 ETH) 10**15
    ...
    // 4. Get Winners
    function requestNumberOfWinners() public returns (bytes32 requestId) {
