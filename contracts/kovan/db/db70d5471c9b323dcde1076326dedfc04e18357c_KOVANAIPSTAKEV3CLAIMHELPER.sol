...
contract KOVANAIPSTAKEV3CLAIMHELPER {
  ...
  function executeChangeAndInit(address implem, address slashingAdmin, address cooldownPauseAdmin, address claimHelper, uint256 maxSlashablePercentage) external{
      bytes memory initParams =
      abi.encodeWithSelector(
        STK_AAVE_TOKEN.initialize.selector,
        slashingAdmin,
        cooldownPauseAdmin,
        claimHelper,
      ...
      STK_AAVE_TOKEN.upgradeToAndCall(implem, initParams);
