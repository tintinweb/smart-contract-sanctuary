...
contract RGANFT is ERC721URIStorage , VRFConsumerBase {
    ...
    struct Artwork {
        uint256 random_value_1;
        uint256 random_value_2;
        uint256 random_value_3;
        string artworkName;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        uint256 rv1 = (randomNumber % 100);
        uint256 rv2 = ((randomNumber % 10000) / 100);
        uint256 rv3 = ((randomNumber % 1000000) / 10000);
