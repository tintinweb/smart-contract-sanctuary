    ...
    BaseUpgradeableStrategyStorage
{
    ...
    function initialize(
        ...
        require(_storage != address(0), "BaseUpgradeabilityStrategy: cannot set 0 address");
        require(_underlying != address(0), "BaseUpgradeabilityStrategy: cannot set 0 address");
        require(_vault != address(0), "BaseUpgradeabilityStrategy: cannot set 0 address");
        require(_rewardToken != address(0), "BaseUpgradeabilityStrategy: cannot set 0 address");
        require(_rewardPool != address(0), "BaseUpgradeabilityStrategy: cannot set 0 address");
...
// File: contracts/interfaces/sushiswap/IMasterChef.sol
...
// File: contracts/strategies/sushiswap/SushiMasterChefLPStrategy.sol
...
contract SushiMasterChefLPStrategyF1 is IStrategy, BaseUpgradeableStrategy {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
