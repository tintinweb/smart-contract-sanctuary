...
interface IMarketplace {
    ...
    struct Order {
        ...
        uint256 createdAt;
        // address of wo created the order first
        address createdBy;
    ...
    struct Bid {
        ...
        uint256 createdAt;
        // address of who created the bid first
        address createdBy;
...
contract Marketplace is Ownable, Pausable, FeeManager, IMarketplace, ERC721Holder {
        ...
        internal
    {
        ...
        address payable assetOwner = nftRegistry.ownerOf(_assetId);
        ...
        internal
    {
        ...
        // address(this).transfer(_priceInWei);
