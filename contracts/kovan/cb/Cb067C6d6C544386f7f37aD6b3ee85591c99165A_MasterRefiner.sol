...
contract MasterRefiner is Ownable {
    ...
    event Log(string msg, uint256 val1, uint256 val2 ,uint256 val3 ,uint256 val4, uint256 val5, uint256 val6);
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.accRP1PerShare =
            ...
            ((propellantReward * 1e12) / (lpSupply));
        pool.lastRewardBlock = block.number;
        emit Log("lpSupply multiplier pool.allocPoint totalAllocPoint proppelantReward accRP1PerShare", lpSupply, multiplier, pool.allocPoint, totalAllocPoint, propellantReward, pool.accRP1PerShare);
    }
