...
// 15%~ Slippage required: 8% ADA Auto-reflect /5% Dev & Marketing Wallet/2% Auto-LP
    ...
    contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
          ...
          address public immutable BUSD = address(0x1484a6020A0F08400F6f56715016d2C80e26cDC1); //TUSDT TESTNET
    ...
    contract Tokenflect is IBEP20, Ownable {
        ...
        address public constant TUSDT                   = address(0x1484a6020A0F08400F6f56715016d2C80e26cDC1); // TUSDT TESTNET
        ...
        address payable public _supplyWalletAddress    = payable(0xf5D5B22Bb7DDed4453c90744B66471d6602F1b3E); // Wallet Supply-team (là où nous enverrons les tokens à la création du smartcontract avant d'airdrop la v2)
        address payable public _partWalletAddress      = payable(0x5407Da105D55828D2Ca2d0b6C1589eB14be93eea); // Wallet Partenaires "générique" (quand nous n'avons pas add influenceur un acheteur pour le link à un partenaire, pour les 1,5% partenaires en BUSD et 1,5% partenaires en token)
        address payable public _teamWalletAddress      = payable(0x353d157171876c5CA1C985523A01618E476e6A4A); // Wallet Team (pour les 1% de transaction fees "Team"
        address payable public _algoWalletAddress      = payable(0x8eD9888A266704d6E01Ccc2381E62DA873b99A34); // Wallet Algo (pour les 7% transaction fees sur price impact > 2%)
        ...
        function _addLiquidity(
            ...
            if (IUniswapV2Factory(uniswapV2Router.factory()).getPair(tokenA, tokenB) == address(0)) {
                uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(tokenA, tokenB);
        ...
        function addLiquidity(
            ...
            // approve token transfer to cover all possible scenarios
            _approve(_msgSender(), address(uniswapV2Router), amountA);
            _transfer(_msgSender(), uniswapV2Pair, amountA);
            
            // approve token transfer to cover all possible scenarios
            ERC20(tokenB).approve(address(uniswapV2Router), amountB);
            ERC20(tokenB).transferFrom(_msgSender(), uniswapV2Pair, amountB);
