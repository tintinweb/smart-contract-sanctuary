...
contract Rebaser is IRebaser, Ownable, KeeperCompatibleInterface {
    ...
    uint32 public upkeepTimeWindow = 15 hours;
    ...
    function checkUpkeep(
        ...
        upkeepNeeded = block.timestamp - lastUpkeepTime >= upkeepInterval && block.timestamp % 1 days <= upkeepTimeWindow;
    ...
    function performUpkeep(
        ...
        require(rebasers[msg.sender] == true, "Whitelisted addresses only");
        require(block.timestamp - lastUpkeepTime >= upkeepInterval && block.timestamp % 1 days <= upkeepTimeWindow, "Bad time window");
