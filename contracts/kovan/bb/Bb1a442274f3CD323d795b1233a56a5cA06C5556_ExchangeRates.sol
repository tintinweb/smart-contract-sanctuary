...
contract ExchangeRates is ApeStreetModule, OwnableUpgradeable {
    ...
    function requireAndGetAddress() internal view returns (address) {
        return address(0x0);
    }
    ...
    function _getRateAndUpdatedTime(bytes32 currencyKey) internal view returns (RateAndUpdatedTime memory) {
        ...
        require(aggregator != AggregatorV2V3Interface(address(0)), "ExchangeRates: NO_AGGREGATOR_AVAILABLE");
...
contract ApeStreetModule {
    ...
    modifier onlyInternalModule() {
        require(master.isModule(msg.sender),  "ApeStreetModule: NON_MODULE_CALLER");
        _;
    }
