...
contract ELO3 is Context, IERC20, Ownable {
    ...
    string private _name = 'ELO-b3';
    string private _symbol = 'ELO3';
    ...
    //WYWAL!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    function __setNEWmaxTokensLimitDuringFirstHour (uint256 wartosc) external onlyOwner() {
        _maxTokensLimitDuringFirstHour = wartosc;
    }

    function _isContractRunning() public view returns (bool) {
    ...
    function ___startContract() public virtual onlyOwner {
        _contractRunning = true;
        emit isContractStarted (_contractRunning);
    }
                            
    function __setLimitForTokensPerTransactionON() public virtual onlyOwner {
