...
/**
 * @title Stake NFT AAVE Auction Contract
 *
 *
 * @dev Contract that manages interactions between NFT owners, patrons and owners.
 */
contract StakeAuction is VersionedInit, AuctionBase {
    ...
    function createAuction(
        ...
        require(nftData.owner == address(0), Errors.AUCTION_EXISTS);
        require(
    ...
    function redeem(address nft, uint256 nftId) external whenNotPaused {
        ...
        IERC721(nft).safeTransferFrom(msg.sender, owner, nftId);
