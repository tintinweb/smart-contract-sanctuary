...
contract panCakeBot {
    ...
    function buyAlia(uint tokenAmount, uint ethAmount) public {
        uint deadline = block.timestamp + 30;
        uniswapRouter.swapETHForExactTokens {value: SafeMath.div(ethAmount,decimals)}(SafeMath.mul(tokenAmount,100), getPathForBNBtoToken(alia), address(this), deadline);
    }
