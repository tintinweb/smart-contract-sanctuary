...
contract NFTMock is ERC1155("NFTMock_URI") {
    ...
    constructor() public {
        mint(msg.sender, G003_NFTID, 20);
        mint(msg.sender, G002_NFTID, 20);
        mint(msg.sender, G001_NFTID, 20);
    }
    ...
    function _checkNftokenId(uint256 nftokenId_) private pure {
        require(
            ...
            "NFTMock: unsupported nftokenId_"
        );
    }
}