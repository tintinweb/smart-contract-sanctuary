...
contract BalancerTrader is Ownable {
    ...
    constructor() {
      bPool = BFactory(0x8f7F78080219d4066A8036ccD30D588B416a40DB); // Mainnet Factory Balancer
      poolTokens = [
        ...
        pushBPTAddress(0x3f706B48Ca959F32d0BB24Eb704b759f4F29Eb9c); // Add the address of Balancer Pool Token
    }
