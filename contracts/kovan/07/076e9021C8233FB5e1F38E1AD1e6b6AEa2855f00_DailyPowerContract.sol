...
contract DailyPowerContract is Ownable, ChainlinkClient {
    ...
    function calculateSettlementAmounts() public onlyOwner {
        ...
        uint256 adjustedCadToUsdPrice = uint256(latestUsdToCadPrice) * 10**10; // it comes with 8 decimals already, so add 10 to get to 18 decimals
        ...
        if (settledPriceCadCents == price) {
            buyerRefundEthAmount = buyerFundEthWeiAmount;
            sellerRefundEthAmount = sellerFundEthWeiAmount;
        }
