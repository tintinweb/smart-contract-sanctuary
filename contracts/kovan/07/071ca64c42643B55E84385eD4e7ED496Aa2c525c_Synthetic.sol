...
contract Synthetic is Ownable {
    ...
    function mintSynthetic(
        ...
        uint256 canWithdrawRemainning = _amount - requiredAmount;
        ...
        mn.currentRatio = (_backedAmount / exchangeRate) * denominator; // must more than 1.5 ratio
        mn.willLiquidateAtPrice =
            (_backedAmount / liquidationRatio) *
            denominator; // must more than 1.5 ratio
