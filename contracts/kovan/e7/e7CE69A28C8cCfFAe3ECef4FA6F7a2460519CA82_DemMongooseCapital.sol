...
"What could Mongoose Coin do to crypto coins?"
The first ever Yield Meme Coin named by a US senator, Mongoose Coin.
Mongoose Coin. $DMC.
You buy on Ethereum, we farm on multiple chains and return the profits to $DMC holders.

Website: http://demmongoose.capital/

Twitter: https://twitter.com/DemMongoose

Telegram: https://t.me/DemMongooseCapital
...
contract DemMongooseCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Dem-Mongoose Capital";
    ...
    address payable public holderReflection = payable(0x70177c395dE3E3785a6997d46D47212C6b0BD51b);
    address payable public treasury = payable(0x70177c395dE3E3785a6997d46D47212C6b0BD51b);
    ...
    constructor (    ) Auth(0x70177c395dE3E3785a6997d46D47212C6b0BD51b) {
        address _owner = 0x70177c395dE3E3785a6997d46D47212C6b0BD51b;
    ...
    function setholderReflection(address _holderReflection) external onlyOwner {
