...
// COnstructor Params for KOVAN
// "0xad4AB4Cb7b8aDC45Bf2873507fC8700f3dFB9Dd3","0x75A807a667FbcB303f46c0F8Ca45fdfEF8fdC9AC","0xE5Ae4E49bEA485B5E5172EE6b1F99243cB15225c","0x807C8eCb73d9c8203d2b1369E678098B9370F2EA","0xB19bc2e13Bd6BAeeE8c0D8282387221D7f9b8833","500000000000000000","10000000000000000","40","145"

contract AeveSafeSaviour is SafeMath, SafeSaviourLike {
    // --- Variables ---
    ...
    address WETHGatewayContractAddressOFAAVE = 0xf8aC10E65F2073460aAD5f28E1EABE807DC287CF; // KOVAN
    address aEth = 0x87b1f4cf9BD63f7BBD3eE1aD04E8F52540349347; // KOVAN
    ...
    */
    function withdraw(uint256 safeID, uint256 collateralTokenAmount) external controlsSAFE(msg.sender, safeID) nonReentrant {
        ...
        IERC20(aEth).approve(WETHGatewayContractAddressOFAAVE, collateralTokenAmount);
        IWETHGateway(WETHGatewayContractAddressOFAAVE).withdrawETH(collateralTokenAmount, msg.sender); // AAVE withdraw eth method
