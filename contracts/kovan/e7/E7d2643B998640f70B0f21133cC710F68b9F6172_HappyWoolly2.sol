...
contract HappyWoolly2 is ERC721Enumerable, Ownable, VRFConsumerBase {
    ...
    uint256 public REVEAL_TIMESTAMP = block.timestamp + 60 minutes;
    ...
    function adopt(uint256 num) public payable {
        ...
        require( num < 10,                  "You can mint a maximum of 10 fantastic woolly" );
        require( supply + num <= MAX_WOOLLY_SUPPLY,  "Exceeds maximum Woolly supply" );
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if ((totalSupply() >= MAX_WOOLLY_SUPPLY || block.timestamp >= REVEAL_TIMESTAMP)) {
            uint256 offsetId = tokenId.add(offsetIndex);
