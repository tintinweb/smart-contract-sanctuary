...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    // add the imported VRFConsumerBase constructor with required arguments
    constructor(
    ...
    function endLottery() public onlyOwner {
        ...
        bytes32 requestId = requestRandomness(keyhash, fee); // returns requestid (see imported contract code)
        emit RequestedRandomness(requestId);
    }

    // override means overring the original fulfillrandomness from imported contract VRFConsumerBase
        ...
        override
    {
        ...
        // pick a random winner using modulo
