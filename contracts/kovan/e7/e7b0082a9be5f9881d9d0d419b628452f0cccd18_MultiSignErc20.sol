...
// File: MultiSign/MultiSignErc20.sol
...
contract MultiSignErc20 is ERC20Permit {
    constructor(string memory name,string memory symbol,address to,uint amount) ERC20Permit(name) ERC20(name,symbol) {
        _mint(to,amount);
    }
