...
contract TCoinwebToken is ERC777 {
    
    event Deployed(address releaser );
    TokenReleaser rel;
    
    constructor() ERC777("Test Coinweb", "TCWEB", new address[](0) ) {
        ...
        rel = new TokenReleaser( 0x40F93F0f63FA340F45C70dbb52AA57F6580a2675 // Admin A 
                               , 0x803637DCe8A437C178105b75a1370DdB5164D79a // Admin B
                               , this
                               , totalSupply
                               );
...
contract TokenReleaser {
    ...
    function setTokenomics(uint256 avaliableTokens) private{
        ...
        // NOTICE: we take a month to be equivalent to 30 hours, regardless of actual calendar months.
        // In particular, 12 month would not sum up a whole year, but 360 hours.


        tokenomic[ SEED_ROUND                     ] = ReleaseType
         ({ tokenLockTime             :  0 * 30 hours
          , tokenReleaseDuration      : 24 * 30 hours 
          , immediateAccessTimeWindow :  1 * 30 hours
          }
         );

        tokenomic[ PRIVATE_ROUND                  ] = ReleaseType
         ({ tokenLockTime             :  0 * 30 hours
          , tokenReleaseDuration      : 12 * 30 hours
          , immediateAccessTimeWindow :  1 * 30 hours
          }
         );
        ...
        tokenomic[ PUBLIC_SALE                    ] = ReleaseType
         ({ tokenLockTime             :  0 * 30 hours
          , tokenReleaseDuration      :  0 * 30 hours
          , immediateAccessTimeWindow :  0 * 30 hours 
        ...
        tokenomic[ COMPANY_RESERVE                ] = ReleaseType
         ({ tokenLockTime             :  0 * 30 hours
          , tokenReleaseDuration      : 36 * 30 hours
          , immediateAccessTimeWindow :  1 * 30 hours
          }
         );

        tokenomic[ TEAM_AND_ADVISORS              ] = ReleaseType
         ({ tokenLockTime             : 12 * 30 hours
          , tokenReleaseDuration      : 36 * 30 hours
          , immediateAccessTimeWindow :  0 * 30 hours
          }
         );
        ...
        tokenomic[ FOUNDERS_AND_EARLY_CONTRIBUTORS] = ReleaseType
         ({ tokenLockTime             : 12 * 30 hours
          , tokenReleaseDuration      : 48 * 30 hours
          , immediateAccessTimeWindow :  0 * 30 hours
          }
         );

        tokenomic[ MINING_RESERVE                 ] = ReleaseType
         ({ tokenLockTime             :  6 * 30 hours
          , tokenReleaseDuration      : 60 * 30 hours
          , immediateAccessTimeWindow :  0 * 30 hours
          }
         );
