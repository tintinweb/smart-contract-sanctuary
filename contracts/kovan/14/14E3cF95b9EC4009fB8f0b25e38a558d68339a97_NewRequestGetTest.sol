...
contract NewRequestGetTest is ChainlinkClient {
    ...
    bytes32 constant UINT256_MUL_JOB = bytes32("50fc4215f89443d185b061e5d7af9490");
    ...
    function _setChainlinkToken(address ad) public{
        setChainlinkToken(ad);
    }
...

    {
      ...
      req.add("get","https://api.rarible.com/protocol/v0.1/ethereum/nft/items/0x5e833e99463d487b0645f999cea5d807fb0360e3:18");
        // Adds a URL with the key "get" to the request parameters
//        req.add("get", "https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=USD");
        // Uses input param (dot-delimited string) as the "path" in the request parameters
      req.add("copyPath", "owners");
        // Sends the request with 1 LINK to the oracle contract
        sendChainlinkRequest(req, ORACLE_PAYMENT);
    }

    // fulfill receives a uint256 data type
    function fulfill(bytes32 _requestId, string[] memory _price)
    public
