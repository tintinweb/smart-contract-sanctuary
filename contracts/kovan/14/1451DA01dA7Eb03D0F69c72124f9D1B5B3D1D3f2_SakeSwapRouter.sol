...
interface ISakeSwapFactory {
    ...
    function setMintSToken(bool _mintSToken) external;

    function setMintSTokenForAllPair(bool _mintSToken) external;

    function setMintSTokenForPair(bool _mintSToken, address _pair) external;
}
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex'1b75a0acc4df2236d0141169dd07275b30fa0ae62d1476711f7025664ff89ee0' // init code hash
                    )
                )
            )
        );
