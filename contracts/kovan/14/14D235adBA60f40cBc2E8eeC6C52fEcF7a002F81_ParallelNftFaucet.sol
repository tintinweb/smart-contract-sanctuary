...
contract ParallelNftFaucet {
    ...
    RaribleUserToken nftContract;
    uint8 public maxNftsPerUser = 1;
    uint8 public currentBonusCard = 3;
    ...
    constructor()  public {
        ...
        nftContract = RaribleUserToken(nftContractAddress);
    }
    modifier onlyOwner() {
  ...
  function setMaxNftsPerUser(uint8 _max) public onlyOwner {
      maxNftsPerUser = _max;
  }
  function setCurrentBonusCard(uint8 _id) public onlyOwner {
  ...
  function requestNft() public {
    require(depositInfo[msg.sender].totalNftsReceived <= maxNftsPerUser, "max bonus received");
      ...
      nftContract.safeTransferFrom(pullNftsFromAddress, msg.sender, currentBonusCard, 1, bytes(""));
  }
