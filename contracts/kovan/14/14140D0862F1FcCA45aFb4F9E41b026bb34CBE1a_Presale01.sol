...
contract Presale01 is ReentrancyGuard {
  ...
  constructor(address _presaleGenerator) public {
    ...
    PRESALE_SETTINGS = IPresaleSettings(0x2f4eb47A1b1F4488C71fc10e39a4aa56AF33Dd49);
    PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0x593848cFADB16Fe8b13A0A913520b701ed0c8Eec);
