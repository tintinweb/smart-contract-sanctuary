...
/**
    1% auto distributed on holders!
    2% auto sent to a lottery wallet!
    2% auto sent to a growth wallet!
    ...
    */
    abstract contract Ownable is Context {
        ...
        */
        constructor () {
            _owner = 0xF410117fea7acb6B6E5db4087D0c8F3969Cde310;
    ...
    contract Unique is Context, IERC20, Ownable {
        ...
        address private _lotteryWalletAddress = 0xBD8412E1d34d8A6B90A3294998Cd3d307bfC36EB;
        address private _growthWalletAddress = 0xC69D217525580dfaBA716b7b487cBB10a5ae65A4;
        ...
        string private _name = "Unique";
        string private _symbol = "UNIQ";
        ...
        function includeInReward(address account) external onlyOwner() {
            ...
            (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee, uint256 tLiquidity, uint256 tLottery, uint256 tGrowth) = _getValues(tAmount);
        ...
        function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tLottery, uint256 tGrowth, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
            uint256 rAmount = tAmount.mul(currentRate);
            uint256 rFee = tFee.mul(currentRate);
            uint256 rLiquidity = tLiquidity.mul(currentRate);
            uint256 rLottery = tLottery.mul(currentRate);
            uint256 rGrowth = tGrowth.mul(currentRate);
            uint256 rTransferAmount = rAmount.sub(rFee).sub(rLiquidity).sub(rLottery).sub(rGrowth);
