...
// File contracts/8/LionInterface.sol
...
contract LionInterface {
    ...
    struct LionSimple{
        uint256 LionId;
        ILion.Lion Lion;
        // LionBreedLimitInfo breedLimitInfo;
        IAuction.Auction auctionInfo;
        bool isOnAuction;
        // RaceBase.LionRace raceInfo;
    }
    ...
    constructor(address _nftAddress, address _siringAuction) {
    ...
    function getLionSimple(uint256 _tokenId) public view returns(LionSimple memory){
        ...
        // LionBreedLimitInfo memory _breedLimitInfo = LionBreedLimitInfo({
        ...
        // RaceBase.LionRace memory _raceInfo = raceBase.getLionRaceInfo(_tokenId);
    ...
    function getLionDetail(uint256 _tokenId) external view returns(LionDetail memory) {
        ...
        // ILion.Lion[] memory _offsprings = new ILion.Lion[](_Lion.offsprings.length);
        ...
        for (uint256 index = 0; index < _Lion.offsprings.length; index++) {
            ...
            // _offsprings[index] = nonFungibleContract.getLion(tokenId);
            _offsprings[index] = getLionSimple(tokenId);
        }
        uint256 _matronId = _Lion.matronId;
        uint256 _sireId = _Lion.sireId;
        // ILion.Lion memory _matron = nonFungibleContract.getLion(_matronId);
        // ILion.Lion memory _sire = nonFungibleContract.getLion(_sireId);
    ...
    // function getAllBreedLions() external view returns(LionSimple[] memory) {
    //     uint256 tokenCount = nonFungibleContract.totalSupply();
    //     console.log('tokenCount:',tokenCount);
    //     LionSimple[] memory result = new LionSimple[](tokenCount);
    //     uint256 i = 0;
    //     for (uint256 index = 0; index < tokenCount; index++) {
    //         LionSimple memory _Lion = getLionSimple(index);
    //         if(_Lion.isOnAuction){
    //             console.log('getAllBreedLions:i:',i);
    //             result[i] = _Lion;
    //             i = i + 1;
    //         }
    //     }
    //     console.log('getAllBreedLions:length:',result.length);
        
    //     LionSimple[] memory result2 = new LionSimple[](i);
    //     for (uint256 index = 0; index < i; index++) {
    //         result2[index] = result[index];
    //     }
    //     console.log('getAllBreedLions:length:2:',result2.length);
    //     return result2;
    // }
