...
contract Fll is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xDe6fA3B7B0C7C823560C3daB8C652ef98FE257Db); // Marketing Address
    address payable public devAddress = payable(0x8EEEE720001a1EbfFB37F64a45082A34Ff60bdc4);  // Team Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 1000000000000000000000, "Floki: maxtxAmount must be more than 1000000000000000000000 ");
