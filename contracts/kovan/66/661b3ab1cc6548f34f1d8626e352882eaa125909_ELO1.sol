...
contract ELO1 is Context, IERC20, Ownable {
    ...
    address[] private _excluded;
                                ...
                                // prepare database for know BOTs addresses
                                ...
                                // Contract is stoped as default state on the beggining.
                                bool public _contractRunning = false;
                                ...
                                //limity
                                uint256 _maxTokensLimitDuringFirstHour = 4000000000000000 * 10**9;
                                uint256 _maxTokensInitialLimit = 100000000000000 * 10**9;
                                uint256 currentLimit;
                                bool maxTokensLimitDuringFirstHour = false;
                                bool allLimitsOff = false; 
    ...
    string private _name = 'ELO-b11';
    string private _symbol = 'ELO1';
    ...
    constructor () public {
        ...
        // set default state of currentLimit variable;
        currentLimit = _maxTokensInitialLimit.div (1 * 10**9);
    
    
        
    // Locking know BOTs addresses to prevent unfair "buy first, huge dump leater" method.
    ...
    function totalFees() public view returns (uint256) {
        return _tFeeTotal;
                           ...
                           function _setAllLimitsPerTransactionsOFF() public virtual onlyOwner {
                            allLimitsOff = true;
                            currentLimit = 0;
                           ...
                           function _setMaxTokensAmountPerTransactionON() public virtual onlyOwner {
    ...
    return allLimitsOff;
     ...
     function __setNEWmaxTokensLimitDuringFirstHour (uint256 warosc) external onlyOwner() {
        _maxTokensLimitDuringFirstHour = warosc;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        // searching for BOTs to lock, but continue all other transactions.
...
if (allLimitsOff == true && maxTokensLimitDuringFirstHour == false && sender != owner() && recipient != owner())
