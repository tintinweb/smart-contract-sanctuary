...
contract CoreBank is Ownable {
    ...
    function withdraw(uint256 withdrawAmount) public returns(uint256 remainingBalance)
    {
        ...
        //msg.sender.transfer(withdrawAmount); <= 0.5.0
        ...
        //broadcast event   
        emit WitdrawMade(msg.sender, withdrawAmount);
    }
    ...
    function payDividensPerYear() public payable onlyOwner {
