 ...
 */
contract White1 is Context, IERC20 , Ownable{
    ...
    // Set preSell to default ongoing state.
    bool public preSellDone = false;
    event preSellEnded (bool preSellDone);    
    ...
    function preSellOver() public virtual ownerOnly {
        preSellDone = true;
        emit preSellEnded (preSellDone);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (preSellDone == true || _isWhiteListed[sender] || _isWhiteListed[recipient]) {
            ...
            require (preSellDone == true, "PreSell is not over yet");
        }
    }
