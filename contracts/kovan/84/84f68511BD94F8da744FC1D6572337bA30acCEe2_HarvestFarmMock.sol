...
// Root file: contracts/mock/HarvestFarmMock.sol
...
contract HarvestFarmMock {
	...
	function withdraw(uint256 _amount) external {
		deposited[msg.sender] = deposited[msg.sender].sub(_amount);
	...
	function getReward() external {
		uint256 amount = 1000 * (10**uint256(ERC20(rewardToken).decimals()));
