...
contract WeldTokensaleMock is WeldTokensale {
    ...
    constructor(
        ...
        address _treasury,
        address WELD, 
        uint maxAmount, uint pre_start, uint pre_end, uint pub_start, 
        uint pub_end, uint withdrawal_period, uint pre_pool, uint public_pool, uint vest_duration) public  
    {
        WeldTokensale.initialize(_treasury, WELD, maxAmount, pre_start, pre_end, pub_start,
...
contract WeldTokensale is OwnableUpgradeable, PausableUpgradeable {
    ...
    */
     ...
     * @param treasury Address of protocol's treasury where funds from sale go to
     * @param WELD WELDToken mainnet address
     */
    function initialize(address treasury, address WELD, uint maxAmount, 
        ...
        vestingStart = 0;
        maxTokensAmount = maxAmount * (10 ** 18);
    ...
    */
    ...
    function adminAddWhitelsit(address _user) virtual external onlyOwner {
        isWhitelisted[_user]==true;
    }

    function adminRemoveWhitelsit(address _user) virtual external onlyOwner {
