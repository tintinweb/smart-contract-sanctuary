...
contract SecondChancePool is VRFConsumerBase, Ownable {
    ...
    /**
     * Selfdestruct the pool contract and send all ethers to owner
     */
...
contract Controller is Ownable {
     ...
     * Return all prophet pools addreses
     */
    function getAllSecondChancePools() external view returns (address[] memory) {
        return secondChancePools;
    }
