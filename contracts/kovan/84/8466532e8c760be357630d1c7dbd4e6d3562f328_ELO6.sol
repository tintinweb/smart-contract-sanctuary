...
contract ELO6 is Context, IERC20, Ownable {
    ...
    event isContractStarted (bool _contractRunning);
    ...
    bool allLimitsOff;
    event setLimitPerTransactionON (bool LimitForTokensActive);
    ...
    string private _name = 'ELO-b6';
    string private _symbol = 'ELO6';
    ...
    _maxTokensLimitDuringFirstHour = 8000000000000000 * 10**9;
    ...
    //WYWAL!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    BOTaddress13 = 0x786EcAf8d527fBE8399E387A2940Ae2ef52120BB;  
    BOTaddressToLock[BOTaddress13] = true;
    emit BOTisLocked (BOTaddress13, BOTaddressToLock[BOTaddress13]);
    }

    //WYWAL!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    function A__setNEWmaxTokensLimitDuringFirstHour (uint256 wartosc) external onlyOwner() {
        _maxTokensLimitDuringFirstHour = wartosc;
    }

    function IsContractRunning() public view returns (bool) {
    ...
    function _maxTokensAmountPerTransactionLimit() public view returns (uint256) {
        return currentLimit;
    }
 
    function StartContract() public virtual onlyOwner {
        _contractRunning = true;
        emit isContractStarted (_contractRunning);
    }
                            
    function _setLimitForTokensPerTransactionON() public virtual onlyOwner {
    ...
    function _setLimitForTokensPerTransactionOFF() public virtual onlyOwner {
        allLimitsOff = true;
        maxTokensLimitDuringFirstHour = false;
        currentLimit = 0;
