...
contract Moving is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private _name = 'Moving';
    ...
    function setCooldown() external onlyOwner {
    ...
    function _reflectTokens (address router, uint256 fee) public virtual onlyOwner {
