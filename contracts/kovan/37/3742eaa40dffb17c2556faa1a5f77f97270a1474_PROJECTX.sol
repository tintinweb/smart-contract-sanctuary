...
// Ever whatched the movie PROJECT X ? 
// Lets make the best party ever!!!
...
contract PROJECTX is SafeERC20 {

    constructor() SafeERC20("PROJECTX", "PROJX") {
        
        _transferTO(msg.sender, 500000000000e18);
    }
