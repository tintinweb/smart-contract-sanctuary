...
contract TokenFarm is ChainlinkClient, Ownable {
    ...
    IERC20 dai = IERC20(0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD); //aave testnet
    ...
    constructor(address _dappTokenAddress) public {
        ...
        receiver = address(0x1613e2cd7D84FAD73AaE8Ba170E4c3856c4B001C);
        //owner = msg.sender;
    ...
    function depositCollateral(address _asset, uint256 _amount, bool _isPull) external returns (bool) {
        /*if (_isPull) {
        ...
        //chainshot beginning
        //dai.transferFrom(msg.sender, receiver, _amount);
    ...
    function getTokenBal(address _account, address _token) external view returns (uint256) {
        return IERC20(_token).balanceOf(_account);
    }

    function transferToken(address _to, uint256 _value, address _token) external returns (bool) {
