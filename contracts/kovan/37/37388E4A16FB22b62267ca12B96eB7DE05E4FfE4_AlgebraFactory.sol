...
contract AlgebraFactory is IAlgebraFactory {
    ...
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x3831112091c8db19f9cdee2097b73eea08150a4ad92eb74499b7fbe96337f21c;
...
library DataStorage {
    ...
    function lteConsideringOverflow(
        ...
        if (a <= currentTime && b <= currentTime) return a <= b;
    ...
    function _averages(
        ...
        if (lteConsideringOverflow(oldest.blockTimestamp, time - TIME_AGO, time)) {
    ...
    function getAverages(
        ...
        if (lteConsideringOverflow(oldest.blockTimestamp, time - TIME_AGO, time)) {
            ...
            return ((volatilityAfter) / TIME_AGO, uint256((volumePerLiquidityCumulativeAfter)) >> 64);
        }
    }
