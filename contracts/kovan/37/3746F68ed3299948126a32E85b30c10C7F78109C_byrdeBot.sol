...
contract byrdeBot is ICallee, Ownable {
...
// This is our "Withdraw" action sent to dydex
// This is our request for funds
    ...
    function callFunction(address sender, Account.Info memory accountInfo, bytes memory data) external override {
        ...
        // WETH.withdraw(WETH.balanceOf(address(this)) - loanAmount - 1000000000000004);	//costs gas unnecessary
		...
		// REGARDLESS OF A PROFIT OR NOT
		// CALCULATE PROFIT AND REVERT ON A LOSS
    }
}