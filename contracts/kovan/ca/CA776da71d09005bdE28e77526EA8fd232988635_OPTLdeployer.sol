...
contract OPTLdeployer is ReentrancyGuard {
    ...
    address public routerAddressUni;
    ...
    constructor(address payable _admin, IERC20 _opttoken) {
        admin = _admin;
        opttoken=_opttoken;
        adminFee = 10000e18;
        routerAddressUni = (0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    }

    receive() payable external{}

    function createPreSaleEth(
        IERC20 token,
        uint256 _tokenPrice,
        ...
        bytes memory bytecode = type(preSaleEth).creationCode;
...
contract preSaleEth {
    ...
    constructor() {
        deployer = msg.sender;
        allow = true;
        admin = payable(0x1dce55E0382A075dd8ADc7A726984122145964AC);
    ...
    function initialize(
        ...
        hardCap = _hardCap;
        routerAddressUni = IUniswapV2Router02(routeraddress);
