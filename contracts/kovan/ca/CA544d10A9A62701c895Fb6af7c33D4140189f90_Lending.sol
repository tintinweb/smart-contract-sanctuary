...
// File: contracts/lending-platform/interfaces/ILending.sol
...
// File: contracts/lending-platform/interfaces/IAavePriceOracle.sol
...
// File: contracts/lending-platform/interfaces/IAaveAddressesProvider.sol
...
// File: contracts/lending-platform/interfaces/DataTypes.sol
...
// File: contracts/lending-platform/interfaces/IAaveLendingPool.sol
...
// File: contracts/lending-platform/interfaces/ICompoundPriceOracle.sol
...
// File: contracts/lending-platform/interfaces/ICompoundComptroller.sol
...
// File: contracts/lending-platform/interfaces/ICompoundErc20.sol
...
// File: contracts/lending-platform/Converter.sol
...
// File: contracts/lending-platform/Lending.sol
...
contract Lending is ILending {
    ...
    function withdrawCollateral(uint platformIndex, address collateralToken, uint256 amount) external override onlyProvider {
        ...
        if (platformIndex == 1) {
            ...
            AAVEInfo memory info;
            info.collateral = (collateralETH / priceReserveETH) * (10 ** decimalReserve);
            info.borrowedAmount = (borrowedAmountETH / priceReserveETH) * (10 ** decimalReserve);
            info.liquidationThreshold = (liquidationThreshold / priceReserveETH) * (10 ** decimalReserve);
            require(
                (info.collateral - amount) * info.liquidationThreshold / info.borrowedAmount > 2,
                "LENDING: COLLATERAL_NOT_ENOUGH"
            );
