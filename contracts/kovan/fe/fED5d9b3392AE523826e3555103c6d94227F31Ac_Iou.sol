...
/**
 * @dev ERC20 token to represent a single tranche for a CAGS bond
 *
 */
contract Iou is IIou, ERC20, Initializable, AccessControl {
...
/**
 * @dev ERC20 token to represent a single IOU for a CAGS bond
 *
 */
