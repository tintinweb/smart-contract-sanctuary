...
contract Config is Ownable, IConfig, AddressCheck {
    ...
    function setExtendV1(address key, address value) external {
        extendsV1[key] = value;
    }
    ...
    function setExtendV2(uint256 key, address value) external {
        extendsV2[key] = value;
    }
    ...
    function setExtendV3(address key, uint256 value) external {
        extendsV3[key] = value;
    }
