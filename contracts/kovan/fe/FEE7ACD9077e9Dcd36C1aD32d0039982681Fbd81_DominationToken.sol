...
*         once they're ready.
*/
contract DominationToken is ERC777Upgradeable, AccessControlUpgradeable, UUPSUpgradeable
{
    /**
    1.5 billion tokens:
    ...
    */
    function initialize(address[] memory defaultOperators) public initializer
    {
        ...
        _setupRole(UPGRADE_ROLE, defaultOperators[0]);
    ...
    function _authorizeUpgrade(address) internal view override {
        require(hasRole(UPGRADE_ROLE, msg.sender), "UNAUTHORIZED");
    }
