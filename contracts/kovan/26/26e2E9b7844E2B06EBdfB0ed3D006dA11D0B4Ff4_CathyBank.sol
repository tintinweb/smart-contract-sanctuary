...
contract CathyBank is Ownable {
    ...
    address[] public cathyBankTokenHolders;
    ...
    function withdrawETH() public {
        ...
        uint256 fee =
            (redeemAmount.mul(ethWithdrawFeePercentage)).div(DECIMALS);
