...
contract SwapAI is ISwapAI {
  ...
  function _processAnalysisManualToTUSD(
    ...
    SwapUser storage currentUser = userData[userAddress];
...
contract TokenSwapper {
   ...
   */
  function _swapTUSDtoWBTC(SwapUser memory _user) internal {
   ...
   */
  function _swapWBTCtoTUSD(SwapUser memory _user) internal {
