...
contract AASwapFactory is IUniswapV2Factory {
    address public feeTo;
    address public feeToSetter;
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(AASwapPair).creationCode));
...
contract AASwapPair is IUniswapV2Pair, AASwapERC20 {
...
contract AASwapERC20 is IUniswapV2ERC20 {
    using SafeMath for uint;

    string public constant name = 'AASwap-LP-Token';
    string public constant symbol = 'AASWAP-LP';
