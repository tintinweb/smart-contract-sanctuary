...
contract SecurityTokenSBT is ERC20Token, Ownable, IERC1594 {
    ...
    event SetPartitionRegistry(IERC1410Registry indexed TransferPartitionRegistry);
    ...
    public 
    {
        ...
        emit SetPartitionRegistry(_TransferPartitionRegistry);
    }
    ...
    function transferByPartition(bytes32 _partition, address _to, uint256 _value, bytes calldata _data) external returns (bytes32) {
        TransferPartitionRegistry.transferByPartition(_partition,_to, _value, _data);
    }
    ...
    function operatorTransferByPartition(bytes32 _partition, address _from, address _to, uint256 _value, bytes calldata _data, bytes calldata _operatorData) external returns (bytes32) {
        ...
        TransferPartitionRegistry.operatorTransferByPartition(_partition,_from,_to, _value, _data,_operatorData);
    }
 ...
 * @dev Interface of the Registry contract.
 */
interface ITokenlibRegistery {
    function canTransfer(uint256 balanceOfFrom,address _to, uint256 _value, bytes calldata _data) external view returns (bool, byte, bytes32);

    function canTransferFrom(uint256 balanceOfFrom,address _to, uint256 _value, bytes calldata _data,uint256 balanceOfTo) external view returns (bool, byte, bytes32);
