...
contract EscrowFarm is Ownable {
    ...
    address aweth_address = 0x87b1f4cf9BD63f7BBD3eE1aD04E8F52540349347;
    address WETHGatewayaddress = 0xcc9a0B7c43DC2a5F023Bb9b738E45B0Ef6B06E04;
    address poolAddress;
    IERC20 dai;
    IWeth iweth;
    IERC20 adai;
    ...
    uint256 private higheststaker;
    uint256 public creationtime;

    constructor(address _nadavTokenAddress) public {
        ...
        aaveatoken[daiaddress] = adai_address;
        aaveatoken[wethaddress] = aweth_address;
    ...
    function stakeAdminTokens(uint256 _amount, address _token) public {
        require(_amount > 0, "Amount must be more than 0");
        IERC20(_token).transferFrom(msg.sender, address(this), _amount);
    }

    function stakenAdavTokens(uint256 _amount, address _token) public {
        require(
    ...
    function stakeEath() public payable {
        ...
        updateUniqueTokensStaked(msg.sender, wethaddress);
    ...
    function unstakeAsETH() public {
        ...
        IERC20(aaveatoken[_token]).approve(poolAddress, totransfer);
        IERC20(aaveatoken[_token]).approve(address(this), totransfer);
        IWeth(aaveatoken[_token]).approve(poolAddress, totransfer);
        IWeth(aaveatoken[_token]).approve(address(this), totransfer);
        WETHgateway.withdrawETH(_token, totransfer, msg.sender);
    }
}
