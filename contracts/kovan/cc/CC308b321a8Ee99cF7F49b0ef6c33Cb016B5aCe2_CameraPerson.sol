...
contract CameraPerson is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CAMERA PERSON NFT", "CPNFT") {
    setHiddenMetadataUri("ipfs://QmSxAb6h65NghQ7CwovMK3Va22JXcXuPwbt69nhXPD8V7A/hidden.json");
  }
