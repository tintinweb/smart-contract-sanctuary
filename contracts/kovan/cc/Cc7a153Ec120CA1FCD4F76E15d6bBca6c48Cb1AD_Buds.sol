...
contract Buds is Context, IERC20, Ownable, VRFConsumerBase(0xdD3782915140c8f3b190B5D67eAc6dc5760C46E9, 0xa36085F69e2889c224210F603D836748e7dC0088) {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        uint secondThirdOfMax = firstThirdOfMax*2;
   ...
   function setAddresses(address _goodBudsWallet, address _smokeOutWallet, address _manualLiquidityWallet, address _budsBank, address _zombie) public onlyOwner {
    ...
    function contractCLinkTestingState() public onlyOwner() {
     setAddresses (
          0x409C262ED26950fAcb247D9eF23F20f05CD81709,
