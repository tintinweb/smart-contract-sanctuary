...
contract FactoryErc721 is AccessControl, ExchangeProvider {
    ...
    function makeERC721(
        ...
        ERC721Main newAddress = new ERC721Main(name, symbol, baseURI, CONTRACT_URI, signer, address(_emitter));
        _emitter.addValidAddress(address(newAddress));
    ...
    function setEmitter(address _emitterAddress) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(_emitterAddress != address(0), "invalid address");
        _emitter = EventEmitter(_emitterAddress);
    }
    ...
    AccessControl
{
    ...
    EventEmitter private immutable _emitter;
        ...
        override(ERC721, ERC721URIStorage)
    {
        ...
        _emitter.emitERC721Transfer(owner, address(0), tokenId);
    }
    ...
    function _safeMint(address to, uint256 tokenId) internal override(ERC721) {
        ...
        _emitter.emitERC721Transfer(address(0), to, tokenId);
    }

    function _transfer(address from, address to, uint256 tokenId) internal override(ERC721) {
        ERC721._transfer(from, to, tokenId);
        _emitter.emitERC721Transfer(from, to, tokenId);
    }
