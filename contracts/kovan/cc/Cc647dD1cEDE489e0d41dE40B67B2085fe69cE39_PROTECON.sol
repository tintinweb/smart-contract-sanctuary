...
contract PROTECON {
    ...
    function initiateContract(address payable counterparty, uint256 SignDeadline, uint ContractDeadline, uint BackoutTime, address payable judge, string memory title, string memory currency, uint256 fee) public payable {
    ...
    function initiateContractToken(address payable counterparty, uint256 SignDeadline, uint ContractDeadline, uint BackoutTime, address payable judge, string memory title, uint256 amount, address token, string memory currency, uint256 fee) public payable {
