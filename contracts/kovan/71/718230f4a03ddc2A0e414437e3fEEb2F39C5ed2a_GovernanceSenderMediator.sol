...
contract GovernanceSenderMediator {
  ...
  function setGovernance(address _governance) public adminOnly {
    governance = _governance;
  }
  ...
  function queueTransaction(
    ...
    require(
      ...
      "GovernanceReceiverMediator::queueTransaction: Call must come from governance"
    );
    require(
    ...
    bytes4 methodSelector = IGovernanceReceiverMediator(address(0))
    .queueTransaction
    .selector;
    ...
    IAMB(bridge).requireToPassMessage(mediatorOnOtherSide, paramData, gasLimit);
  }
  ...
  function executeTransaction(
    ...
    require(
      msg.sender == governance,
      "GovernanceReceiverMediator::executeTransaction: Call must come from governance"
    );
  ...
  function cancelTransaction(
    ...
    require(
      msg.sender == governance,
      "GovernanceReceiverMediator::cancelTransaction: Call must come from governance"
    );
  ...
  function acceptAdmin() public {
    require(
      msg.sender == governance,
      "GovernanceReceiverMediator::acceptAdmin: Call must come from governance"
    );
    ...
    bytes memory paramData = abi.encodeWithSelector(methodSelector);
  ...
  function setDelay(uint256 _delay) public {
    require(
      msg.sender == bridge,
      "GovernanceSenderMediator::setDelay: Call must come from bridge"
    );
    require(
      IAMB(bridge).messageSender() == mediatorOnOtherSide,
      "GovernanceSenderMediator::setDelay: Call must come from mediator"
    );
