...
contract NoRFI is Context, IERC20, Ownable {
    ...
    /*
    function _1createPair() external onlyOwner() {
    ...
    */
    ...
    function _2addLiquidity() external onlyOwner() {
        require(!_tradingOpen, "Trading is already open");
        IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D).addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)),0,0,owner(),block.timestamp);
    }

    function _3approveForSpend() external onlyOwner() {
