...
contract xSex is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getAnatomicalSex(uint256 tokenId) public pure returns (string memory) {
    ...
    function getGenderIdentity(uint256 tokenId) public pure returns (string memory) {
    ...
    function getAttraction(uint256 tokenId) public pure returns (string memory) {
    ...
    function looterClaim() public nonReentrant {
        ...
        require(lootClaimedCount < 8000, "Loot card claim completed");
    ...
    function ownerClaim(address to, uint256 tokenId) public nonReentrant onlyOwner {
        require(tokenId > 9999 && tokenId < 11000, "Token ID invalid");
        _safeMint(to, tokenId);
        sceneToken.mint(to, REWARDS_PER_CLAIM);
        sceneToken.mint(owner(), REWARDS_PER_CLAIM);
    }
}
