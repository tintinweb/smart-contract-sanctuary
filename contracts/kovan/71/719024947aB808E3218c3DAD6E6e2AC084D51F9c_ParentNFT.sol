...
contract ParentNFT is ERC721, ChainlinkClient {
    //linkpool isn't using KeeperCompatible here so I'm not either?
    ...
    uint256 public largestChildTokenCount;
    ...
    function addMyToken(
        ...
        if (childTokenCount[parentTokenId] > largestChildTokenCount) {
            largestChildTokenCount = childTokenCount[parentTokenId];
        }
        return true;
    }
    ...
    function finalizeAndCreateFamilyPhoto(uint256 parentTokenId) public {
        ...
        //TODO add error handling...and create a single parent-token version of this
    ...
    function checkActiveStatusesAndRegenerateImgs() public returns (bool) {
        //called from keeper presumably. check ALL tokens. regen ONLY if something changed in the ActiveAddress array
    ...
    function performUpkeep(bytes calldata performData) external  {
        //given a list of parent token IDs,childtokens in performData, mark [email protected] as inactive.
