...
contract BeastNFT is ERC721, Ownable {
    ...
    function mint() external {
        ...
        if (randNum==0&&randNum<5) {
            beast = Beast("AAA", 6, 20, "QmTyQ3Mab2711GWGMyvXqMVCQpK49WH1KQRzhUBJS96Q7W");
        } else if (randNum>=5&&randNum<100) {
            beast = Beast("AAA", 5, 5, "QmcNEMp12fU7tNyTt8oRBKeW7QjXR9gLKwJoXPYAav86XV");
        } else if (randNum>=100&&randNum<800) {
            beast = Beast("AAA", 4, 4, "QmZwioRnSrxDUcDK1e4LNkvGi7WW9eJXnHrEwXavathiwe");
        } else if (randNum>=800&&randNum<2200) {
            beast = Beast("AAA", 3, 3, "Qmbdyp864SwZZ2X3yBWKX1YeSax4BRj8F3yvLM9PcgAXYw");
        } else if (randNum>=2200&&randNum<5000) {
            beast = Beast("AAA", 2, 2, "QmPbsQEreJNFVRkNkgyzDNTgkQ6Xt6GrPQXjz83FYTyQMi");
        } else {
