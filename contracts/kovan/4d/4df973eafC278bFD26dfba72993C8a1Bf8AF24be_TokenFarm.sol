...
contract TokenFarm is Ownable {
    ...
    function setPriceFeedContract(address _token, address priceFeed)
        public
        onlyOwner
    {
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            // send them token reward based on their value reward
        ...
        returns (uint256)
    {
        ...
        // 10 ETH -> 10 * 10**18
        // ETH/USD = 1/100 -> 1/(10**18)
        // 10 * 100 = 1000 -> 1000 * 10**18
        // 1000 * 10**18 / 10 ** 18
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        // remember stakers and number of staked tokens and amount
    ...
    function unstakeTokens(address _token) public {
        ...
        //TODO: remove msg.sender from stakers if uniqueTokensStaked = 0
    }
