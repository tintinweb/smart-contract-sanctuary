...
contract TokenPresale is Ownable {
    ...
    function existUser(string memory _userNickName) public view returns (bool) {
        require(keccak256(abi.encodePacked(_userNickName)) != keccak256(abi.encodePacked("")), "USER NICKNAME CAN'T BE EMPTY");
    ...
    function getWallet(string memory _userNickName) public view returns (address) {
        require(keccak256(abi.encodePacked(_userNickName)) != keccak256(abi.encodePacked("")), "USER NICKNAME CAN'T BE EMPTY");
    ...
    function getInviter(string memory _userNickName) public view returns (string memory) {
        require(keccak256(abi.encodePacked(_userNickName)) != keccak256(abi.encodePacked("")), "USER NICKNAME CAN'T BE EMPTY");
    ...
    function getInviteeList(string memory _userNickName) public view returns (string memory) {
        require(keccak256(abi.encodePacked(_userNickName)) != keccak256(abi.encodePacked("")), "USER NICKNAME CAN'T BE EMPTY");
    ...
    function buyPresale(string memory _userNickName) public payable {
        require(presaleStatus == true, "Presale : Presale is finished");
        require(keccak256(abi.encodePacked(_userNickName)) != keccak256(abi.encodePacked("")), "USER NICKNAME CAN'T BE EMPTY");
        require(msg.value >= 1 * 1e17, "Presale : Unsuitable Amount");
        require(msg.value <= 10 * 1e18, "Presale : Unsuitable Amount");
        
        uint256 tokenAmount = msg.value.mul(rewardTokenCount).div(1e18);
