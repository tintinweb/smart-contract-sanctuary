...
contract PickleVoterProxy {
    ...
    address public constant gaugeController = address(0x2e57627ACf6c1812F99e274d0ac61B786c19E74f);
    ...
    function voteGaugeWeight(address[] calldata _tokenVote, uint256[] calldata _weight) external returns(bool){
        ...
        //vote
        IVoting(gaugeController).vote(_tokenVote, _weight);
        return true;
    }
