...
contract EXTERNAL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"External";
    string private constant _symbol = unicode"EXTERNAL";
    ...
    function getTokenBalanceOf(address holder) public view returns (uint256) {
        return myToken.balanceOf(holder);
    }    
}