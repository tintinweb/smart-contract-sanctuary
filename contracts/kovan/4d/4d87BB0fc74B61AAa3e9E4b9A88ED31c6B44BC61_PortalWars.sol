...
contract PortalWars{
    ...
    mapping (address => uint256) public secondBRS; 
    mapping (address => uint256) public thirdBRS;
    ...
    function getHighestBRS(PortalAavegotchiTraitsIO[PORTAL_AAVEGOTCHIS_NUM] memory portalAavegotchiTraits_) public view returns(uint256 _highestBRS/*, uint256 _secondBRS, uint256 _thirdBRS*/){
        _highestBRS = 0;
        //_secondBRS = 0;
        //_thirdBRS = 0;
        ...
        for(uint i = 0; i < PORTAL_AAVEGOTCHIS_NUM; i++){
            ...
            if(BRS > _highestBRS){
                //_thirdBRS = _secondBRS;
                //_secondBRS = _highestBRS;
                _highestBRS = BRS;
    ...
    function collectPrizes() public{
        ...
        highBRS[msg.sender] = 0;
        highBRS[opponents[msg.sender]] = 0;
