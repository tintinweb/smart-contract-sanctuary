    ...
    function _setHeroEquipment(uint heroId, uint[] memory itemIds, bool isRemove) private {
        ...
        if(isRemove == false){
            ...
            for (uint i = 0; i < itemIds.length; i++) {
                ...
                if (hero.gem1 != 0 && hero.gem1 == itemId) {
                    hero.gem1 = 0;
                } else if (hero.gem2 != 0 && hero.gem2 == itemId) {
                    hero.gem2 = 0;
                } else if (hero.gem3 != 0 && hero.gem3 == itemId) {
                    hero.gem3 = 0;
                } else if (hero.gem4 != 0 && hero.gem4 == itemId) {
                    hero.gem4 = 0;
                } else if (hero.gem5 != 0 && hero.gem5 == itemId) {
                    hero.gem5 = 0;
                }
            }
        }
