...
// Part: OpenZeppelin/[email protected].4.0/SafeMath
...
// File: EnchantedCollectible.sol

contract EnchantedCollectible is ERC721, VRFConsumerBase {
    ...
    constructor(
        ...
        ERC721("Stalker_Factions", "Factions")
    {
        keyHash = _keyHash;
        fee = 0.1 * 10**18;
        tokenCounter = 0;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
        ...
        override
    {
        address factionBadgeOwner = requestIdToSender[requestId];
        string memory tokenURI = requestIdToTokenURI[requestId];
        uint256 newItemId = tokenCounter;
        _safeMint(factionBadgeOwner, newItemId);
        _setTokenURI(newItemId, tokenURI);
        Breed factionBreed = Breed(randomNumber % 10);
        tokenIdToBreed[newItemId] = factionBreed;
