 ...
 */
contract LimitOrders is Ownable, OnlyDxln, IAutoTrader, ICallee {
    ...
    // bytes32 private constant FILELIMIT = "LimitOrders";
    ...
    /* solium-disable-next-line indentation */
    bytes32 private constant EIP712_LIMIT_ORDER_STRUCT_SCHEMA_HASH =
        keccak256(
            abi.encodePacked(
                "LimitOrder(",
                "uint256 makerMarket,",
    ...
    function getOrderHash(Order memory order) private view returns (bytes32) {
        ...
        bytes32 structHash = keccak256(
            abi.encode(EIP712_LIMIT_ORDER_STRUCT_SCHEMA_HASH, order)
        );
