...
contract MomentumSale is ReentrancyGuard, Context, IMomentumSale {
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "Error: create new sale after 24 hours"
        );
        ...
        returns (bool)
    {
        ...
        IERC20(edgexTokenContract).transfer(_msgSender(), totalTokens);
        IERC20(edgexTokenContract).transfer(organisation, orgTokens);
