...
contract ForRentReservation is ForRentFactory {
    ...
    function reserve(uint256 _forRentId) public {
        ...
        require(forRent.reservated == true, "Oups, already reservated!");
        ...
        bool sent = drtToken.transferFrom(
            msg.sender,
            forRentToOwner[forRent.lockBoxAddress],
            amountExpected
        );
        ...
        forRentToRenter[forRent.lockBoxAddress] = msg.sender;
    }
    ...
    function cancelReservation(uint256 _forRentId) public {
        ...
        require(forRent.reservated == false, "Oups, it isn't reservated!");
        ...
        bool sent = drtToken.transferFrom(
            msg.sender,
            forRentToRenter[forRent.lockBoxAddress],
            amountExpected
        );
