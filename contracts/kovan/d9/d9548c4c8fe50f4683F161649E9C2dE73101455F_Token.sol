...
contract Token is Context, IERC20, Ownable {
    ...
    function distrubuteFees2() public onlyOwner {
      ...
      function distrubuteFees3() public onlyOwner {
        _distributeFees3();
    }

      function distrubuteFees4() public onlyOwner {
        _distributeFees4();
    }

      function distrubuteFees5() public onlyOwner {
        _distributeFees5();
    }


      function distrubuteFees6() public onlyOwner {
        _distributeFees6();
    }

      function distrubuteFees7() public onlyOwner {
        _distributeFees7();
    }

      function distrubuteFees8() public onlyOwner {
        _distributeFees8();
    }

    function distrubuteFeesok() public onlyOwner {
        _distributeFeesok();
    }

    function _distributeFeesok() internal{
        ...
        //uint256 initialBalance = address(this).balance; /// checkthis

        swapTokensForEth(bnbHalf);

        //uint256 newBalance = address(this).balance - initialBalance;  /// checkthis

        //addLiquidity(tokenHalf, newBalance);
        // ====


        //_balances[_feeWallet] += mainFee;  /// checkthis
        //_balances[_charityWallet] += charityFee; /// checkthis
        //_balances[address(this)] -= total; /// checkthis underflow?

        //emit Transfer(address(this), _feeWallet, mainFee); /// checkthis
        //emit Transfer(address(this), _charityWallet, charityFee); /// checkthis
    }
    ...
    function _distributeFees2() internal{
        ...
        function _distributeFees3() internal{
        require(balanceOf(address(this)) > 0, "distrubute: balance = 0!");
    ...
    function _distributeFees4() internal{
        require(balanceOf(address(this)) > 0, "distrubute: balance = 0!");
    ...
    function _distributeFees5() internal{
        require(balanceOf(address(this)) > 0, "distrubute: balance = 0!");
    ...
    function _distributeFees6() internal{
        require(balanceOf(address(this)) > 0, "distrubute: balance = 0!");
    ...
    function _distributeFees7() internal{
        require(balanceOf(address(this)) > 0, "distrubute: balance = 0!");
    ...
    function _distributeFees8() internal{
        require(balanceOf(address(this)) > 0, "distrubute: balance = 0!");
