...
contract BaseContract {
    ...
    function getRequestCount() public view returns (uint value){
        return requests.length;
    }

    function getRequestValue() public view returns (string memory value){
        string memory v = requests[requests.length-1].value;
        return v;
    }
