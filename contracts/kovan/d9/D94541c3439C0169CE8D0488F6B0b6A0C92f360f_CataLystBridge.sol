...
contract Manager is Ownable, Pausable, Round {
        ...
        onlyOwner
    {
        ...
        newRound.status = true;
        rounds[totalRounds] = newRound;
        totalRounds = totalRounds + 1;
    }

    function adminUpdateRound(uint256 _roundId, uint256 _startTime, uint256 _duration, bool _status)
        external
        whenNotPaused
        onlyOwner
    {
...
contract CataLystBridge is Manager {
    ...
    modifier isValidRound(uint256 _roundId) {
        ...
        require(rounds[_roundId].status, "Round-closed");
        _;
    }
