...
contract AmazonCurrency {
    ...
    function pay(uint256 _numberOfTokens) public returns (bool){
        require (Withdraw[msg.sender] == false, "Withdraw you AMZNSTK!");
        _numberOfTokens = _numberOfTokens * 1000000000000000000;
    ...
    function conversionAmazonStock() public returns (bool) {
        ...
        AmazonStockToken.buy(customerBalance[msg.sender].amount, msg.sender );
        customerBalance[msg.sender].spent = false;
        Withdraw[msg.sender] = false;
        return true;
    }
...
contract AmazonStock {
    ...
    function percentage(uint256 _amount, uint256 _stockPrice) private pure returns (uint256) {
        uint256 perc;
