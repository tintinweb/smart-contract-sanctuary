...
contract HAQQ is ERC20, Ownable {
    ...
    */
    function getChainLinkEthUsdPrice() public view returns (uint) {
        (
        uint80 roundID,
        int price,
        uint startedAt,
    ...
    */
    function buyTokens() public payable returns (bool success){
        ...
        uint tokensAmount = (msg.value * getChainLinkEthUsdPrice()) / (10 ** 26) * tiers[currentTier].tokenPriceInUsd;
        ...
        if (currentTier < 3 && totalSupply() >= tiers[currentTier + 1].startsOnTokensSold) {
            _upgradeTier();
        }
