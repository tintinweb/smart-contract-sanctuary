...
contract VaultRouter is RoleAware, BaseRouter {
        ...
        external
    {
        ...
        uint256 extinguishAmount =
            IMarginTrading(leverageTrading()).recordDeposit(
                msg.sender,
                depositToken,
                depositAmount
            );
    ...
    function bridgeOvercollateralizedCredit(
        ...
        IMarginTrading(leverageTrading()).recordOvercollLoan(
            msg.sender,
            depositToken,
            depositAmount,
            borrowToken,
    ...
    function bridgeCloseAccount() external {
        (address[] memory holdingTokens, uint256[] memory holdingAmounts) =
            IMarginTrading(leverageTrading()).getHoldingAssetAmount(msg.sender);

        // requires all debts paid off
        IMarginTrading(leverageTrading()).recordMarginCall(msg.sender);
    ...
    function registerTrade(
        ...
        (uint256 extinguishAmount, uint256 borrowAmount) =
            IMarginTrading(leverageTrading()).recordSwapAndLoan(
                trader,
                inToken,
                outToken,
                inAmount,
...
interface IMarginTrading {
    ...
    function recordMarginCall(address trader) external;

    function getHoldingAssetAmount(address trader)
        external
        view
        returns (
    ...
    function getLoanAmount(address trader)
        external
        view
