...
contract AccuweatherConsumer3 is ChainlinkClient {
     ...
     * @param _locationResult The location information (encoded as tuple).
     * @param _currentConditionsResult The current weather conditions (encoded as tuple).
     */
    function fulfillLocationCurrentConditions(
        ...
        if (_locationFound) {
            // Location
            LocationResult memory locationResult = abi.decode(_locationResult, (LocationResult));

            location.locationFound = true;
            location.locationKey = locationResult.locationKey;
            location.name = locationResult.name;
            location.countryCode = locationResult.countryCode;
            ...
            currentConditions.locationKey = locationResult.locationKey;
