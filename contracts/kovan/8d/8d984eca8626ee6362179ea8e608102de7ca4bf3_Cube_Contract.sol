...
contract Cube_Contract is Ownable, IST20 {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    ...
    function blackList(address _user) public onlyOwner {
        require(!isBlacklisted[_user], "Cube: user already blacklisted");
    ...
    function removeFromBlacklist(address _user) public onlyOwner {
        require(isBlacklisted[_user], "Cube: user already whitelisted");
    ...
    // ------------------------------------------------------------------------
    function multipleBlackList(address[] memory _users) public onlyOwner {
        for (uint8 i = 0; i < _users.length; i++) {
    ...
    function withdrawToken(address _token, uint256 _amount) external onlyOwner {
        IST20(_token).transfer(msg.sender, _amount);
    }
