...
contract swapContract is AccessControl
{
    ...
    function getMinConfirmationBlocks() public view returns(uint256) {
        return minConfirmationBlocks;
    }

    function setMinConfirmationBlocks(uint256 _minConfirmationBlocks) external onlyOwnerAndManager {
        require(_minConfirmationBlocks > 0, "swapContract: Minimum confirmation blocks cannot be zero");
        minConfirmationBlocks = _minConfirmationBlocks;
    }
