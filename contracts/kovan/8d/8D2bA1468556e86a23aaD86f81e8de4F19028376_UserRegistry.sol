...
contract UserRegistry is Registry, IUserRegistry,IERC1643{
    ...
    // function transferByPartition(address _from, address _to, uint256 _value, bytes32 _partition, bytes memory _data, address _operator, bytes memory _operatorData) external  override onlyToken returns (bytes32) {
