 ...
 */
contract ERC20UpgradeSafe is  IERC20, OwnableUpgradeSafe {
     ...
     */
    function transfer(address recipient, uint256 amount) whenNotPaused external returns (bool) {
