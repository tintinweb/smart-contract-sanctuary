...
contract MintLeverFactory is ConfigBase {
    ...
    event CreateMintLever(uint256 id, address indexed mintLever);

    event CreateContract(address indexed _contract);
    ...
    function cloneMint(address template) external onlyOwner {
        ...
        emit CreateMintLever(mints.length, mintLever);
    }
