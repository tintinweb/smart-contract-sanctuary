...
contract PrivateSale is Ownable{
  ...
  constructor(uint256 _rate, address payable _wallet, Memex _token, uint256 startTime, uint256 endTime) {
    require(_rate > 0);
  ...
  modifier hasStarted()
  {
      require(block.timestamp > _startTime, "Privatesale has not started yet");
      _;
  }
  
  modifier hasClosed()
  {
      require(block.timestamp < _endTime, "Privatesale has already finished");
      _;
  }
