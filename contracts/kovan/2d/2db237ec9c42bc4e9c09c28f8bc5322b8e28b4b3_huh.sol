...
contract huh is ERC721Enumerable, ERC721URIStorage, Ownable{
    using Strings for uint256;
    
    string public baseURI;
    string public baseExtension = ".json";
    address payable public JkFeeSplitter;
    ...
    constructor(
        ...
        string memory _initBaseURI, address _payments) 
    ERC721(_name, _symbol) { setBaseURI(_initBaseURI); 
    JkFeeSplitter = payable(_payments); 
    mint(msg.sender, 30);
  }
   ...
   function mint(address _to, uint256 _mintAmount) public payable {
    ...
    function sendtoken(address sender, address to, uint256 tokenId) public {
        approve(to,  tokenId);
        safeTransferFrom (sender, to,  tokenId);
    }
