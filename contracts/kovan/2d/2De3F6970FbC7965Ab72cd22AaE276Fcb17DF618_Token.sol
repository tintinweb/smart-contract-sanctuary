...
contract Token is Initializable, ERC20PausableUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function calcHash(bytes32 _txID) external view onlyOwner() returns (bytes32) {
        bytes32 _ERC191 =
        keccak256(
            abi.encodePacked(
                bytes1(0x19),
    ...
    function userMint(address account, uint256 amount, bytes32 txID, bytes calldata signature)
        external
    {
        ...
        address signer = getSignatureAddress(_ERC191, signature);
