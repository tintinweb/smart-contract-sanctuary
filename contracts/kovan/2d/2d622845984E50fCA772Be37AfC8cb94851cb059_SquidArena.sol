...
contract SquidArena is ERC721, ERC721Enumerable, Ownable, ERC721Pausable, VRFConsumerBase {
  ...
  // Constants
  uint256 public constant NUM_ROUNDS = 8; // Number of rounds this game will last
  uint256 public constant MAX_ELEMENTS = 2**NUM_ROUNDS; // Max number of tokens minted
  uint256 public constant PRICE = 7 * 10**15; // Price to mint a single token
  uint256 public constant MAX_BY_MINT = 128; // Max number of tokens to be minted in a single transaction
