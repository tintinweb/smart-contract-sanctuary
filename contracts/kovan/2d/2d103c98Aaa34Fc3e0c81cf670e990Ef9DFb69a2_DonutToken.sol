...
contract DonutToken is ERC20, BoringOwnable {
   using BoringMath for uint256;
   // ERC20 'variables'
   string public constant symbol = "DT";
   string public constant name = "DonutToken";
   ...
   function mint(address to, uint256 amount) public onlyOwner {
       require(to != address(0), "DT: no mint to zero address");
   ...
   function burn(uint256 amount) public {
       require(amount <= balanceOf[msg.sender], "DT: not enough");
