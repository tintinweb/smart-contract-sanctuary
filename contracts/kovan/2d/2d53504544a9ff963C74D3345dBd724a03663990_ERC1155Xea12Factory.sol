 ...
 *
 */
contract ERC1155Xea12Factory is Ownable {
    IBeacon public beacon;
    address transferProxy;
    address lazyTransferProxy;

    event Create1155Xea12Proxy(BeaconProxy proxy);
    ...
    function createToken(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external {
        bytes memory data = abi.encodeWithSelector(ERC1155Xea12(0).__ERC1155Xea12_init.selector, _name, _symbol, baseURI, contractURI);
        BeaconProxy beaconProxy = new BeaconProxy(address(beacon), data);
        ERC1155Xea12 token = ERC1155Xea12(address(beaconProxy));
