...
// File: contracts/Hentai4AnimeLovers.sol


pragma solidity ^0.8.4;


contract Hentai4AnimeLovers is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    using Address for address;
  ...
  // Minting constants
    ...
    constructor() ERC721("Hentai 4 Anime Lovers", "H4AL") {
    }
    ...
    // @dev Reserves limited number of NFTs for giveaways or promotional purposes.
    ...
    function mintPublicSale(uint tokensCount) public nonReentrant payable {
      require(_isSaleActive, "Have patience, Party is yet to start");
      require(totalSupply() < MAX_SUPPLY, "All H-Anime Girls have been minted");
      require(tokensCount > 0, "You must mint more than 0 H-Anime Girls");
