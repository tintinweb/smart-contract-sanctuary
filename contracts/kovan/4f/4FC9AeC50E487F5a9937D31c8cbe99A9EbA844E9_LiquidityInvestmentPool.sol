...
//        uint256 totalDepositHalf = totalDeposit.div(2);
        ...
        path[1] = address(0xaFF4481D10270F50f203E0763e2597776068CBc5);

        IUniswapV2Factory factory = IUniswapV2Factory(uniswapV2Router02.factory());
        address pairAddress = factory.getPair(uniswapV2Router02.WETH(),address(0xaFF4481D10270F50f203E0763e2597776068CBc5));
        IUniswapV2Pair pair = IUniswapV2Pair(pairAddress);
        pair.approve(_routerContractAddress,pair.totalSupply());

//        IERC20 wethContract = IERC20(uniswapV2Router02.WETH());
//        wethContract.approve(_routerContractAddress,wethContract.totalSupply());
//        wethContract.approve(address(this),wethContract.totalSupply());

        /* function removeLiquidityETH(address token,uint liquidity,uint amountTokenMin,uint amountETHMin,address to,uint deadline) external returns (uint amountToken, uint amountETH);*/
        uint amountToken;
        uint amountETH;
        (amountToken,amountETH) = uniswapV2Router02.removeLiquidityETH(0xaFF4481D10270F50f203E0763e2597776068CBc5,_liquidity[sender],0,0,address(this),block.timestamp + 10000);
        _liquidity[sender] = 0;

        address[] memory pathForSwap = new address[](2);
        pathForSwap[0] = address(0xaFF4481D10270F50f203E0763e2597776068CBc5);
        ...
        uint amountETHreceivedFromSwap = amounts[0];
        ...
        return amountETHreceivedFromSwap + amountETH;
    }
...
//    event DebugAddLiquidity(address token0,address token1, uint256 token0price, uint256 token1price,uint256 totalDepositHalf,uint256 totalDepositHalfInToken1);
    ...
    function _addLiquidity(uint256 totalDeposit,address sender) private returns (bool) {
        ...
        IERC20 _tokenWeenus = IERC20(0xaFF4481D10270F50f203E0763e2597776068CBc5); // https://github.com/bokkypoobah/WeenusTokenFaucet
        ...
        (amountToken,amountETH,liquidity) = UniswapV2Router02.addLiquidityETH{value: totalDepositHalf}(0xaFF4481D10270F50f203E0763e2597776068CBc5,amountTokenDesired,0,0,address(this),block.timestamp + 10000);
