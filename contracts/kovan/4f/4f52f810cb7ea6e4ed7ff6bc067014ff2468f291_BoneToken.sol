...
contract BoneToken is ERC20("BONE DOGECOIN KILLER", "BONE"), Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        emit DelegationTransferCaled(sender, recipient, amount);
    }
    ...
    event DelegateVotesChanged(address indexed delegate, uint previousBalance, uint newBalance);
        ...
        /// @notice An event thats emitted when a delegate account's vote balance changes
    event DelegationTransferCaled(address indexed delegateFrom, address indexed delegateTo, uint256 theBalance);
