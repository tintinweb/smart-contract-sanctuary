...
contract Periphery is IPeriphery, ReentrancyGuard {
    ...
    function newLimitLiquidity(
        ...
        emit RebalanceRangeLiqudity(address(vault), _limitLower, _limitUpper, _percentage);
    }
...
/// @title Aastra Periphery
/// @author 0xKal1
/// @notice Aastra Periphery provides simple interface for SM to interact with vault
