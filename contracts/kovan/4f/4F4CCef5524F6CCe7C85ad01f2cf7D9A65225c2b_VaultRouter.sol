...
contract VaultRouter is RoleAware, BaseRouter {
    ...
    function crossBorrow(address borrowToken, uint256 borrowAmount) external {
        ...
        Lend(lending()).updateHourlyYield(borrowToken);
    ...
    function registerTrade(
        ...
        if (extinguishAmount > 0) {
            ...
            Lend(lending()).updateHourlyYield(outToken);
            IncentiveReporter.subtractFromClaimAmount(
                outToken,
                trader,
                extinguishAmount
        ...
        if (borrowAmount > 0) {
            ...
            Lend(lending()).updateHourlyYield(inToken);
    ...
    function _fundSwapExactT4T(
        ...
        _swap(amounts, pairs, tokens, asset());
    }
