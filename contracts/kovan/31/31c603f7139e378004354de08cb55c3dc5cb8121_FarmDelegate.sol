...
contract FarmDelegate is FarmStorageV1 {
    ...
    (
        ...
        uint256 allocPoint,
        uint256 lastRewardBlock,
        uint256 accGanPerShare,
        uint256 accLockGanPerShare,
        uint256 accUsdtPerShare,
        uint256 totalAmount,
        uint256 lastAccLockGanPerShare,
        uint256 convertRate,
        ...
        accGanPerShare = pool.accGanPerShare;
        accLockGanPerShare = pool.accLockGanPerShare;
        ...
        lastAccLockGanPerShare = pool.lastAccLockGanPerShare;
