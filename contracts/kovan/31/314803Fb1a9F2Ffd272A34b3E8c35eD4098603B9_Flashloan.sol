...
contract Flashloan is FlashLoanReceiverBase {
    ...
    event FlashloanReceived(address initiator, uint256 amount, uint256 fee, bytes params);
    ...
    function executeOperation(
        ...
        emit FlashloanReceived(initiator, amounts[0], premiums[0], params);

        revert('nothing to do here');
        /**
