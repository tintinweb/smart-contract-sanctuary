...
contract MNT is ERC20, ERC20Detailed, PriceConsumerV3{
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint;

  constructor () ERC20Detailed("MENT", "MNT", 2) PriceConsumerV3() public{

    _totalSupply = 10000000 * (10**uint256(2)) ;
...
contract tokenSale is Ownable, PriceConsumerV3{
  ...
  // The token being sold
    ...
    function buy(address beneficiary) payable  public
    {
        ...
        amountOfTokens =  unitPrice * uint256(10**2); //1 MNT token * USD amount of Value
