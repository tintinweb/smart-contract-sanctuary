    ...
    ERC721Burnable
{
    ...
    string public prefix =
        '{"title": "Kyoko BToken","type": "object","properties": {"name": {"type": "string","description": "BToken"},"description": {"type": "string","description": "This token is used to redeem the collateral."},"image": {"type": "string","description": "http://app.kyoko.finance/btoken/';
    ...
    function mint(address player) public onlyOwner returns (uint256) {
        ...
        string memory _URI = strConcat(prefix, uint2str(newItemId), suffix);
