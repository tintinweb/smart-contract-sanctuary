...
contract Dispatcher is IDispatcher {
    ...
    function __isContract(address _who) public view returns (bool isContract_) {
        uint256 size;
        assembly {
...
contract VaultProxy {
    constructor(bytes memory _constructData, address _vaultLib) public {
        // "0x3b5a7770459800df1d6333d62cac9887c9f88b09f54508f5ae9aca9f9becef72" corresponds to
        // bytes32(keccak256('tao2.0.proxiable.vaultlib'))
        require(
            bytes32(
                0x3b5a7770459800df1d6333d62cac9887c9f88b09f54508f5ae9aca9f9becef72
