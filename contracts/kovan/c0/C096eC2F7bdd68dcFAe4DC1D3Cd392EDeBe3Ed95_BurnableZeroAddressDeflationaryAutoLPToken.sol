...
contract BurnableZeroAddressDeflationaryAutoLPToken is DeflationaryAutoLPToken {
    ...
    constructor(
        ...
        _isExcludedFromReward[ZERO_ADDRESS] = 1;
    }
    ...
    function burn(uint256 amount) external {
        ...
        _tokenTransfer(_msgSender(), ZERO_ADDRESS, amount, false);
    }

//this method is responsible for taking all fee, if takeFee is true
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) internal override {
            ...
            if (takeFee) {
                ...
                if (!isRecipientExcluded) {
                    if (isSenderExcluded) {
                        ...
                        _tIncludedInReward -= tBurn;
                        _rIncludedInReward -= tBurn * rate;                      
                    }
                }

                _tOwned[ZERO_ADDRESS] += tBurn;
...
contract DeflationaryAutoLPToken is Context, IERC20, Ownable {
