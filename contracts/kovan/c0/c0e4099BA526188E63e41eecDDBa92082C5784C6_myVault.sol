...
contract myVault {
	...
	function rebalance() public {
		...
		if (usdBalancePercentage < usdTargetPercentage) {
			uint amountToSellUSD = totalBalance / 100 * (usdBalancePercentage - (100 - usdTargetPercentage));
	...
	function buyWeth(uint amountToBuyUSD) internal {
		...
		uint256 amountIn = amountToBuyUSD; // includes 18 decimals
	...
	function sellWeth(uint amountToSellUSD) internal {
		...
		uint24 fee = 3000;
		address recipient = address(this);
		uint256 amountOut = amountToSellUSD; // includes 18 decimals
