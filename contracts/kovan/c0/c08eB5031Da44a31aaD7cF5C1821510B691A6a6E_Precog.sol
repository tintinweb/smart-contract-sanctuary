...
contract Precog is IPrecog {
    ...
    mapping(address => mapping(address => bool)) isTradeFinished;
    ...
    function getIsTradeFinished(address user, address futureContract) external view returns(bool) {
        return isTradeFinished[user][futureContract];
    }
    ...
    function withdrawLiquidate(address futureContract, address to, address user) external {
        require(!isTradeFinished[user][futureContract], "PrecogV2: ALREADY_LIQUIDATED");
    ...
    function liquidate(address futureContract, address user) external returns(uint256 amount) {
        ...
        isTradeFinished[user][futureContract] = true;
