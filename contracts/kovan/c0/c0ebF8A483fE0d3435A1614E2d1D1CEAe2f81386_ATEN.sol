...
contract ATEN is ERC721URIStorage, ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    string public prefix =
        '{"title": "Kyoko testToken","type": "object","properties": {"name": {"type": "string","description": "testToken"},"description": {"type": "string","description": "This token is used to test kyoko."},"image": {"type": "string","description": "http://app.kyoko.finance/btoken/';
