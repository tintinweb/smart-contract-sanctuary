...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public softCapEthAmount = 900 ether;
    uint256 public hardCapEthAmount = 8000 ether;
    ...
    constructor(
        ...
        token = _token;
        // presale = 0xB4FbD6a28beB7b2B5140ED67D8Bd35232fee8249;
        presale = 0xdA9f9d44F4c5022c789641802c10Da5992557D35;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(60 days);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.125 ether; // 8 tokens per BNB
