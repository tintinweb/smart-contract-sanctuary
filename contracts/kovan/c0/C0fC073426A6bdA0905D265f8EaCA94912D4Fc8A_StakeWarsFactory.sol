...
contract StakeWarsFactory is ERC721Enumerable, Administerable, VRFConsumerBase {
    event RequestedRandomness(bytes32 indexed requestId, address sender);
    ...
    mapping(uint256 => StakeWarInternals) public tokenIdToStakeWarrior;
        ...
        override
    {
        ...
        caught = true;
        StakeWarInternals warrior = tokenIdToStakeWarrior[tokenId];
    ...
    function createMint(uint256 i) internal {
        ...
        requestIdToUser[requestId] = User(msg.sender, _tokenIdsGen);
        StakeWarInternals warrior = new StakeWarInternals(
            _tokenIdsGen,
            securityKey
        );
