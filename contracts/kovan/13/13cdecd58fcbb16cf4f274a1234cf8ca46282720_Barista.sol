...
// Barista is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterCafe.
contract Barista {
    using SafeMath for uint256;
    ...
    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many BEAN tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws BEAN tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes BeanRoast tokens.
    ...
    // Deposit BeanRoast tokens to Barista for Reward allocation.
    ...
    // Withdraw BeanRoast tokens from Barista.
