...
// token transfers
// ----------------------------------------------------------------------------
contract OnePlanetOffset is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        checkGasFactor = 1;
        offsetSwitch = 1;
        offsetMsg = "These tokens are carbon neutral using 1PLANET. Visit www.1PLANET.app to verify Tx info. Burning one 1PLCO2 = offsetting 1 metric ton of CO2.";
