    ...
    ReentrancyGuardUpgradeable
{
    ...
    function _mintAndDeposit(
        ...
        ensureMinimumMintingAmount(msg.sender, token, tokenQuote, tokenAmount);
    ...
    function mintWithoutCollateral(
        ...
        ensureMinimumMintingAmount(msg.sender, token, quote, tokenAmount);
    ...
    function burn(
        ...
        require(handle.getDebt(msg.sender, token) >= amount, "IA");
        ...
        uint256 fee =
            ...
            // Cancel out fee ratio unit after fee multiplication.
                .div(1000)
                .mul(handle.getTokenPrice(token))
    ...
    function ensureMinimumMintingAmount(
        ...
        uint256 principal =
            handle.getPrincipalDebt(account, fxToken).add(newMintAMount);
        ...
        minimumMintingAmount =
            ((minimumMintingAmount + roundBy - 1) / roundBy) *
            roundBy;
        require(principal >= minimumMintingAmount, "IA");
    }
