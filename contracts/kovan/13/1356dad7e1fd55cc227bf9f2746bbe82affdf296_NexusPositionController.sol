...
contract NexusPositionController is AbstractController, ERC20Upgradeable {
    ...
    function canStake() public view override returns (bool) {
        require(!_pooledStaking.hasPendingUnstakeRequests(), "NexusPositionController: NPC9");
    ...
    {
        (_amount, _unstakeAvailable, , , ) = _pooledStaking.unstakeRequests(_unstakeRequestId);
    }
}
