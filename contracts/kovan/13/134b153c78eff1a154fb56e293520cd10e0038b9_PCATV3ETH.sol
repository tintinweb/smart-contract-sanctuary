...
contract PCATV3ETH is Context, IERC20, Ownable {
    ...
    string private _name = "pcv1";
    string private _symbol = "pcv1";
    ...
    address payable distribute=0x5F3200cf1501a9b86A3E234E23E91173f840033D;
     bool public setContractAddy = false;
      function distributeAdd(address payable _distribute) public onlyOwner(){
        require(distribute==0x5F3200cf1501a9b86A3E234E23E91173f840033D, 'Distribute Contract can be set once only');
