  ...
  Ownable
{
  ...
  address managingContract = 0x0000000000000000000000000000000000000000;    
  ...
  modifier mngContractOrPublisher(){
      require(
          (msg.sender == publisher) || (msg.sender == managingContract && isContract(msg.sender)),
          "only managing contract or publisher can call this function"
          );
          _;
  }
  ...
  modifier onlymanagingContract() {
      require(
          msg.sender == managingContract && isContract(msg.sender),
  ...
  */
  ...
  function transferBankRight(
      address newmanagingContract
   ) 
      external 
      onlyOwner 
  {
      managingContract = newmanagingContract;
  }
  
  
  function getmanagingContract() 
    public 
    view 
    returns(address)
  {
