...
contract TONKATSUTEST is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tonkatsu Inu TEST";
    string private constant _symbol = unicode"TONKATSUTEST";
