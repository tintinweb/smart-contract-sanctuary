...
contract Comptroller is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError{
    ...
    function mintAllowed(
        ...
        //这两个是和Comp代币有关的操作，先不用看
        updatePubSupplyIndex(pToken);
        
        //getCashPrior函数对于不同的资产返回的数量级不同，导致出现问题，需要特殊处理
        // console.log("mintAllow::distributeSupplierComp!");
    ...
    function borrowAllowed(
        ...
        if (LoanType.NORMAL == loanType) {
            ...
            distributeBorrowerComp(pToken, creditLoanBorrower, borrowIndex);
        }
    ...
    function repayBorrowAllowed(
        ...
        if (LoanType.NORMAL == loanType) {
            ...
            distributeBorrowerComp(pToken, payer, borrowIndex);
        }
    ...
    function distributeSupplierComp(address pToken, address supplier) internal {
        ...
        if (supplierIndex.mantissa == 0 && supplyIndex.mantissa > 0) {
            //compInitialIndex初始值: 1000000000000000000000000000000000000, 1e36
     ...
     */
    function claimCompV1(address holder) public {
        return claimCompV2(holder, allMarkets);
    }
     ...
     */
    function claimCompV2(address holder, PToken[] memory pTokens) public {
        address[] memory holders = new address[](1);
        holders[0] = holder;
        claimCompV3(holders, pTokens, true, true);
    }
    ...
    function grantCompInternal(address user, uint256 amount) internal returns (uint256) {
        ...
        console.log("amount:", amount, "compRemaining:", compRemaining);
