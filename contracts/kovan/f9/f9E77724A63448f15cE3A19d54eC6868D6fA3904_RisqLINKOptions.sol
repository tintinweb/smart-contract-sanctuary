...
/**
 * @author macemclain
 * @title Risq LINK Bidirectional (Call and Put) Options
...
contract RisqLINKOptions is Ownable, IRisqOptions {
    ...
    address[] public ethToLinkSwapPath;
    IERC20 public link;

    /**
     * @param _priceProvider The address of ChainLink LINK/USD price feed contract
    ...
    constructor(
        ...
        ethToLinkSwapPath = new address[](2);
        ethToLinkSwapPath[0] = uniswapRouter.WETH();
        ethToLinkSwapPath[1] = address(link);
        ...
        returns (uint256 optionID)
    {
        ...
        uint amountIn = swapToLINK(totalETH, total);
        ...
        )
    {
        ...
        totalETH = uniswapRouter.getAmountsIn(total, ethToLinkSwapPath)[0];
    }
     ...
     * @param period Option period in seconds (1 days <= period <= 4 weeks)
     * @param strike Strike price of the option
     * @param currentPrice Current price of LINK
    ...
    /**
     * @notice Swap ETH to LINK via Uniswap router
