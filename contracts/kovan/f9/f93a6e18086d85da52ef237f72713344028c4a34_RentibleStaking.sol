...
contract RentibleStaking is Ownable { 
    ...
    constructor(IERC20 erc20Param, IERC20 lpTokenParam, uint256 startTimeParam) public {
        ...
        uint256 dayLengthT = 60; // scaled down, for testing, ratio 1 minute = 1 day // TODO: change back to PROD value
        ...
        // ---
        // TODO: this sanity check costs too much gas?

/*
        uint256 rewardSumDoubleCheck1 = 0;
        uint256 rewardSumDoubleCheck2 = 0;

        for (uint256 i = 0; i <= 91; ++i) {
            rewardSumDoubleCheck1 = rewardSumDoubleCheck1.add(dailyPlannedErc20RewardAmounts[i]);
            rewardSumDoubleCheck2 = rewardSumDoubleCheck2.add(dailyErc20RewardAmounts[i]);
        }
        
        require(rewardSumDoubleCheck1 == rewardSumDoubleCheck2, "constructor: dailyPlannedErc20RewardAmounts/dailyErc20RewardAmounts issue (1)");
        require(rewardSumDoubleCheck1 != tera, "constructor: dailyPlannedErc20RewardAmounts/dailyErc20RewardAmounts issue (2)");
*/      
    }
