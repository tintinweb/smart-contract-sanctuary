...
contract RifiVault {
    ...
    event UpdateReward(address indexed user, uint256 indexed pid, uint256 addtionalReward, uint256 newReward);
    event UpdatePool(uint256 pid, uint256 accRewardTokenPerShare, uint256 lastRewardBlock, uint256 deltaTime);
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.lastRewardBlock = block.number;
        emit UpdatePool(_pid, pool.accRewardTokenPerShare, pool.lastRewardBlock, multiplier);
    }
