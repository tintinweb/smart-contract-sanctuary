...
/**
 * 
 * Be responsible! Good luck everybody!
...
contract TONKOTSUTEST is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tonkotsu Inu TEST";
    string private constant _symbol = unicode"TONKOTSUTEST";
    ...
    function setRemoveSellCooldownTime(uint256 nocooldown) external onlyOwner() {
        require(nocooldown > 0 && nocooldown < 7200, "Must be greater than 0 and less than 2 hours");
