 ...
 * behavior.
 */
contract x_Crowdsale is ReentrancyGuard, OwnerContract {
    using SafeMath for uint256;
...
contract x_Presale is x_Crowdsale {
    constructor (
        uint256 rate,
        address payable wallet,
        IERC20 token,
        ...
        public
        x_Crowdsale(rate, wallet, token, presaleAmount, minBuy, maxBuy, liquidRateFromPresale, _pancakeFactory, _pancakeRouter)
    {
    }
}