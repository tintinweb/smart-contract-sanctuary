...
contract EverPay {
    ...
    // Utils
    function txHash(uint256 proposalID, bytes32 everHash, address to, uint256 value, bytes memory data) public pure returns (bytes32) {
        return keccak256(abi.encodePacked(proposalID, everHash, to, value, data));
    }
