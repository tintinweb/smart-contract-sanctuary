...
contract LPStaking is ReentrancyGuard, Ownable {
    ...
    // Farming will be open on 14/03/2021 at 23:00:00 UTC
    uint256 public constant FARMING_START_TIMESTAMP = 1615762800;

    // No more rewards after 14/04/2021 at 23:00:00 UTC
    ...
    function withdraw(uint256 amount_) external nonReentrant {
        ...
        require(balanceOf(msg.sender) > 0, "LPStaking: Cannot withdraw 0");
        require(
...
contract LudusStaking is ReentrancyGuard, Ownable {
    ...
    function withdraw(uint256 amount_) external nonReentrant {
        ...
        require(
            balanceOf(msg.sender) > 0 && amount_ > 0,
            "LudusStaking: Cannot withdraw 0"
        );
        require(
