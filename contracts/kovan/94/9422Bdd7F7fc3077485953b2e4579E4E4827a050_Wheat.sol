...
contract Wheat is ERC777, IERC777Recipient, ReentrancyGuard, IERC721Receiver, ERC165, ERC721Holder  {
    ...
    */
        ...
        )
    {
        ...
        uint256 combinedMultipliers = compostMultiplier.mul(maturityMultiplier).mul(equipmentMultiplier).
        ...
        )
    {
        ...
        uint256 addressCombinedMultipliers = getCombinedMultipliers(targetAddress);
