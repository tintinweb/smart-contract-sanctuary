...
contract wxyGovern{
    ...
    function _setCollateralFactor(address cToken, uint newCollateralFactorMantissa) external {
        emit NewCollateralFactor(cToken, newCollateralFactorMantissa, newCollateralFactorMantissa);
    }
}