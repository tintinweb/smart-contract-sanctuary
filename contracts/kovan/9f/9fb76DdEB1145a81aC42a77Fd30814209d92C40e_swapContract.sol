...
contract swapContract is AccessControlEnumerable
{
    ...
    event Deposit(address user, uint256 amountToPay, uint256 amountToReceive, address newAddress);
    ...
    function getSwapLimits(address account) public view returns (uint256[3] memory)
    {
