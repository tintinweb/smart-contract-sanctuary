...
contract LiquidityPoolFarm is Ownable {
    ...
    function deposit(uint256 _amount) public {
        ...
        if (user.amount > 0) {
            ...
            if (pending > 0) {
                emit Test(accAdyPerShare, pending.mul(1e18), 0, 0);
        ...
        emit Test(accAdyPerShare, user.amount, user.rewardDebt, 0);
    ...
    function updatePool() public {
        ...
        uint256 currentReward = adyReward.mul(1e18).div(daiSupply);
        accAdyPerShare = accAdyPerShare.add(currentReward);
        emit Test(accAdyPerShare, adyReward, daiSupply, currentReward);
