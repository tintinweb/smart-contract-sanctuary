 ...
 */
    ...
    */
    ...
    function getPoolPairReserves(address pool) public view
    returns (uint112 reserve0, uint112 reserve1, address token0, address token1, address weth)
    {
        IPool _poolContract = IPool(pool);
        return _poolContract.getPoolPairReserves();
    }
