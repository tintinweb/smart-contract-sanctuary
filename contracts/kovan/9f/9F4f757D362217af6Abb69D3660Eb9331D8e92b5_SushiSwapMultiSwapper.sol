...
contract SushiSwapMultiSwapper {
    ...
    function swap (IERC20 tokenIn, IERC20 tokenOut, uint256 amountMinOut, address[] calldata path, uint256 shareIn, address to) external returns (uint256 shareOut) {
        ...
        (, shareOut) = bentoBox.deposit(tokenOut, address(bentoBox), to, amount, 0);
    }
