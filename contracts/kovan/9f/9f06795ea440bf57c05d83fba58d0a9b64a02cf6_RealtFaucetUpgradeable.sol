...
contract RealtFaucetUpgradeable is AccessControlUpgradeable {
  ...
  function setAmountAllowed(uint256 amountAllowed_) public onlyRole(_FAUCET_MODERATOR) {
  ...
  /// @return addmin address
  function getFaucetAdmin() external pure returns (bytes32) {
    return DEFAULT_ADMIN_ROLE;
  }
  /// @return moderator address
  function getFaucetModerator() external pure returns (bytes32) {
