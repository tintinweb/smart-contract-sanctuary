...
contract Airdrop is Ownable {
    ...
    uint256 public fee;
    address private mcnToken;
    address private usdcToken;

    
    constructor (uint256 _fee,address _admin,address _mcnToken, address _usdcToken) {
        fee = _fee;
        mcnToken= _mcnToken;
    ...
    function disperseMCNToken(address[] memory _recipients, uint256[] memory _amount) public payable returns (bool) {
     ...
     function disperseUSDCToken(address[] memory _recipients, uint256[] memory _amount) public payable returns (bool) {
