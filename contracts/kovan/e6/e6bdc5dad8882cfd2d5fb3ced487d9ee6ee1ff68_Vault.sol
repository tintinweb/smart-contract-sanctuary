...
//HIGH PRIORITY: SET THE MASTER ADDRESS WHEN YOU DEPLOY THIS FOR REAL
...
contract Vault 
{
    function deposit() public payable {
        address RECEIPT_TOKEN_ADDRESS = address(0x03b099B2cf0DF2c2d3D66BF2aBE5F6208e3fB80b);
        ...
        if (oldTokenSupply == 0) {
            ...
            uint256 oldVaultValue = calculateValueOfVault();
            receiptTokensOwed = (oldTokenSupply * depositValue) / oldVaultValue; //ensure arithmetic is correct and that this holds up in testing to be the right amount
        }
