...
contract PoolToken is Context, ERC20, Ownable, Pausable {
    ...
    function deposit(address erc20Addr, uint amount) public whenNotPaused {
    ...
    function redeemMany(address[] memory erc20s, uint[] memory amounts) public whenNotPaused {
     ...
     function redeemSingle(address account, address erc20, uint amount) public whenNotPaused {
    ...
    function offset(uint amount) public whenNotPaused {}
...
contract ProjectERC20 is Context, ERC20, IERC721Receiver {
    ...
    function onERC721Received(address operator, address from, uint256 tokenId, bytes calldata data)
        ...
        (string memory _projectId, uint16 _vintage, , uint quantity, bool confirmed) = IBatchCollection(msg.sender).getBatchNFTData(tokenId);
...
interface IRetirementBadgeCollection {
    ...
    function mintBadge(address to, string memory projectId, uint16 vintage, uint amount) external;
