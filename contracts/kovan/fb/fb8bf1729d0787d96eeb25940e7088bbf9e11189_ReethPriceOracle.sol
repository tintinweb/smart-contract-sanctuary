...
// It initially uses 1 minute averages but can be updated on the fly by governance
...
contract ReethPriceOracle {
    ...
    uint256 public updateFrequency = 1 minutes; // Oracle can be updated at least every 1 minute
