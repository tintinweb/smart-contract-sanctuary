...
contract SB is Ownable, IERC20 {
    ...
    address private britneyFund1 = address(1);
    address private britneyFund2 = address(2);
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100_000_000 * 10 ** 18; // SET CHANGE
    ...
    uint256 public _sellTxLimit = 60_000 ether;
    uint256 public _buyTxLimit = 1; // 0 to disable, 1 for auto mode
    uint256 public _maxAutoBuyTxLimit = 120_000 ether;
    uint256 public _sellCooldown = 60;
    uint256 public _buyCooldown = 60;
    bool public autoDonate = true;
    uint256 public pairPercentage = 15;
    uint256 private _initialBuyLimit = 30_000 ether;
    uint256 private _buyLimitIncrements = 15_000 ether;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (sender == _v2PairAddress) {
            if (_limitsEnabled && !_midSwap && recipient != owner()) {
    ...
    function setBlacklistStatus(address sender, bool status) external onlyOwner {
