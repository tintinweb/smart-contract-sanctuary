...
contract HAQQ is ERC20, Ownable {
    ...
    */
    ...
    /* Event to be emitted, when accepted coin removed  */
    event AcceptedCoinRemoved (address indexed coinAddress, address indexed addedBy);

    /*
    * Contract owner can remove accepted coin
    */
    function removeAcceptedCoin(address _address) external onlyOwner returns (bool success){
        acceptedCoins[_address] = false;
        emit AcceptedCoinRemoved(_address, msg.sender);
        return true;
    }
