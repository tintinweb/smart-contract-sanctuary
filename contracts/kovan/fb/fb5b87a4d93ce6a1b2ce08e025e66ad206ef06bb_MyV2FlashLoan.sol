...
//    ILendingPoolAddressesProvider _addressProvider = ILendingPoolAddressesProvider(0x88757f2f99175387aB4C6a4b3067c77A695b0349);
    ...
    function fWithdraw( address _token, uint _iApprove ) payable public returns( bool ) {
        ...
        if ( cWithdrawToken.balanceOf( address( this ) ) > 0 ){
            ...
            return cWithdrawToken.transfer( msg.sender, tokenBalance );
        }
