...
import "./interfaces/PaladinControllerInterface.sol";
import "./interfaces/PalPoolInterface.sol";
import "./interfaces/PalLoanTokenInterface.sol";
...
contract PalZap is Ownable, Pausable {
    ...
    function _makeSwap(
        ...
        if (_fromTokenAddress == address(0)) {
            ...
            IERC20(_fromTokenAddress).safeApprove(_allowanceTarget, _amount);
        }
...
interface PalPoolInterface {
    ...
    function palToken() external returns(address);
