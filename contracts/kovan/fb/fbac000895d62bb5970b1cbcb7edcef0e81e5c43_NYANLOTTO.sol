...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 lottoAllocation = _available.div(100).mul(30);
        uint256 marketingAllocation = _available.div(100).mul(50); 
...
contract NYANLOTTO is IERC20, Ownable {
    ...
    uint256 public swapThreshold = 1000 * 10**9;
    uint256 public tradeSwapVolume = 2000 * 10**9;
