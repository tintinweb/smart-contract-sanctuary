...
abstract contract Declaration is Global {
    ...
    uint32 constant SECONDS_IN_DAY = 3600 seconds; // for testing
    ...
    address constant DAI = 0x0637643CE48a65D97345Be974187Eb9edD84D78c; // kovan
    ...
    ILiquidityGuard public LIQUIDITY_GUARD = ILiquidityGuard(
        0x5AC6cE700Ab0a07Ae96890DE57D40e808b38EDE3 // kovan
    );
