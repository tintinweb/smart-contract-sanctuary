...
contract assignmentToken {
    ...
    uint256  MAXSUPPLY = 1000000; // // The total supply of the token is capped at 1,000,000 
    ...
    // reward 1 unit of the token to the minter with every transfer transaction
    event rewardMinter(uint256 blockNumber, uint256 token);
