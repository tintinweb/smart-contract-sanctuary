...
contract BFactory {
    ...
    function setKLabs(address b)
        external
    {
        require(msg.sender == _klabs, "ERR_NOT_KLABS");
        emit LOG_KLABS(msg.sender, b);
        _klabs = b;
    }
        ...
        external 
    {
        ...
        bool xfer = pool.transfer(_klabs, collected);
...
contract BToken is KTokenKase, IERC20 {
