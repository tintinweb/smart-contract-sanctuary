...
contract ERC20UpgradAndMintable is ERC20Upgradeable, MinterRole {
    /**
     * @dev See `ERC20._mint`.
     *
     * Requirements:
     ...
     * `amount`.
     */
    function getAirdrop(address recipient, uint256 amount)
        public
        onlyMinter
        returns (bool)
    {
...
contract TokenMintERC20MintableToken is Initializable, ERC20UpgradAndMintable {
    string private _name;
    string private _symbol;
    uint8 private _decimals;

    // constructor(string memory tokenName, string memory tokenSymbol, uint256 tokenDecimals, uint256 initialSupply, address payable feeReceiver, address tokenOwnerAddress)  payable{
    //   _name = tokenName;
    //   _symbol = tokenSymbol;
