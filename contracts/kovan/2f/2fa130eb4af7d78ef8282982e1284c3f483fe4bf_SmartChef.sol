...
contract SmartChef is Ownable {
    ...
    // Info of each pool.
    struct PoolInfo {
        IBEP20 lpToken;           // Address of LP token contract. (pancake kontrat adresi)
        uint256 allocPoint;       // How many allocation points assigned to this pool. CAKEs to distribute per block.  1000 girilmiş
        uint256 lastRewardBlock;  // Last block number that CAKEs distribution occurs. 
        uint256 accCakePerShare; // Accumulated CAKEs per share, times 1e12. See below.
    }

    // The CAKE TOKEN!
    IBEP20 public syrup; // cake 
    IBEP20 public rewardToken; //dusk
    ...
    constructor(
        IBEP20 _syrup, //cake
        IBEP20 _rewardToken, //dusk
        uint256 _rewardPerBlock, //1000
        uint256 _startBlock,
