...
contract PairFarmPool is Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        getRewards(periodIds);
    }

    /* 一次提取多期奖励 */
    function getRewards(uint256[] memory periodIds)
        public
        virtual
        nonReentrant
    {
    ...
    function _withdaw(address user, uint256 amount) private {
        require(amount > 0, "PairFarmPool: Amount must be greater than 0");
