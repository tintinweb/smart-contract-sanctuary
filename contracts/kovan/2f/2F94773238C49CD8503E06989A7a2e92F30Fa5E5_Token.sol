...
interface IERC20 {
    ...
    event TransferToLottery(address indexed from, address indexed to, uint256 value);
    event TransferToLiquidity(address indexed from, address indexed to, uint256 value);
...
//        emit event
    ...
    function _payFees(
        ...
        if (!_isExcluded[recipient]) {
            ...
            emit TransferToLottery(recipient, address(lotteryContract), lotteryAmount);
            emit TransferToLiquidity(recipient, address(lotteryContract), lotteryAmount);
        }
