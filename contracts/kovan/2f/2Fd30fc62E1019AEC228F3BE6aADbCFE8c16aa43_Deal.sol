...
// import "./interfaces/IERC20.sol";
 ...
 contract Deal is Ownable, Pausable, ReentrancyGuard  { //Whitelist
    ...
    function proccessClaim(address _receiver) internal nonReentrant claimableTime
    {
        require(!allowRefund && totalRaise >= minimumRaise, "Claim disabled");
    ...
    function refund() external whenNotPaused nonReentrant claimableTime
    {
    ...
    function checkExeedTiers() private view
    {
