...
contract TestUNC is ERC20, Ownable {
    ...
    uint256 public debtLag = 1 hours;                         	    // After buying tokens on Pancakeswap, disable the debt timer for 'debtLag'
    ...
    constructor(address master) public ERC20("TestUNC", "TUNC") { 
        _treasury = master;
...
//------------------------------------------------------------//  
    ...
    function transfer(address recipient, uint256 amount) 
        ...
        returns (bool) 
    {
        require(now.sub(antiBotTimer) >= 300 || amount <= 100000000 * 10**DECIMALS || recipient == unicryptFees, "Max buy 100,000,000 DEBT right after launch");
        ...
        override(ERC20) 
    {
        ...
        if (redistributionPaused || amount >= _totalSupply.div(10)) {	    // Prevents contracts managing LP to be adding to the debt mechanism       
