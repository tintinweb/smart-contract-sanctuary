...
// Froyo Staking contract for http://frozenyogurt.finance/
// Froyo staked within this contact entitles stakers to a portion of the admin fees generated by Frozen Yogurt' AMM contracts
...
contract MultiFeeDistribution is ReentrancyGuard, Ownable {
    ...
    function exit() external updateReward(msg.sender) {
        (uint256 amount, uint256 penaltyAmount) =
