...
contract OrderOfShadows is ERC721, Ownable { 
    ...
    string internal baseTokenURI = "https://nftorderofshadows.com/metadata/";
    ...
    address public a5 = 0x4f95219f13dC43641645B5ebE5259b040e38b281;
    ...
    function buyPresale(uint qty) external payable {
        ...
        require(balanceOf(msg.sender) + qty <= presaleMaxTx, "Too many, or you've alredy minted the maximum for presale");
        require(qty + nonce <= totalSupply, "Value exceeds totalSupply");
