...
contract BlossomCoin is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'BlossomCoin';
    string  private constant _SYMBOL = 'BLOSM';
    ...
    uint256 private     _TAX_FEE = 100; // 5% BACK TO HOLDERS
    uint256 private    _BURN_FEE = 100; // 5% BURNED
    uint256 private _CHARITY_FEE = 300; // 1% TO CHARITY WALLET
