...
contract NFT1 is ERC721Enumerable, ERC721Pausable, Ownable {
    ...
    constructor() ERC721("NFT1 Token", "NFT1") {}
    
    function mint10CoinTo(address to) public {
        if (to == address(0)) {
            to = address(this);
        }
        uint256 id;
    ...
    function mintAndInitBox(address boxContract) public {
        mint10CoinTo(msg.sender);
    }
