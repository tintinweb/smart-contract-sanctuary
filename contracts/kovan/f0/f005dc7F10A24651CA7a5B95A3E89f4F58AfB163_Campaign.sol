...
contract Campaign is Ownable, ReentrancyGuard, Pausable {
     ...
     * @return Returns the last ETH / USD price
     */
     ...
     */
    function setChainlinkContract(AggregatorV3Interface _chainlinkContract) external onlyOwner {
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "ICO_CAMPAIGN::TOKEN_AMOUNT_NOT_AVAILABLE"
        );
