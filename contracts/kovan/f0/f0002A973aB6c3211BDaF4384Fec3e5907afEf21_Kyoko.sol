...
contract Kyoko is Ownable, ERC721Holder {
    ...
    mapping(address => mapping(uint256 => ASSETS)) AssetsMap;
    ...
    event AddAssets(uint256 indexed _lTokenId, IERC20 _erc20Token);
    ...
    function repay(
        ...
        require(!_nft.marks.isRepay, "This debt has clear");
        require(!_nft.marks.liquidate, "This debt has liquidating");
        ...
        emit AddAssets(_nft.lTokenId, _nft.collateral.erc20Token);
