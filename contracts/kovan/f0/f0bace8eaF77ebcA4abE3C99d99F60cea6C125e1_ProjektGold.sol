...
contract ProjektGold is Context, IERC20, Ownable {
    ...
    event Staked(uint256 Stake, bool StakeVerified, uint256 StakeAmount);
...
// ####################
    ...
    function investorBalance(address _address) external view onlyInvestor returns(uint256){
        return m_iBalance[m_InvestorId[_address]].div(10**18);
    }
    ...
    function verifyStake() external onlyInvestor {
        ...
        emit Staked (m_Stake[_msgSender()], m_Staked[_msgSender()], m_Stake[_msgSender()]);
    }
