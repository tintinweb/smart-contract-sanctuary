...
contract ElonApeVaultKovan is ERC20("DAO Vault Elon", "daoELO"), Ownable, BaseRelayRecipient {
    ...
    function invest() external onlyAdmin {
        ...
        strategy.invest(
            _invest(_USDT, _poolInUSD),
            _invest(_USDC, _poolInUSD),
            _invest(_DAI, _poolInUSD)
        );
    }
