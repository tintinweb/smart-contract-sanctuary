...
contract WeatherNFT is ERC721, Ownable, ChainlinkClient, IERC721Receiver {
    ...
    mapping(bytes32 => address) requestIdToAttemptee;
    mapping(string => string) weatherToWeatherURI;
    mapping(uint256 => string) overRideTokenIdToWeatherURI;
    /**
    ...
    {   
        string memory stringResponse = bytes32ToString(_response);

        if(keccak256(abi.encodePacked(("tokenZero"))) == keccak256(abi.encodePacked((stringResponse)))){
            safeTransferFrom(address(this), requestIdToAttemptee[_requestId], 0);
        }
        if (keccak256(abi.encodePacked(("tokenOne"))) == keccak256(abi.encodePacked((stringResponse)))){
            safeTransferFrom(address(this), requestIdToAttemptee[_requestId], 1);
        }
        if (keccak256(abi.encodePacked(("tokenTwo"))) == keccak256(abi.encodePacked((stringResponse)))){
            safeTransferFrom(address(this), requestIdToAttemptee[_requestId], 2);
        }
        if (keccak256(abi.encodePacked(("tokenThree"))) == keccak256(abi.encodePacked((stringResponse)))){
            safeTransferFrom(address(this), requestIdToAttemptee[_requestId], 3);
        }
