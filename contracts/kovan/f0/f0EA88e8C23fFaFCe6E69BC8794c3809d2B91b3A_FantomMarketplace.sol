...
contract FantomMarketplace is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address payable _feeRecipient, uint16 _platformFee, IERC20 _RWT, address _ownerAddr)
        public
        initializer
    {
    ...
    function _buyItem(
        ...
        uint256 pricesubfee = price.sub(feeAmount);
        IERC20(_payToken).safeTransferFrom(
            _msgSender(),
            _owner,
            pricesubfee
        ...
        RWT.safeTransferFrom(ownerAddr, _owner, pricesubfee.mul(5).div(100));
        RWT.safeTransferFrom(ownerAddr, _msgSender(), pricesubfee.mul(5).div(100));
