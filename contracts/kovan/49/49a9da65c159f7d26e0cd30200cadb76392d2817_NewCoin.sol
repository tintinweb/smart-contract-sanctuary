...
contract NewCoin {
    ...
    uint256 constant TRANSACTFEE = 1;
  ...
  mapping(address => uint256) public balances;
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(TRANSACTFEE <= _value);
        balances[msg.sender] -= _value;
        balances[_to] += (_value - TRANSACTFEE);
        balances[minter] += TRANSACTFEE;
    ...
    function transferFrom(
        ...
        require(TRANSACTFEE <= _value,"Balance is insufficient to cover gas fees");
