...
contract Wheat is ERC777, IERC777Recipient, ReentrancyGuard, IERC721Receiver, ERC165, ERC721Holder  {
    ...
    */
     ...
     */
    uint256 public immutable fee = 100; // 1% 
    ...
    */
        ...
        preventSameBlock(_msgSender())
    {
        ...
        (,,, uint256 amountUnderlying,) = getUnderlyingTokenDetails(amount); // Returns the underlying LAND
    ...
    function release()
        ...
        requireEquipment(_msgSender(), false) // You can't release the LAND until you have released your farmland equipment
    {
        ...
        uint256 feeAmountLP = fee.mul(amountLP).div(_percentMultiplier);
    ...
    function getUnderlyingTokenDetails(uint256 amount)
        public
        view
        returns (
