...
contract PharoStakePool is Context, AccessControl, Ownable, ReentrancyGuard {
    ...
    function updateBurnAddress(address _burnAddress)
        ...
        onlyOwner 
    {
        require(hasRole(OPERATOR_ROLE, msg.sender), "PharoDao :: not in the Operator role, sorry...");
        ...
        public
    {
        ...
        uint256 contractBeforeBalance = phroToken.balanceOf(address(this));
        ...
        onlyOwner
    {
        ...
        phroToken.mintTokens(address(this), pharoReward);
        ...
        nonReentrant
    {
        ...
        // gphroToken.burn(address(msg.sender), _amount);
...
contract PharoToken is TokenRecover, ERC20Snapshot {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
