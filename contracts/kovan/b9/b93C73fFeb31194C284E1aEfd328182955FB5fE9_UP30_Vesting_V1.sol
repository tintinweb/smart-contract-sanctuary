...
contract UP30_Vesting_V1 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
      ...
      _name = "Up 30 Vesting";
      _decimals = 10;
      _totalSupply = 0 * 10 ** decimals();//Start with zero coins -> mint and burn as needed
