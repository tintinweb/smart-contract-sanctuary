...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Reward = IBEP20(0x000000000000000000000000000000000000dEaD); 
    address WBNB = 0x000000000000000000000000000000000000dEaD;
    IDEXRouter router;
    ...
    constructor (address _router) {
       /* router = _router != address(0)
            ...
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);*/
             ...
             router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x000000000000000000000000000000000000dEaD);
        _token = msg.sender;
    }
...
contract BitRides is IBEP20, Auth {
    ...
    address Reward = 0x000000000000000000000000000000000000dEaD;
    address USDT = 0x000000000000000000000000000000000000dEaD;
    address WBNB = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor () Auth(msg.sender) {
      /*  router = IDEXRouter(0x000000000000000000000000000000000000dEaD);
