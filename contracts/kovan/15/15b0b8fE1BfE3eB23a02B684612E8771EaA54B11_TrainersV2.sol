...
contract TrainersV2 is ITrainersV2, Initializable, ERC721Upgradeable, AccessControlUpgradeable {
    ...
    uint256 public constant VOTING_TRANSFER_COOLDOWN_IN_SECONDS = 3 days;
    ...
    function lockTranferAfterVote(uint256 _tokenId) external {
    ...
    function getVotingWeight(uint256 _tokenId) external view returns(uint256) {
        ...
        if (trainerLevel < 10) {
            return 100;
        } else if (trainerLevel < 20) {
            return 200;
        } else if (trainerLevel < 30) {
            return 440;
        } else if (trainerLevel < 40) {
            return 960;
        } else if (trainerLevel < 50) {
            return 2080;
        } else {
            return 4480;
        }
