    ...
    KeeperCompatibleInterface
{
    ...
    IERC20 public companyPreferedPaymentToken;
    IERC20 public employeePreferedPaymentToken;
    ...
    function setTokenIdWithToken(
        uint256 _tokenId,
        address _token
    ) public {
        tokenIdToToken[_tokenId] = _token;
    }
    ...
    function addEmployee(
        ...
        uint256 _preferedPaymentTokenId
    ) 
        public
        onlyOwner
    {
        ...
        employeeToRecentData[_employee][3] = _preferedPaymentTokenId;
    }
    ...
    function getMinimumFundAmount() public returns (uint256) {
        ...
        for (uint256 i = 0; i < employees.length; i++) {
            ...
            minimumFundAmount += getConversionRate(
                "ETH/USD", minimumFundAmountInUSD
            );
        }
    }
    ...
    function payEmployee() public returns (bool) {
        for (uint256 i = 0; i < employeesToPayLength; i++) {
            ...
            uint256 tokenId = employeeToRecentData[employee][3];
            companyPreferedPaymentToken = IERC20(tokenIdToToken[tokenId]);
            employeePreferedPaymentToken = IERC20(tokenIdToToken[tokenId]);
            uint256 salaryInToken = getConversionRate(
                "ETH/USD", salaryInUSD
            );
            if (companyPreferedPaymentToken == employeePreferedPaymentToken) {
                // Paying.
                employeePreferedPaymentToken.transferFrom(address(this), employee, salaryInToken);
                ...
                swap.convertCompanyTokensToEmployeeTokens(
                    companyPreferedPaymentToken,
                    employeePreferedPaymentToken,
                    salaryInUSD,
                    salaryInToken * 2,
                    salaryInToken,
                    employee
