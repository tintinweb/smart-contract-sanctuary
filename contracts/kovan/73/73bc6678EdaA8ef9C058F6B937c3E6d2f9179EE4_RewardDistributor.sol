...
contract RewardDistributor is Ownable, Pausable {
    ...
    address constant public LON_TOKEN_ADDR = 0x0712629Ced85A3A62E5BCa96303b8fdd06CBF8dd;
    ...
    *************************************************************/
    modifier only_Operator_or_Owner {
        require((msg.sender == operator) || (msg.sender == owner), "only operator or owner can call");
        _;
    }
