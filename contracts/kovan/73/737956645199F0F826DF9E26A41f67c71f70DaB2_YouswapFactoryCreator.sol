...
contract YouswapFactoryCreator {
    ...
    /// @notice 新建矿池合约: 项目方管理员，矿池外围合约地址，矿池core合约地址， invite合约地址， 是否在前端展示
    ...
    IYouswapInviteV1 public invite; //邀请关系
    ...
    */
    ...
    /**
        @notice 获取支持支付的币种和状态
        @return (address[] memory, bool[] memory) 全部佣金币种，当前支持状态
     */
