...
// File contracts/interfaces/IAPIConsumer.sol
...
contract ChainportSideBridge is Initializable, ChainportMiddleware {
    ...
    public
    {
        ...
        IAPIConsumer(APIConsumerAddress).getMainBridgeTokenSupply(token);
        uint256 result = uint256(IAPIConsumer(APIConsumerAddress).getLatestResult());
