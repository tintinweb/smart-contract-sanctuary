...
/**
 * @title Pawn Contract
 * @notice The governance/reward token of the protocol
 * @author Hifi
 */
contract Pawn is Ownable, Erc20, ProtocolTokenInterface {
    constructor() Erc20("Pawn", "$PAWN", STANDARD_TOKEN_DECIMALS) {
        console.log("Deploying Pawn..");
    }
