...
contract CryptoApe is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _isExcluded [address(msg.sender)] = true;  //Owner excluded from reflection
        _fundingWallet = address(0x0f7167C461666C14d29C75593c00234aA91a0679);
        BURN = address(0x000000000000000000000000000000000000dEaD); // Burn eaexcuded from reflection
        _isExcluded[BURN] = true; 
        _fundingWalletFee = 3;
        _liquidityFee = 5;
        _reflectionFee = 3;
        _burnFee = 1;
