...
contract CustomMedia is Media, ICustomMedia {
    ...
    function batchMint(
        ...
        _batchMintForCreator(msg.sender, data, bidShares, amount, mintLimit);
    }

    /**
     * @notice See ICustomMedia
     */
    function batchMintWithSig(
        address creator,
        MediaData memory data,
        IMarket.BidShares memory bidShares,
        uint256 amount,
        ...
        require(
            ...
            "Media: batchMintWithSig expired"
        );
...
interface ICustomMedia {
    /**
     * @notice Mint new batches media for msg.sender.
    ...
    /**
     * @notice EIP-712 batchMintWithSig method. Mints a batch of new media for a creator given a valid signature.
     * Compared with mintWithSig, it receives an amount for the batch, that needs to be > 0 and a mint limit.
     */
    function batchMintWithSig(
        address creator,
        IMedia.MediaData memory data,
        ...
        uint256 amount,
        uint256 mintLimit,
        IMedia.EIP712Signature memory sig
    ) external;
}
