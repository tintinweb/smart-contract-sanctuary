...
contract COCA is ERC721, Ownable, ERCWithdrawable {
    ...
    function presaleMint() external payable onlySender whitelistSale {
        ...
        require(totalSupply <= 3, "user cannot mint more 3 tokens");
    ...
    function publicMint() external payable onlySender publicSale {
        ...
        require(msg.value == mintPrice, "Invalid value sent!");
        require(maxTokens > totalSupply, "No more remaining tokens!");
        require(totalSupply <= 30, "user cannot mint more 3 tokens");
