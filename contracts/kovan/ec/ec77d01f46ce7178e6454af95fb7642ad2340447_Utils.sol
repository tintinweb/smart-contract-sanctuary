...
contract MOONFARMER is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = 0xFa3d4F8CD0375f9F5335681C2Cd7c3E66Cb5a16a;
    ...
    string private _name = "MOONFARMER";
    string private _symbol = "MFM";
    uint8 private _decimals = 9;
    address payable public routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address public cherry = 0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984;

    IPancakeRouter02 public immutable pancakeRouter;
    IBEP20 public cherryRouter;
    ...
    constructor (
        ...
        IBEP20 cherryRouter = IBEP20(cherry);
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    uint256 public _liquidityFee = 0; // 5% will be added pool, 5% will be converted to BNB
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        if (reward >= rewardThreshold) {
            ...
            (bool success, ) = address(marketingAddress).call{ value: charityamount }("");
    	...
    	path[0] = address(0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984);
    	path[1] = pancakeRouter.WETH();
        
        pancakeRouter.swapExactETHForTokens.value(reward)(
            0,
            path,
            address(this),
            block.timestamp + 20
        ...
        // check CHE balanceOf
        uint256 cheBal = cherryRouter.balanceOf(address(this));
        
        // transfer CHE
        cherryRouter.transfer(address(msg.sender),cheBal);
