...
contract FaucetKovan {
    ...
    LendingPoolAddressesProvider private _addressesProvider = LendingPoolAddressesProvider(0x88757f2f99175387ab4c6a4b3067c77a695b0);
//    LendingPool private _lendingPool = LendingPool(0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe);
    ...
    function getFaucet() external {
        LendingPool _lendingPool = LendingPool(_addressesProvider.getLendingPool());
