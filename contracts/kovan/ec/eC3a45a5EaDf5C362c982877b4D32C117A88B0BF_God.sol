...
contract God is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function decode_op(bytes calldata data) public view returns (OP memory) {
        ...
        console.log("pass1 datatype:%s", op.datatype);
        console.log("pass1 price:%s", op.price);
        console.log("pass1 token:%s", op.token);
        console.log("pass1 timestamp:%s", op.timestamp);
        console.log("pass1 sign count:%s", s.length);
