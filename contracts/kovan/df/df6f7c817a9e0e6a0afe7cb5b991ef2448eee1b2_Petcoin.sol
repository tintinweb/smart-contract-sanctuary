...
contract Petcoin is Context, IERC20, Ownable {
    ...
    event CharityTransfer(string message, address indexed from, address indexed to, uint256 value);
    ...
    function _takeCharity(uint256 tCharity) private {
        ...
        emit CharityTransfer("Charity Wallet Transfer",msg.sender, _charityWalletAddress, tCharity);
    }
