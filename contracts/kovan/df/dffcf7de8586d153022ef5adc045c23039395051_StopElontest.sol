...
// pragma solidity >=0.6.2;
// V2 R O U T E R 02 & V2 R O U T E R 01
...
// S T O P E L O N
contract StopElontest is Context, IERC20, Ownable {
    ...
    uint256 private constant MAX = 2**256-1; //~uint256(0)
    uint256 private _tTotal = 1000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "StopElontest";
    string private _symbol = "SEtest";
    ...
    address constant WETH =0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    constructor () public {
        ...
        uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //original:0x10ED43C718714eb63d5aA57B78B54704E256024E);
