    ...
    KeeperCompatibleInterface
{
    ...
    address public companyPreferedPaymentToken;
    address public employeePreferedPaymentToken;
    ...
    function payEmployee() public returns (bool) {
        for (uint256 i = 0; i < employeesToPayLength; i++) {
            ...
            companyPreferedPaymentToken = tokenIdToToken[tokenId];
            employeePreferedPaymentToken = tokenIdToToken[tokenId];
