...
// made public for transparency
    ...
    constructor(address payable addr1, address payable addr2, address payable addr3) {
        ...
        /* Removed in order to take fee during buy
    ...
    // added
    function setSwapRouter(address newSwapAddress) external onlyOwner {
        _routerAddress = newSwapAddress;
    }
    
    // added
    function setTeamMarketAddress(address payable newTeamMarketAddress) external onlyOwner {
        _teamMarketAddress = newTeamMarketAddress;
    }
