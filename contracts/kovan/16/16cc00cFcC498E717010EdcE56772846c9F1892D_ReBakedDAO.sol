	...
	*/
		...
		returns(uint256 amount_)
	{
		...
		amount_ = packageData[projectId_][packageId_].bonus 
				* collaboratorData[projectId_][packageId_][msg.sender].bonusScore / PCT_PRECISION * 10e18;
		...
		returns(uint256 amount_)
	{
		...
		for (uint256 i = 0; i < packageIds_.length; i++) {
			...
			_amount = packageData[projectId_][packageIds_[i]].bonus 
				* collaboratorData[projectId_][packageIds_[i]][msg.sender].bonusScore / PCT_PRECISION * 10e18;
			amount_ += _amount;
