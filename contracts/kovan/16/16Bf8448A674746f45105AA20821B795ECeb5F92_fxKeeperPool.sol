...
interface IfxKeeperPool {
    ...
    struct Snapshot {
        // TODO: REMOVE THIS VARIABLE IN NEXT DEPLOYMENT "collateralToSum"
        // It is deprecated and only used by Deposit struct, not the Pool struct
        // Only kept here because deleting it breaks proxy upgradeability
        // for the current deployed contract.
