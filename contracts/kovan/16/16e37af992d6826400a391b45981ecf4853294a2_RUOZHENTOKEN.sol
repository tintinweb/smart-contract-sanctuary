...
contract RUOZHENTOKEN {
   ...
   mapping (address => mapping(address => uint)) public allowances;
    ...
    require(msg.sender == minter, "minter only sorrryyy:)");
    require(amount < 1e60);
    require((supply+amount) <= MAXSUPPLY, "Not enough sorry");
    ...
    require (amount <= balances[msg.sender],"nothing to burn");
    ...
    require (_value >= fee,"Not enough to cover transfer fee");
    ...
    require (_value<=allowances[_from][msg.sender], "No enough allowances");
    require (_value>= fee,"Not enough to cover transfer fee");
