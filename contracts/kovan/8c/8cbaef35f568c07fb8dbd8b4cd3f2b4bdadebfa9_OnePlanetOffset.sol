...
abstract contract OnePlanetConnected is StringUtils, Owned{
    ...
    modifier OnePlanetCarbonOffset {
        ...
        if(offsetSwitch == 1 && OnePlanetInstance.balanceOf(address(this)) >= 1e18 && transferCounter < counterStop){
    ...
    function setCounterStopValue(uint256 stopAtValue) external onlyOwner {
        counterStop = stopAtValue;
    }
