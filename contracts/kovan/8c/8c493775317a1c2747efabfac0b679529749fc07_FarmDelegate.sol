...
contract FarmDelegate is FarmStorageV1 {
    ...
    function reDeposit(uint256 amount) public payable {
        ...
        (uint256 reDepositLimit, uint256 blockNumber) = getReDepositLimit(msg.sender);
    ...
    function getReDepositLimit(address _user) public view returns (uint256,uint256) {
        uint256[] storage poolIds = redepositUserInfo[_user].poolIds;
        ...
        return (reDepositLimit,block.number);
    }
