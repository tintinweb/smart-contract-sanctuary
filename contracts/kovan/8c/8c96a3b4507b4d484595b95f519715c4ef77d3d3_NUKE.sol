 ...
 *
 * Mini NUKE, a crazy new token that will blow up the cryptospace. This will never be the same again.
 *
 *     --------
 *    /        \/|  ---  ---  ---  --  ---  ---         --- ---  --- ---  --- ---  ------
 *   |    ||     |  | \  / |  | |  | \ | |  | |         | \ | |  | | | |  | |/ /   |  __|
...
pragma solidity ^0.6.12;
    ...
    contract NUKE is Context, IERC20, Ownable {
        ...
        function addBotToBlackList(address account) external onlyOwner() {
            require(account != 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D, 'We can not blacklist PancakeSwap router.');
