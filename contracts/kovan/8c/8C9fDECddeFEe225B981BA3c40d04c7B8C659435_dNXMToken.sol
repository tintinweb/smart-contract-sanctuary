...
contract dNXMToken is IdNXMToken, ERC20PermitUpgradeable {
    ...
    **/
    ...
    function withdraw(uint _amountDNXM) public {
        require(_amountDNXM > 0, "dNXMToken: can't withdraw 0 dNXM");
        (uint256 _amountDNXMRequested, , uint256 _coolDownTimeEnd) = getWithdrawalInfo(_msgSender());
        ...
        //TODO call rewards
        //TODO calculate part of rewards
        //TODO record remaining rewards here
        //TODO withdraw deposit
        //TODO apply fee
        //TODO rwap to wNXM
        //TODO clean withdrawalsInfo
        //TODO burn dNXM
        //TODO write event
    ...
    function _getNXMtoDNXMRatio() internal view returns (uint) {
        ...
        uint _stakesAndRewards = _currentlyDeposited().add(_pooledStaking.stakerReward(address(this)));
