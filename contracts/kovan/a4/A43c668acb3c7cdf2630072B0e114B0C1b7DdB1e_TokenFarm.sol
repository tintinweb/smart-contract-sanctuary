...
contract TokenFarm is Ownable {
    ...
    // how many unique tokens each staker has
    ...
    function issueTokens() public onlyOwner {
        for(uint i = 0; i < stakers.length; i++){
            ...
            //send a reward based on their total value locked
    ...
    function getSingleTokenValue (address _user, address _token) public view returns (uint) {
