...
contract StakeWarsCharacter is Administerable {
    ...
    function getRarity(address warrior)
        ...
        view
        onlyAfterRelease
        returns (StakeWarsInternals.Rarity)
    {
    ...
    function _getClass(address warriorAddr, int8 index)
        public
        view
        returns (StakeWarsInternals.Class)
    {
        StakeWarsInternals warrior = _registeredStakeWarriors[warriorAddr];
        StakeWarsInternals.Class class = warrior.class(index);
        return class;
    }
    ...
    function _getLand(address warrior, int8 index)
        public
        view
        returns (StakeWarsInternals.Lands)
    {
    ...
    function _setClass(
        address warrior,
        StakeWarsInternals.Class newClass,
        int8 index
    ...
    function _setLand(
        address warrior,
        StakeWarsInternals.Lands newLand,
        int8 index
    ) public onlyAdminOrGameControl {
