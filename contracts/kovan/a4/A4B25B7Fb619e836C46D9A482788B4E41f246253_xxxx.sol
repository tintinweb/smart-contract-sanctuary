...
import "../contracts/uniswapContracts/IUniswapV2Factory.sol";
import "../contracts/uniswapContracts/IUniswapV2Pair.sol";
import "../contracts/uniswapContracts/IUniswapV2Router02.sol";
...
contract xxxx is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xc661eC9D9E534ba7fd202e28a698B20c91a45682); // Marketing Address
        
        devAddress = payable(0xdF75557887faA897f895c122D3a3098cADC8bE0e); // Dev Address
    ...
    function launch() external onlyOwner returns (bool){
        require(!tradingActive, "active, cannot relaunch");
        enableTrading();
    ...
    function _approve(
        ...
        require(owner != address(0), "ERC:zero add");
        require(spender != address(0), "ERC20: approve to the 0 add");
    ...
    function _transfer(
        ...
        require(from != address(0), "ERC20: transfer from the 0 add");
        require(to != address(0), "ERC20: transfer to the 0 add");
