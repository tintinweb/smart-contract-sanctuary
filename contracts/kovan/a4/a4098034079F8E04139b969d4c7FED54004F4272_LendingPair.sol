...
contract LendingPair is TransferHelper {
  ...
  function depositRepay(address _account, address _token, uint _amount) public {
  ...
  function depositRepayETH(address _account) public payable {
    accrueAccount(_account);
  ...
  function deposit(address _account, address _token, uint _amount) public {
    _validateToken(_token);
    accrueAccount(_account);
  ...
  function repayAll(address _account, address _token) public {
    _validateToken(_token);
    accrueAccount(_account);
  ...
  function repayAllETH(address _account) public payable {
    accrueAccount(_account);
  ...
  function repay(address _account, address _token, uint _amount) public {
    _validateToken(_token);
    accrueAccount(_account);
