    ...
    IBEP721Receiver
{
    ...
    event ListItem(uint256 tokenId, uint256 auctionId, address owner, uint256 price, uint256 endsAt, uint256 topTime);
    ...
    function createAuction(
        ...
        emit ListItem(_tokenId, _auctions, _msgSender(), _price, _endsAt, _topTime);
        return true;
    }
        ...
        returns (bool)
    {
        ...
        BidInfo storage b = _bid[a.winner][_auctionId];
        uint256 topTime = block.timestamp - b.createdAt;
        require(a.end < block.timestamp || a.toptime < topTime, "Auction Error: sale not ended or top time not ended");
