...
contract HelloFlashLoans is FlashLoanReceiverBase {
    ...
    address uniswapAddress = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    IUniswapV2Router02 public uniswapRouter = IUniswapV2Router02(uniswapAddress);
    address private weth = 0xd0A1E359811322d97991E03f863a0C30C2cF029C;
    WETH9 wethContract = WETH9(weth);
    address private maker = 0xAaF64BFCC32d0F15873a02163e7E500671a4ffcD;
    IERC20 makerContract = IERC20(maker);
    address private mcDai = 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa;
    IERC20 daiContract = IERC20(mcDai);
        ...
        returns (bool)
    {
        ...
        wethContract.approve(uniswapAddress, 7 ether);
        makerContract.approve(uniswapAddress, 7 ether);
        daiContract.approve(uniswapAddress, 7 ether);

        uint swapAmount = 1 finney;
        
        uniswapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(swapAmount, 0, path, address(this), deadline);
        */
