...
contract GYM_Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 88888888888888  * 10**8;
    ...
    uint256 private _transferTotal = _tTotal.sub(devWalletAmount);
    uint256 private _tFeeTotal;
    uint256 private _tCommTotal;
    
    string private   _name = "GYM Token";
    string private _symbol = "GYM";
    ...
    address public devWallet2 = 0x3164d66A863321DA910f93Cd996eAd848010f7E7;
    address public devWallet3 = 0xBd6ee81097Df693185FE49F3B9eAd313a368215B;
    ...
    uint256 public _maxTxAmount = 8888888888888 * 10**8;
    uint256 private numTokensSellToAddToLiquidityOrBurn = 222222222222 * 10**8;
    ...
    function setRWallet(address cWallet) external onlyOwner()  {
    ...
    // function setDeadFeePercentt(uint256 deadFee) external onlyOwner() {
    //     _deadFee = deadFee;
    // }
    ...
    //get some tx-relative Values (rAmount, rTransferAmount, rFee, tTransferAmount, tFee, tLiquidity)
    // r means reflections
    // t means tx-relative
    ...
    // function _getCommValues(uint256 tCommFee, uint256 currentRate) private pure returns (uint256){
    ...
    // function calculatedDeadFee(uint256 _amount) private view returns (uint256) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transfer(_burnPool,toBurn);
        
        // burn to zero
        emit Transfer(address(this), _burnPool,toBurn);
