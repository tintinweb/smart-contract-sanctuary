...
contract ChainlinkOraclePriceFeed is IPriceFeed{
    ...
    function priceWithValidity() public view override  returns (uint256, bool){
        ...
        return (uint256(price).mul(WAD).div(10 ** uint256(priceFeed.decimals())), block.timestamp - lastUpdated <= frequency);
    }
    ...
    function price() public view  override returns (uint256) {
        ...
        return uint256(price).mul(WAD).div(10 ** uint256(priceFeed.decimals()));
    }
