...
contract FreeBettingContract is AbstractBettingContract {
        ...
        onlyLock
    {
        ...
        require(IERC20(tokenAddress).balanceOf(address(this)) == award);
...
import "../FreeBettingContract.sol";
import "../interface/IBettingFactory.sol";

contract FreeBettingFactory is IBettingFactory {
    function createNewBettingContract(
        address payable _owner,
        address payable _creator
    ) public override returns (address) {
        FreeBettingContract betting = new FreeBettingContract(_owner, _creator);
