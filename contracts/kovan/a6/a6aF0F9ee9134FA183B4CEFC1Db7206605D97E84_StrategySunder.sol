...
contract StrategySunder {
    ...
    address constant public want    = address(0x65095738D66A350d3388847788D971388DBF743c); // Sunder
    address constant public xSunder = address(0x7F7E1569c94e4326113eDBaaB1D6F51f6f3dAA8A); // xSunder

    address constant public dToken = address(0x5336f1A7dc6e8d6B74ECDA116e235e2a648b1A8c);
    address constant public eToken = address(0x299ACc437C832fB89b2ac64c0CEd46Dd56D7181E);
