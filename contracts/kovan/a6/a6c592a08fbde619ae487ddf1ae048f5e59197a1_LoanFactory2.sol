...
// SPDX-License-Identifier: MIT
// COPIED FROM https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.3.0/Clones.sol
...
import {ITrueFiPool2} from "ITrueFiPool2.sol";
import {ITrueRateAdjuster} from "ITrueRateAdjuster.sol";
...
contract LoanFactory2 is ILoanFactory2, Initializable {
    ...
    function createLoanToken(
        ...
        LoanToken2(newToken).initialize(_pool, borrowingMutex, msg.sender, lender, admin, liquidator, _amount, _term, 0);
