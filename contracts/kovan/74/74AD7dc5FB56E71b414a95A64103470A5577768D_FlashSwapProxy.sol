...
contract FlashSwapProxy is IUniswapV2Callee, Ownable{
    ...
    function uniswapV2Call(address sender, uint amount0, uint amount1, bytes calldata _data) external override {
        ...
        // FIXME Should use getAmountsIn, because the actual state os the pair it is inconsistent.
        ...
        // TODO Instead of using library, use the code (deployment should be cheaper).
        IERC20(data.tokenToReturn).safeTransfer(msg.sender, data.amountToReturn);
