...
contract TokenFarm is Ownable {
    ...
    IERC20 public penwuinToken;

    constructor(address _penwuinTokenAddress) public {
        penwuinToken = IERC20(_penwuinTokenAddress);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            penwuinToken.transfer(recipient, userTotalValue);
        }
    }
