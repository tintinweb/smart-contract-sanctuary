...
contract BondContract is Initializable {
    ...
    function deposit(uint _amount, uint _maxPrice, address _depositer) external returns (uint){
        ...
        // console.log("value", value); // 1.000000000000000000
    ...
    function bondPrice() public view returns ( uint price_ ) {        
        ...
        console.log("price_", price_); // 0.100000000000000000
        console.log("terms.controlVariable", terms.controlVariable); // 4
        console.log("debtRatio()", debtRatio()); // 0
        // console.log("terms.minimumPrice", terms.minimumPrice); // 

        // if ( price_ < terms.minimumPrice ) {
        //     price_ = terms.minimumPrice; // 0.277777778
        // }

    }

    function _bondPrice() internal returns ( uint price_ ) {        
        price_ = terms.controlVariable.mul( debtRatio() ).div( 1e7 ).add(1e17);
    ...
    function payoutFor( uint _value ) public view returns ( uint ) {
        // console.log("payout", _value.mul(1e18).div(bondPrice())); // 0.009999999999990000
        // console.log("_value", _value); // 0.000999999999999000
        // console.log("bondPrice()", bondPrice()); // 0.100000000000000000
