...
contract FundPoolDelegate is FundPoolStorgeV1, FundPoolEvents {
    ...
    function deposit(uint256 _tokenAmountIn) external {
        ...
        _deposit(_tokenAmountIn, totalTokens);
    }
    ...
    function depositETH() external payable {
        ...
        _deposit(msg.value, totalTokens);
    }

    function _deposit(uint256 _tokenAmountIn, uint256 totalTokens) private {
        // deposit fee
    ...
    function distributeTokens(
        ...
        IController.TokenAmount[] memory tokenInPool = new IController.TokenAmount[](1);
