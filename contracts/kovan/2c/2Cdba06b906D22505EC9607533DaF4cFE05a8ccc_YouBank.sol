 ...
 */
    ...
    returns (
        ...
        IPool _poolContract = IPool(pool);
        uint256 _poolValueUSD;
        uint256 _poolValue;
        string memory _proofOfValue;
        (_poolValueUSD, _poolValue, _proofOfValue) = _poolContract.getPoolValues();
        return (_poolValueUSD,_poolValue,_proofOfValue,_poolValuesTotal,_poolValuesUSDTotal);
    }
