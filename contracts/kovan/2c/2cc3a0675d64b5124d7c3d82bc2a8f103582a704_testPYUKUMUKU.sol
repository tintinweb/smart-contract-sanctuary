...
contract testPYUKUMUKU is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "testPYUKUMUKU";
    string private _symbol = "tPYU";
    ...
    uint256 public _taxFee = 100; //1% of every transaction's TFC tokens will be collected as tax fee, and redistributed to reward holders
    uint256 public _burnFee = 800; // 8% of every transaction's TFC tokens will be burned 
