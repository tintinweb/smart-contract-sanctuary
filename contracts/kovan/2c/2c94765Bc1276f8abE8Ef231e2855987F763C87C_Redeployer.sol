...
contract Redeployer {
    ...
    function generateBytecode(address contract_, bytes memory arguments) public view returns (bytes memory code) {
    ...
    function redeploy(
        ...
        bytes memory bytecode = generateBytecode(contract_, arguments);
