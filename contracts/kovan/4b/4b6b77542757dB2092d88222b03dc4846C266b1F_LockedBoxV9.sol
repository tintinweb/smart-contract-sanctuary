...
contract LockedBoxV9 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function checkCinoBalance() public view returns (uint256){
        return cino.balanceOf(_msgSender());
    }
