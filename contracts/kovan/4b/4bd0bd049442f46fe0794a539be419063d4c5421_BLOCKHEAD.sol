...
contract BLOCKHEAD is ERC20, ERC20Burnable, Ownable, ERC20Pausable {
    constructor(
        string memory name,
        ...
        _setTotalSupply(initialSupply); // 100 trillion

        // For Initial Coin Offering
        uint256 icoTokens = 45000000000000; // 5100000/1000000 = forty-five trillion
        _initialTransfer(
            0x1568b6c0CF7b0CE96A39a9105cf41Ba0939a5038,
            (icoTokens * decimalFactor)
        );
        // Founder and Community
        uint256 foundCommTokens = 5000000000000; // 5 trillion
        _initialTransfer(
            0xe1B16df896c83997fdbD48852Efae7Ff3Be14FA7,
            (foundCommTokens * decimalFactor)
        );
        // Reserve and Exchange
        uint256 reserveExTokens = 50000000000000; // 50 trillion
        _initialTransfer(
