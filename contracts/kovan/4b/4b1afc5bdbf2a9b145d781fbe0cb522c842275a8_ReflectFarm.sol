...
contract ReflectFarm is Context, IBEP20, Ownable {
    ...
    constructor() public {
        ...
        _symbol = "RFARM";
        _decimals = 9;
        _tTotal = 100_000 * 10**9;
        _rTotal = (MAX - (MAX % _tTotal));

        _rOwned[_msgSender()] = _rTotal;
        _maxTransferAmount = 2_000 * 10**9;
        _numTokensSellToAddToLiquidity = 100 * 10**9;
    ...
    function _transfer(
        ...
        if (overMinTokenBalance && !_inSwapAndLiquify && recipient != address(pancakePair) && isSwapAndLiquifyEnabled) {
