...
contract MarsBaseOtc is Ownable, IMarsBaseOtc, ReentrancyGuard {
    ...
    function emergencyWithdraw(bytes32 id, address investor, uint256 bidIndex) external onlyOwner nonReentrant {
        require(investor != address(0), ' investor is address(0)');
        ...
        vault.withdraw(bidArrWrite[bidIndex].investedToken, bidArrWrite[bidIndex].investor, bidArrWrite[bidIndex].amountInvested);
...
//Vault address = 0x5B8CF88e8642990771F652d6886E9a9766588b3C
//MarsBaseOtc address = 0x4bfb8871868a5A0A20c790759E06C9149712d5F4
