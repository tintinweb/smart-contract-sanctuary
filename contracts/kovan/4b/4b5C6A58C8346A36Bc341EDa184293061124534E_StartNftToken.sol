...
/**
 * @title StartNft Token
 * @dev StartNft ERC20 Token
 */
contract StartNftToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Geek Coin", "GEEK") {
     ...
     * Owner is assumed to be governance or StartNft trusted party for helping users
