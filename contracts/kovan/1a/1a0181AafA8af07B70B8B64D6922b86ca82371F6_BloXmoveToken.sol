...
contract BloXmoveToken is ERC20, ERC165 {
     ...
     * and it gets the 1 million Tokens.
     * 
     * Emits a {Transfer} event twice.
     */
    constructor(address _publicSaleAddress) ERC20("Test bloXmove Token", "TBLXM") {
        _mint(_msgSender(), 49000000000000000000000000);
        _mint(_publicSaleAddress, 1000000000000000000000000);
