    ...
    ERC721Burnable
{
    ...
    constructor() ERC721("KyokoBToken", "KBT") {}
...
contract Kyoko is Ownable, ERC721Holder {
    ...
    event AddWhiteList(IERC20 _address);

    event SetWhiteList(IERC20[] _whiteList);
    ...
    function addOffer(
        ...
        uint256 _amount = _price.div(10000 + fee).mul(10000);
        ...
        isPause
    {
        ...
        _offer.accept = false;
        _offer.symbol = false;
        uint256 _price = _offer.price.div(10000).mul(10000 + fee);
    ...
    function claimCollateral(IERC721 _nftToken, uint256 _nftTokenId) public {
        NFT storage _nft = NftMap[_nftToken][_nftTokenId];
        require(
