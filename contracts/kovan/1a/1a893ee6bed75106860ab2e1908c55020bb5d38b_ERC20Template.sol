...
contract ERC20Template is ERC20Pausable {
    ...
    function mint(address account, uint256 amount) public whenNotPaused onlyOperator {
        require(block.timestamp >= lastUpdateTime, "mint time interval is 24 hours");
        require(amount <= 1e22, "mint cannot be greater than 10000");
        _mint(account, amount);
        lastUpdateTime=block.timestamp.add(1*600);
    }
