...
contract Router{
    ...
    event RefinanceLoan(address _col, address _paired, uint256 _colAmt, uint48 _expiry, uint256 _mintRatio);
    ...
    function refinanceLoan(
        ...
        emit RefinanceLoan(_col, _paired, _colAmt, _expiry, _mintRatio);
