...
contract BnbPricePredictionBet is Ownable {
    ...
    constructor() {
        // oracle = AggregatorV3Interface(0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526);  //bsc testnet
        oracle = AggregatorV3Interface(0x9326BFA02ADD2366b30bacB125260Af641031331); //bsc mainnet
        // Mainnet address : 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419
        //Kovan test netwoek: 0x9326BFA02ADD2366b30bacB125260Af641031331
        token = IERC20(0x37C5832d3d92d714d69dFFF8358ED4B79FF634D2);
    ...
    function betDown(uint256 betAmount) external {
        ...
        if (!round.status) checkRunningRound();
        // Update user data
        ...
        if (userRounds[msg.sender].length == 0 || userRounds[msg.sender].length > 0 && userRounds[msg.sender][userRounds[msg.sender].length - 1] != currentEpoch) {
