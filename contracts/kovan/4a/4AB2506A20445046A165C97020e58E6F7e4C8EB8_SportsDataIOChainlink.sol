...
contract SportsDataIOChainlink is ChainlinkClient, IChainLinkOracleSportData {
    ...
    constructor(address _oracle, address _linkToken) {
        ...
        jobId = "333df2ce1ecd48de885991e0d79e9de0";
    ...
    function requestData(uint256 _competitionId) public override returns (bytes32) {
    ...
    function fulfill(bytes32 _requestId, uint256[] memory _data)
        public
    ...
    function getData(bytes32 _id) external override view returns (uint256[] memory) {
        require(isRequest[_id], "ChainLinkContract: Cannot request price");
        // require(
        //     isResponse[_id],
        //     "ChainLinkContract: Have not received any feedback about the price"
