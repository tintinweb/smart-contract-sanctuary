...
contract TokenFarm is Ownable{
    ...
    // 50 ETH and 50 DAI staked, and we want to give a rewared of 1 DAPP / 1 DAI
    // We have to first convert ETH to DAI
    ...
    function issueTokens() public onlyOwner {
        ...
        for(uint256 stakersIndex = 0; stakersIndex < stakers.length; stakersIndex++) {
            ...
            // transfer cause this contract will hold all the dappTokens 
            // based on total value locked
        }
    }

    // would also be possible to make a function for people to claim, we gonna distribute here
    ...
    function getUserSingleTokenValue(address _user, address _token) public view returns(uint256) {
        // 1 ETH -> 2000$ should return 2000$
        // no require because we want it to still go on. Not the transaction to revert
    ...
    function updateUniqueTokenStaked(address user, address _token) internal {
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        // transferFrom sender to this address the amount
    ...
    function unstakeTokens(address _token) public {
        ...
        // could implement function that removes the person from stakers array   
    }
