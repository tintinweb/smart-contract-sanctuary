...
contract Precog is IPrecog {
    ...
    function invest(
        ...
        if (profitInfo.canBorrow) {
            loan.borrowAmount = _getDebtAmount(loan, block.timestamp, profitInfo.expiryDate);
        ...
        emit Trade(user, 
            tradeInfo.futureContract, profitInfo.expiryDate, 
            amount, profitInfo.profit, fee.feeTrading, 
