...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function startLottery() public onlyOwner {
        require(state == LOTTERY_STATE.CLOSED, "NO START LOTTERY");
        state = LOTTERY_STATE.OPEN;
    }

    function endLottery() public onlyOwner {
        // require(state != LOTTERY_STATE.CLOSED, "NO LOTTERY AVAILABLE");
        // state = LOTTERY_STATE.FINDING_WINNER;
        ...
        override
    {
        require(
            state == LOTTERY_STATE.FINDING_WINNER,
            "LOTTERY IS NOT IN THE END"
        );
        require(_randomness > 0, "F random number");
