...
contract Lottery is VRFConsumerBase,Ownable{
    ...
    function startLottery() public onlyOwner{
        require(lottery_state==LOTTERY_STATE.CLOSED,"Lottery has not started yet!");
    ...
    function fulfillRandomness(bytes32 _requestId,uint256 _randomness) internal override {
        ...
        uint256 luckyPlayerIndex=_randomness%players.length;
        recentWinner=players[luckyPlayerIndex];
        payable(recentWinner).transfer(payable(address(this)).balance);
