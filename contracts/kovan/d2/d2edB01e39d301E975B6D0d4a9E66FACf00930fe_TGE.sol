...
contract TGE is Ownable, Signature {
    ...
    bytes32 public constant termsAndConditions =
        0x51bd07ba6c2ffaeb24c9ac86939dbe122114786d187702fb57399d4ae32ab065;
    ...
    function claimEthSurplus(uint256 eth) private {
        ...
        if (eth > 0) msg.sender.call{value: eth}("");
    }
    ...
    function getReferralForexAmount(address referrer)
        ...
        returns (uint256)
    {
        uint256 earnedValueEth = (referrerDeposits[referrer] * 5) / 100;
        if (earnedValueEth == 0) return 0;
        uint256 price = forexPrice();
        return (earnedValueEth * (1 ether)) / price;
    }
    ...
    function emergencyWithdrawAllFunds() public onlyOwner {
        ...
        uint256 balance = forex.balanceOf(self);
