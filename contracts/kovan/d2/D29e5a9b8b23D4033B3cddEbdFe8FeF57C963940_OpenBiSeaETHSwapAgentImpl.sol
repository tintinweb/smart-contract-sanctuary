...
contract OpenBiSeaETHSwapAgentImpl is Context,IERC721Receiver,IERC1155Receiver {
    ...
    mapping(uint256 => uint256) public contractWalletTokenIdTotalAmount;
    ...
    function fillBSC2ETHSwap(bytes32 bscTxHash, address erc20Addr, address toAddress, uint256 amount) onlyOwner external returns (bool) {
        ...
        require(contractWalletTokenIdTotalAmount[uint256(erc20Addr).add(uint256(toAddress))] >= amount, "this amount address token was not swapped");
        ...
        contractWalletTokenIdTotalAmount[uint256(erc20Addr).add(uint256(toAddress))] = contractWalletTokenIdTotalAmount[uint256(erc20Addr).add(uint256(toAddress))].sub(amount);
        return true;
    }
    ...
    function fill721BSC2ETHSwap(bytes32 bscTxHash, address erc721Addr, address toAddress, uint256 tokenId) onlyOwner external returns (bool) {
        ...
        require(contractWalletTokenIdTotalAmount[uint256(erc721Addr).add(uint256(toAddress)).add(tokenId)] >= 1, "this amount address token was not swapped");
        ...
        contractWalletTokenIdTotalAmount[uint256(erc721Addr).add(uint256(toAddress)).add(tokenId)] = contractWalletTokenIdTotalAmount[uint256(erc721Addr).add(uint256(toAddress)).add(tokenId)].sub(1);
        return true;
    }
    ...
    function fill1155BSC2ETHSwap(bytes32 bscTxHash, address erc1155Addr, address toAddress, uint256 tokenId, uint256 amount) onlyOwner external returns (bool) {
        ...
        require(contractWalletTokenIdTotalAmount[uint256(erc1155Addr).add(uint256(toAddress)).add(tokenId)] >= amount, "this amount address token was not swapped");
        ...
        contractWalletTokenIdTotalAmount[uint256(erc1155Addr).add(uint256(toAddress)).add(tokenId)] = contractWalletTokenIdTotalAmount[uint256(erc1155Addr).add(uint256(toAddress)).add(tokenId)].sub(amount);
        return true;
    }
    ...
    function swapETH2BSC(address erc20Addr, uint256 amount) payable external notContract returns (bool) {
        ...
        contractWalletTokenIdTotalAmount[uint256(erc20Addr).add(uint256(msg.sender))] = contractWalletTokenIdTotalAmount[uint256(erc20Addr).add(uint256(msg.sender))].add(amount);
        return true;
    }
    function swap721ETH2BSC(address erc721Addr, uint256 tokenId) payable external notContract returns (bool) {
        require(registeredERC[erc721Addr], "not registered token");
        require(msg.value == swapFee, "swap fee not equal");
        ...
        contractWalletTokenIdTotalAmount[uint256(erc721Addr).add(uint256(msg.sender)).add(tokenId)] = contractWalletTokenIdTotalAmount[uint256(erc721Addr).add(uint256(msg.sender)).add(tokenId)].add(1);

        return true;
    }

    function swap1155ETH2BSC(address erc1155Addr, uint256 tokenId, uint256 amount) payable external notContract returns (bool) {
        require(registeredERC[erc1155Addr], "not registered token");
        require(msg.value == swapFee, "swap fee not equal");
        ...
        contractWalletTokenIdTotalAmount[uint256(erc1155Addr).add(uint256(msg.sender)).add(tokenId)] = contractWalletTokenIdTotalAmount[uint256(erc1155Addr).add(uint256(msg.sender)).add(tokenId)].add(amount);
