...
contract PresalePublic is ReentrancyGuard {
    ...
    function registerTierOneTwo(uint256 _tokenAmount, uint256 _tier, bytes memory _signature) external openRegister {
    ...
    function register(uint256 _tokenAmount, uint256 _tier, bytes memory _signature) external openRegister {
        require(usedSignature[keccak256(_signature)] == 0);
        require(
