...
contract PresaleSettings is Ownable {
    ...
    constructor() public {
        SETTINGS.BASE_FEE = 30; // 3%
        SETTINGS.TOKEN_FEE = 30; // 3%
        SETTINGS.REFERRAL_FEE = 10; // 1%
        SETTINGS.ETH_CREATION_FEE = 5e17; // 0.5 ETH
        SETTINGS.ETH_FEE_ADDRESS = msg.sender;
        SETTINGS.TOKEN_FEE_ADDRESS = msg.sender;
        SETTINGS.MAX_PRESALE_LENGTH = 64800; // 3 days || old = 93046 => 2 weeks
    }
