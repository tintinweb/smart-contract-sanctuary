...
contract VAULTZ is Context, IERC20, Ownable {
    ...
    address public dev = 0x38103CC2F3c72D71BcbD08f81849667ACaf01FBe;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public devFeePercent = 6;
    ...
    function _transfer(
        ...
        uint256 devFee = _amount.mul(devFeePercent).div(100);
        uint256 amount = _amount.sub(devFee);
        _tOwned[dev] = _tOwned[dev].add(devFee);
        _rOwned[dev] = _rOwned[dev].add(devFee);      
