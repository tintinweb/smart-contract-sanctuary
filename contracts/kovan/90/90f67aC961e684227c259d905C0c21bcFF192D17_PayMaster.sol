...
contract PayMaster is KeeperCompatibleInterface, PharoPayouts {
    /**
...
contract PharoPayouts is Ownable {
  ...
  */
  function payProvider(uint256 _amount, address _provider, address _asset)
    public
    returns (bool success)
  {

    // payout the stablecoin
    IERC20(_asset).transfer(_provider, _amount);

    // payout rewards
    phroToken.transfer(_provider, _amount);
  ...
  * @return success 
  */
  function payCoverBuyer(uint256 _amount, address _buyer, address _asset)
    public
    returns (bool success)
  {
    
    // payout the stablecoin
    IERC20(_asset).transfer(_buyer, _amount);

    // payout rewards
    phroToken.transfer(_buyer, _amount);
