...
contract AccuweatherConsumer is ChainlinkClient {
        ...
        recordChainlinkFulfillment(_requestId)
    {
        ...
        if (result.locationKey > 0) {
            ...
            currentConditions.precipitationPast12Hours = result.precipitationPast24Hours;
            currentConditions.precipitationPast12Hours = result.precipitationPastHour;
