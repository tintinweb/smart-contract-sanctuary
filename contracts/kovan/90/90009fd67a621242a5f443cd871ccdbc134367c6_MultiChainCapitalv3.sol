...
contract MultiChainCapitalv3 is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 9000 * 1e7 * 1e9; //max transaction set to 9%
    uint256 public _maxWalletSize = 9000 * 1e7 * 1e9; //max wallet set to 9%
