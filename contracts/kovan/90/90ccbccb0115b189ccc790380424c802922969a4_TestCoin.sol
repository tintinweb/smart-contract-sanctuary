...
contract TestCoin is Context, IERC20, Ownable {
    ...
    address private _charityWallet = 0xC993bCEbAb756BEDdCC308E771c6698A715eDF23;
...
// Bot End here
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        ...
        transfer(getCharityWallet(), _charityFee);
    }
    ...
    function _removeCharityFee() private {
    ...
    function removeCharityFee(bool check) public returns(bool){
        _removeCharityFee();
    }
