...
contract TokenFarm is Ownable {
    ...
    IERC20 public pegasusToken;

    constructor(address _pegasusTokenAddress) public {
        pegasusToken = IERC20(_pegasusTokenAddress);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            pegasusToken.transfer(recipient, userTotalValue);
        }
    }
