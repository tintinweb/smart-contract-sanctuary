...
contract Expedition is Ownable {
    ...
    constructor(PowerToken _stakingToken, bool _doMint) public {
    ...
    function updateRewardPerBlock(uint256 _pid, uint256 _rewardPerBlock) public onlyOwner {
        ...
        pool.rewardTokensPerBlock = _rewardPerBlock;
        massUpdatePools();
    }
...
contract PowerToken is ERC20("Power Token", "POW"), Ownable {
    ...
    function mint(address _to, uint256 _amount) public onlyMiners  {
        _mint(_to, _amount);
    }
