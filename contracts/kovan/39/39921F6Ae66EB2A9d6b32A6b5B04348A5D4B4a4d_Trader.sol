...
abstract contract TraderRelaysHandler {
  ...
  function _relay(
    ...
    (bytes memory abiManipulated, uint256 txValue) =
...
library PricesLib {
    ...
    returns (uint256 tokenAmount)
  {
    ...
    tokenAmount = unitsToConvertToWei.mul(wethPriceInToken);
  }
}
...

{
  ...
  "libraries": {
    "cache/solpp-generated-contracts/lib/PricesLib.sol": {
      "PricesLib": "0xd5ca2447ea2164826fd17a017b154b9b4adc8104"
    }
  }
}