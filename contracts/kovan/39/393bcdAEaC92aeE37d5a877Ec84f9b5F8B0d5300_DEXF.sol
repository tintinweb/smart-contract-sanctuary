...
contract DEXF is BEP20Interface, Pausable {
    ...
    address public constant _treasury = 0x7FDf7C5e0f067fa70e75C9824dc04166F3BBe33F;
    address public constant _team = 0x961ED6B3BCC3086474C0C14bb3Eef823ee5BcC5f;
    address public constant _stakingPool = 0x0Af231668bEF383AE0bf33f5651b7b3715545088;
    ...
    constructor () {
        ...
        _epoch1Start = block.timestamp + 600; // to test after 3 minutes
        _epochDuration = 300; // to test 1 hours
    }
