...
*/
    ...
    function getInternalQuestionData(bytes32 _idQuestion) internal view returns (reacQuestion memory) {
    ...
    function getQuestionData(uint _categorie, uint _questionnaire, uint _question) public view returns (reacQuestion memory) {
		require(_categorie < categoriesIndex.length, "categorie not exist!");
        bytes32 id = categoriesIndex[_categorie];
		require(_questionnaire < categories[id].questionnairesIndex.length, "Questionnaire not exist!");
		bytes32 qid = categories[id].questionnairesIndex[_questionnaire];
		...
		return getInternalQuestionData(id);
    }
/*
	// From interface web ****************************
	// delete question
...
*/
    ...
    function addQuestion(bytes32 _qid, string memory _titre, string memory _question, string memory _image) internal returns (bool) {
	...
	function addQuestions(uint _categorie, uint _questionnaire, string memory _titre, string memory _question, string memory _image) public returns (bool) {
		require(_categorie < categoriesIndex.length, "categorie not exist!");
		bytes32 id = categoriesIndex[_categorie];
		require(_questionnaire < categories[id].questionnairesIndex.length, "questionnaire not exist!");
		...
		return addQuestion(categories[id].questionnairesIndex[_questionnaire], _titre, _question, _image);
	}
