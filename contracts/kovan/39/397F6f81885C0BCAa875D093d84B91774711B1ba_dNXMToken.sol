...
contract dNXMToken is IdNXMToken, ERC20PermitUpgradeable {
    ...
    **/
    function stake(uint _amount) public {
        ...
        uint[] memory stake = new uint[](1);
        stake[0] = _currentlyAtStake().add(_amount);
        _mint(_msgSender(), convertNXMToDNXM(_amount));
        _pooledStaking.depositAndStake(_amount, contracts, stake);
    }
