...
contract WeatherNFT is ERC721, Ownable, ChainlinkClient, IERC721Receiver {
     ...
     */
    constructor(address _weatherFeed, address _oracle, bytes32 _jobId, uint256 _fee) public
    ...
    function attemptPassword(string memory password) public {
