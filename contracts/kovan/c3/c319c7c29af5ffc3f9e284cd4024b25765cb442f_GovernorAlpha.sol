...
contract GovernorAlpha {
    ...
    function quorumVotes() public pure returns (uint) { return 2500000e18; } // 25,000,000 = 2.5% of Ring

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 250000e18; } // 2,500,000 = .25% of Ring

    /// @notice The maximum number of actions that can be included in a proposal
    function proposalMaxOperations() public pure returns (uint) { return 10; } // 10 actions

    /// @notice The delay before voting on a proposal may take place, once proposed
    function votingDelay() public pure returns (uint) { return 333; } // ~0.5 days in blocks (assuming 13s blocks)

    /// @notice The duration of voting on a proposal, in blocks
    function votingPeriod() public pure returns (uint) { return 1000; } // ~1.5 days in blocks (assuming 13s blocks)
