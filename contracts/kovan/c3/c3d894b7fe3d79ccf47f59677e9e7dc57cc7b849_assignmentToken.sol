...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require ((supply+amount) <= MAXSUPPLY,"Maximum Supply Limit Exceeded");
    ...
    function transferMintership(address newMinter) public returns (bool) {
        ...
        require(msg.sender == minter,"Only a minter transfers mintership");
        minter = newMinter;
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(_value > 1,"Fee of 1 token is charged. Please increase transfer amount");
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        require (_value <= balances[msg.sender],"Don't have enough tokens");
        require (allowances[_from][msg.sender]>= _value,"Approval not granted");
        require(_value > 1,"Fee of 1 token is charged. Please increase the transfer amount");
