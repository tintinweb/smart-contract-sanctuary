...
contract SushiStableCoinFactory is SushiFactoryBase, ISushiStableCoinStrategyFactory {
    ...
    function createStrategy(  
        ...
        address _ownerAccount) external requireBeacon onlyRouter override {
...
contract StrategyFactoryBase is AccessControl  {
    ...
    function getStrategyUserStrategies() view external returns(address[] memory) {
          return _getStrategyUserStrategies(msg.sender);
    }

    function _getStrategyUserStrategies(address account) view private returns(address[] memory) {
