...
contract LimitOrderManager is
    ...
    function placeLimitOrder(LimitOrderParams calldata params)
        ...
        // TODO change this to be non-proxy
        ...
        _mint(msg.sender, (_tokenId = positionInfo.nextId++));

        {

            uint32 _selectedIndex = _selectMonitor();
            positionInfo.nextMonitor = _selectedIndex + 1;
    ...
    function _selectMonitor() internal view returns (uint32 _selectedIndex) {
        ...
        _selectedIndex = positionInfo.nextMonitor == monitorLength
            ? 0
            : positionInfo.nextMonitor;
    }
