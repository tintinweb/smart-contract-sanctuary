...
contract Limah is ERC721, ERC721Enumerable, Ownable {
    ...
    bool private _stimaesPresaleStarted;
    bool private _presaleStarted;
    string public baseURI;
    mapping(address => uint256) public stimaesWhitelistBalance;
    ...
    constructor() ERC721("LIMAH", "LIMH") {
        _saleStarted = false;
        _stimaesPresaleStarted = false;
        _presaleStarted = false;

        stimaesWhitelistBalance[0xE61f895B4382F03b8a4A6cBea85a63469896aA41] = 2;
        whitelistBalance[0xE61f895B4382F03b8a4A6cBea85a63469896aA41] = 1;
    }
    ...
    modifier whenStimaesPresaleStarted() {
        require(_stimaesPresaleStarted);
        _;
    }
    ...
    function stimaesPresaleMint(uint256 amount) external payable whenStimaesPresaleStarted {
        uint256 preSaleAllowance = stimaesWhitelistBalance[msg.sender] - whitelistMinted[msg.sender];
        require(amount * _price <= msg.value, "Inconsistent amount sent!");
        require(preSaleAllowance >= amount, "Address does not own enough nfts from first collection");
    ...
    function toggleStimaesPresaleStarted() external onlyOwner {
        _stimaesPresaleStarted = !_stimaesPresaleStarted;
    }
    ...
    function stimaesPresaleStarted() public view returns (bool) {
        return _stimaesPresaleStarted;
    }
    ...
    function updateStimaesWhitelistAllowance(address newAddress, uint256 amount) public onlyOwner {
        whitelistBalance[newAddress] = amount;
    }
    
    function getStimaesWhitelistAllowance(address userAddress) public  view  returns (uint256)  {
    ...
    function getStimaesPresaleAllowance(address userAddress) public view returns (uint256) {
        return stimaesWhitelistBalance[userAddress] - whitelistMinted[userAddress];
    }
