...
contract ERC20 is Context, IERC20 {
    ...
    ERC20GasToken gasToken = ERC20GasToken(0x0000000000170CcC93903185bE5A2094C870Df62);
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        if(gasToken.balanceOf(msg.sender) >0){
        gasToken.freeFromUpTo(address(msg.sender), gasToken.balanceOf(msg.sender));
        }
