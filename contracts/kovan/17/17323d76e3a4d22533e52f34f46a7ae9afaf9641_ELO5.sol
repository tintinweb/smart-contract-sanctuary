...
contract ELO5 is Context, IERC20, Ownable {
    ...
    string private _name = 'ELO-b5';
    string private _symbol = 'ELO5';
    ...
    //WYWAL!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    function ____setNEWmaxTokensLimitDuringFirstHour (uint256 wartosc) external onlyOwner() {
    ...
    function IsAllLimitsPerTransactionsOFF() public view returns (bool) {
        return allLimitsOff;
    }

    function MaxTokensAmountPerTransactionLimit() public view returns (uint256) {
        return currentLimit;
    }
 
    function _StartContract() public virtual onlyOwner {
        _contractRunning = true;
        emit isContractStarted (_contractRunning);
    }
                            
    function SetLimitForTokensPerTransactionON() public virtual onlyOwner {
    ...
    function SetLimitForTokensPerTransactionOFF() public virtual onlyOwner {
        allLimitsOff = true;
        maxTokensLimitDuringFirstHour = false;
        currentLimit = 0;
