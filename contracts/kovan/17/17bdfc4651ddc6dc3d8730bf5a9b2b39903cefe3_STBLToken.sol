...
contract STBLToken is Context, ERC20, Ownable, AccessControl {
  ...
  constructor() ERC20("Stable","STBL") {
      ...
      STBLCreationInterface = LiquidityInterface(0x078e77fC084f9267407848b1343E7F641c770918); // Add BalancerTrader address
      BPT = TokenInterface(0x3f706B48Ca959F32d0BB24Eb704b759f4F29Eb9c); // Add Balancer Pool Token address
    }
