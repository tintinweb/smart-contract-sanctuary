...
contract ForexVesting is Ownable {
    ...
    function claim() external {
        ...
        participant.lastClaimDate = block.timestamp;
        // Clear initial claimable amount if claimed.
    ...
    function balanceOf(address account) public view returns (uint256) {
        ...
        uint256 lastClaimed = participant.lastClaimDate > claimStartDate
        ...
        uint256 elapsed = block.timestamp > vestingCompleteDate
