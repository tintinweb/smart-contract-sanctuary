...
/// @title Uniswap Oracle for any token
/// @author Ring Protocol
/// @notice maintains the TWAP of a uniswap v3 pool contract over a specified duration
contract ERC20RUSDUniswapOracle is IUniswapOracle, CoreRef {
    ...
    /// @notice ERC20RUSDUniswapOracle constructor
    ...
    constructor(
        ...
        isPrice0 = _tokenAddress < address(ICore(_core).rusd());
    ...
    function read() external view override returns (Decimal.D256 memory, bool) {
        ...
        return (sqrtPriceDecimal.pow(2), valid);
    }
