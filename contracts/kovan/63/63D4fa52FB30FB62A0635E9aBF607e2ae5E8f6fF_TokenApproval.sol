...
contract TokenApproval is ITokenApproval {
    ...
    function getdaiallowanceforxfer(address addr) external view override returns (uint256) {
...
//    }
    ...
    function redeemdai(uint256 maxAmount) external {
        ...
        require(
            _underlyingAsset.balanceOf(aaveDaiAdapterAddress) >= maxAmount,
            "insufficient underlying asset");
        //bool isRedeemed = _aaveDaiAdapter.redeemWrappedToken(maxAmount);
