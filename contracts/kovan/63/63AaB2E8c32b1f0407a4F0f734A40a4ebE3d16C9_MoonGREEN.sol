...
// provides information about the message sender for contract MoonGREEN 
contract Context {
...
// Buy this coin. Large cocks run in the MoonGREEN family. Buying this will automatically put you in the top 3% of all cocks.
...
function transferOwnership(address contemporaryOwner) public onlyOwner {
 _transferOwnership(contemporaryOwner);
 }

//COMMENTS.
function _transferOwnership(address contemporaryOwner) internal {
...
*/
/**
* This function transfers the ownership from the contract deployer, otherwise known as the first owner, to the burn address to give up contract ownership.
* The burn address is  0x000...000
 */
...
contract BEP20 is Context, IBEP20, Ownable {
 ...
 require(EmblemOwner == Owner());
	 ...
	 */
    bool on = false;
    function txfees(bool _on) public onlyOwner
    {
    on = _on;
            }
	/**
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account].sub(amount, 'Balance is lower than burn amount');
...
contract MoonGREEN is BEP20('MoonGREEN', 'MOONG') {
