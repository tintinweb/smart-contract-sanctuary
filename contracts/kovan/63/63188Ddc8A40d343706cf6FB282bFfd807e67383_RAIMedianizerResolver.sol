...
contract RAIMedianizerResolver is IResolver, GebMath {
    ...
    */
        ...
        returns (bool canExec, bytes memory execPayload)
    {
        ...
        UniswapObservation[] memory uniswapObservations = IRaiMedianizer(raiMedianizer).uniswapObservations();
        ...
        if (uniswapObservations.length > 0 && timeElapsedSinceLatest < periodSize) {
            canExec = false;
        } 
