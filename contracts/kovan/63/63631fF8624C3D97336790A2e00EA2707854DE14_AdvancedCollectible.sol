...
contract AdvancedCollectible is ERC721Enumerable, Ownable, ChainlinkClient {
   ...
   function checkID(string memory geohash, address send) internal returns (bytes32 requestId) 
    {
    ...
    function fulfill(bytes32 _requestId, uint256 _flag, address send) public recordChainlinkFulfillment(_requestId)
    {
        flag = _flag;
