...
contract TONKATSO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tonkatso Inu TEST";
    string private constant _symbol = unicode"TONKATSO";
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isExcludedFromFee[to]) {
                ...
                if(buyCooldownEnabled) {
                    ...
                    cooldown[to].sell = block.timestamp + (90 seconds);
                }
            ...
            if (!inSwap && from != uniswapV2Pair && tradingOpen) {
                ...
                if(sellCooldownEnabled) {
                    ...
                    cooldown[from].sell = block.timestamp + (90 seconds);
                }
