...
import "./RociCreditTokenInterface.sol";
    ...
    RociCreditTokenInterface
{
    ...
    function initialize() public initializer {
        __ERC721_init("RociCreditToken", "RCT");
        __Pausable_init();
        __Ownable_init();
    ...
    /**
     * @notice returns the signed message hash
     */
    ...
    /**
     * @notice returns the signer of a signed message using ecrecover
     */
    ...
    /**
     * @notice returns the r,s,v values of a signature
     */
    ...
    function storeBundle(uint256 tokenId, address[] memory bundle) private {
        ...
        require(
            _exists(tokenId),
            "ERC721: Cannot store bundle for nonexistent token"
        );
        require(
            !_bundleNonce[tokenId],
            "ERC721: This token already has an associated bundle"
        );
        ...
        returns (address[] memory)
    {
        require(
            _exists(tokenId),
            "ERC721: cannot get bundle of nonexistent token"
        );
        require(
            _bundleNonce[tokenId],
            "ERC721: This token does not have an associated address bundle yet"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "This address does not own a token."
        );
  ...
  */
    ...
    /**
     * @notice remints a token after burning the existing one
     */
    function remintToken(
        ...
        mintToken(bundle, signatures, _message, _nonce);
    }
