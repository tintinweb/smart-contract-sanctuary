...
contract SpaceportGeneratorv1 is Ownable {
    ...
    constructor() public {
        SPACEPORT_FACTORY = ISpaceportFactory(0x07AA1458CA946cBc8caD765918b7374A34759F2a);
        SPACEPORT_SETTINGS = ISpaceportSettings(0x59A999D51bf6F7b0ef4c9b48aeaB9aa6F1f5CaCE);
    }
...
contract Spaceportv1 is ReentrancyGuard {
  ...
  constructor(address _spaceportGenerator) public {
    ...
    PLASMASWAP_FACTORY = IPlasmaswapFactory(0x745c475CC101cA5580eFf6F723976480881BC008);
    WETH = IWETH(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    SPACEPORT_SETTINGS = ISpaceportSettings(0x59A999D51bf6F7b0ef4c9b48aeaB9aa6F1f5CaCE);
    SPACEPORT_LOCK_FORWARDER = ISpaceportLockForwarder(0x9eE8287686ba2A23143adB011d896F5b6540a205);
    PLFI_DEV_ADDRESS = 0xD4FCB8398E9448Ddbf20F2108AeDc017B1a9e34C;
  }
...

{
  ...
  "evmVersion": "istanbul",
  "libraries": {
    "/Users/pavelbulochkin/plasmapay/Plasma-contracts/Spaceport-IDO-LaunchPad/contracts/Spaceport-v1-periphery/contracts/SpaceportHelper.sol": {
      "SpaceportHelper": "0xeC52416AdD9a65bA431A7c060750e2fbF7193f25"
    }
  },
  "outputSelection": {
    "*": {
