...
contract MerkleDrop is IMerkleDistributor {
    ...
    function claim(uint amount, bytes32[] calldata proof) override public {
        require(! withdrawn[msg.sender], "You have already withdrawn your entitled token.");
        require(verifyEntitled(msg.sender, amount, proof), "The proof could not be verified.");
    ...
    function verifyEntitled(address recipient, uint amount, bytes32[] memory proof) public view returns (bool) {
