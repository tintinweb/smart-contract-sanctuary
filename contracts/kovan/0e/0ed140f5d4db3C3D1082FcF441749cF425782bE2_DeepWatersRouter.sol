...
contract DeepWatersRouter is Ownable {
    ...
    **/
    ...
    // balances of router loans by assets
    mapping(address => uint256) public routerLoanBalances;
    
    // Aave interest bearing WETH (aWETH)
    address public aWETH; // '0x87b1f4cf9BD63f7BBD3eE1aD04E8F52540349347'
    
    constructor(
        address payable _vault,
        address _aaveLendingPool, // 0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe (kovan)
        address _aaveWETHGateway //  0xA61ca04DF33B72b235a8A28CfB535bb7A5271B70 (kovan)
    ) public {
    ...
    **/
        ...
        onlyOwner
    {
        ...
        routerLoanBalances[_asset] = routerLoanBalances[_asset].add(_amount);
    ...
    **/
        ...
        onlyOwner
    {
        ...
        require(_amount <= routerLoanBalances[_asset], "_amount exceeds the loan balance of an asset in DeepWatersRouter contract");
        ...
        routerLoanBalances[_asset] = routerLoanBalances[_asset].sub(_amount);
