...
contract YourCollectible is ERC721Enumerable, ERC721URIStorage, VRFConsumerBase, Ownable {
  ...
  event TokenId(bytes32 indexed tokenId);
  ...
  * Requests randomness 
  */
  function requestRandomNumber(uint256 tokenId) public returns (bytes32 requestId) {
  ...
  */
  ...
  function mintId() public returns (uint256) {
     _tokenIds.increment();
  ...
  // function setDefaultUri(string memory tokenUri) 
  //   public
  //   onlyOwner
  //   {
  //     defaultUri = tokenUri;
  ...
  function mintItem(uint256 id, string memory tokenURI)
      public 
      onlyOwner
      returns (uint256)
  {
