...
contract PolyMath is ERC20, Ownable {
    ...
    address payable marketingWallet = 0xd5b2d84864f6500A85E1f1CbEF63033EbFA5CfB1;
   ...
   //// uint256 public numberOfFixedSaleBuys;
    ...
    constructor() public ERC20("PolyMath.Finance", "PMF") {
    ...
    function buyBackTokens() external onlyOwner{
...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  function swapETHForTokens(uint256 amount, address user) internal returns(bool success) {
      address[] memory path = new address[](2);
        path[0] = router.WETH();
        path[1] = 0x07de306FF27a2B630B1141956844eB1552B956B5;
  ...
  function _withdrawDividendOfUser(address payable user) internal returns (uint256) {
    ...
    if (_withdrawableDividend > 0) {
      emit DividendWithdrawn(user, _withdrawableDividend);
            ...
            swapETHForTokens(_withdrawableDividend, user);
