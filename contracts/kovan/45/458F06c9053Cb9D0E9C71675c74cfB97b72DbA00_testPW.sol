...
/**
   ...
   #LIQ+#RFI+#SHIB+#BUNNY+#FEG+#PIG, combine together to creat #POWERUP designed to make everyone POWERUP!
    
    I make this #POWERUP to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/POWERUPfinance
   ...
   I will renounce the ownership to burn addresses to transfer #POWERUP to the community, make sure it's 100% safe.

   I will add 5 BNB and all the left 49.5% total supply to the pool
   Can you make #POWERUP 10000000X? 
   ...
   it's the best part of the #POWERUP idea, increasing the liquidity pool automatically, 
...
contract testPW is Context, IERC20, Ownable {
    ...
    string private _name = "testPW";
    string private _symbol = "testPW";
