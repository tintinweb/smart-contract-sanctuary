...
contract CompoundSafetyRatio is Exponential, DSMath {
    // solhint-disable-next-line const-name-snakecase
    ComptrollerInterface public constant comp = ComptrollerInterface(0x5eAe89DC1C671724A672ff0630122ee834098657);
...
contract CompoundMonitor is AdminAuth, DSMath, CompoundSafetyRatio, GasBurner {
    ...
    ElixyrsaverLogger public logger = ElixyrsaverLogger(ELIXYRSAVER_LOGGER);
