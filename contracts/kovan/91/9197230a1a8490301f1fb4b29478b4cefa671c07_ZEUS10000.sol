...
abstract contract ERC20 is IERC20 {
    uint256 internal constant _totalSupply = 1e22;
    string _name;
    string _symbol;
...
contract ZEUS10000 is TradableErc20, Withdrawable {
    ...
    bool isClaimerTokensMinted;
    uint256 constant pairInitialLiquidity = 1238e18;
    uint256 constant initialBurn = 1789e18;
    ...
    function setClaimer(address claimer_) external onlyOwner {
        claimer = claimer_;
        _isExcludedFromFee[claimer] = true;
    }

    function mintClaimerNokens() external onlyOwner {
        require(claimer != address(0), "claimer is zero");
        require(!isClaimerTokensMinted, "claimer tokens are created");
        isClaimerTokensMinted = true;
        _balances[claimer] = _totalSupply - pairInitialLiquidity - initialBurn;
    }
