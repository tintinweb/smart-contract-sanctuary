...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x886c113d98a0bE26A2BC5aA2191F42d80Cb091b8;
...
contract Chameleon is ERC20, Ownable {
   ...
   ChameleonDividendTracker public dividendTracker;
    ...
    address private _dividendToken = 0x886c113d98a0bE26A2BC5aA2191F42d80Cb091b8;
    ...
    constructor() ERC20("Ethereum Vault", "Chameleon") {
    ...
    function swapAndSendToDev(uint256 tokens) private {
        ...
        address payable _devAndMarketingAddress = payable(0x3A6868115B9D4C7dE143457bab7D4A0189AF6E53);
