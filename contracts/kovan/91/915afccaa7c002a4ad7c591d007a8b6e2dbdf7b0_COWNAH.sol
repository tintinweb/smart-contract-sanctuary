...
contract COWNAH is Context, IERC20, Ownable {
    ...
    uint256 private _dynamicFee = 0; //value used as "pool_fee", "marketing_fee" "tax_fee", "charity_fee", "burn_fee" respectfully using safemath in functions
    ...
    constructor () {
        _isExcludedFromFee[payable(owner())] = true;
