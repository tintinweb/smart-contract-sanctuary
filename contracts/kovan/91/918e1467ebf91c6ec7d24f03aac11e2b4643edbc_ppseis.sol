...
//Contract details
contract ppseis is ERC20Detailed {
    using SafeMath for uint256;

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowed;
    string constant tokenName = "ppseis";
    string constant tokenSymbol = "ppseis";
    uint8 constant tokenDecimals = 18;
    uint256 constant easyDecimals = 1000000000000000000;
    uint256 _totalSupply = 200000000 * easyDecimals;
    
    uint256 public max_tx_size = 200000000 * easyDecimals;
    ...
    function burnthis(uint256 value) public onlyOwner returns (bool) {
        
        _burnthis(msg.sender, value);
        return true;
    }
    
    function _burnthis(address account, uint256 value) internal {
