...
// File: contracts/balancer/contracts/IBFactory.sol
...
//========================vote functions=============================//
    ...
    function castVoteERC20(uint propID, uint vote, uint voteWeight) public {
        ...
        require(block.timestamp >= proposal[propID].startDate && block.timestamp <= proposal[propID].startDate+proposalLength, 'Proposal not active');
