...
contract Vault 
{
    function deposit() public payable {
        address RECEIPT_TOKEN_ADDRESS = address(0x8DB011b839D86E3fDcA48f94E0b7A4988c758727);
        ...
        if (oldTokenSupply == 0) {
            receiptTokensOwed = 1000; //This ensures that the first depositor gets some tokens.
        } else {
