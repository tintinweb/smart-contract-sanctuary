    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(address payable _feeRecipient, uint256 _platformFee, IERC20 _RWT, address _ownerAddr)
        public
        initializer
    {
    ...
    /// @param _ownerAddr New owner address

    function setOwnerAddr(address _ownerAddr)
        external
        onlyOwner
    {
        ownerAddr = _ownerAddr;
