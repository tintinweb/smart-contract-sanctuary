...
import "../erc-1155/ERC1155Xea12.sol";
import "@openzeppelin/contracts/proxy/BeaconProxy.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

/**
 * @dev This contract is for creating proxy to access ERC1155Xea12 token.
 *
 * The beacon should be initialized before call ERC1155Xea12Factory constructor.
 *
 */
contract ERC1155Xea12FactoryC2 is Ownable{
    address public beacon;
    address transferProxy;
    address lazyTransferProxy;

    event Create1155Xea12Proxy(address proxy);
    ...
    function getData(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) pure internal returns(bytes memory){
        return abi.encodeWithSelector(ERC1155Xea12(0).__ERC1155Xea12_init.selector, _name, _symbol, baseURI, contractURI);
    }
