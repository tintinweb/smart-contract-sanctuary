...
contract AlphaS is Context, IERC20, Ownable {
    ...
    string private _name = 'AlphaS';
    string private _symbol = 'ALPHAS';
    ...
    address payable public _projectDevelopmentWalletAddress = payable(0x4a648b39fd70296823c7A827c6c636AD8b8f1f94);
