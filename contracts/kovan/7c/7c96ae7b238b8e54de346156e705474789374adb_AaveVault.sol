    ...
    AccessControlUpgradeable
{
        ...
        whenNotPaused
    {
        ...
        collateralBalances[tx.origin][_aToken] = collateralBalances[tx.origin][_aToken].add(balanceA.sub(balanceB));
        avgIndex[tx.origin][_asset] = avgIndex[tx.origin][_asset].add((balanceA.sub(balanceB).mul(1e27)).div(getLiquidityIndex(_asset)));
