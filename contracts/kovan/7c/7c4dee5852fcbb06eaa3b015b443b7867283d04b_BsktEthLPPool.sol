...
contract BsktEthLPPool is LPTokenWrapper {
    IERC20 public STAKEBSKT = IERC20(0x1B6540CaF1f3f0293dF68F5f03EFd78A5698e166); // BSKT-ETH-LP TOKEN ADDRESS
    ...
    function stake(uint256 amount) public updateReward(msg.sender) checkStart {
        ...
        require(!minimumBsktStakingEntry[_msgSender()] && ( amount >= 5000 * 10 ** 17 ) , "Error:For Initial entry 5000 token must be required.");
        super.stake(amount);
    }
