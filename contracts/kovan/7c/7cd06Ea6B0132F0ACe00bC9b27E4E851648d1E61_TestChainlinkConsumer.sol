...
// contract ChainlinkConsumer is ChainlinkClient, IEscrow {
...
//     bytes32 private jobIdTimeline = bytes32('1c21e7c329a74ca58476979905b2791a');
...
//         request.addUint('taskId', _taskId);
//         request.add('promoterId', data.promoterUserId);
//         request.addUint('timeWindowStart', data.timeWindowStart);
//         request.addUint('timeWindowEnd', data.timeWindowEnd);
//         request.addUint('duration', data.persistenceDuration);
//         request.add('taskHash', data.taskHash);

//         //request.add('endpoint', 'UserTimeline');

//         req = request;
//         return sendChainlinkRequestTo(oracle, request, fee);
//     }

//     function verifyLookupData(
//         uint256 _taskId,
//         Task memory data,
//         bytes4 fulfillSelector
//     ) internal returns (bytes32 requestId) {
...
//         //request.add('endpoint', 'TweetLookup');

//         return sendChainlinkRequestTo(oracle, request, fee);
//     }

//     function changeJobIdTimeline(uint256 _jobId) public {
//         jobIdTimeline = bytes32(_jobId);
//     }

//     function changeJobIdLookup(uint256 _jobId) public {
//         jobIdLookup = bytes32(_jobId);
//     }
