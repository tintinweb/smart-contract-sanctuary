...
contract BettingContract is IBettingContract {
    ...
    function close() external override onlyPriceClosed onlyOpen {
        ...
        if (winers.length > 0) {
            ...
            IERC20(tokenAddress).safeTransfer(creator, getTotalToken());
        }
        Address.sendValue(creator, (address(this).balance * 95) / 100);
        ...
        )
    {
        ...
        price = (_price * 10**bracketsPriceDecimals) / 10**_decimals;
        if (price == 0) {
