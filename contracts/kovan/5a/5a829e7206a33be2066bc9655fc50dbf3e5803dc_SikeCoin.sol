...
contract SikeCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "SikeCoin";
    string private constant _symbol = "SIKE";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee <=5, "Invalid Tax Fee Percentage!");
        _taxFee = taxFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee <=5, "Invalid Liquidity Fee Percentage!");
