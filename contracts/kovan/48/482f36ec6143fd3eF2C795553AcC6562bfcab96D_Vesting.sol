...
contract Vesting is Ownable {
    ...
    event LogClaimLock(bool claimLock);
    ...
    /**
     * @dev Function that sets the claim lock true or false
     * @param _claimLock The claim lock
     */
    function setClaimLock(bool _claimLock) public onlyOwner {
        claimLock = _claimLock;
        emit LogClaimLock(_claimLock);
    }
    ...
    function claim() public {
        ...
        require(claimLock == false, "The claimLock hasn't unlocked");
