...
/**
 * @title SmartVault (version 0.3.5)
...
contract SmartVault is ERC721PresetMinterPauserAutoId, Ownable {
    ...
    constructor(uint256 _minVaultPrice, uint256 _processingFee) ERC721PresetMinterPauserAutoId("Carapace Smart Vault", "CSV", "") {
    ...
    function executeSmartVault(uint256 _vaultId) public onlyVaultReadyAndTrustees(_vaultId) {
        ...
        //Balance
        payable(owner()).transfer(vaultBalance[smartVaults[_vaultId].owner][_vaultId]-_totalBalanceToDistribute); //*processingFee/100);
