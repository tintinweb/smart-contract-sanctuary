...
contract PresaleFactory is Ownable {
    ...
    event presaleCreated(address presaleContract, uint256 endBlock);
     ...
     */
    function registerPresale (address _presaleAddress, uint256 _endBlock) public {
        require(presaleGenerators.contains(msg.sender), 'FORBIDDEN');
        presales.add(_presaleAddress);
        emit presaleCreated(_presaleAddress, _endBlock);
