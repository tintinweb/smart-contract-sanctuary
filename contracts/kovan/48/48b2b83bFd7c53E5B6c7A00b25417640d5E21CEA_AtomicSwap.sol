...
contract AtomicSwap {
    ...
    )
  {
    ...
    inputTokenInstance.safeApprove(address(uniswapRouter), 0);
    ...
    collateralInstance.safeApprove(address(synthereumPool), 0);
    ...
    )
  {
    ...
    synthToken.safeApprove(address(synthereumPool), 0);
    ...
    collateralInstance.safeApprove(address(uniswapRouter), 0);
