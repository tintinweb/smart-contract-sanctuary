...
/*
    ...
    */
    address bFactory = address(0x8f7F78080219d4066A8036ccD30D588B416a40DB);
    ...
    function approveTokensForPool(address _poolAddress) public {
      poolToken1.approve(address(_poolAddress), decimals.mul(1000));
      poolToken2.approve(address(_poolAddress), decimals.mul(1000));
      poolToken3.approve(address(_poolAddress), decimals.mul(1000));
    }

    function bindTokensToPool() public {
