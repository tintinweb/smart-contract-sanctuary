...
contract Puzzles is ERC721 {
    ...
    constructor(  address _chessToken) ERC721("NFTContractPuzzles", "PZL") {
    ...
    function claimReward(uint counter)  public {
        token.transferFrom(chessToken, msg.sender, counter);
    }
}
