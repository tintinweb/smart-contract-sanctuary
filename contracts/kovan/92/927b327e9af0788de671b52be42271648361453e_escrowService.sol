...
contract escrowService is Ownable{
    ...
    function withdrawETH(uint256 amount, address payable receiveAddress) internal {
        approveSpend(amount);
        wETHGateway.withdrawETH(lendingPoolAddress, uint256(amount) , address(this));
        require(receiveAddress.send(amount));
    }
    ...
    function withdrawProfits() public onlyOwner {
        ...
        approveSpend(profit);
        withdrawETH(profit, address(this));
    ...
    function withdrawAtokens() public payable onlyOwner {
