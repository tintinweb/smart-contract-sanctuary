    ...
    AccessControl
{
    ...
    event TEST_RERANGE(int24 baseLower, int24 baseUpper);
    ...
    constructor(
        ...
        tickSpacing = IUniswapV3Pool(currentPool.pool).tickSpacing();
    ...
    function rerange(int24 _tickRange, uint8 _poolId) external {
        ...
        int24 deltaLower = _tick - _baseLowerPrev;
        int24 deltaUpper = _baseUpperPrev - _tick;
        int24 _baseLower = (_tick - deltaLower * _tickRange / (deltaLower + deltaUpper));
        int24 _baseUpper = (_tick + deltaUpper * _tickRange / (deltaLower + deltaUpper));

        emit TEST_RERANGE(_baseLower, _baseUpper);
