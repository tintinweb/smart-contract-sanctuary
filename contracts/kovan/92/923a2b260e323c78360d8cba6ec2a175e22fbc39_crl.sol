...
// File openzeppelin-solidity/contracts/token/BEP20/[email protected]
...
// File contracts/tokens/deflationalAutoLP/UniswapV2/extensions/FeeToAddr/crl_constructed.sol


pragma solidity 0.8.4;
contract crl is FeeToAddrDeflAutoLPToken, AbstractBurnableDeflToken {
    constructor(
        string memory tName, 
        string memory tSymbol, 
        uint256 totalAmount,
