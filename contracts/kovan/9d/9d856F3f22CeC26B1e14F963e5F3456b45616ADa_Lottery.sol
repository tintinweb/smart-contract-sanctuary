...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function enter() public payable {
        ...
        require(msg.value > getEntranceFee(), 'You need at least $50 to enter');
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        require(lottery_state == LOTTERY_STATE.CALCULATING_WINNER, 'Lottery needs to be calculating a winner to fire this function');
        require(_randomness > 0, 'Randomness not initialized'); 
