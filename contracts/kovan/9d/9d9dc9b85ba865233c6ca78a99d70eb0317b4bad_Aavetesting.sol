...
contract Aavetesting {
    ...
    function withdrawETH() external {
        aToken.approve(address(lendingPoolAddress), aToken.balanceOf(address(this)));
        require(aToken.allowance(address(this), lendingPoolAddress) > 0, "approval missing");
        wETHGateway.withdrawETH(lendingPoolAddress, aToken.balanceOf(address(this)), msg.sender);
    }
