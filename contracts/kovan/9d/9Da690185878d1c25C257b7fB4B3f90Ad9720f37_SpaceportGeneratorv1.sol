...
contract Spaceportv1 is ReentrancyGuard {
  ...
  struct BuyerInfo {
    ...
    uint256 tokensLockTime; // lock time for spaceport tokens, unix timestamp -> e.g. 2 weeks
  }
  ...
  function userDeposit (uint256 _amount) external payable nonReentrant {
    ...
    buyer.tokensLockTime = 30 minutes;
  ...
  function userWithdrawTokens () external nonReentrant {
    ...
    BuyerInfo storage buyer = BUYERS[msg.sender];
    require(STATUS.LP_GENERATION_COMPLETE_TIME + buyer.tokensLockTime < block.timestamp, "AWAITING TOKENS UNLOCK");
...

{
  ...
  "libraries": {
    "/Users/pavelbulochkin/plasmapay/Launchpad-testdev/contracts/Spaceport-v1-periphery/contracts/SpaceportHelper.sol": {
      "SpaceportHelper": "0x92794011C85b0660a80B54f25c2AaE1333f0099e"
    }
  },
  "outputSelection": {
    "*": {
