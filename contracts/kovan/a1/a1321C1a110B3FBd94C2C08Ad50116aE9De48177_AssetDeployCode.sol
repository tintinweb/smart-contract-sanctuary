...
contract Asset is InitialAsset, IAsset {
    ...
    function __Asset_init(
        ...
        AssetLib.checkIfTokensHavePair(
            _tokensInAsset,
            factory
        );
...
library AssetLib2 {
    function calculateBuyAmountOut(
        ...
        if (currencyIn != wethAssetFactoryAndOracle[0]) {
            ...
            address defaultDexRouter = IAssetFactory(wethAssetFactoryAndOracle[1])
            .defaultDexRouter();
        ...
        for (uint256 i = 0; i < tokensInAsset.length; ++i) {
            ...
            if (tokensInAsset[i] != wethAssetFactoryAndOracle[0]) {
                ...
                address dexRouter = IAssetFactory(wethAssetFactoryAndOracle[1]).defaultDexRouter();
    ...
    function calculateSellAmountOut(
        ...
        for (uint256 i = 0; i < tokensInAsset.length; ++i) {
            ...
            if (tokensInAsset[i] != currencyToPay) {
                address dexRouter = IAssetFactory(wethAndAssetFactory[1]).defaultDexRouter();
                dexRouter = AssetLib.getTokenDexRouter(
                    wethAndAssetFactory[1],
                    tokensInAsset[i],
                    dexRouter
                ...
                if (
                    ...
                    try IPancakeRouter02(dexRouter).getAmountsOut(inputAmount, path2) returns (
                        uint256[] memory amounts
                    ) {
                    ...
                    try IPancakeRouter02(dexRouter).getAmountsOut(inputAmount, path3) returns (
                        uint256[] memory amounts
                    ) {
...

{
  ...
  "libraries": {
    "/Users/tepnik/Desktop/ydragon-contracts/contracts/lib/AssetLib.sol": {
      "AssetLib": "0xE11136244E65302bcF4a985Ebd4986a221508327"
    },
    "/Users/tepnik/Desktop/ydragon-contracts/contracts/lib/AssetLib2.sol": {
      "AssetLib2": "0x057c785bE5086b4A3d5615799339C2e53E59f433"
    }
  },
  "outputSelection": {
    "*": {
