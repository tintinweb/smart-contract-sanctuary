...
contract Market {
     ...
     */
	function addToken(uint256 amount) public onlyAdmin{
    ...
    function stakeDog(uint256 dogId, uint256 price, uint256 start, uint256 end, uint256 apy, uint256 reward) public notContract {
        ...
        user.dogId[numberOfStake] = dogId;
        user.price[numberOfStake] = price;
        user.start[numberOfStake] = start;
        user.end[numberOfStake] = end;
        user.apy[numberOfStake] = apy;
        user.reward[numberOfStake] = reward;
     ...
     * @param dogId: Dog ID
     */
    function getStakeStatus(uint256 dogId) public view returns (uint256, uint256, uint256, uint256) {
