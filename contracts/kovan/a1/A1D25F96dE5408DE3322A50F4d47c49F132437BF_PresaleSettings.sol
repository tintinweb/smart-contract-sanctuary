...
contract PresaleSettings is Ownable {
    ...
    constructor(uint256 _baseFee, uint256 _tokenFee, uint256 _ethCreationFee) public {
        SETTINGS.BASE_FEE = _baseFee; // in parts of 1000
        SETTINGS.TOKEN_FEE = _tokenFee; // in parts of 1000
        SETTINGS.REFERRAL_FEE = 200; // 20%
        SETTINGS.ETH_CREATION_FEE = _ethCreationFee; // 1 BNB / 250 Matic / 0.06 ETH
