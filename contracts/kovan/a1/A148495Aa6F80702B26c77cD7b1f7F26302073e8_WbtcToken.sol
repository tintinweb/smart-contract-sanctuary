...
// contract address: 0xB6870dd4A747eC999e64Af7bA9588c3c92ca4327

contract WbtcToken is ChainlinkClient, ConfirmedOwner {
    ...
    string private _name = 'wraped BTC';
    string private _symbol = 'WBTC';
    
    
    address public senderAdddre;

    mapping(address => uint256) private _balances;
    
    // mapping(bytes32 => address) private _contractSender;
...
//   );
    ...
    function mint(address _oracle,string memory _bitconAddress, string memory _hashBit, string memory _jobId)
      public 
      onlyOwner {
    Chainlink.Request memory req = buildChainlinkRequest(stringToBytes32(_jobId), address(this), this.fullfilMint.selector);
    req.add("hash", _hashBit);
    req.add("address", _bitconAddress);
    sendChainlinkRequestTo(_oracle, req, ORACLE_PAYMENT);
    }

    function fullfilMint(bytes32 _requestId, uint256 _value)
      public
      recordChainlinkFulfillment(_requestId)
    {
        _mint(0x7b2a3598d63256D0CE33a64ed88515dD6e76Eb2A, _value);
    }
