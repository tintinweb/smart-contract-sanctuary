...
contract CrateNFT is Context, ERC721 {
        ...
        public
    {
        ...
        removeCrateFromSold(crateId);
		transferFrom(seller, _marketAddress, crateId);
    }    
    ...
    // Utility function to remove crate from sale list
    function removeCrateFromSold(uint256 crateId) internal {
        uint256 numOfCrates = soldCrates.length;
		uint256 label = 0;
