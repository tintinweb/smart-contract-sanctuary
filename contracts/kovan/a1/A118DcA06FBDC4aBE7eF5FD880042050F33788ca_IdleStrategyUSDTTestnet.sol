...
contract IdleFinanceStrategy is IStrategy, RewardTokenProfitNotifier {
    ...
    constructor(
        ...
        idleTokenHelper = IIdleTokenHelper(0x29C2EaD9ebf7893edfe2F28557E219B21B9273aa);
        virtualPrice = idleTokenHelper.getRedeemPrice(idleUnderlying);
    }
...
contract IdleStrategyUSDTTestnet is IdleFinanceStrategy {
    ...
    address constant public __uniswap = address(0x29C2EaD9ebf7893edfe2F28557E219B21B9273aa);
    address constant public __idleUnderlying= address(0x29C2EaD9ebf7893edfe2F28557E219B21B9273aa);
