...
interface FeedRegistryLike {
    function latestRoundData(address base, address quote) external returns (uint80 roundId, int256 answer, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound);
...
contract FeedRegistry {
    ...
    FeedRegistryLike immutable public fallbackFeedRegistry;
    UniswapOracle immutable public usdcWcfgPool;
    address immutable public wcfg;
