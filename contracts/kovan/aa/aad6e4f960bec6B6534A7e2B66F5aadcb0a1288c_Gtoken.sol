...
contract Gtoken is IGtoken, Context {
        ...
        returns (bool)
    {
        ...
        emit Transfer(address(0), recipient, amount,0,0);
        return true;
    }
    ...
    function _transfer(
        ...
        emit Transfer(sender, recipient, amount,fee,receiverAmount);
    }
...
interface IGtoken {
     ...
     */
    event Transfer(address indexed from, address indexed to, uint256 value,uint256 fee,uint256 receiverAmount);
