...
contract GotchiVault is IERC173, Initializable,PausableUpgradeable, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
    ...
    address internal constant im_diamondAddress = 0x07543dB60F19b9B48A69a7435B5648b46d4Bb58E; //kovan
    address internal constant im_ghstAddress = 0xeDaA788Ee96a0749a2De48738f5dF0AA88E99ab5; //kovan
...
contract vGHST is Initializable, ERC20Upgradeable, PausableUpgradeable {
    ...
    address public constant ghstAddress=0xeDaA788Ee96a0749a2De48738f5dF0AA88E99ab5; //kovan
   ...
   // address public constant ghstAddress=0x385Eeac5cB85A38A9a07A70c73e0a3271CfB54A7;
    ...
    address public constant diamondAddress=0x07543dB60F19b9B48A69a7435B5648b46d4Bb58E; //kovan
    ...
    function convertVGHST(uint256 _share) public view whenNotPaused returns(uint256 _ghst){
        if(_share > 0){
            uint256 totalShares = totalSupply(); // Gets the amount of vGHST in existence
