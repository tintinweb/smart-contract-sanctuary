...
contract LBPManager {
  ...
  function pause() external {
    ...
    require(lbp.getSwapEnabled(), "pool must be unpaused");
    (bool paused, , ) = lbp.getPausedState();
    require(paused == false, "pool is already paused");
    lbp.setPaused(true);
  }
  ...
  function unpause() external {
    ...
    (bool paused, , ) = lbp.getPausedState();
    require(paused, "pool is not paused");
