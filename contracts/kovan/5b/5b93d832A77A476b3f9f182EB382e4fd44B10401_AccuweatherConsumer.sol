...
contract AccuweatherConsumer is ChainlinkClient {
    ...
    //     bytes32 name;
    //     bytes32 countryCode;
    //     bytes32 localDateTime;
    //     bytes32 precipitationType;
    //     bytes32 weatherText;
    //     bytes32 windDirection;
    // }
    // Maps <RequestId, Result>
    // mapping(bytes32 => LocationCurrentConditions) public requestIdData;
    mapping(bytes32 => Location) public requestIdLocationData;
    mapping(bytes32 => CurrentConditions) public requestIdCurrentConditionsData;
     ...
     * @param _lan the latitude
     * @param _lan the longitude
    ...
    function fulfillLocationCurrentConditions(bytes32 _requestId, LocationCurrentConditions memory _result)
        public
        recordChainlinkFulfillment(_requestId)
    {
        // Location
        Location memory location;
        location.locationFound = _result.locationFound;
        location.locationKey = _result.locationKey;
        location.name = _result.name;
        location.countryCode = _result.countryCode;

        requestIdLocationData[_requestId] = location;

        // CurrentConditions
        CurrentConditions memory currentConditions;
        currentConditions.hasPrecipitation = _result.hasPrecipitation;
        currentConditions.feelTemperature = _result.feelTemperature;
        currentConditions.relativeHumidity = _result.relativeHumidity;
        currentConditions.temperature = _result.temperature;
        currentConditions.timestamp = _result.timestamp;
        currentConditions.uvIndex = _result.uvIndex;
        currentConditions.weatherIcon = _result.weatherIcon;
        currentConditions.windSpeed = _result.windSpeed;
        currentConditions.localDateTime = _result.localDateTime;
        currentConditions.precipitationType = _result.precipitationType;
        currentConditions.weatherText = _result.weatherText;
        currentConditions.windDirection = _result.windDirection;

        requestIdCurrentConditionsData[_requestId] = currentConditions;
    }
