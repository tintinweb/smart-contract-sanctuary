...
contract MasterChef is Ownable {
    ...
    // Reward TOKEN!
    address public rewardToken=0xbAd583fA3300a8C94119D51E3f9D7a58499d3019;
    //代替铸币合约
    address public constant masterChefMinter = 0xdc4C4088E1b5e6dcCfa1D11A2130Aaec607F28bf;
      //收入统计合约 
    ...
    function _updatePool(uint256 _pid) private {
        ...
        uint256 rewardAmount = multiplier.mul(rewardPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        if (rewardAmount>0){
          IMasterChefMinter(masterChefMinter).transferOut(rewardToken,rewardAmount,address(this));
        }
