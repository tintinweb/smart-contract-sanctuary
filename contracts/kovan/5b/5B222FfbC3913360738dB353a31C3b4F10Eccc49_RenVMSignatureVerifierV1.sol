...
contract RenVMSignatureVerifierV1 is Initializable, OwnableUpgradeable, RenVMSignatureVerifierStateV1, IERC1271 {
    ...
    bytes4 public constant CORRECT_SIGNATURE_RETURN_VALUE = CORRECT_SIGNATURE_RETURN_VALUE_;
    bytes4 public constant INCORRECT_SIGNATURE_RETURN_VALUE = 0x000000;

    function __RenVMSignatureVerifier_init(address mintAuthority_) public initializer {
        __Ownable_init();
