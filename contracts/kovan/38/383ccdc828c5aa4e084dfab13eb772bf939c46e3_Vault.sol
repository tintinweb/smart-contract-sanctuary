...
contract Vault 
{
    function deposit() public payable {
        address RECEIPT_TOKEN_ADDRESS = address(0x08BcDD77B55c2c46a43D8b9f1dE8fD7E3aeDDe8b);
        ...
        if (oldTokenSupply == 0) {
            ...
            receiptTokensOwed = (depositValue**2 * oldTokenSupply + depositValue * oldVaultValue * oldTokenSupply)/(depositValue * oldVaultValue + oldVaultValue**2);
        }
