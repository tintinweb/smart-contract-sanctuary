...
contract RandomNumber is VRFConsumerBase,Ownable {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        IPool(poolContract)._setRandomNumber(randomness);
       }

   function randomNumber() external view returns (uint256 random){
         return randomResult;
     } 
...
// Co-ordinator  0xdD3782915140c8f3b190B5D67eAc6dc5760C46E9
