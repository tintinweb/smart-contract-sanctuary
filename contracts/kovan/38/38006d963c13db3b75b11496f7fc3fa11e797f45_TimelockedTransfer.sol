...
pragma solidity 0.6.12;
 // All this probably sucks but it works.
 // Nah nvm, it was just me being a dumbass, took away about 2/3 of my code and now it should be pretty optimized
 // NOTE code probably breaks if you send a 2nd transaction to the same address before the 1st was completed (most likely the 1st transaction would be lost)
contract TimelockedTransfer is Context {
	using SafeMath for uint256;
	using Address for address;
	...
	function queueSend(address _sender, address _reciever, uint256 _amountSent, uint256 _delay) public {
