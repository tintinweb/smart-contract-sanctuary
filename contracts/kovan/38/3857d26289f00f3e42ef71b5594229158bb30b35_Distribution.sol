...
contract Distribution is Ownable, IDistribution {
    ...
    constructor(
        ...
        stake[FOUNDATION_REWARD] = 38_527_231 ether;
        ...
        cliff[PRIVATE_OFFERING] = 10 minutes; // unlock of the cliff tranche and start of installments unlocking
        cliff[ADVISORS_REWARD] = 20 minutes; // unlock of the cliff tranche and start of installments unlocking
        cliff[FOUNDATION_REWARD] = 30 minutes; // unlock of the cliff tranche and start of installments unlocking
        cliff[TEAM_FUND] = 40 minutes; // unlock of the cliff tranche and start of installments unlocking
