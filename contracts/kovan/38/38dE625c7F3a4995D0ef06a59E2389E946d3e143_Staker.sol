...
contract Staker {
  ...
  modifier notCompleted() {
    require(exampleExternalContract.completed() == false, 'Staking been completed');
    _;
  }
  ...
  function execute() public notCompleted {
    ...
    uint256 amountStaked = address(this).balance;
    if (amountStaked > threshold) {
      exampleExternalContract.complete{value: amountStaked}();
    } else {
  ...
  function withdraw() public notCompleted {
    ...
    require(sent, 'Failed to withraw funds');
  }
