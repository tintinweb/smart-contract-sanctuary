...
contract UsdcToUsdAssimilator is IAssimilator {
    ...
    IERC20 private constant usdc = IERC20(0x7B5392CD8e2a48313939AB167F1CdECE227a314D);
...
library ABDKMath64x64 {
   ...
   * @return signed 64.64-bit fixed point number
   */
  function divu (uint256 x, uint256 y) internal view returns (int128) {
    // x = 10
    // y = 100
    // 1 / 10
    require (y != 0);
    ...
    console.log("uint128 result:");
    console.log(result);
    require (result <= uint128 (MAX_64x64));
    console.log("int128 (result)");
    console.logInt(int128 (result));
    return int128 (result);
    // uint128 -> (0, 127) 
    // int128 -> (-64, 64)
  }
