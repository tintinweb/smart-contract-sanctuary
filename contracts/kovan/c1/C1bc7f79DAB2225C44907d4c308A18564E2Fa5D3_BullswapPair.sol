...
import './interfaces/IBullswapERC20.sol';
import './libraries/SafeMath.sol';

contract BullswapERC20 is IBullswapERC20 {
    using SafeMath for uint;

    string public constant name = 'BullBNB LPs';
    string public constant symbol = 'BullBNB-LP';
    ...
    bytes32 public constant PERMIT_TYPEHASH = 0xd597a243ecfbd2b346035710b46b25e6b3e2df8bb9f5103ba08d7aba7f54f63a;
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'Bullswap: INVALID_SIGNATURE');
...
import './interfaces/IBullswapCallee.sol';
