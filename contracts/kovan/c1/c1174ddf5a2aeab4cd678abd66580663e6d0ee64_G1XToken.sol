...
/**
 * @title G1XToken
 * @dev The G1X Token can be minted and burned.
 * Accounts can be paused, limiting the token holder's ability to
 * transfer and transferFrom tokens.
 * G1X has a cap value of 5.000.000.000 tokens.
 */
contract G1XToken is ERC20Detailed, ERC20Capped, ERC20Resumable, ERC20Burnable {
    string private name_ = 'G1X Token';
    string private symbol_ = 'G1X';
    uint256 private constant decimals_ = 18;
    uint256 private constant cap_ = 5000000000 * (10**18);
