...
contract SecurityTokenSBT is ERC20Token, Ownable, IERC1594,IERC1644 {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, address _controller,IUserRegistry _userRegistry,IERC1410Registry _TransferPartitionRegistry) 
    public 
    {
