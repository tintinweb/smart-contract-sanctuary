...
contract LiquidityPoolFarm is Ownable {
    ...
    function deposit(uint256 _amount) public {
        ...
        user.rewardDebt = user.amount.mul(accAdyPerShare.div(1e12)).div(1e18);
    ...
    function updatePool() public {
        ...
        accAdyPerShare = accAdyPerShare.add(
            adyReward.mul(1e18).div(daiSupply).mul(1e12)
        );
    ...
    function pendingAdy(address _user) external view returns (uint256) {
        ...
        return
            user.amount.mul(_accAdyPerShare.div(1e12)).div(1e18).sub(
                user.rewardDebt
            );
    }
