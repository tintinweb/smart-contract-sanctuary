...
contract GrailerTokhan is ERC20, AccessControl, ERC20Snapshot, ERC20Pausable, ERC20Burnable {
    ...
    uint256 public constant AMOUNT_TREASURY = INITIAL_SUPPLY / 100 * 50;            // 5,000,000
    uint256 public constant AMOUNT_AIRDROP = INITIAL_SUPPLY / 100 * 20;             // 2,000,000
    uint256 public constant AMOUNT_LP = INITIAL_SUPPLY / 100 * 12;                  // 1,200,000
    uint256 public constant AMOUNT_AUCTION = INITIAL_SUPPLY / 100 * 10;             // 1,000,000
    uint256 public constant AMOUNT_BOOTSTRAP_PLATFORM = INITIAL_SUPPLY / 100 * 8;   // 800,000
    ...
    constructor(address admin) ERC20("Grailers", "GRAIL") {
        ...
        address initialAddress = 0x058FA96b880dc3E85D648Eac519F0DbD5958d27c;
        _mint(initialAddress, INITIAL_SUPPLY);
    }
