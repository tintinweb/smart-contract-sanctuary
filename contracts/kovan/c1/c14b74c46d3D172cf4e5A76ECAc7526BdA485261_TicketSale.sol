...
contract TicketSale {
    ...
    event TicketTransfered(address indexed _from, address indexed _to);
    ...
    function TransferTicket(address _to) public hasTicket(msg.sender){
        tickets[msg.sender]--;
        tickets[_to]++;
        emit TicketTransfered(msg.sender, _to);
    }
