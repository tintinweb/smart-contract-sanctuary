...
contract DebtProtocol is ERC20, Ownable {
    ...
    constructor(address master) public ERC20("Debt Protocol", "DEBT") { 
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())               // Create the DEBT-BNB Pancakeswap V2 pair
            .createPair(address(this), address(0xF7237475185053eFE89A12E5dEeA6c00ABE2857e)); // BSC WBNB :  0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
        ...
        _isExcluded[address(uniswapV2Router)] = true;                               // Pancakeswap router excluded 
...
//        require(now.sub(antiBotTimer) >= 300 || amount <= 100000000 * 10**DECIMALS, "Max buy 100,000,000 DEBT right after launch");
        ...
        override(ERC20) 
    {
        ...
        } else if (amount >= _totalSupply.div(10)) {                        // Allow contracts managing LP not to be part of the debt mechanism
