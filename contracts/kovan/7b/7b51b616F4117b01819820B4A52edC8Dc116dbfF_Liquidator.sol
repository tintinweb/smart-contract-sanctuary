    ...
    ReentrancyGuardUpgradeable
{
    ...
    // Threshold of Keeper Pools' ETH staked amount at which only
    ...
    /**
     * @notice Ensures that the staked amount in the target fxKeeperPool is
               greater than the threshold if the sender is not the keeper pool.
     * @param fxToken the pool fxToken
     * @param tokenPrice the fxToken quote in ETH
     */
