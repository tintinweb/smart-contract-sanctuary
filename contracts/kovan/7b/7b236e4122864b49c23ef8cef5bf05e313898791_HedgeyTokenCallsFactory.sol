...
contract HedgeyTokenCallsV1 is ReentrancyGuard {
    ...
    address public weth = 0xc778417E063141139Fce010982780140Aa0cD5Ab; //wrapped eth    
    uint public fee;
    ...
    function getFrom(uint amountIn) public view returns (uint cashOut, uint wethOut) {
        ...
        //now that we know how much the assetIn buys us in WETH - how much pymtCurrency does that WETH get us
...
contract HedgeyTokenCallsFactory {
    ...
    function createContract(address asset, address pymtCurrency) public {
        ...
        HedgeyTokenCallsV1 callContract = new HedgeyTokenCallsV1(asset, pymtCurrency, collector, fee, collectorSet);
