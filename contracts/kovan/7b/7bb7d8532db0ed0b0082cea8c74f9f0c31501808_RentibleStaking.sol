...
*/      
    ...
    function updateDailyTotalLptAmount() private {
        ...
        for (uint256 i = currentStakingDayNumber; i <= 91; i++) {
            dailyTotalLptAmount[currentStakingDayNumber] = currentTotalLptAmount;
        } 
    ...
    function addToTheTheUsersAssignedReward() public returns(uint256) {
        ...
        if (dayNumber == 1) {
            rewardCountedUptoDayNextDay =  rewardCountedUptoDay;
        } else {
        ...
        for (uint256 i = rewardCountedUptoDayNextDay; i <= dayNumberMinusOne; i++) {
            ...
            uint256 k = dailyTotalLptAmount[i].div(usersCurrentLtpAmount);
