...
contract RadarToken is ERC20 {
    uint256 constant TOTAL_INIT_SUPPLY = 1e10 * 1e18;

    /**
     * @dev constructor
     *      distribute tokens to mint addresses and the rest will go to deployer
    ...
    constructor(
        ...
        require(totalSupply() <= TOTAL_INIT_SUPPLY, "RadarToken: cannot mint more than 10B tokens initially");

        _mint(msg.sender, TOTAL_INIT_SUPPLY - totalSupply());
    }
