...
// hevm: flattened sources of /nix/store/kmnis12ammyx2s1cg13r0yvicn118822-dsr-manager/dapp/dsr-manager/src/DsrManager.sol

pragma solidity >=0.5.12;

////// /nix/store/kmnis12ammyx2s1cg13r0yvicn118822-dsr-manager/dapp/dsr-manager/src/DsrManager.sol
// DsrManager.sol
...
contract DsrManager {
    PotLike_2  public pot;
    GemLike_4  public dai;
    ...
    constructor(address pot_, address daiJoin_) public {
        ...
        dai = GemLike_4(daiJoin.dai());

        VatLike_11 vat = VatLike_11(pot.vat());
