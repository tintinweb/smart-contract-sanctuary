...
contract FarmDelegate is FarmStorageV1 {
    ...
    function reDeposit(uint256 _pid, uint256 amount) public payable {
        ...
        (uint256 reDepositLimit, uint256 blockNumber) = getReDepositLimit(_pid,msg.sender);
    ...
    // view function
    function getReDepositLimit(uint256 _pid,address _user) public view returns (uint256, uint256) {
            UserInfo storage user = userInfo[_pid][_user];
            (
