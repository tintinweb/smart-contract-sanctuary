...
contract Scarabs is ERC721Enumerable, Ownable {
    ...
    address private _artistAddress = 0x92377Ad4968dd540eEecFC8eEE272686E40b346f;
    address private _devAddress = 0x19654b747d9C72417b0432f3312eA0b040540fa5;
    ...
    function presaleBuy(uint256 tokenQuantity) external payable {
        ...
        require(totalSupply() < MAX_SUPPLY, "All available scarabs are minted");
        require(privateAmountMinted + tokenQuantity <= PRESALE_ALLOCATION, "Minting would exceed the presale allocation");
        require(presalerListPurchases[msg.sender] + tokenQuantity <= presalePurchaseLimit, "You can mint up to 2 scarabs in the presale");
        require(SCARAB_PRICE * tokenQuantity <= msg.value, "Insufficient ETH sent");
