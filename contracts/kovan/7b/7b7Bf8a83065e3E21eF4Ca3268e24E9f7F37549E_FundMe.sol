...
// Dans lles versions inférieures à 0.8 il peut y avoir des overflow de types, on peut donc utiliser la librairie suivante pour checker pour les version < 0.8, à partir de 0.8, ça ne sert plus à rien car c'est intégré en natif !
