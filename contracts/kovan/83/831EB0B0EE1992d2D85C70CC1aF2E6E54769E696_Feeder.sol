...
contract Feeder is OwnableUpgradeable, IFeeder {
    ...
    function resolveCondition(
        ...
        router.resolveCondition(agreements, conditionID, outcomeWin);
    }
    ...
    function createAgreement(
        ...
        require(
            timePeriod > 0 &&
                ...
                jobPenalty > jobFund &&
                taskResultPenalty > 0,
            "Agreement fields must be set!"
        );
        router.FEEDcreateAgreement(
            timePeriod,
            coreType,
            jobTaskCount,
            jobFund,
    ...
    function cancelAgreement(uint256 agreementID) external override onlyOwner {
        router.FEEDcancelAgreement(agreementID);
    }
    ...
    function getOwner() external view override returns (address ownerWallet) {
        return owner();
    }
}
