...
contract DOPE is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(sent){
            _tokenTransfer(address(this), 0x07Fca3622e35DAdA3E41BCe2C2BDf15057AB9Cc4, charityPortion, false);
            emit Transfer(address(this), 0x07Fca3622e35DAdA3E41BCe2C2BDf15057AB9Cc4, charityPortion);
        } else {
