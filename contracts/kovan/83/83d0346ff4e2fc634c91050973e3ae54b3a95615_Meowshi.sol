...
//  ៱˳_˳៱   ∫
contract Meowshi {
    IBentoBoxBasic constant bento = IBentoBoxBasic(0x559fb960791D049E3C1D110D7F48fa0ff722ce32); // BENTO vault contract (multinet)
    ISushiBar constant sushiToken = ISushiBar(0x11cb374BeEE797dBBB4c848195bf24D7085acd68); // SUSHI token contract (mainnet)
    address constant sushiBar = 0x921496CA04caF4a2858A7EbB6D35F721B70B5993; // xSUSHI token contract for staking SUSHI (mainnet)
