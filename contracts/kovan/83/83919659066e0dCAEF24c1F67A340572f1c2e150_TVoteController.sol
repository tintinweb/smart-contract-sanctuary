...
// File: TVoteController.sol

contract TVoteController {
    ...
    function returnToken1(address _comp, uint256 _proposalId) public {
        require(msg.sender == operator || msg.sender == governance, "!operator");
        require(proposalId[_comp] == _proposalId, "!proposalId");
        uint8 _type = types[_comp];
        require(_type > 0, "!type");
    ...
    function returnToken11(address _comp, uint256 _proposalId) public {
        require(msg.sender == operator || msg.sender == governance, "!operator");
        require(proposalId[_comp] == _proposalId, "!proposalId");
        uint8 _type = types[_comp];
        require(_type > 0, "!type");
    ...
    function returnToken2(address _comp, uint256 _proposalId) public {
        require(msg.sender == operator || msg.sender == governance, "!operator");
        require(proposalId[_comp] == _proposalId, "!proposalId");
        uint8 _type = types[_comp];
        require(_type > 0, "!type");
    ...
    function returnToken3(address _comp, uint256 _proposalId) public {
        require(msg.sender == operator || msg.sender == governance, "!operator");
        require(proposalId[_comp] == _proposalId, "!proposalId");
        uint8 _type = types[_comp];
        require(_type > 0, "!type");
