...
*/
    ...
    returns (uint112 reserve0, uint112 reserve1, address token0, address token1, address weth,uint price0CumulativeLast,uint price1CumulativeLast)
    {
        ...
        return (_reserve0,_reserve1,pair.token0(), pair.token1(),uniswapV2Router02.WETH(),pair.price0CumulativeLast(),pair.price1CumulativeLast());
    }
    /*************************************************************
