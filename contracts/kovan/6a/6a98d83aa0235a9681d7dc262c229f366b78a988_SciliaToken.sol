...
contract SciliaToken {
    ...
    uint256 supply = 50000; //The initial supply of the token at contract creation is 50,000
    ...
    function transferFrom(address _from,address _to,uint256 _value) public returns (bool) {
        ...
        require(_value <= allowances[_from][msg.sender],"not sufficient allowance");
        require(1 <= _value);
