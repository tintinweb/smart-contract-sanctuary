 ...
 */
/**
 * @title A consumer contract for Enetpulse EA.
 * @author LinkPool
 * @notice Request Schedule, Game Details, and Game Score.
 */
contract EnetpulseConsumerLR is ChainlinkClient {
    ...
    /**
     * @notice Returns today's game IDs.
     * @dev Result format is "[<gameId_1>,...,<gamId_N>]" as bytes.
     * @param _jobId the job ID.
     * @param _payment the LINK amount in Juels (i.e. 10^18 aka 1 LINK).
     * @param _leagueId the ID of the tournament (check the table above).
     */
    ...
    /**
     * @notice Returns the game IDs for a given date.
     * @dev Result format is "[<gameId_1>,...,<gamId_N>]" as bytes.
     * @param _jobId the job ID.
     * @param _payment the LINK amount in Juels (i.e. 10^18 aka 1 LINK).
     * @param _leagueId the ID of the tournament (check the table above).
     * @param _date the date of the game (YYYY-MM-DD).
     */
    function requestSchedule(
        bytes32 _jobId,
        uint256 _payment,
    ...
    /**
     * @notice Returns the details for a given game ID.
     * @dev Result format is
     * "[<homeTeamId>,<homeTeam as bytes>,<awayTeamId>,<awayTeam as bytes>,<kickOffTime>,<status>]" as bytes.
     * @param _jobId the job ID.
     * @param _payment the LINK amount in Juels (i.e. 10^18 aka 1 LINK).
     * @param _gameId the game ID (to be obtained via Provider's API or `requestSchedule()`)
     */
    ...
    /**
     * @notice Returns the score for a given game ID.
     * @dev Result format is "[<status>,<homeTeamScore>,<awayTeamScore>]" as bytes.
     * @param _jobId the job ID.
     * @param _payment the LINK amount in Juels (i.e. 10^18 aka 1 LINK).
     * @param _gameId the game ID (to be obtained via Provider's API or `requestSchedule()`)
     */
