...
contract ETHSwapAgentImpl is Context,IERC721Receiver,IERC1155Receiver {
    ...
    event SwapPair721Register(address indexed sponsor,address indexed erc20Addr, string name, string symbol, string baseURI);
    event SwapStarted(address indexed erc20Addr, address indexed fromAddr, uint256 amount, uint256 feeAmount);
    event Swap721Started(address indexed erc20Addr, address indexed fromAddr, uint256 tokenId, uint256 feeAmount);
    event SwapFilled(address indexed erc20Addr, bytes32 indexed bscTxHash, address indexed toAddress, uint256 amount);
    event Swap721Filled(address indexed erc20Addr, bytes32 indexed bscTxHash, address indexed toAddress, uint256 tokenId);
