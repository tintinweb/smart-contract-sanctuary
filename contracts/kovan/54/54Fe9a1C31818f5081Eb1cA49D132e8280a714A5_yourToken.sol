...
/***
 *                                                                                                                                                          
 *     _____      _____         _____     ____   ____      _____          _________________         _____     ____    ____       ______    _____   ______   
 *    |\    \    /    /|   ____|\    \   |    | |    | ___|\    \        /                 \   ____|\    \   |    |  |    |  ___|\     \  |\    \ |\     \  
 *    | \    \  /    / |  /     /\    \  |    | |    ||    |\    \       \______     ______/  /     /\    \  |    |  |    | |     \     \  \\    \| \     \ 
 *    |  \____\/    /  / /     /  \    \ |    | |    ||    | |    |         \( /    /  )/    /     /  \    \ |    | /    // |     ,_____/|  \|    \  \     |
 *     \ |    /    /  / |     |    |    ||    | |    ||    |/____/           ' |   |   '    |     |    |    ||    |/ _ _//  |     \--'\_|/   |     \  |    |
 *      \|___/    /  /  |     |    |    ||    | |    ||    |\    \             |   |        |     |    |    ||    |\    \'  |     /___/|     |      \ |    |
 *          /    /  /   |\     \  /    /||    | |    ||    | |    |           /   //        |\     \  /    /||    | \    \  |     \____|\    |    |\ \|    |
 *         /____/  /    | \_____\/____/ ||\___\_|____||____| |____|          /___//         | \_____\/____/ ||____|  \____\ |____ '     /|   |____||\_____/|
 *        |`    | /      \ |    ||    | /| |    |    ||    | |    |         |`   |           \ |    ||    | /|    |   |    ||    /_____/ |   |    |/ \|   ||
...
contract yourToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1234567890 * _decimalFactor;
    ...
    uint256 private _minUsdAmtToChangeToken = 0;

    address public usd = 0x55d398326f99059fF775485246999027B3197955; //USDT on PCS Mainnet
    ...
    uint256 public _maxTxAmount = 1234567890 * _decimalFactor;
    uint256 private minimumTokensBeforeSwap = 1000000 * _decimalFactor;  

    address uniRouterAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address pcsRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address routerAddress = uniRouterAddress;
    ...
    modifier hasEnoughUsdToChangeStuff() {
        require(hasEnoughUsd() || !isTokenLive(), "Sorry: You don't have enough USD to change stuff");
        _;
    }
    ...
    function yourUSDValue(address yourAddress) public view returns (uint256) {
        ...
        //uint[] memory amounts = uniswapV2Router.getAmountsOut(tokenBalance, path);

       
    }

    function getUsdDecimals() public view returns (uint256) {
    ...
    function changeTelegramLink(string memory newTelegramLink) external onlyOwner {
        _telegramLink = newTelegramLink;
    }

    function changeDiscordLink(string memory newDiscordLink) external onlyOwner {
    ...
    function setMarketingDivisor(uint256 divisor) external hasEnoughUsdToChangeStuff {
