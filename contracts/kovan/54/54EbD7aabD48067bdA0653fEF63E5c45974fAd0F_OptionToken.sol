...
// hevm: flattened sources of src/core/OptionToken.sol
...
////// src/core/implementations/IProtocol.sol
/* pragma solidity ^0.8.4; */
...
////// src/libraries/DateTimeLibrary.sol
/* pragma solidity ^0.8.4; */
...
////// src/openzeppelin/proxy/utils/Initializable.sol
...
////// src/openzeppelin/utils/introspection/IERC165.sol
...
////// src/openzeppelin/token/ERC1155/IERC1155.sol
...
////// src/openzeppelin/token/ERC20/IERC20Upgradeable.sol
...
////// src/openzeppelin/token/ERC20/extensions/IERC20MetadataUpgradeable.sol
...
////// src/openzeppelin/utils/ContextUpgradeable.sol
...
////// src/openzeppelin/token/ERC20/ERC20Upgradeable.sol
...
////// src/openzeppelin/token/ERC20/IERC20.sol
...
////// src/openzeppelin/token/ERC20/utils/SafeERC20.sol
...
contract OptionToken is Initializable, ERC20Upgradeable {
     ...
     */
    event Mint(address indexed impl, uint256 amt, bytes mintData);
     ...
     */
    event Wrap(address indexed impl, uint256 amt, bytes wrapData);
     ...
     */
    event Redeem(address indexed impl, uint256 amt, bytes redeemData);
    ...
    function initialize(
        ...
        require(msg.sender == optionRegistry);
        ...
        for (uint256 i = 0; i < optionData.impls.length; i++) {
            ...
            require(protocol.create(optionData));
     ...
     */
    function mint(address impl, uint256 amt, bytes memory mintData) external {
        ...
        require(newSubOptionBal >= subOptionBal + amt, "OptionToken::failed-to-receive-options");

        // Mint Polynomial option tokens accordingly
        _mint(msg.sender, amt);

        emit Mint(impl, amt, mintData);
    }

    function wrap(address impl, uint256 amt, bytes memory tokenData) external {
        require(implementations[impl], "OptionToken::invalid-impl");
        require(block.timestamp < data.expiry, "OptionToken::expired");
     ...
     */
    function redeem(address impl, uint256 amt, bytes memory redeemData) external {
        require(implementations[impl], "OptionToken::invalid-impl");
        require(balanceOf(msg.sender) >= amt, "OptionToken::insufficient-options");
        require(block.timestamp < data.expiry, "OptionToken::expired");
        ...
        uint256 newSubOptionBal = protocol.balanceOf(data, address(this));
        require(subOptionBal >= newSubOptionBal + amt, "OptionToken::failed-to-burn-options");

        // Burn Polynomial option tokens accordingly
        _burn(msg.sender, amt);

        emit Redeem(impl, amt, redeemData);
    }
     ...
     */
    function settleOne(address impl) external returns (bool) {
        require(implementations[impl], "OptionToken::invalid-impl");
        // Expiry + 6 Hours
        require(block.timestamp >= data.expiry + 21600, "OptionToken::not-expired");
