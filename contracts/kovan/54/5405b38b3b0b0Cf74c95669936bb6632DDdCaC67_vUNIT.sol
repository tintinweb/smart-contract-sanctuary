...
contract vUNIT is ERC20Permit, IOHM, Ownable, AccessControl, OlympusAccessControlled {
	...
	function mint (address account, uint256 amount) public override {
		require(hasRole(MINTER_ROLE, msg.sender) || authority.vault() == msg.sender, "vUNIT: caller is not a minter");
