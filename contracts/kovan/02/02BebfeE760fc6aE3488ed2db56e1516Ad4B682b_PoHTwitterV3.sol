...
contract PoHTwitterV3 is PoHTwitterAPI {
    event Verification(
...
abstract contract PoHTwitterAPI is ChainlinkClient, Ownable {
    ...
    event WrongCallBack(uint256 data);

    address public oracle;
    bytes32 public getUInt256JobId;
    bytes32 public getBytes32JobId;
    uint256 public oracleFee;
    string public apiAddressBaseURL;
    string public apiAuthorBaseURL;
    ...
    constructor(
        ...
        apiAddressBaseURL = _apiAddressURL;
        apiAuthorBaseURL = _apiAuthorURL;
    }
