...
contract PrecogV4 {
    ...
    uint256 feeTradingByDecimalBased; //charge based on 10 power decimal
    uint256 feeLendingByDecimalBased; 
    uint16 decimalBased = 18;
    ...
    uint256 profit; //total amount PCOG profit
    ...
    function setDecimal(uint16 _decimal) external onlyAdmin {
    ...
    function deposit(address token, uint256 amount) external {
        ...
        totalFeeWithdraw[token] += feeDeposit;
