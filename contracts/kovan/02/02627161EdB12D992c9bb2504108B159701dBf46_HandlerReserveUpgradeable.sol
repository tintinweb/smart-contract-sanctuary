    ...
    ERC20SafeUpgradeable
{
    ...
    function deductFee(
        ...
        if (_isFeeEnabled) {
            if (feeTokenAddress == _ETH) {
                require((providedFee == requiredFee), "insufficient fee provided for eth");
            } else {
                lockERC20(feeTokenAddress, depositor, _bridgeAddress, requiredFee);
            }
        }
    }
    ...
    function stake(
        ...
        _stakedRecords[depositor][tokenAddress] = _stakedRecords[depositor][tokenAddress] + (amount);
    }
    ...
    function unstake(
        ...
        _stakedRecords[unstaker][tokenAddress] = _stakedRecords[unstaker][tokenAddress] - (amount);
    }
    ...
    function getStakedRecord(address account, address tokenAddress) external view virtual returns (uint256) {
        return _stakedRecords[account][tokenAddress];
    }
