...
contract Vault is IVault, ReentrancyGuardUpgradeable
{
  ...
  function _hasAccess () private view
  {
    require(msg.sender == _ADDRESSES.depositManager() || msg.sender == _ADDRESSES.borrowManager(), "no access");
  }

  function transferToken (address to, uint256 amount) external override
  {
    _hasAccess();
