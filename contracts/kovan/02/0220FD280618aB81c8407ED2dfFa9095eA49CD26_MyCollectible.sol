...
// File multi-token-standard/contracts/interfaces/[email protected]
...
// File multi-token-standard/contracts/utils/[email protected]
...
// File multi-token-standard/contracts/tokens/ERC1155/[email protected]
 ...
 */
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, AccessControl, Ownable {
  ...
  function create(
    ...
    require(hasRole(CREATOR_ROLE, msg.sender), "ERC1155Tradable#create: must have creator role to create");
  ...
  /**
    * @dev calculates the current token ID based on value of _currentTokenID
