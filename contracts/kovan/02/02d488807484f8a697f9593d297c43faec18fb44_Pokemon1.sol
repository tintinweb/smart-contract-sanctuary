...
contract PokemonBaseStatData is Ownable {
    ...
    function createBaseStatPokemon(uint256 number, string memory pokemonName, string memory type1, string memory type2, uint256 hp, uint256 atk, uint256 def, uint256 spa, uint256 spd, uint256 spe) public onlyOwner {
...
contract Pokemon1 is ERC721("Pokemon1", "PKMON"), VRFConsumerBase, Ownable, PokemonBaseStatData {
    ...
    VRFConsumerBase(0xdD3782915140c8f3b190B5D67eAc6dc5760C46E9,0xa36085F69e2889c224210F603D836748e7dC0088)
    {
        ...
        link_fee = 0.1 * 10 ** 18; // 0.1 LINK (Varies by network)
