...
contract ERC721Xea12 is ERC721Base {

    event CreateERC721Xea12(address owner, string name, string symbol);

    function __ERC721Xea12_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        _setBaseURI(baseURI);
        ...
        emit CreateERC721Xea12(_msgSender(), _name, _symbol);
    }
