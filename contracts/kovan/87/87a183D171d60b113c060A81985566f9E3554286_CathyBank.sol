...
contract CathyBank is Ownable {
    ...
    mapping(address => uint256) public PHXBalance;

    uint256 public PHXReserves = 0;

    // Settings
    uint8 public minCollateralPercent = 150;
    uint8 public interestPercent = 7;
    uint256 public ETHPHXConversionRate = 10000000;
    //================
    ...
    function borrowPHX(uint256 _PHXAmount) payable public {
        ...
        require((msg.value * ETHPHXConversionRate / 100) / _PHXAmount >= minCollateralPercent);
