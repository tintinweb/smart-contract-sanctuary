...
contract RewardCenter is Ownable {
    ...
    bytes32 public currentMerkelRoot;
    ...
    function settlePositionReward(
        ...
        currentMerkelRoot = merkelRoot;

        emit SettlePositionReward(
            msg.sender,
            epochRound,
            rewardAmount,
            merkelRoot
    ...
    function claimPositionReward(
        ...
        // require(MerkleProof.verify(proof,currentMerkelRoot,sha256(leafData)) == true ,"CHFRY: MerkleProof Fail");
