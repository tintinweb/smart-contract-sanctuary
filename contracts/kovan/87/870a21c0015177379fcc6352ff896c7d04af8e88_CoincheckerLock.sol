...
contract CoincheckerLock is Ownable {
        ...
        public
    {
        ...
        uint256 j;
        uint256 arrLength = depositsByWithdrawalAddress[msg.sender].length;
        for (j=0; j<arrLength; j++) {
            if (depositsByWithdrawalAddress[msg.sender][j] == _id) {
                depositsByWithdrawalAddress[msg.sender][j] = depositsByWithdrawalAddress[msg.sender][arrLength - 1];
