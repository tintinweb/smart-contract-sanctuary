/**
    ...
    Website: https://rxx.com
    Twitter: https://twitter.com/xxxx
    Gitbook: https://gitbook.com/xxxx
	...
	CryptoTankz is a game-reward token, also with auto-stacking mode.
	You just have to hodl to receive automatic airdrops. That's all.
	(0.2% tokens from each transition will be taken as fee and
	spread as airdrop to all hodlers).

	10 000 000 as Total Supply
	5 000 000 for liquidity pool
	5 000 000 for game rewards. Locked on another special SmartContract (rewards distributor)
	No mint function - TotalSupply will never change.
...
contract x8 is Context, IERC20, Ownable {
    ...
    // Token detalis.
    string private _name = 'x8';
    string private _symbol = 'x8';
