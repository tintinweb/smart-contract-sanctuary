...
contract CdaiAdapter is AdapterBase {
    ...
    function getOneCTokenInUnderlyingUnderlyingCore()
        internal
        returns (uint256)
    {
        ...
        uint256 scale = 18 + underlyingDecimals - cTokenDecimals;
        uint256 exchangeRateMantissa = _cdai.exchangeRateCurrent();

        return exchangeRateMantissa.div(10**scale);
    }
