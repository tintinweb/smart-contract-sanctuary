...
contract ParentNFT is ERC721 {
    ...
    mapping(uint256 => ChildNFT[]) public tokenMapping; //pTokenaddress -> nfts
    mapping(uint256 => uint256) public childTokenCount; //pTokenaddress -> totalnum child tokens

    mapping(uint256 => uint8) public tokenStatusMap; //need to case enum as uint8() in the mapping
    ...
    function addMyToken(
        ...
        childTokenCount[parentTokenId] = childTokenCount[parentTokenId] + 1;
        return true;
    }
    ...
    function finalizeAndCreateFamilyPhoto(uint256 parentTokenId) public {
        ...
        //TODO do EA to call back and set URI
    }
