...
/**
 __   __  __   __  _______  __   __  _______  ___     ___   __    _  __   __ 
|  |_|  ||  | |  ||       ||  | |  ||  _    ||   |   |   | |  |  | ||  | |  |
|       ||  | |  ||  _____||  | |  || |_|   ||   |   |   | |   |_| ||  | |  |
|       ||  |_|  || |_____ |  |_|  ||       ||   |   |   | |       ||  |_|  |
|       ||       ||_____  ||       ||  _   | |   |   |   | |  _    ||       |
| ||_|| ||       | _____| ||       || |_|   ||   |   |   | | | |   ||       |
|_|   |_||_______||_______||_______||_______||___|   |___| |_|  |__||_______|

Fatty, salty, and super rich, Musubi Inu is a cozy bite wrapped up in a safe package!
...
7. 10% developer fee, split amongs team

Telegram: t.me/MusubInu
Twitter: https://twitter.com/MusubInuToken
*/
...
contract MUSUBINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "MusubInu";
    string private constant _symbol = 'MUSUBINU';
