...
/**
    Name = X14
    Symbol = X14
    Total Supply = 500_000_000_000_000
    Decimal = 9
    TOTAL 7% TRANSACTION FEE
    2% of each transaction to the liquidity pool
    2% of each transaction to the marketing wallet
    2% of each transaction to the charity wallet
    1% of each transaction to holders
*/
...
contract X14 is Context, IERC20, Ownable {
    ...
    string private _name     = "X14";
    string private _symbol   = "X14";
    uint8 private  _decimals = 9;
    
    uint256 public _taxFee       = 1; 
    uint256 public _liquidityFee = 6; 
    uint256 public _percentageOfLiquidityForMarketing = 40; 
    uint256 public _percentageOfLiquidityForCharity   = 40;
    ...
    constructor (address cOwner, address marketingWallet, address charityWallet) Ownable(cOwner) {
        // set marketing and charity wallet addresses and owner
        _marketingWallet = marketingWallet;
        _charityWallet = charityWallet;
        _rOwned[cOwner] = _rTotal;
        
        // uniswap
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // KOVAN TESTNET 
    ...
    /*
     * offers avenue for caller to put tAmount in circulation for reward pool by adding tAmount into feeTotal
     */
    ...
    /*
     * set tax fee percent i.e. the percentage going back to holders
     */
    ...
    /*
     * set liquidity fee percent i.e. the percentage being split between liquidity/marketing wallet/charity wallet 
     */
    ...
    /*
     * set percentage of liquidity fee for marketing wallet 
     */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        // take charity fee
        uint256 charityFee            = newBalance.mul(_percentageOfLiquidityForCharity).div(100);
        
        // add fees together to get total fees to sub
        uint256 txFees                = marketingFee.add(charityFee);
        ...
        if (charityFee > 0) {
            payable(_charityWallet).transfer(charityFee);
            emit CharityFeeSent(_charityWallet, charityFee);
        }
