...
contract UniswapTradeExample{
    ...
    function buyDai() payable returns(uint256){
        ...
        address daiAddress = 0xf4C83715Ca56145c5d700c3B2BFC5c0324050792;
        //Define Uniswap
        ...
        ERC20 daiToken = ERC20(0xff795577d9ac8bd7d90ee22b6c1703490b6512fd);
    ...
    function getDAIPrice() constant returns(uint256){
        OrFeedInterface orfeed= OrFeedInterface(0xF83be7e18C42477036E32C6A7660Ce10Ef5B37cc);
