...
contract REDeFiMBSToken is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    function initialize() initializer public {
        __ERC20_init("REDeFiMBSToken", "RED");
        __Pausable_init();
        __Ownable_init();
