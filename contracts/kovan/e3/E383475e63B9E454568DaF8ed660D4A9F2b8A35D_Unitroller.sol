...
contract PToken is PTokenInterface, Exponential, TokenErrorReporter {
    ...
    function borrowFresh(
        ...
        uint256 allowed = comptroller.borrowAllowed(address(this), msg.sender, borrower, borrowAmount, id, _loanType);
        if (allowed != 0) {
            //3, 14, 4
        ...
        accountBorrows[borrower_].principal = vars.accountBorrowsNew;
        accountBorrows[borrower_].interestIndex = borrowIndex;
        totalBorrows = vars.totalBorrowsNew;

        /* We emit a Borrow event */
        emit Borrow(borrower_, borrowAmount, vars.accountBorrowsNew, vars.totalBorrowsNew, _loanType);
    ...
    function repayBorrowFresh(
        ...
        uint256 allowed = comptroller.repayBorrowAllowed(address(this), msg.sender, borrower, repayAmount, id, loanType);
        if (allowed != 0) {
        ...
        emit RepayBorrow(payer, borrower_, vars.actualRepayAmount, vars.accountBorrowsNew, vars.totalBorrowsNew, loanType);
    ...
    */
    ...
    //测试专用，后期whiteList写死
    function setWhiteListInternal(address _trustList, bool _state) public returns (uint256) {
    ...
    function doCreditLoanRedeemInternal(
        ...
        /*
        // console.log("doCreditLoanRedeemInternal::caller:", msg.sender);
        // console.log("this:", address(this));
        // require(whiteList[msg.sender], "doCreditLoanRedeemInternal caller not in whitelist"); //TODO重要！！
