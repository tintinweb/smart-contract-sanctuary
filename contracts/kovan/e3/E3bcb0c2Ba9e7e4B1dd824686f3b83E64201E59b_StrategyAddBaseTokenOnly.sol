...
contract StrategyAddBaseTokenOnly is Ownable, ReentrancyGuard, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "UniswapV2StrategyAddBaseTokenOnly::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function execute(
    ...
    // 4(1-f) = 4*997*1000   = 3988000, where f = 0.003 and 10,000 is a way to avoid floating point
    ...
    require(
      ...
      "UniSwapV2StrategyAddBaseTokenOnly::execute:: insufficient LP tokens received"
    );
    require(
      lpToken.transfer(msg.sender, lpToken.balanceOf(address(this))),
      "UniSwapV2StrategyAddBaseTokenOnly::execute:: failed to transfer LP token to msg.sender"
    );
