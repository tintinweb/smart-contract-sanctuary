...
contract Astrada is ERC721, Ownable {
    ...
    uint256 public tokenPrice; // first launch should be 0.02
    ...
    constructor(string memory name, string memory symbol, uint256 maxSupply, uint256 mintInterval, uint256 saleStart) public
    ERC721(name, symbol){
        MAX_SUPPLY = maxSupply;
        MINT_INTERVAL = mintInterval;

        REVEAL_TIMESTAMP = saleStart; // TODO: convert time
    }
    ...
    // TODO: Lookup Licensing
    // TODO: Lookup Provenance
    ...
    function mintAstrada(uint256 numberOfTokens) public payable {
        ...
        //TODO: limit to one per person on whitelist
    ...
    //     // add the address to the list of whitelisted addresses
    //     whitelist[userAddress] = true;
    //     whitelistedAddresses[whitelistCounter] = userAddress;
    //     whitelistCounter++;
    // }
    ...
    // function getwWhitelistSize() public view returns (uint256) {
    ...
    // function setWhiteListStatus(bool status) public {
    //     WHITELIST_ACTIVE = status;
    // }
