...
import { BRLCToken } from "../core/nonupgradeable/BRLCToken.sol";

contract MockBRLCToken is BRLCToken {
    ...
    constructor(
        ...
        BRLCToken(name_, symbol_, decimals_)
    { }
...
abstract contract BRLCToken is Rescuable, PausableEx, Blacklistable, ERC20 {
    constructor(
        string memory name_,
        string memory symbol_,
        uint8 decimals_
