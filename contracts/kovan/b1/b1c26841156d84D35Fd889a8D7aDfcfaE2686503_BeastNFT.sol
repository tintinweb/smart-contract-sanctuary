    ...
    function mint(uint256 amount) external {
        ...
        for(uint i=0; i<amount; i++) {
            ...
            if (randNum==0&&randNum<5) {
                string[2] memory imgs = ["QmTyQ3Mab2711GWGMyvXqMVCQpK49WH1KQRzhUBJS96Q7W", "QmTyQ3Mab2711GWGMyvXqMVCQpK49WH1KQRzhUBJS96Q7W"];
                beast = Beast("FFF", 6, 20, imgs);
            } else if (randNum>=5&&randNum<100) {
                string[2] memory imgs = ["QmcNEMp12fU7tNyTt8oRBKeW7QjXR9gLKwJoXPYAav86XV", "QmcNEMp12fU7tNyTt8oRBKeW7QjXR9gLKwJoXPYAav86XV"];
                beast = Beast("EEE", 5, 5, imgs);
            } else if (randNum>=100&&randNum<800) {
                string[2] memory imgs = ["QmZwioRnSrxDUcDK1e4LNkvGi7WW9eJXnHrEwXavathiwe", "QmZwioRnSrxDUcDK1e4LNkvGi7WW9eJXnHrEwXavathiwe"];
                beast = Beast("DDD", 4, 4, imgs);
            } else if (randNum>=800&&randNum<2200) {
                string[2] memory imgs = ["Qmbdyp864SwZZ2X3yBWKX1YeSax4BRj8F3yvLM9PcgAXYw", "Qmbdyp864SwZZ2X3yBWKX1YeSax4BRj8F3yvLM9PcgAXYw"];
                beast = Beast("CCC", 3, 3, imgs);
            } else if (randNum>=2200&&randNum<5000) {
                string[2] memory imgs = ["QmPbsQEreJNFVRkNkgyzDNTgkQ6Xt6GrPQXjz83FYTyQMi", "QmPbsQEreJNFVRkNkgyzDNTgkQ6Xt6GrPQXjz83FYTyQMi"];
                beast = Beast("BBB", 2, 2, imgs);
            } else {
                string[2] memory imgs = ["QmRXAzXAA8oiuMxe9m8Tdp9oq4tsBXgDjkpNz3Tz5uuRj2", "QmRXAzXAA8oiuMxe9m8Tdp9oq4tsBXgDjkpNz3Tz5uuRj2"];
                beast = Beast("AAA", 1, 1, imgs);
            }
