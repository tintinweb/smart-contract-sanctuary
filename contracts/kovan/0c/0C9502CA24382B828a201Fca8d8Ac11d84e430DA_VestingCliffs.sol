...
contract VestingCliffs is Ownable, ReentrancyGuard {
    ...
    constructor(address newOwner, address tokenAddr, uint256 _startTime, uint256 _totalAmount) {
        ...
        cliffs.push(Cliff(10, 30 minutes));
        cliffs.push(Cliff(30, 120 minutes));
        cliffs.push(Cliff(30, 270 minutes));
        cliffs.push(Cliff(30, 450 minutes));
