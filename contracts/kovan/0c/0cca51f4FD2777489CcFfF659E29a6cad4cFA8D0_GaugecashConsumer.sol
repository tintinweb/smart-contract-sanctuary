...
/**
 * @title A consumer contract for GAUGECASH.
 * @author LinkPool
 * @notice Request the index coming from the Financial Market making of the Forex Market.
 */
contract GaugecashConsumer is ChainlinkClient {
    ...
    /**
     * @notice Requests the GAUGECASH index.
     * @param _specId the jobID.
     * @param _payment the LINK amount in Juels (i.e. 10^18 aka 1 LINK).
     */
    function requestIndex(bytes32 _specId, uint256 _payment) public {
    ...
    /**
     * @notice Stores the index value by its request ID.
     * @param _requestId The request ID for fulfillment.
     * @param _result the GAUGECASH index (GAU/USD).
     */
    function fulfillIndex(bytes32 _requestId, uint256 _result) public recordChainlinkFulfillment(_requestId) {
