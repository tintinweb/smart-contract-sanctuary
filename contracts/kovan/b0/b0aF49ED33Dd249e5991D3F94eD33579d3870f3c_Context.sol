...
contract FrogCoin is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _symbol = "$FROG TICKER";
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        uint256 feeAmount = amount.mul(liquidFee).div(100);
    ...
    function swapBack() internal swapping {
        ...
        uint256 halfLiquid = amountToSwap.mul(liquidFee.div(2)).div(reflectionFee+liquidFee);
        ...
        uint256 amountETHReflection = amountETH.mul(reflectionFee).div(100);
        uint256 amountETHLiquid = amountETH.sub(amountETHReflection);
