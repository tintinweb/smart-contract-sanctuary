...
contract Oracle is IOracle, Ownable
{
  ...
  function _getRate (address from, address to) private view returns (uint256)
  {
    if (from == to && to == _DAI)
    {
      return _DECIMALS;
