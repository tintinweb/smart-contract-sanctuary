...
contract BulletoSmartMatrix {
    ...
    function updateActiveReferrerSecondLevel(address userAddress, address referrerAddress, uint8 level) internal {
        if (
            users[referrerAddress].ActiveMatrix[level].secondLevelReferrals.length < 4
        ) {
    ...
    function updateActiveReferrerThirdLevel(address userAddress, address referrerAddress, uint8 level) internal {
        ...
        if(users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[0] == address(0)){  // Means its 7th place, we'll give data to 1st downline
            ...
            address reciver1stDownlineFirst = users[referrerAddress].ActiveMatrix[level].firstLevelReferrals[0]; // First downline here
        ...
        else if(users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[1] == address(0)) // To give investment to 8th and 9th place
        {
            users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[1] = userAddress;
            return sendETHDividends(referrerAddress, userAddress, level);
        }
        
        else if(users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[2] == address(0)) // To give investment to 8th and 9th place
        {
        ...
        else if(users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[4] == address(0)) // To give investment to 8th and 9th place
        {
            users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[4] = userAddress;
            return sendETHDividends(referrerAddress, userAddress, level);
        }
        
        else if(users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[5] == address(0)) // To give investment to 8th and 9th place
        {
            ...
            for(uint8  i = 0 ; i < 7 ; i++){
                ...
                if(!users[reciver3rdDownline].ActiveMatrix[level].blocked){
                    return setReflection(userAddress, reciver3rdDownline, level);
                }
        ...
        else if (users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[7] == address(0)){
    ...
    function setReflection(address userAddress, address referrerAddress, uint8 level) internal{
        ...
        while(true){   
            if(referrerAddress != address(0)){
                ...
                }else if(!users[referrerAddress].ActiveMatrix[level].blocked){
    ...
    function updateActiveReferrerThirdLevelReflection(address userAddress, address referrerAddress, uint8 level) internal{
        
        if(users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[1] == address(0)) // To give investment to 8th and 9th place
        {
            users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[1] = userAddress;
            return sendETHDividends(referrerAddress, userAddress, level);
        }else if(users[referrerAddress].ActiveMatrix[level].thirdLevelReferrals[2] == address(0)) // To give investment to 8th and 9th place
