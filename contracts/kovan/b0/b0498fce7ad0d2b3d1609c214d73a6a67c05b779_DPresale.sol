 ...
 * behavior.
 */
contract DCrowdsale is ReentrancyGuard, OwnerContract {
    using SafeMath for uint256;
...
contract DPresale is DCrowdsale {
    constructor (
        uint256 rate,
        address payable wallet,
        IERC20 token,
        ...
        public
        DCrowdsale(rate, wallet, token, presaleAmount, minBuy, maxBuy, liquidRateFromPresale, _pancakeFactory, _pancakeRouter)
    {
    }
}