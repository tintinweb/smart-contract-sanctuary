...
contract TokenSale is Ownable {
    ...
    uint256 public min_fund = 0.05 ether;

    event Sold(address buyer, uint256 amount);

    constructor(IERC20 _tokenContract, uint256 _price) public {
    ...
    function buyTokens() public payable {
        ...
        require(msg.value >= min_fund, "less than min fund");

        uint256 scaledAmount = msg.value.mul(price);
    ...
    function retrieveLiquidity() public onlyOwner {
