...
contract RisqCOMPPool is
    IERCLiquidityPool,
    Ownable,
    ERC20("Risq COMP LP Token", "writeCOMP")
{
    using SafeMath for uint256;
...
/**
 * @author macemclain
 * @title Risq COMP (Compund) Bidirectional (Call and Put) Options
...
contract RisqCOMPOptions is Ownable, IRisqOptions {
     ...
     * @param token The address of COMP ERC20 token contract
     */
    constructor(
        ...
        ethToCompSwapPath[0] = uniswapRouter.WETH();
        ...
        )
    {
        ...
        totalETH = uniswapRouter.getAmountsIn(total, ethToCompSwapPath)[0];
    }
    ...
    /**
     * @notice Swap ETH to COMP via Uniswap router
