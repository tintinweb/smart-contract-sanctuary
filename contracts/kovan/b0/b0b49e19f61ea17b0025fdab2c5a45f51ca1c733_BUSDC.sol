    ...
    GovernanceAndOwner
{
    ...
    ///@param _lockTimeStamp- Amount of duration for which certain functions are locked
    ...
    function initialize(
        ...
        _TimeLockMechanism_init(_lockTimeStamp);
        _GovernanceAndOwner_init(_whiteListAddresses);
    }
...
///@title GovernanceAndOwner contract is used to restrict access of functions to onlyGovernance and onlyOwner.
///@notice This contains suitable modifiers to restrict access of functions to onlyGovernance and onlyOwner.
contract GovernanceAndOwner is
    Initializable,
    ContextUpgradeable,
    OwnableUpgradeable
{
    ...
    function _GovernanceAndOwner_init(address[] memory _whiteListAddresses)
        internal
        initializer
    {
        __Context_init_unchained();
    ...
    modifier onlyGovernance {
        require(whiteListAddresses[_msgSender()], "Not a whitelist address");
        _;
    }

    modifier onlyGovernanceOrOwner {
        require(
            whiteListAddresses[_msgSender()] || owner() == _msgSender(),
    ...
    function addAddressInWhiteList(address addr) external onlyGovernance {
