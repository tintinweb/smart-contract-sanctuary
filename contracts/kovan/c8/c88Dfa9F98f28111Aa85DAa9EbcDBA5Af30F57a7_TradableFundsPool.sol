...
contract TradableFundsPool is Ownable {
    ...
    function depositFund(address _tokenAddress, uint256 _amount) public {
        ...
        uint256 percentageIncrease = amountWorth / (amountWorth + beforeWorth); //change from float to uint256
        updateInvestorsOwnership(percentageIncrease * 10**18, msg.sender);
    }
