...
contract ATEN is ERC721URIStorage, ERC721Enumerable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    string public prefix = "http://test.kyoko.finance/kyoko/";

    string public suffix = ".png";

    constructor() ERC721("kyokoTest", "KT") {}
