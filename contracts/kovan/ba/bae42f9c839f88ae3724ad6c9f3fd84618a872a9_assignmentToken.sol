...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require (msg.sender == minter,"Minter ownership not found Error 101");
        require (supply+amount <= MAXSUPPLY," MAXSUPPLY Limit is less than the value defined");
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require (msg.sender == minter,"Minter ownership not found Error 101");
        require (balances[minter] >= amount,"Balance Issue- Need more money from dad ");
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(balances[msg.sender] >= _value+1,"Low balance, Please check");
    ...
    function transferFrom(
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require(balances[_from] >= _value+1, "Low balance, Please check");
        require(allowances[_from][msg.sender] >= _value, "allowances is low");
