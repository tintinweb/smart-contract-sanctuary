...
contract GoatCoin is Context, IERC20, Ownable {
    ...
    constructor() public {
        _charityWalletAddress = 0x5EDC0446911Aefdf0865E36223E302eF0784B200;
        _marketingWalletAddress = 0x91D3FD004ED0d8ae8dB725B09bA2a1140d092475;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 half = contractTokenBalance.div(_liqFeeRatio);
        uint256 otherHalf = contractTokenBalance.div(_liqFeeRatio);
        ...
        sendBNBToCharity(portionForFees.div(2));
        sendBNBToMarketing(portionForFees.div(2));
