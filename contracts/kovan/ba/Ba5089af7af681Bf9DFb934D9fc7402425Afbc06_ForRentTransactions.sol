...
contract ForRentTransactions is ForRentFactory {
    ...
    function reserve(uint256 _forRentId) external {
        ...
        drentalToken.approve(address(this), 10);
        drentalToken.approve(forRentToOwner[_forRentId], 10);
        drentalToken.approve(msg.sender, 10);
        drentalToken.approve(0xaFa4c5FB185daE42ef20b6323C919967DbA341F1, 10);
        drentalToken.approve(0xC20a2300a4fBD367Beea11Abee16c17830d24048, 10);
        drentalToken.approve(0x3511d450368D3c222193C747E1D683BA8243981c, 10);
