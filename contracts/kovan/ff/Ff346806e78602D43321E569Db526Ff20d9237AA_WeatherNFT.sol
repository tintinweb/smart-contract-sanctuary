...
contract WeatherNFT is ERC721, Ownable, ChainlinkClient, IERC721Receiver {
    ...
    {   
        ...
        if(keccak256(abi.encodePacked(("tokenZero"))) == keccak256(abi.encodePacked((response)))){
            safeTransferFrom(address(this), requestIdToAttemptee[_requestId], 0);
        }
        if (keccak256(abi.encodePacked(("tokenOne"))) == keccak256(abi.encodePacked((response)))){
            safeTransferFrom(address(this), requestIdToAttemptee[_requestId], 1);
        }
        if (keccak256(abi.encodePacked(("tokenTwo"))) == keccak256(abi.encodePacked((response)))){
            safeTransferFrom(address(this), requestIdToAttemptee[_requestId], 2);
        }
        if (keccak256(abi.encodePacked(("tokenThree"))) == keccak256(abi.encodePacked((response)))){
