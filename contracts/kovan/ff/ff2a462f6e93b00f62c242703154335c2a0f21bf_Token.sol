...
/*
    FINAL3
    + distrubuteFees prvni v transfer, recipient == uniswapV2pair
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    address public _marketingWallet = 0x3c1af3AccB3b1986c3989CffaAC9cE7Ba988e5AB;
    address public  _treasuryWallet = 0x2077Da167A8f6CBa4c43812520D65dF97a2F15D1;
    address public _lpWallet = 0x6AA518E92f215A2A557dAe720E6Ae95e0A7b6d9E;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if( ( balanceOf(address(this)) > totalSupply()/1000 ) && distributeFeesEnabled && recipient == uniswapV2Pair ){
            _distributeFees();
        }
    ...
    function distrubuteFees() external onlyOwner{
        _distributeFees();
