...
contract assignmentToken {
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(balances[msg.sender] >= _value + flat_fee); //sender should have enough on the balance value and fee to send
        balances[_to] +=_value;
    ...
    function transferFrom(
        ...
        // NOTE: transfer value needs to be sufficient to cover fee 
        require(allowances[_from][msg.sender] >= _value + flat_fee); // for transfer need to have enough allowance to cover
        //value send and fee
        balances[_from] -= _value + flat_fee;
        balances[_to] += _value; 
        balances[minter] += flat_fee;
        allowances[_from][msg.sender] -= _value + flat_fee;
