...
contract Stablecoin is ERC20, ERC20Detailed, ReentrancyGuard {
    ...
    function getEthPriceSource() public view returns (uint256){
        ...
        return uint256(200000);
    }

    function calculateCollateralProperties(uint256 collateral, uint256 debt) public view returns (uint256, uint256) {
    ...
    function isValidCollateral(uint256 collateral, uint256 debt) public view returns (bool) {
