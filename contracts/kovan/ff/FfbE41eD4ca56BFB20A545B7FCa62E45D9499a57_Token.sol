...
contract Token {
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        // Ensure sending is to valid address! 0x0 address can be used but
    ...
    // @param _value amount value of token to sending
    ...
    // @param _from, address sending to and the amount to sending
    // @param _to receiver of token
    // @param _value amount value of token to send
    // @dev internal helper transfer function with required safety checks
