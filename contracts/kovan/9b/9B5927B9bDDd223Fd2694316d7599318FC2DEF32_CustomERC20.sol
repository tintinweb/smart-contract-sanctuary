...
contract CustomERC20 is ERC20, Ownable {
    ...
    constructor(
        ...
        whitelisted[address(swapHandler)] = Whitelisted(
            true, // max transfer
            true, // max balance
            true  // Tax
        );
    ...
    */
    ...
    function _afterTokenTransfer(
        ...
        if (isLpPair[to_] && !whitelisted[from_].maxSell) {
...
contract SwapHandler is Ownable {
    ...
    uint256 public totalHoldersBNB;
    ...
    function swapToNativeWrappedToken(
        ...
        if (holderAmount_ > 0) {
            ...
            totalHoldersBNB += address(erc20.hodlRewardDistributor()).balance - balanceBefore;
        }
    }
