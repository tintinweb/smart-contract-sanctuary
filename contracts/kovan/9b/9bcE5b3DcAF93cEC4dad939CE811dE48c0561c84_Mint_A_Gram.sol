...
import "SafeMath.sol";   
import "Counters.sol";
import "Ownable.sol"; // for testings conveniece
    ...
    ReentrancyGuard
{
    ...
    function mintImage(string memory tokenURI)
        ...
        returns (uint256)
    {
        // require(/*Mintagram Network Fee, say 12 cents*/);
    ...
    // function minterEntry() public payable {
    //   require(msg.value == x_mintCount == 3);
    //   require(x_lotteryState == lotteryState.OPEN, "Lottery is not open");
    //   x_usersEntered.push(payable(msg.sender));
    //   emit enteredDraw(msg.sender);
    // }
