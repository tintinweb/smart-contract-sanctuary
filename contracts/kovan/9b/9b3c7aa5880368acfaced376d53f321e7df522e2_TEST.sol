...
/* contacts let = "name KNIX" id =1000000000000000 
getAmountOut(knix)
...
// File: contracts\knix.sol

contract TEST is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	...
	uint256 private constant _totalTokens = 10000000000 * 10**_decimals;	//10 billion total supply
	...
	// BUYBACK
	address payable private constant _buybackAddress = payable(0x15ccfd328ed015179A33BCfB03Bf6D6E857A6aAD); // A percentage of the BNB pool will go to the charity address
	...
	// TEAM
	address payable private constant _teamAddress = payable(0xBcd2780c00Dfd795DeA878c75c726D7F295D8302);
	...
	constructor (address routerAddress) {
		...
		uint256 _tokenForLiquidity = _totalTokens * 18 / 100;
		...
		uint256 _tokenForBurn = _totalTokens * 80 / 100;
