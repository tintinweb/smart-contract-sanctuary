...
library Utils {
    ...
    function calculateBNBReward(uint256 _tTotal,uint256 currentBalance,uint256 currentBNBPool,uint256 winningDoubleRewardPercentage,
													uint256 totalSupply,address ofAddress) public view returns (uint256) {
    ...
    function swapETHForTokens(address routerAddress,address recipient,uint256 ethAmount) public {
        IPancakeRouter02 pancakeRouter = IPancakeRouter02(routerAddress);
    ...
    function addLiquidity(address routerAddress,address owner,uint256 tokenAmount,uint256 ethAmount) public {
        IPancakeRouter02 pancakeRouter = IPancakeRouter02(routerAddress);
...
contract GhostFace is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Sports NFT";
    ...
    constructor (address payable routerAddress) public {
        _owner = 0xA422784270925A604BeEa5bA7420D859CD76B73D;
        
        _rOwned[0x23209755719086A224036C32489a81f95f85655F] = _rTotal;
		...
		_isExcludedFromFee[0xf5969D9Ecf9e1Ea339a19cdD9A80d56797b86E73] = true;
		_isExcludedFromFee[0x23209755719086A224036C32489a81f95f85655F] = true;
		_isExcludedFromFee[0xF0A53d93A16015F98ED835AE9Cc2CcBd7B94bF42] = true;
    ...
    uint256 public _liquidityFee = 9; // 4% will be added pool, 4% will be converted to BNB
    ...
    function calculateBNBReward(address ofAddress) public view returns (uint256) {
        ...
        return Utils.calculateBNBReward(_tTotal,balanceOf(address(ofAddress)),
						address(this).balance, winningDoubleRewardPercentage,totalSupply,ofAddress);
    }
    ...
    function topUpClaimCycleAfterTransfer(address recipient, uint256 amount) private {
        uint256 currentRecipientBalance = balanceOf(recipient); // 接收方的余额
        ...
        nextAvailableClaimDate[recipient] = nextAvailableClaimDate[recipient] + Utils.calculateTopUpClaim(
					currentRecipientBalance,basedRewardCycleBlock,threshHoldTopUpRate,amount);
    }

    function ensureMaxTxAmount(address from,address to,uint256 amount,uint256 value) private {
	...
	function swapAndLiquify(address from, address to) private {
        ...
        if (!inSwapAndLiquify && shouldSell && from != pancakePair && swapAndLiquifyEnabled &&
