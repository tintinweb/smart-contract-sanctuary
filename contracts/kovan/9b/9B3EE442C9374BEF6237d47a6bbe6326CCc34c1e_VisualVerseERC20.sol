...
contract VisualVerseERC20 is ERC20, Ownable {
    ...
    uint256 public processingGasLimit;
    ...
    constructor(
        ...
        _mint(marketing_, 100000000 * BASE);
    }
    ...
    */
    ...
    function setTreasuryWallet(
        ...
        require(
            newTreasuryWallet_ != marketingWallet,
        ...
        marketingWallet = newTreasuryWallet_;
    }
    ...
    */
    function excludeFromHodlRewards(
        ...
        if(teamReserved + hodlReserved + marketingReserved > 0)
            processReserves();
    ...
    function _customTransfer(
        ...
        if (whitlisted[from_].tax || whitlisted[to_].tax) {
            ...
            if (reflectionEnabled) {
                ...
                uint256 prevTotal = teamReserved + hodlReserved + marketingReserved;
                teamReserved += amount_.mul(currentAppliedTax.team).div(100);
                ...
                uint256 totalTax = teamReserved + hodlReserved + marketingReserved;
...
contract SwapHandler is Ownable {
    ...
    constructor (
        ...
        erc20 = IVisualVerseERC20(msg.sender);
    }
    ...
    function swapToNativeWrappedToken(
        ...
        if (teamAmount_ > 0){
            //erc20.teamWallet()
            totalTeamInERC20 += teamAmount_;
            balanceBefore = erc20.teamWallet().balance;
            _swap(teamAmount_, erc20.teamWallet());
            totalTeamInNative += erc20.teamWallet().balance-balanceBefore;
        }

        if (holderAmount_ > 0){
            totalToHoldersInERC20 += holderAmount_;
