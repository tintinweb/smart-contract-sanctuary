...
contract DexCallerV3 {
    ...
    function flashSell(address buyToken, address sellToken, uint sellAmount, uint minBuyAmount, uint24 fee) external returns (uint actualSellAmount, uint buyAmount){
