...
contract Token is ERC20Capped, IToken {
    ...
    constructor(
        ...
        require(teamAccount_ != address(0), "Token: zero team account");
        require(teamAmount > 0, "Token: zero team amount");
    ...
    modifier onlyBy(address account) {
        require(msg.sender == account, "Token: sender unauthorized");
        _;
    }
    ...
    {
        require(account != address(0), "Token: zero governance account");
