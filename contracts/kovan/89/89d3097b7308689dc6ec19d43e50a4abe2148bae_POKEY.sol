...
contract POKEY is ERC20, ERC20Burnable, Ownable, ERC20Pausable {
    constructor(
        string memory name,
        ...
        _setTotalSupply(initialSupply); // 10 trillion 

        // sale to public
        uint256 icoTokens = 4500000000000; // 5100000/1000000 =  four trillion five hundred billion
        _initialTransfer(
            0xA9065B57fEC5B2A8F65e4522c04cb0E102134652,
            (icoTokens * decimalFactor)
        );
        // Friends,family and facilators
        uint256 foundCommTokens = 500000000000; // five hundred billion
        _initialTransfer(
            0x1568b6c0CF7b0CE96A39a9105cf41Ba0939a5038,
            (foundCommTokens * decimalFactor)
        );
        // Retain by developer
        uint256 reserveExTokens = 5000000000000; // five trillion
        _initialTransfer(
