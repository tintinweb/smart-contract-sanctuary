...
contract LiquidityVault is Initializable, ERC20Upgradeable {
    ...
    constructor(IOptionRegistry optionRegistry_, ILiquidityManager liquidityManager_) {
        ...
        require(address(liquidityManager_) != address(0x0));
    ...
    // Access control to Owner
    modifier onlyOwner() {
        require(liquidityManager.owner() == msg.sender, "LiquidityVault::caller-is-not-owner");
        _;
    }

    // Access control to rebalancers
    modifier onlyRebalancer() {
        require(liquidityManager.rebalancers(msg.sender), "LiquidityVault::caller-is-not-owner");
        _;
    }
    ...
    function deposit(uint256 mintAmt) external {
    ...
    function withdraw(uint256 burnAmt) external {
