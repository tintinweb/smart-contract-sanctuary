...
contract ParallelNftFaucet {
    ...
    // requestNft
    function gibFren(bytes memory _ticket, uint32 _nftId, uint _ticketBlock) public {
        ...
        require(plsSir(trustedSigner, msg.sender, _nftId, 1, ticketPhrase, _ticketBlock, _ticket));
