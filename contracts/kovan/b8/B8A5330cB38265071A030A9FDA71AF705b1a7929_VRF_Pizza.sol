...
// Part: alphachainio/[email protected]/AggregatorV3Interface
...
contract VRF_Pizza is ChainlinkClient, Ownable{
    ...
    constructor(address _link, address _MaticToUSD, address _oracle, string memory jobid, uint256 usd_price)
    public  {
        if (_link == address(0)) {
    ...
    function fulfil_random_pizza(uint256 randomNumber) public returns (bytes32){
        ...
        request.addUint("random_number", randomNumber);
