...
contract PropertyRegistry is Ownable {
    ...
    function changeTokenValuation(address property, uint256 tokenValuation) public {
        require(PropertyRegistryHelpers(_dataProxy).hasSystemAdminRights(msg.sender) || msg.sender == _specialWallet || msg.sender == _exchange, "PropertyRegistry: You don't have permission");
