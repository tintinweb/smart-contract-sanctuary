...
contract Group {
    ...
    function init(uint enterFee, string memory name, string memory game, uint32 maxPlayers) external returns(uint32){
    ...
    function addParticipant(string calldata username, uint32 tournamentId) payable external {
    ...
    function removeParticipant(uint32 tournamentId) payable external {
        tournamentData storage currentTournament = tournaments[tournamentId];
    ...
    function closeRegistration(uint32 tournamentId) payable external {
        tournamentData storage currentTournament = tournaments[tournamentId];
    ...
    function declareWinner(uint32 participant, uint32 tournamentId) public {
        tournamentData storage currentTournament = tournaments[tournamentId];
