...
contract SashimiToken is ERC20("SashimiToken", "SASHIMI"), Ownable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "SASHIMI::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "SASHIMI::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "SASHIMI::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "SASHIMI::_writeCheckpoint: block number exceeds 32 bits"
        );
