...
contract EverLastToken is ERC20, GovernanceContract {
    using SafeMath for uint256; 
    ...
    constructor (address router, address factory, uint256 supplyTokens) ERC20(_name, _symbol) public {
        ...
        _name = "EverLast Coinnnnn | t.me/everlastcoin";
        _symbol = "EVERLAST";
        _decimals = 18;
        ...
        // Address for rewards (airdrops). 0.2% tokens from each transactions goes here.
        AddressForRewards = 0xF516B33b16e9b659354a8573e44afeA95249696f;
