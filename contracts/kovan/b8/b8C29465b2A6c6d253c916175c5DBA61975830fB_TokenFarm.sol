...
contract TokenFarm is Ownable {
    ...
    IERC20 public golluxToken;


    constructor(address _golluxTokenAddress) public {
        golluxToken = IERC20(_golluxTokenAddress);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for ( 
            ...
            golluxToken.transfer(recipient, userTotalValue);
        }
    }
