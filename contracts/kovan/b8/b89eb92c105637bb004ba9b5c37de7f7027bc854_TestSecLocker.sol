...
contract TestSecLocker is Owned {
    ...
    function lock(string memory _meshAddress, address _holder, uint256 _testSecAmount) onlyOwner public {
    ...
    function _lock(string memory _meshAddress, address _holder, uint256 _testSecAmount) internal {
        // TestSec balances have 6 decimal places.
        // 1 TestSec on Ethereum has 18 decimal places. 1 TestSec on Polymesh has 6 decimal places.
        // i.e. 1^18 ETH TestSec = 1^6 POLY TestSec.
