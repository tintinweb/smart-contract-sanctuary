...
contract APICall is ChainlinkClient {
    ...
    mapping(bytes32 => string) requestToClipName;
    ...
    constructor(address _LinkToken) public {
        ...
        jobId = "7c4b968028f74b2eabd7d428f03ba45c";
        fee = 0.1 * 10 ** 18; // (Varies by network and job)
        // ERC721("Gaming Clip", "GG"){
     ...
     */ 
    function fulfill(bytes32 _requestId, bytes32 _clipName) public recordChainlinkFulfillment(_requestId)
    {
        validateChainlinkCallback(_requestId);
        
        clipName = _clipName;

        uint256 c = clips.length;
