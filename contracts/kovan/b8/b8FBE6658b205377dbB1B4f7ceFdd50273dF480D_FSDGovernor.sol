...
contract FSDGovernor is GovernorSettings, GovernorCountingSimple, GovernorProposalThreshold, GovernorVotes, GovernorVotesQuorumFraction {
	...
	// delay = 1 block, period = 1 day (13.2 secs / block), threshold 1M
	GovernorSettings(1, 6545, 1000000 ether)
    {
    }
