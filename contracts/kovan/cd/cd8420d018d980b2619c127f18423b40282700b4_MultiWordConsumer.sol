...
contract ChainlinkClient {
    ...
    internal
  {
    ...
    ENSResolver __resolver = ENSResolver(ens.resolver(linkSubnode));
    setChainlinkToken(__resolver.addr(linkSubnode));
...
// File: docs.chain.link/samples/APIRequests/MultiWordConsumer.sol
...
contract MultiWordConsumer is ChainlinkClient {
  ...
  constructor(
    ...
    setChainlinkOracle(0x43B26Ac199FA7c8fef86e716FA70e29ed11977Bb);
  }
   ...
   * @param _eventName string cost of request in LINK (JUELS)
   */
  function setEventName(
    ...
    public
  {
    Chainlink.Request memory req = buildChainlinkRequest(_stringToBytes32(_jobId), address(this), this.fulfillMultipleParameters.selector);
    req.add("eventName", _eventName);
  ...
  {
    emit RequestMultipleFulfilled(_requestId, _cid);
    fulfilled = "Yes.";
    cid = _cid;
  } 
