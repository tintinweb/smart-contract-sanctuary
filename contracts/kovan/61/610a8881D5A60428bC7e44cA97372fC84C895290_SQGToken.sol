...
contract SQGToken is ERC20, Ownable {
    address public devAddress = 0xB9e5F470d0D3319AfF27ACE65B4aD6579DC1C158;
    ...
    constructor() ERC20("SquidGame", "SQG") {
        ...
        _mint(devAddress, 7000000000 ether);
    }
    ...
    function _transferWithTax(
        ...
        if (sender != _owner && recipient != _owner && sender != devAddress && recipient != devAddress){
            ...
            _transfer(sender, devAddress, taxMarketingAmount);
