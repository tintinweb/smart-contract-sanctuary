    ...
    AccessControlUpgradeable
{
    ...
    // Mapping user address to check if token is claimed.
    ...
    function setClaimableRole(address[] memory claimableAddress,bytes32 _role) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function claimNFT(bytes32 _role) external whenNotPaused nonReentrant {
        ...
        require(tierTotalClaimed[_role] < tierTotalSupply[_role].sub(1), "Max supply limit reached for tier");
