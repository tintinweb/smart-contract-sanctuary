...
contract LockedBoxV10 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function checkTimeUntilUnlock(address _address) public view returns (bool isLocked, uint256 untilUnlock ){
        uint256 _unlockTime = addressUnlockTime[_address];

        bool _isLocked = block.timestamp >= _unlockTime;
        ...
        return (_isLocked, timeTilUnlock);
    }
