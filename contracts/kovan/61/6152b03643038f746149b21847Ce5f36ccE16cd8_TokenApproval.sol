...
contract TokenApproval is ITokenApproval {
    ...
    function approvetodepositfiftydai() external {
        ...
        _underlyingAsset.safeTransferFrom(msg.sender, aaveDaiAdapterAddress, 50 ether);  
    }
...
//    }
    ...
    function redeemdai(uint256 maxAmount) external {
    ...
    function approveredeemfiftydai() external {
        require(
            _underlyingAsset.balanceOf(aaveDaiAdapterAddress) >= 50 ether,
            "insufficient underlying asset");
        _aaveDaiAdapter.redeemfiftydai(msg.sender);
        //require(isRedeemed, "redeem fifty dai failed");
    }
