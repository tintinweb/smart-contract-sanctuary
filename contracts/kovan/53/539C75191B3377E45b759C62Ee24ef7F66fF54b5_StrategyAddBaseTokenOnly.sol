...
contract StrategyAddBaseTokenOnly is
  Ownable,
  ReentrancyGuard,
  IStrategy
{
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "StrategyAddBaseTokenOnly::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function execute(
    ...
    require(
      ...
      "StrategyAddBaseTokenOnly::execute:: insufficient farmingToken amount received"
    );
