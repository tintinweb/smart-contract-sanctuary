  ...
  IPoolsParametersManagement
{
  ...
  function createNewPool(
    ...
    emit PoolCreated(borrower, maxBorrowableAmount, underlyingToken, distributionRate);
  }
...
interface IBorrowerManagement {
  event PoolCreated(bytes32 borrower, uint256 maxBorrowableAmount, address underlyingToken, uint256 maintenanceFeeRate);
