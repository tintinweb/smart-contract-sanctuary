...
contract Exercies {
   ...
   struct pendingToken {
    ...
    uint private  pendingAddCount = 0;
    uint private  pendingRemoveCount = 0;
    uint private  pendingDepositETHCount = 0;
    uint private  pendingWithdrawETHCount = 0;
    uint private  pendingDepositTokenCount = 0;
    uint private  pendingWithdrawTokenCount = 0;
    ...
    function doVote (uint candidateID, uint votetype ) public {
