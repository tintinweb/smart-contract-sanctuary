...
contract BsktLPPool is LPTokenWrapper {
    ...
    uint256 public constant duration = 30 days;     //-----| Pool Duration |-----       
    ...
    function stake(uint256 amount) public updateReward(msg.sender) checkStart {
        ...
        require(!minimumBsktStakingEntry[_msgSender()] && ( amount >= 5000 * 10 ** 18 ) , "Error:For Initial entry 5000 token must be required.");
        super.stake(amount);
    }
    ...
    function notifyRewardRate(uint256 _reward) public updateReward(address(0)) onlyOwner{
        ...
        require(permitNotifyReward() == true || firstNotify == false, "Error : You can only nofify once current duration completed.");
