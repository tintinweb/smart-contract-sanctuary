...
contract MyERC721Metadata is ERC165, ERC721BasicToken, Owned {
    ...
    string public baseURI = "https://lianstreets-bucket.oss-cn-beijing.aliyuncs.com?tokenId=";
...
contract CHENGLIANNFT is MyERC721Metadata,IERC721Enumerable {
    ...
    constructor() MyERC721Metadata("CHENG LIAN NFT", "CL", 2000000000000) public {
    }
