...
contract TokenApproval is ITokenApproval {
    ...
    function getbalanceofmsgsender() external view returns (uint256) {
        uint256 balancemsgsender = _underlyingAsset.balanceOf(msg.sender);
...
function addtoDepositfiftydai() external {
        ...
        // slither-disable-next-line reentrancy-events
        //uint256 receiveQuantity =
            _aaveDaiAdapter.depositUnderlyingToken(50 ether);
    ...
    function redeemfiftydai() external {
        bool isApproved = _aaveDaiAdapter.redeemUnderlyingAsset(msg.sender, 50 ether);
        require(isApproved, "redeem fifty dai failed");
    }
