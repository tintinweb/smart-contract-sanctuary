    ...
    PaymentSplitterUpgradeable
{
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(poops[tokenId].currentlyForSale == false, "ERC721: Cann't Approve during sale");
    ...
    function sellPoop (uint poopNumber, uint price) external {
        ...
        address from = getApproved(poopNumber);
        require(from == address(this),"sellPoop: Not approved");
