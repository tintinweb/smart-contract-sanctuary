...
contract OptionRegistry is Ownable {
    ...
    constructor(address optionLogic) {
        require(optionLogic != address(0x0));
    ...
    function createSeries(
        ...
        if (data.isCall) {
            require(data.collateral == data.underlying, "OptionRegistry::underlying-eq-collateral");
        }

        // Both underlying and collateral should be whitelisted
        require(assets[data.collateral].isActive, "OptionRegistry::collateral-not-valid");
        require(assets[data.underlying].isActive, "OptionRegistry::underlying-not-valid");
    ...
    function addImplementation(address impl) external onlyOwner {
        ...
        require(!implementations[impl], "fail");
    ...
    function removeAsset(address asset) external onlyOwner {
        require(assets[asset].isActive, "OptionRegistry::asset-not-approved");
