...
address constant kKatalystKyberProxy = 0x9AAb3f75489902f3a48495025729a0AF77d4b11e; // Mainnet, Katalyst Kyber Network Proxy Contract
address constant kKyberProxy = 

// KyberHintHandler (KyberMatchingEngine)
address constant kKyberHint = 0xa1C0Fa73c39CFBcC11ec9Eb1Afc665aba9996E2C;
...
contract PreachersCompFiLqdt is Structs {
		...
		require(Errors[0] == 0, "02 Comptroller.enter Markets for collateral Token failed.");
	 	...
	 	if (collateralToken != kETH && collateralToken != flashToken ) {
    	   ...
    	   require( executeKyberSwap(cCollateralToken, 
	            ...
	            9999999999999999999999999999999) > 0, "02 Back to Flash Token swap failed");
        }
    ...
    /// @dev Withdraw ETH
    function withdrawETH(uint256 amount, address payable sendTo) external onlyOwner {
    ...
    ****************************************************************************/
    ...
    function executeKyberSwap( ERC20 cSrcToken, uint256 srcQty, ERC20 cDestToken, 
        ...
        uint256 platformFeeBps = 0;    // unwanted complication
