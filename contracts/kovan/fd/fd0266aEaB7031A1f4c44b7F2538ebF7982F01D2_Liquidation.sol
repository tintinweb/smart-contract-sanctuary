...
contract Liquidation is ILiquidationInterface, Ownable, Tools, ErrorReporter, CarefulMath {
    ...
    function liquidateBorrowDrectlyFresh(
        ...
        */
        ...
        capital.doTransferOut(liquidator, assetUnderlying, toLiquidatorAmt, address(this));
        console.log("toLiquidatorAmt:", toLiquidatorAmt);

        address payable owner = address(uint160(owner()));
        capital.doTransferOut(owner, assetUnderlying, vars.benifits.sub(toLiquidatorAmt), address(this));
