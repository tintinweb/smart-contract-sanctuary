...
contract IndicesPayment is ReentrancyGuard,Initializable {
    ...
    function initialize(address _ASTRTokenAddress, address _poolConf,address _exchangeContract, address treasury) public initializer{
    ...
    */
    ...
    function setAstraAmount(uint256 _amount) external{
        astraAmount = _amount;
    }
