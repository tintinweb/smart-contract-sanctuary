...
contract jFRANC is ERC20("jFRANC", "jFRC") {
    ...
    function wrap(uint256 _amount) public {
        uint256 amountTokens = _amount.div(rate);
        jEUR.safeTransferFrom(msg.sender, address(this), _amount);
    ...
    function unwrap(uint256 _amount) public {
        ...
        uint256 amountTokens = _amount.mul(rate);
        _burn(msg.sender, _amount);
        jEUR.safeTransfer(msg.sender, amountTokens);
    }
