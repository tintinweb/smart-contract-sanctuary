...
contract Farm {
    ...
    constructor(IERC20 _erc20, uint256 _rewardPerBlock, uint256 _startBlock, address _manager) {
        erc20 = _erc20;
    ...
    function move(uint256 _pid, address _caller) external {
        ...
        erc20Transfer(_caller, pendingAmount);
