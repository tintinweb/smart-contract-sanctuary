...
contract TokenApproval is ITokenApproval {
    ...
    function depositfivedai() external {
        ...
        //_underlyingAsset.safeTransferFrom(msg.sender, aaveDaiAdapterAddress, 5 ether);
    ...
    function deposittocontract(uint256 amount) external {
        ...
        // slither-disable-next-line reentrancy-events
        //uint256 receiveQuantity =
            _underlyingAsset.safeTransfer(address(this), amount);
...
//    }
    ...
    function approveredeemfivedai() external {
        require(
            _underlyingAsset.balanceOf(aaveDaiAdapterAddress) >= 5 ether,
            "insufficient underlying asset");
