...
// File contracts/tokens/deflationalAutoLP/UniswapV2/extensions/FeeToAddr/SHIBASQUID_constructed.sol



contract SHIBASQUID is AutoBurnableFeeToAddrDeflAutoLPToken, Pausable {
    constructor(
        string memory tName, 
        string memory tSymbol, 
        uint256 totalAmount,
