...
contract StabilizeStrategyREETHArbV1 is Ownable {
    ...
    uint256 public startTradeThreshold = 10000; // At within 10% threshold, the strategy will trade
    ...
    // Testnet specific vars
    address constant SUSHISWAP_ROUTER_ADDRESS = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Address of Sushiswap
    address constant WETH_ADDRESS = address(0xd0A1E359811322d97991E03f863a0C30C2cF029C);
    address constant REETH_ADDRESS = address(0x8F7D268A85EbFC589D7082bB28a941f3aEf9D291);
    address constant SUSHISWAP_REETH_ETH_LP = address(0x8Ec43C199C85ca69e5d8fA7222dBD45f2E23f1Ba);
    ...
    function withdrawTokenReserves() public view returns (address, uint256) {
        // This function will return the address and amount of reeth, then weth
    ...
    function getFastGasPrice() internal pure returns (uint256) {
        return uint256(1000000000);
    }
