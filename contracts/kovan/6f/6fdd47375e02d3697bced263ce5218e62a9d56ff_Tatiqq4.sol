...
contract Tatiqq4 is Context, IERC20, Ownable {
    ...
    string private _name = 'tatiq4';
    string private _symbol = 'taqiq4';
    ...
    constructor (address rLibrary, address fLibrary) {
        ...
        _sOwned[_msgSender()] = tokenFromReflection(_rOwned[_msgSender()]);
