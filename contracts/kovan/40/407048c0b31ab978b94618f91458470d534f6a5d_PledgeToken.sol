...
// File: contracts2/PledgeToken2.sol
...
contract PledgeToken is Ownable {
    ...
    address public apple = 0x323A4Df3855b5F64fd11bAE71af1c4992eE23588;

    address public masterChef = 0x76bAAB64424E8c7c50A9CD56da25eb6ac9adf1C0;
    ...
    constructor(address _token, address _certificate, uint256 _pid, uint256 _allocPoint ) public 
    {
        token = _token;
    ...
    function setAllocPoint(uint256 _allocPoint) public onlyOwner {
        //require(_radio < 1000, "MasterChef: taxRadio too big");
        updatePool();
        poolInfo.allocPoint = _allocPoint;
    }
    ...
    function migrate(address _address) public onlyOwner{
        ...
        ICertificate(certificate).transferOwnership(_address);
