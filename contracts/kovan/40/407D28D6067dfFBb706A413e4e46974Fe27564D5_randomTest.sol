...
contract randomTest is Ownable, VRFConsumerBase
{
	uint256 public fee;
	...
	function requestRandom(uint256 tokenId) public returns (bytes32 requestId) {
	...
	function viewResult() public view returns (uint256 randomNumber) {
