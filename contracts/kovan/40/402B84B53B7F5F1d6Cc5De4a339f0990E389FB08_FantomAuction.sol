...
contract FantomAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address payable _platformFeeRecipient, IERC20 _RWT)
        public
        initializer
    {
        require(
        ...
        nonReentrant
    {
        ...
        if (payAmount > 0) {
            if (auction.payToken == address(0)) {
                ...
                RWT.safeTransferFrom(rewardsender, IERC721(_nftAddress).ownerOf(_tokenId), payAmount.mul(5).div(100));
                RWT.safeTransferFrom(rewardsender, winner, payAmount.mul(5).div(100));
            }
        }
