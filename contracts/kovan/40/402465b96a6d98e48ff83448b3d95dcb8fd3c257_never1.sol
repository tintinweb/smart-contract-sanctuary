...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function contracInitialised() public view returns (bool) {
        return _state;
    }
     ...
     * After first use it will lock.
     */
    function initTotalSupply (uint256 _initialSupply) public onlyOwner {
        require(initialSupplyDone == false);
...
contract never1 is ERC20 {
    ...
    constructor(address Router, address Factory) Ownable() ERC20(uniswapV2Router, uniswapV2Factory){}
