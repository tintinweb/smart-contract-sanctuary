...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #OG3  

    I make this #OG3 to hand over it to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #OG3 to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #OG3 10000000X? 
   ...
   it's the best part of the #OG3 idea, increasing the liquidity pool automatically, 
