...
/**
 * @title Pesa's PErc20USDCDelegator Contract
 * @notice PTokens which wrap an EIP-20 underlying and delegate to an implementation
 */
contract PErc20USDCDelegator is PTokenInterface, PErc20Interface, PDelegatorInterface {
    /**
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "PErc20USDCDelegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"PErc20USDCDelegator:fallback: cannot send value to fallback");
