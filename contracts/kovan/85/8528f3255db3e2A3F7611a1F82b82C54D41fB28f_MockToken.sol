...
contract MockToken is Ownable, IMockToken {
    ...
    constructor(string memory symbol1, string memory name1, uint8 decimals1, uint256 amount1) {
        _symbol = symbol1;
        _name = name1;
        _decimals = decimals1;
        // _maxSupply = 1 * 10 ** 14;
     ...
     * {IMockToken-balanceOf} and {IMockToken-transfer}.
     */
    ...
    /**
     * @dev See {IMockToken-totalSupply}.
     */
   ...
   */
    ...
    /**
     * @dev See {IMockToken-transferFrom}.
     *
     ...
     * problems described in {IMockToken-approve}.
     *
    ...
    function mint(address recipient, uint256 amount) public override isMinter {
