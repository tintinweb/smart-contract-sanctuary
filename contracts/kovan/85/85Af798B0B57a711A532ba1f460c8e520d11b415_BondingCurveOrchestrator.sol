...
contract ERC20BondingCurve is BondingCurve {
    ...
    constructor(
        ...
        BondingCurve(
            ...
            oracle,
            duration,
            uint256(0) // incentive fixed to 0, avoid stack too deep error.
        )
    {
        ...
        returns (uint256 amountOut)
    {
        ...
        TransferHelper.safeTransferFrom(address(erc20TokenAddress), msg.sender, address(this), amountIn);
        return _purchase(amountIn, to);
    }

    function getTotalPCVHeld() public view virtual override returns (uint256) {
        return erc20TokenAddress.balanceOf(address(this));
    }
        ...
        override
    {
        ...
        TransferHelper.safeTransfer(address(erc20TokenAddress), pcvDeposit, amount);
...
contract BondingCurveOrchestrator is IBondingCurveOrchestrator, Ownable {
    ...
    function init(
        ...
        override
        onlyOwner
        returns (address erc20BondingCurve)
    {
        ...
        erc20BondingCurve = address(
            new ERC20BondingCurve(
                core,
                allocations,
                ratios,
                uniswapOracle,
