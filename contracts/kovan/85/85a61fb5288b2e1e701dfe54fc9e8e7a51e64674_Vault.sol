...
contract Vault 
{
    ...
    function deposit() public payable {
        address RECEIPT_TOKEN_ADDRESS = address(0xEB9C104dD6a004843B03eCB875d8B6dd82024FFC);
    ...
    function rebalancePortfolio() public returns (bool success)
    {
        ...
        uint256 goalAssetValue = currentAssetValue + (uint256)(excessWei);
        ...
        int256 totalCheck = 0;
        for(uint i = 0; i < NUMBER_OF_ASSETS; i++) {
            amountToBuyOfEach[i] = (int256)(idealAssetDistribution[i] - currentAssetDistribution[i]);
