...
contract CHILLIFarm is Ownable {
    ...
    // Info of each user to get LP tokens returned
    mapping(uint256 => mapping(address => PsuedoUserInfo))
        public pseudoUserInfo;
