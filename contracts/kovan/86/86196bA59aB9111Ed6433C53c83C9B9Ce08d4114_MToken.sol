...
import {IMoveIncentivesController} from '../../interfaces/IMoveIncentivesController.sol';
  ...
  IMToken
{
  ...
  IMoveIncentivesController internal _incentivesController;
  ...
  function initialize(
    ...
    IMoveIncentivesController incentivesController,
   ...
   **/
  function _getIncentivesController() internal view override returns (IMoveIncentivesController) {
   ...
   **/
  function getIncentivesController() external view override returns (IMoveIncentivesController) {
...
import {IMoveIncentivesController} from './IMoveIncentivesController.sol';
...
interface IMToken is IERC20, IScaledBalanceToken, IInitializableMToken {
   ...
   * @dev Returns the address of the incentives controller contract
   **/
  function getIncentivesController() external view returns (IMoveIncentivesController);
}
...
interface IMoveIncentivesController {
...
abstract contract IncentivizedERC20 is Context, IERC20, IERC20Detailed {
   ...
   **/
  function _getIncentivesController() internal view virtual returns (IMoveIncentivesController);
