...
/**
 * @title DBRE | Stobox Technologies Inc.
...
/**
 * @title DBRE FOR FAT | Stobox Technologies Inc.
 * @author Stobox Technologies Inc.
 * @dev DBRE ERC20 Token | This contract is opt for digital securities management.
 */
...
contract DBREToken is IERC20, Roles {
    ...
    constructor() public Roles(msg.sender) {
        _name = "Digital Block Real Estate Callable Bonds";
        _symbol = "DBRE";
        _decimals = 0;
        _kDecimals = 18;
        _k = 10**_kDecimals;
        _defaultTransferLimit = 25000;
        _defaultTransactionCountLimit = 0;

        _mint(msg.sender, 6088235);
