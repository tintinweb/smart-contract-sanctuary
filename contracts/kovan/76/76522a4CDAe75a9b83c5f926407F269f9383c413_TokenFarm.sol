...
contract TokenFarm is Ownable {
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        // transferFrom: use it insted of 'transfer', if you don't owe ERC20
        IERC20(_token).transferFrom(msg.sender, address(this), _amount); // wrap the token with ERC20 and send to this contract
