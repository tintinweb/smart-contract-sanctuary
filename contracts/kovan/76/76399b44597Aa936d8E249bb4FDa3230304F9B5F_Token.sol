...
contract Token {
    ...
    // My Variables
    string public nameOfCon;
    string public symbolOfCon;
    uint256 public decimalsOfCon;
    uint256 public totalSupplyOfCon;
    ...
    constructor(string memory _name, string memory _symbol, uint _decimals, uint _totalSupply) {
        nameOfCon = _name;
        symbolOfCon = _symbol;
        decimalsOfCon = _decimals;
        totalSupplyOfCon = _totalSupply; 
        balanceOf[msg.sender] = totalSupplyOfCon;
    }
