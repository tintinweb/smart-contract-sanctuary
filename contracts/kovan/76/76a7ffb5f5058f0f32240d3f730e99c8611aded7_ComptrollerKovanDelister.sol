...
contract ComptrollerKovanDelister is ComptrollerV5Storage, ComptrollerErrorReporter, ExponentialNoError {
  function getCompAddress() public view returns (address) {
  ...
  function delist() public {
      ...
      CToken last = allMarkets[len - 1];
      CToken bad = allMarkets[len - 2];
      require(address(bad) == address(0xeC59D09130FC417661C289ebF70847922eA0e23f), "wrong-delist");
      allMarkets.pop();
      allMarkets.pop();
      allMarkets.push(last);
  }
}
