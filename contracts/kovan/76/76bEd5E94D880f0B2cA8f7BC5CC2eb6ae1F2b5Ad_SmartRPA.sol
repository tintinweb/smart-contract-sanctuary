...
contract SmartRPA is ERC721, Ownable, ChainlinkClient {
    ...
    mapping(address => address payable) requestToPayable;
    ...
    function terminateContract(bytes32 _requestId) public {
        selfdestruct(requestToPayable[requestToSender[_requestId]]);  
    }
    ...
    // // return the tokens of a given address
    // function getBuyersOffers(address _buyer) public view returns(uint[] memory) {
    //     return _tokensOfOwner(_buyer);
    // }
