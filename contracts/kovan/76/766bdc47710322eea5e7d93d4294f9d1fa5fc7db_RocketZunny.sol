...
contract RocketZunny is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 80 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'Zunny';
    string private _symbol = 'ZUNNY';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(swappingInProgress){
            ...
            uint256 tokensToLock = liquidityFee;
    ...
    */
    ...
    function getMinTokenBeforeSwap() public view returns(uint256) {
