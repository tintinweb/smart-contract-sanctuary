...
contract SalvationPad_IDO is Ownable {
    ...
    uint public  stakingStart = 1620274814; // staking starting time
    uint public  stakeEnds = 1620235214; // staking ending time
    uint public  userMaxStake = 5*1e18; // max stake 5 tokens

    uint public  softCapAmount = 1*1e18; // 500 bnb max
