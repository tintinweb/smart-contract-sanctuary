...
contract UiPoolDataProvider is IUiPoolDataProvider {
    ...
    )
  {
    ...
    baseCurrencyInfo.networkBaseTokenPriceDecimals = _networkBaseTokenPriceInUsdProxyAggregator.decimals();

    try oracle.BASE_CURRENCY_UNIT() returns (uint256 baseCurrencyUnit) {    
      baseCurrencyInfo.baseCurrencyUnit = baseCurrencyUnit;
    } catch (bytes memory /*lowLevelData*/) {  
      baseCurrencyInfo.baseCurrencyUnit = ETH_CURRENCY_UNIT;
    }
