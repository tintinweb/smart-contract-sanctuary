...
contract ChangeMinShareProposal is Proposal {

    function getName() public override returns (string memory) {

        return "Change Min Share Proposal";
    }

    function execute(ProtocolSettings settings) public override {
        
        settings.setMinShareForProposal(250, 1e5);
    }
}
...
contract GovToken is ManagedContract, ERC20 {
    ...
    function issue(
        ...
        external
    {
        require(msg.sender == getOwner(), "You're not allowed to deposit");
