...
// hevm: flattened sources of /nix/store/b748ii3m6qrlwq7qk8p0lfpl3f36awcf-geb-proxy-actions/dapp/geb-proxy-actions/src/GebProxyIncentivesActions.sol
pragma solidity =0.6.7 >=0.5.0 >=0.6.2 >=0.6.7 >=0.6.7 <0.7.0;
...
////// /nix/store/b748ii3m6qrlwq7qk8p0lfpl3f36awcf-geb-proxy-actions/dapp/geb-proxy-actions/src/uni/interfaces/IUniswapV2Factory.sol
/* pragma solidity >=0.5.0; */

interface IUniswapV2Factory_1 {
...
////// /nix/store/b748ii3m6qrlwq7qk8p0lfpl3f36awcf-geb-proxy-actions/dapp/geb-proxy-actions/src/uni/interfaces/IUniswapV2Pair.sol
/* pragma solidity ^0.6.7; */

interface IUniswapV2Pair_1 {
...
////// /nix/store/b748ii3m6qrlwq7qk8p0lfpl3f36awcf-geb-proxy-actions/dapp/geb-proxy-actions/src/uni/interfaces/IUniswapV2Router01.sol
/* pragma solidity >=0.6.2; */

interface IUniswapV2Router01_1 {
...
////// /nix/store/b748ii3m6qrlwq7qk8p0lfpl3f36awcf-geb-proxy-actions/dapp/geb-proxy-actions/src/uni/interfaces/IUniswapV2Router02.sol
/* pragma solidity >=0.6.2; */

/* import './IUniswapV2Router01.sol'; */

interface IUniswapV2Router02_1 is IUniswapV2Router01_1 {
...
////// /nix/store/b748ii3m6qrlwq7qk8p0lfpl3f36awcf-geb-proxy-actions/dapp/geb-proxy-actions/src/GebProxyIncentivesActions.sol
/// GebProxyActions.sol
...
contract GebProxyIncentivesActions is BasicActions {
    ...
    function _provideLiquidityUniswap(address coinJoin, address uniswapRouter, uint tokenWad, uint ethWad, address to, uint[2] memory minTokenAmounts) internal {
        CoinJoinLike_1(coinJoin).systemCoin().approve(uniswapRouter, tokenWad);
        IUniswapV2Router02_1(uniswapRouter).addLiquidityETH{value: ethWad}(
            address(CoinJoinLike_1(coinJoin).systemCoin()),
            tokenWad,
            minTokenAmounts[0],
            minTokenAmounts[1],
            to,
    ...
    function _stakeInMine(address incentives) internal {
        DSTokenLike_2 lpToken = DSTokenLike_2(GebIncentivesLike(incentives).stakingToken());
    ...
    function _removeLiquidityUniswap(address uniswapRouter, address systemCoin, uint value, address to, uint[2] memory minTokenAmounts) internal returns (uint amountA, uint amountB) {
        DSTokenLike_2(getWethPair(uniswapRouter, systemCoin)).approve(uniswapRouter, value);
        return IUniswapV2Router02_1(uniswapRouter).removeLiquidityETH(
            systemCoin,
            value,
            minTokenAmounts[0],
            minTokenAmounts[1],
    ...
    function openLockETHGenerateDebtProvideLiquidityUniswap(
        ...
        safe = openSAFE(manager, collateralType, address(this));
        DSTokenLike_2 systemCoin = DSTokenLike_2(CoinJoinLike_1(coinJoin).systemCoin());
    ...
    function stakeInMine(address incentives, uint wad) external {
        DSTokenLike_2(GebIncentivesLike(incentives).stakingToken()).transferFrom(msg.sender, address(this), wad);
        _stakeInMine(incentives);
    }
    ...
    function getRewards(address incentives) public {
        ...
        DSTokenLike_2 rewardToken = DSTokenLike_2(incentivesContract.rewardsToken());
    ...
    function exitMine(address incentives) external {
        GebIncentivesLike incentivesContract = GebIncentivesLike(incentives);
        DSTokenLike_2 rewardToken = DSTokenLike_2(incentivesContract.rewardsToken());
        DSTokenLike_2 lpToken = DSTokenLike_2(incentivesContract.stakingToken());
    ...
    function migrateCampaign(address _oldIncentives, address _newIncentives) external {
        ...
        DSTokenLike_2 rewardToken = DSTokenLike_2(incentives.rewardsToken());
        DSTokenLike_2 lpToken = DSTokenLike_2(incentives.stakingToken());
        incentives.exit();
    ...
    function removeLiquidityUniswap(address uniswapRouter, address systemCoin, uint value, uint[2] calldata minTokenAmounts) external returns (uint amountA, uint amountB) {
        DSTokenLike_2(getWethPair(uniswapRouter, systemCoin)).transferFrom(msg.sender, address(this), value);
    ...
    function withdrawAndRemoveLiquidity(address coinJoin, address incentives, uint value, address uniswapRouter, uint[2] calldata minTokenAmounts) external returns (uint amountA, uint amountB) {
        GebIncentivesLike incentivesContract = GebIncentivesLike(incentives);
        incentivesContract.withdraw(value);
        return _removeLiquidityUniswap(uniswapRouter, address(CoinJoinLike_1(coinJoin).systemCoin()), value, msg.sender, minTokenAmounts);
    }
    ...
    function exitAndRemoveLiquidity(address coinJoin, address incentives, address uniswapRouter, uint[2] calldata minTokenAmounts) external returns (uint amountA, uint amountB) {
        ...
        incentivesContract.exit();
        rewardToken.transfer(msg.sender, rewardToken.balanceOf(address(this)));
        return _removeLiquidityUniswap(uniswapRouter, address(CoinJoinLike_1(coinJoin).systemCoin()), lpToken.balanceOf(address(this)), msg.sender, minTokenAmounts);
    }
    ...
    function getWethPair(address uniswapRouter, address token) public view returns (address) {
        IUniswapV2Router02_1 router = IUniswapV2Router02_1(uniswapRouter);
        IUniswapV2Factory_1 factory = IUniswapV2Factory_1(router.factory());
