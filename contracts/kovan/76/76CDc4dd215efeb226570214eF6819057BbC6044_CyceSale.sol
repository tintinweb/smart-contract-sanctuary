...
contract CyceSale is Context, Ownable {
    ...
    function buyToken() external payable {
      ...
      totalSold += msg.value.div(getUSDValue());
      console.log("sold token amount", msg.value.div(getUSDValue()));
      payable(owner()).transfer(msg.value);
      IERC20(cyceToken).transfer(msg.sender, msg.value.div(getUSDValue()));
