 ...
 */
contract NFT is Context, Ownable, ERC165, INFT, IERC721Metadata {
     ...
     */
    constructor (string memory name_, string memory symbol_, address testERCAddress_) {
        _name = name_;
        _symbol = symbol_;
        _testERCAddress = testERCAddress_;
