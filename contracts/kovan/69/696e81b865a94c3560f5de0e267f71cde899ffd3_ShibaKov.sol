...
contract ShibaKov is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaKov";
    string private constant _symbol = "SHIBAKOV";
    ...
    uint256 private _dynamicFee = 3; //value used as "pool_fee", "tax_fee", "charity_fee", "burn_fee" respectfully using safemath in functions
