...
abstract contract OnePlanetConnected is StringUtils, Owned{
    ...
    uint8 public retireMessageSwitch;
   ...
   //OnePlanet Modifiers
    ...
    modifier OnePlanetCarbonOffsetMinGas {
     ...
     function offsetWith1PL(uint256 gasEstOffset) internal {
        ...
        // string memory retireMessage = retireMessageSwitch == 1 ? createRetireMessage(gasEstOffset): "";
    ...
    function offsetWithETH(uint256 gasEstOffset) internal {
        ...
        OnePlanetInstance.offsetDirectWithETH.value(CO2offsetETH)(""); //Retire 1Planet tokens based on CO2 emitted in ETH
        }
    ...
    // function createRetireMessage(uint256 gasEstOffset) internal view returns (string memory){
    ...
    // function setRetireMessageSwitch(uint8 retireMessageSwitchState) external onlyOwner {
    //     retireMessageSwitch = retireMessageSwitchState;
    // }
