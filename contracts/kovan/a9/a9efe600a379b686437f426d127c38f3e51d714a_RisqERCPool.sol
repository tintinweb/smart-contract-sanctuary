...
// File: contracts/Pool/RisqSDEFIPool.sol
...
contract RisqERCPool is
    IERCLiquidityPool,
    Ownable,
    ERC20("Risq sDEFI LP Token", "writeSDEFI")
{
    using SafeMath for uint256;
    ...
    /*
     * @nonce A provider supplies SDEFI to the pool and receives writeSDEFI tokens
    ...
    /*
     * @nonce Provider burns writeSDEFI and receives SDEFI from the pool
...
// File: contracts/Options/RisqSDEFIOptions.sol
 ...
 */
contract RisqSDEFIOptions is Ownable, IRisqOptions {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    /**
     * @param _priceProvider The address of ChainLink sDEFI/USD price feed contract
     ...
     * @param period Option period in seconds (1 days <= period <= 4 weeks)
     * @param strike Strike price of the option
     * @param currentPrice Current price of sDEFI
