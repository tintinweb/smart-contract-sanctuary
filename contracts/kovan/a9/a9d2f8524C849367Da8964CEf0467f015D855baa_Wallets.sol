...
contract Wallets is AccessControl, IWallets {
  ...
  bytes32 public constant DAO_CONTRACT = keccak256("DAO_CONTRACT_#$#");
  ...
  function depositWalletTT(address asset, uint256 amount) public override {
...
interface IWallets {
  function depositWalletTT(address asset, uint256 amount) external;
