    ...
    ReentrancyGuard
{
    ...
    function makeExchangeERC721(
        ...
        uint256[3] calldata tokenToBuy, // 0 - tokenAddress, 1 - id, 2 - amount
        uint256[3] calldata tokenToSell,
        ...
        require(
            address(uint160(tokenToBuy[0])) != address(0) && tokenToBuy[2] == 0,
            "Exchange: Wrong tokenToBuy"
        );
        require(
            address(uint160(tokenToSell[0])) != address(0) && tokenToSell[1] == 0,
        ...
        uint256 tokenToSeller = tokenToSell[2];
        if (address(uint160(tokenToSell[0])) == 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE) {
            ...
            for (uint256 i = 0; i < feeAddresses.length; i++) {
                tokenToSeller = tokenToSeller - feeAmounts[i];
                IERC20(address(uint160(tokenToSell[0]))).transferFrom(
                    SellerBuyer[1],
                    feeAddresses[i],
                    feeAmounts[i]
                );
        ...
        IERC721(address(uint160(tokenToBuy[0]))).safeTransferFrom(
            SellerBuyer[0],
            SellerBuyer[1],
            tokenToBuy[1]
        );
        ...
        emit ExchangeMadeErc721(
            SellerBuyer[0],
            SellerBuyer[1],
            address(uint160(tokenToBuy[0])),
            tokenToBuy[1],
            tokenToBuy[2],
            address(uint160(tokenToSell[0])),
            tokenToSell[1],
            tokenToSell[2],
            feeAddresses,
            feeAmounts
    ...
    function makeExchangeERC1155(
        ...
        require(
            address(uint160(tokenToBuy[0])) != address(0),
            "Exchange: Wrong tokenToBuy"
        );
        require(
            address(uint160(tokenToSell[0])) != address(0) && tokenToSell[1] == 0,
        ...
        IERC1155(address(uint160(tokenToBuy[0]))).safeTransferFrom(
            SellerBuyer[0],
            SellerBuyer[1],
            tokenToBuy[1],
            tokenToBuy[2],
