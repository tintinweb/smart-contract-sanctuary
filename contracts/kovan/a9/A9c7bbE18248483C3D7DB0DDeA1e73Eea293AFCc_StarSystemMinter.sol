...
contract StarSystemMinter is Ownable {
    ...
    StarSystemMaps public maps;

    constructor(StarSystems _sys, StarSystemMaps _maps) {
        starSystems = _sys;
        maps = _maps;
    }
...
contract StarSystems is ERC721("Star System", "STARSYS"), Ownable {
    ...
    // TODO: Add relayer IP entry set by owner
    // TODO: Allow owner to set 2 fees, to make users of relayer pay more fees
