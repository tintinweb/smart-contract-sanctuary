...
contract FlashloanV2 is FlashLoanReceiverBase, Withdrawable {
        ...
        returns (bool)
    {
        ...
        for (uint i = 0; i < assets.length; i++) {
            ...
            console.log("Approving for lending pool", amounts[i].add(premiums[i]), address(LENDING_POOL));
...
console.log("Address", receiverAddress);
    ...
    function getLendingPoolAddress() public view returns(address) {
        ILendingPoolAddressesProvider pool = ILendingPoolAddressesProvider(0x88757f2f99175387aB4C6a4b3067c77A695b0349);
