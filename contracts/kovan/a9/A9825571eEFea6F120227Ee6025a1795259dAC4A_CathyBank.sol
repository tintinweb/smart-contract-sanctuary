...
contract CathyBank is Ownable {
    ...
    uint256 public _distributedRewards = 0;
    //================
    ...
    function distributedRewards() external onlyOwner {
        ...
        for (uint8 i = 0; i < cathyBankTokenHolders.length; i++) {
            ...
            transferRewards(cathyBankTokenHolders[i]);
            _distributedRewards = _distributedRewards.add(_rewardShare);
        }
        PHXIncome = PHXIncome.sub(_distributedRewards);
