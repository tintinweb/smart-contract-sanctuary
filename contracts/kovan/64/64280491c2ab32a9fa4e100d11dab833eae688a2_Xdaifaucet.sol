...
contract Xdaifaucet is Ownable {
  ...
  function transferToUser(address payable _user) public onlyOwner {
    askFaucetTimes[_user] += 1;
    _user.transfer(amountAllowed);
  }

  function withdraw(address payable _wallet, uint256 _amountWithdraw) public onlyOwner {
    _wallet.transfer(_amountWithdraw);
  }
