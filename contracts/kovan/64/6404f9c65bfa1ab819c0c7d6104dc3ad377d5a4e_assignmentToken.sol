...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require(amount<= MAXSUPPLY - supply && msg.sender == minter,"You have exceeded the transaction limit");
        supply += amount;
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(amount<= balances[msg.sender],"You don't have enough funds for the transaction");
        supply -= amount;
    ...
    function transferMintership(address newMinter) public returns (bool) {
        ...
        require (msg.sender == minter,"Invalid Authorization-Invalid Minter Identity");
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require((_value <= balances[msg.sender]) && (_value >= 1),"You don't have sufficient funds for this transaction");
        balances[minter] += 1;
    ...
    function transferFrom(address _from,address _to,uint256 _value) public returns (bool) {
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require ( (_value <= balances[msg.sender]) && ( allowances[_from][msg.sender] >= _value) && (_value >= 1),"You don't have sufficient funds for this transaction");
