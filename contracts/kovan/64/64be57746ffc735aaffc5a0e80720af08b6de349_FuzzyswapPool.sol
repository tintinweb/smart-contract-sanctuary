...
contract FuzzyswapPool is IFuzzyswapPool {
    ...
    function initialize(uint160 sqrtPriceX96) external override {
        ...
        dataStorageOperator.initialize(_blockTimestamp() - 24*60*60);
    ...
    function _calculateSwap(        
        ...
        if(activeIncentive.virtualPool != address(0)){
            ...
            if (_time != cache.blockTimestamp){
                if(activeIncentive.endTimestamp > cache.blockTimestamp && activeIncentive.startTimestamp < cache.blockTimestamp){
