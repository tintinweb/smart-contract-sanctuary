...
contract MyTester is Context, IERC20, Ownable, Pausable {
  ...
  function _burn(address account, uint256 amount) onlyOwner internal {
  ...
  function _burnFrom(address account, uint256 amount) onlyOwner internal {
