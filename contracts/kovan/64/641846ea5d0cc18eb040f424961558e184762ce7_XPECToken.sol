...
contract XPECToken is ERC20Pausable {
    address factory;
    address _operator;
    address _pauser;
    uint256 private constant _preMineSupply = 0;   //预先发放量0枚
    uint256 private constant _maxSupply = 6980000 * 1e18;     //总量6980000枚

    constructor(address operator,address pauser) public ERC20("Proxima ECO Chian","XPEC") {
        _operator = operator;
        _pauser=pauser;
        _setupDecimals(18);
        factory=msg.sender;
