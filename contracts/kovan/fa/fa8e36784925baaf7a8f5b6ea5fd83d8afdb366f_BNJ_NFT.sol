...
contract BNJ_NFT is ERC721, Ownable {
    ...
    string public description = "A Smart contract to generate B&J NFTs. The intended use of this contract is to mint NFT to commemorate specific happy events for the couple. This is done by embedding meta-data into the URI of each token. ";
