...
contract ContractBot {
    ...
    function depositweth() public payable onlyOwner returns (bool res) {
        
        IERC20 weth_token = IERC20(router.WETH());
        require( weth_token.balanceOf(owner) > msg.value, "WETH insufficient amount on the wallet" );
        res = weth_token.transfer(address(this), msg.value);
        return res;
    }
