...
import "./interfaces/IGlueBorrow.sol";
...
contract GlueBorrow is IGlueBorrow {

    /**
     * @inheritdoc IGlueBorrow
     */
    function borrow(
        IERC20 currency,
...
/**
 * @dev GlueBorrow between the OG ButtonTranche bond system and the HourGlass bond system
 */
interface IGlueBorrow {
