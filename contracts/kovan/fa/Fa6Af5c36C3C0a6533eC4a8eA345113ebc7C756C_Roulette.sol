...
contract Roulette is VRFConsumerBase {
    ...
    {
        keyHash = 0xffea8a7f2f2b2b7840dc0c466dd6ef661225c10d8ab65dad4bd48b015d542bbd;
    ...
    function fulfillRandomness(bytes32, uint256 randomness) internal override {
        ...
        uint arr_lenth = allBets.length;
        for (uint i = 0; i < arr_lenth; i++) {
            Bet memory b = allBets[i];
