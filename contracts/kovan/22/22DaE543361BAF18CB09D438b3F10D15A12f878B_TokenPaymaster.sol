...
contract TokenPaymaster is BasePaymaster {
    ...
    constructor(address _relayHub, IForwarder _forwarder, address _token, address _router) {
    ...
    function preRelayedCall(
        ...
        address recipient = address(uint160(uint256(readBytes32(reqData, 4 + msgIdx + 20))));
    ...
    function postRelayedCall(bytes memory context, bool success, uint256 gasUseWithoutPost, GsnTypes.RelayData memory relayData)
        public
        override
        relayHubOnly
    {
