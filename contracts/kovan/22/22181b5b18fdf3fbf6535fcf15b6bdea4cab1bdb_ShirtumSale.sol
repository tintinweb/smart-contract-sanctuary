...
contract ShirtumSale is ReentrancyGuard, Ownable {
    ...
    // General conditions
    uint256 public generalMinBuy = 100000000000000000; // 0.4 BNB
    uint256 public generalMaxBuy = 5000000000000000000; // 4 BNB
    ...
    uint256 public corpMinBuy = 30000000000000000000000; // 0.5 BNB
    uint256 public corpMaxBuy = 30000000000000000000000; // 0.5 BNB
    ...
    constructor(
        ...
        minimalGoal = 1000000000000000000;    // 0.2 ETH
        hardCap = 1900000000000000000000;   // 10,000 ETH
        buyPrice = 83333333330000;  // 0,000142857142900000 BNB
        totalTokens = 22800000000000000000000000;  // 70,000,000.00 TOKEN
