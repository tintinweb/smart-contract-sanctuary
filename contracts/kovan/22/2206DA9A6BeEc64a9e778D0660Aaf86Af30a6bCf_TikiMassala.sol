...
contract TikiMassala is ERC20, Ownable {
    /*
    ...
    */
    ...
    uint32 public liquidityFee = 100;
    uint128 public minTokensBeforeSwap = 100 * 10**6 * 10**18; // 100 million mininum
    ...
    ) public ERC20("TikiMassala", "TIKI3") {
