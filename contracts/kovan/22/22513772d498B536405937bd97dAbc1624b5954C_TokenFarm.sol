...
contract TokenFarm is Ownable {
  ...
  IERC20 public mickyToken;

  constructor(address _mickyTokenAddress) public {
    mickyToken = IERC20(_mickyTokenAddress);
  }
  ...
  function issueTokens() public onlyOwner {
    for (
      ...
      mickyToken.transfer(recipient, userTotalValue);
    }
  }
  ...
  function getUserTotalValue(address _user) public view returns (uint256) {
    ...
    for (
      ...
      totalValue =
        totalValue +
        getUserSingleTokenValue(_user, allowedTokens[allowedTokenIndex]);
    }
    return totalValue;
  }
