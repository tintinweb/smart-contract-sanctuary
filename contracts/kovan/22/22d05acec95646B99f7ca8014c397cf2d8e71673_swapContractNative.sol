...
contract swapContractNative is AccessControlEnumerable, Pausable
{
    ...
    */  
    ...
    /** 
      ...
      */
    function transferToOtherBlockchain(uint128 blockchain, string memory newAddress) external payable whenNotPaused
    {
        require( 
            msg.value >= minTokenAmount,
            "swapContract: Less than required minimum of Ether requested"
        );
        require(
        ...
        whenNotPaused
    {
        ...
        TransferHelper.safeTransferETH(user, amountWithoutFee);
    ...
    /** 
      ...
      */
    function changeFeeAddress(address payable newFeeAddress) external onlyOwner
    {
