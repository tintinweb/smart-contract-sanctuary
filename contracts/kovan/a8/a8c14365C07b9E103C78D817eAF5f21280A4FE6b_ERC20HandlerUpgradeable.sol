    ...
    */
        ...
        returns (address settlementToken)
    {
        ...
        if (address(swapDetails.destTokenAddress) == swapDetails.destStableTokenAddress) {
            ...
            settlementToken = handleExecuteForReserveToken(swapDetails);
        } else if (
            ...
            settlementToken = handleExecuteForNonReserveToken(swapDetails);
        }
    }
    ...
    function handleExecuteForReserveToken(SwapInfo memory swapDetails) internal returns (address settlementToken) {
        if (_burnList[address(swapDetails.destTokenAddress)]) {
            ...
            if (reserveBalance < swapDetails.destStableTokenAmount) {
                ...
                swapDetails.returnAmount = swapDetails.destStableTokenAmount;
                return _reserve._contractToLP(address(swapDetails.destStableTokenAddress));
            } else {
        ...
        swapDetails.returnAmount = swapDetails.destStableTokenAmount;
        return address(swapDetails.destStableTokenAddress);
    }
    ...
    function handleExecuteForNonReserveToken(SwapInfo memory swapDetails) internal returns (address settlementToken) {
        ...
        return address(swapDetails.destTokenAddress);
    }
}
