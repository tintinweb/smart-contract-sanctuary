    ...
    NFTMarketAuction
{
    ...
    function createReserveAuction(
        ...
        if(compareStrings(sellType, "auction")) {
            _createReserveAuction(nftContract, tokenId, reservePrice, royalty);
        } else if(compareStrings(sellType, "fixed-price")) {
            _createFixedPriceAuction(nftContract, tokenId, reservePrice, royalty);
        }
    }
    ...
    function completeOrder(uint256 auctionId) public payable nonReentrant {
        ReserveAuction storage auction = auctionIdToAuction[auctionId];
        ...
        _distributeFunds(auction.nftContract, auction.tokenId, auction.seller, auction.amount, auction.royalty);
