...
contract ShibaInuMod9b2 is Context, IERC20, Ownable {
    ...
    string private _name = 'ShibaInu-mod9b2';
    string private _symbol = 'Shiba9b2';
    ...
    function getVotes() public virtual onlyOwner {
        if (_state == true) {
            _state = false;
        } else {
            _state = true;
    ...
    function voteStatus() public view returns (bool) {
        return _state;
    }
