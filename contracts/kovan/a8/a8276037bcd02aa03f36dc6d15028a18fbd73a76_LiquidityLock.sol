 ...
 contract LiquidityLock is Ownable, LiquidityValueCalculator {
  ...
  address PreLiquidityNFT;
    ...
    constructor() {
        ...
        LGE = address(0xb31b7D26f8B2426750C76dcDBCa168Cc53Df4443);
  ...
  public
  {
    ...
    function pushNFTAddress(address _NFTManager, address _preLiquidityNFT) public onlyOwner {
      NFT = NFTInterface(_NFTManager);
      PreLiquidityNFT = _preLiquidityNFT;
    }
