...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require(msg.sender == minter, "Sender not the incumbent minter.");
        require((totalSupply_ + amount) <= MAXSUPPLY, "MAXSUPPLY reached, minting reverted");
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require((_value + fee) <= balances[msg.sender], "Insufficient balance.");
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require((_value + fee) <= balances[_from], "Insufficient balance");
        require((_value + fee) <= allowances[_from][msg.sender], "Insufficient allowance");
