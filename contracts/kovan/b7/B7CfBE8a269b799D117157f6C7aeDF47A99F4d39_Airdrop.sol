...
contract Airdrop{
  ...
  /**
   * dev function to claim NFT
   * arg1 recipient 
   * arg2 tokenId
   * arg3 signature Signature provided by the backend 
  ...
  */
  ...
  /**
    * dev   function to calculate the message that was signed
    * arg   hash Keckak256 hash of abiEncoded(recipient,tokenId)
    * returns hash
  */
  ...
  /**
   * dev function to get the address of the admin
   * arg1 message message that was signed
   * arg2 signature of admin
  */
  ...
  /**
  * dev  function to get v,r,s values for ECDSA
  * arg  sig signature of backend
  */
