...
contract AdvancedCollectible is ERC721Enumerable, Ownable, ChainlinkClient {
   ...
   function checkID(string memory geohash, address send, uint256 supply) internal returns (bytes32 requestId) 
    {
    ...
    function fulfill(bytes32 _requestId, uint256 _flag, address send, uint256 supply) public recordChainlinkFulfillment(_requestId)
    {
        flag = _flag;
