...
contract A {
    ...
    function getNumber1(bytes calldata data) external view returns (uint) {
        uint256[] memory x;
        uint y;
        address[] memory z;
        address[] memory w;
    ...
    function getArray(bytes calldata data) external view returns (uint[] memory) {
        uint256[] memory x;
        uint y;
        address[] memory z;
        address[] memory w;
    ...
    function getNumber(bytes calldata data) external view returns (uint) {
        uint256[] memory x;
        uint y;
        address[] memory z;
        address[] memory w;
    ...
    function anyArray(bytes calldata data) external view returns (uint[] memory) {
        uint[] memory x;
        x = abi.decode(data, (uint[]));
        return x;
    }
