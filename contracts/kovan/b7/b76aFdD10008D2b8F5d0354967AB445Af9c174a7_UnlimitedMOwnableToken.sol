...
// File contracts/UnlimitedMOwnableToken.sol
...
contract UnlimitedMOwnableToken is ERC20Base, ERC20Mintable, Ownable, FeeProcessor {
    constructor(
        string memory name,
        ...
        FeeProcessor(feeReceiver, "UnlimitedMOwnableToken")
        payable {

        require(initialSupply > 0, "UnlimitedMOwnableToken: initial supply cannot be zero");
