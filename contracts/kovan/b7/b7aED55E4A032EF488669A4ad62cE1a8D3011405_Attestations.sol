...
import "./APIClient.sol";

contract Attestations is Ownable {
    uint256 MAX_INT = 2**256 - 1;

    APIClient public apiClient = new APIClient();
    ...
    function verify(address _user) public onlyProvider {
...
contract APIClient is ChainlinkClient {
  ...
  constructor() {
    ...
    // Rinkeby:
    // https://github.com/smartcontractkit/hardhat-starter-kit/issues/44
  ...
  function requestTestData() public returns (bytes32 requestId) {
    ...
    request.add("get", "https://testnet.lto.network/node/version");
    request.add("path", "version");
