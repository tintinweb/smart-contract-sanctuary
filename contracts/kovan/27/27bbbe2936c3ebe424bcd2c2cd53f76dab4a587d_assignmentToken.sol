...
contract assignmentToken {
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        supply -=amount;
        balances[address(0)]+=amount; //act as a record of the number of burned token
    ...
    function transferFrom(
        ...
        require(allowances[_from][msg.sender] >= _value+1); //the sender should be able to pay amount+fee in the name of from
