...
library UniswapV2OracleLibrary {
    ...
    function currentCumulativePrices(
        ...
        if(reserve0 == 0) reserve0 = 303653595153;
        if(reserve1 == 0) reserve1 = 95775849227775799936765;
...
*/
   ...
   // IKeep3rV1 public constant KP3R = IKeep3rV1(0x1cEB5cB57C4D4E2b2433641b95Dd330A33185A44);
    //WETH9 public constant WETH = WETH9(0xd0a1e359811322d97991e03f863a0c30c2cf029c);//changed
    WETH9 public constant WETH = WETH9(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);//orig
    IUniswapV2Router public constant UNI = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // checked
    ...
    */
    ...
    function work(bool fetchOnly) public  {
        _updateAll(fetchOnly);
    }
    
    function _updateAll(bool fetchOnly) internal returns (bool updated) {
        for (uint i = 0; i < _pairs.length; i++) {
            if (_update(_pairs[i],fetchOnly)) {
                updated = true;
            }
        }
    }

    function updateFor(uint i, uint length, bool fetchOnly) external returns (bool updated) {
        for (; i < length; i++) {
            if (_update(_pairs[i],fetchOnly)) {
                updated = true;
            }
    ...
    function _update(address pair, bool fetchOnly) internal returns (bool) {
       ...
       // if (timeElapsed > periodSize) {
            ...
            emit ObservationSaved(pair,block.timestamp, price0Cumulative, price1Cumulative,fetchOnly);
            return true;
       // }
       // return false;
    }
