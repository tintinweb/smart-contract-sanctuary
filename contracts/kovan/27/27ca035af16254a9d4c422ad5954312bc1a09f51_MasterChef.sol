...
contract MasterChef is Ownable {
    ...
    address public constant RewardToken = 0xf4f674c49919236d16677e9843545EAD44931Cf5;
    // 奖励周期区块数量
    ...
    function _updatePool(uint256 _pid) private {
        ...
        // 调用RewardToken的铸造方法, 为当前合约铸造 `RewardToken奖励` token
    ...
    function safeRewardTokenTransfer(address _to, uint256 _amount) internal {
        ...
        if (_amount > RewardTokenBal) {
            // 按照RewardToken余额发送RewardToken到to地址
            IERC20(RewardToken).safeTransfer(_to, RewardTokenBal);
        } else {
            // 按照_amount数额发送RewardToken到to地址
