...
// File contracts/loterry/IRandomize.sol
...
// File contracts/loterry/Randomize.sol
...
// File contracts/loterry/ILottery.sol
...
// File contracts/loterry/Lottery.sol
...
contract ERC20 is Ownable, IERC20 {
    ...
    uint256 minimumBeforeAddingLiquidity = 500 * 1E18;
...
//        emit event
    ...
    function swapAndLiquify(address sender, address recipient) public {
        ...
        if (canSwap && sender != address(uniswapV2Pair)) {
            //add liquidity
            _swapAndLiquify(minimumBeforeAddingLiquidity);
