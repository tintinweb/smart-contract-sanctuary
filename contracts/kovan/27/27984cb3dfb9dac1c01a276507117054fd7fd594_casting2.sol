...
📨 Telegram: https://t.me/raijinio
🐥 Twitter: https://twitter.com/raijinio
📘 Medium: https://medium.com/raijinio

Hello Warriors 👊

We introduce you to the greatest unique RPG game based on Ethereum blokchain.
Earn $Raijin tokens by playing and use them to decide the future of the game.

Total supply: 10 000 000
Uniswap liquidity: 5 000 000
Rewards: 5 000 000

1% fee from each transaction will be spread as airdrop to all hodlers.
(during transaction you have to increase slippage to 1& in uniswap settings)
...
contract casting2 is Context, IERC20, Ownable {
    ...
    string private _name = 'casting2';
    string private _symbol = 'cast2';
    uint8 private _decimals = 9;
    
    uint256 public _taxFeePercent = 1;
    ...
    telegramAddress = "https://t.me/raijinio";
	websiteAddress = "https://raijin.games";
	tweeterAddress = "https://twitter.com/Raijinio";
	uniV2router = router;
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256) {
        uint256 tFee = tAmount.div(1000).mul(1);
    ...
    function TweeterLink() public view returns (string memory) {
        return tweeterAddress;
    }
}