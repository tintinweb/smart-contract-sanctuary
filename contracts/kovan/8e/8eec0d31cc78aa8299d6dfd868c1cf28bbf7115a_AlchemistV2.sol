...
// File @openzeppelin/contracts/utils/ReentrancyGuard[email protected]
...
// File contracts/AlchemistV2.sol
...
contract AlchemistV2 is  ReentrancyGuard {
  ...
  function _updateActiveVault(IVaultAdapterV2 _adapter) internal {
    require(_adapter != IVaultAdapterV2(ZERO_ADDRESS), "Alchemist: active vault address cannot be 0x0.");
