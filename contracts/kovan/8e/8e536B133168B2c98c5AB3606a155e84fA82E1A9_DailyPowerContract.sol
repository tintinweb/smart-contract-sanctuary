...
contract DailyPowerContract is Ownable, ChainlinkClient {
    ...
    function calculateFundingAmounts() public onlyOwner {
        ...
        uint256 buyerAmountCadAdjusted = buyerFundCadCentsAmount * (10**15);

        //seller price
        //uint256 sellerAmountCad = (((priceCap - price) * volume * 24)) * (10**13);
        sellerFundCadCentsAmount = (((priceCap - price) * volume * 24)) / 1000;
        uint256 sellerAmountCadAdjusted = sellerFundCadCentsAmount * (10**15);
        ...
        buyerFundEthWeiAmount = buyerEthAmount;
        sellerFundEthWeiAmount = sellerEthAmount;
    ...
    function calculateSettlementAmounts() public onlyOwner {
        ...
        uint256 winningsAmountCadAdjusted = winningsCadCentsAmount * (10**15);
