...
import "./deflationaryTokenUpgradeableV1.sol";

contract deflationaryTokenUpgradeableV2 is deflationaryTokenUpgradeableV1 {
...
contract deflationaryTokenUpgradeableV1 is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function calculateFee(uint256 amount) public view returns (uint256) {
        uint256 defInterestFee = amount.mul(defInterestRate).div(10000);
