...
contract TestSecLocker is Owned {
    ...
    event TestSecLocked(address _holder, string _meshAddress, uint256 _testSecBalance, uint256 _testSecTokenBalance);
    event TestSecUnlocked(address _holder, string _meshAddress, uint256 _testSecBalance, uint256 _testSecAmount);
    ...
    function testlock(string calldata _meshAddress, address _holder,  uint256 _testSecAmount) onlyOwner public {
    ...
    function _lock(string memory _meshAddress, address _holder, uint256 _testSecAmount) internal {
        ...
        require(_testSecAmount >= E18, "Insufficient amount");
        ...
        emit TestSecLocked( _holder, _meshAddress, testSecBalance, _testSecAmount);
    }

    function testunlock(string calldata _meshAddress, address _holder,  uint256 _testSecAmount) onlyOwner public {
    ...
    function _unlock(string memory _meshAddress, address _holder, uint256 _testSecAmount) internal {
        ...
        emit TestSecUnlocked( _holder, _meshAddress, testSecBalance, _testSecAmount);
    }
}