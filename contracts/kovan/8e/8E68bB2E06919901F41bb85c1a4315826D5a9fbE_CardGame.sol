...
contract CardGame is IERC721Receiver, Context, CardGameS1  {
    ...
    IERC721 erc721 = IERC721(0xe7D505dfc108c492CdFB552572d34C2836e422d8);
    ...
    constructor() {
      counters._value=15;
      _dev = address(0x1b5Fe099068C237Aaa3C291CeBB1b793e85243Fa);
    }
    ...
    function mint(address to,uint256 tokenId,string memory tokenURI) public virtual{
      require(_msgSender()==_dev,'CardGame : no permission');
