...
contract CRCN is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
    ...
    public view returns (address _owner_address, uint256 _balance, uint256 _onSaleNum, uint256 _price)
    {
        address owner_address = owners[_id]._values[0];
        uint256 balance = balances[owner_address][_id];
        uint256 onSaleNum = onSaleBalances[owner_address][_id];
        uint256 price = prices[owner_address][_id];
        return (owner_address, balance, onSaleNum, price);
    }
