...
contract LockedBoxV7 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    uint256 private pendingForDistribution;


    mapping(address => mapping(uint256 => uint256)) public lockedTokenAmounts;
    ...
    function checkTime() public view onlyOwner returns (uint256){
