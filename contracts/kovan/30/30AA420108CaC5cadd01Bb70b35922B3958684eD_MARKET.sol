...
contract MARKET{
    ...
    function getavailableproducts(uint256 index)
    public view returns(
        uint256 id,
        uint256 onemonth,
        uint256 threemonth,
        ...
        uint256 mem)
    {
        ...
        return(
            products[index].item_id,
            products[index].pricefor1month,
            products[index].pricefor3month,
            products[index].paytogopricepermin,
            products[index].operatingsystem,
            products[index].vcpus,
            products[index].meromrycapicity
            );
