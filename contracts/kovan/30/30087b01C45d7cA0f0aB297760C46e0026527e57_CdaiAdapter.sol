...
contract CdaiAdapter is AdapterBase {
    ...
    constructor(
        ...
        _underlying = IERC20(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa);
    }
    ...
    function supplyErc20ToCompound(
        ...
        underlying.safeApprove(cErc20Contract, amount);
        cToken.mint(amount);
    }
    ...
    function approveTransfer(uint256 amount) external {
        _underlying.safeApprove(msg.sender, amount);
    }
