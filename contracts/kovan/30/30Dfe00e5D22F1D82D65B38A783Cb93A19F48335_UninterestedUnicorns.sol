    ...
    ERC721Pausable
{
    ...
    uint256 public constant MAX_QUANTITY = 5; // Maximum mint per transaction
    uint256 public constant LAUNCH_PRICE = 0.01 ether;
    ...
    function mint(uint256 _quantity) public payable whenNotPaused {
        ...
        CANDY_TOKEN.updateRewardOnMint(_msgSender(), _quantity);
    }
