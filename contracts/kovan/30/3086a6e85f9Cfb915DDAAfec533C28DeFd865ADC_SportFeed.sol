...
contract SportFeed is ChainlinkClient, Owned {
    ...
    function setSeason(string memory _season) public onlyOwner {
        season = _season;
    }

    function setEventSport(string memory _event) public onlyOwner {
        eventSport = _event;
    }

    function setGender(string memory _gender) public onlyOwner {
        gender = _gender;
    }

    function setEndpoint(string memory _endpoint) public onlyOwner {
        endpoint = _endpoint;
    }
     ...
     * Initial request
     */
    function requestSportsWinner() public {
