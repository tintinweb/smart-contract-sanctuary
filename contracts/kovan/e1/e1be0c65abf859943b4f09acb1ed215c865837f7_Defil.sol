...
contract Defil {
    ...
    uint256 private _rewardRate = 20;

    uint256 private _releaseDuration = 365;
    ...
    function withdraw(uint256 index) public {
        ...
        uint256 _amount;
        if (block.timestamp.sub(b.stakeTime).div(86400) < b.day) {
