...
contract CryptoApe is Context, IERC20, Ownable {
    ...
    constructor () {
        _uniswapV2Router = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //PCS Routerl
    ...
    function excludeAccountFromReflection(address account) external onlyOwner() {
    ...
    function includeAccountInReflection(address account) external onlyOwner() {
        require(_isExcluded[account], "Account is already excluded");
