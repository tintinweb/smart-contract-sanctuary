...
contract Spaceportv1 is ReentrancyGuard {
  ...
  constructor(address _spaceportGenerator) public {
    ...
    PLASMASWAP_FACTORY = IPlasmaswapFactory(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f);
    ...
    SPACEPORT_LOCK_FORWARDER = ISpaceportLockForwarder(0x718E672254dAE5253F94Cac1E6deE91d863cE60f);
