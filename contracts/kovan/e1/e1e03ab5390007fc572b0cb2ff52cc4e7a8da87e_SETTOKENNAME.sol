...
// ####################
    ...
    function _swapTokensForETH(uint256 _amount) private lockTheSwap {                           // If you want to do something like add taxes to Liquidity, change the logic in this block
        ...
        _path[1] =address(0xF0210049B574A489c30147a6E2957F7a040D102d);
...
// ######################
    ...
    function addLiquidity() external onlyOwner() {
        ...
        m_UniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xF0210049B574A489c30147a6E2957F7a040D102d));
