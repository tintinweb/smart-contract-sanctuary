...
contract PEther is PToken {
     ...
     */
    constructor(PControllerInterface pController_,
                InterestRateModel interestRateModel_,
                uint initialExchangeRateMantissa_,
                string memory name_,
                string memory symbol_,
        ...
        initialize(pController_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_);
