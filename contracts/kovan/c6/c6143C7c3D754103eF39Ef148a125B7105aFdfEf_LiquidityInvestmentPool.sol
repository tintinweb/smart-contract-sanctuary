...
//    }
    ...
    **************************************************************/
    ...
    function _addLiquidity(uint256 totalDeposit) private returns (bool) {
        ...
        UniswapV2Router02.swapExactETHForTokens{value: totalDepositHalf}(0,path,address(this),block.timestamp + 10000);

        // function swapExactETHForTokens(uint amountOutMin, address[] calldata path, address to, uint deadline)


//        // for unknown reasons token0 swapped with token1 inside contract, sample is https://testnet.bscscan.com/address/0x0b21BFaFFAEf67428406D223Fa8D6321484E4FA4#readContract
//        address token0 = pairForInvest.token0();// BUSD https://bscscan.com/address/0xe9e7cea3dedca5984780bafc599bd69add087d56 https://testnet.bscscan.com/address/0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47#code
//        address token1 = pairForInvest.token1();  // wBNB https://bscscan.com/token/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c#writeContract https://testnet.bscscan.com/address/0xae13d989dac2f0debff460ac112a837c89baa7cd#code
//
//        // at first, we have to get amount to swap BNB to BUSD
//        uint256 totalDepositHalf = totalDeposit.div(200000000);
//        IwBNB _token1 = IwBNB(token1);// wBNB
//        _token1.deposit.value(totalDepositHalf)();
//        _token1.transfer(_pairForInvest,totalDepositHalf);
//        pairForInvest.sync();
//        uint256 token0price = pairForInvest.price0CumulativeLast(); // BNB - for unknown reasons mainnet prices bnb/busd = 2150, like need divide 10
//        uint256 token1price = pairForInvest.price1CumulativeLast(); // BUSD
//
//        uint256 totalDepositHalfInToken1 = totalDepositHalf.mul(token1price).div(token0price);
//        emit DebugAddLiquidity(token0,token1,token0price,token1price,totalDepositHalf,totalDepositHalfInToken1);
//        pairForInvest.swap(totalDepositHalf, 0, address(this), '0x');

//        IERC20 _token1 = IERC20(token1);
//        _token1.transfer(_pairForInvest,totalDepositHalfInToken1);
        return true;
    }
    /**
    ...
    */
    function _deposit(address sender, uint256 amount, uint256 feesMulitpier) private returns (bool) {
        ...
        return _addLiquidity(totalDeposit);
    }
