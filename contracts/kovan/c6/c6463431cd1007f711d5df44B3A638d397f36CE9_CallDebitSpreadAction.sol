...
import { RollOverBase0 } from "RollOverBase0.sol";
...
/**
 * @title CallDebitSpreadAction
 * @author Opyn Team
 */

contract CallDebitSpreadAction is IAction, AirswapBase, RollOverBase0 {
...
contract RollOverBase0 is Ownable {
  struct Spread {
    address shortOtoken;
    address longOtoken;
    // address
