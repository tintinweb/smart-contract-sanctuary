...
contract zsbToken is ERC20("Stabilize Strategy Test Token", "zsb-Test"), Ownable, ReentrancyGuard {
    ...
    // Token information
    // This wrapped token accepts multiple usd coins
    // BUSD, DAI, USDC, USDT
    struct TokenInfo {
