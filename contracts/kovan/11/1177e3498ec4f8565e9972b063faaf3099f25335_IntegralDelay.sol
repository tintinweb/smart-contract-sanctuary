...
contract IntegralDelay is IIntegralDelay {
    ...
    function _executeWithdraw(Orders.WithdrawOrder memory withdrawOrder) public {
        ...
        (bool success, uint256 wethAmount, uint256 amount0, uint256 amount1) = (true, 0, 0, 0);
...

{
  "libraries": {
    "IERC20.sol": {
      ...
      "AddLiquidity": "0x167b060b16B3AAD0b6826fc4561550f1deAbA034",
      "BuyHelper": "0x8FB37D93c257053606d92fcD2f12428e826DF04b",
      "WithdrawHelper": "0x421137A857cf993363F60E1EA3992AE66d92c89c"
    },
    "IIntegralERC20.sol": {
      "TokenShares": "0x8C828E61a9ECDc297aE3cdD36fA6102A9D3e7BFe",
      "Orders": "0xA5f52Dcdf340aBDAB12B47be54DbD5934B6C62f4",
