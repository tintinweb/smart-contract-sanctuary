...
contract SimpleTokenSwap is HyperBase {
    using SafeERC20 for IERC20;

    address private constant wethTokenAddress = 0xd0A1E359811322d97991E03f863a0C30C2cF029C;
    ...
    {
        uint256 toInvest = _pullTokens(fromToken, amount, affiliate);
        _fillQuote(fromToken, toInvest, toToken, swapTarget, swapCallData);
    }
    ...
    function _pullTokens(
        ...
        if (swapAmount > 0) {
            toInvest = swapAmount - (_subtractFeeValue(fromToken, swapAmount, affiliate));
        }
    }
