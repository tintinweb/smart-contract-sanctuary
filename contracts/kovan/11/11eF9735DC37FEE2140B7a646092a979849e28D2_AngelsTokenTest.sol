...
contract AngelsTokenTest is ERC20Burnable, Ownable {
  ...
  constructor(
    ...
    uint256 step = 2 * 60 * 60;
    mintSchedule.push(TokenRelease({timestamp: ts + 1 * step, amount: 78986742 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 2 * step, amount: 77847862 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 3 * step, amount: 76804959 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 4 * step, amount: 75832072 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 5 * step, amount: 74839277 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 6 * step, amount: 73801579 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 7 * step, amount: 72784979 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 8 * step, amount: 71797398 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 9 * step, amount: 70826707 * 1e18}));
    mintSchedule.push(TokenRelease({timestamp: ts + 10 * step, amount: 69862089 * 1e18}));
