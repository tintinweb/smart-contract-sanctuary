...
contract ShaktiToken is ERC20 {
    address public admin;
    uint public totalSupplyCap;
    uint private totalCirculatingSupply;
    uint private initialSupply;
    
    constructor() ERC20('Shakti', 'SHAKTI') {
    ...
    function mint(address to, uint amount) external {
        ...
        require(totalCirculatingSupply + amount <= totalSupplyCap, 'Shakti token cap exceeded');
    ...
    function futureSupply() public view returns (uint remaining) {
       return totalSupplyCap - totalCirculatingSupply;
    }
}