...
contract WOWORToken is Context, IBEP20, Ownable {
    ...
    string private _name     = "WOWOR Token";
    string private _symbol   = "WOWOR";
    ...
    //uint256 private _maxWalletToken = 20000 * 10**6 * 10**9;
