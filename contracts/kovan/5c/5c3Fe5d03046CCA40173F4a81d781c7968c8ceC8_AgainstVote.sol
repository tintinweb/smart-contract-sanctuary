...
contract AgainstVote {
    ...
    function approve(address _comp) public {
        IERC20(_comp).approve(voteController, uint256(-1));
    }
    ...
    function againstVote(address _comp, uint256 _proposalId) public {
