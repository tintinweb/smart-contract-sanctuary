...
contract FlashloanV2 is FlashLoanReceiverBaseV2, Withdrawable {
     ...
     */
    function flashloanBulk(address[] memory assets, uint256[] memory amounts) public onlyOwner {
    ...
    function testGetter() public view returns(string memory){
        return "Working";
    }

    function getLendingPoolAddress() public view returns(address) {
        ILendingPoolAddressesProviderV2 pool = ILendingPoolAddressesProviderV2(0x88757f2f99175387aB4C6a4b3067c77A695b0349);

        return pool.getLendingPool();
    }
}
