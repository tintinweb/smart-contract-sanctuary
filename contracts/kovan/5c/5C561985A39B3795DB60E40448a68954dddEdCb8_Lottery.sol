...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    enum LotteryState { Open, Closed, CalculatingWinner }
    ...
    function enter () public payable {
        require (lotteryState == LotteryState.Open, "The lottery must be open");

        // $50 minimun
        uint256 minimunFee = getEntranceFee();
        require (msg.value >= minimunFee, "You need more ETH!");
    ...
    function getEntranceFee () public view returns(uint256) {
        ...
        uint256 fee = (usdEntryFee * 10 ** 18) / uPrice;
        return fee;
    }
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        require (lotteryState == LotteryState.CalculatingWinner, "You can't complete this function call");
