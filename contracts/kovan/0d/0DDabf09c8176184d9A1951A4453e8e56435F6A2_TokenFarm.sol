...
contract TokenFarm is Ownable {
    ...
    // 100ETH 1:1 for every ETH, we give 1 DappToken
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        require(tokenIsAllAllowed(_token), "Token is currently no allowed");
        // transferFrom
    ...
    function tokenIsAllAllowed(address _token) public returns (bool) {
        for (
