...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #FRIENDLYSHIBA  to the community, make sure it's 100% safe.
   ...
   it's the best part of the #FRIENDLYSHIBA idea, increasing the liquidity pool automatically, 
...
contract FRIENDLYSHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "FRIENDLYSHIBA";
