...
contract ProphetPool is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    function settlePool() external {
        ...
        uint256 newRandom = _getRandomNumberBlockchain(0, randomResult);
        while(winnerIndexes.length < poolConfig.numOfWinners) {
            ...
            newRandom = _getRandomNumberBlockchain(winnerIndexes.length, newRandom);
        }
    ...
    function collectRewards() public nonReentrant {
        ...
        for (uint256 i = 0; i < poolConfig.participantLimit; i = i.add(1)) {
            ...
            if (isWinner) {
                ...
                _transferBuyToken(player, rewardPerParticipant);
            } else {
