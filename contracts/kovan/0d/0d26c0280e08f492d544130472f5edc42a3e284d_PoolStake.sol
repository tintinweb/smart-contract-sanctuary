...
contract PoolStake is Owned {
    ...
    address internal lqdy;                      //utility token for migration 
    ...
    constructor(address _token, address _Owner) public Owned(_Owner) {
        ...
        lqdy = 0x466260f1d6094eC86B63fB0d7C10689c43992aC9;
     ...
     */ 
    function migrateToLQDY(address _multiplier) external returns(bool) {
        ...
        emit MigratedToLQDY(msg.sender, lqdy);
        return true;
    }
    ...
    function _withdrawUserETHBonus(address payable _user, uint releasedAmount, uint _asset) internal returns(bool) {
        ...
        if(_asset == 1) require(IERC20(uToken).transferFrom(_user, platformWallet, fee), "must approve fee");
        else require(IERC20(lqdy).transferFrom(_user, platformWallet, fee), "must approve fee");
