...
contract S is Context, IERC20 {
    ...
    string private _name = "Smelly";
    string private _symbol = "SMELLY";
    ...
    address payable private _marketingWallet = payable(0x5b51Dc39590A00176E48123a04e913e08C836184);
    ...
    uint256 private swapThreshold = (_tTotal * 50) / 10000;
    uint256 private swapAmount = (_tTotal * 50) / 1000;
