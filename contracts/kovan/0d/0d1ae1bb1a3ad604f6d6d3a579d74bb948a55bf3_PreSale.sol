...
contract PreSale is Owned {
    ...
    constructor(address _tokenAddress) {
        owner = payable(0x744F7EC5267d0E0FfBd9D9824D167607128111FD) ;
    ...
    function Invest() public payable whitelisted whitelistedAmt{
        ...
        investors[msg.sender].tokens = investors[msg.sender].tokens + getTokenAmount(msg.value);
        investors[msg.sender].amount = investors[msg.sender].amount + msg.value;
    }
