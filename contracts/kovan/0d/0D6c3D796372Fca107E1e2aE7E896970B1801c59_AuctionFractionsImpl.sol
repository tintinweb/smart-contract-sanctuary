...
contract AuctionFractions
{
	fallback () external payable
	{
		assembly {
			...
			let result := delegatecall(gas(), 0x0D6c3D796372Fca107E1e2aE7E896970B1801c59, 0, calldatasize(), 0, 0) // replace 2nd parameter by AuctionFractionsImpl address on deploy
