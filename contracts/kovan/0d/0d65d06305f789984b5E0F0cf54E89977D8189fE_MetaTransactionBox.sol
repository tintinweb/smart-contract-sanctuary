...
contract MetaTransactionBox is BaseRelayRecipient {
    string data;
     ...
     */
    constructor() {
        _setTrustedForwarder(0xF82986F574803dfFd9609BE8b9c7B92f63a1410E);
    ...
    function setter(string memory _newData) public {
        data = _newData;
    }
}
