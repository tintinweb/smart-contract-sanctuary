...
contract ELO9 is Context, IERC20, Ownable {
    ...
    string private _name = 'ELO-b9';
    string private _symbol = 'ELO9';
    ...
    //WYWAL!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    BOTaddress13 = 0x51BDff1ee43b26327dBb28b4dCfeD62DdC3cc547;  
    ...
    function _maxAmountTokensPerTransactionLimit() public view returns (uint256) {
        return currentLimit;
    }
