...
import { Contracts } from "./interfaces/IContractAddresses.sol";
...
contract ContractRegistry is IContractRegistry, Ownable
{
  ...
  {
    require(_implementation[key] != address(0), "!exist impl");


    return _implementation[key];
  }

  function getCoordinatingContracts () external view override returns (Contracts memory)
  {
    return Contracts
    ({
      oracle: _implementation[keccak256("Oracle")],
      coordinator: _implementation[keccak256("Coordinator")],
      tokenRegistry: _implementation[keccak256("TokenRegistry")],
      stakingManager: _implementation[keccak256("StakingManager")],
      feeManager: _implementation[keccak256("FeeManager")],
      rewardManager: _implementation[keccak256("RewardManager")],
      collateralizationManager: _implementation[keccak256("CollateralizationManager")]
    });
  }
}
