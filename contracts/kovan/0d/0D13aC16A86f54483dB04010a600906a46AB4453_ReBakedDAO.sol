...
contract ReBakedDAO is IReBakedDAO, Ownable, ReentrancyGuard, Projects {
	...
	*/
		...
		returns(uint256 amount_)
	{
		...
		_pay(projectId_, amount_*10e17);
		emit PaidMgp(projectId_, packageId_, msg.sender, amount_*10e17);
	}
	...
	*/
		...
		returns(uint256 amount_)
	{
		...
		_pay(projectId_, amount_*10e17);
		emit PaidMgps(projectId_, packageIds_, msg.sender, amount_*10e17);
	}
	...
	*/
		...
		returns(uint256 amount_)
	{
		...
		_pay(projectId_, amount_*10e17);
		emit PaidBonus(projectId_, packageId_, msg.sender, amount_*10e17);
	}
	...
	*/
		...
		returns(uint256 amount_)
	{
		...
		_pay(projectId_, amount_*10e17);
		emit PaidBonuses(projectId_, packageIds_, msg.sender, amount_*10e17);
	}
	...
	*/
		...
		returns(uint256 amount_)
	{
		...
		_pay(projectId_, amount_*10e17);
		emit PaidObserverFee(projectId_, packageId_, msg.sender, amount_*10e17);
	}
	...
	*/
		...
		returns(uint256 amount_)
	{
		...
		_pay(projectId_, amount_*10e17);
		emit PaidObserverFees(projectId_, packageIds_, msg.sender, amount_*10e17);
	}
...
contract Projects is Packages {
	...
	*/
	function _pay(
		...
		internal
	{
		projectData[projectId_]._pay(amount_*10e17);
	}
