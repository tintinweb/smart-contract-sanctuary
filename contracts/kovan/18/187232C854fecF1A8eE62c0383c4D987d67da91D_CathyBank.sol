...
contract CathyBank is Ownable {
    ...
    uint256 ethDepositDiscountPercentage;
    uint256 ethWithdrawFeePercentage;
    address payable CETHContractAddress;
    ...
    function withdrawETH(uint256 _amount) public payable {
        require(
            ethDeposits[msg.sender] >= _amount.add(ethWithdrawFeePercentage),
