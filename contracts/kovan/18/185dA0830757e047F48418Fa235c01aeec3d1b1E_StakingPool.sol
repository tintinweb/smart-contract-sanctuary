...
contract StakingPool is IStakingPool, PermissionGroup {
    ...
    function setKabyContract(IKabyHero kabyAddr) external onlyOwner {
        require(address(kabyAddr) != address(0));
        kabyHeroContract = kabyAddr;
    }
    ...
    function claim(uint heroId) external override {
        ...
        if (stakingHero.stakingType == StakingType.upgradeStar) {
