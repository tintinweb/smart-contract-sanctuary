...
contract HODLRewardsDistributor is Ownable {
    ...
    function depositWrappedNativeTokenRewards(
        ...
        IWAVAX(wrappedNativeToken).transferFrom(msg.sender, address(this), amount_);
        IWAVAX(wrappedNativeToken).withdraw(IWAVAX(wrappedNativeToken).balanceOf(address(this)));
    }
