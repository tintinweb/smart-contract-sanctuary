...
contract EverPorn is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x731823805c3fBAd79Cd08edc7117A9898C42B308); // Marketing Address
    ...
    string private _name = "PornCumies";
    string private _symbol = "POCU";
