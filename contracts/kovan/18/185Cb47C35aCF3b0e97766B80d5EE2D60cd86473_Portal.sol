...
contract Portal is OwnableUpgradeable,CacheResolverUpgradeable {
    ...
    modifier enterActive() {
        require(_enterActive() == true, "the function of enter is inactive");
        _;
    }

    function _enterActive() private view returns (bool) {
        bytes32 functionname = "enter";
        bytes32 systemname = "System";
        systemStatus().requireFunctionActive(functionname, systemname);
        return true;
