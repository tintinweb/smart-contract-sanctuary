...
contract LockedBoxV10 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    mapping(address => stakingInfo[]) public lockedTokenAmounts;
    ...
    function checkCinoBalance(address addressToCheck) public view returns (uint256){
        return cino.balanceOf(addressToCheck);
    }
