...
contract GasDaoToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    function startVest(address tokenLockAddress) public onlyOwner {
        ...
        GasDaoTokenLock(tokenLockAddress).lock(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266, 30_000_000_000e18);
        GasDaoTokenLock(tokenLockAddress).lock(0xcA38B710828Bf7D696Da40785AbE27387c7823c7, 20_500_000_000e18);
