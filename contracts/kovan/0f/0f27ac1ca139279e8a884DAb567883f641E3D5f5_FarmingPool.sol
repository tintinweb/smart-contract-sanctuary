...
contract FarmingPool is Pausable, ReentrancyGuard, IFarmingPool {
        ...
        )
    {
        ...
        interestRateSlope1_ = (integerInterestRatePoint2 <<
            (2 * NUM_FRACTION_BITS))
            .sub(integerInterestRatePoint1 << (2 * NUM_FRACTION_BITS))
            .div(utilisationRatePoint2_.sub(utilisationRatePoint1_));
        interestRateSlope2_ = (PERCENT_100 << (2 * NUM_FRACTION_BITS))
            .sub(integerInterestRatePoint2 << (2 * NUM_FRACTION_BITS))
