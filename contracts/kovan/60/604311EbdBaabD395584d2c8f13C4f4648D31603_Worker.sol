...
import "../../apis/pancake/IUniswapV2Router02.sol";
...
contract Worker is Ownable, ReentrancyGuard, IWorker {
  /// @notice Libraries
  ...
  constructor(
    ...
    require(
      ...
      "Worker::initialize:: LP underlying not match with farm & base token"
    );
  }
  ...
  function work(
    ...
    require(
      ...
      "Worker::work:: unable to transfer lp to strat"
    );
  ...
  function getMktSellAmount(
    ...
    if (aIn == 0) return 0;
    require(rIn > 0 && rOut > 0, "Worker::getMktSellAmount:: bad reserve values");
