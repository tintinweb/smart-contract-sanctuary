...
// File: contracts\MarketPlaceProxy.sol
...
contract MarketplaceProxy is Initializable, Ownable, Pausable, FeeManager, IMarketplace, ERC721Holder {
    ...
    function acceptBid(address _nftAddress, uint256 _assetId, uint256 _priceInWei) public whenNotPaused {
        ...
        acceptedToken.safeTransfer(bid.bidder,bid.price.sub(saleShareAmount));
