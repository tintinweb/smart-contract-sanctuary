...
contract L1_NovaExecutionManager is Auth, CrossDomainEnabled {
    /*///////////////////////////////////////////////////////////////
                    TRANFER FROM RELAYER CONSTANTS
    //////////////////////////////////////////////////////////////*/
    ...
    /// could steal them by calling exec with the token set as the strategy and transferFrom or pull (used by DAI/MKR use) set as calldata.
...
contract L1_NovaApprovalEscrow {
    ...
    /// @param approver The user who approved the token to the escrow.
    ...
    function transferApprovedToken(
        ...
        // Transfer tokens from the approver to the recipient.
        (bool success, bytes memory returnData) =
            address(token).call(
                abi.encodeWithSelector(
