...
// File contracts/UnlimitedMBROwnableToken.sol
...
contract UnlimitedMBROwnableToken is ERC20Base, ERC20Mintable, ERC20Burnable, ERC20Recoverable, FeeProcessor {
    constructor(
        string memory name,
        ...
        FeeProcessor(feeReceiver, "UnlimitedMBROwnableToken")
        payable {

        require(initialSupply > 0, "UnlimitedMBROwnableToken: initial supply cannot be zero");
