...
contract L2 is ILayer2, Deserializer, PermissionGroups, ReentrancyGuard {
    ...
    uint256 private constant NUM_TX_IN_BLOCKS = 4;
...
contract KeysWithPlonkVerifier is VerifierWithDeserialize {
    ...
    // params: 
    //   number_blocks_in_batch = 4
    //   number_txs_in_block = 4
    //   number_ops_in_block = 4
    //   number_validators = 21
    function getVkBlock32() internal pure returns(VerificationKey memory vk) {
        vk.domain_size = 16777216;
        vk.num_inputs = 1;
        vk.omega = PairingsBn254.new_fr(0x1951441010b2b95a6e47a6075066a50a036f5ba978c050f2821df86636c0facb);
        vk.selector_commitments[0] = PairingsBn254.new_g1(
            0x21356351087affe1b41fd5c0f8d38767f9064f74f1ce8a090628a7b48728f9d5,
            0x100c7422017c2cc0d1d4b59b0d2a8c34ed29ba9e23af8bd52d410f059fb7d326
        );
        vk.selector_commitments[1] = PairingsBn254.new_g1(
            0x26f30b1c7a785a1d3347c39f681624d7323ff75706cdee68456af7bca932e101,
            0x06bd5d8d52733a29a99184d5a9b444d4113f076be72eb843698a977ce5fe7f26
        );
        vk.selector_commitments[2] = PairingsBn254.new_g1(
            0x0475c16f83cd1fa62b9de4f270f51b4bb12815e280c39fad3b8251bb68baec97,
            0x184a33199f4cdc3e99d58a7236b40242dc4b593680c2771626c6d1c5fd782d75
        );
        vk.selector_commitments[3] = PairingsBn254.new_g1(
            0x1528098d893efcc9fedb93acd670744cf134c492164f5a2aca835797cd281868,
            0x0ff38dbc696fac1459508ef00338c2ef9d01772306fac3baf3378be240d2cef7
        );
        vk.selector_commitments[4] = PairingsBn254.new_g1(
            0x06716164809b63ce3f65512c1e39faf374dbaeb65858b7715cfae4299abfd575,
            0x27f241481dbaf804c42c5514636952cd0f9bc57205cd839bffeaa13d9f367229
        );
        vk.selector_commitments[5] = PairingsBn254.new_g1(
            0x03c731d00dca119991470175152075c9b5a228e11f7a06bd7bf2547eb1f31df0,
            0x1ee591c615546a110fbe9c91006d274f488675ee21977f295bfc0c0b278488ee
        );
        ...
        vk.next_step_selector_commitments[0] = PairingsBn254.new_g1(
            0x195e80b2a0c93804b58fa1db9ef6403720f00b661af936d4d7173538aea9a3a0,
            0x00f63543e316da45ed9e0e4db95ea053f0bfa91fa56cc6eaf199242e3986ae46
        );

         vk.permutation_commitments[0] = PairingsBn254.new_g1(
            0x3044ec08a984b468c3453406ecf0b875880e5abc65e03f25e050a48b8181d314,
            0x27477aee56c9ed067b6cdcae40dace9aed8e2d9b60953f8b2f35fb0077183d7c
        );
        vk.permutation_commitments[1] = PairingsBn254.new_g1(
            0x22d5671ac6093786122bedf864db6b2a56c65006d3361da3eb2feaa367661c9e,
            0x14c1b11619f56b889e9507f27e68a396e0ec0b0c0c95413e3ca16142e452ae6f
        );
        vk.permutation_commitments[2] = PairingsBn254.new_g1(
            0x2a638ee41a6621c9b27bf0cca09260032e00ae3eead263e7f55fda37c1d37d2e,
            0x121eff20430c2efb3b4d3cb557bcd93d649d06d08a6eff6ceb1b1f67579320df
        );
        vk.permutation_commitments[3] = PairingsBn254.new_g1(
            0x1305d6ae953051b0e90fc75273140cfcb2b4cf18888e0fc882ccbccaaa1bdeeb,
            0x01d7e3a9fe7c92519398c7a9d5b605bbbe94b5a23f448ae5d5ba54923537baaa
        );
