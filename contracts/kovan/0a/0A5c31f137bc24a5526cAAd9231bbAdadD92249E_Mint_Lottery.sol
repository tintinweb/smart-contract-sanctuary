...
contract Mint_Lottery is VRFConsumerBase, KeeperCompatibleInterface {
  ...
  function checkUpkeep(bytes memory /*checkData*/) public view override 
    returns(bool upKeepNeeded, bytes memory/*performData*/) {
      ...
      upKeepNeeded = (((block.timestamp - x_lastTimeStamp) > x_interval) 
        && isOpen && hasLink && (address(this).balance >= 0));
    }
  ...
  function fulfillRandomness(bytes32 /*requestId*/, uint256 randomness) internal override {
    ...
    x_usersEntered = new address payable[](0); // reset the array. Im considering using a mapping 4 random indexes but maybe overkill.
