...
contract Lottery is VRFConsumerBase,Ownable{
    ...
    address _vrfCoordinaror, 
    address _link,
    uint256 _fee,
    bytes32 _keyhash
    )
    public VRFConsumerBase(_vrfCoordinaror,_link){
    ...
    function enter() public payable{ 
        require(lottery_state == LOTTER_STATE.OPEN,"Lottery not open");
    ...
    function startLottery() public onlyOwner{
        require(lottery_state == LOTTER_STATE.CLOSED,"Lottery is already open");
        lottery_state = LOTTER_STATE.OPEN;
    }


    function endLottery() public onlyOwner{
        //  uint(keccack256 (abi.encodePacked(nonce,msg.sender,
       ...
       internal override {
        require(lottery_state == LOTTER_STATE.CALCULATING_WINNER,"You are not there yet!");
