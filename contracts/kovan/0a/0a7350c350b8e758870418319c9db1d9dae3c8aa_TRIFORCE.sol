...
/**
   ...
   #LIQ+#RFI+#SHIB+#BUNNY+#FEG+#PIG, combine together to creat #TRIFORCE designed to make everyone TRIFORCE!
    
    I make this #TRIFORCE to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/TRIFORCEfinance
   ...
   I will renounce the ownership to burn addresses to transfer #TRIFORCE to the community, make sure it's 100% safe.

   I will add 5 BNB and all the left 49.5% total supply to the pool
   Can you make #TRIFORCE 10000000X? 
   ...
   it's the best part of the #TRIFORCE idea, increasing the liquidity pool automatically, 
