...
contract ProxyFactory {
    ...
    function deployMinimal(
        ...
        // Adapted from https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/master/contracts/proxy/ClonesUpgradeable.sol
        assembly {
            let ptr := mload(0x40)
            mstore(ptr, 0x3d602d80600a3d3981f3363d3d373d3d3d363d73000000000000000000000000)
            mstore(add(ptr, 0x14), shl(0x60, _logic))
            mstore(add(ptr, 0x28), 0x5af43d82803e903d91602b57fd5bf30000000000000000000000000000000000)
            proxy := create2(0, ptr, 0x37, _salt)
        }

        require(proxy != address(0), "ProxyFactory: create2 failed");
    ...
    /**
     * @dev Computes the address of a clone deployed.
     */
    function predictDeterministicAddress(
        ...
        bytes32 salt = keccak256(abi.encodePacked(_symbol, _futureVault));
    ...
    function deploySigned(
        ...
        require(signer != address(0), "ProxyFactory: Invalid signature");
...
contract BaseAdminUpgradeabilityProxy is BaseUpgradeabilityProxy {
    ...
    function changeAdmin(address newAdmin) external ifAdmin {
        require(
            newAdmin != address(0),
            "BaseAdminUpgradeabilityProxy: Cannot change the admin of a proxy to the zero address"
        );
    ...
    function _willFallback() internal virtual override {
        require(msg.sender != _admin(), "BaseAdminUpgradeabilityProxy: Cannot call fallback function from the proxy admin");
        super._willFallback();
    }
}
...
contract BaseUpgradeabilityProxy is Proxy {
    ...
    function _setImplementation(address newImplementation) internal {
        require(
            ...
            "BaseUpgradeabilityProxy: Cannot set a proxy implementation to a non-contract address"
        );
