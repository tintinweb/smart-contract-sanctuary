...
contract SETTOKENNAME is Context, IERC20, Ownable {
    ...
    constructor () {
        FTPAntiBot _antiBot = FTPAntiBot(0x88C4dEDd24DC99f5C9b308aC25DA34889A5073Ab);           // AntiBot address for KOVAN TEST NET (its ok to leave this in mainnet push as long as you reassign it with external function)
        AntiBot = _antiBot;
...
// ####################
    ...
    function _swapTokensForETH(uint256 _amount) private lockTheSwap {                           // If you want to do something like add taxes to Liquidity, change the logic in this block
        ...
        //_path[1] = m_UniswapV2Router.address(0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48);
        _path[1] =address(0xb7a4F3E9097C08dA09517b5aB877F7a917224ede);
...
// ######################
    ...
    function addLiquidity() external onlyOwner() {
        ...
        //m_UniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.address(0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48));
        m_UniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xb7a4F3E9097C08dA09517b5aB877F7a917224ede));
