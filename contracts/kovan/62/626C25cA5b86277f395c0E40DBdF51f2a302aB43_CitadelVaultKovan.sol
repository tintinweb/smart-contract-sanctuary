...
contract CitadelVaultKovan is ERC20("DAO Vault Citadel", "daoCDV"), Ownable, BaseRelayRecipient {
    ...
    function getAllPoolInUSD() public view returns (uint256) {
        uint256 _currentETHprice = _getPriceFromChainlink(0x0bF499444525a23E7Bb61997539725cA2e928138); // USDT/ETH
        uint256 _currentUSDprice = _getPriceFromChainlink(0x9326BFA02ADD2366b30bacB125260Af641031331); // ETH/USD
    ...
    function getAllPoolInETH(uint256 _price) public view returns (uint256) {
        ...
        uint256 _vaultPoolInETH = _vaultPoolInUSD.mul(_price);
    ...
    function _determineETHPrice(uint256 _tokenIndex) private view returns (uint256) {
        ...
        if (address(Tokens[_tokenIndex].token) == 0x07de306FF27a2B630B1141956844eB1552B956B5) { // USDT
            _priceFeedContract = 0x0bF499444525a23E7Bb61997539725cA2e928138; // USDT/ETH
        } else if (address(Tokens[_tokenIndex].token) == 0xb7a4F3E9097C08dA09517b5aB877F7a917224ede) { // USDC
            _priceFeedContract = 0x64EaC61A2DFda2c3Fa04eED49AA33D021AeC8838; // USDC/ETH
        } else { // DAI
            _priceFeedContract = 0x777A68032a88E5A84678A77Af2CD65A7b3c0775a; // DAI/ETH
        }
