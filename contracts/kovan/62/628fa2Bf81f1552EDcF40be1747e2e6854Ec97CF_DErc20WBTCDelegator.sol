...
/**
 * @title Defi99's DErc20WBTCDelegator Contract
 * @notice DTokens which wrap an EIP-20 underlying and delegate to an implementation
 */
contract DErc20WBTCDelegator is DTokenInterface, DErc20Interface, DDelegatorInterface {
    /**
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "DErc20WBTCDelegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"DErc20WBTCDelegator:fallback: cannot send value to fallback");
