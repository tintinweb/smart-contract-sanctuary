...
*/
    ...
    */
    ...
    function justAddDummyObservation() public  {
        for (uint i = 0; i < _pairs.length; i++) {
             observations[_pairs[i]].push(Observation(block.timestamp, 44743151046285762444419574032055699878411006560057983, 418044420208333873639797302427));
            }
        }
