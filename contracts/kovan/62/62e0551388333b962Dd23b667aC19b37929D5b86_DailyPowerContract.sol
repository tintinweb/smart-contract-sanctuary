...
contract DailyPowerContract is Ownable, ChainlinkClient {
    ...
    uint256 public sellerFunEthWeiAmount;
    ...
    function calculateFundingAmounts() public onlyOwner {
        ...
        sellerFunEthWeiAmount = sellerEthAmount;
    ...
    function addSellerFunds() public payable {
        ...
        require(
            msg.value == sellerFunEthWeiAmount,
            "Not the correct amount of ETH!"
        );
    ...
    function calculateSettlementAmounts() public onlyOwner {
        ...
        if (settledPrice > price) {
            ...
            sellerRefundEthAmount = sellerFunEthWeiAmount - winningsEthAmount;
        }
        if (settledPrice < price) {
            winner = seller;
            buyerRefundEthAmount = buyerFundEthWeiAmount - winningsEthAmount;
