...
contract DelayInsurance is ChainlinkClient, KeeperCompatibleInterface {
    ...
    function requestData() public {
      Chainlink.Request memory request = buildChainlinkRequest(stringToBytes32("050fe78dcc334875a74e919b095c96f9"), address(this), this.receiveWeatherData.selector);

      request.add("uuid", "b8625b67-7142-cfd1-7b85-595cebfe4191");
      // Sends the request
      bytes32 requestId = sendChainlinkRequestTo(weatherOracle, request, weatherFee);
    }
    uint256 gust;
    function receiveData(bytes32 _requestId, uint256 _gust) public recordChainlinkFulfillment(_requestId) {
        gust =  _gust;
      }
