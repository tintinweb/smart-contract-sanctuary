...
contract StakeWarInternals {
    ...
    constructor(
        ...
        rarity = determineRarity(_rarityValue, _SEED2);
        class[0] = determineClass(_rarityValue, _SEED2);
        land[0] = determineLand(_rarityValue, _SEED2);
    }
...
contract StakeWarsV1 is ERC721Enumerable, Administerable, VRFConsumerBase {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness)
        ...
        override
    {
        address sender = requestIdToUser[requestId];
        caught = true;
        ...
        // tokenIdToStakeWarrior[tokenId] = warrior;
