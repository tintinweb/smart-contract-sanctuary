...
import "contracts/protocol/futures/futureWallets/HybridFutureWallet.sol";

/**
 * @title Contract for Custom Future Wallet
 * @notice Handles the future wallet mechanisms for the Custom platform
 * @dev Implement directly the stream future wallet abstraction as it fits the cToken IBT
 */
contract CustomFutureWallet is HybridFutureWallet {
