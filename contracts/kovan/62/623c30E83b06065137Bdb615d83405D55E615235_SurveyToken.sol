...
contract SurveyToken is ERC20, VRFConsumerBase {
    ...
    enum ContractState {                                        // The different states the contract might be in chronological order
        ...
        PAYOUT,                                                     // Winners may claim their prices
        FINISHED }                                                  // Winners may still claim prices, contract can be deleted (optionally)
    ...
    // Oracle configuration: Network: >>Kovan<<
    address private coordinatorAddress = 0xdD3782915140c8f3b190B5D67eAc6dc5760C46E9;                // Chainlink VRF Coordinator address
    address private linkTokenAddress = 0xa36085F69e2889c224210F603D836748e7dC0088;                  // LINK token address
    bytes32 internal keyHash = 0x6c3699283bda56ad74f6b855546325b68d482e983852a7a82979cc4807b641f4;  // Key Hash
    uint256 internal fee = 0.1 * 10 ** 18;                                                          // 0.1 LINK (Kovan only)
    ...
    constructor(string memory _tokenName, string memory _tokenSymbol) 
        ...
        VRFConsumerBase(
            coordinatorAddress, // VRF Coordinator
    ...
    */
     ...
     * price expires
     **/
    function startSurvey(uint256 surveyDurationSeconds, uint256 payoutPeriodSeconds, uint256[] memory pricesInGwei) public onlyOwner{
