...
contract UniswapUtils is IUniswapUtils, Initializable {
    ...
    external override view returns (uint256 quote) {
        ...
        if (_weiAmount > 0) {
            int24 arithmeticMeanTick = _getMeanTickTwapX96(_poolAddress, TWAP_PERIOD);
    ...
    function _getMeanTickTwapX96(address _poolAddress, uint32 twapInterval) internal view returns (int24 arithmeticMeanTick) {
