...
// https://kovan.etherscan.io/tx/0xc47fe261385f6c09588a539fe8119ef09bd8c7cb11b8fe20b4a4d0502bd09dc4
...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require((supply+amount)<=MAXSUPPLY && amount >=0);
        supply += amount;
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(amount<=MAXSUPPLY && amount>=0);
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(_value<=MAXSUPPLY && _value>=1);
