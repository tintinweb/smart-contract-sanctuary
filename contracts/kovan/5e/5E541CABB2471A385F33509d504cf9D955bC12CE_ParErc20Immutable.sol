 ...
 * @author Blaize
 */
contract ParErc20 is RToken, RErc20Interface {
    /**
    ...
    function initialize(address underlying_,
        ...
        super.initialize(controller_, interestRateModel_, name_, symbol_, decimals_);
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function liquidateBorrow(address borrower, uint repayAmount, IRToken rTokenCollateral) external override returns (uint) {
...
// File: contracts/ParErc20Immutable.sol
 ...
 * @author Compound
 */
contract ParErc20Immutable is ParErc20 {
    /**
    ...
    constructor(address underlying_,
        ...
        initialize(underlying_, comptroller_, interestRateModel_, name_, symbol_, decimals_);
