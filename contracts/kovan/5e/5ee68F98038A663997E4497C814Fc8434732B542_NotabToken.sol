 ...
 */
contract ERC20 is Context, INotabToken {
...
/**
 * @title ERC20 Token for NotabToken.
 * Is a Standard ERC20 token.
 *
 * Access is extended from the AccessControl
 * abstract contract.
 */
contract NotabToken is ERC20Pausable, AccessControl {
    ...
    function pause() public {
        require(hasRole(PAUSER_ROLE, _msgSender()) ||  hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Caller is not a pauser");
        _pause();
    }
