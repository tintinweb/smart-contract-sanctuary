...
contract APIConsumer is ChainlinkClient, Ownable {
    ...
    uint256 public regularMarketPrice;
        ...
        onlyOwner
    {
        ...
        req.add("get", "https://query2.finance.yahoo.com/v10/finance/quoteSummary/tsla?modules=price");
        req.add("path", "quoteSummary.result[0].price.regularMarketPrice.raw");
    ...
    function fulfillEthereumPrice(
        bytes32 _requestId,
        uint256 _regularMarketPrice
    ) public recordChainlinkFulfillment(_requestId) {
        emit RequestEthereumPriceFulfilled(_requestId, _regularMarketPrice);
        regularMarketPrice = _regularMarketPrice;
    }
