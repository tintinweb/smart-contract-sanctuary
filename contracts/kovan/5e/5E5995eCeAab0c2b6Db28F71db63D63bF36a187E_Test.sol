...
interface MyContract {
    ...
    function deposit(address pool,address _erc20Contract, address user, uint256 _amount) external returns (bool success);
...
contract Test is MyContract {
   ...
   function deposit(address pool,address _erc20Contract, address user, uint256 _amount) override public returns(bool success){
       ILendingPool(pool).deposit(_erc20Contract, _amount, user, 0);
       return true;
   }
