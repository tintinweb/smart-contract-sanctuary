...
contract KeeperRebase is ChainlinkClient, Ownable {

    using Chainlink for Chainlink.Request;

    uint256 private constant fee = 0.1 * 10 ** 18;
    bytes32 private constant jobId = bytes32("0dccf381bb00449c83aeceb0f7f0fdf7");

    event RebasePerformed(uint256 price);
    ...
    function initiateRebase() external {
        Chainlink.Request memory req = buildChainlinkRequest(jobId, address(this), this.rebaseCallback.selector);
