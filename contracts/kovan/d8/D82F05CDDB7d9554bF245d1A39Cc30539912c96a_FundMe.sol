...
contract FundMe {
    ...
    function fund() public payable {
        uint256 minimumUSD = 50; //50 * 10**18;
        require(
            EthereumToUSD(msg.value) >=
                EthereumToUSD(USDToEthereum(minimumUSD)),
    ...
    function USDToEthereum(uint256 _usdAmount) public view returns (uint256) {
        uint256 usdAmount = _usdAmount * 10**8; // getprice() has 8 digit by own
