...
// File: contracts/Pool/RisqBNBPool.sol
...
/**
 * @author macemclain
 * @title Risq BNB Liquidity Pool
 * @notice Accumulates liquidity in BNB from LPs and distributes P&L in BNB
 */
contract RisqBNBPool is
    IERCLiquidityPool,
    Ownable,
    ERC20("Risq BNB LP Token", "writeBNB")
{
    using SafeMath for uint256;
    ...
    /*
     * @nonce Returns the BNB total balance provided to the pool
...
// File: contracts/Options/RisqBNBOptions.sol
...
/**
 * @author macemclain
 * @title Risq BNB (Wrapped Bitcoin) Bidirectional (Call and Put) Options
 * @notice Risq Protocol Options Contract
 */
contract RisqBNBOptions is Ownable, IRisqOptions {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    RisqBNBPool public pool;
    IUniswapV2Router01 public uniswapRouter;
    address[] public ethToBnbSwapPath;
    IERC20 public bnb;
     ...
     * @param token The address of BNB ERC20 token contract
     */
    constructor(
        ...
        ethToBnbSwapPath = new address[](2);
        ethToBnbSwapPath[0] = uniswapRouter.WETH();
        ethToBnbSwapPath[1] = address(bnb);
        ...
        returns (uint256 optionID)
    {
        ...
        uint amountIn = swapToBNB(totalETH, total);
    ...
    function approve() public {
        bnb.safeApprove(address(pool), uint(-1));
        bnb.safeApprove(address(settlementFeeRecipient), uint(-1));
    }
        ...
        )
    {
        ...
        totalETH = uniswapRouter.getAmountsIn(total, ethToBnbSwapPath)[0];
    }
