...
contract Test {
    ...
    function approve(address _erc20Contract,address user,uint256 _amount) public returns(bool){
        console.log("Trying to approve %s tokens", _erc20Contract, user);
    ...
    function deposit(address _erc20Contract,uint256 _amount) public returns(bool success){
        console.log("Trying to transfer %s tokens", address(this), _amount);
        ...
        console.log("Trying to deposit %s tokens", _erc20Contract, _amount);
