...
contract PHROToken is ERC20Burnable, Ownable, ReentrancyGuard, AccessControl {
    ...
    */
    ...
    uint256 public constant _TIMELOCK_YEAR = 31536000; // 1 year in seconds
    uint256 public constant _TIMELOCK_6MONTHS = _TIMELOCK_YEAR / 2; // 6 months in seconds
    ...
    address public constant TreasuryAddress = 0x3f15B8c6F9939879Cb030D6dd935348E57109637;
        ...
        ReentrancyGuard()
    {
        ...
        _mint(0x3f15B8c6F9939879Cb030D6dd935348E57109637, 10000000 ether);
        ...
        // Sean CEO - 60,000,000
        // _mint(0x..., 60000000 ether);
        // Bliss Developer - 5,000,000
        // _mint(0x..., 5000000 ether);
        // The rest of the team tokns to be given at a later time
        // _mint(0x..., 75000000 ether);
