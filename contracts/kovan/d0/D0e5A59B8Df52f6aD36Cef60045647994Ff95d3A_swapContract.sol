...
contract swapContract is AccessControlEnumerable, Pausable, ECDSAOffsetRecovery
{
    ...
    mapping(address => uint256 [3]) public xdceSwapLimits;

    uint128 [3] xdceSwapRatios = [1, 3, 5];
    ...
    ) external whenNotPaused
    {
        ...
        (uint256[3] memory xdceSwapLimitsNew, uint256 xdceAmountNew, uint256 xdcAmountNew) = calculateXdcAmount(xdceSwapLimits[sender], xdceAmount);
