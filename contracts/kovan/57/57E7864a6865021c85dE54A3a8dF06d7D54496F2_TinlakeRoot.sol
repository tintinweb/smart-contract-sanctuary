...
contract TinlakeRoot is Auth {
    ...
    function deploy() public {
        ...
        DependLike_4(lenderDeployer.assessor()).depend("navFeed", navFeed);
        ...
        if (wireAdapter) {
            AuthLike_4(adapterDeployer.mgr()).rely(address(adapterDeployer));
            adapterDeployer.wireAdapter();
            AuthLike_4(adapterDeployer.mgr()).deny(address(adapterDeployer));   
        }
    }
