...
import './structer/functions.sol';
import './structer/dto.sol';
import './structer/input.sol';

contract TSC is TerminateContractTemplate, FunctionStructer, InputStructer, DtoStructer {
    string public title;
