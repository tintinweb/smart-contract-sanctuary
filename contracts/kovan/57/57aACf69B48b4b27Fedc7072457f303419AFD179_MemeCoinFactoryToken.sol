...
contract MemeCoinFactoryToken is Context,IERC20, Ownable{
    ...
    string private _name = "Memecoin Factory";
    string private _symbol = "FACTORY";
    ...
    uint256 private _totalSupply = 500000 * 10**4 * 10**9; //5B supply
    uint256 public requiredTokensToSwap = currentThreshold * 10 ** 5 * 10 ** 9; //threshold of around 1000000 0.02% tokens 
    ...
    function currentliqFee() public view returns (uint256){
            return liqFee;
    }
    function currentmktfee() public view returns (uint256){
            return mktFee;
    }
    function currentprizepoolfee() public view returns (uint256){
            return prizePool;
    }
