...
contract CoreOrchestrator is Ownable {
    ...
    function initPCVDepositUSDC() public onlyOwner() {
        (int24 usdcTickLower, int24 usdcTickUpper) = rusd < USDC ? (-276830, -275830) : (int24(275810), int24(276810));
    ...
    function initPCVDepositUSDT() public onlyOwner() {
        (int24 usdtTickLower, int24 usdtTickUpper) = rusd < USDT ? (-276830, -275830) : (int24(275810), int24(276810));
