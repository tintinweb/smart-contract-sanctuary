...
contract HedgeyCallsV2 is ReentrancyGuard {
    ...
    address payable public weth = 0xd0A1E359811322d97991E03f863a0C30C2cF029C; //kovan weth 
    uint public fee;
    address payable public feeCollector;
    bool public feeCollectorSet;
    uint public c = 0;
    address public uniFactory = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f; //kovan swap factory
