...
// File @openzeppelin/contracts-upgradeable/utils/ContextUpgradeable[email protected]
        ...
        if(escrowedandlockedAmount > 0) {
            ...
            if(keepLocked == false) {
                if(_amount > escrowedandlockedAmount) {
                    ...
                    portal().onlyExitAccountEscrowedLockedAmount(receiver, escrowedandlockedAmount);
                ...
                if(_amount <= escrowedandlockedAmount) {
                    ...
                    portal().onlyExitAccountEscrowedLockedAmount(receiver, _amount);
                }
            }
        }
