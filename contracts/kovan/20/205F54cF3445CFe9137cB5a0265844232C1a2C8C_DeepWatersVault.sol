...
contract DeepWatersVault is IDeepWatersVault, Ownable {
    ...
    **/
    ...
    /**
    * @dev gets scarcity ratio of the asset (in percents and with 18 decimals).
    ...
    **/
    ...
    /**
    * @dev gets variable interest rate of the asset (in percents and with 18 decimals).
    ...
    **/
    ...
    /**
    * @dev gets current stable interest rate of the asset (in percents and with 18 decimals).
    ...
    **/
    ...
    /**
    * @dev gets liquidity rate of the asset (in percents and with 18 decimals).
    ...
    **/
    ...
    /**
    * @dev gets calculated cumulated liquidity index of the asset (in percents and with 18 decimals).
    * @param _asset the address of the asset
    ...
    **/
    ...
    /**
    * @dev gets last stored cumulated liquidity index of the asset (in percents and with 18 decimals).
    * @param _asset the address of the asset
    ...
    **/
    ...
    /**
    * @dev gets last stored timestamp of last update of the cumulated liquidity index of the asset
    ...
    **/
    ...
    /**
    * @dev updates cumulated liquidity index of the asset
    * @param _asset the address of the asset
    **/
    ...
    /**
    * @dev sets cumulated liquidity index of the asset
    * @param _asset the address of the asset
    **/
    ...
    /**
    * @dev updates user cumulated liquidity index of the asset
    * @param _asset the address of the asset
    ...
    **/
    ...
    /**
    * @dev sets user cumulated liquidity index of the asset
    * @param _asset the address of the asset
    * @param _user the user address
    **/
    ...
    /**
    * @dev gets user cumulated liquidity index of the asset (in percents and with 18 decimals)
    * @param _asset the asset address
    * @param _user the user address
    ...
    **/
    ...
    /**
    * @dev gets timestamp last update of the user cumulated liquidity index of the asset
    * @param _asset the asset address
    * @param _user the user address
    ...
    **/
    ...
    /**
    * @dev sets scarcity ratio target of the asset
    * @param _asset the address of the asset
    **/
    ...
    /**
    * @dev sets base interest rate of the asset
    * @param _asset the address of the asset
    **/
    ...
    /**
    * @dev sets interest rate growth factor of the asset
    * @param _asset the address of the asset
    **/
    ...
    /**
    * @dev sets large interest rate growth factor of the asset
    * @param _asset the address of the asset
    **/
