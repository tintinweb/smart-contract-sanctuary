...
interface IDeepWatersLending {
    ...
    function afterTransferDToken(address _asset, address _fromUser, address _toUser) external;
}
...
contract DeepWatersVault is IDeepWatersVault, Ownable {
        ...
        if (userDebt.borrowBalance > 0) {
            ...
            updateBorrowBalance(
                ...
                usersDebts[_asset][liquidator].borrowBalance.
                    add(userDebt.borrowBalance).
                    add(getUserBorrowCurrentLinearInterest(_asset, _user))
            );
    ...
    **/
    function updateBorrowBalance(address _asset, address _user, uint256 _newBorrowBalance) public {
        require(
            msg.sender == lendingContractAddress || msg.sender == address(this),
