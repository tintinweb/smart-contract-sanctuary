...
contract Consts {
    ...
    string public constant TOKEN_NAME = "LEEWAY TOKEN";
    string public constant TOKEN_SYMBOL = "LEWT";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x7A2D87F5DB7B0825264CC6329D95FD660952DEc7;
    
    uint public constant START_TIME = 1624984207;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(1 * TOKEN_DECIMAL_MULTIPLIER, 0x7A2D87F5DB7B0825264CC6329D95FD660952DEc7, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1625041800)
        CappedCrowdsale(200000000000000000000)
