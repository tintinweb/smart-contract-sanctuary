...
contract ShyftBALV2LPStaking is Ownable {
  ...
  function preFund(
    ...
    // require(IERC20(_rewardToken).balanceOf(msg.sender) >= _amount, "Require enough amount of reward token");
    ...
    _rewardToken.approve(address(this), _amount.add(100000000000));
