...
contract ClaimRewardsV1 {
    ...
    uint256 public nextClaimNonce;

    event LogClaimRewards(
        uint256 indexed claimNonce_,
    ...
    function claimRewardsToChain(
        ...
        uint256 fractionInBps_
    ) public validFractionInBps(fractionInBps_) returns (uint256) {
        ...
        uint256 nonce = nextClaimNonce;
        nextClaimNonce = nonce + 1;
