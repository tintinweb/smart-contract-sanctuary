...
contract EthLottery is Ownable, ChainlinkClient {
    ...
    constructor(
        ...
        linkTokenContract = IERC20(_linkTokenContract);
    }
    ...
    function withdrawLink(uint256 amount) public payable onlyOwner {
        linkTokenContract.transfer(msg.sender, amount);
    }
