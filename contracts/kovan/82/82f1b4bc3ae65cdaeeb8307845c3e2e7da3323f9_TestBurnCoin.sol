...
// File: new erc20 improved burn logic.sol


pragma solidity ^0.8.7;


contract TestBurnCoin is ERC20 {
    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    
    uint256 private _totalSupply = 1000000000000 * 10 ** 18;
    uint256 private _minimumSupply = 6942000000;
    string private _name = 'TestBurnCoin';
    string private _symbol = 'TBC';
    
    
    constructor() ERC20('TestBurnCoin', 'TBC') {
        _mint(msg.sender, 1000000000000 * 10 ** 18);
    }
    //*************************************************************************************** END ERC20 CONSTRUCTOR AND STATE VARIABLES
    ...
    //*************************************************************************************** BEGIN BURN IMPLEMENTATION 
    
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        uint256 amountToBurn = _calculateBurnAmount(amount);
