...
contract Fauceth {
    uint    public constant fr   = 3;         // Fee Rate 0.3%
    uint    public constant frb  = 1000;      // Fee Rate Base

    address public constant _vsdc             = 0xFe6DD18AC92a69bE78C189DFD6c41Bf381069891;
