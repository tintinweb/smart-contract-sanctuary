...
contract SolipayConsumer is ChainlinkClient {
     ...
     * @param _wallet the Solipay address.
     ...
     * @param _isValid whether the address' most visited country was in the list of country codes.
     * @param _message the reason behind the API resolution.
     */
    function fulfillRequestMostVisitedLocation(
        bytes32 _requestId,
        bool _isValid,
        string memory _message
    ) public recordChainlinkFulfillment(_requestId) {
        requestIdContainsMostVisitedLocation[_requestId].isValid = _isValid;
        requestIdContainsMostVisitedLocation[_requestId].message = _message;
    }
