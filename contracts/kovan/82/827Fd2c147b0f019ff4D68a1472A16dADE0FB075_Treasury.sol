...
contract Treasury is DexCaller, Adminable {
    ...
    // total available balance to share
    uint public totalToShare;
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            totalToShare = totalToShare.sub(reward);
