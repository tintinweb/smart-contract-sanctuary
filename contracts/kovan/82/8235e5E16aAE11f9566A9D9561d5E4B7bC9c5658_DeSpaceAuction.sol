...
contract DeSpaceAuction is ERC721Holder, Ownable {
    ...
    function bidWithEther(
        ...
        if(auction.bidCount == 0) { 
            ...
            uint amount = _nextBidAmount(_token, _tokenId);
            require(
                msg.value == amount, 
    ...
    function bidWithToken(
        ...
        require(
            _bidAmount > 0, 
            "Error: must bid with a compliant token"
        );
        require(
            ...
            "Error: must input the value from nextBidAmountToken"
    ...
    function getAuction(
        ...
        return auctions[_token][_tokenId];
    }
    ...
    function _nextBidAmount(
        ...
        if (
            ...
            else return ((current * 10000) / DIVISOR);
        }
        return 0;
    }
