...
contract NewPrecog {
    ...
    function payAllDebtsAndBalanceLiquidity() public {
        ...
        if(totalCurrentSupply * 100 / totalSupply < 10) {
            totalAmountPay = totalDebtsAmount + (totalSupply * (10 * totalSupply - totalCurrentSupply * 100 / totalSupply) / 100);
        }
        else {
            totalAmountPay = totalDebtsAmount - (totalSupply * (totalCurrentSupply * 100 - 10 * totalSupply / totalSupply) / 100);
        }
