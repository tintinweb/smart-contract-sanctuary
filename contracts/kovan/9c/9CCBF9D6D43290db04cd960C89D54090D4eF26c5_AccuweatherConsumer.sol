...
contract AccuweatherConsumer is ChainlinkClient {
    ...
    mapping(address => LocationResult) public requestIdLocationResult;
    mapping(address => RequestParams) public requestIdRequestParams;
    ...
    function requestLocation(
        ...
        storeRequestParams(address(this), 0, "location", _lat, _lon, "");
    }
    ...
    function requestCurrentConditions(
        ...
        // Below this line is just an example of usage
        storeRequestParams(address(this), _locationKey, "current-conditions", "0", "0", _units);
    }
    ...
    function requestLocationCurrentConditions(
        ...
        // Below this line is just an example of usage
        storeRequestParams(address(this), 0, "location-current-conditions", _lat, _lon, _units);
    }
    ...
    function storeLocationResult(bytes32 _requestId, bytes memory _locationResult) private {
        ...
        requestIdLocationResult[address(this)] = result;
    }
