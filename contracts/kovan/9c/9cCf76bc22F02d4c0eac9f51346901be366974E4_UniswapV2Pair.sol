...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function _getBalance(address _token) private view returns (uint256 balance) {
    ...
    function burn(address to) external lock returns (uint256 amount0, uint256 amount1) {
        ...
        uint256 balance0 = _getBalance(_token0);
        uint256 balance1 = _getBalance(_token1);
    ...
    function swap(
        ...
        require(amount0In > 0 || amount1In > 0, 'UniswapV2: INSUFFICIENT_INPUT_AMOUNT');
        {
            ...
            uint256 feeRate = IUniswapV2Router02(router).feeRate();
            uint256 balance0Adjusted = balance0.mul(10000).sub(amount0In.mul(feeRate));
            uint256 balance1Adjusted = balance1.mul(10000).sub(amount1In.mul(feeRate));
            require(
