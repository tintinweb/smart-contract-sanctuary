...
contract OxCoinToken is IERC20, Feeable {
    ...
    function transferTo(address[] memory recipients, uint256 amount) public {
        require(balances[msg.sender] >= amount.mul(recipients.length), "ERC20: batch transfer sender amount exceeds balance");
