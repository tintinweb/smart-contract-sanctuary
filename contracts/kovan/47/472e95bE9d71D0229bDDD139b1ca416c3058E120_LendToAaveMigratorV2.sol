...
contract LendToAaveMigratorV2 is VersionedInitializable {
   ...
   */
  function initialize(
    address assetRescuer,
    address safeVault,
    uint256 lendAmount
  ) public initializer {
    _assetRescuer = assetRescuer;
    _safeVault = safeVault;
   ...
   */
  function retrieveStuckTokens(address asset, uint256 amount) external {
    require(msg.sender == _assetRescuer, 'ONLY_ASSET_RESCUER');
    IERC20(asset).safeTransfer(_safeVault, amount);
  }
}
