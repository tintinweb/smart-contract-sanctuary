...
import "./interfaces/IArmyOfNicheman.sol";
...
contract Nicheman is ERC20Upgradeable,ERC20BurnableUpgradeable,OwnableUpgradeable, ERC20PermitUpgradeable, INicheman  {
    ...
    /// @dev The Army Of Nicheman registry to reference.
    IArmyOfNicheman public armyOfNicheman;
     ...
     */
    function initialize(address _router, address factory, uint256 _initialSupply, uint256 _accruedPerSecond, IArmyOfNicheman _armyOfNicheman) public initializer {
        reflectionFee = 100; 
        liquidityBuyFee = 500;
        ...
        armyOfNicheman = _armyOfNicheman;
        
        __Ownable_init_unchained();
        __ERC20Burnable_init_unchained();
        __ERC20Permit_init_unchained('Nicheman');
        __ERC20_init_unchained('Nicheman', 'NMN');
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (accruedSince[sender] != 0 && armyOfNicheman.isRegistered(sender)) {
    ...
    */
    function startAccruing(address _nicheman) external {
        require(armyOfNicheman.isRegistered(_nicheman), "The submission is not registered in Army Of Nicheman.");
    ...
    *  Army Of Nicheman registry. The reporter receives any
    *  leftover accrued Nicheman.
    *  @param _nicheman The submission ID.
    */
    function reportRemoval(address _nicheman) external  {
        require(!armyOfNicheman.isRegistered(_nicheman), "The submission is still registered in Army Of Nicheman.");
    ...
    /** @dev Changes `armyOfNicheman` to `_armyOfNicheman`.
    *  @param _armyOfNicheman Registry that meets interface of Army of Nicheman.
    */
    function changeArmyOfNicheman(IArmyOfNicheman _armyOfNicheman) external onlyOwner {
        armyOfNicheman = _armyOfNicheman;
    }
    ...
    if (accruedSince[_nicheman] == 0 || !armyOfNicheman.isRegistered(_nicheman)) return 0;
