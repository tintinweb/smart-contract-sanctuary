...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "CRYPTOPHOENIX";
     ...
     * See: `Liquifier`
     */
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY; // There is no fees collected to the contract therefore this will never be used
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    // Uniswap V2
    address private _mainnetRouterV3Address = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // Testnet
    ...
    function initializeLiquiditySwapper(Env env, uint256 maxTx, uint256 liquifyAmount) internal {
        ...
        else if (_env == Env.MainnetV3){ _setRouterAddress(_mainnetRouterV3Address); }
...
abstract contract PhoenixAbstract is BaseRfiToken, Liquifier, Antiwhale {
...
contract CRYPTOPHOENIX is PhoenixAbstract{
    ...
    constructor() PhoenixAbstract(Env.Testnet){
