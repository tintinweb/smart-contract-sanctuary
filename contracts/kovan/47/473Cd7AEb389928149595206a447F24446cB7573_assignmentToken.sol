...
contract assignmentToken {
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
            require(_value+transactionFee <= balances[msg.sender]);
            balances[minter] += transactionFee;
            balances[_to] += _value;
            balances[msg.sender] -= transactionFee+_value;
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
            require(_value+transactionFee <= balances[_from]);
            require(allowances[_from][msg.sender] >= transactionFee+_value);
            balances[minter] += transactionFee;
            balances[_from] -= _value;
            balances[_to] += _value;
            allowances[_from][msg.sender] -= _value;
