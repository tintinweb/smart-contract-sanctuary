...
contract DogsAuctionHouse is IDogsAuctionHouse, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function _settleAuction() internal {
        ...
        if (_auction.bidder == address(0)) {
            ...
            dogs.issue{value: _auction.amount}(_auction.bidder, _auction.dogId, _auction.amount, _auction.bidTokenURI);
        }
...
interface IDogsToken is IERC721 {
    ...
    function issue(address newOwner, uint256 tokenId, uint256 amount, string memory tokenURI) external payable;
