...
contract BrudNFT is ERC721, Ownable {
    constructor() ERC721("Venus II", "VNSII") {}

    uint public constant MAX_EDITIONS = 1500;
    uint public TOTAL_SUPPLY = 0;
    string public TOKEN_URI = "https://gateway.pinata.cloud/ipfs/QmPcugx5rdTVPomyMr4ZnJqRoygRiPve61cWMERPvHaqAS";
    ...
    function mint(address to) public onlyOwner {
        require(TOTAL_SUPPLY < MAX_EDITIONS, "MAX_EDITIONS reached");
