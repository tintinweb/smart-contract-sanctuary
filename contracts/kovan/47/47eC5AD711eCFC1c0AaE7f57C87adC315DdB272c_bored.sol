...
contract bored is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x4dEE921Cd0b09C4420Ce406A0741424E63EE623a); // Marketing Address
    ...
    string private _name = '\xc6\x81\xe2\xac\xa4\xc6\xa6\xe2\x91\xa2\xc6\x89';
    string private _symbol = "BoredBuyBack";
    ...
    uint256 private minimumTokensBeforeSwap = 200000000000 * 10**9; 
    uint256 public buyBackSellLimit = 1 * 10**18;
