...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 public BSKTASREWARD = IERC20(0x830b5aEd18C1a26Cd7DE2D3b9137f2AF725207E2);  // Approve and Transfer for Stake and Withdraw
...
contract BsktLPPool is LPTokenWrapper {
    IERC20 public STAKEBSKT = IERC20(0x830b5aEd18C1a26Cd7DE2D3b9137f2AF725207E2); // BSKT TOKEN ADDRESS
    ...
    // permit to extend pool reward once current active pool completed.
    function permitNotifyReward() public view returns (bool) {    
    ...
    function notifyRewardRate(uint256 _reward) public updateReward(address(0)) onlyOwner{
        ...
        require(permitNotifyReward() || !firstNotify, "Error : You can only nofify once current duration complete.");
    ...
    function setDuration(uint256 _duration) public onlyOwner {
        require(permitNotifyReward(), "Error : Able to set duration once current duration complete.");
        duration = _duration;   
    }
