...
contract RICH is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6 * 10**5 * 10**7;
    ...
    uint256 private _maxTxAmount = 50000e8;
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 1500e8 , 'maxTxAmount should be greater than 1500e8');
