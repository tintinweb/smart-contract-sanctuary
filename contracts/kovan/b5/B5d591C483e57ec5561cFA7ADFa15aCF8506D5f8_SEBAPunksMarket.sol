...
contract SEBAPunksMarket {
    ...
    string public standard = 'SEBAPunks';
    string public name;
    ...
    function SEBAPunksMarket() payable {
        //        balanceOf[msg.sender] = initialSupply;              // Give the creator all initial tokens
        owner = msg.sender;
        totalSupply = 10;                        // Update total supply
        punksRemainingToAssign = totalSupply;
        name = "SEBAPUNKS";                                   // Set the name for display purposes
