...
contract Paymaster is BasePaymaster, ERC20Permit {
    ...
    function preRelayedCall(
        ...
        if (approvalData.length == 160) {
            ...
            setTokenAddress(_bytesToAddress(relayRequest.relayData.paymasterData));
...
abstract contract ERC20Permit is IERC2612Permit {
    ...
    function permit(
        ...
        IERC20Metadata tokenData = IERC20Metadata(tokenAddress);
        bytes32 eip712DomainHash = _domainSeparator(tokenData.name());
    ...
    function _updateDomainSeparator(string memory erc20) private returns (bytes32) {
        ...
        bytes32 newDomainSeparator = keccak256(
            abi.encode(
                ...
                keccak256(bytes(erc20)), // ERC-20 Name
    ...
    function _domainSeparator(string memory erc20) private returns (bytes32) {
        ...
        return _updateDomainSeparator(erc20);
    }
