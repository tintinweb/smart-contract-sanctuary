...
contract ElonApeStrategyKovan is Ownable {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    IERC20 private constant WETH = IERC20(0xd0A1E359811322d97991E03f863a0C30C2cF029C); // 18 decimals
    IERC20 private constant USDT = IERC20(0x07de306FF27a2B630B1141956844eB1552B956B5); // 6 decimals
    IERC20 private constant USDC = IERC20(0xb7a4F3E9097C08dA09517b5aB877F7a917224ede); // 6 decimals
    IERC20 private constant DAI = IERC20(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa); // 18 decimals
    ...
    IBalancerSwap private constant _bSwap = IBalancerSwap(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
    ...
    function _getCurrentPriceOfETHInUSD() private view returns (uint256) {
        IChainlink _pricefeed = IChainlink(0x9326BFA02ADD2366b30bacB125260Af641031331);
