...
contract VOTX_Staking is Ownable {
    ...
    address public constant tokenDepositAddress = 0x9C0E1ff2Bf6F9116533aBb09454De8B97FB03445;
    // token contract address
    address public constant tokenRewardAddress = 0x5999EB3478a1D8f6442766d8E29E01Ef8cCEaf0F;
    
    // reward rate 208.00% per year
    
    uint public rewardRate = 20800;
    ...
    uint public constant unstakeTime = 15 minutes;
    // unstaking possible after 30 days
    uint public constant claimTime = 15 minutes;
    ...
    //foto estatica de los pending + poner en true "ended" (ended impide nuevos depositos)
