...
contract WarriorNFT is Context, IERC721, Ownable {
    ...
    function mint(uint256 amount) external {
        ...
        uint256 executeBackAmount = bloodstoneAmount.mul(20).div(100).div(amount);
        uint256 randNum;
        ...
        for(uint i=0; i<amount; i++) {
            ...
            if (randNum==0&&randNum<5) {
                ...
                warrior = Warrior("FFF", 6, 45000+genRand(5001, randNum), imgs, executeBackAmount);
                ...
                warrior = Warrior("EEE", 5, 4000+genRand(1501, randNum), imgs, executeBackAmount);
                ...
                warrior = Warrior("DDD", 4, 3000+genRand(1000, randNum), imgs, executeBackAmount);
                ...
                warrior = Warrior("CCC", 3, 2000+genRand(1000, randNum), imgs, executeBackAmount);
                ...
                warrior = Warrior("BBB", 2, 1000+genRand(1000, randNum), imgs, executeBackAmount);
            } else {
                string[2] memory imgs = ["QmRXAzXAA8oiuMxe9m8Tdp9oq4tsBXgDjkpNz3Tz5uuRj2", "QmRXAzXAA8oiuMxe9m8Tdp9oq4tsBXgDjkpNz3Tz5uuRj2"];
                warrior = Warrior("AAA", 1, 400+genRand(600, randNum), imgs, executeBackAmount);
            }
