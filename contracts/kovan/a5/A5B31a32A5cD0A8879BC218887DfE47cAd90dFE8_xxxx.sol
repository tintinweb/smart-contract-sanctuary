...
contract xxxx is Context, IERC20, Ownable {
    ...
    function launch(address[] memory presaleWallets, uint256[] memory amounts) external onlyOwner returns (bool){
        ...
        require(presaleWallets.length < 200, "airdrop 200 wals per txn due glimit"); // allows for airdrop + launch at the same exact time, reducing delays and reducing sniper input.
