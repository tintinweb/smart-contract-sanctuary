...
contract assignment {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require(msg.sender == minter, "Beware, sender is not a minter!");
        require(MAXSUPPLY>supply+amount, "The total supply exeeds MAXSUPPLY!");
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(balances[msg.sender] >= amount, "Balance not sufficient for coins to burn :/ ");   
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(_value+1<=balances[msg.sender], "Amount way too large to cover transfer and fees, beware");
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require((_value+1)<=balances[_from], "Sender does not have enough balance");
