...
contract WAVEToken is ERC20, ERC20Burnable, Ownable {
    ...
    function returnAccidentalERC20(address _token, address _to, uint _amount) external onlyOwner() returns(bool success) {
