...
// hevm: flattened sources of /nix/store/07p0c2i79x0cv84yjvg1wbhgn4ixi8hs-dss/dapp/dss/src/flop.sol
...
////// /nix/store/07p0c2i79x0cv84yjvg1wbhgn4ixi8hs-dss/dapp/dss/src/flop.sol
...
contract Flopper is LibNote {
    ...
    VatLike_5  public   vat;  // CDP Engine
    ...
    function dent(uint id, uint lot, uint bid) external note {
        ...
        if (msg.sender != bids[id].guy) {
            ...
            if (bids[id].tic == 0) {
                uint Ash = VowLike_3(bids[id].guy).Ash();
                VowLike_3(bids[id].guy).kiss(min(bid, Ash));
            }
