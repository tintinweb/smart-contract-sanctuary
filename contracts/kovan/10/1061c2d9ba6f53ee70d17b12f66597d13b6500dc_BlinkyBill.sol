...
contract BlinkyBill is Context, IERC20, Ownable {
    ...
    string private _name = "Blinky Bill Finance";
    string private _symbol = "BLINKY";
    ...
    uint256 public _maxTxAmount = 500000000 * 10**18; // 500M
    ...
    uint256 private minTokensBeforeSwap = 100000000000000000000; // 100 tokens
