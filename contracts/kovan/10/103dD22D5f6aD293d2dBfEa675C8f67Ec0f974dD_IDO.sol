...
abstract contract UniRef is IUniRef, OracleRef {
    ...
    uint256 private constant FIXED_POINT_GRANULARITY = 2**192;
        ...
        returns (Decimal.D256 memory)
    {
        ...
        uint256 priceX192 = sqrtPriceX96**2;
        if (oracle.isPrice0()) {
            return Decimal.ratio(priceX192, FIXED_POINT_GRANULARITY);
        } else {
            return Decimal.ratio(FIXED_POINT_GRANULARITY, priceX192);
        }
    }
