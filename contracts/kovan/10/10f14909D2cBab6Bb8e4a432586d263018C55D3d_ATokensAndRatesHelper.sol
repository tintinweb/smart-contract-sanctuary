...
contract LendingPool is VersionedInitializable, ILendingPool, LendingPoolStorage {
  ...
  function addLiquidator(address addr) public onlyLendingPoolConfigurator {
    liquidators[addr] = true;
  }

  function removeLiquidator(address addr) public onlyLendingPoolConfigurator {
    liquidators[addr] = false;
  }
