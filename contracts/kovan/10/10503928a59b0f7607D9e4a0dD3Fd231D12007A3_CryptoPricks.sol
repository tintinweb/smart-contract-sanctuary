...
// File contracts/cpw-successcompiled.sol
...
contract CryptoPricks is ERC721Enumerable, Ownable, ChainlinkClient {
  using Strings for uint256;
  using Chainlink for Chainlink.Request;
  ...
  mapping(uint256 => string) public currentRoundBaseURI;
  ...
  constructor(
    ...
    currentRoundBaseURI[1] = "ipfs://bafybeiecda6kw6ak2ibzmuwzg2hexcpmgd3bx6bqs3pkr6nnqbrmhhvnsy/";
    currentRoundBaseURI[2] = "ipfs://bafybeic3sa6ayue325pt5ov3ektbgd7yohjpwccygpsafhuoc5iluaqwyq/";
    currentRoundBaseURI[3] = "ipfs://bafybeianbl5sfswy5r4rw56l3hs7hmgyhoonbuxuauo6p5jce3hmchhqzq/";
    currentRoundBaseURI[4] = "ipfs://bafybeiexbsblgy7hl52tblibnbbwjkbhxcyxddrtbevokcexvlkm5dta2e/";
    currentRoundBaseURI[5] = "ipfs://bafybeiga4x2xynkeiyz5jz4ef3gvwim7igk6qhkfuqzju2n6nrgyk3qblm/";
    currentRoundBaseURI[6] = "ipfs://bafybeifn5qmba7l7kr4qjctqiecrlb5hthjfucjt35rlpft7otb3eyteku/";
    currentRoundBaseURI[7] = "ipfs://bafybeigvehavavisj7zxkl5evlhouc3vzxhesdqy4ooetrdpkd3pae6574/";

    mint(msg.sender, 20);

    latestDateChecked = _getDateBeforeTimestamp(block.timestamp - 86_400);
  }
  ...
  function requestVolumeData() public returns (bytes32 requestId)
  {
    ...
    // Set the URL to perform the GET request on (_getDateBeforeTimestamp(block.timestamp))
    request.add("get", "https://api.openweathermap.org/data/2.5/onecall/timemachine?lat=36.5&lon=116.9&dt=1635302910&appid=1ca83fabbf7172826cc74938a40bb9ba");
  ...
  */
  function fulfill(bytes32 _requestId, uint256 _volume) public recordChainlinkFulfillment(_requestId)
  {
    volume = _volume;
    if(revealed) {
      latestDateChecked = _getDateBeforeTimestamp(block.timestamp);
      if(volume > 0) {
        round = round + 1;
      }
    }
  ...
  function _getDateBeforeTimestamp(uint256 timestamp)
    private
    pure
    returns (uint256)
  {
    ...
    uint256 dateBeforeTimestamp = timestamp - currentDayTimestamp - secondsInDay;
    return dateBeforeTimestamp;
  }

  // internal
  function _baseURI() internal view virtual override returns (string memory) {
    return currentRoundBaseURI[round];
  }

  // public
  function getLatestDateChecked() public view returns (uint256) {
    return latestDateChecked;
  }
  ...
  function setBaseURI(string memory _newBaseURI) public onlyOwner {
    currentRoundBaseURI[round] = _newBaseURI;
  }

  function setround(uint256 _newround) public onlyOwner {
    round = _newround;
  }
 ...
 function whitelistUser(address _user) public onlyOwner {
    ...
    returns (bool upkeepNeeded, bytes memory performData)
  {
    ...
    block.timestamp - secondsInDay >= latestDateChecked + secondsInDay
        ? upkeepNeeded = true
        : upkeepNeeded = false;
