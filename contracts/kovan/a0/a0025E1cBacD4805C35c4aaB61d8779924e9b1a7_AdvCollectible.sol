...
// File: AdvCollectible.sol

// import "@openzeppelin/contracts/utils/Counters.sol";

contract AdvCollectible is ERC721, VRFConsumerBase {
    ...
    VRFConsumerBase(_vrfCoordinator, _linkToken) ERC721("bandit", "BAN") 
    {
        // could paramterise ERC721 flag as well
        tokenCounter = 0;
        keyhash = _keyhash;
        fee = _fee;
    }
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        // only the owner of the token id can update the uri 
