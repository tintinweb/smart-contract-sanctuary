...
contract Tranche is Math, Auth, FixedPoint {
    ...
    ReserveLike_7 public reserve;
    CoordinatorLike_3 public coordinator;
    ...
    function depend(bytes32 contractName, address addr) public auth {
        ...
        else if (contractName == "reserve") {reserve = ReserveLike_7(addr);}
        else if (contractName == "coordinator") {coordinator = CoordinatorLike_3(addr);}
        else revert();
    }
