...
/**
 * @title Blank Token
 * @dev Blank ERC20 Token
 */
contract BlankToken is ERC20Permit, Ownable {
    uint256 public constant MAX_CAP = 125 * (10**6) * (10**18); // 125 million
    ...
    constructor() ERC20("BlankToken", "BLANK") {
     ...
     * Owner is assumed to be governance or Blank trusted party for helping users
