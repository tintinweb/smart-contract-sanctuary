...
contract LMTerminal is Initializable, OwnableUpgradeable {
    ...
    event ClaimFeeWithdraw(address indexed pool, uint256 amount0, uint256 amount1);
    ...
    function deployIncentivizedPool(
        ...
        require(msg.value == deploymentFee, "Need to send ETH for CLR pool deployment");
        // Deploy CLR
    ...
    function initiateRewardsProgram(
        ...
        clrPool.notifyRewardAmount(rewardAmount);
    ...
    /**
     * @notice set a manager for this contract
     * @notice manager can call any management function apart from this one
     */
    ...
    /**
     * @dev Withdraw function for xToken fees
    ...
    /**
     * Withdraw claim fees for a given CLR pool
     */
