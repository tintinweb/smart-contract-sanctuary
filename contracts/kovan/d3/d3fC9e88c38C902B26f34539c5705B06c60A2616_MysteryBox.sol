    ...
    AccessControlUpgradeable
{
    ...
    mapping(uint256 => Rarity) tokenRarity;
    mapping(uint256 => bool) openedBoxes;
    ...
    event OpenBox(uint256 indexed boxId, uint256 opener, uint256 timestamp);
    ...
    // function cooldownEnd(uint256 _id) public view returns (uint256) {
    //     return SafeMath.add(tokens[_id].createTimestamp, BOX_OPEN_COOLDOWN);
    // }
