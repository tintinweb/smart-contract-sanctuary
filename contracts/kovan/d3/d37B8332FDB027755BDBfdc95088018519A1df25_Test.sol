...
contract Test {
   ...
   function deposit(address _erc20Contract, uint256 _amount) public returns(bool success){
       ...
       IERC20(_erc20Contract).approve(0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe,_amount);
       ILendingPool(0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe).deposit(_erc20Contract, _amount, msg.sender,0);
       return true;
   }
