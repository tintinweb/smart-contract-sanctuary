...
contract CopperProxy is Ownable {
    ...
    event TransferedPoolOwnership(address indexed pool, address currentOwner, address newOwner);
    ...
    event ChangedFeeRecipient(address currentFeeRecipient, address newRecipient);
    ...
    function exitPool(address pool, uint256[] calldata minAmountsOut) external onlyPoolOwner(pool) {
        ...
        emit TransferedToken(pool, poolTokens[1], msg.sender, firstTokenBalance);
    }
