...
contract AtomicSwap {
    ...
    )
  {
    ...
    uint256[] memory amounts = _getNeededAmountAndLeftover(collateralAmountOut, tokenSwapPath, tokenAmountIn);
    ...
    )
  {
    ...
    uint256[] memory amounts = _getNeededAmountAndLeftover(amountTokenOut, tokenSwapPath, collateralRedeemed);
  ...
  function _getNeededAmountAndLeftover(uint256 tokenOuput, address[] memory path, uint256 readyAmount) internal view returns(uint256[] memory amounts) {
