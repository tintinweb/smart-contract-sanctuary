...
contract ERC721PresetMinterPauserAutoId is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    ...
    bytes32 private constant FOUNDRY_ROLE = keccak256("FOUNDRY_ROLE");
    ...
    constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol) {
        ...
        _setupRole(FOUNDRY_ROLE, _msgSender());
    }
    ...
    function isApprovedForAll(address owner, address operator) public view virtual override(ERC721) returns (bool) {
        if (hasRole(WRAPPER_ROLE, operator) || hasRole(FOUNDRY_ROLE, operator)) return true;
        return _operatorApprovals[owner][operator];
    }
