...
contract Token {
    ...
    function transfer(uint256 srcChain, uint256 dstChain, address _to, uint256 _value) returns (bool success);
    function transferFrom(uint256 srcChain, uint256 dstChain,address _from, address _to, uint256 _value) returns (bool success);
    function approve(address _spender, uint256 _value) returns (bool success);
    function allowance(address _owner, address _spender) constant returns (uint256 remaining);
    event Transfer(uint256 srcChain, uint256 dstChain, address indexed _from, address indexed _to, uint256  indexed_value);
...
contract StandardToken is Token {
    ...
    function transfer(uint256 srcChain, uint256 dstChain, address _to, uint256 _value) returns (bool success) {
        if (balances[msg.sender] >= _value && _value > 0) {
            ...
            balances[_to] += _value;
            Transfer(srcChain, dstChain, msg.sender, _to, _value);
            return true;
        } else {
            return false;
        }
    ...
    function transferFrom(uint256 srcChain, uint256 dstChain, address _from, address _to, uint256 _value) returns (bool success) {
        if (balances[_from] >= _value && allowed[_from][msg.sender] >= _value && _value > 0) {
            ...
            Transfer(srcChain, dstChain, _from, _to, _value);
            return true;
        } else {
            return false;
        }
