...
contract StrategyBoring {
    ...
    address constant public want        = address(0x6A4399D248B8dBbD97a61045928538d49fE23133); // BORING TOKEN
    address constant public boringChef  = address(0x05b64B9a9d4D20641B0E70a580146547549DF9d3); // BORING Chef
    uint256 constant public pid = 0;
    address constant public dToken = address(0xD9F0145eBBf20D05fdF3335665A27C71d51e3688);
    address constant public eToken = address(0x1c9436c1663d626DFaC7A56777a43E552ef49C56);
