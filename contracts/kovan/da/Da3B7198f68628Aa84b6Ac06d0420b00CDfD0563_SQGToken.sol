...
contract SQGToken is ERC20, Ownable {
    ...
    address public marketingAddress = 0xb6fC501BA0CB8ec1332cB6a2b859eB17AF4912DA;
    address public diamondHolderPoolAddress = 0x55e92caa6A9C480F9B4484790328C8815Ca46c06;
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        uint256 transferAmount = amount - taxDiamondHolderAmount - taxMarketingAmount - taxBurnAmount;

        // transfer tax
        _transfer(_msgSender(), diamondHolderPoolAddress, taxDiamondHolderAmount);
        _transfer(_msgSender(), marketingAddress, taxMarketingAmount);
