...
abstract contract Finance {
    ...
    */
    function deposit(address _token, uint256 _amount, string calldata _reference) external payable virtual;
}
...
// File: browser/FinanceManager.sol
...
// File: browser/IdSponsorshipsMinter.sol
