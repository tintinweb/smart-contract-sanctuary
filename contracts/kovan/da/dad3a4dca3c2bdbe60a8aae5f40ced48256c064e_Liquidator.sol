...
contract Liquidator {
    address internal borrower = 0xea10031Bb69b1b64B19447C7a956f9a951183fb5; // Value hardcoded for Kovan
    ...
    receive() external payable {} // for weth withdrawal

    // Make sure to approve tokens before
