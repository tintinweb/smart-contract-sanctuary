...
contract PriceOracleProxy is Initializable, PriceOracle, Exponential, Denominations {
    ...
    event AggregatorUpdated(address indexed tokenAddress, address indexed base, address indexed quote, bool isUsed);
