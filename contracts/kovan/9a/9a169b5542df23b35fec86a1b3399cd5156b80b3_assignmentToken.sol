...
contract assignmentToken {
    ...
    uint256 supply = 50000; // Supply cannot be constant because I got an error when updating supply

    uint256 constant fee = 1; // fee is constant, can't be adjusted below
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require( (supply + amount < MAXSUPPLY),  "Supply Exceeds MAXSupply");
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require((_value <=balances[msg.sender]), "Sender needs to have enough tokens");
        require((_value >= fee), "Transfer value needs to be sufficient to cover fee");
    ...
    function transferFrom(
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require((_value <= balances[_from]),"from needs to have enough tokens");
