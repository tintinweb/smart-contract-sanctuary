...
contract SpaceportGeneratorv1 is Ownable {
    ...
    function createSpaceport (
      ...
      uint256[2] memory vesting_params
        ...
        newSpaceport.init2(_baseToken, _spaceportToken, SPACEPORT_SETTINGS.getBaseFee(), SPACEPORT_SETTINGS.getTokenFee(), SPACEPORT_SETTINGS.getEthAddress(), SPACEPORT_SETTINGS.getTokenAddress(), _burnAddress, vesting_params[0], vesting_params[1]);
...
contract Spaceportv1 is ReentrancyGuard {
  ...
  function init2 (
    ...
    uint256 _vestingEnd
      ...
      BURN_INFO.burn_address = _burnAddress;
  }
  ...
  function addLiquidity() external nonReentrant {
    ...
    if (remainingSBalance > STATUS.TOTAL_TOKENS_SOLD) {
        ...
        TransferHelper.safeTransfer(address(SPACEPORT_INFO.S_TOKEN), BURN_INFO.burn_address, burnAmount);
    }
...

{
  ...
  "libraries": {
    "/Users/pavelbulochkin/plasmapay/Launchpad-testdev/contracts/Spaceport-v1-periphery/contracts/SpaceportHelper.sol": {
      "SpaceportHelper": "0xeE992Ba573F6065C64d92fd24C29497ffAC8758C"
    }
  },
  "outputSelection": {
    "*": {
