...
contract ActivityBase is Ownable{
    ...
    function setDividendWeight(uint256 _userDividendWeight, uint256 _devDividendWeight) public virtual onlyOwner {
        require(
    ...
    function setDeveloperAddress(address _devAddress) public virtual onlyOwner {
...
contract MasterchefActivityOneDelegator is MasterchefActivityOne, DelegatorInterface {
    ...
    function setDistributeShardVelocity(uint256 _shardPerBlock, bool _withUpdate) public override {
        delegateToImplementation(
            abi.encodeWithSignature(
                "setDistributeShardVelocity(uint256,bool)",
                _shardPerBlock,
                _withUpdate
            )
        );
