...
contract LooksWorker is Ownable, ReentrancyGuard, IWorker {
  ...
  function getFeeSharingSystemShares() internal returns (uint256) {
    (uint256 _shares , , ) = feeSharingSystem.userInfo(address(this));
    return _shares;
  }
