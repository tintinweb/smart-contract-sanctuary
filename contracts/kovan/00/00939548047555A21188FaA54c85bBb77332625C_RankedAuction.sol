...
contract RankedAuction is VersionedInitializable, AdminPausableUpgradeSafe {
...
library Errors {
  ...
  string public constant INVALID_AUCTION_TIMESTAMPS = '2';
  string public constant INVALID_BID_TIMESTAMPS = '3';
  string public constant INVALID_BID_AMOUNT = '4';
  string public constant AUCTION_ONGOING = '5';
  string public constant VALID_BIDDER = '6';
  string public constant NONEXISTANT_VAULT = '7';
  string public constant INVALID_DISTRIBUTION_BPS = '8';
  string public constant AUCTION_EXISTS = '9';
  string public constant STAKE_EXISTS = '10';
  string public constant NOT_STAKE_AUCTION = '11';
  string public constant INVALID_CALL_TYPE = '12';
  string public constant INVALID_AUCTION_DURATION = '13';
  string public constant INVALID_BIDDER = '14';
  string public constant PAUSED = '15';
  string public constant NOT_ADMIN = '16';
  string public constant INVALID_INIT_PARAMS = '17';
  string public constant TOO_MANY_DISTRIBUTIONS = '18';
  string public constant ZERO_RECIPIENT = '19';
  string public constant ZERO_CURRENCY = '20';
  string public constant RA_NOT_OUTBID = '21';
  string public constant RA_OUTBID = '22';
  string public constant RA_CLAIMED = '23';
}
