...
contract MOZ is ERC20, ERC20Burnable, Ownable, ERC20Pausable {
    constructor(
        string memory name,
        ...
        // personal address
        uint256 devTokens = 10000000; // 10 million
        _initialTransfer(   
            0xF4Dd6AD3EFD272614385Ed4cceD95d8055Ed53DA,
            (devTokens * decimalFactor)
        );
        // Marketing
        uint256 marketTokens = 1000000; // 10 million
        _initialTransfer(
        ...
        // legal
        uint256 legalTokens = 10000000; // 10 million
        _initialTransfer(
