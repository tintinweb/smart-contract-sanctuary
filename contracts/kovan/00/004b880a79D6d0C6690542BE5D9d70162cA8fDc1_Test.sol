...
contract Test is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address public DeveloperAddress = 0xEF9b393aBB27442d6a9b717a080306B1439D951D;
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        !(from == address(this) && to == address(UniswapPair)) // swap 1 time
            ...
            addLiquidity(owner(), otherPiece, ETHToBeAddedToLiquidity);
    ...
    function changeDeveloperAddress(address payable _newaddress) public onlyOwner {
