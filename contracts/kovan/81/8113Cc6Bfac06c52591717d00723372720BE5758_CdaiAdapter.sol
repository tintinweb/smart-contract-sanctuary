...
contract CdaiAdapter is AdapterBase {
        ...
        returns (uint256)
    {
        ...
        uint256 receivedWrappedTokenQuantity =
            amount.mul(10**28).div(_cdai.exchangeRateCurrent());
        ...
        returns (uint256, uint256)
    {
        ...
        //redeemTokens uses 18 decimals
        uint256 receivedUnderlyingTokenQuantity =
            redeemTokens.mul(_cdai.exchangeRateCurrent()).div(10**28);
        //_redeemTokens uses 8 decimals
