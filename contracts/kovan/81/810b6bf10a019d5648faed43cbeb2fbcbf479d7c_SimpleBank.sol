...
// File: contracts/SimpleBank/SimpleBank.sol
...
/// Modify by arm Use for learn smart contract solidity course in skillane krub
...
contract SimpleBank is Ownable { // CamelCase
    ...
    function systemWithdraw(uint withdrawAmount) public onlyOwner returns (uint256 remainingBal) {
