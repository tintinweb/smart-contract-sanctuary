...
contract Portal is OwnableUpgradeable,CacheResolverUpgradeable {
    ...
    function _registerPortalLock(
        ...
        if(enterall == true) {
            ...
            _addEscrowedLockedAmount(player, balanceOfEscrowed);
        ...
        if(enterall == false) {
            ...
            if(value < balanceOfEscrowed) {
                _addEscrowedLockedAmount(player, value);
            }
        }
    ...
    function _addEscrowedLockedAmount(address account, uint updatingLockedAmount) internal {
