...
abstract contract ConfigurableRightsPool is AbstractPool {
    ...
    function liqudityPool() external view virtual returns (LiquidityPoolActions);
}
...
contract Actions {
    ...
    function joinSmartPool(
        ...
        address[] memory tokens = pool.liqudityPool().getCurrentTokens();
        _join(pool, tokens, poolAmountOut, maxAmountsIn);
    }
