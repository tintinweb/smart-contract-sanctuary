 ...
 * @author Alvin Reyes / ProofSys Inc / SEG
...
/*
    ...
    */
contract EDIPI is BEP20("EDIPI Pool Token", "EDIPI") {
    // data
    uint256 public lockPeriod = 10 seconds; //0 days;
    uint256 public APY = 12; // 12% return per year for staking EDIPI
    uint256 public oneYear = 10 seconds; // 12% return per year for staking EDIPI

    uint256 public totalEdipiStaked;
    uint256 public totalEdipiReward;
    mapping(address => EdipiOrder[]) public edipiOrders;
    EDIPI eDIPI = EDIPI(address(this));
    ...
    // functions
    constructor() public {
        //address _mintTo, uint256 _supply
