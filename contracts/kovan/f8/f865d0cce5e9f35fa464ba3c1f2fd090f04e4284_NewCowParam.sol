...
contract NewCowParam is INewCowParam {
    ...
    uint[31] private blindBoxProbability=[uint(0),3176,1772,1174,840,628,481,376,297,237,190,154,125,101,83,68,56,46,37,31,25,21,17,14,12,10,8,7,6,5,4];
    ...
    uint[31] private upgradeFailProbability=[uint(0),0,0,352,704,1056,1407,1759,2111,2463,2815,3167,3519,3870,4222,4574,4926,5278,5630,5981,6333,6685,7037,7389,7741,
    8093,8444,8796,9148,9500,10000];
    ...
    function upgradeSuccessProbability(uint level) view external override returns(uint){
        ...
        uint successProbability=10000-upgradeFailProbability[level];
        return successProbability.toX128(2);
    }
    ...
    uint[31] private powerList=[uint(0),100,125,155,193,239,298,370,461,573,714,890,1109,1384,1727,2158,2698,3377,4231,5308,6669,8393,10583,13375,16948,23000,
    30000,45000,65000,100000,180000];
