...
interface PT {
    function allowance(address _sender, address _spender) external view returns (uint256 allowance);
    function burnFrom(address _sender, uint256 _amount) external view returns (bool isBurned);
}
