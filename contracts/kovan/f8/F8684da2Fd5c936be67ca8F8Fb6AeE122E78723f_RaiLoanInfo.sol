...
contract RaiLoanInfo is DSMath {
    ...
    function getSafeInfo(uint256 _safeId) public returns (SafeInfo memory safeInfo) {
        ...
        (collInfo, raiInfo) = getCollAndRaiInfo(collType);
        uint256 calculatedDebt = mul(debt, collInfo.currRate);
        ...
        safeInfo = SafeInfo({
            ...
            safeAddr: safeAddr,
            collType: collType,
            collPrice: collInfo.assetPrice,
            raiTargetPrice: raiInfo.redemptionPrice
        });
    }
