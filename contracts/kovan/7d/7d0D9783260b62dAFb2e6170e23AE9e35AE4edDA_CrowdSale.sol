...
contract CrowdSale is Ownable {
        ...
        onlyOwner
    {
        for (uint256 j = 0; j < _whitelist.length; j++) {
            whitelist[_whitelist[j]] = _amount;
        }
    }
    ...
    function buyTokens() public payable {
        uint256 value = msg.value * rateInTokens;
        require(value > 0);
        require(whitelist[msg.sender] >= value, "Incorrect value");
        whitelist[msg.sender] = whitelist[msg.sender] - value;
