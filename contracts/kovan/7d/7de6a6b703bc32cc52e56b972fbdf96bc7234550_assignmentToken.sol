...
contract assignmentToken {
    ...
    function mint(address receiver, uint256 amount) public returns (bool) {
        ...
        require (msg.sender == minter,"User doesn't have minter ownership");
        require (supply+amount <= MAXSUPPLY,"Value is more than the MAXSUPPLY Limit");
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require (msg.sender == minter,"User doesn't have minter ownership");
        require (balances[minter] >= amount,"Not enough balances available");
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        require(balances[msg.sender] >= _value+1,"balances too low for transaction ( = 1 coin)");
    ...
    function transferFrom(
        ...
        // NOTE: transfer value needs to be sufficient to cover fee
        require(balances[_from] >= _value+1, "balances too low for transaction (= 1 coin)");
