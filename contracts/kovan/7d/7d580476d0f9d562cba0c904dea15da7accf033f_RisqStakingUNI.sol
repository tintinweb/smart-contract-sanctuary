...
// File: contracts/Staking/RisqStakingUNI.sol
...
contract RisqStakingUNI is RisqStaking, IRisqStakingERC20 {
    using SafeERC20 for IERC20;
    using SafeMath for uint;

    IERC20 public immutable UNI;

    constructor(ERC20 _token, ERC20 uni) public
        RisqStaking(_token, "RISQ UNI Staking lot", "rlUNI") {
        UNI = uni;
    }
    ...
    function sendProfit(uint amount) external override {
        ...
        if (_totalSupply > 0) {
            ...
            UNI.safeTransferFrom(msg.sender, FALLBACK_RECIPIENT, amount);
        }
    }
