...
contract AlgebraFactory is IAlgebraFactory {
    ...
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x9895b5446e705d3cdb17721fea26e470c8b816298dd34e81c6880fd9c1705cd5;
    ...
    function getAverages(
        ...
        if (lteConsideringOverflow(oldest.blockTimestamp, time - TIME_AGO, time)) {
            ...
            return (
             ...
             return (
                (volatilityAfter) / TIME_AGO,
                uint256((volumePerLiquidityCumulativeAfter)) >> 64
            );           
        }
    }
