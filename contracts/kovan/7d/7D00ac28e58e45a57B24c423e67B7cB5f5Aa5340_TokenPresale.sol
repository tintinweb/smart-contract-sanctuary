...
contract TokenPresale is Ownable {
    ...
    function buyPresale(address inviter) public payable {
        ...
        uint256 tokenAmount = msg.value.div(1e18).mul(tokenPricePerBNB);
        ...
        /*token.transferFrom(mainWallet, inviter, tokenForInviter);
        token.transferFrom(mainWallet, msg.sender, tokenForBuyer);*/
