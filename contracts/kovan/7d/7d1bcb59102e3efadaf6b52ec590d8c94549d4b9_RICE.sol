...
contract RICE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Rice Token";
    ...
    uint256 public minTokensBeforeSwap = 1000e18;
    ...
    function settFeeActive(bool value) external onlyOwner {
        isFeeActive = value;
    }
