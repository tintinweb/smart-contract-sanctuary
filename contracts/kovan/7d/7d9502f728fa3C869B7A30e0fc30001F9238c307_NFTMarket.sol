...
contract NFTMarket is ReentrancyGuard, ChainlinkClient, Ownable, IMarket {
    ...
    function createMarketItem(
        ...
        require(idTokenToMarket[tokenId] == 0, "TokenId exists");
    ...
    function distributeAssets(uint256 itemId, uint256 shareMinter) private returns(bool) {
        require(_itemIds.current() >= itemId, "Market item not found");
        require(!idToMarketItem[itemId].isDistributeAssets, "Assets have already allocated");
        require(!idToMarketItem[itemId].isRejected, "Payment has been rejected");
        require(shareMinter <= 10000, "Share exceeded");
        require(idToMarketItem[itemId].commission <= 10000, "Comission exceeded");
        ...
        if(isPremium == true){
            minterShare = (totalSent * shareMinter) / 10000;
            ...
            minterShare = (totalSent * shareMinter) / 10000;
            sellerShare = totalSent * (10000 - commission - shareMinter);
