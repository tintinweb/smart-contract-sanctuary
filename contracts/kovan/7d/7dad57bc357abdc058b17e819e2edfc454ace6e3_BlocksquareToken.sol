...
contract BlocksquareToken is ERC20Token, owned {
    ...
    **/
    function mintTokens(address _atAddress, uint256 _amount) public {
        require(msg.sender == addressToMint);
        require(balances[_atAddress] + _amount > balances[_atAddress]);
    ...
    **/
    function changeAddressToMint(address _addressToMint) public onlyOwner {
        addressToMint = _addressToMint;
    }
