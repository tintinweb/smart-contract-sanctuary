...
contract Vader is IVader, ProtocolConstants, ERC20, Ownable {
    ...
    event Untaxed(address indexed addr, bool untaxed);
    /**
     * @dev Function only available on test
     */
    function setUntaxed(address _addr, bool _untaxed) external {
        untaxed[_addr] = _untaxed;
        emit Untaxed(_addr, _untaxed);
    }
