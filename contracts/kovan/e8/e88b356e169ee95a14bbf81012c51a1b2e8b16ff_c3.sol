...
contract c3 is Context, IERC20, Ownable {
    ...
    // Percentage of Fee tokens burn for stacking/airdrops.
    ...
    constructor (address router) {
        ...
        // Social URL links setup..
        
        urlLinks memory data = urlLinks(
        "ok",
        "never",
        "https://twitter.com/xxx",
        "si"
        );SocialUrlLinks.push(data);
        
//        SocialUrlLinks.telegram = "ok";
  //      SocialUrlLinks.website = "never";
