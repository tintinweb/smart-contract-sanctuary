...
contract Presale01 is ReentrancyGuard {
  ...
  constructor(address _presaleGenerator) public {
    ...
    PRESALE_SETTINGS = IPresaleSettings(0x5f6Ef6608B3deb84A38d12Bce535Fdd6aB195A66);
    PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0x7ae1B6a5e6e0956c8130C619aEE53F3a8373FDE7);
    UNICRYPT_DEV_ADDRESS = 0x67926b0C4753c42b31289C035F8A656D800cD9e7;
  }
