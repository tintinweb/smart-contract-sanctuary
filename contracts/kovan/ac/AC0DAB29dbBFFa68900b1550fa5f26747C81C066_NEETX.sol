...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RewardToken = IERC20(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa); //DAI
...
contract NEETX is IERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "NEETX Finance";
    string constant _symbol = "NEETX";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address RewardToken = 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa; 

    uint256 _totalSupply = 3000 * (10 ** _decimals); // 1,000,000,000,000
    uint256 public _maxTxAmount = _totalSupply * 15 / 1000; // 1% of total supply.
    uint256 public _walletMax = _totalSupply * 15 / 1000; // 1% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xDFA0B3fCf7B9E6e1BFB8ef536Aa33B5aF6Fd7F47;
    ...
    function approveMax(address spender) external returns (bool) {
        return approve(spender, (256**2) - 1);
    }
