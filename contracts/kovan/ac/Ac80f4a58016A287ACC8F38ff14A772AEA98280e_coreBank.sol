...
// File: contracts/artifacts/SimpleBank1.sol
...
contract coreBank is Ownable {
    ...
    event PayDividendsPerYearMade(address indexed admin, uint256 totalInterest);
    ...
    function withdraw(uint256 withdrawAmount) public returns (uint256 remainingBalance) {
        ...
        // Transfer ether back to Users, revert on failed
    ...
    function systemWithdraw(uint256 withdrawAmount) public onlyOwner returns (uint256) {
        // Only owner
        // require(owner == msg.sender, "You aren't authorized to perform this function.");
        require(withdrawAmount <= systemBalance(), "Amount to withdraw is not enought!");
    ...
    function payDividendsPerYear() public payable onlyOwner {
        ...
        emit PayDividendsPerYearMade(msg.sender, totalInterest);
    }
