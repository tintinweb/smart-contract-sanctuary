...
contract IntegralDelay is IIntegralDelay {
    ...
    function _addLiquidityAndMint(
        ...
        uint256 amount0Desired,
        uint256 amount1Desired
    ) internal returns (uint256 amount0Left, uint256 amount1Left) {
    ...
    function _executeWithdraw(Orders.WithdrawOrder memory withdrawOrder) public {
        ...
        require(amount0 >= withdrawOrder.amount0Min && amount1 >= withdrawOrder.amount1Min, 'AL_INSUFFICIENT_AMOUNT');
    }
