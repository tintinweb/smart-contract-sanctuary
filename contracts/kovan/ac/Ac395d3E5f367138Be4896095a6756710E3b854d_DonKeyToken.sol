...
/**
 * @title DonKey Token
 * @dev DonKey ERC20 Token
 */
contract DonKeyToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("DonKeyToken", "DON") {
     ...
     * Owner is assumed to be governance or DonKey trusted party for helping users
