...
contract APIConsumer is ChainlinkClient, KeeperCompatibleInterface {
    ...
    constructor() public {
        ...
        jobId = stringToBytes32("050fe78dcc334875a74e919b095c96f9");
    ...
    function getGust() public view returns(uint) {
        return gust;
    }
