...
contract Presale01 is ReentrancyGuard {
  ...
  constructor(address _presaleGenerator) public {
    ...
    PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0x6C592B288A8fbe97215f6e826F91a033356fD812);
...
interface IPresaleFactory {
    function registerPresale (address _presaleAddress, uint256 _endBlock) external;
...
contract PresaleGenerator01 is Ownable {
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0x480A98b413b59a2e2e23A2f632011a09e010973D);
        PRESALE_SETTINGS = IPresaleSettings(0x09C20ED4702B169a72ba0449C85399cCE7F9863D);
    }
    ...
    function createPresale (
      ...
      uint256[10] memory uint_params
        ...
        PRESALE_FACTORY.registerPresale(address(newPresale), params.endblock);
    }
