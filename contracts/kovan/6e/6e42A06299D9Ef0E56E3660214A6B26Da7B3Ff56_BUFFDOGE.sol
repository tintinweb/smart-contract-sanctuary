...
contract BUFFDOGE is ERC20 {
    ...
    uint256 private constant SUPPLY = 137000000000000 * 1e18;
    ...
    constructor() payable ERC20("Test", "TST") {
        ...
        uint256 initialTokenLiquidity = SUPPLY.mul(20).div(100);

        _approve(address(this), UNISWAP_ROUTER, initialTokenLiquidity);
    ...
    function open() external {
        ...
        uint256 maxThreshold = initialTokenLiquidity.mul(5).div(1000);
        _mint(_owner, maxThreshold);
