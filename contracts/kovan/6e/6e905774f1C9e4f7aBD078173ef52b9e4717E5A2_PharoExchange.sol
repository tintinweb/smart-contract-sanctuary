...
contract PharoExchange is Ownable, ReentrancyGuard {
    ...
    */
        ...
        returns(bool success)
    {
        ...
        require(contractBalance >= _wei, "PharoExchange :: Not enough wei in contract.");
        ...
        contractBalance = contractBalance.sub(_wei); // Adjusts the contract balance
    ...
    */
        ...
        returns(bool success)
    {
        ...
        contractBalance = contractBalance.add(msg.value); // Adjust contract bal of ETH
    ...
    */
        ...
        returns(bool success)
    {
        ...
        require(contractBalance >= _amount, "PharoExchange :: Not enough ETH in contract for withdraw.");
