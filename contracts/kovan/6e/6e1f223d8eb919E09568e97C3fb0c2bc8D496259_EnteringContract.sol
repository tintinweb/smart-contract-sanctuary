...
contract EnteringContract{
    IContest public contestAddress;
    IERC20 public tokenToStake;

    constructor(
        IERC20 _tokenToStake,
        IContest _contestAddress
    ){
