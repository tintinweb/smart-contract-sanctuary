...
contract GradientLifeNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public generalCost = 0.05 ether;
    uint256 public whitelistCost = 0.03 ether;
    uint256 public maxSupply = 10000;
    uint256 public maxMintAmount = 5;
    uint256 public mintPerAddressLimit = 3;
    uint256 public tokenPerAddressLimit = 3;
    uint256 public reserved = 500;
    bool public paused = false;
    bool public hasWhitelist = false;

    address public owner1 = 0xD8f94d447c5f7dfB5a6278be1e927bd00cf1c851;
    address public owner2 = 0xD8f94d447c5f7dfB5a6278be1e927bd00cf1c851;
    ...
    function MintCollectible(uint256 mint) public payable {
        ...
        require(mint <= maxMintAmount, "max mint amount per session exceeded");
        ...
        if (msg.sender != owner()) {
            ...
            if (tokenPerAddressLimit > 0) {
                uint256 ownerTokenCount = balanceOf(msg.sender);
                require(
                    ownerTokenCount + mint <= tokenPerAddressLimit,
            ...
            if (hasWhitelist) {
                ...
                require(
                    msg.value >= whitelistCost * mint,
                    "insufficient funds"
                );
            } else {
                require(msg.value >= generalCost * mint, "insufficient funds");
            }
        }
    ...
    function setmaxMintAmount(uint256 _set) public onlyOwner {
        maxMintAmount = _set;
    }
    ...
    function withdraw(uint256 _percent) public payable onlyOwner {
        ...
        (bool success1, ) = owner1.call{value: amount / 2}("");
        (bool success2, ) = owner2.call{value: amount / 2}("");
