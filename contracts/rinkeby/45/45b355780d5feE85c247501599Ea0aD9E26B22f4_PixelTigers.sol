...
contract PixelTigers is PixelTigers721 {
    ...
    function breed(uint256 tiger1, uint256 tiger2) external onlyOwnerToken(tiger1) onlyOwnerToken(tiger2) {
        ...
        Stripes.burn(msg.sender, BREED_PRICE);
        babyCount++;
    ...
    function transferFrom(address from, address to, uint256 tokenId) public override {
        if (tokenId < totalAmtGenesis) {
            Stripes.rewardSystemUpdate(from, to);
...
contract PixelTigers721 is ERC721Enumerable, Ownable {
   ...
   function mint(uint256 _count) public payable {
    ...
    function settokenERC20(address tokenERC20Address) external onlyOwner {
        Stripes = iStripesERC20(tokenERC20Address);
    }
