...
contract SongsOfTheMetaverseV1 is ERC721Enumerable, ReentrancyGuard, Ownable {
  uint256 public lootPrice = 200000000000000000; //0.2 ETH
  uint256 public price = 5000000000000000; //500000000000000000; //0.5 ETH
  ...
  string[] private songList = [
    "ipfs://QmTE5LjL3XSmMKiZRBEKXtd1SdvBypVYmQiKBztjURC5Df",
    "ipfs://QmRU9QBoBD1n7J6npwZntqFf2vTJCQVYKwA6Daj31TNVQB",
    "ipfs://QmWYuB8gZn8CikakbHeFWqCu1ykustX67G9Kxx2vpXj3FP",
    "ipfs://QmYWhppVEGeMjuZu2rp9EKRym9kFq2M9R1g8ZTPn25xz4G",
    "ipfs://QmeVUmBo9LdjJ6gMKTVBNaGfg24Vk6dryCX9uQGtSpNE3K",
    "ipfs://QmaxVyCiR1tZZNHvB3C2CStQMVC1hDE9T3DRCysQbTLhNw"
  ];
  ...
  string[] private singingStyles = [
    ...
    "Sing Harmony",
    "Whistle",
    "Screaming at the bird",
    "Belch",
    "Storytelling around a Campfire",
    "Choir",
    "Monotone",
    "Tone Deaf but counts",
    "Falsetto",
    "Gregarious and jolly",
    "Acappella",
    "Grungy",
    "Yodel",
    "Trill",
  ...
  function getProficiency(uint256 tokenId) public view returns (string memory) {
    return pluck(tokenId, "PROFICIENCY", proficiencies);
  }
    ...
    string memory json =
      Base64.encode(
        bytes(
          string(
            abi.encodePacked(
              '{"name": "Songs of the Metaverse #',
              toString(tokenId),
              '", "description": "The Songs of the Metaverse. First collection of 5 unique and original songs to accompany you on the journey ahead. Compatible with Loot (for Adventurers)", "animation_url": "',
              song,
  ...
  constructor() ERC721("Songs of the Metaverse", "Songs of the Metaverse") Ownable() {}
}
