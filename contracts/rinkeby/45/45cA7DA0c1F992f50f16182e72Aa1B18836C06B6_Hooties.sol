...
contract Hooties is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public hootiesRemainingToAssign = 0;
    uint256 public claimPrice = 70000000000000000;
    address private splitter;

    constructor (address splitter_) ERC721("Hooties", "hoot") {
