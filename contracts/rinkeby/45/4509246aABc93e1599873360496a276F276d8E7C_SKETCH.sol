...
contract SKETCH is ERC1155, Ownable {
    uint public constant MAX_FLUFFY_SKETCHES = 9;
    ...
    constructor() ERC1155("https://arweave.net/BC_gs65Rduy3Gourwo0C0K97A8bZY9beBWxXRNG6iuE") {}
    ...
    function preSaleMint(uint256 numberOfTokens) external payable {
        ...
        require(CLAIMED_SKETCHES <= MAX_FLUFFY_SKETCHES, "Purchase would exceed max tokens");
