...
contract EthTacToe {
    ...
    string Aexplaination = "These numbers are the spaces where the O and X's are. Refer to the ShowSampleBoard function to view the board";
    ...
    string wintext = "Check the seeboard functions and the chart on the source code to see if you won!";
    ...
    string line2 = "|      |      |      |";
    string line3 = "|  1   |  2   |  3   |";
    string line4 = "______________________";
    string line5 = "|      |      |      |";
    string line6 = "|  4   |  5   |  6   |";
    string line7 = "______________________";
    string line8 = "|      |      |      |";
    string line9 = "|  7   |  8   |  9   |";
    string line0 = "______________________";
    
    function ShowSampleBoard() public view returns(string memory, string memory, string memory, string memory, string memory, string memory, string memory, string memory, string memory, string memory){
        

        return (line1, line2, line3, line4, line5, line6, line7, line8, line9, line0);
    }
