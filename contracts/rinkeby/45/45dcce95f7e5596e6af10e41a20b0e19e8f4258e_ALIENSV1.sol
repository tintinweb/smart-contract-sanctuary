...
contract ALIENSV1 is ERC721Enumerable, Ownable {

    function getAfrom () public view returns (uint256){
        IERC721 sd = IERC721(0x593E46E0858e1907C464eB06f7c151231555C694); // address of contract 1 after deployment.
        return sd.balanceOf(0x004a325C5D0DE38eDaBf2BAfAb186A61EBa134a9);
    }
    ...
    constructor() ERC721("Alien V1", "Alien V1") {}
