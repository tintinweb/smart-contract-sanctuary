...
contract CheekyTokens is ERC721Enumerable, Ownable, Pausable {
    ...
    {
        require(amount > 0, "Amount must be higher than 0; check amount specified!");
        require(amount <= maxMintAmount, "Amount is too high; check amount specified!");
        require(totalSupply() + amount <= maxSupply, "Amount would overflow max supply; check amount specified!");
        
        address wallet = _msgSender();

        // We require a fee for the public.
        if (wallet != owner()) {
