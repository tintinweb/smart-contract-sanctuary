...
contract NikNovak  is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Nik Novak", "NINO") {
        setBaseURI(baseURI);
    }
    ...
    function presaleMintNFT(uint256 _count) public payable {
        ...
        require(
            balanceOf(msg.sender) <= MAX_PRESALE_ALLOWED,
            "MAX 2 NFTs can be held per account"
        );
