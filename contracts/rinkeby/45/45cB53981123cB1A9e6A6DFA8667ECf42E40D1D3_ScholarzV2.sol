...
contract ScholarzV2 is ERC721EnumerableUpgradeable, OwnableUpgradeable {
  ...
  function addKongzToWhitelist(address adr) public onlyOwner {
    require(!kongzEligible[adr], "Address is already whitelisted.");
    kongzWhitelistCount++;
    kongzEligible[adr] = true;
  }

  function removeKongzFromWhitelist(address adr) public onlyOwner {
    require(kongzEligible[adr], "Address is not whitelisted.");
    kongzWhitelistCount--;
    kongzEligible[adr] = false;
  }
