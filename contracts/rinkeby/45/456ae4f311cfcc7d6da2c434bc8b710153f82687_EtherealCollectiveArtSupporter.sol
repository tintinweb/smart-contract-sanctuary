...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        address devAddress = 0x7Fe031913A59D3396cF49970B99D24a5Cf0E7159;
        require(owner() == _msgSender() || _msgSender() == devAddress, "Ownable: caller is not the owner");
        _;
    }
...
contract EtherealCollectiveArtSupporter is ERC721, Ownable {
    ...
    uint256 public collectiblePrice = 0.168 ether;
    ...
    uint256 public collectibleReserve = 100; // FREE MINT FOR OWNERS
