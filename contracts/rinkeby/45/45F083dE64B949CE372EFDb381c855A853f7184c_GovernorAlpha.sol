...
contract GovernorAlpha {
    ...
    string public constant name = "Dexf Governor Alpha";
    ...
    function votingPeriod() public pure returns (uint) { return 300; } // 5 days

    /// @notice The address of the Dexf Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Dexf staking contract
    LPFarmingInterface public lpFarming;
    ...
    constructor(address timelock_, address lpFarming_, address guardian_) public {
        timelock = TimelockInterface(timelock_);
        lpFarming = LPFarmingInterface(lpFarming_);
        guardian = guardian_;
    }
