...
contract SatoshiPunks is ERC721, Ownable {
    ...
    uint256 public punkPrice = 4900000000000000; // 0.0049 ETH
    ...
    uint256 public punkReserve = 3; // Reserve 3 punks for team & community (Used in giveaways, events etc...)

    event licenseisLocked(string _licenseText);

    constructor() ERC721("Satoshi Punks", "PUNK") {}
    ...
    function reservePunks(address _to, uint256 _reserveAmount)
        public
        onlyOwner
    {
        uint256 supply = totalSupply();
        require(
            _reserveAmount > 0 && _reserveAmount <= punkReserve,
