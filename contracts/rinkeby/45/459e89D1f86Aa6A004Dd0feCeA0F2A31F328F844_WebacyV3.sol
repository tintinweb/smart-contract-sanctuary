...
contract WebacyV3 is AccessControl {
    ...
    mapping(address => mapping(address => mapping(uint256 => address)))
        private _AssetBeneficiaryToContractToVersionToMember;
    ...
    mapping(address => mapping(address => mapping(uint256 => address)))
        private _TokenBeneficiaryToContractToVersionToMember;

    mapping(address => mapping(uint256 => mapping(address => uint256)))
        private _memberToVersionToContractToAllowableAmount;

    mapping(address => uint256) private _backupWalletToMemberVersion;
    ...
    mapping(address => mapping(uint256 => address)) private _backupWalletToVersionToMember;

    function getMemberFromBackup() external view returns (address) {
        uint256 backupWalletsVersion = _backupWalletToMemberVersion[msg.sender];
        return _backupWalletToVersionToMember[msg.sender][backupWalletsVersion];
    }
    ...
    function aprovedERC721Tokens(
        ...
        for (uint256 i = 0; i < destinationAddresses.length; i++) {
            ...
            _AssetBeneficiaryToContractToVersionToMember[destinationAddresses[i]][contractAddress][
                ERC721SCVersion
            ] = msg.sender;
        }
    }
    ...
    function _saveBackupWallet(address[] memory backupAddresses, string[] memory backupAliases) private {
        ...
        if (_memberToVersionToBackupWallets[msg.sender][backupWalletsVersion].length == 0) {
            for (uint256 i = 0; i < backupAddresses.length; i++) {
                ...
                _backupWalletToVersionToMember[backupAddresses[i]][backupWalletsVersion]=msg.sender; 
    ...
    function _validateAssetBeneficiaryNotExists(
        ...
        // console.log(_contractVersion);
        // console.log(
        //     _AssetBeneficiaryToContractToVersionToMember[_destinationAddress][_contractAddress][_contractVersion]
        // );
        // console.log(
        //     _AssetBeneficiaryToContractToVersionToMember[_destinationAddress][_contractAddress][_contractVersion] ==
        //         address(0)
    ...
    function _validateTokenBeneficiaryNotExists(
        ...
        // console.log(_contractVersion);
        // console.log(
        //     _TokenBeneficiaryToContractToVersionToMember[_destinationAddress][_contractAddress][_contractVersion]
        // );
        require(
            _TokenBeneficiaryToContractToVersionToMember[_destinationAddress][_contractAddress][_contractVersion] ==
                address(0),
    ...
    function _validateBackupNotExists(address _backupAddress, uint256 _contractVersion) internal view {
        require(
            _backupWalletToVersionToMember[_backupAddress][_contractVersion] == address(0),
