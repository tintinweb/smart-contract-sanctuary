...
contract EpicNFT is ERC721URIStorage {
  ...
  string svgBase = "<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 350 350'>";
  ...
  string[] firstWords = ["Mighty", "Worthy", "Fearless", "Brave", "Avenger", "Angry", "Sad", "Happy", "Curious", "Gorgeous"];
  string[] secondWords = ["Cat", "Dog", "Eagle", "Dolphin", "Shark", "Lion", "Tiger", "Pig", "Goat", "Orca"];
  string[] thirdWords = ["OfDoom", "OfDarkness", "OfMisfortune", "OfSuffering", "OfWar", "FromSpace", "FromTheAbism", "FromTheVoid", "FromTheDepths", "FromHell"];
  ...
  constructor() ERC721 ("MightyRandomCreatures", "SQUARE") {
