...
contract LockingLayers is ILockingLayers, ERC721, VRFConsumerBase, Ownable {
    ...
    uint16 constant BLOCKS_PER_ACTION = 2222;
    ...
    uint256 public constant AUTOMATIC_START_BLOCK_DELAY = 1000;
    ...
    mapping(uint256 => uint8) public _locksRemaining;
    ...
    uint256 constant vrfFee = 100000000000000000;
    ...
    function currentPrice(ArtworkTier tier) public override view returns (uint256) {
        ...
        if(tier == ArtworkTier.ENTHUSIAST) {
            ...
            uint256 collectorMin =  5 * 1 ether / 1000;
            uint256 collectorMax = 25 * 1 ether / 1000;
    ...
    function withdrawlFunds() public {
        (bool success, ) = address(0xf8aa14210b01C8e80b434681a7689f069f9af09B).call{value: address(this).balance}("");
