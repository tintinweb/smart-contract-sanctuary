...
contract MooncatPunks is Ownable, ERC721Enumerable {
    using Strings for uint256;    
    uint256 public MAXSUPPLY = 6969;
    uint256 public MINT_PRICE = 0.015 ether;
    uint256 private SALES_LIMIT = 20;    
    uint256 private MAX_NFT_PRESALE = 969;      
    ...
    constructor(string memory _initBaseURI) ERC721("Mooncat Punks", "MCPUNKS") {
