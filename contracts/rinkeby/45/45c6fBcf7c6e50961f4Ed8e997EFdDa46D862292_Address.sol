...
contract GG is ERC721, ERC721Enumerable, Ownable {
    ...
    string public baseSymbolName = "GaggedGirl";
    string private _baseURIextended;
    address public devAddress = 0x546Ac773B49cf87f723eEC01b5b957D6EE598B68;

    constructor(    
    ) ERC721("Gagged Girls", "GG") {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory)
    {
        ...
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI, baseSymbolName, tokenId.toString(), baseExtension))
            : "";
    }
    ...
    function withdraw() public onlyOwner {
        ...
        if (totalSupply() < 1111) {
            ...
            payable(msg.sender).transfer(balance.div(100).mul(90));
            payable(devAddress).transfer(balance.div(100).mul(10));
        }
