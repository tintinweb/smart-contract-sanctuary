...
contract KommunitasProject{
    ...
    function initialize(
        ...
        for(uint i=0; i<3; i++){
            ...
            booster[i].price = _price[i].mul(10**currency.decimals()).div(1e6);
        }
        ...
        minPublicBuy = _minMaxPublicBuy[0].mul(10**currency.decimals()).div(1e6);
        maxPublicBuy = _minMaxPublicBuy[1].mul(10**currency.decimals()).div(1e6);
        fee = _fee;
