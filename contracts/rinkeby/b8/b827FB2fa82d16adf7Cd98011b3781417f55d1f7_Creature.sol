...
contract Creature is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress, string memory _baseURI, string memory _notRevealedUri)ERC721Tradable("Knight Pass", "KTP", _proxyRegistryAddress){
        baseURI = _baseURI;
        notRevealedUri = _notRevealedUri;
        preSalePrice = 0.03 ether;
        normalPrice = 0.03 ether;
    }
