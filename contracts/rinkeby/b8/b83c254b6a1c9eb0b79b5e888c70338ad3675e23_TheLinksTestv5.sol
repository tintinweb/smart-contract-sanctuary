...
contract TheLinksTestv5 is ERC721, Ownable {
    using SafeMath for uint256;


    uint256 public itemPrice;
    bool public isSaleActive;
    uint256 constant public totalTokenToMint = 20;
	uint256 public purchasedLinks;
    uint256 public startingIpfsId;
    address public fundWallet;
    uint256 private _lastIpfsId;

    constructor (string memory _tokenBaseUri, address _fundWallet) ERC721("TheLinksTestv5", "TheLinksTestv5") {
