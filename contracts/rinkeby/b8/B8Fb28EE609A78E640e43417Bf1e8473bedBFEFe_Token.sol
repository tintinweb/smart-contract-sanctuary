...
//
//
//      ASCII ART PLACEHOLDER (FOR MAINNET DEPLOYMENT)
//
//
//
//
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TK5";
    ...
    constructor() public {
        ...
        // Owner and contract are exempt from fees \\
        _isExemptFromFee[owner()] = true;
        _isExemptFromFee[address(this)] = true;

        marketingWallet = 0x690EAEA9E0f59ad37035388D672d7Ff914c99D20;
    ...
    // redo.. check callback shit \\
    receive() external payable {}

    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            newAddress != address(uniswapV2Router),
            "Token: Unable to use existing address"
        );
    ...
    // Distribute fee to marketing & burn \\
