...
contract UnipilotFarm is IUnipilotFarm, ReentrancyGuard, IERC721Receiver {
        ...
        onlyGovernance
    {
        ...
        emit UpdatePilotPerBlock(pool, pilotPerBlock, pilotPerBlock = value);
    }
        ...
        onlyGovernance
    {
        ...
        emit UpdateMultiplier(
            _pool,
            poolState.rewardMultiplier,
            poolState.rewardMultiplier = _value
        );
    }
...
interface IUnipilotFarm {
    ...
    function updatePilotPerBlock(address pool, uint256 value) external;
