...
contract BlootWheelsUp is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private shimmers = ['x1="0%" y1="0%" x2="100%" y2="0%"', 'x1="100%" y1="0%" x2="0%" y2="0%"', 'x1="0%" y1="0%" x2="0%" y2="100%"', 'x1="0%" y1="100%" x2="0%" y2="0%"', 'x1="0%" y1="0%" x2="100%" y2="100%"', 'x1="100%" y1="0%" x2="0%" y2="100%"', 'x1="0%" y1="100%" x2="100%" y2="0%"', 'x1="100%" y1="100%" x2="0%" y2="0%"'];
    ...
    function getShimmer(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "SHIMMER", shimmers);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory shimmer = string(abi.encodePacked('<defs><linearGradient id="shimmer" ', getShimmer(tokenId), '><stop stop-color="rgba(212,175,55,0.1)"></stop><stop stop-color="#d4af37"><animate attributeName="offset" values=".05;.95" dur="2s" begin="0" repeatCount="indefinite"/></stop><stop stop-color="rgba(212,175,55,0.1)"><animate attributeName="offset" values="0;1" dur="2s" begin="0" repeatCount="indefinite"/></stop></linearGradient></defs>'));
