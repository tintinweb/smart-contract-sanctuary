...
contract PunksV1Wrapper is Ownable, ERC721 {
    ...
    address payable public punkAddress = payable(0x70b5709e6b8b8F2485c3f22Ba5eFeCea6e9195C8);
    string public _baseTokenURI;

    constructor() payable ERC721("BAF Wrapped CryptoPunks", "WPUNKS") {}
    ...
    function wrap(uint _punkId) public payable {
        ...
        emit Wrapped(_punkId, msg.sender);
    }
    ...
    function unwrap(uint256 _punkId) public {
        ...
        emit Unwrapped(_punkId, msg.sender);
    }
