...
contract HeadPortraitGift is OwnableContract{
    ...
    function claimOfAdmin(address user, uint256 _tokenId) public onlyAdmin{
        ...
        emit Claim(0, tokenId, user, address(0), 0);
    }

    function getAttributes(uint256 _tokenId) internal view returns(HeadPortrait721Interface.Attribute memory attribute){
