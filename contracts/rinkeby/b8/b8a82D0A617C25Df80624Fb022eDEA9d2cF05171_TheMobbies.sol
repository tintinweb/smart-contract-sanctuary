...
contract TheMobbies is ERC721Enumerable, Ownable {
   ...
   constructor(
    ...
    //PUBLIC
    function mint(uint256 _mintAmount) public payable notPaused minimumMintAmount(_mintAmount) {
        uint supply = totalSupply();
        require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded");
        require(_mintAmount <= maxMintAmount, "You can mint in range (1-50) Mobbies!");
