...
contract Thorgi is ERC20Burnable, Ownable {
    ...
    // staking
    uint256 public constant pupRatePerDay = 1 * 10**9; // 1 $THORGI per day for staked pups
    uint256 public constant corgiRatePerDay = 3; // 3 $THORGI per day for staked corgis
