...
contract TestTokens is ERC721, Ownable, Pausable, ReentrancyGuard {
    ...
    function mint(uint _amount) public payable whenNotPaused nonReentrant {
    ...
    function getTokenToBeMinted() private returns (uint16) {
        uint limit = _availableTokens.length;
