...
//gaper x cam s/o allenhena/cryptoking/ali/cowboy //1629500400

contract Stakers is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    mapping (uint256 => string) private _tokenURIs;
    mapping (uint256 => string) private skinTone;

    
    uint256 public maxChips;
    uint256 private chipPrice = 0.0000002 ether;
    uint256 public saleStartTimestamp = 1628879640;
    ...
    return uint(keccak256(abi.encodePacked(msg.sender, block.timestamp))) % 3;
    }

    function mintChip(uint256 chipQuantity) public payable {
        uint256 supply = totalSupply();
        require( chipQuantity < 20,"3 Max" );
    ...
    function setLightSkin(uint256 tokenId) public {
        address owner = ERC721.ownerOf(tokenId);
        require(
            _msgSender() == owner,
    ...
    function setMidSkin(uint256 tokenId)public {
        address owner = ERC721.ownerOf(tokenId);
        require(
            _msgSender() == owner,
            "This isn't your Staker."
    ...
    function setDarkSkin(uint256 tokenId) public {
        address owner = ERC721.ownerOf(tokenId);
        require(
            _msgSender() == owner,
            "This isn't your Staker"
 ...
 function tokenURI(uint256 tokenId) public view virtual override(ERC721, ERC721URIStorage) returns (string memory) {
            ...
            return string(abi.encodePacked(base, tokenId.toString(), skinTone[tokenId]));
