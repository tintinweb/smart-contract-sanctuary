...
abstract contract IDO is Ownable, ReentrancyGuard {
    ...
    uint256 public constant lockDuration = 7 * unit;
    uint256 public constant regDuration = 24 * unit;
    uint256 public constant saleStartsAfter = regDuration + 12 * unit;
...
// File: contracts\IDOStaker\DEXWrap.sol
...
contract DEXWrap is RaffleWrap {
    ...
    modifier afterFCFSSale() {
        require(isInitialized, "Not Initialized Yet");
        require(saleStarts + saleDuration <= block.timestamp, "Sale Not Ended Yet");
        _;
    }
