...
contract RegisterManager {
    ...
    function autoSwapAndDistritue(uint _estimatedAmount) private {
        // balance check
        // if balance is bigger than 10eth, swap into whl for 9eth and distribute whl to whlc holders
    ...
    function systemPrimeRegister() external {
        ...
        // require(token0.allowance(msg.sender, daiPrimeFeeAddress) >= daiPrimeFee, "dai is not approved!");
    ...
    function systemApexRegister() external {
        ...
        // require(token0.allowance(msg.sender, daiApexFeeAddress) >= limitAmount, "dai is not approved!");
