...
contract NonFungibleHeroesGodsMinter is Ownable, ReentrancyGuard {
    ...
    // ======== Cost =========
    uint256 public constant GOD_COST = 0.001 ether;
    ...
    function mintPublic(uint amount) public payable nonReentrant {
        ...
        if (block.timestamp < publicSaleStart) {
            ...
            uint256 remainingMints = saleWhitelist[msg.sender] - addressToMintCount[msg.sender];
            require(amount <= remainingMints, "You have no more whitelist mints remaining");
        }
