...
/// @title Social Recovery Module - Allows to replace an owner without Safe confirmations if heirs approve the replacement.
/// @author Stefan George - <[email protected]>
contract SocialRecoveryModule is Module {

    string public constant NAME = "Heir Module";
