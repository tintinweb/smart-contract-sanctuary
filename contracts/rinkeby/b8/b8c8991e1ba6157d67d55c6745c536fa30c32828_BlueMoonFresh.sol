 ...
 */
contract BlueMoonFresh is ERC721, Ownable {
    using SafeMath for uint256;

    address public ownerWalletAddress;

    constructor() ERC721("BlueMoonFresh", "BMFRESH") public {
    ...
    * Mints BlueMoon
    */
    function mintFresh(address payable recipient, string memory uri) public payable returns (uint256) {
