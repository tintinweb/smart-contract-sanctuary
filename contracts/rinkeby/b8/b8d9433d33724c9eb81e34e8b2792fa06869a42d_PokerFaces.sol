...
contract PokerFaces is ERC721, Ownable {
    ...
    uint256 public constant maxFacePurchase = 20;

    uint256 public constant MAX_FACES = 10000;

    bool public saleIsActive = false;

    uint256 public faceReserve = 250; // Reserve 250 faces for team & community (Used in giveaways, events etc...)

    event licenseisLocked(string _licenseText);

    constructor() ERC721("Poker Faces", "FACE") {}
