...
// File: contracts/LightYearRebaseV0.sol
pragma solidity ^0.7.4;

contract LightYearRebaseV0 is ERC20Detailed, Ownable {
  ...
  constructor() ERC20Detailed("LightYearRebaseV0", "LightYearRebaseV0", uint8(DECIMALS)) {
    // Sushi 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
    // Cake 0x10ED43C718714eb63d5aA57B78B54704E256024E
    // NOTE: the address we using just mock to test deploy
  ...
  function shouldSwapBack() internal view returns (bool) {
    return msg.sender != pair && !inSwap && swapEnabled && _gonBalances[address(this)] >= gonSwapThreshold;
  }
