...
contract PKKT is ERC721Enumerable, Ownable {
    uint256 public constant MAX_KITTIES = 15;
    uint256 public constant FreeSupply  =  5;
    uint256 public constant PaidSupply  = 10;
    ...
    uint256 private _price = 0.01 ether; // .01 ETH
    uint256 private _saleTime = 1634794200;
