...
contract FFT is ERC721PresetMinterPauserAutoIdUpgradeable, IGameTokens {
    ...
    function initialize(address gameCardsAddress, string calldata networkId) public initializer {
        ...
        ERC721PresetMinterPauserAutoIdUpgradeable.initialize("Football Fantasy Token", "FFT", baseURI); 
    }
