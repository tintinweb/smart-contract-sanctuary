...
contract Launchpad is OwnableUpgradeable {
    ...
    function getClaimableBalance() public view returns (uint256) {
        ...
        return whitelistWallet.rewardedAmount;
    }
    ...
    function registerIDO() external {
        ...
        uint256 userBalance = IERC20Upgradeable(_safeMoonAVAX).balanceOf(
            _address
        );
    ...
    function buyTokens() external payable {
        ...
        if (
            ...
            whitelistSnapshot.rewardedAmount =
                ...
                GOLD_WEIGHT;
            console.log(
                "rewardedAmount %s, amount transferred %s",
                goldParticipants * tokenAllocationPerTier * GOLD_WEIGHT,
                acceptedAmount
            );
        } else if (
            keccak256(abi.encode(whitelistSnapshot.tier)) ==
        ...
        uint256 totalAmount = (tokenRate * whitelistSnapshot.rewardedAmount) /
            10**18;
    ...
    function redeemTokens() external {
        ...
        // Update total redeem
        totalRedeemed += whitelistWallet.rewardedAmount;
