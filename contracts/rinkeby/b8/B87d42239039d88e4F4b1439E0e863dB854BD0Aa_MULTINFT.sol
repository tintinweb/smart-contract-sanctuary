...
contract MULTINFT is ERC1155, Ownable{
    ...
    function transferItemFromBox(
        ...
        require(token.balanceOf(to) > total, "No momey");

        require(
            token.allowance(to, address(this)) >= total,
        ...
        safeBatchTransferFrom(address(this), to, _ids, _amount, "0x00");
        _setApprovalForAll(address(this),to,false);
