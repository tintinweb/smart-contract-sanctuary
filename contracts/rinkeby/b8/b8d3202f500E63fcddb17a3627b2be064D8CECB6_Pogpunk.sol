...
contract Pogpunk is ERC721Enumerable, Ownable, PogpunkERC721, PogpunkMetadata {
  ...
  uint256 public constant POGPUNK_GIFT = 100;
  uint256 public constant POGPUNK_PUBLIC = 900;
  ...
  */
  ...
  function gift(address[] calldata to) external override onlyOwner {
    require(totalSupply() < POGPUNK_MAX, 'All tokens have been minted');
    require(totalGiftSupply + to.length <= POGPUNK_GIFT, 'Not enough tokens left to gift');
