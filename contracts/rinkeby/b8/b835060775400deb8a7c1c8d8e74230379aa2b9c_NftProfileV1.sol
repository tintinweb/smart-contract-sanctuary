    ...
    UUPSUpgradeable
{
    ...
    address public stakeContract;             // staked contract to receive nft token fees
...
contract CreatorCoin is ERC20 {
    ...
    */
    function performAction(
        ...
        _fees[stakingContract] = _fees[stakingContract].add(_protocolFee);
    ...
    */
    function redeemFees() external {
        ...
        uint256 protocolFee;
        (protocolFee, _fees[stakingContract]) = (_fees[stakingContract], 0);
        IERC20(nftCashAddress).transfer(stakingContract, protocolFee);
    }
