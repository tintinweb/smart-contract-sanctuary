...
contract testlow_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Hybrid of Satan", "HSS") {
    setHiddenMetadataUri("ipfs://QmYeGFFmoSGojDadPBayJxwCiQnr2CcUAKjjnr2DF6sXxC/Unrevealed HSS.json");
  }
