...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    constructor(address _priceFeedAddress, address _vrfCoordonator, address _link, uint256 _fee, bytes32 _keyhash) public VRFConsumerBase(_vrfCoordonator, _link) {
    ...
    function endLottery() public onlyOwner {
        // uint(keccak256(abi.encodePacked(nonce, msg.sender, block.difficulty, block.timestamp))) % players.length; // nu bun
