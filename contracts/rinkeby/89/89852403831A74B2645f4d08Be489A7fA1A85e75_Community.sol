...
contract Community is ICommunity {
    ...
    function initialize(IHomeFi _homeFi, IEvents _eventsContract)
        external
        override
        initializer
    {
        homeFiInstance = _homeFi;
    ...
    function transferFraction(
        ...
        address _to,
        uint256 _amount
    ) external override nonReentrant nonZero(_to) returns (bool) {
        require(
            communities[_communityID].projectDetails[_project].exists,
            "Community::Project !Exists"
        );
    ...
    ReentrancyGuardUpgradeable
{
     ...
     *
     * @param _homeFi IHomeFi - instance of main HomeFi contract. Can be accessed with raw address
     * @param _eventsContract IEvents - instance of events contract. Can be accessed with raw address
     */
    function initialize(IHomeFi _homeFi, IEvents _eventsContract)
        external
        virtual;
     ...
     * - _communityAddr community contract address
...

{
  ...
  "libraries": {
    "contracts/libraries/SignatureDecoder.sol": {
      "SignatureDecoder": "0xe84b1383bb3a9f475950fb3c40bf1beea8a8bea3"
    }
  }
}