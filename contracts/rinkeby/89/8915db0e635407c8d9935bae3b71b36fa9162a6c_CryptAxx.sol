...
// Uses ERC721Enumerable, Ownable
    ...
    // Mint costs 0.1 Ether for all mints
    // 5,000 available for whitelist mint (use the whitelistMint function for these)
    // 4,799 available for public mint (use the publicMint function for these)
    // 180 held for promotions & community giveaways (use the adminMint function for these)
    // 20 given to the CryptAxx artists, developers, mods, & team (use the teamMint function for these)
    // 1 mythic airdropped to random (offchain - live event) whitelist address at 20% completion
    ...
    // Dec 18 - Run mythicMint at 20% completion - offchain - live Discord event
    ...
    // Jan 2 - Set revealed to true to activate final metadata
...
contract CryptAxx is ERC721Enumerable, Ownable{
    ...
    function mythicMint(address to) public onlyOwner {
