...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmSEhxw5NZDQWbtA6NZs3KfVNM8P7azYgDkmBTwR1799Yx/";
        ...
        constructor(
            ...
            payableAddresses.push(0x83057AA552a731dd04ccfC3C4D1642120f70310e);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 6900");
    ...
    // File: contracts/dsTestContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract DsTestContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("DS Test", "DS", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/V1166lPCLaADeJAZN3oj/contract-metadata";
        }
    }