...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public maximumDepositEthAmount = 3.5 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x6E63254076c50CA260dD33644276d3EB30117893;

        // presaleStartTimestamp = now.add(1 hours);
        // presaleEndTimestamp = now.add(2 days).add(1 hours);
        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(2 days);
    }
