...
contract DoodleCrack is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
	// Token Info
	uint256 public constant MAX_SUPPLY = 10000;
	uint256 public MAX_VOLUME_MINTABLE  = 500;
	...
	mapping(address => bool) private _stock;
	...
	// Owners
	address private owner0 = 0xcDd5e60F2139A5C31E89227a92B6d01AfEA8309e;
	address private owner1 = 0x1E63ff3a030e1eB13b4A27750CA0777198C7b030;
	address private owner2 = 0x10Ad4c027F5d6081b0679C65feCCb3b164d02eb9;
	...
	modifier isOwner() {
        require(msg.sender == owner0 || msg.sender == owner1 || msg.sender == owner2, "You are not an owner");
        _;
    }
    ...
    constructor() ERC721('DoodleCrack', 'DC') {}
	...
	function setVolumeMintable(uint256 maxMintable) external onlyOwner {
	...
	function mintPresale(uint8 TOKENS_TO_MINT) public payable isRealUser nonReentrant {
		...
		require(_stock[msg.sender] != false, "You can not mint.");
		_allowList[msg.sender] = false;
		_stock[msg.sender] = false;
