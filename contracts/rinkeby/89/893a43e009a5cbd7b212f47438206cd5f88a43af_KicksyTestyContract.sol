...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://Qmd9aeS6gK7YJXRq9iHhbLVdDTf3oEU5cYmV9QNWmNx6ox/";
    ...
    // File: contracts/kicksyTestyContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract KicksyTestyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("KicksyTesty", "KT", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/h1PJavQwUY7J308uMwT0/contract-metadata";
        }
    }