...
contract RandomCollectorSelector is Ownable, VRFConsumerBase
{
    ...
    constructor(address _vrfCoordinator, address _linkToken, bytes32 _keyHash, uint256 _fee, string memory _ipfsGiveawayData) VRFConsumerBase( _vrfCoordinator, _linkToken) 
    {
        keyHash = _keyHash;
        fee = _fee;
    ...
    function getSnapshot() public view
    {
        
    }

    function addGiveawayData(string memory _ipfsGiveawayData) external onlyOwner { ipfsGiveawayData.push(_ipfsGiveawayData); }    
