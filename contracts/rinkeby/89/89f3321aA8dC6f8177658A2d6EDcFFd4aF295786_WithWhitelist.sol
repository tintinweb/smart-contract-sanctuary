...
contract WithWhitelist is ERC1155Supply, Ownable, Pausable {
    ...
    address private signerAddress = 0x2Cc6Ec43DB75802B26bF08Af2F22FA98C25132a9;
    ...
    function mintPlatinum(uint256 numberOfTokens) external payable {
        ...
        require(hasAddressMintedPlatinum[msg.sender] + numberOfTokens < 3, "WILL_EXCEED_MAX_NUMBER_PER_WALLET_ON_PURCHASE");
