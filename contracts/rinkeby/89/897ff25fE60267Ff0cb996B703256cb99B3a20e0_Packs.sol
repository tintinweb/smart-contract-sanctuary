...
contract Packs is IPacks, ERC721, ReentrancyGuard {
  ...
  //   return interfaceId == _INTERFACE_ID_ROYALTIES_RARIBLE || interfaceId == _INTERFACE_ID_ROYALTIES_EIP2981 || interfaceId == type(IPacks).interfaceId || super.supportsInterface(interfaceId);
  // }
...

{
  ...
  "libraries": {
    "contracts/LibPackStorage.sol": {
      "LibPackStorage": "0xcb3b8722e1cd1e81f511aec7f375c0d105ebccdc"
    }
  }
}