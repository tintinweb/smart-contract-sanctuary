...
contract CTF is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private constant initialMint = 20337 * 10**18; //20337 tokens minted when deployed

    uint256 private constant numTokensToMigrateV1 = 1270 * 10**18; //1.4k tokens to be migrated from v1
    uint256 private constant numTokensToMigrateV2 = 64793 * 10**18; //64793 tokens to be migrated from v2
    ...
    IERC20 public oldCTFV1 = IERC20(0x299baC24C8ad5635586fDe6619efF7891a6c8969);
    IERC20 public oldCTFV2 = IERC20(0x410319197d3394652B7ddDc669E58fbe30B56090);
