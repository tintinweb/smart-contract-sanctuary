...
contract PudgyHalloween is ERC1155, Ownable {
    ...
    mapping (address => uint256[]) private _pudgyPenguinsOwnerUsed;
    ...
    function MintPudgyHalloween(uint256[] memory _tokenIds) public {
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            _pudgyPenguinsOwnerUsed[wallet].push(_tokenId);
    ...
    function hasClaim(address wallet) public view returns(uint256[] memory) {
        return _pudgyPenguinsOwnerUsed[wallet];
    }
