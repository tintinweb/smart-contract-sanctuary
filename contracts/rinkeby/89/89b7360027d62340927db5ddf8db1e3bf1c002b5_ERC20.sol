...
contract ERC20 is IERC20, Owned {
    ...
    function transferFrom(address from, address to, uint value) external override returns(bool success) {
    ...
    function approve(address spender, uint value) external canApprove(spender, value) override returns(bool approved) {
