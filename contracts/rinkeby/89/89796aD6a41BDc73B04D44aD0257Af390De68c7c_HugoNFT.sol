...
/**
 * @title Hugo NFT
 * Hugo NFT - a contract for non-fungible tokens.
 */
contract HugoNFT is ERC721Tradable {
    ...
    event Buy(address buyer, string artworkID, uint256 orderNumber, uint256 tokenID, uint256 blockTime);

    constructor(address _proxyRegistryAddress)
    ERC721Tradable("Hugo NFT", "HUG", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://loclhost:5000/nft/info/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://localhost:5000/nft/contract";
    }
