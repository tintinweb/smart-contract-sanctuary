...
contract EnchantedElves is ERC721Enumerable, Ownable {
    ...
    uint public immutable maxPerMintPublicsale;
    uint public immutable maxPerMintPresale;
    ...
    constructor() ERC721("EnchantedElves", "ELVES") {
      allocGift = 50;
      allocPresale = 1000;
      allocMax = 9823; // gift + public
      pricePublicsale = 0.001 ether;
      pricePresale = 0.001 ether;
      maxPerMintPublicsale = 2;
      maxPerMintPresale = 2;
    ...
    function mintPublicsale( uint amount) external payable {
        ...
        require(totalSupply() + amount <= allocMax - allocGift, "Exceeding Publicsale limit");
        require(amount <= maxPerMintPublicsale, "Minting more than allowed in 1 transaction");
        ...
        external payable onlyWhitelisted(_v,_r,_s)
    {
        ...
        require(totalSupply() + amount <= allocPresale, "Exceeding total presale limit");
        require(amount <= maxPerMintPresale, "Minting more than allowed in one transaction | Presale");
        require(amount > 0,"Cant mint 0");
