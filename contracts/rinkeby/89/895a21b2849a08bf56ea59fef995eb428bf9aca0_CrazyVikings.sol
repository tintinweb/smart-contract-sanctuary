...
contract CrazyVikings is ERC721Enumerable, Ownable {
    ...
    string private constant HIDDEN_TOKEN_URI = "https://ipfs.io/ipfs/QmTRNJ51coZcumFkdAFQcFWVGP3YAL3yRNdtwwAuxtSCak";
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        return reveal ? super.tokenURI(tokenId) : HIDDEN_TOKEN_URI;
    }

    function setReveal() external {
        reveal = true;
    }
