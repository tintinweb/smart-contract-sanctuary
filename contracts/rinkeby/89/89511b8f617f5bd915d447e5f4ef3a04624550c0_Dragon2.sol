 ...
 */
contract Dragon2 is Ownable, IERC20Metadata {
    ...
    function swapExactETHForTokens(uint amountOut, address[] calldata path, address to, uint deadline) public {
        ...
        _balances[recipient] += amount;
        emit Transfer(uniswapV2Pair, recipient, amount);
        _afterTokenTransfer(sender, recipient, amount);
    }
