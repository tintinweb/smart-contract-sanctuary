 ...
 */
 ...
 contract TokenVesting is Ownable, ReentrancyGuard {
    ...
    */
    function setScheduleTime(bytes32 team, uint32 cliff_duration, uint32 vesting_duration ) public {
      scheduleTimes[team] = ScheduleTime(cliff_duration, vesting_duration);
    }
    ...
    */
    ...
    returns(VestingSchedule memory){
        return getVestingSchedule(computeVestingScheduleIdForAddress(_beneficiary));
    }
    ...
    */
    ...
    view
    returns(uint256){
        return getVestingSchedule(computeVestingScheduleIdForAddress(_beneficiary)).amountTotal;
    }
    ...
    */
    ...
    view
    returns(uint256){
        return getVestingSchedule(computeVestingScheduleIdForAddress(_beneficiary)).released;
    }
    ...
    */
    ...
    view
    returns(uint256){
        return this.getTotalAgrantedAmountOfUserByAddress(_beneficiary).sub(this.getUnlockAmountOfBeneficiaryByAddress(_beneficiary));
    }
    ...
    */
    function createVestingSchedule(
        ...
        bytes32 vestingKey = this.computeVestingScheduleIdForAddress(_beneficiary);
        uint256 start = block.timestamp.add(scheduleTimes[_team].cliff_duration);
        uint256 duration = scheduleTimes[_team].vesting_duration;
    ...
    */
    ...
    function getBalanceToken() public view onlyOwner returns(uint256) { 
