...
contract ERC1155UAE is Ownable, ERC1155Supply, ERC1155Pausable, ERC1155Burnable {
    ...
    constructor(
        ...
        require(bytes(name_).length != 0, "ERC1155UAE: Invalid name");
        require(bytes(symbol_).length != 0, "ERC1155UAE: Invalid symbol");
        require(releaseMintTo_ != address(0), "ERC1155UAE: Invalid release mint to address");
        require(releaseTokenId_ != 0, "ERC1155UAE: Invalid release token id");
        require(bytes(releaseTokenUri_).length != 0, "ERC1155UAE: Invalid release token URI");
    ...
    function updateRoyaltyParams(address royaltyAddress_, uint256 royaltyPercent_) external virtual onlyOwner {
        require(royaltyPercent_ <= _MAX_PERCENT, "ERC1155UAE: Invalid royalty percent");
