...
contract ProjectV2 is Project {
        ...
        override
    {
        ...
        EventsV3(address(eventsInstance)).contractorInvited(contractor);
    }
    ...
    function delegateContractor(bool _bool) external {
        ...
        EventsV3(address(eventsInstance)).contractorDelegated(_bool);
    }
        ...
        override
    {
        ...
        for (uint256 i = 0; i < _hash.length; i++) {
            ...
            // FIXME logic of funding
        }
        taskCount = _taskCount;
        EventsV3(address(eventsInstance)).tasksAdded(_taskCosts, _hash);
    }
    ...
    // FIXME check if the visibility can be changed to private
