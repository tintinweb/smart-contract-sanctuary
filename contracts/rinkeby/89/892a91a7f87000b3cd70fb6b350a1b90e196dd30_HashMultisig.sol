...
contract HashMultisig {
	...
	uint constant public DELAY = 2 days;
	...
	event NewTransaction(uint indexed transactionId, address indexed initiator, uint8 method, address to, uint amount, uint timeStamp);
