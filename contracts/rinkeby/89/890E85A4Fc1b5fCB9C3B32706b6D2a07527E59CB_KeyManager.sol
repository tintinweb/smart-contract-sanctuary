...
contract KeyManager is Context{
    ...
    event ExecutedRelayedCall(uint256 indexed  _value, address from,  bytes _data);
    ...
    external
    {
        ...
        (bool excuteCallSuccess,) = from.call{value: 0, gas: gasleft()}(_data); //(success, ) =
        require(excuteCallSuccess, "KeyManager.executeRelayedCall: Failed to call account");
        
        emit ExecutedRelayedCall(0, from, _data);
    }
}
