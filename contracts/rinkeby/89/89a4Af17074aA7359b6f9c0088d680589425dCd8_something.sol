...
contract something is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("something", "$$") {
    setHiddenMetadataUri("ipfs://QmY3RLsq9W5zdfSAK8SmFpzdbkC279waScA5rnoK7tj2GU/_metadata.json");
  }
