...
/**
 * @title   SynapseLiquidityMiningVesting
 * @notice  Synapse Network Liquidity Mining Vesting contract
 * @dev     Vesting is constantly releasing tokens every block every second
 */
contract SynapseLiquidityMiningVesting is SynapseMultiVesting {
    /**
