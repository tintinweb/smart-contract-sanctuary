...
contract PACFounder is ERC721 {
    ...
    string defaultMetadata = "QmVmTpmAK517aq7pEesCnekrjFUHN4JSZPw59sm53XHKwV";

    constructor (uint256 _floorPrice, uint256 _minStep, address payable _beneficiary) public ERC721 ("PAC DAO FOUNDER", "FPAC"){
        	currentId = 0;
