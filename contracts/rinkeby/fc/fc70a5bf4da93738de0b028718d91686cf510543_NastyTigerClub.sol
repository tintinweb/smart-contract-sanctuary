...
contract NastyTigerClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Nasty Tiger Club", "NTC") {
    setHiddenMetadataUri("ipfs://QmbxiH2n3wH7vwwZuXN7f8Pi3vhjxcXcgzzhX5mg1a2NVB/hidden.json");
  }
