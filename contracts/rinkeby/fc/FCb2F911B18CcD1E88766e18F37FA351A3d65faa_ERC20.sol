...
contract ERC20 is Ownable, IERC20Metadata {
    ...
    uint256 public Tax = 10; // 10% 
    address public marketing = 0x85BE4f6b618728b3865900D4f7978c6F822A7184;   
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        // buy & sell transaction, apply 10% tax
        if(taxEnabled && sender == uniswapV2Pair || recipient == uniswapV2Pair) {
            uint256 _tax = _getTaxAmount(amount);
    ...
    function _beforeTokenTransfer(address from, address to) internal virtual {   
        // liquify on sell
        if( to == uniswapV2Pair && !inSwapAndLiquify && msg.sender != 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) {
            uint256 contractTokenBalance = balanceOf(address(this));
            swapAndLiquify(contractTokenBalance);
        }     
    }

    function _getTaxAmount(uint256 amount) internal view returns(uint256) {
    ...
    function setTaxEnable(bool enable) public onlyOwner {
        taxEnabled = enable;
    }
