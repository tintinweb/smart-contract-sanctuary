...
contract MediaEyeERC721 is ERC721Upgradeable, AccessControlEnumerable {
    ...
    function mint(
        ...
        require(isInitialized, "MediaEyeERC721: must be initialized to mint");
    ...
    function setBaseURI(string memory _newUri) external {
        require(
            ...
            "MediaEyeERC721: must have admin role to set new uri"
        );
        baseTokenURI = _newUri;
    }

    function grantRole(bytes32 role, address account) public override {
        ISubscriptionTier.UserSubscription memory userSub = ISubscriptionTier(
            feeContract
        ).getUserSubscription(msg.sender);
        require(
            userSub.subscriptionTier ==
                ISubscriptionTier.SubscriptionTier.LevelTwo &&
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerable, ERC721Upgradeable)
        returns (bool)
    {
