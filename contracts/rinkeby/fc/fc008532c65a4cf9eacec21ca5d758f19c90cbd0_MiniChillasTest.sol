...
contract MiniChillasTest is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            require(ownerMintedCount + _mintAmount <= whitelistedAddresses[msg.sender], "max NFT per address exceeded");
        }
