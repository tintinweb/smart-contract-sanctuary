...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        string private IPFSTokenURI = "ipfs://QmfKaEbbGEdJSDrNEMQV9uUtjXZ1tYBPqk8VpBsKdecqRD/";
        ...
        constructor(
            ...
            payableAddresses.push(0xE01961C26b8F2720783FACA6Fb894f45642de30D);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 10');
    ...
    // File: contracts/fireCryNftX1Contract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract FireCryNftX1Contract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Fire Cry NFT X1", "FCRYX1", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/c7UeUhEdvolMtE4ZMBoL/contract-metadata";
        }
    }