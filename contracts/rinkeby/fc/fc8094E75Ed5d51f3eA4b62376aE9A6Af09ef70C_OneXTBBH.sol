...
contract OneXTBBH is ERC20PresetMinterPauser, Auth {
    ...
    uint256 distributorGas = 8000000;
...
contract DividendDistributor is IDividendDistributor {
    ...
    address Dividend = 0x03fF0ff224f904be3118461335064bB48Df47938;
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = 0; //Dividend.balanceOf(address(this));
        ...
        uint256 amount = 0; //Dividend.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            payable(shareholder).transfer(am);
