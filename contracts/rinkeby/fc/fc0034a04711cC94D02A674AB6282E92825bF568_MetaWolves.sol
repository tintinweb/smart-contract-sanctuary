...
contract MetaWolves is ERC721Enumerable {
    ...
    constructor () ERC721("MetaWolves", "MWL") {
        mintLimits.push(MintLimit(1643205600, 1, 68));
        mintLimits.push(MintLimit(0, 215, 215));
        baseURIRoots.push(BaseURIRoot(0, "ipfs://bafybeihhv63xnmjnjl4zabasirvzze7keoxpse7yqwo6soaqbmgy64wyna/"));
        baseURIRoots.push(BaseURIRoot(6, "ipfs://bafkreig7vzyp6q4gqxcfdq26s3qb3lufk7c4rktvjgfu4t7jsi2hmxmkoq/?"));
