...
contract Flava is ERC721, Pausable, Ownable {
    ...
    string _baseTokenURI = 'https://flava.tools/api/metadata/';

    uint256 private _price = 0.59 ether;
    uint256 private _available_supply = 200;
    uint256 TOTAL_SUPPLY = 1000;
    uint256 private _founder_supply = 20;

    event Mint(address indexed _address, uint256 tokenId);

    constructor() ERC721("FlavaToolsGas", "FLVA3") {
