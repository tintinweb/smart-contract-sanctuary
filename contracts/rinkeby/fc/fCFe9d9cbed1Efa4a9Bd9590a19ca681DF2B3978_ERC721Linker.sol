...
contract ERC721Linker is ERC721, RoyaltiesV2, AbstractRoyalties, Ownable {
    address internal creator;
    LibPart.Part[] internal defaultFees;
    ...
    function batchMint(uint8 _amount) external onlyOwner {
        ...
        for (uint8 i = 0; i < _amount; i++) {
            _mint(creator, total + i);
            // _saveFees(total + i, defaultFees);
            // creators[total + i] = [creator];
        }
    }
}
