...
contract Peps is ERC721, ERC721Enumerable,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    address payable private _teamAddress1 = payable(0x4c1eE086DDDf00C291F24a833bD66cd0780E961B);
    address payable private _teamAddress2 = payable(0x4109078F99BF8772706Dd061005A05935aB67609);
    
    uint16 public constant maxSupply = 10000;
    string private _baseTokenURI;
    
    uint256 public _startDate = 1630404000;
    ...
    function contractURI() public view returns (string memory) {
        return "https://ipfs.io/ipfs/QmVBVpH5zJiWpkJCRvY9Zwov5DL3TW4xqG6gH66TF57n8G";
    }
    ...
    function withdraw() public onlyOwner {
        ...
        _teamAddress1.transfer(amount / 2);
        _teamAddress2.transfer(amount / 2);
    }
}