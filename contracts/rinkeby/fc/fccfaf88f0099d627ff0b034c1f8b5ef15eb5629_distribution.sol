...
contract distribution{
    ...
    function getTokenA(uint256 _amount) payable public returns(uint256)
    {
        ...
        EthUser[msg.sender].tokenAmount1=((EthUser[msg.sender].amountETH).mul(oneETHPrice));// decimal conversion
    ...
    function getTokenB(uint256 _amount) payable public returns(uint256)
    {
        ...
        BtcUser[msg.sender].tokenAmount2 = ((BtcUser[msg.sender].amountBTC).mul(oneBTCPrice));//decimal conversion
