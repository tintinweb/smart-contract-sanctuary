...
contract InsuracePositionController is AbstractController {
    ...
    function __InsuracePositionController_init(
        ...
        IERC20(_stakingAssetAddress[0]).approve(address(_stakingController), PreciseUnitMath.MAX_UINT_256);
    ...
    */
    ...
    function withdrawRewards() external override {
        ...
        //apply fee
        base.transferFrom(address(this),feeInfo.feeRecipient, _fee);
        ...
        uint256 baseTokenAmount = _buyInsuraceAsset(
            rewardsBalance,
            address(_insurToken),
            address(base)
        );
