...
contract XRC is ERC721, Ownable, ReentrancyGuard {
    ...
    // TODO update max supply
    uint256 public constant MAX_SUPPLY = 20;
    // TODO update reserve count
    ...
    address private w1 = 0x859957c556434e8D89771A82e1A2836150A80fc3;
    address private w2 = 0xde7bd280B1b7a87DdFD880A71250ED416c1B3112;
    address private w3 = 0x2982F097a68AB6caf16508FC1E17B7470c5AB71E;
    ...
    function withdraw() external nonReentrant onlyOwner {
        ...
        (bool success1, ) = payable(w1).call{value: v1}("");
        (bool success2, ) = payable(w2).call{value: v2}("");
        (bool success3, ) = payable(w3).call{value: v3}("");
