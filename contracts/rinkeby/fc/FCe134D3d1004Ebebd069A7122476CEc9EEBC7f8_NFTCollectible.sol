...
contract NFTCollectible is ERC1155Tradable {
  ...
  function contractURI() public view returns (string memory) {
    string memory baseURL = "https://metadata-testnets.tahu.digital/c/";
    string memory contract_address = string(abi.encodePacked(address(this)));
    return Strings.strConcat(baseURL,contract_address);
  }
