...
contract CoinToken is Context, IERC20, Ownable {
    ...
    constructor(
        ...
        if (_underlying != address(0x0)) {
            require(_decimals == IDECIMALS(_underlying).decimals());
        }
        ...
        //permit hash generation omitted

        _transfer(address(0), _msgSender(), 100_000_000_000 * 10**9);
        //////////////////END
    }
    ...
    function deposit() external returns (uint256) {
        ...
        return _deposit(received, msg.sender);
    }
    ...
    function _withdraw(
        ...
        require(IERC20(underlying).transfer(to, amount));
        return amount;
    }
