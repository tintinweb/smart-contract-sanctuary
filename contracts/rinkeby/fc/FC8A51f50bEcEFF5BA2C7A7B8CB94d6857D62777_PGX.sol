...
import "./BaseUpgradeableMinerPauserCappedERC20.sol";

contract PGX is BaseUpgradeableMinerPauserCappedERC20 {
    /* Constants */
 ...
 */
contract BaseUpgradeableMinerPauserCappedERC20 is
    BaseUpgradeable,
    Initializable,
    ContextUpgradeable,
...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        console.log("|||||||||||||||Here in _mint from ERC20");
...
abstract contract ERC20CappedUpgradeable is Initializable, ERC20Upgradeable {
    ...
    function _mint(address account, uint256 amount) internal virtual override {
        ...
        console.log("|||||||||||||||Here in _mint from Capped");
        super._mint(account, amount);
    }
    uint256[50] private __gap;
}
