...
contract EtalonToken is LimboContract("Etalon", "ETA") {
    ...
    uint256 constant MAX_PRICE_FALL_PERCENT = 2e16; // 1e18=100% the maximum accepted percentage as a price movement for a single transaction from the account
    uint256 constant MAX_FALL_PERCENT_GLOBAL = 5e16; // (1%)the maximum accepted percentage as a price movement for multiple transactions
...

{
  ...
  "libraries": {
    "contracts/GlobalLimits.sol": {
      "GlobalLimits": "0x9885a9152395ea34b98ea024e2eebcf9a0e5b1a8"
    },
    "contracts/SellLimit.sol": {
      "SellLimit": "0x6decb646810c2e7dfd935a3638a11f3c70ddc38b"
    }
  }
}