...
contract sOlympus is ERC20Permit, Ownable {
    ...
    constructor(address _staking) ERC20("Staked Olympus", "sOHM", 9) {
    ...
    function rebase(uint256 amount) public onlyMonetaryPolicy() returns (uint256) {
        uint256 _rebase;
        ...
        if(circulatingSupply() > 0 ){
            _rebase = amount.mul(_totalSupply).div(circulatingSupply());
        }
