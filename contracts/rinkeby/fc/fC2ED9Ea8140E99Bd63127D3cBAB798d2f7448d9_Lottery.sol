...
contract Lottery is VRFConsumerBase, Ownable{
    ...
    function endLottery() public onlyOwner {
        ...
        bytes32 requestId = requestRandomness(keyHash, fee); // can omit "bytes32 requestId =" -- will still work the same
    }
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        ...
        uint256 randomResult = _randomness % players.length;
        recentWinner = players[randomResult];
