...
contract TestToken is IERC20, Ownable {
    ...
    string public constant name = "Test Dao Token";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 10, "transaction fee percentage exceeds 10");
        require(feePercentage_ >= 0, "transaction fee percentage equals 0");
