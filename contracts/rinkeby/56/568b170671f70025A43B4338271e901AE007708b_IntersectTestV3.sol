...
contract IntersectTestV3 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable {
    function initialize() initializer public {
        __ERC20_init("Intersect Test V3", "XTV3");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("Intersect Test V3");
    }
