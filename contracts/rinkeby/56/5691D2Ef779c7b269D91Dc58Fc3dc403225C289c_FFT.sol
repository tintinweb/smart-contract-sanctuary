...
contract FFT is ERC721PresetMinterPauserAutoIdUpgradeable, IGameTokens {
    ...
    function initialize(address gameCardsAddress) public initializer {
        require(gameCardsAddress != address(0), "FFT: gameCards address is required"); 
        gameCards = IGameCards(gameCardsAddress);
        ERC721PresetMinterPauserAutoIdUpgradeable.initialize("Football Fantasy Token", "FFT","https://api.footballfantasy.io/v1/cards/"); 
    }
    ...
    function getGameCardsSender()
        external
        view
        returns (address)
    {
        return gameCards.getSender();
    }
