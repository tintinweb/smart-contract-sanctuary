...
contract Staking is Ownable, ReentrancyGuard {
    ...
    uint256 public minStakingAmount = 1000000000000000000000; // Minimal amount for staking
    uint256 public constant lockPeriod = 5760; // Number of blocks that must be passed to get the opportunity for claim and unStake
