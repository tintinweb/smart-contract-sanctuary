...
contract ITR is  ERC721, Ownable, RandomlyAssigned {
    ...
    uint public txFeeAmount = cost * 0.05 ether;
    ...
    function transferFrom(
      ...
      uint256 tokenId
        ...
        if(msg.sender != owner() || msg.sender != _artist){
            _payTxFee(from);
        }
    ...
    function _payTxFee(address from) internal {
      ...
      token.transferFrom(from, _artist, txFeeAmount);
    }
