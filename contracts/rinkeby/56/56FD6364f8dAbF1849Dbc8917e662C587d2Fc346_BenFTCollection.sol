...
contract BenFTCollection is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    uint public presaleStart = 1635490719; // November 6th 9AM EST
    uint public presaleEnd = 1635491100;   // November 6th 12PM EST
    uint public publicSale = 1635491100;   // November 6th 12PM EST
        ...
        PaymentSplitter(team, team_shares)
    {
        ...
        // teamClaimNFTs
        accounts[admins[0]] = Account( 100, 0, 0, false, false); // Jim 
        accounts[admins[1]] = Account( 50, 0, 0, false, false);
