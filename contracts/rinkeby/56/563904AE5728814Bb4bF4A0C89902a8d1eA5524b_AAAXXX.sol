...
contract AAAXXX is ERC721, ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint256 public maxAirdropAmount = 2;
    ...
    address devAddr = 0xcea1195A82013fFb50CbCbe122844F76887bE91C;
    address withdrawAddr = 0x2a588Bf6754E23eD315AAaBDcfd3beCE75D0a2B3;
    ...
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("AAAXXX", "AAAXXX") { 
    ...
    function withdraw() external onlyOwner {
        uint256 balance = address(this).balance;
        require(balance > 0);
        payable(devAddr).transfer((balance * 100) / 1000); //10%
        payable(withdrawAddr).transfer((balance * 900) / 1000); //90%
    }
