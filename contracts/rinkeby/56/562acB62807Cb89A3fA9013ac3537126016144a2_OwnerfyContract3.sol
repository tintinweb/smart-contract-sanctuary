...
contract OwnerfyContract3 is Context, AccessControlEnumerable, ERC1155Burnable {
  ...
  // CIDs
    mapping (uint256 => bytes32) private cids;
     ...
     */
    function mint(address to, uint256 id, uint256 amount, bytes memory data, string calldata _update, bytes32 cid) public virtual {
     ...
     */
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data, string[] calldata updates, bytes32[] memory _cids) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "Ownerfy: must have minter role to mint");
    ...
    // Change to the creator of a token can set a new uri for a token
    ...
    function uri(uint256 _id) public view virtual override returns (string memory) {
      ...
      return string(abi.encodePacked('https://gateway.pinata.cloud/ipfs/Qm', bytes32ToString(cids[_id])));
    }
