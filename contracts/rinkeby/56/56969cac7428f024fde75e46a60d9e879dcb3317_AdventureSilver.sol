...
contract AdventureSilver is Context, Ownable, ERC20 {
    ...
    address public blootContractAddress = 0x35DAC5FC44B7f881fE05bd646769B84c37Eb5Db5;
    address public lootContractAddress = 0x80Bb9F365d280C711864cc1cd222F02f40f54A50;
    ...
    */
    ...
    constructor() Ownable() ERC20("Adventure Silver", "ASLD") {
    ...
    /// Gold in batches.
    function claimAllBlootForOwner() external {
    ...
    /// this is a concern, you should use claimRangeForOwner and claim Based
    /// Gold in batches.
    function claimAllLootForOwner() external {
