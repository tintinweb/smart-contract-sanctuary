...
//vrf coordinator    // rinkeby: 0xb3dCcb4Cf7a26f6cf6B120Cf5A73875B7BBc655B
//vrfcoordinator   // rinkeby: 0x01BE23585060835E02B77ef475b0Cc51aA1e0709a
...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase {
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(
            ...
            "ERC 721: transfer caller is not owner"
        );
