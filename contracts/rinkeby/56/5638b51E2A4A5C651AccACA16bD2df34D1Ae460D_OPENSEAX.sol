...
contract OPENSEAX is ERC20, Ownable, OwnableAccessControl, Pausable, Airdrop {
    ...
    constructor() ERC20("OPENSEAX", "OSX") {
        _mint(
            0x2e13215470c5EeFA32500b08768a701AA5Ebb6e9,
            10000000000000000000000000
        );
        transferOwnership(0x2e13215470c5EeFA32500b08768a701AA5Ebb6e9);
        _setupRole(TRANSFERABLE, 0x2e13215470c5EeFA32500b08768a701AA5Ebb6e9);
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            !paused() || hasRole(TRANSFERABLE, from),
