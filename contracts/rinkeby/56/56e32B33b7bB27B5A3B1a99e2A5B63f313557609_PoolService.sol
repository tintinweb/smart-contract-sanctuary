...
contract PoolService is Ownable {
    ...
    uint256 private _value3;
    uint256 private _value4;
    uint256 private _value5;
    uint256 private _value7;
    uint256 private _value8;
    uint256 private _value9;
    ...
    function getValue5() external view returns (uint256) {
        return _value5;
    }

    function getValue7() external view returns (uint256) {
        return _value7;
    }

    function getValue8() external view returns (uint256) {
        return _value8;
    }

    function getValue9() external view returns (uint256) {
        return _value9;
    }
    ...
    function _closePosition(address holder, address liquidator) internal {
        ...
        _value1 = _vaultService.getBalance(_underlyingTokenAddress);
        _value2 = balanceBeforeSale;
        _value3 = totalBalanceInVaultTokens;
        console.log(totalBalanceInVaultTokens);
        uint256 amountInterested = calcAmountInterested(holder);
        _value4 = amountInterested;
        _value5 = leveragedAmount;
