...
contract Plasma is ERC20Burnable, Ownable {
    ...
    function getMessage1() public view returns(address) {
        return msg.sender;
    }
    function getMessage2(uint256 tokenId) public view returns(address) {
        return IERC721(A51Address).ownerOf(tokenId);
    }
    function getMessage3(uint256 tokenId) public view returns(address) {
