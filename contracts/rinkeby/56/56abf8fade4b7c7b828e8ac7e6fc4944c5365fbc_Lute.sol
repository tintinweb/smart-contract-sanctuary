...
contract Lute is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: rgb(25, 25, 25); font-family: Courier; font-size: 12px; }</style><rect width="100%" height="100%" fill="rgb(245, 244, 243)" /><text x="10" y="20" class="base">GNRE: ';
