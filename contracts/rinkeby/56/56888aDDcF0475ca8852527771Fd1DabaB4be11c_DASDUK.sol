...
contract DASDUK is ERC721A, Ownable, Pausable {
    ...
    function promoMint() public onlyOwner {
        ...
        _safeMint(0x8aa986eB2F0D3b5001C9C2093698A4e13d646D5b, 32); // Thorne
        _safeMint(0xb7940060B6AbD40d2EC723e95A3EA03bF569cDCf, 20); // Yapein
        _safeMint(0x2351bbfAD2a6Cfd217b8c9ae6C390F495d298097, 24); // Cupid
        _safeMint(0x9f3Ef50Ea64ADAD5B33F1F8222760CFBF42007F7, 24); // AlphaSerpentis
    }
