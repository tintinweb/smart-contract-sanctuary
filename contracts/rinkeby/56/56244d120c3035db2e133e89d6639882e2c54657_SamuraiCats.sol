...
// hevm: flattened sources of src/SamuraiCats.sol
...
contract SamuraiCats is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mintPrivateSale(uint256 numOfToken)
        external
        payable
        onlyPrivateSaleList
        nonReentrant
    ...
    function mintPreSale(uint256 numOfToken)
        external
        payable
        onlyPreSaleList
        nonReentrant
    {
        ...
        require(
            !_preSaleWalletTxStatus[msg.sender],
            "MINT: you already done presale"
        );
    ...
    function _mintToken(
        ...
        require(totalSupply() + numOfToken <= limit, "MINT: reach limit");
