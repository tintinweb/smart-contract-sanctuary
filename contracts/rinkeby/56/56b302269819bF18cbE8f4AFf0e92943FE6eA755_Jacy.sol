...
contract Jacy is Context, IERC20, Ownable {
    ...
    uint256 public rewardFeePercent = 40;
    ...
    address public rewardWallet = 0x4073e060dcbd9Ff47fd3E3d479405A079093aCfD;
    ...
    function setFees(uint256 taxFee_, uint256 marketingFee_, uint256 rewardFeePercent_, uint256 liquidityFee_,
                    uint256 distSharePercentage, uint256 SwapThresholdAmount_) external onlyOwner {
        taxFee = taxFee_;
        marketingFeePercent = marketingFee_;
        rewardFeePercent = rewardFeePercent_;
    ...
    function setWallets(address _marketingWallet, address _rewardWallet) external onlyOwner {
    ...
    function distributeShares(uint256 balanceToShare) private {
        ...
        uint256 rewardShare = balanceToShare.mul(rewardFeePercent).div(100);
        
        payable(marketingWallet).transfer(marketingshare);
        payable(rewardWallet).transfer(rewardShare);
