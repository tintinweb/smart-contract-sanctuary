...
contract CryptoFartPunks is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    string internal _baseTokenURI = "ipfs://QmVqjRjZA8AE1DQBuvRNgKe4C8W65sMfwt9QKDzb9FVeCW/";
    ...
    address litquidityAddress = 0x0000000000000000000000000000000000000000;
    ...
    function withdraw() public onlyOwner {
        ...
        payable(devAddress).transfer(balance/3.0);
        payable(creator1Address).transfer(balance/3.0);
        payable(creator2Address).transfer(balance/3.0);
        // payable(litquidityAddress).transfer(balance/4.0);
    }
}
