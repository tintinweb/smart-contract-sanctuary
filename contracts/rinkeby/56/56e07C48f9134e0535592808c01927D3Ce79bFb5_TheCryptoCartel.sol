...
contract TheCryptoCartel is ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Pausable, AccessControl {
    ...
    function setRevealStatus(bool _reveal) public onlyRole(DEFAULT_ADMIN_ROLE) {
        reveal = _reveal;
    }
    ...
    function mint(uint numberOfTokens, string[] memory uris) public payable {
        uint256 ts = totalSupply();
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            _safeMint(msg.sender, tokenId);
            /**
             * The uris param will contain random metadata jsons
             * The number of uris in it will be equal to numberOfTokens
             * Once a uri is used it should not be passed here again
             */
