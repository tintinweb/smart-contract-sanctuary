...
contract APMRegistryFactory is APMInternalAppNames {
    ...
    constructor(
        ...
        ENS _ens,
        ENSFactory _ensFactory // DAO initialized without evmscript run support
    ) public {
        daoFactory = _daoFactory;
    ...
    function configureAPMPermissions(
        ACL _acl,
        APMRegistry _apm,
        address _root
    ) internal {
