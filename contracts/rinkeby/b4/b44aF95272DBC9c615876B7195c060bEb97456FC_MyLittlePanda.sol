...
contract MyLittlePanda is ERC721, Ownable {
    ...
    uint256 public TOKEN_PRICE = 0.0125 ether;
    ...
    function setMaxPublic(uint64 maxTokens) external onlyOwner {
        MAX_SUPPLY = maxTokens;
    }
    function setMaxPerTxn(uint64 maxTokens) external onlyOwner {
