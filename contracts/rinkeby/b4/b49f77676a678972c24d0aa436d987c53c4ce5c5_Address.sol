...
// SPDX-License-Identifier: MIT
    ...
    abstract contract Ownable is Context {
        ...
        constructor () {
            _owner = 0x7440a27C580e83F0CE918226cd1c35DcB619BcFC; // should this msg.sender
    ...
    contract LEAP is Context, IERC20, Ownable {
        ...
        address private _developmentWalletAddress = 0x1Dd80cf2E26ec6727e0f281927BD05967e3CCa54;
        address payable private _teamAddress;
        uint256 private constant MAX = ~uint256(0);
        uint256 private _tTotal = 20000000000000000 * 10**18;
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;
        string private _name = "Leap Lottery Token";
        ...
        uint256 public _maxTxAmount = 20000000000000000 * 10**18;
        uint256 private numTokensSellToAddToLiquidity = 20000000000000000 * 10**18;
        ...
        constructor () {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xBf1bCB70C0e0F26A5E4d4744b1bC24d5355C4F90);
        ...
        function _transfer(address from, address to, uint256 amount) private {
            ...
            if(from != owner() && to != owner()) {
                ...
                if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                    ...
                    calculateTaxFee(sellnumber[from]);
                }
            bool takeFee = true;
