...
contract Staker {
  ...
  modifier contractNotCompleted() {
      require (!exampleExternalContract.completed(), "Contrarct is not complete");
      _;
  }
 ...
 function withdraw() public payable contractNotCompleted() {
     require(block.timestamp > deadline, "Deadline not yet reached");
     require(balances[msg.sender] > 0, "You haven't deposited");
     require(address(this).balance < threshold, "Threshold was met, execute instead.");
  ...
  function execute() public contractNotCompleted() {
