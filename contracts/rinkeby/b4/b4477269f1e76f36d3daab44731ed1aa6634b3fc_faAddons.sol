...
contract faAddons is Ownable, ERC721, ERC721Enumerable {
    ...
    function newBattlePoints(uint16 _fromId, uint16 _toId) external view returns (uint32,uint32,uint32,uint32,uint32) {
       ...
       // uint randomLuck = uint256(keccak256(abi.encodePacked(block.timestamp+1 days, msg.sender)));
        ...
        return (fromStats.life, fromStats.armour, fromStats.attack, fromStats.defence, fromStats.luck); 
       /*      
