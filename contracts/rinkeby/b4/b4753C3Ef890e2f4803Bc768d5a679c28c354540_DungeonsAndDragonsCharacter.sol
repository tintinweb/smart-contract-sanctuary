...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase, Ownable {
    ...
    function battle() public{
        // if(characters[tokenId].experience == 255){
        //     levelUp(tokenId);
        // }
    }
    ...
    function getTotalCharacterNumber() public view returns (uint256) {
        ...
        )
    {
        return (
            ...
            characters[tokenId].level, //getLevel(tokenId) 
    ...
    // function sqrt(uint256 x) internal view returns (uint256 y) { // karekok ama 25ten 36ya kadar da 5 vermeye devam ediyo
    //     uint256 z = (x + 1) / 2;
    //     y = x;
    //     while (z < y) {
    //         y = z;
