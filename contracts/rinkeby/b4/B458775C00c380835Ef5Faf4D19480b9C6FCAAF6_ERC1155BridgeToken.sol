...
// File: contracts/tokens/ERC1155BridgeToken.sol
...
contract ERC1155BridgeToken is ERC1155, IBurnableMintableERC1155Token {
    ...
    function mintSingle(address _to, uint256 _id, uint256 _value) external onlyBridge {
        _mint(_to, _id, _value, new bytes(0));
    }
