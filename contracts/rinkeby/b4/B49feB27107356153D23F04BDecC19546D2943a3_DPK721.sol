...
contract ERC721 is Context, IERC165, IERC721, IERC721Metadata {
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view returns (bool) {
        ...
        address owner = ERC721.ownerOf(tokenId);
        return (spender == owner || getApproved(tokenId) == spender || isApprovedForAll(owner, spender) || (msg.sender == address(marketplace)));
    }
...
contract DPK721 is HonHuangMarket {
    ...
    function buyBox() payable public returns(uint) {
        require(msg.value >= bnbPrice, 'BNB not enough');
	...
	constructor(address usdtAddress, address _proxyRegistryAddress) public ERC721Tradable("Dont play with kitty", "DPK", 7000, _proxyRegistryAddress) {
		_setBaseMetadataURI("https://yanyi-test.oss-cn-hangzhou.aliyuncs.com/");
		usdtERC20 = USDTERC20(usdtAddress);
	}
