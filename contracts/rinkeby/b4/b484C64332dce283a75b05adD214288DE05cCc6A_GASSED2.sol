...
contract GASSED2 is Context, ERC721Enumerable, ERC721Burnable, Ownable {
    uint internal constant MAX_MINTS_PER_TRANSACTION = 20;
    uint internal constant TOKEN_LIMIT = 500;
    ...
    address payable internal devteam = payable(0x1a96946959E3D5e9CE3f544424F90BA80eAD9d49); 
    address payable internal seaneen = payable(0x630cE4d80eF8712DFFd1A38fe390683b675Ab48a);
    address payable internal markos = payable(0xc4c746E4783E2eCd4610dC798874a8a765a724C0);
    address payable internal leeroy = payable(0x630cE4d80eF8712DFFd1A38fe390683b675Ab48a);
    ...
    */
    function ToDevs() external onlyOwner {
        ...
        require(devSupplyAwarded < 10,"Dev supply already awarded");
        uint i;
        uint id;
