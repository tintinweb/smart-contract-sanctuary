...
contract NFETH is ERC721, ERC721Enumerable, Ownable {
  ...
  uint256 public wrapAmount = 0.0001 ether;
  uint256 public price = 0.00002 ether;
  uint256 public halfPrice = 0.00001 ether;
  address public creatorRecipient = 0xb397e4b169EF902C9e84065620f5bC9c53F2ee35;
  address public donationRecipient = 0x71C7656EC7ab88b098defB751B7401B5f6d8976F; //Etherscan donation address
  ...
  function withdrawFees() public onlyOwner {
    ...
    sold = 0; //reentrancy guard - only collects correct amount of fees
    (bool donationFee, ) = donationRecipient.call{value: withdrawAmount*halfPrice}(""); //0.01 eth per mint
    (bool creatorFee, ) = creatorRecipient.call{value: withdrawAmount*halfPrice}(""); //0.01 eth per mint
