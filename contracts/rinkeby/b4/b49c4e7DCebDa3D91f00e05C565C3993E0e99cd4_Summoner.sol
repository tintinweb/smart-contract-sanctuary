...
ReentrancyGuardUpgradeable
{
    ...
    nonReentrant
    {
        ...
        require(remoteDestinationAddress != address(0), "DEST ADDRESS");
        ...
        require(IERC721Upgradeable(sourceNFTAddress).ownerOf(sourceNFTId) == msg.sender, "NOT OWNER");
        ...
        bytes32 _id = _generateId(chainId);
        ...
        if (remoteNetworkID == originalNetworkId && mosaicNftAddress == sourceNFTAddress) {
        ...
        // take fees
        _takeFees(sourceNFTAddress, sourceNFTId, _id, remoteNetworkID, feeToken);
    }
    ...
    function preMintNFT(uint256 n) external onlyOwner {
        require(mosaicNftAddress != address(0), "MOSAIC NFT NOT SET");
