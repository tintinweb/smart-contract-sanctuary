    ...
    *
    ...
    onlyReceiptOwner(_receiptId) receiptExist(_receiptId) 
       external override  payable returns (uint tokenAmount, uint amountETH, uint liquidity){
        ...
        curveParameters[_erc20Token] = CurveRules(msg.value,_amountTokenDesired,msg.value,_rRatio,lastPrice,(IERC20(_erc20Token).totalSupply()),lastPrice.mul(IERC20(_erc20Token).totalSupply()),_maxCap,_rRtype,0);
