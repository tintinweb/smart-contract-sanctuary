...
contract Ticketing is ERC721URIStorage {
    ...
    constructor() public ERC721("Ticketing", "TKT") {}
    ...
    function createEvent(string memory eventName) public returns (uint256) {
        // validate event data to see if it's valid
        // if not, return error.
        _eventIds.increment();

        uint256 newEventId = _eventIds.current();
        events[newEventId] = eventName;
        return newEventId;
    }

    function getEvent(uint256 eventId) public view returns (string memory) {
    ...
    function buyTicket(
        ...
        uint256 newtokenId = tokenId * eventId;
