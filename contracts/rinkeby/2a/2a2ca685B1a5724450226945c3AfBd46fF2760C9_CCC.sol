...
contract CCC is ERC721Enumerable, Ownable {
    using Strings for uint256;


    string private _tokenBaseURI;
    // uint256 public giftedSupply = 5; // -- local
    // uint256 public preSaleSupply = 10; // -- local
    // uint256 public publicSupply = 85; // -- local
    uint256 public giftedSupply = 5; // -- rinkeby
    uint256 public preSaleSupply = 5; // -- rinkeby
    uint256 public publicSupply = 25; // -- rinkeby
    // uint256 public giftedSupply = 100; // -- mainnet
    // uint256 public preSaleSupply = 1000; // -- mainnet
    // uint256 public publicSupply = 8900; // -- mainnet
    uint256 public collectionSupply = giftedSupply + preSaleSupply + publicSupply;
    uint256 public price = 0.01 ether;
    uint256 public maxMint = 20;
    
    // address public wallet1 = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8; // -- local test address 
    // address public wallet2 = 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC; // -- local test address 
    address public wallet1 = 0xB070F8fee8e4B4107c6539258A5241d0De5a590B; // -- rinkeby test address
    address public wallet2 = 0x9bc655e67241f3DDE1d7Ba518042129396Ef36A5; // -- rinkeby test address
