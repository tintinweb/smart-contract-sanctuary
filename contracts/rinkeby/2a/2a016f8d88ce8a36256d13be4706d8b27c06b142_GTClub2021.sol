...
contract GTClub2021 is ERC721, Ownable, PaymentSplitter, RandomlyAssigned {
  ...
  uint256 public constant PreSale_Cost = 0.03 ether;
  uint256 public constant PreSaleNum = 2000;
  uint256 public constant Sale_Cost = 0.07 ether;
  uint256 public constant SaleNum = 5000;
  uint256 public constant FinalSale_Cost = 0.11 ether;
  uint256 public constant Save_NFT = 10;
  uint256 public constant Reserv_NFT = 1000;
  uint256 public constant NFT_Collection = 10000;
  ...
  constructor() 
    ERC721("Gentle Tiger Club", "GTC2022")
    PaymentSplitter(payeeAddresses, payeeShares)
    RandomlyAssigned(NFT_Collection, 1) // Max. 10000 NFTs available; Start counting from 1 (instead of 0)
    {
      for (uint256 a = 1; a <= Save_NFT; a++) {
