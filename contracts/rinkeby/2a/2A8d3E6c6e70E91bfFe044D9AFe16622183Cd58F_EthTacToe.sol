...
contract EthTacToe {
    ...
    function ShowSampleBoard(uint8 Typeanumberhere) public view returns(string memory, string memory, string memory, string memory, string memory, string memory, string memory, string memory, string memory, string memory){
