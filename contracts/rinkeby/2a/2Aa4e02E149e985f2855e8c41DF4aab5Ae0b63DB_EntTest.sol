...
contract EntTest is Itest, ERC721Enumerable, Ownable, Pausable {
  ...
  function burnAndRecycle(uint256 tokenId) external payable {
    require(msg.sender == tx.origin, "Cannot use a contract for this");
    require(nttzToken.balanceOf(msg.sender) <= burnNTTZ, "You don't have enough NTTZ to perform this action");
