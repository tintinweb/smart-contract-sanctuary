  ...
  function configureFee(
   ...
   function swapExactTokensForTokens(
    ...
    function swapTokensForExactTokens(
        ...
        swapRouter.swapTokensForExactTokens(amountOut,amountSubFee,path,to,deadline);
    ...
    function swapETHForExactTokens(
       ...
       uint deadline
        ...
        require(msg.value > 0 && msg.value > swap_fee,"C98Swap: Fee not enough");
        uint[] memory outputAmount =  swapRouter.swapETHForExactTokens{ value: amountSubFee }(amountOut,path,to,deadline);

        payable(msg.sender).transfer(outputAmount[0]);
    ...
    function swapTokensForExactETH(
       ...
       uint deadline
        ...
        swapRouter.swapTokensForExactETH(amountOut,amountSubFee,path,to,deadline);
        FeeInfo storage feeInfo = FeeInfos[path[0]];
