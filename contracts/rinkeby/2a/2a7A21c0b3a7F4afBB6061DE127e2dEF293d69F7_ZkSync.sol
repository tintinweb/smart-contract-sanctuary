...
contract ZkSync is UpgradeableMaster, Storage, Config, Events, ReentrancyGuard {
    ...
    function upgrade(bytes calldata upgradeParameters) external nonReentrant {
        ...
        RegenesisMultisig multisig = RegenesisMultisig(0xAA7113B9de498556dC76eDFEFc57681083c861C1);
        ...
        additionalZkSync = AdditionalZkSync(address(0x7fbaD9d9C9a1204F45FA38CcbF732B0930F8B582));
