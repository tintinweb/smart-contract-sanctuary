...
contract Token is ERC1155 {
    ...
    function mintTokenAndPlaceOrder(
        uint256 _editions,
        ...
        mintToken(_editions, _tokenURI, _tokenURIMongo, _creator, _coCreator, _creatorPercent);
        placeOrder(
                _creator,
                tokenId,
                _editions,
    ...
    function placeOrder(
        ...
        require(creator[msg.sender], "Only approved users can place order");
        require(_editions > 0, "Zero editions");
        require(_pricePerNFT > 0, "Zero price");
        require(_adminPlatformFee < 51, "Admin fee too high");
        require(paymentEnabled[_tokenAddress], "Selected token payment disabled");
        require(_saleType == Type.Instant || _saleType == Type.Auction, "Invalid saletype");
