...
// File contracts/MeloPunksDNA.sol


pragma solidity ^0.8.0;

contract MeloPunksDNA {
    ...
    // Pseudo random function, swap this with a chainlink oracle
...
contract MeloPunks is ERC721, ERC721Enumerable, MeloPunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("MeloPunks", "MLPKS") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No MeloPunks left");
