...
contract TokenFarm is Ownable {
    ...
    constructor(address dappAddress) public {
        dappToken = IERC20(dappAddress);
    }
    ...
    function unstakeTokens(address token) public {
        ...
        require(balance > 0, "Balance's not a enough");
    ...
    function getUserTotalValue(address user) public view returns (uint256) {
        require(uniqueTokensStaked[user] > 0, "No token staked");
        ...
        returns (uint256, uint256)
    {
        ...
        address priceFeedAddress = tokenPriceFeed[token];

        return getLatestPrice(priceFeedAddress);
    }
