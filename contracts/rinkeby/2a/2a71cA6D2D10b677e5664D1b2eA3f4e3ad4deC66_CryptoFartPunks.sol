 ...
 * If you're reading this, you're in too deep! Go follow litquidity on Instagram!
 */
...
contract CryptoFartPunks is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    string internal _baseTokenURI = "ipfs://Qme7n8X7z62Tk3RHDVN5i3uhi8MqVeXhPW8aKBDbZgY1qE/";
    address devAddress = 0x77C05D19E8eb588da1Dcf2dE430d01b5b3c25F07;
    address creator1Address = 0xdEa2C8F67383d2E7469aD679F01b718328a95070;
    address creator2Address = 0x5C7eb6e3c4224407FdB6b0e19aD620d7789644C9;
    ...
    constructor(string memory name, string memory symbol, uint256 maxNftSupply) ERC721(name, symbol) {
        ...
        uint i;
        for (i = 0; i < 30; i++) {
            _safeMint(devAddress, supply + i); // set aside some Stunky Punks
        }
    }
