...
contract DoodleDoge is ERC721, Ownable {
  ...
  uint256 public maxMintPerWallet = 12;
  uint256 public maxMintPerTxn = 6;
  ...
  function publicMint(uint256 _mintAmount) public payable {
    ...
    // first 666 free mints max 3 per wallet
    if (s+1 <= maxFreeMint){
      require(s + _mintAmount <= maxFreeMint, "DoodleDoge: Exceeded free mint supply"); 
      require(addressToMintedAmount[msg.sender] + _mintAmount<= 3, "DoodleDoge: Exceeded allowed free mints per wallet");
    } else {
