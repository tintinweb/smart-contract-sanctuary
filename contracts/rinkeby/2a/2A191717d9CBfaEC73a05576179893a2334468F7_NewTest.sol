...
contract NewTest is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/70/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/70/contract-uri";
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("NewTest", "TST") {
