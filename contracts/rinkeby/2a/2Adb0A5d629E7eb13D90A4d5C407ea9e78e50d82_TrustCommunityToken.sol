...
interface IERC20 {
    ...
    function isAddressBlocked(address addr) external view returns (bool);
...
contract TrustCommunityToken is Context, IERC20, IERC20Metadata, Ownable {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _blockedAddresses;
    mapping(address => uint256) private _sellLimitAddresses;
    uint256 private _totalSupply = 2500000000000000000000000000000000; //2.5 quad with 18 decimals;

    string private _name = 'Trust Community Token';
    string private _symbol = 'TRUST';
    address private _tctBurnAddress = 0x8cd3c5fF5C6d094CeFEEDB1c8669DfF76d8c1c95;
    address private _communityWallet = 0x5c66E55fE639e8cD2b20aD48a7fb669d1cfd2622;
    uint256 private _burnRate = 100;
    bool private _turnOffSellLimit = true;
    ...
    function checkIfExceedsLimit(address addr, uint256 amount) internal virtual {
        if(_turnOffSellLimit) {
            ...
            uint256 addrBalance = balanceOf(addr);
