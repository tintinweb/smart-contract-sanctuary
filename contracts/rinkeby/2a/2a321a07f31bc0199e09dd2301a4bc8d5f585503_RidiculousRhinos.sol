...
/*
    ...
    /::\  \        /\  \      /::\  \        /\  \      /::\  \       /:/  /        /:/  /    /::\  \       /:/  /        /::\  \                /::\  \       /:/  /         /\  \      /::|  |       /::\  \       /::\  \   
   /:/\:\  \       \:\  \    /:/\:\  \       \:\  \    /:/\:\  \     /:/  /        /:/  /    /:/\:\  \     /:/  /        /:/\ \  \              /:/\:\  \     /:/__/          \:\  \    /:|:|  |      /:/\:\  \     /:/\ \  \  
  /::\~\:\  \      /::\__\  /:/  \:\__\      /::\__\  /:/  \:\  \   /:/  /  ___   /:/  /    /:/  \:\  \   /:/  /  ___   _\:\~\ \  \            /::\~\:\  \   /::\  \ ___      /::\__\  /:/|:|  |__   /:/  \:\  \   _\:\~\ \  \ 
...
contract RidiculousRhinos is ERC721, Ownable {
    ...
    uint256 public privatePrice = 35000000 gwei; // 0.035 Ether
    ...
    uint256 public price = 50000000 gwei; // 0.05 Ether

    /**
     * Mints allowed per address during presale
     */
    ...
    /**
     * Reserve tokens for giveaways and developers
     */
    ...
    function mint(uint256 _count) public payable {
        ...
        require(
            _count > 0 && _count < MAX_MINTS_PER_TXN + 1,
            "Exceeds maximum tokens you can purchase in a single transaction"
        );
        require(
            totalSupply + _count < maxTokenSupply + 1,
    ...
    function preSaleMint(uint256 _count) external payable {
        ...
        require(
            msg.value >= privatePrice.mul(_count),
            "Ether value sent is not correct"
        );
    ...
    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        rhinoProvenance = _provenanceHash;
    }
