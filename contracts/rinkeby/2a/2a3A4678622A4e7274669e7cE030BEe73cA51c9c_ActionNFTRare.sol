...
/* Accounting Data */ 
    ...
    ) public ERC721 ("PACDAO ACTION NFT RARE", "PAC-A1-RARE"){
...
/* Bid */
    ...
    function updateHighestBidder(address addr, uint currentValue) internal {
	    uint i = 0;
    ...
    for(uint j = topBidders.length - 1; j > i; j--) {
...
/* Withdraw Functions */
	function withdraw() public {
		...
		require(now < auctionEndTime + (60 * 60 * 24 * 30)); 
...
/* Admin Functions */
	...
	function setAuctionEnded() public
	{
		...
		auctionEnded = true;
		auctionEndTime = now;
		for(uint _i = 0; _i < topBidders.length; _i++ ) {
