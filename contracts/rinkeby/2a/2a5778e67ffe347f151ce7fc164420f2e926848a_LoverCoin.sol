...
contract LoverCoin is ERC721, Ownable {

    uint public mintPrice = 0.007 ether; // Mutable by owner
    uint public maxItems = 10000000;
    ...
    constructor() ERC721("LoverCoin", "DM") {}
