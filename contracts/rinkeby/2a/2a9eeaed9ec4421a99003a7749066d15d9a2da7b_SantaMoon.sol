...
contract SantaMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Santa";
    ...
    address payable private _developmentAddress = payable(0x9F46Ca6C4BB314065eF22E07881055280B739A04);
    address payable private _marketingAddress = payable(0x9F46Ca6C4BB314065eF22E07881055280B739A04);
    ...
    uint256 public _maxTxAmount = 100000000000000 * 10**9; //0.5%
    uint256 public _maxWalletSize = 200000000000000 * 10**9; //1%
