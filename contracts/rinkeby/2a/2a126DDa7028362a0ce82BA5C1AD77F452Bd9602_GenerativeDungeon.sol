...
contract GenerativeDungeon is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Gen D", "DDDD2") {
        MAX_NFTS = 10000; 
        MAX_NFTS_PLUS_1 = 10001; // to save gas during 3rd "require" in mint below 
    ...
    */
    function mint(uint256 _numberOfTokens) public payable {
        ...
        require(_numberOfTokens < 6, "Can only mint 5 at a time"); // use < rather than <= to save gas
        require(supply + _numberOfTokens < MAX_NFTS_PLUS_1, "Exceeds max NFT supply"); // again, < to save gas
