...
interface IEACAggregatorProxy
{
  ...
  contract BBRStaking {
    ...
    =            WRITE FUNCTIONS            =
    ==========================================*/
    function buy_(address _user,address _referredBy, uint256 BBRToken) external returns(uint256)
    {
      require(msg.sender == tokenAffiliateAddress,  "Invalid caller");
      require(BBRToken > 0, "invalid amount sent");
      //require(BBRToken >= minimumBuyAmount, "Minimum limit does not reach");
