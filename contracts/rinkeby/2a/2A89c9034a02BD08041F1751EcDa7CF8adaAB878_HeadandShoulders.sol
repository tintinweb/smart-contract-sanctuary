...
/////////                    
*/
contract HeadandShoulders is ERC721Tradable {
    ...
    event MintDuck (address indexed sender, uint256 startWith, uint256 times);

    //uints 
    uint256 public totalDucks;
	...
	// Wallets
	address private community_wallet = 0x65F24404593EC2A61c1D87811093d6B0495277ee;
	address private RZ_wallet = 0x5068E62f34b319b6b3CCE4D934A59743611b5F4e;
	address private AR_wallet = 0xd275751b48fD56e71342431638DC1Ff010763eBB;
	address private s_wallet = 0x68Eac05D46f61E6f636c526b47A720Bd8e93E531;

	// mapping
	mapping(address => uint) public mintedNFTs;

    //constructor args 
	constructor(address _proxyRegistryAddress, string memory _cURI) ERC721Tradable("POOP", "POOP", _proxyRegistryAddress) {_contractURI = _cURI; }
    ...
    function mintDuck(uint256 _count) payable public {
        ...
        emit MintDuck(_msgSender(), TotalSupply+1, _count);
