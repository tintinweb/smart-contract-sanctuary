...
contract KyokoCCAL is BaseContract {
    ...
    function borrowAssetViaBot(
        ...
        require(amount >= asset.totalAmount, "is not freezed enough token");
        require(asset.internalId == internalId, "bad asset internalId");
    ...
    function getUserDepositList(
        ...
        return depositMap[game][user].length;
    }
    ...
    function getUserBorrowList(
        ...
        return borrowMap[game][user].length;
    }
}
...
contract BaseContract is AccessControlEnumerable, ERC721Holder, StorageLayer, ProjectConfig {
    ...
    function checkUserIsInCreditSystem(address user) internal returns(bool) {
        (bool inG2GSystem, bool inCCALSystem) = ICreditSystem(creditSystem).getState(user);
        return inCCALSystem;
    }
