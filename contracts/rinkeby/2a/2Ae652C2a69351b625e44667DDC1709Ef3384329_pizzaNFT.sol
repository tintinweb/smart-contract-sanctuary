    ...
    */
    ...
    function buyingPizza(
        ...
        */
        ...
        Ingredients memory _ingredientItem = idToPizzaIngredients[
        ingredientItemId
        ];
    ...
    function setStatus(uint256 BuyingtokenID, bool val) public {
        pizzabuying memory _ingredientItem = idToBuyingPizza[
        BuyingtokenID
        ];

        _ingredientItem.isRandom = val;
        idToBuyingPizza[BuyingtokenID] = _ingredientItem;
    }

    function getStatus(uint256 BuyingtokenID) public view returns (bool) {
        pizzabuying memory _ingredientItem = idToBuyingPizza[
        BuyingtokenID
        ];

        return _ingredientItem.isRandom;
    }
