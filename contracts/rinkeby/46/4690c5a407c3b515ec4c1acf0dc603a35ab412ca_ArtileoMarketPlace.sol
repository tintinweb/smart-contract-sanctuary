...
contract ArtileoMarketPlace is ERC1155Tradable {
  constructor(address _proxyRegistryAddress)
  ERC1155Tradable(
    "Artileo",
    "ARTILEO",
    _proxyRegistryAddress,
    "http://softquake.in/demo/artileo/creations/metadata/"
  ){
    
  }
  function contractURI() public pure returns (string memory) {
    return "https://softquake.in/demo/artileo/contract/artx.json";
  }
