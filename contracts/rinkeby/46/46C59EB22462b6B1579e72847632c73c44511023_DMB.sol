...
contract DMB is IERC20 {
    using SafeMath for uint256;

    uint8 public constant decimals = 18;    
    string public constant symbol = "DMB";
    string public constant name = "One Fancy token";
    uint256 public constant initialBalance = 1_000_000 * (1e18);
    ...
    function _validateSignedData(
        ...
        require(
            ...
            "DMB::_validateSignedData: INVALID_SIGNATURE"
        );
    }
    ...
    function _transfer(
        ...
        require(
            ...
            "DMB::_transfer: NOT_VALID_TRANSFER"
        );
        // Balance is implicitly checked with SafeMath's underflow protection
        balanceOf[from] = balanceOf[from].sub(value);
        balanceOf[to] = balanceOf[to].add(value);
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "DMB::permit: AUTH_EXPIRED");
    ...
    function transferWithAuthorization(
        ...
        require(block.timestamp > validAfter, "DMB::transferWithAuthorization: AUTH_NOT_YET_VALID");
        require(block.timestamp < validBefore, "DMB::transferWithAuthorization: AUTH_EXPIRED");
        require(!authorizationState[from][nonce], "DMB::transferWithAuthorization: AUTH_ALREADY_USED");
