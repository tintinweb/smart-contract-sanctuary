...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    address public constant w1 = 0x2d6DCb0fC05989041769cD8F5d3A5BF2c9e1A72f;
...
contract Orthoverse is ERC1155, Ownable, ERC1155Supply {
    ...
    function upgradeCastleLevel(address account_) public payable {
        ...
        if (tokenCastleLevel[tokenId] == 7 || tokenCastleLevel[tokenId] == 15) {
            require(false, "Castle is already at max level");
        }
