...
The max transfer amount for any 1 trade is 1,000,000 (0.1% of total supply). This will act as a way to prevent mass dumps. This also applies to team wallet. 
...
contract Catnip is Context, IBEP20, Initializable {
    ...
    function includeBurnInReward(address account) internal {
    ...
    function transferTokens(address sender, address recipient, uint256 transferAmount, bool takeFee) private {
        ...
        // }
        // else{
        //     includeBurnInReward(burnAddress);
        // }
        ...
        // this will add to the amount that is being transfered, only done after the transfer occurs to make sure no errors
    ...
    function initializeWhiteListAddresses() internal {
    ...
    function initializeExcludeFromRFIAddresses() internal {
        includeBurnInReward(0x0000000000000000000000000000000000000001);
        includeBurnInReward(0x0000000000000000000000000000000000000000);
        includeBurnInReward(0x000000000000000000000000000000000000dEaD);
    }
