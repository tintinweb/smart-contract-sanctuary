...
library SafeMath {
    ...
    function sub3(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 3");
        uint256 c = a - b;
...
contract DeepWatersLending is ReentrancyGuard {
    ...
    **/
        ...
        internal
    {
        ...
        if (borrowBalanceUSD > 0) {
            ...
            checkNewCRatio(collateralBalanceUSD.sub1(_amountUSD), borrowBalanceUSD);
        }
    ...
    **/
        ...
        nonReentrant
    {
        ...
        uint256 newBorrowBalance = currentBorrowBalance.add(linearInterest).sub2(msg.value);
    ...
    **/
        ...
        internal
    {
        ...
        uint256 newBorrowBalance = currentBorrowBalance.sub3(_amount);
