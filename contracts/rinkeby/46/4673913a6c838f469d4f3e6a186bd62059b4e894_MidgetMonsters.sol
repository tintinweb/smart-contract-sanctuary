...
contract MidgetMonsters is ERC721Enumerable, Ownable {
    ...
    function Reward_Special_PixelDoors_Owners () private { //Airdropping as promised
        mint(bridge.ownerOf(1),1);
        mint(bridge.ownerOf(2),1);
        mint(bridge.ownerOf(3),1);
        mint(bridge.ownerOf(4),1); //Community helper
