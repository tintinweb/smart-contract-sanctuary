...
contract Tester is NPass {

    string public baseTokenURI;

    constructor(string memory baseURI_) NPass("Project N Test", "TEST", false, 10, 5, 0.0888 ether, 0.0888 ether) {
...
abstract contract NPassCore is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 public constant MAX_N_TOKEN_ID = 10;
