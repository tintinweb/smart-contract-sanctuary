...
contract LazyNFT is ERC721URIStorage, EIP712, AccessControl {
    ...
    constructor(address payable minter) ERC721("LazyNFT", "LAZ") EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION) {
    ...
    struct NFTVoucher {
        /// @notice The id of the token to be redeemed. Must be unique - if another token with this ID already exists,
        /// the redeem function will revert.
        uint256 tokenId;
    ...
    function withdraw() public {
        ...
        // IMPORTANT: casting msg.sender to a payable address is only safe if
        // ALL members of the minter role are payable addresses.
