...
contract TruthToken is ERC721Enumerable, Ownable {
    ...
    uint256 public dimesUpdateReward = 50000000000000000000; // 50 DIMES
    ...
    mapping (uint256 => uint256) public bayesIdTotalPoints; // total points awared per babel
    ...
    mapping(address => bool) public projectProxy; // auto-approve registry proxies like OS
    ...
    function claimRewards(address _owner) public {
        require(msg.sender == _owner, "Only the owner can claim reward");
