...
contract TOKordinator is Ownable, ReentrancyGuard, Multicall {
    ...
    constructor(IWETH _weth, IERC20 _usdt, IUniswapV2Factory _uniswapV2, IUniswapV2Factory _sushiswap, IHelioswapFactory _helioswap, ISwapRouter _swapRouter) {
        weth = _weth;
        usdt = _usdt;
        uniswapV2 = _uniswapV2;
        sushiswap = _sushiswap;
        helioswap = _helioswap;
