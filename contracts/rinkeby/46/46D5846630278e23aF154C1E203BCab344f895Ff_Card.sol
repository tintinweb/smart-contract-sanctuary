...
contract Card is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private legendaryMonsters = [
        "Dragon",
        "Wizard",
        // "Vampire",
        // "Goddess"
    ...
    function getCommonMonster(uint256 tokenId, uint256 offset) public view returns (string memory) {
    ...
    function pluck(
        ...
        //     output = string(
        //         abi.encodePacked(
        //             modifiers[rand % modifiers.length],
        //             " ",
        //             monsterModifiers[rand % monsterModifiers.length],
        //             " ",
        ...
        //                 sourceArray[rand % sourceArray.length],
        //                 " ",
        //                 location[rand % sourceArray.length]
        //             )
        //         );
        //     } else {
        output = string(
