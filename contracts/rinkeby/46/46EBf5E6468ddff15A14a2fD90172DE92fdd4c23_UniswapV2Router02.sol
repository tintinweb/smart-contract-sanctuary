...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function _addLiquidity(
        ...
        if (IUniswapV2Factory(factory).getPair(tokenA, tokenB) == address(0)) {
            createdPair = IUniswapV2Factory(factory).createPair(tokenA, tokenB);
        }
    ...
    function pairFor(address _factory, address tokenA, address tokenB) public pure returns (address) {
        return UniswapV2Library.pairFor(_factory, tokenA, tokenB);
    }

    function getReserves(address _factory, address tokenA, address tokenB) public view returns (uint reserveA, uint reserveB) {
        return UniswapV2Library.getReserves(_factory, tokenA, tokenB);
    }
