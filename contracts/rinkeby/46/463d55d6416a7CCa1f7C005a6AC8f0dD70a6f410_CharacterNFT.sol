...
contract CharacterNFT is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    uint256 public maxWhitelistId = 1000;
    ...
    function mintWhitelist(
      bytes32[] calldata merkleProof
        ...
        nonReentrant
    {
        require(whitelistId <= maxWhitelistId, "Error: Already minted maximum number of tokens!");
        require(!isClaimed[msg.sender], "Error: NFT is already isClaimed by this wallet");
        _mint(msg.sender, whitelistId);
        _setTokenURI(whitelistId, Strings.toString(whitelistId));
        whitelistId ++;
