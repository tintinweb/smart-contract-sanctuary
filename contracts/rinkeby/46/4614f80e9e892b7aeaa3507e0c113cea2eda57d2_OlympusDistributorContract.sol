...
contract OlympusDistributorContract is Ownable {
    ...
    function distribute() external returns ( bool ) {
        if ( block.number >= nextEpochBlock ) {
            ...
            uint _ohmToDistribute = supply.mul( rewardRate ).div( 1000000 );
    ...
    /**
        ...
        @return bool
     */
    function setRewardRate( uint _rewardRate ) external onlyOwner() returns ( bool ) {
        rewardRate = _rewardRate;
        return true;
    }
    ...
    /**
        ...
        @return bool
     */
    function setTimelock() external onlyOwner() returns ( bool ) {
    ...
    /**
        ...
        @return bool
     */
    function migrate() external onlyOwner() returns ( bool ) {
