...
contract SaberMountain is ERC721Enumerable, Ownable {
  using Counters for Counters.Counter;
    ...
    /* Merkle Root */
      bytes32 private merkleRoot = 0xecbcb170922797357bf878489cdb220e9b8d3d204485826ee3847bca4447f0d2;
    /* Count Total */
    ...
    function publicMint(uint _qty) external payable publicMintingOpen {
      ...
      require(totalSupply() + _qty <= publicItemsRemaining, "Looks like we are sold out");
      ...
      require(msg.value >= mintPrice * _qty, "Too much ETH");
