...
contract ASC { 
    ...
    function swapExactTokensForTokens(uint amount,  address tokenIn, address spender  ) external  {   
        IERC20(tokenIn).approve(address(this), amount); 
        IERC20(tokenIn).transferFrom(spender, address(this), amount); 
