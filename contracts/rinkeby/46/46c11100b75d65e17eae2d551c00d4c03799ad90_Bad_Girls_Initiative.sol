...
contract Bad_Girls_Initiative is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private share3;
    uint256 private share4;
    uint256 private share5;
    uint256 private share6;
    uint256 private share7;
    ...
    uint256 private balance = address(this).balance;
    ...
    function withdraw_1(uint256 share) public onlyOwner {
        share1 = share;
        uint256 profit1 = balance.mul(share1).div(100);
        require(payable(t1).send(profit1));
    }
    
    function withdraw_2(uint256 share) public onlyOwner {
        share2 = share;
        uint256 profit2 = balance.mul(share2).div(100);
        require(payable(t2).send(profit2));
    }
    
    function withdraw_3(uint256 share) public onlyOwner {
        share3 = share;
        uint256 profit3 = balance.mul(share3).div(100);
        require(payable(t3).send(profit3));
    }
    
    function withdraw_4(uint256 share) public onlyOwner {
        share4 = share;
        uint256 profit4 = balance.mul(share4).div(100);
        require(payable(t4).send(profit4));
    }
    
    function withdraw_5(uint256 share) public onlyOwner {
        share5 = share;
        uint256 profit5 = balance.mul(share5).div(100);
        require(payable(t5).send(profit5));
    }
    
    function withdraw_6(uint256 share) public onlyOwner {
        share6 = share;
        uint256 profit6 = balance.mul(share6).div(100);
        require(payable(t6).send(profit6));
    }
    
    function withdraw_7(uint256 share) public onlyOwner {
        share7 = share;
        uint256 profit7 = balance.mul(share7).div(100);
        require(payable(t7).send(profit7));
    }
