...
contract PielandOctopieUpgradeableUpgradedTest is ERC721BonfireWithPreSaleBasedOnWhitelistUpgradeable {
    function initialize() initializer public {
      ERC721BonfireWithPreSaleBasedOnWhitelistUpgradeable.init("Octopie", "OCTOPIE", "https://metadata.livetoken.co/api/metadata/OCTOPIE/", 66, 6, 6, .06 ether, 16);
    }
}
