...
contract GeekPunksClub is ERC721("Geek Punks Club", "GEPU") {
  ...
  //Gift nfts to single address
  function giftToAddress(address receiver, uint256 _amount)
      external
      onlyOwner
      tokensAvailable(_amount)
  {
      for (uint256 i = 0; i < _amount; i++)
          _mint(receiver, ++circulatingSupply);
  }
