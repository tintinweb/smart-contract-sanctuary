...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    //this fucntion creates a collectible and request a random number with VRF consumberbase random function
    function createCollectible() public returns (bytes32) {
        bytes32 requestId = requestRandomness(keyhash, fee);
        requestIdToSender[requestId] = msg.sender;
        //emit an event with the requestId and msg sender id
        emit requestedCollectible(requestId, msg.sender);
    }

    // function to retun the randomness
        ...
        override
    {
        ...
        //emit an event about the token assigend to the breed
    ...
    // fucntion requiress the owner of th contract is teh one whio can set the token id
