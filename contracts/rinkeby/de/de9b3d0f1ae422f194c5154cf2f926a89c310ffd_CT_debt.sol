...
contract decoffer_V2{
    ...
    Credit_token CT = Credit_token(0xD7b41783A5c1E0258E8E0BDec01150d47a50B9c3);
...
contract CT_debt{
    ...
    decoffer_V2 DT = decoffer_V2(0x3903d4047167194125b1f034460372EdFCc68D64);
    Credit_token CT = Credit_token(0xD7b41783A5c1E0258E8E0BDec01150d47a50B9c3);
    ...
    //1.認購金額  2.price  3.credit  4.get_CT 
    mapping(uint=>mapping(uint=>uint))public fee_info;
    ...
    function withdraw()public {
        ...
        if(debt_info[msg.sender][3] >= discount){
            uint fine = debt_info[msg.sender][3].sub(discount);
            require(total_profit >= fine);
            total_profit = total_profit.sub(fine);
        }
        
        DT.CT_swap_ETH(msg.sender,debt_info[msg.sender][4],total_profit,total_profit,fee);
        reset();
