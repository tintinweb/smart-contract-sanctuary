...
contract RiseAngleMembership2 is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    string public IPFS_HASH = "QmVYaFv71ToqpmqVvzduFkLDCfHUR9UXxzGs6fR2RE5iSd";
    ...
    constructor() ERC721("RiseAngle Membership v2", "RAMv2") {
    ...
    function setIPFS_HASH(string memory _hash) external onlyOwner {
            IPFS_HASH = _hash;
            for(uint i = 1; i <= numRamsMinted; i++) {
                _setTokenURI(i, IPFS_HASH);
            }
    }
