...
contract ZenAcademy is ERC1155Supply, Ownable, Pausable {
    ...
    uint256 public constant TOKEN_ID_GENESIS = 33;
     ...
     */
    function adminMint(address account, uint256 id, uint256 amount, bytes memory data) public onlyOwner
    {
