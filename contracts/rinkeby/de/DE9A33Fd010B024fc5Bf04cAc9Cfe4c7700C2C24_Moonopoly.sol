...
contract Moonopoly is ERC1155, Ownable, Pausable, ERC1155Burnable
{
    ...
    function setRandomMint(uint[] memory MINT_MAPPING) public onlyOwner { _MINT_MAPPING = MINT_MAPPING; }

    function deleteMintMapping() public onlyOwner
    {
        delete _MINT_MAPPING;
    }
