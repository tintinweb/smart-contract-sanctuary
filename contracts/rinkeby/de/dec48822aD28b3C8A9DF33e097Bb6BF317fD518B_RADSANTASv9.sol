...
contract RADSANTASv9 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(publicAmountMinted + _mintAmount <= Santas_Public, "EXCEED_PUBLIC"); //Public mints don't pull from private reserves.
    if (msg.sender != owner()) {
 ...
 function privatemint(uint256 _mintAmount) public onlyOwner {
    ...
    //require(totalSupply() < maxSupply, "All Santas have been minted");
...
/*  Can be set to reserve 30 Tokens
function reserveSantas() public onlyOwner {
