...
contract doggos is ERC721Enumerable {
    ...
    constructor() ERC721("doggos", "MICE") {
        _owner = msg.sender;
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
    ...
    function mintdoggos(uint256 _times) public payable {
        require((_times > 0 && _times <= 20) && (msg.value == _times * price) && (totalSupply() < MAX_SUPPLY), "t");
                ...
                abi.encodePacked(
                    ...
                    doggosLibrary.encode(
                        bytes(
                            string(
                                abi.encodePacked(
                                    '{"name": "on-chain d0gg0s #',
                                    doggosLibrary.toString(_tokenId),
                                    '", "description": "on-chain d0gg0s is a collection of 10,000 unique doggos. All the metadata and images stored 100% on-chain.", "image": "data:image/svg+xml;base64,',
                                    doggosLibrary.encode(
