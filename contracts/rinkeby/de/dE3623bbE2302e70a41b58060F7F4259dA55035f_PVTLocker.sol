...
contract PVTLocker is Ownable {
    ...
    mapping(address => mapping(address => bool)) public addressWithdrawn;
    ...
    function getAllTokensByLockOwner(address lockOwner) public view returns(address[] memory) {
        return tokensByLockOwner[lockOwner];
    }
    ...
    function createLock(address _token, uint256 _amount, uint256 _startTimestamp, uint256 _endTimestamp) public payable {
        ...
        require(locks[_token].lockOwner == address(0), "Token is already in locking");
