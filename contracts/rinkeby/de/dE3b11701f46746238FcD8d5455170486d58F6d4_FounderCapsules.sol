...
// File: contracts/FounderCapsules.sol
...
contract FounderCapsules is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FounderCapsules", "JIFC") {
    setHiddenMetadataUri("ipfs://QmQwpkf75a7rVTNLmvADYfagnWneUkxnwpmqeszTyuoAws/hidden.json");
  }
