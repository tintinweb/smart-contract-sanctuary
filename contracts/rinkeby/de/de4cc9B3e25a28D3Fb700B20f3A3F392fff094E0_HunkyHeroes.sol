...
contract HunkyHeroes is ERC721Enumerable, ERC721Burnable {
    ...
    address public msgSigner = address(0x5F5668780ee882a968968845bA479A45CfC3c816);//address(0x2498281F2F30A5AEf5de4411dAd21978EAB969D2); //whitelist signer
    ...
    uint256[3] private teamSplit = [2000, 4000, 4000];
    ...
    constructor(string memory baseURI_) ERC721("HunkyHeroes", "HERO") {
        ...
        teamList[1] = 0x7636D709c18DE85d3DD116D2065551f1D6d39b93; //Chief
        teamList[2] = 0x21D1332dDa69a368D26577471554bF9Ec05a6877; //Mayor
    ...
    */
    ...
    function withdraw() public onlyTeam {
        ...
        for (uint256 member = 0; member < 3; member++) {
            uint256 amnt = teamSplit[member] * bal / 10000;
            payable(teamList[member]).send(amnt);
        }
    }
