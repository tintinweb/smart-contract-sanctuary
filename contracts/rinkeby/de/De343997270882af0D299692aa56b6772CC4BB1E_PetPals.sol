...
contract PetPals is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("StreetDawgs", "SD") {}
    
    function createPetPal() external payable returns (bool) {
        require(totalSupply() + 1 <= maxGSupply, "createDawgs: creation must not exceed maximum supply");
        require(price == msg.value, "createDawgs: value must match accumulated price");
