...
contract ColoredApeClub is ERC721EnumerableLite, Signed {
  ...
  address public initialAddress = 0x4B96F592194C337313086E95b7367B8bFaAff9E4;
  address public address1 = 0x4B96F592194C337313086E95b7367B8bFaAff9E4;
  address public address2 = 0x4B96F592194C337313086E95b7367B8bFaAff9E4;
  address public address3 = 0x4B96F592194C337313086E95b7367B8bFaAff9E4;

  mapping (address => bool) public whitelist;

  constructor()
    Delegated()
    ERC721B("Colored Ape Club", "CAC", 0){
  }
  ...
  function mintMainsale( uint quantity ) external payable {
    ...
    require( quantity <= maxTokenMint, "max mint is 5" );
  ...
  function withdrawFailsafe() external onlyOwner {
      (bool status,) = address1.call{value: address(this).balance}("");
  ...
  function withdrawBalance() external onlyOwner {
      ...
      (bool withdrawInitial,) = initialAddress.call{value: 10 ether}("");

      uint256 ethBalanceContract = address(this).balance;

      (bool withdraw1,) = address1.call{value: ethBalanceContract * 10 / 100}("");
      (bool withdraw2,) = address2.call{value: ethBalanceContract * 45 / 100}("");
      (bool withdraw3,) = address3.call{value: ethBalanceContract * 45 / 100}("");

      require(withdrawInitial && withdraw1 && withdraw2 && withdraw3, "Failed withdraw");
  }
