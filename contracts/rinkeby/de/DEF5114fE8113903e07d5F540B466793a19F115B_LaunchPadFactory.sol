...
contract LaunchPadFactory is Ownable {
    ...
    address public lpImplementation;
    address public lpWhitelistedImplementation;
        ...
        onlyOwner
    {
        ...
        lpImplementation = _upgradedImplementation;
    }

    function upgradeLPWhitelistedImplementation(address _upgradedImplementation)
        external
        onlyOwner
    {
        require(_upgradedImplementation != address(0), "CF04");
        lpWhitelistedImplementation = _upgradedImplementation;
    }
