...
contract NobodyAirdrop is ERC721Enumerable, Ownable {
  ...
  function _mintnobodycost(address _to, uint256 _numNobody ) internal {
        for (uint256 i = 0; i < _numNobody; i++) {
  ...
  function airdropNobodycost(address _to, uint256 _numNobody ) public onlyOwner {        
    _mintnobodycost(_to, _numNobody);
  }
