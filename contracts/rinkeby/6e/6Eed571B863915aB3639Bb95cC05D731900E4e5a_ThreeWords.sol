    ...
    ERC721
{
        ...
        private
    {
        ...
        if (receiverIsDev) {
            ...
            (bool dSent, bytes memory dData) = DRIBNET.call{value: ROYALTY_PRICE}("");
            (bool mSent, bytes memory mData) = multisig.call{value: multisigFee}("");
            require(dSent && mSent, "Failed to send Ether");
        }
