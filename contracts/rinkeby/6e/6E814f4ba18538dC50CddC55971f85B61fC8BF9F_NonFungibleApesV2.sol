    ...
    ERC721Enumerable
{
    ...
    event UpdateBaseURI(
        string indexed previousBaseUri,
    ...
    constructor(
        ...
        _setupRole(MINTER_ROLE, 0x1F7283bEDAB59e843bA6671A95417244b532C3e6);
    }
    ...
    /// @return (bool)
    function isNfaOfRarityTier(uint256 tokenId, uint256 rarityTier)
        external
        view
        returns (bool)
    {
    ...
    function updateBaseTokenURI(string memory baseTokenURI)
        external
