...
contract Generascope is ERC721Enumerable, Ownable {
    ...
    uint256 public constant GS_PRIVATE = 600;
    uint256 public constant GS_PUBLIC = 511;
    uint256 public constant GS_MAX = GS_PRIVATE + GS_PUBLIC;
    uint256 public constant GS_PRICE = 0.000001 ether;
    uint256 public constant GS_PURCHASE_LIMIT = 500;
