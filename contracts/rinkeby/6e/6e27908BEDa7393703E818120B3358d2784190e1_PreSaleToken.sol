...
contract PreSaleToken is Ownable {
    ...
    */
    ...
    function getTokens() public payable {
        require(msg.value > 0, "You must pay some BNB to get TestToken.");
        require(addressToAmountPurchased[msg.sender] + msg.value <= purchaseCap,  "You cannot purchase this many PST, that would put you past your cap.");
 
        // 1 BNB = 1 TestToken to transfer to msg sender
        tt.transfer(msg.sender, msg.value);
        addressToAmountPurchased[msg.sender] += msg.value;
    }
