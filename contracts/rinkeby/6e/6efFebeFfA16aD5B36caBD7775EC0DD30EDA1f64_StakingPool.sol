...
contract StakingPool is SotaTokenWrapper, Constant {
	...
	function setSotaNFT(ERC1155Tradable _sotaNFT) public onlyOwner {
		sotaNFTs = _sotaNFT;
	}
	...
	// 1000 SOTA staked will earn 10 pumpkins perday
...
contract SotaTokenWrapper is Ownable {
	...
	function setSotaToken(IERC20 _sotaToken) public onlyOwner {
		sotaToken = _sotaToken;
	}
}
