...
contract FBomb is ERC721PresetMinterPauserAutoId {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    uint256 public price = 155650000000000000;
    uint256 public maxPerMint = 3;
    uint256 public maxSupply = 9999;

    constructor() ERC721PresetMinterPauserAutoId('FBomb', 'FBOMB', 'https://fbombnft.com/metadata') {}
    ...
    function mintSale(uint256 quantity) public payable {
        ...
        for(uint i; i < quantity; i++) {
            _safeMint(_msgSender(), _tokenIdTracker.current() + 1);
