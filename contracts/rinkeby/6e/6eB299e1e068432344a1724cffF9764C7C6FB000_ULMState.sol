...
contract ULMState is IULMState, BlockTimestamp {
    ...
    function checkLiquidityAmounts(
        ...
        // (int24 baseTickLower, int24 baseTickUpper, , , , ) = IUniStrategy(IUniswapLiquidityManager(liquidityManager).uniStrategy()).getTicks(pool);
        (, , uint256 ratio) = getLiquidityRatios(pool, baseTickLower, baseTickUpper);
