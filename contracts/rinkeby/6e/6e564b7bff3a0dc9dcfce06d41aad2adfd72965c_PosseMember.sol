...
contract PosseMember is ERC721, Ownable {
    
    using SafeMath for uint256;

    string public MEMBER_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN TREES ARE ALL SOLD OUT
    ...
    // Reserve 125 Posse Members for team - Giveaways/Prizes etc
    ...
    function reserveMembers(address _to, uint256 _reserveAmount) public onlyOwner {        
        ...
        memberReserve = memberReserve.sub(_reserveAmount);
    }
    ...
    function mintPosseMember(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_MEMBERS, "Purchase would exceed max supply of Members");
        require(msg.value >= memberPrice.mul(numberOfTokens), "Ether value sent is not correct");
    ...
    // GET ALL MEMBERS OF A WALLET AS AN ARRAY OF STRINGS. WOULD BE BETTER MAYBE IF IT RETURNED A STRUCT WITH ID-NAME MATCH
