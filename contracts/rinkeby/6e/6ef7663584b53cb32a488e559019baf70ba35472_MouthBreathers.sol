...
// GO TO LINE 1904 TO SEE WHERE THE MOUTH BREATHERS STARTS
...
//Definitely not the next BAYC. Mouth Breathers are 10,000 generated fish. I set out on this adventure to challenge myself to learn new skills.
//Color is a key part of each mouth breather's uniqueness as there are fewer traits than the big name projects (hope you like pastels).
//What MBs are lacking in traits and a roadmap, they make up for with an unbeatable price.
...
contract MouthBreathers is ERC721, Ownable {
    ...
    string public MOUTHBREATHERS_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN MOUTH BREATHERS ARE ALL SOLD OUT
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        MOUTHBREATHERS_PROVENANCE = provenanceHash;
    }
