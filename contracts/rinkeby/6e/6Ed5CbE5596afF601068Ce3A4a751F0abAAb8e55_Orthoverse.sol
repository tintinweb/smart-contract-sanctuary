...
contract Orthoverse is ERC1155, Ownable, ERC1155Supply {
    address private w0 = 0x2830B5a3b5242BC2c64C390594ED971E7deD47D2;
    address private w1 = 0x2d6DCb0fC05989041769cD8F5d3A5BF2c9e1A72f;
    ...
    function castlePrice(uint256 tokenId_) public view returns (uint256) {
        return (tokenCastleLevel[tokenId_] + 1) * CASTLE_BASE_PRICE;
    }
    ...
    function upgradeCastleLevel(address account_) external payable {
        ...
        require(tokenCastleLevel[tokenId] < 8, "Castle already at level 8");

        if (msg.sender != w0 || msg.sender != w1) {
            require(
                msg.value >= castlePrice(tokenId),
                "Not enough ETH"
            );
        }
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    // Base price to build a level 1 castle
    uint256 public constant CASTLE_BASE_PRICE = 0.0004 ether;
