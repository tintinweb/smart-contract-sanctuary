...
// File contracts_src/Templated.sol
...
contract Templated is ERC721Enumerable, Ownable {
    ...
    address private wal1 = 0xb8258175018a494ca3E241e709e7A1E74Aef8116;
    ...
    constructor() ERC721("PixelBotsTest", "PXLBTST") {}
    ...
    function giveAway(address to) external onlyOwner {
        uint256 supply = totalSupply();
        require(_reserved > 0, "No tokens left");
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(wal1).send(address(this).balance), "Withdraw1 Failed");
    }
}