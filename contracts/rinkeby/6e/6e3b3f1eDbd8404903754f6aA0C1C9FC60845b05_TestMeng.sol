...
contract TestMeng is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test Meng", "TM") {
    setHiddenMetadataUri("ipfs://QmRFsPRRchUgqdagRqw7REoHtEnRiKGXNzF8PihZor8urb/1.json");
  }
