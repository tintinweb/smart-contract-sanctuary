...
contract ERC20Standards is ERC20 {
  ...
  constructor(
    ...
    for (uint256 index = 0; index < _types.length; index++) {
      types[keccak256(abi.encodePacked(_types[index]))] == 1;
    }
    ...
    checkTypes("Mintable")
  {
    ...
    require(types[keccak256(abi.encodePacked("Governance"))] == 1);
  ...
  // @dev Burnable
  function burn(uint256 amount) public virtual checkTypes("Burnable") {
  ...
  function _beforeTokenTransfer(
    ...
    address to,
    uint256 amount
  ) internal virtual override checkTypes("Pausable") {
  ...
  function delegate(address delegatee) external checkTypes("Governance") {
  ...
  function delegateBySig(
    ...
    bytes32 r,
    bytes32 s
  ) external checkTypes("Governance") {
