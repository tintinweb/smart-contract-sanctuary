...
contract RandomSVG is ERC721URIStorage, VRFConsumerBase {
    ...
    function generateSVG(uint256 _randomNumber) public view returns (string memory finalSvg){
        ...
        finalSvg = string(abi.encodePacked("<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns:ev='http://www.w3.org/2001/xml-events' height='", uint2str(size),"' width='", uint2str(size), "'>"));
