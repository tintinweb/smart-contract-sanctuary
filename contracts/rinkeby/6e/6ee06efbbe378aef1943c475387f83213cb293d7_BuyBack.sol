...
contract BuyBack is Ownable{
    ...
    * @param _GDAO token contract
    ...
    constructor(
        ...
        forTreasury = 50 * PERCENT_PRECISION;
    ...
    */
    function _distributeGDAO() internal{
        ...
        //Send some eth to caller for gas reimbursement
        payable(tx.origin).transfer(_applyPercent(address(this).balance, gasReimbursement));
