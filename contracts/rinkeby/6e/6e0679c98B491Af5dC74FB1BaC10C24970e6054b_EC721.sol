...
contract Base721 is Generic721, controllerPanel, Pausable, vrfConnector {
    ...
    function addCardClass(
        ...
        Generic721.addCardClass(_cardID, _className, _start, _end);
    }
    ...
    function mint(uint256 _newItemId, uint256 _traits)
        ...
        returns (uint256)
    {
        Generic721._safeMint(tx.origin, _newItemId);
...
abstract contract Generic721 is IndexedLastTransfer, ERC721, Initialisation {
    ...
    function addCardClass(
        ...
        require(
            _cardID <= CardTypeCount,
            "CardID cannot be larger than typeCount."
        );
        require(
            _start < _end,
        ...
        CardType[_cardID].initial = _end - _start + 1;
        CardType[_cardID].minted = 0;
        CardTypeCount++;
    }
