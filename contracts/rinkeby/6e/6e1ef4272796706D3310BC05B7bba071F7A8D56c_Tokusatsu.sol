...
contract Tokusatsu is ERC721, ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Tokusatsu", "TKS") {
  ...
  function _baseURI() internal pure override returns (string memory) {
    return "https://nft.immortalz.io/immortalz/";
  }
  ...
  function purchase(uint256 quantity) external payable {
    ...
    require(msg.value == totalPrice, "amount is incorrect");
  ...
  function getTokenIdsByOwner(address _owner) external view returns(uint[] memory) {
    uint totalTokens = balanceOf(_owner);
