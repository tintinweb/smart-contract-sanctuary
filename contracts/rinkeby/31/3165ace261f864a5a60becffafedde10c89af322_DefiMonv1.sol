...
contract DefiMonv1 is ERC721URIStorage, Ownable {
	...
	uint256 public constant defimonPrice = 90000000000000000;
    uint256 public constant defimonWLPrice = 70000000000000000;
    uint256 public constant mintEggPrice = 0.03 ether;
    uint256 public constant maxDefimons = 10000;
    ...
    function mintEgg(uint numberOfTokens) public payable {
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            if (tokenCounter < maxDefimons) {
				 _safeMint(msg.sender, tokenCounter);
                 defiTokenURI = string(abi.encodePacked(baseURI, Strings.toString(tokenCounter)));
                 setTokenURI(tokenCounter,defiTokenURI);
    ...
    function updateMerkleRoot(bytes32 newmerkleRoot) external onlyOwner {
	 ...
	 function whitelistedMints(uint numberOfTokens, bytes32[] calldata merkleProof ) payable external  {
        ...
        require(whitelistSaleIsActive, "Sale must be active to mint defimon");
