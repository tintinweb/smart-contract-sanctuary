...
{    
    ...
    uint private priceInSOS = 30000000e18;
    ...
    {
        return string(abi.encodePacked(tokenMeta[tokenId].message));
    }
    ...
    function setSOSContract(IERC20 _openDAOContract) external onlyOwner
    {
        // SOS contract
        sosContract = _openDAOContract;
    }    
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        svg_output = string(abi.encodePacked(
            svg_output,
            '<foreignObject  width="100%" height="350" x="0" y="0" requiredExtensions="http://www.w3.org/1999/xhtml"><div xmlns="http://www.w3.org/1999/xhtml" style="display: flex; align-items: center; position:relative; justify-content: center; height: 100%;"><p id="preview" style="padding: 0px; color: white; text-align: center; font-family: Cooper Black; font-size:40px; -webkit-text-stroke: 2px black;">',
            memTraits.message,            
