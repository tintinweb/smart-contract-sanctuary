...
contract UnipilotFarm is IUnipilotFarm, IERC721Receiver {
    ...
    function initializer(address[] memory pools) internal onlyAdmin {
        for (uint256 i = 0; i < pools.length; i++) {
            ...
            poolInfo[pools[i]] = PoolInfo({
                ...
                globalReward: poolInfo[pools[i]].globalReward,
                lastRewardBlock: block.number,
                totalSupply: poolInfo[pools[i]].totalSupply,
                ...
                altGlobalReward: poolInfo[pools[i]].altGlobalReward,
                isAltActive: poolInfo[pools[i]].isAltActive,
                lastAltRewardBlock: poolInfo[pools[i]].lastAltRewardBlock,
        ...
        returns (bool)
    {
        ...
        globalFarmingReward += poolInfo[poolAddress].globalReward.sub(lastGR);
