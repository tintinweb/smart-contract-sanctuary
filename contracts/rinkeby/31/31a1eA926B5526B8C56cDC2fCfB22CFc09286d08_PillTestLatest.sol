...
contract PillTestLatest is ERC721, Ownable {
  ...
  string public uriPrefix = "https://testapi.pillnft.com/metadata/";
  ...
  constructor(bytes32 merkleRoot, address _proxyRegistryAddress) ERC721("TestPILL", "PTTT") {
    root = merkleRoot;
  ...
  function takePill(uint256 _mintAmount) public payable mintCompliance(_mintAmount) onlyOrigin {
  ...
  function takePillEarly(address account, uint256 _mintAmount, bytes32[] calldata proof) public payable mintCompliance(_mintAmount) onlyOrigin {
    require(msg.sender == account, "You are not who you claim to be!");
    require(isMintActive, "Mint is not active!");
  ...
  function communityMint(uint256 _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
    _mintLoop(msg.sender, _mintAmount);
  }
  ...
  function setIsMintActive(bool _state) public onlyOwner {
    isMintActive = _state;
  }
  ...
  function setIsPublicMintActive(bool _state) public onlyOwner {
  ...
  function withdrawAll() public onlyOwner {
    ...
    _withdraw(payable(0xF73416D81690E9cf4fb91a9463cB45c7b9622379), (balance * 15) / 100);
    _withdraw(payable(0x7480a0D17A923A95d4126c2042e3a77518bC7110), (balance * 10) / 100);
    _withdraw(payable(0xbA08A0D42756D7210D61F8a2c35EaF89c0eFd967), (balance * 15) / 100);
