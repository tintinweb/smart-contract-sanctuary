...
contract thePickleverse is ERC721Enumerable, Ownable {
  ...
  function mintFreePickle(uint256 _mintAmount) public payable {
        require(preSaleIsActive == true, "Free mints are not available yet.");
        require(_mintAmount > 0, "need to mint at least 1 Pickle");
        require(_mintAmount <= 3, "Max free mint amount");
        uint256 supply = totalSupply();
        require(supply <= freeMints, "No more free mints"); 
  ...
  function mintPickle(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner() || preSaleIsActive != true) {
  ...
  function withdraw() public payable onlyOwner {
    ...
    require(success, "ThePickleverse: The transfer failed");
  }
}