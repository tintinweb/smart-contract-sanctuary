...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        usdEntryFee = 50;
        ethUsdPriceFeed = AggregatorV3Interface(_priceFeedAfddress);
    ...
    function enter() public payable {
        ...
        require(msg.value >= getEntranceFeeInWei(), "Not enough $$$");
        players.push(msg.sender);
    }

    function getEntranceFeeInWei() public view returns (uint256) {
        (, int256 ethPriceInUsd, , , ) = ethUsdPriceFeed.latestRoundData();
        uint256 ethPriceInUsd256 = uint256(ethPriceInUsd) / 10**18;

        uint256 costToEnter = (usdEntryFee * 10**18) / ethPriceInUsd256;
        return costToEnter;
    }
    ...
    // This is callback after well requestRandomness from VRFConsumerBase
        ...
        override
    {
        ...
        uint256 random_index = _randomness % players.length;
        recentWinner = players[random_index];
