...
contract MicaTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MicaTestCoin() {
        ...
        name = "MicaCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MCA";                                             // Set the symbol for display purposes (CHANGE THIS)
