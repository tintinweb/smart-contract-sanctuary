...
contract Messaging {
    ...
    mapping(address => string) public pubEncKeys; // mapping of address to public encryption key https://docs.metamask.io/guide/rpc-api.html#eth-getencryptionpublickey
