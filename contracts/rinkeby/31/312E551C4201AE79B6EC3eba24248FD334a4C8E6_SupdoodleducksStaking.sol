...
contract SupdoodleducksStaking is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    address public stakingDestinationAddress = 0x8dF0e399510ba373f4F099AE99D4092254ABAdfd;
  ...
  */
    function querywinnerbytokens(uint256[] calldata _tokenIds) public view returns (uint[] memory) {
