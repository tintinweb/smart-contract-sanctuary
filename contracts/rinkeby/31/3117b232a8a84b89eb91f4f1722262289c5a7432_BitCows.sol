...
contract BitCows is ERC721Enumerable, Ownable {
    ...
    uint256 private _saleTime = 1630790514; 

    string private _baseTokenURI;

    constructor(string memory baseURI)
        ERC721("BITCWS", "BitCows")
    {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        require(
            _count < _maxPerTx,
            "That's way too many cows to mint!"
        );
        require(totalSupply < MAX_COWS, "All cows are already minted.");
        require(
            totalSupply + _count <= MAX_COWS,
            "This amount of cows will exceed max supply."
        );
