...
contract CryptoDrunksNFT is ERC1155, Ownable {
    ...
    uint256 public freeMintMax = 1014;

    uint256 public mintFee = 0.005 ether;
    constructor() ERC1155("") {}
    string public name = "CryptoDrunks";
//"ipfs://QmVw1FfqDZHTFAJNAKcJmQterVQ1gyT8n8DwDpbrD83N5Z/{id}.json"
    ...
    function freeMint(address account) payable
        public
    {
        require(msg.value >= 0.01 ether, "Insufficient fee!");
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        require(newItemId<=freeMintMax, "No more, no more!");
    ...
    function mintBatch(address to, uint256 count)
        ...
        onlyOwner
    {
        require((_tokenIds.current()+count)<=freeMintMax, "No more available.");
