...
abstract contract BaseToken  is ERC20, Ownable {
    ...
    uint256 internal constant _tokensSupply = 100000000 * 10**9;
...
//   ======================================
    ...
    function lockContract(uint256 time) public virtual onlyOwner {
        ...
        _lockTime = block.timestamp + time;
         renounceOwnership();
         emit ContractLocked(time);
    }

    function unlockContract() public virtual {
        require(_previousOwner == msg.sender, "Only the Owner can resume the contract");
...
abstract contract BaseLiquidity is BaseToken, Manageable {
    ...
    bool public autoLiquidity = false;
...
contract SymplexiaToken is  AntiWhale,  BaseLiquidity,  BaseRFI {
  ...
  //
    ...
    constructor () BaseToken ( "DEBUG26", "DBG26", 5, 5, 5, 
