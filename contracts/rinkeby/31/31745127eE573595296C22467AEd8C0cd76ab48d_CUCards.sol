...
contract CUCards is ERC721 {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;


    constructor () public ERC721 ("Crypto Universe Cards", "CUC"){}
     
    function createCollectible(address player, string memory tokenURI) public returns (uint256){
        // msg.sender only admin
