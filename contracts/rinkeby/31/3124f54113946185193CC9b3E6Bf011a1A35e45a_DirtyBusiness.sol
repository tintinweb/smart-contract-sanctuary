...
contract DirtyBusiness is NPassCore {
    ...
    function getMentalStrength(uint256 tokenId) public view returns (string memory) {
        if (n.getFourth(tokenId) == 0 || n.getFourth(tokenId) >= 11) {
    ...
    function getPersonality(uint256 tokenId) public view returns (string memory) {
        return personality[n.getFifth(tokenId)];
    }
    ...
    function getSkill8(uint256 tokenId) public view returns (string memory) {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[5] = getBodyBuild(tokenId);

        parts[6] = '</text><text x="10" y="80" class="base">';

        parts[7] = getMentalStrength(tokenId);

        parts[8] = '</text><text x="10" y="100" class="base">';

        parts[9] = getPersonality(tokenId);

        parts[10] = '</text><text x="10" y="120" class="base">';

        parts[11] = getAimAccuracy(tokenId);

        parts[12] = '</text><text x="10" y="140" class="base">';

        parts[13] = getSpecialty(tokenId);

        parts[14] = '</text><text x="10" y="160" class="base">';

        parts[15] = getSkill8(tokenId);
