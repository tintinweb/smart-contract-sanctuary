...
contract GutterSpecies is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	//do you know a more efficient way to do this? contact me for a bonus
	mapping(uint256 => bool) public pairCatClaimed;
	mapping(uint256 => bool) public pairRatClaimed;

	string private _baseTokenURI = "https://xxxx/metadata/";
	string private _contractURI = "ipfs://xxxxxxxxxx";
	...
	function getPassForPair(uint256 catID, uint256 ratID) public nonReentrant {
		...
		require(pairCatClaimed[catID] == false, "someone already claimed this cat");
		require(pairRatClaimed[ratID] == false, "someone already claimed this rat");
	...
	function getKeccak256(uint256 a, uint256 b) public pure returns (bytes32) {
