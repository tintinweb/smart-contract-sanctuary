...
contract J is ERC1155, Ownable, ERC1155Burnable {
    uint public constant MAX_J_TOKEN = 8888;
    uint256 public CLAIMED_J;
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/QmSpEUaKQQ4KSR5cyZCdNZK6XtjsLdurTUnn1UdkEnbb4Q") {}
     ...
     */
    function checkSaleStatusPublic() public view onlyOwner returns (bool){
        return hasPublicSaleStarted;
    }
    ...
    function preSaleMint(uint256 numberOfTokens) external payable {
        ...
        require(CLAIMED_J + numberOfTokens <= MAX_J_TOKEN, "Purchase would exceed max tokens");
