...
// File: contracts/nftAnarchists.sol
...
contract AnarchyworldNFT is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory _initIpfsURI, address[] memory whitelistaddrs, uint[] memory freeMintList) ERC721("AnarchyWorld", "AW") 
    {
    ...
    function mint(address to, uint256 mintAmount) public payable
    {
        ...
        if (msg.sender != owner())
        {
            uint256 currentCost = _paused ? (entry.isWhitelisted ? _lowCost : _cost) : _cost;
