...
contract RebelTickets is ERC20, ReentrancyGuard {
    ...
    function claim(IERC721Enumerable minterContract, uint8 scale) internal {
        ...
        emit Transfer(address(minterContract),address(minterContract), rewardPerToken);
        emit Transfer(address(minterContract),address(minterContract), notRewardedTokens);
