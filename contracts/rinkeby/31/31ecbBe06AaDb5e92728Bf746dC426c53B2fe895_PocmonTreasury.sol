...
// Part: ISendValueWithFallbackWithdraw
...
// Part: OpenZeppelin/[email protected]/EnumerableSetUpgradeable
 ...
 */
contract Treasury is AdminRole, OperatorRole, CollateralManagement, WithdrawFromEscrow {
  function initialize(address admin) public initializer {
    AdminRole._initializeAdminRole(admin);
  }
}

// File: PocmonTreasury.sol

contract PocmonTreasury is Treasury {
}