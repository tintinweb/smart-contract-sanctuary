...
contract ERC721Staking is StakingBase, IERC721Staking, IERC721Receiver {
        ...
        onlyEOAIfSet(msg.sender)
    {
        ...
        console.log("stakeAll msg.sender> ", msg.sender);
    ...
    function _safeOutputTokenMint(
        ...
        console.log("ERC721Staking._safeOutputTokenMint this", address(this));
        console.log(
            "ERC721Staking._safeOutputTokenMint roles manager>   ",
...
abstract contract StakingBase is Base, IStaking {
    ...
    // TODO Analyze gas spending per pool.
    // TODO Create massUpdatePools(from pid, to pid)
...
abstract contract Base {
    ...
    modifier onlyMinter(address account) {
        console.log("Base.onlyMinter account>      ", account);
        console.log("Base.onlyMinter msg.sender>   ", msg.sender);
        console.log("Base.onlyMinter roles manager>   ", address(_rolesManager()));
        _requireHasRole(
...
contract PlatformSettingsConsts {
    ...
    bytes32 public constant PNT_TOKEN_PAUSED = "PNTTokenPaused";
}
