...
contract LarvaWolf is ERC721Enumerable, ReentrancyGuard, Ownable {
	...
	string[7] private thirdLayers = [
		...
		''];
	string[8] private fourthNames = ['3D Glasses','VR','Dizzy Eyes','Eye Patch','Classic Shades','Regular Shades','Cyclope','None'];
