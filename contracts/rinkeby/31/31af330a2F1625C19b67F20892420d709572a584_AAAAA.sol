...
contract scsdfgdfgs     is fdherhsfhtfg, uyoyuykht, fdhdgjsdfhfgh, sefsdfgsf, hgkghfhnfyhng {
...
contract sdfsdfgdfghd   is fdherhsfhtfg, uyoyuykht, fdhdgjsdfhfgh, sefsdfgsf, hgkghfhnfyhng {
...
contract fghfghnfghd    is fdherhsfhtfg, uyoyuykht, fdhdgjsdfhfgh, sefsdfgsf, hgkghfhnfyhng {
    ...
    function c_LINK_Solution(uint Solution_ID, uint to_Problem_ID, string memory Linkage_Reason) public {
        ...
        bool alreadyLinked_4;
        
        for (uint i=1; i<=problemDetails.Linked_Solutions_byID_ARRAY.length; i++) {
            
            if (problemDetails.Linked_Solutions_byID_ARRAY[i]==Solution_ID) {
            
                alreadyLinked_4 = true;
                
            }
            
        }
        
        if (alreadyLinked_4==false) {
...
contract AAAAA          is tyuryjthrth, scsdfgdfgs, sdfsdfgdfghd, fghfghnfghd {
