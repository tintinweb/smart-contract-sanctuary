...
contract NFTAuctionSale is Ownable {
        ...
        returns (AuctionProgress[] memory)
    {
        ...
        mapping(uint256 => AuctionProgress) storage auctionBids = bids[auctionId];
    ...
    function claimReward(uint256 auctionId) external {
        ...
        mapping(address => uint256) storage auctionCurrentBids = currentBids[auctionId];
        ...
        isBidAvailable(auctionId)
    {
        ...
        auctionCurrentBids[_msgSender()] = auctionCurrentBids[_msgSender()]
            .add(1);
