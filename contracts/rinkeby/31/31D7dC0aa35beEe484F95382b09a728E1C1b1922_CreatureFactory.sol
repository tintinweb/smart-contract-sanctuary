...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        // Token openSeaCreature = Token(nftAddress);
        // if (_optionId == SINGLE_CREATURE_OPTION) {
        //     openSeaCreature.mintTo(_toAddress, _optionId);
        ...
        //         lootBoxNftAddress
        //     );
        //     openSeaCreatureLootBox.mintTo(_toAddress, _optionId);
        // }
    }
...
contract Token is ERC721Tradable {
    ...
    string      _tokenURI = "https://client-metadata.ether.cards/tyson/";
    string      _contractURI = "https://client-metadata.ether.cards/tyson";
