...
contract ColorLoot is ReentrancyGuard, ERC721Enumerable, Ownable {
     ...
     *
     * @notice for the first 1-7779 tokens, please use mint
     * @notice this method only enabled when there is new tokens > 7779 minted
     * 
     * @notice public price is 0.05 eth
     */
    ...
    /**
     * @notice auto token id enabled for loot 1 - 7779
     *
