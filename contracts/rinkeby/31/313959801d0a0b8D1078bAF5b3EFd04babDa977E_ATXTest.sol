...
/**
 * @title ATX Test Contract
 * @author Authentix Management Limited
 * @dev Extends from ERC1155Tradeable 
 */
contract ATXTest is ERC1155Tradeable {
    ...
    {
        owner = _msgSender();
        _setURI("https://authentix.t3j.co.uk/tokens/{id}.json");
    }

    /**
     * @dev Returns the configured contract URI used by OpenSea.
     */
    function contractURI() public pure returns (string memory) {
        return "https://authentix.t3j.co.uk/contract.json";
    }
 ...
 */
contract ERC1155Tradeable is Context, AccessControlEnumerable, ERC1155Pausable, ERC1155Burnable {
