...
contract DrainBrainz is Ownable, IERC721Receiver {
    using Strings for uint256;

    //uints 
    address public _stakingAddr;
    address public _brainzAddr;
    address public _ztoadzAddr;

    //constructor args 
    constructor() { }

    function setAddresses(address stakingAddr, address brainzAddr, address ztoadzAddr) external onlyOwner {
        _stakingAddr = stakingAddr;
        _brainzAddr = brainzAddr;
        _ztoadzAddr = ztoadzAddr;
    }
    ...
    function withdrawBrainz(uint256 zombieToadId, uint256 expirationBlock) external onlyOwner {
