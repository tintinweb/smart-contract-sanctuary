...
contract JollyElvesGirls is ERC721Enumerable, Ownable, JEVoucherSigner {  
    ...
    constructor (string memory newBaseURI, address voucherSigner) ERC721 ("Jolly Elves Girls", "JEG") JEVoucherSigner(voucherSigner) {
    ...
    function mintElves(uint256 _amount) public {
        ...
        require( _amount > 0 && _amount < 2, "Can't Mint More Than One" );
    ...
    // Presale Minting
    function mintPresale(uint256 _amount, JEVoucher.Voucher calldata v) public {
        uint256 supply = totalSupply();
        require(presaleActive, "Private Sale Not Active");
        require(claimedVouchers[v.voucherId] + _amount <= 1, "No Voucher For Your Address");
        require(_amount <= 1, "Can't Mint More Than One");
