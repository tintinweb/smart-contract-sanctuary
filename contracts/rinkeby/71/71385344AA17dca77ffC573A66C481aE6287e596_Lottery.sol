...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        // price = $4000 = 400000000
        // We know the ethUSD pricefeed returns 8 decimals. Adding (10**10) will result in 18 decimals.
        uint256 adjustedPrice = uint256(price) * (10**10);
        // adjustedPrice = $4000 = 4000000000000000000

        // usdEntryFee = 50_0000000000_00000000 * (10**18)
