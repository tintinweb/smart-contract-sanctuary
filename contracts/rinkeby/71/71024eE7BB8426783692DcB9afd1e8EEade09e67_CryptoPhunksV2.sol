...
contract CryptoPhunksV2 is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  function giveFreeRoll(address receiver) public onlyOwner {
    // max number of free mints we can give to the community
  ...
  // THIS WONT WORK CONTRACT TOO BIG

  // set inital contract state for v2, carryover from v1 state
  // Done in sets of max(50) due to limits
}
