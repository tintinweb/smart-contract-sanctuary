...
contract DepressedDucks is ERC721, ERC721Enumerable, Ownable {
    ...
    string public LICENSE_TEXT = "Depressed Ducks is a community cursed with knowledge"; // IT IS WHAT IT SAYS
    ...
    function mintDepressedDuck(uint numberOfTokens) public payable {
        ...
        require(msg.value >= _duckPrice.mul(numberOfTokens), "Ether value sent is not correct");
