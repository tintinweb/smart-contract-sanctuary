...
import "../../token/ERC20/ERC20BurnPause.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20BurnPause is ContractOwnable, IMasterERC20 {
  ERC20BurnPause[] private childERC20BurnPause;
  ...
  function createERC20(
    ...
    ERC20BurnPause child = new ERC20BurnPause(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20BurnPause.push(child);
...
contract ERC20BurnPause is ERC20 {
  constructor(
    address _owner,
    string memory name,
    string memory symbol,
