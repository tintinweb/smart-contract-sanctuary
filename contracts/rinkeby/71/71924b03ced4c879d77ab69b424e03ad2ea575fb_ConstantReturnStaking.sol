...
contract ConstantReturnStaking is Ownable {
    ...
    address public constant trustedStakingContractAddress = 0x20BcE7e502C45eEE96abCf4967BBFbA482F2a877;

    // earnings reward rate
    uint public constant REWARD_RATE_X_100 = 10000;
    uint public constant REWARD_INTERVAL = 3 hours;
    ...
    uint public constant ADMIN_CAN_CLAIM_AFTER = 3 hours;
    ...
    function stakeExternal() external noContractsAllowed {
        ...
        depositedTokens[msg.sender] = depositedTokens[msg.sender].sub(amountToDepositByContract);
