...
contract SappySeals is ERC721URIStorage, Ownable{
    ...
    event MintSeals (address indexed summoner, uint256 startWith, uint256 times);
    ...
    uint256 public releaseUnix = 1630344600; // Doesnt work KEKW
    ...
    function adminMintToAnotherAddy(address _addr,uint256 _sealNumber) public onlyOwner {
        emit MintSeals(_addr, _sealNumber, 1);
