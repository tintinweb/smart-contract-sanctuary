...
contract Prueba5_0 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor() ERC721('Prueba 5', 'PRB5') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 6; i++) internalMint(to);
    }
