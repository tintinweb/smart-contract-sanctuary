...
contract CATFeed is IFeed {
    ...
    constructor(IArchiSwapOracle _archiSwapOracle, IFeed _ethFeed, address _cat, address _weth) public {
    ...
    function latestAnswer() public view returns (uint) {
        (uint catEthPrice, ) = archiSwapOracle.current(cat, 1e8, weth);
        return catEthPrice
