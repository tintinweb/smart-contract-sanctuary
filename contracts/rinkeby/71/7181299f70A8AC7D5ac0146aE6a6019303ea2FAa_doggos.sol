...
contract doggos is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("doggos", "DOGZ") {
        //_owner = msg.sender;
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    ...
                                    '", "description": "On-Chain d0gg0s is a collection of 10,000 unique doggos. All the metadata and images are stored 100% on the Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
                                    doggosLibrary.encode(
