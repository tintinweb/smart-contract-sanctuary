...
contract OwnerfyContract6 is Context, AccessControlEnumerable, ERC1155Burnable {
  ...
  // CIDs
     ...
     */
    function mint(uint256 id, uint256 amount, bytes memory data, string calldata _update, string calldata cid) public virtual {
     ...
     */
    function mintBatch(uint256[] memory ids, uint256[] memory amounts, bytes memory data, string[] calldata updates, string[] calldata _cids) public virtual {
    ...
    // TODO: unfinished - needs to set these varibale, will need new map of creator addresses
    // for each token 
    // https://github.com/rarible/protocol-contracts/blob/master/royalties/contracts/LibPart.sol
    // function getRaribleV2Royalties(uint256 id) override external view returns (Royalty[] memory) {
    //     Royalty[] Royalties;
    //     Royalty royalty = Royalty(account, royaltyAmount);
    //     Royalty royalty = Royalty(platform, platformAmount);
    //     Royalties.push(royalty);
    //     return Royalties;
    // }

    // TODO: needs to be implemented: how to return 2 values
