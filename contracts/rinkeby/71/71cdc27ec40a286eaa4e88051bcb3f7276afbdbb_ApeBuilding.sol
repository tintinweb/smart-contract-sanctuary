    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        //Collaterals Setting (Rinkeby Default)
        collaterals["wAoE"] = address(0xf1108700Bb74bFFC7c2acA9664959BdC31316Be2);
        collaterals["aWood"] = address(0xd8E0Fec01Fb430621F5960aD99D271621115a581);
        collaterals["aStone"] = address(0x498B03b5f633ABFE403259Afea18535C6f0cCBC3);
        collaterals["aStraw"] = address(0x96e3D41bd1CA70b0471B2a7E4632D7620A3274Bd);
        ...
        apeHouse.fullURI = "https://storageapi.fleek.co/877cda1b-4b59-49b8-bdc3-d65ac313f1b6-bucket/NFTs/ApeHouse.json";
        ...
        apeFarm.fullURI = "https://storageapi.fleek.co/877cda1b-4b59-49b8-bdc3-d65ac313f1b6-bucket/NFTs/ApeFarm.json";
        ...
        apeFarm.fullURI = "https://storageapi.fleek.co/877cda1b-4b59-49b8-bdc3-d65ac313f1b6-bucket/NFTs/ApeBarracks.json";
    ...
    //Our methods
    function saleEnabled(string memory buildingName, bool status) public onlyOwner {
        bProps[buildingName].saleEnabled = status;
    }

    function setPrice(string memory buildingName, uint256 price_) public onlyOwner {
        bProps[buildingName].price = price_;
    }

    function setCollateral(string memory buildingName, address collateralAddress) public onlyOwner {
    ...
    function balanceOf(string memory buildingTypeName, address own) public view virtual returns (uint256) {
