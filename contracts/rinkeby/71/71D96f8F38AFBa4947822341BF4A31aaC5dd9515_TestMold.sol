    ...
    HasSecondarySaleFees
{
    ...
    string public constant defaultBaseURI = "https://nft.testquest.info/metadata/";
    ...
    function setCustomBaseURI(string memory _customBaseURI) public onlyOperator {
    ...
    function setIpfsHash(uint256 _tokenId, bytes32 _ipfsHash) public onlyOperator {
    ...
    function mint(address[] memory _toList, uint256[] memory _tokenIdList) public onlyOperator {
