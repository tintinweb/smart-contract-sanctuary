...
contract BarGangNFT is ERC721, Ownable {
    ...
    *******************************/
    ...
    uint PRIVATESALE_MAX_PER_USER = 2;
    ...
    uint256 PUBLIC_MINT_AVAILABLE_TIME = 2592000;  // publicsale is available only for 30days
    ...
    function requestPrivateSale() external payable {
        ...
        require(_countlist[msg.sender] + 1 <= PRIVATESALE_MAX_PER_USER, "Overflow 2 tokens");
    ...
    function requestPublicSale(uint mintCount) external payable {
        ...
        require(secondsPassed < PUBLIC_MINT_AVAILABLE_TIME, "Public Minting is ended.");
    ...
    function getPresaleMintingAvailableTime() public view returns(uint256) {
       return PRESALE_MINT_AVAILABLE_TIME;
    }
    ...
    function getPublicMintingAvailableTime() public view returns(uint256) {
       return PUBLIC_MINT_AVAILABLE_TIME;
    }
