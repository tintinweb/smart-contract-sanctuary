...
contract BoringBananasCo is ERC721, Ownable {
    ...
    uint256 public constant bananaPrice = 1000000000000000; // 0.025 ETH
    
    
    uint public constant maxBananaPurchase = 100;
