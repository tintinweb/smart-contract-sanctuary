...
contract MOONDUCKS is ERC721, Ownable {
    ...
    string public MOONDUCKS_PROVENANCE = ""; // DEV to add our hash, as well as the seed used to generate Moondogs

    uint256 public MOONDUCKPRICE = 25000000000000000; // 0.025 ETH

    uint public constant MAXMOONDUCKSPURCHASE = 20;

    uint256 public constant MAX_MOONDUCKS = 5000;

    bool public saleIsActive = false;

     // withdraw addresses
    address t1 = 0x6f9093fFf1ea19e63b10e586396B236Bb4B85888;
    address t2 = 0x99cFF519b010902d9a207e5c5eA0a6E495F69036;
    
    // Reserve up to 100 MOONDOGS for team - Giveaways/Prizes/New Members etc
    uint public MOONDUCKSRESERVE = 100;

    constructor() ERC721("MoonDucks StellarBang", "MDUCK") { }
    ...
    function RESERVEMOONDUCKS(address _to, uint256 _reserveAmount) public onlyOwner {        
        ...
        require(_reserveAmount > 0 && _reserveAmount <= MOONDUCKSRESERVE, "NOPE");
    ...
    function MINTMOONDUCKS(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= MAXMOONDUCKSPURCHASE, "You can only mint 20 tokens at a time");
        require(totalSupply().add(numberOfTokens) <= MAX_MOONDUCKS, "Purchase would exceed max supply of Moondogs");
