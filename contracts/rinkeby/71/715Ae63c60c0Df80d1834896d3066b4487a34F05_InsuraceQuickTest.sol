...
contract InsuraceQuickTest {
    ...
    address insurToken = 0x0921f628b8463227615D2199D0D3860E4fBcD411;

    constructor(){
        _uniswapRouter = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        _stakersPool = IStakersPoolV2(0x38e8D3D7C8a1169e3Cc77BD6049AD965bF60A672);
        _stakingController = IStakingV2Controller(0x3a4DABDf43fb8704400531c810F437Fb60D28a9D);
    }

    function apy(address stakingAsset, address swapRewardsVia) public view returns (uint256 _apy) {
        ...
        uint256 _stakingDecimals = IERC20(stakingAsset).decimals();
        uint256 _insurInOneStaking = _howManyTokensAinB(
            insurToken,
            stakingAsset,
            swapRewardsVia,
            1 * 10**_stakingDecimals
        );
        uint256 _poolTVLInRewardsAsset = _poolTVLInStakingAsset.mul(_insurInOneStaking);
