...
contract TonySharks is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    ) ERC721("TESTHOLA", "HOLA") PaymentSplitter(team, team_shares) {
        _team = team;
    ...
    function setmaxNFTForMint(uint256 _newmaxMintAmount) public onlyOwner {
    ...
    function reserveTony() public onlyOwner {
