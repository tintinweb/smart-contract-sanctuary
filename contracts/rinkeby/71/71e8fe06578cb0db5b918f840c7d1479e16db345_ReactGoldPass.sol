...
contract ReactGoldPass is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address g0 = 0xDaFcc93eb40832566418aE94a621396d146F21F3;
    address g1 = 0xfc1b71D9aCA6C9C7c1B909b13150E038135681b6;
    address g2 = 0x9323b4813B3CfC0E7b924ebD08E74Bd9ecc03Ef8;
    address g3 = 0xCf09F8d9Fc3AA60aB810E1A169188fFA9573FC5B;
    address g4 = 0xF8C4d6F0DFc7eb090389f6d7Ee84F4Fb385DaF19;

    constructor() ERC721 ("ReactGold Pass", "REACT")  {
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(g0).send(_each));
        require(payable(g1).send(_each));
        require(payable(g2).send(_each));
        require(payable(g3).send(_each));
        require(payable(g4).send(_each));
    }
}