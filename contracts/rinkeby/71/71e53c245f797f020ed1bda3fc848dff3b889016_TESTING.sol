    ...
    function buy() public payable returns (uint256) {
        ...
        for (uint k = 0; k < tot_supp.length;k++) {
            ...
            if (tot_supp[k] > pur_token) {
                percentage = k;
                if (k > 0) {
                    _bnb_token_rate_per = (_bnb_inc_token_rate.mul(1)).div(uint(100));//100*2/100
                    _bnb_inc_token_rate = _bnb_inc_token_rate.add(_bnb_token_rate_per);//100+2
                }
                break;
                ...
                break;
                    ...
                    // if (_bnb_inc_token_rate > 18914000000000) {
                    //     _bnb_token_rate = _bnb_inc_token_rate;
                    // }
