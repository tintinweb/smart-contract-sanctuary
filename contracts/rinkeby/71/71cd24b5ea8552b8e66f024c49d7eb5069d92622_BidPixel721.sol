    ...
    ERC721BurnableUpgradeable
{
    ...
    function initialize() public initializer  {
        __Ownable_init();
        ERC721Upgradeable.__ERC721_init("BidPixel", "BidPixel");
        _tid = 1;
    ...
    function listNft(address from, uint256 token_id) public payable{
        require( msg.value == listingfee, "Invalid Fees");
        listingNFT[token_id][from] = true;
