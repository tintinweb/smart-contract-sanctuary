...
contract DeliCon {
    ...
    */
    ...
    function open_order(string calldata customer_data, address restaurant_address) public payable returns (uint256)  {
    ...
    function restaurant_pledge_courier(uint256 nonce, address restaurant_address, uint256 max_time_till_arrival, uint256 max_deposit, address courier_address, bytes calldata signature, uint256 order_num) public {
        ...
        require(recoverSigner(message, signature) == courier_address, "Signature is not valid");
