...
// Caob_Coin
contract Caob is BEP20('Caob Coin', 'Caob', 18, 15000000000 * 1e18), MinterRole {
    ...
    /// @notice Reward `_amount` token to `_to`. Must only be called by the minter.
    function reward(address _to, uint256 _amount) public onlyMinter {
