...
contract HaktDAO is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("HaktDAO", "HDAO") public {
    ...
    _cids = ["bafkreiduavmx6bki3vexcsdq2hvlyqsjz6skdy7fzudxyqt4gqk437muoe", "bafkreihsc45wzgdwqgg3eeza2yvz6gq3bhzpgfr2rw75dtk6jeapgtc3ke", "bafkreiaa2o7jkjcwhpl3lli4l7qmnx5gaz336thp3mcaqxdnysmtcrw6vu", "bafkreigeuhbnrtjjlmmbwvyloswa4xkm4tlkv4wcagcpk6kflp4id7byae", "bafkreihvpyxf2gfjyluvppu3yrosoj5nfadq4zapdfc5dlht5whxqmjnyq"];
  }
  ...
  function _mintItem(address to)
      ...
      returns (uint256)
  {
    require( _tokenIds.current() < _cids.length , "NEED MORE CIDs");
    string memory cid = _cids[_tokenIds.current()];
    _tokenIds.increment();
  ...
  /// @notice Add a new CID to the list of CIDs 
  /// @param cid string of the new CID
  function addCID(string memory cid)
      public
      onlyOwner
  {
    _cids.push(cid);
  ...
  /// @notice Overwride of the burn function
  ...
  /// @notice Overwride of the beforeTokenTransfer function
  ...
  /// @notice Overwride of the supportsInterface function
