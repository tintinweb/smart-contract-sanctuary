...
/**
 * @title Thirdling
 * Thirdling - a contract for my non-fungible art.
 */
contract Thirdling is ERC721Enumerable, Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    bool public isSaleActive = false;
    uint public constant maxMintBatch = 20;
    uint256 public constant tokenPrice = 1000000000000000; // 0.001 ETH
    uint256 public maxTokensCount = 1000;
    address[] private distributions;
    string private baseURI;
    string public baseTokenURI;
    string public contractURI;

    constructor() ERC721("Thirdling", "THD") {
        baseURI = "https://raw.githubusercontent.com/MoonSilverOwl/DemoSquirrel/main/images/";
        baseTokenURI = "https://raw.githubusercontent.com/MoonSilverOwl/DemoSquirrel/main/images/DemoSquirrelGeneral.json";
        contractURI = "https://raw.githubusercontent.com/MoonSilverOwl/DemoSquirrel/main/images/DemoSquirrelContract.json";
    }
    ...
    function reserveThirdling() public onlyOwner {
    ...
    function mintThirdling(uint numberOfTokens) public payable {
