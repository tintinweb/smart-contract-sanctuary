...
contract FourArtV3 is Context, ERC1363, AccessControlEnumerable, ERC20Burnable, ERC20Pausable, ERC20Capped{
    ...
    event SendEther(address indexed user, uint256 amount);
    ...
    constructor(string memory name, string memory symbol, uint256 _sellPrice,uint256 _buyPrice) ERC20(name, symbol) ERC20Capped(1000000000 * (10 ** uint256(decimals()))) payable {
   ...
   // @dev if owner wants to transfer contract ether balance to own account.
    ...
    function buy() payable public {
        uint256 amount =  SafeMath.div(msg.value,buyPrice); // calculates the amount  
