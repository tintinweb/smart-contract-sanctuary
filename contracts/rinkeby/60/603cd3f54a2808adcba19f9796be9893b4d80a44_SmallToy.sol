 ...
 */
contract SmallToy is ERC721URIStorage, Ownable, Pausable {

    // General constants
    enum mintTypes {PRIVATE, WHITELIST, RAFFLE, PUBLIC}
    uint256 constant maxItems                       = 77; // Maximum items in the collection
    uint256 constant price                          = 0.01 ether; // Price for minting one NFT
