 ...
 */
contract MetaAngels is ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 public immutable goldlistSaleSupply;
     ...
     * @param goldlistSaleSupply_ FirstSale Supply of tokens
     * @param reserveSupply_ Reserve Supply of tokens 
     */
    constructor(
        string memory name,
    ...
    function mint(
        ...
        if (isFirstSaleActive) {
            require(currentSupply + mintNumber <= goldlistSaleSupply, "NOT_ENOUGH_MINTS_AVAILABLE");
        } else {
        ...
        if (isFirstSaleActive && (currentSupply + mintNumber >= goldlistSaleSupply)) {
