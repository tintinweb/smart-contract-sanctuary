...
contract AniCats is ERC721, Ownable {
    ...
    uint constant public MAX_SUPPLY = 90; // 9000 unique AniCats will be in total.
    uint constant public PRICE = 0.007 ether; // 0.07 ETH + gas per transaction

    string private _apiURI = "https://anicats.herokuapp.com/token/";
    uint private _presaleTokensLimit = 20;
    uint private _reservedTokensLimit = 10; // 200 AniCats will be reserved for marketing needs.
    ...
    constructor() ERC721("AniCats", "ANC") {
