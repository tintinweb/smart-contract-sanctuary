...
contract BallotFactory is Owner {
    ...
    function createElection (string memory electionName, string memory description, uint startTime, uint endTime, uint minVote, uint maxVote) isAdmin public{
        ...
        // front end can catch this event to read contract address of new ballot
        emit NewBallot(address(newBallot));
    }
