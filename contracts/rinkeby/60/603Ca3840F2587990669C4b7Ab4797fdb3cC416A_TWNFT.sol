...
contract TWNFT is ERC721Enumerable, Ownable {
    ...
    //After this date, public minting of soldiers will be possible. Befor this date, only the owner and generals can be minted.
    uint256 private constant START_TIMESTAMP = 1632682447; //Now for testing, CHANGE FOR MAINNET
    ...
    string private constant COMMANDER = "bafybeick7bj677i3fhq5upoc2vplu4gmgmgdpacbtahx6f4uqkgl7dattq"; //1
    string private constant GENERAL   = "bafybeidzfegfpn24lpjkf235tdhqvk26b2bsr7ye7sj2ggsodxk4rs25ju"; //2
    string private constant SOLDIER   = "bafybeiceynivdpcrnu633gmcyp36x4lw7avehpznbjx5i62a52nqh2lk5i"; //3
    string private constant ARMY      = "bafybeihn4y3bf364ihww2ogzpqavuryhjaeakvpk6ci7rrkjj4mmsqjpae"; //image for opensea
    ...
    //psoldier is a public minted soldier
    ...
    //used for opensea, see https://docs.opensea.io/docs/contract-level-metadata
    ...
    function mintWhitelisted() public {
        ...
        require(nextGeneralId < FIRST_DEV_SOLDIER_ID, "General limt reached, we are already at the first dev soldier");
        ...
        //add msg.sender to list of minters
    ...
    function mintByOwner(address[] memory _addresses, uint256 _rank) public onlyOwner {
        ...
        for (uint256 i=0; i < _addresses.length; i++) {
            if (_rank == 1) {
                require(nextCommanderId < FIRST_GENERAL_ID, "Commander limt reached, we are alrdeay at the first general id");
                ...
                require(nextDevSoldierId < FIRST_PUB_SOLDIER_ID, "Dev Soldier limit reached, we are already at the public soldier");
    ...
    function mint() public {
        ...
        require(bal >= SOLDIER_MINT , "Insufficient balance, soldier level not reached");

        uint256 tokenId;

        if (bal >= COMMANDER_MINT && releasedTGT) {
            require(nextCommanderId < FIRST_GENERAL_ID, "Commander limt reached, we are already at the first general id");
            tokenId = nextCommanderId;
            nextCommanderId = nextCommanderId + 1;
            ...
            require(nextPubSoldierId < FIRST_INVALID, "Soldier limt reached, we are already at the first invalid id");
