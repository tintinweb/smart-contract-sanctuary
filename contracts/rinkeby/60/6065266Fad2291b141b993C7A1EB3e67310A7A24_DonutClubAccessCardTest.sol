 ...
 * corresponding is an NFT, there is no guarantee that no other token with the
...
contract DonutClubAccessCardTest is ERC1155Supply, Ownable
{
    ...
    uint public constant NUMBER_RESERVED_TOKENS = 49;
    uint256 public constant PRICE = 100000000000000000; // in wei = 0.1 ETH
    string public name = "Donut Club Access Card";

    uint public reservedTokensMinted = 0;

    string public contractURIstr = "";

    constructor() ERC1155("https://ipfs.io/ipfs/QmS2ng7jrYmUSTZDbp98q3b2MLtSS23bopvL37Dh5uiXQr") {}
    ...
    {
        require(whitelistMintActive, "Whitelist sale must be active to mint");
        ...
        require(totalClaimed[msg.sender] + amount <= maxPerWallet, "Purchase exceeds max allowed");
    ...
    function getMintsClaimed(address addr) external view returns (uint256) {
        return totalClaimed[addr];
    }
