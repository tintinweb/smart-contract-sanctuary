...
contract AirdropToken is Context, IERC20, Ownable {
    using Address for address;

    // strings
    string private _tokenName = "Airdrop";
    string private _tokenSymbol = "AIRDROP";

    // uint256
    uint256 private constant MAX = ~uint256(0);
    uint256 private _totalSupplyT = 10000000000 * 10**18;
    ...
    uint256 public _maxTokensForTx = 500000000 * 10**18;
    uint256 private maxFrensForLiquidity = 25000000 * 10**18;
    ...
    constructor (address payable stakingAddress) public {
        _stakingAddress = stakingAddress;
        _marketingAddress = stakingAddress;
    ...
    function sendPubFundsToWallet(uint256 amount) private {
        ...
        _stakingAddress.transfer(address(this).balance);
    }

    function _setMarketingAddress(address payable marketingAddress) external onlyOwner() {
