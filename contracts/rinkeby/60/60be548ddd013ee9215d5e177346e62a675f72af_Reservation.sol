...
enum StateType { Reserved, Cancel, Complete, CompleteCancel }
...
contract Reservation {
    ...
    event eventDeal(ReservationDeal deal);
    ...
    function initReservation(
        ...
        require(_checkOutDate - _checkInDate >= 1 days , "Invalid reservation period");
        uint _totalDays = (_checkOutDate - _checkInDate) / 1 days;
        require(msg.value >= _price * _quantity * _totalDays, "Invalid price value");
        ...
        deal.totalDays = _totalDays;
        deal.price = _price * _quantity * _totalDays * 1 gwei;
    ...
    function cancelReservation(bytes32 dealId) public onlyCustomerOrHotel(dealId) {
        ...
        require(deal.checkInDate - currentDate >= 3 days, "This deal is no longer able to be canceled"); 
