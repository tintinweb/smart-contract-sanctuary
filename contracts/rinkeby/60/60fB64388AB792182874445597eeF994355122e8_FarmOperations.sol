...
contract FarmOperations is VRFConsumerBase, Ownable {
    ...
    function placeOrder(
        ...
        require(farm_token.allowance(_buyer_address, _farm_token) >= _total_amount, "Allowance is not enought");

        require(
            farm_token.transferFrom(_buyer_address, _farm_token, _total_amount),
