...
contract NFT is Ownable, ERC721URIStorage {
    ...
    mapping(uint256 => uint256) public nftIDToOptionID;
    mapping(uint256 => uint256) public collectionIDToNftID;
    ...
    function createNFT(
        ...
        collectionIDToNftID[instance.collectionMinted] = newItemId;
        ...
        nftIDToOptionID[newItemId] = optionID;
