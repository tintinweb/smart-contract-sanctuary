...
// File: src\contracts\SimpleCollectible.sol
...
contract SimpleCollectible is ERC721 {
    ...
    struct FunnyCharacter {
        uint256 id;
        string tokenURI;
    }

    FunnyCharacter[] public funnyCharacters;
    constructor () public ERC721 ("TechforceNFT", "TNFT"){
        tokenCounter = 0;
    }

    function createCollectible(string memory tokenURI) public payable returns (uint256) {
        uint256 newItemId = funnyCharacters.length;
        funnyCharacters.push(
            FunnyCharacter(
                newItemId,
                tokenURI
            )
