...
contract BitmindCrowdsale {
    ...
    function Purchase(uint _amount) public {
        ...
        pairAddress.approve(address(this), _amount);
        
        require(pairAddress.allowance(msg.sender, address(this)) > 0, 'BitmindMsg: Allowance not found');
        uint tokenAmount = pairAddress.allowance(msg.sender, address(this));
        
        
        pairAddress.transferFrom(msg.sender, address(this), tokenAmount);
