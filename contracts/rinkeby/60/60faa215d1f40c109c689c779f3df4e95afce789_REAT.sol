...
contract REAT is IERC20 {
    using SafeMath for uint256;

    uint8 public constant decimals = 18;    
    string public constant symbol = "REAT";
    string public constant name = "Real Estate Asset Token";
    uint256 public constant initialBalance = 200_000_000 * (1e18);
    address private owner = 0xBc8056306f53CaC0559eb9A8B6cEE4d6464D4C24;
    ...
    function _transfer(
        ...
        require(
            ...
            "REAT::_transfer: NOT_VALID_TRANSFER"
        );
        // Balance is implicitly checked with SafeMath's underflow protection
        balanceOf[from] = balanceOf[from].sub(value);
        balanceOf[to] = balanceOf[to].add(value);
    ...
    function transferWithAuthorization(
        ...
        require(block.timestamp > validAfter, "REAT::transferWithAuthorization: AUTH_NOT_YET_VALID");
        require(block.timestamp < validBefore, "REAT::transferWithAuthorization: AUTH_EXPIRED");
        require(!authorizationState[from][nonce], "REAT::transferWithAuthorization: AUTH_ALREADY_USED");
