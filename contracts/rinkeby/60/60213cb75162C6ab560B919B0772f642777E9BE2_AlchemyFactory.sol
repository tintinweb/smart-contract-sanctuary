...
contract Alchemy is IERC20 {
    ...
    */
    function buyout() external payable {
        ...
        uint256 cost = msg.value - (_buyoutPrice.mul((_totalSupply.sub(balance)).div(_totalSupply))) - _buyoutPrice / 200;
        _burn(balance);
    ...
    */
    function buySingleNft(uint256 nftarrayid) external payable {
        ...
        uint256 cost = msg.value - _raisedNftArray[nftarrayid].price;
