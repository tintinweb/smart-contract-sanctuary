...
contract NFTExample is ERC721Tradable {
    constructor(address _proxyRegistryAddress) ERC721Tradable("NTFExample", "NTFExample", _proxyRegistryAddress) {}

    function baseTokenURI() public pure virtual override returns (string memory) {
        return "ipfs://ipfs/QmPMTrB1oUCdP6cvhTNfkuf73LmJtcLg4mfuVHxah4WVPp/";
    }
}
