...
contract Inheritance {
    ...
    /*  function add_nomination_1(address _nominyAddress, uint256 _inheritedAmt)
        public
        onlyOwner
    {
    ...
    */
    function add_nomination() public payable onlyOwner {
        wallets.push(msg.sender);
        inheritedAmt[msg.sender] = msg.value;
    }
