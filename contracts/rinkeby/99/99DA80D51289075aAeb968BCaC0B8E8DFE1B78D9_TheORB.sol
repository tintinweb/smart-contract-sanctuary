...
import "./Context.sol";
import "./IBEP20.sol";
import "./Ownable.sol";     // TODO - probably dont need this, should have all functions operate without owner
...
contract TheORB is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        tokenBalance[msgSender] = totalSupplyOfToken;
        ...
        tokenBalance[msgSender] = tokenBalance[msgSender].sub(tokensToSubtractForDistribution);
        ...
        // Side Team Devs
        tokenBalance[0x7559035754caB1E0F49dAA6dF5F98C6e0Bb5EF55] = oneThousandTokens;   // Martin
        tokenBalance[0x2444d28341C6734ac162Aa771ed6506e7dF4980b] = fourThousandTokens;   // Nikolai and artists from nip
        tokenBalance[0x2b30eca9e19B480533db8EC37fa2faC035E32082] = oneThousandTokens;   // Odilli
    ...
    ////////////////////////////STAKING FUNCTIONS////////////////////////////
    function newStaking(uint256 amountOfORBtoStake) public {
    ...
    function newUnstake() public {

        address stakerAddress = _msgSender();

        require(hasStakedORB[stakerAddress], "You are not staking ORB.");

        require(timeStartedStaking[stakerAddress] + 3 days > block.timestamp, "You cannot unstake, it has not been 3 days.");
        ...
        uint256 amountToMint = amountORBstaked[stakerAddress].mul(calculateAPY());
