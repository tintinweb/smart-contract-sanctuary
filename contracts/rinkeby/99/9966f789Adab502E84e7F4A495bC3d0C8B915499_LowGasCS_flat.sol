...
contract LowGasCS_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Crystal Skullz", "SGS") {
    setHiddenMetadataUri("ipfs://QmXKHhBpyTDPb2A24obNMq6ndryX6RSRoNmSYcbpAdTCa2/hidden.json");
  }
