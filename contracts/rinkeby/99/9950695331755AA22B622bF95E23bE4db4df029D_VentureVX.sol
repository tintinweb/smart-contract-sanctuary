...
contract VentureVX is ERC721Enumerable, Ownable {
    ...
    constructor (string memory _ventureURI, address _daoAddress) public ERC721 ("VentureVX", "VVX"){
        ...
        token_tracker[uint256(VentureRank.Howard)] = RankDetails(true, 8, 8, 31, 0, 0.0002 ether, 0.00008 ether);
        token_tracker[uint256(VentureRank.Hank)] = RankDetails(true, 31, 31, 61, 0, 0.00013 ether, 0.00006 ether);
        token_tracker[uint256(VentureRank.Joe)] = RankDetails(true, 61, 61, 101, 0, 0.00009 ether, 0.00004 ether);
        MAX_PER_TX = 2;
        MAX_PER_WALLET = 2;
        ...
        // Used for testing
        setRankAvailability(0, 10);
        setRankAvailability(1, 10);
        setRankAvailability(2, 10);
        setRankAvailability(3, 10);
    }
