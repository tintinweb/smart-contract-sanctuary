 ...
 */
contract StarBlock is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
...
/**
 * @title MintableTokenFactory
 * 使用Factory部署智能合约
 */

// contract StarBlockFactory  {
    
//      //存储已经部署的智能合约的地址
//     uint public numCollections = 0;
//     mapping(uint => address) addrCollections;
...
//      function createFactoryCollection(string memory name, string memory symbol,address newOwner) public  {
        
//          StarBlock token = new StarBlock(name,symbol, newOwner, "https://my-json-server.typicode.com/abcoathup/samplenft/tokens","ipfs://"); 
//          addrCollections[numCollections] = address(token);
//          numCollections++;
//      }
...
//           StarBlock token = StarBlock(getAddress());
//           token.mint(tokenId,tokenURI);
//      }
     
    
// //      function getAddress() public view returns(address) {
// //         return addrCollections[numCollections - 1];
// //      }
