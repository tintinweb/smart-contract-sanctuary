...
contract WhattyClub is ERC721, Ownable, WithdrawFairly {
    ...
    uint256 public publicSalesStart = 1634968800; // 2021-10-25 at 21:00:00 UTC
    ...
    function whitelistSalesMint(uint256 _count, uint256 _max, bytes memory _signature) public payable whitelistIsOpen{
        ...
        require(whitelistSalesSignature(wallet,_count,_max,_signature) == owner(), "Not authorized to mint");
    ...
    function preSalesMint(uint256 _count, uint256 _signatureId, bytes memory _signature) public payable preIsOpen{
        ...
        require(preSalesSignature(wallet,_count,_signatureId,_signature) == owner(), "Not authorized to mint");
...
contract WithdrawFairly is Ownable {
    ...
    constructor(){
        parts.push(Part(0x722FFd38eB050e92f4C3804a8bf823521C726d77, 50, 50)); // creator
