...
contract Invaders is ERC721 {
    ...
    uint public max_amount = 20 ; //maximum invader amount/address
    ...
    */
    ...
    function baseTokenURI() public pure returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmXDoUhHo32ESHotggxv5wWfqV77zRD4JnrjFhbC2mEzLK/";
    }
    ...
    */
    ...
    /**
    * @dev concatenate two strings a and b: a + b
    * @param a, string a
    * @param b, string b
    * @param c, string c
    */
