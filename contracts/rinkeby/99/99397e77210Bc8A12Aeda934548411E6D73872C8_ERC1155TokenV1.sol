...
contract ERC1155TokenV1 is Ownable, ERC1155Supply, ERC1155Pausable, ERC1155Burnable {
    ...
    constructor(
        ...
        require(royaltyPercent_ <= _MAX_PERCENT, "ERC1155Token: Invalid royalty percent");
        _name = name_;
        _symbol = symbol_;
    ...
    function updateRoyaltyPercent(uint256 royaltyPercent_) external onlyOwner {
        require(royaltyPercent_ <= _MAX_PERCENT || royaltyPercent_ != _royaltyPercent, "ERC1155Token: Invalid royalty percent");
        _royaltyPercent = royaltyPercent_;
    }
