            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Character #',
                        toString(tokenId),
                        '", "description": "Mounts are randomized generated and stored on chain. Images and other functionality are intentionally omitted for others to interpret. Feel free to use characters in any way you want. Inspired and compatible with Loot (for Adventurers)", "image": "data:image/svg+xml;base64,',
