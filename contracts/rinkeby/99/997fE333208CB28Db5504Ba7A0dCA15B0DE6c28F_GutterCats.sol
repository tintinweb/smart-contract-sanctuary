...
contract GutterCats is ERC1155, Ownable {
	...
	//adopts a cat with the _id
	function adoptCat(uint256 _id) public payable {
		require(msg.value == itemPrice, "insufficient ETH");
		require(_totalSupply[_id] == 0, "this cat is already owned by someone");
		_totalSupply[_id] = 1;
	...
	function mint(
		...
		require(amount == 1, "only unique cats here");
		_totalSupply[id] = 1;
		_mint(to, id, 1, data);
	}
