...
contract OctoHedz is Ownable, ERC721Enumerable {
    ...
    uint256 private _price = 0.007 ether;  //testing is 0.007. - make sure to change that before deployment
   ...
   function getOctoHedz(uint256 numOctoHedz) public payable {
        ...
        require(numOctoHedz > 0 && numOctoHedz <= 100, "You can mint minimum 1, maximum 100 OctoHedz");     //adjust that back before final deployment
