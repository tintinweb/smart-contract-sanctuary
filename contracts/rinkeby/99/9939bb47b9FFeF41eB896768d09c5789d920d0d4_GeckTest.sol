...
contract GeckTest is ERC721Enumerable, RoyaltiesV2Impl { 
    ...
    uint16[9] LEGENDARY_TIERS = [1000, 1000, 1000, 4000, 4000, 4000, 8000, 8000, 8000];
    ...
    function mintInternal() internal {
        ...
        if (legendariesMinted < 9) {
            ...
            if (legendaryDecider == 0) {
                ...
                setRoyalties(thisTokenId, payoutAddress, royaltyFeeBps);
                return; 
            }
        }
