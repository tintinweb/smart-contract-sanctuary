...
/**
   ...
   @dev This contract is used to handle Spore NFT Token using ERC-1155 (https://eips.ethereum.org/EIPS/eip-1155)
*/
contract SporesNFT1155 is Initializable, ERC1155URIStorageUpgradeable, OwnableUpgradeable {
    ...
    /**
       ...
       @dev This function should be called only once - right after SporeNFT1155 contract is deployed
    */
    ...
    */
    function transferMinter(address _newMinter) external {
        ...
        require(_newMinter != address(0), "SporeNFT1155: Set zero address");
    ...
    */
    ...
    /**
       @notice Minting new Spore NFT Token (ERC1155)
       @dev Caller must have Minter role
       @param _to           Receiver Address
       @param _tokenId      Token ID
       @param _amount       An amount of Spore NFT Token being minted
