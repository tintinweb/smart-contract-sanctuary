...
contract UniswapV2SpellV1 is WhitelistSpell {
  ...
  function addLiquidityInternal(
    ...
    require(whitelistedLpTokens[lp], 'UniSpell line 116: lp token not whitelisted');
  ...
  function removeLiquidityInternal(
    ...
    require(whitelistedLpTokens[lp], 'UniSpell line 255:lp token not whitelisted');
  ...
  function harvestWStakingRewards(address wstaking) external {
    ...
    require(whitelistedLpTokens[lp], 'UniSpell line 385: lp token not whitelisted');
    require(collToken == wstaking, 'collateral token & wstaking mismatched');
