...
// File: contracts\MintDeflation.sol
...
contract MintDeflation is Ownable {
    ...
    modifier onlyEOA() {
        ...
        require(msg.sender == tx.origin, "MintDeflation: must use EOA");
        _;
    }
    ...
    function _convert(address token0, address token1) internal {
        ...
        require(address(pair) != address(0), "MintDeflation: Invalid pair");
        // balanceOf: S1 - S4: OK
        // transfer: X1 - X5: OK
        ...
        uint256 amountMTS = _convertStep(token0, token1, amount0, amount1);
        emit LogConvert(
            msg.sender,
            token0,
            token1,
    ...
    function _swap(
        ...
        require(address(pair) != address(0), "MintDeflation: Cannot convert");
    ...
    {
        // X1 - X5: OK
        // mts receive address is own contract
        amountOut = _swap(token, mts, amountIn, address(this));
    }
}