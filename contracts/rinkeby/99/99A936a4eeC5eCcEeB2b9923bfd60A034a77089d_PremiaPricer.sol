...
pragma solidity >=0.7.0;// solhint-disable-line
 ...
 * Premia
 * Copyright (C) 2021 Premia Protocol
 *
...
// /**
//  * @author 0mllwntrmt3
//  * @title Premia Protocol V8888 Interface
 ...
 **/
interface IPremiaPool is IERC721, IPriceCalculator {
     ...
     *   is distributed among the Premia staking participants
...
/**
 * @notice The interface for the contract that stakes Premia tokens
 *   through buying microlots (any amount of Premia tokens per microlot)
 *   and staking lots (888,000 Premia per lot), accumulates the staking
...
// File: contracts/Interfaces/IOptionsManager.sol
/**
...
// File: contracts/Facade/Pricer.sol
/**
 * -License-Identifier: GPL-3.0-or-later
 * Premia
 * Copyright (C) 2021 Premia Protocol
...
/**
 * @author 0mllwntrmt3
 * @title Premia Protocol V8888 Pricer Contract
 ...
 **/
contract PremiaPricer is Ownable {
     ...
     **/
    function poolApprove(IPremiaPool pool) external {
    ...
    function createOption(
        ...
        require(
            ...
            "Pricer Error: The option price is too high"
        );
     ...
     **/
    function unlockAll(IPremiaPool pool, uint256[] calldata optionIDs) external {
    ...
    function claimAllStakingProfits(
        IPremiaStaking[] calldata stakings,
        address account
    ) external {
        uint256 arrayLength = stakings.length;
        for (uint256 i = 0; i < arrayLength; i++) {
            IPremiaStaking s = stakings[i];
    ...
    function exercise(uint256 optionId) external {
        require(
            ...
            "Pricer Error: _msgSender is not eligible to exercise the option"
        );
        IPremiaPool(optionsManager.tokenPool(optionId)).exercise(optionId);
    }
