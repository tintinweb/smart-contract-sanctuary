...
contract TestToken is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  address private constant payoutAddress1 = 0x76f344a68965C1b2223C13cCEDA2805bECA335E7;

  address private constant payoutAddress2 = 0xb04C80c914ABCa4105949c223c74e70103eeC242;

  function withdraw() public {
    uint256 balance = address(this).balance;

    payable(owner()).transfer(balance * 20 / 100);
