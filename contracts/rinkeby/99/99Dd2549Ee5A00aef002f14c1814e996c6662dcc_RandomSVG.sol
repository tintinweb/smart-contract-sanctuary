...
constructor(address _VRFCoordinator, address _LinkToken, bytes32 _keyHash, uint256 _fee) 
    ...
    function create() public payable returns(bytes32 requestId) {
        ...
        requestId = requestRandomness(keyHash, fee); // main piece to get a Random number
        ...
        // use random number to gen random SVG code
        // base64 to encode SVG code
        // get tokenURI and mint NFT
    ...
    function finishMint(uint256 _tokenId) public {
        ...
        // check if that tokenURI has already been assigned  (01:45:00)
