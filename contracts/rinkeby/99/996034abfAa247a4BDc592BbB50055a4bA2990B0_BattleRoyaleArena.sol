...
contract BattleRoyale is ERC721Tradable {
  ...
  */
   ...
   * payout artist
   */
  function payoutArtist() public onlyOwner payable {
...
contract BattleRoyaleArena is Ownable, VRFConsumerBase {
  ...
  function withdrawBalanceInNFTContract(address payable _nftAddress) external onlyOwner payable {
    require(_nftAddress != address(0));
    BattleRoyale battle = BattleRoyale(_nftAddress);
  ...
  // function createNewBattleRoyale(
  //   string memory _name,
  //   string memory _symbol,
  //   uint256 _price,
  //   uint256 _units,
  ...
  //   BattleRoyale b = new BattleRoyale(_name, _symbol, _price, _units, _supply, _artist, _feeRate);
  //   address payable ba = address(b);
  //   battleQueue.push(ba);
  //   return ba;
  // }
  /* ==========================
