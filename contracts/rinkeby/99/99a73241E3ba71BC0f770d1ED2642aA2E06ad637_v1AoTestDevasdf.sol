...
contract v1AoTestDevasdf is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://localhost:5005/@PROJECTID/metadata/image/65.png";
	string private _contractURI = "https://nftify-dev-bucket.s3.us-east-2.amazonaws.com/65/contract-uri";
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("v1AoTestDevasdf", "sadf") {
