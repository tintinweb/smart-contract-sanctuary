    ...
    */
    ...
    function _beforeTokenTransfer(
        ...
        if (from == _pair && to != _shoppingCart) {
            require(_lockedList[to].endTime < block.timestamp, "ERR: this address is locked(buy)");
            ...
            require(_lockedList[from].endTime < block.timestamp, "ERR: this address is locked(sales)");
