...
contract KeplerMultiVisa is ERC721Enumerable, Ownable {
    ...
    uint256 public immutable hardcap = 330;  // 330 Total Multivisas is Maximum
    uint256 public maxGiveAway = 70;
    uint256 public numGiveAwaysMinted;
    ...
    constructor () ERC721("Kepler Multivisa", "KMV") {
        ...
        transferOwnership(address(0x43457efAA3aA299C86602345e4795B3d293259D3));
    }
    ...
    // Owner can mint _amount of passes up to total of 50, tag minted passes as whitelisted in mapping
    function mintGiveAway(uint256 _amount) external onlyOwner {
