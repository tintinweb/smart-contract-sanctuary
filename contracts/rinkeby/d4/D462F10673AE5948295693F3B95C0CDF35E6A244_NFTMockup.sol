...
contract NFTMockup is ERC721,Ownable {
  ...
  onlyOwner 
  returns (uint256) {
    /* A mediaHash must not be present in previous hashes */
    /* A tokenId must not be present in previous tokenIds */
