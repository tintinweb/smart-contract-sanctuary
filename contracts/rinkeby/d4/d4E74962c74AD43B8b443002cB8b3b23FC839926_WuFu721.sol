...
contract WuFu721 is ERC721,Owner {
    ...
    constructor() ERC721("WuFu Token", "WuFu") {
    ...
    function mint(address recipient_, string memory tokenURI) external returns(uint256) {
        require(miners[msg.sender].enable, "get out");
        uint256 tokenId= _getNextTokenId();
        _safeMint(recipient_, tokenId);
        _setTokenURI(tokenId, tokenURI);
        _incrementTokenId();
        miners[msg.sender].totalSupply += 1;
        return tokenId;
    }
