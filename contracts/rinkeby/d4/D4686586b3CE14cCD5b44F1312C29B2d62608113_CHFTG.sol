...
contract CHFTG is ERC721  {
    ...
    constructor() ERC721("Characters (for the game)", "CHFTG", " https://unencrypted.digital/characters/json/" ,address(0x5859e2C1637C28a564Ad58F3299Ab369f1f927eB)) {
    ...
    function buyNFT()external payable returns(bool, uint){
        require(!contractPaused);
    ...
    function buyNFT2()external payable {
        require(!contractPaused);
        require(_startSale, "The sale hasn't started.");
        require(tokensSold+1 <=10000, "The tokens limit has reached.");
        require(msg.value >= price, "Insufficient funds to purchase.");
