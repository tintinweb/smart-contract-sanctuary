...
contract HNFTS is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // ===============================================================
    constructor() public ERC721("handNFTs", "HNFT") {}
    ...
    */
    ...
    function finalizeProvenance(string memory provenanceData) public onlyOwner {
