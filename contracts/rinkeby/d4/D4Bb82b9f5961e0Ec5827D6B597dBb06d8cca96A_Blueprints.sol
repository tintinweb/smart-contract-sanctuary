...
*/
    ...
    string imageUrl = 'https://axons.art/api/blu3prints/image/';//'ipfs://QmcemCSGwpJ9GevU5adZbKhmGguRM3UTrSwgzz5QrPD8op?x=';
    string otherTraits = '';
    ...
    constructor(address _blueprintsData, bytes32 _dayOneMerkleRoot, bytes32 _eightsMerkleRoot, bytes32 _sevensMerkleRoot) ERC721("BLU3PRINTS", "BLU3PRINTS") {
        ...
        // Palette
        TIERS[0] = [800,800,800,700,300,300,300,500,100,100,300,100,4400,500];
        // Form
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
     ...
     * @dev Batch mint dev
     */
    function devMint(uint256 amt) public onlyOwner {
...
*/
        ...
        returns (string memory)
    {
        ...
        string memory description = '", "description": "1489 forgotten BLU3PRINTS were found, left behind by a distant civilization. Traits generated on-chain. Metadata and BLU3PRINTS are mirrored permanently on-chain.",';
