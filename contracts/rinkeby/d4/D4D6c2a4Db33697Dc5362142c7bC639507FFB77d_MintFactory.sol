...
// File: contracts/EtermonProxySupported/MintFactory.sol
...
contract MintFactory is MinterRole {
    ...
    function mintTo(address to,address nftAddress, uint256 tokenId) external onlyMinter{
        Etermon(nftAddress).mint(to, tokenId);
    }
}