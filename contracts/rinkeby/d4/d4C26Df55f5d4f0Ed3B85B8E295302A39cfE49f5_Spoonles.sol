...
contract Spoonles is Ownable, ERC721A, ReentrancyGuard, Pausable {
    ...
    uint16 public constant TOTAL_TOKENS_COUNT = 5555;
    uint256 public constant MAX_BATCH_SIZE = 7;

    string private _baseTokenURI = "https://spoonles.eth";

    constructor() ERC721A("Spoonles", "SPL", MAX_BATCH_SIZE) {}
    ...
    function mint(uint256 quantity) external payable callerIsUser whenNotPaused {
        require(
            ...
            "Spoonles: Reached max tokens count"
        );
