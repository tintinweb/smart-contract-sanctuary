        ...
        bytes(
          string(
            abi.encodePacked(
              ...
              toString(tokenId),
              '", "description": "The Songs of the Metaverse. First collection of 5 unique and original songs to accompany you on the journey ahead. Along with each song you will also get musical characteristics. Compatible with Loot (for Adventurers)", "animation_url": "',
              song,
