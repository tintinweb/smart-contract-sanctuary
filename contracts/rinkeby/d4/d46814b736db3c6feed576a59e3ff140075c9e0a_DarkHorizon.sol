    ...
    OwnableUpgradeable
{
    ...
    function initialize(address _proxyRegistryAddress) public initializer {
        __ERC721_init('DarkHorizon', 'DH');
        __ERC721Enumerable_init();
        __Ownable_init();

        proxyRegistryAddress = _proxyRegistryAddress;

        _verifier = 0xBC2BE33AA56186764e716b04A64c5aa617139cad;
         ...
         */
        baseTokenURI = 'https://www.darkhorizon.io/api/tokens/';

        // TODO: set provenance hash
        provenanceHash = '';
    }
    ...
    function _mintTokens(
        ...
        address signer = _recoverWallet(sender, tokensAmount, id, signature);
