...
contract Pizza is ERC721Token, Ownable {
    event Buy(
        uint indexed idx,
        address owner,
        uint x,
    ...
    function mint(address _to, uint256 _tokenId) public {
        super._mint(_to, _tokenId);
        super._setTokenURI(_tokenId, tokenURI(_tokenId));
    }
    function tokenURI(uint256 _tokenId) public view returns (string) {
     return (String.appendUintToString("https://btcnft.pizza/p/", _tokenId));
    }
