...
contract SisterFactory is FactoryERC721, Ownable {
    ...
    function name() external pure override returns (string memory) {
        return "1,989 Sisters Sale [FINAL_DRAFT]";
    }

    function symbol() external pure override returns (string memory) {
        return "1989-Sisters-Factory-FINAL-DRAFT";
    }
...
contract Sister is ERC721Tradable {
    string public SISTER_COLLECTION_NAME = "1,989 Sisters [FINAL_DRAFT]";
    string public SISTER_SYMBOL = "1989-Sisters-FINAL-DRAFT";
