...
// File: contracts/CoolMonsters.sol
...
contract CoolMonsters is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;

    //sale settings
    uint256 constant private MAX_SUPPLY = 5555;
    uint256 constant private MAX_PRESALE_MINT = 0;
    uint256 private TEAM_RESERVE_AVAILABLE_MINTS = 5555;
    uint256 private COST = 0.00 ether;
    uint256 private MAX_SALE_MINT = 5555;
  ...
  function withdraw() public onlyOwner {
    ...
    // You can remove this if you want, or keep it in to support HashLipsthe dev.
    // =============================================================================
