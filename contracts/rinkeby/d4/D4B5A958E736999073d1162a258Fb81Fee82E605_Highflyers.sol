// Highflyers.sol
//
// degenerated.io // 2021 // [email protected]
//
...
contract Highflyers is ERC721 {
    ...
    function _mintWithChecks(address mintAddress, uint256 numberOfTokensToMint) internal {
        ...
        for (uint256 mt = 0; mt < numberOfTokensToMint; mt++) {
            ...
            // onERC721Received receiver in the remote contract. this means you couls mint to a contract that doesn't
            // accept ERC721 tokens, but if someone mints to a non-ERC721 accepting address, that's on them
