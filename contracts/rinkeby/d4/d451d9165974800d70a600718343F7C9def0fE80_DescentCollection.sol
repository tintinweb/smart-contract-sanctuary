...
contract DescentCollection is ERC721, Ownable {
    ...
    function mintDescent(address _toAddress, uint256 tokenId) public onlyOwner {
        _tokenCount++;
        tokenId = _tokenCount;
    ...
    function burnDescent(uint256 tokenId) public virtual onlyOwner {
