...
contract LuxuryDeerClub is ERC721Enumerable, Ownable {
    ...
    uint256 public OWNER_RESERVED = 8;
    uint256 public price = 10000000000000000; //0.01 Ether test price-- should be changed to 0.1 before going live
    string baseTokenURI;
    ...
    function setMaxSupply(uint256 _max_supply) public onlyOwner {
        require(_max_supply <= 7777,"Max supply limit cannot be set for greater than 7777");
