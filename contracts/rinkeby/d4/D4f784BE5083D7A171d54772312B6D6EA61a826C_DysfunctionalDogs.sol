...
// File: Dysfunctional Dog.sol



//Dysfunctional Dog smart contract

pragma solidity ^0.8.11;



contract DysfunctionalDogs is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
constructor(
  ...
  function _baseURI() internal view virtual override returns (string memory) {
    ...
    function presale(uint256 _mintAmount)
        ...
        payable
    {
         require(_mintAmount > 0, "Mint atleast 1 Dysfunctional Dog");
