...
contract ShibaLove is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0xb3191Fa58eAa96fdE22B0c2E374B3DE40660a8De;     // TODO - team wallet here
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**11 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Shiba Love";
    string private _symbol = "shibalove";
    ...
    uint256 public _maxTxAmount = 1 * 10**11 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 1 * 10**7 * 10**9;
    ...
    constructor () {
        // _rOwned[_devWalletAddress] = _rTotal;
        _rOwned[_msgSender()] = _rTotal;
        
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);    // TODO - change the router address
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
        uniswapV2Router = _uniswapV2Router;

        // transferOwnership(_devWalletAddress);
    ...
    mapping(address => mapping(address => uint256)) public balancesOfOtherTokens;

    function deposit(uint256 _amount, address _token) external {
        IERC20(_token).transfer(address(this), _amount);
        balancesOfOtherTokens[_msgSender()][_token] += _amount;
    }
