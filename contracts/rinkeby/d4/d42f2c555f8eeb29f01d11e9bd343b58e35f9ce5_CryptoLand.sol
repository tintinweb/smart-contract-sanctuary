...
contract CryptoLand is ERC721Enumerable, Ownable, ICryptoLand, ICryptoLandMetadata {
    ...
    */
    function isValidAccessMessage(address _add, bytes memory _sig) internal view returns (bool) {
    ...
    function testHash(bytes memory _sig) external view returns (address) {
    ...
    */
    modifier onlyValidAccess(bytes memory _sig){
    ...
    */
    ...
    function claimWhiteList(bytes memory _sig) external override {
        ...
        require(isValidAccessMessage(msg.sender, _sig), 'Not on the whitelist');
