...
contract Thelandmark is ERC721Enumerable, Ownable {
    ...
    uint256 public _reserved = 100; // Reserved for team and marketing 
    uint256 public _price = 0.14 ether; // Price 
    uint256 public whitelist_count  =  0; // start count for whitelist
    uint256 public mintpass_count  =  0; // start count for mintpass
    bool public _paused = true; // contract is paused 
...
// MINTPASS Mint public payable only for the whitlisted people 
