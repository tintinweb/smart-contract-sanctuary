...
// File: contracts/WerewolvesofWallStreet_flattener.sol
...
// File: contracts/WerewolvesofWallStreet.sol
...
contract WerewolvesofWallStreet is ERC721, Ownable {
    ...
    string private _baseTokenURI; // = "ipfs://QmQbmR7YxrHUMpFnZwj21nmrtSu9ijy5kSZkE26ZjeEw8w/";
    uint256 public _price; // = 80 ether;
    ...
    function stopEarlyMint() public onlyOwner {
        isInEarlyMint = false;
    }
}