...
contract NFTCollectible is ERC721Enumerable, Ownable {
    ...
    uint256 constant PRESALES_PRICE = 0.01 ether;
    ...
    constructor(string memory baseURI)
        ERC721("name test collection", "NFTNTC")
    {
        setBaseURI(baseURI);
    }
    ...
    function addListAddressToWhitelist(address[] memory addrs)
        public
        onlyOwner
    {
    ...
    function mintNFTs(uint256 _count) public payable {
        ...
        if (_presaleActive) {
            require(
                PRESALES_PRICE.mul(_count) <= msg.value,
            ...
            require(
                PUBLIC_PRICE.mul(_count) <= msg.value,
                "Ether sent is not correct"
            );
        }
