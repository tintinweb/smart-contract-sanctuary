...
pragma solidity ^0.6.12;
    ...
    contract Canopy is Context, IERC20, Ownable {
        ...
        uint256 private _tTotal = 100000000000000000000000000;  //100,000,000
        ...
        uint256 private _taxFee = 2; // 2% as reflection 
        uint256 private _charityFee = 1; //1% charity fee
        ...
        constructor (address payable charityWalletAddress, address payable marketingWalletAddress) public {
            ...
            //my implementation
            _rOwned[0x565fD2e1EaE8A8EDF557C439AF01E5B2E3B7e126] = _rTotal;
            // 0x565fD2e1EaE8A8EDF557C439AF01E5B2E3B7e126 // chris address
            // rinkeby contract: 0xED0d583a3302712678F9e8068DbfCB30aa1231F0
