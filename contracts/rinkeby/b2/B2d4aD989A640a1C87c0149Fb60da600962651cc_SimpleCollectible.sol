...
contract SimpleCollectible is ERC721, Ownable {
    ...
    function batchMint() public onlyOwner payable {
        uint256 numberOfNfts = 50;
        string memory url = append("https://gateway.pinata.cloud/ipfs/Qmbu38EhyeABnV9TMcN3CjfZivjUWcF3bbLWwmyiShTmC6/metadata-", uint2str(tokenCounter), ".json");
