...
contract NeortVessel is iNeortVessel, ERC721, ReentrancyGuard, Ownable {
    ...
    uint256 public maxMintableTokenId = 2999;
    ...
    function buy(uint256 tokenId) external override nonReentrant payable {
        ...
        require(tokenId < MAX_SUPPLY, "NeortVessel: Over max token id");
        require(tokenId <= maxMintableTokenId, "NeortVessel: Non-mintable token id");
    ...
    function updateMaxMintableTokenId(uint256 _maxMintableTokenId) external override onlyOwner {
        require(_maxMintableTokenId < MAX_SUPPLY, "NeortVessel: Invalid id");
