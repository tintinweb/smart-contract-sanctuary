...
contract Stampu is IERC2981, ERC1155, Ownable {
  ...
  function sendPostcard(
    ...
    _sendPostcard(from, to, id, fromText, toText, message, msg.value);
  }
  ...
  function _sendPostcard(
    ...
    emit SendPostcard(_postcardIdCounter.current(), from, to, id, fromText, toText, message, value);
  ...
  function batchSendPostcards(
    ...
    for (uint256 i = 0; i < toAddresses.length; i++) {
      _sendPostcard(from, toAddresses[i], id, fromText, toText, message, valuePerPostCard);
    }
  }
  ...
  function mintAndSendPostcard(
    ...
    _sendPostcard(from, to, id, fromText, toText, message, valueLeft);
  }
