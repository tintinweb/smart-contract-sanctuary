...
contract Escrow is Pausable, Ownable {
    ...
    mapping(address => uint256[]) public address_contract_ids; // Contract IDs associated with each address
    ...
    modifier onlyBuyer(uint256 _id) {
        require(contracts[_id].buyer == msg.sender || contracts[_id].buyer == address(0), "Error: Only buyer");
        _;
    }
    ...
    /**
     * Find n contracts after from offset
     */
    ...
    /**
     * Find n contracts of address after from offset
     */
