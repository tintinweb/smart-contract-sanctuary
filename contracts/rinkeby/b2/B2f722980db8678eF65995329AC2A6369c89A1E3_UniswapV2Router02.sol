...
contract UniswapV2Router02 is IUniswapV2Router02 {
        ...
        override
    {
        ...
        // TransferHelper.transferFrom(token, address(this), to, amount);
    }
}
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex'e78e81bbc6542769cb853236f5ab55fe25942da0776a3a6c40f7bbec4076d3dc' // init code hash of factory
                    )
                )
            )
        );
