...
contract PlanetNFT is ERC721Tradable {
    ...
    function create_random(uint256 tokenId,
        ...
        newPlanet.history=uint64(randomNum(1000000000000000000, newPlanet.randomness, block.timestamp));
        newPlanet.distance=uint64(randomNum(1000000000000000000, newPlanet.randomness, block.timestamp));
        ...
        newPlanet.rotationX=100+uint16(randomNum(600-newPlanet.radius, newPlanet.randomness, block.timestamp));
        ...
        if(_angletype==0){
            ...
            newPlanet.positionY=int16(700-int16(newPlanet.radius)-int16(newPlanet.rotationY)*2)-int16(uint16(randomNum((700-newPlanet.radius-newPlanet.rotationY)*2, newPlanet.randomness, block.timestamp)));
            ...
            newPlanet.positionY=int16(700-int16(newPlanet.radius)-int16(newPlanet.rotationX)*2)-int16(uint16(randomNum((700-newPlanet.radius-newPlanet.rotationX)*2, newPlanet.randomness, block.timestamp)));
...
*/
    ...
    function _getJsonAttributes(
        ...
        ERC721MetadataAttribute[] memory metadataAttributes;
