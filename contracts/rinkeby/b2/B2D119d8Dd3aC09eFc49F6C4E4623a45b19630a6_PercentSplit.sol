...
contract PercentSplit is Constants, Initializable {
  ...
  receive() external payable {
    ...
    _shares[0].recipient.sendValue(msg.value - totalSent);
  }
  ...
  function proxyCall(address target, bytes memory callData) public payable onlyRecipient {
    target.functionCallWithValue(callData, msg.value);
  }
}
