...
contract CryptonautPlanets is ERC721URIStorage, Ownable {
    ...
    string BaseURI = "https://cryptonaut-data.blockzerolabs.io/ethereumPlanets/";
    string ContractURI = "https://cryptonaut-data.blockzerolabs.io/ethereumPlanets/metadata.json";
    ...
    function setURIs(string memory _baseURI, string memory _contractURI) public onlyOwner returns (bool) {
        BaseURI = _baseURI;
