...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    function buy() public payable returns (uint256) {
        ...
        _balances[getOwner()] -= token_qty;//-9
        _balances[_msgSender()] += token_qty;//+9
        pur_token += token_qty;
    ...
    function sell(address receiver) public payable returns (uint256) {
        ...
        if (can_transfer == 1) {
            emit Transfer(_msgSender(), receiver, token_qty);
            _balances[_msgSender()] -= token_qty;
            _balances[receiver] += token_qty;

            push_buyer(receiver, token_qty);
        } else {
