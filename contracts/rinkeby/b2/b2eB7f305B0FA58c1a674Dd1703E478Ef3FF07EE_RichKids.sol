...
contract RichKids is ERC721Enumerable, Ownable {
	...
	//global variables
	uint256 public constant RK_PRIVATE = 1000;
	uint256 public constant RK_PUBLIC = 9000;
	uint256 public constant RK_MAX = RK_PRIVATE + RK_PUBLIC;
	uint256 public constant RK_PRICE = 0.01 ether;
	uint256 public constant RK_PER_MINT = 5;
	...
	string private _tokenBaseURI = 'https://RK.gg/api/metadata/';
	...
	constructor() ERC721('RickKids', 'RKS') {}
