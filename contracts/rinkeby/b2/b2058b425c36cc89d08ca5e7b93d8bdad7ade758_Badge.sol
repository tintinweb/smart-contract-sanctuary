...
contract Badge is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[23] = 'Str  ';
        parts[24] = getStrength(tokenId);
        parts[25] = '</text><text x="10" y="180" class="base">';
        parts[26] = 'Sta  ';
        parts[27] = getStamina(tokenId);
        parts[28] = '</text><text x="10" y="200" class="base">';
        parts[29] = 'Agi  ';
        parts[30] = getAgility(tokenId);
        parts[31] = '</text><text x="10" y="220" class="base">';
        parts[32] = 'Cha  ';
        parts[33] = getCharisma(tokenId);
        parts[34] = '</text><text x="10" y="240" class="base">';
        parts[35] = 'Int  ';
        parts[36] = getIntelligence(tokenId);
        parts[37] = '</text><text x="10" y="260" class="base">';
        parts[38] = 'Shi  ';
        parts[39] = getShield(tokenId);
