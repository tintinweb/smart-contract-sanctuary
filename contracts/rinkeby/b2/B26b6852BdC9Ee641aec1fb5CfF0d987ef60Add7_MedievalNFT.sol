...
contract MedievalNFT is Initializable, ERC721BEnumerableUpgradeable, MedievalAccessControlled, VRFConsumerBase{
    ...
    // TODO implement burned in the base class
    Counters.Counter _burned;
    ...
    function mint(address to, uint256 occupation) public onlyMinter{
        ...
        //tokenSeed[tokenId] = uint256(keccak256(abi.encode(
         //   blockhash(block.number-1), tokenId)));
    ...
    function _setLevelCap(uint256 _cap) internal {
        levelCap = _cap;
    }
