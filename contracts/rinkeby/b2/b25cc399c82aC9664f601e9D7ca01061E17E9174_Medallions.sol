...
contract Medallions is ERC721Enumerable, Ownable {  
    ...
    function mintWithRunners(uint256 [] memory ids) external payable {
        ...
        require(isPublic || allowRenegades, "Mint not active");
    ...
    function mint(uint256 qty) external payable {
        ...
        require(isPublic, "Mint not active");
    ...
    function setIsPublic(bool value) public onlyOwner {
        isPublic = value;
    }

    function setAllowRenegades(bool value) public onlyOwner {
        allowRenegades = value;
    }

    function withdraw() public  {
        (bool success, ) = foundryTreasury.call{value: address(this).balance}("");
