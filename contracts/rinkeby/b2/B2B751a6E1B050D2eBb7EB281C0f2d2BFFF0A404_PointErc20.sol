...
contract PointErc20 is ERC20Burnable, Ownable {
  ...
  constructor() public ERC20("dPoint", "DPT") ERC20Burnable() {
  }
  ...
  function transfer(address recipient, uint256 amount) public override returns (bool) {
    require(whitelisted[recipient] || whitelisted[_msgSender()], "PointErc20: only allowed to be used in ecosystem");
    return super.transfer(recipient, amount);
  }

  function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
    require(whitelisted[recipient] || whitelisted[sender], "PointErc20: only allowed to be used in ecosystem");
