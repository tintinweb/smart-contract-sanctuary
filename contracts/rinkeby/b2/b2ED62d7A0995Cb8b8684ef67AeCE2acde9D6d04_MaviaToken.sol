 ...
 * @title Mavia Token
 *
 * @notice This contract is the implementation of Mavia token
 *
 * @dev This contract contains logic Mavia ERC20 token
 *
...
contract MaviaToken is ERC20Token, ICustomToken {
  ...
  function __MaviaToken_init(address _l1CustomGateway, address _l1GatewayRouter) public initializer {
    __ERC20Token_init("MaviaToken", "MAVIA", 18, 250_000_000);
