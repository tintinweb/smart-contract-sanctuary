...
contract BridgeETH is Ownable, ReentrancyGuard {
    ...
    address public constant TRUSTED_TOKEN_ADDRESS = 0x5550121471fe1D74C2e1193434517B0969900A2b;
    address public verifyAddress = 0x12f54Da9b1126B405f43867210ca0D52F669988F;
    ...
    /// signature methods.
	function verify(address account, uint amount, uint chainId, uint id, bytes calldata signature) internal view returns(bool) {
