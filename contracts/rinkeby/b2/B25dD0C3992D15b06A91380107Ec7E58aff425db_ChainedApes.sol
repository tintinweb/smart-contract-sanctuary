...
contract ChainedApes is ERC721Enumerable {
    ...
    //address
    address cigerethAddress;
    address _owner;

    constructor() ERC721("Apes Unchained", "APES") {
        _owner = msg.sender;

        //Declare all the rarity tiers

        //Hat
        TIERS[0] = [200, 300, 500, 700, 1000, 1300, 6000];
        //Glasses
        TIERS[1] = [100, 500, 2400, 7000];
        //Neck
        TIERS[2] = [500, 1000, 1500, 7000];
        //Earrings
        TIERS[3] = [50, 200, 300, 300, 9150];
        //Eyes
        TIERS[4] = [50, 100, 400, 450, 500, 700, 1800, 2000, 2000, 2000];
        //Mouth
        TIERS[5] = [100, 250, 500, 900, 1000, 1200, 1250, 1500, 1500, 1800];
        //Shirts
        TIERS[6] = [1000, 2000, 7000];
        //Character
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
    ...
    /**
     * @dev Returns the current cigereth cost of mint.
     */
    ...
    /**
     * @dev Mint for Cigereth
     */
    function mintCatWithToken() public {        
        //Burn this much Cigereth
        ICigereth(cigerethAddress).burnFrom(msg.sender, currentApeCost());
        return mintInternal();
    }
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    ...
                                    '", "description": "Chained Apes. Ethereum. Figure out the rest you dirty ape..", "image": "data:image/svg+xml;base64,',
                                    ApesLibrary.encode(
...
|     | \      / |  |  ||     ||  .  \    |  |   |     ||  |  \     | |  |   |  ||     ||  |  |\    |
 \___/   \_/\_/  |__|__||_____||__|\_|    |__|    \__,_||__|__|\____| |__|  |____|\___/ |__|__| \___|
    ...
    */
    ...
    /**
     * @dev Sets the Cigereths ERC20 address
     * @param _cigerethAddress The Cigereth address
     */

    function setCigerethAddress(address _cigerethAddress) public onlyOwner {
        cigerethAddress = _cigerethAddress;
    }
