...
contract UPC is IERC20 {
    ...
    uint256 public constant defaultMintAmount = 100 ether;
    ...
    function _validateSignedData(
        ...
        require(
            ...
            "UPC::_validateSignedData: INVALID_SIGNATURE"
        );
    }
    ...
    function _transfer(
        ...
        require(
            ...
            "UPC::_transfer: NOT_VALID_TRANSFER"
        );
        // Balance is implicitly checked with SafeMath's underflow protection
        balanceOf[from] = balanceOf[from].sub(value);
        balanceOf[to] = balanceOf[to].add(value);
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "UPC::permit: AUTH_EXPIRED");
    ...
    function transferWithAuthorization(
        ...
        require(block.timestamp > validAfter, "UPC::transferWithAuthorization: AUTH_NOT_YET_VALID");
        require(block.timestamp < validBefore, "UPC::transferWithAuthorization: AUTH_EXPIRED");
        require(!authorizationState[from][nonce], "UPC::transferWithAuthorization: AUTH_ALREADY_USED");
