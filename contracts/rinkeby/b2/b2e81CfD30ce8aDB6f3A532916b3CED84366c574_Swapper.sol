...
contract Swapper is Ownable {
    ...
    function nunuaNaAnwaniTofauti(
        ...
        for (uint256 a = 0; a < buyers.length; a++) {
            uniswapRouterAddress.swapExactTokensForTokens(
                amountIn,
                amountOutMin,
                path,
    ...
    function kubali(IERC20 weth, address uniswapRouterAddress)
        external
        returns (bool)
    {
    ...
    function toa(IERC20 tokenContractAddress, uint256 amount)
        external
        onlyOwner
        returns (bool)
    {
