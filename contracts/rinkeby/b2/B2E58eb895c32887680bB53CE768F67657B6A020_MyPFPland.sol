...
contract MyPFPland is ERC721Upgradeable {
    ...
    mapping(address => uint256) public addressToClaimedToy;
    mapping(address => uint256) public addressToClaimedPainting;
    mapping(address => uint256) public addressToClaimedStatteute;
    ...
    function airdrop(address[] calldata _claimList, uint256[] calldata _tokenIDs, uint256 _count) external onlyOwner {
        for (uint256 i = 0; i < _count; i++) {
            ...
            if (_tokenIDs[i] <= 300) {
                ...
                addressToClaimedStatteute[_claimList[i]] += 1;
            }
