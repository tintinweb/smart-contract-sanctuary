...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(address _priceFeedAddress, address _vrfCoordinatorAddress, address _linkTokenAddress, bytes32 _keyHash, uint256 _fee) public VRFConsumerBase(_vrfCoordinatorAddress, _linkTokenAddress) {
    ...
    function getEntranceFee() public view returns(uint256) {
        ...
        uint256 adjustedPrice = uint256(price) * 10**10; //this will give the usd price for one 1eth with 10 decimals
        // $50, $2000 / ETH => get nicht
        // 50 * 100000 / 2000
    ...
    function startLottery() public onlyOwner {
        require(lottery_state != LOTTERY_STATE.OPEN, "This lottery is already open");
        lottery_state = LOTTERY_STATE.OPEN;
    }

    function endLottery() public onlyOwner {
        // sudo pseudo randomnumber
    ...
    function fulfillRandomness(bytes32 requestId, uint256 _randomness) internal override {
        ...
        require(randomness > 0, "No randomnumber found");
