...
contract DirtyBusiness is NPassCore {
    ...
    function getPersonality(uint256 tokenId) public view returns (string memory) {
        ...
        if (personality < 164) return "ISTJ";
        else if (personality < 276) return "ESTJ";
        else if (personality < 361) return "ISTP";
        else if (personality < 442) return "ISFJ";
        else if (personality < 518) return "ISFP";
        else if (personality < 593) return "ESFJ";
        else if (personality < 662) return "ESFP";
        else if (personality < 726) return "ENFP";
        else if (personality < 782) return "ESTP";
        else if (personality < 830) return "INTP";
        else if (personality < 871) return "INFP";
        else if (personality < 911) return "ENTP";
        else if (personality < 944) return "INTJ";
        else if (personality < 971) return "ENTJ";
        else if (personality < 987) return "ENFJ";
        else return "INFJ";
    }
...
abstract contract NPassCore is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function withdrawFunds() external {
        address addr1 = 0x63e7C4170b38fFd6e2A9Ac22FF4ab91E5e8C0265;
        address addr2 = 0xdC89c600175546AE9c7340699385B70bD338B2E5;
        payable(addr1).transfer(address(this).balance * 67 / 100);
        payable(addr2).transfer(address(this).balance);
    }
}
