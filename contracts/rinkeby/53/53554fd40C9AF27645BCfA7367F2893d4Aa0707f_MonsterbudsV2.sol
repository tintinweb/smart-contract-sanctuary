...
contract MonsterbudsV2 is MonsterBudHolders, ERC721URIStorageUpgradeable, IMonsterBudsV2 {
    ...
    */
    ...
    function list(uint256 token_id, uint256 price) external returns(uint256){
       address owner = ownerOf(token_id); 
       require(owner == msg.sender, "$MONSTERBUDS: You are not owner of token");
       tokenListing[owner][token_id] = price; 

       emit ListTokenDetails(owner, token_id, price);
       return price;  
    }
    ...
    */
    ...
    function buyCollectiable(uint256 token_id) external override payable returns(bool){
        ...
        require(tokenListing[owner][token_id] == msg.value && tokenListing[owner][token_id] != 0, "$MONSTERBUDS: Price is incorrect");
