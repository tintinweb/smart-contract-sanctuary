...
contract DoppleToken is ERC20("Coin Token", "Coin-Ton"), Ownable {
  ...
  constructor(uint256 _startReleaseBlock, uint256 _endReleaseBlock) public {
    ...
    // maunalMint 1000k for seeding liquidity
    manualMint(0x413B5b114862C1A2A44F8fd9beeE3fD9aEE8C522, 1000000e18);
  }
