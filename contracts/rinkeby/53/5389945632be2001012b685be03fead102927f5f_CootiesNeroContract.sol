  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x069dFfD8D5E00952D956aEF824D3E3DcDadeEA63);
    ...
    // File: contracts/cootiesNeroContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CootiesNeroContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Cooties Nero", "CTN", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmXkFxLHwu4PwETHCQ13DAJtaFDvfCbJ8YUEnDrfPhdwVB/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/W6hTtUnRec3XeaVDvpYe/contract-metadata";
        }
    }