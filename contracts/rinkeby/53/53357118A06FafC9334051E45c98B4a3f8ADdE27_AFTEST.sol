...
// File: contracts/AFTEST.sol

pragma solidity 0.7.0;


contract AFTEST is ERC721, Ownable {
    using SafeMath for uint256;


    uint256 public constant TESTPrice = 60000000000000000; // 0.06 ETH
    uint public constant maxTESTPurchase = 1;
    uint256 public MAX_TEST = 25;
    bool public saleIsActive = false;

    constructor() ERC721("AFTEST", "AFS") {
    }
    ...
    function mintTEST(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxTESTPurchase, "Can only mint 1 token at a time");
