...
contract Astog is ERC20 {
     ...
     */
    constructor(address _devFeesWallet) ERC20("AstogEtoken", "ASTG") {
        require(
            _devFeesWallet != address(0),
            "DevWallet cannot be zero address."
        );
        devFeesWallet = _devFeesWallet;
    ...
    function _transfer(
        ...
        uint256 feeAmount = (amount * currentRate) / (10000 * 100);
        amount -= feeAmount;
