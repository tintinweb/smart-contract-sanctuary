...
contract SpankPopMinter is ERC721URIStorage, ERC721Enumerable, Ownable {

    bool public saleStarted = true;

    constructor() ERC721("SPANK TEST", "SPKT") {
    }

    function contractURI() public pure returns (string memory) {
        return "https://storage.googleapis.com/pop-shots-support-dev/contractMetadata.json";
    }

    function mint(address _buyer, string memory _tokenURI) public onlyOwner returns (uint256) {
        ...
        emit PermanentURI(_baseURI(), newItemId);
