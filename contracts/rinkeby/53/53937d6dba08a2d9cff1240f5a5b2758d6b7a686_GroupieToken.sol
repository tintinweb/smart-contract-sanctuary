...
contract GroupieToken is ERC721, PaymentSplitter, Ownable {
  ...
  string private _contractURI = "ipfs://QmUX8Dami6mt2EdyNu6czA5bohAdQUuMAG1SRw5LvzZWHw";

  string public baseURI = "http://api.peacevoid.world/";
  ...
  function mint(uint amount) public payable {
    require(startTime > 0, 'GroupieToken: not yet launched');
