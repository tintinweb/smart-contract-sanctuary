...
contract MetaLeopards is ERC721, ERC721Enumerable, Pausable, AccessControl {
    ...
    function addWhiteListed(address _newWhiteListed) public {
        require(hasRole(WHITE_LIST_MANAGER, msg.sender) || hasRole(ROLE_ADMIN, msg.sender) || hasRole(PROJECT_OWNER, msg.sender) == true);
    ...
    function setBaseURI(string memory _newBaseURI) public {
        require(hasRole(CONTRACT_MANAGER, msg.sender) || hasRole(ROLE_ADMIN, msg.sender) || hasRole(PROJECT_OWNER, msg.sender) == true);
        baseURI = _newBaseURI;  
    }
    ...
    function addContractManager(address _newContractManager) public {
        require(hasRole(ROLE_ADMIN, msg.sender) || hasRole(PROJECT_OWNER, msg.sender) == true);
