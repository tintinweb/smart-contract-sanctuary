...
contract LostKoalas is ERC721Enumerable, Ownable{
    ...
    uint256 public whitelistSupply = 1250;
    uint256 public whitelist;
    ...
    constructor()
        ERC721("Lost Koalas", "LK")
    {}

    function whitelistMint(uint256 _amount, bytes32[] memory proof) external payable {
        require(!whitelistState, "Whitelist sale is not enabled");
        require(!paused, "Lost Koalas contract is paused");
        require(_amount < presaleAmountLimit, "Max whitelist mint limit reached");
        require(_presaleClaimed[msg.sender] <= _amount + presaleAmountLimit);
    ...
    function publicMint(uint256 _amount) external payable {
        require(publicState, "Public sale not live");
        require(!paused, "Lost Koalas contract is paused");
        require(totalMint + _amount <= maxSupply, "Max supply reached");
        uint256 _newItemId;
