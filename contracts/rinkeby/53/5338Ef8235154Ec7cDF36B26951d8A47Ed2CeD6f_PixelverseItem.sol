...
contract PixelverseItem is ERC1155PresetMinterPauser, Ownable {
    ...
    address pixelMarketplaceAddress;
    
    // TODO replace with actual IPFS URL (currently just sappy seals lol)
    constructor(address marketplaceAddress) 
        ERC1155PresetMinterPauser("https://ipfs.io/ipfs/QmXUUXRSAJeb4u8p4yKHmXN1iAKtAV7jwLHjw35TNm5jN7/{id}") 
    {
        pixelMarketplaceAddress = marketplaceAddress;
        mintToMarketplace(0, 750, ""); // Pixel Pass

        mintToMarketplace(1, 500, ""); // Arcade - Sappy Jump
        mintToMarketplace(2, 250, ""); // Arcade - Flappy Seal

        mintToMarketplace(3, 1000, ""); // Starter Pack - Sappy Seals
        mintToMarketplace(4, 1000, ""); // Starter Pack - Winter Bears
        mintToMarketplace(5, 1000, ""); // Starter Pack - 24px
    ...
    */
    function mintToMarketplace(
        ...
        super.mint(pixelMarketplaceAddress, id, amount, data);
    }

    // TODO batchMint also maybe?
