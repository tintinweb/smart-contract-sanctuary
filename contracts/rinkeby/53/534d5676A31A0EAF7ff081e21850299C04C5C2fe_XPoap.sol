...
contract XPoap is Initializable, ERC721, ERC721Enumerable, ERC165Storage, PoapRoles, PoapPausable {
    ...
    function tokenURI(uint256 tokenId) public override view returns (string memory) {
        ...
        return _strConcat(baseURI, _uint2str(eventId), "/", _uint2str(tokenId), "");
    }
    ...
    function initialize(string memory __name, string memory __symbol, string memory _baseURI, address[] memory admins) public initializer
    {
    ...
    function _strConcat(string memory _a, string memory _b, string memory _c, string memory _d, string memory _e) internal pure returns (string memory _concatenatedString)
    {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view override(ERC165Storage, ERC721, ERC721Enumerable) returns (bool) {
        return
