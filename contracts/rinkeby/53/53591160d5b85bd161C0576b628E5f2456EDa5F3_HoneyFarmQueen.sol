...
contract HoneyFarmQueen is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    uint256 public REWARDS_COOLOFF = 86400;
    uint256 public HIVE_CLAIM_COOLOFF = 86400;
    ...
    function claimBeesHoney(uint256[] calldata _beesIds) external nonReentrant {
        ...
        for (uint256 i; i < _beesIds.length; i++) {
            ...
            if (roundsToReward > bee.claimCounter) {
                nonRewardsRounds = roundsToReward - 10;
                bee.active = 0;
