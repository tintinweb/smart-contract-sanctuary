...
abstract contract TestCan is ERC721Mochi {
    ...
    //     require(block.timestamp <= auctions[tokenId].auctionEnd, "Auction already ended.");
    //     require(bid_value > auctions[tokenId].highestBid, "There already is a higher bid.");

    //     address owner = ownerOf(tokenId);
    //     require(msg.sender!=owner, "The owner cannot bid his own collectible");

    //     if (auctions[tokenId].highestBid>0) {
    //         require(payment_token.transfer(auctions[tokenId].highestBidder, auctions[tokenId].highestBid), "ERR6");
    ...
    //     require(payment_token.transferFrom(msg.sender, address(this), bid_value), "ERR5");
    ...
    //     require(msg.sender==contract_owner, "Only contract owners");
    //     admin = _admin;
...
contract TestMarketPlace is ERC721Mochi, ReentrancyGuard, TestCan {
    ...
    function buy(uint256 tokenId) public nonReentrant {
        ...
        require(payment_token.transferFrom(msg.sender, _wallets[tokenId], amount4owner), "ERR3");
