...
contract LegoX is ERC721, ERC721Enumerable, Ownable {
	...
	uint public constant MAX_TOKENS_VIP = 30;
	
	
	uint public CURR_MINT_COST = 0.0009 ether;
	...
	uint public CURR_ROUND_SUPPLY = 1932;
	...
	function TransferNFT(address from, address to, uint token) external payable returns(bool)
	{
	...
	function burnAndMint(uint tokenId1, uint tokenId2) public {
