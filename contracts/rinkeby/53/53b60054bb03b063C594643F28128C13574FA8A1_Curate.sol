...
contract Curate is ERC721 {
    ...
    // make sure to change this before actual deployment
    ...
    constructor() ERC721("Curate NFT", "XCUR") {
        // for testing purposes (change back to const owner address later)
        owner = msg.sender;
    }
    ...
    function mintTo(uint16 tokenId, address to) public {
        require(msg.sender == owner, "Not owner");
    ...
    function batchMint(uint16[] memory tokens, address to) public {
        require(msg.sender == owner, "Not owner");
        require(mintingActive, "Minting not active");
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     *  * Combined with _mint, data parameter is "" by default
     *
     * Requirements:
     *
     ...
     *
     * Emits a {Transfer} event
     * Has  an additional `data` parameter which is
