...
contract EtherHeads is Ownable, ERC721Enumerable, recovery {
    ...
    string public EH_PROVENANCE = "952e55ea6b0e344c5b0d4ffb3222d6b234a634d7f8b424ad13fe377ab302de17"; 
    ...
    uint256 public constant maxEarlyAllocation = 2000;
    uint256 public maxEarlySlot = 1000;
    ...
    function redeemableTokensByOwner(address _owner) external view returns(uint256[] memory ) {
        ...
        if (tokenCount == 0) {
            ...
            for (index = 0; index < tokenCount; index++) {
                ...
                // tokenOfOwnerByIndex found in IERC721Enumerable -> IERC721Enumerable public EtherCards; ???
    ...
    // claim free EH tokens for EC holders
