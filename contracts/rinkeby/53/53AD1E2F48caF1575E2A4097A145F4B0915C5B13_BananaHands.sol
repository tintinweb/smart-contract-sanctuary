...
contract BananaHands is ERC721Enumerable, Pausable, Ownable, PaymentSplitter {
    ...
    function hasClaimedFreePresale() public view returns (bool) {
        return _presaleClaimed[msg.sender];
    }
        ...
        presaleMustBeActive
    {
        ...
        require(!hasClaimedFreePresale(), "Already claimed free presale mint");
