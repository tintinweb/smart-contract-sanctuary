...
ur welcome mate btw u mean with same like this 
2%buysell 
2%burn 
3%liq 
3%dev/mark 
both for sell and buy then the burning will work right?
*/
...
contract ETHEREUMINUKU  is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 2000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "ETHEREUM INUKU";
    string public _symbol = "$ETHIKU";
