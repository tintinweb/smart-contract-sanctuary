...
contract PropositionToken is ERC721Enumerable, Ownable {
    ...
    */
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        // string memory heavenlyBody = heavenlyBodyColors[getIndexes(imageCode, 2)];
        ...
        jsonMeta = string(abi.encodePacked(jsonMeta, ' "attributes": [{ "trait_type": "Image DNA", "value": "',toString(imageCode),'" }, { "trait_type": "Sky", "value": "',skyColors[getIndexes(imageCode, 0)],'" }, { "trait_type": "Planet", "value": "',bodyColors[getIndexes(imageCode, 1)],'" }, { "trait_type": "Heavenly Body", "value": "',heavenlyBodyColors[getIndexes(imageCode, 2)],'" }, { "trait_type": "Heavenly Reflection", "value": "',heavenlyReflectionColors[getIndexes(imageCode, 3)],'" }]}'));
