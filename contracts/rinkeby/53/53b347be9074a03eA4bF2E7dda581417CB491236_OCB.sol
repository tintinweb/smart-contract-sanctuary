...
contract OCB is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private constant tokenMaxSupply = 3000;
    uint256 private constant _mask = (2**256 - 1) ^ 0xFFFF;

    address private _a = 0x919036152224102F223641057770F8895a12c46C;
    address private _b = 0x0678abfD613DD53673D1179F719768BD160B068f;
    address private _c = 0x000000000000000000000000000000000000dEaD;
    ...
    {
        string memory color = ["#C47", "#E73", "#457", "#1A4", "#444"][
            sticker_type / 6
        ];
        string memory text = [
            "HODL!",
    ...
    function _getColor(uint256 age) private pure returns (string memory) {
        ...
        return string(abi.encodePacked("rgb(", red, ",210,20)"));
    }
    ...
    function _svgEnvelop(string memory content)
        private
        pure
        returns (string memory)
    {
        ...
        returns (uint256)
    {
        ...
        return (block.timestamp - _ages[tokenId]).div(1 minutes);
    }
        ...
        returns (string memory)
    {
        ...
        traits[0] = seed % 100;
        traits[1] = (seed /= 1000) % 100;
        traits[1] = traits[1] > 70 ? (traits[1] - 70) : 100;
        traits[2] = (seed /= 1000) % 100;
        traits[2] = traits[2] > 70 ? (traits[2] - 70) / 5 : 100;
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "OnChain Banana #',
                        Util.toStr(tokenId),
                        '", "description": "Beautiful Banana Collective","attributes":',
                        attributes,
...
library SpotsUtil {
        ...
        returns (string memory)
    {
        ...
        uint256[] memory str = _strToIndex(pattern_tbl[spotstype % pattern_tbl.length]);
        string memory ret = "";
