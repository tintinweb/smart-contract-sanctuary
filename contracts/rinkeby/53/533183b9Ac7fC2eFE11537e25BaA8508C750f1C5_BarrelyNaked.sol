...
abstract contract Ownables is Ownable {
    ...
    bool private _ownerApproved;
    bool private _secondOwnerApproved; 
    address private _secondOwner;

    modifier onlySecondOwner() {
        require(secondOwner() == _msgSender(), "Caller is not the second owner");
        _;
    }
    ...
    modifier ownersAgreed () {
         require(
            _ownerApproved == true && _secondOwnerApproved == true, 
            "Owners don't agree");
        _;
    }
    ...
    function setOwnerApproval(bool confirmation_) public onlyOwner {

        _ownerApproved = confirmation_;

    }

     function setSecondOwnerApproval(bool confirmation_) public onlySecondOwner {

        _secondOwnerApproved = confirmation_;
