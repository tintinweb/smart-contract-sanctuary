...
contract WallStreetWolves is ERC721Enumerable, Ownable {
    ...
    address[19] private _PaymentAddressList = [
        0xd5e1FF6EA491e2e2078B29dfFd62502D511C9aC5,
        0x4854134ed47698A5635ba58627aa4B52BE4278E4,
        0x4115911Bd2038161d0e1318D7fAC3685563de0c2,
        0xaabd9F8196f9495f2c847eb8449Ab532fa28bC59,
        0x2b79ea5895e40e8772de7bfC9166EdD9d38794Ed,
        0x430c7347bcCEbF66d656Fa5c93529687f086AD75,
        0xA3e063277ECB3917F0b100cEDE48e9528dFD1828,
        0xA74ef7e99cE76e2D18154238599b662521c0C5F5,
        0x9B81f799Bd3389C71339bf16715179aa0c5649E4,
        0xe2f64352251711b4f3De24a17684ff961cF1C7D4,
        0x024f52F7450C687a4C88F152b2Ff456Ce5D2E05f,
        0xA699632b3CD4E562040e3Fd58b592946484ab7Ed,
        0x0696f18dDC6aa68437aD3B54A535ee70649Bdd86,
        0x1640bf06aFfb26B0d7386C692De8f22d6BAa9372,
        0xbFe0709Aa299039847AcC11a87B03fcD1990aAeD,
        0xF100f8A58fD884E56fdcebFF3470a4C22c879E23,
        0xA120d07DB4e07365f9586B359C5719C03c8Ff436,
        0x13c337DE83495Ea68e62623E7787a24B57714B8C,
        0x645C9fa05962DbCfbAA2674ddb53828Afff7910b
    ];

    uint256 [19] _PaymentPercentList = [
        50,
        10,
        10,
        40,
    ...
    uint256 public WOLFIE_MAX = 10000;
    ...
    Counters.Counter private _publicWOLFIE;

    constructor() ERC721("WallStreetWolves", "WOLFIE") {}
    ...
    function airdrop(address to, uint256 numberOfTokens) external onlyOwner {
        for (uint256 i = 0; i < numberOfTokens; i++) {
            uint256 tokenId = _publicWOLFIE.current();

            if (_publicWOLFIE.current() < WOLFIE_MAX) {
                _publicWOLFIE.increment();
    ...
    function purchase(uint256 numberOfTokens) external payable {
        ...
        require(_publicWOLFIE.current() < WOLFIE_MAX,"Purchase would exceed WOLFIE_MAX");
    ...
    function withdraw() external onlyOwner {
        ...
        for (uint256 i = 0 ; i < 19 ; i++) {
            uint256 amount = currentbalance * _PaymentPercentList[i] / 1000;
