...
contract MahaToken is AnyswapV4Token {
using SafeMath for uint256;
    ...
    string public constant symbol = 'MAHA';
    string public constant name = 'Maha Token';
    ...
    function poolMint(address who, uint256 amount) external onlyPools {
        _mint(who, amount);
