...
contract Seraph is Ownable, SeraphStorage {
    ...
    event UnprotectedExecute(bytes4 indexed _clientId, address indexed _contractAddress, bytes4 indexed _functionSelector, bytes _callData);
