    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        phasePrices[0] = 0.069 ether;
        phasePrices[1] = 10000 ether;
        phasePrices[2] = 20000 ether;
        phasePrices[3] = 40000 ether;
        phasePrices[4] = 80000 ether;
    ...
    function mint(
        ...
        if (phase() == 1) {
            require(
                msg.value == phasePrices[0] * amount,
