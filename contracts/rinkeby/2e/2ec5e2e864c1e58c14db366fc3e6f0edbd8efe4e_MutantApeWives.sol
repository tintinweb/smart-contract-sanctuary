...
contract MutantApeWives is ERC721Enumerable, Ownable {
    ...
    function addToWhiteList (address newWalletaddr) public onlyOwner{
        require(whitelist[newWalletaddr].exists == false, "Wallet is already on the Whitelist!");
        whitelist[newWalletaddr].exists = true;
