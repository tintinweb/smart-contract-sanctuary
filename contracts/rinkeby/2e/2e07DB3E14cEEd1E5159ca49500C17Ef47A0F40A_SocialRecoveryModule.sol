...
contract SocialRecoveryModule is Module {
    ...
    /* string private constant SWAP_OWNER_TYPE = "SwapOwner(address prevOwner,address oldOwner, address newOwner)";
   ...
   /*  function hashSwapOwner(SwapOwner memory swapOwner) private pure returns (bytes32){
    ...
    function verify(address signer, SwapOwner memory bid, sigR, sigS, sigV) public pure returns (bool) {
