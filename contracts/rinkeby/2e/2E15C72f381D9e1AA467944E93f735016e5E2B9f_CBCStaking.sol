...
contract CBCStaking is Ownable, ReentrancyGuard {
    ...
    */
    function emergencyWithdraw(address payable receiver, address tokenAddress, uint256 tokenId) public onlyOwner {
      pauseDeposit(true);
      require(receiver != address(0x0), "Cannot send to 0 address");
