...
contract SipherIBCO is Ownable {
    ...
    uint256 public constant START = 1638657313; // Monday, December 6, 2021 1:00 AM UTC
    uint256 public constant END = START + 600; // Thursday, December 9, 2021 1:00 AM UTC
    uint256 public constant TOTAL_DISTRIBUTE_AMOUNT = 4000 * DECIMALS;
    uint256 public constant MINIMAL_PROVIDE_AMOUNT = 2 ether;
