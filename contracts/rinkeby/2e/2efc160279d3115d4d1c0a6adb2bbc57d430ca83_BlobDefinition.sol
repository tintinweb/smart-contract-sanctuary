...
contract BlobDefinition
{
    ...
    /**
     * @dev Get metadata of many blobs
     * @param from Starting id of blob
     * @param to Ending id of blob
     * @return The details
     */
    function getAllOwners(uint from, uint to) public view returns (address[] memory)
    {
