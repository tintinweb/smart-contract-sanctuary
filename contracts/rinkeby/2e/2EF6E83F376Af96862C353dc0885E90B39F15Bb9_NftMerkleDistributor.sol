...
contract NftMerkleDistributor is IMerkleDistributor, Ownable {
    ...
    function claim( uint256 groupId, uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof ) external override {
        ...
        //require(index < newTokenIdBase, "");
        uint256 newTokenId = newTokenIdBase.add(index);
        ...
        ISuper1155( token ).mintBatch( account, _asSingletonArray(newTokenId), _asSingletonArray(uint(1)), "" );
