...
// File contracts/protocol/CKValuer.sol
 ...
 * @author Cook Finance
 *
 * Contract that returns the valuation of CKTokens using price oracle data used in contracts
...
contract CKValuer {
    ...
    function calculateCKTokenValuation(ICKToken _ckToken, address _quoteAsset) external view returns (uint256) {
        ...
        for (uint256 i = 0; i < components.length; i++) {
            ...
            int256 aggregateUnits = _ckToken.getTotalComponentRealUnits(component);
