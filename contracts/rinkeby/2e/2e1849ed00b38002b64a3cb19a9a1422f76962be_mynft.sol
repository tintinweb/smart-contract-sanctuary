...
contract mynft is ERC721 {
    ...
    function setPresaleContract(address addr) external {
        require(msg.sender == _owner, "You are not the owner");
        require(presaleContract == address(0), "Already set");
        presaleContract = addr;
    }
    
  function mintByPrivateSale(address to) external {
        require(msg.sender == presaleContract, "Only the presaleContract can mint tokens");
        tokenCounter +=1;
