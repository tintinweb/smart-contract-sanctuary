...
contract TEST is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/@PROJECTID/metadata/68/image";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/68/contract-uri";
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("TEST", "ANDR") {
