    ...
    SplitForwarderFactory
{
    ...
    function airdropMintToCreator(
        ...
        emit ApproveVerifiedForAll(_creatorAddress, true);
        newTokenId = _mint(
            _tokenURI,
     ...
     * @param _approveVerifiedOperatorForAll bool if true, this and future tokens minted on this contract will be approved for the contracts verified operator address
     * @param _approveVerifiedOperatorForOne bool if true, this token will be approved for the contracts verified operator address
     */
    function mintWithParams(
        ...
        address payable _paymentAddress,
        uint32 _tokenRoyalty,
        bool _approveVerifiedOperatorForAll,
        bool _approveVerifiedOperatorForOne
    ) public returns (uint256 newTokenId) {
        require(
        ...
        if (_approveVerifiedOperatorForAll) {
            setApprovalForAll(verifiedOperator, true);
        } else if (_approveVerifiedOperatorForOne) {
            approve(verifiedOperator, newTokenId);
        }
    }
     ...
     */
    function setApprovalForVerifiedOperator(address tokenOwner, bool approved) public {
        require(
     ...
     */
    function isApprovedForVerifiedOperator(address tokenOwner) public view returns (bool) {
