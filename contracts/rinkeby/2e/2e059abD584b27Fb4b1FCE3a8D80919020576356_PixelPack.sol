...
contract PixelPack is Ownable, ERC1155 {
  ...
  modifier validId(uint256[] memory id){
    for(uint256 i =0;i<id.length;i++){
      require(id[i]>=0&&id[i]<5,"Purchase: Id array is not valid!");
    }
    _;
  }
  ...
  function mint(
    ...
    require(_id>=0&&_id<5,"Purchase: Id is not valid!");
  ...
  function batchMint(
    ...
    bytes memory _data
  ) public onlyAdmins() validId(_ids){
