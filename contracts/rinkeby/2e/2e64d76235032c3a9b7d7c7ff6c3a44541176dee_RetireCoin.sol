...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0xCcA623A2996E819dED27a1CeD0cB932374C4fF45;
...
contract RetireCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Retire Coin";
    ...
    address FeeCollector=0xCcA623A2996E819dED27a1CeD0cB932374C4fF45; //fee holder
    
    uint256 public _feeDecimal = 0; // do not change this value...
    uint256 public _taxFee = 8; // means 8%(distributed to all holders)
    uint256 public _liquidityFee = 0; // means 0%
    uint256 public _burnFee = 0; // means 0%
    uint256 public _ownerFee=800; // 800 means 8% this is how it sets (this is the developer fee)
    ...
    uint256 roundValue = value.ceil(_ownerFee);
    uint256 onePercent = roundValue.mul(_ownerFee).div(10000);
    return onePercent;
  }
    ...
    function _transfer(
        ...
        //Owner fee
        _reflectionBalance[FeeCollector] = _reflectionBalance[FeeCollector].add(tokensToBurn.mul(rate));
