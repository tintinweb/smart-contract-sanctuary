...
contract GoaldIndirectDeployer {
    ...
    function deploy(
        ...
        require(
               latestProxy.getProxyAddress() == address(latestProxy)
            && latestProxy.isAllowedDeployer(address(this))
        , "Invalid address");
...
contract GoaldIndirect is ERC721 {
    ...
    constructor(
        ...
        // Do all of our validation at once.
        require(
            ...
            && collateralToken != intermediaryToken
            && paymentToken    != address(0)
            && paymentToken    != address(this)
            && paymentToken    != intermediaryToken

            // Validate the fee.
            && fee > 0
            && feeIntervalDays > 0
            && finalizationIntervals > 0

            // Validate the timestamp.
            && _nextFeeTimestamp > block.timestamp
        , "Invalid parameters");
