...
contract pg {
    ...
    string internal nftName = "paint";
    string internal nftSymbol = "p☵";
    address public glyphContractAddress = 0xfCFF602F2782CA53d4E0aD91475F962C79E8c0BA;
    ...
    function tokenURI(uint256 id) external pure returns (string memory) {
        return string(abi.encodePacked("https://pgtest.azurewebsites.net/api/HttpTrigger?id=", integerToString(uint256(id))));
    }
