...
import "./SushiHodlStrategyRinkeby_DAI_WETH.sol";

contract SushiHodlStrategyRinkeby_DAI_WETH_Factory is Controllable {
  event NewSushiHodlStrategyRinkeby_DAI_WETH(address impl);

  constructor(address _storage) Controllable(_storage) public {}

  function newSushiHodlStrategyRinkeby_DAI_WETH() public onlyGovernance returns(address) {
    SushiHodlStrategyRinkeby_DAI_WETH addrNew = new SushiHodlStrategyRinkeby_DAI_WETH();
    // SushiHodlStrategyRinkeby_DAI_WETH(address(addrNew)).initializeStrategy(_storage, _vault);
    emit NewSushiHodlStrategyRinkeby_DAI_WETH(address(addrNew));
...
contract SushiHodlStrategyRinkeby_DAI_WETH is MasterChefHodlStrategy {
  ...
  function initializeStrategy(
    ...
    address sushi = address(0x0769fd68dFb93167989C6f7254cd0D766Fb2841F);
    MasterChefHodlStrategy.initializeMasterChefHodlStrategy(
      _storage,
      underlying,
      _vault,
      address(0x80C7DD17B01855a6D2347444a0FCC36136a314de), // master chef contract
      sushi,
      2,  // Pool id
      address(0x38745eab5b545CE76a9697562c920FFa06b26170), // Sushi hodlVault fsushi
