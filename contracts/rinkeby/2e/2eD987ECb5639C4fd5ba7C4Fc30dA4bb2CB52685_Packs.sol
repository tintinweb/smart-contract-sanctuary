...
contract Packs is IERC721, ERC721, ReentrancyGuard {
  ...
  function createNewCollection(bool _editioned, uint256[] memory _initParams, string memory _licenseURI, address _mintPass, uint256 _mintPassDuration) public onlyDAO {
    LibPackStorage.createNewCollection(_editioned, _initParams, _licenseURI, _mintPass, _mintPassDuration);
    LibPackStorage.Storage storage ds = LibPackStorage.packStorage();
...

{
  ...
  "libraries": {
    "contracts/LibPackStorage.sol": {
      "LibPackStorage": "0xe8d5b5c6b32360923dae7f9b58e10c1f2adb518b"
    }
  }
}