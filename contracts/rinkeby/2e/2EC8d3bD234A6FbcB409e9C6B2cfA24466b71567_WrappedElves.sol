...
contract WrappedElves is ERC721, Ownable {
    ...
    string private baseURI = ""; // Used for Unwrapped Token URI
    address private immutable floppyAddress;

    constructor(address _floppyAddress) ERC721("WrappedElves", "wELF") {
    ...
    function wrappedURI(uint256 id) internal view returns (string memory) {
        ...
        string memory image = Base64.encode(
            bytes(SVGBuilder.makeBox(owner, hasFloppies))
        );
        string
...
library SVGBuilder {
    function makeBox(address owner, bool hasFloppies)
        public
        pure
        returns (string memory)
    {
        Colors memory colors;
        colors.boxTop = "#E32D4E";
        colors.boxFront = "#C11E3A";
        colors.ribbonFront = "#982438";
        colors.ribbonTop = "#00000033";
        colors.bow = "#00aa00";
        if (hasFloppies) {
            colors.boxTop = "#15EDF5";
            colors.boxFront = "#10afb5";
            colors.ribbonFront = "#5c145a";
            colors.ribbonTop = "#8A1D88";
            colors.bow = "#361995";
        }
