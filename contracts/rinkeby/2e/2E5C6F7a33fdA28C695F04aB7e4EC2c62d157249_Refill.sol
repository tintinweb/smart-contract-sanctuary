...
interface Common1155NFT {
    function mint(address account, uint256 id, uint256 amount, uint256 specifyCreator) external;
...
contract Refill is AccessControl, Pausable, Utils {
    ...
    function withdraw(uint256 _amount,address _contractAddress, uint256 _tokenId, address _fromAddress,uint256 specifyCreator,bytes32 hash, bytes memory signature, string memory nonce) public whenNotPaused{
        //验证hash
    ...
    function batchWithdraw(uint256[] memory _amountArray,address[] memory _contractAddressArray, uint256[] memory _tokenIdArray, address[] memory _fromAddressArray,uint256 specifyCreator, bytes32 hash, bytes memory signature, string memory nonce) public whenNotPaused{
        //验证hash
    ...
    function _mintNFT(uint256 _amount,address _contractAddress, uint256 _tokenId,uint256 specifyCreator) internal returns(bool){
        if (_checkProtocol(_contractAddress) == 1) {
