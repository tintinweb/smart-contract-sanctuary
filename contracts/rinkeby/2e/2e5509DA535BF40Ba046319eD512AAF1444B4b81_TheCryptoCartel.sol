...
contract TheCryptoCartel is ERC721Enumerable, ERC721Burnable, Pausable, AccessControl {
    ...
    string public BASE_URI = "https://gateway.pinata.cloud/ipfs/QmZcdAb3DugXAeYPhUCAurVvbCbcK2he2B4eesPzefvwoY";
    ...
    function mintForWhitelistedMember(uint256 numberOfTokens, bytes32[] calldata proof, bytes32 merkleRoot) external payable {
    ...
    function mint(uint numberOfTokens, bytes32[] calldata proof, bytes32 merkleRoot) public payable {
        uint256 ts = totalSupply();
    ...
    //         address account,
    //         uint256 tokenId,
    //         bytes32[] calldata proof) public payable {
