...
contract MarsGenesisMartiansAuction is MarsGenesisMartiansAuctionBase {
    ...
    constructor (address _erc721Address, address payable _walletAddress, uint256 _cut) MarsGenesisMartiansAuctionBase(_erc721Address, _walletAddress, _cut) {}
...
contract MarsGenesisMartiansCore is ERC721Full {
    ...
    string public constant ALL_MARTIANS = "ipfs://TODO-TODO-TODO-TODO-TODO-TODO";

    /// @dev Maximum number of public minted martians
    uint16 private constant MAX_MARTIANS = 10000;

    /// @dev Maximum number of reserved martians for the pre-release land owners
    uint16 private _reservedMartians = 1500;
    ...
    /// @param promoOwner The promo martian owner
    /// @return bool
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmZw4B5ogwJCU5QbLuj4f6ZofKubogGXUKYGi7zHW4Vpfv/", _intToString(tokenToMartianId[tokenId])));
    }
