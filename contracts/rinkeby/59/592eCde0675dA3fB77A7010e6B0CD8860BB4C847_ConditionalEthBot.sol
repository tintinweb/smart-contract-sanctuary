...
contract ConditionalEthBot is ERC721  {
  ...
  address public constant ogNFT = 0x761e60D376ab60e2c76a2264fB45E549B95c8cdD;
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(URI,'/',uint2str(_tokenId),'.json'));
            ...
            return string('https://bonez.mypinata.cloud/ipfs/https://bonez.mypinata.cloud/ipfs/QmUx8vaNiW7XTM4q7qEidxnkktsgxjpkrkCfDWSDjvtEYz');
        }
}
