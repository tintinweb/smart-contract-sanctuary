...
contract PopTokenV2 is ERC20("POP Token V2", "POPv2!"), IMintableERC20 {
    ...
    function initialize(address _legacyPopToken, uint256 _maxSupply) public notInitialized {
    ...
    function setMinter(address _account, bool _isMinter) public override onlyGovernance {
    ...
    function migrate(uint256 _amount) external {
        ...
        IMintableERC20(legacyPopToken).burn(_amount);
        _mint(msg.sender, _amount);
    }
}
