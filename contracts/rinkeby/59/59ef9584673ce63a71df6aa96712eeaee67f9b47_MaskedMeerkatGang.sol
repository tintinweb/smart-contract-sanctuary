	...
	Ownable 
{
    ...
    uint256 public presaleTime = 1633995495; 
    uint256 public presaleEndTime = 1665590400;
    
    // time where general sale occurs
    uint256 public pledgeTime = 1665590400; 

    uint256 public price = 0.01 ether;
    uint256 public whitelistPrice = 0.01 ether;
    uint256 private reservedGiveaways = 10;
    
    // reserve presale amount for whitelist address
    uint256 private reservedPresale = 20;
    
    // dev address, will be used to withdraw first 111 meerkats which will be distributed during give away
    address dev = 0x76d84959E41953373aA5fF60cfCaBa0A12243db8;
    ...
    */
    function presaleMint(uint8 _num) external payable onlyWhitelisted {
        ...
        require(totalMint != reservedPresale + 111,
            "Sorry all presale Meerkats are sold out!"
        );
        require(
            totalMint + uint256(_num) <= reservedPresale + 111 ,
