...
contract CatsClub3D is ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint256 public constant RESERVE_ELEMENTS = 100;
    uint256 public constant PRICE = 0.025 ether;
    uint256 public constant MAX_BY_MINT = 20;

    address public constant creatorAddress = address(0); // 45%
    address public constant devAddress = 0x5D68CeBc24e32958E519E33aEF1602E8C3831aeC;  // 35%
    address public constant charityAddress = address(0);  // 20%
