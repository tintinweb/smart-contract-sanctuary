...
contract MintShop1155 is PermitControl, ReentrancyGuard {
  ...
  */
  ...
  /**
    ...
    @param _item The address of the Erc1155 item collection contract that will
  ...
  */
  constructor(address _owner, ICoof1155 _item, address _paymentReceiver,
  ...
  */
  function mintFromPool(uint256 _id, uint256 _groupId, uint256 _assetIndex,
    ...
    // Verify that any possible ERC-1155 ownership requirements are met.
      ...
      ICoof1155 requiredItem = ICoof1155(poolRequirement.requiredAsset);
