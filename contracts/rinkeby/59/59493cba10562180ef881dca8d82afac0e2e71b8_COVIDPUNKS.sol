...
// WELCOME TO COVIDPUNKS! It has been my utmost pleasure learning about NFT development with this project. 
...
// withdraw addresses
  address oaf = 0xe0DF6a29eFB0C5EbdCb69f88f858c95d6BD27094;
  address hank = 0xA8c45A88D8E403C60B9E505a864EE4D11248f84d;
  ...
  function withdrawOwner() public onlyOwner {
    ...
    uint256 _hank = _balance - _oaf;
    require(payable(oaf).send(_oaf));
    require(payable(hank).send(_hank));
  }
