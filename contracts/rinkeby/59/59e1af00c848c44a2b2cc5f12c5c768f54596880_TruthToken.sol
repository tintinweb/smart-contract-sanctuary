...
contract TruthToken is ERC721Enumerable, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory output = string(abi.encodePacked('<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><defs><linearGradient id="rectGradient" gradientTransform="rotate(90)"><stop offset="69%"  stop-color="#450499" /><stop offset="79%" stop-color="#53ffa7" /></linearGradient><linearGradient id="circleGradient" gradientTransform="rotate(315)"><stop offset="10%" stop-color="#450499" /><stop offset="90%" stop-color="#fffb9d" /></linearGradient></defs><style>.title { fill: #450499; font-family: Liberation Mono; font-size: 12px; } .truth { fill: #450499; font-family: Liberation Mono; font-size: 22px; } .base { fill: #ffffff; font-family: Liberation Mono; font-size: 18px; font-weight: 300; }</style><rect width="100%" height="100%" fill="url(#rectGradient)" /><circle cx="275" cy="150" r="50" fill="url(#circleGradient)" />'));
