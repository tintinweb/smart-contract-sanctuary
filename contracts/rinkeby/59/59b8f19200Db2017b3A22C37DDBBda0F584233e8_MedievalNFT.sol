...
contract MedievalNFT is Initializable, ERC721EnumerableUpgradeable, MedievalAccessControlled, VRFConsumerBaseUpgradable{
    ...
    function mint(address to, uint256 occupation) public onlyMinter{
        uint256 tokenId = _nounce.current();
        _nounce.increment();
        _mint(to, tokenId);
    ...
    function weight(uint256 tokenId) public view returns(uint256){
        ...
        return tokenLevel[tokenId] * 
            _gaussianTrait(tokenSeed[tokenId], 0, 1, 1, 0, 2**256-1);
    }
    ...
    function upgradeLevel(uint256 upgradeTokenId, uint256[] calldata materialTokenIds) external {
        ...
        tokenLevel[upgradeTokenId] += materialTokenIds.length;
        require(tokenLevel[upgradeTokenId] <= levelCap, "Exceed the level cap!");
    }
