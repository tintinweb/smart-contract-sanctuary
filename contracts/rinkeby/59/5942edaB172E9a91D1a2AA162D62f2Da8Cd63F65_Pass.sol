...
contract Pass is ERC721Enumerable, Ownable {
    ...
    uint256 public PASS_PUBLIC = 7777;
    ...
    function buy(uint256 tokenQuantity) external payable {
        ...
        require(totalSupply() < PASS_PUBLIC, "Out of stock.");
    ...
    function reserveGiveaway(uint256 numPass) public onlyOwner {
        ...
        require(totalSupply().add(numPass) <= PASS_PUBLIC, "Exceeds PASS_PUBLIC");
        require(saleLive == false, "Sale has already started");
        uint256 index;
