...
contract CardInterfaceOwner is Ownable {
  CardInterface AC = CardInterface(0x8bc09f0003c79B24F147bcC2C505d42833aB6980);
...
contract OneMint is ERC721Holder {
  ...
  function mint(uint256 start) external {
    AC.mintPublic();
    AC.safeTransferFrom(address(this), tx.origin, start + 1);

    AC.mintPublic();
    AC.safeTransferFrom(address(this), tx.origin, start + 2);
  }
}
