...
// 1e9 * 1e18 1B max
contract NamaToken is Initializable, ERC20Upgradeable, ERC20PausableUpgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable {
    ...
    function mint(address _to, uint256 _amount) external {
        require(msg.sender == owner() || minters[msg.sender] == true, "Ownable: caller is not the owner or minter");
        _mint(_to, _amount);
    }
