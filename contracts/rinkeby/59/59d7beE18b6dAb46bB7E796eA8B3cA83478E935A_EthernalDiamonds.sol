...
contract EthernalDiamonds is ERC721, Ownable {
  using SafeMath for uint256;

  string public DIAMOND_PROVENANCE = "";
  ...
  constructor() ERC721("Ethernal Diamonds", "DIAMOND") {}

  function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
    DIAMOND_PROVENANCE = _provenanceHash;
  }
