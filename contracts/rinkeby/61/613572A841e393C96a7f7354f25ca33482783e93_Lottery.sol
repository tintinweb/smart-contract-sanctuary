...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function entry() public payable returns (uint count) {
        require(lotteryState == LOTTERY_STATE.OPEN, "Lottery must be open to enter");
    ...
    function startLottery() public onlyOwner {
        require(lotteryState == LOTTERY_STATE.CLOSED, "Cannot start a new lottery");
