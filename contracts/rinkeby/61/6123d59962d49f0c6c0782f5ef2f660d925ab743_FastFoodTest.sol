...
contract  FastFoodTest  is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory baseURI) ERC721("FastFoodTest", "PFF") {
        setBaseURI(baseURI);

        _shareholders[0] = 0xa9DE4Bc2017f5c058DaBAca64b0F70620e4DC89a; // kuip
        _shareholders[1] = 0x38F97aA08bfF98162a4311Cca5bdD9Aa74B86264; // derv
    ...
    function mint(uint chosenAmount) public payable isSaleOpen{
        ...
        else
        {
            ...
            require(msg.value==200,"First 10 tokens are free");
            _safeMint(msg.sender,totalSupply());
