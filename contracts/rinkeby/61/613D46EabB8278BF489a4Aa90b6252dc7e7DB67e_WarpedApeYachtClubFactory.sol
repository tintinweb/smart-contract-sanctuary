...
contract WarpedApeYachtClubFactory is IFactoryERC1155, AuthorizedList, ReentrancyGuard {
    ...
    function _createOrMint(
        ...
        WarpedApeYachtClub tradable = WarpedApeYachtClub(_erc1155Address);
        // Lazily create the token
        if (!tradable.exists(_id)) {
            tradable.create(_to, _id, _amount, SUPPLY_PER_NFT, "", _data);
        } else {
...
//            WarpedApeYachtClub WAYC = WarpedApeYachtClub(lootBoxAddress);
