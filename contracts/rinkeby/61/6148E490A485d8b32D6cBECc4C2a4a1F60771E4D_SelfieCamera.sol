...
contract SelfieCamera is ERC721Enumerable, Ownable {
    ...
    string public cameraScript;
    mapping(uint => string) names;
    mapping(uint => string) fileExt;
    ...
    function setBaseImageURI(string memory baseURI) public onlyOwner {
        _baseImageURI = baseURI;
    }

    function setCameraScript(string memory script) public onlyOwner {
        cameraScript = script;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked(
            ...
            '"image":"',
                string(abi.encodePacked(_baseImageURI, tokenId.toString(), fileExt[tokenId])),
            '", "attributes":[',
    ...
    function takePhoto(string memory name, string memory ext) public onlyOwner {
