 ...
 */
contract Vindergood is AssetContract, ReentrancyGuard {
    // Migration contract address
    Vindergood public migrationTarget;
    ...
    modifier creatorOnly(uint256 _id) {
        require(
            ...
            "Vindergood#creatorOnly: ONLY_CREATOR_ALLOWED"
        );
        _;
    }
    ...
    modifier onlyFullTokenOwner(uint256 _id) {
        require(
            ...
            "Vindergood#onlyFullTokenOwner: ONLY_FULL_TOKEN_OWNER_ALLOWED"
        );
        _;
    }
    ...
    constructor(
        ...
        migrationTarget = Vindergood(_migrationAddress);
    }
    ...
    function disableMigrate() public onlyOwnerOrProxy {
        migrationTarget = Vindergood(address(0));
    }
    ...
    function migrate(Ownership[] memory _ownerships) public onlyOwnerOrProxy {
        Vindergood _migrationTarget = migrationTarget;
        require(
            _migrationTarget != Vindergood(address(0)),
            "Vindergood#migrate: MIGRATE_DISABLED"
        );
        ...
        for (uint256 i = 0; i < _ownerships.length; ++i) {
            ...
            require(
                owner != address(0),
                "Vindergood#migrate: ZERO_ADDRESS_NOT_ALLOWED"
            );
    ...
    function batchMint(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            require(
                ...
                "Vindergood#_batchMint: ONLY_CREATOR_ALLOWED"
            );
        }
        _batchMint(_to, _ids, _quantities, _data);
    }
    ...
    function setCreator(uint256 _id, address _to) public creatorOnly(_id) {
        require(_to != address(0), "Vindergood#setCreator: INVALID_ADDRESS.");
    ...
    function _requireMintable(address _address, uint256 _id) internal view {
        require(
            ...
            "Vindergood#_requireMintable: ONLY_CREATOR_ALLOWED"
        );
    }
