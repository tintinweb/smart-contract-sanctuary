...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/Qmc4sLLzDbXT96RJLHmurqcdg5ot1tiWeE69iJd2Eq7wJv";
...
contract Creature is ERC721Tradable {
	...
	ERC721Tradable("CEC_test_surprise", "EGS", _proxyRegistryAddress)
    {}
...
contract CreatureLootBox is ERC721Tradable {
    uint256 NUM_CREATURES_PER_BOX = 2;
    uint256 OPTION_ID = 1;
    address factoryAddress;

    constructor(address _proxyRegistryAddress, address _factoryAddress)
        ERC721Tradable("CEC_test_cryptoegg", "EGS", _proxyRegistryAddress)
    {
...
function unpack(uint256 _tokenId) public {
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmcbCJPzQ1ab7yic1eVTtyBm8rZC2P886vj9kiie24XXvk";
    }
