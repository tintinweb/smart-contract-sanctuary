...
// File: contracts/Viejos/ERC20.sol
...
contract xVORTEX_ is Context, AccessControl, ERC20, ERC20Pausable {
     ...
     *
     */
    constructor(string memory name, string memory symbol, address account, uint256 initialSupply) public ERC20(name, symbol) {
