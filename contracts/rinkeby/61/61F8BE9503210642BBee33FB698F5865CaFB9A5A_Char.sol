...
contract Char is ERC721, VRFConsumerBase, Ownable {
    ...
    constructor(address _VRFCoordinator, address _LinkToken, bytes32 _keyhash) public VRFConsumerBase(_VRFCoordinator, _LinkToken) ERC721("Char", "CHAR") {
        vrfCoordinator = _VRFCoordinator;
    ...
    function mintCharNft (string memory name) public returns (bytes32) {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        uint256 newId = chars.length;
        uint256 statA = (randomNumber % 100);
        uint256 statB = (randomNumber % 10000) / 100;
        uint256 statC = (randomNumber % 1000000) / 10000;
        uint256 statD = (randomNumber % 100000000) / 1000000;
        uint256 statE = (randomNumber % 10000000000) / 1000000;
