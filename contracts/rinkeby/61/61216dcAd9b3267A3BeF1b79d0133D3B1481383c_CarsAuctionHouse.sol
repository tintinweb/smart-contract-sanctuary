...
contract CarsAuctionHouse is ICarsAuctionHouse, Pausable, ReentrancyGuard, Ownable {
    ...
    // mapping from carId to list of bids
    mapping(uint256 => Bid[]) private carIdBids;
    ...
    function getBidsForId(uint256 _carId) public view returns (Bid[] memory) {
        return carIdBids[_carId];
    }
}
