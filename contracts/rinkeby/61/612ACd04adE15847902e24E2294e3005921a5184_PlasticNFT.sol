...
constructor () public ERC721 ("Plastic","PLA") {
    uint256 newItemId;
    string memory tokenURI = "data:application/json;utf8,{\"image\":\"data:image/svg+xml,<svg height='30' width='200'> <text x='0' y='35' fill='lime'>N3R1</text></svg>\"}";
