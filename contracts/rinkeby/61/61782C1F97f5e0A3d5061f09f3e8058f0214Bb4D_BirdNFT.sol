...
contract BirdNFT is ERC721Enumerable, Ownable {
    ...
    uint256 private _price = 0.000000001 ether; // 1 GWEI
    bool public _paused = true;

    address t1 = 0xf58b2948909Cf93CeC8962C31121ace8e444636C;
    address t2 = 0xf58b2948909Cf93CeC8962C31121ace8e444636C;

    constructor(string memory baseURI) ERC721("Odd Birds", "ODD")  {
        setBaseURI(baseURI);
    }

    function mintNFT(uint256 num) public payable {
        // Assigning totalSupply to uint256 save gas since you check for require later
        ...
        require( supply + num < 50 - _reserved,      "Exceeds maximum NFT supply" );
