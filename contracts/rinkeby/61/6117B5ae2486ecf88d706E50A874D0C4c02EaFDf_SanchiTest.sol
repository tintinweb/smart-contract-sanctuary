...
contract SanchiTest is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress, uint256 mvpMintStart, uint256 giveAwayIndex) ERC721Tradable("Contract", "TOZ", _proxyRegistryAddress) {
    ...
    function withdraw_invest(address payable to) external {
