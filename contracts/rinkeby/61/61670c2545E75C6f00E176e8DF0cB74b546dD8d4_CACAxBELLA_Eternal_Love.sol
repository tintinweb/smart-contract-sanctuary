...
contract CACAxBELLA_Eternal_Love is ERC1155Tradable {
	constructor() public ERC1155Tradable("CACAxBELLA_Eternal_Love", "CBEL") {
  ...
  function setMaxSupply(uint256 _id, uint256 _newMaxSupply) public onlyWhitelistAdmin {
    require(_exists(_id), "CACAxBELLA_Eternal_Love#setMaxSupply: NONEXISTENT_TOKEN");
    require(_newMaxSupply >= tokenSupply[_id], "CACAxBELLA_Eternal_Love#setMaxSupply: Max supply cannot be less than token supply");
