...
// File contracts/StonerApeClub.sol
...
contract StonerApeClub is ERC721, ERC721Enumerable, Ownable {
    ...
    uint public maxTokenPurchaseVIP = 25;
    ...
    address private founder1 = 0x25eDb46cBB7744De5507ebe50b5086D236B63073;
    address private founder2 = 0x827dfa08e6282961b6491851869001cB444b840F;
    address private founder3 = 0xDf958FE148633B49930775c1E0393594983a128B;
    address private founder4 = 0x458f5AA4393035f4713bE4EB7176B89f8dD4A6F1;
    address private founder5 = 0x5f09Bd6Ef7EBDB9CC7d090DC43f9047a2b7A2240;
    address private founder6 = 0x0308539095797e6F562203C3d8F60Cae82566eBA;
    address private devAddress = 0x5e62Fb9dbA3f654E2A7fc112c172da59b0BB93c2;

    event AddWhiteListWallet(address[] _wallets );
    event AddWhiteListWalletVIP(address[] _wallets);
...
function occupiedList() public view returns (uint256[] memory) {
	...
	function addWhiteListWallet (address[] memory _wallets) public {
		require(_msgSender() == owner() || _msgSender() == devAddress, "Owner could call addWhiteListWallet function!");
    	...
    	function addWhiteListWalletVIP (address[] memory _wallets) public {
		require(_msgSender() == owner() || _msgSender() == devAddress, "Owner could call addWhiteListWalletVIP function!");
		for(uint i = 0; i < _wallets.length; i++) {
			_isWhiteListed[_wallets[i]] = true;
		}
        
        emit AddWhiteListWalletVIP(_wallets);(_wallets);
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(founder1).transfer(balance.div(100).mul(23));
		payable(founder2).transfer(balance.div(100).mul(23));
        payable(founder3).transfer(balance.div(100).mul(23));
        payable(founder4).transfer(balance.div(100).mul(19));
        payable(founder5).transfer(balance.div(100).mul(7));
        payable(founder6).transfer(balance.div(100).mul(5));
    }
}