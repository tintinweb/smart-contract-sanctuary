...
contract FastFoodDoges is ERC721Namable, Ownable {
    ...
    address public constant pleasrDaoWallet = 0xCb20a54C4Ed357bF7E28D1966e3F0f5215e25B37;
    address public constant fffWallet = 0x2b35ACE6069c68483b4e48cAD85BACE790789A92;
    ...
    ERC20Burnable private nameChangeToken;
    bool public nameChangeOpen = false;
    bool public breedingOpen = false;
    uint256 public babyDogeCount = 0;

    bytes32 whiteListRoot = 0x22e5deb0c62b72ff5c43b17ed1b37bd28548fa707386e4a2184dbd8039f29959;
    ...
    constructor() ERC721Namable("FastFoodDoge", "FFD") {
        setBaseURI("https://fast-food-doge.herokuapp.com/fastfooddoge/");
    }
    ...
    function validSale(uint256 _count) private {
        uint256 total = _totalSupply();
        require(total + _count <= MAX_BASE_ELEMENTS, "Max limit");
        require(total <= MAX_BASE_ELEMENTS, "Sale end");
    ...
    function mintFromWhiteList(bytes32[] calldata _merkleProof, uint256 _count) public payable {
        require(whiteListOpen, "WhiteList Sale not open");
        require(!whiteListClaimed[msg.sender], "Address has already minted from white list");
    ...
    function breed(uint256 ogDoge) external {
        ...
        require(ownerOf(ogDoge) == msg.sender);
        require(ogDoge < MAX_BASE_ELEMENTS, "Not an OG Doge");
        require(_totalSupply() < MAX_ELEMENTS, "Exceeds maximum number of items in collection");
        require(lastBreed[ogDoge] + breedCoolDown < block.timestamp);
        lastBreed[ogDoge] = block.timestamp;

        nameChangeToken.burnFrom(msg.sender, breedPrice);
        _mintAnElement(msg.sender);
    }
	...
	function setToken(address _nameChangeToken) external onlyOwner {
		nameChangeToken = ERC20Burnable(_nameChangeToken);
	}
	...
	function changeName(uint256 tokenId, string memory newName) public override {
		...
		nameChangeToken.burnFrom(msg.sender, nameChangePrice);
	...
	function changeBio(uint256 tokenId, string memory _bio) public override {
		...
		nameChangeToken.burnFrom(msg.sender, bioChangePrice);
