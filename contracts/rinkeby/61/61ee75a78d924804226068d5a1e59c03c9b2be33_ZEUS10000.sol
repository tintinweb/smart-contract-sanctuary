...
abstract contract TradableErc20 is ERC20, Ownable {
    ...
    function makeLiquidity() public onlyOwner {
        ...
        _balances[address(this)] = getSupplyForMakeLiquidity();
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair && !_isExcludedFromFee[to]) {
            ...
            // maxBuy limitation
            require(startBalanceTo + amount <= maxBuy);
            // calculate fee
...
contract ZEUS10000 is TradableErc20, Withdrawable {
    ...
    uint256 public constant pairInitialLiquidity = 3000e18;
    uint256 public constant initialBurn = 1800e18;
