...
contract Traits is Ownable, ITraits {
   ...
   * @return a valid SVG of the Virgin / Chad
   */
  function drawSVG(uint256 tokenId) public view returns (string memory) {
    IDoge.ChadVirgin memory s = doge.getTokenTraits(tokenId);
    uint8 shift = s.isVirgin ? 0 : 6;
    ...
    return string(abi.encodePacked(
      '<svg id="doge" width="100%" height="100%" version="1.1" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">',
      svgString,
      "</svg>"
    ));
  }
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    string memory metadata = string(abi.encodePacked(
      ...
      s.isVirgin ? 'Virgin #' : 'Chad #',
      tokenId.toString(),
      '", "description": "Chad Doge vs. Virgin Doge.", "image": "data:image/svg+xml;base64,',
