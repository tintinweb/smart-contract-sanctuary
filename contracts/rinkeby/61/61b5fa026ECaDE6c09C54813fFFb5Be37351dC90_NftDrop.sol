...
contract NftDrop {
    ...
    function generateRawAddressHash(address address1)
        public
        pure
        returns (bytes32)
    {
    ...
    function verifiableAddressHash(address address1)
        public
        pure
        returns (bytes32)
    {
        return
            keccak256(
                abi.encodePacked(
                    ...
                    generateRawAddressHash(address1)
                )
            );
    }
    ...
    function getSigner(
        ...
        return ecrecover(verifiableAddressHash(address1), v, r, s);
    }
    ...
    function isDropRecipient(
        ...
        address signedBy = ecrecover(verifiableAddressHash(address1), v, r, s);
