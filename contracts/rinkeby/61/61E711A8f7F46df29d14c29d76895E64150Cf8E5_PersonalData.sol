...
contract PersonalData is Ownable {
    ...
    function updateServiceName(address _dataTypesAddress) public {
        dataTypesAddress = _dataTypesAddress;
    }

    function updateDataTypes() public{
        dataTypes = DataTypesInterface(dataTypesAddress);
    }

    /*function retrieve() public view returns (uint256) {
        DataTypesInterface dataTypes = DataTypesInterface(dataTypesAddress);
        return dataTypes.retrieve();
    }*/
