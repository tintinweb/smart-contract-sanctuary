...
contract Space is ERC721Enumerable, Ownable {
    ...
    string constant public preRevealImageUrl = 'ipfs://Qma1CQepRezX6kAuw3YDdCx23qNUQdaDbXccQfgLRdp8iG';

    string public revealedCollectionBaseURL;

    uint256 constant public MAX_SPACE_SUPPLY = 5;

    uint256 constant public HIGHER_TOKEN_COUNT = 1;

    uint256 constant public MEDIUM_TOKEN_COUNT = 3;

    string[] public boardFactorStr = ["1.05", "1.1", "1.15"];

    uint256[] public boardFactorNumber = [1050000000000000000, 1100000000000000000, 1150000000000000000];
    ...
    mapping(uint256 => uint256) private tokenBoardFactorIndex;
    ...
    constructor() ERC721('GOF Space', "Space") {
    ...
    function setBoardFactor(uint256 tokenId) private {
        ...
        tokenBoardFactorIndex[tokenId] = index;
    }

    function getBoardFactor(uint256 tokenId) public view returns (uint256){
        return boardFactorNumber[tokenBoardFactorIndex[tokenId]];
    }

    function getBoardFactorStr(uint256 tokenId) private view returns (string memory){
        return boardFactorStr[tokenBoardFactorIndex[tokenId]];
    }
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        if (keccak256(abi.encodePacked(revealedCollectionBaseURL)) == keccak256(abi.encodePacked(''))) {
            ...
            content = abi.encodePacked(content,
                ...
                ', ',
                '"attributes": [{"trait_type": "Background", "value": "',getBoardFactorStr(_tokenId),'"}]',
                ', ',
