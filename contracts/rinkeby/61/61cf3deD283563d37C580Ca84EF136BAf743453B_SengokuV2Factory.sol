...
contract SengokuV2Router is IUniswapV2Router02 {
...
contract SengokuV2Factory is IUniswapV2Factory {
...
import "../uniswapv2/SengokuV2Factory.sol";

contract SushiSwapFactoryMock is SengokuV2Factory {
    constructor(address _feeToSetter) public SengokuV2Factory(_feeToSetter) {}
}
