...
contract Experimental is IERC721, Ownable, Functional {
     ...
     */
    constructor() {
        _name = "Experimental Projects";
        _symbol = "XPX";
        _baseURI = "https://triple7dice.club/gamedata/experimental/"; //make sure to include final /
        
        totalTokens = 1000; // 2000, 4000, 6000, 8000, ..
        price = 100 * (10 ** 15); // Replace leading value with price in finney
        maxPerWallet = 100;
        reservedTokens = 15; // uncomment to reserve tokens for the owner or other purposes
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == Experimental.onERC721Received.selector;
    }
    ...
    function ownerMint(address _to, uint256 qty) external onlyOwner {
        ...
        uint256 mintSeedValue = _seedTracker; //Store the starting value of the mint batch
        numberMinted += qty;
        _seedTracker += qty;
    ...
    function airDrop(address[] memory _to) external onlyOwner {
        ...
        uint256 mintSeedValue = _seedTracker;
        numberMinted += qty;
        _seedTracker += qty;
    ...
    function mint(address _to, uint256 qty) external payable reentryLock {
    ...
    //////////////////// Setters and Getters /////////////////////
    //////////////////////////////////////////////////////////////
    function newBatch(uint256 startValue, uint256 endValue) external onlyOwner {
        _seedTracker = startValue; //json start number for the new collection.
        totalTokens = endValue; //add on to the existing collection.
    }
