...
contract WithWhitelist is ERC1155Supply, Ownable, Pausable {
    ...
    mapping (address => bool) public hasAddressMintedPlatinumWhitelistFree;
     ...
     */
    function mintPlatinumWhitelistFree(bytes32 messageHash, bytes calldata signature) external payable {
        require(saleIsActivePlatinumWhitelist, "SALE_NOT_ACTIVE");
        require(!collectionMinted[TOKEN_ID_PLATINUM], "PLATINUM_TOKEN_LOCKED");
        require(totalSupply(TOKEN_ID_PLATINUM) < MAX_TOKENS_PLATINUM_PUBLIC, "MAX_TOKEN_SUPPLY_REACHED");
        require(hasAddressMintedPlatinumWhitelistFree[msg.sender] == false, "ADDRESS_HAS_ALREADY_MINTED_PLATINUM_WHITELIST");
        ...
        hasAddressMintedPlatinumWhitelistFree[msg.sender] = true;
