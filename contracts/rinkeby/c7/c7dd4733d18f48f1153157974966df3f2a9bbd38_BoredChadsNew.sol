...
contract BoredChadsNew is ERC721, Ownable {
  ...
  IERC20 private tokenKONGZ = IERC20(0x44fE11dD7450b596e994E62a4a80ef0024025199); // KONGZ mainnet mainnet
  IERC20 private tokenMAYC = IERC20(0xf63476B447aB6610429d3C9d4d0f447716A316c8); // Mutant Ape Mainnet
  IERC20 private tokenHabibz = IERC20(0xf63476B447aB6610429d3C9d4d0f447716A316c8); // Habibz Mainnet, update all contract addrs
  ...
  function _mintForOG(uint256 _mintQuantity) internal {
    ...
    require(msg.value >= (cost/2) * _mintQuantity, "Insufficient funds sent!");
    _mintChads(msg.sender, _mintQuantity);
  }
