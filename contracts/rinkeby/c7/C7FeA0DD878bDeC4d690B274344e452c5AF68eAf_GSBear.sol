...
// File contracts/GangStarBear.sol
...
contract GSBear is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(address payable fundsTo_, uint256 maxSupply_, uint256 maxPerTx_, uint256 pricePer_) ERC721("GSBear", "GSBear") {
        fundsTo = fundsTo_;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://njcustomdirect.com/pages/nft/bears/";
    }
