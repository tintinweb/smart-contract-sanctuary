...
contract LetterFinalNFT is ERC721Enumerable, Ownable { // contract name to yours
  ...
  uint256 public maxSupply = 2; // max supply, contract will stop minting after this amount is reach in your open sea colection
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        if(whitelisted[msg.sender] != true) {
          require(msg.value >= cost * _mintAmount, "Unknown shit.");
        }
    }
  ...
  function returnBaseURI() view public returns (string memory) {

    return revealed ? baseURI : notRevealedURI;
  }
