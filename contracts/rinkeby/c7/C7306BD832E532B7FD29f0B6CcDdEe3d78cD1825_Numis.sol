...
contract Numis is ERC721TradableNumis {
    ...
    uint256 constant private PRICE = 197800000000000000;    // 0.1978 ETH
    uint32  constant private PRESALE_TIME = 86400;         // 24 hours
    uint8   constant private MAX_QUANTITY = 5;            // Maximum allowed quantity to purchase
    uint8   constant public  COMMUNITY_QUOTA = 10;       // 10% of the sale proceeds stays in the community
    address constant public  COMMUNITY_WALLET = 0x229ddBd9A20e3Df3ab7f540Ec77bEB258476fEe5;


    function baseTokenURI() override public pure returns (string memory) {
        return "https://mint.numisnft.com/item?token_id=";
    }

    function contractURI() public pure returns (string memory) {
        return "https://mint.numisnft.com/collection";
    }
