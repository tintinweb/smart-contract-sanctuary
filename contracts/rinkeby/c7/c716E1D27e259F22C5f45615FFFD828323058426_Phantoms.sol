...
contract Phantoms is Ownable, ERC721Enumerable, ContinuousDutchAuction {
    ...
    bytes32 private _merkleRoot = 0xb18200816e904c24b42664c58302faf011d067b05946cca1a7c429b2dc25964c;
    ...
    function setAuction(
        ...
        super.setAuction(auctionId, startingPrice_, decreasingConstant_, startingBlock_, period_);
    }
    ...
    function merkleClaim(bytes32[] calldata proof) public payable {
        ...
        require(msg.value == 0.04 ether, "wrong msg.value");
        payout(msg.value);
