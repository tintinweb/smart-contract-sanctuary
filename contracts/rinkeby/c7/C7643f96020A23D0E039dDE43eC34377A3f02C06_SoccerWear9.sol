...
contract SoccerWear9 is ERC721Enumerable, ReentrancyGuard, Ownable {
    string[14] private _empty;
    string[] private _goalkeepers = [
        unicode"Bartłomiej Drągowski"
    ];
    string[] private _rightBacks = ["rfb 1", "rfb 2", "rfb 3", "rfb 4", "rfb 5", "rfb 6", "rfb 7", "rfb 8"];
    string[] private _leftBacks = ["lfb 1", "lfb 2", "lfb 3", "lfb 4", "lfb 5", "lfb 6", "lfb 7", "lfb 8"];
    string[] private _centerBacks = ["cb 1", "cb 2", "cb 3", "cb 4", "cb 5", "cb 6", "cb 7", "cb 8"];
    string[] private _centerBacks2 = ["cb 1", "cb 2", "cb 3", "cb 4", "cb 5", "cb 6", "cb 7", "cb 8"];
    string[] private _leftMidfielders = ["dmf 1", "dmf 2", "dmf 3", "dmf 4", "dmf 5", "dmf 6", "dmf 7", "dmf 8"];
    ...
    string[] private _leftWingers = ["s 1", "s 2", "s 3", "s 4", "s 5", "s 6", "s 7", "s 8"];
    string[] private _rightWingers = ["str 1", "str 2", "str 3", "str 4", "str 5", "str 6", "str 7", "str 8"];
    ...
    constructor() ERC721("SoccerWear9", "SOCWEAR9") Ownable() {}
}
