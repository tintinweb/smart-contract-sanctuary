...
/**
 * @title POTUS
 * President - a contract for a non-fungible president
 */
contract POTUS is ERC721Tradable {
    string private _baseTokenUri = "https://www.POTUSnft.io/api/token/";
    string private _contractUri = "https://www.POTUSnft.io/api/contract/";
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("POTUSnft", "POTUS", _proxyRegistryAddress)
    {}
