...
contract ConvexCompoundGauge {
    ...
    event LendingAmount(uint256 lendingAmount, uint256 collateralAmount, uint256 interestValue);
    ...
    function _borrow(
        ...
        emit LendingAmount(lendingAmount, collateralAmount, interestValue);
        ...
        )
    {
        ...
        uint256 lendingAmount = (_token0Price *
            ...
            (1e18 + utilizationRate * _borrowBlocks) /
            1000;
        ...
        uint256 collateralAmount = lendingAmount
            .mul(uint256(1e18).add(compoundRatePerBlock))
            .div(80)
            .div(1000)
            .div(collateralFactorMantissa);
        uint256 interestValue = getBorrowInterestRate(
            utilizationRate,
            _compoundPid
        );
        ...
        return (
            lendingAmount,
            collateralAmount,
            interestValue.mul(_borrowBlocks)
        );
    }
