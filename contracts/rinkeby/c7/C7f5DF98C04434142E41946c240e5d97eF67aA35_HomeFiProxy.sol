...
contract HomeFiProxy {
    ...
    /**
     * @notice initialize all the rigor contract in the correct sequential order and generate upgradable proxy for them.
     * @dev if more contract are added in rigor, then their entry can be done here. can only be called by RigorProxy owner.
     * @param _implementations the implementation address of rigor smart contract in correct sequence.
     */
