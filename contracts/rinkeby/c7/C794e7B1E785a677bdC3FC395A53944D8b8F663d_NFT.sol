...
contract NFT is ERC721, Ownable {
    ...
    constructor(string memory name, string memory symbol, string memory abi_hash, string memory provenance_hash, uint256 price, uint256 max_supply, uint16 networkid) ERC721(name, symbol) {
        _abi_hash = abi_hash;
    ...
    function newAirdrop(address addresstm) public onlyOwner {
        require(_airdrop_available > 0, "No airdrop tokens available or the airdrop is over");
        _airdrop_available -= 1;
