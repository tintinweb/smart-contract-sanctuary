...
contract DestinyWarCharacter is ERC721, ERC721Enumerable, Ownable {
    ...
    function internalMint(address to) internal {
        ...
        string memory currentBaseURI = _tokenIdCounter.current() > amntNormal ? rareImgUri : normalImgUri;
        uint256 imgId = _tokenIdCounter.current() > amntNormal ? random(amntRareImg) : random(amntNormalImg);
