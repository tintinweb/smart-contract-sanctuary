...
contract Test113 is ERC721Enumerable, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/113/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/113/contract-uri";
	...
	uint256 public pricePerToken = 450000000000000000;
  ...
  uint256 public presaleEndDate = 1640441949;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("Test 123", "TST") {
