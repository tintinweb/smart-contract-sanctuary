...
// File: contracts/Pool/PremiaPool.sol
...
/**
 * @author 0mllwntrmt3
 * @title Premia Protocol V8888 Main Pool Contract
 ...
 * unlocks the expired options and distributes the premiums among the liquidity providers.
 **/
abstract contract PremiaPool is
    IPremiaPool,
    ERC721,
    AccessControl,
    ReentrancyGuard
{
    ...
    IPremiaStaking public settlementFeeRecipient;
    ...
    constructor(
        ...
        IPremiaStaking _settlementFeeRecipient,
    ...
    {
        return
            interfaceId == type(IPremiaPool).interfaceId ||
    ...
    function _calculateTotalPremium(
        ...
        require(
            ...
            "PremiaPool: The option's price is too low"
        );
    }
     ...
     **/
    function setSettlementFeeRecipient(IPremiaStaking recipient)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
...
// File: contracts/Pool/PremiaPut.sol
...
/**
 * @author 0mllwntrmt3
 * @title Premia Protocol V8888 Put Liquidity Pool Contract
 * @notice The Put Liquidity Pool Contract
 **/

contract PremiaPUT is PremiaPool {
