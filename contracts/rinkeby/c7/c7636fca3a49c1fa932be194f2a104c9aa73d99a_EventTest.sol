...
contract EventTest {
    ...
    event AnonymousEvent(address indexed _addr1, uint256 indexed _num1, uint256 indexed _num2, uint256 _data1, uint256 _data2) anonymous;
    ...
    function anonymousEvent() external returns (bool) {
        emit AnonymousEvent(msg.sender, 1, 2, 3, 4);
    }
}