...
contract TestDonations is Ownable {
    ...
    function getDonaterDonataions(address _donater) public view returns(uint[] memory) {
        return _donations[_donater];
    }

    function withdraw(address payable toAddress) public onlyOwner {
