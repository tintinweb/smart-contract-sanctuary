...
contract HippoStreetTEST2 is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    string public baseExtension = "";
    // CHANGE BEFORE DEPLOY TO ETH MAINNET
    ...
    // CHANGE BEFORE DEPLOY TO ETH MAINNET
    // toti
    address t1 = 0xd70C752Cb4f015485D96e5632641a94428f7628F;
    // toto
    address t2 = 0x5377171aaA0352Aa186794CA9856CFAE13F88b39;
    

    // CHANGE BEFORE DEPLOY TO ETH MAINNET
    constructor(string memory baseURI) ERC721("HippoStreetTEST2", "HSNFT2")  {
        setBaseURI(baseURI);
    ...
    function mint(uint256 num) public payable {
        ...
        require( num < 11,                            "You can mint a maximum of 20" );
