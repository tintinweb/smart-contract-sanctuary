...
contract TheDoodles is ERC721, ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    uint256 public constant maxSupply = 999; //only 999
    uint256 private _price = 0; //wei
    
    uint256 private _addressMaxMint = 5;
    mapping(address => uint256) private _addressClaimed;

    bool private _saleStarted;
    string public baseURI;

    constructor() ERC721("The Doodles", "DOOD") {
        _saleStarted = false;
    }
