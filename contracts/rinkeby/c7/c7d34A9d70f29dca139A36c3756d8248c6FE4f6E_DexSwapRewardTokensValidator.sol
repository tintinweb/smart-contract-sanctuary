...
contract DexSwapRewardTokensValidator is IRewardTokensValidator, Ownable {
    ...
    constructor(address _dexTokenRegistryAddress, uint256 _dexTokenRegistryListId)
    {
        require(
            ...
            "DexSwapRewardTokensValidator: 0-address token registry address"
        );
        require(
            _dexTokenRegistryListId > 0,
            "DexSwapRewardTokensValidator: invalid token list id"
        );
        ...
        override
    {
        require(
            ...
            "DexSwapRewardTokensValidator: 0-length reward tokens array"
        );
        for (uint256 _i = 0; _i < _rewardTokens.length; _i++) {
            address _rewardToken = _rewardTokens[_i];
            require(
                _rewardToken != address(0),
                "DexSwapRewardTokensValidator: 0-address reward token"
            );
            require(
                ...
                "DexSwapRewardTokensValidator: invalid reward token"
            );
        }
    }
}
