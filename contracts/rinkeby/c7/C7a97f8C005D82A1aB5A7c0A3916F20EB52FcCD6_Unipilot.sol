...
contract Unipilot is IUnipilot, ERC721Permit, PeripheryPayments {
    ...
    function deposit(
        ...
        pay(params.token0, params.sender, params.exchangeAddress, params.amount0Desired);
        pay(params.token1, params.sender, params.exchangeAddress, params.amount1Desired);
