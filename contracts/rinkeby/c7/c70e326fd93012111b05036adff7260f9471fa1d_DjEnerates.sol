...
contract DjEnerates is ERC721 {
    ...
    uint256 private startClaimDate = 1627250400; //1629817200
    uint256 private claimPrice = 88800000000000000; // 0.08 ETH
    ...
    string private baseURI =
        "https://ipfs.io/ipfs/QmboV2JsVbbCp9grvdHbaCiSmM98NVfkRxpRPNuTmzpnRF/";
        ...
        onlyCollaborator
    {
     ...
     /**
     * Set 100 random DJEN aside for rewards and wages
     */
    function reserveDjens() public onlyOwner {        
        require(availableTokens.length >= 100, "No tokens left to reserve");
        require(hasReserved,"100 DJen have been already reserved, you can not reserve more");
        uint256[] memory tokenIds = new uint256[](100);

        claimedTokensPerWallet[msg.sender] += 10;
        totalMintedTokens += 10;
