...
contract Batch is IERC721Receiver, AccessControl {
    ...
    */
    ...
    function _removeNFTFromCollection(
        ...
        //uint256 index = allNFTs[_nftsIndex];
        // // nftsByCollectionId -> mapping of nfts id to collection id
        // uint256 lastNFTId = nftsByCollectionId[collectionId_].length - 1;
        // // setting the nft as the last element in the nftsByCollectionId mapping
        // nft = lastNFTId;
        // // // removing the last element of nftsByCollectionId mapping
        // // nftsByCollectionId[collectionId_].pop();
        // // allNFTs[lastNFTId].indexInCollection = index;

        // allNFTs[_nftsIndex] = allNFTs[allNFTs.length - 1];
        // allNFTs.pop();
    }

    function removeNFTFromCollection(address tokenAddress_, uint256 nftId_, uint256 collectionId_) external {
        address nftOwner = allNFTs[nftId_].owner;
        _removeNFTFromCollection(tokenAddress_, nftId_, collectionId_);
        _withdrawNFT(nftOwner, nftId_);
    }
