...
contract Storage {
    ...
    function TestMul(uint256 p) public returns(uint256 qx, uint256 qy) {
    ...
    function Verify(uint256 t_rx, uint256 t_ry, uint256 t_omega, bytes32 t_GroupName) public view returns(uint8){
        uint256 sum_rx = t_rx;
        uint256 sum_ry = t_ry;
        uint256 sum_omega = t_omega;
        uint256 px;
        uint256 py;
        uint256 qx;
        uint256 qy;
