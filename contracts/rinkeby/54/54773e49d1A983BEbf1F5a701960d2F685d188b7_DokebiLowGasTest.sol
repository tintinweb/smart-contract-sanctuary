...
// File: contracts/DokebiLowGasTest.sol
...
contract DokebiLowGasTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("DokebiLowGasTest", "DKB") {
    setHiddenMetadataUri("ipfs://QmVJrsQEoFpdNv4gbiJq4AVSG11EZpzvCsjUJ2J1D2VMhq/hidden.json");
  }
