...
import "PlanetLootBox.sol";

contract PlanetFactory is FactoryERC721, Ownable {
    ...
    constructor(address _proxyRegistryAddress, address _nftAddress) {
        ...
        lootBoxNftAddress = address(
            new PlanetLootBox(_proxyRegistryAddress, address(this))
        );
    ...
    function mint(uint256 _optionId, address _toAddress) public override {
        ...
        PlanetNFT openSeaCreature = PlanetNFT(nftAddress);
        if (_optionId == SINGLE_CREATURE_OPTION) {
            ...
            PlanetLootBox openSeaCreatureLootBox = PlanetLootBox(
                lootBoxNftAddress
            );
    ...
    {
        PlanetNFT openSeaCreature = PlanetNFT(nftAddress);
        return openSeaCreature.tokenURI(_optionId);
