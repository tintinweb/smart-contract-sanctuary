...
contract Staking is IStaking, Ownable {
    ...
    function stake(uint256 _amount) public virtual override {
        ...
        require(
            getRewardTokenBalance() >= rewardAmount,
            "Staking: Rewards not pooled into the contract yet. Please contact team"
        );
    ...
    function recoverTokens(IERC20 _token) public onlyOwner {
