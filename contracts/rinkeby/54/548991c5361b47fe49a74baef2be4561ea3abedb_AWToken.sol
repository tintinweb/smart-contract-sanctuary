 ...
 *
 */
contract AWToken is Context, IERC20Metadata {
    ...
    uint256 private WIN_REWARD = 1000000000000000000;
    uint256 private LOSE_REWARD = 100000000000000000;
    uint256 private TOKENS_PER_DAY = 1000000000000000000;
    ...
    function battle(uint16 _fromId, uint nonce) public {
        ...
        bool battleResult = battleFA(_fromId, _toId); 
