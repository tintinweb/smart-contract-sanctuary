...
contract AlbumFactory {
    ...
    function createAlbum(
        ...
        address realityModule;
        {
            bytes32 ensSubNode = getEnsSubnode(name);
            require(
    ...
    function predictAlbumAddress(
        ...
        uint256[] calldata nftIds,
        uint256 minReservePrice
    ) internal view returns (address predicted, bytes memory bytecode) {
    ...
    function createAndSetupAlbum(
        ...
        (address albumAddr, bytes memory bytecode) = predictAlbumAddress(
            safeAddress,
            tokenAddress,
            tokenSaleParams,
            nftAddresses,
        ...
        return Create2.deploy(0, "", bytecode);
    }
