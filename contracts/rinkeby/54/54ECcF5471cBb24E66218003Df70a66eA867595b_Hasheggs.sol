 ...
 * ERC721Tradable - ERC721 contract that whitelists a OpenSea trading address, and has minting functionality.
 */
contract ERC721Tradable is ERC721Full, Ownable {
    
    // Set the maximum number of Hasheggs that can be minted to 5000
    ...
    function mintTo(address _to) public onlyOwner {
        require(totalSupply() < MAX_NFT_SUPPLY, "Max number of hasheggs minted.");
    ...
    function baseTokenURI() public pure returns (string memory) {
        return "https://hasheggs.com/api/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://hasheggs.com/api/contract";
    }
...
/**
 * @title Hasheggs
 * Hasheggs - a contract for non-fungible hasheggs.
 */
contract Hasheggs is ERC721Tradable {
    // The list of all 5000 hasheggs and their SHA256 HASH is pinned in the InterPlanetary File System (IPFS).
    // It is viewable using the following address ipfs://Qmb3hSbrX3wp94aimXn8sTcwpDsJtF8unicpyxLevWuD85
    // Use the hash from the list to validate the specific hashegg is authentic.
    string public listHash = "287252fb2a22018cfa07982f8103b593998fcfbbd82fac00c05ab2714d48529c";

    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("Hasheggs", "HE", _proxyRegistryAddress)
    {}
}