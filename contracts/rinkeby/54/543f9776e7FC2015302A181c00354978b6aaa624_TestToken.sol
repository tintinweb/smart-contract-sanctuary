...
contract TestToken is ERC721, Ownable {
    ...
    uint256 public constant tokenPrice = 250000000000000; // 0.0025 ETH
    ...
    uint256 public tokenReserve = 25;

    event TokenMinted(uint256 supply);

    constructor() ERC721("Token Test.", "TTTS") {}
    ...
    function mintToken(uint256 numberOfTokens) external payable {
        ...
        require(
            ...
            "Can only mint maxTokenPurchase tokens at a time"
        );
        require(
