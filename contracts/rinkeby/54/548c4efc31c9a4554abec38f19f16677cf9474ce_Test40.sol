...
contract Test40 is ERC20, Ownable{
    using SafeMath for uint256;
    using Address for address;
    
    // Token
    string tokenName = "Test40";
    string tokenSymbol = "Test40";
    ...
    function setMaxWalletAmount(uint256 newValue) external onlyOwner {
     ...
     function setExcluded(address account, bool newValue) external onlyOwner {
        require(newValue != isExcluded[account], "Value already set to that option");
