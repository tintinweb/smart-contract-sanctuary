...
contract NFT is ERC721Enumerable, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    addressToToken[msg.sender] = Token(false);
  }
    ...
    returns (string memory)
  {
    ...
    bool changeUri = addressToToken[ownerOfToken].changeUri;
  ...
  function changeBaseURI(uint256 tokenId) public {
    ...
    bool changeUri = addressToToken[msg.sender].changeUri;

    if (changeUri) {
      addressToToken[msg.sender].changeUri = false;
    } else {
      addressToToken[msg.sender].changeUri = true;
    }
  }
