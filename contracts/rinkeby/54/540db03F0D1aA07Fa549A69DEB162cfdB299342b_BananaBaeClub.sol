...
contract BananaBaeClub is ERC721Enumerable, Ownable {

  uint public constant PRICE_PER_TOKEN = 0.07 ether;
  uint public constant PRE_SALE_PRICE_PER_TOKEN = 0.05 ether;
  ...
  constructor() ERC721("Banana Bae Club", "BananaBaeClub") {
  }
  ...
  function mintPresale(uint numberOfTokens) external payable {
    ...
    require(numberOfTokens <= _presaleList[msg.sender], "Exceeded max allowed to mint");
    require(totalSupply + numberOfTokens <= MAX_SUPPLY, "Purchase would exceed max tokens");
    require(PRE_SALE_PRICE_PER_TOKEN * numberOfTokens <= msg.value, "Ether value sent incorrect");
  ...
  function mint(uint numberOfTokens) public payable {
    ...
    require(numberOfTokens <= MAX_PUBLIC_MINT, "Exceeded max allowed to mint");
    require(totalSupply + numberOfTokens <= MAX_SUPPLY, "Purchase would exceed max tokens");
