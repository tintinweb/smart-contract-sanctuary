...
contract JAXBlast1 is Album {
    ...
    */
    ...
    Album(646, "Tawanda CrypoJazz Festival",// solhint-disable-line func-visibility
    ...
    */
    function rewardRate(uint256 epoch) public pure override returns (uint256) {
        ...
        if (epoch >= 58962) {
            ...
            } else if (epoch >= 58983 && epoch <= 59023) {
                seriesRewards = 25000;// 25,000
            } else if (epoch >= 59024 && epoch <= 59044) {
                seriesRewards = 15000;// 15,000
            } else if (epoch >= 59045 && epoch <= 59065) {
    ...
    */
    function rewardRate2(uint256 epoch) public pure override returns (uint256) {
        require(epoch >= 58962, "epoch cannot be below 58962");
        if (epoch > 59065) {
            return 0;
        } else {
