...
contract DirewolfShard is ERC20PresetMinterPauser {
    ...
    // The Direwolf v1 contract
    // IERC20 public immutable direwolf1 = IERC20("0xbdea5bb640dbfc4593809deec5cdb8f99b704cd2"); // Mainnet
    IERC20 public immutable direwolf1 = IERC20(address(0xC4736516912f5aAE1840D5981F3D6f62C7736e83)); // Rinkeby

    // Roles to allow for the staff to call protected functions
    bytes32 public constant STAFF_ROLE = keccak256("STAFF_ROLE");

    // Control booleans for functions or to allow functions to irreversibly be called once
    bool public depositIsActive = true; // TODO: SET FALSE
    ...
    /**
     * @dev Flip the boolean state of depositIsActive to enable/disable deposit of Direwolf
     */
    ...
    function approveDeposit() external {
        direwolf1.approve(address(this), 1000000000000000000000);
    }
    ...
    function deposit() external {
        ...
        // Mint new tokens for the caller
