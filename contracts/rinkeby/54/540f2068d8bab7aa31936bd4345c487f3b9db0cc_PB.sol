...
contract PB is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("PB", "PB")  {
        setBaseURI(baseURI);
    }
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= maxMintAmount, "PB: Maximum minting amount = 10/transaction.");
        ...
        require(balanceOf(msg.sender) < maxClaimable ,"PB : You can't own more than 5 tokens");
        if(msg.sender != owner()){
    ...
    function whiteListMint(bytes memory sig) public payable {
        ...
        require(isValidUser(msg.sender,sig),"PB: INVALID SIGNATURE");
        require(!hasMintedWhitelist(msg.sender),"PB : Whitelist can be used Once Only!");
