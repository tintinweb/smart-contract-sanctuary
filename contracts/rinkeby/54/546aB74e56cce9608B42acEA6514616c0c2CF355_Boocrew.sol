...
contract Boocrew is ERC721Enumerable, Ownable {
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(balanceOf(msg.sender) < walletLimit, 'Each address may only own a certain amount of Boos.');
    ...
    returns (string memory)
  {
    require(
      _exists(tokenId),
      "ERC721Metadata: URI query for nonexistent Boocrew"
    );
 ...
 // This withdraw's the contract's balance of ETH to the Owner (whoever launched the contract) address.
