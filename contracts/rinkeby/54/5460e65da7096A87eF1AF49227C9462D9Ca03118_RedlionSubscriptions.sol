...
contract RedlionSubscriptions is Context, AccessControlEnumerable, ERC721Enumerable {
    ...
    constructor(
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, cassandra);
    ...
    */
    ...
    function addAdmin(address admin) onlyRole(DEFAULT_ADMIN_ROLE) public {
        grantRole(DEFAULT_ADMIN_ROLE, admin);
    }

    function withdraw() onlyRole(DEFAULT_ADMIN_ROLE) public {
        uint amount = address(this).balance;
        payable(_cassandra).transfer(amount);
    }
    
    function setRedPrice(uint newPrice) onlyRole(DEFAULT_ADMIN_ROLE) public {
        RED_PRICE = newPrice;
    }
    function setGoldPrice(uint newPrice) onlyRole(DEFAULT_ADMIN_ROLE) public {
        GOLD_PRICE = newPrice;
    }
    function setSilverPrice(uint newPrice) onlyRole(DEFAULT_ADMIN_ROLE) public {
