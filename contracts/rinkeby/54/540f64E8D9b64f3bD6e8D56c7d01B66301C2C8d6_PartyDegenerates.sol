...
contract PartyDegenerates is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint16 public constant NUM_RESERVED_NFTS = 200; //TODO: number of reserved tokens for the team
    address RESERVE_VAULT_WALLET = 0x6f6d91D82810f0beE80D9689498e663D72D431eB; //TODO send the reserve NFTs to this wallet before activating the public sale

    string public degeneratesProvenance;
    bool public provenanceLocked = false;
    //used to shift the tocken ids to the right by a random number of positions
    ...
    function getMintPrice() public view returns (uint256) {
        ...
        if (elapsed >= publicSaleDuration) {
            ...
            uint256 currentPrice = publicSaleDegenerateStartingPrice +
                ((DEGENERATES_END_PRICE - publicSaleDegenerateStartingPrice) /
                    publicSaleDuration) *
                elapsed;
            return
    ...
    */
    function reserve(uint256 numDegeneratesToMint)
        ...
        notLocked
    {
        //for (uint256 i = 0; i < NUM_RESERVED_NFTS; i++) {
