...
contract PublicSaleStorage  {
    ...
    struct SetValueInfo {
        uint256 startAddWhiteTimeSet;
        uint256 endAddWhiteTimeSet;
        uint256 startExclusiveTimeSet;
        uint256 endExclusiveTimeSet;
        uint256 startDepositTimeSet;
        uint256 endDepositTimeSet;
        uint256 startOpenSaleTimeSet;
        uint256 endOpenSaleTimeSet;
        uint256 startClaimTimeSet;
        uint256 claimIntervalSet;
        uint256 claimPeriodSet;
    }
    ...
    mapping (uint => SetValueInfo) public setValues;
