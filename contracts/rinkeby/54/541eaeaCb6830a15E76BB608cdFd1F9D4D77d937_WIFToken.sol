...
contract WIFToken is Pausable, AccessControlEnumerable, ERC20Burnable, ERC20Snapshot, ERC20Permit {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal override(ERC20, ERC20Snapshot) {
        ...
        require(
            ...
            hasRole(WHITELISTED_FROM_ROLE, from),                      // from is whitelisted (can be used to add liquidity on uniswap )
            "transfers paused"
        );
    }
