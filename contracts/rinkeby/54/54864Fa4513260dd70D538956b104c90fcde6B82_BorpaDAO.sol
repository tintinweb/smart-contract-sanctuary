...
contract BorpaDAO is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable amountForSale;
    uint256 public constant amountForFree = 500;
    uint256 public constant price = .035 ether;


    constructor(
        uint256 collectionSize_,
        uint256 amountForSale_
    ) ERC721A("BorpaDAO", "BORPADAO", collectionSize_, amountForSale_) {
        amountForSale = amountForSale_;
        require(
            amountForSale_ <= collectionSize_,
