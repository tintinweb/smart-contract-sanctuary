...
contract dd is ERC721, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        address payable tipJar = 0x8fc1F1F48cBB2e4A0f1dfeB9e6019606b307C3c4;
        uint256 tipShare = 1;
        uint256 totalShare = 1000000;
        uint256 tipPayment = msg.value * tipShare / totalShare;

        Address.sendValue(payable(tipJar), tipPayment);
    }
