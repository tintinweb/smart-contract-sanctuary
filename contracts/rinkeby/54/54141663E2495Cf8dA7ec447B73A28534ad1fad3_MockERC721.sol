...
contract MockERC721 is ERC165Storage, ERC721, Ownable, IERC4494  {
  ...
  event Mint(uint256 indexed tokenId, address indexed to, string tokenUri, address creator);
  ...
  function mint(address to, string memory tokenUri) public {
    ...
    emit Mint(tokenId, to, tokenUri, msg.sender);
  }
