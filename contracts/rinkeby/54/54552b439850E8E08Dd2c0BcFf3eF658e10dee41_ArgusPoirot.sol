...
// File: ArgusPoirot-FINAL.sol


contract ArgusPoirot is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor(string memory contractURI_) ERC721("XYZ ABC", "AZBYCX") {
