...
contract SLC{
    ...
    function EndAuction(string memory uid,address Treasury_Admin,address Token_Owner) public onlyEscrow returns(bool){
        ...
        if(success){
            ...
            require(usdcInstance.transfer(Token_Owner,owner_money),"USDC TRANSFER TO TOKEN OWNER FAIL ");
            require(usdcInstance.transfer(Treasury_Admin,treasury_money),"USDC TRANSFER TO TREASURY ADMIN FAIL");
            return true;
        }
        else{
