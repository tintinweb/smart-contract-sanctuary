...
contract AppLogo is ERC721, VRFConsumerBase {
  ...
  //  bytes32 internal keyHash;
    ...
    ERC721("AppLogo", "D&S") {
      ...
      internal override {
        ...
        uint256 stamina = ((randomNumber % 100000) /10000);
     ...
     function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
       ...
       _setTokenURI(tokenId, _tokenURI);  // this is how you would render to opensea
     }
