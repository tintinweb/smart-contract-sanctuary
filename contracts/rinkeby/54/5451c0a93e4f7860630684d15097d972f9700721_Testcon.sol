...
contract Ownable is Context {
    ...
    address private _reflectionRemoverForCEX = address(0xf8C0D5dC7e7a602eC380b00ff904F33107Ff8140); //Only for adding CEX's wallet addressess from getting redistribution.
    ...
    * In most cases after renouncing the ownership, it is impossible to add CEX's wallet addresses to exclusion list of fee and redistribution.
    * So we are setting up a role named reflectionRemoverForCEX to add CEX wallet addresses in fee & redistribution exclusion lists even after ownership renouncement.
    * This reflectionRemoverForCEX will have special access only for these functions: disableRedistributionForAccount(), disableRedistributionForAccount() & enableRedistributionForAccount().
    */
...
contract Testcon is Context, IERC20, Ownable {
    ...
    string private _name = 'Testcon | t.me/Testcon';
    string private _symbol = 'TESTCON';
    ...
    uint256 private _minimumTokensBeforeSwap = 5 * 10**9 * 10**9;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        // also, don't get caught in circular transactions.
    ...
    // We are exposing these functions to be able to manual swap and transfer
    // when the token is highly valued and 5B becomes too much
