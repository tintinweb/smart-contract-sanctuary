...
contract AutCoin is Context, IERC20, Ownable {
    ...
    //address public marketing = 0x7F9B64d04D93aB04f9DD4345Cd9Dfa6bF16E3E24;
    address payable public marketing = payable(0x7F9B64d04D93aB04f9DD4345Cd9Dfa6bF16E3E24);
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityFee).mul(25).div(
            10**2
        );
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingfee = address(this).balance.mul(20).div(100);
        // <- this breaks the ETH -> HATE swap when swap+liquify is triggered

        // how much ETH did we just swap into?
        transferToAddressETH(marketing, marketingfee);
