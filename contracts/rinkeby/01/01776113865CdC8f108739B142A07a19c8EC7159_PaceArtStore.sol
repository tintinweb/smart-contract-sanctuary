 ...
 */
abstract contract ERC721Tradable is RoyaltiesV2Impl, ERC721, Ownable {
    using SafeMath for uint256;
    ...
    //  */
    // function mintTo(address _to) public onlyOwner returns(uint) {
    ...
    function mintTo(address _to, LibPart.Part memory _royalty) public whenSaleActive returns(uint) {
        // require(mintPrice <= msg.value, "ERC721Tradable: Ether value sent is not correct");
...
contract PaceArtStore is ERC721Tradable {
