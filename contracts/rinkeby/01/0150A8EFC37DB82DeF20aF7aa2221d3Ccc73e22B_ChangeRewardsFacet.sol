...
// File contracts/libraries/LibCampfireStorage.sol
...
library LibCampfireStorage {
    bytes32 constant STORAGE_POSITION = keccak256("fi.solace.campfire.storage");
    ...
    function campfireStorage() internal pure returns (Storage storage ds) {
...
// File contracts/libraries/LibDiamondStorage.sol
...
// File contracts/libraries/LibOwnership.sol
...
// File contracts/facets/ChangeRewardsFacet.sol
...
contract ChangeRewardsFacet {
    function changeRewardsAddress(address _rewards) public {
        ...
        LibCampfireStorage.Storage storage ds = LibCampfireStorage.campfireStorage();
