...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0xCE20f9344208F4CCDB48593E3916430bFA0463cD); // BUSD
...
contract TestRat is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DontTest", "TAT") {
        
        address newOwner = address(0x6EC155E4d80eA630EB00ec9F9601e6108c3Dd1e1);
    ...
    function swapBack() private {
        ...
        swapBnbForRewardToken(ethForRewards - ethFormarketing);
        ...
        else // send remainder to marketingWallet
