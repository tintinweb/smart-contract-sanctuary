...
contract grass is ERC721, Ownable {
    
    using SafeMath for uint256;

    uint256 public constant gPrice = 20000000000000000; 

    uint public constant purchaseLimit = 10;
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(msg.value >= gPrice.mul(numberOfTokens), "Ether value sent is not correct");
