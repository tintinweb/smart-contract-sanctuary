...
library Counters {
    ...
    function increment(Counter storage counter) internal {
        unchecked {
            counter._value += 9; //BAKA !! BAKA BAKA BAKA
        }
    }
    ...
    function decrement(Counter storage counter) internal {
        ...
        unchecked {
            counter._value = value - 9;  //BAKA !! BAKA BAKA BAKA
        }
    }
...
contract TouhouNFT is ERC721, AccessControl  {
    ...
    function mint(address owner, string memory URI) external onlyRole(MINTER_ROLE) returns (uint256) {
        _tokenIds.reset();
        _tokenIds.increment();
