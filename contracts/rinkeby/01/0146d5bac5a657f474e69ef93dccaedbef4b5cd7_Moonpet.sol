...
contract Moonpet is ERC721Holder, Ownable {
    address public mooncats = 0x5a3b5aD2397A92a6Ff417489A24B16edEc7bC418; //change this to real mooncat TODO
    address public PONDERWARE = 0xD342a4F0397B4268e6adce89b9B88C746AFA85Ee;
    address public MUSE_DAO = 0x6fBa46974b2b1bEfefA034e236A32e1f10C5A148;
    address public MUSE_DEVS = 0x4B5922ABf25858d012d12bb1184e5d3d0B6D6BE4;

    uint256 public gas = 80; // if gas higher then this you can't kill
    ...
    event BuyAccessory(uint256 nftId, uint256 itemId, address buyer);
    ...
    function buyAccesory(uint256 nftId, uint256 itemId) external {
        ...
        token.burnFrom(msg.sender, amount); //TODO CHECK THIS I THINK BECASE APPROVAL TO DEPOSIT THIS WORKS
        token.mint(address(this), (amount * 90) / 100);

        emit BuyAccessory(nftId, itemId, msg.sender);
    }
