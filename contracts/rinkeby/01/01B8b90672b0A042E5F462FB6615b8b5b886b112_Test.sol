...
contract Test is Ownable, ERC721Enumerable {
    ...
    uint256 public MAX_NFT_PRESALE_1 = 666;
    uint256 public MAX_NFT_PRESALE_2 = 3000;
    uint256 public PRESALE_COST_1 = 0.1 ether;
    uint256 public PRESALE_COST_2 = 0.15 ether;
    ...
    // uint256 public mintMaxWallet_presale_1 = 2;

    mapping(address => bool) public preSaleMapping;

    uint256 public totalUnsoldPresale_1;
    ...
    function preSaleWhitelist1(
        ...
        require(isPresale_1, "pre sale is not active");
        require(
            MerkleProof.verify(proof, Whitelist_Root, _leaf(account)),
            "account not part of whitelist"
        );
        require(!preSaleMapping[account], "already minted"); // checks if already minted
        require(
            _mintAmount <= mintTxLimit_presale_1,
            "Amount exceeds mintable limit per transaction" //checks if only one entered directly
        );
        // require(
        //     _mintAmount <= mintMaxWallet_presale_1 - claimed,
        //     "Amount exceeds mintable limit"
        // );
        require(
        ...
        totalUnsoldPresale_1 = MAX_NFT_PRESALE_1 - counter;
    ...
    function preSaleWhitelist2(
        ...
        uint256 counter = totalSupply();
        require(isPresale_2, "pre sale is not active");
        require(
            MerkleProof.verify(proof, Whitelist_Root, _leaf(account)),
            "account not part of whitelist"
        );
        ...
        require(
            counter + _mintAmount <= MAX_NFT_PRESALE_2 + totalUnsoldPresale_1,
