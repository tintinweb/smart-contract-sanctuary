 ...
 */
contract Humpty is ERC721Tradable {
    string private _baseTokenURI;
    uint256 public _reserved = 555;
    uint256 public _price = 0.0555 ether;
    bool public _paused = true;


    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Humpty", "Humpty", _proxyRegistryAddress)
    {}
    ...
    function mint(uint256 num) public virtual payable {
        uint256 supply = totalSupply();
        require( !_paused,                            "Sale paused" );
        require( num < 21,                            "You can mint a maximum of 20" );
        require( (supply + num) < (9999 - _reserved),     "Exceeds maximum supply" );
   ...
   function setReserved(uint256 _newReserved) public onlyOwner {
    ...
    function flushToken(IERC20 _token) public onlyOwner {
