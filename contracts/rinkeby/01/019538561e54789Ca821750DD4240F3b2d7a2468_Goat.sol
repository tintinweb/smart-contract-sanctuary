...
contract Goat is IGoat, ERC721Enumerable, Ownable, Pausable {
    ...
    */
    constructor(address _egg, address _traits, uint256 _maxTokens, address _whitelistSigner) ERC721("Goat Game", 'GGAME') { 
        egg = EGG(_egg);
    ...
    */
    function mintCost(uint256 tokenId) public view returns (uint256) {
        // !!!!!! @TODO: COMMENTED THIS OUT FOR TESTING PURPOSE
        // if (tokenId <= PAID_TOKENS) return 0;
        // if (tokenId <= MAX_TOKENS * 2 / 5) return 20000 ether;
        // if (tokenId <= MAX_TOKENS * 4 / 5) return 40000 ether;
        // return 80000 ether;

        if (tokenId <= 5) return 0;
        if (tokenId <= MAX_TOKENS * 2 / 5) return 20000 ether;
        if (tokenId <= MAX_TOKENS * 4 / 5) return 40000 ether;
        return 80000 ether;
    }
    ...
    */
    function setSales(bool _earlyAccessMintSale, bool _publicMintSale) external onlyOwner {
        require(_earlyAccessMintSale != _publicMintSale, 'setSales: Sales both active?');
