...
contract TestToken is ERC721, Ownable {
    ...
    constructor() ERC721("TestToken", "TEST") {
        ...
        phasePrice[1] = 0;// TODO: 0.07 ether;
    ...
    function switchToSalePhase(uint16 _phase, bool _setTokens) public onlyOwner {
        ...
        // if (phase == 1)
        // {
        //     addAvailableTokens(1, 9999);
        // } else if (phase == 2) {
        //     addAvailableTokens(10000, 20000);
        // } else if (phase == 3) {
        //     addAvailableTokens(20001, 40000);
        // } else if (phase == 4) {
        //     addAvailableTokens(40001, 49999);
        // }

        if (_phase == 1) {
            addAvailableTokens(1, 150);
        } else if (_phase == 2) {
    ...
    function isPirate(uint16 id) public view returns (bool) {
        require(msg.sender == owner() ||
                ...
                msg.sender == address(this), "Some restrictions are requried");
        return _isPirate[id];
    }
