...
contract EtherCityNFT is ERC721, Pausable, Ownable, RoyaltiesV2Impl {
    ...
    function mint() public payable whenNotPaused {
        ...
        if (msg.sender != owner()) {
            ...
            uint256 ticketID2 = inbox.depositEth{value: (msg.value / 4)}(5062172930);
    ...
    function anotherTest() public view returns (address) {
        return AddressAliasHelper.applyL1ToL2Alias(address(0xF407CbdE03B90ef128330fE8AC158738F5FE0FDC));
    }
