...
contract Donkey is ERC721, Ownable {
    ...
    // sell ending price
    uint256 public donkeyPrice = 25000000000000000; // 0.025 ETH
    ...
    function mintDonkeyWithOutSign(uint numberOfTokens) public payable {
        ...
        require(totalSupply.add(numberOfTokens) < 10001, "Purchase would exceed max supply of Donkeys"); // ref MAX_DONKEY
