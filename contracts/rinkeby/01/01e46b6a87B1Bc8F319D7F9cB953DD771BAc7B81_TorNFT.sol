...
contract TorNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant baseTorPerUri = 40 ether;
    ...
    event TorReleased(address recipient, uint256 value);
    event WorkCreated(address recipient, uint256 tokenId, bool customItem, string customString);

    constructor() ERC721("TheOsunRiver", "TOR") Ownable() {}
    ...
    function createPermanentURI(
        ...
        tor.transfer(msg.sender, baseTorPerUri);
    ...
    function releaseSolos(address recipient, uint256 amount) public onlyTimelock {
        tor.transfer(recipient, amount);
        emit TorReleased(recipient, amount);
    } // only timelock
