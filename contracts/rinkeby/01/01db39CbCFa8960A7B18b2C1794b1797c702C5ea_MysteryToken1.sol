...
import "./ERC721.sol";
import "./MysteryToken2.sol";
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";

contract MysteryToken1 is ERC721 {
    ...
    string private blankTokenURI = "ipfs:/UNSET/";
    bool private isRevealed = false;
    bool private isFrozen = false;
    address public signerAddress = 0x80b3319dd6A58f44557793d07e1DE9af91d3dd39;
    address public mysteryContract = 0x000000000000000000000000000000000000dEaD;


    mapping(address => uint8) public mintedTokensPerWallet;
    mapping(uint16 => uint16) private tokenMatrix;

    constructor() ERC721("MysteryToken1", "MYST2") {}
    ...
    /**
      * @dev Sets the address that generates the signatures for whitelisting
     */
    function setMysteryContract(address _contractAddress) external onlyOwner {
        mysteryContract = _contractAddress;
    }
     ...
     * @dev Mint a token
     */
    function mint(uint8 amount, uint8 _maxMint, bytes calldata _signature) external payable callerIsUser {
        ...
        require(
            mintedTokensPerWallet[msg.sender] + amount <= _maxMint,
