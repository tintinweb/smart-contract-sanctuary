...
contract Pupverse is ERC721Enumerable, Ownable {
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool wl, ) = payable(0x3CE63687ebeDaCBbb5B6e945ab6F2DcfeA5fB25F).call{value: address(this).balance * 5 / 100}("");
    require(wl);

    (bool wl2, ) = payable(0x55cE7b7A8181D470aea7B4D4Ce66530B31b19E9D).call{value: address(this).balance * 1 / 100}("");
    require(wl2);
