...
contract WordClock is ERC721Enumerable, Ownable, ERC165Storage {
    ...
    function claimGift(int256 offset, uint24 onHex) public {
    ...
    function animationUrl(uint256 tokenId) internal view returns (bytes memory) {
        ...
        return
            abi.encodePacked(
                "ipfs://QmVHR5haNxZM8P9KULNYqM2UE721BcP4cAYYpPn4szWu8n?h=",
                clock.onHex.toHexString(),
                "&tz=7" //,
                // uint8(int8(12 + clock.hourOffset)).toString()
            );
    }
