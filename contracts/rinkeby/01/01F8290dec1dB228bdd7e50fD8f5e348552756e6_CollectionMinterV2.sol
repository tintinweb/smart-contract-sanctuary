...
contract CollectionMinterV2{
    
    event NewCollectionV2(IERC721 collectionAddress);
    
    
    function createNewCollection(string memory _nm, string memory symbol, uint256 startId, uint256 royaltypercent) public{
        ERC721 collection = new ERC721(_nm,symbol,royaltypercent,startId,msg.sender);
        emit NewCollectionV2(collection);
    }
