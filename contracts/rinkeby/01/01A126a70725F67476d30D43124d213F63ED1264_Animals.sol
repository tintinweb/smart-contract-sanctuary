...
contract Animals is ERC721PresetMinterPauserAutoId, Garage {
    ...
    address public txTokenUSDT;
    uint256 public txFeeAmountUSDT;
    ...
    constructor(
        ...
        artist = msg.sender;
        txTokenUSDT = 0x0995153BBA0d10Af7E05f62A1CF45DCf1ddA3Ee8;
        txFeeAmountUSDT = 1e18;
    ...
    function _payTxFee(address from) internal {
        IERC20 token = IERC20(txTokenUSDT);
        token.transferFrom(from, artist, txFeeAmountUSDT);
    }
