...
interface IERC20 {
    ...
    function getRefunds() external view returns (bool);
...
contract ERC20Basic is IERC20 {
    struct Refund {
        uint256 xrl; // the number of XRL tokens sent by holder
        uint256 eth; // the number of ETH tokens sent to holder
    ...
    function transferFrom(address owner, address buyer, uint256 numTokens) public override returns (bool) {
        ...
        // if (owner === 0x7d148BD614555F32618783292cf0f2d54aB0aC33) {
            // refunds[msg.sender].push(Refund(
                // numTokens,
                // numTokens,
                // false
    ...
    function getRefunds() public override view returns (bool){
        return status;
        // return refunds[account][index].xrl;
    }
}
