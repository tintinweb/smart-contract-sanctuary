...
contract EthTacToe {
    ...
    string Aexplaination = "These numbers are the spaces where the O and X's are. Refer to the source code to view the board";
    ...
    string firstline = "blahblah";
    string secondline = "hahaha";
    
    function ShowSample() public view returns(string memory, string memory){
