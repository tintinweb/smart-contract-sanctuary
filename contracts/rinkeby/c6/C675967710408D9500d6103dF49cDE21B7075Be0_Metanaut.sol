...
contract Metanaut is ERC721Enumerable, Pausable, AccessControl, PaymentSplitterAdjustable {
    ...
    function mintToken(uint256 _mintCount, address referrerAddress) external payable whenMintIsLive whenNotPaused {
        mintTokenTo(_mintCount, referrerAddress, _msgSender());
    }
