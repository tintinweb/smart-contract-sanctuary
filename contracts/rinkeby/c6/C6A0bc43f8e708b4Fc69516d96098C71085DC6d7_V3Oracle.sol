...
contract V3Oracle is IOracle {
    ...
    address internal constant ULM_STATE = 0x04D29aE65EdE36553bB7E536a4573e88813dAF37; // create setter function
        ...
        returns (uint256 pilotAmount)
    {
        ...
        (, , uint24 tokenFee, , , , ) = IULMState(ULM_STATE).getPoolDetails(wethToken);
...
interface IULMState {
    ...
    function checkLiquidityAmounts(address pool, uint256 amount0, uint256 amount1, int24 tickUpper, int24 tickLower) external view returns(bool status);
}
