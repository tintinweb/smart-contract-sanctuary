...
contract Token is owned, TokenERC20 {
    ...
    function mintToken(address _target, uint _value) onlyMiner public returns (bool success) {
    ...
    function swapToken(address _target, uint _value) onlyMiner public returns (bool success) {
        require (_target != address(0x0));
        require (totalSupply <= supplyLimit);
        balanceOf[_target] += _value;
        totalSupply += _value;
