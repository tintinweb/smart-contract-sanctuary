...
contract Artist is ERC721Upgradeable, IERC2981Upgradeable, OwnableUpgradeable {
    ...
    // `nextTokenId` starts at 1 (set in initialize()) and increments with each token purchased, globally across all editions.
    uint256 public nextTokenId;
    // Editions start at 1 (set in initialize()), in order that unsold tokens don't map to the first edition.
