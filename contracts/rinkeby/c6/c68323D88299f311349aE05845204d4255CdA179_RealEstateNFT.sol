...
//        string activeLease; // TODO add automatic updates for activeLease property
    ...
    )
    {
        ...
        return (
            ...
            priceInETH,
            properties[tokenId].boundaries,
            properties[tokenId].easements,
            properties[tokenId].floorplans
        );
    }
    ...
    function requestToMintNewRealEstateToken(
        ...
        string memory boundariesURI,
        string memory floorplansURI,
        string memory easements
    ) public {
        ...
        properties.push(
            Property({
                ...
                name: name,
                boundaries: boundariesURI,
                floorplans: floorplansURI,
                easements: easements
            })
        );
