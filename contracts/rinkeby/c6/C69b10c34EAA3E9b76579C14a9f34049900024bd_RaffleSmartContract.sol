...
contract RaffleSmartContract is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mint(
        ...
        require(_amount > 0 && waveTotalMinted + _amount <= waveMaxTokens, "wave completed" );
        require(waveOwnerToClaimedCounts[_wallet][indexWave - 1] + _amount <= waveMaxTokensToBuy && totalSupply() + _amount < MAX_SUPPLY, "Max allowed" );
