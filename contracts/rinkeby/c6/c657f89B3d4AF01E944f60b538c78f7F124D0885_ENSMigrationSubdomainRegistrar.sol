...
contract RegistrarInterface {
    ...
    function register(bytes32 label, string calldata subdomain, address resolver) external payable;
...
contract EthRegistrarSubdomainRegistrar is AbstractSubdomainRegistrar {
     ...
     */
    function register(bytes32 label, string calldata subdomain, address resolver) external not_stopped payable {
        ...
        // User must hold tokens of the domain configured erc721
        require(domain.erc721.balanceOf(msg.sender) > 0);
