...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/doodleSwampContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract DoodleSwampContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Doodle Swamp", "Swamp Dood", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/PWHITMoB8RSEsQ5sVmdh/contract-metadata";
        }
    }