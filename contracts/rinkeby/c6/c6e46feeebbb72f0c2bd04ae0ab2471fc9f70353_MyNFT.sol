...
// File: contracts/token/ERC1155/presets/ERC1155PresetMinterPauser.sol + setURI 
 ...
 */
contract MyNFT is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    ...
    function setURI(string memory uri_) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Error: must have admin role to setURI");
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "Error: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "Error: must have pauser role to unpause");
        _unpause();
    }
