...
contract NFT is ERC721Enumerable, Ownable {
    ...
    bytes32 merkleRoot =
        0xb8a54c380799e6c0b09e5e9f9269dafbd733ef727fe76c856deece4b431fc33a;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.08 ether;
    uint256 public increaseCost = 0.01 ether;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        cost = cost + (cost * increaseCost);
    }

    function whiteListedMint(bytes32[] calldata _merkleProof) public {
    ...
    function setIncreaseCost(uint256 _newIncresedCost) public onlyOwner {
        increaseCost = _newIncresedCost;
    }
