...
contract MarketPlace {
    ...
    */    
     ...
     * @param _landIds the array of SionLand ids list that buyer is going to purchase.
     */
    function buyLands(address _currentOwner,  uint256 _rateToLand,  uint256[] memory _landIds) public {        
...
contract SionToken is ERC20, Ownable {    
     ...
     * the total supply.
     */
    function mintSionTokens(address account, uint256 amount) public onlyOwner{
...
contract SionLand is ERC721, Ownable{
    ...
    mapping(address => mapping(uint256 => uint256)) userLandsList;
     ...
     * @param _landIds the array of SionLand ids list to mintbatch.
     */
    function landMintBatch(address _to, uint256[] memory _landIds) public onlyOwner {
     ...
     */
    function getLandsBatch(address _account) public view returns(uint256[] memory landsList) {
        require(balanceOf(_account) > 0, "no land owned");
        landsList = new uint256[](balanceOf(_account));
     ...
     */
    function getLand(address _account, uint256 _id) public view returns(uint256) {
        require(balanceOf(_account) > 0, "no land owned");        
