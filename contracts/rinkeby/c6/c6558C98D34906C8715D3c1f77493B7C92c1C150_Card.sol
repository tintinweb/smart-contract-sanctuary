            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "animation_url": "',
                        animationUrl,
                        '", "description": "Cards are collectable game based on crypto primatives. Everything is on chain. And can be unbundled and converted in to individual NFTs for trading or playing", "image": "data:image/svg+xml;base64,',
