...
contract Boomer is ERC721Enumerable, Ownable {
    ...
    uint256 public boomerPrice = 0.05 ether;
    ...
    function mintSpecialBoomer(uint256 numberOfBoomers)
        public
        payable
        onlyOwner
    {
        require(!isPresaleActive, "Presale is active.");
        require(mintingActive, "Minting is not activated yet.");
        require(numberOfBoomers == 1, "Only one special NFT");
        require(
            totalSupply().add(numberOfBoomers) == maxBoomers + 1,
            "Not allow to mint more"
        );
        require(
            boomerPrice.mul(numberOfBoomers) <= msg.value,
            "Ethereum sent is not sufficient."
    ...
    function mintAsMember(uint256 numberOfBoomers) public payable {
        ...
        require(numberOfBoomers > 0, "Minting is not activated yet.");
        require(
