...
contract DefiYieldCrowdsale is WhitelistCrowdsale {
  ...
  modifier onlyWhileOpen {
    require(isOpen(), "RoundCrowdsale: not open");
    _;
  }
   ...
   */
  function withdrawTokens(address beneficiary) virtual public {
    require(hasClosed(), "DefiYieldCrowdsale: not closed");
   ...
   * @param collateralAmount Amount of collateral tokens involved in the purchase
   */
  function _preValidatePurchase(address beneficiary, uint256 collateralAmount) override internal onlyWhileOpen view {
    require(_state == State.Open, "DefiYieldCrowdsale: sales is already closed or not open");
    require(_rounds[_activeRound].state == State.Open, "DefiYieldCrowdsale: sales round is already closed or not open");
...
abstract contract WhitelistCrowdsale is Crowdsale, WhitelistedRole {
   ...
   */
  function isWhitelistOptional() public view returns (bool) {
    return _optional;
  }
   ...
   */
  function getMaxWhitelistAmount() public view returns (uint256) {
