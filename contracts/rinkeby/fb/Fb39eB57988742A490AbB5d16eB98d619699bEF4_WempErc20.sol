 ...
 */
contract WempErc20 is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    string private constant _name = "WempErc20";
    string private constant _symbol = "WEMP_ERC20";
    ...
    function _transfer(
        ...
        //else remove fee
        if(!enableFee || setForNoFee[from] || setForNoFee[to]){
            takeFee = false;
        }
