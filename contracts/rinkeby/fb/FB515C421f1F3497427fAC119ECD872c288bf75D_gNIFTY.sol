...
contract gNIFTY is IgNIFTY, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _sNIFTY) ERC20("Governance NIFTY", "gNIFTY", 18) {
        approved = msg.sender;
     ...
     * @notice can only be done once, at the time of contract initialization
    ...
    /**
     * @notice pull index from sNIFTY token
     */
    ...
    /**
        @notice converts gNIFTY amount to NIFTY
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts NIFTY amount to gNIFTY
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gNIFTY::getPriorVotes: not yet determined");
