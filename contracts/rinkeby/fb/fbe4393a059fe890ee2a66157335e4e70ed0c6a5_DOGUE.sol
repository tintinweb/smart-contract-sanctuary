...
contract DOGUE is Context, IERC20, Ownable {
    ...
    string private _name = 'ugu elite';
    string private _symbol = 'finance \xF0\x9F\x90\xA9';
    uint8 private _decimals = 18;

    address private communityFund = address(0xA558142141C2f03e732642E70129f3db4EA491ff); //
    ...
    constructor () public {
        ...
        _isExcludedFromFee[address(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506)] = true; //Uniswap
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506, 'We can not exclude Uniswap router.'); //TODO router
