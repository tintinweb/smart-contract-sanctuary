...
contract MyEpicNFT is ERC721URIStorage {
  ...
  event NewEpicNFTMinted(address sender, uint256 tokenId, uint256 totalNFTsMinted);
  ...
  function makeEpicNFT() public {
    require (
      totalNFTsMinted <= 50,
      "The total amount of NFTs allowed for this collection has already been minted, sorry!"
    );
    ...
    totalNFTsMinted += 1;
    emit NewEpicNFTMinted(msg.sender, newItemId, totalNFTsMinted);
  }
