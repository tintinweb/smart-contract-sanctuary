...
contract CandadaNFT is ERC721, ERC721Burnable, Ownable {
  ...
  constructor() public ERC721("CanadaNFT", "CADNFT") {
		admin = msg.sender;
        delegateHistory.push(admin);
      	_setBaseURI("http://localhost:3000/token?m=");
  }
