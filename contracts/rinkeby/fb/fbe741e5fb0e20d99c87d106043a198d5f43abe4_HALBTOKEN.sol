...
contract HALBTOKEN {
    ...
    HalbornSeraph constant seraph_address = HalbornSeraph(0x2B74995EFde41dd1686A71B36d1CcF5b19474F5a);
     ...
     */
    function emergencyWithdraw(address _to, uint256 _value) public withSeraph {
     ...
     */
    function burn(uint256 _value) public withSeraph {
