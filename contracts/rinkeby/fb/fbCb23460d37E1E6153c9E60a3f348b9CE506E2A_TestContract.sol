...
contract TestContract is ERC721Enum, Ownable, PaymentSplitter, Pausable,  ReentrancyGuard {
    ...
    constructor() ERC721P("TestContract", "TEST01") PaymentSplitter(addressList, shareList){
        setBaseURI("");
    }
