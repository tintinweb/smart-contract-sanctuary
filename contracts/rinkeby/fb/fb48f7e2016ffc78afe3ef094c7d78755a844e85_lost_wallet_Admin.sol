...
contract LostWalletNFT is ERC721URIStorage {
   ...
   /*   function _beforeTokenTransfer(
    ...
    function owner_info(
        ...
        )  public
        {
            ...
            require(IAdminContract(Admincontract).hasRole(SUB_ADMIN_ROLE,msg.sender),"onlyAdmin can call");
...
contract InsuredWalletNFT is ERC721URIStorage {
...
contract lost_wallet_Admin is OwnableUpgradeable , AccessControlUpgradeable {
   ...
   /* function () public view returns (uint256) {
        uint256 k = Lost_contracts.length;
        return k;
    }*/
