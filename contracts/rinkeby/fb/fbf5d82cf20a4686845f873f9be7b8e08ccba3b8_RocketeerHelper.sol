...
contract RocketeerHelper {
    ...
    Rocketeer constant rocketeer = Rocketeer(0x95d6b9549315212D3FDce9FdCa9d80978b8bB41D);
    ...
    */
    ...
    /**
    @notice Spawn all Rocketeers up until a specific ID (like 1337). Doesn't care about 42 mechanic. Fails if the Rocketeer would go
