...
contract VonderToken is BEP20('VONDER Token', 'VON-T') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "VON::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "VON::delegateBySig: invalid nonce");
        require(now <= expiry, "VON::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "VON::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying VONs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "VON::_writeCheckpoint: block number exceeds 32 bits");
