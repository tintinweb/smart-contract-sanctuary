    ...
    ReentrancyGuard
{
    ...
    //address public _toadzContractAddress = 0xFF9C1b15B16263C61d017ee9F65C50e4AE0113D7;
    ...
    constructor() ERC721("DingDongz", "DINGDONGZ") {}
    ...
    function mint(uint256 toadId, string memory code)
        ...
        nonReentrant
    {
        require(isVibe(code), "Ribbit");
        require(_mintingAllowed, "Minting Not Allowed");
        require(totalSupply() < maxSupply, "All Choadz Claimed");
        require(toadId > 0, "Out of Range");
        require(toadId <= maxSupply, "Out of Range");
    ...
    function batchMint(uint256[] memory toadIds, string memory code)
        public
        payable
        nonReentrant
    {
        ...
        // if (_onlyToadz) {
        //     require(
        //         toadzContract.balanceOf(_msgSender()) > 0,
        //         "Only for Toadz"
        //     );
        // }
        ...
        for (uint256 i = 0; i < toadIds.length; i++) {
            ...
            require(toadIds[i] <= maxSupply, "Out of Range");
            // if (_onlyToadz) {
            //     require(
