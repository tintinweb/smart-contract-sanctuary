...
// Mint costs 0.01 Ether -> Funds sent to treasury fund 
...
contract WeMintCash is ERC721, Ownable, RandomlyAssigned {
      ...
      payable
  {
      ...
      require( _amount <= 50, "YOU CAN'T MINT MORE THAN 50 PER CALL");
      ...
      if (msg.sender != owner()) {  
        require( block.timestamp >= 1631901600, "CANNOT MINT UNTIL SALE STARTS");
        require( msg.value >= 0.01 ether * _amount);
      }
