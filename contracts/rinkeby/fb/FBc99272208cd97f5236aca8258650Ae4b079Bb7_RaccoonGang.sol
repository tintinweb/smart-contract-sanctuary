...
contract RaccoonGang is ERC1155, Ownable {
	...
	string public _contractURI =
		"https://rinkeby.etherscan.io/address/0x02529d2e5e9cdd18fe818b20c1256dc3a44d7c7c#code#F1#L1";
	...
	//adopts a cat
	function adoptRaccoon() public payable {
		require(msg.value == itemPrice, "insufficient ETH");
		adopt();
	}

	//adopts multiple cats at once
	function adoptRaccoons(uint256 _howMany) public payable {
