...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        uint256 _fee,
        bytes32 _keyHash
    ) public VRFConsumerBase(_vrfAddr, _linkAddr) {
        usdFee = 50 * (10**18);
        ethUsdFeed = AggregatorV3Interface(_feedAddr);
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 entryFee = (usdFee * 10**18) / adjPrice;
        return entryFee;
    }
    ...
    // function getRandom() view returns (uint256) {
    //     rand =
    //         uint256(
    //             keccack256(
    //                 abi.encodePacked(
