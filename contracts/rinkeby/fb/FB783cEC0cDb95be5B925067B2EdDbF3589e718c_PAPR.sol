...
import './libs/DoubleOperator.sol';
...
contract PAPR is ERC20Burnable, DoubleOperator {
    ...
    function mint(address recipient_, uint256 amount_) public onlySecondaryOperator returns (bool) {
        ...
        // update papr amount of recipient address in DFIANCE money pot
        moneyPotContract.updatePaprBonusShare(recipient_);
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        // update papr amount of recipient address in DFIANCE money pot
        moneyPotContract.updatePaprBonusShare(_msgSender());
        moneyPotContract.updatePaprBonusShare(recipient);
