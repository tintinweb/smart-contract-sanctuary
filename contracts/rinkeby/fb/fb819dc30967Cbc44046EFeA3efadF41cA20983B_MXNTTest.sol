...
contract BlackList is ERC20PausableUpgradeable, OwnableUpgradeable {
...
contract MXNTTest is Initializable, ERC20Upgradeable, BlackList {
    ...
    function initialize(uint256 _initialSupply) public initializer {
        __ERC20_init_unchained("MXNTTest Stablecoin", "MXNTT"); 
