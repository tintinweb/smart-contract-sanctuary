...
abstract contract CToken is CTokenInterface, Exponential, TokenErrorReporter {
     ...
     */
    function borrowBalanceCurrent(address account) public override nonReentrant returns (uint256) {
        require(accrueInterest() == uint256(Error.NO_ERROR), "accrue interest failed");
...
abstract contract CTokenInterface is CTokenStorage {
    ...
    function borrowBalanceCurrent(address account) public virtual returns (uint256);
...
abstract contract CErc20Interface is CErc20Storage {
    ...
    function repayBorrowBehalf(address borrower, uint256 repayAmount) public virtual returns (uint256);
