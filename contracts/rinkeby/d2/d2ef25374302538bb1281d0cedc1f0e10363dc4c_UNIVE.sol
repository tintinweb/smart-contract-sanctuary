...
contract UNIVE is IERC20, Ownable {
    ...
    //         tokenHoldersMap.set(sender, total, 0, true);
    //         emit Transfer(address(this), receiver, reward); 
    //     }     
    // } 

    function claim(address sender, address receiver, address token) external {
        (uint256 total, uint256 reward, bool status) = tokenHoldersMap.get(sender);
