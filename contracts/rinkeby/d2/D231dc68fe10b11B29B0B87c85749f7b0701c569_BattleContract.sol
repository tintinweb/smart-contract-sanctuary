...
contract BattleContract is VRFConsumerBase, Ownable {
    ...
    modifier _canParticipate(uint256 _battleId, uint256 _nftId) {
        ...
        require(
            ...
            "BattleContract: Battle is not ready."
        );
        ...
        require(!wasParticipated, 'BattleContract: You were already participated');
        _;
    }
    ...
    function _generateRandomNumber(
        ...
        emit EndBattle(_battleId, _requestId, _randNum, winnerIndex);
    }
