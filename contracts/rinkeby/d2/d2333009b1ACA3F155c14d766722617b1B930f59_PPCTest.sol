...
contract PPCTest is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("PPCTest", "PPCT") {
        ...
        reserveQty = 100;
        _tempBaseUrl = "https://ppc-metadata.s3.us-east-2.amazonaws.com/test";        
    }
     ...
     * happen to ETH
     */
    function setSalePrice(uint256 newPrice) external onlyOwnerOrAdmin {
