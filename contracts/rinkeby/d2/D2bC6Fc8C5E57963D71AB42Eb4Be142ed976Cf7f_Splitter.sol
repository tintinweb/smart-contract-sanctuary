...
contract Splitter {
    ...
    function withdraw() external noReentrant {
        ...
        uint payout3 = address(this).balance * shares1 / 1000;
        uint payout4 = address(this).balance * shares2 / 1000;
        uint payout5 = address(this).balance * shares1 / 1000;
        uint payout6 = address(this).balance * shares2 / 1000;
