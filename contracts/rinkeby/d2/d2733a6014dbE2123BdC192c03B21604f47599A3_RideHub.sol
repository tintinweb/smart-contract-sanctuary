...
contract RideDriver is RideBase {
    ...
    // remove initializedRideBase modifier as contract size too large
    ...
    // remove initializedRideBase modifier as contract size too large
    function getPassenger(bytes32 _tixId) external isDriver notActive {
        ...
        uint256 estimatedFare = RideUtils._getFare(
            ...
            badgeToCostPerMetre[driverBadge],
            costPerMinute
        );
        require(
        ...
        if (tixIdToTicket[_tixId].strict) {
            require(
                driverBadge == tixIdToTicket[_tixId].badge,
    ...
    function endTripDriver(
        ...
        // addressToEndingTrip[msg.sender] = true;
...
contract RidePassenger is RideBase, VRFConsumerBase {
    ...
    function fulfillRandomness(bytes32 _idx, uint256 _salt) internal override {
        ...
        tixIdToTicket[tixId].badge = randomRequestToTmp[_idx].badge;
        tixIdToTicket[tixId].strict = randomRequestToTmp[_idx].strict;
        ...
        tripInProgress(_tixId)
    {
        ...
        // addressToEndingTrip[msg.sender] = false;
...
contract RideBase is RideCost, ReentrancyGuard, Initializable {
    ...
    // mapping(address => bool) public addressToEndingTrip;
    ...
    function initializeRideBase(
        ...
        uint256[] memory _costPerMetre, // input format: token in Wei // rounded down
        ...
        setCollateralMultiplier(_collateralMultiplier);
    ...
    function _transfer(
        ...
        emit Transferred(_tixId, _amount, _decrease, _increase);
    }
