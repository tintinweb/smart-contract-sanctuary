...
contract NonGenerativeBB is GenerativeBB {
   ...
   mapping ( uint256 => uint256[]) public _allowedCurrencies;
...
/** 
    ...
    */
    ...
    function buyNonGenBoxPayable(uint256 seriesId) validateCurrencyType(seriesId,3, true) internal {
        ...
        uint256 price = dex.calculatePrice(nonGenSeries[seriesId].price , baseCurrency[seriesId], 3, 0, address(this), address(this));
