...
contract PigeonPaisans is ERC721, Ownable {
	using Counters
	...
	uint public CURR_ROUND_TIME = 1640389227000;
	...
	constructor() ERC721("Pigeon Paisans", "PigeonPaisans") {
		setBaseURI("http://137.184.20.41/pigeon/");
	}
