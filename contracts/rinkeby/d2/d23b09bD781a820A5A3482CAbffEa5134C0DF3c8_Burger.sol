...
contract Burger is ERC721Enumerable, Pausable, Ownable {
        ...
        returns (uint256)
    {
        ...
        uint256 idMinted = mint(boxType);
        return idMinted;
    }

    function mint(uint8 boxType) internal returns (uint256) {
        _safeMint(msg.sender, totalSupply());
        boxTypeById[totalSupply()] = boxType;

        emit MintNFT(msg.sender, totalSupply(), boxType);
