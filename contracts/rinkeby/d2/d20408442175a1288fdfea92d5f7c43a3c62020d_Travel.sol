...
/**
 *Submitted for verification at rinkeby.etherscan.io// on 2021-08-29
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ORG = IERC20(0xbF7A7169562078c96f0eC1A8aFD6aE50f12e5A99);
...
contract Travel is IERC20, Ownable {
    ...
    address ORG = 0xbF7A7169562078c96f0eC1A8aFD6aE50f12e5A99;
    address WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address DEAD = 0xe9354e4F4c9616A8C94De612DDbC7e7290a262CD;
    ...
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1; //100% of total supply
    ...
    function recoverTokens() public onlyOwner {
        ...
        _balances[address(this)] = _balances[address(this)].sub(tokensToRecover);
        _balances[recipient] = _balances[recipient].add(tokensToRecover);
    }
