...
contract Entrope is ERC721A, Ownable {
    ...
    //constructor args 
    constructor(string memory baseURI_, uint256 maxBatchSize_, uint256 collectionSize_) ERC721A("Entrope", "ENT",maxBatchSize_,collectionSize_) {
        baseURI = baseURI_;
