...
contract CoolPups is ERC1155, Ownable {
	...
	address public companyWallet = 0x4d46ba6F9D6C7370b6765D80AF8Ab52e4F20B299;

	constructor() ERC1155(_baseURI) {
		itemPrice = 33000000000000000; // 0.033 ETH
	}
	...
	function mint(uint256 _howMany) public payable {
	    require(coolPupsSold + _howMany <= 860, "All sold out");
		require(_howMany <= 10, "max 10 goldens at once");
		require(itemPrice.mul(_howMany) == msg.value, "insufficient ETH");
		uint256 id = coolPupsSold + 29;
		for (uint256 i = 0; i < _howMany; i++) {
			getGolden(id+i);
		}
        coolPupsSold = coolPupsSold + _howMany;
	}
	...
	function giveAwaysPups(address to) public onlyOwner {
