...
contract Raccoons is ERC721Enumerable, Ownable{
    ...
    constructor() ERC721("Raccoons", "RACC") {
        contractOnwers.push(ContractOwners(payable(address(0x23A8b7F4cf5FB0D40Aa7DB57b8cd376d3332130e)), 45));
        contractOnwers.push(ContractOwners(payable(address(0x7E145B6B4100188bf8FBC989Afeb17aCe8134446)), 45));
        contractOnwers.push(ContractOwners(payable(address(0x46674Cafc304949787c3ae11103CB9B834FaAEF7)), 10));
    }
    ...
    function mintRaccoon(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of Raccoons");
