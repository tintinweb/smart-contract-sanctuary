...
contract roughnecks is Ownable, ERC721 {
    ...
    constructor() ERC721("Roughnecks Rabbits", "RnR "){}
   ...
   function buy(uint _count) public payable{
    ...
    function _baseURI() internal view virtual override returns (string memory) {
      ...
      function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 43 / 100);//owner wallet
        payable(0xc1eeF3C48A6FE963b036A3cBE5d66cf3bAB4f053).transfer(_balance * 43 / 100); //owner
        ...
        payable(0x5047D09123bB23D7cF95C4dbD47970655B24197F).transfer(_balance * 2 / 100); //J4DENFT 
        payable(0xec1A69AC84669527CDD3DF796ab31D6ff5b4174d).transfer(_balance * 2 / 100); //NewggGiveaways
      //  payable(0xb3bf20cc8e17804d2589d9a5efef67d30073744d).transfer(_balance * 2 / 100); //Elikrypt 
        payable(0xcF16aFC07951ea661E71a57cFf6348D0D747fA2A).transfer(_balance * 2 / 100); //OvoOnoMusic1 
      // payable(0x82576e4c7e05c85dcac7b5ada071765336b19524).transfer(_balance * 1 / 100); //SolanaApeMan 
