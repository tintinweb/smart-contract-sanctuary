...
contract EthereumLottery {
    ...
    uint constant private rangeNumbers = 49;
    ...
    */
    ...
    function checkWin(uint[] memory _winningNumbers, uint[] memory ticket, uint counter) internal pure returns(uint){
    ...
    function getJackpotNumbers() public onlyOwner {
        for (uint x=0; x<6; x++) {
    ...
    */
    ...
    function drawn() public payable onlyOwner {
        ...
        lotteries[idLotteryCounter].endDate = block.timestamp;
        lotteryState = State.toStart;
        idLotteryCounter++;
    }
