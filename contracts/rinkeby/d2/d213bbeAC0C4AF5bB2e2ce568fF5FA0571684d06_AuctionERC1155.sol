...
contract AuctionERC1155 {
    ...
    //      */
    //     function contractIsProductOwner( address _deedRepositoryAddress,
    //         uint256 _productId,
    //         bool _token
    //    ) public returns (bool){
    //        if(token==true){
    ...
    //         }
    //         }else{
    //         address productOwner = ERC1155Tradable(_deedRepositoryAddress).ownerOf(_productId);
    //         if(productOwner == msg.sender){
    //             return true;
    //         }else{
    //             return false;
    ...
    function bidOnERC1155FixedAuction(
        uint256 _auctionId,
        uint256 _quantity,
