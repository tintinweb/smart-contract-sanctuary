...
contract GenericNFTCollection is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public reservedMintCount;
	...
	event TotalMintCountChanged(uint256 count);
    ...
    function mint(uint256 tokenQuantity) external nonReentrant payable {
        ...
        require(publicSaleMintCount + tokenQuantity <= PUBLIC_SUPPLY, "MINTING_WOULD_EXCEED_PUBLIC_SUPPLY");
		...
		emit TotalMintCountChanged(totalSupply());
    }
    ...
    function mintReserved(address[] calldata addresses) external onlyOwner {
        ...
        require(reservedMintCount + addresses.length <= RESERVED_SUPPLY, "MINTING_WOULD_EXCEED_MAX_RESERVED_SUPPLY");
