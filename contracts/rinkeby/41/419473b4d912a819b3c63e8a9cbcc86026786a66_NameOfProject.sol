...
contract NameOfProject is ERC721, Ownable {
    using SafeMath for uint256;

    string public TOKEN_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN BANANAS ARE ALL SOLD OUT
    ...
    // Reserve 125 tokens for the team - Giveaways/Prizes etc
    ...
    constructor() ERC721("Project Name", "TICKER") {}
    ...
    // function changeTokenName(uint256 _tokenId, string memory _name) public {
    //     require(
    //         ownerOf(_tokenId) == msg.sender,
    //         "Hey, your wallet doesn't own this token!"
    //     );
    //     require(
    //         sha256(bytes(_name)) != sha256(bytes(tokenNames[_tokenId])),
    ...
    // function viewTokenName(uint256 _tokenId)
    //     public
    //     view
    //     returns (string memory)
    // {
    ...
    // GET ALL TOKENS OF A WALLET AS AN ARRAY OF STRINGS
    // function tokenNamesOfOwner(address _owner)
    //     external
    //     view
    //     returns (string[] memory)
    // {
