...
contract SimpleCollectible is ERC721, Ownable {
    ...
    function batchMint() public onlyOwner payable {
        ...
        string memory url = append("https://gateway.pinata.cloud/ipfs/QmearqU5XrKTE6eCjpPnggxnXcr3qD3TAGmfvbDpmueKnT/metadata-", appendToFourDigits(uint2str(tokenCounter)), ".json");
