...
contract ERC20MintableBurnable is ERC20Standard, ERC20Ownable {
...
contract ERC20Burn is ERC20Standard, ERC20Ownable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) allowed;
    constructor(
        address _owner,
...
import "./ERC20Standard.sol";
import "./ERC20Ownable.sol";
contract ERC20Mintable is ERC20Standard, ERC20Ownable {
