...
contract faFactory is Ownable, ERC721, ERC721Enumerable {
    ...
    /**
     * @dev  Changes the animation and color settings of tokenId
     */
    function changeAnimationNColor (uint16 tokenId, uint32 colorNanimation) public {
        ...
        faArray[tokenId].ColorNAnimation = colorNanimation;
    }
