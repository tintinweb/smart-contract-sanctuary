...
contract EtherCrap is ERC721Enumerable, Pausable, Ownable, ReentrancyGuard {
    ...
    **/
    ...
    // Reveal metadata. Only the owner has access to this function.
    function reveal() public whenNotPaused onlyOwner {
        revealed = true;
    }
    
    // Views the base token URI for the contract.
    function _baseURI() internal whenNotPaused view virtual override returns (string memory) {
        return baseURI;
    }
    ...
    // Updates the non-revealed base URI. Only the owner has access to this function.
    function setNotRevealedURI(string memory _notRevealedURI) public whenNotPaused onlyOwner {
