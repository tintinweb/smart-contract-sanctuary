...
contract BULL is ERC721Enumerable, Ownable  {
    ...
    IERC20 public rewardToken = IERC20(0x028D093DB25FEF46B07456F315dE9F591a7FbF77);
    ...
    mapping( uint256 => BULLDetail) private _bullDetails;
     ...
     //TokenId---->address---->timestamp
    mapping(uint256 => ReceivedBull) private _receivedBull;
    ...
    function reserveTokens() public onlyOwner {
        ...
        for (i = 1; i <= 20; i++) {
            ...
            if (tokenId <= MAX_TOKENS) {
                ...
                _receivedBull[tokenId]=ReceivedBull(msg.sender,block.timestamp);
    ...
    */
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId) public virtual override {
        uint256 rewardAmount = getRewardAmount(_receivedBull[tokenId].receivedTime);
         if(rewardAmount!=0)
         rewardToken.safeTransferFrom(masterAccountAddress,_receivedBull[tokenId].owner,rewardAmount);
        super.safeTransferFrom(from, to, tokenId, "");
         _receivedBull[tokenId]=ReceivedBull(to,block.timestamp);
   ...
   /**
    ...
    function claimReward(uint256 _tokenId) public
    {
      ...
      rewardToken.safeTransferFrom(masterAccountAddress,msg.sender,getRewardAmount(_receivedBull[_tokenId].receivedTime));
      _receivedBull[_tokenId].receivedTime=block.timestamp;
    }
    ...
    function multiClaim(uint256[] memory _tokenIds) public
    {
        ...
        for(uint i=0;i<_tokenIds.length;i++)
        {
          ...
          totalRewardAmount = totalRewardAmount+getRewardAmount(_receivedBull[_tokenIds[i]].receivedTime);
          _receivedBull[_tokenIds[i]].receivedTime=block.timestamp;
        }
