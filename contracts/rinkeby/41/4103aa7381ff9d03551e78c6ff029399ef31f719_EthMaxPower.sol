...
contract EthMaxPower is Context, IERC20, Ownable {
    ...
    string private _name = 'Eth Max Power';
    string private _symbol = 'ETHMAXPOWER';
    ...
    address payable public _marketingWalletAddress = payable(0x1F5d1473F901e2b2b777CfC0dF7BFe44E5588236);
