...
contract LP is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function addLiquidity(uint256 amount) external {
        ...
        // totalReserve decreased by locked Payouts by executing conditions
        _mint(
            msg.sender,
            totalSupply() == 0
                ? amount
    ...
    /**
     * @dev period length stored at router's LP register
     */
...
library Errors {
    ...
    uint256 internal constant WITHDRAW_LIQUIDITY_EXCEEDED_RESERVE = 36;
    uint256 internal constant NOT_STAKE_OWNER = 37;
    uint256 internal constant NO_WIN_NO_PRIZE = 38;
    uint256 internal constant CONDITION_NOT_EXISTS = 39;
    uint256 internal constant INCORRECT_AGREEMENT = 40;
    ...
    uint256 internal constant NOT_ENOUGH_LIQUIDITY = 49;
    uint256 internal constant CONDITION_EXISTS = 50;
    uint256 internal constant NOT_ENOUGH_RESERVE = 51;
    uint256 internal constant START_DATE_ALREADY_SET = 52;
    uint256 internal constant PERIOD_NOT_PASSED = 53;
    uint256 internal constant LP_INIT = 54;

    // Feeder
    uint256 internal constant FEED_ONLY_OWNER = 80;
    uint256 internal constant FEED_SECURITY_VIOLATION = 81;
    uint256 internal constant FEED_PUNISHMENTVALUE_EXCEEDED = 82;
    uint256 internal constant AGREEMENT_FIELDS_MUST_BE_SET = 83;

    // CoreBase
    uint256 internal constant TIME_EXCEEDED = 90;
    uint256 internal constant BIG_DIFFERENCE = 91;
    uint256 internal constant RATE_TOO_SMALL = 92;
    uint256 internal constant EVENT_NOT_HAPPENED_YET = 93;
    uint256 internal constant EVENT_NOT_RESOLVED_YET = 94;
    uint256 internal constant DISPUTE_ALREADY_STARTED = 95;
    uint256 internal constant DISPUTE_NOT_IN_DISPUTE_PERIOD = 96;
    uint256 internal constant DISPUTE_OUTCOME_MUST_BE_DIFFER = 97;
    uint256 internal constant DISPUTE_NOT_STARTED = 98;
    uint256 internal constant DISPUTE_ALREADY_RESOLVED = 99;
    uint256 internal constant DISPUTE_CONDITION_ALREADY_COMPLETED = 100;
}
