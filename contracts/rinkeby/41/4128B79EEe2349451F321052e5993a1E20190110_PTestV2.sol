...
contract PTestV2 is ERC721, Ownable {
  ...
  mapping(address => uint256) public MultiMintBalances;

  uint256 public constant MAX_NFT_SUPPLY = 1000;
  uint256 public constant currentPrice = 200000000000000000; // .2 ETH
  address internal EtherpomsV1;
  ...
  constructor(address _etherpomsV1, address _paymentSplitter)
    public
    ERC721("Etherpoems", "ETHP")
  {
    EtherpomsV1 = _etherpomsV1;
  ...
  // TODO Dev should be able to refund all
  function withdrawFunds() public reentrancyGuard returns (bool success) {
    require(MultiMintBalances[msg.sender] > 0);
    uint256 amount = MultiMintBalances[msg.sender];
    MultiMintBalances[msg.sender] = 0;
