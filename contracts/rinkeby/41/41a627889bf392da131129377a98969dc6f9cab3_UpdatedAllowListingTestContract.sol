...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
    ...
    // File: contracts/updatedAllowListingTestContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract UpdatedAllowListingTestContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Updated Allow Listing Test", "ALLOW", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "http://localhost:5001/nft-rampp/us-central1/app/Z3TTdvH5E5YepvTJUc1h/contract-metadata";
        }
    }