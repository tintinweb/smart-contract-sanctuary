...
contract DragonArena is LockableReceiver { 
    ...
    function initialize(address accessControl, address dragonToken, uint weiFightPrice) public initializer {
    ...
    function updatePrice(uint newFightPrice) public onlyRole(CFO_ROLE) {
        _fightPrice = newFightPrice;
    }
    ...
    function fightInfo(uint fightId) public view returns (FightInfo.Details memory) {
