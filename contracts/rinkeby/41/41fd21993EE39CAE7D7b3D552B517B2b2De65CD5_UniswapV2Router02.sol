...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function removeLiquidityETH(
        ...
        bool bTransfered = IUniswapV2Pair(pair).transferFrom(msg.sender, pair, liquidity);
        require(bTransfered, 'Failed in sending liquidity to pair'); // send liquidity to pair
        (uint256 amount0, uint256 amount1) = IUniswapV2Pair(pair).burnETH(to, address(this));
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex'1297edafbca51b165f5dc253e2f1bb03195f91a3a76901ad988944cb0ee1e461' // init code hash of factory
                    )
                )
            )
        );
