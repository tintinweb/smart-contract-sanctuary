...
contract lottery is VRFConsumerBase, Ownable {
    ...
    function getEntrenceFee() public view returns (uint256) {
        ...
        uint256 costToEnter = (USDEntrenceFee * 10**18) / adjustedPrice;
        return costToEnter;
    }
    ...
    function fulfillRandomness(bytes32 _reauestId, uint256 _randomness)
        internal
        override
    {
        require(
        ...
        require(_randomness > 0, "Randomness is not found");
