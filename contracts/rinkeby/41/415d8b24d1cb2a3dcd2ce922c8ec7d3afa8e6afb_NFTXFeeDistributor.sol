...
contract NFTXFeeDistributor is INFTXFeeDistributor, ReentrancyGuardUpgradeable, PausableUpgradeable {
  ...
  function changeReceiverAlloc(uint256 _vaultId, uint256 _receiverIdx, uint256 _allocPoint) external override virtual onlyOwner {
  ...
  function changeReceiverAddress(uint256 _vaultId, uint256 _receiverIdx, address _address, bool _isContract) external override virtual onlyOwner {
    FeeReceiver storage feeReceiver = feeReceivers[_vaultId][_receiverIdx];
