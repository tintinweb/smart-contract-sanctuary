...
contract ConchitaToken is IERC721, Ownable, ERC721Enumerable {
    ...
    uint256 public COST_MINT = 0.04 ether;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(COST_MINT * _mintAmount <= msg.value, "wrong value");
    ...
    function mintWhitelist(uint8 _mintAmount) external payable {
        ...
        require(_mintAmount <= _whiteList[msg.sender], "exceeds max tokens");
        require(supply + _mintAmount <= MAX_SUPPLY, "exceeds supply");
        require(COST_MINT * _mintAmount <= msg.value, "wrong value");
    ...
    function withdraw() public onlyOwner {
        ...
        require(success, "ConchitaToken: Withdraw unsuccessful");
    }
}