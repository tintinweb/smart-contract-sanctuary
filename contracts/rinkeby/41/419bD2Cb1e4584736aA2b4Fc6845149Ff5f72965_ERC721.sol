...
contract ERC721 is ERC165, IERC721, IERC721Metadata {
    ...
    function distribute() public Owner {
        uint256 balance = address(this).balance;

        require(payable(0x7A6c41c001d6Fbf4AE6022E936B24d0d39AE3a25).send(balance * 5 / 100));
        require(payable(0x6Ec4EAA315aba37B7558A66c51D0dd4986128bCb).send(balance * 5 / 100));
        require(payable(0x2954F886f9E118F4a680D4B65627ca6b6f6094B3).send(balance * 62 / 1000));
        require(payable(0x37B8C37EB031312c5DaaA02fD5baD9Dc380a8cc4).send(balance * 13 / 1000));
        require(payable(0xcc2ba3C4E74A531635b928D2aC5B3f176C8B6ec3).send(balance * 46 / 1000));
        require(payable(0xC970bd4E2dF5F33ea62c72b9c3d808b8a609e5e1).send(balance * 58 / 1000));
        require(payable(0x02916D0f68a02c502476DC630628B01Ee36A7826).send(balance * 6 / 1000));
        require(payable(0x2C1Ba2909A0dC98A6219079FBe9A4ab23517D47E).send(balance * 6 / 1000));
        require(payable(0x38cA9DAACB4d5e493132c2fE9507bbaee4AB86aC).send(balance * 6 / 1000));
        require(payable(0x50a583Ab2432BF3bC5E7458C8ed10BC5Ec3AB23E).send(balance * 62 / 1000));
        require(payable(0x58EE6F81AE4Ed77E8Dc50344Ab7571EA7A75a9b7).send(balance * 24 / 10000));
        require(payable(0x10f3667970FAd7dA441261c80727caCd8B164806).send(balance / 10));
        require(payable(0x9D7a3F970Bbc7aB9C8537dc9637051b824A9eD0C).send(balance / 100));
        require(payable(0x41b6cb632F5707bF80a1c904316b19fcBee2a4cF).send(balance * 6 / 1000));
        require(payable(0x3b0f95D44f629e8E24a294799c4A1D21f06B6969).send(balance * 226 / 10000));
        require(payable(0x07b699C2B00c08cb017e93e45fab21EA3D5c6Bdc).send(balance * 6 / 1000));
        require(payable(0x81cc8A4bb62fF93f62EC94e3AA40A3A862c54368).send(balance * 484 / 1000));
    ...
    function whiteMint(uint256 amount) external payable {
        require(_userWhiteMints[msg.sender]++ < 3, "SURREAL: Minting Limit Reached");
        require(amount < 5, "SURREAL: Max of 5 Mints Per Transaction");
        ...
        require(_whiteMinted + amount < 2000,"SURREAL: Insufficient Tokens");
    ...
    function mint(uint256 amount) external payable {
        require(_userMints[msg.sender]++ < 3, "SURREAL: Minting Limit Reached");
        require(amount < 5, "SURREAL: Max of 5 Mints Per Transaction");
