...
contract AmuletPriceProvider is Ownable {
    ...
    mapping(address => PriceFeedProvider) feed;
    
    event NewOracleAdded(address indexed _amuley, address _provider, uint8 _providerType);
        ...
        onlyOwner 
    {
        ...
        if  (OracleType(_providerType) == OracleType.Uniswap) {
            ...
            require(IUniswapV2Pair(_provider).token0() == WETH || IUniswapV2Pair(_provider).token0() == WETH,
