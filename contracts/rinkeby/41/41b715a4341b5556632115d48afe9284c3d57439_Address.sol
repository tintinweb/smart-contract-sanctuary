...
// File contracts/MetaBunnies.sol
...
contract MetaBunnies is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(address payable fundsTo_, uint256 maxSupply_, uint256 maxPerTx_, uint256 pricePer_) ERC721("MetaBunnies", "METABUNNIES") {
        fundsTo = fundsTo_;
