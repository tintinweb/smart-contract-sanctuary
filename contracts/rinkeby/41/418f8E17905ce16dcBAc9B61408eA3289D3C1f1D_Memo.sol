...
contract Memo is Ownable, ERC721URIStorage {
    ...
    constructor() ERC721("MemoTest", "MEMOTEST") {
        price = 10**18;
        fee = 20;
    }
    ...
    function mint(string memory tokenURI) public onlyOwner {
        execMint(msg.sender, msg.sender, tokenURI);
    }
        ...
        payable
    {
        ...
        execMint(recipient, msg.sender, tokenURI);
    }
    ...
    {
        return (address(this), _salePrice / fee);
    }

    function feeInfo(uint256 _salePrice) external view returns (uint256 _fee) {
