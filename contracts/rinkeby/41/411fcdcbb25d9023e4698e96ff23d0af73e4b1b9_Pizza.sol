...
contract Pizza is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("PizzaOnChain", "PZS") {
        ...
        //Crust Type
        traitTypes[2].push(Trait("Thin","Crust","",0));
        traitTypes[2].push(Trait("Thick","Crust","",0));
        ...
        //Topping 3
        TIERS[6] = [1355, 1400, 1400, 1400];
        
        TIERS[7] = [1355, 1400, 1400, 1400];
        
        
        //Sizes
        traitTypes[7].push(Trait("Nano","Size","",0));
        traitTypes[7].push(Trait("Medium","Size","",0));
        traitTypes[7].push(Trait("Large","Size","",0));
        traitTypes[7].push(Trait("Massive","Size","",0));
     ...
     */
    function bakeReservedPizza() public onlyOwner {
            return mintInternal();
    }
