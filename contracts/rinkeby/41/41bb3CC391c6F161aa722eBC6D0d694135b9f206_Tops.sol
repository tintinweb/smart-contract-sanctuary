...
contract Tops is ERC1155Burnable, ERC1155Supply, ReentrancyGuard, AdminControl {
    ...
    function setRecyclingActive(bool recyclingActive_) external onlyAdmin {
        recyclingActive = recyclingActive_;
    }

    function devMint(address to, uint amount, Tier tier) external onlyAdmin {
