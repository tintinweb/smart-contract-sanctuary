...
contract AgoraS01 is AccessControl, EIP712, ERC721, Ownable {  
    ...
    constructor(address creator, IERC20 token) EIP712("AgoraS01", "1") ERC721("Agora S01", "AGR") {
    ...
    function burn(uint256 tokenId) external onlyRole(BURNER_ROLE) {
        ...
        require(block.timestamp > 1640995200);
        _burn(tokenId);
    ...
    function setDeadline(uint256 deadline) external onlyOwner {
        ...
        if (_deadline != 0) {
            require(
                ...
                "Current deadline has already passed."
            );
        }
