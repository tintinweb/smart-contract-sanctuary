...
contract CnM is ICnM, ERC721Enumerable, Ownable, Pausable {
    ...
    // 0 - 7 are associated with Cats & Crazy Cat Lady, 8 - 15 are associated with Mice
    ...
    constructor(uint256 _maxTokens) ERC721("Cant & Mouse game", "CnM") {
        ...
        // body
        rarities[8] = [100, 80, 177, 199, 255, 40, 211, 177, 25, 230, 90, 130, 199, 230];
        aliases[8] = [4, 3, 3, 4, 4, 13, 9, 1, 2, 5, 13, 0, 6, 12];
        // head
        rarities[9] = [255];
        aliases[9] = [0];
        // spell
        ...
        aliases[10] = [0];
        // eyes
        rarities[11] = [90, 40, 219, 80, 183, 225, 40, 120, 60, 220];
        aliases[11] = [1, 8, 3, 2, 5, 6, 5, 9, 4, 3];
        // neck
        rarities[12] = [255];
        aliases[12] = [0];
        // mouth
        rarities[13] = [239, 244, 255, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234];
        aliases[13] = [1, 2, 2, 0, 2, 2, 9, 0, 5, 4, 4, 4, 4, 4];
        // tail
        rarities[14] = [80, 200, 144, 145, 80, 140, 120];
        aliases[14] = [1, 6, 0, 0, 3, 0, 3];
        // wand
        rarities[15] = [255];
        aliases[15] = [0];
    }
    ...
    */
    ...
    /**
    * Set roll to the Mouse - any game logic should be handled before this function.
    */
