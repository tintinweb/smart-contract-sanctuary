...
contract Demon is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0xC4f842B2Ed481C73010fc1F531469FFB47EE09e9; //J
    address t2 = 0x7F9B1c94DBAb6F3F5299e30eb9f9B8845d45614B; //Kev
    constructor(string memory baseURI) ERC721("Demon World", "Demon") {
    ...
    */
    function mintDemon(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MaxDemonPurchase, "Can only mint 15 tokens at a time");
    ...
    function withdrawAll() public payable onlyOwner {
        uint256 _jacob = address(this).balance * 50/100;
        uint256 _kevy = address(this).balance * 50/100;
        require(payable(t1).send(_jacob));
