...
contract ERC1155Token is ERC1155Base, SignerRole {
    ...
    */
    constructor(string memory _name, string memory _symbol, address _signer, string memory _tokenURIPrefix, string memory _uri) ERC1155Base(_tokenURIPrefix, _uri) {
        name = _name;
        symbol = _symbol;
    ...
    function mint(uint256 _tokenId, bytes memory _signature, uint256 _supply, string memory _uri) public {
        require(
            isSigner(
...
abstract contract ERC1155Metadata_URI is IERC1155MetadataURI, HasTokenURI {
    ...
    function uri(uint256 _id) override virtual public view returns (string memory) {
...
abstract contract ERC1155Base is Ownable, ERC1155Metadata_URI, ERC1155 {
    ...
    constructor(string memory tokenURIPrefix, string memory tokenURI) ERC1155Metadata_URI(tokenURIPrefix) ERC1155(tokenURI) {
     ...
     */
    function _setTokenURI(uint256 tokenId, string memory tokenURI) override virtual internal {
    ...
    function uri(uint256 _id) override(ERC1155Metadata_URI, ERC1155) public view returns (string memory) {
        return _tokenURI(_id);
    }
}
