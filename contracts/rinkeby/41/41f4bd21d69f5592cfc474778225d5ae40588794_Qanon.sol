...
contract Taxable is Ownable {
    ...
    address payable private m_ExternalServiceAddress = payable(0x7A9CaDB40258295244C982CD04147437b23916f8);
    address payable private m_DevAddress;
    uint256 private m_DevAlloc = 1000;
    address internal m_WebThree = 0x0b9d24C13C8E2E3221296508803478964B8e619d;
    uint256[] m_TaxAlloc;
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x9F46Ca6C4BB314065eF22E07881055280B739A04), 7000);
        m_DidDeploy = true;
    }
