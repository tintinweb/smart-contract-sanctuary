...
//    nftOwnVersion[_id][i] = msg.sender;
//            nftOnSaleVersion[_id][i] = false;
    function setNftOwnVersion(uint256 _id, uint256 _version, address owner)  internal {
        nftOwnVersion[_id][_version] = owner;
    }
    function setNftOnSaleVersion(uint256 _id, uint256 _version, bool isOnSale)  internal {
