...
contract xRooStaking {
    ...
    event Staked(address indexed _user, uint256 _stake, uint256 _liqudity);
    event Unstaked(address indexed _user, uint256 _stake, uint256 _liqudity);
        ...
        )
    {
        ...
        emit Staked(_user, _amount, liquidity);
    }
