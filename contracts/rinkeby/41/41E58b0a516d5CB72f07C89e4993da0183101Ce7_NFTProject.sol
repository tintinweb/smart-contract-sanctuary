...
contract NFTProject is ERC721, Ownable, Pausable {
    ...
    function finalizeAuction(uint256 itemID) public returns (bool) {
        ...
        uint256 calculatePlatformRoyality = SafeMath.mul(itemsOnProject[itemID].price, platformRoyality); 
        uint256 calculateCreatorRoyality = SafeMath.mul(itemsOnProject[itemID].price, creatorRoyality); 
