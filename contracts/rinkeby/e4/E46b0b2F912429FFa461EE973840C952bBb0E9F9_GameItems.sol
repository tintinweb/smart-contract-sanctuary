...
// import '/Users/stone/Desktop/CHFRY/node_modules/@openzeppelin/contracts/token/ERC1155/ERC1155.sol';
...
contract GameItems is ERC1155 {
	...
	address[] public participantsCollection;
	...
	modifier onlyAvaiable {
		require(avaiable == true, '!avaiablen');
		_;
	}
	...
	constructor() ERC1155('https://60700aa685c3f0001746f4ca.mockapi.io/api/v1/1') {
		admin = msg.sender;
		_mint(msg.sender, GOLD, 30, '');
	}
	...
	function mint() public onlyAvaiable {
		require(participants[msg.sender] == false, '!no twice mint');
		participantsCollection.push(msg.sender);
