...
contract APG is ContextMixin, ERC721, NativeMetaTransaction, Ownable {
    ...
    function buyAmount(uint256 count) internal {
        require(_tokenSupply.current() + count < MAX_PUBLIC_SUPPLY, "Max Public Supply Reached");
    ...
    function mintMany(uint256 num, address _to) public onlyOwner {
        ...
        require(_tokenSupply.current() + num < MAX_SUPPLY, "Max Supply Reached");
