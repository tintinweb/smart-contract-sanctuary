...
contract OurGirlfriend is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    event Wooed(address indexed _wooer, uint256 _newScore);
    ...
    constructor() ERC721("Our Girlfriend", "OURGF") Ownable() {}
    ...
    function isGfTired() internal view returns (bool) {
        return lastWooed + 60 seconds > block.timestamp;
    }
    ...
    function woo(uint256 tokenId) public nonReentrant { 
        ...
        emit Wooed(_msgSender(), relationshipScores[tokenId]);

        // If your relationship score goes to 30, you become Our GF's soulmate
        if (relationshipScores[tokenId] == 4) {
            soulmate = _msgSender();
