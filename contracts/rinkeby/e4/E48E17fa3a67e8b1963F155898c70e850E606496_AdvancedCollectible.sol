...
contract AdvancedCollectible is ERC721URIStorage, VRFConsumerBase {
    ...
    event breedAssifgned(uint256 indexed tokenId, Breed breed);
    ...
    constructor(
        ...
        bytes32 _keyhash,
        uint256 _fee
    ) VRFConsumerBase(_vrfCoordinator, _linkToken) ERC721("Dogi", "DGC") {
        tokenCounter = 0;
        keyhash = _keyhash;
        fee = _fee;
    }
        ...
        override
    {
        ...
        emit breedAssifgned(newTokenId, breed);
