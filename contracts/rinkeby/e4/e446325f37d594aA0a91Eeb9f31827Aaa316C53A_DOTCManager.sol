...
contract DOTCManager is IdOTC, AdminFunctions, ReentrancyGuard {
     ...
     */
    mapping(uint256 => Order) public takerOrders;
    mapping(uint256 => Offer) public allOffers;
    mapping(address => Offer[]) public offersFromAddress;
    mapping(address => Offer[]) public takenOffersFromAddress;
     ...
     */
    function getOwner(uint256 offer_id) external view override returns (address owner) {
        return allOffers[offer_id].maker;
    }

    /**
     *  @dev getTaker returns the address of the taker
     *  @param order_id uint256 the id of the order
     *  @return taker address
     */
    function getTaker(uint256 order_id) external view override returns (address taker) {
        return takerOrders[order_id].takerAddress;
    }
     ...
     *   @return offer Offer
     */
    function getOffer(uint256 offer_id) external view override returns (Offer memory offer) {
     ...
     *   @return order Order
     */
    function getTakerOrders(uint256 order_id) external view override returns (Order memory order) {
     ...
     *   @return Offer[] memory
     */
    function getOffersFromAddress() public view returns (Offer[] memory) {
        return offersFromAddress[msg.sender];
    }

    function getTakenOffersFromAddress() public view returns (Offer[] memory) {
        return takenOffersFromAddress[msg.sender];
    }
