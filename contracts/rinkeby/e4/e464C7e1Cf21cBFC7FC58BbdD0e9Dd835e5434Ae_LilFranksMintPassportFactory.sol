...
contract LilFranksMintPassportFactory is AbstractMintPassportFactory  {
    ...
    function makeLeaf(string memory _addr) public view returns (bytes32) {
    ...
    function verifyMerkleProofCustom(bytes32[] calldata merkleProof, uint256 mpIndex) public view returns (bool) {
        // if(mintPasses[mpIndex].merkleRoot == 0xb92ca5e8bf9d9857f07e265516244178cf4460f6dc80b3b1f7e060416dc9cb9a){
        //     return true;
        // }
        // string memory leaf = makeLeaf(msg.sender);
        bytes32 node = 0xb994a1338c1886d5ad92db70c75f7a9db276103343fc6da74738ef5bccf191a1;
        return MerkleProof.verify(merkleProof, mintPasses[mpIndex].merkleRoot, node);
    }

    // function showLeaf() public view returns (bytes32) {
    //     bytes32 leaf = makeLeaf(msg.sender);
    //     return leaf;
    // }

    function showRoot(uint256 mpIndex) public view returns (bytes32) {
        return mintPasses[mpIndex].merkleRoot;
    }

    function verifyMerkleProofTest(bytes32[] calldata merkleProof, bytes32 node, bytes32 merkleRoot) public view returns (bool) {
        // if(mintPasses[mpIndex].merkleRoot == 0xb92ca5e8bf9d9857f07e265516244178cf4460f6dc80b3b1f7e060416dc9cb9a){
        //     return true;
        // }
        // // string memory leaf = makeLeaf(msg.sender);
