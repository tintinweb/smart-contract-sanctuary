...
contract SoneToken is ERC20("SoneToken", "SONE"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "SONE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "SONE::delegateBySig: invalid nonce");
        require(now <= expiry, "SONE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "SONE::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "SONE::_writeCheckpoint: block number exceeds 32 bits");
