...
contract ContractsRegistry is IContractsRegistry, AccessControlUpgradeable {
    ...
    bytes32 public constant AAVA_PROTOCOL_NAME = keccak256("AAVA_PROTOCOL");
    ...
    function getAavaProtocolContract() external view override returns (address) {
        return getContract(AAVA_PROTOCOL_NAME);
    }
