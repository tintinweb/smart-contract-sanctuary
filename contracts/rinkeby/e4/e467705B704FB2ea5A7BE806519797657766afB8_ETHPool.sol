...
contract ETHPool is Ownable {
    ...
    function withdrawETH(uint256 poolID) external {
        ...
        uint256 withdrawlAmount = userDeposit_[address(msg.sender)][poolID] + userRewards_[address(msg.sender)][poolID];
        ...
        (bool success, ) = address(msg.sender).call{value:withdrawlAmount}("");
        require(success, "Transfer failed.");
        emit UserWithdrawl(poolID, address(msg.sender), withdrawlAmount);
    }
