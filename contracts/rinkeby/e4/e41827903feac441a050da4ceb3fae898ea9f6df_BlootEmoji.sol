...
contract BlootEmoji is ERC721Enumerable, ReentrancyGuard, Ownable {
    //Loot Contract
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Person #',
                        toString(tokenId),
                        '", "description": "Bloot Emoji describes an abstract person", "image": "data:image/svg+xml;base64,',
    ...
    function mint(uint256 tokenId) public nonReentrant {
        require(tokenId > 8008 && tokenId <= 10000, "Token ID invalid");
    ...
    constructor() ERC721('Bloot Emoji', 'Bloot Emoji') Ownable() {}
}
