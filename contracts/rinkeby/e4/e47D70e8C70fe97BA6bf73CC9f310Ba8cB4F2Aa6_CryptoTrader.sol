...
contract CryptoTrader is ERC721 {
    // ERC721
    string tokenName = "Crypto Trader";
    string tokenSymbol = "TESTCRYPTOTRADER";

    address owner;
    uint256 public tokenCounter;
    address tokenUriProviderAddress;

    constructor(address _tokenUriProviderAddress)
        public
        ...
        returns (string memory)
    {
        ...
        return CryptoTraderInterface(tokenUriProviderAddress).btcTokenURI(); // for Crypto Trader I and .ethTokenUri() for Crypt Trader II
    }
