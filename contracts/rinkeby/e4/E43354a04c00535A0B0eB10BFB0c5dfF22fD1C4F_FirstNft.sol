...
contract FirstNft is  ERC721PresetMinterPauserAutoIdUpgradeable  {
    ...
    function initialize(string memory name, string memory symbol) public initializer {
      ERC721PresetMinterPauserAutoIdUpgradeable.initialize(name, symbol, 'ipfs://');
    }


//    function _hashExists(string memory hash) internal view virtual returns (bool) {
//
////        if(_tokenURIs[hash]) {
////            return true;
////        }
...
//    }
    ...
    function mintNFT(address to, string memory hash) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC721PresetMinterPauserAutoId: must have minter role to mint");

        // TODO - check if hash exsists
//        require(!_hashExists(hash), "IpfsHash already exists");
