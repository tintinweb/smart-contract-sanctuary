...
contract OnlyCam is Context, IERC20, Ownable {
    ...
    address payable public _creatorsWalletAddress;
    ...
    constructor (address payable creatorsWalletAddress) public {
        _creatorsWalletAddress = creatorsWalletAddress;
        _rOwned[_msgSender()] = _rTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x26841A7aa35665934738059b088b776D924D9233);
    ...
    function sendBNBToCreators(uint256 amount) private { 
        swapTokensForEth(amount); 
        _creatorsWalletAddress.transfer(address(this).balance); 
    }
    
    function _setCreatorsWallet(address payable creatorsWalletAddress) external onlyOwner() {
        _creatorsWalletAddress = creatorsWalletAddress;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendBNBToCreators(portionForFees);
