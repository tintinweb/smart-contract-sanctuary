...
contract onkol4 is ERC721, Ownable, RandomlyAssigned {

  using Strings for uint256;
  uint256 public currentSupply = 0;
  uint256 public cost = 3 ether;
  string public baseURI = "ipfs://onkol4/";

  constructor() 
    ERC721("onkol4onkol4", "onkol4")
    RandomlyAssigned(5000,1)
    {
       for (uint256 a = 1; a <= 500; a++) {
            mint(msg.sender);
        }
    }
