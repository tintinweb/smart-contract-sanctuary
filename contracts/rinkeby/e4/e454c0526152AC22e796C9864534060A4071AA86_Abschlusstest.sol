...
contract Abschlusstest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Abschlusstest", "Kriega") {
    setHiddenMetadataUri("ipfs://QmSXkm4Cs68qNx8k9hsFkjL2bApcmHaAsvXx3exC2dbKDz.json");
  }
