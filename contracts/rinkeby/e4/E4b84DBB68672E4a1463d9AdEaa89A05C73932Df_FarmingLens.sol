...
// File: contracts/farming/FarmingInterface.sol
...
// File: contracts/farming/FarmingLens.sol
...
contract FarmingLens is Ownable {
    ...
    function getBalanceOf(address _token, address _account) external
        ...
        balance.tokenBalance = IERC20(_token).balanceOf(_token);
    ...
    function getLPMetadata(address _token) external returns (LPInfo memory info){
        ...
        info.tokenDecimals = ERC20Detailed(_token).decimals();
