...
contract StakingRewards {
     ...
     */
    function closeStaking() external onlyManager {
     ...
     */
    function rewardsToMaintain() public view returns (uint256) {
        uint256 currentBalance = IERC20(stakeToken).balanceOf(address(this));
        return stakingPool.add(stakingPoolRewards).sub(currentBalance);
    }
