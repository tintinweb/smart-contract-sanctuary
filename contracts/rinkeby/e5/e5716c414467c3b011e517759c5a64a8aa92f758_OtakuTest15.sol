...
contract OtakuTest15 is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function allClaim(uint256 tokenId) public nonReentrant {
        require(tokenId > 0 && tokenId < 7778, "Token ID invalid");
    ...
    constructor() ERC721("OtakuTest15", "OtakuTest15") Ownable() {}
}
