...
contract NftMarket is NftMarketBase {
    ...
    */
    function createLoanOfferNFT(NftLoanData.LoanDetailsNFT memory loanDetailsNFT)
        ...
        uint256 maxLtv = this.getMaxLtv(loanDetailsNFT.stakedNFTPrice[index], msg.sender);
    ...
    function nftLoanOfferAdjusted(
        ...
        uint256 maxLtv = this.getMaxLtv(loanOffersNFT[_nftloanIdAdjusted].stakedNFTPrice[index], msg.sender);
    ...
    function nftLoanPaybackBeforeTermEnd(uint256 _nftLoanId) public {
        ...
        for(uint256 i  = 0 ; i  <  loanDetailsNFT.stakedCollateralNFTsAddress.length ; i++){
           ...
           IERC721(loanDetailsNFT.stakedCollateralNFTsAddress[i]).transferFrom(address(this), msg.sender, loanDetailsNFT.stakedCollateralNFTId[i]);
        }   
        ...
        loanDetailsNFT.loanStatus = NftLoanData.LoanStatus.CLOSED;
