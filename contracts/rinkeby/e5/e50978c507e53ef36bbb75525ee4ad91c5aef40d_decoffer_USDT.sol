...
contract decoffer_USDT{
    ...
    IERC20 usdt  = IERC20(address(0xa97A7293001CB73fad5f93c73fdbcF75c9CB5786));
    IERC20 dusdt = IERC20(address(0x63606Db67a3D7e5c9384Eb5a8135F94C7672263e));
    ...
    function deposit(uint usdt_amount)public {
        ...
        user_info[msg.sender][2] = user_info[msg.sender][2].add(dusdt_amount);
    ...
    function get_out_share()public returns(uint){
        token_supply = dusdt.totalSupply().sub(dusdt.balanceOf(address(this)));
        return token_supply;
    } 
