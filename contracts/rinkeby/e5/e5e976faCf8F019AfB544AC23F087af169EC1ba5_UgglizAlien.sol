...
/**
 * @title Uggliz Aliens contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 * @dev Author Katlego Mokala
 * @dev twitter: @bombo_za 
 */
...
import "@openzeppelin/contracts/token/ERC721/ERC721.sol";
 ...
 contract UgglizAlien is ERC721, Ownable {
 ...
 */
  constructor(string memory name, string memory symbol, uint256 maxNftSupply, uint256 saleStart) ERC721(name, symbol) public {
    ...
    function mintApe(uint numberOfAliensMint) public payable {
        require(SALE_IS_ACTIVE, "Sale must be active to mint Ape");
        require(numberOfAliensMint <= MAX_ALIENT_MINT_TX, "Can only mint 20 aliens at a time");
        require(totalSupply().add(numberOfAliensMint) <= MAX_ALIENS, "Purchase would exceed max supply of Apes");
    ...
    function setSTARTING_INDEX() public {
