...
contract CommunityArtMint is Ownable {
    ...
    uint64 constant public NUM_EDITIONS = 10;
    uint64 constant public EDITION_SIZE = 100;

    uint256 public mintPrice = 0.1 ether;

    bool[] public minorMintOngoing = new bool[](NUM_EDITIONS);
    uint8[] public nextMinorId = new uint8[](NUM_EDITIONS);
    uint64[] public seedOfToken = new uint64[](NUM_EDITIONS*EDITION_SIZE);
    ...
    function mintMinor(uint64 edition, uint64 seed) public payable {
        ...
        require(seed >= 1000000000000000000, "Seed phrase to low");
        require(seed <= 9999999999999999999, "Seed phrase to high");
        require(nextMinorId[edition] <= maxMinorId[edition], "All tokens available have been minted");
        
        uint64 tokenId = edition * EDITION_SIZE + nextMinorId[edition];
    ...
    function getTokenBySeed(uint64 seed) public view virtual returns (uint256) {
