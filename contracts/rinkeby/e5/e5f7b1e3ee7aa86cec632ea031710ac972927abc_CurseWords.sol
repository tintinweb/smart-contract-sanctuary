...
contract CurseWords is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 public constant MINT_PRICE = 4269000000000000; //0.004269 ETH
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked(
            ...
            toString(tokenId), 
            '", "description": "Empty Curses (for Assholes) are randomly generated, minimally artistic curse words generated on-chain. They do nothing...? BTW did I mention this is all generated on-chain? Look at the contract. I know you nerds love that shit.", ', 
            metadata, 
    ...
    function daBagz() onlyOwner internal {
