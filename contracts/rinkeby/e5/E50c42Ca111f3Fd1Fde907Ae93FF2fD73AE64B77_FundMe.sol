...
contract FundMe {
    ...
    function fund() public payable {
        ...
        require(getCoversionRate(msg.value) >= minimumUSD, "you need to spend more ETH!"); //if the send didn't send enough momey, the fund would be revesred
    ...
    function getPrice() public view returns (uint256) {
        AggregatorV3Interface priceFeed = AggregatorV3Interface(0x8A753747A1Fa494EC906cE90E9f37563A8AF630e);
       // (uint80 roundId, int256 answer, uint256 started, uint256 updatedAt, uint80 answeredInRound) = priceFeed.latestRoundData();
