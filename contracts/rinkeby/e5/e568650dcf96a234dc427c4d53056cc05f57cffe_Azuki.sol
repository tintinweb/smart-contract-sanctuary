...
contract Azuki is Ownable, ERC721A, ReentrancyGuard {
  ...
  function isPublicSaleOn(
    ...
    uint256 public constant PRICE = 3 * 10**12;
    ...
    function mint(uint256 _count) public payable {
        ...
        require(msg.value >= _price(_count), "Transfer value below price");
        _safeMint(msg.sender, _count);
    }

    function _price(uint256 _count) public pure returns (uint256) {
