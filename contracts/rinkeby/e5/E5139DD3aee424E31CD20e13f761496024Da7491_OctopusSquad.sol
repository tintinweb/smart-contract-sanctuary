...
contract OctopusSquad is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public _saleStartDate = 1639665900; // 16 Dec 14:45 UTC

    address payable treasurer; // withdraw to
    uint256 public discountTokensCount = 50;
    uint256 public discountTokenPrice = 0.01 ether; // 20 Matic for first 1000 octopuses
