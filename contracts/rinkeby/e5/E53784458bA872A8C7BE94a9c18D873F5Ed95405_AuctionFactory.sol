...
contract AuctionFactory is IAuctionFactory, IERC721Receiver {
    ...
    function createAuction(
        ...
        auctions[auctionId].startBlockNumber = _startBlockNumber;
        auctions[auctionId].endBlockNumber = _endBlockNumber;
        auctions[auctionId].resetTimer = _resetTimer;
        auctions[auctionId].numberOfSlots = _numberOfSlots;
        auctions[auctionId].supportsWhitelist = _supportsWhitelist;
    ...
    function depositERC721(
        ...
        if (auctions[auctionId].supportsWhitelist) {
            require(
                auctions[auctionId].whitelistAddresses[depositor] == true,
        ...
        auctions[auctionId].slots[slotIndex].auctionId = auctionId;
        auctions[auctionId].slots[slotIndex].slotIndex = slotIndex;
        auctions[auctionId].slots[slotIndex].nfts.push(item);
