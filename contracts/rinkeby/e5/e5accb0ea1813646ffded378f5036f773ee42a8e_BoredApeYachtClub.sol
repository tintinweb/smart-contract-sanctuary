...
contract BoredApeYachtClub is ERC721, Ownable {
     ...
     */
    function reserveApes(uint amount) public onlyOwner {        
    ...
    */
    ...
    function setPrice(uint256 _newPrice) public onlyOwner {
        apePrice = _newPrice;  // old: 80000000000000000
    }

    // Change format
    function setPresaleLimit(uint256 _newLimit) public onlyOwner {
        preSaleLimit = _newLimit;  // old: 80000000000000000
    }
    ...
    */
    ...
    /**
    * Mints Bored Apes for whitelisted users
    */
