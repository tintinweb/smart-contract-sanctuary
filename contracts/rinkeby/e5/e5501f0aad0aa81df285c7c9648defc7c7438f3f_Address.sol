...
contract UnitedPunksUnion is ERC721, Ownable {
   ...
   function mintUNITEDPunksUnion(uint256 numPunks) public payable {
        require(totalSupply() < MAX_UNITEDPUNKSUNION, "Sale has already ended");
        require(numPunks > 0 && numPunks <= 20, "You can adopt minimum 1, maximum 20 United Punks Union");
        require(totalSupply().add(numPunks) <= MAX_UNITEDPUNKSUNION, "Exceeds MAX_UNITED PUNKS UNION");
