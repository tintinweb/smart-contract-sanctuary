...
contract ControlledAccess is Ownable {
    address public signerAddress = 0x5b2dd4138B38377590432B4ec777463Ac35D86B6;
    ...
    */
        ...
        view public returns (bool)
    {
        ...
        bytes32 sigSha = keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", hash));
        address sig =  ecrecover(
            sigSha,
            _v,_r,_s
        );

        require(signerAddress == sig, "Signer address does not match");
...
contract SODA is Delegated, ERC721EnumerableB, ControlledAccess, PaymentSplitter {
  ...
  address[] private addressList = [
    ...
    0x30A8Bac5AED69b9fF46d4fC04A48388cDe5D3A59, // Drew - Real
  ...
  function presaleMint( uint quantity, bytes32 _r, bytes32 _s, uint8 _v )
  ...
  external payable {
    ...
    require(currentBalance + quantity <= maxOrder, "Order exceeds presale limit" );
  ...
  function setPresaleActive(bool isPresaleActive_) external onlyDelegates{
