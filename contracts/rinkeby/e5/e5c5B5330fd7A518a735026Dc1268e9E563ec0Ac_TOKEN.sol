...
contract TOKEN is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private amountSoldTrack;
    mapping (address => uint256) private amountBlockToSellNext;
    uint256 limitToSellBeforeBlockCooldown = 50000000000000 * 10**9;
    ...
    mapping (address => Limiter) public _Limit;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);       // TODO - change this to the actual router
    ...
    function _transfer(
        ...
        require(amountBlockToSellNext[from] >= block.number,"You have sold too much, try to sell again in 1000 Blocks.");
    ...
    function recordLimit (address _addr, uint256 _amount, uint256 _block) public {
        _Limit[_addr] = Limiter(_amount, _block);
    }
