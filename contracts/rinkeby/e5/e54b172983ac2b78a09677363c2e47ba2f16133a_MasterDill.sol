...
contract Gauge is ReentrancyGuard {
    ...
    IERC20 public constant PICKLE = IERC20(0xa9B2A3B87fDc5fDaFE116048e569E4EfBAcaa9FF);
    IERC20 public constant DILL = IERC20(0x4d0b039a53194e187aB9c453EB4c016Cab409A07);
    address public constant TREASURY = address(0x113D107Ae6a16A4B8D262918244d759cA3090676);
...
contract GaugeProxy is ProtocolGovernance {
    ...
    MasterChef public constant MASTER = MasterChef(0xa740f6eA13d7602a607d3DFD28110E5309C8547f);
    IERC20 public constant DILL = IERC20(0x4d0b039a53194e187aB9c453EB4c016Cab409A07);
    IERC20 public constant PICKLE = IERC20(0xa9B2A3B87fDc5fDaFE116048e569E4EfBAcaa9FF);
