...
// File: contracts/Synergy.sol

pragma solidity ^0.8.7;

contract Synergy is ERC721Enumerable, Ownable {
    ...
    uint256 public              buyBackPrice        = 0.075 ether;
    uint256 public              buyBackLimit        = 5;

    uint256 public constant     MAX_PER_TX          = 10;
    uint256 public constant     RESERVES            = 50;
    uint256 public constant     priceInWei          = 0.075 ether;
    ...
    function buyBackTotal() public view returns (uint256) {
        return _buyBackTracker._value;
    }
