...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase, Ownable {
        ...
        override
    {
        ...
        uint256 dicksize = ((randomNumber % 10000) / 100 );
        uint256 comfyness = ((randomNumber % 1000000) / 10000 );
        uint256 mememagic = ((randomNumber % 100000000) / 1000000 );
        uint256 autism = ((randomNumber % 10000000000) / 100000000 );
        uint256 racism = ((randomNumber % 1000000000000) / 10000000000);
        ...
        )
    {
        return (
            ...
            characters[tokenId].rarity + characters[tokenId].dicksize + characters[tokenId].comfyness + characters[tokenId].mememagic + characters[tokenId].autism + characters[tokenId].racism,
            getLevel(tokenId),
        ...
        )
    {
        return (
            ...
            characters[tokenId].dicksize,
            characters[tokenId].comfyness,
            characters[tokenId].mememagic,
            characters[tokenId].autism,
            characters[tokenId].racism,
            characters[tokenId].experience
        );
    }
