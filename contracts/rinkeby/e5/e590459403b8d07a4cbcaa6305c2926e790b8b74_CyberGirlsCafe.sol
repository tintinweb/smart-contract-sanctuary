...
contract CyberGirlsCafe is IERC165, ERC721Metadata, ERC721Enumerable, Ownable {
    ...
    string public constant PROVENANCE = "0xF57B2c51dED3A29e6891aba85459d600256Cf317";
    ...
    function mint(uint256 count) external payable {
        require(_mintState == 2, "Public mint is not allow");
    ...
    function presaleMint(uint256 count) external payable {
        require(_mintState == 1, "Whitelist mint is not allow");
