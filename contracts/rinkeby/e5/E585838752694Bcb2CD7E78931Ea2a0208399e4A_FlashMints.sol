...
contract FlashMints is ERC721, Ownable {
    ...
    address public a1 = 0x57ccEFe8fDD9F2B17B9dD148061ae9a5f3a7e767;
    address public a2 = 0x80f039085f78fFF512a1edE6d25eC64927392888;
    address public a3 = 0x1E815a8188F1b84564577C1c998f7E6B4706B752;
    address public a4 = 0x607502216Cfe3bFe8407Ee5Ef62e9A4cFEfcb66C;
    address public a5 = 0x11b99B09B02cB833f1A12EeFbcEB5930B82172B5;
    ...
    function withdrawTeam() external onlyOwner {
        ...
        require(payable(a1).send((balance * 1) / 100));
        require(payable(a2).send((balance * 3) / 100));
        require(payable(a3).send((balance * 75) / 1000));
        require(payable(a4).send((balance * 10) / 100));
        require(payable(a5).send((balance * 785) / 1000));
    }
