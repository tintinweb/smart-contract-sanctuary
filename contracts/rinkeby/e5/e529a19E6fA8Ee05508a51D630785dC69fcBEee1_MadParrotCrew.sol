...
//   _______     _       _______     _______      ___    _________  // 
//  |_   __ \   / \     |_   __ \   |_   __ \   .'   `. |  _   _  | //  
//    | |__) | / _ \      | |__) |    | |__) | /  .-.  \|_/ | | \_| // 
//    |  ___/ / ___ \     |  __ /     |  __ /  | |   | |    | |     // 
//   _| |_  _/ /   \ \_  _| |  \ \_  _| |  \ \_\  `-'  /   _| |_    // 
//  |_____||____| |____||____| |___||____| |___|`.___.'   |_____|   // 
...
// File: contracts/MPC.sol

pragma solidity ^0.8.7;

contract MadParrotCrew is ERC721Enumerable, Ownable {
    ...
    uint256 public constant     priceInWei          = 0.060 ether;
    ...
    function whitelistMint(uint256 count, bytes32[] calldata _merkleProof) public payable {
        ...
        require(addressToMinted[_msgSender()] + count <= 5, "Exceeds maximum mint per wallet"); 
