...
contract Mugshots is ERC721, ERC721URIStorage, Ownable {
  ...
  address dopeDaoAddress;

  constructor() 
    ERC721("Hustler Mugshots", "MUGSHOT") 
  {
    metadataBaseUrl = 'https://rebel.fun/dope-wars/collectibles/';
    rebelAddress = 0x440DAA861400Bf754B83121479Bf26895F1Df7C4;
    dopeDaoAddress = 0x440DAA861400Bf754B83121479Bf26895F1Df7C4;
  }
  ...
  function withdraw() public onlyOwner {
    ...
    uint256 daoBalance = (address(this).balance / 100) * 5;
  
    payable(dopeDaoAddress).transfer(daoBalance);
