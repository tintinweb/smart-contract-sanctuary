...
contract SoccerPunks is ERC721, Ownable {
    ...
    uint256 public price = 2500000000000000; // 0.025 Ether
    ...
    function adjustPrice() private {
        ...
        if(totalSupply > 2500 && totalSupply < 4999 && price != 3500000000000000){
            price = 3500000000000000;
        }
        else if(totalSupply > 5000 && totalSupply < 7499 && price != 4500000000000000){
            price = 4500000000000000;
        }
        else if(totalSupply > 7500 && totalSupply < 9999 && price != 5500000000000000){
