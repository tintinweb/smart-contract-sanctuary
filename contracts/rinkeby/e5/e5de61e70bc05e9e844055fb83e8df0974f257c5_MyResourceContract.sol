...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/myResourceContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MyResourceContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("My resource", "MYRSC", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/achTOPOLVBPZ7v6mlI0L/contract-metadata";
        }
    }