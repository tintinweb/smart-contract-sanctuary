...
// File: AdvanceCollectable.sol

contract AdvanceCollectable is ERC721, VRFConsumerBase {
    ...
    mapping(uint256 => Faction) public tokenIdToFaction;
    event requestedCollectable(bytes32 indexed requestId, address requester);
    event factionAssigned(uint256 indexed tokenId, Faction faction);
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
        ...
        override
    {
        Faction faction = Faction(randomNumber % 4);
        uint256 newTokenId = tokenCounter;
        tokenIdToFaction[newTokenId] = faction;
        emit factionAssigned(newTokenId, faction);
