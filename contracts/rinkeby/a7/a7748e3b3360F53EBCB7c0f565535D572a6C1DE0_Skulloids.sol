...
abstract contract ERC721PresetMinterPauserAutoId is Base, Context, ERC721Burnable, ERC721Pausable, IERC721Mintable {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(address platformSettings, string memory name, string memory symbol, string memory baseURIValue) public Base(platformSettings) ERC721(name, symbol) {
