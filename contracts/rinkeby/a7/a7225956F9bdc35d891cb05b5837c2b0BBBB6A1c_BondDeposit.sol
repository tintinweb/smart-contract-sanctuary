...
interface ITreasury {
    ...
    function deposit( uint _amount, address _token, bool _stake ) external returns ( uint );

    function depositEth( uint _amount, bool _stake ) external payable returns ( uint );
}
