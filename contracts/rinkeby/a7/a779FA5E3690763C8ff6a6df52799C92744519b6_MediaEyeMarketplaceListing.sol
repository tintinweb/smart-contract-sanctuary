    ...
    ReentrancyGuard
{
    ...
    event ListingPaymentAdded(
        uint256 listingId,
        MediaEyeOrders.ListingPayment listingPayment
    );
    event ListingCreated(
        uint256 listingId,
        string label,
    ...
    event ListingNftAdded(uint256 listingId, MediaEyeOrders.Nft nft);
    ...
    function createListing(
        ...
        for (uint256 i = 0; i < _listingPayments.length; i++) {
            ...
            emit ListingPaymentAdded(listingId, _listingPayments[i]);
        }
        ...
        for (uint256 i = 0; i < _nfts.length; i++) {
            ...
            emit ListingNftAdded(listingId, _nfts[i]);
        }
