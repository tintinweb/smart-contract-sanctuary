...
interface INFTLegends is IERC721Enumerable {
    function isMintedBeforeReveal(uint256 index) external view returns (bool);
}

/**
 * @title NFTLegends contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract NFTLegends is Context, Ownable, ERC165, INFTLegends, IERC721Metadata {
    ...
    // This is the provenance record of all NFTLegends artwork in existence
    ...
    // Time after which NFTLegends are randomized and allotted
    ...
    // Mapping from token ID to whether the NFTLegends was minted before reveal
    ...
    */
    ...
    /**
     * @dev Gets current NFTLegends Price
     */
