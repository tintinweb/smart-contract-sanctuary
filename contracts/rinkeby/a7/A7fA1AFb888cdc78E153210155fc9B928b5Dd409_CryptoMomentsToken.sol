...
contract CryptoMomentsToken is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable, Pausable, PaymentSplitter, ReentrancyGuard {
  ...
  address[] private _team = [0x2F8D0A89F59a69fC42ab51B09CdD692eF1c64721];
  ...
  function _baseURI() internal override pure returns (string memory) {
    return "ipfs://Qmet9Rhi9inAQcaeQytmENCRtrpYGPPtjLpzziCGUyc4kK/";
  }
  ...
  function mintMultipleTokensForPrivateSale(uint256 _amount) public payable nonReentrant {
    require(privateSale, "Team sale must be active to mint as a team member");
    require(totalSupply() < 100, "Exceeded tokens allocation for team members");
    require(_privateSaleAddresses[address(msg.sender)], "Not a team member");
