...
contract BadWolf is Context, ERC721Enumerable, ERC721Burnable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory name, string memory symbol, address _t1, address _t2, address _t3, address _t4) ERC721(name, symbol) {
		t1 = _t1;
		t2 = _t2;
		t3 = _t3;
		t4 = _t4;
  ...
  function withdrawAll() external payable {
    ...
    _withdraw(t1, (balance * 25) / 100);
    _withdraw(t2, (balance * 22) / 100);
    _withdraw(t3, (balance * 20) / 100);
    _withdraw(t4, (balance * 33) / 100);
  }
  ...
  function tokenURI(uint tokenId) public view virtual override returns (string memory) {
    ...
    return _baseURISet == true ? string(abi.encodePacked(_baseTokenURI, uintToBytes(tokenId))) : "ipfs://QmPrgdWq4CNRj7zTX7GBzcCrwE1bfAnn5UDK6y7D3rFCqJ";
  }
