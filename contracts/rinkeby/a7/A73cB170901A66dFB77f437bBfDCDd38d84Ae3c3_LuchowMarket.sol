...
// File: contracts\LuchowMarket.sol
...
contract LuchowMarket is Ownable, ERC721Holder {
	...
	function initialize(
        ...
        createCollection("LUCHOWNFT", "https://ipfs.io/ipfs/QmRxreUQ3uxJAxdK8DyabzFxjSZgx8eFCtEBA3dem3227J", true);		
	}    
	...
	function createCollection(string memory _name, string memory _uri, bool bPublic) public returns(address collection) {
        ...
        ILuchowNFT(collection).initialize(_name, _uri, msg.sender, bPublic);
