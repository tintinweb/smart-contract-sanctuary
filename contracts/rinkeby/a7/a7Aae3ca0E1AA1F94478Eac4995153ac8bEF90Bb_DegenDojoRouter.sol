...
contract DegenDojoRouter is VRFConsumerBase {
     ...
     */
    function initiateSpinTradeWithERC20(IERC20 token, uint256 amount) public {
        ...
        //get the pair to trade from uniswap factory
        IUniswapV2Pair pair = IUniswapV2Pair(
            factory.getPair(address(token), weth)
        );
        //check that the pair exists
        require(address(pair) != address(0), "No pair available for swap!");
