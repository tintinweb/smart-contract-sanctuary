...
contract EnglightenedOwlCouncil is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public constant MAX_OWLS = 8888;
    uint256 public constant PRICE = 0.05 ether;
    uint256 public constant MAX_PER_MINT = 10;
    uint256 public constant PRESALE_MAX_MINT = 5;
    uint256 public constant MAX_OWLS_MINT = 20; // per address
    uint256 public constant RESERVED_OWLS = 100;
    ...
    constructor(string memory baseURI) ERC721("EnglightenedOwlCouncil", "EOC") {
