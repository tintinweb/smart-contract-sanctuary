...
contract SharkSociety is ERC721, ERC721Enumerable, Ownable {
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0x4d7183Eb8A51FE8803c8c38Bf989E659Bd4536AA).transfer(balance.mul(10).div(100));
        payable(0x8A7fA1106068DD75427525631b086208884111a5).transfer(balance.mul(20).div(100));
        payable(0x0Cf7d58A50d5b3683Fd38c9f3934723DeC75A3c0).transfer(balance.mul(25).div(100));
        payable(0xfc9DA6Edc4ABB3f3E4Ec2AD5B606514Ce1DE0dA4).transfer(balance.mul(30).div(100));
        payable(0xD7cFc0D803fB6276d00755e04bf2fD251f66b444).transfer(balance.mul(15).div(100));
    }
