...
contract SamuraiDoge is ERC721, Ownable {
    ...
    uint256 public apePrice; //0.08 ETH
    ...
    */
    function flipFinalSaleState(uint256 price) public onlyOwner {
        apePrice = price;
    ...
    * Pause sale if active, make active if paused
    */
    function flipPreSaleState(uint256 price) public onlyOwner {
        apePrice = price;
    ...
    * Pause sale if active, make active if paused
    */
    function flipPrimarySaleState(uint256 price) public onlyOwner {
        apePrice = price;
