...
contract Revolue is ERC721,ERC721URIStorage,ERC721Enumerable, Ownable {
   using Counters for Counters.Counter;
    ...
    function withdraw() public onlyOwner {
        ...
        address _devWallet = 0x06b639618826CE6882556e15b834E86913b3fDd9;
        payable(_devWallet).transfer((_balance * 2)/10);
        
        address _devWallet2 = 0x06b639618826CE6882556e15b834E86913b3fDd9;
