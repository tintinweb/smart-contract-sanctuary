...
contract AlphaStrategy is Pausable, AlphaToken {
    ...
    uint256 public ALPHA_PRICE = 1;
    uint256 public ALPHA_PRICE_WAVG = 1;

    // withdrawals
    uint256 public LOCKUP_PERIOD = 1 hours; // 1 hour for testing purposes
    ...
    function updatePortfolioValue(uint256 _nav) external onlyManager {
        NAV = _nav;
        ALPHA_PRICE = NAV / totalSupply() * COEFF_SCALE_WEI;
    ...
    function deposit(uint256 _amount) external whenNotPaused {
        ...
        uint256 _alphaAmount = _amount / ALPHA_PRICE * COEFF_SCALE_WEI;
    ...
    function withdrawalRequest(uint256 _amount) external whenNotPaused {
        require(
        ...
        uint256 _amountStable = _amount * ALPHA_PRICE / COEFF_SCALE_WEI;
    ...
    function withdraw() external whenNotPaused {
        ...
        _alphaToken.transferFrom(msg.sender, address(this), _amountLP);
        _stableToken.transferFrom(address(this), msg.sender, _amountStable);
