...
contract Edworm is Ownable, ERC721Enumerable {
	...
	constructor() ERC721('Edworm', 'WORM') {
		...
		meta[
			'desc0rig'
		] = "The Worm is on a mission through the Ethereum blockchain, leaving a permanent trail along the way. Help him on his journey by passing him along.";
		meta[
			'descHolo'
		] = "I've left this beautiful Hologram of myself as a memento of our special time together. You cannot transfer, sell, or burn it. Why would you even want to? Best Wishes. - The Worm.";
