...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase, Ownable {
    ...
    function getCharacterOverView(string memory)
        public
        view
        returns (
            string memory
        ...
        )
    {
        return ( "test"
            ...
            characters[tokenId].hat + characters[tokenId].body + characters[tokenId].mouth + characters[tokenId].intelligence + characters[tokenId].wisdom + characters[tokenId].charisma,
            getLevel(tokenId),
