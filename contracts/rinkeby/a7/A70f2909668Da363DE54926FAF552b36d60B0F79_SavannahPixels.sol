...
contract SavannahPixels is ERC721Enum, Ownable {
  ...
  string _initNotRevealedUri = "http://savannahpixelsnft.com/hidden.json";
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool s, ) = payable(0x3d025dF1652716290Dc42Ffe326F94aA0Dfd2e26).call{value: address(this).balance * 5 / 100}("");
    require(s);
