...
contract TrustMultipleV2 is Initializable,ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable {
    event Approve(
    ...
    function initialize() public initializer {
        ERC1155Upgradeable.__ERC1155_init("", "NIFTMultiple", "NIFTY");
        __Ownable_init();
         _tid = 1;
        serviceValue = 2500000000000000000;
        addTokenType("DETH",0x4d514AD816db95B92F33C24A131c05e320398dA0);
    }
    ...
    function NewchangePrice(uint256 value, uint256 tokenId) public{
        require( _balances[tokenId][msg.sender] > 0, "Is Not a Owner");
        require( value < order_place[msg.sender][tokenId].price);
        order_place[msg.sender][tokenId].price = value;
        emit ChangePrice(msg.sender, tokenId, value);
