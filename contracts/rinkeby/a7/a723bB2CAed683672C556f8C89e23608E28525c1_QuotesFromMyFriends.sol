...
/// @title ERC-721 Non-Fungible Token Standard, optional enumeration extensicon
...
/// @author William Entriken (https://phor.net)
contract BaseNFT is ERC721, ERC721Metadata, ERC721Enumerable {
    ...
    {
        _tokenURI = "ipfs://QmWGrUL4cKWyGvZYFPQhZCvir96o513nYHK1iLQepQiS35/nfttest/000001.json";
        bytes memory _tokenURIBytes = bytes(_tokenURI);
        _tokenURIBytes[62] = bytes1(uint8(48+(_tokenId / 100000) % 10));
        _tokenURIBytes[63] = bytes1(uint8(48+(_tokenId / 10000) % 10));
    ...
    function tokenByIndex(uint256 _index) override external pure returns (uint256) {
    ...
    uint256 private constant TOTAL_SUPPLY = 22;
    ...
    constructor() {
        ...
        // unnecessary at deployment time
         _tokensOfOwnerWithSubstitutions[address(this)] = new uint256[](TOTAL_SUPPLY);
...
/// @author William Entriken (https://phor.net)
contract SuPromo is AccessControl, BaseNFT {
...
/// @author William Entriken (https://phor.net)
contract SuVending is BaseNFT {
    uint256 constant SALE_PRICE = 500; // 0.5 Ether
...
/* QuotesFromMyFriends.sol *****************************************************************/

/// @title The features that deed owners can use
/// @author William Entriken (https://phor.net)
contract QuotesFromMyFriends is AccessControl, BaseNFT, SuVending, SuPromo {
    constructor()  {
    }
}