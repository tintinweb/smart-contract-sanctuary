...
contract DichoStudio0xCarat is ERC721, IERC2981, ReentrancyGuard, Ownable {
    ...
    constructor(address _openSeaProxyRegistryAddress) ERC721("Dicho Studio 0xCarat", "CRT") {
