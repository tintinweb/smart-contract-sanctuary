...
contract DojoRouter is VRFConsumerBase, Ownable {
    ...
    function claimTrade() public {
        ...
        require(
            address(house).balance / 5 >=
                AddressToPendingTrade[address(msg.sender)]._amount
        );
...
contract DojoHouse is ERC20("DojoLiquidity", "DLP") {
    ...
    function spinTrade(
        ...
        //multiply the trade size by the DLP-ETH ratio
        uint256 what = (msg.value * totalSupply()) /
            (address(this).balance - msg.value);
        //mint 1% of the value to the treasury and bar
        _mint(treasury, what / 100);
        _mint(bar, what / 100);
