...
contract DegenerativeArt is AccessControlUpgradeable, ERC721BurnableUpgradeable, ERC721EnumerableUpgradeable, UUPSUpgradeable {
    ...
    CountersUpgradeable.Counter private _nextId;

    function _authorizeUpgrade(address) internal override onlyRole(DEFAULT_ADMIN_ROLE) {}

    function initialize(string memory newBaseURI) public initializer {
        __AccessControl_init();
        __ERC721_init("Degenerative ART", "DGEN");
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721EnumerableUpgradeable, AccessControlUpgradeable, ERC721Upgradeable) returns (bool) {
