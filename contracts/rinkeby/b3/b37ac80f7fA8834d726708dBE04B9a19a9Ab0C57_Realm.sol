...
contract Realm is ERC721, ERC721Enumerable, IERC721Receiver, ReentrancyGuard, Ownable {
    ...
    function increaseSupply(uint256 additional, uint256 price) external onlyOwner {
	...
	function increaseSupplyAndMint(address to, uint256 count) external payable nonReentrant onlyOwner {
        require(SUPPLY_INDEX == SUPPLY_LIMIT, "Limit not reached");
	    require(SUPPLY_LIMIT + count <= MAX_SUPPLY - CREATOR_RESERVED, "Max supply");
		GENERATION += 1;
	...
	function claimCreator(address to, uint256 count) external onlyOwner {
...

{
  ...
  "libraries": {
    "/contracts/Realm.sol": {
      "Util": "0xf62ec2383648c6dc0B13cc893B9b9c15613cE9bA"
    }
  },
  "outputSelection": {
    "*": {
