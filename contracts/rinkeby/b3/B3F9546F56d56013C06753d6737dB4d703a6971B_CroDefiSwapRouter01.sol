...
contract CroDefiSwapRouter01 is ICroDefiSwapRouter01 {
    ...
    function swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, CroDefiSwapLibrary.pairFor(factory, path[0], path[1]), amounts[0]);
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) public pure override returns (uint amountIn) {
        return CroDefiSwapLibrary.getAmountOut(amountOut, reserveIn, reserveOut);
    }
