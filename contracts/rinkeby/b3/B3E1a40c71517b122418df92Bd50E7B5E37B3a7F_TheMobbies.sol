...
contract TheMobbies is ERC721Enumerable, Ownable {
   ...
   constructor(
    ...
    function mint(uint256 _mintAmount) public payable notPaused minimumMintAmount(_mintAmount) {
        ...
        require(addressMintedBalance[msg.sender] + _mintAmount <= maxMintAmount, "You can not mint more than 50 Mobbies");   
     ...
     function _generateRandomId() private returns (uint256) {
        uint256 totalSize = maxSupply/2 - totalSupply();
