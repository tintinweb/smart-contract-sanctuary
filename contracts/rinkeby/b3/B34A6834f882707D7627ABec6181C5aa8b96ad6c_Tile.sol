...
contract Tile is ERC721 {
    ...
    function mint(uint256 id) public {
        uint256[100] memory colors;
        TileInfo memory tile = TileInfo('', '', colors);
        tiles[id] = tile;
    }

    function setInfo(uint256 id, string memory title, string memory ownerURL, uint256[100] memory colors) public {
