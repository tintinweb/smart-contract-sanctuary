...
contract DarkEchelon is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Dark Echelon", "DARK"){}
    ...
    function mint(uint256 numNFTs) public payable onlyOwner {
        ...
        require(totalSupply() + numNFTs < publicSupply, "Exceeds retail supply");
