...
contract CryptoGladsReborn is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public TOTAL_SUPPLY = 10000;

    uint256 public gladPrice = 10000000000000000;
    ...
    function reserveGLADs() public onlyOwner {
    ...
    function mintGLADsTo(address _to, uint numberOfTokens) public payable {
        ...
        require(_currentTokenId.add(numberOfTokens) <= TOTAL_SUPPLY, "Purchase would exceed max supply");
