...
import "./redeem/ERC721/ERC721BurnRedeem.sol";
import "@openzeppelin/contracts/utils/Strings.sol";
import "@openzeppelin/contracts/utils/introspection/ERC165.sol";

contract C is AdminControl, ERC721BurnRedeem, ICreatorExtensionTokenURI  {
    ...
    function tokenURI(address creator, uint256 tokenId) external view override returns (string memory) {
        ...
        uint256 metadataId = (MAX + 1) - _mintNumbers[tokenId];
        return string(abi.encodePacked((API_BASE_URL), metadataId.toString()));
    }
}
