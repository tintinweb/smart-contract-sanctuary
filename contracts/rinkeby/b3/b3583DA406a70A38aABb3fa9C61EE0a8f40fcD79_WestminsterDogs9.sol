...
// File: contracts/WestminsterDogs9.sol
...
contract WestminsterDogs9 is ERC721Enumerable, Ownable {  
  DC private dc;
  ...
  function adoptDog(uint256 dcTokenId) public {
    ...
    require(dcTokenId < maxDogs, "Requested tokenId exceeds upper bound");
