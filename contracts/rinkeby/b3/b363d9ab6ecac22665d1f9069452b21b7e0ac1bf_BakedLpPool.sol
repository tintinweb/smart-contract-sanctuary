...
contract LPTokenWrapper is Ownable {
    ...
    function getStakes(uint256 _stakeid) view public returns (uint256, uint256, uint256, address, bool,bool) {
        return (_stakeid,Stakemap[_stakeid].amount, Stakemap[_stakeid].timestamp, Stakemap[_stakeid].walletaddress,Stakemap[_stakeid].iswhitelisted,Stakemap[_stakeid].stakeStatus);
    }
