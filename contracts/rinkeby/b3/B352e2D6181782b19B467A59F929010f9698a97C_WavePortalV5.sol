...
contract WavePortalV5 is Initializable {
  ...
  function wave(string memory _message, string memory _uri) public {
    // spam prevention
    ...
    wavesV5.push(WaveV5(msg.sender, _message, block.timestamp, _uri));
  ...
  function getAllWaves() view public returns(WaveV5[] memory) {
    return wavesV5;
  }
  ...
  function getAllUris() view public returns(string[] memory) {
