...
contract JuraNFT is ERC721Tradable {
    ...
    uint256 public powerPerBlock = 1200 * (10**15);
        ...
        ERC721Tradable("JurassicNFT", "JUR", _proxyRegistryAddress)
    {
        ...
        heightOnClaimBegin = block.number + 6636 * 30;
    }
    ...
    function baseTokenURI() public view override returns (string memory) {
        return metaURI.concat("api/creature/");
    }

    function contractURI() public view returns (string memory) {
        string memory mURI = metaURI;
        string memory api = "contract/opensea-creatures";
