...
contract TheMetaverse is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = .004 ether; // change price per unit
  ...
  constructor(
    ...
    mint(msg.sender,5); // Must be lower than line 1231 | This is how many is minted FREE to owner upon deployment
  }
