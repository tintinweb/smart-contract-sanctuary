...
contract Bridge is Ownable, ReentrancyGuard {
    ...
    uint public dailyTokenWithdrawLimitPerAccount = 100_000e8;
    uint public constant CHAIN_ID = 4;
    uint public constant ONE_DAY = 24 hours;
    
    address public constant TRUSTED_TOKEN_ADDRESS = 0x729C996c122d05D7907d0D654447b33B0A75444e;
    address public verifyAddress = 0x652157BBf0193a6c0eA8c5e2FD5a036A291EB9d1;
