...
contract MyEpicNFT is ERC721URIStorage {
    ...
    function makeAnEpicNFT() public {
        ...
        // Ensure only 50 nfts can be minted
        require(newItemId < 50, "Fresh out of NFT's!");
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                ...
                combinedWord,
                '", "description": "A highly coveted arrangement of occupations.", "image": "data:image/svg+xml;base64,',
