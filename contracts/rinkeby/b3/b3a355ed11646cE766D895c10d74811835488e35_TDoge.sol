...
/**
 * @title TestDoge contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */


contract TDoge is ERC721Burnable {
    using SafeMath for uint256;

    uint256 public mintPrice;
    uint256 public maxMintAmount;
    uint256 public MAX_TDOGE_SUPPLY;
    ...
    constructor() ERC721("Test Doge", "TDG") {
        MAX_TDOGE_SUPPLY = 3500;
    ...
    */
     ...
     * Mint Doges by owner
     */
    function reserveDoges(address to, uint256 numberOfTokens) external onlyOwner {
        require(to != address(0), "Invalid address to reserve.");
        require(currentMintCount.add(numberOfTokens) <= MAX_TDOGE_SUPPLY, "Reserve would exceed max supply");
    ...
    */
    function mintDoges(uint256 numberOfTokens) external payable {
        ...
        require(currentMintCount.add(numberOfTokens) <= MAX_TDOGE_SUPPLY, "Purchase would exceed max supply");
