...
contract Collection is ERC1155, AccessControl {
    ...
    function _withStones(address buyer) private {
        uint256 stones = stone.rewardedStones(buyer); //rewardedPoints olarak değiştir!!!!!!!!!!!!!!!!!!!
...
contract MoneyHandler is Context,Ownable {
   ...
   // uint256 public amu = 1;
    ...
    function redeem (address[] memory payees, uint256 [] memory sharePerc_) public onlyOwner {
        ...
        require(_totalAmount > 0,"redeem: insufficient funds");
        ...
        require(_totalAmount >= totalShareAmount, "redeem: the total amount in the contract must be equal to or greater than the amount to be withdraw"); 
