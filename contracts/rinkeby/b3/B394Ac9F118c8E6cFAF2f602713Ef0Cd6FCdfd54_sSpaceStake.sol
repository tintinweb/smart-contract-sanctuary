...
contract sSpaceStake is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked SpaceStake", "sSPST", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSPST supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSPST
