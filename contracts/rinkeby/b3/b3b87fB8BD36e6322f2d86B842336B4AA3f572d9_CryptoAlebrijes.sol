...
// File contracts/CryptoAlebrijesDNA.sol

pragma solidity ^0.8.0;

contract CryptoAlebrijesDNA {
    ...
    function _getDNASection (uint8 _dna, uint8 _rightDiscard) internal pure returns (uint8){
        return uint8(
...
// File contracts/CryptoAlebrijes.sol
...
contract CryptoAlebrijes is  ERC721, ERC721Enumerable, CryptoAlebrijesDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("CryptoAlebrijes", "ALBRJS") {
    ...
    function mint() public {
        ...
        require(current < maxSupply, "No Crypto Alebrijes left");
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "Crypto Alebrijes #',
                tokenId.toString(),
                '", "description": "Crypto Alebrijes are randomized alebrije created not for humans beigns, is 100% machine art", "image": "',
                image,
                '"}'
            ) 
        );
