    ...
    ReentrancyGuard
{
    ...
    // Events
    event AuctionCreated(uint256 indexed id, address indexed nftContract, uint tokenId, address creatorAddress,uint creatorShare, uint openEditionPrice,uint minBidIncrement,uint duration,uint durationIncrement);
    event AuctionBid(
        uint256 indexed id,
        bool oneOfOne,
        uint256 amount,
    ...
    function createAuction(
        ...
        // Emit event
        emit AuctionCreated(auctionId, nftContract,tokenId,creatorAddress,creatorShare,openEditionPrice,minBidIncrement,duration,durationIncrement);
    }
