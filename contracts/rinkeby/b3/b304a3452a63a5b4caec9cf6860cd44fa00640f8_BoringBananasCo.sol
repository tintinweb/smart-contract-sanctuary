...
contract BoringBananasCo is ERC721, Ownable {
    ...
    uint256 public constant rulerPrice = 80000000000000000; // 0.08 ETH

    uint public constant maxRulerPurchase = 100;
    ...
    // Reserve 100 Rulers for team - Giveaways/Prizes etc
    uint public rulerReserve = 100;
    
    event bananaNameChange(address _by, uint _tokenId, string _name);
    
    event licenseisLocked(string _licenseText);

    constructor() ERC721("Rulers of the Sea", "RoS") { }
    ...
    function mintRuler(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_RULERS, "Purchase would exceed max supply of Bananas");
