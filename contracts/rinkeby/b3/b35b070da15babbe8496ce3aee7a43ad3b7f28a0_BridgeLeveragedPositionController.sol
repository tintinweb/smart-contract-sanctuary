...
contract BridgeLeveragedPositionController is AbstractController {
    ...
    function callUnstake() external override onlyIndex returns (uint256) {
        ...
        uint256 _bmiXAmount = leveragedPortfolio.getAvailableBMIXWithdrawableAmount(address(this));
        //all or nothing
        require(_bmiXAmount == bmiXToken.balanceOf(address(this)), "BridgeLeveragedPositionController: BLPC6");
    ...
    function _sellBMI(uint256 _amount) internal returns (uint256 _baseAmount) {
        ...
        _baseAmount = _swapTokenForToken(_amount, _priceFeed.bmiToken(), _priceFeed.daiToken());
