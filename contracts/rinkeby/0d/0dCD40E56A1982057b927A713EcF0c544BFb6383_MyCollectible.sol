...
interface IMyCollectible is IERC721 {
    /**
...
import "./ERC721.sol";
import "./IMyCollectible.sol";
import "./Ownable.sol";
import "./IProxyRegistry.sol";

contract MyCollectible is Ownable, ERC721, IMyCollectible {
    ...
    uint256 public immutable maxAmountPerMint = 10;
    ...
    /// @notice Creates MyCollectible NFTs, stores all the required parameters.
    ///  contractURI_ Collection URI with collection metadata.
    ///  baseURI_ Collection base URI prepended to each tokenURI.
//    constructor(string memory contractURI_, string memory baseURI_) ERC721("MyCollectible", "MYC1") {
 //       contractURI = contractURI_;
  //      baseURI = baseURI_;
   // }

    constructor() ERC721("MyCollectible", "MYC1") {
        contractURI = "https://api.baconclub.io/contract";
        baseURI = "https://api.baconclub.io/nfts/";
    }
    ...
    /// @dev Function for minting multiple tokens
