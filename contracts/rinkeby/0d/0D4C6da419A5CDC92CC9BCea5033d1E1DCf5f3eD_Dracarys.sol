...
contract Dracarys is Context, IERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 9000 * 10**9;

    //test accounts
    address public charityWallet = 0xf88aDf5d4C08D9B88E4A7CFC1d1023C79c5c2D2B;
    address public marketingWallet = 0x9139144a4690A7Dbe48f604561Ecd63606Fe001d;
    address public dracWallet = 0x7A8321403CF8C93e00B9930656493334e6a455a0;

    // address public marketingWallet = 0x6d9b2E1B8F7144D673E1B33c021794652d7F1B43;
    // address public charityWallet = 0x95938133445DF1783B0Aa8F0bA9b01Ca0f5BC811;
    // address public dracWallet = 0x86CcBfb75A05CD22e33646Bb74cFE84418D46529;
    ...
    function airDrops(address[] calldata newholders, uint256[] calldata amounts) external onlyOwner(){
        uint256 iterator = 0;
    ...
    function claimTokens () public onlyOwner {
        distributeShares(address(this).balance);
    }
    ...
    function checkSwap() public view returns (bool) {
        ...
        return (overMinTokenBalance && !inSwapAndLiquify);
    }
