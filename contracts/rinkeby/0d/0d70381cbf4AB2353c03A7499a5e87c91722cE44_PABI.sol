...
contract PABI is ERC721Enumerable, Ownable {
	...
	string private baseUri = "https://test.com/base/";
	string private contractUri = "https://test.com/contract";
	string private beforeRevealUri = "https://test.com/unreveal";
	...
	constructor() ERC721("PABI Test", "TEST") {}
