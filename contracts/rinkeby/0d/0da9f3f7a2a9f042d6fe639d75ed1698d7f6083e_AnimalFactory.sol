...
contract AnimalFactory is Ownable
{
   ...
   { 
     ...
     **/ 
    function claimFreeAnimalFromAnimalFactory( string animalName, string animalDesc, string urilink) public
    {
     ...
     **/ 
    function MintAnimalsFromAnimalFactory(string animalName, string animalDesc, string urilink) public payable 
    {
        require (!isContractPaused);
    ...
    function mateAnimal(uint parent1Id, uint parent2Id, string animalName,string animalDesc) public payable 
    {
        ...
        // the owner fees 
        uint OwnerPercentage=animalAgainstId[parent1Id].priceForMating.mul(ownerPerHundredShareForMating);
        OwnerPercentage=OwnerPercentage.div(100);
    ...
    **/  
    ...
    { 
		...
		animalAgainstId[animalId].urilink=urilink;
        token.setAnimalMeta(animalId, urilink);
    }
