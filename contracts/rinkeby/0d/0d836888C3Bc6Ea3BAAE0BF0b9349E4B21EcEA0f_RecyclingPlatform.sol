...
contract RecyclingPlatform is Context, AccessControlEnumerable {
    ...
    */
    ...
    function exchangeRCL(address client, uint256 amountRCL) public payable {
        exchangeRCLgeneral(client, amountRCL, payable(msg.sender));
    }

    function exchangeRCLplatform(address client, uint256 amountRCL) public payable {
        exchangeRCLgeneral(client, amountRCL, payable(address(this)));
    }

    function exchangeRCLgeneral(address client, uint256 amountRCL, address payable ethSender) internal {
