...
contract decoffer_V2{
    ...
    Credit_token CT = Credit_token(0x5C5c41e9d3078744Fe9AaD9Aa77B4B6281A7a072);
    recommender RT = recommender(0xAC11BDF1c32975b2ac6B6295df1fDF3cF5237077);
    ...
    //1.invest 2.price 3.credit 4.get_CT 5.discount 6.Has_been_claim 7.performance
    ...
    function bouns(address _user , uint rt_ct_amount)private{
        ...
        for(uint i=1; i<=3; i++){
            ...
            coffer_info[rt][7] = coffer_info[rt][7].add(bonus);
        }
    }
