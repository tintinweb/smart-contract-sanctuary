...
contract Planeto is ERC721, Pausable, PaymentSplitter, Ownable {
    ...
    constructor(address _proxyRegistryAddress, address _communityWallet, address[] memory payees, uint256[] memory shares_) ERC721("Planeto", "PLTO") PaymentSplitter(payees, shares_) {
