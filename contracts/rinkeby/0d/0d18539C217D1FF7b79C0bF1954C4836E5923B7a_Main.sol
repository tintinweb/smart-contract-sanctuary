    ...
    VRFConsumerBase
{
    ...
    uint128 public PUBLIC_MINT_LIMIT = 8;
    ...
    address private _treasury = 0x42327eD1d94BA956cf82842B28e4f0262cC0d36c; //TODO: update for mainnet
    // LINK
    ...
    constructor(
        ...
        payable
        ERC721Sequencial("TeddyBearSquad", "TBS")
        Pausable()
...
contract RewardToken is ERC20, ERC20Pausable, ERC20Burnable, Ownable {
    ...
    // Only callable by the erc721 contracts on mint/transferFrom/safeTransferFrom.
