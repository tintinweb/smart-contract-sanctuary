...
contract HEROZ is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("HEROZ", "HEROZ") {
    }
    ...
    function reserveTokens() public onlyOwner {
        ...
        require(supply < 30, "More than 30 tokens have already been reserved or minted.");
        uint i;
        for (i = 0; i < 100; i++) {
