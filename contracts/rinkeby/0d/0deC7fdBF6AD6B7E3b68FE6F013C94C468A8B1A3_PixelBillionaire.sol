...
contract PixelBillionaire is ERC721EnumerableB, Ownable, PaymentSplitter {
    ...
    // string public _baseTokenURI="https://ipfs.pixelbillionaire.com/token/";
    string public _baseTokenURI;
    string public baseExtension = '.json';
    uint256 public reserved = 100;
    uint256 public mintPrice = 0.04 ether;
    uint256 public presaleSupply = 888;
    ...
    // Merkle root generated for whitelisting. WHitelisted addresses must provide merkle proof in order to mint presale.
    bytes32 public wlMerkleRoot = 0xdfbbafde06e3f540e4da2ff751ab56e2e9f9f418d96c74d9bbbcdc44b7caf3c8;
    bytes32 public ogMerkleRoot = 0xdf73116724cbd034759c0d3af1cb6e91abfc75d4f2ef4a023c6b38048708377c;
    
    address[] private payees = [
        // 0xe339d5bE1d2E9059F0B3a6a8BE45e43722dd0f6B, //team1
        0x5B38Da6a701c568545dCfcB03FcB875f56beddC4,
        0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2, //team2
        0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db, //team3
        0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB //team4
        // 0xe339d5bE1d2E9059F0B3a6a8BE45e43722dd0f6B, //Me
        // 0xF7479D33746bbaf8B47C31151F13345E757e00bc, //PQ
        // 0xD5a7E317ab12351833dCEb2E0f57d870A4aeB89f, //Jobel
        // 0xA49eF8D3A12dc10dB603Daa5A1E75c6ff2A2652D, //Jessica
    ];
    ...
    function mint(uint256 _mintQty) public payable {
        ...
        require( _mintQty < 8, "You can only mint a maximum of 7 PXLB" );
        
        uint256 supply = totalSupply();
        require( supply + _mintQty < maxSupply - reserved + 1, "Sold out!" );
    ...
    function premint(uint256 _mintQty, bytes32[] calldata _WLmerkleProof, bytes32[] calldata _OGmerkleProof) public payable {
        require(presaleOpen, 'Presale not open');

        bytes32 leafNode = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(_WLmerkleProof, wlMerkleRoot, leafNode), "Your address is not whitelisted");

        require(_mintQty < 4, 'Exceeded presale transaction limit');
        require(_mintQty < 4 - presaleMintedAmount[msg.sender], 'Your address has already claimed your presale mints');
       
        uint256 supply = totalSupply();
        // require(supply + _mintQty < presaleSupply + 1, 'Sold out!');
        require(msg.value >= mintPrice * _mintQty, 'Ether sent is not correct');

        if (MerkleProof.verify(_OGmerkleProof, ogMerkleRoot, leafNode) && _mintQty >= 2) {
            // Free NFT for OGs if they mint at least 2
        ...
        // Free NFT don't count in presale allocated amount per address
        presaleMintedAmount[msg.sender] = presaleMintedAmount[msg.sender] + _mintQty;
    }

    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount < reserved + 1, "Exceeds reserved PXBL supply" );
