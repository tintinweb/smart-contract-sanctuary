...
contract Tarot is ERC721Enumerable, ReentrancyGuard, Ownable {
	...
	function drawCard(uint256 tokenId) public view returns (string memory) {
		string memory output = tarotCards[random() % tarotCards.length];
		return output;
	}
	...
	function tokenURI(uint256 tokenId) override public view returns (string memory) {
		...
		parts[1] = drawCard(tokenId);
		parts[2] = '</text><text x="10" y="40" class="base">';
		parts[3] = drawCard(tokenId);
		parts[4] = '</text><text x="10" y="60" class="base">';
		parts[5] = drawCard(tokenId);
		parts[6] = '</text><text x="10" y="80" class="base">';
		parts[7] = drawCard(tokenId);
		parts[8] = '</text><text x="10" y="100" class="base">';
		parts[9] = drawCard(tokenId);
		parts[10] = '</text><text x="10" y="120" class="base">';
		parts[11] = drawCard(tokenId);
		parts[12] = '</text><text x="10" y="140" class="base">';
		parts[13] = drawCard(tokenId);
		parts[14] = '</text></svg>';
	...
	constructor() ERC721("Tarotology", "TAROT") Ownable() {}
}
