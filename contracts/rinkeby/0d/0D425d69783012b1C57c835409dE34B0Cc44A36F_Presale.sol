...
contract Presale is Ownable {
    ...
    function buy() public payable {
        require(isActive == true, "Presale has not yet started!");
...
abstract contract ERC20Rug is ERC20Capped, ERC20Pausable, Ownable {
    function _beforeTokenTransfer(
        address from,
        address to,
        uint256 amount
    ) internal virtual override(ERC20Capped, ERC20Pausable) {
    ...
    function disablePause() external virtual;
