import "./BaseArbitrage.sol";
import "./interfaces/IUniswapV2Router02.sol";

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

contract EthArbitrage is BaseArbitrage {
    using SafeMath for uint256;

    IUniswapV2Router02 uniswapRouter;
    address public uniswapRouterAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

    constructor(address tokenAddressBasic, address tokenAddressStable) BaseArbitrage(tokenAddressBasic, tokenAddressStable) {}
...
contract BaseArbitrage is Ownable {
    using SafeMath for uint256;
