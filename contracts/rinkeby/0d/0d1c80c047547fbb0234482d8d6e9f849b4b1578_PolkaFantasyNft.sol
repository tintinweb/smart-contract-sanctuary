...
// File: contracts/PolkaFantasyNft.sol

pragma solidity ^0.5.11;


/**
 * @title PolkaFantasyNft
 * PolkaFantasyNft - a contract for my semi-fungible tokens.
 */
contract PolkaFantasyNft is ERC1155Tradable {
  ...
  ERC1155Tradable(
    ...
    _setBaseMetadataURI("https://polkafantasy.v1.staging.riochain.io/api/v1/creature/");
  }

  function contractURI() public view returns (string memory) {
    return "https://polkafantasy.v1.staging.riochain.io/api/v1/erc1155";
  }
}