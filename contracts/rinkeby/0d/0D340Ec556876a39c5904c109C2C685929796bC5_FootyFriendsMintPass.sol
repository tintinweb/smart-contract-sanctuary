...
// File: contracts/FootyFriendsMintPass.sol
...
/**
 * @title FootyFrensMintPass
 * FootyFrensMintPass - a contract for the FootyFrens MintPass
 */
 
contract FootyFriendsMintPass is ERC1155Tradable {
    ...
    function mint(uint256 _quantity, uint256 _id) public payable {
        ...
        require(_quantity > 0, "Number Of Tokens cannot be 0.");
        require(
