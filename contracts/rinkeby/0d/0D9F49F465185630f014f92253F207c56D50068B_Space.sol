...
contract Space is ERC721Enumerable, Ownable {
    ...
    string constant preRevealImageUrl = 'ipfs://Qma1CQepRezX6kAuw3YDdCx23qNUQdaDbXccQfgLRdp8iG';
    string public revealedCollectionBaseURL;
    bool public frozen;

    event Mint(address indexed owner);

    constructor() ERC721('Space TEST', "Space") {
    }
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        bytes memory tokenName = abi.encodePacked('Space #', Strings.toString(_tokenId));
        ...
        if (keccak256(abi.encodePacked(revealedCollectionBaseURL))  == keccak256(abi.encodePacked(''))) {
            ...
            content = abi.encodePacked(content,
                ...
                ', ',
                '"attributes": [{"trait_type": "Background", "value": "Banana Bay"}, {"trait_type": "Surfboard", "value": "USA"}]',
