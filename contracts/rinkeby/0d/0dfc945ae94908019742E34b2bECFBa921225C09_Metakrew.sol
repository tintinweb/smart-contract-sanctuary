...
contract Metakrew is ERC721Enumerable, Ownable, IMerkleDistributor {
   ...
   // This is a packed array of booleans.
    ...
    function remainderClaim (address account, uint256 amountToClaim) external {
        require(claimIsActive, "Claim must be active to mint Krew");
        require(block.timestamp <= deadline, "The claiming time has passed.");
        ...
        claimKrew(amountToClaim, account);
    }
