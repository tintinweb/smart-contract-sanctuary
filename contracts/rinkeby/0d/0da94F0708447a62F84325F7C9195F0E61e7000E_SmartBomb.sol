...
contract SmartBomb is ERC721, Ownable {
    using Strings for uint256;
    ...
    string public uriPrefix =
        "ipfs://QmV425jZyevtXBXSWFhdW6K6Yxgj8xSWD7hDLXcHYfqisZ";
    ...
    // remember to add '0x' at in front
    bytes32 public merkleRoot =
        0xcf1591e52e0ddcd84db9ff1a14646247a6dfffd77802ddba3d1a1440093be0c7;
    mapping(address => bool) public whitelistClaimed;

    constructor() ERC721("SmartBomb", "SM01") {
        setHiddenMetadataUri(
            "ipfs://QmW5q1fCpe7kGNigpnx7Jm522bVQMcZEhTB5bzpK95JoVb/hidden.json"
        );
    }
