...
contract OOTest is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PER_PRESALE_PURCHASE = 5; // TODO: Change this before mainnet deployment
    ...
    // Payout addresses
    address private constant _otterJef = 0x814d3e874B2Ec6287D742cC1b8A77a1648f4e3ba; // Founder
    address private constant _otterPico = 0x86190c50d1dD3Eeb2Ab1dbb8E7195F2195AF321f; // Solidity dev
    address private constant _otterSpenser = 0xf1cD6C7a5944129E0edDBcc625f447A38a230a6a; // Artist
    ...
    address[4] private _shareholders = [_otterJef, _otterPico, _otterSpenser, _otterCommunity];
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        _shares[_otterJef] = 4000;
        _shares[_otterPico] = 1000;
        _shares[_otterSpenser] = 4000;
        _shares[_otterCommunity] = 1000;
    }
    ...
    function presaleMint(bytes32 hash, bytes memory sig, string calldata nonce, uint256 qty) external payable nonReentrant {
        ...
        require(hashTransaction(msg.sender, nonce) == hash, "Hash check failed");
        require(qty > 0, "Quantity cannot be zero");
        require(msg.value == (salePrice * qty), "Incorrect payment amount");
