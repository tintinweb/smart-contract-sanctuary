...
import "./interfaces/IERC20MetadataTest.sol";
 ...
 */
contract ERC20Test is Context, IERC20Test, IERC20MetadataTest {
     ...
     */
    constructor(
        uint256 initialSuplly_,
        string memory name_,
        string memory symbol_
    ) {
        _name = name_;
        _symbol = symbol_;
        _initialSupply = initialSuplly_;
    }
    ...
    function initialSupply() public returns (uint256) {
         _mint(msg.sender, _totalSupply);
...
interface IERC20MetadataTest is  IERC20Test {
