...
contract Jigsaw1BadgeContract is ERC1155, Ownable {
    ...
    Counters.Counter private totalTokenIds;
    uint256 public totalToken0Minted = 0;
    uint256 public MAX_FINAL_PUZZLE_PICTURE_NUMBER;
    // uint256 public constant JIGSAW_PIECES = 1;

    mapping( address => mapping ( uint256 => bool)) public hasMintedFinalPicture;
    ...
    constructor() ERC1155(baseURI) {
        // _mint(msg.sender, JIGSAW_FINAL_PICTURE, 2, "");
        // _mint(msg.sender, JIGSAW_PIECES, 1, "");
        addMinter(msg.sender);
        totalTokenIds.increment(); //already 0 tokenId generated.
    }
    ...
    function mintFinalPicture(address _account) public onlyMinter{
        require(!hasMintedFinalPicture[_account][JIGSAW_FINAL_PICTURE], 'JBC: Final jigsaw puzzle picture already minted for this account');
        _mint(_account, JIGSAW_FINAL_PICTURE, 1, '');
        // finalPictureTokenIds.increment();
        totalToken0Minted += 1;
        hasMintedFinalPicture[_account][JIGSAW_FINAL_PICTURE] = true;
    }
