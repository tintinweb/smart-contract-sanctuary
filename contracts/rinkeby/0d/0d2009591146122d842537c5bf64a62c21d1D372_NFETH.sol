...
contract NFETH is ERC721, ERC721Enumerable, Ownable {
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    Colors.Color memory base = Colors.fromSeedWithMinMax(c0seed, 1, 359, 100, 100, 50, 100);
    ...
    string memory bg = Colors.fromSeedWithMinMax(string(abi.encodePacked(colorSeed, "BACKGROUND")), 200, 350, 60, 90, 1, 10).toHSLString();
