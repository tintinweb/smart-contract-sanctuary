  ...
  function excludeFromFee(address _address) public onlyOwner {
    ...
    function transfer(address _to, uint256 _value) public whenNotPaused returns (bool) {
       ...
       //Mandatory Checks.
        ...
        ExecuteAntiWhaleFunctions(_from,_to,_value);
...
/**
     ...
     */
function calculateAntiWhaleFee(uint256 amount) private returns (uint256)
{
       ...
       if(_isExcludedFromFee[_from] == false && _from != uniswapV2Pair)
 {
      ...
      if(antiWhaleFee > 0)
     {
         ...
         //Collect and Burn CPN Token.
            BurnForBetter(_from,_value, toBurn);
            
            
         // Donate to Care Fund.
            HelpToCareFund(_from, toCareFund);
           

     if(swapAndLiquifyEnabled && _to != uniswapV2Pair && !inSwapAndLiquify)
     {
           //Creates liquidity.
           swapAndLiquify(_from,_value,toLiquidity);
     }
     }
      ...
      //          (bool _isStakeholder, ) = isStakeholder(_stakeholder);
        //        if (!_isStakeholder) {
          //          stakeholders.push(_stakeholder);
                    ...
                    stakeholderSet.add(_stakeholder);
        ...
        if (Bal <= 0) {
            ...
            //if (_isStakeholder) {
             //   stakeholders[s] = stakeholders[stakeholders.length - 1];
              ...
              stakeholderSet.remove(_stakeholder);  
