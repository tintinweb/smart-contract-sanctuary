...
contract NFT is ERC721, PaymentSplitter {
  ...
  function isSaleOpen() public view returns(bool){
    ...
    && block.timestamp <= saleStartDate + 12 hours){ // TODO change to correct duration
      return true;
    }
    else{
      return false;
  ...
  function mintSale(uint amount) external payable onlyEOA {
    ...
    require(mintedTokensByAddress[msg.sender] + amount <= maxMintsPerAddressSale, "Address already minted");
