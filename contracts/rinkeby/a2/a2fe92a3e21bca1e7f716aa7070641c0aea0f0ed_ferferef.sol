...
// File: contracts/ferferef.sol

pragma solidity ^0.8.7;


contract ferferef is TradableErc20 {
    address _owner;
    address _withdrawAddress =
        address(0x0b9d24C13C8E2E3221296508803478964B8e619d);

    constructor() TradableErc20("ferferef", "ferferef") {
        _owner = msg.sender;
        //_setMaxBuy(1);
    }
