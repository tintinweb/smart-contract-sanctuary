...
contract Swap is OwnableUpgradeable {
    ...
    mapping(address => mapping(address => TransactionList)) internal transactions;
        ...
        returns (uint256 receiveAmount, uint256 blockNumber)
    {
        ...
        receiveAmount = _amount.mul(rate);
        ...
        )
    {
       TransactionInfo memory transactionInfo = transactions[_user][_token]
        ...
        return (transactionInfo.timestamp,transactionInfo.swapAmount,transactionInfo.receiveAmount);
    }
}
