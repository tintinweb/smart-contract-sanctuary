...
contract AvatarMinter is Ownable, ContextMixin {
    ...
    function redeemAvatar(uint256 tokenId, bytes32[] memory proof) public {
        ...
        require(proof.verify(merkleRoot, keccak256(abi.encodePacked(msg.sender))), "AvatarMinter: Not Allocated");
    ...
    function batchRedeemAvatars(uint256[] calldata tokenIds, bytes32[] memory proof) public {
        uint256 tokenId;
        //bytes32[] memory proof;
        address minter = msg.sender;
        
        require(proof.verify(merkleRoot, keccak256(abi.encodePacked(minter))), "AvatarMinter: Not Allocated");
