...
contract GoodOneBid is Ownable, Pausable, GoodOneBidStorage {
    ...
    */
        ...
        returns (bytes4)
    {
        ...
        Bid memory bid = _getBid(msg.sender, _tokenId);
        ...
        require(
            goodOneToken.transfer(_from, price.sub(saleShareAmount)),
    ...
    */
    function withdraw(address _withdrawAddress, uint256 _amount) external onlyOwner {
        ...
        require(
            goodOneToken.transferFrom(address(this), _withdrawAddress, _amount),
            "Withdraw failed"
        );       
    }
