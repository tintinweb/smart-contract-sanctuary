  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x1df6Ab1a08cEb3e179902B41330848A57e68eD4E);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 4408');
    ...
    // File: contracts/krohnsContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract KrohnsContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Krohns", "KON", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/ayaF7X8zYLZeuJA8KJiA/contract-metadata";
        }
    }