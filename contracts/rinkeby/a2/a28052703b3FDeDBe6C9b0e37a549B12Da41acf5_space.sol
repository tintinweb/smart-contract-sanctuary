...
contract space is Initializable, ERC721EnumerableUpgradeable, OwnableUpgradeable, PausableUpgradeable {
  ...
  address payable constant platformAddress = payable(0x6A5d132e80f3d22D03546297eB308eAc7F6EeFeE);
  ...
  function initialize(string memory _name, string memory _symbol, uint256 _maxTokens, uint256 _tokenPrice, address _artistFundsAddress) public initializer {
    ...
    artistAddress = owner(); // initialize to the deployer address
  ...
  function _generalMint(address _recipient) internal {
    ...
    artistFundsAddress.transfer(artistAmount);
  }
