...
contract  BLOCKGAMECAPITAL  is ERC721Enumerable, Ownable
{
    ...
    uint public  hotelSupply =1000;
    uint public  mansionSupply =88;
    uint public  apartmentSupply =3000;
    uint public  townHouseSupply =5800;
    ...
    function mansionMint(uint chosenAmount) public payable {
        ...
        require(totalSupply()+chosenAmount<=mansionSupply,"Quantity must be lesser then MaxSupply");
        ...
        require(isPaused == false, "Sale is not active at the moment");
        require(totalSupply()+chosenAmount<=hotelSupply,"Quantity must be lesser then MaxSupply");
        require(chosenAmount > 0, "Number of tokens can not be less than or equal to 0");
        require(chosenAmount <= maxQuantity,"Chosen Amount exceeds MaxQuantity");
        ...
        require(isPaused == false, "Sale is not active at the moment");
        require(totalSupply()+chosenAmount<=apartmentSupply,"Quantity must be lesser then MaxSupply");
        require(chosenAmount > 0, "Number of tokens can not be less than or equal to 0");
        require(chosenAmount <= maxQuantity,"Chosen Amount exceeds MaxQuantity");
        ...
        require(isPaused == false, "Sale is not active at the moment");
        require(totalSupply()+chosenAmount<=townHouseSupply,"Quantity must be lesser then MaxSupply");
        require(chosenAmount > 0, "Number of tokens can not be less than or equal to 0");
        require(chosenAmount <= maxQuantity,"Chosen Amount exceeds MaxQuantity");
        if(townHouseeSupply()>=4589)
        {
