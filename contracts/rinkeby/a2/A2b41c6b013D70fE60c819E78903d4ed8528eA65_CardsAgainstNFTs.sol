...
contract CardsAgainstNFTs is ERC721, ERC721URIStorage, Ownable {
        ...
        returns (string memory) 
    {
        ...
        parts[2] = '; font-family: serif; font-size: 14px; } .footer { fill: ';

        parts[3] = string(abi.encodePacked(textColor));

        parts[4] = '; font-family: serif; font-size: 8px; }</style><rect width="100%" height="100%" fill="';
        
        parts[5] = string(abi.encodePacked(bg));
        
        parts[6] = '" /><text x="10" y="20" class="base">';

        parts[7] = cardInfo.text;

        parts[8] = '</text><text x="10" y="120">';
