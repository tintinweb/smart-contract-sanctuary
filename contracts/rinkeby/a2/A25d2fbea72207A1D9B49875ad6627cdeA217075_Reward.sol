...
contract Reward is Ownable {
    ...
    receive() external payable {
        ...
        uint256 tValue = (msg.value * _config.ratio) / _config.totalSupply_100;
        uint256 oValue =  msg.value - (_config.totalSupply * tValue);
    ...
    constructor (
        ...
        _config.totalSupply_100 = totalSupply * 100;
    ...
    function claimToken(uint256 tokenId) public returns (bool) {
        require(_config.enableClaim,  "claim temporarily disabled"); //FIXME
    ...
    */
    function claimTokens(uint256[] calldata tokenIds) public returns (bool) {
        ...
        for (i = 0; i < tokenIds.length; i++) {
            tmpAmount               = _tBalance - _tClaimed[tokenIds[i]];
            amounts[i]              = tmpAmount;
            totalAmount            += tmpAmount;
            _tClaimed[tokenIds[i]] += tmpAmount;
        }
