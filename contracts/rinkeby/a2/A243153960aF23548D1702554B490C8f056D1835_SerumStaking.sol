...
contract SerumStaking is ERC1155, IERC1155Receiver, IERC721Receiver, Ownable, ReentrancyGuard, Pausable {
    ...
    function mintSerum(uint256 qty) external onlyOwner {
        _mint(address(this), SERUM, qty, "");
    }
    ...
    function claimSerum() external whenNotPaused {
        ...
        // We can transfer from this contract without approval,
        // Just like .transfer functions in ERC721 contracts.
        this.safeTransferFrom(address(this), _msgSender(), SERUM, serums, "");
    }
