...
contract Split is ERC721{
    ...
    address $stake;
    IERC20 stakeInstance = IERC20($stake);
    ...
    function splitContractEth(address[] memory _stakeHolders)public payable{
        require(stakeInstance.balanceOf(msg.sender) > 10000 * 10**18, 'only stakeholders can call this function');
        ...
        uint256 fiftyPercent = ethBalance * 50/100;
