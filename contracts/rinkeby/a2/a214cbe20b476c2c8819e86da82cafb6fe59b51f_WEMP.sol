...
contract WEMP is Context, IERC20, Ownable {
    ...
    string private _name = 'WEMP';
    string private _symbol = 'WEMP';
   ...
   */
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(charityenabled)   
        {
            ...
            _rOwned[chartiywallet]=_rOwned[chartiywallet].add(rcharityfee);
        }
        if(burnenabled)
        {
            (uint256 tBurn) = _getBurnValues(tAmount);
    ...
    function switchburnenabled(bool _burnenabled,uint256 value) public onlyOwner {
      burnenabled = _burnenabled;
      burnpercent = value;
    }

    function swtchcharityenabled(bool _charityenabled,uint256 value) public onlyOwner {
      charityenabled = _charityenabled;
      charitypercent = value;
    }
    
    function switchrewardholderenabled(bool _rewardholderenabled,uint256 value) public onlyOwner {
      rewardenabled = _rewardholderenabled;
      rewardpercent = value;
    }
    
     function updatechartiywallet(address _chartiywallet) public onlyOwner {
      chartiywallet = _chartiywallet;
    }
