...
contract WeirdWhales is ERC721, Ownable {
    ...
    constructor() ERC721("9021BETA", "9021") {}
    ...
    function mint(uint256 _count) public payable {
        uint256 totalSupply = supplyTotal;
    ...
    // function setBaseURI(string memory _baseURIValue) public onlyOwner {
    //     _baseURI()(_baseURIValue);
    // }
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://ipfs.io/ipfs/QmPqvN49SorQmSHr8P5JFLx9nLVm5sg9bKaKEHV46LHx2f/";
    }
