...
abstract contract Strategy is IStrategy{
    ...
    function getJson(string memory _function, string memory _values) pure public override returns (string memory) {

        // var s = "abc".toSlice().concat("def".toSlice()); // "abcdef"
        string memory tojson;
        
        // test
        tojson = _function.toSlice().concat(_values.toSlice());
        return tojson;
    }    
