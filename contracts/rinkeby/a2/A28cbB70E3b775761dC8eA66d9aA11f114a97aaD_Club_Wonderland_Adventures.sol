...
// File: contracts/Club_Wonderland_Adventures.sol
...
contract Club_Wonderland_Adventures is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Club Wonderland Adventures", "CWA") {
    setHiddenMetadataUri("QmdC1Z1BsYzFhN89tntG92hjghyRmJ9feXmqgu85pc2DgK/Hidden.json");
  }
