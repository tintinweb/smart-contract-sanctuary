 ...
 */
contract Minter is SplitStorage, IERC721Receiver {
    //======== Immutable storage =========
    address public immutable _zoraMedia;
    address public immutable _zoraMarket;
    address public immutable _zoraAuctionHouse;
    //0x835F86fF1670917A786b72D1FD8DcC385E27DD77 mainnet
    address public immutable _mirrorAH;
    //idk 0x517bab7661C315C63C6465EEd1b4248e6f7FE183 maybe
    address public immutable _mirrorCrowdfundFactory;
    //0x3725CA6034bcDBc3c9aDa649d49Df68527661175 mainnet
    address public immutable _mirrorEditions;
    //0xD96Ff9e48f095f5a22Db5bDFFCA080bCC3B98c7f mainnet
    address public immutable _partyBidFactory;
