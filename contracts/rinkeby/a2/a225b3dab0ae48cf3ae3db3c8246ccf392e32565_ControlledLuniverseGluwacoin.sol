...
contract ERC20Reservable is ExtendedERC20 {
    ...
    function _checkUnreservedBalance(address from, uint256 amount) internal view {
        if (from != address(0)) {
...
contract ControlledLuniverseGluwacoin is ERC20Pausable, CurrencyBoard, ERC20Burnable, ERC20Reservable, ETHlessTransfer {
    ...
    public whenNotPaused returns (bool success) {
        ...
        _validateSignature(0x5cb4744Bb6bcC360A63f54499d92c7617F0a8f8c, sender, recipient, amount, fee, nonce,sig);
    ...
    function reserve(address sender, address recipient, address executor, uint256 amount, uint256 fee, uint256 nonce,
     ...
     /** @dev execute the transfer using the reserved balance.
     *
     *  Returns a boolean value indicating whether the operation succeeded.
     *      
     */
