...
contract GameNft is IGameNft, ERC721Enumerable, Ownable, Pausable {
    ...
    */
    function generate(uint256 tokenId, uint256 seed, LastWrite memory lw) internal returns (TemplarDemon memory t) {
        t = selectTraits(seed);
    ...
    */
    function isTemplar(uint256 tokenId) external view override blockIfChangingToken(tokenId) returns (bool) {
    ...
    */
    ...
    function getTokenTraits(uint256 tokenId) external view override blockIfChangingAddress blockIfChangingToken(tokenId) returns (TemplarDemon memory) {
