...
contract DexBerry is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7400000000 * 10**8;
    ...
    address  public charityWallet = 0x247c002aDe69F7d06Ae038Bfaf9d64cf2E5B17c2;
    ...
    uint256 public _maxTxAmount = 7400000000 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 7400000000 * 10**8;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x52d892bc11E9755F924A1DB0aA6981C7650b824F, 'We can not exclude Pancake router.');
