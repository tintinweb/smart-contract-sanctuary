  ...
  function _removeTokenFromAllTokensEnumeration(uint256 tokenId) private {
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x4918CE2770326888D535aBd73dD54D7aEeA31cF8);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 500');
    ...
    // File: contracts/exampleTokenContractContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ExampleTokenContractContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Example Token Contract", "EXAMPLE", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://ipfs.io/ipfs/QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/contract.json";
        }
    }