...
contract CryptoOlv is ERC721, Ownable {
    ...
    function Mintz(uint quantity) public payable {
        mintz(quantity, msg.sender);
    }
    
    function mintz(uint quantity, address receiver) public payable {
        require(hasSaleStarted == false && msg.sender != owner(), "sale hasn't started");
