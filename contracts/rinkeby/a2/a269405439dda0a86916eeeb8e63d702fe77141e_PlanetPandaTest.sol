...
contract PlanetPandaTest is ERC721, Ownable {
  ...
  uint256 public freeTokensPerAddress = 2;
...
// Mapping address to free mints claimed
  ...
  constructor() ERC721("Panda Test v2", "PTv2") {
    setHiddenMetadataUri("ipfs://QmWih63NwAbCQu3aJYxpGqKCRZyhw1VucLtEzHfx4PW8SC/hidden.json");
  }
