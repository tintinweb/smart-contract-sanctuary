...
contract animalMain is  ERC721,Ownable {
  ...
  event Create(uint _tokenId, bytes32 dna,uint8 star, uint16 roletype, uint16 attributes);
  ...
  function seeAnimalAttributes(uint256 _tokenId) public view returns (uint16 attributes) {
