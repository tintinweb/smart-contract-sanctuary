...
contract RightBite is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("RightBites", "RB") {
    setHiddenMetadataUri("ipfs://QmYGz4nxs4XGqAmR9ba472Cz14PoFcFRMnEzFj1vjr5HnX/hidden.json");
  }
