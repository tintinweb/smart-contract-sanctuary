...
contract PublicSale is IPublicSale, Ownable {
    ...
    uint256 public constant PUBLIC_SALE_DELAY = 30 minutes;
    uint256 public constant LP_CREATION_DELAY = 10 minutes;
    uint256 public constant TRADING_BLOCK_DELAY = 10 minutes;
    uint256 public constant WHITELISTED_USERS_ACCESS = 10 minutes;
    ...
    uint256 public constant HARD_CAP_ETH_AMOUNT = 0.5 ether;
    uint256 public constant MIN_DEPOSIT_ETH_AMOUNT = 0.01 ether;
...
contract InvestorsVesting is IVesting, Ownable {
    ...
    uint256 public constant VESTING_DELAY = 10 minutes;
