...
contract StakBank is LPTokenWrapper, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    function getReward() public whenNotPaused updateReward(_msgSender()) {
    ...
    function getBaseDate (address account) external view returns (uint256) {
        return userInfo[account].baseDate;
    }
