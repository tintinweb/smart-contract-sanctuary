...
contract Musto is ERC721URIStorage {
    ...
    constructor() ERC721("Musto", "MUSTO") {
      owner = msg.sender;
    }
    ...
    * Mint Mustos
    */
    function mint(address player, uint numberOfMints, string memory uri)
        public payable
        returns (uint256)
    {
        require(_tokenIds.current() + numberOfMints < 9900, "Maximum amount of Mustos already minted."); //10000 item cap (9900 public + 100 team mints)
