...
contract Jigsaw1 is ERC721Enumerable, Ownable {
    ...
    function mint() external payable {
        ...
        require( hasMinted[msg.sender] < MAX_MINTED_NUMBER, 'ER: You have already minted maximum allowed tokens');
    ...
    function getSalesBeginTimestamp() external view returns(uint256, uint256, uint256, uint) {
        return (privateSaleBegin, fiatSaleBegin, publicSaleBegin, block.timestamp);
    }
    ...
    */
    ...
    function grabAllOwners() 
        ...
        // mapping(address => uint256) public hasMinted;
        // balanceOf - total toakens of user.
        // tokenOfOwnerByIndex 
        uint256 ts = totalSupply();
        address[] memory owners = new address[](ts);
        uint256[][] memory tokens = new uint256[][](ts);
        
        //TODO: use uint256 array to insert tokenId 
        //and itereate array to find element exists or not.
        //current func might fail if used dynamic generated long tokenIds
        bool[] memory tempTokenIds = new bool[](ts+1);
