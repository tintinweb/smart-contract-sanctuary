...
contract Crowdsale is Context, ReentrancyGuard, Ownable {
        ...
        internal
    {
        ...
        balanceDeposited[beneficiary] = balanceDeposited[beneficiary] + tokenAmount;
...
contract ICOSale is Ownable, Crowdsale, AllowanceCrowdsale {
    ...
    */
        ...
        override
    {
        ...
        require(_weiAmount >= minCap && _weiAmount <= maxCap, "Crowdsale: cannot buy outside the allocated range.");
        require(balanceDeposited[_beneficiary] + _weiAmount <= maxCap, "Crowdsale: cannot buy more than the max allocation.");
