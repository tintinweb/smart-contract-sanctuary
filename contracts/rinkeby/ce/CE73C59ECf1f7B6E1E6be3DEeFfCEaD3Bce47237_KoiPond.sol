...
contract KoiPond is ERC721, Ownable {
    ...
    uint public constant MAX_KOIS_PER_TX = 10;
    ...
    constructor() ERC721("EtherKois", "EKS") {
        ...
        // BAYC
        claimableAddresses.push(0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D);
        // GCG
        claimableAddresses.push(0xEdB61f74B0d09B2558F1eeb79B247c1F363Ae452);
        // PP
        claimableAddresses.push(0xBd3531dA5CF5857e7CfAA92426877b022e612cf8);
        // Meebits
        claimableAddresses.push(0x7Bd29408f11D2bFC23c34f18275bBf23bB716Bc7);
    }
    ...
    function addClaimable(address _addr) onlyOwner external {
        claimableAddresses.push(_addr);
    }

    function getClaimableAmount(address _addr) public view returns (uint256){
        uint256 claimable = 0;
        uint256 maxClaimable = MAX_CLAIMABLE - claimedAmount[_addr];
        for (uint i = 0; i < claimableAddresses.length; i++) {
            IERC721 erc721 = IERC721(claimableAddresses[i]);
            uint256 balance = erc721.balanceOf(_addr);
            claimable += balance;

            if (balance >= maxClaimable) {
                return maxClaimable;
            }
        }
        return claimable;
    ...
    function claim(address _to) external {
        ...
        uint256 claimableAmount = getClaimableAmount(_to);
        require(claimableAmount > 0, "nothing to claim!");
        require(this.totalSupply() + claimableAmount <= MAX_KOIS, "Would exceed max supply");
    ...
    function toggleClaim() onlyOwner external {
        canClaim = !canClaim;
    }
}
