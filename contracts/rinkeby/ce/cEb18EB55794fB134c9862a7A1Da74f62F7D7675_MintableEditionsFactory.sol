...
contract MintableEditions is ERC721Upgradeable, IERC2981Upgradeable, IMintableEditions, OwnableUpgradeable {
    ...
    // type of content
    EditionsMetadataHelper.ContentType internal _contentType;
    ...
    function initialize(
        ...
        _contentType = EditionsMetadataHelper.ContentType(contentType);
        _size = size;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return EditionsMetadataHelper.createTokenURI(name(), _description, _contentUrl, _contentType, tokenId, _size);
    }
