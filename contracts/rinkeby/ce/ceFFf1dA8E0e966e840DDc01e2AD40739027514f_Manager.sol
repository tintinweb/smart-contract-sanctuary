...
contract Manager is Ownable {
    ...
    uint public basePrice = 100 ether; // 100 pennies per token
    uint public changeNamePrice = 500 ether; // 100 pennies per token
    uint public changeDescriptionPrice = 1000 ether; // 100 pennies per token
