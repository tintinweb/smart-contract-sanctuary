...
contract QuicMasterFarmer is QuicMasterStorage, Ownable, Authorizable {
    ...
    function updatePool(uint256 _pid) public {
        (bool delegateCallStatus, ) = transactionsContract.delegatecall{gas:GAS_FOR_UPDATE_POOL}(
            abi.encodeWithSignature("updatePool(uint256)", _pid)
        );
        require(delegateCallStatus, "DCF");
    }
    ...
    function claimReward(uint256 _pid) public {
        (bool delegateCallStatus, ) = transactionsContract.delegatecall{gas:GAS_FOR_CLAIM_REWARD}(
    ...
    function _harvest(uint256 _pid) internal {
        (bool delegateCallStatus, ) = transactionsContract.delegatecall{gas:GAS_FOR_HARVEST}(
    ...
    function deposit(uint256 _pid, uint256 _amount, address _ref) public {
        (bool delegateCallStatus, ) = transactionsContract.delegatecall{gas:GAS_FOR_DEPOSIT}(
  ...
  // Withdraw LP tokens from QuicMasterFarmer.
    function withdraw(uint256 _pid, uint256 _amount, address _ref) public {
        (bool delegateCallStatus, ) = transactionsContract.delegatecall{gas:GAS_FOR_WITHDRAW}(
    ...
    function emergencyWithdraw(uint256 _pid) public {
        (bool delegateCallStatus, ) = transactionsContract.delegatecall{gas:GAS_FOR_EMERGENCY_WITHDRAW}(
    ...
    function safeQuicTransfer(address _to, uint256 _amount) internal {
        (bool delegateCallStatus, ) = transactionsContract.delegatecall{gas:GAS_FOR_TRANSFER}(
	...
	// 		uint256 estDelta = block.number - userInfo[_pid][msg.sender].lastWithdrawBlock;
	// 		return estDelta;
	// 	} else {
	// 	    uint256 estDelta = block.number - userInfo[_pid][msg.sender].firstDepositBlock;
	// 		return estDelta;
	// 	}
	// }
