...
interface DeformedDonkeysExtraContract {
...
contract DeformedDonkeys is ERC721, Ownable {
    ...
    address extraDonkeyContractAddress;
    ...
    // sell ending price
    uint256 public donkeyPrice = 69000000000000000; // 0.069 ETH
    ...
    function setExtraDonkeyContractAddress(address newExtraDonkeyContractAddress) external onlyOwner {
        extraDonkeyContractAddress = newExtraDonkeyContractAddress;
    }
    ...
    function adoptDonkey(uint numberOfTokens, bytes memory eligibilityKey) public payable {
        ...
        bool isValidEligibilityKey = validateEligibilityKey(msg.sender, eligibilityKey);
        ...
        DeformedDonkeysExtraContract deformedDonkeysExtra = DeformedDonkeysExtraContract(extraDonkeyContractAddress);
        deformedDonkeysExtra.sendDonkey(numberOfTokens, msg.sender);
    }
