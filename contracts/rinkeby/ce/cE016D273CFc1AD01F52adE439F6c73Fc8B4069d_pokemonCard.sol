...
// File: contracts\pokemonCard.sol
...
contract pokemonCard is ERC721 {

  // string constant name = "pokemonToken";
  // string constant symbol = "PTK";

  address constant ADMIN = 0x8E35B66ea2736C3fe4A60e7063bAaC9c8C2b1e6c;
  ...
  function tokenizedPokemonCard(address _PokemonCardOwner, uint256 _tokenId, string memory _tokenURI) onlyAdmin public {
    super._mint(_PokemonCardOwner, _tokenId);
