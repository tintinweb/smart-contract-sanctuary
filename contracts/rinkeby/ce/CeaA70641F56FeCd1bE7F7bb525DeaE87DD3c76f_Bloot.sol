...
contract Bloot is ERC721Enumerable, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" class="all" preserveAspectRatio="xMaxYMax meet" viewBox="0 0 350 350"><style>.base { fill: #01ff01; font-family: serif; font-size: 14px; }.all {transform: rotate(180deg);}</style><rect width="100%" height="100%" fill="black" /><text x="10" y="20" class="base">';
