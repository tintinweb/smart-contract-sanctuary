...
// Requirements
// Admin per token ID that can mint & burn, set token URI
...
///         Non transferable
///
contract ERC1155Shares is ERC1155, AccessControl {
    // Roles
    ...
    *****************/
    ...
    function burnTokens(
        ...
        require(tokenAdmins[_tokenId] == msg.sender, "ERC1155Shares#burnTokens: NOT_ADMIN");
    ...
    *****************/
    ...
    function _beforeTokenTransfer(
        ...
        for (uint256 _i = 0; _i < ids.length; _i++) {
            require(
                tokenAdmins[ids[_i]] == msg.sender || transfersEnabled[ids[_i]],
                "!admin or transfers not enabled"
            );
        }
    }
}
