...
interface ICryptoLand {
    ...
    function claimWhiteList(uint8 _v, bytes32 _r, bytes32 _s) external;
...
contract CryptoLand is ERC721Enumerable, Ownable, ICryptoLand, ICryptoLandMetadata {
    ...
    */
    function isValidAccessMessage(address _add, uint8 _v, bytes32 _r, bytes32 _s) internal view returns (bool) {
    ...
    function testHash() external view returns (bytes32) {

        return keccak256(abi.encodePacked(address(this), msg.sender));
        //return keccak256(abi.encodePacked('a8564fAE98bC799f7160554B346B11E669C431d3', '862E845e7ac5e021d58bb7986500B12e7c4e5bB7'));
        /*
        return ecrecover(
            keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", hash)),
            _v,
    ...
    */
    ...
    function claimWhiteList(uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,_r,_s) external override {
