...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    constructor(address _priceFeed, address _VRFCoordinator, address _link, uint256 _linkFee, bytes32 _linkKeyHash) public
    VRFConsumerBase(
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        require(lotteryState == LOTTERY_STATE.CALCULATING_WINNER, "Aren't there yet!");
