...
contract OwnNFT is ERC721B, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    address public vaultAddress = 0x4cB6f369e6D4f56d7812B3EAd83d5217Dd54A3f8;

    constructor(string memory _baseURI, string memory collectionURI) ERC721B("Sample NFT", "NFT") {
        setBaseURI(_baseURI);
