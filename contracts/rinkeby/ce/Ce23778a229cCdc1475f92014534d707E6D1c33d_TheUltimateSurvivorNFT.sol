...
contract TheUltimateSurvivorNFT is ERC721Enumerable, Ownable {
  ...
  uint public constant maxSurvivorWhiteList = 250;
  ...
  uint256 public constant whiteListPrice = 0.0001 ether;
  ...
  function mintPresale(uint numberOfTokens, bytes32[] calldata _merkleProof) public payable {
    ...
    require(claimed < 250, "Already claimed whitelist tokens.");
    ...
    whiteListClaims[msg.sender] = claimed + numberOfTokens;
}
