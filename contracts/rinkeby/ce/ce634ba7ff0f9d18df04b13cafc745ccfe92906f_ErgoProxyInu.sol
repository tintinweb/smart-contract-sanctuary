...
contract ErgoProxyInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000 * 10**1 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Ergo Proxy Inu";
    string private _symbol = "ERGOPROXY";
    ...
    address payable public taxWallet = 0x4B90156C93752E2a9388381F5E6807f80Ea94Ca7;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount = 20000000000000 * 10**1 * 10**18;
