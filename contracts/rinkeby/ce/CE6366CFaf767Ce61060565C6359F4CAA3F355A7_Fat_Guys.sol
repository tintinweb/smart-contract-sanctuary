...
// File: contracts/Fat_Guys.sol

pragma solidity ^0.8.0;

contract Fat_Guys is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 40; // max allowed to mint at one time N.O.T.E must be => than line 1241 - mint(msg.sender, 10);
  ...
  constructor(
    ...
    mint(msg.sender, 40); // Must be lower than line 1231 | This is how many is minted FREE to owner upon deployment
  }
