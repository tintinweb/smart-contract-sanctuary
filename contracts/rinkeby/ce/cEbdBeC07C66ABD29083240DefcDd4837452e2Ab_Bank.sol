...
contract Bank is OwnableUpgradeable, IBank {
    ...
    event CryptoClysmSet(address indexed cryptoClysm);
    event OpenTokenManagerSet(
    ...
    function initialize(address creditToken_) external initializer {
        ...
        require(creditToken_ != address(0), "CREDIT cannot be zero");
    ...
    function setCryptoClysm(address cryptoClysm_) external onlyOwner {
        ...
        emit CryptoClysmSet(cryptoClysm);
    }
    ...
    function setStakingReward(address stakingToken, address stakingReward)
        ...
        onlyOwner
    {
        require(stakingToken != address(0), "StakingToken cannot be zero");
        require(stakingReward != address(0), "StakingReward cannot be zero");
        ...
        onlyOwner
    {
        ...
        emit OpenTokenManagerSet(tokenManager, enable);
    }
