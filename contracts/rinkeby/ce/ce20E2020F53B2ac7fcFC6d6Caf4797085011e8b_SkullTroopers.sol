...
contract SkullTroopers is ERC721, ERC721Burnable, EIP712, Ownable {
    ...
    constructor() ERC721("Skull Troopers", "SKULL") EIP712("SKULL", "1.0.0") {
        dutchInitialPrice = 0.666 ether;
        dutchEndPrice = 0.1 ether;
        preSalePrice = 0.2 ether;
        dutchStartTimestamp = 1635791100;
        dutchEndTimestamp = 1635791400;
    ...
    function mint(uint quantity) external payable {
        ...
        require(msg.value >= quantity * currentPrice(), "not enougth ethers");
        require(totalSupply() + quantity <= MAX_SUPPLY, "quantity exceeds max supply");
    ...
    function preSaleMint(uint maxFreeMints, uint maxMints, uint quantity, bytes calldata signature) 
        ...
        require(msg.value >= quantity * preSalePrice, "not enougth ethers");
    ...
    function setDutchDates(uint startTimestamp, uint endTimestamp) external onlyOwner {
        dutchStartTimestamp = startTimestamp;
        dutchEndTimestamp = endTimestamp;
    }
