...
pragma solidity ^0.8.0;
 ...
 /*
 * Sequences are on chain beats that can be used as a basis for music.
 * This is v1 of the project and is built as a Tunes derivative. The Tune id seeds the sequence generation.
 * The visual element of sequences can be retrieved via the tokenURI metadata and contains an SVG of a step sequencer.
 ...
 *                             -.-.-.-.-.-.-.-.
 * This pattern alternates between playing a sound and silence.
