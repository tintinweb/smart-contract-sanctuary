...
interface IMasterChef {
    ...
    function updateEmissionRate(uint256 _ttestPerBlock) external;
}
...
contract Timelock is Ownable {
    ...
    constructor(IMasterChef masterchef_, address admin_) public {
    ...
    function add(uint256 _allocPoint, address _lpToken, uint16 _depositFeeBP, bool _withUpdate) public onlyOwner {
        ...
        address lp = _lpToken;
        uint16 dfee = _depositFeeBP;
        bool flag = _withUpdate;
        
        masterchef.add(ap, lp, dfee, flag);
    }
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint16 _depositFeeBP, bool _withUpdate) public onlyOwner {
        ...
        masterchef.set(pid, ap, dfee, flag);
    }
    
    function updateEmissionRate(uint256 _ttestPerBlock) public onlyOwner {
        uint256 perBlock = _ttestPerBlock;
        
        masterchef.updateEmissionRate(perBlock);
    }
}