...
contract Poodles is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Poodles", "POO") {
    setHiddenMetadataUri("ipfs://QmcyFyE7SazvsXoUrtQX1uiDTM1GRVhxwD8WrJ5ShexBYD/hidden.json");
  }
