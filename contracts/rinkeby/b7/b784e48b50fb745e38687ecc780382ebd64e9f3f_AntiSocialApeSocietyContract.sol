  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 420');
    ...
    contract AntiSocialApeSocietyContract is ERC721Tradable {
        ...
        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmUeLAN4cqZ3t25jWncmxmzja5R8oCQbjUBcrNbVN8BwEo/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/xES1yWjopq8JXeiQFn4s/contract-metadata";
        }
    }