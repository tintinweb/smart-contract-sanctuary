...
contract BusinessCard is ERC1155{
    ...
    // Constructor
    // ------------------------------------------------------------------------
    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/Qmc6AX7xe19dxG1eUaKv2r2LqLFCyYBGK2VwtvuUrdynzF"){
	...
	function setSymbol(string memory newSymbol) public owner {
		_symbol = newSymbol;
	}    
}