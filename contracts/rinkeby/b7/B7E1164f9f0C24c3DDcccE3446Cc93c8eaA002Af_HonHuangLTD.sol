...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable, Random {
    ...
    mapping (address => bool) ifAirdropped;
    ...
    function _exists(uint256 _id) internal view returns (bool) {
		return NFTtoOwner[_id] != address(0);
    }
    
    function adjustNFTprice(uint256 _price) public onlyOwner {
        NFTprice = _price;
...
interface MarketPlace {
    ...
    function createSale(uint256 _tokenId, uint256 _amount, uint256 _startingPrice, uint256 _endingPrice, uint256 _duration) external;
    function createAuction(uint256 _tokenId, uint256 _amount, uint256 _initialPrice, uint256 _duration) external;
