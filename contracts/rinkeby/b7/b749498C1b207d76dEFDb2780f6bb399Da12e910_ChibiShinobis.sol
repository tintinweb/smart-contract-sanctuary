...
contract ChibiShinobis is ERC721Enumerable, Ownable {
    ...
    address t2 = 0xe8a32496551Bf7E493a465D46A7bCa467db3A675;
    address t3 = 0x85Fb09e64287a44847d6288afc5dff3c720A4f61;
    address t4 = 0xAb67e05ebE9F68D5f8A59edc3b96664b87d75D6A;

    // 500 shinobis to test with.
    ...
    function clone(uint256 num) public payable {
        ...
        require( num < 3,                               "You can clone a maximum of 2 Shinobis" );
        require( supply + num + _reserved < 501,        "Exceeds maximum Shinobis supply" );
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Exceeds reserved Ninja supply" );
