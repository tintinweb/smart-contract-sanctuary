...
contract TokenVesting is Context,Ownable{
    ...
    function upDataRelease(bool isUpDataCreateTimestamp) private returns(uint256,uint256) {
      ...
      if(releaseDay >= 1 && tokenVestUsers[msg.sender]._lockUpAmount != 0){
        ...
        if(tokenVestUsers[msg.sender]._unlockAmount < tokenVestUsers[msg.sender]._lockUpAmount){
          ...
          tokenVestUsers[msg.sender]._unlockAmount = tokenVestUsers[msg.sender]._unlockAmount.add(indexReleaseDeltaunlockReleaseAmount);
      ...
      if(newAwardSeconds >= awardCycle && tokenVestUsers[msg.sender]._lockUpAmount != 0){
