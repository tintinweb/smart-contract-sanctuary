...
/**
 * @title FoxNFT
 * FoxNFT - Digital brand assets 
 */
contract FOXNFT is ERC1155Tradable {
	constructor() public ERC1155Tradable("FoxNFT", "FOXT") {
		_setBaseMetadataURI("https://yanyi-test.oss-cn-hangzhou.aliyuncs.com/foxnft/");
	}
}