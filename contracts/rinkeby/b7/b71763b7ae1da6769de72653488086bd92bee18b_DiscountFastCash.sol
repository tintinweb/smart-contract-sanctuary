...
contract DiscountFastCash {
   ...
   function withdrawFastcash(uint256 _amount) external onlyOwner("Only owner can withdraw fastcash") {
      fastcashContract.transfer(msg.sender, _amount);
   }
   ...
   function buy() external payable {
      ...
      require(!luckyParticipants[msg.sender], "Your luck has run out");
