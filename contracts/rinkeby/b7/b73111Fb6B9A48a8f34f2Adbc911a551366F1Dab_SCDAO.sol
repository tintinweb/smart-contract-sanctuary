...
// Task 1: Contract verification. (ABI / Constructor issue, try to deploy & verify from HardHat to Rinkeby)
// Task 2: Deploy to test-net ProxyGrid. ABI. (Confirm twice Multi-Sig to TimeLock to ProxyAdmin works)
// Task 3: Re-config Minting Daap. ABS JSON.
// Task 4: Finalize metadata. (Essentially just double check).
// Task 5: Deploy to main-net ProxyGrid. ABI. (Confirm twice Multi-Sig to TimeLock to ProxyAdmin works)
