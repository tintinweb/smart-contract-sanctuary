...
contract sftestnet is ERC721, Ownable {
    ...
    constructor() ERC721("Santa Force Testnet", "SFTN") {}
    ...
    function ownerMint(address[] memory addresses) external onlyOwner {
        require((currentToken + addresses.length) <= maxSupply, "Mint Quantity Exceeds Tokens Available");
    ...
    function withdraw() external onlyOwner {
        ...
        require(payable(0x509c217351d0821e75787bDfd1649e2c0bc9394A).send(halfAmount));
        require(payable(0x09C1561332416c1ce9814929aEbcCb1Bfb9158CD).send(halfAmount));
    }
