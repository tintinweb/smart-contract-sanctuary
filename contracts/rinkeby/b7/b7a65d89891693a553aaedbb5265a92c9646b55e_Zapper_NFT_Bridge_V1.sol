...
// File contracts/NFT/utils/Context.sol
...
// File contracts/NFT/access/Ownable.sol
...
// File contracts/NFT/utils/introspection/IERC165.sol
...
// File contracts/NFT/ERC1155/IERC1155.sol
...
// File contracts/NFT/Zapper_NFT_Bridge_V1.sol
...
interface IZapper_NFT_V2 {
    ...
    function craft(uint256 id, uint256 quantity) external;
...
contract Zapper_NFT_Bridge_V1 is Ownable {
    ...
    function bridge(uint256 id, uint256 quantity) external {
        require(mintIDs[id] != 0, "Invalid ID");
    ...
    function bridgeAndCraft(uint256 id, uint256 quantity) external {
        ...
        uint256 craftID = Zapper_NFT_V2.nextRarity(mintID);

        Zapper_NFT_V2.mint(
            craftID,
            quantity / Zapper_NFT_V2.craftingRequirement()
        );
    ...
    function setMintIDs(uint256 fromId, uint256 toId) external onlyOwner {
        mintIDs[fromId] = toId;
    }
}