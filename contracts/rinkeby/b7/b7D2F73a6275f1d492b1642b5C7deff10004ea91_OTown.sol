...
contract OTown is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    address proxyRegistryAddress;
    address oTownWallet = 0xe73e90fc400c0256Bc271C83e576ACb97603452b;
    mapping (uint256 => string) private _tokenURIs;
    string private BASE_URI = "https://api.otown.com/";
    uint256 public MAX_TOKENS = 5555;
    uint256 public TOKEN_PRICE = 40000000000000000;
    uint public MAX_TOKENS_PER_ORDER = 20;
    bool public ON_SALE = false;                 

    constructor(address _proxyRegistryAddress) ERC721("OTown", "OTOWN") {
