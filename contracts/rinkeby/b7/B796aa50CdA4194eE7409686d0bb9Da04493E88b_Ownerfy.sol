...
contract Ownerfy is Context, AccessControlEnumerable, ERC1155Burnable {
  ...
  bytes32 public constant AUDITOR_ROLE = keccak256("AUDITOR_ROLE");
     ...
     */
    constructor() ERC1155("https://us-central1-receiptcoin-receiptchain-de560.cloudfunctions.net/app/api/items/{id}") {
     ...
     */
    function mint(address to, uint256 id, uint256 amount, bytes memory data, string memory _update) public virtual {
     ...
     */
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data, string[] memory updates) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "Ownerfy: must have minter role to mint");
