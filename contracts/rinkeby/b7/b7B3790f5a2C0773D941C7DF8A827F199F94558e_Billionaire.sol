...
contract Billionaire is ERC721Enumerable, Pausable, PaymentSplitter {
    ...
    uint256 public maxTotalSupply = 10126;
    ...
    function setUpSale() external onlyOwner {
        ...
        require(
            ...
            "Bilionaire: presale not not finished"
        );
    ...
    function presaleMint(uint256 _amount) public payable whenNotPaused {
        ...
        require(
            block.timestamp <
                _presaleConfig.startTime + _presaleConfig.duration,
            "Bilionaire: Presale is finished"
        );
        require(
            _presaleList[msg.sender] == true,
            " Caller is not on presale list"
        );
        require(
            _amount <= _presaleConfig.maxCount,
