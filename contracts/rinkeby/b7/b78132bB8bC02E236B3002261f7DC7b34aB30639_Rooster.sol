...
contract Rooster is ERC721, Ownable,Pausable, RandomlyAssigned {
  ...
  constructor() 
    ERC721("Rooster", "Roos")
    RandomlyAssigned(maxSupply,1) // Max. 852 NFTs available; Start counting from 1 (instead of 0)
    { 
      setHiddenMetadataUri("ipfs://QmaYNGeYCwbSV2umCAxufCNWCP1TXF5qsqAZzdsLv6S8ve");
    }
