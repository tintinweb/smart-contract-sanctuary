...
contract HumanID is ERC721Enumerable, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        string memory id = string(abi.encodePacked(addr));
        ...
        parts[
            16
        ] = '</text><animate xlink:href="#adjective" attributeName="y" from="35%" to="20%" values="35%; 20%; 35%" dur="0.5s" begin="click" repeatCount="indefinite" fill="freeze" id="anim2"/><animate xlink:href="#noun" attributeName="x" from="30%" to="70%" values="50%; 30%; 50%; 70%; 50%;" dur="1s" begin="click" repeatCount="indefinite" fill="freeze" id="anim3"/><animate xlink:href="#verb" attributeName="y" from="65%" to="80%" values="65%; 80%; 65%;" dur="0.2s" begin="click" repeatCount="indefinite" fill="freeze" id="anim3"/><animate xlink:href="#descriptor" attributeName="x" from="50%" to="50%" values="-5%; 105%;" dur="4s" begin="0s" repeatCount="indefinite" fill="freeze" id="anim"/></svg>';
