...
contract Pandamonium is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    address public pandaOwner = 0xDb9E7c04378299048DD1882F6c9Cf21d709f9319;
    address public developer = 0xDb9E7c04378299048DD1882F6c9Cf21d709f9319;
    ...
    // Presale
    mapping (address => bool) private presaleClaimed; // can only claim once per address
    ...
    function mintPresale(
        ...
        require(!presaleClaimed[_msgSender()], "Already minted in the presale with this address");
    ...
    function mint(uint256 tokenCount) external nonReentrant payable {
        ...
        _premint(_msgSender(), tokenCount);
    }
    ...
    function _premint(address recipient, uint256 tokenCount) private {
        ...
        for (uint256 i = 1; i <= tokenCount; i++) {
            ...
            emit MintPanda(_msgSender(), tokenId);
    ...
    function withdraw() public onlyOwner {
        ...
        payable(developer).transfer(balance / 10);
        payable(pandaOwner).transfer(balance / 90);
    }
