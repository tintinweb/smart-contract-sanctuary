...
contract TokenMarket is TokenMarketBase {
    ...
    */
    ...
    function activateLoanFullToken(uint256 _loanId, uint256 _stableCoinAmount, bool _autoSell) public {
        ...
        IERC20(loanOffersToken[_loanId].borrowStableCoin).transferFrom(msg.sender, loanOffersToken[_loanId].borrower, loanAmountAfterAPYFee);
    ...
    function liquidateBorrowerCollateral(uint256 _loanId) public onlyLiquidatorRole(msg.sender) {
        ...
        require(this.isLiquidationPending(_loanId) || (loanTermLengthPassedInDays > loanDetails.termsLengthInDays), "GTM: Liquidation Error");
...
interface ITokenMarket {
    ...
    @dev function that will get APY fee of the loan amount in borrower
     */
    function getAPYFee(TokenLoanData.LoanDetails memory _loanDetails) external returns(uint256);
