...
contract MightyManateesMerchCard is ERC721, Ownable {
    ...
    uint public constant maxMerchCardPurchase = 1;
...
//    event PROVupdated(string newProv);
    ...
    function mintManatees() public payable {
        require(isLive, "Can not mint merch cards before the sale has started");
        require(totalSupply().add(1) <= MAX_CARDS, "Purchase would exceed max supply of Merch Cards");
        require(MerchCardPrice.mul(1) <= msg.value, "Ether value sent is not correct");
