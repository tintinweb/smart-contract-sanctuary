...
contract Escrow {
        ...
        returns (bool)
    {
        ...
        if (_order.saleType == 2) {
            ...
            // if (accept[_order.tokenId][_editionNumber] != address(0)) {
            //     require(
            //         msg.sender == accept[_order.tokenId][_editionNumber],
            //         "Not intended buyer"
            //     );
            // }
        }
        ...
        returns (bool)
    {
        ...
        uint256 finalcreatorsCut = platformCut.mul(10).div(100);
        uint256 creatorCut = finalcreatorsCut.mul(_percent1).div(100);
        uint256 coCreatorsCut = finalcreatorsCut.sub(creatorCut);
        // payable(_creator).transfer(creatorCut);
        sendValue(payable(_creator), creatorCut);
        ...
        holder[_order.tokenId][_editionNumber] = bid[_order.tokenId][
            _editionNumber
        ]
        .bidder;
        delete order[_orderNonce];
