...
contract DefpunkMain is IDefpunkMain, Ownable, ReentrancyGuard, Pausable {
    ...
    /**
    * mint a token - 90% Tortoise, 10% Goat
    * The first 25% are claimed with eth, the remaining cost $EGG
    */
    ...
    */
    ...
    /**
    * Updates the whitelist signer address
    */
    function setWhitelistSigner(uint256 _mintPriceInWei) external onlyOwner {
    ...
    */
    ...
    /**
    * Updates the max mints per transaction
    */
