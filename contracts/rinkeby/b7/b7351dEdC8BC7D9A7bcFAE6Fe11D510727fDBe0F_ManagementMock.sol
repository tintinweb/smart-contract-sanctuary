...
contract ManagementMock is Ownable {
    ...
    function setKycWhitelists(address[] memory _address, bool _value) public {
    ...
    function setPrivateWhitelists(address[] memory _address, bool _value)
        public
    {
        for (uint256 i = 0; i < _address.length; i++) {
