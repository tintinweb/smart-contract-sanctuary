...
contract FarmProRata is Ownable {
    ...
    function deposit(
        ...
        IERC20(trustedPlatformTokenAddress).safeApprove(address(uniswapRouterV2), 0);
        IERC20(trustedPlatformTokenAddress).safeApprove(address(uniswapRouterV2), amountToDepositByContract);
