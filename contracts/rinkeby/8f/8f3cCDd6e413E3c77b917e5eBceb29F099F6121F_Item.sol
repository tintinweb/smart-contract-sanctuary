...
contract Item is ERC1155, ERC721Holder, ERC1155Holder, ItemComponents, MaterialMetadata {
    ...
    IERC721 recipe = IERC721(0xb8cF9db625CdB1E4aC8F71765faFAD909afC873a);
    RecipeInterface recipeContract = RecipeInterface(0xb8cF9db625CdB1E4aC8F71765faFAD909afC873a);
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '"description" : ', '"Item allows you to create items from Material Bag Item tokens and your Recipe token, or breakdown your 1155 Item to retrieve the original ERC721 Recipe and ERC1155 Material Bag Items.", ',
