...
contract PSH is ERC721Enumerable, Ownable {
    ...
    function mintSale(uint _numGens) external payable{
        ...
        require(_numGens > 0 && _numGens <= GEN_LIMIT, "Invalid PSH count");
        require(_tokenIdTracker.current() + _numGens <= MAX_PUBLIC, "All PSHs have been minted");
        require(_numGens * itemPrice == msg.value, "Incorrect amount of ether sent");
    ...
    function mintReserve(uint _numGens) external {
        ...
        require(_reservedTokenIdTracker.current() + _numGens <= RESERVED, "All reserved PSHs have been minted");
