...
// interface WebacyProxyFactoryInterface {
...
contract WebacyProxyFactory {
    ...
    function createProxyContract(address _memberAddress, address _webacyAddress) public {
        WebacyProxy webacyProxy = new WebacyProxy(_memberAddress, _webacyAddress);
        _memberToContract[_memberAddress] = webacyProxy;
    }

    function deployedContractFromMember(address _memberAddress) public view returns (WebacyProxy) {
