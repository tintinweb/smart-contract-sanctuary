...
contract GovWorldLiquidator is GovLiquidatorBase {
    ...
    function liquidateLoan(uint256 _loanId) public override onlyTokenMarket {
        ...
        if(lenderDetails.autoSell  == true) {
            ...
            uint256 thresholdFeeinStable = ((loanDetails.loanAmountInBorrowed.mul(thresholdFee)).div(10000));
            ...
            for(uint256 i  = 0 ; i  <  loanDetails.stakedCollateralTokens.length ; i++){
                ...
                uint256 priceofCollateral = govPriceConsumer.getAltCoinPriceinStable(loanDetails.borrowStableCoin, loanDetails.stakedCollateralTokens[i], loanDetails.stakedCollateralAmounts[i]);
