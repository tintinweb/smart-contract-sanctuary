...
/**
 * @title Deez nuts
 * Deez nuts - a contract not for my balls.
 */
contract DeezNuts is ERC721Tradable {
    ...
    string public _contractURI =
        "https://gateway.pinata.cloud/ipfs/QmUGbYMyyJp8GvU5Ntg6XyuokMBwiqmsJhuUKXUjkFnENe";
    ...
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Deez Nuts", "DNUT", _proxyRegistryAddress)
    {
        // mint(msg.sender, 200);
    }
