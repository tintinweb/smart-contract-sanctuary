...
contract VIP_8SIAN_GOLD_PASS is ERC1155, Ownable  {
    ...
    string private constant SIG_WORD = "8SIAN";
    address private SIGNER_ADDRESS = 0xebC4C5905E8813BB556636aDEbCbBb0822a84e14;
    mapping(address => bool) public buyersList;
    bool public presaleLive;
    bool public saleLive;

    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmetsWYW6svzykYypmaW9Ro3Q2VUdCiRMVbJTvnKEgLed7/{id}") {}
    ...
    function buy(uint256 tokenQuantity) external payable {
        ...
        require(TOKENS_MINTED.current() + tokenQuantity <= MAX_TOKENS, "EXCEED_MAX_TOKENS");
        require(TOKEN_PRICE * tokenQuantity <= msg.value, "INSUFFICIENT_ETH");
        for (uint256 index = 0; index < tokenQuantity; index++) {
             TOKENS_MINTED.increment();
        }
        _mint(msg.sender, PASS_ID, tokenQuantity, "");  
    }
}