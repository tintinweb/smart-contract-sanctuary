    ...
    function GenerateLadder(uint256 tokenId) public view returns (string memory) {
        ...
        if (ladderNumTemp == 0) {
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_1">',
                    '<path d="M400,150 l-125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][0]],
                    '"/>',
                    '<path d="M400,150 l125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][1]],
                    '"/>',
                '</g>'
            ));
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_2">',
                    '<path d="M400,400 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][2]],
                    '"/>',
                    '<path d="M400,400 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][3]],
                    '"/>',
                '</g>'
            ));
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_3">',
                    '<path d="M400,650 l-125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][0]],
                    '"/>',
                    '<path d="M400,650 l125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][1]],
                    '"/>',
                '</g>'
            ));
        }
        else if (ladderNumTemp == 1) {
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_1">',
                    '<path d="M400,110 l-125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][0]],
                    '"/>',
                    '<path d="M400,110 l125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][1]],
                    '"/>',                    
                    '<path d="M400,190 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][2]],
                    '"/>',
                    '<path d="M400,190 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][3]],
                    '"/>',
                '</g>'
            ));
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_2">',
                    '<path d="M400,360 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][0]],
                    '"/>',
                    '<path d="M400,360 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][1]],
                    '"/>',
                    '<path d="M400,440 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][2]],
                    '"/>',
                    '<path d="M400,440 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][3]],
                    '"/>',
                '</g>'
            ));
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_3">',             
                    '<path d="M400,610 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[2]][0]],
                    '"/>',
                    '<path d="M400,610 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[2]][1]],
                    '"/>',
                    '<path d="M400,690 l-125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[2]][2]],
                    '"/>',
                    '<path d="M400,690 l125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[2]][3]],
                    '"/>',       
                '</g>'
            ));
        }
        else if (ladderNumTemp == 2) {
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_1">',
                    '<path d="M400,90 l-125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][0]],
                    '"/>',
                    '<path d="M400,90 l125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][1]],
                    '"/>',          
                    '<path d="M400,150 l-125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][2]],
            ...
            ladderString = string(abi.encodePacked(
                ladderString,
                    ...
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[0]][3]],
                    '"/>',          
                    '<path d="M400,210 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][0]],
                    '"/>',
                    '<path d="M400,210 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][1]],
                    '"/>',
                '</g>'
            ));
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_2">',
                    '<path d="M400,340 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][2]],
                    '"/>',
                    '<path d="M400,340 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[1]][3]],
                    '"/>',
                    '<path d="M400,400 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[2]][0]],
            ...
            ladderString = string(abi.encodePacked(
                ladderString,
                    ...
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[2]][1]],
                    '"/>',
                    '<path d="M400,460 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[2]][2]],
                    '"/>',
                    '<path d="M400,460 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[2]][3]],
                    '"/>',
                '</g>'
            ));
            ladderString = string(abi.encodePacked(
                ladderString,
                '<g id="ladder_3">',             
                    '<path d="M400,590 l-100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[3]][0]],
                    '"/>',
                    '<path d="M400,590 l100,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[3]][1]],
                    '"/>',
                    '<path d="M400,650 l-125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[3]][2]],
                    '"/>'
            ));
            ladderString = string(abi.encodePacked(
                ladderString,
                    '<path d="M400,650 l125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[3]][3]],
                    '"/>',
                    '<path d="M400,710 l-125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[4]][0]],
                    '"/>',
                    '<path d="M400,710 l125,0" style="fill:none;stroke-width:20;stroke:#',
                    LadderColor[neucleotideCombIndexed[neucleotideIdxArray[4]][1]],
                    '"/>',       
                '</g>'
            ));
        }
