...
// File: contracts/DerivedElfNFT2.sol
pragma solidity ^0.7.5;



contract DerivedElfNFT2 is ERC721Upgradeable {
    ...
    function getRoyalty(address owner) external view returns (uint256) {
        return royalties[owner];
    }

    function getTemp() external pure returns (uint256) {
        return 11;
    }
