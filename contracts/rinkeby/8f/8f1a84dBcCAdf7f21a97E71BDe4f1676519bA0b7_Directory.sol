    ...
    Common
{
    ...
    virtual
    {
        _marketer.putForSale(owner, tokenId, salePrice);
    }
...
PaymentRecipient
{
    ...
    address private _wyvernRegistry;
...
contract WyvernExchangeInterface {
    ...
    function approveOrder_(
        ...
        uint feeMethod, // FeeMethod
        uint side, // Side
        uint saleKind, // SaleKind
        uint howToCall, //HowToCall
