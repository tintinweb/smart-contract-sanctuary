...
contract LvlUp is ERC20, Ownable {
    ...
    address public _marketingWalletAddress =
        0x21F3Cca57f3C44acf483F904217aa2Aa9e8E4c8a;
    ...
    constructor() public ERC20("LvlUp", "LvlUp") {
    ...
    function prepForLaunch() public onlyOwner {
        ...
        */
        ...
        // TODO: UPDATE to 1 day
        launchSellFeeDeadline = now + 15 minutes; // sell penalty for the first 24 hours
    ...
    function setMaxTxPercent(uint256 newMaxTx) public onlyOwner {
        require(newMaxTx >= 5, "LvlUp: Max TX should be a value between 0.5 and 1%");
