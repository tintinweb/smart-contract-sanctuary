...
contract GoodGamer is ERC721Enumerable, AccessControl {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        // TODO {Contract_Version} needs to be changed for new deployment
        // return "https://nft.goodgamer.gg/api/{Contract_Version}/";
        return "https://nft.goodgamer.gg/api/1/";
    }
    ...
    function transfer(uint256 amount) public onlyRole(TRANSFER_ROLE) {
        treasury.transfer(amount);
    }

    function transferAll() public onlyRole(TRANSFER_ROLE) {
