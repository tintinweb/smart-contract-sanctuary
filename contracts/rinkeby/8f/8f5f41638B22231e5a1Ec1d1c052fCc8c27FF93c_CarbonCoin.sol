...
contract CarbonCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    constructor () public {
        ...
        _balance[_msgSender()] = _total.div(2);
        _balance[_burnPool] = _total.sub(_balance[_msgSender()]);
        ...
        emit Transfer(address(0), _burnPool, _total.sub(_balance[_msgSender()]));
    }
...
//--------------------------------
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if(!argu.isExcludedFromFee(from) && !argu.isExcludedFromFee(to))
    ...
    function _topUpClaimCycleByAmount(address recipient, uint256 amount) private {
        ...
        argu.setNextAvailableClaimDate(recipient,_calculateTopUpClaim(
    ...
    function migrateAltToken(address _newAddress, address _altToken, uint256 altTokenAmount)public {
        ...
        _approve(address(this), _altToken, altTokenAmount);
