...
contract PhatDonkeyCockClub is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("PhatDonkeyCockClub", "PDCC"){
    ...
    function freeMintPDCC(uint numberOfTokens) public {
    ...
    function mintPDCC(uint numberOfTokens) public payable {
        require(drop_is_active, "Please wait until the drop is active to mint");
        require(numberOfTokens > 0 && numberOfTokens <= maxMaycPurchase, "Mint count is too little or too high");
        require(tokensMinted + numberOfTokens <= maycSupply, "Purchase would exceed max supply of PDCC");
        require(msg.value >= maycPrice * numberOfTokens, "ETH value sent is too little for this many PDCC");
        require(addressesThatMinted[msg.sender] + numberOfTokens <= 10, "You have already minted 10!");
