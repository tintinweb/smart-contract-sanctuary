...
contract TheGodStoneProject is ERC721, ERC721Enumerable, Ownable {
    ...
    */
    function mintYellowStone(uint256 amount, uint256 stoneClassIndex) external payable {
        ...
        setStonePropertyToUsed( stoneClassIndex, requiredStones); 
    }
    ...
    */
    ...
    /**
    INPUT:
    stoneClassIndex: class index of stone (e.g for YellowStone index is 1)
    stones: array of tokenId
    */
    function setStonePropertyToUsed( uint256 stoneClassIndex , uint256[] memory stones) internal {
        Stone[] storage _stones = mapStoneClass[stoneClassIndex].arrayOfStones;
            for (uint256 i = 0; i < stones.length; i++) {
            _stones[i].isUsed = true;
        }  
    }
