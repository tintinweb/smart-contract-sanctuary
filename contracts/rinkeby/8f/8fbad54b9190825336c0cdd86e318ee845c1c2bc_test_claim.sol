...
uint256 public Series0start = 0; // 2 [GANapes]
uint256 public Series1start = 2; // 2 [TestNFT]
...
//        require(_id < Series2, "CHOOSE A GLICPIXXX INSIDE RANGE");
    ...
    // YEAH ALSO I HAD TO COMMENT THIS FUNCTION CAUSE THERE WASN'T ANY SPACE LEFT
     ...
     function calculateStartingIndexPerCollection(CollectionToClaim _collection)  public view returns(uint256){
         ...
         if(_collection == CollectionToClaim.Series0) {
             return (Series0start + mintStartIndex) % Series2total;
         }
         else if (_collection == CollectionToClaim.Series1) {
             return (Series1start + mintStartIndex) % Series2total;
         }
         else {
             revert();
         }
