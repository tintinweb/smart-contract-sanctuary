...
// Part: smartcontractkit/chainlink-brownie-cont[email protected]/VRFConsumerBase
...
contract Agora is VRFConsumerBase, Ownable {
    address payable[] public members;
    bytes32 public keyHash;
    uint256 public membershipUSD;
    ...
    constructor(address _priceFeedAddress, address _vrfCoordinator, address _link, uint256 _fee, bytes32 _keyHash) public
        VRFConsumerBase(_vrfCoordinator, _link) {
            membershipUSD = 50 * (10**18);
    ...
    function join() public payable {
        require(msg.value >= checkMembershipFee(), "Not Enough ETH!");
        members.push(msg.sender);
    }

    function checkMembershipFee() public view returns (uint256) {
        (, int256 answer, , , ) = ethUsdPriceFeed.latestRoundData();
        uint256 eth = uint256(answer) * 10**10;
        uint256 membershipFee = (membershipUSD * 10**18) / eth;
