...
/// @title A Token Builder
/// @notice Use this contract to create another token
contract TokenBuilder {

    /// @notice Alerts when new token was created
...
/// @dev It is used work as template to create new ERC-20 token by Token Builder
