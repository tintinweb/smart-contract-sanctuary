...
contract OldNft is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("OldNft", "OldNft") Ownable() {}
    ...
    function claim(address to, uint256 _num) public nonReentrant {
