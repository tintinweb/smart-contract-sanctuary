...
contract EvilElves is ERC721, Ownable {

    uint256 public constant MAX_TOKENS = 6000;
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 20;
    uint256 public constant price = 20 * 10**15; // .02 eth
    uint public reserve = 125;
    bool public isSaleActive = false;

    constructor() ERC721("EvilElves", "EVIL") payable {}
    ...
    function mintElf(uint256 _count) public payable {
        ...
        require(totalSupply + _count < MAX_TOKENS + 1, "Exceeds available Elves");
