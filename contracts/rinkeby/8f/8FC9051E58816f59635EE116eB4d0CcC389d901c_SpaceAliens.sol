    ...
    Ownable
{
    ...
    uint256 public _currentGroup1TokenId = 0;
    ...
    uint256 public Startdate = 1633068000; // 04/10/2021 18:00:00 UTC+7 - 1633345200
    uint256 public Enddate = 1633068900; // 04/10/2021 18:30:00 UTC+7 - 1633347000

    string _name = "SpaceAliensNFT";
    string _symbol = "SANFT";
    
    address SB_address = 0x8503f4AD5a808b4CfE810d5E5A8c3193BdADfB5A;
    
    address[] public whitelistedAddressesGroup1;
    address[] public whitelistedAddressesGroup2;
    ...
    function mintGroup1() external {
        ...
        require(isWhitelistedGroup1(_msgSender()) , "You are not in this group.");
    ...
    function mintGroup2() external {
        ...
        require(isWhitelistedGroup2(_msgSender()) , "You are not in this group.");
        require(balanceOf(_msgSender()) == 0, "You have already Claimed Nft.");
  ...
  function isWhitelistedGroup1(address _user) public view returns (bool) {
    for (uint i = 0; i < whitelistedAddressesGroup1.length; i++) {
      if (whitelistedAddressesGroup1[i] == _user) {
          return true;
      }
    }
    return false;
  ...
  function whitelistUsersGroup1(address[] calldata _users) public onlyOwner {
    delete whitelistedAddressesGroup1;
    whitelistedAddressesGroup1 = _users;
  }
  
   function isWhitelistedGroup2(address _user) public view returns (bool) {
    for (uint i = 0; i < whitelistedAddressesGroup2.length; i++) {
      if (whitelistedAddressesGroup2[i] == _user) {
          return true;
      }
    }
    return false;
  ...
  function whitelistUsersGroup2(address[] calldata _users) public onlyOwner {
    delete whitelistedAddressesGroup2;
    whitelistedAddressesGroup2 = _users;
  }
