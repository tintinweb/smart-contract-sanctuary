...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    function _transfer(
        ...
        if (user_type1 == 1) {//only buyer condition
            ...
            if(block.timestamp >= _locktime_buy[_msgSender()] + 300 seconds && block.timestamp < _locktime[_msgSender()] + 300 seconds) {//buyer
                _lock_buy[_msgSender()] = 0;
                _locktime_buy[_msgSender()] = 0;
                can_transfer = 1;
                _buy_bal[_msgSender()] -= token_qty;
            ...
            } else if(block.timestamp < _locktime_buy[_msgSender()] + 300 seconds && block.timestamp >= _locktime[_msgSender()] + 300 seconds) {//bounty
                _lock[_msgSender()] = 0;
                _locktime[_msgSender()] = 0;
                can_transfer = 1;
                _bou_bal[_msgSender()] -= token_qty;
            ...
            } else if(block.timestamp >= _locktime_buy[_msgSender()] + 300 seconds && block.timestamp >= _locktime[_msgSender()] + 300 seconds) {
                _lock_buy[_msgSender()] = 0;
                _locktime_buy[_msgSender()] = 0;
                _lock[_msgSender()] = 0;
                _locktime[_msgSender()] = 0;
