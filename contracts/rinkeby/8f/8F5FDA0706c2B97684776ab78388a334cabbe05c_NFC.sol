    ...
    ERC721PausableUpgradeable
{
    ...
    mapping(string => uint256) private _tokenIdByOid;
    mapping(string => bool) private _isOidExistedByOid;
    ...
    function project(uint256 projectId) public view returns (Project memory) {
        require(
            projectId < _nextProjectId.current(),
    ...
    function projectIdByTokenId(uint256 tokenId) public view returns (uint256) {
        require(tokenId < _nextTokenId.current(), "NFC: Token not exist");
    ...
    function tokenIdByOid(string memory oid) public view returns (uint256) {
        require(_isOidExistedByOid[oid], "NFC: OID does not exist");
        return _tokenIdByOid[oid];
    }
    ...
    function mint(
        ...
        _tokenIdByOid[oid] = newTokenId;
        _isOidExistedByOid[oid] = true;
    ...
    function createProject(
        ...
        mint(_msgSender(), newProjectId, firstMintCid, firstMintOid);
