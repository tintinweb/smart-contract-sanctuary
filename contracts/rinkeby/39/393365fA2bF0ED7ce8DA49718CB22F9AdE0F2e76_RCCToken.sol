...
contract RCCToken is Ownable {
    ...
    function setStakingAddress(address stakingAddress) public onlyOwner {
        require(stakingAddress != address(0), "Zero address.");
        require(_stakingAddress != stakingAddress, "Already set.");
    ...
    function mint(address to, uint256 amount) public {
        require(msg.sender == _stakingAddress, "Not allow to mint");
        _mint(to, amount);
    }
