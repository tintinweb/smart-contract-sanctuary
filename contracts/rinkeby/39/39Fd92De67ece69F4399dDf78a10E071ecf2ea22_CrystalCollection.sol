...
// File: contracts/CrystalCollection.sol
 ...
 * Sog - a contract for my non-fungible CrystalCollection.
 */
contract CrystalCollection is TradeableERC721Token {
  constructor(address _proxyRegistryAddress) TradeableERC721Token("Crystal Collection", "ECC", _proxyRegistryAddress) public {  }

  function baseTokenURI() public view returns (string memory) {
    return "https://metadata.everdreamsoft.com/ecc-rinkeby/";
  }
}