...
contract TrendyTigers is ERC721Enumerable, Ownable {
    ...
    uint256 public constant TT_GIFT = 99;
    uint256 public constant TT_PRIVATE = 900;
    uint256 public constant TT_PUBLIC = 9000;
    uint256 public constant TT_MAX = TT_GIFT + TT_PRIVATE + TT_PUBLIC;
    uint256 public constant TT_PRICE = 0.03 ether;
    uint256 public constant TT_PER_MINT = 5;

    mapping(address => bool) public rareList;
    mapping(address => uint256) public rareListPurchases;
    mapping(string => bool) private _tickets;

    string private _contractURI;
    string private _tokenBaseURI = "https://uat-1.zinbucks.com/jt-rest/nft/TT/";
    address private _signerAddress = 0x6f909DCd586C095F2D6E5f819a59e4F87969efF4;
    ...
    constructor() ERC721("Trendy Tigers 0.1", "TT1") { }
    ...
    function buy(bytes32 hash, bytes memory signature, string memory ticket, uint256 tokenQuantity) external payable {
        require(saleLive, "SALE_CLOSED");
        require(!presaleLive, "ONLY_PRESALE");
        //require(matchAddresSigner(hash, signature), "DIRECT_MINT_DISALLOWED");
        require(!_tickets[ticket], "HASH_USED");
        //require(hashTransaction(msg.sender, tokenQuantity, ticket) == hash, "HASH_FAIL");
