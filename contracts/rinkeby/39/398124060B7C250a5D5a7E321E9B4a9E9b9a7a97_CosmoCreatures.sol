...
contract CosmoCreatures is ERC721, Ownable {
  ...
  // TODO: UPDATE
  // acct 
  address payable public immutable creatorAddress = payable(0x30B9721de4c8acf3863C32C666359eA623A3E91f);
  address payable public immutable devAddress = payable(0x9A82163dd320ba97769252d46Bdb9CF1bbf15620);
  ...
  function withdraw() public onlyOwner {
        ...
        Address.sendValue(devAddress, balance.mul(50).div(100));
    }
