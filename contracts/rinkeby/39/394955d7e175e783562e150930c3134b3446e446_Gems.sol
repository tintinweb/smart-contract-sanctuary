...
contract Gems is ERC721Enumerable, Ownable {
    ...
    **/
    ...
    function mintReserve(uint256 tokenQuantity) onlyOwner external  {
        require(_reserveMinted+tokenQuantity<6,"EXCEEDS_RESERVE_MINTS");
    ...
    function mintInternal() internal {
        require(ERC721Enumerable.totalSupply() < MAX_SUPPLY);
    ...
    function mintWithBallerBars(uint256 ballerBarsGeneration, uint256 quantity) public {
        ...
        require(ERC721Enumerable.totalSupply()+quantity<=MAX_SUPPLY,"EXCEEDS_MAX_SUPPLY");
