    ...
    function FILL_Problem(uint Problem_ID) public payable {
        ...
        for (uint i=1;i<=TOTAL_Fillings;i++) {
            ...
            if (zddscdx.Investor!=msg.sender) {
                payable(address(zddscdx.Investor)).transfer(((zddscdx.Filling_Weis*((zddscdx.Filling_Weis*1000000000000000000000000000000000000)/(T_weis*1000000000000000000000000000000000000)))/1000000000000000000000000000000000000)/1000000000000000000000000000000000000);
            }
            RSRTYRDH storage sdgdfhd=SOLUTION_byID[zddscdx.Solution_ID];
            if (sdgdfhd.Problem_ID==Problem_ID) {
                payable(address(sdgdfhd.Master)).transfer(((zddscdx.Filling_Weis*((zddscdx.Filling_Weis*1000000000000000000000000000000000000)/(T_weis*1000000000000000000000000000000000000)))/1000000000000000000000000000000000000)/1000000000000000000000000000000000000);
            }
            ERYDDT storage szfxzswwz=PROBLEM_byID[zddscdx.Problem_ID];
            if (szfxzswwz.Problem_ID==Problem_ID) {
                payable(address(szfxzswwz.Thinker)).transfer(((zddscdx.Filling_Weis*((zddscdx.Filling_Weis*1000000000000000000000000000000000000)/(T_weis*1000000000000000000000000000000000000)))/1000000000000000000000000000000000000)/1000000000000000000000000000000000000);
            }
        }
        uint weis;
...
contract Huintsphe is drgreer, puptptpu, yyyyggff, dsgdsd {
    constructor() {
        owner=msg.sender;
    }
