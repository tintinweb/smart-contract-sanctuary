...
contract test is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/247/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/247/contract-uri";
	...
	constructor(address _signerAddress) ERC721("name", "SCV") {
