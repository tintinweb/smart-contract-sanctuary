...
contract Sk8ers is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRESALE_DURATION = 1800;
    ...
    modifier preSaleIsOpen() {
        require(block.timestamp >= _saleTime - PRESALE_DURATION, "The Sk8ers presale has not yet started");
    ...
    function reserve(uint256 _count) public onlyOwner {
        require(block.timestamp < _saleTime - PRESALE_DURATION, "Presale has already started");
