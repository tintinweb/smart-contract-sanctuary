...
contract Bridge{
    ...
    function parallelContractsOf(address contractAddress) external view returns(address parallelContract, address mainContract){
        ...
        uint256 totalVoted;
            ...
            if(totalVoted * 2 >= _totalStakedFT){
                ...
                if(_index[signer] != 0){
                    ...
                    FT.transfer(signer, fee - claimedFees);
