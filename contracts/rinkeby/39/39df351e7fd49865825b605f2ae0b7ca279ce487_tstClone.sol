...
contract tstClone is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address public constant communityWallet = 0xB3A88B3b682316Dcd1e45f60C6ECd012fe73a473;
    address public constant teamWallet = 0x17a18727dB777776Ab5A3Bf686AA5fCfaf2b2738;
    ...
    constructor(string memory baseURI) ERC721("tstClone", "TSTCLONE") {
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(communityWallet, ((balance * 10) / 100));
        _widthdraw(teamWallet, address(this).balance);
    }
