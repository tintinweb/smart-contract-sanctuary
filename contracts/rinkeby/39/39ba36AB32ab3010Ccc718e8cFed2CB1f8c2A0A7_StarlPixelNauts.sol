...
contract StarlPixelNauts is Ownable, ERC721Enumerable {
    ...
    constructor (string memory _initBaseURI, string memory _pendingTokenUri) public ERC721("Starlink PixelNauts", "STPN") {
    ...
    function revealTokenURIs(uint256 tokenIdFrom, bytes32[] calldata hashes) public onlyOwner {
        ...
        require(tokenIdFrom.add(hashes.length) < supply, "invalid length of hashes");
