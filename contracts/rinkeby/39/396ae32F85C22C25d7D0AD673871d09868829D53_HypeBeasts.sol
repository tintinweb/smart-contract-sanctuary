...
contract HypeBeasts is HypeBeastCoreERC721, ReentrancyGuard, VRFConsumerBase {
  ...
  uint256 public constant numberOfTraits = 4;
  ...
  constructor(
    ...
    bytes32[] memory mouthNames,
    uint16[] memory hairProbabilities,
    bytes32[] memory hairNames
  )
    ...
    VRFConsumerBase(VRFCoordinator, LinkToken)
  {
    ...
    traitNames[2] = mouthNames;
    traitCategories[2] = "Mouth";

    traitProbabilities[3] = hairProbabilities;
    traitNames[3] = hairNames;
    traitCategories[3] = "Hair";
  }
