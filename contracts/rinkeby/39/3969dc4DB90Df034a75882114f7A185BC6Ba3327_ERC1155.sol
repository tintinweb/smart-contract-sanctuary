...
contract ERC1155 is ERC165, IERC1155, IERC1155MetadataURI {
    //BigToys mint pass contract developed by the Crypto Family
    //https://cryptofamily.tech/
    ...
    function mint(address account, uint256 amount) external payable {
        ...
        require(_mints[msg.sender] + amount <= _totalAllowedMintsPerUser, "TheRedApeFamily: Max mints reached");
        require(_totalMints + amount <= _totalAllowedMints, "TheRedApeFamily: Insufficient NFTs for minting");
