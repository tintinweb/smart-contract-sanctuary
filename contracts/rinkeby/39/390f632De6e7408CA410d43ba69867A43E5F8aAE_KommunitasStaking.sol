...
contract KommunitasStaking is Ownable {
    ...
    function stake(uint256 _amount, uint256 _lpid) isStakePaused public {
        ...
        locks[msg.sender].push(TokenLock(_lpid, userStaked.length-1, _amount, block.timestamp, matureUntil, lockReward, false));
    ...
    function everStaked(address _of) public view returns(bool){
        ...
        if(userStaked[locks[_of][0].userStakedIndex] == _of){
            return true;
        } else{
            return false;
        }
