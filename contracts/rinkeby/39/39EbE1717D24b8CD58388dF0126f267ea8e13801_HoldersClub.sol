...
contract HoldersClub is ERC721, ERC721Enumerable, IERC721Receiver, Ownable {
    ...
    function burnAndMintOne(ERC721 token, uint256 tokenId) public {
        uint256 supply = totalSupply();
    ...
    function burnAndMintAll(ERC721Enumerable token, uint256 _nbTokens) public {
        ...
        uint256 nAllTokens = token.balanceOf(msg.sender);

        require(_nbTokens == nAllTokens, "You need to mint exactly how many you have");

        for (uint256 i; i < nAllTokens; i++) {
