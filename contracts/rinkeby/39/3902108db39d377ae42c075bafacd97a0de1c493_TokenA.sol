...
contract TokenA is token{
    ...
    function balanceOf(address _account) public override view returns (uint256) { //To check balance of an address
        return balances[_account];
    }
    function transfer(address _to, uint256 _amount) public override returns(bool) { // Transfer from one address to another
    ...
    function approve(address spender, uint256 amount) public NotAddressZero(spender) override returns(bool) {  //To approve an address
        require(amount>0,"amount must be greater than zero");
    ...
    function allowance(address _owner, address _spender) public override view returns(uint256) { //To check allowance
    ...
    function mint(address _to, uint256 _amount) public override onlyAdmin { //To mint TokenA
    ...
    function burn(address _to, uint256 _amount) public override onlyAdmin { //To burn TokenA
