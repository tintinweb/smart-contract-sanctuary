...
contract ASSXToken is ERC20("ASSXToken", "ASSX"), Ownable, Authorizable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "ASSX::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ASSX::delegateBySig: invalid nonce");
        require(now <= expiry, "ASSX::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ASSX::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ASSX::_writeCheckpoint: block number exceeds 32 bits");
