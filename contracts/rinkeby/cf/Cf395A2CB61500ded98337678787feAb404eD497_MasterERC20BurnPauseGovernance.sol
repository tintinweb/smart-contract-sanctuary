...
import "../../token/ERC20/ERC20BurnPauseGovernance.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20BurnPauseGovernance is ContractOwnable, IMasterERC20 {
  ERC20BurnPauseGovernance[] private childERC20BurnPauseGovernance;
  ...
  function createERC20(
    ...
    ERC20BurnPauseGovernance child = new ERC20BurnPauseGovernance(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20BurnPauseGovernance.push(child);
...
contract ERC20BurnPauseGovernance is ERC20 {
  constructor(
    address _owner,
    string memory name,
    string memory symbol,
