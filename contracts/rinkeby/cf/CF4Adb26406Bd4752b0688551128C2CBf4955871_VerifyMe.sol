...
import "./ContractF.sol";

contract ContractE {
  function callE(ContractF _contractF) public {
    console.log(msg.sender, "I am in ContractE");

    ContractF(_contractF).callInF();
  }
}
...
contract ContractF {
  function callInF() public view {
    console.log(msg.sender, "I am in F");
  }
}
...
contract VerifyMe {
  mapping (uint256 => bool) public isNumberTrue;
