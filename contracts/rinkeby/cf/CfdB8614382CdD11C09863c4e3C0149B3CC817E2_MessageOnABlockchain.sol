...
{    
    ...
    constructor(IERC20 _openDAOContract) ERC721("Message on a Blockchain", "MOABC") 
    {
        ...
        shapes[0].svg = 'd="M 175 0 L 350 350 L 0 350 Z" />';
        shapes[1].name = 'Triangle flipped';
        shapes[1].svg = 'd="M 175 350 L 0 0 L 350 0 Z" />';
        shapes[2].name = 'Triangle left';
        shapes[2].svg = 'd="M 0 175 L 350 0 L 350 350 Z" />';
        shapes[3].name = 'Triangle right';
        shapes[3].svg = 'd="M 350 175 L 0 350 L 0 0 Z" />';
        shapes[4].name = 'Star';
        shapes[4].svg = 'd="M 175 0 L 230 120 L 350 135 L 255 218 L 300 350 L 175 285 L 50 350 L 95 218 L 0 135 L 120 120 Z" />';        
        shapes[5].name = 'Pentagon flipped';
        shapes[5].svg = 'd="M 175 350 L 350 175 L 270 0 L 80 0 L 0 175 Z" />';
        shapes[6].name = 'Hexagon';
        shapes[6].svg = 'd="M 0 175 L 90 0 L 260 0 L 350 175 L 260 350 L 90 350 Z" />';
        shapes[7].name = '4-Star';
        shapes[7].svg = 'd="M 175 0 L 230 130 L 350 175 L 230 220 L 175 350 L 120 220 L 0 175 L 120 130 Z" />';
        shapes[8].name = 'Diamond';
        shapes[8].svg = 'd="M 175 0 L 350 175 L 175 350 L 0 175 Z" />';
        shapes[9].name = 'Stairway to Heaven';
        shapes[9].svg = 'd="M 0 350 L 0 300 L 50 300 L 50 250 L 100 250 L 100 200 L 150 200 L 150 150 L 200 150 L 200 100 L 250 100 L 250 50 L 300 50 L 300 0 L 350 0 L 350 350 Z" />';
        shapes[10].name = 'Stairway to Hell';
        shapes[10].svg = 'd="M 0 350 L 50 350 L 50 300 L 100 300 L 100 250 L 150 250 L 150 200 L 200 200 L 200 150 L 250 150 L 250 100 L 300 100 L 300 50 L 350 50 L 350 0 L 0 0 Z" />';        
        shapes[11].name = 'The L';
        shapes[11].svg = 'd="M 0 0 L 87 0 L 87 263 L 175 263 L 175 350 L 0 350 Z" />';
        shapes[12].name = 'The L mirrored';
        shapes[12].svg = 'd="M 350 350 L 175 350 L 175 263 L 263 263 L 263 0 L 350 0 Z" />';
        shapes[13].name = 'Block left';
        shapes[13].svg = 'd="M 0 350 L 50 350 L 50 300 L 100 300 L 100 250 L 150 250 L 150 200 L 200 200 L 200 150 L 150 150 L 150 100 L 100 100 L 100 50 L 50 50 L 50 0 L 0 0 Z" />';
        shapes[14].name = 'Block top';
        shapes[14].svg = 'd="M 350 0 L 350 50 L 300 50 L 300 100 L 250 100 L 250 150 L 200 150 L 200 200 L 150 200 L 150 150 L 100 150 L 100 100 L 50 100 L 50 50 L 0 50 L 0 0 Z" />';
        shapes[15].name = 'Zig zag';
        shapes[15].svg = 'd="M 350 350 L 350 300 L 300 300 L 300 250 L 250 250 L 250 200 L 200 200 L 200 150 L 150 150 L 150 100 L 100 100 L 100 50 L 50 50 L 50 0 L 0 0 L 0 0 Z" />';
      
        colors[0] = "Aquamarine";
        colors[1] = "Lavenderblush";
        colors[2] = "Lightpink";
        colors[3] = "Lightblue";
        colors[4] = "Lightsalmon";
        colors[5] = "Lightgoldenrodyellow";
        colors[6] = "Peachpuff";
        colors[7] = "Powderblue";
        colors[8] = "Thistle";
        colors[9] = "Mediumaquamarine";
        colors[10] = "Lightsteelblue";
        colors[11] = "Lightgreen";
        colors[12] = "Mistyrose";
        colors[13] = "Tomato";
        colors[14] = "Lavender";
        colors[15] = "Blanchedalmond";
    }
    ...
    function getTraits(uint256 _tokenId) internal view returns (Traits memory) {        
        ...
        for (uint i = 1; i <= _elementCount; i++){
            ...
            _rMash = uint(keccak256(abi.encodePacked(_r, i,_elementCount - i)));
            _r = _r ^ _rMash;
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory metaData =  string(abi.encodePacked(
                '{"name": "MOABC #',
                toString(tokenId),
                '", "description": "Your message, 100% generated and stored on the Ethereum blockchain. No IPFS, no centralized data storage!","image": "data:image/svg+xml;base64,',
        ...
        {            
            ...
            {      
                compiledAttributes = string(abi.encodePacked(compiledAttributes,string(abi.encodePacked(
                    ...
                    toString(i),
                    ' Color","value":"',
                    bytes32ToString(colors[memTraits.shape_colors[i]]),
                    '"}'
                ))));
            }
        }
