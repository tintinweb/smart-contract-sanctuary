...
contract HashBridge is Ownable {
	...
	event VoteAdd(uint indexed voteId, uint indexed orderId, address indexed voterAddress, uint voteWeight, uint guarantee, bool success, bool ultimate);
	...
	function vote(uint _orderId, bool _success) external {
        ...
        emit VoteAdd(voteId, _orderId, msg.sender, voteWeight, guarantee, _success, ultimate);
	}
