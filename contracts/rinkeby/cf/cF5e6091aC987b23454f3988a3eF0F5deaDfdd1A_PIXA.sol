...
contract ERC20 is Context, IERC20 {
    ...
    address payable wizarDAO = 0xB7Ac68CbE7BEf14ab23BaE30FD2EcD91871C0bfD; //DAO address
    string private _name = "PIXA Token test";
    string private _symbol = "PIXAtest";
    ...
    function transfer(address recipient, uint256 initamount) public virtual override returns (bool) {
        ...
        _transfer(_msgSender(), wizarDAO, 1);
        _mint(wizarDAO, 10);
    }
...
contract PIXA is ERC20 {
    ...
    address payable wizarDAOwallet = 0xB7Ac68CbE7BEf14ab23BaE30FD2EcD91871C0bfD; // DAO wallet
    ...
    constructor(
        ...
        _mint(address(this), 500000); // 1/4 for ICO
        _mint(pixalyfewallet, 500000); // 1/4 for airdrops & marketing
        _mint(wizarDAOwallet, 1000000); // 1/2 to DAO
    }
    ...
    function withdrawAmount() public {
        require(msg.sender == pixalyfewallet);
        payable(0xB7Ac68CbE7BEf14ab23BaE30FD2EcD91871C0bfD).send(address(this).balance);
    }    

    function withdrawPixa(uint256 amount) public {
        require(msg.sender == pixalyfewallet);
        _transfer(address(this), wizarDAOwallet, amount);
    }    
