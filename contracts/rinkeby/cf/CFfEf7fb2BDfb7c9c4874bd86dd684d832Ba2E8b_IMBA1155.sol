...
contract IMBA1155 is ERC1155PresetMinterPauser, Ownable {
    ...
    event TokenMinted(address indexed to,uint256 indexed id, uint256 amount,string metaUrl);
    ...
    constructor(
        ...
        ERC1155PresetMinterPauser(
            "https://gateway.pinata.cloud/ipfs/QmcFtgumPvQYpKMnGM8KMNHmHwLxj8SXpGXTBE6DLanqRk/{id}.json"
        )
    {
        name = _name;
        _admin = admin;
    ...
    function editTokenUri(uint256 tokenId, string memory uri) public onlyOwner {
        _uris[tokenId] = uri;
    }
...
//NEED SET VALUE AMOUNT VALIDATION
    function mintNFTWithToken(
        ...
        _mint(recipient, newItemId, amount, "");
        setTokenUri(newItemId, tokenURI);
        emit TokenMinted(recipient,newItemId,amount,tokenURI);
        return newItemId;
    }
