...
// File: contracts/NastyTigerClub.sol
    ...
    contract NastyTigerClub is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 88000000000000000; // 0.088 ETH 
      ...
      event TigerMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("Nasty Tiger Club", "NTC") {}
      ...
      function mintTiger(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit TigerMinted(id, msg.sender);
          }
        }
      }
    
      function presaleTiger(uint256 numberOfTokens) external payable {
