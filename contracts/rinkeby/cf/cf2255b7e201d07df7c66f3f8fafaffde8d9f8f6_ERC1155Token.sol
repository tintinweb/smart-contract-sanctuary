...
contract ERC1155Token is ERC1155Base, MinterRole {
    ...
    */
    function initialize(string memory _name, string memory _symbol, string memory _tokenURIPrefix)  public initializer {
    ...
    function mint(uint256 _supply) public onlyMinter{
        tokenIdPointer = tokenIdPointer.add(1);
        uint256 tokenId = tokenIdPointer;
        _mint(tokenId, _supply);
    }
}
