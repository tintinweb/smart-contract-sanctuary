...
contract SmartContract is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("SmartContract", "SC") {
        setBaseURI(baseURI);
        mint(msg.sender, 1); // team gets the first 1
    }
    ...
    function mint(address _to, uint256 num) public payable {
        ...
        if(msg.sender != owner()) {
          ...
          require( num < (_maxMint+1),"You can mint a maximum of _maxMint items");
          require( msg.value >= _price * num, "Ether sent incorrect");
        }
