...
contract Pogpunk is ERC721Enumerable, Ownable, PogpunkERC721, PogpunkMetadata {
    ...
    uint256 public constant POGPUNK_GIFT = 0;
    uint256 public constant POGPUNK_PUBLIC = 270;
    ...
    uint256 public allowListMaxMint = 300;
    ...
    function purchase(uint256 numberOfTokens) external payable override {
        ...
        require(
            totalSupply() + numberOfTokens < POGPUNK_MAX,
         ...
         */
        require(
            totalPublicSupply < POGPUNK_PUBLIC,
            "Purchase would exceed POGPUNK_PUBLIC"
        );
        require(
        ...
        override
    {
        ...
        require(
            totalPublicSupply + numberOfTokens <= POGPUNK_PUBLIC,
            "Purchase would exceed POGPUNK_PUBLIC"
        );
        require(
    ...
    function gift(address to) external override onlyOwner {
        require(totalSupply() < POGPUNK_MAX, "All tokens have been minted");
        require(
            totalGiftSupply + POGPUNK_GIFT <= POGPUNK_GIFT,
