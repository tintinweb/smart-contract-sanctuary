    ...
    Ownable
{
    ...
    event NewDragonRascal(uint256 tokenId, string uri);

    constructor() ERC721("Dragon Rascal", "DRAGON") {
        balanceLimit = 15;
        royaltyRate = 500; // 5%
    ...
    function safeMint(
        ...
        emit NewDragonRascal(tokenId, uri);
    }
    ...
    function setTokenURI(uint256 tokenId, string memory tokenURI) public {
        return super._setTokenURI(tokenId, tokenURI);
    }
