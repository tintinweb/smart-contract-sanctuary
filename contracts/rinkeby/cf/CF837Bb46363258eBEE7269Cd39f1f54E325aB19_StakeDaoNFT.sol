...
contract StakeDaoNFT is ERC1155Tradable {
    ...
    {
        _setBaseMetadataURI(
            "https://gateway.pinata.cloud/ipfs/Qmdft2MfYSDRNE4ASnSUkAeT3EWyk5Ex2nRiCqLb6kZZnz/metadata/"
        );
    }

    function contractURI() public view returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmesW3jozxa6ffTMht2dUd9RsLbxtNYd6XVGcU7ZpAC8tQ/metadata/4";
    }
}