...
contract SyntheticRewarder is ISyntheticRewarder {
    address private immutable SSRP;

    constructor(address _SSRP) {
        SSRP = _SSRP;
    }

    receive() external payable {}

    function onReward(address _to, uint256 _amount) external payable override onlySSRP returns (uint256) {
