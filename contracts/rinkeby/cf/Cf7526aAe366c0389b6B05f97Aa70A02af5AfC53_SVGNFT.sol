...
// Stroring all the NFT metadata on-chain 
...
contract SVGNFT is ERC721URIStorage {
        ...
        constructor() ERC721 ("Night Kids", "NK"){
            tokenCounter = 0;
        }   
        ...
        function svgToImageURI(string memory _svg) public pure returns(string memory) {
            //base 64 format <Base64-encoding>
            string memory baseURL = "data:image/svg+xml;base64,";
            //use base64-sol to convert the svg 
            string memory svgBase64Encoded = Base64.encode(bytes(string (abi.encodePacked(_svg))));
            //concatenate baseURL + svgBase64Encoded to create the image URI
            ...
            return string(abi.encodePacked(
                ...
                Base64.encode(
                    bytes(abi.encodePacked(
                        '{"name": "Night Kids invitation NFT!",',
                        '"description": "An NFT for the Discord invitation!",',
                        '"attributes":"",',
                        '"image":"',_imageURI,'"}'
                    )
                ))
