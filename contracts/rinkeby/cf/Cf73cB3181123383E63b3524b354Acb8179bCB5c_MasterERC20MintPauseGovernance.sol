...
import "../../token/ERC20/ERC20MintPauseGovernance.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20MintPauseGovernance is ContractOwnable, IMasterERC20 {
  ERC20MintPauseGovernance[] private childERC20MintPauseGovernance;
  ...
  function createERC20(
    ...
    ERC20MintPauseGovernance child = new ERC20MintPauseGovernance(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20MintPauseGovernance.push(child);
