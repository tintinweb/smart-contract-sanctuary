...
TokenListener {
  ...
  function addExternalErc20Award(IERC20Upgradeable _externalErc20) external onlyOwner requireAwardNotInProgress {
  ...
  function addExternalErc20Awards(IERC20Upgradeable[] calldata _externalErc20s) external onlyOwner requireAwardNotInProgress {
  ...
  function addExternalErc721Award(IERC721Upgradeable _externalErc721, uint256[] calldata _tokenIds) external onlyOwner requireAwardNotInProgress {
...
contract MultipleWinners is PeriodicPrizeStrategy {
  ...
  /// @notice 初始化策略
  /// @param _prizePeriodStart 奖池开始时间
  /// @param _prizePeriodSeconds 奖池周期时长（多久开一次奖）
  /// @param _prizePool 奖池地址
  /// @param _ticket 奖池代币地址
  /// @param _sponsorship 赞助商 TODO: 为什么是 IERC20Upgradeable
  /// @param _rng 预言机地址
  /// @param _numberOfWinners 多少个获胜者
