...
// contracts/BlootElvesReborn.sol
// SPDX-License-Identifier: MIT
...
contract BlootElvesReborn is ERC721, Ownable {
    using SafeMath for uint256;
    using Strings for string;

    ERC721 bloot = ERC721(0xCAccb157236B0969fe21eb486f2Bc5dc0662a5c5);
    BlootElves oldElves = BlootElves(0xB833de3a239675A09f3191E5D3387F89740b894b);

    uint256 MINT_PER_BLOOT = 2;
    uint256 MAX_SUPPLY = 5000;

    uint256 TOKEN_LIMIT_MIGRATE = 1480;
    ...
    constructor()
        public
        ERC721("BlootElvesReborn", "BlootElvesReborn")
        payable
    {
    }
    ...
    function requestNewBloot(
        ...
        require(super.totalSupply() + oldElves.totalSupply() - oldElves.balanceOf(address(this)) < MAX_SUPPLY, "Maximum supply reached.");
        ...
        else if (msg.value == 10000000000000000 || msg.value == 40000000000000000) {
    ...
    function migrate(uint[] calldata _newIDs) external {
        ...
        for(uint i = 0; i < _newIDs.length; i++) {
            ...
            oldElves.transferFrom(msg.sender, address(this), oldElves.tokenOfOwnerByIndex(msg.sender, 0));
        }
    }
    ...
    // function elfToMigrate(address oldElfOwner) external view returns (uint256) {
    //     require(msg.sender != address(0), "ERC721: balance query for the zero address");
