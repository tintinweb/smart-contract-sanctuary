...
contract SAVENFT is Context, IERC20, Ownable {
    ...
    address payable public _devWallet = 0xb77549FD4D20b6FCeeA883ecE79b5e593dcca37D;
    address payable public _marketingwallet = 0xa459C60D629d1857de858368B7960f35d7Ce1621;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount = 2000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 8640 * 10**9 * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendBNBToMarketing(portionForDev);
