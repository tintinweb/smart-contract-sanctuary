...
contract MyCollectible is ERC721 {
    ...
    _mint(msg.sender, 100-cupcakeBalances[address(this)]);
    //super._setTokenUri(100-cupcakeBalances[address(this)]);
    cupcakeBalances[address(this)] -= 1;
    cupcakeBalances[msg.sender] += 1;
    }

    function totallSupply() public returns (uint) {
        return (100-cupcakeBalances[address(this)]);
    }
}