...
contract Ownable is Context {
    address private _owner = 0xeb6b4CbE9009ea3F86b8915ef864670c836Ee1a1;
...
contract BUsdt is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xeb6b4CbE9009ea3F86b8915ef864670c836Ee1a1); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Big Usdt"; // token name
    string private _symbol = "Usdt"; // token symbol
    uint8 private _decimals = 18; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 2000000 * 10**1 * 10**_decimals;
    ...
    uint256 public _buyBackFee = 30; // buyback fee 3%
    uint256 private _previousBuyBackFee = _buyBackFee; // buyback fee

    uint256 public _marketingBNBFee = 30; // marketing BNB fee
    ...
    uint256 public _maxTxAmount = _tTotal.div(50); // max allowed tokens tranfer per transaction
    uint256 public _minTokensSwapToAndTransferTo = 40000 * 10**1 * 10**_decimals; // modifier to after each successfull swapandliquify disable the swapandliquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(50); // Max number of tokens that an address can hold 2% of total supply
