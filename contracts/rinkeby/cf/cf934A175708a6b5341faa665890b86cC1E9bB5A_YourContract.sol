...
contract YourContract is VRFConsumerBase {
  ...
  function blockDifficult() public view returns(uint) {
  ...
  function requestIdsLength() public view returns (uint256) {
    return requestIds.length;
  }

  function getRequestIdByIndex(uint i) public view returns (bytes32) {
    return requestIds[i];
  }
