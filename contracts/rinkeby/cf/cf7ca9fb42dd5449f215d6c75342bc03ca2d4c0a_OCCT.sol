...
1% Marketing Wallet
3% Automatic Burn to dead wallet for every transaction

2Q Max Buy Limit per transaction

Anything that can be use for RUG, we want it removed
Contract can NOT mint additional tokens
We can discuss game API and gas fees and BSC chainlink tomorrow
*/
...
contract OCCT is Context, IERC20, Ownable {
    ...
    address private marketingWallet = 0x9bcBE4Af33C43E12c82d2fcD77DF6AF7F82174A2; // Acc1 
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // test net 
