...
contract Market {
    ...
    event PushItem(uint256 indexed tokenId, address indexed seller, uint256 startPrice, uint256 endPrice, uint256 startTime, uint256 duration);
    event Buy(uint256 indexed tokenId, address indexed seller, address indexed buyer, uint256 price, uint256 time);
    ...
    function buy(uint256 tokenId) public payable returns(bool){
        ...
        emit Buy(tokenId, addressOwner, msg.sender, priceItem, now);
    ...
    function pushItemSell(uint256 tokenId, uint256 startPrice, uint256 endPrice, uint256 duration) public {
        ...
        listSell[tokenId].seller = msg.sender;
        ...
        emit PushItem(tokenId, msg.sender, startPrice, endPrice, now, duration);
    }
