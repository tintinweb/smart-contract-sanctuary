...
contract ObscuraCurated is ERC721Enumerable, AccessControlEnumerable, IERC2981 {
    ...
    // TODO: add events for all write functions
    ...
    function mintTo(address to, uint256 projectId)
        external
        onlyRole(MINTER_ROLE)
    {
        ...
        uint256 tokenId = (projectId * DIVIDER) + (circulatingPublic);
    ...
    function getProjectPrice(uint256 projectId)
        external
        view
