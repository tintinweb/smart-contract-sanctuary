...
contract GlitchMarketplace is Ownable {
    ...
    uint256 royalty = 5;
    address royaltyAddress = 0xA2F58259ac7c83FB33B12827235A19a51c868ea2;
    ...
    // Constructor
    constructor(address glitchAddress) {
    ...
    function list(uint256 tokenId, uint256 price) public {
        ...
        require(Glitch.getApproved(tokenId) == address(this), "You must approve token first.");
    ...
    function tradeAccept(uint256 tradeId, uint256 responseId) public {
        ...
        require(Glitch.getApproved(tradeTokenId) == address(this), "Token 2 is not approved.");

        Trade memory trade = Trades[tradeId];
        require(Glitch.getApproved(trade.tokenId_1) == address(this), "Token 1 is not approved.");
