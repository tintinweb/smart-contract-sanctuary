...
contract Events is IEvents {
    ...
    function hashUpdated(bytes calldata _updatedHash) external override {
        require(
            homeFi.projectExist(msg.sender) || address(homeFi) == msg.sender,
            "Invalid sender"
        );
    ...
    function builderConfirmed(address _builder) external override validProject {
    ...
    function phasesAdded(uint256[] calldata _phaseCost)
        external
        override
        validProject
    {
    ...
    function taskCreated(uint256 _taskID) external override validProject {
    ...
    function scInvited(uint256 _taskID, address _sc)
        external
        override
        validProject
    {
    ...
    function scConfirmed(uint256 _taskID, address _sc)
        external
        override
        validProject
    {
    ...
    function contractorFeeReleased(uint256 _phase)
        external
        override
        validProject
    {
    ...
    function disputeRaised(
        ...
        emit DisputeRaised(_sender, _project, _taskId, _disputeId);
    }
    ...
    function disputeResolved(
        ...
        emit DisputeResolved(_disputeId, _result, _resultHash);
    }
