...
contract BNBPunks is Context,  AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage{
  ...
  uint public mintPrice = 400000000000000000;
  ...
  /**
    ...
    * See {ERC721-tokenURI}.
    */
  constructor() ERC721("BNBPunks", "bPunks") {
      _price = mintPrice;
      _max = max;
      _admin = address(0x13168bbb0257aB6f463ef06b276761E072DC39aE);
  ...
  function setPrice(uint _mintPrice) external {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "BNBPunks: must have admin role to change price");
    _price = _mintPrice;
    mintPrice = _mintPrice;
  }
  
  function setReflectionFee(uint _reflectionFee) external {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "BNBPunks: must have admin role to change reflection");
    reflectionFee = _reflectionFee;
  }

  function setMax(uint _maxNum) external {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "BNBPunks: must have admin role to change max");
    _max = _maxNum;
  }
