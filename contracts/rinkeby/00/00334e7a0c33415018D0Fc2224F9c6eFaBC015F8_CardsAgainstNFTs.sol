...
Cards Against NFTs is a fun experiment to explore the idea of an on-chain
community created game. When this experiment succeeds, an on-chain 
contract will have brought the community together to create a card deck. 
Note that only the game creation is on-chain. Not the game play itself. 
This game is best experienced when played face to face. 

Black and white cards minted using this contract will become part
of the inaugural deck we'll publish on December 1st 2021. We'll setup 
a DAO to decide further course of action based on community interest.
