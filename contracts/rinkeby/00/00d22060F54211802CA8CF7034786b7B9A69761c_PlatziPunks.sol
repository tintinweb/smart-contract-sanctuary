...
contract PlatziPunksDNA {
    ...
    // This is a deterministic functions and should be used in production
    function deterministicPseudoRandomDNA(uint256 _idToken, address _minter) 
        public
        pure
        returns(uint256)
    {
        uint256 combinedParams = _idToken + uint160(_minter);
        ...
        returns (uint8)
    {
        return uint8(
            ...
            (1 * 10**(_rightDiscard + ADN_SECTION_SIZE))
        );
    }
