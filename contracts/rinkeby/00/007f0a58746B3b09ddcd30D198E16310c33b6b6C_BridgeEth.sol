...
contract BridgeEth is Initializable {
  ...
  function transferToContract(address to, uint amount) external { //burn
  ...
  function transferFromContract(address to, uint amount, uint otherChainNonce) external {  //mint
