...
contract PlanetNFT is ERC721Tradable {
    ...
    function create_random(uint256 tokenId,
        ...
        int16 positionX=int16(600-size)-int16(uint16(randomNum((1200-size)*2, seedfinal, block.timestamp)));
        int16 positionY=int16(600-size)-int16(uint16(randomNum(1200-size, seedfinal, block.timestamp)))-200;
    ...
    function validateParams(
        ...
        require(bytes(color2).length>0, "invalid color2");
        require(size > 0 && size < 500, "invalid width size");
        ...
        require(roation[0] > 0 && roation[0] < 800, "invalid roation x");
        require(roation[1] > 0 && roation[1] < 800, "invalid roation y");
        require(roation[2] > 0 && roation[2] < 360, "invalid roation angle");
