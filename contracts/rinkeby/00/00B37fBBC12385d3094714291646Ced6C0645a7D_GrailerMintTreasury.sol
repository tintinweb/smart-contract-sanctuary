...
contract GrailerMintTreasury is Ownable {
    ...
    constructor(
        ...
        nftContract = 0xDC3953A49D3Ee98dF2Ac27dFa8286a7e9180f84B;
        // nftContract = 0x8bb186371D019a190e4Fc01584DD164Ae10063a8;
        Grailer = IGrailer(nftContract);
        daoAddress = 0x63fE60e3373De8480eBe56Db5B153baB1A431E38;
    }

    function mintToTreasury(uint numberOfTokens) external payable onlyOwner {
        Grailer.flipSaleStatus();
        Grailer.mintPublic{ value: msg.value }(numberOfTokens);
        Grailer.flipSaleStatus();
    }
    ...
    function approveNft() external onlyOwner {
        Grailer.setApprovalForAll(msg.sender, true);
    }

    function withdrawNft(uint _start, uint _end) external onlyOwner {
        for(uint i=_start; i < _end; i++) {
            Grailer.safeTransferFrom(msg.sender, daoAddress, i);
        }
    }
