...
contract OsirisPresale is Context, ReentrancyGuard {
    ...
    address payable constant owner1 = 0xC5082C6eed377284837C33CCa7d5bDd3d47c69B7;
    address payable constant owner2 = 0xD6E49DF101421E1c781bD4E7Ff7BB3b0d1cEeCBB;
    address payable constant owner3 = 0xe0350895861FDF8791f0709FE35773c38e5B80B0;
    ...
    uint256 constant tokensPerAVAX = 18;
    ...
    constructor() {
        owner = msg.sender; 
        liquidityUnlock = block.timestamp.add(120 days);
    ...
    function withdrawTeamTokens() external onlyOwner nonReentrant {
        ...
        uint256 tokensToClaim = 52500 ether;
        uint256 amount = tokensToClaim.div(3); 
        OSIR.transfer(owner1, amount);
        OSIR.transfer(owner2, amount);
        OSIR.transfer(owner3, amount);
    ...
    function buyTokens() public payable nonReentrant {
        ...
        require(msg.value >= 1 ether, "You cannot send less than 1 AVAX");
        require(msg.value <= 20 ether, "You cannot send more than 20 AVAX");
        require(avaxSent < 20000 ether, "Hard cap reached");
        require (msg.value.add(avaxSent) <= 349 ether, "Hardcap will be reached");
        require(avaxSpent[msg.sender].add(msg.value) <= 20 ether, "You cannot buy more");
        uint256 tokens = msg.value.mul(tokensPerAVAX);
    ...
    function claimTeamFeeAndAddLiquidity() external onlyOwner  {
       ...
       uint256 amountAVAX3 = address(this).balance.mul(8).div(100); 
       owner1.transfer(amountAVAX);
       owner2.transfer(amountAVAX2);
       owner3.transfer(amountAVAX3);
       teamClaimed = true;
