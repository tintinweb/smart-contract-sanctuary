...
contract ChainlinkYoutube is ChainlinkClient, Ownable {
    ...
    function twitterFullfill(bytes32 _requestId1, uint256 _followerCount) public onlyOwner recordChainlinkFulfillment(_requestId1) {
    ...
    function youtubeFullfill(bytes32 _requestId2, uint256 _youtubeSub) public onlyOwner recordChainlinkFulfillment(_requestId2){
