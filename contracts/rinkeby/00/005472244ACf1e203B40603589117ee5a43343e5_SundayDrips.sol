...
contract SundayDrips is ERC721, Ownable {
    ...
    uint256 public sunriseAvailable = 1330;
    uint256 public sunsetAvailable = 667;
    uint256 public midnightAvailable = 225;
    ...
    uint256 public constant timeDelta = 12 hours;

    // Amount of ETH to increase every 'timeDelta'
    uint256 public constant priceDelta = 0.0005 ether;
    ...
    constructor(string memory metadataBaseURI) ERC721("Sunday Drips", "DRIPS") {
