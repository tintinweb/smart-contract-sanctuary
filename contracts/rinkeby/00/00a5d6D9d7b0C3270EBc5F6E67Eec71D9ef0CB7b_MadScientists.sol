...
contract MadScientists is ERC721Enumerable, Ownable {
    ...
    address a2 = 0x7d52923Ca0135F59B15986FCADeC7107758BbeFd;
    ...
    function preSaleMint(uint256 mintCount) public payable {
        ...
        require(mintCount <= 5,                    "max_presale_mint_count_exceeded");
        require(balanceOf(msg.sender) <= 1,         "presale_wallet_limit_met");
        require(supply < 25,                       "max_token_supply_exceeded");
