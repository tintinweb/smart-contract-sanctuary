...
contract VariousBooks is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    ...
    //   '<path class="flag" fill="', getSpineColor(tokenId),'" d="M100,31c-8.118,0-8.364,4.504-16.471,4.504',
    ...
    '<defs>',
      '<path id="first-band" fill="#0067C6" d="M699.43,231.07c-87.37,0-87.37,20-174.74,20s-87.37-20-174.74-20-87.36,20-174.72,20-87.37-20-174.73-20v-83c87.36,0,87.36,20,174.73,20s87.36-20,174.72-20,87.37,20,174.74,20,87.37-20,174.74-20Z"/>',
      '<path id="second-band" fill="#FFFFFF" d="M699.43,319.07c-87.37,0-87.37,20-174.74,20s-87.37-20-174.74-20-87.36,20-174.72,20-87.37-20-174.73-20v-83c87.36,0,87.36,20,174.73,20s87.36-20,174.72-20,87.37,20,174.74,20,87.37-20,174.74-20Z"/>',
      '<path id="third-band" fill="#C9A504" d="M699.43,407.07c-87.37,0-87.37,20-174.74,20s-87.37-20-174.74-20-87.36,20-174.72,20-87.37-20-174.73-20v-83c87.36,0,87.36,20,174.73,20s87.36-20,174.72-20,87.37,20,174.74,20,87.37-20,174.74-20Z"/>',
    '</defs>',

    '<use xlink:href="#first-band" x="0" y="0">',
        '<animate attributeName="x" from="0" to="-350" dur="1s" repeatCount="indefinite"/>',
    '</use>',
    '<use xlink:href="#second-band" x="0" y="0">',
        '<animate attributeName="x" from="0" to="-350" dur="1s" repeatCount="indefinite"/>',
    '</use>',
    '<use xlink:href="#third-band" x="0" y="0">',
        '<animate attributeName="x" from="0" to="-350" dur="1s" repeatCount="indefinite"/>',
    '</use>',
    '</svg>'
      ));
