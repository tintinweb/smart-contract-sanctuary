...
contract Nornir is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBase {
	...
	function createVikingDataset(uint256 randomNumber1, uint256 randomNumber2, bool conditionNeeded) internal pure returns (string memory) {
		if (conditionNeeded) {
			// Type - Condition - Value
			return string(abi.encodePacked(randomNumber1, '_', statNumberToName(randomNumber2), '_', randomNumber2));
		}

		// Type - Value
		return string(abi.encodePacked(randomNumber1, randomNumber2));
	}
	...
	function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
		...
		vikings.push(
			Viking(
				createVikingDataset((randomNumber % 100), (randomNumber % 10000) / 100, true),
				createVikingDataset((randomNumber % 1000000) / 10000, (randomNumber % 100000000) / 1000000, true),
				createVikingDataset((randomNumber % 10000000000) / 100000000, (randomNumber % 1000000000000) / 10000000000, true),
				createVikingDataset((randomNumber % 1000000000000) / 10000000000, (randomNumber % 100000000000000) / 1000000000000, true),
				createVikingDataset((randomNumber % 100000000000000) / 1000000000000, (randomNumber % 10000000000000000) / 100000000000000, false)
				// weapon
				// (randomNumber % 100),
				// // attack
				...
				// // top
				// (randomNumber % 1000000000000000000000000000000) / 1000000000000000000000000000
			)
		);
