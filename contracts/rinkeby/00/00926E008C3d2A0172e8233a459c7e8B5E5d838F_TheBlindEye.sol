...
contract TheBlindEye is ERC721EnumerableB, Ownable, ReentrancyGuard {
  ...
  uint public constant PRICE = 0.054 ether;
  uint public preSalePrice = 0.054 ether;
