...
contract WOWPixies is ERC721, Ownable {
    ...
    bytes32 public merkleRoot = 0x27e35a316792d608873f05f56059e5195f402f90e7fd6e2af152549ac686ed84;
    ...
    function mintWhitelist(bytes32[] calldata _merkleProof, uint amount) public payable onlyOwner {    
        require(presaleIsActive, "Sale must be active to mint");
        require(!whitelistClaimed[msg.sender], "Address has already claimed");
        require(amount <= 5, "Can only mint 5 tokens at a time");
        require(currentIndex + amount <= 5555, "Purchase would exceed max supply of");
        require(0.06 ether * amount <= msg.value, "Ether value sent is not correct");
