...
// File: contracts/WinOrBurn.sol


pragma solidity ^0.8.0;

/*
These contract for minting nft all eth will send or burn
*/
...
contract WinOrBurn is ERC721Enumerable, ERC721URIStorage, Ownable {

    event Claim (address indexed buyer, uint256 startWith, uint256 batch);
    event Winner (address indexed winner);
    event WinOrBurncoy ();

    uint256 public totalCount = 100;
    uint256 public maxBatch = 10; 
    uint256 public price = 0.001 * 10**18; //Mint Price
    string public baseURI = "ipfs://QmWy67tFHAh1n4NVyC3mNfsqc67cCsw5TQA2VPiym4oR7u/";
    bool private _started = false;
    uint public endDate = 0;

    constructor()
    ERC721("WinOrBurn", "WinOrBurn")
    {}
