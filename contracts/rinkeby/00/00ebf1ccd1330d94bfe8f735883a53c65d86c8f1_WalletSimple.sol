...
contract WalletSimple {
  ...
  */
  ...
  function showdeployerAddressAS()public view returns(address, address){
      
      address inz = WalletFactory(walletFactoryAddress).showDeployerAddress();
      address inz2 = WalletFactory(walletFactoryAddress).deployer();
