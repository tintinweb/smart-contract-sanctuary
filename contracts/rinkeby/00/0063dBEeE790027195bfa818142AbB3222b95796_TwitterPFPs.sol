...
contract TwitterPFPs is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("TwitterPFPs", "TWPFP") {
  ...
  function mint(string memory tokenURI_) public payable nonReentrant {
    ...
    tokenURIMap[totalSupply()] = tokenURI_;
  }
