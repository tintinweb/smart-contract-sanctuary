...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 0.1 hours; // min 1 hour delay
    uint256 public minDistribution = 0.1 * (10 ** 18); // 1 BUSD minimum auto send
...
contract KKC is IBEP20, RSunAuth {
    ...
    address BUSD = 0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b;
