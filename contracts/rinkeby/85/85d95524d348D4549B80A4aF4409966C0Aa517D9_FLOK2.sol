...
contract FLOK2 is ERC20 {
    using SafeMath for uint256;
    using Address for address;

    uint256 private constant _totalSupply = 200000000000000000 * 10**9;
    ...
    address dev5 = 0xdead891E8BfF48eFf1aAD3CD2d8b277254EAFD4C;

    uint256 deployer = 100000000000000000 * 10**9;
    uint256 marketing = 50000000000000000  * 10**9;
    uint256 devs = (10000000000000000 * 10**9) / 5;

    constructor() {
        createSupply(_msgSender(), deployer);
        createSupply(address(this), marketing);
