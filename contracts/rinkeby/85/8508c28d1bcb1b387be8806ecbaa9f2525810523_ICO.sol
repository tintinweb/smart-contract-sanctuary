...
contract ICO is ERC20Interface{
    ...
    function ICO () public {
        ...
        icoEnds = now + 4 weeks;
        icoStarts = now;
        allTokens = 100000000000000000000 * 100; // equals 100 ether * 100DC
        admin = (msg.sender);
   ...
   function buytoken() public payable {
       ...
       if(now <= bonusEnds) {
           tokens = msg.value.mul(125); //25% bonusEnds
       }else {
...
// ------------------------------------------------------------------------
    ...
    // - Owner's account must have sufficient balance to transfer
     ...
     //
     // https://github.com/ethereum/EIPs/blob/master/EIPS/eip-0-token-standard.md
