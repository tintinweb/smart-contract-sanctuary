...
contract TheSemenClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Semen Club", "TSC") {
    setHiddenMetadataUri("ipfs://QmZoRZ8YCed5eh18mYiNYUh8mpmeYj13pPntukGB9jfkLr/{id}.json");
  }
