...
contract MonsterbudsV2 is MonsterBudHolders, ERC721URIStorageUpgradeable, IMonsterBudsV2 {
    ...
    */
    ...
    function freeMint() external override returns(uint256) {
        ...
        emit FreeTokenDetails(msg.sender, _uri, newItemId, false);
    ...
    function createPPPcollectible(uint256 _tokenId) external returns (uint256){
        require(_tokenId <= 200 && ownerOf(_tokenId) == msg.sender ,"$MONSTERBUDS: Not a PPP Token or owner of PPP token");
        ...
        emit FreeTokenDetails(msg.sender, token_uri, newItemId, true);
        return newItemId;
