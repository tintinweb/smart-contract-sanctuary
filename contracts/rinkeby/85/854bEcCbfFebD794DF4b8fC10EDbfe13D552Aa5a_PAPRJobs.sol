...
contract Escrow is Migratable {
    ...
    event OnCreateEscrow(address indexed dapp, address indexed client, address indexed provider, uint256 amount, uint256 paprLPBalance, uint256 proofDeposit);
    ...
    function returnPPFS() public view returns (uint256) {

       return IPAPRBUSDVault(vault).getPricePerFullShare();
    }
    ...
    returns (uint256) {
        ...
        uint256 proofOfDeposit = returnPPFS();
        ...
        emit OnCreateEscrow(escrowDapp, _client, _provider, _amount, paprLPBalance, proofOfDeposit);
    ...
    function returnProof(uint _escrowId) public view returns (uint256) {

       return escrows[_escrowId].proofofdeposit;
    }
    ...
    function withdraw(uint _escrowId) public {
        ...
        uint256 computeWithdraw = LPdeposited.div(toWithdraw);
