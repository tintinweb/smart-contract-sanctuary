...
contract RawLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  // Set public price
  uint256 private public_price = 5000000000000000; //0.005 ETH
  ...
  function mintWithLoot(uint256 lootId, uint256 tokenId) external nonReentrant {
    ...
    require(tokenId >= 50000 && tokenId < block.number.div(100), "Token Id must between 50000 and the latest block divided by 100");
