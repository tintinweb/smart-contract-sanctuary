...
import "./interfaces/IMasterERC777.sol";
import "../ERC20/ListAddressContract.sol";
import "../../access/GroupOwnerUpgradeable.sol";
import "../../proxy/Initializable.sol";

contract MasterERC777 is Initializable, GroupOwnerUpgradeable {
  Dictionary private config;
  IMasterERC777 private iMasterERC777;
  ...
  function createTokenERC777(
    ...
    iMasterERC777 = IMasterERC777(s);
    iMasterERC777.createERC777(name, symbol, decimal, initialSupply, _cap);
...
contract GroupOwnerUpgradeable is Initializable {
  ...
  function __GroupOwnable_init() internal initializer {
    __GroupOwnable_init_unchained();
  }

  function __GroupOwnable_init_unchained() internal initializer {
  ...
  modifier groupOwner() {
    require(
      checkOwner(msg.sender) || owner() == msg.sender,
