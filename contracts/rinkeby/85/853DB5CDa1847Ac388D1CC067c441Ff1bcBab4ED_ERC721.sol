...
*/
    ...
    function mint(address to, uint256 tokenId) public onlyOwner {
        ...
        if(totalSupply == 0)
            require(tokenId == 1 , "ERC721 :: _mint: Token ID should be 1");
        else 
    ...
    function testConversions() public {
        ...
        string memory stg  = new string(51);
        string memory stg2 = new string(51);
       // stg = "QmRHrPGvS94kr2QCYvviFCVAgKoQ3xMBgxN53dM9zXiG99";
       stg = "QmRjANc5rCFECnc479uccVQUk3jFHzm3DsT5T1oThkaKsn";
        uint offset = sizeOfString(stg);
        console.log(offset);
        stringToBytes(offset, bytes(stg), buffer);
        bytesToString(offset,buffer, bytes(stg2));
