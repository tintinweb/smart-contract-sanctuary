...
interface ITestYield is IERC20{
    ...
    function burnFrom(address account, uint256 amount) external;
    function burn(address _address, uint256 _count) external;
    function updateRewardOnTransfer(address _from, address _to) external;
    function updateReward(address _address) external;
    function rewards(address _address) external view returns(uint256);
    function claimReward(address _to) external;
    function lastTime(address _address) external view returns(uint256);
    }
...
contract ChainedApes is ERC721Enumerable {
    ...
    function transferFrom(address from, address to, uint256 tokenId) public override {
		testYield.updateRewardOnTransfer(from, to);
		addressBalance[from]--;
		addressBalance[to]++;
    ...
    function claimRewards() external {
        testYield.claimReward(msg.sender);
    }
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
    ...
    function mintInternal() internal {
        ...
        testYield.updateReward(msg.sender);
    ...
    function mintApeWithToken() public {        
        ...
        testYield.burn(msg.sender, 1000000000000000000);
        return mintInternal();
    }
