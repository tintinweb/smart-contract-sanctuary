...
contract CryptoWords is ERC721, ERC721Enumerable, Ownable {
    ...
    string public WORDS_PROVENANCE = "";
    uint256 public startingIndex;

    bool private _saleStarted;
    // string public baseURI;

    constructor() ERC721("CryptoWords", "WORDS") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://metadata.buildship.dev/api/token/cryptowords/";
    }
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        WORDS_PROVENANCE = provenanceHash;
    }
