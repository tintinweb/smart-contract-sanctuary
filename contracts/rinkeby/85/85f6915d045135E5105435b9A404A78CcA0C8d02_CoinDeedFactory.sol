...
contract CoinDeedFactory is ICoinDeedFactory, AccessControl {
    ...
    address public override feedRegistryAddress;
    ...
    uint256 public override maxPriceDrop;
    ...
    function setFeedRegistry(address _feedRegistryAddress) public override onlyRole(DEFAULT_ADMIN_ROLE) {
        feedRegistryAddress = _feedRegistryAddress;
    }

    function setTreasuryAddress(address _treasuryAddress) public override onlyRole(DEFAULT_ADMIN_ROLE) {
