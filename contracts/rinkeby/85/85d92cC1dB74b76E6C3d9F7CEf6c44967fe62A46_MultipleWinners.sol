...
contract MultipleWinners is PeriodicPrizeStrategy {
    ...
    function _distribute(uint256 randomNumber) internal override {
        ...
        address mainWinner = tulipFarm.draw(randomNumber);
    ...
    OwnableUpgradeable
{
    ...
    /// @param _tulipFarm The staking contract used to draw winners
    ...
    /// @param secondsPerBlockMantissa The number of seconds per block to use for the calculation.
    ///        Should be a fixed point 18 number like Ether.
    ...
    function startAward() external requireCanStartAward {
        ...
        // Tell the TulipFarm contract to pause deposits and withdrawals
    ...
    function cancelAward() public {
        ...
        // Tell TulipFarm contracts that deposits/withdrawals are live again
        tulipFarm.finishDraw();
