...
contract GOLDIAMA is ERC20PresetMinterPauser, ERC20Capped, Ownable {
    ...
    constructor(string memory name, string memory symbol, uint256 _initialSupply, uint256 supply) ERC20PresetMinterPauser(name, symbol)  ERC20Capped(supply * 10 ** 8) public{
