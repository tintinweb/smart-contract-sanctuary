...
contract Flokitar is ERC721, Ownable {
    ...
    uint256 public constant GENESIS_MINT_COST = 0.0003 ether;
    uint256 public constant REGULAR_MINT_COST = 0.0005 ether;
    ...
    uint256 public constant RARE_NFT_RANGE = 100;
    ...
    function mint(uint256 _number) external payable {
        ...
        bool _isGenesisHolder = _hasGenesisNFT(msg.sender);
    ...
    function _hasGenesisNFT(address _account) private view returns (bool) {
