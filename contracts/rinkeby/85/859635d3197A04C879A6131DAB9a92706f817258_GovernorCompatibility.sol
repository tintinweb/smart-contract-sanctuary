...
contract GovernorCompatibility is GovernorCompatibilityBravo, GovernorTimelockControl, GovernorVotes {
    constructor(
        string memory name_,
        ERC20Votes token_,
    ...
    function queue(
        ...
        bytes[] memory calldatas,
        bytes32 salt
    ) public virtual override(GovernorTimelockControl, GovernorCompatibilityBravo) returns (uint256) {
