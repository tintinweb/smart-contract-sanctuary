...
contract InteractionProxyDeployer is ERC2771Context {
  ...
  function _init(address _uniswapProxy, address router_, address factory_) internal {
    UniswapInteractionProxy(_uniswapProxy).initialize(router_, factory_);
  }
  ...
  function deploy(bool choice) external {
    ...
    _init(_proxyAddress, _router, _factory);
