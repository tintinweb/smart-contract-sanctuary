...
contract SmartLease {
    ...
    function contract_status() internal returns (CONTRACT_STATUS) {
        return status;
    }

    function get_contract_balance() public view only_lessee returns (uint256) {
    ...
    function transfer_full_monthly_lease_payment_to_contract_balance()
        public
        payable
        only_lessee
        returns (bool)
    ...
    function transfer_money_to_lessor(uint256 _amount) internal {
