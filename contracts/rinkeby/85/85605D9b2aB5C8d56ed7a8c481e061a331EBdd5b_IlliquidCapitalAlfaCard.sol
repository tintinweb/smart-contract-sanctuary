...
contract IlliquidCapitalAlfaCard is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    mapping(address => uint256) public allocationCount;

    event CreateCard(uint256 indexed id);
    constructor() ERC721("AlfaCard", "ALFA") {
        pause(true);
    }
    ...
    function mint(address _to, uint256 _count) public payable saleIsOpen {
        ...
        require(allocationCount[msg.sender] < 1, "Allocation limit reached");
