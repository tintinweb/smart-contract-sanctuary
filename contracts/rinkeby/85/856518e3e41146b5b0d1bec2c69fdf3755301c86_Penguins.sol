...
// NOTE: https://xtremetom.medium.com/cool-cats-contract-improvements-8643fcbc7fb9
contract Penguins is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0xD8B3AffA8747b9aea0f60FF97D7797942276Fcda; // Dheeraj
    address t2 = 0x4Ee34BA6c5707f37C8367fd8AEF43F754435F588; // 0xkowloon
    // TODO: Change it to Morphs' address here.
    address t3 = 0x1b33EBa79c4DD7243E5a3456fc497b930Db054b2; // Morphs
    // TODO: Change it to Gnosis Safe address here.
    address t4 = 0xC257274276a4E539741Ca11b590B9447B26A8051; // Multisig

    constructor(string memory baseURI) ERC721("Penguins", "PENGUINS") {
        setBaseURI(baseURI);
    }

    function adopt(uint256 num) external payable {
        uint256 supply = totalSupply();
        require(!_paused, "Sale paused");
        require(num < 21, "You can adopt a maximum of 20 Penguins");
        require(supply + num <= 1000 - _reserved, "Exceeds maximum supply");
