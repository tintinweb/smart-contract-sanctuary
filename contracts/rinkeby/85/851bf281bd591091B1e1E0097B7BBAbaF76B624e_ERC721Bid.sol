...
// contracts/ERC721BidStorage.sol
...
contract ERC721Bid is Ownable, Pausable, ERC721BidStorage {
    ...
    */
    constructor(address _goodOneToken, address _owner) Ownable() Pausable() {
    ...
    */
        ...
        whenNotPaused()
    {
        ...
        if (bidFeePerMillion > 0) {
            ...
            require(
                goodOneToken.transferFrom(msg.sender, owner(), feeAmount),
    ...
    */
        ...
        returns (bytes4)
    {
        ...
        if (ownerCutPerMillion > 0) {
            ...
            require(
                goodOneToken.transferFrom(bidder, owner(), saleShareAmount),
                "Transfering the cut to the bid contract owner failed"
            );
        }

        // Transfer GOOD from bidder to seller
        require(
            goodOneToken.transferFrom(bidder, _from, price.sub(saleShareAmount)),
            "Transfering GOOD to owner failed"
        );
        ...
        if (inflationPerMillion > 0) {
            ...
            // Transfer share amount to the bid conctract Owner
            goodOneToken.mint(owner(), mintShareAmount);
        }
    ...
    * to use bidder GOOD on his belhalf
    ...
    */
    function _requireBidderBalance(address _bidder, uint256 _amount) internal view {
        ...
        require(
            ...
            "The contract is not authorized to use GOOD on bidder behalf"
        );        
    }
}