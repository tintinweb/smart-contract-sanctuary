...
contract AcyV1Arbitrage is IAcyV1Arbitrage{
    ...
    event PrintError(bool success, bytes data);
    ...
    function swap(uint amountIn,address inputToken,address outputToken) payable external {
        ...
        (bool success, bytes memory data) = inputToken.call(abi.encodeWithSelector(0x23b872dd, msg.sender, UniswapV2Library.pairFor(factory, arr[0], arr[1]), amountIn));
        emit PrintError(success, data);
