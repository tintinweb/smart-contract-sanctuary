...
contract ChillCubes is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    IERC721 punkin = IERC721(0x0aBB3916532F4D574e7DB5a69EBff2D1E0F00900);
	//sale settings
    ...
    require(punkin.ownerOf(tokenId) == msg.sender, "Not Owner");
    _safeMint(msg.sender , tokenId);
    }
    //presale minting
	function mintPresale(uint256 _mintAmount) public payable {
	uint256 s = totalSupply() + 666;
	...
	presaleWhitelist[_addresses[i]] = 3;
	}
	}
