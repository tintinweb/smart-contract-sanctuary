...
contract rabishshark is Ownable, ERC721 {
    
    uint public tokenPrice = 0.01819 ether;
    uint constant maxSupply = 1080;
    uint public presale_price = 0.01819 ether;
    ...
    constructor() ERC721("Rabish shark", "RabishShark"){}
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 25 / 100); //test1
        payable(0xc1Efbb6ad2AfD85cA419CfC69b79fA6C4A847C95).transfer(_balance * 25 / 100); //test2
        payable(0xcBaab43eFec1f2abF0A955c1c4f6B420c5778c61).transfer(_balance * 25 / 100); //test3
        payable(0x27C0dE29567fA57Dc2E596f7Fc9b92a9037d2b55).transfer(_balance * 25 / 100); //jeff
