...
contract MergeFaucet is Ownable {
    ...
    EnumerableSet.UintSet redTokens;  // For tier 4
    EnumerableSet.UintSet yellowTokens;  // For tier 3
    EnumerableSet.UintSet blueTokens;  // For tier 2
    EnumerableSet.UintSet tokenIds;  // For all tokens
    ...
    function _exist(uint256 tokenId) private view returns (uint256) {
