...
contract NiftyPass is ERC721, ERC721Enumerable, Ownable,ERC721Burnable {
    ...
    function isOneNFTFree(uint256 numberOfTokens) public view returns (bool) {
        if (MembershipToken.balanceOf(msg.sender) > 0 && isFreeMinted[msg.sender] != true && numberOfTokens == 1 ) return true;
        return false;
    }
    ...
    function mintPass(uint256 numberOfTokens) public payable saleIsOpen {
        ...
        if (isOneNFTFree(numberOfTokens)) {
