	...
	ERC1155Pausable
{
	...
	constructor(string memory uri, address factory) ERC1155(uri) {
		...
		_setupRole(PAUSER_ROLE, factory);
	}
	...
	/**
	 * @dev Creates `amount` new tokens for `to` with existed tokenId
	 *
	 * See {ERC1155-_mint}.
	 *
	 * Requirements:
	...
	function mintMore(
		...
		require(id < _tokenIdTracker.current(), "Can't mint new id");
