            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "animation_url": "',
                        animationUrl,
                        '", "description": "Decks are collectable card game based on crypto primatives. The cards can be unbundled and swapped to improve your deck.", "image": "data:image/svg+xml;base64,',
