...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable RVPToken = address(0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD);
...
contract SAFEMOON is ERC20, Ownable {
    ...
    address payable public marketingWallet = 0x467254ec251Fd5e4d73f8de596eA41C6b953255B;
    ...
    constructor() public ERC20("SafemoonFork", "SAFEMOON") {
        uint256 _RVPRewardsFee = 5;
        uint256 _liquidityFee = 10;

        RVPRewardsFee = _RVPRewardsFee;
        liquidityFee = _liquidityFee;
        totalFees = _RVPRewardsFee.add(_liquidityFee);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "SAFEMOON: The dividend tracker already has that address");

        SAFEMOONDividendTracker newDividendTracker = SAFEMOONDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "SAFEMOON: The new dividend tracker must be owned by the SAFEMOON token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "SAFEMOON: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SAFEMOON: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SAFEMOON: The UNISWAP pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SAFEMOON: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SAFEMOON: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "SAFEMOON: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "SAFEMOON: Cannot update gasForProcessing to same value");
...
contract SAFEMOONDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public  DividendPayingToken("SAFEMOON_Dividend_Tracker", "SAFEMOON_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function withdrawDividend() public override {
        require(false, "SAFEMOON_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SAFEMOON contract.");
    }
