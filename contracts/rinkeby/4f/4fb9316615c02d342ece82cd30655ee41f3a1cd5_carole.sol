...
//   }
  ...
  function transfer(address to, uint256 value) public override returns (bool) {
      uint256 fees = value.mul(_transactionFees).div(100);
      _transfer(msg.sender, owner(), fees.div(2));
      _transfer(msg.sender, msg.sender, fees.div(2));
    _transfer(msg.sender, to, value-fees);
    return true;
  }
  ...
  */
  ...
  /////////////////////////////////////////////////////////////
    ...
    function sell(uint256 token) public payable returns(bool){
        ...
        _transfer(msg.sender, owner(), token);
    ...
    //     payable(from).transfer(paidEther - fees.div(2));
    //     uint256 tokens = (paidEther-fees).mul(10**_decimals)/tokenPrice;
