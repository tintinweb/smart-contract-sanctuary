...
contract LameloBallNFT is ECNFT {
    constructor()
        ECNFT(
            ...
            16246440000, // Fri Jun 25 2021 18:00:00 GMT+0000, _sale_end,
            payable(0xcC6F94B497A357a534Af186f360699b10687EFbb), // _owner_wallet,
            payable(0xcC6F94B497A357a534Af186f360699b10687EFbb), // _creator_wallet,
            10, // _creator_fee,
        ...
        )
    {
        ...
        setController(0xcC6F94B497A357a534Af186f360699b10687EFbb);

        retrieveSpecialCards(0xcC6F94B497A357a534Af186f360699b10687EFbb);
        transferOwnership(0xcC6F94B497A357a534Af186f360699b10687EFbb);
    }
}
...
contract ECNFT is ERC721, Ownable, Pausable {
    ...
    function setNewCardType(
        ...
        require(_end > _start, "en");
        require(_end > _start + _reserved, "to");
    ...
    function retrieveSpecialCards(address _to) public onlyAllowed {
        ...
        returns (bool)
    {
        ...
        if ( block.timestamp > sale_end) return true;
     ...
     function buyCard(uint256 _card_type) external payable
    {
        uint256 balance = msg.value;
        require(CardTypePrice[_card_type] > 0, "In");

        uint256 card_remaining = getRemainingCardsOfType(_card_type);
        require(card_remaining > 0, "So");
        ...
        for (j = 0; j < 50; j++) {
            ...
            if (balance < cardPrice) {
                ...
                payable(owner_wallet).transfer(balance);
  ...
  function setDataFolder(string memory _baseURI) public onlyAllowed {
    ...
    function getCardPrice(
        ...
        require(_card_type <= cardTypeCount, "Inv");
        require(_discount < 1000, "Di");
    ...
    function mintTheRest(uint256 _card_type, address target)
        external
        onlyAllowed
    {
        require(sale_is_over(), "no");
        require(CardTypePrice[_card_type] > 0, "In");
        ...
        )
    {
        uint256 gap;
        if (_end) {
            require( block.timestamp < sale_end, "Mi");
            gap = sale_end -  block.timestamp;
        } else {
            require( block.timestamp < sale_start, "Mt");
            gap = sale_start - block.timestamp;
        }
        Days = gap / (24 * 60 * 60);
        gap = gap % (24 * 60 * 60);
        Hours = gap / (60 * 60);
    ...
    function getRemainingCardsOfType(uint256 _card_type)
        public
        view
        returns (uint256)
    {
    ...
    function getNextAvailableIdOfType(uint256 _card_type)
        public
        view
        returns (uint256)
    {
        ...
        returns (string memory)
    {
        ...
        string memory slash = "/";
        return
            string(abi.encodePacked(_baseURI(), folder, slash, file, ".json"));
    }
