...
contract NFace is NPassCore {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        parts[
            16
        ] = ' 100,150 " /></defs><rect width="100%" height="100%" fill="white" /><g transform="translate(175,75)"><use xlink:href="#l" /><use transform="translate(-100,0)" xlink:href="#r" /><use xlink:href="#n" /><use xlink:href="#m" /><use xlink:href="#c" /></g></svg>';
