...
contract T02Staking is Owned {
    ...
    function stake(uint256 _amount) public {
        ...
        t02.transferFrom(msg.sender, address(this), _amount);
        uint256 burnedAmount = (_amount * 12) / 100;
        if (t02.totalSupply() - burnedAmount >= t02.minSupply()) {
            t02.burn(burnedAmount);
        } else {
            burnedAmount = 0;
        }
        uint256 communityWalletAmount = (_amount * 3) / 100;
        t02.transfer(communityWallet, communityWalletAmount);
    ...
    function withdraw() public {
        ...
        t02.transfer(msg.sender, balance);
    ...
    function claimReward() public {
        ...
        t02.transfer(msg.sender, reward);
    ...
    function initNewRewardPeriod() external {
        ...
        uint256 rewardPool = t02.balanceOf(address(this)) - totalAmountStaked;
        ...
        t02.transfer(msg.sender, initializationReward);
