    ...
    AccessControlUpgradeable
{
    ...
    function totalValue(uint256 currentIncomeIndex) external view virtual returns (uint256); // The total value locked in the money market, in terms of the underlying stablecoin
...
contract CompoundERC20Market is MoneyMarket {
    ...
    function totalValue(uint256 currentIncomeIndex) external view override returns (uint256) {
        uint256 cTokenBalance = cToken.balanceOf(address(this));
