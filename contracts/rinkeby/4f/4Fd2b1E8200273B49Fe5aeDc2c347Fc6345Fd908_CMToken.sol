...
contract CMToken is ERC20, ERC20Burnable, Pausable {
    ...
    constructor(address _accessControl) ERC20("CMToken", "CMT") {
    ...
    // {
    //     require(
    //         accessControl.hasRole(WHITELISTED_ROLE, account),
    //         "Account not whitelisted"
    //     );
    ...
    //     bool senderIsWhitelisted = accessControl.hasRole(
    //         WHITELISTED_ROLE,
    //         msg.sender
    //     );
    //     bool recipientIsWhitelisted = accessControl.hasRole(
    //         WHITELISTED_ROLE,
    //         account
    //     );

    //     require(
    //         senderIsWhitelisted && recipientIsWhitelisted,
    //         "Illegal transfer between non whitelisted addresses"
    //     );
    ...
    function _beforeTokenTransfer(
        ...
        require(
            _validateIfOnWhitelist(to),
            "Illegal transfer: recipient not whitelisted"
        );
    }

    function _validateIfOnWhitelist(address account)
        private
        view
        returns (bool)
    {
        bool isAddressWhitelisted = accessControl.hasRole(
            WHITELISTED_ROLE,
            account
        );
