...
contract ShoefyStaking2 is Ownable{
    ...
    IERC20 public shoefy = IERC20 (0xdacD69347dE42baBfAEcD09dC88958378780FB62);

    uint256 year = 365;
    
    constructor(){
        //times.push(2592000); // 30 days
        //times.push(5184000); // 60 days
        //times.push(7776000); // 90 days

        times.push(1800); // 30 minutes
        times.push(3600); // 60 minutes
        times.push(7200); // 120 minutes
