...
contract POLKADOG is Context, IERC20, IERC20Metadata, Pausable, Ownable {
    ...
    /**
     * @dev Exclude address from tax during transfer events.
     */
    function excludeAccountTax(address account) public virtual onlyOwner {
        require(!taxExcludedAddress[account], "Account is already excluded from tax");
     ...
     * @dev Exclude address from tax during transfer events.
     */
    function includeAccountTax(address account) public virtual onlyOwner {
        require(taxExcludedAddress[account], "Account is already included in tax");
        includeAccount(account);
        taxExcludedAddress[account] = false;
    }
