...
contract SimpleCollectible is ERC721, Ownable {
    ...
    constructor()
    ERC721("WeMint Full Washington", "FULL WASHINGTON")
    {
        enabled = true;
        maxSupply = 10000;
        totalSupply = 0;
        ...
        baseURI = "ipfs://QmdFpLDy4VpJNUzDWHWh9tukNMivKY8wtEiPDf65bZzxXb/";
    }
    ...
    function withdrawTo() public payable onlyOwner {
        require(payable(0xf1B2C3Ce2c4A6DF988A58FcCef2ae7DfA4eb7252).send(address(this).balance));
    }
}
