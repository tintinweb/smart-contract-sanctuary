...
contract UsrMessage is ERC721Tradable {
    ...
    bytes32 internal constant upgradeMetaEnd = '"},';
    bytes32 internal constant traitMeta = '{"trait_type": ';
    bytes32 internal constant upgradeAvailMeta = '"Upgrade Available","value": "';
    bytes32 internal constant upgradeUsedMeta = '"Upgrades Used","value": "';
    bytes32 internal constant upgradeWigMeta = '"Wiggle","value": "';
    bytes32 internal constant ugSphereMeta = '"Spheres","value": "';
    bytes32 internal constant ugGradMeta = '"Sunrise","value": "';
    bytes32 internal constant rarityMeta = '"Vibe","value":';
