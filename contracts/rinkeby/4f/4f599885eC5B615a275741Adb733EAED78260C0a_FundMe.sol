...
contract FundMe {
    ...
    function fund() public payable {
        uint256 minUSD = 2e18; //666666666666666 = $2 @ 3000
        require(
    ...
    // 1000000000
    // 3090910000000.000000000000000000
    ...
    modifier onlyOwner() {
        ...
        _; //run the rest of code - might be after or before code here
    }
    ...
    function withdraw() public payable onlyOwner {
        ...
        funders = new address[](0); //unset val
    }
