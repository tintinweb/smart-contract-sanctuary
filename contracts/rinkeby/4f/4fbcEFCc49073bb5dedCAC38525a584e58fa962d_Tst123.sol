...
contract Tst123 is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public presaleEndDate = 0;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("Tst123", "TST") {
