...
/* ======== EVENTS ======== */
  ...
  event Bond(uint256 indexed id, address user, uint256 payout, uint256 amount, uint256 price, uint256 vestsAt);
...
/* ======== DEPOSIT ======== */
  ...
  function deposit(
    ...
    emit Bond(_id, _user, payout_, _amount, price, expiry_);
...
/* ======== CREATE ======== */
  ...
  function create(
    ...
    emit CreateMarket(id_, address(_quoteToken), _market[1], _market[0], _booleans[0], _terms[1]);
  }
...
/* ========== REDEEM ========== */
   ...
   * @param _sendgFLOOR  send payout as gFLOOR or sFLOOR
   * @return             sum of payout sent, in gFLOOR
   */ 
  function redeemAll(address _user, bool _sendgFLOOR) external override returns (uint256) {
    return redeem(_user, indexesFor(_user), _sendgFLOOR);
  }
