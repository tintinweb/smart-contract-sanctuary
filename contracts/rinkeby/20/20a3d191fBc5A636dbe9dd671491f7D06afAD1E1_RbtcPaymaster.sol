...
contract RbtcPaymaster is BasePaymaster {
     ...
     */
    function setPostGasUsage(uint256 _postGasUsage) external onlyOwner {
    ...
    function preRelayedCall(
        ...
        uint256 bnbMaxCharge = relayHub.calculateCharge(maxPossibleGas.add(postGasUsage), relayRequest.relayData);
    ...
    function postRelayedCall(
        ...
        uint256 bnbActualCharge = relayHub.calculateCharge(gasUseWithoutPost.add(postGasUsage), relayData);
        ...
        emit TokensCharged(gasUseWithoutPost, postGasUsage, bnbActualCharge, tokenActualCharge);
    }
}
