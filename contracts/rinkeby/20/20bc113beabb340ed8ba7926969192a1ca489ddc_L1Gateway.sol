...
// File contracts/arbBridge/IInbox.sol
...
// File contracts/arbBridge/L1Gateway.sol
...
//-------------------------------- Gateway start --------------------------------//
    ...
    function setInbox(address _newInbox) external {
    ...
    function setTokenL1(address _newTokenL1) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "must be admin");
    ...
    function setGatewayL2(address _newGatewayL2) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "must be admin");
