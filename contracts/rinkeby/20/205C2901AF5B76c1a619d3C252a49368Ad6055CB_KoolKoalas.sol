...
contract KoolKoalas is ERC721Enumerable, Ownable {
    uint public constant MAX_KOALAS = 1817;
    ...
    modifier saleIsOpen{
        require(totalSupply() < MAX_KOALAS, "No more eucaylptus leaves left");
        _;
    }
    
    function reserve50Koala() public onlyOwner {
    ...
    function mintKoalas(address _to, uint _count) public payable saleIsOpen {
        ...
        require(totalSupply() + _count <= MAX_KOALAS, "Lower mints");
    ...
    function price(uint _count) public view returns (uint256) {
        ...
        if(_id <= 180 ){
            require(_count <= 60, "1 at a time folks");
            return 0;
        }
    ...
    function contractURI() public view returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmSdnYiCQ2LNMJL2A5XyHzy4yimArqHkLnRWdFaMPXzqgx";
    }
