...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v3.1.0/contracts/access/AccessControl.sol
...
// File: browser/enchainte.sol

pragma solidity <=0.6.6;

 
contract Enchainte is AccessControl{
    
    bytes32 public constant WRITER_ROLE = keccak256("WRITER_ROLE");
 
    mapping (bytes32 => bool) private checkpoints;
    event NewCheckpoint(bytes32 indexed _checkpoint);
    ...
    function addCheckpoint(bytes32 _checkpoint) public {
        require(hasRole(WRITER_ROLE, msg.sender), "Sender not authorized");
        checkpoints[_checkpoint] = true;
        emit NewCheckpoint(_checkpoint);
    }
 
    function getCheckpoint(bytes32 _checkpoint) public view returns (bool) {
