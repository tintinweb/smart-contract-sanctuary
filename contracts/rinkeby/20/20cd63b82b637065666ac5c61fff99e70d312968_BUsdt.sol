...
contract BUsdt is Context, IBEP20, Ownable { // contract name
    ...
    uint256 public _minTokensSwapToAndTransferTo = 200000000 * 10**1 * 10**_decimals; // modifier to after each successfull swapandliquify disable the swapandliquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(10); // Max number of tokens that an address can hold 2% of total supply
