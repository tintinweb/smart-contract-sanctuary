...
contract Numbers is ERC721Enumerable, NumbersDNAFactory, Ownable {
  ...
  uint256 public price = 40000000000000000; // 0.040 Ether
  
  address public thedudesaddress = 0x65400f550849b2d9fA5DD8fD77d91A8358d34DeF; 
   ...
   function _claim(address _to, string memory thedudesdna) internal {
      uint256 mintIndex = totalSupply();
          if (totalSupply() < maxNumbers) {
                string memory numid = string(abi.encodePacked(thedudesdna));
...
// thedudes (thedudes.art) modified DNA Factory Contract 
...
contract NumbersDNAFactory {
  ...
  Trait[7]  internal background;
  Trait[10]  internal textColor;
  Trait[6]  internal strokeColor;
  Trait[10]  internal strokeWeight;
  ...
  function _setTraitTable() internal {
    ...
    background[0] = Trait("0", 0);
    background[1] = Trait("1", 28);
    background[2] = Trait("2", 42);
    background[3] = Trait("3", 56);
    background[4] = Trait("4", 70);
    background[5] = Trait("5", 84);
    background[6] = Trait("6", 95);


    textColor[0] = Trait("0", 0);
    textColor[1] = Trait("1", 10);
    textColor[2] = Trait("2", 20);
    textColor[3] = Trait("3", 30);
    textColor[4] = Trait("4", 40);
    textColor[5] = Trait("5", 50);
    textColor[6] = Trait("6", 60);
    textColor[7] = Trait("7", 70);
    textColor[8] = Trait("8", 80);
    textColor[9] = Trait("9", 90);

    strokeColor[0] = Trait("0", 0);
    strokeColor[1] = Trait("1", 16);
    strokeColor[2] = Trait("2", 32);
    strokeColor[3] = Trait("3", 48);
    strokeColor[4] = Trait("4", 64);
    strokeColor[5] = Trait("5", 80);

    strokeWeight[0] = Trait("9", 0);
    strokeWeight[1] = Trait("8", 10);
    strokeWeight[2] = Trait("7", 20);
    strokeWeight[3] = Trait("6", 30);
    strokeWeight[4] = Trait("5", 40);
    strokeWeight[5] = Trait("4", 50);
    strokeWeight[6] = Trait("3", 60);
    strokeWeight[7] = Trait("2", 70);
    strokeWeight[8] = Trait("1", 80);
    strokeWeight[9] = Trait("0", 90);

    traitTable.push(background);
    traitTable.push(textColor);
    traitTable.push(strokeColor);
    traitTable.push(strokeWeight);
