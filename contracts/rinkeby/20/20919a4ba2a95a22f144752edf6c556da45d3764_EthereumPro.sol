...
contract EthereumPro is Context, IERC20, Ownable {
    ...
    string private _name = 'Ethereum Pro';
    string private _symbol = 'EPRO';
    ...
    address payable private _marketingWalletAddress = payable(0x1284A9ec75d2fBEa09df0e5Ca988fF6A11005732);
