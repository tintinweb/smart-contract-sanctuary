...
// File @openzeppelin/contracts/utils/[email protected].2.0
...
contract FTFTF is ERC721, ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint256 public maxAirdropAmount = 3;
    ...
    address mainAddr = 0x92e01633DC46e39FC77266D467F8C06659ae3075;
    address main2Addr = 0x92e01633DC46e39FC77266D467F8C06659ae3075;
    ...
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("FTFTF", "FTFTF") { 
