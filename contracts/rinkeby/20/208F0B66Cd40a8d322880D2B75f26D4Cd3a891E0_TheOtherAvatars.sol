...
contract TheOtherAvatars is ERC721Enumerable, TheOtherAvatarsRoyalties, CustomCounter, ReentrancyGuard, Signable {
    ...
    // Constants
    // TODO: Check constants before deploy
    uint256 public constant maxSupply = 22;
    uint256 public constant mintPrice = 0.001 ether;
    uint256 public constant mintPerAccount = 2;
    uint256 public constant artistTokensCount = 8;
    
    // TODO: Check constants before deploy
    address private constant withdrawAddress = 0x3592173b31C348AA23Cdd5C047263922c16048A5;
    ...
    // TODO: Update name, symbol and artists value
    constructor() ERC721("The Other Avatars", "TOA") CustomCounter(artistTokensCount) TheOtherAvatarsRoyalties(withdrawAddress) {
        string memory baseTokenURI = "https://www.saatchiart.com/nft/"; // TODO: Fix link
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(withdrawAddress, balance);
    }
...
abstract contract TheOtherAvatarsRoyalties is Ownable, IRaribleV2 {
    ...
    address private _defaultAccount;
