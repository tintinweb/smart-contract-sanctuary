...
contract YJS is ERC721, Ownable {
    ...
    uint256 private constant presalePrice = 0.001 ether;
    uint256 private constant startPriceDA = 1.8 ether;
    uint256 private constant endPriceDA = 1.1 ether;
    ...
    string private baseUri =
        "https://ymh.mypinata.cloud/ipfs/QmUKGx2maqiVxkBQMyYchCqxVXD4vLiystho4vp6wSdp4L/";
    string private baseExtension = ".json";

    mapping(address => uint256) public mintedTokensByAddress;

    constructor() ERC721("YOO JAE SICK", "YJS") {}
    ...
    function mintSale(uint256 amount) external payable onlyEOA {
        ...
        // require(
        //     msg.value >= calculateTokenPriceDA() * amount,
