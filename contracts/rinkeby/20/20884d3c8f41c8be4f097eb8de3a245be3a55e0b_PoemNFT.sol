...
contract PoemNFT is ERC721, ERC721Enumerable,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    uint16 public constant maxSupply = 111;
    string private _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmfHXGBs1kJQcm9xCuDt6ZXkwCpGcemCBCDdkK9BidPLsT/";
    
    uint256 public _startDate = 1635109613;
    
    mapping (address => bool) private _whitelisted;

    constructor() ERC721("Poem", "POEM") {
