...
contract ShyftBALV2LPStaking is Ownable {
  ...
  address public immutable wEthToken = 0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735;
  ...
  function updatePairObservation(
    ...
    observation.price0 = price0.mul(1).decode144();
    observation.price1 = price1.mul(1).decode144();
  ...
  function getPrice(
    ...
    (address token0,) = UniswapV2Library.sortTokens(_tokenA, _tokenB);

    if (_tokenA == token0) {
      priceA = observation.price0;
      priceB = observation.price1;
    } else {
      priceA = observation.price1;
      priceB = observation.price0;
    }
