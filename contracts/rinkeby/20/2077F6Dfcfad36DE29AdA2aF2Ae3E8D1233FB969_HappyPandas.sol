...
contract HappyPandas is Ownable, ERC721Enumerable {
    ...
    */
    function mintPresale() external payable {
        ...
        require(hasBought(msg.sender) == false, "Address has already purchased pre-sale token");
        require(presaleActive, "Presale is not active now");
        require(totalSupply().add(1) <= MAX_PANDAS, "Cannot mint more than the maximum number of tokens");
