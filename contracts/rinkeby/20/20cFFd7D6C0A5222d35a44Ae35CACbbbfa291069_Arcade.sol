...
contract Arcade is DisplayURISwitchable, ERC721Enumerable, AccessControl, Ownable {
    ...
    constructor(uint256 maxPublic, uint256 maxTemporaryPublic, uint256 maxReserved, uint256 startingReservedID, uint256 maxPerAddress, address[] memory whitelistAddresses) ERC721("PArc", "PARC") {
