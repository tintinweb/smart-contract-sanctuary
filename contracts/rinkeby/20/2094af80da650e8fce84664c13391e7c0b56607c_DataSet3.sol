...
// File: contracts\DataSet3.sol

contract DataSet3 is ERC721Mintable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("DataSet3", "DataSet3", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset3/metadata/token/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset3/metadata/contract/metadata.json";
    }
}