...
contract SumatraFitnessSquad is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	uint256 public priceForLessThan4 = 65000000000000000; //0.065 ETH each
	...
	function buy(uint256 amount) public payable nonReentrant {
		...
		if (amount < 4) {
			expectedPrice = amount * priceForLessThan4;
		}
	...
	//used by admin to modify the price 1 [only owner]
	function modifyPriceLessThan4(uint256 _newPrice) public onlyOwner {
		priceForLessThan4 = _newPrice;
	}

	//used by admin to modify the price 2 [only owner]
	function modifyPriceLessThan10(uint256 _newPrice) public onlyOwner {
		priceForLessThan10 = _newPrice;
	}

	//used by admin to modify the price 3 [only owner]
