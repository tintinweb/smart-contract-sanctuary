...
contract Panda is ERC721Enumerable, Ownable {  
    ...
    constructor (string memory newBaseURI) ERC721 ("Test Pandas", "Test") {
    ...
    function mintToken(uint256 _amount) public payable {
        ...
        require( _amount > 0 && _amount < 4,    "Can only mint up to 3 tokens at once" );
        require( supply + _amount <= MAX_PANDAS, "Can't mint more than max supply" );
