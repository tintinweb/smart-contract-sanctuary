...
contract Pledge is Context , Ownable {
    ...
    mapping(uint256 => uint256) public _lock;
    ...
    function pledgeNft(uint256 _tokenId, uint256 _time) public returns(bool){
        ...
        _lock[_tokenId] = block.timestamp.add(_time);
        return true;
    }
    ...
    function takeOutNft(uint256 _tokenId) public returns(bool){
        ...
        require(block.timestamp > _lock[_tokenId],"");
