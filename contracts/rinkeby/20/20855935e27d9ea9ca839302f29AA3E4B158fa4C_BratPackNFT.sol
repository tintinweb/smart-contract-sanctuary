...
contract BratPackNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public constant bratPackMax = 11;
    uint256 public constant purchaseLimit = 200;

    uint256 private bratPrice = 0.0000000000008 ether;
    ...
    constructor() ERC721("BratPackNFT", "BRATNFT") { 
 ...
 function mint(uint256 numberOfTokens) external payable {
  require(saleLive, 'Contract is not active');
    ...
    require(amountMinted < bratPackMax, 'No Tokens Left');
