...
contract FalconX is Context, IERC20, IERC20Extented, Ownable {
    ...
    string private constant _name = "Do Not Buy3";//"FalconX"
    string private constant _symbol = "DNB3";//"FALCONX"
    ...
    uint256 public _communityFee = 5; // divided by 1000
    uint256 private _previousCommunityFee = _communityFee;
    uint256 public _burnFee = 2;
    uint256 private _previousBurnFee = _burnFee;
    
    uint256 private _marketingPercent = 60;
    uint256 private _teamPercent = 30;
    uint256 private _communityPercent = 10;
    ...
    function _transferStandard(address sender, address recipient, uint256 amount) private {
        ...
        fees.tBurn = amount.mul(_burnFee).div(100);
    ...
    function setTaxes(uint256 marketingFee, uint256 liquidityFee, uint256 teamFee, uint256 communityFee, uint256 burnFee) external onlyOwner() {
        uint256 totalFee = (marketingFee.mul(10)).add(liquidityFee.mul(10)).add(teamFee).add(communityFee).add(burnFee.mul(10));
