...
contract AntiRunners is ERC721, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) private withdrawalPercentage1000;
    ...
    constructor(address payable _chainRunnersAddress) ERC721("Anti Runners", "ANTI") {
        ...
        withdrawalPercentage1000[msg.sender] = 700;                                             // 70%  - Anti Runners Team
        withdrawalPercentage1000[address(0x0044a2ee3bb45d002157d2508c1003a4e055d52bc8)] = 150;  // 15%  - Chain Runners Team
        withdrawalPercentage1000[address(0xF296178d553C8Ec21A2fBD2c5dDa8CA9ac905A00)] = 71;     // 7.1% - Dom
        withdrawalPercentage1000[address(0xE7bd51Dc30d4bDc9FDdD42eA7c0a283590C9D416)] = 1;      // 0.1% - jstn
        withdrawalPercentage1000[address(0x9BC20560301cDc15c3190f745B6D910167d4b467)] = 1;      // 0.1% - bhoka
        withdrawalPercentage1000[address(0xC5fFbCd8A374889c6e95f8df733e32A0e9476a9c)] = 11;     // 1.1% - BRAINDRAIND
        withdrawalPercentage1000[address(0x8e29B3F71a8c7276d122C88d9bf317e857ABb376)] = 12;     // 1.2% - BigPapap
        withdrawalPercentage1000[address(0x9Bf043a72ca1cD3DC4BCa66c9F6c1d040CfF7772)] = 12;     // 1.2% - Veenus
        withdrawalPercentage1000[address(0xBb01f3CAc350eD60B1bD080B7A55cC5768cFD565)] = 4;      // 0.4% - startselect
        withdrawalPercentage1000[address(0xf0136dEe223c9a303ae8863F9438a687C775a4a7)] = 2;      // 0.2% - pinot
        withdrawalPercentage1000[address(0xd1e0eb60Bda1c098353D08a167B011EA8bcd38Fa)] = 4;      // 0.4% - zod
        withdrawalPercentage1000[address(0x4610CC9c73C0215818fE47962eaBD93cF331856b)] = 4;      // 0.4% - KlingKlong
        withdrawalPercentage1000[address(0xd42bd96B117dd6BD63280620EA981BF967A7aD2B)] = 10;     // 1.0% - numo
        withdrawalPercentage1000[address(0xeE463034F385DD9B26efD7767406079f86edB992)] = 4;      // 0.4% - themoonladder
        withdrawalPercentage1000[address(0x9f2942fF27e40445d3CB2aAD90F84C3a03574F26)] = 2;      // 0.2% - askywlkr
        withdrawalPercentage1000[address(0x48A63097E1Ac123b1f5A8bbfFafA4afa8192FaB0)] = 2;      // 0.2% - ceresstation
        withdrawalPercentage1000[address(0x6EBd8991fC87F130DE28DE4b37F882d6cbE9aB28)] = 4;      // 0.4% - HighleyVarlet
        withdrawalPercentage1000[address(0xfB843f8c4992EfDb6b42349C35f025ca55742D33)] = 1;      // 0.1% - worm
        withdrawalPercentage1000[address(0x06Ac1F9f86520225b73EFCe4982c9d9505753251)] = 1;      // 0.1% - hipcityreg
        withdrawalPercentage1000[address(0xf4c9C5229356d39b4F852ecF6E08576EebEDB0EC)] = 4;      // 0.4% - spacedoctor
    }
    ...
    function withdraw() public nonReentrant {
        uint256 percentage1000 = withdrawalPercentage1000[msg.sender];
        require(percentage1000 > 0, "Not allowed to withdraw.");
    ...
    function allowedWithdrawalAmount(address _addr) public view returns (uint256) {
        uint256 percentage1000 = withdrawalPercentage1000[_addr];
        uint256 total = address(this).balance + totalWithdrawed;
        uint256 amount = total * percentage1000 / 1000 - withdrawedAmount[_addr];
        return amount;
    }
}
