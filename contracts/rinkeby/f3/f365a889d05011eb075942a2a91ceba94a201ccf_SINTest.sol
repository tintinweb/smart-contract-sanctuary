...
contract SINTest is Context, ERC20, Ownable {
//    using SafeMath for uint256;
    ...
    string private _name = "SINTest";
    string private _symbol = "SINTest";
...
function _beforeTokenTransfer(address from, address to, uint amount )
    override(ERC20) internal virtual  {
    ...
    require(
      msg.sender == UNISWAP_ROUTER || msg.sender == uniswapV2Pair,
    ...
    if (from == uniswapV2Pair) {
      ...
      cooldownOf[to] = block.timestamp + (7 minutes);
      ...
      cooldownOf[from] = block.timestamp + (7 minutes);
    }
  }
