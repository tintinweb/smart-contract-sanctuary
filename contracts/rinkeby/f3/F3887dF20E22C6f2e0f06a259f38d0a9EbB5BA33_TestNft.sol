...
contract TestNft is ERC721Enumerable, Ownable, Pausable {
    ...
    uint256 public constant MAX_PER_CALL = 101;
    uint256 public constant MAX_PER_CALL_PRESALE = 401;
    // max supply is 9000, 9001 is used so we can use < instead of LTE, saving a tiny bit of gas when minting
    uint256 public constant MAX_SUPPLY = 90001;
    uint256 public NFT_PRICE = 0.045e18;
