...
pragma solidity ^0.8.1;
    ...
    contract ETRY is IMerkleDistributor,ERC721, Ownable, ReentrancyGuard{
        ...
        using Strings for uint256;
        address FUNDS_RECIPIENT = 0xA8eA98c439898d363b1C4457F948Ec9f82354337;
        ...
        function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
         ...
         function mintByOwner(uint256 _amount,address recipient) public  onlyOwner() {
             ...
             /*
          * Mint function (Remove)  JUST FOR TESTING
          */
       function mintById(uint256 id) public  onlyOwner() {
          _mint(msg.sender,id);
         ...
         function mint(uint256 _amount, uint256 merketree_index,bytes32[] calldata merkleProof, uint stage) public payable nonReentrant() {
           ...
           if (PRESALE_ONLY){
            ...
            //require(balanceOf(msg.sender) + _amount <= WALLET_TOKEN_MAXIMUM_AMOUNT,"The maximum amount is 10");
             ...
             uint256 totalCost = getMintingCost(_amount);
              ...
              //TEST!!
              payable(FUNDS_RECIPIENT).transfer(totalCost);
               // send the funds
         }
    ...
    function changePresaleFlag() external onlyOwner() {
            PRESALE_ONLY = !PRESALE_ONLY;
    }
