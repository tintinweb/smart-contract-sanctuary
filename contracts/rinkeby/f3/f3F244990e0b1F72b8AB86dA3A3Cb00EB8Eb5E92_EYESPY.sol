...
contract EYESPY is ERC721, Ownable {
  ...
  address payable private dev = payable(0x8e06A4505b050a4d33f92f26cCA7AC1a41D87277);
  ...
  function withdrawFunds() public onlyOwner {
    ...
    _withdraw(dev, (balance * 500)/1000);
    _withdraw(marketing, (balance * 500)/1000);
    // _withdraw(payable(msg.sender), accountBalance());  
  }
