...
contract Superpunk is ERC721, Ownable {
     ...
     * @dev Initializes the contract by setting a `name` and a `symbol` to the token collection.
     */
    constructor (string memory __name, string memory __symbol, string memory _uri) ERC721(__name, __symbol) {
        _setBaseURI(_uri);
    }
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 1450) {
            return 0.007 ether; // 1450 - 1499 0.7 ETH
        } else if (currentSupply >= 1400) {
            return 0.005 ether; // 1400 - 1449 0.5 ETH
        } else if (currentSupply >= 1200) {
            return 0.003 ether; // 1200 - 1399 0.3 ETH
        } else if (currentSupply >= 800) {
            return 0.002 ether; // 800 - 1199 0.2 ETH
        } else if (currentSupply >= 400) {
            return 0.0015 ether; // 400 - 799 0.15 ETH
        } else {
            return 0.001 ether; // 0 - 399 0.1 ETH 
        }
    }
