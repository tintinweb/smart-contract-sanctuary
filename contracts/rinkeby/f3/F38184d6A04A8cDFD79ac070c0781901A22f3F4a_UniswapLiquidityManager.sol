    ...
    BlockTimestamp
{
    ...
    IUnipilot internal unipilot;
    IOracle internal oracle;

    address internal constant ORACLE = 0xC6A0bc43f8e708b4Fc69516d96098C71085DC6d7; // create set
    address internal constant INDEX_FUND = 0xaBfF3ac119e83824df568C698441cB9AB843e07c;
    address internal constant UNI_STRATEGY = 0x58474D9c8eC0fb7A45b8B8D5193e89056F70f37a; //create set
    address internal constant ULM_STATE = 0x04D29aE65EdE36553bB7E536a4573e88813dAF37;
    ...
    function _isUnipilot() internal view {
        require(msg.sender == address(unipilot), "NUP");
    }
        ...
        )
    {
        ...
        if (position.totalLiquidity > 0) {
            ...
            if (position.baseTickLower != 0 && position.baseTickUpper != 0) {
                ...
                params.amount0Desired = IULMState(ULM_STATE).checkLiquidityAmounts(
                    params.pool,
                    params.amount0Desired,
                    params.amount1Desired,
                    ticks.baseTickLower,
