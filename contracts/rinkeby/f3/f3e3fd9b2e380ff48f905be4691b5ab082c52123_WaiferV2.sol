...
contract WaiferV2 is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function _transfer(
        ...
        require(amount == 0, "BEP20: Testing for upgradable");
    ...
    function antiWhaleBot(uint256 amount) internal virtual {
        ...
        (,uint112 reserve1,) = IUniswapV2Pair(uniswapV2Pair).getReserves();
        uint256 liquidityToken = (reserve1 * antiwhaleFee) / 10**2;
