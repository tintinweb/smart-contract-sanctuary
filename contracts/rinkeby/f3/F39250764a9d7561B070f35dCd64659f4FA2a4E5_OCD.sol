...
contract OCD is ERC721Enumerable, Ownable {
    ...
    function tokenURI(uint256 _tokenId) public pure override returns (string memory){
        ...
        string memory aparts = string(abi.encodePacked(
              '[{"trait_type": "Background","value": "',ocdone.bg.toString(),
              '"},{"trait_type": "Flap","value": "',ocdone.flap.toString(),
              '"},{"trait_type": "Side","value": "',ocdone.side.toString(),
              '"},{"trait_type": "Eyes","value": "',ocdone.hole.toString(),
              '"},{"trait_type": "Eyecover","value": "',ocdone.eyecover.toString(),
              '"},{"trait_type": "Brews","value": "',ocdone.brws.toString(),
              '"},{"trait_type": "Top","value": "',ocdone.top.toString(),
              '"}]'
        ));
