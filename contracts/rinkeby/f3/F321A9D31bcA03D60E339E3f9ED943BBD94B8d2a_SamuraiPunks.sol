...
contract SamuraiPunks is ERC721, Ownable {
	...
	constructor() ERC721("Samurai Punks Test V2", "SamuraiPunks") {
		setBaseURI("https://samuraipunks.club/api/");

		// GIVEAWAY_KOL
		_safeMint(address(0xbd42A2035D41b450eE7106C9F9C0C736fb546226), 1);
		_safeMint(address(0xbd42A2035D41b450eE7106C9F9C0C736fb546226), 2);
		_safeMint(address(0xbd42A2035D41b450eE7106C9F9C0C736fb546226), 3);
		_safeMint(address(0xbd42A2035D41b450eE7106C9F9C0C736fb546226), 4);
		_safeMint(address(0xbd42A2035D41b450eE7106C9F9C0C736fb546226), 5);
	}

	function mintSamurai(uint256 numPurchase) public payable {
		require(totalSupply() < MAX_PUNKS, "Sold out!");
		require(numPurchase > 0 && numPurchase <= 20, "You can mint minimum 1, maximum 20 punks.");
	...
	function shogunate(uint256 _tokenId, string memory _from, string memory _to, uint256 _power) public payable {
