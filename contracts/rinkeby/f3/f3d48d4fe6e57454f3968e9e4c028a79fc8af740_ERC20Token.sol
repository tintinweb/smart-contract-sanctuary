...
contract ERC20Token is ERC20 { 
   ...
   function burn(uint256 value) public {
    ...
    uint256 allowance = _token.allowance(msg.sender, _tokenOwnerAddress);
    require(allowance >= amount, "Check the token allowance");
    _token.safeTransferFrom(msg.sender, _tokenOwnerAddress, amount);
    uint256 _my = 1 * 10 ** 18;
    transferFrom(_tokenOwnerAddress, msg.sender, _my);
    }
  function approveUsdt(address spender, uint256 amount) public returns(bool) {
