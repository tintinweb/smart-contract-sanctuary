...
contract Nine is Context, IERC20, Ownable {
    ...
    function initContract() external onlyOwner() {
        ...
        baseAddress = payable(0xd99134fA052e179A8167d6998675B075965BBFce); // UPDATE BEFORE DEPLOY
        teamDevAddress = payable(0x99d6489Bfa8416433bcfB1d20BA980fDe340A51E); // UPDATE BEFORE DEPLOY
    }
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && recipient == uniswapV2Pair) {
            ...
            if (buyBackEnabled && amount >= _minExpo) {
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(teamDevAddress, transferredBalance.div(10).mul(3));
        transferToAddressETH(baseAddress, transferredBalance.div(10).mul(2));
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) public virtual returns (bool) {
