...
contract FirstNFT is ERC721URIStorage, Ownable {
    ...
    function approveTokenTransfer(uint256 tokenId, address to) onlyOwner public {
        _approve(to, tokenId);
    }
    function transferApprovedToken(uint256 tokenId, address to) public{
        require(owners[tokenId]==msg.sender, "Not the owner");
        require(getApproved(tokenId)==to, "Not yet approved by contract owner");
