...
contract dynamicNFT is ERC721, VRFConsumerBase {
    ...
    function requestNewRandomCharacter(uint256 userProvideSeed, string memory name) public returns (bytes32) {
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
      require(
        _isApprovedOrOwner(_msgSender(), tokenId), "ERC721: transfer caller not owner nor approved"
      );
