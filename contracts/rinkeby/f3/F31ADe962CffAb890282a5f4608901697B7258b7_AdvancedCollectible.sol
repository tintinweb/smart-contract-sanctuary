...
contract AdvancedCollectible is ERC721Enumerable, Ownable, ChainlinkClient {
   ...
   function checkID(string memory geohash) public returns (bytes32 requestId) 
    {
        Chainlink.Request memory request = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);
        //string memory test = append(_baseProvableURI, geohash);
        
        // Set the URL to perform the GET request on
        request.add("get", "https://8xgwf476od.execute-api.ap-south-1.amazonaws.com/ak16994521");
    ...
    function _baseProURI() internal view virtual returns (string memory) {
        return _baseProvableURI;
    }
