...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // Base URI
    string private _baseURI = "https://google.com";
...
// File: contracts/QuotesFromMyFriends.sol
...
contract QuotesFromMyFriends is ERC721, Ownable {
...
//   mapping(string => uint8) public myTokenName;
  ...
  uint256 public constant MAX_NFT_SUPPLY = 99;
  uint256 public constant currentPrice = 30000000000000000;
  ...
  constructor(address _paymentSplitter)
    ERC721("QuotesFromMyFriends", "QFMF")
  {
...
//     {
//         _tokenURI = "https://ipfs.io/ipfs/QmaHr8Kb6eLDXKHHokCsEkbuHNVPN5mpvRwvWyNnBkoQBZ/nfttest/000001.json";
//         bytes memory _tokenURIBytes = bytes(_tokenURI);
//         _tokenURIBytes[76] = bytes1(uint8(48+(_tokenId / 100000) % 10));
//         _tokenURIBytes[77] = bytes1(uint8(48+(_tokenId / 10000) % 10));
//         _tokenURIBytes[78] = bytes1(uint8(48+(_tokenId / 1000) % 10));
//         _tokenURIBytes[79] = bytes1(uint8(48+(_tokenId / 100) % 10));
//         _tokenURIBytes[80] = bytes1(uint8(48+(_tokenId / 10) % 10));
//         _tokenURIBytes[81] = bytes1(uint8(48+(_tokenId / 1) % 10));
//     }

//     modifier mustBeValidToken(uint256 _tokenId) {
//         require(_tokenId >= 1 && _tokenId <= MAX_NFT_SUPPLY);
//         _;
//     }
  ...
  function mint(
    ...
    _validateTokenToBeMinted(_myTokenURI);
