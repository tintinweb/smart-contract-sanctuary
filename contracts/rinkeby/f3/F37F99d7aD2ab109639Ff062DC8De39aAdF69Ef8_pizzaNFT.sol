...
contract pizzaNFT is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    // 1. Raw ingredient NFTs sold on website for 0.01ETH – 10% of sale made claimable to artist
    // address (0.001ETH), 90% (0.009ETH) remains in smart contract.
    // 2. Random BAKE on website for 0.05ETH – 0.05ETH goes into smart contract.
    // 3. BAKE function on website for 0.01ETH – 0.01ETH goes into smart contract.
    // 4. REBAKE function on website for 0.01ETH – 0.01ETH goes into smart contract.
    // 5. UNBAKE function on website for 0.05ETH – 0.05ETH goes into smart contract.
    // 6. OpenSea secondary sales – 2.5% royalty from all secondary sales paid into smart contract.
    // At Rarity Reward block:
    // 1. 1% of available funds in the smart contract at the time of the Rarity Reward Block is made
    // claimable to the holder of the rarest pizza.
    // 2. 1% is made claimable to creator wallet.
    // 3. 1% is made claimable to development wallet
    ...
    */
    ...
    //     require(msg.sender != address(0));
    //     Pizzas memory _buyingPizzaItem = pizzasList[
    //     tokenId
    //     ];
    ...
    //     pizzasList[tokenId] = _buyingPizzaItem;
    // }
    // /*
    // 5) 	UNBAKE
