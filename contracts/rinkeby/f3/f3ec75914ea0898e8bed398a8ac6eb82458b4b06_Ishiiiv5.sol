...
// Following the recent worldwide pandemic, emerging reports suggest that several ishihara species have begun exhibiting strange characteristics. Our research team located across the globe has commenced efforts to study and document these unusual phenomena.
...
// The fate of the world's ishiharas depends on it.

// from our website (https://boringishiharas.co)

// BoringBananasCo is a community-centered enterprise focussed on preserving our research about the emerging reports that several ishihara species have begun exhibiting strange characteristics following the recent worldwide pandemic. 
...
contract Ishiiiv5 is ERC721, Ownable {
    ...
    constructor() ERC721("Ishii5", "Ishii5") { }
