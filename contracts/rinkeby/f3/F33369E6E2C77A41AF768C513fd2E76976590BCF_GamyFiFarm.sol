...
contract GamyFiFarm is Ownable {
    ...
    // Accumulated rewardToken per share, times 1e18.
    uint256 public accRewardTokenPerShareMultiple = 1e18;
        ...
        returns (uint256)
    {
        ...
        uint256 totalReward =
            user
                ...
                .div(accRewardTokenPerShareMultiple)
                .sub(user.rewardDebt);
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.accRewardTokenPerShare = getPoolRewardPerShare(_pid);
    ...
    // Deposit tokens to GamyFiFarm Test for rewardToken allocation.
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        user.rewardDebt = user.amount.mul(pool.accRewardTokenPerShare).div(
            accRewardTokenPerShareMultiple
        );
        ...
        returns (uint256)
    {
        ...
        return
            pool.accRewardTokenPerShare.add(
                poolReward.mul(accRewardTokenPerShareMultiple).div(lpSupply)
            );
    }
}
