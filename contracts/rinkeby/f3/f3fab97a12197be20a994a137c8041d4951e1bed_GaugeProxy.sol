...
contract Gauge is ReentrancyGuard {
    ...
    IERC20 public constant PICKLE = IERC20(0x7CeBC7A14ff1399C53Fe1d0b19CC4388b5eA7433);
    IERC20 public constant DILL = IERC20(0x431F7FEC6E77E8efD7bA10813DF061DAcf84015f);
    address public constant TREASURY = address(0x91A4cB8DCdD793dc5C1b6706f5B0c37B1B8796CE);
...
contract GaugeProxy is ProtocolGovernance {
    ...
    MasterChef public constant MASTER = MasterChef(0x2897952EdcA67f27AdA122dE9E9216840adA313C);
    IERC20 public constant DILL = IERC20(0x431F7FEC6E77E8efD7bA10813DF061DAcf84015f);
    IERC20 public constant PICKLE = IERC20(0x7CeBC7A14ff1399C53Fe1d0b19CC4388b5eA7433);
