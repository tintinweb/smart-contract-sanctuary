    ...
    */
    ...
    function _checkpoint(
        ...
        if (lockedNew.end > timestamp && lockedNew.amount > 0) {
            ...
            // add
            changeNew.slope = changeNew.slope.mul(lockedNew.boostValue);
            changeNew.bias = changeNew.bias.mul(lockedNew.boostValue);
        ...
        if (lockedOld.end > timestamp && lockedOld.amount > 0) {
            ...
            // add
            changeOld.slope = changeOld.slope.mul(lockedOld.boostValue);
            changeOld.bias = changeOld.bias.mul(lockedOld.boostValue);
        }
