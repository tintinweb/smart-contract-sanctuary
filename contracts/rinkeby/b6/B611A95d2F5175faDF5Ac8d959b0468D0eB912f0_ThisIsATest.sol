...
contract ThisIsATest is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor() ERC721("This Is A Test", "TIAT") {}

    function safeMint(uint256 numberOfNfts, address to) public onlyOwner {
        require(totalSupply() < _maxSupply, "Minting would exceed max supply of Nfts");
