...
contract SplitFactory {
    ...
    address public immutable zora = 0x7C2668BD0D3c050703CEcC956C11Bd520c26f7d4; //rinkeby
    address public immutable auctionHouse =
        0xE7dd1252f50B3d845590Da0c5eADd985049a03ce; // rinkeby
...
interface ISplitFactory {
    ...
    function zora() external returns (address);
...
contract SplitProxy is SplitStorage, IERC721Receiver {
    ...
    constructor() {
        ...
        zora = ISplitFactory(msg.sender).zora();
        ...
        IMedia(ISplitFactory(msg.sender).zora()).setApprovalForAll(
            ISplitFactory(msg.sender).auctionHouse(),
            true
        );
    }
    ...
    function safeTransferNFT(
        ...
        require(msg.sender == owner());
        IMedia(tokenContract).safeTransferFrom(
            address(this),
            newOwner,
            tokenId
        );
