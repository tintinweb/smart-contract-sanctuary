...
// File contracts/Alive_Takeover_Club.sol


pragma solidity ^0.8.0;


contract Alive_Takeover_Club is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Alien Takeover Club", "ATC") {
        setBaseURI(baseURI);

    }
    function mint(uint256 mintCount) public payable {
        uint256 supply = totalSupply();
        require(mintCount <= 5,                    "max_mint_count_exceeded");
