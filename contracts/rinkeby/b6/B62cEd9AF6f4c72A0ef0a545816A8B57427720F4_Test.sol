...
contract Test is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/224/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/224/contract-uri";
	...
	uint256 public pricePerToken = 67800000000000000;
    ...
    uint256 public presaleEndDate = 1640448038;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _signerAddress) ERC721("Test", "TEST") {
