...
contract FactoryMigrationHelper {
	...
	function sendTokenToContract(uint256 amount) public onlyOwner{
		MigrationHelper hc = MigrationHelper(migrations[0]);
...
contract MigrationHelper {
	...
	function claim() public {
		...
		uint256 amountToReceive = newAmountToReceive.sub(10**decimalsNewToken).mul(10**operationalDecimals);
