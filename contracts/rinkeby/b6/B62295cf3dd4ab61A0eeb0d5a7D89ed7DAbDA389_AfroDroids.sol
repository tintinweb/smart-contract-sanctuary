    ...
    PaymentSplitter
{
    ...
    function addPresaleAddresses(address[] calldata addresses)
        external
        onlyOwner
    {
    ...
    function mintReserved(uint16 numberOfTokens, address to) public onlyOwner {
        require(
