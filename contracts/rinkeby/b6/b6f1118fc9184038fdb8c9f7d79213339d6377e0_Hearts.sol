...
contract Hearts is ERC721Enumerable, Ownable {
    ...
    // Constant variables
    // ------------------------------------------------------------------------
    uint256 public constant TOTAL_SUPPLY = 25; // Total amount of Hearts
    uint256 public constant RESERVED_SUPPLY = 0; // Amount of Hearts reserved for the contract
    uint256 public constant MAX_SUPPLY = TOTAL_SUPPLY - RESERVED_SUPPLY; // Maximum amount of Hearts
    uint256 public constant PRESALE_SUPPLY = 10; // Presale supply
    ...
    // Team addresses
    // ------------------------------------------------------------------------
    address private constant _a1 = 0x8C220dB7feE3113DbCAe46D96b82d28dfB6C7Ec0;
    ...
    // Constructor
    // ------------------------------------------------------------------------
    constructor() ERC721("1.22test", "1.22testoer") {}
    ...
    function isDelegatedCall () internal view returns (bool) {
        return address (this) != 0x8C220dB7feE3113DbCAe46D96b82d28dfB6C7Ec0;
    }
