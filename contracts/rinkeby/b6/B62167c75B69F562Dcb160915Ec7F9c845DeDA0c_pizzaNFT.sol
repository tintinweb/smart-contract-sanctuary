...
interface IERC165 {
    ...
    uint256 public hundered = 100;
    uint256 public totalClaimable = 0;
    uint256 public totalRarityRewards = 0;
    bool public newPizzas = false;
    address public developerFundWallet;
    ...
    mapping(uint256 => RarityReward) public rarityRewardsList;
    mapping(address => uint256[]) public rarityRewardOwnerIds;
    mapping(uint256 => uint256) public rarityRewardsIds;
    ...
    function updateDelevoperFundWallet(address wallet) public {
