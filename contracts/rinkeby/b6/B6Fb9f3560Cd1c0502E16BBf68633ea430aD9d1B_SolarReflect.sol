...
/**
 * @title SolarReflectToken
 * @dev Solar Reflect is an ERC20 Token.
 ...
 */
contract SolarReflect is ERC20, ERC20Burnable {
    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor(address owner, uint256 amount) ERC20("Solar Reflect", "SLRT") {
        _mint(owner, amount * (1 ether));
    }
}
