...
import {ERC721, ERC721Enumerable} from "./erc/ERC721.sol";
import {Ownable} from "./Ownable.sol";
import {RandomNumberConsumer} from "./Random.sol";

contract NeonCity is ERC721, ERC721Enumerable, Ownable, RandomNumberConsumer {
    uint256 public constant TOKEN_PRICE = 20000000000000000; // 0.02 ETH

    mapping(bytes32 => uint256) private _vrfRequestIdToTokenId;
    mapping(uint256 => uint256) private _tokenIdToTokenData;

    constructor()
        // Rinkeby network settings
    ...
    function initiate() public payable {
        ...
        _vrfRequestIdToTokenId[vrfRequestId] = mintIndex;
        _tokenIdToTokenData[mintIndex] = 0;
    }

    function getTokenData(uint256 tokenId) public view returns (uint256) {
        return _tokenIdToTokenData[tokenId];
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        _tokenIdToTokenData[tokenId] = randomness;
    }
...
import {IERC721, IERC721Metadata, IERC721Receiver, IERC721Enumerable} from "./IERC721.sol";
import {IERC165} from "./IERC165.sol";
