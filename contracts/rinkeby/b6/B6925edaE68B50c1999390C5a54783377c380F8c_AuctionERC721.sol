...
contract AuctionERC721 is Ownable, IERC721Receiver, AbstractSale {
    ...
    function closeAuction(address erc721token, uint256 tokenId, address erc20Token,  Trade memory trade, BuyerSig memory buyerSig, SystemSig memory systemSig) public {
