...
contract Lottery is VRFConsumerBase, Ownable {
  ...
  function enterLottery() public payable {
    ...
    require(currentState == LOTTERY_STATE.OPEN, "Lottery is not opened.");
  ...
  function startLottery() public onlyOwner {
    require(currentState == LOTTERY_STATE.CLOSED, "You can't start a new lottery");
  ...
  function endLottery() public onlyOwner {
    ...
    currentState = LOTTERY_STATE.PROCESSING;
  ...
  function fulfillRandomness(bytes32 _requestId, uint256 _randomness)
    ...
    override
  {
    require(currentState == LOTTERY_STATE.PROCESSING,"You aren't there yet!");
    require(_randomness > 0, "random-not-found");
    uint256 indexOfWinner = _randomness % participants.length;
    latestWinner = participants[indexOfWinner];
