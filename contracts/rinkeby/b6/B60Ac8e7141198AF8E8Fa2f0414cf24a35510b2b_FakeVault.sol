...
contract FakeVault is ERC20 {
    ...
    function depositTokens(uint256 _amount, address _vaultPipe) public {
        bool success = acceptedToken.transferFrom(_vaultPipe, address(this), _amount);
     ...
     */
    function withdrawTokens(uint256 _amount, address _user, address _vaultPipe) public {
        bool depositSuccess = transferFrom(_vaultPipe, address(this), _amount);
