...
contract TheOtherSideV9 is ERC721EnumerableT, Delegated {
  ...
  constructor()
    ERC721T("The Other Side v.9", "TOSV9"){
  }
  ...
  function getBalanceofContract() external onlyDelegates view returns (uint256) {
