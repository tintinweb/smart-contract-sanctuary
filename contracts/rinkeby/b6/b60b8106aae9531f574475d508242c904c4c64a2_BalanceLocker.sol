...
contract BalanceLocker is Initializable, ContextUpgradeable, OwnableUpgradeable,
    ERC20BurnableUpgradeable, AbstractLocker
{
    ...
    */
    ...
    function initialize(
        ...
        __BalanceLocker_init(_chainGuid, _lockerToken, _oracleAddress, _feeAddress, _feeBP, _lpFeeShareBP);
    }
    ...
    function __BalanceLocker_init(
        ...
        __BalanceLocker_init_unchained(_lpFeeShareBP);
    }
    ...
    */
    ...
    function liquidityRefund(
        ...
        // values must cover all non-signature arguments to the public function call
