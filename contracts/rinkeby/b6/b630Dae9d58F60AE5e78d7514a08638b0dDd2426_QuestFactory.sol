...
contract QuestFactory {
    ...
    event QuestCreated(address questAddress, string _requirementsIpfsHash);
    ...
    function createQuest(
        ...
        external
    {
        Quest quest = new Quest(_requirementsIpfsHash, _rewardToken, _expireTime, aragonGovernAddress, _fundsRecoveryAddress);
        emit QuestCreated(address(quest), _requirementsIpfsHash);
    }
}
