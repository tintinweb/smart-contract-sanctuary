...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function enter() public payable {
        require(lottery_state == LOTTERY_STATE.OPEN, "Lottery has not been opened yet!");
    ...
    function endLottery() public onlyOwner {
        ...
        // One hashing algorithm does not mean that making a hash will be random
        // difficulty can be manipulated by miners!
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        ...
        require(_randomness > 0, "random not found (0)");
