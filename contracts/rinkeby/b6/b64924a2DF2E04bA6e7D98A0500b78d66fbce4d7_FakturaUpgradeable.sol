...
ERC721ProxyCall
{
    ...
    function initialize(
        ...
        TreasuryNode._initializeTreasuryNode(payable(msg.sender), _creatorPaymentAddress);
...
abstract contract TreasuryNode is Initializable {
     ...
     */
    function _initializeTreasuryNode(address payable _treasury, address payable _creatorPaymentAddress) internal initializer {
...
abstract contract ERC721ProxyCall {
    ...
    returns (address payable result)
    {
        ...
        require(result.isContract(), "ERC721ProxyCall: address returned is not a contract");
    }
    uint256[46] private __gap;
}
