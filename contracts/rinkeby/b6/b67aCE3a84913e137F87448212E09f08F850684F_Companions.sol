...
contract Companions is ERC721Enumerable, ReentrancyGuard, Ownable {
    uint256 public price = 20000000000000000; //0.02 ETH

    //Loot Contract
    //address public lootAddress = 0xFF9C1b15B16263C61d017ee9F65C50e4AE0113D7;
    address public lootAddress = 0x2f1c469b73D96795bec5366d4357Cd2b401cae71;
    ...
    function getLoyalty(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "LOYALTY", loyalty);
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[9] = getLoyalty(tokenId);

        parts[10] = '</text><text x="10" y="120" class="base">';

        parts[11] = getAgility(tokenId);
    ...
    function withdraw() public onlyOwner {
        payable(0x37F9C01B717F60d4F5ac7Fc7cDBb4d7A720D4C0f).transfer(address(this).balance);
    }
    ...
    constructor() ERC721("Companions", "COMP") Ownable() {}
  }
