...
contract Involve is ERC20Burnable {
    ...
    uint32 internal conversionRate = 9600000;
    ...
    receive() external payable {
        totalAmount = (msg.value * getThePrice()) / conversionRate;
        Paid(msg.sender, msg.value);
        TokenDistribution(getThePrice(), priceFeed.decimals(), totalAmount);
        _exchangeToToken(msg.sender, totalAmount);
    ...
    function _exchangeToToken(address sender, uint256 value) internal virtual {
        _mint(sender, value);
    }
}
