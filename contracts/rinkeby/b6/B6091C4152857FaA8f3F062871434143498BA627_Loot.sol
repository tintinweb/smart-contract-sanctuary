...
contract Loot is ERC721Enumerable, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" class="all" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; } .all { background-color: black;  }</style><g transform="translate(150,0)rotate(40)"><rect width="100%" height="100%" fill="black"/><text x="10" y="20" class="base">';
