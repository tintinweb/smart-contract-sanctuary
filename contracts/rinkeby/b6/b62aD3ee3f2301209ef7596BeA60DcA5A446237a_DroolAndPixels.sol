...
import {IDrools} from "./interfaces/IDrools.sol";

contract DroolAndPixels is IDrools, ERC721, Ownable {
  ...
  function tokenURI(uint256 tokenId) public view override(ERC721, IDrools) returns (string memory) {
