 ...
 */
contract OpenSpace is ERC721Tradable {
    constructor(address _proxyRegistryAddress, address _saleContractAddress)
    ERC721Tradable("TestOpenSpace", "OS", _proxyRegistryAddress, _saleContractAddress) {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://romanow.xyz/stars/meta/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://romanow.org/";
    }
}
...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    // ONLY FOR TEST MVP
    function updateSaleContractAddress(address _saleContractAddress) external onlyOwner {
        saleContractAddress = _saleContractAddress;
    }
...
//        }
        ...
        if (operator == saleContractAddress) {
            return true;
        }
