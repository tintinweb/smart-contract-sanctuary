...
Percentage of redistribution: 1%

Percentage of tax: 15% (tax breakdown)

1% : distributed to holders
4%: add to liquidity pool
4% : burns
4.5% for awareness/marketing
2.5% to dev and staff costs/charity
 * 
 */
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Dinotest";
    string internal constant SYMBOL = "DTST";
    ...
    address internal marketingAddress = 0x29D9A1C688DdfF8Fb9B470B0C1200BB0c5b9F7a7;
...
abstract contract DinoToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract DinoTokenV1Beta is DinoToken{

    constructor() DinoToken(Env.MainnetV2){
