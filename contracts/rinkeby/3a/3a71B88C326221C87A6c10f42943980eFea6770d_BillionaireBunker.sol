...
contract BillionaireBunker is ERC721("The Billionaire Bunker", "BB") {
    string public baseURI;
    bool public isSaleActive;
    uint256 public circulatingSupply;
    address public owner = msg.sender;
    uint256 public itemPrice = 0.088 ether;
    uint256 public frenPrice = 0.066 ether;
    uint256 public itemPricePresale = 0.088 ether;
    uint256 public constant totalSupply = 4_444;

    address public team1 = 0xe5Adc5Ff824bab42bC628B2e26Db3eB0A9A432a1;
    address public team2 = 0xC63Cd0F5f852c69342dD6F6f46b10509328ce093;
    address public team3 = 0x419e90565Db6D2222b93841e38e586cbB1f8a5ee;
    address public team4 = 0xD8F4564E30285a07cf5af5c394d96Cc2f32e03D6;
    address public team5 = 0x4AE659CEDF547d0791781D5320B97acfB64a5fb6;
    address public dev = 0xADDaF99990b665D8553f08653966fa8995Cc1209;

    bool public isWhiteListActive;
    uint256 public whiteListMaxMint = 100;
        ...
        tokensAvailable(_howMany)
    {
        ...
        require(_howMany > 0 && _howMany <= 100, "Mint min 1, max 100");
        require(msg.value >= _howMany * itemPrice, "Need to send more ETH");
    ...
    // Mint multiple NFTs at once
    function mintFrenTokens(uint256 _howMany)
        external
        payable
        tokensAvailable(_howMany)
    {
        ...
        require(_howMany > 0 && _howMany <= 100, "Mint min 1, max 100");
        require(msg.value >= _howMany * frenPrice, "Need to send more ETH");
    ...
    function withdrawETH() external onlyOwner {
        ...
        uint256 _34_percent = (balance * 0.34 ether) / 1 ether;
        uint256 _20_percent = (balance * 0.20 ether) / 1 ether;
        uint256 _10_percent = (balance * 0.10 ether) / 1 ether;
        uint256 _1_percent = (balance * 0.1 ether) / 1 ether;

        payable(msg.sender).transfer(_34_percent);
        payable(team2).transfer(_34_percent);
        payable(team3).transfer(_20_percent);
        payable(team4).transfer(_1_percent);
        payable(team5).transfer(_1_percent);
    ...
    // Change frensale price in case of ETH price changes too much
    function setFrenPrice(uint256 _frenPrice) external onlyOwner {
        frenPrice = _frenPrice;
    }
