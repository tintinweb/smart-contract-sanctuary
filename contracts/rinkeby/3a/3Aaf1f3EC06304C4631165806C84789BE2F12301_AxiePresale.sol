...
contract HasNoEther is Ownable {
 ...
 constructor() payable {
   ...
   */
  function reclaimEther() external payable onlyOwner {
...
contract AxiePresale is HasNoEther, Pausable {
  ...
  uint256 constant public INITIAL_PRICE_INCREMENT = 0.0016 ether;
    ...
    whenNotPaused
  {
    ...
    address actualReferrer = address(0x0);
