...
contract ETCPunks is ERC721, Ownable {
    ...
    constructor(string memory name, string memory symbol, string memory baseURI,address payable _developer , address payable _firstOwner) ERC721(name, symbol) {
