...
contract SocialRecoveryModule is Module {
    ...
    function recoverAccess(address prevOwner, address oldOwner, address newOwner)
        ...
        onlyFriend
    {
        (bytes32 dataHash,) = getSwapOwnerHash(prevOwner, oldOwner, newOwner);
        require(!isExecuted[dataHash], "Recovery already executed");
    ...
    function confirmRecoverAccess(address prevOwner, address oldOwner, address newOwner)
        ...
        onlyFriend
    {
        (bytes32 dataHash, bytes memory data) = getSwapOwnerHash(prevOwner, oldOwner, newOwner);
        require(!isExecuted[dataHash], "Recovery already executed");
    ...
    function getSwapOwnerHash(address prevOwner, address oldOwner, address newOwner)
        private
        pure
