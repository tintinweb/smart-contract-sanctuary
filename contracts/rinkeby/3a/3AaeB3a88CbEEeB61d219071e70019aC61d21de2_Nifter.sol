  ...
  INifter
{
  ...
  INifterMarketAuction public marketAuction;
  IMarketplaceSettings public marketplaceSettings;
  INifterRoyaltyRegistry public royaltyRegistry;
  INifterTokenCreatorRegistry public tokenCreatorRegistry;
  ...
  function __Nifter_init(string memory _uri) public initializer {
    __Ownable_init();
    __ERC1155_init(_uri);
    __AccessControl_init();
    __EIP712_init("NifterNFT", "1.1.0");
  ...
  /**
   * @dev See {IERC1155-setApprovalForAll}. by NifterMarketAuction
   */
  ...
  function setMarketAddresses(
    ...
    tokenCreatorRegistry = INifterTokenCreatorRegistry(_tokenCreatorRegistry);
    ...
    return
      _hashTypedDataV4(
        keccak256(
          abi.encode(
            keccak256(
              "NifterNFT(address _creator,uint256 _tokenAmount,bool _isForSale,uint256 _price,uint8 _priceType,uint8 _royaltyPercentage,uint256 _startTime,uint256 _endTime,uint256 _tokenId,uint8 _paymentMode)"
            ),
            _creator,
            _tokenAmount,
            _isForSale,
