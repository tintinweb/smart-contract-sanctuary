        ...
        bytes(
          string(
            abi.encodePacked(
              ...
              toString(tokenId),
              '", "description": "Each Traveling Musician carries a theme song. You can find the animation_url in the tokenURI. Compatible with Loot (for Adventurers)", "animation_url": "',
              song,
