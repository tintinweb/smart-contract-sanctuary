    ...
    ERC20Upgradeable 
{
    ...
    // error ValueIsNotEvenNumber(uint256);
    ...
    function initialize() initializer public {
        ...
        // marketing and team percent is not in here

        ETHRewardsFee = 2; // Should find where this is used, goes to ExoticDivendTracker contract first and be distributed with claim function

        liquidityFee = 2; // 6% for team wallet and 2% for liquidity wallet
        teamFee = 6; // 6% for team wallet and 2% for liquidity wallet
        notHoldersFee = liquidityFee.add(teamFee); // 8
        ...
        rewardsTracker.excludeFromRewards(address(uniswapV2Router));
    ...
    // Use plural values for this function inputs
...
contract ExoticRewardsTracker is RewardPayingToken, Ownable {
    ...
    constructor() RewardPayingToken("x", "EXOTIC_Rewards_Tracker") {
        claimWait = 3600;
