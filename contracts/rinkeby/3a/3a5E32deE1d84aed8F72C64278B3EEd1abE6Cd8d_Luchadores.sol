...
contract Luchadores is ERC721Pausable, Ownable, VRFConsumerBase {
	...
	bytes32 internal keyHash = 0x2ed0feb3e7fd2022120aa84fab1945545a9f2ffc9076fd6156fa96eaff4c1311; // Mainnet - 0xAA77729D3466CA35AE8D28B3BBAC7CC36A5031EFDC430821C02BC31A238AF445
  uint256 internal LinkFee = 2 * 10**18; // 2 LINK
	address private VRFCoordinator = 0xb3dCcb4Cf7a26f6cf6B120Cf5A73875B7BBc655B; // Mainnet - 0xf0d54349aDdcf704F77AE15b96510dEA15cb7952
	address private LinkToken = 0x01BE23585060835E02B77ef475b0Cc51aA1e0709; // Mainnet - 0x514910771af9ca656af840dff83e8264ecf986ca
		...
		VRFConsumerBase(VRFCoordinator, LinkToken) 
	{
		...
		art.mask[3] = Item("Striped", "<path d='M11 2h2V1h1V0h-4v1h1zM6 10v2h1v-1h1v-1H7zM17 10h-1v1h1v1h1v-2z'/><path class='lucha-alt' d='M16 3h1V2h-1V1h-1v1h-1v1h-1v1h-2V3h-1V2H9V1H8v1H7v1h1v1h1v1h1v1h1v9h2V6h1V5h1V4h1z'/>");
	...
	function generateLuchador(uint256 _quantity, uint256 _deadline) external payable whenNotPaused {
		require(_quantity <= 20, "mint quantity must not exceed 20");
		require(_tokenIds.current() + _quantity <= 10000, "maximum luchadores reached");
