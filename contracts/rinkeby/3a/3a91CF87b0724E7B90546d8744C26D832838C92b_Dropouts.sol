...
contract Dropouts is ERC721, Ownable {
    ...
    function _setTokenURI(uint256 tokenId, string memory _tokenURI) internal override virtual {
        require(_exists(tokenId), "DO: URI set of nonexistent token");
        _tokenURIs[tokenId] = _tokenURI;
    }

    function _preValidatePurchase() internal view {
        require(msg.sender != address(0));
        require(msg.value >= price(), "DO: Insufficient funds");
        require(totalSupply() < limitSupply(), "DO: All tokens sold");
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "DO: URI query for nonexistent token");
    ...
    function buyTokens() external payable returns (uint256[] memory) {
        ...
        require(tokensAmount <= tokenAmountBuyLimit(), "DO: Limited amount of tokens");
