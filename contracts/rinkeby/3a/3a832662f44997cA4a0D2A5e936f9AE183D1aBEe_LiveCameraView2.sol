...
pragma solidity ^0.8.2;
    ...
    // LiveCameraView is custom name
    contract LiveCameraView2 is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
        
        using Strings for uint256;
        mapping (uint256 => string) private _tokenURIs; // Optional mapping for token URIs
        string private _baseURIextended; // Base URI

        constructor() ERC721("Battle of The Cameras 2", "CAM2") {}
