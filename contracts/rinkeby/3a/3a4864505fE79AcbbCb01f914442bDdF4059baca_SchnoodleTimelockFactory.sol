...
contract SchnoodleTimelock is Initializable {
...
contract SchnoodleTimelockFactory {
    ...
    function createToken(IERC20 name, address beneficiary, uint256 releaseTime) external returns (address) {
        address clone = Clones.clone(tokenImplementation);
        SchnoodleTimelock(clone).initialize(name, beneficiary, releaseTime);
        return clone;
    }
}
