...
contract SimpleCollectible is ERC721, Ownable {
    ...
    function batchMint() public onlyOwner payable {
        uint256 numberOfNfts = 70;
        string memory url = append("https://gateway.pinata.cloud/ipfs/QmTBpzRcCk8B6YvSFLYfS4sWyjiTJ9ofdvVBTHhKMW92Lm/metadata-", uint2str(tokenCounter), ".json");

        for (uint i = 0; i < numberOfNfts; i++) {
            createCollectible(url);
        }
    }
