...
contract BidPixel1155 is Initializable,BEP1155Upgradeable, OwnableUpgradeable, BEP1155BurnableUpgradeable {
   event Approve(
    ...
    function initialize() public initializer {
        BEP1155Upgradeable.__BEP1155_init("", "BidPixel", "BidPixel");
        __Ownable_init();
        _tid = 1;
        serviceValue = 2500000000000000000;
        sellervalue = 0;
        listingfee = 20000000000000000;
        deci = 18;
    }
    ...
    function mint(uint256 value, uint256 royal, uint256 nooftoken, string memory ipfsname,
        ...
        token_id[id_] = Metadata(ipfsname, ipfsimage, ipfsmetadata);
    ...
    function _acceptBId(string memory tokenAss,address from, uint256 amount, uint256 tokenId) internal{
        ...
        emit FeeTransfer(_adminfee,roy,netamount.div(10**Tokendecimals));
    }
    ...
    function orderPlace(uint256 tokenId, uint256 _price) public{
        ...
        require(listingNFT[tokenId][msg.sender] == true, "You are Not Eligible for Listing"); 
        Order memory order;
