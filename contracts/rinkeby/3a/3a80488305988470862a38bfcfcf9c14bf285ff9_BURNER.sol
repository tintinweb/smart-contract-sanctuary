...
contract BURNER is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
	...
	function getLayersOrder(uint256 _tokenId) public view returns (string memory) {
		...
		// We have 7 images per layer, and each
		// possible value goes from 0 to F.
		// In case the given value is 0 or F, we favor the first image.
		// Any other number, it will be mapped to 2-7:
		// 1,2 => 1; 3,4 => 2; 5,6 => 3; 7,8 => 4; 9,A => 5; BC => 6; DE => 7.
