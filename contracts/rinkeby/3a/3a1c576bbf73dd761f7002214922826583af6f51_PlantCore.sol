...
contract PlantCore is ERC721Pausable, AccessControl, Ownable, IPlantCore {
    ...
    address public CPCToken = 0xfC4542634EBf9b7FF344e45e9640deCfC1b676f4;
    bool public isBurn;
    uint256 public rate;
    ...
    function addSeedFarm(uint256[] calldata _seedId) external onlyOwner {
        for (uint256 i = 0; i < _seedId.length; i++) {
    ...
    function createPlant(address _owner, uint256 _amount) external {
        ...
        require(
            IERC20(CPCToken).transferFrom(msg.sender, address(this), _amount)
        );
