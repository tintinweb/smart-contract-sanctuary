...
contract Dracarys is Context, IERC20, Ownable {
    ...
    address public dracWallet = 0x9139144a4690A7Dbe48f604561Ecd63606Fe001d;
    address public marketingWallet = 0x7A8321403CF8C93e00B9930656493334e6a455a0;
    ...
    function setFees(uint256 taxFee_, uint256 marketingFee_, uint256 charityFee_, uint256 dracFee_, uint256 liquidityFee_, uint256 SwapThresholdAmount_) external onlyOwner {
        taxFee = taxFee_;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 dracShare = newBalance.mul(dracFeePercent).div(100);
