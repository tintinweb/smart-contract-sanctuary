...
interface WarBotStatsContract {
     ...
     function initializeWarbot ( uint256 _warbot ) external;
     function creator ( uint256 _warbot ) external returns(address);
}
...
contract WarhelmPatchGemPass is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    ...
    WarBotManufacturer warbotsmanufacturercontract;
    address public oracle;
    address public EmergencyAddress;
    address payable  public gameFunds;
    ...
    string public  contractURIstorefront = '{ "name": "WarHelm Patches Gem Pass", "description": "This WarHelm Patch Gem Pass will entitle you to one WarHelm Patch of Random Scarcity", "image": "https://gateway.pinata.cloud/ipfs/QmTf2ZDUysg4icoPzjCX8RP7vmNGFwG5ceZ76QSuxV3y7N", "external_link": "https://riseofthewarbots.com", "seller_fee_basis_points": 300, "fee_recipient": "0xa119144A2371Ea0f4e51b423aFa44Bc8767022A4"}'; 
    
    string public _tokenURI = '{"attributes": [],"name": "WarHelm Patches Mint Pass","description": "WarHelm Patches Mint Pass","image": "https://gateway.pinata.cloud/ipfs/QmSzdA4nMeHyjLdW4qrWYkaByeDEhV2d2zo7xnxKmK4x2F"}';
    
    
    constructor() ERC721("WarHelm Patches Gem Pass", "MP_WarHelmPatch") {
        ...
        gameFunds  = payable( 0xa119144A2371Ea0f4e51b423aFa44Bc8767022A4) ;
    ...
    function mintPass() public  payable {
        require ( msg.value == price , "Please enter correct price for a single pass");   
        require ( _tokenIds < max_quantity, "Maximum Mint Already Hit");
        _tokenIds++;
        uint256 newTokenId = _tokenIds;
        _safeMint( address(this) , newTokenId);
        _setTokenURI(newTokenId, _tokenURI);
        devAddress.transfer ( msg.value / devShare );
    }
    
    function withdrawETH () public OnlyEmergency {
        
        gameFunds.transfer (  address(this).balance );
