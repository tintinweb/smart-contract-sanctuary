...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 amountTokens) public {
    bool tokenSendSuccess = yourToken.transferFrom(msg.sender, address(this), amountTokens);
    require(tokenSendSuccess, "Token send unsuccessfull");
    (bool ethSendSuccess, ) = msg.sender.call{value: amountTokens/tokensPerEth}("");
    require(ethSendSuccess, "ETH send unsuccessfull");
  }
