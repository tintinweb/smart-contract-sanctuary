...
contract StarNFTV1Factory is Ownable {
    ...
    event CreateStarNFT(address newStarNFT, uint256 daoID);
    ...
    function createStarNFTV1(address owner, uint256 daoID) external returns (address nft) {
