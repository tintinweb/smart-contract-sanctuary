...
contract EasyAuctionTemplate {
    ...
    constructor(
        address _WETH,
        IAuctionLauncher _auctionLauncher,
        uint256 _auctionTemplateId
    ) public {
        auctionLauncher = _auctionLauncher;
        mesaFactory = IMesaFactory(_auctionLauncher.factory());
        auctionTemplateId = _auctionTemplateId;
    }

    /// @dev internal setup function to initialize the template, called by init()
    /// @param _auctionLauncher tbd
    ...
    function initTemplate(
        ...
        mesaFactory = IMesaFactory(auctionLauncher.factory());
        auctionTemplateId = _auctionTemplateId;

        IAuctionLauncher(auctionLauncher).getDepositAmountWithFees(5000);
        ...
        */
        ...
        bytes memory encodedInitData = abi.encode(_tokenOut);
