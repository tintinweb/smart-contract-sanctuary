    ...
    ReentrancyGuard
{
    ...
    // Events
    event AuctionCreated(uint256 indexed id, address indexed nftContract, uint tokenId, address creatorAddress,uint creatorSharem, uint openEditionPrice,uint minBidIncrement,uint duration,uint durationIncrement);
    event AuctionBid(
        uint256 indexed id,
        bool oneOfOne,
        uint256 amount,
