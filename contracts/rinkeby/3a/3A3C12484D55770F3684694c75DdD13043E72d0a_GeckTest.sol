...
contract GeckTest is ERC721Enumerable, RoyaltiesV2Impl { 
    ...
    //uint256s
    uint256 public constant MAX_PRIVATE_SUPPLY = 0;
    ...
    uint16[9] LEGENDARY_TIERS = [10, 10, 10, 40, 40, 40, 60, 60, 60];
    ...
    constructor(
        ...
        //Leftover
        TIERS[0] = [5, 15, 20, 30, 40, 50, 60, 90, 120, 570];
        //Body Armor
        TIERS[1] = [20, 80, 100, 300, 500];
        //Weapon
        TIERS[2] = [30, 80, 90, 100, 700];
        //Eyes
        TIERS[3] = [5, 20, 30, 30, 915];
        //Mouth
        TIERS[4] = [5, 10, 40, 45, 50, 70, 180, 200, 200, 200];
        //Head
        TIERS[5] = [428, 428, 428, 429, 429, 429, 429];
        //Body
        TIERS[6] = [200, 200, 200, 200, 200];
        //Background
        TIERS[7] = [2, 7, 72, 100, 155, 200, 300, 434, 541, 559];
    }
