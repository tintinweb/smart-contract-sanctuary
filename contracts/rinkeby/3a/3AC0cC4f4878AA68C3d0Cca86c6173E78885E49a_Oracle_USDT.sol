...
contract UniversalGMUOracle is Ownable, IOracle {
    ...
    function getPrice() public view override returns (uint256) {
        ...
        return (
            price
                .mul(_PRICE_PRECISION) //regular 1 dollar without adjusted decimals
                .mul(10**GMUOracle.getDecimalPercision()) //regular 1 dollar with adjusted decimals
                .div(getGMUPrice()) //2000000 that's a fixed price, arbitrarily determined
                .div(precision)
        );
    }
