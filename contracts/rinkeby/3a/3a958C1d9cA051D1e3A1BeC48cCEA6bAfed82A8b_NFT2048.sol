...
contract NFT2048 is ERC721, Ownable {
    ...
    uint256 public maxGiveableAmount = 1000;

    mapping(address => bool) private mintedFreeAddresses;
    mapping(address => bool) private mintedFree2048Addresses;

    constructor() ERC721("SpaceBudzNFT", "SBUDZ") {
        _baseTokenURI = "https://2048nfts.io/api/token/";
    }

    function contractURI() external pure returns (string memory) {
        return "https://www.2048nfts.io/api/contract_metadata";
    }
        ...
        onlyOwner
    {
        ...
        for (uint256 i = 0; i < arrayLength; i++) {
            _mintAmount(receivers[i], amount);
        }
    }
