...
contract Dancing is ERC721, Ownable {
    ...
    uint256 public whiteListMintLimit = 3000;
    ...
    function whitelistBuy(uint256 _numberOfPasses) public payable {
        ...
        require(
            _tokenIdCounter.current().add(_numberOfPasses) <=
                whiteListMintLimit,
            "ATTEMPTED TO MINT PAST MAX WHITELIST SUPPLY"
        );
        require(
    ...
    function setWhitelistMaxMintSupply(uint256 _maxMintSupply)
        external
        onlyOwner
    {
        whiteListMintLimit = _maxMintSupply;
    }
