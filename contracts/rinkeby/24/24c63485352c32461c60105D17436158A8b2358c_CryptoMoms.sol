...
contract CryptoMoms is ERC721Enumerable, Ownable {
    ...
    // DAD private constant dad = DAD(0xECDD2F733bD20E56865750eBcE33f17Da0bEE461); // MAINNET
    DAD private constant dad = DAD(0x2B39A10F648bf84Ec3Cd8625817d0D383F5e07B2); // RINKEBY
    ...
    constructor(
        ...
        string memory momsContractURI,
        address payable recipient,
        uint256 bps
    ) ERC721("CryptoMoms", "MOM") {
        baseTokenURI = baseURI;
        _contractURI = momsContractURI;
    ...
    function mint() external whenHolderClaimStarted {
        ...
        require(eligibleToClaim, "You have already claimed your CryptoMom");
    ...
    function setContractURI(string memory momsContractURI) public onlyOwner {
        _contractURI = momsContractURI;
    }
