...
/// @author 1001.digital - edit mhjey + ophidian
...
abstract contract WithLimitedSupply {
    ...
    /// @dev Increment the token count
    function onlyIncrement() internal {
        _tokenCount.increment();
    }
...
abstract contract RandomlyAssigned is WithLimitedSupply {
    ...
    function matrixToken(uint256 _tokenId) internal {
        ...
        if (tokenMatrix[maxIndex - 1] == 0) {
            // ...store that ID in the current matrix position.
            tokenMatrix[_tokenId] = maxIndex - 1;
        } else {
            // ...otherwise copy over the stored number to the current matrix position.
            tokenMatrix[_tokenId] = tokenMatrix[maxIndex - 1];
        }
