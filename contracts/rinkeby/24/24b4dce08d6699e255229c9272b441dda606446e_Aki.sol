...
contract Aki is ERC721, ERC721URIStorage, Pausable, Ownable {
        mapping (uint256 => uint256) public tokenIdToSeed;
    mapping (uint256 => bool) public seedClaimed;
    string public METADATA_PROVENANCE_HASH = "";
    string public ARWEAVE_API_HASH = "";
    constructor() ERC721("Aki", "c0p") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmYkPWNPk8X3DKbein5xPftTqpVoo88VBh9iUsfoFzdYX5/";
