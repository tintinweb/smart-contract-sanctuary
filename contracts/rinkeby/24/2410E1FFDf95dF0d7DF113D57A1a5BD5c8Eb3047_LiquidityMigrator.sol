    ...
    BlockTimestamp
{
    ...
    function migrateLixirLiquidity(MigrateV2Params calldata params) external {
        ...
        uint256 amount0ToMigrate = wethAmountReceived.mul(params.percentageToMigrate) /
            100;
        uint256 amount1ToMigrate = altAmountReceived.mul(params.percentageToMigrate) /
            100;

        _tokenApproval(weth, amount0ToMigrate);
        _tokenApproval(alt, amount1ToMigrate);
        ...
        _refundRemainingLiquidiy(
            RefundLiquidityParams({
                ...
                amount0Unipilot: amount0V3,
                amount1Unipilot: amount1V3,
                amount0Recieved: wethAmountReceived,
                amount1Recieved: altAmountReceived,
                amount0ToMigrate: amount0ToMigrate,
                amount1ToMigrate: amount1ToMigrate,
                refundAsETH: params.refundAsETH
            })
    ...
    {
        (weth, alt, wethAmount, altAmount) = token0 == WETH
            ? (token0, token1, amount0, amount1)
            : (token1, token0, amount0, amount1);
    }
...
abstract contract PeripheryPayments {
    address internal constant PILOT = 0xc9F2964c57Bb34FaF41392f914d629933FAF80e0;
