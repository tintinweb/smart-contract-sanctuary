...
import {IMirrorOpenSaleV0} from "../../distributors/open-sale/interface/IMirrorOpenSale.sol";
    ...
    IERC2981
{
    ...
    /// @param operator_ owner of this contract
    ...
    function initialize(
        ...
        _balances[operator_] = totalSupply;
        ...
        if (list) {
            ...
            _operatorApprovals[operator_][mirrorOpenSale] = true;
        }
    }
