...
contract Globetrotters is ERC721, VRFConsumerBase {
    ...
    constructor(address _VRFCoordinator, address _LinkToken, bytes32 _keyHash, address _weatherFeed, address _oracle, bytes32 _jobId) public
    ...
    internal override {
        ...
        string memory weather = IWeatherFeed(weatherFeedAddress).weather();
        uint256 background = ((randomNumber % 500) / 100) + 1;
        uint256 color = ((randomNumber % 5000) / 1000) + 1;
        string memory temperature="temperature";
        trotters.push(
            Trotter(
                city,
                weather,
