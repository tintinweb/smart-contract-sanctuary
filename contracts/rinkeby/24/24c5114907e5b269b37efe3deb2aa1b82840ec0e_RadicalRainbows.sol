...
//Rainbow contract starts here

contract RadicalRainbows is ERC721, Ownable {
    
    using SafeMath for uint256;

    string public RAINBOW_PROVENANCE = "";

    uint256 public constant MAX_TOKENS = 3400;
    ...
    constructor() ERC721("Radical Rainbows", "RadRain") {}

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        RAINBOW_PROVENANCE = _provenanceHash;
    }
