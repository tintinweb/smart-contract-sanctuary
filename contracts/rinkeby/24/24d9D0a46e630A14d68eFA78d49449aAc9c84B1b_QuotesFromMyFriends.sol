...
contract BaseNFT is ERC721, ERC721Metadata, ERC721Enumerable {
    ...
    {
        _tokenURI = "https://gateway.pinata.cloud/ipfs/QmWGrUL4cKWyGvZYFPQhZCvir96o513nYHK1iLQepQiS35/nfttest/000001.json";
        bytes memory _tokenURIBytes = bytes(_tokenURI);
        _tokenURIBytes[89] = bytes1(uint8(48+(_tokenId / 100000) % 10));
        _tokenURIBytes[90] = bytes1(uint8(48+(_tokenId / 10000) % 10));
        _tokenURIBytes[91] = bytes1(uint8(48+(_tokenId / 1000) % 10));
        _tokenURIBytes[92] = bytes1(uint8(48+(_tokenId / 100) % 10));
        _tokenURIBytes[93] = bytes1(uint8(48+(_tokenId / 10) % 10));
        _tokenURIBytes[94] = bytes1(uint8(48+(_tokenId / 1) % 10));
