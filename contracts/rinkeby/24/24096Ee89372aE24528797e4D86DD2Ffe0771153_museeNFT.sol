...
contract museeNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Holder, Ownable, ReentrancyGuard {
    ...
    function createItem(
        ...
        if(!isV1Holder(msg.sender)) {
            require(msg.value == info.listingFee, "insufficient eth");
        }
    ...
    */
    ...
    function _processPayment(uint256 _id, address buyer, uint256 _amount) internal {
        ...
        uint256 _commission = _total.mul(info.adminFeePercent).div(PERCENTS_DIVIDER);
    ...
    */
	...
	function setFeePercent(uint256 _adminPercent, uint256 _royalty, uint256 _listingFee) external onlyOwner {
