...
contract EXOTIC is ERC20 {
    ...
    EXOTICDividendTracker public dividendTracker;

    address public liquidityWallet;
    address payable public marketingWallet = 0x8d0B837be477482683337717D640CE1Bf28EBB09;
    address payable public teamWallet = 0x6e8c9AF9715A9bb9D28F2e139C811F6eB47d47F0;
    ...
    constructor() public ERC20("Exotic Metaverse", "EXOTIC") {
    	...
    	dividendTracker = new EXOTICDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        EXOTICDividendTracker newDividendTracker = EXOTICDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the EXOTIC token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "EXOTIC: Account is already the value of 'excluded'");
    ...
    function sendETHToWallets(uint256 amount) private { 
        ...
        marketingWallet.transfer(balance.div(2)); 
        teamWallet.transfer(balance.div(2));
    }


    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "EXOTIC: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "EXOTIC: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "EXOTIC: Cannot update gasForProcessing to same value");
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        uint256 half = tokens.div(8);
        uint256 otherHalf = tokens.div(8);
...
contract EXOTICDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("EXOTIC_Dividend_Tracker", "EXOTIC_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "EXOTIC_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "EXOTIC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NFTY contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "EXOTIC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "EXOTIC_Dividend_Tracker: Cannot update claimWait to same value");
