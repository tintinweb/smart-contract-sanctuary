...
contract ME is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        _foundersDeedHolderSnapshot[0x86190c50d1dD3Eeb2Ab1dbb8E7195F2195AF321f] = SnapshotAddressMinted(true, false);
        _foundersDeedHolderSnapshot[0x27ae7150C7249CA2A449d85C72A7e824f51d2a87] = SnapshotAddressMinted(true, false);
        _foundersDeedHolderSnapshot[0xd821bd8F420F842b0EfCc7488573A5C0Ffd5842A] = SnapshotAddressMinted(true, false);

        // Testing only
        _foundersDeedHolderSnapshot[_ferb] = SnapshotAddressMinted(true, false);
        _foundersDeedHolderSnapshot[_wickedDig] = SnapshotAddressMinted(true, false);
        _foundersDeedHolderSnapshot[_picoPyro] = SnapshotAddressMinted(true, false);
        _foundersDeedHolderSnapshot[_jups] = SnapshotAddressMinted(true, false);
        _foundersDeedHolderSnapshot[_friendly] = SnapshotAddressMinted(true, false);
        _foundersDeedHolderSnapshot[_duo] = SnapshotAddressMinted(true, false);
    }
