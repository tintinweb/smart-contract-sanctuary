...
//Telegram: https://t.me/RatBSC
//We are GONNA BEEEE RICH!
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0xF962AF6a99C54d777B20BF5e7C832763E8D7611E); // BUSD
...
contract RatCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DontLookUp", "RAT") {
        
        address newOwner = address(0xB7010ef1aB4d7cA088BCbdbbaAf2C6b21c30fCf9);
    
        uint256 totalSupply = 7_753_000_000 * 10**18;
    	...
    	marketingWallet = address(0x1545d5c17A3B20d00995393b95B8dcA658E6F829); // set as marketing wallet
    ...
    function updatemarketingWallet(address newmarketingWallet) external onlyOwner {
        require(newmarketingWallet != address(0), "cannot set to address 0");
