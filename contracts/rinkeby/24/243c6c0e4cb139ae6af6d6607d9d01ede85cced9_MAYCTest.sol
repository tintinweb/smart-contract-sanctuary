...
contract MAYCTest is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    string memory _initNotRevealedUri) ERC721P('MAYCTest', 'MAYCTest') {setBaseURI(_initBaseURI); setNotRevealedURI(_initNotRevealedUri);}
