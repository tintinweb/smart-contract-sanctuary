	...
	*/
	function collateral2DEI(
		...
		if(global_collateral_ratio == 1000000) {
			...
			(uint collateral_needed_amount, uint collateral_for_deus_amount, uint deus_amount) = getAmountsForMint(global_collateral_ratio, proxy_input.amount_out, proxy_input.deus_price);
	...
	function getAmountsForMint(
		...
		collateral_needed_amount = (amount_out * global_collateral_ratio) / (collateral_missing_decimals_d18 * 1e6);
