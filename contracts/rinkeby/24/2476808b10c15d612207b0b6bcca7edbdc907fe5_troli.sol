...
contract troli is Context, IERC20, Ownable {
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 1;
        _rOwned[address(this)] = _rTotal / 1000 * 999;
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 1 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 999 / 1000);
