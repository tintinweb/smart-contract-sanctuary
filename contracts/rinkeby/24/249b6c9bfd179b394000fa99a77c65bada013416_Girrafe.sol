...
contract Girrafe is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;

    uint256 public MAX_ELEMENTS = 9876;
    uint256 public PRICE = 2 * 10**16;
    uint256 public MAX_BY_MINT = 5;
    uint256 public girafee = 20;
	uint256 public giveAways = 1;
	address[] public whitelistedAddresses;
    string public baseTokenURI = "https://api.boredbabes.com/babe/";
    bool public presale = true;
    address public creatorAddress = 0x4d46ba6F9D6C7370b6765D80AF8Ab52e4F20B299;
    address public devAddress = 0x4d46ba6F9D6C7370b6765D80AF8Ab52e4F20B299;

    mapping(address => uint256) public userBalance;
    
    constructor() ERC721("Gaudy Giraffe", "GIRAFFE") {
    }
    ...
    function mint(uint256 _count) public payable {
        ...
        require(girafee + _count <= MAX_ELEMENTS, "Max limit");
	...
	function giveAway(address to) public onlyOwner {
	    require(giveAways <= 20, "max 20 allowed");
