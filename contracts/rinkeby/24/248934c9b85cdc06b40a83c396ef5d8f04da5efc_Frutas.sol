...
//https://etherscan.io/address/0x31f3bba9b71cb1d5e96cd62f0ba3958c034b55e9#code
pragma solidity ^0.8.0;

import 'ERC721Enumerable.sol';
import 'Ownable.sol';

contract Frutas is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 private _maxMint = 20;
    uint256 private _price = 3 * 10**10;///3 * 10**16; ----> 0.03 ETH;
    bool public _paused = true;
    uint public constant MAX_ENTRIES = 10000;

    constructor(string memory baseURI) ERC721("Frutas", "FRU")  {
        setBaseURI(baseURI);

        // team gets the first 50
        mint(msg.sender, 1); //Ahora da 1 al equipo de inicio
    }
