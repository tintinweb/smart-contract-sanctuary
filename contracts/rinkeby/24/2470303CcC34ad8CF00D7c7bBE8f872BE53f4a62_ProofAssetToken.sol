...
contract ProofAssetToken is ERC20 {
    ...
    IERC20 public prf = IERC20(0xD53347f50096dcFcD32f85B22EEB710b7Ffc8C61);    
    prfInterface public prfInterfaceCall = prfInterface(0xD53347f50096dcFcD32f85B22EEB710b7Ffc8C61);
