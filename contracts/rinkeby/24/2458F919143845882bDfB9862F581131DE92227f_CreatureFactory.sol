...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "http://happybearsisland.com/api/creature/";
    string public contractURI = "http://happybearsisland.com/contract/happy-bear-island";

    /*
     * Enforce the existence of only 100 OpenSea creatures.
     */
    uint256 CREATURE_SUPPLY = 1;
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        Finaltest openSeaCreature = Finaltest(nftAddress);
...
contract CreatureLootBox is ERC721Tradable {
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "http://happybearsisland.com/api/box/";
    }
...
/**
 * @title Finaltest
 * Finaltest - a contract for my non-fungible creatures.
 */
contract Finaltest is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Final Test", "FT", _proxyRegistryAddress)
    {}
