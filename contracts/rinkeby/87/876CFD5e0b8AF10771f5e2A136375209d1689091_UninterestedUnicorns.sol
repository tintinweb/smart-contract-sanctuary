    ...
    Ownable
{
    ...
    uint256 public constant PRIVATE_SALE_WINDOW = 10 minutes; // For testing only
    ...
    uint256 public constant PRIVATE_SALE_OPEN = 1631223300; // For testing only
    uint256 public constant PUBLIC_SALE_OPEN =
        PRIVATE_SALE_OPEN + PRIVATE_SALE_WINDOW;
    ...
    IBloot private BLOOT = IBloot(0x4F8730E0b32B04beaa5757e5aea3aeF970E5B613);
    // uint256 public constant BLOOT_SALE_WINDOW = 1 hours;
    uint256 public constant BLOOT_SALE_WINDOW = 15 minutes;
    ...
    function mint(uint256 _quantity) public payable whenNotPaused onlyEOA {
        ...
        require(
            ...
            "UninterestedUnicorns: Limit Exceeded"
        );
        require(
            _quantity > 0,
    ...
    function isBlootSaleOpen() private view returns (bool) {
        return
            block.timestamp >=
