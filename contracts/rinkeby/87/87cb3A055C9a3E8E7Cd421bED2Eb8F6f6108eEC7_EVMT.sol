...
contract EVMT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666666666666 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "Evil Von Musk Token";
    string private _symbol = "EVMT";
    ...
    uint256 public numTokensSellToAddToLiquidity = 6666666 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 66666, "Max Tx Amount cannot be less than 66 Thousand");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 66666, "Swap Threshold Amount cannot be less than 66 Thousand");
