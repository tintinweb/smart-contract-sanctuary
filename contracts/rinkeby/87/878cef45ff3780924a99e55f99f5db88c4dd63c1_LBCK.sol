...
contract LBCK is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_LBCK = 8888;
    ...
    bool private reservedLBCK = false;
    uint256 public  reserveMinted = 0;
    bool public saleEnabled = false;

    // presale for the lbck community :)
    uint256 public prelbckCount = 0;
    mapping(address => bool) prelbckAllowed;
    mapping(address => uint256) prelbckMinted;
    ...
    constructor(string memory _lbck) ERC721("LBCK", "LBCK") {
        baseURI = _lbck;
    }
    ...
    function freeMintLBCK() public payable isSaleStarted {
        ...
        require(prelbckCount + 1 <= MAX_FREE, "No more free LBCKs!");
        require(prelbckMinted[msg.sender] < 1, "You already minted your free LBCK!");

        _safeMint(msg.sender, __lbck);
        lbckBalance[msg.sender]++;

        prelbckMinted[msg.sender] = 1;
        prelbckCount += 1;
    }
