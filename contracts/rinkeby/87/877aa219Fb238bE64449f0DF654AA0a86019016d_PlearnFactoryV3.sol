...
contract PlearnFactoryV3 is Initializable, IPlearnFactory {
...
contract PlearnPair is IPlearnPair, PlearnERC20 {
    ...
    uint32 public override swapFee; // uses 0.1% default
    uint32 public override devFee; // uses 0.5% default from swap fee
