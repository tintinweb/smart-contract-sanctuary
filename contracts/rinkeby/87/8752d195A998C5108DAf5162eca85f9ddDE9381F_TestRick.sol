...
contract TestRick is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test Rick", "RC") {
    setHiddenMetadataUri("ipfs://QmXXTuVyjxEefYyVNSUKFUnvW3uf6Y4RRxYoeVEtAnXFGF/hidden.json");
  }
