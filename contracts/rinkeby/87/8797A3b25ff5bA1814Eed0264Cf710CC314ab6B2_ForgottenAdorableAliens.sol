 ...
 * @notice This contract provides minting for Forgotten Aliens NFT by twitter.com/adorablealiens_
 */
contract ForgottenAdorableAliens is ERC721, Ownable, ReentrancyGuard {
    ...
    function mintWithAlien() public nonReentrant {
        ...
        require(_tokenIds.current() < MAX_SUPPLY, "MAX_SUPPLY_REACHED");
    ...
    function mint(uint256 numberOfMints) public payable nonReentrant {
        ...
        require(_tokenIds.current() + numberOfMints < MAX_SUPPLY, "MAX_SUPPLY_REACHED");
