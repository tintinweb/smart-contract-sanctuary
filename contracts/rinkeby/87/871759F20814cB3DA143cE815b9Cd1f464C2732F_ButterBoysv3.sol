...
/* ____  _     _____  _____  _____ ____    ____  ____ ___  _ ____ 
/  __\/ \ /\/__ __\/__ __\/  __//  __\  /  __\/  _ \\  \/// ___\
| | //| | ||  / \    / \  |  \  |  \/|  | | //| / \| \  / |    \
| |_\\| \_/|  | |    | |  |  /_ |    /  | |_\\| \_/| / /  \___ |
\____/\____/  \_/    \_/  \____\\_/\_\  \____/\____//_/   \____/
*/                                        

contract ButterBoysv3 is ERC721, Ownable, ERC721Burnable, ERC721Pausable {
    uint256 private _tokenIdTracker;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    //mint elements
    uint256 public constant MAX_ELEMENTS = 8888;
    uint256 public constant PRESALE_ELEMENTS = 4444;
    uint256 public constant TOTAL_FREE_MINTS = 500;
    ...
    constructor()
    ERC721("ButterBoys v3", "BUTTERSV3")
    {
        pause(true);
        setWithdrawAddress(0xa4916A833C41224b990566C727af901f9e358d29);
    }
    ...
    function mint(uint256 _count) public payable saleIsOpen noContract {
        ...
        require(total + _count <= MAX_ELEMENTS, "Max limit exceeded");
        require(_count <= MAX_BY_MINT, "Exceeds max mint amount (3)");
        if(_tokenIds.current() > 500) {
            require(msg.value >= 80000000000000000, "Value is too low");
        }
