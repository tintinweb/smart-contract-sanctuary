...
// File: Metaease/contracts/IERC20Cutted.sol
...
// File: Metaease/contracts/lockToken.sol
...
contract VestingWallet is Ownable {
    ...
    mapping (address => bool) public beneficiarys;
    mapping(address => uint256) public addressAvailableToken;
    ...
    modifier onlyBeneficiary() {
        require(beneficiarys[msg.sender] == true, "VestingWallet: caller is not the beneficiary");
        _;
    }

    constructor() {
        beneficiarys[address(0x01e5fB08c65015c485C68c63B1634a43c06598E4)] = true;
        beneficiarys[address(0xD51D05C75807d880D654D347111184B9dc149FF5)] = true;
        beneficiarys[address(0x5be145BDf69853846E8773fE49f6da10d67FE651)] = true;
        addressAvailableToken[address(0x01e5fB08c65015c485C68c63B1634a43c06598E4)] = 50_000_000 ether;
        addressAvailableToken[address(0xD51D05C75807d880D654D347111184B9dc149FF5)] = 25_000_000 ether;
        addressAvailableToken[address(0x5be145BDf69853846E8773fE49f6da10d67FE651)] = 25_000_000 ether;
    ...
    function withdraw() public onlyBeneficiary whenLocked {
        ...
        if (block.timestamp >= start.add(duration)) {
            ...
            uint256 tokensByPart = addressAvailableToken[msg.sender].div(parts);
            ...
            uint256 tokensToWithdraw = tokensToWithdrawSinceStart.sub(withdrawedTokens[msg.sender]);
            require(tokensToWithdraw > 0, "VestingWallet: no tokens available for withdrawal at this moment");
            withdrawedTokens[msg.sender] = withdrawedTokens[msg.sender].add(tokensToWithdraw);
