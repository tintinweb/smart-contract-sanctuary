...
// END AMOS //
    ...
    function redeem(
       ...
       lastRedeemed[msg.sender] = block.number;
        ...
        mintersDetails[msg.sender].amount = mintersDetails[msg.sender].amount.sub(collateralNeededBeforeFee);
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0xC4BC84B3c6779Db9009ae73Bb110fe6DF907b8CF"
    }
  },
  "outputSelection": {
    "*": {
