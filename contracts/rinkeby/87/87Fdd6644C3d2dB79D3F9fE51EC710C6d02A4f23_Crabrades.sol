...
contract Crabrades is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address admin = 0xDC4BEE14DF2a04D9c52Df2103AdF39E524788CeB;
    ...
    function adopt(uint256 num) public payable {
        ...
        require( num < 31,                              "You can adopt a maximum of 30 Crabrades" );
        require( supply + num < 10000 - _reserved,      "Exceeds maximum Crabrades supply" );
    ...
    function withdrawAll() public payable onlyOwner {
        require(payable(admin).send(address(this).balance));
    }
}
