...
contract CHROMEkids2 is ERC721Enumerable, Ownable {
    ...
    uint256 public constant             MAX_KIDS                 = 6667;
    ...
    function publicMint(uint256 _mintAmount) public payable {
        ...
        //require(publicMints[msg.sender] + _mintAmount < 11, "No more than 10 public mints per wallet");
        require(_mintAmount < KIDS_PER_TX, "Exceeded max per transaction");
        require(_mintAmount * KID_PRICE == msg.value, "Not enough ETH bruh.");
  
        //publicMints[msg.sender] += _mintAmount;
        for (uint256 i = 0; i < _mintAmount; i++) {
          _mint(_msgSender(), totalSupply + i);
        }
    }
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool cool, ) = payable(partner).call{value: address(this).balance * 5 / 100}("");
