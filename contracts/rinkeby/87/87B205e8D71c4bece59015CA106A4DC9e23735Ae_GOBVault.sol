...
contract GOBVault is IGOBVault, Ownable {
  ...
  // uint numberOfHolders = 1000;

  // GOBToken _token;

  //   mapping(uint => uint) rewardByRound;

  // function captureSnapshot() public onlyOwner {

  // }

  //   function receive() external payable {
  //     uint fracValue = msg.value / numberOfHolders;
  //     rewards[currentRound] = rewards[currentRound] + fracValue;
  //   }

  //   function withdraw(uint round) public {
  //     uint rewardValue = rewards[round];
  //     uint balance = 0; // ...



  //    uint value = rewardValue * balance;
  //    transfer(value, )
  //   }
