...
contract VR002 is ERC721Enumerable, Ownable {
	...
	address public burnerWallet = 0x39A715308a23e04Efe5D23c3000A141fE2ad02aE; // need to fill
	string public parentURI;
	bool public salesActive;

	// should be able to access index here
	...
	// depending on tokenId, set whitelist to given state (true/false)
	...
	// get balance of token type
	function getAmountClaimedForToken(uint8 _tokenId) public view returns (uint8) {
		uint8 tokenId = getTokenId(_tokenId);
		return tokens[tokenId].claimed;
	}

	// mint depending on tokenId
