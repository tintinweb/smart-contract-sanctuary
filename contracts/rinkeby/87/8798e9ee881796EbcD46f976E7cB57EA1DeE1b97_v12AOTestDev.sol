...
contract v12AOTestDev is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/94/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/94/contract-uri";
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("v12AOTestDev", "1") {
