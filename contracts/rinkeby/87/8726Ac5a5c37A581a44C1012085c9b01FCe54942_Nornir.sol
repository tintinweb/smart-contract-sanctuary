...
contract Nornir is ERC721, VRFConsumerBase {
	...
	uint16 public constant MAX_VIKING = 9873;
	...
	struct Viking {
		...
		uint256 intellgience; // Unattached
		string name;
	}
	...
	function requestRandomnViking(uint256 userProvidedSeed, string memory _name) public returns (bytes32) {
	...
	function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
		...
		uint256 defense = ((randomNumber % 10000000000) / 100000000);
		uint256 intellgience = ((randomNumber % 1000000000000) / 10000000000);
