...
contract ricksanchezuni is ERC721, Ownable, ERC721Enumerable {
    ...
    event RickMinted(uint256 tokenId, address owner);

    constructor() ERC721("Rick Sanchez Universe-Test", "DSGN") {}
    ...
    function mintRick(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_TOKENS) {
                ...
                emit RickMinted(id, msg.sender);
            }
        }
    }

    function presaleRick(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
    {
        ...
        if (isRevealed == false) {
            return
                "ipfs://QmW43wsV8FyF3ALPcUPuiWzbbAJVxBfSFYdxwFRq4BRgXn/HiddenGif.json";
        }
