...
import "@openzeppelin/[email protected]/access/roles/WhitelistedRole.sol";
import "@openzeppelin/[email protected]/ownership/Ownable.sol";
...
contract WavepoolICO is Crowdsale, TimedCrowdsale, WhitelistedRole, Ownable {
  ...
  function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
    ...
    require(_contributions[beneficiary].add(weiAmount) <= _weiCap, "Beneficiary's cap exceeded");
