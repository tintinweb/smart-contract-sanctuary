...
contract bhsbhdfTest02 is ERC721Enumerable, Ownable {
	...
	function setPresaleAmounts(uint start, uint cap, uint qty) public onlyOwner {
		...
		presalePriceCap = cap;
		maxTxQty = qty;
		priceFactor = ((cap - start) * (10 ** 16) / (maxTokenSupply / 100));
	}
