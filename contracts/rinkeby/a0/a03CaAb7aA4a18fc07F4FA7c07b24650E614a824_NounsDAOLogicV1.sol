...
contract NounsDAOLogicV1 is NounsDAOStorageV1, NounsDAOEvents {
    ...
    event TempThres(uint256 _value);
    event NounsVotes(uint96  _value);
    ...
    function propose(
        ...
        uint96 numPri = nouns.getPriorVotes(msg.sender, block.number - 1);
        emit TempThres(temp.proposalThreshold);
        emit NounsVotes(numPri);
