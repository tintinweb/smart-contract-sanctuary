...
contract SimpleCollectible is ERC721, RoyaltiesV2Impl, Ownable {
    ...
    function createCollectible(string memory myTokenURI)
        public
        payable
        returns (uint256)
    {
        ...
        uint256 floorPrice = 10**13;
        //TEST Price of 10**13 = 0.00001 eth
    ...
    //onlyOwner
    function setRoyalties(uint256 _tokenId) public {
    ...
    // (TokenURI) Add back the missing _setTokenURI() from ^0.8.0
