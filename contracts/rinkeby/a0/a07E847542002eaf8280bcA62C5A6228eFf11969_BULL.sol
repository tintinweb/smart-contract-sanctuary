...
contract BULL is ERC721Enumerable, Ownable {
    ...
    uint256 constant public preSaleTime = 1633651200;
    ...
    */
    ...
    constructor() ERC721("BULL", "BULL") {
        //setBaseURI(baseURI);
        singleAddressToWhiteList(0x12C7959cc5E30B7c4D8668aB250e17A4c19b0C31);
    }
    ...
    */
    ...
    function preSaleMint(uint256 _mintCount) public payable onlyWhitelisted {
        ...
        require(block.timestamp >= preSaleTime,                 'Pre sale is not started yet.');
    ...
    function info() public view returns (uint256, uint256, uint256, uint256, bool, bool) {
        return (price, maxPreSaleMint, maxPublicSaleMint, preSaleTime, isPreSaleActive, isPublicSaleActive);
    }
}
