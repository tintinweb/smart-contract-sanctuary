...
contract Crypt0bugs is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("Crypt0bugs", "cBUGs");
        __Ownable_init();
    }

    function safeMint() public payable {
        require(msg.value >= 85000000000000000, "Not enough ETH sent; check price!"); 
