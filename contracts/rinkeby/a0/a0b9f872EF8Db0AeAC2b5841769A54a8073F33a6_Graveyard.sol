...
contract Graveyard is ERC721Enumerable {
    ...
    uint256 public DEFAULT_DIGGING_TIME = 120;
    ...
    function initDigTime(uint256 graveId, uint256 multipler) internal {
        tokenIdToTargetTime[graveId] =
            block.timestamp +
            (DEFAULT_DIGGING_TIME * multipler);
    }
