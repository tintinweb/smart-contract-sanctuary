...
contract NFTFlag is ERC721Enumerable, Ownable {  
    ...
    // Starting and stopping sale and WhiteListMint
    ...
    function setAddresses(address[] memory _treasury) public onlyOwner {
        Treasury = _treasury[0];
    }
    ...
    function withdrawTeam(uint256 amount) public payable onlyOwner {
        ...
        // send to Guild Treasury
        require(payable(Treasury).send(percent * 100));
    }
