  ...
  function _beforeTokenTransfer(
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xa63e950424b8e5fC61556dEBFb6C33ca46Dc0064);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 22');
    ...
    // File: contracts/tribuanaContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract TribuanaContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Tribuana", "TRIB", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://rampp.xyz/XK1dzbzZ1xzJS7jfng6s/token/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://rampp.xyz/XK1dzbzZ1xzJS7jfng6s/contract-metadata";
        }
    }