...
contract HippyGhostsERC721 is ERC721Enumerable, IERC2981, Ownable {
     ...
     */
    uint256 private _mintIndex = 100;
     ...
     */
    uint256 public mintPrice = 30000000000000000;  // 0.03 ether
    ...
    function _mintInSequenceToAddress(address destination, uint256 numberOfTokens) internal {
        require(totalSupply() + numberOfTokens <= maxSupply, "Not enough ghosts remaining to mint");
    ...
    function mint(uint256 numberOfTokens) public payable {
        ...
        require(numberOfTokens <= 20, "Max ghosts to mint is 20");
    ...
    function mintMultipleTokensWithSignature(
        ...
        require(valueInWei == msg.value, "Incorrect ether value sent");
        require(_claimedMintKeys[mintKey] == false, "Mint key already claimed");
        require(totalSupply() + tokenIds.length <= maxSupply, "Not enough ghosts remaining to mint");
