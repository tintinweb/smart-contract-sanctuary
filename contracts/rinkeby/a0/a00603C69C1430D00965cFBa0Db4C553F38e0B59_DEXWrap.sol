...
abstract contract IDO is Ownable, ReentrancyGuard {
    ...
    uint256 public constant lockDuration = 3 * unit;
    uint256 public constant regDuration = 3 * unit;
    uint256 public constant saleStartsAfter = regDuration + 5 * unit;
    uint256 public constant saleDuration = 3 * unit;
    uint256 public constant fcfsDuration = 3 * unit;
