...
contract VaultPipe is Pipe {
     ...
     * by utilizing the external contract's interface.
     */
    function _withdrawFromVault(uint256 _amount, address _user, address _sender) public override {
        vault.withdrawTokens(_amount, _user, _sender);
    }
...
contract Pipe is Vault {
    ...
    function _withdraw(int96 _flowRate, address _user) internal returns (uint256) {
        ...
        if (availableVaultWithdrawAmount > 0) {
            ...
            _withdrawFromVault(availableVaultWithdrawAmount, _user, address(this));
...
abstract contract IFakeVault is ERC20 {
    ...
    function withdrawTokens(uint256 _amount, address _user, address _sender) public virtual;
}
...
abstract contract Vault {
    ...
    function _withdrawFromVault(uint256 amount, address user, address _sender) public virtual {}
