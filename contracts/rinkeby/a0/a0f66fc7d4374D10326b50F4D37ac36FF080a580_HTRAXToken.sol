...
abstract contract ERC20Snapshot is ERC20 {
        ...
        private view returns (bool, uint256)
    {
        ...
        //  created for this id, and all stored snapshot ids are smaller than the requested one. 
        ...
        //  There will be no entry for the requested id: the value that corresponds to it is that of the smallest 
        //  snapshot id that is larger than the requested one.
        //
        //  In summary, we need to find an element in an array, returning the index of the smallest value
        //  that is larger if it is not found, unless said value doesn't exist (e.g. when all values are smaller). 
