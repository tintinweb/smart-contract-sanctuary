    ...
    Ownable
{
    ...
    uint256 private constant maxTokensPerTransaction = 20;
    uint256 private tokenPrice = 50000000000000000; //0.05 ETH
    uint256 public constant nftsNumber = 14; // Starts at Octoplush #1 so only 13 in total
    uint256 private constant nftsPublicNumber = 14; // 50 for giveaways and promotions

    Counters.Counter private _tokenIdCounter;

    event Giveaway(address to, uint256 tokensNumber);

    constructor() ERC721("Octoplushv2", "OCTO") {
