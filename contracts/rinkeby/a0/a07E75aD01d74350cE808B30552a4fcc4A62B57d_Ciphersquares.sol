...
contract Ciphersquares is ERC721, Ownable {
    ...
    uint256 public constant nftPrice = 90000000000000000; //0.09 ETH
    ...
    address payable private constant _tFirst =
        payable(0x033863BDa902514972fb0A427aA92B8bB324f95E);
    address payable private constant _tSecond =
        payable(0x6aE2270b24286930E756525b378eF4E4F1D72AC9);
