...
contract SPLAT is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor (string memory customBaseURI_) ERC721("721 SPLAT", "TSPLT") {
  ...
  function mint(uint256 id) public nonReentrant onlyOwner {
