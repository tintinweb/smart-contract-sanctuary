...
contract BadCache721 is ERC721, ERC721URIStorage, Ownable {
  ...
  // function tokenURI(uint256 tokenId) public view virtual override(ERC721, ERC721URIStorage) onlyOwner returns (string memory) {
