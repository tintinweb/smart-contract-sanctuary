...
contract testNftFactory is Ownable, ERC721{
  ...
  //  uint public HungerBrainz_MAX_COUNT = 40000; //maxSupply
    ...
    constructor(address _gameAddress, address _tokenAddress,address _whitelist,address _metadata,address _vrf) ERC721("HungBiz", "HBZ") {
    ...
    // available at this link: https://hungerbrainz.com/terms 
        ...
        require(tokenId_.current() <= 10000,"Buy using SUP");
        if(isPresale){
    ...
    // available at this link: https://hungerbrainz.com/terms
       require(tokenType < 2,"Invalid type");
       require(tokenId_.current() > 10000,"Buy using Eth");
