...
contract PublicPricingSession is ReentrancyGuard, PostSessionLibrary {
    ...
    //For test
    mapping (address => uint) public amountHarvested;
    //For test
    mapping (address => uint) public ethPayout;
    //For test
    mapping (address => uint) public winnerPoints;
    ...
    */
    ...
    function claimProfit() checkHarvestLoss nonReentrant checkParticipation external {
        ...
        console.log("Eth Payout: %s", ethPayout[msg.sender]);
