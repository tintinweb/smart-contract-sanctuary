...
contract PrettyAwesomeWords is ERC721Enumerable, Ownable {
  ...
  uint256 public bgone;
  uint256 public faceone;
  uint256 public eyeone;
  uint256 public mouthone;
   struct Word { 
      string name;
      string description;
      string bgz;
  ...
  function mint() public payable {
    ...
    bgone = randomNum(3, block.difficulty, supply);
    faceone =randomNum(3, 1000000, 10000);
    eyeone = randomNum(3, 1000000, 10000);
    mouthone = randomNum(3, block.timestamp, supply);
  ...
  function buildImage(uint256 _tokenId) public view returns(string memory) {
      ...
      return Base64.encode(bytes(
          abi.encodePacked(
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 32 32" shape-rendering="crispEdges">',currentWord.bgz,'',currentWord.facez,'',currentWord.eyez,'',currentWord.mouthz,'</svg>')
      ));
  }
