...
// Part: JellyAccessControls

contract JellyAccessControls is JellyAdminAccess {
 ...
 */
contract Jelly is Context, JellyAccessControls, ERC20, Pausable, ERC20Permit {
    ...
    */
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused() || hasOperatorRole(_msgSender()), "ERC20Pausable: token transfer while paused");
    }
