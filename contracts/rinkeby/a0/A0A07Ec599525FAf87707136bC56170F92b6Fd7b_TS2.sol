...
contract TS2 is ERC721("TS-2-Project", "TS-2"), ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NFT_PUBLIC = 15;
    uint256 private constant MAX_NFT = 20;
    ...
    */
    function mintByOwner(
        ...
        onlyOwner
    {
        require(_tokenId < (MAX_NFT + 1), "Tokens number to mint cannot exceed number of MAX tokens");
