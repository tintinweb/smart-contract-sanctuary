...
contract EGGVERSEAuction is ERC721, Ownable {
    ...
    event AuctionAccepted(uint256 _tokenId, address acceptBidder, uint256 acceptedAt, uint256 acceptedPrice);
     ...
     */
    function acceptBid(uint256 _tokenId, address acceptBidder, uint256 acceptedAt, uint256 acceptedPrice) external onlyBid {
        auctionStatus[_tokenId] = Status.PENDING;
        emit AuctionAccepted(_tokenId, acceptBidder, acceptedAt, acceptedPrice);
    }
