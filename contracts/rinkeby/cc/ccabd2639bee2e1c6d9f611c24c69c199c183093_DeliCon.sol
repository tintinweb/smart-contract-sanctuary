...
contract DeliCon {
    ...
    struct Order {
        ...
        /* Hash of the decrypted customer_data
         * this way the courier can verfiy that
         * the restaurant has not manipulated the
         * customer_data it presents to the courier.
         */
        bytes32 customer_data_hash;
        uint256 number; 
        address restaurant;
        address customer;
        address courier;
 ...
 // ["test", "test", "test"], "hello", 0xDEADBEEF
    ...
    */
    ...
    function customer_create_order(string calldata customer_data, bytes32 customer_data_hash, address restaurant_address) public payable returns (uint256)  {
        ...
        order.customer_data_hash = customer_data_hash;
