...
contract NEWT is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    constructor()
    ERC721("New Test", "NEWT")
    PaymentSplitter(addressList, shareList)  {}

    function mint(uint256 _count) public payable {
        uint256 supply = totalSupply();
        require( block.timestamp >= _startTime,        "General sale has not started yet" );
        require( _count <= MAX_TOKENS_PER_TRANSACTION, "You can mint a maximum of 20 per transaction" );
        require( supply + _count <= MAX_SUPPLY,        "Exceeds current supply limit" );
    ...
    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        NEWT_PROVENANCE = _provenanceHash;
    }
