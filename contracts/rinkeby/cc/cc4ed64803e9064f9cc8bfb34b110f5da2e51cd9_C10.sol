...
contract C10 is Context, IERC20, Ownable {
    ...
    uint256 private _newValue = 2;
    address payable private _feeAddrWallet1;
    address payable private _feeAddrWallet2;
    string private constant _name = "C10";
    string private constant _symbol = "C10";
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        function setNewValue(uint256 newValue) external onlyOwner() {
