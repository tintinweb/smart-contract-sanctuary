...
contract Controller is IController, Context {
    ...
    function setVault(address _token, address _vault) public governanceOrStrategy {
    ...
    /// @param _vault Address of the vault.
    /// @param _strategy Address of the strategy.
    function setStrategy(address _vault, address _strategy) public governanceOrStrategy {
    ...
    /// @dev Can only be called by governance or strategist.
    /// @param _vault Address of the vault.
    function withdrawAll(address _vault) public governanceOrStrategy {
    ...
    /// @param _token Address of the token.
    /// @param _amount Amount of the tokens.
    function inCaseTokensGetStuck(address _token, uint256 _amount) public governanceOrStrategy {
    ...
    /// @param _token Address of the token.
    /// @param _strategy Address of the strategy.
    function inCaseStrategyTokenGetStuck(address _strategy, address _token) public governanceOrStrategy {
