...
contract Nft is ERC721Enumerable, ERC721Pausable, Ownable, Unlockable {
    ...
    function sumRoyalties() public view returns (uint256) {
    ...
    function nftListCancel(uint256 _id) external {
        require(
            _isApprovedOrOwner(msg.sender, _id),
    ...
    function _nftMint(address _to, uint256 _id) private {
        _safeMint(_to, _id);
    }

    function getTradeStatus(uint256 _id) external view returns (bool) {
...

{
  ...
  "libraries": {
    "/home/ubuntu/environment/contracts/contracts/Nft.sol": {
      "SwapMapping": "0xc66201b75c8e87Eeb07040130c71c5fCB8096864"
    }
  },
  "outputSelection": {
    "*": {
