...
contract InventoryERC1155 is  ERC1155, Ownable {
     ...
     * 
     */
    constructor (string memory uri_, address _dungToken)  ERC1155(uri_) 
    {
        dungERC20 = _dungToken;
        _mint(address(this), 0, 5, bytes('0')); 
        inventoryProperties[0] = Inventory(InventoryType.Hat,       3000e33, 20);
        _mint(address(this), 1, 3, bytes('0'));
        inventoryProperties[1] = Inventory(InventoryType.Pipe,      2500e33, 15); 
        _mint(address(this), 2, 5, bytes('0')); 
        inventoryProperties[2] = Inventory(InventoryType.Moonshine, 2000e33, 12);
        _mint(address(this), 3, 5, bytes('0')); 
        inventoryProperties[3] = Inventory(InventoryType.Shovel,    1500e33, 10);
        _mint(address(this), 4, 5, bytes('0')); 
        inventoryProperties[4] = Inventory(InventoryType.Rake,      1500e33, 10);
        _mint(address(this), 5, 3, bytes('0'));
        inventoryProperties[5] = Inventory(InventoryType.Pitchfork, 1500e33, 10); 
    }
    ...
    /*
     * @dev this is not full standard bot common use imlementation
     *
     */ 
