...
contract EthereumPepe is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 777777777777777777 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tBurnTotal;

    string private _name = 'Ethereum Pepe';
    string private _symbol = 'ePEPE';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[2]/**tholder*/ = tAmount.div(100).mul(7);
        _localVal[3]/**tLiquidity*/ = tAmount.div(100).mul(7);
