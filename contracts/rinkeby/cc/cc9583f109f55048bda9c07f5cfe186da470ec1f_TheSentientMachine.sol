...
// File @openzeppelin/contracts/token/ERC721/extensions/[email protected]2.0
...
contract TheSentientMachine is ERC721Enumerable {
  ...
  function contractURI() public pure returns (string memory) {
    return
      string(
        'https://sentientmachine.mypinata.cloud/ipfs/QmXBDqbdut27nQSbn5jyorxwoRdLkLLba863RLc1E7kEw8'
      );
  }
