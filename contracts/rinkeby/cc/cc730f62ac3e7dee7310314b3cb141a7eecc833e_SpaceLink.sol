...
Minting 10% from purchase, that 10% is split between ( 50% auto reflection, 30% liquidity, 20% charity wallet)
 */ 
contract SpaceLink is Context, IERC20, Ownable {
    ...
    address private _CharityWalletAddress = 0x37024940342307e195EAE82521B389182d510bE7;
