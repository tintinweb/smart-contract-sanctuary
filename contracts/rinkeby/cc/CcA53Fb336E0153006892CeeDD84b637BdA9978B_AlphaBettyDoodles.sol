...
contract AlphaBettyDoodles is ERC721Enumerable, Ownable {
    ...
    uint256 private _launchTimeEpochSeconds = 1628100000;

    string private _baseTokenURI = "https://cloudfront.net/fooobar/";
    bool private _ripCord = false;

    constructor() ERC721("Alpha Betty Doodles", "ALPHABETTY") {}
    ...
    function mintOwnerTokens() public onlyOwner {
        uint256 totalSupply = totalSupply();
        require(totalSupply < 100, "100 tokens already minted.");
    ...
    function mint(uint256 _count) public payable {  
        ...
        require(_count <= 50, "Mint 50 or fewer, please.");
    ...
    function freeMint(uint256 _count) public {
        require(getChainId() != 1, "No free lunch on mainnet");
        uint256 totalSupply = totalSupply();
