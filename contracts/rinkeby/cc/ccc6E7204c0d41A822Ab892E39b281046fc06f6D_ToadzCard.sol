...
contract ToadzCard is ERC721, Ownable {
    using SafeMath for uint256;

    ERC721 CrypToadz_OG = ERC721(0x1CB1A5e65610AEFF2551A50f76a87a7d3fB649C6);
    ERC721 CrypToadz = ERC721(0xe3D0EF05dF02F2fe76796DcE1E9D600cA34a7998);
    ...
    function publicMint(uint256 _quantity) public payable {
        require(totalSupply() < 9697, "No more tokens to mint");
