...
contract OlympusDistributorContract is Policy {
    ...
    uint public immutable blocksInEpoch;
    ...
    function distribute() external returns ( bool ) {
        ...
        ITreasury( treasury ).mintRewards( staking, getCurrentRewardForNextEpoch() );
        return true;
    }
    ...
    /**
        @notice set reward rate in ten-thousandths of a percent ( 5000 = 0.5% )
        @return bool
     */
