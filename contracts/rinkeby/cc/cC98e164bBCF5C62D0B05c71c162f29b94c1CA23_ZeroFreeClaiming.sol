...
// File: contracts/ZeroFreeClaiming.sol
...
contract ZeroFreeClaiming is Ownable {
    using SafeMath for uint256;

    mapping(address => uint256) public buyers_limits;
    address public token;
    uint256 public genesis;
    uint256 public claimingDuration = 1 days;
    ...
    function setClaimingDuration(uint256 newDeadline) external onlyOwner {
        claimingDuration = newDeadline;
    }
    ...
    function purchase() public {
        require(block.timestamp < genesis + claimingDuration, "Claiming finished");
        uint256 amount = buyers_limits[msg.sender];
        buyers_limits[msg.sender] = 0;
