...
contract VariousBooks is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private nouns = [ 
    ...
    "Vallonia","Bandung City","Friedegg", "Caledonia","Aburidiland", "Carpathia", "Aeluca",
    "Arkadia", "Oz", "Kastanije", "Penlands", "Freeholds", "Aburidiland", "Paphlagonia",
    "Trapezuntia", "Mysia", "Caria", "Thessalia", "Thistle", "Northwatch", "Fitzgibbon",
    "Sonora", "Niakyr", "Riftwatch", "Roucester","Nemuro","Luskan","Castellis",
    "Locke","Hillcrest","Marlstown","Myconid","Luskan","Castellis","Locke","Hillcrest","Marlstown",
    "Myconid","Hannat", "Carras", "Harthaurd", "Khuul", "Trent", "Koromarr", "Illefarnil", "Gloomhaven",
    "Rivermorne","Blossom", "Luskan", "Elze", "Apolis", "Rhylcross", "Redwater", "Leras", "Mistshore",
    "Silverymoon", "Sykt",  "Eldrich", "Shuruppak", "Locmaria", "Loudwater", "Morast"
  ...
  string[] private adjectives = [
    ...
    "Caliphate", "Republic", "Province", "Grand", "Duchy", "Capital Federation","Autonomous Province", "Deadmoon Docks","Free democracy",
    "Forgotten Shores","Federal Republic", "Decentralized Unitary Republic"
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    ...
    string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Country:', getTitleOutput(tokenId), '", "description": "Various Books is a collection of speculative books generated and stored on chain.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
