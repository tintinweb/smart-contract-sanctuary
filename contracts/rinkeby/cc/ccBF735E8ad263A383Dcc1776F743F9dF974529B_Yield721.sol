...
contract Yield721 is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public rewardsPerDay = 10;
    ...
    function setMintStart(uint256 _startTime) external onlyOwner {
        require(_startTime > block.timestamp, "Can only set mint start on a future date");
    ...
    function getRewardDays(uint256 _startTime, uint256 _endTime) internal pure returns (uint256) {
