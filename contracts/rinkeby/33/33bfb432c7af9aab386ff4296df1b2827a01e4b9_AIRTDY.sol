...
contract AIRTDY is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable{
	...
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = 15;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 15;
	
	uint256 public SALE_PRICE = 9 * 10**16;
	uint256 public PRESALE_PRICE = 85 * 10**15;
    ...
    constructor(string memory baseURI) ERC721("Air Teddy", "AIRTDY") {
		setBaseURI(baseURI);
        pause(true);
    }
