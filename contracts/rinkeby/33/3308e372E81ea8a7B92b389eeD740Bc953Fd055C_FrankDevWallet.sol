...
contract FrankDevWallet is AccessControlEnumerable {
    ...
    /// @param founder1 founder 1     
    /// @param founder2 founder 2

    constructor (address founder1, address founder2) {
        _deployerAddress = msg.sender;
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);

        // Initial cap table
        createInitialFounder(founder1, 5000);
        createInitialFounder(founder2, 5000);
