...
contract TheDerivative is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    //constructor() ERC721("TheTest", "SMOOTH") {
    constructor() ERC721("TheDerivative", "ROUGH") {
    ...
    */
    function setTheDerivativeTokenId() public onlyOwner {
        ...
        uint random = uint(keccak256(abi.encodePacked(block.timestamp, msg.sender))) % MAX_SUPPLY;
