...
contract JetPack is ERC721URIStorage, AccessControl, ERC721Enumerable, Ownable {
    ...
    address public constant JETPACK_ADMIN_WALLET = 0x85F2D9C49Da205C089Bb96fD6171064c5f1c02C6;
    constructor() ERC721("Jadu Jetpack", "JETPACK") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(MINTER_ROLE, msg.sender);
        setBaseURI("https://jadu.ar");
        MAXIMUM_TOTAL_SUPPLY = 1111;
        PRE_SALE_TIME_START = block.timestamp;
        PRE_SALE_TIME_END = PRE_SALE_TIME_START + (1 * 60 * 60); // 1 hour for testing
