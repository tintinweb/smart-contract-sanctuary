  ...
  */
  function isApprovedForAll(address _owner, address _operator) public view override returns (bool isOperator) {
    ...
    function mint(uint256 num) public payable {
        ...
        require( num < 21,                              "You can adopt a maximum of 20 Gotchis at once" );
        require( supply + num < 9501,      "Exceeds maximum Gotchis supply" );
    ...
    function finalGiveaway() public {
        ...
        for(uint256 i; i < tokenCount; i++){
            ...
            require(ownedToken < 9500, "Only one final giveaway Gotchi per person!");
        }
