...
contract TestFactory is EIP712, Ownable{
    ...
    function verifyTypedSig(
        ...
        bytes32 digest =
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256("Bonus(address implementation,string name,string symbol)"),
                        implementation,
