    ...
    ReentrancyGuard
{
    ...
    using TestOrders for TestOrders.Nft;
    ...
    event TestEmit2(TestOrders.Nft nft);

    event TestEmit3(TestOrders.Nft[] nfts);
    ...
    function testEmit2(TestOrders.Nft[] memory _nfts) external {
        emit TestEmit2(_nfts[0]);
    }

    function testEmit3(TestOrders.Nft[] memory _nfts) external {
        emit TestEmit3(_nfts);
    }

    function createListing(
        string calldata _label,
        TestOrders.Nft[] memory _nfts,
