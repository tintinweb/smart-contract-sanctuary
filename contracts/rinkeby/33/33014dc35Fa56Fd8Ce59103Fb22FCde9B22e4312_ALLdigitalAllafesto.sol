...
contract ALLdigitalAllafesto is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("ALLdigital Allafesto", "ATAR")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 112;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 112 at a time");
  ...
  {
    return (address(this), (salePrice * 9900) / 10000);
  }
