...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function startLottery() public onlyOwner{
        require(lottery_state == LOTTERY_STATE.CLOSED, "Lottery cannot be started");
        lottery_state = LOTTERY_STATE.OPEN;
    }

    function endLottery() public onlyOwner{
        // Issue is hashing func(keccak256) itself is not random.
        // nonce is predictable(aka, trans no)
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        require(lottery_state == LOTTERY_STATE.CALCULATING_WINNER, "Winner selection state have not reached");
