...
contract TheNeed is ERC721, Ownable {
    ...
    address public constant ADDRESS_1 = 0xB61bec1C7dA88d905b8b749f1222ce5d889b98B8; // Austin 5
    address public constant ADDRESS_2 = 0x22AE23Bf8A61301e9Fc36A23a759D681BA315470; // Community 15
    address public constant ADDRESS_3 = 0xA9441365eaF746560c6C7525b8E0CF2d238E37bf; // Lee 15
    address public constant ADDRESS_4 = 0x03313d6CD88874a9c4344b6da1F8f77A652a463B; // Jason 7.5
    address public constant ADDRESS_5 = 0xC5aa93fF62C372E1097B8c04A313a7d9C16dd301; // Art 40
    address public constant ADDRESS_6 = 0xDeDfA9DE0BBCA5234a4fc4500f7070048188533d; // Dev 17.5
 ...
 constructor() ERC721("Adam", "Adamz") { 
    ...
    function mint(uint256 numberOfMints) public payable {
       ...
       // require(saleActive, "Sale must be active to mint");
        require(numberOfMints <= 1000, "Invalid purchase amount");
    ...
    function withdrawAll() external onlyOwner {
        ...
        payable(ADDRESS_5).transfer(balance * 175 / 1000);
