...
contract testmerkle is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("test merkle", "tm") {
...
function mintWhitelist(uint256 _mintAmount,
    ...
    require( balanceOf(msg.sender)+_mintAmount > presalemaxMintAmount, "Buyer has already minted max pre-sale creatures");
    }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require(msg.value >= cost * _mintAmount, "Insufficient funds!");
        ...
        if ( balanceOf(msg.sender)+_mintAmount > maxMintAmount)
            revert("Buyer has already minted max creatures");
    } 
  ...
  function seturiPrefix(string memory _newuriPrefix) public onlyOwner {
    ...
    function sethiddenMetadataUri(string memory _newhiddenMetadataUri) public onlyOwner {
