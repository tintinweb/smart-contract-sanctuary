...
// File: @openzeppelin/contracts-upgradeable/token/ERC721/presets/ERC721PresetMinterPauserAutoIdUpgradeable.sol
...
contract Metalegends is  ERC721PresetMinterPauserAutoIdUpgradeable  {
    ...
    function initialize() initializer public {
        __ERC721PresetMinterPauserAutoId_init("Meta Legends", "METALEGENDS", "https://localhost");
    ...
    function sendBal(address payable receiver, uint amount) payable external  returns(bool success) {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "METALEGENDS must have admin role to withdraw");
        emit LogWithdrawal(msg.sender, amount);
        receiver.transfer(amount);
        return true;
    }

      function multipleMInt(address to, string[] memory hashes) public {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC721PresetMinterPauserAutoId: must have minter role to mint");
