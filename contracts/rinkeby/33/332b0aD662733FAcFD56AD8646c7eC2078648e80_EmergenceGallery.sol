    ...
    IERC721Enumerable
{
    ...
    modifier onlyArtist(uint256 _collectionId) {
        require(
            _collections[_collectionId].artist == _msgSender(),
            "EmergenceGallery: only artist can call this function"
        );
        _;
    }
    ...
    function purchaseTo(address _to, uint256 _collectionId) public payable {
        ...
        .value
        .mul(_collections[_collectionId].artistPercentage)
        .div(100);

        _collections[_collectionId].artist.transfer(artistReward);
    ...
    function updateArtistAddress(uint256 _collectionId, address payable _artist)
        public
        onlyArtist(_collectionId)
    {
        _collections[_collectionId].artist = _artist;
    }
        ...
        )
    {
        ...
        return (
            ...
            _collections[_collectionId].artist,
            _collections[_collectionId].artistPercentage
        );
    }
