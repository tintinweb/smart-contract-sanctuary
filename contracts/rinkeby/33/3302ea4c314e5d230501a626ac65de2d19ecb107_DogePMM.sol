...
contract Ownable is Context {
    address private _owner = 0x5a5821CCFB25E8146d5E9ea4143EAF1bb2E8cc03;
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 4 hours");
...
contract DogePMM is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xe9354e4F4c9616A8C94De612DDbC7e7290a262CD); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Doge PMM"; // token name
    string private _symbol = "DogePMM"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 4 hours; // duration betweeen each buyback
    ...
    uint256 public _minTokensSwapToAndTransferTo = 1000000000000 * 10**9; // min token liquidity fee collected before swapandLiquify
