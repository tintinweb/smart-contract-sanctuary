...
contract ApeToken is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    string public BCT_PROVENANCE = "2b999cc660cc93fb08e2efcef4f0de598164cc2e6bfce71fddadaf38a3621ecd";
    ...
    function mintApes(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of apes");
