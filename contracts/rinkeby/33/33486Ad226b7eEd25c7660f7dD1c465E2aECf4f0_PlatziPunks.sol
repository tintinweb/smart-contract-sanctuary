...
contract PlatziPunks is ERC721, ERC721Enumerable, Ownable {
    ...
    // Get attributes
    function _getDNASection(uint256 _tokenId, uint8 _rightDiscard)
        internal
        view
        returns (uint8)
    {
        ...
        return
            uint8(
                (_tokenDNA[_tokenId] %
                    (1 * 10**(_rightDiscard + sectionSize))) /
                    (1 * 10**_rightDiscard)
            );
    }

    function getAccessoriesType(uint256 tokenId)
        public
        view
    ...
    function getClotheColor(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getClotheType(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getEyeBrowType(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getFacialHairColor(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getFacialHairType(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getGraphicType(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function _paramsURI(uint256 tokenId) internal view returns (string memory) {
        ...
        // Params are intentionally scoped to avoid Too Deep Stack error
        {
            params = string(
                abi.encodePacked(
                    "accessoriesType=",
                    getAccessoriesType(tokenId),
                    "&clotheColor=",
                    getClotheColor(tokenId),
                    "&clotheType=",
                    getClotheType(tokenId),
                    "&eyeType=",
                    getEyeType(tokenId),
                    "&eyebrowType=",
                    getEyeBrowType(tokenId),
                    "&facialHairColor=",
                    getFacialHairColor(tokenId),
                    "&facialHairType=",
                    getFacialHairType(tokenId),
                    "&hairColor=",
                    getHairColor(tokenId),
                    "&hatColor=",
                    getHatColor(tokenId),
                    "&graphicType=",
                    getGraphicType(tokenId),
                    "&mouthType=",
                    getMouthType(tokenId),
                    "&skinColor=",
        ...
        return
            string(abi.encodePacked(params, "&topType=", getTopType(tokenId)));
    }
        ...
        returns (string memory)
    {
        ...
        string memory imageData = string(
            abi.encodePacked(baseURI, "?", paramsURI)
        );
