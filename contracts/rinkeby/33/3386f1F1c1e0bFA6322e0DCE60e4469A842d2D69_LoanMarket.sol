    ...
    */
    ...
    function getTokenPriceInBorrowed(
        ...
        if (pair.token0() == _stable) {
            ...
            return (_altAmount.mul(resD.div(res1))).div(token0Decimals); // return amount of alt needed to buy 1 stable
        } else {
            uint256 resD = res1 * (10**token1Decimals);
            return (_altAmount.mul(resD.div(res0))).div(token1Decimals); // return amount of alt needed to buy 1 stable
        }
    }
