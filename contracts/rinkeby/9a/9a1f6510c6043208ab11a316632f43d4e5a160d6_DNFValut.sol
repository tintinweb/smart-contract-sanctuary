...
contract DNFValut is Ownable{
    ...
    constructor (address _tokenAddress, uint256 _dayValue,uint256 _rewardRate, uint256 _totalReward,uint256 _totalValueLocked ) {
    ...
    function stake(uint256 amount) public {
        ...
        require(totalValueLocked >= _totalSupply + amount,"Max totalValueLocked");
