...
contract DEFICANDY_TEST_TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "DEFICANDY Test Token";
    string private _symbol = "DEFICANDYTEST";
