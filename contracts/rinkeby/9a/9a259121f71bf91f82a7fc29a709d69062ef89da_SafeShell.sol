...
contract SafeShell is ERC20Permit, ERC20Burnable, Ownable {
    constructor(address _owner) public ERC20("SafeShell Token", "SSH") EIP712("SafeShell Token", "1") {
        _mint(_owner, 1e9 ether);
