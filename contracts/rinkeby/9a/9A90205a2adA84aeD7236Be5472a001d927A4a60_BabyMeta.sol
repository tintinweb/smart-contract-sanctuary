...
contract BabyMeta is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    uint[] private _babyShares = [2450, 2450, 2450, 2450, 2000];
    ...
    function bornOnWhitelist(uint256 amount, bytes32[] calldata proof) public payable {
        ...
        require(totalSupply() + amount <= MAX_BABYMETA, "SOLD OUT");
    ...
    function bornOwner() public onlyOwner {
        uint8 OWNER_MINT = 20;
        require(totalSupply() + OWNER_MINT <= MAX_BABYMETA, "SOLD OUT");
