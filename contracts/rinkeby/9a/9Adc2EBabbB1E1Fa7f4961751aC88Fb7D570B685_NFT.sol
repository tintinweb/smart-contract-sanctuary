...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 constant maxSupply = 8888;
  address public a1;
  address public a2;
  address public a3;
...
constructor (
  ...
  // Exclusive presale minting
    ...
    function mintKuma(uint256 _amount) public payable {
        uint256 supply = totalSupply();
  ...
  //Reveal Kumas
  function revealKuma() public onlyOwner() {
      revealed = true;
  }
  ...
  //View UnrevealedURI of specific Token and alter (WARNING: DO NOT CHANGE!)
    function setNotRevealedURI(string memory _notRevealedURI) public onlyOwner {
    notRevealedUri = _notRevealedURI;
  }
  
  //View BaseURI of KumaWorld and alter (WARNING: DO NOT CHANGE!)
  function setBaseURI(string memory _newBaseURI) public onlyOwner {
    baseURI = _newBaseURI;
  }
  
  //View Specific baseExtension and alter (WARNING: DO NOT CHANGE!)
