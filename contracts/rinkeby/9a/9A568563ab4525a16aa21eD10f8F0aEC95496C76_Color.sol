...
contract Color is ERC721Tradable {
  ...
  constructor(address _proxyRegistryAddress) ERC721Tradable("Color", "HEX", _proxyRegistryAddress) public {}
  ...
  function calculatePrice() public view returns (uint256) {
      ...
      } else if (currentSupply >= 9600) {
          return 640000000000000000;         // 9600-9899:  0.64 ETH
      } else if (currentSupply >= 8000) {
          return 320000000000000000;         // 8000-9599:  0.32 ETH
      } else if (currentSupply >= 4000) {
          return 160000000000000000;         // 4000-7999:  0.16 ETH
      } else if (currentSupply >= 2000) {
          return 80000000000000000;          // 2000-3999:  0.08 ETH 
      } else if (currentSupply >= 1000) {
          return 40000000000000000;          // 1000-1999:   0.04 ETH 
      } else if (currentSupply >= 100) {
          return 20000000000000000;          // 100 - 999     0.02 ETH
      } else {
          return 10000000000000000;          // 1 - 99     0.01 ETH
      }
  }
  ...
  function mintColor(uint256[] memory colorTokens) public payable {
      ...
      require(msg.value >= calculatePrice().mul(numColors), "Ether sent is below minting price");
  ...
  function reserveGiveaway(uint256[] memory colorTokens) public onlyOwner {
      uint256 numColors = colorTokens.length;
  ...
  function baseTokenURI() override public pure returns (string memory) {
      return "https://pantone-services-sachin3.vercel.app/api/color/";
  }

  function contractURI() public view returns (string memory) {
      return "https://pantone-services-sachin3.vercel.app/api/niftypantone";
  }
}
