...
contract NFTMarketplaceMain is IERC721Receiver, Ownable, ILayerZeroReceiver {
    ...
    function buy(uint _tokenId, bool _mintOnMain) public payable {
        ...
        // calculate relayer fees (in this case, we are paying for the fees)
        // uint _relayerFee = endpoint.estimateNativeFees(
        //     _childChainId, address(0x0), _payloadBytes, false, bytes("")
        // );
        // require(_relayerFee > address(this).balance, "Not enough gas in contract for relayer");
