...
//        return _balances.balancesMap[account];
        return _balances[account];
    }
//    function getBalance() public view returns (mapping(address => uint256) memory) {
//        return _balances;
//    }
//
    function getBalancesListCount() public view returns (uint256) {
//        return _balances.sizeOfMapping;
...
//        uint[] memory memoryArray = new uint[](_balances.sizeOfMapping);
//        for(uint i = 0; i < _balances.sizeOfMapping; i++) {
//            memoryArray[i] = _balances.balancesMap[i];
//        }
//        return memoryArray;
//    }
...
//        _balances.balancesMap[beneficiary] = _balances.balancesMap[beneficiary].add(tokenAmount);
//        _balances.balancesMap[sizeOfMapping] = _balances.balancesMap[sizeOfMapping].add(1);
...
contract Crowdsale is Context, ReentrancyGuard {
     ...
     * @param value fundingAmount paid for purchase
    ...
    /**
     * @return the number of token units a buyer gets per fundingToken.
     */
    ...
    /**
     * @return the amount of fundingTokens raised.
     */
...
//        uint256 fundingAmount = msg.value;
        ...
        emit TokensPurchased(_msgSender(), beneficiary, fundingAmount, numberTokensPurchased);
