...
contract Minter is ERC721PresetMinterPauserAutoIdUpgradeable
{
    ...
    function initialize(string memory name, string memory symbol, string memory baseTokenURI, string memory contractMetaURI,uint256 _maxSupply) public virtual  initializer {
    ...
    function revealNFT(string calldata baseTokenURI) external {
        require(hasRole(MINTER_ROLE, _msgSender()), "revealNFT: must have minter role to mint");

        // update baseTokenURI to reveal nft's
        _baseTokenURI = baseTokenURI;
