...
/**
 * @notice Dark Matter token contract is minted
 *         as a reward by staking Moon Boyz NFTs
 *         and is burned when merging Moon Boyz
 ...
 */
contract DarkMatterToken is ERC20, ERC20Permit, IMintableERC20, IBurnableERC20, AccessControl {
  /**
   ...
   */
  constructor() ERC20("Dark Matter", "DARK") ERC20Permit("Dark Matter") {
