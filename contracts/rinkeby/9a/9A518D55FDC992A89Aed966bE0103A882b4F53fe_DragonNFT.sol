...
contract DragonNFT is ERC721Enumerable, Ownable {
  ...
  uint256[5] private PRICES =  [0.01 ether, 50 ether, 70 ether, 90 ether, 110 ether];
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
      if (supply < 500) {
        require(_mintAmount == 1, "Only buy a NFT in airdrop");
        require(airdrop[msg.sender] == 0, "Only have a NFT in airdrop");
