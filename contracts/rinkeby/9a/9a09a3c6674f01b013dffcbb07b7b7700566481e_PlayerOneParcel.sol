...
contract PlayerOneParcel is ERC721Token, Ownable {
  struct BoundingBox {
    int16 x1;
    int16 y1;
    int16 z1;
  ...
  constructor () public
    ERC721Token('PlayerOne Parcel', 'POP')
  { 
    creator = msg.sender;
  }
...
//   }
  ...
  function batchMint(address _to, uint256[] _tokenIds, string[] _uris) public onlyOwner {
      uint256 len = _tokenIds.length;
      require(len == _uris.length);
