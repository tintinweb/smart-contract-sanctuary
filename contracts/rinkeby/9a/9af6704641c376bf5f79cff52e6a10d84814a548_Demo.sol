...
contract Demo is ERC721Mintable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("DEMO", "DEMO", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://for-opensea-sg.s3-ap-northeast-1.amazonaws.com/metadata/token/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://for-opensea-sg.s3-ap-northeast-1.amazonaws.com/metadata/contract/metadata1.json";
    }
}