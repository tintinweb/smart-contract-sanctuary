...
import "./Collection/ERC721.sol";
import "./Collection/ERC2981.sol";
import "./Collection/extensions/ERC721Enumerable.sol";
import "./Collection/extensions/ERC721URIStorage.sol";
import "./Collection/extensions/ERC721Burnable.sol";
import "./Collection/access/Ownable.sol";
import "./Collection/utils/Counters.sol";

/**
 * @title (Collection Name) contract
 *
 * @dev Extends ERC721 non-fungible token standard
 */
contract Collection is ERC721, ERC2981, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    /**
     * @dev Mints an NFT to `account` with metadata `URI`
     */
    function mint(address account, string memory URI) public onlyOwner {
        ...
        emit Mint(account, _tokenIdCounter.current());
    }
