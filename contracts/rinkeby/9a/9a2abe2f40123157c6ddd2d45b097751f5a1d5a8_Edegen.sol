...
// File contracts/Unflatedegen.sol

contract Edegen is VRFConsumerBase, AccessControlEnumerable, ERC721Enumerable {
...
//      setBaseURI("https://degen.deafbeef.com/tokens/");
      ...
      mint_pass_limit[0] = 8;
      mint_pass_limit[1] = 10;
      mint_pass_limit[2] = 12;
      mint_pass_limit[3] = 14;
      mint_pass_limit[4] = 12;
      mint_pass_limit[5] = 10;
      mint_pass_limit[6] = 8;
      mint_pass_limit[7] = 6;
      mint_pass_limit[8] = 4;
      mint_pass_limit[9] = 2;                  
    ...
    function roll(uint256 tid) public payable requireOwner(tid) returns (bytes32 r)  {
      require(tid < num_machines,"Token ID out of range");
      require(tokens[tid].level < paused_level,"Rolling paused");
	...
	//JACKPOT
	tokens[tid].s1 = tokens[tid].level+2; //TODO
