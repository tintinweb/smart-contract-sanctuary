...
contract wMEMO is ERC20 {
    ...
    function wrap(uint256 _amount) external returns (uint256) {
        ...
        uint256 value = MEMOTowMEMO(_amount);
    ...
    function unwrap(uint256 _amount) external returns (uint256) {
        ...
        uint256 value = wMEMOToMEMO(_amount);
    ...
    /**
        ...
        @return uint
     */
    function wMEMOToMEMO(uint256 _amount) public view returns (uint256) {
    ...
    /**
        ...
        @return uint
     */
    function MEMOTowMEMO(uint256 _amount) public view returns (uint256) {
