...
contract DNAContract is ERC721Enumerable, Ownable {
    ...
    */
    ...
    function GenerateLadder(uint256 tokenId) public view returns (string memory) {
        ...
        string[3*ladderNum] memory ladder_pos_y = ["150", "400", "650", "90", "330", "710", "210", "470", "590"];
        string[4] memory LadderColor = [
            DNAColors_ATCG[2*neucleotideIdxArray[0]], //green for A
            DNAColors_ATCG[2*neucleotideIdxArray[0]+1], //red for T
            DNAColors_ATCG[2*neucleotideIdxArray[1]], //blue for C
            DNAColors_ATCG[2*neucleotideIdxArray[1]+1]  //yellow for G
        ];
