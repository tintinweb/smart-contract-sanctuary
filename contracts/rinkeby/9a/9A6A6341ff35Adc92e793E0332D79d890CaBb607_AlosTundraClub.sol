...
contract AlosTundraClub is ERC721, Ownable, PaymentSplitter {
    ...
    address[] private payeeAddresses = [
        0x886c0Ea23312E814108e44caAeB2424bbff3c01E, // Team 1
        0x3388B1edDC683857Df7B048B5E85Ed4872731445, // Team 2
        0xA75Dec79F464212d27f9b0714AEADaFBA0E02cf4, // Team 3
        0x869E8f62E59f33919d27BcA582d6375215E365FE, // Team 4
        0x7cfe810CDae2F10Da2f51294B5B2C21715428966, // Community Wallet
        0xC3c98CF752190A3244c4Dd204f472E5ABeA11904 // Charity
    ];

    uint256[] private payeeShares = [40, 39, 5, 1, 10, 5];

    constructor(string memory _newURI, address _proxyRegistryAddress)
        ERC721("Alos Tundra Club", "ATC")
    ...
    function preSaleMint(
        ...
        require(
            mintCountByAddress[msg.sender] + _numberOfTokens <= 2,
