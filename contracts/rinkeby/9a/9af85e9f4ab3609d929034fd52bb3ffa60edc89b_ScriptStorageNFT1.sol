...
contract ScriptStorageNFT1 is ERC721, Pausable, AccessControl, ERC721Burnable {
    ...
    constructor() ERC721("NFT Storage 2", "NF2") {
...
//    }
    ...
    function formatScript (uint256 tokenId) internal view returns (string memory){
        ...
        return formatTokenURI(scriptBase64Encoded);
        //return uriScript;
    }

    

    function formatTokenURI(string memory uriScript) internal pure returns (string memory) {
        return string(abi.encodePacked("data:application/json;base64,",Base64.encode(bytes(abi.encodePacked('{"name":"TurkeyTits", "description":"mikehauncho", "image":"',uriScript,'"}')))));
    }
