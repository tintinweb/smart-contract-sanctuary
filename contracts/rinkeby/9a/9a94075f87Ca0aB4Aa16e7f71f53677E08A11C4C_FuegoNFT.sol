...
contract FuegoNFT is ERC721Enumerable, Ownable {
    ...
    address public constant teamAddress = 0x053A743Fa810aF2f015fdC1aB9AA86f38379Cd2E;
    address public constant artistAddress = 0xefE276ee824141326AF16EA13713131a8F9E2c58;
    address public constant influencerAddress = 0x68518165EB4f9ACa00D4A4bcf2DB0aD158Ba632D;
    address public constant devAddress = 0xF43A020356D7463042150D4A67356761B71bd470;
    ...
    constructor(string memory baseURI) ERC721("FuegoNFTs", "NFT") {
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(influencerAddress, ((balance * 10) / 100));
        _widthdraw(teamAddress, ((balance * 20) / 100));
