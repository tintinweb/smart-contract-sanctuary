...
contract FlyNFT is ERC1155Burnable, OwnableAndWhitelistble {

    string public name = 'FlyNFT';
    string public symbol = 'FLY-NFT';
    uint public decimals = 0;

    uint public constant JUNIOR = 1;
    uint public constant LIEUTENANT = 2;
    uint public constant CAPTAIN = 3;
    uint public constant ADMIRAL = 4;
    uint public constant GRAND_ADMIRAL = 5;

    constructor() 
    ERC1155('test/{id}.json') {
        owner = msg.sender;
        
        _mint(msg.sender, JUNIOR, 800, "");
        _mint(msg.sender, LIEUTENANT, 500, "");
        _mint(msg.sender, CAPTAIN, 100, "");
        _mint(msg.sender, ADMIRAL, 15, "");
        _mint(msg.sender, GRAND_ADMIRAL, 1, "");
    }
}
