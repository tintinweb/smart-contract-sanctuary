...
// Part: OpenZeppelin/openzeppelin-con[email protected]/Context
...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function endLottery() public onlyOwner {
        // hashing algoritam - keccack256
        // problem je sto funkcija hasiranja nije rendom, uvek je ista i uvek hash-uje na isti nacin
        // uint256(
        //     keccack256(
        //         abi.encodePacked(
        //             nonce, // moze se pretpostaviti - broj transakcije
        //             msg.sender, // moze se pretpostaviti
        //             block.difficulty, // mineri ih mogu menjati
        //             block.timestamp // moze se pretpostaviti
        //         )
        //     )
        // ) % players.length;
        ...
        override
    {
        ...
        require(_randomness > 0, "Nije izracunat pobednik");
