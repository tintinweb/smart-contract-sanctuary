...
contract AnonymiceV2 is ERC721Enumerable {
    ...
    uint256 COST_MULTIPLIER = 3;
    uint256 INITIAL_CHEETH_COST = 10 * (10**18);
    ...
    constructor() ERC721("Anonymice", "MICE") {
        ...
        //Hat
        TIERS[0] = [1, 3, 4, 4, 4, 4, 5, 5, 5, 65];
        //whiskers
        TIERS[1] = [1, 9, 10, 20, 60];
        //Neck
        TIERS[2] = [1, 8, 11, 11, 70];
        //Earrings
        TIERS[3] = [1, 3, 6, 10, 80];
        //Eyes
        TIERS[4] = [1, 3, 4, 6, 10, 11, 12, 12, 20, 21];
        //Mouth
        TIERS[5] = [20, 20, 20, 20, 20];
        //Nose
        TIERS[6] = [20, 20, 20, 20, 20];
        //BaseMouse
        TIERS[7] = [1, 3, 4, 5, 5, 7, 10, 15, 20, 30];
    }
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
    ...
    function rarityGen(uint256 _randinput, uint8 rarityTier)
        internal
        view
        returns (string memory)
    {
        uint8 currentLowerBound = 0;
        for (uint8 i = 0; i < TIERS[rarityTier].length; i++) {
            uint8 thisPercentage = TIERS[rarityTier][i];
            if (
    ...
    function hash(
        ...
        //The first 8 digits are random, the ninth is 0, due to the mouse not being burned.
        ...
        //Add the not burned trait;
        currentHash = string(abi.encodePacked(currentHash, "0"));

        if (hashToMinted[currentHash] == true) return hash(_t, _a, _c + 1);
    ...
    function burnForMint(uint256 _tokenId) public {
        ...
        string memory newTokenHash = string(abi.encodePacked(AnonymiceLibrary.substring(tokenIdToHash[_tokenId], 0, 8), "1"));

        tokenIdToHash[_tokenId] = newTokenHash;
        ...
        returns (string memory)
    {
        ...
        for (uint8 i = 0; i < 9; i++) {
            uint8 thisTraitIndex = AnonymiceLibrary.parseInt(
                AnonymiceLibrary.substring(tokenIdToHash[_tokenId], i, i + 1)
            );
        ...
        svgString = string(
            abi.encodePacked(
                ...
                svgString,
                "<style>rect{width:1px;height:1px;} #mouse-svg{shape-rendering: crispedges;}.c00{fill:#000000}.c01{fill:#B1ADAC}.c02{fill:#D7D7D7}.c03{fill:#FFA6A6}.c04{fill:#FFD4D5}.c05{fill:#B9AD95}.c06{fill:#E2D6BE}.c07{fill:#7F625A}.c08{fill:#A58F82}.c09{fill:#4B1E0B}.c10{fill:#6D2C10}.c11{fill:#D8D8D8}.c12{fill:#F5F5F5}.c13{fill:#2F6295}.c14{fill:#5F97B6}.c15{fill:#05FF00}.c16{fill:#01C700}.c17{fill:#0B8F08}.c18{fill:#421C13}.c19{fill:#6B392A}.c20{fill:#A35E40}.c21{fill:#DCBD91}.c22{fill:#777777}.c23{fill:#848484}.c24{fill:#ABABAB}.c25{fill:#BABABA}.c26{fill:#C7C7C7}.c27{fill:#EAEAEA}.c28{fill:#0C76AA}.c29{fill:#0E97DB}.c30{fill:#10A4EC}.c31{fill:#13B0FF}.c32{fill:#2EB9FE}.c33{fill:#54CCFF}.c34{fill:#50C0F2}.c35{fill:#54CCFF}.c36{fill:#72DAFF}.c37{fill:#B6EAFF}.c38{fill:#FFFFFF}.c39{fill:#954546}.c40{fill:#0B87F7}.c41{fill:#FF2626}.c42{fill:#180F02}.c43{fill:#2B2319}.c44{fill:#FBDD4B}.c45{fill:#F5B923}.c46{fill:#CC8A18}.c47{fill:#3C2203}.c48{fill:#53320B}.c49{fill:#7B501D}.c50{fill:#FFE646}.c51{fill:#FFD627}.c52{fill:#F5B700}.c53{fill:#242424}.c54{fill:#4A4A4A}.c55{fill:#676767}.c56{fill:#F08306}.c57{fill:#FCA30E}.c58{fill:#FEBC0E}.c59{fill:#FBEC1C}.c60{fill:#14242F}</style></svg>"
            )
        );
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    ...
                                    '", "description": "Anonymice Desc.", "image": "data:image/svg+xml;base64,',
                                    AnonymiceLibrary.encode(bytes(svgString)),
                                    '","attributes":',
                                    string(
                                        abi.encodePacked(
                                            "[",
