...
contract NightRoseNFT is ERC721{
    ...
    string [] private q = ["N", "C", "C", "C", "C", "SR", "C", "C", "C", "C", "N", "N", "C", "C", "C", "C", "C", "R", "C", "C", "C", "N", "R", "N", "R", "N", "C", "C", "C", "R", "N", "C", "C", "C", "R", "C", "C", "N", "C", "C", "C", "N", "N", "C", "C", "R"];

    Card[] public cards; // First Item has Index 0
    address public owner;
    mapping (uint256 => string) private _tokenURIs;
    uint64 public maxSupply = 4;
    ...
    function _get_level(uint256 x) internal view returns (string memory){
        return q[x];
    }
