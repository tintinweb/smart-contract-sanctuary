...
contract FishingDock {
  ...
  function create(uint256 _realmId) external {
    ...
    uint256 _resourceId = 1; //_rarity(_realmId, resourceProbability);

    // TODO: Maybe use _owner as salt
    docks[_realmId][_id].id = _id;
    docks[_realmId][_id].realmId = _realmId;
    docks[_realmId][_id].food = 1; //_rarity(_realmId, dataProbability);
    docks[_realmId][_id].workforce = 1; //_rarity(
