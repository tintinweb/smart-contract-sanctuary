...
contract FactoryMaster  {
    ...
    event ChildCreatedERC20Mintable(address childAddress,uint256 cap_, string name, string symbol);
    ...
    function createChild(Types types,uint256 cap_, string memory name,string memory symbol) external payable {
