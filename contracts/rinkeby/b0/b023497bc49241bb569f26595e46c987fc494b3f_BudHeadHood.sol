 ...
 * {ERC721Enumerable}.
 *
 * Also includes implementation of https://eips.ethereum.org/EIPS/eip-2309[ERC2309], A standardized event emitted 
 *  when creating/transferring one, or many non-fungible tokens using consecutive token identifiers.
 *
 * THIS HAS YET TO BE THOROUGHLY TESTED.  USE AT YOUR OWN RISK. 
 *
 * Limitations:
 *  -Contract owner must always be the minter
...
contract ERC2309 is Context, ERC165, IERC721, IERC721Metadata, IERC2309, Ownable {
    ...
    /**
     * @dev Reimplements ownerOf to default the owner to the contract creator.
     */
    function ownerOf(uint256 tokenId) public view virtual override returns (address) {
        require(tokenId < _tokenCount, "haven't been minted"); 
     ...
     *
     * Tokens start existing when they are minted (`_mintConsecutive`),
     */
...
// File: contracts/BudHeadHood.sol
...
contract BudHeadHood is ERC2309 {
    ...
    constructor(uint _tokenCount, string memory _uri) ERC2309("BudHeadHoodGT", "BHHGT") {
        admin = msg.sender;
        uri = _uri;
