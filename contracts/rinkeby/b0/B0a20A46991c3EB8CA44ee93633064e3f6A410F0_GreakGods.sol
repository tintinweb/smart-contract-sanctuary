...
contract GreakGods is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    ...
    uint256 public pricePer = 80000000000000000; // 0.08 ETH
    uint256 public constant minPricePer = 10000000000000000; // 0.01 ETH
    ...
    constructor() ERC721("Greak Gods (dev)", "GreekGods") {
        pauseSale();
        
        fundsTo = payable(msg.sender);
    }
    ...
    function setPricePer(uint256 newPricePer) public onlyOwner {
        require(newPricePer >= minPricePer, "Price is too low, make sure it's in wei and it's higher than 0.01 ETH in equivalent");
        pricePer = newPricePer;
    }
    
    function setMaxPerTx(uint256 newMaxPerTx) public onlyOwner {
    ...
    function safeMint(uint256 quantity) payable public whenNotPaused {
        // Cannot mint 0
