...
contract NervousNFTFactory {
    ...
    ) external returns (NervousNFT newNFTContractAddress) {

        NervousNFT newNFTContract = new NervousNFT(name, symbol, baseUrl, payees, shares);

        tokenAddress.push(address(newNFTContract));
