...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    /* @dev lets whoever transfer from the owner whenever.
    *  Not tested and I have no idea what the ramifications may be.
    *  Let the chaos begin.
    */
    function _unsafeTransfer(address to) internal virtual {
...
contract TheBag is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("The Bag", "THEBAG")  {
