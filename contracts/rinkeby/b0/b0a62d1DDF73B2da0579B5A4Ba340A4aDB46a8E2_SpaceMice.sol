...
contract SpaceMice is ERC721URIStorage, Ownable{
    ...
    function mintMiceWithDeez(uint256 amount) public {
        ...
        if (TOTALMICE <= 200) {
            require(amount == 10000000000000000000000, "Must pay 10,000 $DEEZ");
        } 
        else if (TOTALMICE > 200 && TOTALMICE <= 400) {
            require(amount == 20000000000000000000000, "Must pay 20,000 $DEEZ");
        }
        else if (TOTALMICE > 400 && TOTALMICE <= 600) {
            require(amount == 30000000000000000000000, "Must pay 30,000 $DEEZ");
        }
        else if (TOTALMICE > 600 && TOTALMICE <= 800) {
            require(amount == 40000000000000000000000, "Must pay 40,000 $DEEZ");
        }
        else {
            require(amount == 50000000000000000000000, "Must pay 50,000 $DEEZ");
        }
        require(TOTALMICE + 1 <= TOTALCOUNT, "not enough mice!");
        IERC20(DEEZTOKEN).transfer(address(this), amount);
