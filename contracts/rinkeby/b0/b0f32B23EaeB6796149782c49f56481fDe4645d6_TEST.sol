...
contract TEST is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    event MintSuccess(address sender, uint256 tokenId);

    string private _baseTokenURI = "https://example.example.com";
    string private _contractURI =
        "ipfs://bafybeifrgq4uluthzmbyiellomdpu5e2tkm5xxfwqnhjumqve27qaaqnpm/metadata.json";

    uint256 public maxSupply = 9999;
    uint256 public maxPresale = 8000;

    mapping(string => bool) private _usedNonces;
    address private _signerAddress = 0x6c24C6eCDeDcBA9cedE67e38FAD15410214465c0; //Metasaur Signer

    uint256 public pricePerToken = 80000000000000000; //0.07 ETH

    bool public publicSaleLive = false;
    bool public presaleLive = true;

    constructor() ERC721("Test-Junz9", "TJUNZS9") {}
    ...
    function hashTransaction(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(
                ...
                keccak256(abi.encode(sender, qty, nonce))
            )
        );
        return hash;
    }
