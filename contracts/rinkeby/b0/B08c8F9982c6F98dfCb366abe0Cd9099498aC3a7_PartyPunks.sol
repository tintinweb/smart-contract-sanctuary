...
contract PartyPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Party Punks", "PP") {
    setHiddenMetadataUri("ipfs://Qmdc6p86rzW7Lp2vJDunxJFktKCV49tpEGRuyKDZ5ZQFtb/Hidden.json");
  }
