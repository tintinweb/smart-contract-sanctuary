...
contract MiamiHome is ERC721, Ownable //,VRFConsumerBase 
{
  ...
  address r1 = 0x26dd4cfBD75ed17db6dd521A434800a83cb8AcB3; // Property
  address r2 = 0x26dd4cfBD75ed17db6dd521A434800a83cb8AcB3; // TitleDAO
  address r3 = 0x26dd4cfBD75ed17db6dd521A434800a83cb8AcB3; // Charity
  ...
  constructor()
    ...
    keyHash = 0x2ed0feb3e7fd2022120aa84fab1945545a9f2ffc9076fd6156fa96eaff4c1311; // for chainlink oracle
    ...
    //    tokenIdWinner = randomResult % (1251) + 250 ; 
        // we select the address that has the tokenid in that moment and we saved it
        // even if it changes hands later, the winners is the address that was here. 
  ...
  function mint() public payable {
    ...
    //require(totalSupply() <= MAX_SUPPLY, "MiamiHome is sold out!.");
    // Actually mint the NFT to the sender using msg.sender.
    _safeMint(msg.sender, _nextTokenId.current());
    // Increment the counter for when the next NFT is minted.
    _nextTokenId.increment();
       console.log("An NFT w/ ID %s has been minted to %s", _nextTokenId.current(), msg.sender);
  }
    ...
    function withdrawBalance() public onlyOwner {
        ...
        payable(r2).transfer((balance * 25) / 100);  // 25% - TitleDAO
