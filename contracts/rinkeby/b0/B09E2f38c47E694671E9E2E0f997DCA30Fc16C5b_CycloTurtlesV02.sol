...
contract CycloTurtlesV02 is ERC721URIStorage, Ownable { 
        ...
        onlyOwner
    {
        ...
        for (uint i = 0; i < totalSupply; i++) {
            _setTokenURI(i, string(abi.encodePacked(_tokenBaseURI, i)));
        }
    }
        ...
        // whenNotPaused
    {
        ...
        for (uint i = 0; i < _addresses.length; i++) {
            ...
            _setTokenURI(_newTokenId, string(abi.encodePacked(baseURI, _newTokenId)));
    ...
    function vitMint(uint256 _amount) internal {
        require(
            vitSaleConfig.isActive == true,
