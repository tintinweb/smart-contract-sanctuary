...
contract Rengoku is ERC721, Ownable {
  ...
  //   uint16 public constant RESERVED_SUPPLY = 93;
  ...
  function mintWhitelist(
    ...
    require(!isClaimed(index), "You have already minted your alloted amount");
    ...
    require(block.timestamp < preSaleStartDate + 2 days, "Presale has ended");
  ...
  function burnToken(uint256 tokenId) external {
    ...
    require(msg.sender == ERC721.ownerOf(tokenId), "must be owner of token");
    _burn(tokenId);
  }
