...
contract Needelman is ERC721, Ownable {
    ...
    uint public constant MAX_CHUBBIES = 5;
    ...
    constructor(string memory baseURI) ERC721("CoolPaint","CoolPaint")  {
        setBaseURI(baseURI);
    }
   ...
   function adoptPaint(uint256 numChubbies) public payable {
        require(totalSupply() < MAX_CHUBBIES, "Sale has already ended");
        require(numChubbies > 0 && numChubbies <= 2, "You can adopt minimum 1, maximum 20 chubbies");
