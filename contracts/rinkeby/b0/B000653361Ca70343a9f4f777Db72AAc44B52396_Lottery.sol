...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        // remember Sol doesn't work with decimals, hence the big long numbers
        uint256 adjustedPrice = uint256(price) * 10e10; // 18 decimals
        // $50, $2k / Eth
        // 50 / 2000
        // 50 * 1e5
        uint256 costToEnter = (usdEntryFee * 10e18) / adjustedPrice;
        return costToEnter;
    }


    function startLottery() public onlyOwner {
        require(lottery_state == LOTTERY_STATE.CLOSED, "Can't start a new lottery yeet!");
