...
contract ShitCoinToken is IERC20, Context, Ownable {
   using Address for address;
    ...
    uint256 private _tTotal = 1000000 * 10**3 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    string private _name = "ShitCoinToken";
    ...
    uint256 public _maxTxAmount = 10000 * 10**3 * 10**7;
    uint256 private numTokensSellToAddToLiquidity = 2000 * 10**3 * 10**7;
