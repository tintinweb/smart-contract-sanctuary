...
contract undergroundPersianRap is owned {
    ...
    string constant private _name = "UPR";
    string constant private _symbol = "UPR";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply = 11000000 * (10**_decimals);         
    uint256 constant public maxSupply = 11000000 * (10**_decimals);    //
    //uint constant private _preMine =  10000000 * (10**_decimals);       //  
