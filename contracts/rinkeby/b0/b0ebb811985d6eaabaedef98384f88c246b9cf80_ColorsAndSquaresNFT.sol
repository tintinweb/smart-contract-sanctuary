...
contract ColorsAndSquaresNFT is ERC721CappedSale {
    ...
    )
    {
        ...
        _unrevealTime = block.timestamp+INIT__EA_TIME+INIT__UNREVEAL_AFTER;
    }
    ...
    function isUnrevealed() public view returns(bool) {
        return block.timestamp < _unrevealTime;
    }
    ...
    // just dev stuff
    function setEATime(uint256 newEaTime) public onlyOwner {
        _earlyAdopterTime = newEaTime;
    }
    function setUnrevealTime(uint256 newUnrevealTime) public onlyOwner {
        _unrevealTime = newUnrevealTime;
    }
