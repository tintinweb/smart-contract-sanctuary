...
// File: contracts/BoredApeYachtClub2.sol
 ...
 */
contract BoredApeYachtClub2 is ERC721, Ownable {
    using SafeMath for uint256;
    // This is the provenance record of all Apes in existence 
    string private BAYC_PROVENANCE = "";

    uint256 public startingIndexBlock;

    uint256 public startingIndex;

    uint256 public constant apePrice = 100000000000000000; //0.1 ETH

    uint public constant maxApePurchase = 20;

    uint256 private MAX_APES;

    bool public saleIsActive = false;

    // Time after which Apes are unleeeashed
    uint256 private REVEAL_TIMESTAMP;
    ...
    */
     ...
     * Set some Apes aside
     */
    function reserveApes() onlyOwner public {        
    ...
    */
     ...
     */
    function setRevealTimestamp(uint256 revealTimeStamp) onlyOwner public {
    ...
    */
    function flipSaleState() onlyOwner public {
    ...
    */
    ...
    /**
     * @dev Set the starting index block for the collection, essentially opening up
     * possibility of setting starting index
     */
    function emergencySetStartingIndexBlock() onlyOwner public {
        require(startingIndex == 0, "Starting index is already set");
