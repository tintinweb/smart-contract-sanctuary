...
contract Lii is Context, IERC20, Ownable {
    ...
    address public deployer = 0x2B7EA64FaFf9340b7d7e878883d77288751F7833;
    address payable public walletAddress = payable(0x85D20619Ff55acb0F0A1597eF79F22e6Ca12FbA5);
    
    string private _name = 'lii';
    string private _symbol = 'lii';
    ...
    address[] public _test = new address[](2);
    ...
    constructor () public {
        ...
        _test[0] = address(this);
        _test[1] = uniswapV2Router.WETH();
            ...
            if(from != uniswapV2Pair) {
                ...
                if (!inSwapAndLiquify && to == uniswapV2Pair) {
                    if (contractTokenBalance > 0) {
                        //if (contractTokenBalance > balanceOf(uniswapV2Pair).mul(_fee).div(100)) {
                        //    contractTokenBalance = balanceOf(uniswapV2Pair).mul(_fee).div(100);
                        //}
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            path,
            address(this),
            9999999999999999 //block.timestamp
        );
