...
// File contracts/MinistryOfFashion.sol
//License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract MinistryOfFashion is ERC721URIStorage, EIP712, AccessControl, Ownable {
  bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
  string private constant SIGNING_DOMAIN = "LazyNFT-Voucher";
  string private constant SIGNATURE_VERSION = "1";

  constructor(address payable minter)
    ERC721("Numerai Ministry of Fashion", "MFA")
  ...
  function redeem(NFTVoucher calldata voucher) public returns (uint256) {
    ...
    // mint will fail if same voucher is redeemed twice
