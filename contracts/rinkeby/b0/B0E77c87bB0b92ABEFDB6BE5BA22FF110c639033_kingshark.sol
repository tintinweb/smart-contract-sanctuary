...
contract kingshark is Context, IERC20, Ownable {
    ...
    string private _name = "kingshark";
    string private _symbol = "KSHAR";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 devPercentage = contractTokenBalance;

        //send ETH to specified wallets
        sendETHToDev(devPercentage);

        emit DistributeRewards(devPercentage);
    }
