...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public minRate = 0.07 ether;
  bool public paused = false;
  bool public revealed = false;
  bool public onlyWhitelisted = true;
  address[] public whitelistedAddresses;
  mapping(address => uint256) public addressMintedBalance;
  address contractOwner = 0xfcd979407EC518CCc5fa9D82e8463e22693F5f4c;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount > 0, "Min 1 per TX");
    require(_mintAmount <= maxMintAmount, "Max 5 per TX");
    ...
    if (msg.sender != contractOwner) {
        if(onlyWhitelisted == true) {
            ...
            require(ownerMintedCount + _mintAmount <= nftPerAddressLimit, "Max 10 Holding");
        }
        require(msg.value >= minRate * _mintAmount, "Insufficient funds");
    }
  ...
  function changeMinRate(uint256 _newMinRate) public onlyOwner {
    minRate = _newMinRate;
  }
