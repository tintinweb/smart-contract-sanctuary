...
contract Escrow is Migratable {
    ...
    returns (bool) {
        ...
        uint256 isInProfit = escrows[_escrowId].payoutAmount.sub(initialPAPRAmountConverted);
        ...
        uint256 providerPayoutCan = escrows[_escrowId].payoutAmount.sub(payToDappAmount).sub(payToDevAmount);
