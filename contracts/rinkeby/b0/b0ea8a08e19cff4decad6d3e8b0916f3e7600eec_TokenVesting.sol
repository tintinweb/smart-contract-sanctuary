...
contract TokenVesting is Ownable {
     ...
     */
    function setDelegate(bytes32 _id, address _delegate) external onlyBeneficiary {
        IDelegation(_delegateRegistry).setDelegate(_id, _delegate);
     ...
     * @dev Delegates the voting power of tokens held in the contract to a new account (`_delegate`)
     */
    function clearDelegate(bytes32 _id) external onlyBeneficiary {
        IDelegation(_delegateRegistry).clearDelegate(_id);
