...
contract Implementations is Setup {
    ...
    IndexInterface immutable public stakeAllIndex;
    ...
    modifier isMaster() {
        require(msg.sender == stakeAllIndex.master(), "Implementations: not-master");
        _;
    }
...
contract StakeAllImplementations is Implementations {
    constructor(address _stakeAllIndex) public Implementations(_stakeAllIndex) {}
