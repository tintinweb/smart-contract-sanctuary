...
contract WonkyStonk is ERC721, ERC721Enumerable, ERC721URIStorage, IERC2981, Ownable {
    ...
    */
     ...
     * Price does not increase as quantity becomes scarce.
     */
    function getCurrentPriceForQuantity(uint8 _quantityToMint) public view returns (uint64) {
     ...
     */
    function mintQuantity(uint8 _quantityToMint) public payable {
    ...
    /**
     * Mint quantity of NFTs for address initiating minting
     * These 46 promotional mints are used by the contract owner for promotions, contests, rewards, etc.
     */
    function mintPromotionalQuantity(uint8 _quantityToMint) public onlyOwner {
        require(_quantityToMint >= 1, "Minimum number to mint is 1");
        require(
            (_quantityToMint + totalSupply()) <= maxSupply,
            "Exceeds maximum supply"
