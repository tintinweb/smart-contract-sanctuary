...
contract Ooh is Context, IERC20, Ownable {
    ...
    uint8 private _taxFee = 6; // 6% reflection fee for every holder
    ...
    // We will set a minimum amount of tokens to be swapped => 2000000000
    uint256 private _numOfTokensToExchangeForMarketing = 2000000000 * 10**9;
