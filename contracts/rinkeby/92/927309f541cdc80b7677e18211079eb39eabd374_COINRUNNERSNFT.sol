...
contract COINRUNNERSNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public constant COINRUNNERS_PRICE = 0.08 ether;
    ...
    address private _paymentSplitter = 0x68BF3967e779353d3aEE8Ff960D978a2f73CCBED;
    address private _signerAddress = 0x8Cc1764cAbDE44437445aa87055f98F11aFD8942;
    ...
    */
    ...
    function buy(bytes32 hash, bytes memory signature, string memory nonce, uint256 tokenQuantity) external payable {
        ...
        require(totalAmountMinted + tokenQuantity <= COINRUNNERS_MAX, "EXCEED_MAX");
    ...
    function withdraw() external onlyOwner {
        payable(_paymentSplitter).transfer(address(this).balance);
    }
