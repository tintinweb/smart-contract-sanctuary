...
contract StakingRewardsOnPolyWrapper is ReentrancyGuardUpgradeable { 
    ...
    function _stake(address _beneficiary, address _token, uint256 _amount) internal virtual nonReentrant {
...
contract StakingRewardsOnPoly is StakingRewardsOnPolyWrapper, OwnableUpgradeable { 
    ...
    function stake(address _beneficiary, address _token, uint256 _amount) external {
        _stake(_beneficiary, _token, _amount);
    }

    function _stake(address _beneficiary, address _token, uint256 _amount) internal override notPaused {
        super._stake(_beneficiary, _token, _amount);
