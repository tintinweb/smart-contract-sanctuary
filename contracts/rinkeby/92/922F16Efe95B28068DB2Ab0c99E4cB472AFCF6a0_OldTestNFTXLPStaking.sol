...
// File contracts/solidity/OldTestNFTXLPStaking.sol
...
contract OldTestNFTXLPStaking is PausableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;
    ...
    function assignOldImpl() public {
        require(address(rewardDistTokenImpl) == address(0), "Already assigned");
        rewardDistTokenImpl = new RewardDistributionTokenUpgradeable();
        rewardDistTokenImpl.__RewardDistributionToken_init(IERC20Upgradeable(address(0)), "", "");
    }
