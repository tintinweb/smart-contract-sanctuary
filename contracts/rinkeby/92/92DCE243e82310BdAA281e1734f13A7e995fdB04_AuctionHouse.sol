...
import "../exchange/lib/LibTransfer.sol";
import "../exchange/TransferManager.sol";

/// @dev contract to create and interact with auctions 
contract AuctionHouse is AuctionHouseBase, TransferExecutor, TransferManager {
...
import "./lib/LibAucDataV1.sol";
import "./lib/LibBidDataV1.sol";
...
import "../lazy-mint/lib/LibERC721LazyMint.sol";
...
import "../exchange/lib/LibAsset.sol";
