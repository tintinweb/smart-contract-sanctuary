...
contract DeepWatersVault is IDeepWatersVault, Ownable {
    ...
    **/
    ...
    mapping(address => uint256) internal totalBorrowBalances;
    ...
    **/
    function updateBorrowBalance(address _asset, address _user, uint256 _newBorrowBalance) external {
        ...
        totalBorrowBalances[_asset] = totalBorrowBalances[_asset].sub(usersBorrowBalances[_asset][_user]).add(_newBorrowBalance);
