...
contract FusionCoreNFT is FusionCoreERC721 {


    IFCore public FCore;

    constructor(string memory name, string memory symbol, uint256 supply, uint256 genCount) FusionCoreERC721(name, symbol, supply, genCount) {}
...
contract FusionCoreERC721 is ERC721Enumerable, Ownable {
