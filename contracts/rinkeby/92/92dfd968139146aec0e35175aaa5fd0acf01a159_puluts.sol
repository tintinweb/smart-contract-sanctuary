...
contract puluts{
    ...
    IERC20  plt = IERC20(address(0x981ab7460a11cC109A43be8C339e1261c1caeB49));
    ...
    mapping(uint=>mapping(uint=>uint)) public rate_info; 
    mapping(address=>mapping(uint=>uint)) public user_info;
    //1.deposit_usdt 3.借的金額 4.應付金額 5.抵押枚數 6.清算條件 7.推薦獎金
    ...
    function deposit(uint amount ,address recommender)public {
        ...
        uint rt_quota = usdt_amount.mul(rate_info[3][1].add(rate_info[3][2]).add(rate_info[3][3])).div(1000);
