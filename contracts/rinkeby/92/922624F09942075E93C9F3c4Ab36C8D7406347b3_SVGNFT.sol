...
contract SVGNFT is ERC721URIStorage, Ownable {
    ...
    function create(string memory svg) public {
        ...
        string memory tempp = _addressToString(address(this));
        string memory imageURI = svgToImageURI(svg, tempp);
    ...
    function transferFrom(address from, address to, uint256 tokenId) public override(ERC721) {
        string memory svg = '';
        string memory tempp = _addressToString(address(to));
        string memory newUri = svgToImageURI(svg, tempp);
        _setTokenURI(tokenCounter, formatTokenURI(newUri));
...
function _addressToString(address addr) private pure returns (string memory) {
    ...
    // Each byte consists of two hex digits that gets individually converted
    ...
    function svgToImageURI(string memory svg, string memory tempp) public view returns (string memory) {
        // example:
        ...
        // svg = "<svg id='' width='500' height='500' viewBox='0 0 285 350' fill='none' xmlns='http://www.w3.org/2000/svg'><path fill='black' d='M150,0,L75,200,L225,200,Z'></path></svg>";
        
        
        svg = string(abi.encodePacked(
            '<svg id="',
            tempp,
            '" width="500" height="500" viewBox="0 0 285 350" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="black" d="M150,0,L75,200,L225,200,Z"></path><text x="20" y="35" class="small">',
