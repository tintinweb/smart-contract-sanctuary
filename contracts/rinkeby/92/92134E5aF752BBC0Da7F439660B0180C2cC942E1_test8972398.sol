...
// //  _              _    _____  _____  ______ _____  _____  _____  _____ 
// | |            | |  |  _  ||  _  ||___  // __  \|____ ||  _  ||  _  |
// | |_  ___  ___ | |_  \ V / | |_| |   / / `' / /'    / /| |_| | \ V / 
// | __|/ _ \/ __|| __| / _ \ \____ |  / /    / /      \ \\____ | / _ \ 
// | |_|  __/\__ \| |_ | |_| |.___/ /./ /   ./ /___.___/ /.___/ /| |_| |
//  \__|\___||___/ \__|\_____/\____/ \_/    \_____/\____/ \____/ \_____/
...
contract test8972398 is ERC721, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

    uint256 public totalSupply = 0;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/258/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/258/contract-uri";
	...
	uint256 public pricePerToken = 120000000000000000;
    uint256 public tokenfyPrice = 2000000000000000000;
	...
	constructor(address _signerAddress) ERC721("test8972398", "TST") {
