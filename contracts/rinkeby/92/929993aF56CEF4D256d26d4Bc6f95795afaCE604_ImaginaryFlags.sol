...
contract ImaginaryFlags is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    string memory output = string(abi.encodePacked(
      ...
      // string memory output = string(abi.encodePacked(
  //       '<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="350" height="700" viewBox="0 0 350 700" xmlns:xlink="http://www.w3.org/1999/xlink">',
  //   '<defs>',
  //   '<path fill="#D63931" id="first-band"  d="M699.43,231.07c-87.37,0-87.37,20-174.74,20s-87.37-20-174.74-20-87.36,20-174.72,20-87.37-20-174.73-20v-83c87.36,0,87.36,20,174.73,20s87.36-20,174.72-20,87.37,20,174.74,20,87.37-20,174.74-20Z"/>',
  //   '<path fill="#0042AD" id="second-band" d="M699.43,319.07c-87.37,0-87.37,20-174.74,20s-87.37-20-174.74-20-87.36,20-174.72,20-87.37-20-174.73-20v-83c87.36,0,87.36,20,174.73,20s87.36-20,174.72-20,87.37,20,174.74,20,87.37-20,174.74-20Z"/>',
  //   '<path fill="#1EB439" id="third-band" class="cls-3" d="M699.43,407.07c-87.37,0-87.37,20-174.74,20s-87.37-20-174.74-20-87.36,20-174.72,20-87.37-20-174.73-20v-83c87.36,0,87.36,20,174.73,20s87.36-20,174.72-20,87.37,20,174.74,20,87.37-20,174.74-20Z"/>',
  //   '</defs>',
  //   '<use xlink:href="#first-band" x="0" y="0">',
  //       '<animate attributeName="x" from="0" to="-350" dur="3s" repeatCount="indefinite"/>',
  //   '</use>',
  ...
  constructor() ERC721("ImaginaryFlags", "VAB") Ownable() {
    _tokenIdCounter.increment();
  }
}
