...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
    ...
    // File: contracts/hasAllowlistContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract HasAllowlistContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Has Allowlist", "ACCESS", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://ipfs.io/QmfCj28SzFZY6Rq7JaX2v1Jm4UhTByiUi2Pr8vm7rhBLiV/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/qQ2KzlJCzvc9Gt3DBVJo/contract-metadata";
        }
    }