...
contract CardKeeper is Ownable {
    ...
    function harvest() public {
        ...
        if (pendingToshicash > 0) {
            ...
            toshicash.addClaimed(pendingToshicash);
        }
    ...
    function stake(uint256[] memory _cardIds, uint256[] memory _cardAmounts) public {
        ...
        ropeMaker.safeBatchTransferFrom(msg.sender, address(this), _cardIds, _cardAmounts, "");
    ...
    function depositERC1155(uint256 poolId, uint256 quantity) public {
        ...
        ropeMaker.safeTransferFrom(msg.sender, address(this), erc1155.id , quantity, "");
    ...
    function withdrawERC1155(uint256 poolId, uint256 quantity) public {
        ...
        ropeMaker.safeTransferFrom(address(this), msg.sender, erc1155.id, quantity, "");
