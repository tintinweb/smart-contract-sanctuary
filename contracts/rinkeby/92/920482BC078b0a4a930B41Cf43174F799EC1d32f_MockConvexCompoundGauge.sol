...
contract MockConvexCompoundGauge {
    ...
    function borrow(
        ...
        uint256 utilizationRate = getUtilizationRate(IBooster(compoundBooster).totalSupplyOf(_pid), token1Amount,0);
    ...
    function DemoAddPool() public {
        ...
        sSupportTokens[0] = 0xDf032Bc4B9dC2782Bb09352007D4C57B75160B15;
        sSupportTokens[1] = 0xDf032Bc4B9dC2782Bb09352007D4C57B75160B15;
