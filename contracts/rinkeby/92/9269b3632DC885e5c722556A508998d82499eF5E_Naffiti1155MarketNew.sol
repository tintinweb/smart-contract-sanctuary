...
contract Naffiti1155MarketNew is ERC1155Holder {
    ...
    modifier isAuctionNotStartedByOwner(
        ...
        require(
            nftContractAuctions[_nftContractAddress][_tokenId]
                .detailItem[_listId]
                .nftSeller !=
                //            nftContractAuctions[_nftContractAddress][_tokenId].detailItem[_listId].nftSeller !=
                msg.sender,
    ...
    function _doesBidMeetBidRequirements(
        ...
        uint256 bidIncreaseAmount = (nftContractAuctions[_nftContractAddress][
            _tokenId
        ].detailItem[_listId].nftHighestBid *
            (10000 +
    ...
    function _getBidIncreasePercentage(
        ...
        uint32 bidIncreasePercentage = nftContractAuctions[_nftContractAddress][
            _tokenId
        ].detailItem[_listId].bidIncreasePercentage;
        ...
        returns (uint32)
    {
        uint32 auctionBidPeriod = nftContractAuctions[_nftContractAddress][
            _tokenId
        ].detailItem[_listId].auctionBidPeriod;
        ...
        returns (address)
    {
        address nftRecipient = nftContractAuctions[_nftContractAddress][
            _tokenId
        ].detailItem[_listId].nftRecipient;
        ...
        increasePercentageAboveMinimum(_bidIncreasePercentage)
    {
        ...
        if (
            _lastListId != 0 &&
            nftContractAuctions[_nftContractAddress][_tokenId].lastListId == 0
        ) {
            // New minted item listing
            _listId = 0;
        } else {
            _listId = nftContractAuctions[_nftContractAddress][_tokenId]
                .lastListId;
            _listId++;
        }
        nftContractAuctions[_nftContractAddress][_tokenId]
        ...
        nftContractAuctions[_nftContractAddress][_tokenId]
            .detailItem[_listId]
            .nftQuantity = _quantity;
        nftContractAuctions[_nftContractAddress][_tokenId].lastListId = _listId;
    ...
    //        increasePercentageAboveMinimum(_bidIncreasePercentage)
    {
        //        nftContractAuctions[_nftContractAddress][_tokenId].detailItem[_listId].auctionBidPeriod = _auctionBidPeriod;
        //        nftContractAuctions[_nftContractAddress][_tokenId].detailItem[_listId].bidIncreasePercentage = _bidIncreasePercentage;
        //        nftContractAuctions[_nftContractAddress][_tokenId].detailItem[_listId].nftQuantity = _quantity;
        _createNewNftAuction(
            _nftContractAddress,
            _tokenId,
            _erc20Token,
    ...
    function restCurrentListId(
        address _nftContractAddress,
        uint256 _tokenId,
        uint256 _newCurrentListId
    ) external {
        if (
            nftContractAuctions[_nftContractAddress][_tokenId].lastListId != 0
        ) {
            _listId = _newCurrentListId;
        }
    }
    ...
    function _reverseAndResetPreviousBid(
        ...
        address nftHighestBidder = nftContractAuctions[_nftContractAddress][
            _tokenId
        ].detailItem[_listId].nftHighestBidder;
