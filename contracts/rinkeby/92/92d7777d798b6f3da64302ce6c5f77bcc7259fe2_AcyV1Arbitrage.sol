...
contract AcyV1Arbitrage is IAcyV1Arbitrage{
    ...
    constructor(address _factory,address _tokenAA,address _tokenBB,address _tokenCC) public {
        factory = _factory;
        tokenAA = _tokenAA;
        tokenBB = _tokenBB;
        tokenCC = _tokenCC;
    ...
    function swap(uint amountIn,address inputToken,address outputToken) external {
        ...
        // IERC20(inputToken).approve(address(this), amountIn);
        // this.swapExactTokensForTokensSupportingFeeOnTransferTokens(
        //     amountIn,
        //     amountOutMin, // accept any amount of pair token
        //     arr,
        //     address(this),
        //     block.timestamp
        // );
