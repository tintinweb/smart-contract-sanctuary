...
// Part: OpenZeppelin/openzeppelin-contracts[email protected]/IERC721Metadata
...
contract RandomHumans is Context, ERC721, Ownable {
        ...
        uint private constant maxHumans = 100000;
    ...
    function createCollectible(string memory tokenURI) public payable returns (uint256) {
     ...
     function mintME(string memory tokenURI) private onlyOwner returns (uint256) {
        uint256 newItemId = tokenCounter;
        _safeMint(msg.sender, newItemId);
        _setTokenURI(newItemId, tokenURI);
        tokenCounter = tokenCounter + 1;
