...
contract __1Project is ERC721Enumerable, Ownable {
    ...
    // Token Detail
    mapping(uint256 => _1Project) private  _1ProjectDetails;
    ...
    function reserveTokens() public onlyOwner {
        ...
        for (i = 1; i <= 50; i++) {
            ...
            if (tokenId <= MAX_TOKENS) {
                ...
                _1ProjectDetails[tokenId] = _1Project(first_encounter);
    ...
    function safeTransferFrom(
        ...
        {
        _tokenLevel[tokenId]=tokenLevel+1;
        }
        uint256 royalty = msg.value.div(100);
     ...
     */
    function get1ProjectDetail(uint256 tokenId)
        public
        view
        returns (_1Project memory detail)
    {
        require(_exists(tokenId), "Token was not minted");

        return _1ProjectDetails[tokenId];
    }
}
