...
contract PawnMortgage is Pawn
{
    ...
    function updateMaxLoanDuration(uint256 _newMaximumLoanDuration) external onlyOwner {
        require(_newMaximumLoanDuration != 0, 'updateMaxLoanDuration:: duration can not be zero');
        uint256 _oldMaximumLoanDuration = maximumLoanDuration;
        maximumLoanDuration = _newMaximumLoanDuration;
        emit MaxLoanDurationUpdated(_oldMaximumLoanDuration, _newMaximumLoanDuration);
    }
