...
contract geev1 is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("geev1", "GV1") {
        setBaseURI(_baseURI);
