...
contract ERC721Suika is ERC721Mochi, ReentrancyGuard {
    ...
    */
    ...
    constructor(address _owner, address payable _admin, uint256 _commissionRate, string memory name, string memory symbol, bool _anyoneCanMint) 
    ...
    function buy(uint256 tokenId) public payable nonReentrant {
        ...
        // transfer funds
        require(msg.value >= sellBidPrice[tokenId], "ERC721Suika: Not enough funds");
