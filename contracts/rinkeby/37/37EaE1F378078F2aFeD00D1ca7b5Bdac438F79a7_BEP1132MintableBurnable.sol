...
import "@openzeppelin/contracts/contracts/token/ERC1132/draft-ERC1132.sol";
 ...
 * as well as the default admin role, which will let it grant minter roles to other accounts.
 */
contract BEP1132MintableBurnable is Context, Ownable, AccessControlEnumerable, ERC20Burnable, ERC1132, IBEP20 {
     ...
     */
    constructor(string memory name, string memory symbol, uint256 initialSupply) ERC1132(name, symbol) {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "BEP1132MintableBurnable: must have minter role to mint");
        _mint(to, amount);
    }
