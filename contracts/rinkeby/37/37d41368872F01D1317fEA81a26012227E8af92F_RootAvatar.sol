...
import {Royalty} from "../../common/Royalty.sol";
...
contract Royalty is IERC2981
{
    ...
    function setRoyaltyAddress(address royaltyAddress) public onlyRoyaltyOwner {
        _royaltyAddress = royaltyAddress;
    }

    /// @dev sets royalties fees
    function setRoyaltyPercentage(uint256 royaltyPercentage)  public onlyRoyaltyOwner {
