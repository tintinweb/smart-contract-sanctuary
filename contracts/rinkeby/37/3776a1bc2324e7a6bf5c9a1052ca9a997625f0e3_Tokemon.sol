...
contract Tokemon  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned; 
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
	address payable public NFT = payable(0x129238b9580E11212DB3D61f0c0ff7267E4D1F91); // TokeEgg
	address payable public marketingAddress = payable(0xf14359aBcae8C684611FbC618969AD87fdE903cB); // Marketing Address
