...
contract COSMOSVG is ERC721URIStorage, Ownable {
    uint256 public tokenCounter;
    event CreatedCOSMOSVG(uint256 indexed tokenId, string tokenURI);

    constructor() ERC721("COSMO SVG NFT", "cosmosvgNFT")
    {
        tokenCounter = 0;
    }
    ...
    function create(string memory svg) public {
        ...
        emit CreatedCOSMOSVG(tokenCounter, svg);
    }
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                "COSMO SVG NFT", // You can add whatever name here
