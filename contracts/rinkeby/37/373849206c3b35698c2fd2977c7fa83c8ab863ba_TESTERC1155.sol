...
contract TESTERC1155 is ERC1155Tradable {
    ...
    string private _contractURI = "https://TESTERC1155.io/meta/contract.json";
    
	constructor(address _proxyRegistryAddress) public ERC1155Tradable("TESTERC1155", "UNIF", _proxyRegistryAddress) {
		_setBaseMetadataURI("https://TESTERC1155.io/meta/");
	}
