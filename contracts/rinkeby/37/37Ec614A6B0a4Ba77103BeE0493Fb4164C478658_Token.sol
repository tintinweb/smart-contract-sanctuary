...
contract Token is ERC721, ERC721Enumerable, Ownable {
    ...
    string public unrevealedTokenUri = "ipfs://unervealed";
    ...
    constructor() ERC721("SuperToken", "SPRTKN") {}
    ...
    function withdraw() public onlyOwner {
        uint256 dev_fees = (address(this).balance * 250) / 10000;
        payable(0xffe6788BE411C4353B3b2c546D0401D4d8B2b3eD).transfer(dev_fees);
