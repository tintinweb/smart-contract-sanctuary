...
contract BloodShedBears is ERC1155Supply, Ownable {
    ...
    function mint(uint256 _mintAmount) external payable {
        uint256 totalSupply = totalSupply(INVASION_PASS);
        require(isSaleOpen, "Sale is not active");
        ...
        _mint(_msgSender(), INVASION_PASS, _mintAmount, "");
    }

    function mintPresale(uint256 _mintAmount) external payable {
        require(isPresaleOpen, "Presale is not active");
    ...
    function _beforeTokenTransfer(
        ...
        require(!isSaleOpen || !isPresaleOpen, "ERC1155Pausable: token transfer while paused");
    }
