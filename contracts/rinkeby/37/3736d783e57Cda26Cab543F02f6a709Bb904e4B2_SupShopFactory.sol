...
contract SupShop is ERC1155Upgradeable, OwnableUpgradeable {
    ...
    function uri(uint256 typeId) public view override returns (string memory) {
        require(itemTypeIds[typeId], "URI requested for invalid item type");
        return
...
// WIP
contract SupShopFactory is Initializable, ContextUpgradeable, ERC1155Upgradeable, IFactory, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  using StringsUpgradeable for uint256;
