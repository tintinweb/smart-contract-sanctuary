...
contract VTest is ERC721, Ownable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    uint256 public mintPrice = 30000000000000000; // 0.050 ETH
    ...
    function setMaxSupply(uint256 amount) public onlyOwner {
        require(MAX_SUPPLY.add(amount) < ~uint256(0), "Exceeds numberic limts");
