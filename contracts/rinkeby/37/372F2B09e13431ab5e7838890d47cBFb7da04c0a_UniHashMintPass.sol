...
contract UniHashMintPass is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    ...
    mapping ( address => uint256[] ) public userNFTS;
     ...
     string public  contractURIstorefront = '{ "name": "Limited-Edition Mint Pass", "description": "This Limited-Edition Mint Pass by UniHash provides the holder with unlimited "preferred access" to UniHash token & NFT sales/presales.", "image": "https://gateway.pinata.cloud/ipfs/QmRtV55zMH99YNbBgyCejkyxc1hsGJVLkmyYykKHtzTaim", "external_link": "https://gateway.pinata.cloud/ipfs/QmRtV55zMH99YNbBgyCejkyxc1hsGJVLkmyYykKHtzTaim", "seller_fee_basis_points": 300, "fee_recipient": "0x92Fb29f59C1742E7008Be501cA6A71Adf77A4C14"}'; 
    
     string public _tokenURI = "ipfs://Qman4dZ3uBGKUAwsfR55DtMhgroT5cxrNVmQmDkr7ambk8";
    
    
    constructor() ERC721("UniHash Mint Pass", "MP_UniHash") {
        mintingEnabled = !mintingEnabled;
       
        EmergencyAddress = msg.sender;
        oracle = 0xE892632bdCB507934e7d0a172B4B66fF1552C68D;
       
        price = 50000000000000000;
        max_quantity = 10000;
        devAddress = payable(0xE892632bdCB507934e7d0a172B4B66fF1552C68D);
        gameFunds  = payable( 0xE892632bdCB507934e7d0a172B4B66fF1552C68D) ;
