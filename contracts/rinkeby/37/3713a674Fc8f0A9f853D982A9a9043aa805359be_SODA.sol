...
contract ControlledAccess is Ownable {
    ...
    */
    function isValidAccessMessage( address _add, bytes32 _r, bytes32 _s, uint8 _v) view public returns (bool)
    {
...
// File contracts/ERC721EnumerableB.sol
...
contract SODA is Delegated, ERC721EnumerableB, ControlledAccess, PaymentSplitter {
  ...
  address[] private addressList = [
    0x62F9ACbD11350FB05B3215507dD1f6e05ed27aF5, // Amin & Samantha
    0x3C31abE4b91c9e8bD39fB505CD98c59fc78cD8E6, // Liam
    0x30A8Bac5AED69b9fF46d4fC04A48388cDe5D3A59, // Drew
    0x66c17Dcef1B364014573Ae0F869ad1c05fe01c89,  // Yeti
    0xE0679Ed38E8445CaB1aB9C87e61CC7ae8AD1181B // Community
  ];
  ...
  constructor()
    Delegated()
    ERC721B("SECRET NFT TEST", "SECRET")
  ...
  function mint( uint quantity ) external payable {
    ...
    require(currentBalance + quantity <= walletLimit, "Order exceeds wallet limit" );
  ...
  function presaleMint( uint quantity, bytes32 _r, bytes32 _s, uint8 _v ) onlyValidAccess(_r,_s,_v) external payable {
  ...
  function setSaleState(uint8 saleState_) external onlyDelegates{
