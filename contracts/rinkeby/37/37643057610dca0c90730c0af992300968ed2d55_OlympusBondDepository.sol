...
contract OlympusBondDepository is IBondDepository, Ownable {
    ...
    function redeemBond() external override returns ( bool ) {
        ...
        uint256 pendingInterestDue_ = depositorInfo[msg.sender].interestDue;
        uint256 pendingBondMaturationBlock_ = depositorInfo[msg.sender].bondMaturationBlock;
        uint256 pendingPrincipleAmount_ = depositorInfo[msg.sender].principleAmount;
        ...
        uint256 value = IBondingCalculator( bondCalculator ).principleValuation( pendingPrincipleAmount_ );
        ...
        totalDebt = totalDebt.sub( balance );
