...
contract SoulcopsCompanion is ERC721EnumerableM, Ownable {
    ...
    // get remaining airdrop qty
    function airdropQtyRemaining() public view returns (uint256) {
        return MAX_AIRDROP - airdropQtyMinted;
    }
    ...
    function airdropMint(uint256 count, uint256 allowance, bytes32[] calldata proof) external {
        ...
        require(airdropQtyMinted + count <= airdropQtyRemaining(), "Minting would exceed the presale allocation.");
