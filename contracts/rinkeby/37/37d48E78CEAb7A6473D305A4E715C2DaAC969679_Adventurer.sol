...
contract Adventurer is Adventurer721 {
    ...
    function summon(
        ...
        require(supply < maxSupply, "Cannot summon any more adventurers");
        require(
    ...
    {
        return "https://pxquest.com/meta/tokens/1/";
    }

    //base url for returning info about the token collection contract
    function contractURI() public pure returns (string memory) {
        return "https://pxquest.com/meta/contracts/1/token";
    }
}
...
abstract contract Adventurer721 is ERC721, Ownable {
    ...
    function getMerkelRoot() public view returns (string memory) {
        return _merkelroot;
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(baseTokenURI(), Strings.toString(offsetid))
            );
    }
}
