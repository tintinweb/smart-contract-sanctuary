...
contract UnipilotFarm is IUnipilotFarm, ReentrancyGuard, IERC721Receiver {
    ...
    address private constant PILOT_TOKEN = 0x18F10404cC1414e6ACBfEA16CCC97D9ed303e98C; //rinkeby
    address private constant UNIPILOT = 0x4AC41d4f46C5d00F1Bc3deC8a59cc7Dc4da42b87; //rinkeby
    ...
    function getGlobalReward(
        ...
        if (backwardCompatible) {
            for(uint i = 0; i < deprecated.length; i++){
               tvl = tvl.add(IUnipilotFarmV1(deprecated[i]).poolInfo(pool).totalLockedLiquidity);
            }
