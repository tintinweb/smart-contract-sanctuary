...
contract NFT is ERC721, Ownable {
    ...
    constructor(
        ...
        whitelisted[0xa66F98ceD83c6a8311CA0a6c60Cb29c570032890] = true;
    }
    ...
    function discover(uint256 numberOfTokens) public payable {
    ...
    function discoverWhitelisted(uint256 numberOfTokens) public payable {
        require(whitelistIsActive, "Whitelist must be active to mint NFT");
        require(
    ...
    function discoverFree(uint256 numberOfTokens, address to) public onlyOwner {
        require(
            totalSupply().add(numberOfTokens) <= MAX_NFT,
            "Purchase would exceed max supply of NFT"
        );
    ...
    function whitelistAddressMulti(address[] calldata adds) public onlyOwner {
        for (uint256 i = 0; i < adds.length; i++) {
            whitelisted[adds[i]] = true;
        }
    }

    function emergencyChangeSupply(uint256 newSupply) public onlyOwner {
        MAX_NFT = newSupply;
    }
