...
// Used for common actions of settlementFee pool
// interface IAsteriaFeePool {    
...
interface IAsteriaOption {
    ...
    event Exercise(address indexed holder, uint256 indexed id, uint256 profit);
    ...
    ERC20("Asteria WBTC LP Token", "writeWBTC")
{
    ...
    /*
     * @nonce calls by AsteriaOptions to lock funds
    ...
    /*
     * @nonce Calls by AsteriaOptions to unlock funds
    ...
    function withdraw(uint256 amount, uint256 maxBurn) external returns (uint256 burn) {
        ...
        require(
            ...
            "AsteriaWBTCPool: You are trying to unlock more funds than have been locked for your contract. Please lower the amount."
        );
