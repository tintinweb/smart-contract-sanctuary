 ...
 */
contract ERC721Collection is ERC721Storage, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    function mint(address to, string calldata tokenURI_, bytes memory _data) external onlyOwner {
        uint256 tokenId = totalSupply();
