...
contract SwampGold is Context, Ownable, ERC20 {
    ...
    struct CyrptoContractInfo {
        ...
        IERC721Enumerable iContractAddress;
        uint256 tokenAmount;
    ...
    function init() internal{
        ...
        address toadziContractAddress = 0x1Fd612bFBe4c47dC462C8A8F032d0dC9dA75185a;
    ...
    function SetToadzContractAddress(address toadzAddress)
        public
        onlyOwner
    {
        toadz.nftiContractAddress = toadzAddress;
    }

    function SetFlyzContractAddress(address flyzAddress)
        public
        onlyOwner
    {
        flyz.nftiContractAddress = flyzAddress;
    }

    function SetPolzContractAddress(address polzAddress)
        public
        onlyOwner
    {
        polz.nftiContractAddress = polzAddress;
    }
