...
contract EnglishAuctionPropy {
    ...
    constructor(uint256 _id, uint256 _startTime) public {
        token = address(0x74Fe64902153834c9E4E7dfd4492e833F57b714F);
        id = _id;
        startTime = _startTime;
        length = 30 minutes; // TODO CHANGE TO 24 HOURS
        endTime = startTime + length;
        lastBid = 0.1 ether; // TODO CHANGE TO 7.5 ETH
    ...
    function pull() public {
        ...
        require(!live(), "Auction live");
        // transfer erc721 to seller
        IERC721(token).safeTransferFrom(address(this), seller, id);
        ended = true;
    }
