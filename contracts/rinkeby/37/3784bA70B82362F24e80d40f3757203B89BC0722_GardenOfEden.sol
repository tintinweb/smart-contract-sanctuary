...
contract GardenOfEden is ERC721Enumerable, Ownable {

    mapping(address => uint) public whitelistRemaining; // Maps user address to their remaining mints if they have been whitelisted
    ...
    address[] public team = [
        address(0x0),
        0xE9C30a76e744c6680CCCba2B0CbB2a511e3A3029,
        0xbfF79922FCbF93f9c30aBB22322B271460C6BeBb,
        address(0x0),
        0xc38ED033B432A94660aF42099E1F820D95b26177,
        0xa511388e9A84a54cC8fE893b515a59c20Fa06bd5,
        0xa4789C4F1b66e5BcEAE47730bE25bDf741723b70
    ];

    uint[] public portions = [
        5000,
        250,
        375,
        1250,
    ...
    constructor() ERC721("Great Relics", "GR") {
        require(team.length == portions.length, "Mismatched arrays");
        uint portionTotal = 0;
        for (uint i = 0; i < portions.length; i++) {
            portionTotal += portions[i];
        }
        require(portionTotal == 10000, "Improper portions sum");
    }
    ...
    function setBatchWhitelist(address[] memory users, uint[] memory amounts) public onlyOwner {
    ...
    function withdraw() external {
        ...
        for (uint i = 0; i < team.length; i++) {
            sendEther(team[i], amount * portions[i] / 1000);
        }
    }
