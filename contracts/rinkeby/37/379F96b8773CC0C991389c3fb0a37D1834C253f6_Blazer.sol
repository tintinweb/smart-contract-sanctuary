...
contract Blazer is ERC721, Ownable {
    ...
    uint public preMintMaxItems = 100;
    uint public maxItems = 3000;
    uint public giveawayCount = 0;
    uint public preMintCount = 0;
    uint public totalSupply = 0;
    uint public maxItemsPerPreMint = 1; // Mutable by owner
    uint public maxItemsPerTx = 5; // Mutable by owner
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmbaE1BD2Wr2kRLy9B4V9xFGnVpZEdbAFjvrB3u9Z7YskK/";
