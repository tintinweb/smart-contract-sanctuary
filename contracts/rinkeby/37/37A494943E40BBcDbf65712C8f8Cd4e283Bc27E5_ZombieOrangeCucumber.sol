...
contract ZombieOrangeCucumber is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public mintPrice = 2500000 gwei; // 0.0025 ETH
    ...
    constructor(
        ...
        uint256 maxDragonSupply
    ) ERC721(name, symbol) {
        maxTokenSupply = maxDragonSupply;

        _shareholders[0] = 0x449F9B6f81c9e600445de67671Be23BD17193E04; // Shareholder 1
        _shareholders[1] = 0x11BC1923f0910855E0500108236B6a62EE0528b2; // Shareholder 2
...
//    }
    ...
    /*
     * Mint Cucumber NFTs, woo!
     */
    function mintCucumbers(uint256 numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to adopt dragons");
        require(
            numberOfTokens <= MAX_MINTS_PER_TXN,
            "You can only adopt 15 dragons at a time"
        );
        require(
            totalSupply() + numberOfTokens <= maxTokenSupply,
            "Purchase would exceed max available dragons"
        );
        require(
