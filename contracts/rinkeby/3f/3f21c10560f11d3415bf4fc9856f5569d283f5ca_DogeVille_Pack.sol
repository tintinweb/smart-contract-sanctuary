...
contract DogeVille_Pack is ERC721Enumerable, Mintable {
    string private _baseURIExtended;
    string private _contractURIExtended;
    address public shareholder1Address = 0x544d5D3984ACB59E93CB38B95cBDc8f9Ba59CFba;
    address payable private shareholder1 = payable(shareholder1Address);
    address public shareholder2Address = 0xfC985B5EC567935CAc9a64515084E1Cd4e65a9E6;
    address payable private shareholder2 = payable(shareholder2Address);
    address public shareholder3Address = 0xaEbA9F5fDcd60B180499Bb16011F2629759200Ea;
    ...
    function setImxUri( address _imxUri) public onlyOwner{
        imx = _imxUri;
    }
    ...
    function transferBalance()public payable{
        uint shareholder1Part = address(this).balance / 100 * 75;
        uint shareholder2Part = address(this).balance / 100 * 20;
        uint shareholder3Part = address(this).balance / 100 * 5;
