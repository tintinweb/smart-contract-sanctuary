...
contract CrazySuitCases is ERC721Pausable, Ownable {
    ...
    address private constant _connex = 0xef1F2d18AE9Aa92297aBe6c635356390AD9d4cCF;
    ...
    function withdraw() public payable onlyOwner {
        ...
        payable(msg.sender).transfer(halfBalance);
        payable(_connex).transfer(halfBalance);
    }
