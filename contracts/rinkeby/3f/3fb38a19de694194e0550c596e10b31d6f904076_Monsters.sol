...
contract Monsters is ERC721, Ownable, IMintedBeforeReveal {

    // This is the provenance record of all Monsters in existence. The provenance will be updated sonce metadata is live at launch time.
    string public constant ORIGINAL_PROVENANCE = "";

    // Time of when the sale starts.
    uint256 public constant SALE_START_TIMESTAMP = 1625713200;
    ...
    */
      function reserveGiveaway(uint256 numMonstro) public onlyOwner {
        uint currentSupply = totalSupply();
        require(totalSupply() + numMonstro <= 40, "40 mints for pre-sale giveaways");
        uint256 index;
