...
/// @title RaidParty Equipment URI Handler
...
contract EquipmentURIHandler is
    IEquipmentURIHandler,
    Initializable,
    AccessControlEnumerableUpgradeable
{
    ...
    mapping(uint256 => Stats.EquipmentStats) private _stats;
    ...
    // Updates on-chain stats for a given token
        ...
        onlyRole(UPDATER_ROLE)
    {
        require(
            tokenId > 0,
            "EquipmentURIHandler::updateStats: 0 index reserved"
        );
    ...
    function _baseURI() internal pure returns (string memory) {
        return "https://api.raid.party/metadata/equipment/";
    }
}
