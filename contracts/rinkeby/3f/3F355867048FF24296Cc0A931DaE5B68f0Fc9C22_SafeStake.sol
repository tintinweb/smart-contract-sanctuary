...
contract SafeAffinity is IERC20, Context, Ownable {
    ...
    address private _dexRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // --> Rinkeby
...
contract AffinityDistributor is IAffinityDistributor {
    ...
    address SafeEarn = 0x9788f8565aBea33AE86B1526F8F839ab7AcA185e; // --> RINKEBY BUSE
    // SafeVault
    ...
    address SafeVault =  0x9788f8565aBea33AE86B1526F8F839ab7AcA185e; // --> RINKEBY BUSD
