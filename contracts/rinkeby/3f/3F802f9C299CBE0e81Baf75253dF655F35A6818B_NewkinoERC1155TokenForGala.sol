...
contract NewkinoERC1155TokenForGala is IERC2981, ERC165Storage, Ownable, IERC1155MetadataURI, ERC1155, MinterRole {
    ...
    */
    ...
    function setMintQuantities(address minter, uint tokenId, uint quantity) public onlyAdmin {
    ...
    function mint(address _beneficiary, uint256 _tokenId, uint256 _supply) public onlyMinter{
        require(mintQuantities[msg.sender][_tokenId] == _supply, "_supply is not valid");
        safeMint(_beneficiary, _tokenId, _supply);
    }
