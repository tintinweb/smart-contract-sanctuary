...
contract Project92 is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/92/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/92/contract-uri";
	...
	uint256 public pricePerToken = 45600000000000000;
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("Test Tokens", "TOKEN") {
