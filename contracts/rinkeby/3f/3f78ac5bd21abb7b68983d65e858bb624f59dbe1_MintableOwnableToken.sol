...
contract MintableOwnableToken is Ownable, ERC721, IERC721Metadata, ERC721Burnable, ERC721Base, SignerRole {
    ...
    function mint(uint256 tokenId, uint8 v, bytes32 r, bytes32 s, Fee[] memory _fees, string memory tokenURI, address userWallet) onlyOwner public {
        require(isSigner(StringLibrary.getAddress(abi.encodePacked(this, tokenId, userWallet), v, r, s)), "signer should sign tokenId");
