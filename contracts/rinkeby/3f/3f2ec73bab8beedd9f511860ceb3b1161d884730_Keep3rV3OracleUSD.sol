...
contract Keep3rV3OracleUSD  {
    ...
    function assetToEth(address tokenIn, uint amountIn, uint granularity) public view returns (QuoteParams memory q) {
        ...
        q.sCUR = amountIn * sushiswapV2Router.getAmountsOut(amountIn, _path)[1] / _decimals;
        q.uCUR = amountIn * uniswapV2Router.getAmountsOut(amountIn, _path)[1] / _decimals;
    ...
    function ethToAsset(uint amountIn, address tokenOut, uint granularity) public view returns (QuoteParams memory q) {
        ...
        _path[0] = WETH;
        _path[1] = tokenOut;
        q.sCUR = amountIn * sushiswapV2Router.getAmountsOut(amountIn, _path)[1] / DECIMALS;
        q.uCUR = amountIn * uniswapV2Router.getAmountsOut(amountIn, _path)[1] / DECIMALS;
