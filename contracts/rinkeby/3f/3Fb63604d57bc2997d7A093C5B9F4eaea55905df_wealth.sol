...
contract wealth is ERC1155Supply, Ownable  {
    using SafeMath for uint256;
    bool public saleIsActive = true;
    uint constant TOKEN_ID = 1;
    uint constant NUM_RESERVED_TOKENS = 2;
    uint constant MAX_TOKENS_PER_PURCHASE = 1;
    uint constant MAX_TOKENS = 100;
    uint constant TOKEN_PRICE = 3 ether;
    address A1 = 0x66675B779B143437Ea81dCD126dcD337aA89335D;
    ...
    function withdraw() public onlyOwner {
        ...
        payable(A1).transfer(address(this).balance.mul(10).div(100));
        payable(owner()).transfer(address(this).balance.mul(100).div(100));
    }
}
