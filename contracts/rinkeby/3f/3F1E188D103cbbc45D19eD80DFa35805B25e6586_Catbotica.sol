...
contract Catbotica is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard, IERC2981 {
    ...
    uint256 public constant TICK_PERIOD = 1 minutes; // Time period to decrease price
    uint256 public constant PUBLIC_SALE_PERIOD = 8 minutes; // Dutch Auction Time Period
    ...
    uint16 public constant MAX_PRIVATE_SALE_SUPPLY = 26; // Cap for tokens to be sold in private sale is 2500 in addition to 500 for redmeption by RWA list
    uint16 public constant MAX_TOKENS = 40; // Max number of token sold in  sale
