...
contract Lottery is AccessControl {
    ...
    function pickWinner() public restricted {
        require(block.timestamp - lastRun > 5 minutes, "Lottery has been drawn less than 5 minutes ago!");
    ...
    function enter(uint amount) public {
        require(tokenContract.balanceOf(msg.sender) >= ticketPrice*amount, "Not enough funds");
        tokenContract.transferFrom(msg.sender, address(this), ticketPrice*amount);
        customers.push(msg.sender);
        sales += ticketPrice*amount;
    }
