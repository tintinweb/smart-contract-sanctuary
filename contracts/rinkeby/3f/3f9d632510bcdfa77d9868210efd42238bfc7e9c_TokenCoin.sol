...
contract AbstractToken {
    ...
    constructor(string memory _name, string memory _symbol,uint256 _supply, uint8 _decimals) public {
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
...
contract TokenCoin is AbstractToken{
    constructor() public AbstractToken("Internet Computer","ICP",469213710 ,6) {
    }
}