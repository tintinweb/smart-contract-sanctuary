...
contract MerkleDistributor is IMerkleDistributor {
  ...
  function claim(
    ...
    // require(msg.sender == account, "Only owner can claim"); //! todo to be uncommented
    ...
    )
  {
    ...
    // console.log("PERCENTAGE_BASE: ", PERCENTAGE_BASE);
    // console.log("initialPoolSize: ", initialPoolSize);
    ...
    // console.log("totalToClaim: ", totalToClaim);
