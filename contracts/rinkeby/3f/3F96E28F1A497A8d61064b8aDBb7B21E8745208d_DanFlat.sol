...
contract DanFlat is ERC721Enumerable, Ownable
{
    ...
    // withdraw addresses
    address t1 = 0x0F4f77423637B1d9428A6748B293bac5AB4AFa7f;
    address t2 = 0x6148A31c598123068955E2b9Cc00a648D2Ee8481;

    constructor(string memory baseURI) ERC721("Dan Flat", "DAN") {
        setBaseURI(baseURI);
    }
