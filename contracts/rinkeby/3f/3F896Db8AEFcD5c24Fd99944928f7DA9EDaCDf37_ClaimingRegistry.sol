...
contract ClaimingRegistry is IClaimingRegistry, Initializable, AbstractDependant {
    ...
    uint256 internal constant ANONYMOUS_VOTING_DURATION_CONTRACT = 4200;
    uint256 internal constant ANONYMOUS_VOTING_DURATION_EXCHANGE = 4200;

    uint256 internal constant EXPOSE_VOTE_DURATION = 4200;
