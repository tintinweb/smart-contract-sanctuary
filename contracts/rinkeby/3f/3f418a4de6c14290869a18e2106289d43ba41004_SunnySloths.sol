...
contract SunnySloths is ERC721Enumerable, Ownable {
  ...
  uint256 public giveawayReserve = 100;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(
      supply + _mintAmount <= maxSupply - giveawayReserve,
      'Not enough tokens left for your specified quantity'
    );
  ...
  //recommend to send in 50 at a time, to prevent OOG
