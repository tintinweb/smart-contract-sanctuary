...
contract OneSplitRoot is IOneSplitView {
    ...
    uint256 constant internal DEXES_COUNT = 9;
    ...
    IERC20 constant internal dai = IERC20(0x5592EC0cfb4dbc12D3aB100b257153436a1f0FEa);
    IERC20 constant internal usdc = IERC20(0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b);
    IERC20 constant internal usdt = IERC20(0xD9BA894E0097f8cC2BBc9D24D308b98e36dc6D02);
    ...
    IUniswapV2Factory constant internal sushiswapFactory = IUniswapV2Factory(0xc35DADB65012eC5796536bD9864eD8773aBc74C4);
...
contract OneSplitView is IOneSplitView, OneSplitRoot {
        ...
        returns(function(IERC20,IERC20,uint256,uint256,uint256) view returns(uint256[] memory, uint256)[DEXES_COUNT] memory)
    {
        ...
        return [
			...
			invert != flags.check(FLAG_DISABLE_SUSHISWAP_ALL | FLAG_DISABLE_SUSHISWAP_ETH)  ? _calculateNoReturn : calculateUniswapV2ETH,
            invert != flags.check(FLAG_DISABLE_SUSHISWAP_ALL | FLAG_DISABLE_SUSHISWAP_DAI)  ? _calculateNoReturn : calculateUniswapV2DAI,
            invert != flags.check(FLAG_DISABLE_SUSHISWAP_ALL | FLAG_DISABLE_SUSHISWAP_USDC) ? _calculateNoReturn : calculateUniswapV2USDC
        ];
    }
