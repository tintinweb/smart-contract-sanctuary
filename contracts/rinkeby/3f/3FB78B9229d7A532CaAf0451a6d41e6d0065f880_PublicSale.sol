...
contract PublicSale is IPublicSale, Ownable {
    ...
    uint256 public constant PUBLIC_SALE_DELAY = 1 hours;
    uint256 public constant LP_CREATION_DELAY = 5 minutes;
    uint256 public constant TRADING_BLOCK_DELAY = 5 minutes;
    uint256 public constant WHITELISTED_USERS_ACCESS = 30 minutes;
    ...
    uint256 public constant HARD_CAP_ETH_AMOUNT = 0.26 ether;
    uint256 public constant MIN_DEPOSIT_ETH_AMOUNT = 0.001 ether;
    uint256 public constant MAX_DEPOSIT_ETH_AMOUNT = 1 ether;
    ...
    function lockCompanyTokens(address developerReceiver, address marketingReceiver, address reserveReceiver) external override {
        ...
        developerLockContract = address(new CliffVesting(developerReceiver, 1 hours, 2 hours, address(oneUpToken)));    //  1 month cliff  6 months vesting
        marketingLockContract = address(new CliffVesting(marketingReceiver, 1 hours, 2 hours, address(oneUpToken)));      //  7 days cliff   3 months vesting
        reserveLockContract = address(new CliffVesting(reserveReceiver, 1 hours, 2 hours, address(oneUpToken)));        //  9 months cliff 3 months vesting
...
contract InvestorsVesting is IVesting, Ownable {
    ...
    uint256 public constant VESTING_DELAY = 1 hours;
...
contract LiquidityProvider is ILiquidityProvider, Ownable {
    ...
    uint256 public constant LP_TOKENS_LOCK_DELAY = 5 hours;
