...
contract SHTest is ERC721Enumerable, Ownable {
        ...
        returns (string memory)
    {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '"image":',
                        '"data:image/png;base64,"',
                        "}"
                    )
                )
            )
        ...
        // return
        //     "https://95a33w49s5.execute-api.us-east-1.amazonaws.com/default/bitmap-conversion-dev-token_uri";
