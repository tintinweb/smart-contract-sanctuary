...
contract syac is ERC721, Ownable, Pausable {
        ...
        payable
    {
        ...
        for (uint256 i = 1; i <= _count; i++) {
            ...
            require(totalWhiteListMinted[msg.sender]<3,"you can't mint more than 3");
            totalWhiteListMinted[msg.sender]++;
        }
        totalSupply += _count;
    ...
    function mint(uint256 _count) public payable {
        ...
        for (uint256 i = 1; i <= _count; i++) {
            _safeMint(msg.sender, (totalSupply + i));
            require(totalPublicMinted[msg.sender]<=8,"Maximum NFT Limit reached");
            totalPublicMinted[msg.sender]++;
...
//["0x12E8613F1d980FD0543ECEBB2dab9533C589250F","0x1827B98F27A1c6cDFC5f8c7fa3De830Eb7bDfa41","0x8D6E152F92622A8EeF2001885130e6A977a7A7Dc","0xb6A705F8368C85180FB5aFE40efCacB7ED098B2A"]