...
import './ERC721EnumerableA.sol';
import "@openzeppelin/contracts/utils/Strings.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/finance/PaymentSplitter.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";

contract AveragePunks is ERC721EnumerableA, Ownable, PaymentSplitter, ReentrancyGuard {
  ...
  function tokenURI(uint tokenId) external view virtual override returns (string memory) {
    ...
    return bytes(_baseTokenURI).length > 0 ?
      ...
      'ipfs://QmWvpPDSv5RWE2uHv3Dh528LNPAWTShAjR38hL9GGxbFQ9';
  }
}
...
abstract contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _transfer(
        ...
        require(ERC721A.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
 ...
 * account.
 */
abstract contract ERC721EnumerableA is ERC721A, IERC721Enumerable {
    /**
     * @dev See {IERC165-supportsInterface}.
     */
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < ERC721EnumerableA.totalSupply(), "ERC721Enumerable: global index out of bounds");
        return index;
    }
}