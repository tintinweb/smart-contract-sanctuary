...
contract BasicToken is owned {
    ...
    function _transfer(address _from, address _to, uint256 _value) public payable  {
    ...
    function transerFrom(address _from, address _to, uint256 _value) public payable returns(bool success){
    ...
    function mintToken(address _target, uint256 _mintedAmount)public payable {
    ...
    function burn(address _target, uint256 _value) public payable returns(bool success){
        require(exists(msg.sender), 'The sender address is not registered as a Minter');
