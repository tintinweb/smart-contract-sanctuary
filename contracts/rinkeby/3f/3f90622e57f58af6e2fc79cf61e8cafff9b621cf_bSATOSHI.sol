...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x8fBd0A8C6333eC14A136174ab78e5DF5Bc0D8E45;
...
contract bSATOSHI is ERC20, Ownable {
   ...
   bSATOSHIDividendTracker public dividendTracker;
    ...
    address private _dividendToken = 0x8fBd0A8C6333eC14A136174ab78e5DF5Bc0D8E45;
...
contract bSATOSHIDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 30 && newClaimWait <= 86400, "bSATOSHI_Dividend_Tracker: claimWait must be updated to between 0.5 min and 24 hours");
