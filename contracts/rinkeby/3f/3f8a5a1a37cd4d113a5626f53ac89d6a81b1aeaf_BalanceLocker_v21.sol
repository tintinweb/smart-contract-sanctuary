    ...
    ERC20BurnableUpgradeable, AbstractLocker_v21
{
    ...
    */
    ...
    function __BalanceLocker_init_unchained(
        ...
        */
        ...
        __setLpLockerTokenBalanceCap( _lpLockerTokenBalanceCap);
    }

    function setLpLockerTokenBalanceCap(uint256 _cap) external onlyOwner {
        __setLpLockerTokenBalanceCap(_cap);
    }
    ...
    */
    ...
    function __setLpLockerTokenBalanceCap(uint256 _lpLockerTokenBalanceCap) internal {
        __gap[0] = _lpLockerTokenBalanceCap;
    }

    function lpLockerTokenBalanceCap() public view returns (uint256) {
        return __gap[0];
    }
...
abstract contract AbstractLocker_v21 is Initializable, OwnableUpgradeable {
    ...
    function __AbstractLocker_init_unchained(
        ...
        __setTokenDecimals(IERC20Decimals(lockerToken).decimals());
    }
    ...
    function __setTokenDecimals(uint256 _tokenDecimals) internal {
        __gap[0] = _tokenDecimals;
    }
