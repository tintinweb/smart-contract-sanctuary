...
contract LimitTokenSale is Ownable, ReentrancyGuard {
  ...
  function claimToken(uint256 _index, uint256 _resubmit, uint256 _refund) external nonReentrant {
    ...
    require(round.state == SaleLib.State.finalized, "LimitTokenSale: Sale is not finalized");
   ...
   */
  function toSaleTokenAmount(uint256 _collateralTokenAmount, uint256 price) private view returns(uint256) {
