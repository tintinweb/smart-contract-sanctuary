...
contract PeepToken is ERC721Tradable {
	...
	// @note Provenance is only relevant for generated peeps
	string public GENERATED_PROVENANCE = '';
	...
	/**
	 * @dev Update provenance for generated Peeps
	 */
	...
	function burn(uint256 tokenId) public {
		require(BURN_ACTIVE, 'PeepToken: burning is not enabled');
		require(
