...
contract MyNTFContract is ERC721, Ownable {
    ...
    uint16 public totalTokens = 1172;
    uint16 public currentTokenIndex = 0;
	// baseURI of metaData
	// https://ipfs.io/ipfs/QmceJ4XEJkaCqD9wncmHBy1GzZXcso2CJk4VD7xqX1iVUZ/
    string private baseURI = "ipfs://QmceJ4XEJkaCqD9wncmHBy1GzZXcso2CJk4VD7xqX1iVUZ/";
    bool private isFrozen = false;
	uint256 public mintPrice = 0.1 ether;
	uint256 private startMintDate = 0;

    constructor() ERC721("MyNTFContract", "NFTC") {}
    ...
    function getAvailableTokens() public view returns (uint16) {
        return totalTokens - currentTokenIndex;
    }
        ...
        mintStarted
    {
        ...
        _safeMint(msg.sender, currentTokenIndex);
		currentTokenIndex++;
    }
}
