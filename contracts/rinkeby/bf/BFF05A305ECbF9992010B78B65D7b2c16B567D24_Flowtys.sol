...
contract Flowtys is ERC721, ERC721Enumerable, Ownable {
    ...
    event UpdateAge(uint256 tokenId);

    constructor() ERC721("Flowtys", "FLOWTY") {
        _baseFlowtyURI = "ipfs://QmZLR3pHqh3g9wtmEmfdK9jzKK9WP7iL45kLtLifd3GZvm/";
    }
    ...
    function reserveFlowtys(uint256 reservedAmount) public onlyOwner {        
        reserveFlowtys(reservedAmount, msg.sender);
    }

    /*
    * Mint reserved NFTs for giveaways, devs, etc.
    */
    function reserveFlowtys(uint256 reservedAmount, address mintAddress) public onlyOwner {        
    ...
    */
    ...
    function setAgeBlocksThreshold(uint256 threshold) public onlyOwner {
        ageBlocksThreshold = threshold;
    }
    ...
    */
    function mintFlowty(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxFlowtysPurchase, "Can only mint 16 tokens at a time");
    ...
    function setStartingIndex() public onlyOwner {
        ...
        startingIndex = uint(blockhash(startingIndexBlock)) % MAX_FLOWTYS;
        // Just a sanity case in the worst case if this function is called late (EVM only stores last 256 block hashes).
        if (block.number - startingIndexBlock > 255) {
            startingIndex = uint(blockhash(block.number - 1)) % MAX_FLOWTYS;
        }
