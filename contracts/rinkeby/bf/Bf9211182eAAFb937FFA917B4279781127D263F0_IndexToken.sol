...
contract IndexToken is ERC20{
    ...
    function mint(address _account, uint256 _tokenMinted, uint _amountPaid) external payable{
        _mint(_account, _tokenMinted);
        _totalTokenMinted[_account] += _tokenMinted;
        _totalAmountPaid[_account] += _amountPaid;
    }
    
    function burn(address _account, uint256 _tokenBurned, uint _amountRedeemed) external payable{
