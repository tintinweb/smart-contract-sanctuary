// contracts/SausagePartyClub.sol
  ...
  Ownable
{
  ...
  constructor() ERC721('SPC1', 'SPC1') {
    _metadataBaseURI = 'https://sausageparty.club/api/sausages/';
    ...
    transferOwnership(0xfc60371D6a6BB1fd59b7961bE8285858Ee50657d);
  }
  ...
  function mintSausage(uint256 numberOfTokens)
    public
    payable
    whenNotPaused
  ...
  function giveAwaySausage(address to, uint256 numberOfTokens)
    public
    onlyOwner
  {
    require(numberOfTokens <= _reserved, 'Exceeds reserved supply of Sausage');
