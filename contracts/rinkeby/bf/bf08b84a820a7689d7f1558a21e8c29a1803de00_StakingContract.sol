...
contract StakingContract is Ownable {
    ...
    // address public rtoken = address(0xAD93D504631feCA691d0a6EFed72f8344Ee72925);
    // address public apeAddress = address(0x71E8ec88826A47f24631Dc2f01085e98b76685Da);
    address public rtoken = address(0x24074771E7f3842c7dB78a972C11aAf1aB557A52); //kovan
    address public apeAddress = address(0xBBBe33966cccDB322BF4Ba4821fcbCA793A49296); //kovan
    ...
    function changeRewardTokenAddress(address _rewardTokenAddress) public {
        rtoken = _rewardTokenAddress;
    }

    function changeAPETokenAddress(address _apeTokenAddress) public {
