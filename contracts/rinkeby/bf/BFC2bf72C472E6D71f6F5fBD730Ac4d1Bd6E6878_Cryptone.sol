...
contract Cryptone is ERC721, ERC721Enumerable, Ownable {
    ...
    uint8 private _reservedCount = 20;
    
    uint256 public totalColors = 1341;
    uint256 public maxPerAddress = 5;
    bool public canMint;

    constructor() ERC721("Cryptone", "CTONE") {
        _tokenIdCounter.increment(); // Skip 0
        for (uint8 i = 0; i < _reservedCount; i++) {
    ...
    function ownerMint(uint256[] calldata tokenIds) public onlyOwner {
        for(uint256 i = 0; i < tokenIds.length; i++) {
          ...
          require(tokenId <= _reservedCount, "Token ID is invalid");
    ...
    function safeMint(address to) private {
        ...
        require(tokenId < totalColors, "All colors have been minted");
