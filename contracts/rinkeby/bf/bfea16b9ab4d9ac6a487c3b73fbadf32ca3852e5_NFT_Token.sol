...
contract NFT_Token is ERC721Enumerable, Ownable {
    ...
    uint256 public preCost = 1 ether;  
    ...
    function mint(uint256 _mintAmount) public payable{ 
        ...
        if(saleState == 1){   //presale
            ...
            require(currentSupply + _mintAmount <= maxPreSupply, "NFTs sold out"); 
            require(msg.value >= preCost * _mintAmount, "Not enough ether to mint"); 
        }  
        if(saleState == 2){   //public
            require(_mintAmount <= maxPublicMintAmount, "Exceded Mint Amount"); 
            require(currentSupply + _mintAmount <= maxPublicSupply, "NFTs sold out"); 
