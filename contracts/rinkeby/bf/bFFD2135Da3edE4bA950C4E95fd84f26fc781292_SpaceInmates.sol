...
contract SpaceInmates is ERC721Enumerable, Ownable, ISpaceInmates, ISpaceInmatesMetaData {
    ...
    uint256 public constant INMATES_RESERVED = 99;
    uint256 public constant INMATES_PUBLIC = 9900;
    ...
    function reserve(address[] calldata to) external override onlyOwner {
        require(totalSupply() < INMATES_MAX, "All tokens have been minted");
        require(totalReservedSupply + to.length <= INMATES_RESERVED,"Not enough tokens left to reserve"
        );
    ...
    function withdraw() external override onlyOwner {
        ...
        //uint256 payForTeam = balance * 0.1;
        //uint256 payForCommunityWallet = balance * 0.6;
        //address communityWallet = ;
        //address[] teamWallets =  [0x36eaf79c12e96a3dc6f53426c, 0xf235aa56dd96bda02acfb361e];
