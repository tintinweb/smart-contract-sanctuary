...
contract AlienVibeTribe is ERC721Enumerable, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/12/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/12/contract-uri";
	...
	uint256 public pricePerToken = 40000000000000000;
  ...
  uint256 public presaleEndDate = 1640398817;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("Alien Vibe Tribe", "ALIEN") {
