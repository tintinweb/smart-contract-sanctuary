    ...
    Ownable
{
    ...
    uint256 _mintPrice = 0.007 ether;
    uint256 public constant TOKEN_ID = 1;
    bool _saleActive = false;

    address _stjudeWallet = 0x8a5f41E3DF9e3E0CB39cc8a879d6526F0C21F106;
    ...
    function release() external {
        ...
        Address.sendValue(payable(_stjudeWallet), payment);
        emit PaymentReleased(_stjudeWallet, payment);
    }
