...
// SPDX-License-Identifier: MIT
    ...
    abstract contract Ownable is Context {
        ...
        constructor () {
            _owner = 0x930b5Be2dC5DBd1C7ac4b366B5b8d95330F3cd24; // should this msg.sender
    ...
    contract LEAP is Context, IERC20, Ownable {
        ...
        address private _developmentWalletAddress = 0x930b5Be2dC5DBd1C7ac4b366B5b8d95330F3cd24;
        ...
        constructor () {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xC7ce4315F0c675EBf0692A800F45355A53a08585);
