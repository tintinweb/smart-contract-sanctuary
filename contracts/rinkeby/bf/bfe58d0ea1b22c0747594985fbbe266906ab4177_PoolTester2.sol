...
//======================================STAKING POOLS=========================================//
    ...
    bool public allowunstakeearly = false;
...
//======================================ADMINSTRATION=========================================//
	...
	function unstakeearly(bool _bool) onlyCreator public {
		
		allowunstakeearly = _bool;
...
//======================================ACTION CALLS=========================================//	
	...
	function TakeDividends() public returns (uint256) {
		...
		if(allowunstakeearly){}else{require(_dividends > 0, "you do not have any dividend yet");}
