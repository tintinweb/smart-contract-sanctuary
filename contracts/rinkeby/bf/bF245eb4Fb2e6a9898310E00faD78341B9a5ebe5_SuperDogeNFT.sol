    ...
    ReentrancyGuard
{
    ...
    uint256[] public rookieCardClaims;
    ...
    function rookieCardMint(uint256 rookieCardId) public nonReentrant {
        ...
        require(rookieCardClaims[rookieCardId] == 0, "SuperDogeNFT: Free SuperDogeNFT already claimed for specified Rookie Card.");

        _safeMint(msg.sender, s + 1, "");
        rookieCardClaims[rookieCardId] = 1;
