...
contract Metamaticians is
    ...
    */
        ...
        nonReentrant
    {
        ...
        uint256 amountOut = fee * _quantity;
    ...
    function contractURI() public view returns (string memory) {
        ...
        console.log("ADDRESS TO STRING: ", addressToString(owner));
        console.log("ADDRESS TO STRING BYTES: ", string(bytes(addressToString(owner))));
        console.log("LENGTH OF ADDRESS: ", bytes(string(bytes(addressToString(owner)))).length);
