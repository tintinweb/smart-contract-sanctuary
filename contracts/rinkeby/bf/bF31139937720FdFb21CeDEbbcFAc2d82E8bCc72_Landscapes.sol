...
contract Landscapes is Proxy {
    ...
    constructor(address signingAddress) {
        ...
        Address.functionDelegateCall(
            ...
            abi.encodeWithSignature("initialize(address,uint16,uint256,uint16,uint16,address)", 0x6390EF330e04BdefFB329395604A2d7AD7bD650d, 1000, 500000000000000000, 2, 0, signingAddress)
        );
    }
