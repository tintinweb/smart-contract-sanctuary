...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        kash.transfer(address(this), kashReward);
...
abstract contract Kash is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint256 public _maxTxAmount = 50000000 * 10**6 * 10**9; // 5%
    ...
    constructor () public {
        ...
        _isIncludedInFee[owner()] = false;
        _isIncludedInFee[address(this)] = false;
