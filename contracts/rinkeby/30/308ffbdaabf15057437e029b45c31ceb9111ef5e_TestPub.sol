...
contract TestPub is Ownable
{
	...
	uint256 price1 = 0.025 ether;
	uint256 price2 = 0.050 ether;
	uint256 price3 = 0.075 ether;
    ...
    uint256 public totalDogsCreated=0;
	uint256 public totalFreeDogsCreated=0;
   ...
   { 
	...
	function setMintPrice(uint256 p1, uint256 p2,uint256 p3) public onlyOwner returns (bool) 
    {		
        price1=p1;
		price2=p2;
		price3=p3;
