...
contract TempestPlot is TempestPlotERC721 {


    IFCore public FCore;

    constructor(string memory name, string memory symbol, uint256 supply, uint256 genCount) TempestPlotERC721(name, symbol, supply, genCount) {}
...
contract TempestPlotERC721 is ERC721Enumerable, Ownable {
