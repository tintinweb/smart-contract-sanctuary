...
import "../../token/ERC20/ERC20MintPause.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20MintPause is ContractOwnable, IMasterERC20 {
  ERC20MintPause[] private childERC20MintPause;
  ...
  function createERC20(
    ...
    ERC20MintPause child = new ERC20MintPause(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20MintPause.push(child);
...
contract ERC20MintPause is ERC20 {
