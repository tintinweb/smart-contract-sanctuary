...
contract DystoPunks is  Ownable, ERC721Enumerable {
   ...
   function getTestPunk(uint256 numDystoPunks) public payable {
        require(totalSupply() < MAX_SPUNKS, "Sale has already ended");
    ...
    function reserveGiveaway(uint256 numDystoPunks) public onlyOwner {
        uint currentSupply = totalSupply();
        require(totalSupply() + numDystoPunks <= 130, "Exceeded giveaway supply");
