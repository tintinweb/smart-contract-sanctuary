...
contract ENSToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    uint256 public constant AIRDROP_AMOUNT = 1000000;
    ...
    function setWrapperAddress(address _wrapperAddress) external onlyOwner {
        require(wrapperAddress == address(0), "ENS: Already set");
        require(_wrapperAddress != address(0), "ENS: Invalid registry");
    ...
    function registerAirdrop(address _user) external {
        require(msg.sender == wrapperAddress, "ENS: Auth restricted");
        userToClaim[_user] = AIRDROP_AMOUNT;
    }
