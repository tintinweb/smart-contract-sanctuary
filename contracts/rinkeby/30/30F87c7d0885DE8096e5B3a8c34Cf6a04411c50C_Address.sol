...
contract NFTEyeballs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Eyeballs-NFTs", "EYES") {
    setHiddenMetadataUri("ipfs://QmRtfDVaqFM7XBVhNkxA7TZdKxEZzoA7p8n1SnowpnoiPm/_metadata.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x0dc3915e54372B595684ca1c97b834E1f5CA7094).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
