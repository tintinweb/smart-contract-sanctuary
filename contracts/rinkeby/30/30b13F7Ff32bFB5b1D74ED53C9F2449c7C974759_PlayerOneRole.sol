...
contract PlayerOneRole is ERC721Enumerable, Ownable {
    uint256 public MAX_ELEMENTS = 20000;
    uint256 public expiresTime = 30 minutes;

    mapping(uint256 => string) internal contentURIs;

    constructor() ERC721("PlayerOne Role", "POR") {}
    ...
    function mint(
        ...
        require(totalSupply() + 1 <= MAX_ELEMENTS, "Max limit");
        ...
        require(
            block.timestamp < _timestamp + expiresTime,
    ...
    function updateMaxElements(uint256 num) public onlyOwner {
        MAX_ELEMENTS = num;
    }

    function updateExpiresTime(uint256 num) public onlyOwner {
        expiresTime = num;
    }
