...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
    ...
    function getUserScore(address account) public view returns (uint256) {
        ...
        uint256 amountScore = daysSinceLastWithdrawal >= 30 ? stakeDeposit.amount : stakeDeposit.amount.mul(daysSinceLastWithdrawal).div(30);
        uint256 amount = stakeDeposit.amount.div(10**18);
