...
contract TestTokenTest is ERC721Enumerable, Ownable {
  uint public constant MAX_TOKFD = 10001;
  uint _reserved = 400;
  string _baseTokenURI = "https://test.test.com/meta/";
  bool public isActive = false;

  constructor(address _to, uint _count) ERC721("ETestTokenTest", "EDTOKFDD")  {
  ...
  function mintKokeshi(address _to, uint _count) public payable {
    ...
    require(totalSupply() < MAX_TOKFD, "Sale end");
    require(totalSupply() + _count <= MAX_TOKFD, "Max limit");
