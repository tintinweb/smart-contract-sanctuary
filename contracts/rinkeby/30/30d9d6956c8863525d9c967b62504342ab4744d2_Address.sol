...
contract cryptobatto is ERC721, Ownable {
  using Strings for uint256;
...
//bool public revealed = false;
  ...
  constructor() ERC721("cryptobatto", "cb") {
    setHiddenMetadataUri("ipfs://QmdAoX95N47FoVdAfaTJnVpqFWWy84P1FEnJBGgyug1gXi/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x6f776dAFa5Ac625a10FEdEA7cE76AE5f4e4B21Cb).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
