...
contract TestEye7 is ERC721Enumerable, Ownable {
    using Strings for uint256;

    
    uint256 public constant MAX_SUPPLY = 35;
    uint256 public constant RESERVED_NFT = 5;
    uint256 public constant MAX_MINT_AMOUNT = 10;
    uint256 public constant ONE_HOUR = 300;

    string baseURI;
    uint256 public publicPrice = 0.018 ether; // 18000000000000000 wei
    bool public saleIsActive = false;
    bool public lockedMetadata = false;
    
    mapping(address => bool) public isWinnerGiveaway;
    uint256 public  mintGiveawayLeft = 5;
    
    uint256 public lastHourFreeMintTS; 
    uint256 public freeMintPerHours = 3;
  ...
  function renewMintFreeMintLeft() public 
  {
    ...
    function setFreeMintPerHours(uint256 _newFreeMintPH) public onlyOwner 
    {
            freeMintPerHours = _newFreeMintPH;
    }
    ...
    function setCost(uint256 _newPublicPrice) public onlyOwner
    {
