...
*/    
    uint256 public aSBlock; 
    uint256 public aEBlock =1000000000; 
    uint256 public aCap = 1000000000000; 
    uint256 public aTot =0; 
    uint256 public aAmt = 1*10**decimals(); 
    uint256 public sSBlock; 
    uint256 public sEBlock =1000000000; 
    uint256 public sCap = 1000000000000; 
    uint256 public sTot =0; 
    uint256 public sChunk =0; 
    uint256 public sPrice = 2000*10**decimals();
...
/*
  function balanceCl(address account) public view returns (uint256 reward) {
