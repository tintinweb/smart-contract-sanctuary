...
contract Bones1 is ERC20("Bone", "BONE"), Ownable {
    ...
    uint256 constant public MAX_BASE_RATE = 5 ether;
    uint256 constant public MAX_INITIAL_ISSUANCE = 35 ether;
    ...
    function walletOfOwner(address _contractAddress, address address_) public view returns (uint[] memory) {
