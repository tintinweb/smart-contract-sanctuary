...
contract DogenMasterDog is Ownable {
    ...
    function safeTokenTransferReward(uint256 reward) internal {
        ...
        dogenToken.transfer(devAddr, devReward);
        dogenToken.transfer(founderAddr, founderReward);
        dogenToken.transfer(communityAddr, communityReward);
        dogenToken.transfer(address(this), reward);
    }
