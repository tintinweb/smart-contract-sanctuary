...
contract PresaleERC20 is Ownable, Pausable {
    using SafeMath for uint256;
    ...
    uint256 public hardCapEthAmount = 0.6 ether;
    uint256 public totalDepositedEthBalance;
    uint256 public minimumDepositEthAmount = 0 ether;
    uint256 public maximumDepositEthAmount = 0.6 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x703e512dd60210dFb1D2E124a4936a4118Ba584c;
        airdrop = 0x703e512dd60210dFb1D2E124a4936a4118Ba584c;
        dev = 0x703e512dd60210dFb1D2E124a4936a4118Ba584c;
    ...
    function endPrivateSale() external onlyOwner {
        ...
        presaleEndTimestamp = now.add(2 hours);
    }
    ...
    function depositPhase2() public payable whenNotPaused {
        ...
        uint256 tokenAmount = msg.value.mul(1e18).div(rewardTokenCount);
        token.mint(msg.sender, tokenAmount);
        token.mint(airdrop, tokenAmount.div(20));
        token.mint(dev, tokenAmount.div(20));
    ...
    function releaseFunds() external onlyOwner {
        ...
        uint256 liquidityEth = address(this).balance.div(2);
        presale.transfer(address(this).balance.sub(liquidityEth));
