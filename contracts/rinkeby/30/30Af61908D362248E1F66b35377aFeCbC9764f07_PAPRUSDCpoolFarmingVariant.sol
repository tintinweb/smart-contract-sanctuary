...
contract PAPRUSDCpoolFarmingVariant is Ownable, ReentrancyGuard {
    ...
    address public constant trustedDepositTokenAddress = 0xB801341a5008F4195e6Ca646354f0aeCEC34B75C;
    // Earned Tokens address : PRNTR
    address public constant trustedRewardTokenAddress = 0xB7F7644f999D34fB58cE91b3dBc26B0Bf7081337;
    address public constant prntrLPAddress = 0x3fD5D987eee6b6d5E590835DA55a12cf5658307d;
    ...
    // Amount of tokens
    uint public constant disburseAmount = 60000e18;
    ...
    (uint256 reserve0, uint256 reserve1,) = IUniswapV2Pair(prntrLPAddress).getReserves();
