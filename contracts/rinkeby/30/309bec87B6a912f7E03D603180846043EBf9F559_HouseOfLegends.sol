...
contract HouseOfLegends is ERC721Enumerable, Ownable {
    ...
    address public constant creator1Address =
        0x28509491A0fD240431fa3d1cAADbF5Ff712745AF;

    // Minting Variables
    uint256 public maxSupply = 9993;
    uint256 public maxPrivateSupply = 238;
    uint256 public maxGiftSupply = 60;
    uint256 public maxPublicSupply =
        maxSupply - maxPrivateSupply - maxGiftSupply; //9,695
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(creator1Address, balance.div(3));
