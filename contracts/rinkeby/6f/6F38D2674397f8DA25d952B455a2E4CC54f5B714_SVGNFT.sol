...
contract SVGNFT is ERC721URIStorage {
    ...
    event CreatedSVGNFT(uint256 tokenId, string tokenURI);
    ...
    function formatTokenURI(string memory _imageURI) public pure returns (string memory) {
        ...
        string memory tokenURI = Base64.encode(bytes(string(abi.encodePacked('{"name": "SVG NFT", "description": "TEST", "attributes": "", "image": "', _imageURI, '"}'))));

        return string(abi.encodePacked(baseURL, tokenURI));
    }
}
