...
contract Tiger is ERC1155 {
    ...
    // id => creators
    mapping (uint256 => uint256) public total_supplies;

    // Contract name
    string public name = "Tiger";
    // Contract symbol
    ...
    function create(uint256 _initialSupply, string calldata _uri) external returns(uint256 _id) {
        ...
        total_supplies[_id] = _initialSupply;
    ...
    function burn(uint256 _id, uint256 _value) external {
        require(balances[_id][msg.sender] >= _value, "Sender balance must be not less than _value.");
