    ...
    Ownable
{
    ...
    uint256 public presale_Startdate = 1641670070; //
    uint256 public presale_Enddate = 1642793270; // 
    bool public end_presale = false;
    
    uint256 public NFT_price = 0.039 ether; 
    uint256 public NFT_price_for_3 = 0.099 ether; 

    uint256 public startTime = 1642793271; // 
    string _name = "SpaceDucksNFT2";
    string _symbol = "SPD2";
    ...
    uint256 public reveal_time = 1641843336; // 
