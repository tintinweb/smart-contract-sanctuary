...
contract NeandNation is ERC721, Pausable, Ownable {
    ...
    address public constant CONTRACT_DEVELOPER_ADDRESS = 0x731885B6fc5F7dd9Ad82b5B1bdc5c09187bA6bc5;
    address public constant OWNER_ADDRESS = 0x731885B6fc5F7dd9Ad82b5B1bdc5c09187bA6bc5; // OWNER ADDRESS
    ...
    string IMAGE_URL = "https://gateway.pinata.cloud/ipfs/Qme6z9qRYjfy9v9PNEUj4FQqrom4eRjSMS9KMRBF1YnQkC/";
    ...
    constructor() ERC721("ContractTesting", "YY") {}
    ...
    function unpause() public onlyOwner {
      ...
      /**
     * @dev Get minted tokens by address
     */
     function getTokensMintedAtPresale(address account) external view  returns(uint256) {
      ...
      /**
     * @dev Set Pre Sale Mint Limit
     */
      function setMaxTokenMintedByAddress(uint256 _amount) external onlyOwner{
        MAX_TOKENS_MINTED_BY_ADDRESS_PRESALE = _amount;
    }
    ...
    function preSaleMint(uint256 numberOfTokens) payable external  {
    ...
    function publicSaleMint(uint256 numberOfTokens) payable external  {
