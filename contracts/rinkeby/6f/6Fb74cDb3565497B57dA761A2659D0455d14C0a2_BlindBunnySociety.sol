...
contract BlindBunnySociety is ERC721, Ownable {
    ...
    address private ownerAddr = 0xD052a3CcBa6675B336b5dEca281Fb44a66F10f8c;
    
    mapping(address => bool) public presalerList;
    mapping(address => uint256) public presalerListPurchases;
    
    constructor() ERC721("BlindBunnySociety", "BBS") {
    ...
    function mintPresale(uint256 numberOfTokens) external payable {
        ...
        require(presalerList[msg.sender], "Address not in Whitelit");
