...
contract Nornir is ERC721, VRFConsumerBase {
	...
	struct Viking {
		uint256[2] speed; // Boots
		uint256 stamina; // Bottoms
		uint256 intelligence; // Hat
		uint256 defense; // Sheild
	...
	function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
		...
		vikings.push(
			Viking(
				[(randomNumber % 100),(randomNumber % 10000) / 100],
				((randomNumber % 10000) / 100), // stamina
				((randomNumber % 1000000) / 10000), // intelligence
				((randomNumber % 100000000) / 1000000), // defense
				((randomNumber % 10000000000) / 100000000), // attack
				[(randomNumber % 100)],
				((randomNumber % 100000000000000) / 1000000000000), // face
				((randomNumber % 10000000000000000) / 100000000000000), // beard
				((randomNumber % 1000000000000000000) / 10000000000000000), // top
