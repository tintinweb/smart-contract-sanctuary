...
contract HomeFi is IHomeFi, ERC721, Initializable {
    ...
    function initialize(
        ...
        ETHER_CURRENCY = _etherCurrency;
        DAI_CURRENCY = _daiCurrency;
        USDC_CURRENCY = _usdcCurrency;
    }
    ...
    function setAddr(
        ...
        wrappedToken[ETHER_CURRENCY] = _hETHAddress;
        wrappedToken[DAI_CURRENCY] = _hDAIAddress;
        wrappedToken[USDC_CURRENCY] = _hUSDCAddress;
        addrSet = true;
    }
