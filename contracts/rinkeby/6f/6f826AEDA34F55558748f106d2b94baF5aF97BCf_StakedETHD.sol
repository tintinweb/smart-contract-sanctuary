...
/**
 * @dev Wrappers over Solidity's arithmetic oper1ations with added overflow
 * checks.
 *
...
contract StakedETHD is ERC20Permit, Ownable {
    ...
    constructor() ERC20("StakedTestETHD", "sETHD", 9) ERC20Permit() {
