...
contract Rainbow_RB_Protocol {
    ...
    */
    function depositCalculation(
        ...
        payUsdts = mulDiv(totalAssets,dataStatistics.licenseFees,10000);
        return payUsdts;
    }
    ...
    function deposit(
        ...
        {
            uint256 payUsdts = mulDiv(totalAssets,dataStatistics.licenseFees,10000);
...

        {
                ...
                require(user.tokenAmount == 0,"Go to settle .");
        }
