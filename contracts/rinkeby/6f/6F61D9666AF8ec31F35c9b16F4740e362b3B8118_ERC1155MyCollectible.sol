...
contract ERC1155 is Context, IERC1155, WhiteListed, ERC165 {
  ...
  mapping (address => mapping(uint256 => uint256)) internal balances;
    // Objects balances
  mapping (address => uint256) internal balancesERC20;
    ...
    internal
  {
    ...
    balancesERC20[_from]=balancesERC20[_from].sub(_amount);
    balancesERC20[_to]=balancesERC20[_to].add(_amount);
    // Emit event
    ...
    internal
  {
    ...
    for (uint256 i = 0; i < nTransfer; i++) {
      ...
      balancesERC20[_from]=balancesERC20[_from].sub(_amounts[i]);
      balancesERC20[_to]=balancesERC20[_to].add(_amounts[i]);
      emit Transfer(_from, _to,_amounts[i]);
    }
...
contract ERC1155MintBurn is ERC1155 {
    ...
    internal virtual
  {
    ...
    for (uint256 i = 0; i < nMint; i++) {
      ...
      _totalSupply += _amounts[i];
       emit Transfer(address(0x0), msg.sender,_amounts[i]);
    ...
    internal
  {
    ...
    for (uint256 i = 0; i < nBurn; i++) {
      ...
      balances[_from][_ids[i]] = balances[_from][_ids[i]].sub(_amounts[i]);
      _totalSupply -= _amounts[i];
      emit Transfer(_from, address(0x0),_amounts[i]);
    }
