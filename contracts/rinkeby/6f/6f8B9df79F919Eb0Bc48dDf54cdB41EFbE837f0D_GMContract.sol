...
contract GMContract is ERC721Enumerable, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        if (supply < 420) {
            ...
            output = string(abi.encodePacked(             // output is image
                    ...
                    color_options[colorIndex],                  // text color
