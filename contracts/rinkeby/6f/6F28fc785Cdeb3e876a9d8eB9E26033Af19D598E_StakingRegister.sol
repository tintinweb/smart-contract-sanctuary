...
contract StakingRegister is IStakingRegister, IStakingFactory, Managed, EIP712 {
    ...
    bytes32 private immutable _GENESIS_CONTAINER_TYPEHASE =
        keccak256(
    ...
    bytes32 private immutable _LIQUIDITY_MINING_CONTAINER_TYPEHASE =
        keccak256(
    ...
    function isOwner(address _owner, address _staking)
        ...
        returns (bool)
    {
        EnumerableSet.AddressSet storage set = _ownerStakes[_owner];
        return set.contains(_staking);
    }
    ...
    function setGenesisStakingImplementation(
        ...
        require(
            ...
            "GenesisStakeFactory: wrong staking implementation address"
        );
    ...
    function createGenesisStaking(
        ...
        bool isRegular = _hasPermission(_msgSender(), ROLE_REGULAR);
        require(
            isAdmin || isRegular,
        ...
        if (!isAdmin) {
            ...
            require(signer == factorySigner, "GenesisFactory: Invalid signer");
        }
    ...
    function remove(address _owner, address _stakingAddress)
        ...
        requirePermission(ROLE_ADMIN)
    {
        require(_stakes.remove(_stakingAddress), "Register: Not found");
        require(
            _ownerStakes[_owner].remove(_stakingAddress),
            "Register: Not found"
        );
    ...
    function _add(
        ...
        require(_stakes.add(_stakingAddress), "Register: Alreade exists");
        require(
            _ownerStakes[_owner].add(_stakingAddress),
