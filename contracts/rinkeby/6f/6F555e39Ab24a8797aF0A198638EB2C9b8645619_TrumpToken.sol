...
/**
 *Submitted for verification at hecoinfo.com on 2021-03-30
*/
...
contract TrumpToken is ERC20, Ownable {
  uint256  public preMineSupply = 2000000 * 1e9;
  ...
  function mintMine(address _to, uint256 _amount) external onlyMinter returns (bool){
    _mint(_to, _amount);
    _moveDelegates(address(0), _delegates[_to], _amount);
    return true;
  }
  ...
  internal
  {
    ...
    // balance of underlying TRUMPs (not scaled);
