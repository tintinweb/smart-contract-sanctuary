...
contract SoccerSol is ERC721, Ownable, ReentrancyGuard {
  ...
  // Mint Price
  uint256 public preSalePrice = 0.00048 ether; // presale price
  uint256 public publicSalePrice = 0.0006 ether; // publicsale price

  // BaseURI (real)
  string private realBaseURI =
    'https://gateway.pinata.cloud/ipfs/Qma287A4TL338E3Z89vKnktnEgwoJhvV1ekEQfKHEUegBr/';
