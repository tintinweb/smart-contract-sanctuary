...
contract Metagenesis is ERC721, Ownable {
    ...
    uint public airdropItems = 24;
    uint public preMintMaxItems = 1500;
    ...
    mapping(address => uint) public airdrops; // Maps address to how many they can premint
    ...
    function airdropMint() external payable {
        ...
        uint amount = 1;
        require(amount <= airdrops[msg.sender], "airdropMint: Amount greater than allocation");
