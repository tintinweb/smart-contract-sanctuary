...
interface ICollaborativePainting is IERC721Enumerable {
...
/**
 * @title CollaborativePainting contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract CollaborativePainting is Context, Ownable, ERC165, ICollaborativePainting, IERC721Metadata {
    ...
    uint256 public constant MIN_PRICE = 1; // in wei
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 97) {
            ...
            return MIN_PRICE*200;
        } else if (currentSupply >= 85) {
    ...
    */
    ...
    function mintPiece(uint256 numberOfNfts) public payable {
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
        require(numberOfNfts > 0, "numberOfNfts cannot be 0");
        require(numberOfNfts <= 1, "You may not buy more than 1 NFTs at once");
...
// contract CollaborativePainting is ERC721, Ownable {
...
//     // Mapping from token ID to whether the Hashmask was minted before reveal
//     mapping (uint256 => bool) private _mintedBeforeReveal;
//     mapping (address => EnumerableSet.UintSet) private _holderPieces;
//     EnumerableMap.UintToAddressMap private _tokenOwners;
...
//     constructor() public ERC721("CollaborativePainting", "CPNT") {
//     }
...
//     /**
//      * @dev Gets current Price of 1 piece
//      */
//     function getPiecePrice() public view returns (uint256) {
//         require(block.timestamp >= SALE_START_TIMESTAMP, "Sale has not started");
//         require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
...
//         require(numberOfNfts <= 1, "You may not buy more than 1 NFTs at once");
//         require(totalSupply().add(numberOfNfts) <= MAX_NFT_SUPPLY, "Exceeds MAX_NFT_SUPPLY");
//         require(getPiecePrice().mul(numberOfNfts) == msg.value, "Ether value sent is not correct");
...
//     */
//     function getHolderPieces(address user) public view returns (uint256[] memory){
//         return _holderPieces[user];
//     }

//     /**
//      * @dev chang {IERC721-ownerOf}.
//      */
//     function ownerOf(uint256 tokenId) public view override returns (address) {
//         return _tokenOwners.get(tokenId, "ERC721: owner query for nonexistent token");
//     }
...
//     /**
//      * @dev change {IERC721Enumerable-totalSupply}.
//      */
//     function totalSupply() public view override returns (uint256) {
//         // _tokenOwners are indexed by tokenIds, so .length() returns the number of tokenIds
//         return _tokenOwners.length();
...
//     /**
//     * @dev Override _mint to save all nfts of owner
//     */
//     function _mint(address to, uint256 tokenId) internal virtual {
//         require(to != address(0), "ERC721: mint to the zero address");
//         require(!_exists(tokenId), "ERC721: token already minted");
//         _beforeTokenTransfer(address(0), to, tokenId);
//         _holderPieces[to].add(tokenId);
//         _owners[tokenId] = to;
//         emit Transfer(address(0), to, tokenId);
//     }
...
//     /**
//      * @dev change {IERC721-balanceOf}.
//      */
//     function balanceOf(address owner) public view virtual override returns (uint256) {
//         require(owner != address(0), "ERC721: balance query for the zero address");
//         return _holderPieces[owner].length();
//     }

//         /**
//      * @dev changee {IERC721Enumerable-tokenOfOwnerByIndex}.
//      */
//     function tokenOfOwnerByIndex(address owner, uint256 index) public view override returns (uint256) {
//         return _holderPieces[owner].at(index);
//     }
...
//         // Clear approvals
//         _approve(address(0), tokenId);
//         _holderPieces[owner].remove(tokenId);
//         _tokenOwners.remove(tokenId);
//         emit Transfer(owner, address(0), tokenId);
//     }
