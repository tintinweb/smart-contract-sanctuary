...
contract LiquidityProtection is ILiquidityProtection, Utils, Owned, ReentrancyGuard, Time {
    ...
    function getViewData(uint256 id) public view returns(ProtectedLiquidity memory, PackedRates memory, uint256, Fraction memory, Fraction memory, Fraction memory) {
    ...
    function getViewData1(uint256 id) public view returns(ProtectedLiquidity memory) {
        ProtectedLiquidity memory liquidity = protectedLiquidity(id, msg.sender);
        return liquidity;
    }

    function getViewData2(uint256 id) public view returns(PackedRates memory) {
        ProtectedLiquidity memory liquidity = getViewData1(id);
        PackedRates memory packedRates =
            packRates(
                liquidity.poolToken,
                liquidity.reserveToken,
    ...
    function getViewData3(uint256 id) public view returns(uint256) {
        ProtectedLiquidity memory liquidity = getViewData1(id);
        PackedRates memory packedRates = getViewData2(id);
        uint256 targetAmount =
            removeLiquidityTargetAmount(
                liquidity.poolToken,
                liquidity.reserveToken,
    ...
    function getViewData4(uint256 id) public view returns(Fraction memory) {
        ProtectedLiquidity memory liquidity = getViewData1(id);
        PackedRates memory packedRates = getViewData2(id);
    ...
    function getViewData5(uint256 id) public view returns(Fraction memory) {
        ProtectedLiquidity memory liquidity = getViewData1(id);
        PackedRates memory packedRates = getViewData2(id);
    ...
    function getViewData6(uint256 id) public view returns(Fraction memory) {
        ProtectedLiquidity memory liquidity = getViewData1(id);
        Fraction memory poolRate = poolTokenRate(liquidity.poolToken, liquidity.reserveToken);
        return poolRate;
    }
