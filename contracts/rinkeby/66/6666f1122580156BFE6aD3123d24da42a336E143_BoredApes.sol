...
contract BoredApes is ERC721Enumerable, Ownable {
    ...
    uint256 public apesPrice = 1 * 10 ** 18;
    ...
    constructor() ERC721("BoredApes", "BAP") {
        revealed = true;
        saleOpen = true;
        baseURI = 'https://ipfs.io/ipfs/QmPFSY2g7VNMpPtxcU1iavxwBnAdsmbhQJEwy56h1vTyH2/';
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(msg.value >= apesPrice * _mintAmount, "Must send proper eth value to mint");
        }
