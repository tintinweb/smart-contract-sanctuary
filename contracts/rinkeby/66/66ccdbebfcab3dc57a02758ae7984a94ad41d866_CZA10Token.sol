...
contract CZA10Token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD835a242D9Da0bAa65D60aF1494eca4F6d1a0d38); // Marketing Address
    ...
    string private _name = "CoinZero.Alpha10";
    string private _symbol = "CZA10";
