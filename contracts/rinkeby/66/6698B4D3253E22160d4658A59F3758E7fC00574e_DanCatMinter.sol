...
contract DanCatMinter is ERC721Enumerable, Ownable {
    ...
    // Allows for the early reservation of 100 tokens from the creators for promotional usage
    function reserveByOwner(uint256 _count) public onlyOwner {
        uint256 totalSupply = totalSupply();
        require(
            totalSupply + _count < 101,
            "Owner can only reserve max 1% of tokens"
        );
