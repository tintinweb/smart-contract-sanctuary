...
//TODO: remove before final deployement
...
contract Jigsaw1 is ERC721Enumerable, Ownable {
    ...
    //TODO: remove sale timestamp and other if required.
    // 5min and 10 min are for testing purpose only.
    constructor() ERC721('Bored Puzzles Jigsaw1', 'BPJ1') {
        editable = true;
        privateSaleBegin = block.timestamp + 2 minutes;
        fiatSaleBegin = block.timestamp + 3 minutes;
        publicSaleBegin = block.timestamp + 5 minutes;
    }
    ...
    function endGame() external onlyOwner {
        ...
        //TODO: transfer final jigsaw nft to winner
    ...
    //TODO: testing util method: remove this function before mainent deployement
    ...
    */
    ...
    function claimCommunity(
        ...
        console.log('isClaimedCommunity :', isClaimedCommunity[_account]);
        require(endedAt > 0, 'ER: Game is not ended yet');
        ...
        //TODO: transfer final jigsaw nft to winner
        // mintFinalPicture(_account);
    }


    //TODO: make it internal, instead of public, before final deployement
    /**
