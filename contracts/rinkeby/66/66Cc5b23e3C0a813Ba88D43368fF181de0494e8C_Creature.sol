...
contract Creature is ERC721Tradable{
    ...
    {   
        ...
        test = new RobinToken();// it looks like it doesn't get the addr

        // it looks like it will run out of gas?
        //newContract = address(new RobinToken());
        //test = newContract(newContract);
