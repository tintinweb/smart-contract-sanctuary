...
contract CollectionContract is Initializable, ERC721EnumerableUpgradeable {
    ...
    uint256                  public           priceInWeiWhitelist;
    ...
    function initialize(
        ...
        require(_msgSender() == address(collectionFactory), "CollectionContract: Proxy must be created via the factory");
    ...
    function whitelistClaim(uint256 count) public payable {
        require(!paused, "Contract is paused.");
        require(whitelistActive, "Whitelist claiming is not active yet.");
        ...
        require(count * priceInWeiWhitelist == msg.value, "Invalid funds provided.");
    ...
    function mint(uint256 count) public payable {
        require(!paused, "Contract is paused.");
        require(!whitelistActive, "Public sale is not active yet.");
    ...
    function setWhitelist(uint256 _priceInWeiWhitelite, address[] calldata _addresses) public onlyOwner {
        delete whitelist;
        whitelist = _addresses;
        priceInWeiWhitelist = _priceInWeiWhitelite;
