...
contract ARTHAUS is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
   ...
   string public ARTWORK_CREDITS = "Nicholas Keays";
   string public OWNER = "Bitlabs Pte. Ltd.";
   uint256 public MAX_SUPPLY = 1000;
    ...
    function safeMint(uint numberOfTokens) public onlyOwner {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeichvjjbm5zgjgybftkrq3lt6givi326gxn2egi5ligabqsv7ckymy/?filename=metadata.json";
    }
