...
contract ConcaveM is ERC721Enumerable, Pausable, Ownable {
    ...
    function mintMany(uint256 _mintAmount) external payable whenNotPaused {
        ...
        //require(!_isSoldOut(_totalSupply), "sold out"); Wouldnt delet isSouldOut though, could be used for front end porpuse. 
    ...
    function withdraw() public payable onlyOwner {
        ...
        payable(0xb9Ac54502Bd6B0789ed007D06245100778C6b1b4).transfer(address(this).balance);
    }
