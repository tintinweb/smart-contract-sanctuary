...
contract MxtterAuctionManager is Ownable, ERC721Holder {
    ...
    IMxtterToken public mxtterToken; // todo setter
    IAuctionHouse public auctionHouse; // todo setter

    string public preGenerativeURI; // todo setter
    uint256 public duration; // todo setter
    uint256 public reservePrice; // todo setter
    ...
    constructor(
        ...
        mxtterToken.setApprovalForAll(address(auctionHouse), true); // todo add this when updating zora auction house address
    }
    ...
    function newAuction() external onlyOwner {
        ...
        auctionHouse.createBid(auctionId, reservePrice);
