...
contract PublicSale is IPublicSale, Ownable {
    ...
    uint256 public constant PRE_SALE_DELAY = 1 hours;
    uint256 public constant LP_CREATION_DELAY = 1 hours;
    ...
    uint256 public constant MAX_DEPOSIT_ETH_AMOUNT = 0.2 ether;
...
contract LiquidityProvider is ILiquidityProvider, Ownable {
    ...
    function recoverERC20(address lpTokenAddress, address receiver) public override onlyOwner {
        ...
        require(block.timestamp >= lock.add(1 hours), 'recoverERC20: You can claim LP tokens after 12 weeks!');
