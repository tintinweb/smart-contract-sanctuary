    ...
    Ownable
{
    ...
    uint256 public Startdate = 1634020524; // Oct 15, 16:00:00 UTC - 1634306400
    uint256 public Enddate = 1636696646; // Oct 16, 16:00:00 UTC - 1634392800

    string _name = "SpaceAliensNFT";
    string _symbol = "SANFT";
    
    address SB_address = 0x8503f4AD5a808b4CfE810d5E5A8c3193BdADfB5A; // testnet SB address 
  ...
  function withdraw() external onlyOwner {
    ...
    function tokenURI(uint256 _tokenId)
        ...
        returns (string memory)
    {
        string memory waiting_url = "https://gateway.pinata.cloud/ipfs/QmS6wFpvTh8mMV6tmatjssz5ysp7rqCJ52ahxdmrzWENS6";
