...
contract BNBMiner{
    ...
    uint256 public EGGS_TO_HATCH_1MINERS=10368000;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x0871f1C4434D1de8cAf3F73ab39b30b46cD4FC1a);
    }
