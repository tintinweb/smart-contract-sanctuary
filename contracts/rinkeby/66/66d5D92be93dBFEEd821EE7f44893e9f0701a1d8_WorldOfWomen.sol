...
contract WorldOfWomen is ERC721, ERC721Enumerable, Ownable, Clubs {
    ...
    // Defines addresses of the team
    // TO CHANGE BEFORE DEPLOY
    address t1 = 0xf6Ecb785abc70db336614a67ABFB127d1D5C5C7d;
    address t2 = 0x19379CB7591A866EF984D4264D94C16d4bE0db78;
    ...
    // This should be set before any minting.
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        WOW_PROVENANCE = provenanceHash;
    }

    // Helper to list all the WoW of a wallet
    ...
    // Inspired by Hashmasks & BAYC
    function setStartingIndex() public {
        require(startingIndex == 0, "Starting index is already set");

        startingIndex = uint(blockhash(block.number)) % maxSupply;
...
contract Clubs is Ownable {
    ...
    function addClubToken(uint256 id, uint256 _tokenId) external onlyOwner clubExist(id) {
        ...
        for (uint256 i = 0; i < arrayClubs[id].tokens.length; i++) {
