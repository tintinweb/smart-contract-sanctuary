...
contract b2dClub is ERC721Enumerable, Ownable {
  ...
  function withdraw() public payable onlyOwner {
    ...
    // This will pay dev 10% of the initial sale.after the 45 days Hold
    // =============================================================================
    (bool hs, ) = payable(0xe36410a9E0B5e4E0F8839FE261cf2dEab37254f5).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
    // This will payout the designer 10% of the contract balance. after the 45 days Hold
    (bool d, ) = payable(0x214702EDC75711CF6a378A04598Da5477FCdfB1F).call{value: address(this).balance * 10 / 100}("");
    require(d);
    // This will payout the owner 80% of the contract balance. after the 45 days Hold
    // =============================================================================
