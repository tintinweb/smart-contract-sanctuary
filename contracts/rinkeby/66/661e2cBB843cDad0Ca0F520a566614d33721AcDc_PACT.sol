...
contract PACT is IDelegableERC20, DelegableToken, Ownable
{
    ...
    constructor() ERC20("P2PB2B community token", "PACT", 1000000000e18) public {}


    uint256 AmountReserve           = 50000000e18;
    uint256 AmountTeam              = 50000000e18;
    uint256 AmountP2PB2B            = 50000000e18;
    uint256 AmountBasePool          = 25000000e18;
    uint256 AmountFarming           = 50000000e18;
    ...
    function setupReserve(address account) external onlyOwner returns (bool) {
        ...
        _mint( account, AmountReserve);
        AmountReserve=0;
        return true;
    }
    function setupTeam(address account) external onlyOwner returns (bool) {
        require(AmountTeam > 0, "Team account already setup");
        _mint( account, AmountTeam);
        AmountTeam=0;
        return true;
    }
    function setupP2PB2B(address account) external onlyOwner returns (bool) {
        require(AmountP2PB2B > 0, "P2PB2B account already setup");
        _mint( account, AmountP2PB2B);
        AmountP2PB2B=0;
        return true;
    }
