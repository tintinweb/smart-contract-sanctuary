...
def supportsInterface(_interfaceID: bytes32) -> bool:
    ...
    """
    _convertedERC165InterfaceID: bytes32 = convert(0x01ffc9a7, bytes32)
    _convertedERC721InterfaceID: bytes32 = convert(0x80ac58cd, bytes32)
    _convertedERC721MetadataInterfaceID: bytes32 = convert(0x5b5e139f, bytes32)
    _convertedERC721EnumerableInterfaceID: bytes32 = convert(0x780e9d63, bytes32)
    _convertedInvalidID: bytes32 = convert(0xffffffff, bytes32)
    if _interfaceID == _convertedInvalidID:
        return False

    if _interfaceID == _convertedERC165InterfaceID or _interfaceID == _convertedERC721InterfaceID \
		or _interfaceID == _convertedERC721MetadataInterfaceID or _interfaceID == _convertedERC721EnumerableInterfaceID:
	    return True
