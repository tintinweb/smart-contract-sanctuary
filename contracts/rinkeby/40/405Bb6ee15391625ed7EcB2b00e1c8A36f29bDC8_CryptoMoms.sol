...
contract CryptoMoms is ERC721Enumerable, Ownable {
    ...
    mapping(address => bool) private _holderClaimed;
    ...
    constructor(string memory baseURI) ERC721("CryptoMoms", "MOM") {
    ...
    function mint() external whenHolderClaimStarted {
        ...
        require(!_holderClaimed[msg.sender], "You have already claimed your CryptoMom");
        ...
        uint256 tokenId = numMomsMinted + 1;

        numMomsMinted += 1;
        _holderClaimed[msg.sender] = true;
