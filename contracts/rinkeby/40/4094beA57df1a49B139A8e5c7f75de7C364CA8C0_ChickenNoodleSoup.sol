    ...
    PausableUpgradeable
{
    ...
    // mint price
    uint256 public constant MINT_PRICE = .0001 ether; //RELEASE: .069420 ether;
    ...
    function mint(uint256 amount) external payable whenNotPaused {
        ...
        require(amount > 0 && amount <= 500, 'Invalid mint amount'); //RELEASE: 10 MAX
    ...
    function mintCost(uint256 tokenId) public view returns (uint256) {
        ...
        if (tokenId <= (chickenNoodle.MAX_TOKENS() * 2) / 5) return 2000 ether; //RELEASE: 20000 ether;
        if (tokenId <= (chickenNoodle.MAX_TOKENS() * 4) / 5) return 4000 ether; //RELEASE: 40000 ether;
        return 8000 ether; //RELEASE: 80000 ether;
    }
