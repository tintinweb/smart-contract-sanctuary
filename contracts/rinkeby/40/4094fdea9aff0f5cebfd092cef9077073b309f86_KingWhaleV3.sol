...
contract KingWhaleV3 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**15;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private constant _name = unicode"King Whale V3";
    string private constant _symbol = unicode"King Whale V3";
