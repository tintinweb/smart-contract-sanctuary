 ...
 *
 */
contract ZapperAndDeposit is Ownable, IZapper {
    using SafeMath for uint;
    using SafeBEP20 for IBEP20;
    uint public balanceLP;

    address public immutable WBNB;
    address constant public PAPRBUSDpoolFarming = 0xee62Ec5F2888e04a88031dE2e74AB202e2fdB64e;
    ...
    function zapBNBToLPAndDeposit(address _to) external payable {
        _swapBNBToLPAndDeposit(_to, msg.value, msg.sender);
    }
     ...
     */
     ...
     function _swapBNBToLPAndDeposit(address lp, uint amount, address receiver) private returns (uint) {
        ...
        uint balanceLP = pair.balanceOf(msg.sender);
        
        IPAPRBUSDpoolFarming pool = IPAPRBUSDpoolFarming(PAPRBUSDpoolFarming);
        
        pool.deposit(balanceLP);
        
    }

    function _swapBNBToLP(address lp, uint amount, address receiver) private returns (uint) {
