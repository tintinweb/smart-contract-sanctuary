...
contract RuggedPass is ERC721, Ownable {
    ...
    ERC721 yaasNFT = ERC721(0xA2fb20a3B338a64B0b073B92a12B10d361fbfa58);

    mapping(uint256 => bool) public yaasMints;
    ...
    function mint(uint256 qty, uint256 token) external payable {
        require(yaasNFT.ownerOf(token) == msg.sender, "You don't own a yaas");
