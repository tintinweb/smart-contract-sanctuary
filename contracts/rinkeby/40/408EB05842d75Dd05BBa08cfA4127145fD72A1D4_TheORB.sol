...
contract TheORB is Context, IBEP20, Ownable {
    ...
    function endPresaleProvideLiquidity() external onlyOwner {
        ...
        require(block.timestamp > creationDateOfcContract + 1 days, "You cannot end the presale yet because it has not been 1 day after the creation of the contract.");
