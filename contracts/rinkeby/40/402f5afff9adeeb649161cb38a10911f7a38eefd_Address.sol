...
contract OverCloudz is ERC721, Ownable, RandomlyAssigned {
  ...
  string public baseURI = "https://ipfs.io/ipfs/QmWQwHS43sQoju7FpjwVqTwiB1aydgM9s8QLH9EzZTWXkT/";

  //Constructor is only called once when the contract is deployed
  //There will be 10 Supply, 2 will be minted by dev
  constructor() 
    ERC721("OverCloudz", "OVCD")
