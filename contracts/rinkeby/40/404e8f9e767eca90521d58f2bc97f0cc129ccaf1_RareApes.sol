...
contract RareApes is ERC721 {
    ...
    string public constant RARE_APES_PROVENANCE = "b9e2ad47185076f3f43847eeec601e7bc4a1cb51a208b34b5eb1c650cf06a546";
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 4750) {
            return 1500000000000000000; // 4750 - 5000 1.5 ETH
        } else if (currentSupply >= 4000) {
            return 900000000000000000; // 4000 - 4749 0.9 ETH
        } else if (currentSupply >= 2000) {
            return 500000000000000000; // 2000 - 3999 0.5 ETH
        } else if (currentSupply >= 750) {
            return 300000000000000000; // 750 - 1999 0.3 ETH
        } else {
            return 100000000000000000; // 0 - 749 0.1 ETH 
        }
    }
    ...
    */
    ...
    /**
     * @dev Withdraw ether from this contract (Callable by owner and withdrawal address)
    */
