...
contract NFT is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_PUBLIC_SUPPLY = 9899;
    ...
    function mint(uint256 num) public payable {
        ...
        uint256 claimed = _claimed[msg.sender];
        bool free = claimed == 0;
        uint256 resolvedCost = cost * (num - (free ? 1 : 0));

        // console.log("num %s", num);
        // console.log("claimed %s", claimed);
        // console.log("free %s", free);
        // console.log("resolvecost %s", resolvedCost);
        ...
        require(msg.value >= resolvedCost, "ETH sent is not correct");
        require(claimed + num < maxMint + 1, "Max tokens already claimed");
