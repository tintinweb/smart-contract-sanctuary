...
// Gas Deploy Contract : 3671727
// Gas Mint Transaction : ?
 ...
 */
contract SanchiTest is ERC721Tradable {
    using Address for address;
    ...
    bool private lock;
    uint256 mvpMintStartDate;
    uint256 giveAwayIndexStart;
    ...
    // TODO change contract name and symbol
    constructor(address _proxyRegistryAddress, uint256 mvpMintStart, uint256 giveAwayIndex) ERC721Tradable("SanchiTest", "TOZ", _proxyRegistryAddress) {
        // ) ERC721Tradable("ApeRacingAcademy NFTs", "ARANFTs", _proxyRegistryAddress) {

         // TODO input 9850 or 100
        giveAwayIndexStart = giveAwayIndex;
        giveAwayIdCount._value = giveAwayIndexStart;
        ...
        // FIXME: What difference with: define new var in constructor
        // uint256 vipMintStartDate = vipMintStart; 
    }
    ...
    /// @notice Mints `tokenId` and transfers it to message sender
    /// @param amount Number tokens to mint
    function mvp_mint(uint256 amount) external payable {
        require(msg.value >= price * amount, "Incorrect amount sent");
    ...
    /// @notice Recovers once 5% of ETH that accrue on this contract
    function withdraw_invest() external {
        // TODO: Address Ravan : 0x66F02e34Ce51397D9eCEe0bec87E09Ef9d67993e

        address invest = 0xa9b2D3089324f1c24f998eEA60B5fD2B08b9d656;
        require(msg.sender == invest, "Not eligible");
        require(! withdrawInvest, "Share Withdrawed Already");

        withdrawInvest = true;
        uint256 amountToRecover = (5 * address(this).balance) / 100;

        payable(msg.sender).transfer(amountToRecover);
    }
