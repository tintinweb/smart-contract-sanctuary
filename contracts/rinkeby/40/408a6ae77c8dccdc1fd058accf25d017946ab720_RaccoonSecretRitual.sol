...
contract RaccoonSecretRitual is ERC721, ERC721Enumerable, Ownable, IERC721Receiver, ERC721Burnable {
    using Strings for uint256;
    ...
    function onERC721Received(address, address, uint256 _tokenId, bytes calldata) external override returns(bytes4) {
        IRaccoonSecretSociety(RSS_CONTRACT).transferFrom(address(this), address(0), _tokenId);
        return 0x150b7a02;
    }
    ...
    function setRSSAddr(address _address) public payable {
    ...
    function ritual(uint256 tokenId1, uint256 tokenId2, uint256 tokenId3) public {
        ...
        require(totalSupply() + 1 <= MAX_TOKENS, "All angels are minted");
