...
contract FarmlandLotto is ERC20, ERC20Burnable, Pausable, Ownable, ReentrancyGuard {
...
// CONSTRUCTOR
    ...
    constructor(
        ...
        uint256 _drawLength
        ) ERC20 ("Farmland Lotto Ticket", "LOTTO")
    {
...
// PUBLIC FUNCTIONS
        ...
        withinDeadline
    {
        ...
        _mint(_msgSender(), numTickets * 10 ** decimals());                           // Mint Ticket Tokens
