...
contract Bridge10 is ERC20Upgradeable, MyPausableUpgradeable {
     ...
     */
   function initialize(uint256 _totalSupply, string memory _totalSupply2, uint256 _totalSupply3) public initializer {
