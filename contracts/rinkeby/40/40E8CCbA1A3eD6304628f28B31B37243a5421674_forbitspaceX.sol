...
import { IforbitspaceX, IforbitspaceX_full } from "../interfaces/IforbitspaceX.sol";

abstract contract Storage is IforbitspaceX_full, OwnableUpgradeable {
	...
	function owner() public view virtual override(IforbitspaceX_full, OwnableUpgradeable) returns (address) {
		return OwnableUpgradeable.owner();
	}

	function renounceOwnership() public virtual override(IforbitspaceX_full, OwnableUpgradeable) {
		OwnableUpgradeable.renounceOwnership();
	}

	function transferOwnership(address newOwner) public virtual override(IforbitspaceX_full, OwnableUpgradeable) {
...
interface IforbitspaceX_full is IforbitspaceX {
