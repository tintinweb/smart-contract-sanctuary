...
contract NewToken is ERC20 {
    ...
    constructor(string memory name, string memory symbol, address _operator, address _factory) public ERC20(name, symbol) {
    ...
    function init(uint8 _decimals, uint256 _initialSupply, address _mintAddress) external {
