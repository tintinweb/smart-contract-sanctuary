...
contract RAMNew is ERC721, ERC721Enumerable, Ownable {
    ...
    uint public constant airDropReserveNum = 10;
    bool public saleIsActive;

    string private _baseTokenURI = "ipfs://QmWfyHz3fvXJSmxkHhEZ4WdSmJjSMXc9a2eH7nTEttqZzy/";
    string private _baseContractURI = "ipfs://QmWfyHz3fvXJSmxkHhEZ4WdSmJjSMXc9a2eH7nTEttqZzy/contract";


    constructor() ERC721("RAMNew2", "RA2")  {
        saleIsActive = false;
        setBaseURI(_baseTokenURI);
        setContractURI(_baseContractURI);

        // Reserve first tokens for gifts
        reserveTokens();
    }
