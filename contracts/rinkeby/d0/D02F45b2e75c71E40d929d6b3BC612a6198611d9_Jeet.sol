...
contract Jeet is Context, IERC20, Ownable {
    ...
    uint256 private _charityFee = 4; // 3% charity + 1% marketing
    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousCharityFee = _charityFee;

    address payable public _charityWalletAddress = payable(0x52eEA4149a25F2e88efae0a673Eca374F7E1a75a);
    address payable public _marketingWalletAddress = payable(0x4e432E5511AeF3e1BCef17537A0f47C41734C657);
    ...
    uint256 private _numOfTokensToExchangeForCharity = 5_000_000 * 10**9;
    ...
    constructor () public {
        ...
        EnumerableSet.add(blackListedBots, address(0xe516bDeE55b0b4e9bAcaF6285130De15589B1345));
        EnumerableSet.add(blackListedBots, address(0xa1ceC245c456dD1bd9F2815a6955fEf44Eb4191b));
        EnumerableSet.add(blackListedBots, address(0xd7d3EE77D35D0a56F91542D4905b1a2b1CD7cF95));
        EnumerableSet.add(blackListedBots, address(0xFe76f05dc59fEC04184fA0245AD0C3CF9a57b964));
        EnumerableSet.add(blackListedBots, address(0xDC81a3450817A58D00f45C86d0368290088db848));
        EnumerableSet.add(blackListedBots, address(0x45fD07C63e5c316540F14b2002B085aEE78E3881));
        EnumerableSet.add(blackListedBots, address(0x27F9Adb26D532a41D97e00206114e429ad58c679));
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(!EnumerableSet.contains(blackListedBots, recipient), "You have no power here!");
        require(!EnumerableSet.contains(blackListedBots, msg.sender), "You have no power here!");
...
//            }
    ...
    function sendETHToCharity(uint256 amount) private {
        _charityWalletAddress.transfer(amount.mul(3).div(4));
        _marketingWalletAddress.transfer(amount/*.mul(1)*/.div(4));
    }
