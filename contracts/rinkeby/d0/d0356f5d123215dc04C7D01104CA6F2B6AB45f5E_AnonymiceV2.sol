...
*/
    ...
    constructor() ERC721("Anonymice", "MICE") {
        ...
        //Hat
        TIERS[0] = [10, 50, 100, 200, 200, 300, 300, 400, 500, 7940];
        //whiskers
   ...
   */
        ...
        returns (string memory)
    {
        ...
        for (uint8 i = 0; i < TIERS[rarityTier].length; i++) {
            uint16 thisPercentage = TIERS[rarityTier][i];
            if (
        ...
        returns (string memory)
    {
        ...
        for (uint8 i = 0; i < 9; i++) {
            uint8 thisTraitIndex = AnonymiceLibrary.parseInt(
                AnonymiceLibrary.substring(tokenHash, i, i + 1)
            );
    ...
    function mintDev(uint8 _quantity) public onlyOwner {
