...
contract MyERC721Metadata is ERC165, ERC721BasicToken, Owned {
    ...
    string public baseURI = "http://image.cowex.hichengdai.com/index.html?tokenId=";
...
contract GUOGUONFT is MyERC721Metadata,IERC721Enumerable {
    ...
    constructor() MyERC721Metadata("GUOGUO NFT", "GG", 1000) public {
    }
    ...
    function mint(address _to, string memory _type, string memory _subtype, string memory _name, string memory _description, string memory _tags) public returns (uint256) {
        ...
        require(_tokenIds.current() < _max_supply, "DreamChannelNFT: maximum quantity reached");
        _tokenIds.increment();
