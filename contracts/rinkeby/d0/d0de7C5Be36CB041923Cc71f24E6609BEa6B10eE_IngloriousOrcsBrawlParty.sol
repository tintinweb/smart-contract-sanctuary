...
contract IngloriousOrcsBrawlParty is ERC721Enumerable, Ownable {
    ...
    uint256 private _mintPrice = 0.075 ether;
    ...
    constructor(string memory baseURI) ERC721("IngloriousOrcsBrawlParty", "ORC") {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 num) public payable {
        ...
        require(num < 6, "You can mint a maximum of 5 per transaction");
