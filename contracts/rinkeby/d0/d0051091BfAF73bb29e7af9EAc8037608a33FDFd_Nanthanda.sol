...
contract Nanthanda is ERC721, ERC721Enumerable, Ownable {
  
  // Provenance
  string public Nathanda_HASH = "";
  ...
  constructor(string memory baseURI) ERC721("Nanthanda", "NAAN") {
    setBaseURI(baseURI);
  }
