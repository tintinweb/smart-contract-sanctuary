...
contract StakingRewards is IStakingRewards, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable rewardDurationInDays;
    ...
    constructor(
        ...
        require(_owner != address(0), "RadarStakingRewards: invalid owner");
        ...
        rewardDurationInDays = _rewardDurationInDays * 1 days;
    }
    ...
    function getRewardForDuration() external view override returns (uint256) {
        return rewardRate * rewardDurationInDays;
    }
    ...
    function fundRewards(uint256 reward) external updateReward(address(0)) {
        ...
        rewardRate = reward / rewardDurationInDays;
        ...
        require(rewardRate <= balance / rewardDurationInDays, "RadarStakingRewards: provided reward too high");

        lastUpdateTime = block.timestamp;
        periodFinish = block.timestamp + rewardDurationInDays;
...
abstract contract Ownable {
    ...
    constructor(address owner_) {
        _setOwner(owner_ == address(0) ? msg.sender : owner_);
    }
