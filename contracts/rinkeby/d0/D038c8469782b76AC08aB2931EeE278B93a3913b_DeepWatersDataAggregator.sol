...
contract DeepWatersVault is Ownable {
    ...
    **/
    function updateBorrowBalance(address _asset, address _user, uint256 _newBorrowBalance)
        external
        onlyLendingContract 
    {
    ...
    **/
    function getUserBorrowBalance(address _asset, address _user)
        external
        view
        returns (uint256)
    {
    ...
    **/
    ...
    function getAssetPriceUSD(address _asset)
        external
        view
        returns (uint256)
    {
