...
contract RepToken is ChainlinkClient {
    ...
    event RepTokensMinted(address indexed to, uint256 balanceOf);
    event RepTokensBurned(address indexed from, uint256 balanceOf);
    ...
    function mint(address _predictor) private {
        ...
        emit RepTokensMinted(_predictor, balanceOf[_predictor]);
    }
    ...
    function burn(address _predictor) private {
        ...
        emit RepTokensBurned(_predictor, balanceOf[_predictor]);
    }
