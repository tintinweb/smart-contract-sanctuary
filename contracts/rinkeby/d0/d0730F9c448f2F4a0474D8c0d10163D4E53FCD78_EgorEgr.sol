...
contract EgorEgr is ERC721Tradable {
    constructor(address _proxyRegistryAddress) ERC721Tradable("EgorEgr", "EGR", _proxyRegistryAddress) {}

    function baseTokenURI() public pure override returns (string memory) {
        return "https://egor-nft.web.app/";
    }
