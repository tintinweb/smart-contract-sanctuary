...
contract Token is ERC721Tradable  {
    ...
    uint256  constant    public _sale_end = _sale_start + 7 days;
     constructor(address _proxyRegistryAddress)
        ERC721Tradable("Dirty Robot\'s Seasons", "SEASONS", _proxyRegistryAddress)
    {}
    ...
    function _beforeTokenTransfer(
        ...
        if (block.timestamp > _sale_end) return;
        require (from == address(0),"Tokens cannot be moved until the end of the sale");
    }
