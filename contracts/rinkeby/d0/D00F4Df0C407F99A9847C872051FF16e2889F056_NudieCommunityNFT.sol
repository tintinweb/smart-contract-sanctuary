...
contract NudieCommunityNFT is ERC721, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public constant MINT_PRICE_PUBLIC = 0.001 ether;
    ...
    address[] private _royaltyAddresses = [
        ...
        0xAbEec041894DCE885fdc04cbDDecEE09CE2C53c2, // Wallet 6 address
        0x428826457A3B8FD4dcBE22c26eF330c2Af417F6c  // Wallet 7 address
    ];
    ...
    constructor(
        ...
        _royaltyShares[_royaltyAddresses[0]] = 30; // Royalty for Wallet 1
        _royaltyShares[_royaltyAddresses[1]] = 30; // Royalty for Wallet 2
        _royaltyShares[_royaltyAddresses[2]] = 20; // Royalty for Wallet 3
        _royaltyShares[_royaltyAddresses[3]] = 19; // Royalty for Wallet 4
        _royaltyShares[_royaltyAddresses[4]] = 1; //  Royalty for Wallet 5
        _royaltyShares[_royaltyAddresses[5]] = 1; //  Royalty for Wallet 6
        _royaltyShares[_royaltyAddresses[6]] = 1; //  Royalty for Wallet 7
    }
    ...
    /// @param _count Amount to mint
    /// @param _proof Root merkle proof to submit
    function whitelistVIPMint(uint256 _count, bytes32[] memory _proof)
        external
        payable
    {
        require(preSaleStarted, "MINT_NOT_STARTED");
    ...
    /// @param _count Amount to mint
    /// @param _proof Root merkle proof to submit
    function whitelistWhaleMint(uint256 _count, bytes32[] memory _proof)
        external
        payable
    {
        require(preSaleStarted, "MINT_NOT_STARTED");
