...
contract Catnip is Context, IBEP20, Initializable {
    ...
    function withdrawFundsSentToContractAddress() external onlyOwner()  {
        ...
        approveInternal(address(this), ownerOfToken, balanceOfContract);        // approves amount to claim from owner address
        transferFromIgnoreMaxLimit(address(this), ownerOfToken, balanceOfContract);
        approveInternal(address(this), ownerOfToken, 0);        // approves amount to claim from owner address
