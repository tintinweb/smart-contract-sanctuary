...
// File: lostcitybookofdreams.sol

pragma solidity ^0.8.0;

contract LostCityBookofDreams is ERC721, Ownable {
    using SafeMath for uint256;
    uint public constant MAX_LostDreams = 100;
    bool public hasSaleStarted = false;
    
    constructor() ERC721("LostCityBookofDreams","LOSTDREAMS")  {
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmehHA1ZeDr3pHVh2HGmZGzcEfNQoEs1W3DBZojYh5HHPL/");
        
        // Ciel
        _safeMint(address(0xF75341b90b8BEb9F93c50FAcB92Bc552f20797bB), 0);
        _safeMint(address(0xF75341b90b8BEb9F93c50FAcB92Bc552f20797bB), 1);
        _safeMint(address(0xF75341b90b8BEb9F93c50FAcB92Bc552f20797bB), 2);
        _safeMint(address(0xF75341b90b8BEb9F93c50FAcB92Bc552f20797bB), 3);
        _safeMint(address(0xF75341b90b8BEb9F93c50FAcB92Bc552f20797bB), 4);
        _safeMint(address(0xF75341b90b8BEb9F93c50FAcB92Bc552f20797bB), 5);
        _safeMint(address(0xF75341b90b8BEb9F93c50FAcB92Bc552f20797bB), 6);
    }
    ...
    function calculatePrice() public view returns (uint256) {
        ...
        require(totalSupply() < MAX_LostDreams, "Sale has already ended");
     ...
     function calculatePriceTest(uint _id) public view returns (uint256) {
        ...
        require(_id < MAX_LostDreams, "Sale has already ended");
   ...
   function adoptLostDream(uint256 numLostDreams) public payable {
        require(totalSupply() < MAX_LostDreams, "Sale has already ended");
        require(numLostDreams > 0 && numLostDreams <= 25, "You can adopt minimum 1, maximum 25 lost dreams");
        require(totalSupply().add(numLostDreams) <= MAX_LostDreams, "Exceeds MAX_LostDreams");
        require(msg.value >= calculatePrice().mul(numLostDreams), "Ether value sent is below the price");

        for (uint i = 0; i < numLostDreams; i++) {
