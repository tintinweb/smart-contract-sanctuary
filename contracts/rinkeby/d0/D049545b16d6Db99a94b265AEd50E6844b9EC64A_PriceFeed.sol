...
contract PriceFeed is Ownable, CheckContract, BaseMath, IPriceFeed {
    ...
    uint constant public TIMEOUT = 86400;  // 4 hours: 60 * 60 * 24
    ...
    */
        ...
        onlyOwner
    {
        ...
        // console.log("_chainlinkIsBroken(chainlinkResponse, prevChainlinkResponse", _chainlinkIsBroken(chainlinkResponse, prevChainlinkResponse));
        // console.log("_chainlinkIsFrozen(chainlinkResponse)", _chainlinkIsFrozen(chainlinkResponse));
