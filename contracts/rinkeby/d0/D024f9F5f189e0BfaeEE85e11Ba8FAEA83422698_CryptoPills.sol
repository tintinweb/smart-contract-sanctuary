...
contract CryptoPills is ERC721, Pausable, Ownable, PaymentSplitter {
    using SafeMath for uint256;

    uint256 public MAX_SUPPLY = 10000;
    uint256 _reservedCount = 100;
    uint256 _totalSupply = 0;
    uint256 _mintPrice = 0.07 ether;
    uint256 _maxPurchaseCount = 20;
    ...
    ) ERC721("Crypto Pills", "CP") PaymentSplitter(payees, paymentShares) {
