...
contract LoserChickNFTTest is OwnableContract, ERC721("ShriekingChick", "ShriekingChick"){
...
contract SmashEggs is OwnableContract{
    ...
    function getOneChickNFT() internal returns(uint256, address){
        ...
        LoserChickNFTTest loserChickNFT = LoserChickNFTTest(chickAddr);
    ...
    function transferActivityNFT(address receiver, uint256 count) external{
        ERC721 erc721 = ERC721(activityNFTAddr);
        uint256 amount = erc721.balanceOf(address(this));
