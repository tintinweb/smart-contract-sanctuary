...
import "./CommunityV2.sol";
import "./EventsV2.sol";

/* solhint-disable not-rely-on-time */

/**
 * V3 has extra message hash emit in addMember and publishProject
 */
contract CommunityV3 is CommunityV2 {
    using SafeERC20Upgradeable for IToken20;
    modifier deprecated() {
        revert("Community::Deprecated");
        _;
    }
        ...
        override
    {
        ...
        EventsV2(address(eventsInstance)).memberAdded(
            _communityID,
            _memberToAdd,
            _messageHash
        );
    ...
    function publishProject(
    ...
    ) external virtual checkMember(_communityID, _msgSender()) {
        require(
        ...
        EventsV2(address(eventsInstance)).projectPublished(
            _communityID,
            _project,
            _projectDetails[0],
            _hash
        ...
        checkMember(_communityID, _msgSender())
    {
        ...
        EventsV2(address(eventsInstance)).investorInvested(
            _communityID,
            _project,
            _msgSender(),
            _investment,
    ...
    function publishProject(
        ...
        address _project,
        uint256[] calldata _projectDetails
    ) external pure override deprecated {}

    function investInProject(
        uint256 _communityID,
        address _project,
        uint256 _investment
    ) external payable override deprecated {}
}
...
/**
 * V2 has extra feature of Escrow reduce debt
 */
contract CommunityV2 is Community {
    /**
    ...
    function escrow(bytes calldata _data, bytes calldata _signature) external {
        ...
        address _a0 = SignatureDecoder.recoverKey(_hash, _signature, 0);
        address _a1 = SignatureDecoder.recoverKey(_hash, _signature, 1);
        address _a2 = SignatureDecoder.recoverKey(_hash, _signature, 2);
        require(
            (_a0 == _builder &&
                ((_a1 == _investor && _a2 == _agent) ||
                    (_a1 == _agent && _a2 == _investor))) ||
                (_a0 == _investor &&
                    ((_a1 == _builder && _a2 == _agent) ||
                        (_a1 == _agent && _a2 == _builder))) ||
                (_a0 == _agent &&
                    ((_a1 == _investor && _a2 == _builder) ||
                        (_a1 == _builder && _a2 == _investor))),
            "Community::!B||!agent||!IN"
        );
...
/**
 * EventsV2 has extra events in addMember and publishProject
 */
contract EventsV2 is Events {
    ...
    function memberAdded(
        ...
        address _member,
        bytes calldata _hash
    ) external virtual onlyCommunityContract {
    ...
    function investorInvested(
        ...
        emit InvestorInvested(_communityID, _project, _investor, _cost, _hash);
    }

    function contractorDelegated(bool _bool) external validProject {
...
contract Events is IEvents {
    ...
    function tasksAdded(
        ...
        emit TasksAdded(msg.sender, _phaseID, _taskCosts, _taskHashes);
    }
    ...
    function adminLock(bool _locked) external override onlyCommunityContract {
        emit AdminLock(_locked);
    }
    ...
    function repayInvestor(
        ...
        emit RepayInvestor(_communityID, _project, _investor, _tAmount);
    }
    ...
    function debtReduced(
        ...
        emit DebtReduced(_communityID, _project, _investor, _tAmount, _details);
    }
