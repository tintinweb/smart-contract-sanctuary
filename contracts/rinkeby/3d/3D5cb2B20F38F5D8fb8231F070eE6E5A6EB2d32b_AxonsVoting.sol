...
contract AxonsVoting is IAxonsVoting, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function vote(uint16 votes, uint256 auctionCounter) public {
        require(votes < 1024, 'Invalid vote');
        ...
        // Add upvotes
        currentVotesForAxonNumbers[auctionCounter][0] += votes & (1 << 0);
        currentVotesForAxonNumbers[auctionCounter][1] += votes & (1 << 1);
        currentVotesForAxonNumbers[auctionCounter][2] += votes & (1 << 2);
        currentVotesForAxonNumbers[auctionCounter][3] += votes & (1 << 3);
        currentVotesForAxonNumbers[auctionCounter][4] += votes & (1 << 4);
        currentVotesForAxonNumbers[auctionCounter][5] += votes & (1 << 5);
        currentVotesForAxonNumbers[auctionCounter][6] += votes & (1 << 6);
        currentVotesForAxonNumbers[auctionCounter][7] += votes & (1 << 7);
        currentVotesForAxonNumbers[auctionCounter][8] += votes & (1 << 8);
        currentVotesForAxonNumbers[auctionCounter][9] += votes & (1 << 9);
