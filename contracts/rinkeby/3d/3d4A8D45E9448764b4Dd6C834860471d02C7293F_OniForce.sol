...
// File: contracts/oni/token/IERC721.sol
...
// File: contracts/oni/token/IERC721Receiver.sol
...
// File: contracts/oni/token/extensions/IERC721Metadata.sol
...
// File: contracts/oni/token/ERC721.sol
...
// File: contracts/oni/token/extensions/IERC721Enumerable.sol
...
// File: contracts/oni/token/extensions/ERC721Enumerable.sol
...
// File: contracts/oni/Ownable.sol
...
// File: contracts/oni/OniForce.sol
...
contract OniForce is ERC721Enumerable, Ownable, IOniForce, IOniForceMetadata {
  ...
  function purchaseAllowList(uint256 numberOfTokens) external payable override {
    require(isActive, 'Contract is not active');
    ...
    require(
      totalPublicSupply + numberOfTokens <= ONI_PUBLIC,
      'Purchase would exceed ONI_PUBLIC'
    );
    require(
  ...
  function gift(address[] calldata to) external override onlyOwner {
    require(totalSupply() < ONI_MAX, 'All tokens have been minted');
    require(
      totalGiftSupply + to.length <= ONI_GIFT,
