    ...
    SmolMintable
{
    ...
    constructor(
        ...
        payoutWallet = 0xC97E12D5D123626931460f499A80a1938376BF9E;
    ...
    function setTokenURI(uint256 tokenId, string memory permanentTokenURI) public virtual  onlyOwner() {
        _setTokenURI(tokenId, permanentTokenURI);
    }
...
abstract contract SmolMintable is Context, ERC721Enumerable, Ownable {
    ...
    function publicMint() public payable {
        ...
        require(boughtAmounts[msg.sender] <= _maxTokensPerWallet + amount, "SM: L2");
    ...
    function whitelistMint(string memory tier, bytes memory validator ) public payable {
        ...
        // check maxTokensPerWallet limit is not reached
        require(boughtWhitelistAmounts[validatorWallet][msg.sender] <= _maxTokensPerWhitelistWallet + amount, "SM: L2");
