...
contract GovernanceToken is 
  ...
  ERC20VotesUpgradeable {
    ...
    uint256 public constant PRICE_PER_VOTE = 0.01 ether;
    ...
    function buyTokens(uint256 amount, address to) public payable {
        require(
          msg.value >= amount * PRICE_PER_VOTE,
          "GovernanceToken: Not enough funds to buy."
        );
        _mint(to, amount);
    }
