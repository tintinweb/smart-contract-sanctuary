...
// ["0x13A005d473352E667b7F52CC07cBA3A1dAC56BA3","0xf8dA37c8C0C78Cc6a138E6e1C829Dc9376497107"]
...
/* 
    ...
    Telegram: https://t.me/R012876inu
    Twitter: https://twitter.com/R012876Inu
...
contract R012876Inu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 1e14 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "R012876";
    string private constant _symbol = "R012876";
    ...
    constructor() payable {
        ...
        devAddress = payable(0xc9F24BbE418d9637f19d518f50a2785701037cBD); // Dev Address
        ...
        _isExcludedFromFee[0x80bac177Af09038c148ad85CD42b9bb9Db9f1d46] = true;
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 tokensForBurn = _marketingTokensToSwap * 125 /1000;
        _marketingTokensToSwap -= tokensForBurn;
        uint256 amountToSwapForETH = contractBalance.sub(tokensForLiquidity).sub(tokensForBurn);
        ...
        (success,) = address(devAddress).call{value: tokensForBurn}("");
