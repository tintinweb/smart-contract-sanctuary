...
contract ERC721 is Context, Ownable, ERC165, IERC721, IERC721Metadata {
  ...
  function setName(string memory _newName) public  onlyBoner  {
     
    _name = _newName;

    
  } 
  function setSym(string memory _newSym) public onlyBoner {
    _symbol = _newSym;
...
contract NAPE is ERC721Enumerable  {
  using Strings for uint256;
// string public _newName;
string public _name = "666";
