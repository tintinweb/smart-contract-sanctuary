...
contract FantasticNFT is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("FantasticNFT", "FNFT") {
    collectionName = name();
    collectionSymbol = symbol();
    uint256 _price = 0.009 * 10**18;
    setPrice(_price);
  }
  ...
  function mint() public payable returns(uint256) {
    require(msg.value >= getPrice(1), "Value below price");
    ...
    string memory json = Base64.encode(
      bytes(
        string(
          ...
          '{"name": "',
            combinedWord,
            '", "description": "A highly acclaimed collection Fantastic Warriors", "image": "data:image/svg+xml;base64,',
