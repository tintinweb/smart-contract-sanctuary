...
contract SvgTest is ERC721Enumerable, Ownable {
	...
	constructor() ERC721('SvgTest', 'SVG') {}
					...
					SvgTestLibrary.encode(
						bytes(
							abi.encodePacked(
								'{"name":"Svg Test - Token',
								' #',
								SvgTestLibrary.decimalString(tokenId, 0, false),
								'", "description":"',
	...
	function generateSVG() private pure returns (string memory) {
		return
			string(
				abi.encodePacked(
					'<svg version="1.1" id="svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="48" height="48" viewBox="0 0 48 48">',
					'   <style>     rect {      fill: green;       animation: test 5s infinite;      }          @keyframes test {  to {    fill: red;  }}  </style>',
					generatePaths(),
					'</svg>'
				)
			);
	...
	function generatePaths() private pure returns (string memory result) {
		for (uint8 i = 0; i < 100; i++) {
			result = string(abi.encodePacked(result, generatePath()));
		}
	}

	function generatePath() private pure returns (string memory) {
		return
			string(
				abi.encodePacked(
					'<g><rect width="48" height="4" x="1" y="23" transform="rotate(90 25 24)"/><rect width="48" height="4" y="21" /></g>',
					'<g><rect width="48" height="4" x="1" y="23" transform="rotate(90 25 24)"/><rect width="48" height="4" y="21" /></g>',
					'<g><rect width="48" height="4" x="1" y="23" transform="rotate(90 25 24)"/><rect width="48" height="4" y="21" /></g>',
					'<g><rect width="48" height="4" x="1" y="23" transform="rotate(90 25 24)"/><rect width="48" height="4" y="21" /></g>',
					'<g><rect width="48" height="4" x="1" y="23" transform="rotate(90 25 24)"/><rect width="48" height="4" y="21" /></g>',
