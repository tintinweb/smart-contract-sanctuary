...
contract KongzVX is ERC721Namable, Ownable {
	...
	address constant public KONGZ = address(0xEEC09F8EBd6Deac17c19414B8832C3F941dC57A7);
	...
	function _isClaimed(uint256 _tokenId) internal view returns (bool) {
	...
	// 		}
	// 		else {
	// 			require(!_isClaimed(_tokenIds[i]), "KongzVX: Bebe claimed already");
	...
	function claim(uint256 _tokenId) external {
		...
		if (_tokenId < 1001) {
			...
			uint256 currentMinted = sold + minted;
			require(!_isClaimed(_tokenId), "KongzVX: Bebe claimed already");
	...
	function mint(uint256 _amount) external payable {
		...
		require(_amount < 6, "KongzVX: Buy limit is 5");
