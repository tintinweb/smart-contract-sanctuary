...
contract GOBToken is ERC1155, Ownable, Pausable, ERC1155Burnable {
    ...
    {
        require(_whitelist[msg.sender] == true, "You must be in the whitelist");
   ...
   function burnFromRedeem(
    ...
    function updateWhitelist(address to, bool value) public onlyOwner {
        _whitelist[to] = value;
    }
