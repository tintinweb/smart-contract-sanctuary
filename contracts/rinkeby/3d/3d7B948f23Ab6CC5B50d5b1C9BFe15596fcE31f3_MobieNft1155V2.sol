...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */
    ...
    function _mint(address from, uint256 tokenId, uint256 _supply, string memory _uri, address[] memory _royaltyAddress, uint256[] memory _royaltyfee) internal {
        ...
        emit TransferSingle(msg.sender, address(0x0), from, tokenId, _supply);
    ...
    */
    ...
    function mintAndTransfer(address from, address to, uint256 itemId, address[] memory _royaltyAddress, uint256[] memory _royaltyfee, uint256 _supply,string memory _tokenURI, uint256 qty,bytes memory data) public virtual override returns(uint256){
        require(msg.sender == transferProxy,"ERC1155: caller is not Approved");
        itemId = tokenCounter;
        _operatorApprovals[from][transferProxy] = true;
        _mint(from, itemId, _supply, _tokenURI, _royaltyAddress, _royaltyfee);
...
contract MobieNft1155V2 is ERC1155 {
    ...
    */
    ...
    function mint(string memory uri, uint256 supply, address[] memory royaltyAddress, uint256[] memory royaltyFee, Sign memory sign)  public {
        ...
        _mint(msg.sender, tokenCounter, supply, uri, royaltyAddress, royaltyFee);
