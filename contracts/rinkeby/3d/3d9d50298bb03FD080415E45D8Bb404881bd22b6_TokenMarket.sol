...
contract TokenMarket is TokenMarketBase, Pausable, Ownable {
    ...
    */
        ...
        whenNotPaused
    {
        ...
        uint256 collateralLTVPercentage = _priceConsumer.calculateLTV(
        ...
        returns (uint256, uint256, uint256)
    {
        ...
        uint256 maxLoanAmountValue = IGovWorldTierLevel(govWorldTierLevel)
            .getMaxLoanAmountToValue(collatetralInBorrowed, msg.sender);
...
interface IGovWorldTierLevel {
    ...
    function getMaxLoanAmountToValue(uint256 _collateralTokeninStable, address _borrower)
        external
        view
        returns (uint256);
