...
// File: contracts/duckypenguins.sol
...
contract DuckyPenguins is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint16 public numFree = 444;
  uint8 public maxMintAmount = 10;
  bool public paused = false;

  constructor() ERC721("Ducky Penguins", "DUCKY PENGUINS") {
    setBaseURI("ipfs://QmbH6dFSd4bgmpQCAwn7MKoLTiCU48cf8WCJwtbmDavb32/");
    mint(1);
  }
