...
// File: contracts\Royalti.sol

// contracts/JoyalNFT.sol
...
contract Royalti is ERC721Enumerable, IERC2981, Ownable {
    uint256 royaltyPercentage = 5; // 0- 100%

    constructor() ERC721("Royalti", "RYLT") {}
        ...
        returns (string memory)
    {
        ...
        return
            "https://gateway.pinata.cloud/ipfs/QmV4QvZL6mMm3F6Jzce564MbbKJDyTbjwXaqSWe2BSoRzt";
    }
    ...
    function royaltyInfo(uint256, uint256 salePrice)
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        receiver = address(this); // the contract will get the royalty
