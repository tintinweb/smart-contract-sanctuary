...
contract SporesNFTFactory is Ownable {
	...
	/**
	 * @dev Factory mint function to distribute spores NFT to user
	 */
	function mintTo(address nft, address to) public {
		IERC721Mintable allowedNft = IERC721Mintable(nft);
		allowedNft.mint(to);
	}
	...
	function mintMultipleTo(
		...
		require(
			...
			"SporesNFTTokenFactory: invalid number of items to mint"
		);
		IERC721Mintable allowedNft = IERC721Mintable(nft);
