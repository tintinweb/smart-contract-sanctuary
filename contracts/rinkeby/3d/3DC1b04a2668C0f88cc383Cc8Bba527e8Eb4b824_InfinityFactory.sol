...
contract infinityTokensPublic is ERC721, OwnableClone, HasSecondarySaleFees, Saleable {
	...
	function NFTMouldMetadata(uint256 NFTId) public view returns (string memory name, Attributes[] memory attributes, uint256 editionSize, uint256 editionsMinted, uint256 evolutionLevel, uint256 totalRedemptions, uint64 redemptionExpiration, bool isActive) {
