...
contract LiquidMarket is Context, Ownable, IERC20Burnable {
    ...
    uint public constant TRANSACTION_FEE = 1600;
    ...
    function amountWithFee(uint amount) public pure returns (uint) {
        return amount.add(amount.mul(TRANSACTION_FEE).div(DECIMALS));
    }
    ...
    function transfer(address recipient, uint amount) public virtual override returns (bool) {
        _transfer(_msgSender(), recipient, amountWithFee(amount));
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint amount) public virtual override returns (bool) {
        _transfer(sender, recipient, amountWithFee(amount));
