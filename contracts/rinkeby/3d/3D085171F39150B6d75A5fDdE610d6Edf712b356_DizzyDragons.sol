...
contract DizzyDragons is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    event DragonsMerged(uint256 firstTokenId, uint256 secondTokenId, uint256 mergedDragonTokenId);
    ...
    constructor(string memory name, string memory symbol, uint256 maxDragonSupply) ERC721(name, symbol) {
        ...
        _shareholders[1] = 0x34af048BCFCB2f21e0de4F55C8E0Ba425507bD81;
        _shareholders[2] = 0x366Bc8C683b0b638f6d3476D737Ad11d0a602109;
        _shareholders[3] = 0x653C7C5d8B14e0b2b261Ed1FCfd652EEA0496376;
    ...
    function withdraw(uint256 amount) public onlyOwner {
        ...
        uint256 totalShares = _shares[0] + _shares[1] + _shares[2] + _shares[3];
    ...
    */
    ...
    /*
    * Pause merging if active, make active if paused.
    */
    function flipMergingState() public onlyOwner {
    ...
    */
    ...
    function mergeDragons(uint256 firstTokenId, uint256 secondTokenId) public {
        require(mergingIsActive && !saleIsActive, "Either sale is currently active or merging is inactive");
        ...
        // mint new token
        uint256 mergedDragonTokenId = _tokenIdCounter.current() + 1;
        _safeMint(msg.sender, mergedDragonTokenId);
        _tokenIdCounter.increment();

        // fire event in logs
        emit DragonsMerged(firstTokenId, secondTokenId, mergedDragonTokenId);
    }
}
