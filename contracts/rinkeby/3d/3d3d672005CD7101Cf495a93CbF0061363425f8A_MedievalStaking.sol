...
contract MedievalStaking is MedievalAccessControlled {
     ...
     */
    function setContract( CONTRACTS _contract, address _address ) external onlyAdmin() {
     ...
     */
    function setWarmup( uint _warmupPeriod ) external onlyAdmin() {
        warmupPeriod = _warmupPeriod;
    }

    function setEpochEndBlock(uint _epochEndBlock) external onlyAdmin {
