...
contract ShibaBurn is Ownable {
  ...
  function burnShib(uint256 amount) public {
    burnToken(0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE, amount);
  }

  function burnRyoshi(uint256 amount) public {
    burnToken(0x777E2ae845272a2F540ebf6a3D03734A5a8f618e, amount);
  }

  function burnLeash(uint256 amount) public {
    burnToken(0x27C70Cd1946795B66be9d954418546998b546634, amount);
  }

  function burnBone(uint256 amount) public {
    burnToken(0x9813037ee2218799597d83D4a5B6F3b6778218d9, amount);
  }
