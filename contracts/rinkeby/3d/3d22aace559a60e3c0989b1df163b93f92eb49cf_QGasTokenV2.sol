...
// File: contracts/QGasTokenV2.sol
 ...
 */
contract QGasTokenV2 is  ERC20, Ownable {
    ...
    constructor(uint256 id) public ERC20("IToken5", "IT5") {
        _setupDecimals(18);
        _mint(msg.sender, 600000000000000000000000000);
        active = true;
    }
