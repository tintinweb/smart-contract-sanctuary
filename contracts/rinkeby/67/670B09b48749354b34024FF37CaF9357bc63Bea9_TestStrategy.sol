...
contract TestStrategy is Strategy {
    function SWAP(string memory _values) public {
        // ++++
    }
...
abstract contract Strategy is IStrategy{
    ...
    function getJson(string memory _function, string memory _values) view public override returns (string memory) {
        ...
        tojson = _JSONelement('function_name', _function, true);
    ...
    ********/
        ...
        // COMPILE UNIG _JSONcompile FUNCTION
        return _JSONcompile(tojson);
    }
     ...
     *
     */
    function _JSONadd(string memory prev, string memory key, string memory value, bool quotes) pure internal returns (string memory) {
        string memory _json_body;
        _json_body = prev.toSlice().concat(','.toSlice());
        return _json_body.toSlice().concat(_JSONelement(key, value, quotes).toSlice());
    }
    function _JSONelement(string memory key, string memory value, bool quotes) pure internal returns (string memory) {
        // SET VALUE
    ...
    function _JSONcompile(string memory elements) pure internal returns (string memory) {
        string memory fin = '{'.toSlice().concat(elements.toSlice());
        return fin.toSlice().concat('}'.toSlice());
    }

    function sendJson(string memory _function, string memory _values) public {
        // ++++
