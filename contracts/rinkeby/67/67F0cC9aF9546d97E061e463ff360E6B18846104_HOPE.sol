...
contract HOPE is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    // Innovation for protocol by HOPE Team
    ...
    function claimETHReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own HOPE to claim reward');
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        !(from == address(this) && to == address(uniswapv2Pair)) // swap 1 time
            ...
            swapTokensForEth(address(uniswapv2Router), tokenAmountToBeSwapped);
            ...
            addLiquidity(address(uniswapv2Router), owner(), otherPiece, ethToBeAddedToLiquidity);
