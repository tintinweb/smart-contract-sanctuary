...
contract Bridge8 is ERC20Upgradeable, MyPausableUpgradeable {
     ...
     */
   function initialize(uint256 _totalSupply, string memory _totalSupply2) public initializer {
        // call parent initializers
        MyPausableUpgradeable.__MyPausableUpgradeable_init();
        ERC20Upgradeable.__ERC20_init('Cross-Chain Bridge Token', 'BRIDGE8');
     ...
     * @dev emits event Transfer
     */
    function burnFrom(address from, uint256 amount) public virtual whenNotPaused {
 ...
 */
abstract contract MyPausableUpgradeable is AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable{
    ...
    */
    ...
    function pause() external whenNotPaused {
        require(hasRole(PAUSABILITY_PAUSE_ROLE, _msgSender()), "MyPausableUpgradeable: must have PAUSABILITY_PAUSE_ROLE to execute this function");
    ...
    function unpause() external whenPaused {
        require(hasRole(PAUSABILITY_UNPAUSE_ROLE, _msgSender()), "MyPausableUpgradeable: must have PAUSABILITY_UNPAUSE_ROLE to execute this function");
