...
/** 
 *  SourceUnit: d:\repos\NFTurbo\contracts\nfturbo\test.sol
*/
...
contract Thing1 is ERC721Enumerable, ERC721Burnable, ERC721Pausable, Ownable {
    string private baseTokenURI;

    uint256 private price = 30000000000000000;
    uint256 private supplyCap = 5000;
    uint256 private perTxLimit = 20;
    uint256 private reservedMints = 10;
    uint256 private projectFunds = 0;
    ...
    constructor(string memory _projectBaseURI, address[] memory _teamMembers)
        payable
        ERC721("The Thing 1", "TNG1")
    {
        setBaseURI(_projectBaseURI);
        teamMembers = _teamMembers;
    }

    //  ----------- ERC721 actions:
    function mintThing(uint256 _amountMinted, address _to) public payable {
