...
contract Needlz is ERC721, Ownable, IMintedBeforeReveal {
    ...
    string public constant ORIGINAL_PROVENANCE = "F493508662D5C85730DA2340486DEC484CA613E0D2263E2D7DB92B55E92B4F84";

    // Time of when the sale starts.
    uint256 public constant SALE_START_TIMESTAMP = 1616183300;

    // Time after which the Needlz are randomized and revealed (1 day from initial launch).
    uint256 public constant REVEAL_TIMESTAMP = SALE_START_TIMESTAMP + (86400 * .02);
