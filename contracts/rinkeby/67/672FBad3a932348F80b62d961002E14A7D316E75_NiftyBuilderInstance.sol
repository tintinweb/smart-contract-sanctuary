...
contract NiftyBuilderInstance is ERC721, ERC721Burnable, ERC721Enumerable {
  ...
  string[10] artifact = ["QmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
                         ...
                         "QmEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE",
                         "QmFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
                         "QmGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG",
                         "QmHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH",
                         "QmIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII",
                         "QmJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJ"];

  address immutable dateTimeContract; 
  ...
  function tokenIPFSHash(uint256 tokenId) external view override returns (string memory) {
      require(_exists(tokenId), "ERC721Metadata: IPFS hash query for nonexistent token");
       ...
       uint minute = uint(dateTime.getMinute(block.timestamp)) % 10;
