...
contract Stakers is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function mintChip(uint256 chipQuantity) public payable {
        ...
        for(uint256 i; i < chipQuantity; i++){
            ...
            uint8 rng1 = uint8(uint256(keccak256(abi.encodePacked(i, msg.sender)))%3);
            if(rng1 == 2){
                skinTone[supply + i] = "c";
            }
             else if(rng1 == 1){
    ...
    function setLightTone(uint256 tokenId) public {
        address owner = ERC721.ownerOf(tokenId);
        require(
            _msgSender() == owner,
    ...
    function setMidTone(uint256 tokenId)public {
        address owner = ERC721.ownerOf(tokenId);
        require(
            _msgSender() == owner,
            "This isn't your Staker."
    ...
    function setDarkTone(uint256 tokenId) public {
        address owner = ERC721.ownerOf(tokenId);
        require(
            _msgSender() == owner,
            "This isn't your Staker"
