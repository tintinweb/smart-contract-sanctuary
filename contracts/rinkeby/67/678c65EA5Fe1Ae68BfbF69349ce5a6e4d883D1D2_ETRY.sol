...
pragma solidity ^0.8.0;
    ...
    contract ETRY is IMerkleDistributor,ERC721, Ownable, ReentrancyGuard{
        ...
        //Internal function to verify merkleProof
         function verify(uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof) internal {
       ...
       function mintById(uint256 id) public  onlyOwner() {
          ...
          * Mint function
          */
         function mint(uint256 _amount, uint256 merketree_index,bytes32[] calldata merkleProof) public payable nonReentrant() {
           ...
           if (PRESALE_ONLY){
               verify(merketree_index,msg.sender, 1, merkleProof);
               require(balanceOf(msg.sender) + _amount <=PRESALE_TOKEN_MAXIMUM_AMOUNT,"The total amount for this phase is 10");
            }
