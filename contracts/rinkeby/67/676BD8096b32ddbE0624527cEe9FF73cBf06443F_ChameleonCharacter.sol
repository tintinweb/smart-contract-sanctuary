...
contract ChameleonCharacter is ERC721, VRFConsumerBase {
    ...
    // function to request a random number from chainlink VRF to create a new character
    // request randomness

    function requestNewRandomCharacter (uint256 userProvidedSeed, string memory name) public
    returns (bytes32) {
