...
contract GameFiShibaCoinPool is Ownable, Pausable {
    ...
    function withdraw(uint256 tokenId) private whenNotPaused returns (uint256) {
    ...
    function estimatedIncome(uint256 tokenId) private whenNotPaused view returns (uint256) {
        require(
