...
contract Gloxis is ERC721, VRFConsumerBase {
    ...
    int16 maxRGBValue = 255;

    uint8[] randomNumberDigits;
    ...
    // function generateRGB(uint16 _randomNumber) internal returns (RGB memory) {
    //     return
    //         RGB(
    //             _randomNumber[0:2] <= maxRGBValue
    //                 ? _randomNumber[0:2]
    //                 : maxRGBValue,
    //             _randomNumber[1:3] <= maxRGBValue
    //                 ? _randomNumber[1:3]
    //                 : maxRGBValue,
    //             _randomNumber[2:4] <= maxRGBValue
    //                 ? _randomNumber[2:4]
    //                 : maxRGBValue
    //         );
    // }

    // function generateRandomNumberArray(uint256 _randomNumber) {
    //     delete randomNumberDigits;
    //     uint256 returnNum = _randomNumber;
    //     while (returnNum > 99) {
    //         uint8 digit = uint8(returnNum % 100);
    //         returnNum = returnNum / 100;
    //         randomNumberDigits.push(digit);
    //     }
    // }

    // function test() public {
    //     uint256 newId = characters.length;
    //     ColorPalette memory colorPalette = createColorPalette(123);
    //     Character memory character;
    //     character.name = "lucas";
    //     character.colorPalette = colorPalette;
    //     character.level = 1;
    //     character.manaCount = 25;
    //     character.readyTime = uint32(block.timestamp);
    ...
    {
        uint256 newId = characters.length;
        // generateRandomNumberArray(randomNumber);
        // ColorPalette storage colorPalette = createColorPalette(randomNumber);
        ...
        characters.push(
            Character(
                ...
                [
                    randomNumber % 100,
                    (randomNumber % 1000) / 10,
                    (randomNumber % 10000) / 100
                ]

                // generateRGB(randomNumber[0:4]),
                // generateRGB(randomNumber[1:5]),
                // generateRGB(randomNumber[2:6]),
                // generateRGB(randomNumber[3:7]),
                // generateRGB(randomNumber[4:8]),
                // generateRGB(randomNumber[5:9]),
                // generateRGB(randomNumber[6:10]),
                // generateRGB(randomNumber[7:11]),
                // generateRGB(randomNumber[8:12]),
                // generateRGB(randomNumber[9:13]),
                // generateRGB(randomNumber[10:14]),
                // generateRGB(randomNumber[11:15]),
                // generateRGB(randomNumber[12:16]),
                // generateRGB(randomNumber[13:17]),
                // generateRGB(randomNumber[14:18]),
                // generateRGB(randomNumber[15:19]),
                // generateRGB(randomNumber[16:20]),
                // generateRGB(randomNumber[17:21])
