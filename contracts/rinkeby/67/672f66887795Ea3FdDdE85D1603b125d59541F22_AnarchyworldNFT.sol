...
// File: contracts/0_AnarchyNFT.sol
...
contract AnarchyworldNFT is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory _initIpfsURI) ERC721("AnarchyWorld", "AW") 
    {
        setCost(0.004 ether, 0.003 ether);
    ...
    function pause(bool yes) public onlyOwner
    {
        _paused = yes;
    }
    ...
    function mint(address to, uint256 mintAmount) public payable
    {
        ...
        require(!_paused || entry.isWhitelisted);
        ...
        if (msg.sender != owner())
        {
            uint256 currentCost = entry.isWhitelisted ? _cost : _lowCost;
    ...
    function addWhitelistEntries(address[] calldata addrs, uint[] calldata freeMintList) public onlyOwner
    {
