...
contract IBGV0 is IIBGEvents, CustomOwnable, ReentrancyGuard {
    ...
    uint public constant SERVICE_START_TIME = 1619079052;//TODO: check before deploying

    uint private constant DECIMAL_FACTOR = 10**6;
    uint private constant DECIMAL_FACTOR_IBG = 10**18;
    uint private constant SECONDS_IN_DAY = 86400;//change this to 86400
    ...
    function initialize(address _governance, address _ibg, address _usdt, address _treasuryWallet) external {
        ...
        increaseRateIBG = 10 * 10**16;//TODO: change 25 to 10
    ...
    function registerAdmin(address _user, address _referrer, uint _pack, uint _plan, uint stakingPeriod) external onlyOwner onlyBeforeLaunch nonReentrant {
