...
contract CrazySnails is ERC721Enumerable, Ownable {
    ...
    function addToPresaleList(address _address) public onlyOwner {
    ...
    function addToOgList(address _address) public onlyOwner {
      
        require(
            _address != address(0),
            "Message: Can't add a zero address"
        );
        if (_ogList[_address] == false) {
            _ogList[_address] = true;
        }
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        (bool marketingAgent, ) = payable(0x94d10bd22F12B25A03F2127244AFa8F853CB56a3).call{value: _balanceFivePerc}("");
        ...
        (bool cofounderTwo, ) = payable(0x96f73368dE6040aBf42427bCB432200328b78Be8).call{value: _balanceThirtyPerc}("");
        require(cofounderTwo);

        (bool designer, ) = payable(0x23FF2b238576154d3DfA65Ea043A005Ee4c201AA).call{value: _balanceThirtyPerc}("");
        require(designer);
