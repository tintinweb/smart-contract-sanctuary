...
contract Layerx is IERC20, Owned {
    ...
    IERC20 UNILAYER = IERC20(0x47a7747972CDeC8f568E1984f31b5ef514Df5Dd8);// ETH MAINNET = 0x0fF6ffcFDa92c53F615a4A75D982f399C989366b;
    ...
    */
    function withdraw(uint index) external paused exist(index) {
        ...
        require(rwds.isReceived == false, 'You have already withdrawn rewards.');
        require(balances[owner] >= rwds.layersx, 'Insufficient account balance.');
        require(address(this).balance >= rwds.eth,'Invalid account state, insufficient funds.');
