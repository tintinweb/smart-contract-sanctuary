...
contract Loomi is ERC20, ReentrancyGuard, Ownable {
    ...
    constructor() ERC20("LOOMI", "LOOMI") {
      ...
      // depositedAmount[_msgSender()] = 123;
      // spentAmount[_msgSender()] = 23;
    ...
    */
    function depositLoomi(uint256 amount) public nonReentrant {
    ...
    */
    function withdrawLoomi(uint256 amount) public nonReentrant {
      require(getUserBalance(_msgSender()) >= amount, "Insufficient balance");

      uint256 tax;

      if (!withdrawTaxCollectionStopped) {
        tax = (amount * withdrawTaxAmount) / 100;
    ...
    */
    function claimLoomiTax(address user, uint256 amount) public onlyAuthorised {
    ...
    */
    function changeStakingContract(address _staking) public onlyOwner {
    ...
    */
    function updateWithdrawTaxAmount(uint256 _taxAmount) public onlyOwner {
      require(_taxAmount < MAX_CHANCE_VALUE, "Wrong value passed");
