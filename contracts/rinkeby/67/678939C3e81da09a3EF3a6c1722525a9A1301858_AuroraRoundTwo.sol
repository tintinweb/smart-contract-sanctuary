...
contract AuroraRoundTwo  is Ownable {
    ...
    uint256 public price = 40000;
	uint256 public thelowestquantitybuytogetbonus = 500000000;
	bool public offbuy;
	...
	function BuyTokenAur(address _sponsor, uint256 _balance) public {
		...
		if(_balance >= thelowestquantitybuytogetbonus){
			uint256 bonus = _balance.mul(5).mul(10**aurDecinal).div(100).div(price);
