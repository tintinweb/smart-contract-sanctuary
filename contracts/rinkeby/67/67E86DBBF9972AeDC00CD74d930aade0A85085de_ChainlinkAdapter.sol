...
library Constants {
    ...
    uint256 internal constant DAY = 30;
    // We use six day weeks to ensure that all time references divide evenly
    uint256 internal constant WEEK =180;
    uint256 internal constant MONTH =900;
    uint256 internal constant QUARTER = 3600;
...
contract ChainlinkAdapter is AggregatorV2V3Interface {
    ...
    int256 public price = 260718752525687  ;
    constructor (
        ...
        baseToUSDDecimals = int256(10**8);
        quoteToUSDDecimals = int256(10**8);
    }
    ...
    function _calculateBaseToQuote() internal view returns (
        ...
        return (36893488147419103532,price,block.timestamp,block.timestamp,36893488147419103532);
    }
