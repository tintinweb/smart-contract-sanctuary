...
contract BluntHeads is ERC1155, Ownable, Pausable, ERC1155Burnable
{
    ...
    string public _BASE_URI = "https://ipfs.io/ipfs/Qma9tU3y57va3BVoKNCwz3z2RkKp2Lp6nUtN6YYtVdNyW3/";
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/Qma9tU3y57va3BVoKNCwz3z2RkKp2Lp6nUtN6YYtVdNyW3/{id}.json") 
    {
    ...
    function BluntHeadsMint(uint numberOfTokens) public payable
    {
        ...
        require(_BLUNT_PRICE.mul(numberOfTokens) <= msg.value, "Ether value sent is not correct. 0.03 ETH Per Blunt | 30000000000000000 WEI");
