...
contract ERC721CollectionImplementation is ERC721CollectionBase, AdminControlUpgradeable {
     ...
     */
    function activate(uint256 startTime_, uint256 duration) external override adminRequired {
        _activate(startTime_, duration);
    }
...
abstract contract ERC721CollectionBase is ReentrancyGuard, CreatorExtension, IERC721Collection, ICreatorExtensionTokenURI {
     ...
     * Activate the sale
     */
    function _activate(uint256 startTime_, uint256 duration) internal virtual {
        require(!active, "Already active");
...
interface IERC721Collection is IERC165 {
     ...
     */
    function activate(uint256 startTime_, uint256 duration) external;
