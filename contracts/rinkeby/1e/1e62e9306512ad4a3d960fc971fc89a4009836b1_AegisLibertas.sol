...
// Simple Aegis Operator management contract
 ...
 * @notice Trying to use Token to Contracts that doesn't accept tokens and doesn't have tokenFallback function will fail, and all contracts
 * must comply to ERC223 compliance. 
*/
contract AegisLibertas is ERC223, BurnableToken, Ownable, MintableToken, OperatorManaged {
    
    event Finalized();

    string public name = "Aegis Libertas";
