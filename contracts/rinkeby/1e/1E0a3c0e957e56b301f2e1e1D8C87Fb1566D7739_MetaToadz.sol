...
contract MetaToadz is ERC721Enumerable, Ownable
{
    uint256 public constant _maxSupply = 4;    
    uint256 public constant _tokensAllowedPerMint = 1;
    uint256 public constant _initialReserve = 4;
    string private constant _tokenBaseURI = "ipfs://QmdCqwcue7gB5QGGsNSob4KC4CPJp8ppVaHAVD3w63jvch/";

    bool public _bIsPaused = true;
    uint256 public _price = 0.05 ether;

    constructor() 
    ERC721("MetaToadz", "MTOADZ")
    {
