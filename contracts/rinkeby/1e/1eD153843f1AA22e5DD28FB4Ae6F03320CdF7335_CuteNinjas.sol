...
contract CuteNinjas is ERC721, Ownable {
    ...
    uint16 public constant MAX_NINJAS = 20;
    ...
    function startSale() public onlyOwner {
      require(_hasSaleStarted == true, "Sale has already started.");
      _hasSaleStarted = true;
    }

    function pauseSale() public onlyOwner {
      require(_hasSaleStarted == false, "Sale has already been paused.");
    ...
    function mintNFT(uint8 numNinjas) public payable returns (uint256) {
