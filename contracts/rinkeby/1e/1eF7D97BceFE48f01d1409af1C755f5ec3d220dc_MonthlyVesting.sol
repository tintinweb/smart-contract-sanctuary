...
contract MonthlyVesting is VestingWallet {
    uint64 time_OneDay = 24 * 60 * 60;
    uint64 time_OneHour = 60 * 60;
    uint64 time_TenMinutes = 10 * 60;
    uint64 time_FiveMinutes = 5 * 60;


    uint64 timeStep = time_FiveMinutes;
    constructor(uint64 _timeStep) VestingWallet(0xA6827b05ACf553550a61aDE21dd51ea43eD576da,1638842311, time_OneDay) {
        timeStep = _timeStep;
    }
