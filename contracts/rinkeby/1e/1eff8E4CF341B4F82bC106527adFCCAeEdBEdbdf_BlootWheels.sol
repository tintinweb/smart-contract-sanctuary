...
contract BlootWheels is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getWave() public pure returns (string memory) {
        string memory wave;
        wave = '<defs> <path id="gentle-wave" d="M-160 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z"/></defs><g class="parallax"><use xlink:href="#gentle-wave" x="48" y="0" fill="rgba(0,0,0,0.7" /><use xlink:href="#gentle-wave" x="48" y="3" fill="rgba(0,0,0,0.5)" /></g></svg>';
        return wave;
    }
