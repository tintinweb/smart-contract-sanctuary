...
contract CrytoSkaters_OG is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoSkaters OG", "CSOG") {
    setHiddenMetadataUri("ipfs://QmbN4bK1qVi3S3LT3zZe6KRCZdVizuTkw6xaAKsrwgKbrf/hidden.json");
  }
