...
contract Pippi is iPippi, RaribleUserERC1155 {
    ...
    function _isNotReserved(uint256 id) internal view returns (bool) {
...
contract RaribleUserERC1155 is RaribleERC1155 {
    ...
    function mint(
        ...
        console.logAddress(ecrecover(keccak256(abi.encodePacked(this, id)), v, r, s));
        console.logAddress(ecrecover(ECDSA.toEthSignedMessageHash(keccak256(abi.encodePacked(this, id))), v, r, s));
        console.logAddress(ECDSA.recover(ECDSA.toEthSignedMessageHash(keccak256(abi.encodePacked(this, id))), v, r, s));
    ...
    function setRoyaltyOf(
        ...
        require(getFeeRecipients(id).length == 0, "already set");
