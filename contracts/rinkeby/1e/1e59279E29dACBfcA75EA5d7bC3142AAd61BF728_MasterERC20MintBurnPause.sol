...
import "../../token/ERC20/ERC20MintBurnPause.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20MintBurnPause is ContractOwnable, IMasterERC20 {
  ERC20MintBurnPause[] private childERC20MintBurnPause;
  ...
  function createERC20(
    ...
    ERC20MintBurnPause child = new ERC20MintBurnPause(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20MintBurnPause.push(child);
