...
contract SwarmNft is ERC1155Tradable {
    ...
    ERC1155Tradable(
        ...
        _setBaseMetadataURI("https://bee-1.gateway.ethswarm.org/bzz/");
    }
    ...
    function createAndTransfer(
        ...
        uint256 _id = this.create(msg.sender, _recipients.length, _uri, _data);
        setUri(_id, _uri);
    ...
    function mintAndTransfer(
        ...
        require(_recipients.length > 0, "Empty recipients list");
        this.mint(msg.sender, _id, _recipients.length, _data);
