...
contract Immutable is ERC1155, ERC1155Holder, NativeMetaTransaction, Ownable
{
    using SafeMath for uint256;
    string constant NAME = "Immutable";
    string constant SYMBOL = "IMMT";
    ...
    uint256 constant price = 0.00000005 ether;
