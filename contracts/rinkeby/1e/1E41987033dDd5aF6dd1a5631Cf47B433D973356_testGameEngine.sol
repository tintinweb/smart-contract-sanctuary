...
/// @dev Inheriting contracts can use this to get Implementation and Admin access
contract Proxied {
...
contract testGameEngine is Ownable, ReentrancyGuard , Proxied {
    ...
    function initialize(address _randomEngineAddress, address _nftAddress, address _tokenAddress,address _metadata) external {
        require(msg.sender == _getAddress(ADMIN_SLOT), "not allowed");
        _owner = msg.sender;
