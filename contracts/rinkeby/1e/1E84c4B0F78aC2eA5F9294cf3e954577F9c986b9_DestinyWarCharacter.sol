...
contract DestinyWarCharacter is ERC721, ERC721Enumerable, Ownable {
        ...
        returns (string memory)
    {
        ...
        //     : "";
        string memory currentBaseURI = tokenId > amntNormal ? normalImgUri : rareImgUri;
        uint256 imgId = tokenId > amntNormal ? random(amntNormalImg) : random(amntRareImg);
        return string(abi.encodePacked(currentBaseURI, imgId.toString(), baseImgExtension));
    }
