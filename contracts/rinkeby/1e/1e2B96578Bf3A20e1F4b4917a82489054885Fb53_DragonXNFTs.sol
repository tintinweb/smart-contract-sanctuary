...
contract DragonXNFTs is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(
    ...
    // mint(msg.sender, 10);
    // After launching and giving 100 tokens to Owner, maxMintAmount
    // sets to 20 and walletLimit sets to 3.
    // maxMintAmount = 5;
    // walletLimit = 50;
