...
contract PetToken is RawToken {
    ...
    function getTotalTokens() public override view returns (uint256, uint256, uint256, uint256){
...
ERC721Burnable {
    ...
    function getTotalTokens() public virtual view returns (uint256, uint256, uint256, uint256);
