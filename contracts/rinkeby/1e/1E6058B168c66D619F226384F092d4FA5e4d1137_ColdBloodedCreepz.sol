...
contract ColdBloodedCreepz is Context, ERC721Enumerable, VRFConsumerBase, Ownable, ReentrancyGuard  {
  ...
  // Provenance hash
  string public PROVENANCE_HASH = "c42c2d712b7b41db2c4a9e7e985099d8a9c4602896ef46d38875c1056f62ed5b";
  ...
  mapping(address => mapping(address => uint)) public _mintPassesUsed;
  ...
  constructor(address _royaltyAddress, address _signerAddress, address _fxc, address _invasionPass)
