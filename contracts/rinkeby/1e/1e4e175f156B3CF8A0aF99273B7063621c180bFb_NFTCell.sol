...
contract NFTCell is Evolable, IFactory, Ownable, ReentrancyGuard {
...
//        require(cell.nextEvolutionBlock > block.number, "You are ready to evolve");
    ...
    constructor(address _owner, address _proxyRegistryAddress) {
    ...
    function mint(uint256 _optionId, address _toAddress) override public nonReentrant() {
...
contract CellToken is ERC1155, ICellToken, Ownable {
    ...
    constructor(address _owner, address _proxyRegistryAddress) ERC1155("https://cell-bucket.s3.eu-north-1.amazonaws.com/metadata/{id}.json") {
        require(_owner != address(0), "Address should not be empty");
