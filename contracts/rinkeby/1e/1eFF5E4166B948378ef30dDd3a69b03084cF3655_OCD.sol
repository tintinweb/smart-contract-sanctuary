...
contract OCD is ERC721Enumerable, Ownable {
    ...
    function tokenURI(uint256 _tokenId) public pure override returns (string memory){
        ...
        OCDGenerator.OCDRands memory ocdone;
        string memory svg = OCDGenerator.getOCDForSeed(Strings.toString(_tokenId * 321));
        ocdone = OCDGenerator.randomOCD(Strings.toString(_tokenId * 321));
        string memory aparts = string(abi.encodePacked(
              '[{"trait_type": "Background","value": "', Strings.toString(ocdone.bg),
              '"},{"trait_type": "Flap","value": "', Strings.toString(ocdone.flap),
              '"},{"trait_type": "Side","value": "',Strings.toString(ocdone.side),
              '"},{"trait_type": "Eyes","value": "',Strings.toString(ocdone.hole),
              '"},{"trait_type": "Eyecover","value": "',Strings.toString(ocdone.eyecover),
              '"},{"trait_type": "Brews","value": "',Strings.toString(ocdone.brws),
              '"},{"trait_type": "Top","value": "',Strings.toString(ocdone.top),
              '"}]'
              ));
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "OnChainD", "description": "OnChainNoobs","attributes":', aparts, ', "image": "data:image/svg+xml;base64,', Base64.encode(bytes(svg)),'"}'))));
