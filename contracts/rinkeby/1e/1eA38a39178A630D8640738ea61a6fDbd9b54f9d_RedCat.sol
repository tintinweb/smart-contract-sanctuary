...
contract RedCat is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("RedCat", "RCN") {
        ...
        for(uint256 i = 0; i <= 1; i++) {
            ...
            redCats[i] = RedCatData(4, false, true);           
        }
        getAirDropNFT();
    }
    ...
    function getAirDropNFT() private {
        ...
        redCats[2] = RedCatData(0, false, true);
        redCats[3] = RedCatData(0, false, true);
        redCats[4] = RedCatData(2, false, true);
        redCats[5] = RedCatData(0, false, true);
        redCats[6] = RedCatData(0, false, true);
        redCats[7] = RedCatData(1, false, true);
        redCats[8] = RedCatData(0, false, true);
        redCats[9] = RedCatData(0, false, true);
        redCats[10] = RedCatData(0, false, true);
        redCats[11] = RedCatData(0, false, true);
    }
