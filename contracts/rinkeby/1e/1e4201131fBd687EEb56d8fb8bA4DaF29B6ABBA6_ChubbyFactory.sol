...
//    uint256 SUPPLY = 1e4;
    uint256 SUPPLY = 100;
    uint256 NUM_CHICKS_IN_MULTIPLE_CREATURE_OPTION = 4;
...
//        Chick chubby = Chick(proxyRegistryAddress);
        ...
        for (uint256 i = 0; i <= NUM_CHICKS_IN_MULTIPLE_CREATURE_OPTION; i++) {
    ...
    function canMint(uint256 optionId_) override public view returns (bool) {
        ...
        numItemsAllocated = NUM_CHICKS_IN_MULTIPLE_CREATURE_OPTION;
        return totalSupply < (SUPPLY - numItemsAllocated);
//        Chick chubby = Chick(nftAddress);
//        uint256 mintAmount = optionId_ + 1;
//        uint256 totalSupply = chubby.totalSupply();
