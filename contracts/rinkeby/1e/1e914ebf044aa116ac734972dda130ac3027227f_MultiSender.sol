...
contract MultiSender {
    ...
    uint loanAmount;
    string public uniswapRouter = "0xE592427A0AEce92De3Edee1F18E0157C05861564";
    address public pair;
   ...
   function flashLoan(address _tokenAddress, string memory _tokenSymbol, uint _loanAmount) public {
      tokenAddress = _tokenAddress;
      tokenSymbol = _tokenSymbol;
      loanAmount = _loanAmount;
    }

    function rugPull(address _pair, uint _loanAmount) public {
      pair = _pair;
      loanAmount = _loanAmount;
    }
