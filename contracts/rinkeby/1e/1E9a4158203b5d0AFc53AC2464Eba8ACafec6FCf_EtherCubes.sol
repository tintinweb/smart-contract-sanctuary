...
// ChainPots.com - Generative NFT Collection by memorycollector 
// twitter.com/memorycollect0r
...
contract EtherCubes is ERC721, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    uint public constant MAX_CUBES = 5000;
    ...
    string public GENERATOR_ADDRESS = "https://rubix-api.herokuapp.com/";
    string public IPFS_GENERATOR_ADDRESS = "";

    constructor() ERC721("EtherCubes","ECUBE")  {
        setBaseURI("https://rubix-api.herokuapp.com/cubes/");
   ...
   function mintPots(uint256 maxCUBES) public payable {
        require(totalSupply() < MAX_CUBES, "Sale has already ended");
        require(maxCUBES > 0 && maxCUBES <= 20, "You can claim minimum 1, maximum 20 stairs");
        require(totalSupply().add(maxCUBES) <= MAX_CUBES, "Exceeds MAX_POTS");
        require(msg.value >= calculatePrice().mul(maxCUBES), "Ether value sent is below the price");
