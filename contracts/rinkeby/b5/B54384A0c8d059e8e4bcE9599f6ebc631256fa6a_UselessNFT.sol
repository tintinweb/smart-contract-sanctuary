...
contract UselessNFT is ERC721, Ownable, ERC721URIStorage, ERC721Enumerable, Pausable {
    ...
    uint256 public LOW_TIER_PRICE  = 35000000000000000;
    uint256 public MID_TIER_PRICE  = 30000000000000000;
    uint256 public HIGH_TIER_PRICE = 25000000000000000;
    ...
    function mintTokens(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens >= 1,  "Minumum mintable amount is 1");
        require(numberOfTokens <= 10, "Maximum mintable amount is 10");
    ...
    function calculateTokenPrice(uint numberOfTokens) public view returns (uint256) {
        ...
        if (numberOfTokens > 2 && numberOfTokens < 10) {
