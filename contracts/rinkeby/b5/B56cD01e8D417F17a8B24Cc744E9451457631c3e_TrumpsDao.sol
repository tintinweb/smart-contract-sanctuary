...
contract TrumpsDao is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmWppNT6d3HEGWPooaKAM2FkqCDCtPmTHk92hG27QjwJb2";
    ...
    constructor(
    ) ERC721A("TrumpsDao", "TRMP", 20, maxSupply) {
    }
    ...
    function ownerMint(address _address) 
        external
        onlyOwner
    {
