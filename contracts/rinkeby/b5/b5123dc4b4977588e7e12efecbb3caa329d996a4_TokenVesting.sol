...
contract TokenVesting is Ownable, ReentrancyGuard {
        ...
        returns (uint256 claimedTokens, uint8 claimedPeriods)
    {
        ...
        // Events
        emit FundsClaimed(beneficiary, claimableTokens, claimablePeriods);
        _broadcastStateChanges();
    ...
    function _broadcastStateChanges() private {
        emit GlobalStateUpdated(vestedFunds, unVestedFunds, claimedFunds);
    }
}