...
interface IERC721 is IERC165 {
    ...
    function mintAndTransfer(address from, address to, uint256 itemId, uint256 fee, string memory _tokenURI, bytes memory data)external returns(bool);
}
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  // mapping for token creator
    ...
    */
    ...
    function mintAndTransfer(address from, address to, uint256 itemId, uint256 fee, string memory _tokenURI, bytes memory data) public virtual override returns(bool){
        require(isApprovedForAll(from,msg.sender),"ERC721: caller is not Approved");
        itemId = tokenCounter;
...
contract LazyMintNft721 is ERC721 {
    address private owner;
