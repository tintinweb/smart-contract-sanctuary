...
contract FeudalPunks is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 constant MAX_SUPPLY = 8888;

    uint256 public price = 0.02 ether;
    uint256 public splitterId;
    bool public hasSaleStarted = false;

    PaymentSplitter _splitter;

    constructor() ERC721("Feudal Punks", "FPUNK") {
        _splitter = PaymentSplitter(0xDC7130df63647f891dCC8B0f99bdEfFEE600bF81); //TODO: TROCAR PARA MAINNET
    }
    ...
    function setSplitterId(uint256 id) external onlyOwner {
        splitterId = id;
    }
