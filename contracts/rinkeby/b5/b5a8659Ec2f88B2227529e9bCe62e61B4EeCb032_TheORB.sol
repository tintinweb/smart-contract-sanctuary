...
contract TheORB is Context, IBEP20, Ownable {
    ...
    bool isApproveEnabled;      // Approves are disabled until after the presale ends because otherwise people could provide liquidity on their own.
