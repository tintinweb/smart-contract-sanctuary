...
contract MainchainGatewayManager is MainchainGatewayStorage {
    ...
    // function withdrawToken(uint256 _withdrawalId, address _token, uint256 _amount, bytes memory _signatures) public whenNotPaused {
    //     withdrawTokenFor(_withdrawalId, msg.sender, _token, _amount, _signatures);
    // }

    // function withdrawTokenFor(uint256 _withdrawalId, address _user, address _token, uint256 _amount, bytes memory _signatures) public whenNotPaused {
