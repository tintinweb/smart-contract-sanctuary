...
interface IStaker {
  ...
  function poolInfo ( address ) external view returns ( address token, uint256 tokenStrength, uint256 tokensPerShare, uint256 pointStrength, uint256 pointsPerShare, uint256 lastRewardBlock );
