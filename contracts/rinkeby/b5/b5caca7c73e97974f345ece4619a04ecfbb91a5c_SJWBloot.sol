...
contract SJWBloot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function svblootOwnerFreeClaim() public nonReentrant {
        require(svblootOwnersSupply < 2000, "No more bloot owner claims");
        require(totalSupply() < maxSupply, "No more tokens to mint");
        require(svblootContract.balanceOf(msg.sender) > 0, "Must own a bloot to claim from this method");
        uint index = totalSupply();
