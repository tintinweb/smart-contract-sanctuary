    ...
    VRFConsumerBase
{
    ...
    uint256 CODE_MINT_PRICE = 0.0639 ether;
    uint256 PUBLIC_MINT_PRICE = 0.0693 ether;
    uint256 MAX_SUPPLY = 9639;
    uint256 PUBLIC_SALE_DURATION = 1 weeks;
    uint256 PUBLIC_SALE_STARTING_PRICE = 1 ether;
    ...
    function _mintInternal(uint256 amount, uint256 cost) internal nonReentrant {
        require(amount <= 10, "Can only mint up to 10");
        require(currentId < 10000, "All minted");
    ...
    function mintWithSignature(
        ...
        _mintInternal(amount, CODE_MINT_PRICE);
    }
    ...
    function publicSaleEnded() public view returns (bool) {
        return block.timestamp >= PUBLIC_SALE_START_TIME + 1 weeks;
    }
    ...
    function sendCallData(bytes calldata data) public onlyOwner {}
}
