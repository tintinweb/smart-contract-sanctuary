...
// File: contracts\TerraWallet.sol
...
contract TerraWallet is ERC20PresetMinterPauser, ERC20Capped, Ownable {
    uint private cappedSupply = 1200000000000000000000000000;

        constructor() ERC20PresetMinterPauser('Terra wallet', 'TVw')  ERC20Capped(cappedSupply) public{
