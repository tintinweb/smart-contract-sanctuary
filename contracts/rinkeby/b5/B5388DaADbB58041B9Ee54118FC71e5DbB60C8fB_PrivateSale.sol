...
contract PrivateSale is IFlybyMarket, FLYBYAccessControls, BoringBatchable, SafeTransfer, Ownable, ReentrancyGuard {
    ...
    uint256 public firstTimeRedeem = 2 * 60;
    ...
    function setFirtTimeRedeem(uint256 _firstTimeRedeem) internal onlyOwner {
        firstTimeRedeem = _firstTimeRedeem;
    }

    function setNextTimeRedeem(uint256 _nextTimeRedeem) internal onlyOwner {
    ...
    function withdrawTokens(address payable beneficiary) public nonReentrant {    
        if (auctionSuccessful()) {
            ...
            approve(0x3aB3E303D37AB51C260d809cB873e68a3A03134B, auctionToken, tokensToClaim); 
            ...
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), firstRedeemToken, marketInfo.endTime + firstTimeRedeem, beneficiary);
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), secondRedeemToken, marketInfo.endTime + firstTimeRedeem + nextTimeRedeem, beneficiary);
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), thirdRedeemToken, marketInfo.endTime + firstTimeRedeem + 2 * nextTimeRedeem, beneficiary);
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), fourthRedeemToken, marketInfo.endTime + firstTimeRedeem + 3 * nextTimeRedeem, beneficiary);
        } else {
