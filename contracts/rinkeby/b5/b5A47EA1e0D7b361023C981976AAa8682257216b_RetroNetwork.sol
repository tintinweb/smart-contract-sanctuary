    ...
    AccessControlUpgradeable
{
    ...
    event RecoverBlackFunds(address _from, address _to, uint256 _howmuch, uint256 _when);
    event BurnBlackFunds(address _from, address _to, uint256 _howmuch, uint256 _when);
    ...
    function initialize(
        ...
        __ERC20_init("RetroNetwork", "RETRO");
    ...
    function recoverBlackFunds(address _from, address _to, uint256 _howmuch)
        public
    ...
    function burnBlackFunds(address _from, address _to, uint256 _howmuch)
        public
        onlyRole(GOVERNANCE_ROLE)
    {
        require(
        ...
        _updateBlackList(_from, false);
        _transfer(_from, address(0), _howmuch);
        _updateBlackList(_from, true);
        emit BurnBlackFunds(_from, _to, _howmuch, block.timestamp);
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(!getBlackListStatus(from), "BeforeTokenTransfer:: User blacklisted");
