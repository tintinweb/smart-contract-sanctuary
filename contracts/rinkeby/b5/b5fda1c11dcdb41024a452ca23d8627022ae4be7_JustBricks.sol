...
pragma solidity 0.8.7;
    ...
    contract JustBricks is ERC721Enumerable, Ownable {
        using Strings for uint256;
        ...
        mapping ( uint256 => address payable ) public royaltyContract;
        
        uint256 public royaltyRate = 3;
        ...
        constructor (
            ...
            function setRoyaltyContract( uint256 _tokenId, address payable _address ) public onlyOwner {
                require ( _address != address(0) , "No Zero Address");
                royaltyContract[_tokenId] = _address;
            }

            function royaltyInfo( uint256 _tokenId, uint256 _salePrice ) public view returns ( address receiver, uint256 royaltyAmount ) {
                receiver = royaltyContract[_tokenId];
                royaltyAmount = (_salePrice * royaltyRate / 100);
            }
