...
contract RedCat is ERC721Enumerable, Ownable {
    ...
    event Adpot(address owner, uint tokenId, uint time);
    ...
    mapping (uint => bool) public bans;
    mapping (uint => bool) public unboxes;
    ...
    function getAirDropNFT() private {
        ...
        redcats[2] = RedCatData(0);
        redcats[3] = RedCatData(0);
        redcats[4] = RedCatData(2);
        redcats[5] = RedCatData(0);
        redcats[6] = RedCatData(0);
        redcats[7] = RedCatData(1);
        redcats[8] = RedCatData(0);
        redcats[9] = RedCatData(0);
        redcats[10] = RedCatData(0);
        redcats[11] = RedCatData(0);
    }
