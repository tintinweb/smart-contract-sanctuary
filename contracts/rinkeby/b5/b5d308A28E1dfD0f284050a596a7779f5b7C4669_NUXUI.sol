    ...
    AccessControl
{
    ...
    uint8 public constant MAX_MINT_COUNT = 6;       // +1 to save on gas cost of <= vs <
    uint8 public constant ARTIST_PROOF_COUNT = 11;  // +1 to save on gas cost of <= vs <
    uint256 public constant MAX_SUPPLY = 333;       // +1 to save on gas cost of <= vs <
    uint public constant ETH_PRICE = 0.2 ether;
