...
contract stuffx5 is ERC721, ReentrancyGuard, Ownable {
    ...
    uint256[] private teamShares = [30,30,20,20];
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        _widthdraw(teamWallets[1], balance.mul(teamShares[1]).div(100));
        _widthdraw(teamWallets[2], balance.mul(teamShares[2]).div(100));
