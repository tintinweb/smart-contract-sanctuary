...
contract CoinDeed is ICoinDeed, AccessControl, ReentrancyGuard {
    ...
    function _convertTokens(
        ...
        FeedRegistryInterface feedRegistry = FeedRegistryInterface(coinDeedFactory.feedRegistryAddress());
        uint256 answer = uint256(feedRegistry.latestAnswer(tokenA, tokenB));
        require(answer > 0, "Invalid oracle answer");

        uint8 decimals = feedRegistry.decimals(tokenA, tokenB);
        return tokenAAmount * answer / decimals;
    }
