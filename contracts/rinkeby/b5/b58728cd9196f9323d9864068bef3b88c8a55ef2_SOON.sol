...
contract SOON is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x508ca0CCDF1a76879079Ac6f65E4B0365284410f);
    address payable private _marketingAddress = payable(0xc968947204352d75BFF5bAea51C7D11956d91C95);
    
    string private constant _name = "Soon Token";
