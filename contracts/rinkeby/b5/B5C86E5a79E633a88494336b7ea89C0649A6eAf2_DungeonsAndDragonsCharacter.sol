...
function requestNewRandomCharacter(uint256 _userProvidedSeed, string memory name) public returns(bytes32){
...
internal override{
    ...
    uint256 speed = ((_randomNumber % 10000) / 100);
    uint256 stamina = ((_randomNumber % 1000000) / 10000);
