...
contract MintingPass is ERC1155, Ownable {
    ...
    function mint(uint256 passId, uint256 amount) public payable returns (bool) {
        ...
        require(passId <= mintingPasses.length, "MintingPass::mint: mintingPassId doesn't exist");
        require(msg.value == mintingPasses[passId].rate * amount, "MintingPass::mint: not enough ether sent");
    ...
    function getMintingPasses() public view returns (MintingPassData[] memory) {
