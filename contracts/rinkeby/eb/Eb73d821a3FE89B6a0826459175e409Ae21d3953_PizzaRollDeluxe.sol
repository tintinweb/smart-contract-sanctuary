...
pragma solidity ^0.8.0;
/**
 * @title PizzaRollDeluxe contract
 * @dev Extends ERC721 Token
 */
contract PizzaRollDeluxe is ERC721, ERC721Enumerable, Ownable {

    using Strings for uint256;

    uint256 public salePrice = 0.23 ether;
    uint public constant maxNFTsPerTx = 1;
    uint256 public MAX_SUPPLY = 300;
    bool public saleIsActive = false;

    constructor() ERC721("PizzaRollDeluxe", "PIZZA") {
    }
    ...
    function mint() public payable {
        ...
        require(totalSupply() + 1 <= MAX_SUPPLY, "Mint would exceed max supply of NFTs");
    ...
    // Allow for Extending the Contract Functionality, no plans to enable this at this time
    address burnOrMint;
    ...
    function withdraw() public onlyOwner {
        address sendTo = withdrawAddress;
        if (sendTo == address(0)) {
            sendTo = msg.sender;
        }
