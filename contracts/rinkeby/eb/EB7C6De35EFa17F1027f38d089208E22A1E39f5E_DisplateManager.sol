...
contract DisplateManager is CloneFactory, Ownable {
    ...
    constructor(address _accessManangerAddress) {
    ...
    function NFTDrop(
        ...
        require(
            ...
            "You are not allowed to create drop"
        );
        NFT clonedNFT = NFT(createClone(_templateAddress));
        clonedNFT.init(
            _tokenName,
            _tokenSymbol,
            _totalAmountOfEdition,
...
contract NFT is ERC721URIStorage {
    ...
    function awardToken(
        ...
        emit TokenAwarded(_user, _name, _symbol, _tokenID, _tokenURI);
