...
contract EtherealCollectiveArtSupporter is ERC721, Ownable {
    ...
    uint256 public constant maxCollectiblePerPurchase = 9; // 1-3 tokens per transaction
    uint256 public constant maxCollectibles = 8168;
    uint256 public presalePurchaseLimit = 3; // PRESALE: 3 tokens per wallet maximum.
    uint256 public purchaseLimit = 12; // PUBLIC SALE: 10 tokens per wallet maximum.
    uint256 public collectibleReserve = 200; // FREE MINT FOR OWNERS
