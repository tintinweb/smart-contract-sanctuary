...
contract YTestStrategy {
    ...
    function getNameStrategy() public view returns (string memory){
        return name;
    }
    ...
    function withdraw(address _asset) public onlyController {
    ...
    function convert(address _token) public returns(uint){
        return 0;
    }
