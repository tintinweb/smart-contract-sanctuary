...
contract FoxGameNFT is IFoxGameNFT, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor(address carrot, address game, address traits) ERC721("FoxGame", "FOX") {
    ...
    // Tail (typo in FoxGameNFTTraits where 7 & 8 are swapped)
    rarities[8] = [ 255, 153, 204, 102 ];
    aliases[8] = [ 0, 0, 0, 1 ];
    // Fur (typo in FoxGameNFTTraits where 7 & 8 are swapped)
    rarities[7] = [ 255, 204, 153, 153 ];
    aliases[7] = [ 0, 0, 1, 1 ];
    // Feet
