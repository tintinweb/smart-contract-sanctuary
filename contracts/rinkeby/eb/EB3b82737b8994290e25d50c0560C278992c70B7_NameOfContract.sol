...
contract NameOfContract is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private baseURI_ = "http://google.com/";
  ...
  constructor() ERC721("Name of the contract", "POP") {
    setHiddenMetadataUri("ipfs://bafybeidc7ojlavxa622owbwmzwwnyaoki467sxogmkcdoo6ttzwbft3a4u/hidden_test.json");
  }
