...
contract ApprovingBone is ERC721Enumerable, Ownable {
    ...
    constructor(address owner) ERC721("ApprovingBone", "ACBONE")  {
    ...
    function isBoneMintActive() public view returns (bool){
...
contract ApprovingCorgis is ERC721Enumerable, Ownable {
    ...
    constructor(string memory tokenBaseUri, address boneContractAddress) ERC721("ApprovingCorgis", "CORGIS")  {
