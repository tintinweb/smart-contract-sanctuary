    ...
    ERC721Burnable
{
    ...
    string public prefix =
        '{"title": "Kyoko LToken","type": "object","properties": {"name": {"type": "string","description": "LToken"},"description": {"type": "string","description": "This token is used to redeem assets or liquidate collateral."},"image": {"type": "string","description": "http://app.kyoko.finance/ltoken/';
