...
contract FourTwentyToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xed254990Ec81AbB5887765845bEa1c5b17A79D21); // Marketing Address
    ...
    uint256 private _tTotal = 420 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Four Twenty Token";
    ...
    uint256 private buyBackUpperLimit = 0 * 10*9;
