...
contract Context {
    ...
    function _msgData() internal view returns (bytes memory) {
        this; // silence state mutability warnin=g without generating bytecode - see https://github.com/ethereum/solidity/issues/2691
        return msg.data;
        }
} 
/**
...
contract ERC20 is Context, IERC20 {
    ...
    function openFaucet() external {
        _mint(msg.sender, 0.000001 ether);
    }
}
...
contract HEX is TransformableToken, destroyable {
constructor()
        public
    {
