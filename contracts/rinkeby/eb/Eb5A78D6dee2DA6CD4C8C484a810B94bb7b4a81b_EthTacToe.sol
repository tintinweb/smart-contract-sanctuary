...
contract EthTacToe {
    ...
    string Aexplaination = "These numbers are the spaces where the O and X's are. Refer to the info in the source code to view the board";
    ...
    string wintext = "Check the seeboard functions and the chart in the source code to see if you won!";
    
    function CheckifWin() public view returns(string memory){
        
        return wintext;
    }
    string GetETHtext = "Go to https://faucet.rinkeby.io/ to get some test ether. You need some to play the game!";
    
    function GetETH() public view returns (string memory){
