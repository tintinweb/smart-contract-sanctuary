 ...
 * lengths to ensure that the contracts optimised to reduce the gas burden on the end user.
 */
...
contract TheWeirdos is ERC721Enumerable, Ownable {
    ...
    uint256 public constant mintPrice = 0.02 ether; //TODO: CHANGE THIS
    ...
    function publicMint(uint256 count) public payable {
        ...
        require(
            ...
            "Excedes current public mint supply"
        );
        require(count * mintPrice == msg.value, "Invalid funds provided");
