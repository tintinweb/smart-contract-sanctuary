 ...
 */
contract Obscurite is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mintNFT(uint256 numberOfTokens) public payable nonReentrant {
        ...
        if (presaleStatus && presaleVouchers[msg.sender] != 0) {
            require(presaleStatus, "NFT: Presale must be active.");
            ...
            require(publicStatus, "NFT: Public sale must be active.");
