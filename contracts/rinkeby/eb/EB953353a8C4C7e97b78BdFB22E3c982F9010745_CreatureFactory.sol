...
/**
 * @title BearTest
 * BearTest - a contract for my non-fungible creatures.
 */
contract BearTest is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Bear Test", "BT", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "http://beartest.herokuapp.com/api/creature/";
    }

    function contractURI() public pure returns (string memory) {
        return "http://beartest.herokuapp.com/contract/happy-bear-island";
    }
}
...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        BearTest openSeaCreature = BearTest(nftAddress);
