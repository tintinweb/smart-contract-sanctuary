...
// File: contracts/XTokenClonable.sol
...
// File: contracts/XTokenFactory.sol
...
contract XTokenFactory {
  ...
  function createXToken(
    ...
    XTokenClonable x = XTokenClonable(ClonesUpgradeable.cloneDeterministic(template, salt));
  ...
  function getXTokenAddress(bytes32 salt) external view returns (address) {
