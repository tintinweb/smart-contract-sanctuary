...
contract TheGringosNFT is ERC721Enumerable, Ownable {
    ...
    function setOwnerReserved(uint256 _ownerReserved) public onlyOwner {
        require(_ownerReserved <= 10000,'Owner reserved can not be more than 10000');
        OWNER_RESERVED = _ownerReserved;
    }

    function setMaxSupply(uint256 _max_supply) public onlyOwner {
        require(_max_supply <= 10000,'Max supply can not be more than 10000');
        MAX_SUPPLY = _max_supply;
    }

    function setPresaleReserved(uint256 _presale_reserved) public onlyOwner {
        require(_presale_reserved <= 10000,'Presale supply can not be more than 10000');
