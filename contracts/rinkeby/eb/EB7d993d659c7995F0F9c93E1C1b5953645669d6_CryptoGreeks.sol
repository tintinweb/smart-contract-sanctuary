...
contract CryptoGreeks is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private preSaleMax = 2000;
     ...
     */
    address t1 = 0x533230F4c84330E8d9fB49eBcEf3F9F9F6B5DB4e;
    address t2 = 0xf136698F0547fBf7D966fd7B1C1F807DC7cB5Ef5;
    ...
    */
    ...
    function addAddressesToPresaleList(address[] memory addrs) public onlyOwner {
     ...
     /**
     remove addresses from the preSaleList
     */
    function removeAddressesFromPresaleList(address[] memory addrs)
        public
        onlyOwner
    {
        for (uint256 i = 0; i < addrs.length; i++) {
            PresaleList[addrs[i]] = false;
        }
    }
    ...
    function mint(uint256 _numberTokens) external payable whenSaleStarted {
        ...
        require(
            ...
            "Enough Tokens are not left; Try a reduced amount");
        require(_numberTokens.mul( _price ) <= msg.value,
         "Amount sent is less" );
