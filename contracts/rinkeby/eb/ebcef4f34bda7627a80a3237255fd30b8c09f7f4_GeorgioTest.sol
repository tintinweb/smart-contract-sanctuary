...
// File: contracts/GeorgioTest.sol

pragma solidity ^0.7.0;

/**
 * @title GeorgioTest contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract GeorgioTest is ERC721, Ownable {
    using SafeMath for uint256;

    string public PROVENANCE = "";
    uint256 public constant price = 180000000000000000; //0.18 ETH
    ...
    constructor() ERC721("GeorgioTest", "GT") {
    }
    ...
    function presaleMint() public payable {
        ...
        require(whitelist[msg.sender], "Only whitelist addresses can mint");
