...
contract Sale is Ownable{
    ...
    function getFeeCollectors(uint256 value) public view onlyOwner returns(address,uint256){
        return(feeCollectors[value],feepercent[value]);
    }
    ...
    //mapping(uint256 => uint256) private feelist;
