...
import '@forbitswap/lib/contracts/libraries/SafeERC20Namer.sol';
...
import '@forbitswap/v3-core/contracts/libraries/BitMath.sol';
...
library NFTDescriptor {
    ...
    function generateDescriptionPartOne(
        ...
        return
            string(
                abi.encodePacked(
                    'This NFT represents a liquidity position in a ForbitswapV2 ',
                    quoteTokenSymbol,
                    '-',
                    baseTokenSymbol,
                    ' pool. ',
...
/// @title NFTSVG
/// @notice Provides a function for generating an SVG associated with a ForbitswapV2 NFT
library NFTSVG {
    using Strings for uint256;
...

{
  ...
  "libraries": {
    "contracts/libraries/NFTDescriptor.sol": {
      "NFTDescriptor": "0x0896cd99ea66a20ae74f43c0035cfc417e4ca5f9"
    }
  }
}