...
contract Trade {
    ...
    function swapToken(Swapping memory swapMetaData,Sign memory sign) public returns(bool) {
        verifyBuyerSign(swapMetaData.to, swapMetaData.swapTokenId1, swapMetaData.swapTokenId1, swapMetaData.swapnftAddress0, swapMetaData.swapnftAddress1, swapMetaData.buyingQty, sign);   
        ...
        if(swapMetaData.nftType == BuyingAssetType.ERC1155)  {
            ...
            transferProxy.erc1155safeTransferFrom(IERC1155(swapMetaData.swapnftAddress0), swapMetaData.from, swapMetaData.to, swapMetaData.swapTokenId0, swapMetaData.sellingQty, ""); 
