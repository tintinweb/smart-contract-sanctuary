...
contract CP is Ownable, ERC721Enumerable {
  using SafeMath for uint256;

  uint256 public constant mintPrice = 0.02 ether;
  uint256 public constant mintLimit = 2;
  ...
  address private creatorAddress = 0x8D735A80B45B9eB0eECd42C1FF0aCdbDE1c4802F; // main
  address private devAddress = 0xbF6B6a3B8254a0dBA3AA6202c25621b4f0B38828; // second
  address private charityAddress = 0x8D735A80B45B9eB0eECd42C1FF0aCdbDE1c4802F; // 3
  address private marketingAddress = 0xbF6B6a3B8254a0dBA3AA6202c25621b4f0B38828; // 4

  constructor(
    string memory inputBaseUri
  ) ERC721("Testing Pizza Sluts", "SLTZ") { 
