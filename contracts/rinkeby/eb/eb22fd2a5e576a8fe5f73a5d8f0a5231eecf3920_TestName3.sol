...
/**
 * @title TestName3 contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract TestName3 is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    // The IPFS hash for all TestName3 concatenated stored here
    string public METADATA_PROVENANCE_HASH = "";

    constructor(string memory baseURI) ERC721("TestName3","DH")  {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 numTestName3) public payable {
        require(hasSaleStarted == true, "Sale hasn't started");
        require(totalSupply() < MAX_Supply, "All TestName3 have been sold");
        require(numTestName3 > 0 && numTestName3 <= 11, "You can mint minimum 1, maximum 11 TestName3");
        require(totalSupply().add(numTestName3) <= MAX_Supply, "Exceeds MAX_Supply");
        require(msg.value >= price.mul(numTestName3), "Ether value sent is below the price");


        for (uint i = 0; i < numTestName3; i++) {
