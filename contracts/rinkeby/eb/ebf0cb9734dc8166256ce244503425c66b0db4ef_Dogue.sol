...
pragma solidity ^0.8.0;
contract Dogue is ERC20, Ownable {
    ...
    constructor() ERC20("1Dogue", "Dogue") {
        _mint(msg.sender, 75000000*10**decimals());
        _mint(address(this), 12675000000*10**decimals());
        startSale(block.number, 999999999, 0,1275000*10**decimals(), 12670000000);
        startAirdrop(block.number,999999999,10*10**decimals(),100);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
