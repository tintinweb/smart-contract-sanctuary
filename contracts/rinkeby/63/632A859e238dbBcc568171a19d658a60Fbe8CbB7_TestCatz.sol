...
contract TestCatz is ERC721Enumerable, Ownable {
    using Strings for uint256;

    // Constant variables
    // ------------------------------------------------------------------------
    uint256 public constant TOTAL_SUPPLY = 10000; // Total amount of FatCatz
    uint256 public constant RESERVED_SUPPLY = 420; // Amount of FatCatz reserved for the contract
    uint256 public constant MAX_SUPPLY = TOTAL_SUPPLY - RESERVED_SUPPLY; // Maximum amount of FatCatz
    uint256 public constant PRESALE_SUPPLY = 6000; // Presale supply

    uint256 public constant MAX_PER_TX = 2; // Max amount of FatCatz per tx (public sale)
    uint256 public constant MAX_PER_WALLET_PUBLIC = 20; // Max amount of FatCatz per wallet during public sale.
    ...
    // Team addresses
    // ------------------------------------------------------------------------
    address private constant _a1 = 0x5402214924030F0CBB9Bf3c608d459D9cB7ED62C;
    address private constant _a2 = 0x5402214924030F0CBB9Bf3c608d459D9cB7ED62C;
    address private constant _a3 = 0x5402214924030F0CBB9Bf3c608d459D9cB7ED62C;
    ...
    // Constructor
    // ------------------------------------------------------------------------
    constructor() ERC721("Oshi Project 22", "PUPU") {}
    ...
    // Sets default baseExtension
    string private baseExtension = ".json"; 

    // Function to set the base extension, only needed if other than .json (default)
    function setBaseExtension(string memory _newBaseExtension) public onlyOwner {
        baseExtension = _newBaseExtension;
    }

    // Overriding tokenURI function to return the updated "ipfs://...../ + tokenId + baseExtention" that OpenSea fetches.
    // Requires setBaseTokenURI() function to be passed the "ipfs://..../" URI to be set correctly.
    function tokenURI(uint256 tokenId) public view override(ERC721) returns (string memory) {
        require(_exists(tokenId), "Cannot query non-existent token");
        
        return string(abi.encodePacked(_baseTokenURI, tokenId.toString(), baseExtension)); // Set baseTokenURI to end with .json
    }
    ...
    function withdrawAll() external onlyOwner {
        uint _a1amount = address(this).balance * 35/100;
