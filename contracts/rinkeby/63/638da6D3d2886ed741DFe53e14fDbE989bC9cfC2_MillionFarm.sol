...
// Part: OpenZeppelin/openzeppelin-co[email protected]/IERC20
...
contract MillionFarm is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        simba.transfer(dev, simbaReward.div(25));           //4% to the Core Team
        simba.transfer(lionBank,simbaReward.div(20));       //5% to the Lion Bank
        simba.transfer(simbaTreasury,simbaReward.div(50));  //2% to Treasury for Liquidity purposes
