...
contract EliteCarsTest is ERC721Enumerable, Ownable{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    string public ECTS_PROVENANCE = "800825d68691490f17b4961905b07f3c993c6716c6af8a479cd112fe4ba9c880";
    ...
    constructor() ERC721("100EliteCars","AHEC"){
    }
    ...
    function mintCar(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of Cars");
