...
contract DonkeyDads is ERC721Enumerable, Ownable {

    uint256 public dadPrice = 20000000000000000;
    uint public maxDadPurchase = 10;
    uint public dadSupply = 5000;
    ...
    constructor() ERC721("Fatdad", "FDAD"){
    ...
    function freeMintLDAD(uint numberOfTokens) public {
        ...
        require(addressesThatMintedFree[msg.sender] + numberOfTokens <= 5, "You have already minted 5 free xxxxx");
    ...
    function mintLDAD(uint numberOfTokens) public payable {
        require(drop_is_active, "Please wait until the drop is active to mint");
        require(numberOfTokens > 0 && numberOfTokens <= maxDadPurchase, "Mint count is too little or too high");
        require(tokensMinted + numberOfTokens <= dadPrice, "Purchase would exceed max supply of xxxxx");
        require(msg.value >= dadPrice * numberOfTokens, "ETH value sent is too little for this many xxxxx");
    ...
    function setFreeMint(uint256 newFree)public onlyOwner{
        freeMints = newFree;
    }
