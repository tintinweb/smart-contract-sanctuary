...
contract SubZero is ERC721Enumerable, Ownable
{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    uint public constant _TOTALSUPPLY = 2069;
    uint256 public presalePrice = 42000000000000000; // 0.42 ETH
    uint256 public publicPrice = 69000000000000000; // 0.69 ETH
    bool public isPaused = true;
    bool public isPresale = true;

    constructor(string memory baseURI) ERC721("SubZeroNFT", "SZNFT")  {
        setBaseURI(baseURI);
    }
