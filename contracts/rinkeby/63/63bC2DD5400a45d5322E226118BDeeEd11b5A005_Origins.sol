...
contract Origins is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    parts[1] = '<tspan x="60" y="344" fill="';
    parts[2] = toString(getColor(tokenId));
    parts[3] = '">';
    parts[4] = getCity(tokenId);
    parts[5] = '</tspan><tspan x="60" y="388" fill="';
    parts[6] = toString(getColor(tokenId));
    parts[7] = '">';
    parts[8] = getProvince(tokenId);
    parts[9] = '</tspan><tspan x="60" y="432" fill="';
    parts[10] = toString(getColor(tokenId));
    parts[11] = '">';
    parts[12] = getKingdom(tokenId);
    parts[13] = '</tspan></text><line x1="490.5" y1="192.5" x2="490.5" y2="475.5" stroke="#979797" stroke-linecap="square"></line>';
    parts[14] = "</g></svg>";
