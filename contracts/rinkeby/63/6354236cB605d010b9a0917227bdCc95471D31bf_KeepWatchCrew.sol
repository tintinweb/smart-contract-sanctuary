...
contract KeepWatchCrew is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public publicSaleDate = 1639512000;

    address payable public constant payoutAddress =
        payable(0x434dE59168ad5AE1D2155521eF69c8bAE1F01078);
    ...
    function addUsersToPresaleList(address[] calldata _users) public onlyOwner {
        delete presaleAddresses;
        presaleAddresses = _users;
    }

    function addUserToPresaleList(address _user) public onlyOwner {
        presaleAddresses.push(_user);
    }

    // Add users to VIP list
    function addUsersToVIPList(address[] calldata _users) public onlyOwner {
        delete vipAddresses;
        vipAddresses = _users;
    }

    function addUserToVIPList(address _user) public onlyOwner {
        vipAddresses.push(_user);
    }
    ...
    function updateMaxPresaleAmount(uint256 _amount) public onlyOwner {
