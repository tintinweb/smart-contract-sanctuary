...
contract Bloodline is ERC721Tradable, ReentrancyGuard {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        //     '"attributes": [{"trait_type": "Generation", "value": "', getGeneration(tokenId), '"},',
        //     '{"trait_type": "Father", "value": "', getFather(tokenId), '"},',
        //     '{"trait_type": "Mother", "value": "', getMother(tokenId), '"},',
        //     '{"trait_type": "Gender", "value": "', getGender(tokenId), '"},',
        //     '{"trait_type": "Appearance", "value": "', getAppearance(tokenId), '"},',
        //     '{"trait_type": "Character", "value": "', getCharacter(tokenId), '"},',
        //     '{"trait_type": "Nation", "value": "', getNation(tokenId), '"},',
        //     '{"trait_type": "Profession", "value": "', getProfession(tokenId), '"},',
        //     '{"trait_type": "Hobby", "value": "', getHobby(tokenId), '"}',
        //     '],'
        //     ));
