    ...
    ChainlinkClient
{
    ...
    //等待中的用戶
    address public waitingAddress = address(0);
     ...
     * 產生84 個id 每一個 0顆
     */
     function createAllObjects () public{
        for (uint256 i = 0; i < 84; i++) { 
            create(_msgSender(), i, 0, '',''); 
        }
     }
     ...
     * 用戶來 mint 隨機殭屍
     */
     function mint_one_Zombie () public{
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        ...
        /**
     * 測試設定取貨人 waitingAddress
     */
     function get_waitingAddress() public view returns (address ) {
        return waitingAddress; 
    } 
    /**
     * 
     */
     function set_waitingAddress(address _waitingAddress) public 
    {
        waitingAddress = _waitingAddress; 
    }
...
/**
    ...
    function fulfill_test() public 
    {
        ...
        uint256[] memory qa = new uint256[](7);
        qa[0] = 1;
        qa[1] = 1;
        qa[2] = 1;
        qa[3] = 1;
        ...
        // uint256[] memory ids = [1,2,3,4,5,6,7];
        // uint256[] memory qa = [1,1,1,1,1,1,1]; 
        batchMint(waitingAddress,ids,qa,''); 
