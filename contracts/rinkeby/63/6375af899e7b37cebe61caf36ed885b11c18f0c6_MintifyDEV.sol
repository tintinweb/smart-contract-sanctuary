...
contract MintifyDEV is ERC721, Ownable {

    bool is_paused = false;
    uint16 max_per_user = 1;
    uint16 nextTokenId = 1;
    uint16 max_supply = 2222;
    // uint256 mintPrice = 50000000000000000;
    uint256 mintPrice = 0;
    bool public IS_PRESALE_ACTIVE = true;
    string private baseURI = "https://ipfs.io/ipfs/QmPLVo65s5Riq3FzxbtJT4bEgh7LFyxtrhUZnhQ7QbzUko";
    mapping(address => bool) public whitelisted;


    // Constructor
    constructor() ERC721("MintifyDEV", "MNTFYDEV") {
