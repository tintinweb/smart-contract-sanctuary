...
contract MainnetBridgePool is AccessControl, ReentrancyGuard {
  ...
  constructor(address _raini, address _factory) {
    require(_raini != address(0), "MainnetBridgePool: _raini is zero address");
    require(_factory != address(0), "MainnetBridgePool: Uniswap factory is zero address");
  ...
  function deposite(address _recipient, uint256 _amount) 
    external payable nonReentrant {
      require(msg.value == fee, "MainnetBridgePool: not enough bnb");
