...
/**
 * TestERC1155 is an ERC1155 contract which also:
 * - is owned
 * - can mint new tokens or batches of tokens
 * - can burn tokens or batches of tokens
 */

contract TestERC1155 is ERC1155, Owned {

  constructor(string memory _uri) ERC1155(_uri) {}

  function mint(address account, uint256 id, uint256 amount, bytes memory data)
    public
    onlyOwner // onlyOwner for now but will depend on how we use these contracts - could limited to registered parties
  {
