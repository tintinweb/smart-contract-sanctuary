...
contract GovWorldAdminBase is Ownable {
    ...
    event RemoveAdminForApprove(address indexed _admin, address indexed _removedBy);
    event AdminRemovedByAll(address indexed _admin);
    event EditAdminApproved(address indexed _admin,address indexed _editedBy);
