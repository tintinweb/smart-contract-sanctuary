...
// File: InsertProjectName.sol

contract InsertProjectName is ERC721, Ownable {
    using SafeMath for uint256;
    
    bool public SALE_IS_ACTIVE = false;
    uint public MAX_TOKEN_PURCHASE = 20;
    uint256 public constant UNIT_PRICE = 10000000000000000; //0.01 ETH
    ...
    function mintToken(uint numberOfTokens) public payable {
        require(SALE_IS_ACTIVE, "Sale must be active to mint tokens");
        require(numberOfTokens > 0 && numberOfTokens <= MAX_TOKEN_PURCHASE, "You can mint minimum 1, maximum 20 tokens");
