...
contract Odyssey is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor(bytes32 _hash, address payable _withdrawAddr)
        ERC721("Odyssey", "ODYSSEY")
        Ownable()
    {
        hash = _hash;
    ...
    function getBalanceWithdrawAddr() public view returns (uint256) {
        return withdrawAddr.balance;
    }

    function getBalanceThis() public view returns (uint256) {
