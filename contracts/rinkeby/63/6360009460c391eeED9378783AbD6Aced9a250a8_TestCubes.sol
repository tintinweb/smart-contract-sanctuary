...
contract TestCubes is ERC721Enumerable, Ownable {
    ...
    address creator = 0x48b2569f166EF103E915E852214D0d8F7F2a71Bb;

    constructor(string memory initialBaseURI) ERC721("TestCubes", "TestCubes") {
    ...
    function lottery() external {
        ...
        metadataIndex = uint256(blockhash(lotterySeed)) % _maxSupply;
