...
{
  /**
   * @dev `FANGovernor` contract constructor.
   *
   * `GovernorVotesQuorumFraction` which works together
   * with ERC20Votes to define quorum as a percentage
   * of the total supply at the block a proposal’s
   * voting power is retrieved. This requires a constructor parameter to set the percentage. Most Governors nowadays use 4%, so we will initialize the module with parameter 4 (this indicates the percentage, resulting in 4%).
   *
