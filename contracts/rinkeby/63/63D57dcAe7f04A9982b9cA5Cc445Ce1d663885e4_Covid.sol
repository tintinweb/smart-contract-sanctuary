...
import "contract-killable/contracts/Killable.sol";
  ...
  /**
  * @title Snark Art AoQ Contract
  *
  * @notice Smart Contract provides ERC721 functionality.
  * @author Andrey Skurlatov
  */

contract Covid is ERC721Full, Killable {

  /**
  * @notice AoQ constructor
  * @dev Constructor calls ERC721Metadata constructor to set name and symbol
