...
/**
 * @title NFT
 * @dev A basic NFT template used for test
 *
 * Authors: .s.
 * Created: 08.11.2021
 */
contract NFT is ERC721Enumerable, Ownable {
     ...
     */
    constructor()
    ERC721("A test NFT", "NFT")
    {}

    /**
     * @dev Mint 'numOfTokens' new tokens
     */
    function mint(uint256 numOfTokens) public payable {
        require(totalSupply().add(numOfTokens) <= MAX_SUPPLY, "Sale has already ended");
        require(numOfTokens <= MAX_NUM_MINT, "Max MAX_NUM_MINT can be minted");
        require(MINT_PRICE.mul(numOfTokens) == msg.value, "Ether value sent is not correct");
    ...
    /**
     * @dev Assign 'numOfTokens' tokens to the 'destination' address
    */
    function assign(uint256 numOfTokens, address destination) public onlyOwner() {
        require(totalSupply().add(numOfTokens) <= MAX_SUPPLY, "Sale has already ended");
