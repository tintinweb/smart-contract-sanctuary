...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    address payable public recentWiner;
    ...
    function enter() public payable {
        ...
        require(msg.value >= getEntranceFeed(), "not enough Eth !");
        ...
        override
    {
        ...
        recentWiner = players[indexOfWiner];
        recentWiner.transfer(address(this).balance);
        //reset
