  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x022b79f4444E3316c6179265F49F39f1CBE296c2);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 180');
    ...
    // File: contracts/cryptoApesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CryptoApesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Crypto Apes", "CA", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmY9tniU1hAS4suaDbsgjLY31NnGo9bNvunXg9KkCaX4Dc/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/Kn1ghm3zRCwEoEsRARia/contract-metadata";
        }
    }