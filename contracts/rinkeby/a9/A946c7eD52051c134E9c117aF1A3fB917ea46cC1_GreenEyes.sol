...
// ____                     _   ______                
// |  _ \                   | | |  ____|               
// | |_) | ___  _ __ ___  __| | | |__  _   _  ___  ___ 
// |  _ < / _ \| '__/ _ \/ _` | |  __|| | | |/ _ \/ __|
// | |_) | (_) | | |  __/ (_| | | |___| |_| |  __/\__ \
// |____/ \___/|_|  \___|\__,_| |______\__, |\___||___/
//                                      __/ |          
//                                     |___/        
...
contract GreenEyes is ERC721Enum, Ownable, Pausable,  ReentrancyGuard {
    ...
    uint256 public maxFree = 50;  
    uint256 public nftPerAddressLimit = 9;
	bool public status = false;
    mapping(address => uint256) public addressMintedBalance;

		
	constructor() ERC721S("Green Eyes", "GE"){
	    setBaseURI("");
	}
	...
	function gift(uint[] calldata quantity, address[] calldata recipient) external onlyOwner{
		...
		for(uint i = 1; i <= recipient.length; ++i){
			for(uint j = 1; j <= quantity[i]; ++j){
