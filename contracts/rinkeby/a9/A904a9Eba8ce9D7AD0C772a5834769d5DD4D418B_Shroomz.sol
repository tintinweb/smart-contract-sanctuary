...
contract Shroomz is ERC721, ERC721Enumerable, ERC721Burnable, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("Shroomz Cool", "SHROOMZ") 
    {
    }
    ...
    function mint(uint256 numberOfNfts) public nonReentrant payable {
        require(saleIsActive, "Sale did not start");
        require(totalSupply() < MAX_SUPPLY - RESERVED_SUPPLY, "Sale has ended");
        require(numberOfNfts > 0, "Cannot buy 0");
        require(numberOfNfts <= MAX_PURCHASE, "You may not buy that many NFTs at once");
        require(totalSupply().add(numberOfNfts) <= MAX_SUPPLY - RESERVED_SUPPLY, "Exceeds max supply");
    ...
    function mintReserve(uint256 numberOfNfts) public nonReentrant payable {
        require(saleIsActive, "Sale did not start");
        require(totalSupply() < MAX_SUPPLY, "Sale has ended");
        require(numberOfNfts > 0, "Cannot buy 0");
        require(whitelist[msg.sender].sub(numberOfNfts) >= 0, "Not enough reserve allowance");
        require(numberOfNfts <= MAX_PURCHASE, "You may not buy that many NFTs at once");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://api.shroomz.cool/cards/";
    }
