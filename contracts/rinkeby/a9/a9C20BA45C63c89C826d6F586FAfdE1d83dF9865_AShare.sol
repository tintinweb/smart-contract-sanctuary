...
contract AShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 aSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) ERC20("OSHARE", "OSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 ATH Share for initial pools deployment
