...
//    bool private _mintIsRandom = false;
  ...
  //      setRandomMintToggle();
        ...
        setItemPrice(10000000000000000);
    }
    ...
    function getOneNFT() public payable {
        ...
        require(_tokenIdCounter.current() <= MAXNFT + 1, "Purchase would exceed max supply");
        master_mint();
    }
    ...
    function getMultipleNFT(uint256 _howMany) public payable {
        ...
        require(_tokenIdCounter.current().add(_howMany) <= MAXNFT + 1, "Purchase would exceed max supply");
