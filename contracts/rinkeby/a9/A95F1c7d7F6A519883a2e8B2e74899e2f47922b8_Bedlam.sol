...
contract Bedlam is Ownable, ReentrancyGuard, BaseERC721, Merkle {          
    ...
    event Submitted(string[] ids, address sender);
     ...
     */
    function submitSymbols(uint256[] memory ids, uint256[][] memory value) external nonReentrant {        
    ...
    function getSubmission(uint id) external view returns (uint256[] memory) {        
