...
contract ClockAuction is ERC721Tradable{
    ...
    uint256 public maxPerPresale = 10;
    ...
    event SaleMode(bool publicOn, bool auctionOn);
    ...
    */
    ...
    function setPublicLive() external onlyOwner {
        yeeYee = true;
        emit SaleMode(yeeYee, auctionLive);
    }
     ...
     * @param _maxSupply uint256 the maximum token supply
     * @param _freeze bool whether or not these numbers are changeable afterwards
     */
    function setSaleNumbers(uint256 _minPrice, uint256 _maxPrice, uint256 _maxSupply, bool _freeze) external onlyOwner {
