...
// File: contracts/CryptoDeers.sol
...
contract CryptoDeers is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoDeer", "CD") {
    setHiddenMetadataUri("ipfs://QmaKmcKxrYTeFXccxkwYufc7fQ4jsK7HHSwfneFQZNDm3C/hidden.json");
  }
