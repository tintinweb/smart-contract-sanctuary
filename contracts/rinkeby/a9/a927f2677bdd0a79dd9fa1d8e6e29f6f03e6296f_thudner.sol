...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0x02C2Cc6081c3310589fE44c67f737CC997042135;
...
contract thudner is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public BurnToken = 0xC28244D7132Fb89aBC260d60C48f084D2c64C00D;
    uint256 public toBurnThunderBnbFee = 0;
    ...
    constructor() ERC20("Thunder", "TDA") {
        a80DividendTracker = new A80DividendTracker();

        marketingWallet = 0xAaD5c453E5f3ad2af18a33D9508AaEA2238Bb3A1;
        teamWallet = 0xcE144d1dA55B4F87439C06B1f1907502A7FA185C;
        a80DividendToken = 0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b;
    ...
    function setToBurnThunderBnbFee(uint256 newFee) external onlyOwner {
        require(newFee <= MAX_FEE_RATE, "wrong");
        toBurnThunderBnbFee = newFee;
        _updateTotalFee();
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        swapTokensAtAmount = 300000 * (10**18);
    ...
    function _updateTotalFee() internal {
        totalFees = buyBackAndLiquidityFee.add(marketingFee).add(a80DividendRewardsFee).add(toBurnThunderBnbFee);
    }
    ...
    function _transfer(
        ...
        if (
            ...
            if (!swapping && contractTokenBalance >= swapTokensAtAmount) {
                ...
                if(marketingEnabled && buyBackAndLiquifyEnabled && toBurnThunderBnbFee > 0 && buyBackMode){

                    uint256 total3Fees = marketingFee.add(buyBackAndLiquidityFee).add(toBurnThunderBnbFee);
                    ...
                    if(increaseAmount > 0){
                        ...
                        uint256 bnbToBurnThunderBnb = increaseAmount.mul(toBurnThunderBnbFee).div(total3Fees);
                    ...
                    if(toBurnThunderBnbFee > 0){
                        uint256 swapTokensToBurnThunderBnb = contractTokenBalance.mul(toBurnThunderBnbFee).div(totalFees);
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ADA80", "ADA80Tracker", 0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000 * (10**18); //must hold 10000+ tokens
    }
