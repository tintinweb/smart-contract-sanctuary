...
contract TokenFactory is  ERC721URIStorage, IERC721Receiver, AccessControl {
    ...
    function requestDiamondLiquidity(uint256 _diamondId)
        public
    {
        safeTransferFrom(msg.sender, address(this), _diamondId);
    }
        ...
        onlyAdmin
    {
        ...
        rftToken.approve(_diamond.owner, _diamond.price.mul(10**18));
    }
    ...
    {   
        ...
        rftToken.transfer(msg.sender, _diamond.price.mul(10**18));
    }

    function reedemDiamond(uint256 _diamondId, uint256 _amount) public {
        Diamond memory _diamond = nfts[_diamondId];
        require(_diamond.price.mul(10**18) >= _amount, 'Token Factory 107: Not Enough Reedemable Collateral');

        rftToken.transferFrom(msg.sender, address(this), _diamond.price.mul(10**18));
        safeTransferFrom(address(this), msg.sender, _diamondId);
    }
