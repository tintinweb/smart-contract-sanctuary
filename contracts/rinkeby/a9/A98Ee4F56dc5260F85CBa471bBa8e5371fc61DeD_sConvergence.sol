...
contract sConvergence is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Convergence", "sCONV", 9) ERC20Permit() {
    ...
    /**
        @notice increases sCONV supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sCONV
