...
contract WrappedElves is ERC721Enumerable, Ownable {
    ...
    function mint(address to) public payable {
        ...
        require(totalTokens < maxElfId, "We're maxed out on elves");
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '", "description":"',
                                "Wrapped Elves are Cool",
                                '", "external_url":"https://wrappedelfs.eth.link/?token=',
                                id.toString(),
                                '", "attributes": [], "owner":"',
