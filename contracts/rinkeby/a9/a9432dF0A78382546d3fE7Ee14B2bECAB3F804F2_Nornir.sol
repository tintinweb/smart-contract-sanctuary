...
contract Nornir is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBase {
	...
	function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
		...
		vikings.push(
			Viking(
				// Weapon & Attack
				Stats((randomNumber % 100), statNumberToName((randomNumber % 10000) / 100), (randomNumber % 10000) / 100),
				// Sheild & Defence
				Stats((randomNumber % 1000000) / 10000, statNumberToName((randomNumber % 100000000) / 1000000), (randomNumber % 100000000) / 1000000),
				// Boots & Speed
				Stats((randomNumber % 10000000000) / 100000000, statNumberToName((randomNumber % 1000000000000) / 10000000000), (randomNumber % 1000000000000) / 10000000000),
				// Helmet and Intelligence
				Stats((randomNumber % 100000000000000) / 1000000000000, statNumberToName((randomNumber % 10000000000000000) / 100000000000000), (randomNumber % 10000000000000000) / 100000000000000),
				// Bottoms & Stamina
				Stats((randomNumber % 1000000000000000000) / 10000000000000000, statNumberToName((randomNumber % 100000000000000000000) / 1000000000000000000), (randomNumber % 100000000000000000000) / 1000000000000000000)
			)
		);
