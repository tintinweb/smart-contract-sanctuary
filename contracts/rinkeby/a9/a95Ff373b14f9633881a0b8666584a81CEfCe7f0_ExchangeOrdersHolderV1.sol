...
contract MintableToken is Ownable, ERC721Base, OwnableOperatorRole {
    ...
    constructor (string memory name, string memory symbol) public ERC721Base(name, symbol) {
...
contract MockERC721 is ERC721 {
  constructor() ERC721("Mock ERC721", "mockerc721") public {}
...
contract MockERC20 is ERC20 {
  constructor() ERC20("Mock ERC20", "mockERC20") public {}
