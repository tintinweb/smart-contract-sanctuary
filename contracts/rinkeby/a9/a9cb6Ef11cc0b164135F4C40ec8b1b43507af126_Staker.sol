...
contract Staker {
  ...
  // External contract to hold the staked funds
  ...
  // Modifiers
  // Requires the deadline to be reached or not
  ...
  // Collect the funds and update balances
  function stake() public payable deadlineReached(false) stakeNotCompleted {
    // Update the user's balance
    balances[msg.sender] += msg.value;
    
    // Emit the event when staked funds are collected
    emit Stake(msg.sender, msg.value);
  }

  // After deadline is reached, allow anyone to call an execute() function
  function execute() public stakeNotCompleted deadlineReached(true) {
    ...
    // Execute the contract. Transfer all the balance to the contract.
    exampleExternalContract.complete{value: address(this).balance}();
  }


  // If the deadline has passed but the threshold was not met, allow everyone to call a withdraw() function
