...
contract MP {
    ...
    uint256 public  price; //to store price of token
    address public  owner ; // to address of owner
    address public  tokenContract; //address of deployed contract
    ...
    mapping (address =>uint256) public soldToken; //to find number of token of sold to address
    mapping (uint256 =>address) public tokenOwner; //to find owner of token
    uint256 public  tokenNum = 201; //Token number
