...
contract WOC is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateWOC(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Wise Own Club", "WOC") {
		setBaseURI(baseURI);
        pause(true);
    }
