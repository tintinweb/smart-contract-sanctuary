...
contract YourContract is ERC1155, Ownable {
  ...
  // Mapping from token to the total supply
  mapping(uint256 => uint256) public tokenSupply;

  constructor() public ERC1155("https://johncarter.com/api/item/{id}.json") {
  }

  function mint(string memory _hash, uint256 _quantity) public onlyOwner {
