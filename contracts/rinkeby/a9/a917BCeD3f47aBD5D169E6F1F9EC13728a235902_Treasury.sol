            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex'3d18c2d50107c75fc36e00d554545f11884be9823eac8bdc907138d40aa92c27' // init code hash
                    )
                )
            )
        );
...
contract Oracle is Epoch {
        ...
        returns (uint224 amountOut)
    {
        ...
        FixedPoint.uq112x112 memory avg0 = FixedPoint.uq112x112(
            uint224((price0Cumulative - price0CumulativeLast) / timeElapsed)
        );
        FixedPoint.uq112x112 memory avg1 = FixedPoint.uq112x112(
            uint224((price1Cumulative - price1CumulativeLast) / timeElapsed)
        );
...
contract Treasury is TreasuryState, ContractGuard {
        ...
        checkOperator
    {
        ...
        // uint256 capitalReserve = seigniorage.mul(capitalAllocationRate).div(100);
        // if (capitalReserve > 0) {
        //     IERC20(cash).safeIncreaseAllowance(fund, capitalReserve);
