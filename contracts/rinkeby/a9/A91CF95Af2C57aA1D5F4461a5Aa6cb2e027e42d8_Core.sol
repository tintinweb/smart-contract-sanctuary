...
contract Core is ERC1155, AccessControl, ERC1155Pausable {
    ...
    uint256 constant NON_FUNGIBLE_TOKENS_BASE = 999;
    ...
    constructor(
        ...
        string memory fungibleTokenURI,
        ...
        _idToIPFSHashMapping[FUNGIBLE_TOKEN_ID] = fungibleTokenURI;
    }
    ...
    function approveSubmission(string calldata ipfsHash) public {
        ...
        uint256 newTokenId = NON_FUNGIBLE_TOKENS_BASE + _uniquetteNonce.current();
