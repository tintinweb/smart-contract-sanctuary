...
contract Treasury is Ownable{
    ...
    constructor(address _oracle, address factory, address portfolioTokenAddress, address farmAddress){
    ...
    // figure out the appropriate approval amount
    function approveRouter(address _asset) public {
        IERC20 asset = IERC20(_asset);
        uint balance = asset.balanceOf(address(this));
        asset.approve(address(router), balance);
    }
