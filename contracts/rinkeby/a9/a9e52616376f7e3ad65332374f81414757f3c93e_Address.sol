...
// File: contracts/PandaGame.sol

/**
 * @title PandaGame contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract PandaGame is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("Panda Game", "PANDA") {
        MAX_PANDA_SUPPLY = 10000;
        BASE_URI = 'https://testURI';
    ...
    /**
     * Mint Pandas by owner
     */
    function reservePandas(address _to, uint256 _numberOfTokens) external onlyOwner {
    ...
    */
    function getTokensURI(uint256[] memory tokenIds) external view returns (string[] memory) {
        ...
        if (tokenIdsLength == 0) {
            ...
            for (uint256 index; index < tokenIdsLength; index++) {
                result[index] = bytes(BASE_URI).length > 0
                    ? string(abi.encodePacked(BASE_URI, tokenIds[index] ))
                    : '';   
            }
            return result;
        }
