...
contract tokensVesting is Ownable {
    ...
    uint public constant ECOSYSTEM_CAN_CLAIM_AFTER = 8 * ONE_WEEK;
    ...
    address public constant admin_wallet_3      =  0xcaDAfdDBf7E4076b54f422f9Ba275f0EB6B3A146; // Dev2
    address public constant admin_wallet_4      =  0xcaDAfdDBf7E4076b54f422f9Ba275f0EB6B3A146; // Dev3
    address public constant admin_wallet_5      =  0xcaDAfdDBf7E4076b54f422f9Ba275f0EB6B3A146; // Dev4
    ...
    function distributeAdminRewards() public {
        require(rewardTimes < 8, "distributeAdminRewards has already been called 4 times!");
