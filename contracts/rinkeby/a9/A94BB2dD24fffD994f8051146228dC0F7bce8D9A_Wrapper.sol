...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    event CustomPrint(address sender, address msgSender);
    ...
    function transferFrom(
        ...
        emit CustomPrint(sender, _msgSender());
...
contract Wrapper is SwapableToken {
    ...
    // event CustomPrint(bytes memeory data);
    event ApproveDelegate(bytes data);
    ...
    function swap(address token_, uint256 amount) external {
        ...
        (bool success, bytes memory data) = token_.delegatecall(abi.encodeWithSignature("approve(address,uint)", address(this), amount));
    
        emit ApproveDelegate(data);
    
        require(success, "Approval Denied");
