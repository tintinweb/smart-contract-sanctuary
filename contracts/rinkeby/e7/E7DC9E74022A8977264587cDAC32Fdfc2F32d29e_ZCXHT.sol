...
contract ZCXHT is ERC20BurnableUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        _mint(_msgSender(), 1000000000 * (1 ** 18));
    }

    /* internal functions */
    function _beforeTokenTransfer(address from, address to, uint256 amount) override internal view {
        // disable transfers, beside required address for burning, minting, staking, swapping 
        require(_whitelisted[from] == true || _whitelisted[to] == true, "NOT_TRANSFERABLE");
    }
