...
contract ChainConstants {
    ...
    uint256 constant public CHILD_CHAIN_ID = 4;
    bytes constant public CHILD_CHAIN_ID_BYTES = hex"04";
}
    ...
    ContextMixin
{
    ...
    function setIcoCount(uint _new_count) external only(DEPOSITOR_ROLE) {
        //require(msg.sender == owner, "You is not owner");
        countBy = _new_count;
    }
    function setIcoDec(uint _new_dec) external only(DEPOSITOR_ROLE) {
        //require(msg.sender == owner, "You is not owner");
        countDec = _new_dec;
    }
    function setIcoPrDec(uint _new_dec) external only(DEPOSITOR_ROLE) {
        //require(msg.sender == owner, "You is not owner");
        priceDec = _new_dec;
    }
    /**
