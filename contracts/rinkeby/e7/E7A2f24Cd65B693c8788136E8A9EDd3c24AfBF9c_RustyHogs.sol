...
contract RustyHogs is ERC721, MerkleWhitelist, Ownable, ERCWithdrawable {
    ...
    */
    ...
    function whitelistMint(bytes32[] memory proof_, uint256 amount_) external payable onlySender whitelistSale {
        ...
        require(addressToWhitelistMinted[msg.sender]+amount_ < 2, "You have no whitelisted mints remaining!");
    ...
    function publicMint(uint256 amount_) external payable onlySender publicSale {
        require(addressToPublicMinted[msg.sender]+amount_ < 5, "You have no public mints remaining!");
        require(msg.value == mintPrice*amount_, "Invalid value sent!");
