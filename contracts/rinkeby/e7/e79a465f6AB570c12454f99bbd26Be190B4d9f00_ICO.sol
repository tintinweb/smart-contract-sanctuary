...
contract Token is ERC20, Ownable {
    ...
    address constant ICO_ADDRESS = 0x20785649d2Ff3b40eB88e26a442b25270236f956;
    uint256 constant ICO_AMOUNT = 250000000e18;
//    address constant BOUNTY_ADDRESS = 0x9fDe232Cb4c0F3fe0844c9013F9631f1e1516e22;
    address constant BOUNTY_ADDRESS = 0x554bEc3Dd2Ea6aa46eef1527259198E213584cc4;
...
//    constructor() ERC20(NAME, SYMBOL) public {
    constructor(address addr) ERC20(NAME, SYMBOL) public {
        _mint(address(this), MINT_AMOUNT);
//        _transfer(address(this), ICO_ADDRESS, ICO_AMOUNT);
        _transfer(address(this), addr, ICO_AMOUNT);
