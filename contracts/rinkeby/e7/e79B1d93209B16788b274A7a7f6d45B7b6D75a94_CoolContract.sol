...
contract CoolContract is Context, IERC20, Ownable, VRFConsumerBase {
    ...
    uint256 public _liquidityBalanceForPeriod = 1;
    uint256 public _lotteryBalanceForPeriod = 1;
    ...
    //event LiquidifyRequirementBalance(uint256 _liquidityBalanceForPeriod, uint256 numTokensSellToAddToLiquidity);

    //event LotteryRequirementBalance(uint256 _lotteryBalanceForPeriod,uint256 numTokensSellForLottery);
    ...
    function _transfer(
        ...
        //emit LiquidifyRequirementBalance(_liquidityBalanceForPeriod, numTokensSellToAddToLiquidity);

        //emit LotteryRequirementBalance(_lotteryBalanceForPeriod, numTokensSellForLottery);
