...
contract CBTryMain is ERC721Enumerable, Ownable {
  using Strings for uint256;

  address public CBGen;

  string public bgone;
   string public faceone;

   string public eyesone;
 struct CB { 
      string name;
      string description;
      string bg;
  ...
  mapping (uint256 => CB) public CBeauty;
  constructor() ERC721("Crypto Beauties Genesis", "CryptoBeautiesGen") 
    {}

 function mint() public payable {
    uint256 supply = totalSupply();
    require(supply + 1 <= 11111);
    ICBGenerate c = ICBGenerate(CBGen);
    bgone = c.backgrounds(randomNum(4, block.difficulty, 100));
    faceone = c.faces(randomNum(4, block.timestamp, 100));
    eyesone = c.eyes(randomNum(4, block.timestamp, 80));
    CB memory newCB = CB(
        string(abi.encodePacked('CryptoBeauties #', uint256(supply + 1).toString())), 
        "Pretty Awesome Cryptobeauties. These NFTs are created to empower women in the NFT space!.",
        bgone,
        faceone,
        eyesone);
    
    if (msg.sender != owner()) {
      require(msg.value >= 0.029 ether);
    }
    
    CBeauty[supply + 1] = newCB;
    _safeMint(msg.sender, supply + 1);
  }

function setCBGen(address _newCBGen) public onlyOwner {
    CBGen = _newCBGen;
  }
...
function buildImage(uint256 _tokenId) public view returns(string memory) {
      CB memory currentCB = CBeauty[_tokenId];
      return Base64.encode(bytes(
          abi.encodePacked(
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 32 32" shape-rendering="crispEdges">',
              '<path stroke="',currentCB.bg,'" d="M9 0h8M7 1h11M6 2h13M6 3h13M5 4h14M5 5h15M4 6h16M4 7h16M4 8h16M4 9h16M4 10h16M4 11h16M3 12h18M3 13h18M3 14h18M4 15h17M5 16h16M3 17h1M5 17h16M4 18h1M6 18h16M4 19h1M6 19h16M7 20h15M7 21h15M8 22h14M8 23h14M9 24h13M10 25h12M11 26h10M9 27h1M12 27h9M9 28h2M14 28h6M9 29h3M16 29h4M9 30h5M9 31h7"/>',
              '<path stroke="#03b2bd" d="M9 0h8M7 1h11M6 2h13M6 3h13M5 4h14M5 5h15M4 6h16M4 7h16M4 8h16M4 9h16M4 10h16M4 11h16M3 12h18M3 13h18M3 14h18M4 15h17M5 16h16M3 17h1M5 17h16M4 18h1M6 18h16M4 19h1M6 19h16M7 20h15M7 21h15M8 22h14M8 23h14M9 24h13M10 25h12M11 26h10M9 27h1M12 27h9M9 28h2M14 28h6M9 29h3M16 29h4M9 30h5M9 31h7"/>',
              '<path stroke="#000000" d="M7 0h2M22 0h1M6 1h1M23 1h1M5 2h1M24 2h1M5 3h1M25 3h1M4 4h1M25 4h1M4 5h1M26 5h1M3 6h1M26 6h1M3 7h1M26 7h1M3 8h1M26 8h1M3 9h1M26 9h1M3 10h1M26 10h1M2 11h2M26 11h1M2 12h1M25 12h1M2 13h1M25 13h1M2 14h1M25 14h1M2 15h2M26 15h1M2 16h1M26 16h1M2 17h1M4 17h1M26 17h1M3 18h1M5 18h1M26 18h1M3 19h1M5',
              '19h1M26 19h1M4 20h3M26 20h1M6 21h1M26 21h1M6 22h2M26 22h1M7 23h1M25 23h1M8 24h1M25 24h1M8 25h1M24 25h1M8 26h1M24 26h1M8 27h1M23 27h1M8 28h1M23 28h1M8 29h1M22 29h1M8 30h1M16 30h6M8 31h1M17 31h1" />',
              '<path stroke="#03b2bd" d="M9 0h8M7 1h11M6 2h13M6 3h13M5 4h14M5 5h15M4 6h16M4 7h16M4 8h16M4 9h16M4 10h16M4 11h16M3 12h18M3 13h18M3 14h18M4 15h17M5 16h16M3 17h1M5 17h16M4 18h1M6 18h16M4 19h1M6 19h16M7 20h15M7 21h15M8 22h14M8 23h14M9 24h13M10 25h12M11 26h10M9 27h1M12 27h9M9 28h2M14 28h6M9 29h3M16 29h4M9 30h5M9 31h7" />',
              '<path stroke="#028e97" d="M17 0h5M18 1h5M19 2h5M19 3h6M19 4h6M20 5h6M20 6h6M20 7h6M20 8h6M20 9h6M20 10h6M20 11h6M21 12h4M21 13h4M21 14h4M21 15h5M3 16h2M21 16h5M21 17h5M22 18h4M22 19h4M22 20h4M22 21h4M22 22h4M22 23h3M22 24h3M22 25h2M9 26h1M21 26h3M10 27h1M21 27h2M11 28h1M20 28h3M12 29h2M20 29h2M14 30h2M16 31h1" />',
              '<path stroke="#00090a" d="M9 25h1M10 26h1M11 27h1M12 28h2M14 29h2" />',
              '</svg>'
          )
      ));
  }
