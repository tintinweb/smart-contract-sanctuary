...
contract NodestoneAlpha is ERC721, ERC721Enumerable, Ownable,ERC721Burnable {
    ...
    uint private constant limitTransaction = 3;
    uint private constant limitWallet      = 6;
    uint256 public maxSupply = 5555;
    bool public saleIsActive = false;
    bool public presaleActive = true;
    string public baseTokenURI;
    bytes32 public merkleRoot = 0x45a561cd74eae1e0578eabedc92c4e8b8ad5ea7a9724a0c1ab7b54ae0a55ca6c;
    IERC721 AlphaToken;

    constructor(string memory baseURI) ERC721("DreamyGeeks", "Dreamy") { 
        baseTokenURI = baseURI;
        AlphaToken = IERC721(address(this));
    }
    ...
    function mintToken(uint256 numberOfTokens,bytes32[] calldata _merkleProof) public payable saleIsOpen {
        ...
        require(AlphaToken.balanceOf(msg.sender) <= limitWallet, "Exceeded max token purchase per wallet");
        if (numberOfTokens == 3) require(tokenPrice * numberOfTokens * 4/5 <= msg.value, "Ether value sent is not correct");
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(0x989ead03f535a514f92925312dd2266552fE1aEe, balance.mul(25).div(1000));
