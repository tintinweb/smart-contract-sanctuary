...
{
    uint256 public constant poolFoundersPercent = 75;
    uint256 public constant poolCommunityPercent = 10;
    uint256 public constant poolInvestorsPercent = 10;
    uint256 public constant poolLotteryPercent = 5;

    address public immutable tree;
    address public immutable poolFounders;
    address public immutable poolCommunity;
    address public immutable poolInvestors;
        ...
        internal
    {
        ...
        uint256 toInvestors = (total * poolInvestorsPercent) / 100;
        uint256 toLottery = total - (toFounders + toCommunity + toInvestors);
        ...
        _sendEth(poolInvestors, toInvestors);
    ...
    function _sendEth(address recipient, uint256 value) internal {
        ...
        require(
            success,
            "DistributionPool: unable to send value, recipient may have reverted"
        );
    }
