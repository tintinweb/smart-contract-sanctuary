...
contract Config is IConfig, Initializable {
    ...
    function setInitMarginRatio(uint256 _initMarginRatio) external override {
        require(_initMarginRatio >= 500, "ratio >= 500");
        initMarginRatio = _initMarginRatio;
    }

    function setLiquidateThreshold(uint256 _liquidateThreshold) external override {
    ...
    function setLiquidateFeeRatio(uint256 _liquidateFeeRatio) external override {
