...
contract BoonjixJoaFactory is ERC721, ERC721URIStorage, NFTFactory, Ownable {
  ...
  function registerFactory(address governance, uint32 _creatorAccountId, address creator, bytes calldata signature) external onlyOwner {
