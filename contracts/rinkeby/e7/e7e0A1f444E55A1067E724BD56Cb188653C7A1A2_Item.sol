...
contract Item is ERC1155, ERC721Holder, ERC1155Holder, ItemComponents, MaterialMetadata {
    ...
    IERC721 recipe = IERC721(0x3D2AAC449391fBABe164E64Df3a75BED80B61cfF);
    RecipeInterface recipeContract = RecipeInterface(0x3D2AAC449391fBABe164E64Df3a75BED80B61cfF);
    IERC1155 materialBagItems = IERC1155(0x88b869F285b231AbbFC6BF86C104D5B8E87cf8f2);
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 16px; }</style><rect width="100%" height="100%" fill="black" /><text x="50%" y="50%" class="base" style="text-anchor: middle;">';
