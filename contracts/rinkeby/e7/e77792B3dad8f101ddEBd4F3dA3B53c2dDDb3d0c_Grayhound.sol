...
contract Grayhound is Context, IERC20, Ownable {
    ...
    string private _name = 'Grayhound';
    string private _symbol = 'GRAYHOUND';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 2; // 2% reflection fee for every holder
    uint256 private _charityMarketingFee = 10; // 10% charity+marketing
    uint256 private _liquidityFee = 13; // 13% into liquidity

    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousCharityMarketingFee = _charityMarketingFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    address payable private _charityWalletAddress = payable(0x8b239dEC3Ef210bd46974cbfB4896Bbde11e27D9);
    address payable private _marketingWalletAddress = payable(0x8b239dEC3Ef210bd46974cbfB4896Bbde11e27D9);
...
//        && sender != uniswapV2Pair
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && overMinTokenBalance) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 toCharityMarketing = contractTokenBalance.mul(_charityMarketingFee).div(_charityMarketingFee.add(_liquidityFee));
        ...
        // swap tokens for ETH
        uint256 toSwapForEth = half.add(toCharityMarketing);
