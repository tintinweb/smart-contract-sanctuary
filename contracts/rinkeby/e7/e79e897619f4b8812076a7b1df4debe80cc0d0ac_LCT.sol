...
contract LCT is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant MAX_TOTAL_OWN_AMOUNT = 28;
    ...
    event NewLCMinted(address sender, uint256 tokenId);
        ...
        mustPassChecks(_mintAmount)
    {
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            emit NewLCMinted(msg.sender, id);
            _tokenSupply.increment();
        }
    }
