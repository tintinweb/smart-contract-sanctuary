...
contract NFTFactory is ERC721, AccessControl, Ownable {
    ...
    string public uri = "https://gateway.pinata.cloud/ipfs/QmTrpY2WPnJvqvVBjNE9QxU7Sjfkh4tLGKirSqwCoUKET3/";

    constructor() ERC721("Dak Prescott: The Fortress", "DAKP") {}

    function safeMint(address to, uint256 tokenId) public {
        require(hasRole(MINTER_ROLE, msg.sender), "Caller does not have minter role");
        require(tokenId <= maxId, "Maximum supply exceeded");
        _safeMint(to, tokenId);
        minted[tokenId] = true;
    }
