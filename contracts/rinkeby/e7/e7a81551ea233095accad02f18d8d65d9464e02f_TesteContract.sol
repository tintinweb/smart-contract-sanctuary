  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x9ee28FA6f0E83757Ac0e7d158d1E853cfD8A241f);
    ...
    // File: contracts/testeContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract TesteContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("teste", "test", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmXVhE6DS7K58DSqg3gZctkUwhRhmZiH6G4SQDx4gQBbA8/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/IxipvrUv4KXo6xiLnl60/contract-metadata";
        }
    }