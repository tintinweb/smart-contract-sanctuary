...
// NFT Proof Of Work created by BowTiedDeployer
// (C) SmartDeployer


// *** Generated images ***
// *** Decentralised hosting for the metadata and jpegs ***
// *** Minting integrated in website ***
// *** Hosted and customised website ***

// *** CONTACT. https://smartdeployer.com/ for collaborations and project creations***
...
contract YourNFT is NFTokenEnumerableMetadata, Ownable {
	using SafeMath for uint256;

	uint256 public price = 0.05 ether; // 0.01 eth
	uint256 public maxSupply = 10_000;
	string public baseUri = 'ipfs://QmcTyQhFDvHJpuuw8Z34wscjx6eHa2HSwSACvrgsdbyEgD/';
