...
// File: contracts/ETH_ON_EVM_VAULT.sol
...
contract ETH_ON_EVM_VAULT is Withdrawable, IERC777Recipient {
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function tokensReceived(
        ...
        if (userData.length > 0) {
            ...
            (bytes32 tag, address _destinationAddress) = abi.decode(userData, (bytes32, address));
    ...
    function pegInEth(address _destinationAddress)
        external
        payable
        returns (bool)
    {
