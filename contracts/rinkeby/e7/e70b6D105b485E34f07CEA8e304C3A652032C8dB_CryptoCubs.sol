...
contract CryptoCubs is ERC721Enumerable, Ownable {
    ...
    address private signerWallet = 0x1d02e34493123d7Ab56ffF485995360ABC7C0279;
    address public cryptoWolvesContract = 0x73235f64e0ED6da374984505D133977d03f4E615;
    ...
    constructor() ERC721("Crypto Wolf Cubs", "CWC") {
    }
    ...
    ) public canMint (alphaId, betaId, amount, signature) {
