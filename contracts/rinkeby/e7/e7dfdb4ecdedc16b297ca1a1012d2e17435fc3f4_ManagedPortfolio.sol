...
contract ManagedPortfolio is ERC20, InitializableManageable, IERC721Receiver, IManagedPortfolio {
    using BPMath for BP;
    ...
    constructor() ERC20("ManagedPortfolio", "MPS") InitializableManageable(msg.sender) {}
