...
contract Nornir is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBase {
	...
	struct VikingConditions {
		string weapon_condition;
		string shield_condition;
		string boots_condition;
		string helmet_condition;
		string bottoms_condition;
	}

	struct VikingVisuals {
		string weapon;
		string shield;
		string boots;
		string helmet;
	...
	function statNumberToName(uint256 value) internal pure returns (string memory) {
		if (value >= 97) {
			return 'perfect';
		} else if (value >= 91) {
			return 'good';
	...
	function styleNumberToName(string memory style, uint256 randomNumber) private pure returns (string memory) {
		bytes32 _styleHash = keccak256(bytes(style));

		if (_styleHash == keccak256('weapon')) {
			return 'weapon_style_test';
		}
		else if (_styleHash == keccak256('shield')) {
			return 'shield_style_test';
		}
		else if (_styleHash == keccak256('boots')) {
			return 'boots_style_test';
		}
		else if (_styleHash == keccak256('helmet')) {
			return 'helmet_style_test';
		}
		else if (_styleHash == keccak256('bottoms')) {
			return 'bottoms_style_test';
		}
		else if (_styleHash == keccak256('body')) {
			return 'body_style_test';
		}
		else if (_styleHash == keccak256('face')) {
			return 'face_style_test';
		}
		else if (_styleHash == keccak256('beard')) {
			return 'beard_style_test';
		}
		else if (_styleHash == keccak256('top')) {
			return 'top_style_test';
		}
		else {
			return 'hash_mistake';
		}
	...
	function setVikingConditions(uint256 randomNumber) internal pure returns (VikingConditions memory) {
		return VikingConditions(
			// weapon_condition
			statNumberToName((randomNumber % 10000) / 100),
			// shield_condition
			statNumberToName((randomNumber % 100000000) / 1000000),
			// boots_condition
			statNumberToName((randomNumber % 1000000000000) / 10000000000),
			// helmet_condition
			statNumberToName((randomNumber % 10000000000000000) / 100000000000000),
			// bottoms_condition
			statNumberToName((randomNumber % 100000000000000000000) / 1000000000000000000)
		);
	}

	function setVikingVisuals(uint256 randomNumber) internal pure returns (VikingVisuals memory) {
		return VikingVisuals(
			styleNumberToName('weapon', (randomNumber % 100)),
			styleNumberToName('shield', (randomNumber % 1000000) / 10000),
			styleNumberToName('boots', (randomNumber % 10000000000) / 100000000),
			styleNumberToName('helmet', (randomNumber % 100000000000000) / 1000000000000),
			styleNumberToName('bottoms', (randomNumber % 1000000000000000000) / 10000000000000000),
			styleNumberToName('body', (randomNumber % 1000000000000000000000000) / 10000000000000000000000),
			styleNumberToName('face', (randomNumber % 100000000000000000000000000) / 1000000000000000000000000),
			styleNumberToName('beard', (randomNumber % 10000000000000000000000000000) / 100000000000000000000000000),
			styleNumberToName('top', (randomNumber % 1000000000000000000000000000000) / 10000000000000000000000000000)
		);
	}

	function setVikingStats(uint256 randomNumber) internal pure returns (VikingStats memory) {
		return VikingStats(
