...
contract WallMarket is IERC721Receiver {
    ...
    function acceptBidLastBidOnPiece(uint _id) public {
        ...
        emit BidAccepted(_id, bidamount, bidder);
    }
    ...
    function listPieceForSale(
        ...
        require(WallToken.getApproved(_id) == address(this), 'MARKET: Token is not approved to MARKET');
        WallToken.setOnSale(_id, _salePrice, _acceptsbids);

        emit PieceListed(_id);
    }
    ...
    function placeBid(
        ...
        emit BidPlaced(_id, _bidPrice, msg.sender);
    }
...
interface IWallToken is IERC721 {
    ...
    function setOnSale (uint _id, uint salePrice, bool acceptsbids) external;
