...
contract LoanMarket is LoanMarketBase {
    ...
    */
    ...
    function activateLoanFullToken(uint256 _loanId, uint256 _stableCoinAmount) public {
        ...
        IERC20(loanDetailsToken.borrowStableCoin).transferFrom(lenderAddress, loanDetailsToken.borrower, loanDetailsToken.loanAmountInBorrowed); //TODO APY FEE CUT AFTER LOAN ACTIVATION
