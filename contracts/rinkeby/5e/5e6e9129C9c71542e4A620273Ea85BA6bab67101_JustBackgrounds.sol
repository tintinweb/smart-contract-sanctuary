...
contract JustBackgrounds is ERC721PresetCollectible, Ownable {
    ...
    function initializeMetadata(bytes8[] memory colorMetadata) external {
        require(!_initialized, "GRNDS: Contract already initialized");
    ...
    function startSale() external override onlyOwner {
        require(_initialized, "GRNDS: Contract not initialized");
        _unpause();
    }
    ...
    /**
     * @dev Add initialization check to before-mint hook.
     */
    function _beforeTokenMint(address, uint256) internal view override {
