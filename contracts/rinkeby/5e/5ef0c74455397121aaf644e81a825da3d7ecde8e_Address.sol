...
contract Muncles is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/test/";

  constructor() 
    ERC721("WeMint Uncles", "Muncles")
    RandomlyAssigned(5000,1) // Max. 10000 NFTs available; Start counting from 1 (instead of 0)
    {
       for (uint256 a = 1; a <= 1000; a++) {
            mint(msg.sender);
        }
    }
