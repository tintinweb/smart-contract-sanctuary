...
contract SLC{
    ...
    function InitiateTransaction(address receiver,uint amount,string memory token_uri) public ONLY_SLF_AND_OWNERS returns(bool){
        ++TOKEN_ID;
        mint(receiver,amount);
        mintNFTcontract(MINTNFT_DEPLOYED_ADDRESS).mint(receiver,TOKEN_ID,token_uri);
        return true;
    }
