...
contract GovWorldProtocolRegistry is GovWorldProtocolBase {
    ...
    uint256 private lenderUnearndedAPYPercentage;
    uint256 private govUnearndedAPYPercentage;
    uint256 private govPlatformFee;
    ...
    */
    ...
    function setUnearnedAPYPercentageForLender(uint _percentage) public onlyEditFeeRole(msg.sender) {
        require(_percentage <= 100, "GPL: Gov Percentage Error");
    ...
    @param _percentage percentage which goes to lender
     */
    function setUnearnedAPYPercentageForGovLoanMarket(uint _percentage) public onlyEditFeeRole(msg.sender) {
        require(_percentage <= 100, "GPL: Gov Percentage Error");
     ...
     */
    function setGovPlatfromFee(uint _percentage) public onlyEditFeeRole(msg.sender) {
        require(_percentage <= 100, "GPL: Gov Percentage Error");
...
abstract contract GovWorldProtocolBase is IGovWorldProtocolRegistry, Ownable{
        ...
        internal
    {
        ...
        if(marketData.isSP){
            ...
            emit TokensAdded(_tokenAddress, approvedTokens[_tokenAddress]);      
        } else {
