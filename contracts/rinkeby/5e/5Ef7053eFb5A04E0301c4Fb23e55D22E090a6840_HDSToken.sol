...
contract HDSToken is ERC20, Ownable {
    
    uint256 public balance;
    event Contribute(address indexed _from, uint _value);
    event withdrawEth(uint _value, address indexed _destination);
    event withdrawEth(address indexed _tokenAddress, uint _value, address indexed _destination);
  
    constructor() ERC20("HDSToken", "HDS") {}
    ...
    receive() payable external { 
       ...
       balance += msg.value;
       emit Contribute(msg.sender, msg.value * 10000);
    }
    ...
    function withdrawToken(address _tokenContract, uint256 _amount, address payable destAddr) public onlyOwner {
        ...
        balance -= _amount;
        emit withdrawEth(_tokenContract, _amount, destAddr);
    }
