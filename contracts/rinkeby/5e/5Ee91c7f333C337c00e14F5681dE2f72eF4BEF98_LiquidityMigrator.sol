...
contract LiquidityMigrator is ILiquidityMigrator, IERC721Receiver, Context {
        ...
        )
    {
        ...
        (amount0Base, amount1Base, ) = LiquidityReserves.getLiquidityAmounts(
            ticks.baseTickLower,
            ticks.baseTickUpper,
            baseLiquidity,
            0,
        ...
        (amount0Range, amount1Range, ) = LiquidityReserves.getLiquidityAmounts(
            ticks.rangeTickLower,
            ticks.rangeTickUpper,
            rangeLiquidity,
            0,
    ...
    function migrateV2Liquidity(MigrateV2Params calldata params) external {
        ...
        MigrateV2Vars memory v;
        if (pair != address(0)) {
            bytes memory data = abi.encode(params.fee, params.unipilotTokenId);
            (v.amount0Base, v.amount1Base, v.amount0Range, v.amount1Range, ) = IUnipilot(params.unipilotAddress).deposit(
            ...
            (v.amount0Base, v.amount1Base, v.amount0Range, v.amount1Range, ) = IUnipilot(params.unipilotAddress)
