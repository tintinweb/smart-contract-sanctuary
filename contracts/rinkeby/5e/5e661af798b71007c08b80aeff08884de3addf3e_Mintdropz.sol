...
contract Mintdropz is ERC721, Ownable {
    ...
    // uint256 public constant mintdropzPrice = 30000000000000000; // each token price is 0.03 ETH

    uint public constant maxMintdropzPurchase = 20;

    uint256 public constant MAX_MINTDROPZ = 10000;

    bool public saleIsActive = true;
    
    mapping(uint => string) public mintdropzNames;

    // Reserve 125 Mintdropz for team - Giveaways/Prizes etc
    uint public mintdropzReserve = 125;
    
    event mintdropzNameChange(address _by, uint _tokenId, string _name);
    ...
    function changeMintdropzName(uint _tokenId, string memory _name) public {
    ...
    function viewMintdropzName(uint _tokenId) public view returns( string memory ){
