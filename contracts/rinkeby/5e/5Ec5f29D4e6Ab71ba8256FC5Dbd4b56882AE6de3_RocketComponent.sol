...
contract RocketComponent is ERC721, Ownable {
    ...
    constructor() ERC721("Tom Sachs Rocket Components", "TSRC") {
        ...
        componentModels.push(ComponentModel("711", 0, 65));
        componentModels.push(ComponentModel("Apple", 66, 131));
        componentModels.push(ComponentModel("Brian", 132, 197));
        componentModels.push(ComponentModel("Budweiser", 198, 263));
        componentModels.push(ComponentModel("Campbells", 264, 329));
        componentModels.push(ComponentModel("Chanel", 330, 395));
        componentModels.push(ComponentModel("Cup Noodles", 396, 461));
        componentModels.push(ComponentModel("Domino", 462, 527));
        componentModels.push(ComponentModel("Ferarri", 528, 593));
        componentModels.push(ComponentModel("Green Giant", 594, 659));
        componentModels.push(ComponentModel("Grey Poupon", 660, 725));
        componentModels.push(ComponentModel("Hello Kitty", 726, 791));
        componentModels.push(ComponentModel("Hermes", 792, 857));
        componentModels.push(ComponentModel("Kikkoman", 858, 923));
        componentModels.push(ComponentModel("Lisa", 924, 989));
        componentModels.push(ComponentModel("Marlboro", 990, 1055));
        componentModels.push(ComponentModel("MCdonalds", 1056, 1121));
        componentModels.push(ComponentModel("Miami Vice", 1122, 1187));
        componentModels.push(ComponentModel("NASA", 1188, 1253));
        componentModels.push(ComponentModel("Nikecraft", 1254, 1319));
        componentModels.push(ComponentModel("Purple", 1320, 1385));
        componentModels.push(ComponentModel("Scotch", 1386, 1451));
        componentModels.push(ComponentModel("Skippy", 1452, 1517));
        componentModels.push(ComponentModel("Snickers", 1518, 1583));
        componentModels.push(ComponentModel("Sweet n Low", 1584, 1649));
        componentModels.push(ComponentModel("Tiffany", 1650, 1715));
        componentModels.push(ComponentModel("USPS", 1716, 1781));
        componentModels.push(ComponentModel("Vaseline", 1782, 1847));
        componentModels.push(ComponentModel("WD-40", 1848, 1913));
        componentModels.push(ComponentModel("Wonder", 1914, 1999));
    }
    ...
    function claim() external payable {
        ...
        require(
            claimedComponentsPerAddress[msg.sender] < maxClaimsPerAddress,
        ...
        claimedComponentsPerAddress[msg.sender]++;
