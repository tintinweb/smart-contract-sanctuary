...
contract IconGirlNFT is ERC721, Ownable, Pausable, IERC998ERC721TopDown, IERC998ERC721TopDownEnumerable {
    ...
    constructor()
        ERC721("IcongirlTest", "ICGTEST")
        Ownable()
    {
        setBaseURI("https://api.mooncat.community/traits/");
