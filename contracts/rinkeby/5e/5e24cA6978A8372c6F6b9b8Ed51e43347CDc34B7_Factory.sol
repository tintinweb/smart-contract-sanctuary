...
contract Factory is Ownable {
  ...
  function createNFT(string memory _uri, uint256 amount) external virtual {
    ...
    projects[projectId].nft.mint(_msgSender(), tokenId, amount);
    projectId++;
    tokenId++;
  }

  function mintNFT(uint64 amount, uint256 _projectId) external virtual {
    _mintNFT(amount, _projectId, tokenId);
    tokenId++;
  }
  ...
  function mintNFTCopies(
    ...
    _mintNFT(amount, _projectId, _tokenID);
  }
  ...
  function _mintNFT(
    ...
    require(amount > 0, "Factory: Invalid Amount of NFTs");
    projects[_projectId].nft.mint(_msgSender(), _tokenID, amount);
  }
