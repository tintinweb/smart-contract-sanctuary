...
abstract contract RolesManager {
    ...
    function _removeRole(uint256 _role, address _manager)
        private
    ...
    RolesManager
{
    ...
    function createCollection(
        ...
        require(
            ...
            "start time must be less than end time , end time greater than current time "
        );
        require(
    ...
    function updateCollectionTime(
        ...
        _collection.startTiming = _startTime;
        _collection.endingTiming = _endTime;
    }
    ...
    function mint(
        ...
        collection storage _collection = collections[collectionIndex];
        require(
            block.timestamp > _collection.startTiming,
            "collection not started yet"
        );
        require(
            block.timestamp < _collection.endingTiming,
