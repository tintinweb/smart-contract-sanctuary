...
contract BaseContract is Ownable, Initializable {
    ...
    event CollectionCreated(address collectionAddress, address sender, uint256 blockNumber);
    ...
    function createCollection(string memory _id, IERC20 token) public {
        ...
        emit CollectionCreated(address(collectionContract), tx.origin, block.number);
    }
