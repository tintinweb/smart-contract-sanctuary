...
import "../../token/ERC20/ERC20Governance.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20Governance is ContractOwnable, IMasterERC20 {
  ERC20Governance[] private childERC20Governance;
  ...
  function createERC20(
    ...
    ERC20Governance child = new ERC20Governance(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20Governance.push(child);
