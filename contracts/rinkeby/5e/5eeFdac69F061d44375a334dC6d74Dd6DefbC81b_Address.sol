...
contract RobotilicLowGas02 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Robotilic Low Gas 02", "RLG02") {
    setHiddenMetadataUri("ipfs://QmVTP4YNs3kThNXfXLmEBzTsF9aqc2AB1D7evsPqXFpjMF/hidden.json");
  }
