...
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
contract ChainPixNFT     is  ERC721Enumerable, ReentrancyGuard
{
    using Address for address;
    using Strings for uint256;
    ...
    mapping(uint256 => uint256)     public chainHashes;
    ...
    constructor()   ERC721("The SHENPX Token", "SPX01")   // temporary Symbol and title
    {
    ...
    function    reserve(uint256 quantity)                   external onlyOwner
    {
        ...
        for (uint256 i=0; i<quantity; i++)
        {
            ...
            chainHashes[mintedTokenCount] = generateChainHashWithParam(mintedTokenCount);
        }
    }
    //=============================================================================
    function    mint(uint256 quantity, uint256 affHash)                      external payable callerIsUser nonReentrant
    {
        ...
        uint256 orderTotalPrice = mintOnlyPrice * quantity;
    ...
    //=============================================================================
    //=============================================================================
    function    generateChainHashWithParam(uint256 tokenId) internal view returns(uint256)
    {
        return uint256
        (
            keccak256
...
*/
    function    setAffiliate(string memory username) public
    {
        uint256 affHash = forgeAffHash(username, msg.sender);
        
        affiliates[affHash] = TAffiliate( msg.sender, 800, username, true, 0 );       // 8%
    }
    //==============================²===============================================
