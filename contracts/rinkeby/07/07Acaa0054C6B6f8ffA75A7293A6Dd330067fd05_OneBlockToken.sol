...
contract OneBlockToken is ERC721MintableNotEnum, ERC721Permit , Ownable, ERC721URIStorage {
    string public _defaultURI;
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("1Block:Token", "1BLOCK") ERC721Permit("1Block:Token") {
        setDefaultURI("https://1block.world/api/metadata/");
    }
