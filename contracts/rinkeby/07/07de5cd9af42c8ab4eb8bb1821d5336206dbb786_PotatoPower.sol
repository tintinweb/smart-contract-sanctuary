...
contract PotatoPower is ERC721, Ownable,Pausable {
    ...
    mapping(address => SpecificAddresses) public _myAddresses;
    ...
    function addAdapter(address whiteAddress)public onlyOwner {
        require(!_addressExist[whiteAddress],"Address already Exist");
        
        _myAddresses[whiteAddress]=SpecificAddresses({
    ...
    function mintBeta() public payable{
        ...
        SpecificAddresses storage myaddress = _myAddresses[msg.sender];
