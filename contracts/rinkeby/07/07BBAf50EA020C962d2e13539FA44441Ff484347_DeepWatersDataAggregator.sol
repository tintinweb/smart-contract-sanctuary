...
contract DeepWatersDataAggregator is IDeepWatersDataAggregator {
        ...
        )
    {
        ...
        dTokenBalance = vault.getUserAssetBalance(_asset, _user);
        dTokenBalanceUSD = assetPriceUSD.mul(dTokenBalance).div(10**decimals);
        
        borrowBalance = vault.getUserBorrowBalance(_asset, _user);
    ...
    **/
        ...
        )
    {
        ...
        for (uint256 i = 0; i < assets.length; i++) {
            ...
            currentAssetUserData.balance = vault.getUserAssetBalance(currentAssetUserData.assetAddress, _user);
            currentAssetUserData.borrowBalance = vault.getUserBorrowBalance(currentAssetUserData.assetAddress, _user);
        ...
        if (borrowBalanceUSD == 0) {
            ...
            healthFactor = collateralBalanceUSD.mul(80).div(100).div(borrowBalanceUSD);
        }
        
        availableToBorrowUSD = collateralBalanceUSD.mul(75).div(100) - borrowBalanceUSD;
    }
