  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xAe66E5F9E499C4d236d071382a5E493b57E17406);
    ...
    // File: contracts/africanSpearsContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract AfricanSpearsContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("African Spears", "ASC2", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmUdLNzeCmjhoRxqC5YLZZntRgbkaRFc3RerSFyq2yQX1w/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/7iYznfpxXwMsc7tgcqqT/contract-metadata";
        }
    }