...
contract VR002 is ERC721Enumerable, Ownable {
	...
	constructor () ERC721("VR002", "VR002") {
		tokens[0] = TokenInfo(0, 50, 60, 0, 1, 0.001 ether);
		tokens[1] = TokenInfo(0, 25, 30, 60, 5, 0.001 ether);
		tokens[2] = TokenInfo(0, 10, 12, 90, 10, 0.001 ether);
		tokens[3] = TokenInfo(0, 50, 60, 102, 0, 0 ether);
	}
