    ...
    ERC20Votes
{
  ...
  {
    require(block.timestamp >= mintingAllowedAfter, "DFY::mint: minting not allowed yet");
    require(to_ != address(0), "DFY::mint: cannot transfer to the zero address");
    require(amount_ <= (totalSupply() * MINT_CAP / 100), "DFY::mint: exceeded mint cap");
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_)
    ...
    override(ERC20)
  {
    require(!blacklist[from_], "DFY::_beforeTokenTransfer: from address is blacklisted");
    require(!blacklist[to_], "DFY::_beforeTokenTransfer: to address is blacklisted");
