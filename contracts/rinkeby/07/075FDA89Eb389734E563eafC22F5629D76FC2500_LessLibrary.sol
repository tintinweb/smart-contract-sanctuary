...
contract LessLibrary is Ownable {
    uint256 private minInvestorBalance = 3 * 1e18;
    //uint256 private votingTime = 259200; //three days
    uint256 private votingTime = 300;
    uint256 private minStakeTime = 1 minutes;
    uint256 private minUnstakeTime = 6 minutes;

    address private factoryAddress;

    uint256 private minYesVotesThreshold = 5 * 1e18; // minimum number of yes votes needed to pass
    uint256 private minVoterBalance = 2 * 1e18; // minimum number of  tokens to hold to vote
    uint256 private minCreatorStakedBalance = 2 * 1e18; // minimum number of tokens to hold to launch rocket
