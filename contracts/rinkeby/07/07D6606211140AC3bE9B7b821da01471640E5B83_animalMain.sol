...
contract animalMain is  ERC721,Ownable {
  ...
  function seeAnimalshiny(uint256 _tokenId) public view returns (uint16 shiny) {
    return animals[_tokenId].shiny;
  }
  ...
  function createAnimal() public payable {
      ...
      uint id = animals.push(animal(dna, uint8(star), uint8(roletype), uint8(shiny))) - 1;
