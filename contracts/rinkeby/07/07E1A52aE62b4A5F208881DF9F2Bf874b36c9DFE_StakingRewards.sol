...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    mapping(address => bool) public payingCharges;
    ...
    function payWithdrawCharges() external {
        payingCharges[msg.sender] = true;
    ...
    function claim() public nonReentrant {
        ...
        if(payingCharges[msg.sender] == true){
            amount=amount.sub(amount.mul(withdrawCharges).div(100));
            _balances[msg.sender] = _balances[msg.sender] - amount;
            payingCharges[msg.sender] = false;
        }
