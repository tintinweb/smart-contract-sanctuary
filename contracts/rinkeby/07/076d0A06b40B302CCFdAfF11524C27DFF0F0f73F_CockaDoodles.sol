...
contract CockaDoodles is ERC721, EIP712, Ownable {
    // EIP712 Feature
    ...
    uint256 public MAX_SUPPLY_PLUS_ONE = 3334;
    uint256 public totalSupply;
    address public store;

    event SetStore1(address store);
    ...
    function burnLowerMaxSupply(uint256 _newmax) external onlyOwner {
    ...
    function mintPresaleMerkle(address to, bytes32[] calldata proof) public onlyOwnerOrStore {
    ...
    function mintPresaleHash(
        ...
        require(totalSupply + _passAmount < MAX_SUPPLY_PLUS_ONE, "Exceeds max supply");
