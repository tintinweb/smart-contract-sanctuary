...
contract BondlyLaunchPad is Ownable {
    ...
    constructor() {
        ...
        limitTokenForPublicSale = 0x5dD7606377A8FAaa54d897Ab103703a1200449a2;
    ...
    function createCard(
        ...
        _newCard.purchasers = new address[](_totalAmount);
    ...
    function purchaseNFT(uint256 _cardId, uint256 _amount) external payable {
        ...
        _cards[_cardId].purchasers.push(msg.sender);
    ...
    {
        return _cards[_cardId].purchasers;
    }
