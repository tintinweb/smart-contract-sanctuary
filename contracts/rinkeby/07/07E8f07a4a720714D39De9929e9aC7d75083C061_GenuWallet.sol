...
contract GenuWallet is Ownable, Pausable, IERC721Receiver {
    ...
    */
    ...
    event FlushedERC20(address indexed msgSender, address indexed forwarderAddress, address indexed tokenContractAddress);
    event FlushedERC721(address indexed msgSender, address indexed forwarderAddress, address indexed tokenContractAddress);
   ...
   */
    function flushForwarderTokens(
        ...
        _forwarder.flushTokens(tokenContractAddress);
        emit FlushedERC20(msg.sender, forwarderAddress, tokenContractAddress);
    }

    /**
     * Execute an ERC721 token flush from one of the forwarder addresses.
     *
     * @param forwarderAddress the address of the forwarder address to flush the tokens from
     * @param tokenContractAddress the address of the erc20 token contract
    */
    function flushForwarderTokensERC721(address payable forwarderAddress, address tokenContractAddress) external onlyOwner whenNotPaused {
        ...
        emit FlushedERC721(msg.sender, forwarderAddress, tokenContractAddress);
    }

    /**
     * Execute an ERC721 token flush from one of the forwarder addresses in the quantity specified.
     *
     * @param forwarderAddress the address of the forwarder address to flush the tokens from
     * @param tokenContractAddress the address of the erc20 token contract
     * @param quantity the quantity to move
