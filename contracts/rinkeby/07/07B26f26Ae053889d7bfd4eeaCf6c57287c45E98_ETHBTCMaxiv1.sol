...
contract ETHBTCMaxiv1 is ERC721Enumerable, Ownable {
    ...
    uint256 public constant     BURN_REWARD         = 210000000000; //0xbtc reward (divide by 10^8 to get units)
    uint256 public constant     MAX_PER_TX          = 10; //max number of tokens purchasable in 1 txn
    uint256 public constant     RESERVES            = 5; //tokens reserved for the team and free to mint
