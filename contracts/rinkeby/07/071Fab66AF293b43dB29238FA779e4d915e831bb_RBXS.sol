...
contract RBXS is ERC20, ERC20Burnable, AccessControl, ERC20Permit, ERC20Votes {
    ...
    constructor(address _previousToken) ERC20("RBXS", "RBXSamurai") ERC20Permit("RBXS") {
    ...
    function _transfer(address sender, address recipient, uint amount) internal override(ERC20) {
        ...
        if (block.timestamp <= elysium &&
            ...
            _routerPairs[sender].pair == sender) {
                ...
                _addBal(address(this), amount - initLimit);
            }
        // snipe and bot funcs #end
        else if (
            fundingEnabled &&
            !swapping &&
    ...
    function _addBal(address account, uint amount) internal returns(bool) {
        _balances[account] += amount;
        return true;
    }
