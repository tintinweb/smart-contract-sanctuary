  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x1db88e5046E3D9a90ab09b65784E632485390E55);
    ...
    // File: contracts/piggyporkContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract PiggyporkContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("PIGGYPORK", "PIGGY", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmbgM9jKgSDdjyvHxgte3hj3xgM8bhByyFNvRDokbRDNR6/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/JQBiIyYmi63rw2x9UmCA/contract-metadata";
        }
    }