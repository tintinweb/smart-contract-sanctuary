...
library Token {
    ...
    function approve(
        ...
        Require.that(checkSuccess(), FILE, "Approve failed");
    }
    ...
    function transfer(
        ...
        Require.that(checkSuccess(), FILE, "Transfer failed");
    }
    ...
    function transferFrom(
        ...
        Require.that(checkSuccess(), FILE, "TransferFrom failed");
    }
...
library Storage {
        ...
        returns (Monetary.Price memory)
    {
        ...
        Require.that(price.value != 0, FILE, "Price cannot be zero", marketId);
        return price;
    }
...
library AdminImpl {
    ...
    function ownerWithdrawExcessTokens(
        ...
        Require.that(!excessWei.isNegative(), FILE, "Negative excess");
        ...
        view
    {
        ...
        Require.that(!marketExists, FILE, "Market exists");
    }
    ...
    function _validateMarketId(Storage.State storage state, uint256 marketId)
        ...
        view
    {
        Require.that(marketId < state.numMarkets, FILE, "Market OOB", marketId);
    }
}
...
contract Getters is State {
    ...
    function _requireValidMarket(uint256 marketId) private view {
        Require.that(marketId < g_state.numMarkets, FILE, "Market OOB");
    }
...
contract IAutoTrader {
    ...
    function getTradeCost(
        ...
        bytes memory data
    ) public returns (Types.AssetAmount memory);
}
...
library OperationImpl {
    ...
    function _verifyInputs(
        ...
        Require.that(actions.length != 0, FILE, "Cannot have zero actions");

        Require.that(accounts.length != 0, FILE, "Cannot have zero accounts");
 ...
 */
contract SoloMargin is State, Admin, Getters, Operation, Permission {
    // ============ Constructor ============
