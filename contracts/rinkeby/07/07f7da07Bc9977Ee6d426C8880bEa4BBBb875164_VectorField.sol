...
contract VectorField is ERC721URIStorage, VRFConsumerBase, Ownable {
 ...
 function withdraw() public payable onlyOwner {
    ...
    function Reserve() public returns (bytes32 requestId) {
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '", "description":"Land art generated and stored immutably on the Ethereum blockchain", "attributes":"", "image":"',imageURI,'"}'
                            )
                        )
                    )
                )
