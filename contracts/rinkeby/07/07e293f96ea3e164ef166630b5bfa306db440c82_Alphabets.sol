 ...
 */
contract Alphabets is ERC721, ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    //Nproject Contract
    address public NprojectAddress = 0x3d9dE07E000D0Af49C7339668652302E3B2E073a;
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="#f4ca16" /><text x="10" y="30" class="base">';

        parts[1] = getLetter1(tokenId);

        parts[2] = '</text><text x="10" y="60" class="base" font-weight="bold" font-size="2em" fill="black">';
        ...
        parts[4] = '</text><text x="10" y="90" class="base" font-weight="bold" font-size="2em" fill="black" >';

        parts[5] = getLetter3(tokenId);

        parts[6] = '</text><text x="10" y="120" class="base" font-weight="bold" font-size="2em" fill="black" >';

        parts[7] = getLetter4(tokenId);
        
        parts[8] = '</text><text x="10" y="150" class="base" font-weight="bold" font-size="2em" fill="black">';

        parts[9] = getLetter5(tokenId);
        
        parts[10] = '</text><text x="10" y="180" class="base" font-weight="bold" font-size="2em" fill="black">';
    ...
    constructor() ERC721("ALPHABETS", "ABC") {
    }
    ...
    function mintWithNproject(uint NprojectId, uint TokenIdWanted) public payable nonReentrant {
        ...
        _safeMint(msg.sender, NprojectId);
    }
    ...
    function mint(uint TokenIdWanted) public payable nonReentrant {
        ...
        require(TokenIdWanted > 2000 && TokenIdWanted < 10000, "Token ID invalid");
        require(!_exists(TokenIdWanted), "This token has already been minted");
    ...
    function multiMint(uint[] memory TokenIdsWanted) public payable nonReentrant {
        ...
        for (uint i=0; i<TokenIdsWanted.length; i++) {
            require(TokenIdsWanted[i] > 2000 && TokenIdsWanted[i] < 10000, "Token ID invalid");
