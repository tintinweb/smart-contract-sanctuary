...
contract NFT is ERC721URIStorage{
    ...
    string private _baseURIextended;
     constructor () ERC721("My NFT", "NFT") {
       //setBaseURI('https://opensea-creatures-api.herokuapp.com/api/creature/');
        fundWallet = 0xA44082A231aB4893b1Ec5d6064a8D029AF926307;
    }
...
function createViper(
        ...
        returns (uint)
    {
       ...
       newViperId++;
        _mint(viperOwner, newViperId);
        _setTokenURI(newViperId,'https://opensea-creatures-api.herokuapp.com/api/creature/');
        tokenURI(newViperId);
        return newViperId;
    }
