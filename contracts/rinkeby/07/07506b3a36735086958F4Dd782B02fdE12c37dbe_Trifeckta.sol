...
// @@@@@@@@@@@@@@@@@@@@@@@###########@@@@@[email protected]@#$$$$$$$$$$$$$$E$$$$$$$$$Ddd33Iccci\           \\\\\\\\\\\\\ii\\\\\\\\iuC3E$############//
// @@@##############@###$$EDDDE$#####$$$#$ui9#$D699DDDDD###DDD63d6d333d$$$$d3Ci\\\\         \\\\\\\\\\\\i\\iuccccuii\\\\iI6dDDDE########//
// @@#             [email protected]           \$##l    [email protected]\          d#C           \$$$c\            \    \i\\     \ui             \3dDi     i#######//
// @@@cuuu\    [email protected]    C33C    \##i    [email protected]@\   \iiiiCI$#C    illcclu3$$\            \\i    \i     \ce3C\\\\     \\\id##3       3######//
// @@@@@@@l    @@@@@@3    uUCi    C##l    #@#\    \\\\i$##C        \\\3$U          \\icCc          \I3333dE$E\    ######E   \6    D#####//
// @@@@@@@l    @@@@##U          l$#E#c    ###\         6##C           \\\    \\\\ilce3d3U           i333D$$$$\    #####$\   6#c    $####//
// @@@@@@@l    @@@###U    D$\    [email protected]@#i    ###\   \######3\     \\\\\\\\\      \\ce\  \udI     \3\    \Cd6$###\    #####\           \####//
// @@@@@@@l    ######U    E##i    l##C    ##$\   \$$6c\ \\\                           U63    i$$$i    \$#####\    ####u    \\\\\    e###//
// @@@@@@@3\\\\######3\\\\$###i\\\\c#d\\\\#$$\\   \    \\i\                         \\\\\  \\C$$##C\\\\\#####i\\\\###D\\\\I#####C\\\\$##//
// @@@@@@@@@@###################$#@@@@#@@@#$du\         \i\\\\\ici\\\\       \\\\\\\\\\\\\\uUd$$########################################//
// @@@@@@@@#####################@##$#@##@@#l             \\\\\\ii\\\\\\\\    \\\\\\\\\\\\\lccC3d########################################//
// @@@@@@@####################@@@[email protected]##@@C\              \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\6##########################################//
// @@@@@@#########################[email protected]##@d\\            \\\\\\\\iiuui\\\\\\\\\\\\\\\\\\\\\\\\$##########################################//
// @@@@@######################[email protected]#[email protected]@#@$\\          \iu\\\\\\\iccu\\\\\\\\\\\\\\\\\\\\\\\\l$##########################################//
// @@@@########################@@@d##@@@@#\\         \ucu\\\\\\\\lci\\\\\\\\\\\iullui\\\\\\i$#######@@##################################//
 ...
 */
abstract contract MintManager is AdminControl, ERC721, ERC721CreatorCore, Pausable {
    ...
    function pause() public virtual override nonReentrant adminRequired {
        _pause();
    }

    function unpause() public virtual override nonReentrant adminRequired {
        _unpause();
    }
