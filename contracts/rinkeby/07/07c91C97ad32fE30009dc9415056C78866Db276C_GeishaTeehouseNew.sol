...
// File contracts/GeishaTeehouseDev.sol
...
contract GeishaTeehouseNew is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxMintAmountPresale = 7;
    uint256 public maxMintAmount = 8;
    uint256 public nftPerAddressLimitVipPresale = 3;
    uint256 public nftPerAddressLimitPresale = 7;
    uint256 public nftPerAddressLimit = 8;
    uint256 public vipPreSaleDate = 1638763200;
    uint256 public preSaleDate = 1638849600;
    uint256 public publicSaleDate = 1638936000;
    ...
    modifier saleStarted() {
        require(block.timestamp >= vipPreSaleDate, "Sale has not started yet");
        _;
    }
    ...
    function isWhitelisted(address _user) public view returns (bool) {
        // vip whitelist users are also whitlested
        return
            whitelistedAddresses[_user]; /*|| whitelistedVipAddresses[_user]*/
    }
    ...
    function setNftPerAddressLimitVipPreSale(uint256 _limit) public onlyOwner {
        nftPerAddressLimitVipPresale = _limit;
    }
    ...
    function setVipPreSaleDate(uint256 _vipPreSaleDate) public onlyOwner {
        vipPreSaleDate = _vipPreSaleDate;
    }
