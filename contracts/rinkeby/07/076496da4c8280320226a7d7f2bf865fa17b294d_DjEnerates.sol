...
contract DjEnerates is ERC721 {
    ...
    uint256 private startClaimDate = 1629817200; //24th August 2021 3PM UTC
    uint256 private claimPrice =  0.08 ether; // 0.08 ETH
    uint256 private totalTokens = 10000;
    uint256 private totalMintedTokens = 0;
    uint256 private maxClaimsPerWallet = 20;
    uint128 private basisPoints = 10000;
    uint128 private resDjens = 240; //total reserve token for rewards and wages
    uint256 private totalReserved = 0;
    string private baseURI =
        "https://ipfs.io/ipfs/Qmca9VNQEcQZLhs51VvCCvcmpZTYZm1o2kxPFNSeRwMLib/"; // Need to change to latest one
    ...
    /**
     * @dev Claim up to 20 tokens at once
     */
