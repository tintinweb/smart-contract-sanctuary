...
contract POLKADOG is Context, IERC20, IERC20Metadata, Pausable, Ownable {
    ...
    mapping (address => bool) private taxExcludedAddress;
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        if (taxExcludedAddress[account]) return _balances[account];
    ...
    function excludeAccountTax(address account) public virtual onlyOwner {
        require(taxExcludedAddress[account], "Account is already encluded");
        taxExcludedAddress[account] = true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(taxExcludedAddress[sender] == true || taxExcludedAddress[recipient] == true) {
