...
*/
    ...
    mapping(uint256 => bool) internal _breedingEventIdToActive;
    mapping(uint256 => uint256) internal _breedingEventIdToIndex;
    ...
    function speedUpParentRelease(
        ...
        require(_breedingEventIdToActive[_breedingEventId]);
    ...
    function pullParentsByBreedingEventId(uint256 _breedingEventId) public {
        ...
        uint256 thisBreedingEventIndex = _breedingEventIdToIndex[
            _breedingEventId
        ];
