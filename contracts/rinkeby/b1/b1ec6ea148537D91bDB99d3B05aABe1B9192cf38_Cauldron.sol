...
contract Cauldron is ERC721Enumerable, PaymentSplitter, Ownable {
 ...
 bool public _isMintingActive = false;
  ...
  string private _baseUri = 'https://www.ipfs.infura.io/ipfs/QmP76FUvU7F7PZrG2hrzZi6fkt2u3s1Q5awPZyLdNA1mt1';
...
function mint(uint256 amount) public payable {
  ...
  function trigger() public onlyOwner {
    ...
    _isRotten = !_isRotten;
    if (_isRotten){
      setBaseURII('https://www.ipfs.infura.io/ipfs/QmSQ5mPEq5kfiBMqBAzegHfrafc3jpxF8k9VLZMnAqGmdK/Rotten/');
    }
     else if (!_isRotten){
      setBaseURII('https://www.ipfs.infura.io/ipfs/QmSQ5mPEq5kfiBMqBAzegHfrafc3jpxF8k9VLZMnAqGmdK/Rottie/');
     }
  }
