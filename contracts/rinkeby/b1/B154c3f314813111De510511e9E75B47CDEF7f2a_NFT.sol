...
contract NFT is ERC721, Ownable {
    ...
    uint256 public constant SALE_START_TIMESTAMP = 1633696687;
    uint256 public constant ALLOW_ETH_TIMESTAMP = SALE_START_TIMESTAMP + 300 ;
    ...
    */
    function mintNFT(uint numberOfNfts, uint256 _value, bool _isETH) public payable {
        ...
        if(block.timestamp <= ALLOW_ETH_TIMESTAMP)
        {
            ...
            IERC20Burnable(LEASH).transferFrom(msg.sender, address(this), _value);
        }
