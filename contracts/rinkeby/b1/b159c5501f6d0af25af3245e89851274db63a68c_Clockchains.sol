...
pragma solidity ^0.8.0;
contract Clockchains is Context, ERC721Enumerable, ERC721Burnable {
	...
	function MassMint(uint256 _amount) public virtual {
		require(_msgSender() == smart_contract_owner, "Not authorized!");
		require((ERC721Enumerable.totalSupply() + _amount <= 365), "Cannot mint more than 365 tokens!");
