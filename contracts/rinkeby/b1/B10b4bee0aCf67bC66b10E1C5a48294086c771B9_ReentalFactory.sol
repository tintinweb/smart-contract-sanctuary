...
import "./ReentalToken.sol";
import "./utils/UUPSUpgradeableByRole.sol";

contract ReentalTokenProxy is BeaconProxy {
...
contract ReentalFactory is UUPSUpgradeableByRole {
    ...
    function initialize() public initializer {
        ...
        UpgradeableBeacon _beacon = new UpgradeableBeacon(address(new ReentalToken()));
        beacon = address(_beacon);
        _beacon.transferOwnership(msg.sender);
    }

    function createToken(bytes calldata initializeCalldata) public onlyRole(DEFAULT_ADMIN_ROLE) returns(address) {
        ReentalTokenProxy proxy = new ReentalTokenProxy(
            beacon,
            initializeCalldata
        );
