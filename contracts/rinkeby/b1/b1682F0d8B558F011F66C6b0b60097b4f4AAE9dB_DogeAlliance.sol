...
contract DogeAlliance is ERC721Enumerable, Ownable {
    ...
    uint8 public constant maxEarlyAccessPurchase = 3;
    uint8 public constant maxPublicPurchase = 5;
    uint256 public maxEarlyAccess = 1300;
    uint256 public maxSupply = 9000;
    bool public isActive = false;
    bool public isEarlyAccessActive = false;

    mapping (address => uint256) public mintedPerWhitelistedAddress;
    mapping (address => bool) public whitelistedAddress;
    mapping(address => uint256) addressBlockBought;

    constructor(string memory tokenBaseUri ) ERC721("Doge Alliance", "DOGE")  {
     ...
     * Mint Early Access
     */
    function earlyMint(uint256 numberOfTokens) public payable {
        uint256 supply = totalSupply();
        uint256 numberOfMints = mintedPerWhitelistedAddress[msg.sender];
        ...
        require(isEarlyAccessActive, "Early Access Mint is not active yet");
        require(whitelistedAddress[msg.sender], "You need to be whitelisted"); 
        require(numberOfMints <= maxEarlyAccessPurchase, "You've already minted 3");
    ...
    function mintDoge(uint256 numberOfTokens) public payable {
        ...
        require(supply + numberOfTokens <= maxSupply, "Exceeds maximum supply" );
    ...
    function mintReserved() public onlyOwner {
        uint256 supply = totalSupply();
        require(reserved > 0, "Giveaway has been minted!");
    ...
    function isAddressReserved(address _address) internal view returns(bool) {
    ...
    function addMultipleAddresses(address[] memory _address) public onlyOwner {
