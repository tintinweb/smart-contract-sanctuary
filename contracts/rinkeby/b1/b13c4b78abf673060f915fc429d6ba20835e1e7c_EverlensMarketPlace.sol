    ...
    IERC721ReceiverUpgradeable
{
    ...
    mapping(uint256 => AuctionOrder) auctionOrders;

    //orderId -> BidDetails
    mapping(uint256 => BidDetails) tokenBids;
    ...
    uint256 constant MARKETPLACE_LISTING_FEES = 10**6;
        ...
        OnlySeller(orderId)
    {
        ...
        //Transfer Fees to the feeAddress
        elenTokenContract.transferFrom(address(this), feeAddress, feeAmt);
