...
contract TestGuys is ERC721Enumerable, Ownable {
	...
	// withdraw address
	address t1 = 0x9eDa1cd31386f67C030c64EbdB362F46fdD79226;

	constructor(string memory baseURI, string memory passPhrase) ERC721("TestGuys", "TESTGUYS")  {
		setBaseURI(baseURI);
	...
	function mintLilguys(uint256 num) public payable {
		...
		require( supply + num < 8500 - _reserved, "Exceeds maximum lilguys supply" );
