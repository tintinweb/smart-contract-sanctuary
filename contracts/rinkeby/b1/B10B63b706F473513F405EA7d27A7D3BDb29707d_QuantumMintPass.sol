...
contract QuantumMintPass is IQuantumMintPass, OSContractURI, Ownable, ERC1155Supply, ERC1155Burnable {
    ...
    function claim(
        ...
        require(mp.redeemableContract != address(0), "claim: mint pass does not exist");
