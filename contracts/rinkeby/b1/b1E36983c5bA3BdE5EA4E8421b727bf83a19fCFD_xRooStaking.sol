...
contract xRooStaking {
    using PRBMathUD60x18 for uint256;
    event Staked(address indexed _user, uint256 _stake, uint256 _liquidity, uint256 _weth);
    ...
    function removeLiquidity(uint256 _amountTokenMin, uint256 _amountWETHMin)
        external
    {
        require(users[msg.sender].lastTimestamp + lockTime < block.timestamp, "Locked");
    ...
    function _claimContractNFTXRewards() internal {
        ...
        require(
            NFTXVault.balanceOf(address(this)) ==
                currentRewards + dividend,
            "Unexpected balance"
        );
