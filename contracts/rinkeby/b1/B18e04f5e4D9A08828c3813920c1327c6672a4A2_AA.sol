...
contract AA is ERC721A, Ownable {
    ...
    uint256 public presaleTime = 1641840718;
    //December 16th 11PM GMT 
    uint256 public presaleClose = 1641964993;

    //December 17th 3AM GMT
    uint256 public mainsaleTime = 1642051393;
  ...
  ) ERC721A("AA", "AA", maxBatchSize_, collectionSize_){
    ...
    {
        transferFrom(address(this), airdropPatricipent, tokenID);
    }
