...
contract dogeIncubator is Ownable, IERC1155Receiver, VRFConsumerBase {
    ...
    */
    ...
    function debug_manualHatchEgg(uint256 randomNumber, address hatcher) public onlyOwner {
    ...
    function debug_manualHatchSpecificEgg(uint256 eggIndex, address hatcher) public onlyOwner {
        
        require(availableDoges.length >= 1, "No more doges");
        
        uint256 randomDoge = eggIndex;
    ...
    function debug_getEggHatcher(bytes32 requestId) public view onlyOwner returns(address) {
        return(eggHatcher[requestId]);
    }
