...
contract Recipt is 
    ...
    function getData(uint256 tokenId) public view returns (address, uint256, string memory) {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        return string(abi.encodePacked(fname,id,fauthor,author,fdate,date,ftext,text,fend));
    }
