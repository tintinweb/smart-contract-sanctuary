...
contract AcidBoyz is ERC721URIStorage, VRFConsumerBase {
    ...
    function getTokenURI() private returns(string memory) {
        getRandomNumber();
        for(uint256 i = block.timestamp+80; i>block.timestamp; i--) {} //To ensure that randomness fullfilled;
        return string(abi.encodePacked(
            "https://ipfs.io/ipfs/QmdWigZe82LRoSLit4BzhB6HTJRNYgGtZk4FxSrKduQyeS/", 
            Strings.toString(randomResult),
            ".json"));
    }
