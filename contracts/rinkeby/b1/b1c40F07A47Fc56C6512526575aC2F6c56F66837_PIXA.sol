...
contract ERC20 is Context, IERC20 {
    ...
    address payable wizarDAO = 0xcB388d32d0E5531fc85ca636238a2D307baAba6B; //DAO address
...
contract PIXA is ERC20 {
    ...
    address payable wizarDAOwallet = 0xcB388d32d0E5531fc85ca636238a2D307baAba6B; // DAO wallet
    ...
    function buyTokens(uint256 _numberOfTokens) public payable {
        require(saleStatus);
        require(msg.value == multiply(_numberOfTokens.div(1000000000000000000), tokenPrice));
