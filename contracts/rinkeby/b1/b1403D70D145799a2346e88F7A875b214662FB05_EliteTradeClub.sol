...
contract EliteTradeClub is ERC721, Ownable {
    ...
    constructor() ERC721("IgorNft", "IGOR") {}

    function mint(uint256 count) external payable {
        require(!_paused, "Can't mint while sales paused");
        require(_presaleStarted, "Sales not active at the moment");
    ...
    function mintPresale(uint256 count) public payable {
        ...
        require(presaleClaimedList[msg.sender] + count <= MAX_NFT_PURCHASE_PRESALE,"Exceeds quota of presale mint.");
        require(msg.value >= count * 0.01 ether, "Insufficient payment");
