...
contract MyToken is ERC20 {
    string public tokenName = "TapiroToken";
    string public tokenSymbol = "TAP";
...
contract MyBank {
    string public name = "MyBank";
    MyToken public token;

    uint256 public totalBankBalance;
    address payable public owner;
    mapping(address => uint256) public userBankAccountBalances;
    ...
    function deposit(uint _amount) public {
        require(token.balanceOf(msg.sender) > _amount, "User has not sufficient balance");
        totalBankBalance += _amount;
        userBankAccountBalances[msg.sender] += _amount;
    ...
    function withdraw(uint _amount) public {
        require(userBankAccountBalances[msg.sender] >= _amount, "Your Bank Account balance is low");
        totalBankBalance -= _amount;
        userBankAccountBalances[msg.sender] -= _amount;
