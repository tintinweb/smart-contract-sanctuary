...
contract nft is ERC721, Ownable {
    ...
    address payable public constant projectWallet = payable(0xC84305CE347FD912B3ddeFBaA7FD731A329A81A6);
    address public marketingAccount = 0xC84305CE347FD912B3ddeFBaA7FD731A329A81A6;
    ...
    */
    ...
    function mint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v, _r, _s) public payable {
        ...
        require(msg.value == mintCost * number, "Not sufficient ether to mint this amount of NFTs (Cost = 0.0666 ether for each NFT)");
    ...
    function changeMarketingAccount(address _marketingAccount) public {
        address ow = owner();
        require(msg.sender == ow, "Only available for the Owner of the Contract");
