...
contract TheOtherAvatars is ERC721Enumerable, Ownable, CustomCounter, ReentrancyGuard, Signable {
    ...
    uint256 public constant mintPerAccount = 10;
    uint256 public constant artistTokensCount = 8;
    
    // TODO: Check constants before deploy
    address private constant withdrawAddress = 0x35C4CE85EEd7857BD9eB756387feC18809adad42;
    ...
    constructor() ERC721("The Other Avatars", "TOA") CustomCounter(artistTokensCount) {
