...
contract HELLOWORLD is Delegated, ERC721EnumerableB, PaymentSplitter {
  using Strings for uint;

  uint public MAX_SUPPLY = 99;

  bool public isActive   = false;
  uint public maxOrder   = 4;
  ...
  address[] private addressList = [
    0xfcBc113DA9a4ae62006914468Eed0974ed508885,
  ...
  constructor()
    Delegated()
    ERC721B("HELLO WORLD PLZ WORK", "HELLOWORLD")
