...
contract Color is ERC721Namable, Ownable {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Color #',
                        toString(tokenId),
                        '", "description": "Colors On Chain are randomized hex colors generated and stored on chain. All functionality is intentionally omitted for others to interpret. Feel free to use Color in any way you want.", "image": "data:image/svg+xml;base64,',
    ...
    function mint(uint256 num) public payable {
        ...
        require(newItemId > 100, "presale mint not complete");
    ...
    function breed(uint256 tokenIdOne, uint256 tokenIdTwo) public payable {
        ...
        require(tokenIdOne > 0 && tokenIdOne < 8889 && tokenIdTwo > 0 && tokenIdTwo < 8889, "Can only breed gens");
        uint256 newItemId = _tokenIds.current();
        require(newItemId > 2, "Minting has not completed");
