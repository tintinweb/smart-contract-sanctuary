...
contract Pets is ERC721, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = string(abi.encodePacked('<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.Godly { fill: white;', info,'}.Hellish { fill: white;', info, '}.Mythical { fill: %23e8b23d; ', info, '}.Legendary { fill: %23e8b23d;', info, ' }.Epic { fill: %23b935d2;', info, abi.encodePacked(' }.Rare { fill: %236699cc;', info, '}.Common { fill: %236a7b7e;', info, '}</style><rect width="100%" height="100%" fill="black" /><text x="10" y="20" class="', rarity, '">')));
