...
contract Project1207Claim is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address public project1207ContractAddress;

  mapping(address => uint256) public addressMintedBalance;

  IERC721Enumerable public project1207Contract;
...
*/
      ...
      require(
          ...
          "PROJECT1207_CLAIMED_FOR_TOKEN_ID"
      );
  ...
  function project1207OwnerFreeClaim() public {
    uint256 tokenBalanceOwner = project1207Contract.balanceOf(_msgSender());
 //   uint index = totalSupply();
    ...
    for (uint256 i = 0; i < tokenBalanceOwner; i++) {
        ...
        // the _claim() function
        _claim(
            project1207Contract.tokenOfOwnerByIndex(_msgSender(), i),
            _msgSender()
        );

//    _safeMint(_msgSender(), index + i);
    }
  }
  ...
  function withdraw() public payable onlyOwner {
    ...
    /// @notice Allows to set a new contract address for Project1207. This is
    /// relevant in the event that Project1207 migrates to a new contract.
    /// @param project1207ContractAddress_ The new contract address for Project1207
  function setProject1207ContractAddress(address project1207ContractAddress_)
        external
        onlyOwner
    {
        project1207ContractAddress = project1207ContractAddress_;
        project1207Contract = IERC721Enumerable(project1207ContractAddress);
    }
