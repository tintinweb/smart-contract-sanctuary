...
contract VestingMock is EIP712, Ownable {
    ...
    function getInfo()
        ...
        returns (
            ...
            uint256 tokenPrice,
            uint256 initialUnclokPercentage,
    ...
    function deposite(uint256 _amount, bool _fiat) external {
    ...
    function harvest() external {
        ...
        require(amountToTransfer != 0, "Not have avail rewards");
    ...
    function convertToToken(uint256 _amount) public view returns (uint256) {
        return _amount.mul(_tokenPrice).div(10**18);
    }
    ...
    function _calculateUnlock(address _addr) internal view returns (uint256) {
        ...
        uint256 initialUnlockAmount =
            tokenAmount.mul(_initialPercentage).div(10**18);
    ...
    function _isValidAmount(uint256 _amount) internal view returns (bool) {
        ...
        uint256 remainingAmount =
            Math.min(
                ...
                _totalSupply.sub(_totalDeposited)
            );
        return
