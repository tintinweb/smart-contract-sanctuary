...
contract NeverFightTwice is VRFConsumerBase, IERC721Receiver {
    ...
    event Win(address _better, bytes32 requestId, uint256 randomNumber, address NFTcontract, uint256 tokenId);
    ...
    internal override {
        ...
        if(randomNumber.mod(2) == 0 || NFTsLen == 0) {
            ...
            emit Win(nft.owner, requestId, randomNumber, winningNFT.NFTcontract, winningNFT.tokenId);
        }
    }
