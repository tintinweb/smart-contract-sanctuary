...
abstract contract MonsterBlockCoreERC721 is ERC721, ERC721Burnable, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
  ...
  function withdraw() public onlyOwner {
    (bool charitySuccess, ) = payable(charityAddress).call { value: address(this).balance * 15 / 100 }('');
...
contract MonsterBlocks is MonsterBlockCoreERC721, VRFConsumerBase {
  ...
  function mintMonsterBlock(uint256 _quantity) internal {
    ...
    for (uint8 i = 0; i < _quantity; i++) {
      ...
      if (_quantity % 5 == 0) { // New Chainlink call for every five mints
    ...
    VRFConsumerBase(VRFCoordinator, LinkToken)
  {
    ...
    traitProbabilities[0] = [4, 10, 17, 20, 4, 17, 17, 17, 17, 4, 17, 17, 20, 17, 17, 17, 10, 17, 17, 10, 17, 17, 3, 17, 17, 10, 17, 20, 17, 17, 17, 17, 17, 8, 17, 19, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 2, 17, 8, 17, 17, 17, 10, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 4, 17, 17];
    ...
    traitProbabilities[2] = [1, 2, 2, 1, 12, 10, 4, 10, 12, 12, 7, 12, 14, 12, 12, 12, 7, 12, 10, 12, 12, 14, 4, 12, 12, 6, 12, 4, 4, 12, 12, 12, 12, 12, 12, 12, 12, 10, 14, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 14, 12, 12, 12, 12, 12, 14, 12, 12, 12, 12, 12, 14, 12, 12, 12, 12, 13, 6, 3, 12, 12, 12, 14, 12, 6, 12, 14, 12, 12, 12, 12, 14, 6, 12, 12, 12, 8, 12, 12, 14, 14, 14];
