...
contract TchToken is ERC20Burnable, OwnableContract {
    ...
    function updateBlacklist(address _user, bool _value) public  onlyOwner {
        blacklist[_user] = _value;
        emit BlacklistUpdated(_user, _value);
    }
    ...
    function _beforeTokenTransfer(address _from, address _to, uint256 _amount) internal virtual override(ERC20) {
        require (!isBlackListed(_from), "Token transfer refused by blacklist");
