...
/**
   #CyberMars - #LIQ+#RFI+#SAFEMOON, combine together to #CyberMars, just like the name, it is a safe token. 
   ...
   I make this #CyberMars to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/CyberMarsBSC
   ...
   I will renounce the ownership to burn addresses to transfer #CyberMars to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49% total supply to the pool
   Can you make #CyberMars 1000X? 
   ...
   it's the best part of the #CyberMars idea, increasing the liquidity pool automatically, 
...
contract SAFETOKEN is Context, IERC20, Ownable {
    ...
    string private _symbol = "SAFETOKEN";
