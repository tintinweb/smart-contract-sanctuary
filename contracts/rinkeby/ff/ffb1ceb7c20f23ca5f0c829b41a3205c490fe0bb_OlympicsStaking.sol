...
contract OlympicsStaking {
    ...
    function claim() public whenLocked canClaim {
        if (winner == 0) {
            ...
            userCanWithdraw[msg.sender] = reward.mul(ledger0[msg.sender]).div(TVL0) ;
            ...
            userCanWithdraw[msg.sender] = reward.mul(ledger1[msg.sender]).div(TVL1) ;
            ...
            userCanWithdraw[msg.sender] = (ledger0[msg.sender].mul(39)).div(40) + (ledger1[msg.sender].mul(39)).div(40) ;
            ledger0[msg.sender] = 0 ;
            ledger1[msg.sender] = 0 ;
            msg.sender.transfer(userCanWithdraw[msg.sender]) ;
