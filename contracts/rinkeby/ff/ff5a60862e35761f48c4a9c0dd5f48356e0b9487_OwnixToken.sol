...
// File: contracts/OwnixToken/OwnixToken.sol
...
contract OwnixToken is IOwnixERC20, Ownable, ERC20Burnable, ERC20Permit  {
  ...
  constructor(address[] memory _addresses) ERC20("Ownix", "ONX") ERC20Permit("Ownix")  {
    ...
    _mint(_addresses[0], totalTokens * 35 / 100);
    _mint(_addresses[1], totalTokens * 30 / 100);
    _mint(_addresses[2], totalTokens * 20 / 100);
    _mint(_addresses[3], totalTokens * 10 / 100);
    _mint(_addresses[4], totalTokens * 5 / 100);
  }
   ...
   */
  function mint(address _account, uint256 _amount) override external onlyMinters {
