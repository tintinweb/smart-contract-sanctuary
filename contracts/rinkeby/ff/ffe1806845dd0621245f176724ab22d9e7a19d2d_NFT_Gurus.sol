...
contract NFT_Gurus is ERC721Enumerable, Ownable {
    ...
    uint256 public _limit = 7;
    uint256 public _reserved = 2;
    ...
    function WHITELIST_MINT(uint256 num) public payable {
        ...
        require( perWallet[msg.sender] + num <= _maxperWalletWhiteList,   "You are exceeding limit of per wallet GURUS" );
        require( supply + num <= _limit - _reserved,             "Exceeds maximum GURUS supply" );
        require( msg.value >= _price * num,                      "Ether sent is not correct" );
