...
contract ConceptualProject is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  // TODO: Remove from contract after done with testing
  // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  function ownerUpdateNaturalCount(uint256 _count) public onlyOwner {
    naturalCount = _count;
  }

  function ownerUpdateSyntheticCount(uint256 _count) public onlyOwner {
    syntheticCount = _count;
  }
      ...
      bytes(
        string(
          abi.encodePacked(
            ...
            '",',
            '"description": "The Conceptual Project is a collection of randomly generated conceptual metephors generated and stored entirely on the Ethereum blockchain. These abstract thoughts and ideas can inspire endless interpretations and use cases. Feel free to use these concepts in any way you see fit.",',
...

{
  ...
  "libraries": {
    "/contracts/ConceptualProjectParts.sol": {
      "ConceptualProjectParts": "0x625750a3fdf0e54E9B95fc6Adf263368c3e47a19"
    }
  },
  "outputSelection": {
    "*": {
