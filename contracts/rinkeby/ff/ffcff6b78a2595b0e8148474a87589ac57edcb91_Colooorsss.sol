...
contract Colooorsss is ERC721, ERC721Enumerable, Ownable {
  
  // Provenance
  string public COLOOORSSS_HASH = "";
  ...
  constructor(string memory baseURI) ERC721("Colooorsss", "CLOO") {
    setBaseURI(baseURI);
  }
  ...
  function withdraw() payable public {
        payable(member1).transfer(address(this).balance /34);
        payable(member2).transfer(address(this).balance /34);
		payable(member3).transfer(address(this).balance /32);
}
  ...
  function setProvenanceHash(string memory provenanceHash) public onlyOwner {
    COLOOORSSS_HASH = provenanceHash;
  }
}