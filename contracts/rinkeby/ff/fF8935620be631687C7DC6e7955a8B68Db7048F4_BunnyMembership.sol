...
/*
    function getMembershipInfo( uint _membershipType, address _user ) public view returns (uint256[] memory) {

        // return premint discount price
        uint256[] memory retvals;
        
        retvals[0] = _memebershipPrice[_membershipType];
        retvals[1] = _forSaleSupply[_membershipType];
        retvals[2] = _membershipSupply[_membershipType];
        retvals[3] = _discountTable[_membershipType][_discountType[_user]];
