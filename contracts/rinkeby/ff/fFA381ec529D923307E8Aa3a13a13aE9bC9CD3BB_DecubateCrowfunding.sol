...
contract DecubateCrowfunding is IDecubateFactory, Ownable, ReentrancyGuard {
     ...
     *
     */
    uint256 private _requiredVoteNumber;
    ...
    modifier requireDCB(address _wallet) {
        ...
        require(
            _decubateToken.balanceOf(address(_wallet)) > 0,
        ...
        returns (bool)
    {
        ...
        dcbAgreement.totalInvestFund += dcbAgreement.investorList[msg.sender]
            .investAmount;
     ...
     *
     */
    function voteDCBAgreement() external override returns (uint256) {
        ...
        require(
            ...
            "Investor already vote on this project"
        );
     ...
     *
     */
    function claimInnovatorFund(uint256 _agreementID, address _token)
        external
        override
        nonReentrant
        requireDCB(msg.sender)
        returns (bool)
    {
        ...
        require(
            ...
            "agreement should have enough vote"
        );
        ...
        */
        ...
        emit ClaimFund(_agreementID, _token);
        return true;
    }
...
interface IDecubateFactory {
     ...
     *
     */
    event ClaimFund(uint256 identifier, address token);
