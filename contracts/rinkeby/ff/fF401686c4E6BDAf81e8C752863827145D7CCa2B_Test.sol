...
contract Swapper is Ownable {
    ...
    public payable
    {
        ...
        // TransferHelper.safeApprove(_tokenIn, address(uniswapRouter), _amountInMaximum);
        ...
        // _amountIn = uniswapRouter.exactOutputSingle(params);
        TEST_AMOUNT_IN = uniswapRouter.exactOutputSingle(params);
