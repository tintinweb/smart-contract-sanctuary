...
contract CharityStarsToken is ERC721Enumerable, Ownable {
    ...
    function addCategory(string calldata newCategory) external onlyOwner {
    ...
    function setCategoryVisibility(bytes32 categoryHash, bool visibility) external onlyOwner {
