...
contract ManateezComic is ERC721, Ownable {
    ...
    function sendAlgaeToMerchPassOwners(uint256 _id) external {
        ...
        rewards[msg.sender] += MERCH_PASS_PAYMENT;
    ...
    constructor(address _algae, IERC721Enumerable _mightyManateez, IMerchPass _merchPass) ERC721("MightyManateez Comic Issue 1", "MMCOMIC") {
