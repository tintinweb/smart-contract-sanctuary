...
contract Cheesus is TransactionThrottler, ERC20 {

    constructor()
    ERC20("Cheesus token", "CHEESUS")
    { 
     ...
     * See {ERC20-_burn}.
     */
    function burn(uint256 amount) external transactionThrottler(msg.sender, address(0), amount){
