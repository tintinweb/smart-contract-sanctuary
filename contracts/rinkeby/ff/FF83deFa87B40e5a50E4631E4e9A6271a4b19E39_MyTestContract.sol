...
// File contracts/MyTestContract.sol
...
contract MyTestContract is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("MyTestContract", "MTC") {
        setBaseURI(baseURI);
    }
    ...
    function preSaleMint() public payable {
        ...
        require(supply < 1000,                      "max_token_supply_exceeded");
    ...
    function withdrawAll() public payable onlyOwner {
        address a1 = 0xb13280E2a670037C34bDCCd0dcF7835ebA8F1225;
