 ...
 */
abstract contract Test4YokaiMasksEthereum is ContextMixin, ERC721, ERC721Enumerable, ERC721URIStorage, NativeMetaTransaction, Ownable {
     ...
     */
    constructor(address _proxyRegistryAddress) ERC721("Yokai Masks", "YM") {
        devAddr = msg.sender;
...
contract Test4YokaiEthereumBridge is IERC721Receiver, Ownable {
    // Signer address
...
contract Test4YokaiBSCBridge is IERC721Receiver, Ownable {
    // Signer address
    address public signerAddress;
