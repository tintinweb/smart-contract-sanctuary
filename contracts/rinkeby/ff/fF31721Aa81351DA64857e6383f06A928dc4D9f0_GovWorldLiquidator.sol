...
contract GovWorldLiquidator is GovLiquidatorBase {
    ...
    function _liquidateCollateralAutSellOff(uint256 _loanId) internal {
        ...
        for (
            ...
            if (govClaimToken.isClaimToken(claimToken)) {
                IERC20Upgradeable(loanDetails.stakedCollateralTokens[i]).safeTransfer(
                    lenderDetails.lender,
                    loanDetails.stakedCollateralAmounts[i]
                );
        ...
        onlyLiquidatorRole(msg.sender)
    {
        ...
        // require(this.isLiquidationPending(_loanId));  // TODO uncomment this line before  deployment
    ...
    function fullLoanPaybackEarly(uint256 _loanId) internal {
        ...
        govTokenMarket.getLoanOffersToken(_loanId).loanStatus = TokenLoanData
            .LoanStatus
            .CLOSED; //TODO check again is status updating or not?
    ...
    function payback(uint256 _loanId, uint256 _paybackAmount) public override {
        ...
        // require(!this.isLiquidationPending(_loanId), "GLM: you cannot payback this time"); //TODO uncomment before live
        require(
