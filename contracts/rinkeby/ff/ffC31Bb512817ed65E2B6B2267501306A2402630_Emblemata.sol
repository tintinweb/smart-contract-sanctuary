...
contract Emblemata is CryptoCollecatableBase {
    constructor()
        CryptoCollecatableBase(
            "Emblemata",
            "EMBL",
            0.12 ether,
            8000,
    ...
    {
        setMintBatchLimit(20); //can mint maximum 20 at once -> 10 is default
    }
    ...
    function mintBatch(uint256 numberOfItemsToMint)
        external
        payable
        mintingAllowed
        nonReentrant
    {
        ...
        require(
            msg.value >= mintPrice * numberOfItemsToMint,
...
contract CryptoCollecatableBase is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    ReentrancyGuard, 
    Ownable
{
    ...
    //all funds redrawall function
    function withdrawSomeFunds(uint256 amount) external onlyOwner nonReentrant {
        uint256 balance = address(this).balance;
