...
contract Catbotica is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard, IERC2981 {
    ...
    uint256 public constant TICK_PERIOD = 2 minutes; // Time period to decrease price
    uint256 public constant PUBLIC_SALE_PERIOD = 16 minutes; // Dutch Auction Time Period
    ...
    uint256 public constant RESERVED_TOKEN_ID_OFFSET = 20; // Tokens reserved for RWA list
    ...
    uint16 public constant MAX_PRIVATE_SALE_SUPPLY = 20; // Cap for tokens to be sold in private sale is 2500 in addition to 500 for redmeption by RWA list
    ...
    function mintPrivateSale(uint8 numTokens) public payable {
        ...
        require(msg.value >= PRIVATE_SALE_PRICE * numTokens, 'Insuffiecint ETH');
    ...
    /**
     * @dev Adds list of wallet addresses and their Catbotica membership card balances to whitelsited members in '_memberslist'.
     *
    ...
    /**
     * @dev removes list of wallet addresses of already whitelsited members from '_walist'.
     *
     * @param users - List of wallet addresses
     */
