...
contract SporesNFTMarket is Ownable, ReentrancyGuard {
    ...
    */
    function updateRegistry(address _newRegistry) external onlyOwner {
        require(_newRegistry != address(0), "SporesNFTMarket: Set zero address");
    ...
    */
    function buyNFT721NativeCoin(
        ...
        require(
            registry.supportedNFT721(_contractNFT) == true,
        ...
        paymentTransfer(payable(registry.treasury()), _fee);
    ...
    */
    function buyNFT1155NativeCoin(
        ...
        require(
            registry.supportedNFT1155(_contractNFT) == true,
            "SporesNFTMarket: NFT1155 Contract not supported"
        );
        require(
    ...
    */
    function buyNFT721ERC20(
        ...
        require(
            registry.supportedTokens(_paymentToken) == true,
        ...
        IERC20(_paymentToken).safeTransferFrom(_msgSender(), registry.treasury(), _fee);
...
contract SporesRegistry is Initializable, OwnableUpgradeable {
    ...
    */
    function unregisterToken(address _token) external onlyOwner {
        require(supportedTokens[_token], "SporesRegistry: Token not registered");
    ...
    */
    function registerNFTContract(address _contractNFT, uint256 _opcode) external onlyOwner {
        ...
        require(_opcode == NFT721_OPCODE || _opcode == NFT1155_OPCODE, "SporesRegistry: Invalid opcode");

        if (_opcode == NFT721_OPCODE) {
            require(!supportedNFT721[_contractNFT], "SporesRegistry: NFT721 Contract registered");
            ...
            require(!supportedNFT1155[_contractNFT], "SporesRegistry: NFT1155 Contract registered");
    ...
    */
    function unregisterNFTContract(address _contractNFT, uint256 _opcode) external onlyOwner {
        require(_opcode == NFT721_OPCODE || _opcode == NFT1155_OPCODE, "SporesRegistry: Invalid opcode");
        if (_opcode == NFT721_OPCODE) {
            require(supportedNFT721[_contractNFT], "SporesRegistry: NFT721 Contract not registered");
            delete supportedNFT721[_contractNFT];
        }else if (_opcode == NFT1155_OPCODE) {
            require(supportedNFT1155[_contractNFT], "SporesRegistry: NFT1155 Contract not registered");
