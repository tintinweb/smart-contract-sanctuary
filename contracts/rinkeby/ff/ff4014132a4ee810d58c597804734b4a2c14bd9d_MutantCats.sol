...
// File: contracts/MutantCats.sol


pragma solidity ^0.7.0;


contract MutantCats is ERC721, Ownable {
    using Strings for uint256;
    ...
    // todo 空投方法
    function preSale(address[] memory saleAddresses) public onlyOwner {
        require(totalCats + saleAddresses.length <= totalCount, "Purchase would exceed max supply of Apes");
