...
contract SlyPantherClub is ERC721Enumerable, Ownable {
    ...
    function preSaleMint(uint256 numOfTokens) public payable {
        ...
        require(_tokenIdTrackerPrivate.current() < MAX_SUPPLY, "Out Of Stock.");
        require(_tokenIdTrackerPrivate.current() + numOfTokens <= PRIVATE_SUPPLY, "Exceeded private amount.");
        ...
        for(uint256 i=0; i<numOfTokens; i++) {
            ...
            _safeMint(msg.sender, _tokenIdTrackerPrivate.current() + 1);
