...
contract KEKL is ERC721PresetMinterPauserAutoId, Ownable, ContextMixin {
    using SafeMath for uint256;

    uint256 public constant MAX_TOKENS = 10000;
    uint256 private _price = 0.02 ether;
    address who = 0xD2CBAF3C8B3F6630da84891D07571EaC8a851536;
    ...
    function mintToken(uint256 quantity, address receiver) public payable {
        ...
        require(
            ...
            "value must be greater than 0.02"
        );
        require(
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(who).send(_total));
    }
