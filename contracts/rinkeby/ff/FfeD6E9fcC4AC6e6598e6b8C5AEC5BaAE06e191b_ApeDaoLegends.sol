...
contract ApeDaoLegends is ERC1155, ERC1155Burnable, ERC1155Supply, Ownable, Pausable, ReentrancyGuard {
  ...
  address public mintTokenAddress = 0x32e173e29245c89cb938245a7b5F9fa8844A1e6A;
  ...
  function withdraw() public onlyOwner {
    Address.sendValue(payable(0x5e2eBd311Ed77dC6638c9f1998B8546C068067E5), address(this).balance);
  }
