...
contract Pseudopop is ERC721, ERC721Enumerable, Ownable {
    ...
    function vend(uint256 num) public payable {
        ...
        for (uint256 i = 0; i < num; i++) {
            ...
            uint256[2] memory seedFizz = BubbleMaker
                .biggerAndBetterThanGemblosBYAPPSUS(_currentToken);
...
contract BottleCaps is ERC20, ERC20Burnable, Ownable {
