...
contract Test1 is ERC721Enumerable, Ownable {
    ...
    uint256 public Test1Price = 10000000000000000;
    ...
    function mintpxMAYC(uint numberOfTokens) public payable {
        ...
        require(msg.value >= Test1Price * numberOfTokens, "ETH value sent is too little for this many pxMAYC");
    ...
    function _baseURI() internal view virtual override returns (string memory) {
      ...
      function setpxMAYCPrice(uint256 newTest1Price)public onlyOwner{
        Test1Price = newTest1Price;
    }
