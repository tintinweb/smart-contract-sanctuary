...
contract PerksForAdventurers is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint128 public constant MAX_SYNTHETIC_ITEMS = 2000;
    uint128 public price = 20000000000000000; //0.02 ETH
...
'Spoiled'
    ...
    function pluck(uint256 tokenId, string memory keyPrefix, string[] memory sourceArray) internal view returns (string memory) {
        ...
        // } else if(keccak256(abi.encodePacked(keyPrefix)) != keccak256(abi.encodePacked("FLAW")) ) {
        } else if (!strCompare(keyPrefix, "FLAW") ){
            ...
            if (strCompare(keyPrefix, "FIGHTING") || strCompare(keyPrefix, "CRAFTING") ){
                prefix = perkPrefixes;
            }
    ...
    function _totalSyntheticSupply() internal view returns (uint256) {
    ...
    function _totalOriginSupply() internal view returns (uint256) {
