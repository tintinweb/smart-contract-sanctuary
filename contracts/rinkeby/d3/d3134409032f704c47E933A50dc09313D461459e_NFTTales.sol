...
contract NFTTales is ERC721, ReentrancyGuard, Ownable {
    ...
    string[] private goal = [
		...
		"to sweep the floor by buying a",
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><rect width="100%" height="100%" fill="#FFBE61" /><style>.base { fill: #ffffff; font-family: papyrus; font-weight: bold; font-size: 12px; }</style><text x="33" y="65" class="base" style="font-size: 36px;">&#127800; NFT Tales &#127800;</text> <text x="145" y="105" class="base">N&#333; ';

        parts[1] = '</text><foreignObject width="300" height="250"  x="25" y="120" requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility"><p xmlns="http://www.w3.org/1999/xhtml" style="fill: #ffffff; font-family: papyrus; font-weight: bold; font-size: 12px; ">Once upon a time, there was a ';
		...
		output = string(abi.encodePacked(output, ', and', getTask3(tokenId), getGoal(tokenId), getGoalNft(tokenId), '. Complications arose when it was discovered that', getComplications(tokenId), '. Assistance came in the form of a', getHelpAttribute(tokenId)));
