...
contract FeelineFactory is Ownable {
    ...
    // How many items are available to sell
    ...
    constructor() {
        ...
        _FeelineClub = FeelineClub(0xbeb7646282e4B222a97c84F75b3CB41966Ae08De);
        _active = false;
        _readOnly = false;
        _inventory = 0;
    }
     ...
     */
    function addToInventory(uint256 _numItems) public onlyOwner {
        require(_readOnly == false, "Contract not active");
        require(
     ...
     */
    function removeFromInventory(uint256 _numItems) public onlyOwner {
        require(_readOnly == false, "Contract not active");
        require(
