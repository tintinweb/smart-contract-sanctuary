...
/**
*     ____          __    _        ___                 __ 
*    / __/_ _____  / /__ (_)__    / _ \___  ___  __ __/ /_
*   / _// // / _ \/  '_// / _ \  / // / _ \/ _ \/ // / __/
*  /_/  \_,_/_//_/_/\_\/_/_//_/ /____/\___/_//_/\_,_/\__/                                                      
* 
*/
interface IERC165 {
...
contract FunkinDonutsTest is IERC721 {
    ...
    uint public constant SALE_LIMIT = 500;
    ...
    string internal nftName = "Funkin Donuts Test";

    uint internal numTokens = 0;
    uint internal numSales = 0;

    address internal donuts;
    ...
    function tokenURI(uint256 _tokenId) external view validNFToken(_tokenId) returns (string memory) {
        return string(abi.encodePacked("https://funcked.co/api/", toString(_tokenId)));
    }
