 ...
 */
// TODO: is it right that upgrades/removals must pass by the guild/owner of this contract?
contract OraclesManager is Ownable, IOraclesManager {
    ...
    function instantiate(
        ...
        // FIXME: msg sender should be a KPI token
        ...
        address _instance = Clones.clone(_template);
        if (
...
interface IOraclesManager {
    ...
    function addTemplate(address _template, bool _automatable, string calldata _description)
        external;
