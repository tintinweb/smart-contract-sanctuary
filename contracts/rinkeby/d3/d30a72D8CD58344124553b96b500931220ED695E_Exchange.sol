...
contract ExchangeCore is ReentrancyGuarded, EIP712, ERC1155("papi"),Ownable,MoneyHandler{
        ...
        reentrancyGuard
    {
        ...
        require(validateOrderParameters(buyer, firstHash), "First order has invalid parameters");

        /* Calculate second order hash. */
        bytes32 secondHash = hashOrder(buyer);

        /* Check second order validity. */
        require(validateOrderParameters(seller, secondHash), "Second order has invalid parameters");
