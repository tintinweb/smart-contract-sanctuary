...
contract EveryDifferentWallet is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"EveryDifferentWallet";
    string private constant _symbol = unicode"EDW";
