...
contract Loomi is ERC20, ReentrancyGuard, Ownable {
    ...
    event InternalTransfer(address indexed from, address indexed to, uint256 indexed amount);

    constructor() ERC20("LOOMI", "LOOMI") {
    ...
    */
    function mintFor(address user, uint256 amount) external onlyAuthorised {
