...
contract ConvexCompoundGauge {
    ...
    function borrow(
        ...
        uint256 interestRate = getBorrowInterestRate(utilizationRate, _pid);
    ...
    function DemoAddPool() public {
        ...
        addPool(0,dai_usdc_supportPids,cusdc_cdai_curveCoinIds,1000);

        uint256[] memory eth_supportPids = new uint256[](2);
        eth_supportPids[0] = 0;

        int128[] memory ceth_curveCoinIds = new int128[](2);
        cusdc_cdai_curveCoinIds[0] = 0;

        addPool(1,eth_supportPids,ceth_curveCoinIds,1000);
    }
