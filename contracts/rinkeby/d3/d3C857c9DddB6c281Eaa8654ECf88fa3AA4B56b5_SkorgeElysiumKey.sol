...
contract SkorgeElysiumKey is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    uint public constant PRICE = 200000000000000;
    uint public constant ADDRESS_MAX_MINTS = 4;
    ...
    constructor(string memory baseURI) ERC721("ElysiumKey", "SEK") {
        _setBaseURI(baseURI);
    }
    ...
    address payable private maple = payable(0xb6F92F38f38Ee18977D3fED704c376fc218DBe77);
    address payable private devGuy = payable(0x270fE71bb18831DEaf845763EB629dD539931054);
    ...
    //Allows to see how many minted so far
