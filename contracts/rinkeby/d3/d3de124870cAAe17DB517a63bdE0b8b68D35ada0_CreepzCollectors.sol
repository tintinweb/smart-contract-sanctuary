...
contract CreepzCollectors is ERC1155Supply, Ownable {
    ...
    uint256 public ROYALTY_SIZE = 1000; // 10%
    ...
    function buyCreepzCollectors(uint256 tokensNumber, bytes calldata signature) public payable {
      ...
      require(totalSupply(CREEPZ_COLLECTORS) + tokensNumber <= MAX_SUPPLY, "You tried to mint more than the max allowed");
    ...
    function isWhitelisted(bytes calldata signature) public view returns (bool) {
        return (_validateSignature(signature, _msgSender()));
    }
