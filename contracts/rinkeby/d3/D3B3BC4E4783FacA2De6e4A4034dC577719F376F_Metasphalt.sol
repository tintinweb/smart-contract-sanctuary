//888b     d888 8888888888 88888888888     d8888  .d8888b.  8888888b.  888    888        d8888 888    88888888888 
//8888b   d8888 888            888        d88888 d88P  Y88b 888   Y88b 888    888       d88888 888        888     
//88888b.d88888 888            888       d88P888 Y88b.      888    888 888    888      d88P888 888        888     
//888Y88888P888 8888888        888      d88P 888  "Y888b.   888   d88P 8888888888     d88P 888 888        888     
//888 Y888P 888 888            888     d88P  888     "Y88b. 8888888P"  888    888    d88P  888 888        888     
//888  Y8P  888 888            888    d88P   888       "888 888        888    888   d88P   888 888        888     
//888   "   888 888            888   d8888888888 Y88b  d88P 888        888    888  d8888888888 888        888     
//888       888 8888888888     888  d88P     888  "Y8888P"  888        888    888 d88P     888 88888888   888     
...
// SPDX-License-Identifier: MIT                                                                                                              
    ...
    contract Metasphalt is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 7500000000000000; // 0.0075 ETH 
      ...
      event RacerMinted(uint256 tokenId, address owner); 
    
      constructor() ERC721("METASPHALT", "MTSPLT") {}
      ...
      function reserveTokens(address _to, uint256 _reserveAmount) //FOR DEVELOPERS
        external
        onlyOwner
      {
        require(
      ...
      function mintRacer(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit RacerMinted(id, msg.sender);
          }
        }
      }
    
      function presaleRacer(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmWs9f6tJVZXS4Wrrsx74WMvxEPR9bzf7sAwmMcW9pMkuT/hidden.json";
        }
