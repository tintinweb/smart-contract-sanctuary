...
contract Fragmented is NPassCore {
    ...
    bool public isDayOneSaleActive = true;
    bool public isDayTwoSaleActive = false;

    uint16 public constant DAY_ONE_END = 150;
    uint16 public constant DAY_TWO_END = 350;

    string public baseTokenURI = "ipfs://QmSX7zV2sjsAr72hwjVh4dZ42sW6JzTmLjv14L7EU9Gzh9/";
    ...
    /**
    To be updated day two quota is minted. This will deactivate the sale for day one and is done automatically
     */
