...
contract BLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: gold; font-family: STKaiti; font-size: 14px; }</style><rect width="100%" height="100%" fill="black" /><text x="10" y="20" class="base">';
    ...
    function claim() public nonReentrant {
        require(_globalTokenId < 20001, "Token ID invalid");
        uint256 times = _claimTimes[msg.sender];
        require (times < 5  , "Claim times invalid");
    ...
    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
        require(tokenId > 8000 && tokenId < _globalTokenId, "Token ID invalid");
        _safeMint(owner(), tokenId);
    }
