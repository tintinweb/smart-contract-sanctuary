...
contract Traits is Ownable, ITraits {
  ...
  constructor() {
    ...
    // // test
    // traitSvgs[1][0][0][0] = 0xe7D7DC79BCE64431cc3d7F19C1268971c382c5aF; // breed0 head0
    // traitSvgs[1][0][2][0] = 0xe7D7DC79BCE64431cc3d7F19C1268971c382c5aF; // breed0 color0
    // traitSvgs[3][0][4][0] = 0x882E667fb780cdf2816E3bF3FFCbE9B29ED02168; // class0 armor0
    // traitSvgs[3][0][5][0] = 0x882E667fb780cdf2816E3bF3FFCbE9B29ED02168; // class0 offhand0
    // traitSvgs[3][0][6][0] = 0x882E667fb780cdf2816E3bF3FFCbE9B29ED02168; // class0 mainhand0
  }
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    string memory metadata = string(abi.encodePacked(
      '{"name": "Dogewood #',
      tokenId.toString(),
      '", "description": "All the metadata and images are generated and stored 100% on-chain. No IPFS. NO API. Just the Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
