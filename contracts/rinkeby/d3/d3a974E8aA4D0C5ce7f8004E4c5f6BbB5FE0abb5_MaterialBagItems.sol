...
contract MaterialBagItems is ERC1155, MaterialMetadata {
    ...
    IERC721 materialBag = IERC721(0x636966D3dD160C3e2d551b9E648722F3C54940eb);
    ...
    constructor() ERC1155("") {
        ...
        // FOR TESTING
        //dragonskin belt
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 196608, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 1441793, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 851970, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 1835011, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 327684, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 196613, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 393222, 1, "");

        //ancient helm
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 262144, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 983041, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 196610, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 2031619, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 65540, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 720901, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 327686, 1, "");

        //divine gloves
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 196608, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 2097153, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 851970, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 1638403, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 131076, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 720901, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 131078, 1, "");

        //ornate gauntlets
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 393216, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 655361, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 131074, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 3, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 393220, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 131077, 1, "");
        _mint(0x9d6C5Ba61C6348878623E90ba0934fa8Cd58169C, 262150, 1, "");
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        ...
        parts[1] = materialTokenName(tokenId);
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    abi.encodePacked(
                        '{ "name": "', materialTokenName(tokenId),'", ', 
                        ...
                        '"attributes": ', materialAttributes(tokenId),
                        '}'
                    )
                )
            )
...
contract MaterialMetadata is MaterialComponents {
    ...
    function materialAttributes(uint256 id) public view returns (string memory) {
        (uint256[1] memory components, uint256 itemType) = MaterialTokenId.fromId(id);
        // should we also use components[0] which contains the item name?
        string memory slot = materialItemTypes[itemType];
        string memory res = string(abi.encodePacked('[', materialTrait("Slot", slot)));

        string memory item = materialItemName(itemType, components[0]);
        res = string(abi.encodePacked(res, ", ", materialTrait("Item", item)));
