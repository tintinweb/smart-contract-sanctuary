...
contract Stacking is Ownable {
    ...
    function removeStakeholder(address _stakeholder) internal {
     ...
     function userInfo(uint256 tokenId) internal{
        Stack[currentID].tokenId=tokenId;
        Stack[currentID].amount=uint8(1);
    ...
    function claim(uint256 id) public{
        ...
        stakedToken.transferFrom(address(this),msg.sender,Stack[id].tokenId);
    }
    constructor() {
        tokenPerSecond = 1000000000000;  //0.033
        stakedToken =IERC721(0x255EeBAce001DF24f4466d3755E1d1d85F9495F0);
        rewardToken = IBEP20(0x97fBDcE053E4C22D61581EA1B07832774a3dfA2c); 
    }
}