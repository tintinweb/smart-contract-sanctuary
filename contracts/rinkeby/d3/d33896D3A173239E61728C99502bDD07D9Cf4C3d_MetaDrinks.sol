...
contract MetaDrinks is ERC721Enumerable, ReentrancyGuard, Ownable {
    // immutable configuration
    uint256 private constant TOKEN_PRICE = 0.05 ether;
    uint256 private constant MAX_TOKENS_COUNT = 10000;
    address private constant leaderAddress = 0x0000000000000000000000000000000000000000;
    address private constant engineerAddress = 0x0000000000000000000000000000000000000000;
    address private constant bartenderAddress = 0x0000000000000000000000000000000000000000;
    ...
    constructor() ERC721("MD Test Desc 2", "mdtd2") {
    ...
    function tokenURI(uint256 _tokenId) override public view returns (string memory) {
        return MetaDrinksMetaDataGenerator.genJsonTokenURI('<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="red" /><circle cx="150" cy="100" r="80" fill="green" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="white">SVG</text></svg>');
    }
...
library MetaDrinksMetaDataGenerator {
    function genJsonTokenURI(string memory _drinkSvg) internal pure returns (string memory) {
        return string(abi.encodePacked("data:application/json;base64,", Base64.encode(bytes(string(abi.encodePacked(
                "{",
                '"name":"', string(abi.encodePacked("A", " ", "B", " ", "C")), '",',
                '"description": "The genesis collection of 10K Metadrinks with two generatives within each of them. A singular mantra in the title which sends you to a headspace and a unique random how-to. Ownership and commercial usage rights are given to you, the Metadrinker, over your [%]. Feel free to use it any way you want. [metadrinks.io](https://metadrinks.io/)",',
