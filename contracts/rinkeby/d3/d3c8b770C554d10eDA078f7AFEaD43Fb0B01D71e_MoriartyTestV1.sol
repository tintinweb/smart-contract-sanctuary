// SPDX-License-Identifier: MIT
    ...
    contract MoriartyTestV1 is ERC721, Ownable, ERC721Enumerable {
      ...
      event TestMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("MoriartyTestV1", "MTV") {}
      ...
      function mintTest(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit TestMinted(id, msg.sender);
          }
        }
      }
    
      function presaleTest(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmTRwfMCRNZtuDPw86SDmSwRsdsJp7df53edbQhW2V2izg/hidden.json";
        }
        ...
        return
          bytes(currentBaseURI).length > 0
            ...
            //ipfs://QmTRwfMCRNZtuDPw86SDmSwRsdsJp7df53edbQhW2V2izg/1.json
      }
