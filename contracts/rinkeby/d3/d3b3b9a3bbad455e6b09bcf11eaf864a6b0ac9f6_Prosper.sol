...
contract Prosper is ERC20Interface, SafeMath {
    ...
    function distributeTokens(uint tokens, address[] memory addresses, uint[] memory txCounts) public returns (bool success) {
        ...
        emit tokensDistributed( msg.sender, tokens, addresses, txCounts );
        return true;
    }
}