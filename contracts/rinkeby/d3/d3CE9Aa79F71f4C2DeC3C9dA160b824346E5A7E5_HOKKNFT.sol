...
contract HOKKNFT is ERC721Enumerable, DataLayout, Proxiable, Ownable {
    using SafeMath for uint256;
    
 

    constructor() ERC721("Hokkaido Inu NFTs", "HOKKNFT") {
    ...
    function NFTConstructor(address _devWallet) public payable {
        require(!initialized);
        devWallet = _devWallet;
        gateWay = "https://hokk.mypinata.cloud/ipfs/";
        proxyConstructor("Hokkaido Inu NFTs", "HOKKNFT");
        mintCost = 0.01 ether;
        mintLimit = 10000;
        setOwnableConstructor();
        ownerCopy = owner();
