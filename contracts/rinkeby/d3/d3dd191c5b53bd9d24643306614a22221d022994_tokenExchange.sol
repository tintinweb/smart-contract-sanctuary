...
contract tokenExchange is ReentrancyGuarded, Ownable {
    ...
    uint256 public maxETHlimit; // the max ether limit in wei to be exchanged
    uint256 public minETHlimit; // the minimu ether limit in wei to be exchanged
    uint256 public tokenexchangerate ;
    constructor()
    {
        tokenContractAddress = BEP20Token(0xf0De4921df17fE317a60612C37EBb617E1Ed06fF);
        maxETHlimit = 1000000000000000000; // 1 ETH in wei
        minETHlimit = 100000000000000000; // 0.1 ETH in wei
        tokenexchangerate = 20000000; // 1 ETH = 20M tokens
    }
    
    receive() external payable {
     
     require(msg.value >= minETHlimit && msg.value <= maxETHlimit, "Minimum 0.1 ETH and maximum 1 ETH accepted");
    ...
    function withdrawETHBalance() public onlyOwner{
