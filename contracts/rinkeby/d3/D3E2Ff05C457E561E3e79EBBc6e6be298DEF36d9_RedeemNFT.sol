    ...
    IRedeemNFT
{
    ...
    constructor(address initialSignerAddress)
        ERC1155("https://api.monkeybet.co/monkeybet/pitboss/{id}.json")
        AccessControl()
    {
        require(
    ...
    function _requireValidNonceAndUpdate(address signer, uint256 nonce) internal {
