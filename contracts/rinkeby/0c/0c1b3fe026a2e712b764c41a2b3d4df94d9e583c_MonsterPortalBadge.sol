...
contract MonsterPortalBadge is ERC721Enumerable, ERC721Pausable, Ownable {
    ...
    uint constant public MAX_BADGE = 2;
    uint public mintLimitPerUser = 1;
    bool public pauseDestroyPortal = true;
    ...
    constructor() ERC721("MonsterPortalBadge", "MPB") {}
    ...
    function updatePauseDestroyPortal(bool isDestroy) external onlyOwner() {
        pauseDestroyPortal = isDestroy;
    }
