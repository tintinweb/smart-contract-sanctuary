...
contract Packs is IPacks, ERC721, ReentrancyGuard {
  ...
  // function getToken(uint256 cID, uint256 index, address minter) public view returns(uint256) {
  //   LibPackStorage.Storage storage ds = LibPackStorage.packStorage();
  //   uint256 test = ds.collection[cID].mintPassContract.tokenOfOwnerByIndex(minter, index);
  //   return test;
  // }
