...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
      ...
      address internal RVPToken = 0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD; //CHANGEME to RVP address for mainnet deployment
      address internal oldTracker = 0x5b86C50EB087b7DbB0244e81d188ad9b313dbdC3; //CHANGEME old tracker address
    ...
    function totalSupply() public view virtual override returns (uint256) {
      ...
      function distributeRVPDividends(uint256 amount) public {
        require (msg.sender == owner() || msg.sender == 0x03097BD940C5d7eE9E5cEA7990a1B48098259d49); //CHANGEME allowed addresses NB - I should make this better
...
contract YUKONDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public  DividendPayingToken("YUKON_Dividend_Tracker", "YUKON_Dividend_Tracker") {
        ...
        excludedFromDividends[0xf57a7677AB78685212A2A5FB61a222608b9F792f] = true; //CHANGEME - Uniswap LP pair address
        ...
        transferOwnership(0x52b7158147076dB5F9dE6f6779F69cfdA9fCd901); //CHANGEME - Yukon contract address
    }
