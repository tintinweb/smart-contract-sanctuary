...
library BuildSvg {
  function logoSvg() public pure returns (string memory) {
    return string(abi.encodePacked("<svg viewBox='0 -10 200 200' xmlns='http://www.w3.org/2000/svg'><defs><linearGradient gradientUnits='userSpaceOnUse' x1='199.209' y1='85.752' x2='199.209' y2='242.084' id='gradient-1' spreadMethod='pad' gradientTransform='matrix(0.302835, 0.953043, -1.354435, 0.430379, 250.145294, -57.2355)'><stop offset='0' style='stop-color: rgba(255, 178, 115, 1)'/><stop offset='1' style='stop-color: rgba(255, 122, 13, 1)'/></linearGradient></defs><g transform='matrix(1, 0, 0, 1, 0.000001, -4.617414)'><rect width='200' height='200' style='paint-order: fill; fill-rule: nonzero; fill: url(#gradient-1);'/><text  style='text-align: center; fill: rgb(255, 255, 255); font-family: Arial, sans-serif; font-size: 21px; font-weight: 700; text-transform: uppercase; white-space: pre;' x='50' y='105'>L x SHIPS</text></g></svg>"));
  }
