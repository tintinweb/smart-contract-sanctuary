...
contract Cards is ERC721Tradable, ICards {
    ...
    string public constant CARDS_PROVENANCE = "df760c771ad006eace0d705383b74158967e78c6e980b35f670249b5822c42e1";  // FIXME: add correct hash here
    uint256 public constant SALE_START_TIMESTAMP = 1618108819;  // FIXME: adjust these parameters
    // Time after which cards are randomized and allotted
    uint256 public constant REVEAL_TIMESTAMP = SALE_START_TIMESTAMP + (86400 * 14); // timestamps in solidity are in seconds https://docs.soliditylang.org/en/latest/units-and-global-variables.html?highlight=block#block-and-transaction-properties
    uint256 public constant NAME_CHANGE_PRICE = 1830 * (10 ** 18);  // FIXME: adjust this if we want to
    uint256 public startingIndexBlock;
    uint256 public startingIndex;
    uint256 public constant MAX_NFT_SUPPLY = 100;  // FIXME: set this to 42000
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "https://parablenft.com/api/parables/"; // FIXME: adapt this
    }

    function contractURI() public pure returns (string memory) {
        return "https://parablenft.com/api/contractmeta/"; // FIXME: adapt this
    }
    ...
    function mintNftTo(address _to) public onlyOwner {
      ...
      // require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended"); // This is already in the factory
