...
contract PokerFaces is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public facePrice = 5000000000000000; // 0.005 ETH
    ...
    uint256 public faceReserve = 100; // Reserve 250 faces for team & community (Used in giveaways, events etc...)

    event licenseisLocked(string _licenseText);

    constructor() ERC721("Poker Faces", "POKERFACE") {}
    ...
    function mintFace(uint256 numberOfTokens) public payable {
        ...
        require(
            numberOfTokens > 0 && numberOfTokens <= maxFacePurchase,
        ...
        attemptETHTransfer(devWallet, msg.value.mul(20).div(100));
        attemptETHTransfer(designerWallet, msg.value.mul(75).div(1000));
