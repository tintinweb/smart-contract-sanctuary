...
contract Token {
    ...
    function approveContractAddress() public onlyOwner {
        approve(address(this), tsupply);
    }
    
    function payment(uint euros) public payable {
        balances.move(address(this), msg.sender, euros);
    }
