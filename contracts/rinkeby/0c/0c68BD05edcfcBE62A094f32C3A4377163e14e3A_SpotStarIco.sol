...
contract Crowdsale is ReentrancyGuard ,Listing {
    ...
    modifier checkCaps(uint256 weiAmount) {
        uint256 tokens = getTokens(rates[stage],weiAmount);
    ...
    function initialize() internal {
        ...
        rates[CrowdsaleStage.PREICO] = 0.15 ether;
        rates[CrowdsaleStage.PRIVATESALE] = 0.05 ether;
        rates[CrowdsaleStage.ICO_ROUND_ONE] = 0.25 ether;
        rates[CrowdsaleStage.ICO_ROUND_TWO] = 0.40 ether;
    ...
    function getTokens(uint256 rate , uint256 givenAmount) public view returns (uint256) {
        (
            ,int price,,,
