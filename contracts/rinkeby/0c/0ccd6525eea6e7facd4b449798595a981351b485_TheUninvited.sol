...
contract TheUninvited is ERC1155, Ownable, Pausable {
    ...
    string public constant name = "The Uninvited"; // gets overriden by contract metadata, but adding for redundancy
    string public constant symbol = "TU";
