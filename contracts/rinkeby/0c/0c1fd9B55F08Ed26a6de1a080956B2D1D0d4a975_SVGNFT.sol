...
contract SVGNFT is ERC721URIStorage, Ownable {
    ...
    // svgToImageURI has the information about the svg image, which is passed to imageURI to create tokenURI
    ...
    //formatTokenURI is actually compiling the complete metadata of our our svg, which is our tokenURI now
