    ...
    Ownable
{
    ...
    string[5] public baseTokenURI = [
        "https://gateway.pinata.cloud/ipfs/QmTsEN9wzpzd7sqb63jiAtDtwKTZRDqhuCNMZrhL3VUt7Y/0/",
        "https://gateway.pinata.cloud/ipfs/QmTsEN9wzpzd7sqb63jiAtDtwKTZRDqhuCNMZrhL3VUt7Y/1/",
        "https://gateway.pinata.cloud/ipfs/QmTsEN9wzpzd7sqb63jiAtDtwKTZRDqhuCNMZrhL3VUt7Y/2/",
        "https://gateway.pinata.cloud/ipfs/QmTsEN9wzpzd7sqb63jiAtDtwKTZRDqhuCNMZrhL3VUt7Y/3/",
        "https://gateway.pinata.cloud/ipfs/QmTsEN9wzpzd7sqb63jiAtDtwKTZRDqhuCNMZrhL3VUt7Y/4/"
        ];
        
    uint256 public NFT_small_price = 0.059 ether; 
    uint256 public NFT_big_price = 0.129 ether; 
    // uint256 public NFT_big_price = 1 ether;
    ...
    */
    modifier onlyOniOwner(uint256[] calldata providedTokens) {
        ...
        require(matchedTokenCount == providedTokens.length, 'Only the owner of all tokens can use this function.');
        _;
    }
   ...
   function setSurpriseMint(bool result) external onlyOwner {
    ...
    function surpriseClaim() external {
        require(is_surprise == true, "There is no more Free NFT.");
