...
// TODO dutch auction price function 
// TODO public sale
// TODO whitelist
// TODO private sale
// TODO public sale 2
...
contract NFT is ERC721, PaymentSplitter {
  ...
  address[] private _distributions = [
    ...
    0x1132Bc00E7A4A1e9013C6c4a585dE7caf5685FAB // TODO change to community multisig
  ];
  ...
  uint public constant whitelistSpots = 3000;
  uint public constant price = 0.1 ether;
  uint public constant reservedAmount = 100; // TODO decide on final value
  ...
  mapping(address => uint) public mintsByAddress;
  ...
  function addToWhitelistUINT(address[] memory addresses) external onlyTeam {
  ...
  function mintSale(uint amount) external payable onlyEOA {
    ...
    require(mintsByAddress[msg.sender] + amount <= maxMintsPerAddress, "Address already minted");
  ...
  function mintWhitelist(uint amount) external payable onlyEOA {
    require(whitelistSaleOpen , "Sale not open yet");
    require(totalSupply() + amount <= maxSupply - (reservedAmount - reservedMintedAlready), "Max Supply reached");
  ...
  function switchWhitelistSaleState() external onlyTeam {
    whitelistSaleOpen = !whitelistSaleOpen;
  }
