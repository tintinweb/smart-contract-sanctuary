...
contract HivePunks is ERC721Enumerable, Ownable {
    ...
    function prepareBlueprint(
        ...
        setBlueprintPrepared(_blueprintID);
    }

    function beginSale(uint256 blueprintID) external {
        require(
    ...
    function _setupBlueprint(
        ...
        blueprints[_blueprintID].baseTokenUri = _blueprintMetaData;
    ...
    mapping(uint16 => bool) private claimedPunks; // TODO remove
    ...
    function mintPunk() public payable {
        ...
        require(!claimedPunks[punkIndex], "YOU MESSED UP YOUR LINKED LIST BRO");

        punks[index] = parseAssets(cryptoPunksData.punkAttributes(punkIndex));
        ogPunks[index] = punkIndex;
        claimedPunks[punkIndex] = true;
