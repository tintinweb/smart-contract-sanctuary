    ...
    ERC721Burnable
{
    ...
    function salewithToken(
        ...
        movetokenwithSale(tokenAss, from, owner(), amount, tokenId);
    ...
    function movetokenwithSale(
        ...
        uint256 tokenId
          ...
          if (tokenAss == WethAddress) {
            val = pBEPent(amount, serviceValue).add(amount);
        }
    ...
    function acceptBId(
        ...
        _acceptBId(tokenAss, bidaddr, owner(), amount, tokenId);
    ...
    function _acceptBId(
        ...
        require(
            ...
            "Approve value insufficent in Admin Fee"
        );
