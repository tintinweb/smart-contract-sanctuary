...
contract Stakes is IERC721Receiver, Ownable {
    using EnumerableSet for EnumerableSet.UintSet;

    address public DustAddr;
    ...
    constructor(
        ...
        rewardRate = [10 ,22 ,33, 55, 0]; //Common, Rare, Ultra rare, 1/1, Spare
    }
    ...
    function claimRewards(uint256[] calldata tokenIds) public {
        ...
        if (reward > 0) {
            IDust(DustAddr).whitelist_mint(msg.sender, reward);
        }
    }
