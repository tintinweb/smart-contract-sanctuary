...
contract SassySucculent is ERC721, Ownable {
    ...
    uint256 public constant MAX_TOKENS = 4500;

    uint256 private TOKENS_MINTED = 0;
    
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 20;

    uint256 private price = 15000000000000000; // 0.015 Ether
    ...
    function succulentPrice() public view returns(uint256) {
        return price;
    }
