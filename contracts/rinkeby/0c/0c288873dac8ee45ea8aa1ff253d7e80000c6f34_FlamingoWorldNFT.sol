...
contract FlamingoWorldNFT is  Ownable, ERC721B {
    ...
    function getMintPrice() public view returns (uint256 price) {
        if (_owners.length <= 1000) {
        return 0.03 ether;
        } else if (_owners.length > 1000 && _owners.length <= 3000) {
        return 0.04 ether;
        } else if (_owners.length > 3000 && _owners.length <= 5000) {
        return 0.05 ether;
        } else if (_owners.length > 5000 && _owners.length <= 7000) {
        return 0.06 ether;
        } else if (_owners.length > 7000 && _owners.length <= 9000) {
        return 0.07 ether;
        } else if (_owners.length > 9000 && _owners.length <= 10000) {
        return 0.08 ether;
        }
    }
