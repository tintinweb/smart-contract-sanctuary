...
contract TESTFISH is ERC721Enumerable, Ownable {
    ...
    uint public constant FISH_WALLET_PRESALE_LIMIT = 200; //FISHperwalletInWholeDuration
    uint public constant FISH_WALLET_PUBLICSALE_LIMIT = 200; //FISHperwalletInWholeDuration
