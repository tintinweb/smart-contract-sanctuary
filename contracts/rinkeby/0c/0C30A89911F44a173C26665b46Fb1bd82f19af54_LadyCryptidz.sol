...
contract LadyCryptidz is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address private coder_wallet = 0x1F0b53dB1fA67F5b2891400D4108Bc01dEfBdAC6;
	address private shamdoo_wallet = 0x850C431af3c1aE7a322e945C6629DbD63CDb4577;
    address private kaveh_wallet = 0xC5aDdeF7CcF69Ef65e65870CF00eC47B25374694;
    ...
    function withdraw() public payable onlyOwner {
        ...
        uint256 _coder = (address(this).balance * 0) / 100;

        // Calculated from the rest of the balance
		uint256 _team = address(this).balance - _coder;
        
        // 97% distributed to the Owner
    uint256 _sh= _team.mul(30).div(100);
    uint256 _kv= _team.mul(70).div(100);
 



		payable(coder_wallet).transfer(_coder);
        payable(shamdoo_wallet).transfer(_sh);
        payable(kaveh_wallet).transfer(_kv);
