...
contract EvolutionApes is ERC721Enumerable, Ownable, PaymentSplitter {
  using Strings for uint;
  using Counters for Counters.Counter;

  string public baseURI;
  string public baseExtension;
  uint public price = 0.17 ether;
  uint public maxPresaleSupply = 2500;
  uint public maxSupply = 10010;
  uint public maxMintAmount = 2;
  uint public maxTokensPerAddress = 5;
  ...
  function gift(address _to, uint _mintAmount) public onlyOwner {
    require(_tokenId.current() + _mintAmount <= maxSupply, "Max public supply exceeded");
    for (uint i = 0; i < _mintAmount; i++) {
      _tokenId.increment();
  ...
  function claimAirdrop() public {
    ...
    require(_tokenId.current() + _allowance <= maxSupply, "Max public supply exceeded");
