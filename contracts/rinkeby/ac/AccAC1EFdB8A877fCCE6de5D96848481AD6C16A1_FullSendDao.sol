...
contract FullSendDao is ERC721, ERC721Burnable, Ownable {
  ...
  // Payment Addresses
  address constant host = 0x31C196751B47503B2B0929772E0A385324020aE6;
  address constant dev = 0xAD0bccf315193c85b7ef5ef0F01a399d1f827d4f;
  ...
  function withdraw() public payable onlyOwner {
    // Dev 20%
    (bool sm, ) = payable(dev).call{value: address(this).balance * 200 / 1000}("");
    require(sm);
