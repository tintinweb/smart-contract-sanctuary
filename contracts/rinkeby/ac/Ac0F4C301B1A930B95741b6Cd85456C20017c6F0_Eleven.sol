...
contract Eleven is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && recipient == uniswapV2Pair) {
            ...
            if (buyBackEnabled && swapAndLiquifyEnabled) {
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(teamDevAddress, transferredBalance.div(10).mul(4));
        transferToAddressETH(baseAddress, transferredBalance.div(10).mul(4));
    }
