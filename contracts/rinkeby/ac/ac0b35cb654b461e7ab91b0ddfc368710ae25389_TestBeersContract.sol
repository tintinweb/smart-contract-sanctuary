  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x3A27d74ce0f79c9d3568d1aE2fC845D7CD9C4e74);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 999');
    ...
    // File: contracts/testBeersContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract TestBeersContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Test Beers", "TEST", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmRBeWJW1tHQJ71B18sRkquBLWXjRk6d352BJb5Ub2tWS6/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/vwMosq3zaKcahSQEbUSo/contract-metadata";
        }
    }