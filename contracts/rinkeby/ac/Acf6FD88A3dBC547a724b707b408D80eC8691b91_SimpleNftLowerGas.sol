...
// File: contracts/golf_metaclub_contract.sol
...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("Golf MetaClub", "GMC") {
    setHiddenMetadataUri("ipfs://QmNndbfWb3izjzXMpRFqYZaQKWWmHj5MRwaWK5VKtFeCLe/1.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require(!paused, "The contract is not availible yet");
