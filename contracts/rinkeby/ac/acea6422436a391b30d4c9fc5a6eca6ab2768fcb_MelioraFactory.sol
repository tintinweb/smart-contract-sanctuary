...
contract MelioraLaunchpad {
    ...
    constructor(address _melioraFactoryAddress, address _melioraDevAddress)
        public
    {
        require(_melioraFactoryAddress != address(0), "address0 compare error");
        require(_melioraDevAddress != address(0), "address0 compare error1");
    ...
    function setGeneralInfo(
        ...
        require(_hardCapInWei <= _totalTokens.mul(_tokenPriceInWei), "hardCapInwei is over");
        require(_softCapInWei <= _hardCapInWei, "softCapInwei is over hard");
...
contract MelioraFactory {
    ...
    uint256 public debugA = 0;
    uint256 public debugB = 0;
    uint256 public debugC = 0;
