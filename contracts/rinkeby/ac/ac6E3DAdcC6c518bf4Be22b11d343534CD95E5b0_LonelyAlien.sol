...
contract LonelyAlien is ERC721, PaymentSplitter, Ownable, Pausable {
  ...
  uint256 public constant MAXNFT = 5;

  mapping(uint256 => uint256) private _totalSupply;
  Counters.Counter private _tokenIdCounter;

  address[] private _team = [
    0xb4E779d38fdE1301f8F2Ff93cd1f319E6b13c37f // 100
  ];
  ...
  constructor()
    ...
    ERC721('Rinked', unicode'Emotional👻')
  {
    _api_entry = 'https://extincttoads.com/output/';
