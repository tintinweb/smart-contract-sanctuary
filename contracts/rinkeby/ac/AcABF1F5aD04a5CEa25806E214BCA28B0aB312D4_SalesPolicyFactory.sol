...
contract SalesPolicy is ERC1155, ISalesPolicy, ReentrancyGuard {
    ...
    modifier onlyMC() {
        require(msg.sender == masterChef, "UnoRe: Not masterChef");
        _;
    }
    ...
    function buyPolicy(
        ...
        (string memory protocolName, , ) = IMasterChef(masterChef).getProtocolData(protocolIdx);
    ...
    function setPremiumPool(address _premiumPool) external override onlyMC {
        require(_premiumPool != address(0), "UnoRe: zero address");
        premiumPool = _premiumPool;
    }

    function setExchangeTokens(address _exchangeTokens) external override onlyMC {
