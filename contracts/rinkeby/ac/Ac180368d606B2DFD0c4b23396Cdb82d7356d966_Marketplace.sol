...
contract Marketplace is Nft, Auction {
    ...
    event Minted (
        uint256 indexed id,     // token id
        address indexed owner,  // owner wallet address
        string nft              // ipfs hash
    );
    ...
    event Listed (
        ...
        address indexed owner,  // owner wallet address
        string nft,             // ipfs hash
        uint256 price           // nft price in eth
    );
...
//    function getNft(uint256 _id) public view returns (MintedItem memory) {
//        MintedItem memory item = idToMintedItem[_id];
//        return item;
//    }
}
