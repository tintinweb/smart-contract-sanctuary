...
contract Main is VRFConsumerBase, Ownable {
    ...
    address payable public winner = payable(owner());
    ...
    function pickWinner() external ifClosed onlyOwner {
        ...
        override
    {
        ...
        winnerIndex = randomness % 10;
    }

    function claimReward() external ifCompleted onlyOwner {
        // uint256 winnerPrize = prizePool * (winnerPercentage / 100);
        transferPrize(prizePool);
        lotteryStatus = Status.NOT_STARTED;
    }
