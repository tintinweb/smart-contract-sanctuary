...
contract Bobos is ERC721, Ownable {
    ...
    bool public Presale2IsActive = false;
    ...
    function mintPresale2(uint256 mintCount) external payable {
        require(Presale2IsActive, "Bobo Presale not active");
        require(msg.value >= _presaleprice * mintCount, "Amount of Ether sent too small");
    ...
    function setRoot(bytes32 merkleroot) external onlyOwner {
     ...
     function togglePresale() public onlyOwner {
       ...
       function togglePresale2() public onlyOwner {
        Presale2IsActive = !PresaleIsActive;
    }
