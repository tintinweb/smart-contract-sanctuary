...
import "./Random.sol";
import "./AllowableSale.sol";

contract PowerUpMembershipPass1155 is ERC1155, Random, AllowableSale {   
    ...
    string public name = "PowerUp Pass";
    string public description = "This is a test description.";
    ...
    function claim() public activeSale allowablePresale {   
...
contract AllowableSale is Ownable {
    ...
    modifier allowablePresale() {
        if (isPresale) {
            require(_allowList[msg.sender] == true, "Presale: not in allow list."); 
        }
        _;
    }
