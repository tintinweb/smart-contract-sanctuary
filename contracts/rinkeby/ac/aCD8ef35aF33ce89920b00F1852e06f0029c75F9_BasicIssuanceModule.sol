...
library Invoke {
    ...
    /**
     * Instructs the CKToken to unwrap the passed quantity of WHT
     *
     * @param _ckToken        CKToken instance to invoke
     * @param _wht             WHT address
     * @param _quantity        The quantity to unwrap
     */
    function invokeUnwrapWHT(ICKToken _ckToken, address _wht, uint256 _quantity) internal {
        bytes memory callData = abi.encodeWithSignature("withdraw(uint256)", _quantity);
        _ckToken.invoke(_wht, 0, callData);
    }

    /**
     * Instructs the CKToken to wrap the passed quantity of HT
     *
     * @param _ckToken        CKToken instance to invoke
     * @param _wht            WHT address
     * @param _quantity        The quantity to unwrap
     */
    function invokeWrapWHT(ICKToken _ckToken, address _wht, uint256 _quantity) internal {
        bytes memory callData = abi.encodeWithSignature("deposit()");
        _ckToken.invoke(_wht, _quantity, callData);
    }
}
...
// Root file: contracts/protocol/modules/BasicIssuanceModule.sol
