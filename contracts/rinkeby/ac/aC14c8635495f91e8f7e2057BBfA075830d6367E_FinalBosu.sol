...
contract FinalBosu is ERC721Enumerable, Ownable {
    ...
    uint256 public WHITELIST_MAX_MINT = 5;

    /**
     * 0: Sale is not active
     * 1: Private sale
     * 2 or higher: Public sale
     */
    ...
    /**
     * Mint certain amount tokens defined in quantity
     */
    function mint(uint quantity) external payable {
        require(saleStatus > 0, "FinalBosu: sale is not active");
        ...
        if (saleStatus == 1) {
            // If private sale, sender should be whitelisted already
