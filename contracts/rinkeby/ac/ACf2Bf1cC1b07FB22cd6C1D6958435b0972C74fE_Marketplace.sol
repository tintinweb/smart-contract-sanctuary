...
contract Marketplace is Pausable, Ownable, ReentrancyGuard {
    ...
    // Offer
    function makeOffer(uint256 tokenId, uint256 price, uint256 endTime) external whenNotPaused nonReentrant {
    ...
    function acceptOffer(uint256 offerId, uint256 tokenId) external whenNotPaused nonReentrant isTokenOwner(tokenId) {
        ...
        emit OfferAccepted(offer.id, _msgSender(), offer.offerer, tokenId, price);
