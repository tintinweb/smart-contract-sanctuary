...
contract MetaPassNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    string public baseTokenURI =
        "ipfs://QmRxZ9R3esCjUFrz98VBRUKSurAGb6MASpxToQ2sdgESEH/";
    address public genesisAddress;
    GenesisContractAbi private genesisContract;
    uint256 public tokenCount = 0;
...
contract GenesisNFT is Ownable, ERC721, IERC2981, ReentrancyGuard {
    ...
    string public baseTokenURI =
        "ipfs://QmdedFUx72ft9aErWDfVAx77NpJEtLDpHXQTg6qmGiDtTj/";
    uint256 public tokenCount = 0;
    ...
    modifier onlyIfAvailable(
        ...
        expectedValue += MERCH_PASS_PRICE * _merchAmount;
        expectedValue += META_PASS_PRICE * _metaAmount;
        expectedValue += UTILITY_PASS_PRICE * _utilityAmount;
