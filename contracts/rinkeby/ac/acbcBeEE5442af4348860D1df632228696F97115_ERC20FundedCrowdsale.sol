...
contract ERC20FundedCrowdsale is Crowdsale, AllowanceCrowdsale, WhitelistCrowdsale {
    ...
    function _fundingAmount(uint256 fundingTokenAmount) internal returns (uint256) {
        ...
        emit SetFundingAmount(_msgSender(), fundingTokenAmount*1000000000000);
        return fundingTokenAmount*1000000000000;
    }
...
// 5,000.000,000
    ...
    */
     ...
     */
    function _getTokenAmount(uint256 fundingAmount) internal returns (uint256) {
        emit SetTokenAmount(_msgSender(), fundingAmount.mul(100).div(_rate));
        return fundingAmount.mul(100).div(_rate);
    }
