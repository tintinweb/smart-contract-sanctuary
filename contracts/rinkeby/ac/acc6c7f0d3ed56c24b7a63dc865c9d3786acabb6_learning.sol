...
contract learning is ERC721Enumerable, Ownable{
    ...
    uint public constant MAX_NFT_PURCHASE = 2;
    ...
    constructor() ERC721("learning","learning"){
    ...
    function airdrop(address to, uint256 amount) public onlyOwner{
        ...
        require(supply + amount <= MAX_SUPPLY, "Will Exceed Max Supply.");
    ...
    function reserveTokens(uint256 num) public onlyOwner {
        uint supply = totalSupply();
        require(supply + num <= MAX_SUPPLY, "Will Exceed Max Supply.");
        uint i;
        for (i = 0; i < num; i++) {
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        uint256 price = getPrice(numberOfTokens);
