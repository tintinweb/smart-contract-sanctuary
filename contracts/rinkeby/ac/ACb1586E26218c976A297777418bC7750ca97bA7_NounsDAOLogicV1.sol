...
contract NounsDAOLogicV1 is NounsDAOStorageV1, NounsDAOEvents {
    ...
    uint256 public constant MAX_PROPOSAL_THRESHOLD_BPS = 2_000; // 2,000 basis points or 20%

    /// @notice The minimum setable voting period
    uint256 public constant MIN_VOTING_PERIOD = 5_760; // About 4 hours

    /// @notice The max setable voting period
    uint256 public constant MAX_VOTING_PERIOD = 483_840; // About 2 weeks

    /// @notice The min setable voting delay
    uint256 public constant MIN_VOTING_DELAY = 1;

    /// @notice The max setable voting delay
    uint256 public constant MAX_VOTING_DELAY = 241_920; // About 1 week
