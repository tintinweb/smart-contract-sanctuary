...
contract CheechAndChongToken is ERC721A, AccessControlEnumerable, Pausable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant RESERVED_MINTER_ROLE = keccak256("RESERVED_MINTER_ROLE");
    uint16 public MAX_SUPPLY = 10_420;

    uint16 _remainingReserved = 100;

    string _baseURIValue;

    constructor(string memory baseURI_) ERC721A("Homies In Dreamland", "HOMIES", 20) {
