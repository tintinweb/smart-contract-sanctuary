...
/// @notice URN tokens have no utility or value, who knows what the future holds.
/// URN tokens are minted when you commit failed NFT project tokens to the Graveyard (more if you own a CRYPT).
contract Urn is ERC20("URN", "URN"), ReentrancyGuard, Ownable(5) {
    /// Track controller contracts and their permissions
    mapping(address => bool[2]) private _controllers;

    /// Authorises known addresses to mint or burn URN tokens.
    ...
    function addController(address contractAddress, bool canMint, bool canBurn) public onlyOwner {
