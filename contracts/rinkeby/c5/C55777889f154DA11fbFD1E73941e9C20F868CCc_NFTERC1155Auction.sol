...
contract NFTERC1155Auction is ERC1155Holder, Ownable{
    ...
    function _isAuctionOngoing(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (bool)
    {
        uint256 auctionEndTimestamp = nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].auctionEnd;
    ...
    function _isABidMade(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (bool)
    {
        return (nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftHighestBid > 0);
    }
    ...
    function _isMinimumBidMade(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (bool)
    {
        uint256 minPrice = nftContractAuctions[_nftContractAddress][_tokenId][msg.sender]
            .minPrice;
        return
            minPrice > 0 &&
            (nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftHighestBid >=
                minPrice);
    }
    ...
    function _isBuyNowPriceMet(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (bool)
    {
        uint256 buyNowPrice = nftContractAuctions[_nftContractAddress][_tokenId][msg.sender]
            .buyNowPrice;
        return
            buyNowPrice > 0 &&
            nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftHighestBid >=
    ...
    function _isASale(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (bool)
    {
        return (nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].buyNowPrice >
            0 &&
    ...
    function _isWhitelistedSale(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (bool)
    {
        return (nftContractAuctions[_nftContractAddress][_tokenId][msg.sender]
    ...
    function _isHighestBidderWhitelisted(
        ...
        return (nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftHighestBidder ==  
                nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].whitelistedBuyer);
    }
    ...
    function _getBidIncreasePercentage(
        ...
        uint256 bidIncreasePercentage = nftContractAuctions[ _nftContractAddress][_tokenId][msg.sender].bidIncreasePercentage;
    ...
    function _getAuctionBidPeriod(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (uint256)
    {
        uint256 auctionBidPeriod = nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].auctionBidPeriod;
    ...
    function _getNftRecipient(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (address)
    {
        address nftRecipient = nftContractAuctions[_nftContractAddress][ _tokenId][msg.sender].nftRecipient;
        ...
        internal
    {
        ...
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].auctionEnd =
    ...
    function ownerOfNFT(address _nftContractAddress, uint256 _tokenId)
        ...
        returns (address)
    {
        address nftSeller = nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftSeller;
        if (nftSeller != address(0)) {
            return nftSeller;
        }
        address ownerAddr = nftOwner[_nftContractAddress][_tokenId][msg.sender];
