...
contract SupplyChain {
  ...
  modifier checkValue(uint _upc) {
    SupplyChain.Item memory supplyChainItem = items[_upc];
    uint _price = supplyChainItem.productPrice;
  ...
  function harvestItem(uint _upc, address payable _originFarmerID, string memory _originFarmName, string memory _originFarmInformation, string memory _originFarmLatitude, string memory _originFarmLongitude, string  memory _productNotes) public 
  {
    ...
    address ownerID = _originFarmerID;
  ...
  function processItem(uint _upc) public isHarvested(_upc) verifyCaller(items[_upc].originFarmerID)
  {
  ...
  // Call modifier to check if upc has passed previous supply chain stage
  // Call modifier to verify caller of this function
  function packItem(uint _upc) public isProcessed(_upc) verifyCaller(items[_upc].originFarmerID)
  {
    // Update the appropriate fields
  ...
  // Call modifier to check if upc has passed previous supply chain stage
  // Call modifier to verify caller of this function
  function sellItem(uint _upc, uint _price) public isPacked(_upc) verifyCaller(items[_upc].originFarmerID)
  {
    // Update the appropriate fields
  ...
  function buyItem(uint _upc) public payable isForSale(_upc) paidEnough(items[_upc].productPrice) checkValue(_upc)
  {
  ...
  // Call modifier to check if upc has passed previous supply chain stage
  // Call modifier to verify caller of this function
  function shipItem(uint _upc) public isSold(_upc) verifyCaller(items[_upc].originFarmerID)
  {
    // Update the appropriate fields
  ...
  // Call modifier to check if upc has passed previous supply chain stage  
  // Access Control List enforced by calling Smart Contract / DApp
  function purchaseItem(uint _upc) public isReceived(_upc)
  {
