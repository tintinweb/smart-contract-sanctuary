...
contract TerminusCollisionTest {

    address owner;
    bool addressesFinalized;
    mapping (address => uint256) private amountClaimableByAddress;
    address public reserveAddress = 0x63a9dbCe75413036B2B778E670aaBd4493aAF9F3; //terminus address 0xc53f5c08237F679b5411B0028c0c8FA4C91c54Ca
    
    using Roles for Roles.Role;
        
    Roles.Role private _approvedCaller;

    AvastarsNFT private avastarsNFT = AvastarsNFT(0x30E011460AB086a0daA117DF3c87Ec0c283A986E);  //mainnet avastars 0xF3E778F839934fC819cFA1040AabaCeCBA01e049
    ...
    function pushAddresses(address[] memory attendee) public isOwner {
        ...
        for(uint256 i = 0; i < attendee.length; i++){
            amountClaimableByAddress[attendee[i]] = 5;
        }
    ...
    function claimAvastar() public {
        ...
        require(amountClaimableByAddress[msg.sender] > 0);
        
        amountClaimableByAddress[msg.sender] = amountClaimableByAddress[msg.sender] - 1;
    ...
    function claimAvastarStatic() public {
        require(addressesFinalized == true);
        require(amountClaimableByAddress[msg.sender] > 0);
        
        amountClaimableByAddress[msg.sender] = amountClaimableByAddress[msg.sender] - 1;

        uint256 randomAvastarIndex = 10;
