...
contract CrazyRaccoonFam is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public TOTAL_SUPPLY = 10000;

    uint256 public raccoonPrice = 20000000000000000;
    ...
    function reserveRacs() public onlyOwner {
    ...
    function mintDogsTo(address _to, uint numberOfTokens) public payable {
        ...
        require(_currentTokenId.add(numberOfTokens) <= TOTAL_SUPPLY, "Purchase would exceed max supply of Raccoons");
        require(getPrice().mul(numberOfTokens) <= msg.value, "Ether value sent is not correct");
