...
contract boom is Context, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    address payable internal devteam = payable(0xeac9472633FBDCDf0e47c4Ad6d6dE54d805d5358); 
    address payable internal seaneen = payable(0xeac9472633FBDCDf0e47c4Ad6d6dE54d805d5358);
    address payable internal markos = payable(0x3383b7110EDe73964CC4d903e024aAAd115d8afE);
    address payable internal leeroy = payable(0x6fD54C8B67Aa2B957faa6CE196910d9a6ee3553f);
