...
contract Galleries is Context, Ownable, ERC165, IERC721Enumerable, IERC721Metadata {
    ...
    // TODO: Update to my GalleriesSHA256
    string public galleriesProvenance;

    // Time after which Galleries are randomized and allotted
    // TODO: Update to final reveal date
    uint256 public revealTimestamp = 1625320800; // 3 July
    ...
    */
    ...
    function getNFTPriceInNCT() public view returns (uint256) {
        ...
        return priceInETH * 200000; // 1 ETH = 200k NCT; 1 Gallery = 16k NCT
    }
    ...
    */
    function mintNFTWithNCT(uint256[] memory connectedNftIndices, string memory nftType) public {
        ...
        // uint allowance = IERC20(nctAddress).allowance(msg.sender, address(this));
        // uint balance = IERC20(nctAddress).balanceOf(msg.sender);
        // require(allowance >= getNFTPriceInNCT(timelockInDays).mul(numberOfNfts), "Allowance is not correct");
        // require(balance >= getNFTPriceInNCT(timelockInDays).mul(numberOfNfts), "NCT amount is below the price");
        ...
        // IERC20(nctAddress).transferFrom(msg.sender, address(this), price);
    }
    ...
    */
    function mintNFT(uint256[] memory connectedNftIndices, string memory nftType) internal {
        ...
        for (uint i = 0; i < numberOfNfts; i++) {
            ...
            // require(connectedNftIndices[i] < IMasksInterface(masksAddress).totalSupply(), "Mask at index has not been minted");
            // require(connectedNftIndices[i] < 16384, "Mask at index has not been minted");
    ...
    */
    function withdrawERC20(address tokenAddress) public onlyOwner {
        ...
        // IERC20(nctAddress).increaseAllowance(msg.sender, balance);
        // uint allowance = IERC20(nctAddress).allowance(msg.sender, address(this));
    }
