...
contract Luchademo is ERC721Enumerable, Ownable, ReentrancyGuard, VRFConsumerBase {
	...
	uint256 internal LinkFee = 0.1 * 10**18; // 2 LINK
	...
	function generateLuchador(uint256 _quantity, uint256 _deadline) external payable nonReentrant {
	...
	function metadata(uint256 _tokenId) public view returns (string memory) {
		...
		string[7] memory traitType = ["Spirit", "Cape", "Torso", "Arms", "Mask", "Mouth", "Bottoms"];
