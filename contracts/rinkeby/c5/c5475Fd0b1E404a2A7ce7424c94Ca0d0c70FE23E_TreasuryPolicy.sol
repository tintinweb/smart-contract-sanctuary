...
contract TreasuryPolicy is Ownable, Initializable, ITreasuryPolicy {
    ...
    /**
     * @dev Initializes Treasury address, redemption fee, minting fee and excess collateral safety margin. Can be called only by the owner.
     */
    function initialize(
        address _treasury,
    ...
    /**
     * @dev Sets redemption fee. Can be called only by the owner.
     * @param _redemption_fee New redemption fee value.
     *
     * Reverts if `_redemption_fee` exceeds maximum redemption fee value.
     */
    ...
    /**
     * @dev Sets minting fee. Can be called only by the owner.
     * @param _minting_fee New minting fee value.
     *
     * Reverts if `_minting_fee` exceeds maximum minting fee value.
     */
    ...
    /**
     * @dev Sets excess collateral safety margin. Can be called only by the owner.
     * * @param _excess_collateral_safety_margin New excess collateral safety margin value.
     *
     * Reverts if `_excess_collateral_safety_margin` is less than minimal excess collateral safety margin value.
     */
