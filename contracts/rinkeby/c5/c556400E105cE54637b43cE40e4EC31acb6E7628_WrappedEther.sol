...
// File: contracts/WrappedEther.sol

pragma solidity 0.7.6;



contract WrappedEther is ERC20Pausable, Operable {

    constructor() ERC20("WrappedEther", "ETH") Operable(msg.sender) {
    }

    function mint(address account, uint256 amount) public virtual onlyOperator {
        _mint(account, amount);
    }

    function burn(address account, uint256 amount) public virtual onlyOperator {
