...
contract ApprovingBone is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("ApprovingBone", "ACBONE")  {
        // setBaseURI for metadata
        setBaseURI('http://my-json-server.typicode.com/abcoathup/samplenft/tokens/');
    }
...
contract ApprovingCorgis is ERC721Enumerable, Ownable {
    ...
    uint256 public constant price = 0.05 ether;
    uint8 public constant maxPurchase = 10;
    uint256 public maxCorgis = 9999;
    uint256 public maxEarlyAccess = 2000;
    uint8 public constant maxEarlyAccessPurchase = 5;
    bool public saleIsActive = true;
    bool public earlyAccessIsActive = true;

    uint256 public donationToCharity = 20 ether;
    uint256 public sendToCommunityVault = 30 ether;

    address public communityVault = 0xfc86A64a8DE22CF25410F7601AcBd8d6630Da93D;
    address public charityFundWallet = 0x4265de963cdd60629d03FEE2cd3285e6d5ff6015;

    ApprovingBone public approvingBoneContract;

    constructor(string memory tokenBaseURI) ERC721("ApprovingCorgis", "CORGIS")  {
        // Approving Bone Contract
        approvingBoneContract = new ApprovingBone();
        // setBaseURI for metadata
    ...
    function earlyAccessMint(uint256 numberOfTokens) public payable {
        ...
        require(earlyAccessIsActive, "Sale is not active yet");
        require(tokenCount == 1, "You don't have a mint pass");
        require(numberOfTokens <= maxEarlyAccessPurchase, "You can adopt a maximum of 20 Corgis");
