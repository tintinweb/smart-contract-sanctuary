...
contract Obtainable721 is CoreERC721, ERC1155 {
  address proxyRegistryAddress;
  mapping (address => mapping(address => bool)) private _operatorApprovals;
  constructor(
    string memory _uri,
    address _proxyRegistryAddress
  ) CoreERC721(CollectionOptions({
    name: "@Obtainable NFT Collection",
    symbol: "Obtainable-NFT",
    feeBps: 1000,
...
contract ERC721 is Context, IERC721, ERC165, IERC721Metadata {
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        ...
        _operatorApprovals[_msgSender()][operator] = approved;
        emit ApprovalForAlls(_msgSender(), operator, approved);
    }
...
interface IERC721 is IERC165 {
     ...
     */
    event ApprovalForAlls(address indexed owner, address indexed operator, bool approved);
