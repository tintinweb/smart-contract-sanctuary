...
contract BlockchainOfFame is ERC721URIStorage, Ownable {
    ...
    uint256 public bofReserve = 50;
    uint256 private supply;
    
    address public creator1Address = 0x833AFf717925131df28c79E2C057514565ac6c78;
    address public creator2Address = 0xDa1e5202Ec5a0107acb1887131173b666b834Eb1;
    ...
    function whitelistedMints(string memory newName, bytes32[] calldata merkleProof ) payable external  {
    ...
    function reserveBOF(address _to, string memory newName) public onlyOwner {        
    ...
    function changeNameAfterMint(uint256 tokenId, string memory newName) public {
