  ...
  function _removeTokenFromAllTokensEnumeration(uint256 tokenId) private {
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x1F0b53dB1fA67F5b2891400D4108Bc01dEfBdAC6);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 150');
    ...
    // File: contracts/ladyCryptidzContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract LadyCryptidzContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Lady Cryptidz", "RAMPP", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://gateway.pinata.cloud/ipfs/QmRsZ9t3eR6tnK73YH5Pu9jEmQU5H2d5jiK36765VoGqzi/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://gateway.pinata.cloud/ipfs/QmR27BrX5MPewsknPcBpG6mn5yWqstX9R4SZj8Nkmt1W3h";
        }
    }