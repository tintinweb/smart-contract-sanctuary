...
contract SoviBazaarFactory is Manageable, IERC721Receiver {
    ...
    function upgrade(uint256 tokenId1, uint256 tokenId2) external {
        ...
        uint256 newCard = _upgradeMapping[nftType1][nftType2];
        if (newCard == 0) {
            newCard = _upgradeMapping[nftType2][nftType1];
        }
        require(newCard > 0, "Bazaar: can't upgrade");
        ...
        uint256 newCardId = _buFactory.mint(msg.sender, 0, category1, nftType1, 1);
