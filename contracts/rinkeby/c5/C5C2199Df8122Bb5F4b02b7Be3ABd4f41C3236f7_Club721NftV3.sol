...
contract Club721NftV3 is OwnableUpgradeable, ERC721EnumerableUpgradeable {
    ...
    address public store3;

    modifier onlyStoreOrOwner() {
        address sender = msg.sender;
        require(store1 == sender || store2 == sender || store3 == sender || owner() == sender, 'Club721NFT: caller is not store or owner');
        _;
    }
    ...
    function setStore3(address _store) external onlyOwner {
        store3 = _store;
    }
