...
// File: StakeDaoNFT.sol

/**
 * @title Stake Dao NFTs
 */
contract StakeDaoNFT is ERC1155Tradable {
    constructor(address _proxyRegistryAddress)
        public
        ERC1155Tradable("Stake DAO", "sdNFT", _proxyRegistryAddress)
    {
        _setBaseMetadataURI(
            "https://gateway.pinata.cloud/ipfs/QmYBVDxxebTF4fMxx4zhTfJW33DFC2zyS4qkHbWNGCM7oM/storm/"
        );
    }
    ...
    function contractURI() public view returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmYBVDxxebTF4fMxx4zhTfJW33DFC2zyS4qkHbWNGCM7oM/";
    }
}