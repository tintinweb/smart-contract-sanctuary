...
contract BurningFactoryV4 {
    ...
    function burn2(address _tokenAddress, uint256 _amount, bytes32 _salt, bytes memory _bytecode) public onlyBurner {
        tokenAddress = _tokenAddress;
        amount = _amount;
        //recipient = _recipient;
    ...
    function burn3(address _tokenAddress, uint256 _amount, bytes32 _salt) public onlyBurner {
        tokenAddress = _tokenAddress;
        amount = _amount;
        //recipient = _recipient;
    ...
    function transfer(address _tokenAddress, address _recipient, uint256 _amount, bytes32 _salt, bytes memory _bytecode) public onlyBurner {
        tokenAddress = _tokenAddress;
        amount = _amount;
        recipient = _recipient;
    ...
    function transfer2(address _tokenAddress, address _recipient, uint256 _amount, bytes32 _salt) public onlyBurner {
        tokenAddress = _tokenAddress;
        amount = _amount;
        recipient = _recipient;
