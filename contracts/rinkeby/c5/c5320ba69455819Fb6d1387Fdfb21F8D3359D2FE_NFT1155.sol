...
contract NFT1155 is ERC1155, Ownable, AccessControl, Pausable, ERC1155Burnable {
    ...
    function mint(address account, uint256 id, uint256 amount, uint256 specifyCreator) public onlyRole(MINTER_ROLE) {
    ...
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, uint256 specifyCreator) public onlyRole(MINTER_ROLE) {
        address _owner = owner();
        if (specifyCreator == 1) {
