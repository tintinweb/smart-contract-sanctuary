...
contract PH is ERC721Enumerable, Ownable {
    ...
    uint256 private currentSupply = 3;

    string private baseURI = "ipfs://QmaCHBYV7usukwZbnTvPazL9WcfMBCtfsm7Ko3CqwL7Rnf/";

    address private dev = 0xAE77beeda3c1BB43B1cAEaE04815F68e1c07e077;
    address private wallet1 = 0x666FDd2160D19dC763DE299dcb657DdEB222Bb36;
    ...
    function isAvailableToMint(uint256 _tokenId) public view returns (bool) {
        return isMintEnabled() && !isMintedAlready(_tokenId) && _tokenId >= 1 && _tokenId <= currentSupply;
    }
    ...
    function addTokens(string[] memory _uris) public onlyOwner {
        for (uint256 i = 0; i < _uris.length; i++) {
            customTokenToURI[currentSupply + i + 1] = _uris[i];
        }
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmVa2WuGWaF3Ji2tUQzxP25M7e7ttb1vxXu7SiGY6NP4jy";
    }
}
