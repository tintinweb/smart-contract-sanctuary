...
contract MadParrotCrew is ERC721Enumerable, Ownable {
    ...
    function setBaseURI(string memory _newBaseURI) public onlyOwner {
        require(!lockedURI, "cannot change URI post-reveal");
        baseURI = _newBaseURI;
    }
    ...
    // Function to lock the URI once all 10k parrots are revealed
    ...
    //allows for tokens to be released in stages, but caps the total possible supply to 10,000
