...
contract MetaElon is ERC20, Ownable, Shared {
   ...
   address public marketingWalletAddress = 0x69442077Ab70698Ca2B4fA569ec0A56f99ED60f6;
   address public devWalletAddress = 0x2ce3fd8436345cC95cfD3510d67E1249502f6cDe;
   address public buybackWallet = 0x84C02d62b4400670f9fC8C406599d08D43A1e7F2;
   ...
   constructor() ERC20("MetaElon", "$MetaElon") {
       ...
       */
       _mint(owner(), 1_000_000_000 * 10**18);
        maxTxAmount = totalSupply() / 50; // 2.0%
        maxWallet = totalSupply() / 50; // 2.0%
   }
   ...
   function updateUniswapV2Router(address newAddress) public onlyOwner {
       require(newAddress != address(uniswapV2Router), "MetaElon: The router already has that address");
   ...
   function setMarketingWallet(address payable wallet) external onlyOwner{
       require(marketingWalletAddress != address(0), "MetaElon: Can't set marketing wallet to the zero address");
       marketingWalletAddress = wallet;
   }
  
   function setDevWallet(address payable wallet) external onlyOwner{
       require(devWalletAddress != address(0), "MetaElon: Can't set developer wallet to the zero address");
       devWalletAddress = wallet;
   }
  
    function setbuybackWallet(address payable wallet) external onlyOwner{
       require(buybackWallet != address(0), "MetaElon: Can't set buyback wallet to the zero address");
       devWalletAddress = wallet;
   }
   ...
   function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
       require (maxTxPermille > 0, "MetaElon: Can't set max Tx to 0");
       maxTxAmount = maxTxPermille;
   }
   ...
   function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
       require(pair != uniswapV2Pair, "MetaElon: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
   ...
   function _setAutomatedMarketMakerPair(address pair, bool value) private {
       require(automatedMarketMakerPairs[pair] != value, "MetaElon: Automated market maker pair is already set to that value");
   ...
   function _transfer(
       ...
       require (tradingOpened || isExcludedFromFees[from], "MetaElon: Trading paused");
       require(from != address(0), "ERC20: transfer from the zero address");
       require(to != address(0), "ERC20: transfer to the zero address");
       require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "MetaElon: Blacklisted address");
