...
contract DeGuild is Context, Ownable, IDeGuild {
    ...
    function jobOf(address account) public view virtual
        override returns (uint256) {
        return _currentJob[account];
    }

    function expOf(address account) public view virtual
        override returns (uint256) {
        return _exp[account];
    }

    function forceCancel(uint256 id) public onlyOwner virtual
    ...
    function cancel(uint256 id) public virtual
        override returns (bool) {
        require(_exists(id), "ERC721: owner query for nonexistent token");
        Job memory job = _JobsCreated[id];
    ...
    function take(uint256 id) public virtual
        override returns (bool) {
        require(_exists(id), "ERC721: owner query for nonexistent token");
        Job memory job = _JobsCreated[id];
        require(
    ...
    function complete(uint256 id) public virtual
        override returns (bool) {
        require(_exists(id), "ERC721: owner query for nonexistent token");
        Job memory job = _JobsCreated[id];
    ...
    function report(uint256 id) public virtual
        override returns (bool) {
        require(_exists(id), "ERC721: owner query for nonexistent token");
        Job memory job = _JobsCreated[id];
    ...
    function judge(uint256 id, bool decision) public onlyOwner virtual
        override returns (bool) {
        require(_exists(id), "ERC721: owner query for nonexistent token");
        Job memory job = _JobsCreated[id];
