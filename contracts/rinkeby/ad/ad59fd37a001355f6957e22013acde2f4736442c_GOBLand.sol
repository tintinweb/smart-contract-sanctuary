...
contract GOBLand is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    bool public _redeemEnabled = true;
    ...
    constructor(uint256 ml, address landPassAddress) ERC721("GOBLand", "LAND") {
    ...
    function externalMint(uint256 amount) public onlyAuthorizedContracts {
    ...
    function setMaxLands(uint256 value) public onlyOwner {
        maxLands = value;
    }
    ...
    function forceMint(address account, uint256 amount)
        public
        onlyOwner
    {
        require(amount > 0, "Amount must be greater than 0");
