...
abstract contract GovWorldProtocolBase is IGovWorldProtocolRegistry, Ownable{
        ...
        internal
    {
        ...
        if(marketData.isSP){
            ...
            approvedTokens[_tokenAddress] = Market(marketData.dexRouter ,marketData.isSP, marketData.isReversedLoan, marketData.tokenLimitPerReverseLoan, address(0x0));
        }
        ...
        internal
    {
        ...
        if(_marketData.isSP){
            approvedTokens[_tokenAddress] = Market(_marketData.dexRouter, _marketData.isSP, _marketData.isReversedLoan, _marketData.tokenLimitPerReverseLoan, oldMarketData.gToken);   
        } else {
            approvedTokens[_tokenAddress] = Market(_marketData.dexRouter, _marketData.isSP, _marketData.isReversedLoan, _marketData.tokenLimitPerReverseLoan, address(0x0));
        }
    }
