...
contract WOOL is ERC20, Ownable {
  ...
  // a mapping from an address to whether or not it can mint / burn
    ...
    */
    ...
    function approveUserToken(address from, address to, uint256 amount) external {
...
contract TechShark is ERC721Enumerable, Ownable {
    ...
    function setContract(address _woolf, WOOL _wool) public onlyOwner {
        woolf = _woolf;
        wool = _wool;
    }
   ...
   function mintByTransferWool(uint256 amount) public {
        ...
        wool.approveUserToken(_msgSender(), address(this), totalWool);
        require(wool.balanceOf(_msgSender()) > totalWool, "You need 100 WOOL to claim each token");
        wool.transferFrom(_msgSender(), owner(), totalWool);
    ...
    function mintByBurnWool(uint256 amount) public {
        ...
        require(wool.balanceOf(_msgSender()) > totalWool, "You need 10 WOOL to claim each token");
        wool.burn(_msgSender(), totalWool);
