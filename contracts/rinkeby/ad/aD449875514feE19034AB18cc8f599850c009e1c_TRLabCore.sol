    ...
    UUPSUpgradeable
{
    ...
    /**
     * Creates a new artwork object. TODO: need review if must set royalty
     */
    ...
    function releaseArtworkForReceiver(
        ...
        _batchArtworkRelease(receiver, _artworkId, _numReleases);
    }
     ...
     * @param  _artworkOwner address the owner of the NFT token
    ...
    function _batchArtworkRelease(
        ...
        require(_count + currentPrintIndex <= _artwork.totalSupply, "Total supply exceeded.");
        ...
        for (uint32 i = 0; i < _count; i++) {
            ...
            emit ArtworkReleaseCreated(newArtworkReleaseId, _artworkOwner, _artworkId, newPrintEdition, _tokenURI);
            // This will assign ownership and also emit the Transfer event as per ERC721
            _safeMint(_artworkOwner, newArtworkReleaseId);
            _setTokenURI(newArtworkReleaseId, _tokenURI);
            _setRoyalty(newArtworkReleaseId, royalty);
        }
...
contract ERC2981Upgradeable is Initializable, IERC2981Upgradeable, ERC165Upgradeable {
    ...
    // token id -> royalty
    mapping(uint256 => Royalty) private royaltyMap;
