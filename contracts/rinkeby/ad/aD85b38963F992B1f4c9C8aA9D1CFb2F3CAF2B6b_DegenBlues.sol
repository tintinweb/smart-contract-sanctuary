...
contract DegenBlues is ERC721 {
    ...
    constructor(address dateTimeAddress, address priceFeedAddressETH, address priceFeedAddressBTC) ERC721("Degen Blues", "DGB") {
        dates = DateTimeAPI(dateTimeAddress);
    ...
    function getAllDataForGoldMaster() public view returns (DayData memory) {
        ...
        return DayData(0, new uint256[](0), ethDataString, btcDataString, '');
    ...
    function getAllDataForDay(uint256 fromTimestamp) public view returns (DayData memory) {
        ...
        string memory ethDataString = Encoding.encode(ethData);
        string memory btcDataString = Encoding.encode(btcData);
        string memory ethStats = metadata.getAttributes(ethData, fromTimestamp, false);

        return DayData(fromTimestamp, tokenIds, ethDataString, btcDataString, ethStats);
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        uint fromTimestamp = (tokenId == 0 ? perpetualDataStartTime() : fromTimestamps[tokenId]);
        ...
        uint256 bgHue;
        {
            ...
            attributesStr = metadata.getAttributes(ethPriceData, fromTimestamp, tokenId == 0);
        }
        ...
        return string(
            ...
            Base64.encode(
                ...
                abi.encodePacked(
                    ...
                    unicode', "name":"Degen Blues · ', displayDate,
                    '"',
                    ', "external_url":"',
                    'https://dataism.xyz/projects/degen-blues?',
                    // TODO: better way of doing a permalink
                    displayDate,
                    '"',
                    ', "image":"',
                    ...
                    'https://dataism.xyz/projects/degen-blues/r?',
                    tokenId == 0 ? "master=1&" : "",
    ...
    function contractURI() external pure returns (string memory) {
        ...
        return 'https://dataism.xyz/projects/degen-blues/contract.json';
    }
}
...
contract Metadata {
    ...
    function getAttributes(int32[] memory ethPriceData, uint fromTimestamp, bool isGoldMaster) external pure returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                '{',
                    ...
                    '"value": "', getDirectionString(open, close), '"',
                '},',
                '{',
