...
contract StarNotary is ERC721 {
    ...
    constructor() ERC721("Stargazer", "STAR") {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            msg.sender == sender1 || msg.sender == sender2, 
            "StarNotary: sender should be owner one of the stars sent for exchange"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            ...
            "StarNotary: sender should be owner of the star being transferred"
        );
