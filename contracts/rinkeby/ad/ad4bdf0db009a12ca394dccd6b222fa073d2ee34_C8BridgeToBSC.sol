...
contract C8BridgeToBSC is Ownable {
  ...
  function setFee(uint _feeAmount) public onlyOwner {
  ...
  function transitToBSC(address _to, uint _amount) public payable {
    ...
    require(msg.value >= feeAmount, "Transit: Insufficient for ETH Fee");
