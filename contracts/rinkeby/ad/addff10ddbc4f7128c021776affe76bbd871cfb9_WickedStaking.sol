...
contract WickedStaking is Ownable {
    ...
    TWS private tws = TWS(0x580D93Bb29862338BEEf80e369E910c7c21C16c0);
    WickedCraniumsComic private comic = WickedCraniumsComic(0xf8EdF832c8994Bece6993F9dC36f95F531Db41CB);
    WickedCraniumsXHaylos private haylos = WickedCraniumsXHaylos(0x2338230ff310F986d72237fBD81735dB8e63794B);
    ...
    function unstakeAll() public {
        ...
        for (uint256 i = 0; i < craniumsToUnstake.length; i++) {
    ...
    function unstakeSome(uint256 totalToUnstake) public {
        ...
        for (uint256 i = 0; i < totalToUnstake; i++) {
