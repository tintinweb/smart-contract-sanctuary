...
contract NFTAuction is Context, ReentrancyGuard {
    ...
    function placeBid(uint256 _tokenId) external payable nonReentrant whenNotPaused {
        ...
        NFTDetail memory _nft;
        (_nft.tokenId, _nft.creator, _nft.owner, _nft.price, _nft.tokenUri) = marketTradingNft.getNFTDetailByTokenId(_tokenId);
        emit BidPlaced(_nft.tokenId, _nft.creator, _nft.owner, _nft.price, _nft.tokenUri, "1 of 1", _msgSender(), bidAmount);
    }
    ...
    function resultAuction(uint256 _tokenId) external nonReentrant {
        ...
        NFTDetail memory _nft;
        (_nft.tokenId, _nft.creator, _nft.owner, _nft.price, _nft.tokenUri) = marketTradingNft.getNFTDetailByTokenId(_tokenId);
        emit AuctionResulted(_nft.tokenId, _nft.creator, _nft.owner, _nft.price, _nft.tokenUri, "1 of 1", winner, winningBid);
    }
    ...
    function _createAuction(
        ...
        NFTDetail memory _nft;
        (_nft.tokenId, _nft.creator, _nft.owner, _nft.price, _nft.tokenUri) = marketTradingNft.getNFTDetailByTokenId(_tokenId);
        emit AuctionCreated(_nft.tokenId, _nft.creator, _nft.owner, _nft.price, _nft.tokenUri, "1 of 1");
    }
