...
contract CryptoDads is ERC721Enumerable, Ownable {
    ...
    uint256 public constant RESERVED_DADS = 100;
    ...
    constructor() ERC721("CryptoDads", "DAD") {
        baseTokenURI = "ORIGINAL_BASE_URI/";
    }
    ...
    function claimReserved() external onlyOwner {
        ...
        uint256 _nextTokenId = numDadsMinted;
    ...
    function mintPresale(uint256 amountOfDads) external payable whenPresaleStarted {
        ...
        require(PRICE * amountOfDads <= msg.value, "ETH amount is not sufficient");
