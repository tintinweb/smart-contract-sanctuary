...
contract MultiSenderV6 is ServiceCharges { 
    ...
    modifier getServiceFee(string memory _paymentMethod, uint noOfRecipients, uint noOfIds, uint noOfAmounts) {
		...
		else if(noOfRecipients >= recipientsRange[2][0] && noOfRecipients <= recipientsRange[2][0]) multiplier = 2;
		else if(noOfRecipients >= recipientsRange[3][0] && noOfRecipients <= recipientsRange[3][0]) multiplier = 3;
		else if(noOfRecipients >= recipientsRange[4][0] && noOfRecipients <= recipientsRange[4][0]) multiplier = 4;
		else multiplier = 20;
