...
contract PropositionToken is ERC721Enumerable, Ownable {
    ...
    uint256 public constant batchMintPrice = 250000000000000000; //0.25 ETH
    ...
    string[10] public skyColors = [
        ...
        '#b31400', // dark red
        '#f56500', // orange
        '#006056', // dark aqua // REPLACE
        '#001e60', // dark blue
        '#bf00a0', // dark pink // REPLACE
        '#3d028a', // purple
        '#000000'  // black
    ];
    ...
    string[10] public heavenlyReflectionColors = [
        ...
        '#ffd700', // light gold
        '#f56500', // orange
        '#000033', // dark purple // REPLACE
        '#20d1cc', // med aqua
        '#20d186', // med green
        '#000000', // black
        '#ffffff',  // white
        '#696969', // dark gray // REPLACE
        '#6a0d01'  // dark red
    ];
    ...
    */
    function transformString(string memory str) public pure returns (string memory){
        ...
        // need to build out the bytes based on the correct length
        for (uint i = 0; i < bStr.length; i++) {
            ...
            if ((uint8(bStr[i]) >= 65) && (uint8(bStr[i]) <= 90)) {
                ...
                if (uint8(bStr[i]) == 20) {
                    ...
                    // else don't add char and leave history
                    // should remove all spaces to start string and duplicate spaces
                    // until a non-space is hit and resets history
                } else {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if (idToPropAssignment[tokenId] == false) {
            ...
            string memory jsonMeta = string(abi.encodePacked('{"name": "Proposition: ',tokenId,'", "description": "Beliefs are not private. Beliefs are not free.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '",'));
