...
contract DONETOKEN is Ownable, IERC20 {
    ...
    address private donefund1 = address(0x15E3F1953842D57a08F74cdE29E2E16C36378628);
    address private donefund2 = address(0xd910a391AA907CA116f250c27A421Ce6064275e6);
    ...
    string private _name = 'DONETOKEN';
    string private _symbol = 'DONETOKEN';
    ...
    function donateFunds() public {    
        if (owner() == address(0) || donefund1 == address(0) || donefund2 == address(0)) {
            return;
        }
        ...
        payable(donefund1).transfer(fund1Share);
        payable(donefund2).transfer(fund2Share);
    }
}