...
contract KumoXWorld is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("DudiWorld", "DDW") {}

    uint256 public PRICE = 0.00001 ether;
    uint256 public constant KUMO_GIFT_SUPPLY = 3;
    uint256 public constant EXPEDITION_RESERVED = 2;
    uint256 public constant KUMO_PUBLIC_SUPPLY = 10;
    uint256 public constant MAX_SUPPLY =
        KUMO_PUBLIC_SUPPLY + KUMO_GIFT_SUPPLY + EXPEDITION_RESERVED;

    uint256 public constant TRANSACTION_LIMIT = 2;
    uint256 public constant ADDRESS_PURCHASE_LIMIT = 2;
