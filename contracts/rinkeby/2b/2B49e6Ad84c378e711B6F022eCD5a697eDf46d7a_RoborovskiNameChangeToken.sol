...
import "./INftShort.sol";

contract RoborovskiNameChangeToken is ERC20, Ownable {
    uint256 public constant INITIAL_ALLOTMENT = 1830 ether;
    uint256 public constant PRE_REVEAL_MULTIPLIER = 2;
    uint256 public constant EMISSION_START = 1639137600; // TODO // 2021-12-10T12:00:00.000Z
    uint256 public constant EMISSION_END = 1954497600; // TODO // 2031-12-08T12:00:00.000Z // 1639137600 + 10*365*86400
    ...
    function lastClaim(uint256 tokenId) public view returns (uint256) {
        ...
        require(
            tokenId < INftShort(nft).totalSupply(),
    ...
    function accumulated(uint256 tokenId) public view returns (uint256) {
        ...
        if (lastClaimed == EMISSION_START) {
            uint256 initialAllotment = INftShort(nft).isMintedBeforeReveal(
                tokenId
            ) == true
                ? INITIAL_ALLOTMENT * PRE_REVEAL_MULTIPLIER
                : INITIAL_ALLOTMENT;
