...
contract PixlBrosFactory is FactoryERC721, Ownable {
    ...
    /*
     * Enforce the existence of only 3333.
     */
    uint256 MAX_TOKENS = 10;
    ...
    function initialMint(uint256 _count) public {
        PixlBros nft = PixlBros(nftAddress);
        uint256 totalSupply = nft.totalSupply();

        require(totalSupply + _count < MAX_TOKENS + 1, "Exceeds maximum tokens available");
