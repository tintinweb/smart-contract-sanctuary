...
/// @author Hifi
contract HifiFlashUniswapV2 is IHifiFlashUniswapV2Underlying {
    ...
    function uniswapV2Call(
        ...
        // TODO: fix check
        // // Check that the caller is a genugetRepayCollateralAmountine UniswapV2Pair contract.
        ...
        uint256 repayCollateralAmount = getRepayCollateralAmount(underlyingAmount);
    ...
    function mintAndLiquidateBorrow(
        ...
        uint256 repayAmount = mintedHTokenAmount > debtAmount ? debtAmount : mintedHTokenAmount;
