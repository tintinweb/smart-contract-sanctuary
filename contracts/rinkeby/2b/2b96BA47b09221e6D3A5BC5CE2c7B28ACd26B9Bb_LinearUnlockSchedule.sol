...
contract LinearUnlockSchedule is BaseGovernanceWithUserUpgradable {
    ...
    function __LinearUnlockSchedule_init(ILock _lock, uint256 _lockStartTimestamp, uint256 _lockEndTimestamp, uint256 _cliffTimestamp, address governanceAddress) internal initializer {
    ...
    function __LinearUnlockSchedule_init_unchained(ILock _lock, uint256 _lockStartTimestamp, uint256 _lockEndTimestamp, uint256 _cliffTimestamp) internal initializer {
