...
//   /  _____/_____  |  | _____  ___  ______.__.  /   |   \   ___________  ____   ____   ______ \_   ___ \  ____ |__| ____  
//  /   \  ___\__  \ |  | \__  \ \  \/  <   |  | /    ~    \_/ __ \_  __ \/  _ \_/ __ \ /  ___/ /    \  \/ /  _ \|  |/    \ 
//  \    \_\  \/ __ \|  |__/ __ \_>    < \___  | \    Y    /\  ___/|  | \(  <_> )  ___/ \___ \  \     \___(  <_> )  |   |  \
//   \______  (____  /____(____  /__/\_ \/ ____|  \___|_  /  \___  >__|   \____/ \___  >____  >  \______  /\____/|__|___|  /
//          \/     \/          \/      \/\/             \/       \/                  \/     \/          \/               \/ 
...
contract GHC is Context, IBEP20, Ownable {
    ...
    uint256 public _liquidityFee = 9; //consists of buyback + liq + dividends tax 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    
    uint256 public div1 = 3;
    uint256 public div2 = 33;
    ...
    constructor (address _buybackAddress, address _devAddress, address _lpAddress, address _stakingAddress, address _uniswapAddress) {
        ...
        // ERM: Passed this into the constructor now
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        uint256 devBalance = transferredBalance.mul(div2).div(100);
        
        uint256 buybackBalance = transferredBalance.sub(devBalance);
    ...
    function addressChange(address payable _lpAddress, address payable _stakingAddress, address payable _devAddress, address payable _buybackAddress) external onlyOwner{
    ...
    function buyBack() public payable {
        ...
        path[1] = address(this);
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value : msg.value}(0,path,stakingAddress,block.timestamp.add(10));
    }
