...
contract Samurai2088 is ERC721Enumerable, Ownable, PaymentHandler {
    ...
    string public constant CONTRACT_META_URI =
        "ipfs://QmdSmeqFVhSzVGwLp9y9bs9Y4Ep29WmPrPR76j58J4vWzG";
    ...
    function _requireValidCountAndPrice(
        ...
        uint256 alreadyMinted = balanceOf(sender);
        require(
