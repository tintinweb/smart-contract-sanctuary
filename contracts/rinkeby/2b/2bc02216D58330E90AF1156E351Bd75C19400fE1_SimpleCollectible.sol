...
contract SimpleCollectible is ERC721, Ownable {
    ...
    constructor () public ERC721 ("Russian Drunken Bears", "Drunken Bear"){
        tokenCounter = 0;
    }

    function createCollectible() public onlyOwner returns (uint256) {
        uint256 newItemId = tokenCounter;
        string memory tokenURI = append("https://gateway.pinata.cloud/ipfs/QmTBpzRcCk8B6YvSFLYfS4sWyjiTJ9ofdvVBTHhKMW92Lm/metadata-", uint2str(tokenCounter), ".json");
    ...
    function batchMint(uint256 numberOfNfts) public onlyOwner payable {
