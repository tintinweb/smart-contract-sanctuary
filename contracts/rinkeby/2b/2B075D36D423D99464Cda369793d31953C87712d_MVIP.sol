...
contract MVIP is ERC721Creator {
    ...
    function getVIPUri(uint r) private pure returns (string memory) {
      string memory uri;
      if (r < 41 ){
        uri = "ipfs://QmTfFj2d8oXRRhmFG9h82zkSdTjzEiqk3ZCiotFp2XLtfg";
      } else if (r >= 41 && r <  69){
        uri = "ipfs://QmYXwKTQRutEgMyjP35kcSqvZ6mZnB92Q4Hgu7LnVvLD4j";
      } else if (r >= 69 && r < 86){
        uri = "ipfs://QmW7us4Zmk9ZcZQVgR17QijKCXFMFCXvtLxwSL9gFFFL6y";
      } else if (r >= 86 && r < 96){
        uri = "ipfs://QmR2LJjd7hCm95FFtVvgxz8f98LKLTQeXgHdWqHiwnToQR";
      } else if (r >= 96 && r < 100){
        uri = "ipfs://QmYtD7m8mUb3JHwQCEaskjW9KPwrr2XgQNnFEwjLnnEzkC";
      } else {
        uri = "ipfs://QmQDAGCT5ux1Fc6zTKjbVNF18KofYpLDTK7AiRN3P5dP4C";
      }
      return uri;
    }
