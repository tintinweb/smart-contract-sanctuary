...
contract KickstarterContractToken is ERC20Mintable, ERC20Detailed {
    constructor (string memory tokenName, string memory tokenSymbol) public ERC20Detailed(tokenName,tokenSymbol, 18) {
    }
}

contract KickstarterContract is CappedCrowdsale, RefundableCrowdsale, MintedCrowdsale {
    constructor (
        uint256 openingTime,
        uint256 closingTime,
        uint256 rate,
