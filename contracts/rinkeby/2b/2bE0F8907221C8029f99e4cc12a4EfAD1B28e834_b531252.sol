...
contract b531252 is ERC721, ERC721Enumerable, Ownable {
    ...
    // Reserve 100 Brains for team & community (Used in giveaways, promotions etc...)

    function reserveTokens() public onlyOwner {
        uint supply = totalSupply();
        require(supply < 2000, "More than 100 tokens have already been reserved or minted.");
        uint i;
        for (i = 0; i < 2000; i++) {
