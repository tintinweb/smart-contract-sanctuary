...
contract THELUCKYCAT is Context, IERC20, Ownable {
    ...
    uint256 public _buyLiquidityFee = 3; //changed from 5 to 3
    uint256 public _buyMarketingFee = 5;

    uint256 public _sellTaxFee = 0;
    uint256 public _sellLiquidityFee = 5; //edited from 8 to 5
    ...
    constructor() {
        ...
        marketingAddress = payable(0xce9664bD11eBdEa35b198A8A519F331cF29a11d9); //  update to marketing address
        liquidityAddress = payable(address(0x7F1499eB08932a834358d5B687596331AE187755)); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
