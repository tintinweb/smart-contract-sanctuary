...
contract GrantNft is ERC721 {
  ...
  function checkUint2Str(uint256 value) public pure returns (string memory) {
    return StringsCustomlyCombined.uint2str(value);
  }
}
...
library StringsCustomlyCombined {
  // via https://github.com/oraclize/ethereum-api/blob/master/oraclizeAPI_0.5.sol
  // +
  // the function uint2str replaced according to
