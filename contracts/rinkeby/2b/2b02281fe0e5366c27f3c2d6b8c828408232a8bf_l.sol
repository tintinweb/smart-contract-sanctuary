...
contract l is Context, IERC20, Ownable {
    ...
    address payable public walletAddress = payable(0x2B7EA64FaFf9340b7d7e878883d77288751F7833);
    
    string private _name = 'l';
    string private _symbol = 'l';
    uint8 private _decimals = 18;
    
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant TTOTAL = 1 * 1e6 * 1e18;
