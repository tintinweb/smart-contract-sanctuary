...
contract Goat is IGoat, ERC721Enumerable, Ownable, Pausable {
    ...
    */
    ...
    ///  expensive (it walks the entire Owner's array looking for Goats belonging to owner),
