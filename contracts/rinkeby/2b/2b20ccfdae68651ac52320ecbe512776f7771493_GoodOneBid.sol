...
contract GoodOneBid is Ownable, Pausable, GoodOneBidStorage {
  ...
  function listNFT(
    ...
    require(
      listByToken[_tokenAddress][_tokenId].id == bytes32(0),
  ...
  function unlistNFT(
    ...
    require(
      listByToken[_tokenAddress][_tokenId].owner == msg.sender ||
        msg.sender == owner(),
  ...
  function placeBid(
    ...
    // TODO: minumum reaise
    require(
      _price > highestBid.price && _price > listToken.reservePrice,
      "Price should be bigger than highest bid or reserve price"
    );
  ...
  function accpetBid(
    ...
    //List memory list = listByToken[_tokenAddress][_tokenId];
    address owner = listByToken[_tokenAddress][_tokenId].owner;

    //TODO: accpect bid only after it ended
    //require(
    //  listToken.expiresAt < block.timestamp,
