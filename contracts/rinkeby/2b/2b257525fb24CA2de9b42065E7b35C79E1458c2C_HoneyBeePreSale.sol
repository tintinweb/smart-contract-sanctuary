...
contract HoneyBeePreSale is Ownable {
    ...
    uint256 constant public MINTS_PER_USER = 90;
    uint256 constant public MINTS_PER_USER_RAISED = 100;
    uint256 constant public MINT_PRICE = 0.0000000005 ether;
    ...
    uint256 public preSaleRaiseLimit =  15 * 60; // 15 * 60 =  15 minutes after presale open
    uint256 public preSaleDuration = 3600 * 24;//3600 * 24;

    /** MERKLE */
    bytes32 public preSaleMerkleRoot = 0xd490fe28a7c3cc5e8b9eb9ac856532042080ab4d8f63efb0f8ef4c2ba8710959;
