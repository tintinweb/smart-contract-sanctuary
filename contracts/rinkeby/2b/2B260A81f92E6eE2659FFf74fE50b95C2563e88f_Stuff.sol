    ...
    PaymentSplitter
{
    ...
    event TokensMinted(uint256 _amountMinted);
    ...
    function mint(uint256 _amountMinted) public payable nonReentrant {
        require(
            ...
            "ERC721: Public sale has not started."
        );
        require(totalSupply() < supplyCap, "ERC721: All tokens sold.");
        require(
        ...
        emit TokensMinted(_amountMinted);
    }
