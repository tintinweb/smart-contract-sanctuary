...
import {IMirrorERC20Relayer, IMirrorERC20RelayerEvents} from "./interface/IMirrorERC20Relayer.sol";
 ...
 */
contract MirrorERC20Relayer is
    IERC20,
    IMirrorERC20Relayer,
    ...
    IERC20Events
{
    ...
    function initialize(
        ...
        address proxyAddress = IMirrorERC20ProxyStorage(proxyStorage)
            .initialize(operator_, name_, symbol_, totalSupply_, decimals_);
