...
contract Traits is Ownable, ITraits {
	...
	function compileAttributes(uint256 tokenId) public view returns (string memory) {
		...
		if (s.isApe) {
			...
			traits = string(
				abi.encodePacked(
					attributeForTypeAndValue(_traitTypes[0], traitData[9][s.skin].name),
					",",
					attributeForTypeAndValue(_traitTypes[1], traitData[10][s.eyes].name),
					",",
					attributeForTypeAndValue(_traitTypes[2], traitData[12][s.mouth].name),
					",",
					attributeForTypeAndValue(_traitTypes[3], traitData[14][s.clothing].name),
					",",
					attributeForTypeAndValue(_traitTypes[4], traitData[15][s.headwear].name),
					",",
