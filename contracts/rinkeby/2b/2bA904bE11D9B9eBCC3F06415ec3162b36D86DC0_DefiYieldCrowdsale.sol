...
contract DefiYieldCrowdsale is CappedCrowdsale {
  ...
  constructor(address wallet_, address token_, address[] memory collaterals_, DefiYieldTokenVesting vesting_)
  ...
  function setDirectWithdrawPercentage(uint256 percentage_)
    ...
    onlyAdmin
  {
    require(!isClosed(), "DefiYieldCrowdsale::setDirectWithdrawPercentage: sales is already closed");
  ...
  function closeSale()
    ...
    onlyAdmin
  {
    require(isOpen(), "DefiYieldCrowdsale::closeSale: sales is already closed or not open");
    _state = State.Closed;
  ...
  function addRound(uint256 price_, uint256 totalSupply_, uint8 pool_)
    ...
    onlyAdmin
  {
    require(!isClosed(), "DefiYieldCrowdsale::addRound: sales is already closed");
    ...
    onlyAdmin
  {
    ...
    require(_rounds[index_].state != State.Closed, "DefiYieldCrowdsale::updateRound: round is already closed");
    require(!isClosed(), "DefiYieldCrowdsale::updateRound: sales is already closed");
  ...
  function openRound(uint256 index_)
    ...
    onlyAdmin 
  {
    require(isOpen(), "DefiYieldCrowdsale::openRound: sales is not open yet");
  ...
  function closeRound(uint256 index_)
    ...
    onlyAdmin 
  {
    require(isOpen(), "DefiYieldCrowdsale::closeRound: sales is not open yet");
