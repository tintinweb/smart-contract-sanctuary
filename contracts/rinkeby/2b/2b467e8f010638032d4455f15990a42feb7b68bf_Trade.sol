...
contract Trade {
    ...
    function buyAsset(address paymentAssetAddress, address assetOwner, uint paymentAmt, BuyingAssetType buyingAssetType, address buyingAssetAddress, uint tokenId, uint8 buyingAssetQty, bytes memory data) public returns(bool) {
    ...
    function executeBid(address paymentAssetAddress, address buyer, uint paymentAmt, BuyingAssetType buyingAssetType, address buyingAssetAddress, uint tokenId, uint8 buyingAssetQty, bytes memory data) public returns(bool) {
        Fee memory fee = getFees(paymentAmt, buyingAssetType, buyingAssetAddress, tokenId);
