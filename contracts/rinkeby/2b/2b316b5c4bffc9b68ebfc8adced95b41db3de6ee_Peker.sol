...
contract Peker is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Peker", "PEKER") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://nft.mrpeker.com/api/";
    }
    ...
    uint public constant MAX_NFTS = 10001;
    bool public HAS_SALE_STARTED = false;
    ...
    function toggleSale() public onlyOwner {
        HAS_SALE_STARTED = !HAS_SALE_STARTED;
    }
