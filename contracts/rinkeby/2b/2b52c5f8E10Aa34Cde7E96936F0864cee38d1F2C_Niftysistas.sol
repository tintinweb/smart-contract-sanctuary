...
contract Niftysistas is ERC721, Ownable, Pausable {
    ...
    uint[] private lowerBounds = [880, 861, 823, 646, 304, 184, 141, 100, 784, 679, 494, 443, 247];
    uint[] private upperBounds = [898, 879, 860, 678, 442, 246, 183, 140, 822, 783, 645, 493, 303];
