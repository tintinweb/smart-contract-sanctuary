...
contract PKKT is ERC721Enumerable, Ownable {
    uint256 public constant MAX_KITTIES = 50;
    uint256 public constant MAX_KITTIES_test = 50;
    ...
    uint256 private _saleTime = 9244092; // August 23rd @ 6:30 EST
    uint256 private _freeSupply = 10;
    ...
    function mint(uint256 _count) public payable {
        ...
        require(block.number >= _saleTime, "Sale is not yet open.");
        require(
            _count < _maxPerTx,
