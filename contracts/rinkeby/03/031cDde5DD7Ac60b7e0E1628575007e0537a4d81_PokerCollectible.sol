...
contract PokerCollectible is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Poker", "PKR") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFTS() public payable {
        // require(NFTholders[msg.sender] != true, "You can only mint one player NFT");
        uint totalMinted = _tokenIds.current();
        require(totalMinted.add(MAX_PER_MINT) <= MAX_SUPPLY, "Not enough NFTs");
