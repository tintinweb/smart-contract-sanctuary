...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721En[email protected]
...
// File contracts/ArawaneyTreeDNA.sol
pragma solidity ^0.8.4;

contract ArawaneyTreeDNA {
...
// File contracts/ArawaneyTree.sol

pragma solidity ^0.8.4;
contract ArawaneyTree is ERC721, ERC721Enumerable, ArawaneyTreeDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("ArawaneyTree", "ARW3") {
    ...
    function mint() public {
        ...
        require(current < maxSupply, "No Arawaney Tree Left :(");
    ...
    function tokenURI(uint256 tokenId) 
        ...
        returns(string memory) 
    {
        require(_exists(tokenId), "ERC721 Metadata: URI Queri form noneexistent token");
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "ArawaneyTree #',
                tokenId.toString(),
                '", "description": "Arawaney Tree are randomized Avataaars stored on chain", "image": "',
                image,
                '"}'
            )
        );
