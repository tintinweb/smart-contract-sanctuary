...
contract Symbols is Ownable, ERC721B {
    ...
    uint256 public constant AGC_PRICE = 0.0002 ether;
    ...
    address private _signerAddress = 0xd31D371368A65f0C32c880D1326C0d5544de89f7;
    address private _vaultAddress = 0x4d19D7C3de5c143CDB470269fA81984013881Ad4;
    ...
    constructor(string memory baseURI, string memory notRevealedURI) ERC721B("Simple Symbols", "SS") { 
        setBaseURI(baseURI);
    ...
    //function M!nt(bytes32 hash, bytes memory signature, uint256 tokenQuantity) external payable {
