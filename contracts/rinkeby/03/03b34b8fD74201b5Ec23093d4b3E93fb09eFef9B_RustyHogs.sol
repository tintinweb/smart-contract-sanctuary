...
contract RustyHogs is ERC721, MerkleWhitelist, Ownable, ERCWithdrawable {
    ...
    */
    ...
    // Project Constraints
    uint16 immutable public maxTokens = 3500;
    ...
    function whitelistMint(bytes32[] memory proof_) external payable onlySender whitelistSale {
        ...
        require(addressToWhitelistMinted[msg.sender] == 0, "You have no whitelisted mints remaining!");
        require(msg.value == mintPrice, "Invalid Value Sent!");
        require(maxTokens > totalSupply, "No more tokens available!");
    ...
    function publicMint() external payable onlySender publicSale {
        require(addressToPublicMinted[msg.sender] < 5, "You have no public mints remaining!");
        require(msg.value == mintPrice, "Invalid value sent!");
        require(maxTokens > totalSupply, "No more tokens available!");
