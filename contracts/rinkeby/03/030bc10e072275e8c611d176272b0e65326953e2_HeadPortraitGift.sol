...
contract HeadPortraitGift is OwnableContract{
    ...
    function getOrderIdIsClaim(uint256[] memory orderId) public view returns(uint256[] memory unconfirmedOrderId){
        uint256 count = 0;
    ...
    function batchClaim(uint256[] memory orderId, uint256[] memory amount, bytes[] memory signature) public returns(uint256[] memory tokenIdArray){
