...
contract APG is ContextMixin, ERC721A, NativeMetaTransaction, Ownable {
    ...
    uint256 public NFT_price_for_10 = 0.099 ether;

    uint256 public startTime = 2147462145;

    string _name = "Angry Penguins Grotto";
    string _symbol = "APG";

    uint256 public reveal_time = 2147462145;
    ...
    function buyThree() public payable mintHasStarted {
        require(msg.value == NFT_price_for_3, "Wrong amount for three");
        buyAmount(3);
    }

    function buyTen() public payable mintHasStarted {
        require(msg.value == NFT_price_for_10, "Wrong amount for ten");
        buyAmount(10);
    }
