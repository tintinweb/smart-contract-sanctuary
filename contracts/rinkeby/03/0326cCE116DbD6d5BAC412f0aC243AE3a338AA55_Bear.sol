...
contract Bear is IBear, ERC721Enumerable, Ownable, Pausable, VRFConsumerBase {
  ...
  mapping(bytes32 => uint) public randomnessRequestResult;
  ...
  constructor(address _honey, address _traits, uint256 _maxTokens) 
 ...
 //   uint256 public Price = 8e16; //0.08 ETH
  ...
  function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
      randomnessRequestResult[requestId] = randomness;
