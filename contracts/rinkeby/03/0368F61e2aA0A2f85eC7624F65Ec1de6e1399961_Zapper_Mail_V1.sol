...
contract Zapper_Mail_V1 is SignatureVerifier, Ownable {
    ...
    EnsRegistry public registry = EnsRegistry(address(0));
    EnsResolver public resolver = EnsResolver(address(0));
    ...
    function registerUser(
        ...
        // require(verify(_account, _publicKey, _signature), "Err: Invalid Signature");
