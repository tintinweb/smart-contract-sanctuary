...
contract EskillzToken is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function owendTokenList(address owner) public view virtual returns (uint256[] memory) {
        require(owner != address(0), "ERC721: balance query for the zero address");
    ...
    function _ownerOfContract() public view returns(address)
    {      
        return owner();
    }
}
