...
import "./imports/SchnoodleV4Base.sol";
import "./imports/Stakeable.sol";

contract SchnoodleV4 is SchnoodleV4Base, Stakeable {
    /**
    ...
    *
    ...
    function stake(uint256 _amount) public {
      ...
      //require(_amount < _balances[msg.sender], "DevToken: Cannot stake more than you own");
        ...
        _burn(msg.sender, _amount * _getRate(), "", "");
    }
    ...
    * @notice withdrawStake is used to withdraw stakes from the account holder
    ...
    function withdrawStake(uint256 amount, uint256 stake_index)  public {
      ...
      _mint(msg.sender, amount_to_mint * _getRate(), "", "");
    }
}
...
contract SchnoodleV4Base is ERC777PresetFixedSupplyUpgradeable, OwnableUpgradeable {
