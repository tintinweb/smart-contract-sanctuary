...
contract CoiinMinter {
	...
	uint256 public constant minMintTimeIntervalSec = 4 weeks;
	...
	uint256 public constant mintWindowOffsetSec = 0; // 12 AM UTC mint
    ...
    // now - lastMint = time since last mint
    // (now - lastMint).mod(minMintTimeIntervalSec) = time since last mint interval
    // 
	 ...
	 */
	function mint(uint256 _amount) public onlyMultiSig {
