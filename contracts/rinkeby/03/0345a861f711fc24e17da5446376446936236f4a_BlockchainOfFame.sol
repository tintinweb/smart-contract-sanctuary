...
contract BlockchainOfFame is ERC721Enumerable, Ownable {
    ...
    function totalToken() public view returns (uint256) {
     ...
     function mintBof(string memory newName) public payable {
    ...
    function whitelistedMints(string memory newName, bytes32[] calldata merkleProof ) payable external  {
        ...
        require(msg.value == WHITELIST_PRICE, "Ether value sent is not correct");
		...
		if (totalSupply() < MAX_ELEMENTS) {
               ...
               saleIsOpen = !saleIsOpen;
               payable(msg.sender).transfer(WHITELIST_PRICE);
            }
