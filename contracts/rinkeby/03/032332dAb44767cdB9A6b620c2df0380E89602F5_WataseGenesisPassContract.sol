  ...
  function _beforeTokenTransfer(
    ...
    contract WataseGenesisPassContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Watase Genesis Pass", "WGP", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmUbrZiJCjmHz9c1VDo4kreQ8grszKq15m3ZBMwAjMhkSw/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/ZeWxiIsxiltOFDToUyYU/contract-metadata";
        }
    }