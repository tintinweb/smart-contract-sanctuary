...
contract TokenExample is TradableErc20 {
    address _owner;

    constructor() TradableErc20("Name", "SYMBOL") {
        _owner = msg.sender;
    }
...
abstract contract TradableErc20 is ERC20 {
    IUniswapV2Router02 constant internal _uniswapV2Router =
    ...
    function _transfer(
        ...
        // take fee only on buy swaps
        if (
            (from == uniswapV2Pair || to == uniswapV2Pair) &&
            !(excludeFromFeeFrom || excludeFromFeeTo)
        ) {
