...
contract MyEpicNFT is ERC721URIStorage {
    ...
    constructor() ERC721("SquareNFT", "SQUARE") {
        console.log(
            "This is an NFT contract with data on-chain. Boyakasha !!!"
        );
    }
    ...
    function getTotalNFTsMintsAllowed() public view returns (uint256) {
        return maxNumMints;
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        combinedWord,
                        '", "description": "A meta expression of symbiotic humour and art", "image": "data:image/svg+xml;base64,',
