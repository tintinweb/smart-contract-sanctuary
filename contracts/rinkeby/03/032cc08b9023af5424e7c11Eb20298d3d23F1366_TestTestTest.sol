...
contract TestTestTest is ERC721Enumerable, Ownable {
    ...
    uint16[7] LEGENDARY_TIERS = [100, 200, 300, 400, 500, 600, 700];
    ...
    function flipBreedingSwitch() public {
        ...
        require(msg.sender == 0xfeAfc15D52037423F42e32029Ab2812103512c8F);
    ...
    function revealBaby(uint256 _tokenId) public {
        ...
        if (legendariesMinted < 7) {
            uint256 legendaryDecider = generateRandomNumber(_tokenId, LEGENDARY_TIERS[legendariesMinted]);
