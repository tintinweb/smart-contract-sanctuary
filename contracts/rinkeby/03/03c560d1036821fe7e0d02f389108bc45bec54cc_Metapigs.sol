...
contract Metapigs is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateMetapigs(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Meta Pigs", "Metapigs") {
		setBaseURI(baseURI);
        pause(true);
    }
