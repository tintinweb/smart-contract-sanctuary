...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    // the 'indexed' keyword just make it easier to search for this event.
        ...
        override
    {
        ...
        // msg.sender here is always gonna be the vrf coordinator
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        ...
        // _isApprovedOrOwner is inherited from ERC721, it checks if somebody
        // is approved to work with this token id or is the owner
        // _msgSender() is also inherited from ERC721
        require(
            _isApprovedOrOwner(_msgSender(), tokenId),
            "ERC721: caller is not owner nor approved user"
        );
