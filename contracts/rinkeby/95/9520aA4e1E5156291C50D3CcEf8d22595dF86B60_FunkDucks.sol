...
contract FunkDucks is ERC721, Ownable
{
    ...
    function tryCreateDuck(string memory tokenURI) public returns (uint) 
    {
        if (_tokenIds.current() <= MAX_TOKENS)
        {
            _tokenIds.increment();
    ...
    // function createCollectables(string memory tokenURI) public returns (bytes32)
    // {
    ...
    //     // TEST for testing - event like message - outputs requestId
    ...
    // {
    //     FUNK_PROVENANCE = _provenanceHash;
    // }
