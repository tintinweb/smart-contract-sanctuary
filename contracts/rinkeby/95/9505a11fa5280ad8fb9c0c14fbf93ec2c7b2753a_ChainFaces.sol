...
//       require(block.timestamp < 1574711999, "ChainFaces sale has completed. They are now only available on the secondary market. ");
        ...
        address(0x027Fb48bC4e3999DCF88690aEbEBCC3D1748A0Eb).transfer(msg.value);
   ...
   function integerToString(uint _i) internal pure 
    ...
    function tokenURI(uint256 id) external view returns (string memory) {
        ...
        return string(abi.encodePacked("https://chainfacesrinkeby2.azurewebsites.net/api/HttpTrigger?id=", integerToString(id)));
    }
