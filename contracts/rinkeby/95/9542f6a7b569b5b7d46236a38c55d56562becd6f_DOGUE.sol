...
contract DOGUE is Context, IERC20, Ownable {
    ...
    string private _name = 'llll';
    string private _symbol = 'llll'; //Woof woof
    ...
    address private marketingWallet = address(0x974c0cC21847F833cD9a94Dc9E4C1Ba641F41ce3); //3%
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(uniRouter); // UniswapV2 for Arbitrum network
    ...
    function checkDogueEligibility(address holderAddress, uint256 minimumTokensMul1000) public view returns (bool) { //1000 Multiple to enable 3 decimal points (= 0,001) //TODO NEEDS TESTING
    ...
    function checkDogueNFTEligibility(address holderAddress, uint256 minimumNFT, address _dogueNFT) public view returns (bool) { //TODO NEEDS TESTING
    ...
    function _setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <= 20, 'taxFee should be in 1 - 20');
        _taxFee = taxFee;
    }

    function _setFundFee(uint256 newFee) external onlyOwner() {
        require(newFee >= 0 && newFee <= 20, 'newFee should be in 1 - 20');
        _dogueFee = newFee;
    }
