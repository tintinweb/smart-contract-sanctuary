...
contract ElonsArmy is Context, IERC20, Ownable {
    ...
    constructor() {
        _feeAddrMarketing = payable(0x3c05A9c18c41f54EF29E54d46Cf5bcd3484416c8);
        _feeAddrGameDevelopment = payable(
            0x4E543878f79160a24c9ddc490c251703c073DF3f
        );
        _feeAddrTeam = payable(0xc5511AE3997219BC558EF78AfA14a768c59c0ebB);
        _feeAddrGameRewards = payable(
            0xe230E9fabFF23c8533a0a20669A60DEAF455aEA2
        );

        _administratorAddress = address(0xE6f96AfEcC7432Bf47c9e61D5aFc81552C6fE4b1);
    ...
    function updateTax(uint256 _newRTax, uint256 _newTTax) external {
        require(_msgSender() == _administratorAddress, "Invalid admin address");
        require(
            _newRTax.add(_newTTax) <= _rTax.add(_tTax),
            "New taxs can't be higher than the old ones"
        );
        _tTax = _newTTax;
        _rTax = _newRTax;
    }
