...
contract RegisterManager {
    ...
    constructor(address _daiToken, address _distributionToken, address _whlclubAddress, address _daiPrimeFeeAddress, address _daiApexFeeAddress, address payable _donationAddress) {
