// SPDX-License-Identifier: MIT
    ...
    contract TestGirlx is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 6000000000000000; // 10 matic
      uint256 public constant maxTokenPurchase = 5;
      uint256 public constant MAX_TOKENS = 3000;
    
      string public baseURI = "ipfs://QmS7NUd6ryJH26STj2y5MdLt7yJjiUaVw2QqqfHd9jf7EZ/"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT
      ...
      uint256 public devReserve = 60;
    
      event PartyGirlMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("TestGirlx", "EFS") {}
      ...
      function mintPartyGirl(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit PartyGirlMinted(id, msg.sender);
          }
        }
      }
    
      function presalePartyGirl(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmY1ARsQ5YBouuS35bABN71GacBYu6fFTdjvfhpubeaorw/hidden.json";
        }
