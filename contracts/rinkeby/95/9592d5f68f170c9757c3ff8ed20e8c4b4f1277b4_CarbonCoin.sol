...
contract CarbonCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    function setClaimEventTime() private {
        claimEventTime = block.timestamp + 30 minutes;
    }
    ...
    function claimReward() isHuman nonReentrant public {
        ...
        require(claimEventTime < block.timestamp,'Error: claim event does not start yet');
