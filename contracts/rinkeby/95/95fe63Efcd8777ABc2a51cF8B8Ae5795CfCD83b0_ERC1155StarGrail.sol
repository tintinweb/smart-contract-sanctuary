...
contract ERC1155StarGrail is Initializable, ERC1155Base {
    ...
    function __ERC1155StarGrail_init(
        ...
        string memory contractURI) public initializer {
        // OwnableUpgradeable
        ...
        // Initializer inside OwnableUpgradeable
...
RoyaltiesV2Upgradeable, RoyaltiesV2Impl
{
    ...
    function setPriceForToken(uint256 _tokenID, uint256 _price)
    external
    payable
    {
        require(
...
//    function __ERC1155BaseURI_init_unchained() internal initializer {
//        __ERC1155_init("");
//    }
...
ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI {
    ...
    // Initializer instead of constructor
    function __ERC1155Base_init_unchained(string memory _name, string memory _symbol) public initializer {
        name = _name;
        symbol = _symbol;
    }
