...
contract IndexFund {
    ...
    address private constant PILOT_ADDRESS = 0x156ba900cE4De8906416469dF5D7897C2C9F0502;
    ...
    function withdraw(address[] calldata _tokenAddresses, uint256 _pilotAmount) external {
    ...
    function addLockedFundsAddresses(address[] calldata _accounts) external onlyTimelock {
