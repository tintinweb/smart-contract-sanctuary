...
contract Mseratus is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    string public baseURI = "ipfs://QmZ2D9x7JXuVJtnNE1yGCmisfqZLWVBqtLsKhzbCmZmLfS/";
    bool private _started = false;
    uint public endDate = 0;

    constructor()
    ERC721("Mseratus", "Mseratus")
    {}
    ...
    function claim(uint256 _batchCount) payable public {
        ...
        require(_batchCount > 0 && _batchCount <= maxBatch, "Batch must be between 0 and 6");
