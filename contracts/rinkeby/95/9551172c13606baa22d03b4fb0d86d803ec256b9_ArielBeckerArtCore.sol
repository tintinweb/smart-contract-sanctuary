...
contract ArielBeckerArtCore is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
	...
	struct TokenStruc {
		bytes data; // Todo va aquí adentro; el render se encarga de separar y mostrar las cosas por su lado.
	}
	...
	string private _baseTokenURI = "https://arielbecker.com/arielbeckerart/token.php";
	string private _contractURI = "https://arielbecker.com/arielbeckerart/contract.php";
	string private _contractJSON = '{"name": "Ariel Becker Art","description": "Crazy elucubrations of an Argentinian lunatic.","image": "https://arielbecker.com/arielbeckerart/aba.png","external_link": "https://arielbecker.com/arielbeckerart","seller_fee_basis_points": 1000,"fee_recipient": "0xC12Df5F402A8B8BEaea49ed9baD9c95fCcbfE907"}';
	...
	function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
		// La URL base debe tener ya la ruta para el token, por ejemplo "https://arielbecker.com/arielbeckerart/token.php"
	...
	function retrieveData(uint256 _tokenId) public view returns (bytes memory) {
		require(_tokenId >= 0, "Token ID cannot be less than zero!");
		require(_tokenId < totalSupply(), "Token ID out of bounds!");
