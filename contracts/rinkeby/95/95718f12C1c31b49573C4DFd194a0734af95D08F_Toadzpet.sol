...
contract Toadzpet {
    ...
    event ToadLoved(address indexed toadlover, uint256 indexed amount);
    ...
    function addLove(address toadlover, uint256 amount) internal {
        love[toadlover] += amount;
        emit ToadLoved(toadlover, amount);
    }
