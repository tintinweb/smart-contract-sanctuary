...
contract PlanetPanda is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public freeTokensPerAddress = 5;
...
// Mapping address to free mints claimed
  ...
  constructor() ERC721("Panda Test", "PT") {
    setHiddenMetadataUri("ipfs://QmVoRzgbd9aP871EKzDabNKLQ3mEJqFaedbG8LmSC1CLp6/hidden.json");
  }
