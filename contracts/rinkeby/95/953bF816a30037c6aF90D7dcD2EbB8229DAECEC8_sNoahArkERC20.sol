...
contract sNoahArkERC20 is IsNAC, ERC20Permit {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor() ERC20("Staked NoahArk Coin", "sNAC", 9) ERC20Permit("Staked NoahArk Coin") {
    ...
    /**
        @notice increases sNAC supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sNAC
