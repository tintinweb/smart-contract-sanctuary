...
contract FluffySketches is ERC1155, Ownable {
    ...
    address public constant ARTIST_ADDRESS = 0x2a408eB3538e54fE60E6bb591826B16575537faF;
    ...
    function preSaleMint(uint256 amount) external payable {
        ...
        require(amount <= MAX_FLUFFY_SKETCHES, "Purchase would exceed max tokens");
        // Can only claim 20 at a time
        require(amount <= 20, "Too many requested");
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        uint toOwner = balance - (toDeveloper + toArtist);
