      ...
      bytes(
        string(
          ...
          abi.encodePacked(
            ...
            '", "description": "Hi! This is BelleDAOphine <3\nWelcome to my cute and weird lil world..\nThis is where you will find 1111 membership passes that wont be found anywhere else! I am so excited to share this silly, vulnerable, and magical journey with you. ^-^", "image": "',
            output,
            '"}'
          )
        )
