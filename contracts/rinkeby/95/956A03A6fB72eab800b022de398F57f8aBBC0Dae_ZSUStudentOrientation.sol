...
contract ZSUStudentOrientation is ERC721Enumerable, Ownable {
    ...
    uint256 public constant zombiePrice = 88000000000000000; //0.088 ETH
    ...
    uint256 public MAX_LEGENDARY_COUNT = 11;
    ...
    function _generateRandomStudentId(string memory _identifier)
        ...
        returns (uint256)
    {
        return uint256(keccak256(abi.encodePacked(_identifier))) % 10**26; //10 is modulus and 26 is student id digits based on number of layers
    }
