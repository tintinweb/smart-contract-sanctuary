  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x701ac8c529286B27DC7cf26783bc9299B6b35864);
    ...
    // File: contracts/thattayaContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ThattayaContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Thattaya", "TT", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://gateway.pinata.cloud/ipfs/QmXfAsKk8Y1b18zz8fJZpTNVkGwDnVaH6gJhcTtRxMTbYV/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/8RjfFb6KxLnE4cAltd6P/contract-metadata";
        }
    }