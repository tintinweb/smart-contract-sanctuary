...
contract DCB {
    ...
    constructor() payable{
        ...
        ownedToken = creator.createToken('Dubbo Color ball Coin','DCBC', 100000000 * 10 ** uint256(18), 18);
    }    
...
contract TokenCreator {
    function createToken(bytes32 _name,string memory _symbol, uint _totalSupply, uint _decimals) public returns (OwnedToken tokenAddress) {
        return new OwnedToken(_name, _symbol,_totalSupply,_decimals);
    }
