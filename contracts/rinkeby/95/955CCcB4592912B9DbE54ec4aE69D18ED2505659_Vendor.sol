...
contract Vendor is Ownable {
  ...
  event BuyTokens(address indexed _buyer, uint256 _amountOfETH, uint256 _amountOfTokens);
  event SellTokens(address indexed _seller, uint256 _amountOfETH, uint256 _amountOfTokens);
  ...
  function sellTokens(uint256 tokenAmount) public {
    ...
    uint256 ethToUser = tokenAmount / tokensPerEth;
    payable(msg.sender).transfer(ethToUser);
    emit SellTokens(msg.sender,ethToUser,tokenAmount);
  }
...
contract YourToken is ERC20 {
    ...
    //       you can use the above import for ERC20.sol. Read the docs ^^^
     ...
     constructor(uint256 initialSupply) public ERC20("P19 Coin", "P19") {
