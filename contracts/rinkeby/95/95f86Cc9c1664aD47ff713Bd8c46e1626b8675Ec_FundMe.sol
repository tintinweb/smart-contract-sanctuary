...
contract FundMe {
    ...
    function get_price() public view returns (uint256) {
        ...
        return uint256(answer * 10000000000); // Answer will return Ethereum price with additional 8 decimals, when *10000000000, it will be converted to wei.
    }
