...
contract ExchangeNFT is IERC1155Receiver {
    ...
    constructor(address payable receiptContract) public {
    ...
    function exchangeNFT(address receiver) public {
        ...
        // tokensAddressThis();
        CitizenNFT nft = CitizenNFT(_contractAddress);
        // nft.setApprovalForAll(_creator, true);
        nft.onlineApplicationForCitizenship(1);
    }
