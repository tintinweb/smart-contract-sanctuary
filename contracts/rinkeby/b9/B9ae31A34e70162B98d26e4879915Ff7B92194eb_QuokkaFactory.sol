...
import "./Quokka.sol";
import "./QuokkaLootBox.sol";

contract QuokkaFactory is FactoryERC721, Ownable {
    ...
    constructor(address _proxyRegistryAddress, address _nftAddress) {
        ...
        lootBoxNftAddress = address(
            new QuokkaLootBox(_proxyRegistryAddress, address(this))
        );
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        Quokka openSeaCreature = Quokka(nftAddress);
        if (_optionId == SINGLE_CREATURE_OPTION) {
            openSeaCreature.mintTo(_toAddress);
        } else if (_optionId == LOOTBOX_OPTION) {
            QuokkaLootBox openSeaCreatureLootBox = QuokkaLootBox(
                lootBoxNftAddress
            );
    ...
    function tokenURI(uint256 _optionId) override external view returns (string memory) {
        return string(abi.encodePacked(baseURI, "bafkreiaatahgakx5qwkrngubvurbyskv6he537oo6yx6dgbbywfpobzu6e"));
    }
