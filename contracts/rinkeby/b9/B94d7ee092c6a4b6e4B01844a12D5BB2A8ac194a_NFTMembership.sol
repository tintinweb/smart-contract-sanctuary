...
contract NFTMembership is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;

    // TODO: Change this with your own base URL
    string _baseTokenURI = 'https://ipfs.infura.io:5001/api/v0';
    ...
    constructor() ERC721("NFT Premium Membership", "NFTPM") {
	...
	// Here we make sure the plan actually exist and user is paying the correct price
        require(plan.price == msg.value, "Oops! You've sent the wrong amount");
        require(plan.duration > 0, "Sorry, that Premium Membership doesn't exist");
    ...
    function mint() whenNotPaused public payable  {
        require(msg.value == _price, "Oops! You've sent the wrong amount");
        require(_tokenIdCounter.current() < FOUNDING_MEMBERS_SUPPLY, "Sorry! You can't mint over the limit");

	// TODO: Decide the amount of NFT a wallet can hold
        require(balanceOf(msg.sender) == 0, "Sorry! Only one Founding Membership can be minted");
