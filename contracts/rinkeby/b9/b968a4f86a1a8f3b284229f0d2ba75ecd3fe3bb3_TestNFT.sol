...
contract TestNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public GRAVEL_PRICE = 50000000000000000; // 0.03 ETH
   ...
   function mint(uint256 amountToMint) public payable {
        ...
        require(amountToMint > 0, "You must mint at least one TestNFT.");
        require(amountToMint <= MAX_PURCHASABLE, "You cannot mint more than 30 NFTs.");
        require(totalSupply() + amountToMint <= MAX_NFT_SUPPLY, "The amount of NFTs you are trying to mint exceeds the MAX_NFT_SUPPLY.");
