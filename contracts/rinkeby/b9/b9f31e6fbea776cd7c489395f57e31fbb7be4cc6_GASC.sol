...
contract GASC is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable{
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;
	
	uint256 public MAX_NFT = 7888;
	uint256 public MAX_BY_MINT_PRESALE = 2;
	uint256 public MAX_BY_MINT_SALE = 2;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = 2;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 2;
	
	uint256 public SALE_PRICE = 28 * 10**16;
	uint256 public PRESALE_PRICE = 28 * 10**16;
    ...
    constructor(string memory baseURI) ERC721("Great Ape Social Club", "GASC") {
		setBaseURI(baseURI);
        pause(true);
    }
