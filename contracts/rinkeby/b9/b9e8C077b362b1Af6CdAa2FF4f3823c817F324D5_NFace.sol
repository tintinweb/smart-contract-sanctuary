...
contract NFace is NPassCore {
    ...
    constructor(address _nContractAddress)
        NPassCore("NFace", "NFace", IN(_nContractAddress), true, 8888, 0, 13370000000000000, 0)
    {}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" height="350" width="350"><defs><path id="l" stroke="#000" fill="none" d="M 10,20 Q 50,';

        parts[1] = toString((n.getFirst(tokenId) * 10) + 5);

        parts[2] = ' 70,20 " /><path id="r" stroke="#000" fill="none" d="M 0,20 Q 50,';

        parts[3] = toString((n.getSecond(tokenId) * 10) + 5);

        parts[4] = ' 80,20 " /><path id="n" stroke="#000" fill="none" d="M 0,';
        ...
        parts[8] = ' -20,40 0,30" /><path id="m" stroke="#000" fill="none" d="M-75,150 C -75,';
        ...
        parts[12] = ' 75,150 " /><path id="c" stroke="black" fill="none" d="M-125,0 C -200,';
        ...
        parts[
            16
        ] = ' 100,150 " /></defs><g transform="translate(175,75)"><rect width="100%" height="100%" fill="white" /><use xlink:href="#l" /><use transform="translate(-100,0)" xlink:href="#r" /><use xlink:href="#n" /><use xlink:href="#m" /><use xlink:href="#c" /></g></svg>';
