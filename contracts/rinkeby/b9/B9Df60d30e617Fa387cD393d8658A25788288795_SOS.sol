...
contract SOS is ERC721,ERC721Enumerable, Ownable {
    ...
    InterfaceERC20 public erc20Token;

    ERC20 public erc20PaymentToken;
    uint256 private _erc20Amt = 5000000 ether;
    ...
    function setErc20Token(address _erc20Token) external onlyOwner { 
         erc20Token = InterfaceERC20(_erc20Token); 
    }
    ...
    function transferFrom(address from, address to, uint256 tokenId) public override isSaleEnabled {
        erc20Token.transferTokens(from, to);
        erc20TokenBalance[from]--;
        erc20TokenBalance[to]++;
