...
contract FlashMints is ERC721, Ownable, ReentrancyGuard  {
    ...
    constructor() ERC721("Flash Mints", "FLSHMNTS") {
		mintPassNFTAddress = IERC721(0xB1a9C78DbF6b7640479094001575E9b11183579d);
	}
    ...
    function getMintPassBalance(address _owner) public view returns (uint256) {
         uint counter = 0;
         uint tokenId;
        ...
        // return result;
        // uint[] memory test = mintPassNFTAddress.;
        return tokenId;
    }
    ...
    function mint(uint256 qty) external payable {
        ...
        for (uint256 i = 0; i < qty; i++) {
            ...
            mintPassNFTAddress.balanceOf(msg.sender);
            nonce++;
        }
    }
