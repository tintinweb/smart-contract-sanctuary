...
contract KPITokensFactory is Ownable, IKPITokensFactory {
    ...
    function createToken(
        ...
        bool _hasZeroWeightOracle = false;
        ...
        for (uint256 _i = 0; _i < _oracles.length; _i++) {
            ...
            if (!_hasZeroWeightOracle && _oracle.weight == 0)
                _hasZeroWeightOracle = true;
        ...
        if (_totalWeight != 0 && _hasZeroWeightOracle)
            revert InvalidOracleWeights();
        if (_jobsFunding > 0)
