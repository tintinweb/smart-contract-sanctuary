...
// File contracts/KaijuKingzERC721.sol
...
// File contracts/KaijuKingz.sol

pragma solidity ^0.8.0;
interface IRWaste {
    function burn(address _from, uint256 _amount) external;
    function updateReward(address _from, address _to, uint256 _kaijuId) external;
} 
...
contract KaijuKingz is KaijuKingzERC721 {
    ...
    event KaijuHatched(uint256 kaijuId);
    ...
    function hatch(uint256 kaijuId) external kaijuOwner(kaijuId) {
        babyKaiju[kaijuId] = 2;
        emit KaijuHatched(kaijuId);
    }
