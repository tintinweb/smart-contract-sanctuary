...
contract Daruma is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "https://darumagl.vercel.app/meta/";
  ...
  constructor() ERC721("Daruma Good Luck", "DGL") {
    setHiddenMetadataUri("https://darumagl.vercel.app/meta/hidden.json");
  }
