...
contract DeepWatersVault is IDeepWatersVault, Ownable {
    ...
    **/
    function getAssetScarcityRatio(address _asset) public view returns (uint256) {
        ...
        return reserveSize == 0 ? 0 : getAssetTotalBorrowBalance(_asset).mul(100).mul(1000000).div(reserveSize);
    }
    ...
    **/
    ...
    /**
    * @dev gets calculated cumulated liquidity index of the asset (18 decimals).
    * @param _asset the address of the asset
    ...
    **/
    ...
    /**
    * @dev gets last stored cumulated liquidity index of the asset (18 decimals).
    * @param _asset the address of the asset
