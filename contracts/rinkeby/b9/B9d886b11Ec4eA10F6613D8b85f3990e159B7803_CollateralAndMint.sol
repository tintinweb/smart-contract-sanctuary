...
contract CollateralAndMint is LandOracleProxy {
    using SafeMath for uint256;
    uint256 public collateralRequirementPercent;
    address public oracleAddress;
    address public CompAddress;
    uint256 public CETHBalanace;
    ...
    function CollateralizeEth() public payable {
        ...
        uint256 NewBalance = ICompProxy(CompAddress).balanceOf(CompAddress);
        CETH[msg.sender] = NewBalance.sub(CETHBalanace);
        CETHBalanace = NewBalance;
    }
    ...
    function CalculateCollateralUse(
        address _address,
        uint256 _mint,
        uint256 _burn
    ) private {
    ...
    function MintAsset(uint256 _amount) public {
        ...
        CalculateCollateralUse(msg.sender, _amount, 0);
    ...
    function BurnAsset(uint256 _amount) public {
        ...
        CalculateCollateralUse(msg.sender, 0, _amount);
    ...
    function WithdrawCollateral(uint256 _amount) public {
        ...
        // Have to check if the withdraw was succesful.
        ICompProxy(CompAddress).redeem(_amount);
        ...
        // Working on depositing collateral in an lending protocol.
