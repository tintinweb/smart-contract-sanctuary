...
contract NFTCultureCollectionBase is ERC1155Supply, Ownable {
    ...
    function claimPiecesInCollection(
        ...
        require(_getForgeComponent(nftcultTokenId) == forgeComponentId, 'Invalid forge component Id');
        require(_cultTokenClaimYield[forgeComponentId] > 0, 'Cult token not claimable');
        require(_cultTokenClaimsConsumed[nftcultTokenId] + count <= _cultTokenClaimYield[forgeComponentId], 'No claims remaining');
