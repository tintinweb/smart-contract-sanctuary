...
contract LootQuests is ERC721Enumerable, Ownable, ReentrancyGuard {

    //ERC721 loot = ERC721(0xFF9C1b15B16263C61d017ee9F65C50e4AE0113D7);
    ERC721 loot = ERC721(0x79E2d470f950f2Cf78eeF41720E8ff2cf4B3CD78);
    ...
    constructor() ERC721("Loot Quests", "LOOTQUESTS") Ownable() {}
    ...
    function questTokenUri(uint256 tokenId) internal view returns (string memory) {
        ...
        // TODO: Add attributes
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "', parts[1], '", "description": "Quests.", "attributes": [ { "trait_type": "Step 1", "value": "', actions[0], '" }, { "trait_type": "Step 2", "value": "', actions[1], '" }, { "trait_type": "Step 3", "value": "', actions[2], '" }, { "trait_type": "Step 4", "value": "', actions[3], '" } ], "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function actionTokenUri(uint256 tokenId) internal view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: black; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="white" /><text x="10" y="20" class="base" text-decoration="underline">';
