...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Legendary", "Magicly", "Unbelievable", "Thrilling", "Gorgeous", "Cringy"];
  string[] secondWords = ["Megan", "Alaine", "Bridget", "Mary", "Selena", "Nancy"];
  string[] thirdWords = ["Batman", "CatWoman", "Stark", "Ironman", "Princess", "Wizard"];
