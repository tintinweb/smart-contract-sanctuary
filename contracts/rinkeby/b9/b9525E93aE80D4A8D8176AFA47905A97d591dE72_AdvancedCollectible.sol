...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    mapping(uint256 => Breed) public _tokenIdToBreed;
    mapping(bytes32 => address) public _requestIdToSender;
    event requestedCollectible(bytes32 indexed requestId, address requester);
    event breedAssigned(uint256 indexed _tokenId, Breed _breed);
        ...
        override
    {
        ...
        address owner = _requestIdToSender[_requestId];
