...
// File @openzeppelin/contracts/utils/introspection/[email protected]3.3
...
contract PlatziPunks is ERC721, ERC721Enumerable, DNA {
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        require(_exists(tokenId), "ERC731 Metada: URI query for nonexistent token");
