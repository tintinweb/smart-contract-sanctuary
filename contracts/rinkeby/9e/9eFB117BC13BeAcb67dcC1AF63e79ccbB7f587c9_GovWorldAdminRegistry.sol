...
contract GovWorldAdminRegistry is GovWorldAdminBase {
    ...
    external
    {
        ...
        require(_newSuperAdmin != newSuperAdmin, 'already designated');
        require(msg.sender == newSuperAdmin,'not super admin');
    ...
    function isApprovedByAll(address _newAdmin) external view returns (bool) {
        ...
        if(allCount.div(2)+1 < presentCount)// standard multi-sig 51 % approvals needed to perform
            return true;
        else return false;
    }
        ...
        onlyEditGovAdminRole(msg.sender)
    {
        ...
        require(_admin != newSuperAdmin, "GAR: Cannot Remove Super Admin");
        ...
        onlyEditGovAdminRole(msg.sender)
    {
        ...
        require(_admin != newSuperAdmin, "GAR: Cannot Edit Super Admin");
...
interface IGovWorldAdminRegistry {
    ...
    // event SuperAdminAdded(address indexed _superAdmin, AdminAccess _adminAccess);
