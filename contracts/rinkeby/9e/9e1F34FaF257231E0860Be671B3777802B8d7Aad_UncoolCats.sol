...
contract UncoolCats is ERC721, ERC721Enumerable, Ownable {
    ...
    // use five separate addresses? 
    // team withdraw address
    address teamAddress = 0x78609F01FDcc87469E8bb3918dDe84f4AC17a644;

    constructor( string memory _initBaseURI) ERC721("UncoolCats", "UNCOOL") {
