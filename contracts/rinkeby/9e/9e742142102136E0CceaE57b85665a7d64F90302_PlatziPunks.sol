...
// File contracts/PlatziPunksDNA2.sol

 

pragma solidity >=0.8.4 <0.9.0;

contract PlatziPunksDNA2 {
...
pragma solidity >=0.8.4 <0.9.0;
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA2{  
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory)
    {
        ...
        string memory jsonURI = Base64.encode(abi.encodePacked('{ "name": "PlatziPunks #',
                tokenId,
