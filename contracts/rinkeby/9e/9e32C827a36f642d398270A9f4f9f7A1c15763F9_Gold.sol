...
contract Gold is ERC20, IGold, Ownable {
  ...
  function transferFrom(address sender, address recipient, uint256 amount) public virtual override(ERC20, IGold) disallowIfStateIsChanging returns (bool) {
