...
contract FeelineClub is ERC721Enumerable, Ownable {
    ...
    mapping(uint256 => uint256) private _userVals3;
    ...
    // Event called when userVal2 is changed
    event ChangeUserVal3(address caller, uint256 from, uint256 to);
    ...
    constructor() ERC721("FeelineClub", "FLC") {
        // Initial functionality for userValues will be disabled
    ...
    function setFeel(
        ...
        require(
            _userVal1 <= 99999999,
            "Invalid userVal1, must be a int between 0 and 99999999"
        );
        require(
            _userVal2 <= 99999999,
            "Invalid userVal2, must be a int between 0 and 99999999"
        );
        require(
            _userVal3 <= 99999999,
            "Invalid userVal3, must be a int between 0 and 99999999"
        );
     ...
     * @dev Gets the userVal2 value of a token
     */
    function getUserVal3(uint256 _tokenId) public view returns (uint256) {
        require(
            _allowUserValues == true,
            "Not allowed until supportsUserValues is enabled"
        );
        return _userVals3[_tokenId];
    }
