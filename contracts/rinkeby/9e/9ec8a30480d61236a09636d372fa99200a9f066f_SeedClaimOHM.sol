 ...
 *  This ensures that network ownership does not exceed predefined levels because the
 *  amount claimed increases with staking rewards, and claimants only receive the network
 *  margin of dilution once they have maxed their claims. This also penalizes sellers,
 *  since the balance sold is still considered staked within this contract. This is a strong 
 *  step taken to rebalance the exposure profile of seed investors and advisors. This change 
 *  is applied retroactively, effectively making it implemented from launch.
 */
