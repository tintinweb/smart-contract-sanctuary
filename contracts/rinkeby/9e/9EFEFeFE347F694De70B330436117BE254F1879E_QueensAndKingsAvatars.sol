...
contract QueensAndKingsAvatars is ERC721Upgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("Queens+KingsAvatars", "Q+KA");
        totalTokens = 6900;
        totalSupply = 0;
        latestExternalTokenId = totalTokens + 1;
     }
    ...
    function mintTraits(
        ...
        address recoveredWallet = ECDSAUpgradeable.recover(messageHash, _signature);
...
abstract contract ProtectedMint is OwnableUpgradeable {
...
interface ITrait is IERC721Upgradeable {
 ...
 * {ERC721Enumerable}.
 */
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable, ProtectedMint {
