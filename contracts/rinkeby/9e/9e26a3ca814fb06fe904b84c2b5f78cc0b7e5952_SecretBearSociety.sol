...
// File: NFTTokenContract.sol

pragma solidity ^0.8.0;

contract SecretBearSociety is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;

    uint256 public MAX_SUPPlY = 11111;
    uint256 public PRESALE_RESERVED = 1000;
    uint256 public MAX_ALLOWED = 20;
    uint256 public OWNER_RESERVED = 111;
    uint256 public price = 50000000000000000; //0.05 Ether
    string baseTokenURI;
    
    address owner_account1 = 0xBC63b1C975414EdB4eCAb0a8a4E8D3F74F1A4F57;
    address owner_account2 = 0x6421f1c2ec19EE63AAcbDA5BD7031202841AFf89;
    ...
    constructor(string memory baseURI) ERC721("Secret Bear Society", "SBS") {
        setBaseURI(baseURI);
    }
    ...
    function withdrawAll() public onlyOwner {
        ...
        (bool owner1_success, ) = owner_account1.call{value: (address(this).balance)/2}("");
        require(owner1_success, "Transfer failed.");
        
        (bool owner2_success, ) = owner_account2.call{value: (address(this).balance)}("");
        require(owner2_success, "Transfer failed.");
    }
    
    //Presale Mint NFT
    function presaleMintNFT(uint256 _count) public payable {
        if (msg.sender != owner()) {
            require((presaleOpen == true), "Presale is not open please try again later");
        ...
        require(balanceOf(msg.sender) < MAX_ALLOWED, "Maximum 20 NFTs allowed per account");
