...
contract Wemp is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    uint256 private _dTotal = 100000 * 10**9 * 10**18;
    ...
    event TransferOne(address indexed from, address indexed to, uint256 rvalue, uint256 tvalue);
    ...
    constructor () {
        ...
        emit TransferOne(address(0), _msgSender(), _rOwned[_msgSender()], _tOwned[_msgSender()]);
