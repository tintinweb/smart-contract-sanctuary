...
contract OrcBazaarZug{
    ...
    address zugAddress = _zug; ///0xEB468b1c73E8D0159C163E9F0D95ABBD0B20b616;
    ...
    function closeOfferingWithZug(bytes32 _offeringId) external {
        ...
        zug.transferFrom(msg.sender,offeringRegistry[_offeringId].offerer,sellerPayable);
