...
contract OnChainSeaside is ERC721, ERC721Enumerable, Ownable {
    ...
    function getSun(uint256 num) internal pure returns (string memory) {
     ...
     function tokenURI(uint256 tokenId) pure public override(ERC721)  returns (string memory) {
        ...
        parts[7] = '" d="M8087,687c-158,0-320-3.15-469-3 c-293,0-616,10-701,10c-261,0-600-17-809-17 c-118,0-246,11-376,11c-158,0-320-10-469-10 c-293,0-379,10-574,10c-195,0-331-11-540-11 c-118,0-246,11-376,11c-158,0-320-10-469-10 c-293,0-616,17-701,17c-261,0-600-12-809-12 c-118,0-246,12-376,12c-103,0-263-9-469-9 c-92,0-181,2-260,2c-171,0-304,0-362,0c-261,0-330-0-330-0 v525l9053-6V688C9039,688,8217,687,8087,687z"/> <animateMotion path="M 0 0 L -8050 20 Z" dur="10s" repeatCount="indefinite" /> </g> <g> <path xmlns="http://www.w3.org/2000/svg" fill="#'; // 3
        parts[8] = '" d="M8097,846c-158,0-319-7-470-7c-285,0-443,20-651,20 c-172,0-353-5-449-9c-101-4-247-20-413-20c-116,0-243,26-373,26 c-158,0-320-31-471-31c-285,0-352,36-560,36c-172,0-390-31-556-31 c-116,0-243,26-373,26c-158,0-320-31-471-31c-285,0-442,35-650,35 c-172,0-353-5-449-9c-101-4-247-20-413-20c-116,0-245,25-375,25 c-158,0-322-13-474-13c-107,0-197,2-277,3c-133,1-243,0-372,0 c-172,0-308-0-308-0v364h9053V846C9038,846,8227,846,8097,846z"/> <animateMotion path="M 0 0 L -8050 40 Z" dur="10s" repeatCount="indefinite" /> </g> <g> <polygon fill="#'; // 3
        parts[9] =  string(abi.encodePacked('" points="',getShip(params[0],params[1],0), '"/> <polygon opacity="0.2" fill="#')); // 3
        parts[10] = string(abi.encodePacked('" points="',getShip(params[0],params[1],1),'"/> <animateMotion path="m 0 0 h ',(params[1]==1 ? '':'-'),'5000" dur="20s" repeatCount="indefinite" /> </g>'));
        ...
        parts[13] = string(abi.encodePacked('" ',getSun(params[7]*2-1),'/> <circle fill="url(#SunGradient)" ',getSun(params[7]*2-2),'/>')); 
        ...
        string memory output = string(abi.encodePacked(parts[0],colors[1],parts[1],colors[2]));
         ...
         output = string(abi.encodePacked(output,parts[18],colors[1],parts[13]));
