...
contract PRNTRBUSDpoolFarming is Ownable {
    ...
    // LP Tokens / Farming tokens
    address public trustedDepositTokenAddress = 0x2Ea6B1FdAa3fb343a37930E856379545bE34D4d9;
    // Earned Tokens address
    address public trustedRewardTokenAddress = 0xeBdC557EBF858Ae8169ecA64726ac2D041aE4989; 

    // Amount of tokens
    uint public disburseAmount = 35000e18;
    // To be disbursed continuously over this duration
    uint public disburseDuration = 175 days;

    // If there are any undistributed or unclaimed tokens left in contract after this time
    // Admin can claim them
    // To change to 1 year
    uint public adminCanClaimAfter = 1 hours;
