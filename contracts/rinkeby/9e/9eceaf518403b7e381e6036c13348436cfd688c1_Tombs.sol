...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        return string(abi.encodePacked(base, Strings.toString(tokenId), '/', Strings.toString(tokenId), '.json'));
    }
...
contract Tombs is ERC721Tradable {
    ...
    function mintAll (uint256 _min, uint256 _max) external onlyOwner {
    ...
    function settTaxAddress (address payable _taxAddress) external onlyOwner {
    ...
    function setMin (uint256 _mix) external onlyOwner {
        min = _mix;
    }
