...
library ShapeArtGenerator{
   ...
   function getShape(uint256 tokenId,uint256 i) internal pure returns(uint256){
    ...
    function makeShapeFactory(uint256 tokenId) internal pure returns(string memory){
        string[20] memory shapecolors=["#C46D5E", "#4D9078", "#F9DB6D", "#966B9D", "#79C7C5", "#B7B361", "#DBBBF5", "#C6EBBE", "#D3C1C3", "#ADE1E5", "#F26419", "#C98686", "#D64933", "#BA4848", "#399252", "#5D9D63", "#BEB947", "#BAF2D8", "#989A1F", "#41A39D"];
        ...
        string[6] memory colors=["#FFB563", "#FFFFFF", "#326273", "#000000", "#FFD151", "#A5243D"];
