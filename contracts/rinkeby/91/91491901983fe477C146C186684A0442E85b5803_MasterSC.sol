...
contract MasterSC is Initializable, OwnableUpgradeable {
  ...
  function createTokenERC20(
    ...
    require(msg.value >= config.getFees(_keyTypes), "ERC20:Not enough value");
  ...
  function createTokenERC777(
    ...
    require(msg.value >= config.getFees(_keyTypes), "ERC777:Not enough value");
  ...
  function createTokenERC721(
    ...
    require(msg.value >= config.getFees(_keyTypes), "ERC721:Not enough value");
  ...
  function createTokenERC1155(
    ...
    require(msg.value >= config.getFees(_keyTypes), "ERC1155:Not enough value");
  ...
  function createBlockRewardFarmingPool(
    ...
    require(
      msg.value >= config.getFee(_keyType),
