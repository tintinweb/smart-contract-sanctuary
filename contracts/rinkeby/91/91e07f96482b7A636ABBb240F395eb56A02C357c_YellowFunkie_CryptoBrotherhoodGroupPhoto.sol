...
/**
 * @title YellowFunkie_CryptoBrotherhoodGroupPhoto
 * YellowFunkie_CryptoBrotherhoodGroupPhoto - a contract for my non-fungible creatures.
 */
contract YellowFunkie_CryptoBrotherhoodGroupPhoto is ERC721Tradable {

	constructor(address _proxyRegistryAddress)
        ERC721Tradable("YellowFunkie_CryptoBrotherhoodGroupPhoto", "YFCB-GROUP", _proxyRegistryAddress, 121, "api/group/")
    {
	}
...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
   ...
   */
	...
	function getSpecialMintAddress() public onlyOwner view returns (address){	
		return nftSpecialMintAddress;
	}
	
	function factoryMintNFT(address _toAddress) public {
		require(msg.sender == nftSpecialMintAddress);
