...
contract Ownable is Context {
    address private _owner = 0xe9354e4F4c9616A8C94De612DDbC7e7290a262CD;
...
contract questionmark is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xEbF0C5f50C8aaea52057345D866692dD4625F4Bc); // Marketing Address
    address payable public _burnAddress = payable(0xEbF0C5f50C8aaea52057345D866692dD4625F4Bc); // Burn Address
    ...
    uint256 public _minTokensSwapToAndTransferTo = 20000 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(50); // Max number of tokens that an address can hold 5% of total supply
