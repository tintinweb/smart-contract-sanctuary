...
contract BearXNFTStaking is OwnableUpgradeable{
    ...
    function initialize() public initializer{
        __Ownable_init();
        BearXNFTAddress = 0x2D0da5ab2cf0A5c9922075410EE7E7c67EA890b5;
        ROOTxTokenAddress = 0x3DE15D494A2478868d9555EaA2d8D72e28B845C8;
        SROOTxTokenAddress = 0x8abB8688905C26374cAb862e110F67a83FFc514b;
        totalStakes = 0; 
        MaxSROOTXrate = 100*10**18;
        MinSROOTXrate = 50*10**18;
        MaxRate = 11050*10**18;
    ...
    function getTestValues () public view returns(uint256, uint256) {
        return(test1, test2);
    }
    ...
    function setmaxprovision() public {
        // maxprovision = maxprovision.add(maxprovision);
        maxprovision = 6000;
    }
    ...
    function isSpecialBear(uint256 _id) internal pure returns(bool) {
        if(_id >= 10000000000000) return true;
        else if(_id <=10000000000005) return true;
        else return false;
    }
