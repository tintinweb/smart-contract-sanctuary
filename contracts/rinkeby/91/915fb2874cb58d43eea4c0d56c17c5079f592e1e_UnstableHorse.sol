...
library SafeMath {
    ...
    // uint public total_No_Horses = 9800;
...
contract UnstableHorse is ERC721URIStorage {
    ...
    address payable fundWallet = payable(0x1dE9CfD2c41c84d202309dda4285616583FB56fD);  
    string private baseUri = "https://gateway.pinata.cloud/ipfs/QmTyGF89MvPoVEYFFDoUgDrA6H7V9dnLqKfcdD7rnpFYKm/";
    string private FarmJuice_baseUri = "https://goatz.mypinata.cloud/ipfs/QmcW6JUUM37WN3kDggeVpBqhm8VRo8gBdL5YUtDGAu9qNq/373";



    constructor() ERC721("The Unstable Horses Yard", "TUHY") {
        owner = msg.sender;
    }
    ...
    // constructor(address _fundWallet, string memory _baseUri, string memory _FarmJuice_baseUri) ERC721("The Unstable Horses Yard", "TUHY") {
