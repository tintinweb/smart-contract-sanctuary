...
contract MarbleMarket is Ownable {
    ...
    function executeTrade(uint256 _trade) public virtual {
        ...
        uint256 marketCut = (trade.price / 1000) * cutPerThousand;
        uint256 received = trade.price - marketCut;

        currencyToken.transferFrom(msg.sender, owner(), marketCut);
        currencyToken.transferFrom(msg.sender, trade.poster, received);
    ...
    function updateCut(uint256 _newCutPerThousand) public virtual onlyOwner {
        require(_newCutPerThousand >= 0 && _newCutPerThousand <= 100, "Trade cut can only be between 0% and 10%");
        cutPerThousand = _newCutPerThousand;
    }
