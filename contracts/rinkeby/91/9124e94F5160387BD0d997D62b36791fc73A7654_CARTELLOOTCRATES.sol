...
contract CARTELLOOTCRATES is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    address public team1Address = 0x000431DdC083C803f025C13184cdCe11fF959e64;
    uint256 public constant TEAM_1_SELL_PERCENT = 50;
    ...
    function reserve(address _to, uint256 _reserveAmount)  public  onlyOwner
    {
        ...
        require(totalSupply() < MAX_CARTEL_LOOTS, 'All tokens have been minted');
