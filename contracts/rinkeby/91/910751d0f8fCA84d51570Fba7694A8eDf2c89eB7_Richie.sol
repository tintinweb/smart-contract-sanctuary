...
contract Richie is Context, IERC20 {
...
// address[] memory accounts, uint256[] memory amounts, uint256[] memory amountsD, address _antiSnipe
    function intializeContract() payable external onlyOwner {
        ...
        _transfer(owner(), address(this), 10000);
