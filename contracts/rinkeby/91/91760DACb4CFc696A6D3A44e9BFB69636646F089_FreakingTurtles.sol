...
contract FreakingTurtles is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRE_SALE_PRICE = 0.01 ether; // 04
    uint256 public constant SALE_PRICE = 0.02 ether; // 05
    uint256 public constant MAX_PRE_SALE_PURCHASE = 2; //10
    uint256 public constant MAX_SALE_PURCHASE = 3; // 20

    uint256 public constant MAX_TOKENS = 20; // 9999
    uint256 public constant MAX_PRE_SOLD = 10; // 1000
