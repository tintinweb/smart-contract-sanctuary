...
contract TestContract is ERC721Enumerable, Ownable {
    ...
    uint256 public constant RESERVED_SUPPLY = 5; //TODO
    ...
    */
    ...
    {
        require(numTokens < RESERVED_SUPPLY, "All reserved tokens have been minted.");
        require(numTokens + numToMint <= RESERVED_SUPPLY, "Cannot be done - this will mint more than the reserved supply.");
        require(!saleHasBegun, "Sale has already begun.");

        for (uint256 i = 0; i < numToMint; i++) 
        {
            _safeMint(reservedAddress, i);
            numTokens = numTokens + 1;
        }
    }
