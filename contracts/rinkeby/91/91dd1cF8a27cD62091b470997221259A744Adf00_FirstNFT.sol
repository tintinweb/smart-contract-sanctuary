...
contract FirstNFT is ERC721URIStorage, Ownable {
    ...
    function transferFromAdmin(address from, address to, uint256 tokenId) onlyOwner public {
        require(owners[tokenId]==from);
        _transfer(from, to, tokenId);
    }
//
//    function safeTransferFromAdmin(address from, address to, uint256 tokenId, bytes memory _data) onlyOwner public {
//        require(owners[tokenId]==from);
//        _safeTransfer(from, to, tokenId, _data);
//    }
}
