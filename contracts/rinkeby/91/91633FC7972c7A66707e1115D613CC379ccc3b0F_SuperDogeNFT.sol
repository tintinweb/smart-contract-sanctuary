    ...
    ReentrancyGuard
{
    ...
    string public baseURI = "https://web3.superdoge.io/api/";
    bool public saleIsActive;

    uint256 public price = 0.07 ether;
    uint256 public constant maximumSupply = 10000;
    address[] private treasuryWallets = [
        0x7103125F7Bc298690Cb89c7480F998D4C4E6b304,
        0x1D412Fe758Ea100F70000c69Ee6418f2e78902e0
    ];
    ...
    function withdrawAll() public onlyOwner {
        for (uint256 i = 0; i < treasuryWallets.length; i++) {
            address payable wallet = payable(treasuryWallets[i]);
            release(wallet);
        }
    }
