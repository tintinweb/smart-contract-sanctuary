...
contract MedievalNFT is Initializable, ERC721Upgradeable, MedievalAccessControlled, VRFConsumerBaseUpgradable{
    ...
    function initialize(
        ...
        _setControlCenter(_controlCenter, tx.origin); // TODO use tx.origin?
    ...
    function setName(uint256 tokenId, string calldata name) public {
        require(ownerOf(tokenId) == msg.sender, "Not NFT Owener!");
    ...
    function upgradeLevel(uint256 upgradeTokenId, uint256[] calldata materialTokenIds) external {
        ...
        for(uint256 i=0; i < materialTokenIds.length; i++){
            ...
            // TODO upgrade with the same occupation?
            require(occupation == tokenOccupation[tokenIdToBurn]);
