    ...
    function oniTest(uint256[] calldata tokens) public onlyOniOwner(tokens) {
      ...
      if(tokens.length < 2) {
         ...
         if(currentRound == 1 && checkOniLevel(tokens, 0)) {
             // round 1
             require(tokens.length == 2, '[ROUND 1] require 2 Oni on level 1');
         ...
         if(currentRound == 2) {
             ...
             if(checkOniLevel(tokens, 2)) {
                 require(tokens.length == 2, '[ROUND 2] require 2 Oni on level 2');
                 _batchUpdate(tokens, 1);
             } 
             if (checkOniLevel(tokens, 0)) {
                 require(tokens.length == 4, '[ROUND 2] require 4 Oni on level 1');
         ...
         if(currentRound == 3) {
             ...
             if(checkOniLevel(tokens, 3)) {
                 require(tokens.length == 2, '[ROUND 3] require 2 Oni on level 3');
                 _batchUpdate(tokens, 1);
             }
             if(checkOniLevel(tokens, 2)) {
                 require(tokens.length == 4, '[ROUND 3] require 4 Oni on level 2');
                 _batchUpdate(tokens, 2);
             }
             if(checkOniLevel(tokens, 0)) {
                 require(tokens.length == 8, '[ROUND 3] require 8 Oni on level 1');
