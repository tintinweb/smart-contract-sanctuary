...
contract EscrowForAragonCourtV1 is EscrowContract, AmendablePreSigned, WithPreSignedMilestones {
     ...
     */
    constructor(address _registry, address _arbiter, address _disputeManager) EscrowContract(_registry) {
    ...
    function dispute(bytes32 _cid, uint8 _index, bytes calldata _evidence) external isDisputer(_cid) {
        ...
        emit DisputeWitnessed(_cid, _index, _evidence);
    }
    ...
    function appealDispute(
        ...
        require(_feeToken.transferFrom(msg.sender, address(this), _appealFee), ERROR_APPEAL_PAY_FAILED);
    ...
    function confirmAppealDispute(
        ...
        require(_feeToken.transferFrom(msg.sender, address(this), _confirmAppealFee), ERROR_APPEAL_PAY_FAILED);
    ...
    function resolveDispute(bytes32 _cid, uint8 _index) external {
        ...
        if (_ruling == RULE_PAYER_WON) {
            ...
            emit DisputeCompleted(_cid, _index, _ruling);
