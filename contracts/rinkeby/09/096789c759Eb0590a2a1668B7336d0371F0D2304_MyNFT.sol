...
/*
  ...
  (IERC721Metadata) as well as a mechanism for per-token metadata. 
  That’s where the _setTokenURI method comes from: we use it to store an item’s metadata.
 */

contract MyNFT is ERC721URIStorage {
    string public constant TOKEN_URI =
        "https://gateway.pinata.cloud/ipfs/QmaRtw77ATMCk8M2AgGEbdLbPEnwbrXTtM2SMPwW4iPJ5b";
    ...
    constructor() ERC721("LigmaNFT", "LIGMA") {
        console.log("This is my contract");
    }

    // mint function
    function mintLigma() public {
