...
contract ArchiSwapTokenFeed is IFeed {
    ...
    constructor(IArchiSwapOracle _archiSwapOracle, IFeed _ethFeed, address _inputToken, address _outputToken) public {
    ...
    function latestAnswer() public view returns (uint) {
        (uint tokenEthPrice, ) = archiSwapOracle.current(inputToken, 1e18, outputToken);
