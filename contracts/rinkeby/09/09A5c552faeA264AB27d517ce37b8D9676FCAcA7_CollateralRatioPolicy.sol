...
contract CollateralRatioPolicy is Ownable, Constants, ICollateralRatioPolicy, Initializable {
    ...
    /**
     * @dev Initializes contract's public variables with constant values.
     */
    constructor() {
        ...
        price_target = 1 * PRICE_PRECISION; // = $1. (6 decimals of precision). Collateral ratio will adjust according to the $1 price target at genesis
        price_band = 5000;
    }

    /**
     * @dev Sets up treasury and dollar smart contracts addresses. Can be called only by the owner.
     * @param _treasury Address of the treasury smart contract.
     * @param _dollar Address of the dollar smart contract.
     */
    ...
    /**
     * @dev Computes and returns effective collateral ratio (ECR).
     *
     * Note, will return `target_collateral_ratio` if `using_effective_collateral_ratio` is set to `false`.
     */
    function calcEffectiveCollateralRatio() public view returns (uint256) {
        ...
        uint256 global_collateral_value = ITreasury(treasury).globalCollateralValue();
        uint256 global_share_value = ITreasury(treasury).globalShareValue();
        uint256 ecr = global_collateral_value * RATIO_PRECISION / (global_collateral_value + global_share_value);
    ...
    /**
     * @dev Refreshes target collateral and effective collateral ratios.
     *
     * Reverts if `collateral_ratio_paused` is set to `true`. Also, reverts if not enough time has passed from last refreshment.
     */
    ...
    /**
     * @dev Sets ratio step. Can be called only by the owner.
     * @param _ratio_step New ratio step value.
     */
    ...
    /**
     * @dev Sets price target. Can be called only by the owner.
     * @param _price_target New price target value.
     */
    ...
    /**
     * @dev Sets refresh cooldown. Can be called only by the owner.
     * @param _refresh_cooldown New refresh cooldown value.
     */
    ...
    /**
     * @dev Sets price band. Can be called only by the owner.
     * @param _price_band New price band value.
     */
    ...
    /**
     * @dev Sets Dollar smart contract's address. Can be called only by the owner.
     * @param _dollar Address of Dollar smart contract.
     *
     * Reverts if `_dollar` is zero address.
     */
    ...
    /**
     * @dev Use this to retstore collateral ratios incase of using new Treasury. Can be called only by the owner.
     * @param _target_collateral_ratio New TCR value.
     * @param _effective_collateral_ratio New ECR value.
     */
    ...
    /**
     * @dev Pauses/unpauses using of collateral ratios. Can be called only by the owner.
     */
    ...
    /**
     * @dev Pauses/unpauses using of effective collateral ratio. Can be called only by the owner.
     */
    ...
    /**
     * @dev Sets new Dollar oracle smart contract's addresss. Can be called only by the owner.
     * @param _oracleDollar Address of Dollar oracle smart contract.
     */
