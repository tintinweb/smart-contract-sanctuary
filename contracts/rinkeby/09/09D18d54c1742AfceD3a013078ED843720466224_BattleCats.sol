...
contract BattleCats is ERC721Enumerable, Ownable {
  ...
  uint256 public setMaxMintAmountPerTxn = 20; // this is max limit per transaction
  uint256 public maxMintAmountPresalePerWallet = 20; // this is for per wallet limit during presale
    ...
    returns (string memory)
  {
    ...
    function addOneToFreeMint(address _address)
        external
        onlyOwner
        {
            require(
                ...
                if (_giftFreeMint[_address] == false) {
                    _giftFreeMint[_address] = true;
                }
        }
...
//   add extra function to add few addresses
