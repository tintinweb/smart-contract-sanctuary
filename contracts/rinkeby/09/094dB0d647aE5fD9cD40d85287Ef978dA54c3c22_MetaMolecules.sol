...
// File: MetaMolecules.sol

contract MetaMolecules is Ownable, ERC721 {
    uint256 public constant maxMoleculeSupply = 10;
    uint256 public tokenCounter;
    // TODO: move price value to .env
    uint256 public tokenPrice = 6 * 10**16;
    // TODO: move baseMoleculesURI to .env
    string public _baseURI = "QmdA15fBPHYUif1Nnf7ykiT4Dsm8V4spU98kdEcaDTcxVW";
    ...
    constructor() public ERC721("MetaMolecules", "MMOL") {}
        ...
        returns (string memory)
    {
        ...
        // If both are set, concatenate the baseURI and tokenURI (via abi.encodePacked).
        if (bytes(_tokenURI).length > 0) {
            return string(abi.encodePacked("ipfs://", base, "/", _tokenURI));
        }
        // If there is a baseURI but no tokenURI, concatenate the tokenID to the baseURI.
        return
            string(abi.encodePacked("ipfs://", base, "/", tokenId.toString()));
    }
}