...
contract DropspaceSale is IDropspaceSale, ERC721, Ownable {
    ...
    bool public override saleActive = saleActive || (saleTime >= block.timestamp);
    bool public override presaleActive = whitelistSaleActive || (presaleTime >= block.timestamp);
    bool public override whitelistSaleActive = presaleActive || (saleTime >= block.timestamp);
    ...
    uint256 public presaleTime = 2**256 - 1;
    uint256 public whitelistSaleTime = 2**256 - 1;
    uint256 public saleTime = 2**256 - 1;
    ...
    function setPresaleTime(uint256 _whitelistSaleTime) external override onlyOwner {
        whitelistSaleTime = _whitelistSaleTime;
    }
    
    function setWhitelistSaleTime(uint256 _whitelistSaleTime) external override onlyOwner {
        whitelistSaleTime = _whitelistSaleTime;
    }

    function setSaleTime(uint256 _whitelistSaleTime) external override onlyOwner {
        whitelistSaleTime = _whitelistSaleTime;
    }
...
interface IDropspaceSale {
    ...
    function setPresaleTime(uint256 _whitelistSaleTime) external;
    function setWhitelistSaleTime(uint256 _whitelistSaleTime) external;
    function setSaleTime(uint256 _whitelistSaleTime) external;
