    ...
    function _moveDelegates(address srcRep, address dstRep, uint256 amount) internal {
        if (srcRep != dstRep && amount > 0) {
            ...
            if (dstRep != address(0)) {
                ...
                uint256 srcRepOld = dstRepNum > 0 ? checkpoints[dstRep][dstRepNum - 1].votes : 0;
                uint256 dstRepNew = srcRepOld.add(amount);
                _writeCheckpoint(dstRep, dstRepNum, srcRepOld, dstRepNew);
            }
        }
    }
