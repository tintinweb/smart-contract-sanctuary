...
contract ANoobs is Ownable, ERC721A, ReentrancyGuard {
  ...
  mapping(address => uint256) public whitelist;
    ...
    uint256 maxBatchSize_ = 2;
    uint256 collectionSize_ = 10;
    uint256 amountForAuctionAndDev_ = 8;
    uint256 amountForDevs_ = 2;

  constructor() ERC721A("ANoobs", "NOOB", maxBatchSize_, collectionSize_) {
  ...
  function whitelistMint() external payable callerIsUser {
    ...
    require(price != 0, "not in the whitelist time");
  ...
  uint256 public constant AUCTION_END_PRICE = 0.007432 ether;
  uint256 public constant AUCTION_PRICE_CURVE_LENGTH = 17 minutes;
