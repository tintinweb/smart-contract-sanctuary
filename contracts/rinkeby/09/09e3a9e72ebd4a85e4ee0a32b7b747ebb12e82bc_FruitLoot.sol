...
contract FruitLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    string[] private fruits = ["Kiwi", "Banana", "Orange", "Apple"];
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Basket #',
                        toString(tokenId),
                        '", "description": "Fruit Loot is a riff on loot. Feel free to use Fruit Loot in any way you want.", "image": "data:image/svg+xml;base64,',
