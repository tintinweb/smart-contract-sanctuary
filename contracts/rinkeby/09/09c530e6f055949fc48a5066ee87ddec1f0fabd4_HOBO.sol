...
contract HOBO is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable{
    ...
    event MintHOBO(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("The Hobbos", "HOBO") {
		setBaseURI(baseURI);
        pause(true);
    }
    ...
    function _mintAnElement(address _to) private {
        ...
        emit MintHOBO(_tokenIdTracker.current());
    }
