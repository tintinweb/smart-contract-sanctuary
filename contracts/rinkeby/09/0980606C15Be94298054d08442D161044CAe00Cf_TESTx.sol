...
contract TESTx is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    constructor (
        ...
        IUniswapRouter02 _uniswapRouter = IUniswapRouter02(address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D));
    ...
    function calculateETHReward(
        ...
        uint256 reward = ethPool.mul(multiplier).mul(currentBalance).div(100).div(ttlSupply);
