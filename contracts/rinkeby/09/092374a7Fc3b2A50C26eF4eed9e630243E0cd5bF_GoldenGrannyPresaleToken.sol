...
contract GoldenGrannyPresaleToken is ERC1155, Ownable, Pausable {
    ...
    constructor() ERC1155("https://staging.goldengrannys.com/api/presale-metadatas/{id}-metadatas.json") {
    }
    ...
    function mintPublicFlag(uint256 tokenId) payable public whenNotPaused {
        ...
        require(
            ...
            "Only one presale token per holder"
        );
