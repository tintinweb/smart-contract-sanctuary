    ...
    return
      string(
        abi.encodePacked(
          ...
          color,
          '" stroke-width="5px" /><text text-anchor="end" x="340" y="20" class="base">#',
          uint2str(tokenId),
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            getName(tokenId),
            '", "description": "Monsters are randomized forgotten beasts generated and stored on chain. Slay them if you can - with the right Loot! Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Monsters in any way you want.", "image": "data:image/svg+xml;base64,',
