...
contract TestZZZ is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x857Edb0ACC9D9Eef5cff9ce3280ac121928b8B50;

    constructor(string memory baseURI) ERC721("TestZZZ", "TestZZZ")  {
        setBaseURI(baseURI);
    }
    ...
    function adopt(uint256 num) public payable {
        ...
        require( num < 6,                              "You can adopt a maximum of 20 Cats" );
