...
contract NFTID is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getText(uint256 tokenId) public view returns (string memory) {
        return _users[tokenId].text;
    }
    
    function getHover(uint256 tokenId) public view returns (string memory) {
        return _users[tokenId].hover;
    }
    
    function getMain(uint256 tokenId) public view returns (string memory) {
        return _users[tokenId].main;
    }
    
    function getRole(uint256 tokenId) public view returns (string memory) {
        return _users[tokenId].role;
    }
    
    function getHead(uint256 tokenId) public view returns (string memory) {
        return _users[tokenId].head;
    }
    
    function getBody(uint256 tokenId) public view returns (string memory) {
        return _users[tokenId].body;
    }
    ...
    function claim(uint256 tokenId, string memory name, string memory motto) public nonReentrant {
