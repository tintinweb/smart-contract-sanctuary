...
contract Packz is ERC721, ERC721Burnable, ERC721Enumerable, Ownable, PaymentSplitter {
  ...
  function setPrivateSeed(bytes32 privateSeed) public onlyOwner {
    _traitz.setPrivateSeed(privateSeed);
  }

  function setTraitzBaseURI(string memory traitzBaseURI) public onlyOwner {
    _traitz.setBaseTokenURI(traitzBaseURI);
  }

  function setPackzURI(string memory packzURI) public onlyOwner {
    _packzURI = packzURI;
  }
