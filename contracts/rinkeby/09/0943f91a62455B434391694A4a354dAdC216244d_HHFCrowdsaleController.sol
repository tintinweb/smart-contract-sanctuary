...
// File @openzeppelin/contracts/crowdsale/emission/[email protected]
...
// File @openzeppelin/contracts/crowdsale/distribution/[email protected]
...
// File @openzeppelin/contracts/payment/escrow/[email protected]
...
contract HHFCrowdsaleController is Crowdsale, AllowanceCrowdsale, TimedCrowdsale, RefundableCrowdsale, RefundablePostDeliveryCrowdsale {

    constructor(
        uint256 openingTime,      // opening time in unix epoch seconds
        uint256 closingTime,      // closing time in unix epoch seconds
      //uint256 initialRate,      // variable rate minimum value
      //uint256 finalRate,        // variable rate maximum value
        uint256 goal,              // goal for the refundable contract
        uint256 rate,             // rate, in TKNbits
        address payable wallet,   // wallet to send Ether
        address tokenWallet,      // Token allowance from this wallet
        IERC20 token             // the token smc address
    )
