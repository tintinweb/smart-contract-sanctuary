...
contract Climate is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = 0xf80Db887DB0658255aDDeD259909094c6eb586A2; // Charity Address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swapTokensForEth(charityAlloc); 
        // _tDonationTotal = _tDonationTotal.add(address(this).balance);
        // TransferCharityETH(charityAddress, address(this).balance);
        // uint256 initialBalance = address(this).balance;
        // swapTokensForEth(liquidityAlloc.div(2));
        //  uint256 newBalance = address(this).balance.sub(initialBalance);
        // _tLiquidityTotal = _tLiquidityTotal.add(newBalance);
        // addLiquidity(liquidityAlloc.div(2),newBalance);
    }
