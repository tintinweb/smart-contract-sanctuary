...
contract Anthromancer is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    uint256 public blockInterval = 12; //About 6500 Blocks in a day per Etherscan data, 23 Blocks set for Test, ~5mins
   ...
   function mintLateHymn(uint hymnNumber)payable public {
      require (blockInterval > (idToHymn[hymnNumber]._hymnEndBlock - block.number), "This Hymn has not yet Dropped."); //REQUIRE that the current block number is greater than the End Block of the Hymn being requested for Mint 
