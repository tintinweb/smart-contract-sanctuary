...
interface IMAHA is IERC20, IAnyswapV4Token {
    function poolMint(address who, uint256 amount) external;
...
//to implement once solid struture is there
...
_MAHA.poolBurnFrom(msg.sender, _amount);
_ARTH.poolMint(address(this), arthTotalValue);
_ARTH.transfer(fund, feesValue);
_ARTH.transfer(msg.sender, toMint);
