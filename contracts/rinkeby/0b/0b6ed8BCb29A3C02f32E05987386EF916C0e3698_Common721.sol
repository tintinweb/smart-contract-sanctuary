 ...
 */
contract Common721 is  Token721 {
  constructor(
    string memory _name,
  ...
  function baseTokenURI() override public pure returns (string memory) {
    return "https://api.nftsky.io/api/v1/";
  }
...
abstract contract Token721 is ContextMixin, ERC721URIStorage, NativeMetaTransaction, Ownable {
    ...
    function tokenURI(uint256 _tokenId) override(ERC721URIStorage) public pure returns (string memory) {
    ...
    function burn(uint256 tokenId) public virtual {
        //solhint-disable-next-line max-line-length
        require(_isApprovedOrOwner(_msgSender(), tokenId), "Token721: caller is not approved");
        _burn(tokenId);
    }
