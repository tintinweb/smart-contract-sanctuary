...
contract Comp is ERC721, Ownable{
    ...
    mapping (address => int256) private _giftContract;
...
[5,9,10,10,9,9,9,0,0]
    ...
    // random contract
    address  public randomContract= address(0xABa31c041E916e4141036F080B554D40Cdb2BCD0);
    address private _nmtContractAddress = address(0x4373A302B3Fd99d91E9eF540f200FdCd856Fbb73);
...
//    address  public NMTERC20Contract= address(0xd742C20DDe8474f74026df193AA12f26f96e3e65);
    ...
    */
    constructor() ERC721("Chinese Opera Mask Plus","COMP"){
        ...
        //NMT
        _giftContract[_nmtContractAddress]=-1;

        //CryptoPunks
        _giftContract[0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB]=1;
        //Bored Ape Yacht Club
        _giftContract[0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D]=1;
        //Bored Ape Kennel Club
        _giftContract[0xba30E5F9Bb24caa003E9f2f0497Ad287FDF95623]=1;
        //Art Blocks Curated
        _giftContract[0xa7d8d9ef8D8Ce8992Df33D8b8CF4Aebabd5bD270]=1;
        //Cool Cats NFT
        _giftContract[0x1A92f7381B9F03921564a437210bB9396471050C]=1;
        //Hashmasks
        _giftContract[0xC2C747E0F7004F9E8817Db2ca4997657a7746928]=1;
        //ZED RUN
        _giftContract[0xA5F1Ea7DF861952863dF2e8d1312f7305dabf215]=1;
    ...
    */
    function mint(string memory luckyData,address giftContractAddress) public{
        ...
        if(tokenId>100){
            ...
            int256  target = _giftContract[giftContractAddress];
