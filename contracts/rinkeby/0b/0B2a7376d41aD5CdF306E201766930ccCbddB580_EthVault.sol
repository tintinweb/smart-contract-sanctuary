...
contract EthVault is Vault {
    ...
    constructor(IERC20Detailed underlying_, IERC20 reward_, address harvester_, string memory name_, string memory symbol_, IUniswapRouter router_)
        Vault(underlying_, reward_, harvester_, name_, symbol_, router_) {}
    ...
    function withdrawETH(uint amount) external {
        ...
        uint received = swap(amount, address(underlying), address(_weth), address(this));

        console.log("RECEIVED:");
        console.log(received);

        _weth.withdraw(received);
...
contract Vault is Ownable, Pausable, DividendToken {
    ...
    function swap(uint amount, address from, address to, address depositAddress) internal returns (uint) {
        ...
        console.log("swapExactTokensForTokens Amount: ");
        console.log(amount);
        console.log("swapExactTokensForTokens Amount Out: ");
        console.log(amountOut);
        console.log("swapExactTokensForTokens Min: ");
    ...
    function withdraw(uint amount) public {
        ...
        _weth.safeTransfer(msg.sender, received);
    }
