...
contract SolarNFT is ERC721, ERC721Enumerable, Ownable {
    uint256 public constant MAX_SUPPLY = 8888;
    uint64[10] public PRICE = [
      0.05 ether,
      0.096 ether,
      0.138 ether,
      0.172 ether,
    ...
    address payable marketing = payable(0x556F4d365F610aCa3DDA579b79686558509Af5cf);
    uint256 marketingFraction = 900;

    string private URI = "";

    constructor() ERC721("Solar", "SOL") {}
    ...
    function mint(address to, uint256 amount) external payable {
        ...
        require(msg.value >= PRICE[amount - 1], "Incorrect ETH");
