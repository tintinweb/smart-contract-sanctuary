...
contract StETHSubRouter is ISubRouter, SushiswapSwaps, Ownable {

    IVaultTransfers public stethHiveVault;
    IVotingStakingRewards public votingStakingRewards;
    ICurveStETHStableSwap public curveStETH; // 0xDC24316b9AE028F1497c275EB9192a3Ea0f67022
    IERC20 public curveStETHLpToken;

    address public xbe;
    address public usdc;
    address public steth; // 0xae7ab96520de3a18e5e111b5eaab095312d7fe84

    uint256 public stETHIndexInStableSwapPool;
    ...
    {
        transferOwnership(_easyXBERouter);
        xbe = _xbe;
        steth = _steth;
        usdc = _usdc;
        ...
        returns(uint256)
    {
        ...
        TransferHelper.safeApprove(steth, address(curveStETH), tokensReceived);
        uint256[2] memory amounts;
        amounts[stETHIndexInStableSwapPool] = tokensReceived;
        uint256 curveStETHtLpAmount = curveStETH.add_liquidity(
            amounts,
            params.minAmountLP
        );
        ...
        stethHiveVault.depositFor(curveStETHtLpAmount, params.recipient);

        return curveStETHtLpAmount;
    }
