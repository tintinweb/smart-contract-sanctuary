...
contract MintTicket is ERC721Enumerable, Ownable {
    ...
    address developerAddress = 0x5aaA4a97f7128a52eA0f7aDca1E9677b995ab446;
    address creatorOne = 0x04091c6f16516Aa55f2c61Ac9A3dA31df2c47DBe;
    address creatorTwo = 0x3AE9EC1E62d60a55E5F7f6d457aE36BF428e37C0;
    uint256 maxSupply = 10000;
    uint256 maxPerTX = 0;
    uint256 cost = 0.06 ether;
    ...
    constructor (
        ...
        string memory _givenTicketName,
        string memory _givenTicketSymbol
    ) ERC721(_givenTicketName, _givenTicketSymbol) {
    ...
    modifier checkSetup{
        ...
        require(creatorTwo!=address(0), "Treasury address not set");
        require(saleConfig.startTime !=0, "Sale start time not set yet");
        require(saleConfig.endTime != 0, "Sale end time not set yet");
        require(saleConfig.initialMintMax > 0, "Max per transaction not yet set");
        _;
    }
    ...
    function isWl(address check) public view returns(bool) {
        return wl[check];
    }
    ...
    function mint(uint256 _amnt) public payable{
        ...
        require(paused == false, "Mint is not live yet");
    ...
    bool _presaleAvailable) public onlyOwner {
        ...
        uint32 _uin32MaxPerWallet = _maxPerWallet.toUint32();
        saleConfig = saleConf({
            ...
            maxPerWallet: _uin32MaxPerWallet,
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(creatorOne, balance.mul(45).div(100));
        _widthdraw(creatorTwo, address(this).balance);
    }
