...
contract SlotiesPublicSale is Ownable {
    ...
    mapping(address => uint256) public whaleAddressToNonce;

    /** Phase 3 */
    bool public phaseThreeActive = false;
    uint256 public constant phaseThreeMaxSupply = 50;
    uint256 public constant phaseThreeMaxTicketsPerUser = 10; 
    uint256 public constant phaseThreeTicketPrice = 0.000008 ether; // 0.08 ether    

    uint256 public phaseThreeTicketSales = 0;
    ...
    /** Events */
    event SetSlotiesNFT(address _slotieNFT);
    ...
    function whaleBuyTicket(uint256 amount, uint256 nonce, bytes memory signature) external payable {
        require(phaseThreeActive, "PHASE THREE NOT ACTIVE");

        require(whaleAddressToNonce[msg.sender] == nonce, "INCORRECT NONCE");
        ...
        whaleAddressToNonce[msg.sender] = whaleAddressToNonce[msg.sender].add(1);
    ...
    function mintSloties() external {
        ...
        slotiesNFT.mintTo(toMint, msg.sender);
