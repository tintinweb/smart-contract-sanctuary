...
interface ILQTYStaking {
    ...
    event WETHAddressChanged(address _wethTokenAddress);
...
interface ILUSDToken is IERC20, IERC2612 { 
    ...
    event TroveManagerAddressRemoved(address _troveManagerAddress);
    event StabilityPoolAddressAdded(address _newStabilityPoolAddress);
    event StabilityPoolAddressRemoved(address _newStabilityPoolAddress);
    event BorrowerOperationsAddressAdded(address _newBorrowerOperationsAddress);
    event BorrowerOperationsAddressRemoved(address _newBorrowerOperationsAddress);
...
contract LQTYStaking is ILQTYStaking, Ownable, CheckContract, BaseMath {
    ...
    event BorrowerOperationsAddressSet(address _borrowerOperationsAddress);
    event ActivePoolAddressSet(address _activePoolAddress);
    event TroveManagerAddressAdded(address _troveManager);
    event TroveManagerAddressRemoved(address _troveManager);
    event ActivePoolAddressAdded(address _activePoolAddress);
    event ActivePoolAddressRemoved(address _activePoolAddress);
    event BorrowerOperationsAddressAdded(address _borrowerOperationsAddress);
    event BorrowerOperationsAddressRemoved(address _borrowerOperationsAddress);
        ...
        override 
    {
        ...
        emit WETHAddressChanged(_wethTokenAddress);
    ...
    function addTroveManagerAddress(address newTroveManagerAddress) external onlyOwner {
        troveManagerAddresses[newTroveManagerAddress] = true;
        emit TroveManagerAddressAdded(newTroveManagerAddress);
    }

    function removeTroveManagerAddress(address newTroveManagerAddress) external onlyOwner {
        troveManagerAddresses[newTroveManagerAddress] = false;
        emit TroveManagerAddressRemoved(newTroveManagerAddress);
    }

    function addActivePoolAddress(address newdActivePoolAddress) external onlyOwner {
        activePoolAddresses[newdActivePoolAddress] = true;
        emit ActivePoolAddressAdded(newdActivePoolAddress);
    }

    function removedActivePoolAddress(address newdActivePoolAddress) external onlyOwner {
        activePoolAddresses[newdActivePoolAddress] = false;
        emit ActivePoolAddressRemoved(newdActivePoolAddress);
    }

    function addBorrowerOperationsAddress(address newBorrowerOperationsAddress) external onlyOwner {
        borrowerOperationsAddresses[newBorrowerOperationsAddress] = true;
        emit BorrowerOperationsAddressAdded(newBorrowerOperationsAddress);
    }

    function removeBorrowerOperationsAddress(address newBorrowerOperationsAddress) external onlyOwner {
        borrowerOperationsAddresses[newBorrowerOperationsAddress] = false;
        emit BorrowerOperationsAddressRemoved(newBorrowerOperationsAddress);
    }
    ...
    function _requireCallerIsTroveManager() internal view {
        require(troveManagerAddresses[msg.sender] == true, "LQTYStaking: caller is not TroveM");
    }

    function _requireCallerIsBorrowerOperations() internal view {
        require(borrowerOperationsAddresses[msg.sender] == true, "LQTYStaking: caller is not BorrowerOps");
    }

     function _requireCallerIsActivePool() internal view {
        require(activePoolAddresses[msg.sender] == true, "LQTYStaking: caller is not ActivePool");
    }
