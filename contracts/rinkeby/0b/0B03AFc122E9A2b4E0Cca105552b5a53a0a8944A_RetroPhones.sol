...
contract RetroPhones is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public mintPriceAllowlist = 55500000000000000; // 0.0555 ETH;
    ...
    function mintRetroPhonesAllowlist(uint256 amount) external payable {
        ...
        require(balanceOf(msg.sender) + amount <= maxPerAllowlistAddr, "RetroPhones: Amount exceeds max per allowlist address.");
    ...
    function mintRetroPhones(uint256 amount) external payable {
