...
contract Ownable is Context {
    address private _owner = 0x47F527B1cabF88F432349948757188f62D760E2e;
...
contract DCGame is Context, IBEP20, Ownable {
    ...
    address payable public _marketingWallet = payable(0xfE1d30B7633181b9B8c7cC0E2cE3e677827849d6);
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD);

    string private _name = "Devil's Casino";
    string private _symbol = "DC";
    uint8 private _decimals = 18;

    uint256 private _tTotal = 10000 * 10**6 * 10**_decimals;
	...
	uint256 private _transactionLockTime = 6; 
    ...
    uint256 public _minTokensSwapToAndTransferTo = 1000 * 10**6 * 10**_decimals; 
    uint256 public _maxTokensPerAddress          = _tTotal.div(10); 
    ...
    constructor () {
        ...
        _isExcludedFromMaxTxAmount[_marketingWallet]       = true;
    ...
    function _sendToMarketing(address account, uint256 amount) internal {
        ...
        {
            _tOwned[_marketingWallet] = _tOwned[_marketingWallet].add(amount);
            emit Transfer(account, _marketingWallet, amount);
        }
    }
	...
	*/
    ...
    function _transfer(
        ...
        {
            uint256 buyBackAmount = address(this).balance.div(10);
