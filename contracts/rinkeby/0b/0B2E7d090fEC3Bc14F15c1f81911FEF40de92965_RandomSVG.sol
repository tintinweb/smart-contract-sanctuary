...
constructor(address _VRFCoordinator, address _LinkToken, bytes32 _keyHash, uint256 _fee) 
    ...
    ERC721("RandomSVG","rsNFT")
    {
        ...
        /* Step by Step
        // 1) get a randome number https://docs.chain.link/docs/get-a-random-number/
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        randomNumber = randomNumber % 99999;
    ...
    memory pathCommand) {
        ...
        % size;
        pathCommand = string(abi.encodePacked(pathCommand, " ", uint2str(parameterOne),
