...
contract MutantApeWives is ERC721Enumerable, Ownable {
    ...
    whitelist[0x9D096539D98B4bD35a5a3a5587edb2E8534170F7] = 0;
    }
    ...
    function PresaleMint(uint256 numberOfTokens) public payable{
        require(tokensMinted + numberOfTokens <= maxApePurchase);
        require(numberOfTokens > 0);
        require(whitelist[msg.sender] + numberOfTokens <= 2);
        require(msg.value >= apePrice * numberOfTokens);
