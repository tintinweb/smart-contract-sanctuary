...
/**
 * 
 * PONGO -INU is an anime-inspired, auto-impact investing token. The name "pongo" comes from the latin name for Organutan ! 
 
 * Website: https://pongoinu.net
...
contract PONGOINU is Context, IERC20, Ownable {
