...
contract SoccerWear3 is ERC721Enumerable, ReentrancyGuard, Ownable {
    string[] private _empty = [''];
    string[] private _goalkeepers = ["gk 1", "gk 2", "gk 3", "gk 4", "gk 5", "gk 6", "gk 7", "gk 8"];
    ...
    string[] private _coaches = ["lmf 1", "lmf 2", "lmf 3", "lmf 4", "lmf 5", "lmf 6", "lmf 7", "lmf 8"];
        ...
        returns (string memory)
    {
        ...
        parts[11] = getRightMidfielder(tokenId);
    ...
    constructor() ERC721("SoccerWear3", "SOCWEAR3") Ownable() {}
}
