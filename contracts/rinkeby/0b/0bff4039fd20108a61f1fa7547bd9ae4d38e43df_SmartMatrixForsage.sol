...
contract SmartMatrixForsage is SmartMatrixForsageBasic {
    ...
    function init(address _ownerAddress, address _multisig) public onlyContractOwner {
        ...
        for (uint8 i = 1; i <= LAST_LEVEL; i++) {
            users[_ownerAddress].activeX14Levels[i] = true;
        }
...
//        depositToken = _depositTokenAddress;
    ...
    function registrationExt(address referrerAddress) public {
       ...
       // registration(0x1beE1FaD0e6CD41e4e3CAaEf65b8a8B09F3aa31d, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
        //registration(0x1BEE1FAD0e6cD41E4E3caaEf65B8A8b09f3AA31E, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
        
    //    registration(0x1BEE1fAd0e6CD41e4E3caAeF65B8a8b09F3AA31f, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
     //   registration(0x1BEe1FAD0e6cd41e4E3cAaeF65B8a8b09f3aA310, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
      //  registration(0x1BEe1FaD0e6cd41E4E3caAEF65B8A8b09f3AA319, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
    //    registration(0x1BEe1faD0E6Cd41E4e3cAaEF65b8A8B09f3AA32c, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
     //   
      //  registration(0x2bEE1fAd0e6CD41e4e3cAaEf65B8A8b09F3Aa31D, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
      //  registration(0x2BEe1fAd0e6cd41e4e3CAaEf65b8A8b09f3Aa31e, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
    //    registration(0x2BEe1fad0e6Cd41E4E3CAAEF65B8a8b09f3aA31F, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
     //   registration(0x2bEe1fad0e6CD41E4E3CAAEF65B8A8B09F3AA310, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
      //  registration(0x2beE1Fad0E6cd41E4E3cAaeF65b8A8b09f3Aa319, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
    //    registration(0x2bEe1Fad0E6CD41E4e3CaAeF65b8a8B09f3Aa32c, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
     //   registration(0x2BEe1FaD0e6CD41e4e3caaEF65b8a8B09F3Aa33c, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
        
    }
    
     function registrationExt_1level(address referrerAddress) public {
        //registration(msg.sender, referrerAddress);
    ...
    function registrationExt_2level(address referrerAddress) public {
        //registration(msg.sender, referrerAddress);
    ...
    function registrationExt_3level(address referrerAddress) public {
        //registration(msg.sender, referrerAddress);
    ...
    function registrationExt_14Node(address referrerAddress) public {
        
        registration(0x1BeE1FAd0e6cd41e4E3CaaEF65b8a8B09F3Aa318, 0x1beE1FAD0E6Cd41e4E3CAaeF65b8a8b09f3Aa31B);
    ...
    function registrationExt_7Node(address referrerAddress) public {
    ...
    function registrationFor(address userAddress, address referrerAddress) public {
    ...
    function _buyNewLevel(address _userAddress, uint8 matrix, uint8 level) internal {
        ...
        require(matrix == 2 || matrix == 3, "invalid matrix");
       ...
       {
            require(users[_userAddress].activeX14Levels[level-1], "buy previous level first");
            require(!users[_userAddress].activeX14Levels[level], "level already activated"); 

            if (users[_userAddress].x14Matrix[level-1].blocked) {
                users[_userAddress].x14Matrix[level-1].blocked = false;
            }

            address freeX14Referrer = findFreeX14Referrer(_userAddress, level);
            
            users[_userAddress].activeX14Levels[level] = true;
            updateX14Referrer(_userAddress, freeX14Referrer, level);
            
            emit Upgrade(_userAddress, freeX14Referrer, 2, level);
        }
    }
    ...
    function registration(address userAddress, address referrerAddress) private {
       ...
       // require(size == 0, "cannot be a contract");
        ...
        emit NewUserPlace(userAddress, freeX14Referrer, 3, 1, 0);
    ...
    function updateX14Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].x14Matrix[level].firstLevelReferrals.length < 2) {
            ...
            if (users[referrerAddress].x14Matrix[level].closedPart != address(0)) {
                if ((users[referrerAddress].x14Matrix[level].firstLevelReferrals[0] == 
                    users[referrerAddress].x14Matrix[level].firstLevelReferrals[1]) &&
                    (users[referrerAddress].x14Matrix[level].firstLevelReferrals[0] ==
                    users[referrerAddress].x14Matrix[level].closedPart)) {
    
                    updateX14(userAddress, referrerAddress, level, true);
                    return updateX14ReferrerSecondLevel(userAddress, referrerAddress, level);
                } else if (users[referrerAddress].x14Matrix[level].firstLevelReferrals[0] == 
                    users[referrerAddress].x14Matrix[level].closedPart) {
                    updateX14(userAddress, referrerAddress, level, true);
                    return updateX14ReferrerSecondLevel(userAddress, referrerAddress, level);
                } else {
            ...
            if (users[referrerAddress].x14Matrix[level].firstLevelReferrals[1] == userAddress) {
                updateX14(userAddress, referrerAddress, level, false);
                return updateX14ReferrerSecondLevel(userAddress, referrerAddress, level);
            } else if (users[referrerAddress].x14Matrix[level].firstLevelReferrals[0] == userAddress) {
                updateX14(userAddress, referrerAddress, level, true);
                return updateX14ReferrerSecondLevel(userAddress, referrerAddress, level);
            }
            
            if (users[users[referrerAddress].x14Matrix[level].firstLevelReferrals[0]].x14Matrix[level].firstLevelReferrals.length <= 
                users[users[referrerAddress].x14Matrix[level].firstLevelReferrals[1]].x14Matrix[level].firstLevelReferrals.length) {
                updateX14(userAddress, referrerAddress, level, false);
            } else {
                updateX14(userAddress, referrerAddress, level, true);
            }
    ...
    function updateX14ReferrerThirdLevel(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (referrerAddress != id1) {
            ...
            emit Reinvest(id1, address(0), userAddress, 3, level);
            sendETHDividends(id1, userAddress, 3, level);
        }
    }
