...
contract sSAMOD is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Token Staked samoDAO", "sSAMOD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSAMOD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSAMOD
