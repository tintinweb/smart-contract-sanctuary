 ...
 */
contract BagedBoys is ERC721, Ownable {
    ...
    constructor() ERC721("Baged Boys", "BAG") {}
    ...
    */
    ...
    function toggleRevealede() external onlyOwner {
        string memory base = baseURI();
        require(bytes(base).length > 0,  "baseURI is not found");
        revealed = !revealed;
    }
    ...
    */
    function togglePreSale() external onlyOwner {
        require(bytes(notRevealedURI).length > 0,  "notRevealedURI is not found");
    ...
    */
    function toggleSale() external onlyOwner {
        require(SALE_TIMESTAMP > 0,  "SALE_TIMESTAMP is not found");
        string memory base = baseURI();
        require(bytes(base).length > 0,  "baseURI is not found");
