...
contract SkyRocket is Context, IBEP20, Ownable {
    ...
    address public BUSD     = address(0xaD6D458402F60fD3Bd25163575031ACDce07538D); // BUSD address for Swapping   
    ...
    uint256 public _numTokensSellToAddToLiquidity = 200000 * 10**9; // 1,500,000,000 1,5 billion
    ...
    function _transfer(
        ...
        */
        ...
        if (
            ...
            swapAndSendToMarketingFee(marketingFunds);
            uint256 devFunds             = contractTokenBalance.mul(_devFee).div(tFees);
            swapAndSendToDevFee(devFunds);
        }
    ...
    function swapAndSendToMarketingFee(uint256 tokens) private {
        ...
        IBEP20(BUSD).transfer(_marketingWallet, newBalance);
    }
    ...
    function swapAndSendToDevFee(uint256 tokens) private {
        ...
        swapTokensForBUSD(tokens);
        uint256 newBalance     = IBEP20(BUSD).balanceOf(address(this)).sub(initialBalance);
        IBEP20(BUSD).transfer(_devWallet, newBalance);
    }
