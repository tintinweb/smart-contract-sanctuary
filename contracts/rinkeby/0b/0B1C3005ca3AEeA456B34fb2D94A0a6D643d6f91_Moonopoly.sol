...
contract Moonopoly is ERC1155, Ownable, Pausable, ERC1155Burnable
{
    ...
    function set_BASE_URI(string memory BASE_URI) public onlyOwner { _BASE_URI = BASE_URI; }
    ...
    function setRandomMint(bytes memory MINT_MAPPING) public onlyOwner 
    { 
        assign_int64_storage_from_bytes(_MINT_MAPPING, MINT_MAPPING); 
    }
