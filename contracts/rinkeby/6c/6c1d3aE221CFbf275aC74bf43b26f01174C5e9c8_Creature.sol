...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    function compareHash(string memory _tokenPayload, string memory _tempHash) public pure returns (string memory) {
        require(keccak256(abi.encodePacked(_tokenPayload)) == stringToBytes32(_tempHash), "not match");
        return "it is match!";
    }
