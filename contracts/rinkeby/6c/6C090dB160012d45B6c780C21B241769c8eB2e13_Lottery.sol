...
contract Lottery is Ownable, VRFConsumerBase{
    ...
    constructor(address _priceFeedAddress, address _vrfCoordinator, address _link, uint _fee, bytes32 _keyhash) VRFConsumerBase(_vrfCoordinator, _link){
        usdEntryFee = 50 * 10 ** 18; // entry fee in wei
...
//        wei conversion of eth/usd
        ...
        uint cost = usdEntryFee*(10**5)/uint(price);
        return cost ;
