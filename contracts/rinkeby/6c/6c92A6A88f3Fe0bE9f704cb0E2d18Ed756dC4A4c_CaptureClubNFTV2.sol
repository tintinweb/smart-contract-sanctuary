...
contract CaptureClubNFTV2 is Initializable, ERC721PresetMinterPauserAutoIdUpgradeable {
    // We patched ERC721PresetMinterPauserAutoIdUpgradeable to add decentralizedMint.
    uint256 public constant codeName = 110;
    uint256 private magicPower;

    event ValueChanged(uint256 newValue);

    function store(uint256 initialMagicPower) public {
        magicPower = initialMagicPower;
        emit ValueChanged(magicPower);
    }
