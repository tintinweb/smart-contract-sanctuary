...
contract Crowdsale is Context, ReentrancyGuard, Ownable {
    ...
    // tracks the amount project tokens to be claimed
     ...
     */
    constructor (uint256 _rate, address  _wallet, IERC20 _token, IERC20 _tokenToDeposit)
    {
     ...
     */
    function buyTokens(address _beneficiary, uint value) public nonReentrant
    {
     ...
     */
    function getCrowdsaleToken() public view returns (IERC20) {
     ...
     */
    function _forwardFunds(uint _value)
        internal
    {
     ...
     */
    function _processPurchase(address beneficiary, uint256 tokenAmount, uint value)
        internal
    {
...
contract ICOSale is Ownable, Crowdsale, AllowanceCrowdsale {
    ...
    */
    ...
    Crowdsale(_rate,  _wallet, _token, _tokenToDeposit)
        ...
        override
    {
        ...
        require(_tokens <= remainingTokens(), "Crowdsale: insufficient crowdsale token balance.");
