...
contract KommunitasProject{
    ...
    uint public constant BOOSTER_RUNNING = 120; // 604800; // 7 days
    uint public constant BOOSTER_DELAY = 120; // 172800; // 2 days
    uint public constant VESTING_DELAY = 120; // 2592000; // 30 days
