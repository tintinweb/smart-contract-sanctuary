...
contract Ninpo is ERC721Enumerable, Ownable {
    ...
    uint256 public _max_ninpo = 8800;
    ...
    */
    function ownerMint(address _to,uint256 ninpoNumber) public payable onlyOwner() {
        uint256 supply = totalSupply();
        require( msg.value >= _price * ninpoNumber,             "Ether sent is not correct" );
        require( supply + ninpoNumber < _total_ninpo - _max_giveaway,      "Exceeds maximum Ninpo supply" );
    ...
    */
    ...
    /**
    * @dev Change the max Ninpo
    */
    function setMaxNinpo(uint256 maxNinpo) public onlyOwner {
        _max_ninpo = maxNinpo;
    }
