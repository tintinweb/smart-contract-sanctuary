...
contract GRPSBeneficiaryTokenVesting is Ownable {
  ...
  uint256 public percentAfterCliff;
  ...
  mapping (address => bool) public cliffReleased;
  ...
  constructor(
    ...
    duration = _duration;
    cliff = _start + _cliff;
    percentAfterCliff = _percentAfterCliff;
    start = _start;
    period = _period;
    percent = _percent;
  }
  ...
  function addBeneficiary(address _beneficiary, uint256 _sharesAmount) onlyOwner public {
    require(block.timestamp < cliff || (cliff == start && block.timestamp < start + period), "Invalid timing");
  ...
  function claimTokens() onlyBeneficiaries public {
    ...
    if (unreleased > 0) {
      ...
      if(!cliffReleased[msg.sender]) { 
        cliffReleased[msg.sender] = true;
      }
    }
  }
  ...
  function releasableAmount() public view returns (uint256) {
    ...
    if (block.timestamp < cliff) {
      ...
      if(!cliffReleased[msg.sender]) {
        result = totalBalance * percentAfterCliff / BP;
      }
