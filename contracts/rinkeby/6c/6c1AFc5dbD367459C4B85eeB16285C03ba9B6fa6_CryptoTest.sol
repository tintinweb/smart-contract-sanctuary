...
contract CryptoTest is ERC721, Ownable {
    ...
    constructor(string memory baseURI, string memory baseContract) ERC721("CrytoTest olv","OLV") {
        setBaseURI(baseURI);
    ...
    function Mint100(uint256 quantity) public payable {
        mint100(quantity, msg.sender);
    }
    
    function mint100(uint256 quantity, address receiver) public payable {
        require(hasSaleStarted || msg.sender == owner(), "sale hasn't started");
        require(quantity > 0, "quantity cannot be zero");
        require(quantity <= 40, "exceeds 40");
        require(totalSupply().add(quantity) <= MAX_SUPPLY || msg.sender == owner(), "sold out");
