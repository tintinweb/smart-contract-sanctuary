...
contract NFTFactory {
  ...
  constructor() public {
    ...
    //创建交易市场
    place = new NFTMarketplace(address(nftAddress));
  }
  ...
  function createNewPhotoNFT(
    ...
    nftAddress.mySafeMint(owner, tokenId);
    nftAddress.mySetTokenURI(tokenId, jsonURI);
    place.setPrice(tokenId, nftPrice);
    place.whetherToSell(tokenId, whether_to_sell);
    place.setLevel(tokenId,level);
