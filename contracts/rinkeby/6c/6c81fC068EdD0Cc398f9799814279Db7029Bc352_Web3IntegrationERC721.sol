...
contract Web3IntegrationERC721 is ERC721, Pausable, Ownable {
    ...
    constructor() ERC721("", "") {
        _baseURIValue = "https://opensea-creatures-api.herokuapp.com/api/creature/1?tokenId=";
        _saleStart = block.timestamp + 3600;
    }
    ...
    function setMaxSupply(uint256 maxCount) public {
        require(
            maxCount >= totalSupply(),
            "Cannot set below current totalSupply"
        );
        MAX_SUPPLY = maxCount;
    }
