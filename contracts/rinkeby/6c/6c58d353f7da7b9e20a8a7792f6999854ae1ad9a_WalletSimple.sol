...
contract WalletSimple {
  ...
  function flushTokens(address tokenContractAddress) public {
    require(WalletFactory(walletFactoryAddress).isOwnerOrNot(msg.sender) == true); 
  ...
  function showCOldWalletAddresAS()public view returns(address){
      return(WalletFactory(walletFactoryAddress).showColdWalletAddress());
  }
