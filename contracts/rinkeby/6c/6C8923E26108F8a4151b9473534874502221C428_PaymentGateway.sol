...
contract PaymentGateway is Operable {
    ...
    event PaymentReceived(address indexed payer, uint256 indexed weiAmount, uint256 indexed sessionId);
     ...
     */
    function sendPayment(uint256 _sessionId) external payable {
        escrow.deposit{value: msg.value}(wallet);

        emit PaymentReceived(msg.sender, msg.value, _sessionId);
    }
