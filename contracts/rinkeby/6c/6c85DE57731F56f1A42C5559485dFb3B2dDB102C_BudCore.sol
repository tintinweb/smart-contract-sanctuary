...
contract BudBase is Ownable {
     ...
     *
     */
    uint256 public newBornBreedingCoolDown = uint256(1 minutes); // CHANGE THIS WHEN MAINNET !!!
    
    /**
     * @dev amount of time an seed needs to wait to be grown
     */
    uint256 public seedingDuration = uint256(5 minutes);     // CHANGE THIS WHEN MAINNET !!!
     ...
     *
     */
    uint256 public breedingMultiplierCoolDown = uint256(10 minutes);    // CHANGE THIS WHEN MAINNET !!!
