 ...
 */
contract EpochManager is Initializable, AccessControlUpgradeable, UUPSUpgradeable, EpochManagerV1Storage, IEpochManager {
     ...
     */
    function initialize(address _controller, uint256 _epochLength) external initializer {
     ...
     */
    function setEpochLength(uint256 _epochLength) external override  onlyRole(CONTROLLER_ROLE) {
        require(_epochLength > 0, "Epoch length cannot be 0");
