...
library SafeMath {
    ...
    function sub4(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 4");
        uint256 c = a - b;

        return c;
    }
    
    function sub5(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 5");
        uint256 c = a - b;

        return c;
    }
    
    function sub6(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 6");
        uint256 c = a - b;

        return c;
    }
    
    function sub7(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 7");
        uint256 c = a - b;

        return c;
    }
    
    function sub8(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 8");
        uint256 c = a - b;

        return c;
    }
    
    function sub9(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 9");
        uint256 c = a - b;

        return c;
    }

    function sub10(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 10");
        uint256 c = a - b;

        return c;
    }
    
    function sub11(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 11");
        uint256 c = a - b;

        return c;
    }
    
    function sub12(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 12");
        uint256 c = a - b;

        return c;
    }
    
    function sub13(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 13");
        uint256 c = a - b;

        return c;
    }
    
    function sub14(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 14");
        uint256 c = a - b;

        return c;
    }
    
    function sub15(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 15");
        uint256 c = a - b;

        return c;
    }
    
    function sub16(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 16");
        uint256 c = a - b;

        return c;
    }
    
    function sub17(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "SafeMath: subtraction overflow 17");
        uint256 c = a - b;
...
contract ERC20 is IERC20 {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public returns (bool) {
        ...
        _approve(sender, msg.sender, _allowances[sender][msg.sender].sub4(amount));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
        _approve(msg.sender, spender, _allowances[msg.sender][spender].sub5(subtractedValue));
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balances[sender] = _balances[sender].sub6(amount);
    ...
    function _burn(address account, uint256 value) internal {
        ...
        _totalSupply = _totalSupply.sub7(value);
        _balances[account] = _balances[account].sub8(value);
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(account, msg.sender, _allowances[account][msg.sender].sub9(amount));
    }
}
...
library SafeERC20 {
    ...
    function safeDecreaseAllowance(IERC20 token, address spender, uint256 value) internal {
        uint256 newAllowance = token.allowance(address(this), spender).sub10(value);
        callOptionalReturn(token, abi.encodeWithSelector(token.approve.selector, spender, newAllowance));
    }
...
contract DeepWatersVault is IDeepWatersVault, Ownable {
    ...
    **/
        ...
        returns (uint256)
    {
        ...
        return userDebt.borrowBalance.mul(block.timestamp.sub13(userDebt.lastTimestamp)).mul(rate).div(SECONDS_PER_YEAR).div(HUNDRED_PERCENT);
    }
    ...
    function getAssetVariableInterestRate(address _asset) public view returns (uint256) {
        ...
        if (scarcityRatio <= scarcityRatioTarget) {
            ...
            variableInterestRate = assets[_asset].baseInterestRate.
                ...
                add(scarcityRatio.sub14(scarcityRatioTarget).
                        mul(assets[_asset].interestRateGrowthFactor).
                        div(HUNDRED_PERCENT.sub15(scarcityRatioTarget)));
        }
    ...
    **/
    function getAssetCumulatedLiquidityIndex(address _asset) public view returns (uint256) {
        return getAssetLiquidityRate(_asset).
                  mul(block.timestamp.sub16(getAssetCumulatedLiquidityIndexLastUpdate(_asset))).
    ...
    * @param _asset the address of the basic asset
    **/
    function updateCumulatedLiquidityIndex(address _asset) external onlyLendingContract {
