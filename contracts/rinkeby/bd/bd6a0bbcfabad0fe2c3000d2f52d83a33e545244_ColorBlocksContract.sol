  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 26');
    ...
    // File: contracts/colorBlocksContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ColorBlocksContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Color Blocks", "COLOR", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmfCj28SzFZY6Rq7JaX2v1Jm4UhTByiUi2Pr8vm7rhBLiV/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://rampp.xyz/api/kCuCHLOmwtdnkQQQN9jH/contract-metadata";
        }
    }