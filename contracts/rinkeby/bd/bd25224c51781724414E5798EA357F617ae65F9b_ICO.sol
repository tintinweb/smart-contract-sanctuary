...
contract ICO is Ownable  {
    ...
    function getTokenUri(uint256 tokenIdUri) public view virtual returns(string memory ) {
     ...
     function getTotalSale() public view virtual returns(uint256) {
        return  token._getTotalSale();
    }
    ...
    function black_list(address whitelisted) onlyOwner public {
     ...
     function Check_Whitelist(address whitelisted) public view virtual returns(bool) {
       
        return whitelistAddress[whitelisted];
    }
