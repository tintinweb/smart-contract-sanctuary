...
contract Treasury is Operator, ContractGuard, Epoch {
    ...
    /* ========== VIEW FUNCTIONS ========== */
    // get CTRL Price
    // CTRL function the IdeaFund
    function gettheControlPrice() public view returns (uint256) {
        return IIdeaFund(ideafund).controlPrice();
    }
...
//console.log("pegPriceCeiling: ", getPegPriceCeiling());
...
//console.log("percentage: ", percentage);
        ...
        if (percentage > 10) {
            //TODO confirm the percentage is 10%
...
//console.log("percentage: ", percentage);
//console.log("pegSupply: ", pegSupply);
//console.log("wbtcOneUnit: ", wbtcOneUnit);
...
//console.log("devFund: ", seigniorage.mul(devfundAllocationRate).div(100));
//console.log("ideaFund: ", seigniorage.mul(ideafundAllocationRate).div(100));
...
//console.log("percentage: ", percentage);
//console.log("seigniorage: ", seigniorage);
//console.log("pegMint: ", pegMint);

        seigniorage = seigniorage.sub(pegMint);

//console.log("seigniorage: ", seigniorage);
//console.log("controlPrice: ", IIdeaFund(ideafund).controlPrice());

        // seigniorage - mintedLFBTC * currentvalue(peg)  / control value = number to Mint
        uint256 mintControl = seigniorage.mul(pegPrice).div(IIdeaFund(ideafund).controlPrice());
        IBasisAsset(control).mint(address(this), mintControl);

//console.log("mintControl: ", mintControl);
        // Boardroom
        if (mintControl > 0) {
    ...
    function initialize() public checkOperator {
        ...
        IBasisAsset(peg).burn(IERC20(peg).balanceOf(address(this)));
