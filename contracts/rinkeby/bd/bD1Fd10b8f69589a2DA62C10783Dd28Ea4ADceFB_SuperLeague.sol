...
// File contracts/SuperLeague.sol
...
contract SuperLeague is Context, ERC165, Ownable, IERC721Metadata {
    ...
    uint public constant MAX_TOKENS_SUPPLY = 10800;

    uint private constant MAX_GIVEAWAY_TOKENS = 50;

    string private constant NAME = 'Super League';

    string private constant SYMBOL = 'SPRLG';
    ...
    */
    ...
    /**
     * @dev Sets the prize address
    */
    function setPrizeAddress(address prizeAddress) external onlyOwner {
        require(prizeAddress != address(0), "Prize address can not be zero address");

        _prizeAddress = prizeAddress;
    }

    /**
     * @dev Gets the prize address
     *
     * @return prize address
    */
    function getPrizeAddress() public view returns (address) {
    ...
    */
    ...
    /**
     * @dev Sets the prize share
    */
    function setPrizeShare(uint prizeShare) external onlyOwner {
        require(prizeShare < 100 && prizeShare > 1, "Prize share should be in interval from 1% to 100%");
    ...
    */
    function mint(uint tokenAmount) external payable {
        ...
        uint price = _tokenPrice * tokenAmount;
    ...
    */
    function withdraw() onlyOwner external {
        ...
        if (balance > 0) {
            payable(_msgSender()).transfer(balance / (100 - _prizeShare));
            payable(_prizeAddress).transfer(balance / _prizeShare);
        }
    }
