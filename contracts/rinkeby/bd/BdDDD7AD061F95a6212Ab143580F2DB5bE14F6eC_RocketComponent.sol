...
contract RocketComponent is ERC721, Ownable {
    ...
    mapping(address => bool) private earlyAccess;
    ...
    constructor() ERC721("Tom Sachs Rocket Components", "TSRC") {
        ...
        componentModels.push(ComponentModel("Purple", 0, 2));
        componentModels.push(ComponentModel("Miami Vice", 3, 5));
        componentModels.push(ComponentModel("Cup Noodles", 6, 8));
        componentModels.push(ComponentModel("Domino Sugar", 9, 11));
        componentModels.push(ComponentModel("Vaseline", 12, 14));
        componentModels.push(ComponentModel("Kikkoman", 15, 17));
        componentModels.push(ComponentModel("Lisa Simpson", 18, 23));
        componentModels.push(ComponentModel("Wonder Bread", 24, 29));
        componentModels.push(ComponentModel(unicode"Hermès", 30, 35));
        componentModels.push(ComponentModel("Marlboro", 36, 44));
        componentModels.push(ComponentModel("Green Giant", 45, 53));
        componentModels.push(ComponentModel("Ferrari", 54, 62));
        componentModels.push(ComponentModel("WD-40", 63, 83));
        componentModels.push(ComponentModel("Brian", 84, 104));
        componentModels.push(ComponentModel("Grey Poupon", 105, 125));
        componentModels.push(ComponentModel("Budweiser", 126, 146));
        componentModels.push(ComponentModel("Tiffany", 147, 191));
        componentModels.push(ComponentModel("Apple", 192, 239));
        componentModels.push(ComponentModel("7Eleven", 240, 302));
        componentModels.push(ComponentModel("NIKECRAFT", 303, 389));
        componentModels.push(ComponentModel("Snickers", 390, 482));
        componentModels.push(ComponentModel("Sweet'N Low", 483, 590));
        componentModels.push(ComponentModel("USPS", 591, 743));
        componentModels.push(ComponentModel("Hello Kitty", 744, 974));
        componentModels.push(ComponentModel("Campbell's", 975, 1226));
        componentModels.push(ComponentModel("Scotch", 1227, 1523));
        componentModels.push(ComponentModel("Skippy", 1524, 1850));
        componentModels.push(ComponentModel("NASA", 1851, 2207));
        componentModels.push(ComponentModel("Chanel", 2208, 2588));
        componentModels.push(ComponentModel("McDonald's", 2589, 2999));
    }
    ...
    /**
     * @dev Adds addresses for early access
     */
    function addEarlyAccess(address[] memory _addresses) external onlyOwner {
        for (uint256 i; i < _addresses.length; i++) {
            earlyAccess[_addresses[i]] = true;
        }
    }

    /**
     * @dev Remove addreses from early access
     */
    function removeEarlyAccess(address[] memory _addresses) external onlyOwner {
        for (uint256 i; i < _addresses.length; i++) {
            earlyAccess[_addresses[i]] = false;
        }
    }
        ...
        returns (ComponentView memory)
    {
        for (uint256 i; i < componentModels.length; i++) {
            ...
            string memory tokenIdStr = utils.uint2str(_tokenId);
            if (_tokenId >= 1000) {
                serialNumber = string(
