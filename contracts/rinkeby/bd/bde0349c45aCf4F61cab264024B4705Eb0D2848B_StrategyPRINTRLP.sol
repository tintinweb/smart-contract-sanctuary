...
contract StrategyPRINTRLP is Ownable, Pausable {
     ...
     * {PAPR} - PAPRFinance token, used to send funds to the treasury.
     ...
     * {treasury} - Address of the PAPRFinance treasury
     ...
     *
     * {REWARDS_FEE} - 3% goes to PAPR holders through the {rewards} pool.
