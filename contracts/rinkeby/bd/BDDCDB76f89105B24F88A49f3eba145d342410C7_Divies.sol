...
interface HourglassInterface {
    ...
    function buy(address _playerAddress, uint _bombAmount) payable external returns(uint256);
...
contract Divies {
    ...
    HourglassInterface constant P3Dcontract_ = HourglassInterface(hourglassAddress);
    ...
    */  
        ...
        isHuman()
    {
        ...
        uint256 _bal = BOMBTOKEN.balanceOf(address(this));
        uint256 _mnPayout;
        ...
        )
        {
            ...
            // buy & sell    
            // approve first 
            BOMBTOKEN.approve(address(P3Dcontract_), uint(-1));

            P3Dcontract_.buy(_pusher, _bal);
