...
contract GreatMastersNFT is ERC721Upgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function mint(address to, string calldata ipfsHash) public onlyMinter returns (uint256 tokenId) {
