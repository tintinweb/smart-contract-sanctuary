...
contract Punktestv1 is ERC721, Ownable, ERC721URIStorage {

    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("PUNKSTICKS", "PKST") {}

    function mintByUser(address minter, string memory nftURI) public returns (uint256){
...
contract VerifySignature is Ownable {
    ...
    function verify(address _signer, bytes memory signature) public view returns (bool) {
