...
contract RumToken is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function mint(uint256 numberOfTokens)
        ...
        try token.tokenOfOwnerByIndex(msg.sender, 0) {
            uint256 mintIndex = totalSupply();
            if (mintIndex < MAX_NFT && numberOfTokens == 1) {
