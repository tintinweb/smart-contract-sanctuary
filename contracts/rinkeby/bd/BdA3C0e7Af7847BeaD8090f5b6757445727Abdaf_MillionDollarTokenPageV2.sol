...
contract MillionDollarTokenPageV2 is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, IERC721ReceiverUpgradeable {
    ...
    uint256 public tokenIdsToMigrateCount;
    uint256 public tokenIdsMigratedCount;
    // mapping(uint256 => bool) public tokenIdsToMigrate;

    event TokenContentURIChanged(uint256 indexed tokenId);

    function initialize(uint16 _totalMintLimit, uint16 _singleMintLimit, uint16 _userMintLimit, uint256 _mintPrice, string memory _metadataBaseURI, string memory _defaultContentBaseURI, address _original) public virtual initializer {
        __MillionDollarTokenPageV2_init(_totalMintLimit, _singleMintLimit, _userMintLimit, _mintPrice, _metadataBaseURI, _defaultContentBaseURI, _original);
    }

    function __MillionDollarTokenPageV2_init(uint16 _totalMintLimit, uint16 _singleMintLimit, uint16 _userMintLimit, uint256 _mintPrice, string memory _metadataBaseURI, string memory _defaultContentBaseURI, address _original) public onlyInitializing {
        __ERC721_init("MillionDollarTokenPage", "\u22A1");
        __Pausable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();
        __MillionDollarTokenPageV2_init_unchained(_totalMintLimit, _singleMintLimit, _userMintLimit, _mintPrice, _metadataBaseURI, _defaultContentBaseURI, _original);
    }

    function __MillionDollarTokenPageV2_init_unchained(uint16 _totalMintLimit, uint16 _singleMintLimit, uint16 _userMintLimit, uint256 _mintPrice, string memory _metadataBaseURI, string memory _defaultContentBaseURI, address _original) public onlyInitializing {
    ...
    function proxiedOwnerOf(uint256 tokenId) public view returns (address) {
        address owner = _owners[tokenId];
    ...
    function addTokensToMigrate(uint256[] memory _tokenIdsToMigrate) external onlyOwner {
