...
contract Example1155 is ERC1155Supply, Ownable {
    ...
    uint256 private _nerdyNuggetPrice = 30000000000000000; // 0.03 ETH
    ...
    constructor() ERC1155("Test Contract") { }
    ...
    function tokenLicense(uint _id) public view returns(string memory) {
        require(_id < totalSupply(10000), "Choose a NerdyNugget in supply range");
        return LICENSE_TEXT;
    }
    ...
    function mintNerdyNuggets(uint numberOfTokens) public payable {
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            uint mintIndex = totalSupply(1000);
            if (totalSupply(1000) < MAX_NUGGETS) {
