...
contract BoozeBottlers is ERC721, ERC721Enumerable,ERC721Burnable, Ownable, PaymentSplitter{
    using SafeMath for uint256;
    using Strings for uint256;
    using Counters for Counters.Counter;
    uint256 public constant TOTAL = 3;
    ...
    constructor(string memory name, string memory symbol, address[] memory _payees, uint256[] memory _shares) ERC721(name, symbol) PaymentSplitter(_payees, _shares) payable {}
