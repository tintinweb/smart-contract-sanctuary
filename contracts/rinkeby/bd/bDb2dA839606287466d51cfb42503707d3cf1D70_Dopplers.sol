...
contract Dopplers is ERC721 {
    ...
    constructor () public ERC721 ("tester", "tester"){
        tokenCounter = 1;
        _setBaseURI("ipfs://QmTv37uGcqRrDdUX5UMCf7naBYXPSJVxp6MyuEkcNNfYex/");
        _setOwner(wallet);
    }

    function mintDoppler() public payable{
        require(saleStatus);
        require(msg.value == 20000000000000000);
        require(tokenCounter<101);
        _safeMint(msg.sender, tokenCounter);
        tokenCounter = tokenCounter + 1;
    }

    function ownermintDoppler() public payable{
