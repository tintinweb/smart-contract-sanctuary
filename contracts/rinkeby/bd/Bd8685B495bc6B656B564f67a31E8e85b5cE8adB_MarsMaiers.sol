...
contract MarsMaiers is ERC721, AccessControl, ReentrancyGuard {
  ...
  function setBaseURI(string memory uri, bool lock) external onlyRole(DEFAULT_ADMIN_ROLE) {
  ...
  function withdraw(uint256 amount, address to) external onlyRole(TREASURER_ROLE) {
