...
abstract contract ScrewUpERC1155MintWhitelistBase is ScrewUpMintWhitelistBase ,IScrewUpERC1155Whitelist {
    ...
    function advanceMintAmount (address addr,uint256 amount) external virtual override onlyFromTokenToMint {
        _advanceMintAmount(addr,amount);
    }
...
interface IScrewUpERC1155Whitelist {
    ...
    //Advance mint abount should call by owner or ERC721 contact address as sender.
    function advanceMintAmount (address addr,uint256 amount) external;
...
abstract contract ScrewUpToMintTokenAddon is Ownable {
    ...
    function getToMintTokenAddress() external view returns (address){return _toMintokenAddress;}
}
