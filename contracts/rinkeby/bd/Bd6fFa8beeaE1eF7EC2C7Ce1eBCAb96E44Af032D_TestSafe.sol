...
contract TestSafe is ERC721, ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    uint256 public constant TOKEN_LIMIT = 10000;
    uint256 public constant TOKEN_PRICE = 100000000000000000; // 0.1 ETH in Wei

    string private _baseURIextended;

    constructor() ERC721("TestSafe", "TS") {}
