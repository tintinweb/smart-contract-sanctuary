...
contract AcyV1Router02 is IAcyV1Router02 {
    ...
    function getDirAmount(uint256 amountT,address XToken,address YToken,address ZToken) view public returns (uint dirAmount) {
        ...
        uint256 fenmu = uint256(reserves.Zx).mul(reserves.Yz) + uint256(reserves.Yx).mul(reserves.Zy) + uint256(reserves.Yx).mul(reserves.Zx);
        dirAmount = (reserves.Yx).mul(reserves.Zy).mul(reserves.Xz).div(fenmu) + (reserves.Yx).mul(reserves.Zy).mul(amountT).div(fenmu) + (reserves.Yx.mul(amountT) - reserves.Xy.mul(reserves.Yz)).mul(reserves.Zx).div(fenmu);
        return dirAmount;
    }
    
    function getFenZi(uint256 amountT,address XToken,address YToken,address ZToken) view public returns (uint256 fenmu) {
        ...
        return uint256(Yx).mul(Zy).mul(Xz) + uint256(Yx).mul(Zy).mul(amountT) + uint256(Yx.mul(amountT) - Xy.mul(Yz)).mul(Zx);
    }
