 ...
 */
contract OurMinter is OurStorage, IERC721Receiver {
  //======== Constants =========
  ...
  function onERC721Received(
    ...
    emit NFTReceived(address(this), tokenId);
  ...
  /**======== IERC721 =========
   * @notice Althought OurMinter.sol is generally implemented to work with Zora (or Mirror),
