...
contract LeapNFoundersDeed is ERC721, Ownable, ReentrancyGuard {
    ...
    // TODO: Change this before mainnet deployment
    ...
    address[4] private _shareholders = [_picoPyro, _frederickLevins, _ferb, _wickedDig];
    ...
    constructor() ERC721("LeapN Founders Deed", "DEED") {
        ...
        // TODO: Change these before mainnet deployment
        _shares[_picoPyro] = 100;
        _shares[_frederickLevins] = 200;
        _shares[_ferb] = 31285;
        _shares[_wickedDig] = 17615;
