...
contract Yakuza is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    using Address for address;
    ...
    function activateWhitelistMint() public onlyOwner {
      whitlistMintActive = true;
    }

    function deactivateWhitelistMint() public onlyOwner {
      whitlistMintActive = false;
    }
