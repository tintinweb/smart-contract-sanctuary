...
// Part: Uniswap/[email protected].0.0/IUniswapV3PoolImmutables
    ...
    ReentrancyGuard
{
        ...
        )
    {
        ...
        emit Debug2(msg.sender, to, shares, amount0, amount1);
        ...
        emit Debug3(msg.sender, to, totalSupply(), maxTotalSupply);
