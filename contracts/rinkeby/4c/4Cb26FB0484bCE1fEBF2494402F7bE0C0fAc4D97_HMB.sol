...
interface IPage {
    function burnPage(uint256 tokenId) external;
 ...
 */
contract HMB is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    mapping(uint256 => bool) public blackList;

    uint256 public constant MAX_NFT_SUPPLY = 5;
    uint256 public constant DEFAULT_TIME_LIMIT_FOR_ART_CREATION = (86400 * 28); //~28 days 
    ...
    function startCreationTimer() public {
        ...
        artDepositTimelimit = block.number + DEFAULT_TIME_LIMIT_FOR_ART_CREATION;
    }

    function addGracePeriod(uint256 additionalTime) onlyOwner public {
        artDepositTimelimit = artDepositTimelimit + additionalTime;
    }
