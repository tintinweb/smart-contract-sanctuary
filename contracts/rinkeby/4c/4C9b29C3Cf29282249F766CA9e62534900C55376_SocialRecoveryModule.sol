...
contract SocialRecoveryModule is Module {
    ...
    // One of the friends need to deposit an amount of ERC20 tokens before calling the recover function
        ...
        public
    {
        ...
        setManager();
        _reconfigure(_friends, _threshold, _timelapse, _ERC20DepositAddress, _ERC20ToDepositAmount);
    }
