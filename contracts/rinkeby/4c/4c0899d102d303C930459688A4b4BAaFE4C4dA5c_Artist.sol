...
contract Artist is ERC721Upgradeable, IERC2981Upgradeable, OwnableUpgradeable {
    ...
    function withdrawFunds(uint256 editionId) external {
        ...
        uint256 remainingForEdition = (editions[editionId].price * editions[editionId].numSold) - // Compute total amount of revenue that has been generated for the edition so far.
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        // Concatenate the baseURI, editionId and tokenId, to create URI.
        return string(abi.encodePacked(baseURI, _toString(editionId), '/', _toString(_tokenId)));
    }
