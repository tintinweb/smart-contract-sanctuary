...
import './MintdropzERC721.sol';

contract MintdropzERC721Factory {
    ...
    function createContract(
        ...
        contractAddresses[msg.sender] = address(new MintdropzERC721(msg.sender, _name, _symbol, _royaltyReceiver, _royaltyPercent, _DENOMINATOR));
        contractCount++;
    }
...
contract MintdropzERC721 is ERC721Enumerable {
    ...
    function reserveMintdropz(address _to, uint256 _reserveAmount) public onlyOwner(msg.sender) {        
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner(msg.sender) {
    ...
    function setBaseURI(string memory _newBaseURI) public onlyOwner(msg.sender) {
        baseURI = _newBaseURI;
    }
    ...
    function flipSaleState() public onlyOwner(msg.sender) {
    ...
    function lockLicense() public onlyOwner(msg.sender) {
        licenseLocked =  true;
        emit licenseisLocked(LICENSE_TEXT);
    }
    
    // Change the license
    function changeLicense(string memory _license) public onlyOwner(msg.sender) {
