  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x68372a4d01e4261A5D60D81EABfF6f712d09b7bd);
    ...
    // File: contracts/etHskiContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract EtHskiContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("ETHski", "ESKI", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmT5LZCxDxK4VXLCSWLSifH2tHWHWus42SbxVGa9wgBsoP/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/0jju5ukop4dnANCPM1ji/contract-metadata";
        }
    }