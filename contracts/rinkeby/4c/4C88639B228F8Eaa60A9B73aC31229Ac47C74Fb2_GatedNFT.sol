...
// hevm: flattened sources of src/test/GatedNFT.sol
// SPDX-License-Identifier: GPL-3.0-or-later AND MIT
pragma solidity >=0.4.23 >=0.8.0 <0.9.0 >=0.8.6 <0.9.0;
...
contract GatedNFT is ERC721 {
    address gatingNFT;
    uint256 totalSupply;
    constructor(address _gatingNFT) ERC721("Gated", "") {
