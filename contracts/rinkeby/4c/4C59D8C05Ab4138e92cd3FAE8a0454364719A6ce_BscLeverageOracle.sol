...
contract BscLeverageOracle is Ownable {
    ...
    constructor() public {
       // BTC/USD
        ...
        // ETH/USD (BSC)   ETH/USD (ETH)
        assetsMap[2] = AggregatorV3Interface(0x8A753747A1Fa494EC906cE90E9f37563A8AF630e);
        // BNB/ USD (BSC)  ETH/USD (ETH)
        assetsMap[6] = AggregatorV3Interface(0x8A753747A1Fa494EC906cE90E9f37563A8AF630e);
        //  BNB/ USD (BSC)  ETH/USD (ETH)
        assetsMap[0] = AggregatorV3Interface(0x8A753747A1Fa494EC906cE90E9f37563A8AF630e);

        //wbtc => BTC/USD
        assetsMap[uint256(0x797b41F40981FA85Bd1232DBD1663e3f4c5D17C8)] = AggregatorV3Interface(0xECe365B379E1dD183B20fc5f022230C044d51404);
        //weth => ETH/USD
        ...
        // BUSD => BUSD/USD
        assetsMap[uint256(0x7bAb582C8D90B1F9E2d8998547e43507249046A7)] = AggregatorV3Interface(0xa24de01df22b63d23Ebc1882a5E3d4ec0d907bFB);
        // USDT => USDT/USD
        assetsMap[uint256(0xf442A11F2c607525652Be1121C4c2cee677Fc8f1)] = AggregatorV3Interface(0xa24de01df22b63d23Ebc1882a5E3d4ec0d907bFB);
        // USDC => USDC/USD
        assetsMap[uint256(0x171BeD8f6714a51557B39C2AbFb7DDb79Cd1a6D5)] = AggregatorV3Interface(0xa24de01df22b63d23Ebc1882a5E3d4ec0d907bFB);
        ...
        decimalsMap[2] = 18;
        decimalsMap[6] = 18;
        decimalsMap[uint256(0x797b41F40981FA85Bd1232DBD1663e3f4c5D17C8)] = 18;
        decimalsMap[uint256(0x0000000000000000000000000000000000000000)] = 18;
        decimalsMap[uint256(0x7bAb582C8D90B1F9E2d8998547e43507249046A7)] = 18;
        decimalsMap[uint256(0xf442A11F2c607525652Be1121C4c2cee677Fc8f1)] = 18;
        decimalsMap[uint256(0x171BeD8f6714a51557B39C2AbFb7DDb79Cd1a6D5)] = 18;
    }
