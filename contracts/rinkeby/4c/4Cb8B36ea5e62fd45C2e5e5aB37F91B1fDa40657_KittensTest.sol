...
contract KittensTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Kittens Test", "KITT") {
    setHiddenMetadataUri("ipfs://QmZP358s7mC2GgyjZhDBoWN5DK8tixYMWXuu91pdHHy5AZ/_metadata.json");
  }
