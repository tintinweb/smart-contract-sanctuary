...
contract CapitalPool is ICapitalPool, OwnableUpgradeable, AbstractDependant {
    ...
    function addPolicyHoldersHardSTBL(
        ...
        leveragePoolBalance += userLeveragePoolPremium;
        ...
        if (reinsurancePoolBalance > 0) {
            reinsurancePool.addPolicyPremium(_epochsNumber, reinsurancePoolPremium);
        }
        if (leveragePoolBalance > 0) {
