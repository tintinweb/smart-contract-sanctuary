...
contract BCtwatter{
    ...
    // emit event header
    event TwatReceived(uint256 index, address indexed from, uint256 timestamp, string message, uint256 n_cheers);
    
    // struct containing variables of a twat
    struct Twat{
        uint256 twatID; //ID of twat
    ...
    function twat(string memory _message) public {
        ...
        //prevent spam
        require(
            lastTwattedAt[msg.sender] + 1 minutes < block.timestamp,
            "Yo man please wait 1 min before you can twat again."
        );
        ...
        emit TwatReceived(totalTwats, msg.sender, block.timestamp, _message, 0);
    ...
    function cheers(uint256 twatIndex) public {
        ...
        // prevent spam
        require(
            lastCheersedAt[msg.sender] + 1 minutes < block.timestamp,
            "Yo man please wait 1 min before you can cheers again."
        );
