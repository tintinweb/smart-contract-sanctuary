...
contract KPIToken is Initializable, ERC20Upgradeable {
    ...
    function initialize(
        ...
        require(_kpiId != bytes32(""), "KT01");
        require(_oracle != address(0), "KT02");
        require(_creator != address(0), "KT03");

        require(_collateral.token != address(0), "KT04");
        require(_collateral.initialAmount > 0, "KT05");
        require(
    ...
    function redeem() external {
        require(finalized, "KT06");
        uint256 _kpiTokenBalance = balanceOf(msg.sender);
        require(_kpiTokenBalance > 0, "KT07");
