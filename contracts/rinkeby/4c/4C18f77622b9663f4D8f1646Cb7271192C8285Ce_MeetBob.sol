...
contract MeetBob is ERC721Enumerable, Ownable, Pausable {
    ...
    uint256 public maxSupplyEarlyAccess = 4101;

    uint8 public maxPerTransaction = 2;
    uint8 public maxPerWallet = 10;
    uint8 public maxPerWalletEarlyAccess = 5;

    uint256 public earlyAccessWindowOpens = 1641924000;
    uint256 public publicSaleWindowOpens    = 1642010400;
    uint256 public publicSaleWindowCloses   = 1642096800;
    ...
    address public constant community = 0xB680b8c21f885390F2De0f7759C3681E633f1Faa;
    // Team addresses
    address public constant addr1 = 0xFaD54dF4CcDa532FddDf38117326F8a49A4d10c5;
    address public constant addr2 = 0xE62Cc548C172F28C153397512E498Bb3a5B08c74;
    ...
    */
    function editSaleRestrictions(uint8 _maxPerTransaction, uint8 _maxPerWallet, uint8 _maxPerWalletEarlyAccess) external onlyOwner {
    ...
    * @notice edit windows
    *
    * @param _publicSaleWindowOpens UNIX timestamp for purchasing window opening time
    * @param _publicSaleWindowCloses UNIX timestamp for purchasing window close time
    ...
    */
    function editWindows(
        ...
        require(
            _burnWindowOpens > _publicSaleWindowCloses &&
            _publicSaleWindowOpens > _earlyAccessWindowOpens &&
    ...
    */
    function publicSale(uint256 amount) public payable whenNotPaused {
        ...
        require(currentBalance + amount <= maxPerWalletEarlyAccess, "Exceeds maximum tokens per wallet");
    ...
    */
    function earlyAccessSale(
        ...
        require(block.timestamp >= earlyAccessWindowOpens && block.timestamp <= publicSaleWindowCloses, "Early access: window closed");
        require(totalSupply() + amount <= maxSupplyEarlyAccess, "Exceeds maximum early access supply");
    ...
    function withdrawAll() public onlyTeam {
        ...
        uint256 share = balance.mul(20).div(100);

        _withdraw(addr2, share);
        _withdraw(addr1, address(this).balance);
    }
