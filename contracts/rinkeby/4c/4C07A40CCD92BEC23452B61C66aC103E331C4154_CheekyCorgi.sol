...
contract CheekyCorgi is CheekyCorgiBase
{
    ...
    function initialize(
        ...
        */
        ...
        Claimables[0].token = 0xC675Fb458a155C1af6F373057Dde1DD00cdd3494; // Uninterested Unicorns
        Claimables[1].token = 0xA40d506CF2f13570ffdADE1eF4d26cD82eD42620; // JunkYard
        Claimables[2].token = 0x0D60372D752CBe4Ef603C2657E32D6186c22ED59; // ApprovingCorgis
        totalClaimed = 0;
        maxClaimable = 300;
    }

    function claim(address _claimableNft, uint256 _tokenId) external whenNotPaused {
        require(
        ...
        for (uint256 i = 0; i < 3; i++) {
            if (Claimables[i].token != _claimableNft) {
                continue;
            }
        ...
        // _claimableNft or _tokenId is wrong, and not able to claim with that
    ...
    // ---------------------- ADMIN FUNCTIONS -----------------------
    function setAdminImplementation(address _adminImplementation) external onlyAdmin {
