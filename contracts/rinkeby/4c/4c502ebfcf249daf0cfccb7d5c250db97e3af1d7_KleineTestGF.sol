...
contract KleineTestGF is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
      ...
      payable
  {
    ...
    if (msg.sender != owner()) {
        require(msg.value >= cost * _mintAmount);
              require( _mintAmount <= maxMintAmount, "You can't mint more than 5 ghosts");
      require( balanceOf(msg.sender) >= 5, "You can only mint 5 ghosts per wallet");
    }
  ...
  function setPaused() public onlyOwner returns (bool){
      //Toggle mint pause state
      isPaused = !isPaused;
