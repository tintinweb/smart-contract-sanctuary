...
contract Marsupial is Ownable, ERC721URIStorage, ERC721Enumerable {
  ...
  function mint(address recipient, uint number) private tokensLeft(number) saleIsActive {
    require(number >= 1, "Invalid mint amount");
    require(number <= 20, "Max mint count");
  ...
  function buyFor(address recipient, uint number) public payable {
