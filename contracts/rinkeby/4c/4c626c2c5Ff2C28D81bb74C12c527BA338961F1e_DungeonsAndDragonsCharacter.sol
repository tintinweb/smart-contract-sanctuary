...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase, Ownable {
    ...
    event CHARACTER_CREATED(bytes32 requestId, uint256 tokenId);
        ...
        override
    {
        ...
        emit CHARACTER_CREATED(requestId, newId);
        _safeMint(requestToSender[requestId], newId);
    }

    function getTokenId(bytes32 requestId) public view returns (uint256) {
