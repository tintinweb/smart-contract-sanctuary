...
contract ShardManager is Context, ERC20Permit, ERC20Burnable, Ownable, ERC1155Holder {
	...
	constructor(address _landXNFT) ERC20Permit("LDXS") ERC20("LandX Shard", "LDXS") {
	...
	function getShards(uint256 _id) external {
		...
		require(landXNFT.balanceOf(msg.sender, _id) > 0, "you must own this NFT");
