...
// rinkeby _proxy 0xf57b2c51ded3a29e6891aba85459d600256cf317

contract CREATURE is ERC721TradableRandomMint {
    string public baseURI;
    string public contractURI;


    constructor(address _proxyRegistryAddress)
        ERC721TradableRandomMint("The Creature", "CRE", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public  pure returns (string memory) {
        return "https://ipfs.io/ipfs/QmU53KVfCTdwXm31FyN1QRTz55E1Gc18fDJwPGTzUwGbSA/";
    }
