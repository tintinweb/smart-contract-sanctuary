...
contract NiftyEntity {
   ...
   //address public immutable masterBuilderContract;// = 0xCA9fC51835DBB525BB6E6ebfcc67b8bE1b08BDfA;
   address public masterBuilderContract;
   
   // nifty registry is hard coded
   //address immutable niftyRegistryContract;// = 0x33F8cb717384A96C2a5de7964d0c7c1a10777660;
...
contract BuilderShop is NiftyEntity {
   ...
   function createNewBuilderInstance(
    ...
    constructor(address _masterBuilderContract, address _niftyRegistryContract) NiftyEntity(_masterBuilderContract, _niftyRegistryContract) public {
    }
}
...
contract ERC721Metadata is Context, ERC165, ERC721, IERC721Metadata, NiftyEntity {
   // Token name
   ...
   constructor (string memory name, 
                ...
                address _niftyRegistryContract) NiftyEntity(_masterBuilderContract, _niftyRegistryContract) public {
       _name = name;
       _symbol = symbol;
...
contract ERC721Full is ERC721, ERC721Enumerable, ERC721Metadata {
   constructor (string memory name, 
                ...
                address niftyRegistryContract) public ERC721Metadata(name, 
                                                                     symbol,
                                                                     masterBuilderContract,
                                                                     niftyRegistryContract) {
       // solhint-disable-previous-line no-empty-blocks
...
contract NiftyBuilderInstance is ERC721Full {
   ...
   constructor(
       ...
       address masterBuilderContract, 
       address niftyRegistryContract) ERC721Full(name, symbol, masterBuilderContract, niftyRegistryContract) public {
