...
contract CryptoPunk is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 10000;
    uint256 public punkPrice = 0.08 * 10 ** 18;
    ...
    //DaBunny investors wallets address
    address daBunny20ContractAddress;
    address w1;
    address w2;
    address w3;

    constructor() ERC721("CryptoPunk", "CRP") { }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(msg.value >= punkPrice * _mintAmount, "Must send proper eth value to mint rare DaBunny");
        }
