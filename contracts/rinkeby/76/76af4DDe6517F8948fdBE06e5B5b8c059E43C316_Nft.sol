...
contract Nft is ERC721Enumerable, Ownable {
    ...
    // Defines whether sale is currently active
    ...
    // Maximum number of tokens minted at once
    uint256 private MAX_PURCHASE = 50;

    // Constructor
    constructor(string memory newBaseURI) ERC721("Nft Test Test", "NFT")  {
    ...
    function mint(uint256 _amount) public payable {
        ...
        require( _amount <= MAX_PURCHASE, "Can only mint 50 tokens at a time" );
    ...
    // Get array of tokens held by an address
