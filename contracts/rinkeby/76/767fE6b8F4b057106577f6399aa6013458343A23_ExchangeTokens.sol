...
contract ExchangeTokens is Context, Ownable {
    ...
    function exchange() public {
        ...
        require(QTUM.allowance(msg.sender, address(this)) >= amount, "exchange: contract not allowed to transfer enough QTUM for this exchange");
        require(WQTUM.balanceOf(address(this)) >= amount, "exchange: not enough WQTUM token in the contract for this exchange");
