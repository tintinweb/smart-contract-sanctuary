...
contract Buy is Ownable, CollectionManager, ReentrancyGuard {
...
contract ContractState {
    ...
    function statusOfNFTs(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            states[i] = NFTState({
                ...
                redeemed: stake.nftRedeemed(nft, tokenId),
    ...
    function statusOfUnlockedNFTs(
        ...
        return statusOfNFTs(stake, nft, tokenIds);
    }
    ...
    function statusOfLockedNFTs(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            stats[i] = NFTState({
                ...
                redeemed: stake.nftRedeemed(nft, tokenIds[i]),
                unlockTimestamp: stake
                    .getNFTStakeDetails(
                    nft,
