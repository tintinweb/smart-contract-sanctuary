...
contract GrailCoin is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Grailcoin", "Grail") ERC20Permit("Grailcoin") {
        _mint(/* GnosisSafe Address */ msg.sender, 1000000000 * 10 ** decimals() /* 1 billion tokens fixed */); 
    }
