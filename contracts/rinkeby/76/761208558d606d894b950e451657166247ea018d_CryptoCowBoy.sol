...
contract CryptoCowBoy is Ownable, ERC721Enumerable  {
    using SafeMath for uint256;

    bool public saleIsActive = false;
    string private baseURI = "http://cryptocowboysnft.com/metadata/?tokenId=";
    uint public MAX_PURCHASE = 5;
    uint256 public CURRENT_PRICE = 0.08 ether;
    uint256 public FIRST_BATCH = 1000;
    uint256 public MAX_TOKENS = FIRST_BATCH;

    constructor() ERC721("CryptoCowBoy", "CCB") {
        setBaseURI(baseURI);
    }
