...
contract Monkey2 is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private z = ['<!DOCTYPE html><html><body><svg height="500" width="500"><rect x="0" y="0" width="500" height="500" style="fill:#',
'"/><rect width="300" height="120" x="99" y="400" style="fill:#',
'"/><circle cx="190" cy="470" r="5" style="fill:#',
'"/><circle cx="310" cy="40" r="5" style="fill:#',
'"/><circle cx="100" cy="250" r="0" style="fill:#',
'"/><circle cx="100" cy="250" r="20" style="fill:#',
'"/><circle cx="400" cy="20" r="50" style="fill:#',
'"/><circle cx="400" cy="250" r="0" style="fill:#',
'"/><circle cx="250" cy="20" r="10" style="fill:#',
'"/><circle cx="250" cy="250" r="20" style="fill:#',
'"/><circle cx="200" cy="215" r="35" style="fill:#fff"/><circle cx="305" cy="22" r="31" style="fill:#fff"/><circle cx="200" cy="220" r="20" style="fill:#',
'"/><circle cx="300" cy="20" r="20" style="fill:#',
'"/><circle cx="200" cy="220" r="7" style="fill:#000"/><circle cx="300" cy="20" r="7" style="fill:#000"/>',
'<ellipse cx="250" cy="35" rx="84" ry="34" style="fill:#',
'"/><rect x="195" y="30" width="110" height="3" style="fill:#000"/><circle cx="28" cy="295" r="5" style="fill:#000"/><circle cx="232" cy="295" r="5" style="fill:#000"/>',
'</svg></body></html>'];

  string private cross='<rect x="5" y="75" width="10" height="40" style="fill:#872"/><rect x="8" y="25" width="30" height="10" style="fill:#872"/>';
  string private clo1='<rect width="30" height="120" x="9" y="40" style="fill:#';
  string private clo2='"/><rect width="50" height="55" x="20" y="40" style="fill:#';
  string private hh1='<rect width="200" height="99" x="10" y="4" style="fill:#';
  string private hh2='"/><rect width="200" height="33" x="10" y="106" style="fill:#';
  string private sl1='<rect x="150" y="19" width="20" height="30" style="fill:#';
  string private sl2='"/><rect x="160" y="170" width="10" height="50" style="fill:#';
  string private mou='<line x1="287" y1="31" x2="320" y2="366" style="stroke:#000;stroke-width:5"/>';

string private ey1='<rect x="160" y="19" width="75" height="15" style="fill:#';
string private ey2='"/><rect x="275" y="10" width="65" height="15" style="fill:#';
string private ey3='<rect x="160" y="23" width="10" height="50" style="fill:#';
string private zz='"/>';

string private ea1='<circle cx="10" cy="20" r="14" style="fill:#';
string private ea2='fe7';
string private ea3='999';
string private ea4='"/><circle cx="10" cy="20" r="4" style="fill:#000"/>';
string private ea5='<circle cx="1" cy="290" r="12" style="fill:#';
string private ea6='bdd';

string private mo1='<line x1="';
string private mo2='" y1="30" x2="';
string private mo3='" y2="31" style="stroke:#000;stroke-width:2"/>';
string private mo4='" y1="31" x2="';
string private mo5='" y2="32" style="stroke:#000;stroke-width:2"/>';
...
struct Ape {
  ...
  uint8 hat;
    ...
    function claim(uint256 tokenId) public nonReentrant {
        require(tokenId > 0 && tokenId < 9501, "TokenID invalid");
        _safeMint(_msgSender(), tokenId);
    }
    
    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
        require(tokenId > 9500 && tokenId < 10001, "TokenID invalid");
