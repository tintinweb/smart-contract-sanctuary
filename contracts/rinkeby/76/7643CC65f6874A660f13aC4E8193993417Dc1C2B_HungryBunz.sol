...
contract HungryBunz is Initializable, PaymentSplitter, Ownable, ERC721 {
        ...
        payable
    {
        ...
        //to revert on attempted reentry on ERC721 receiver function.
        ...
        for (uint i = 0; i < numberOfTokens; i++) {
            offset++;
            _mintToken(msg.sender, uint32(bytes4(signature)), offset); //Using msg.sender because we are not interested in allowing mints through proxies.    
        }
    }
    ...
    function consume(uint16 consumer, uint256 burn, uint16[] memory team) public {
        ...
        //call to the snax contract. Smooth brain solution.
