...
contract BabyMeta is ERC721, Ownable {
    ...
    uint256 public constant BABYMETA_PER_WALLET = 2;
    ...
    function bornWL(uint256 amount, bytes32[] calldata proof) public payable {
        ...
        require(verify(proof, msg.sender), "You are not listed on the WL");
        for (uint8 i = 0; i < amount; i++) {
            _mintElement(msg.sender);
        }
    }

    function bornOS(uint256 amount) public payable {
