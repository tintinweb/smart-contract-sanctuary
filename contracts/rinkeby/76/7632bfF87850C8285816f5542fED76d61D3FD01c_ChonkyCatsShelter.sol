...
// File: ChonkyCatsShelter.sol

contract ChonkyCatsShelter is ERC721 {
    uint256 public tokenCounter;
    constructor () public ERC721 ("ChonkyCatsShelter", "CHONKY"){
        tokenCounter = 0;
    }

    function mintME(string memory tokenURI) public returns (uint256) {
