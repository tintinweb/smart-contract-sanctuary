...
contract TESTBBBB is ERC721Enumerable, Ownable {
    ...
    uint256 constant MAX_NFT_SUPPLY = 100;
    ...
    constructor () ERC721 ("TESTBBBB", "TEB") {
        //for init
    ...
    function addAddressToFreeMint(address addr, uint claimAmount) onlyOwner public returns(bool success) {
        require(freeMintList[msg.sender].addr != msg.sender, "Already whitelisted");
    ...
    function freemint(uint256 num) public payable{
        ...
        require(freeMintList[msg.sender].addr == msg.sender, "Is not have free mint");
    ...
    function mint(uint256 num) public payable {
        ...
        if(_presaleActive){
            ...
            require(isWhitelistCanMint(msg.sender), "Can only mint 3 while whitelisted");
    ...
    function reserve(address addr, uint256 amount) public onlyOwner {
        require( totalSupply() + amount <= MAX_NFT_SUPPLY, "Exceeds maximum supply" );
