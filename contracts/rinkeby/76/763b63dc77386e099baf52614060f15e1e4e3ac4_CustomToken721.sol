...
contract CustomToken721 is NFTokenMetadata,Ownable
{

  
    constructor(string memory _nftName, string memory _symbol) public
    {
        nftName = _nftName;
        nftSymbol = _symbol;
    }
    ...
    function burn(uint256 _tokeID) external onlyOwner
    {
        super._burn(_tokeID);
    }
