...
// by @berkozdemir aka princess camel
                                                             
// A UTILITY TOKEN FOR GLICPIXXX RELATED ARTSY FART THINGIES

// FIRST IMPLEMENTATION IS GOING TO BE ARTGLIXXX

// GLICPIXXX IS LOVE, GLICPIXXX IS LIFE

// AN AESTHETICAL MOVEMENT BY BERK ÖZDEMİR
...
contract GLIXTOKEN is ERC20, Ownable {
    ...
    function mint(address to, uint256 amount) external returns(bool) {
        require(minterPermission[msg.sender], "Address don't have burn permission");
        _mint(to, amount);
        return true;
    }
