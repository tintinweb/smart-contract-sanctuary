...
contract SketchyPixelSpace is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sketchy Pixel Space", "SPS") {
    setHiddenMetadataUri("ipfs://QmSwenCNqKMAasP36odTyb7fPhhnjtDCYEYE2mzF4mzapJ/1.json");
  }
