...
contract Farm is IRandomnessConsumer, Proxied, PausableUpgradeable {
    ...
    uint256 public constant DAILY_GEN0_EGG_RATE = 10000000 ether; //RELEASE: 10000 ether;
    // Gen 1 Chickens earn 6000 $EGG per day
    uint256 public constant DAILY_GEN1_EGG_RATE = 6000000 ether; //RELEASE: 6000 ether;
    // Chicken must have 2 days worth of $EGG to unstake or else it's too cold
    uint256 public constant MINIMUM_TO_EXIT = 5 minutes; //RELEASE: 2 days;
    ...
    uint256 public constant MAXIMUM_GLOBAL_EGG = 2400000000000 ether;//RELEASE: 2400000000 ether;
    ...
    {
        return vrf.processingStats(claimsRequested, claimsProcessed, 1 hours); // release 12 hours
    }
    ...
    function checkRandomness(bool force) public {
        ...
        if (force) {
            ...
            vrf.checkRandomness(claimsRequested, claimsProcessed, 1 hours);
        }
