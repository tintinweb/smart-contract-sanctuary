...
contract DreamGardensNFT is ERC721Tradable {
  // JSONS
  string private _prerevealMetaURI = "https://gateway.pinata.cloud/ipfs/QmTaZQMzg2BrFAEXE8BEcfBrAuynmrXLm4Txcjo3ZxGqZs";
  string private _revealedMetaURI = "https://gateway.pinata.cloud/ipfs/Qme2fftoyuT5d7GA3c83krBdnh3D7xowVPkqV383vf2nH3/";
  ...
  //////////////////////////////////////////
  // DELETE THESE THREE
  function getNightmareURI() public view onlyOwner returns(string memory) {
    return _nightmareMetaURI;
  }

  function getPreRevealURI() public view onlyOwner returns(string memory) {
    return _prerevealMetaURI;
  }

  function getRevealedURI() public view onlyOwner returns(string memory) {
    return _revealedMetaURI;
  }
  //////////////////////////////////////////
  ...
  function tokenURI(uint256 _tokenId) override public view returns (string memory) {
    ...
    //return "https://gateway.pinata.cloud/ipfs/QmZbLjJnPvzNB8t6d9o7aFCPxNzaiPpUefCTXsjecgSDt2/"+1+".json";
  }
  ...
  function setNightmareMode(uint256 _tokenId) public  {
    ...
    // TODO: make sure owner owns this token
