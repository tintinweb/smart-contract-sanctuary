    ...
    RoyalPausableUpgradeable
{
    ...
    */ 
    ...
    function initialize() public initializer {
        ...
        // Pointed to Contract Metdata V0.7
        __ERC1155_init("https://royal-io.mypinata.cloud/ipfs/QmZQSw34kncRoaZfiw5SitQ4uTCn4Vztz8rpisC8jj59G9/{id}.json");
    ...
    function mintable(uint128 tierID) external view returns (bool) {
        return _tierCurrentSupply[tierID] < _tierMaxSupply[tierID];
    }
        ...
        onlyOwner
    {
        ...
        require(tierID != 0 && maxSupply >= 2, "Invalid tier definition");
        require(_tierCurrentSupply[tierID] == 0, "This tier has already been minted. Current supply has value");
        require(_tierMaxSupply[tierID] == 0, "This tier has already been minted. Max supply set.");
    ...
    // Overrides
    function _msgSender() override internal view virtual returns (address) {
