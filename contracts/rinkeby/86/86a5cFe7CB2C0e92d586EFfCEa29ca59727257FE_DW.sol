...
contract DW is ERC721Enumerable, Ownable {
    ...
    bytes32 private whitelistRoot = 0x372676213804d032a3fcd432a78723040277158a79c67c324cf0a440bd669455;
    ...
    constructor(string memory _baseUrl, string memory _notRevealedUrl) ERC721("DW", "DW") {
        baseURI = _baseUrl;
