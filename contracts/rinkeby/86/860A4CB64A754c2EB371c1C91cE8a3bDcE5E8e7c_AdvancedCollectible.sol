...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    // createCollectible(userProvidedSeed, tokenURI);
    // tokenURI: eips.ethereum.org/EIPS/eip-721:
    // "A distinct Uniform Resource Identifier (URI) for a given asset. Basically
    // this can be a URL, or API (in our case, we'll use IPFS) to a JSON file
    // In the json, it had name, description, image (url), and attributes
    ...
    // https://github.com/smartcontractkit/chainlink-brownie-contracts/blob/main/contracts/src/v0.6/VRFConsumerBase.sol#L121
