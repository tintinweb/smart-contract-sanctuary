...
contract TestClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test Club", "TCL") {
    setHiddenMetadataUri("ipfs://QmW98KgydkQADtCs8AunRaUgWPKdvADwM54wPtMjpwYQjP/2.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if (presale) { //contract dont allow minting if presale is set and buyer is not in whitelisted map
