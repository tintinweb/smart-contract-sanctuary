...
library Trigonometry {
     ...
     * integer.
     *
     * @param _ratio A 256-bit ratio as a number in the range 0 to infinite.
     *               angle units, instead of the standard 360 degrees.
     * @return The arctan result as a number in the range 0 to 340282366920938463463374607431768211455 (2^256).
     */
...
contract Space {
    ...
    function test_arctan(uint256 val) public pure returns (uint256) {
        return Trigonometry.arctan(val);
    }
