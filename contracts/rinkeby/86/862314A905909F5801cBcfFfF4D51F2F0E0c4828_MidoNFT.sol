...
contract MidoNFT is ERC721, AccessControl {
    ...
    constructor(uint64 _maxNFTSupply) ERC721("MidoNFT", "MIDONFT") {
    ...
    /**
    * @dev Call to mint new tokens, only by Minter
    *  Can mint up to maxNFTSupply tokens
    * @param _amount amount of tokens to mint
    * @param _to recipient of tokens
    */
    function mintNFT(uint64 _amount, address _to) external onlyRole(MINTER_ROLE) {
    ...
    /**
    * @dev Call to increase the total number of NFTs supply.
    * Can only be called by the minter.
    * @param _amount amount of tokens to increase
    */
    function increaseTotalSupply(uint64 _amount) external onlyRole(MINTER_ROLE) {
        maxNFTSupply+=_amount;
    }

    /**
    * @dev add minter to a new address.
