...
contract ProofAssetToken is ERC20 {
    ...
    IERC20 public prf = IERC20(0x8f56e55bf6E7f211cB2F04380152834f650364e5);    
    prfInterface public prfInterfaceCall = prfInterface(0x8f56e55bf6E7f211cB2F04380152834f650364e5);
    address private smart;
    event CheckIn(address indexed addr, uint256 prfs);    
    event RateUp(uint256 value);
    constructor() public {
        smart = address(this);
    }
    ...
    function prf2prs(uint256 amount) external {
        ...
        prfInterfaceCall.fnSwap(msg.sender, amount);
