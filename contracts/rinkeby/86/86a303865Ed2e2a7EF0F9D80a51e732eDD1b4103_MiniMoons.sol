...
contract MiniMoons is Context, ERC1155Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 constant TOTAL_TYPES = 10;
    uint256 constant BASIS_POINTS = 100;
    uint256 public maxMintsAllowed = 100;
    uint256 public maxTokensPerMint = 10;
    uint256 public mintingFee = 30000000000000000;
    uint256 public totalMints = 0;
    uint256 public nonce = 0;
    uint256[] internal weights = [40, 15, 10, 10, 5, 5, 5, 4, 4, 2];
    address public lootContractAddress =
        0x38df8Ed5455961D9d9493eCe76682E3dff6F5330;
    Loot public lootContract = Loot(lootContractAddress);
    ...
    function mint() public payable nonReentrant {
        ...
        require(totalMints < maxMintsAllowed, "All Tokens Have Been Minted");
        if (onlyLootHolders) {
            require(
        ...
        totalMints = totalMints + amount[0];
    }
    ...
    function mintBatch(uint256 _amount) public payable nonReentrant {
        ...
        require(
            (totalMints + _amount) < maxMintsAllowed,
        ...
        for (uint256 i = 0; i < tokens.length; i++) {
            ...
            totalMints = totalMints + _quantity;
        }
    }
