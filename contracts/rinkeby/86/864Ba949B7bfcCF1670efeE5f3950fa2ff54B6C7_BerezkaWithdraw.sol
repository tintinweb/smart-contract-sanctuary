...
contract BerezkaWithdraw is Ownable {
    ...
    function withdraw(
        ...
        // Check that signature is not expired
        //
        require(
    ...
    function isValidSignature(
        ...
        return recover(_price, _timestamp, _signature) == oracleAddress;
    }
    ...
    function recover(
        ...
        bytes32 dataHash = keccak256(abi.encodePacked(_price, _timestamp));
