...
contract Game is Ownable, IERC721Receiver, IERC1155Receiver, ReentrancyGuard {
    ...
    mapping(uint256 => uint256) public powerUp; //time to increase to current tod
    ...
    function isAlive(uint256 _playerId) public view returns (bool) {
        return timeUntilDeath(_playerId) == 0 ? false : true;
    }
    ...
    */
    ...
    function register(
        ...
        TOKEN.burnFrom(msg.sender, 40 * 1 ether); //burn 40 royal to join and get 3 days.
    ...
    function buyPowerUp(uint256 _id, uint256 _amount) public {
        ...
        timeWenDed[_id] += getAmountOfTOD(_amount); //TODO check this works and think.
        tokenBurnt += _amount;
        ...
        payable
    {
        ...
        require(timeUntilDeath(_opponent) > timeToDecrease + 8 hours, "!kill");
    ...
    function kill(uint256 _opponentId) public nonReentrant {
        ...
        TOKEN.mint(msg.sender, 15 * 10**18); //TODO decide on tokens given for killing
        playersAlive--;
    }
