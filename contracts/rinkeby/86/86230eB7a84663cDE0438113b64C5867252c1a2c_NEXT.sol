...
contract NEXT is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xFF0dF0BDA102aecDaD1b2A9BC96BBf7e59b216da;
    ...
    string private constant _name = "Exploration NEXT";
    ...
    function transferToFeeWallet() internal {
        swapTokensForEth(_marketingFeeBalance, _marketingWalletAddress);
