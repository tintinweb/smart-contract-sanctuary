...
//Contract
contract MferGame is ERC721Enumerable, Pausable, ReentrancyGuard {
    bytes32 internal entropySauce;


    string _baseTokenURI = "ipfs://QmWiQE65tmpYzcokCheQmng2DCM33DEhjXcPB6PanwpAZo/";//defaults to mfers metadata for testing

    address public owner;

    address constant internal nullAddress = address(0x0);

    ICoin internal coinContract;
    IStaking internal stakingContract;

    uint constant MAX_SUPPLY = 10021;
    uint constant ETH_MINT_SUPPLY = 5;
    uint constant public mintCost = 0.05 ether;
    uint constant public coinPhasePriceIncrease = 2000 ether;
    ...
    /// @dev Constructor
    constructor() ERC721("MferGame", "MferGame") {
        owner=msg.sender;
    }
