...
contract CybordMercenariesNFT is ERC1155, Ownable {
    ...
    uint256 public constant  VIP_NFT_PRICE       = 100000000000000000;  // VIP price 0.15 ETH
    uint256 public constant  WHITELIST_NFT_PRICE = 120000000000000000;  // Whitelist price 0.15 ETH
    ...
    string public contractState  = "NOT_ACTIVE"; // Good values : NOT_ACTIF, VIP_SALE, WHITELIST_SALE, RAFFLE, PUBLIC_SALE
