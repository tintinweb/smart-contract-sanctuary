...
contract Blitnauts is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string public compileInstructions = 'Call frameDataFor(tokenID) and inspect the returned .txHash on an archive node. ETC ETC';

    constructor(address _blitmapContractAddress) ERC721("Blitnaut", "NAUT") Ownable() {
        blitmapContractAddress = _blitmapContractAddress;
        blitmapContract = BlitmapContract(blitmapContractAddress);

        setBaseURI("https://api-blitnauts.blitmap.com/v1/metadata/");
    }
