...
contract NFT_721 {
    ...
    function transferFrom(address _from, address _to, uint256 _tokenId) external payable{
        require(_from == msg.sender || tokenApprovals[_tokenId] == msg.sender || operatorApprovals[_from][msg.sender]);
        require(_to != address(0));
        require(tokenOwners[_tokenId] == msg.sender || tokenApprovals[_tokenId] == msg.sender || operatorApprovals[_from][msg.sender]);
        tokenOwners[_tokenId] = _to;
        emit Transfer(_from,  _to, _tokenId);
    }
