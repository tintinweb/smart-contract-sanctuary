...
contract COCA is ERC721, Ownable, ERCWithdrawable {
    // Constructor
    constructor() ERC721("The Club of Cool Ape", "COCA") {}
    ...
    function isWhitelisted(address address_) public view returns (bool) {
        return presaleWhitelist[address_];
    }
    ...
    function presaleMint(uint16 amount) external payable onlySender whitelistSale {
        require(isWhitelisted(msg.sender), "You are not whitelisted!");
        require(amount <= 2, "Max 2 mints per transaction");
        require(addressToPublicMinted[msg.sender] < 4, "Max 4 mints per account!");
    ...
    function setPresale(bool bool_) external onlyOwner {
