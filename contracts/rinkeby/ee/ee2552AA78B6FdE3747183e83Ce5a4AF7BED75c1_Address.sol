...
contract PFPoop is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    uint256 public _mintPrice = 20000000000000000; //0.02 ether

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmeEoM1yaeL7nEu3cNqwCoF1kQjYja2Hgfjq2JrqwVPEMa/";
    ...
    /**
     * Operator mechanism to allows operator to transfer token en behalf
     * Allow gas free listing on selected marketplaces
     */
    ...
    /*
    * END: Operator mechanism
    */


    /*
    * Implementation of ERC2771 that allow Metatransaction (in order to pay gas fees to user)
    */
