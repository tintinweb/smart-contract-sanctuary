...
contract PAPRUSDCpoolFarmingV3 is Ownable, ContractGuard {
    ...
    address public trustedDepositTokenAddress = 0xf7A7eCeB7BE17695B31aFe76D90182f0b5152995;
    // Earned Tokens address : PRNTR
    address public trustedRewardTokenAddress = 0xB7F7644f999D34fB58cE91b3dBc26B0Bf7081337;
    
    address public prntr = 0xb40e2e77aADe08b19235Db2e6E709447842AF813;
    address public unirouter = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;

    // Amount of tokens
    uint public disburseAmount = 50000e18;
    ...
    function swapToPRNTR(uint256 _amount) public {
    IUniswapRouterETH(unirouter).swapExactTokensForTokensSupportingFeeOnTransferTokens(_amount, 0, usdcToPRNTRRoute, address(this), now);
    }
    ...
    function updateAccount(address account) private {
        ...
        if (pendingDivs > 0) {
            require(Token(prntr).transfer(account, prntrBal), "Could not transfer tokens.");
    ...
    function withdraw(uint amountToWithdraw) public onlyOneBlock {
    ...
    function claim() public onlyOneBlock {
        updateAccount(msg.sender);
    }
