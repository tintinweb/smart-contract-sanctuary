...
contract TBM is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    //presale settings
    uint256 public presaleDate = 1640100600;
    mapping(address => uint256) public presaleWhitelist;
    uint256[] public mintArray;
    

    //share settings
    // address[] private addressList = [
    //     0x8D1E02E5c9322e9bbF82AD843Ac779bf7a2552d7,0x8D1E02E5c9322e9bbF82AD843Ac779bf7a2552d7
    // ];
    // uint256[] private shareList = [20, 80];
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        ...
        for (uint256 i = 0; i < _mintAmount; ++i) {
            _safeMint(msg.sender, mintArray[s + i-1], "");
        }
        delete s;
    }
    ...
    function mintArraySet(uint256 _array) public onlyOwner {
        mintArray.push(_array);
    }
