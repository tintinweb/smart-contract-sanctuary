...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function endLottery() public onlyOwner {
        // The below is a bad way of getting a pseudo-random number
    ...
    // Override the original declaration of the fulfillRandomness (meant to be overriden so VRFCoordinator can call this as a callback)
