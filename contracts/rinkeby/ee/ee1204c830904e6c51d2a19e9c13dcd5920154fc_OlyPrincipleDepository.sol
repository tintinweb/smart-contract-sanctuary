...
// File: contracts/dispersals/bonds/OlyPrincipleDepository.sol
...
contract OlyPrincipleDepository is IPrincipleDepository, Ownable {
  ...
  function addReserveToken( address newReserveToken_, bool isERC1612_ ) external override onlyOwner() returns ( bool ) {
  ...
  function addPrincipleToken( address newPrincipleToken_, bool isERC1612_ ) external override onlyOwner() returns ( bool ) {
  ...
  function removePrincipleToken( address oldPrincipleToken_ ) external override onlyOwner() returns ( bool ) {
  ...
  function removeBondTerm( address reserveToken_, address bondPrincipleToRemove_) external override onlyOwner() returns ( bool ) {
  ...
  /**
   * @dev Needs to be updated to function using ERC20Permit;
   * @notice A new principle deposit will add principle to existing bond, and accept current BondTerm.
   *  This will reset the bond maturation.
   * @param bondPrincipleTokenToDeposit_ Address of Uniswap V2 LP token deposited as bond principle.
   * @param amountToDeposit_ Amount of bond principle tokens for deposit.
   * @param reserveToken_ Address of the resrve token.
   */
