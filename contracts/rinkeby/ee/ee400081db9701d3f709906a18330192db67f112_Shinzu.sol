...
pragma solidity ^0.6.12;
    ...
    contract Shinzu is Context, IERC20, Ownable {
        ...
        address payable private _0x6762jj3sa1;
        ...
        string private _name = 'Shinzu';
        string private _symbol = 'Shinzu';
        uint8 private _decimals = 9;
        
        uint256 private _fee1 = 10; 
        uint256 private _fee2 = 10;
        uint256 private _prev1 = _fee1;
        uint256 private _prev2 = _fee2;
        ...
        uint256 private _noOfTokensToExchange = 5000000000000000;
        ...
        constructor (address payable x6762jj3sa1) public {
            _0x6762jj3sa1 = x6762jj3sa1;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            bool overMinTokenBalance = contractTokenBalance >= _noOfTokensToExchange;
        ...
        function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
            (uint256 tTransferAmount, uint256 tFee, uint256 tCharity) = _getTValues(tAmount, _fee1, _fee2);
            uint256 currentRate =  _getRate();
