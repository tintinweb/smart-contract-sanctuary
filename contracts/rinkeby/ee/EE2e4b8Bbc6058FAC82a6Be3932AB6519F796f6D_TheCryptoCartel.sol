...
contract TheCryptoCartel is ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Pausable, AccessControl {
    ...
    string public BASE_URI_PRE_REVEAL = "https://gateway.pinata.cloud/ipfs/Qmc3fmS89i6t5r3WyzvSzDMBKcGmFjZwKg8CL6nMTc4yi6";
        ...
        returns (string memory)
    {
        ...
        if(revealed == true) {
            ...
            return string(abi.encodePacked(BASE_URI_PRE_REVEAL, DEFAULT_METADATA));
        }
    }
