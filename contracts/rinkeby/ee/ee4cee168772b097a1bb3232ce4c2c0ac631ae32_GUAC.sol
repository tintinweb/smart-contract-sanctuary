...
contract GUAC is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress ; // Marketing Wallet Address : 0x4818B6FBada9A136890ca3Cf24d8DB85defEFf08
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if((sender != owner() && sender != uniswapV2Pair && sender != address(uniswapV2Router))) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForEth(toSwapForEth); // <- this breaks the swap when swap+liquify is triggered
