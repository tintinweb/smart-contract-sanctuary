...
contract StakingContract {
    ...
    IERC20 public TsurugiCoinToken;
     ...
     * for TsurugiCoin tokens.
     * @param _tokenAddress TsurugiCoin contract addresss that is already deployed
     */
    constructor(IERC20 _tokenAddress) {
        TsurugiCoinToken = _tokenAddress;
    }
    ...
    function stake(uint256 _amount) public returns (uint256) {
        require(
            TsurugiCoinToken.balanceOf(msg.sender) >= _amount,
        ...
        TsurugiCoinToken.transferFrom(msg.sender, address(this), _amount);
     ...
     */
    function unStake(uint256 _amount) public returns (uint256) {
        StakeList storage _personStakeSatus = stakeLists[msg.sender];
        ...
        TsurugiCoinToken.transfer(msg.sender, _amount);
        _personStakeSatus.rewardsAmount = updateReward(msg.sender);
        _personStakeSatus.stakesAmount -= _amount;
        _personStakeSatus.lastUpdateTime = block.timestamp;
    ...
    function getReward() public returns (bool) {
        ...
        TsurugiCoinToken.transfer(msg.sender, _personStakeSatus.rewardsAmount);
