...
contract Bollystake is ERC20("sBOLLY Staked Bollycoin", "sBOLLY"){
    ...
    IERC20usdt usdt = IERC20usdt(address(usdt_address));

    // Define the BOLLY token contract
    constructor(address _usdt,IERC20 _BOLLY, address _owner) {
       ...
       returns(uint256)
   {
    ...
    function enter_stake(uint256 _amount) public {
        ...
        require(_amount >= 10000*10e18,"minimum 10000 BOLLY needs to be staked");
