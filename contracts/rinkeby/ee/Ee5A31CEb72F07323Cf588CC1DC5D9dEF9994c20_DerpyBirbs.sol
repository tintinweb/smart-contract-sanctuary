...
contract DerpyBirbs is Context, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    address payable internal artTeam = payable(0x23aD59Cc6aFff2E508772F69D22b19FfEBf579e7); 
    address payable internal devTeam = payable(0xdEC5190D59Ed370Aeed30341DCda3a2b8888e9c2);

    string internal _baseTokenURI;
    bool internal saleStarted = false;
    bool internal devSupplyAwarded = false;
    ...
    /**
    * Can only be called once. Gives 64 Birbs to devs for giveaways, marketing purposes and team members.
    * 28 of these will go to Treasure Chests holders.
    */
    function awardDevs() external {
        require(saleStarted == false);
        require(devSupplyAwarded == false);
        uint i;
        uint id;
    ...
    */
    ...
    function mint(address to, uint amount) external payable{
        ...
        require(amount <= MAX_MINTS_PER_TRANSACTION, "Trying to mint to many");
