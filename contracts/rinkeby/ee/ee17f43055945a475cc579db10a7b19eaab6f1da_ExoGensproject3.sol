...
contract ExoGensproject3 is ERC721("ExoGens Official Collection", "ExoGens"), ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    string private baseURI;
    string private blindURI;
    string public jsonparam = 'json';
    ...
    uint256 public NFTPrice = 110000000000000000;  // 0.11 ETH
    bool public reveal;
    ...
    */
        ...
        onlyOwner 
    {
        ...
        payable(address(0x8bc186967bB71b80de80085C9a227573D8209085)).transfer(balance);
    }
