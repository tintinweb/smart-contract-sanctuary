...
contract TacticalTangrams is ERC721URIStorage {
	...
	function mint() public payable {
		//require(msg.value <= mintPrice * maxMintPerAddress, "Too much ETH sent");
		//uint8 numberOfTansToMint = uint8(msg.value / mintPrice);
		//require(mints[msg.sender] + numberOfTansToMint <= maxMintPerAddress, "Maximum allowed mints per address is 7");
