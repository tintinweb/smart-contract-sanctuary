...
contract MetaverseCapital is Context, IERC20, Ownable {
    ...
    address payable public treasuryAddress = payable(0x6f11b5A9d2c997ccC7F3359218a32aC47Daf7796); // Treasury Address
    ...
    constructor() payable {
        ...
        maxBuyAmount = _tTotal * 1 / 1; // no maxTransactionAmountTxn
        maxSellAmount = _tTotal * 1 / 1; // no maxTransactionAmountTxn
