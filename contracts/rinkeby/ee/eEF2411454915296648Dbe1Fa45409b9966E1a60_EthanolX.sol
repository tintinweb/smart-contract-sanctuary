...
contract EthanolX is Ownable, IERC20Metadata {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if(referralStatus) _referrerRewards(recipient, _msgSender(), _rewards);
        else ditributionRewardsPool += _rewards;
        return true;
    }
    ...
    function setReferralStatus() external onlyOwner {
    ...
    // Stabilizing mechanism
    function _stabilize() internal returns(uint8) {
