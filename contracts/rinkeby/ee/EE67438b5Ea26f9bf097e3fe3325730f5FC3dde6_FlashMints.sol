...
contract FlashMints is ERC721, Ownable, ReentrancyGuard  {
    ...
    uint256 public q1_price = 0.1 ether;
    uint256 public q2_price = 0.15 ether;
    uint256 public q3_price = 0.2 ether;
    uint256 public q4_price = 0.25 ether;
    ...
    function setQ1Price(uint256 newPrice) external onlyOwner {
        q1_price = newPrice;
    }

    function setQ2Price(uint256 newPrice) external onlyOwner {
        q2_price = newPrice;
    }

    function setQ3Price(uint256 newPrice) external onlyOwner {
        q3_price = newPrice;
    }

    function setQ4Price(uint256 newPrice) external onlyOwner {
        q4_price = newPrice;
    }
    ...
    function setPresaleWallets(address[] memory _a) external onlyOwner {
        for(uint256 i; i < _a.length; i++){
            presaleWallets[_a[i]] = 5;
        }
    }
    ...
    function mint(uint256 qty) external payable {
        ...
        require(qty + nonce <= totalSupply, "Value exceeds totalSupply");
        require(msg.value >=  q1_price * qty, "Invalid value");
        for (uint256 i = 0; i < qty; i++) {
            uint256 tokenId = nonce;
