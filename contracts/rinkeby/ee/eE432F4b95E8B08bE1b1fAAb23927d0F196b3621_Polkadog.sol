...
contract Polkadog is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(_takeBothTax) {
            ...
            (taxAmount.tTransferAmount, taxAmount.tFee, taxAmount.tLiquidity, taxAmount.tBurn, taxAmount.tMarketingFee) = getTaxTValues(tAmount, receiver);
            (taxAmount.rAmount, taxAmount.rTransferAmount, taxAmount.rFee) = getTaxRValues(tAmount, taxAmount.tFee, taxAmount.tLiquidity, taxAmount.tBurn, taxAmount.tMarketingFee, receiver);
        } else {
            address receiver = recipient;
