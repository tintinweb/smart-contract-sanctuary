...
import "../../token/ERC777/ERC777Standard.sol";
import "./interfaces/IMasterERC777.sol";
import "../../access/ContractOwner.sol";

contract MasterERC777Standard is ContractOwnable, IMasterERC777 {
  ERC777Standard[] private childERC777Standard;
  ...
  function createERC777(
    ...
    ERC777Standard child = new ERC777Standard(
      name,
      symbol,
      decimal,
    ...
    childERC777Standard.push(child);
