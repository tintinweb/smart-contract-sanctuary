...
import "./IWalletOfOwner.sol";

contract ApePunks is ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    IWalletOfOwner private _hodlGang;
    ...
    function mintHodlGang() public payable saleIsOpen {
    ...
    function setHodlGang(address hodlGang) external onlyOwner {
        _hodlGang = IWalletOfOwner(hodlGang);
    }
}
