...
contract PunkKub is ERC721Enumerable {
    /*
  ___                                    _          
 / _ \                                  (_)         
...
\_| |_/_| |_|\___/|_| |_|\__, |_| |_| |_|_|\___\___|
                         ...
                         |___/                      
*/
    using PunkKubLibrary for uint8;
    ...
    constructor() ERC721("Anonymice", "MICE") {
        ...
        //Eyes
        TIERS[1] = [50, 100, 400, 450, 500, 700, 1800, 2000, 2000, 2000];
        //Mouth
        TIERS[2] = [1428, 1428, 1428, 1429, 1429, 1429, 1429, 2000,3000,3000];
        //Nose
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
    ...
    function randomLearn(uint256 _t, address _a, uint256 _c) public returns(uint256) {
        uint16 _randinput;
        for (uint8 i = 0; i < traitNum; i++) {
            SEED_NONCE++;
            _randinput = uint16(
                uint256(
                    keccak256(
    ...
    function mintInternal() internal {
        ...
        require(!PunkKubLibrary.isContract(msg.sender));
...
*/
        ...
        returns (string memory)
    {
        ...
        for (uint8 i = 0; i < traitNum + 1; i++) {
            uint8 thisTraitIndex = PunkKubLibrary.parseInt(
                PunkKubLibrary.substring(_hash, i, i + 1)
            );
            ...
            for (
                ...
                string memory thisPixel = PunkKubLibrary.substring(
                ...
                uint8 x = letterToNumber(
                    PunkKubLibrary.substring(thisPixel, 0, 1)
                );
                uint8 y = letterToNumber(
                    PunkKubLibrary.substring(thisPixel, 1, 2)
                );
                ...
                svgString = string(
                    abi.encodePacked(
                        svgString,
                        "<rect class='c",
                        PunkKubLibrary.substring(thisPixel, 2, 4),
                        "' x='",
                        x.toString(),
                        "' y='",
                        y.toString(),
        ...
        svgString = string(
            abi.encodePacked(
                ...
                svgString,
                "<style>rect{width:1px;height:1px;} #mouse-svg{shape-rendering: crispedges;} .c00{fill:#000000}.c01{fill:#21ab09}.c02{fill:#ffffff}.c03{fill:#fa6597}.c04{fill:#e3d307}.c05{fill:#b0ab06}.c06{fill:#218011}.c07{fill:#e83535}.c08{fill:#137de9}.c09{fill:#58cfff}.c10{fill:#5eff58}.c11{fill:#fff658}.c12{fill:#ff58e0}.c13{fill:#a09d9d}.c14{fill:#0204f8}.c15{fill:#ef6d2c}.c16{fill:#bacedc}.c17{fill:#e0e0e0}.c18{fill:#642600}.c19{fill:#6a3617}.c20{fill:#a04d1b}.c21{fill:#cdba47}.c22{fill:#f7d60d}.c23{fill:#845538}</style></svg>"
            )
        );
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    PunkKubLibrary.encode(
                        bytes(
                            string(
                                abi.encodePacked(
                                    '{"name": "Anonymice #',
                                    PunkKubLibrary.toString(_tokenId),
        ...
        returns (string memory)
    {
        ...
        if (ownerOf(_tokenId) == 0x000000000000000000000000000000000000dEaD) {
            tokenHash = string(
                abi.encodePacked(
                    "1",
                    PunkKubLibrary.substring(tokenHash, 1, 9)
                )
            );
        }
 ...
 \___/   \_/\_/  |__|__||_____||__|\_|    |__|    \__,_||__|__|\____| |__|  |____|\___/ |__|__| \___|
    ...
    */
    ...
    function clearTraits() public onlyOwner {
        for (uint256 i = 0; i < traitNum + 1; i++) {
            delete traitTypes[i];
        }
    }
