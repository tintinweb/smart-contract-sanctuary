...
contract CheYuWuXNobody is ERC721, Ownable {
  ...
  address public c1 = 0x5D85fDA5516b63F70B995748010b27eEb3d1e736; 
  address public c2 = 0xc3F419b637Df272e19eB86A39cde5dcA04Df46D5; 


  mapping(address => uint256) claimAllowance;
  mapping(address => uint256) presaleAllowance;

  constructor (uint _maxNobody, uint _maxNobodyPerPurchase, uint _price ) ERC721("CheYuWuXNobody", "CheYuWuXNobody") {
  ...
  function setWhitelistAllowances(address[] memory _to, uint256 _allowance) public onlyOwner {
  ...
  function setClaimAllowances(address[] memory _to, uint256 _allowance) public onlyOwner {
      for (uint256 i = 0; i < _to.length; i++) {
          claimAllowance[_to[i]] = _allowance;
      }
  }
