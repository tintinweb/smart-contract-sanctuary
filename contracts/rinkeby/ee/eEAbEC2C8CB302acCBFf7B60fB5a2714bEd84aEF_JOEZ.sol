  ...
  ReentrancyGuard
{
  ...
  // Presale
  mapping(address => bool) private boughtPresale;
  ...
  external onlyOwner {
    ...
    _mintReserveTokens(msg.sender, reserveMintCount);
  }
  ...
  function getPresaleSigningHash(
    ...
    return
      keccak256(
        abi.encodePacked(sender, tokenCount, presaleMaxMint)
      );
  }
  ...
  function _mintTokens(
    ...
    require(_lastReserveTokenId < TOTAL_SUPPLY, "This has been fully minted");
    require((_lastReserveTokenId + tokenCount) <= TOTAL_SUPPLY, "Cannot purchase more than the available supply");
