...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x20919A4Ba2a95a22f144752EdF6C556Da45d3764;
...
contract bSATOSHI is ERC20, Ownable {
   ...
   bSATOSHIDividendTracker public dividendTracker;
    ...
    address private _dividendToken = 0x20919A4Ba2a95a22f144752EdF6C556Da45d3764;
    ...
    function swapAndSendToDev(uint256 tokens) private {
        ...
        address payable _devAndMarketingAddress = payable(0x1284A9ec75d2fBEa09df0e5Ca988fF6A11005732);
