...
contract NFT721 is ERC721EnumerableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 private MaxTokensPerPresale;

    uint256 private MaxTokensPerSale;
    ...
    function mintPresale(address to, uint count) public payable onlyPresale nonReentrant{
     ...
     * @dev generates a next bit number based on block info, sender and previous seed
