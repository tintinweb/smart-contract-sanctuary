...
abstract contract ERC721URIStorage is ERC721 {
    ...
    function _setTokenURI(uint256 tokenId, string memory _tokenURI) internal virtual {
        ...
        _tokenURIs[tokenId] = string(abi.encodePacked(_tokenURI, tokenId)) ;
    }
...
contract JungleFreaks is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address princeWallet = 0xc3413814669A07898819b166Ba4560Ac80D5F7b6;
    address shWallet = 0x20b96AC4B1fEe570E710F5b48d7Be0403730fbBF;
    address devWallet = 0xA9faDB8D48b48Dc1b94F784549c36850253690ae;
    address rkWallet = 0x3e887F97b3683aAaF6d7d6095dB399E4F9Ab8f1d;

    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('DHGGGGG', 'CJDHG') {}
    ...
    function internalMint(address to) internal {
        ...
        _setTokenURI(newItemId, _formatURI("http://103.206.21.63:8081/", _uint2str(newItemId)));
      //  _setTokenURI(newItemId, "http://103.206.21.63:8081/1/1.json");
    ...
    function mint(uint256 amount) public payable {
      ...
      //  require(amount <= 500, 'only 3 per transaction allowed');
        for (uint256 i = 0; i < amount; i++) internalMint(msg.sender);
    }
