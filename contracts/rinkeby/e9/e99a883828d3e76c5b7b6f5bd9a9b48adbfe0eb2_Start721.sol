...
contract Start721 is ERC721Tradable {
    ...
    string public _baseTokenURI="https://gateway.pinata.cloud/ipfs/Qmd6QN48YmV5k93gNkNksrU4W8RBDv2T5mTYYDk7EdXfiL/";
    
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Against All Odds by Felix Ip", "AAOFI", _proxyRegistryAddress)
    {}
    ...
    function contractURI() public pure  returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmaecyUgSt7cL9dxSVKj9efXwkTQwM3tV7iqBLrBDnYdix";
    }
}