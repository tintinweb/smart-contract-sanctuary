    ...
    HasSecondarySaleFees
{
    ...
    function setGlobalOperator(address operator) external onlyAdmin {
        _setupRole(OPERATOR_ROLE, operator);
    }

    function removeGlobalOperator(address operator) external onlyAdmin {
    ...
    function createPreorder(
        ...
        require(!isPreorder[_preorderTokenId]); // is not already a master
        ...
        returns (address payable[] memory)
    {
        ...
        // TODO: test that you can change this admin at this index
