    ...
    ReentrancyGuard
{
    ...
    address _proxyRegistryAddress = 0xF57B2c51dED3A29e6891aba85459d600256Cf317;
    ...
    function mint(uint256 toadId, string memory notSoSecretCode)
        public
        payable
        nonReentrant
    {
        require(isVibe(notSoSecretCode), "Code Invalid");
    ...
    function mintMultiple(
        uint256[] memory toadIds,
        string memory notSoSecretCode
    ...
    function mintSpecial(uint256 toadId, string memory notSoSecretCode)
        public
        payable
        nonReentrant
    {
