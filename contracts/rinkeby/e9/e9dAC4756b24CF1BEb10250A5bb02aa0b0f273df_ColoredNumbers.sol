...
contract ColoredNumbers is ERC721Enumerable, Ownable {
    ...
    function seed(uint256 blockNum) public view returns (uint256) {
        return uint256(keccak256(abi.encodePacked(blockhash(blockNum - 1))));
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return formatTokenURI(tokenId, seed(mintedBlockNumber[tokenId]), imageURI);
    }
