...
contract animalMain is  ERC721,Ownable {
  ...
  using SafeMath for uint256;
    string public name_ = "kappatoken";
  ...
  function seeAnimalSex(uint256 _tokenId) public view returns (uint16 sex) {
    return animals[_tokenId].sex;
  }
  ...
  function createAnimal() public payable {
      ...
      uint id = animals.push(animal(dna, uint8(star), uint8(roletype),uint8(sex))) - 1;
