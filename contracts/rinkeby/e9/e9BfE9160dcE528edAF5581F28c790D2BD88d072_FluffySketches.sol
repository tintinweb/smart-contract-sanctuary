...
contract FluffySketches is ERC1155, Ownable {
    ...
    address public constant CHARITY_ADDRESS = 0x16eFE37c0c557D4B1D8EB76d11E13616d2b52eAF;
    ...
    uint256 public constant PRICE_PER_TOKEN = 0.077 ether;
    mapping(address => uint8) private _allowList;
    uint256 constant private _tokenId = 1;
    
    constructor() ERC1155("https://kodbilen.com/") {}
    ...
    /**
     * @dev Activate the presale
     */
    function setPresaleActive(bool _hasPreSaleActive) external onlyOwner {
        hasPreSaleActive = _hasPreSaleActive;
    }
    ...
    function preSaleMint(uint256 numberOfTokens) external payable {
        //require(hasPreSaleActive, "Pre-sale minting is not active");
        // require(numberOfTokens <= _allowList[msg.sender], "Exceeded max available to purchase");
        require(numberOfTokens <= MAX_FLUFFY_SKETCHES, "Purchase would exceed max tokens");
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        uint toArtist = (balance * CHARITY_FEE) / SHARE_SUM;
        ...
        payable(msg.sender).transfer(toPool);
