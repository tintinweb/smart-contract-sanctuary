...
contract Whitelist is Ownable {
  ...
  mapping (address => bool) internal whitelistedMap;
  ...
  function addAddress(address _address)
    ...
    onlyOwner
  {
    require(whitelistedMap[_address] != true,"Account already exist");
...
contract PrivateVesting is Ownable, ReentrancyGuard,Whitelist{
   ...
   //Whitelist whitelist = new Whitelist;
    ...
    uint256 private getTotalReleasedAmount;
    mapping(address => uint256) private holdersVestingCount;
    mapping (address => bytes32) private bytes32IDs;
    ...
    */
     ...
     */
    constructor(address token_,uint256 _cliff,uint256 _start, uint256 _duration,uint256 _slicePeriodSeconds ) {
    ...
    */
    function createVestingSchedule(
        ...
        require(isWhitelisted(_beneficiary)!= false ,"Whitelist: Beneficiary must be pre-regesitred");
        ...
        bytes32IDs[_beneficiary] = vestingScheduleId;
    ...
    */
    function release(
        ...
        getTotalReleasedAmount = getTotalReleasedAmount.add(amount);
    ...
    */
    ...
    /**
    * @dev Computes the byte32 ID for a vesting schedule.
    * @return the byte32 ID
    */
    
    function computeByteIdForAddress(address holder)
        public
        view
        returns(bytes32){
            
           return bytes32IDs[holder];
    }
    ...
    */
    ...
    returns(uint256){
        ...
        if ((currentTime < start.add(cliff_) ) || vestingSchedule.revoked == true) {
            return 0;
