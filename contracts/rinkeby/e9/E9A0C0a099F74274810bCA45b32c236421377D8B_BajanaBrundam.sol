...
contract BajanaBrundam is ERC1155, Ownable {
    // TODO: Will generate a new one for real deployment
    address private passwordSigner = 0x37eC452B7DD2E86e0B15752d20b0a48e41869eEF;

    uint private constant GOLD_PASS_ID = 1;
    uint private constant SILVER_PASS_ID = 2;

    string public name = "Bajana Brundam";
    string public symbol = "BBM";

    uint16 private maxGoldPasses = 1300;
    uint16 private maxSilverPasses = 1300;

    uint16 private currentGoldPassCount = 0;
    uint16 private currentSilverPassCount = 0;

    uint private silverPassPrice = 0.000005 ether;
    uint private goldPassPrice = 0.000005 ether;

    bool public sale = false;

    string private baseUri = "ipfs://QmR58ne17hbN23uBjEUQ4oKKa1XbxUuohHzHD3BjdXvjMm/";
