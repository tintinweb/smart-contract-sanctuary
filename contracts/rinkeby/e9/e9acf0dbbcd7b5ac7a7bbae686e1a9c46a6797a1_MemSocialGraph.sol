...
contract MemSocialGraph {
    // does this need to be a dynamic memory array?
    // yes it does!
    // 1. storage arrays
    // 2. memory arrays
    
    // these need to be storage arrays I believe
    ...
    // [
        ...
        //     }
        // ]
    // addressToFollowerArray[WHERE address = "0xasdfads"] = 
    constructor() {
        // console.log("Yo yo, I am a contract and I am smart");
    }

    //modifiers to check/avoid gas
    ...
    function follow(address _followed) followSelf(_followed) external {
        // is this necessary? 
        ...
        // console.log("%s has followed %s", msg.sender, _followed);
    }
