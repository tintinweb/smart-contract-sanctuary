...
contract Strawberries is ERC721Enumerable {
    ...
    **/
    ...
    function mintInternal() internal {
        ...
        require(!FruitsLibrary.isContract(msg.sender));
    ...
    function mintStrawberry(uint256 _times) public payable {
        require((_times > 0 && _times <= 30) && (msg.value == _times * price) && (totalSupply() < MINTS_PER_TIER), "Please check variables and minting status.");
    ...
    function mintStrawberryWithSeeds() public {
        ...
        ISeeds(seedsAddress).burnFrom(msg.sender, currentSeedsCost());
        return mintInternal();
    }
