...
contract FoxPartyPoly is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FoxPartyPoly", "FPP") {
    setHiddenMetadataUri("ipfs://QmbKu6wwNbofDBBg96G3nXhmycpSyB3iCxfsjvciGpj3iq/Hidden.json");
  }
