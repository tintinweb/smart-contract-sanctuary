...
contract MillionDollarTokenPageV2 is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, IERC721ReceiverUpgradeable {
    ...
    function initialize(uint16 _totalMintLimit, uint16 _singleMintLimit, uint16 _ownershipMintLimit, uint256 _mintPrice, string memory __metadataBaseURI, string memory __defaultContentBaseURI, address _original, uint256[] memory _tokenIdsToMigrate) public virtual initializer {
        __MillionDollarTokenPageV2_init(_totalMintLimit, _singleMintLimit, _ownershipMintLimit, _mintPrice, __metadataBaseURI, __defaultContentBaseURI, _original, _tokenIdsToMigrate);
    }

    function __MillionDollarTokenPageV2_init(uint16 _totalMintLimit, uint16 _singleMintLimit, uint16 _ownershipMintLimit, uint256 _mintPrice, string memory __metadataBaseURI, string memory __defaultContentBaseURI, address _original, uint256[] memory _tokenIdsToMigrate) public onlyInitializing {
        __ERC721_init("MillionDollarTokenPage", "\u22A1");
        __Pausable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();
        __MillionDollarTokenPageV2_init_unchained(_totalMintLimit, _singleMintLimit, _ownershipMintLimit, _mintPrice, __metadataBaseURI, __defaultContentBaseURI, _original, _tokenIdsToMigrate);
    }

    function __MillionDollarTokenPageV2_init_unchained(uint16 _totalMintLimit, uint16 _singleMintLimit, uint16 _ownershipMintLimit, uint256 _mintPrice, string memory __metadataBaseURI, string memory __defaultContentBaseURI, address _original, uint256[] memory _tokenIdsToMigrate) public onlyInitializing {
        canMintCenter = false;
        _metadataBaseURI = __metadataBaseURI;
        _defaultContentBaseURI = __defaultContentBaseURI;
