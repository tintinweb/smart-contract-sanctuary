  ...
  ERC721EnumerableOptimized
{
  ...
  // function rdm() private view returns (uint) {
    ...
    returns (string memory)
  {
    ...
    parts[0] = '<svg width="400" height="250" xmlns="http://www.w3.org/2000/svg"><style>rect.move {stroke:white; stroke-width:1px;} rect.square {stroke:white; stroke-width:1px;}</style><rect x="0" y="0" width="50" height="50" rx="10" ry="10" fill="';
    parts[1] = getType(tokenId);
    parts[2] = '" class="square"/><rect x="50" y="0" width="50" height="50" rx="10" ry="10" fill="';
    parts[3] = getType(tokenId);
    parts[4] = '" class="square"/><rect x="100" y="0" width="50" height="50" rx="10" ry="10" fill="#ef8030" class="square"/><text x="125" y="25" dominant-baseline="middle" text-anchor="middle" fill="white">';
    parts[5] = "1";//FlootConstants.toString(rdm());
    parts[6] = '</text><rect x="150" y="0" width="50" height="50" rx="10" ry="10" fill="#ef8030" class="square"/><text x="175" y="25" dominant-baseline="middle" text-anchor="middle" fill="white">';
    parts[7] = "1"; //FlootConstants.toString(rdm());
    parts[8] = '</text><rect x="200" y="0" width="50" height="50" rx="10" ry="10" fill="#ef8030" class="square"/><text x="225" y="25" dominant-baseline="middle" text-anchor="middle" fill="white">';
    parts[9] = "1"; //FlootConstants.toString(rdm());
    parts[10] = '</text><rect x="250" y="0" width="50" height="50" rx="10" ry="10" fill="#ef8030" class="square"/><text x="275" y="25" dominant-baseline="middle" text-anchor="middle" fill="white">';
    parts[11] = "1"; //FlootConstants.toString(rdm());
    parts[12] = '</text><rect x="300" y="0" width="50" height="50" rx="10" ry="10" fill="#ef8030" class="square"/><text x="325" y="25" dominant-baseline="middle" text-anchor="middle" fill="white">';
    parts[13] = "1"; //FlootConstants.toString(rdm());
    parts[14] = '</text><rect x="350" y="0" width="50" height="50" rx="10" ry="10" fill="ef8030" class="square"/><text x="375" y="25" dominant-baseline="middle" text-anchor="middle" fill="white">';
    parts[15] = "1"; //FlootConstants.toString(rdm());
...

{
  ...
  "libraries": {
    "contracts/FlootConstants.sol": {
      "FlootConstants": "0xc91e780b4703f535b5a807d26e7e7db553050fe9"
    }
  }
}