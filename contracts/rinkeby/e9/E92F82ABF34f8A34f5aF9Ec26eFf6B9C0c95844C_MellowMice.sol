...
// File: contracts/mellow mice.sol

pragma solidity ^0.8.0;

contract MellowMice is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;
  ...
  constructor(
    ...
    mint(msg.sender, 15); // Must be lower than line 1231 | This is how many is minted FREE to owner upon deployment
  }
