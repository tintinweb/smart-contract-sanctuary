...
// contract NiftyFishes is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
contract NiftyFishes is ERC721Enumerable, Ownable, ERC721Burnable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    // TODO: minting discount for holders of Fish. Won't apply to the first MenuSection sale
    // TODO: Let holders get a head start on sales. First X% Sales will only be open for holders.
    //       If X% sales is not reached within X days open up for everyone. Won't apply to the first MenuSection sale
    struct MenuSection { 
        string title;
        bool initialized;
        bool saleStarted;
    ...
    constructor() ERC721("NiftyFishes", "Fish") {
        upsertMenuSection(0, "Starters", true, false, 22, MAX_MINT_PER_TRANSACTION, 20, PRICE);
        upsertMenuSection(1, "Mains", true, false, 33, MAX_MINT_PER_TRANSACTION, 60, PRICE);
    }

    function upsertMenuSection(
        uint256 _key,
        ...
        require(menuSection.initialized || !menuSectionsLocked, "Can't add more sections");
    ...
    function setMenuSection(uint8 _sectionKey) public onlyOwner {
        ...
        require(totalSupply() >= maxSupply(), "Current section is not sold out"); // TODO: test first
    ...
    function mint(address _to, uint256 _count) public payable {
        ...
        require(msg.value >= menuSection.price.mul(_count), "Value below price");
