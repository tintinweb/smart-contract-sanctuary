...
contract MyLittleUzis is ERC721Enumerable, Ownable {
  ...
  uint256 public immutable MAX_NFT_SUPPLY  = 10;

  constructor(uint256 startTimestamp_, string memory hiddenURI_, string memory baseURI_) ERC721("MyLittleUzis", "MLU") {
