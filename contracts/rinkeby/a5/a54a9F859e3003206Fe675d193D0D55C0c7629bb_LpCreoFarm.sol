...
contract LpCreoFarm is Ownable {
    using SafeMath for uint256;
    ...
    string public name = "CREO_FARM: LP-CREO";
    ...
    function farmBalance() public view returns(uint256) {
        uint256 deduct = unclaimedRewards;
    ...
    function stake(uint256 amount) public {
        ...
        require(
            amount >= 0 &&
            creoLpToken.balanceOf(_msgSender()) >= amount, 
            "CreoFarm: You cannot stake 0 Lp tokens");
        ...
        creoLpToken.safeTransferFrom(_msgSender(), address(this), amount);
    ...
    function unstake(uint256 amount) public {
        ...
        creoLpToken.safeTransfer(_msgSender(), balTransfer);
    ...
    function _sendRewards(address user) private {
        ...
        creoToken.safeTransfer(user, rewards);
