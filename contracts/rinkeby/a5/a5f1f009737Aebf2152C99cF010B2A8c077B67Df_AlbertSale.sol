...
import {IAlbertBlock} from '../interface/IAlbertBlock.sol';
...
//   bytes32 public override merkleRoot; // store the merkle root data for verification purpose
  ...
  IAlbertBlock public immutable override nft;
...
interface IAlbertBlock is IERC721Enumerable {
//   /**
...
import {IAlbertBlock} from './IAlbertBlock.sol';
...
interface INFTSale {
  ...
  function nft() external view returns (IAlbertBlock);
}
