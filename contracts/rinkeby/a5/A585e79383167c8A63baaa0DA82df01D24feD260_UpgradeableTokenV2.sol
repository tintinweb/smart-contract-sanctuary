...
contract UpgradeableTokenV2 is ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("Upgradeable Token", "UTKN");
        __Ownable_init();
    ...
    function blacklist(address _user) external {
        require(msg.sender == governor, 'Blacklist restricted to governor only');
