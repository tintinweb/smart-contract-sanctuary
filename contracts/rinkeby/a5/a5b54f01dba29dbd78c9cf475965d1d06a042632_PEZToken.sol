...
contract Stakable   is Ownable
{
    ...
    event       NftStakeInitiated(string collectionName, address stakerWallet, TNftStaker stakerInfo);
    ...
    constructor() 
    {
        ...
        setStakableNftCollection("DOOLNIES", 0x8FA2F5c40BB5Ccc3Ad9A4Fa52452b40735EE3508, 86400, 10000000000000000000,13000000000000000000,1731801600,1701801600);
