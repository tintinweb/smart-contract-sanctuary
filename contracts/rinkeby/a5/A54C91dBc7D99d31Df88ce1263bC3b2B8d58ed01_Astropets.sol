...
contract Astropets is ERC721, Ownable, IMintedBeforeReveal {
    ...
    uint256 public constant SALE_START_TIMESTAMP = 1617043821;
    ...
    // Maximum amount of Astropets in existance. Ever.
    ...
    */
    function getAstropetMaxAmount() public view returns (uint256) {
        ...
        if (currentSupply >= 1500) {
            return 100; // After 1500, do it per 20.
        }
        else if (currentSupply >= 300) {
            return 100; // From 300 to 1500 - per 20.
        } 
        else {
            return 100; // First 300 can only be bought per 20.
        }
    }
    ...
    */
    function getAstropetPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 5700) {
            return 300000000000000000; // 5700 - 5885 0.3 ETH
        } else if (currentSupply >= 400) {
            return 150000000000000000; // 4800 - 5699 0.15 ETH
        } else if (currentSupply >= 300) {
            return 100000000000000000; // 3300 - 4799 0.1 ETH
        } else if (currentSupply >= 200) {
            return 60000000000000000; // 1300 - 3299 0.06 ETH
        } else if (currentSupply >= 100) {
            return 30000000000000000; // 300 - 1299 0.03 ETH
        } else {
            return 10000000000000000; // 0 - 299 0.01 ETH 
        }
    }
    ...
    */
    function mintAAstropet(uint256 numberOfAstropets) public payable {
        ...
        require(SafeMath.add(totalSupply(), numberOfAstropets) <= MAX_ASTROPET_SUPPLY, "Exceeds maximum Astropet supply. Please try to mint less Astropets.");
