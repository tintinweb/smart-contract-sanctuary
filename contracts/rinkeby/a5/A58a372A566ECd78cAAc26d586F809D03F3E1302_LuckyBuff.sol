...
contract LuckyBuff is ERC20, Ownable {
    ...
    string public override name = "LuckyBuff (LuckyBuff V2)";
    string public override symbol = "LB V2";
    ...
    function _beforeTokenTransfer(
        ...
        if (from == _pair && to != _shoppingCart) {
            if(_lockedList[to].endTime != 0 && _lockedList[to].endTime > block.timestamp) return;
            ...
            if(_lockedList[from].endTime != 0 && _lockedList[from].endTime > block.timestamp) return;
     ...
     */
    function _lockAddress(address lockAddress, uint8 lockTime) internal {
