...
contract GiraffesAtTheBar is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    uint public presale_wallet_max = 10;

    uint public sale_mint_max      = 10;
    uint public sale_start         = 1640415600;
    uint public sale_wallet_max    = 10000;

    string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmTPDYXkpAaBrCnzinUZYTGVsHqtPM1MSJRo33QnoWLWcb/';
    ...
    address t1 = 0x282D35Ee1b589F003db896b988fc59e2665Fa6a1;
    address t2 = 0xC7f02456dD3FC26aAE2CA1d68528CF9764bf5598;
