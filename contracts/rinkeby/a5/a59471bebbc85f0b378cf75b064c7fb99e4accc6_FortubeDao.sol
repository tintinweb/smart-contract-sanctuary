...
library FixidityLib {
    ...
    function init(Fixidity storage fixidity, uint8 digits) internal {
        assert(digits < 36);
    ...
    function round_off(Fixidity storage fixidity, int256 v, uint8 digits) internal pure returns (int256) {
    ...
    function trunc_digits(Fixidity storage fixidity, int256 v, uint8 digits) internal pure returns (int256) {
