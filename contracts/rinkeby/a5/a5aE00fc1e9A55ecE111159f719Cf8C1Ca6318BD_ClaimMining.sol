...
contract ClaimMining is Ownable, ReentrancyGuard {
    ...
    uint256 constant public phase1TokenPerBlock = 75;
    ...
    bool public enableWhitelist = true;  // Whitelist switch
    ...
    function updateWhitelistSwitch(bool _enableWhitelist) public onlyOwner {
    ...
    function isWhitelisted(address _address) public view returns (bool) {
        return enableWhitelist ? whitelist[_address] : true;
    }
}