...
contract SimpsOffice is Ownable, IERC721Receiver {
    ...
    //uint public constant ALL_LOVE_IN_THE_UNIVERSE = 2400000000 ether;
    ...
    // emergency rescue to allow unstaking without any checks but without $LLOVE
    ...
    function mercyJackpotPayout() public returns (Stake[] memory stakedTokens){

        return _mercyJackpotPayout();
    }
