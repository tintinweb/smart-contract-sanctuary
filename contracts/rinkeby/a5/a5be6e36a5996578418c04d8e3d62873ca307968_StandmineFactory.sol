...
// File: contracts/StandmineThing.sol
...
contract StandmineThing is ERC721Full, ERC721MetadataMintable, ERC721Burnable, Ownable {
  using SafeMath for uint256;
...
// File: contracts/StandmineFactory.sol

pragma solidity ^0.5.7;


contract StandmineFactory {
    ...
    function launchStore(
      ...
      string memory uri
        ...
        address newStore = address(new StandmineThing(name, symbol, uri, mintbase, msg.sender));
