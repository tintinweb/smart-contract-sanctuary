...
contract LowerGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Money eye", "$$") {
    setHiddenMetadataUri("ipfs://QmQfrcjLtVevAHVBfRsF31UcUzUBZSM6nAB49Vs3Sk3Yjf/_metadata.json");
  }
  ...
  function withdraw() public onlyOwner 
    ...
    // =============================================================================
    // (bool hs, ) = payable(0x92979728045b2c6120893fa1F94C15618b14FA7F).call{value: address(this).balance*5 / 100}("");
    // require(hs);
    // =============================================================================
