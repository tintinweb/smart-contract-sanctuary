...
contract CryptoPump is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant pumpkinPrice = 100000000000000000; //0.10 ETH
    uint256 public constant pumpkinPatchPrice = 240000000000000000; //0.24 ETH
    uint256 public constant pumpkinFarmPrice = 700000000000000000; //0.70 ETH

    uint public constant maxPumpkinPurchase = 10;

    uint256 public constant MAX_PUMPKINS = 10000;
    ...
    constructor() ERC721("CryptoPump", "CP") { }
    ...
    function mintPumpkin(uint numberOfTokens) public payable returns(uint256[] memory ) {
        ...
        require(pumpkinPrice * numberOfTokens <= msg.value, "Ether value sent is not correct");
    ...
    function mintPumpkinPatch() public payable returns(uint256[] memory ) {
        ...
        require(pumpkinPatchPrice <= msg.value, "Ether value sent is not correct");
    ...
    function mintPumpkinFarm() public payable returns(uint256[] memory ) {
        ...
        require(pumpkinFarmPrice <= msg.value, "Ether value sent is not correct");
