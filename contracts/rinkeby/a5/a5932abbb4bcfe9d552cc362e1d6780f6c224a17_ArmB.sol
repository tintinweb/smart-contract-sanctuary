...
contract ArmB is ERC721Enumerable, Ownable {
  uint256 public basePrice = 0.0308 ether;
  ...
  uint256 public constant MAX_MINTSUPPLY = 5000;
  ...
  constructor(string memory baseURI) ERC721("Armed Bears Test", "ABT") {
    setBaseURI(baseURI);
  }
