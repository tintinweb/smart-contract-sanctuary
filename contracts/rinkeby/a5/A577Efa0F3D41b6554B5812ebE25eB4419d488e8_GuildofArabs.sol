...
// File: contracts/GuildofArabs.sol
...
contract GuildofArabs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Guild of Arabs", "GOA") {
    setHiddenMetadataUri("ipfs://QmQ9FLCd35KdPd1a6dPZVpAn24Lrc2cDPjHWBToEkr5DmW/hidden.json");
  }
