...
contract Hustler is ERC1155, ERC1155Receiver, HustlerMetadata, Ownable {
    ...
    function onERC1155Received(
        ...
        require(msg.sender == address(swapmeet), Errors_1.IsNotSwapMeet);
    ...
    function onERC1155BatchReceived(
        ...
        require(sig == equip, Errors_1.EquipSignatureInvalid);
        require(ids.length == hustlerIds.length, Errors_1.NumHustlerIdMismatch);
    ...
    modifier onlyHolder(uint256 id) {
        require(balanceOf(msg.sender, id) == 1, Errors_1.IsHolder);
        _;
    }
}