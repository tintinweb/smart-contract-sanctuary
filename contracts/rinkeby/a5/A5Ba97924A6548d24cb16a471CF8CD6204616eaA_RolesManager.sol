...
contract RolesManager is AccessControl, IRolesManager {
    ...
    constructor(uint8 initialMaxMultiItems) public {
        ...
        _setRoleAdmin(_consts().VAULT_REGISTRAR_ROLE(), _consts().OWNER_ROLE());
        ...
        */
        ...
        _setupRole(_consts().VAULT_CONFIGURATOR_ROLE(), msg.sender);
        _setupRole(_consts().VAULT_REGISTRAR_ROLE(), msg.sender);
    }
