...
contract DarkPlanets is ERC721Enumerable, Ownable {
    ...
    //id -> bType 11
    mapping(uint256 => uint256) public _bTypes;
    //id -> sType 5
    mapping(uint256 => uint256) public _sTypes;
    ...
    function claim() public payable {
        ...
        uint256 btype = randomNum % 11;
        _bTypes[_totalPlanets] = btype;
        uint256 stype = randomNum % 5;
        _sTypes[_totalPlanets] = stype;
        _totalPlanets++;
    }

    function getClaimFee()public pure returns(uint256){
        return 1 * 1e18;
