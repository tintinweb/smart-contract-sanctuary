...
contract DAIDistributorContract {
    ...
    function distribute() external returns ( bool ) {
        if ( block.number >= nextEpochBlock ) {
            ...
            require( notEnoughDAIToDistribute == false );
    ...
    function setBlockInEpoch( uint _blocksInEpoch ) external returns ( bool ) {
        require( msg.sender == owner);
    ...
    function transferRemainingDAIOutIfNotEnoughForNextEpoch() external returns ( bool ) {
        require( msg.sender == owner );
        require( notEnoughDAIToDistribute == true );
