...
contract LANDRegistry is Storage, Ownable, FullAssetRegistry, ILANDRegistry {
  ...
  */
  ...
  function tokenURI(uint256 tokenId, string memory _type) public view returns (string memory){
      return string(abi.encodePacked(baseURI, 'tokenId=', toString(tokenId), "&type=", _type));
  }
}