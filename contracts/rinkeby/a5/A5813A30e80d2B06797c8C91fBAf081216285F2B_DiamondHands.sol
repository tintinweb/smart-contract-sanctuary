...
contract DiamondHands is ERC721, Ownable {
    ...
    // Asset links
    // Hand emojis designed by OpenMoji – the open-source emoji and icon project. License: CC BY-SA 4.0
    string[] public diamondUrls = [
        "QmbyzHV4vG5eTpfW9JMUXzP4kCXnNfQE2CnDWgZjS78Grz",
        "QmcU2NiNnXNx3jKxkC3k3AisJAvvfqDUKsWHErBFxAarKR",
        "QmcU2NiNnXNx3jKxkC3k3AisJAvvfqDUKsWHErBFxAarKR",
        "QmcU2NiNnXNx3jKxkC3k3AisJAvvfqDUKsWHErBFxAarKR",
        "QmcU2NiNnXNx3jKxkC3k3AisJAvvfqDUKsWHErBFxAarKR",
        "QmcU2NiNnXNx3jKxkC3k3AisJAvvfqDUKsWHErBFxAarKR",
    ...
    uint256 public constant FOUNDER_1_RESERVE_AMOUNT = 40;
    uint256 public constant FOUNDER_2_RESERVE_AMOUNT = 10;
    address private constant FOUNDER_2_ADDR =
        0x7115FB8e1d857831Fc94f4a26bfBCa95cA0F2De6;
     ...
     */
    function mintNotAuditedNoRoadmap() external returns (uint256) {
        require(
        ...
        returns (string memory)
    {
        ...
        string memory description = string(
            'description: "Do you have what it takes to reach diamond hands?", '
        );
        string memory image = string(
            abi.encodePacked('image: "ipfs://', ipfsId, '"}')
        );
        return string(abi.encodePacked(name, description, image));
    }
