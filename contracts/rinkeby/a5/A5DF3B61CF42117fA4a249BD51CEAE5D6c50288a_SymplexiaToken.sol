...
//   ======================================
    ...
    function _transfer( address sender, address recipient, uint256 amount ) internal override whenNotPaused {
       ...
       // If any account belongs to "_isExcludedFromFee" then no fee will be applied. 
        ...
        if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient])  applyFee = _NOT_ENABLED; 
...
//   ======================================
    ...
    function tokenFromReflection(uint256 rAmount) public view returns(uint256) {
        require(rAmount <= _reflectedSupply, "Amount must be less than Reflections");
        uint256 currentRate =  _getRate();
...
contract SymplexiaToken is  Taxable {
  ...
  //
    ...
    constructor () ERC20 ("DEBUG38", "DBG38") BaseToken (5, 5, 5, 
