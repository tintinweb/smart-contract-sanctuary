...
contract GolffPet is ERC721Enumerable, Ownable {
    ...
    constructor(address account,string memory _ipfsHash,bytes32 merkleRoot_ ) ERC721('Golff CCC', "Golff CCC") {
    ...
    function claim_size(uint256 size) public{
