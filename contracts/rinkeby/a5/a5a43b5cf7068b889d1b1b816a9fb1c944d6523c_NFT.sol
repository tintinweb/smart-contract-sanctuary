...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Token name
    string private _name = "Crypto Titles Club";
...
contract NFT is ERC721, Ownable, ReentrancyGuard {
  ...
  uint256 private _mintCost = 0.01 ether;
  uint256 private _maxSupply = 9900;
  bool private _isPublicMintEnabled = false;
  ...
  * Note: `cost` is in wei. 
  */
  constructor() ERC721("Crypto Titles Club", "CTC") Ownable() {}
  ...
  */
  ...
  nonReentrant{
    ...
    require(count > 0 && count <= 3, "You can drop minimum 1, maximum 10 NFTs");
