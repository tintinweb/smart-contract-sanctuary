...
contract GobbleGang is ERC721Enumerable, Ownable {  
    ...
    uint256 constant MAX_FOR_PRESALE = 3;
    
    // Reserved for giveaways, collabs, and so on 
    ...
    address private teamAddress = 0x7afC7eDF521538713f3De565Fe930FF8B74Db8AB;
    address private signerAddress = 0x7afC7eDF521538713f3De565Fe930FF8B74Db8AB;
   ...
   // Free mint
    function mintFree() public payable {
        require(!saleActive && presaleActive, "sale_is_closed");
    ...
    function mintGobble(bytes32 hash, bytes memory signature, string memory nonce, uint256 amount) external payable {
    ...
    // Set team addresses
    function setAddresses(address newTeamAddress) external onlyOwner {
