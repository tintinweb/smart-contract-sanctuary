...
// File contracts/nftAtributos.sol


pragma solidity 0.8.11;

contract nftAtributos {
...
// File contracts/nftCreacion.sol
...
contract nftCreacion is ERC721Enumerable, nftAtributos {
    using Base64 for bytes;
    using Strings for uint256;
    uint256 public maxSupply ;
    constructor(uint256 _maxSupply) ERC721("4SHEPHERDS","4ST"){
    ...
    function mint(address _to, uint256 _tokenId) public payable {
        ...
        require(totalSupply() < maxSupply-1,"No hay nada para entregar");
    ...
    returns (string memory) {
        ...
        parts[1] = getProfile(_tokenId);

        parts[2] = '</text><text x="10" y="40" class="base">';

        parts[3] = getInstructor(_tokenId);

        parts[4] = '</text><text x="10" y="60" class="base">';

        parts[5] = getExchange(_tokenId);

        parts[6] = '</text><text x="10" y="80" class="base">';

        parts[7] = getToken(_tokenId);

        parts[8] = '</text><text x="10" y="100" class="base">';

        parts[9] = getBlockchain(_tokenId);

        parts[10] = '</text><text x="10" y="120" class="base">';

        parts[11] = getWallet(_tokenId);

        parts[12] = '</text><text x="10" y="140" class="base">';

        parts[13] = getYoutubeProgram(_tokenId);

        parts[14] = '</text><text x="10" y="160" class="base">';

        parts[15] = getNFT(_tokenId);
