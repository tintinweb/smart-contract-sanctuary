...
contract NymUpgradeable is OwnableUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    function initialize(
        ...
        _name = "GRIDZONE NeonPunks";
        _symbol = "Ticker NEON";
        _cap = 300;
        mintPrice = 3e17; // 0.3 ETH
        locked = true;
        ...
        _mintInternal(0xeFd9928Aa5A192C0267CdAed43235006B7A28628);
        _mintInternal(0xd91Fbc9b431464D737E1BC4e76900D43405a639b);
        _mintInternal(0xAa5d61cE6eB431f55dE741Ea6a6ff3a1AfE4D47B);
