...
contract RingMaster is NFTExtension, Metadata {
  ...
  // Public sale details
  uint256 public constant publicSaleSupply = 3430;
...
contract Metadata is Ownable {
  ...
  uint256 public _changeNameFee = 10;
  uint256 public _changeBioFee = 25;
  uint256 TotalSupply;
  ...
  // Maaping from tokenId to boolean to make sure name is updated.
  mapping(uint256 => bool) _isNameUpdated;

  // Maaping from tokenId to boolean to make sure bio is updated.
