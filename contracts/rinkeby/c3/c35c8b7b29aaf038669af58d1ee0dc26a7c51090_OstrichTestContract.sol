...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmWQTWvymXeasvoE9z9ddk2VSJXFDtxFfKhGpJUdGchf3u/";
        ...
        constructor(
            ...
            payableAddresses.push(0x2Ea6539Ca4CCdd05c255836807Dac22BBE2a8Faf);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 5');
    ...
    // File: contracts/ostrichTestContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract OstrichTestContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("OstrichTest", "COT", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/qmSolDNQWHRizGo0SJLB/contract-metadata";
        }
    }