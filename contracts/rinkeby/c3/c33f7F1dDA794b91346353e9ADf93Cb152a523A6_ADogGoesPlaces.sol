...
contract ADogGoesPlaces is ERC721Enumerable, Ownable {
  ...
  // // Temporary address for testing
  // address private artistAddress = 0x807c47A89F720fe4Ee9b8343c286Fc886f43191b;
  // address private devAddress = 0x23BB2Bb6c340D4C91cAa478EdF6593fC5c4a6d4B;
  ...
  bytes32 public rootEarlyMeow;
  bytes32 public rootMeowJunior;
  ...
  constructor(string memory _initBaseURI) ERC721("DogGoesPlaces", "DGP") {
  ...
  // THIS FUNCTION IS FOR ONLY FOR LOCAL TESTING

  function setMaxSupplyAndPreMintSupply(uint256 max_supply, uint256 max_premint)
    public
    onlyOwner
  {
    MAX_MEOWS_SUPPLY = max_supply;
    MAX_PRE_MINT_RESERVED = max_premint;
  }
