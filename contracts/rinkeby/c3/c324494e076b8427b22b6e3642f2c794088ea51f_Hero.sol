...
contract Hero is ERC721Tradable {
    ...
    function mintRandomMobTo(address _to, uint256 _level, uint256 random) internal onlyOwner {
    ...
    function mintRandomBossTo(address _to, uint256 _level, uint256 random) internal onlyOwner {
        //Look up characters that have available cards
    ...
    function mintRandomHeroTo(address _to, uint256 _level) internal onlyOwner {
    ...
    function saleMint(uint _qty, address _toAddress) external payable {
    ...
    function setPublicSaleState(bool _state) external {
