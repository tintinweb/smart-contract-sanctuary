...
contract nft is ERC721, Ownable {
    ...
    address payable public constant shareholder1 = payable(0x70d00b995290577A1d78297a252D8B365584Dc53);
    address payable public constant shareholder2 = payable(0xF370908E52B9Ca2996c1381c57ebaE98e7b3183e);
    address payable public constant shareholder3 = payable(0xce5E8dBa1b00D313943DFc7507013aDc40f4224B);
    address payable public constant shareholder4 = payable(0x330DD6d20A756a7622d4C1A3CD6E845b5a2F7fd4);
    address payable public projectAccount = payable(0xC84305CE347FD912B3ddeFBaA7FD731A329A81A6);
    ...
    constructor(string memory nombre, string memory simbolo) ERC721(nombre, simbolo) {
        numberOfTokens = 0;
        baseURI = 'ipfs://QmZXEkeV9CLjSGq3f1ozzXKhRBKJ7zTdQoWjQRTHgcQtZ9/';
        maxTokens = 6666;
    ...
    */
    ...
    function mint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v, _r, _s) public payable {
        ...
        require(msg.value == mintCost * number, "Not sufficient/Excessive Eether to mint this amount of NFTs (Cost = 0.06 ether for each NFT)");
    ...
    function initalMint() public {
        ...
        for (uint256 i = 0; i < 66; i++) {
            uint256 tid = tokenId();
            _safeMint(projectAccount, tid);
            mintsPerAddress[projectAccount] += 1;
        }
        nInitialMint += 1;
    }
    ...
    function withdrawAll() public {
        ...
        withdraw(projectAccount, ((balance * 10) / 100));
    }
    ...
    function changeProjectAccount(address payable _projectAccount) public {
        address ow = owner();
        require(msg.sender == ow, "Only available for the Owner of the Contract");
