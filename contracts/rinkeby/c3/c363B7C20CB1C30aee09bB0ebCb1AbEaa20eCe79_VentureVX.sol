...
contract VentureVX is ERC721Enumerable, Ownable {
    ...
    constructor (string memory _ventureURI, address _daoAddress) public ERC721 ("VentureVX", "VVX"){
        token_tracker[uint256(VentureRank.Reptilian)] = RankDetails(true, 1, 1, 8, 0, 90 ether, 90 ether);
        token_tracker[uint256(VentureRank.Howard)] = RankDetails(true, 9, 9, 508, 0, 0.0002 ether, 0.00008 ether);
        token_tracker[uint256(VentureRank.Hank)] = RankDetails(true, 509, 509, 3008, 0, 0.00013 ether, 0.00006 ether);
        token_tracker[uint256(VentureRank.Joe)] = RankDetails(true, 3009, 3009, 10000, 0, 0.00009 ether, 0.00004 ether);
        MAX_PER_TX = 5;
        MAX_PER_WALLET = 5;
