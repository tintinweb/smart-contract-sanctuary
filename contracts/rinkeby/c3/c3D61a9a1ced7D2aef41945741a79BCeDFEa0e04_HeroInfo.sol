...
contract HeroInfo is Ownable {
    ...
    function makeJson(
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                ...
                '", "description": "', _shortDescription, '\nThis special character for Dungeons and Dragons Game is handmade, well balanced and stored on chain. Skills, equipment, and other functionality are intentionally specified so you will not be bothered creating ones. Feel free to play this complete DnD character!", "image": "data:image/svg+xml;base64,',
                Base64.encode(_svg),
                '", "attributes": [',
                _attrs,
                "]}"
        ...
        returns (bytes memory)
    {
        ...
        bytes memory loots = abi.encodePacked(
            textTag("Type: ", _loot[0], "20"),
            textTag("Short story: ", _loot[1], "43"),
            textTag("Class: ", _loot[2], "66"),
            textTag("Sub-Class: ", _loot[3], "89"),
            textTag("Race: ", _loot[4], "112"),
            textTag("Sub-Race: ", _loot[5], "135"),
            textTag("Backstory: ", _loot[6], "158"),
            textTag("Level: ", _loot[7], "181")
        );
