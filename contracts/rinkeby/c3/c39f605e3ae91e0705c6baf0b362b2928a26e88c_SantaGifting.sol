...
contract SantaGifting is Ownable {
    ...
    function erc20Deposit(address fromAddress, address toAddress, address token, uint256 amount, uint256 aditionalFee) payable public {
    ...
    function erc20Withdraw(address to, address token, uint amount) payable public {
