    ...
    UUPSUpgradeable
{
    ...
    function initialize(address _signer, string calldata _uri)
        public
        initializer
    {
        __Pausable_init();
    ...
    function mintableSupply(uint256 _tokenId) external view returns (uint256) {
        ...
        whenNotPaused
    {
        ...
        // return nicer error message if we are out of tokens
        require(balanceOf(address(this), _ticket.tokenId) > 0, "Out of tokens");
