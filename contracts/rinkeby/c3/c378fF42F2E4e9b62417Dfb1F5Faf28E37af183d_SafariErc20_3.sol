...
contract SafariErc20_3 is UUPSUpgradeable, ERC20Upgradeable, OwnableUpgradeable {
  ...
  function upgrade(address _stripes) public onlyOwner {
    stripesAddress = _stripes;
    stripesBurning = false;
  }

  function setStripesAddress(address _stripes) public onlyOwner {
    stripesAddress = _stripes;
  }
