...
contract LP1 is ERC721, Ownable {
    ...
    function reserveLP1() public onlyOwner {   
     ...
     function mintLP1(uint256 numberOfTokens) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 20 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxLP1, "Purchase would exceed max supply of LP1");
