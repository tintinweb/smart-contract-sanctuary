...
/// @title Space Test Token contract
/// @dev Extends ERC721 Non-Fungible Token Standard basic implementation
contract SpaceTestERC721 is ERC721, ERC721Enumerable, Ownable {

    string internal baseURI;

    uint256 public constant MAX_SUPPLY = 16;

    constructor() ERC721("Space Test Token", "SPACETEST") {}
    ...
    /// @dev mints the given token id to the given address
