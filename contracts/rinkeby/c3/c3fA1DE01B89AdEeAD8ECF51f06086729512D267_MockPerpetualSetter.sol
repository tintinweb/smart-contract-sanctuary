...
interface IMockPerpetualSetter {
    ...
    function setPnLparticipantsCashCC(uint256 _poolId, int128 _fPnLparticipantsCashCC) external;
    ...
    function setPerpetualFees(
        ...
        int128 _fReferralRebateRate
    ) external;

    function setTargetAMMFundSize(uint256 _poolId, int128 value) external;

    function setTargetDFSize(uint256 _poolId, int128 value) external;

    function setAMMFundCashCC(uint256 _poolId, int128 value) external;

    function setDefaultFundCashCC(uint256 _poolId, int128 value) external;
    ...
    function setCurrentTraderExposureEMA(
        bytes32 _iPerpetualId,
        int128 ema
    ) external;
    ...
    function setGenericPairData(bytes32 _iPerpetualId, string memory _varName, int128 _value1, int128 _value2) external;
...
contract MockPerpetualSetter is PerpetualBaseFunctions, IMockPerpetualSetter, IFunctionList {
    ...
    function setPnLparticipantsCashCC(uint256 _poolId, int128 _fPnLparticipantsCashCC) external override {
    ...
    function setPerpetualFees(
        ...
        perpetual.fReferralRebateRate = _fReferralRebateRate;
    }

    function setTargetAMMFundSize(uint256 _poolId, int128 _value) external override {
        PerpStorage.LiquidityPoolData storage pool = liquidityPools[_poolId];
        pool.fTargetAMMFundSize = _value;
        // need to update perpetual too
    }

    function setTargetDFSize(uint256 _poolId, int128 _value) external override {
        PerpStorage.LiquidityPoolData storage pool = liquidityPools[_poolId];
        pool.fTargetDFSize = _value;
        // need to update perpetual too
    }

    function setAMMFundCashCC(uint256 _poolId, int128 _value) external override {
        PerpStorage.LiquidityPoolData storage pool = liquidityPools[_poolId];
        pool.fAMMFundCashCC = _value;
        // need to update perpetual too
    }

    function setDefaultFundCashCC(uint256 _poolId, int128 _value) external override {
        PerpStorage.LiquidityPoolData storage pool = liquidityPools[_poolId];
    ...
    function setGenericPriceData(
        ...
        if (this.isStringEqual(_varName, "indexS2PriceData")) {
            perpetual.indexS2PriceData.fPrice = _fPX;
            perpetual.indexS2PriceData.time = block.timestamp;
        } else if (this.isStringEqual(_varName, "indexS3PriceData")) {
            perpetual.indexS3PriceData.fPrice = _fPX;
            perpetual.indexS3PriceData.time = block.timestamp;
        } else if (this.isStringEqual(_varName, "settlementS2PriceData")) {
            perpetual.settlementS2PriceData.fPrice = _fPX;
            perpetual.settlementS2PriceData.time = block.timestamp;
        } else if (this.isStringEqual(_varName, "settlementS3PriceData")) {
            perpetual.settlementS3PriceData.fPrice = _fPX;
            perpetual.settlementS3PriceData.time = block.timestamp;
        } else if (this.isStringEqual(_varName, "currentPremium")) {
            perpetual.currentPremium.fPrice = _fPX;
            perpetual.currentPremium.time = block.timestamp;
        } else if (this.isStringEqual(_varName, "currentPremiumEMA")) {
            perpetual.currentPremiumEMA.fPrice = _fPX;
            perpetual.currentPremiumEMA.time = block.timestamp;
        } else {
        }
    }
    ...
    function setGenericPerpInt128(
        ...
        } else if (this.isStringEqual(_varName, "fReferralRebateRate")) {
            perpetual.fReferralRebateRate = _value;
        ...
        } else if (this.isStringEqual(_varName, "fDFCoverN")) {
            perpetual.fDFCoverN = _value;
