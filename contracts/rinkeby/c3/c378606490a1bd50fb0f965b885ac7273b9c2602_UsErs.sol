...
contract UsErs is ERC721, ERC721Enumerable, Ownable {
  
  // Provenance
  string public US_ERS_HASH = "";

  // Price & Supply
  uint256 public constant NFT_PRICE = 77000000000000000; //0.077 ETH
  uint public constant MAX_SUPPLY = 7777;
  uint public constant UsErsReserve = 7;
  uint public constant MAXReserve = 7;
  ...
  // Adress
  address member1 = 0x2E80404924B722162258b6a321aEe9961f0cee8C;
  address member2 = 0x0635bec8a3D8fc431C23b23b02967B359eA34584;
  address member3 = 0x29ebC11Fe7F2910daF1d8d040ED8925771420d01;
  
  // Sale
  bool public hasSaleStarted = false;
  uint private constant MAX_MINT_PER_CALL = 7;

  // Pre-Sale
  bool public hasPreSaleStarted = false;
  uint public constant MAX_PRESALE_SUPPLY = 777;
  
  constructor(string memory baseURI) ERC721("Us Ers", "UE") {
    setBaseURI(baseURI);
  }
  ...
  function reserveUsErs(address _to, uint256 _reserveAmount) public onlyOwner {        
        uint supply = totalSupply();
        require(_reserveAmount > 0 && _reserveAmount <= UsErsReserve, "Not enough reserve left for team");
  ...
  function withdraw() public onlyOwner {
    require(payable(member1).send(address(this).balance /100*40 ));
    require(payable(member2).send(address(this).balance /100*50));
