...
// File contracts/Ocean32_b_testnet.sol
...
contract Ocean32 is ERC721Upgradeable, UUPSUpgradeable, OwnableUpgradeable {
  ...
  function initialize() initializer public {
      ...
      contractURI = "https://raw.githubusercontent.com/PizzaDAO/pizza-smartcontract/master/data/opensea_metadata.mainnet.json";
  }
  ...
  function purchase(address to) public payable{
  ...
  /* function tokenURI(uint256 tokenId) public view override returns (string memory){
        require(tokenId<=count, 'token does not exist');
        return string(abi.encodePacked(_uriBase, IPFSHashes[tokenId]));
    } */
