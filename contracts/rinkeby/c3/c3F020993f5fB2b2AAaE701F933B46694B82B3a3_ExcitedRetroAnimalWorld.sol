...
contract ExcitedRetroAnimalWorld is ERC721Enumerable, Ownable{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    string public ERAW_PROVENANCE = "2b999cc660cc93fb08e2efcef4f0de598164cc2e6bfce71fddadaf38a3621ecd";
    ...
    constructor() ERC721("ExcitedRetroAnimalWorld","ERAW"){
    }
    ...
    function mintAnimal(uint numberOfTokens) public payable {
    ...
    function calcStartingIndex() public onlyOwner {
        ...
        require(startingIndexBlock != 0, "Starting index block has not been set yet");
