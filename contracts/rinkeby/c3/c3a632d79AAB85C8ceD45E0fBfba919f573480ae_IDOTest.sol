...
contract BaseClaim is Ownable {
    ...
    function getWithdrawableAmount(address _user, uint256 _timestamp)
        public
        view
        returns (uint256)
    {
