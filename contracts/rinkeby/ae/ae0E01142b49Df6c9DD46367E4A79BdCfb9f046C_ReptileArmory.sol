 ...
 * {ERC721Enumerable}.
 */
contract ReptileArmory is Context, ERC721Enumerable, VRFConsumerBase, Ownable, ReentrancyGuard  {
    ...
    uint256 public constant BASE_RATE_TOKENS = 5;
    ...
    )
    {
      ...
      _basePrice = 15000 ether;
      _incrementRate = 1000 ether;
    }
    ...
    function armsPurchase(uint256 tokensToMint, bool autoStake) public nonReentrant {
      ...
      if (_msgSender() != owner()) {
        ...
        require(LOOMI.getUserBalance(_msgSender()) >= batchPrice, "Insufficient Balance");
    ...
    function updareBasePrice(uint256 _newPrice) public onlyOwner {
      require(!saleIsActive, "Pause sale before price update");
      _basePrice = _newPrice;
    }

    function updareIncrementRate(uint256 _newRate) public onlyOwner {
      require(!saleIsActive, "Pause sale before price update");
    ...
    function tokenURI(uint256 tokenId) external view virtual override returns (string memory) {
      ...
      if (!metadataRevealed) return _armsBaseURI;
