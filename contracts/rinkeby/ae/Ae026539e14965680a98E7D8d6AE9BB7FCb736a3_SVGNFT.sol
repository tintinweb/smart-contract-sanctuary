...
contract SVGNFT is ERC721URIStorage{
    ...
    constructor() ERC721 ("Phenomenal Pixels", "PXL") {
        ...
        return string(abi.encodePacked(
            ...
            Base64.encode(
                bytes(abi.encodePacked(
                    '{"name": "Phenomenal Pixels", ',
                    '"description": "Phenomenal Pixels are 100,000,000 randomly generated, on chain, 50x50 pixel grids on the Polygon network.", ',
                    '"attributes": "", ',
                    '"image":"', imageURI, '"}'
                    )
            ))
