...
contract DePoToken is Ownable, ERC20, UsingLiquidityProtectionService {
    ...
    function liquidityProtectionService() internal pure override returns(address) {
        return 0xaabAe39230233d4FaFf04111EF08665880BD6dFb; // Mainnet and rinkeby address
    }
    // Expose balanceOf().
    ...
    function protectionChecker() internal view override returns(bool) {
        return ProtectionSwitch_timestamp(1632837600); // Switch off protection on Monday, Tuesday, September 28, 2021 2:00:00 PM.
...
abstract contract UsingLiquidityProtectionService {
    ...
    function counterToken() internal pure virtual returns(address) {
        return 0xc778417E063141139Fce010982780140Aa0cD5Ab; // WETH: 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2 Rinkeby: 0xc778417E063141139Fce010982780140Aa0cD5Ab
    }
