...
// File @openzeppelin/contracts/token/ERC721/extensions/IERC721Metada[email protected]
...
contract UnitedMetaverseNationV2 is ERC721("United Metaverse Nation", "UMN"), ERC721Enumerable, Ownable {
    ...
    */
    ...
    uint256 public constant MAX_NFT_PUBLIC = 10861;
    ...
    */
    ...
    function setBuyLimitPerTransaction(uint256 _limit) public onlyOwner{
        require(_limit <= MAX_NFT_PUBLIC, "Cannot set buy limit more then max supply of NFT's" );
    ...
    */
    function directMint(address to, uint256 tokenId) public onlyOwner {
        require(tokenId > MAX_NFT_PUBLIC, "Tokens number to mint must exceed number of public tokens");
        require(tokenId <= MAX_NFT, "Tokens number to mint cannot exceed number of MAX tokens");
        _safeMint(to, tokenId);
    }
    /*
