...
contract SpaceDragon is Context, IERC20, Ownable {
	...
	string private _name = "Reflect ME";
	string private _symbol = "RFM";
	...
	uint256 private numTokensSellToAddToLiquidity = 500 * 10 ** 3;
	uint256 public _maxWalletToken = 25000 * 10 ** 3;
