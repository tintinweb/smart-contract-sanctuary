...
contract Potenza is ReentrancyGuard, Ownable, NPassCore {
    ...
    constructor (string memory _name, string memory _symbol, address _n) NPassCore(_name, _symbol, IN(_n), false, 1000, 1000, 20000000000000000, 50000000000000000) {
    }
