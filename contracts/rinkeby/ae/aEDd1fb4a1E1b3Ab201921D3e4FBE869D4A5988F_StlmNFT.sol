...
/// @title StlmNFT
/// @notice A contract for virtual Stlmllite in the starlink ecosystem
contract StlmNFT is StarlERC721("Starlink Living Module", "STLM") {
    ...
    /// @notice event emitted when Stlmllite info
    ...
    /// @dev Stlmllite Info for each Stlm NFT
    struct StlmInfo {
        uint256 st_planet;
        uint256 st_speed;
    ...
    /**
     @notice Set Stlmllite launch time, Stlm will start to earn rewards
     @dev Only Governance can call this method
     @param _tokenId The ID of the token being updated
     @param _timestamp Timestamp of launching Stlmllite
     */
    ...
    /**
     ...
     @dev Only Governance can call this method
     @param _tokenIds The ID of the token being updated
     @param _timestamps Timestamp of launching Stlmllite
     */
