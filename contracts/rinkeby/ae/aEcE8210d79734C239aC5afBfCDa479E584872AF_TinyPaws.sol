...
contract TinyPaws is ERC1155, Ownable {
    ...
    constructor() ERC1155("https://storage.googleapis.com/test1488/testmeta/{id}") {
    ...
    modifier maxSupplyCheck(uint amount)  {
        require(mintedNFTs + tokensSupply + amount <= MAX_SUPPLY, "Tokens supply reached limit");
    ...
    function totalSupply() external view returns (uint) {
        return mintedNFTs + tradeNFTsMinted - burnedNFTs;
    }
    ...
    function trade(uint[] memory tokens) external {
        ...
        burnedNFTs += 3;
        tradeNFTsMinted += 1;
        _mint(msg.sender, MAX_SUPPLY + tradeNFTsMinted, 1, "");
    }
