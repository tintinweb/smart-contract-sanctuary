...
abstract contract VaultStorage is Initializable, ISmartVault {
  ...
  function vaultFractionToInvestNumerator() public view override returns (uint256) {
  ...
  function vaultFractionToInvestDenominator() public view override returns (uint256) {
  ...
  function allowSharePriceDecrease() public view override returns (bool) {
  ...
  function withdrawBeforeReinvesting() public view override returns (bool) {
  ...
  function nextImplementationDelay() public view override returns (uint256) {
  ...
  function strategyTimeLock() public view override returns (uint256) {
