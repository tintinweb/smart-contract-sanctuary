...
contract DutchAuction{
    ...
    function getCurrentPrice() public returns(uint256) {
        ...
        if (open == 1){
            if (finish <= block.timestamp){
                ...
                currentPrice = startprice * ((finish - block.timestamp)*10000/(finish - start))/10000;
    ...
    function bid(uint256 amount) public payable{
        ...
        price = getCurrentPrice();
        require (msg.value >= price * amount / 10**18, "Not enough payment");
