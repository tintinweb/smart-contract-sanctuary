...
contract OyizaNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _name, string memory _symbol, string memory _initBaseURI) ERC721 (_name, _symbol){
        ...
        uint256 reserveMint = 5;
        maxMintAmount = reserveMint;
        mint(reserveMint);
        maxMintAmount = 10;
    }
    ...
    function mint(uint _mintAmount) public payable {
        ...
        require(_mintAmount <= maxMintAmount,
            string(abi.encodePacked("Maximum mint amount(" , maxMintAmount , ") exceeded")));
