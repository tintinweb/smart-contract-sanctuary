...
/**
 *  This contract allows Olympus founding team to claim OHM. It has been
 *  revised to consider 2/3 tokens as staked at the time of claim; previously,
 *  no claims were treated as staked. This keeps network ownership under check. 
 *  100% can be treated as staked, if governance sees fit to do so.
 */
contract SeedClaimOHM {
    ...
    bool useStatic; // track 1/3 as static. governance can disable if desired.
