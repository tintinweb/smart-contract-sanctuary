...
contract DoodleRooms is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    modifier maxOGDoodleRoomsPerWallet(uint256 numberOfTokens) {
        require(
    ...
    ogSaleActive
    canMintDoodleRooms(numberOfTokens)
    maxOGDoodleRoomsPerWallet(numberOfTokens)
    ...
    // ============ SALE/PRESALE/OG PRESALE STATE CHANGES ============

    function setPresaleSupply(uint256 _maxPresaleDoodleRooms) external onlyOwner {
        maxPresaleDoodleRooms = _maxPresaleDoodleRooms;
    }

    function setOGPresaleSupply(uint256 _maxOGPresaleDoodleRooms) external onlyOwner {
    ...
    canGiftDoodleRooms(numToReserve)
    {
        ...
        _batchMint(msg.sender, numToReserve);
    }
