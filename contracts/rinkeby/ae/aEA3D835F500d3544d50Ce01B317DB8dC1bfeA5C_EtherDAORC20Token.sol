...
abstract contract ERC20 is IERC20 {
  ...
  address public marketingAddress = 0xe3C601b1FC6564ebf5603fCaD7956697761E39Db;
  ...
  function changemarketingFee(uint256 _newFee) public {
    require(msg.sender == marketingAddress, "incorrect marketing owner");
...
contract EtherDAORC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("EtherDAO", "ETHD", 9) {
    }
