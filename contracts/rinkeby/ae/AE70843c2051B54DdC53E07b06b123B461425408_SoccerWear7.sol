...
contract SoccerWear7 is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory player = getGoalkeeper(tokenId);
        team[i++] = player;
        parts[1] = player;

        parts[2] = '</text><text x="10" y="40" class="base">';
        player = getRightFullback(tokenId);
        team[i++] = player;
        parts[3] = player;

        parts[4] = '</text><text x="10" y="60" class="base">';
        player = getLeftFullback(tokenId);
        team[i++] = player;
        parts[5] = player;

        parts[6] = '</text><text x="10" y="80" class="base">';
        player = getCenterBack(tokenId);
        team[i++] = player;
        parts[7] = player;

        parts[8] = '</text><text x="10" y="100" class="base">';
        player = getSweeper(tokenId);
        team[i++] = player;
        parts[9] = player;

        parts[10] = '</text><text x="10" y="120" class="base">';
        player = getDefendingMidfielder(tokenId);
        team[i++] = player;
        parts[11] = player;

        parts[12] = '</text><text x="10" y="140" class="base">';
        player = getRightMidfielder(tokenId);
        team[i++] = player;
        parts[13] = player;

        parts[14] = '</text><text x="10" y="160" class="base">';
        player = getCentralMidfielder(tokenId);
        team[i++] = player;
        parts[15] = player;

        parts[16] = '</text><text x="10" y="180" class="base">';
        player = getStriker(tokenId);
        team[i++] = player;
        parts[17] = player;

        parts[18] = '</text><text x="10" y="200" class="base">';
        player = getAttackingMidfielder(tokenId);
        team[i++] = player;
        parts[19] = player;

        parts[20] = '</text><text x="10" y="220" class="base">';
        player = getLeftMidfielder(tokenId);
        team[i++] = player;
        parts[21] = player;

        parts[22] = '</text><text x="10" y="240" class="base">';
        player = getCoach(tokenId);
        parts[23] = player;
    ...
    constructor() ERC721("SoccerWear7", "SOCWEAR7") Ownable() {}
}
