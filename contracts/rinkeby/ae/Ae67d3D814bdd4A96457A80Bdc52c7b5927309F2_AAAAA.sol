...
contract dgfsergrvrbtrf is dgdshthtr, hfljjdthf, wfsdafsdac, fgfgegfbfvwf, scscfdsddwdvb {
...
contract dfhfdbtgfgvgef is dgdshthtr, hfljjdthf, wfsdafsdac, fgfgegfbfvwf, scscfdsddwdvb {
    ...
    function b_NEW_Solution(uint Problem_ID, string memory Name, string memory Explanation) public {
        ...
        solutionDetails.Solution_ID                         = q_TOTAL_Solutions;
...
contract sdgfghfgr is dgdshthtr, hfljjdthf, wfsdafsdac, fgfgegfbfvwf, scscfdsddwdvb {
...
contract AAAAA is segfdfgfd, dgfsergrvrbtrf, dfhfdbtgfgvgef, sdgfghfgr {
