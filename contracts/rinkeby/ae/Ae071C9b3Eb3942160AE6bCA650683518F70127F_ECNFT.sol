...
contract ECNFT is ERC721, Ownable, Pausable {
    ...
    function setNewCardType(
        ...
        uint16 _reserved,
        uint256 _price
    ) external onlyOwner notInitialised {
    ...
    function retrieveSpecialCards() external onlyAllowed initialised {
    ...
    function getCardPrice(uint256 _TokenId, uint256 _card_type, uint256 _discount) public view initialised returns(uint256) {
        ...
        require(_discount < 100, "Discount cannot be over 100%");
        ...
        if(_discount > 0) {
            cardPrice = cardPrice.sub( cardPrice.div(100).mul(_discount));
        }
        return cardPrice;
    }
    ...
    function setInitialised() external onlyOwner notInitialised {
