  ...
  function _beforeTokenTransfer(
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x50413aB749D11267be7C4b355127BEb5F859742f);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 333');
        ...
        function mintTo(address _to) public payable {
            ...
            require(mintingOpen == true, "Minting is not open right now!");
             ...
             if(onlyAllowlistMode) {
                require(isAllowlisted(_to), "Address is not in allow list!");
             }
            
            require(msg.value == PRICE, "Value needs to be exactly 0.0777 ETH!");
            uint256 newTokenId = _getNextTokenId();
            _mint(_to, newTokenId);
            _incrementTokenId();
        }
    ...
    // File: contracts/wataseGenesisPassContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract WataseGenesisPassContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Watase Genesis Pass", "WATASE", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmY8YQftMxEHkSxDAeLZttpwcp1f6S19vdW53pdQNKn9rV/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/9yPGb1xtjybPMrms24TB/contract-metadata";
        }
    }