...
contract Vendor {
    ...
    uint256 public amountOfDAITokensToPay;
    uint256 public amountOfDAITokensToPay2;
    uint256 public scv_price;
    ...
    function buyTokens() public payable {
        ...
        uint256  latestPrice = getLatestPrice(aggregatorAddressFor_ETH_USD);
    ...
    function buyTokensForDAI(uint256 amountToBuy) public {
        ...
        amountOfDAITokensToPay = amountToBuy/uint256(getLatestPrice(aggregatorAddressFor_DAI_USD));
//        amountOfDAITokensToPay2 = amountToBuy/uint256(getLatestPrice(aggregatorAddressFor_DAI_USD));
...
//        myTokenContract.transfer(msg.sender, amountToBuy);
    ...
    function getLatestPrice(address aggregatorAddress) internal returns (uint256){
        ...
        scv_price = uint256(price)/10**decimals;
