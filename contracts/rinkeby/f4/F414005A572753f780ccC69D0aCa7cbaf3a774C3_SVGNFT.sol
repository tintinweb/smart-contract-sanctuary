...
contract SVGNFT is ERC721URIStorage {
    ...
    function formatTokenURI(string memory _imageURI) public pure returns (string memory) {
        ...
        string memory tokenBase64Encoded = Base64.encode(bytes(string(abi.encodePacked('{"name":"SVGNFT", "desciption": "test", "attributes":"", "image": "',_imageURI,'"}'))));
        string memory tokenURI = string(abi.encodePacked(baseURL, tokenBase64Encoded));
        return tokenURI;
    }
}
