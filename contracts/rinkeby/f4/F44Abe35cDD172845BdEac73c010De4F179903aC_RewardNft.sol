...
contract RewardNft is Ownable {
    ...
    function claimReward(address _token, uint256 _tokenId) onlyEnabledNft(_token) external {
        require(tokenClaimed[_token][_tokenId] == false, "token already claimed");
        require(IERC721(_token).ownerOf(_tokenId) == msg.sender, "wrong tokenId");
