...
library URI {
    ...
    function formatTokenURI(uint256 _tokenId, string memory _imageURI) internal pure returns (string memory) {
        string memory baseURL = "data:application/json;base64,";
        string memory tokenJsonBase64Encoded = Base64.encode(bytes(abi.encodePacked(    
            "{",
            '"name": "Scalable Vector Graphics NFT #', Strings.toString(_tokenId), '", ',
