...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transferToExcluded(address sender_address, address recipient_address, uint256 tAmount) private {
        (uint256 tTransferAmount, uint256 tFee, uint256 charity_amount, uint256 marketing_amount, uint256 burn_amount) = _getTValues(tAmount);
        uint256 currentRate =  _getRate();
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, currentRate);
        ...
        // update amount in recipient address
        uint256 transfer_amount = tTransferAmount - charity_amount - marketing_amount - burn_amount;
        _tOwned[recipient] = _tOwned[recipient].add(transfer_amount);
        ...
        // burn transacton %
        _burn(_msgSender(), burn_amount);_reflectFee(rFee, tFee);
        
        emit Transfer(sender, recipient, tTransferAmount);
    }

    function _transferFromExcluded(address sender_address, address recipient_address, uint256 tAmount) private {
        (uint256 tTransferAmount, uint256 tFee, uint256 charity_amount, uint256 marketing_amount, uint256 burn_amount) = _getTValues(tAmount);
        uint256 currentRate =  _getRate();
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, currentRate);
        ...
        // subtract from sender
        uint256 sub_amount = tAmount - charity_amount - marketing_amount - burn_amount;
        _tOwned[sender] = _tOwned[sender].sub(sub_amount);
    ...
    function _transferBothExcluded(address sender_address, address recipient_address, uint256 tAmount) private {
        (uint256 tTransferAmount, uint256 tFee, uint256 charity_amount, uint256 marketing_amount, uint256 burn_amount) = _getTValues(tAmount);
        uint256 currentRate =  _getRate();
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, currentRate);
