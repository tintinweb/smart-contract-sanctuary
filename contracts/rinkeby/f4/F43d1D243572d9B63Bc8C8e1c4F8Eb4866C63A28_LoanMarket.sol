...
contract LoanMarket is LoanMarketBase {
    ...
    */
     function createLoanOfferToken(LoanData.LoanDetails memory loanDetails)
        ...
        uint256 ltv  = this._calculateLTV(loanDetails.stakedCollateralAmounts, loanDetails.stakedCollateralTokens, loanDetails.borrowStableCoin, loanDetails.loanAmountInBorrowed);
    ...
    function tokenLoanOfferAdjusted(
        ...
        uint256 ltv  = this._calculateLTV(loanOffersToken[_loanIdAdjusted].stakedCollateralAmounts, loanOffersToken[_loanIdAdjusted].stakedCollateralTokens, _newBorrowStableCoin, _newLoanAmountBorrowed);
        uint256 maxLtv = this.getMaxLtv(collatetralInBorrowed, msg.sender);
        ...
        returns (uint256)
    {
        ...
        return this._calculateLTV(stakedCollateralAmounts, stakedCollateralTokens, borrowedToken, loanDetails.loanAmountInBorrowed);
    }
