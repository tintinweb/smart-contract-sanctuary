...
contract PublicSale is IPublicSale, Ownable {
    ...
    uint256 public constant PRE_SALE_DELAY = 2 hours;
    uint256 public constant LP_CREATION_DELAY = 3 hours;
    ...
    uint256 public constant MAX_DEPOSIT_ETH_AMOUNT = 0.5 ether;
    ...
    function addLiquidity() external override  {
        ...
        oneUpToken.setTradingStart(block.timestamp.add(2 hours));
    }
    ...
    function lockCompanyTokens(address developerReceiver, address marketingReceiver, address reserveReceiver) external override {
        ...
        developerLockContract = address(new CliffVesting(developerReceiver, 1 hours, 3 hours, address(oneUpToken)));    //  1 month cliff  6 months vesting
        marketingLockContract = address(new CliffVesting(marketingReceiver, 1 hours, 3 hours, address(oneUpToken)));      //  7 days cliff   3 months vesting
        reserveLockContract = address(new CliffVesting(reserveReceiver, 1 hours, 3 hours, address(oneUpToken)));        //  9 months cliff 3 months vesting
