...
contract CubSkwad is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("CUBSKWAD", "CUB") {
    ...
    // only trusted because we will only call addresses we trust for the withdraw
    function trustedWithdrawAll(address payable _to) public payable onlyOwner {
    ...
    function safeMintPresale() public payable {
