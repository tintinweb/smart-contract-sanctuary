...
contract HBMS is ERC721, Ownable {
    ...
    uint256 private SINGLE_OPTION = 1;
    uint256 private FIVE_OPTION = 5;
    uint256 private TEN_OPTION = 10;
    ...
    function canBuy(uint _optionId, address _sender) internal view returns (bool){
        ...
        if (_optionId != SINGLE_OPTION && _optionId != FIVE_OPTION && _optionId != TEN_OPTION) {
            revert("invalid_option");
        }
        if (_sender != owner()) {
            return addressToBalance[_sender] >= ((1 ether * PRICE / 100) * _optionId);
        } else {
            return true;
        }
    }
    ...
    function canMint(uint256 _optionId) internal view returns (bool) {
        ...
        return currentSupply < (SUPPLY - _optionId);
    }
    ...
    function deductBalance(uint _optionId) internal {
        ...
        uint value = (10000000000000000 * PRICE) * _optionId;
