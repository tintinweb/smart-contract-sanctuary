...
contract MechanizedPreSale is Ownable {
    ...
    bool public ownerCanModify = true;
     ...
     // Token data
    uint256 public MAX_SUPPLY_PRE_SALE = 500;    // the maximum amount of tokens that can be minted
    uint256 public MAX_GIVEAWAY_SUPPLY = 50;
    uint256 public PRE_SALE_MINT_PRICE = 0.00000001 ether; //persale mint price: 0.01 ETH
    uint256 public MAX_PRE_MINT_PER_USER = 500; // maximum amount of tokens one address can mint  
    ...
    mapping(address => bool) public giveAwayClaimed;
     ...
     /** MERKLE */
    bytes32 public preSaleMerkleRoot = 0xeb981f7ae2e43052da7fa2e37245c2fd9037cb7832560cbcf502d0000a83d7db;
    bytes32 public giveawayMerkleRoot = 0x5652680efd92be84add211823332ab0527521d243af1dfb2ad8ab7e3a4b66fc7;
