...
contract Tan is ERC721, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        //return string(abi.encodePacked("id: ", tokenId.toString(), ", shape: ", shape, ", generation: ", (uint8(generation)+1).toString(), ", rarity: ", rarityDescription.percentage.toString(), ", description: ", rarityDescription.description, ", category: ", RARITY_CATEGORY_NAME[uint256(rarityDescription.category)]));
        ...
        return string(
            abi.encodePacked(
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            '{"name":"bbx test","description":"', shape, '","image":"', imageURI ,'"}'
                            // '{"name":"Boombox gen',
                            // generationString, ' #', tanId.toString(), '","description":"',
                            // shape,
                            // '","attributes":[{"trait_type":"Generation","value":',
                            // generationString,
                            // ',"max_value":7,"display_type":"number"},{"trait_type":"Shape","value":"',
                            // shape,
