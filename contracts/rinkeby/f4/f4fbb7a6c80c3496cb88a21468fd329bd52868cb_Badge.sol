...
contract Badge is ERC1155, BaseContract {
    ...
    mapping(address => mapping(uint256 => uint8)) public isBadgeClaimed;
    ...
    function getBadgePrice(uint256 ids) public view returns (uint256) {
        return _badgePrize[ids];
    }

    function getBadgeExpiry(uint256 ids) public view returns (uint256) {
        return badgeExpiry[ids];
    }

    function getCoolingTime(uint256 badgeIds) public view returns (uint256) {
        return coolingTime[badgeIds];
    }

    function isBadgeAssign(uint256 ids) public view returns (uint256) {
    ...
    function getCopiesLeft(uint256 ids) public view returns (uint256) {
    ...
    function tokenIdToURI(uint256 ids) public view returns (string memory) {
