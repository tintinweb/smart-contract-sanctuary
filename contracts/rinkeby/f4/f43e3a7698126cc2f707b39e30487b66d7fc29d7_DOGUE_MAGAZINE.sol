...
contract DOGUE_MAGAZINE is ERC721Enumerable, Ownable {
    ...
    address private communityFund = address(0xa89146d9d72E4Aa7bd2c10599D9f45bebAA74F39);    //$DOGUE's Community Fund
    ...
    constructor() ERC721("Dogue Magazine", "DOGUEMAG")  { //TODO Name
        //Mint the first ever batch of DOGUE Magazines
        _safeMint(owner(), 0); //TODO Make batch mint function? 
        _safeMint(communityFund, 1);
    }
