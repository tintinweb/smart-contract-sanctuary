...
contract MWC is ERC721Enum, Ownable, ReentrancyGuard {
	...
	require(_mintAmount <= preSaleMint, "Too many" );
    ...
    function setPreMintAmount(uint256 _newMaxMintAmount) public onlyOwner {
	preSaleMint = _newMaxMintAmount;
	}
