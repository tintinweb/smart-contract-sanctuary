...
contract CryptoCrooks is ERC721, Ownable {
    ...
    string public BANANA_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN CROOKS ARE ALL SOLD OUT
    ...
    uint256 public constant MAX_BANANAS = 5000;
    ...
    function mintBoringBanana(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_BANANAS, "Purchase would exceed max supply of Crooks");
