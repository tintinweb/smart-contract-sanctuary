...
contract Test is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public maxPerTranscation = 10;
    ...
    string PROVENANCE = "";
    address t1 = 0x5E1457B43574738cf5857F9b5BfA9c0a9EA9f369; 
    address t2 = 0x442ED4127b07032C6e717a729E09d47e7F434Fd1; 
    address t3 = 0x56ce67140B48169F2765C2a8e3240CA7CF8ED563; 
    address t4 = 0x88D9843637e8a8be60277F48b4a1b1CF68C3524a; 
    ...
    function setmaxPerTranscation(uint256 newmaxPertranscation) external onlyOwner {
        maxPerTranscation = newmaxPertranscation;
    }
    ...
    function mint(uint256 numberofTokens) external payable whenSaleStarted {
        require(numberofTokens <= maxPerTranscation,"You can't mint more than 10 per transcation.");
        require(_t.add(numberofTokens) <= maxSupply,"Exceed the max supply.");
        require(numberofTokens*price <= msg.value,"You need more ETH to mint." );
