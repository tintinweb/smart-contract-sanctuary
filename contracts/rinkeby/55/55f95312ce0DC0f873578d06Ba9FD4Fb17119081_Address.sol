...
// File @openzeppelin/contracts/token/ERC721/extensions/IE[email protected]
...
contract ZZZINU is ERC721, ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint256 public maxAirdropAmount = 20;
    ...
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("ZZZINU", "ZZZINU") { 
