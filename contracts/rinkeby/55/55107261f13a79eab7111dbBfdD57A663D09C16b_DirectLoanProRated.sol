 ...
 */
contract DirectLoanProRated is DirectLoanBase {
    /* ********** */
    /* DATA TYPES */
    /* ********** */

    bytes32 public constant LOAN_TYPE = bytes32("DIRECT_LOAN_PRO_RATED");
     ...
     */
    function _updateInterestRate(uint256 _loanId) internal {
        ...
        returns (uint256 adminFee, uint256 payoffAmount)
    {
        ...
        adminFee = LoanChecksAndCalculations._computeAdminFee(interestDue, uint256(_loan.loanAdminFeeInBasisPoints));
    ...
    function _computeInterestDue(
        ...
        uint256 interestDueAfterEntireDuration = (_loanPrincipalAmount * _loanInterestRateForDurationInBasisPoints) /
            uint256(HUNDRED_PERCENT);
        uint256 interestDueAfterElapsedDuration = (interestDueAfterEntireDuration * _loanDurationSoFarInSeconds) /
