...
contract InsuracePositionController is AbstractController {
    ...
    */
    ...
    function unstake() external override onlyIndex returns (uint256) {
        ...
        _stakingController.withdrawTokens(lptokenBalance, _stakingAsset);

        require(
            IERC20Internal(_stakingAsset).balanceOf(address(this)) >= _stakes,
        ...
        // Convert to base
        uint256 baseAmount = _swapAssets(_stakes, _stakingAsset, address(base));
