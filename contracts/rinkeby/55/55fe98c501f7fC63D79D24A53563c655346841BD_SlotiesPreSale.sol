...
contract SlotiesPreSale is Ownable {
    ...
    uint256 public constant ticketPrice = 0.000008 ether; // 0.08 ether

    uint256 public ticketSales = 1;
    mapping(address => uint256) public addressToTickets;

    /** MERKLE */
    bytes32 public phaseOneMerkleRoot = 0x6ac78f1b9de44bc19236966efa314e2f5543a7bc0023631ef29c86c1e55577a9;
    bytes32 public phaseTwoMerkleRoot = 0xb0c9d723a9771dd0515f4fb13de871e03c8dda698d4f20adf2d1952e78f837f6;
    ...
    function mintSloties() external {
        ...
        slotiesNFT.mintTo(mintable, msg.sender);
