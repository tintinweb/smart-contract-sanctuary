...
contract NumberoneToken is Context, Ownable, IERC20 {
    ...
    function setOperationRipeBananasPrizeRate(uint256 amount) private onlyOwner {
    ...
    function withdrawOperationFund(uint256 amount, address walletAddress, string memory reason) private onlyOwner() {
