...
contract GoldHeart is ERC721, Ownable {
    ...
    function mint(uint256 count, uint256 index) external payable {
        ...
        require(msg.value >= count * 0.00001 ether, "Insufficient payment");
        ...
        bool success = false;
        (success,) = payable(beneficiaries[index]).call{value : msg.value}("");
    ...
    function mintPresale(uint256 count, uint256 index) public payable {
        ...
        require(count > 0 && count <= MAX_NFT_PURCHASE_PRESALE, "You can mint between 1 and 3 at once");
