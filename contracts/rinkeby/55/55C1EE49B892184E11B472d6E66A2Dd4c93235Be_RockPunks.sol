...
// File contracts/RockPunksDNA.sol



pragma solidity ^0.8.4;

contract RockPunksDNA {
...
// This pseudo random function is determistic and should not be used on production
    ...
    function _getDNASection(uint256 _dna, uint8 _rightDiscard) internal pure returns (uint8) {
        ...
        return uint8 ((_dna % (1 * 10 **(_rightDiscard)))/(1 * 10 **_rightDiscard));
    }
...
// File contracts/RockPunks.sol


pragma solidity ^0.8.4;
contract RockPunks is ERC721,ERC721Enumerable, RockPunksDNA {
    ...
    constructor(uint256 _maxsupply) ERC721("RockPunks", "RFPKS"){ 
    ...
    function mint () public {
        ...
        require(current < maxSupply, "No Rock Punks left :(");
