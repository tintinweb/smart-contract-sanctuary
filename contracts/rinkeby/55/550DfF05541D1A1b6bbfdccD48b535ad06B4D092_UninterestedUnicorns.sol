    ...
    Ownable
{
    ...
    uint256 public constant PRIVATE_SALE_OPEN = 1631223900; // For testing only
    ...
    IBloot private BLOOT = IBloot(0x936815E1C2330a2a2f47Ce23cba079af7C521507);
    // uint256 public constant BLOOT_SALE_WINDOW = 1 hours;
    uint256 public constant BLOOT_SALE_WINDOW = 10 minutes;
