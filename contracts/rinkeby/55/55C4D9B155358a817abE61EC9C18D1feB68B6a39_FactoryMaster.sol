...
contract FactoryMaster {
    ERC20FixedSupply[] public childrenErc20;
    ...
    function getChildrenErc20() external view returns (address) {
    ...
    function getChildrenErc20Burnable() external view returns (address) {
    ...
    function getChildrenErc20Mintable() external view returns (address) {
    ...
    function getChildrenErc20MintableBurnable()
        external
        view
        returns (address)
    {
...
contract ERC20Burn is ERC20Burnable {
    ...
    constructor( string memory name, string memory symbol, uint8 decimal, uint256 initialSupply) ERC20Standard(name, symbol, decimal) {
...
contract ERC20Mintable is ERC20Standard {
    ...
    constructor(uint256 cap_, string memory name, string memory symbol,uint8 decimal,uint256 initialSupply) 
