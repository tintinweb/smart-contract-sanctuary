...
contract Batch is IERC721Receiver, AccessControl {
    ...
    */
    ...
    function amountDmgTokenOut(uint256 _amount) public view returns(uint256){
        uint256 diamondTokenOut = getDiamondTokenPrice().div(pricePrecesion).div(_amount);
    ...
    function _depositNFT(
        ...
        uint256 diamondTokenOut = getDiamondTokenPrice().div(pricePrecesion).div(price_);
    ...
    function addNFTToCollection(
        ...
        uint256 collateralAmount = getCollateralTokenPrice().div(pricePrecesion).div(price_);
