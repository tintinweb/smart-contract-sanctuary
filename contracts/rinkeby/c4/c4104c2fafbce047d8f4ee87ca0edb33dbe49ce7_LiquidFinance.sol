...
//5% fee is deducted from each transaction, of that 5% fee, 3% is is instantly distributed among all holders of the token & 2% is automatically burned which continuously reduces the total supply.
...
contract LiquidFinance is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 20 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Liquid Finance';
    string private _symbol = 'Liquid';
