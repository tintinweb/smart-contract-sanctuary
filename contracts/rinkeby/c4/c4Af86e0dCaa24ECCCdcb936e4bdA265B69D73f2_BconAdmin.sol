...
contract BconContract is IBconContract {
    ...
    */
    ...
    event ContractNewMessage(
        IBillingUnits.Message message
    );
    ...
    */
    ...
    function throwDocumentsUpdated() public override {
       require(
            msg.sender == bconContract.documents,
            "sender must be documents contract"
        ); 
        ...
        ) = Documents(bconContract.documents).getDocuments();
    ...
    function throwNewMessage(IBillingUnits.Message memory message)
        public override {
        // TODO: require
