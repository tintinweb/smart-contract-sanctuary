...
/* This code will work for any ERC-721 contract. Please feel free to reuse by following the below 4 steps :-)

- Change IERC721Enumerable contract address in constructor
- Update domainLabel value
- Set controller address of the top level domain to this deployed contract
- Follow `@hodl_pcc` on Twitter and say Hi
...
contract EnsMapper is Ownable {
    ...
    function setDomain(string calldata label, uint256 token_id) public {
        ...
        require(tokenHashmap[token_id] == 0x0, "Label is currently being used");
    ...
    function getClaimableIdsForAddress(address addy) public view returns(uint256[] memory){
        if(address_whitelist[addy] || publicClaimOpen || owner() == addy){
