...
contract AAACryptoAccessories is IERC1155 {
    ...
    constructor( ) {
        ...
        _setOwner(msg.sender); // 1
        _owner1 = 0xe3C4829b5A733557c58d97f2610eD8d2fF74115C; // 2
        _owner2 = 0x519a1D0b42C802b7684Dbaae61a2725c510c332f; // 3
        first25 = 0xe3C4829b5A733557c58d97f2610eD8d2fF74115C; // 2
        ...
        [
            0xf957D41f98b279e8BB142a8325fb569BaA15f5B6, // 4
