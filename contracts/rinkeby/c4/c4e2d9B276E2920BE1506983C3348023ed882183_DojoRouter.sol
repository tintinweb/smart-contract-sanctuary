...
contract DojoRouter is Ownable {
    ...
    function swapTokensforETH(
        ...
        uint256 amount = _swap(_tokenIn, router.WETH(), _amount, address(this));
        //withdraw the weth to eth
        IWETH(WETH).withdraw;
        //initate trade, ETH can be claimed directly from dojo
        dojo.initiateTrade{value: amount}(_belt);
    }

    receive() external payable {}

    /**
     * Copied from sushimaker contract
     */
    function _swap(
        address fromToken,
        address toToken,
