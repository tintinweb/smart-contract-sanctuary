...
contract EthereumDatabase
{
 ...
 address owner;
 int256 public CurrentRID;
 int256 public CurrentPID;
  ...
  struct databaseP
 {
    ...
    function SetDatabaseR(int256 id, string name, string destinasi,int256 R0, int256 R1, int256 R2, int256 R3, int256 R4, int256 R5, int256 R6)
    {
       // var hash = sha3(msg.sender, owner, R1);
        ...
        var dataR = databaseR(msg.sender, id, name ,destinasi, R0, R1, R2, R3, R4, R5, R6);
