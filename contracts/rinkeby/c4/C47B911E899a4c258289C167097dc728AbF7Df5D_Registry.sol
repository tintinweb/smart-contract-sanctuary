...
contract Registry is IRegistry, AccessControl {
    event EventCreated(address addr, string name, string uri, address owner);
    address[] private _allEvents;
    ...
    function addEvent(
        ...
        _allEvents.push(addr);
        emit EventCreated(addr, name, uri, owner);
    }
}
