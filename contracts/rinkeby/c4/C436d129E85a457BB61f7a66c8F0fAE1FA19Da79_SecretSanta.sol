...
contract SecretSanta is ERC721, Ownable, IERC721Receiver {
    event Deposited(bool success, uint256 tokenId, address addr);
    ...
    function withdraw() public {
        ...
        IERC721(gift.addr).approve(address(this), gift.tokenId);
    ...
    function deposit(address addr, uint256 tokenId) public {
        ...
        emit Deposited(true, gift.tokenId, gift.addr);
    }
