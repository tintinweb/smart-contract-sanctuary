...
contract PrivateSale is Ownable {
  ...
  bytes32 public immutable walletsHash;
  ...
  function erasePurchase(address buyer) external {
    require(block.chainid != 1, '!testnet');
    hasBought[buyer] = false;
  }
