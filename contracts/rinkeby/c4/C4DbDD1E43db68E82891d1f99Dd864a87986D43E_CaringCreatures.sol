...
contract CaringCreatures is ERC721, Ownable {
    ...
    uint256 public activePresaleRound;
    ...
    address private _wallet1 = 0xCcb45d48dA2746888618eF9c512E24357426C3cd;
    address private _wallet2 = 0x8A57A49844294d7aa917A8279A6E3F0207aF73D3;
    ...
    function mint(uint256 count) external payable {
        ...
        require(count > 0 && count <= 25, "You can mint between 1 and 25 at once");
    ...
    function mintPresale(uint8 round, uint256 count) external payable {
        require(msg.sender == tx.origin, "Reverted");
        require(count > 0 && count <= 25, "You can mint between 1 and 25 at once");
        ...
        require(presaleRound.addresses[msg.sender] >= count, "You don't have slot to mint");
        require(presaleRound.active, "Round not active");
    ...
    function updateGiveawayMintCount(uint256 newLimit) external onlyOwner {
    ...
    function activeMintingDetails() public view returns (string memory publicOrPresale, uint256 round) {
        if (publicsaleActive) {
