...
contract decoffer_V2{
    ...
    recommender RT = recommender(0x7334D035BC07aeDe8507a69d0bE1DC475A8090A9);
    ...
    function bouns(address _user , uint ct_amount)private{
        ...
        for(uint i=1; i<=3; i++){
            ...
            uint bonus = ct_amount.mul(rate).div(1000);
