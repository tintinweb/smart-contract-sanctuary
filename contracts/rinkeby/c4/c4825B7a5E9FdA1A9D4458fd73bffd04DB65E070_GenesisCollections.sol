...
contract GenesisCollections is Ownable {
    ...
    address private chainLinkNativeToUsd = 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e; // Chainlink Eth/Usd Rinkeby
    ...
    constructor(address _usdt, address[] memory _ids, address _communityWallet) {
        ...
        priceFeed = AggregatorV3Interface(
            chainLinkNativeToUsd
        );

        require(_communityWallet != address(0), "GenesisCollections: community wallet is not setup");
    ...
    function getPriceNativeTokenToUsd() public view returns(uint256) {
        (, int256 price, , , ) = priceFeed.latestRoundData();
