...
contract RabbitCollegeClub is ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_TOKENS_TO_RESERVE = 40;
    ...
    function reserveRabbits(uint tokens) public onlyOwner {
        require(tokens <= MAX_TOKENS_TO_RESERVE, "RabbitCollegeClub: tokens more then MAX_TOKENS_TO_RESERVE");
