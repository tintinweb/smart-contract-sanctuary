...
contract BrainDrops is ERC721, Ownable {
    ...
    // TODO gas comparison for calculating vs storing
    ...
    function addProject(string memory _projectName, string memory _projectBaseURI, address _artistAddress, uint256 _pricePerTokenInWei, bool _dynamic, uint _maxAmount) public onlyWhitelisted {
    ...
    function maxAmount(uint _projectId) public view returns(uint) {
      Project storage project = projects[_projectId];
      return project.maxInvocations;
    }
