...
contract FeistyPrint is ERC721Enumerable, Ownable, Pausable {
  ...
  // -- Functions -- //
  function print() external whenNotPaused {
  ...
  function redeem() public whenNotPaused {
    ...
    require(tokenCount > 0, "FeistyPrint: sender doesn't have a print");

    uint256 tokenToRedeem = tokenOfOwnerByIndex(_msgSender(), tokenCount - 1);
