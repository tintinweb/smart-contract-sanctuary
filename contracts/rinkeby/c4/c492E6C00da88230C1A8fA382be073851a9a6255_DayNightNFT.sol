    ...
    VRFConsumerBaseInitializable
{
    ...
    //     __ERC721_init("DiceAlx", "ALX");
    //     VRFCoordinator = _VRFCoordinator;
    //     LinkToken = _LinkToken;
    //     keyHash = _keyhash;
    //     fee = 0.1 * 10**18;

    //     emit WhichInitializerWorked("the Constructor was used");
    // }
    ...
    function __VRF_init(address _VRFCoordinator, address _LinkToken)
        internal
        initializer
    {
        VRFCoordinator = _VRFCoordinator;
        ...
        emit WhichInitializerWorked("the __VRF_init was used");
    }

    function mintNft(address toAddress, string memory tokenUrisHashcode1, string memory tokenUrisHashcode2)
        public
        onlyOwner
        returns (uint256)
    {
        ...
        tokenUrisHashcodes[0] = tokenUrisHashcode1;
        tokenUrisHashcodes[1] = tokenUrisHashcode2;

        activeUriHashcode[newTokenId] = tokenUrisHashcode1;
