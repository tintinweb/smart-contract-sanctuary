...
contract GivingBulls is ERC721EnumerableLite, Ownable {
    ...
    constructor() ERC721B("Giving Bulls", "GivingBulls") {
    ...
    function mint(uint8 total) public payable {
        ...
        require(nextId + total <= _maxSupply, "Purchase would exceed max supply");
