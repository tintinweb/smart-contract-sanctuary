...
contract MerkleProofTest is ERC721, ERC721Enumerable, Ownable {
    ...
    // config
    uint constant MAX_SUPPLY = 7777; // big up to area 51
    uint constant PRICE = 5 ether / 1000 ; // 0.05 ETH mint price
    ...
    function seeRoot() public view returns (bytes32 root){
