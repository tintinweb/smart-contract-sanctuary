...
import "./ERC721.sol";
import "./IBaconClub.sol";
import "./Ownable.sol";
import "./IProxyRegistry.sol";

contract BaconClub is Ownable, ERC721, IBaconClub {
    ...
    constructor() ERC721("Bacon Club NFT", "BACONFT") {
        // set after contract deployment
        contractURI = "https://baconclub.mypinata.cloud/ipfs/QmU1RhYkokWV11F54TUwmab1GAB2TuMXE8Yw1Zst6j1CEW";
        baseURI = "https://baconclub.mypinata.cloud/ipfs/QmYSruCkDFwvdDgbV2LAotrC1vX1NzBGSUqffeb9YzBfHT";
    }
    ...
    function mint(uint256 amount) external payable override {
        ...
        require(_isSaleActive, 'Sale must be active to mint Bacon Club NTFs');
        require(amount <= maxAmountPerMint, 'Cannot mint more than 10 NFTs in a transaction');
        require(msg.value >= price * amount, 'Not enough ether to mint - use 0.1 per NFT');
    ...
    function _safeMint(address recipient, uint256 tokenId) internal override {
        ...
        super._safeMint(recipient, tokenId+1);
    }
...
interface IBaconClub is IERC721 {
    /**
