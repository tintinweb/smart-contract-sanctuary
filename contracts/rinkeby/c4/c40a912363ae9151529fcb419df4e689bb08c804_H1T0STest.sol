...
// File: @openzeppelin/c[email protected]/token/ERC721/extensions/IERC721Metadata.sol
...
contract H1T0STest is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("H1T0STest", "HTS") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmevsJUzGU2XkQ8prw4A4LdDnrEvHvBDQjq62jUXNATqPQ/";
    }
