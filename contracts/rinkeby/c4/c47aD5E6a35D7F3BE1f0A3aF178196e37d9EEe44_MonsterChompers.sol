...
contract MonsterChompers is ERC721Enumerable, Ownable {
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {        
        baseURI = "https://ipfs.io/ipfs/Qmer6KJU3ZCmBGEXD9AtpDK6f1UYdftqGWJ7qXd1h6Mz5S/";
    }

    bool public saleStarted = true;
    uint256 public constant monsterPrice = 40000000000000000; //0.04 ETH
    uint256 public constant maxMonsters = 10000;
    ...
    function mint(address _buyer, uint256 numberOfTokens) public payable{
        ...
        require(_buyer != address(0x0), "Public address is not correct");

        for(uint i = 0; i < numberOfTokens; i++) {            
            uint mintIndex = totalSupply();                 
            if (totalSupply() < maxMonsters) {
                _safeMint(_buyer, mintIndex);                
            }
