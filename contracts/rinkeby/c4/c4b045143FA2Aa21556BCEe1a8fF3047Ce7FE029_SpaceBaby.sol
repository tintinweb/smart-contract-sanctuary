...
contract SpaceBaby is ERC20, Ownable {
    ...
    constructor() ERC20("Space Baby", "SPB") {
        ...
        btcbDividendToken = 0x0bF197f62245726D950a175502779Db5FAd5143B; //BUSD for testnet - CHANGME
        dogeDividendToken = 0x1f728F76AcD56c09186a1Bd506627BB64257C932; //USDC for testnet - CHANGME
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D - Uniswap V2 Router
...
contract BtcbDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Btcb_Dividend_Tracker", "Btcb_Dividend_Tracker", 0x0bF197f62245726D950a175502779Db5FAd5143B) {
        claimWait = 3600;
...
contract DogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Doge_Dividend_Tracker", "Doge_Dividend_Tracker", 0x1f728F76AcD56c09186a1Bd506627BB64257C932) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10_000_000 * (10**18); //must hold 10000+ tokens
    }
