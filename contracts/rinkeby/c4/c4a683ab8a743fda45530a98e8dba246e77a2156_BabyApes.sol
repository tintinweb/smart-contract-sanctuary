...
interface IChainedApes {}

// 
contract BabyApes is ERC721Enumerable {
    ...
    IChainedApes public apesContract;
    
    function setApesContract(address _address) public onlyOwner{
        apesContract = IChainedApes(_address);
    }
    ...
    constructor() ERC721("BabyApes", "BAPES") {
        _owner = msg.sender;
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
    ...
    function mintBaby(address _to) external {
        require(msg.sender == address(apesContract));
        ...
        tokenIdToHash[thisTokenId] = hash(thisTokenId, _to, 0);
