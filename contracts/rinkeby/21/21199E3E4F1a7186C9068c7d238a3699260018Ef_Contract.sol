  ...
  PresaleList
{
    ...
    payable
  {
    ...
    require(!presaleMinted[msg.sender], "presaleMinted"); // address can only mint once
  ...
  function mintPartner(bytes32[] memory merkleProof, uint16 _count) external {
    ...
    require(ts + _count <= MAX_SUPPLY, "MAX_SUPPLY");
    require(!partnerMinted[msg.sender], "partnerMinted"); // address can only mint once
  ...
  // TODO: allow multiple mintings not greater than 10
