...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
      //  _owner = 0x9bcBE4Af33C43E12c82d2fcD77DF6AF7F82174A2; // Test Owner Noman 
      // _owner = 0x7cce8D677219f20fE340ACac2fCCf03c904E8041; // Basset Owner Address 
        _owner = 0x7cce8D677219f20fE340ACac2fCCf03c904E8041;
...
contract Basset is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x83BeEaF3df5d30bde5C792B5136337280762E970; // Charity/ Burn Address
    ...
    string private _name = "Basset Finance";
    string private _symbol = "Basset";
    ...
    constructor () {
        ...
        // For Binance Mainet IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Ether for all network
