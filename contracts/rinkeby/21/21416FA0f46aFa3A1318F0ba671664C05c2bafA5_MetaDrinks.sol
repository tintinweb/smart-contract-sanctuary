...
contract MetaDrinks is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("MD Test Desc", "mdtd") {
    ...
    function tokenURI(uint256 _tokenId) override public view returns (string memory) {
        ...
        return MetaDrinksMetaDataGenerator.genJsonTokenURI("svg");
    }
...
library MetaDrinksMetaDataGenerator {
    function genJsonTokenURI(string memory _drinkSvg) internal pure returns (string memory) {
        return string(abi.encodePacked("data:application/json;base64,", Base64.encode(bytes(string(abi.encodePacked(
                ...
                '"description": "The genesis collection of 10K Metadrinks with two generatives within each of them. A singular mantra in the title which sends you to a headspace and a unique random how-to. Ownership and commercial usage rights are given to you, the Metadrinker, over your [%]. Feel free to use it any way you want.  \n[metadrinks.io](https://metadrinks.io/)",',
