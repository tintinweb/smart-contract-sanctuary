...
contract MerkleDistributorCreator is AdminableUpgradeable {
    ...
    event MerkleDistrCreated(address merkleDistr);

    function __MerkleDistributorCreator_init(address _distributorImpl, address _proxyAdmin) public initializer {
        __Adminable_init();
    ...
    function createDistributor(address _token, bytes32 _merkleRoot) public onlyOwnerOrAdmin returns (address) {
        ...
        // TODO: think about ownership & admin permission of msg.sender
        ...
        emit MerkleDistrCreated(address(proxy));
