...
contract GamingChickAuction is OwnableContract, IERC721Receiver, Initializable{
    ...
    function removeWinnerRecords() public onlyAdmin {
        ...
        for (uint256 i = 0; i < winnerList[id].length; i++) {
            ...
            userInfo[0][addr].amount = 0;
            userInfo[0][addr].poolScore = 0;
            userInfo[0][addr].baseScore = 0;
            userInfo[0][addr].sameAttrScore = 0;
            userInfo[0][addr].specialAttrScore = 0;
            userInfo[0][addr].nftAttr = nftAttr;
            userInfo[0][addr].depositTokens = depositTokens;
