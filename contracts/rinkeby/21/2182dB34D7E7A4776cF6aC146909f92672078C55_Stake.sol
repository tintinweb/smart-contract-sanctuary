...
contract Stake is Ownable {
    ...
    event WithdrawSuccess(uint256 indexed stakeID,uint256 indexed amount, bool indexed WithdrawAll);
    ...
    function withdraw(address receiver, uint256 amount, uint256 stakeId, bool withdrawAll, uint stakePlanNumber) public onlyOperators {
        _token = IERC20(mappingStakePlan[stakePlanNumber].ERC20ContractAddress);
        require(_token.transfer(receiver,amount) == true,"Fail to transfer");
        emit WithdrawSuccess(stakeId,amount,withdrawAll);
    }
