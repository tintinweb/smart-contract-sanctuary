...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
    ...
    contract TestContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("test", "test", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/STRvB6YTcyHkdv8k5N97/contract-metadata";
        }
    }