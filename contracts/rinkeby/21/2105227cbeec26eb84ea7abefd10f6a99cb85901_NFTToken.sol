...
contract NFTToken is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;
    CountersUpgradeable.Counter private _tokenIds;
    mapping (uint256 => NFTMeta) private _tokenMeta;
    ...
    */
    function initialize() public initializer {
        ERC721Upgradeable.__ERC721_init_unchained("MyNft", "NFT");
        ...
        setBaseURI("http://api.abolfazl.dev/token/");
    }
    /**
    ...
    */
    function _setTokenMeta(uint256 _tokenId, NFTMeta memory _meta) private {
    ...
    * Mint NFT
    */
    function mintNFT(uint _TokensNr) public payable {
        require(saleIsActive, "Sale must be active to mint Tokens");
        require(_TokensNr <= MAX_PURCHASE, "Can only mint 15 tokens at a time");
        require(TokenCounter(_TokensNr)  <= MAX_TOKENS, "May supply of NFT's");
        ...
        for(uint i = 1; i <= _TokensNr; i++) {
            ...
            if (ItemID <= MAX_TOKENS) {
                ...
                NFTMeta memory metaData = NFTMeta(ItemID);
    ...
    */
    function mintGift(uint _GiftNr) public onlyOwner {
        ...
        require(TokenCounter(_GiftNr)  <= MAX_TOKENS, "Exceed max supply of NFT's");
        uint ItemID;
    ...
    */
    ...
    function tokenMeta(uint256 _tokenId) public view returns (NFTMeta memory) {
        require(_exists(_tokenId));
