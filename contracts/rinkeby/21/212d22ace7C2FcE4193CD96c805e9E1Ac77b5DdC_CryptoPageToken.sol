...
contract CryptoPageToken is ERC20, AccessControl {
    ...
    constructor() ERC20("Crypto Page", "PAGE") {
        ...
        PAGE_MINTER = new PageMinter(address(this));
...
contract PageMinter is AccessControl{
    ...
    constructor(address _page) {   
        // setAdminRole
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);

        _minters[msg.sender] = true;        
        TreasuryAddress = msg.sender; // setTreasuryAddress
        PAGE = CryptoPageToken(_page); // PAGE ADDRESS
    }

    mapping(string => uint256) private _addresses;
    function set(string memory _key, uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
