...
contract USDTieredSTOFactory is UpgradableModuleFactory {
    ...
    function deploy(bytes calldata _data) external returns(address) {
        address usdTieredSTO = address(new USDTieredSTOProxy(logicContracts[latestUpgrade].version, msg.sender, registry.getAddress("PayToken"), logicContracts[latestUpgrade].logicContract));

        require(false, "usdTieredSTO was created in deploy.");
