...
// TODO test ability to hide and reveal the baseURI
...
contract Doggo is ERC721A, Ownable, Pausable, PreSaleAware, ReentrancyGuard {
	...
	bytes32 public constant PRE_SALE_MERKLE_ROOT = 0x2d2896af09c1e5630ca80f13901fbb11d65e464884724d383ab20d53cc35f13a;
	...
	uint16 public constant MAX_MINT_AMOUNT = 8; // the max amount an address can mint
	...
	constructor() ERC721A("DoggoEye5", "DE5", 500) {
		setHiddenMetadataUri("ipfs://QmZV3dCwxVqU9EHtAJ6upr3DmaK5BXaTk132xyN2rT6FCk/hidden.json");
		//_pause(); // TODO deploy the contract paused
	}
	...
	/*
	 * @dev Withdraws the contracts balance to owner.
	 */
	function withdraw() public onlyOwner {
		// TODO reserve 35% for the DAO
