...
contract TokenERC1155 is AccessControl, ERC1155Pausable {
    ...
    function setBaseUri(string memory _newBaseMetadataURI) public {
        require(
            hasRole(ADMIN, _msgSender()),
            "must have Admin role to set new base URI"
        );
    ...
    function pause() public {
        require(
            hasRole(ADMIN, _msgSender()),
            "ERC1155PresetMinterPauser: must have Admin role to pause"
        );
        _pause();
    }
    ...
    function unpause() public {
        require(
            hasRole(ADMIN, _msgSender()),
            "ERC1155PresetMinterPauser: must have Admin role to unpause"
        );
        _unpause();
    }
}
