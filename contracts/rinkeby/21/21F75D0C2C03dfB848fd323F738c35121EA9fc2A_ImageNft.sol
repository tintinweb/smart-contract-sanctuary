...
contract ImageNft is ERC721 {
    ...
    constructor() ERC721("SWMS SMART CONTRACT","SWMSSC") {
        _tokenIds.increment();
        _owner = msg.sender;
    }
    /**
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "attributes": [ { "trait_type": "Artist", "value": "SWMS"}]}'
                    )
                )
            )
        );
    ...
    function mintSWMSNFT(
        ...
        _tokenIds.increment();
        emit CardNFTMinted(msg.sender, newItemId, newItemId);
    }
