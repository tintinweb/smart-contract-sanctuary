...
contract Nfinite is NPassCore {
    ...
    modifier saleLive() {
        require(block.timestamp >= launchTime, "SALE_NOT_LIVE");
        _;
    }
     ...
     */
    function multiMintWithN(uint256 numberOfMints) public payable virtual nonReentrant saleLive {
     ...
     */
    function multiMint(uint256 numberOfMints) public payable virtual nonReentrant saleLive {
     ...
     */
    function mintWithN() public payable virtual nonReentrant saleLive {
        require(isPreSaleActive, "SALE_NOT_ACTIVE");
     ...
     */
    function mint() public payable virtual nonReentrant saleLive {
        require(isPublicSaleActive, "SALE_NOT_ACTIVE");
        require(balanceOf(msg.sender) + 1 <= MAX_NUMBER_OF_MINTS, "REACHED_MINT_THRESHOLD");
