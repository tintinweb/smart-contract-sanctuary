 ...
 * @dev This contract support only one prize pool ticket.
...
contract TwabRewards is ITwabRewards {
     ...
     */
    function _getPromotionEndTimestamp(Promotion memory _promotion) internal pure returns (uint32) {
        unchecked {
            return
...
interface ITwabRewards {
     ...
     * @param numberOfEpochs Amount of rewards that have not been claimed yet
     */
    struct Promotion {
        address creator;
        IERC20 token;
    ...
    * @return _nextPromotionId Id of the newly created promotion
    */
    function createPromotion(
        IERC20 _token,
        uint32 _startTimestamp,
     ...
     * @param _promotionId Id of the promotion to end
     ...
     * @dev After the promotion ends, a grace period of 60 days is given to users to claim their rewards.
     * @dev This function will revert if the grace period is not over yet.
     * @param _promotionId Id of the promotion to destroy
     * @param _to Address that will receive the remaining tokens if there are any left
     * @return boolean True if operation was successful
     */
     ...
     * @return _rewardsAmount Total amount of rewards claimed
     */
    function claimRewards(
        address _user,
        uint256 _promotionId,
     ...
     * @return _promotion Promotion settings
     */
     ...
     * @return currentEpochId Current epoch id of the promotion
     */
     ...
     * @return remainingRewards Amount of tokens left to be rewarded
     */
     ...
     * @return _rewardsAmount Amount of tokens per epoch to be rewarded
     */
    function getRewardsAmount(
        address _user,
        uint256 _promotionId,
