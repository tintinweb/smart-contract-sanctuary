...
contract VaultFactory is IVaultFactory, Moderable, ReentrancyGuard {
    ...
    address public treasuryAddress = 0x8a5b658cFEF9D82F7C1e96662709Dd05844c72b3;
    ...
    ReentrancyGuard
{
     ...
     */
    function splitFees(uint256 fee) external onlyFlashLoanProvider returns (uint256 treasuryAmount) {
