...
// BIG SHOUTOUT TO THOSE THAT CAME BEFORE - BAYC, GAN, BANANAS, KITTIES, EVERY 10K PROJECT EVER
...
contract MOONDOGS is ERC721, Ownable {
    ...
    string public MOONDOGS_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN MOONDOGS ARE ALL SOLD OUT

    uint256 public constant MOONDOGSPrice = 25000000000000000; // 0.025 ETH
    ...
    // Reserve 50 MOONDOGS for team - Giveaways/Prizes etc
    uint public MOONDOGSReserve = 50;

    constructor() ERC721("MOONDOGS", "DOXIES") { }
    ...
    function reserveMOONDOGS(address _to, uint256 _reserveAmount) public onlyOwner {        
        ...
        require(_reserveAmount > 0 && _reserveAmount <= MOONDOGSReserve, "Not enough reserve left for team");
    ...
    function MintMOONDOGS(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxMOONDOGSPurchase, "Can only mint 20 tokens at a time");
