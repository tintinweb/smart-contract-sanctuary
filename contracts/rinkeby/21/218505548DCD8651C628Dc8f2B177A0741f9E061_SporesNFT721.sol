...
/**
   ...
   @dev This contract is used to handle Spore NFT Token using ERC-721 (https://eips.ethereum.org/EIPS/eip-721)
*/
    ...
    ERC721URIStorageUpgradeable
{
    ...
    /**
       ...
       @dev This function should be called only once - right after SporeNFT721 contract is deployed
    ...
    */
    function transferMinter(address _newMinter) external {
        ...
        require(_newMinter != address(0), "SporeNFT721: Set zero address");
