...
contract RyukaiTempest is RyukaiTempestERC721 {
    ...
    constructor(string memory name, string memory symbol, uint256 supply, uint256 genCount) RyukaiTempestERC721(name, symbol, supply, genCount) {}
...
contract RyukaiTempestERC721 is ERC721Enumerable, Ownable {
   ...
   function mint(uint256 numberOfMints) public payable {
    ...
    emit newRyukaiMint(msg.sender, newItemId);
    }
