...
contract NFTV2 is ERC721Enumerable, Ownable {
    ...
    // Constant variables
    uint256 public constant FOX_TOTAL_SUPPLY = 20;   // Total fox supply : 2000    
    uint256 public constant PRICE = 0.06 ether; //0.05 ETH
    uint256 public constant OG_PRICE = 0.05 ether; //0.06 ETH

    // Team addresses
    address private constant _oAddress  = 0x017CFC695c42297C315D631b9294F76c04608AC7;
    address private constant _mAddress  = 0x017CFC695c42297C315D631b9294F76c04608AC7;
    address private constant _hAddress  = 0x017CFC695c42297C315D631b9294F76c04608AC7;
    
    // Signer address
    address private _signerAddress = 0x017CFC695c42297C315D631b9294F76c04608AC7;
    ...
    function presalesMint(bytes32 hash, bytes memory signature, uint256 quantity, bool isOG) external payable onlyPresale 
    {
    ...
    function publicMint(uint256 quantity) external payable onlyPublicSale 
    {
        ...
        require(PRICE * quantity == msg.value, "INSUFFICIENT_ETH_AMOUNT");
