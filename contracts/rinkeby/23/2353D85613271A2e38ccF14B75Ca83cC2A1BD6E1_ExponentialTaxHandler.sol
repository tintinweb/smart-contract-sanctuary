...
contract ExponentialTaxHandler is ITaxHandler, ExchangePoolProcessor {
    ...
    mapping(uint256 => uint256) public basisPointsPerImpactTier;
...
//        IUniswapV2Pair pair = IUniswapV2Pair(primaryPool);
//
//        uint112 reserves0;
//        uint112 reserves1;
//        uint32 _timestampLast;
//
//        if (pair.token0() == WETH) {
//            (reserves0, reserves1, _timestampLast) = pair.getReserves();
//        } else {
//            (reserves1, reserves0, _timestampLast) = pair.getReserves();
//        }
//
//        uint256 price = uint256(reserves1) / uint256(reserves0);
//
//        uint256 constantProduct = uint256(reserves0) * uint256(reserves1);
//        uint256 newReserves1 = reserves1 + amount;
//        uint256 newReserves0 = constantProduct / newReserves1;
