...
contract FullOnchainTest is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getColor1(uint256 tokenId) public view returns (string memory) {
        return pick(tokenId, color1);
    }
    function getColor2(uint256 tokenId) public view returns (string memory) {
        return pick(tokenId, color2);
    }
    function getColor3(uint256 tokenId) public view returns (string memory) {
        return pick(tokenId, color3);
    }
    function getColor4(uint256 tokenId) public view returns (string memory) {
        return pick(tokenId, color4);
    }
    function getColor5(uint256 tokenId) public view returns (string memory) {
        return pick(tokenId, color5);
    }

    function pick(uint256 tokenId, string[] memory sourceArray) internal view returns (string memory) {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[1] = getColor1(tokenId);
        parts[2] = ';}.cls-4{fill:#';
        parts[3] = getColor2(tokenId);
        parts[4] = ';}.cls-1{fill:#';
        parts[5] = getColor3(tokenId);
        parts[6] = ';}.cls-5{fill:#';
        parts[7] = getColor4(tokenId);
        parts[8] = ';}.cls-3{fill:#';
        parts[9] = getColor5(tokenId);
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Otaku Coin #', toString(tokenId), '", "description": "Otaku Coin", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("FullOnchainTest", "FullOnchainTest") Ownable() {}
}
