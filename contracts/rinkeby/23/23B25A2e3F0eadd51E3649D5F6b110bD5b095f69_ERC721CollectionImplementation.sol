...
contract ERC721CollectionImplementation is ERC721CollectionBase, ERC721Upgradeable, AdminControlUpgradeable {
     ...
     * Initializer
     */
    function initialize(string memory _name, string memory _symbol, uint16 tokenMax_, uint256 tokenPrice_, uint16 transactionLimit_, uint16 purchaseLimit_, uint256 presaleTokenPrice_, uint16 presalePurchaseLimit_, address signingAddress) public initializer {
        __ERC721_init(_name, _symbol);
        __Ownable_init();
        _initialize(tokenMax_, tokenPrice_, transactionLimit_, purchaseLimit_, presaleTokenPrice_, presalePurchaseLimit_, signingAddress);
    }
...
abstract contract ERC721CollectionBase is CollectionBase, IERC721Collection {
    ...
    function _initialize(uint16 tokenMax_, uint256 tokenPrice_, uint16 transactionLimit_, uint16 purchaseLimit_, uint256 presaleTokenPrice_, uint16 presalePurchaseLimit_, address signingAddress) internal {
