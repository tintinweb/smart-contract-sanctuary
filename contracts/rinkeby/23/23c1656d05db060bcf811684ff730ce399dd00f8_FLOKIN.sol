...
contract FLOKIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 79000 * 10**9; //1T
    ...
    address payable public _devWallet = 0xc948A6CF771Ac27Be7b3681e0f8b4B4a168CE31F;
    address payable public _marketingWalletAddress = 0xEad236363Ff8e5284a902B9a131c7B4303F973ad;
    ...
    uint256 public _maxTxAmount = 2500000000 * 10**9; //B
    uint256 public _maxWalletAmount = 5000000000 * 10**9; //5B
    uint256 public numTokensSellToAddToLiquidity = 100000000 * 10**9; //5M
    ...
    function _setDevingWallet(address payable dAddress) external onlyOwner() {
        _devWallet = dAddress;
    }
