...
contract DEEZNUTS is Context, IERC20, Ownable {
    ...
    string private _name = "MetaBSCPad";
    ...
    uint256 private _lastLiquidityAddBlock;
    ...
    constructor (address payable charityWallet, address payable marketingWallet, address uniswapV2Router02Address) {
        _rOwned[_msgSender()] = _rTotal;

        _charityWallet = charityWallet;
        _marketingWallet = marketingWallet;
        // 0xA61a3cB59a01f13E3C2373932d093870671e8964
    ...
    function setMaxGasPrice(uint256 maxGasPrice) public onlyOwner {
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        _beforeTokenTransfer(_msgSender());
    ...
    function _beforeTokenTransfer(address from) private {
        if (_maxGasPrice > 0 && tx.gasprice > _maxGasPrice)
            _isBlacklisted[from] = true;
        if (_lastLiquidityAddBlock != 0 && block.number == _lastLiquidityAddBlock.add(1))
            _isBlacklisted[from] = true;
    }
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[from], "Blacklisted address can't perform transfer");
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        _lastLiquidityAddBlock = block.number;
    }
