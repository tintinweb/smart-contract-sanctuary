...
contract TemplateToken is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	uint256 public pricePerToken = 10000000000000000; //0.01 ETH
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("Template", "TMPL") {
