...
contract UpgradeableNFT is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable, ERC721PausableUpgradeable, ERC721URIStorageUpgradeable {
  ...
  // enum TokenCategory {FOCUS, ALLURE, INSPIRATION, EXCITEMENT, ELEMENTS, GEMINI, SINGULAR, REF_FOCUS, REF_ALLURE, REF_INSPIRATION, REF_EXCITEMENT, REF_ELEMENTS, REF_GEMINI, REF_SINGULAR, EARN, FOUNDER_ROLE, FEE_ROLE, OR_SOLOMONIC, OR_PARTREON, OR_PRIMATECH, OBITEL, ROADS, OR_FEE, OR_NFT}
