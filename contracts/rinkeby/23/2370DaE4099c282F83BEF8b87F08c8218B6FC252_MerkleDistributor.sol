...
contract MerkleDistributor is IMerkleDistributor {
    ...
    modifier isGovernanceOrSelf(address account) {
        if (msg.sender != _governance && msg.sender != account) revert NotGovernanceOrSelf();
        _;
    }
        ...
        clawbackAllowed
    {
        ...
        bool result = IERC20(_token).transfer(msg.sender, balance);
