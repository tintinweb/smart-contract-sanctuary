...
//            string image = abi.encodePacked(revealedCollectionBaseURL, Strings.toString(_tokenId),'.png');
//            if(_tokenId == 2) {
//                image = abi.encodePacked(revealedCollectionBaseURL, Strings.toString(_tokenId),'.gif');
//            }
            if(_tokenId == 2){
                content = abi.encodePacked(content,
                    ', ',
