...
contract Poopies is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Poopies", "POOP") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://openseatest.sfo3.digitaloceanspaces.com/";
    }
