...
contract BrainDanceNft is ERC721, Ownable, HeroFactory {
    ...
    function mintWhitelist(uint256 sign, uint256 count) public payable {
        ...
        uint256 end = mintedInitialTokenCount + realcount;
        if (end > INITIAL_TOKEN_COUNT) {
            realcount -= (end - INITIAL_TOKEN_COUNT);
    ...
    function mint(uint256 count) public payable {
        ...
        if (mintedInitialTokenCount + realcount > INITIAL_TOKEN_COUNT) {
            realcount -= (mintedInitialTokenCount + realcount - INITIAL_TOKEN_COUNT);
        }
