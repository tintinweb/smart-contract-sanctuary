...
contract TestContract is ERC721, Ownable, Treasury {
    ...
    address public investmentWallet =
        0x787cB639b04D844D3865CaF3c769bAee065243Ca;
    address public marketingWallet = 0x31023A496F5587DB7d3A4b7480D840D68952d547;
    ...
    uint256[] private shareList = [10, 20, 70];
    ...
    ) ERC721(_name, _symbol) Treasury(addressList, shareList) {
    ...
    /**
     * @dev Setter for the max mint amount
     */
    ...
    /**
     * @dev Setter for the max tokens per wallet presale
     */
    ...
    /**
     * @dev Setter for the max tokens per wallet
     */
