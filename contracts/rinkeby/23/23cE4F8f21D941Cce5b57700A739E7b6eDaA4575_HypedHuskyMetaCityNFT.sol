...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
    ...
    uint256 public _customisedTokenId = 9001;
    ...
    */
    ...
    function CustomizedSales(
        ...
        for (uint256 i = 0; i < _initialSupply; i++) {
            ...
            _incrementCustomisedTokenTypeId();
            creators[_id] = msg.sender;
            _mint(_initialOwner, _id, 1, _data);
            tokenSupply[_id] = 1;
  ...
  /**
    ...
    */
    ...
    /**
        * @dev calculates the next token ID based on value of _customisedTokenId
        * @return uint256 for the next token ID
        */
    function _getNextCustomisedTokenID() private view returns (uint256) {
        return _customisedTokenId.add(1);
    }
    ...
    /**
        * @dev increments the value of _customisedTokenId
        */
    function _incrementCustomisedTokenTypeId() private  {
        _customisedTokenId++;
    }
}
