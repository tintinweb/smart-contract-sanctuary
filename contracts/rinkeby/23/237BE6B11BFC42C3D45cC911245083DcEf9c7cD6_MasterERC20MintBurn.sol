...
import "../../token/ERC20/ERC20MintBurn.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20MintBurn is ContractOwnable, IMasterERC20 {
  ERC20MintBurn[] private childERC20MintBurn;
  ...
  function createERC20(
    ...
    ERC20MintBurn child = new ERC20MintBurn(
      tx.origin,
      name,
      symbol,
      decimal,
