...
contract TestCubes is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("TestCubes", "TCubes") {
...
//     // withdraw addresses
//     address t1 = 0xb0BCF49F6C630Ef0D2f5CBAe6540Fe50A7fcEBF4;

//     constructor(string memory baseURI) ERC721("Test Cubes", "Tcubes") {
//         setBaseURI(baseURI);

//         // team gets the first cube
//         _safeMint(t1, 0);
//     }
