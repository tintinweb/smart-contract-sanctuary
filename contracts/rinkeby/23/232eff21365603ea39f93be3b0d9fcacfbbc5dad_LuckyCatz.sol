...
contract LuckyCatz     is  ERC721Enumerable 
{
    ...
    constructor() ERC721("LKZ15","LKZ015 Token")       // temporary Symbol and title
    {
    ...
    function    getTokenToBeClaimedByRandom() private returns (uint256) 
    {
    ...
    function    getTokenToBeClaimed() private view returns (uint256) 
    {
