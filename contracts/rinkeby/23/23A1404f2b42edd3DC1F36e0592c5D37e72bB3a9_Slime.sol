...
pragma solidity 0.8.11;
  ...
  contract Slime is Ownable,ERC721Enumerable,PaymentSplitter {

    uint public constant MAX_WIVES = 10000;
    uint private DAW_PRICE = 0.0008 ether;
        ...
        PaymentSplitter(team, team_shares)
    {
        ...
        accounts[admins[0]] = Account( 100, 0, 0, false, false, true);
        accounts[admins[1]] = Account(  90, 0, 0, false, false, true);
        _reserved = 190;
