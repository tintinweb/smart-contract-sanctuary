...
/*
   __            _                                 _
  / / _   _  ___| | ___   _  /\/\   ___  _ __  ___| |_ ___ _ __ ___
 / / | | | |/ __| |/ / | | |/    \ / _ \| '_ \/ __| __/ _ \ '__/ __|
/ /__| |_| | (__|   <| |_| / /\/\ \ (_) | | | \__ \ ||  __/ |  \__ \
\____/\__,_|\___|_|\_\\__, \/    \/\___/|_| |_|___/\__\___|_|  |___/
                      |___/
 */
...
contract TestNFTRewards is ERC721, Ownable {
    ...
    // Rewards
    uint256 constant public RATE = 24 * (10 ** 18);
    uint256 constant public INITIAL_ISSUANCE = 100 * (10 ** 18);
    mapping(address => uint256) public rewards;
    mapping(address => uint256) public lastUpdate;
    TOKEN20 public REWARD_TOKEN;
    event ERC20RewardPaid(address indexed user, uint256 reward);
    // Team
    address private artistAddress = 0xE333CE2b02FDD78Ab3a56F793DF9BcFA8E59f05e;
    ...
    * =====================================
    */
    function setRewardToken(address _newRewardAddress) public onlyOwner {
        require(_newRewardAddress != address(0), "Invalid address.");
        REWARD_TOKEN = TOKEN20(_newRewardAddress);
    }
    ...
    */
    function withdraw() external{
        require(msg.sender == owner() || msg.sender == address(devAddress) || msg.sender == address(artistAddress), "Not team!");
        uint256 balance = address(this).balance;
        require(balance > 0, 'Insufficient balance');
        uint256 artistBalance = balance.mul(30).div(100);
