...
contract GameCards is AccessControlEnumerableUpgradeable, IGameCards {
    ...
    {
        require(hasRole(MINTER_ROLE, _msgSender()), strConcat ("GameCards: must have minter role to mint for: ", toAsciiString(_msgSender())));
        ...
        require(cards[cardId].playerId == 0, "GameCards: Card already exists");
    ...
    function getSender () external override view returns (address)
    {
        return _msgSender();
    }
