    ...
    NativeMetaTransaction
{
    ...
    uint256 public mintPrice = 0.0666 * 10**9; 
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        AmayaProxyRegistry proxyRegistry = AmayaProxyRegistry(proxyRegistryAddress);
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmYtroCu9HaZb1vofQFnmokSN4fbFBueJPdtjvdw5X1SLi";
    }
}