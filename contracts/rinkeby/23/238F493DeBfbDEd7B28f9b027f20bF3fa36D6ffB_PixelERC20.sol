...
contract PixelERC20 is ERC20, Ownable {
    ...
    uint256 public amountLeftForReserve = 10000 ether;
    ...
    function airdropWinners(address to, uint256 amount) external onlyOwner {
        require(amount * 1000000000000000000 <= amountLeftForReserve, "No more reserved");
        _mint(to, amount * 1000000000000000000);
        amountLeftForReserve = amountLeftForReserve - amount * 1000000000000000000;
        amountTakenFromReserve = amountTakenFromReserve + amount * 1000000000000000000;
    }
    ...
    function airdrop(address[] calldata to, uint256 amount) external onlyOwner {
        ...
        amountLeftForReserve = amountLeftForReserve - totalamount;
        amountTakenFromReserve = amountTakenFromReserve + totalamount;
    }
