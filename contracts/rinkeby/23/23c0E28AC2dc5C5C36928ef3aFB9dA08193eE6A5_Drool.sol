...
contract Drool is Context, ERC721Enumerable, Ownable {
    ...
    function mintNouns(bytes memory seed) public onlyOwner {
        uint256 mintIndex = totalSupply() + 1;
        seeds[mintIndex] = seed;
    ...
    function dataURI(uint256 tokenId) public view returns (string memory) {
        ...
        string memory name = string(abi.encodePacked('Drool ', droolId));
        string memory description = string(abi.encodePacked('Drool ', droolId, ' is a character XXX'));
...
library NFTDescriptor {
     ...
     */
    function constructTokenURI(TokenURIParams memory params, mapping(uint256 => string[]) storage palettes)
        public
        view
     ...
     */
    function generateSVGImage(MultiPartRLEToSVG.SVGParams memory params, mapping(uint256 => string[]) storage palettes)
        public
        view
...
library MultiPartRLEToSVG {
     ...
     */
    function generateSVG(SVGParams memory params, mapping(uint256 => string[]) storage palettes)
        internal
        view
        returns (string memory svg)
    {
     ...
     */
    // prettier-ignore
    function _generateSVGRects(SVGParams memory params, mapping(uint256 => string[]) storage palettes)
        private
        view
        returns (string memory svg)
    {
