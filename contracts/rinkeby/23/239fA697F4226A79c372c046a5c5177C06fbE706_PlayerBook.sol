...
//==============================================================================    
        ...
        public
    {
       devAddress = msg.sender;
        ...
        plyr_[1].addr = 0x102921eF10283cF79D2aA2B4E2df7e590eBf63F7;
        plyr_[1].name = ".Andy";
        plyr_[1].names = 1;
        pIDxAddr_[0x102921eF10283cF79D2aA2B4E2df7e590eBf63F7] = 1;
        pIDxName_[".Andy"] = 1;
        plyrNames_[1][".Andy"] = true;
        plyrNameList_[1][1] = ".Andy";
...
//==============================================================================    
    ...
    modifier onlyDevs() 
    {
        require(msg.sender == devAddress, "msg sender is not a dev");
        _;
    }
