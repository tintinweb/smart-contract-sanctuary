...
contract LuigiInu is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    using TransferHelper for address;

    string private _name = "Luigi Inu";
    string private _symbol = "Luigi-Inu";
    ...
    function swap() private lockTheSwap {
        uint256 totalFee = _charityFeeCollected.add(_marketingFeeCollected);
        ...
        uint256 amountCharity = address(this).balance;
        if (amountCharity > 0)
