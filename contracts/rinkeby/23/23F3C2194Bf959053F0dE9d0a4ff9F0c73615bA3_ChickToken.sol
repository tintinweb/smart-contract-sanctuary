...
contract ChickToken is ERC20("CHICK", "CHICK") {
    ...
    mapping(address => uint256) public swapCchickCountPerUser;
    ...
    function chickSwapCchick(uint256 floatAmount) public{
        require(floatAmount != 0, 'burnAmount cannot be zero');
        swapCchickCountPerUser[msg.sender] = floatAmount.add(swapCchickCountPerUser[msg.sender]);
       _burn(msg.sender, floatAmount.mul(1e18));
