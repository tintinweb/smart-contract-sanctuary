...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "GWspp";
    string internal constant SYMBOL = "GPP";
     ...
     */
    address internal tipToTheDev = 0xC28244D7132Fb89aBC260d60C48f084D2c64C00D;
    ...
    function _addFees() private {
         ...
         */ 
        _addFee(FeeType.Rfi, 20, address(this) ); // 4% Redistribute to holders
        _addFee(FeeType.Burn, 10, burnAddress ); // 1% Burn
        _addFee(FeeType.Liquidity, 20, address(this) ); // 4% added to liquidity
        _addFee(FeeType.ExternalToETH, 80, tipToTheDev ); // 0.1% Tips to the Dev
