...
/* STAKING MECHANICS */
    ...
    //deposit function. 
    function deposit(uint256[] calldata tokenIds) external whenNotPaused requireCropToken {
    ...
    //withdrawal function.
    function withdraw(uint256[] calldata tokenIds) external whenNotPaused requireCropToken nonReentrant() {
        claimRewards(tokenIds);
