...
contract VectorField is ERC721URIStorage, VRFConsumerBase, Ownable {
    ...
    ERC721("Vector Field", "VCFD")
    {
        ...
        height = 2000;
        width = 1500;
        colors = ["#e7d2cc", "#cce1e7" "#cab8b3", "#ad9e99", "#908380", "#736966", "#574f4d", "#3a3533", "#1d1a1a", "#b9b7bd", "#a2a0a5", "#8b898e", "#747276", "#5c5b5f", "#454547", "#2e2e2f", "#171718", "#868b8e", "#eeede7", "#647c90", "#586d7e", "#4b5d6c", "#3f4e5a", "#970c10", "#0c9793", "#840b0e", "#71090c", "#5e080a", "#FF5F1F"];
    }
 ...
 function withdraw() public payable onlyOwner {
    ...
    function generateSVG(uint256 _randomness) public view returns (string memory finalSvg) {
        ...
        uint256 bgopacity = uint256(keccak256(abi.encode(_randomness + 1))) % 30;
