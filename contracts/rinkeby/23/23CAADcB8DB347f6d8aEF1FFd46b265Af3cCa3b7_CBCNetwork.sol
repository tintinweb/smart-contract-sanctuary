...
contract CBCNetwork is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    mapping(address => bool) private _lock;
    string private _name;

    function initialize() initializer public {
        __ERC20_init("CBC Network", "CBC");
