...
contract MetaBunniesNFT is ERC721Enumerable, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (onlyWhitelisted == true){
            require(whitelistedAddresses[msg.sender], "Your address is not whitelisted for this sale.");
  ...
  function whitelistUsersMem(address[] memory _users) public onlyOwner {
      for(uint256 i = 0; i < _users.length; i++) {
        whitelistedAddresses[_users[i]] = true;
      }
  }
