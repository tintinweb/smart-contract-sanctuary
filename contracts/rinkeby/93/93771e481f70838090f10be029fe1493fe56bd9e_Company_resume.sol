...
/////////////////////////////////////輸入協力廠-零件完成品基本及檢驗資料/////////////////////////////////////////
    ...
    function push5_part_data(string memory partname,string memory partID,string memory partday,string memory approved_name,string memory checked_name,string memory drawn_name,string memory gps,uint256 part_num)public
    {   
        ID=count;
