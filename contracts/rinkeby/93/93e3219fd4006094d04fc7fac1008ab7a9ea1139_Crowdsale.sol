...
contract Crowdsale {
 ...
 // 这下面是我从openzepplin抄的
  ...
  constructor () public {
    ...
    addressOfTokenUsedAsReward =  0x0C7Ea7900C9ef2Da8a05101eb4220F25263cB02E;
  ...
  function setTokenToSell(address _tokenAddress) public {
    require (msg.sender == wallet);
