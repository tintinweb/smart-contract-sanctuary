...
contract VosNFT is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable, Pausable, PaymentSplitter, ReentrancyGuard {
    ...
    // Token URIs base
    string public baseURI = "ipfs://QmZDTc8mFVNVpB3KVKeRYJKyh4f4E8a6yaHN4wfzgkUGyZ/";
    ...
    address[] private _team = [0x33F2f88f1B4222EBaE3751eE300a3de2aD6Fb980, 0xcf686969ABaC2d90f88403c104C5FBC21e6677DA];
        ...
        ERC721("VosNFT", "VOS")
    {
        ...
        setTokenPrice(40000000000000000);
