...
contract Alpacadabraz is ERC721, Ownable {
    ...
    mapping(address => uint) whitelistRemaining; // Maps user address to their remaining mints if they have minted some but not all of their allocation
    mapping(address => bool) whitelistUsed; // Maps user address to bool, true if user has minted
