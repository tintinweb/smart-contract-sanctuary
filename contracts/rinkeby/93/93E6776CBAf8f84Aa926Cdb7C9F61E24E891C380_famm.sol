...
contract famm is ERC721, Ownable, ReentrancyGuard {
    string private _collectionURI;
    string public baseURI;

    uint256 public constant MAX_FRIENDS_SUPPLY = 4;
    uint256 public constant MAX_WHITELIST_SUPPLY = 10;
    uint256 public constant MAX_SUPPLY = 30;

    uint256 public cost = 0.01 ether;
    uint256 public mintsPerTx = 6;
