...
contract OwnixMarket is ERC1155Holder, Ownable, Pausable, IOwnixMarket {
   ...
   * @param _indexOffset The index offset
   */
  function listNFT(uint256 _tokenId, uint256 _amount, uint256 _reservePrice, uint256 _duration, uint256 _indexOffset) external whenNotPaused() {
