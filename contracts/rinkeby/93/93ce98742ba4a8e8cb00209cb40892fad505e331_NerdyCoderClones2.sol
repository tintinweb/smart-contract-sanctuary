...
contract NerdyCoderClones2 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxBlootSupply = 5;
  bool public paused = false;
  mapping(address => bool) public whitelisted;
  
  //Allow Bloot holders to mint for free
  
  address public blootAddress = 0xb593AE27bD7cf2c9b05cEF62Da410518774ed49e;
  ...
  function blootFreeClaim(uint256 _mintAmount) public {
    ...
    require(blootOwnersSupply + _mintAmount <= maxBlootSupply, "No more bloot owner claims");
    require(supply + _mintAmount <= maxSupply);
    require(blootContract.balanceOf(msg.sender) > 0, "Must own a bloot to claim from this method");
    blootOwnersSupply = blootOwnersSupply + _mintAmount;
