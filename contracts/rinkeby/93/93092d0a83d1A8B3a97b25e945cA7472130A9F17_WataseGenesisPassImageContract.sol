  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        function mintTo(address _to) public payable {
            ...
            require(msg.value == PRICE, "Value needs to be exactly 0.07 ETH!");
            uint256 newTokenId = _getNextTokenId();
            _mint(_to, newTokenId);
            _incrementTokenId();
        }
    ...
    // File: contracts/wataseGenesisPassImageContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract WataseGenesisPassImageContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Watase Genesis Pass Image", "WGPI", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmVUbY8iBUTkkJhsjjNzZw8WmX1zRQywUZUZVyyceJQKdH/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/QmXixP8zgCgCE7pNiSzM/contract-metadata";
        }
    }