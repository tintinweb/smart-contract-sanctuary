...
contract GreedIsRealGood {
    AggregatorV3Interface internal priceFeed;
    IERC20 public token;
    event Bought(uint256 amount);

    constructor() public {
        token = new GreedIsGood();
    ...
    string[] students = getInterface(student_contract).getStudentsList();
    uint256 public lengt = students.length;
    ...
    function buy() public payable {
        ...
        amountTobuy = (msg.value * uint256(getLatestPrice() / (10**8))) / lengt;
...
contract GreedIsGood is IERC20 {
    string public name = "GreedIsGood";
