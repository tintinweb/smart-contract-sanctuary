...
contract PX is ERC721, ERC721Metadata {
    ...
    function _transfer(address from, address to, uint256 tokenId) internal {
        address ownerOfTokenIdSndr = ownerOf(tokenId);
        require(_exists(tokenId), "ERC721: transfer attempt for nonexistent token");
        require(ownerOfTokenIdSndr == from, "ERC721: transfer of token that is not own");
        ...
        uint256 tokenIdDead = _merge(tokenIdRcvr, tokenIdSndr, ownerOf(tokenIdRcvr) , ownerOfTokenIdSndr);
