...
contract MathematicsNFT is ERC721Burnable, AccessControlEnumerable, Pausable {
    ...
    uint16 public RESERVED_SUPPLY = 200;
    ...
    uint16 _totalSupply = RESERVED_SUPPLY;
    uint16 _lastId = _totalSupply;
    uint16 _lastReservedId = 0;

    string _baseURIValue;

    constructor(string memory baseURI_) ERC721("Reserve testing", "MATHPORK") {
        ...
        whenNotPaused
    {
        ...
        uint256 lastId = _lastReservedId;
        uint256 maxId = lastId + numberOfTokens;

        require(
            maxId <= RESERVED_SUPPLY, "MAX_SUPPLY_EXCEEDED"
        );
        ...
        _lastReservedId += numberOfTokens;
    }
