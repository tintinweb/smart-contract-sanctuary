...
contract SVGNFT is ERC721URIStorage {
    ...
    uint tokenId;
    constructor() ERC721("My SVGNFT", "SVGNFT"){}
    ...
    function formatTokenURI(string memory _imguri) public pure returns(string memory){
        ...
        string memory tokenURI = string(abi.encodePacked(
            ...
            '"attributes":"Gotten from w3school svg",',
            '"image":"',_imguri,'"}'
            )))));
