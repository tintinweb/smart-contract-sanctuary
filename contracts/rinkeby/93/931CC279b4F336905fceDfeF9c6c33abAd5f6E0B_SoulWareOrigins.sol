...
contract WithdrawFairlyOrigin is Ownable {
    ...
    constructor(){
        parts.push(Part(0x0000000000000000000000000000000000000001, 350, 375)); // jimmy 35 37.5
        parts.push(Part(0x0000000000000000000000000000000000000002, 90, 110)); // Charles 9 11
        parts.push(Part(0x0000000000000000000000000000000000000003, 140, 60)); // Yvick 14 6
        parts.push(Part(0x0000000000000000000000000000000000000004, 35, 15)); // Alexandra 3.5 1.5
        parts.push(Part(0x0000000000000000000000000000000000000005, 100, 150)); // Alexandre 10 15
        parts.push(Part(0x0000000000000000000000000000000000000006, 65, 110)); // Hippolyte 6.5 11
        parts.push(Part(0x0000000000000000000000000000000000000007, 10, 15)); // Léo 1 1.5
        parts.push(Part(0x0000000000000000000000000000000000000008, 10, 15)); // Yannick 1 1.5
        parts.push(Part(0xcBCc84766F2950CF867f42D766c43fB2D2Ba3256, 200, 150)); // miinded 20 15
    }
