...
contract ZombiePenguins is ERC721Enumerable, IERC721Receiver, Ownable{
    ...
    IERC721 CONTROL = IERC721(address(this));
    IERC20 TOKEN = IERC20(0xb83e5b86657eb50C83C6d2a2f45EDd6A351E1882);
    ...
    uint public MAX_TOKEN_SUPPLY = 8888;

    uint256 public RATE = 5;
    uint256 public EXPIRATION;

    address private waddress;

    constructor() ERC721("ZomPeng", "Pengu") {
        baseTokenURI = "https://ipfs.billionaireclubnft.com/ipfs/QmaL5xahrX8dcmGkGNYgbsfFUr3SSeGbXziPkAVMkm2hFs/";
    ...
    function seeWithdrawAddress() external view onlyOwner() returns(address){
        return waddress;
    }
