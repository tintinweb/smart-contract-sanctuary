...
/**
 * @title SkatePunks Club contract
...
contract SkatePunksClub is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public constant punkPrice = 0; // 75000000000000000 = 0.075 ETH
    uint256 public constant maxPunkPurchase = 1000; // 20
    ...
    function mintPunk(uint256 numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint SkatePunk");
