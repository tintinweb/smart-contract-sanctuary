...
contract CommunityArtNFT is ERC721Enumerable, Ownable {
    ...
    /// Maps a tokenId to its seed.
    mapping (uint256 => uint256) public tokenid2seed;
     ...
     */
    function mint(address recipient, uint256 tokenId, uint256 seed) external {
    ...
    function getSeedByTokenId(uint256 tokenId) public view virtual returns (uint256) {
        return tokenid2seed[tokenId];
    }
