...
import "./DateTime.sol";
contract Cryptogotchi_v2 is ERC721Enumerable, VRFConsumerBase, Ownable {
    ...
    */
    ...
    function getTokensReadyToBatch(uint256 batchType, address wallet) internal view returns(uint256[] memory, bool hasBatch) {
        uint256[] memory ownersTokens = getOwnersTokenIds(wallet);
    ...
    function returnReadyTokens(uint256 batchType, address wallet) public view returns(uint256[] memory, bool hasBatch) {
        return getTokensReadyToBatch(batchType, wallet);
    }
