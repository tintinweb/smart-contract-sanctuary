...
contract SimpleToken is  ERC20PresetMinterPauser, ERC20Capped, Ownable{
    using SafeMath for uint256;
    address private publicAddress = 0x5fC71C43f64FE205218A77f48B085B3c8b8f2B11;
    uint256 private cappedSupply = 1200000000000000000000000;
    constructor() ERC20PresetMinterPauser('Owner Token', 'ATV')  ERC20Capped(cappedSupply) public{
        _mint(publicAddress, 100000000000000000000);
