...
contract Deployer is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Deployer" ;
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xA3d6000560a275881e241F9f2fb7C82ba0020D1b);
	    teamFeeReceiver = address(0xA3d6000560a275881e241F9f2fb7C82ba0020D1b);
