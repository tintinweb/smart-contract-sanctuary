...
// ----------------------------------------------------------------------------
// yBXTB Service Contract V3 (mockup)
//
// Used for testing migrate() function
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
contract YieldTokenService is ApproveAndCallFallBack, SettlementInterface, Migrate_YieldTokenService, Owned {
...
//    }
    ...
    function migrate(
        uint _BXTBAmount, uint _USDTAmount, uint _CHIPBackstop,
        uint _CHIPCommissionsAvailable, uint _CHIPCommissionsTotal, uint _CHIPOutstanding,
        uint _CHIPTotal, uint _yieldTokenOutstanding, uint _yieldTokenTotal) external override {
        require(msg.sender == 0xCCCd3A7184e44dAd24b70A3A6521e01005EB5d3c, "Caller not allowed");  // Only accept call from the current Service Contract
