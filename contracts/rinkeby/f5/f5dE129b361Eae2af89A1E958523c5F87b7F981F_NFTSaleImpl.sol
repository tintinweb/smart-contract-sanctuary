...
// NFTSaleImpl SMART CONTRACT
contract NFTSaleImpl is Initializable, OwnableUpgradeable {
     ...
     */
    address public constant eth_usd_feed = 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;
     ...
     */
    address public constant eur_usd_feed = 0x78F9e60608bF48a1155b4B2A5e31F32318a1d85F;
    ...
    function buyReleaseArtwork(uint256 nftId) public payable {
        ...
        payOwnerFee(payable(OwnableUpgradeable.owner()), msg.value - clientsShare);
     ...
     *
     * @param recipient - owner of NFTSaleImpl
    ...
    /**
     * Release Artwork
     * Contract instance NFTSaleImpl must pass _isApprovedOrOwner of nftAddress for nftId
