...
contract Poop is ERC20, EIP712 {
    ...
    function claim(uint256 amountV, bytes32 r, bytes32 s) external {
        ...
        require(total <= AMOUNT_AIRDROP, "GasDAO: Exceed max supply");
