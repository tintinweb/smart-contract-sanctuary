...
contract SettlersOfCryptan is ERC721Enumerable, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<circle style="fill:#E6E6E6;" cx="250" cy="250" r="50"/><g style="fill:';
        parts[
            2
        ] = ';font-family:serif;font-size:60px;"><text x="250" y="262" text-anchor="middle">';
        ...
        if (num == 6 || num == 8) {
            ...
            parts[
                5
            ] = '<circle cx="226" cy="275" r="4"/><circle cx="238" cy="275" r="4"/><circle cx="250" cy="275" r="4"/><circle cx="262" cy="275" r="4"/><circle cx="274" cy="275" r="4"/></g>';
        } else if (num == 5 || num == 9) {
            parts[1] = "#000";
            parts[
                5
            ] = '<circle cx="232" cy="275" r="4"/><circle cx="244" cy="275" r="4"/><circle cx="256" cy="275" r="4"/><circle cx="268" cy="275" r="4"/></g>';
        } else if (num == 4 || num == 10) {
            parts[1] = "#000";
            parts[
                5
            ] = '<circle cx="238" cy="275" r="4"/><circle cx="250" cy="275" r="4"/><circle cx="262" cy="275" r="4"/></g>';
        } else if (num == 3 || num == 11) {
            parts[1] = "#000";
            parts[
                5
            ] = '<circle cx="244" cy="275" r="4"/><circle cx="256" cy="275" r="4"/></g>';
        } else {
            parts[1] = "#000";
    ...
    // Land #1 to #9000 are claimable by anyone. Land #9001 to #10000 will be distributed by the contract deployer through different giveaways, adventures and other means.
    ...
    constructor() ERC721("Settlers of Cryptan", "SOCL") Ownable() {}
}
