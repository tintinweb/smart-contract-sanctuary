...
contract TestPunks is ERC721Enumerable, Ownable {
    ...
    uint256 public reserveTokens = 50;
    ...
    function mintFuturePunks(uint256 numberOfTokens) public payable {
        ...
        require(salePhase != 0, "no phase is active");
        require(numberOfTokens > 0 && numberOfTokens <= maxPurchase, "Not within the range of maxPurchase");
        require((totalSupply() + numberOfTokens) <= MAX_NFT_SUPPLY - reserveTokens, "Purchase would exceed max supply of FuturePunks");
    ...
    function getReserves(uint256 amount) public onlyOwner {
        require(reserveTokens > 0, "All the reserve tokens have been minted already!");
        require(reserveTokens - amount >= 0, "Amount would exceed the number of reserve tokens");
