  ...
  AccessControl
{
  ...
  function mintNft(uint256 numberOfTokens) public payable whenNotPaused {
    ...
    if (msg.value < PRICE_PER_NFT * numberOfTokens) {
      revert NotEnoughEther({
        requiredEtherAmount: PRICE_PER_NFT * numberOfTokens
      });
    }
  ...
  function devMint(address to) public onlyRole(MINTER_ROLE) {
