...
contract CryptoFluffs is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("FLUFFS", "FLUFF") {
        setBaseURI(baseURI);
    }
    ...
    function preSaleMint(uint256 mintCount) public payable {
        ...
        require(balanceOf(msg.sender) + mintCount <= 20,    "presale_wallet_limit_met");
    ...
    function setGeneration(uint256 series) external onlyOwner {
        _series = series;
    }
