...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable, MinterRole, WhitelistAdminRole {
   ...
   * @param _to the owner address of new token
    ...
    uint256 _id,
		...
		require(!_exists(_id), "EXISTED NFT ID");
		...
		if (_initialSupply != 0) _mint(_to, _id, _initialSupply, _data);
