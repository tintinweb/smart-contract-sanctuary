...
contract Token is ERC777, ERC2771Context, Ownable, Pausable {
    ...
    constructor(address owner, string memory name, string memory symbol, uint256 initialSupply, address forwarder_, IPolicy policy_) 
    ...
    function _beforeTokenTransfer(address operator, address from, address to, uint256 amount) internal view override {
        require(_policy.isTransferable(address(this), operator, from, to, amount), "No transferable");
    }

    function isOperatorFor(address operator, address tokenHolder) public view virtual override returns (bool) {
        return _policy.isOperatorFor(address(this), operator, tokenHolder) || ERC777.isOperatorFor(operator, tokenHolder);
    }
