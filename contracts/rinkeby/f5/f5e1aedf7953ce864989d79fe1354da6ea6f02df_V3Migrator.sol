...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x071ab11ae433fe68e2c5e07de78ec45d1e7d012ada4d70b2f84e7043573534dc;
...
/// @title V3 Migrator
/// @notice Enables migration of liqudity from Veniceswap v2-compatible pairs into Veniceswap v3 pools
interface IV3Migrator is IMulticall, ISelfPermit, IPoolInitializer {
    struct MigrateParams {
        address pair; // the Veniceswap v2-compatible pair
...
contract V3Migrator is IV3Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IVeniceswapV2Pair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IVeniceswapV2Pair(params.pair).burn(address(this));
