...
import "../../token/ERC1155/ERC1155Burn.sol";
import "./interfaces/IMasterERC1155.sol";
import "../../access/ContractOwner.sol";

contract MasterERC1155Burn is ContractOwnable, IMasterERC1155 {
  ERC1155Burn[] private childERC1155Burn;
  ...
  function createERC1155(
    ...
    ERC1155Burn child = new ERC1155Burn(
      name,
      symbol,
      tx.origin,
      amount,
