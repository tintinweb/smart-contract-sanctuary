...
contract UniswapV2Router02 is IUniswapV2Router02, Ownable {
    ...
    IMistTradeRewards private TradeRewards;

    function setTradeRewardsContract(address _address) public onlyOwner {
        TradeRewards = IMistTradeRewards(_address);
    }
    ...
    function _swap(uint[] memory amounts, address[] memory path, address _to, address _referrer) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            address lp = UniswapV2Library.pairFor(factory, input, output);
            uint256 _amount = amounts[i] * amountOut; 
            TradeRewards.updateRewards(_referrer, _to, lp, _amount);
    ...
    function swapExactTokensForTokens(
        ...
        _swap(amounts, path, to, address(0));
    }
    function swapExactTokensForTokens(
        uint amountIn,
        uint amountOutMin,
        ...
        returns (uint[] memory amounts)
    {
        ...
        _swap(amounts, path, address(this), address(0));
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
                ...
                hex'35f7a54c6a456c4a293f097f48ed523e1ae2cc46c294e42b9607ad7913f800ee'
...
interface IMistTradeRewards {

    function updateRewards(address _referrer, address _to, address _lp, uint256 _amount) external;
