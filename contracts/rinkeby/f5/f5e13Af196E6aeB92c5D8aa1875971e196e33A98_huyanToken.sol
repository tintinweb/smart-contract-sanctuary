...
contract huyanToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "huyan";
    string  public constant symbol = "huyan";
    ...
    uint256 public tokenExchangeRate = 625;             // 625 huyan 兑换 1 ETH
