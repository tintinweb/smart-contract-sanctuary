...
contract MultiSenderV7 is ServiceCharges { 
    ...
    modifier getServiceFee(string memory _paymentMethod, uint noOfRecipients, uint noOfIds, uint noOfAmounts) {
        ...
        else if( keccak256(abi.encodePacked(_paymentMethod)) == keccak256(abi.encodePacked("usdc")) ) IERC20(usdtAddress).transferFrom(msg.sender, feeRecipient, (usdcFee * multiplier));
