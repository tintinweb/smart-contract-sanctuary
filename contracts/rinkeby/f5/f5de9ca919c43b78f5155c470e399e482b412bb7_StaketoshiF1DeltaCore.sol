...
// File contracts/StaketoshiF1DeltaCore.sol
...
contract StaketoshiF1DeltaCore is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address _token, address _revv, address _nft, address _fee, address _kycContract, uint256 _percent) public initializer {
        __Ownable_init();
    ...
    /**
        ...
        _amount: uint256
     */
    function borrow(uint256 _amount) external  onlyPlayer beforeStarted  {
        require(_amount > 0, 'invalid amount');
    ...
    function endTournament() external onlyOwner afterLockEnded {
        ...
        for(uint i = 0; i < playerIndices.length; i++) {
            player storage p = players[playerIndices[i]];
    ...
    function getCurrentTour() private view returns(Tour storage) {
