...
// File contracts/HH_Main_Contract.sol


pragma solidity ^0.8.0;


contract HellHounds is ERC721Enumerable, Ownable {  
    using Address for address;
    ...
    uint256 public constant PUBLIC_SUPPLY = MAX_SUPPLY-MAX_GIFT_SUPPLY-PRESALE_SUPPLY;
    uint256 private GIFT_SUPPLY = 100;
    ...
    constructor (string memory newBaseURI) ERC721 ("Hell Hounds", "HH") {
    ...
    function gift(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= GIFT_SUPPLY, "Can't Mint More Than Max Gift Supply" );
