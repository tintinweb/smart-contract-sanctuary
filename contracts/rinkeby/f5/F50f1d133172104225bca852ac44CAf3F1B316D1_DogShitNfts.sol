...
contract DogShitNfts is ERC721URIStorage, ERC721Pausable, Ownable {
    ...
    constructor() ERC721("DOGSHIT", "DOGSHIT") {
        ...
        _baseURIPrefix = "ipfs://QmbGCimQVxo7kWsFXGQAeU2zoqcpsPfC5EGCsBrVzdWXNT/";
    }
    ...
    function d0gsh1t(address wallet, uint numberOfMints) whenNotPaused public payable returns (uint256) {
