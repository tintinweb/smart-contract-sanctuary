...
4% buy/sell reward automatic for holder
4% liquidy
5% for marketing/dev
If sell 2% extra to marketing/dev

1% of total supply transaction limit

TOTAAL SUPPLY: 2.000.000.000.000.000

0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D // UNISWAP Mainnet 
0x9bcBE4Af33C43E12c82d2fcD77DF6AF7F82174A2 //lq test
0xF572a157622C260186b6de19F999a328E035910D
*/
contract ETHEREUMINUKU is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "ETHEREUM INUKU";
    string private constant _symbol = "$ETHINK";
    ...
    uint256 public _maxTxAmount = 20000000000000; // 1% of max supply 
    uint256 public numTokensSellToAddToLiquidity = 100000000000;
