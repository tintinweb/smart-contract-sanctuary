...
contract MultiGame is Ownable, ReentrancyGuard {
    ...
    constructor(address _orgAddress, address _enjinStaking){
    ...
    function pseudoConstructor(
        ...
        enjinStaking.initiateGame(_msgSender(), _lockIn, _entryAmt, _entryAmt * _numPlayers, _gameId);
    }
...
contract EnjinStaking is Ownable, ReentrancyGuard {
  ...
  function checkWhiteList(address _creator) public view returns (bool){
    return whiteListedCreators[_creator];
  }
