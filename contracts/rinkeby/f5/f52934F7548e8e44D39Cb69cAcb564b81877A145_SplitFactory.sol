...
contract SplitProxy is SplitStorage, IERC721Receiver {
    ...
    constructor() {
        ...
        _setTarget(_zoraMedia);

        address(_zoraMedia).call(abi.encodeWithSignature("setApprovalForAll(address,bool)", owner(), true));
        address(_zoraMedia).call(abi.encodeWithSignature("setApprovalForAll(address,bool)", _zoraAuctionHouse, true));
    }
    ...
    function transferOwnership(address newOwner) public {
        ...
        address(_zoraMedia).call(abi.encodeWithSignature("setApprovalForAll(address,bool)", owner(), false));
        address(_zoraMedia).call(abi.encodeWithSignature("setApprovalForAll(address,bool)", newOwner, true));
