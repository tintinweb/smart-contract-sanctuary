...
contract MyFirstNFT is ERC721Enumerable, OpenSea, Ownable, PaymentSplitter {
    ...
    ) ERC721("MyFirstNFT", "MyFirstNFT") PaymentSplitter(_payees, _shares) {
    ...
    function mint(uint256 count) public payable {
        ...
        if (supply < 66 && supply + count > 66) {
            uint256 payCount = supply + count - 66;
