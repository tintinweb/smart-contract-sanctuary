...
contract SNAFU20Pair is ERC20, ERC1155Receiver {
    ...
    {
        return (IERC1155MetadataURI(nftAddress).uri(tokenId), tokenIdsToEditions[tokenId], getTokenValue(tokenId));
    }
    ...
    function _withdraw1155(
        ...
        IERC1155(nftAddress).safeTransferFrom(_from, _to, _tokenId, value, "0x0");
    }
    ...
    function swap1155(
        ...
        require(tokenIdsToEditions[in_id] != 0 && tokenIdsToEditions[out_id] != 0, "Editions must be set!");
        require(in_amount == out_amount, "Need to swap same amount of NFTs");
        require(getTokenValue(in_id) == getTokenValue(out_id), "Token to swap must have the same value");
