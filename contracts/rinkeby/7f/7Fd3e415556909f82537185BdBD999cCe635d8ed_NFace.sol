...
contract NFace is NPassCore {
    ...
    constructor(address _nContractAddress) NPassCore("NFace", "NFace", IN(_nContractAddress), false, 8888, 0, 0, 0) {}
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "nFace #',
                        toString(tokenId),
                        '", "description": "Just a simple face.", "image": "data:image/svg+xml;base64,',
