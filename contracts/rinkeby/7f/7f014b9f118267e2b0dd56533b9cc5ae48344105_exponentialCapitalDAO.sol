...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a ABCD shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract exponentialCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "exponential Capital DAO";
    string private constant _symbol = "ecd";
    ...
    address payable public marketingWallet = payable(0x9F46Ca6C4BB314065eF22E07881055280B739A04);
    address payable public treasury = payable(0x9F46Ca6C4BB314065eF22E07881055280B739A04);
    ...
    constructor (    ) Auth(0x5d08F72B19efb244767fCd36375621934cC75f13) {
        address _owner = 0x5d08F72B19efb244767fCd36375621934cC75f13;
