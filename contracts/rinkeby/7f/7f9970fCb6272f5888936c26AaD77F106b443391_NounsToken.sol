...
contract NounsToken is Ownable, ERC721Checkpointable {
    // The internal noun ID tracker
    uint256 private _currentNounId;

    constructor() ERC721("Nouns Governance Test", "TNOUNGOV") {}

    function mint(address to) public {
        _mint(to, _currentNounId++);
    }

    function burn(uint256 nounId) public {
        _burn(nounId);
    }
}
