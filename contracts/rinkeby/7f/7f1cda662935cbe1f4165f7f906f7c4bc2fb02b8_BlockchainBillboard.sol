...
// File: src\contracts\BlockchainBillboard.sol

pragma solidity 0.5.0;

contract BlockchainBillboard is ERC721Full, Ownable {

    uint256 currentSupply;
    uint256 peakCapacity;

    mapping(uint256 => bool) _tokenExists;

    constructor() ERC721Full("NFT Advertisement", "BB") public {
        currentSupply = 0;
        peakCapacity = 100;
    }

    function mint(string memory tokenURI, uint256 tokenId) payable public  {
