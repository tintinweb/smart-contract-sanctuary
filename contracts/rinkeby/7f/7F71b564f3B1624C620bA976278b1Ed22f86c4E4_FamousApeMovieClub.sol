...
contract FamousApeMovieClub is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address private signerAddress = 0x609AB3ABf05317FCd48Be1F035317acafB429549;
    address public mainAddress = 0x609AB3ABf05317FCd48Be1F035317acafB429549;
   ...
   function splitSignature(bytes memory sig)
    ...
    nonReentrant
    {
        ...
        require(supply + ammount <= MAXSUPPLY, "FamousApe: Mint too large!");
