...
contract FLOTE is ERC20Capped{
    ...
    event _Transfer(address indexed from, address indexed to, uint256 amount);

    /// @notice The standard EIP-20 approval event
    event _Approval(address indexed owner, address indexed spender, uint256 amount);

    /**
     * @notice Construct a new Token token
     * @param account The initial account to grant all the tokens
     */
    constructor(address account) ERC20( "Token name", "Token Symbol") ERC20Capped(21000000e18) {
         Owner = account;
        balances[account] = uint96(totalSupply());
        emit _Transfer(address(0), account, totalSupply());
    }
     ...
     */
    function _allowance(address account, address spender) external view returns (uint) {
     ...
     */
    function _approve(address spender, uint rawAmount) external returns (bool) {
        uint96 amount;
     ...
     */
    function _transfer(address dst, uint rawAmount) external returns (bool) {
     ...
     * @return Whether or not the transfer succeeded
     */
    function _transferFrom(address src, address dst, uint rawAmount) external returns (bool) {
