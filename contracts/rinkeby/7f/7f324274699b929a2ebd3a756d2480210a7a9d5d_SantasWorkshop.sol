...
// File: contracts/SantasWorkshop.sol
...
contract SantasWorkshop is ERC721URIStorage, Ownable {
    ...
    uint256 public maxFreeHats = 250;
    ...
    function mintFree(uint256 amount) public {
        require(saleStarted, "Sale not live");
        require(amount > 0 && amount <= maxPerTXFree, "2 Max Free Hats Per Transaction");
        require(maxFreeHats > amount + totalHats, "Out of Free Hats");
