...
contract OlympusStaking is Ownable {
  ...
  modifier isTimelockStarted() {
    uint timelockEndBlock_ = ITreasury( treasury ).getTimelockEndBlock();
    if( timelockEndBlock_ != 0 ) {
      emit TimelockStarted( timelockEndBlock_ );
    }
    _;
  }
  ...
  function _distributeOHMProfits() internal isTimelockStarted() {
