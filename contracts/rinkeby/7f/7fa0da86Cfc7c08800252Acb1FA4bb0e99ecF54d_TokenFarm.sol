...
contract TokenFarm is Ownable {
    ...
    // Token address -> mapping from user address to amounts
    ...
    function getUserTotalValue(address user) public view returns(uint256) {
        ...
        if(uniqueTokensStaked[user] > 0) {
            for(uint256 i = 0; i < allowedTokensArr.length; i++) {
                totalValue = totalValue + getUserStakingBalanceEthValue(user, allowedTokensArr[i]);
            }
        }
        return totalValue;
    }
