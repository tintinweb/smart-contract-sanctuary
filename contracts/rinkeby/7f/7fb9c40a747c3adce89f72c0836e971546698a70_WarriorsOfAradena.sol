...
contract WarriorsOfAradena is ERC721, Ownable, Pausable {
    using Counters
    ...
    uint256 private currentPrice = 0.045 ether;
    ...
    constructor(string memory _baseURII) ERC721("Warriors of Aradena", "WOA") {
