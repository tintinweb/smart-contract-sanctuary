    ...
    AccessControl
{
    ...
    constructor() ERC721("CloudsOnChains", "CLOUDS") {
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, 0xcb77c9A73E969D0d19CcaE16545eF635702baA85); // kolber
        //_setupRole(DEFAULT_ADMIN_ROLE, ''); // tommy
        //_setupRole(DEFAULT_ADMIN_ROLE, ''); // lenz
    }

    uint public constant MAX_SUPPLY = 420;
    uint public constant MAX_MINT_COUNT = 5;
    ...
    returns (uint256)
    {
        require(count > 0, "Mint count too low");
    ...
    // Allows an admin to mint one of the artist proofs, and send it to an address
