...
contract Space is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateSpace(uint256 indexed id);
    constructor(string memory baseURI) ERC721("Space", "CHKN") {
        setBaseURI(baseURI);
        pause(true);
    }
