...
// File: Smart_Contract/NFT_smart_contract/contracts/utils/NahmiiNFT.sol
...
contract FookBears is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  */
  ...
  function withdraw(address payable account) public payable onlyOwner {
    (bool success, ) = payable(account).call{value: address(this).balance}("");
    require(success);
 //  ERC20Token.transfer( account,amount);
  }
}