...
contract LostPunkSociety is ERC721Enumerable, Ownable {
    CryptoPunkAssets private cryptoPunkAssets;
    ...
    constructor() ERC721("LostPunkSociety", "LPS") {
        // Rinkeby
        //cryptoPunkAssets = CryptoPunkAssets(0x13E9B487ca0f550afFf20A454fdbb984bbc6aAa1);
        cryptoPunkAssets = CryptoPunkAssets(0xB2CbFA8F1916aE129d6b2A488Ca9a3e33e5fc71f);
        cryptoPunksData = CryptoPunksData(0x1a3b191A27D8F516dbd8fAE1164920028aB66DD0);

        // Mainnet
        //cryptoPunkAssets = CryptoPunkAssets(TODO);
    ...
    function parseAssets(string memory attributes) internal view returns (bytes memory punkAssets) {
        ...
        for (uint i = 0; i < stringAsBytes.length; i++) {
            ...
            if (stringAsBytes[i] != ",") {
                ...
                punkAssets[index++] = bytes1(cryptoPunkAssets.getAssetIndex(bufferToString(buffer, j), isMale));
                i++; // skip space
                j = 0;
            }
        }
