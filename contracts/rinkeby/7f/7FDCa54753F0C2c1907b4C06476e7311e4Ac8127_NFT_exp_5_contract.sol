...
// File: contracts/5.sol
contract NFT_exp_5_contract is ERC721 {
    using SafeMath for uint256;
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "5 owner is required");
        _;
    }

    constructor(string memory _base_uri) ERC721("5", "NFTEX2") {
        _owner = msg.sender;
