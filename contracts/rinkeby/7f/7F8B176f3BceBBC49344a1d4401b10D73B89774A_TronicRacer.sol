...
contract TronicRacer is ERC721, Ownable, WithIPFSMetaData, WithContractMetaData, WithWithdrawals {
    // In seconds. Note: subtract 1 second when initializing to reduce gas
    ...
    function mint(uint256 amount) external payable {
        ...
        require(mintIndex + amount <= MAX_SUPPLY, "Racers are sold out!");
        ...
        for (uint256 index = 0; index < amount; index++) {
            ...
            _safeMint(_msgSender(), mintIndex + index);
        }
    }
    ...
    function setSaleStart(uint256 _saleStartTimestamp) public {
        saleStartTimestamp = _saleStartTimestamp;
    }
