...
// File: @openzeppelin\contracts\token\ERC721\ERC721Full.sol
...
// File: src\contracts\ERC721Tradable.sol
 ...
 */
contract MeoCardsTest is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
    public
    ERC721Tradable("Meo Cards Test", "MCT", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "http://api.meocards.com/api/get-card/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://meocards.com/сontracts/";
    }
