...
// SPDX-License-Identifier: MIT 
    ...
    contract NewName is ERC721, Ownable {
        
    constructor() ERC721("NewName", "NN") {}
            
    using SafeMath for uint256;

        uint256 public constant nftPrice = 69000000000000000; 
        uint public constant MAX_PURCHASE = 10;
        uint256 public constant MAX_MAIN = 961;
        bool public saleIsActive = false;
        uint public teamReserve = 100;
        ...
        mapping (uint256 => string) public genSeeds;
        mapping (uint256 => bool) public seedSet;
        mapping (uint => string) public mintedCol;
        ...
        function setColors(uint col, string calldata pale) public onlyOwner {
            mintedCol[col] = pale;
        } 
    
        function viewColors(uint col) public view returns(string memory) {
            return mintedCol[col];
        }
        
        function reserve(address _to, uint256 _reserveAmount) public onlyOwner {        
            uint supply = totalSupply();
            require(_reserveAmount > 0 && _reserveAmount <= teamReserve, "");
        ...
        function publicMint(uint _numberOfTokens) public payable { 
            ...
            require(_numberOfTokens <= MAX_PURCHASE, "");
            require(totalSupply().add(_numberOfTokens) <= MAX_MAIN, ""); 
