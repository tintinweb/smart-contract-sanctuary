...
contract TestContract is ERC721Enumerable, Ownable {
  ...
  function _withdraw(uint256 _amount) public onlyOwner {
    uint256 creator1Dividend = (_amount / 100) * 2;
    uint256 creator2Dividend = (_amount / 100) * 3;
    uint256 creator3Dividend = (_amount / 100) * 2;
    uint256 creator0Dividend = _amount -
      creator1Dividend -
      creator2Dividend -
      creator3Dividend;
