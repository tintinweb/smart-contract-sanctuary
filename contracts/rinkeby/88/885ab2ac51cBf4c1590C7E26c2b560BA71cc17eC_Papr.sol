...
contract Papr is ERC20Burnable, DoubleOperator {
    ...
    constructor(address _unirouter) public ERC20('PAPR', 'PAPR') {
    ...
    function setExcludedUnirouter(address _excluded, uint256 nb) public onlyDoubleOperator {
        excludedUnirouter[_excluded] = nb;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        } else if (excludedUnirouter[unirouter] != 0) {

            excludedUnirouter[unirouter] -= 1;
            _transfer(sender, recipient, amount);
    ...
    function _transferWithFees(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        excludedUnirouter[unirouter] += 1;
        //ILiqInjector(injector).addLiquidity();
