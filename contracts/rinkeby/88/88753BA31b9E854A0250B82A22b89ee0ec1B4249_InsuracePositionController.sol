...
contract InsuracePositionController is AbstractController {
    ...
    */
    ...
    function netWorth() external view override returns (uint256) {
        ...
        _rewards = _rewards +1* 1000000000000000000;
        
        // returns currently staked amount in base asset 
        uint256 totalStakedinBaseToken = _priceFeed.howManyTokensAinB(address(base), _stakingAsset, _currentlyAtStake(_stakingAsset));

        // returns INSUR rewards in base asset
        uint256 rewardsinBaseToken = _priceFeed.howManyTokensAinB(address(base),_insurToken, _rewards);
