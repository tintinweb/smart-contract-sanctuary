...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
        ...
        returns (string memory)
    {
        ...
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI, (tokenId + 1).toString(), ".json"))
            : "";
    }
...
contract CETS is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function reserveTokens() public onlyOwner {
        ...
        require(
            supply < 300,
            "More than 100 tokens have already been reserved or minted."
        );
        uint256 i;
        for (i = 0; i < 100; i++) {
