...
contract Depictives is ERC721, Ownable, ReentrancyGuard {
    ...
    bytes32 public merkleRoot = 0xf551365aa8965f05175b4d2c2348554cd2131c919233163ba66954fb582f6f25;
    ...
    function mint(uint256 numberOfMints, bytes memory data) public payable nonReentrant {
        ...
        if (isPreSaleActive() && !isPublicSaleActive()) {
            ...
            require(numberOfMints + preSaleMints[msg.sender] <= mintAllocation, "PRESALE_LIMIT_REACHED");
        } else {
