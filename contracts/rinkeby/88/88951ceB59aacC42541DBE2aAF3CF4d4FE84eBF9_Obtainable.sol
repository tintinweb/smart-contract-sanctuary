...
contract Obtainable is ContextMixin, ERC721, ERC1155, NativeMetaTransaction, Ownable {
...
*/
interface IFNFT /* is ERC20, ERC165 */{
  ...
  **/
  function sendRoyalty() external payable returns(bool);
