    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint256[] public lengthMulipliers;
    ...
    function __UniQuest_init(
        ...
        lengthMulipliers = [10000, 10500, 11000];
        ...
        public
    {
        ...
        Quest memory _quest = Quest(
            ...
            lengthMulipliers[questLevel], // uint256 lengthMultiplier;
    ...
    function claimHODLRewards(uint256[] memory tokenIds) public {
        for (uint256 i = 0; i < tokenIds.length; i++) {
            require(
