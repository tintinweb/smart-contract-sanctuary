...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase {
    ...
    bytes32 public keyHash; // TODO: internal - public just for demo purposes
    ...
    function requestNewRandomCharacter(uint userProviderSeed, 
    ...
    function fulfillRandomness(bytes32 requestId, uint randomNumber) internal override {
        uint newId = characters.length;
        uint strength = (randomNumber % 100);
        uint speed = (randomNumber % 10000) / 100;
        uint staminia = (randomNumber % 1000000) / 10000;
