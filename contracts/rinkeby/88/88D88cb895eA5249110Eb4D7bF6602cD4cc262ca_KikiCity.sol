...
contract KikiCity is Ownable, ERC721Enumerable {
    ...
    constructor() ERC721("Kiki City", "KIKI") {
        MAX_TOKENS = 10000;
        mintPass = IERC1155(address(0x24C360186Ad288683d92aB65a8b3B5007aE923f4));
        _safeMint( FRANK, 0);
    }
   ...
   */
    ...
    */
    function mintPreSaleTokens(uint numberOfTokens) external payable {
        ...
        require(mintPass.balanceOf(msg.sender,420)>0,"You MUST have a mintpass to use get tokens");
    ...
    function hasTunaPass() external view returns(bool){
        return mintPass.balanceOf(msg.sender,420)>0;
    }
