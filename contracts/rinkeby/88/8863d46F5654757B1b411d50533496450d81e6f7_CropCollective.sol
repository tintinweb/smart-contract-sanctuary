...
contract CropCollective is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {    
    ...
    uint public royalityMinterFeePercent = 5;
    uint public royalityTeamFeePercent = 5;    

    address public teamWallet = 0x0f22F0f1C70b0277dEE7F0FF1ac480CB594Ca450;
    address public chartiyWallet = 0x6a9307652d93CaB45634cAD19cf9E60b0D7504E7;
    ...
    constructor() ERC721('Crop Collective', '$HYDRO') {}
    ...
    function setWallets(address _teamWallet, address _charityWallet) external onlyOwner{
