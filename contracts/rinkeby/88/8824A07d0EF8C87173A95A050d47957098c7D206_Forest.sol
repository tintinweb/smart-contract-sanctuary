...
contract Bear is IBear, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
 ...
 //   uint256 public Price = 8e16; //0.08 ETH
    ...
    // bears
    // background
    rarities[9] = [255, 29, 78, 240, 244, 245];
    aliases[9] = [0, 0, 3, 3, 5, 4];
    // body
    rarities[10] = [210, 255, 240, 31, 245, 244, 239, 84, 255, 29, 91];
    aliases[10] = [0, 1, 2, 1, 4, 4, 6, 8, 0, 5, 1];
    // ears
    rarities[11] = [24, 30, 33, 255];
    aliases[11] = [3, 3, 3, 3];
    // eyes
	  rarities[12] = [235, 247, 239, 241, 76, 225, 235, 255];
    aliases[12] = [1, 2, 3, 0, 5, 6, 7, 7];
    // face
    rarities[13] = [243, 47, 251, 255, 183, 63, 35, 177, 26, 241, 255, 85];
    aliases[13] = [0, 0, 0, 3, 3, 3, 4, 9, 9, 10, 10, 9];
    // head
    rarities[14] = [236, 25, 74, 238, 28, 255, 235, 230, 89, 81, 73, 255];
    aliases[14] = [5, 5, 5, 11, 11, 3, 3, 0, 0, 0, 6, 6];
    // mouth
    rarities[15] = [25, 237, 72, 246, 34, 255, 255, 239, 245, 235, 245, 239, 89, 230];
    aliases[15] = [6, 6, 6, 5, 5, 5, 4, 10, 10, 13, 13, 1, 1, 7];
    // (wing or) NECK 
    rarities[16] = [78, 76, 255, 19]; 
    aliases[16] = [2, 2, 2, 2];
    // senseIndex
    rarities[17] = [25, 160, 73, 255];
    aliases[17] = [2, 3, 3, 3];
  }
...
//add the logic honey tokens to mint cubs based on price
  ...
  function selectTraits(uint256 seed) internal view returns (BeesCubs memory t) {    
    ...
    seed >>= 16;
    t.wingNeck = selectTrait(uint16(seed & 0xFFFF), 7 + shift);
    seed >>= 16;
