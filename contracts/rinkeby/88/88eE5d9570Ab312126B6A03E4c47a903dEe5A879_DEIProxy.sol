	...
	*/
	function collateral2DEI(
		...
		if(global_collateral_ratio == 1000000) {
			...
			IUniswapV2Router02(uniswap_router).swapExactTokensForTokens(collateral_needed_amount + collateral_for_deus_amount, 1, collateral2deus_path, address(this), deadline);
	...
	function getAmountsForMint(
		...
		// deus_amount = amount_out * (1e6 - global_collateral_ratio) / deus_price;
	...
	// 		uint collateral_needed = deus_to_collateral * global_collateral_ratio / ((1e6 - global_collateral_ratio) * collateral_missing_decimals_d18);
