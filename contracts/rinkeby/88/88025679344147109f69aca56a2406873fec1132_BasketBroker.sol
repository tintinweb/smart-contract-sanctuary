...
contract BasketBroker is ReentrancyGuard, VRFConsumerBase {
    ...
    */
    ...
    {   
        ...
        for (uint256 i = 0; i < components.length; i++) {
            ...
            // Make them leave their 5% in for the pot
            //uint256 reducedCompenentQuantity = componentQuantity - componentQuantity.preciseMul(potFee);
  ...
  */ 
      ...
      external 
  {
      ...
      uint256 entries = _quantity / 10**17;
...
/*************** Lottery *****************/
      ...
      payable
  {
      ...
      if (lotteryOccurance) {
          ...
          // Shuffle array random amount of times between 1-5
          shuffleLotteryTickets((randomResult % 5) + 1);
          address winner = lotteryEntries[(randomResult % 10) + 1];
          // Transfer pot winnings to winner.
          transferFrom(basketToken, address(this), winner, basketToken.balanceOf(address(this)));
          emit Lottery(msg.sender, basketToken.balanceOf(address(this)));
      } else {
