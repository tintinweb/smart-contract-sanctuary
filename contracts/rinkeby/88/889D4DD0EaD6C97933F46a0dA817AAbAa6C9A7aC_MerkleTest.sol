...
contract MerkleTest is ERC721Enumerable, Ownable {
    ...
    uint256 public constant RESERVES = 30;
    ...
    function allowListMint(uint256 count, bytes32[] calldata proof) public payable {
        ...
        require(addressToMinted[_msgSender()] + count <= MAX_PER_WALLET, "exceeds wallet max"); 
