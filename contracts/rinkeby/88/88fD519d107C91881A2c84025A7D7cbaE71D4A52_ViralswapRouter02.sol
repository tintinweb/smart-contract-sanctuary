...
library ViralswapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'6cf05e476b8dc8ac8467dcd214e040640e435b771e15ecb684272b6216b1e618' // init code hash
            ))));
    }
    ...
    function vaultFor(address factory, address tokenA, address tokenB) internal pure returns (address vault) {
        ...
        vault = address(uint(keccak256(abi.encodePacked(
                ...
                factory,
                keccak256(abi.encodePacked(token0, token1)),
                hex'f1f1048bae948a9e888861f56d90fa4142637fc8d454aa86dbd3a57d580aa0d4' // init code hash
            ))));
    }
