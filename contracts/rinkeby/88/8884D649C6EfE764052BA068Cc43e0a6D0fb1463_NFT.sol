...
contract NFT is ERC721Enumerable, Ownable {
  ...
  string public baseURI = "ipfs://QmW9vdCUXCUewXStxipmYJxsh3PTRvGHaRjQfFuisqeqfW/";
  string public baseExtension = ".json";
  string public notRevealedUri = "ipfs://QmaKx98qLtmAgRvCvaogyZwchCZhg1X4pyaAeZX56Da7QD/hidden.json";
  uint256 public cost = 0.05 ether;
  uint256 public maxSupply = 2019;
  uint256 public maxMintAmount = 5;
  uint256 internal _reserved = 20;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount, "You can only mint 5 NFTs at a time");
