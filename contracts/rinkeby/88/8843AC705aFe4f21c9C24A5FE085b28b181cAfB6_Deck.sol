...
contract Deck is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private mythicCreatureModifiers = ["Nameless", "Chaos", "Grand", "Undead", "Ancient"];
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        output = string(
            abi.encodePacked(
                '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><defs><style>@import url("https://fonts.googleapis.com/css?family=Arvo:400,400i,700,700i");</style></defs><style>.base{fill: white; font-family: Arvo, serif; font-size: 12px;}.title{fill: white; font-family: Arvo, serif; font-size: 24px;}.appen{fill: white; font-family: Arvo, serif; font-size: 10px;}</style><rect width="100%" height="100%" style="fill-opacity: .0;"/><rect width="100%" height="100%" fill="#E83062" rx="15" /><rect x="30" y="30" width="290" height="290" fill="black" rx="10"/> <text x="43" y="63" class="title">Starter Deck</text>',
                output,
                "</svg>"
            )
        );
        ...
        string memory animationUrl = string(
            abi.encodePacked("https://animationurl.vercel.app/animation/", stringTokenId)
        );
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        stringTokenId,
                        '", "background_color", "FFFFFF", "animation_url": "',
                        animationUrl,
                        '", "description": "Decks are collectable card game based on crypto primatives. The cards can be unbundled and swapped to improve your deck.", "image_data": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("Deck", "Deck") Ownable() {}
}
