...
contract Roles is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[1] = '<style>.base {fill: white; font-family: monospace; font-size: 14px;}</style>';
        ...
        bytes(
            ...
            abi.encodePacked(
                ...
                '",',
                '"description": "assigning on-chain generative roles for the metaverse and beyond. 6969 total roles available. rarity is up to you.",',
