...
contract TheRockingUniquehorns is ERC721Enumerable, Ownable {
    ...
    function mint(uint256 num) public payable nonReentrant {
        ...
        require( msg.value >= _price * num,                          "The Amount of Ether sent is not correct" );
    ...
    function fire(uint256 tokenId) public nonReentrant {
        ...
        _widthdraw(msg.sender, trus[tokenId].mintPrice);
    }
    ...
    */
    ...
    function getMaxMintableTransactionForWallet(address addr) public view returns(uint256) {
        return _getMaxMintableTransactionForWallet(addr);
    }
    ...
    function _isWalletWhitelisted(address addr) private view returns (bool) {
        return _whitelisted[addr] > 0;
    }

    function _getMaxMintableTransactionForWallet(address addr) public view returns(uint256) {
        if(!_whitelistPaused) {
    ...
    function _castOriginalBand() private onlyOwner {
