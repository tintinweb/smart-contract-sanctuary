...
contract faAddons is Ownable, ERC721, ERC721Enumerable {
    ...
    function newBattlePoints(uint16 _fromId, uint16 _toId) external view returns (uint32, uint32,uint32, uint32,uint32, uint32) {
       ...
       */
        statsIncreased[_fromId].life = IFA(_nftAddress).getLife(_fromId);
        statsIncreased[_fromId].armour = IFA(_nftAddress).getArmour(_fromId);
        statsIncreased[_fromId].attack = IFA(_nftAddress).getAttack(_fromId);
        statsIncreased[_fromId].defence = IFA(_nftAddress).getDefence(_fromId);
        statsIncreased[_fromId].magic = IFA(_nftAddress).getMagic(_fromId);
        statsIncreased[_fromId].luck = IFA(_nftAddress).getLuck(_fromId);
        
        
        if (faAddonArray[fromStandardAddonId].typeId==1)
            statsIncreased[_fromId].life = IFA(_nftAddress).getLife(_fromId) + faAddonArray[fromStandardAddonId].level;
        if (faAddonArray[fromStandardAddonId].typeId==2)
            statsIncreased[_fromId].armour = IFA(_nftAddress).getArmour(_fromId) + faAddonArray[fromStandardAddonId].level;
        if (faAddonArray[fromStandardAddonId].typeId==3)
            statsIncreased[_fromId].attack = IFA(_nftAddress).getAttack(_fromId) + faAddonArray[fromStandardAddonId].level;
        if (faAddonArray[fromStandardAddonId].typeId==4)
            statsIncreased[_fromId].defence = IFA(_nftAddress).getDefence(_fromId) + faAddonArray[fromStandardAddonId].level;
        if (faAddonArray[fromStandardAddonId].typeId==5)
            statsIncreased[_fromId].magic = IFA(_nftAddress).getMagic(_fromId) + faAddonArray[fromStandardAddonId].level;
        if (faAddonArray[fromStandardAddonId].typeId==6)
            statsIncreased[_fromId].luck = IFA(_nftAddress).getLuck(_fromId) + faAddonArray[fromStandardAddonId].level;
