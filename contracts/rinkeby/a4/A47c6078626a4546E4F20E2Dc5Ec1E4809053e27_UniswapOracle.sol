...
interface IOracle {
    ...
    event Update(uint256 _peg,uint32 _times,uint256 _cup,uint256 _dup,uint256 _f,uint256 _d);
...
contract UniswapOracle is Permissions, IUniswapOracle {
    ...
    function update() external override returns (bool) {
        ...
        emit Update(_twap.asUint256(),priorTimestamp,priorCumulative,deltaCumulative,FIXED_POINT_GRANULARITY,duration);
