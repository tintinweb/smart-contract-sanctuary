...
contract FunFaces11 is ERC721, PaymentSplitter, Ownable, Pausable {
    ...
    */
    ...
    /*
       @dev   Whitelist mint
       @param @param _count Amount to mint
    ...
    */
    ...
    // Pause the contract as an emergency switch
    function pause() external onlyOwner {
        require(!paused(), "ALREADY_PAUSED");
        _pause();
    }

    // Unpause the contract as an emergency switch
