...
contract DescentCollection is ERC721Enumerable, ERC721Burnable, ReentrancyGuard, Ownable {
    ...
    function mint(uint256 _numberToMint) public payable nonReentrant() {
        require(isSaleActive, "Mint hasn't started yet.");
        require(totalSupply() < MAX_DESCENTS, "Sale has already ended.");
        ...
        require(priceCheck().mul(_numberToMint) <= msg.value, "Price is 0.15ETH");
