...
contract HW04Exchange {
    ...
    IERC20 SerhiiToken = IERC20(0x5443E06C6Dce3fB5e7e448540c5311556Bf6c0e2);
    ...
    function buySerhiiTokens() public payable {
        ...
        if(SerhiiToken.balanceOf(address(this)) < amountSLTKToBuy){
            (bool sent,) = msg.sender.call{value: msg.value}("Not enough SLTK tokens on this Exchange");
            return;
        }
    ...
    function buySerhiiTokensForDAI(uint256 amountDaiToPay) public {
        ...
        if(SerhiiToken.balanceOf(address(this)) < amountSLTKToBuy){
            (bool sent,) = msg.sender.call("Not enough SLTK tokens on this Exchange");
            return;
        }
