...
/** 
 *  SourceUnit: /home/aniket/escrow-contracts/contracts/Treasury/Treasury.sol
*/
...
Conversion of 
 */
contract Treasury is AccessControlEnumerableUpgradeable, OwnableUpgradeable {
	/**
    @notice OWNER ROLE - Only Owner can add admins.
    The role is only used to assign roles to other roles.
    ...
    */
	...
	event NamedTransfer(address indexed sender, address indexed recipient, uint256 amount);
    ...
    For initialization. 
     */
	function initialize(address _owner, address tokenAddr) external initializer {
		__Ownable_init();
    ...
    @dev This is a function added specifically for Vanilla Token.
    The newBalance - oldBalance makes sure that 5% burn of VNLA token is kept into account.
    ...
    */
	function deposit(uint256 amount) external {
		...
		emit NamedTransfer(_msgSender(), address(this), newBalance - oldBalance);
	}
