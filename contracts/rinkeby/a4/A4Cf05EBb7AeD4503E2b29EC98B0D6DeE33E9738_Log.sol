...
contract Log {
    ...
    function TakeaGuess(uint256 num) public {number = num;}
    
    function ResetPuzzle() public {number = 0;}

    function CheckNumberYouPutIn() public view returns (uint256){
        
        return number;
    }
    
    string combo = "Congrats! You got it right! Please reset the puzzle before you leave!";
