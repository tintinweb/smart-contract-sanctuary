...
contract PixelBillionaire is ERC721EnumerableB, Ownable, PaymentSplitter {
    ...
    bytes32 public wlMerkleRoot = 0xd5136386e624c4d52b035176f53a5b6b11c38c3f4f8b9ab9c52ff41794983893;
    bytes32 public ogMerkleRoot = 0xc5cb7cfa77fc1ffc20657411e6d3a3ccf9511eee656104839bf192365bff9d7e;
    
    address[] private payees = [
        0x4Ee581AA4EBd5cb0453162aF718A1B42C9EcC8C8,
        0xe339d5bE1d2E9059F0B3a6a8BE45e43722dd0f6B, //team2
    ...
    function premint(uint256 _mintQty, bytes32[] calldata _wlProof, bytes32[] calldata _ogProof) public payable {
        ...
        if (MerkleProof.verify(_ogProof, ogMerkleRoot, leafNode) && _mintQty >= 2) {
