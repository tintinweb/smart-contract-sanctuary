...
// import "@openzeppelin/contracts/token/ERC721/presets/ERC721PresetMinterPauserAutoId.sol"; <-- Look at this for reference
    ...
    Ownable
{
    ...
    uint256 public costToMint = 80000000000000000;
    ...
    modifier whenNotOutOfTokens() {
        require(_tokenIdTracker.current() < supply, "Out of tokens");
        _;
    }

    function mint(address to) payable public virtual nonReentrant whenNotPaused whenNotOutOfTokens onlyOwner {
    ...
    */
    function mintByOwner(address to) public nonReentrant whenNotPaused whenNotOutOfTokens{
        _mint(to, _tokenIdTracker.current());
        _tokenIdTracker.increment();
    }
