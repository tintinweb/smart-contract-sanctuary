...
contract uSee is ERC721URIStorage {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    address private marketplaceAddress;
    address private managementAddress;

    constructor(address _marketplaceAddress, address _managementAddress) ERC721("unsee", "uSee") {
        marketplaceAddress = _marketplaceAddress;
        managementAddress = _managementAddress;
    }

    function isAllowed(address sender) private returns (bool){
        InterfaceManagement I =  InterfaceManagement(managementAddress);
        return I.isAddressAllowed(sender);
    }
