...
contract W10 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private mapReflect;
    ...
    string private constant _name = "C12";
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        function addWhitelistedAccount(address acc) onlyOwner public returns(bool){
        require(!isInWhitelist[acc]);
        isInWhitelist[acc] = true;
        emit LogAddressAdded(msg.sender,acc);
        return true;
    }
        ...
        emit LogAddressDeleted(msg.sender,acc);
        return true;
    }
        function isInTheWhiteList(address acc) public view onlyOwner returns(bool){
