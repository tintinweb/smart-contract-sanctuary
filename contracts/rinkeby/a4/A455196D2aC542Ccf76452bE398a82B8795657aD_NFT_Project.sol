...
contract NFT_Project is ERC721, Ownable, ReentrancyGuard{
   ...
   event BatchMint(uint256 _totalNft, string msg);
    ...
    function batchMint(uint256 _totalNft, string[] memory _uri, uint256[] memory _royalty) public nonReentrant returns (bool) {
        ...
        for(uint i = 0; i< _totalNft; i++) {
            require(_royalty[i]<100,"Royalty cannnot be 100 or more");
