...
contract SVGNFT is ERC721URIStorage{
    ...
    // constructor of ERC721 is called in SVGNFT constructor
    ...
    function formatTokenURI(string memory imageURI) public pure returns (string memory) {
        ...
        Base64.encode(bytes(abi.encodePacked('{"name": "SVG NFT", "description": "An NFT based on SVG!", "attributes": "","image":',imageURI, '"}')))));
