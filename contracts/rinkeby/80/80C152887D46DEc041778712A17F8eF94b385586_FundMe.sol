...
contract FundMe {
    ...
    AggregatorV3Interface priceFeed;/*o pricefeed recebe o AggregatorV3Interface com o endereço do par ETH/USD da rede Kovan. Permitindo que 
    ele realize diversas operações, como a obtenção do valor do atual do par.*/
    ...
    constructor(address _priceFeedAddress){/*o constructor é uma função que é chamada no momento de criação da classe, nesse caso do contrato
