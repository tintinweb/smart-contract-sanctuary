...
contract BinaryOptions is Ownable, Pausable, Oracle {
    ...
    function bidLong(uint256 bids) public payable whenNotPaused {
        ...
        emit eventBid("Long Bid Invoked", msg.sender, msg.value);
    }
    ...
    function bidShort(uint256 bids) public payable whenNotPaused {
        ...
        shortBid++;
        dvdBalance[msg.sender] = msg.value;
        emit eventBid("Short Bid Invoked", msg.sender, msg.value);
    }
    ...
    function transferDVD(address _from, uint256 _amount) external {
        console.log("transfer DVD from", _from, _amount);
    ...
    function withdraw(address _to, uint256 _amount) public {
        require(
            _amount < dvdBalance[_to],
            "Cannot transfer more than your total contribution"
        );
        dvdToken.transferFrom(address(this), _to, _amount);
    }

    receive() external payable {
        console.log("receive function invoked", msg.sender, msg.value);
    }
}
