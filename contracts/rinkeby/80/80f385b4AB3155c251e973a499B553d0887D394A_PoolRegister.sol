...
contract PoolRegister is IPoolRegister, Managed {
    ...
    mapping(address => bool) private privates;
    ...
    function isPrivate(address _pool) external view override returns(bool){
        return privates[_pool];
    }
    ...
    function remove(address _pool) external override requirePermission(ROLE_ADMIN) {
        pools.remove(_pool);
