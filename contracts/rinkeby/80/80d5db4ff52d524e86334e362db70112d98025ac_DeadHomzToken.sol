...
contract DeadHomzToken is IERC721, Ownable, ERC721Enumerable {
  ...
  uint public constant MAX_PRIZE_MINTS = 100;

  string private _contractURI = "https://gist.github.com/Aman7123/07c4a3b196f2140498c130cb00bb0990";

  string public baseURI = "https://mockbin.org/bin/4745d5ad-0b13-4675-8446-b46ed430ae17/";

  address public immutable proxyRegistryAddress;

  constructor(address _proxyRegistryAddress) ERC721('DeadHomz', 'DEADHOMZ') {
  ...
  function mint(uint amount) public payable {
    ...
    require(currentTotalSupply >= MAX_PRIZE_MINTS, "DeadHomzToken: Not yet launched");

    /// @notice Cannot exceed maximum supply
    require(currentTotalSupply+amount <= MAX_SUPPLY, "DeadHomzToken: Not enough mints remaining");
    ...
    require(msg.value > 0 && msg.value == amount * PRICE, "DeadHomzToken: Not enough value sent");
  ...
  function withdraw() public onlyOwner {
    ...
    require(success, "DeadHomzToken: Withdraw unsuccessful");
  }
}