...
contract RandomClown is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  ...
  constructor(string memory _name, string memory _symbol) 
    ...
    RandomlyAssigned(500,1) // Max. 10000 NFTs available; Start counting from 1 (instead of 0)
    {
