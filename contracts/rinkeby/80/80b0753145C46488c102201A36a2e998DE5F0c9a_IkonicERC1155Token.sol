...
abstract contract ERC1155Base is
    ...
    function uri(uint256 _id) override(ERC1155Metadata_URI, ERC1155) public view virtual returns (string memory) {
...
contract IkonicERC1155Token is ERC1155Base, SignerRole {
