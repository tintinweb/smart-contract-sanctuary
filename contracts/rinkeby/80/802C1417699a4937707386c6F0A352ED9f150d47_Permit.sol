...
contract Permit is ERC20Permit {
    ...
    function testPermit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) public {
        permit(owner, spender, value, deadline, v, r, s);
        TestToken token = TestToken(0xC0658e83E25cfF3A105b8bDF4F3D9D99375C0078);
