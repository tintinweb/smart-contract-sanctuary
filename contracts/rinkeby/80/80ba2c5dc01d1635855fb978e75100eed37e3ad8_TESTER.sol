...
contract TESTER is Context, IERC20, Ownable {
  ...
  constructor() public {
    ...
    vestibleTokens[0] = VestibleToken("team", startTime, 180 days, 10, finalTotalSupply.mul(10).div(100), 0);
    vestibleTokens[1] = VestibleToken("operations", startTime, 30 days, 12, finalTotalSupply.mul(6).div(100), 0);
