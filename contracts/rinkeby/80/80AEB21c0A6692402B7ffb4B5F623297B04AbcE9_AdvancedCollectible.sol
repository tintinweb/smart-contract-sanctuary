...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    constructor(
        //  # All this parameters are from the VRF contract or services in
    ...
    function createCollectible() public returns (bytes32) {
        ...
        // saving the address that request the token
        ...
        override
    {
        ...
        // here we are establishing what dos s each tokenId
        tokenIdToBreed[newTokenId] = breed;
        emit breedAssigned(newTokenId, breed);
        // Finding the address that request the random number for the token
