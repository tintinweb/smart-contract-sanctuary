...
contract LoveLettersV1 is ERC721 {
    ...
    function createCollectible(string memory tokenURI, address recipient) public returns (uint256) {
    ...
    function readLetters(string memory newItemId) public view returns (string memory) {
      string memory letternumber = newItemId;
      string memory letter = "This is just a sample Letter";
      return letter;
    }
