...
contract PotatoPower is ERC721, Ownable,Pausable {
    ...
    uint256 private currentPrice = 0.05 ether;
    uint256 private maxQuantity=30;
    ...
    constructor(string memory _baseURII) ERC721("Potato Power", "PW"){tokenBaseURI=_baseURII; Owner = payable(msg.sender);}
    ...
    require(msg.sender!=Owner,"Not for Owner");
    require(totalSupply()+_quantity<=maxSupply,"Quantity must be lesser then MaxSupply");
    ...
    require(getPrice(_quantity) == msg.value, "Ether value sent is not correct");
       ...
       function mintByAdmin( uint256 _quantity) whenNotPaused() public  onlyOwner  returns (uint256) {
