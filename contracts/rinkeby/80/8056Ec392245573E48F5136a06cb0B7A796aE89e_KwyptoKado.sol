...
contract KwyptoKado is ERC721Enumerable, Pausable, Ownable  {
    ...
    constructor() ERC721("KwyptoKado Gen1", "KWK") {
    ...
    function createKado(uint8 _amount) public payable whenNotPaused {
        ...
        require(balanceOf(msg.sender) + _amount <= maxPerWallet, "Only 99 per wallet!");
        require(_currentTokenId + _amount <= maxSupply, "Not enough left, sorry!");
