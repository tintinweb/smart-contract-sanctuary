  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x0D0015a9D61ed65d9E1665a3F4BD2d49D63c8f18);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 3333');
    ...
    // File: contracts/skxllysContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract SkxllysContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Skxllys", "SKXLLY", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/GO141pn92iDDNiMrW07b/contract-metadata";
        }
    }