...
contract LPBankFactory is Ownable, Pausable {
    ...
    function registerLPBank(
        ...
        uint256 tokenIndex =
            getCreatedLPBanksLengthByToken(msg.sender, _lpToken);
        bytes32 salt =
        ...
        getLPBanks[msg.sender][_lpToken].push(pool);
...
contract LPBank is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
