...
contract RKC is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateRKC(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Royal Knights Club", "RKC") {
		setBaseURI(baseURI);
        pause(true);
    }
