...
contract Paytr{
    ...
    event PaymentInfoErc20(address sender, uint256 amount, bytes paymentReference, uint dueDate, address supplier, address tokenAddress);
   ...
   constructor() public {
    ...
    function supplyErc20ToCompound(
        ...
        emit PaymentInfoErc20(sender, amount, paymentReference, dueDate,supplier, tokenAddress);
    ...
    function createDueListAndPayErc20() public payable {
        ...
        for (uint i = 0; i < dueInvoicesErc20.length; i++) {
            ...
            if (dueInvoicesErc20[i].supplier != 0x0000000000000000000000000000000000000000) {
                ...
                //address sender, invoice amount, payment reference, supplier, interest amount
                emit PaymentInfoErc20(dueInvoicesErc20[i].sender, dueInvoicesErc20[i].amount, dueInvoicesErc20[i].paymentReference, dueInvoicesErc20[i].dueDate, dueInvoicesErc20[i].supplier, erc20TokenAddress);
