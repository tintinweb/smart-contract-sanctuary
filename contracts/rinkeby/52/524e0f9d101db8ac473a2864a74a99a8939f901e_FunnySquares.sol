...
// File: contracts/FunnySquares.sol
...
contract FunnySquares is ERC721Enumerable, Ownable { 
    using Address for address;
    ...
    constructor () ERC721 ("FunnySquares", "FSQR") { }
    ...
    function withdrawTeam(uint256 amount) public payable onlyOwner {
        ...
        require(payable(a1).send(percent * 50)); // 50% for Owner1
        require(payable(a2).send(percent * 50)); // 50% for Owner2
    }
}