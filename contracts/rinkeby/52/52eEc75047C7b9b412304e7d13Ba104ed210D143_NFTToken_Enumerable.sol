...
contract NFTToken_Enumerable is ERC721Enumerable, Ownable {
    ...
    function mint(uint256 _tokensId) public payable saleIsOpen {
        ...
        _mintAnElement(wallet, _tokensId);

    }

    // function signatureWallet(address wallet, uint256 _tokensId, uint256 _timestamp, bytes memory _signature) public view returns (address){
