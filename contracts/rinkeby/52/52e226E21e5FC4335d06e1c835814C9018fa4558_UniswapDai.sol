...
contract UniswapDai{
    ...
    WETH9 we = WETH9(_weth);
      ...
      address[] public  path1 = [_weth,_dai];
      address[] public path2 = [_dai,_weth];
    ...
    function swapExactETHForTokens(uint amountOutMin)
        ...
        returns (uint[] memory amounts){
         ...
         amounts =  ur.swapExactETHForTokens(amountOutMin,path1,owner,_deadline);
         return (amounts);
    ...
    function swapExactTokensForETH(uint amountIn, uint amountOutMin)
        ...
        returns (uint[] memory amounts){
          ...
          _deadline = block.timestamp +120;
         amounts =  ur.swapExactTokensForETH(amountIn,amountOutMin,path2,owner,_deadline);
          return (amounts);
