...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase, Ownable {
    ...
    uint256 internal hats_len = 33;
    uint256 internal eyes_len = 25;
    uint256 internal facial_hairs_len = 2;
    uint256 internal earrings_len = 4;
    uint256 internal mouths_len = 15;
    uint256 internal extras_len = 1;
    uint256 internal shirts_len = 11;
    uint256 internal skins_len = 6;
    uint256 internal backgrounds_len = 7;
    ...
    {
        string memory character_traits = appendUintToString('', characters[tokenId].hat);
        character_traits = appendUintToString('', characters[tokenId].eye);
        character_traits = appendUintToString('', characters[tokenId].facial_hair);
        character_traits = appendUintToString('', characters[tokenId].earring);
        character_traits = appendUintToString('', characters[tokenId].mouth);
        character_traits = appendUintToString('', characters[tokenId].extra);
        character_traits = appendUintToString('', characters[tokenId].shirt);
        character_traits = appendUintToString('', characters[tokenId].skin);
        character_traits = appendUintToString('', characters[tokenId].background);
        return (
            characters[tokenId].name,
            character_traits
            // characters[tokenId].hat,
            // characters[tokenId].eye,
            // characters[tokenId].facial_hair,
            // characters[tokenId].earring,
            // characters[tokenId].mouth,
            // characters[tokenId].extra,
            // characters[tokenId].shirt,
            // characters[tokenId].skin,
