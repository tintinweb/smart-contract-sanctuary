...
import "../../token/ERC20/ERC20MintBurnGovernance.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20MintBurnGovernance is ContractOwnable, IMasterERC20 {
  ERC20MintBurnGovernance[] private childERC20MintBurnGovernance;
  ...
  function createERC20(
    ...
    ERC20MintBurnGovernance child = new ERC20MintBurnGovernance(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20MintBurnGovernance.push(child);
...
contract ERC20MintBurnGovernance is ERC20 {
...
abstract contract ContractOwnable is Context, Ownable {
