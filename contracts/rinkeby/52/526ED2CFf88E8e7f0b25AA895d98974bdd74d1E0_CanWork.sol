...
contract CanWorkJob is Escrow {
    ...
    returns (bool) {
        ...
        emit OnCreateJob(msg.sender, _jobId, _employer, _provider, _totalCosts);
...
contract Escrow is Migratable {
    ...
    returns (uint256) {
        ...
        require(escrowToken.transferFrom(_employer, address(this), _amount), "Client must have authorisation and balance to transfer PAPR");
