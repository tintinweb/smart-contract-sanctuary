...
contract METAKITTEN{// modify
    ...
    string private name = "METAKITTEN"; // modify
    string private symbol = "MKT"; // modify
    
    address public Owner = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2; // modify
    address public Developer = 0xCA35b7d915458EF540aDe6068dFe2F44E8fa733c; // modify
    address public CharityWallet = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db; // modify

    uint public immutable decimals = 18; // modify
    uint public totalSupply = 1000000000000 * 10 ** 18; // modify
    uint public immutable CappedSupply = 2000000000000 * 10 ** 18; // modify
