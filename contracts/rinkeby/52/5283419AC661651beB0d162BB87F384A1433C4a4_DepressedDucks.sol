...
pragma abicoder v2;
contract DepressedDucks is ERC721, Ownable {

    using SafeMath for uint256;

    string public DUCK_PROVENANCE = "";

    uint256 public duckPrice = 20000000000000000; // 0.02 ETH
    ...
    function mintDepressedDuck(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxDuckPurchase, "Can only mint 10 ducks at a time");
