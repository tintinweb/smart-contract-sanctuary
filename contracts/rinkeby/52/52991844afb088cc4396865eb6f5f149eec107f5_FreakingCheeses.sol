...
contract FreakingCheeses is ERC721Enumerable, Ownable{
    ...
    uint256 public constant cheesePrice = 100000000000000000; // 0.001 ETH
  ...
  function reserveCheese(address _to, uint256 _reserveAmount) public onlyOwner {        
        uint supply = totalSupply();
        require(_reserveAmount > 0, "Amount Should be positive");
