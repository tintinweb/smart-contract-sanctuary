 ...
 */
contract KevinIsTheMan is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("Kevin", "Kev") {
        ...
        REVEAL_TIMESTAMP = block.timestamp + (86400 * 0);
        mintPrice = 50000000000000000; // 0.069 ETH
        maxToMint = 30;
        saleIsActive = false;
        wallet1 = 0xD9a8d6026e301671B39694c26D3512953C13150d;
     ...
     * Mint Doges by owner
     */
    function ReserveForPromotion(address _to, uint256 _numberOfTokens) external onlyOwner {
    ...
    */
    function mint(uint256 numberOfTokens) external payable {
        ...
        require(totalSupply()+numberOfTokens <= MAX_DOGE_SUPPLY, "Purchase would exceed max supply");
