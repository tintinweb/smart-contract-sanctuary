...
contract NFTI is IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
    ...
    */
    ...
    modifier paused() {
        require(block.timestamp > _start_sold_time);
        _;
    }
    ...
    */
    ...
    function isAdressInPreSale(address customer) public pure returns (bool) {
        return customer == address(0x5ad0734530568E5C80036fd814A8B50ac0A3EB4F) ||
               ...
               customer == address(0x4a384E9bf528A7D2026Dc2C5FB0441b1091D804D);
    }
    ...
    // TODO: REMOVE
    function setRevealTime(uint256 time_) onlyOwner public {
        _finish_reveal_time = time_;
    }

    // TODO: REMOVE
    function setStartTime(uint256 time_) onlyOwner public {
        _start_sold_time = time_;
    }

    // TODO: REMOVE
    function setPreSaleTime(uint256 time_) onlyOwner public {
        _start_presale_time = time_;
    }
    ...
    */
    ...
    function buyItem(uint256 numberOfNfts) public payable paused {
        ...
        require(!isPreSaleNow() || isPreSaleNow() && _tokenOwners.length().add(numberOfNfts) <= 10 && isAdressInPreSale(_msgSender()), "");
