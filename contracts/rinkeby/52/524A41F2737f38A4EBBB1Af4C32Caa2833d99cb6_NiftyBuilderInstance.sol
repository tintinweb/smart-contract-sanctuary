...
contract NiftyBuilderInstance is ERC721, ERC721Burnable {
    ...
    // engine of dynamic assets
    address public _tokenUriAddress;
     ...
     * 
     * @param tokenUriAddress_ tokenUriAddress_
     ...
     */
    constructor(
        address tokenUriAddress_,
        address niftyRegistryContract,
        address defaultOwner
    ) ERC721(tokenUriAddress_, defaultOwner, niftyRegistryContract) {
        _creator = "Dave Pollot";
    }
     ...
     */
    function setTokenUriAddress(address tokenUriAddress_) public onlyValidSender {
        _setTokenUriAddress(tokenUriAddress_);
    }
...
contract ERC721 is NiftyEntity, Context, ERC165, IERC721, IERC721Metadata {
    ...
    address private _tokenUriAddress;
     ...
     * @param tokenUriAddress_ The location where dynamic ipfs hash configured.
    ...
    constructor(
        ...
        _name = "14:59 - The Crypto Traders";
        _id = 1;
        _typeCount = 2;
        _tokenUriAddress = tokenUriAddress_;

        _symbol = "CRYTOTRADERS";
    ...
    function tokenURI(uint256 tokenId) external view override returns (string memory) {
        ...
        if (niftyType == 1) {
            // cryptoTrader1
            return CryptoTraderInterface(_tokenUriAddress).btcTokenURI();
        } else {
            // cryptoTrader2
            return CryptoTraderInterface(_tokenUriAddress).ethTokenURI();
        }
    }
    ...
    /**
     * @dev Token URI for computing {tokenURI}.
     */
    function _setTokenUriAddress(address tokenUriAddress_) internal {
        _tokenUriAddress = tokenUriAddress_;
    }
...
contract NiftyEntity {
    ...
    */
    modifier onlyValidSender() {
        require(
          INiftyRegistry(_niftyRegistryContract)
          .isValidNiftySender(msg.sender), 
          "NiftyEntity: Invalid msg.sender");
        _;
    }
    ...
    */
    constructor(address niftyRegistryContract_) {
      ...
      _niftyRegistryContract = niftyRegistryContract_;
    }
}
