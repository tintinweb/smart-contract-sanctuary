...
contract NFTHack2022 is LilOwnable, ERC721 {
    ...
    string public constant NFT_NAME = "NFTHack 2022";
    string public constant NFT_SYMBOL = "NFTH2022";

    uint256 public totalSupply;

    string public constant COHORT_NAME = "Genesis";
    mapping(uint256 => address) public minterOf;

    constructor() payable ERC721(NFT_NAME, NFT_SYMBOL) {}
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        ...
        string memory svgString = string(
            abi.encodePacked(
                SVGlib.svgStart(240, 320),
                "<style>.base { fill: black; font-family: serif; font-size: 12px; }</style>",
                // SVGlib.svgRectStart(10,10,300,220,12,12,"slateblue"),
                // SVGlib.svgRectEnd(),
        ...
        return SVGlib.buildSvg("NFT Name","NFT",svgString);
    }
...
// primes nft
// https://etherscan.io/address/0xBDA937F5C5f4eFB2261b6FcD25A71A1C350FdF20#code
