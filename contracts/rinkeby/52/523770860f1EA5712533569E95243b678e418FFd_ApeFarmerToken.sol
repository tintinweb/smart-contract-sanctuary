...
contract ApeFarmerToken is BEP20("ApeFarmer Token", "APEF") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "LORY::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "LORY::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "LORY::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "LORY::_writeCheckpoint: block number exceeds 32 bits"
            );
