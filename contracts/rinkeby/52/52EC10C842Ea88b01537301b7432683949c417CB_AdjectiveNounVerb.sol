...
contract AdjectiveNounVerb is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getDescriptor(string memory id)
        public
        view
        returns (string memory)
    {
