...
contract DigifoxToken is Ownable, StandardToken {
    ...
    constructor() {
        ...
        emit Transfer(address(0x0), earlyAdopterDistributionWallet, earlyAdopterDistributionAmount);
        balances[earlyAdopterDistributionWallet] += earlyAdopterDistributionAmount;
        
        // 5% goes toward liquidity provider program
        emit Transfer(address(0x0), liquidityProviderDistributionWallet, liquidityProviderDistributionAmount);
        balances[liquidityProviderDistributionWallet] += liquidityProviderDistributionAmount;
