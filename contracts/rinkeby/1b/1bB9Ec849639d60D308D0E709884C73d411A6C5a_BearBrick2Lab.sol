...
/**
 * @title BearBrick2Lab contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract BearBrick2Lab is ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    uint public constant MAX_TOKEN_PURCHASE = 10;
    uint public constant TOKEN_PRICE = 0.03 ether; // 50000000000000000 Wei
