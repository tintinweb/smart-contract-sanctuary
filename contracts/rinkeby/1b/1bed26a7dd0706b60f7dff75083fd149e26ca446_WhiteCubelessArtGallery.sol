...
contract WhiteCubelessArtGallery is ERC721,ERC2981Collection {
    ...
    uint256 public nextEditionId = WhiteCubelessGalleryVersion*ONE_MILLION;
    ...
    function addEdition(string memory _editionName, uint256 _editionLimit)  onlyWhitelisted public
    {
        ...
        //1-updateEditionBaseIpfsURI
        //2-updateEditionDescription
        //3-updateEditionWebsite
        //4-updateEditionArtist
    ...
    function editionDetails(uint256 _editionId) view public returns (string memory editionName, string memory artist, string memory description,string memory website) 
    {
        editionName = editions[_editionId].name;
        artist = editions[_editionId].artist;
        description = editions[_editionId].description;
        website = editions[_editionId].website;
