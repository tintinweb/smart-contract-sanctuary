...
contract NFT is ERC721,Ownable,ERC721URIStorage{
    ...
    Counters.Counter private _tokenId1;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://bafybeiausr23nin4yh3tfkcfre5fyt4aertccldrrgc33eaj7wjebf6qry.ipfs.dweb.link/";
    }
        ...
        returns (string memory)
    {
        return string(abi.encodePacked(
            "https://bafybeiesjmaqigg5x6adlymwlhafk3euqotrg635mf4mn2yi3jq6tvtmeu.ipfs.dweb.link/",
            Strings.toString(tokenId)
        ));
    }


    function _generate() private returns(uint256){
            _tokenId.increment();
    ...
    function createNFT() public returns(uint256){
            if(_tokenId.current() < _totalSupply){
                return _generate();
            }
            else{
