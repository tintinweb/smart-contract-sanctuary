...
contract NFTest is ERC721Enumerable, Ownable{
    ...
    // SHA-256 provenance hash of images at origional index: cd1e9ece2d406f1b6e8d3c0d6a264771af257c71891fae40dbcff3c9b5d35424
    uint256 public offSetIndex;
    uint256 public offSetIndexBlock;

    address public constant Address1 = 0x5F553361C0DB8544B75ae3689F28C963A0d8E783;
    address public constant Address2 = 0x596261D50EE888698AB61dE1b1513E667943ef08;
    address public constant Address3 = 0x4eCDd8564c42033A604e91CEEc77c69505982957;

    uint256 public constant MAX_MINTED = 60;

    uint256 public constant PURCHASE_LIMIT = 5;
    uint256 public constant WlistPURSHASE_LIMIT = 2;

    uint256 public constant PRICE = 0.3 ether;
    uint256 public constant wlistPRICE = 0.15 ether;

    // 0 - Close,  1 - Whitelist, 2 - Public
    uint8 public saleSTATE = 0;
    string public BaseURI;

    uint64 public WHITELIST_MAXMEMBERS = 3;
    uint64 public WHITELIST_MEMBERCOUNT = 0;
    mapping (address => whiteListStruct) public WHITELIST;
    struct whiteListStruct{
        uint8 amountPurchased;
        bool exists;
    }

    event SaleStateChanged(uint8 _value);
    ...
    // tokens minted for a promo giveaway
    ...
    function addToWhiteList(address _address) public onlyOwner{
        require(!WHITELIST[_address].exists, "Wallet already whitelisted!");
        require(WHITELIST_MEMBERCOUNT < WHITELIST_MAXMEMBERS, "Maximum whitelist spots reached!");

        WHITELIST_MAXMEMBERS++;
        WHITELIST[_address].exists = true;
    ...
    function updateSaleState(uint8 _value) public onlyOwner{
        require(_value < 3, 'Bad value entered!');
        saleSTATE = _value;
        emit SaleStateChanged(saleSTATE);
    }

    function mintToken(uint8 _amount) public payable{
        require( (_amount + totalSupply() ) <= MAX_MINTED, "Purchase is beyond mintable tokens");
        require(totalSupply() < MAX_MINTED, "All tokens have been minted!");
    ...
    function generateOffsetIndex() public{
        ...
        if (block.number.sub(offSetIndexBlock) > 255 && _offset == 0) {
            _offset = uint(blockhash(offSetIndexBlock - 1)) % MAX_MINTED;
        }
    ...
    function withdrawETH() public onlyOwner {
        ...
        uint256 amount = balance.mul(33).div(100);
