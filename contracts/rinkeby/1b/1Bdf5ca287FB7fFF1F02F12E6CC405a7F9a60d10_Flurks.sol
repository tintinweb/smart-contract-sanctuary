...
contract Flurks is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 private constant nftsNumber = 5040; //40 Reserved for giveaways and influencers
    uint256 private constant nftsPublicNumber = 5003; //first 3 reserved for original stonetoss NFT holders
    ...
    function mintGiveawayFlurks(address to, uint256 tokenId) public onlyOwner {
        ...
        require(tokenId <= 3, "Those aren't for you");
