...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        address _vrdCoordinator,
        address _link,
        uint256 _fee,
        bytes32 _keyhash
    ) public VRFConsumerBase(_vrdCoordinator, _link) {
    ...
    function endLottery() public onlyOwner {
        // uint256(            // bad way to get random since these are all deterministic values with a minpulative number
        //     keccack256(
        //         abi.encodePacked(
        //             nonce,
        //             msg.sender,
