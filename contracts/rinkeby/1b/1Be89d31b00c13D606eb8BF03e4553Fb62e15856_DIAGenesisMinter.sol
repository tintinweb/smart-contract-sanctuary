...
contract DIAGenesisMinter is Ownable {
	...
	event MintedDataNFT(uint NFTIndex, address owner, uint256 numMinted, uint256 newRank, bool isGenesis);
	...
	function postGenesisMint(uint NFTIndex) external{
		...
		emit MintedDataNFT(NFTIndex, msg.sender, diaDataNFTImpl.numMintedNFTs(), newRank, false );
	}
	...
	function genesisMint() external {
		...
		emit MintedDataNFT(genesisNFTIndex, msg.sender, numMintedNFTs, newRank, true);
	}
}
...

{
  ...
  "libraries": {
    "contracts/DIAGenesisMinter.sol": {
      "NFTUtil": "0x45aa3ae6c36b35b4c63d62476cbb13ed827317f0"
    }
  }
}