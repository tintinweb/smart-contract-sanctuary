...
contract Realm is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  event Terraform(uint256 realmId, uint256 newFeatureId, uint256 wealthGained);
  ...
  function terraform(uint256 _realmId, uint256 _feature) external {
    ...
    uint256 _wealthGained = _random(wealth[_realmId], 10**4);
    ...
    emit Terraform(_realmId, _newFeatureId, _wealthGained);
  }
