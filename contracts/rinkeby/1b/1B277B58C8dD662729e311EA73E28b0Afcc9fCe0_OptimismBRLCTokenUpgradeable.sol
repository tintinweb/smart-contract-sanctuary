...
import { IL2StandardERC20 } from "./eth-optimism-contracts/IL2StandardERC20.sol";
import { BRLCTokenUpgradeable } from "../core/upgradeable/BRLCTokenUpgradeable.sol";

/**
 * @title OptimismBRLCTokenUpgradeable
 * @dev An OptimismBRLCTokenUpgradeable is an ERC20 implementation which represents L1 asset deposited into L2,
 * minting and burning on deposits and withdrawals.
 *
 * `OptimismBRLCTokenUpgradeable` implements the IL2StandardERC20 interface provided by optimism to link into
 * a standard L1 deposit contract while using the `ERC20`implementation I as a developer want to use.
 *
 * Compiler used: optimistic-solc
 * Runtime target: OVM
 */
contract OptimismBRLCTokenUpgradeable is BRLCTokenUpgradeable, IL2StandardERC20 {
    ...
    function initialize(
        ...
        __OptimismBRLCTokenUpgradeable_init(l2Bridge_, l1Token_, name_, symbol_, decimals_);
    }

    function __OptimismBRLCTokenUpgradeable_init(
        address l2Bridge_,
        address l1Token_,
        string memory name_,
        string memory symbol_,
        ...
        __OptimismBRLCTokenUpgradeable_init_unchained(l2Bridge_, l1Token_);
    }

    function __OptimismBRLCTokenUpgradeable_init_unchained(address l2Bridge_, address l1Token_) internal initializer {
        l2Bridge = l2Bridge_;
        l1Token = l1Token_;
    }

    modifier onlyL2Bridge {
        require(l2Bridge == _msgSender(), "Only L2 Bridge can mint and burn");
        _;
    }
    ...
    function mint(address to, uint256 amount) public override onlyL2Bridge {
        _mint(to, amount);
        emit Mint(to, amount);
    }

    function burn(address from, uint256 amount) public override onlyL2Bridge {
        _burn(from, amount);
...
/**
 * @dev Source: @eth-optimism/contracts/libraries/standards/IL2StandardERC20.sol
 */
interface IL2StandardERC20 is IERC20Upgradeable, IERC165Upgradeable {
...
abstract contract BRLCTokenUpgradeable is RescuableUpgradeable, PausableExUpgradeable, BlacklistableUpgradeable, ERC20Upgradeable {
