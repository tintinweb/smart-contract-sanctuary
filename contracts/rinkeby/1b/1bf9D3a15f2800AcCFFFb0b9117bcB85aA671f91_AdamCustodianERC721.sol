...
contract AdamCustodianERC721 is AccessControl, AccessControlInitializer, ERC721Receiver, ReturnIncorrectERC20, ReturnIncorrectERC721 {
    ...
    function callERC721SafeTransferFrom(IERC721 erc721, address to, uint256 tokenId, bytes memory data) public virtual {
        require(hasRole(TRANSFER_CALLER_ROLE, _msgSender()), "AdamCustodianERC721: must have TRANSFER_CALLER_ROLE for callERC721SafeTransferFrom");
