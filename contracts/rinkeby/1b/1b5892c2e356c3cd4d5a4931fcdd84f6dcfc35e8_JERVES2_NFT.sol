...
pragma solidity ^0.8.0;
contract JERVES2_NFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    uint256 public constant TOKENS_PUBLIC = 10000;
	uint256 public constant TOKENS_PUBLIC_PRESALE = 100;
    uint256 public constant maxSupply = 10000;
    uint256 public constant PURCHASE_LIMIT = 10;
	uint256 public constant PURCHASE_LIMIT_PRESALE = 1;
    ...
    constructor() ERC721("JERVES2_NFT", "J2NFT") {
	...
	function purchasePresale(uint256 numberOfTokens) external payable nonReentrant {
        ...
        require(
            _publicTotalTokens.current() < TOKENS_PUBLIC_PRESALE,
            "Purchase would exceed TOKENS_PUBLIC_PRESALE"
        );
        require(
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (_publicTotalTokens.current() < TOKENS_PUBLIC_PRESALE) {
                _publicTotalTokens.increment();
                _safeMint(msg.sender, tokenId);
            }
        }
