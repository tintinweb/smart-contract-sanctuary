...
contract Escrow is Migratable {
    ...
    returns (uint256) {
        ...
        uint256 paprPrice = IPapr(paprgov).getPaprPrice();
        //uint256 totalPayoutPAPR = ERC20(paprgov).balanceOf(address(this));
        escrows[_escrowId].amount = ERC20(paprgov).balanceOf(address(this));
