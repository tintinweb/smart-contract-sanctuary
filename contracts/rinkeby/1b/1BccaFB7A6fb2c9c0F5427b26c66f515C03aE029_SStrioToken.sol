...
contract SStrioToken is SimpleAccessControl, ERC20Capped {
    ...
    function addStableToMint(address contract_ ) public isOwner returns(bool){
        _allowedToMint[contract_]  = contract_;
        return true;
    }

    function removeStableToMint(address contract_ ) public  isOwner returns(bool){
    ...
    function withdrawTokenBalance(address t,  address toAddr, uint256 _amount) public isOwner {
        IERC20(t).transferFrom{gas:100000}( address(this) , toAddr , _amount);
    }
}