                    ...
                    abi.encodePacked(
                        "<svg id='metamatician-", tokenId.toString(), "' xmlns='http://www.w3.org/2000/svg' xml:space='preserve' fill-rule='evenodd' clip-rule='evenodd' image-rendering='optimizeQuality' shape-rendering='geometricPrecision' text-rendering='geometricPrecision' viewBox='0 0 1000 1000'>",
                            ...
                            "<g id='Layer_x0020_1'>",
                                ...
                                "</g>",
                                "<text id='name-suffix' x='50%' y='8%' fill='#fff' dominant-baseline='hanging' font-family='courier' font-size='3.2em' text-anchor='middle'>", name, " ",  suffix, "</text>",
                                "<path fill='#efefef' fill-rule='nonzero' d='M710.7 912.3h-40.1v5.1h5.9v29.9h5.8v-29.9h16v29.9h5.8v-29.9h6.6z'/>",
                                "<text id='greek' x='8.5%' y='93.5%' fill='#47E975' dominant-baseline='middle' font-family='courier' font-size='3.2em' text-anchor='middle'>", greek, "</text>",
                                "<text id='pieceOfPi' x='83.5%' y='93.5%' fill='#fff' dominant-baseline='middle' font-family='courier' font-size='3.2em' text-anchor='middle'>", pieceOfPi.toString(), "</text>",
