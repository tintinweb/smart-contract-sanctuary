 ...
 */
 ...
 contract SSTReseller is Ownable {
     ...
     uint8[] public REFERRAL_PERCENTS = [10, 7, 7, 8, 8];
     uint8 public FEE_PERCENT = 10;
     ...
     address public boss1 = 0xBE28F06AB35605e8Feb5e0DA8Ef21BcE5F556dDb;
     address public boss2 = 0x8d9De56881709300255bf953dF569F6Ea08A62A9;
     address public boss3 = 0xF7DC616C58A7e4e1Adf547dBA6f65a052d95cD3C;
     address public boss4 = 0x2d35e8C931BefB9FDC3D5ECF759A9d4A81eF23F3;
     ...
     function setRefBonus(uint8 level1, uint8 level2, uint8 level3, uint8 level4, uint8 level5) public {
         ...
         REFERRAL_PERCENTS[0] = level1;
         REFERRAL_PERCENTS[1] = level2;
         REFERRAL_PERCENTS[2] = level3;
         REFERRAL_PERCENTS[3] = level4;
         REFERRAL_PERCENTS[4] = level5;
