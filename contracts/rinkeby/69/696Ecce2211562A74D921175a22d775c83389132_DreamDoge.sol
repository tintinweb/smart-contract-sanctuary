...
contract DreamDoge is ERC721Enumerable, Ownable {
    ...
    uint256 private _total = 100;
    uint256 private _price = 0.005 ether;
    bool public _paused = false;

    address t1 = 0xebD7acd94e7BB776D9cDEd73D42d2eaA2A57Aa64;
    address t2 = 0x451Bcf0e43A3FF2C68CeA57006c22C5fc8968D39; 
    ...
    function adopt(uint256 num) public payable {
        ...
        require( supply + num < _total - _reserved,      "Exceeds maximum Shibas supply" );
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Exceeds reserved Doges supply" );
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(payable(t1).send(_percent * 30));
        require(payable(t2).send(_percent * 70));
    }
}