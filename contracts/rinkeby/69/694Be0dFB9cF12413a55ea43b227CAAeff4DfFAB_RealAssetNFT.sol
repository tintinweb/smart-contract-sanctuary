    ...
    ReentrancyGuard
{
    ...
    uint256 public immutable maxTokenPerMint; //Maximum No of token can be purchased by user in single tx in public sale.
    ...
    address private signerAddress = 0x9A391E6b53C56B7622CA3ee9f07d10535504987f;
    ...
    //MaxTokenPerMint 5 tokens
    //MaxSupply 8888
    constructor(address _vrfCoordinator, address _link , bytes32 _keyHash , string memory _metadataBaseUri , uint256 _mintCost , uint256 _maxSuppply,uint256 _preSaleStartTime ,uint256 _preSaleDuration,uint256 _maxTokenPerMint)
    ...
    { 
        ...
        require(_maxTokenPerMint > 0,"Maximum no of tokens minted in single tx must be greater then zero");
    ...
    function mint(uint256 tokenQuantity) external nonReentrant() payable saleNotEnded saleStarted preSaleEnded {
        ...
        require(tokenQuantity <= maxTokenPerMint, "Limit exceed to purchase in signle mint");
