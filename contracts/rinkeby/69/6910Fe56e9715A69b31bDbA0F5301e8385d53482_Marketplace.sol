...
import { IBundleMarketplace } from "./interfaces/IBundleMarketplace.sol";
import { INFTFactory } from "./interfaces/INFTFactory.sol";
import { ITokenRegistry } from "./interfaces/ITokenRegistry.sol";
import { IPriceFeed } from "./interfaces/IPriceFeed.sol";

/* 
    Contracts coming from Artion.
    Proxy contract : https://ftmscan.com/token/0xa06aecbb8cd9328667f8e05f288e5b3ac1cff852#readProxyContract
    Bundle implementation: https://ftmscan.com/address/0xeebc1628e4d512de9f03a1b489ef80a17845c392#code
    Address contract: https://ftmscan.com/address/0xf5418f4c04c99d100ce1211338c9582b00dd2859#code
    Marketplace contract: https://ftmscan.com/address/0xa15b1f79652999940c10c51cad1036f0fff6a925#code

    MODIFICATIONS: 
    - Removing the Proxy architecture
    - Removing the `initialize()` function and adding the parameters in the constructor
    - Removing the `getPrice` function
    - Removing the addresses and adding weth, dai and usdc in the storage
    - Removing the bundle listing
        * Change IBundleMarketplace(addressRegistry.bundleMarketplace()).validateItemSold(_nftAddress, _tokenId, listedItem.quantity); in `buyItems` and `acceptOffre` into 
    - Removing the `isFantomNFT()` function
    - Removing the auction in the `createOffer` function
*/
...
contract Marketplace is Ownable, ReentrancyGuard {
    ...
    function registerRoyalty(
        ...
        minters[_nftAddress][_tokenId] = _feeReceipient;
...
contract WETH is ERC20 {
    constructor(uint256 _totalSupply) ERC20("Wrapped Ether", "WETH") public {
...
contract ERC1155NFT is ERC1155 {
    constructor () ERC1155("osef") public {}
...
contract ERC721NFT is ERC721 {
    constructor () ERC721("Test NFT", "TNFT") public {}
