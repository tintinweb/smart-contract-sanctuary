...
contract TestTestTest is ERC721Enumerable, Ownable {
    ...
    function speedUpParentRelease(
        ...
        _addressToBreedingEvents[msg.sender][thisBreedingEventIndex].releaseBlock = newReleaseBlock;
        ...
        public
    {
        ...
        if(blocksToRemove > _tokenToIncubator[_tokenId].revealBlock){
            ...
            newRevealBlock = _tokenToIncubator[_tokenId].revealBlock - blocksToRemove;
        }
