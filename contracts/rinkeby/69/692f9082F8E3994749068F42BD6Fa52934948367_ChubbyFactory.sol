...
contract ChubbyFactory is FactoryERC721, Ownable {
    ...
    /*
     * Number of options for minting ChubbyPops.
     */
    uint256 NUM_OPTIONS = 10;
    uint256 LIMIT_PER_OWNER = 32;
    ...
    function canMint(uint256 optionId_) override public view returns (bool) {
        ...
        uint256 tokenCount = ownerTokens[msg.sender];
        if ((tokenCount + mintAmount) > LIMIT_PER_OWNER) {
            return false;
        }
...
contract ChubbyPops is ERC721Tradable {
    constructor(address proxyRegistryAddress_) ERC721Tradable("Chubby Pops", "CHIP", proxyRegistryAddress_) {}
