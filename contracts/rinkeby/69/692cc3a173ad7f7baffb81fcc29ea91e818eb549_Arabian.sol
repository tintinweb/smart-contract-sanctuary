...
contract Arabian is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string private _baseURIextended = "https://gateway.pinata.cloud/ipfs/QmbnKjANHCSJNpBUPtJC3HELN6fByPM4UswMnKepUoxYQd/";
    uint256 private _priceextended = 130000000000000000;
    ...
    constructor() ERC721("META ARABS", "$MAB") {
    }
