...
contract EverWeapons is ERC721Enumerable, Pausable {
    ...
    address private constant USDT = 0x1A4Ac8BE0db15CE588226444d1df76514FF3cB83;
    ...
    event StaffMinted(address _to, uint256 _amount);

    constructor (uint256 _price) ERC721("EverWeapons", "EVEWEAPONS") {
        price = _price;
    ...
    function mint (uint256 _amount) public whenNotPaused {
        ...
        require(_amount > 0, "EverWeapons_Mint: Can't mint 0 staffs.");
        ...
        uint256 owedPrice = price * _amount;
        require(IERC20(USDT).balanceOf(msg.sender) > owedPrice, "EverWeapons_Mint: Insufficient USDT");
        
        IERC20(USDT).transferFrom(msg.sender, owner(), owedPrice);
        ...
        emit StaffMinted(msg.sender, _amount);
    }
    ...
    //     require(balance > 0, "EverWeapons_Withdraw: No balance in contract");

    //     _widthdraw(owner(), balance);
    // }

    // function _widthdraw(address _address, uint256 _amount) private {
    //     IERC20(USDT).transferFrom(address(this), _address, _amount);
    // }
