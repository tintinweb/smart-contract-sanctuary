    ...
    Pausable
{
    ...
    function changeStakingAddress(address _stakingDestinationAddress)
        public
        onlyOwner
    {
        stakingDestinationAddress = _stakingDestinationAddress;
    ...
    function changeRewardAddress(address rewardAddress) public onlyOwner {
    ...
    modifier onlyCertificate() {
        require(
            stakingDestinationAddress == _msgSender(),
