...
import {IUniswapV2Router02,IUniswapV2Factory} from  "./UniSwapCommon.sol";

contract SquidPieces is Context,Ownable{
    ...
    string public constant name = "SquidPieces";
    string public constant symbol = "SquidPieces";
    ...
    uint constant TOTAL = 800_000_000 * 10 ** 18;
    uint public _maxTxAmount =  8_000_000 * 10 ** 18;//1% * total
    ...
    event SwapAndCharged(uint256 token, uint256 liquidAmount, uint256 bnbLiquidity);
    ...
    constructor() {
        // Test Net
        IUniswapV2Router02 _uniswapV2Router02 = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        //Mian Net
        // IUniswapV2Router02 _uniswapV2Router02 = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router02.factory())
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        _balances[address(this)] = _balances[address(this)] + amount - tTransferAmount;
    ...
    function init(address rewardPool,address dev, address funds,address other) public onlyOwner{
