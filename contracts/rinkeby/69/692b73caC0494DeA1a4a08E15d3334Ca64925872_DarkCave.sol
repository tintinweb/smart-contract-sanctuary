...
contract DarkCave is OwnableUpgradeable, IERC721ReceiverUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function addManyToCave(address account, uint16[] calldata tokenIds) external blockExternalContracts nonReentrant {   
  ...
  function _addKnightsToCave(address account, uint256 tokenId) private whenNotPaused _updateEarnings {
  ...
  function _sendDragonsHunting(address account, uint256 tokenId) private {
  ...
  function calculateReward(uint16[] calldata tokenIds) public view blockExternalContracts returns (uint256 owed) {
