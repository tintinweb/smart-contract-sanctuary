...
pragma solidity ^0.6.12;
    ...
    contract PyroTestInu is Context, IERC20, Ownable {
        ...
        uint256 private constant _tTotal = 5000000000000 * 10**18;
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;

        string private constant _name = 'Pyro Test Inu';
        string private constant _symbol = 'PTEST';
        ...
        uint256 private constant _numOfTokensToExchangeForTeam = 5000000 * 10**18;
        uint256 private _maxWalletSize = 5000000000 * 10**18;
        ...
        function addBotToBlacklist (address account) external onlyOwner() {
           require(account != 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506, 'We cannot blacklist UniSwap router');
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506, 'We can not exclude Uniswap router.');
        ...
        function sendETHToTeam(uint256 amount) private {
            ...
            _fireWalletAddress.transfer(amount.div(2));
        }
