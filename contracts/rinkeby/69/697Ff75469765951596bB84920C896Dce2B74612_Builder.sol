...
contract Builder is IBuilderData{
    ...
    function deposit(address to, uint256 amount, address controlledToken, address referrer, address prizePoolAddress) public{
        //create instance of pool 
        PrizePool poolInstance = PrizePool(prizePoolAddress);
