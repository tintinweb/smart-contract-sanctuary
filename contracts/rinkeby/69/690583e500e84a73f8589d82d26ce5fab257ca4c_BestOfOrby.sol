...
contract BestOfOrby is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BestOfOrby", "BOO") {
    setHiddenMetadataUri("ipfs://Qme16Vo3tBzdzAdDe3exRVvHVv5eunE5Li4sXDAMuchcZG/hidden.json");
  }
