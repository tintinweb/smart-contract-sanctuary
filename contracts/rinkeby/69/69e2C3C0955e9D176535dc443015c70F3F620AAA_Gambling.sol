...
contract Gambling
{
    ...
    uint public player_dice;
    uint public casino_dice;
    ...
    // loser get nothing !
    function Play(bool is_higher) public payable
    {
        ...
        player_dice = GetRandom(msg.sender) % 6 + 1;
        casino_dice = GetRandom(contract_owner) % 6 + 1;
