...
contract FortuneTigers is ERC721, Ownable {
  ...
  function contractURI() public pure returns (string memory) {
    string memory contractmeta = string(
      abi.encodePacked(
        '{"name": "Fortune Tigers 2022", "description": "Welcome the Year of the Tiger 2022 with your very own Fortune Tiger! Time to get Lucky with your very own fortune and lucky set of numbers!", "seller_fee_basis_points": 100, "fee_recipient": "0x0F0B154Aff44B2701874DEb88c48FD60DF49cf57"}'
      )
    );
  ...
  function tokenURI(uint256 tokenId) public view override(ERC721) returns (string memory) {
    ...
    //QmepFr4wZ7GkHkrsTvmHpFkg48wDKoe9ch4iAfKrUJ8Se1
    string memory imgfile = string(abi.encodePacked(_imgURI, tokenId.toString(), ".png"));
    string memory metadata = string(
      abi.encodePacked(
        '{"name": Fortune Tiger #',
        tokenId.toString(),
        '", "description": "Welcome the Year of the Tiger 2022 with your very own Fortune Tiger! Time to get Lucky with your very own fortune and lucky set of numbers!", "image":"',
        imgfile,
        '"}'
      )
    );
