...
contract CryptoButlers is ERC721, AccessControl, Ownable {
    ...
    uint256 private _maxSupply = 888;
    uint256 private _ethPrice = 0.06 * 10 ** 18;
    uint256 private _maxMint = 20;
    uint256 private _saleStart = 16392475; //test
    uint256 private _whitelistSaleStart = 16392475;
    ...
    function setDefaultURI(string memory defaultURI_) public onlyRole(MINTER_ROLE) {
