 ...
 * @notice This contract provides minting for Adorable Aliens NFT by twitter.com/
 */
contract AdorableAliens is NPassCore {
    ...
    uint256 public constant M_PERCENT_CUT = 15;
    uint256 public constant A_PERCENT_CUT = 43;
    uint256 public constant I_PERCENT_CUT = 42;

    address public constant mAddress = 0x459176f62188A95FF99A12DB9ED1D635472e0216;
    address public constant aAddress = 0x7C45Fc2C517BB6dDea0eaeA9302e5f62C9B645Cf;
    address public constant iAddress = 0x558cc0273e98AFb65a18D1B8Ad55ba0e3D23BdBf;

    string public baseTokenURI = "ipfs://TBD/";
    ...
    function mintWithN() public payable virtual nonReentrant {
        ...
        require(n.balanceOf(msg.sender) > 0, "NPass:INVALID_OWNER");
