...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    // Used for mapping needed for transfering tokens to multiple addresses
    uint[] private _idarray;
    uint[] private _amountarray;
    ...
    function sendToMany(
        ...
        safeBatchTransferFrom(from, to[i], _idarray, _amountarray, data);
        emit TransferBatch(operator, from, to[i], _idarray, _amountarray);
         }
    }
