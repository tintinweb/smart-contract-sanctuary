...
contract PUGLIFE is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    uint256 public minTokensToAddToLiquidity = 10000 * 10**18;
    ...
    function setMinTokensToAddToLiquidity(uint256 _minTokensToAddToLiquidity) external onlyOwner {
        require(_minTokensToAddToLiquidity > 0, "Amount cant be zero");
        minTokensToAddToLiquidity = _minTokensToAddToLiquidity;
    }
    ...
    function _swapAndLiquify(address from) private {
        ...
        bool overMinTokenBalance = contractTokenBalance >= minTokensToAddToLiquidity;
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            from != uniswapV2Pair &&
            ...
            contractTokenBalance = minTokensToAddToLiquidity;
            //add liquidity
