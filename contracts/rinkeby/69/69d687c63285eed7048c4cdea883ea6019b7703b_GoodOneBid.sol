...
contract GoodOneBid is Ownable, Pausable, GoodOneBidStorage {
    ...
    */
        ...
        ) 
    {
        ...
        (bidId, bidder, price, expiresAt) = getBid(_tokenAddress, _tokenId, bidIndex);
        if (_bidder != bidder) {
    ...
    */
    function getBid(address _tokenAddress, uint256 _tokenId, uint256 _index) 
        public 
        view
    ...
    */
    function setInflationCollector(address _inflationCollector) external onlyOwner {
        require(_inflationCollector != address(0), "ERC20: address can't be the zero address");
