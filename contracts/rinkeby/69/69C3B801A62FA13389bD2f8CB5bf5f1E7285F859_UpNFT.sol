...
contract UpNFT is Initializable, UUPSUpgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    mapping(uint256 => CountersUpgradeable.Counter) private _yearlyCounts;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        for(uint256 i = 0; i < tokenId*10000; i++) {
        ...
        output = string(abi.encodePacked(output, parts[31], parts[32], parts[33], parts[34], parts[35], parts[36], parts[37], parts[38]));
...
library Colors {
  ...
  function fromSeedWithMinMax(string memory seed, uint256 hMin, uint256 hMax, uint256 sMin, uint256 sMax, uint256 lMin, uint256 lMax) internal pure returns (Color memory) {
    return
      Color(
  ...
  function valueFromSeed(string memory seed, uint256 from, uint256 to) internal pure returns (uint256) {
