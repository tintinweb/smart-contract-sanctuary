...
contract FlipCoins is ERC1155Supply, Ownable, VRFConsumerBase {
    ...
    address private constant LINK_TOKEN = 0x01BE23585060835E02B77ef475b0Cc51aA1e0709; // Rinkeby LINK token contract
    address private constant CHAINLINK_VRF = 0xb3dCcb4Cf7a26f6cf6B120Cf5A73875B7BBc655B; // Rinkeby Chainlink VRF Coordinator
    bytes32 private constant CHAINLINK_VRF_KEYHASH = 0x2ed0feb3e7fd2022120aa84fab1945545a9f2ffc9076fd6156fa96eaff4c1311; // Rinkeby Chainlink VRF Key Hash
    uint256 private constant CHAINLINK_VRF_FEE = 0.1 * 10 ** 18; // Rinkeby Chainlink VRF fee = 0.1 LINK
