...
contract ScorpioNFT is IScorpioNFT, ERC721 {
    ...
    mapping(uint => uint) public projectIdToBurnedAmount; 
    ...
    */
    constructor(
        ...
        console.log("Created token %s with symbol %s", name_, symbol_);
    }
    ...
    function burn(uint256 tokenId, uint256 projectId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId));
        _burn(tokenId);
        projectIdToBurnedAmount[projectId] +=  1; 
        // currentSupply[projectId] = tokenId - 1;
    }
    ...
    function tokenURI(uint tokenId_) public view override returns (string memory) {
        ...
        console.log(_tokenURIs[tokenId_]);
        return string(abi.encodePacked(_baseURIs[projectId],"/", tokenId.toString(),".json"));
    }
    ...
    */
    ...
    function mint(uint projectId_, address to_) external payable override returns (uint tokenId_) {
        ...
        // require(projectToCurrentTokenId[projectId].add(projectToCurrentBurns[projectId]) < projectToMaxTokenId[projectId])
        ...
        // console.log("projectId_:", projectId_);
        _mint(to_, tokenId_);
        _incrementTokenId(projectId_);
        ...
        // currentSupply[projectId_] = tokenId_;
        // update proceeds
    ...
    // function sendViaCall(address payable _to) payable public returns (uint balance_){
    //     // Call returns a boolean value indicating success or failure.
    //     // This is the current recommended method to use.
    //     (bool sent, bytes memory data) = _to.call{value: 1}("");
    //     require(sent, "Failed to send Ether");
    //     address myAddress = address(this);
    //     require(msg.value == 1, "addy different");
    //     return balance_;
    // }
}
