...
contract PunkSticks is ERC721, Ownable, VerifySignature{
    uint256 public totalMinted = 0;
    uint256 private constant totalSupply = 10;
    uint256 public totalReserved = 2;
    uint256 public mintingPrice = 3 * 10 ** 16;
    string baseUri = "ipfs://QmSyubwjz6jUuYJ9wQN8P3YPsYvSUAwwZ8aBMUUu6DFmw4/"; 
    ...
    function mintByOwner(address _to, uint256 mintQuantity) public onlyOwner {
      require(totalMinted + mintQuantity <= totalSupply - totalReserved, "Maximum Minting Limit Reached,  Try Adjusting your quantity");
