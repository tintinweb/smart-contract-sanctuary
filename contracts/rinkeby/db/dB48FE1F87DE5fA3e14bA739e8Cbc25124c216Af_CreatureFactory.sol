...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    /*
     * Enforce the existence of only 3333 OpenSea creatures.
     */
    uint256 CREATURE_SUPPLY = 3333;
    ...
    function ownerOf(uint256 _tokenId) public view returns (address _owner) {
        if(_tokenId >= 0 && _tokenId < CREATURE_SUPPLY)
            return owner();
        else
            return nftAddress;
    }
...
contract Creature is ERC721Tradable {
    ...
    string public _baseTokenURI = "https://avatachi.github.io/AvaTachi/api/metadata/";
    string public _contractURI = "";
    address private _creator;

    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Creature", "G4GT", _proxyRegistryAddress)
    {
        _creator=msg.sender;
    }
    ...
    function changeBaseTokenURI(string memory _uri) public {
        require(creator() == _msgSender(), "NFT: caller is not the creator");
        _baseTokenURI=_uri;
    }

    function changeContractURI(string memory _uri) public {
        require(creator() == _msgSender(), "NFT: caller is not the creator");
        _contractURI=_uri;
    }
