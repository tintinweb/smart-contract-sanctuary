...
contract MasterERC1155 is Initializable, GroupOwnerUpgradeable {
  Dictionary private config;
  IMasterERC1155 private iMasterERC1155;
  ListAddressContract private cAddress;
  address payable public owner_;
  mapping(address => uint256) private balances;

  function initialize(address configFee, address _cAddress) public initializer {
  ...
  function createTokenERC1155(
    ...
    iMasterERC1155 = IMasterERC1155(s);
    iMasterERC1155.createERC1155(name, symbol, amount, metadata);
