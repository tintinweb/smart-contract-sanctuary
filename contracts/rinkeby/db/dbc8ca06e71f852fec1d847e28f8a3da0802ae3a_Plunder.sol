...
contract Plunder is ERC721, Ownable {

    uint public mintPrice = 0; // Mutable by owner
    uint public maxItems = 5000;
    uint public totalSupply = 0;
    uint public maxItemsPerTx = 1; // Mutable by owner
    string public _baseTokenURI;
    bool public publicMintPaused = false;
    uint public startTimestamp = 1632258000; // Tuesday, September 21, 2021 22:00 UTC

    event Mint(address indexed owner, uint indexed tokenId);

    constructor() ERC721("Plodding Pirate Plunder", "Plunder") {}
