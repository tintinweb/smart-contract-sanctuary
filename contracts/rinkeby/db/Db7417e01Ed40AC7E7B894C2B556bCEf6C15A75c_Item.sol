...
contract Item is ERC1155, ERC721Holder, ERC1155Holder, ItemComponents, MaterialMetadata {
    ...
    IERC721 recipe = IERC721(0xdfEdB400f430DBE2D0c31D26F6B2c14b5d38d07C);
    RecipeInterface recipeContract = RecipeInterface(0xdfEdB400f430DBE2D0c31D26F6B2c14b5d38d07C);
    IERC1155 materialBagItems = IERC1155(0x3225C3191A87dAFfFE903AD825Db8F2Dfa4040A0);
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 16px; }</style><rect width="100%" height="100%" fill="black" /><text x="50%" y="50%" class="base">';
