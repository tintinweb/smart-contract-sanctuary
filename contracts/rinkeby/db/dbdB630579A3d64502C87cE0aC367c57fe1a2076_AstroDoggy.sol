...
contract AstroDoggy is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100_000_000_00 * 10**9;
    ...
    address payable private _marketingWalletAddress = payable(0x0797D08b470579e1F754cD055D7FF82902a3EFE2);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 10000000 * 10**9;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xf164fC0Ec4E93095b804a4795bBe1e041497b92a); // UniswapV2 for Ethereum network
    ...
    function excludeFromReward(address account) external onlyOwner() {
        require(account != 0xf164fC0Ec4E93095b804a4795bBe1e041497b92a, 'We can not exclude Uniswap router.');
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0xf164fC0Ec4E93095b804a4795bBe1e041497b92a, 'We can not blacklist Uniswap router.');
