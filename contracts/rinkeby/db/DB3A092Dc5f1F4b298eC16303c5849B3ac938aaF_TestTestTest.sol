...
contract TestTestTest is ERC721Enumerable, Ownable {
    ...
    function speedUpParentRelease(
        ...
        _addressToBreedingEvents[msg.sender][_breedingEventIndex]
        ...
        public
    {
        ...
        if (_breedingEventIndex >= _addressToBreedingEvents[msg.sender].length)
            return;

        for (
            uint256 i = _breedingEventIndex;
