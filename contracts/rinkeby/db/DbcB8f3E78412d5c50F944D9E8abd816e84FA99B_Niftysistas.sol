...
contract Niftysistas is ERC721, Ownable, Pausable {
    ...
    uint[] private lowerBounds = [881, 862, 824, 647, 304, 184, 142, 100, 785, 680, 494, 443, 247];
    uint[] private upperBounds = [899, 880, 861, 679, 442, 246, 183, 141, 823, 784, 646, 493, 303];
    ...
    function detachTrait(uint sistaid, uint[] memory traitsToDetach, bool burn) external {
        ...
        for (uint i=0; i < traitsToDetach.length; i++) {
            ...
            require(containsTrait(sistaid, traitsToDetach[i]), "trait not found");
