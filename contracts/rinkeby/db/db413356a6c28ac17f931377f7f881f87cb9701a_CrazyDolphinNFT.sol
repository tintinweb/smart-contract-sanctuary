...
contract CrazyDolphinNFT is ERC721, Ownable {
    ...
    uint256 public constant bananaPrice = 44000000000000000; // 0.044 ETH

    uint public constant maxBananaPurchase = 30;

    uint256 public constant MAX_BANANAS = 4444;
    ...
    constructor() ERC721("Crazy Dolphin NFT", "DOLPHIN") { }
