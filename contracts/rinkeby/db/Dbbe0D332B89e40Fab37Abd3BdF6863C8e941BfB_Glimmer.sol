...
contract Glimmer is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[6] = ' week(s)</text><text x="20" y="90" class="base">Sigil - ';

        parts[7] = getWaist(tokenId);

        parts[8] = '</text><text x="20" y="110" class="base">Affinity - ';
        ...
        parts[16] = '</text><text x="135" y="275" class="base" style="font-size: 10px; letter-spacing: 1.5; fill: purple">The Alchemist\'s</text><text x="120" y="300" class="base" style="font-size: 20px; letter-spacing: 5;">GLIMMER</text></svg>';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Object #', toString(tokenId), '", "description": "houseofmagnus.com", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
