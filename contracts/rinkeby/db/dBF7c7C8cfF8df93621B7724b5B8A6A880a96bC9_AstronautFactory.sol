...
contract AstronautFactory is FactoryERC1155, Ownable, ReentrancyGuard {
    ...
    string public constant name = "Happy Astronauts Game";
    

    string public constant symbol = "HATSF";
    ...
    function setOption(
        address to, uint256 option_id, uint256 quantity) public onlyOwnerOrMaster {
        address operator = _msgSender();

        emit TransferSingle(operator, address(0), to, option_id, quantity);
    }
