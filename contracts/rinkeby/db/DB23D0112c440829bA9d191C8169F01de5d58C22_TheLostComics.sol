...
// Latest deployment to rinkeby: 0xdC8AF91f80ED65eAA813004f107ff64e2F87b355
contract TheLostComics is ERC721, ERC721Enumerable, Ownable {
    ...
    function glitchOwnerTest() public view returns (uint amount) {
      return tlg.tokensOfOwner(msg.sender).length;
    }
