    ...
    PausableUpgradeable
{
    ...
    function initialize(BorrowToken _bToken, LenderToken _lToken)
        public
        initializer
    {
        __Ownable_init();
    ...
    function addWhiteList(address _address) external whenNotPaused onlyOwner {
     ...
     */
    function lend(uint256 _bTokenId) external whenNotPaused {
        NFT storage _nft = NftMap[_bTokenId];
        require(!_nft.marks.isBorrow, "This collateral already borrowed");
