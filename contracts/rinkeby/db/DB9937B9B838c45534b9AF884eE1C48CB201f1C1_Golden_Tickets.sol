...
contract Golden_Tickets is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Golden Tickets", "GLD") {
      fee = 80000000000000000 wei; //0.08 ETH
      baseUri = "ipfs.io/ipfs/QmZn6dUmzwJrvCeLbMELMiGUKf6WSQYRrkYb3nbhGp9vZZ";
    }
    ...
    */
    function mint(address player, uint numberOfMints)
        ...
        returns (uint256)
    {
        require(_tokenIds.current() + numberOfMints <= 9900, "Maximum amount of Tickets already minted."); //10000 item cap (9900 public + 100 team mints)
