...
contract SalePlatform is AContinuousDutchAuction, AccessControlEnumerable, ReentrancyGuard {
    ...
    constructor(
        ...
        artistPercentage = 9000; //default 90% for artist
    }
    ...
    function payout(address artist, uint256 amount) internal {
        uint256 payout = (amount*artistPercentage)/10000;
        Address.sendValue(payable(artist), payout);
        Address.sendValue(quantumTreasury, amount - payout);
    }
