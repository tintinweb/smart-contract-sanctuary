...
import "../commons/Initializable.sol";
...
contract ERC721Bid is Initializable, Ownable, Pausable, ERC721BidStorage, NativeMetaTransaction {
    using SafeMathUpgradeable for uint256;
    using AddressUpgradeable for address;

    /**
    * @dev Initialize the contract.
    * @param _KMONCoin - address of the kmon token
    * @param _owner - address of the owner for the contract
    */
    function __ERC721Bid_init(address _KMONCoin, address _owner, uint256 _ownerCutPerMillion)
        public
        initializer
    {
        __Ownable_init();
        __Pausable_init();
         ...
         // EIP712 init
        _initializeEIP712('Kryptomon Bid', '1');
    ...
    */
        ...
        returns (bytes4)
    {
        ...
        // Transfer KMON from bidder to seller
        require(
            KMONCoin.transferFrom(bidder, _from, price.sub(saleShareAmount)),
            "Transfering KMON to owner failed"
        );
    ...
    * to use bidder KMON on his belhalf
    ...
    */
    function _requireBidderBalance(address _bidder, uint256 _amount) internal view {
        ...
        require(
            ...
            "The contract is not authorized to use KMON on bidder behalf"
        );
    }
}
