...
contract FuegoNFT is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("FuegoNFT", "FUEGO") {
    ...
    function updatePrice() public {
        if (!customPrice) {
            ...
            pricePublicSale = PRICE_PUBLIC_SALE - (timePassed / SECONDS_BETWEEN_TICK * PRICE_TICK);
            
            if (pricePublicSale < PRICE_FLOOR) {
                pricePublicSale = PRICE_FLOOR;
                customPrice = true;
            }
        }
    }
