...
contract FactoryMaster {
    ...
    event ChildCreatedERC20MintableCappable(address childAddress,uint256 cap_, string name, string symbol);
        ...
        if (types == Types.erc20Burn){
          ...
          if (types == Types.erc20Mintable){
           ...
           if (types == Types.erc20MintableCappable){
            ...
            emit ChildCreatedERC20MintableCappable(address(child),1000, name, symbol);
        }
