    ...
    ERC721URIStorage
{
    ...
    // bsc: 0xa555fC018435bef5A13C6c6870a9d4C11DEC329C
    address public LinkToken;
    // rinkeby: 0x01BE23585060835E02B77ef475b0Cc51aA1e0709
    // bsc: 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06
    // bsc keyHash: 0xcaf3c3727e033261d383b315559476f48034c13b18f8cafed4d871abe5049186
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    function safeTransferFromBatch(address from, address to, uint256[] memory tokenId, bytes[] memory _data) public virtual {
    ...
    function _safeTransferBatch(address from, address to, uint256[] memory tokenId, bytes[] memory _data) internal virtual {
        ...
        require(_checkOnERC721ReceivedBatch(from, to, tokenId, _data), "ERC721: transfer to non ERC721Receiver implementer");
    }
    ...
    function _checkOnERC721ReceivedBatch(address from, address to, uint256[] memory tokenId, bytes[] memory _data)
        private returns (bool)
    {
        if (to.isContract()) {
            try IERC721Receiver(to).onERC721ReceivedBatch(_msgSender(), from, tokenId, _data) returns (bytes4 retval) {
                return retval == IERC721Receiver(to).onERC721ReceivedBatch.selector;
            } catch (bytes memory reason) {
                if (reason.length == 0) {
                    revert("ERC721: transfer to non ERC721Receiver implementer");
                } else {
