 ...
 * Enumerable has been modified to not track tokenByIndex to save gas fees on minting.
 * Easely will keep track of this by reading the ERC721 mint events.
 */
 ...
 * enumerability all token ids owned by each account.
 *
 * Enumerable has been modified to not track tokenByIndex to save gas fees on minting.
 * Easely will keep track of this by reading the ERC721 mint events.
 */
...
contract ERC721StandardCollection is ERC721Marketplace {   
    ...
    function _init(
        ...
        /* Default to 5 minutes per price decrement */
