...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 public BAKED = IERC20(0xa0634742280470FD65c3514733be2B1C2E21DE15); // BAKED Token
    ...
    BAKED.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function getStakes(uint256 _stakeid) view public returns (uint256, uint256, uint256, address, bool,bool) {
        return (_stakeid,Stakemap[_stakeid].amount.div(10**18), Stakemap[_stakeid].timestamp, Stakemap[_stakeid].walletaddress,Stakemap[_stakeid].iswhitelisted,Stakemap[_stakeid].stakeStatus);
    }
...
contract BakedLpPool is LPTokenWrapper {
    ...
    function AllStakes() public view returns(uint256[] memory)
    {
        return toCheckList[msg.sender];
    }
