...
contract TestTestMulti is ERC721Enumerable, Ownable{
    ...
    address public constant devaAddress = 0xaB8e9D054a7Fe77e55733BA160C463bF083722eF;
    address public constant artaAddress = 0x0d585837d3Dd5F9A93bf5a96921aA635539a57dF;
    address public constant creatoraAddress = 0x86D039B55FcAaE4152dccFc3EdA46017eC58B0ec;
    ...
    constructor() ERC721("Test Test Multi","TTM"){
    }
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        uint256 devaShare = balance.mul(1).div(100);
        uint256 artaShare = balance.mul(49).div(100);
        uint256 creatoraShare = balance.mul(50).div(100);
        require(balance > 0);
        _withdraw(devaAddress, devaShare);
        _withdraw(artaAddress, artaShare);
        _withdraw(creatoraAddress, creatoraShare);
    }
