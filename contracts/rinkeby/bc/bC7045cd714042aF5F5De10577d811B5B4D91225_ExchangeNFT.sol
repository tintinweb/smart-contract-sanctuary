...
contract ExchangeNFT is ERC1155, Ownable, IERC1155Receiver, ReentrancyGuard {
    ...
    function exchangeNFT() public nonReentrant {
        IERC1155 nft = IERC1155(address(this));
        nft.safeTransferFrom(this.owner(), msg.sender, CITIZEN_NFT_ID, 1, "");
    }
}