...
/*
 * DiamondHandsProtocol DYOR 
 * Holders will be rewarded while sellers will be rekt
 * The burn rate reduces the longer this contract exists.
 * 
 * READ THIS CAREFULLY:
...
contract CAMPFIRE is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**9 * 10**9; // 15 Billion
    ...
    uint256 public _maxTxAmount = 3 * 10**9 * 10**9; // Max Transaction: 100 Million (0.6%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 3 * 10**9 * 10**9; // Max Wallet: 200 Million (1.3%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Campfire";
    string private _symbol = "CAMPFIRE";
