...
contract Vault is ERC1155 {
    constructor() ERC1155("http://ipfs/", "qwffff234gf345g345g") {}
    ...
    function mint(
        ...
        /** onlyOperator **/
        _mint(_receiver, _id, _amount, _uri);
    }
}
...
contract ERC1155 is ERC165, IERC1155, AccessControl {
    ...
    function _mint(
        ...
        _accounts[_receiver].balances[_id] += _amount;

        Token storage token = _tokens[_id];
