...
contract Printizen1155 is Ownable{
...
contract PrintizenMultiMint is Printizen1155{
    string public name;
    string public symbol;

    mapping (uint256 => string) private _tokenURIs;

    constructor(string memory _name, string memory _symbol) Printizen1155(name, symbol) public{
        name = _name;
        symbol = _symbol;
    }
}