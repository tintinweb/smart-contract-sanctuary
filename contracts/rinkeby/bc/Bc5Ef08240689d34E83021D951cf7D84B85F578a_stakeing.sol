...
contract stakeing is Ownable , IERC721Receiver,ReentrancyGuard{
    ...
    function deposit(uint256[] memory eyeStarIds,uint256 lockMod) external {
    ...
    function depositDouble(uint256[2][] memory eyeStarIds,uint256 lockMod) external {
    ...
    function claimAndWithdraw30() external  nonReentrant() {
        require(claimLive30, "claim_closed");
        require(hashrate30[msg.sender] > 0, "already extracted");
    }

    function claimAndWithdraw60() external  nonReentrant() {

        require(claimLive60, "claim_closed");
        require(hashrate60[msg.sender] > 0, "already extracted");
