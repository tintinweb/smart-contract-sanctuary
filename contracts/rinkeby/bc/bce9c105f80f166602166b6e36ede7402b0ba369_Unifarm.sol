...
contract TokenVesting is Ownable {
   ...
   */
  constructor(address _beneficiary, uint256 _start, uint256 _cliff, uint256 _duration, bool _revocable) Ownable(msg.sender) {
...
contract Unifarm is Ownable {
    ...
    function vestingAllocate(address _beneficiary, uint256 _start, uint256 _cliff, uint256 _duration, bool _revocable) public onlyOwner {
        address poolAddress;
        poolAddress = address(new TokenVesting(_beneficiary, _start, _cliff, _duration, _revocable));
