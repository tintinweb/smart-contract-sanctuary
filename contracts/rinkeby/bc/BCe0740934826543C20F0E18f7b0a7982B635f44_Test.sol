...
contract Test is ERC721, Ownable {
    ...
    function batchMint(address[] memory receivers, uint[] memory quantities) public onlyOwner {
    ...
    function burn(uint tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "sender is not approved nor owner");
        _burn(tokenId);
    }
