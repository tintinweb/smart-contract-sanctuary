...
contract LootCV is LootCVBase {
    ...
    function ownerClaim(uint256[] memory tokenIds) public onlyOwner {
        for (uint i = 0; i < tokenIds.length; i++) {
            require(tokenIds[i] > 7900 && tokenIds[i] <= 8000, "invalid tokenid");
    ...
    function claim(uint256 numTokens) public {
        ...
        require(totalSupply() + numTokens <= 7900, "sale over");
...
contract LootCVBase is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        work["lissan"] = Work([unicode"Papal Mage of Lissän", unicode"Crusader of Lissän", '"The Second Dragon Wars" +1', unicode'High Bishop, "Third Treatise of Länsän" +1'], ["High Troubadour of the Papacy","High Wandmaker to the Papacy"], unicode"Soldier of Lissän");
        work["inpen"] = Work(["Senate Premier of Inpen", "Commander of the Inpen United Forces", 'Veteran of the Inpen United Forces, "Siege of Parota" +1', "High Cabinet Member of Inpen"], ["Council Mage of Monlo","Council Mage of Kannin"], "Soldier of the Inpen United Forces");
        work["koyaro"] = Work(["Chancellor of Koyaro", 'General of the Koyaro Imperial Army, "Siege of Parota" +1','Koyaro Minister of Finance','Koyaro Minister of Defense'], ["Lieutenant of the Koyaro Imperial Army","Koyaro Defense Administrator"], "Recruit of the Koyaro Imperial Army");
        work["mage"] = Work(["Shaman of the Free Mages", unicode'Proletariat of the Free Mages, "Third Treatise of Länsän" +1','Military General of the Free Mages, "Siege of Parota" +1','Military General of the Free Mages'], ["Council Member of the Free Mages", "Delegate of the Free Mages"], "Military Volunteer of the Free Mages");
    }
    ...
    function pluckKingdom(uint256 tokenId) internal view returns (Kingdom memory) {
        ...
        if (rand % 10 <= 1) { //20%
            ...
            return Kingdom("inpen", "United Principality of Inpen", "#03261F");
        } else if (rand % 10 <= 8) { //30%
            return Kingdom("koyaro", "Royal Koyaro Empire", "#330606");
        } else { // 10%
            return Kingdom("mage", "Commune of Free Mages", "#082033"); 
        }
    }
