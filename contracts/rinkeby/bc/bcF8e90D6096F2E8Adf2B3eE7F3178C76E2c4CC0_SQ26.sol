...
contract SQ26 is Ownable, ERC721A, ReentrancyGuard {
    ...
    function mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable callerIsUser  {
        ...
        if (msg.sender != owner()) {
            ...
            if (sale == Sale.WHITELIST) {
                ...
                require(ownerMintedCount + _mintAmount <= maxMintWhitelist,"max mint amount exceeded");
                }  
                
                else { require(_mintAmount <= maxBatchSize, "Too many items minted");}
    ...
    // Token reserved for team or gifts
