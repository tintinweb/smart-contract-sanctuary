    ...
    ERC721
{
    ...
    uint MAX_SUPPLY = 5;
    uint MULTISIG_RESERVED = 2;
    uint256 PRICE = 1 * 10**15; // 0.333 ETH
    uint256 ROYALTY_PRICE = 1 * 10**13; // 3% of PRICE
    uint256 MULTISIG_PRICE = PRICE - ROYALTY_PRICE;
    address DRIBNET = 0x370433a205B84839B507420B8E22900BAb902a8b;
        ...
        private
    {
        ...
        require (msg.value >= PRICE || receiver == multisig, "must pay mint fee");
