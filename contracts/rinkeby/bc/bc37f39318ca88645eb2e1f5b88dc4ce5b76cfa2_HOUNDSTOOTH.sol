...
contract  HOUNDSTOOTH  is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory baseURI) ERC721("Hound Stooth", "HS")  {
        setBaseURI(baseURI);
    }
    ...
    function addNewCollection(string memory _artName,uint _quantity,string memory _subTitle,string memory _description)public onlyOwner
    {
    ...
    // function mint(uint chosenAmount) public onlyOwner {
    ...
    //         }
    // }
    function newCollectionMint(uint _tokenid) public onlyOwner{
