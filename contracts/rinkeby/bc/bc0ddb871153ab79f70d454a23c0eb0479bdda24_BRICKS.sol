...
contract BRICKS is Context, IERC20, IERC20Metadata, Ownable {
     ...
     */
    function setTeamAddress(address team_address) external virtual onlyOwner returns (bool){
     ...
     */
    function setDevelopmentAddress(address development_address) external virtual onlyOwner returns (bool){
     ...
     * @dev Set development address from the owner.
     */
    function setCommunityAddress(address community_address) external virtual onlyOwner returns (bool){
