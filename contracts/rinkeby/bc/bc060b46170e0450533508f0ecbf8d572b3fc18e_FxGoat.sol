...
contract FxGoat is AbstractERC1155Factory, PaymentSplitter  {

    uint256 constant MAX_SUPPLY = 1000;
  

    uint8 maxPerTx = 10;
    uint8 maxTxPublic = 10;
   

    uint256 public mintPrice = 10000000000000000;
    uint256 public cardIdToMint = 1;

    uint256 public purchaseWindowOpens    = 1643042559;
    ...
    */
    ...
    function uri() public pure  returns (string memory) {
            ...
            return string("https://gateway.pinata.cloud/ipfs/QmWx3iQjozSkwcGznATDTAVmWAekMVSnW6vin9ypDX1tgP");
    }
}