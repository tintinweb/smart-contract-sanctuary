...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
      ...
      address internal RVPToken = 0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD; //CHANGEME
    ...
    function distributeRVPDividends(uint256 amount) public {
        require (msg.sender == owner() || msg.sender == 0x03097BD940C5d7eE9E5cEA7990a1B48098259d49);
        require(totalSupply() > 0);
...
contract YUKONDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public  DividendPayingToken("YUKON_Dividend_Tracker", "YUKON_Dividend_Tracker") {
        ...
        excludedFromDividends[0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D] = true; //CHANGEME - swap pair address
    }
