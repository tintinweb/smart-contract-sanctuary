...
contract MoonOwlToken is Context, IBEP20, Ownable, ReentrancyGuard {
         ...
         if (sender != address(this) && liquidityAdded){
               ...
               forCharity = amount.div(100);
                    ...
                    if(balanceAfter > balanceBefore)
                        swapTokensForBNBForCharity(address(pancakeRouter), balanceAfter.sub(balanceBefore));
            }
         }
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        !(from == address(this) && to == address(pancakePair)) // swap 1 time
            ...
            _swapTokensForETH(address(pancakeRouter), tokenAmountToBeSwapped);
            ...
            _addLiquidity(address(pancakeRouter), owner(), otherPiece, bnbToBeAddedToLiquidity);
