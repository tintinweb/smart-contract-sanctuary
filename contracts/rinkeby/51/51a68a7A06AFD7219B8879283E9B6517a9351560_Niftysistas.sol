...
contract Niftysistas is ERC721, Ownable, Pausable {
    ...
    uint[] private lowerBounds = [838, 819, 814, 642, 305, 184, 141, 100, 775, 672, 495, 443, 249];
    uint[] private upperBounds = [856, 837, 818, 671, 442, 248, 183, 140, 813, 774, 641, 494, 304];
