...
contract TrialToken is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    uint public buyLimit = 20;
    uint public price = 0.00001 ether;
    string public uri = "https://gateway.pinata.cloud/ipfs/QmSjtfCrFhQxu1KhTYyPGNhoSHv1F1bKCJBSVbWDk4TucN/";

    constructor() 
    ERC721("Trial Token", "TRT") {}
    ...
    function _tokenMint(address to, uint32 quantity) public payable onlyOwner {
        if (_msgSender() != owner())
