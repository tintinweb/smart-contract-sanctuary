...
/**
 * @title My_Test_Contract
 * My_Test_Contract - a contract for my non-fungible creatures.
 */
contract My_Test_Contract is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("My_Test_Contract", "MTC", _proxyRegistryAddress)
    {}
	...
	function numberToMint(uint _numberToMint) public onlyOwner returns (uint) {
