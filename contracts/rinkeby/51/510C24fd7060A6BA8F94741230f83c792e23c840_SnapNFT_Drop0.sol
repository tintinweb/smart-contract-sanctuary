...
contract SnapNFT_Drop0 is ERC721URIStorage, ERC721Pausable, Ownable {
    ...
    constructor() ERC721("SNAP! NFT Strip", "SNAP_DROP0") {
    ...
    function mint(address wallet, uint numberOfMints) whenNotPaused public returns (uint256) {
        ...
        require(_tokenIds.current() + numberOfMints <= 100, "Maximum amount of tokens already minted.");
