...
// File: contracts/PPCL_Test.sol

pragma solidity 0.8.6;

contract PPCL_Test is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("PPCL-Test", "PPCLT") {
        isActive = false;
        _qtyReserved = 0;
    }
    ...
    function mint(uint256 qty) public payable nonReentrant {
        ...
        require((totalSold() + qty + RESERVE_QTY) <= MAX_SUPPLY, "Requested quantity would exceed total supply");
    ...
    function safeWithdraw(address recipient, uint256 amt) external onlyOwner nonReentrant {
        require(recipient != address(0), "Recipient cannot be a zero address");
