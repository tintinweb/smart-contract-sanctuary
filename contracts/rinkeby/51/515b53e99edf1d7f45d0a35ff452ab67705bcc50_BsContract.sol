  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xbB062E96ac8F9ab0cB5C013c3A9bcE0877de4dd2);
        ...
        function mintTo(address _to) public payable {
            ...
            require(msg.value == PRICE, "Value needs to be exactly 0.1 ETH!");
            uint256 newTokenId = _getNextTokenId();
            _mint(_to, newTokenId);
            _incrementTokenId();
        }
    ...
    // File: contracts/bsContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract BsContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("BS", "RAMPPs", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://gateway.pinata.cloud/ipfs/Qmaz73HnRYog2mz4HKksRzboYP8MAqdU53wSo8e5qsn2nK/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/Tgut8Fku2knUfpqSBy0n/contract-metadata";
        }
    }