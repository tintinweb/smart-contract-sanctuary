...
// File: original_contracts/AdapterStorageV5.sol

pragma solidity 0.7.5;


contract AdapterStorageV5 {
    ...
    mapping (bytes32 => bool) internal routerData;
    ...
    function getAdapteeData(bytes32 key) public view returns(bytes memory) {
    ...
    function getRouterData(bytes32 key) public view returns (bool) {
...
// File: original_contracts/AugustusSwapperV5.sol
...
contract AugustusSwapper is AdapterStorageV5, AccessControl {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function initializeRouter(address router, bytes calldata data) external onlyAdmin {
        ...
        (bool success,) = router.delegatecall(abi.encodeWithSelector(IExchange.initialize.selector, data));
    ...
    function setFeeWallet(address payable feeWallet) external onlyAdmin {
        ...
        onlyAdmin
    {
        ...
        require(_partnerShare > 0 && _partnerShare < 100, "Invalid values");
