...
contract ConvexCompoundGauge {
    ...
    function getLendingInfo(
        ...
        uint256 lendFlareRate = getLendFlareRate(
            compoundRate,
            amplificationFactor
        );
    ...
    function getLendFlareRate(
        ...
        // uint256 compoundRate = ICompoundBooster(compoundBooster)
        //     .getBorrowRatePerBlock(_supportPid);
        // uint256 a = getCompoundRate(compoundRate, _n);
