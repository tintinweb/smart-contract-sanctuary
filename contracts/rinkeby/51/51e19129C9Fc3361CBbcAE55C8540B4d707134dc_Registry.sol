...
contract Registry is Initializable, AccessControlEnumerableUpgradeable {
       ...
       returns(string memory)
   {
    ...
    function createProject(ProjectDetail memory projectDetail, ProjectMint memory projectMint)
        public
        onlyDefaultAdmin
    {
        ...
        // Registry admin 0 is Owner (for opensea config etc.).
        projectContract.transferOwnership(admin);
