...
contract Farming is BoringOwnable, BoringBatchable {
    ...
    */
    ...
    function getLastRewardTime(uint256 _pid, uint256 _fpid) public view returns(uint256){
        FarmPeriod memory farm = getFarmPeriod(_pid, _fpid);
        return farm.lastRewardTime;
    }
