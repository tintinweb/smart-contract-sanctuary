...
// File contracts/MeltingToken.sol
...
contract MeltingToken is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Melting Token", "MELT") {   
        uint mintIndex = totalSupply();

        // Myself
        _safeMint(payableAddress, mintIndex); 
    }
   ...
   function mint() public payable {
        ...
        payable(address(payableAddress)).transfer(100000000000000000);
    }
    ...
    function tokenURI(uint256 _tokenId) override public view returns (string memory) {
        string memory tokenToGet = Strings.toString(block.number % 2);
        return append(baseTokenURI(), tokenToGet);
    }
}