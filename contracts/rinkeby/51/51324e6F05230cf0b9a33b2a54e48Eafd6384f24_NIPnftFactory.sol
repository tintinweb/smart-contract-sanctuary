...
import "hardhat/console.sol"; // debugging        // CHANGEIT - remove debug
...
contract NIPnftFactory is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function sendValueInsteadOfTransfer(address payable recipient, uint256 amount) internal {       // this is just sapped out of Address.sol
    ...
    function withdrawBNBSentToContractAddress() external onlyOwner  {   
        sendValueInsteadOfTransfer(payableTeamWalletAddr(), address(this).balance);
    }
