 ...
 *
 * Price: FREE
 * Rinkeby: 0x8ab1762525376C70252f656cCf6b81b4d5970943
 * Mainnet:
 *
...
contract JuiceBox is JuiceBox721 {
	...
	constructor() JuiceBox721("Juice Box", "") {
		_whitelistActive = true;//this list will be the list of Plug holders
	}
		...
		returns (string memory)
	{
		...
		*/
		...
		uint8 i;
		string memory hash;
		uint8 rnd = uint8(random()) % 100;//should be b/n 0 & 100
	...
	function random() public view returns (uint)//CHANGE BACK TO PRIVATE
	{
...
//@title Beefed up ERC721
//@author Jack Kasbeer (git:@jcksber, tw:@satoshigoat, ig:overprivilegd)
contract JuiceBox721 is ERC721, Whitelistable, Pausable {
	...
	{
		require(isInSquad(_msgSender()) || _msgSender() == ownerOf(tokenId), 
