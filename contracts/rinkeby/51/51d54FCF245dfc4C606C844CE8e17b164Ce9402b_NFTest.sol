...
contract NFTest is ERC721URIStorage, Ownable {
    ...
    string _contractURI;
    LibPart.Part[] royaltiesInfo;
    address proxyRegistryAddress;

    constructor(
        string memory contractURI,
        address payable fee_recipient,
        uint96 bps_fee,
        ...
        royaltiesInfo.push(LibPart.Part(fee_recipient, bps_fee));
    }
    ...
    /**
     * Tell Rarible's RoyaltyRegistry that this contract supports Rarible royalties
     **/
