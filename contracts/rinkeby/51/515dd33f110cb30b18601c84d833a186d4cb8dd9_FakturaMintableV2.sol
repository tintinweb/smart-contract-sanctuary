...
UUPSUpgradeable
{
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if(_revealed) {
            ...
            return "https://faktura.mypinata.cloud/ipfs/QmYmR5QoiFULZXGNyguMAWkY2PmpEdpZoBZEgqSugfZ2qn/0.json";
        }
    }
    ...
    function safeBatchMint(address to, uint256 amount) public payable {
        ...
        for (uint256 i = 0; i < amount; i++) _mintTo(to);
    }
    ...
    function withdraw() external onlyOwner {
        ...
        //Pay to Treasury
        payable(getTreasury()).transfer((address(this).balance * secondaryFakturaFeeBasisPoints) / 100);
        //Pay to Creator
        payable(getTokenCreatorPaymentAddress()).transfer((address(this).balance * secondaryCreatorFeeBasisPoints) / 100);
    }
