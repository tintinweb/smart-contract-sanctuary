...
contract PlanetBananaClub is ERC721Enumerable, Ownable { // contract name to yours
  ...
  uint256 public cost = .042 ether; // change price per unit
  uint256 public maxSupply = 5400; // max supply, contract will stop minting after this amount is reach in your open sea colection
