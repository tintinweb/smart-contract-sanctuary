...
contract SOON is Context, IERC20, Ownable {
    ...
    payable(0xc968947204352d75BFF5bAea51C7D11956d91C95); // Marketing Address
    ...
    function _transfer(
        ...
        if (
            ...
            //antiwhale
            if (maxWallet) {
                require(balanceOf(to) + amount <= (totalSupply() * holdingCapPercent) / 100);
            }
    ...
    function enableMaxWallet() public onlyOwner {
        maxWallet = true;
    }
