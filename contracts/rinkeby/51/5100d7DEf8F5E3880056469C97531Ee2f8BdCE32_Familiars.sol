...
contract Familiars is ERC721, ReentrancyGuard, Ownable {
    ...
    string[] private color = ["Gold", "Silver", "Red", "Blue", "Shiny", "Gray", "Black", "White", "Magenta"];
    string[] private weapon = ["Spear", "Sword", "Katana", "Bow", "Claw", "Teeth", "Mace", "Shield"];
    string[] private prefixesSpecies = [
        "Young", 
        "Mature", 
        "Ancient", 
        "Ascendant", 
        ...
        string[] private prefixesClothing = [
        "Protective",
        "Divine",
        "Unholy",
        "Shining",
