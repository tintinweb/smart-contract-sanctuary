...
contract IslandToken is Context, Ownable, IERC20 {
    ...
    uint256 private operationSandPrize = 0;
    uint256 private operationSandPrizeRate = 10;
    ...
    function setOperationSandPrizeRate(uint256 amount) public onlyOwner {
        operationSandPrizeRate = amount;
    }
    ...
    function startSand() public onlyOwner returns (bool success) {
        ...
        // send 10% to the operational fund
        operationSandPrize = sandFund.mul(10).div(100);
        
        sandFund = sandFund.sub(operationSandPrize);
        operationalFund = operationalFund.add(operationSandPrize);
      	_balance[address(this)] = _balance[address(this)].sub(operationSandPrize);

        // give the rest to the prizes
