...
contract MusicFund is ERC721, ERC721Enumerable, Ownable, PaymentSplitter {

    string public PROVENANCE;

    uint256[] private _teamShares = [99, 1];
    address[] private _team = [0x0F7590b0050DcaFd7E17C8b29e4834a75942e3c2, 0x9DbC4720d6Aa52921fC037BFf41696b3D34278a2];
    ...
    uint256 private _reserve = 100;
    uint256 private _preSaleCap = 7;
    ...
    constructor() ERC721("MusicFund", "MUSICXYZ") PaymentSplitter(_team, _teamShares) {
    }
    ...
    function reserveTokens() public onlyOwner {
        ...
        require(supply < _reserve, "We have already hit the reserve limit");
        uint i;
    ...
    function setPreSaleCap(uint _newPreSaleCap) public onlyOwner {
