...
// File: contracts\DataSet6.sol

contract DataSet6 is ERC721Mintable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("DataSet6", "DataSet6", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset6/metadata/token/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset6/metadata/contract/metadata.json";
    }
}