...
contract InscribeMetadata is InscribeMetaDataInterface {
    ...
    function migrateBaseURI(uint256 baseURIId, string memory baseURI) external override {
        ...
        require(_baseURIExists(baseURIId), "Inscription URI does not exist");
    ...
    /**
     */
    function getBaseURI(uint256 baseURIId) external view {
     ...
     */ 
    function _baseURIExists(uint256 URIId) internal view returns (bool) {
...
contract Inscribe is InscribeApproval, InscribeInterface {
    ...
    function getInscriptionURI(uint256 inscriptionId) external view override returns (string memory inscriptionURI) {
        ...
        string memory baseURI = _getBaseURI(inscription.baseURIId);
