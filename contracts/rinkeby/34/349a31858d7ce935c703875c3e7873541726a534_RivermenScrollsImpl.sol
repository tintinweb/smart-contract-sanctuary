...
contract RivermenScrollsData {
    ...
    mapping(bool => mapping(uint256 => uint256)) internal _tokenIdFusionCountMapping;
    mapping(uint256 => Hierarchy) internal _tokenHierarchyMapping;
}

contract RivermenScrollsImpl is
    RivermenScrollsData,
    Initializable,
    ERC721Upgradeable,
    ...
    UUPSUpgradeable
{
     ...
     */
    function verifyFusion(uint256[] memory tokenIds, bool fromPawn) public view returns (bool) {
        ...
        for (uint256 i = 0; i < tokenIds.length; ++i) {
            ...
            if (owner != _msgSender()) return false;
    ...
    function fuse(uint256[] memory tokenIds, bool fromPawn) external whenNotPaused nonReentrant {
        _notContract();
        require(verifyFusion(tokenIds, fromPawn), "not a valid list of tokens");
