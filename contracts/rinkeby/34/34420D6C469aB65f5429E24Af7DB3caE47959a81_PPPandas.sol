...
contract PPPandas is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, PaymentSplitter {
    ...
    uint public presaleStartTime = 1631493360;
    uint private preSaleDuration = 5 minutes;
    uint public publicSaleStartTime = presaleStartTime + preSaleDuration; // TODO: delete for production
    //  uint public publicSaleStartTime = presaleStartTime + 5 hours;
    ...
    address coreTeam = 0x087aE7bb96397ce11e3D57493Ee46aF2e703a019;
    ...
    function setPresaleTime(uint _newTime) external onlyOwner {
        ...
        publicSaleStartTime = presaleStartTime + preSaleDuration;
    }
