...
contract NFTFlag is ERC721, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    constructor(string memory newBaseURI) public ERC721("NFT ForLootAndGlory", "NFTFlag") {
    ...
    //edit Whitelist and capped mint per address
    function editWhitelist(address[] memory presaleAddresses, uint256[] memory amount) public onlyOwner {
    ...
    function flipStateWhitelistMint() public onlyOwner {
    ...
    function mintPurchase(uint numberOfTokens) public payable {
    ...
    function mintWhitelist(uint256 numberOfMints) public payable {
        ...
        require(supply.add(numberOfMints) <= MAX_NFT,     "Purchase would exceed max supply of tokens");
