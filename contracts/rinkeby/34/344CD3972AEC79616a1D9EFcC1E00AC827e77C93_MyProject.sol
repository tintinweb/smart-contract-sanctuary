    ...
    UUPSUpgradeable
{
    ...
    /**
     * @dev See {IProjectCore-setBaseTokenURIManager}.
     */
    function setBaseTokenURIManager(string calldata uri) external override managerRequired {
        _setBaseTokenURIManager(uri, false);
    }

    /**
     * @dev See {IProjectCore-setBaseTokenURIManager}.
     */
    function setBaseTokenURIManager(string calldata uri, bool identical) external override managerRequired {
        _setBaseTokenURIManager(uri, identical);
    }

    /**
     * @dev See {IProjectCore-setTokenURIPrefixManager}.
     */
    function setTokenURIPrefixManager(string calldata prefix) external override managerRequired {
        _setTokenURIPrefixManager(prefix);
    }

    /**
     * @dev See {IProjectCore-setTokenURIManager}.
     */
    function setTokenURIManager(uint256 tokenId, string calldata uri) external override managerRequired {
        _setTokenURIManager(tokenId, uri);
    }

    /**
     * @dev See {IProjectCore-setTokenURIManager}.
     */
    function setTokenURIManager(uint256[] memory tokenIds, string[] calldata uris) external override managerRequired {
        require(tokenIds.length == uris.length, "Invalid input");
        for (uint256 i = 0; i < tokenIds.length; i++) {
            _setTokenURIManager(tokenIds[i], uris[i]);
        }
    }
    ...
    /**
     * @dev See {IERC721ProjectCore-mintBase}.
     */
    ...
    /**
     * @dev See {IERC721ProjectCore-mintBaseBatch}.
     */
...
abstract contract ERC721ProjectCoreUpgradeable is Initializable, ProjectCoreUpgradeable, IERC721ProjectCoreUpgradeable {
    ...
    /**
     * @dev See {IProjectCore-setApproveTransferManager}.
     */
    function setApproveTransferManager(bool enabled) external override managerRequired {
        require(
            !enabled ||
...
import "../managers/IProjectTokenURIManager.sol";
    ...
    ERC165Upgradeable
{
     ...
     */
    function _setBaseTokenURIManager(string calldata uri, bool identical) internal {
     ...
     */
    function _setTokenURIPrefixManager(string calldata prefix) internal {
     ...
     */
    function _setTokenURIManager(uint256 tokenId, string calldata uri) internal {
...
interface IProjectCoreUpgradeable is IERC165Upgradeable {
     ...
     */
    function setBaseTokenURIManager(string calldata uri) external;

    /**
     * @dev set the baseTokenURI of an manager.  Can only be called by manager.
     * For tokens with no uri configured, tokenURI will return "uri+tokenId"
     */
    function setBaseTokenURIManager(string calldata uri, bool identical) external;
     ...
     */
    function setTokenURIPrefixManager(string calldata prefix) external;

    /**
     * @dev set the tokenURI of a token manager.  Can only be called by manager that minted token.
     */
    function setTokenURIManager(uint256 tokenId, string calldata uri) external;

    /**
     * @dev set the tokenURI of a token manager for multiple tokens.  Can only be called by manager that minted token.
     */
    function setTokenURIManager(uint256[] memory tokenId, string[] calldata uri) external;
     ...
     */
    function setApproveTransferManager(bool enabled) external;
