...
contract LFGClaim is Ownable {
    ...
    function setAddress(address airdropToken_) onlyOwner public {
        require(airdropToken_ != address(0));
        airdropTokenAddress = airdropToken_;
    }
