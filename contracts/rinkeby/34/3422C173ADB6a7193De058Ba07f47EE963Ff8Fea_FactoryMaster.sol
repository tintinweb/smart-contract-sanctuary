...
contract FactoryMaster {
    ERC20Standard[] public childrenErc20;
    ...
    event ChildCreatedERC20(address childAddress,uint256 totalSupply_, string name, string symbol);
    ...
    function createChild(
        ...
        if (types == Types.erc20) {
            ...
            ERC20Standard child = new ERC20Standard( totalSupply_, name, symbol);
            childrenErc20.push(child);
            emit ChildCreatedERC20(address(child), totalSupply_, name, symbol);
        }
        ...
        if (types == Types.erc20Mintable) {
            ...
            ERC20Mintable child = new ERC20Mintable(cap_, name, symbol);
            childrenErc20Mint.push(child);
            emit ChildCreatedERC20Mintable(address(child), cap_, name, symbol);
        }
