...
contract Koala is ERC721Enum, ERC721Burn, Ownable, ReentrancyGuard{
    ...
    //presale settings
    uint256 public presaleDate = 1641362400;
    uint256 public publicsaleDate = 1641364200;
    mapping(address => uint256) public presaleWhitelist;
    uint256[300] public travelerToken;
    uint256[] public koalaMet;
    Traveler public Travelers;


    // Travelers public Travelers;
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        require(publicsaleDate <= block.timestamp, "Not yet");
    ...
    // function travelerReserve(uint256 _travelerTokenID) public {
        function travelerReserve() public payable{
        uint256 s = totalSupply();
        uint256 t = totalTravelerReserve();
        require(t + 1 <= maxTravelerReserve, "Sorry");
        // require(_travelerTokenID>14,"First 15 travelers have met Koalas.");
        // require(travelerToken[_travelerTokenID] == 0, "This traveler has already met a Bora Bora Koala.");
        // require(Travelers.ownerOf(_travelerTokenID)==_msgSender());
        _safeMint(msg.sender, s + 1, "");
        // koalaMet.push(_travelerTokenID);
        // travelerToken[_travelerTokenID] = 1;
        Travelers.mint{value: msg.value}(1);
        delete s;
        delete t;
    }
