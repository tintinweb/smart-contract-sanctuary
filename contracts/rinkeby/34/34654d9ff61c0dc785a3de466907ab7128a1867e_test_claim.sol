...
contract test_claim is ERC721Enumerable, Ownable, VRFConsumerBase {
...
uint256 public Series0start = 1; // 2 [GANapes]
uint256 public Series1start = 3; // 2 [TestNFT]
uint256 public Series2total = 4; // 4 total

// SERIES 0 and SERIES 1 ADDRESSES

address public Series0Address = 0x719879d9699DBF3828A40bb2E8C6Dc5273F97d84;
address public Series1Address = 0x2ca26Ff42F5fb1bcc73a7680dd4D3BD6E1b300C5;
...
constructor()
    ...
    fee = 0.1 * 10 ** 18; // 0.1 LINK (Varies by network) ***CURRENTLY SET FOR RINKEBY FEES***
    }
