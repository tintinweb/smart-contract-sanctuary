...
contract NFTERC1155Auction is ERC1155Holder, Ownable{
    ...
    function _updateOngoingAuction(
       NFT memory _nft
        ...
        if (_isBuyNowPriceMet(_nft)) {
            _transferNftAndPaySeller(_nft.nftContractAddress,_nft.tokenId);
            return;
        }
    ...
    function _resetAuction(address _nftContractAddress, uint256 _tokenId)
        internal
    {
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].minPrice = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].buyNowPrice = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].amount = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].auctionEnd = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].auctionBidPeriod = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].bidIncreasePercentage = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftSeller = address( 0);
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].whitelistedBuyer = address(0);
        delete nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].batchTokenIds;
        delete nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].batchAmounts;
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].ERC20Token = address( 0 );
    }
    ...
    function _resetBids(address _nftContractAddress, uint256 _tokenId)
        internal
    {
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftHighestBidder = address(0);
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftHighestBid = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftRecipient = address(0);
    }
    ...
    function _updateHighestBid(
        ...
        address auctionERC20Token = nftContractAuctions[_nftContractAddress][ _tokenId ][msg.sender].ERC20Token;
        if (_isERC20Auction(auctionERC20Token)) {
    ...
    function _reversePreviousBidAndUpdateHighestBid(
        ...
        address prevNftHighestBidder = nftContractAuctions[_nftContractAddress][_tokenId ][msg.sender].nftHighestBidder;

        uint256 prevNftHighestBid = nftContractAuctions[_nftContractAddress][_tokenId ][msg.sender].nftHighestBid;
    ...
    function _transferNftAndPaySeller(
        ...
        address _nftSeller = nftContractAuctions[_nftContractAddress][_tokenId][msg.sender]  .nftSeller;
        address _nftHighestBidder = nftContractAuctions[_nftContractAddress][_tokenId ][msg.sender].nftHighestBidder;
        address _nftRecipient = _getNftRecipient(NFT(_nftContractAddress, _tokenId, msg.sender));
        uint256 _nftHighestBid = nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].nftHighestBid;
    ...
    function _payFeesAndSeller(
        ...
        for (
            uint256 i = 0;
            i <
            nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].feeRecipients.length;
            i++
        ) {
            uint256 fee = _getPortionOfBid(
                _highestBid,
                nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].feePercentages[i]
            );
            feesPaid = feesPaid + fee;
            _payout(
                _nftContractAddress,
                _tokenId,
                nftContractAuctions[_nftContractAddress][_tokenId][msg.sender].feeRecipients[i],
                fee
            );
        }
        _payout(
