...
contract EasyBakeOven is ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    uint16 public MAX_SUPPLY = 140;

    constructor(string memory _name, string memory _symbol, address _storeOwner, address _proxyRegistryAddress) ERC721(_name, _symbol) {
        storeOwner = _storeOwner;
        proxyRegistryAddress = _proxyRegistryAddress;
        setBaseURI('ipfs://ipfs/');
