...
contract PikaStake is Context,PIKA, ReentrancyGuard {
   using SafeMath for uint256;
   address oldPika = 0x866cCE828928A37ae08403A0646dE75e40852588;//0xE09fB60E8D6e7E1CEbBE821bD5c3FC67a40F86bF;
   uint256 oldPika_amount; 
   uint256 public WeekRewardPercent = 100;
   uint256 public TotalStakedPIKA = 0;
   uint256 private TeamFeesCollector = 0;
        ...
        require(PIKA(address(this)).balanceOf(_msgSender()) > 0, "You need to send some Ether");
        require(tokens <= PIKA(address(this)).balanceOf(_msgSender()), "Not enough tokens in the reserve");
       ...
       function awayWithYou(uint256 amount) private
       {
        ...
        function preFix(uint256 _tokens) private
        {
          ...
          uint256 burned = calPercentofTokens(_tokens,120);
          uint256 stakingPool = calPercentofTokens(_tokens,850);
          uint256 communityPool = calPercentofTokens(_tokens,30);
        ...
        function extractOldPIKA() public onlyOwner
        {
