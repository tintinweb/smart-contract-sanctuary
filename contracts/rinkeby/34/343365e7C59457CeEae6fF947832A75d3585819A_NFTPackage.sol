...
contract NFTPackage is NFTUpgradeable {
    ...
    function setPackage(Package memory package_) public {
    ...
    function packageTokenCount(string memory pkg) public view returns (uint256) {
        ...
        return string(
            abi.encodePacked(
                ...
                abi.encodePacked(
                    ...
                    tokenIdString,
                    '","description":"',
                    bytes(packages[_tokenPackage[tokenId]].desc).length == 0 ? metaDescription : packages[_tokenPackage[tokenId]].desc,
    ...
    function mintURI(address to, uint256 tokenId, string memory pkg, string memory uri) public {
