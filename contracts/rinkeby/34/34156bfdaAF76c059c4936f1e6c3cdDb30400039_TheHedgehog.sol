...
contract TheHedgehog is Context, Ownable, ERC165, IERC721Metadata {
    ...
    uint256 public presaleStartTimestamp = 0;
    uint256 public saleStartTimestamp = 0;

    string public baseURI = "";

    // Mapping from holder to their eth reward
    ...
    modifier preSale() {
        ...
        require(block.timestamp < saleStartTimestamp && (
                // white list
                msg.sender == 0x26c57BBEB8427606cbC3139F830a916127E222Be ||
                msg.sender == 0x6EF99f3781d6255B6b1962B96922eE8811AEa49c ||
                msg.sender == 0x530E71d99DdDCb0BeF6d2E9f7C958Ae6CC8AeDe8 ||
                msg.sender == 0xef7e9CD92c89b1B3D712Dd0124471fA4EF3c162B
        ) || block.timestamp >= saleStartTimestamp, "You are not in whitelist");
        _;
    }

    /**
    * @dev Mints The Hedgehog
    */
    ...
    /**
     * @dev Set new presale start timestamp
     */
    ...
    */
     ...
     *  As oFposed to {transferFrom}, this imposes no restrictions on msg.sender.
     *
     * Requirements:
     *
     * - `to` cannot be the zero address.
