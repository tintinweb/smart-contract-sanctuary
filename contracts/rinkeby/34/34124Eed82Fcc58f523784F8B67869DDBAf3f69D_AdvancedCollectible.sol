...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    mapping(uint256 => TypeOfKnight) public tokenIdToKnight;
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomNumber)
        ...
        override
    {
        address knightOwner = requestIdToSender[_requestId];
        string memory tokenURI = requestIdToTokenURI[_requestId];
        uint256 newItemId = tokenCounter;
        _safeMint(knightOwner, newItemId);
        _setTokenURI(newItemId, tokenURI);
        TypeOfKnight typeOfKnight = TypeOfKnight(_randomNumber % 3);
        tokenIdToKnight[newItemId] = typeOfKnight;
