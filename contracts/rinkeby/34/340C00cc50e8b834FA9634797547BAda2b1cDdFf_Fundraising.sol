...
contract Fundraising {
    ...
    event FundraiseCreated(address indexed fundraiser, address indexed beneficiary, uint256 fundraiseGoal, uint256 fundraiseDeadline, uint256 indexed fundraiseId);
    ...
    function createFundraise(address beneficiary, uint256 fundraiseGoal, string memory fundraiseAgenda, uint256 fundraiseDeadline) external {
        ...
        emit FundraiseCreated(msg.sender, beneficiary, fundraiseGoal, fundraiseDeadline, fundraiseId);
    } 
