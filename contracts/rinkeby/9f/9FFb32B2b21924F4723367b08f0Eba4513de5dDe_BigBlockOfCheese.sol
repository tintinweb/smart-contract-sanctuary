...
contract BigBlockOfCheese is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("TestPegs", "TPGS") Ownable() {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmZq5zbk1yorT6Q3bT5N1SE3cDq5YkN8RsMD4SBauFYYtj/";
    }
    ...
    function ownerClaim(uint16 tokenId) public onlyOwner nonReentrant {
        // Allow owner to claim their reserved tokens... caller responsible for determining unclaimed IDs
        require(tokenId > 0 && tokenId >= (MAX_SUPPLY - OWNER_SUPPLY), "No available tokens");
        _safeMint(_msgSender(), tokenId);
    }

    function claim() public nonReentrant {
        require(nextToken > 0 && nextToken < (MAX_SUPPLY - OWNER_SUPPLY), "No available tokens");
