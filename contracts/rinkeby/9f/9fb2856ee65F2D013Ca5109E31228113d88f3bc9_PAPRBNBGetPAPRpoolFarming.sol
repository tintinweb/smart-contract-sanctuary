...
contract PAPRBNBGetPAPRpoolFarming is Ownable {
    ...
    address public trustedDepositTokenAddress = 0x7607CcB24C388Ec563be1488Ecc2B27455265ba6;
    // Earned Tokens address : PAPR
    address public trustedRewardTokenAddress = 0x7bf5F00AdF1a71bad1Fdbb916e4F0cC229f9c541; 

    // Amount of tokens
    uint public disburseAmount = 150000e18;
    // To be disbursed continuously over this duration
    uint public disburseDuration = 37 days;

    // If there are any undistributed or unclaimed tokens left in contract after this time
    // Admin can claim them
    // To change to 1 year
    uint public adminCanClaimAfter = 365 days;
