...
contract FeedMob is ERC20, Ownable {
    ...
    modifier onlyWhiteList() {
        ...
        require(_approved, "Feedmob: caller is not in the whitelist");
        _;
    }

    constructor() ERC20("FeedMob", "FMB") {}
    ...
    function removeWhiteList(address _address) public onlyOwner {
        ...
        if (indexToBeDeleted < whiteListLength()-1) {
            whiteList[indexToBeDeleted] = whiteList[whiteListLength()-1];
        }
    }
    ...
    function addTaskInfo(uint256 taskId, uint256 reward, address receiver) public onlyWhiteList{
        taskInfos[taskId] = TaskInfo(reward, receiver, false);
    }
    ...
    function confirmTask(uint256 taskId) public onlyWhiteList {
        TaskInfo memory task = taskInfos[taskId];
        task.isDone = true;
