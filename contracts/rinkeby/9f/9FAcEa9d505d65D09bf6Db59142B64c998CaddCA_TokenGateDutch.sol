...
contract TokenGateDutch is Ownable {
    ...
    function getThresholdAtBlock(
        ...
        // todo: improve this, this is going to jump at the end. idea
        //       smooth this out deterministically, by calculating the diff
        //       and then distributing it in a deterministic way across the 
        //       the blocks.
