...
//   ======================================
    ...
    function _sendAndFreeze(address _sender, address _recipient, uint256 _amountToFreeze, uint64 _freezeDuration) internal {
        ...
        require(!Wallet[_sender].isLocked, "Sender Wallet is locked");
...
//   ======================================
    ...
    function UnfrozenAssetsBalance(address _recipient) external view returns (uint256 _frozenAmount) {
        uint48 _currentTime = uint48(block.timestamp/86400);    
        uint48 _nextRelease = Wallet [_recipient].headFrozenAssets;
        uint48 _currentNode;
...
contract SymplexiaToken is  Taxable {
   ...
   // swapRouterAddress
    ...
    constructor ()  ERC20("BETA47", "BTG47") BaseToken ( 
