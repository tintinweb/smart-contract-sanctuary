...
contract threestages is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint8 _mintAmount) public payable {
    ...
    require(mintState <= 2, "Minting is finished!"); //only 2 states
    ...
    if (mintState == 1){
      //free mint of 1 with 734 spots
          require(supply + _mintAmount <= 10, "Total Free supply exceeded!");
    }


    else if (mintState ==2){
      //public mint
          require(supply + _mintAmount <= 30);
    }
