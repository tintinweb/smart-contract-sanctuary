...
// File: https://github.com/Uniswap/uniswap-v3-core/blob/main/contracts/libraries/LowGasSafeMath.sol
...
contract BeefyZapUniswapV2 {
    ...
    receive() external payable {
     ...
     function beefIn (address lpAddress, uint256 tokenAmountOutMin, address tokenIn, uint256 tokenInAmount) external {
    ...
    function beefInETH (address lpAddress, uint256 tokenAmountOutMin) external payable {
    ...
    function _swapAndStake(address lpAddress, uint256 tokenAmountOutMin, address tokenIn) private {
        ...
        (,, uint256 amountLiquidity) = router
            .addLiquidity(path[0], path[1], lp0Bal, lp1Bal, 1, 1, msg.sender, block.timestamp);
