...
contract skyb is ERC721Upgradeable, OwnableUpgradeable {
    ...
    uint256 public constant MAX_SUPPLY = 20; // Max public tokens
    uint256 public constant MAX_HL_SUPPLY = 10;
    uint256 public constant MAX_PUBLIC_SUPPLY = 10;
    uint256 private constant BASE_PUBLIC_ID = 100;
    ...
    function publicMint(uint256 amount) external payable notContract {
        ...
        for (uint256 i = 0; i < amount; i++) {
            ...
            if (publicCnt < MAX_PUBLIC_SUPPLY) {
                publicCnt += 1;
                counter.increment();
                uint256 cnt = publicCnt + BASE_PUBLIC_ID;
