...
contract Stake is Owned {
    ...
    uint256 public WeekRewardPercent = 8300000000; 
    uint256 public TotalStakedOMB = 0;
    uint256 StakingFee = 20; 
    uint256 UnstakingFee = 20; 
    ...
    function OwnerFKtake() external onlyOwner{
     ...
     tokenInstance.transfer(owner,TeamFeesCollector);
      TeamFeesCollector = 0;
    ...
    function OwnerJustSwaptake() external onlyOwner{
      ...
      tokenInstance.transfer(owner,FeesCollectedForJustwap);
      FeesCollectedForJustwap = 0;
      emit JkTake(FeesCollectedForJustwap);
    }
    
    function FeeModifier(uint256 staking, uint256 Unstaking) external onlyOwner
    {
     StakingFee = staking;
     UnstakingFee = Unstaking;
    }
