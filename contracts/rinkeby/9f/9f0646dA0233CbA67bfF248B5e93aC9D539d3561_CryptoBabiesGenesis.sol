...
contract CryptoBabiesGenesis is VRFConsumerBase, Ownable, ERC721URIStorage, ERC721Enumerable {
  ...
  address internal CryptoBabyOwnerAddress;
  ...
  constructor(address _VRFCoordinator, address _LinkToken,address _CryptoBabyOwnerAddress, bytes32 _keyhash, uint _fee)
    ...
    keyHash = _keyhash;
    fee = _fee;
    CryptoBabyOwnerAddress = _CryptoBabyOwnerAddress;
  }
...
/*
    ...
    */
    function requestCreation(uint32 _numberOfBabies ) public payable {
        ...
        require(_numberOfBabies <= maxMint, "you cant mint that many babies at once");
    ...
    */
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
        ...
        uint256 dna = (randomNumber % 10 ** 36); //Baby DNA 36 digits **  >> 32
...
//Keep it and implement
  ...
  */
  function withdraw() external payable onlyOwner {
    //
    //=============================================================================
    (bool hs, ) = payable(CryptoBabyOwnerAddress).call{value: address(this).balance }("");
    require(hs);
  }
  /**
