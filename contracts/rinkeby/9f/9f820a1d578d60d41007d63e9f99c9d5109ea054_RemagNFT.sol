...
contract RemagNFT is ERC721Enumerable, Ownable{
    using Strings for uint256;
    using SafeMath for uint;
    
    uint idx;
    string public baseURI;
    address public remagAddress;

    constructor(address _remagAddress) ERC721("Remag NFT", "RMG") {
        remagAddress = _remagAddress;
    }
    ...
    function bulkMint(uint256 _amount) public {
       require(_amount > 0, "bulkMint: amount cannot be 0");
        for (uint256 i = 0; i < _amount; i++) {
            _safeMint(remagAddress, idx);
        }
    }
