...
contract SecondMiddleware is IERC721Receiver, Ownable{
    ...
    function setMigrationContract(address _contractAddress) public onlyOwner{
        migrateContract = NFTMigration(_contractAddress);
    }

    function getMigrationContract() public view returns(address) {
        return address(migrateContract);
    }
