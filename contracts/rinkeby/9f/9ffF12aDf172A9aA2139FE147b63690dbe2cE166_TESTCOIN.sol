...
contract TESTCOIN is Context, IERC20, Ownable {
    ...
    uint256 public div1 = 5; // 1/5rd goes to liquidity
    uint256 public div2 = 62; // 62% of 4/5ths goes to marketing
    ...
    address payable public stakingAddress; // does nothing
    ...
    function addressChange(address payable _lpAddress, address payable _stakingAddress, address payable _devAddress, address payable _marketingAddress) external onlyOwner{
        ...
        require(_marketingAddress != address(0),"cant set buyback address 0");
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 1;
        _liquidityFee = 14;
        _maxTxAmount = 3 * 10**9 * 10**9; // 3 Billion (0.3%)
    }
