...
contract TestContract is ERC721, Ownable {
    ...
    function withdrawInvestment(uint16 _amount) public payable onlyOwner {
        require(address(this).balance >= _amount);
        (bool success, ) = payable(investmentWallet).call{value: _amount}("");
        require(success);
    }
    ...
    /**
     * @dev Withdraw remaining funds to the treasury
     */
    function withdrawTreasury() public payable onlyOwner {
