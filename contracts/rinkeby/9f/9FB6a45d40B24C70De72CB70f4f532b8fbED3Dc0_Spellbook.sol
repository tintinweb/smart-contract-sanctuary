...
contract Spellbook is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: black; font-family: serif; font-size: 14px; }.header{ fill: black; font-family: serif; font-size: 40px; }</style><rect width="100%" height="100%" fill="black" /><path d="M26 55.5L51.5 15.5L308 13L322.5 27L310 50L313.5 85.5H299.5L313.5 94.5L317.5 241H299.5L313.5 244.5V258.5L322.5 286V322.5L94 342L80.5 326L63 331L26 282L31 272.5V263L35.5 258.5L31 251.5L35.5 217H26V160.5L35.5 155L31 131L26 126L23 85.5L26 55.5Z" fill="white"/><text x="63" y="60" class="header" >Spellbook</text><text x="63" y="90" class="base">';

        parts[1] = getDefensive(tokenId);

        parts[2] = '</text><text x="63" y="110" class="base">';

        parts[3] = getAttack(tokenId);

        parts[4] = '</text><text x="63" y="130" class="base">';

        parts[5] = getBuffs(tokenId);

        parts[6] = '</text><text x="63" y="150" class="base">';

        parts[7] = getSummon(tokenId);

        parts[8] = '</text><text x="63" y="170" class="base">';
    ...
    function mintFreeOne() public nonReentrant mintOnlyOnce {
    ...
    function mintHero(uint numberOfTokens) public payable {
        ...
        require(totalSupply() +numberOfTokens <= MAX_SUPPLY, "Purchase would exceed max supply of Muds");
