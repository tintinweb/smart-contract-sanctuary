...
contract WBMC is ERC721, Ownable {  
    ...
    uint internal wbPrice = 80000000000000000; //0,08 eth
    ...
    constructor(string memory myBase, address _vibe20address) ERC721("WBMCxx", "WANNABESxx") {
        setBaseURI(myBase);
	...
	payable 
    {
        ...
        require(msg.value >= salePrice, "funds sent not enough");
    ...
    * ==========================================================================
    * NAMING
    * Be careful with it. They say, the name determines the fate 
    * ==========================================================================
    */
