...
contract ERC20DefaultVault is BaseVault {
    ...
    function getLockRecord(uint8 _chainId, uint64 _lockNonce) external view returns (LockRecord memory) {
        return lockRecords[_chainId][_lockNonce];
    }
    ...
    function lock(
        ...
        lockRecords[_chainId][_lockNonce] = LockRecord(
            tokenAddress,
            _chainId,
            _assetId,
            recipientAddress,
