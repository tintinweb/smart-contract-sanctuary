...
contract FTest is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public pricePer; // Sale price
    bool public sale; // Is the sale enabled

    // TODO: Update name/identifier
    constructor(address payable _payoutAddress, uint256 _maxSupply, uint256 _maxPerTx, uint256 _pricePer) ERC721("FTest", "FTEST") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmXqzwR16byhek3qZwE76WAfaYnjdTNySitHJC4xpFEND7/";
    }
