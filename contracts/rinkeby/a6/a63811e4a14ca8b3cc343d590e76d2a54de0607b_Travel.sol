...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ORG = IERC20(0x79B627bC95fa5B36ecA53eB39c3cdf43AaFDD10f);
    address WBNB = 0x8F8526dbfd6E38E3D8307702cA8469Bae6C56C15;
    IDEXRouter router;
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ORG.balanceOf(address(this));
        ...
        uint256 amount = ORG.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ORG.transfer(shareholder, amount);
...
contract Travel is IERC20, Ownable {
    using SafeMath for uint256;

    address ORG = 0x79B627bC95fa5B36ecA53eB39c3cdf43AaFDD10f;
    address WBNB = 0x8F8526dbfd6E38E3D8307702cA8469Bae6C56C15;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Travel Token";
    string constant _symbol = "Travel";
