...
contract DogsPublisher is Ownable
{
	...
	// Total free Dogs created
    uint256 public totalFreeDogsMax=1500;

    //the number of free Dogs an address can claim
    uint public freeDogsLimit = 1;
