...
contract ForEverAward is ERC721, Ownable {
    ...
    mapping(uint256 => address) public tokenIdToSender;
     ...
     /**
      * @dev keep a map of the tokenURIs so each token can be different than the base
      */
     mapping (uint256 => string) private _tokenURIs;

    /**
     * @dev Base URI to override the parent
     */
    ...
    /**
     * @dev below is in response for 0.8.0 removing _setTokenURI
     */
