...
contract NerdyNuggets is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NUGGETS = 8315;
    bool public saleIsActive = false;
    
    uint256 private _nerdyNuggetPrice = 25000000000000000; // 0.025 ETH
    ...
    function withdraw() public onlyOwner {
        address testAddress = 0x0027aDb95CA83B1e0343693662e7dd79CD4FDD8B;
        address testAltAdd = 0x42afa67C80A4727BAca49430CB49687dA359bEc6;
        address testAlt3Add = 0xe562e30E2Ad523298772b3f2ffd4f4E1a99B0417;
        ...
        uint partyOne = balanceToMultiply * twentyPercent;
        remainingBalance = remainingBalance - partyOne;
        uint partyTwo = balanceToMultiply * twentyPercent;
        remainingBalance = remainingBalance - partyTwo;
        uint partyThree = balanceToMultiply * onePointFivePercent;
        remainingBalance = remainingBalance - partyThree;

        payable(testAddress).transfer(partyOne);
        payable(testAltAdd).transfer(partyTwo);
        payable(testAlt3Add).transfer(partyThree);
    ...
    function mintNerdyNuggets(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxNerdyNuggetPurchase, "Oops - you can only mint 10 NerdyNuggets at a time");
