...
contract Niftysistas is ERC721, Ownable, Pausable {
    ...
    uint[] private lowerBounds = [857, 838, 807, 635, 298, 182, 141, 100, 768, 665, 485, 435, 245];
    uint[] private upperBounds = [875, 856, 837, 664, 434, 244, 181, 140, 806, 767, 634, 484, 297];
