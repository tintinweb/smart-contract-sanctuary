    ...
    RoyaltiesV2Impl
{
    ...
    function setPriceForToken(uint256 _tokenID, uint256 _price) external {
        require(
    ...
    function mintAndTransfer(
        ...
        require(
            msg.value >= minPrice && msg.value >= prices[data.tokenId],
            "The payment sent must be at least the sale price and registed token price"
        );
