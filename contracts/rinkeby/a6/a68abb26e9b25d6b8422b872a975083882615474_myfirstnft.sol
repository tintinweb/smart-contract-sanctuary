...
// File: contracts/myfirstnfta.sol
...
contract myfirstnft is ERC721, Ownable, RoyaltiesV2Impl {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;
    constructor() ERC721("myfirstnfta", "mfnfta") {}

    function mint(address _to) public onlyOwner { //TODO currently only the owner can mint
