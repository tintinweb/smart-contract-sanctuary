...
contract ChipmunksAndFriends is ERC721Enumerable, Ownable {
    ...
    function setUpPresale(
        ...
        // Check params
        require(whitelistSigner != address(0), "ChipmunksAndFriends: zero address");
        require(_startTime > 0 && _endTime > _startTime, "ChipmunksAndFriends: invalid time range");
    ...
    function setUpSale(
        ...
        require(_initMaxCount > 0 && _unlockedMaxCount > 0, "ChipmunksAndFriends: zero amount");
        require(_startTime > 0 && _maxCountUnlockTime > _startTime, "ChipmunksAndFriends: invalid time range");
    ...
    function mintPresaleTokens(
        ...
        require(_presaleConfig.whitelistSigner != address(0), "ChipmunksAndFriends: presale not configured");
        ...
        require(count > 0, "ChipmunksAndFriends: invalid count");
        require(block.timestamp >= _presaleConfig.startTime, "ChipmunksAndFriends: presale not started");
        require(block.timestamp < _presaleConfig.endTime, "ChipmunksAndFriends: presale ended");
    ...
    function mintTokens(uint256 count) external payable {
        ...
        require(_saleConfig.startTime > 0, "ChipmunksAndFriends: sale not configured");

        require(treasury != address(0), "ChipmunksAndFriends: treasury not set");
        require(tokenPrice > 0, "ChipmunksAndFriends: token price not set");
        require(count > 0, "ChipmunksAndFriends: invalid count");
        require(block.timestamp >= _saleConfig.startTime, "ChipmunksAndFriends: sale not started");
        ...
        require(
            ...
            "ChipmunksAndFriends: max count per tx exceeded"
        );
        require(_nextTokenId + count <= maxSupply, "ChipmunksAndFriends: max supply exceeded");
        require(tokenPrice * count == msg.value, "ChipmunksAndFriends: incorrect Ether value");
