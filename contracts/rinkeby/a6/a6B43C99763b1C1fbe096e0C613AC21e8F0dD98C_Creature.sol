...
/**
 * @title Creature
 * Creature - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract Creature is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    using SafeMath for uint256;

    address proxyRegistryAddress;
    uint256 private _currentTokenId = 0;
    string private _baseTokenURI;
    string constant name1 = "SantaNFT";
    string constant symbol1 = "SNT";

    uint256 public constant MAX_NFT_SUPPLY = 20000;
...
//        _balances[address(this)] = MAX_NFT_SUPPLY;
        
    }

    /**
     * @dev Buying Santa Clauses
     *
    function buyNFT(uint256 numberOfNfts) public payable {
    ...
    **
    ...
    function setBaseTokenURI(string calldata _url) public onlyOwner {
        _baseTokenURI = _url;
    }
    ...
    function DEV_destroy() public onlyOwner {
