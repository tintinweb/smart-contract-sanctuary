...
contract MinterVault {
    ...
    modifier onlyMinter() {
        ...
        uint256 cost = _gasUsed.sub(gasleft()).add(TRANSFER_USED_GAS).add(CALC_USED_GAS).mul(gasPrice);
