...
contract ThugDogeMarket is ThugDoge {
    uint256 price;
    address recipient;
    ...
    constructor(
        ...
        uint256 _price
    ) ThugDoge(_baseURI, _contractURI) {
        price = _price;
    }
    ...
    modifier _isEnoughPay(uint256 amount) {
        require(
            ...
            "ThugDogeMarket: msg.value is not enough"
        );
        _;
    }
...
contract ThugDoge is ERC721Enumerable, Ownable {
    ...
    modifier _isEnoughTokens(uint256 amount) {
        require(
            ...
            "ThugDoge: more than possible minted amount"
        );
        _;
    }

    modifier _checkAmount(uint256 amount) {
        require(amount >= 1, "ThugDoge: amount should be positive");
        _;
    }
