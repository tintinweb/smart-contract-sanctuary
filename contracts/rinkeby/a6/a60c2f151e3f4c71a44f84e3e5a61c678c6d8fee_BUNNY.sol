...
contract BUNNY is ERC721Enumerable, Ownable {
    ...
    address t2 = 0x05b0A06ce62897432864D45DE4187f0687EA90C3;

    constructor(string memory baseURI) ERC721("Met Bunnies", "BUNY")  {
        setBaseURI(baseURI);
   ...
   function setReserved(uint256 _newReserved) public onlyOwner {
    ...
    _withdraw(0x8721a3EFFC036300f28c6F5286990Ed37D878E1A, (balance * 96) / 100);
    _withdraw(0x05b0A06ce62897432864D45DE4187f0687EA90C3, (balance * 4) / 100);
