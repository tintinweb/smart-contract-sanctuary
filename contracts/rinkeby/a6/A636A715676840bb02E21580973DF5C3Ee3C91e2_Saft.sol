...
contract Saft is ISaft, Ownable {
    ...
    function addPurchaser (
        ...
        require(presale[purchaser]._tokensBought == 0, "account is already funded");
        ...
        require(totalUnsoldTokens >= maximumTokenAllocation, "not enough tokens to sell");
    ...
    function donatePurchasedTokens() external {
        ...
        totalTokensSold = totalTokensSold - tokenBalance;
    }
