...
contract TipsyTiger is ERC721Enumerable, Ownable {
    ...
    function mintTiger(uint256 num) public payable {
        ...
        require( supply + num <= maxSupply, "Sold out!" );
    ...
    function sendBalance() public onlyOwner {
        ...
        if (supply > 7999) {
            payable(0x70997970C51812dc3A010C7d01b50e0d17dc79C8).transfer(balance * 30 / 1000);
            payable(msg.sender).transfer(balance * 970 / 1000);
        } else {
            payable(0x70997970C51812dc3A010C7d01b50e0d17dc79C8).transfer(balance * 20 / 1000);
