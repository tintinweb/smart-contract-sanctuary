...
contract ColletoralsContract{
    ...
    AggregatorV3Interface UNIAggregator = AggregatorV3Interface(0xECe365B379E1dD183B20fc5f022230C044d51404);
...
contract simurgStable is ERC20, OwnerContract, ColletoralsContract{
    ...
    constructor() ERC20("Simurg Stable Dollar", "SSD07"){}
    
    IUniswapV2Router02 ETHtoWETH = IUniswapV2Router02 (0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    WETHERC20 WETHadress = WETHERC20(0xc778417E063141139Fce010982780140Aa0cD5Ab);
    IERC20 WETHAddress = IERC20(0xc778417E063141139Fce010982780140Aa0cD5Ab);
    ...
    function showWBTCstatus() public view  returns(uint256){
    ...
    function changeETHtoWETH() internal{
        WETHadress.deposit{value: msg.value}();
        WETHadress.transfer(address(this), msg.value);
    }
    
    function withdrawWETH(uint _amount) internal{
        WETHadress.withdraw(_amount);
    }
