...
contract TwoBitBears is ERC721Enumerable, IBearDetail, Ownable, ReentrancyGuard {
    ...
    */
    ...
    /// @dev Mapping of TokenIds to generated Bear Detail
    mapping(uint256 => IBearDetail.Detail) private _tokenIdToBearDetails;

    /// @dev Mapping of TokenIds to gifted bears
    ...
    /**
     * @dev Celebrate and marvel at the astonishing detail in each Two Bit Bear
     */
    ...
    /**
     * @dev The Golden Rule: Those who articulate their appreciation for the details of the Two Bit Bear renderings will be embraced, and rewarded. But, those who cast judgment, negativity or shade of any kind, especially those who question the quality & detail of the bears should be reminded of The Golden Rule.
     */
