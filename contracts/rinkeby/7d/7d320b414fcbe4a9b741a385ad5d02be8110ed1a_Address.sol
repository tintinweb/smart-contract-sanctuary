...
// Own one of only 7,777 programmatically generated and minted MoonaLisa's. You will own a unique collectible, selected randomly from around 500m possible combinations.
// They are so rare, that only a tiny % of the global population will ever be able to own one. Secure your own MoonaLisa while you can!

// You can visit our website https://moonalisa.io or get the team on https://twitter.com/moonalisa
...
contract MoonaLisa is ERC721, PaymentSplitter, Ownable {
    ...
    address[] private teamWallets = [
        ...
        0x0B6D9B71865DdDf45aB71378A63BaA8eC91065AA, // Founder
        0xb335A50810923f30C21eC4Eb142eB4D962160E02  // Partner
    ];

    uint256[] private teamShares = [10,45,45];
    ...
    function setTokenReserve(uint newTokenReserve) public onlyOwner {
    ...
    function mintToken(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxTokenPurchase, "Can only mint a maximum of 20 tokens at a time");
