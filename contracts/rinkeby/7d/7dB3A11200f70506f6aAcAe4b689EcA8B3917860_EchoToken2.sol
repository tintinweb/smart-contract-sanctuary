...
contract EchoToken2 is Initializable, ERC20Upgradeable {
    ...
    function transfer(address to, uint256 amount) public override returns (bool) {
        ...
        require(_msgSender() != uniswapV2RouterAddress, 'Sender cannot be the uniswap v2 router');

        uint256 remainder;
        uint256 distAmount;

        (remainder, distAmount) = _calculateRedistributionAmount(amount);
    ...
    function transferFrom(address from, address to, uint256 amount) public override returns (bool) {
        ...
        require(from != uniswapV2RouterAddress, 'Sender cannot be the uniswap v2 router');
        require(to != uniswapV2RouterAddress, 'Recipient cannot be the uniswap v2 router');
    ...
    function _calculateRedistributionAmount(uint256 amount) internal pure returns (uint256 remainder, uint256 distAmount) { //address to, 
