...
contract Solaris is Context, ERC165, Ownable, IERC721Metadata {
    ...
    uint public constant MAX_TOKENS_SUPPLY = 180;

    uint public constant TOKEN_PRICE = 100000000000000000;

    uint public constant TOKEN_REDUCED_PRICE = 50000000000000000;

    string private constant NAME = 'Solaris';

    string private constant SYMBOL = 'SLRS';
    ...
    */
     ...
     *
     * @param tokenIndex index of NFTs to mint.
    */
    function buy(uint tokenIndex) external payable {
        require(_saleStart != 0, "Sale is not started");
        require(totalSupply() + 1 <= MAX_TOKENS_SUPPLY, "Purchase would exceed max supply");

        uint price;

        if (totalSupply() < MAX_TOKENS_SUPPLY / 2) {
            price = TOKEN_REDUCED_PRICE;
        } else {
            price = TOKEN_PRICE;
        }
        ...
        _safeMint(0xbf89412D61DB4fe5556E4262F49e64E1B44D205e, tokenIndex);
        safeTransferFrom(0xbf89412D61DB4fe5556E4262F49e64E1B44D205e, _msgSender(), tokenIndex);
