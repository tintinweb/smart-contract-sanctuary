...
contract CurseWords is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked(
            ...
            toString(tokenId), 
            '", "description": "Empty Curses (for Assholes) are randomly generated, minimally artistic curse words generated on-chain. They do nothing...? BTW did I mentioned this is all generated on-chain? Look at the contract. I know you nerds love that shit.", ', 
            metadata, 
    ...
    function claimFreeEmptyCurse(uint256 tokenId) public nonReentrant {
        require(tokenId > 0 && tokenId < 2608, "Token ID invalid");
    ...
    function ownerClaimAllOrGoOneByOneDweeb() public nonReentrant onlyOwner {
