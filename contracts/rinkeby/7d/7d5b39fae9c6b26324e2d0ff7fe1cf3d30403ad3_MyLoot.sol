...
contract MyLoot is ERC721("My Loot", "MYLOOT") {
    // TODO: scarcity
    // TODO: require loot

    mapping(uint256 => string) weaponText;
    mapping(uint256 => string) chestText;
    mapping(uint256 => string) headText;
    mapping(uint256 => string) weaponTexts;
    mapping(uint256 => string) waistText;
    mapping(uint256 => string) footText;
    mapping(uint256 => string) handText;
    mapping(uint256 => string) neckText;
    mapping(uint256 => string) ringText;
