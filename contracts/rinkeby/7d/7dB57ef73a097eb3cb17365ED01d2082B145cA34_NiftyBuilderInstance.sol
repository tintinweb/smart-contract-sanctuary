...
contract NiftyBuilderInstance is ERC721, ERC721Burnable {
    ...
    string[24] artifact = ["Qma5iW6ch6kGE3GB1FkCvUt5LruJ3nZN7CjJQNZwifxSQH", //State 01
    ...
    constructor() ERC721() {
        ...
        _dateTimeContract = 0x740a637ADD6492e5FaA907AF0fe708770B737058;

        _setNiftyTypeName(1, "TODO: Nifty Name");
    }
...
contract ERC721 is NiftyEntity, Context, ERC165, IERC721, IERC721Metadata {
    ...
    constructor() NiftyEntity() {
        ...
        _typeCount = 1;
        _symbol = "SIXNFIVE";
        _name = "TODO: Collection Name";
        _baseURI = "https://api.niftygateway.com/sixnfive/"; 
        
        _defaultOwner = 0xBDbAEe6326cF7164EDaf107C525c1928B66d133f;
