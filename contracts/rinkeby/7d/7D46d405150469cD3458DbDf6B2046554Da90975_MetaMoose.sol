...
contract MetaMoose is ERC721, Ownable, ReentrancyGuard {
    ...
    function setHunters(uint16[] calldata ids) external onlyOwner {
        for (uint i = 0; i < ids.length; i++) {
            _isHunter[ids[i]] = true;
        }
    }
    ...
    */
    function publicMint(uint amount, bool stake) external payable nonReentrant {
