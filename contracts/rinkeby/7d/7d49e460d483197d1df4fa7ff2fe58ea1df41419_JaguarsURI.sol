...
contract JaguarsURI is Ownable {
    ...
    function traitGenerator(uint256 thisTraitCount, uint256 traitProbability) internal view returns(uint256) {
        ...
        else if (traitProbability >=6500 && traitProbability < 8000) {//common
            if(thisTraitCount < 2) {
        ...
        else if (traitProbability >=4500 && traitProbability < 6500) {//uncommon
            if(thisTraitCount < 3) {
        ...
        else if (traitProbability >=2500 && traitProbability < 4500) {//uncommon
            if(thisTraitCount < 4) {
        ...
        else if (traitProbability >=1900 && traitProbability < 2500) {//rare
            if(thisTraitCount < 5) {
        ...
        else if (traitProbability >=1300 && traitProbability < 1900) {//rare
            if(thisTraitCount < 6) {
        ...
        else if (traitProbability >=800 && traitProbability < 1300) {//rare
            if(thisTraitCount < 7) {
        ...
        else if (traitProbability >=500 && traitProbability < 800) {//super rare
            if(thisTraitCount < 8) {
        ...
        else if (traitProbability >=200 && traitProbability < 500) {//super rare
            if(traitCount < 9) {
        ...
        else if (traitProbability >=0 && traitProbability < 200) {//legendary
    ...
    function setBabyJagTraitCount(uint256 count) public onlyOwner {
