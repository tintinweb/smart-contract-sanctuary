...
contract SaberMountain is ERC721Enumerable, Ownable {
  /* Define */
    ...
    modifier whitelistMintingOpen() {
      require(closedAllSales == false, 'The sale has ended, try buying in the open market');
      require(isPublicLive == false, 'Our whitelist sale has ended, however our public sale is still live');
    ...
    function publicMint(uint qty) external payable publicMintingOpen {
      ...
      /* send to mint */
      _mintWithoutValidation(msg.sender, qty);
     }
