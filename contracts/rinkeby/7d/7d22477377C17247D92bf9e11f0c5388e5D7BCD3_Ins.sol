...
contract Ins is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    constructor() ERC721("The INS", "INS") {}

    uint256 public PRICE = 0.006 ether;
    uint256 public constant GIFT_SUPPLY = 27;
    uint256 public constant PUBLIC_SUPPLY = 200;
    ...
    function purchase(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            _safeMint(msg.sender, _publicTokenIdCounter.current());
