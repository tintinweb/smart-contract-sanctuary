...
// File: contracts\DataSet5.sol

contract DataSet5 is ERC721Mintable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("DataSet5", "DataSet5", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset5/metadata/token/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset5/metadata/contract/metadata.json";
    }
}