    ...
    PaymentSplitter
{
    ...
    uint256 constant GIFT_SUPPLY = 45;
    uint256 constant PUBLIC_SUPPLY = 9955;
    ...
    function purchase(uint256 _quantity) public payable override {
    ...
    function presalePurchase(uint256 _quantity) external payable override {
        require(!paused, "Contract is paused");
        ...
        require(
            _quantity <= PRESALE_MINT_LIMIT,
            "Quantity exceeds PRESALE_MINT_LIMIT"
        );
        require(
            _quantity + totalPublicMinted <= MAX_PRESALE,
            "Purchase exceeds available presale supply"
        );
        require(
            _quantity + totalPublicMinted <= PUBLIC_SUPPLY,
            "Purchase exceeds available supply"
