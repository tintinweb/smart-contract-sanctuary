...
contract ECNFT is ERC721, Ownable, Pausable {
    ...
    constructor(
        ...
        require(_sale_start < _sale_end, "SS");
        require(_owner_wallet != address(0), "0x");
        require(_creator_wallet != address(0), "Co");
    ...
    function setNewCardType(
        ...
        if (cardTypeCount > 0) {
            ...
            require(_start > _localCard.end, "Ne");
        }
    ...
    function _beforeTokenTransfer(
        ...
        require(transferAllowed(_from, _to), "Tr");
