...
contract Staking is Ownable {
    ...
    function claimAll() whenNotPaused eoaOnly public {
        uint reward = getClaimAmountOfAccount(msg.sender,block.timestamp);
        if(reward > 0) {
    ...
    function getClaimAmountOfAccount(address account, uint endTimestamp) public view returns(uint total) {
