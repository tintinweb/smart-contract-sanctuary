 ...
 */
contract Creature is ERC721Tradable, IL2MintableNFT
{
    event MintFromL2(
        address owner,
        uint256 id,
    ...
    function mintFromL2(
        ...
        onlyFromLayer2
    {
        require(minter == owner(), "INVALID_MINTER");
    ...
    function tokenURI(uint256 _tokenId)
        ...
        returns (string memory)
    {
        return string(abi.encodePacked(baseTokenURI(), encodeBase58(_tokenId)));
    }

    function encodeBase58(uint256 data)
        public
        pure
        returns (string memory)
    {
        ...
        bytes memory alphabet = BASE58_ALPHABET;
