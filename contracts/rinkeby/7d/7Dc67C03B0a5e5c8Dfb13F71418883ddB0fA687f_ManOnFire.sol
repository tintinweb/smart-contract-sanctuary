...
contract ManOnFire is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xBcF52894955012a36C60473E303E570deC892346); // Marketing Address

    address payable public liquidityAddress =
        payable(0xA1B729591c2fcC1f3286013620b1D055A3006Ab1); // Liquidity Address
                
    address payable public devAddress =
        payable(0xD6e84c0079cA23a984411f984177581c3f10958b); // Dev Address
    ...
    constructor() payable {
        ...
        maxBuyAmount = _tTotal * 25 / 10000; // 0.025% maxTransactionAmountTxn
        maxSellAmount = _tTotal * 25 / 10000; // 0.025% maxTransactionAmountTxn
        maxWallet = _tTotal * 1 / 1000; // 0.1% max Wallet
    ...
    function airdropToWallets(address[] memory airdropWallets, uint256[] memory amount) external onlyOwner() {
        ...
        for(uint256 i = 0; i < airdropWallets.length; i++){
            ...
            uint256 airdropAmount = amount[i]  * (16**9);
    ...
    function updateMaxBuyAmount(uint256 newNum) external onlyOwner { 
        require(newNum >= (_tTotal * 25 / 10000)/1e16, "Cannot set max buy amount lower than 0.025%"); 
        maxBuyAmount = newNum; 
    ...
    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (_tTotal * 25 / 10000)/1e16, "Cannot set max sell amount lower than 0.025%");
