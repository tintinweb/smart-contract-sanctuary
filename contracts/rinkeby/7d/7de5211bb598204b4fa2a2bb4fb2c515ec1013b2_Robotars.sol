...
{
    using SafeMath for uint256;
    string constant NAME = "Robotars";
    string constant SYMBOL = "Robotars";
    string constant _CONTRACT = "ERC1155";
    uint256 constant MAX_TOTAL_SUPPLY = 5000;
    uint256 constant MAX_NUM_PER_TOKEN = 1;
    uint256 constant batchCount = 50;
    uint256 private price = 0.06 ether; //6000000000000000; // 0.06 ETH;

    
    
    // Random tokens assignment
    uint256 internal currentID = 0;
    uint256 internal nonce = 0;
    uint256[MAX_TOTAL_SUPPLY] internal indices;

    string private URI_BASE = "https://robotars.s3.us-west-1.amazonaws.com/metadata/robotars-metadata-";
    ...
    function mintPresale(uint256 _customBatchCount) external payable {
    ...
    function _batchMint(address _to, uint256 num) private {
        ...
        uint totalSize = MAX_TOTAL_SUPPLY - currentID;
        uint256 range = num;
        require(
            range <= totalSize,
            "Sorry, Request More than TotalSupply, Please Change Number"
    ...
    function randomToken() internal returns (uint) {
        uint totalSize = MAX_TOTAL_SUPPLY - currentID;
