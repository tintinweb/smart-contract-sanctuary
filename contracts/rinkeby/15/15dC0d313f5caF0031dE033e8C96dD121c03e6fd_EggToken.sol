...
contract EggToken is ERC20("EGG", "EGG"), OwnableContract{
    ...
    function checkRestrictions(uint256 userAddUpCchickCount, uint256 useAddUpClaimEggCount) internal view returns(bool){
        require(useAddUpClaimEggCount <= userAddUpCchickCount, 'error: useAddUpClaimEggCount > userAddUpCchickCount');
        uint256 index = 0;
        ...
        require(maxEggAmount >=  useAddUpClaimEggCount, 'error: maxEggAmount <  useAddUpClaimEggCount');
    }
