...
// File: contracts/library/CifiUtil.sol
...
// File: contracts/nft/AssetToken.sol
...
contract NFTAsset is ERC721Full, Governance {
    // for minters
    mapping(address => bool) public _minters;



    constructor() public ERC721Full("BlockSportOne", "BSC1") {
        _setBaseURI("https://imgur.com/AsrcHEx");
    }
    ...
    function mint(address to, uint256 tokenId) external returns (bool) {
        ...
        _mint(to, tokenId);
        _setTokenURI(tokenId, CifiUtil.uintToString(tokenId));
        return true;
    }
