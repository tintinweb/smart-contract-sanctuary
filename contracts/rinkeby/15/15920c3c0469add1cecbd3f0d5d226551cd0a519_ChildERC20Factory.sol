...
contract ChildERC20Factory is Factory {
    ...
    function create(string calldata name_, string calldata symbol_, uint8 decimals_, address childChainManager) 
        external
        returns (address wallet)
    {
        ChildERC20 newWallet = new ChildERC20(name_, symbol_, decimals_, childChainManager); 
