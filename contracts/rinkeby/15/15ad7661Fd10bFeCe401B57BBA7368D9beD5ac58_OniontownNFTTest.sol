 ...
 */
 ...
 contract OniontownNFTTest is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Oniontown NFT Test", "OTNFTT") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x01656bF91F43d44C1d0AE2d55B4683a1e89ef247);
          _setupRole(MINTER_ROLE, 0x01656bF91F43d44C1d0AE2d55B4683a1e89ef247);
          _setupRole(MINTER_ADMIN_ROLE, 0x01656bF91F43d44C1d0AE2d55B4683a1e89ef247);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
         transferOwnership(0x01656bF91F43d44C1d0AE2d55B4683a1e89ef247);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "OniontownNFTTest/minter-role-required");
         _mint(to, tokenId);
