          ...
          Base64.encode(
            bytes(
              abi.encodePacked(
                ...
                '", "animation_url": "',
                'https://arweave.net/IYw29Hgb-inCRC0u2W_wtlNlG0YWp2KgIOIiBWbCVdk',
                '", "image": "',
                'https://arweave.net/2wrIALnOAWSNg3dZT1_Je4ZowsgxL288MA_MnpX_FJc',
                '", "license": "',
                getLicense(cID),
                '", "attributes": [',
                encodedMetadata,
...

{
  ...
  "libraries": {
    "contracts/LibPackStorage.sol": {
      "LibPackStorage": "0x800ed6eb614165d9dcc4ed7d22d7c2d450e87fae"
    }
  }
}