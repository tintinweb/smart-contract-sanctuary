...
contract RedCats is ERC721Enumerable, Ownable {
    ...
    address private _withdrawAddress = 0x4368c224665CC098A70FE4C1322218ae03511395;

    constructor(string memory baseURI) ERC721("Red Cat Test", "RCDT")  {
        setBaseURI(baseURI);
    }
...
contract interaction {
    RedCats contract_ = RedCats(0xB59555dd1e07b1016D88365BB872cd62194609E4);

    function getPrice() public view returns (uint) {
        return contract_.getPrice();
    }

    function getTotal() public view returns (uint) {
        return contract_.totalSupply();
    }
}