...
contract Papr is ERC20Burnable, DoubleOperator {
    ...
    function getFeesInExpansionPeriod() external view returns (uint256) {
        return feesInExpansionPeriod;
    }

    function getFeesInDepletionPeriod() external view returns (uint256) {
        return feesInDepletionPeriod;
    }
