...
contract SuperFuzzBadBatch is ERC721URIStorage, ERC721Enumerable, Pausable, PaymentSplitter {
    ...
    uint public presaleStartTime = 1630813156; // 12pm PST -> this will last for 9 hours
    uint public publicSaleStartTime = presaleStartTime + 7 minutes; // starts 9 hours after the presale
    ...
    address private GoldTicketAddress = 0x011559303cc953e30555B8EDcFC746d98E41e8Ae; // TODO: This needs to point to mainnet
    SuperFuzzGoldTicket goldTicket;

    // Team Address

    address[] private _team = [
        0x0C88ECF7FeEbBA1755282B87F5bDbF5A4b5eA08C, // 85
        0x290cB1eA2653Afcd1e3e5a89dDB49ccb2737Fd67, // 10
        0x9247502d319A57eF23A602ABcC4B1d0f180e3BC7 // 5
    ];
        ...
        PaymentSplitter(_team, _team_shares)
    {
        ...
        isTeam[0x0C88ECF7FeEbBA1755282B87F5bDbF5A4b5eA08C] = true; // patches address
    ...
    modifier verifyBuy(address _to, uint _amount) {
        ...
        require(howManyMonsters[_to] >= maxPerWallet == false, "Nice Try! You shall not have more than 2 in your wallet.");
    ...
    function setMaxTx(uint _amount) external onlyTeam { // TODO: only for debugging
        maxPerTx = _amount;
    }
    ...
    function getBalance() public view returns(uint) { // Todo: only for debugging
    ...
    function getHowManyMonster(address _addr) public view returns (uint) { // Todo: Only for debugging
       return howManyMonsters[_addr];
    }
    ...
    function setPreSaleTime(uint _newTime) public onlyTeam {
        ...
        publicSaleStartTime = _newTime + 7 minutes;
    }
...
contract SuperFuzzGoldTicket is Ownable, ERC721URIStorage, ERC721Enumerable {
    ...
    Counters.Counter private _tokenIds;
    string public PROVENANCE = "";
    uint256 public MAX_TICKETS = 150;
    uint256 public TICKET_PRICE = 0.03 ether;
    ...
    constructor() ERC721("Superfuzz Gold Tickets", "SFGT") {
    ...
    function buyTicket() external payable {
        address _to = msg.sender;
        require(msg.value == TICKET_PRICE, "Not enough ETH, try again");
