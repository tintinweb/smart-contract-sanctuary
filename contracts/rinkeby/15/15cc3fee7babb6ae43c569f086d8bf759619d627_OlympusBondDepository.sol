...
contract OlympusBondDepository is Ownable {
    ...
    function redeem() external returns ( bool ) {        
        for ( uint i = 0; i < depositorInfo[ msg.sender ].lastIndex; i++ ) {
            Bond memory bond = depositorInfo[ msg.sender ].bonds[ i ];
            ...
            if ( !bond.vested ) {
                ...
                if ( percentVested >= 10000 ) { // if fully vested
                    ...
                    depositorInfo[msg.sender].totalPayoutRemaining.sub( bond.payoutRemaining );
                    ...
                    depositorInfo[msg.sender].totalPayoutRemaining.sub( payout );
