...
contract HellHounds is ERC721Enumerable, Ownable {  
    ...
    constructor (string memory newBaseURI /*bytes32 merkleRoot*/) ERC721 ("Hell Hounds", "HH") {
    ...
    function purchasePresale(uint256 _amount, bytes32[] calldata proof) external payable {
        require(canMintPresale(msg.sender, proof), 'cannot mint presale');
        require( msg.value == price * _amount,   "Incorrect Amount Of ETH Sent" );
    ...
    function canMintPresale(
        ...
        require(presaleActive, "presale hasn't started");
