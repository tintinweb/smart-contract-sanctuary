...
contract Oily is ERC721Enumerable, Ownable {
    ...
    /// @dev if bool = true, address is eligible to claim their reserved oily
    ...
    /// @dev this function will initialize the presale whitelist with a constant list of address taken from the oilys cryptosign
    ...
    /// @dev this is the presale mint function, open to a list of whitelisted wallets who signed up for the presale
    ...
    /// @dev this is the regular mint function, which is open to the public in the open phase
    ...
    /// @notice Just in case Eth does some crazy stuff and we want to adjust
    ...
    ///@dev new token uri function TODO: test this out XD
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
