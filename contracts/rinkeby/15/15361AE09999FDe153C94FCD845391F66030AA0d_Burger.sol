    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(address pauseMintRoleAddress_) public initializer {
        __ERC721_init("Burger", "BURGER");
        __Ownable_init();
        // __AccessControl_init();
        boxPriceBNB = [1e16, 2 * 1e16, 3 * 1e16];
        boxPriceBURG = [1e16, 2 * 1e16, 3 * 1e16];
        strBaseTokenURI = "http://localhost:8080/api/metadata/";
        ...
        returns (uint256)
    {
        ...
        payable(msg.sender).transfer(msg.value - boxPriceBNB[boxType]);
        // TODO:  Transferir el BNB a una address y que no se quede en el contrato.
    ...
    function withdraw() external onlyOwner {
        // TODO:  Cambiar a billetera directa ¿?
    ...
    function getLimitTokenAmountPerBoxType(uint8 boxId)
        external
        view
        returns (uint256)
    {
        // TODO:  Revisar si esta función es realmente necesaria o podemos partir de "remaining boxes"
...
contract BurgToken is Initializable, ERC20CappedUpgradeable, OwnableUpgradeable {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;
    using AddressUpgradeable for address;
    ...
    function initialize() public initializer {
        ...
        // Añadir las cuentas de minteo
        _mint(msg.sender, 50 * 10e6 * 1e18); // Play to earn 50M // TODO: Enviar 10M al bridge y 40 a otra billetera ?
        _mint(msg.sender, 30 * 10e6 * 1e18); // Team (12M), Advisors (7M), Marketing (5M), Platform Development (5M), Airdrop (1M) - Total 30M
        _mint(msg.sender, 20 * 10e6 * 1e18); // DxSsale Public sale (12M), Liquidity (8M) // TODO:  Incluir otros fees.  Hacer simulación.
    }
