...
contract TestTokens is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://localhost:5005/@PROJECTID/metadata/image/62.png";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/62/contract-uri";
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("TestTokens", "TST") {
