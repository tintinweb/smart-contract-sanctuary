...
//    event Mint(address indexed to, uint256 indexed idStart, uint256 indexed quantity);
...
//        _pause();
    ...
    function mint(uint256 amount) external payable whenNotPaused {
        ...
        // Replaces Transfer() event for a single mint event, saving almost 3k gas per any mint over 1
//        emit Mint(msg.sender, ogAmount, amount);
    }

    // TODO: CHECK OPENSEA DOES NOT NEED TRANSFER EVENT
    function _mint(address to) internal virtual {
        // Transfer event removed for new mints - its a waste of gas
        _owners.push(to);
