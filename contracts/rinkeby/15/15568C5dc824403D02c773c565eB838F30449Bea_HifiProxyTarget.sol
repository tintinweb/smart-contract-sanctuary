...
contract HifiProxyTarget is IHifiProxyTarget {
    ...
    event DebugUnderlyingAmounts(uint256 totalUnderlyingAmount, uint256 maxUnderlyingAmount);
    event DebugHTokenAmounts(uint256 hTokenRequired, uint256 hTokenOut);
    ...
    function buyHTokenAndAddLiquidity(
        ...
        emit DebugUnderlyingAmounts(totalUnderlyingAmount, maxUnderlyingAmount);
        (uint256 hTokenRequired, ) = hifiPool.getMintInputs(underlyingRequired);
        emit DebugHTokenAmounts(hTokenRequired, hTokenOut);
