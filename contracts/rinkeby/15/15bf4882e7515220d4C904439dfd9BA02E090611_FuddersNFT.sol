...
contract FuddersNFT is ERC721("Fudders", "NGMI"), Ownable {
    ...
    uint256 public constant MAX_TEAM_SUPPLY = 20;
    ...
    constructor() public {
        tokenID = 0;
        saleIsActive = false;
        remainingTeamSupply = MAX_TEAM_SUPPLY;
        _setBaseURI("http://api.fudderverse.com/");
    }
    ...
    function teamMint(uint256 numberOfTokens) public onlyOwner {
        require(
            numberOfTokens <= remainingTeamSupply,
            "Can not mint that many team Fudders"
        );
        require(
            totalSupply().add(numberOfTokens) <= MAX_SUPPLY,
        ...
        remainingTeamSupply -= numberOfTokens;
