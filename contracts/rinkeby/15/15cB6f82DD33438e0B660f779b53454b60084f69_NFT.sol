...
contract NFT is AccessControl, ERC2981ContractWideRoyalties, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(AccessControl, ERC2981Base, ERC721, ERC721Enumerable)
        returns (bool)
    {
