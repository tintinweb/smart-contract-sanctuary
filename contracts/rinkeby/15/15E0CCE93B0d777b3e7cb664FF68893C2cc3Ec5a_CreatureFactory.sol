...
contract CreatureLootBox is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress, address _factoryAddress)
        ERC721Tradable("MyPandaverse LootBox", "PANDAVS", _proxyRegistryAddress)
    {
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmNu94VKmSvdT7F4GgJYv8dxbNWcNw3rhL7LkBfvpNmbVe/";
    }
...
contract Creature is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Test My Pandaverse NFT", "PANDANFT", _proxyRegistryAddress)
    {}
