...
contract TNC is ERC721Tradable {  //nome del file 
    
    //nome del contratto e sigla contratto
    constructor(address _proxyRegistryAddress) ERC721Tradable("The Nemesis Companions", "TNC", _proxyRegistryAddress){}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://companions.thenemesis.io/api/v1/assets/"; //1-2-3 metadati della collection
    }
