...
contract DeadProtestSociety is ERC721Enumerable, Ownable {
    ...
    uint256 public constant DPS_PRIVATE = 800;
    uint256 public constant DPS_PUBLIC = 8000;
    uint256 public constant DPS_MAX = DPS_GIFT + DPS_PRIVATE + DPS_PUBLIC;
    ...
    address private _signerAddress = _CTOAddress;
    ...
    constructor() ERC721("DeadHeads", "DPS") { }
    ...
    function buy(bytes32 hash, bytes memory signature, string memory nonce, uint256 tokenQuantity) external payable {
        ...
        require(publicAmountMinted + tokenQuantity <= DPS_PUBLIC, "EXCEED_PUBLIC");
        require(tokenQuantity <= DPS_PER_MINT, "EXCEED_DPS_PER_MINT");
    ...
    function presaleBuy(uint256 tokenQuantity) external payable {
        ...
        require(totalSupply() < DPS_MAX, "OUT_OF_STOCK");
        require(privateAmountMinted + tokenQuantity <= DPS_PRIVATE, "EXCEED_PRIVATE");
    ...
    function withdraw() external onlyOwner {
        ...
        payable(_CMOAddress).transfer(address(this).balance * 30 / 100);
    ...
    function amountAvailable() external view returns (uint256) {
        return DPS_MAX - (privateAmountMinted + publicAmountMinted + DPS_GIFT);
    }
