...
contract Words {
    ...
    function getFiveSyllableLine(uint256 tokenId, uint256 lineNum) external view returns (string memory, uint256, uint256) {
        ...
        return (string(abi.encodePacked(line[0], ' ', line[1])), wordSyllables[0], wordSyllables[1]);
    }
    ...
    function getSevenSyllableLine(uint256 tokenId, uint256 lineNum) external view returns (string memory, uint256, uint256, uint256, uint256) {
        ...
        return (string(abi.encodePacked(line[0], line[1], line[2], line[3], line[4], line[5], line[6])), wordSyllables[0], wordSyllables[1], wordSyllables[2], wordSyllables[3]);
    }
