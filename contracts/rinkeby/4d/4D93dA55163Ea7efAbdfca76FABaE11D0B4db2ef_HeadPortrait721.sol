...
contract HeadPortrait721 is ERC721Enumerable, OwnableContract{
    ...
    mapping(uint256 => Attribute) public tokenIdToAttributesMap;
    ...
    function mint(address user, uint256 tokenId, uint256[] memory attributes) public onlyDev{
        ...
        attribute.hat = attributes[0];
        attribute.skinColor = attributes[1];
        attribute.eyes = attributes[2];
        attribute.beak = attributes[3];
        attribute.clothes = attributes[4];
        attribute.background = attributes[5];
