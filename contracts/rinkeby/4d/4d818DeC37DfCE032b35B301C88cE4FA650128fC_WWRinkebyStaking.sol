...
import './../ERC20/ControllableERC20.sol';
import './../ERC721/base/CoreERC721.sol';


contract ERC721Receiver is IERC721Receiver, IStakeActions, Ownable {
    constructor(address _tokenContract, address _nftContract) {
        tokenContract = ControllableERC20(_tokenContract);
        nftContract = CoreERC721(_nftContract);
    }
...
contract WWRinkebyStaking is ERC721Receiver {
    constructor() ERC721Receiver(
      0x960e70a84acEecd71b2D137970757F5F353396f0,
      0x9A1E359A9cF912792C77394a132bC057dE139a89
    ) {}
}
