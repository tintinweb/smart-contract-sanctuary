...
contract TestTestTest is ERC721Enumerable, Ownable {
        ...
        public
    {
        ...
        require(block.number > thisBreedingEvent.blockNumber);
    ...
    function revealBaby(uint256 _tokenId) public {
        ...
        require(block.number > _tokenToBreedingEvent[_tokenId].blockNumber);
