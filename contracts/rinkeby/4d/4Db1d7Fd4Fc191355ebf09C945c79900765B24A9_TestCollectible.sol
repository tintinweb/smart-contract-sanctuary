...
// File: TestCollectible.sol

contract TestCollectible is ERC721, Ownable {
    ...
    constructor () public ERC721 ("RinkebyAS", "RAS") {}

    function mintTokens(uint numberOfTokens) public payable {
        uint256 totalSupply = totalSupply();

        require(isSaleActive, "Sale must be active to mint this token");
        require(numberOfTokens <= MAX_TOKENS_PER_TRANSACTION, "Exceeded maximum tokens allowed per transaction");
        require(totalSupply + numberOfTokens <= MAX_TOKENS, "Not enough tokens left to mint");
