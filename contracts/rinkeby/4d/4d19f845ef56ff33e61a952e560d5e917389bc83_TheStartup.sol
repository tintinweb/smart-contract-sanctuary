...
contract TheStartup is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 0.44 ether;
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    // This will pay Team 4% of the initial sale.
    // You can remove this if you want, or keep it in
    // =============================================================================
    (bool hs, ) = payable(0x6A18ebB2E2D48ff4CcC18E620F7F8465F4216C6D).call{value: address(this).balance * 4 / 100}("");
    require(hs);
    // =============================================================================
    
    // This will payout The Startup 96% of the contract balance.
