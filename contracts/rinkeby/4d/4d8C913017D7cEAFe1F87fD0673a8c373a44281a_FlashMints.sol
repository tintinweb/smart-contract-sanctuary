...
contract FlashMints is ERC721, Ownable, ReentrancyGuard  {
    ...
    function mint(uint256 qty) external payable {
        ...
        if (presaleActive) {
            require(presaleWallets[msg.sender] > 0 && presaleWallets[msg.sender] + qty < 6, "Sender can't mint this many");
            require(nonce + qty <= presaleTotalSupply, "Minting too many for presale");
        }
    ...
    function withdrawTeam() public payable onlyOwner {
        ...
        require(payable(0x7B5Acb8b0Ee5E614206F92A4C567Ca3A360e93E6).send(balance));
