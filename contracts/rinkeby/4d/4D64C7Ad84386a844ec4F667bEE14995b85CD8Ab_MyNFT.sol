...
contract MyNFT is ERC721URIStorage, Ownable
{
    ...
    uint256 public MintForWhiteListed = 7;
    uint256 public MintForNonWhiteListed = 3;
    ...
    function removeAddress(address _address, uint256 id) public onlyOwner 
    {
    ...
    function mintNFT(address recipient, string memory tokenURI) public payable
    {
        ...
        if(whiteLister)
        {
            require(NFTperAddress[recipient] < MintForWhiteListed , 'limit exceeded');
        ...
        {
            require(NFTperAddress[recipient]  < MintForNonWhiteListed , 'limit exceeded');
            require( msg.value <= PRICE, 'not enough ether to purchase');
