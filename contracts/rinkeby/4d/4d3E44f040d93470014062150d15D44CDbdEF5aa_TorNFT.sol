...
contract TorNFT is ERC721PresetMinterPauserAutoId {
    // the name and symbol for the NFT

    bool private _active;
    string private _tokenURIPrefix;
    address private _owner = 0xBD2B82232e0954ade8a437709C95eDae33b9252a;
    ...
    constructor()
        ERC721PresetMinterPauserAutoId(
            "Deez nuts 6",
            "DEEZ6",
            "https://www.chaosblocks.art/api/token/"
        )
    {
        _active = true;
    }
    ...
    function purchase(uint256 amount) external payable {
        ...
        require(amount <= 5, "Too many requested");
        require(amount <= 100 - super.amountMinted(), "Not enough left");
        require(
