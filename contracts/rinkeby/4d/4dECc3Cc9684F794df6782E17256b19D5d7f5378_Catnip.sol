...
contract Catnip is Context, IBEP20, Initializable {
    ...
    ////////////// PRESALE FUNCTION
    function presaleBuy(uint256 amountOfBNBToInput, uint256 keyCode) external {
        ...
        require(amountOfBNBToInput < 100, "Capped at 100 BNB, please input less BNB.");       // CHANGEIT - presale limits
        ...
        uint256 howMuchMoneyInput = amountOfBNBToInput.mul(uint256(currentPrice));
        ...
        transferBNBToTeamWallet(this, amountOfBNBToInput); 
