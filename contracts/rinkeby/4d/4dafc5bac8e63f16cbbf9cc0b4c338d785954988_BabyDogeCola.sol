...
/**
 *Submitted for verification at oklink.com/ on 2021-08-04
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20  DogeCola = IERC20(0xe320Df552e78D57E95cF1182B6960746d5016561);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DogeCola.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(DogeCola);
        ...
        uint256 amount = DogeCola.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DogeCola.transfer(shareholder, amount);
...
contract BabyDogeCola is IERC20, Ownable {
    using SafeMath for uint256;

    address DogeCola = 0xe320Df552e78D57E95cF1182B6960746d5016561;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyDogeCola";
    string constant _symbol = "BabyDogeCola";
    ...
    function setTxLimit(uint256 amount) external onlyOwner {
        require(amount >= _totalSupply / 1000000000000000);
    ...
    function setSellMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 3 && multiplier * totalFee <= 10000, "Multiplier too high");
