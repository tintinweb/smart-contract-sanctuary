...
contract BbwlToken {
    string constant public name = "BabyWhale";
    string constant public symbol = "BBWL";
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'BBWL: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'BBWL: INVALID_SIGNATURE');
