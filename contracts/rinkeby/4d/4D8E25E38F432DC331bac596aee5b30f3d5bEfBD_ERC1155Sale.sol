...
contract ERC1155Sale is ReentrancyGuard {
    ...
    function buy(
        ...
        ikonicTokenContract.transferFrom(msg.sender, address(this), tokenPrice * buying);

        uint256 price = tokenPrice * buying.mul(10000).div(serviceFeeProxy.getBuyServiceFeeBps(msg.sender).add(10000)).div(buying);
        ...
        transferEther(token, tokenId, owner, buying);
    ...
    function transferEther(
        ...
        uint256 price = (tokenPrice * buying).mul(10000).div(serviceFeeProxy.getBuyServiceFeeBps(msg.sender).add(10000));
        ...
        ikonicTokenContract.transfer(serviceFeeRecipient, sellerServiceFee.add((tokenPrice * buying).sub(price)));
