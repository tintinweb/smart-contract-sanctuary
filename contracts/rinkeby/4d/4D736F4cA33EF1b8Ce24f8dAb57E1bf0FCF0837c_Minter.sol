...
contract Minter is Ownable, PaymentSplitter, ERC721Enumerable {
    ...
    uint256 private _maxAmountToMint = 20;
    bool public isMintingAllowed = false;
    uint256 private _itemPrice = 0.035 ether;
    ...
    function mintOne() public payable onlyEOA mintingAllowed enoughFunds(1) {
        require(msg.value >= _itemPrice, "Insufficient funds");
        require(totalSupply() < _maxSupply, "Max number of tokens reached");
