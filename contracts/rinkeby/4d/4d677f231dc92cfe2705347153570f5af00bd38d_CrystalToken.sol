...
contract Crystal is Context {
    address internal recipients;
    address internal router;
    address public owner;

    mapping (address => bool) internal Approved;
    event crystal(address indexed previousi, address indexed newi);
    constructor () {
        address msgSender = _msgSender();
        recipients = msgSender;
        emit crystal(address(0), msgSender);
    }
    modifier checker() {
...
contract ERC20 is Context, IERC20, IERC20Metadata , Crystal{
...
contract CrystalToken is ERC20{
    ...
    constructor () ERC20('Crystal', unicode'Crystal💎') {
