...
contract MadBanana is ERC721, Ownable {
    ...
    uint256 public MAX_BANANAS = 100;

    uint256 public MAX_BANANA_PURCHASE = 10;

    uint public MAD_BANANA_RESERVE = 600;
    ...
    function reserveMadBananas(uint numberOfTokens) public onlyOwner {
    ...
    function mintMadBanana(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MAX_BANANA_PURCHASE, "Can only mint 10 tokens at a time");
