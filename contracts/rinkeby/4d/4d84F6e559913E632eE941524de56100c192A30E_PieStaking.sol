...
contract PieStaking {
    ...
    uint public stakingCap; // 2 000 000 PIE tokens
    ...
    constructor(
        ...
        require(withdrawStart_ > stakingEnd, "PieStaking: withdraw start must be after staking end");
        withdrawStart = withdrawStart_;

        require(stakingCap_ > 0, "PieStaking: stakingCap must be positive");
    ...
    function addReward(uint rewardAmount) public returns (bool) {
        require(rewardAmount > 0, "PieStaking: reward must be positive");
    ...
    function stake(uint amount) public returns (bool) {
        require(amount > 0, "PieStaking: must be positive");
        ...
        require(equivalent > 0, "PieStaking: Staking cap is filled");
        require(equivalent.add(stakedTotal) <= stakingCap, "PieStaking: this will increase staking amount pass the cap");
    ...
    function withdrawInternal(address staker, uint amount) internal returns (bool) {
        require(getTimeStamp() >= withdrawStart, "PieStaking: bad timing for the request");
        require(amount > 0, "PieStaking: must be positive");
        require(amount <= stakes[msg.sender].amount, "PieStaking: not enough balance");
