...
contract MintdropzERC721Factory {
    ...
    event Deploy(address _newContractAddress, address _owner);
    ...
    function deploy(
        ...
        pool = address(new MintdropzERC721(_name, _symbol, _royaltyReceiver, _royaltyPercent, _DENOMINATOR));
        emit Deploy(pool, msg.sender);
    }
}
