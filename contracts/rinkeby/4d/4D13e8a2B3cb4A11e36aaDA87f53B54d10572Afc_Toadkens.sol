...
contract ToadkensERC721 is ERC721Enumerable, Ownable {
...
contract Toadkens is ToadkensERC721 {
    ...
    constructor(string memory name, string memory symbol, uint256 supply) ToadkensERC721(name, symbol, supply) {}
