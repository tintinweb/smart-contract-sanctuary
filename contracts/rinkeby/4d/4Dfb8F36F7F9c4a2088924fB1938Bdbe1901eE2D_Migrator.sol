...
// Part: ERC721Interface

interface ERC721Interface is IERC721 {
}
...
contract Migrator is Context, IERC721Receiver {
    ...
    ERC721Interface petZoo;
    ERC721Interface tombheads;
    ...
    constructor (address minter, address oldContract, address newContract) {
        ...
        petZoo = ERC721Interface(_oldContract);
        tombheads = ERC721Interface(_newContract);
        _minter = minter;
    }
