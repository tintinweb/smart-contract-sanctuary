...
contract TESTCollectiblesLaunchNFT is ERC721PresetMinterPauserAutoId {
    /**
     * @dev Grants `DEFAULT_ADMIN_ROLE`, `MINTER_ROLE` and `PAUSER_ROLE` to the
     * account that deploys the contract.
     *
     ...
     * See {ERC721-tokenURI}.
     */
    constructor() ERC721PresetMinterPauserAutoId("TEST_CollectiblesLaunchNFT", "TEST_SYMBOL_2", "https://launchcollectible.audius.co/") { }
}