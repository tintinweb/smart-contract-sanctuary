 ...
 */
contract PlayfulPolars is Ownable, ERC721Pausable {
    using SafeMath for uint256;
    ...
    constructor(string memory baseURI) ERC721("Playfulbears Group", "jpg") {  
        _setBaseURI(baseURI);
    }
    ...
    */
    ...
    // function changeData(uint256 requestId, string memory tokenURI) public {
