...
contract ERC1155Token is ERC1155Base, SignerRole {
    ...
    */
    function initialize(string memory _name, string memory _symbol, address _signer, string memory _tokenURIPrefix)  public initializer {
        ERC1155Base.initialize(_tokenURIPrefix);
    ...
    function mint(uint256 _tokenId, bytes memory _signature, uint256 _supply) public {
        require(
            isSigner(
...
abstract contract ERC1155Base is OwnableUpgradeable, IERC1155MetadataURIUpgradeable, ERC1155Upgradeable {
    ...
    function initialize(string memory _tokenURIPrefix) public initializer {
...
contract SignerRole is AccessControlUpgradeable {
