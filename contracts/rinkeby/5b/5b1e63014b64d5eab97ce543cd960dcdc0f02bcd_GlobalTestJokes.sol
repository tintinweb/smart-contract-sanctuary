...
//Global Jokes Main Contract

contract GlobalTestJokes is ERC721Enumerable, Ownable {
    ...
    string private _metaBaseUri = "https://assets.globaljokes.io/";



    constructor() ERC721("GlobalTestJokes", "JOKE") {
        _saleIsActive = true;
    ...
    /**
     * Reserve a few jokes e.g. for giveaways
     */
