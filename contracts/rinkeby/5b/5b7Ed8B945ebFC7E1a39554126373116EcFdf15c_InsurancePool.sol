...
contract InsurancePool {
  ...
  function deposit() external payable {
    ...
    if(!isDepositor) insurers[msg.sender] = Insurer(payable(msg.sender), msg.value);
    depositCount++;
  ...
  function withdraw(uint _amount) external payable {
    require(insurers[msg.sender].balance > 0, "You should deposit first");
    require(msg.value <= insurers[msg.sender].balance, "You dont have enough deposit");
