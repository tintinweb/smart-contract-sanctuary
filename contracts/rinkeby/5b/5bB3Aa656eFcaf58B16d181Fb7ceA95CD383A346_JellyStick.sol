...
contract JellyStick is ERC721Enumerable, Ownable {
  ...
  uint256 public constant PRIVATE_MINT_PRICE = 0.01 ether;
  ...
  uint256 private _maxBalance = 20;

  mapping(address => bool) private _whiteList;

  /* WITHDRAW ADDRESS */
  address team0 = 0x4812cCA41e94fBD4293074e03C8442a1971c5664;

  /* TEAM */
  address team1 = 0xb4d1aEeFc9dA806BE4996C344b80D76C9d042371;
  address team2 = 0x66f914486A68cD3e2650C89bc150677D223e452c;
  address team3 = 0x9D0b47CcF5c59E8315160B518621A499D63d836f;
  address team4 = 0x68157833936dc494B59F2953e8EE3C7e0F0CBD50;

  constructor() ERC721("JellyStick", "JLY")  {
    _safeMint(team1, 0);
    _safeMint(team2, 1);
    _safeMint(team3, 2);
    _safeMint(team4, 3);
  ...
  function mintForWhiteList(uint count) public payable {
    ...
    require(count <= MAX_MINT_COUNT, "Exceeded max available to purchase");
    require(supply + count <= MAX_SUPPLY, "Purchase would exceed max tokens");
    require(balance + count <= _maxBalance, "The maximum number of possessions has exceeded");
    require(PRIVATE_MINT_PRICE * count <= msg.value, "Insufficient balance");
  ...
  function mint(uint count) public payable {
    ...
    require(supply + count <= MAX_SUPPLY, "Purchase would exceed max tokens");
    require(balance + count <= _maxBalance, "The maximum number of possessions has exceeded");
    require(PUBLIC_MINT_PRICE * count <= msg.value, "Insufficient balance");
  ...
  function withdraw() public onlyOwner {
    ...
    payable(team0).transfer(balance);
  }
}