...
contract Catryoshkas is ERC721, IE721Comp, ERC721Enumerable, Ownables {
    ...
    uint256 private constant _MINT_PRICE = 0.00 ether;
   ...
   function kittensMinted() public view returns (uint256) {
    ...
    function giveAway(uint256[] memory numberOfTokens_, address[] memory toAddresses_) public onlyOwners {
        ...
        for (uint256 addressIndex = 0; addressIndex < toAddresses_.length; addressIndex++) {
            ...
            for (uint256 counter = 0; counter < numberOfTokens_.length; counter++) {
                
                uint256 mintIndex = _MAX_MINT_SUPPLY.add(222).add(_reserveSupplyMinted);
                
                _safeMint(reciever, mintIndex);

                _reserveSupplyMinted = _reserveSupplyMinted.add(amount);
...
abstract contract IE721Comp {
    ...
    uint256[222] private _sC = [
        10, 888, 3659, 6486, 2150, 4109, 1381, 309, 5287, 5764, 1281, 2992, 4960,
        1991, 5460, 8742, 3855, 8114, 1179, 2865, 7244, 8339, 3342, 296, 729, 1937,
        145, 6208, 4566, 4869, 7026, 2741, 4158, 7793, 667, 8407, 3958, 6314, 1656,
        693, 5705, 6827, 3920, 4456, 3909, 7917, 1200, 4530, 6238, 2495, 660, 2606,
        7679, 3652, 1781, 7063, 3586, 4759, 5815, 519, 3836, 6403, 1365, 3813, 6886,
        3706, 4077, 6997, 1729, 3732, 2547, 7178, 8509, 41, 921, 2327, 1622, 2887,
        7803, 2697, 6698, 8561, 8833, 1799, 3729, 5901, 3314, 1786, 5034, 5776,
        1680, 8853, 5675, 2730, 1255, 1350, 1377, 7112, 8235, 7618, 7475, 6857,
        6706, 8832, 8412, 7529, 5406, 3585, 4551, 3828, 3590, 1644, 328, 4101, 31,
        7592, 6484, 894, 7032, 388, 7894, 2204, 934, 2148, 8462, 5375, 1057, 4131,
        3685, 592, 3849, 277, 941, 7553, 7543, 5595, 2569, 1928, 371, 2321, 4754,
        8497, 5603, 7983, 2880, 5720, 5238, 5987, 6633, 847, 3511, 8204, 6644, 4457,
        6819, 5358, 5829, 579, 6725, 479, 1535, 258, 4616, 6007, 8035, 5360, 3689,
        7243, 842, 1545, 8521, 161, 97, 5486, 1520, 8042, 5171, 5149, 3568, 1630,
        2177, 6178, 4552, 252, 8431, 6392, 8048, 5004, 1482, 5112, 5707, 5181, 5934,
        8004, 4738, 1169, 2792, 4067, 158, 3437, 7433, 7429, 7373, 1510, 8429, 799,
        435, 3115, 911, 607, 4008, 2210, 7228, 6539, 7019, 1240, 641, 4804, 7432,
        1927, 4880, 8548
    ];   
    
    uint256[111] private _kC = [
        3137, 6648, 5950, 4317, 6284, 6192, 5696, 4184, 2199, 5362, 447, 4595, 7290,
        1509, 6856, 1826, 4549, 4529, 6438, 7345, 3031, 5769, 6956, 4214, 996, 680,
        1486, 2819, 3396, 3512, 3410, 4345, 2191, 7249, 1705, 775, 2907, 837, 3805,
        7003, 2977, 7687, 3948, 6362, 480, 2102, 4512, 4113, 134, 7075, 7234, 5516,
        5425, 1748, 2338, 7836, 3821, 1746, 7899, 5678, 1131, 7695, 2328, 6364,
        2782, 3895, 2932, 2041, 1768, 8023, 5314, 2975, 6738, 1856, 153, 7603, 6457,
        1269, 6692, 7233, 6385, 1636, 2777, 7809, 1040, 5396, 1089, 4945, 1274,
        3017, 4454, 2886, 7848, 6204, 8140, 7332, 8037, 7723, 3190, 461, 8801, 4556,
        8065, 816, 730, 4743, 2515, 1158, 8786, 7149, 723
    ];
