...
contract FlashPokers is ERC721Enumerable, ReentrancyGuard, Ownable {
	...
	string[53] private thirdNames = ['Jack Spade', 'Jack Club', 'Jack Heart', 'Jack Diamond'];
	...
	function randomFlashPoker(uint256 tokenId) internal view returns (CardsObject memory) {
	...
	function getTraits(CardsObject memory FlashPoker) internal view returns (string memory) {
