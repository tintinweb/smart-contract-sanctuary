...
contract RetroPhones is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    string public PROVENANCE_HASH = "";
    uint256 public MAX_RETROPHONES;
    ...
    constructor() ERC721("RetroPhones", "RTP") {
      saleIsActive = false;
      MAX_RETROPHONES = 10000;
    ...
    function mintForCommunity(address _to, uint256 _numberOfTokens) external onlyOwner {
        ...
        require(totalSupply() + _numberOfTokens <= MAX_RETROPHONES, "RetroPhones: Minting would exceed cap");

        for(uint256 i = 0; i < _numberOfTokens; i++) {
          _tokenIdCounter.increment();
          uint256 tokenId = _tokenIdCounter.current();
            if (totalSupply() < MAX_RETROPHONES) {
    ...
    function mintRetroPhones(uint256 amount) external payable whenSaleActive {
        ...
        require(totalSupply() + amount <= MAX_RETROPHONES, "RetroPhones: Purchase would exceed cap");
