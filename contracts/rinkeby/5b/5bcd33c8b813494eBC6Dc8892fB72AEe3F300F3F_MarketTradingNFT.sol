...
contract MarketTradingNFT is ERC721("Market Trading NFT", "MTN") {
    ...
    function mint(address _beneficiary, string calldata _tokenUri, address _postCreator) external returns (uint256) {
        ...
        emit MarketTradingNFTMinted(tokenId, _postCreator, _beneficiary, _tokenUri);
     ...
     */
    function getNFTDetailByTokenId(uint256 tokenId) public view returns (
        uint256 _tokenId, 
        address _creator, 
        address _owner, 
        uint256 _tokenPrice, 
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    /**
     * @dev returns the all tokenIds that Account have.
     */
    function allTokensOfOwner(address owner) public view returns (bytes32[] memory) {
