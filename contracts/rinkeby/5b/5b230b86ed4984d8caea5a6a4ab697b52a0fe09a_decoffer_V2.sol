...
contract recommender{
    ...
    Credit_token CT = Credit_token(0xa6f5b8FE035BF5BB52380a099583D36036faceBd);
    ...
    constructor()public {
        ...
        rule_info[1][1] = 10*10**17;
        rule_info[1][2] = 20*10**17;
    ...
    function level_up()public payable{
       ...
       if(performance>=rule_info[1][1]){
           rt_info[msg.sender][4] = 2;
       }
       
       if(performance >= rule_info[1][2]){
           rt_info[msg.sender][4] = 3;
       }
    }
...
contract decoffer_V2{
    ...
    Credit_token CT = Credit_token(0xa6f5b8FE035BF5BB52380a099583D36036faceBd);
    recommender RT = recommender(0x74CC03d1f955DA9D00660Ee84DC290414f05c58E);
    ...
    //1.invest 2.price 3.credit 4.get_CT 5.discount  
