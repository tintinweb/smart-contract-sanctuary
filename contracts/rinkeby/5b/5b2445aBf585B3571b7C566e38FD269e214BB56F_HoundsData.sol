...
contract HoundsData is Ownable, ERC721, ERC721Holder, Payments {
    ...
    event NewHound(uint256 indexed houndIdStart, Hound.Struct hound);
    event BreedHound(uint256 indexed houndId, Hound.Struct hound);
    event EditHound(uint256 indexed houndId, Hound.Struct hound);
