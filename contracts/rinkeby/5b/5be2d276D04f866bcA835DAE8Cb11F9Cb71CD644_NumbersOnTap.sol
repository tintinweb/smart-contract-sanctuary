...
import "./IStringUtils.sol";

contract NumbersOnTap is ERC721 {
    uint public totalSupply = 0;
    uint public maxId;
    uint public maxMint = 10;
    IStringUtils stringUtils = IStringUtils(0x04B8b686f25CFd855c28071D1E50F2Be4F515654);
    ...
    function setStrings(string calldata _strStyle, string calldata _strTraitsData) public {
        require(!stringsSet, "Strings set");
        strStyle = _strStyle;
        strTraitsData = _strTraitsData;
        stringsSet = true;
    }
        ...
        returns (string memory)
    {
        ...
        bytes memory imageBytes = abi.encodePacked(
            "<svg viewBox='0 0 640 640' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' class='", classname, "'>", strStyle,
        ...
        string[] memory strTraits = stringUtils.split(strTraitsData, '|');
        ...
        bytes memory json = abi.encodePacked(string(abi.encodePacked(
            '{'
                ...
                '"image": "', image, '",'
                '"traits": [ ',
                    traits.div2 ? strTraits[0] : '',
                    traits.div3 ? strTraits[1] : '',
                    traits.div5 ? strTraits[2] : '',
                    traits.div7 ? strTraits[3] : '',
                    traits.div10 ? strTraits[4] : '',
                    traits.div11 ? strTraits[5] : '')),string(abi.encodePacked(
                    traits.div42 ? strTraits[6] : '',
                    traits.div69 ? strTraits[7] : '',
                    traits.div100 ? strTraits[8] : '',
                    traits.div360 ? strTraits[9] : '',
                    traits.div1000 ? strTraits[10] : '',
                    traits.pow2 ? strTraits[11] : '',
                    traits.sqr ? strTraits[12] : '',
                    strTraits[13],
                ']'
            '}'
        )));

        return string(abi.encodePacked('data:application/json;base64,', stringUtils.base64Encode(json)));
    }
