...
contract TruthToken is ERC721Enumerable, Ownable {
    ...
    uint256 public dimesMintReward = 10000000000000000000; // 10 DIMES
    ...
    uint256 public dimesUpdateReward = 5000000000000000000; // 5 DIMES
    ...
    constructor(address _proxyRegistryAddress, address _babelAddress, address _dimesAddress) ERC721(tokenName, tokenSymbol) {
        projectProxy[_proxyRegistryAddress] = !projectProxy[_proxyRegistryAddress];
    ...
    function returnProjectProxy(address proxyAddress) public view returns(bool) {
