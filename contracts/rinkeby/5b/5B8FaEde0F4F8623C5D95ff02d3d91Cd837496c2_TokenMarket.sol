...
contract TokenMarket is TokenMarketBase, PausableUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    function withdrawToken(
        ...
        IERC20Upgradeable(_tokenAddress).safeTransfer(_walletAddress, _withdrawAmount);
