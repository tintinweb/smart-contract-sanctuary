...
contract PunkBodies is ERC721 {
    address immutable proxyRegistryAddress;
    address public distributor;

    uint256 max_supply = 15000;

    constructor(address _proxyRegistryAddress)  ERC721("PunkBodiesV2", "PBV2") {
        proxyRegistryAddress = _proxyRegistryAddress;
    }
    
     function _baseURI() internal view override returns (string memory) {
        return "https://punkbodiesv2.mypinata.cloud/ipfs/QmU68oCy99Ws5iSgbTWqGFTR45wzEn5hnAnb96KTCiDjHr/";
    }
