...
contract TCA is ERC721, ERC721Enumerable, Ownable {
    ...
    uint public maxMintsPerTx;

    string public baseURI;

    iYield public yieldToken;

    constructor() ERC721("The Coolest Apes Club", "tCAC") {}
    ...
    function publicMint(uint amount) external payable {
        uint maxSupplyPerWallet = balanceOf(msg.sender);
        ...
        require(maxSupplyPerWallet < 30, "Max 30 tokens per account!");
    ...
    function setMaxMintsPerTx(uint16 _maxMintsPerTx) external onlyOwner {
