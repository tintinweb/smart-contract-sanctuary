...
contract Rental is Ownable {
    ...
    function newRentalAgreement() public payable returns(address) {
        // make new agreement
        RentalAgreement x = new RentalAgreement();
        // store new agreemnt
        rentalAgreements.push(x);
        // output agreement address
        return address(x);
    }
}

contract RentalAgreement is Arbitrator, Ownable, Escrow {
