...
contract TvHeadsGangGoldenTicket is ERC721Enumerable, Ownable {
    ...
    mapping (address => bool) private normalMints;

    constructor(string memory _baseUrl, string memory _notRevealedUrl) ERC721("The Tv Head Gang Golden Ticket", "TTHGGT") {
        baseURI = _baseUrl;
    ...
    function mint() public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(normalMints[msg.sender], "You already minted");
            require(msg.value >= cost * 1, "Insuffient funds");
        }

       _safeMint(msg.sender, supply + 1);
       normalMints[msg.sender] = true;
    }
