...
contract SakuraInu is Context, IERC20, Ownable {
    ...
    uint256 public _marketingFee=500;// means 5% eth to marketing Wallet
    uint256 public _devFee=500;// means 5% eth to dev Wallet
    
    
    address marketingAddress=0x726Ce5676DB429F269698039C88D1cf3871c46fe;
    address devAddress=0xBbc95b6da4539c8cc731C4ED5ccb0b1CC9DB38e2;
