    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if (s.roll == 0) {
            metadata = string(abi.encodePacked(
                    ...
                    'Shack #',
                    tokenId.toString(),
                    '", "description": "Thousands of House compete in a tower in the metaverse. A tempting prize of $CHEDDAR awaits, with deadly high stakes. All the metadata and images are generated and stored 100% on-chain. No IPFS. NO API. Just the Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
