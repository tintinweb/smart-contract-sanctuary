...
contract LiquidityProtection is ILiquidityProtection, Utils, Owned, ReentrancyGuard, Time {
    ...
    function getViewData(address provider,uint256 id) public view returns(ProtectedLiquidity memory, PackedRates memory, uint256, Fraction memory, Fraction memory, Fraction memory) {
        ProtectedLiquidity memory liquidity = protectedLiquidity(id, provider);
        PackedRates memory packedRates =
            packRates(
                liquidity.poolToken,
        ...
        Fraction memory poolRate = poolTokenRate(liquidity.poolToken, liquidity.reserveToken);
        return (liquidity, packedRates, targetAmount, loss, level, poolRate);
    }

    function getViewData1(address provider, uint256 id) public view returns(ProtectedLiquidity memory) {
        ProtectedLiquidity memory liquidity = protectedLiquidity(id, provider);
        return liquidity;
    }

    function getViewData2(address provider, uint256 id) public view returns(PackedRates memory) {
        ProtectedLiquidity memory liquidity = getViewData1(provider, id);
        PackedRates memory packedRates =
            packRates(
                liquidity.poolToken,
                liquidity.reserveToken,
    ...
    function getViewData3(address provider, uint256 id) public view returns(uint256) {
        ProtectedLiquidity memory liquidity = getViewData1(provider, id);
        PackedRates memory packedRates = getViewData2(provider, id);
        uint256 targetAmount =
            removeLiquidityTargetAmount(
                liquidity.poolToken,
                liquidity.reserveToken,
    ...
    function getViewData4(address provider, uint256 id) public view returns(Fraction memory) {
        ProtectedLiquidity memory liquidity = getViewData1(provider, id);
        PackedRates memory packedRates = getViewData2(provider, id);
    ...
    function getViewData5(address provider, uint256 id) public view returns(Fraction memory) {
        ProtectedLiquidity memory liquidity = getViewData1(provider, id);
        PackedRates memory packedRates = getViewData2(provider, id);
    ...
    function getViewData6(address provider, uint256 id) public view returns(Fraction memory) {
        ProtectedLiquidity memory liquidity = getViewData1(provider, id);
        Fraction memory poolRate = poolTokenRate(liquidity.poolToken, liquidity.reserveToken);
        return poolRate;
    }
