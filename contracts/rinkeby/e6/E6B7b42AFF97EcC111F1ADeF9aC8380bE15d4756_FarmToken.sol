...
contract FarmToken is ERC20, ChainlinkClient, Ownable {
    address curr_owner;
    ...
    function addGoods(
        ...
        Goods memory new_good = Goods(_farmer_address, _id, _name, _token_amount, _image_uri, _description, all_goods.length, farmer_to_goods[_farmer_address].length);
    ...
    function deleteGood(address _farmer_address, uint256 index1, uint256 index2) public onlyOwner{
        require(index1 < all_goods.length, "Index doesn't exists");
        require(index2 < farmer_to_goods[_farmer_address].length, "Index doesn't exists");
