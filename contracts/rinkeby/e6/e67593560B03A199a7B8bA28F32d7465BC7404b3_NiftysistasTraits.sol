...
contract NiftysistasTraits is ERC1155, Ownable, Pausable {
    ...
    function burn(address account, uint256 tokenId, uint256 amount) external {
        require(mintingContract == msg.sender || balanceOf(msg.sender, tokenId) >= amount, "Burnable: caller is not approved");
    ...
    function claimSpecialTrait(uint[] calldata dudeIds) external {
        ...
        for (uint i=0; i < dudeIds.length; i++) {
            ...
            tokenSupply[dudeIds[i]] = tokenSupply[dudeIds[i]].add(1);
