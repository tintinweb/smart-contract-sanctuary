...
contract lootMounts is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    //Loot Contract
    address public lootAddress = 0xC1FC2C755561BB3b5e819214cCb125b229d308E3;
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "xMount #',
                        toString(tokenId),
                        '", "description": "xMounts are randomized generated and stored on chain. Images and other functionality are intentionally omitted for others to interpret. Feel free to use mounts in any way you want. Inspired and compatible with xLoot (for Adventurers)", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("xMounts", "XMOUNT") Ownable() {}
}
