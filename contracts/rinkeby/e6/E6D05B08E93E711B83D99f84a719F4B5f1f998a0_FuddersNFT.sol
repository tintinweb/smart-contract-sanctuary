...
contract FuddersNFT is ERC721("Testing", "Test"), Ownable {
    ...
    uint256 public price = 3232000000000000; // 6464/2 fer da memes
    ...
    address
        public constant addrThree = 0xfc50011fD1d672d5f18f39D51797484460Af9ac6;
    address
        public constant addrFour = 0x8958eBEB998DB0C051b4857aB8c1d758B12e423f;

    constructor() public {
        saleIsActive = false;
        setBaseURI("http://test.fudderverse.com/");
