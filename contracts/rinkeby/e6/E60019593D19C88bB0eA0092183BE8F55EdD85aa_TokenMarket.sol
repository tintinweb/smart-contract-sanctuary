...
contract TokenMarket is TokenMarketBase {
    ...
    modifier onlyTokenMarket() {
        require(msg.sender == address(this), 'GTM: Not Token Market!');
        _;
    }
    ...
    */
    ...
    function activateLoan(uint256[] memory loanIds, uint256[] memory stableCoinAmounts, bool[] memory _autoSell) public {
        ...
        activatedLoanOffersFull[loanIds[i]] =  TokenLoanData.LenderDetails({
		    lender: msg.sender,
            activationLoanTimeStamp: 1635668198,       // should be block.timestamp, //TODO change time to block.timestamp
    ...
    function fullLoanPaybackEarly(uint256 _loanId) internal {
        ...
        stableCoinAPYFeeFromToken[address(this)] = stableCoinAPYFeeFromToken[address(this)].sub(earnedAPYFee);
  ...
  /**
    ...
    */
    ...
    function swapCollateralTokens(
        ...
        address[] memory path,
        address to,
        uint256 deadline) external override onlyTokenMarket {
     ...
     */
    function transferCollateral(address _collateralToken, address _to, uint256 _amount) external override onlyTokenMarket {
...
interface IGovWorldTierLevel {
    ...
    function getTierDatabyNFTAddress(address _nftContract) external view returns (bytes32 tierLevel);
