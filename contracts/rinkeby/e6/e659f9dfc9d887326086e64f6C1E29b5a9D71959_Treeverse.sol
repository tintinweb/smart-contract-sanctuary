...
contract Treeverse is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Treeverse", "TRV"){
    ...
    {   
        ...
        require(!collections[collectionNumber].created, "A collection with this collection number already exists");
        ...
        require(collectionNumber == nextCollectionNumber, "You are trying to create a collection that doesn't match the nextCollectionNumber");
