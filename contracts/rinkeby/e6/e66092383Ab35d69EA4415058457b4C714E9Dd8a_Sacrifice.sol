...
import "./ShogunNFT.sol";

contract Sacrifice is Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    ShogunNFT public shogunNFT;
    ...
    constructor(address _shogunNFT, address _vault) {
        shogunNFT = ShogunNFT(_shogunNFT);
        vault = _vault;
    }
    ...
    function setRevealedCount(uint256 _state) public onlyOwner {
