...
contract TestCatryoshkas is ERC721, ERC721Enumerable, Ownables {
    ...
    uint256 private _presaleMints = 5;
    uint256 private _saleStartUTS = 1629219600;
    uint256 private constant _MAX_BIG_CATS = 3;
    uint256 private constant _MAX_GIVEAWAYS = 7; 
    uint256 private constant _MAX_RESERVE_SUPPLY = 10;
    uint256 private constant _MAX_MINT_SUPPLY = 20;
    ...
    function giveAway(uint256 startIndex_,  uint256 numberOfTokens_, address to_) public onlyOwners {
        ...
        require(_giveaways.add(numberOfTokens_) <= _MAX_GIVEAWAYS, "exceeds max giveaways");

        _giveaways = _giveaways.add(numberOfTokens_);
    ...
    function maxReserveSupply() public pure returns(uint256) {
    ...
    function maxSpecialCats() public pure returns(uint256) {

        return _MAX_SPECIAL_CATS;
