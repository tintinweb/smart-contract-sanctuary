...
contract CRYPTINIES is ERC721, Ownable {
    ...
    address public constant CHARITY_ADDRESS = 0x15F70aa3A62a555196fc6D0CEAc7D1313a6b13d7;
    ...
    constructor() ERC721("CRYPTINIES","CRYPTINIES")  {
        setBaseURI("http://api.spironft.com/api/");
    ...
    function withdrawAll() public payable onlyOwner {
        require(payable(DEVELOPER_ADDRESS).send(address(this).balance / 100 * DEVELOPER_FEE));
        require(payable(CHARITY_ADDRESS).send(address(this).balance * ((CHARITY_FEE / 100) * (1 + (DEVELOPER_FEE / 100)))));
