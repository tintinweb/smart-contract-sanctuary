...
// SPDX-License-Identifier: Unlicensed
    ...
    contract ELDE is Context, IERC20, Ownable {
        ...
        uint256 private _tTotal = 1441441441440 * 10**9;
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;
        uint256 private _CoolDown = 45 seconds;

        string private _name = 'ELDE';
        string private _symbol = 'EL';
        uint8 private _decimals = 9;
         
        uint256 private _taxFee = 2;
        uint256 private _teamFee = 18;
        ...
        uint256 public _maxTxAmount = 7207207207 * 10**9; 
