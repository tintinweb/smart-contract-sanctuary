...
contract MysteryBox is OwnableUpgradeable {
    ...
    address public mask_token_addr;
        ...
        external
    {
        ...
        box.min_mask_amount = min_mask_amount;
        if (mask_token_addr == address(0)) {
            // ETH mainnet mask token address, save 1 transaction
            mask_token_addr = address(0x69af81e73A73B40adF4f3d4223Cd9b1ECE623074);
        }
        ...
        payable
    {
        ...
        if (box.min_mask_amount > 0) {
            require(IERC20(mask_token_addr).balanceOf(msg.sender) >= box.min_mask_amount, "not holding enough MASK");
        }
        ...
        )
    {
        ...
        min_mask_amount = box.min_mask_amount;
    }
