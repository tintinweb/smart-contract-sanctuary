...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEntranceFee() public view returns(uint256){
        ...
        uint256 adjustedUsdEntryFee = usdEntryFee * 10 ** 36;
        uint256 costToEnter = adjustedUsdEntryFee / price;
        return costToEnter;
    }
    ...
    function endLottery() public onlyOwner {
        require(lottery_state == LOTTERY_STATE.OPEN, "Can't end lottery that's not open!");
