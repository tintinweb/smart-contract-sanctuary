...
contract GoaldDAO {
    ...
    address private _uniswapRouterAddress = 0xEd866b175778f14D6fec196Fe0fb301D133a8351;

    /** @dev The address of the Goald token. Set in constructer and should never have to be changed. */
    address public  _goaldToken;
    ...
    constructor() public {
        _goaldToken = 0x8b94d64403FF1FC143fBDd0D5c50582771DDA692;
        _rewardToken = 0x0450DEF55F4e765Cac0dd757b5b46A37173b176F;
        _intermediaryToken = 0x75036B9c0E30b74C7ae9A7185fB54178DB39bE6E;

        // Copy over current state values.
        IGoaldToken token = IGoaldToken(0x8b94d64403FF1FC143fBDd0D5c50582771DDA692);
