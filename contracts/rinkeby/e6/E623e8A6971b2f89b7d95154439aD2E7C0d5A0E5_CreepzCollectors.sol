...
contract CreepzCollectors is ERC1155Supply, Ownable {
    using ECDSA for bytes32;

    uint256 public constant CREEPZ_COLLECTORS = 0;
    ...
    function buyCreepzCollectors(uint256 tokensNumber, bytes calldata signature) public payable {
      require(saleIsActive, "The mint has not started yet");
      require(tokensNumber > 0 && tokensNumber <= 50, "Wrong amount requested");
      ...
      _mint(_msgSender(), CREEPZ_COLLECTORS, tokensNumber, "");
