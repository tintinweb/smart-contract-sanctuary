...
contract NFTStaking is Ownable {
    ...
    /**
     * @notice NFTStaking Contract Constructor
     *
     * @param _nftContractAddress NFTContract Address
     * @param _gfxContractAddress ERC20 GFX Contract Address
     */
    constructor(address _nftContractAddress, address _gfxContractAddress) {
    ...
    function stakeNFT(uint256 _nftId) public {
        ...
        require(level > 0, "NFTStaking: NFT Level is not enough to stake");
        ...
        emit NewNFTStaked(_nftId, msg.sender, power, nft.lastStakedTime);
    }
