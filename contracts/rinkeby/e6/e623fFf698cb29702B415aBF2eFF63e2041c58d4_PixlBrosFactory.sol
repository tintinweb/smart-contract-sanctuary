...
contract PixlBrosFactory is FactoryERC721, Ownable {
    ...
    function resetOwnership() public onlyCreator {
...
contract PixlBros is ERC721Tradable {
    ...
    string private _ipfsURI = "https://ipfs.io/ipfs/QmR1TaBKC1VPZ72zHhUGdgcCv36FjN7xatMbWM9ogczR78/matadata/";
    ...
    function ipfsURI(uint256 _tokenId) public view returns (string memory) {
        return string(abi.encodePacked(
                _ipfsURI, "metadata/", Strings.toString(_tokenId), "/index.json"));
    }
    ...
    function changeIpfsURI(string memory _uri) public onlyCreator {
        _ipfsURI = _uri;
    }
