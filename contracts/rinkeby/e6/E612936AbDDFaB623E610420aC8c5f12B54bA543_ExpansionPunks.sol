...
contract ExpansionPunks is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public totalReserved = 10;
    ...
    // ----- Owner config -----
    address public jp = 0xE6cC8D91483DfC341622Ea6fA6eaEf2DecD7bBEA;
    address public fu = 0x6EC25460f85F23181f5694c7c61C74027fCDdB03;
    address public dao = 0xAAAA2870050f30510e14FBf38922927C334B4cC0;
    ...
    // restrict to onyl allow when we have a running sale
    modifier noContract() {
        require(!Address.isContract(_msgSender()), "Not callable by contract");
        _;
    }
    ...
    function _internalMint(uint256 _number, address _receiver) internal returns (uint256[] memory tokens){
        ...
        returns(uint256[] memory tokens)
    {
        ...
        return _internalMint(_number, msg.sender);
    }
