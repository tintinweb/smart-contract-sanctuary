...
contract SlimHoodsSpecials is ERC1155, Ownable {
  ...
  constructor(address _slimhoodsAddress) ERC1155("https://slimhoods.com/specials/{id}.json") {
  ...
  function mintSpecialForSlimHood(uint256 specialNumber, uint256 hoodId) public payable virtual {
