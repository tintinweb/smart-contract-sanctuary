...
contract GreyToken is Context, IERC20, Ownable {
    ...
    constructor () {
        FTPAntiBot _antiBot = FTPAntiBot(0x80966ffa5B2b72Ac69f6E81E8Fd219026F1C4244);           // AntiBot address for KOVAN TEST NET (its ok to leave this in mainnet push as long as you reassign it with external function)
        AntiBot = _antiBot;
