...
contract JBLNFT is ERC721{
    ...
    constructor ()  public ERC721("JBL-fireW", "JBL-fireW"){
        owner = msg.sender; 
        _set_JBL_TOKEN(0x199d6407f88462fd6fafc90f0900f02c97312fdd);
    }
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "JBL-fireW";
        string memory tokenURI = "https://farms.jblgamefi.io/nft/event/JBL-fireW.png";
        ...
        _setTokenURI(cardId, "https://emoceanx.i-recu.com/nft/test.json");
