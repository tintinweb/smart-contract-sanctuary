...
// END AMOS //
    ...
    function redeem(
       ...
       lastRedeemed[msg.sender] = block.number;
        ...
        mintersDetails[msg.sender].amount = mintersDetails[msg.sender].amount.sub(collateralNeededBeforeFee.mul(10e11));
    ...
    function redeemBis(uint256 arthAmount, uint256 collateralOutMin) internal  {
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0xf679A2beBf6D1A3e0f0f5FAA59c88B9A0787Ef7e"
    }
  },
  "outputSelection": {
    "*": {
