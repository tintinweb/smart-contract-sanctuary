...
contract BillionaireX is ERC721Enumerable, Ownable
{
    ...
    uint256 public wprice = 0.05 ether; 
    uint256 public sprice = 0.07 ether; 
    ...
    constructor() ERC721("BillionaireX", "Bx")  {
        setBaseURI("https://gateway.pinata.cloud/ipfs/Qmdnx2sfXwnTspzyfoHgwi8t1z4xUDmoJ3yMSJnm368JC5/");

    }
    function giveawayMint() public onlyOwner {
        // mint last 500 to owner
        for(uint i=9501; i< 10001 ; i++){
    ...
    function mint(uint chosenAmount) public payable isSaleOpen {
        require(totalSupply()+chosenAmount<=_TOTALSUPPLY-500,"Quantity must be lesser then MaxSupply");
