...
contract JuiceBox is Kasbeer721 {
	...
	function _getNumPlugs(address owner) internal view returns (uint8)
	{
    ...
    function claim(address to, uint8 numPlugs) public boxAvailable
    	returns (uint256 tid, string memory hash)
    {
    	...
    	require(_getNumPlugs(to) == numPlugs, "JuiceBox: incorrect numPlugs/Plug hodlers only");
