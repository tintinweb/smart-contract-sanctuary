...
contract PRNTR is ERC20Burnable, Operator {
    ...
    function addSenderExcludedAddresses(address newAddress) external onlyOperator returns(bool) {
    ...
    function removeSenderExcludedAddresses(address oldAddress) external onlyOperator returns(bool) {
    ...
    // Add an address to the exluded mapping
    function addrecipientExcludedAddresses(address newAddress) external onlyOperator returns(bool) {
    ...
    // Removes an address from the excluded mapping
    function removeRecipientExcludedAddresses(address oldAddress) external onlyOperator returns(bool) {
    ...
    // Set fees (index) :
    function setfeesTaxRate(uint256 fees) external onlyOperator {
        require(fees <= 45);
        feesTaxRate = fees;
    }
    ...
    function setInjectorAddress(address newInjector) external onlyOperator {
        injector = newInjector;
    }

    function setUnirouter(address newUnirouter) external onlyOperator {
