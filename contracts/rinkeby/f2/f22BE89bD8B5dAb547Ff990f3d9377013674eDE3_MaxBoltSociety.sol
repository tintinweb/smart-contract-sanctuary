...
contract MaxBoltSociety is ERC721Enumerable, Ownable {
  ...
  uint public maxTotalSupply = 7877;
  uint private _reserveTokenId = 7777;
  Sale public sale;
  Counters.Counter private _tokenId;
  mapping(address => bool) public isWhitelisted;

  constructor() ERC721("Max Bolt Society", "BOLTS") {}
  
  function _baseURI() internal view virtual override returns (string memory) {
    return baseURI;
  }

  function mintBolt(uint _mintAmount) public payable {
