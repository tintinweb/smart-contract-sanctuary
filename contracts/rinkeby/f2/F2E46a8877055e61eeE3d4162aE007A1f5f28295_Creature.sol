...
//erc20 token
string memory test = Strings.uint2str(shares);
        pNFT_Token_addrs[msg.sender] = address(new RobinToken(nft_name,test));
    ...
    function testtt(uint shares)public{
        New_erc20_token = RobinToken(pNFT_Token_addrs[msg.sender]);
         ...
         //require(Strings.uint2str(shares) == New_erc20_token.totaltoken() , "not the correct share value");
    }
