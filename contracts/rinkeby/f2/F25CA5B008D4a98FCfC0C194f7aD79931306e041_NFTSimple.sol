...
contract NFTSimple is ERC721, ChainlinkYoutube, Ownable{
    ...
    function updateCollectiables(uint256 _tokenID, string memory _tokenUri, uint256 _dynamicRating, string memory _username, string memory _id) onlyOwner public{
