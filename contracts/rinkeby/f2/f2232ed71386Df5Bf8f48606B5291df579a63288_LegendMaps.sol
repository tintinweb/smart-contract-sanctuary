...
contract LegendMaps is ERC721, ERC721Enumerable, Ownable {
  ...
  string private _unrevealedURI = "https://legendmaps.io/legendmaps-default-metadata.json";
  ...
  function setBaseURI(string memory baseURI_, bool reveal_) external onlyOwner {
      if(reveal_ == true){
        revealed = true;
      }
