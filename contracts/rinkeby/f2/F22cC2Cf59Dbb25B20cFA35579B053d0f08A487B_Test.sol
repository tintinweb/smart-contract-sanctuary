...
contract Test is ERC721Enumerable
{
    ...
    address payable public proceedsSplitter;
    ...
    constructor(string memory defaultBaseURI, address payable splitter) ERC721("Test", "T") {
        owner = msg.sender;
    ...
    function withdraw() external payable onlyOwner {
        Address.sendValue(proceedsSplitter, address(this).balance);
    }
