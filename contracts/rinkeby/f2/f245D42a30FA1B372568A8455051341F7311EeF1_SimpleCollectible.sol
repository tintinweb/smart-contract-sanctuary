...
contract SimpleCollectible is ERC721, Ownable {
    ...
    function batchMint(string memory my_sample_ipfs_metadata_uri) public onlyOwner payable {
        ...
        string memory url = "https://gateway.pinata.cloud/ipfs/Qmc12nGLXep5g5ZAz2oAqHAq7xYuc7xcghRw3NVtBR2zJN/metadata-0.json";

        for (uint i = 0; i < numberOfNfts; i++) {
            //url = append("https://gateway.pinata.cloud/ipfs/Qme9qpW7SyVpKKBsXnLsEaoE3Jbjkm7eAec6Z7zc9RuYx3/metadata-", uint2str(tokenCounter), ".json");
