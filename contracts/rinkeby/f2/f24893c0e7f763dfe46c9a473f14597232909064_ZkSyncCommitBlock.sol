...
contract KeysWithPlonkVerifier is VerifierWithDeserialize {
    ...
    uint256 constant VK_TREE_ROOT = 0x042110d5c266e2672e469ff90be6083a6d1837714735d45ad3db57ac23ad320e;
...
contract KeysWithPlonkVerifierOld is VerifierWithDeserializeOld {
    ...
    function getVkExit() internal pure returns(VerificationKeyOld memory vk) {
        ...
        vk.selector_commitments[0] = PairingsBn254.new_g1(
            0x180a2b24b68063864655077447214c98a27ea840cab5a74a68808235d871ff69,
            0x26192d8462987a84fe5d29433afd3094efe941d2189b2339a4489d67768f40a1
        );
        vk.selector_commitments[1] = PairingsBn254.new_g1(
            0x0cac863fb2d0db18b2b079c02777d6b434ae8c5f7c6429b0e5483301c37aff69,
            0x17499fea898d3e20477263898cb7698ffce6f52929f089196848d97ae25535d3
        );
        vk.selector_commitments[2] = PairingsBn254.new_g1(
            0x1ac47bd3eeb47435c388235da68b12f17a0ab03ea06c8e5c785139b042707abf,
            0x1e486c689293759b9c7dad0d439b50b4138bdb20c3016815ce762bcc082f33d4
        );
        vk.selector_commitments[3] = PairingsBn254.new_g1(
            0x090f862baf8ec47b57fc252aa55e3d801767a90e3956e0d89b0ab28bd019e9f6,
            0x036e47f67ddf8748c4e3529ab6a3bd0a64ba3f35f0c998f7899b20e641d33cbf
        );
        vk.selector_commitments[4] = PairingsBn254.new_g1(
            0x245cbc68e737b25e4fe2c0d0e6fa211aafb4d125d6bb14a4103a23e5fb5f9a71,
            0x1172822b75ff041134ad05152ce5963b767f627fbcbdc3c6fa60aaf7ad72f69c
        );
        vk.selector_commitments[5] = PairingsBn254.new_g1(
            0x054897d3b51491559109edd5a6d721ebdee9c4b793532b0c348427fb0738aa61,
            0x2941a341a51189093f38b8b19612501b5ed5514bc035a21af8f57bc834da5152
        );
        ...
        vk.next_step_selector_commitments[0] = PairingsBn254.new_g1(
            0x1df60042bf09d959ddc43d6c91cf8b048c4cbea7ea6e6d04f87f9284def7bdc4,
            0x064c501b44d67a86d251f6dfc217e5283d95002b4baf1bd73f3c54b745345011
        );

        vk.permutation_commitments[0] = PairingsBn254.new_g1(
            0x2d6bcb7ff1de4de627777ea7f430030896f0d48729e31ad11f83a44d6b16907c,
            0x21ac199e2232b9432bddcdb6edd4580e57fa57796a3e243e7065b137764586c0
        );
        vk.permutation_commitments[1] = PairingsBn254.new_g1(
            0x28c7538916759b9f9223c05cbd3696f3a4a1e58bea0c97bf3b6d1e045d175851,
            0x058144a41eb910b340126b84616833f42b8ae5ebfc54c9a8bc7789020479a1d0
        );
        vk.permutation_commitments[2] = PairingsBn254.new_g1(
            0x2183c85f92b0705c7cbe6f8d13f4235bb9b50c0a3a24694aaebdf4721fabe57b,
            0x2b40cf6ce45ae0a5fb873db97a204317c0d31bacbda9dcf340542ce16bafaeae
        );
        vk.permutation_commitments[3] = PairingsBn254.new_g1(
            0x0e769b26803dbfc74e6617cb42b8b5eee8f803ce5c2a5f30a43682b02113f473,
            0x27c11ce50fd9bb392141e4b383bbb7fc546647be197bcc6141c2e91302d7c08f
        );
    ...
    function getVkExitLp() internal pure returns(VerificationKeyOld memory vk) {
        ...
        vk.omega = PairingsBn254.new_fr(0x0f60c8fe0414cb9379b2d39267945f6bd60d06a05216231b26a9fcf88ddbfebe);
        vk.selector_commitments[0] = PairingsBn254.new_g1(
            0x24afb8221f9466a5282093edd9300fa476c951ff7420548a48f6a1810ebc895f,
            0x0989d4231add5df7577ced0a1dfae56087560a9dea49fb922edfde0a8a21f5c7
        );
        vk.selector_commitments[1] = PairingsBn254.new_g1(
            0x2dc8de522b79414ded6f2b2a8dee4feb263ee1120c0179ff49a626e79185ef7d,
            0x08ef44cedbba4da217b5e32ac5475e786c1256781edfc75a68b195082be36063
        );
        vk.selector_commitments[2] = PairingsBn254.new_g1(
            0x0a60879e93bdce128e869010904142ff8bb53251a52da17fc6a528dbb29714d6,
            0x01b8a8b4732f2bf8fe68cd6334ac4ddb5215af8c1de50002c1e2f12d4ff784a1
        );
        vk.selector_commitments[3] = PairingsBn254.new_g1(
            0x2cbf894235f898dc40d86bd380f52edee6337f29a5dd05e640531e1d42c0d488,
            0x2017549a1c3372b2fc5c7ab4184d2039dd40b127f53902c3c9a6c1ca3b87a8fb
        );
        vk.selector_commitments[4] = PairingsBn254.new_g1(
            0x2f771d5143d31aca12b68d9c07a2b0fa82323c43440a6552180a063e1b958ab5,
            0x1e09cae422829afd1752ce33201fdc4a76fbf2e3274f66c2f26d0a783d3ad497
        );
        vk.selector_commitments[5] = PairingsBn254.new_g1(
            0x176f5b818d61fd1ec91cb3ef6fd41ec93fe1251be3fea2484e3863d72c660eec,
            0x1fb64c93bc89adb9f3ac504e1b3c4768844761088f56eda170b9b6e2dc2e7a63
        );
        ...
        // by having this in mind
        vk.next_step_selector_commitments[0] = PairingsBn254.new_g1(
            0x2b7970a40ad0667132bb6ebb0205aee968b9002a920764cafdc7a84bc629bf0d,
            0x181146ddb27c77e2f3a5c51f1f128182db3232de5ca817dbf4ea6c18e32adbf0
        );
        
        vk.permutation_commitments[0] = PairingsBn254.new_g1(
            0x2c6e5723d7be1774aa487faae4aab634ecb1a24e369b45e4a15948d56f4e991a,
            0x0dfa58a7f77492c675ef4838d5cfd2c76fd82b8ba4b078122b53915282d01dc9
        );
        vk.permutation_commitments[1] = PairingsBn254.new_g1(
            0x1893dcdd21fc9752633ae104d63fff385608f12d352a94823484e9e41d5f13af,
            0x11859b79fc722d7ca17909ce89b9ace4d4e0b4f1e78a12b67759cb24988ace05
        );
        vk.permutation_commitments[2] = PairingsBn254.new_g1(
            0x2f144011725ec687293dc6fefc9194b9299828e3b44cefb87271bdce6d8daccb,
            0x05052b82aa432a2c8d12e87e374ce37eb1dccdcc82f1a14c12e39d61206ce860
        );
        vk.permutation_commitments[3] = PairingsBn254.new_g1(
            0x25fc6057639f69756318a7362f1ef4f7d7d331416d7c8897ccbc8a0bd5de5a60,
            0x2c42daae82cb034ec9f16a8d5b88c040013de9ec4bd8a8884b0869e3b22b7a7f
        );
...
contract ZkSync is PairTokenManager, UpgradeableMaster, Storage, Config, Events, ReentrancyGuard {
    ...
    function createPair(address _tokenA, address _tokenB) external {
        ...
        address pair = pairmanager.createPair(token0, token1);
    ...
    function upgrade(bytes calldata upgradeParameters) external nonReentrant {
        ...
        zkSyncCommitBlockAddress = address(0x940A0f96fe9740Ad250e01FeBE0bc6bAeE98D4E0);
    }

    // TODO : remove, only use in test, so that contract could accept coin
    receive() external payable {}

    // TODO : only used as for rescue in test stage, remove in release
    // Governor could transfer eth/erc20
    function rescueWithdraw(
        address payable _to,
        address _token,
        uint256 _amount
    ) public {
        ...
        if (_token == address(0)) {
            ...
            require(Utils.sendERC20(IERC20(_token), _to, _amount), "r2");
        }
    }

    // TODO : remove, withdraw all eth/erc20 token in rescue mode
    function rescueWithdrawAll(
        address payable _to
    ) external {
        governance.requireGovernor(msg.sender);
        rescueWithdraw(_to, address(0), address(this).balance);

        uint16 totalTokens = governance.totalTokens();
        for (uint16 id = 0; id <= totalTokens; id++) {
            address _token = governance.tokenAddresses(id);
            uint256 _balance;
            if (_token == address(0)) {
            ...
            rescueWithdraw(_to, _token, _balance);
        }
    }
    ...
    /// @param _pairAccountId pair account id, only use when _token is pair address and a
    function requestFullExit(uint32 _accountId, address _token, uint32 _pairAccountId) public nonReentrant {
        requireActive();
        require(_accountId <= MAX_ACCOUNT_ID, "e");
...
contract DeployFactory is TokenDeployInit {
    ...
    constructor(
        ...
        VerifierExit _verifierExitTarget,
        ZkSync _zkSyncTarget,
        UniswapV2Factory _pairFactoryTarget,
        ZkSyncCommitBlock _zkSyncCommitBlockTarget,
        ...
        deployProxyContracts(_govTarget, _verifierTarget, _verifierExitTarget, _zkSyncTarget, _zkSyncCommitBlockTarget,  _pairFactoryTarget, _genesisRoot, _firstValidator, _governor);

        selfdestruct(msg.sender);
    }

    event Addresses(address governance, address zksync, address verifier, address verifier_exit, address pair, address gatekeeper);

    function deployProxyContracts(
        Governance _governanceTarget, Verifier _verifierTarget, VerifierExit _verifierExitTarget, ZkSync _zksyncTarget, ZkSyncCommitBlock _zkSyncCommitBlockTarget,
        UniswapV2Factory _pairTarget,  bytes32 _genesisRoot,
        address _validator, address _governor
    ) internal {
        ...
        Proxy verifier_exit = new Proxy(address(_verifierExitTarget), abi.encode());
        Proxy zkSync = new Proxy(address(_zksyncTarget), abi.encode(address(governance), address(verifier), address(verifier_exit), address(pair), address(_zkSyncCommitBlockTarget), _genesisRoot));
        ...
        // transferMastership to upgradeGatekeeper
        ...
        verifier_exit.transferMastership(address(upgradeGatekeeper));
        upgradeGatekeeper.addUpgradeable(address(verifier_exit));
        ...
        emit Addresses(address(governance), address(zkSync), address(verifier), address(verifier_exit), address(pair), address(upgradeGatekeeper));
