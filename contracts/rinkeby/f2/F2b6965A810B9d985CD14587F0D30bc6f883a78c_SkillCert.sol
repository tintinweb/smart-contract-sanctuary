...
contract SkillCert {
    ...
    mapping(address => bytes32[]) public awarded_certificates_list;
    ...
    function award(bytes32 name, address receiver) public {
        ...
        awarded_certificates_list[msg.sender].push(name);
    }
     ...
     */
    function get_certicates_list(address holder) public view returns (bytes32[] memory){
        return awarded_certificates_list[holder];
    }
}