...
contract HAM is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateHAM(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Handsome Monkey King Club", "HAM") {
		setBaseURI(baseURI);
        pause(true);
    }
