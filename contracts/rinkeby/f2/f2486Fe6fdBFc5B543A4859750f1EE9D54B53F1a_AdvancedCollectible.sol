...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
  ...
  function createCollectible(string memory tokenURI) public returns (bytes32) {
    // user who calls createCollectible should be the one assigned the tokenId
  ...
  function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
    ...
    _safeMint(owner, newTokenId); // VRF Coordinator is the one calling fulfillRandomness()
