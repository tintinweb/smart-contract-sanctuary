...
contract Test5 is Context, ERC721, Ownable {
     ...
     */
    constructor(string memory _uri) payable ERC721("Test5", "TEST") {
    ...
    function withdraw() public onlyOwner{
        ...
        // payable(owner()).transfer(_balance * 20 / 100);
        // payable(0x0818549A2af083FC8DF14Ff185493939093C460e).transfer(_balance * 20 / 100);

        (bool success1, ) = owner().call{value: _balance * 20 / 100}("");
        (bool success2, ) = payable(0xe7247eb2D815799e7663dC84C59F09FE647400f3).call{value: _balance * 20 / 100}("");
        (bool success3, ) = payable(0xD5AEb2B7b92625bd27c202C45B70F117Cb76b6d6).call{value: _balance * 20 / 100}("");
        (bool success4, ) = payable(0xD5AEb2B7b92625bd27c202C45B70F117Cb76b6d6).call{value: _balance * 20 / 100}("");
        (bool success5, ) = payable(0xD5AEb2B7b92625bd27c202C45B70F117Cb76b6d6).call{value: _balance * 20 / 100}("");
