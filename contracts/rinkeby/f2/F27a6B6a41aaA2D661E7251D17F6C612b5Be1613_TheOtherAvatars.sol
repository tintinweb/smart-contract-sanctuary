...
contract TheOtherAvatars is ERC721Enumerable, Ownable, CustomCounter, ReentrancyGuard, Signable {
    ...
    function preSaleMint(uint256 amount, bytes calldata signature) public payable costs(mintPrice * amount) phaseRequired(Phase.PRE_SALE) lock {
        ...
        require(mintedPreSale[msg.sender] + amount <= mintPerAccount, "Account already minted tokens");
