    ...
    DSMath
{
    ...
    function snapshotCumulativesInside(int24 tickLower, int24 tickUpper)
        ...
        returns (
            ...
            uint32 secondsInside,
            uint256 curTimestamps
        )
    {
        tickCumulativeInside;
        secondsPerLiquidityInsideX128;
        secondsInside;
        curTimestamps = block.timestamp;
    ...
    // function coinageIsAdmin(address account)  public view
    //     nonZeroAddress(coinage)
    //     returns (
    //     )
    // {
    //     AutoRefactorCoinageI(coinage).IsAdmin(msg.sender, liquidity * (10**9));
    // }
