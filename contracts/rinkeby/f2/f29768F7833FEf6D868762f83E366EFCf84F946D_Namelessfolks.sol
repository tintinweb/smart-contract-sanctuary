...
contract Namelessfolks is ERC721Enumerable, Ownable {
  ...
  uint256 public constant FOLK_GIVEAWAY = 5;// 300;  // UPDATE BEFORE GO LIVE
  uint256 public constant FOLK_PRIVATE = 2;
  uint256 public constant FOLK_PUBLIC = 5;// 11698;  // UPDATE BEFORE GO LIVE
  uint256 public constant FOLK_MAX = FOLK_GIVEAWAY + FOLK_PRIVATE + FOLK_PUBLIC;
  uint256 FOLK_PRICE = 0.02 ether;

  bool private _isOnPresale = true;     // UPDATE BEFORE GO LIVE
  bool private _isOnPublicSale = false; // UPDATE BEFORE GO LIVE
  uint256 private giveAwayMinted;
  uint256 private publicMinted;
  uint256 private privateMinted;
  string private _baseTokenURI;

  address a1 = 0xc279C8b5ce0128C99F9Fc4671356e70a63DEd798;  // UPDATE BEFORE GO LIVE
  address a2 = 0x1AB9B9c23863814574538dFb6bA3125E73e1be57;  // UPDATE BEFORE GO LIVE
