 ...
 */
contract DogClubERC is ERC20Burnable, ERC20Pausable, Ownable {
    /**
     * @dev Mints an initial supply of 3.25 Billion DOGCLUB tokens with 18 decimals and
     * transfers them to deploying address which is also made the contract `owner`.
     *
     * See {ERC20-constructor}.
     */
    constructor() ERC20("DogClub", "DCLUB") {
