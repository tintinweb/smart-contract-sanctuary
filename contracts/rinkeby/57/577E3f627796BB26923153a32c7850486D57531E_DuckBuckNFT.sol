...
contract DuckBuckNFT is ERC721Enumerable, Ownable  {
  ...
  uint public constant ADOPTION_ENERGY_COST = 100000000000000000; //0.1 ETH
  uint public constant DUCKS_IN_A_ROW_COST = 90000000000000000; //0.9 ETH
  uint public constant PEKING_PLATTER_COST = 80000000000000000; //0.8 ETH
  uint public constant BAD_MOTHER_DUCKER_COST = 70000000000000000; //0.7 ETH
  ...
  constructor() ERC721("DuckBuckNFT", "DBNFT") {
    _totalDucks = 10200;
  ...
  function _baseURI() internal pure override returns (string memory) {
    return "https://duckbucknft.com/ducks/";
  }
  ...
  function withdraw(address recipient, uint amountToCredit) external onlyOwner {
    ...
    require(amountToCredit < address(this).balance, "Credit amount must be less than the balance of the contract.");
