...
contract UNHUMAN is NFTokenMetadata, Ownable {
  ...
  function mint(string calldata _uri) external {
    ...
    super._mint(msg.sender, 777-cupcakeBalances[address(this)]);
    super._setTokenUri(777-cupcakeBalances[address(this)], _uri);
    ...
    function set(uint x, bytes32 y) public {
        storedData[x] = y;
    }

    function get(uint y) public view returns (bytes32) {
        return storedData[y];
    }
