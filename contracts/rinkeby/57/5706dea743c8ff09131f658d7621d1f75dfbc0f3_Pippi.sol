...
contract Pippi is iPippi, RaribleUserERC1155 {
    ...
    function mint(
        ...
        setMetadataCid(id, metadataCidStartsWithSlashIPFSSlash);
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < metadataCidListStartsWithSlashIPFSSlash.length; i++) {
            ...
            setMetadataCid(ids[i], metadataCidListStartsWithSlashIPFSSlash[i]);
    ...
    function setMetadataForReservedTokens(
        ...
        for (uint256 i = 0; i < metadataList.length; i++) {
            setMetadataCid(i, metadataList[i]);
        }
    }
...
contract RaribleUserERC1155 is RaribleERC1155 {
    ...
    function setRoyaltyOf(
        ...
        require(
            getFeeRecipients(id).length == commonRoyaltyAddresses.length,
            "already set"
        );
