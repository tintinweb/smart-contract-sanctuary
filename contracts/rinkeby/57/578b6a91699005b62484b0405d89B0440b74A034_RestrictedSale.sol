...
/**
 * @title Restricted Fixed Supply Sale
 *
 ...
 *
 * @notice Restricted Fixed Supply Sale sells the items only to accounts having `ROLE_BUYER` permission,
 *      and is used effectively to mint first hundred iNFTs in the 10k sale campaign
 *
 ...
 * @author Basil Gorin
 */
contract RestrictedSale is AccessControl {
	// ----- SLOT.1 (256/256)
	/**
	...
	function buyTo(address _to, uint32 _amount) public payable {
		// check the access permission
		require(isSenderInRole(ROLE_BUYER), "access denied");
