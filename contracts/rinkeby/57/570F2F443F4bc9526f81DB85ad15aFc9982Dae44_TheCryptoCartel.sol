...
contract TheCryptoCartel is ERC721Enumerable, ERC721Burnable, Pausable, AccessControl {
    ...
    function mintForWhitelistedMember(uint256 numberOfTokens, bytes32[] calldata proof, bytes32 merkleRoot) external payable onlyRole(WHITELIST_ROLE) {
        ...
        for (uint i = 0; i < numberOfTokens; i++) {
            ...
            require(_verify(_leaf(msg.sender, tokenId), proof, merkleRoot), "Not a whitelisted member!");
