...
contract PixlBros is ERC721Tradable {
    ...
    string private _ipfsTokenURI = "ipfs://QmcaWY7tZmr1MXewj6PmJMf3EJBA1392frF6A1wsbqsBqo/";
    address private _creator;
    uint256 private constant MAX_TOKENS_PER_PURCHASE = 10;
    uint256 private price = 800000000000000000; // 0.08000 Ether
    ...
    function contractURI() public view returns (string memory) {
        return string(abi.encodePacked(_baseTokenURI, _contractURI));
    }
