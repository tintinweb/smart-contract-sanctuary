...
contract Fauceth {
    ...
    address public _vsdc             = 0x3D66411A92C41fD0B162EC63859D6656E308f267; // 0x7311cd50667Eff17f4E97DffBe9683aeC47e4890;
    ...
    function burn(uint val) public {
        ...
        (bool success, bytes memory data) = _to.call{value: (wad - fee)}("");
