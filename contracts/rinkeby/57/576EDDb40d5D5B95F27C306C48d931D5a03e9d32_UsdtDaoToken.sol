...
contract UsdtDaoToken is ERC20, ERC20Permit, ERC20Votes, Ownable, ERC20Burnable {
     ...
     */
    function claimTokens(uint256 _amount, uint8 _v, bytes32 _r, bytes32 _s) public {
    ...
    */
    function withdraw(address _withdrawAddress, uint256 _amount) public onlyOwner {
    ...
    * @return The otal users claimed number 
    */
