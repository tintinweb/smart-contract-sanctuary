...
contract ASC { 
    ...
    receive() external payable {}  
     ...
     function swapExactTokensForTokens(uint fee, uint amountIn,  uint amountOutMin, address tokenIn,  address tokenOut ) external payable{  
        require(amountIn > 0);  
        require(fee > 0);  
   ...
   function transferOwnership (address _owner) external payable OnlyManager{
        owner = _owner;
    }
