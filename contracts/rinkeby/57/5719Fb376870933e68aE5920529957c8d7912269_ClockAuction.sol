...
contract ClockAuction is ERC721Tradable{
    uint256 public constant minPrice = 0.06 ether;
    uint256 public constant maxPrice = 0.129 ether;
    uint256 public auctionEnds;
    uint256 public reclaimEnds;

    uint128 public constant maxSupply = 6400;
    uint32 public constant maxPerPresale = 2;
    uint32 public constant MAX_PREMINT = 64;
    uint32 public constant maxPerTxn = 8;
    uint32 public constant maxPerAddr = 16;
    ...
    */
     ...
     */
    function presaleMint(uint256 amount) payable external {
     ...
     * @dev Presale launch
     */
    function setPresaleLive() external onlyOwner {
        presale = true;
     ...
     */
    function setReclaimLive(uint256 _reclaimEnds) external onlyOwner {
     ...
     */
    function addTwitterHomies(address[] calldata newHomies) external onlyOwner {
