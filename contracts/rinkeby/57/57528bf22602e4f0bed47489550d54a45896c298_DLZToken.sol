...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable, PezNftCollection
{
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual
    {
        ...
        PEZ.transferNftBonus(collectionName, tokenId, from, to);    // Transferer le staking a un autre, tout en stoppant celui de l'ancien proprio
    }
...
contract DLZToken     is  ERC721Enumerable, ReentrancyGuard
{
    ...
    constructor()   ERC721("DL03 Token", "DL03")   // temporary Symbol and title
    {
    ...
    //=============================================================================
    function    setPriceForMinting(uint256 newPresalesPriceInWei, uint256 newSalesPriceInWei)        external onlyOwner
    {
        stakePresalesPrice = newPresalesPriceInWei;
        stakeSalesPrice    = newSalesPriceInWei;
    }
    //=============================================================================
    function    setPriceForMintingWithStake(uint256 newPresalesPriceInWei, uint256 newSalesPriceInWei)   external onlyOwner
    {
        stakePresalesPrice = newPresalesPriceInWei;
        stakeSalesPrice    = newSalesPriceInWei;
    }
    //=============================================================================
    function    setPriceForStaking(uint256 newPriceInWei)   external  onlyOwner
    {
        stakingOnlyPrice = newPriceInWei;
    }
    //=============================================================================
...
*/
        ...
        for (uint256 i=0; i < quantity; i++)
        {
            ...
            tokenStakingStates[mintedTokenCount]  = isWithBonus;
    ...
    function    affTransfer(uint256 affHash) internal
    {
        ...
        {
            emit AFF2(true);
            emit AFF3(affiliate.walletAddress, msg.sender);
