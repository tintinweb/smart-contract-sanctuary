...
contract Support {
    ...
    function generateBytesAuction(address erc721Token, uint256 tokenId, address seller, address buyer, address erc20Token, uint256 bid, uint256 nonce) public pure returns (bytes memory) {
        bytes memory mesageByte = abi.encodePacked(erc721Token, tokenId, seller, buyer, erc20Token, bid, nonce);
        return mesageByte;
    }
