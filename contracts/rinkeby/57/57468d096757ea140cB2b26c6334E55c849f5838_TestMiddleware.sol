...
contract TestMiddleware is IERC721Receiver, Ownable{
    ...
    function safeTransferFrom(uint256[] memory tokenIds) public {
		for(uint256 index=0;index<tokenIds.length;index++){
            ...
            nftContract.safeTransfer(msg.sender, msg.sender, address(this), tokenIds[index]);
            tokenMinter.mint(msg.sender,tokenIds[index]);
        }        
	}
}
