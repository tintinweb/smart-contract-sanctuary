...
contract Ox0ctahedron is ERC721Burnable, Ownable {
    
    string public Ox0CTAHEDRON_PROVENANCE = "";

    uint256 private Ox0_REQUIRED = 250 *10**18;
    uint256 private OxCUBE_REQUIRED = 2;
    
    address public Ox0Address = 0x255662329A4F72c8372Ae47037826125b9d45737;
    address public OxCubesAddress = 0x416C1005A1954f136c753260847d5768395db09D;
    ...
    bool private IS_FORGING_ACTIVE;


    constructor()ERC721("0x0ctahedron", "0x0CTAHEDRON") {
    }
    ...
    */
    function setProvenanceHash(string memory provenanceHash) external onlyOwner {
        Ox0CTAHEDRON_PROVENANCE = provenanceHash;
    }

    function set0x0TokenAddress(address ox0TokenAddress) external onlyOwner {
        Ox0Address = ox0TokenAddress;
        Ox0Token = IERC20(ox0TokenAddress);
    }

    function set0xCubesAddress(address oxCubesAddress) external onlyOwner {
        OxCubesAddress = oxCubesAddress;
        OxCubes = IERC721Enumerable(oxCubesAddress);
    }
    ...
    function flipForgeState() external onlyOwner {
        IS_FORGING_ACTIVE = !IS_FORGING_ACTIVE;
    }
    ...
    function forge0x0ctahedron(uint256 numberOfTokens) external {
