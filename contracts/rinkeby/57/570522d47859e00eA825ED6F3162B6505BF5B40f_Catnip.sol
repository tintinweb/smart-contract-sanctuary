...
contract Catnip is Context, IBEP20, Initializable {
    ...
    // CHANGEIT - decide on to use gnosis or timelock for this function
    ...
    function initializeAirDropAddressesAndAmounts(address[] memory addressesToAirDrop, uint256[] memory amountsToAirDrop) external { 
        address initializer = _msgSender(); 
        require(initializer == teamWalletAddr, "The initializer must be the Gnosis Multisig Safe Team Wallet.");
