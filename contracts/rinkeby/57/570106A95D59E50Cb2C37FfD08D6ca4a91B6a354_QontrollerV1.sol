...
contract QontrollerV1 {
  ...
  mapping(address => mapping(uint => address)) public loanMarketAddresses;
  ...
  function getFixedRateLoanMarket(
    ...
    return loanMarketAddresses[principalTokenAddress][maturity];
  }
  ...
  function _createFixedRateLoanMarket(
    ...
    require(loanMarketAddresses[principalTokenAddress][maturity] == address(0),
