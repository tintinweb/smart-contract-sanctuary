...
contract GameERC20Treasure is Ownable, Pausable {
    ...
    function getUpchainSelector() pure public  returns (bytes4){
        return this.upChain.selector;
    }

    function getTopchainSelector() pure public  returns (bytes4){
        return this.topUp.selector;
    }
