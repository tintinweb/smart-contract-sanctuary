...
contract RepeatOffenders is ERC721, Ownable {
    ...
    string public RO_PROVENANCE = ""; // PLVNDR to add our hash, as well as the seed used to generate the offenders

    uint256 public thePriceForFreedom = 50000000000000000; // 0.05 ETH
    ...
    function buyYourFreedom(uint numberOfTokens) public payable {
        ...
        require(block.number < 9706244); // edited for rinkeby blocks
    ...
    function eraseAccess(uint256 unmarkedToken) public {
