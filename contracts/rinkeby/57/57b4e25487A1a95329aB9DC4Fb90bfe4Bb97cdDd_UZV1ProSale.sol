...
contract UZV1ProSale is OwnableUpgradeable, ReentrancyGuardUpgradeable, DexAMM {
     ...
     **/
    function purchase(address _paymentMethod) external payable nonReentrant() {
        ...
        )
    {
        ...
        priceInStable = estimateSwapAmount(utilityToken, defaultStableCoin, membershipPrice);
    }
...
contract DexAMM {
    ...
    function _getPathFromTokenToToken(address fromToken, address toToken) internal view returns (address[] memory) {
