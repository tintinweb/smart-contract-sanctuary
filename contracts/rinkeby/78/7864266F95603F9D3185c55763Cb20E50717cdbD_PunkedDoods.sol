...
contract PunkedDoods is ERC721EnumerableB, Ownable {
    ...
    function setPrice() public view returns (uint256 price) {
        require(is_locked == true, "Sale hasn't started");
        require(totalSupply() < TOTAL_SUPPLY, "Sale has already ended");

        uint256 currentSupply = totalSupply();
        if (currentSupply <= 500) {
            return 0; // 8900-10000:    0 ETH
        } else {
            return 35000000000000000; // 0 - 500     0.035 ETH
        }
    }
