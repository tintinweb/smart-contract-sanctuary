...
contract CryptoNuggetsTest1 is ERC721, Ownable, IMintedBeforeReveal {
    ...
    function mintMonster(uint256 numberOfMonstro) public payable {
        ...
        require(SafeMath.add(totalSupply(), numberOfMonstro) <= MAX_NUGGET_SUPPLY, "Exceeds maximum Monster supply of 8,000. Please try to mint less Monsters.");
