...
contract DutchAuction{
    ...
    function startAuction(uint256 min, uint _startPrice, uint _finish, address[] memory whitelistd, bool whitelist) public{
    ...
    function getCurrentPrice() public view returns (uint256) {
        uint256 returnPrice;
        if (open == 1) {
            returnPrice = startPrice * ((finish - block.timestamp)*10000/(finish - start))/10000;
    ...
    function withdraw() public{
        ...
        token.transfer(owner, tokensStart - bought);
    }
}
