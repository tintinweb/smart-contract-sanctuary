...
contract MTBNN is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("MetaBunny", "MTBNN") {
    ...
    function mintAsOwner(address[] calldata accounts) external onlyOwner {
        require(totalSupply() + accounts.length <= allowedToExist, "Cannot mint this much");
    ...
    function buy(uint256 amount) external payable {
        require(totalSupply() + amount <= allowedToExist, "Cannot buy this much");
