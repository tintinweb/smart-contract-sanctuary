...
contract MiddleWare is OwnableContract{
    ...
    function getWalletAndMining(address userAddress) public view returns(address[] memory addrArray, uint256[] memory walletArray, uint256[] memory miningArray){
        ...
        for(uint256 i=0; i<5; i++){
            ...
            (uint256 amount, uint256 rewardDebt, uint256 rewardToClaim)= chickMining.getUserInfo(poolIdArray[i], userAddress);
