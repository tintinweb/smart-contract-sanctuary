  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        function mintTo(address _to) public payable {
            ...
            require(msg.value == PRICE, "Value needs to be exactly 0.0123 ETH!");
            uint256 newTokenId = _getNextTokenId();
            _mint(_to, newTokenId);
            _incrementTokenId();
        }
    ...
    // File: contracts/apeDoodlesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ApeDoodlesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Ape Doodles", "Ape Doodle", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://Qmb8RbfVejrtH8wN12vWMcGZ1iv5uqe6J8qDuDR6A7fFk1/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/32S4CS9eGojuU1jhVYZ9/contract-metadata";
        }
    }