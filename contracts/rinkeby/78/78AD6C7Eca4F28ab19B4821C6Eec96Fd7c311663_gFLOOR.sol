...
contract gFLOOR is IgFLOOR, ERC20 {
    ...
    constructor(address _migrator, address _sFLOOR)
     ...
     * @param _sFLOOR address
     */
    function migrate(address _staking, address _sFLOOR) external override onlyApproved {
        ...
        require(_sFLOOR != address(0), "Zero address found");
        sFLOOR = IsFLOOR(_sFLOOR);
    }
