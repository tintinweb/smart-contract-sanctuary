...
contract Channeler is Context, AccessControlEnumerable, Pausable, IChanneler {
    ...
    function fractionalize(IERC721 collection, uint256 tokenId, FractionalizationData calldata data) public override whenNotPaused {
...
interface IChanneler {
    ...
    function fractionalize(IERC721 collection, uint256 tokenId, FractionalizationData calldata data) external;
