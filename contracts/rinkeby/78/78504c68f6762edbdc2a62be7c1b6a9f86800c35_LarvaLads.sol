...
contract LarvaLads is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[8] private baseColors = ['674322','F5979E','58544E','B27C07','F5EEE9','9E0B0F','7A623F','C7B19A'];
    ...
    function getSVG(LarvaObject memory larvaLad) internal view returns (string memory) {
        ...
        parts[0] = '<svg id="x" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 30 29.5"><path fill="#638596" d="M0 0h30v30H0z"/>';
        parts[1] = '<path stroke="#';
