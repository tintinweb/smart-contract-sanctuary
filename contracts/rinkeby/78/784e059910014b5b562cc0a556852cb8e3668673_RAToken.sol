...
contract RAToken is Initializable, ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory name, string memory symbol, address pauser, address updater) public initializer {
