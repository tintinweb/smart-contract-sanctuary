...
contract ClownPunkSociety is ERC721Enumerable, Ownable {
    ...
    function punkToClownAssets(uint16 punkIndex) internal returns (bytes memory childAssets) {
        ...
        for (uint8 j = 0; j < 10 && assetIndex < 8; ++j) {
            ...
            if ((j == uint8(Type.Nose)) && (asset != 18) && (asset != 109) && (kind < 10)) {
                if (nextPseudoRandom(2) == 0) {
                    childAssets[assetIndex++] = bytes1(isMale ? 18 : 109); // red
                } else if (nextPseudoRandom(3) == 0) {
                    childAssets[assetIndex++] = bytes1(isMale ? 134 : 135); // green
                } else {
                    childAssets[assetIndex++] = bytes1(isMale ? 136 : 137); // blue
                }
            } else if ((j == uint8(Type.Eyes)) && (asset != 39) && (asset != 114) && (asset != 94) && (asset != 73)) {
                if (asset == 78) {
                    childAssets[assetIndex++] = bytes1(uint8(94)); // blue
                } else if (asset == 97) {
                    childAssets[assetIndex++] = bytes1(uint8(144)); // purple
                } else if (asset == 126) {
                    childAssets[assetIndex++] = bytes1(uint8(114)); // green
                } else if (asset == 0) {
                    if (nextPseudoRandom(2) == 0) {
                        childAssets[assetIndex++] = bytes1(isMale ? 138 : 139); // purple
                    } else if (nextPseudoRandom(2) == 0) {
                        childAssets[assetIndex++] = bytes1(isMale ? 39 : 114); // green
                    } else {
                        childAssets[assetIndex++] = bytes1(isMale ? 73 : 94); // blue
                    }
                }
            } else if ((j == uint8(Type.Hair)) && (asset != 14) && (asset != 104)) {
                if ((asset == 50) || (asset == 81)) {
                    childAssets[assetIndex++] = bytes1(isMale ? 142 : 143); // red
                } else if (asset == 28) {
                    childAssets[assetIndex++] = bytes1(uint8(144)); // purple
                } else if (asset == 121) {
                    childAssets[assetIndex++] = bytes1(uint8(145)); // pink
                } else if (nextPseudoRandom(3) == 0) {
                    childAssets[assetIndex++] = bytes1(isMale ? 140 : 141); // blue
                } else if (nextPseudoRandom(2) == 0) {
                    childAssets[assetIndex++] = bytes1(isMale ? 14 : 104); // green
                } else if (nextPseudoRandom(2) == 0) {
                    childAssets[assetIndex++] = bytes1(isMale ? 142 : 143); // red
                } else {
                    childAssets[assetIndex++] = bytes1(isMale ? 144 : 145);
                }
            } else if (asset != 0) {
