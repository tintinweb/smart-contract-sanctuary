...
contract CutePigClub3D is ERC721, Ownable {
    ...
    uint256 public pigPrice = 30000000000000000; // 0.03 ETH
    ...
    function Burnpigsinto3dpig(uint256 PIGtokenId1, uint256 PIGtokenId2,uint256 PIGtokenId3) public payable {
       ...
       require(cpcPig.ownerOf(PIGtokenId1) == msg.sender, "Must own the CPC pig for requested tokenId to mint a 3d PIG");
       require(cpcPig.ownerOf(PIGtokenId2) == msg.sender, "Must own the CPC pig for requested tokenId to mint a 3d PIG");
       require(cpcPig.ownerOf(PIGtokenId3) == msg.sender, "Must own the CPC pig for requested tokenId to mint a 3d PIG");
       
       cpcPig.approve(_burnaddress, PIGtokenId1 );
       cpcPig.safeTransferFrom( cpcPig.ownerOf(PIGtokenId1),_burnaddress, PIGtokenId1 );
       cpcPig.approve(_burnaddress, PIGtokenId2 );
       cpcPig.safeTransferFrom( cpcPig.ownerOf(PIGtokenId2),_burnaddress, PIGtokenId2 );       
       cpcPig.approve(_burnaddress, PIGtokenId3 );
