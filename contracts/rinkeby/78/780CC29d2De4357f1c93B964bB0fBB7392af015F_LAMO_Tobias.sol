...
contract LAMO_Tobias is ExPopulusERC721WithSingleMetadataIPFS {
  constructor()
    ExPopulusERC721WithSingleMetadataIPFS(
        "Tobias",
        "LAMO",
        "ipfs://",
        "QmaoTVyQhu6JrvVLcMe7ckZB84XQRzAQZX4FnBxjQRwReM",
        "https://ipfs.io/ipfs/",
        "QmREpWe2LwJmVuju92UCmM76i61hPNyJwF7REm94q64Kmt",
        1,
        100000000000000,
        100,
        payable(address(0xa2BF605a301C09478036DB780B066901B26B8f11)),
        payable(address(0xa2BF605a301C09478036DB780B066901B26B8f11))
    ) {}
}
 ...
 *                                              |__/
 */
contract ExPopulusERC721WithSingleMetadataIPFS is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    event RaribleBeneficiaryTransferred(address payable indexed previousBeneficiary, address payable indexed newBeneficiary);
    ...
    function mintToken(address owner) public payable returns (uint256) {
        ...
        if (getPrice() > 0) {
            (bool sent, bytes memory data) = _beneficiary.call{value : msg.value}("");
    ...
    */
    ...
    function setRaribleBeneficiary(address payable newBeneficiary) public onlyOwner {
        ...
        emit RaribleBeneficiaryTransferred(_raribleBeneficiary, newBeneficiary);
    ...
    function getTotalAmountAllowedToBeMinted() public view virtual returns (uint256)  {
        return _totalAmountAllowedToBeMinted;
    }
    ...
    */
    function setRaribleRoyaltyPercentage(uint96 percentage) public onlyOwner() {
        emit RaribleRoyaltyPercentageChange(_raribleRoyaltyPercentage, percentage);
    ...
    function setContractBaseURI(string memory baseURI_) public onlyOwner() {
        emit ContractBaseURIChanged(_contractBaseURI, baseURI_);
    ...
    function setContractURI(string memory contractURI_) public onlyOwner() {
        emit ContractURIChanged(_contractURI, contractURI_);
