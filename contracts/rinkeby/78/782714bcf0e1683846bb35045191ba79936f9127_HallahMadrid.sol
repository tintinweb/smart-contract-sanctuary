...
contract HallahMadrid is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hallah madrid ⚽️" ;
    string private constant _symbol = unicode"hallah madrid";
