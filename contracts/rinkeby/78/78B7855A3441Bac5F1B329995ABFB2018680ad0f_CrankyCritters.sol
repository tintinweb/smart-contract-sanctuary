...
contract CrankyCritters is ERC721Enumerable, Ownable, VRFConsumerBase {
  ...
  //  mapping(address => bool) private _whiteListClaimed;
    ...
    bytes32 public merkleRoot = 0x0c54a8e40527fa869b41cf8d24536c39240bce90b00f1aaf644d7456a1d758f0; //TODO set
    ...
    function isOnPreSale(address sender, uint8 amount, bytes32[] memory proof) private view returns(bool) {
    ...
    function generalMintingRules(uint256 value, uint256 quantity) private view {
        ...
        require(
            totalPublicSupply + quantity <= CC_PUBLIC,
            "this exceed the public amount"
        );
    ...
    //whitelistMint
       ...
       // require(isPreSaleActive, "PreSale is not active");
        require(isOnPreSale(msg.sender, numberOfTokens + _nrMinted[msg.sender], proof), "Not on Presale with this amount");
        generalMintingRules(msg.value, numberOfTokens);

        for (uint256 i = 0; i < numberOfTokens; i++) {
            totalPublicSupply += 1;
            uint256 tokenId = CC_RESERVE + totalPublicSupply;
            _nrMinted[msg.sender] += 1;
    ...
    function gift(address[] calldata to) external onlyOwner {
        ...
        require(
            totalReserveSupply + to.length <= CC_RESERVE,
