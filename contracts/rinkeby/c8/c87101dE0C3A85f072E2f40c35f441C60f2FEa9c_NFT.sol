...
contract NFT is ERC721("Test NFT Contract", "TEST"), Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant MAX_TEAM_MINTS = 100;
    ...
    constructor() public {
        tokenID = 0;
        saleIsActive = false;
        remainingTeamMints = MAX_TEAM_MINTS;
    }
    ...
    function teamMint(uint256 numberOfTokens) public onlyOwner {
        require(
            numberOfTokens <= remainingTeamMints,
            "Can not mint that many for team!"
        );
        require(
            totalSupply().add(numberOfTokens) <= MAX_SUPPLY,
        ...
        remainingTeamMints -= numberOfTokens;
