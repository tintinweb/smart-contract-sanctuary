...
contract MarsPool {
    address shiba = 0xA740A59a6CaCeEe97fd9870937088f5fD1A3041a;
    ...
    mapping (address => PoolUserStruct) private pool1users;
    ...
    event getPoolPayment(address indexed _user,address indexed _receiver, uint _value, uint _time);
      ...
      constructor(address _creator1) public {
...
//// for creator1
  ...
  UserStruct memory userStruct1;
      ...
      function regUser(uint _referrerID) public payable {
        ...
        ERC20(shiba).transferFrom(address(msg.sender), address(this), REGESTRATION_FESS);
      ...
      function payReferral(uint _level, address _user) internal {
        ...
        ERC20(shiba).transfer(address(msg.sender), level_price_local);
      ...
      function buyPool1() public payable {
        ...
        pool1userList[pool1currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool1Currentuser), pool1_price);
      ...
      function buyPool2() public payable {
        ...
        pool2userList[pool2currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool2Currentuser), pool2_price);
      ...
      function buyPool3() public payable {
        ...
        pool3userList[pool3currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool3Currentuser), pool3_price);
      ...
      function buyPool4() public payable {
        ...
        pool4userList[pool4currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool4Currentuser), pool4_price);
      ...
      function buyPool5() public payable {
        ...
        pool5userList[pool5currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool5Currentuser), pool5_price);
      ...
      function buyPool6() public payable {
        ...
        pool6userList[pool6currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool6Currentuser), pool6_price);
      ...
      function buyPool7() public payable {
        ...
        pool7userList[pool7currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool7Currentuser), pool7_price);
      ...
      function buyPool8() public payable {
        ...
        pool8userList[pool8currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool8Currentuser), pool8_price);
      ...
      function buyPool9() public payable {
        ...
        pool9userList[pool9currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool9Currentuser), pool9_price);
      ...
      function buyPool10() public payable {
        ...
        pool10userList[pool10currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool10Currentuser), pool10_price);
      ...
      function buyPool11() public payable {
        ...
        pool11userList[pool11currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool11Currentuser), pool11_price);
      ...
      function buyPool12() public payable {
        ...
        pool12userList[pool12currUserID]=msg.sender;
        ERC20(shiba).transfer(address(pool12Currentuser), pool12_price);
