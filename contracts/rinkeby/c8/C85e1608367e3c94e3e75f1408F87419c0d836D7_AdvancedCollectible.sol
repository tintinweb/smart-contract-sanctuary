...
contract AdvancedCollectible is ERC721, VRFConsumerBase{
  ...
  mapping(uint256 => Breed) public tokenID2Breed;
  mapping(uint256 => bytes32) public tokenID2RequestID;
  mapping(bytes32 => address) public requestID2Sender;
  mapping(bytes32 => string) public requestID2TokenURI;
  mapping(bytes32 => uint256) public requestID2TokenID;
  ...
  function createCollectible() public returns (bytes32){
    ...
    // requestID2TokenURI[requestID] = tokenURI;
    emit requestedCollectible(requestID, msg.sender);
  }

  function setTokenURI(uint256 tokenID, string memory _tokenURI) public{
    require(_isApprovedOrOwner(_msgSender(), tokenID), "ERC721: transfer caller is not owner nor approved");
    requestID2TokenURI[tokenID2RequestID[tokenID]] = _tokenURI;
  ...
  function fulfillRandomness(bytes32 requestID, uint256 randomness) internal override {
    ...
    tokenID2Breed[newTokenID] = breed;
    requestID2TokenID[requestID] = newTokenID;
    tokenID2RequestID[newTokenID] = requestID;
    _safeMint(requestID2Sender[requestID], newTokenID);
    // _setTokenURI(newTokenID, requestID2TokenURI[requestID]);
