...
contract StandardLiqOwnershpToken is Context, IERC20, Ownable {
    ...
    constructor (string memory tokenName, string memory tokenSymbol,uint256 initialSupply ,uint256 lpFee_){
        _name = tokenName;
        _symbol = tokenSymbol;
        _tTotal = initialSupply * 10 ** _decimals;
