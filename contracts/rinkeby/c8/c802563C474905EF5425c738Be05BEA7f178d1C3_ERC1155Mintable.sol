...
contract ERC1155Mintable is ERC1155, ERC1155Supply, Ownable {
    ...
    function mintBatch(
        ...
        for(; _tokenIdTracker.current() < startingId + amounts.length; _tokenIdTracker.increment()){
            ids.push(_tokenIdTracker.current());
        }
