...
contract CMStaking is Ownable {
    ...
    */
    ...
    function setActiveSeason() public returns (bool) {
...
//        require(startTime_ > block.timestamp, "SEA-01");
    ...
    {
        require (setActiveSeason(), "No active season found!");
        ...
        seasonToTotalStakingAmountSeconds[activeSeason] += stakeAmount*(stakingSeasons[activeSeason-1].endTime - block.timestamp);
    ...
    modifier _after(uint256 eventTime) {
        require(
            ...
            "CMStaking: bad timing for the request"
        );
        _;
    }
    ...
    modifier _hasAllowance(address allower, uint256 amount) {
        ...
        require(
            amount <= ourAllowance,
            "CMStaking: Make sure to add enough allowance"
        );
        _;
    }
