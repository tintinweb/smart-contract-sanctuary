    ...
    AccessControlEnumerableUpgradeable
{
    ...
    function setGlobalOperator(address operator) public onlyAdmin {
        _setupRole(OPERATOR_ROLE, operator);
    }

    function removeGlobalOperator(address operator) public onlyAdmin {
        renounceRole(OPERATOR_ROLE, operator);
    }
