 ...
 */
contract ERC721Mintable is ERC721Tradable, MinterRole {
...
// File: contracts\DataSet7.sol

contract DataSet7 is ERC721Mintable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("DataSet7", "DataSet7", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset7/metadata/token/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset7/metadata/contract/metadata.json";
    }
}