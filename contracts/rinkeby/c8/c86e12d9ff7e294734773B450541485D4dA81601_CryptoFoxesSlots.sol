...
contract CryptoFoxesSlots is Ownable, CryptoFoxesUtility {
    ...
    ICryptoFoxesStakingV2 cryptoFoxesStakingV2;
    ICryptoFoxesOriginsV2 cryptoFoxesOrigin;
    ...
    function _unlockSlot(address _wallet, uint16 _tokenIdOrigin, uint8 _count) private {
        ...
        uint256 price = _getTotalPrice(currentMaxSlot, _count);        
    ...
    function _getTotalPrice(uint8 _currentMaxSlot, uint256 _count) public view returns(uint256){
        uint256 price = 0;
