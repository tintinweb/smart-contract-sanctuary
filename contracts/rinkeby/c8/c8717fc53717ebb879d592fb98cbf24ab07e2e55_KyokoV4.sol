    ...
    PausableUpgradeable
{
    ...
    function getNftHolderMapFromIndex(address holder, uint256 index) public view returns(uint256) {
        return nftHolderMap[holder].at(index);
    }

    function getNftHolderMapLength(address holder) public view returns(uint256) {
        return nftHolderMap[holder].values().length;
    }
    ...
    function getDepositIdOfferMapFromIndex(uint256 _depositId, uint256 index) public view returns(uint256) {
        return depositIdOfferMap[_depositId].at(index);
    }

    function getDepositIdOfferMapLength(uint256 _depositId) public view returns(uint256) {
        return depositIdOfferMap[_depositId].values().length;
    }
