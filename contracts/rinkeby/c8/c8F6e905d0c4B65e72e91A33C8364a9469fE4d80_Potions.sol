...
contract Potions is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private realm = [
        ...
        "Found in",
        "Excavated in",
        "Accidently Discovered in",
        "Accidently Manifested in",
        "Accidently Stolen from",
        "Accidently Alchemized in",
        "Accidently Conjured in",
        "Accidently Concocted in",
...
// change rarity to not repeat the same thing
    ...
    function withdraw() public onlyOwner {
        payable(0x3878f298020283dc48dDd887Cd13cd9567A2aA37).transfer(address(this).balance);
    }
