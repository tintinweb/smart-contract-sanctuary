...
abstract contract Allowance is Ownable {
...
contract DROTokenTrust is IDROTokenTrust, Allowance {
    ...
    function approveSpendToken(address tokenAddress, uint amount) public returns (bool) {
        return ERC20(tokenAddress).approve(address(this), amount);
    }
    ...
    function depositToken(address tokenAddress, uint amount) public {
        ...
        bool transferResult = ERC20(tokenAddress).transferFrom(msg.sender, address(this), amount);
    ...
    function withdrawal(uint256 amount) public override returns (bool) {
        ...
        bool transferResult = payable(msg.sender).send(amount);
