...
// File: src\contracts\MooMooCollectible.sol

pragma solidity ^0.8.0;



contract MooMooCollectible is ERC721, ERC721Enumerable, Ownable {
  using Strings for uint256;
  using Address for address;
  ...
  address public a1 = 0xDABfbc3006Fa8D06D8DeE5769FA5168758908030;
  ...
  constructor(string memory newBaseURI) ERC721("Moo Moo", "MOO") {
  ...
  // Whitelist Presale Minting Function
  ...
  function editPresaleReserved(address[] memory _a, uint256[] memory _amount)
    public
    onlyOwner
  {
  ...
  function withdrawTeam(uint256 amount) public payable onlyOwner {
    ...
    require(payable(a1).send(amount));
  }
