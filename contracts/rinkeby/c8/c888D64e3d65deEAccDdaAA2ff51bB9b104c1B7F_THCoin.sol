    ...
    ERC20Pausable
{
     ...
     */
    constructor() ERC20("THMining Coin", "THC") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(
            ...
            "THCoin: must have minter role to mint"
        );
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(
            ...
            "THCoin: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "THCoin: must have pauser role to unpause"
        );
        _unpause();
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(! isInMinimumRetentionPolicy(from, amount));

        super._beforeTokenTransfer(from, to, amount);
    }

    function isInMinimumRetentionPolicy(address holder, uint256 amount) public view returns (bool) {
      return false;
    }
