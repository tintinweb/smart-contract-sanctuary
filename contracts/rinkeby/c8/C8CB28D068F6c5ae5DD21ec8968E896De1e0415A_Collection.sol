...
contract Collection is AccessControl {
    ...
    mapping(address => Set) private addressToTokenId;
    ...
    constructor(ColData memory collecData) {
    ...
    function buy(
        ...
        addressToTokenId[msg.sender].add(_id);
        available -= 1;
        sold += 1;
        soldCards.add(_id);
    ...
    function setExternalAddresses(
        ...
        emit ExternalAddressesAdded(_token, _treasury, _artist, _middleman);
    }
    ...
    function getAddressToTokenId(address buyer)
        external
        view
        returns (uint256[] memory)
    {
        return addressToTokenId[buyer].getArray();
    }
}
