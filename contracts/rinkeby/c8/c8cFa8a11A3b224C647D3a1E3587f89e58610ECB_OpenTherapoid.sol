...
// File: contracts/OpenTherapoid.sol
...
contract OpenTherapoid is ERC20, Ownable, Pausable {
    ...
    /**
     * @dev Sets the values for {name = ScienceCoin}, {totalSupply = 5000000}, {decimals = 18} and {symbol = NOBL}.
     *
    ...
    constructor(
        ...
        // Since by default the noOfDecimals set is 18
        if (noOfDecimals != 18) {
            super._setupDecimals(noOfDecimals);
        }
        super._mint(msg.sender, fixedSupply); // Since Total supply 500 Million NOBL
    }
