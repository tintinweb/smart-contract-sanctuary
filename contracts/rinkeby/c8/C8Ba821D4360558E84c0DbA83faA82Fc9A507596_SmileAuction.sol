...
contract Auction_ {
    ...
    constructor (
        ...
        require(_startBlock< _endBlock, "startblock is greater than endblock");
        require(_startBlock > block.number, "startblock is less than current block");
    ...
    function withdraw() public onlyEndedOrCanceled returns (bool success) {
        ...
        require(withdrawalAmount > 0, "withdrawal amount 0");
