...
contract VetaverseAuction is Ownable, ERC721Holder {
    ...
    function createAuction(
        ...
        IVetaverseNFT nft = IVetaverseNFT(_collectionId); 
    ...
    function finalizeAuction(uint256 _auctionId) public {
        ...
        if(bidsLength == 0) {
            IVetaverseNFT(myAuction.collectionId).safeTransferFrom(address(this), myAuction.owner, myAuction.tokenId);
            ...
            address _creator = IVetaverseNFT(myAuction.collectionId).creatorOf(myAuction.tokenId);
            uint256 royalty = IVetaverseNFT(myAuction.collectionId).royalties(myAuction.tokenId);
            ...
            IVetaverseNFT(myAuction.collectionId).safeTransferFrom(address(this), lastBid.from, myAuction.tokenId);		
            auctions[_auctionId].active = false;
