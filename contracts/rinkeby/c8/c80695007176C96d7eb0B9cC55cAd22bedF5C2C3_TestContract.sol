...
contract TestContract is ERC721Enumerable, Ownable {
    ...
    {        
        ...
        require(numToMint > 0 && numToMint <= 100, 'You can mint no fewer than 1, and no more than 20 at a time.'); //TODO
    ...
    */
    ...
    function reserve(address[] memory reservedAddresses) public
    {
        ...
        require(numTokens+RESERVED_SUPPLY <= MAX_SUPPLY, "Cannot be done - this will mint more than the total supply.");
