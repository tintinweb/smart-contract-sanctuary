...
contract GigaGardenLSD is ERC721, Ownable, PaymentSplitter, Whitelist {
    ...
    address whitelistAddress = 0xC96a344AF24BE4CE16900fA299Fe38b07Dcf7b7e;
    ...
    /**
     * Choose ERC721 address to check for whitelist
     */
    function setWhitelistAddr(address _newAddr) public onlyOwner {
       whitelistAddress = _newAddr;
    }
     ...
     */
    function checkWhitelisted(address myAddress) public returns (uint256) {
        ERC721 token = ERC721(whitelistAddress);
        
        myint = token.balanceOf(myAddress);
        return (myint+4);
    }
    /**
