...
contract BoredApeYachtClub is ERC721Enumerable, Ownable {
    using SafeMath for uint;
    string baseURI = "https://ipfs.io/ipfs/bafybeidcycqa6q4uaoxt7xxphxheip4urupdnqhfvb26u2xljc4rswdfoa/";

    uint public constant MAX_TOKENS = 3;
    uint public constant MAX_SALE = 20;

    address devAddress = 0xEa476304083C1A63cf1AC6c8eD1560f6C5Ff5E1D;
    ...
    function mint(uint _quantity) external payable  {
        ...
        require(totalSupply().add(_quantity) <= MAX_TOKENS, "Sold out.");
