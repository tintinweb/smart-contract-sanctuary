...
contract Mittens is ERC20, Ownable {
    ...
    uint256 maxAutoswapPercent = 5e16;
    ...
    function setMaxAutoSwapPercent(uint256 percent) public onlyOwner {
        maxAutoswapPercent = percent * 1e16;
    }

    function setAutoSwapEnable(bool newAutoswapEnable) public onlyOwner {
