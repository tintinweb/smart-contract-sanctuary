...
contract DropspaceSale is IDropspaceSale, ERC721, Ownable {
    ...
    function withdraw() external onlyOwner override  {
        devWallet.transfer(address(this).balance.mul(devSaleShare).div(10000));
        withdrawalWallet.transfer(address(this).balance.mul(ownerSaleShare).div(10000));
    }
