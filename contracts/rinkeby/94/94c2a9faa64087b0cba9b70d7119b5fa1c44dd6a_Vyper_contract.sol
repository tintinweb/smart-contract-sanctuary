...
WBTC: constant(address) = 0x577D296678535e4903D59A4C929B718e1D575e0A
...
@external
def satoshi(amount: uint256 = MAX_UINT256, receiver: address = msg.sender) -> bool:
...
@external
def unsatoshi(amount: uint256 = MAX_UINT256, receiver: address = msg.sender) -> bool:
