...
///////////////////////////////
// 1. buyer must check product quality
// 2. The amount of cargo that will be verified by the seller and buyer can vary up to 0.5 %
//////////////////////////////
...
//      ///////////////////////////  End of  Modifiers  ///////////////////
    ...
    // constructor(string _goods_name, string _unit_name, uint _unit_price, uint _delivery_time,
    // uint _penalty_percent, uint _kyc_deadline, uint _broker_percent,
    // uint _demand, string _loading_point, address _buyer, address _seller, address _vessel_validator, address _arbitrator,
    // address _final_seller_inspector )
    // {



    // constructor(string[] memory _all_strings, uint[6] memory _all_uints, address _buyer, address _seller, address _vessel_validator,
    ...
    //     // require(kyc_deadline > block.timestamp);
    //     // require(kyc_deadline < delivery_time);
    ...
    //     payable(arbitrator).transfer(arbitrator_share);
    //     payable(seller).transfer(seller_share);
    //     payable(buyer).transfer(buyer_share);
    // }
    ...
    //         payable(beneficiary).transfer(penalty_value);
    //     }
    // }
    
    // function pay_penalty() public payable inState(State.waiting_to_pay_penalty)
    // {
    //     require(msg.value == penalty_value);
