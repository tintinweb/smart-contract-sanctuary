...
contract TortugaMintPass is ERC721, ReentrancyGuard, Ownable {
    ...
    constructor(string memory customBaseURI_, address earlyMintPassAddress_) ERC721("TortugaMintPass", "TUGAPASS2"){
    ...
    function mint() public payable nonReentrant {
        ...
        require(earlyMintPass.balanceOf(_msgSender()) == 0, "Address already owns an early mint pass");
