...
contract TESTFOX is Ownable, ERC721Enumerable {
    ...
    // Public constants
    address public constant DDOBES = 0xb1C3F867693f133306ee32e12878fc23E270B35B;
    uint256 public constant BUYABLE_SUPPLY = 200;
    uint256 public constant MAX_NFTS = 10000;
    uint256 public startingIndexBlock;
    uint256 public startingIndex;
    uint256 public mintPrice = 0.001 ether;
    uint256 public mintAmount = 15;
    ...
    constructor() ERC721("TESTFOX", "TSTFOX") {
        REVEAL_TIMESTAMP = block.timestamp;
    }

    function mint(uint256 quantity ) public payable {
        require(open, "Tokens not available yet");
    ...
    function mintFreeSome(uint256 _indexStart, uint256 _indexEnd) public payable {
        require(openFree, "Drop not open yet");

        ERC721Enumerable nfts = ERC721Enumerable(DDOBES);
        uint256 numNFTs = nfts.balanceOf(msg.sender);
        require(_indexEnd < numNFTs, "Not Enough Dobes");
