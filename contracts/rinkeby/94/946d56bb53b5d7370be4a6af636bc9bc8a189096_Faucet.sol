...
contract Faucet {
    ...
    constructor(address _tokenAddress) {
        ...
        withdrawLimit = 10000000000000000000000;
    }
    ...
    function withdrawToken () public {
        ...
        TransferHelper.safeTransfer(tokenAddress, msg.sender, 10000000000000000000000);
        emit WithdrawToken(msg.sender, 10000000000000000000000);
    }
