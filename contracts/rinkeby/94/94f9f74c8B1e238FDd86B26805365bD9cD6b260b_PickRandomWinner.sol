...
contract PickRandomWinner is VRFConsumerBase, Ownable {
    ...
    event VerifySigningHash(bytes32 signingHash);
    ...
    function withdrawEthFromContract() public payable onlyOwner {
        ...
        require(privWithdrawWallet.send(accountBalance), "");
    }
    ...
    function verify(bytes memory signature, uint256 blockExpiry, uint256 documentId, uint256 totalSigners) public returns (bool) {
        ...
        emit VerifySigningHash(signingHash);
    ...
    function requestWinner(bytes memory signature, uint256 blockExpiry, uint256 documentId, string memory urlHash, uint256 totalSigners) public payable {
