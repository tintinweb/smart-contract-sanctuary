...
import "@openzeppelin/contracts/token/ERC20/extensions/ERC20Votes.sol";
  ...
  contract Token is ERC20, AccessControl, ERC20Capped,ERC20Permit, ERC20Votes {
  ...
  constructor(
    ...
    ERC20Permit(name_)
    {
      ...
      _setupRole(BURNER_ROLE, _msgSender());
        ...
        _minimumTimeBetweenMints= 1 minutes * 15;  
        _nextAllowedMint = 2000 * (10**uint256(18));
        _mintCount = 3;
        _mintAmountleft = 6000 * (10**uint256(18));
    }
