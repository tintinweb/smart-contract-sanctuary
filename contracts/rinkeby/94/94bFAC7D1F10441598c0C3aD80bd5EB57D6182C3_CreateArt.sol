...
contract CreateArt is ERC721, Ownable {
    ...
    function createArt(
        ...
        assets[tokenCounter] = Asset(msg.sender, price, isForSale, true);

        _safeMint(msg.sender,tokenCounter);
        _setTokenURI(tokenCounter, tokenURI);

        emit NewTokenMinted(msg.sender, tokenCounter);
