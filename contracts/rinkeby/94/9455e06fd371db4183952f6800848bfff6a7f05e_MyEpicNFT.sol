...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string baseSvg2 =
        "'/><text x='50%' y='40%' class='base' dominant-baseline='middle' text-anchor='middle'>Will's Web3 Welcome</text><text x='50%' y='60%' class='base' dominant-baseline='middle' text-anchor='middle'>";
    ...
    constructor() ERC721("Will's Web3 Welcome", "WWW") {
    ...
    function makeAnEpicNFT() public {
        ...
        require(newItemId <= 100, "All 100 NFTs have already been minted.");
