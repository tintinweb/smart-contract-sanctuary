...
// File contracts/interface/ITradeMining.sol
...
contract Updater is Ownable {
    ...
    ITradeMining public tradeMining;
    ...
    constructor(
        ...
        require(_tradeMining != address(0), "Updater: zero address");
        ...
        tradeMining = ITradeMining(_tradeMining);
        admin = _admin;
    }
    ...
    function setTradeMining(address _newAddress) public onlyOwner {
        require(_newAddress != address(0), "Updater: zero address");
        tradeMining = ITradeMining(_newAddress);
    }
    ...
    function update() external canUpdate {
        ...
        // Set cycleRewrad for current cycle
        tradeMining.update();
    ...
    modifier canUpdate () {
        ...
        require(volumeBook.getTotalTradeVolume(currentCycleNum) > 0, "Updater: No Volume");
        _;
    }
