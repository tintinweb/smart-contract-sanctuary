...
contract Stradaverse is ERC721, Ownable, ReentrancyGuard {
  ...
  function tokenURI(uint256 id_) public view override returns (string memory) {
    ...
    string memory description = "Welcome to the Stradaverse.";
    string memory pageUrl = string(
      abi.encodePacked(viewerBaseUrl, '/', id)
    );
...
/// @dev Source: https://etherscan.io/address/0x0f78c6eee3c89ff37fd9ef96bd685830993636f2#code
