...
contract StellaFaciem is ERC721Pausable, Ownable {
    ...
    uint256 private constant mintLimit = 3_333;
...
//        _pause();
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount <= mintLimit, "Max mint 3,333 tokens at a time");
        require(
            balanceOf(msg.sender) + amount <= MAX_SF_PER_ADDRESS,
            "Exceeded max token purchase"
        );
        require(
            _tokenIdCounter.current() + amount < MAX_SF,
