 ...
 */
contract ERC721Public is ERC721Storage, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender(), "ERC721: caller is not the owner");
        _;
    }
    ...
    */
    function balanceOf(address owner_) public view override returns (uint256) {
        require(owner_ != address(0), "KIP17: balance query for the zero address");
    ...
    */
    function tokenOfOwnerByIndex(address owner_, uint256 index) public view override returns (uint256) {
        require(index < balanceOf(owner_), "KIP17Enumerable: owner index out of bounds");
    ...
    function _burn(address owner_, uint256 tokenId) internal virtual{
        require(ownerOf(tokenId) == owner_, "ERC721: burn of token that is not own");
 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721Storage is Context, ERC165 {
    using SafeMath for uint256;
    using Address for address;
    using Counters for Counters.Counter;
