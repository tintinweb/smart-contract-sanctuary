...
contract NifterRoyaltyRegistry is Ownable, IERC1155CreatorRoyalty {
    ...
    function getERC1155TokenRoyaltyPercentage(
        ...
        address creator =
        iERC1155TokenCreator.tokenCreator(_contractAddress, _tokenId);
     ...
     * @return uint8 wei royalty fee.
     */
    function getPercentageForSetERC1155ContractRoyalty(address _contractAddress)
    external
    view
    returns (uint8)
    {
    ...
    function calculateRoyaltyFee(
        ...
        _amount
        .mul(
            getERC1155TokenRoyaltyPercentage(_contractAddress, _tokenId)
        )
        .div(100);
    }
    ...
    returns (address payable)
    {
        return iERC1155TokenCreator.tokenCreator(_contractAddress, _tokenId);
    }
}
