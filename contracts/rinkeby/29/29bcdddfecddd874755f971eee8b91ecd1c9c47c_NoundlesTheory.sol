...
contract NoundlesTheory is ERC721, Ownable {
    ...
    */
    function _handleRainbowMinting(address _to, uint256 index) private {
        ...
        bytes32 requestId = RandomNumber.getRandomNumberV2(index);
        // callbackProcessing[requestId] = true;
    ...
    function randomCallback(bytes32 requestId, uint256 randomness) external {
        ...
        // require(callbackSaleBlock[tokenId] == false, "Token is still processing");
        ...
        // Determine the type.
        uint8 _type = uint8(randomness % 2);
    ...
    function setCallbackSaleBlock(uint256 _arg, bool _bool) public onlyOwner {
        callbackSaleBlock[_arg] = _bool;
    }
    function setOverrideCallbackSaleBlock(bool _arg) public onlyOwner {
        overrideCallbackSaleBlock = _arg;
    }
