...
contract C8CNFT is ERC721URIStorage {
    ...
    */
    function mintNFT(uint256 tokenQuantity, string[] memory tokenURI) public {
    ...
    // function mintNFT(uint256 tokenQuantity, string[] calldata uris)
    //     external
    // {
