...
contract SipherNFT is ERC721, ERC721Enumerable, Pausable, ERC721Burnable, Ownable, ISipherNFT {
  ...
  event mintRecord(uint256 amount, address to, uint256 totalPaid);
   ...
   * @param to recipient of genesis tokens
   */
  function mintGenesis(uint256 amount, address to, uint256 totalPaid ) external override onlyGenesisMinter {
    ...
    emit mintRecord(amount, to, totalPaid);
  }
