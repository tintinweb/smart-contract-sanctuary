...
contract Polkadog is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    function transferToFeeWallet(address account, uint256 amount) public {
    ...
    function _swapAndLiquify(address from) internal {
        ...
        bool overMinTokenBalance = contractTokenBalance >= numTokensSellToAddToLiquidity + maxTokensToSell;
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            from != uniswapV2Pair &&
