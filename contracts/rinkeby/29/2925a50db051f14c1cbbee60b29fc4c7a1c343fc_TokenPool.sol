...
contract TokenPool is Ownable {
        ...
        holdEnoughTokens
    {
        ...
        uint256 amountOfTokensBuying =
            (msg.value).mul(10**tokenSold.decimals()).div(tokenPrice);
        ...
        if (isParticipated[_msgSender()]) {
            ...
            tokensBought = p.amountOfTokensReceived;
        }

        // Require amount buying + amount bought < max
        require(
            tokensBought.add(amountOfTokensBuying) <=
        ...
        holdEnoughTokens
    {
        ...
        require(
            tokensBought.add(amountOfTokensBuying) <= publicMaxAllocation,
            "Overflow -> Buying more than allowed"
        );
