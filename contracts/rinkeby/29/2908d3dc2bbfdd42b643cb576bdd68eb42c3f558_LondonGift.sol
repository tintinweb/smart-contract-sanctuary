...
contract LondonGift is Ownable, ERC721 {
   ...
   function setMintStartAtBlockNum(uint256 _mintStartAtBlockNum) public onlyOwner {
    ...
    function mint(uint mintAmount) onlyAfterMintStartAtBlockNum() onlyUnderMaxSupply(mintAmount) onlyMintUnderMaxPerTx(mintAmount) onlyUnderMaxMintPerAddress() public {
