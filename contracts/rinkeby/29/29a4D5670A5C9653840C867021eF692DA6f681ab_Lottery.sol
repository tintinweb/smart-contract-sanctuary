...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEnteranceFee() public returns (uint256) {
        ...
        int256 adjustedPrice = price * 10**8;
        int256 costToEnter = usdEnteryFee / adjustedPrice;
        ...
        override
    {
        ...
        require(randomness > 0, "Randomness not found");
        uint256 indexOfPlayer = randomness % players.length;
