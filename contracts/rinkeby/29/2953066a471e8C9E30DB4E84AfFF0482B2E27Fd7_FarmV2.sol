...
contract FarmV2 is AccessControl{
    ...
    function deposit(uint256 amount,address account) public {
    ...
    function withdraw(uint256 amount, address account) public {

        require(account == msg.sender,"you are not authorized on this account!");
        require(stakers[account].amount >= amount, "Insufficient amount!");
        require(_token.transfer(address(account), amount), "Transfer error!");
    ...
    function sell(uint256 stones, address from, address to) public {
        ...
        //require(msg.sender == from,"you are not authorized on this account!");
