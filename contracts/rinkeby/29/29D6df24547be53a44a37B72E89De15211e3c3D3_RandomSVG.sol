...
contract RandomSVG is ERC721URIStorage, VRFConsumerBase, Ownable {
    ...
    ERC721("RandomSVG", "rsNFT")
    {
        ...
        size = 500;
        price = 10000000000000000; //0.1 ETH
        pathCommands = ["M", "L"];
    ...
    function create() public payable returns (bytes32 requestId) {
        require(msg.value >= price, "Need to send more eths");
        requestId = requestRandomness(keyHash, fee); 
        //qui pago i LINK: es https://rinkeby.etherscan.io/tx/0x265039ce6144e960b12176364b8bad1286f8c5ddfa4d6509f85f46a593318a9f
