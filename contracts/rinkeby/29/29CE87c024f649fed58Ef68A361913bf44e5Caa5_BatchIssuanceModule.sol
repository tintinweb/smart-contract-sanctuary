...
// Dependency file: contracts/interfaces/IBatchIssuanceHook.sol
...
// Root file: contracts/protocol/modules/BatchIssuanceModule.sol
...
// import { IController } from "contracts/interfaces/IController.sol";
// import { IBatchIssuanceHook } from "contracts/interfaces/IBatchIssuanceHook.sol";
...
contract BatchIssuanceModule is ModuleBase, ReentrancyGuard {
     ...
     */
    function batchIssue(uint256[] memory _rounds) external nonReentrant {
    ...
    function withdrawTo(address _to, uint256 _roundsLimit) public nonReentrant {
        ...
        for(uint256 i = 0; i < numRounds; i ++) {
            ...
            uint256 roundIndex = userRounds[msg.sender][userRoundIndex];
    ...
    function getCurrentRound() public view returns(uint256) {
        return rounds.length.sub(1);
    }

    /**
     * Get un-baked round indexes
     */
    function getRoundsToBake() external view returns(uint256[] memory) {
        uint256 count = 0;
