...
contract ClosedEndFund is Ownable, Pausable {
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        ProjectToken.mint(msg.sender, _amount.mul(10**12));
    ...
    function withdraw(uint256 _pid) public {
        ...
        ProjectToken.burn(msg.sender, user.amount.mul(10**12));
    ...
    function claim(uint256 _pid) public {
        ...
        require(user.amount > 0, "Deposited amount 0");
        require(ProjectToken.balanceOf(msg.sender) >= user.amount.mul(10**12), "Not holding Project Token");
    ...
    function transferProjectToken(uint256 _pid, address _to, uint256 _amount, bool _feeInRE) public {
        ...
        ProjectToken.safeTransferFrom(msg.sender, _to, _amount.mul(10**12));
