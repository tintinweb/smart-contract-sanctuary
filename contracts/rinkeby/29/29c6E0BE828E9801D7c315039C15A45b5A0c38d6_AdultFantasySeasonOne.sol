    ...
    IERC2981
{
    ...
    mapping(bytes32 => bool) private usedRandomHexes;
    ...
    function purchaseTokenMintPass(
        ...
        require(!usedRandomHexes[randomHexes[0]], "Random hex has been used");
        ...
        usedRandomHexes[randomHexes[0]] = true;
    ...
    function purchaseToken(
        ...
        for (uint256 index = 0; index < signedRandomHexes.length; index++) {
            ...
            require(!usedRandomHexes[randomHex], "Random hex has been used");

            usedRandomHexes[randomHex] = true;
        }
    ...
    function batchPurchaseReservedTokenMintPass(
        ...
        for (uint256 index = 0; index < guids.length; index++) {
            ...
            require(
                !usedRandomHexes[randomHexes[0]],
                "Random hex has been used"
            );
    ...
    {
        bytes32 hash = keccak256(
            abi.encodePacked(randomHex, contractIdentifier)
        );
