    ...
    PaymentSplitter
{
    ...
    address[] private _team = [0xa0260d525e841D5FbA772D69860dF59713992E95, 0x2868A996089EBEe1Ed1D9E56a373398A907c2dA3, 0xA44E579043e24Db3C23fd015C21c9591e6D7eAc1, 0x40cb92204724e1564153727aB603Fc5EE433c3C4];


    // Real - double check with everyone before go live
    // 0 = owner / 1 = artist / 2 = marketing / 3 - luke

    constructor(string memory _baseTokenURI)
        payable
        PaymentSplitter(_team, _teamShares)
        ERC721("Empty Bunnies NFT Austin Test", "BUNSV2")
    {
