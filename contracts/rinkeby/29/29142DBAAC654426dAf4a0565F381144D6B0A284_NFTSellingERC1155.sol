...
// File @openzeppelin/contracts/token/ERC1155/presets/[email protected].1.0
...
contract NFTSellingERC1155 is ERC1155Holder {
    ...
    function onERC1155Received(
        ...
        nftsForSale[saleID] = nftInfo(false, id, 0, from);
    ...
    function buy(uint256 saleId) external {
        ...
        WETH.transferFrom(
            ...
            nftsForSale[saleId].price_in_eth
        );
    ...
    function updatePrice(uint256 saleId, uint256 price) external {
        require(msg.sender == nftsForSale[saleId].owner, "Not Owner.");
