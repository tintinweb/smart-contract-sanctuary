...
contract Quilts is ERC721Enumerable, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        // Make a list of the quilt patch names
        ...
        string memory attributes = string(
            abi.encodePacked(
                ...
                quilt.includesSpecialPatch ? "true" : "false",
    ...
    function numMintedForAddress(address addr) public view returns (uint256) {
