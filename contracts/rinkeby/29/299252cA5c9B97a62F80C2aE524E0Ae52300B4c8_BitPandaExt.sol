...
contract BitPanda is ERC721Enumerable, Ownable, GenRand {
    ...
    uint public constant initialPhaseNumBlocks = 5760 * 0.3;// After initialPhaseBlocks, random will be settled or first 318 tokens have been sold 
    uint public constant initialPhaseNumTokens = 101;
    ...
    constructor(string memory baseURI) ERC721("BitPanda","PANDAPUNK") {
        _setBaseURI(baseURI);
    ...
    function calculatePrice(uint256 _id) public view returns (uint256) {
        ...
        if (_id >= 1101) {
            return 100000000000000000;        // 1101-1111:  1 ETH,     1000000000000000000
        } else if (_id >= 1051) {
            return 80000000000000000;         // 1051-1100:  0.80 ETH   800000000000000000
        } else if (_id >= 951) {  
            return 64000000000000000;         // 951-1050:  0.64 ETH    640000000000000000
        } else if (_id >= 751) {
            return 32000000000000000;         // 751-950:  0.32 ETH     320000000000000000
        } else if (_id >= 351) { 
            return 16000000000000000;         // 351-750: 0.16 ETH      160000000000000000
        } else if (_id >= 151) {
            return 8000000000000000;          // 151-350:  0.08 ETH     80000000000000000
        } else if (_id >= 51) {
            return 4000000000000000;          // 51-150:   0.04 ETH     40000000000000000
        } else {
            return 2000000000000000;          // 0 - 50   0.02 ETH      20000000000000000
        }
    }
...
contract BitPandaExt is BitPanda {
    ...
    uint256 public constant numThreshold = 101; // the threshold: a reassign will be triggered if numTotalVotes > numThreshold
