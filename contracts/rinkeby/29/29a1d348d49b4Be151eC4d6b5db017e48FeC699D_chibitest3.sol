...
contract chibitest3 is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("chibis test1", "chib1")  {
        setBaseURI(baseURI);
    }
    ...
    function preSaleMint(uint256 num) public payable {
        ...
        require(supply < 2000,                       "max_token_supply_exceeded");
