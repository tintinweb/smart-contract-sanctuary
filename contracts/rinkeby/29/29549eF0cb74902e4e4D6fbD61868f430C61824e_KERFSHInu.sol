...
contract KERFSHInu is Context, IERC20Upgradeable {
    ...
    address payable private _marketingWallet = payable(0xA772e64Cabdfd77A7e32A870655739bB5FFF3579);
...
//===============================================================================================================
    ...
    function setTaxesBuy(uint256 liquidity, uint256 marketing) external onlyOwner {
        ...
        require(liquidity + marketing <= 3450);
