...
contract VbitdexSingle is
    ...
    
 {
   ...
   function getValobitdxFee() public view returns (uint256){
    ...
    function salewithToken(string memory tokenAss,address from , uint256 tokenId, uint256 amount,address tokenAddress,bool _isbool) public{
        checker[tokenId][from] = true;
        newtokenasbid(tokenAss,from,owner(),amount,tokenId,tokenAddress,_isbool);
    ...
    function newtokenasbid(string memory tokenAss,address from, address admin, uint256 amount, uint256 tokenId,address tokenAddress,bool _isbool) internal {
    ...
    function _acceptBId(string memory tokenAss,address from, address admin, uint256 amount, uint256 tokenId,address tokenAddress,bool _isbool) internal{
    ...
    function tokenTrans(
     ...
     function acceptBId(string memory bidtoken,address bidaddr, uint256 amount, uint256 tokenId,address tokenAss,bool _isbool ) public{
        _acceptBId(bidtoken, bidaddr, owner(), amount, tokenId,tokenAss,_isbool);
