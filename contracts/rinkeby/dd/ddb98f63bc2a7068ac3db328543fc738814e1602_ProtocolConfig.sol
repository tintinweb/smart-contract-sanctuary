...
contract ProtocolConfig is InitializableManageable, IProtocolConfig {
    ...
    BP public override protocolFee;
    ...
    function initialize(BP _protocolFee, address _protocolAddress) external initializer {
        InitializableManageable.initialize(msg.sender);
        protocolFee = _protocolFee;
        protocolAddress = _protocolAddress;
    }

    function setProtocolFee(BP newFee) public onlyManager {
        protocolFee = newFee;
