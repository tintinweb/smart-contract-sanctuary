...
contract AdvancedCollectible is ERC721, Ownable {
    ...
    constructor() ERC721("PixoriesTest", "PXST") {}

    function mintAllTokens(address _to) public onlyOwner {
        require(canMint, "Minting is not active!");
    ...
    function setMinting() public onlyOwner {
        canMint = !canMint;
    }
