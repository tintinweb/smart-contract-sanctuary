...
contract DOGELINK is ERC20, Ownable {
    ...
    constructor() ERC20("DogeLink", "DOGELINK") {
        ...
        linkDividendToken = 0xE875A1CfB3307960AA5a9F3BbB010517e2A7a180;
        dogeDividendToken = 0xf7094Cb989Ef3E1eb415c00cDB474943b0321c89;
...
contract LinkDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Link_Dividend_Tracker", "Link_Dividend_Tracker", 0xE875A1CfB3307960AA5a9F3BbB010517e2A7a180) {
        claimWait = 3600;
...
contract DogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Doge_Dividend_Tracker", "Doge_Dividend_Tracker", 0xf7094Cb989Ef3E1eb415c00cDB474943b0321c89) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 100000 * (10**18); //must hold 100000+ tokens
    }
