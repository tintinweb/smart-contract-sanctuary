...
contract NounsDescriptor is INounsDescriptor, Ownable {
    ...
    /**
     * @notice Get the number of available Sover `hair`.
     */
    ...
    /**
     * @notice Get the number of available Sover `face`.
     */
