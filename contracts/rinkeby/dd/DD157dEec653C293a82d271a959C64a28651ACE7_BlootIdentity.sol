...
contract BlootIdentity is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    mapping (string => string) operationBackgrounds;

    constructor() ERC721("BlootIdentity", "BI") Ownable() {
        operationBackgrounds["alpha"] = "#8B0D35";
        operationBackgrounds["beta"] = "#2D5D96";
        operationBackgrounds["gamma"] = "#7BCA9B";
        operationBackgrounds["delta"] = "#D4A18A";
        operationBackgrounds["epsilon"] = "#9E2FE9";
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[1] = operationBackgrounds[getFirstName(tokenId)];
