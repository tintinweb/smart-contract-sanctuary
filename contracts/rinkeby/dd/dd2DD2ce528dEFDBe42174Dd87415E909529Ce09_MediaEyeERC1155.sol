...
contract MediaEyeERC1155 is ERC1155Upgradeable, AccessControlEnumerable {
    ...
    function initialize(
        ...
        for (uint256 i = 0; i < _mints.length; i++) {
            if (_mints[i].amounts.length == 1) {
                mint(
                    _mints[i].to,
                    _mints[i].amounts[0],
                    _mints[i].data,
                    _mints[i].tokenDatum[0],
                    _mints[i].mediaUris[0],
                    _mints[i].approveIDs[0]
                );
            } else if (_mints[i].amounts.length > 1) {
                mintBatch(
                    _mints[i].to,
                    _mints[i].amounts,
                    _mints[i].data,
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        ...
        // return
        //     ERC1155Strings.strConcat(
        //         super.uri(_id),
        //         ERC1155Strings.uint2str(_id)
        //     );
    }
    ...
    function mint(
        ...
        require(isInitialized, "MediaEyeERC1155: must be initialized to mint");
    ...
    function mintBatch(
        ...
        require(
            _amounts.length == _tokenDatum.length &&
                ...
                _amounts.length == _approveIDs.length,
