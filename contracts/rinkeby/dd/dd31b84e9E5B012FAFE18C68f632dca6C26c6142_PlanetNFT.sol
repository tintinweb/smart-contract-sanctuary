...
contract PlanetNFT is ERC721Tradable {
    ...
    function create_random(uint256 tokenId,
        ...
        //newPlanet.color=_metadataGenerator.pickRandomColor(newPlanet.randomness+randomNum(87, newPlanet.randomness, block.timestamp)*7);
        //newPlanet.color2=_metadataGenerator.pickRandomColor(newPlanet.randomness+randomNum(97, newPlanet.randomness, block.timestamp)*7);
        //newPlanet.lineColor=_metadataGenerator.pickRandomColor(newPlanet.randomness+randomNum(111, newPlanet.randomness, block.timestamp)*7);
