...
contract UniartExchange is Exchange {

    string public constant name = "Project Uniart Exchange";

    string public constant version = "2.2";

    string public constant codename = "Alien Scan";

    /**
     * @dev Initialize a UniartExchange instance
...
contract ProxyRegistry is Ownable {
    ...
    /* Delay period for adding an authenticated contract.
       This mitigates a particular class of potential attack on the Uniart DAO (which owns this registry) - if at any point the value of assets held by proxy contracts exceeded the value of half the WYV supply (votes in the DAO),
       a malicious but rational attacker could buy half the Uniart and grant themselves access to all the proxy contracts. A delay period renders this attack nonthreatening - given two weeks, if that happened, users would have
