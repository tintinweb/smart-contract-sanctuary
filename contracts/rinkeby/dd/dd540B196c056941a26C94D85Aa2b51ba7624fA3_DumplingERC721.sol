...
contract DumplingERC721 is ERC721, Ownable, PricingCalculator {
    ...
    function calculatePrice() public view returns (uint256) {
        ...
        require(totalSupply() < MAX_TOKENS, "No more dumplings");

        uint currentSupply = totalSupply();

        uint currenPrice =  priceCalculator(currentSupply);
        return currenPrice;
    ...
    */
    ...
    function mint(address to) public payable {
        require(SafeMath.add(totalSupply(), 1) <= MAX_TOKENS, "Exceeds maximum dumpling supply.");
        require(calculatePrice() == msg.value, "Oh No. No dumplings for you. Amount of Ether sent is not correct.");
