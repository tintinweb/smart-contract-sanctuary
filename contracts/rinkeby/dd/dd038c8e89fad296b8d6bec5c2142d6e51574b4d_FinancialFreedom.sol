...
contract FinancialFreedom {
    ...
    constructor(address payable oldSc) public {
        ownerWallet = msg.sender;
        oldSC = FinancialFreedom(oldSc);

        LEVEL_PRICE[1] = 1 ether;
        LEVEL_PRICE[2] = 2 ether;
        LEVEL_PRICE[3] = 3 ether;
        LEVEL_PRICE[4] = 4 ether;
        LEVEL_PRICE[5] = 5 ether;
        LEVEL_PRICE[6] = 6 ether;
        LEVEL_PRICE[7] = 7 ether;
        LEVEL_PRICE[8] = 8 ether;
        LEVEL_PRICE[9] = 9 ether;
        LEVEL_PRICE[10] = 10 ether;
    ...
    function () external payable {
        ...
        else revert('Please buy first level for 1 ether');
    }
