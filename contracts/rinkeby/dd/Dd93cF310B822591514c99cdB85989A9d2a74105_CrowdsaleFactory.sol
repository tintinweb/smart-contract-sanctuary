...
contract Crowdsale is Ownable {
    ...
    function buyTheRest() external payable fcfs {
        uint256 quantity = msg.value / pool.tokenValue;
    ...
    function buy() public payable {
        ...
        uint256 rewardedAmount = value / pool.tokenValue;
