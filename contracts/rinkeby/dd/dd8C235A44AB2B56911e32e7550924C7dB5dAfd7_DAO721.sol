    ...
    Ownable
{
    ...
    string public contractURI = "https://meta.vote.dao.721.com/contract";
        ...
        returns (string memory)
    {
        require(
            ...
            "DAO721: URI query for nonexistent token"
        );
        return
    ...
    constructor(IERC721Enumerable _club721)
        ERC1155("https://meta.vote.dao.721.com/")
    {
        club721 = _club721;
    }

    function mint(uint256 _club721TokenId, uint256 _amount) external payable {
