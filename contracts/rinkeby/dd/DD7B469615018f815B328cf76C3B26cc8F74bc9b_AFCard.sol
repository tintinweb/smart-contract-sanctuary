...
contract AFCard is ERC721, ERC721Enumerable, ERC721URIStorage, AFRoles, Ownable, IERC2981{
  ...
  constructor (address characterContractAddress, address specialTraitContractAddress)
  ERC721("AFCard","AFC")
  {
  ...
  function purchaseToken(uint256 purchaseCount) external payable{
    ...
    if(!hasRole(PRESALE_ROLE, msg.sender))
      require(_mintStartTime <= block.timestamp, "Attempted to mint before the minting start time");
      
    require(msg.value == priceWEI * purchaseCount, "Incorrect amount sent");
    require(purchaseCount <= 20, "Quantity was greater than 20");
  ...
  function mintReservedCards(uint256 quantity, address[] memory targetAddresses) external {
...

{
  ...
  "evmVersion": "london",
  "libraries": {
    "/contracts/MathAF.sol": {
      "MathAF": "0x0A7705e64915392DE4388Bd5BA31aF2400CdEC70"
    }
  },
  "outputSelection": {
    "*": {
