...
contract YearnVaultMock is  ERC20Upgradeable {
  ...
  function initialize() public initializer{
    min = 9500;
    owner = msg.sender;
    __ERC20_init("yEarn Mock", "yMOCK");

  }

  function setTokenAndControllerAddress(IDetailedERC20 _token, IYearnController _controller) public  {
