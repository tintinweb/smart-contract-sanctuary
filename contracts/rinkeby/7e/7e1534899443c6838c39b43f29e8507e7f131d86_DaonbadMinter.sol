...
// File: contracts/IDaonbadToken.sol

// Contract based on https://docs.openzeppelin.com/contracts/3.x/erc721

/// @title Interface for DaonbadToken

pragma solidity ^0.8.6;

abstract contract IDaonbadToken {
...
// File: contracts/DaonbadMinter.sol
...
contract DaonbadMinter is Ownable, ReentrancyGuard {
    ...
    // ======== Cost =========
    uint256 public constant TOKEN_COST = 0.0001777 ether;
    ...
    function mintPublic(uint amount) public payable nonReentrant {
        ...
        badToken.mint(amount, msg.sender);
    ...
    function reserveTeamTokens(address _to, uint256 _reserveAmount) public onlyOwner {
        ...
        badToken.mint(_reserveAmount, _to);
    }
