...
contract NEWNFT is ERC721, Ownable 
{
    ...
    uint256 public immutable maxNEWNFT;
    ...
    function reserveNEWNFT() public onlyOwner {   
     ...
     function mintNEWNFT(uint256 numberOfTokens) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 20 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxNEWNFT, "Purchase would exceed max supply of NEWNFT");
