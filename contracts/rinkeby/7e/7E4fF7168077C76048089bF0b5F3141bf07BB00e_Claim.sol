...
contract Claim is ERC721, ERC721Enumerable {
  ...
  constructor() ERC721("OpenNFTs", "NFT") {}
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    // require(tokenId == 0, "Strings: hex length insufficient");
    return string(abi.encodePacked(BASE_URI, "bafkrei", buffer));
  }

  function claim(uint256 tokenId) public {
    require(!_exists(tokenId), "ERC721: token already claimed");
    ERC721._balances[msg.sender] += 1;
    ERC721._owners[tokenId] = msg.sender;
  }
