...
contract Presale {
    ...
    event PresaleRegistered(address _registeredAddress, uint256 _stripAmount);
    ...
    function deposit(address sender) external payable whileOnGoing returns (uint256) {
        ...
        uint256 newStripAmount = weiAmount.div(MAX_ALLOC_WEI).mul(MAX_ALLOC_STRIP);
        ...
        emit PresaleRegistered(sender, recipients[sender].amountStrip);
