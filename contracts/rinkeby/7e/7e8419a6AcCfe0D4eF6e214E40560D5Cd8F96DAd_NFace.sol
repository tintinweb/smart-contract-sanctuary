...
contract NFace is NPassCore {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        parts[3] = toString(n.getSecond(tokenId));

        parts[4] = '</text><text x="10" y="60" class="base">';

        parts[5] = toString(n.getThird(tokenId));

        parts[6] = '</text><text x="10" y="80" class="base">';

        parts[7] = toString(n.getFourth(tokenId));

        parts[8] = '</text><text x="10" y="100" class="base">';

        parts[9] = toString(n.getFifth(tokenId));

        parts[10] = '</text><text x="10" y="120" class="base">';

        parts[11] = toString(n.getSixth(tokenId));

        parts[12] = '</text><text x="10" y="140" class="base">';

        parts[13] = toString(n.getSeventh(tokenId));

        parts[14] = '</text><text x="10" y="160" class="base">';

        parts[15] = toString(n.getEight(tokenId));
