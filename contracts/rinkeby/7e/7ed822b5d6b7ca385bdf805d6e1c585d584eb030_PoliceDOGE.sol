...
contract PoliceDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe1DaeBb653C65039Db81939740439a702F33Fe05); // Marketing Address
    ...
    string private _name = "PoliceDoge";
    string private _symbol = "PoliceDOGE";
