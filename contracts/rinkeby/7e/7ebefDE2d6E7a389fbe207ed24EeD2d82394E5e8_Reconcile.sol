...
contract Reconcile is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20FlashMintUpgradeable {
    function initialize() initializer public {
        __ERC20_init("Reconcile", "RCO");
        __ERC20Burnable_init();
        __Ownable_init();
        __ERC20Permit_init("Reconcile");
