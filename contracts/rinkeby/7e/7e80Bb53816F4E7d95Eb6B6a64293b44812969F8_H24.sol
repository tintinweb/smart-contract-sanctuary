...
// todo stake unstake claim events
// todo "claim failed, use canClaim to know why"
...
contract H24 is ERC20, AccessControl {
    ...
    function getUserReward(address addr) public view returns (uint) {
        ...
        require(rewards[miner.date - 1] != 0, "No reward for stake date");
    ...
    function setReward(uint24 date, uint amount) public onlyRole(ORACLE_ROLE) {
        ...
        require(amount > 0, "Reward can't be negative");
