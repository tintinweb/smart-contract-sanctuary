...
contract OxmusicStaticSong is ERC721, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        TokenDetails memory details = TokenDetails(        
            ...
            string(abi.encodePacked(dj,"&id=",
                id,"&len=", len, "&bg=",bg,''))

        );
                    
        return string(abi.encodePacked('data:application/json,',details.intro,',',details.animationUrl, details.args, details.djIdLenBg ,'"', ',"external_url": "https://www.0xmusic.com", "background_color": "',details.hexColor,'" ,', 
...
contract Oxmusic is ERC721, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory attributes = revealActive ? string(abi.encodePacked('"attributes": [', 
                djTrait, cycleLengthTrait, ambienceT, recordsTrait)) : '"attributes": []}';
