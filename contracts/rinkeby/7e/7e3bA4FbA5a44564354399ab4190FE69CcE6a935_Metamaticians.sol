...
contract Metamaticians is
    ...
    event MintAttempt(address indexed _minter);
    event OwnerMintAttempt(address indexed _minter);
    ...
    */
        ...
        nonReentrant
    {
        ...
        require(msg.value >= MINT_FEE, "required amount to mint: 0.618 ETH");
        ...
        onlyOwner
    {
        ...
        for (uint256 i = 0; i < quantity; i++) {
            emit OwnerMintAttempt(msg.sender);
        ...
        string memory json = string(
            abi.encodePacked(
                '{',
                    ...
                    '"external_url": "https://defrag.fi/metamaticians/', tokenId, '",',
