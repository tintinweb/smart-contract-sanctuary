...
contract Minion is ERC721, ReentrancyGuard, Ownable {
    ...
    {
        string memory baseUrl = "https://www.minionloot.com/api/minion/";
    ...
    function teamClaim() public nonReentrant onlyOwner {
        ...
        require(_tokenIdsOwner.current() < 10000, "No more");

        _tokenIdsOwner.increment();
        _safeMint(owner(), _tokenIdsOwner.current());
    }

    constructor() ERC721("Minion", "MINION") Ownable() {}
}
