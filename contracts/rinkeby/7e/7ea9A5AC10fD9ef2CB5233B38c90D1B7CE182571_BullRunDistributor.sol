...
interface IBullRunConfig {
    ...
    function initialize(address token_, address distributor_, address vault_) external;
    ...
    function updateAll(address token_, address distributor_, address vault_) external;
