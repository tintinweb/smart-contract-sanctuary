...
contract NFTPlanets is ERC721, VRFConsumerBase, Ownable {
   ...
   VRFConsumerBase(VRFCoordinator, LinkToken)
    ...
    //Uses random number generated off chain, saves to planetData and mints to msg.sender
   ...
   function fulfillRandomness (bytes32 requestId, uint256 randomNumber)
    ...
    override
    {
        ...
        uint256 newId = planets.length;
        uint256 planetData = randomNumber;
