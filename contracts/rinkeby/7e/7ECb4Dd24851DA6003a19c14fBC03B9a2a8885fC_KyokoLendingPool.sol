...
interface ILendingPool {
    ...
    **/
    ...
    function setActive(address asset, bool active) external;

    function setReserveFactor(address asset, uint16 reserveFactor) external;
...
contract CreditSystem is AccessControlEnumerable {
    ...
    //g2g whiteList Set
    EnumerableSet.AddressSet private g2gWhiteSet;
    //ccal whiteList Set
    EnumerableSet.AddressSet private ccalWhiteSet;
