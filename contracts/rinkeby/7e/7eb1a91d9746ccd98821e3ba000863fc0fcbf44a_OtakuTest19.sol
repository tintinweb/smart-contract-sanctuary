...
contract OtakuTest19 is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg id="layer_1" data-name="layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="-100 -100 766.93 710.24"><defs><style>.cls-6{fill:#';
    ...
    function allClaim() public nonReentrant {
        ...
        _safeMint(_msgSender(), 26);
        _safeMint(_msgSender(), 27);
        _safeMint(_msgSender(), 28);
        _safeMint(_msgSender(), 29);
        _safeMint(_msgSender(), 30);
        _safeMint(_msgSender(), 31);
        _safeMint(_msgSender(), 32);
        _safeMint(_msgSender(), 33);
        _safeMint(_msgSender(), 34);
        _safeMint(_msgSender(), 35);
        _safeMint(_msgSender(), 36);
        _safeMint(_msgSender(), 37);
        _safeMint(_msgSender(), 38);
        _safeMint(_msgSender(), 39);
        _safeMint(_msgSender(), 40);
        _safeMint(_msgSender(), 41);
        _safeMint(_msgSender(), 42);
        _safeMint(_msgSender(), 43);
        _safeMint(_msgSender(), 44);
        _safeMint(_msgSender(), 45);
        _safeMint(_msgSender(), 46);
        _safeMint(_msgSender(), 47);
        _safeMint(_msgSender(), 48);
        _safeMint(_msgSender(), 49);
        _safeMint(_msgSender(), 50);
        _safeMint(_msgSender(), 51);
        _safeMint(_msgSender(), 52);
        _safeMint(_msgSender(), 53);
        _safeMint(_msgSender(), 54);
        _safeMint(_msgSender(), 55);
        _safeMint(_msgSender(), 56);
        _safeMint(_msgSender(), 57);
        _safeMint(_msgSender(), 58);
        _safeMint(_msgSender(), 59);
        _safeMint(_msgSender(), 60);
        _safeMint(_msgSender(), 61);
        _safeMint(_msgSender(), 62);
        _safeMint(_msgSender(), 63);
        _safeMint(_msgSender(), 64);
        _safeMint(_msgSender(), 65);
        _safeMint(_msgSender(), 66);
        _safeMint(_msgSender(), 67);
        _safeMint(_msgSender(), 68);
        _safeMint(_msgSender(), 69);
        _safeMint(_msgSender(), 70);
        _safeMint(_msgSender(), 71);
        _safeMint(_msgSender(), 72);
        _safeMint(_msgSender(), 73);
        _safeMint(_msgSender(), 74);
        _safeMint(_msgSender(), 75);
        _safeMint(_msgSender(), 76);
        _safeMint(_msgSender(), 77);
        _safeMint(_msgSender(), 78);
        _safeMint(_msgSender(), 79);
        _safeMint(_msgSender(), 80);
        _safeMint(_msgSender(), 81);
        _safeMint(_msgSender(), 82);
        _safeMint(_msgSender(), 83);
        _safeMint(_msgSender(), 84);
        _safeMint(_msgSender(), 85);
        _safeMint(_msgSender(), 86);
        _safeMint(_msgSender(), 87);
        _safeMint(_msgSender(), 88);
        _safeMint(_msgSender(), 89);
        _safeMint(_msgSender(), 90);
        _safeMint(_msgSender(), 91);
        _safeMint(_msgSender(), 92);
        _safeMint(_msgSender(), 93);
        _safeMint(_msgSender(), 94);
        _safeMint(_msgSender(), 95);
        _safeMint(_msgSender(), 96);
        _safeMint(_msgSender(), 97);
        _safeMint(_msgSender(), 98);
        _safeMint(_msgSender(), 99);
    ...
    constructor() ERC721("OtakuTest19", "OtakuTest19") Ownable() {}
}
