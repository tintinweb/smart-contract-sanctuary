...
contract vbitToken  is ERC20 {
    ...
    constructor(
        ...
        require(game != address(0), "vbitsToken: ZERO ADDRESS");
        require(stake != address(0), "vbitsToken: ZERO ADDRESS");
        require(community != address(0), "vbitsToken: ZERO ADDRESS");
        require(team != address(0), "vbitsToken: ZERO ADDRESS");
        _owner = msg.sender;
    ...
    function addLocker(uint8 pool_index, address pool_address) external {
        ...
        require(pool_address != address(0), "vbitsToken: ZERO ADDRESS");
