...
contract ToughToken is ERC20, ERC20Pausable, ERC20Burnable, ERC20Capped  {
    ...
    constructor() ERC20("Tough test Token", "TVT") ERC20Capped(100000000000000000000) public{
    ...
    function mintTokens(address from, uint256 amount) public{
        _mint(from, amount);
    }
}