...
contract Space {
    ...
    mapping (bytes => bool) private _isPlanet;
    ...
    function get_relative_2D_pos(string memory object, string memory observer, int256 t ) public view returns (int256, int256) {
        ...
        require(_isPlanet[bytes(object)], "Object planet name is not correct");
        require(_isPlanet[bytes(observer)], "Observer planet name is not correct");
    ...
    function update_euler_matrix(string memory planet) public {
        require(_isPlanet[bytes(planet)], "Planet name is not correct");
