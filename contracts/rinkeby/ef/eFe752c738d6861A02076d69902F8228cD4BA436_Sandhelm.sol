...
contract Sandhelm is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    uint public publicSale = 1636657430; // November 15th 8PM EST - CURRENT EPOCH TIME FOR TESTING ON RINKEBY
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        //ADMINS
        //accounts[admins[8]] = Account( 0, 0, 0, true); //1
        //accounts[admins[9]] = Account( 0, 0, 0, true); //2
        //accounts[admins[10]] = Account( 0, 0, 0, true); //3
        //accounts[admins[11]] = Account( 0, 0, 0, true); //4
        //accounts[admins[12]] = Account( 0, 0, 0, true); //5
    ...
    function increaseMaxHELM(uint _maxhelm) external onlyOwner {
        MAX_HELM = _maxhelm;
    }
