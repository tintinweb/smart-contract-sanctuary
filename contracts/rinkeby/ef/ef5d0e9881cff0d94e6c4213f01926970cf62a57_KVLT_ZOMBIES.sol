...
contract KVLT_ZOMBIES is ERC721Enumerable, Ownable {
    ...
    function preSaleMint(uint256 mintCount) public payable {
        ...
        require(mintCount <= 12,                    "max_presale_mint_count_exceeded");
        require(balanceOf(msg.sender) <= 12,         "presale_wallet_limit_met");
        require(supply < 2000,                       "max_presale_supply_exceeded");
        require(msg.value >= _presaleprice * mintCount,   "insufficient_payment_value");
        // new below
        uint balance = mads.balanceOf(msg.sender);
        require(balance > 0,                        "Must hold at least one Mad Scientist to mint a Dog");
