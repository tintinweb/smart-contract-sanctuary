...
contract WallToken is WallBase, ERC721("WALLART","WALL-ART") { 
    ...
    function setOnSale (uint _id, uint salePrice, bool acceptsbids) public onlyMarket {
        Piece storage piece = allPieces[_id];
        setSalePrice(_id, salePrice);
        piece.onSale = true; 
        piece.acceptBids =  acceptsbids; 
    }
    ...
    function _finalizeSale(uint _id, address _buyer ,bool isBid) internal {
        ...
        piece.lastBid.bidAmount = 0;
        piece.lastBid.bidder = 0x0000000000000000000000000000000000000000;
