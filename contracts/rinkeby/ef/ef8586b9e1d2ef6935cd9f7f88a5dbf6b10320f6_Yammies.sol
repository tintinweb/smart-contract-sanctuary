...
contract Yammies is ERC721, Ownable {
    ...
    uint256 public maxReservedAmount = 300;
    ...
    function reserveYammies(address _to, uint256 _reserveAmount) public onlyOwner {        
        ...
        require(_reserveAmount > 0 && _reserveAmount <= maxReservedAmount, "Not enough reserves left");
        for (uint256 i = 0; i < _reserveAmount; i++) {
            _safeMint(_to, supply + i);
        }
        maxReservedAmount = maxReservedAmount.sub(_reserveAmount);
    }
