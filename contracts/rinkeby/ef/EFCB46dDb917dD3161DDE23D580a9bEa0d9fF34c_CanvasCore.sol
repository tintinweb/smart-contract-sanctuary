...
contract CanvasBase is CanvasAdministration {
    // Events
    event SquareMint(address creator, uint256 squareId);
    ...
    uint256 public mintFee = 0.00056 ether;
    ...
    function _createSquare(address _owner) internal returns (uint256) {
        ...
        Square memory _square =
            Square({
                ...
                artwork: [Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black, Colors.White, Colors.Black]
            });

        uint256 newSquareId = squares.push(_square);
...
contract SquareOwnership is CanvasBase, ERC721 {
    ...
    // This is used when the square doesn't exist yet and doesn't have an owner..
    function mint(uint256 _tokenId) external payable whenNotPaused {
      require(msg.value >= mintFee);
      _createSquare(msg.sender);

      emit SquareMint(msg.sender, _tokenId);
    }
...
contract Picasso is SquareShop {
  ...
  function _paint(uint _tokenId, Colors[25] newArt) internal {
