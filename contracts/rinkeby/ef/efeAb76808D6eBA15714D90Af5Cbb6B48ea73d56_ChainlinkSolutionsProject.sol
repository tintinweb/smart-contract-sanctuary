...
contract ChainlinkSolutionsProject is ChainlinkClient, Ownable {
    ...
    bytes32 private maxJobId;
    bytes32 private minJobId;
    uint256 public fee;
    ...
    constructor() {
        ...
        maxJobId = "49d17674900148019072f13cbf66ea32";
        minJobId = "c2c4860e14ff476f986fccd21a868d92";
        fee = 0.1 ether;
    }
    ...
    function setMaxJobId(bytes32 maxJobId_) external onlyOwner {
        maxJobId = maxJobId_;
    }

    function setMinJobId(bytes32 minJobId_) external onlyOwner {
        minJobId = minJobId_;
    }
    ...
    function requestHighestBalanceAddress() external onlyOwner {
        Chainlink.Request memory req = buildChainlinkRequest(
            maxJobId,
            address(this),
            this.fulfillHighestBalanceAddress.selector
        );
        req.add("mode", "highest");
        sendChainlinkRequestTo(oracle, req, fee);
    }

    function requestLowestbalanceAddress() external onlyOwner {
        Chainlink.Request memory req = buildChainlinkRequest(
            minJobId,
            address(this),
