...
contract Robots is ERC721PresetMinterPauserAutoId, Garage {
    ...
    function transferFrom(address owner, address newaddress, uint256 id) public virtual override {
        //solhint-disable-next-line max-line-length
        require(_isApprovedOrOwner(owner, id), "ERC721: transfer caller is not owner nor approved");

        _transfer(owner, newaddress, id);
    }
