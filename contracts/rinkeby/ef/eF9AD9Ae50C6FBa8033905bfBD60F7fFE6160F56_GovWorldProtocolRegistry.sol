...
contract GovWorldProtocolRegistry is GovWorldProtocolBase {
    ...
    */
        ...
        onlyAddTokenRole(msg.sender)
    {
        ...
        for (uint256 i = 0; i < _tokenAddress.length; i++) {
            require(this.isContract(_tokenAddress[i]), "GPL: Token Address should be contract address");
        ...
        onlyEditTokenRole(msg.sender)
    {
        for(uint i = 0; i < _removeTokenAddress.length; i++) {
            require(this.isContract(_removeTokenAddress[i]), "GPL: Token Address should be contract address");
            require(
    ...
    */
    ...
    {
        require(this.isContract(_tokenAddress), "GPL: Token Address should be contract address");
        require(
