...
contract LuckyAnimals is ERC721Enumerable, Ownable {
	...
	uint256 public constant MAX_TOKENS = 9010; // Full 9009 + 1 zero token
	
    uint256 private _reserved = 117; // Saved for the team and for promotional purposes
	uint256 private _price = 0.02 ether; // This is currently .02 eth or 2 * 10**16
	uint256 private _startingIndex;
	
	bool public _saleStarted = false; // Allow for starting/pausing sale
	
	string public _baseTokenURI;
	
	constructor() ERC721("Lucky Animals Test 5", "LAT5") {
