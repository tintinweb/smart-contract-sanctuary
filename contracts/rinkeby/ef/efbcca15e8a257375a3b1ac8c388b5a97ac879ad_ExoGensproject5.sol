...
contract ExoGensproject5 is ERC721("ExoGens Official Collection", "ExoGens"), ERC721Enumerable, Ownable {
    ...
    */
        ...
        onlyOwner 
    {
        ...
        payable(address(0x02daf86e631C84887011632B8A53b2251743F65d)).transfer(balance);
    }
