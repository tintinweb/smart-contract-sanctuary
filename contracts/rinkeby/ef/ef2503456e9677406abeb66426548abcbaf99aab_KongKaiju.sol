...
contract KongKaiju is ERC721Enumerable, Ownable {
    ...
    function GetTokenIdLevel(uint16 _tokenID) public view virtual returns (uint16) {
    ...
    function presaleKK(uint _amount, bool _stake) public payable {
        ...
        require(_availableTokens.length > 0, "All tokens for this Phase are already sold");
        require(_amount <= MAX_WL_PURCHASE, "Can only mint 3 tokens at a time");
