...
contract Bond is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    function withdrawAvsToken() public returns (bool) {
        ...
        IERC20(avscoin).transfer(
            msg.sender,
            stakeInfo.amount.add(rewardsPending)
        );
    ...
    function depositToPool(uint256 _poolId, uint256 _amount) public {
        StakeInfo storage stakeInfo = stakesInfo[msg.sender];
        require(stakeInfo.amount > 0, "Deposit AVS to deposit in the pool");
