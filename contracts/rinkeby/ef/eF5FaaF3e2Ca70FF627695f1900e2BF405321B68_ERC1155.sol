...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    modifier ownersOnly(uint256 _id) {
        require(_balances[_id][msg.sender] > 0, "ERC1155Tradable#ownersOnly: ONLY_OWNERS_ALLOWED");
        _;
    }
    ...
    function create( address _initialOwner, uint256 _initialSupply, string memory __uri, bytes memory _data) external returns (uint256) {
