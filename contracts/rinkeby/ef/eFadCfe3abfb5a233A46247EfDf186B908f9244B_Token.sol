...
contract Token is Context, IERC20, Ownable {
  ...
  address payable private feeWallet2 = payable(0xCFFb84CF0F94b31E801c8a4022FEFffc3c4E7725);
  ...
  uint256 private numTokensSellToSendAsFee = 10 * 10**6 * 10**18;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(contractTokenBalance >= _maxTxAmount)
        ...
        bool overMinTokenBalance = contractTokenBalance >= numTokensSellToSendAsFee;
        ...
        if (
            ...
            contractTokenBalance = numTokensSellToSendAsFee;
            //add liquidity
