...
contract BallerChains is ERC721, Ownable {
    ...
    **/
    ...
    // Addresses
    address public _gemsAddress = 0xD892b9439A3Db1FA7EA975684605FFe7A10FC0Fe;
    IGems _gemsContract;

    bool public _paused = true;

    string private _baseTokenURI = "https://api-dev.quandefi.io/go/ballerchain/";
    ...
    unchecked {
        ...
        for (uint256 i; i < 10; i++) {
            require(_gemsContract.ownerOf(_tokenIds[i])==msg.sender,"NOT_GEM_OWNER");
            pack <<= 16;
            pack |= _tokenIds[i];
            _gemsContract.burn(_tokenIds[i]);
        }
