...
contract MyEpicNFT is ERC721URIStorage {
    // Magic by OpenZeppelin
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    uint256 private _maxNumberOfNfts = 3;
    
    // Base SVG without the text and closing tags
    string svgPartOne = "<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 350 350'><style>.base { fill: white; font-family: serif; font-size: 24px; }</style><rect width='100%' height='100%' fill='";
    string svgPartTwo = "'/><text x='50%' y='50%' class='base' dominant-baseline='middle' text-anchor='middle'>";
    
    // Sets of strings to randomly choose words from
    string[] firstWords = ["Terrific", "Artistic", "Symbolic", "Garlic", "Claustrophobic"];
    string[] secondWords = ["Extraterrestrial", "Space", "Mars", "Moon", "Mashed"];
    string[] thirdWords = ["Potato", "Kitty", "Doggy", "Jackal", "Lion"];

    // Random colors
    string[] colors = ["#826C34", "#CF3476", "#924E7D", "#E6D690", "#C93C20", "#8F8F8F", "#7FB5B5", "#7FB5B5", "#252850", "#606E8C"];
    ...
    function makeAnEpicNFT() public {
        require(_tokenIds.current() < _maxNumberOfNfts);
        // Fetch the current new tokenId
        ...
        string memory description = "This wonderful cat's eyes gaze into the night sky full of pigeons and potatoes. ";
        ...
        // Increment to the next tokenId for the next NFT
        _tokenIds.increment();
