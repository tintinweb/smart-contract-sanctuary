...
contract SquidGame is Initializable {
    ...
    event NftPriceChange(address, uint256 value);
    ...
    function clearAccumulator()
        ...
        onlyOwner
        calFee
        returns (uint256 twithdraw, uint256 stakeAmounts)
    {
        twithdraw = _twithdraw;
        _twithdraw = 0;
        stakeAmounts = _stakeAmounts;
        _stakeAmounts = stakeAmounts - twithdraw;
        emit ClearAccumulator(msg.sender, stakeAmounts, twithdraw);
    }
}
