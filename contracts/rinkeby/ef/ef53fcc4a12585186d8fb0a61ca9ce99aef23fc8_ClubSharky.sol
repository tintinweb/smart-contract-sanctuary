...
// File: contracts/ClubSharkyLowGas.sol
...
contract ClubSharky is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Club Sharky", "RAWR") {
    setHiddenMetadataUri("ipfs://Qmd2kPQTezvS8cyaAshaNca6QNazjGScPAUJNTWbDfM6iw/hidden.json");
  }
