    ...
    Ownable
{
    ...
    string public constant PRE_REVEAL_METADATA =
        "https://uunicorns.mypinata.cloud/ipfs/QmeMmfZgXe674rqx7DwkazbDBvPmM5Mn4BmDn2xae1vEVN";

    // uint256 public constant PRIVATE_SALE_WINDOW = 23 hours
    uint256 public constant PRIVATE_SALE_WINDOW = 15 minutes; // For testing only
    ...
    uint256 public constant PRIVATE_SALE_OPEN = 1631030400; // For testing only
    uint256 public constant PUBLIC_SALE_OPEN = 1631030400 + PRIVATE_SALE_WINDOW;
    ...
    function privateMint() public payable whenNotPaused onlyEOA {
        ...
        require(
            isPrivateSaleOpen(),
            "UninterestedUnicorns: Private Sale opens on Monday, 13 September 2021 00:00:00 GMT+08:00 and closes on 14 September 2021 00:00:00 GMT+08:00"
        );
        require(
