...
contract TokenMarket is TokenMarketBase {
    ...
    */
    ...
    function activateLoan(uint256[] memory loanIds, uint256[] memory stableCoinAmounts, bool[] memory _autoSell) public {
        ...
        uint256 loanAmountAfterAPYFee = loanOffersToken[loanIds[i]].loanAmountInBorrowed.sub(apyFee);

        stableCoinAPYFeeFromToken[address(this)] =  stableCoinAPYFeeFromToken[address(this)].add(apyFee);
        ...
        activatedLoanOffersFull[loanIds[i]] =  TokenLoanData.LenderDetails({
		    lender: msg.sender,
            activationLoanTimeStamp: block.timestamp,       //1627894578, //TODO change time to block.timestamp
