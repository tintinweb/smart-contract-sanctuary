...
contract newNFT is ERC721Enumerable, Ownable {
  ...
  address public constant mm_addr = 0xB1B8723A240444E8B7634b7324E6201959076f24;
  ...
  function mintYellowMagicDoodleFrenFromMilk(address _to, uint256 milkID) public payable {
     temp1 = msg.value;
    require(!paused);
  ...
  function mintAllYellowMagicDoodleFrenFromMilk(address _to) public payable {
