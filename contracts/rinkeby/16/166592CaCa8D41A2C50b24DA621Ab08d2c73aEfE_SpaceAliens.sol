    ...
    Ownable
{
    ...
    uint256 public Startdate = 1633966953; // 
    uint256 public Enddate = 1634027791; // 

    string _name = "SpaceAliensNFT";
    string _symbol = "SANFT";
    
    address SB_address = 0x8503f4AD5a808b4CfE810d5E5A8c3193BdADfB5A; // testnet
    //address SB_address = 0x672c1f1c978b8fd1e9ae18e25d0e55176824989c; // mainnet
    ...
    function mintGroup1() external {
        ...
        //only owner of >= 7 spaceboy
        require(SpaceBoyContract.balanceOf(_msgSender()) >= 7, 'only owners of 7 or more spaceboy could mint!');
    ...
    function mintGroup2() external {
        ...
        //only owner of >= 3 spaceboy
        uint256 num = SpaceBoyContract.balanceOf(_msgSender());
        require(num >= 3, 'only owners of 3 or more spaceboy could mint!');
        require(num < 7, 'You should claim for 7 or more!');
