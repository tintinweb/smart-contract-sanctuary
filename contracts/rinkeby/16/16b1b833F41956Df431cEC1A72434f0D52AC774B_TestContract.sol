...
contract TestContract is ERC721Enumerable, Ownable {
    ...
    uint256 public constant RESERVED_SUPPLY = 200; //TODO
    ...
    function beginSale(uint256 _price) public onlyOwner
        {
            ...
            require(_price >= 0 ether, "Price must be set higher."); //TODO
            price = _price;
            saleHasBegun = true;
        }
    ...
    {        
        require(saleHasBegun, 'Cannot be done - sale has not yet begun.');
        require(numTokens < MAX_SUPPLY, 'All Rabbits have been claimed from the burrow.');
        require(numToMint > 0 && numToMint <= 20, 'You can mint no fewer than 1, and no more than 20 at a time.'); //TODO
    ...
    */
    ...
    function reserve() public
    {
        ...
        for (uint256 i = 1; i < RESERVED_SUPPLY+1; i++) 
        {
