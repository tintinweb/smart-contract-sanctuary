...
contract RockPaperScissor is Ownable {
    ...
    uint constant private JACKPOT_MIN = 1000000000000000000;
    uint constant private JACKPOT_MAX = 2000000000000000000;
    ...
    function refreshJackpotThreshold() private {
        _jackpotValue = JACKPOT_MIN + (uint256(keccak256(abi.encodePacked(_jackpotValue,now))) % 1000000)*1000000000000;
    }
